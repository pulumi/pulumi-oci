module github.com/pulumi/pulumi-oci/provider/v3
...
replace (
	...
	github.com/oracle/terraform-provider-oci => ../upstream
)

require (
	github.com/oracle/terraform-provider-oci v0.0.0
...
require github.com/oracle/oci-go-sdk/v65 v65.99.0 // indirect
