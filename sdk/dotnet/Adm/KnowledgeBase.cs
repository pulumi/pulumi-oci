...
namespace Pulumi.Oci.Adm
{
    ...
    public partial class KnowledgeBase : global::Pulumi.CustomResource
    {
        ...
        public KnowledgeBase(string name, KnowledgeBaseArgs args, CustomResourceOptions? options = null)
            : base("oci:Adm/knowledgeBase:KnowledgeBase", name, args ?? new KnowledgeBaseArgs(), MakeResourceOptions(options, ""))
        {
        }

        private KnowledgeBase(string name, Input<string> id, KnowledgeBaseState? state = null, CustomResourceOptions? options = null)
            : base("oci:Adm/knowledgeBase:KnowledgeBase", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static KnowledgeBase Get(string name, Input<string> id, KnowledgeBaseState? state = null, CustomResourceOptions? options = null)
        {
