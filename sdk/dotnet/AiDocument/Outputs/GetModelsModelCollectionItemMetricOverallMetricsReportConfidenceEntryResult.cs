...
namespace Pulumi.Oci.AiDocument.Outputs
{
    ...
    [OutputType]
    public sealed class GetModelsModelCollectionItemMetricOverallMetricsReportConfidenceEntryResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetModelsModelCollectionItemMetricOverallMetricsReportConfidenceEntryResult(
            double accuracy,
