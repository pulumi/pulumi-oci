...
namespace Pulumi.Oci.AiLanguage
{
    ...
    /// {
    ///     var testProject = new Oci.AiLanguage.Project("testProject", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:AiLanguage/project:Project")]
    public partial class Project : global::Pulumi.CustomResource
    {
        ...
        public Project(string name, ProjectArgs args, CustomResourceOptions? options = null)
            : base("oci:AiLanguage/project:Project", name, args ?? new ProjectArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Project(string name, Input<string> id, ProjectState? state = null, CustomResourceOptions? options = null)
            : base("oci:AiLanguage/project:Project", name, state, MakeResourceOptions(options, id))
        {
        }
