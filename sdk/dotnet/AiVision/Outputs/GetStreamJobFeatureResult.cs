...
namespace Pulumi.Oci.AiVision.Outputs
{
    ...
    [OutputType]
    public sealed class GetStreamJobFeatureResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetStreamJobFeatureTrackingTypeResult> TrackingTypes;

        [OutputConstructor]
        private GetStreamJobFeatureResult(
            string featureType,
            ...
            ImmutableArray<Outputs.GetStreamJobFeatureTrackingTypeResult> trackingTypes)
        {
