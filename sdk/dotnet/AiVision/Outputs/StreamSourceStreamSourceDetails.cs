...
namespace Pulumi.Oci.AiVision.Outputs
{
    ...
    [OutputType]
    public sealed class StreamSourceStreamSourceDetails
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.StreamSourceStreamSourceDetailsStreamNetworkAccessDetails StreamNetworkAccessDetails;
        ...
        private StreamSourceStreamSourceDetails(
            ...
            Outputs.StreamSourceStreamSourceDetailsStreamNetworkAccessDetails streamNetworkAccessDetails)
        {
            CameraUrl = cameraUrl;
            SecretId = secretId;
