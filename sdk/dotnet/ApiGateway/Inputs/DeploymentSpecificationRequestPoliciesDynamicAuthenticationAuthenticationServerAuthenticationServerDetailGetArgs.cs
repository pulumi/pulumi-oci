...
namespace Pulumi.Oci.ApiGateway.Inputs
{
    ...
    public sealed class DeploymentSpecificationRequestPoliciesDynamicAuthenticationAuthenticationServerAuthenticationServerDetailGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("audiences")]
        ...
        /// </summary>
        [Input("publicKeys")]
        public Input<Inputs.DeploymentSpecificationRequestPoliciesDynamicAuthenticationAuthenticationServerAuthenticationServerDetailPublicKeysGetArgs>? PublicKeys { get; set; }
        ...
        public Input<Inputs.DeploymentSpecificationRequestPoliciesDynamicAuthenticationAuthenticationServerAuthenticationServerDetailValidationFailurePolicyGetArgs>? ValidationFailurePolicy { get; set; }

        /// <summary>
        /// (Updatable) Authentication Policies for the Token Authentication types.
        /// </summary>
        [Input("validationPolicy")]
        public Input<Inputs.DeploymentSpecificationRequestPoliciesDynamicAuthenticationAuthenticationServerAuthenticationServerDetailValidationPolicyGetArgs>? ValidationPolicy { get; set; }

        [Input("verifyClaims")]
        private InputList<Inputs.DeploymentSpecificationRequestPoliciesDynamicAuthenticationAuthenticationServerAuthenticationServerDetailVerifyClaimGetArgs>? _verifyClaims;

        /// <summary>
        /// (Updatable) A list of claims which should be validated to consider the token valid.
        /// </summary>
        public InputList<Inputs.DeploymentSpecificationRequestPoliciesDynamicAuthenticationAuthenticationServerAuthenticationServerDetailVerifyClaimGetArgs> VerifyClaims
        {
            get => _verifyClaims ?? (_verifyClaims = new InputList<Inputs.DeploymentSpecificationRequestPoliciesDynamicAuthenticationAuthenticationServerAuthenticationServerDetailVerifyClaimGetArgs>());
            set => _verifyClaims = value;
        }

        public DeploymentSpecificationRequestPoliciesDynamicAuthenticationAuthenticationServerAuthenticationServerDetailGetArgs()
        {
        }
        public static new DeploymentSpecificationRequestPoliciesDynamicAuthenticationAuthenticationServerAuthenticationServerDetailGetArgs Empty => new DeploymentSpecificationRequestPoliciesDynamicAuthenticationAuthenticationServerAuthenticationServerDetailGetArgs();
    }
}
