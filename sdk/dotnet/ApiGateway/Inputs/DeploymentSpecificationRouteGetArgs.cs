...
namespace Pulumi.Oci.ApiGateway.Inputs
{
    ...
    public sealed class DeploymentSpecificationRouteGetArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DeploymentSpecificationRouteBackendGetArgs> Backend { get; set; } = null!;

        /// <summary>
        /// (Updatable) Policies controlling the pushing of logs to Oracle Cloud Infrastructure Public Logging.
        /// </summary>
        [Input("loggingPolicies")]
        public Input<Inputs.DeploymentSpecificationRouteLoggingPoliciesGetArgs>? LoggingPolicies { get; set; }
        ...
        public Input<Inputs.DeploymentSpecificationRouteRequestPoliciesGetArgs>? RequestPolicies { get; set; }

        /// <summary>
        /// (Updatable) Behavior applied to any responses sent by the API for requests on this route.
        /// </summary>
        [Input("responsePolicies")]
        public Input<Inputs.DeploymentSpecificationRouteResponsePoliciesGetArgs>? ResponsePolicies { get; set; }
