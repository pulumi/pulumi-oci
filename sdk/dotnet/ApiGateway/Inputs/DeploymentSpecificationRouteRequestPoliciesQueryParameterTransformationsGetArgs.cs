...
namespace Pulumi.Oci.ApiGateway.Inputs
{
    ...
    public sealed class DeploymentSpecificationRouteRequestPoliciesQueryParameterTransformationsGetArgs : Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DeploymentSpecificationRouteRequestPoliciesQueryParameterTransformationsFilterQueryParametersGetArgs>? FilterQueryParameters { get; set; }

        /// <summary>
        /// (Updatable) Rename parameters on the query string as they pass through the gateway.
        /// </summary>
        [Input("renameQueryParameters")]
        public Input<Inputs.DeploymentSpecificationRouteRequestPoliciesQueryParameterTransformationsRenameQueryParametersGetArgs>? RenameQueryParameters { get; set; }

        /// <summary>
        /// (Updatable) Set parameters on the query string as they pass through the gateway.
        /// </summary>
        [Input("setQueryParameters")]
        public Input<Inputs.DeploymentSpecificationRouteRequestPoliciesQueryParameterTransformationsSetQueryParametersGetArgs>? SetQueryParameters { get; set; }
