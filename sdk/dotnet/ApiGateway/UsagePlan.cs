...
namespace Pulumi.Oci.ApiGateway
{
    ...
    public partial class UsagePlan : global::Pulumi.CustomResource
    {
        ...
        public UsagePlan(string name, UsagePlanArgs args, CustomResourceOptions? options = null)
            : base("oci:ApiGateway/usagePlan:UsagePlan", name, args ?? new UsagePlanArgs(), MakeResourceOptions(options, ""))
        {
        }

        private UsagePlan(string name, Input<string> id, UsagePlanState? state = null, CustomResourceOptions? options = null)
            : base("oci:ApiGateway/usagePlan:UsagePlan", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class UsagePlanArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.UsagePlanEntitlementArgs>? _entitlements;

        /// <summary>
        /// (Updatable) A collection of entitlements to assign to the newly created usage plan.
        /// </summary>
        public InputList<Inputs.UsagePlanEntitlementArgs> Entitlements
        {
            get => _entitlements ?? (_entitlements = new InputList<Inputs.UsagePlanEntitlementArgs>());
    ...
    public sealed class UsagePlanState : global::Pulumi.ResourceArgs
    {
        ...
        [Input("entitlements")]
        private InputList<Inputs.UsagePlanEntitlementGetArgs>? _entitlements;

        /// <summary>
        /// (Updatable) A collection of entitlements to assign to the newly created usage plan.
        /// </summary>
        public InputList<Inputs.UsagePlanEntitlementGetArgs> Entitlements
        {
            get => _entitlements ?? (_entitlements = new InputList<Inputs.UsagePlanEntitlementGetArgs>());
            set => _entitlements = value;
        }
