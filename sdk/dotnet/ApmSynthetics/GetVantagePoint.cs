...
namespace Pulumi.Oci.ApmSynthetics
{
    public static class GetVantagePoint
    {
        ...
        ///     public MyStack()
        ///     {
        ///         var testPublicVantagePoint = Output.Create(Oci.ApmSynthetics.GetVantagePoint.InvokeAsync(new Oci.ApmSynthetics.GetVantagePointArgs
        ///         {
    ...
    public sealed class GetVantagePointArgs : Pulumi.InvokeArgs
    {
        /// <summary>
    ...
    public sealed class GetVantagePointInvokeArgs : Pulumi.InvokeArgs
    {
        /// <summary>
        /// The APM domain ID the request is intended for.
        /// </summary>
