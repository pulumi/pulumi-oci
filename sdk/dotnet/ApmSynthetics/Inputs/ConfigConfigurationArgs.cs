...
namespace Pulumi.Oci.ApmSynthetics.Inputs
{
    ...
    public sealed class ConfigConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ConfigConfigurationDatabaseAuthenticationDetailsArgs>? DatabaseAuthenticationDetails { get; set; }
        ...
        public Input<Inputs.ConfigConfigurationDatabaseWalletDetailsArgs>? DatabaseWalletDetails { get; set; }
        ...
        public Input<Inputs.ConfigConfigurationFtpBasicAuthenticationDetailsArgs>? FtpBasicAuthenticationDetails { get; set; }
        ...
        private InputList<Inputs.ConfigConfigurationRequestHeaderArgs>? _requestHeaders;

        /// <summary>
        /// (Updatable) List of request headers. Example: `[{"headerName": "content-type", "headerValue":"json"}]`
        /// </summary>
        public InputList<Inputs.ConfigConfigurationRequestHeaderArgs> RequestHeaders
        {
            get => _requestHeaders ?? (_requestHeaders = new InputList<Inputs.ConfigConfigurationRequestHeaderArgs>());
        ...
        private InputList<Inputs.ConfigConfigurationRequestQueryParamArgs>? _requestQueryParams;

        /// <summary>
        /// (Updatable) List of request query params. Example: `[{"paramName": "sortOrder", "paramValue": "asc"}]`
        /// </summary>
        public InputList<Inputs.ConfigConfigurationRequestQueryParamArgs> RequestQueryParams
        {
            get => _requestQueryParams ?? (_requestQueryParams = new InputList<Inputs.ConfigConfigurationRequestQueryParamArgs>());
        ...
        [Input("verifyTexts")]
        private InputList<Inputs.ConfigConfigurationVerifyTextArgs>? _verifyTexts;
        ...
        /// </summary>
        public InputList<Inputs.ConfigConfigurationVerifyTextArgs> VerifyTexts
        {
            get => _verifyTexts ?? (_verifyTexts = new InputList<Inputs.ConfigConfigurationVerifyTextArgs>());
            set => _verifyTexts = value;
        }

        public ConfigConfigurationArgs()
        {
        }
        public static new ConfigConfigurationArgs Empty => new ConfigConfigurationArgs();
    }
}
