...
namespace Pulumi.Oci.ApmSynthetics.Outputs
{
    ...
    [OutputType]
    public sealed class GetMonitorConfigurationReqAuthenticationDetailResult
    {
        /// <summary>
        /// List of authentication headers. Example: `[{"headerName": "content-type", "headerValue":"json"}]`
        /// </summary>
        public readonly ImmutableArray<Outputs.GetMonitorConfigurationReqAuthenticationDetailAuthHeaderResult> AuthHeaders;
        /// <summary>
        /// Request method.
        /// </summary>
