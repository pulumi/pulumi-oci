...
namespace Pulumi.Oci.BigDataService.Outputs
{
    ...
    public sealed class AutoScalingConfigurationPolicyDetailsScaleDownConfigMetric
    {
        ...
        /// </summary>
        public readonly Outputs.AutoScalingConfigurationPolicyDetailsScaleDownConfigMetricThreshold? Threshold;

        [OutputConstructor]
        private AutoScalingConfigurationPolicyDetailsScaleDownConfigMetric(
            string? metricType,

            Outputs.AutoScalingConfigurationPolicyDetailsScaleDownConfigMetricThreshold? threshold)
        {
