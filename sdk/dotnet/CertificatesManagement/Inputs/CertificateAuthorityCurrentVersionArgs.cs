...
namespace Pulumi.Oci.CertificatesManagement.Inputs
{
    ...
    public sealed class CertificateAuthorityCurrentVersionArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The OCID of the CA.
        /// </summary>
        ...
        private InputList<Inputs.CertificateAuthorityCurrentVersionRevocationStatusArgs>? _revocationStatuses;

        /// <summary>
        /// The current revocation status of the entity.
        /// </summary>
        public InputList<Inputs.CertificateAuthorityCurrentVersionRevocationStatusArgs> RevocationStatuses
        {
            get => _revocationStatuses ?? (_revocationStatuses = new InputList<Inputs.CertificateAuthorityCurrentVersionRevocationStatusArgs>());
        ...
        [Input("validities")]
        private InputList<Inputs.CertificateAuthorityCurrentVersionValidityArgs>? _validities;

        /// <summary>
        /// An object that describes a period of time during which an entity is valid. If this is not provided when you create a certificate, the validity of the issuing CA is used.
        /// </summary>
        public InputList<Inputs.CertificateAuthorityCurrentVersionValidityArgs> Validities
        {
            get => _validities ?? (_validities = new InputList<Inputs.CertificateAuthorityCurrentVersionValidityArgs>());
        ...
        public CertificateAuthorityCurrentVersionArgs()
        {
        }
        public static new CertificateAuthorityCurrentVersionArgs Empty => new CertificateAuthorityCurrentVersionArgs();
    }
}
