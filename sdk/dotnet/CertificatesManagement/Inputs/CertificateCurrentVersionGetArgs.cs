...
namespace Pulumi.Oci.CertificatesManagement.Inputs
{
    ...
    public sealed class CertificateCurrentVersionGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.CertificateCurrentVersionRevocationStatusGetArgs>? _revocationStatuses;

        /// <summary>
        /// The current revocation status of the entity.
        /// </summary>
        public InputList<Inputs.CertificateCurrentVersionRevocationStatusGetArgs> RevocationStatuses
        {
            get => _revocationStatuses ?? (_revocationStatuses = new InputList<Inputs.CertificateCurrentVersionRevocationStatusGetArgs>());
        ...
        private InputList<Inputs.CertificateCurrentVersionSubjectAlternativeNameGetArgs>? _subjectAlternativeNames;

        /// <summary>
        /// A list of subject alternative names.
        /// </summary>
        public InputList<Inputs.CertificateCurrentVersionSubjectAlternativeNameGetArgs> SubjectAlternativeNames
        {
            get => _subjectAlternativeNames ?? (_subjectAlternativeNames = new InputList<Inputs.CertificateCurrentVersionSubjectAlternativeNameGetArgs>());
        ...
        [Input("validities")]
        private InputList<Inputs.CertificateCurrentVersionValidityGetArgs>? _validities;

        /// <summary>
        /// An object that describes a period of time during which an entity is valid. If this is not provided when you create a certificate, the validity of the issuing CA is used.
        /// </summary>
        public InputList<Inputs.CertificateCurrentVersionValidityGetArgs> Validities
        {
            get => _validities ?? (_validities = new InputList<Inputs.CertificateCurrentVersionValidityGetArgs>());
