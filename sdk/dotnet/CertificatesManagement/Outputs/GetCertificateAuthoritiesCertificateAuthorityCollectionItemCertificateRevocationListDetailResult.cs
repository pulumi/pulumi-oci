...
namespace Pulumi.Oci.CertificatesManagement.Outputs
{
    ...
    [OutputType]
    public sealed class GetCertificateAuthoritiesCertificateAuthorityCollectionItemCertificateRevocationListDetailResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetCertificateAuthoritiesCertificateAuthorityCollectionItemCertificateRevocationListDetailObjectStorageConfigResult> ObjectStorageConfigs;

        [OutputConstructor]
        private GetCertificateAuthoritiesCertificateAuthorityCollectionItemCertificateRevocationListDetailResult(
            ImmutableArray<string> customFormattedUrls,

            ImmutableArray<Outputs.GetCertificateAuthoritiesCertificateAuthorityCollectionItemCertificateRevocationListDetailObjectStorageConfigResult> objectStorageConfigs)
        {
