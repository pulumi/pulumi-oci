...
namespace Pulumi.Oci.CertificatesManagement.Outputs
{
    ...
    [OutputType]
    public sealed class GetCertificateCertificateRevocationListDetailResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetCertificateCertificateRevocationListDetailObjectStorageConfigResult> ObjectStorageConfigs;

        [OutputConstructor]
        private GetCertificateCertificateRevocationListDetailResult(
            ImmutableArray<string> customFormattedUrls,

            ImmutableArray<Outputs.GetCertificateCertificateRevocationListDetailObjectStorageConfigResult> objectStorageConfigs)
        {
