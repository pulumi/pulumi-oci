...
namespace Pulumi.Oci.CloudBridge.Inputs
{
    ...
    public sealed class AssetAwsEc2Args : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.AssetAwsEc2NetworkInterfaceArgs>? _networkInterfaces;

        /// <summary>
        /// (Updatable) The network interfaces for the instance.
        /// </summary>
        public InputList<Inputs.AssetAwsEc2NetworkInterfaceArgs> NetworkInterfaces
        {
            get => _networkInterfaces ?? (_networkInterfaces = new InputList<Inputs.AssetAwsEc2NetworkInterfaceArgs>());
        ...
        /// </summary>
        [Input("placement")]
        public Input<Inputs.AssetAwsEc2PlacementArgs>? Placement { get; set; }
        ...
        private InputList<Inputs.AssetAwsEc2SecurityGroupArgs>? _securityGroups;

        /// <summary>
        /// (Updatable) The security groups for the instance.
        /// </summary>
        public InputList<Inputs.AssetAwsEc2SecurityGroupArgs> SecurityGroups
        {
            get => _securityGroups ?? (_securityGroups = new InputList<Inputs.AssetAwsEc2SecurityGroupArgs>());
        ...
        /// </summary>
        [Input("state")]
        public Input<Inputs.AssetAwsEc2StateArgs>? State { get; set; }
        ...
        [Input("tags")]
        private InputList<Inputs.AssetAwsEc2TagArgs>? _tags;

        /// <summary>
        /// (Updatable) Any tags assigned to the instance.
        /// </summary>
        public InputList<Inputs.AssetAwsEc2TagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.AssetAwsEc2TagArgs>());
            set => _tags = value;
        }
        ...
        public AssetAwsEc2Args()
        {
        }
        public static new AssetAwsEc2Args Empty => new AssetAwsEc2Args();
    }
}
