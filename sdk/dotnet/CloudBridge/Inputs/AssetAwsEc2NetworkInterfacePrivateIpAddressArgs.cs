...
namespace Pulumi.Oci.CloudBridge.Inputs
{
    ...
    public sealed class AssetAwsEc2NetworkInterfacePrivateIpAddressArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) Describes association information for an Elastic IP address (IPv4).
        /// </summary>
        [Input("association")]
        public Input<Inputs.AssetAwsEc2NetworkInterfacePrivateIpAddressAssociationArgs>? Association { get; set; }
        ...
        public AssetAwsEc2NetworkInterfacePrivateIpAddressArgs()
        {
        }
        public static new AssetAwsEc2NetworkInterfacePrivateIpAddressArgs Empty => new AssetAwsEc2NetworkInterfacePrivateIpAddressArgs();
    }
}
