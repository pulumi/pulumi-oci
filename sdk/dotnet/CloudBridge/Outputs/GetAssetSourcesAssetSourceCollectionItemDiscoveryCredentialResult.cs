...
namespace Pulumi.Oci.CloudBridge.Outputs
{
    ...
    [OutputType]
    public sealed class GetAssetSourcesAssetSourceCollectionItemDiscoveryCredentialResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetAssetSourcesAssetSourceCollectionItemDiscoveryCredentialResult(
            string secretId,
