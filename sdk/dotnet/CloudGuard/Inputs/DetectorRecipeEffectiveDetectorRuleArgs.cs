...
namespace Pulumi.Oci.CloudGuard.Inputs
{
    ...
    public sealed class DetectorRecipeEffectiveDetectorRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.DetectorRecipeEffectiveDetectorRuleEntitiesMappingArgs>? _entitiesMappings;

        /// <summary>
        /// Data source entities mapping for the detector rule
        /// </summary>
        public InputList<Inputs.DetectorRecipeEffectiveDetectorRuleEntitiesMappingArgs> EntitiesMappings
        {
            get => _entitiesMappings ?? (_entitiesMappings = new InputList<Inputs.DetectorRecipeEffectiveDetectorRuleEntitiesMappingArgs>());
        ...
        [Input("ruleTypes")]
        private InputList<Inputs.DetectorRecipeEffectiveDetectorRuleRuleTypeArgs>? _ruleTypes;

        /// <summary>
        /// Detector rule type
        /// </summary>
        public InputList<Inputs.DetectorRecipeEffectiveDetectorRuleRuleTypeArgs> RuleTypes
        {
            get => _ruleTypes ?? (_ruleTypes = new InputList<Inputs.DetectorRecipeEffectiveDetectorRuleRuleTypeArgs>());
