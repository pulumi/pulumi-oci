...
namespace Pulumi.Oci.CloudGuard.Inputs
{
    ...
    public sealed class TargetTargetDetectorRecipeArgs : Pulumi.ResourceArgs
    {
        ...
        {
            get => _detectorRules ?? (_detectorRules = new InputList<Inputs.TargetTargetDetectorRecipeDetectorRuleArgs>());
        ...
        {
            get => _effectiveDetectorRules ?? (_effectiveDetectorRules = new InputList<Inputs.TargetTargetDetectorRecipeEffectiveDetectorRuleArgs>());
