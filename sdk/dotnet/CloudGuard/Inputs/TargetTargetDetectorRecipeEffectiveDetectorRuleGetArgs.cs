...
namespace Pulumi.Oci.CloudGuard.Inputs
{
    ...
    public sealed class TargetTargetDetectorRecipeEffectiveDetectorRuleGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        {
            get => _details ?? (_details = new InputList<Inputs.TargetTargetDetectorRecipeEffectiveDetectorRuleDetailGetArgs>());
            set => _details = value;
        }
        ...
        {
            get => _entitiesMappings ?? (_entitiesMappings = new InputList<Inputs.TargetTargetDetectorRecipeEffectiveDetectorRuleEntitiesMappingGetArgs>());
        ...
        [Input("ruleTypes")]
        private InputList<Inputs.TargetTargetDetectorRecipeEffectiveDetectorRuleRuleTypeGetArgs>? _ruleTypes;

        /// <summary>
        /// Rule category type
        /// </summary>
        public InputList<Inputs.TargetTargetDetectorRecipeEffectiveDetectorRuleRuleTypeGetArgs> RuleTypes
        {
            get => _ruleTypes ?? (_ruleTypes = new InputList<Inputs.TargetTargetDetectorRecipeEffectiveDetectorRuleRuleTypeGetArgs>());
        ...
        public TargetTargetDetectorRecipeEffectiveDetectorRuleGetArgs()
        {
        }
        public static new TargetTargetDetectorRecipeEffectiveDetectorRuleGetArgs Empty => new TargetTargetDetectorRecipeEffectiveDetectorRuleGetArgs();
    }
}
