...
namespace Pulumi.Oci.CloudGuard
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:CloudGuard/savedQuery:SavedQuery")]
    public partial class SavedQuery : global::Pulumi.CustomResource
    {
        ...
        public SavedQuery(string name, SavedQueryArgs args, CustomResourceOptions? options = null)
            : base("oci:CloudGuard/savedQuery:SavedQuery", name, args ?? new SavedQueryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SavedQuery(string name, Input<string> id, SavedQueryState? state = null, CustomResourceOptions? options = null)
            : base("oci:CloudGuard/savedQuery:SavedQuery", name, state, MakeResourceOptions(options, id))
        {
        }
