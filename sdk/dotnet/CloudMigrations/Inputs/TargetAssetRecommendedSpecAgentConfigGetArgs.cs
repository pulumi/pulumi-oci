...
namespace Pulumi.Oci.CloudMigrations.Inputs
{
    ...
    public sealed class TargetAssetRecommendedSpecAgentConfigGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.TargetAssetRecommendedSpecAgentConfigPluginsConfigGetArgs>? _pluginsConfigs;

        /// <summary>
        /// (Updatable) The configuration of plugins associated with this instance.
        /// </summary>
        public InputList<Inputs.TargetAssetRecommendedSpecAgentConfigPluginsConfigGetArgs> PluginsConfigs
        {
            get => _pluginsConfigs ?? (_pluginsConfigs = new InputList<Inputs.TargetAssetRecommendedSpecAgentConfigPluginsConfigGetArgs>());
            set => _pluginsConfigs = value;
        }

        public TargetAssetRecommendedSpecAgentConfigGetArgs()
        {
        }
        public static new TargetAssetRecommendedSpecAgentConfigGetArgs Empty => new TargetAssetRecommendedSpecAgentConfigGetArgs();
    }
}
