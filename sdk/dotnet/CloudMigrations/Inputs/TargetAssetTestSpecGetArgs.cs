...
namespace Pulumi.Oci.CloudMigrations.Inputs
{
    ...
    public sealed class TargetAssetTestSpecGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("agentConfigs")]
        private InputList<Inputs.TargetAssetTestSpecAgentConfigGetArgs>? _agentConfigs;

        /// <summary>
        /// Configuration options for the Oracle Cloud Agent software running on the instance.
        /// </summary>
        public InputList<Inputs.TargetAssetTestSpecAgentConfigGetArgs> AgentConfigs
        {
            get => _agentConfigs ?? (_agentConfigs = new InputList<Inputs.TargetAssetTestSpecAgentConfigGetArgs>());
        ...
        private InputList<Inputs.TargetAssetTestSpecCreateVnicDetailGetArgs>? _createVnicDetails;
        ...
        /// </summary>
        public InputList<Inputs.TargetAssetTestSpecCreateVnicDetailGetArgs> CreateVnicDetails
        {
            get => _createVnicDetails ?? (_createVnicDetails = new InputList<Inputs.TargetAssetTestSpecCreateVnicDetailGetArgs>());
        ...
        private InputList<Inputs.TargetAssetTestSpecInstanceOptionGetArgs>? _instanceOptions;

        /// <summary>
        /// Optional mutable instance options
        /// </summary>
        public InputList<Inputs.TargetAssetTestSpecInstanceOptionGetArgs> InstanceOptions
        {
            get => _instanceOptions ?? (_instanceOptions = new InputList<Inputs.TargetAssetTestSpecInstanceOptionGetArgs>());
        ...
        private InputList<Inputs.TargetAssetTestSpecPreemptibleInstanceConfigGetArgs>? _preemptibleInstanceConfigs;

        /// <summary>
        /// Configuration options for preemptible instances.
        /// </summary>
        public InputList<Inputs.TargetAssetTestSpecPreemptibleInstanceConfigGetArgs> PreemptibleInstanceConfigs
        {
            get => _preemptibleInstanceConfigs ?? (_preemptibleInstanceConfigs = new InputList<Inputs.TargetAssetTestSpecPreemptibleInstanceConfigGetArgs>());
        ...
        [Input("shapeConfigs")]
        private InputList<Inputs.TargetAssetTestSpecShapeConfigGetArgs>? _shapeConfigs;

        /// <summary>
        /// The shape configuration requested for the instance.
        /// </summary>
        public InputList<Inputs.TargetAssetTestSpecShapeConfigGetArgs> ShapeConfigs
        {
            get => _shapeConfigs ?? (_shapeConfigs = new InputList<Inputs.TargetAssetTestSpecShapeConfigGetArgs>());
        ...
        public TargetAssetTestSpecGetArgs()
        {
        }
        public static new TargetAssetTestSpecGetArgs Empty => new TargetAssetTestSpecGetArgs();
    }
}
