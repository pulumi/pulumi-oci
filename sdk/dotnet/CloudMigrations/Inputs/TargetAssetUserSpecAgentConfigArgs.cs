...
namespace Pulumi.Oci.CloudMigrations.Inputs
{
    ...
    public sealed class TargetAssetUserSpecAgentConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.TargetAssetUserSpecAgentConfigPluginsConfigArgs>? _pluginsConfigs;

        /// <summary>
        /// (Updatable) The configuration of plugins associated with this instance.
        /// </summary>
        public InputList<Inputs.TargetAssetUserSpecAgentConfigPluginsConfigArgs> PluginsConfigs
        {
            get => _pluginsConfigs ?? (_pluginsConfigs = new InputList<Inputs.TargetAssetUserSpecAgentConfigPluginsConfigArgs>());
            set => _pluginsConfigs = value;
        }

        public TargetAssetUserSpecAgentConfigArgs()
        {
        }
        public static new TargetAssetUserSpecAgentConfigArgs Empty => new TargetAssetUserSpecAgentConfigArgs();
    }
}
