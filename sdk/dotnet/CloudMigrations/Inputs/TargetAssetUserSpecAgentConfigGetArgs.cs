...
namespace Pulumi.Oci.CloudMigrations.Inputs
{
    ...
    public sealed class TargetAssetUserSpecAgentConfigGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.TargetAssetUserSpecAgentConfigPluginsConfigGetArgs>? _pluginsConfigs;

        /// <summary>
        /// (Updatable) The configuration of plugins associated with this instance.
        /// </summary>
        public InputList<Inputs.TargetAssetUserSpecAgentConfigPluginsConfigGetArgs> PluginsConfigs
        {
            get => _pluginsConfigs ?? (_pluginsConfigs = new InputList<Inputs.TargetAssetUserSpecAgentConfigPluginsConfigGetArgs>());
            set => _pluginsConfigs = value;
        }

        public TargetAssetUserSpecAgentConfigGetArgs()
        {
        }
        public static new TargetAssetUserSpecAgentConfigGetArgs Empty => new TargetAssetUserSpecAgentConfigGetArgs();
    }
}
