...
namespace Pulumi.Oci.CloudMigrations.Outputs
{
    ...
    [OutputType]
    public sealed class GetTargetAssetRecommendedSpecInstanceOptionResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetTargetAssetRecommendedSpecInstanceOptionResult(bool areLegacyImdsEndpointsDisabled)
        {
