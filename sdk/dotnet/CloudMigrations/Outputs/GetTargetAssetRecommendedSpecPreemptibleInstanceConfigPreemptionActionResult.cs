...
namespace Pulumi.Oci.CloudMigrations.Outputs
{
    ...
    [OutputType]
    public sealed class GetTargetAssetRecommendedSpecPreemptibleInstanceConfigPreemptionActionResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetTargetAssetRecommendedSpecPreemptibleInstanceConfigPreemptionActionResult(
