...
namespace Pulumi.Oci.CloudMigrations.Outputs
{
    ...
    [OutputType]
    public sealed class GetTargetAssetTestSpecPreemptibleInstanceConfigPreemptionActionResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetTargetAssetTestSpecPreemptibleInstanceConfigPreemptionActionResult(
