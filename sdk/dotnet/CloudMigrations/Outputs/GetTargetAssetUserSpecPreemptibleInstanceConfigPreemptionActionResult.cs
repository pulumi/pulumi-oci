...
namespace Pulumi.Oci.CloudMigrations.Outputs
{
    ...
    [OutputType]
    public sealed class GetTargetAssetUserSpecPreemptibleInstanceConfigPreemptionActionResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetTargetAssetUserSpecPreemptibleInstanceConfigPreemptionActionResult(
