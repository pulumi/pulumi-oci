...
namespace Pulumi.Oci.CloudMigrations.Outputs
{
    ...
    [OutputType]
    public sealed class GetTargetAssetsTargetAssetCollectionItemUserSpecInstanceOptionResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetTargetAssetsTargetAssetCollectionItemUserSpecInstanceOptionResult(bool areLegacyImdsEndpointsDisabled)
        {
