...
namespace Pulumi.Oci.CloudMigrations.Outputs
{
    ...
    [OutputType]
    public sealed class TargetAssetEstimatedCost
    {
        /// <summary>
        /// Cost estimation for compute
        /// </summary>
        public readonly ImmutableArray<Outputs.TargetAssetEstimatedCostCompute> Computes;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.TargetAssetEstimatedCostOsImage> OsImages;
        /// <summary>
        /// Cost estimation for storage
        /// </summary>
        public readonly ImmutableArray<Outputs.TargetAssetEstimatedCostStorage> Storages;
        /// <summary>
        /// Subscription ID
        /// </summary>
        ...
        private TargetAssetEstimatedCost(
            ImmutableArray<Outputs.TargetAssetEstimatedCostCompute> computes,

            string? currencyCode,

            ImmutableArray<Outputs.TargetAssetEstimatedCostOsImage> osImages,

            ImmutableArray<Outputs.TargetAssetEstimatedCostStorage> storages,
