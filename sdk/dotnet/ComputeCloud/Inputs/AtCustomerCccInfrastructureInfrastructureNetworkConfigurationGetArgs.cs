...
namespace Pulumi.Oci.ComputeCloud.Inputs
{
    ...
    public sealed class AtCustomerCccInfrastructureInfrastructureNetworkConfigurationGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("dnsIps")]
        ...
        private InputList<Inputs.AtCustomerCccInfrastructureInfrastructureNetworkConfigurationInfrastructureRoutingDynamicGetArgs>? _infrastructureRoutingDynamics;

        /// <summary>
        /// Dynamic routing information for the Compute Cloud@Customer infrastructure.
        /// </summary>
        public InputList<Inputs.AtCustomerCccInfrastructureInfrastructureNetworkConfigurationInfrastructureRoutingDynamicGetArgs> InfrastructureRoutingDynamics
        {
            get => _infrastructureRoutingDynamics ?? (_infrastructureRoutingDynamics = new InputList<Inputs.AtCustomerCccInfrastructureInfrastructureNetworkConfigurationInfrastructureRoutingDynamicGetArgs>());
            set => _infrastructureRoutingDynamics = value;
        }

        [Input("infrastructureRoutingStatics")]
        private InputList<Inputs.AtCustomerCccInfrastructureInfrastructureNetworkConfigurationInfrastructureRoutingStaticGetArgs>? _infrastructureRoutingStatics;

        /// <summary>
        /// Static routing information for a rack.
        /// </summary>
        public InputList<Inputs.AtCustomerCccInfrastructureInfrastructureNetworkConfigurationInfrastructureRoutingStaticGetArgs> InfrastructureRoutingStatics
        {
            get => _infrastructureRoutingStatics ?? (_infrastructureRoutingStatics = new InputList<Inputs.AtCustomerCccInfrastructureInfrastructureNetworkConfigurationInfrastructureRoutingStaticGetArgs>());
            set => _infrastructureRoutingStatics = value;
        }

        [Input("managementNodes")]
        private InputList<Inputs.AtCustomerCccInfrastructureInfrastructureNetworkConfigurationManagementNodeGetArgs>? _managementNodes;

        /// <summary>
        /// Information about the management nodes that are provisioned in the Compute Cloud@Customer infrastructure.
        /// </summary>
        public InputList<Inputs.AtCustomerCccInfrastructureInfrastructureNetworkConfigurationManagementNodeGetArgs> ManagementNodes
        {
            get => _managementNodes ?? (_managementNodes = new InputList<Inputs.AtCustomerCccInfrastructureInfrastructureNetworkConfigurationManagementNodeGetArgs>());
        ...
        public AtCustomerCccInfrastructureInfrastructureNetworkConfigurationGetArgs()
        {
        }
        public static new AtCustomerCccInfrastructureInfrastructureNetworkConfigurationGetArgs Empty => new AtCustomerCccInfrastructureInfrastructureNetworkConfigurationGetArgs();
    }
}
