...
namespace Pulumi.Oci.ContainerEngine.Outputs
{
    ...
    [OutputType]
    public sealed class ClusterImagePolicyConfig
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.ClusterImagePolicyConfigKeyDetail> KeyDetails;

        [OutputConstructor]
        private ClusterImagePolicyConfig(
            bool? isPolicyEnabled,

            ImmutableArray<Outputs.ClusterImagePolicyConfigKeyDetail> keyDetails)
        {
