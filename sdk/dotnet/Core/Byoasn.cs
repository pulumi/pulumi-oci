...
namespace Pulumi.Oci.Core
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:Core/byoasn:Byoasn")]
    public partial class Byoasn : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("byoipRanges")]
        public Output<ImmutableArray<Outputs.ByoasnByoipRange>> ByoipRanges { get; private set; } = null!;
        ...
        public Byoasn(string name, ByoasnArgs args, CustomResourceOptions? options = null)
            : base("oci:Core/byoasn:Byoasn", name, args ?? new ByoasnArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Byoasn(string name, Input<string> id, ByoasnState? state = null, CustomResourceOptions? options = null)
            : base("oci:Core/byoasn:Byoasn", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static Byoasn Get(string name, Input<string> id, ByoasnState? state = null, CustomResourceOptions? options = null)
        {
            return new Byoasn(name, id, state, options);
        }
    }

    public sealed class ByoasnArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The Autonomous System Number (ASN) you are importing to the Oracle cloud.
        /// </summary>
        ...
        public static new ByoasnArgs Empty => new ByoasnArgs();
    }

    public sealed class ByoasnState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The Autonomous System Number (ASN) you are importing to the Oracle cloud.
        /// </summary>
        ...
        [Input("byoipRanges")]
        private InputList<Inputs.ByoasnByoipRangeGetArgs>? _byoipRanges;

        /// <summary>
        /// The BYOIP Ranges that has the `Byoasn` as origin.
        /// </summary>
        public InputList<Inputs.ByoasnByoipRangeGetArgs> ByoipRanges
        {
            get => _byoipRanges ?? (_byoipRanges = new InputList<Inputs.ByoasnByoipRangeGetArgs>());
            set => _byoipRanges = value;
        }
        ...
        public static new ByoasnState Empty => new ByoasnState();
    }
}
