...
namespace Pulumi.Oci.Core
{
    public static class GetPublicIp
    {
        ...
        public static Task<GetPublicIpResult> InvokeAsync(GetPublicIpArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPublicIpResult>("oci:Core/getPublicIp:getPublicIp", args ?? new GetPublicIpArgs(), options.WithDefaults());
        ...
        public static Output<GetPublicIpResult> Invoke(GetPublicIpInvokeArgs? args = null, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPublicIpResult>("oci:Core/getPublicIp:getPublicIp", args ?? new GetPublicIpInvokeArgs(), options.WithDefaults());
    }
