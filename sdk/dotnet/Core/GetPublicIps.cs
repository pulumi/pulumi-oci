...
namespace Pulumi.Oci.Core
{
    public static class GetPublicIps
    {
        ...
        public static Task<GetPublicIpsResult> InvokeAsync(GetPublicIpsArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetPublicIpsResult>("oci:Core/getPublicIps:getPublicIps", args ?? new GetPublicIpsArgs(), options.WithDefaults());
        ...
        public static Output<GetPublicIpsResult> Invoke(GetPublicIpsInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetPublicIpsResult>("oci:Core/getPublicIps:getPublicIps", args ?? new GetPublicIpsInvokeArgs(), options.WithDefaults());
    }
