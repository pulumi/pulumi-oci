...
namespace Pulumi.Oci.Core.Inputs
{
    ...
    public sealed class ClusterNetworkInstancePoolArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        public InputList<Inputs.ClusterNetworkInstancePoolLoadBalancerArgs> LoadBalancers
        {
            get => _loadBalancers ?? (_loadBalancers = new InputList<Inputs.ClusterNetworkInstancePoolLoadBalancerArgs>());
            set => _loadBalancers = value;
        }

        [Input("placementConfigurations")]
        private InputList<Inputs.ClusterNetworkInstancePoolPlacementConfigurationArgs>? _placementConfigurations;

        /// <summary>
        /// The placement configurations for the instance pool.
        /// </summary>
        public InputList<Inputs.ClusterNetworkInstancePoolPlacementConfigurationArgs> PlacementConfigurations
        {
            get => _placementConfigurations ?? (_placementConfigurations = new InputList<Inputs.ClusterNetworkInstancePoolPlacementConfigurationArgs>());
        ...
        public ClusterNetworkInstancePoolArgs()
        {
        }
        public static new ClusterNetworkInstancePoolArgs Empty => new ClusterNetworkInstancePoolArgs();
    }
}
