...
namespace Pulumi.Oci.Core.Inputs
{
    ...
    public sealed class DefaultSecurityListIngressSecurityRuleGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("icmpOptions")]
        public Input<Inputs.DefaultSecurityListIngressSecurityRuleIcmpOptionsGetArgs>? IcmpOptions { get; set; }
        ...
        [Input("tcpOptions")]
        public Input<Inputs.DefaultSecurityListIngressSecurityRuleTcpOptionsGetArgs>? TcpOptions { get; set; }

        [Input("udpOptions")]
        public Input<Inputs.DefaultSecurityListIngressSecurityRuleUdpOptionsGetArgs>? UdpOptions { get; set; }
