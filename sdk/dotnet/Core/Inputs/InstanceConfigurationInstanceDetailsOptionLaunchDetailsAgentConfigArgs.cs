...
namespace Pulumi.Oci.Core.Inputs
{
    ...
    public sealed class InstanceConfigurationInstanceDetailsOptionLaunchDetailsAgentConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.InstanceConfigurationInstanceDetailsOptionLaunchDetailsAgentConfigPluginsConfigArgs>? _pluginsConfigs;

        /// <summary>
        /// The configuration of plugins associated with this instance.
        /// </summary>
        public InputList<Inputs.InstanceConfigurationInstanceDetailsOptionLaunchDetailsAgentConfigPluginsConfigArgs> PluginsConfigs
        {
            get => _pluginsConfigs ?? (_pluginsConfigs = new InputList<Inputs.InstanceConfigurationInstanceDetailsOptionLaunchDetailsAgentConfigPluginsConfigArgs>());
            set => _pluginsConfigs = value;
        }

        public InstanceConfigurationInstanceDetailsOptionLaunchDetailsAgentConfigArgs()
        {
        }
        public static new InstanceConfigurationInstanceDetailsOptionLaunchDetailsAgentConfigArgs Empty => new InstanceConfigurationInstanceDetailsOptionLaunchDetailsAgentConfigArgs();
    }
}
