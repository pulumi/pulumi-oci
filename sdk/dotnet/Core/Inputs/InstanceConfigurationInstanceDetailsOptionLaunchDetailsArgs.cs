...
namespace Pulumi.Oci.Core.Inputs
{
    ...
    public sealed class InstanceConfigurationInstanceDetailsOptionLaunchDetailsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Configuration options for the Oracle Cloud Agent software running on the instance.
        /// </summary>
        [Input("agentConfig")]
        public Input<Inputs.InstanceConfigurationInstanceDetailsOptionLaunchDetailsAgentConfigArgs>? AgentConfig { get; set; }

        /// <summary>
        /// Options for defining the availabiity of a VM instance after a maintenance event that impacts the underlying hardware.
        /// </summary>
        [Input("availabilityConfig")]
        public Input<Inputs.InstanceConfigurationInstanceDetailsOptionLaunchDetailsAvailabilityConfigArgs>? AvailabilityConfig { get; set; }
        ...
        public Input<Inputs.InstanceConfigurationInstanceDetailsOptionLaunchDetailsCreateVnicDetailsArgs>? CreateVnicDetails { get; set; }
        ...
        public Input<Inputs.InstanceConfigurationInstanceDetailsOptionLaunchDetailsInstanceOptionsArgs>? InstanceOptions { get; set; }
        ...
        public Input<Inputs.InstanceConfigurationInstanceDetailsOptionLaunchDetailsPlacementConstraintDetailsArgs>? PlacementConstraintDetails { get; set; }

        /// <summary>
        /// The platform configuration requested for the instance.
        /// </summary>
        [Input("platformConfig")]
        public Input<Inputs.InstanceConfigurationInstanceDetailsOptionLaunchDetailsPlatformConfigArgs>? PlatformConfig { get; set; }

        /// <summary>
        /// Configuration options for preemptible instances.
        /// </summary>
        [Input("preemptibleInstanceConfig")]
        public Input<Inputs.InstanceConfigurationInstanceDetailsOptionLaunchDetailsPreemptibleInstanceConfigArgs>? PreemptibleInstanceConfig { get; set; }
        ...
        /// </summary>
        [Input("shapeConfig")]
        public Input<Inputs.InstanceConfigurationInstanceDetailsOptionLaunchDetailsShapeConfigArgs>? ShapeConfig { get; set; }

        [Input("sourceDetails")]
        public Input<Inputs.InstanceConfigurationInstanceDetailsOptionLaunchDetailsSourceDetailsArgs>? SourceDetails { get; set; }

        public InstanceConfigurationInstanceDetailsOptionLaunchDetailsArgs()
        {
        }
        public static new InstanceConfigurationInstanceDetailsOptionLaunchDetailsArgs Empty => new InstanceConfigurationInstanceDetailsOptionLaunchDetailsArgs();
    }
}
