...
namespace Pulumi.Oci.Core.Outputs
{
    ...
    [OutputType]
    public sealed class GetCaptureFiltersCaptureFilterFlowLogCaptureFilterRuleResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetCaptureFiltersCaptureFilterFlowLogCaptureFilterRuleIcmpOptionResult> IcmpOptions;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetCaptureFiltersCaptureFilterFlowLogCaptureFilterRuleTcpOptionResult> TcpOptions;
        /// <summary>
        /// Optional and valid only for UDP. Use to specify particular destination ports for UDP rules. If you specify UDP as the protocol but omit this object, then all destination ports are allowed.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetCaptureFiltersCaptureFilterFlowLogCaptureFilterRuleUdpOptionResult> UdpOptions;

        [OutputConstructor]
        private GetCaptureFiltersCaptureFilterFlowLogCaptureFilterRuleResult(
            string destinationCidr,

            string flowLogType,

            ImmutableArray<Outputs.GetCaptureFiltersCaptureFilterFlowLogCaptureFilterRuleIcmpOptionResult> icmpOptions,
            ...
            ImmutableArray<Outputs.GetCaptureFiltersCaptureFilterFlowLogCaptureFilterRuleTcpOptionResult> tcpOptions,

            ImmutableArray<Outputs.GetCaptureFiltersCaptureFilterFlowLogCaptureFilterRuleUdpOptionResult> udpOptions)
        {
