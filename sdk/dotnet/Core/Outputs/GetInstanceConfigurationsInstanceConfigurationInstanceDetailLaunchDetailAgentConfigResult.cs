...
namespace Pulumi.Oci.Core.Outputs
{
    ...
    [OutputType]
    public sealed class GetInstanceConfigurationsInstanceConfigurationInstanceDetailLaunchDetailAgentConfigResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetInstanceConfigurationsInstanceConfigurationInstanceDetailLaunchDetailAgentConfigPluginsConfigResult> PluginsConfigs;

        [OutputConstructor]
        private GetInstanceConfigurationsInstanceConfigurationInstanceDetailLaunchDetailAgentConfigResult(
            ...
            ImmutableArray<Outputs.GetInstanceConfigurationsInstanceConfigurationInstanceDetailLaunchDetailAgentConfigPluginsConfigResult> pluginsConfigs)
        {
