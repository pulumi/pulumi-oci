...
namespace Pulumi.Oci.Core.Outputs
{
    ...
    public sealed class GetSecurityListsSecurityListIngressSecurityRuleResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetSecurityListsSecurityListIngressSecurityRuleIcmpOptionResult> IcmpOptions;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetSecurityListsSecurityListIngressSecurityRuleTcpOptionResult> TcpOptions;
        /// <summary>
        /// Optional and valid only for UDP. Use to specify particular destination ports for UDP rules. If you specify UDP as the protocol but omit this object, then all destination ports are allowed. 
        /// * The following 2 attributes specify an inclusive range of allowed destination ports. Use the same number for the min and max to indicate a single port. Defaults to all ports if not specified.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetSecurityListsSecurityListIngressSecurityRuleUdpOptionResult> UdpOptions;

        [OutputConstructor]
        private GetSecurityListsSecurityListIngressSecurityRuleResult(
            string description,

            ImmutableArray<Outputs.GetSecurityListsSecurityListIngressSecurityRuleIcmpOptionResult> icmpOptions,
            ...
            ImmutableArray<Outputs.GetSecurityListsSecurityListIngressSecurityRuleTcpOptionResult> tcpOptions,

            ImmutableArray<Outputs.GetSecurityListsSecurityListIngressSecurityRuleUdpOptionResult> udpOptions)
        {
