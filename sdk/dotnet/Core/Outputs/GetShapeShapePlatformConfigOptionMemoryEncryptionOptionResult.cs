...
namespace Pulumi.Oci.Core.Outputs
{
    ...
    [OutputType]
    public sealed class GetShapeShapePlatformConfigOptionMemoryEncryptionOptionResult
    {
        public readonly ImmutableArray<bool> AllowedValues;
        public readonly bool IsDefaultEnabled;

        [OutputConstructor]
        private GetShapeShapePlatformConfigOptionMemoryEncryptionOptionResult(
