...
namespace Pulumi.Oci.Core.Outputs
{
    ...
    [OutputType]
    public sealed class GetShapeShapePlatformConfigOptionVirtualInstructionsOptionResult
    {
        public readonly ImmutableArray<bool> AllowedValues;
        public readonly bool? IsDefaultEnabled;

        [OutputConstructor]
        private GetShapeShapePlatformConfigOptionVirtualInstructionsOptionResult(
