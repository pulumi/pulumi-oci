...
namespace Pulumi.Oci.Core.Outputs
{
    ...
    [OutputType]
    public sealed class InstanceConfigurationInstanceDetailsLaunchDetailsInstanceOptions
    {
        /// <summary>
        ...
        [OutputConstructor]
        private InstanceConfigurationInstanceDetailsLaunchDetailsInstanceOptions(bool? areLegacyImdsEndpointsDisabled)
        {
