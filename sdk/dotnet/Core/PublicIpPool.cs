...
namespace Pulumi.Oci.Core
{
    ...
    public partial class PublicIpPool : global::Pulumi.CustomResource
    {
        ...
        public PublicIpPool(string name, PublicIpPoolArgs args, CustomResourceOptions? options = null)
            : base("oci:Core/publicIpPool:PublicIpPool", name, args ?? new PublicIpPoolArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PublicIpPool(string name, Input<string> id, PublicIpPoolState? state = null, CustomResourceOptions? options = null)
            : base("oci:Core/publicIpPool:PublicIpPool", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PublicIpPool Get(string name, Input<string> id, PublicIpPoolState? state = null, CustomResourceOptions? options = null)
        {
