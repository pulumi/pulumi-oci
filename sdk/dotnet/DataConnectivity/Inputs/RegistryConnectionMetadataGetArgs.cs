...
namespace Pulumi.Oci.DataConnectivity.Inputs
{
    ...
    public sealed class RegistryConnectionMetadataGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("aggregator")]
        public Input<Inputs.RegistryConnectionMetadataAggregatorGetArgs>? Aggregator { get; set; }
        ...
        public RegistryConnectionMetadataGetArgs()
        {
        }
        public static new RegistryConnectionMetadataGetArgs Empty => new RegistryConnectionMetadataGetArgs();
    }
}
