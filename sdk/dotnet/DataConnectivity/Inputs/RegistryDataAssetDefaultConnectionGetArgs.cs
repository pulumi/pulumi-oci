...
namespace Pulumi.Oci.DataConnectivity.Inputs
{
    ...
    public sealed class RegistryDataAssetDefaultConnectionGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("connectionProperties")]
        private InputList<Inputs.RegistryDataAssetDefaultConnectionConnectionPropertyGetArgs>? _connectionProperties;

        /// <summary>
        /// (Updatable) The properties of the connection.
        /// </summary>
        public InputList<Inputs.RegistryDataAssetDefaultConnectionConnectionPropertyGetArgs> ConnectionProperties
        {
            get => _connectionProperties ?? (_connectionProperties = new InputList<Inputs.RegistryDataAssetDefaultConnectionConnectionPropertyGetArgs>());
        ...
        /// </summary>
        [Input("metadata")]
        public Input<Inputs.RegistryDataAssetDefaultConnectionMetadataGetArgs>? Metadata { get; set; }
        ...
        /// </summary>
        [Input("primarySchema")]
        public Input<Inputs.RegistryDataAssetDefaultConnectionPrimarySchemaGetArgs>? PrimarySchema { get; set; }
        ...
        public Input<Inputs.RegistryDataAssetDefaultConnectionRegistryMetadataGetArgs>? RegistryMetadata { get; set; }
        ...
        public RegistryDataAssetDefaultConnectionGetArgs()
        {
        }
        public static new RegistryDataAssetDefaultConnectionGetArgs Empty => new RegistryDataAssetDefaultConnectionGetArgs();
    }
}
