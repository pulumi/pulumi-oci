...
namespace Pulumi.Oci.DataConnectivity.Inputs
{
    ...
    public sealed class RegistryDataAssetMetadataGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("aggregator")]
        public Input<Inputs.RegistryDataAssetMetadataAggregatorGetArgs>? Aggregator { get; set; }
        ...
        public RegistryDataAssetMetadataGetArgs()
        {
        }
        public static new RegistryDataAssetMetadataGetArgs Empty => new RegistryDataAssetMetadataGetArgs();
    }
}
