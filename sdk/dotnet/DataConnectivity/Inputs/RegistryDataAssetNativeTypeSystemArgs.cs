...
namespace Pulumi.Oci.DataConnectivity.Inputs
{
    ...
    public sealed class RegistryDataAssetNativeTypeSystemArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("parentRef")]
        public Input<Inputs.RegistryDataAssetNativeTypeSystemParentRefArgs>? ParentRef { get; set; }
        ...
        [Input("types")]
        private InputList<Inputs.RegistryDataAssetNativeTypeSystemTypeArgs>? _types;

        /// <summary>
        /// (Updatable) An array of types.
        /// </summary>
        public InputList<Inputs.RegistryDataAssetNativeTypeSystemTypeArgs> Types
        {
            get => _types ?? (_types = new InputList<Inputs.RegistryDataAssetNativeTypeSystemTypeArgs>());
            set => _types = value;
        }

        public RegistryDataAssetNativeTypeSystemArgs()
        {
        }
        public static new RegistryDataAssetNativeTypeSystemArgs Empty => new RegistryDataAssetNativeTypeSystemArgs();
    }
}
