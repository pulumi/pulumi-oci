...
namespace Pulumi.Oci.DataConnectivity.Inputs
{
    ...
    public sealed class RegistryDataAssetNativeTypeSystemGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("parentRef")]
        public Input<Inputs.RegistryDataAssetNativeTypeSystemParentRefGetArgs>? ParentRef { get; set; }
        ...
        [Input("types")]
        private InputList<Inputs.RegistryDataAssetNativeTypeSystemTypeGetArgs>? _types;

        /// <summary>
        /// (Updatable) An array of types.
        /// </summary>
        public InputList<Inputs.RegistryDataAssetNativeTypeSystemTypeGetArgs> Types
        {
            get => _types ?? (_types = new InputList<Inputs.RegistryDataAssetNativeTypeSystemTypeGetArgs>());
            set => _types = value;
        }
