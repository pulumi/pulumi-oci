...
namespace Pulumi.Oci.DataConnectivity.Inputs
{
    ...
    public sealed class RegistryFolderDataAssetNativeTypeSystemArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("parentRef")]
        public Input<Inputs.RegistryFolderDataAssetNativeTypeSystemParentRefArgs>? ParentRef { get; set; }
        ...
        [Input("types")]
        private InputList<Inputs.RegistryFolderDataAssetNativeTypeSystemTypeArgs>? _types;

        /// <summary>
        /// (Updatable) An array of types.
        /// </summary>
        public InputList<Inputs.RegistryFolderDataAssetNativeTypeSystemTypeArgs> Types
        {
            get => _types ?? (_types = new InputList<Inputs.RegistryFolderDataAssetNativeTypeSystemTypeArgs>());
            set => _types = value;
        }
