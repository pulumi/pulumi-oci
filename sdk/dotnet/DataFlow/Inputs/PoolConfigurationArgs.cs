...
namespace Pulumi.Oci.DataFlow.Inputs
{
    ...
    public sealed class PoolConfigurationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("shapeConfig")]
        public Input<Inputs.PoolConfigurationShapeConfigArgs>? ShapeConfig { get; set; }

        public PoolConfigurationArgs()
        {
        }
        public static new PoolConfigurationArgs Empty => new PoolConfigurationArgs();
    }
}
