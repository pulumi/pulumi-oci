...
namespace Pulumi.Oci.DataFlow.Inputs
{
    ...
    public sealed class PoolPoolMetricArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.PoolPoolMetricActivelyUsedNodeCountArgs>? _activelyUsedNodeCounts;

        /// <summary>
        /// A count of the nodes that are currently being used for each shape in this pool.
        /// </summary>
        public InputList<Inputs.PoolPoolMetricActivelyUsedNodeCountArgs> ActivelyUsedNodeCounts
        {
            get => _activelyUsedNodeCounts ?? (_activelyUsedNodeCounts = new InputList<Inputs.PoolPoolMetricActivelyUsedNodeCountArgs>());
        ...
        public PoolPoolMetricArgs()
        {
        }
        public static new PoolPoolMetricArgs Empty => new PoolPoolMetricArgs();
    }
}
