...
namespace Pulumi.Oci.DataFlow.Outputs
{
    ...
    [OutputType]
    public sealed class GetSqlEndpointsSqlEndpointCollectionItemNetworkConfigurationResult
    {
        /// <summary>
        /// A list of SecureAccessControlRule's to which access is limited to
        /// </summary>
        public readonly ImmutableArray<Outputs.GetSqlEndpointsSqlEndpointCollectionItemNetworkConfigurationAccessControlRuleResult> AccessControlRules;
        /// <summary>
