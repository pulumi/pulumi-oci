...
namespace Pulumi.Oci.DataFlow.Outputs
{
    ...
    [OutputType]
    public sealed class PoolPoolMetric
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.PoolPoolMetricActivelyUsedNodeCount> ActivelyUsedNodeCounts;
        /// <summary>
        ...
        [OutputConstructor]
        private PoolPoolMetric(
            string? activeRunsCount,

            ImmutableArray<Outputs.PoolPoolMetricActivelyUsedNodeCount> activelyUsedNodeCounts,
