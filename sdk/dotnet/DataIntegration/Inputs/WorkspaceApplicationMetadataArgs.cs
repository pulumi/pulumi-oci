...
namespace Pulumi.Oci.DataIntegration.Inputs
{
    ...
    public sealed class WorkspaceApplicationMetadataArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("aggregators")]
        private InputList<Inputs.WorkspaceApplicationMetadataAggregatorArgs>? _aggregators;

        /// <summary>
        /// A summary type containing information about the object's aggregator including its type, key, name and description.
        /// </summary>
        public InputList<Inputs.WorkspaceApplicationMetadataAggregatorArgs> Aggregators
        {
            get => _aggregators ?? (_aggregators = new InputList<Inputs.WorkspaceApplicationMetadataAggregatorArgs>());
            set => _aggregators = value;
        }

        [Input("countStatistics")]
        private InputList<Inputs.WorkspaceApplicationMetadataCountStatisticArgs>? _countStatistics;

        /// <summary>
        /// A count statistics.
        /// </summary>
        public InputList<Inputs.WorkspaceApplicationMetadataCountStatisticArgs> CountStatistics
        {
            get => _countStatistics ?? (_countStatistics = new InputList<Inputs.WorkspaceApplicationMetadataCountStatisticArgs>());
        ...
        public WorkspaceApplicationMetadataArgs()
        {
        }
        public static new WorkspaceApplicationMetadataArgs Empty => new WorkspaceApplicationMetadataArgs();
    }
}
