...
namespace Pulumi.Oci.DataIntegration.Inputs
{
    ...
    public sealed class WorkspaceApplicationTaskScheduleLastRunDetailArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("parentReves")]
        private InputList<Inputs.WorkspaceApplicationTaskScheduleLastRunDetailParentRefArgs>? _parentReves;

        /// <summary>
        /// (Updatable) A reference to the object's parent.
        /// </summary>
        public InputList<Inputs.WorkspaceApplicationTaskScheduleLastRunDetailParentRefArgs> ParentReves
        {
            get => _parentReves ?? (_parentReves = new InputList<Inputs.WorkspaceApplicationTaskScheduleLastRunDetailParentRefArgs>());
            set => _parentReves = value;
        }

        public WorkspaceApplicationTaskScheduleLastRunDetailArgs()
        {
        }
        public static new WorkspaceApplicationTaskScheduleLastRunDetailArgs Empty => new WorkspaceApplicationTaskScheduleLastRunDetailArgs();
    }
}
