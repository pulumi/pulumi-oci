...
namespace Pulumi.Oci.DataIntegration.Inputs
{
    ...
    public sealed class WorkspaceApplicationTaskScheduleMetadataArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("aggregators")]
        private InputList<Inputs.WorkspaceApplicationTaskScheduleMetadataAggregatorArgs>? _aggregators;
        ...
        /// </summary>
        public InputList<Inputs.WorkspaceApplicationTaskScheduleMetadataAggregatorArgs> Aggregators
        {
            get => _aggregators ?? (_aggregators = new InputList<Inputs.WorkspaceApplicationTaskScheduleMetadataAggregatorArgs>());
            set => _aggregators = value;
        }

        [Input("countStatistics")]
        private InputList<Inputs.WorkspaceApplicationTaskScheduleMetadataCountStatisticArgs>? _countStatistics;

        /// <summary>
        /// (Updatable) A count statistics.
        /// </summary>
        public InputList<Inputs.WorkspaceApplicationTaskScheduleMetadataCountStatisticArgs> CountStatistics
        {
            get => _countStatistics ?? (_countStatistics = new InputList<Inputs.WorkspaceApplicationTaskScheduleMetadataCountStatisticArgs>());
        ...
        public WorkspaceApplicationTaskScheduleMetadataArgs()
        {
        }
        public static new WorkspaceApplicationTaskScheduleMetadataArgs Empty => new WorkspaceApplicationTaskScheduleMetadataArgs();
    }
}
