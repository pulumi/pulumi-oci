...
namespace Pulumi.Oci.DataIntegration.Inputs
{
    ...
    public sealed class WorkspaceApplicationTaskScheduleMetadataGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("aggregators")]
        private InputList<Inputs.WorkspaceApplicationTaskScheduleMetadataAggregatorGetArgs>? _aggregators;
        ...
        /// </summary>
        public InputList<Inputs.WorkspaceApplicationTaskScheduleMetadataAggregatorGetArgs> Aggregators
        {
            get => _aggregators ?? (_aggregators = new InputList<Inputs.WorkspaceApplicationTaskScheduleMetadataAggregatorGetArgs>());
            set => _aggregators = value;
        }

        [Input("countStatistics")]
        private InputList<Inputs.WorkspaceApplicationTaskScheduleMetadataCountStatisticGetArgs>? _countStatistics;

        /// <summary>
        /// (Updatable) A count statistics.
        /// </summary>
        public InputList<Inputs.WorkspaceApplicationTaskScheduleMetadataCountStatisticGetArgs> CountStatistics
        {
            get => _countStatistics ?? (_countStatistics = new InputList<Inputs.WorkspaceApplicationTaskScheduleMetadataCountStatisticGetArgs>());
        ...
        public WorkspaceApplicationTaskScheduleMetadataGetArgs()
        {
        }
        public static new WorkspaceApplicationTaskScheduleMetadataGetArgs Empty => new WorkspaceApplicationTaskScheduleMetadataGetArgs();
    }
}
