...
namespace Pulumi.Oci.DataIntegration.Inputs
{
    ...
    public sealed class WorkspaceFolderMetadataArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("aggregators")]
        private InputList<Inputs.WorkspaceFolderMetadataAggregatorArgs>? _aggregators;

        /// <summary>
        /// A summary type containing information about the object's aggregator including its type, key, name and description.
        /// </summary>
        public InputList<Inputs.WorkspaceFolderMetadataAggregatorArgs> Aggregators
        {
            get => _aggregators ?? (_aggregators = new InputList<Inputs.WorkspaceFolderMetadataAggregatorArgs>());
            set => _aggregators = value;
        }

        [Input("countStatistics")]
        private InputList<Inputs.WorkspaceFolderMetadataCountStatisticArgs>? _countStatistics;

        /// <summary>
        /// A count statistics.
        /// </summary>
        public InputList<Inputs.WorkspaceFolderMetadataCountStatisticArgs> CountStatistics
        {
            get => _countStatistics ?? (_countStatistics = new InputList<Inputs.WorkspaceFolderMetadataCountStatisticArgs>());
        ...
        public WorkspaceFolderMetadataArgs()
        {
        }
        public static new WorkspaceFolderMetadataArgs Empty => new WorkspaceFolderMetadataArgs();
    }
}
