...
namespace Pulumi.Oci.DataIntegration.Inputs
{
    ...
    public sealed class WorkspaceTaskCancelRestCallConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) Configuration values can be string, objects, or parameters.
        /// </summary>
        [Input("configValues")]
        public Input<Inputs.WorkspaceTaskCancelRestCallConfigConfigValuesArgs>? ConfigValues { get; set; }
        ...
        public WorkspaceTaskCancelRestCallConfigArgs()
        {
        }
        public static new WorkspaceTaskCancelRestCallConfigArgs Empty => new WorkspaceTaskCancelRestCallConfigArgs();
    }
}
