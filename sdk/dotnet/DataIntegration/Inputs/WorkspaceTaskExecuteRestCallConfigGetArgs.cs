...
namespace Pulumi.Oci.DataIntegration.Inputs
{
    ...
    public sealed class WorkspaceTaskExecuteRestCallConfigGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) Configuration values can be string, objects, or parameters.
        /// </summary>
        [Input("configValues")]
        public Input<Inputs.WorkspaceTaskExecuteRestCallConfigConfigValuesGetArgs>? ConfigValues { get; set; }
        ...
        public WorkspaceTaskExecuteRestCallConfigGetArgs()
        {
        }
        public static new WorkspaceTaskExecuteRestCallConfigGetArgs Empty => new WorkspaceTaskExecuteRestCallConfigGetArgs();
    }
}
