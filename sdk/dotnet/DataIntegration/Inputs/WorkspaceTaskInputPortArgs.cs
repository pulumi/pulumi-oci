...
namespace Pulumi.Oci.DataIntegration.Inputs
{
    ...
    public sealed class WorkspaceTaskInputPortArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) Configuration values can be string, objects, or parameters.
        /// </summary>
        [Input("configValues")]
        public Input<Inputs.WorkspaceTaskInputPortConfigValuesArgs>? ConfigValues { get; set; }
        ...
        /// </summary>
        [Input("parentRef")]
        public Input<Inputs.WorkspaceTaskInputPortParentRefArgs>? ParentRef { get; set; }
        ...
        public WorkspaceTaskInputPortArgs()
        {
        }
        public static new WorkspaceTaskInputPortArgs Empty => new WorkspaceTaskInputPortArgs();
    }
}
