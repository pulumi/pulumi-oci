...
namespace Pulumi.Oci.DataIntegration.Inputs
{
    ...
    public sealed class WorkspaceTaskInputPortGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) Configuration values can be string, objects, or parameters.
        /// </summary>
        [Input("configValues")]
        public Input<Inputs.WorkspaceTaskInputPortConfigValuesGetArgs>? ConfigValues { get; set; }
        ...
        /// </summary>
        [Input("parentRef")]
        public Input<Inputs.WorkspaceTaskInputPortParentRefGetArgs>? ParentRef { get; set; }
        ...
        public WorkspaceTaskInputPortGetArgs()
        {
        }
        public static new WorkspaceTaskInputPortGetArgs Empty => new WorkspaceTaskInputPortGetArgs();
    }
}
