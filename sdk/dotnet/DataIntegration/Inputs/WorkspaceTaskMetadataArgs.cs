...
namespace Pulumi.Oci.DataIntegration.Inputs
{
    ...
    public sealed class WorkspaceTaskMetadataArgs : global::Pulumi.ResourceArgs
    {
        ...
        {
            get => _aggregators ?? (_aggregators = new InputList<Inputs.WorkspaceTaskMetadataAggregatorArgs>());
        ...
        {
            get => _countStatistics ?? (_countStatistics = new InputList<Inputs.WorkspaceTaskMetadataCountStatisticArgs>());
        ...
        public WorkspaceTaskMetadataArgs()
        {
        }
        public static new WorkspaceTaskMetadataArgs Empty => new WorkspaceTaskMetadataArgs();
    }
}
