...
namespace Pulumi.Oci.DataIntegration.Inputs
{
    ...
    public sealed class WorkspaceTaskOutputPortArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) Configuration values can be string, objects, or parameters.
        /// </summary>
        [Input("configValues")]
        public Input<Inputs.WorkspaceTaskOutputPortConfigValuesArgs>? ConfigValues { get; set; }
        ...
        /// </summary>
        [Input("parentRef")]
        public Input<Inputs.WorkspaceTaskOutputPortParentRefArgs>? ParentRef { get; set; }
        ...
        public WorkspaceTaskOutputPortArgs()
        {
        }
        public static new WorkspaceTaskOutputPortArgs Empty => new WorkspaceTaskOutputPortArgs();
    }
}
