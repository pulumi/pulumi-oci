...
namespace Pulumi.Oci.DataIntegration.Inputs
{
    ...
    public sealed class WorkspaceTaskPollRestCallConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) Configuration values can be string, objects, or parameters.
        /// </summary>
        [Input("configValues")]
        public Input<Inputs.WorkspaceTaskPollRestCallConfigConfigValuesArgs>? ConfigValues { get; set; }
        ...
        public WorkspaceTaskPollRestCallConfigArgs()
        {
        }
        public static new WorkspaceTaskPollRestCallConfigArgs Empty => new WorkspaceTaskPollRestCallConfigArgs();
    }
}
