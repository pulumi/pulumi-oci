...
namespace Pulumi.Oci.DataIntegration.Outputs
{
    ...
    [OutputType]
    public sealed class WorkspaceTaskPollRestCallConfig
    {
        /// <summary>
        /// (Updatable) Configuration values can be string, objects, or parameters.
        /// </summary>
        public readonly Outputs.WorkspaceTaskPollRestCallConfigConfigValues? ConfigValues;
        /// <summary>
        ...
        private WorkspaceTaskPollRestCallConfig(
            Outputs.WorkspaceTaskPollRestCallConfigConfigValues? configValues,
