...
namespace Pulumi.Oci.DataSafe
{
    public static class GetSqlFirewallViolationAnalytics
    {
        ...
        ///         AccessLevel = @var.Sql_firewall_violation_analytic_access_level,
        ///         CompartmentIdInSubtree = @var.Sql_firewall_violation_analytic_compartment_id_in_subtree,
        ///         GroupBies = @var.Sql_firewall_violation_analytic_group_by,
        ///         QueryTimeZone = @var.Sql_firewall_violation_analytic_query_time_zone,
        ///         ScimQuery = @var.Sql_firewall_violation_analytic_scim_query,
        ///         SummaryFields = @var.Sql_firewall_violation_analytic_summary_field,
        ///         TimeEnded = @var.Sql_firewall_violation_analytic_time_ended,
        ///         TimeStarted = @var.Sql_firewall_violation_analytic_time_started,
        ///     });
        /// 
        /// });
        /// ```
