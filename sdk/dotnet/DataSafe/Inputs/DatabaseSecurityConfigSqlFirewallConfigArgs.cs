...
namespace Pulumi.Oci.DataSafe.Inputs
{
    ...
    public sealed class DatabaseSecurityConfigSqlFirewallConfigArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public DatabaseSecurityConfigSqlFirewallConfigArgs()
        {
        }
        public static new DatabaseSecurityConfigSqlFirewallConfigArgs Empty => new DatabaseSecurityConfigSqlFirewallConfigArgs();
    }
}
