...
namespace Pulumi.Oci.DataSafe.Inputs
{
    ...
    public sealed class SecurityAssessmentCheckArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("references")]
        private InputList<Inputs.SecurityAssessmentCheckReferenceArgs>? _references;
        ...
        /// </summary>
        public InputList<Inputs.SecurityAssessmentCheckReferenceArgs> References
        {
            get => _references ?? (_references = new InputList<Inputs.SecurityAssessmentCheckReferenceArgs>());
