...
namespace Pulumi.Oci.DataSafe.Inputs
{
    ...
    public sealed class TargetDatabaseGroupMatchingCriteriaArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) Criteria to exclude certain target databases from the target database group.
        /// </summary>
        [Input("exclude")]
        public Input<Inputs.TargetDatabaseGroupMatchingCriteriaExcludeArgs>? Exclude { get; set; }
        ...
        public Input<Inputs.TargetDatabaseGroupMatchingCriteriaIncludeArgs> Include { get; set; } = null!;

        public TargetDatabaseGroupMatchingCriteriaArgs()
        {
        }
        public static new TargetDatabaseGroupMatchingCriteriaArgs Empty => new TargetDatabaseGroupMatchingCriteriaArgs();
    }
}
