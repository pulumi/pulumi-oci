...
namespace Pulumi.Oci.DataSafe.Outputs
{
    ...
    [OutputType]
    public sealed class GetSecurityPolicyConfigsSecurityPolicyConfigCollectionItemFirewallConfigResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetSecurityPolicyConfigsSecurityPolicyConfigCollectionItemFirewallConfigResult(
            string excludeJob,
