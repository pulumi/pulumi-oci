...
namespace Pulumi.Oci.DataSafe.Outputs
{
    ...
    [OutputType]
    public sealed class GetTargetDatabaseGroupMatchingCriteriaIncludeCompartmentResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetTargetDatabaseGroupMatchingCriteriaIncludeCompartmentResult(
            string id,
