...
namespace Pulumi.Oci.DataScience.Outputs
{
    ...
    [OutputType]
    public sealed class GetModelDeploymentModelDeploymentConfigurationDetailInfrastructureConfigurationDetailModelDeploymentResourceConfigurationResourceLimitConfigurationResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetModelDeploymentModelDeploymentConfigurationDetailInfrastructureConfigurationDetailModelDeploymentResourceConfigurationResourceLimitConfigurationResult(
            double memoryInGbs,
