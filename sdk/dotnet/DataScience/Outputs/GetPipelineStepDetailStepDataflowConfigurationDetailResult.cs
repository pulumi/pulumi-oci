...
namespace Pulumi.Oci.DataScience.Outputs
{
    ...
    [OutputType]
    public sealed class GetPipelineStepDetailStepDataflowConfigurationDetailResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetPipelineStepDetailStepDataflowConfigurationDetailDriverShapeConfigDetailResult> DriverShapeConfigDetails;
        /// <summary>
        ...
        /// Details for the pipeline step run shape configuration. Specify only when a flex shape is selected.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetPipelineStepDetailStepDataflowConfigurationDetailExecutorShapeConfigDetailResult> ExecutorShapeConfigDetails;
        /// <summary>
        ...
        [OutputConstructor]
        private GetPipelineStepDetailStepDataflowConfigurationDetailResult(
            ImmutableDictionary<string, string> configuration,

            string driverShape,

            ImmutableArray<Outputs.GetPipelineStepDetailStepDataflowConfigurationDetailDriverShapeConfigDetailResult> driverShapeConfigDetails,

            string executorShape,

            ImmutableArray<Outputs.GetPipelineStepDetailStepDataflowConfigurationDetailExecutorShapeConfigDetailResult> executorShapeConfigDetails,
