...
namespace Pulumi.Oci.DataScience.Outputs
{
    ...
    [OutputType]
    public sealed class GetPipelinesPipelineStepDetailStepDataflowConfigurationDetailResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetPipelinesPipelineStepDetailStepDataflowConfigurationDetailDriverShapeConfigDetailResult> DriverShapeConfigDetails;
        /// <summary>
        ...
        /// Details for the pipeline step run shape configuration. Specify only when a flex shape is selected.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetPipelinesPipelineStepDetailStepDataflowConfigurationDetailExecutorShapeConfigDetailResult> ExecutorShapeConfigDetails;
        /// <summary>
        ...
        [OutputConstructor]
        private GetPipelinesPipelineStepDetailStepDataflowConfigurationDetailResult(
            ImmutableDictionary<string, string> configuration,

            string driverShape,

            ImmutableArray<Outputs.GetPipelinesPipelineStepDetailStepDataflowConfigurationDetailDriverShapeConfigDetailResult> driverShapeConfigDetails,

            string executorShape,

            ImmutableArray<Outputs.GetPipelinesPipelineStepDetailStepDataflowConfigurationDetailExecutorShapeConfigDetailResult> executorShapeConfigDetails,
