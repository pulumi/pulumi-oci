...
namespace Pulumi.Oci.Database
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:Database/exadataInfrastructureConfigureExascaleManagement:ExadataInfrastructureConfigureExascaleManagement")]
    public partial class ExadataInfrastructureConfigureExascaleManagement : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("contacts")]
        public Output<ImmutableArray<Outputs.ExadataInfrastructureConfigureExascaleManagementContact>> Contacts { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.ExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfiguration>> DefinedFileSystemConfigurations { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.ExadataInfrastructureConfigureExascaleManagementExascaleConfig>> ExascaleConfigs { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.ExadataInfrastructureConfigureExascaleManagementMaintenanceWindow>> MaintenanceWindows { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.ExadataInfrastructureConfigureExascaleManagementNetworkBondingModeDetail>> NetworkBondingModeDetails { get; private set; } = null!;
        ...
        public ExadataInfrastructureConfigureExascaleManagement(string name, ExadataInfrastructureConfigureExascaleManagementArgs args, CustomResourceOptions? options = null)
            : base("oci:Database/exadataInfrastructureConfigureExascaleManagement:ExadataInfrastructureConfigureExascaleManagement", name, args ?? new ExadataInfrastructureConfigureExascaleManagementArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ExadataInfrastructureConfigureExascaleManagement(string name, Input<string> id, ExadataInfrastructureConfigureExascaleManagementState? state = null, CustomResourceOptions? options = null)
            : base("oci:Database/exadataInfrastructureConfigureExascaleManagement:ExadataInfrastructureConfigureExascaleManagement", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ExadataInfrastructureConfigureExascaleManagement Get(string name, Input<string> id, ExadataInfrastructureConfigureExascaleManagementState? state = null, CustomResourceOptions? options = null)
        {
            return new ExadataInfrastructureConfigureExascaleManagement(name, id, state, options);
        }
    }

    public sealed class ExadataInfrastructureConfigureExascaleManagementArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The Exadata infrastructure [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        /// </summary>
        ...
        public static new ExadataInfrastructureConfigureExascaleManagementArgs Empty => new ExadataInfrastructureConfigureExascaleManagementArgs();
    }

    public sealed class ExadataInfrastructureConfigureExascaleManagementState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The requested number of additional storage servers activated for the Exadata infrastructure.
        /// </summary>
        ...
        [Input("contacts")]
        private InputList<Inputs.ExadataInfrastructureConfigureExascaleManagementContactGetArgs>? _contacts;

        /// <summary>
        /// The list of contacts for the Exadata infrastructure.
        /// </summary>
        public InputList<Inputs.ExadataInfrastructureConfigureExascaleManagementContactGetArgs> Contacts
        {
            get => _contacts ?? (_contacts = new InputList<Inputs.ExadataInfrastructureConfigureExascaleManagementContactGetArgs>());
            set => _contacts = value;
        }
        ...
        private InputList<Inputs.ExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfigurationGetArgs>? _definedFileSystemConfigurations;

        /// <summary>
        /// Details of the file system configuration of the Exadata infrastructure.
        /// </summary>
        public InputList<Inputs.ExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfigurationGetArgs> DefinedFileSystemConfigurations
        {
            get => _definedFileSystemConfigurations ?? (_definedFileSystemConfigurations = new InputList<Inputs.ExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfigurationGetArgs>());
        ...
        private InputList<Inputs.ExadataInfrastructureConfigureExascaleManagementExascaleConfigGetArgs>? _exascaleConfigs;

        /// <summary>
        /// The exascale config response details for the Exadata Cloud@Customer infrastructure or cloud Exadata infrastructure . Applies to both Exadata Cloud@Customer instances and Exadata Cloud Service instances.
        /// </summary>
        public InputList<Inputs.ExadataInfrastructureConfigureExascaleManagementExascaleConfigGetArgs> ExascaleConfigs
        {
            get => _exascaleConfigs ?? (_exascaleConfigs = new InputList<Inputs.ExadataInfrastructureConfigureExascaleManagementExascaleConfigGetArgs>());
        ...
        private InputList<Inputs.ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowGetArgs>? _maintenanceWindows;

        /// <summary>
        /// The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        /// </summary>
        public InputList<Inputs.ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowGetArgs> MaintenanceWindows
        {
            get => _maintenanceWindows ?? (_maintenanceWindows = new InputList<Inputs.ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowGetArgs>());
        ...
        private InputList<Inputs.ExadataInfrastructureConfigureExascaleManagementNetworkBondingModeDetailGetArgs>? _networkBondingModeDetails;

        /// <summary>
        /// Details of bonding mode for Client and Backup and DR networks of an Exadata infrastructure.
        /// </summary>
        public InputList<Inputs.ExadataInfrastructureConfigureExascaleManagementNetworkBondingModeDetailGetArgs> NetworkBondingModeDetails
        {
            get => _networkBondingModeDetails ?? (_networkBondingModeDetails = new InputList<Inputs.ExadataInfrastructureConfigureExascaleManagementNetworkBondingModeDetailGetArgs>());
            set => _networkBondingModeDetails = value;
        }
        ...
        public static new ExadataInfrastructureConfigureExascaleManagementState Empty => new ExadataInfrastructureConfigureExascaleManagementState();
    }
}
