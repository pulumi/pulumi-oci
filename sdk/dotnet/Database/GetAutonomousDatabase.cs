...
namespace Pulumi.Oci.Database
{
    ...
    public sealed class GetAutonomousDatabaseResult
    {
        ...
        /// The URLs for accessing Oracle Application Express (APEX) and SQL Developer Web with a browser from a Compute instance within your VCN or that has a direct connection to your VCN. Note that these URLs are provided by the console only for databases on [dedicated Exadata infrastructure](https://docs.oracle.com/en/cloud/paas/autonomous-database/index.html).  Example: `{"sqlDevWebUrl": "https://&lt;hostname&gt;/ords...", "apexUrl", "https://&lt;hostname&gt;/ords..."}`
        /// </summary>
        public readonly ImmutableArray<Outputs.GetAutonomousDatabaseVanityConnectionUrlResult> VanityConnectionUrls;
        /// <summary>
        /// Details for api gateway and vanity url(custom url) for dbTools.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetAutonomousDatabaseVanityUrlDetailResult> VanityUrlDetails;
        /// <summary>
        ...
        private GetAutonomousDatabaseResult(
            ...
            ImmutableArray<Outputs.GetAutonomousDatabaseAutonomousDatabaseMaintenanceWindowResult> autonomousDatabaseMaintenanceWindows,
            ...
            ImmutableArray<Outputs.GetAutonomousDatabaseVanityConnectionUrlResult> vanityConnectionUrls,

            ImmutableArray<Outputs.GetAutonomousDatabaseVanityUrlDetailResult> vanityUrlDetails,
