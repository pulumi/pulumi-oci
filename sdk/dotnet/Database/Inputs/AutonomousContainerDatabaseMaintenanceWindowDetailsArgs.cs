...
namespace Pulumi.Oci.Database.Inputs
{
    ...
    public sealed class AutonomousContainerDatabaseMaintenanceWindowDetailsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("daysOfWeeks")]
        private InputList<Inputs.AutonomousContainerDatabaseMaintenanceWindowDetailsDaysOfWeekArgs>? _daysOfWeeks;

        /// <summary>
        /// (Updatable) Days during the week when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.AutonomousContainerDatabaseMaintenanceWindowDetailsDaysOfWeekArgs> DaysOfWeeks
        {
            get => _daysOfWeeks ?? (_daysOfWeeks = new InputList<Inputs.AutonomousContainerDatabaseMaintenanceWindowDetailsDaysOfWeekArgs>());
        ...
        [Input("months")]
        private InputList<Inputs.AutonomousContainerDatabaseMaintenanceWindowDetailsMonthArgs>? _months;

        /// <summary>
        /// (Updatable) Months during the year when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.AutonomousContainerDatabaseMaintenanceWindowDetailsMonthArgs> Months
        {
            get => _months ?? (_months = new InputList<Inputs.AutonomousContainerDatabaseMaintenanceWindowDetailsMonthArgs>());
            set => _months = value;
        }
        ...
        public AutonomousContainerDatabaseMaintenanceWindowDetailsArgs()
        {
        }
        public static new AutonomousContainerDatabaseMaintenanceWindowDetailsArgs Empty => new AutonomousContainerDatabaseMaintenanceWindowDetailsArgs();
    }
}
