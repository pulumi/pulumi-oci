...
namespace Pulumi.Oci.Database.Inputs
{
    ...
    public sealed class AutonomousExadataInfrastructureMaintenanceWindowArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("daysOfWeeks")]
        private InputList<Inputs.AutonomousExadataInfrastructureMaintenanceWindowDaysOfWeekArgs>? _daysOfWeeks;

        /// <summary>
        /// (Updatable) Days during the week when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.AutonomousExadataInfrastructureMaintenanceWindowDaysOfWeekArgs> DaysOfWeeks
        {
            get => _daysOfWeeks ?? (_daysOfWeeks = new InputList<Inputs.AutonomousExadataInfrastructureMaintenanceWindowDaysOfWeekArgs>());
        ...
        [Input("months")]
        private InputList<Inputs.AutonomousExadataInfrastructureMaintenanceWindowMonthArgs>? _months;

        /// <summary>
        /// (Updatable) Months during the year when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.AutonomousExadataInfrastructureMaintenanceWindowMonthArgs> Months
        {
            get => _months ?? (_months = new InputList<Inputs.AutonomousExadataInfrastructureMaintenanceWindowMonthArgs>());
            set => _months = value;
        }
        ...
        public AutonomousExadataInfrastructureMaintenanceWindowArgs()
        {
        }
        public static new AutonomousExadataInfrastructureMaintenanceWindowArgs Empty => new AutonomousExadataInfrastructureMaintenanceWindowArgs();
    }
}
