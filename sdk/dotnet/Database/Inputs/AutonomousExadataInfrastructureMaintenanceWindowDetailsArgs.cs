...
namespace Pulumi.Oci.Database.Inputs
{
    ...
    public sealed class AutonomousExadataInfrastructureMaintenanceWindowDetailsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("daysOfWeeks")]
        private InputList<Inputs.AutonomousExadataInfrastructureMaintenanceWindowDetailsDaysOfWeekArgs>? _daysOfWeeks;

        /// <summary>
        /// (Updatable) Days during the week when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.AutonomousExadataInfrastructureMaintenanceWindowDetailsDaysOfWeekArgs> DaysOfWeeks
        {
            get => _daysOfWeeks ?? (_daysOfWeeks = new InputList<Inputs.AutonomousExadataInfrastructureMaintenanceWindowDetailsDaysOfWeekArgs>());
        ...
        [Input("months")]
        private InputList<Inputs.AutonomousExadataInfrastructureMaintenanceWindowDetailsMonthArgs>? _months;

        /// <summary>
        /// (Updatable) Months during the year when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.AutonomousExadataInfrastructureMaintenanceWindowDetailsMonthArgs> Months
        {
            get => _months ?? (_months = new InputList<Inputs.AutonomousExadataInfrastructureMaintenanceWindowDetailsMonthArgs>());
            set => _months = value;
        }
        ...
        public AutonomousExadataInfrastructureMaintenanceWindowDetailsArgs()
        {
        }
        public static new AutonomousExadataInfrastructureMaintenanceWindowDetailsArgs Empty => new AutonomousExadataInfrastructureMaintenanceWindowDetailsArgs();
    }
}
