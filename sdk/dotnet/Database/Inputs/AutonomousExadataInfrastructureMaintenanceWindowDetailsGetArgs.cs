...
namespace Pulumi.Oci.Database.Inputs
{
    ...
    public sealed class AutonomousExadataInfrastructureMaintenanceWindowDetailsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("daysOfWeeks")]
        private InputList<Inputs.AutonomousExadataInfrastructureMaintenanceWindowDetailsDaysOfWeekGetArgs>? _daysOfWeeks;

        /// <summary>
        /// (Updatable) Days during the week when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.AutonomousExadataInfrastructureMaintenanceWindowDetailsDaysOfWeekGetArgs> DaysOfWeeks
        {
            get => _daysOfWeeks ?? (_daysOfWeeks = new InputList<Inputs.AutonomousExadataInfrastructureMaintenanceWindowDetailsDaysOfWeekGetArgs>());
        ...
        [Input("months")]
        private InputList<Inputs.AutonomousExadataInfrastructureMaintenanceWindowDetailsMonthGetArgs>? _months;

        /// <summary>
        /// (Updatable) Months during the year when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.AutonomousExadataInfrastructureMaintenanceWindowDetailsMonthGetArgs> Months
        {
            get => _months ?? (_months = new InputList<Inputs.AutonomousExadataInfrastructureMaintenanceWindowDetailsMonthGetArgs>());
            set => _months = value;
        }
        ...
        public AutonomousExadataInfrastructureMaintenanceWindowDetailsGetArgs()
        {
        }
        public static new AutonomousExadataInfrastructureMaintenanceWindowDetailsGetArgs Empty => new AutonomousExadataInfrastructureMaintenanceWindowDetailsGetArgs();
    }
}
