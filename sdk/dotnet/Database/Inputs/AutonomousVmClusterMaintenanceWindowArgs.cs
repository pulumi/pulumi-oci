...
namespace Pulumi.Oci.Database.Inputs
{
    ...
    public sealed class AutonomousVmClusterMaintenanceWindowArgs : global::Pulumi.ResourceArgs
    {
        [Input("customActionTimeoutInMins")]
        public Input<int>? CustomActionTimeoutInMins { get; set; }

        [Input("daysOfWeeks")]
        private InputList<Inputs.AutonomousVmClusterMaintenanceWindowDaysOfWeekArgs>? _daysOfWeeks;

        /// <summary>
        /// (Updatable) Days during the week when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.AutonomousVmClusterMaintenanceWindowDaysOfWeekArgs> DaysOfWeeks
        {
            get => _daysOfWeeks ?? (_daysOfWeeks = new InputList<Inputs.AutonomousVmClusterMaintenanceWindowDaysOfWeekArgs>());
        ...
        [Input("months")]
        private InputList<Inputs.AutonomousVmClusterMaintenanceWindowMonthArgs>? _months;

        /// <summary>
        /// (Updatable) Months during the year when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.AutonomousVmClusterMaintenanceWindowMonthArgs> Months
        {
            get => _months ?? (_months = new InputList<Inputs.AutonomousVmClusterMaintenanceWindowMonthArgs>());
            set => _months = value;
        }
        ...
        public AutonomousVmClusterMaintenanceWindowArgs()
        {
        }
        public static new AutonomousVmClusterMaintenanceWindowArgs Empty => new AutonomousVmClusterMaintenanceWindowArgs();
    }
}
