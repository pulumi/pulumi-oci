...
namespace Pulumi.Oci.Database.Inputs
{
    ...
    public sealed class AutonomousVmClusterMaintenanceWindowDetailArgs : global::Pulumi.ResourceArgs
    {
        [Input("customActionTimeoutInMins")]
        public Input<int>? CustomActionTimeoutInMins { get; set; }

        [Input("daysOfWeeks")]
        private InputList<Inputs.AutonomousVmClusterMaintenanceWindowDetailDaysOfWeekArgs>? _daysOfWeeks;

        /// <summary>
        /// (Updatable) Days during the week when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.AutonomousVmClusterMaintenanceWindowDetailDaysOfWeekArgs> DaysOfWeeks
        {
            get => _daysOfWeeks ?? (_daysOfWeeks = new InputList<Inputs.AutonomousVmClusterMaintenanceWindowDetailDaysOfWeekArgs>());
        ...
        [Input("months")]
        private InputList<Inputs.AutonomousVmClusterMaintenanceWindowDetailMonthArgs>? _months;

        /// <summary>
        /// (Updatable) Months during the year when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.AutonomousVmClusterMaintenanceWindowDetailMonthArgs> Months
        {
            get => _months ?? (_months = new InputList<Inputs.AutonomousVmClusterMaintenanceWindowDetailMonthArgs>());
            set => _months = value;
        }
        ...
        public AutonomousVmClusterMaintenanceWindowDetailArgs()
        {
        }
        public static new AutonomousVmClusterMaintenanceWindowDetailArgs Empty => new AutonomousVmClusterMaintenanceWindowDetailArgs();
    }
}
