...
namespace Pulumi.Oci.Database.Inputs
{
    ...
    public sealed class CloudAutonomousVmClusterMaintenanceWindowDetailsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("daysOfWeeks")]
        private InputList<Inputs.CloudAutonomousVmClusterMaintenanceWindowDetailsDaysOfWeekArgs>? _daysOfWeeks;

        /// <summary>
        /// (Updatable) Days during the week when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.CloudAutonomousVmClusterMaintenanceWindowDetailsDaysOfWeekArgs> DaysOfWeeks
        {
            get => _daysOfWeeks ?? (_daysOfWeeks = new InputList<Inputs.CloudAutonomousVmClusterMaintenanceWindowDetailsDaysOfWeekArgs>());
        ...
        [Input("months")]
        private InputList<Inputs.CloudAutonomousVmClusterMaintenanceWindowDetailsMonthArgs>? _months;

        /// <summary>
        /// (Updatable) Months during the year when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.CloudAutonomousVmClusterMaintenanceWindowDetailsMonthArgs> Months
        {
            get => _months ?? (_months = new InputList<Inputs.CloudAutonomousVmClusterMaintenanceWindowDetailsMonthArgs>());
            set => _months = value;
        }
        ...
        public CloudAutonomousVmClusterMaintenanceWindowDetailsArgs()
        {
        }
        public static new CloudAutonomousVmClusterMaintenanceWindowDetailsArgs Empty => new CloudAutonomousVmClusterMaintenanceWindowDetailsArgs();
    }
}
