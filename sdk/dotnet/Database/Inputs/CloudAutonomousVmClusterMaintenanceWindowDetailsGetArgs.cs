...
namespace Pulumi.Oci.Database.Inputs
{
    ...
    public sealed class CloudAutonomousVmClusterMaintenanceWindowDetailsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("daysOfWeeks")]
        private InputList<Inputs.CloudAutonomousVmClusterMaintenanceWindowDetailsDaysOfWeekGetArgs>? _daysOfWeeks;

        /// <summary>
        /// (Updatable) Days during the week when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.CloudAutonomousVmClusterMaintenanceWindowDetailsDaysOfWeekGetArgs> DaysOfWeeks
        {
            get => _daysOfWeeks ?? (_daysOfWeeks = new InputList<Inputs.CloudAutonomousVmClusterMaintenanceWindowDetailsDaysOfWeekGetArgs>());
        ...
        [Input("months")]
        private InputList<Inputs.CloudAutonomousVmClusterMaintenanceWindowDetailsMonthGetArgs>? _months;

        /// <summary>
        /// (Updatable) Months during the year when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.CloudAutonomousVmClusterMaintenanceWindowDetailsMonthGetArgs> Months
        {
            get => _months ?? (_months = new InputList<Inputs.CloudAutonomousVmClusterMaintenanceWindowDetailsMonthGetArgs>());
            set => _months = value;
        }
        ...
        public CloudAutonomousVmClusterMaintenanceWindowDetailsGetArgs()
        {
        }
        public static new CloudAutonomousVmClusterMaintenanceWindowDetailsGetArgs Empty => new CloudAutonomousVmClusterMaintenanceWindowDetailsGetArgs();
    }
}
