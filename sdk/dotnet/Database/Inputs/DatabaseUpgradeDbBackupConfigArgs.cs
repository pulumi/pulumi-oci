...
namespace Pulumi.Oci.Database.Inputs
{
    ...
    public sealed class DatabaseUpgradeDbBackupConfigArgs : Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.DatabaseUpgradeDbBackupConfigBackupDestinationDetailArgs>? _backupDestinationDetails;

        /// <summary>
        /// Backup destination details.
        /// </summary>
        public InputList<Inputs.DatabaseUpgradeDbBackupConfigBackupDestinationDetailArgs> BackupDestinationDetails
        {
            get => _backupDestinationDetails ?? (_backupDestinationDetails = new InputList<Inputs.DatabaseUpgradeDbBackupConfigBackupDestinationDetailArgs>());
