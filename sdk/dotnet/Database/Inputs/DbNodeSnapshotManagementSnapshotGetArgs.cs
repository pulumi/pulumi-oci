...
namespace Pulumi.Oci.Database.Inputs
{
    ...
    public sealed class DbNodeSnapshotManagementSnapshotGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("mountPoints")]
        private InputList<Inputs.DbNodeSnapshotManagementSnapshotMountPointGetArgs>? _mountPoints;

        /// <summary>
        /// Details of the mount points
        /// </summary>
        public InputList<Inputs.DbNodeSnapshotManagementSnapshotMountPointGetArgs> MountPoints
        {
            get => _mountPoints ?? (_mountPoints = new InputList<Inputs.DbNodeSnapshotManagementSnapshotMountPointGetArgs>());
        ...
        [Input("volumes")]
        private InputList<Inputs.DbNodeSnapshotManagementSnapshotVolumeGetArgs>? _volumes;

        /// <summary>
        /// Details of the volumes
        /// </summary>
        public InputList<Inputs.DbNodeSnapshotManagementSnapshotVolumeGetArgs> Volumes
        {
            get => _volumes ?? (_volumes = new InputList<Inputs.DbNodeSnapshotManagementSnapshotVolumeGetArgs>());
            set => _volumes = value;
        }

        public DbNodeSnapshotManagementSnapshotGetArgs()
        {
        }
        public static new DbNodeSnapshotManagementSnapshotGetArgs Empty => new DbNodeSnapshotManagementSnapshotGetArgs();
    }
}
