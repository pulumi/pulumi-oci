...
namespace Pulumi.Oci.Database.Inputs
{
    ...
    public sealed class DbSystemMaintenanceWindowArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("daysOfWeeks")]
        private InputList<Inputs.DbSystemMaintenanceWindowDaysOfWeekArgs>? _daysOfWeeks;

        /// <summary>
        /// (Updatable) Days during the week when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.DbSystemMaintenanceWindowDaysOfWeekArgs> DaysOfWeeks
        {
            get => _daysOfWeeks ?? (_daysOfWeeks = new InputList<Inputs.DbSystemMaintenanceWindowDaysOfWeekArgs>());
        ...
        [Input("months")]
        private InputList<Inputs.DbSystemMaintenanceWindowMonthArgs>? _months;

        /// <summary>
        /// (Updatable) Months during the year when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.DbSystemMaintenanceWindowMonthArgs> Months
        {
            get => _months ?? (_months = new InputList<Inputs.DbSystemMaintenanceWindowMonthArgs>());
            set => _months = value;
        }
        ...
        public DbSystemMaintenanceWindowArgs()
        {
        }
        public static new DbSystemMaintenanceWindowArgs Empty => new DbSystemMaintenanceWindowArgs();
    }
}
