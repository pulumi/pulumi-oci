...
namespace Pulumi.Oci.Database.Inputs
{
    ...
    public sealed class DbSystemMaintenanceWindowDetailsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("daysOfWeeks")]
        private InputList<Inputs.DbSystemMaintenanceWindowDetailsDaysOfWeekArgs>? _daysOfWeeks;

        /// <summary>
        /// (Updatable) Days during the week when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.DbSystemMaintenanceWindowDetailsDaysOfWeekArgs> DaysOfWeeks
        {
            get => _daysOfWeeks ?? (_daysOfWeeks = new InputList<Inputs.DbSystemMaintenanceWindowDetailsDaysOfWeekArgs>());
        ...
        [Input("months")]
        private InputList<Inputs.DbSystemMaintenanceWindowDetailsMonthArgs>? _months;

        /// <summary>
        /// (Updatable) Months during the year when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.DbSystemMaintenanceWindowDetailsMonthArgs> Months
        {
            get => _months ?? (_months = new InputList<Inputs.DbSystemMaintenanceWindowDetailsMonthArgs>());
            set => _months = value;
        }
        ...
        public DbSystemMaintenanceWindowDetailsArgs()
        {
        }
        public static new DbSystemMaintenanceWindowDetailsArgs Empty => new DbSystemMaintenanceWindowDetailsArgs();
    }
}
