...
namespace Pulumi.Oci.Database.Inputs
{
    ...
    public sealed class DbSystemMaintenanceWindowDetailsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("daysOfWeeks")]
        private InputList<Inputs.DbSystemMaintenanceWindowDetailsDaysOfWeekGetArgs>? _daysOfWeeks;

        /// <summary>
        /// (Updatable) Days during the week when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.DbSystemMaintenanceWindowDetailsDaysOfWeekGetArgs> DaysOfWeeks
        {
            get => _daysOfWeeks ?? (_daysOfWeeks = new InputList<Inputs.DbSystemMaintenanceWindowDetailsDaysOfWeekGetArgs>());
        ...
        [Input("months")]
        private InputList<Inputs.DbSystemMaintenanceWindowDetailsMonthGetArgs>? _months;

        /// <summary>
        /// (Updatable) Months during the year when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.DbSystemMaintenanceWindowDetailsMonthGetArgs> Months
        {
            get => _months ?? (_months = new InputList<Inputs.DbSystemMaintenanceWindowDetailsMonthGetArgs>());
            set => _months = value;
        }
        ...
        public DbSystemMaintenanceWindowDetailsGetArgs()
        {
        }
        public static new DbSystemMaintenanceWindowDetailsGetArgs Empty => new DbSystemMaintenanceWindowDetailsGetArgs();
    }
}
