...
namespace Pulumi.Oci.Database.Inputs
{
    ...
    public sealed class DbSystemMaintenanceWindowGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("daysOfWeeks")]
        private InputList<Inputs.DbSystemMaintenanceWindowDaysOfWeekGetArgs>? _daysOfWeeks;

        /// <summary>
        /// Days during the week when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.DbSystemMaintenanceWindowDaysOfWeekGetArgs> DaysOfWeeks
        {
            get => _daysOfWeeks ?? (_daysOfWeeks = new InputList<Inputs.DbSystemMaintenanceWindowDaysOfWeekGetArgs>());
        ...
        [Input("months")]
        private InputList<Inputs.DbSystemMaintenanceWindowMonthGetArgs>? _months;

        /// <summary>
        /// Months during the year when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.DbSystemMaintenanceWindowMonthGetArgs> Months
        {
            get => _months ?? (_months = new InputList<Inputs.DbSystemMaintenanceWindowMonthGetArgs>());
            set => _months = value;
        }
        ...
        public DbSystemMaintenanceWindowGetArgs()
        {
        }
        public static new DbSystemMaintenanceWindowGetArgs Empty => new DbSystemMaintenanceWindowGetArgs();
    }
}
