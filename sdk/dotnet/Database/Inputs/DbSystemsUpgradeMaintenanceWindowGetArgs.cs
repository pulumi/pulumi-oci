...
namespace Pulumi.Oci.Database.Inputs
{
    ...
    public sealed class DbSystemsUpgradeMaintenanceWindowGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        public InputList<Inputs.DbSystemsUpgradeMaintenanceWindowDaysOfWeekGetArgs> DaysOfWeeks
        {
            get => _daysOfWeeks ?? (_daysOfWeeks = new InputList<Inputs.DbSystemsUpgradeMaintenanceWindowDaysOfWeekGetArgs>());
        ...
        [Input("months")]
        private InputList<Inputs.DbSystemsUpgradeMaintenanceWindowMonthGetArgs>? _months;

        /// <summary>
        /// Months during the year when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.DbSystemsUpgradeMaintenanceWindowMonthGetArgs> Months
        {
            get => _months ?? (_months = new InputList<Inputs.DbSystemsUpgradeMaintenanceWindowMonthGetArgs>());
            set => _months = value;
        }
