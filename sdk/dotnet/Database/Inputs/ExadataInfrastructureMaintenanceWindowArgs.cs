...
namespace Pulumi.Oci.Database.Inputs
{
    ...
    public sealed class ExadataInfrastructureMaintenanceWindowArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("daysOfWeeks")]
        private InputList<Inputs.ExadataInfrastructureMaintenanceWindowDaysOfWeekArgs>? _daysOfWeeks;

        /// <summary>
        /// (Updatable) Days during the week when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.ExadataInfrastructureMaintenanceWindowDaysOfWeekArgs> DaysOfWeeks
        {
            get => _daysOfWeeks ?? (_daysOfWeeks = new InputList<Inputs.ExadataInfrastructureMaintenanceWindowDaysOfWeekArgs>());
        ...
        [Input("months")]
        private InputList<Inputs.ExadataInfrastructureMaintenanceWindowMonthArgs>? _months;

        /// <summary>
        /// (Updatable) Months during the year when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.ExadataInfrastructureMaintenanceWindowMonthArgs> Months
        {
            get => _months ?? (_months = new InputList<Inputs.ExadataInfrastructureMaintenanceWindowMonthArgs>());
            set => _months = value;
        }
        ...
        public ExadataInfrastructureMaintenanceWindowArgs()
        {
        }
        public static new ExadataInfrastructureMaintenanceWindowArgs Empty => new ExadataInfrastructureMaintenanceWindowArgs();
    }
}
