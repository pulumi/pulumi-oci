...
namespace Pulumi.Oci.Database.Inputs
{
    ...
    public sealed class ExadataInfrastructureMaintenanceWindowGetArgs : Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("daysOfWeeks")]
        private InputList<Inputs.ExadataInfrastructureMaintenanceWindowDaysOfWeekGetArgs>? _daysOfWeeks;

        /// <summary>
        /// (Updatable) Days during the week when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.ExadataInfrastructureMaintenanceWindowDaysOfWeekGetArgs> DaysOfWeeks
        {
            get => _daysOfWeeks ?? (_daysOfWeeks = new InputList<Inputs.ExadataInfrastructureMaintenanceWindowDaysOfWeekGetArgs>());
        ...
        [Input("months")]
        private InputList<Inputs.ExadataInfrastructureMaintenanceWindowMonthGetArgs>? _months;

        /// <summary>
        /// (Updatable) Months during the year when maintenance should be performed.
        /// </summary>
        public InputList<Inputs.ExadataInfrastructureMaintenanceWindowMonthGetArgs> Months
        {
            get => _months ?? (_months = new InputList<Inputs.ExadataInfrastructureMaintenanceWindowMonthGetArgs>());
            set => _months = value;
        }
