...
namespace Pulumi.Oci.Database.Inputs
{
    ...
    public sealed class SchedulingPolicySchedulingWindowWindowPreferenceArgs : global::Pulumi.ResourceArgs
    {
        [Input("daysOfWeeks", required: true)]
        private InputList<Inputs.SchedulingPolicySchedulingWindowWindowPreferenceDaysOfWeekArgs>? _daysOfWeeks;

        /// <summary>
        /// (Updatable) Days during the week when scheduling window should be performed.
        /// </summary>
        public InputList<Inputs.SchedulingPolicySchedulingWindowWindowPreferenceDaysOfWeekArgs> DaysOfWeeks
        {
            get => _daysOfWeeks ?? (_daysOfWeeks = new InputList<Inputs.SchedulingPolicySchedulingWindowWindowPreferenceDaysOfWeekArgs>());
        ...
        private InputList<Inputs.SchedulingPolicySchedulingWindowWindowPreferenceMonthArgs>? _months;

        /// <summary>
        /// (Updatable) Months during the year when scheduled window should be performed.
        /// </summary>
        public InputList<Inputs.SchedulingPolicySchedulingWindowWindowPreferenceMonthArgs> Months
        {
            get => _months ?? (_months = new InputList<Inputs.SchedulingPolicySchedulingWindowWindowPreferenceMonthArgs>());
            set => _months = value;
        }
        ...
        public SchedulingPolicySchedulingWindowWindowPreferenceArgs()
        {
        }
        public static new SchedulingPolicySchedulingWindowWindowPreferenceArgs Empty => new SchedulingPolicySchedulingWindowWindowPreferenceArgs();
    }
}
