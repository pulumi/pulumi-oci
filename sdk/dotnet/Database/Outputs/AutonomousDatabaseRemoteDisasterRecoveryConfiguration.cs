...
namespace Pulumi.Oci.Database.Outputs
{
    ...
    [OutputType]
    public sealed class AutonomousDatabaseRemoteDisasterRecoveryConfiguration
    {
        /// <summary>
        ...
        [OutputConstructor]
        private AutonomousDatabaseRemoteDisasterRecoveryConfiguration(string? disasterRecoveryType)
        {
