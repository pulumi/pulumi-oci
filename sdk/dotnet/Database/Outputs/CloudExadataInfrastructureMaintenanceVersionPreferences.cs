...
namespace Pulumi.Oci.Database.Outputs
{
    ...
    [OutputType]
    public sealed class CloudExadataInfrastructureMaintenanceVersionPreferences
    {
        /// <summary>
        ...
        [OutputConstructor]
        private CloudExadataInfrastructureMaintenanceVersionPreferences(string? referenceResourceIdForImageUpdates)
        {
