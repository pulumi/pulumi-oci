...
namespace Pulumi.Oci.Database.Outputs
{
    ...
    [OutputType]
    public sealed class ExadataInfrastructureMaintenanceVersionPreferences
    {
        /// <summary>
        ...
        [OutputConstructor]
        private ExadataInfrastructureMaintenanceVersionPreferences(string? referenceResourceIdForImageUpdates)
        {
