...
namespace Pulumi.Oci.Database.Outputs
{
    ...
    [OutputType]
    public sealed class GetCloudExadataInfrastructureMaintenanceVersionPreferenceResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetCloudExadataInfrastructureMaintenanceVersionPreferenceResult(string referenceResourceIdForImageUpdates)
        {
