...
namespace Pulumi.Oci.Database.Outputs
{
    ...
    [OutputType]
    public sealed class GetCloudExadataInfrastructuresCloudExadataInfrastructureMaintenanceVersionPreferenceResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetCloudExadataInfrastructuresCloudExadataInfrastructureMaintenanceVersionPreferenceResult(string referenceResourceIdForImageUpdates)
        {
