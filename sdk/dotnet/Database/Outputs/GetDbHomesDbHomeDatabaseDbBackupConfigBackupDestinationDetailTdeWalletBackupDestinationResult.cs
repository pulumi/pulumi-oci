...
namespace Pulumi.Oci.Database.Outputs
{
    ...
    [OutputType]
    public sealed class GetDbHomesDbHomeDatabaseDbBackupConfigBackupDestinationDetailTdeWalletBackupDestinationResult
    {
        public readonly string BackupDestinationId;
        public readonly string BackupDestinationType;

        [OutputConstructor]
        private GetDbHomesDbHomeDatabaseDbBackupConfigBackupDestinationDetailTdeWalletBackupDestinationResult(
