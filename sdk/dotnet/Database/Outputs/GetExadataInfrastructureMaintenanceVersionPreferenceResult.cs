...
namespace Pulumi.Oci.Database.Outputs
{
    ...
    [OutputType]
    public sealed class GetExadataInfrastructureMaintenanceVersionPreferenceResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetExadataInfrastructureMaintenanceVersionPreferenceResult(string referenceResourceIdForImageUpdates)
        {
