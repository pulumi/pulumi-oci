...
namespace Pulumi.Oci.Database
{
    ...
    public partial class PluggableDatabasesRemoteClone : global::Pulumi.CustomResource
    {
        ...
        public Output<ImmutableArray<Outputs.PluggableDatabasesRemoteCloneConnectionString>> ConnectionStrings { get; private set; } = null!;
        ...
        /// </summary>
        [Output("sourceContainerDbAdminPassword")]
        public Output<string> SourceContainerDbAdminPassword { get; private set; } = null!;
        ...
        /// </summary>
        [Output("targetContainerDatabaseId")]
        public Output<string> TargetContainerDatabaseId { get; private set; } = null!;
        ...
        public PluggableDatabasesRemoteClone(string name, PluggableDatabasesRemoteCloneArgs args, CustomResourceOptions? options = null)
            : base("oci:Database/pluggableDatabasesRemoteClone:PluggableDatabasesRemoteClone", name, args ?? new PluggableDatabasesRemoteCloneArgs(), MakeResourceOptions(options, ""))
        {
        }

        private PluggableDatabasesRemoteClone(string name, Input<string> id, PluggableDatabasesRemoteCloneState? state = null, CustomResourceOptions? options = null)
            : base("oci:Database/pluggableDatabasesRemoteClone:PluggableDatabasesRemoteClone", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static PluggableDatabasesRemoteClone Get(string name, Input<string> id, PluggableDatabasesRemoteCloneState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class PluggableDatabasesRemoteCloneState : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.PluggableDatabasesRemoteCloneConnectionStringGetArgs>? _connectionStrings;

        /// <summary>
        /// Connection strings to connect to an Oracle Pluggable Database.
        /// </summary>
        public InputList<Inputs.PluggableDatabasesRemoteCloneConnectionStringGetArgs> ConnectionStrings
        {
            get => _connectionStrings ?? (_connectionStrings = new InputList<Inputs.PluggableDatabasesRemoteCloneConnectionStringGetArgs>());
