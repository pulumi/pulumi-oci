...
namespace Pulumi.Oci.Database
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:Database/schedulingPolicy:SchedulingPolicy")]
    public partial class SchedulingPolicy : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("cadenceStartMonth")]
        public Output<Outputs.SchedulingPolicyCadenceStartMonth> CadenceStartMonth { get; private set; } = null!;
        ...
        /// </summary>
        [Output("timeNextWindowStarts")]
        public Output<string> TimeNextWindowStarts { get; private set; } = null!;
        ...
        public SchedulingPolicy(string name, SchedulingPolicyArgs args, CustomResourceOptions? options = null)
            : base("oci:Database/schedulingPolicy:SchedulingPolicy", name, args ?? new SchedulingPolicyArgs(), MakeResourceOptions(options, ""))
        {
        }

        private SchedulingPolicy(string name, Input<string> id, SchedulingPolicyState? state = null, CustomResourceOptions? options = null)
            : base("oci:Database/schedulingPolicy:SchedulingPolicy", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class SchedulingPolicyArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// (Updatable) The cadence period.
        /// </summary>
        [Input("cadence", required: true)]
        public Input<string> Cadence { get; set; } = null!;

        /// <summary>
        /// (Updatable) Start of the month to be followed during the cadence period.
        /// </summary>
        [Input("cadenceStartMonth")]
        public Input<Inputs.SchedulingPolicyCadenceStartMonthArgs>? CadenceStartMonth { get; set; }
    ...
    public sealed class SchedulingPolicyState : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("cadenceStartMonth")]
        public Input<Inputs.SchedulingPolicyCadenceStartMonthGetArgs>? CadenceStartMonth { get; set; }
        ...
        /// The date and time of the next scheduling window associated with the schedulingPolicy is planned to start.
        /// </summary>
        [Input("timeNextWindowStarts")]
        public Input<string>? TimeNextWindowStarts { get; set; }
