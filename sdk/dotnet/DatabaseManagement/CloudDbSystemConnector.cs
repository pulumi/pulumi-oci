...
namespace Pulumi.Oci.DatabaseManagement
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:DatabaseManagement/cloudDbSystemConnector:CloudDbSystemConnector")]
    public partial class CloudDbSystemConnector : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.CloudDbSystemConnectorConnectionInfo>> ConnectionInfos { get; private set; } = null!;
        ...
        public CloudDbSystemConnector(string name, CloudDbSystemConnectorArgs args, CustomResourceOptions? options = null)
            : base("oci:DatabaseManagement/cloudDbSystemConnector:CloudDbSystemConnector", name, args ?? new CloudDbSystemConnectorArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudDbSystemConnector(string name, Input<string> id, CloudDbSystemConnectorState? state = null, CustomResourceOptions? options = null)
            : base("oci:DatabaseManagement/cloudDbSystemConnector:CloudDbSystemConnector", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CloudDbSystemConnector Get(string name, Input<string> id, CloudDbSystemConnectorState? state = null, CustomResourceOptions? options = null)
        {
            return new CloudDbSystemConnector(name, id, state, options);
        }
    }

    public sealed class CloudDbSystemConnectorArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management agent used for the cloud DB system connector.
        /// </summary>
        ...
        private InputList<Inputs.CloudDbSystemConnectorConnectionInfoArgs>? _connectionInfos;

        /// <summary>
        /// The connection details required to connect to a cloud DB system component.
        /// </summary>
        public InputList<Inputs.CloudDbSystemConnectorConnectionInfoArgs> ConnectionInfos
        {
            get => _connectionInfos ?? (_connectionInfos = new InputList<Inputs.CloudDbSystemConnectorConnectionInfoArgs>());
        ...
        public CloudDbSystemConnectorArgs()
        {
        }
        public static new CloudDbSystemConnectorArgs Empty => new CloudDbSystemConnectorArgs();
    }

    public sealed class CloudDbSystemConnectorState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management agent used for the cloud DB system connector.
        /// </summary>
        ...
        [Input("connectionInfos")]
        private InputList<Inputs.CloudDbSystemConnectorConnectionInfoGetArgs>? _connectionInfos;

        /// <summary>
        /// The connection details required to connect to a cloud DB system component.
        /// </summary>
        public InputList<Inputs.CloudDbSystemConnectorConnectionInfoGetArgs> ConnectionInfos
        {
            get => _connectionInfos ?? (_connectionInfos = new InputList<Inputs.CloudDbSystemConnectorConnectionInfoGetArgs>());
            set => _connectionInfos = value;
        }
        ...
        public CloudDbSystemConnectorState()
        {
        }
        public static new CloudDbSystemConnectorState Empty => new CloudDbSystemConnectorState();
    }
}
