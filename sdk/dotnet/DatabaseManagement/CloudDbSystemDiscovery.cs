...
namespace Pulumi.Oci.DatabaseManagement
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:DatabaseManagement/cloudDbSystemDiscovery:CloudDbSystemDiscovery")]
    public partial class CloudDbSystemDiscovery : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        [Output("cloudDbSystemDiscoveryId")]
        public Output<string> CloudDbSystemDiscoveryId { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.CloudDbSystemDiscoveryDiscoveredComponent>> DiscoveredComponents { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.CloudDbSystemDiscoveryPatchOperation>> PatchOperations { get; private set; } = null!;
        ...
        public CloudDbSystemDiscovery(string name, CloudDbSystemDiscoveryArgs args, CustomResourceOptions? options = null)
            : base("oci:DatabaseManagement/cloudDbSystemDiscovery:CloudDbSystemDiscovery", name, args ?? new CloudDbSystemDiscoveryArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudDbSystemDiscovery(string name, Input<string> id, CloudDbSystemDiscoveryState? state = null, CustomResourceOptions? options = null)
            : base("oci:DatabaseManagement/cloudDbSystemDiscovery:CloudDbSystemDiscovery", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CloudDbSystemDiscovery Get(string name, Input<string> id, CloudDbSystemDiscoveryState? state = null, CustomResourceOptions? options = null)
        {
            return new CloudDbSystemDiscovery(name, id, state, options);
        }
    }

    public sealed class CloudDbSystemDiscoveryArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management agent used for the cloud DB system discovery.
        /// </summary>
        ...
        private InputList<Inputs.CloudDbSystemDiscoveryPatchOperationArgs>? _patchOperations;

        /// <summary>
        /// (Updatable)
        /// </summary>
        public InputList<Inputs.CloudDbSystemDiscoveryPatchOperationArgs> PatchOperations
        {
            get => _patchOperations ?? (_patchOperations = new InputList<Inputs.CloudDbSystemDiscoveryPatchOperationArgs>());
            set => _patchOperations = value;
        }

        public CloudDbSystemDiscoveryArgs()
        {
        }
        public static new CloudDbSystemDiscoveryArgs Empty => new CloudDbSystemDiscoveryArgs();
    }

    public sealed class CloudDbSystemDiscoveryState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management agent used for the cloud DB system discovery.
        /// </summary>
        ...
        [Input("cloudDbSystemDiscoveryId")]
        public Input<string>? CloudDbSystemDiscoveryId { get; set; }
        ...
        private InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentGetArgs>? _discoveredComponents;

        /// <summary>
        /// The list of DB system components that were found in the DB system discovery.
        /// </summary>
        public InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentGetArgs> DiscoveredComponents
        {
            get => _discoveredComponents ?? (_discoveredComponents = new InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentGetArgs>());
        ...
        [Input("patchOperations")]
        private InputList<Inputs.CloudDbSystemDiscoveryPatchOperationGetArgs>? _patchOperations;

        /// <summary>
        /// (Updatable)
        /// </summary>
        public InputList<Inputs.CloudDbSystemDiscoveryPatchOperationGetArgs> PatchOperations
        {
            get => _patchOperations ?? (_patchOperations = new InputList<Inputs.CloudDbSystemDiscoveryPatchOperationGetArgs>());
            set => _patchOperations = value;
        }
        ...
        public CloudDbSystemDiscoveryState()
        {
        }
        public static new CloudDbSystemDiscoveryState Empty => new CloudDbSystemDiscoveryState();
    }
}
