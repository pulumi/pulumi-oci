...
namespace Pulumi.Oci.DatabaseManagement
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:DatabaseManagement/cloudExadataStorageServer:CloudExadataStorageServer")]
    public partial class CloudExadataStorageServer : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("cloudExadataStorageServerId")]
        public Output<string> CloudExadataStorageServerId { get; private set; } = null!;

        /// <summary>
        /// The connector of the Exadata storage server.
        /// </summary>
        [Output("connectors")]
        public Output<ImmutableArray<Outputs.CloudExadataStorageServerConnector>> Connectors { get; private set; } = null!;
        ...
        public CloudExadataStorageServer(string name, CloudExadataStorageServerArgs args, CustomResourceOptions? options = null)
            : base("oci:DatabaseManagement/cloudExadataStorageServer:CloudExadataStorageServer", name, args ?? new CloudExadataStorageServerArgs(), MakeResourceOptions(options, ""))
        {
        }

        private CloudExadataStorageServer(string name, Input<string> id, CloudExadataStorageServerState? state = null, CustomResourceOptions? options = null)
            : base("oci:DatabaseManagement/cloudExadataStorageServer:CloudExadataStorageServer", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static CloudExadataStorageServer Get(string name, Input<string> id, CloudExadataStorageServerState? state = null, CustomResourceOptions? options = null)
        {
            return new CloudExadataStorageServer(name, id, state, options);
        }
    }

    public sealed class CloudExadataStorageServerArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata storage server.
        /// </summary>
        ...
        public CloudExadataStorageServerArgs()
        {
        }
        public static new CloudExadataStorageServerArgs Empty => new CloudExadataStorageServerArgs();
    }

    public sealed class CloudExadataStorageServerState : global::Pulumi.ResourceArgs
    {
        ...
        /// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata storage server.
        /// </summary>
        [Input("cloudExadataStorageServerId")]
        public Input<string>? CloudExadataStorageServerId { get; set; }

        [Input("connectors")]
        private InputList<Inputs.CloudExadataStorageServerConnectorGetArgs>? _connectors;

        /// <summary>
        /// The connector of the Exadata storage server.
        /// </summary>
        public InputList<Inputs.CloudExadataStorageServerConnectorGetArgs> Connectors
        {
            get => _connectors ?? (_connectors = new InputList<Inputs.CloudExadataStorageServerConnectorGetArgs>());
        ...
        public CloudExadataStorageServerState()
        {
        }
        public static new CloudExadataStorageServerState Empty => new CloudExadataStorageServerState();
    }
}
