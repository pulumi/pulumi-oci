...
namespace Pulumi.Oci.DatabaseManagement
{
    public static class GetManagedDatabaseUserProxiedForUser
    {
        ...
        public static Task<GetManagedDatabaseUserProxiedForUserResult> InvokeAsync(GetManagedDatabaseUserProxiedForUserArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.InvokeAsync<GetManagedDatabaseUserProxiedForUserResult>("oci:DatabaseManagement/getManagedDatabaseUserProxiedForUser:getManagedDatabaseUserProxiedForUser", args ?? new GetManagedDatabaseUserProxiedForUserArgs(), options.WithDefaults());
        ...
        public static Output<GetManagedDatabaseUserProxiedForUserResult> Invoke(GetManagedDatabaseUserProxiedForUserInvokeArgs args, InvokeOptions? options = null)
            => Pulumi.Deployment.Instance.Invoke<GetManagedDatabaseUserProxiedForUserResult>("oci:DatabaseManagement/getManagedDatabaseUserProxiedForUser:getManagedDatabaseUserProxiedForUser", args ?? new GetManagedDatabaseUserProxiedForUserInvokeArgs(), options.WithDefaults());
    }
