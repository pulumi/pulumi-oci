...
namespace Pulumi.Oci.DatabaseManagement.Inputs
{
    ...
    public sealed class CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfoArgs>? _connectionInfos;

        /// <summary>
        /// The connection details required to connect to a cloud DB system component.
        /// </summary>
        public InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfoArgs> ConnectionInfos
        {
            get => _connectionInfos ?? (_connectionInfos = new InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfoArgs>());
        ...
        public CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs()
        {
        }
        public static new CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs Empty => new CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs();
    }
}
