...
namespace Pulumi.Oci.DatabaseManagement.Inputs
{
    ...
    public sealed class CloudDbSystemDiscoveryDiscoveredComponentGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("asmInstances")]
        private InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentAsmInstanceGetArgs>? _asmInstances;

        /// <summary>
        /// The list of asm instances for the cloud Asm.
        /// </summary>
        public InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentAsmInstanceGetArgs> AsmInstances
        {
            get => _asmInstances ?? (_asmInstances = new InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentAsmInstanceGetArgs>());
            set => _asmInstances = value;
        }

        [Input("associatedComponents")]
        private InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentAssociatedComponentGetArgs>? _associatedComponents;

        /// <summary>
        /// The list of associated components.
        /// </summary>
        public InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentAssociatedComponentGetArgs> AssociatedComponents
        {
            get => _associatedComponents ?? (_associatedComponents = new InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentAssociatedComponentGetArgs>());
        ...
        private InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceGetArgs>? _clusterInstances;

        /// <summary>
        /// The list of cluster instances for the cloud cluster.
        /// </summary>
        public InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceGetArgs> ClusterInstances
        {
            get => _clusterInstances ?? (_clusterInstances = new InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceGetArgs>());
        ...
        [Input("connectors")]
        private InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentConnectorGetArgs>? _connectors;

        /// <summary>
        /// The connector details used to connect to the cloud DB system component.
        /// </summary>
        public InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentConnectorGetArgs> Connectors
        {
            get => _connectors ?? (_connectors = new InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentConnectorGetArgs>());
        ...
        [Input("dbInstances")]
        private InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentDbInstanceGetArgs>? _dbInstances;

        /// <summary>
        /// The list of database instances.
        /// </summary>
        public InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentDbInstanceGetArgs> DbInstances
        {
            get => _dbInstances ?? (_dbInstances = new InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentDbInstanceGetArgs>());
        ...
        [Input("endpoints")]
        private InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentEndpointGetArgs>? _endpoints;

        /// <summary>
        /// The list of protocol addresses the listener is configured to listen on.
        /// </summary>
        public InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentEndpointGetArgs> Endpoints
        {
            get => _endpoints ?? (_endpoints = new InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentEndpointGetArgs>());
        ...
        private InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentNetworkConfigurationGetArgs>? _networkConfigurations;

        /// <summary>
        /// The list of network address configurations of the cloud cluster.
        /// </summary>
        public InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentNetworkConfigurationGetArgs> NetworkConfigurations
        {
            get => _networkConfigurations ?? (_networkConfigurations = new InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentNetworkConfigurationGetArgs>());
        ...
        private InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentPluggableDatabaseGetArgs>? _pluggableDatabases;

        /// <summary>
        /// The list of Pluggable Databases.
        /// </summary>
        public InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentPluggableDatabaseGetArgs> PluggableDatabases
        {
            get => _pluggableDatabases ?? (_pluggableDatabases = new InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentPluggableDatabaseGetArgs>());
        ...
        private InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentScanConfigurationGetArgs>? _scanConfigurations;

        /// <summary>
        /// The list of Single Client Access Name (SCAN) configurations of the cloud cluster.
        /// </summary>
        public InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentScanConfigurationGetArgs> ScanConfigurations
        {
            get => _scanConfigurations ?? (_scanConfigurations = new InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentScanConfigurationGetArgs>());
        ...
        private InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentVipConfigurationGetArgs>? _vipConfigurations;

        /// <summary>
        /// The list of Virtual IP (VIP) configurations of the cloud cluster.
        /// </summary>
        public InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentVipConfigurationGetArgs> VipConfigurations
        {
            get => _vipConfigurations ?? (_vipConfigurations = new InputList<Inputs.CloudDbSystemDiscoveryDiscoveredComponentVipConfigurationGetArgs>());
            set => _vipConfigurations = value;
        }

        public CloudDbSystemDiscoveryDiscoveredComponentGetArgs()
        {
        }
        public static new CloudDbSystemDiscoveryDiscoveredComponentGetArgs Empty => new CloudDbSystemDiscoveryDiscoveredComponentGetArgs();
    }
}
