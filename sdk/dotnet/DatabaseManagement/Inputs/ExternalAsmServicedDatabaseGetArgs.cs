...
namespace Pulumi.Oci.DatabaseManagement.Inputs
{
    ...
    public sealed class ExternalAsmServicedDatabaseGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("diskGroups")]
        private InputList<string>? _diskGroups;

        /// <summary>
        /// The list of ASM disk groups used by the database.
        /// </summary>
        public InputList<string> DiskGroups
        {
            get => _diskGroups ?? (_diskGroups = new InputList<string>());
        ...
        public ExternalAsmServicedDatabaseGetArgs()
        {
        }
        public static new ExternalAsmServicedDatabaseGetArgs Empty => new ExternalAsmServicedDatabaseGetArgs();
    }
}
