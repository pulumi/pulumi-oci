...
namespace Pulumi.Oci.DatabaseManagement.Inputs
{
    ...
    public sealed class ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("connectors")]
        private InputList<Inputs.ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs>? _connectors;

        /// <summary>
        /// The connector details used to connect to the external DB system component.
        /// </summary>
        public InputList<Inputs.ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs> Connectors
        {
            get => _connectors ?? (_connectors = new InputList<Inputs.ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs>());
        ...
        public ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceArgs()
        {
        }
        public static new ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceArgs Empty => new ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceArgs();
    }
}
