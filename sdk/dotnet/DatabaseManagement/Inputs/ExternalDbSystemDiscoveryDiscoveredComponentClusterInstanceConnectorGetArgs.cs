...
namespace Pulumi.Oci.DatabaseManagement.Inputs
{
    ...
    public sealed class ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfoGetArgs>? _connectionInfos;

        /// <summary>
        /// The connection details required to connect to an external DB system component.
        /// </summary>
        public InputList<Inputs.ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfoGetArgs> ConnectionInfos
        {
            get => _connectionInfos ?? (_connectionInfos = new InputList<Inputs.ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfoGetArgs>());
        ...
        public ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorGetArgs()
        {
        }
        public static new ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorGetArgs Empty => new ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorGetArgs();
    }
}
