...
namespace Pulumi.Oci.DatabaseManagement.Inputs
{
    ...
    public sealed class ExternalDbSystemDiscoveryDiscoveredComponentConnectorArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.ExternalDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfoArgs>? _connectionInfos;

        /// <summary>
        /// The connection details required to connect to an external DB system component.
        /// </summary>
        public InputList<Inputs.ExternalDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfoArgs> ConnectionInfos
        {
            get => _connectionInfos ?? (_connectionInfos = new InputList<Inputs.ExternalDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfoArgs>());
        ...
        public ExternalDbSystemDiscoveryDiscoveredComponentConnectorArgs()
        {
        }
        public static new ExternalDbSystemDiscoveryDiscoveredComponentConnectorArgs Empty => new ExternalDbSystemDiscoveryDiscoveredComponentConnectorArgs();
    }
}
