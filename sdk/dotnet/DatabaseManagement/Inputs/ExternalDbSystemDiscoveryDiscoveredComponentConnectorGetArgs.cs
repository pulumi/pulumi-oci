...
namespace Pulumi.Oci.DatabaseManagement.Inputs
{
    ...
    public sealed class ExternalDbSystemDiscoveryDiscoveredComponentConnectorGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.ExternalDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfoGetArgs>? _connectionInfos;

        /// <summary>
        /// The connection details required to connect to an external DB system component.
        /// </summary>
        public InputList<Inputs.ExternalDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfoGetArgs> ConnectionInfos
        {
            get => _connectionInfos ?? (_connectionInfos = new InputList<Inputs.ExternalDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfoGetArgs>());
        ...
        public ExternalDbSystemDiscoveryDiscoveredComponentConnectorGetArgs()
        {
        }
        public static new ExternalDbSystemDiscoveryDiscoveredComponentConnectorGetArgs Empty => new ExternalDbSystemDiscoveryDiscoveredComponentConnectorGetArgs();
    }
}
