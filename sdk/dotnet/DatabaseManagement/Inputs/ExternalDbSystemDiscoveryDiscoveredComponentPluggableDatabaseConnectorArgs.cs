...
namespace Pulumi.Oci.DatabaseManagement.Inputs
{
    ...
    public sealed class ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorConnectionInfoArgs>? _connectionInfos;

        /// <summary>
        /// The connection details required to connect to an external DB system component.
        /// </summary>
        public InputList<Inputs.ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorConnectionInfoArgs> ConnectionInfos
        {
            get => _connectionInfos ?? (_connectionInfos = new InputList<Inputs.ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorConnectionInfoArgs>());
        ...
        public ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorArgs()
        {
        }
        public static new ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorArgs Empty => new ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorArgs();
    }
}
