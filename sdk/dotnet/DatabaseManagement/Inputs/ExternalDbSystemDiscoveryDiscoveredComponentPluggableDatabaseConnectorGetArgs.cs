...
namespace Pulumi.Oci.DatabaseManagement.Inputs
{
    ...
    public sealed class ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorConnectionInfoGetArgs>? _connectionInfos;

        /// <summary>
        /// The connection details required to connect to an external DB system component.
        /// </summary>
        public InputList<Inputs.ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorConnectionInfoGetArgs> ConnectionInfos
        {
            get => _connectionInfos ?? (_connectionInfos = new InputList<Inputs.ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorConnectionInfoGetArgs>());
        ...
        public ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorGetArgs()
        {
        }
        public static new ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorGetArgs Empty => new ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorGetArgs();
    }
}
