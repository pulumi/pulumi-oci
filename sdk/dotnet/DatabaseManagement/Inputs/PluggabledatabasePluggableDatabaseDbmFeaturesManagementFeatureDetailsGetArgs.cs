...
namespace Pulumi.Oci.DatabaseManagement.Inputs
{
    ...
    public sealed class PluggabledatabasePluggableDatabaseDbmFeaturesManagementFeatureDetailsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.PluggabledatabasePluggableDatabaseDbmFeaturesManagementFeatureDetailsConnectorDetailsGetArgs>? ConnectorDetails { get; set; }

        /// <summary>
        /// The connection details required to connect to the database.
        /// </summary>
        [Input("databaseConnectionDetails")]
        public Input<Inputs.PluggabledatabasePluggableDatabaseDbmFeaturesManagementFeatureDetailsDatabaseConnectionDetailsGetArgs>? DatabaseConnectionDetails { get; set; }
        ...
        public PluggabledatabasePluggableDatabaseDbmFeaturesManagementFeatureDetailsGetArgs()
        {
        }
        public static new PluggabledatabasePluggableDatabaseDbmFeaturesManagementFeatureDetailsGetArgs Empty => new PluggabledatabasePluggableDatabaseDbmFeaturesManagementFeatureDetailsGetArgs();
    }
}
