...
namespace Pulumi.Oci.DatabaseManagement.Outputs
{
    ...
    [OutputType]
    public sealed class GetCloudDbSystemConnectorsCloudDbSystemConnectorCollectionItemConnectionInfoConnectionStringResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetCloudDbSystemConnectorsCloudDbSystemConnectorCollectionItemConnectionInfoConnectionStringResult(
            string hostName,
