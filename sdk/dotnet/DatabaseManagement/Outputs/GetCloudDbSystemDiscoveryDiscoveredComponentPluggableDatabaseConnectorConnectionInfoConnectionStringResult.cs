...
namespace Pulumi.Oci.DatabaseManagement.Outputs
{
    ...
    [OutputType]
    public sealed class GetCloudDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorConnectionInfoConnectionStringResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetCloudDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorConnectionInfoConnectionStringResult(
            string hostName,
