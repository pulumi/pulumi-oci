...
namespace Pulumi.Oci.DatabaseManagement.Outputs
{
    ...
    [OutputType]
    public sealed class GetCloudDbSystemDiscoveryDiscoveredComponentVipConfigurationResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetCloudDbSystemDiscoveryDiscoveredComponentVipConfigurationResult(
            string address,
