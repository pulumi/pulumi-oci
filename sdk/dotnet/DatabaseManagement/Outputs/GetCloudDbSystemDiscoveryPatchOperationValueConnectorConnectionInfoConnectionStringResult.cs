...
namespace Pulumi.Oci.DatabaseManagement.Outputs
{
    ...
    [OutputType]
    public sealed class GetCloudDbSystemDiscoveryPatchOperationValueConnectorConnectionInfoConnectionStringResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetCloudDbSystemDiscoveryPatchOperationValueConnectorConnectionInfoConnectionStringResult(
            string hostName,
