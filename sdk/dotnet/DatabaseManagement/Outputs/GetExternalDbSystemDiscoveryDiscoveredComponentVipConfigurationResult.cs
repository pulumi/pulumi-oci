...
namespace Pulumi.Oci.DatabaseManagement.Outputs
{
    ...
    [OutputType]
    public sealed class GetExternalDbSystemDiscoveryDiscoveredComponentVipConfigurationResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetExternalDbSystemDiscoveryDiscoveredComponentVipConfigurationResult(
            string address,
