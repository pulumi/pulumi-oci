...
namespace Pulumi.Oci.DatabaseMigration.Inputs
{
    ...
    public sealed class MigrationDataTransferMediumDetailsArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("source")]
        public Input<Inputs.MigrationDataTransferMediumDetailsSourceArgs>? Source { get; set; }

        /// <summary>
        /// (Updatable) Optional additional properties for dump transfer in source or target host. Default kind is CURL.
        /// </summary>
        [Input("target")]
        public Input<Inputs.MigrationDataTransferMediumDetailsTargetArgs>? Target { get; set; }
