...
namespace Pulumi.Oci.DatabaseMigration.Inputs
{
    ...
    public sealed class MigrationGoldenGateDetailsSettingsArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("extract")]
        public Input<Inputs.MigrationGoldenGateDetailsSettingsExtractArgs>? Extract { get; set; }

        /// <summary>
        /// (Updatable) Parameters for GoldenGate Replicat processes.
        /// </summary>
        [Input("replicat")]
        public Input<Inputs.MigrationGoldenGateDetailsSettingsReplicatArgs>? Replicat { get; set; }
