...
namespace Pulumi.Oci.DatabaseTools.Outputs
{
    ...
    [OutputType]
    public sealed class GetDatabaseToolsDatabaseApiGatewayConfigsDatabaseToolsDatabaseApiGatewayConfigCollectionItemLockResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetDatabaseToolsDatabaseApiGatewayConfigsDatabaseToolsDatabaseApiGatewayConfigCollectionItemLockResult(
            string message,
