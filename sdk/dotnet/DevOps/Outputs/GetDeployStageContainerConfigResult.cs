...
namespace Pulumi.Oci.DevOps.Outputs
{
    ...
    [OutputType]
    public sealed class GetDeployStageContainerConfigResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDeployStageContainerConfigNetworkChannelResult> NetworkChannels;
        /// <summary>
        /// Determines the size and amount of resources available to the instance.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDeployStageContainerConfigShapeConfigResult> ShapeConfigs;
        /// <summary>
