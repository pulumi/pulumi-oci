...
namespace Pulumi.Oci.DisasterRecovery.Outputs
{
    ...
    [OutputType]
    public sealed class DrProtectionGroupMemberBlockVolumeOperationAttachmentDetails
    {
        /// <summary>
        ...
        [OutputConstructor]
        private DrProtectionGroupMemberBlockVolumeOperationAttachmentDetails(string? volumeAttachmentReferenceInstanceId)
        {
