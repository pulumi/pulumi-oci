...
namespace Pulumi.Oci.Dns.Inputs
{
    ...
    public sealed class SteeringPolicyRuleArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        public InputList<Inputs.SteeringPolicyRuleCaseArgs> Cases
        {
            get => _cases ?? (_cases = new InputList<Inputs.SteeringPolicyRuleCaseArgs>());
            set => _cases = value;
        }

        [Input("defaultAnswerDatas")]
        private InputList<Inputs.SteeringPolicyRuleDefaultAnswerDataArgs>? _defaultAnswerDatas;
        ...
        /// </summary>
        public InputList<Inputs.SteeringPolicyRuleDefaultAnswerDataArgs> DefaultAnswerDatas
        {
            get => _defaultAnswerDatas ?? (_defaultAnswerDatas = new InputList<Inputs.SteeringPolicyRuleDefaultAnswerDataArgs>());
