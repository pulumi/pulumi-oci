...
namespace Pulumi.Oci.FleetAppsManagement
{
    ...
    public partial class CompliancePolicyRule : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("patchTypes")]
        public Output<ImmutableArray<string>> PatchTypes { get; private set; } = null!;
    ...
    public sealed class CompliancePolicyRuleArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("patchTypes", required: true)]
        private InputList<string>? _patchTypes;

        /// <summary>
        /// (Updatable) PlatformConfiguration OCID for the patch type to which this CompliancePolicyRule applies.
        /// </summary>
        public InputList<string> PatchTypes
        {
            get => _patchTypes ?? (_patchTypes = new InputList<string>());
