...
namespace Pulumi.Oci.FleetAppsManagement.Inputs
{
    ...
    public sealed class OnboardingItemGetArgs : global::Pulumi.ResourceArgs
    {
        [Input("appliedPolicies")]
        private InputList<Inputs.OnboardingItemAppliedPolicyGetArgs>? _appliedPolicies;

        /// <summary>
        /// Summary of the Fleet Application Management Onboard Policy.
        /// </summary>
        public InputList<Inputs.OnboardingItemAppliedPolicyGetArgs> AppliedPolicies
        {
            get => _appliedPolicies ?? (_appliedPolicies = new InputList<Inputs.OnboardingItemAppliedPolicyGetArgs>());
        ...
        public OnboardingItemGetArgs()
        {
        }
        public static new OnboardingItemGetArgs Empty => new OnboardingItemGetArgs();
    }
}
