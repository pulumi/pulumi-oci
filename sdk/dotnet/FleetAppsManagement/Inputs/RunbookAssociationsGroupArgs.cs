...
namespace Pulumi.Oci.FleetAppsManagement.Inputs
{
    ...
    public sealed class RunbookAssociationsGroupArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.RunbookAssociationsGroupPropertiesArgs>? Properties { get; set; }
        ...
        public RunbookAssociationsGroupArgs()
        {
        }
        public static new RunbookAssociationsGroupArgs Empty => new RunbookAssociationsGroupArgs();
    }
}
