...
namespace Pulumi.Oci.FleetAppsManagement.Inputs
{
    ...
    public sealed class RunbookAssociationsGroupPropertiesArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.RunbookAssociationsGroupPropertiesNotificationPreferencesArgs>? NotificationPreferences { get; set; }

        /// <summary>
        /// (Updatable) Pause Details
        /// </summary>
        [Input("pauseDetails")]
        public Input<Inputs.RunbookAssociationsGroupPropertiesPauseDetailsArgs>? PauseDetails { get; set; }
        ...
        public RunbookAssociationsGroupPropertiesArgs()
        {
        }
        public static new RunbookAssociationsGroupPropertiesArgs Empty => new RunbookAssociationsGroupPropertiesArgs();
    }
}
