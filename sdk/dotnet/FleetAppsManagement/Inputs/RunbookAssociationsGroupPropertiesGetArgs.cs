...
namespace Pulumi.Oci.FleetAppsManagement.Inputs
{
    ...
    public sealed class RunbookAssociationsGroupPropertiesGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.RunbookAssociationsGroupPropertiesNotificationPreferencesGetArgs>? NotificationPreferences { get; set; }

        /// <summary>
        /// (Updatable) Pause Details
        /// </summary>
        [Input("pauseDetails")]
        public Input<Inputs.RunbookAssociationsGroupPropertiesPauseDetailsGetArgs>? PauseDetails { get; set; }
        ...
        public RunbookAssociationsGroupPropertiesGetArgs()
        {
        }
        public static new RunbookAssociationsGroupPropertiesGetArgs Empty => new RunbookAssociationsGroupPropertiesGetArgs();
    }
}
