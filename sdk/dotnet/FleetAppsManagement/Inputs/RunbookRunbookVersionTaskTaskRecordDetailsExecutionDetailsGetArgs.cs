...
namespace Pulumi.Oci.FleetAppsManagement.Inputs
{
    ...
    public sealed class RunbookRunbookVersionTaskTaskRecordDetailsExecutionDetailsGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        [Input("content")]
        public Input<Inputs.RunbookRunbookVersionTaskTaskRecordDetailsExecutionDetailsContentGetArgs>? Content { get; set; }

        [Input("credentials")]
        private InputList<Inputs.RunbookRunbookVersionTaskTaskRecordDetailsExecutionDetailsCredentialGetArgs>? _credentials;

        /// <summary>
        /// Credentials required for executing the task.
        /// </summary>
        public InputList<Inputs.RunbookRunbookVersionTaskTaskRecordDetailsExecutionDetailsCredentialGetArgs> Credentials
        {
            get => _credentials ?? (_credentials = new InputList<Inputs.RunbookRunbookVersionTaskTaskRecordDetailsExecutionDetailsCredentialGetArgs>());
        ...
        /// </summary>
        [Input("variables")]
        public Input<Inputs.RunbookRunbookVersionTaskTaskRecordDetailsExecutionDetailsVariablesGetArgs>? Variables { get; set; }

        public RunbookRunbookVersionTaskTaskRecordDetailsExecutionDetailsGetArgs()
        {
        }
        public static new RunbookRunbookVersionTaskTaskRecordDetailsExecutionDetailsGetArgs Empty => new RunbookRunbookVersionTaskTaskRecordDetailsExecutionDetailsGetArgs();
    }
}
