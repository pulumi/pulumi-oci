...
namespace Pulumi.Oci.FleetAppsManagement.Inputs
{
    ...
    public sealed class RunbookVersionGroupArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("properties")]
        public Input<Inputs.RunbookVersionGroupPropertiesArgs>? Properties { get; set; }
        ...
        public RunbookVersionGroupArgs()
        {
        }
        public static new RunbookVersionGroupArgs Empty => new RunbookVersionGroupArgs();
    }
}
