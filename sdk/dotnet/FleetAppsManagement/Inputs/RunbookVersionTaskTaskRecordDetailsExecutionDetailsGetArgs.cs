...
namespace Pulumi.Oci.FleetAppsManagement.Inputs
{
    ...
    public sealed class RunbookVersionTaskTaskRecordDetailsExecutionDetailsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("content")]
        public Input<Inputs.RunbookVersionTaskTaskRecordDetailsExecutionDetailsContentGetArgs>? Content { get; set; }

        [Input("credentials")]
        private InputList<Inputs.RunbookVersionTaskTaskRecordDetailsExecutionDetailsCredentialGetArgs>? _credentials;

        /// <summary>
        /// (Updatable) Credentials required for executing the task.
        /// </summary>
        public InputList<Inputs.RunbookVersionTaskTaskRecordDetailsExecutionDetailsCredentialGetArgs> Credentials
        {
            get => _credentials ?? (_credentials = new InputList<Inputs.RunbookVersionTaskTaskRecordDetailsExecutionDetailsCredentialGetArgs>());
        ...
        /// </summary>
        [Input("variables")]
        public Input<Inputs.RunbookVersionTaskTaskRecordDetailsExecutionDetailsVariablesGetArgs>? Variables { get; set; }

        public RunbookVersionTaskTaskRecordDetailsExecutionDetailsGetArgs()
        {
        }
        public static new RunbookVersionTaskTaskRecordDetailsExecutionDetailsGetArgs Empty => new RunbookVersionTaskTaskRecordDetailsExecutionDetailsGetArgs();
    }
}
