...
namespace Pulumi.Oci.FleetAppsManagement.Outputs
{
    ...
    [OutputType]
    public sealed class GetFleetResourceSelectionResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetFleetResourceSelectionRuleSelectionCriteriaResult> RuleSelectionCriterias;

        [OutputConstructor]
        private GetFleetResourceSelectionResult(
            string resourceSelectionType,

            ImmutableArray<Outputs.GetFleetResourceSelectionRuleSelectionCriteriaResult> ruleSelectionCriterias)
        {
