...
namespace Pulumi.Oci.FleetSoftwareUpdate.Inputs
{
    ...
    public sealed class FsuCollectionComponentFleetDiscoveryArgs : global::Pulumi.ResourceArgs
    {
        [Input("filters")]
        private InputList<Inputs.FsuCollectionComponentFleetDiscoveryFilterArgs>? _filters;

        /// <summary>
        /// Filters to perform the target discovery.
        /// </summary>
        public InputList<Inputs.FsuCollectionComponentFleetDiscoveryFilterArgs> Filters
        {
            get => _filters ?? (_filters = new InputList<Inputs.FsuCollectionComponentFleetDiscoveryFilterArgs>());
            set => _filters = value;
        }
        ...
        public FsuCollectionComponentFleetDiscoveryArgs()
        {
        }
        public static new FsuCollectionComponentFleetDiscoveryArgs Empty => new FsuCollectionComponentFleetDiscoveryArgs();
    }
}
