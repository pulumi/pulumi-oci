...
namespace Pulumi.Oci.FleetSoftwareUpdate.Inputs
{
    ...
    public sealed class FsuCollectionComponentFleetDiscoveryFilterArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("tags")]
        private InputList<Inputs.FsuCollectionComponentFleetDiscoveryFilterTagArgs>? _tags;
        ...
        /// </summary>
        public InputList<Inputs.FsuCollectionComponentFleetDiscoveryFilterTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.FsuCollectionComponentFleetDiscoveryFilterTagArgs>());
            set => _tags = value;
        }
        ...
        public FsuCollectionComponentFleetDiscoveryFilterArgs()
        {
        }
        public static new FsuCollectionComponentFleetDiscoveryFilterArgs Empty => new FsuCollectionComponentFleetDiscoveryFilterArgs();
    }
}
