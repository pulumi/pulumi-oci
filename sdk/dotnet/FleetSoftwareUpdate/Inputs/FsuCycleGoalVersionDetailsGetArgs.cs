...
namespace Pulumi.Oci.FleetSoftwareUpdate.Inputs
{
    ...
    {
        [Input("components")]
        private InputList<Inputs.FsuCycleGoalVersionDetailsComponentGetArgs>? _components;

        /// <summary>
        /// (Updatable) Details of goal versions for components in an Exadata software stack.
        /// </summary>
        public InputList<Inputs.FsuCycleGoalVersionDetailsComponentGetArgs> Components
        {
            get => _components ?? (_components = new InputList<Inputs.FsuCycleGoalVersionDetailsComponentGetArgs>());
