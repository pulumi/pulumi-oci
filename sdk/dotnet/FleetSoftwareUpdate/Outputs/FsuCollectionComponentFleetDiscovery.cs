...
namespace Pulumi.Oci.FleetSoftwareUpdate.Outputs
{
    ...
    [OutputType]
    public sealed class FsuCollectionComponentFleetDiscovery
    {
        /// <summary>
        /// Filters to perform the target discovery.
        /// </summary>
        public readonly ImmutableArray<Outputs.FsuCollectionComponentFleetDiscoveryFilter> Filters;
        /// <summary>
        ...
        private FsuCollectionComponentFleetDiscovery(
            ImmutableArray<Outputs.FsuCollectionComponentFleetDiscoveryFilter> filters,
