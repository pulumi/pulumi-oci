...
namespace Pulumi.Oci.FleetSoftwareUpdate.Outputs
{
    ...
    [OutputType]
    public sealed class GetFsuCyclesFsuCycleSummaryCollectionItemDiagnosticsCollectionResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetFsuCyclesFsuCycleSummaryCollectionItemDiagnosticsCollectionResult(string logCollectionMode)
        {
