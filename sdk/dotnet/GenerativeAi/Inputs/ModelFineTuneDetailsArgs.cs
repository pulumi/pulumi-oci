...
namespace Pulumi.Oci.GenerativeAi.Inputs
{
    ...
    public sealed class ModelFineTuneDetailsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.ModelFineTuneDetailsTrainingConfigArgs>? TrainingConfig { get; set; }
        ...
        public Input<Inputs.ModelFineTuneDetailsTrainingDatasetArgs> TrainingDataset { get; set; } = null!;

        public ModelFineTuneDetailsArgs()
        {
        }
        public static new ModelFineTuneDetailsArgs Empty => new ModelFineTuneDetailsArgs();
    }
}
