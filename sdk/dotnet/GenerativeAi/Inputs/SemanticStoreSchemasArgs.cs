...
namespace Pulumi.Oci.GenerativeAi.Inputs
{
    ...
    public sealed class SemanticStoreSchemasArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.SemanticStoreSchemasSchemaArgs>? _schemas;
        ...
        /// </summary>
        public InputList<Inputs.SemanticStoreSchemasSchemaArgs> Schemas
        {
            get => _schemas ?? (_schemas = new InputList<Inputs.SemanticStoreSchemasSchemaArgs>());
            set => _schemas = value;
        }

        public SemanticStoreSchemasArgs()
        {
        }
        public static new SemanticStoreSchemasArgs Empty => new SemanticStoreSchemasArgs();
    }
}
