...
namespace Pulumi.Oci.GenerativeAi.Outputs
{
    ...
    [OutputType]
    public sealed class AgentAgentEndpointGuardrailConfigPromptInjectionConfig
    {
        /// <summary>
        ...
        [OutputConstructor]
        private AgentAgentEndpointGuardrailConfigPromptInjectionConfig(string? inputGuardrailMode)
        {
