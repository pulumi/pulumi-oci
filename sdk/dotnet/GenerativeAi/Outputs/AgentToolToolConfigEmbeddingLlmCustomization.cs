...
namespace Pulumi.Oci.GenerativeAi.Outputs
{
    ...
    [OutputType]
    public sealed class AgentToolToolConfigEmbeddingLlmCustomization
    {
        /// <summary>
        ...
        /// </summary>
        public readonly Outputs.AgentToolToolConfigEmbeddingLlmCustomizationLlmSelection? LlmSelection;

        [OutputConstructor]
        private AgentToolToolConfigEmbeddingLlmCustomization(
            string? instruction,

            ImmutableDictionary<string, string>? llmHyperParameters,

            Outputs.AgentToolToolConfigEmbeddingLlmCustomizationLlmSelection? llmSelection)
        {
