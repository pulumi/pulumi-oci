...
namespace Pulumi.Oci.GenerativeAi.Outputs
{
    ...
    public sealed class GetAgentAgentsAgentCollectionItemLlmConfigRoutingLlmCustomizationResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetAgentAgentsAgentCollectionItemLlmConfigRoutingLlmCustomizationLlmSelectionResult> LlmSelections;

        [OutputConstructor]
        private GetAgentAgentsAgentCollectionItemLlmConfigRoutingLlmCustomizationResult(
            string instruction,

            ImmutableDictionary<string, string> llmHyperParameters,

            ImmutableArray<Outputs.GetAgentAgentsAgentCollectionItemLlmConfigRoutingLlmCustomizationLlmSelectionResult> llmSelections)
        {
