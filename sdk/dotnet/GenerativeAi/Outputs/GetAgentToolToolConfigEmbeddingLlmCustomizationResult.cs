...
namespace Pulumi.Oci.GenerativeAi.Outputs
{
    ...
    [OutputType]
    public sealed class GetAgentToolToolConfigEmbeddingLlmCustomizationResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetAgentToolToolConfigEmbeddingLlmCustomizationLlmSelectionResult> LlmSelections;

        [OutputConstructor]
        private GetAgentToolToolConfigEmbeddingLlmCustomizationResult(
            string instruction,

            ImmutableDictionary<string, string> llmHyperParameters,

            ImmutableArray<Outputs.GetAgentToolToolConfigEmbeddingLlmCustomizationLlmSelectionResult> llmSelections)
        {
