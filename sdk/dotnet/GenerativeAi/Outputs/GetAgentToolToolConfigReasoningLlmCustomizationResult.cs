...
namespace Pulumi.Oci.GenerativeAi.Outputs
{
    ...
    [OutputType]
    public sealed class GetAgentToolToolConfigReasoningLlmCustomizationResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetAgentToolToolConfigReasoningLlmCustomizationLlmSelectionResult> LlmSelections;

        [OutputConstructor]
        private GetAgentToolToolConfigReasoningLlmCustomizationResult(
            string instruction,

            ImmutableDictionary<string, string> llmHyperParameters,

            ImmutableArray<Outputs.GetAgentToolToolConfigReasoningLlmCustomizationLlmSelectionResult> llmSelections)
        {
