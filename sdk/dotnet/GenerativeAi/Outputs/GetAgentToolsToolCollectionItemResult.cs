...
namespace Pulumi.Oci.GenerativeAi.Outputs
{
    ...
    [OutputType]
    public sealed class GetAgentToolsToolCollectionItemResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetAgentToolsToolCollectionItemToolConfigResult> ToolConfigs;

        [OutputConstructor]
        private GetAgentToolsToolCollectionItemResult(
            string agentId,
            ...
            ImmutableArray<Outputs.GetAgentToolsToolCollectionItemToolConfigResult> toolConfigs)
        {
            AgentId = agentId;
