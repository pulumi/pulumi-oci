...
namespace Pulumi.Oci.GenerativeAi.Outputs
{
    ...
    [OutputType]
    public sealed class GetAgentToolsToolCollectionItemToolConfigEmbeddingLlmCustomizationResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetAgentToolsToolCollectionItemToolConfigEmbeddingLlmCustomizationLlmSelectionResult> LlmSelections;

        [OutputConstructor]
        private GetAgentToolsToolCollectionItemToolConfigEmbeddingLlmCustomizationResult(
            string instruction,

            ImmutableDictionary<string, string> llmHyperParameters,

            ImmutableArray<Outputs.GetAgentToolsToolCollectionItemToolConfigEmbeddingLlmCustomizationLlmSelectionResult> llmSelections)
        {
