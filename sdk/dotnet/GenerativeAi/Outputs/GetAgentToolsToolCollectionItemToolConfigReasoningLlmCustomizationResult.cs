...
namespace Pulumi.Oci.GenerativeAi.Outputs
{
    ...
    [OutputType]
    public sealed class GetAgentToolsToolCollectionItemToolConfigReasoningLlmCustomizationResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetAgentToolsToolCollectionItemToolConfigReasoningLlmCustomizationLlmSelectionResult> LlmSelections;

        [OutputConstructor]
        private GetAgentToolsToolCollectionItemToolConfigReasoningLlmCustomizationResult(
            string instruction,

            ImmutableDictionary<string, string> llmHyperParameters,

            ImmutableArray<Outputs.GetAgentToolsToolCollectionItemToolConfigReasoningLlmCustomizationLlmSelectionResult> llmSelections)
        {
