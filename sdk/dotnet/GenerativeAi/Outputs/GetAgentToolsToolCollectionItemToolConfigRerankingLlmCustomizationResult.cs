...
namespace Pulumi.Oci.GenerativeAi.Outputs
{
    ...
    [OutputType]
    public sealed class GetAgentToolsToolCollectionItemToolConfigRerankingLlmCustomizationResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetAgentToolsToolCollectionItemToolConfigRerankingLlmCustomizationLlmSelectionResult> LlmSelections;

        [OutputConstructor]
        private GetAgentToolsToolCollectionItemToolConfigRerankingLlmCustomizationResult(
            string instruction,

            ImmutableDictionary<string, string> llmHyperParameters,

            ImmutableArray<Outputs.GetAgentToolsToolCollectionItemToolConfigRerankingLlmCustomizationLlmSelectionResult> llmSelections)
        {
