...
namespace Pulumi.Oci.GenerativeAi.Outputs
{
    ...
    [OutputType]
    public sealed class GetRoutingProfilePreviousStateRegionRoutingPolicyResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetRoutingProfilePreviousStateRegionRoutingPolicyResult(ImmutableArray<string> allowedRegions)
        {
