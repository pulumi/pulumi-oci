...
namespace Pulumi.Oci.GenerativeAi.Outputs
{
    ...
    [OutputType]
    public sealed class GetRoutingProfilesRoutingProfileCollectionItemRegionRoutingPolicyResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetRoutingProfilesRoutingProfileCollectionItemRegionRoutingPolicyResult(ImmutableArray<string> allowedRegions)
        {
