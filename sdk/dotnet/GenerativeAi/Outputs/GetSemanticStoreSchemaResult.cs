...
namespace Pulumi.Oci.GenerativeAi.Outputs
{
    ...
    [OutputType]
    public sealed class GetSemanticStoreSchemaResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetSemanticStoreSchemaSchemaResult> Schemas;

        [OutputConstructor]
        private GetSemanticStoreSchemaResult(
            string connectionType,

            ImmutableArray<Outputs.GetSemanticStoreSchemaSchemaResult> schemas)
        {
