...
namespace Pulumi.Oci.GoldenGate.Inputs
{
    ...
    public sealed class ConnectionAuthDetailsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public ConnectionAuthDetailsArgs()
        {
        }
        public static new ConnectionAuthDetailsArgs Empty => new ConnectionAuthDetailsArgs();
    }
}
