...
namespace Pulumi.Oci.Identity
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:Identity/domainsOauthClientCertificate:DomainsOauthClientCertificate")]
    public partial class DomainsOauthClientCertificate : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.DomainsOauthClientCertificateIdcsCreatedBy>> IdcsCreatedBies { get; private set; } = null!;
        ...
        public Output<ImmutableArray<Outputs.DomainsOauthClientCertificateIdcsLastModifiedBy>> IdcsLastModifiedBies { get; private set; } = null!;
        ...
        /// </summary>
        [Output("metas")]
        public Output<ImmutableArray<Outputs.DomainsOauthClientCertificateMeta>> Metas { get; private set; } = null!;
        ...
        /// </summary>
        [Output("tags")]
        public Output<ImmutableArray<Outputs.DomainsOauthClientCertificateTag>> Tags { get; private set; } = null!;
        ...
        public DomainsOauthClientCertificate(string name, DomainsOauthClientCertificateArgs args, CustomResourceOptions? options = null)
            : base("oci:Identity/domainsOauthClientCertificate:DomainsOauthClientCertificate", name, args ?? new DomainsOauthClientCertificateArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DomainsOauthClientCertificate(string name, Input<string> id, DomainsOauthClientCertificateState? state = null, CustomResourceOptions? options = null)
            : base("oci:Identity/domainsOauthClientCertificate:DomainsOauthClientCertificate", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DomainsOauthClientCertificate Get(string name, Input<string> id, DomainsOauthClientCertificateState? state = null, CustomResourceOptions? options = null)
        {
            return new DomainsOauthClientCertificate(name, id, state, options);
        }
    }

    public sealed class DomainsOauthClientCertificateArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The Authorization field value consists of credentials containing the authentication information of the user agent for the realm of the resource being requested.
        /// </summary>
        ...
        [Input("tags")]
        private InputList<Inputs.DomainsOauthClientCertificateTagArgs>? _tags;
        ...
        /// * uniqueness: none
        /// </summary>
        public InputList<Inputs.DomainsOauthClientCertificateTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.DomainsOauthClientCertificateTagArgs>());
            set => _tags = value;
        }
        ...
        /// Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        /// </summary>
        [Input("x509base64certificate", required: true)]
        public Input<string> X509base64certificate { get; set; } = null!;

        public DomainsOauthClientCertificateArgs()
        {
        }
        public static new DomainsOauthClientCertificateArgs Empty => new DomainsOauthClientCertificateArgs();
    }

    public sealed class DomainsOauthClientCertificateState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The Authorization field value consists of credentials containing the authentication information of the user agent for the realm of the resource being requested.
        /// </summary>
        ...
        private InputList<Inputs.DomainsOauthClientCertificateIdcsCreatedByGetArgs>? _idcsCreatedBies;
        ...
        /// * type: complex
        /// </summary>
        public InputList<Inputs.DomainsOauthClientCertificateIdcsCreatedByGetArgs> IdcsCreatedBies
        {
            get => _idcsCreatedBies ?? (_idcsCreatedBies = new InputList<Inputs.DomainsOauthClientCertificateIdcsCreatedByGetArgs>());
        ...
        private InputList<Inputs.DomainsOauthClientCertificateIdcsLastModifiedByGetArgs>? _idcsLastModifiedBies;
        ...
        /// * type: complex
        /// </summary>
        public InputList<Inputs.DomainsOauthClientCertificateIdcsLastModifiedByGetArgs> IdcsLastModifiedBies
        {
            get => _idcsLastModifiedBies ?? (_idcsLastModifiedBies = new InputList<Inputs.DomainsOauthClientCertificateIdcsLastModifiedByGetArgs>());
        ...
        [Input("metas")]
        private InputList<Inputs.DomainsOauthClientCertificateMetaGetArgs>? _metas;
        ...
        /// * type: complex
        /// </summary>
        public InputList<Inputs.DomainsOauthClientCertificateMetaGetArgs> Metas
        {
            get => _metas ?? (_metas = new InputList<Inputs.DomainsOauthClientCertificateMetaGetArgs>());
            set => _metas = value;
        }
        ...
        [Input("tags")]
        private InputList<Inputs.DomainsOauthClientCertificateTagGetArgs>? _tags;
        ...
        /// * uniqueness: none
        /// </summary>
        public InputList<Inputs.DomainsOauthClientCertificateTagGetArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.DomainsOauthClientCertificateTagGetArgs>());
            set => _tags = value;
        }
        ...
        public DomainsOauthClientCertificateState()
        {
        }
        public static new DomainsOauthClientCertificateState Empty => new DomainsOauthClientCertificateState();
    }
}
