...
namespace Pulumi.Oci.Identity
{
    ...
    public partial class DynamicGroup : global::Pulumi.CustomResource
    {
        ...
        public DynamicGroup(string name, DynamicGroupArgs args, CustomResourceOptions? options = null)
            : base("oci:Identity/dynamicGroup:DynamicGroup", name, args ?? new DynamicGroupArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DynamicGroup(string name, Input<string> id, DynamicGroupState? state = null, CustomResourceOptions? options = null)
            : base("oci:Identity/dynamicGroup:DynamicGroup", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DynamicGroup Get(string name, Input<string> id, DynamicGroupState? state = null, CustomResourceOptions? options = null)
        {
