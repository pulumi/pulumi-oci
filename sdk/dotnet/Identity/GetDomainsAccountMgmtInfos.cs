...
namespace Pulumi.Oci.Identity
{
    public static class GetDomainsAccountMgmtInfos
    {
        ...
        /// </summary>
        public static Task<GetDomainsAccountMgmtInfosResult> InvokeAsync(GetDomainsAccountMgmtInfosArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDomainsAccountMgmtInfosResult>("oci:Identity/getDomainsAccountMgmtInfos:getDomainsAccountMgmtInfos", args ?? new GetDomainsAccountMgmtInfosArgs(), options.WithDefaults());
    ...
    public sealed class GetDomainsAccountMgmtInfosArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
        /// </summary>
        [Input("accountMgmtInfoCount")]
        public int? AccountMgmtInfoCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("accountMgmtInfoFilter")]
        ...
        public GetDomainsAccountMgmtInfosArgs()
        {
        }
        public static new GetDomainsAccountMgmtInfosArgs Empty => new GetDomainsAccountMgmtInfosArgs();
    }

    public sealed class GetDomainsAccountMgmtInfosInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
        /// </summary>
        [Input("accountMgmtInfoCount")]
        public Input<int>? AccountMgmtInfoCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("accountMgmtInfoFilter")]
        public Input<string>? AccountMgmtInfoFilter { get; set; }
        ...
        public GetDomainsAccountMgmtInfosInvokeArgs()
        {
        }
        public static new GetDomainsAccountMgmtInfosInvokeArgs Empty => new GetDomainsAccountMgmtInfosInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsAccountMgmtInfosResult
    {
        public readonly int? AccountMgmtInfoCount;
        public readonly string? AccountMgmtInfoFilter;
        /// <summary>
        /// The list of account_mgmt_infos.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsAccountMgmtInfosAccountMgmtInfoResult> AccountMgmtInfos;
        ...
        private GetDomainsAccountMgmtInfosResult(
            int? accountMgmtInfoCount,

            string? accountMgmtInfoFilter,

            ImmutableArray<Outputs.GetDomainsAccountMgmtInfosAccountMgmtInfoResult> accountMgmtInfos,
