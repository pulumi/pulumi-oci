...
namespace Pulumi.Oci.Identity
{
    public static class GetDomainsAppRoles
    {
        ...
        /// ```
        /// </summary>
        public static Output<GetDomainsAppRolesResult> Invoke(GetDomainsAppRolesInvokeArgs args, InvokeOutputOptions options)
            => global::Pulumi.Deployment.Instance.Invoke<GetDomainsAppRolesResult>("oci:Identity/getDomainsAppRoles:getDomainsAppRoles", args ?? new GetDomainsAppRolesInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetDomainsAppRolesArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetDomainsAppRolesArgs()
        {
        }
        public static new GetDomainsAppRolesArgs Empty => new GetDomainsAppRolesArgs();
    }

    public sealed class GetDomainsAppRolesInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
        /// </summary>
        [Input("appRoleCount")]
        public Input<int>? AppRoleCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("appRoleFilter")]
        public Input<string>? AppRoleFilter { get; set; }
        ...
        public GetDomainsAppRolesInvokeArgs()
        {
        }
        public static new GetDomainsAppRolesInvokeArgs Empty => new GetDomainsAppRolesInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsAppRolesResult
    {
        public readonly int? AppRoleCount;
        public readonly string? AppRoleFilter;
        /// <summary>
        /// The list of app_roles.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsAppRolesAppRoleResult> AppRoles;
        ...
        private GetDomainsAppRolesResult(
            ...
            ImmutableArray<Outputs.GetDomainsAppRolesAppRoleResult> appRoles,
