...
{
    public static class GetDomainsApprovalWorkflowAssignments
    {
        /// <summary>
    ...
    public sealed class GetDomainsApprovalWorkflowAssignmentsArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
        /// </summary>
        [Input("approvalWorkflowAssignmentCount")]
        public int? ApprovalWorkflowAssignmentCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("approvalWorkflowAssignmentFilter")]
        ...
        public GetDomainsApprovalWorkflowAssignmentsArgs()
        {
        }
        public static new GetDomainsApprovalWorkflowAssignmentsArgs Empty => new GetDomainsApprovalWorkflowAssignmentsArgs();
    }

    public sealed class GetDomainsApprovalWorkflowAssignmentsInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
        /// </summary>
        [Input("approvalWorkflowAssignmentCount")]
        public Input<int>? ApprovalWorkflowAssignmentCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("approvalWorkflowAssignmentFilter")]
        public Input<string>? ApprovalWorkflowAssignmentFilter { get; set; }
        ...
        public GetDomainsApprovalWorkflowAssignmentsInvokeArgs()
        {
        }
        public static new GetDomainsApprovalWorkflowAssignmentsInvokeArgs Empty => new GetDomainsApprovalWorkflowAssignmentsInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsApprovalWorkflowAssignmentsResult
    {
        public readonly int? ApprovalWorkflowAssignmentCount;
        public readonly string? ApprovalWorkflowAssignmentFilter;
        /// <summary>
        /// The list of approval_workflow_assignments.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsApprovalWorkflowAssignmentsApprovalWorkflowAssignmentResult> ApprovalWorkflowAssignments;
        ...
        private GetDomainsApprovalWorkflowAssignmentsResult(
            int? approvalWorkflowAssignmentCount,

            string? approvalWorkflowAssignmentFilter,

            ImmutableArray<Outputs.GetDomainsApprovalWorkflowAssignmentsApprovalWorkflowAssignmentResult> approvalWorkflowAssignments,
