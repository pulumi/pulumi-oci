...
{
    public static class GetDomainsApprovalWorkflowSteps
    {
        /// <summary>
    ...
    public sealed class GetDomainsApprovalWorkflowStepsArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
        /// </summary>
        [Input("approvalWorkflowStepCount")]
        public int? ApprovalWorkflowStepCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("approvalWorkflowStepFilter")]
        ...
        public GetDomainsApprovalWorkflowStepsArgs()
        {
        }
        public static new GetDomainsApprovalWorkflowStepsArgs Empty => new GetDomainsApprovalWorkflowStepsArgs();
    }

    public sealed class GetDomainsApprovalWorkflowStepsInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
        /// </summary>
        [Input("approvalWorkflowStepCount")]
        public Input<int>? ApprovalWorkflowStepCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("approvalWorkflowStepFilter")]
        public Input<string>? ApprovalWorkflowStepFilter { get; set; }
        ...
        public GetDomainsApprovalWorkflowStepsInvokeArgs()
        {
        }
        public static new GetDomainsApprovalWorkflowStepsInvokeArgs Empty => new GetDomainsApprovalWorkflowStepsInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsApprovalWorkflowStepsResult
    {
        public readonly int? ApprovalWorkflowStepCount;
        public readonly string? ApprovalWorkflowStepFilter;
        /// <summary>
        /// The list of approval_workflow_steps.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsApprovalWorkflowStepsApprovalWorkflowStepResult> ApprovalWorkflowSteps;
        ...
        private GetDomainsApprovalWorkflowStepsResult(
            int? approvalWorkflowStepCount,

            string? approvalWorkflowStepFilter,

            ImmutableArray<Outputs.GetDomainsApprovalWorkflowStepsApprovalWorkflowStepResult> approvalWorkflowSteps,
