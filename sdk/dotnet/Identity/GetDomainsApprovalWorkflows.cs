...
{
    public static class GetDomainsApprovalWorkflows
    {
        /// <summary>
        ...
        /// ```
        /// </summary>
        public static Task<GetDomainsApprovalWorkflowsResult> InvokeAsync(GetDomainsApprovalWorkflowsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDomainsApprovalWorkflowsResult>("oci:Identity/getDomainsApprovalWorkflows:getDomainsApprovalWorkflows", args ?? new GetDomainsApprovalWorkflowsArgs(), options.WithDefaults());
    ...
    public sealed class GetDomainsApprovalWorkflowsArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
        /// </summary>
        [Input("approvalWorkflowCount")]
        public int? ApprovalWorkflowCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("approvalWorkflowFilter")]
        ...
        public GetDomainsApprovalWorkflowsArgs()
        {
        }
        public static new GetDomainsApprovalWorkflowsArgs Empty => new GetDomainsApprovalWorkflowsArgs();
    }

    public sealed class GetDomainsApprovalWorkflowsInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
        /// </summary>
        [Input("approvalWorkflowCount")]
        public Input<int>? ApprovalWorkflowCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("approvalWorkflowFilter")]
        public Input<string>? ApprovalWorkflowFilter { get; set; }
        ...
        public GetDomainsApprovalWorkflowsInvokeArgs()
        {
        }
        public static new GetDomainsApprovalWorkflowsInvokeArgs Empty => new GetDomainsApprovalWorkflowsInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsApprovalWorkflowsResult
    {
        public readonly int? ApprovalWorkflowCount;
        public readonly string? ApprovalWorkflowFilter;
        /// <summary>
        /// The list of approval_workflows.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsApprovalWorkflowsApprovalWorkflowResult> ApprovalWorkflows;
        ...
        private GetDomainsApprovalWorkflowsResult(
            int? approvalWorkflowCount,

            string? approvalWorkflowFilter,

            ImmutableArray<Outputs.GetDomainsApprovalWorkflowsApprovalWorkflowResult> approvalWorkflows,
            ...
            int totalResults)
        {
            ApprovalWorkflowCount = approvalWorkflowCount;
            ApprovalWorkflowFilter = approvalWorkflowFilter;
