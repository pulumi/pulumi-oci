...
namespace Pulumi.Oci.Identity
{
    public static class GetDomainsApps
    {
        ...
        /// ```
        /// </summary>
        public static Task<GetDomainsAppsResult> InvokeAsync(GetDomainsAppsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDomainsAppsResult>("oci:Identity/getDomainsApps:getDomainsApps", args ?? new GetDomainsAppsArgs(), options.WithDefaults());
    ...
    public sealed class GetDomainsAppsArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetDomainsAppsArgs()
        {
        }
        public static new GetDomainsAppsArgs Empty => new GetDomainsAppsArgs();
    }

    public sealed class GetDomainsAppsInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
        /// </summary>
        ...
        /// </summary>
        [Input("appFilter")]
        public Input<string>? AppFilter { get; set; }
        ...
        public GetDomainsAppsInvokeArgs()
        {
        }
        public static new GetDomainsAppsInvokeArgs Empty => new GetDomainsAppsInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsAppsResult
    {
        public readonly int? AppCount;
        public readonly string? AppFilter;
        /// <summary>
        /// The list of apps.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsAppsAppResult> Apps;
        ...
        [OutputConstructor]
        private GetDomainsAppsResult(
            int? appCount,

            string? appFilter,

            ImmutableArray<Outputs.GetDomainsAppsAppResult> apps,
