...
namespace Pulumi.Oci.Identity
{
    public static class GetDomainsCloudGateMappings
    {
        ...
        /// ```
        /// </summary>
        public static Task<GetDomainsCloudGateMappingsResult> InvokeAsync(GetDomainsCloudGateMappingsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDomainsCloudGateMappingsResult>("oci:Identity/getDomainsCloudGateMappings:getDomainsCloudGateMappings", args ?? new GetDomainsCloudGateMappingsArgs(), options.WithDefaults());
    ...
    public sealed class GetDomainsCloudGateMappingsArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        public GetDomainsCloudGateMappingsArgs()
        {
        }
        public static new GetDomainsCloudGateMappingsArgs Empty => new GetDomainsCloudGateMappingsArgs();
    }

    public sealed class GetDomainsCloudGateMappingsInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("cloudGateMappingCount")]
        public Input<int>? CloudGateMappingCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("cloudGateMappingFilter")]
        public Input<string>? CloudGateMappingFilter { get; set; }
        ...
        public GetDomainsCloudGateMappingsInvokeArgs()
        {
        }
        public static new GetDomainsCloudGateMappingsInvokeArgs Empty => new GetDomainsCloudGateMappingsInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsCloudGateMappingsResult
    {
        public readonly ImmutableArray<string> AttributeSets;
        public readonly string? Attributes;
        public readonly string? Authorization;
        public readonly int? CloudGateMappingCount;
        public readonly string? CloudGateMappingFilter;
        /// <summary>
        /// The list of cloud_gate_mappings.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsCloudGateMappingsCloudGateMappingResult> CloudGateMappings;
        ...
        private GetDomainsCloudGateMappingsResult(
            ...
            int? cloudGateMappingCount,

            string? cloudGateMappingFilter,

            ImmutableArray<Outputs.GetDomainsCloudGateMappingsCloudGateMappingResult> cloudGateMappings,
