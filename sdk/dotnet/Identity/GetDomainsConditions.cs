...
{
    public static class GetDomainsConditions
    {
        /// <summary>
        ...
        /// </summary>
        public static Task<GetDomainsConditionsResult> InvokeAsync(GetDomainsConditionsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDomainsConditionsResult>("oci:Identity/getDomainsConditions:getDomainsConditions", args ?? new GetDomainsConditionsArgs(), options.WithDefaults());
    ...
    public sealed class GetDomainsConditionsArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        public GetDomainsConditionsArgs()
        {
        }
        public static new GetDomainsConditionsArgs Empty => new GetDomainsConditionsArgs();
    }

    public sealed class GetDomainsConditionsInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("conditionCount")]
        public Input<int>? ConditionCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("conditionFilter")]
        public Input<string>? ConditionFilter { get; set; }
        ...
        public GetDomainsConditionsInvokeArgs()
        {
        }
        public static new GetDomainsConditionsInvokeArgs Empty => new GetDomainsConditionsInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsConditionsResult
    {
        ...
        public readonly string? ConditionFilter;
        /// <summary>
        /// The list of conditions.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsConditionsConditionResult> Conditions;
        /// <summary>
        ...
        private GetDomainsConditionsResult(
            ...
            ImmutableArray<Outputs.GetDomainsConditionsConditionResult> conditions,
