...
{
    public static class GetDomainsCustomerSecretKeys
    {
        /// <summary>
        ...
        /// ```
        /// </summary>
        public static Task<GetDomainsCustomerSecretKeysResult> InvokeAsync(GetDomainsCustomerSecretKeysArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDomainsCustomerSecretKeysResult>("oci:Identity/getDomainsCustomerSecretKeys:getDomainsCustomerSecretKeys", args ?? new GetDomainsCustomerSecretKeysArgs(), options.WithDefaults());
    ...
    public sealed class GetDomainsCustomerSecretKeysArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        public GetDomainsCustomerSecretKeysArgs()
        {
        }
        public static new GetDomainsCustomerSecretKeysArgs Empty => new GetDomainsCustomerSecretKeysArgs();
    }

    public sealed class GetDomainsCustomerSecretKeysInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("customerSecretKeyCount")]
        public Input<int>? CustomerSecretKeyCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("customerSecretKeyFilter")]
        public Input<string>? CustomerSecretKeyFilter { get; set; }
        ...
        public GetDomainsCustomerSecretKeysInvokeArgs()
        {
        }
        public static new GetDomainsCustomerSecretKeysInvokeArgs Empty => new GetDomainsCustomerSecretKeysInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsCustomerSecretKeysResult
    {
        public readonly ImmutableArray<string> AttributeSets;
        public readonly string? Attributes;
        public readonly string? Authorization;
        public readonly string? CompartmentId;
        public readonly int? CustomerSecretKeyCount;
        public readonly string? CustomerSecretKeyFilter;
        /// <summary>
        /// The list of customer_secret_keys.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsCustomerSecretKeysCustomerSecretKeyResult> CustomerSecretKeys;
        /// <summary>
        ...
        [OutputConstructor]
        private GetDomainsCustomerSecretKeysResult(
            ...
            int? customerSecretKeyCount,

            string? customerSecretKeyFilter,

            ImmutableArray<Outputs.GetDomainsCustomerSecretKeysCustomerSecretKeyResult> customerSecretKeys,
            ...
            int totalResults)
        {
            ...
            CustomerSecretKeyCount = customerSecretKeyCount;
