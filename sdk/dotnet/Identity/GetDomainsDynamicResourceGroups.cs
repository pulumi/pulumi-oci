...
namespace Pulumi.Oci.Identity
{
    public static class GetDomainsDynamicResourceGroups
    {
        ...
        /// </summary>
        public static Task<GetDomainsDynamicResourceGroupsResult> InvokeAsync(GetDomainsDynamicResourceGroupsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDomainsDynamicResourceGroupsResult>("oci:Identity/getDomainsDynamicResourceGroups:getDomainsDynamicResourceGroups", args ?? new GetDomainsDynamicResourceGroupsArgs(), options.WithDefaults());
    ...
    public sealed class GetDomainsDynamicResourceGroupsArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("dynamicResourceGroupCount")]
        public int? DynamicResourceGroupCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("dynamicResourceGroupFilter")]
        ...
        public GetDomainsDynamicResourceGroupsArgs()
        {
        }
        public static new GetDomainsDynamicResourceGroupsArgs Empty => new GetDomainsDynamicResourceGroupsArgs();
    }

    public sealed class GetDomainsDynamicResourceGroupsInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("dynamicResourceGroupCount")]
        public Input<int>? DynamicResourceGroupCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("dynamicResourceGroupFilter")]
        public Input<string>? DynamicResourceGroupFilter { get; set; }
        ...
        public GetDomainsDynamicResourceGroupsInvokeArgs()
        {
        }
        public static new GetDomainsDynamicResourceGroupsInvokeArgs Empty => new GetDomainsDynamicResourceGroupsInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsDynamicResourceGroupsResult
    {
        public readonly ImmutableArray<string> AttributeSets;
        public readonly string? Attributes;
        public readonly string? Authorization;
        public readonly string? CompartmentId;
        public readonly int? DynamicResourceGroupCount;
        public readonly string? DynamicResourceGroupFilter;
        /// <summary>
        /// The list of dynamic_resource_groups.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsDynamicResourceGroupsDynamicResourceGroupResult> DynamicResourceGroups;
        /// <summary>
        ...
        private GetDomainsDynamicResourceGroupsResult(
            ...
            int? dynamicResourceGroupCount,

            string? dynamicResourceGroupFilter,

            ImmutableArray<Outputs.GetDomainsDynamicResourceGroupsDynamicResourceGroupResult> dynamicResourceGroups,
