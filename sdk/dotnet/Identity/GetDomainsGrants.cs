...
{
    public static class GetDomainsGrants
    {
        /// <summary>
        ...
        /// ```
        /// </summary>
        public static Task<GetDomainsGrantsResult> InvokeAsync(GetDomainsGrantsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDomainsGrantsResult>("oci:Identity/getDomainsGrants:getDomainsGrants", args ?? new GetDomainsGrantsArgs(), options.WithDefaults());
    ...
    public sealed class GetDomainsGrantsArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("grantFilter")]
        public string? GrantFilter { get; set; }
        ...
        public GetDomainsGrantsArgs()
        {
        }
        public static new GetDomainsGrantsArgs Empty => new GetDomainsGrantsArgs();
    }

    public sealed class GetDomainsGrantsInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("grantCount")]
        public Input<int>? GrantCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("grantFilter")]
        public Input<string>? GrantFilter { get; set; }
        ...
        public GetDomainsGrantsInvokeArgs()
        {
        }
        public static new GetDomainsGrantsInvokeArgs Empty => new GetDomainsGrantsInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsGrantsResult
    {
        public readonly ImmutableArray<string> AttributeSets;
        public readonly string? Attributes;
        public readonly string? Authorization;
        public readonly string? CompartmentId;
        public readonly int? GrantCount;
        public readonly string? GrantFilter;
        /// <summary>
        /// The list of grants.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsGrantsGrantResult> Grants;
        /// <summary>
        ...
        private GetDomainsGrantsResult(
            ...
            ImmutableArray<Outputs.GetDomainsGrantsGrantResult> grants,
