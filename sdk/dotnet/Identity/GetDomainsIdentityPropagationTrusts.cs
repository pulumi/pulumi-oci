...
namespace Pulumi.Oci.Identity
{
    public static class GetDomainsIdentityPropagationTrusts
    {
        ...
        /// </summary>
        public static Task<GetDomainsIdentityPropagationTrustsResult> InvokeAsync(GetDomainsIdentityPropagationTrustsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDomainsIdentityPropagationTrustsResult>("oci:Identity/getDomainsIdentityPropagationTrusts:getDomainsIdentityPropagationTrusts", args ?? new GetDomainsIdentityPropagationTrustsArgs(), options.WithDefaults());
    ...
    public sealed class GetDomainsIdentityPropagationTrustsArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("identityPropagationTrustCount")]
        public int? IdentityPropagationTrustCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("identityPropagationTrustFilter")]
        ...
        public GetDomainsIdentityPropagationTrustsArgs()
        {
        }
        public static new GetDomainsIdentityPropagationTrustsArgs Empty => new GetDomainsIdentityPropagationTrustsArgs();
    }

    public sealed class GetDomainsIdentityPropagationTrustsInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("identityPropagationTrustCount")]
        public Input<int>? IdentityPropagationTrustCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("identityPropagationTrustFilter")]
        public Input<string>? IdentityPropagationTrustFilter { get; set; }
        ...
        public GetDomainsIdentityPropagationTrustsInvokeArgs()
        {
        }
        public static new GetDomainsIdentityPropagationTrustsInvokeArgs Empty => new GetDomainsIdentityPropagationTrustsInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsIdentityPropagationTrustsResult
    {
        ...
        public readonly int? IdentityPropagationTrustCount;
        public readonly string? IdentityPropagationTrustFilter;
        /// <summary>
        /// The list of identity_propagation_trusts.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsIdentityPropagationTrustsIdentityPropagationTrustResult> IdentityPropagationTrusts;
        ...
        [OutputConstructor]
        private GetDomainsIdentityPropagationTrustsResult(
            ...
            int? identityPropagationTrustCount,

            string? identityPropagationTrustFilter,

            ImmutableArray<Outputs.GetDomainsIdentityPropagationTrustsIdentityPropagationTrustResult> identityPropagationTrusts,
            ...
            int totalResults)
        {
            ...
            IdentityPropagationTrustCount = identityPropagationTrustCount;
            IdentityPropagationTrustFilter = identityPropagationTrustFilter;
