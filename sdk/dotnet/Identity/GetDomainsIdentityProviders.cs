...
namespace Pulumi.Oci.Identity
{
    public static class GetDomainsIdentityProviders
    {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetDomainsIdentityProvidersResult> InvokeAsync(GetDomainsIdentityProvidersArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDomainsIdentityProvidersResult>("oci:Identity/getDomainsIdentityProviders:getDomainsIdentityProviders", args ?? new GetDomainsIdentityProvidersArgs(), options.WithDefaults());
    ...
    public sealed class GetDomainsIdentityProvidersArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("identityProviderCount")]
        public int? IdentityProviderCount { get; set; }
        ...
        public GetDomainsIdentityProvidersArgs()
        {
        }
        public static new GetDomainsIdentityProvidersArgs Empty => new GetDomainsIdentityProvidersArgs();
    }

    public sealed class GetDomainsIdentityProvidersInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("identityProviderCount")]
        public Input<int>? IdentityProviderCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("identityProviderFilter")]
        public Input<string>? IdentityProviderFilter { get; set; }
        ...
        public GetDomainsIdentityProvidersInvokeArgs()
        {
        }
        public static new GetDomainsIdentityProvidersInvokeArgs Empty => new GetDomainsIdentityProvidersInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsIdentityProvidersResult
    {
        ...
        public readonly int? IdentityProviderCount;
        public readonly string? IdentityProviderFilter;
        /// <summary>
        /// The list of identity_providers.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsIdentityProvidersIdentityProviderResult> IdentityProviders;
        ...
        private GetDomainsIdentityProvidersResult(
            ...
            int? identityProviderCount,

            string? identityProviderFilter,

            ImmutableArray<Outputs.GetDomainsIdentityProvidersIdentityProviderResult> identityProviders,
