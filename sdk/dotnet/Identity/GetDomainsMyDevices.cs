...
namespace Pulumi.Oci.Identity
{
    public static class GetDomainsMyDevices
    {
        ...
        /// ```
        /// </summary>
        public static Output<GetDomainsMyDevicesResult> Invoke(GetDomainsMyDevicesInvokeArgs args, InvokeOutputOptions options)
            => global::Pulumi.Deployment.Instance.Invoke<GetDomainsMyDevicesResult>("oci:Identity/getDomainsMyDevices:getDomainsMyDevices", args ?? new GetDomainsMyDevicesInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetDomainsMyDevicesArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        public GetDomainsMyDevicesArgs()
        {
        }
        public static new GetDomainsMyDevicesArgs Empty => new GetDomainsMyDevicesArgs();
    }

    public sealed class GetDomainsMyDevicesInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("myDeviceCount")]
        public Input<int>? MyDeviceCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("myDeviceFilter")]
        public Input<string>? MyDeviceFilter { get; set; }
        ...
        public GetDomainsMyDevicesInvokeArgs()
        {
        }
        public static new GetDomainsMyDevicesInvokeArgs Empty => new GetDomainsMyDevicesInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsMyDevicesResult
    {
        ...
        public readonly int? MyDeviceCount;
        public readonly string? MyDeviceFilter;
        /// <summary>
        /// The list of my_devices.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsMyDevicesMyDeviceResult> MyDevices;
        ...
        private GetDomainsMyDevicesResult(
            ...
            ImmutableArray<Outputs.GetDomainsMyDevicesMyDeviceResult> myDevices,
