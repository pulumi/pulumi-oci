...
namespace Pulumi.Oci.Identity
{
    public static class GetDomainsMyRequests
    {
        ...
        /// ```
        /// </summary>
        public static Task<GetDomainsMyRequestsResult> InvokeAsync(GetDomainsMyRequestsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDomainsMyRequestsResult>("oci:Identity/getDomainsMyRequests:getDomainsMyRequests", args ?? new GetDomainsMyRequestsArgs(), options.WithDefaults());
    ...
    public sealed class GetDomainsMyRequestsArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        public GetDomainsMyRequestsArgs()
        {
        }
        public static new GetDomainsMyRequestsArgs Empty => new GetDomainsMyRequestsArgs();
    }

    public sealed class GetDomainsMyRequestsInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("myRequestCount")]
        public Input<int>? MyRequestCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("myRequestFilter")]
        public Input<string>? MyRequestFilter { get; set; }
        ...
        public GetDomainsMyRequestsInvokeArgs()
        {
        }
        public static new GetDomainsMyRequestsInvokeArgs Empty => new GetDomainsMyRequestsInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsMyRequestsResult
    {
        ...
        public readonly int? MyRequestCount;
        public readonly string? MyRequestFilter;
        /// <summary>
        /// The list of my_requests.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsMyRequestsMyRequestResult> MyRequests;
        ...
        private GetDomainsMyRequestsResult(
            ...
            string? myRequestFilter,

            ImmutableArray<Outputs.GetDomainsMyRequestsMyRequestResult> myRequests,
