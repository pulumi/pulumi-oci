...
namespace Pulumi.Oci.Identity
{
    ...
    public sealed class GetDomainsMyTrustedUserAgentsArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        public GetDomainsMyTrustedUserAgentsArgs()
        {
        }
        public static new GetDomainsMyTrustedUserAgentsArgs Empty => new GetDomainsMyTrustedUserAgentsArgs();
    }

    public sealed class GetDomainsMyTrustedUserAgentsInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("myTrustedUserAgentCount")]
        public Input<int>? MyTrustedUserAgentCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("myTrustedUserAgentFilter")]
        public Input<string>? MyTrustedUserAgentFilter { get; set; }
        ...
        public GetDomainsMyTrustedUserAgentsInvokeArgs()
        {
        }
        public static new GetDomainsMyTrustedUserAgentsInvokeArgs Empty => new GetDomainsMyTrustedUserAgentsInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsMyTrustedUserAgentsResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsMyTrustedUserAgentsMyTrustedUserAgentResult> MyTrustedUserAgents;
        ...
        private GetDomainsMyTrustedUserAgentsResult(
            ...
            ImmutableArray<Outputs.GetDomainsMyTrustedUserAgentsMyTrustedUserAgentResult> myTrustedUserAgents,
