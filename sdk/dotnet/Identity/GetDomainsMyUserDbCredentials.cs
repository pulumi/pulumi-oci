...
namespace Pulumi.Oci.Identity
{
    ...
    public sealed class GetDomainsMyUserDbCredentialsArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetDomainsMyUserDbCredentialsArgs()
        {
        }
        public static new GetDomainsMyUserDbCredentialsArgs Empty => new GetDomainsMyUserDbCredentialsArgs();
    }

    public sealed class GetDomainsMyUserDbCredentialsInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// The Authorization field value consists of credentials containing the authentication information of the user agent for the realm of the resource being requested.
        /// </summary>
        ...
        /// </summary>
        [Input("myUserDbCredentialCount")]
        public Input<int>? MyUserDbCredentialCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("myUserDbCredentialFilter")]
        public Input<string>? MyUserDbCredentialFilter { get; set; }
        ...
        public GetDomainsMyUserDbCredentialsInvokeArgs()
        {
        }
        public static new GetDomainsMyUserDbCredentialsInvokeArgs Empty => new GetDomainsMyUserDbCredentialsInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsMyUserDbCredentialsResult
    {
        ...
        public readonly int? MyUserDbCredentialCount;
        public readonly string? MyUserDbCredentialFilter;
        /// <summary>
        /// The list of my_user_db_credentials.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsMyUserDbCredentialsMyUserDbCredentialResult> MyUserDbCredentials;
        ...
        private GetDomainsMyUserDbCredentialsResult(
            ...
            int? myUserDbCredentialCount,

            string? myUserDbCredentialFilter,

            ImmutableArray<Outputs.GetDomainsMyUserDbCredentialsMyUserDbCredentialResult> myUserDbCredentials,
