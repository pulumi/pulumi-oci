...
{
    public static class GetDomainsNetworkPerimeters
    {
        /// <summary>
    ...
    public sealed class GetDomainsNetworkPerimetersArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        public GetDomainsNetworkPerimetersArgs()
        {
        }
        public static new GetDomainsNetworkPerimetersArgs Empty => new GetDomainsNetworkPerimetersArgs();
    }

    public sealed class GetDomainsNetworkPerimetersInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("networkPerimeterCount")]
        public Input<int>? NetworkPerimeterCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("networkPerimeterFilter")]
        public Input<string>? NetworkPerimeterFilter { get; set; }
        ...
        public GetDomainsNetworkPerimetersInvokeArgs()
        {
        }
        public static new GetDomainsNetworkPerimetersInvokeArgs Empty => new GetDomainsNetworkPerimetersInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsNetworkPerimetersResult
    {
        ...
        public readonly int? NetworkPerimeterCount;
        public readonly string? NetworkPerimeterFilter;
        /// <summary>
        /// The list of network_perimeters.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsNetworkPerimetersNetworkPerimeterResult> NetworkPerimeters;
        ...
        [OutputConstructor]
        private GetDomainsNetworkPerimetersResult(
            ...
            int? networkPerimeterCount,

            string? networkPerimeterFilter,

            ImmutableArray<Outputs.GetDomainsNetworkPerimetersNetworkPerimeterResult> networkPerimeters,
