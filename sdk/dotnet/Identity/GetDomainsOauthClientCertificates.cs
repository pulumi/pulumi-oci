...
namespace Pulumi.Oci.Identity
{
    ...
    public sealed class GetDomainsOauthClientCertificatesArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("oauthClientCertificateCount")]
        public int? OauthClientCertificateCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("oauthClientCertificateFilter")]
        ...
        public GetDomainsOauthClientCertificatesArgs()
        {
        }
        public static new GetDomainsOauthClientCertificatesArgs Empty => new GetDomainsOauthClientCertificatesArgs();
    }

    public sealed class GetDomainsOauthClientCertificatesInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// The Authorization field value consists of credentials containing the authentication information of the user agent for the realm of the resource being requested.
        /// </summary>
        ...
        /// </summary>
        [Input("oauthClientCertificateCount")]
        public Input<int>? OauthClientCertificateCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("oauthClientCertificateFilter")]
        public Input<string>? OauthClientCertificateFilter { get; set; }
        ...
        public GetDomainsOauthClientCertificatesInvokeArgs()
        {
        }
        public static new GetDomainsOauthClientCertificatesInvokeArgs Empty => new GetDomainsOauthClientCertificatesInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsOauthClientCertificatesResult
    {
        ...
        public readonly int? OauthClientCertificateCount;
        public readonly string? OauthClientCertificateFilter;
        /// <summary>
        /// The list of oauth_client_certificates.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsOauthClientCertificatesOauthClientCertificateResult> OauthClientCertificates;
        ...
        [OutputConstructor]
        private GetDomainsOauthClientCertificatesResult(
            ...
            int? oauthClientCertificateCount,

            string? oauthClientCertificateFilter,

            ImmutableArray<Outputs.GetDomainsOauthClientCertificatesOauthClientCertificateResult> oauthClientCertificates,
