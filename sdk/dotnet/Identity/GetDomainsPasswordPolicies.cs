...
namespace Pulumi.Oci.Identity
{
    ...
    public sealed class GetDomainsPasswordPoliciesArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        public GetDomainsPasswordPoliciesArgs()
        {
        }
        public static new GetDomainsPasswordPoliciesArgs Empty => new GetDomainsPasswordPoliciesArgs();
    }

    public sealed class GetDomainsPasswordPoliciesInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("passwordPolicyCount")]
        public Input<int>? PasswordPolicyCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("passwordPolicyFilter")]
        public Input<string>? PasswordPolicyFilter { get; set; }
        ...
        public GetDomainsPasswordPoliciesInvokeArgs()
        {
        }
        public static new GetDomainsPasswordPoliciesInvokeArgs Empty => new GetDomainsPasswordPoliciesInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsPasswordPoliciesResult
    {
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsPasswordPoliciesPasswordPolicyResult> PasswordPolicies;
        public readonly int? PasswordPolicyCount;
        public readonly string? PasswordPolicyFilter;
        ...
        private GetDomainsPasswordPoliciesResult(
            ...
            int? passwordPolicyCount,

            string? passwordPolicyFilter,
            ...
            int? totalResults)
        {
            ...
            PasswordPolicyCount = passwordPolicyCount;
            PasswordPolicyFilter = passwordPolicyFilter;
