...
{
    public static class GetDomainsSecurityQuestions
    {
        /// <summary>
    ...
    public sealed class GetDomainsSecurityQuestionsArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        public GetDomainsSecurityQuestionsArgs()
        {
        }
        public static new GetDomainsSecurityQuestionsArgs Empty => new GetDomainsSecurityQuestionsArgs();
    }

    public sealed class GetDomainsSecurityQuestionsInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("securityQuestionCount")]
        public Input<int>? SecurityQuestionCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("securityQuestionFilter")]
        public Input<string>? SecurityQuestionFilter { get; set; }
        ...
        public GetDomainsSecurityQuestionsInvokeArgs()
        {
        }
        public static new GetDomainsSecurityQuestionsInvokeArgs Empty => new GetDomainsSecurityQuestionsInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsSecurityQuestionsResult
    {
        ...
        public readonly int? SecurityQuestionCount;
        public readonly string? SecurityQuestionFilter;
        /// <summary>
        /// The list of security_questions.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsSecurityQuestionsSecurityQuestionResult> SecurityQuestions;
        ...
        private GetDomainsSecurityQuestionsResult(
            ...
            ImmutableArray<Outputs.GetDomainsSecurityQuestionsSecurityQuestionResult> securityQuestions,
