...
namespace Pulumi.Oci.Identity
{
    ...
    public sealed class GetDomainsSelfRegistrationProfilesArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("selfRegistrationProfileCount")]
        public int? SelfRegistrationProfileCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("selfRegistrationProfileFilter")]
        ...
        public GetDomainsSelfRegistrationProfilesArgs()
        {
        }
        public static new GetDomainsSelfRegistrationProfilesArgs Empty => new GetDomainsSelfRegistrationProfilesArgs();
    }

    public sealed class GetDomainsSelfRegistrationProfilesInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("selfRegistrationProfileCount")]
        public Input<int>? SelfRegistrationProfileCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("selfRegistrationProfileFilter")]
        public Input<string>? SelfRegistrationProfileFilter { get; set; }
        ...
        public GetDomainsSelfRegistrationProfilesInvokeArgs()
        {
        }
        public static new GetDomainsSelfRegistrationProfilesInvokeArgs Empty => new GetDomainsSelfRegistrationProfilesInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsSelfRegistrationProfilesResult
    {
        ...
        public readonly int? SelfRegistrationProfileCount;
        public readonly string? SelfRegistrationProfileFilter;
        /// <summary>
        /// The list of self_registration_profiles.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsSelfRegistrationProfilesSelfRegistrationProfileResult> SelfRegistrationProfiles;
        ...
        [OutputConstructor]
        private GetDomainsSelfRegistrationProfilesResult(
            ...
            int? selfRegistrationProfileCount,

            string? selfRegistrationProfileFilter,

            ImmutableArray<Outputs.GetDomainsSelfRegistrationProfilesSelfRegistrationProfileResult> selfRegistrationProfiles,
