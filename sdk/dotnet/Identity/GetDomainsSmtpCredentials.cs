...
namespace Pulumi.Oci.Identity
{
    public static class GetDomainsSmtpCredentials
    {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetDomainsSmtpCredentialsResult> InvokeAsync(GetDomainsSmtpCredentialsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDomainsSmtpCredentialsResult>("oci:Identity/getDomainsSmtpCredentials:getDomainsSmtpCredentials", args ?? new GetDomainsSmtpCredentialsArgs(), options.WithDefaults());
    ...
    public sealed class GetDomainsSmtpCredentialsArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        public GetDomainsSmtpCredentialsArgs()
        {
        }
        public static new GetDomainsSmtpCredentialsArgs Empty => new GetDomainsSmtpCredentialsArgs();
    }

    public sealed class GetDomainsSmtpCredentialsInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("smtpCredentialCount")]
        public Input<int>? SmtpCredentialCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("smtpCredentialFilter")]
        public Input<string>? SmtpCredentialFilter { get; set; }
        ...
        public GetDomainsSmtpCredentialsInvokeArgs()
        {
        }
        public static new GetDomainsSmtpCredentialsInvokeArgs Empty => new GetDomainsSmtpCredentialsInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsSmtpCredentialsResult
    {
        ...
        public readonly int? SmtpCredentialCount;
        public readonly string? SmtpCredentialFilter;
        /// <summary>
        /// The list of smtp_credentials.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsSmtpCredentialsSmtpCredentialResult> SmtpCredentials;
        ...
        private GetDomainsSmtpCredentialsResult(
            ...
            int? smtpCredentialCount,

            string? smtpCredentialFilter,

            ImmutableArray<Outputs.GetDomainsSmtpCredentialsSmtpCredentialResult> smtpCredentials,
