...
namespace Pulumi.Oci.Identity
{
    public static class GetDomainsUserDbCredentials
    {
        ...
        /// {{% /examples %}}
        /// </summary>
        public static Task<GetDomainsUserDbCredentialsResult> InvokeAsync(GetDomainsUserDbCredentialsArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetDomainsUserDbCredentialsResult>("oci:Identity/getDomainsUserDbCredentials:getDomainsUserDbCredentials", args ?? new GetDomainsUserDbCredentialsArgs(), options.WithDefaults());
    ...
    public sealed class GetDomainsUserDbCredentialsArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("userDbCredentialCount")]
        public int? UserDbCredentialCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("userDbCredentialFilter")]
        public string? UserDbCredentialFilter { get; set; }

        public GetDomainsUserDbCredentialsArgs()
        {
        }
        public static new GetDomainsUserDbCredentialsArgs Empty => new GetDomainsUserDbCredentialsArgs();
    }

    public sealed class GetDomainsUserDbCredentialsInvokeArgs : global::Pulumi.InvokeArgs
    {
        [Input("attributeSets")]
        ...
        /// </summary>
        [Input("userDbCredentialCount")]
        public Input<int>? UserDbCredentialCount { get; set; }

        /// <summary>
        /// OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
        /// </summary>
        [Input("userDbCredentialFilter")]
        public Input<string>? UserDbCredentialFilter { get; set; }

        public GetDomainsUserDbCredentialsInvokeArgs()
        {
        }
        public static new GetDomainsUserDbCredentialsInvokeArgs Empty => new GetDomainsUserDbCredentialsInvokeArgs();
    }


    [OutputType]
    public sealed class GetDomainsUserDbCredentialsResult
    {
        ...
        public readonly int? UserDbCredentialCount;
        public readonly string? UserDbCredentialFilter;
        /// <summary>
        /// The list of user_db_credentials.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetDomainsUserDbCredentialsUserDbCredentialResult> UserDbCredentials;
        ...
        private GetDomainsUserDbCredentialsResult(
            ...
            int? userDbCredentialCount,

            string? userDbCredentialFilter,

            ImmutableArray<Outputs.GetDomainsUserDbCredentialsUserDbCredentialResult> userDbCredentials)
        {
