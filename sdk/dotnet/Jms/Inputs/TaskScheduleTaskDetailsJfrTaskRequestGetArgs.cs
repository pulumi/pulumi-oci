...
namespace Pulumi.Oci.Jms.Inputs
{
    ...
    public sealed class TaskScheduleTaskDetailsJfrTaskRequestGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("targets")]
        private InputList<Inputs.TaskScheduleTaskDetailsJfrTaskRequestTargetGetArgs>? _targets;

        /// <summary>
        /// (Updatable) The attachment targets to start JFR.
        /// </summary>
        public InputList<Inputs.TaskScheduleTaskDetailsJfrTaskRequestTargetGetArgs> Targets
        {
            get => _targets ?? (_targets = new InputList<Inputs.TaskScheduleTaskDetailsJfrTaskRequestTargetGetArgs>());
            set => _targets = value;
        }
        ...
        public TaskScheduleTaskDetailsJfrTaskRequestGetArgs()
        {
        }
        public static new TaskScheduleTaskDetailsJfrTaskRequestGetArgs Empty => new TaskScheduleTaskDetailsJfrTaskRequestGetArgs();
    }
}
