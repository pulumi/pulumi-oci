...
namespace Pulumi.Oci.Jms
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:Jms/jmsPlugin:JmsPlugin")]
    public partial class JmsPlugin : global::Pulumi.CustomResource
    {
        ...
        public Output<string> OsArchitecture { get; private set; } = null!;

        /// <summary>
        /// The distribution of the operating system of the plugin.
        /// </summary>
        [Output("osDistribution")]
        public Output<string> OsDistribution { get; private set; } = null!;
        ...
        /// </summary>
        [Output("timeLastSeen")]
        public Output<string> TimeLastSeen { get; private set; } = null!;

        /// <summary>
        /// The date and time the plugin was registered.
        /// </summary>
        [Output("timeRegistered")]
        public Output<string> TimeRegistered { get; private set; } = null!;
        ...
        public JmsPlugin(string name, JmsPluginArgs args, CustomResourceOptions? options = null)
            : base("oci:Jms/jmsPlugin:JmsPlugin", name, args ?? new JmsPluginArgs(), MakeResourceOptions(options, ""))
        {
        }

        private JmsPlugin(string name, Input<string> id, JmsPluginState? state = null, CustomResourceOptions? options = null)
            : base("oci:Jms/jmsPlugin:JmsPlugin", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static JmsPlugin Get(string name, Input<string> id, JmsPluginState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class JmsPluginArgs : global::Pulumi.ResourceArgs
    {
        ...
        public JmsPluginArgs()
        {
        }
        public static new JmsPluginArgs Empty => new JmsPluginArgs();
    }
    ...
    public sealed class JmsPluginState : global::Pulumi.ResourceArgs
    {
        ...
        /// The distribution of the operating system of the plugin.
        /// </summary>
        [Input("osDistribution")]
        public Input<string>? OsDistribution { get; set; }
        ...
        /// </summary>
        [Input("timeLastSeen")]
        public Input<string>? TimeLastSeen { get; set; }

        /// <summary>
        /// The date and time the plugin was registered.
        /// </summary>
        [Input("timeRegistered")]
        public Input<string>? TimeRegistered { get; set; }

        public JmsPluginState()
        {
        }
        public static new JmsPluginState Empty => new JmsPluginState();
    }
}
