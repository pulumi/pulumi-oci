...
namespace Pulumi.Oci.Jms.Outputs
{
    ...
    [OutputType]
    public sealed class GetTaskScheduleTaskDetailScanJavaServerTaskRequestResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetTaskScheduleTaskDetailScanJavaServerTaskRequestResult(ImmutableArray<string> managedInstanceIds)
        {
