...
namespace Pulumi.Oci.Jms.Outputs
{
    ...
    [OutputType]
    public sealed class TaskScheduleTaskDetailsScanJavaServerTaskRequest
    {
        /// <summary>
        ...
        [OutputConstructor]
        private TaskScheduleTaskDetailsScanJavaServerTaskRequest(ImmutableArray<string> managedInstanceIds)
        {
