...
namespace Pulumi.Oci.LoadBalancer.Inputs
{
    ...
    public sealed class RuleSetItemGetArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("conditions")]
        private InputList<Inputs.RuleSetItemConditionGetArgs>? _conditions;

        /// <summary>
        /// (Updatable)
        /// </summary>
        public InputList<Inputs.RuleSetItemConditionGetArgs> Conditions
        {
            get => _conditions ?? (_conditions = new InputList<Inputs.RuleSetItemConditionGetArgs>());
        ...
        /// </summary>
        [Input("redirectUri")]
        public Input<Inputs.RuleSetItemRedirectUriGetArgs>? RedirectUri { get; set; }
