...
namespace Pulumi.Oci.MediaServices
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:MediaServices/mediaWorkflowConfiguration:MediaWorkflowConfiguration")]
    public partial class MediaWorkflowConfiguration : global::Pulumi.CustomResource
    {
        ...
        public MediaWorkflowConfiguration(string name, MediaWorkflowConfigurationArgs args, CustomResourceOptions? options = null)
            : base("oci:MediaServices/mediaWorkflowConfiguration:MediaWorkflowConfiguration", name, args ?? new MediaWorkflowConfigurationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private MediaWorkflowConfiguration(string name, Input<string> id, MediaWorkflowConfigurationState? state = null, CustomResourceOptions? options = null)
            : base("oci:MediaServices/mediaWorkflowConfiguration:MediaWorkflowConfiguration", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static MediaWorkflowConfiguration Get(string name, Input<string> id, MediaWorkflowConfigurationState? state = null, CustomResourceOptions? options = null)
        {
    ...
    public sealed class MediaWorkflowConfigurationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public MediaWorkflowConfigurationArgs()
        {
        }
        public static new MediaWorkflowConfigurationArgs Empty => new MediaWorkflowConfigurationArgs();
    }
    ...
    public sealed class MediaWorkflowConfigurationState : global::Pulumi.ResourceArgs
    {
        ...
        public MediaWorkflowConfigurationState()
        {
        }
        public static new MediaWorkflowConfigurationState Empty => new MediaWorkflowConfigurationState();
    }
}
