...
namespace Pulumi.Oci.MeteringComputation.Inputs
{
    ...
    public sealed class CustomTableSavedCustomTableGetArgs : Pulumi.ResourceArgs
    {
        ...
        [Input("groupByTags")]
        private InputList<Inputs.CustomTableSavedCustomTableGroupByTagGetArgs>? _groupByTags;
        ...
        /// </summary>
        public InputList<Inputs.CustomTableSavedCustomTableGroupByTagGetArgs> GroupByTags
        {
            get => _groupByTags ?? (_groupByTags = new InputList<Inputs.CustomTableSavedCustomTableGroupByTagGetArgs>());
