...
namespace Pulumi.Oci.MeteringComputation.Inputs
{
    ...
    public sealed class QueryQueryDefinitionReportQueryGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("forecast")]
        public Input<Inputs.QueryQueryDefinitionReportQueryForecastGetArgs>? Forecast { get; set; }
        ...
        [Input("groupByTags")]
        private InputList<Inputs.QueryQueryDefinitionReportQueryGroupByTagGetArgs>? _groupByTags;
        ...
        /// </summary>
        public InputList<Inputs.QueryQueryDefinitionReportQueryGroupByTagGetArgs> GroupByTags
        {
            get => _groupByTags ?? (_groupByTags = new InputList<Inputs.QueryQueryDefinitionReportQueryGroupByTagGetArgs>());
        ...
        public QueryQueryDefinitionReportQueryGetArgs()
        {
        }
        public static new QueryQueryDefinitionReportQueryGetArgs Empty => new QueryQueryDefinitionReportQueryGetArgs();
    }
}
