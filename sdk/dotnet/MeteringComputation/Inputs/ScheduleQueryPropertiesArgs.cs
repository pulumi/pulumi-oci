...
namespace Pulumi.Oci.MeteringComputation.Inputs
{
    ...
    public sealed class ScheduleQueryPropertiesArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.ScheduleQueryPropertiesDateRangeArgs> DateRange { get; set; } = null!;
        ...
        [Input("groupByTags")]
        private InputList<Inputs.ScheduleQueryPropertiesGroupByTagArgs>? _groupByTags;

        /// <summary>
        /// GroupBy a specific tagKey. Provide the tagNamespace and tagKey in the tag object. Only supports one tag in the list. For example: [ { "namespace": "oracle", "key": "createdBy" ]
        /// </summary>
        public InputList<Inputs.ScheduleQueryPropertiesGroupByTagArgs> GroupByTags
        {
            get => _groupByTags ?? (_groupByTags = new InputList<Inputs.ScheduleQueryPropertiesGroupByTagArgs>());
