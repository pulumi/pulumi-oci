...
namespace Pulumi.Oci.MeteringComputation.Inputs
{
    ...
    public sealed class UsageCarbonEmissionsQueryQueryDefinitionGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) The common fields for Cost Analysis UI rendering.
        /// </summary>
        [Input("costAnalysisUi", required: true)]
        public Input<Inputs.UsageCarbonEmissionsQueryQueryDefinitionCostAnalysisUiGetArgs> CostAnalysisUi { get; set; } = null!;
        ...
        public UsageCarbonEmissionsQueryQueryDefinitionGetArgs()
        {
        }
        public static new UsageCarbonEmissionsQueryQueryDefinitionGetArgs Empty => new UsageCarbonEmissionsQueryQueryDefinitionGetArgs();
    }
}
