...
namespace Pulumi.Oci.Mysql.Inputs
{
    ...
    public sealed class MysqlDbSystemChannelArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("sources")]
        private InputList<Inputs.MysqlDbSystemChannelSourceArgs>? _sources;

        /// <summary>
        /// Parameters detailing how to provision the initial data of the system.
        /// </summary>
        public InputList<Inputs.MysqlDbSystemChannelSourceArgs> Sources
        {
            get => _sources ?? (_sources = new InputList<Inputs.MysqlDbSystemChannelSourceArgs>());
            set => _sources = value;
        }
        ...
        /// </summary>
        public InputList<Inputs.MysqlDbSystemChannelTargetArgs> Targets
        {
            get => _targets ?? (_targets = new InputList<Inputs.MysqlDbSystemChannelTargetArgs>());
            set => _targets = value;
        }
