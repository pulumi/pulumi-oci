...
namespace Pulumi.Oci.Mysql.Inputs
{
    ...
    public sealed class MysqlDbSystemChannelSourceGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.MysqlDbSystemChannelSourceSslCaCertificateGetArgs>? _sslCaCertificates;

        /// <summary>
        /// The CA certificate of the server used for VERIFY_IDENTITY and VERIFY_CA ssl modes.
        /// </summary>
        public InputList<Inputs.MysqlDbSystemChannelSourceSslCaCertificateGetArgs> SslCaCertificates
        {
            get => _sslCaCertificates ?? (_sslCaCertificates = new InputList<Inputs.MysqlDbSystemChannelSourceSslCaCertificateGetArgs>());
        ...
        public MysqlDbSystemChannelSourceGetArgs()
        {
        }
        public static new MysqlDbSystemChannelSourceGetArgs Empty => new MysqlDbSystemChannelSourceGetArgs();
    }
}
