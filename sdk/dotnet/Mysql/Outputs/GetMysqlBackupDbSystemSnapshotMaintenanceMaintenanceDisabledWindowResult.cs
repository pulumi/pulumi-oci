...
namespace Pulumi.Oci.Mysql.Outputs
{
    ...
    [OutputType]
    public sealed class GetMysqlBackupDbSystemSnapshotMaintenanceMaintenanceDisabledWindowResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetMysqlBackupDbSystemSnapshotMaintenanceMaintenanceDisabledWindowResult(
            string timeEnd,
