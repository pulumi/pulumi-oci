...
namespace Pulumi.Oci.Oci
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:oci/dbmulticloudOracleDbAzureVaultAssociation:DbmulticloudOracleDbAzureVaultAssociation")]
    public partial class DbmulticloudOracleDbAzureVaultAssociation : global::Pulumi.CustomResource
    {
        ...
        public DbmulticloudOracleDbAzureVaultAssociation(string name, DbmulticloudOracleDbAzureVaultAssociationArgs args, CustomResourceOptions? options = null)
            : base("oci:oci/dbmulticloudOracleDbAzureVaultAssociation:DbmulticloudOracleDbAzureVaultAssociation", name, args ?? new DbmulticloudOracleDbAzureVaultAssociationArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DbmulticloudOracleDbAzureVaultAssociation(string name, Input<string> id, DbmulticloudOracleDbAzureVaultAssociationState? state = null, CustomResourceOptions? options = null)
            : base("oci:oci/dbmulticloudOracleDbAzureVaultAssociation:DbmulticloudOracleDbAzureVaultAssociation", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static DbmulticloudOracleDbAzureVaultAssociation Get(string name, Input<string> id, DbmulticloudOracleDbAzureVaultAssociationState? state = null, CustomResourceOptions? options = null)
        {
            return new DbmulticloudOracleDbAzureVaultAssociation(name, id, state, options);
        }
    }
    ...
    public sealed class DbmulticloudOracleDbAzureVaultAssociationArgs : global::Pulumi.ResourceArgs
    {
        ...
        public DbmulticloudOracleDbAzureVaultAssociationArgs()
        {
        }
        public static new DbmulticloudOracleDbAzureVaultAssociationArgs Empty => new DbmulticloudOracleDbAzureVaultAssociationArgs();
    }
    ...
    public sealed class DbmulticloudOracleDbAzureVaultAssociationState : global::Pulumi.ResourceArgs
    {
        ...
        public DbmulticloudOracleDbAzureVaultAssociationState()
        {
        }
        public static new DbmulticloudOracleDbAzureVaultAssociationState Empty => new DbmulticloudOracleDbAzureVaultAssociationState();
    }
}
