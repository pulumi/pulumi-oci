...
{
    [Obsolete(@"oci.oci/getlustrefilestoragelustrefilesystem.getLustreFileStorageLustreFileSystem has been deprecated in favor of oci.lustre/getfilestoragelustrefilesystem.getFileStorageLustreFileSystem")]
    public static class GetLustreFileStorageLustreFileSystem
    {
        /// <summary>
        ...
        /// ```
        /// </summary>
        public static Task<GetLustreFileStorageLustreFileSystemResult> InvokeAsync(GetLustreFileStorageLustreFileSystemArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetLustreFileStorageLustreFileSystemResult>("oci:oci/getLustreFileStorageLustreFileSystem:getLustreFileStorageLustreFileSystem", args ?? new GetLustreFileStorageLustreFileSystemArgs(), options.WithDefaults());
        ...
        /// ```
        /// </summary>
        public static Output<GetLustreFileStorageLustreFileSystemResult> Invoke(GetLustreFileStorageLustreFileSystemInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetLustreFileStorageLustreFileSystemResult>("oci:oci/getLustreFileStorageLustreFileSystem:getLustreFileStorageLustreFileSystem", args ?? new GetLustreFileStorageLustreFileSystemInvokeArgs(), options.WithDefaults());
        ...
        /// ```
        /// </summary>
        public static Output<GetLustreFileStorageLustreFileSystemResult> Invoke(GetLustreFileStorageLustreFileSystemInvokeArgs args, InvokeOutputOptions options)
            => global::Pulumi.Deployment.Instance.Invoke<GetLustreFileStorageLustreFileSystemResult>("oci:oci/getLustreFileStorageLustreFileSystem:getLustreFileStorageLustreFileSystem", args ?? new GetLustreFileStorageLustreFileSystemInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetLustreFileStorageLustreFileSystemArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public string LustreFileSystemId { get; set; } = null!;

        public GetLustreFileStorageLustreFileSystemArgs()
        {
        }
        public static new GetLustreFileStorageLustreFileSystemArgs Empty => new GetLustreFileStorageLustreFileSystemArgs();
    }

    public sealed class GetLustreFileStorageLustreFileSystemInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Lustre file system.
        /// </summary>
        ...
        public GetLustreFileStorageLustreFileSystemInvokeArgs()
        {
        }
        public static new GetLustreFileStorageLustreFileSystemInvokeArgs Empty => new GetLustreFileStorageLustreFileSystemInvokeArgs();
    }


    [OutputType]
    public sealed class GetLustreFileStorageLustreFileSystemResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetLustreFileStorageLustreFileSystemMaintenanceWindowResult> MaintenanceWindows;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetLustreFileStorageLustreFileSystemRootSquashConfigurationResult> RootSquashConfigurations;
        /// <summary>
        ...
        private GetLustreFileStorageLustreFileSystemResult(
            ...
            ImmutableArray<Outputs.GetLustreFileStorageLustreFileSystemMaintenanceWindowResult> maintenanceWindows,
            ...
            ImmutableArray<Outputs.GetLustreFileStorageLustreFileSystemRootSquashConfigurationResult> rootSquashConfigurations,
