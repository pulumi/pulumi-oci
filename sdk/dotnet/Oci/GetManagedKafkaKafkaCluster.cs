...
namespace Pulumi.Oci.Oci
{
    public static class GetManagedKafkaKafkaCluster
    {
        ...
        /// ```
        /// </summary>
        public static Task<GetManagedKafkaKafkaClusterResult> InvokeAsync(GetManagedKafkaKafkaClusterArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetManagedKafkaKafkaClusterResult>("oci:oci/getManagedKafkaKafkaCluster:getManagedKafkaKafkaCluster", args ?? new GetManagedKafkaKafkaClusterArgs(), options.WithDefaults());
        ...
        /// ```
        /// </summary>
        public static Output<GetManagedKafkaKafkaClusterResult> Invoke(GetManagedKafkaKafkaClusterInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetManagedKafkaKafkaClusterResult>("oci:oci/getManagedKafkaKafkaCluster:getManagedKafkaKafkaCluster", args ?? new GetManagedKafkaKafkaClusterInvokeArgs(), options.WithDefaults());
        ...
        /// ```
        /// </summary>
        public static Output<GetManagedKafkaKafkaClusterResult> Invoke(GetManagedKafkaKafkaClusterInvokeArgs args, InvokeOutputOptions options)
            => global::Pulumi.Deployment.Instance.Invoke<GetManagedKafkaKafkaClusterResult>("oci:oci/getManagedKafkaKafkaCluster:getManagedKafkaKafkaCluster", args ?? new GetManagedKafkaKafkaClusterInvokeArgs(), options.WithDefaults());
    }


    public sealed class GetManagedKafkaKafkaClusterArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        ...
        public GetManagedKafkaKafkaClusterArgs()
        {
        }
        public static new GetManagedKafkaKafkaClusterArgs Empty => new GetManagedKafkaKafkaClusterArgs();
    }

    public sealed class GetManagedKafkaKafkaClusterInvokeArgs : global::Pulumi.InvokeArgs
    {
        /// <summary>
        /// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the KafkaCluster.
        /// </summary>
        ...
        public GetManagedKafkaKafkaClusterInvokeArgs()
        {
        }
        public static new GetManagedKafkaKafkaClusterInvokeArgs Empty => new GetManagedKafkaKafkaClusterInvokeArgs();
    }


    [OutputType]
    public sealed class GetManagedKafkaKafkaClusterResult
    {
        /// <summary>
        /// Subnets where broker/coordinator VNICs will be created.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetManagedKafkaKafkaClusterAccessSubnetResult> AccessSubnets;
        /// <summary>
        /// Configuration of the broker node.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetManagedKafkaKafkaClusterBrokerShapeResult> BrokerShapes;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetManagedKafkaKafkaClusterKafkaBootstrapUrlResult> KafkaBootstrapUrls;
        ...
        private GetManagedKafkaKafkaClusterResult(
            ImmutableArray<Outputs.GetManagedKafkaKafkaClusterAccessSubnetResult> accessSubnets,

            ImmutableArray<Outputs.GetManagedKafkaKafkaClusterBrokerShapeResult> brokerShapes,
            ...
            ImmutableArray<Outputs.GetManagedKafkaKafkaClusterKafkaBootstrapUrlResult> kafkaBootstrapUrls,
