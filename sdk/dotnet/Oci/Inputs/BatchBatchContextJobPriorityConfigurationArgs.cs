...
namespace Pulumi.Oci.Oci.Inputs
{
    ...
    public sealed class BatchBatchContextJobPriorityConfigurationArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public BatchBatchContextJobPriorityConfigurationArgs()
        {
        }
        public static new BatchBatchContextJobPriorityConfigurationArgs Empty => new BatchBatchContextJobPriorityConfigurationArgs();
    }
}
