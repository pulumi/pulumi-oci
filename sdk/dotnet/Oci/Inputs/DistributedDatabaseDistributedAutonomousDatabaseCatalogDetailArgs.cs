...
namespace Pulumi.Oci.Oci.Inputs
{
    ...
    public sealed class DistributedDatabaseDistributedAutonomousDatabaseCatalogDetailArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("metadatas")]
        private InputList<Inputs.DistributedDatabaseDistributedAutonomousDatabaseCatalogDetailMetadataArgs>? _metadatas;

        /// <summary>
        /// Additional metadata related to Globally distributed autonomous database resources.
        /// </summary>
        public InputList<Inputs.DistributedDatabaseDistributedAutonomousDatabaseCatalogDetailMetadataArgs> Metadatas
        {
            get => _metadatas ?? (_metadatas = new InputList<Inputs.DistributedDatabaseDistributedAutonomousDatabaseCatalogDetailMetadataArgs>());
        ...
        [Input("peerDetails")]
        private InputList<Inputs.DistributedDatabaseDistributedAutonomousDatabaseCatalogDetailPeerDetailArgs>? _peerDetails;

        /// <summary>
        /// The details required for creation of the peer for the autonomous dedicated infrastructure based catalog.
        /// </summary>
        public InputList<Inputs.DistributedDatabaseDistributedAutonomousDatabaseCatalogDetailPeerDetailArgs> PeerDetails
        {
            get => _peerDetails ?? (_peerDetails = new InputList<Inputs.DistributedDatabaseDistributedAutonomousDatabaseCatalogDetailPeerDetailArgs>());
        ...
        public DistributedDatabaseDistributedAutonomousDatabaseCatalogDetailArgs()
        {
        }
        public static new DistributedDatabaseDistributedAutonomousDatabaseCatalogDetailArgs Empty => new DistributedDatabaseDistributedAutonomousDatabaseCatalogDetailArgs();
    }
}
