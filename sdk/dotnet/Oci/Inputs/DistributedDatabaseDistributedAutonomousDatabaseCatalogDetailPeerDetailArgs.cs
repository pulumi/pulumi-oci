...
namespace Pulumi.Oci.Oci.Inputs
{
    ...
    public sealed class DistributedDatabaseDistributedAutonomousDatabaseCatalogDetailPeerDetailArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("metadatas")]
        private InputList<Inputs.DistributedDatabaseDistributedAutonomousDatabaseCatalogDetailPeerDetailMetadataArgs>? _metadatas;

        /// <summary>
        /// Additional metadata related to Globally distributed autonomous database resources.
        /// </summary>
        public InputList<Inputs.DistributedDatabaseDistributedAutonomousDatabaseCatalogDetailPeerDetailMetadataArgs> Metadatas
        {
            get => _metadatas ?? (_metadatas = new InputList<Inputs.DistributedDatabaseDistributedAutonomousDatabaseCatalogDetailPeerDetailMetadataArgs>());
        ...
        public DistributedDatabaseDistributedAutonomousDatabaseCatalogDetailPeerDetailArgs()
        {
        }
        public static new DistributedDatabaseDistributedAutonomousDatabaseCatalogDetailPeerDetailArgs Empty => new DistributedDatabaseDistributedAutonomousDatabaseCatalogDetailPeerDetailArgs();
    }
}
