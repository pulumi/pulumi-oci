...
namespace Pulumi.Oci.Oci.Inputs
{
    ...
    public sealed class DistributedDatabaseDistributedAutonomousDatabaseShardDetailArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("metadatas")]
        private InputList<Inputs.DistributedDatabaseDistributedAutonomousDatabaseShardDetailMetadataArgs>? _metadatas;

        /// <summary>
        /// Additional metadata related to Globally distributed autonomous database resources.
        /// </summary>
        public InputList<Inputs.DistributedDatabaseDistributedAutonomousDatabaseShardDetailMetadataArgs> Metadatas
        {
            get => _metadatas ?? (_metadatas = new InputList<Inputs.DistributedDatabaseDistributedAutonomousDatabaseShardDetailMetadataArgs>());
        ...
        [Input("peerDetails")]
        private InputList<Inputs.DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailArgs>? _peerDetails;

        /// <summary>
        /// The details required for creation of the peer for the autonomous dedicated infrastructure based shard.
        /// </summary>
        public InputList<Inputs.DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailArgs> PeerDetails
        {
            get => _peerDetails ?? (_peerDetails = new InputList<Inputs.DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailArgs>());
        ...
        public DistributedDatabaseDistributedAutonomousDatabaseShardDetailArgs()
        {
        }
        public static new DistributedDatabaseDistributedAutonomousDatabaseShardDetailArgs Empty => new DistributedDatabaseDistributedAutonomousDatabaseShardDetailArgs();
    }
}
