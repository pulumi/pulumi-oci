...
namespace Pulumi.Oci.Oci.Inputs
{
    ...
    public sealed class DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("metadatas")]
        private InputList<Inputs.DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailMetadataGetArgs>? _metadatas;

        /// <summary>
        /// Additional metadata related to Globally distributed autonomous database resources.
        /// </summary>
        public InputList<Inputs.DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailMetadataGetArgs> Metadatas
        {
            get => _metadatas ?? (_metadatas = new InputList<Inputs.DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailMetadataGetArgs>());
        ...
        public DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailGetArgs()
        {
        }
        public static new DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailGetArgs Empty => new DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailGetArgs();
    }
}
