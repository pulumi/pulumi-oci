...
namespace Pulumi.Oci.Oci.Inputs
{
    ...
    public sealed class DistributedDatabaseDistributedDatabaseCatalogDetailGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Inputs.DistributedDatabaseDistributedDatabaseCatalogDetailDbStorageVaultDetailsGetArgs>? DbStorageVaultDetails { get; set; }
        ...
        [Input("metadatas")]
        private InputList<Inputs.DistributedDatabaseDistributedDatabaseCatalogDetailMetadataGetArgs>? _metadatas;

        /// <summary>
        /// Additional metadata related to Globally distributed database resources.
        /// </summary>
        public InputList<Inputs.DistributedDatabaseDistributedDatabaseCatalogDetailMetadataGetArgs> Metadatas
        {
            get => _metadatas ?? (_metadatas = new InputList<Inputs.DistributedDatabaseDistributedDatabaseCatalogDetailMetadataGetArgs>());
        ...
        [Input("peerDetails")]
        private InputList<Inputs.DistributedDatabaseDistributedDatabaseCatalogDetailPeerDetailGetArgs>? _peerDetails;

        /// <summary>
        /// The details required for creation of the peer for the ExadbXs infrastructure based catalog.
        /// </summary>
        public InputList<Inputs.DistributedDatabaseDistributedDatabaseCatalogDetailPeerDetailGetArgs> PeerDetails
        {
            get => _peerDetails ?? (_peerDetails = new InputList<Inputs.DistributedDatabaseDistributedDatabaseCatalogDetailPeerDetailGetArgs>());
        ...
        public Input<Inputs.DistributedDatabaseDistributedDatabaseCatalogDetailVmClusterDetailsGetArgs>? VmClusterDetails { get; set; }
        ...
        public DistributedDatabaseDistributedDatabaseCatalogDetailGetArgs()
        {
        }
        public static new DistributedDatabaseDistributedDatabaseCatalogDetailGetArgs Empty => new DistributedDatabaseDistributedDatabaseCatalogDetailGetArgs();
    }
}
