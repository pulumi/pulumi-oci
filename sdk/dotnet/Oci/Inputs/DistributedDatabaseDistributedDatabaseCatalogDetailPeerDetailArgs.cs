...
namespace Pulumi.Oci.Oci.Inputs
{
    ...
    public sealed class DistributedDatabaseDistributedDatabaseCatalogDetailPeerDetailArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.DistributedDatabaseDistributedDatabaseCatalogDetailPeerDetailDbStorageVaultDetailsArgs>? DbStorageVaultDetails { get; set; }

        [Input("metadatas")]
        private InputList<Inputs.DistributedDatabaseDistributedDatabaseCatalogDetailPeerDetailMetadataArgs>? _metadatas;

        /// <summary>
        /// Additional metadata related to Globally distributed database resources.
        /// </summary>
        public InputList<Inputs.DistributedDatabaseDistributedDatabaseCatalogDetailPeerDetailMetadataArgs> Metadatas
        {
            get => _metadatas ?? (_metadatas = new InputList<Inputs.DistributedDatabaseDistributedDatabaseCatalogDetailPeerDetailMetadataArgs>());
        ...
        public Input<Inputs.DistributedDatabaseDistributedDatabaseCatalogDetailPeerDetailVmClusterDetailsArgs>? VmClusterDetails { get; set; }
        ...
        public DistributedDatabaseDistributedDatabaseCatalogDetailPeerDetailArgs()
        {
        }
        public static new DistributedDatabaseDistributedDatabaseCatalogDetailPeerDetailArgs Empty => new DistributedDatabaseDistributedDatabaseCatalogDetailPeerDetailArgs();
    }
}
