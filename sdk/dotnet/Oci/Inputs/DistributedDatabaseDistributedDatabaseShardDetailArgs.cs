...
namespace Pulumi.Oci.Oci.Inputs
{
    ...
    public sealed class DistributedDatabaseDistributedDatabaseShardDetailArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("metadatas")]
        private InputList<Inputs.DistributedDatabaseDistributedDatabaseShardDetailMetadataArgs>? _metadatas;

        /// <summary>
        /// Additional metadata related to Globally distributed database resources.
        /// </summary>
        public InputList<Inputs.DistributedDatabaseDistributedDatabaseShardDetailMetadataArgs> Metadatas
        {
            get => _metadatas ?? (_metadatas = new InputList<Inputs.DistributedDatabaseDistributedDatabaseShardDetailMetadataArgs>());
        ...
        [Input("peerDetails")]
        private InputList<Inputs.DistributedDatabaseDistributedDatabaseShardDetailPeerDetailArgs>? _peerDetails;

        /// <summary>
        /// The details required for creation of the peer for the ExadbXs infrastructure based shard.
        /// </summary>
        public InputList<Inputs.DistributedDatabaseDistributedDatabaseShardDetailPeerDetailArgs> PeerDetails
        {
            get => _peerDetails ?? (_peerDetails = new InputList<Inputs.DistributedDatabaseDistributedDatabaseShardDetailPeerDetailArgs>());
        ...
        public static new DistributedDatabaseDistributedDatabaseShardDetailArgs Empty => new DistributedDatabaseDistributedDatabaseShardDetailArgs();
    }
}
