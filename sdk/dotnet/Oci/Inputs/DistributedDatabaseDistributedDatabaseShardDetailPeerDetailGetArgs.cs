...
namespace Pulumi.Oci.Oci.Inputs
{
    ...
    public sealed class DistributedDatabaseDistributedDatabaseShardDetailPeerDetailGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.DistributedDatabaseDistributedDatabaseShardDetailPeerDetailDbStorageVaultDetailsGetArgs>? DbStorageVaultDetails { get; set; }

        [Input("metadatas")]
        private InputList<Inputs.DistributedDatabaseDistributedDatabaseShardDetailPeerDetailMetadataGetArgs>? _metadatas;

        /// <summary>
        /// Additional metadata related to Globally distributed database resources.
        /// </summary>
        public InputList<Inputs.DistributedDatabaseDistributedDatabaseShardDetailPeerDetailMetadataGetArgs> Metadatas
        {
            get => _metadatas ?? (_metadatas = new InputList<Inputs.DistributedDatabaseDistributedDatabaseShardDetailPeerDetailMetadataGetArgs>());
        ...
        public Input<Inputs.DistributedDatabaseDistributedDatabaseShardDetailPeerDetailVmClusterDetailsGetArgs>? VmClusterDetails { get; set; }
        ...
        public DistributedDatabaseDistributedDatabaseShardDetailPeerDetailGetArgs()
        {
        }
        public static new DistributedDatabaseDistributedDatabaseShardDetailPeerDetailGetArgs Empty => new DistributedDatabaseDistributedDatabaseShardDetailPeerDetailGetArgs();
    }
}
