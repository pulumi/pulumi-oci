...
namespace Pulumi.Oci.Oci
{
    ...
    /// ```
    /// </summary>
    [Obsolete(@"oci.oci/lustrefilestoragelustrefilesystem.LustreFileStorageLustreFileSystem has been deprecated in favor of oci.lustre/filestoragelustrefilesystem.FileStorageLustreFileSystem")]
    [OciResourceType("oci:oci/lustreFileStorageLustreFileSystem:LustreFileStorageLustreFileSystem")]
    public partial class LustreFileStorageLustreFileSystem : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        public Output<ImmutableArray<Outputs.LustreFileStorageLustreFileSystemMaintenanceWindow>> MaintenanceWindows { get; private set; } = null!;
        ...
        public Output<Outputs.LustreFileStorageLustreFileSystemRootSquashConfiguration> RootSquashConfiguration { get; private set; } = null!;
        ...
        public LustreFileStorageLustreFileSystem(string name, LustreFileStorageLustreFileSystemArgs args, CustomResourceOptions? options = null)
            : base("oci:oci/lustreFileStorageLustreFileSystem:LustreFileStorageLustreFileSystem", name, args ?? new LustreFileStorageLustreFileSystemArgs(), MakeResourceOptions(options, ""))
        {
        }

        private LustreFileStorageLustreFileSystem(string name, Input<string> id, LustreFileStorageLustreFileSystemState? state = null, CustomResourceOptions? options = null)
            : base("oci:oci/lustreFileStorageLustreFileSystem:LustreFileStorageLustreFileSystem", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static LustreFileStorageLustreFileSystem Get(string name, Input<string> id, LustreFileStorageLustreFileSystemState? state = null, CustomResourceOptions? options = null)
        {
            return new LustreFileStorageLustreFileSystem(name, id, state, options);
        }
    }

    public sealed class LustreFileStorageLustreFileSystemArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The availability domain the file system is in. May be unset as a blank or NULL value.  Example: `Uocm:PHX-AD-1`
        /// </summary>
        ...
        public Input<Inputs.LustreFileStorageLustreFileSystemRootSquashConfigurationArgs> RootSquashConfiguration { get; set; } = null!;
        ...
        public LustreFileStorageLustreFileSystemArgs()
        {
        }
        public static new LustreFileStorageLustreFileSystemArgs Empty => new LustreFileStorageLustreFileSystemArgs();
    }

    public sealed class LustreFileStorageLustreFileSystemState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The availability domain the file system is in. May be unset as a blank or NULL value.  Example: `Uocm:PHX-AD-1`
        /// </summary>
        ...
        private InputList<Inputs.LustreFileStorageLustreFileSystemMaintenanceWindowGetArgs>? _maintenanceWindows;

        /// <summary>
        /// The preferred day and time to perform maintenance.
        /// </summary>
        public InputList<Inputs.LustreFileStorageLustreFileSystemMaintenanceWindowGetArgs> MaintenanceWindows
        {
            get => _maintenanceWindows ?? (_maintenanceWindows = new InputList<Inputs.LustreFileStorageLustreFileSystemMaintenanceWindowGetArgs>());
        ...
        public Input<Inputs.LustreFileStorageLustreFileSystemRootSquashConfigurationGetArgs>? RootSquashConfiguration { get; set; }
        ...
        public LustreFileStorageLustreFileSystemState()
        {
        }
        public static new LustreFileStorageLustreFileSystemState Empty => new LustreFileStorageLustreFileSystemState();
    }
}
