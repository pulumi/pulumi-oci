...
namespace Pulumi.Oci.Oci.Outputs
{
    ...
    [OutputType]
    public sealed class BatchBatchContextNetwork
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.BatchBatchContextNetworkVnic> Vnics;
        ...
        private BatchBatchContextNetwork(
            ...
            ImmutableArray<Outputs.BatchBatchContextNetworkVnic> vnics)
        {
            NsgIds = nsgIds;
            SubnetId = subnetId;
            Vnics = vnics;
