...
namespace Pulumi.Oci.Oci.Outputs
{
    ...
    [OutputType]
    public sealed class DifStackOkeSecret
    {
        /// <summary>
        /// List of kubernetes secret data.
        /// </summary>
        public readonly ImmutableArray<Outputs.DifStackOkeSecretSecretData> SecretDatas;
        /// <summary>
        ...
        private DifStackOkeSecret(
            ImmutableArray<Outputs.DifStackOkeSecretSecretData> secretDatas,
