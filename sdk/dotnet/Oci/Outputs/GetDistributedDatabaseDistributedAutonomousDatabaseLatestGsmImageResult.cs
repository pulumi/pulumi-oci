...
namespace Pulumi.Oci.Oci.Outputs
{
    ...
    [OutputType]
    public sealed class GetDistributedDatabaseDistributedAutonomousDatabaseLatestGsmImageResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetDistributedDatabaseDistributedAutonomousDatabaseLatestGsmImageResult(
            string id,
