...
namespace Pulumi.Oci.Oci.Outputs
{
    ...
    [OutputType]
    public sealed class GetDistributedDatabaseDistributedDatabaseGsmDetailGsmImageDetailResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetDistributedDatabaseDistributedDatabaseGsmDetailGsmImageDetailResult(
            string id,
