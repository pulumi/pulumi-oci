...
namespace Pulumi.Oci.Oci.Outputs
{
    ...
    [OutputType]
    public sealed class GetDistributedDatabaseDistributedDatabaseLatestGsmImageDetailResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetDistributedDatabaseDistributedDatabaseLatestGsmImageDetailResult(
            string id,
