...
namespace Pulumi.Oci.Oci.Outputs
{
    ...
    [OutputType]
    public sealed class GetManagedKafkaKafkaClusterConfigsKafkaClusterConfigCollectionItemLatestConfigResult
    {
        /// <summary>
        ...
        [OutputConstructor]
        private GetManagedKafkaKafkaClusterConfigsKafkaClusterConfigCollectionItemLatestConfigResult(
            string configId,
