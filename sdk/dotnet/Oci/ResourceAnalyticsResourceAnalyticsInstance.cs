...
namespace Pulumi.Oci.Oci
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:oci/resourceAnalyticsResourceAnalyticsInstance:ResourceAnalyticsResourceAnalyticsInstance")]
    public partial class ResourceAnalyticsResourceAnalyticsInstance : global::Pulumi.CustomResource
    {
        /// <summary>
        ...
        /// </summary>
        [Output("adwAdminPassword")]
        public Output<Outputs.ResourceAnalyticsResourceAnalyticsInstanceAdwAdminPassword> AdwAdminPassword { get; private set; } = null!;

        /// <summary>
        /// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the created ADW instance.
        /// </summary>
        [Output("adwId")]
        public Output<string> AdwId { get; private set; } = null!;
        ...
        /// </summary>
        [Output("isMutualTlsRequired")]
        public Output<bool> IsMutualTlsRequired { get; private set; } = null!;
        ...
        /// </summary>
        [Output("oacId")]
        public Output<string> OacId { get; private set; } = null!;
        ...
        public ResourceAnalyticsResourceAnalyticsInstance(string name, ResourceAnalyticsResourceAnalyticsInstanceArgs args, CustomResourceOptions? options = null)
            : base("oci:oci/resourceAnalyticsResourceAnalyticsInstance:ResourceAnalyticsResourceAnalyticsInstance", name, args ?? new ResourceAnalyticsResourceAnalyticsInstanceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private ResourceAnalyticsResourceAnalyticsInstance(string name, Input<string> id, ResourceAnalyticsResourceAnalyticsInstanceState? state = null, CustomResourceOptions? options = null)
            : base("oci:oci/resourceAnalyticsResourceAnalyticsInstance:ResourceAnalyticsResourceAnalyticsInstance", name, state, MakeResourceOptions(options, id))
        {
        }
        ...
        /// <param name="options">A bag of options that control this resource's behavior</param>
        public static ResourceAnalyticsResourceAnalyticsInstance Get(string name, Input<string> id, ResourceAnalyticsResourceAnalyticsInstanceState? state = null, CustomResourceOptions? options = null)
        {
            return new ResourceAnalyticsResourceAnalyticsInstance(name, id, state, options);
        }
    }

    public sealed class ResourceAnalyticsResourceAnalyticsInstanceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Details for the ADW Admin password. Password can be passed as `VaultSecretPasswordDetails` or `PlainTextPasswordDetails`.  Example: `{"passwordType":"PLAIN_TEXT","password":"..."}` Example: `{"passwordType":"VAULT_SECRET","secretId":"ocid..."}`
        /// </summary>
        [Input("adwAdminPassword", required: true)]
        public Input<Inputs.ResourceAnalyticsResourceAnalyticsInstanceAdwAdminPasswordArgs> AdwAdminPassword { get; set; } = null!;
        ...
        /// Require mutual TLS (mTLS) when authenticating connections to the ADW database.
        /// </summary>
        [Input("isMutualTlsRequired")]
        public Input<bool>? IsMutualTlsRequired { get; set; }
        ...
        public ResourceAnalyticsResourceAnalyticsInstanceArgs()
        {
        }
        public static new ResourceAnalyticsResourceAnalyticsInstanceArgs Empty => new ResourceAnalyticsResourceAnalyticsInstanceArgs();
    }

    public sealed class ResourceAnalyticsResourceAnalyticsInstanceState : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Details for the ADW Admin password. Password can be passed as `VaultSecretPasswordDetails` or `PlainTextPasswordDetails`.  Example: `{"passwordType":"PLAIN_TEXT","password":"..."}` Example: `{"passwordType":"VAULT_SECRET","secretId":"ocid..."}`
        /// </summary>
        [Input("adwAdminPassword")]
        public Input<Inputs.ResourceAnalyticsResourceAnalyticsInstanceAdwAdminPasswordGetArgs>? AdwAdminPassword { get; set; }

        /// <summary>
        /// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the created ADW instance.
        /// </summary>
        [Input("adwId")]
        public Input<string>? AdwId { get; set; }
        ...
        /// </summary>
        [Input("oacId")]
        public Input<string>? OacId { get; set; }
        ...
        public ResourceAnalyticsResourceAnalyticsInstanceState()
        {
        }
        public static new ResourceAnalyticsResourceAnalyticsInstanceState Empty => new ResourceAnalyticsResourceAnalyticsInstanceState();
    }
}
