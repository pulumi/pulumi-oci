...
namespace Pulumi.Oci.Ocvp
{
    ...
    /// ```
    /// </summary>
    [OciResourceType("oci:Ocvp/datastoreCluster:DatastoreCluster")]
    public partial class DatastoreCluster : global::Pulumi.CustomResource
    {
        ...
        /// </summary>
        [Output("datastoreClusterType")]
        public Output<string> DatastoreClusterType { get; private set; } = null!;
        ...
        /// </summary>
        [Output("esxiHostIds")]
        public Output<ImmutableArray<string>> EsxiHostIds { get; private set; } = null!;
        ...
        public DatastoreCluster(string name, DatastoreClusterArgs args, CustomResourceOptions? options = null)
            : base("oci:Ocvp/datastoreCluster:DatastoreCluster", name, args ?? new DatastoreClusterArgs(), MakeResourceOptions(options, ""))
        {
        }

        private DatastoreCluster(string name, Input<string> id, DatastoreClusterState? state = null, CustomResourceOptions? options = null)
            : base("oci:Ocvp/datastoreCluster:DatastoreCluster", name, state, MakeResourceOptions(options, id))
        {
        }
    ...
    public sealed class DatastoreClusterArgs : global::Pulumi.ResourceArgs
    {
        ...
        /// Type of the datastore.
        /// </summary>
        [Input("datastoreClusterType", required: true)]
        public Input<string> DatastoreClusterType { get; set; } = null!;
    ...
    public sealed class DatastoreClusterState : global::Pulumi.ResourceArgs
    {
        ...
        /// Type of the datastore.
        /// </summary>
        [Input("datastoreClusterType")]
        public Input<string>? DatastoreClusterType { get; set; }
        ...
        [Input("esxiHostIds")]
        private InputList<string>? _esxiHostIds;

        /// <summary>
        /// The [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the ESXi hosts to attach the datastore to. All ESXi hosts must belong to the same VMware cluster.
        /// </summary>
        public InputList<string> EsxiHostIds
        {
            get => _esxiHostIds ?? (_esxiHostIds = new InputList<string>());
            set => _esxiHostIds = value;
        }
