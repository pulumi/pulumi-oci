...
namespace Pulumi.Oci.Ocvp.Inputs
{
    ...
    public sealed class SddcInitialConfigurationInitialClusterConfigurationGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        [Input("datastores")]
        private InputList<Inputs.SddcInitialConfigurationInitialClusterConfigurationDatastoreGetArgs>? _datastores;

        /// <summary>
        /// A list of datastore info for the Cluster. This value is required only when `initialHostShapeName` is a standard shape.
        /// </summary>
        public InputList<Inputs.SddcInitialConfigurationInitialClusterConfigurationDatastoreGetArgs> Datastores
        {
            get => _datastores ?? (_datastores = new InputList<Inputs.SddcInitialConfigurationInitialClusterConfigurationDatastoreGetArgs>());
        ...
        public Input<Inputs.SddcInitialConfigurationInitialClusterConfigurationNetworkConfigurationGetArgs>? NetworkConfiguration { get; set; }
        ...
        public SddcInitialConfigurationInitialClusterConfigurationGetArgs()
        {
        }
        public static new SddcInitialConfigurationInitialClusterConfigurationGetArgs Empty => new SddcInitialConfigurationInitialClusterConfigurationGetArgs();
    }
}
