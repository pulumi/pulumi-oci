...
namespace Pulumi.Oci.OneSubsription
{
    public static class GetComputedUsages
    {
        ...
        public static Task<GetComputedUsagesResult> InvokeAsync(GetComputedUsagesArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.InvokeAsync<GetComputedUsagesResult>("oci:OneSubsription/getComputedUsages:getComputedUsages", args ?? new GetComputedUsagesArgs(), options.WithDefaults());
        ...
        public static Output<GetComputedUsagesResult> Invoke(GetComputedUsagesInvokeArgs args, InvokeOptions? options = null)
            => global::Pulumi.Deployment.Instance.Invoke<GetComputedUsagesResult>("oci:OneSubsription/getComputedUsages:getComputedUsages", args ?? new GetComputedUsagesInvokeArgs(), options.WithDefaults());
