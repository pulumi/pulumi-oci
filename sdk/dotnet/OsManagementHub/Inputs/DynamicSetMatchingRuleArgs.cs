...
namespace Pulumi.Oci.OsManagementHub.Inputs
{
    ...
    public sealed class DynamicSetMatchingRuleArgs : global::Pulumi.ResourceArgs
    {
        [Input("architectures")]
        ...
        [Input("tags")]
        private InputList<Inputs.DynamicSetMatchingRuleTagArgs>? _tags;

        /// <summary>
        /// (Updatable) The list of the managed instance tags.
        /// </summary>
        public InputList<Inputs.DynamicSetMatchingRuleTagArgs> Tags
        {
            get => _tags ?? (_tags = new InputList<Inputs.DynamicSetMatchingRuleTagArgs>());
            set => _tags = value;
        }

        public DynamicSetMatchingRuleArgs()
        {
        }
        public static new DynamicSetMatchingRuleArgs Empty => new DynamicSetMatchingRuleArgs();
    }
}
