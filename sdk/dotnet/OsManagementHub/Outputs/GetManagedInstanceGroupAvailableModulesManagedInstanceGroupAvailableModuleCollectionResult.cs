...
namespace Pulumi.Oci.OsManagementHub.Outputs
{
    ...
    public sealed class GetManagedInstanceGroupAvailableModulesManagedInstanceGroupAvailableModuleCollectionResult
    {
        ...
        [OutputConstructor]
        private GetManagedInstanceGroupAvailableModulesManagedInstanceGroupAvailableModuleCollectionResult(ImmutableArray<Outputs.GetManagedInstanceGroupAvailableModulesManagedInstanceGroupAvailableModuleCollectionItemResult> items)
        {
            Items = items;
        }
    }
