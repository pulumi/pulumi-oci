...
namespace Pulumi.Oci.OspGateway.Inputs
{
    ...
    public sealed class SubscriptionSubscriptionGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        private InputList<Inputs.SubscriptionSubscriptionBillingAddressGetArgs>? _billingAddresses;

        /// <summary>
        /// (Updatable) Address details model.
        /// </summary>
        public InputList<Inputs.SubscriptionSubscriptionBillingAddressGetArgs> BillingAddresses
        {
            get => _billingAddresses ?? (_billingAddresses = new InputList<Inputs.SubscriptionSubscriptionBillingAddressGetArgs>());
        ...
        public Input<Inputs.SubscriptionSubscriptionPaymentGatewayGetArgs>? PaymentGateway { get; set; }

        [Input("paymentOptions")]
        private InputList<Inputs.SubscriptionSubscriptionPaymentOptionGetArgs>? _paymentOptions;

        /// <summary>
        /// (Updatable) Payment option list of a subscription.
        /// </summary>
        public InputList<Inputs.SubscriptionSubscriptionPaymentOptionGetArgs> PaymentOptions
        {
            get => _paymentOptions ?? (_paymentOptions = new InputList<Inputs.SubscriptionSubscriptionPaymentOptionGetArgs>());
        ...
        /// </summary>
        [Input("taxInfo")]
        public Input<Inputs.SubscriptionSubscriptionTaxInfoGetArgs>? TaxInfo { get; set; }
