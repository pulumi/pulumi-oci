...
namespace Pulumi.Oci.ResourceScheduler.Outputs
{
    ...
    [OutputType]
    public sealed class GetScheduleResourceFilterResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetScheduleResourceFilterValueResult> Values;

        [OutputConstructor]
        private GetScheduleResourceFilterResult(
            string attribute,
            ...
            ImmutableArray<Outputs.GetScheduleResourceFilterValueResult> values)
        {
            Attribute = attribute;
            Condition = condition;
