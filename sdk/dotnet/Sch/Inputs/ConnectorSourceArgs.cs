...
namespace Pulumi.Oci.Sch.Inputs
{
    ...
    public sealed class ConnectorSourceArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("cursor")]
        public Input<Inputs.ConnectorSourceCursorArgs>? Cursor { get; set; }
        ...
        [Input("logSources")]
        private InputList<Inputs.ConnectorSourceLogSourceArgs>? _logSources;

        /// <summary>
        /// (Updatable) The logs for this Logging source.
        /// </summary>
        public InputList<Inputs.ConnectorSourceLogSourceArgs> LogSources
        {
            get => _logSources ?? (_logSources = new InputList<Inputs.ConnectorSourceLogSourceArgs>());
        ...
        private InputList<Inputs.ConnectorSourcePrivateEndpointMetadataArgs>? _privateEndpointMetadatas;

        /// <summary>
        /// The private endpoint metadata for the connector's source or target.
        /// </summary>
        public InputList<Inputs.ConnectorSourcePrivateEndpointMetadataArgs> PrivateEndpointMetadatas
        {
            get => _privateEndpointMetadatas ?? (_privateEndpointMetadatas = new InputList<Inputs.ConnectorSourcePrivateEndpointMetadataArgs>());
        ...
        public ConnectorSourceArgs()
        {
        }
        public static new ConnectorSourceArgs Empty => new ConnectorSourceArgs();
    }
}
