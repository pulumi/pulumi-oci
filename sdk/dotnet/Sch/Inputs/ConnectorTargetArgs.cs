...
namespace Pulumi.Oci.Sch.Inputs
{
    ...
    public sealed class ConnectorTargetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("dimensions")]
        private InputList<Inputs.ConnectorTargetDimensionArgs>? _dimensions;

        /// <summary>
        /// (Updatable) List of dimension names and values.
        /// </summary>
        public InputList<Inputs.ConnectorTargetDimensionArgs> Dimensions
        {
            get => _dimensions ?? (_dimensions = new InputList<Inputs.ConnectorTargetDimensionArgs>());
        ...
        private InputList<Inputs.ConnectorTargetPrivateEndpointMetadataArgs>? _privateEndpointMetadatas;

        /// <summary>
        /// The private endpoint metadata for the connector's source or target.
        /// </summary>
        public InputList<Inputs.ConnectorTargetPrivateEndpointMetadataArgs> PrivateEndpointMetadatas
        {
            get => _privateEndpointMetadatas ?? (_privateEndpointMetadatas = new InputList<Inputs.ConnectorTargetPrivateEndpointMetadataArgs>());
