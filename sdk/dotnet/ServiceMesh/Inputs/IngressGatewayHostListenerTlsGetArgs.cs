...
namespace Pulumi.Oci.ServiceMesh.Inputs
{
    ...
    public sealed class IngressGatewayHostListenerTlsGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// (Updatable) Resource representing the TLS configuration used for validating client certificates.
        /// </summary>
        [Input("clientValidation")]
        public Input<Inputs.IngressGatewayHostListenerTlsClientValidationGetArgs>? ClientValidation { get; set; }
        ...
        public Input<Inputs.IngressGatewayHostListenerTlsServerCertificateGetArgs>? ServerCertificate { get; set; }

        public IngressGatewayHostListenerTlsGetArgs()
        {
        }
        public static new IngressGatewayHostListenerTlsGetArgs Empty => new IngressGatewayHostListenerTlsGetArgs();
    }
}
