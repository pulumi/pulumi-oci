...
namespace Pulumi.Oci.ServiceMesh.Outputs
{
    ...
    [OutputType]
    public sealed class GetIngressGatewaysIngressGatewayCollectionItemHostListenerTlResult
    {
        /// <summary>
        /// Resource representing the TLS configuration used for validating client certificates.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetIngressGatewaysIngressGatewayCollectionItemHostListenerTlClientValidationResult> ClientValidations;
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetIngressGatewaysIngressGatewayCollectionItemHostListenerTlServerCertificateResult> ServerCertificates;
