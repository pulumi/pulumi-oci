...
namespace Pulumi.Oci.StackMonitoring.Inputs
{
    ...
    public sealed class MetricExtensionQueryPropertiesGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.MetricExtensionQueryPropertiesInParamDetailGetArgs>? _inParamDetails;

        /// <summary>
        /// (Updatable) List of values and position of PL/SQL procedure IN parameters
        /// </summary>
        public InputList<Inputs.MetricExtensionQueryPropertiesInParamDetailGetArgs> InParamDetails
        {
            get => _inParamDetails ?? (_inParamDetails = new InputList<Inputs.MetricExtensionQueryPropertiesInParamDetailGetArgs>());
        ...
        /// </summary>
        [Input("sqlDetails")]
        public Input<Inputs.MetricExtensionQueryPropertiesSqlDetailsGetArgs>? SqlDetails { get; set; }
        ...
        public static new MetricExtensionQueryPropertiesGetArgs Empty => new MetricExtensionQueryPropertiesGetArgs();
    }
}
