...
namespace Pulumi.Oci.StackMonitoring.Inputs
{
    ...
    public sealed class MonitoredResourceCredentialsGetArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("properties")]
        private InputList<Inputs.MonitoredResourceCredentialsPropertyGetArgs>? _properties;

        /// <summary>
        /// (Updatable) List of monitored resource properties.
        /// </summary>
        public InputList<Inputs.MonitoredResourceCredentialsPropertyGetArgs> Properties
        {
            get => _properties ?? (_properties = new InputList<Inputs.MonitoredResourceCredentialsPropertyGetArgs>());
