...
namespace Pulumi.Oci.Vault.Inputs
{
    ...
    public sealed class SecretRotationConfigGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.SecretRotationConfigTargetSystemDetailsGetArgs> TargetSystemDetails { get; set; } = null!;

        public SecretRotationConfigGetArgs()
        {
        }
        public static new SecretRotationConfigGetArgs Empty => new SecretRotationConfigGetArgs();
    }
}
