...
namespace Pulumi.Oci.Waa.Outputs
{
    ...
    [OutputType]
    public sealed class AppAccelerationPolicyResponseCachingPolicy
    {
        /// <summary>
        ...
        [OutputConstructor]
        private AppAccelerationPolicyResponseCachingPolicy(bool? isResponseHeaderBasedCachingEnabled)
        {
