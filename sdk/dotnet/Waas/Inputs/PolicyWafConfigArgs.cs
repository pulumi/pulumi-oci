...
namespace Pulumi.Oci.Waas.Inputs
{
    ...
    public sealed class PolicyWafConfigArgs : global::Pulumi.ResourceArgs
    {
        [Input("accessRules")]
        private InputList<Inputs.PolicyWafConfigAccessRuleArgs>? _accessRules;
        ...
        /// </summary>
        public InputList<Inputs.PolicyWafConfigAccessRuleArgs> AccessRules
        {
            get => _accessRules ?? (_accessRules = new InputList<Inputs.PolicyWafConfigAccessRuleArgs>());
        ...
        public Input<Inputs.PolicyWafConfigAddressRateLimitingArgs>? AddressRateLimiting { get; set; }

        [Input("cachingRules")]
        private InputList<Inputs.PolicyWafConfigCachingRuleArgs>? _cachingRules;

        /// <summary>
        /// (Updatable) A list of caching rules applied to the web application.
        /// </summary>
        public InputList<Inputs.PolicyWafConfigCachingRuleArgs> CachingRules
        {
            get => _cachingRules ?? (_cachingRules = new InputList<Inputs.PolicyWafConfigCachingRuleArgs>());
            set => _cachingRules = value;
        }

        [Input("captchas")]
        private InputList<Inputs.PolicyWafConfigCaptchaArgs>? _captchas;
        ...
        /// </summary>
        public InputList<Inputs.PolicyWafConfigCaptchaArgs> Captchas
        {
            get => _captchas ?? (_captchas = new InputList<Inputs.PolicyWafConfigCaptchaArgs>());
            set => _captchas = value;
        }

        [Input("customProtectionRules")]
        private InputList<Inputs.PolicyWafConfigCustomProtectionRuleArgs>? _customProtectionRules;

        /// <summary>
        /// (Updatable) A list of the custom protection rule OCIDs and their actions.
        /// </summary>
        public InputList<Inputs.PolicyWafConfigCustomProtectionRuleArgs> CustomProtectionRules
        {
            get => _customProtectionRules ?? (_customProtectionRules = new InputList<Inputs.PolicyWafConfigCustomProtectionRuleArgs>());
        ...
        public Input<Inputs.PolicyWafConfigDeviceFingerprintChallengeArgs>? DeviceFingerprintChallenge { get; set; }
        ...
        public Input<Inputs.PolicyWafConfigHumanInteractionChallengeArgs>? HumanInteractionChallenge { get; set; }
        ...
        /// </summary>
        [Input("jsChallenge")]
        public Input<Inputs.PolicyWafConfigJsChallengeArgs>? JsChallenge { get; set; }
        ...
        public Input<Inputs.PolicyWafConfigProtectionSettingsArgs>? ProtectionSettings { get; set; }

        [Input("whitelists")]
        private InputList<Inputs.PolicyWafConfigWhitelistArgs>? _whitelists;

        /// <summary>
        /// (Updatable) A list of IP addresses that bypass the Web Application Firewall.
        /// </summary>
        public InputList<Inputs.PolicyWafConfigWhitelistArgs> Whitelists
        {
            get => _whitelists ?? (_whitelists = new InputList<Inputs.PolicyWafConfigWhitelistArgs>());
            set => _whitelists = value;
        }

        public PolicyWafConfigArgs()
        {
        }
        public static new PolicyWafConfigArgs Empty => new PolicyWafConfigArgs();
    }
}
