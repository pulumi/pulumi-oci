...
namespace Pulumi.Oci.Waas.Inputs
{
    ...
    public sealed class PolicyWafConfigJsChallengeArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        public Input<Inputs.PolicyWafConfigJsChallengeChallengeSettingsArgs>? ChallengeSettings { get; set; }

        [Input("criterias")]
        private InputList<Inputs.PolicyWafConfigJsChallengeCriteriaArgs>? _criterias;
        ...
        /// </summary>
        public InputList<Inputs.PolicyWafConfigJsChallengeCriteriaArgs> Criterias
        {
            get => _criterias ?? (_criterias = new InputList<Inputs.PolicyWafConfigJsChallengeCriteriaArgs>());
        ...
        /// </summary>
        [Input("setHttpHeader")]
        public Input<Inputs.PolicyWafConfigJsChallengeSetHttpHeaderArgs>? SetHttpHeader { get; set; }

        public PolicyWafConfigJsChallengeArgs()
        {
        }
        public static new PolicyWafConfigJsChallengeArgs Empty => new PolicyWafConfigJsChallengeArgs();
    }
}
