...
namespace Pulumi.Oci.Waas.Outputs
{
    ...
    [OutputType]
    public sealed class GetWaasPolicyOriginResult
    {
        /// <summary>
        /// A list of HTTP headers to forward to your origin.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetWaasPolicyOriginCustomHeaderResult> CustomHeaders;
        /// <summary>
        ...
        [OutputConstructor]
        private GetWaasPolicyOriginResult(
            ImmutableArray<Outputs.GetWaasPolicyOriginCustomHeaderResult> customHeaders,
