...
namespace Pulumi.Oci.Waf.Inputs
{
    ...
    public sealed class AppFirewallPolicyRequestRateLimitingRuleGetArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        private InputList<Inputs.AppFirewallPolicyRequestRateLimitingRuleConfigurationGetArgs>? _configurations;

        /// <summary>
        /// (Updatable) Rate Limiting Configurations. Each configuration counts requests towards its own `requestsLimit`.
        /// </summary>
        public InputList<Inputs.AppFirewallPolicyRequestRateLimitingRuleConfigurationGetArgs> Configurations
        {
            get => _configurations ?? (_configurations = new InputList<Inputs.AppFirewallPolicyRequestRateLimitingRuleConfigurationGetArgs>());
        ...
        public AppFirewallPolicyRequestRateLimitingRuleGetArgs()
        {
        }
        public static new AppFirewallPolicyRequestRateLimitingRuleGetArgs Empty => new AppFirewallPolicyRequestRateLimitingRuleGetArgs();
    }
}
