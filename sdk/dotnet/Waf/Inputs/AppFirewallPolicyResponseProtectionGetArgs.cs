...
namespace Pulumi.Oci.Waf.Inputs
{
    ...
    public sealed class AppFirewallPolicyResponseProtectionGetArgs : Pulumi.ResourceArgs
    {
        ...
        /// </summary>
        public InputList<Inputs.AppFirewallPolicyResponseProtectionRuleGetArgs> Rules
        {
            get => _rules ?? (_rules = new InputList<Inputs.AppFirewallPolicyResponseProtectionRuleGetArgs>());
            set => _rules = value;
        }
