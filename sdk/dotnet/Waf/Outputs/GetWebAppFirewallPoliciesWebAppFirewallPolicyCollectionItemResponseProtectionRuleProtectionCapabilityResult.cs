...
namespace Pulumi.Oci.Waf.Outputs
{
    ...
    [OutputType]
    public sealed class GetWebAppFirewallPoliciesWebAppFirewallPolicyCollectionItemResponseProtectionRuleProtectionCapabilityResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetWebAppFirewallPoliciesWebAppFirewallPolicyCollectionItemResponseProtectionRuleProtectionCapabilityCollaborativeWeightResult> CollaborativeWeights;
        /// <summary>
        /// Identifies specific HTTP message parameters to exclude from inspection by a protection capability.
        /// </summary>
        public readonly ImmutableArray<Outputs.GetWebAppFirewallPoliciesWebAppFirewallPolicyCollectionItemResponseProtectionRuleProtectionCapabilityExclusionResult> Exclusions;
        /// <summary>
