...
namespace Pulumi.Oci.Waf.Outputs
{
    ...
    [OutputType]
    public sealed class GetWebAppFirewallPolicyRequestAccessControlResult
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableArray<Outputs.GetWebAppFirewallPolicyRequestAccessControlRuleResult> Rules;

        [OutputConstructor]
        private GetWebAppFirewallPolicyRequestAccessControlResult(
            string defaultActionName,

            ImmutableArray<Outputs.GetWebAppFirewallPolicyRequestAccessControlRuleResult> rules)
        {
