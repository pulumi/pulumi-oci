...
func LookupAiPrivateEndpointOutput(ctx *pulumi.Context, args LookupAiPrivateEndpointOutputArgs, opts ...pulumi.InvokeOption) LookupAiPrivateEndpointResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupAiPrivateEndpointResultOutput, error) {
			args := v.(LookupAiPrivateEndpointArgs)
			opts = internal.PkgInvokeDefaultOpts(opts)
			var rv LookupAiPrivateEndpointResult
			secret, err := ctx.InvokePackageRaw("oci:AiAnomalyDetection/getAiPrivateEndpoint:getAiPrivateEndpoint", args, &rv, "", opts...)
			if err != nil {
				return LookupAiPrivateEndpointResultOutput{}, err
			}

			output := pulumi.ToOutput(rv).(LookupAiPrivateEndpointResultOutput)
			if secret {
				return pulumi.ToSecret(output).(LookupAiPrivateEndpointResultOutput), nil
			}
			return output, nil
...
// Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
func (o LookupAiPrivateEndpointResultOutput) DefinedTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupAiPrivateEndpointResult) map[string]string { return v.DefinedTags }).(pulumi.StringMapOutput)
}
...
// Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
func (o LookupAiPrivateEndpointResultOutput) FreeformTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupAiPrivateEndpointResult) map[string]string { return v.FreeformTags }).(pulumi.StringMapOutput)
}
...
// Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
func (o LookupAiPrivateEndpointResultOutput) SystemTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupAiPrivateEndpointResult) map[string]string { return v.SystemTags }).(pulumi.StringMapOutput)
}
