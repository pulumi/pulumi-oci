...
// The provider-assigned unique ID for this managed resource.
func (o GetDetectionProjectsResultOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetDetectionProjectsResult) *string { return v.Id }).(pulumi.StringPtrOutput)
}
