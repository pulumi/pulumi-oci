...
func GetModelType(ctx *pulumi.Context, args *GetModelTypeArgs, opts ...pulumi.InvokeOption) (*GetModelTypeResult, error) {
	...
	err := ctx.Invoke("oci:AiDocument/getModelType:getModelType", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
type GetModelTypeOutputArgs struct {
	...
	// The sub type based upon model selected.
	ModelSubType pulumi.StringPtrInput `pulumi:"modelSubType"`
	// The type of the Document model.
...
func (o GetModelTypeResultOutput) CompartmentId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetModelTypeResult) *string { return v.CompartmentId }).(pulumi.StringPtrOutput)
}
...
func (o GetModelTypeResultOutput) ModelSubType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetModelTypeResult) *string { return v.ModelSubType }).(pulumi.StringPtrOutput)
}
