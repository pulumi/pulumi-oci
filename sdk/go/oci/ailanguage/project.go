...
//			_, err := AiLanguage.NewProject(ctx, "testProject", &AiLanguage.ProjectArgs{
...
func NewProject(ctx *pulumi.Context,
	...
	err := ctx.RegisterResource("oci:AiLanguage/project:Project", name, args, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
...
func GetProject(ctx *pulumi.Context,
	...
	var resource Project
	err := ctx.ReadResource("oci:AiLanguage/project:Project", name, id, state, &resource, opts...)
	if err != nil {
		return nil, err
	}
	return &resource, nil
