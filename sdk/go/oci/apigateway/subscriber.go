...
// (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
func (o SubscriberOutput) DefinedTags() pulumi.MapOutput {
	return o.ApplyT(func(v *Subscriber) pulumi.MapOutput { return v.DefinedTags }).(pulumi.MapOutput)
}

// (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.  Example: `My new resource`
func (o SubscriberOutput) DisplayName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Subscriber) pulumi.StringPtrOutput { return v.DisplayName }).(pulumi.StringPtrOutput)
}

// (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
func (o SubscriberOutput) FreeformTags() pulumi.MapOutput {
	return o.ApplyT(func(v *Subscriber) pulumi.MapOutput { return v.FreeformTags }).(pulumi.MapOutput)
}

// A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in a Failed state.
func (o SubscriberOutput) LifecycleDetails() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Subscriber) pulumi.StringPtrOutput { return v.LifecycleDetails }).(pulumi.StringPtrOutput)
}

// The current state of the subscriber.
func (o SubscriberOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Subscriber) pulumi.StringPtrOutput { return v.State }).(pulumi.StringPtrOutput)
}

// The time this resource was created. An RFC3339 formatted datetime string.
func (o SubscriberOutput) TimeCreated() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Subscriber) pulumi.StringPtrOutput { return v.TimeCreated }).(pulumi.StringPtrOutput)
}

// The time this resource was last updated. An RFC3339 formatted datetime string.
func (o SubscriberOutput) TimeUpdated() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Subscriber) pulumi.StringPtrOutput { return v.TimeUpdated }).(pulumi.StringPtrOutput)
}
