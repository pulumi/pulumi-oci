...
// import (
//
//	"github.com/pulumi/pulumi-oci/sdk/v5/go/oci/apmconfig"
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//
// )
//
...
func LookupConfigOutput(ctx *pulumi.Context, args LookupConfigOutputArgs, opts ...pulumi.InvokeOption) LookupConfigResultOutput {
	...
	return ctx.InvokeOutput("oci:ApmConfig/getConfig:getConfig", args, LookupConfigResultOutput{}, options).(LookupConfigResultOutput)
}
