...
// import (
//
//	"github.com/pulumi/pulumi-oci/sdk/v5/go/oci/audit"
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//
// )
//
...
func GetEventsOutput(ctx *pulumi.Context, args GetEventsOutputArgs, opts ...pulumi.InvokeOption) GetEventsResultOutput {
	...
	return ctx.InvokeOutput("oci:Audit/getEvents:getEvents", args, GetEventsResultOutput{}, options).(GetEventsResultOutput)
}
