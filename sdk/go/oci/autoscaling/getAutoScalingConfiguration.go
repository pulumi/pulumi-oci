...
// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the autoscaling configuration.
func (o LookupAutoScalingConfigurationResultOutput) CompartmentId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupAutoScalingConfigurationResult) *string { return v.CompartmentId }).(pulumi.StringPtrOutput)
}

// For threshold-based autoscaling policies, this value is the minimum period of time to wait between scaling actions. The cooldown period gives the system time to stabilize before rescaling. The minimum value is 300 seconds, which is also the default. The cooldown period starts when the instance pool reaches the running state.
func (o LookupAutoScalingConfigurationResultOutput) CoolDownInSeconds() pulumi.IntPtrOutput {
	return o.ApplyT(func(v LookupAutoScalingConfigurationResult) *int { return v.CoolDownInSeconds }).(pulumi.IntPtrOutput)
}
...
// The maximum number of resources to scale out to.
func (o LookupAutoScalingConfigurationResultOutput) MaxResourceCount() pulumi.IntPtrOutput {
	return o.ApplyT(func(v LookupAutoScalingConfigurationResult) *int { return v.MaxResourceCount }).(pulumi.IntPtrOutput)
}

// The minimum number of resources to scale in to.
func (o LookupAutoScalingConfigurationResultOutput) MinResourceCount() pulumi.IntPtrOutput {
	return o.ApplyT(func(v LookupAutoScalingConfigurationResult) *int { return v.MinResourceCount }).(pulumi.IntPtrOutput)
}
