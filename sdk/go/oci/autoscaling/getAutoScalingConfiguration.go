...
// import (
//
//	"github.com/pulumi/pulumi-oci/sdk/v5/go/oci/autoscaling"
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//
// )
//
...
func LookupAutoScalingConfigurationOutput(ctx *pulumi.Context, args LookupAutoScalingConfigurationOutputArgs, opts ...pulumi.InvokeOption) LookupAutoScalingConfigurationResultOutput {
	...
	return ctx.InvokeOutput("oci:Autoscaling/getAutoScalingConfiguration:getAutoScalingConfiguration", args, LookupAutoScalingConfigurationResultOutput{}, options).(LookupAutoScalingConfigurationResultOutput)
}
...
// Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
func (o LookupAutoScalingConfigurationResultOutput) DefinedTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupAutoScalingConfigurationResult) map[string]string { return v.DefinedTags }).(pulumi.StringMapOutput)
}
...
// Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
func (o LookupAutoScalingConfigurationResultOutput) FreeformTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupAutoScalingConfigurationResult) map[string]string { return v.FreeformTags }).(pulumi.StringMapOutput)
}
