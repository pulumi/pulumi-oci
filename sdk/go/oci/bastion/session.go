...
// import (
//
//	"github.com/pulumi/pulumi-oci/sdk/v5/go/oci/bastion"
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//
// )
//
...
func (o SessionOutput) KeyDetails() SessionKeyDetailsOutput {
	return o.ApplyT(func(v *Session) SessionKeyDetailsOutput { return v.KeyDetails }).(SessionKeyDetailsOutput)
}
...
func (o SessionOutput) TargetResourceDetails() SessionTargetResourceDetailsOutput {
	return o.ApplyT(func(v *Session) SessionTargetResourceDetailsOutput { return v.TargetResourceDetails }).(SessionTargetResourceDetailsOutput)
}
