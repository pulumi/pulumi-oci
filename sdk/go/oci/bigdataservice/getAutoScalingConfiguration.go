...
func LookupAutoScalingConfigurationOutput(ctx *pulumi.Context, args LookupAutoScalingConfigurationOutputArgs, opts ...pulumi.InvokeOption) LookupAutoScalingConfigurationResultOutput {
	...
	return ctx.InvokeOutput("oci:BigDataService/getAutoScalingConfiguration:getAutoScalingConfiguration", args, LookupAutoScalingConfigurationResultOutput{}, options).(LookupAutoScalingConfigurationResultOutput)
}
