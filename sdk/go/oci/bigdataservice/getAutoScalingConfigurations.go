...
func GetAutoScalingConfigurationsOutput(ctx *pulumi.Context, args GetAutoScalingConfigurationsOutputArgs, opts ...pulumi.InvokeOption) GetAutoScalingConfigurationsResultOutput {
	...
	return ctx.InvokeOutput("oci:BigDataService/getAutoScalingConfigurations:getAutoScalingConfigurations", args, GetAutoScalingConfigurationsResultOutput{}, options).(GetAutoScalingConfigurationsResultOutput)
}
