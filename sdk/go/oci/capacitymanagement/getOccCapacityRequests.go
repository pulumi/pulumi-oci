...
//				DisplayName:              pulumi.StringRef(_var.Occ_capacity_request_display_name),
//				Id:                       pulumi.StringRef(_var.Occ_capacity_request_id),
//				Namespace:                pulumi.StringRef(_var.Occ_capacity_request_namespace),
//				OccAvailabilityCatalogId: pulumi.StringRef(oci_capacity_management_occ_availability_catalog.Test_occ_availability_catalog.Id),
//			}, nil)
//			if err != nil {
//				return err
//			}
...
func GetOccCapacityRequestsOutput(ctx *pulumi.Context, args GetOccCapacityRequestsOutputArgs, opts ...pulumi.InvokeOption) GetOccCapacityRequestsResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (GetOccCapacityRequestsResult, error) {
			args := v.(GetOccCapacityRequestsArgs)
			r, err := GetOccCapacityRequests(ctx, &args, opts...)
			var s GetOccCapacityRequestsResult
			if r != nil {
				s = *r
			}
			return s, err
