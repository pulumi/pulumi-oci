...
func LookupCertificateAuthorityOutput(ctx *pulumi.Context, args LookupCertificateAuthorityOutputArgs, opts ...pulumi.InvokeOption) LookupCertificateAuthorityResultOutput {
	...
	return ctx.InvokeOutput("oci:CertificatesManagement/getCertificateAuthority:getCertificateAuthority", args, LookupCertificateAuthorityResultOutput{}, options).(LookupCertificateAuthorityResultOutput)
}
