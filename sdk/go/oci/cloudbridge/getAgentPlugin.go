...
func LookupAgentPluginOutput(ctx *pulumi.Context, args LookupAgentPluginOutputArgs, opts ...pulumi.InvokeOption) LookupAgentPluginResultOutput {
	...
	return ctx.InvokeOutput("oci:CloudBridge/getAgentPlugin:getAgentPlugin", args, LookupAgentPluginResultOutput{}, options).(LookupAgentPluginResultOutput)
}
...
func (o LookupAgentPluginResultOutput) DefinedTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupAgentPluginResult) map[string]string { return v.DefinedTags }).(pulumi.StringMapOutput)
}
...
func (o LookupAgentPluginResultOutput) FreeformTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupAgentPluginResult) map[string]string { return v.FreeformTags }).(pulumi.StringMapOutput)
}
...
func (o LookupAgentPluginResultOutput) SystemTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupAgentPluginResult) map[string]string { return v.SystemTags }).(pulumi.StringMapOutput)
}
