...
//			_, err := CloudBridge.NewInventory(ctx, "testInventory", &CloudBridge.InventoryArgs{
//				CompartmentId: pulumi.Any(_var.Compartment_id),
//				DisplayName:   pulumi.Any(_var.Inventory_display_name),
...
func (o InventoryOutput) DefinedTags() pulumi.MapOutput {
	return o.ApplyT(func(v *Inventory) pulumi.MapOutput { return v.DefinedTags }).(pulumi.MapOutput)
}
...
func (o InventoryOutput) FreeformTags() pulumi.MapOutput {
	return o.ApplyT(func(v *Inventory) pulumi.MapOutput { return v.FreeformTags }).(pulumi.MapOutput)
}
...
func (o InventoryOutput) SystemTags() pulumi.MapOutput {
	return o.ApplyT(func(v *Inventory) pulumi.MapOutput { return v.SystemTags }).(pulumi.MapOutput)
}
