...
func LookupAdhocQueryOutput(ctx *pulumi.Context, args LookupAdhocQueryOutputArgs, opts ...pulumi.InvokeOption) LookupAdhocQueryResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupAdhocQueryResultOutput, error) {
			...
			opts = internal.PkgInvokeDefaultOpts(opts)
			var rv LookupAdhocQueryResult
			secret, err := ctx.InvokePackageRaw("oci:CloudGuard/getAdhocQuery:getAdhocQuery", args, &rv, "", opts...)
			if err != nil {
				return LookupAdhocQueryResultOutput{}, err
			}

			output := pulumi.ToOutput(rv).(LookupAdhocQueryResultOutput)
			if secret {
				return pulumi.ToSecret(output).(LookupAdhocQueryResultOutput), nil
			}
			return output, nil
...
// Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
func (o LookupAdhocQueryResultOutput) DefinedTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupAdhocQueryResult) map[string]string { return v.DefinedTags }).(pulumi.StringMapOutput)
}
...
// Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
func (o LookupAdhocQueryResultOutput) FreeformTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupAdhocQueryResult) map[string]string { return v.FreeformTags }).(pulumi.StringMapOutput)
}
...
// System tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). System tags can be viewed by users, but can only be created by the system.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
func (o LookupAdhocQueryResultOutput) SystemTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupAdhocQueryResult) map[string]string { return v.SystemTags }).(pulumi.StringMapOutput)
}
