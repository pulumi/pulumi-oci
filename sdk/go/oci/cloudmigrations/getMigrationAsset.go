...
type LookupMigrationAssetResult struct {
	...
	ReplicationLocationDetails []GetMigrationAssetReplicationLocationDetail `pulumi:"replicationLocationDetails"`
...
// Mapping of source disk id to destination disk details
func (o LookupMigrationAssetResultOutput) DestinationDisks() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupMigrationAssetResult) map[string]string { return v.DestinationDisks }).(pulumi.StringMapOutput)
}
...
// Replication location detail where the snapshots reside
func (o LookupMigrationAssetResultOutput) ReplicationLocationDetails() GetMigrationAssetReplicationLocationDetailArrayOutput {
	return o.ApplyT(func(v LookupMigrationAssetResult) []GetMigrationAssetReplicationLocationDetail {
		return v.ReplicationLocationDetails
	}).(GetMigrationAssetReplicationLocationDetailArrayOutput)
}
