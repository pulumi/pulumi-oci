...
// Performance of the block volumes.
func (o LookupTargetAssetResultOutput) BlockVolumesPerformance() pulumi.IntPtrOutput {
	return o.ApplyT(func(v LookupTargetAssetResult) *int { return v.BlockVolumesPerformance }).(pulumi.IntPtrOutput)
}

// The OCID of the compartment.
func (o LookupTargetAssetResultOutput) CompartmentId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupTargetAssetResult) *string { return v.CompartmentId }).(pulumi.StringPtrOutput)
}
...
// Created resource identifier
func (o LookupTargetAssetResultOutput) CreatedResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupTargetAssetResult) *string { return v.CreatedResourceId }).(pulumi.StringPtrOutput)
}

// A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
func (o LookupTargetAssetResultOutput) DisplayName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupTargetAssetResult) *string { return v.DisplayName }).(pulumi.StringPtrOutput)
}
...
// Asset ID generated by mirgration service. It is used in the mirgration service pipeline.
func (o LookupTargetAssetResultOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupTargetAssetResult) *string { return v.Id }).(pulumi.StringPtrOutput)
}

// A boolean indicating whether the asset should be migrated.
func (o LookupTargetAssetResultOutput) IsExcludedFromExecution() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupTargetAssetResult) *bool { return v.IsExcludedFromExecution }).(pulumi.BoolPtrOutput)
}

// A message describing the current state in more detail. For example, it can be used to provide actionable information for a resource in Failed state.
func (o LookupTargetAssetResultOutput) LifecycleDetails() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupTargetAssetResult) *string { return v.LifecycleDetails }).(pulumi.StringPtrOutput)
}
...
// OCID of the associated migration plan.
func (o LookupTargetAssetResultOutput) MigrationPlanId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupTargetAssetResult) *string { return v.MigrationPlanId }).(pulumi.StringPtrOutput)
}

// Microsoft license for VM configuration.
func (o LookupTargetAssetResultOutput) MsLicense() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupTargetAssetResult) *string { return v.MsLicense }).(pulumi.StringPtrOutput)
}

// Preferred VM shape type that you provide.
func (o LookupTargetAssetResultOutput) PreferredShapeType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupTargetAssetResult) *string { return v.PreferredShapeType }).(pulumi.StringPtrOutput)
}
...
// The current state of the target asset.
func (o LookupTargetAssetResultOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupTargetAssetResult) *string { return v.State }).(pulumi.StringPtrOutput)
}
...
// The time when the assessment was done. An RFC3339 formatted datetime string.
func (o LookupTargetAssetResultOutput) TimeAssessed() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupTargetAssetResult) *string { return v.TimeAssessed }).(pulumi.StringPtrOutput)
}

// The time when the target asset was created. An RFC3339 formatted datetime string.
func (o LookupTargetAssetResultOutput) TimeCreated() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupTargetAssetResult) *string { return v.TimeCreated }).(pulumi.StringPtrOutput)
}

// The time when the target asset was updated. An RFC3339 formatted datetime string.
func (o LookupTargetAssetResultOutput) TimeUpdated() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupTargetAssetResult) *string { return v.TimeUpdated }).(pulumi.StringPtrOutput)
}

// The type of action to run when the instance is interrupted for eviction.
func (o LookupTargetAssetResultOutput) Type() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupTargetAssetResult) *string { return v.Type }).(pulumi.StringPtrOutput)
}
