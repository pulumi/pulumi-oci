...
// EULA link
func (o AppCatalogSubscriptionOutput) EulaLink() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *AppCatalogSubscription) pulumi.StringPtrOutput { return v.EulaLink }).(pulumi.StringPtrOutput)
}

// The OCID of the listing.
func (o AppCatalogSubscriptionOutput) ListingId() pulumi.StringOutput {
	return o.ApplyT(func(v *AppCatalogSubscription) pulumi.StringOutput { return v.ListingId }).(pulumi.StringOutput)
}
...
// Listing resource version.
func (o AppCatalogSubscriptionOutput) ListingResourceVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *AppCatalogSubscription) pulumi.StringOutput { return v.ListingResourceVersion }).(pulumi.StringOutput)
}

// Oracle TOU link
func (o AppCatalogSubscriptionOutput) OracleTermsOfUseLink() pulumi.StringOutput {
	return o.ApplyT(func(v *AppCatalogSubscription) pulumi.StringOutput { return v.OracleTermsOfUseLink }).(pulumi.StringOutput)
}
...
// A generated signature for this listing resource version retrieved the agreements API.
func (o AppCatalogSubscriptionOutput) Signature() pulumi.StringOutput {
	return o.ApplyT(func(v *AppCatalogSubscription) pulumi.StringOutput { return v.Signature }).(pulumi.StringOutput)
}
