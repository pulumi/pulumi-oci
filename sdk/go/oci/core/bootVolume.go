...
// (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
func (o BootVolumeOutput) DefinedTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *BootVolume) pulumi.StringMapOutput { return v.DefinedTags }).(pulumi.StringMapOutput)
}
...
// (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
func (o BootVolumeOutput) FreeformTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *BootVolume) pulumi.StringMapOutput { return v.FreeformTags }).(pulumi.StringMapOutput)
}
...
// System tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
func (o BootVolumeOutput) SystemTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *BootVolume) pulumi.StringMapOutput { return v.SystemTags }).(pulumi.StringMapOutput)
}
...
// ** IMPORTANT **
// Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
func (o BootVolumeOutput) XrcKmsKeyId() pulumi.StringOutput {
	return o.ApplyT(func(v *BootVolume) pulumi.StringOutput { return v.XrcKmsKeyId }).(pulumi.StringOutput)
}
