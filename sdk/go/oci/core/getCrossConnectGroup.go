...
func LookupCrossConnectGroupOutput(ctx *pulumi.Context, args LookupCrossConnectGroupOutputArgs, opts ...pulumi.InvokeOption) LookupCrossConnectGroupResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupCrossConnectGroupResult, error) {
			args := v.(LookupCrossConnectGroupArgs)
			r, err := LookupCrossConnectGroup(ctx, &args, opts...)
			var s LookupCrossConnectGroupResult
			if r != nil {
				s = *r
			}
			return s, err
...
// Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
func (o LookupCrossConnectGroupResultOutput) DefinedTags() pulumi.MapOutput {
	return o.ApplyT(func(v LookupCrossConnectGroupResult) map[string]interface{} { return v.DefinedTags }).(pulumi.MapOutput)
}
...
// Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
func (o LookupCrossConnectGroupResultOutput) FreeformTags() pulumi.MapOutput {
	return o.ApplyT(func(v LookupCrossConnectGroupResult) map[string]interface{} { return v.FreeformTags }).(pulumi.MapOutput)
}
