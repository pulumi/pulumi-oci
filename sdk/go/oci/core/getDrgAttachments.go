...
// The provider-assigned unique ID for this managed resource.
func (o GetDrgAttachmentsResultOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetDrgAttachmentsResult) *string { return v.Id }).(pulumi.StringPtrOutput)
}
