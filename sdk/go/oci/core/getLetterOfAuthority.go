...
// The name of the entity authorized by this Letter of Authority.
func (o GetLetterOfAuthorityResultOutput) AuthorizedEntityName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetLetterOfAuthorityResult) *string { return v.AuthorizedEntityName }).(pulumi.StringPtrOutput)
}

// The type of cross-connect fiber, termination, and optical specification.
func (o GetLetterOfAuthorityResultOutput) CircuitType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetLetterOfAuthorityResult) *string { return v.CircuitType }).(pulumi.StringPtrOutput)
}
...
// The address of the FastConnect location.
func (o GetLetterOfAuthorityResultOutput) FacilityLocation() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetLetterOfAuthorityResult) *string { return v.FacilityLocation }).(pulumi.StringPtrOutput)
}

// The provider-assigned unique ID for this managed resource.
func (o GetLetterOfAuthorityResultOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetLetterOfAuthorityResult) *string { return v.Id }).(pulumi.StringPtrOutput)
}

// The meet-me room port for this cross-connect.
func (o GetLetterOfAuthorityResultOutput) PortName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetLetterOfAuthorityResult) *string { return v.PortName }).(pulumi.StringPtrOutput)
}

// The date and time when the Letter of Authority expires, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
func (o GetLetterOfAuthorityResultOutput) TimeExpires() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetLetterOfAuthorityResult) *string { return v.TimeExpires }).(pulumi.StringPtrOutput)
}

// The date and time the Letter of Authority was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
func (o GetLetterOfAuthorityResultOutput) TimeIssued() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetLetterOfAuthorityResult) *string { return v.TimeIssued }).(pulumi.StringPtrOutput)
}
