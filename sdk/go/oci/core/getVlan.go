...
// The VLAN's availability domain. This attribute will be null if this is a regional VLAN rather than an AD-specific VLAN.  Example: `Uocm:PHX-AD-1`
func (o LookupVlanResultOutput) AvailabilityDomain() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVlanResult) *string { return v.AvailabilityDomain }).(pulumi.StringPtrOutput)
}

// The range of IPv4 addresses that will be used for layer 3 communication with hosts outside the VLAN.  Example: `192.168.1.0/24`
func (o LookupVlanResultOutput) CidrBlock() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVlanResult) *string { return v.CidrBlock }).(pulumi.StringPtrOutput)
}

// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the VLAN.
func (o LookupVlanResultOutput) CompartmentId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVlanResult) *string { return v.CompartmentId }).(pulumi.StringPtrOutput)
}
...
// A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
func (o LookupVlanResultOutput) DisplayName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVlanResult) *string { return v.DisplayName }).(pulumi.StringPtrOutput)
}
...
// The VLAN's Oracle ID ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)).
func (o LookupVlanResultOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVlanResult) *string { return v.Id }).(pulumi.StringPtrOutput)
}
...
// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the route table that the VLAN uses.
func (o LookupVlanResultOutput) RouteTableId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVlanResult) *string { return v.RouteTableId }).(pulumi.StringPtrOutput)
}

// The VLAN's current state.
func (o LookupVlanResultOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVlanResult) *string { return v.State }).(pulumi.StringPtrOutput)
}

// The date and time the VLAN was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
func (o LookupVlanResultOutput) TimeCreated() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVlanResult) *string { return v.TimeCreated }).(pulumi.StringPtrOutput)
}

// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VCN the VLAN is in.
func (o LookupVlanResultOutput) VcnId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupVlanResult) *string { return v.VcnId }).(pulumi.StringPtrOutput)
}
...
// The IEEE 802.1Q VLAN tag of this VLAN.  Example: `100`
func (o LookupVlanResultOutput) VlanTag() pulumi.IntPtrOutput {
	return o.ApplyT(func(v LookupVlanResult) *int { return v.VlanTag }).(pulumi.IntPtrOutput)
}
