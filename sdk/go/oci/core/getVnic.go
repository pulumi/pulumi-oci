...
func GetVnicOutput(ctx *pulumi.Context, args GetVnicOutputArgs, opts ...pulumi.InvokeOption) GetVnicResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetVnicResultOutput, error) {
			...
			return ctx.InvokeOutput("oci:Core/getVnic:getVnic", args, GetVnicResultOutput{}, options).(GetVnicResultOutput), nil
		}).(GetVnicResultOutput)
}
...
// Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
func (o GetVnicResultOutput) DefinedTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v GetVnicResult) map[string]string { return v.DefinedTags }).(pulumi.StringMapOutput)
}
...
// Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
func (o GetVnicResultOutput) FreeformTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v GetVnicResult) map[string]string { return v.FreeformTags }).(pulumi.StringMapOutput)
}
