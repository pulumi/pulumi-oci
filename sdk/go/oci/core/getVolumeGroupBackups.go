...
// The provider-assigned unique ID for this managed resource.
func (o GetVolumeGroupBackupsResultOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetVolumeGroupBackupsResult) *string { return v.Id }).(pulumi.StringPtrOutput)
}
