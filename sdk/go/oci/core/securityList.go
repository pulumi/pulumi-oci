...
// (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
func (o SecurityListOutput) DefinedTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *SecurityList) pulumi.StringMapOutput { return v.DefinedTags }).(pulumi.StringMapOutput)
}
...
// (Updatable) Rules for allowing egress IP packets.
func (o SecurityListOutput) EgressSecurityRules() SecurityListEgressSecurityRuleArrayOutput {
	return o.ApplyT(func(v *SecurityList) SecurityListEgressSecurityRuleArrayOutput { return v.EgressSecurityRules }).(SecurityListEgressSecurityRuleArrayOutput)
}

// (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
func (o SecurityListOutput) FreeformTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *SecurityList) pulumi.StringMapOutput { return v.FreeformTags }).(pulumi.StringMapOutput)
}

// (Updatable) Rules for allowing ingress IP packets.
func (o SecurityListOutput) IngressSecurityRules() SecurityListIngressSecurityRuleArrayOutput {
	return o.ApplyT(func(v *SecurityList) SecurityListIngressSecurityRuleArrayOutput { return v.IngressSecurityRules }).(SecurityListIngressSecurityRuleArrayOutput)
}
...
// ** IMPORTANT **
// Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
func (o SecurityListOutput) VcnId() pulumi.StringOutput {
	return o.ApplyT(func(v *SecurityList) pulumi.StringOutput { return v.VcnId }).(pulumi.StringOutput)
}
