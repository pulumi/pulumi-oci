...
// The OCID of the compartment containing the image.
func (o ShapeManagementOutput) CompartmentId() pulumi.StringOutput {
	return o.ApplyT(func(v *ShapeManagement) pulumi.StringOutput { return v.CompartmentId }).(pulumi.StringOutput)
}

// The OCID of the Image to which the shape should be added.
func (o ShapeManagementOutput) ImageId() pulumi.StringOutput {
	return o.ApplyT(func(v *ShapeManagement) pulumi.StringOutput { return v.ImageId }).(pulumi.StringOutput)
}

// The compatible shape that is to be added to the compatible shapes list for the image.
func (o ShapeManagementOutput) ShapeName() pulumi.StringOutput {
	return o.ApplyT(func(v *ShapeManagement) pulumi.StringOutput { return v.ShapeName }).(pulumi.StringOutput)
}
