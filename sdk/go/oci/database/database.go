...
//			_, err := Database.NewDatabase(ctx, "test_database", &Database.DatabaseArgs{
//				Database: &database.DatabaseDatabaseArgs{
//					AdminPassword:           pulumi.Any(databaseDatabaseAdminPassword),
//					DbName:                  pulumi.Any(databaseDatabaseDbName),
//					BackupId:                pulumi.Any(testBackup.Id),
//					BackupTdePassword:       pulumi.Any(databaseDatabaseBackupTdePassword),
//					CharacterSet:            pulumi.Any(databaseDatabaseCharacterSet),
...
//						AutoBackupEnabled:    pulumi.Any(databaseDatabaseDbBackupConfigAutoBackupEnabled),
//						AutoBackupWindow:     pulumi.Any(databaseDatabaseDbBackupConfigAutoBackupWindow),
//						AutoFullBackupDay:    pulumi.Any(databaseDatabaseDbBackupConfigAutoFullBackupDay),
//						AutoFullBackupWindow: pulumi.Any(databaseDatabaseDbBackupConfigAutoFullBackupWindow),
//						BackupDeletionPolicy: pulumi.Any(databaseDatabaseDbBackupConfigBackupDeletionPolicy),
...
//								Id:           pulumi.Any(databaseDatabaseDbBackupConfigBackupDestinationDetailsId),
//								Type:         pulumi.Any(databaseDatabaseDbBackupConfigBackupDestinationDetailsType),
//							},
//						},
//						RecoveryWindowInDays:   pulumi.Any(databaseDatabaseDbBackupConfigRecoveryWindowInDays),
//						RunImmediateFullBackup: pulumi.Any(databaseDatabaseDbBackupConfigRunImmediateFullBackup),
//					},
//					DbUniqueName:       pulumi.Any(databaseDatabaseDbUniqueName),
//					DbWorkload:         pulumi.Any(databaseDatabaseDbWorkload),
//					DefinedTags:        pulumi.Any(databaseDatabaseDefinedTags),
//					FreeformTags:       pulumi.Any(databaseDatabaseFreeformTags),
//					KmsKeyId:           pulumi.Any(testKey.Id),
//					KmsKeyVersionId:    pulumi.Any(testKeyVersion.Id),
//					NcharacterSet:      pulumi.Any(databaseDatabaseNcharacterSet),
//					PdbName:            pulumi.Any(databaseDatabasePdbName),
//					PluggableDatabases: pulumi.Any(databaseDatabasePluggableDatabases),
//					SidPrefix:          pulumi.Any(databaseDatabaseSidPrefix),
//					TdeWalletPassword:  pulumi.Any(databaseDatabaseTdeWalletPassword),
//					VaultId:            pulumi.Any(testVault.Id),
//				},
//				DbHomeId:        pulumi.Any(testDbHome.Id),
//				Source:          pulumi.Any(databaseSource),
//				DbVersion:       pulumi.Any(databaseDbVersion),
//				KmsKeyId:        pulumi.Any(testKey.Id),
//				KmsKeyVersionId: pulumi.Any(testKeyVersion.Id),
//			})
//			if err != nil {
