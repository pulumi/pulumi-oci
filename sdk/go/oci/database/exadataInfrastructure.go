...
// Details of the file system configuration of the Exadata infrastructure.
func (o ExadataInfrastructureOutput) DefinedFileSystemConfigurations() ExadataInfrastructureDefinedFileSystemConfigurationArrayOutput {
	return o.ApplyT(func(v *ExadataInfrastructure) ExadataInfrastructureDefinedFileSystemConfigurationArrayOutput {
		return v.DefinedFileSystemConfigurations
	}).(ExadataInfrastructureDefinedFileSystemConfigurationArrayOutput)
}
...
// If true, the infrastructure is using granular maintenance scheduling preference.
func (o ExadataInfrastructureOutput) IsSchedulingPolicyAssociated() pulumi.BoolOutput {
	return o.ApplyT(func(v *ExadataInfrastructure) pulumi.BoolOutput { return v.IsSchedulingPolicyAssociated }).(pulumi.BoolOutput)
}
...
// System tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
func (o ExadataInfrastructureOutput) SystemTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *ExadataInfrastructure) pulumi.StringMapOutput { return v.SystemTags }).(pulumi.StringMapOutput)
}
