...
func (o ExternalNonContainerDatabaseManagementOutput) EnableManagement() pulumi.BoolOutput {
	return o.ApplyT(func(v *ExternalNonContainerDatabaseManagement) pulumi.BoolOutput { return v.EnableManagement }).(pulumi.BoolOutput)
}

// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the [external database connector](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/datatypes/CreateExternalDatabaseConnectorDetails).
func (o ExternalNonContainerDatabaseManagementOutput) ExternalDatabaseConnectorId() pulumi.StringOutput {
	return o.ApplyT(func(v *ExternalNonContainerDatabaseManagement) pulumi.StringOutput {
		return v.ExternalDatabaseConnectorId
	}).(pulumi.StringOutput)
}

// The external non-container database [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
func (o ExternalNonContainerDatabaseManagementOutput) ExternalNonContainerDatabaseId() pulumi.StringOutput {
	return o.ApplyT(func(v *ExternalNonContainerDatabaseManagement) pulumi.StringOutput {
