...
func LookupAutonomousDatabaseBackupOutput(ctx *pulumi.Context, args LookupAutonomousDatabaseBackupOutputArgs, opts ...pulumi.InvokeOption) LookupAutonomousDatabaseBackupResultOutput {
	...
	return ctx.InvokeOutput("oci:Database/getAutonomousDatabaseBackup:getAutonomousDatabaseBackup", args, LookupAutonomousDatabaseBackupResultOutput{}, options).(LookupAutonomousDatabaseBackupResultOutput)
}
