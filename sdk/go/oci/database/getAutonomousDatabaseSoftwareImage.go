...
func LookupAutonomousDatabaseSoftwareImageOutput(ctx *pulumi.Context, args LookupAutonomousDatabaseSoftwareImageOutputArgs, opts ...pulumi.InvokeOption) LookupAutonomousDatabaseSoftwareImageResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupAutonomousDatabaseSoftwareImageResult, error) {
			args := v.(LookupAutonomousDatabaseSoftwareImageArgs)
			r, err := LookupAutonomousDatabaseSoftwareImage(ctx, &args, opts...)
			var s LookupAutonomousDatabaseSoftwareImageResult
			if r != nil {
				s = *r
			}
			return s, err
...
// Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
func (o LookupAutonomousDatabaseSoftwareImageResultOutput) DefinedTags() pulumi.MapOutput {
	return o.ApplyT(func(v LookupAutonomousDatabaseSoftwareImageResult) map[string]interface{} { return v.DefinedTags }).(pulumi.MapOutput)
}
...
// Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
func (o LookupAutonomousDatabaseSoftwareImageResultOutput) FreeformTags() pulumi.MapOutput {
	return o.ApplyT(func(v LookupAutonomousDatabaseSoftwareImageResult) map[string]interface{} { return v.FreeformTags }).(pulumi.MapOutput)
}
