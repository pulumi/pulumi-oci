...
func LookupAutonomousVmClusterOutput(ctx *pulumi.Context, args LookupAutonomousVmClusterOutputArgs, opts ...pulumi.InvokeOption) LookupAutonomousVmClusterResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupAutonomousVmClusterResultOutput, error) {
			...
			return ctx.InvokeOutput("oci:Database/getAutonomousVmCluster:getAutonomousVmCluster", args, LookupAutonomousVmClusterResultOutput{}, options).(LookupAutonomousVmClusterResultOutput), nil
...
// Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
func (o LookupAutonomousVmClusterResultOutput) DefinedTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupAutonomousVmClusterResult) map[string]string { return v.DefinedTags }).(pulumi.StringMapOutput)
}
...
// Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
func (o LookupAutonomousVmClusterResultOutput) FreeformTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupAutonomousVmClusterResult) map[string]string { return v.FreeformTags }).(pulumi.StringMapOutput)
}
...
// The amount of memory (in GBs) to be enabled per OCPU or ECPU.
func (o LookupAutonomousVmClusterResultOutput) MemoryPerComputeUnitInGbs() pulumi.Float64Output {
	return o.ApplyT(func(v LookupAutonomousVmClusterResult) float64 { return v.MemoryPerComputeUnitInGbs }).(pulumi.Float64Output)
}
