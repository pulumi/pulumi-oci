...
// The provider-assigned unique ID for this managed resource.
func (o GetCloudAutonomousVmClustersResultOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetCloudAutonomousVmClustersResult) *string { return v.Id }).(pulumi.StringPtrOutput)
}
