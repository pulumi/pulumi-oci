...
func GetCloudExadataInfrastructuresOutput(ctx *pulumi.Context, args GetCloudExadataInfrastructuresOutputArgs, opts ...pulumi.InvokeOption) GetCloudExadataInfrastructuresResultOutput {
	...
	return ctx.InvokeOutput("oci:Database/getCloudExadataInfrastructures:getCloudExadataInfrastructures", args, GetCloudExadataInfrastructuresResultOutput{}, options).(GetCloudExadataInfrastructuresResultOutput)
}
