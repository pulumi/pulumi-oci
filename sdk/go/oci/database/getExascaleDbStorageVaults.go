...
func GetExascaleDbStorageVaultsOutput(ctx *pulumi.Context, args GetExascaleDbStorageVaultsOutputArgs, opts ...pulumi.InvokeOption) GetExascaleDbStorageVaultsResultOutput {
	...
	return ctx.InvokeOutput("oci:Database/getExascaleDbStorageVaults:getExascaleDbStorageVaults", args, GetExascaleDbStorageVaultsResultOutput{}, options).(GetExascaleDbStorageVaultsResultOutput)
}
