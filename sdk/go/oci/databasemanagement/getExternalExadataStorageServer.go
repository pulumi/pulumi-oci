...
func LookupExternalExadataStorageServerOutput(ctx *pulumi.Context, args LookupExternalExadataStorageServerOutputArgs, opts ...pulumi.InvokeOption) LookupExternalExadataStorageServerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupExternalExadataStorageServerResultOutput, error) {
			...
			return ctx.InvokeOutput("oci:DatabaseManagement/getExternalExadataStorageServer:getExternalExadataStorageServer", args, LookupExternalExadataStorageServerResultOutput{}, options).(LookupExternalExadataStorageServerResultOutput), nil
...
// The additional details of the resource defined in `{"key": "value"}` format. Example: `{"bar-key": "value"}`
func (o LookupExternalExadataStorageServerResultOutput) AdditionalDetails() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupExternalExadataStorageServerResult) map[string]string { return v.AdditionalDetails }).(pulumi.StringMapOutput)
}
...
// Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
func (o LookupExternalExadataStorageServerResultOutput) DefinedTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupExternalExadataStorageServerResult) map[string]string { return v.DefinedTags }).(pulumi.StringMapOutput)
}
...
// Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
func (o LookupExternalExadataStorageServerResultOutput) FreeformTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupExternalExadataStorageServerResult) map[string]string { return v.FreeformTags }).(pulumi.StringMapOutput)
}
...
// System tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). System tags can be viewed by users, but can only be created by the system.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
func (o LookupExternalExadataStorageServerResultOutput) SystemTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupExternalExadataStorageServerResult) map[string]string { return v.SystemTags }).(pulumi.StringMapOutput)
}
