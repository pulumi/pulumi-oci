...
func (o GetDatabaseToolsEndpointServiceResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetDatabaseToolsEndpointServiceResult] {
	return pulumix.Output[GetDatabaseToolsEndpointServiceResult]{
