...
func (o RegistryOutput) CompartmentId() pulumi.StringOutput {
	return o.ApplyT(func(v *Registry) pulumi.StringOutput { return v.CompartmentId }).(pulumi.StringOutput)
}

// (Updatable) Usage of predefined tag keys. These predefined keys are scoped to namespaces. Example: `{"foo-namespace.bar-key": "value"}`
func (o RegistryOutput) DefinedTags() pulumi.MapOutput {
	return o.ApplyT(func(v *Registry) pulumi.MapOutput { return v.DefinedTags }).(pulumi.MapOutput)
}
