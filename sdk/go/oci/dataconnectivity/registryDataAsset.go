...
func (o RegistryDataAssetOutput) AssetProperties() pulumi.MapOutput {
	return o.ApplyT(func(v *RegistryDataAsset) pulumi.MapOutput { return v.AssetProperties }).(pulumi.MapOutput)
}

// (Updatable) The default connection key.
func (o RegistryDataAssetOutput) DefaultConnection() RegistryDataAssetDefaultConnectionOutput {
...
// (Updatable) The list of endpoints with which this data asset is associated.
func (o RegistryDataAssetOutput) EndPoints() pulumi.StringArrayOutput {
...
// (Updatable) The identifying key for the object.
func (o RegistryDataAssetOutput) Key() pulumi.StringOutput {
...
// (Updatable) The type system maps from and to a type.
func (o RegistryDataAssetOutput) NativeTypeSystem() RegistryDataAssetNativeTypeSystemOutput {
	return o.ApplyT(func(v *RegistryDataAsset) RegistryDataAssetNativeTypeSystemOutput { return v.NativeTypeSystem }).(RegistryDataAssetNativeTypeSystemOutput)
}

// (Updatable) The status of an object that can be set to value 1 for shallow references across objects, other values reserved.
func (o RegistryDataAssetOutput) ObjectStatus() pulumi.IntOutput {
	return o.ApplyT(func(v *RegistryDataAsset) pulumi.IntOutput { return v.ObjectStatus }).(pulumi.IntOutput)
}

// (Updatable) The version of the object that is used to track changes in the object instance.
func (o RegistryDataAssetOutput) ObjectVersion() pulumi.IntOutput {
	return o.ApplyT(func(v *RegistryDataAsset) pulumi.IntOutput { return v.ObjectVersion }).(pulumi.IntOutput)
}
...
// (Updatable) Information about the object and its parent.
func (o RegistryDataAssetOutput) RegistryMetadata() RegistryDataAssetRegistryMetadataOutput {
	return o.ApplyT(func(v *RegistryDataAsset) RegistryDataAssetRegistryMetadataOutput { return v.RegistryMetadata }).(RegistryDataAssetRegistryMetadataOutput)
}

// (Updatable) Specific DataAsset Type
func (o RegistryDataAssetOutput) Type() pulumi.StringOutput {
	return o.ApplyT(func(v *RegistryDataAsset) pulumi.StringOutput { return v.Type }).(pulumi.StringOutput)
}
