...
// A comma separated list of one or more archive files as Oracle Cloud Infrastructure URIs. For example, “oci://path/to/a.zip,oci://path/to/b.zip“. An Oracle Cloud Infrastructure URI of an archive.zip file containing custom dependencies that may be used to support the execution of a Python, Java, or Scala application. See https://docs.cloud.oracle.com/iaas/Content/API/SDKDocs/hdfsconnector.htm#uriformat.
func (o LookupApplicationResultOutput) ArchiveUri() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.ArchiveUri }).(pulumi.StringPtrOutput)
}
...
// The class for the application.
func (o LookupApplicationResultOutput) ClassName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.ClassName }).(pulumi.StringPtrOutput)
}

// The OCID of a compartment.
func (o LookupApplicationResultOutput) CompartmentId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.CompartmentId }).(pulumi.StringPtrOutput)
}
...
// The VM shape for the driver. Sets the driver cores and memory.
func (o LookupApplicationResultOutput) DriverShape() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.DriverShape }).(pulumi.StringPtrOutput)
}
...
// The input used for spark-submit command. For more details see https://spark.apache.org/docs/latest/submitting-applications.html#launching-applications-with-spark-submit. Supported options include “--class“, “--file“, “--jars“, “--conf“, “--py-files“, and main application file with arguments. Example: “--jars oci://path/to/a.jar,oci://path/to/b.jar --files oci://path/to/a.json,oci://path/to/b.csv --py-files oci://path/to/a.py,oci://path/to/b.py --conf spark.sql.crossJoin.enabled=true --class org.apache.spark.examples.SparkPi oci://path/to/main.jar 10“ Note: If execute is specified together with applicationId, className, configuration, fileUri, language, arguments, parameters during application create/update, or run create/submit, Data Flow service will use derived information from execute input only.
func (o LookupApplicationResultOutput) Execute() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.Execute }).(pulumi.StringPtrOutput)
}

// The VM shape for the executors. Sets the executor cores and memory.
func (o LookupApplicationResultOutput) ExecutorShape() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.ExecutorShape }).(pulumi.StringPtrOutput)
}
...
// An Oracle Cloud Infrastructure URI of the file containing the application to execute. See https://docs.cloud.oracle.com/iaas/Content/API/SDKDocs/hdfsconnector.htm#uriformat.
func (o LookupApplicationResultOutput) FileUri() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.FileUri }).(pulumi.StringPtrOutput)
}
...
// The timeout value in minutes used to manage Runs. A Run would be stopped after inactivity for this amount of time period. Note: This parameter is currently only applicable for Runs of type `SESSION`. Default value is 2880 minutes (2 days)
func (o LookupApplicationResultOutput) IdleTimeoutInMinutes() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.IdleTimeoutInMinutes }).(pulumi.StringPtrOutput)
}

// The Spark language.
func (o LookupApplicationResultOutput) Language() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.Language }).(pulumi.StringPtrOutput)
}

// An Oracle Cloud Infrastructure URI of the bucket where the Spark job logs are to be uploaded. See https://docs.cloud.oracle.com/iaas/Content/API/SDKDocs/hdfsconnector.htm#uriformat.
func (o LookupApplicationResultOutput) LogsBucketUri() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.LogsBucketUri }).(pulumi.StringPtrOutput)
}

// The maximum duration in minutes for which an Application should run. Data Flow Run would be terminated once it reaches this duration from the time it transitions to `IN_PROGRESS` state.
func (o LookupApplicationResultOutput) MaxDurationInMinutes() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.MaxDurationInMinutes }).(pulumi.StringPtrOutput)
}

// The OCID of Oracle Cloud Infrastructure Hive Metastore.
func (o LookupApplicationResultOutput) MetastoreId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.MetastoreId }).(pulumi.StringPtrOutput)
}

// The number of executor VMs requested.
func (o LookupApplicationResultOutput) NumExecutors() pulumi.IntPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *int { return v.NumExecutors }).(pulumi.IntPtrOutput)
}

// The OCID of the user who created the resource.
func (o LookupApplicationResultOutput) OwnerPrincipalId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.OwnerPrincipalId }).(pulumi.StringPtrOutput)
}

// The username of the user who created the resource.  If the username of the owner does not exist, `null` will be returned and the caller should refer to the ownerPrincipalId value instead.
func (o LookupApplicationResultOutput) OwnerUserName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.OwnerUserName }).(pulumi.StringPtrOutput)
}
...
// The OCID of a pool. Unique Id to indentify a dataflow pool resource.
func (o LookupApplicationResultOutput) PoolId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.PoolId }).(pulumi.StringPtrOutput)
}

// The OCID of a private endpoint.
func (o LookupApplicationResultOutput) PrivateEndpointId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.PrivateEndpointId }).(pulumi.StringPtrOutput)
}

// The Spark version utilized to run the application.
func (o LookupApplicationResultOutput) SparkVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.SparkVersion }).(pulumi.StringPtrOutput)
}

// The current state of this application.
func (o LookupApplicationResultOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.State }).(pulumi.StringPtrOutput)
}

// The date and time the resource was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2018-04-03T21:10:29.600Z`
func (o LookupApplicationResultOutput) TimeCreated() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.TimeCreated }).(pulumi.StringPtrOutput)
}

// The date and time the resource was updated, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2018-04-03T21:10:29.600Z`
func (o LookupApplicationResultOutput) TimeUpdated() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.TimeUpdated }).(pulumi.StringPtrOutput)
}

// The Spark application processing type.
func (o LookupApplicationResultOutput) Type() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.Type }).(pulumi.StringPtrOutput)
}

// An Oracle Cloud Infrastructure URI of the bucket to be used as default warehouse directory for BATCH SQL runs. See https://docs.cloud.oracle.com/iaas/Content/API/SDKDocs/hdfsconnector.htm#uriformat.
func (o LookupApplicationResultOutput) WarehouseBucketUri() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupApplicationResult) *string { return v.WarehouseBucketUri }).(pulumi.StringPtrOutput)
}
