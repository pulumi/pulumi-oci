...
//			_, err := DataIntegration.NewWorkspaceApplicationSchedule(ctx, "testWorkspaceApplicationSchedule", &DataIntegration.WorkspaceApplicationScheduleArgs{
//				ApplicationKey: pulumi.Any(_var.Workspace_application_schedule_application_key),
//				Identifier:     pulumi.Any(_var.Workspace_application_schedule_identifier),
//				WorkspaceId:    pulumi.Any(oci_dataintegration_workspace.Test_workspace.Id),
//				Description:    pulumi.Any(_var.Workspace_application_schedule_description),
//				FrequencyDetails: &dataintegration.WorkspaceApplicationScheduleFrequencyDetailsArgs{
//					ModelType:        pulumi.Any(_var.Workspace_application_schedule_frequency_details_model_type),
//					CustomExpression: pulumi.Any(_var.Workspace_application_schedule_frequency_details_custom_expression),
//					DayOfWeek:        pulumi.Any(_var.Workspace_application_schedule_frequency_details_day_of_week),
//					Days:             pulumi.Any(_var.Workspace_application_schedule_frequency_details_days),
//					Frequency:        pulumi.Any(_var.Workspace_application_schedule_frequency_details_frequency),
//					Interval:         pulumi.Any(_var.Workspace_application_schedule_frequency_details_interval),
//					Time: &dataintegration.WorkspaceApplicationScheduleFrequencyDetailsTimeArgs{
//						Hour:   pulumi.Any(_var.Workspace_application_schedule_frequency_details_time_hour),
//						Minute: pulumi.Any(_var.Workspace_application_schedule_frequency_details_time_minute),
//						Second: pulumi.Any(_var.Workspace_application_schedule_frequency_details_time_second),
//					},
//					WeekOfMonth: pulumi.Any(_var.Workspace_application_schedule_frequency_details_week_of_month),
//				},
//				IsDaylightAdjustmentEnabled: pulumi.Any(_var.Workspace_application_schedule_is_daylight_adjustment_enabled),
//				Key:                         pulumi.Any(_var.Workspace_application_schedule_key),
//				ModelVersion:                pulumi.Any(_var.Workspace_application_schedule_model_version),
//				ObjectStatus:                pulumi.Any(_var.Workspace_application_schedule_object_status),
//				ObjectVersion:               pulumi.Any(_var.Workspace_application_schedule_object_version),
//				RegistryMetadata: &dataintegration.WorkspaceApplicationScheduleRegistryMetadataArgs{
//					AggregatorKey:   pulumi.Any(_var.Workspace_application_schedule_registry_metadata_aggregator_key),
//					IsFavorite:      pulumi.Any(_var.Workspace_application_schedule_registry_metadata_is_favorite),
//					Key:             pulumi.Any(_var.Workspace_application_schedule_registry_metadata_key),
//					Labels:          pulumi.Any(_var.Workspace_application_schedule_registry_metadata_labels),
//					RegistryVersion: pulumi.Any(_var.Workspace_application_schedule_registry_metadata_registry_version),
//				},
//				Timezone: pulumi.Any(_var.Workspace_application_schedule_timezone),
//			})
//			if err != nil {
//				return err
//			}
