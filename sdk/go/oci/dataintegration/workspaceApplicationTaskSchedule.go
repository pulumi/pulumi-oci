...
//			_, err := DataIntegration.NewWorkspaceApplicationTaskSchedule(ctx, "testWorkspaceApplicationTaskSchedule", &DataIntegration.WorkspaceApplicationTaskScheduleArgs{
//				ApplicationKey:         pulumi.Any(_var.Workspace_application_task_schedule_application_key),
//				Identifier:             pulumi.Any(_var.Workspace_application_task_schedule_identifier),
//				WorkspaceId:            pulumi.Any(oci_dataintegration_workspace.Test_workspace.Id),
//				AuthMode:               pulumi.Any(_var.Workspace_application_task_schedule_auth_mode),
//				ConfigProviderDelegate: pulumi.Any(_var.Workspace_application_task_schedule_config_provider_delegate),
//				Description:            pulumi.Any(_var.Workspace_application_task_schedule_description),
//				EndTimeMillis:          pulumi.Any(_var.Workspace_application_task_schedule_end_time_millis),
//				ExpectedDuration:       pulumi.Any(_var.Workspace_application_task_schedule_expected_duration),
//				ExpectedDurationUnit:   pulumi.Any(_var.Workspace_application_task_schedule_expected_duration_unit),
//				IsBackfillEnabled:      pulumi.Any(_var.Workspace_application_task_schedule_is_backfill_enabled),
//				IsConcurrentAllowed:    pulumi.Any(_var.Workspace_application_task_schedule_is_concurrent_allowed),
//				IsEnabled:              pulumi.Any(_var.Workspace_application_task_schedule_is_enabled),
//				Key:                    pulumi.Any(_var.Workspace_application_task_schedule_key),
//				ModelVersion:           pulumi.Any(_var.Workspace_application_task_schedule_model_version),
//				NumberOfRetries:        pulumi.Any(_var.Workspace_application_task_schedule_number_of_retries),
//				ObjectStatus:           pulumi.Any(_var.Workspace_application_task_schedule_object_status),
//				ObjectVersion:          pulumi.Any(_var.Workspace_application_task_schedule_object_version),
//				ParentRef: &dataintegration.WorkspaceApplicationTaskScheduleParentRefArgs{
//					Parent:    pulumi.Any(_var.Workspace_application_task_schedule_parent_ref_parent),
//					RootDocId: pulumi.Any(oci_dataintegration_root_doc.Test_root_doc.Id),
//				},
//				RegistryMetadata: &dataintegration.WorkspaceApplicationTaskScheduleRegistryMetadataArgs{
//					AggregatorKey:   pulumi.Any(_var.Workspace_application_task_schedule_registry_metadata_aggregator_key),
//					IsFavorite:      pulumi.Any(_var.Workspace_application_task_schedule_registry_metadata_is_favorite),
//					Key:             pulumi.Any(_var.Workspace_application_task_schedule_registry_metadata_key),
//					Labels:          pulumi.Any(_var.Workspace_application_task_schedule_registry_metadata_labels),
//					RegistryVersion: pulumi.Any(_var.Workspace_application_task_schedule_registry_metadata_registry_version),
//				},
//				RetryDelay:     pulumi.Any(_var.Workspace_application_task_schedule_retry_delay),
//				RetryDelayUnit: pulumi.Any(_var.Workspace_application_task_schedule_retry_delay_unit),
//				ScheduleRef: &dataintegration.WorkspaceApplicationTaskScheduleScheduleRefArgs{
//					Description: pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_description),
//					FrequencyDetails: &dataintegration.WorkspaceApplicationTaskScheduleScheduleRefFrequencyDetailsArgs{
//						ModelType:        pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_frequency_details_model_type),
//						CustomExpression: pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_frequency_details_custom_expression),
//						DayOfWeek:        pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_frequency_details_day_of_week),
//						Days:             pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_frequency_details_days),
//						Frequency:        pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_frequency_details_frequency),
//						Interval:         pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_frequency_details_interval),
//						Time: &dataintegration.WorkspaceApplicationTaskScheduleScheduleRefFrequencyDetailsTimeArgs{
//							Hour:   pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_frequency_details_time_hour),
//							Minute: pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_frequency_details_time_minute),
//							Second: pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_frequency_details_time_second),
//						},
//						WeekOfMonth: pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_frequency_details_week_of_month),
//					},
//					Identifier:                  pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_identifier),
//					IsDaylightAdjustmentEnabled: pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_is_daylight_adjustment_enabled),
//					Key:                         pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_key),
...
//							Description: pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_metadata_aggregator_description),
//							Identifier:  pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_metadata_aggregator_identifier),
//							Key:         pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_metadata_aggregator_key),
//							Name:        pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_metadata_aggregator_name),
//							Type:        pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_metadata_aggregator_type),
//						},
//						AggregatorKey: pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_metadata_aggregator_key),
...
//									ObjectCount: pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_metadata_count_statistics_object_type_count_list_object_count),
//									ObjectType:  pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_metadata_count_statistics_object_type_count_list_object_type),
//								},
//							},
//						},
//						CreatedBy:       pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_metadata_created_by),
//						CreatedByName:   pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_metadata_created_by_name),
//						IdentifierPath:  pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_metadata_identifier_path),
//						InfoFields:      pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_metadata_info_fields),
//						IsFavorite:      pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_metadata_is_favorite),
//						Labels:          pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_metadata_labels),
//						RegistryVersion: pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_metadata_registry_version),
//						TimeCreated:     pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_metadata_time_created),
//						TimeUpdated:     pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_metadata_time_updated),
//						UpdatedBy:       pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_metadata_updated_by),
//						UpdatedByName:   pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_metadata_updated_by_name),
//					},
//					ModelType:     pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_model_type),
//					ModelVersion:  pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_model_version),
//					Name:          pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_name),
//					ObjectStatus:  pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_object_status),
//					ObjectVersion: pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_object_version),
//					ParentRef: &dataintegration.WorkspaceApplicationTaskScheduleScheduleRefParentRefArgs{
//						Parent:    pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_parent_ref_parent),
//						RootDocId: pulumi.Any(oci_dataintegration_root_doc.Test_root_doc.Id),
//					},
//					Timezone: pulumi.Any(_var.Workspace_application_task_schedule_schedule_ref_timezone),
//				},
//				StartTimeMillis: pulumi.Any(_var.Workspace_application_task_schedule_start_time_millis),
//			})
//			if err != nil {
//				return err
//			}
