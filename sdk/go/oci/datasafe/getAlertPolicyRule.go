...
func (o GetAlertPolicyRuleResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetAlertPolicyRuleResult] {
	return pulumix.Output[GetAlertPolicyRuleResult]{
