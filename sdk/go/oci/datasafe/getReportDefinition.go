...
func LookupReportDefinitionOutput(ctx *pulumi.Context, args LookupReportDefinitionOutputArgs, opts ...pulumi.InvokeOption) LookupReportDefinitionResultOutput {
	...
	return ctx.InvokeOutput("oci:DataSafe/getReportDefinition:getReportDefinition", args, LookupReportDefinitionResultOutput{}, options).(LookupReportDefinitionResultOutput)
}
