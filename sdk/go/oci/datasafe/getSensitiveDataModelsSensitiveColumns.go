...
//				ColumnNames:                     pulumi.ToArray(sensitiveDataModelsSensitiveColumnColumnName),
//				ConfidenceLevels:                pulumi.ToArray(sensitiveDataModelsSensitiveColumnConfidenceLevel),
//				DataTypes:                       pulumi.ToArray(sensitiveDataModelsSensitiveColumnDataType),
//				IsCaseInSensitive:               pulumi.BoolRef(sensitiveDataModelsSensitiveColumnIsCaseInSensitive),
//				Objects:                         pulumi.ToArray(sensitiveDataModelsSensitiveColumnObject),
//				ObjectTypes:                     pulumi.ToArray(sensitiveDataModelsSensitiveColumnObjectType),
//				ParentColumnKeys:                pulumi.ToArray(sensitiveDataModelsSensitiveColumnParentColumnKey),
//				RelationTypes:                   pulumi.ToArray(sensitiveDataModelsSensitiveColumnRelationType),
//				SchemaNames:                     pulumi.ToArray(sensitiveDataModelsSensitiveColumnSchemaName),
//				SensitiveColumnLifecycleState:   pulumi.StringRef(sensitiveDataModelsSensitiveColumnSensitiveColumnLifecycleState),
//				SensitiveTypeIds:                pulumi.ToArray(testSensitiveType.Id),
//				Statuses:                        pulumi.ToArray(sensitiveDataModelsSensitiveColumnStatus),
