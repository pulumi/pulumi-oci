...
//				AccessLevel:            pulumi.StringRef(_var.Sql_collection_analytic_access_level),
//				CompartmentIdInSubtree: pulumi.BoolRef(_var.Sql_collection_analytic_compartment_id_in_subtree),
//				GroupBies:              _var.Sql_collection_analytic_group_by,
//				State:                  pulumi.StringRef(_var.Sql_collection_analytic_state),
//				TargetId:               pulumi.StringRef(oci_cloud_guard_target.Test_target.Id),
//				TimeEnded:              pulumi.StringRef(_var.Sql_collection_analytic_time_ended),
//				TimeStarted:            pulumi.StringRef(_var.Sql_collection_analytic_time_started),
//			}, nil)
//			if err != nil {
//				return err
//			}
...
func GetSqlCollectionAnalyticsOutput(ctx *pulumi.Context, args GetSqlCollectionAnalyticsOutputArgs, opts ...pulumi.InvokeOption) GetSqlCollectionAnalyticsResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (GetSqlCollectionAnalyticsResult, error) {
			args := v.(GetSqlCollectionAnalyticsArgs)
			r, err := GetSqlCollectionAnalytics(ctx, &args, opts...)
			var s GetSqlCollectionAnalyticsResult
			if r != nil {
				s = *r
			}
			return s, err
