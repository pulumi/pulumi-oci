...
//				AccessLevel:            pulumi.StringRef(_var.Sql_firewall_allowed_sql_analytic_access_level),
//				CompartmentIdInSubtree: pulumi.BoolRef(_var.Sql_firewall_allowed_sql_analytic_compartment_id_in_subtree),
//				GroupBies:              _var.Sql_firewall_allowed_sql_analytic_group_by,
//				ScimQuery:              pulumi.StringRef(_var.Sql_firewall_allowed_sql_analytic_scim_query),
//			}, nil)
//			if err != nil {
//				return err
//			}
...
func GetSqlFirewallAllowedSqlAnalyticsOutput(ctx *pulumi.Context, args GetSqlFirewallAllowedSqlAnalyticsOutputArgs, opts ...pulumi.InvokeOption) GetSqlFirewallAllowedSqlAnalyticsResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (GetSqlFirewallAllowedSqlAnalyticsResult, error) {
			args := v.(GetSqlFirewallAllowedSqlAnalyticsArgs)
			r, err := GetSqlFirewallAllowedSqlAnalytics(ctx, &args, opts...)
			var s GetSqlFirewallAllowedSqlAnalyticsResult
			if r != nil {
				s = *r
			}
			return s, err
