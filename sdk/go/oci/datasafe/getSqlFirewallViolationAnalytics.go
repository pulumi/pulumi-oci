...
//				AccessLevel:            pulumi.StringRef(_var.Sql_firewall_violation_analytic_access_level),
//				CompartmentIdInSubtree: pulumi.BoolRef(_var.Sql_firewall_violation_analytic_compartment_id_in_subtree),
//				GroupBies:              _var.Sql_firewall_violation_analytic_group_by,
//				QueryTimeZone:          pulumi.StringRef(_var.Sql_firewall_violation_analytic_query_time_zone),
//				ScimQuery:              pulumi.StringRef(_var.Sql_firewall_violation_analytic_scim_query),
//				SummaryFields:          _var.Sql_firewall_violation_analytic_summary_field,
//				TimeEnded:              pulumi.StringRef(_var.Sql_firewall_violation_analytic_time_ended),
//				TimeStarted:            pulumi.StringRef(_var.Sql_firewall_violation_analytic_time_started),
//			}, nil)
//			if err != nil {
//				return err
//			}
...
func GetSqlFirewallViolationAnalyticsOutput(ctx *pulumi.Context, args GetSqlFirewallViolationAnalyticsOutputArgs, opts ...pulumi.InvokeOption) GetSqlFirewallViolationAnalyticsResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (GetSqlFirewallViolationAnalyticsResult, error) {
			args := v.(GetSqlFirewallViolationAnalyticsArgs)
			r, err := GetSqlFirewallViolationAnalytics(ctx, &args, opts...)
			var s GetSqlFirewallViolationAnalyticsResult
			if r != nil {
				s = *r
			}
			return s, err
