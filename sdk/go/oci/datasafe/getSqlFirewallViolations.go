...
//				AccessLevel:            pulumi.StringRef(_var.Sql_firewall_violation_access_level),
//				CompartmentIdInSubtree: pulumi.BoolRef(_var.Sql_firewall_violation_compartment_id_in_subtree),
//				ScimQuery:              pulumi.StringRef(_var.Sql_firewall_violation_scim_query),
//			}, nil)
//			if err != nil {
//				return err
//			}
...
func GetSqlFirewallViolationsOutput(ctx *pulumi.Context, args GetSqlFirewallViolationsOutputArgs, opts ...pulumi.InvokeOption) GetSqlFirewallViolationsResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (GetSqlFirewallViolationsResult, error) {
			args := v.(GetSqlFirewallViolationsArgs)
			r, err := GetSqlFirewallViolations(ctx, &args, opts...)
			var s GetSqlFirewallViolationsResult
			if r != nil {
				s = *r
			}
			return s, err
