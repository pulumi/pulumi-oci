...
func LookupBuildPipelineOutput(ctx *pulumi.Context, args LookupBuildPipelineOutputArgs, opts ...pulumi.InvokeOption) LookupBuildPipelineResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupBuildPipelineResult, error) {
			args := v.(LookupBuildPipelineArgs)
			r, err := LookupBuildPipeline(ctx, &args, opts...)
			var s LookupBuildPipelineResult
			if r != nil {
				s = *r
			}
			return s, err
...
// The OCID of the compartment where the build pipeline is created.
func (o LookupBuildPipelineResultOutput) CompartmentId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupBuildPipelineResult) *string { return v.CompartmentId }).(pulumi.StringPtrOutput)
}
...
// Optional description about the build pipeline.
func (o LookupBuildPipelineResultOutput) Description() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupBuildPipelineResult) *string { return v.Description }).(pulumi.StringPtrOutput)
}

// Build pipeline display name, which can be renamed and is not necessarily unique. Avoid entering confidential information.
func (o LookupBuildPipelineResultOutput) DisplayName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupBuildPipelineResult) *string { return v.DisplayName }).(pulumi.StringPtrOutput)
}
...
// Unique identifier that is immutable on creation.
func (o LookupBuildPipelineResultOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupBuildPipelineResult) *string { return v.Id }).(pulumi.StringPtrOutput)
}

// A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
func (o LookupBuildPipelineResultOutput) LifecycleDetails() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupBuildPipelineResult) *string { return v.LifecycleDetails }).(pulumi.StringPtrOutput)
}

// The OCID of the DevOps project.
func (o LookupBuildPipelineResultOutput) ProjectId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupBuildPipelineResult) *string { return v.ProjectId }).(pulumi.StringPtrOutput)
}

// The current state of the build pipeline.
func (o LookupBuildPipelineResultOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupBuildPipelineResult) *string { return v.State }).(pulumi.StringPtrOutput)
}
...
// The time the build pipeline was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
func (o LookupBuildPipelineResultOutput) TimeCreated() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupBuildPipelineResult) *string { return v.TimeCreated }).(pulumi.StringPtrOutput)
}

// The time the build pipeline was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
func (o LookupBuildPipelineResultOutput) TimeUpdated() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupBuildPipelineResult) *string { return v.TimeUpdated }).(pulumi.StringPtrOutput)
}
