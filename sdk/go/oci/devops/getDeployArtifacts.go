...
func (o GetDeployArtifactsResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetDeployArtifactsResult] {
	return pulumix.Output[GetDeployArtifactsResult]{
