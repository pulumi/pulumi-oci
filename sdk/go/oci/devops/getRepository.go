...
//				Fields:       pulumi.ToArray(repositoryFields),
//			}, nil)
//			if err != nil {
//				return err
//			}
...
func LookupRepositoryOutput(ctx *pulumi.Context, args LookupRepositoryOutputArgs, opts ...pulumi.InvokeOption) LookupRepositoryResultOutput {
	...
	return ctx.InvokeOutput("oci:DevOps/getRepository:getRepository", args, LookupRepositoryResultOutput{}, options).(LookupRepositoryResultOutput)
}
