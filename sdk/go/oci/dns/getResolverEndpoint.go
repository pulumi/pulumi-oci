...
func LookupResolverEndpointOutput(ctx *pulumi.Context, args LookupResolverEndpointOutputArgs, opts ...pulumi.InvokeOption) LookupResolverEndpointResultOutput {
	...
	return ctx.InvokeOutput("oci:Dns/getResolverEndpoint:getResolverEndpoint", args, LookupResolverEndpointResultOutput{}, options).(LookupResolverEndpointResultOutput)
}
