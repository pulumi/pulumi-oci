...
func (o GetSteeringPoliciesResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetSteeringPoliciesResult] {
	return pulumix.Output[GetSteeringPoliciesResult]{
