...
//
// **Example:** `{"Operations": {"CostCenter": "42"}}`
func (o TsigKeyOutput) DefinedTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *TsigKey) pulumi.StringMapOutput { return v.DefinedTags }).(pulumi.StringMapOutput)
}

// (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
//
// **Example:** `{"Department": "Finance"}`
func (o TsigKeyOutput) FreeformTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *TsigKey) pulumi.StringMapOutput { return v.FreeformTags }).(pulumi.StringMapOutput)
}
