...
// The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to which this rule belongs.
func (o LookupRuleResultOutput) CompartmentId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupRuleResult) *string { return v.CompartmentId }).(pulumi.StringPtrOutput)
}

// A filter that specifies the event that will trigger actions associated with this rule. A few  important things to remember about filters:
// * Fields not mentioned in the condition are ignored. You can create a valid filter that matches all events with two curly brackets: `{}`
func (o LookupRuleResultOutput) Condition() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupRuleResult) *string { return v.Condition }).(pulumi.StringPtrOutput)
}
...
// A string that describes the rule. It does not have to be unique, and you can change it. Avoid entering confidential information.  Example: `"This rule sends a notification upon completion of DbaaS backup."`
func (o LookupRuleResultOutput) DisplayName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupRuleResult) *string { return v.DisplayName }).(pulumi.StringPtrOutput)
}
...
// Whether or not this rule is currently enabled.  Example: `true`
func (o LookupRuleResultOutput) IsEnabled() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v LookupRuleResult) *bool { return v.IsEnabled }).(pulumi.BoolPtrOutput)
}

// A message generated by the Events service about the current state of this rule.
func (o LookupRuleResultOutput) LifecycleMessage() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupRuleResult) *string { return v.LifecycleMessage }).(pulumi.StringPtrOutput)
}
...
// The time this rule was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.  Example: `2018-09-12T22:47:12.613Z`
func (o LookupRuleResultOutput) TimeCreated() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupRuleResult) *string { return v.TimeCreated }).(pulumi.StringPtrOutput)
}
