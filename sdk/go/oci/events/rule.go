...
type Rule struct {
	...
	LifecycleMessage pulumi.StringPtrOutput `pulumi:"lifecycleMessage"`
...
// A message generated by the Events service about the current state of this rule.
func (o RuleOutput) LifecycleMessage() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Rule) pulumi.StringPtrOutput { return v.LifecycleMessage }).(pulumi.StringPtrOutput)
}
