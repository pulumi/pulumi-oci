...
type FleetResource struct {
	...
	PercentCompliant pulumi.Float64Output `pulumi:"percentCompliant"`
...
type FleetResourceState struct {
	...
	// The compliance percentage.
	PercentCompliant pulumi.Float64PtrInput
	// Product associated with the resource when the resource type is fleet. Will only be returned for PRODUCT fleets that are part of a GROUP Fleet.
...
// The compliance percentage.
func (o FleetResourceOutput) PercentCompliant() pulumi.Float64Output {
	return o.ApplyT(func(v *FleetResource) pulumi.Float64Output { return v.PercentCompliant }).(pulumi.Float64Output)
}
