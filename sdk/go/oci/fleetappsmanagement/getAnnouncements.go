...
func GetAnnouncementsOutput(ctx *pulumi.Context, args GetAnnouncementsOutputArgs, opts ...pulumi.InvokeOption) GetAnnouncementsResultOutput {
	...
	return ctx.InvokeOutput("oci:FleetAppsManagement/getAnnouncements:getAnnouncements", args, GetAnnouncementsResultOutput{}, options).(GetAnnouncementsResultOutput)
}
