...
// TenancyId of the resource.
func (o GetComplianceRecordsResultOutput) CompartmentId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetComplianceRecordsResult) *string { return v.CompartmentId }).(pulumi.StringPtrOutput)
}
