...
func (o LookupMaintenanceWindowResultOutput) MaintenanceWindowType() pulumi.StringOutput {
	return o.ApplyT(func(v LookupMaintenanceWindowResult) string { return v.MaintenanceWindowType }).(pulumi.StringOutput)
}
...
func (o LookupMaintenanceWindowResultOutput) TaskInitiationCutoff() pulumi.IntOutput {
	return o.ApplyT(func(v LookupMaintenanceWindowResult) int { return v.TaskInitiationCutoff }).(pulumi.IntOutput)
}
