...
func GetMaintenanceWindowsOutput(ctx *pulumi.Context, args GetMaintenanceWindowsOutputArgs, opts ...pulumi.InvokeOption) GetMaintenanceWindowsResultOutput {
	...
	return ctx.InvokeOutput("oci:FleetAppsManagement/getMaintenanceWindows:getMaintenanceWindows", args, GetMaintenanceWindowsResultOutput{}, options).(GetMaintenanceWindowsResultOutput)
}
