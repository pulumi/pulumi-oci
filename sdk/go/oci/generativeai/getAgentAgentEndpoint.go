...
type LookupAgentAgentEndpointResult struct {
	...
	ProvisionedCapacityConfigs []GetAgentAgentEndpointProvisionedCapacityConfig `pulumi:"provisionedCapacityConfigs"`
...
func LookupAgentAgentEndpointOutput(ctx *pulumi.Context, args LookupAgentAgentEndpointOutputArgs, opts ...pulumi.InvokeOption) LookupAgentAgentEndpointResultOutput {
	...
	return ctx.InvokeOutput("oci:GenerativeAi/getAgentAgentEndpoint:getAgentAgentEndpoint", args, LookupAgentAgentEndpointResultOutput{}, options).(LookupAgentAgentEndpointResultOutput)
}
...
// The configuration includes the provisioned capacity id and component runtime (tool versions, and other relevant information).
func (o LookupAgentAgentEndpointResultOutput) ProvisionedCapacityConfigs() GetAgentAgentEndpointProvisionedCapacityConfigArrayOutput {
	return o.ApplyT(func(v LookupAgentAgentEndpointResult) []GetAgentAgentEndpointProvisionedCapacityConfig {
		return v.ProvisionedCapacityConfigs
	}).(GetAgentAgentEndpointProvisionedCapacityConfigArrayOutput)
}
