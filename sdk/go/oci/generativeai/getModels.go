...
//				Capabilities:  pulumi.ToArray(modelCapability),
...
func GetModelsOutput(ctx *pulumi.Context, args GetModelsOutputArgs, opts ...pulumi.InvokeOption) GetModelsResultOutput {
	...
	return ctx.InvokeOutput("oci:GenerativeAi/getModels:getModels", args, GetModelsResultOutput{}, options).(GetModelsResultOutput)
}
