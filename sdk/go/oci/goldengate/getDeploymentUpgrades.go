...
// The provider-assigned unique ID for this managed resource.
func (o GetDeploymentUpgradesResultOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetDeploymentUpgradesResult) *string { return v.Id }).(pulumi.StringPtrOutput)
}
