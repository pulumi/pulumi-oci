...
// The provider-assigned unique ID for this managed resource.
func (o GetCustomerSecretKeysResultOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetCustomerSecretKeysResult) *string { return v.Id }).(pulumi.StringPtrOutput)
}
