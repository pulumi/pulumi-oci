...
func (o LookupDomainsMyCustomerSecretKeyResultOutput) ToOutput(ctx context.Context) pulumix.Output[LookupDomainsMyCustomerSecretKeyResult] {
	return pulumix.Output[LookupDomainsMyCustomerSecretKeyResult]{
