...
func (o SwiftPasswordOutput) Description() pulumi.StringOutput {
	return o.ApplyT(func(v *SwiftPassword) pulumi.StringOutput { return v.Description }).(pulumi.StringOutput)
}

// Date and time when this password will expire, in the format defined by RFC3339. Null if it never expires.  Example: `2016-08-25T21:10:29.600Z`
func (o SwiftPasswordOutput) ExpiresOn() pulumi.StringOutput {
	return o.ApplyT(func(v *SwiftPassword) pulumi.StringOutput { return v.ExpiresOn }).(pulumi.StringOutput)
}

// The detailed status of INACTIVE lifecycleState.
func (o SwiftPasswordOutput) InactiveState() pulumi.StringOutput {
	return o.ApplyT(func(v *SwiftPassword) pulumi.StringOutput { return v.InactiveState }).(pulumi.StringOutput)
}

// The Swift password. The value is available only in the response for `CreateSwiftPassword`, and not for `ListSwiftPasswords` or `UpdateSwiftPassword`.
func (o SwiftPasswordOutput) Password() pulumi.StringOutput {
	return o.ApplyT(func(v *SwiftPassword) pulumi.StringOutput { return v.Password }).(pulumi.StringOutput)
}

// The password's current state.
func (o SwiftPasswordOutput) State() pulumi.StringOutput {
	return o.ApplyT(func(v *SwiftPassword) pulumi.StringOutput { return v.State }).(pulumi.StringOutput)
}

// Date and time the `SwiftPassword` object was created, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
func (o SwiftPasswordOutput) TimeCreated() pulumi.StringOutput {
	return o.ApplyT(func(v *SwiftPassword) pulumi.StringOutput { return v.TimeCreated }).(pulumi.StringOutput)
}
