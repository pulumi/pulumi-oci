...
func (o GeneratedKeyOutput) CryptoEndpoint() pulumi.StringOutput {
	return o.ApplyT(func(v *GeneratedKey) pulumi.StringOutput { return v.CryptoEndpoint }).(pulumi.StringOutput)
}

// If true, the generated key is also returned unencrypted.
func (o GeneratedKeyOutput) IncludePlaintextKey() pulumi.BoolOutput {
	return o.ApplyT(func(v *GeneratedKey) pulumi.BoolOutput { return v.IncludePlaintextKey }).(pulumi.BoolOutput)
}

// The OCID of the master encryption key to encrypt the generated data encryption key with.
func (o GeneratedKeyOutput) KeyId() pulumi.StringOutput {
	return o.ApplyT(func(v *GeneratedKey) pulumi.StringOutput { return v.KeyId }).(pulumi.StringOutput)
}

// The cryptographic properties of a key.
func (o GeneratedKeyOutput) KeyShape() GeneratedKeyKeyShapeOutput {
	return o.ApplyT(func(v *GeneratedKey) GeneratedKeyKeyShapeOutput { return v.KeyShape }).(GeneratedKeyKeyShapeOutput)
}
