...
// Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
func (o LookupLicenseRecordResultOutput) DefinedTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupLicenseRecordResult) map[string]string { return v.DefinedTags }).(pulumi.StringMapOutput)
}
...
// Simple key-value pair that is applied without any predefined name, type, or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
func (o LookupLicenseRecordResultOutput) FreeformTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupLicenseRecordResult) map[string]string { return v.FreeformTags }).(pulumi.StringMapOutput)
}
...
// Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
func (o LookupLicenseRecordResultOutput) SystemTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupLicenseRecordResult) map[string]string { return v.SystemTags }).(pulumi.StringMapOutput)
}
