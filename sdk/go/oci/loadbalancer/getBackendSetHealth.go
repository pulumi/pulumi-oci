...
func GetBackendSetHealthOutput(ctx *pulumi.Context, args GetBackendSetHealthOutputArgs, opts ...pulumi.InvokeOption) GetBackendSetHealthResultOutput {
	...
	return ctx.InvokeOutput("oci:LoadBalancer/getBackendSetHealth:getBackendSetHealth", args, GetBackendSetHealthResultOutput{}, options).(GetBackendSetHealthResultOutput)
}
