...
func (o SslCipherSuiteOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *SslCipherSuite) pulumi.StringPtrOutput { return v.State }).(pulumi.StringPtrOutput)
}
