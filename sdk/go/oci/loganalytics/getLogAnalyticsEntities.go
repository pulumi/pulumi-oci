...
//				DefinedTagEquals:             pulumi.ToArray(logAnalyticsEntityDefinedTagEquals),
//				DefinedTagExists:             pulumi.ToArray(logAnalyticsEntityDefinedTagExists),
//				EntityTypeNames:              pulumi.ToArray(logAnalyticsEntityEntityTypeName),
//				FreeformTagEquals:            pulumi.ToArray(logAnalyticsEntityFreeformTagEquals),
//				FreeformTagExists:            pulumi.ToArray(logAnalyticsEntityFreeformTagExists),
...
//				MetadataEquals:               pulumi.ToArray(logAnalyticsEntityMetadataEquals),
