...
// The unique identifier for the listing.
func (o ListingPackageAgreementOutput) ListingId() pulumi.StringOutput {
	return o.ApplyT(func(v *ListingPackageAgreement) pulumi.StringOutput { return v.ListingId }).(pulumi.StringOutput)
}

// The version of the package. Package versions are unique within a listing.
func (o ListingPackageAgreementOutput) PackageVersion() pulumi.StringOutput {
	return o.ApplyT(func(v *ListingPackageAgreement) pulumi.StringOutput { return v.PackageVersion }).(pulumi.StringOutput)
}
