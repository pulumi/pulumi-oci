...
func (o GetMediaWorkflowConfigurationsResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetMediaWorkflowConfigurationsResult] {
	return pulumix.Output[GetMediaWorkflowConfigurationsResult]{
