...
func (o GetStreamDistributionChannelsResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetStreamDistributionChannelsResult] {
	return pulumix.Output[GetStreamDistributionChannelsResult]{
