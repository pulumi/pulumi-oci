...
func LookupUsageStatementEmailRecipientsGroupOutput(ctx *pulumi.Context, args LookupUsageStatementEmailRecipientsGroupOutputArgs, opts ...pulumi.InvokeOption) LookupUsageStatementEmailRecipientsGroupResultOutput {
	...
	return ctx.InvokeOutput("oci:MeteringComputation/getUsageStatementEmailRecipientsGroup:getUsageStatementEmailRecipientsGroup", args, LookupUsageStatementEmailRecipientsGroupResultOutput{}, options).(LookupUsageStatementEmailRecipientsGroupResultOutput)
}
