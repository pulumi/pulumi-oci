...
type NetworkFirewallPolicyAddressList struct {
	...
	TotalAddresses pulumi.IntPtrOutput `pulumi:"totalAddresses"`
...
// OCID of the Network Firewall Policy this Address List belongs to.
func (o NetworkFirewallPolicyAddressListOutput) ParentResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *NetworkFirewallPolicyAddressList) pulumi.StringPtrOutput { return v.ParentResourceId }).(pulumi.StringPtrOutput)
}

// Count of total addresses in the AddressList
func (o NetworkFirewallPolicyAddressListOutput) TotalAddresses() pulumi.IntPtrOutput {
	return o.ApplyT(func(v *NetworkFirewallPolicyAddressList) pulumi.IntPtrOutput { return v.TotalAddresses }).(pulumi.IntPtrOutput)
}
