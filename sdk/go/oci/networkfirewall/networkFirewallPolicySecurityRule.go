...
// OCID of the Network Firewall Policy this security rule belongs to.
func (o NetworkFirewallPolicySecurityRuleOutput) ParentResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *NetworkFirewallPolicySecurityRule) pulumi.StringPtrOutput { return v.ParentResourceId }).(pulumi.StringPtrOutput)
}
