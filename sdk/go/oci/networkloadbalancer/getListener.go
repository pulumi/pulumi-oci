...
func LookupListenerOutput(ctx *pulumi.Context, args LookupListenerOutputArgs, opts ...pulumi.InvokeOption) LookupListenerResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (LookupListenerResultOutput, error) {
			...
			return ctx.InvokeOutput("oci:NetworkLoadBalancer/getListener:getListener", args, LookupListenerResultOutput{}, options).(LookupListenerResultOutput), nil
...
// The duration for TCP idle timeout in seconds. Example: `300`
func (o LookupListenerResultOutput) TcpIdleTimeout() pulumi.IntOutput {
	return o.ApplyT(func(v LookupListenerResult) int { return v.TcpIdleTimeout }).(pulumi.IntOutput)
}

// The duration for UDP idle timeout in seconds. Example: `120`
func (o LookupListenerResultOutput) UdpIdleTimeout() pulumi.IntOutput {
	return o.ApplyT(func(v LookupListenerResult) int { return v.UdpIdleTimeout }).(pulumi.IntOutput)
}
