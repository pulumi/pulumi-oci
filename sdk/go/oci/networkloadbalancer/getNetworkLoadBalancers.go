...
// The provider-assigned unique ID for this managed resource.
func (o GetNetworkLoadBalancersResultOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetNetworkLoadBalancersResult) *string { return v.Id }).(pulumi.StringPtrOutput)
}
