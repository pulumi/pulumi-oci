...
// (Updatable) IP version associated with the listener.
func (o ListenerOutput) IpVersion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v *Listener) pulumi.StringPtrOutput { return v.IpVersion }).(pulumi.StringPtrOutput)
}
