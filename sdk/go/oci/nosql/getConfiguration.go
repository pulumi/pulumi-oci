...
// import (
//
//	"github.com/pulumi/pulumi-oci/sdk/v5/go/oci/nosql"
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//
// )
//
...
func LookupConfigurationOutput(ctx *pulumi.Context, args LookupConfigurationOutputArgs, opts ...pulumi.InvokeOption) LookupConfigurationResultOutput {
	...
	return ctx.InvokeOutput("oci:Nosql/getConfiguration:getConfiguration", args, LookupConfigurationResultOutput{}, options).(LookupConfigurationResultOutput)
}
