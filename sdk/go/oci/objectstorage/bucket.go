...
// import (
//
//	"github.com/pulumi/pulumi-oci/sdk/v5/go/oci/objectstorage"
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//
// )
//
...
//				BucketScope:   pulumi.Any(bucketBucketScope),
...
//				},
//				IsBucketKeyEnabled:  pulumi.Any(bucketIsBucketKeyEnabled),
...
type Bucket struct {
	...
	BucketScope pulumi.StringOutput `pulumi:"bucketScope"`
	...
	IsBucketKeyEnabled pulumi.BoolOutput `pulumi:"isBucketKeyEnabled"`
...
type BucketState struct {
	...
	// (Updatable) Scope in which the bucket is unique. Default value is NAMESPACE. Bucket scope as NAMESPACE means that the bucket is unique only in the owning namespace/tenancy. Other  tenancies can have a bucket with same name in their namespace. Bucket scope as REGION means that the bucket is regionally unique. No other tenancy can have a bucket with same name and scope REGION.
	BucketScope pulumi.StringPtrInput
	// (Updatable) The ID of the compartment in which to create the bucket.
	...
	// (Updatable) Specifies whether Object Storage should use intermediate cached Bucket Encryption Keys with server-side encryption using KMS (SSE-KMS) for new objects in the bucket. This reduces calls to Oracle Cloud Infrastructure Vault Key Management Service (KMS). Existing objects are not affected.
	IsBucketKeyEnabled pulumi.BoolPtrInput
	// Whether or not this bucket is read only. By default, `isReadOnly` is set to `false`. This will be set to 'true' when this bucket is configured as a destination in a replication policy.
...
// (Updatable) Scope in which the bucket is unique. Default value is NAMESPACE. Bucket scope as NAMESPACE means that the bucket is unique only in the owning namespace/tenancy. Other  tenancies can have a bucket with same name in their namespace. Bucket scope as REGION means that the bucket is regionally unique. No other tenancy can have a bucket with same name and scope REGION.
func (o BucketOutput) BucketScope() pulumi.StringOutput {
	return o.ApplyT(func(v *Bucket) pulumi.StringOutput { return v.BucketScope }).(pulumi.StringOutput)
}
...
// (Updatable) Specifies whether Object Storage should use intermediate cached Bucket Encryption Keys with server-side encryption using KMS (SSE-KMS) for new objects in the bucket. This reduces calls to Oracle Cloud Infrastructure Vault Key Management Service (KMS). Existing objects are not affected.
func (o BucketOutput) IsBucketKeyEnabled() pulumi.BoolOutput {
	return o.ApplyT(func(v *Bucket) pulumi.BoolOutput { return v.IsBucketKeyEnabled }).(pulumi.BoolOutput)
}
