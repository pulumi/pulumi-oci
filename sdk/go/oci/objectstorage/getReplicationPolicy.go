...
func LookupReplicationPolicyOutput(ctx *pulumi.Context, args LookupReplicationPolicyOutputArgs, opts ...pulumi.InvokeOption) LookupReplicationPolicyResultOutput {
	...
	return ctx.InvokeOutput("oci:ObjectStorage/getReplicationPolicy:getReplicationPolicy", args, LookupReplicationPolicyResultOutput{}, options).(LookupReplicationPolicyResultOutput)
}
