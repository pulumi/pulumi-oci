...
func GetComputedUsagesOutput(ctx *pulumi.Context, args GetComputedUsagesOutputArgs, opts ...pulumi.InvokeOption) GetComputedUsagesResultOutput {
	...
	return ctx.InvokeOutput("oci:OneSubsription/getComputedUsages:getComputedUsages", args, GetComputedUsagesResultOutput{}, options).(GetComputedUsagesResultOutput)
}
