...
// import (
//
//	"github.com/pulumi/pulumi-oci/sdk/v5/go/oci/onesubsription"
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//
// )
//
...
func GetSubscriptionsOutput(ctx *pulumi.Context, args GetSubscriptionsOutputArgs, opts ...pulumi.InvokeOption) GetSubscriptionsResultOutput {
	...
	return ctx.InvokeOutput("oci:OneSubsription/getSubscriptions:getSubscriptions", args, GetSubscriptionsResultOutput{}, options).(GetSubscriptionsResultOutput)
}
