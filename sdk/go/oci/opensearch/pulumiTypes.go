...
type GetOpensearchClustersOpensearchClusterCollectionItemArgs struct {
	...
	// The number of ML nodes configured for the cluster.
	MlNodeCount pulumi.IntInput `pulumi:"mlNodeCount"`
	// The amount of memory in GB, for the cluster's ML nodes.
	MlNodeHostMemoryGb pulumi.IntInput `pulumi:"mlNodeHostMemoryGb"`
	// The number of OCPUs configured for the cluster's ML nodes.
	MlNodeHostOcpuCount pulumi.IntInput `pulumi:"mlNodeHostOcpuCount"`
	// The node shape for the cluster's ML nodes.
	MlNodeHostShape pulumi.StringInput `pulumi:"mlNodeHostShape"`
	// The instance type for the cluster's ML nodes.
	MlNodeHostType pulumi.StringInput `pulumi:"mlNodeHostType"`
	// The amount of storage in GB, to configure per node for the cluster's ML nodes.
	MlNodeStorageGb pulumi.IntInput `pulumi:"mlNodeStorageGb"`
	// The OCID of the NSG where the private endpoint vnic will be attached.
	NsgId pulumi.StringInput `pulumi:"nsgId"`
	// The fully qualified domain name (FQDN) for the cluster's OpenSearch Dashboard API endpoint.
...
// The number of ML nodes configured for the cluster.
func (o GetOpensearchClustersOpensearchClusterCollectionItemOutput) MlNodeCount() pulumi.IntOutput {
	return o.ApplyT(func(v GetOpensearchClustersOpensearchClusterCollectionItem) int { return v.MlNodeCount }).(pulumi.IntOutput)
}

// The amount of memory in GB, for the cluster's ML nodes.
func (o GetOpensearchClustersOpensearchClusterCollectionItemOutput) MlNodeHostMemoryGb() pulumi.IntOutput {
	return o.ApplyT(func(v GetOpensearchClustersOpensearchClusterCollectionItem) int { return v.MlNodeHostMemoryGb }).(pulumi.IntOutput)
}

// The number of OCPUs configured for the cluster's ML nodes.
func (o GetOpensearchClustersOpensearchClusterCollectionItemOutput) MlNodeHostOcpuCount() pulumi.IntOutput {
	return o.ApplyT(func(v GetOpensearchClustersOpensearchClusterCollectionItem) int { return v.MlNodeHostOcpuCount }).(pulumi.IntOutput)
}

// The node shape for the cluster's ML nodes.
func (o GetOpensearchClustersOpensearchClusterCollectionItemOutput) MlNodeHostShape() pulumi.StringOutput {
	return o.ApplyT(func(v GetOpensearchClustersOpensearchClusterCollectionItem) string { return v.MlNodeHostShape }).(pulumi.StringOutput)
}

// The instance type for the cluster's ML nodes.
func (o GetOpensearchClustersOpensearchClusterCollectionItemOutput) MlNodeHostType() pulumi.StringOutput {
	return o.ApplyT(func(v GetOpensearchClustersOpensearchClusterCollectionItem) string { return v.MlNodeHostType }).(pulumi.StringOutput)
}

// The amount of storage in GB, to configure per node for the cluster's ML nodes.
func (o GetOpensearchClustersOpensearchClusterCollectionItemOutput) MlNodeStorageGb() pulumi.IntOutput {
	return o.ApplyT(func(v GetOpensearchClustersOpensearchClusterCollectionItem) int { return v.MlNodeStorageGb }).(pulumi.IntOutput)
}
