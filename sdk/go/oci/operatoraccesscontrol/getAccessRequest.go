...
// Summary comment by the operator creating the access request.
func (o GetAccessRequestResultOutput) AccessReasonSummary() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.AccessReasonSummary }).(pulumi.StringPtrOutput)
}
...
// The last recent Comment entered by the approver of the request.
func (o GetAccessRequestResultOutput) ApproverComment() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.ApproverComment }).(pulumi.StringPtrOutput)
}
...
// The comment entered by the operator while closing the request.
func (o GetAccessRequestResultOutput) ClosureComment() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.ClosureComment }).(pulumi.StringPtrOutput)
}

// The OCID of the compartment that contains the access request.
func (o GetAccessRequestResultOutput) CompartmentId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.CompartmentId }).(pulumi.StringPtrOutput)
}
...
// Duration in hours for which access is sought on the target resource.
func (o GetAccessRequestResultOutput) Duration() pulumi.IntPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *int { return v.Duration }).(pulumi.IntPtrOutput)
}

// Duration in hours for which extension access is sought on the target resource.
func (o GetAccessRequestResultOutput) ExtendDuration() pulumi.IntPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *int { return v.ExtendDuration }).(pulumi.IntPtrOutput)
}
...
// The provider-assigned unique ID for this managed resource.
func (o GetAccessRequestResultOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.Id }).(pulumi.StringPtrOutput)
}

// Whether the access request was automatically approved.
func (o GetAccessRequestResultOutput) IsAutoApproved() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *bool { return v.IsAutoApproved }).(pulumi.BoolPtrOutput)
}

// more in detail about the lifeCycleState.
func (o GetAccessRequestResultOutput) LifecycleDetails() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.LifecycleDetails }).(pulumi.StringPtrOutput)
}

// Additional message specific to the access request that can be specified by the approver at the time of approval.
func (o GetAccessRequestResultOutput) OpctlAdditionalMessage() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.OpctlAdditionalMessage }).(pulumi.StringPtrOutput)
}

// The OCID of the operator control governing the target resource.
func (o GetAccessRequestResultOutput) OpctlId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.OpctlId }).(pulumi.StringPtrOutput)
}

// Name of the Operator control governing the target resource.
func (o GetAccessRequestResultOutput) OpctlName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.OpctlName }).(pulumi.StringPtrOutput)
}

// A unique identifier associated with the operator who raised the request. This identifier can not be used directly to identify the operator. You need to provide this identifier if you would like Oracle to provide additional information about the operator action within Oracle tenancy.
func (o GetAccessRequestResultOutput) OperatorId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.OperatorId }).(pulumi.StringPtrOutput)
}

// Summary reason for which the operator is requesting access on the target resource.
func (o GetAccessRequestResultOutput) Reason() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.Reason }).(pulumi.StringPtrOutput)
}

// This is an automatic identifier generated by the system which is easier for human comprehension.
func (o GetAccessRequestResultOutput) RequestId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.RequestId }).(pulumi.StringPtrOutput)
}

// The OCID of the target resource associated with the access request. The operator raises an access request to get approval to  access the target resource.
func (o GetAccessRequestResultOutput) ResourceId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.ResourceId }).(pulumi.StringPtrOutput)
}

// The name of the target resource.
func (o GetAccessRequestResultOutput) ResourceName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.ResourceName }).(pulumi.StringPtrOutput)
}

// resourceType for which the AccessRequest is applicable
func (o GetAccessRequestResultOutput) ResourceType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.ResourceType }).(pulumi.StringPtrOutput)
}

// Priority assigned to the access request by the operator
func (o GetAccessRequestResultOutput) Severity() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.Severity }).(pulumi.StringPtrOutput)
}

// The current state of the AccessRequest.
func (o GetAccessRequestResultOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.State }).(pulumi.StringPtrOutput)
}
...
// System message that will be displayed to the operator at login to the target resource.
func (o GetAccessRequestResultOutput) SystemMessage() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.SystemMessage }).(pulumi.StringPtrOutput)
}

// Time when the access request was created in [RFC 3339](https://tools.ietf.org/html/rfc3339)timestamp format. Example: '2020-05-22T21:10:29.600Z'
func (o GetAccessRequestResultOutput) TimeOfCreation() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.TimeOfCreation }).(pulumi.StringPtrOutput)
}

// Time when the access request was last modified in [RFC 3339](https://tools.ietf.org/html/rfc3339)timestamp format. Example: '2020-05-22T21:10:29.600Z'
func (o GetAccessRequestResultOutput) TimeOfModification() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.TimeOfModification }).(pulumi.StringPtrOutput)
}

// The time when access request is scheduled to be approved in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.Example: '2020-05-22T21:10:29.600Z'
func (o GetAccessRequestResultOutput) TimeOfUserCreation() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.TimeOfUserCreation }).(pulumi.StringPtrOutput)
}

// The OCID of the user that last modified the access request.
func (o GetAccessRequestResultOutput) UserId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetAccessRequestResult) *string { return v.UserId }).(pulumi.StringPtrOutput)
}
