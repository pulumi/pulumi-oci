...
func (o GetControlAssignmentResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetControlAssignmentResult] {
	return pulumix.Output[GetControlAssignmentResult]{
