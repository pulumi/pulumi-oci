...
func GetAwrHubAwrSnapshotsOutput(ctx *pulumi.Context, args GetAwrHubAwrSnapshotsOutputArgs, opts ...pulumi.InvokeOption) GetAwrHubAwrSnapshotsResultOutput {
	...
	return ctx.InvokeOutput("oci:Opsi/getAwrHubAwrSnapshots:getAwrHubAwrSnapshots", args, GetAwrHubAwrSnapshotsResultOutput{}, options).(GetAwrHubAwrSnapshotsResultOutput)
}
