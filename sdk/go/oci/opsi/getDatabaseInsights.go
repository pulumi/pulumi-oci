...
func (o GetDatabaseInsightsResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetDatabaseInsightsResult] {
	return pulumix.Output[GetDatabaseInsightsResult]{
