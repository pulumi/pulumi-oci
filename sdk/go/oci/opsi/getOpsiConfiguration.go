...
func LookupOpsiConfigurationOutput(ctx *pulumi.Context, args LookupOpsiConfigurationOutputArgs, opts ...pulumi.InvokeOption) LookupOpsiConfigurationResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupOpsiConfigurationResultOutput, error) {
			args := v.(LookupOpsiConfigurationArgs)
			opts = internal.PkgInvokeDefaultOpts(opts)
			var rv LookupOpsiConfigurationResult
			secret, err := ctx.InvokePackageRaw("oci:Opsi/getOpsiConfiguration:getOpsiConfiguration", args, &rv, "", opts...)
			if err != nil {
				return LookupOpsiConfigurationResultOutput{}, err
			}

			output := pulumi.ToOutput(rv).(LookupOpsiConfigurationResultOutput)
			if secret {
				return pulumi.ToSecret(output).(LookupOpsiConfigurationResultOutput), nil
			}
			return output, nil
...
// Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
func (o LookupOpsiConfigurationResultOutput) DefinedTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupOpsiConfigurationResult) map[string]string { return v.DefinedTags }).(pulumi.StringMapOutput)
}
...
// Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
func (o LookupOpsiConfigurationResultOutput) FreeformTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupOpsiConfigurationResult) map[string]string { return v.FreeformTags }).(pulumi.StringMapOutput)
}
...
// System tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"orcl-cloud.free-tier-retained": "true"}`
func (o LookupOpsiConfigurationResultOutput) SystemTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v LookupOpsiConfigurationResult) map[string]string { return v.SystemTags }).(pulumi.StringMapOutput)
}
