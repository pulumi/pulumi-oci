...
// The provider-assigned unique ID for this managed resource.
func (o GetOpsiConfigurationsResultOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetOpsiConfigurationsResult) *string { return v.Id }).(pulumi.StringPtrOutput)
}
