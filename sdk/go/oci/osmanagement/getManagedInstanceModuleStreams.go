...
func (o GetManagedInstanceModuleStreamsResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetManagedInstanceModuleStreamsResult] {
	return pulumix.Output[GetManagedInstanceModuleStreamsResult]{
