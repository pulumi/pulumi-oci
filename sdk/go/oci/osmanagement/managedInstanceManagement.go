...
func (o ManagedInstanceManagementOutput) ChildSoftwareSources() ManagedInstanceManagementChildSoftwareSourceArrayOutput {
	...
	}).(ManagedInstanceManagementChildSoftwareSourceArrayOutput)
}
...
// (Updatable) The ids of the managed instance groups of which this instance is a member.
func (o ManagedInstanceManagementOutput) ManagedInstanceGroups() ManagedInstanceManagementManagedInstanceGroupArrayOutput {
	return o.ApplyT(func(v *ManagedInstanceManagement) ManagedInstanceManagementManagedInstanceGroupArrayOutput {
		return v.ManagedInstanceGroups
	}).(ManagedInstanceManagementManagedInstanceGroupArrayOutput)
}

// OCID for the managed instance
func (o ManagedInstanceManagementOutput) ManagedInstanceId() pulumi.StringOutput {
	return o.ApplyT(func(v *ManagedInstanceManagement) pulumi.StringOutput { return v.ManagedInstanceId }).(pulumi.StringOutput)
}
