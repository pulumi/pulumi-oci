...
//				DisplayNames:                 pulumi.ToArray(profileDisplayName),
...
//				ManagementStations:           pulumi.ToArray(profileManagementStation),
//				ManagementStationNotEqualTos: pulumi.ToArray(profileManagementStationNotEqualTo),
//				OsFamily:                     pulumi.StringRef(profileOsFamily),
//				ProfileId:                    pulumi.StringRef(testProfile.Id),
//				ProfileTypes:                 pulumi.ToArray(profileProfileType),
//				ProfileVersion:               pulumi.StringRef(profileProfileVersion),
//				RegistrationTypes:            pulumi.ToArray(profileRegistrationType),
...
func GetProfilesOutput(ctx *pulumi.Context, args GetProfilesOutputArgs, opts ...pulumi.InvokeOption) GetProfilesResultOutput {
	...
	return ctx.InvokeOutput("oci:OsManagementHub/getProfiles:getProfiles", args, GetProfilesResultOutput{}, options).(GetProfilesResultOutput)
}
