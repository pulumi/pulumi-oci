...
// The architecture for which the packages in this module stream were built.
func (o GetSoftwareSourceModuleStreamResultOutput) ArchType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetSoftwareSourceModuleStreamResult) *string { return v.ArchType }).(pulumi.StringPtrOutput)
}
...
// Indicates whether this module stream is the latest.
func (o GetSoftwareSourceModuleStreamResultOutput) IsLatest() pulumi.BoolPtrOutput {
	return o.ApplyT(func(v GetSoftwareSourceModuleStreamResult) *bool { return v.IsLatest }).(pulumi.BoolPtrOutput)
}
...
// The name of the stream.
func (o GetSoftwareSourceModuleStreamResultOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetSoftwareSourceModuleStreamResult) *string { return v.Name }).(pulumi.StringPtrOutput)
}
