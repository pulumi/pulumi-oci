...
// import (
//
//	"github.com/pulumi/pulumi-oci/sdk/v3/go/oci/osuborganizationsubscription"
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//
// )
//
...
func GetOrganizationSubscriptionsOutput(ctx *pulumi.Context, args GetOrganizationSubscriptionsOutputArgs, opts ...pulumi.InvokeOption) GetOrganizationSubscriptionsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetOrganizationSubscriptionsResultOutput, error) {
			...
			return ctx.InvokeOutput("oci:OsubOrganizationSubscription/getOrganizationSubscriptions:getOrganizationSubscriptions", args, GetOrganizationSubscriptionsResultOutput{}, options).(GetOrganizationSubscriptionsResultOutput), nil
