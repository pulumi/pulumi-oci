...
// import (
//
//	"github.com/pulumi/pulumi-oci/sdk/v3/go/oci/osubsubscription"
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//
// )
//
...
func GetRatecardsOutput(ctx *pulumi.Context, args GetRatecardsOutputArgs, opts ...pulumi.InvokeOption) GetRatecardsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetRatecardsResultOutput, error) {
			...
			return ctx.InvokeOutput("oci:OsubSubscription/getRatecards:getRatecards", args, GetRatecardsResultOutput{}, options).(GetRatecardsResultOutput), nil
...
// The provider-assigned unique ID for this managed resource.
func (o GetRatecardsResultOutput) Id() pulumi.StringOutput {
	return o.ApplyT(func(v GetRatecardsResult) string { return v.Id }).(pulumi.StringOutput)
}
