...
func GetSubscriptions(ctx *pulumi.Context, args *GetSubscriptionsArgs, opts ...pulumi.InvokeOption) (*GetSubscriptionsResult, error) {
	...
	err := ctx.Invoke("oci:OsubSubscription/getSubscriptions:getSubscriptions", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetSubscriptionsOutput(ctx *pulumi.Context, args GetSubscriptionsOutputArgs, opts ...pulumi.InvokeOption) GetSubscriptionsResultOutput {
	return pulumi.ToOutputWithContext(ctx.Context(), args).
		ApplyT(func(v interface{}) (GetSubscriptionsResultOutput, error) {
			...
			return ctx.InvokeOutput("oci:OsubSubscription/getSubscriptions:getSubscriptions", args, GetSubscriptionsResultOutput{}, options).(GetSubscriptionsResultOutput), nil
...
func (o GetSubscriptionsResultOutput) XOneGatewaySubscriptionId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetSubscriptionsResult) *string { return v.XOneGatewaySubscriptionId }).(pulumi.StringPtrOutput)
}

func (o GetSubscriptionsResultOutput) XOneOriginRegion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetSubscriptionsResult) *string { return v.XOneOriginRegion }).(pulumi.StringPtrOutput)
}
