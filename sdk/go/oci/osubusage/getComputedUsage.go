...
func GetComputedUsage(ctx *pulumi.Context, args *GetComputedUsageArgs, opts ...pulumi.InvokeOption) (*GetComputedUsageResult, error) {
	...
	err := ctx.Invoke("oci:OsubUsage/getComputedUsage:getComputedUsage", args, &rv, opts...)
	if err != nil {
		return nil, err
	}
	return &rv, nil
...
func GetComputedUsageOutput(ctx *pulumi.Context, args GetComputedUsageOutputArgs, opts ...pulumi.InvokeOption) GetComputedUsageResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (GetComputedUsageResultOutput, error) {
			...
			opts = internal.PkgInvokeDefaultOpts(opts)
			var rv GetComputedUsageResult
			secret, err := ctx.InvokePackageRaw("oci:OsubUsage/getComputedUsage:getComputedUsage", args, &rv, "", opts...)
			if err != nil {
...
func (o GetComputedUsageResultOutput) XOneOriginRegion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetComputedUsageResult) *string { return v.XOneOriginRegion }).(pulumi.StringPtrOutput)
}
