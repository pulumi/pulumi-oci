...
func GetPrivateEndpointsOutput(ctx *pulumi.Context, args GetPrivateEndpointsOutputArgs, opts ...pulumi.InvokeOption) GetPrivateEndpointsResultOutput {
	...
	return ctx.InvokeOutput("oci:ResourceManager/getPrivateEndpoints:getPrivateEndpoints", args, GetPrivateEndpointsResultOutput{}, options).(GetPrivateEndpointsResultOutput)
}
