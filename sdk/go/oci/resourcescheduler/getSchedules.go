...
// import (
//
//	"github.com/pulumi/pulumi-oci/sdk/v5/go/oci/resourcescheduler"
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//
// )
//
...
func GetSchedulesOutput(ctx *pulumi.Context, args GetSchedulesOutputArgs, opts ...pulumi.InvokeOption) GetSchedulesResultOutput {
	...
	return ctx.InvokeOutput("oci:ResourceScheduler/getSchedules:getSchedules", args, GetSchedulesResultOutput{}, options).(GetSchedulesResultOutput)
}
