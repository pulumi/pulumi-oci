...
// The provider-assigned unique ID for this managed resource.
func (o GetPrivateApplicationPackagesResultOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetPrivateApplicationPackagesResult) *string { return v.Id }).(pulumi.StringPtrOutput)
}
