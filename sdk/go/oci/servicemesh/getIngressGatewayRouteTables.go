...
func (o GetIngressGatewayRouteTablesResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetIngressGatewayRouteTablesResult] {
	return pulumix.Output[GetIngressGatewayRouteTablesResult]{
