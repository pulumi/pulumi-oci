...
func (o GetIngressGatewaysResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetIngressGatewaysResult] {
	return pulumix.Output[GetIngressGatewaysResult]{
