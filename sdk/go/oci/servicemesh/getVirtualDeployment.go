...
func LookupVirtualDeploymentOutput(ctx *pulumi.Context, args LookupVirtualDeploymentOutputArgs, opts ...pulumi.InvokeOption) LookupVirtualDeploymentResultOutput {
	return pulumi.ToOutputWithContext(context.Background(), args).
		ApplyT(func(v interface{}) (LookupVirtualDeploymentResult, error) {
			args := v.(LookupVirtualDeploymentArgs)
			r, err := LookupVirtualDeployment(ctx, &args, opts...)
			var s LookupVirtualDeploymentResult
			if r != nil {
				s = *r
			}
			return s, err
...
// Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
func (o LookupVirtualDeploymentResultOutput) DefinedTags() pulumi.MapOutput {
	return o.ApplyT(func(v LookupVirtualDeploymentResult) map[string]interface{} { return v.DefinedTags }).(pulumi.MapOutput)
}
...
// Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
func (o LookupVirtualDeploymentResultOutput) FreeformTags() pulumi.MapOutput {
	return o.ApplyT(func(v LookupVirtualDeploymentResult) map[string]interface{} { return v.FreeformTags }).(pulumi.MapOutput)
}
...
// Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
func (o LookupVirtualDeploymentResultOutput) SystemTags() pulumi.MapOutput {
	return o.ApplyT(func(v LookupVirtualDeploymentResult) map[string]interface{} { return v.SystemTags }).(pulumi.MapOutput)
}
