...
func (o MeshOutput) DefinedTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *Mesh) pulumi.StringMapOutput { return v.DefinedTags }).(pulumi.StringMapOutput)
}
...
func (o MeshOutput) FreeformTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *Mesh) pulumi.StringMapOutput { return v.FreeformTags }).(pulumi.StringMapOutput)
}
...
func (o MeshOutput) SystemTags() pulumi.StringMapOutput {
	return o.ApplyT(func(v *Mesh) pulumi.StringMapOutput { return v.SystemTags }).(pulumi.StringMapOutput)
}
