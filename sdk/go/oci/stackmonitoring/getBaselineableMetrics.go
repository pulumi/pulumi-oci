...
// The provider-assigned unique ID for this managed resource.
func (o GetBaselineableMetricsResultOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetBaselineableMetricsResult) *string { return v.Id }).(pulumi.StringPtrOutput)
}
