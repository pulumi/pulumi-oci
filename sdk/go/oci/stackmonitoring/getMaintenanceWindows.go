...
func GetMaintenanceWindowsOutput(ctx *pulumi.Context, args GetMaintenanceWindowsOutputArgs, opts ...pulumi.InvokeOption) GetMaintenanceWindowsResultOutput {
	...
	return ctx.InvokeOutput("oci:StackMonitoring/getMaintenanceWindows:getMaintenanceWindows", args, GetMaintenanceWindowsResultOutput{}, options).(GetMaintenanceWindowsResultOutput)
}
