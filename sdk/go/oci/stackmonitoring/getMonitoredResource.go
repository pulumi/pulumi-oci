...
func LookupMonitoredResourceOutput(ctx *pulumi.Context, args LookupMonitoredResourceOutputArgs, opts ...pulumi.InvokeOption) LookupMonitoredResourceResultOutput {
	...
	return ctx.InvokeOutput("oci:StackMonitoring/getMonitoredResource:getMonitoredResource", args, LookupMonitoredResourceResultOutput{}, options).(LookupMonitoredResourceResultOutput)
}
