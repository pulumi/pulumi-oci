...
//			_, err := StackMonitoring.NewMetricExtension(ctx, "testMetricExtension", &StackMonitoring.MetricExtensionArgs{
//				CollectionRecurrences: pulumi.Any(_var.Metric_extension_collection_recurrences),
//				CompartmentId:         pulumi.Any(_var.Compartment_id),
//				DisplayName:           pulumi.Any(_var.Metric_extension_display_name),
//				MetricLists: stackmonitoring.MetricExtensionMetricListArray{
//					&stackmonitoring.MetricExtensionMetricListArgs{
//						DataType:          pulumi.Any(_var.Metric_extension_metric_list_data_type),
//						Name:              pulumi.Any(_var.Metric_extension_metric_list_name),
//						ComputeExpression: pulumi.Any(_var.Metric_extension_metric_list_compute_expression),
//						DisplayName:       pulumi.Any(_var.Metric_extension_metric_list_display_name),
//						IsDimension:       pulumi.Any(_var.Metric_extension_metric_list_is_dimension),
//						IsHidden:          pulumi.Any(_var.Metric_extension_metric_list_is_hidden),
//						MetricCategory:    pulumi.Any(_var.Metric_extension_metric_list_metric_category),
//						Unit:              pulumi.Any(_var.Metric_extension_metric_list_unit),
//					},
//				},
//				QueryProperties: &stackmonitoring.MetricExtensionQueryPropertiesArgs{
//					CollectionMethod: pulumi.Any(_var.Metric_extension_query_properties_collection_method),
//					Arguments:        pulumi.Any(_var.Metric_extension_query_properties_arguments),
//					AutoRowPrefix:    pulumi.Any(_var.Metric_extension_query_properties_auto_row_prefix),
//					Command:          pulumi.Any(_var.Metric_extension_query_properties_command),
//					Delimiter:        pulumi.Any(_var.Metric_extension_query_properties_delimiter),
//					IdentityMetric:   pulumi.Any(_var.Metric_extension_query_properties_identity_metric),
...
//							InParamPosition: pulumi.Any(_var.Metric_extension_query_properties_in_param_details_in_param_position),
//							InParamValue:    pulumi.Any(_var.Metric_extension_query_properties_in_param_details_in_param_value),
//						},
//					},
//					IsMetricServiceEnabled: pulumi.Any(_var.Metric_extension_query_properties_is_metric_service_enabled),
//					JmxAttributes:          pulumi.Any(_var.Metric_extension_query_properties_jmx_attributes),
//					ManagedBeanQuery:       pulumi.Any(_var.Metric_extension_query_properties_managed_bean_query),
//					OutParamDetails: &stackmonitoring.MetricExtensionQueryPropertiesOutParamDetailsArgs{
//						OutParamPosition: pulumi.Any(_var.Metric_extension_query_properties_out_param_details_out_param_position),
//						OutParamType:     pulumi.Any(_var.Metric_extension_query_properties_out_param_details_out_param_type),
//					},
//					ScriptDetails: &stackmonitoring.MetricExtensionQueryPropertiesScriptDetailsArgs{
//						Content: pulumi.Any(_var.Metric_extension_query_properties_script_details_content),
//						Name:    pulumi.Any(_var.Metric_extension_query_properties_script_details_name),
//					},
//					SqlDetails: &stackmonitoring.MetricExtensionQueryPropertiesSqlDetailsArgs{
//						Content:        pulumi.Any(_var.Metric_extension_query_properties_sql_details_content),
//						ScriptFileName: pulumi.Any(_var.Metric_extension_query_properties_sql_details_script_file_name),
//					},
//					SqlType:    pulumi.Any(_var.Metric_extension_query_properties_sql_type),
//					StartsWith: pulumi.Any(_var.Metric_extension_query_properties_starts_with),
//				},
//				ResourceType: pulumi.Any(_var.Metric_extension_resource_type),
//				Description:  pulumi.Any(_var.Metric_extension_description),
//			})
//			if err != nil {
//				return err
//			}
