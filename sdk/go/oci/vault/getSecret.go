...
// The OCID of the compartment where you want to create the secret.
func (o LookupSecretResultOutput) CompartmentId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSecretResult) *string { return v.CompartmentId }).(pulumi.StringPtrOutput)
}

// The version number of the secret version that's currently in use.
func (o LookupSecretResultOutput) CurrentVersionNumber() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSecretResult) *string { return v.CurrentVersionNumber }).(pulumi.StringPtrOutput)
}
...
// The OCID of the master encryption key that is used to encrypt the secret.
func (o LookupSecretResultOutput) KeyId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSecretResult) *string { return v.KeyId }).(pulumi.StringPtrOutput)
}

// Additional information about the current lifecycle state of the secret.
func (o LookupSecretResultOutput) LifecycleDetails() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSecretResult) *string { return v.LifecycleDetails }).(pulumi.StringPtrOutput)
}
...
// The user-friendly name of the secret. Avoid entering confidential information.
func (o LookupSecretResultOutput) SecretName() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSecretResult) *string { return v.SecretName }).(pulumi.StringPtrOutput)
}
...
// The current lifecycle state of the secret.
func (o LookupSecretResultOutput) State() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSecretResult) *string { return v.State }).(pulumi.StringPtrOutput)
}

// A property indicating when the secret was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
func (o LookupSecretResultOutput) TimeCreated() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSecretResult) *string { return v.TimeCreated }).(pulumi.StringPtrOutput)
}

// An optional property indicating when the current secret version will expire, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
func (o LookupSecretResultOutput) TimeOfCurrentVersionExpiry() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSecretResult) *string { return v.TimeOfCurrentVersionExpiry }).(pulumi.StringPtrOutput)
}

// An optional property indicating when to delete the secret, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
func (o LookupSecretResultOutput) TimeOfDeletion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSecretResult) *string { return v.TimeOfDeletion }).(pulumi.StringPtrOutput)
}

// The OCID of the Vault in which the secret exists
func (o LookupSecretResultOutput) VaultId() pulumi.StringPtrOutput {
	return o.ApplyT(func(v LookupSecretResult) *string { return v.VaultId }).(pulumi.StringPtrOutput)
}
