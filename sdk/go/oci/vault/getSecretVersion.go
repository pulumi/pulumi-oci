...
// The content type of the secret version's secret contents.
func (o GetSecretVersionResultOutput) ContentType() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetSecretVersionResult) *string { return v.ContentType }).(pulumi.StringPtrOutput)
}

// The provider-assigned unique ID for this managed resource.
func (o GetSecretVersionResultOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetSecretVersionResult) *string { return v.Id }).(pulumi.StringPtrOutput)
}

// The name of the secret version. A name is unique across versions of a secret.
func (o GetSecretVersionResultOutput) Name() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetSecretVersionResult) *string { return v.Name }).(pulumi.StringPtrOutput)
}
...
// A optional property indicating when the secret version was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
func (o GetSecretVersionResultOutput) TimeCreated() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetSecretVersionResult) *string { return v.TimeCreated }).(pulumi.StringPtrOutput)
}

// An optional property indicating when the current secret version will expire, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
func (o GetSecretVersionResultOutput) TimeOfCurrentVersionExpiry() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetSecretVersionResult) *string { return v.TimeOfCurrentVersionExpiry }).(pulumi.StringPtrOutput)
}

// An optional property indicating when to delete the secret version, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
func (o GetSecretVersionResultOutput) TimeOfDeletion() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetSecretVersionResult) *string { return v.TimeOfDeletion }).(pulumi.StringPtrOutput)
}

// The version number of the secret.
func (o GetSecretVersionResultOutput) VersionNumber() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetSecretVersionResult) *string { return v.VersionNumber }).(pulumi.StringPtrOutput)
}
