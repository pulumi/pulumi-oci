...
// The provider-assigned unique ID for this managed resource.
func (o GetCustomProtectionRulesResultOutput) Id() pulumi.StringPtrOutput {
	return o.ApplyT(func(v GetCustomProtectionRulesResult) *string { return v.Id }).(pulumi.StringPtrOutput)
}
