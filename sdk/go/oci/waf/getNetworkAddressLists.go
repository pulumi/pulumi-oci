...
func (o GetNetworkAddressListsResultOutput) ToOutput(ctx context.Context) pulumix.Output[GetNetworkAddressListsResult] {
	return pulumix.Output[GetNetworkAddressListsResult]{
