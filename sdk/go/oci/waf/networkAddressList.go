...
// import (
//
//	"github.com/pulumi/pulumi-oci/sdk/v5/go/oci/waf"
//	"github.com/pulumi/pulumi/sdk/v3/go/pulumi"
//
// )
//
...
func (o NetworkAddressListOutput) CompartmentId() pulumi.StringOutput {
	return o.ApplyT(func(v *NetworkAddressList) pulumi.StringOutput { return v.CompartmentId }).(pulumi.StringOutput)
}
...
func (o NetworkAddressListOutput) Type() pulumi.StringOutput {
	return o.ApplyT(func(v *NetworkAddressList) pulumi.StringOutput { return v.Type }).(pulumi.StringOutput)
}

// (Updatable) A list of private address prefixes, each associated with a particular VCN. To specify all addresses in a VCN, use "0.0.0.0/0" for IPv4 and "::/0" for IPv6.
func (o NetworkAddressListOutput) VcnAddresses() NetworkAddressListVcnAddressArrayOutput {
	return o.ApplyT(func(v *NetworkAddressList) NetworkAddressListVcnAddressArrayOutput { return v.VcnAddresses }).(NetworkAddressListVcnAddressArrayOutput)
}
