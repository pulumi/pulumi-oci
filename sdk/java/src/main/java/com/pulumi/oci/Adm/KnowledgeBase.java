...
import com.pulumi.oci.Adm.inputs.KnowledgeBaseState;
 ...
 * 
 */
@ResourceType(type="oci:Adm/knowledgeBase:KnowledgeBase")
public class KnowledgeBase extends com.pulumi.resources.CustomResource {
    ...
    public KnowledgeBase(String name, KnowledgeBaseArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Adm/knowledgeBase:KnowledgeBase", name, args == null ? KnowledgeBaseArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
