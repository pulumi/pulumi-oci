...
public class RemediationRun extends com.pulumi.resources.CustomResource {
     ...
     */
    public RemediationRun(java.lang.String name) {
     ...
     */
    public RemediationRun(java.lang.String name, RemediationRunArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public RemediationRun(java.lang.String name, RemediationRunArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Adm/remediationRun:RemediationRun", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private RemediationRun(java.lang.String name, Output<java.lang.String> id, @Nullable RemediationRunState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Adm/remediationRun:RemediationRun", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static RemediationRun get(java.lang.String name, Output<java.lang.String> id, @Nullable RemediationRunState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
