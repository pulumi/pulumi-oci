...
import com.pulumi.oci.Adm.inputs.GetRemediationRecipesFilterArgs;
...
public final class GetRemediationRecipesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetRemediationRecipesArgs Empty = new GetRemediationRecipesArgs();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetRemediationRecipesFilterArgs>> filters;

    public Optional<Output<List<GetRemediationRecipesFilterArgs>>> filters() {
    ...
    private GetRemediationRecipesArgs() {}

    private GetRemediationRecipesArgs(GetRemediationRecipesArgs $) {
    ...
    public static Builder builder(GetRemediationRecipesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetRemediationRecipesArgs();
        }

        public Builder(GetRemediationRecipesArgs defaults) {
            $ = new GetRemediationRecipesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetRemediationRecipesFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetRemediationRecipesFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetRemediationRecipesFilterArgs... filters) {
        ...
        public GetRemediationRecipesArgs build() {
            return $;
        }
    }
