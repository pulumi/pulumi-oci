...
public final class GetKnowledgebasesKnowledgeBaseCollection {
    private @Nullable List<GetKnowledgebasesKnowledgeBaseCollectionItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetKnowledgebasesKnowledgeBaseCollectionItem> items) {
            this.items = items;
            return this;
        }
