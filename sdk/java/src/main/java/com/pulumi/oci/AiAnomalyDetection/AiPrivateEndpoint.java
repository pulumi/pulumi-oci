...
public class AiPrivateEndpoint extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ List<String>> attachedDataAssets;

    /**
     * @return The list of dataAssets using the private reverse connection endpoint.
     * 
     */
    public Output<Optional<List<String>>> attachedDataAssets() {
        return Codegen.optional(this.attachedDataAssets);
    }
    /**
