...
public class Model extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="modelTrainingDetails", refs={ModelModelTrainingDetails.class}, tree="[0]")
     ...
     * 
     */
    @Export(name="modelTrainingResults", refs={List.class,ModelModelTrainingResult.class}, tree="[0,1]")
    ...
    public Model(java.lang.String name, ModelArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:AiAnomalyDetection/model:Model", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Model(java.lang.String name, Output<java.lang.String> id, @Nullable ModelState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:AiAnomalyDetection/model:Model", name, state, makeResourceOptions(options, id), false);
    }
