...
public class Model extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ List<ModelModelTrainingResult>> modelTrainingResults;

    /**
     * @return Specifies the details for an Anomaly Detection model trained with MSET.
     * 
     */
    public Output<Optional<List<ModelModelTrainingResult>>> modelTrainingResults() {
        return Codegen.optional(this.modelTrainingResults);
    }
    /**
