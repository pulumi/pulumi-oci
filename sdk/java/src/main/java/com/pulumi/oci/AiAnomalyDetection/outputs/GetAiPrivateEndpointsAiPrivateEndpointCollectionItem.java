...
public final class GetAiPrivateEndpointsAiPrivateEndpointCollectionItem {
     ...
     * 
     */
    private @Nullable List<String> attachedDataAssets;
    /**
    ...
    public List<String> attachedDataAssets() {
        return this.attachedDataAssets == null ? List.of() : this.attachedDataAssets;
    }
    /**
     * @return The ID of the compartment in which to list resources.
     * 
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder attachedDataAssets(@Nullable List<String> attachedDataAssets) {
