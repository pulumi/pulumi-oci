...
public final class GetDetectionDataAssetDataSourceDetailVersionSpecificDetail {
    ...
    public static final class Builder {
        ...
        public Builder bucket(String bucket) {
            if (bucket == null) {
              throw new MissingRequiredPropertyException("GetDetectionDataAssetDataSourceDetailVersionSpecificDetail", "bucket");
            }
            this.bucket = bucket;
            return this;
        }
        ...
        public Builder databaseName(String databaseName) {
            if (databaseName == null) {
              throw new MissingRequiredPropertyException("GetDetectionDataAssetDataSourceDetailVersionSpecificDetail", "databaseName");
            }
        ...
        public Builder influxVersion(String influxVersion) {
            if (influxVersion == null) {
              throw new MissingRequiredPropertyException("GetDetectionDataAssetDataSourceDetailVersionSpecificDetail", "influxVersion");
            }
        ...
        public Builder organizationName(String organizationName) {
            if (organizationName == null) {
              throw new MissingRequiredPropertyException("GetDetectionDataAssetDataSourceDetailVersionSpecificDetail", "organizationName");
            }
        ...
        public Builder retentionPolicyName(String retentionPolicyName) {
            if (retentionPolicyName == null) {
              throw new MissingRequiredPropertyException("GetDetectionDataAssetDataSourceDetailVersionSpecificDetail", "retentionPolicyName");
            }
