    ...
    public static final class Builder {
        ...
        public Builder algorithmHint(String algorithmHint) {
            if (algorithmHint == null) {
              throw new MissingRequiredPropertyException("GetDetectionModelsModelCollectionItemModelTrainingDetail", "algorithmHint");
            }
        ...
        public Builder dataAssetIds(List<String> dataAssetIds) {
            if (dataAssetIds == null) {
              throw new MissingRequiredPropertyException("GetDetectionModelsModelCollectionItemModelTrainingDetail", "dataAssetIds");
            }
        ...
        public Builder targetFap(Double targetFap) {
            if (targetFap == null) {
              throw new MissingRequiredPropertyException("GetDetectionModelsModelCollectionItemModelTrainingDetail", "targetFap");
            }
        ...
        public Builder trainingFraction(Double trainingFraction) {
            if (trainingFraction == null) {
              throw new MissingRequiredPropertyException("GetDetectionModelsModelCollectionItemModelTrainingDetail", "trainingFraction");
            }
        ...
        public Builder windowSize(Integer windowSize) {
            if (windowSize == null) {
              throw new MissingRequiredPropertyException("GetDetectionModelsModelCollectionItemModelTrainingDetail", "windowSize");
            }
