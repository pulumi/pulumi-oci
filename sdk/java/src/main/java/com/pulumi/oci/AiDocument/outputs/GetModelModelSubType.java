...
@CustomType
public final class GetModelModelSubType {
    /**
    ...
    public static Builder builder(GetModelModelSubType defaults) {
    ...
    public static final class Builder {
        ...
        private String modelType;
        public Builder() {}
        public Builder(GetModelModelSubType defaults) {
        ...
        public Builder modelSubType(String modelSubType) {
            if (modelSubType == null) {
              throw new MissingRequiredPropertyException("GetModelModelSubType", "modelSubType");
            }
        ...
        public Builder modelType(String modelType) {
            if (modelType == null) {
              throw new MissingRequiredPropertyException("GetModelModelSubType", "modelType");
            }
            this.modelType = modelType;
            return this;
        }
        public GetModelModelSubType build() {
            final var _resultValue = new GetModelModelSubType();
