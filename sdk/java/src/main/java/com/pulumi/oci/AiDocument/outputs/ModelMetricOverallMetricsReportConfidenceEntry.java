...
@CustomType
public final class ModelMetricOverallMetricsReportConfidenceEntry {
    /**
    ...
    public static Builder builder(ModelMetricOverallMetricsReportConfidenceEntry defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double threshold;
        public Builder() {}
        public Builder(ModelMetricOverallMetricsReportConfidenceEntry defaults) {
        ...
        public ModelMetricOverallMetricsReportConfidenceEntry build() {
            final var _resultValue = new ModelMetricOverallMetricsReportConfidenceEntry();
