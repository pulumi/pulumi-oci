...
@CustomType
public final class ModelTestingDataset {
    /**
    ...
    public static final class Builder {
        ...
        public Builder datasetType(String datasetType) {
            if (datasetType == null) {
              throw new MissingRequiredPropertyException("ModelTestingDataset", "datasetType");
            }
        ...
        public ModelTestingDataset build() {
            final var _resultValue = new ModelTestingDataset();
