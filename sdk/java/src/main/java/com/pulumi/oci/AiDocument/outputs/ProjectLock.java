...
public final class ProjectLock {
    ...
    public static Builder builder(ProjectLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(ProjectLock defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("ProjectLock", "type");
            }
            this.type = type;
            return this;
        }
        public ProjectLock build() {
            final var _resultValue = new ProjectLock();
