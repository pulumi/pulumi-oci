...
public final class ModelTrainingDatasetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<ModelTrainingDatasetLocationDetailsArgs> locationDetails;

    /**
     * @return Possible object storage location types
     * 
     */
    public Optional<Output<ModelTrainingDatasetLocationDetailsArgs>> locationDetails() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder locationDetails(@Nullable Output<ModelTrainingDatasetLocationDetailsArgs> locationDetails) {
         ...
         * 
         */
        public Builder locationDetails(ModelTrainingDatasetLocationDetailsArgs locationDetails) {
