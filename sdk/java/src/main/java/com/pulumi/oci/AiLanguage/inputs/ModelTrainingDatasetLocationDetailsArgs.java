...
public final class ModelTrainingDatasetLocationDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ModelTrainingDatasetLocationDetailsArgs Empty = new ModelTrainingDatasetLocationDetailsArgs();
    ...
    private ModelTrainingDatasetLocationDetailsArgs() {}

    private ModelTrainingDatasetLocationDetailsArgs(ModelTrainingDatasetLocationDetailsArgs $) {
        this.bucket = $.bucket;
    ...
    public static Builder builder(ModelTrainingDatasetLocationDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ModelTrainingDatasetLocationDetailsArgs();
        }

        public Builder(ModelTrainingDatasetLocationDetailsArgs defaults) {
            $ = new ModelTrainingDatasetLocationDetailsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ModelTrainingDatasetLocationDetailsArgs build() {
            if ($.bucket == null) {
                throw new MissingRequiredPropertyException("ModelTrainingDatasetLocationDetailsArgs", "bucket");
            }
            if ($.locationType == null) {
                throw new MissingRequiredPropertyException("ModelTrainingDatasetLocationDetailsArgs", "locationType");
            }
            if ($.namespace == null) {
                throw new MissingRequiredPropertyException("ModelTrainingDatasetLocationDetailsArgs", "namespace");
            }
            if ($.objectNames == null) {
                throw new MissingRequiredPropertyException("ModelTrainingDatasetLocationDetailsArgs", "objectNames");
            }
            return $;
        }
    }
