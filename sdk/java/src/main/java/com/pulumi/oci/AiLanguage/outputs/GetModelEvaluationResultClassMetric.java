...
@CustomType
public final class GetModelEvaluationResultClassMetric {
    /**
    ...
    private GetModelEvaluationResultClassMetric() {}
    /**
     * @return F1-score, is a measure of a model’s accuracy on a dataset
     * 
     */
    ...
    public static Builder builder(GetModelEvaluationResultClassMetric defaults) {
    ...
    public static final class Builder {
        ...
        private Double support;
        public Builder() {}
        public Builder(GetModelEvaluationResultClassMetric defaults) {
        ...
        public Builder f1(Double f1) {
            if (f1 == null) {
              throw new MissingRequiredPropertyException("GetModelEvaluationResultClassMetric", "f1");
            }
            this.f1 = f1;
            return this;
        }
        ...
        public Builder label(String label) {
            if (label == null) {
              throw new MissingRequiredPropertyException("GetModelEvaluationResultClassMetric", "label");
            }
            this.label = label;
            return this;
        }
        ...
        public Builder precision(Double precision) {
            if (precision == null) {
              throw new MissingRequiredPropertyException("GetModelEvaluationResultClassMetric", "precision");
            }
        ...
        public Builder recall(Double recall) {
            if (recall == null) {
              throw new MissingRequiredPropertyException("GetModelEvaluationResultClassMetric", "recall");
            }
            this.recall = recall;
            return this;
        }
        ...
        public Builder support(Double support) {
            if (support == null) {
              throw new MissingRequiredPropertyException("GetModelEvaluationResultClassMetric", "support");
            }
            this.support = support;
            return this;
        }
        public GetModelEvaluationResultClassMetric build() {
            final var _resultValue = new GetModelEvaluationResultClassMetric();
            _resultValue.f1 = f1;
