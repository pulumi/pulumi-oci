...
@CustomType
public final class GetModelEvaluationResultMetric {
    /**
    ...
    private GetModelEvaluationResultMetric() {}
    /**
     * @return The fraction of the labels that were correctly recognised .
     * 
     */
    ...
    public static Builder builder(GetModelEvaluationResultMetric defaults) {
    ...
    public static final class Builder {
        ...
        private Double weightedRecall;
        public Builder() {}
        public Builder(GetModelEvaluationResultMetric defaults) {
        ...
        public Builder accuracy(Double accuracy) {
            if (accuracy == null) {
              throw new MissingRequiredPropertyException("GetModelEvaluationResultMetric", "accuracy");
            }
        ...
        public Builder macroF1(Double macroF1) {
            if (macroF1 == null) {
              throw new MissingRequiredPropertyException("GetModelEvaluationResultMetric", "macroF1");
            }
        ...
        public Builder macroPrecision(Double macroPrecision) {
            if (macroPrecision == null) {
              throw new MissingRequiredPropertyException("GetModelEvaluationResultMetric", "macroPrecision");
            }
        ...
        public Builder macroRecall(Double macroRecall) {
            if (macroRecall == null) {
              throw new MissingRequiredPropertyException("GetModelEvaluationResultMetric", "macroRecall");
            }
        ...
        public Builder microF1(Double microF1) {
            if (microF1 == null) {
              throw new MissingRequiredPropertyException("GetModelEvaluationResultMetric", "microF1");
            }
        ...
        public Builder microPrecision(Double microPrecision) {
            if (microPrecision == null) {
              throw new MissingRequiredPropertyException("GetModelEvaluationResultMetric", "microPrecision");
            }
        ...
        public Builder microRecall(Double microRecall) {
            if (microRecall == null) {
              throw new MissingRequiredPropertyException("GetModelEvaluationResultMetric", "microRecall");
            }
        ...
        public Builder weightedF1(Double weightedF1) {
            if (weightedF1 == null) {
              throw new MissingRequiredPropertyException("GetModelEvaluationResultMetric", "weightedF1");
            }
        ...
        public Builder weightedPrecision(Double weightedPrecision) {
            if (weightedPrecision == null) {
              throw new MissingRequiredPropertyException("GetModelEvaluationResultMetric", "weightedPrecision");
            }
        ...
        public Builder weightedRecall(Double weightedRecall) {
            if (weightedRecall == null) {
              throw new MissingRequiredPropertyException("GetModelEvaluationResultMetric", "weightedRecall");
            }
