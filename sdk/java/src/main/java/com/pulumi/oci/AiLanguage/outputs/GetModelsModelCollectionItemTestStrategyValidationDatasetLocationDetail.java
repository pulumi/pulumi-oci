...
public final class GetModelsModelCollectionItemTestStrategyValidationDatasetLocationDetail {
    ...
    public static final class Builder {
        ...
        public Builder bucket(String bucket) {
            if (bucket == null) {
              throw new MissingRequiredPropertyException("GetModelsModelCollectionItemTestStrategyValidationDatasetLocationDetail", "bucket");
            }
            this.bucket = bucket;
            return this;
        }
        ...
        public Builder locationType(String locationType) {
            if (locationType == null) {
              throw new MissingRequiredPropertyException("GetModelsModelCollectionItemTestStrategyValidationDatasetLocationDetail", "locationType");
            }
        ...
        public Builder namespace(String namespace) {
            if (namespace == null) {
              throw new MissingRequiredPropertyException("GetModelsModelCollectionItemTestStrategyValidationDatasetLocationDetail", "namespace");
            }
        ...
        public Builder objectNames(List<String> objectNames) {
            if (objectNames == null) {
              throw new MissingRequiredPropertyException("GetModelsModelCollectionItemTestStrategyValidationDatasetLocationDetail", "objectNames");
            }
        ...
        public GetModelsModelCollectionItemTestStrategyValidationDatasetLocationDetail build() {
            final var _resultValue = new GetModelsModelCollectionItemTestStrategyValidationDatasetLocationDetail();
