...
@CustomType
public final class ModelEvaluationResultClassMetric {
    /**
    ...
    private ModelEvaluationResultClassMetric() {}
    /**
     * @return F1-score, is a measure of a model’s accuracy on a dataset
     * 
     */
    ...
    public static Builder builder(ModelEvaluationResultClassMetric defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double support;
        public Builder() {}
        public Builder(ModelEvaluationResultClassMetric defaults) {
