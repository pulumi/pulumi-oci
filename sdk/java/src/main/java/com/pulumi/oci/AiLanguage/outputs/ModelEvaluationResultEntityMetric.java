...
@CustomType
public final class ModelEvaluationResultEntityMetric {
    /**
    ...
    private ModelEvaluationResultEntityMetric() {}
    /**
     * @return F1-score, is a measure of a model’s accuracy on a dataset
     * 
     */
    ...
    public static Builder builder(ModelEvaluationResultEntityMetric defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double recall;
        public Builder() {}
        public Builder(ModelEvaluationResultEntityMetric defaults) {
