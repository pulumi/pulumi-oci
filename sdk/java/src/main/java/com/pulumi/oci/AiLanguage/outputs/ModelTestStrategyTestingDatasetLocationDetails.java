...
@CustomType
public final class ModelTestStrategyTestingDatasetLocationDetails {
    /**
    ...
    public static Builder builder(ModelTestStrategyTestingDatasetLocationDetails defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> objectNames;
        public Builder() {}
        public Builder(ModelTestStrategyTestingDatasetLocationDetails defaults) {
        ...
        public Builder bucket(String bucket) {
            if (bucket == null) {
              throw new MissingRequiredPropertyException("ModelTestStrategyTestingDatasetLocationDetails", "bucket");
            }
            this.bucket = bucket;
            return this;
        }
        ...
        public Builder locationType(String locationType) {
            if (locationType == null) {
              throw new MissingRequiredPropertyException("ModelTestStrategyTestingDatasetLocationDetails", "locationType");
            }
        ...
        public Builder namespace(String namespace) {
            if (namespace == null) {
              throw new MissingRequiredPropertyException("ModelTestStrategyTestingDatasetLocationDetails", "namespace");
            }
        ...
        public Builder objectNames(List<String> objectNames) {
            if (objectNames == null) {
              throw new MissingRequiredPropertyException("ModelTestStrategyTestingDatasetLocationDetails", "objectNames");
            }
