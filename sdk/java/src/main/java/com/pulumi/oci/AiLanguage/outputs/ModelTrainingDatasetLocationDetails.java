...
@CustomType
public final class ModelTrainingDatasetLocationDetails {
    /**
    ...
    private ModelTrainingDatasetLocationDetails() {}
    /**
     * @return Object storage bucket name
     * 
     */
    ...
    public static Builder builder(ModelTrainingDatasetLocationDetails defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> objectNames;
        public Builder() {}
        public Builder(ModelTrainingDatasetLocationDetails defaults) {
