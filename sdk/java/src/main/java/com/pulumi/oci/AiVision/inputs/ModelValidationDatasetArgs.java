...
public final class ModelValidationDatasetArgs extends com.pulumi.resources.ResourceArgs {

    public static final ModelValidationDatasetArgs Empty = new ModelValidationDatasetArgs();
    ...
    private ModelValidationDatasetArgs() {}

    private ModelValidationDatasetArgs(ModelValidationDatasetArgs $) {
        this.bucket = $.bucket;
    ...
    public static Builder builder(ModelValidationDatasetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ModelValidationDatasetArgs();
        }

        public Builder(ModelValidationDatasetArgs defaults) {
            $ = new ModelValidationDatasetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ModelValidationDatasetArgs build() {
            if ($.datasetType == null) {
                throw new MissingRequiredPropertyException("ModelValidationDatasetArgs", "datasetType");
            }
            return $;
        }
    }
