...
@CustomType
public final class GetStreamJobFeatureTrackingType {
    /**
    ...
    private GetStreamJobFeatureTrackingType() {}
    /**
     * @return compartment Id of biometric compartment.
     * 
     */
    ...
    public static Builder builder(GetStreamJobFeatureTrackingType defaults) {
    ...
    public static final class Builder {
        ...
        private String trackingModelId;
        public Builder() {}
        public Builder(GetStreamJobFeatureTrackingType defaults) {
        ...
        public Builder biometricStoreCompartmentId(String biometricStoreCompartmentId) {
            if (biometricStoreCompartmentId == null) {
              throw new MissingRequiredPropertyException("GetStreamJobFeatureTrackingType", "biometricStoreCompartmentId");
            }
        ...
        public Builder biometricStoreId(String biometricStoreId) {
            if (biometricStoreId == null) {
              throw new MissingRequiredPropertyException("GetStreamJobFeatureTrackingType", "biometricStoreId");
            }
        ...
        public Builder detectionModelId(String detectionModelId) {
            if (detectionModelId == null) {
              throw new MissingRequiredPropertyException("GetStreamJobFeatureTrackingType", "detectionModelId");
            }
        ...
        public Builder maxResults(Integer maxResults) {
            if (maxResults == null) {
              throw new MissingRequiredPropertyException("GetStreamJobFeatureTrackingType", "maxResults");
            }
        ...
        public Builder objects(List<String> objects) {
            if (objects == null) {
              throw new MissingRequiredPropertyException("GetStreamJobFeatureTrackingType", "objects");
            }
        ...
        public Builder shouldReturnLandmarks(Boolean shouldReturnLandmarks) {
            if (shouldReturnLandmarks == null) {
              throw new MissingRequiredPropertyException("GetStreamJobFeatureTrackingType", "shouldReturnLandmarks");
            }
        ...
        public Builder trackingModelId(String trackingModelId) {
            if (trackingModelId == null) {
              throw new MissingRequiredPropertyException("GetStreamJobFeatureTrackingType", "trackingModelId");
            }
            this.trackingModelId = trackingModelId;
            return this;
        }
        public GetStreamJobFeatureTrackingType build() {
            final var _resultValue = new GetStreamJobFeatureTrackingType();
