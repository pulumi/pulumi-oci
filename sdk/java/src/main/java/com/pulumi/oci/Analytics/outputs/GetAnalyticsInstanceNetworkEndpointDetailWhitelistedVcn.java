...
public final class GetAnalyticsInstanceNetworkEndpointDetailWhitelistedVcn {
    ...
    public static final class Builder {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetAnalyticsInstanceNetworkEndpointDetailWhitelistedVcn", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder whitelistedIps(List<String> whitelistedIps) {
            if (whitelistedIps == null) {
              throw new MissingRequiredPropertyException("GetAnalyticsInstanceNetworkEndpointDetailWhitelistedVcn", "whitelistedIps");
            }
        ...
        public GetAnalyticsInstanceNetworkEndpointDetailWhitelistedVcn build() {
            final var _resultValue = new GetAnalyticsInstanceNetworkEndpointDetailWhitelistedVcn();
            _resultValue.id = id;
