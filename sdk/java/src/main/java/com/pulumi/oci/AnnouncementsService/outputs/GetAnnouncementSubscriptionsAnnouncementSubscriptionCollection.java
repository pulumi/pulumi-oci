...
public final class GetAnnouncementSubscriptionsAnnouncementSubscriptionCollection {
    private @Nullable List<GetAnnouncementSubscriptionsAnnouncementSubscriptionCollectionItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetAnnouncementSubscriptionsAnnouncementSubscriptionCollectionItem> items) {
            this.items = items;
            return this;
        }
