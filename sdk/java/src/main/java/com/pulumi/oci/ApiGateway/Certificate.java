...
public class Certificate extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ String> intermediateCertificates;

    /**
     * @return The intermediate certificate data associated with the certificate in pem format.
     * 
     */
    public Output<Optional<String>> intermediateCertificates() {
        return Codegen.optional(this.intermediateCertificates);
    }
    /**
    ...
    private Output</* @Nullable */ List<String>> subjectNames;

    /**
     * @return The entity to be secured by the certificate and additional host names.
     * 
     */
    public Output<Optional<List<String>>> subjectNames() {
