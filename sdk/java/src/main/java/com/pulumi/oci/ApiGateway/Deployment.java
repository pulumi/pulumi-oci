 ...
 *                             .loginPath(deploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicyLoginPath)
 ...
 *                                     .loginPath(deploymentSpecificationRequestPoliciesDynamicAuthenticationAuthenticationServersAuthenticationServerDetailValidationFailurePolicyLoginPath)
...
public class Deployment extends com.pulumi.resources.CustomResource {
    ...
    public Deployment(java.lang.String name, DeploymentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:ApiGateway/deployment:Deployment", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Deployment(java.lang.String name, Output<java.lang.String> id, @Nullable DeploymentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:ApiGateway/deployment:Deployment", name, state, makeResourceOptions(options, id), false);
    }
