...
public class Subscriber extends com.pulumi.resources.CustomResource {
     ...
     */
    public Subscriber(java.lang.String name, SubscriberArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Subscriber(java.lang.String name, SubscriberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:ApiGateway/subscriber:Subscriber", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Subscriber(java.lang.String name, Output<java.lang.String> id, @Nullable SubscriberState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:ApiGateway/subscriber:Subscriber", name, state, makeResourceOptions(options, id), false);
    }

    private static SubscriberArgs makeArgs(SubscriberArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
