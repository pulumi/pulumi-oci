...
public final class ApiLockArgs extends com.pulumi.resources.ResourceArgs {

    public static final ApiLockArgs Empty = new ApiLockArgs();
    ...
    private ApiLockArgs(ApiLockArgs $) {
    ...
    public static Builder builder(ApiLockArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ApiLockArgs defaults) {
            $ = new ApiLockArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ApiLockArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ApiLockArgs", "type");
            }
            return $;
        }
    }
