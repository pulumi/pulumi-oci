...
public final class DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicyArgs Empty = new DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicyArgs();
    ...
    private @Nullable Output<DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicyClientDetailsArgs> clientDetails;

    /**
     * @return (Updatable) Client App Credential details.
     * 
     */
    public Optional<Output<DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicyClientDetailsArgs>> clientDetails() {
    ...
    private @Nullable Output<DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicyResponseHeaderTransformationsArgs> responseHeaderTransformations;

    /**
     * @return (Updatable) A set of transformations to apply to HTTP headers that pass through the gateway.
     * 
     */
    public Optional<Output<DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicyResponseHeaderTransformationsArgs>> responseHeaderTransformations() {
    ...
    private @Nullable Output<DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicySourceUriDetailsArgs> sourceUriDetails;

    /**
     * @return (Updatable) Auth endpoint details.
     * 
     */
    public Optional<Output<DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicySourceUriDetailsArgs>> sourceUriDetails() {
    ...
    private DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicyArgs() {}

    private DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicyArgs(DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicyArgs $) {
    ...
    public static Builder builder(DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicyArgs();
        }

        public Builder(DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicyArgs defaults) {
            $ = new DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicyArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder clientDetails(@Nullable Output<DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicyClientDetailsArgs> clientDetails) {
         ...
         * 
         */
        public Builder clientDetails(DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicyClientDetailsArgs clientDetails) {
         ...
         * 
         */
        public Builder responseHeaderTransformations(@Nullable Output<DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicyResponseHeaderTransformationsArgs> responseHeaderTransformations) {
         ...
         * 
         */
        public Builder responseHeaderTransformations(DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicyResponseHeaderTransformationsArgs responseHeaderTransformations) {
         ...
         * 
         */
        public Builder sourceUriDetails(@Nullable Output<DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicySourceUriDetailsArgs> sourceUriDetails) {
         ...
         * 
         */
        public Builder sourceUriDetails(DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicySourceUriDetailsArgs sourceUriDetails) {
            return sourceUriDetails(Output.of(sourceUriDetails));
        }

        /**
         * @param type (Updatable) Type of the Validation failure Policy.
         * 
         * @return builder
         * 
         */
        ...
        public DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicyArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("DeploymentSpecificationRequestPoliciesAuthenticationValidationFailurePolicyArgs", "type");
            }
            return $;
        }
    }
