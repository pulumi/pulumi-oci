...
public final class DeploymentSpecificationRequestPoliciesAuthenticationValidationPolicyKeyArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeploymentSpecificationRequestPoliciesAuthenticationValidationPolicyKeyArgs Empty = new DeploymentSpecificationRequestPoliciesAuthenticationValidationPolicyKeyArgs();
    ...
    private DeploymentSpecificationRequestPoliciesAuthenticationValidationPolicyKeyArgs() {}

    private DeploymentSpecificationRequestPoliciesAuthenticationValidationPolicyKeyArgs(DeploymentSpecificationRequestPoliciesAuthenticationValidationPolicyKeyArgs $) {
        this.alg = $.alg;
        this.e = $.e;
        this.format = $.format;
        this.key = $.key;
    ...
    public static Builder builder(DeploymentSpecificationRequestPoliciesAuthenticationValidationPolicyKeyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeploymentSpecificationRequestPoliciesAuthenticationValidationPolicyKeyArgs();
        }

        public Builder(DeploymentSpecificationRequestPoliciesAuthenticationValidationPolicyKeyArgs defaults) {
            $ = new DeploymentSpecificationRequestPoliciesAuthenticationValidationPolicyKeyArgs(Objects.requireNonNull(defaults));
        }
