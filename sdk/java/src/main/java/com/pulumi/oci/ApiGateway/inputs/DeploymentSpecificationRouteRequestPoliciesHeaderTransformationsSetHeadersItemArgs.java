...
public final class DeploymentSpecificationRouteRequestPoliciesHeaderTransformationsSetHeadersItemArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public DeploymentSpecificationRouteRequestPoliciesHeaderTransformationsSetHeadersItemArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DeploymentSpecificationRouteRequestPoliciesHeaderTransformationsSetHeadersItemArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("DeploymentSpecificationRouteRequestPoliciesHeaderTransformationsSetHeadersItemArgs", "values");
            }
            return $;
        }
    }
