...
public final class DeploymentSpecificationRouteResponsePoliciesHeaderTransformationsRenameHeadersItemArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public DeploymentSpecificationRouteResponsePoliciesHeaderTransformationsRenameHeadersItemArgs build() {
            if ($.from == null) {
                throw new MissingRequiredPropertyException("DeploymentSpecificationRouteResponsePoliciesHeaderTransformationsRenameHeadersItemArgs", "from");
            }
            if ($.to == null) {
                throw new MissingRequiredPropertyException("DeploymentSpecificationRouteResponsePoliciesHeaderTransformationsRenameHeadersItemArgs", "to");
            }
            return $;
        }
    }
