...
public final class DeploymentSpecificationRouteResponsePoliciesHeaderTransformationsSetHeadersItemArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public DeploymentSpecificationRouteResponsePoliciesHeaderTransformationsSetHeadersItemArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("DeploymentSpecificationRouteResponsePoliciesHeaderTransformationsSetHeadersItemArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("DeploymentSpecificationRouteResponsePoliciesHeaderTransformationsSetHeadersItemArgs", "values");
            }
            return $;
        }
    }
