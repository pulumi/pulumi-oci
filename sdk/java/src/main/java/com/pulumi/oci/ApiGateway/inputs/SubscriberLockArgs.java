...
public final class SubscriberLockArgs extends com.pulumi.resources.ResourceArgs {

    public static final SubscriberLockArgs Empty = new SubscriberLockArgs();
    ...
    private SubscriberLockArgs() {}

    private SubscriberLockArgs(SubscriberLockArgs $) {
    ...
    public static Builder builder(SubscriberLockArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SubscriberLockArgs();
        }

        public Builder(SubscriberLockArgs defaults) {
            $ = new SubscriberLockArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SubscriberLockArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("SubscriberLockArgs", "type");
            }
            return $;
        }
    }
