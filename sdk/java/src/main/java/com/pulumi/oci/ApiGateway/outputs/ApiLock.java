...
public final class ApiLock {
    ...
    public static Builder builder(ApiLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(ApiLock defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("ApiLock", "type");
            }
            this.type = type;
            return this;
        }
        public ApiLock build() {
            final var _resultValue = new ApiLock();
