...
@CustomType
public final class DeploymentSpecificationRequestPoliciesAuthenticationValidationPolicyClientDetails {
    /**
    ...
    public static Builder builder(DeploymentSpecificationRequestPoliciesAuthenticationValidationPolicyClientDetails defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(DeploymentSpecificationRequestPoliciesAuthenticationValidationPolicyClientDetails defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("DeploymentSpecificationRequestPoliciesAuthenticationValidationPolicyClientDetails", "type");
            }
            this.type = type;
            return this;
        }
        public DeploymentSpecificationRequestPoliciesAuthenticationValidationPolicyClientDetails build() {
            final var _resultValue = new DeploymentSpecificationRequestPoliciesAuthenticationValidationPolicyClientDetails();
