...
public final class DeploymentSpecificationRouteRequestPoliciesHeaderTransformationsSetHeadersItem {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("DeploymentSpecificationRouteRequestPoliciesHeaderTransformationsSetHeadersItem", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("DeploymentSpecificationRouteRequestPoliciesHeaderTransformationsSetHeadersItem", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public DeploymentSpecificationRouteRequestPoliciesHeaderTransformationsSetHeadersItem build() {
            final var _resultValue = new DeploymentSpecificationRouteRequestPoliciesHeaderTransformationsSetHeadersItem();
