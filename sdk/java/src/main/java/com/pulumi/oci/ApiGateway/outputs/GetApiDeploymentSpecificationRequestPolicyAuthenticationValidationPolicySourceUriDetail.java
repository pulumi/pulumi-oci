...
public final class GetApiDeploymentSpecificationRequestPolicyAuthenticationValidationPolicySourceUriDetail {
    ...
    public static Builder builder(GetApiDeploymentSpecificationRequestPolicyAuthenticationValidationPolicySourceUriDetail defaults) {
    ...
    public static final class Builder {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetApiDeploymentSpecificationRequestPolicyAuthenticationValidationPolicySourceUriDetail", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder uri(String uri) {
            if (uri == null) {
              throw new MissingRequiredPropertyException("GetApiDeploymentSpecificationRequestPolicyAuthenticationValidationPolicySourceUriDetail", "uri");
            }
            this.uri = uri;
            return this;
        }
        public GetApiDeploymentSpecificationRequestPolicyAuthenticationValidationPolicySourceUriDetail build() {
            final var _resultValue = new GetApiDeploymentSpecificationRequestPolicyAuthenticationValidationPolicySourceUriDetail();
