...
public final class GetApiDeploymentSpecificationRouteBackendHeader {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetApiDeploymentSpecificationRouteBackendHeader", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetApiDeploymentSpecificationRouteBackendHeader", "value");
            }
            this.value = value;
            return this;
        }
        public GetApiDeploymentSpecificationRouteBackendHeader build() {
            final var _resultValue = new GetApiDeploymentSpecificationRouteBackendHeader();
