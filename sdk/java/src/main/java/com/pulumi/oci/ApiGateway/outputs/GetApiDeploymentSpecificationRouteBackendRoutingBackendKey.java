...
public final class GetApiDeploymentSpecificationRouteBackendRoutingBackendKey {
    ...
    public static Builder builder(GetApiDeploymentSpecificationRouteBackendRoutingBackendKey defaults) {
    ...
    public static final class Builder {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("GetApiDeploymentSpecificationRouteBackendRoutingBackendKey", "expression");
            }
        ...
        public Builder isDefault(Boolean isDefault) {
            if (isDefault == null) {
              throw new MissingRequiredPropertyException("GetApiDeploymentSpecificationRouteBackendRoutingBackendKey", "isDefault");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetApiDeploymentSpecificationRouteBackendRoutingBackendKey", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetApiDeploymentSpecificationRouteBackendRoutingBackendKey", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetApiDeploymentSpecificationRouteBackendRoutingBackendKey", "values");
            }
            this.values = values;
            return this;
        }
