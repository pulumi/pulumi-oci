...
public final class GetApiDeploymentSpecificationRouteRequestPolicyHeaderTransformationRenameHeaderItem {
    ...
    public static final class Builder {
        ...
        public Builder from(String from) {
            if (from == null) {
              throw new MissingRequiredPropertyException("GetApiDeploymentSpecificationRouteRequestPolicyHeaderTransformationRenameHeaderItem", "from");
            }
            this.from = from;
            return this;
        }
        ...
        public Builder to(String to) {
            if (to == null) {
              throw new MissingRequiredPropertyException("GetApiDeploymentSpecificationRouteRequestPolicyHeaderTransformationRenameHeaderItem", "to");
            }
            this.to = to;
            return this;
        }
        public GetApiDeploymentSpecificationRouteRequestPolicyHeaderTransformationRenameHeaderItem build() {
            final var _resultValue = new GetApiDeploymentSpecificationRouteRequestPolicyHeaderTransformationRenameHeaderItem();
