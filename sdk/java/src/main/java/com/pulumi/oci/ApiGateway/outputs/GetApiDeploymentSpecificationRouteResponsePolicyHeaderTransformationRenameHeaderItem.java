...
@CustomType
public final class GetApiDeploymentSpecificationRouteResponsePolicyHeaderTransformationRenameHeaderItem {
    /**
    ...
    private GetApiDeploymentSpecificationRouteResponsePolicyHeaderTransformationRenameHeaderItem() {}
    /**
     * @return The original case-insensitive name of the header.  This name must be unique across transformation policies.
     * 
     */
    ...
    public static Builder builder(GetApiDeploymentSpecificationRouteResponsePolicyHeaderTransformationRenameHeaderItem defaults) {
    ...
    public static final class Builder {
        ...
        private String to;
        public Builder() {}
        public Builder(GetApiDeploymentSpecificationRouteResponsePolicyHeaderTransformationRenameHeaderItem defaults) {
