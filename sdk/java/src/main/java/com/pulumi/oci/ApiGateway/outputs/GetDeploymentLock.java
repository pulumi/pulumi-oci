...
public final class GetDeploymentLock {
    ...
    public static Builder builder(GetDeploymentLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetDeploymentLock defaults) {
        ...
        public Builder message(String message) {
            if (message == null) {
              throw new MissingRequiredPropertyException("GetDeploymentLock", "message");
            }
        ...
        public Builder relatedResourceId(String relatedResourceId) {
            if (relatedResourceId == null) {
              throw new MissingRequiredPropertyException("GetDeploymentLock", "relatedResourceId");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetDeploymentLock", "timeCreated");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetDeploymentLock", "type");
            }
            this.type = type;
            return this;
        }
        public GetDeploymentLock build() {
            final var _resultValue = new GetDeploymentLock();
