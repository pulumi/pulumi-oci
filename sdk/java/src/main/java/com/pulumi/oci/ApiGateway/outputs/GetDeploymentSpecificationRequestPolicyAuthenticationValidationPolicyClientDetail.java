...
public final class GetDeploymentSpecificationRequestPolicyAuthenticationValidationPolicyClientDetail {
    ...
    public static Builder builder(GetDeploymentSpecificationRequestPolicyAuthenticationValidationPolicyClientDetail defaults) {
    ...
    public static final class Builder {
        ...
        public Builder clientId(String clientId) {
            if (clientId == null) {
              throw new MissingRequiredPropertyException("GetDeploymentSpecificationRequestPolicyAuthenticationValidationPolicyClientDetail", "clientId");
            }
        ...
        public Builder clientSecretId(String clientSecretId) {
            if (clientSecretId == null) {
              throw new MissingRequiredPropertyException("GetDeploymentSpecificationRequestPolicyAuthenticationValidationPolicyClientDetail", "clientSecretId");
            }
        ...
        public Builder clientSecretVersionNumber(String clientSecretVersionNumber) {
            if (clientSecretVersionNumber == null) {
              throw new MissingRequiredPropertyException("GetDeploymentSpecificationRequestPolicyAuthenticationValidationPolicyClientDetail", "clientSecretVersionNumber");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetDeploymentSpecificationRequestPolicyAuthenticationValidationPolicyClientDetail", "type");
            }
            this.type = type;
            return this;
        }
