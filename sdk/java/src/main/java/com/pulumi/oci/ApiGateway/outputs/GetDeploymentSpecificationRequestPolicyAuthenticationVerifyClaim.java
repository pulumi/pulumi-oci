...
public final class GetDeploymentSpecificationRequestPolicyAuthenticationVerifyClaim {
    ...
    public static Builder builder(GetDeploymentSpecificationRequestPolicyAuthenticationVerifyClaim defaults) {
    ...
    public static final class Builder {
        ...
        public Builder isRequired(Boolean isRequired) {
            if (isRequired == null) {
              throw new MissingRequiredPropertyException("GetDeploymentSpecificationRequestPolicyAuthenticationVerifyClaim", "isRequired");
            }
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetDeploymentSpecificationRequestPolicyAuthenticationVerifyClaim", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetDeploymentSpecificationRequestPolicyAuthenticationVerifyClaim", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetDeploymentSpecificationRequestPolicyAuthenticationVerifyClaim build() {
            final var _resultValue = new GetDeploymentSpecificationRequestPolicyAuthenticationVerifyClaim();
