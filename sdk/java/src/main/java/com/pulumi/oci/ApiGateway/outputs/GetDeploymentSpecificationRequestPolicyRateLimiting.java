    ...
    public static final class Builder {
        ...
        public Builder rateInRequestsPerSecond(Integer rateInRequestsPerSecond) {
            if (rateInRequestsPerSecond == null) {
              throw new MissingRequiredPropertyException("GetDeploymentSpecificationRequestPolicyRateLimiting", "rateInRequestsPerSecond");
            }
        ...
        public Builder rateKey(String rateKey) {
            if (rateKey == null) {
              throw new MissingRequiredPropertyException("GetDeploymentSpecificationRequestPolicyRateLimiting", "rateKey");
            }
