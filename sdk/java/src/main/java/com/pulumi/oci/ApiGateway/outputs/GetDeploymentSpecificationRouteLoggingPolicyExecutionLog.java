...
public final class GetDeploymentSpecificationRouteLoggingPolicyExecutionLog {
    ...
    public static final class Builder {
        ...
        public Builder isEnabled(Boolean isEnabled) {
            if (isEnabled == null) {
              throw new MissingRequiredPropertyException("GetDeploymentSpecificationRouteLoggingPolicyExecutionLog", "isEnabled");
            }
        ...
        public Builder logLevel(String logLevel) {
            if (logLevel == null) {
              throw new MissingRequiredPropertyException("GetDeploymentSpecificationRouteLoggingPolicyExecutionLog", "logLevel");
            }
            this.logLevel = logLevel;
            return this;
        }
        public GetDeploymentSpecificationRouteLoggingPolicyExecutionLog build() {
            final var _resultValue = new GetDeploymentSpecificationRouteLoggingPolicyExecutionLog();
