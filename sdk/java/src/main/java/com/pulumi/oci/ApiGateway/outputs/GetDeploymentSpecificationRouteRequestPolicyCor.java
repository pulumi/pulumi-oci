...
@CustomType
public final class GetDeploymentSpecificationRouteRequestPolicyCor {
    /**
    ...
    private GetDeploymentSpecificationRouteRequestPolicyCor() {}
    /**
     * @return The list of headers that will be allowed from the client via the Access-Control-Allow-Headers header. &#39;*&#39; will allow all headers.
     * 
     */
    ...
    public static Builder builder(GetDeploymentSpecificationRouteRequestPolicyCor defaults) {
    ...
    public static final class Builder {
        ...
        private Integer maxAgeInSeconds;
        public Builder() {}
        public Builder(GetDeploymentSpecificationRouteRequestPolicyCor defaults) {
