...
public final class GetDeploymentSpecificationRouteRequestPolicyHeaderTransformationRenameHeaderItem {
    ...
    public static final class Builder {
        ...
        public Builder from(String from) {
            if (from == null) {
              throw new MissingRequiredPropertyException("GetDeploymentSpecificationRouteRequestPolicyHeaderTransformationRenameHeaderItem", "from");
            }
            this.from = from;
            return this;
        }
        ...
        public Builder to(String to) {
            if (to == null) {
              throw new MissingRequiredPropertyException("GetDeploymentSpecificationRouteRequestPolicyHeaderTransformationRenameHeaderItem", "to");
            }
            this.to = to;
            return this;
        }
        public GetDeploymentSpecificationRouteRequestPolicyHeaderTransformationRenameHeaderItem build() {
            final var _resultValue = new GetDeploymentSpecificationRouteRequestPolicyHeaderTransformationRenameHeaderItem();
