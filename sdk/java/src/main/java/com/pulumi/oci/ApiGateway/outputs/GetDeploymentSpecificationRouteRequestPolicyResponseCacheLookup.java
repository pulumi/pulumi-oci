    ...
    public static final class Builder {
        ...
        public Builder cacheKeyAdditions(List<String> cacheKeyAdditions) {
            if (cacheKeyAdditions == null) {
              throw new MissingRequiredPropertyException("GetDeploymentSpecificationRouteRequestPolicyResponseCacheLookup", "cacheKeyAdditions");
            }
        ...
        public Builder isEnabled(Boolean isEnabled) {
            if (isEnabled == null) {
              throw new MissingRequiredPropertyException("GetDeploymentSpecificationRouteRequestPolicyResponseCacheLookup", "isEnabled");
            }
        ...
        public Builder isPrivateCachingEnabled(Boolean isPrivateCachingEnabled) {
            if (isPrivateCachingEnabled == null) {
              throw new MissingRequiredPropertyException("GetDeploymentSpecificationRouteRequestPolicyResponseCacheLookup", "isPrivateCachingEnabled");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetDeploymentSpecificationRouteRequestPolicyResponseCacheLookup", "type");
            }
            this.type = type;
            return this;
        }
        public GetDeploymentSpecificationRouteRequestPolicyResponseCacheLookup build() {
            final var _resultValue = new GetDeploymentSpecificationRouteRequestPolicyResponseCacheLookup();
