    ...
    public static final class Builder {
        ...
        public Builder timeToLiveInSeconds(Integer timeToLiveInSeconds) {
            if (timeToLiveInSeconds == null) {
              throw new MissingRequiredPropertyException("GetDeploymentSpecificationRouteResponsePolicyResponseCacheStore", "timeToLiveInSeconds");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetDeploymentSpecificationRouteResponsePolicyResponseCacheStore", "type");
            }
            this.type = type;
            return this;
        }
