    ...
    public static final class Builder {
        ...
        public Builder allowedHeaders(List<String> allowedHeaders) {
            if (allowedHeaders == null) {
              throw new MissingRequiredPropertyException("GetDeploymentsDeploymentCollectionSpecificationRequestPolicyCor", "allowedHeaders");
            }
        ...
        public Builder allowedMethods(List<String> allowedMethods) {
            if (allowedMethods == null) {
              throw new MissingRequiredPropertyException("GetDeploymentsDeploymentCollectionSpecificationRequestPolicyCor", "allowedMethods");
            }
        ...
        public Builder allowedOrigins(List<String> allowedOrigins) {
            if (allowedOrigins == null) {
              throw new MissingRequiredPropertyException("GetDeploymentsDeploymentCollectionSpecificationRequestPolicyCor", "allowedOrigins");
            }
        ...
        public Builder exposedHeaders(List<String> exposedHeaders) {
            if (exposedHeaders == null) {
              throw new MissingRequiredPropertyException("GetDeploymentsDeploymentCollectionSpecificationRequestPolicyCor", "exposedHeaders");
            }
        ...
        public Builder isAllowCredentialsEnabled(Boolean isAllowCredentialsEnabled) {
            if (isAllowCredentialsEnabled == null) {
              throw new MissingRequiredPropertyException("GetDeploymentsDeploymentCollectionSpecificationRequestPolicyCor", "isAllowCredentialsEnabled");
            }
        ...
        public Builder maxAgeInSeconds(Integer maxAgeInSeconds) {
            if (maxAgeInSeconds == null) {
              throw new MissingRequiredPropertyException("GetDeploymentsDeploymentCollectionSpecificationRequestPolicyCor", "maxAgeInSeconds");
            }
            this.maxAgeInSeconds = maxAgeInSeconds;
            return this;
        }
        public GetDeploymentsDeploymentCollectionSpecificationRequestPolicyCor build() {
            final var _resultValue = new GetDeploymentsDeploymentCollectionSpecificationRequestPolicyCor();
