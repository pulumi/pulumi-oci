...
public final class GetDeploymentsDeploymentCollectionSpecificationRouteBackendHeader {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetDeploymentsDeploymentCollectionSpecificationRouteBackendHeader", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetDeploymentsDeploymentCollectionSpecificationRouteBackendHeader", "value");
            }
            this.value = value;
            return this;
        }
        public GetDeploymentsDeploymentCollectionSpecificationRouteBackendHeader build() {
            final var _resultValue = new GetDeploymentsDeploymentCollectionSpecificationRouteBackendHeader();
