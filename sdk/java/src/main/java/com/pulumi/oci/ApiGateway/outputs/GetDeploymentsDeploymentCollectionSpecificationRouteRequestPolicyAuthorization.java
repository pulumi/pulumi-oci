    ...
    public static final class Builder {
        ...
        public Builder allowedScopes(List<String> allowedScopes) {
            if (allowedScopes == null) {
              throw new MissingRequiredPropertyException("GetDeploymentsDeploymentCollectionSpecificationRouteRequestPolicyAuthorization", "allowedScopes");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetDeploymentsDeploymentCollectionSpecificationRouteRequestPolicyAuthorization", "type");
            }
            this.type = type;
            return this;
        }
        public GetDeploymentsDeploymentCollectionSpecificationRouteRequestPolicyAuthorization build() {
            final var _resultValue = new GetDeploymentsDeploymentCollectionSpecificationRouteRequestPolicyAuthorization();
