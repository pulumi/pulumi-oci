    ...
    public static final class Builder {
        ...
        public Builder cacheKeyAdditions(List<String> cacheKeyAdditions) {
            if (cacheKeyAdditions == null) {
              throw new MissingRequiredPropertyException("GetDeploymentsDeploymentCollectionSpecificationRouteRequestPolicyResponseCacheLookup", "cacheKeyAdditions");
            }
        ...
        public Builder isEnabled(Boolean isEnabled) {
            if (isEnabled == null) {
              throw new MissingRequiredPropertyException("GetDeploymentsDeploymentCollectionSpecificationRouteRequestPolicyResponseCacheLookup", "isEnabled");
            }
        ...
        public Builder isPrivateCachingEnabled(Boolean isPrivateCachingEnabled) {
            if (isPrivateCachingEnabled == null) {
              throw new MissingRequiredPropertyException("GetDeploymentsDeploymentCollectionSpecificationRouteRequestPolicyResponseCacheLookup", "isPrivateCachingEnabled");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetDeploymentsDeploymentCollectionSpecificationRouteRequestPolicyResponseCacheLookup", "type");
            }
            this.type = type;
            return this;
        }
        public GetDeploymentsDeploymentCollectionSpecificationRouteRequestPolicyResponseCacheLookup build() {
            final var _resultValue = new GetDeploymentsDeploymentCollectionSpecificationRouteRequestPolicyResponseCacheLookup();
