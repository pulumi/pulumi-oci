...
public final class GetDeploymentsDeploymentCollectionSpecificationRouteResponsePolicyHeaderTransformation {
     ...
     * 
     */
    private @Nullable List<GetDeploymentsDeploymentCollectionSpecificationRouteResponsePolicyHeaderTransformationFilterHeader> filterHeaders;
    /**
     * @return Rename HTTP headers as they pass through the gateway.
     * 
     */
    private @Nullable List<GetDeploymentsDeploymentCollectionSpecificationRouteResponsePolicyHeaderTransformationRenameHeader> renameHeaders;
    /**
     * @return Set HTTP headers as they pass through the gateway.
     * 
     */
    private @Nullable List<GetDeploymentsDeploymentCollectionSpecificationRouteResponsePolicyHeaderTransformationSetHeader> setHeaders;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder filterHeaders(@Nullable List<GetDeploymentsDeploymentCollectionSpecificationRouteResponsePolicyHeaderTransformationFilterHeader> filterHeaders) {
        ...
        @CustomType.Setter
        public Builder renameHeaders(@Nullable List<GetDeploymentsDeploymentCollectionSpecificationRouteResponsePolicyHeaderTransformationRenameHeader> renameHeaders) {
        ...
        @CustomType.Setter
        public Builder setHeaders(@Nullable List<GetDeploymentsDeploymentCollectionSpecificationRouteResponsePolicyHeaderTransformationSetHeader> setHeaders) {
