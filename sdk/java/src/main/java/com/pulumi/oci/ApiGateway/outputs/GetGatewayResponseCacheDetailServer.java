...
public final class GetGatewayResponseCacheDetailServer {
    ...
    public static final class Builder {
        ...
        public Builder host(String host) {
            if (host == null) {
              throw new MissingRequiredPropertyException("GetGatewayResponseCacheDetailServer", "host");
            }
            this.host = host;
            return this;
        }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetGatewayResponseCacheDetailServer", "port");
            }
            this.port = port;
            return this;
        }
