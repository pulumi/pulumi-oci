...
public final class GetGatewaysGatewayCollectionCaBundle {
    ...
    public static final class Builder {
        ...
        public Builder caBundleId(String caBundleId) {
            if (caBundleId == null) {
              throw new MissingRequiredPropertyException("GetGatewaysGatewayCollectionCaBundle", "caBundleId");
            }
        ...
        public Builder certificateAuthorityId(String certificateAuthorityId) {
            if (certificateAuthorityId == null) {
              throw new MissingRequiredPropertyException("GetGatewaysGatewayCollectionCaBundle", "certificateAuthorityId");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetGatewaysGatewayCollectionCaBundle", "type");
            }
            this.type = type;
            return this;
        }
        public GetGatewaysGatewayCollectionCaBundle build() {
            final var _resultValue = new GetGatewaysGatewayCollectionCaBundle();
