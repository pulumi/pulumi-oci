    ...
    public static final class Builder {
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetSubscribersResult", "compartmentId");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetSubscribersResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder subscriberCollections(List<GetSubscribersSubscriberCollection> subscriberCollections) {
            if (subscriberCollections == null) {
              throw new MissingRequiredPropertyException("GetSubscribersResult", "subscriberCollections");
            }
        ...
        public GetSubscribersResult build() {
            final var _resultValue = new GetSubscribersResult();
            _resultValue.compartmentId = compartmentId;
            _resultValue.displayName = displayName;
            _resultValue.filters = filters;
            _resultValue.id = id;
            _resultValue.state = state;
            _resultValue.subscriberCollections = subscriberCollections;
            return _resultValue;
        }
    }
}
