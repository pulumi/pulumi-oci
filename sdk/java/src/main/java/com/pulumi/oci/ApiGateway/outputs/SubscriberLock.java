...
@CustomType
public final class SubscriberLock {
    /**
    ...
    public static Builder builder(SubscriberLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(SubscriberLock defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("SubscriberLock", "type");
            }
            this.type = type;
            return this;
        }
        public SubscriberLock build() {
            final var _resultValue = new SubscriberLock();
