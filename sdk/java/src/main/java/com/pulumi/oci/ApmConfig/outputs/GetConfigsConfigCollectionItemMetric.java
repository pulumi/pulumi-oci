...
public final class GetConfigsConfigCollectionItemMetric {
    ...
    public static final class Builder {
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetConfigsConfigCollectionItemMetric", "description");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetConfigsConfigCollectionItemMetric", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder unit(String unit) {
            if (unit == null) {
              throw new MissingRequiredPropertyException("GetConfigsConfigCollectionItemMetric", "unit");
            }
            this.unit = unit;
            return this;
        }
        ...
        public Builder valueSource(String valueSource) {
            if (valueSource == null) {
              throw new MissingRequiredPropertyException("GetConfigsConfigCollectionItemMetric", "valueSource");
            }
            this.valueSource = valueSource;
            return this;
        }
        public GetConfigsConfigCollectionItemMetric build() {
            final var _resultValue = new GetConfigsConfigCollectionItemMetric();
