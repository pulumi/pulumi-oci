...
public class OnPremiseVantagePointWorker extends com.pulumi.resources.CustomResource {
    ...
    public OnPremiseVantagePointWorker(String name, OnPremiseVantagePointWorkerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:ApmSynthetics/onPremiseVantagePointWorker:OnPremiseVantagePointWorker", name, args == null ? OnPremiseVantagePointWorkerArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
