...
public final class GetResultArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetResultArgs build() {
            if ($.apmDomainId == null) {
                throw new MissingRequiredPropertyException("GetResultArgs", "apmDomainId");
            }
            if ($.executionTime == null) {
                throw new MissingRequiredPropertyException("GetResultArgs", "executionTime");
            }
            if ($.monitorId == null) {
                throw new MissingRequiredPropertyException("GetResultArgs", "monitorId");
            }
            if ($.resultContentType == null) {
                throw new MissingRequiredPropertyException("GetResultArgs", "resultContentType");
            }
            if ($.resultType == null) {
                throw new MissingRequiredPropertyException("GetResultArgs", "resultType");
            }
            if ($.vantagePoint == null) {
                throw new MissingRequiredPropertyException("GetResultArgs", "vantagePoint");
            }
            return $;
        }
    }
