...
@CustomType
public final class ConfigConfigurationFtpBasicAuthenticationDetailsPassword {
    /**
    ...
    private ConfigConfigurationFtpBasicAuthenticationDetailsPassword() {}
    /**
     * @return (Updatable) Password.
     * 
     */
    ...
    public static Builder builder(ConfigConfigurationFtpBasicAuthenticationDetailsPassword defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String vaultSecretId;
        public Builder() {}
        public Builder(ConfigConfigurationFtpBasicAuthenticationDetailsPassword defaults) {
        ...
        public ConfigConfigurationFtpBasicAuthenticationDetailsPassword build() {
            final var _resultValue = new ConfigConfigurationFtpBasicAuthenticationDetailsPassword();
