...
@CustomType
public final class DedicatedVantagePointMonitorStatusCountMap {
    /**
    ...
    private DedicatedVantagePointMonitorStatusCountMap(
    ...
    public static Builder builder(DedicatedVantagePointMonitorStatusCountMap defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(DedicatedVantagePointMonitorStatusCountMap defaults) {
        ...
        public Builder total(@Nullable Integer total) {
            ...
            return new DedicatedVantagePointMonitorStatusCountMap(disabled, enabled, invalid, total);
        }
    }
}
