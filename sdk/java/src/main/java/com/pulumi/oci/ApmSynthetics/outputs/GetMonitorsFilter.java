...
@CustomType
public final class GetMonitorsFilter {
    /**
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetMonitorsFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetMonitorsFilter", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetMonitorsFilter build() {
            final var _resultValue = new GetMonitorsFilter();
