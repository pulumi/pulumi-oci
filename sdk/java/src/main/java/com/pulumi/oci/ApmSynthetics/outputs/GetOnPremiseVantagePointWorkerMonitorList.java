...
@CustomType
public final class GetOnPremiseVantagePointWorkerMonitorList {
    /**
    ...
    private GetOnPremiseVantagePointWorkerMonitorList() {}
    /**
     * @return Unique name that can be edited. The name should not contain any confidential information.
     * 
     */
    ...
    public static Builder builder(GetOnPremiseVantagePointWorkerMonitorList defaults) {
    ...
    public static final class Builder {
        ...
        private String timeAssigned;
        public Builder() {}
        public Builder(GetOnPremiseVantagePointWorkerMonitorList defaults) {
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetOnPremiseVantagePointWorkerMonitorList", "displayName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetOnPremiseVantagePointWorkerMonitorList", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isRunNow(Boolean isRunNow) {
            if (isRunNow == null) {
              throw new MissingRequiredPropertyException("GetOnPremiseVantagePointWorkerMonitorList", "isRunNow");
            }
        ...
        public Builder monitorType(String monitorType) {
            if (monitorType == null) {
              throw new MissingRequiredPropertyException("GetOnPremiseVantagePointWorkerMonitorList", "monitorType");
            }
        ...
        public Builder timeAssigned(String timeAssigned) {
            if (timeAssigned == null) {
              throw new MissingRequiredPropertyException("GetOnPremiseVantagePointWorkerMonitorList", "timeAssigned");
            }
            this.timeAssigned = timeAssigned;
            return this;
        }
        public GetOnPremiseVantagePointWorkerMonitorList build() {
            final var _resultValue = new GetOnPremiseVantagePointWorkerMonitorList();
