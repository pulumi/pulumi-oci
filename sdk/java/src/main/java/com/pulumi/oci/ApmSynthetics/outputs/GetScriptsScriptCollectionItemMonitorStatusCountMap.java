...
public final class GetScriptsScriptCollectionItemMonitorStatusCountMap {
    ...
    public static final class Builder {
        ...
        public Builder disabled(Integer disabled) {
            if (disabled == null) {
              throw new MissingRequiredPropertyException("GetScriptsScriptCollectionItemMonitorStatusCountMap", "disabled");
            }
        ...
        public Builder enabled(Integer enabled) {
            if (enabled == null) {
              throw new MissingRequiredPropertyException("GetScriptsScriptCollectionItemMonitorStatusCountMap", "enabled");
            }
        ...
        public Builder invalid(Integer invalid) {
            if (invalid == null) {
              throw new MissingRequiredPropertyException("GetScriptsScriptCollectionItemMonitorStatusCountMap", "invalid");
            }
        ...
        public Builder total(Integer total) {
            if (total == null) {
              throw new MissingRequiredPropertyException("GetScriptsScriptCollectionItemMonitorStatusCountMap", "total");
            }
            this.total = total;
            return this;
        }
