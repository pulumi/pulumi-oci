...
public final class AutoScalingConfigurationPolicyExecutionSchedule {
    ...
    public static final class Builder {
        ...
        public Builder expression(String expression) {
            if (expression == null) {
              throw new MissingRequiredPropertyException("AutoScalingConfigurationPolicyExecutionSchedule", "expression");
            }
        ...
        public Builder timezone(String timezone) {
            if (timezone == null) {
              throw new MissingRequiredPropertyException("AutoScalingConfigurationPolicyExecutionSchedule", "timezone");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("AutoScalingConfigurationPolicyExecutionSchedule", "type");
            }
            this.type = type;
            return this;
        }
