...
public final class AutoScalingConfigurationPolicyDetailsScaleDownConfigMetricThresholdArgs extends com.pulumi.resources.ResourceArgs {

    public static final AutoScalingConfigurationPolicyDetailsScaleDownConfigMetricThresholdArgs Empty = new AutoScalingConfigurationPolicyDetailsScaleDownConfigMetricThresholdArgs();
    ...
    private AutoScalingConfigurationPolicyDetailsScaleDownConfigMetricThresholdArgs() {}

    private AutoScalingConfigurationPolicyDetailsScaleDownConfigMetricThresholdArgs(AutoScalingConfigurationPolicyDetailsScaleDownConfigMetricThresholdArgs $) {
    ...
    public static Builder builder(AutoScalingConfigurationPolicyDetailsScaleDownConfigMetricThresholdArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AutoScalingConfigurationPolicyDetailsScaleDownConfigMetricThresholdArgs();
        }

        public Builder(AutoScalingConfigurationPolicyDetailsScaleDownConfigMetricThresholdArgs defaults) {
            $ = new AutoScalingConfigurationPolicyDetailsScaleDownConfigMetricThresholdArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AutoScalingConfigurationPolicyDetailsScaleDownConfigMetricThresholdArgs build() {
            return $;
        }
    }
