...
public final class AutoScalingConfigurationPolicyDetailsScaleOutConfigMetricThresholdArgs extends com.pulumi.resources.ResourceArgs {

    public static final AutoScalingConfigurationPolicyDetailsScaleOutConfigMetricThresholdArgs Empty = new AutoScalingConfigurationPolicyDetailsScaleOutConfigMetricThresholdArgs();
    ...
    private AutoScalingConfigurationPolicyDetailsScaleOutConfigMetricThresholdArgs() {}

    private AutoScalingConfigurationPolicyDetailsScaleOutConfigMetricThresholdArgs(AutoScalingConfigurationPolicyDetailsScaleOutConfigMetricThresholdArgs $) {
    ...
    public static Builder builder(AutoScalingConfigurationPolicyDetailsScaleOutConfigMetricThresholdArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AutoScalingConfigurationPolicyDetailsScaleOutConfigMetricThresholdArgs();
        }

        public Builder(AutoScalingConfigurationPolicyDetailsScaleOutConfigMetricThresholdArgs defaults) {
            $ = new AutoScalingConfigurationPolicyDetailsScaleOutConfigMetricThresholdArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AutoScalingConfigurationPolicyDetailsScaleOutConfigMetricThresholdArgs build() {
            return $;
        }
    }
