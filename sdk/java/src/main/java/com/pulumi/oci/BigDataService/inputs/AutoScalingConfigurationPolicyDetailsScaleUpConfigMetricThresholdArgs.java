...
public final class AutoScalingConfigurationPolicyDetailsScaleUpConfigMetricThresholdArgs extends com.pulumi.resources.ResourceArgs {

    public static final AutoScalingConfigurationPolicyDetailsScaleUpConfigMetricThresholdArgs Empty = new AutoScalingConfigurationPolicyDetailsScaleUpConfigMetricThresholdArgs();
    ...
    private AutoScalingConfigurationPolicyDetailsScaleUpConfigMetricThresholdArgs() {}

    private AutoScalingConfigurationPolicyDetailsScaleUpConfigMetricThresholdArgs(AutoScalingConfigurationPolicyDetailsScaleUpConfigMetricThresholdArgs $) {
    ...
    public static Builder builder(AutoScalingConfigurationPolicyDetailsScaleUpConfigMetricThresholdArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AutoScalingConfigurationPolicyDetailsScaleUpConfigMetricThresholdArgs();
        }

        public Builder(AutoScalingConfigurationPolicyDetailsScaleUpConfigMetricThresholdArgs defaults) {
            $ = new AutoScalingConfigurationPolicyDetailsScaleUpConfigMetricThresholdArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AutoScalingConfigurationPolicyDetailsScaleUpConfigMetricThresholdArgs build() {
            return $;
        }
    }
