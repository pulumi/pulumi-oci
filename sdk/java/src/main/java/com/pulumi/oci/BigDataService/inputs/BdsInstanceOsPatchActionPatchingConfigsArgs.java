...
public final class BdsInstanceOsPatchActionPatchingConfigsArgs extends com.pulumi.resources.ResourceArgs {

    public static final BdsInstanceOsPatchActionPatchingConfigsArgs Empty = new BdsInstanceOsPatchActionPatchingConfigsArgs();
    ...
    private BdsInstanceOsPatchActionPatchingConfigsArgs() {}

    private BdsInstanceOsPatchActionPatchingConfigsArgs(BdsInstanceOsPatchActionPatchingConfigsArgs $) {
    ...
    public static Builder builder(BdsInstanceOsPatchActionPatchingConfigsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BdsInstanceOsPatchActionPatchingConfigsArgs();
        }

        public Builder(BdsInstanceOsPatchActionPatchingConfigsArgs defaults) {
            $ = new BdsInstanceOsPatchActionPatchingConfigsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BdsInstanceOsPatchActionPatchingConfigsArgs build() {
            if ($.patchingConfigStrategy == null) {
                throw new MissingRequiredPropertyException("BdsInstanceOsPatchActionPatchingConfigsArgs", "patchingConfigStrategy");
            }
            return $;
        }
    }
