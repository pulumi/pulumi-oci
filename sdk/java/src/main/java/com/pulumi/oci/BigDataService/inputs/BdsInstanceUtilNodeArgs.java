...
public final class BdsInstanceUtilNodeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<BdsInstanceUtilNodeShapeConfigArgs> shapeConfig;

    /**
     * @return The shape configuration requested for the node.
     * 
     */
    public Optional<Output<BdsInstanceUtilNodeShapeConfigArgs>> shapeConfig() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder shapeConfig(@Nullable Output<BdsInstanceUtilNodeShapeConfigArgs> shapeConfig) {
         ...
         * 
         */
        public Builder shapeConfig(BdsInstanceUtilNodeShapeConfigArgs shapeConfig) {
        ...
        public BdsInstanceUtilNodeArgs build() {
            if ($.numberOfNodes == null) {
                throw new MissingRequiredPropertyException("BdsInstanceUtilNodeArgs", "numberOfNodes");
            }
            if ($.shape == null) {
                throw new MissingRequiredPropertyException("BdsInstanceUtilNodeArgs", "shape");
            }
            if ($.subnetId == null) {
                throw new MissingRequiredPropertyException("BdsInstanceUtilNodeArgs", "subnetId");
            }
            return $;
        }
    }
