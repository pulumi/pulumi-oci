...
public final class BdsInstanceWorkerNodeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    /**
     * @return The amount of worker nodes should be created, at least be 3.
     * 
     */
    ...
    private BdsInstanceWorkerNodeArgs() {}

    private BdsInstanceWorkerNodeArgs(BdsInstanceWorkerNodeArgs $) {
    ...
    public static Builder builder(BdsInstanceWorkerNodeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BdsInstanceWorkerNodeArgs();
        }

        public Builder(BdsInstanceWorkerNodeArgs defaults) {
            $ = new BdsInstanceWorkerNodeArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param numberOfNodes The amount of worker nodes should be created, at least be 3.
         * 
         * @return builder
         * 
         */
