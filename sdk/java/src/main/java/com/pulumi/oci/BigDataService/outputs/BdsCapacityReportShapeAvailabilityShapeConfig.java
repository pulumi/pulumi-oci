...
@CustomType
public final class BdsCapacityReportShapeAvailabilityShapeConfig {
    /**
    ...
    public static Builder builder(BdsCapacityReportShapeAvailabilityShapeConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer ocpus;
        public Builder() {}
        public Builder(BdsCapacityReportShapeAvailabilityShapeConfig defaults) {
        ...
        public BdsCapacityReportShapeAvailabilityShapeConfig build() {
            final var _resultValue = new BdsCapacityReportShapeAvailabilityShapeConfig();
