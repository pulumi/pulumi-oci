...
import com.pulumi.oci.BigDataService.outputs.BdsInstanceEdgeNodeShapeConfig;
...
@CustomType
public final class BdsInstanceEdgeNode {
    /**
    ...
    public static Builder builder(BdsInstanceEdgeNode defaults) {
    ...
    public static final class Builder {
        ...
        private String subnetId;
        public Builder() {}
        public Builder(BdsInstanceEdgeNode defaults) {
        ...
        public Builder numberOfNodes(Integer numberOfNodes) {
            if (numberOfNodes == null) {
              throw new MissingRequiredPropertyException("BdsInstanceEdgeNode", "numberOfNodes");
            }
        ...
        public Builder shape(String shape) {
            if (shape == null) {
              throw new MissingRequiredPropertyException("BdsInstanceEdgeNode", "shape");
            }
            this.shape = shape;
            return this;
        }
        @CustomType.Setter
        public Builder shapeConfig(@Nullable BdsInstanceEdgeNodeShapeConfig shapeConfig) {
        ...
        public Builder subnetId(String subnetId) {
            if (subnetId == null) {
              throw new MissingRequiredPropertyException("BdsInstanceEdgeNode", "subnetId");
            }
