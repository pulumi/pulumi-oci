...
@CustomType
public final class BdsInstanceUtilNodeShapeConfig {
    /**
    ...
    private BdsInstanceUtilNodeShapeConfig(
    ...
    public static Builder builder(BdsInstanceUtilNodeShapeConfig defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(BdsInstanceUtilNodeShapeConfig defaults) {
        ...
        public Builder ocpus(@Nullable Integer ocpus) {
            this.ocpus = ocpus;
            return this;
        }        public BdsInstanceUtilNodeShapeConfig build() {
            return new BdsInstanceUtilNodeShapeConfig(memoryInGbs, ocpus);
        }
    }
}
