...
import com.pulumi.oci.BigDataService.outputs.GetAutoScalingConfigurationPolicyDetailScaleUpConfigMetricThreshold;
import java.lang.String;
import java.util.List;
import java.util.Objects;

@CustomType
public final class GetAutoScalingConfigurationPolicyDetailScaleUpConfigMetric {
    /**
     ...
     * 
     */
    public List<GetAutoScalingConfigurationPolicyDetailScaleUpConfigMetricThreshold> thresholds() {
    ...
    public static final class Builder {
        ...
        public Builder metricType(String metricType) {
            if (metricType == null) {
              throw new MissingRequiredPropertyException("GetAutoScalingConfigurationPolicyDetailScaleUpConfigMetric", "metricType");
            }
        ...
        public Builder thresholds(List<GetAutoScalingConfigurationPolicyDetailScaleUpConfigMetricThreshold> thresholds) {
            if (thresholds == null) {
              throw new MissingRequiredPropertyException("GetAutoScalingConfigurationPolicyDetailScaleUpConfigMetric", "thresholds");
            }
