...
@CustomType
public final class GetAutoScalingConfigurationPolicyDetailScaleUpConfigMetricThreshold {
    /**
    ...
    public static final class Builder {
        ...
        public Builder durationInMinutes(Integer durationInMinutes) {
            if (durationInMinutes == null) {
              throw new MissingRequiredPropertyException("GetAutoScalingConfigurationPolicyDetailScaleUpConfigMetricThreshold", "durationInMinutes");
            }
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("GetAutoScalingConfigurationPolicyDetailScaleUpConfigMetricThreshold", "operator");
            }
        ...
        public Builder value(Integer value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetAutoScalingConfigurationPolicyDetailScaleUpConfigMetricThreshold", "value");
            }
            this.value = value;
            return this;
        }
        public GetAutoScalingConfigurationPolicyDetailScaleUpConfigMetricThreshold build() {
            final var _resultValue = new GetAutoScalingConfigurationPolicyDetailScaleUpConfigMetricThreshold();
