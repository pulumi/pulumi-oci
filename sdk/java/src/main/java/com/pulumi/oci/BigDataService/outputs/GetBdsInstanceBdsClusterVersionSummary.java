...
@CustomType
public final class GetBdsInstanceBdsClusterVersionSummary {
    /**
    ...
    private GetBdsInstanceBdsClusterVersionSummary() {}
    /**
     * @return Big Data Service version installed in the cluster.
     * 
     */
    ...
    public static Builder builder(GetBdsInstanceBdsClusterVersionSummary defaults) {
    ...
    public static final class Builder {
        ...
        private String odhVersion;
        public Builder() {}
        public Builder(GetBdsInstanceBdsClusterVersionSummary defaults) {
        ...
        public Builder bdsVersion(String bdsVersion) {
            if (bdsVersion == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceBdsClusterVersionSummary", "bdsVersion");
            }
        ...
        public Builder odhVersion(String odhVersion) {
            if (odhVersion == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceBdsClusterVersionSummary", "odhVersion");
            }
            this.odhVersion = odhVersion;
            return this;
        }
        public GetBdsInstanceBdsClusterVersionSummary build() {
            final var _resultValue = new GetBdsInstanceBdsClusterVersionSummary();
