...
@CustomType
public final class GetBdsInstanceIdentityConfigurationsIdentityConfigurationUpstConfiguration {
    /**
    ...
    private GetBdsInstanceIdentityConfigurationsIdentityConfigurationUpstConfiguration() {}
    /**
     * @return The kerberos keytab content used for creating identity propagation trust config, in base64 format
     * 
     */
    ...
    public static Builder builder(GetBdsInstanceIdentityConfigurationsIdentityConfigurationUpstConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private String vaultId;
        public Builder() {}
        public Builder(GetBdsInstanceIdentityConfigurationsIdentityConfigurationUpstConfiguration defaults) {
        ...
        public Builder keytabContent(String keytabContent) {
            if (keytabContent == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceIdentityConfigurationsIdentityConfigurationUpstConfiguration", "keytabContent");
            }
        ...
        public Builder masterEncryptionKeyId(String masterEncryptionKeyId) {
            if (masterEncryptionKeyId == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceIdentityConfigurationsIdentityConfigurationUpstConfiguration", "masterEncryptionKeyId");
            }
        ...
        public Builder secretId(String secretId) {
            if (secretId == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceIdentityConfigurationsIdentityConfigurationUpstConfiguration", "secretId");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceIdentityConfigurationsIdentityConfigurationUpstConfiguration", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceIdentityConfigurationsIdentityConfigurationUpstConfiguration", "timeCreated");
            }
        ...
        public Builder timeTokenExchangeKeytabLastRefreshed(String timeTokenExchangeKeytabLastRefreshed) {
            if (timeTokenExchangeKeytabLastRefreshed == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceIdentityConfigurationsIdentityConfigurationUpstConfiguration", "timeTokenExchangeKeytabLastRefreshed");
            }
        ...
        public Builder timeUpdated(String timeUpdated) {
            if (timeUpdated == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceIdentityConfigurationsIdentityConfigurationUpstConfiguration", "timeUpdated");
            }
        ...
        public Builder tokenExchangePrincipalName(String tokenExchangePrincipalName) {
            if (tokenExchangePrincipalName == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceIdentityConfigurationsIdentityConfigurationUpstConfiguration", "tokenExchangePrincipalName");
            }
        ...
        public Builder vaultId(String vaultId) {
            if (vaultId == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceIdentityConfigurationsIdentityConfigurationUpstConfiguration", "vaultId");
            }
            this.vaultId = vaultId;
            return this;
        }
        public GetBdsInstanceIdentityConfigurationsIdentityConfigurationUpstConfiguration build() {
            final var _resultValue = new GetBdsInstanceIdentityConfigurationsIdentityConfigurationUpstConfiguration();
