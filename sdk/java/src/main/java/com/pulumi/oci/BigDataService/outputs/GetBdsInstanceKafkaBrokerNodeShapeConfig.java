...
@CustomType
public final class GetBdsInstanceKafkaBrokerNodeShapeConfig {
    /**
    ...
    private GetBdsInstanceKafkaBrokerNodeShapeConfig() {}
    /**
     * @return The total amount of memory available to the node, in gigabytes.
     * 
     */
    ...
    public static Builder builder(GetBdsInstanceKafkaBrokerNodeShapeConfig defaults) {
    ...
    public static final class Builder {
        ...
        private Integer ocpus;
        public Builder() {}
        public Builder(GetBdsInstanceKafkaBrokerNodeShapeConfig defaults) {
        ...
        public Builder memoryInGbs(Integer memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceKafkaBrokerNodeShapeConfig", "memoryInGbs");
            }
        ...
        public Builder nvmes(Integer nvmes) {
            if (nvmes == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceKafkaBrokerNodeShapeConfig", "nvmes");
            }
            this.nvmes = nvmes;
            return this;
        }
        ...
        public Builder ocpus(Integer ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceKafkaBrokerNodeShapeConfig", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
