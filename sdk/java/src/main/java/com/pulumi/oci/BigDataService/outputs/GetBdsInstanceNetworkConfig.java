...
public final class GetBdsInstanceNetworkConfig {
    ...
    public static final class Builder {
        ...
        public Builder cidrBlock(String cidrBlock) {
            if (cidrBlock == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceNetworkConfig", "cidrBlock");
            }
        ...
        public Builder isNatGatewayRequired(Boolean isNatGatewayRequired) {
            if (isNatGatewayRequired == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceNetworkConfig", "isNatGatewayRequired");
            }
