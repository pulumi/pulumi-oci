...
@CustomType
public final class GetBdsInstanceNodeBackupResult {
    /**
    ...
    public static Builder builder(GetBdsInstanceNodeBackupResult defaults) {
    ...
    public static final class Builder {
        ...
        private String timeCreated;
        public Builder() {}
        public Builder(GetBdsInstanceNodeBackupResult defaults) {
    	      ...
    	      this.nodeBackupId = defaults.nodeBackupId;
        ...
        public Builder backupTriggerType(String backupTriggerType) {
            if (backupTriggerType == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceNodeBackupResult", "backupTriggerType");
            }
        ...
        public Builder backupType(String backupType) {
            if (backupType == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceNodeBackupResult", "backupType");
            }
        ...
        public Builder bdsInstanceId(String bdsInstanceId) {
            if (bdsInstanceId == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceNodeBackupResult", "bdsInstanceId");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceNodeBackupResult", "displayName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceNodeBackupResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder nodeBackupConfigId(String nodeBackupConfigId) {
            if (nodeBackupConfigId == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceNodeBackupResult", "nodeBackupConfigId");
            }
        ...
        public Builder nodeBackupId(String nodeBackupId) {
            if (nodeBackupId == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceNodeBackupResult", "nodeBackupId");
            }
        ...
        public Builder nodeHostName(String nodeHostName) {
            if (nodeHostName == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceNodeBackupResult", "nodeHostName");
            }
        ...
        public Builder nodeInstanceId(String nodeInstanceId) {
            if (nodeInstanceId == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceNodeBackupResult", "nodeInstanceId");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceNodeBackupResult", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceNodeBackupResult", "timeCreated");
            }
            this.timeCreated = timeCreated;
            return this;
        }
        public GetBdsInstanceNodeBackupResult build() {
            final var _resultValue = new GetBdsInstanceNodeBackupResult();
            ...
            _resultValue.nodeBackupId = nodeBackupId;
