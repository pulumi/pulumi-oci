    ...
    public static final class Builder {
        ...
        public Builder blockVolumeSizeInGbs(String blockVolumeSizeInGbs) {
            if (blockVolumeSizeInGbs == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceWorkerNode", "blockVolumeSizeInGbs");
            }
        ...
        public Builder numberOfNodes(Integer numberOfNodes) {
            if (numberOfNodes == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceWorkerNode", "numberOfNodes");
            }
        ...
        public Builder shape(String shape) {
            if (shape == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceWorkerNode", "shape");
            }
            this.shape = shape;
            return this;
        }
        ...
        public Builder shapeConfigs(List<GetBdsInstanceWorkerNodeShapeConfig> shapeConfigs) {
            if (shapeConfigs == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceWorkerNode", "shapeConfigs");
            }
        ...
        public Builder subnetId(String subnetId) {
            if (subnetId == null) {
              throw new MissingRequiredPropertyException("GetBdsInstanceWorkerNode", "subnetId");
            }
            this.subnetId = subnetId;
            return this;
        }
        public GetBdsInstanceWorkerNode build() {
            final var _resultValue = new GetBdsInstanceWorkerNode();
