...
@CustomType
public final class GetBdsInstancesBdsInstanceUtilNodeShapeConfig {
    /**
    ...
    public static final class Builder {
        ...
        public Builder memoryInGbs(Integer memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetBdsInstancesBdsInstanceUtilNodeShapeConfig", "memoryInGbs");
            }
        ...
        public Builder nvmes(Integer nvmes) {
            if (nvmes == null) {
              throw new MissingRequiredPropertyException("GetBdsInstancesBdsInstanceUtilNodeShapeConfig", "nvmes");
            }
            this.nvmes = nvmes;
            return this;
        }
        ...
        public Builder ocpus(Integer ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetBdsInstancesBdsInstanceUtilNodeShapeConfig", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
