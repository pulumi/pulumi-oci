...
@CustomType
public final class GetBlockchainPlatformComponentDetailOsnOcpuAllocationParam {
    /**
    ...
    public static final class Builder {
        ...
        public Builder ocpuAllocationNumber(Double ocpuAllocationNumber) {
            if (ocpuAllocationNumber == null) {
              throw new MissingRequiredPropertyException("GetBlockchainPlatformComponentDetailOsnOcpuAllocationParam", "ocpuAllocationNumber");
            }
            this.ocpuAllocationNumber = ocpuAllocationNumber;
            return this;
        }
        public GetBlockchainPlatformComponentDetailOsnOcpuAllocationParam build() {
            final var _resultValue = new GetBlockchainPlatformComponentDetailOsnOcpuAllocationParam();
