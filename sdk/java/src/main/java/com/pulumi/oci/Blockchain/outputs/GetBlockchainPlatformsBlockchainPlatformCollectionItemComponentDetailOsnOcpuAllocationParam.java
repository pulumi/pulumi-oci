    ...
    public static final class Builder {
        ...
        public Builder ocpuAllocationNumber(Double ocpuAllocationNumber) {
            if (ocpuAllocationNumber == null) {
              throw new MissingRequiredPropertyException("GetBlockchainPlatformsBlockchainPlatformCollectionItemComponentDetailOsnOcpuAllocationParam", "ocpuAllocationNumber");
            }
        ...
        public GetBlockchainPlatformsBlockchainPlatformCollectionItemComponentDetailOsnOcpuAllocationParam build() {
            final var _resultValue = new GetBlockchainPlatformsBlockchainPlatformCollectionItemComponentDetailOsnOcpuAllocationParam();
