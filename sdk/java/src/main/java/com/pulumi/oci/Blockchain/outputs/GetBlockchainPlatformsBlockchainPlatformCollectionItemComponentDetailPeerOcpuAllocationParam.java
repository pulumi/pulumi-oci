    ...
    public static final class Builder {
        ...
        public Builder ocpuAllocationNumber(Double ocpuAllocationNumber) {
            if (ocpuAllocationNumber == null) {
              throw new MissingRequiredPropertyException("GetBlockchainPlatformsBlockchainPlatformCollectionItemComponentDetailPeerOcpuAllocationParam", "ocpuAllocationNumber");
            }
        ...
        public GetBlockchainPlatformsBlockchainPlatformCollectionItemComponentDetailPeerOcpuAllocationParam build() {
            final var _resultValue = new GetBlockchainPlatformsBlockchainPlatformCollectionItemComponentDetailPeerOcpuAllocationParam();
