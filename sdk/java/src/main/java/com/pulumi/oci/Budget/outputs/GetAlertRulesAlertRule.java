...
public final class GetAlertRulesAlertRule {
    ...
    public static final class Builder {
        ...
        public Builder version(Integer version) {
            ...
            return new GetAlertRulesAlertRule(budgetId, definedTags, description, displayName, freeformTags, id, message, recipients, state, threshold, thresholdType, timeCreated, timeUpdated, type, version);
        }
    }
}
