...
public class OccAvailabilityCatalog extends com.pulumi.resources.CustomResource {
     ...
     */
    public OccAvailabilityCatalog(String name) {
     ...
     */
    public OccAvailabilityCatalog(String name, OccAvailabilityCatalogArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:CapacityManagement/occAvailabilityCatalog:OccAvailabilityCatalog", name, args == null ? OccAvailabilityCatalogArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private OccAvailabilityCatalog(String name, Output<String> id, @Nullable OccAvailabilityCatalogState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:CapacityManagement/occAvailabilityCatalog:OccAvailabilityCatalog", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static OccAvailabilityCatalog get(String name, Output<String> id, @Nullable OccAvailabilityCatalogState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
