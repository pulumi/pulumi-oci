...
public class OccCapacityRequest extends com.pulumi.resources.CustomResource {
     ...
     */
    public OccCapacityRequest(java.lang.String name) {
     ...
     */
    public OccCapacityRequest(java.lang.String name, OccCapacityRequestArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public OccCapacityRequest(java.lang.String name, OccCapacityRequestArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:CapacityManagement/occCapacityRequest:OccCapacityRequest", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private OccCapacityRequest(java.lang.String name, Output<java.lang.String> id, @Nullable OccCapacityRequestState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:CapacityManagement/occCapacityRequest:OccCapacityRequest", name, state, makeResourceOptions(options, id), false);
    }

    private static OccCapacityRequestArgs makeArgs(OccCapacityRequestArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? OccCapacityRequestArgs.Empty : args;
    }
     ...
     */
    public static OccCapacityRequest get(java.lang.String name, Output<java.lang.String> id, @Nullable OccCapacityRequestState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
