 ...
 *             .availabilityDomain(var_.occ_capacity_request_availability_domain())
 *             .compartmentId(var_.compartment_id())
 *             .dateExpectedCapacityHandover(var_.occ_capacity_request_date_expected_capacity_handover())
 *             .details(OccCapacityRequestDetailArgs.builder()
 *                 .demandQuantity(var_.occ_capacity_request_details_demand_quantity())
 *                 .resourceName(oci_usage_proxy_resource.test_resource().name())
 *                 .resourceType(var_.occ_capacity_request_details_resource_type())
 *                 .workloadType(var_.occ_capacity_request_details_workload_type())
 *                 .actualHandoverQuantity(var_.occ_capacity_request_details_actual_handover_quantity())
 *                 .dateActualHandover(var_.occ_capacity_request_details_date_actual_handover())
 *                 .dateExpectedHandover(var_.occ_capacity_request_details_date_expected_handover())
 *                 .expectedHandoverQuantity(var_.occ_capacity_request_details_expected_handover_quantity())
 *                 .build())
 ...
 *             .occCapacityRequestId(var_.occ_capacity_request_occ_capacity_request_id())
 *             .region(var_.occ_capacity_request_region())
 *             .definedTags(Map.of(&#34;foo-namespace.bar-key&#34;, &#34;value&#34;))
 *             .description(var_.occ_capacity_request_description())
 *             .freeformTags(Map.of(&#34;bar-key&#34;, &#34;value&#34;))
 *             .lifecycleDetails(var_.occ_capacity_request_lifecycle_details())
 *             .patchOperations(OccCapacityRequestPatchOperationArgs.builder()
 *                 .operation(var_.occ_capacity_request_patch_operations_operation())
 *                 .selection(var_.occ_capacity_request_patch_operations_selection())
 *                 .from(var_.occ_capacity_request_patch_operations_from())
 *                 .position(var_.occ_capacity_request_patch_operations_position())
 *                 .selectedItem(var_.occ_capacity_request_patch_operations_selected_item())
 *                 .value(var_.occ_capacity_request_patch_operations_value())
 *                 .values(var_.occ_capacity_request_patch_operations_values())
 *                 .build())
 *             .requestState(var_.occ_capacity_request_request_state())
 *             .build());
 * 
 *     }
 * }
