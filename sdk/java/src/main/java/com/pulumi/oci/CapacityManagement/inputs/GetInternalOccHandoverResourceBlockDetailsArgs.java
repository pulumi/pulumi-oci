...
import com.pulumi.oci.CapacityManagement.inputs.GetInternalOccHandoverResourceBlockDetailsFilterArgs;
...
public final class GetInternalOccHandoverResourceBlockDetailsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetInternalOccHandoverResourceBlockDetailsArgs Empty = new GetInternalOccHandoverResourceBlockDetailsArgs();

    @Import(name="filters")
    private @Nullable Output<List<GetInternalOccHandoverResourceBlockDetailsFilterArgs>> filters;

    public Optional<Output<List<GetInternalOccHandoverResourceBlockDetailsFilterArgs>>> filters() {
    ...
    private GetInternalOccHandoverResourceBlockDetailsArgs() {}

    private GetInternalOccHandoverResourceBlockDetailsArgs(GetInternalOccHandoverResourceBlockDetailsArgs $) {
    ...
    public static Builder builder(GetInternalOccHandoverResourceBlockDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetInternalOccHandoverResourceBlockDetailsArgs();
        }

        public Builder(GetInternalOccHandoverResourceBlockDetailsArgs defaults) {
            $ = new GetInternalOccHandoverResourceBlockDetailsArgs(Objects.requireNonNull(defaults));
        }

        public Builder filters(@Nullable Output<List<GetInternalOccHandoverResourceBlockDetailsFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetInternalOccHandoverResourceBlockDetailsFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetInternalOccHandoverResourceBlockDetailsFilterArgs... filters) {
        ...
        public GetInternalOccHandoverResourceBlockDetailsArgs build() {
            if ($.occHandoverResourceBlockId == null) {
                throw new MissingRequiredPropertyException("GetInternalOccHandoverResourceBlockDetailsArgs", "occHandoverResourceBlockId");
            }
            return $;
        }
    }
