...
import com.pulumi.oci.CapacityManagement.inputs.GetInternalOccHandoverResourceBlocksFilterArgs;
...
public final class GetInternalOccHandoverResourceBlocksArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetInternalOccHandoverResourceBlocksArgs Empty = new GetInternalOccHandoverResourceBlocksArgs();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetInternalOccHandoverResourceBlocksFilterArgs>> filters;

    public Optional<Output<List<GetInternalOccHandoverResourceBlocksFilterArgs>>> filters() {
    ...
    private GetInternalOccHandoverResourceBlocksArgs() {}

    private GetInternalOccHandoverResourceBlocksArgs(GetInternalOccHandoverResourceBlocksArgs $) {
    ...
    public static Builder builder(GetInternalOccHandoverResourceBlocksArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetInternalOccHandoverResourceBlocksArgs();
        }

        public Builder(GetInternalOccHandoverResourceBlocksArgs defaults) {
            $ = new GetInternalOccHandoverResourceBlocksArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetInternalOccHandoverResourceBlocksFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetInternalOccHandoverResourceBlocksFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetInternalOccHandoverResourceBlocksFilterArgs... filters) {
        ...
        public GetInternalOccHandoverResourceBlocksArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetInternalOccHandoverResourceBlocksArgs", "compartmentId");
            }
            if ($.namespace == null) {
                throw new MissingRequiredPropertyException("GetInternalOccHandoverResourceBlocksArgs", "namespace");
            }
            if ($.occCustomerGroupId == null) {
                throw new MissingRequiredPropertyException("GetInternalOccHandoverResourceBlocksArgs", "occCustomerGroupId");
            }
            return $;
        }
    }
