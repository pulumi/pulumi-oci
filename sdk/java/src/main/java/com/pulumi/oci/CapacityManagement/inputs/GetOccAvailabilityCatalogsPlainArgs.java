...
import com.pulumi.oci.CapacityManagement.inputs.GetOccAvailabilityCatalogsFilter;
...
public final class GetOccAvailabilityCatalogsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetOccAvailabilityCatalogsPlainArgs Empty = new GetOccAvailabilityCatalogsPlainArgs();
    ...
    public Optional<List<GetOccAvailabilityCatalogsFilter>> filters() {
    ...
    private GetOccAvailabilityCatalogsPlainArgs() {}

    private GetOccAvailabilityCatalogsPlainArgs(GetOccAvailabilityCatalogsPlainArgs $) {
    ...
    public static Builder builder(GetOccAvailabilityCatalogsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOccAvailabilityCatalogsPlainArgs();
        }

        public Builder(GetOccAvailabilityCatalogsPlainArgs defaults) {
            $ = new GetOccAvailabilityCatalogsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetOccAvailabilityCatalogsPlainArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetOccAvailabilityCatalogsPlainArgs", "compartmentId");
            }
            return $;
        }
    }
