...
import com.pulumi.oci.CapacityManagement.inputs.GetOccmDemandSignalsFilter;
...
public final class GetOccmDemandSignalsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetOccmDemandSignalsPlainArgs Empty = new GetOccmDemandSignalsPlainArgs();
    ...
    public Optional<List<GetOccmDemandSignalsFilter>> filters() {
    ...
    private GetOccmDemandSignalsPlainArgs() {}

    private GetOccmDemandSignalsPlainArgs(GetOccmDemandSignalsPlainArgs $) {
    ...
    public static Builder builder(GetOccmDemandSignalsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOccmDemandSignalsPlainArgs();
        }

        public Builder(GetOccmDemandSignalsPlainArgs defaults) {
            $ = new GetOccmDemandSignalsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetOccmDemandSignalsPlainArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetOccmDemandSignalsPlainArgs", "compartmentId");
            }
            return $;
        }
    }
