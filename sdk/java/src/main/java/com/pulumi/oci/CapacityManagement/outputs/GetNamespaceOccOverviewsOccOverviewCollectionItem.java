...
@CustomType
public final class GetNamespaceOccOverviewsOccOverviewCollectionItem {
    /**
    ...
    private GetNamespaceOccOverviewsOccOverviewCollectionItem() {}
    /**
     * @return A raw json blob containing all the capacity requests corresponding to the resource name
     * 
     */
    ...
    public static Builder builder(GetNamespaceOccOverviewsOccOverviewCollectionItem defaults) {
    ...
    public static final class Builder {
        ...
        private String workloadTypeBreakdownBlob;
        public Builder() {}
        public Builder(GetNamespaceOccOverviewsOccOverviewCollectionItem defaults) {
        ...
        public Builder capacityRequestsBlob(String capacityRequestsBlob) {
            if (capacityRequestsBlob == null) {
              throw new MissingRequiredPropertyException("GetNamespaceOccOverviewsOccOverviewCollectionItem", "capacityRequestsBlob");
            }
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetNamespaceOccOverviewsOccOverviewCollectionItem", "compartmentId");
            }
        ...
        public Builder periodValue(String periodValue) {
            if (periodValue == null) {
              throw new MissingRequiredPropertyException("GetNamespaceOccOverviewsOccOverviewCollectionItem", "periodValue");
            }
        ...
        public Builder resourceName(String resourceName) {
            if (resourceName == null) {
              throw new MissingRequiredPropertyException("GetNamespaceOccOverviewsOccOverviewCollectionItem", "resourceName");
            }
        ...
        public Builder totalAvailable(String totalAvailable) {
            if (totalAvailable == null) {
              throw new MissingRequiredPropertyException("GetNamespaceOccOverviewsOccOverviewCollectionItem", "totalAvailable");
            }
        ...
        public Builder totalCancelled(String totalCancelled) {
            if (totalCancelled == null) {
              throw new MissingRequiredPropertyException("GetNamespaceOccOverviewsOccOverviewCollectionItem", "totalCancelled");
            }
        ...
        public Builder totalDemanded(String totalDemanded) {
            if (totalDemanded == null) {
              throw new MissingRequiredPropertyException("GetNamespaceOccOverviewsOccOverviewCollectionItem", "totalDemanded");
            }
        ...
        public Builder totalRejected(String totalRejected) {
            if (totalRejected == null) {
              throw new MissingRequiredPropertyException("GetNamespaceOccOverviewsOccOverviewCollectionItem", "totalRejected");
            }
        ...
        public Builder totalSupplied(String totalSupplied) {
            if (totalSupplied == null) {
              throw new MissingRequiredPropertyException("GetNamespaceOccOverviewsOccOverviewCollectionItem", "totalSupplied");
            }
        ...
        public Builder totalUnfulfilled(String totalUnfulfilled) {
            if (totalUnfulfilled == null) {
              throw new MissingRequiredPropertyException("GetNamespaceOccOverviewsOccOverviewCollectionItem", "totalUnfulfilled");
            }
        ...
        public Builder unit(String unit) {
            if (unit == null) {
              throw new MissingRequiredPropertyException("GetNamespaceOccOverviewsOccOverviewCollectionItem", "unit");
            }
            this.unit = unit;
            return this;
        }
        ...
        public Builder workloadTypeBreakdownBlob(String workloadTypeBreakdownBlob) {
            if (workloadTypeBreakdownBlob == null) {
              throw new MissingRequiredPropertyException("GetNamespaceOccOverviewsOccOverviewCollectionItem", "workloadTypeBreakdownBlob");
            }
            this.workloadTypeBreakdownBlob = workloadTypeBreakdownBlob;
            return this;
        }
        public GetNamespaceOccOverviewsOccOverviewCollectionItem build() {
            final var _resultValue = new GetNamespaceOccOverviewsOccOverviewCollectionItem();
