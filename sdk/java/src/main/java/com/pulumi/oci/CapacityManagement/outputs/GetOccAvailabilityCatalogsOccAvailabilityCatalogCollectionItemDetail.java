...
public final class GetOccAvailabilityCatalogsOccAvailabilityCatalogCollectionItemDetail {
    ...
    public static Builder builder(GetOccAvailabilityCatalogsOccAvailabilityCatalogCollectionItemDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String workloadType;
        public Builder() {}
        public Builder(GetOccAvailabilityCatalogsOccAvailabilityCatalogCollectionItemDetail defaults) {
        ...
        public Builder availableQuantity(String availableQuantity) {
            if (availableQuantity == null) {
              throw new MissingRequiredPropertyException("GetOccAvailabilityCatalogsOccAvailabilityCatalogCollectionItemDetail", "availableQuantity");
            }
        ...
        public Builder catalogId(String catalogId) {
            if (catalogId == null) {
              throw new MissingRequiredPropertyException("GetOccAvailabilityCatalogsOccAvailabilityCatalogCollectionItemDetail", "catalogId");
            }
        ...
        public Builder dateExpectedCapacityHandover(String dateExpectedCapacityHandover) {
            if (dateExpectedCapacityHandover == null) {
              throw new MissingRequiredPropertyException("GetOccAvailabilityCatalogsOccAvailabilityCatalogCollectionItemDetail", "dateExpectedCapacityHandover");
            }
        ...
        public Builder dateFinalCustomerOrder(String dateFinalCustomerOrder) {
            if (dateFinalCustomerOrder == null) {
              throw new MissingRequiredPropertyException("GetOccAvailabilityCatalogsOccAvailabilityCatalogCollectionItemDetail", "dateFinalCustomerOrder");
            }
        ...
        public Builder resourceName(String resourceName) {
            if (resourceName == null) {
              throw new MissingRequiredPropertyException("GetOccAvailabilityCatalogsOccAvailabilityCatalogCollectionItemDetail", "resourceName");
            }
        ...
        public Builder resourceType(String resourceType) {
            if (resourceType == null) {
              throw new MissingRequiredPropertyException("GetOccAvailabilityCatalogsOccAvailabilityCatalogCollectionItemDetail", "resourceType");
            }
        ...
        public Builder workloadType(String workloadType) {
            if (workloadType == null) {
              throw new MissingRequiredPropertyException("GetOccAvailabilityCatalogsOccAvailabilityCatalogCollectionItemDetail", "workloadType");
            }
            this.workloadType = workloadType;
            return this;
        }
        public GetOccAvailabilityCatalogsOccAvailabilityCatalogCollectionItemDetail build() {
            final var _resultValue = new GetOccAvailabilityCatalogsOccAvailabilityCatalogCollectionItemDetail();
