...
public final class CertificateAuthorityCurrentVersionRevocationStatusArgs extends com.pulumi.resources.ResourceArgs {

    public static final CertificateAuthorityCurrentVersionRevocationStatusArgs Empty = new CertificateAuthorityCurrentVersionRevocationStatusArgs();
    ...
    private CertificateAuthorityCurrentVersionRevocationStatusArgs() {}

    private CertificateAuthorityCurrentVersionRevocationStatusArgs(CertificateAuthorityCurrentVersionRevocationStatusArgs $) {
    ...
    public static Builder builder(CertificateAuthorityCurrentVersionRevocationStatusArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CertificateAuthorityCurrentVersionRevocationStatusArgs();
        }

        public Builder(CertificateAuthorityCurrentVersionRevocationStatusArgs defaults) {
            $ = new CertificateAuthorityCurrentVersionRevocationStatusArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CertificateAuthorityCurrentVersionRevocationStatusArgs build() {
            return $;
        }
    }
