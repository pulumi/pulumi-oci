...
public final class CertificateCurrentVersionValidityArgs extends com.pulumi.resources.ResourceArgs {

    public static final CertificateCurrentVersionValidityArgs Empty = new CertificateCurrentVersionValidityArgs();
    ...
    private CertificateCurrentVersionValidityArgs() {}

    private CertificateCurrentVersionValidityArgs(CertificateCurrentVersionValidityArgs $) {
    ...
    public static Builder builder(CertificateCurrentVersionValidityArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CertificateCurrentVersionValidityArgs();
        }

        public Builder(CertificateCurrentVersionValidityArgs defaults) {
            $ = new CertificateCurrentVersionValidityArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CertificateCurrentVersionValidityArgs build() {
            return $;
        }
    }
