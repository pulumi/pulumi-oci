...
public final class CertificateCertificateConfigSubjectAlternativeName {
    ...
    public static final class Builder {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("CertificateCertificateConfigSubjectAlternativeName", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("CertificateCertificateConfigSubjectAlternativeName", "value");
            }
            this.value = value;
            return this;
        }
        public CertificateCertificateConfigSubjectAlternativeName build() {
            final var _resultValue = new CertificateCertificateConfigSubjectAlternativeName();
