    ...
    public static final class Builder {
        ...
        public Builder timeOfValidityNotAfter(String timeOfValidityNotAfter) {
            if (timeOfValidityNotAfter == null) {
              throw new MissingRequiredPropertyException("CertificateCertificateConfigValidity", "timeOfValidityNotAfter");
            }
        ...
        public CertificateCertificateConfigValidity build() {
            final var _resultValue = new CertificateCertificateConfigValidity();
