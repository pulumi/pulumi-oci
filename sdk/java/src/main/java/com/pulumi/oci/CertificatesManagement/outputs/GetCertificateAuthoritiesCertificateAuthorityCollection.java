...
public final class GetCertificateAuthoritiesCertificateAuthorityCollection {
    private @Nullable List<GetCertificateAuthoritiesCertificateAuthorityCollectionItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetCertificateAuthoritiesCertificateAuthorityCollectionItem> items) {
            this.items = items;
            return this;
        }
