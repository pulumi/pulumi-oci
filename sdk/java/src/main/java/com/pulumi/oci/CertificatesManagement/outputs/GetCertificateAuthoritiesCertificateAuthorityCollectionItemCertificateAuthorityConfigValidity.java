    ...
    public static final class Builder {
        ...
        public Builder timeOfValidityNotAfter(String timeOfValidityNotAfter) {
            if (timeOfValidityNotAfter == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthoritiesCertificateAuthorityCollectionItemCertificateAuthorityConfigValidity", "timeOfValidityNotAfter");
            }
        ...
        public Builder timeOfValidityNotBefore(String timeOfValidityNotBefore) {
            if (timeOfValidityNotBefore == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthoritiesCertificateAuthorityCollectionItemCertificateAuthorityConfigValidity", "timeOfValidityNotBefore");
            }
        ...
        public GetCertificateAuthoritiesCertificateAuthorityCollectionItemCertificateAuthorityConfigValidity build() {
            final var _resultValue = new GetCertificateAuthoritiesCertificateAuthorityCollectionItemCertificateAuthorityConfigValidity();
