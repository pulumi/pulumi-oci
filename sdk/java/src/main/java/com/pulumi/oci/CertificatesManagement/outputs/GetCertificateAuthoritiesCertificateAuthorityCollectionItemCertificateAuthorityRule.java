...
public final class GetCertificateAuthoritiesCertificateAuthorityCollectionItemCertificateAuthorityRule {
    ...
    public static Builder builder(GetCertificateAuthoritiesCertificateAuthorityCollectionItemCertificateAuthorityRule defaults) {
    ...
    public static final class Builder {
        ...
        public Builder certificateAuthorityMaxValidityDuration(String certificateAuthorityMaxValidityDuration) {
            if (certificateAuthorityMaxValidityDuration == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthoritiesCertificateAuthorityCollectionItemCertificateAuthorityRule", "certificateAuthorityMaxValidityDuration");
            }
        ...
        public Builder leafCertificateMaxValidityDuration(String leafCertificateMaxValidityDuration) {
            if (leafCertificateMaxValidityDuration == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthoritiesCertificateAuthorityCollectionItemCertificateAuthorityRule", "leafCertificateMaxValidityDuration");
            }
