    ...
    public static final class Builder {
        ...
        public Builder timeOfValidityNotAfter(String timeOfValidityNotAfter) {
            if (timeOfValidityNotAfter == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthoritiesCertificateAuthorityCollectionItemCurrentVersionValidity", "timeOfValidityNotAfter");
            }
        ...
        public Builder timeOfValidityNotBefore(String timeOfValidityNotBefore) {
            if (timeOfValidityNotBefore == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthoritiesCertificateAuthorityCollectionItemCurrentVersionValidity", "timeOfValidityNotBefore");
            }
        ...
        public GetCertificateAuthoritiesCertificateAuthorityCollectionItemCurrentVersionValidity build() {
            final var _resultValue = new GetCertificateAuthoritiesCertificateAuthorityCollectionItemCurrentVersionValidity();
