    ...
    public static final class Builder {
        ...
        public Builder timeOfValidityNotAfter(String timeOfValidityNotAfter) {
            if (timeOfValidityNotAfter == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityCertificateAuthorityConfigValidity", "timeOfValidityNotAfter");
            }
        ...
        public Builder timeOfValidityNotBefore(String timeOfValidityNotBefore) {
            if (timeOfValidityNotBefore == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityCertificateAuthorityConfigValidity", "timeOfValidityNotBefore");
            }
        ...
        public GetCertificateAuthorityCertificateAuthorityConfigValidity build() {
            final var _resultValue = new GetCertificateAuthorityCertificateAuthorityConfigValidity();
