    ...
    public static final class Builder {
        ...
        public Builder objectStorageBucketName(String objectStorageBucketName) {
            if (objectStorageBucketName == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityCertificateRevocationListDetailObjectStorageConfig", "objectStorageBucketName");
            }
        ...
        public Builder objectStorageNamespace(String objectStorageNamespace) {
            if (objectStorageNamespace == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityCertificateRevocationListDetailObjectStorageConfig", "objectStorageNamespace");
            }
        ...
        public Builder objectStorageObjectNameFormat(String objectStorageObjectNameFormat) {
            if (objectStorageObjectNameFormat == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityCertificateRevocationListDetailObjectStorageConfig", "objectStorageObjectNameFormat");
            }
