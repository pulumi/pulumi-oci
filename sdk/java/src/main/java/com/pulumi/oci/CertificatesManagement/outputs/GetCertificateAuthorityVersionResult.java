    ...
    public static final class Builder {
        ...
        public Builder certificateAuthorityId(String certificateAuthorityId) {
            if (certificateAuthorityId == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityVersionResult", "certificateAuthorityId");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityVersionResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder issuerCaVersionNumber(String issuerCaVersionNumber) {
            if (issuerCaVersionNumber == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityVersionResult", "issuerCaVersionNumber");
            }
        ...
        public Builder revocationStatuses(List<GetCertificateAuthorityVersionRevocationStatus> revocationStatuses) {
            if (revocationStatuses == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityVersionResult", "revocationStatuses");
            }
        ...
        public Builder serialNumber(String serialNumber) {
            if (serialNumber == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityVersionResult", "serialNumber");
            }
        ...
        public Builder stages(List<String> stages) {
            if (stages == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityVersionResult", "stages");
            }
            this.stages = stages;
            return this;
        }
        ...
        public Builder subjectAlternativeNames(List<GetCertificateAuthorityVersionSubjectAlternativeName> subjectAlternativeNames) {
            if (subjectAlternativeNames == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityVersionResult", "subjectAlternativeNames");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityVersionResult", "timeCreated");
            }
        ...
        public Builder timeOfDeletion(String timeOfDeletion) {
            if (timeOfDeletion == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityVersionResult", "timeOfDeletion");
            }
        ...
        public Builder validities(List<GetCertificateAuthorityVersionValidity> validities) {
            if (validities == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityVersionResult", "validities");
            }
        ...
        public Builder versionName(String versionName) {
            if (versionName == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityVersionResult", "versionName");
            }
        ...
        public Builder versionNumber(String versionNumber) {
            if (versionNumber == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityVersionResult", "versionNumber");
            }
