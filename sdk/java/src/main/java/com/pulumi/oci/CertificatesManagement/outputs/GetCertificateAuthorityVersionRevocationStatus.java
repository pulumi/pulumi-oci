    ...
    public static final class Builder {
        ...
        public Builder revocationReason(String revocationReason) {
            if (revocationReason == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityVersionRevocationStatus", "revocationReason");
            }
        ...
        public Builder timeOfRevocation(String timeOfRevocation) {
            if (timeOfRevocation == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityVersionRevocationStatus", "timeOfRevocation");
            }
