...
public final class GetCertificateAuthorityVersionSubjectAlternativeName {
    ...
    public static final class Builder {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityVersionSubjectAlternativeName", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityVersionSubjectAlternativeName", "value");
            }
            this.value = value;
            return this;
        }
