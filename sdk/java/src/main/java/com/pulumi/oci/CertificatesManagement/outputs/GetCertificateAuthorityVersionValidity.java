    ...
    public static final class Builder {
        ...
        public Builder timeOfValidityNotAfter(String timeOfValidityNotAfter) {
            if (timeOfValidityNotAfter == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityVersionValidity", "timeOfValidityNotAfter");
            }
        ...
        public Builder timeOfValidityNotBefore(String timeOfValidityNotBefore) {
            if (timeOfValidityNotBefore == null) {
              throw new MissingRequiredPropertyException("GetCertificateAuthorityVersionValidity", "timeOfValidityNotBefore");
            }
            this.timeOfValidityNotBefore = timeOfValidityNotBefore;
            return this;
        }
        public GetCertificateAuthorityVersionValidity build() {
            final var _resultValue = new GetCertificateAuthorityVersionValidity();
