    ...
    public static final class Builder {
        ...
        public Builder timeOfValidityNotAfter(String timeOfValidityNotAfter) {
            if (timeOfValidityNotAfter == null) {
              throw new MissingRequiredPropertyException("GetCertificateCertificateConfigValidity", "timeOfValidityNotAfter");
            }
        ...
        public Builder timeOfValidityNotBefore(String timeOfValidityNotBefore) {
            if (timeOfValidityNotBefore == null) {
              throw new MissingRequiredPropertyException("GetCertificateCertificateConfigValidity", "timeOfValidityNotBefore");
            }
            this.timeOfValidityNotBefore = timeOfValidityNotBefore;
            return this;
        }
        public GetCertificateCertificateConfigValidity build() {
            final var _resultValue = new GetCertificateCertificateConfigValidity();
