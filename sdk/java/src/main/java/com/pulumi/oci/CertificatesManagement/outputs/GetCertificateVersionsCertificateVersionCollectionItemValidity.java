    ...
    public static final class Builder {
        ...
        public Builder timeOfValidityNotAfter(String timeOfValidityNotAfter) {
            if (timeOfValidityNotAfter == null) {
              throw new MissingRequiredPropertyException("GetCertificateVersionsCertificateVersionCollectionItemValidity", "timeOfValidityNotAfter");
            }
        ...
        public Builder timeOfValidityNotBefore(String timeOfValidityNotBefore) {
            if (timeOfValidityNotBefore == null) {
              throw new MissingRequiredPropertyException("GetCertificateVersionsCertificateVersionCollectionItemValidity", "timeOfValidityNotBefore");
            }
        ...
        public GetCertificateVersionsCertificateVersionCollectionItemValidity build() {
            final var _resultValue = new GetCertificateVersionsCertificateVersionCollectionItemValidity();
