...
public final class GetCertificatesCertificateCollectionItemCertificateConfigSubjectAlternativeName {
    ...
    public static final class Builder {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetCertificatesCertificateCollectionItemCertificateConfigSubjectAlternativeName", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetCertificatesCertificateCollectionItemCertificateConfigSubjectAlternativeName", "value");
            }
            this.value = value;
            return this;
        }
        public GetCertificatesCertificateCollectionItemCertificateConfigSubjectAlternativeName build() {
            final var _resultValue = new GetCertificatesCertificateCollectionItemCertificateConfigSubjectAlternativeName();
