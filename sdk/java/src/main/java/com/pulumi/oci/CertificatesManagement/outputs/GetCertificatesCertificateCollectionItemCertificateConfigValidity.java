    ...
    public static final class Builder {
        ...
        public Builder timeOfValidityNotAfter(String timeOfValidityNotAfter) {
            if (timeOfValidityNotAfter == null) {
              throw new MissingRequiredPropertyException("GetCertificatesCertificateCollectionItemCertificateConfigValidity", "timeOfValidityNotAfter");
            }
        ...
        public Builder timeOfValidityNotBefore(String timeOfValidityNotBefore) {
            if (timeOfValidityNotBefore == null) {
              throw new MissingRequiredPropertyException("GetCertificatesCertificateCollectionItemCertificateConfigValidity", "timeOfValidityNotBefore");
            }
        ...
        public GetCertificatesCertificateCollectionItemCertificateConfigValidity build() {
            final var _resultValue = new GetCertificatesCertificateCollectionItemCertificateConfigValidity();
