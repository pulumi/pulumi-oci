...
@CustomType
public final class GetCertificatesCertificateCollectionItemCurrentVersionRevocationStatus {
    /**
    ...
    public static final class Builder {
        ...
        public Builder revocationReason(String revocationReason) {
            if (revocationReason == null) {
              throw new MissingRequiredPropertyException("GetCertificatesCertificateCollectionItemCurrentVersionRevocationStatus", "revocationReason");
            }
        ...
        public Builder timeOfRevocation(String timeOfRevocation) {
            if (timeOfRevocation == null) {
              throw new MissingRequiredPropertyException("GetCertificatesCertificateCollectionItemCurrentVersionRevocationStatus", "timeOfRevocation");
            }
        ...
        public GetCertificatesCertificateCollectionItemCurrentVersionRevocationStatus build() {
            final var _resultValue = new GetCertificatesCertificateCollectionItemCurrentVersionRevocationStatus();
