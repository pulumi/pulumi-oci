...
@CustomType
public final class AssetComputeScsiController {
    /**
    ...
    public static Builder builder(AssetComputeScsiController defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer unitNumber;
        public Builder() {}
        public Builder(AssetComputeScsiController defaults) {
        ...
        public AssetComputeScsiController build() {
            final var _resultValue = new AssetComputeScsiController();
