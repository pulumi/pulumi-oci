...
public final class GetAssetComputeScsiController {
    ...
    public static Builder builder(GetAssetComputeScsiController defaults) {
    ...
    public static final class Builder {
        ...
        public Builder label(String label) {
            if (label == null) {
              throw new MissingRequiredPropertyException("GetAssetComputeScsiController", "label");
            }
            this.label = label;
            return this;
        }
        ...
        public Builder sharedBus(String sharedBus) {
            if (sharedBus == null) {
              throw new MissingRequiredPropertyException("GetAssetComputeScsiController", "sharedBus");
            }
        ...
        public Builder unitNumber(Integer unitNumber) {
            if (unitNumber == null) {
              throw new MissingRequiredPropertyException("GetAssetComputeScsiController", "unitNumber");
            }
