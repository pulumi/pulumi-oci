...
public final class GetAssetVmwareVcenter {
    ...
    public static final class Builder {
        ...
        public Builder dataCenter(String dataCenter) {
            if (dataCenter == null) {
              throw new MissingRequiredPropertyException("GetAssetVmwareVcenter", "dataCenter");
            }
        ...
        public Builder vcenterKey(String vcenterKey) {
            if (vcenterKey == null) {
              throw new MissingRequiredPropertyException("GetAssetVmwareVcenter", "vcenterKey");
            }
        ...
        public Builder vcenterVersion(String vcenterVersion) {
            if (vcenterVersion == null) {
              throw new MissingRequiredPropertyException("GetAssetVmwareVcenter", "vcenterVersion");
            }
