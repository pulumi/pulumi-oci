...
public final class GetDiscoverySchedulesDiscoveryScheduleCollection {
    private @Nullable List<GetDiscoverySchedulesDiscoveryScheduleCollectionItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetDiscoverySchedulesDiscoveryScheduleCollectionItem> items) {
            this.items = items;
            return this;
        }
