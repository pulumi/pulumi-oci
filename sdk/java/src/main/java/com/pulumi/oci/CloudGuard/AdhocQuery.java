...
public class AdhocQuery extends com.pulumi.resources.CustomResource {
     ...
     */
    public AdhocQuery(String name, AdhocQueryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:CloudGuard/adhocQuery:AdhocQuery", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private AdhocQuery(String name, Output<String> id, @Nullable AdhocQueryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:CloudGuard/adhocQuery:AdhocQuery", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static AdhocQuery get(String name, Output<String> id, @Nullable AdhocQueryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
