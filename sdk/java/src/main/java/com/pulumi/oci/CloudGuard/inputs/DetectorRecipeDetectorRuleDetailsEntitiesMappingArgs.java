...
public final class DetectorRecipeDetectorRuleDetailsEntitiesMappingArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="queryField", required=true)
    private Output<String> queryField;

    /**
     * @return (Updatable) The entity value mapped to a data source query
     * 
     */
    public Output<String> queryField() {
        return this.queryField;
    }

    private DetectorRecipeDetectorRuleDetailsEntitiesMappingArgs() {}

    private DetectorRecipeDetectorRuleDetailsEntitiesMappingArgs(DetectorRecipeDetectorRuleDetailsEntitiesMappingArgs $) {
    ...
    public static Builder builder(DetectorRecipeDetectorRuleDetailsEntitiesMappingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DetectorRecipeDetectorRuleDetailsEntitiesMappingArgs();
        }

        public Builder(DetectorRecipeDetectorRuleDetailsEntitiesMappingArgs defaults) {
            $ = new DetectorRecipeDetectorRuleDetailsEntitiesMappingArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder queryField(Output<String> queryField) {
