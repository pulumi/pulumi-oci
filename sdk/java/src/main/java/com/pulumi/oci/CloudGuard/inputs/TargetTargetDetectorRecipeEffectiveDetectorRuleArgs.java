...
import com.pulumi.oci.CloudGuard.inputs.TargetTargetDetectorRecipeEffectiveDetectorRuleDetailArgs;
import com.pulumi.oci.CloudGuard.inputs.TargetTargetDetectorRecipeEffectiveDetectorRuleEntitiesMappingArgs;
import com.pulumi.oci.CloudGuard.inputs.TargetTargetDetectorRecipeEffectiveDetectorRuleRuleTypeArgs;
...
public final class TargetTargetDetectorRecipeEffectiveDetectorRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<TargetTargetDetectorRecipeEffectiveDetectorRuleRuleTypeArgs>> ruleTypes;

    /**
     * @return Rule category type
     * 
     */
    public Optional<Output<List<TargetTargetDetectorRecipeEffectiveDetectorRuleRuleTypeArgs>>> ruleTypes() {
    ...
    private TargetTargetDetectorRecipeEffectiveDetectorRuleArgs() {}

    private TargetTargetDetectorRecipeEffectiveDetectorRuleArgs(TargetTargetDetectorRecipeEffectiveDetectorRuleArgs $) {
    ...
    public static Builder builder(TargetTargetDetectorRecipeEffectiveDetectorRuleArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TargetTargetDetectorRecipeEffectiveDetectorRuleArgs();
        }

        public Builder(TargetTargetDetectorRecipeEffectiveDetectorRuleArgs defaults) {
            $ = new TargetTargetDetectorRecipeEffectiveDetectorRuleArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder details(@Nullable Output<List<TargetTargetDetectorRecipeEffectiveDetectorRuleDetailArgs>> details) {
            $.details = details;
            return this;
        }
         ...
         * 
         */
        public Builder details(List<TargetTargetDetectorRecipeEffectiveDetectorRuleDetailArgs> details) {
         ...
         * 
         */
        public Builder details(TargetTargetDetectorRecipeEffectiveDetectorRuleDetailArgs... details) {
         ...
         * 
         */
        public Builder entitiesMappings(@Nullable Output<List<TargetTargetDetectorRecipeEffectiveDetectorRuleEntitiesMappingArgs>> entitiesMappings) {
         ...
         * 
         */
        public Builder entitiesMappings(List<TargetTargetDetectorRecipeEffectiveDetectorRuleEntitiesMappingArgs> entitiesMappings) {
         ...
         * 
         */
        public Builder entitiesMappings(TargetTargetDetectorRecipeEffectiveDetectorRuleEntitiesMappingArgs... entitiesMappings) {
        ...
        /**
         * @param ruleTypes Rule category type
         * 
         * @return builder
         * 
         */
        public Builder ruleTypes(@Nullable Output<List<TargetTargetDetectorRecipeEffectiveDetectorRuleRuleTypeArgs>> ruleTypes) {
            $.ruleTypes = ruleTypes;
            return this;
        }
         ...
         * 
         */
        public Builder ruleTypes(List<TargetTargetDetectorRecipeEffectiveDetectorRuleRuleTypeArgs> ruleTypes) {
         ...
         * 
         */
        public Builder ruleTypes(TargetTargetDetectorRecipeEffectiveDetectorRuleRuleTypeArgs... ruleTypes) {
        ...
        public TargetTargetDetectorRecipeEffectiveDetectorRuleArgs build() {
            return $;
        }
    }
