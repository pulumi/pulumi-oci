...
@CustomType
public final class DetectorRecipeDetectorRuleEntitiesMapping {
    /**
    ...
    public static Builder builder(DetectorRecipeDetectorRuleEntitiesMapping defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String queryField;
        public Builder() {}
        public Builder(DetectorRecipeDetectorRuleEntitiesMapping defaults) {
        ...
        public DetectorRecipeDetectorRuleEntitiesMapping build() {
            final var _resultValue = new DetectorRecipeDetectorRuleEntitiesMapping();
