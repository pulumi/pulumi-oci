...
@CustomType
public final class GetAdhocQueryAdhocQueryRegionalDetail {
    /**
    ...
    private GetAdhocQueryAdhocQueryRegionalDetail() {}
    /**
     * @return Expected number of instances on which query should run
     * 
     */
    ...
    public static Builder builder(GetAdhocQueryAdhocQueryRegionalDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String succeededCount;
        public Builder() {}
        public Builder(GetAdhocQueryAdhocQueryRegionalDetail defaults) {
        ...
        public Builder expectedCount(String expectedCount) {
            if (expectedCount == null) {
              throw new MissingRequiredPropertyException("GetAdhocQueryAdhocQueryRegionalDetail", "expectedCount");
            }
        ...
        public Builder expiredCount(String expiredCount) {
            if (expiredCount == null) {
              throw new MissingRequiredPropertyException("GetAdhocQueryAdhocQueryRegionalDetail", "expiredCount");
            }
        ...
        public Builder failedCount(String failedCount) {
            if (failedCount == null) {
              throw new MissingRequiredPropertyException("GetAdhocQueryAdhocQueryRegionalDetail", "failedCount");
            }
        ...
        public Builder region(String region) {
            if (region == null) {
              throw new MissingRequiredPropertyException("GetAdhocQueryAdhocQueryRegionalDetail", "region");
            }
            this.region = region;
            return this;
        }
        ...
        public Builder regionalError(String regionalError) {
            if (regionalError == null) {
              throw new MissingRequiredPropertyException("GetAdhocQueryAdhocQueryRegionalDetail", "regionalError");
            }
        ...
        public Builder regionalStatus(String regionalStatus) {
            if (regionalStatus == null) {
              throw new MissingRequiredPropertyException("GetAdhocQueryAdhocQueryRegionalDetail", "regionalStatus");
            }
        ...
        public Builder succeededCount(String succeededCount) {
            if (succeededCount == null) {
              throw new MissingRequiredPropertyException("GetAdhocQueryAdhocQueryRegionalDetail", "succeededCount");
            }
            this.succeededCount = succeededCount;
            return this;
        }
        public GetAdhocQueryAdhocQueryRegionalDetail build() {
            final var _resultValue = new GetAdhocQueryAdhocQueryRegionalDetail();
