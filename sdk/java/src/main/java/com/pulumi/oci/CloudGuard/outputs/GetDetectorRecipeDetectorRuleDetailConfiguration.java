...
public final class GetDetectorRecipeDetectorRuleDetailConfiguration {
     ...
     * 
     */
    private @Nullable List<GetDetectorRecipeDetectorRuleDetailConfigurationValue> values;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder values(@Nullable List<GetDetectorRecipeDetectorRuleDetailConfigurationValue> values) {
            this.values = values;
            return this;
        }
