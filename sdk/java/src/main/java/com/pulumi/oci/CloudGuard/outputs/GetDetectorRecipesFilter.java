...
public final class GetDetectorRecipesFilter {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetDetectorRecipesFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetDetectorRecipesFilter", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetDetectorRecipesFilter build() {
            final var _resultValue = new GetDetectorRecipesFilter();
