...
public final class GetGuardTargetTargetDetectorRecipeDetectorRuleEntitiesMapping {
    ...
    public static final class Builder {
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetGuardTargetTargetDetectorRecipeDetectorRuleEntitiesMapping", "displayName");
            }
        ...
        public Builder entityType(String entityType) {
            if (entityType == null) {
              throw new MissingRequiredPropertyException("GetGuardTargetTargetDetectorRecipeDetectorRuleEntitiesMapping", "entityType");
            }
        ...
        public Builder queryField(String queryField) {
            if (queryField == null) {
              throw new MissingRequiredPropertyException("GetGuardTargetTargetDetectorRecipeDetectorRuleEntitiesMapping", "queryField");
            }
            this.queryField = queryField;
            return this;
        }
        public GetGuardTargetTargetDetectorRecipeDetectorRuleEntitiesMapping build() {
            final var _resultValue = new GetGuardTargetTargetDetectorRecipeDetectorRuleEntitiesMapping();
