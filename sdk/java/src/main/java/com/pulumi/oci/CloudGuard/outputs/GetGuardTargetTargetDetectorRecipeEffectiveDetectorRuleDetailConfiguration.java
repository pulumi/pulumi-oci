...
public final class GetGuardTargetTargetDetectorRecipeEffectiveDetectorRuleDetailConfiguration {
     ...
     * 
     */
    private @Nullable List<GetGuardTargetTargetDetectorRecipeEffectiveDetectorRuleDetailConfigurationValue> values;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder values(@Nullable List<GetGuardTargetTargetDetectorRecipeEffectiveDetectorRuleDetailConfigurationValue> values) {
            this.values = values;
            return this;
        }
        ...
        public GetGuardTargetTargetDetectorRecipeEffectiveDetectorRuleDetailConfiguration build() {
            final var o = new GetGuardTargetTargetDetectorRecipeEffectiveDetectorRuleDetailConfiguration();
