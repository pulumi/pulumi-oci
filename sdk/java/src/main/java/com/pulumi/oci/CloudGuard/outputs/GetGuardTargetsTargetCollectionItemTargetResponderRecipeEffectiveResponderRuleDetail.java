...
public final class GetGuardTargetsTargetCollectionItemTargetResponderRecipeEffectiveResponderRuleDetail {
    ...
    public static final class Builder {
        ...
        public Builder condition(String condition) {
            if (condition == null) {
              throw new MissingRequiredPropertyException("GetGuardTargetsTargetCollectionItemTargetResponderRecipeEffectiveResponderRuleDetail", "condition");
            }
        ...
        public Builder configurations(List<GetGuardTargetsTargetCollectionItemTargetResponderRecipeEffectiveResponderRuleDetailConfiguration> configurations) {
            if (configurations == null) {
              throw new MissingRequiredPropertyException("GetGuardTargetsTargetCollectionItemTargetResponderRecipeEffectiveResponderRuleDetail", "configurations");
            }
        ...
        public Builder isEnabled(Boolean isEnabled) {
            if (isEnabled == null) {
              throw new MissingRequiredPropertyException("GetGuardTargetsTargetCollectionItemTargetResponderRecipeEffectiveResponderRuleDetail", "isEnabled");
            }
        ...
        public Builder mode(String mode) {
            if (mode == null) {
              throw new MissingRequiredPropertyException("GetGuardTargetsTargetCollectionItemTargetResponderRecipeEffectiveResponderRuleDetail", "mode");
            }
            this.mode = mode;
            return this;
        }
