...
import com.pulumi.oci.CloudGuard.outputs.GetResponderRecipeResponderRuleDetail;
...
public final class GetResponderRecipeResponderRule {
    ...
    public static Builder builder(GetResponderRecipeResponderRule defaults) {
    ...
    public static final class Builder {
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetResponderRecipeResponderRule", "compartmentId");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetResponderRecipeResponderRule", "description");
            }
        ...
        public Builder details(List<GetResponderRecipeResponderRuleDetail> details) {
            if (details == null) {
              throw new MissingRequiredPropertyException("GetResponderRecipeResponderRule", "details");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetResponderRecipeResponderRule", "displayName");
            }
        ...
        public Builder lifecycleDetails(String lifecycleDetails) {
            if (lifecycleDetails == null) {
              throw new MissingRequiredPropertyException("GetResponderRecipeResponderRule", "lifecycleDetails");
            }
        ...
        public Builder policies(List<String> policies) {
            if (policies == null) {
              throw new MissingRequiredPropertyException("GetResponderRecipeResponderRule", "policies");
            }
        ...
        public Builder responderRuleId(String responderRuleId) {
            if (responderRuleId == null) {
              throw new MissingRequiredPropertyException("GetResponderRecipeResponderRule", "responderRuleId");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetResponderRecipeResponderRule", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder supportedModes(List<String> supportedModes) {
            if (supportedModes == null) {
              throw new MissingRequiredPropertyException("GetResponderRecipeResponderRule", "supportedModes");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetResponderRecipeResponderRule", "timeCreated");
            }
        ...
        public Builder timeUpdated(String timeUpdated) {
            if (timeUpdated == null) {
              throw new MissingRequiredPropertyException("GetResponderRecipeResponderRule", "timeUpdated");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetResponderRecipeResponderRule", "type");
            }
            this.type = type;
            return this;
        }
        public GetResponderRecipeResponderRule build() {
            final var _resultValue = new GetResponderRecipeResponderRule();
