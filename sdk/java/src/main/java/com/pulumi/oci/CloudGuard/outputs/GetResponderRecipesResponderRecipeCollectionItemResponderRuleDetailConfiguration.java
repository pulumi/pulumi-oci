...
public final class GetResponderRecipesResponderRecipeCollectionItemResponderRuleDetailConfiguration {
    ...
    public static final class Builder {
        ...
        public Builder configKey(String configKey) {
            if (configKey == null) {
              throw new MissingRequiredPropertyException("GetResponderRecipesResponderRecipeCollectionItemResponderRuleDetailConfiguration", "configKey");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetResponderRecipesResponderRecipeCollectionItemResponderRuleDetailConfiguration", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetResponderRecipesResponderRecipeCollectionItemResponderRuleDetailConfiguration", "value");
            }
            this.value = value;
            return this;
        }
