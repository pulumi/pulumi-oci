...
@CustomType
public final class TargetTargetDetectorRecipeEffectiveDetectorRuleEntitiesMapping {
    /**
    ...
    public static Builder builder(TargetTargetDetectorRecipeEffectiveDetectorRuleEntitiesMapping defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String queryField;
        public Builder() {}
        public Builder(TargetTargetDetectorRecipeEffectiveDetectorRuleEntitiesMapping defaults) {
        ...
        public TargetTargetDetectorRecipeEffectiveDetectorRuleEntitiesMapping build() {
            final var _resultValue = new TargetTargetDetectorRecipeEffectiveDetectorRuleEntitiesMapping();
