...
public class MigrationAsset extends com.pulumi.resources.CustomResource {
     ...
     */
    public MigrationAsset(java.lang.String name) {
     ...
     */
    public MigrationAsset(java.lang.String name, MigrationAssetArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public MigrationAsset(java.lang.String name, MigrationAssetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:CloudMigrations/migrationAsset:MigrationAsset", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private MigrationAsset(java.lang.String name, Output<java.lang.String> id, @Nullable MigrationAssetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:CloudMigrations/migrationAsset:MigrationAsset", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static MigrationAsset get(java.lang.String name, Output<java.lang.String> id, @Nullable MigrationAssetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
