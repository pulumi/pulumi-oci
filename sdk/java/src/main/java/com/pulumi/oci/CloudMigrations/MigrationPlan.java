...
public class MigrationPlan extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="calculatedLimits", refs={Map.class,String.class}, tree="[0,1,1]")
    private Output<Map<String,String>> calculatedLimits;

    /**
     * @return Limits of the resources that are needed for migration. Example: {&#34;BlockVolume&#34;: 2, &#34;VCN&#34;: 1}
     * 
     */
    public Output<Map<String,String>> calculatedLimits() {
     ...
     */
    public MigrationPlan(java.lang.String name) {
     ...
     */
    public MigrationPlan(java.lang.String name, MigrationPlanArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public MigrationPlan(java.lang.String name, MigrationPlanArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:CloudMigrations/migrationPlan:MigrationPlan", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private MigrationPlan(java.lang.String name, Output<java.lang.String> id, @Nullable MigrationPlanState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:CloudMigrations/migrationPlan:MigrationPlan", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static MigrationPlan get(java.lang.String name, Output<java.lang.String> id, @Nullable MigrationPlanState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
