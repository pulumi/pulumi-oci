...
public class ReplicationSchedule extends com.pulumi.resources.CustomResource {
     ...
     */
    public ReplicationSchedule(java.lang.String name) {
     ...
     */
    public ReplicationSchedule(java.lang.String name, ReplicationScheduleArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ReplicationSchedule(java.lang.String name, ReplicationScheduleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:CloudMigrations/replicationSchedule:ReplicationSchedule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ReplicationSchedule(java.lang.String name, Output<java.lang.String> id, @Nullable ReplicationScheduleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:CloudMigrations/replicationSchedule:ReplicationSchedule", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ReplicationSchedule get(java.lang.String name, Output<java.lang.String> id, @Nullable ReplicationScheduleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
