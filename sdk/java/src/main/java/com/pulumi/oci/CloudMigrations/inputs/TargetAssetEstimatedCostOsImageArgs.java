...
public final class TargetAssetEstimatedCostOsImageArgs extends com.pulumi.resources.ResourceArgs {

    public static final TargetAssetEstimatedCostOsImageArgs Empty = new TargetAssetEstimatedCostOsImageArgs();
    ...
    private TargetAssetEstimatedCostOsImageArgs() {}

    private TargetAssetEstimatedCostOsImageArgs(TargetAssetEstimatedCostOsImageArgs $) {
    ...
    public static Builder builder(TargetAssetEstimatedCostOsImageArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TargetAssetEstimatedCostOsImageArgs();
        }

        public Builder(TargetAssetEstimatedCostOsImageArgs defaults) {
            $ = new TargetAssetEstimatedCostOsImageArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TargetAssetEstimatedCostOsImageArgs build() {
            return $;
        }
    }
