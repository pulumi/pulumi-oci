...
@CustomType
public final class GetMigrationPlanMigrationPlanStatTotalEstimatedCostStorageVolume {
    /**
    ...
    private GetMigrationPlanMigrationPlanStatTotalEstimatedCostStorageVolume() {}
    /**
     * @return Gigabyte storage capacity
     * 
     */
    ...
    public static Builder builder(GetMigrationPlanMigrationPlanStatTotalEstimatedCostStorageVolume defaults) {
    ...
    public static final class Builder {
        ...
        private Double totalGbPerMonthBySubscription;
        public Builder() {}
        public Builder(GetMigrationPlanMigrationPlanStatTotalEstimatedCostStorageVolume defaults) {
        ...
        public Builder capacityGb(Double capacityGb) {
            if (capacityGb == null) {
              throw new MissingRequiredPropertyException("GetMigrationPlanMigrationPlanStatTotalEstimatedCostStorageVolume", "capacityGb");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetMigrationPlanMigrationPlanStatTotalEstimatedCostStorageVolume", "description");
            }
        ...
        public Builder totalGbPerMonth(Double totalGbPerMonth) {
            if (totalGbPerMonth == null) {
              throw new MissingRequiredPropertyException("GetMigrationPlanMigrationPlanStatTotalEstimatedCostStorageVolume", "totalGbPerMonth");
            }
        ...
        public Builder totalGbPerMonthBySubscription(Double totalGbPerMonthBySubscription) {
            if (totalGbPerMonthBySubscription == null) {
              throw new MissingRequiredPropertyException("GetMigrationPlanMigrationPlanStatTotalEstimatedCostStorageVolume", "totalGbPerMonthBySubscription");
            }
            this.totalGbPerMonthBySubscription = totalGbPerMonthBySubscription;
            return this;
        }
        public GetMigrationPlanMigrationPlanStatTotalEstimatedCostStorageVolume build() {
            final var _resultValue = new GetMigrationPlanMigrationPlanStatTotalEstimatedCostStorageVolume();
