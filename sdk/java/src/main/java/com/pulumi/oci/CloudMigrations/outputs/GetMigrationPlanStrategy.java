    ...
    public static final class Builder {
        ...
        public Builder adjustmentMultiplier(Double adjustmentMultiplier) {
            if (adjustmentMultiplier == null) {
              throw new MissingRequiredPropertyException("GetMigrationPlanStrategy", "adjustmentMultiplier");
            }
        ...
        public Builder metricTimeWindow(String metricTimeWindow) {
            if (metricTimeWindow == null) {
              throw new MissingRequiredPropertyException("GetMigrationPlanStrategy", "metricTimeWindow");
            }
        ...
        public Builder metricType(String metricType) {
            if (metricType == null) {
              throw new MissingRequiredPropertyException("GetMigrationPlanStrategy", "metricType");
            }
        ...
        public Builder percentile(String percentile) {
            if (percentile == null) {
              throw new MissingRequiredPropertyException("GetMigrationPlanStrategy", "percentile");
            }
        ...
        public Builder resourceType(String resourceType) {
            if (resourceType == null) {
              throw new MissingRequiredPropertyException("GetMigrationPlanStrategy", "resourceType");
            }
        ...
        public Builder strategyType(String strategyType) {
            if (strategyType == null) {
              throw new MissingRequiredPropertyException("GetMigrationPlanStrategy", "strategyType");
            }
            this.strategyType = strategyType;
            return this;
        }
        public GetMigrationPlanStrategy build() {
            final var _resultValue = new GetMigrationPlanStrategy();
