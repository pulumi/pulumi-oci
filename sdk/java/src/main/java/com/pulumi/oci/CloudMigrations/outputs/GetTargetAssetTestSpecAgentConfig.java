...
import com.pulumi.oci.CloudMigrations.outputs.GetTargetAssetTestSpecAgentConfigPluginsConfig;
import java.lang.Boolean;
import java.util.List;
import java.util.Objects;

@CustomType
public final class GetTargetAssetTestSpecAgentConfig {
    /**
     ...
     * 
     */
    private List<GetTargetAssetTestSpecAgentConfigPluginsConfig> pluginsConfigs;

    private GetTargetAssetTestSpecAgentConfig() {}
    /**
     * @return Whether Oracle Cloud Agent can run all the available plugins. This includes the management and monitoring plugins.
     * 
     */
     ...
     * 
     */
    public List<GetTargetAssetTestSpecAgentConfigPluginsConfig> pluginsConfigs() {
    ...
    public static Builder builder(GetTargetAssetTestSpecAgentConfig defaults) {
    ...
    public static final class Builder {
        ...
        private List<GetTargetAssetTestSpecAgentConfigPluginsConfig> pluginsConfigs;
        public Builder() {}
        public Builder(GetTargetAssetTestSpecAgentConfig defaults) {
        ...
        public Builder areAllPluginsDisabled(Boolean areAllPluginsDisabled) {
            if (areAllPluginsDisabled == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetTestSpecAgentConfig", "areAllPluginsDisabled");
            }
        ...
        public Builder isManagementDisabled(Boolean isManagementDisabled) {
            if (isManagementDisabled == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetTestSpecAgentConfig", "isManagementDisabled");
            }
        ...
        public Builder isMonitoringDisabled(Boolean isMonitoringDisabled) {
            if (isMonitoringDisabled == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetTestSpecAgentConfig", "isMonitoringDisabled");
            }
            this.isMonitoringDisabled = isMonitoringDisabled;
            return this;
        }
        @CustomType.Setter
        public Builder pluginsConfigs(List<GetTargetAssetTestSpecAgentConfigPluginsConfig> pluginsConfigs) {
            if (pluginsConfigs == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetTestSpecAgentConfig", "pluginsConfigs");
            }
            this.pluginsConfigs = pluginsConfigs;
            return this;
        }
        public Builder pluginsConfigs(GetTargetAssetTestSpecAgentConfigPluginsConfig... pluginsConfigs) {
            return pluginsConfigs(List.of(pluginsConfigs));
        }
        public GetTargetAssetTestSpecAgentConfig build() {
            final var _resultValue = new GetTargetAssetTestSpecAgentConfig();
