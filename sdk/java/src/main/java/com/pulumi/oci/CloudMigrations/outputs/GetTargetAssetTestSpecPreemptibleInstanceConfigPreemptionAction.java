...
@CustomType
public final class GetTargetAssetTestSpecPreemptibleInstanceConfigPreemptionAction {
    /**
    ...
    private GetTargetAssetTestSpecPreemptibleInstanceConfigPreemptionAction() {}
    /**
     * @return Whether to preserve the boot volume that was used to launch the preemptible instance when the instance is terminated. By default, it is false if not specified.
     * 
     */
    ...
    public static Builder builder(GetTargetAssetTestSpecPreemptibleInstanceConfigPreemptionAction defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetTargetAssetTestSpecPreemptibleInstanceConfigPreemptionAction defaults) {
        ...
        public Builder preserveBootVolume(Boolean preserveBootVolume) {
            if (preserveBootVolume == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetTestSpecPreemptibleInstanceConfigPreemptionAction", "preserveBootVolume");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetTestSpecPreemptibleInstanceConfigPreemptionAction", "type");
            }
            this.type = type;
            return this;
        }
