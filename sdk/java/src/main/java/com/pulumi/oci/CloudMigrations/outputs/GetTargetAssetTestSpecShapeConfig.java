    ...
    public static final class Builder {
        ...
        public Builder baselineOcpuUtilization(String baselineOcpuUtilization) {
            if (baselineOcpuUtilization == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetTestSpecShapeConfig", "baselineOcpuUtilization");
            }
        ...
        public Builder memoryInGbs(Double memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetTestSpecShapeConfig", "memoryInGbs");
            }
        ...
        public Builder ocpus(Double ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetTestSpecShapeConfig", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
        public GetTargetAssetTestSpecShapeConfig build() {
            final var _resultValue = new GetTargetAssetTestSpecShapeConfig();
