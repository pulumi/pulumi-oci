...
@CustomType
public final class GetTargetAssetUserSpecInstanceOption {
    /**
    ...
    private GetTargetAssetUserSpecInstanceOption() {}
    /**
     * @return Whether to disable the legacy (/v1) instance metadata service endpoints. Customers who have migrated to /v2 should set this to true for added security. Default is false.
     * 
     */
    ...
    public static Builder builder(GetTargetAssetUserSpecInstanceOption defaults) {
    ...
    public static final class Builder {
        private Boolean areLegacyImdsEndpointsDisabled;
        public Builder() {}
        public Builder(GetTargetAssetUserSpecInstanceOption defaults) {
        ...
        public Builder areLegacyImdsEndpointsDisabled(Boolean areLegacyImdsEndpointsDisabled) {
            if (areLegacyImdsEndpointsDisabled == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetUserSpecInstanceOption", "areLegacyImdsEndpointsDisabled");
            }
