...
public final class GetTargetAssetsTargetAssetCollectionItemEstimatedCost {
    ...
    public static final class Builder {
        ...
        public Builder computes(List<GetTargetAssetsTargetAssetCollectionItemEstimatedCostCompute> computes) {
            if (computes == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemEstimatedCost", "computes");
            }
        ...
        public Builder currencyCode(String currencyCode) {
            if (currencyCode == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemEstimatedCost", "currencyCode");
            }
        ...
        public Builder osImages(List<GetTargetAssetsTargetAssetCollectionItemEstimatedCostOsImage> osImages) {
            if (osImages == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemEstimatedCost", "osImages");
            }
        ...
        public Builder storages(List<GetTargetAssetsTargetAssetCollectionItemEstimatedCostStorage> storages) {
            if (storages == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemEstimatedCost", "storages");
            }
        ...
        public Builder subscriptionId(String subscriptionId) {
            if (subscriptionId == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemEstimatedCost", "subscriptionId");
            }
        ...
        public Builder totalEstimationPerMonth(Double totalEstimationPerMonth) {
            if (totalEstimationPerMonth == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemEstimatedCost", "totalEstimationPerMonth");
            }
        ...
        public Builder totalEstimationPerMonthBySubscription(Double totalEstimationPerMonthBySubscription) {
            if (totalEstimationPerMonthBySubscription == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemEstimatedCost", "totalEstimationPerMonthBySubscription");
            }
