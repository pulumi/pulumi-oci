...
@CustomType
public final class GetTargetAssetsTargetAssetCollectionItemEstimatedCostStorageVolume {
    /**
    ...
    private GetTargetAssetsTargetAssetCollectionItemEstimatedCostStorageVolume() {}
    /**
     * @return Gigabyte storage capacity
     * 
     */
    ...
    public static Builder builder(GetTargetAssetsTargetAssetCollectionItemEstimatedCostStorageVolume defaults) {
    ...
    public static final class Builder {
        ...
        private Double totalGbPerMonthBySubscription;
        public Builder() {}
        public Builder(GetTargetAssetsTargetAssetCollectionItemEstimatedCostStorageVolume defaults) {
        ...
        public Builder capacityGb(Double capacityGb) {
            if (capacityGb == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemEstimatedCostStorageVolume", "capacityGb");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemEstimatedCostStorageVolume", "description");
            }
        ...
        public Builder totalGbPerMonth(Double totalGbPerMonth) {
            if (totalGbPerMonth == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemEstimatedCostStorageVolume", "totalGbPerMonth");
            }
        ...
        public Builder totalGbPerMonthBySubscription(Double totalGbPerMonthBySubscription) {
            if (totalGbPerMonthBySubscription == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemEstimatedCostStorageVolume", "totalGbPerMonthBySubscription");
            }
