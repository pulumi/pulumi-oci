...
@CustomType
public final class GetTargetAssetsTargetAssetCollectionItemRecommendedSpecCreateVnicDetail {
    /**
    ...
    private GetTargetAssetsTargetAssetCollectionItemRecommendedSpecCreateVnicDetail() {}
    /**
     * @return Whether the VNIC should be assigned a DNS record. If set to false, there will be no DNS record registration for the VNIC. If set to true, the DNS record will be registered. By default, the value is true.
     * 
     */
    ...
    public static Builder builder(GetTargetAssetsTargetAssetCollectionItemRecommendedSpecCreateVnicDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String vlanId;
        public Builder() {}
        public Builder(GetTargetAssetsTargetAssetCollectionItemRecommendedSpecCreateVnicDetail defaults) {
        ...
        public Builder assignPrivateDnsRecord(Boolean assignPrivateDnsRecord) {
            if (assignPrivateDnsRecord == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemRecommendedSpecCreateVnicDetail", "assignPrivateDnsRecord");
            }
        ...
        public Builder assignPublicIp(Boolean assignPublicIp) {
            if (assignPublicIp == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemRecommendedSpecCreateVnicDetail", "assignPublicIp");
            }
        ...
        public Builder definedTags(Map<String,String> definedTags) {
            if (definedTags == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemRecommendedSpecCreateVnicDetail", "definedTags");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemRecommendedSpecCreateVnicDetail", "displayName");
            }
        ...
        public Builder freeformTags(Map<String,String> freeformTags) {
            if (freeformTags == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemRecommendedSpecCreateVnicDetail", "freeformTags");
            }
        ...
        public Builder hostnameLabel(String hostnameLabel) {
            if (hostnameLabel == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemRecommendedSpecCreateVnicDetail", "hostnameLabel");
            }
        ...
        public Builder nsgIds(List<String> nsgIds) {
            if (nsgIds == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemRecommendedSpecCreateVnicDetail", "nsgIds");
            }
            this.nsgIds = nsgIds;
            return this;
        }
        ...
        public Builder privateIp(String privateIp) {
            if (privateIp == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemRecommendedSpecCreateVnicDetail", "privateIp");
            }
        ...
        public Builder skipSourceDestCheck(Boolean skipSourceDestCheck) {
            if (skipSourceDestCheck == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemRecommendedSpecCreateVnicDetail", "skipSourceDestCheck");
            }
        ...
        public Builder subnetId(String subnetId) {
            if (subnetId == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemRecommendedSpecCreateVnicDetail", "subnetId");
            }
        ...
        public Builder vlanId(String vlanId) {
            if (vlanId == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemRecommendedSpecCreateVnicDetail", "vlanId");
            }
            this.vlanId = vlanId;
            return this;
        }
        public GetTargetAssetsTargetAssetCollectionItemRecommendedSpecCreateVnicDetail build() {
            final var _resultValue = new GetTargetAssetsTargetAssetCollectionItemRecommendedSpecCreateVnicDetail();
