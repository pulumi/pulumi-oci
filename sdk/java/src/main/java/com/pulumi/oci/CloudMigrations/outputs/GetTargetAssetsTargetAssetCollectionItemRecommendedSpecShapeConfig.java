...
@CustomType
public final class GetTargetAssetsTargetAssetCollectionItemRecommendedSpecShapeConfig {
    /**
    ...
    private GetTargetAssetsTargetAssetCollectionItemRecommendedSpecShapeConfig() {}
    /**
     * @return The baseline OCPU utilization for a subcore burstable VM instance. Leave this attribute blank for a non-burstable instance, or explicitly specify non-burstable with `BASELINE_1_1`.
     * 
     */
    ...
    public static Builder builder(GetTargetAssetsTargetAssetCollectionItemRecommendedSpecShapeConfig defaults) {
    ...
    public static final class Builder {
        ...
        private Double ocpus;
        public Builder() {}
        public Builder(GetTargetAssetsTargetAssetCollectionItemRecommendedSpecShapeConfig defaults) {
        ...
        public Builder baselineOcpuUtilization(String baselineOcpuUtilization) {
            if (baselineOcpuUtilization == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemRecommendedSpecShapeConfig", "baselineOcpuUtilization");
            }
        ...
        public Builder memoryInGbs(Double memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemRecommendedSpecShapeConfig", "memoryInGbs");
            }
        ...
        public Builder ocpus(Double ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemRecommendedSpecShapeConfig", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
