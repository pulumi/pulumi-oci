...
@CustomType
public final class GetTargetAssetsTargetAssetCollectionItemRecommendedSpecSourceDetail {
    /**
    ...
    private GetTargetAssetsTargetAssetCollectionItemRecommendedSpecSourceDetail() {}
    /**
     * @return The OCID of the boot volume used to boot the instance.
     * 
     */
    ...
    public static Builder builder(GetTargetAssetsTargetAssetCollectionItemRecommendedSpecSourceDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String sourceType;
        public Builder() {}
        public Builder(GetTargetAssetsTargetAssetCollectionItemRecommendedSpecSourceDetail defaults) {
        ...
        public Builder bootVolumeId(String bootVolumeId) {
            if (bootVolumeId == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemRecommendedSpecSourceDetail", "bootVolumeId");
            }
        ...
        public Builder bootVolumeSizeInGbs(String bootVolumeSizeInGbs) {
            if (bootVolumeSizeInGbs == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemRecommendedSpecSourceDetail", "bootVolumeSizeInGbs");
            }
        ...
        public Builder bootVolumeVpusPerGb(String bootVolumeVpusPerGb) {
            if (bootVolumeVpusPerGb == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemRecommendedSpecSourceDetail", "bootVolumeVpusPerGb");
            }
        ...
        public Builder imageId(String imageId) {
            if (imageId == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemRecommendedSpecSourceDetail", "imageId");
            }
        ...
        public Builder kmsKeyId(String kmsKeyId) {
            if (kmsKeyId == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemRecommendedSpecSourceDetail", "kmsKeyId");
            }
        ...
        public Builder sourceType(String sourceType) {
            if (sourceType == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemRecommendedSpecSourceDetail", "sourceType");
            }
            this.sourceType = sourceType;
            return this;
        }
        public GetTargetAssetsTargetAssetCollectionItemRecommendedSpecSourceDetail build() {
            final var _resultValue = new GetTargetAssetsTargetAssetCollectionItemRecommendedSpecSourceDetail();
