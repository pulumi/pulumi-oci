...
public final class GetTargetAssetsTargetAssetCollectionItemTestSpecInstanceOption {
    ...
    public static Builder builder(GetTargetAssetsTargetAssetCollectionItemTestSpecInstanceOption defaults) {
    ...
    public static final class Builder {
        ...
        public Builder areLegacyImdsEndpointsDisabled(Boolean areLegacyImdsEndpointsDisabled) {
            if (areLegacyImdsEndpointsDisabled == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemTestSpecInstanceOption", "areLegacyImdsEndpointsDisabled");
            }
