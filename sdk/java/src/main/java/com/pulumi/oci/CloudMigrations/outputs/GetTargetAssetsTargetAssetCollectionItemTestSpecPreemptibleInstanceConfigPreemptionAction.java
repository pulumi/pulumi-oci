    ...
    public static final class Builder {
        ...
        public Builder preserveBootVolume(Boolean preserveBootVolume) {
            if (preserveBootVolume == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemTestSpecPreemptibleInstanceConfigPreemptionAction", "preserveBootVolume");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemTestSpecPreemptibleInstanceConfigPreemptionAction", "type");
            }
            this.type = type;
            return this;
        }
