...
@CustomType
public final class GetTargetAssetsTargetAssetCollectionItemTestSpecShapeConfig {
    /**
    ...
    private GetTargetAssetsTargetAssetCollectionItemTestSpecShapeConfig() {}
    /**
     * @return The baseline OCPU utilization for a subcore burstable VM instance. Leave this attribute blank for a non-burstable instance, or explicitly specify non-burstable with `BASELINE_1_1`.
     * 
     */
    ...
    public static Builder builder(GetTargetAssetsTargetAssetCollectionItemTestSpecShapeConfig defaults) {
    ...
    public static final class Builder {
        ...
        private Double ocpus;
        public Builder() {}
        public Builder(GetTargetAssetsTargetAssetCollectionItemTestSpecShapeConfig defaults) {
        ...
        public Builder baselineOcpuUtilization(String baselineOcpuUtilization) {
            if (baselineOcpuUtilization == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemTestSpecShapeConfig", "baselineOcpuUtilization");
            }
        ...
        public Builder memoryInGbs(Double memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemTestSpecShapeConfig", "memoryInGbs");
            }
        ...
        public Builder ocpus(Double ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemTestSpecShapeConfig", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
