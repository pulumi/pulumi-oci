...
@CustomType
public final class GetTargetAssetsTargetAssetCollectionItemTestSpecSourceDetail {
    /**
    ...
    private GetTargetAssetsTargetAssetCollectionItemTestSpecSourceDetail() {}
    /**
     * @return The OCID of the boot volume used to boot the instance.
     * 
     */
    ...
    public static Builder builder(GetTargetAssetsTargetAssetCollectionItemTestSpecSourceDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String sourceType;
        public Builder() {}
        public Builder(GetTargetAssetsTargetAssetCollectionItemTestSpecSourceDetail defaults) {
        ...
        public Builder bootVolumeId(String bootVolumeId) {
            if (bootVolumeId == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemTestSpecSourceDetail", "bootVolumeId");
            }
        ...
        public Builder bootVolumeSizeInGbs(String bootVolumeSizeInGbs) {
            if (bootVolumeSizeInGbs == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemTestSpecSourceDetail", "bootVolumeSizeInGbs");
            }
        ...
        public Builder bootVolumeVpusPerGb(String bootVolumeVpusPerGb) {
            if (bootVolumeVpusPerGb == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemTestSpecSourceDetail", "bootVolumeVpusPerGb");
            }
        ...
        public Builder imageId(String imageId) {
            if (imageId == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemTestSpecSourceDetail", "imageId");
            }
        ...
        public Builder kmsKeyId(String kmsKeyId) {
            if (kmsKeyId == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemTestSpecSourceDetail", "kmsKeyId");
            }
        ...
        public Builder sourceType(String sourceType) {
            if (sourceType == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemTestSpecSourceDetail", "sourceType");
            }
