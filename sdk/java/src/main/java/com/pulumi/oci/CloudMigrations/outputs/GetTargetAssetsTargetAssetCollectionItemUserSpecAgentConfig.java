...
import com.pulumi.oci.CloudMigrations.outputs.GetTargetAssetsTargetAssetCollectionItemUserSpecAgentConfigPluginsConfig;
import java.lang.Boolean;
import java.util.List;
import java.util.Objects;

@CustomType
public final class GetTargetAssetsTargetAssetCollectionItemUserSpecAgentConfig {
    /**
     ...
     * 
     */
    private List<GetTargetAssetsTargetAssetCollectionItemUserSpecAgentConfigPluginsConfig> pluginsConfigs;

    private GetTargetAssetsTargetAssetCollectionItemUserSpecAgentConfig() {}
    /**
     * @return Whether Oracle Cloud Agent can run all the available plugins. This includes the management and monitoring plugins.
     * 
     */
     ...
     * 
     */
    public List<GetTargetAssetsTargetAssetCollectionItemUserSpecAgentConfigPluginsConfig> pluginsConfigs() {
    ...
    public static Builder builder(GetTargetAssetsTargetAssetCollectionItemUserSpecAgentConfig defaults) {
    ...
    public static final class Builder {
        ...
        private List<GetTargetAssetsTargetAssetCollectionItemUserSpecAgentConfigPluginsConfig> pluginsConfigs;
        public Builder() {}
        public Builder(GetTargetAssetsTargetAssetCollectionItemUserSpecAgentConfig defaults) {
        ...
        public Builder areAllPluginsDisabled(Boolean areAllPluginsDisabled) {
            if (areAllPluginsDisabled == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemUserSpecAgentConfig", "areAllPluginsDisabled");
            }
        ...
        public Builder isManagementDisabled(Boolean isManagementDisabled) {
            if (isManagementDisabled == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemUserSpecAgentConfig", "isManagementDisabled");
            }
        ...
        public Builder isMonitoringDisabled(Boolean isMonitoringDisabled) {
            if (isMonitoringDisabled == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemUserSpecAgentConfig", "isMonitoringDisabled");
            }
            this.isMonitoringDisabled = isMonitoringDisabled;
            return this;
        }
        @CustomType.Setter
        public Builder pluginsConfigs(List<GetTargetAssetsTargetAssetCollectionItemUserSpecAgentConfigPluginsConfig> pluginsConfigs) {
            if (pluginsConfigs == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemUserSpecAgentConfig", "pluginsConfigs");
            }
            this.pluginsConfigs = pluginsConfigs;
            return this;
        }
        public Builder pluginsConfigs(GetTargetAssetsTargetAssetCollectionItemUserSpecAgentConfigPluginsConfig... pluginsConfigs) {
            return pluginsConfigs(List.of(pluginsConfigs));
        }
        public GetTargetAssetsTargetAssetCollectionItemUserSpecAgentConfig build() {
            final var _resultValue = new GetTargetAssetsTargetAssetCollectionItemUserSpecAgentConfig();
