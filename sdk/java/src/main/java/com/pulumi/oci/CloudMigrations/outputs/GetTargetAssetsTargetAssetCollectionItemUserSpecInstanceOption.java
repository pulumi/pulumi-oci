...
@CustomType
public final class GetTargetAssetsTargetAssetCollectionItemUserSpecInstanceOption {
    /**
    ...
    private GetTargetAssetsTargetAssetCollectionItemUserSpecInstanceOption() {}
    /**
     * @return Whether to disable the legacy (/v1) instance metadata service endpoints. Customers who have migrated to /v2 should set this to true for added security. Default is false.
     * 
     */
    ...
    public static Builder builder(GetTargetAssetsTargetAssetCollectionItemUserSpecInstanceOption defaults) {
    ...
    public static final class Builder {
        private Boolean areLegacyImdsEndpointsDisabled;
        public Builder() {}
        public Builder(GetTargetAssetsTargetAssetCollectionItemUserSpecInstanceOption defaults) {
        ...
        public Builder areLegacyImdsEndpointsDisabled(Boolean areLegacyImdsEndpointsDisabled) {
            if (areLegacyImdsEndpointsDisabled == null) {
              throw new MissingRequiredPropertyException("GetTargetAssetsTargetAssetCollectionItemUserSpecInstanceOption", "areLegacyImdsEndpointsDisabled");
            }
            this.areLegacyImdsEndpointsDisabled = areLegacyImdsEndpointsDisabled;
            return this;
        }
        public GetTargetAssetsTargetAssetCollectionItemUserSpecInstanceOption build() {
            final var _resultValue = new GetTargetAssetsTargetAssetCollectionItemUserSpecInstanceOption();
