...
@CustomType
public final class MigrationPlanMigrationPlanStatTotalEstimatedCostOsImage {
    /**
    ...
    public static Builder builder(MigrationPlanMigrationPlanStatTotalEstimatedCostOsImage defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double totalPerHourBySubscription;
        public Builder() {}
        public Builder(MigrationPlanMigrationPlanStatTotalEstimatedCostOsImage defaults) {
