...
@CustomType
public final class TargetAssetEstimatedCostCompute {
    /**
    ...
    private TargetAssetEstimatedCostCompute() {}
    /**
     * @return Total number of GPU
     * 
     */
    ...
    public static Builder builder(TargetAssetEstimatedCostCompute defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double totalPerHourBySubscription;
        public Builder() {}
        public Builder(TargetAssetEstimatedCostCompute defaults) {
