...
@CustomType
public final class TargetAssetEstimatedCostOsImage {
    /**
    ...
    private TargetAssetEstimatedCostOsImage() {}
    /**
     * @return Total price per hour
     * 
     */
    ...
    public static Builder builder(TargetAssetEstimatedCostOsImage defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double totalPerHourBySubscription;
        public Builder() {}
        public Builder(TargetAssetEstimatedCostOsImage defaults) {
