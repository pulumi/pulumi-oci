...
public final class TargetAssetRecommendedSpecPreemptibleInstanceConfigPreemptionAction {
    ...
    public static Builder builder(TargetAssetRecommendedSpecPreemptibleInstanceConfigPreemptionAction defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(TargetAssetRecommendedSpecPreemptibleInstanceConfigPreemptionAction defaults) {
        ...
        public TargetAssetRecommendedSpecPreemptibleInstanceConfigPreemptionAction build() {
            final var _resultValue = new TargetAssetRecommendedSpecPreemptibleInstanceConfigPreemptionAction();
