...
@CustomType
public final class TargetAssetRecommendedSpecSourceDetail {
    /**
    ...
    public static Builder builder(TargetAssetRecommendedSpecSourceDetail defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String sourceType;
        public Builder() {}
        public Builder(TargetAssetRecommendedSpecSourceDetail defaults) {
        ...
        public TargetAssetRecommendedSpecSourceDetail build() {
            final var _resultValue = new TargetAssetRecommendedSpecSourceDetail();
