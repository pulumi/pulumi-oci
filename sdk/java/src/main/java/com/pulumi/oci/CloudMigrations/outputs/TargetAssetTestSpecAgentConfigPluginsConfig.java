...
public final class TargetAssetTestSpecAgentConfigPluginsConfig {
    ...
    public static Builder builder(TargetAssetTestSpecAgentConfigPluginsConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String name;
        public Builder() {}
        public Builder(TargetAssetTestSpecAgentConfigPluginsConfig defaults) {
        ...
        public TargetAssetTestSpecAgentConfigPluginsConfig build() {
            final var _resultValue = new TargetAssetTestSpecAgentConfigPluginsConfig();
