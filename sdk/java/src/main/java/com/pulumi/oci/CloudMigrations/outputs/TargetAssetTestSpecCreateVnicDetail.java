...
@CustomType
public final class TargetAssetTestSpecCreateVnicDetail {
    /**
    ...
    private TargetAssetTestSpecCreateVnicDetail() {}
    /**
     * @return Whether the VNIC should be assigned a DNS record. If set to false, there will be no DNS record registration for the VNIC. If set to true, the DNS record will be registered. By default, the value is true.
     * 
     */
    ...
    public static Builder builder(TargetAssetTestSpecCreateVnicDetail defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String vlanId;
        public Builder() {}
        public Builder(TargetAssetTestSpecCreateVnicDetail defaults) {
        ...
        public TargetAssetTestSpecCreateVnicDetail build() {
            final var _resultValue = new TargetAssetTestSpecCreateVnicDetail();
