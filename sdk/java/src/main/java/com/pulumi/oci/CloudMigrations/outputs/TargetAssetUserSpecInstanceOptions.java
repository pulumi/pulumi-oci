...
@CustomType
public final class TargetAssetUserSpecInstanceOptions {
    /**
    ...
    private TargetAssetUserSpecInstanceOptions() {}
    /**
     * @return (Updatable) Whether to disable the legacy (/v1) instance metadata service endpoints. Customers who have migrated to /v2 should set this to true for added security. Default is false.
     * 
     */
    ...
    public static Builder builder(TargetAssetUserSpecInstanceOptions defaults) {
    ...
    public static final class Builder {
        private @Nullable Boolean areLegacyImdsEndpointsDisabled;
        public Builder() {}
        public Builder(TargetAssetUserSpecInstanceOptions defaults) {
        ...
        public TargetAssetUserSpecInstanceOptions build() {
            final var _resultValue = new TargetAssetUserSpecInstanceOptions();
