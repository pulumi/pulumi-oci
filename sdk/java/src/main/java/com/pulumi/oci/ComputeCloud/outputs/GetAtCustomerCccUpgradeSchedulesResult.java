...
public final class GetAtCustomerCccUpgradeSchedulesResult {
    ...
    public static final class Builder {
        ...
        public Builder cccUpgradeScheduleCollections(List<GetAtCustomerCccUpgradeSchedulesCccUpgradeScheduleCollection> cccUpgradeScheduleCollections) {
            if (cccUpgradeScheduleCollections == null) {
              throw new MissingRequiredPropertyException("GetAtCustomerCccUpgradeSchedulesResult", "cccUpgradeScheduleCollections");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetAtCustomerCccUpgradeSchedulesResult", "id");
            }
            this.id = id;
            return this;
        }
