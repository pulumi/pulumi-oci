    ...
    public static final class Builder {
        ...
        public GetInstanceAgentPluginsArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetInstanceAgentPluginsArgs", "compartmentId");
            }
            if ($.instanceagentId == null) {
                throw new MissingRequiredPropertyException("GetInstanceAgentPluginsArgs", "instanceagentId");
            }
            return $;
        }
    }
