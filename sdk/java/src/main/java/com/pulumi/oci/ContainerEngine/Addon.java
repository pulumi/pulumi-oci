...
public class Addon extends com.pulumi.resources.CustomResource {
    ...
    public Addon(java.lang.String name, AddonArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:ContainerEngine/addon:Addon", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Addon(java.lang.String name, Output<java.lang.String> id, @Nullable AddonState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:ContainerEngine/addon:Addon", name, state, makeResourceOptions(options, id), false);
    }
