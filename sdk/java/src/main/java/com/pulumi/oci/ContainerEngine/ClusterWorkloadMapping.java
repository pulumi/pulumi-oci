...
public class ClusterWorkloadMapping extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ String> mappedTenancyId;

    /**
     * @return The OCID of the mapped customer tenancy.
     * 
     */
    public Output<Optional<String>> mappedTenancyId() {
        return Codegen.optional(this.mappedTenancyId);
    }
    /**
    ...
    public ClusterWorkloadMapping(String name, ClusterWorkloadMappingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:ContainerEngine/clusterWorkloadMapping:ClusterWorkloadMapping", name, args == null ? ClusterWorkloadMappingArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
