...
public final class AddonAddonErrorArgs extends com.pulumi.resources.ResourceArgs {

    public static final AddonAddonErrorArgs Empty = new AddonAddonErrorArgs();
    ...
    private AddonAddonErrorArgs() {}

    private AddonAddonErrorArgs(AddonAddonErrorArgs $) {
        this.code = $.code;
    ...
    public static Builder builder(AddonAddonErrorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AddonAddonErrorArgs();
        }

        public Builder(AddonAddonErrorArgs defaults) {
            $ = new AddonAddonErrorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AddonAddonErrorArgs build() {
            return $;
        }
    }
