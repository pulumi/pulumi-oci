    ...
    public static final class Builder {
        ...
        public ContainerInstanceImagePullSecretArgs build() {
            if ($.registryEndpoint == null) {
                throw new MissingRequiredPropertyException("ContainerInstanceImagePullSecretArgs", "registryEndpoint");
            }
            if ($.secretType == null) {
                throw new MissingRequiredPropertyException("ContainerInstanceImagePullSecretArgs", "secretType");
            }
            return $;
        }
    }
