...
public final class VirtualNodePoolState extends com.pulumi.resources.ResourceArgs {

    public static final VirtualNodePoolState Empty = new VirtualNodePoolState();
    ...
    private @Nullable Output<List<VirtualNodePoolPlacementConfigurationArgs>> placementConfigurations;
     ...
     * 
     */
    public Optional<Output<List<VirtualNodePoolPlacementConfigurationArgs>>> placementConfigurations() {
     ...
     * 
     */
    @Import(name="podConfiguration")
    private @Nullable Output<VirtualNodePoolPodConfigurationArgs> podConfiguration;

    /**
     * @return (Updatable) The pod configuration for pods run on virtual nodes of this virtual node pool.
     * 
     */
    public Optional<Output<VirtualNodePoolPodConfigurationArgs>> podConfiguration() {
        return Optional.ofNullable(this.podConfiguration);
    }
    ...
    private VirtualNodePoolState() {}

    private VirtualNodePoolState(VirtualNodePoolState $) {
    ...
    public static Builder builder(VirtualNodePoolState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new VirtualNodePoolState();
        }

        public Builder(VirtualNodePoolState defaults) {
            $ = new VirtualNodePoolState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param kubernetesVersion The version of Kubernetes running on the nodes in the node pool.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param lifecycleDetails Details about the state of the Virtual Node Pool.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder placementConfigurations(@Nullable Output<List<VirtualNodePoolPlacementConfigurationArgs>> placementConfigurations) {
         ...
         * 
         */
        public Builder podConfiguration(@Nullable Output<VirtualNodePoolPodConfigurationArgs> podConfiguration) {
        ...
        /**
         * @param state The state of the Virtual Node Pool.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param timeCreated The time the virtual node pool was created.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param timeUpdated The time the virtual node pool was updated.
         * 
         * @return builder
         * 
         */
        ...
        public VirtualNodePoolState build() {
            return $;
        }
    }
