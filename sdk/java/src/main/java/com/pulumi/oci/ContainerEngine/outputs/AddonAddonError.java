...
@CustomType
public final class AddonAddonError {
    /**
    ...
    public static Builder builder(AddonAddonError defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String status;
        public Builder() {}
        public Builder(AddonAddonError defaults) {
