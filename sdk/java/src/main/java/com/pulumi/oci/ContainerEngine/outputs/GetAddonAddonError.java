...
public final class GetAddonAddonError {
    ...
    public static final class Builder {
        ...
        public Builder code(String code) {
            if (code == null) {
              throw new MissingRequiredPropertyException("GetAddonAddonError", "code");
            }
            this.code = code;
            return this;
        }
        ...
        public Builder message(String message) {
            if (message == null) {
              throw new MissingRequiredPropertyException("GetAddonAddonError", "message");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetAddonAddonError", "status");
            }
            this.status = status;
            return this;
        }
