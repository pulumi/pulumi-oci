...
@CustomType
public final class GetClusterMetadata {
    /**
    ...
    public static Builder builder(GetClusterMetadata defaults) {
    ...
    public static final class Builder {
        ...
        private String updatedByWorkRequestId;
        public Builder() {}
        public Builder(GetClusterMetadata defaults) {
        ...
        public Builder createdByUserId(String createdByUserId) {
            if (createdByUserId == null) {
              throw new MissingRequiredPropertyException("GetClusterMetadata", "createdByUserId");
            }
        ...
        public Builder createdByWorkRequestId(String createdByWorkRequestId) {
            if (createdByWorkRequestId == null) {
              throw new MissingRequiredPropertyException("GetClusterMetadata", "createdByWorkRequestId");
            }
        ...
        public Builder deletedByUserId(String deletedByUserId) {
            if (deletedByUserId == null) {
              throw new MissingRequiredPropertyException("GetClusterMetadata", "deletedByUserId");
            }
        ...
        public Builder deletedByWorkRequestId(String deletedByWorkRequestId) {
            if (deletedByWorkRequestId == null) {
              throw new MissingRequiredPropertyException("GetClusterMetadata", "deletedByWorkRequestId");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetClusterMetadata", "timeCreated");
            }
        ...
        public Builder timeCredentialExpiration(String timeCredentialExpiration) {
            if (timeCredentialExpiration == null) {
              throw new MissingRequiredPropertyException("GetClusterMetadata", "timeCredentialExpiration");
            }
        ...
        public Builder timeDeleted(String timeDeleted) {
            if (timeDeleted == null) {
              throw new MissingRequiredPropertyException("GetClusterMetadata", "timeDeleted");
            }
        ...
        public Builder timeUpdated(String timeUpdated) {
            if (timeUpdated == null) {
              throw new MissingRequiredPropertyException("GetClusterMetadata", "timeUpdated");
            }
        ...
        public Builder updatedByUserId(String updatedByUserId) {
            if (updatedByUserId == null) {
              throw new MissingRequiredPropertyException("GetClusterMetadata", "updatedByUserId");
            }
        ...
        public Builder updatedByWorkRequestId(String updatedByWorkRequestId) {
            if (updatedByWorkRequestId == null) {
              throw new MissingRequiredPropertyException("GetClusterMetadata", "updatedByWorkRequestId");
            }
            this.updatedByWorkRequestId = updatedByWorkRequestId;
            return this;
        }
        public GetClusterMetadata build() {
            final var _resultValue = new GetClusterMetadata();
