...
import com.pulumi.oci.ContainerEngine.outputs.GetClustersClusterOptionOpenIdConnectTokenAuthenticationConfigRequiredClaim;
...
@CustomType
public final class GetClustersClusterOptionOpenIdConnectTokenAuthenticationConfig {
    /**
     ...
     * 
     */
    private List<GetClustersClusterOptionOpenIdConnectTokenAuthenticationConfigRequiredClaim> requiredClaims;
    /**
    ...
    private GetClustersClusterOptionOpenIdConnectTokenAuthenticationConfig() {}
    /**
     * @return A Base64 encoded public RSA or ECDSA certificates used to signed your identity provider&#39;s web certificate.
     * 
     */
     ...
     * 
     */
    public List<GetClustersClusterOptionOpenIdConnectTokenAuthenticationConfigRequiredClaim> requiredClaims() {
    ...
    public static Builder builder(GetClustersClusterOptionOpenIdConnectTokenAuthenticationConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String usernamePrefix;
        public Builder() {}
        public Builder(GetClustersClusterOptionOpenIdConnectTokenAuthenticationConfig defaults) {
        ...
        public Builder caCertificate(String caCertificate) {
            if (caCertificate == null) {
              throw new MissingRequiredPropertyException("GetClustersClusterOptionOpenIdConnectTokenAuthenticationConfig", "caCertificate");
            }
        ...
        public Builder groupsClaim(String groupsClaim) {
            if (groupsClaim == null) {
              throw new MissingRequiredPropertyException("GetClustersClusterOptionOpenIdConnectTokenAuthenticationConfig", "groupsClaim");
            }
        ...
        public Builder groupsPrefix(String groupsPrefix) {
            if (groupsPrefix == null) {
              throw new MissingRequiredPropertyException("GetClustersClusterOptionOpenIdConnectTokenAuthenticationConfig", "groupsPrefix");
            }
        ...
        public Builder isOpenIdConnectAuthEnabled(Boolean isOpenIdConnectAuthEnabled) {
            if (isOpenIdConnectAuthEnabled == null) {
              throw new MissingRequiredPropertyException("GetClustersClusterOptionOpenIdConnectTokenAuthenticationConfig", "isOpenIdConnectAuthEnabled");
            }
        ...
        public Builder issuerUrl(String issuerUrl) {
            if (issuerUrl == null) {
              throw new MissingRequiredPropertyException("GetClustersClusterOptionOpenIdConnectTokenAuthenticationConfig", "issuerUrl");
            }
            this.issuerUrl = issuerUrl;
            return this;
        }
        @CustomType.Setter
        public Builder requiredClaims(List<GetClustersClusterOptionOpenIdConnectTokenAuthenticationConfigRequiredClaim> requiredClaims) {
            if (requiredClaims == null) {
              throw new MissingRequiredPropertyException("GetClustersClusterOptionOpenIdConnectTokenAuthenticationConfig", "requiredClaims");
            }
            this.requiredClaims = requiredClaims;
            return this;
        }
        public Builder requiredClaims(GetClustersClusterOptionOpenIdConnectTokenAuthenticationConfigRequiredClaim... requiredClaims) {
        ...
        public Builder signingAlgorithms(List<String> signingAlgorithms) {
            if (signingAlgorithms == null) {
              throw new MissingRequiredPropertyException("GetClustersClusterOptionOpenIdConnectTokenAuthenticationConfig", "signingAlgorithms");
            }
        ...
        public Builder usernameClaim(String usernameClaim) {
            if (usernameClaim == null) {
              throw new MissingRequiredPropertyException("GetClustersClusterOptionOpenIdConnectTokenAuthenticationConfig", "usernameClaim");
            }
        ...
        public Builder usernamePrefix(String usernamePrefix) {
            if (usernamePrefix == null) {
              throw new MissingRequiredPropertyException("GetClustersClusterOptionOpenIdConnectTokenAuthenticationConfig", "usernamePrefix");
            }
            this.usernamePrefix = usernamePrefix;
            return this;
        }
        public GetClustersClusterOptionOpenIdConnectTokenAuthenticationConfig build() {
