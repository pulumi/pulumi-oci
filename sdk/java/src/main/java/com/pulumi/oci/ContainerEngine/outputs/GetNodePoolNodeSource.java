...
public final class GetNodePoolNodeSource {
    ...
    public static final class Builder {
        ...
        public Builder imageId(String imageId) {
            if (imageId == null) {
              throw new MissingRequiredPropertyException("GetNodePoolNodeSource", "imageId");
            }
        ...
        public Builder sourceName(String sourceName) {
            if (sourceName == null) {
              throw new MissingRequiredPropertyException("GetNodePoolNodeSource", "sourceName");
            }
        ...
        public Builder sourceType(String sourceType) {
            if (sourceType == null) {
              throw new MissingRequiredPropertyException("GetNodePoolNodeSource", "sourceType");
            }
