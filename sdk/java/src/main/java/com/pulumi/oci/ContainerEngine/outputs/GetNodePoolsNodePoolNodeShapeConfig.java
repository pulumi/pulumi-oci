...
public final class GetNodePoolsNodePoolNodeShapeConfig {
    ...
    public static final class Builder {
        ...
        public Builder memoryInGbs(Double memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetNodePoolsNodePoolNodeShapeConfig", "memoryInGbs");
            }
        ...
        public Builder ocpus(Double ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetNodePoolsNodePoolNodeShapeConfig", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
