...
@CustomType
public final class GetPodShapesPodShapeMemoryOption {
    /**
    ...
    private GetPodShapesPodShapeMemoryOption() {}
    /**
     * @return The default amount of memory per OCPU available for this shape, in gigabytes.
     * 
     */
    ...
    public static Builder builder(GetPodShapesPodShapeMemoryOption defaults) {
    ...
    public static final class Builder {
        ...
        private Double minPerOcpuInGbs;
        public Builder() {}
        public Builder(GetPodShapesPodShapeMemoryOption defaults) {
        ...
        public Builder defaultPerOcpuInGbs(Double defaultPerOcpuInGbs) {
            if (defaultPerOcpuInGbs == null) {
              throw new MissingRequiredPropertyException("GetPodShapesPodShapeMemoryOption", "defaultPerOcpuInGbs");
            }
        ...
        public Builder maxInGbs(Double maxInGbs) {
            if (maxInGbs == null) {
              throw new MissingRequiredPropertyException("GetPodShapesPodShapeMemoryOption", "maxInGbs");
            }
        ...
        public Builder maxPerOcpuInGbs(Double maxPerOcpuInGbs) {
            if (maxPerOcpuInGbs == null) {
              throw new MissingRequiredPropertyException("GetPodShapesPodShapeMemoryOption", "maxPerOcpuInGbs");
            }
        ...
        public Builder minInGbs(Double minInGbs) {
            if (minInGbs == null) {
              throw new MissingRequiredPropertyException("GetPodShapesPodShapeMemoryOption", "minInGbs");
            }
        ...
        public Builder minPerOcpuInGbs(Double minPerOcpuInGbs) {
            if (minPerOcpuInGbs == null) {
              throw new MissingRequiredPropertyException("GetPodShapesPodShapeMemoryOption", "minPerOcpuInGbs");
            }
