...
import com.pulumi.oci.Core.outputs.BootVolumeBackupRetentionPeriod;
...
public class BootVolumeBackup extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="retentionPeriod", refs={BootVolumeBackupRetentionPeriod.class}, tree="[0]")
    private Output<BootVolumeBackupRetentionPeriod> retentionPeriod;
     ...
     * 
     */
    public Output<BootVolumeBackupRetentionPeriod> retentionPeriod() {
     ...
     */
    public BootVolumeBackup(java.lang.String name) {
     ...
     */
    public BootVolumeBackup(java.lang.String name, @Nullable BootVolumeBackupArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public BootVolumeBackup(java.lang.String name, @Nullable BootVolumeBackupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/bootVolumeBackup:BootVolumeBackup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private BootVolumeBackup(java.lang.String name, Output<java.lang.String> id, @Nullable BootVolumeBackupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/bootVolumeBackup:BootVolumeBackup", name, state, makeResourceOptions(options, id), false);
    }

    private static BootVolumeBackupArgs makeArgs(@Nullable BootVolumeBackupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? BootVolumeBackupArgs.Empty : args;
    }
     ...
     */
    public static BootVolumeBackup get(java.lang.String name, Output<java.lang.String> id, @Nullable BootVolumeBackupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
