...
public class CaptureFilter extends com.pulumi.resources.CustomResource {
     ...
     */
    public CaptureFilter(java.lang.String name) {
     ...
     */
    public CaptureFilter(java.lang.String name, CaptureFilterArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CaptureFilter(java.lang.String name, CaptureFilterArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/captureFilter:CaptureFilter", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CaptureFilter(java.lang.String name, Output<java.lang.String> id, @Nullable CaptureFilterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/captureFilter:CaptureFilter", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static CaptureFilter get(java.lang.String name, Output<java.lang.String> id, @Nullable CaptureFilterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
