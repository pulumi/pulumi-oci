...
public class CrossConnect extends com.pulumi.resources.CustomResource {
     ...
     */
    public CrossConnect(java.lang.String name, CrossConnectArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CrossConnect(java.lang.String name, CrossConnectArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/crossConnect:CrossConnect", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private CrossConnect(java.lang.String name, Output<java.lang.String> id, @Nullable CrossConnectState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/crossConnect:CrossConnect", name, state, makeResourceOptions(options, id), false);
    }
