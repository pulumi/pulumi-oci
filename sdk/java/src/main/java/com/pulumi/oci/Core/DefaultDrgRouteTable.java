...
import com.pulumi.oci.Core.inputs.DefaultDrgRouteTableState;
 ...
 * 
 */
@ResourceType(type="oci:Core/defaultDrgRouteTable:DefaultDrgRouteTable")
public class DefaultDrgRouteTable extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public DefaultDrgRouteTable(java.lang.String name) {
        this(name, DefaultDrgRouteTableArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public DefaultDrgRouteTable(java.lang.String name, DefaultDrgRouteTableArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DefaultDrgRouteTable(java.lang.String name, DefaultDrgRouteTableArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/defaultDrgRouteTable:DefaultDrgRouteTable", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DefaultDrgRouteTable(java.lang.String name, Output<java.lang.String> id, @Nullable DefaultDrgRouteTableState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/defaultDrgRouteTable:DefaultDrgRouteTable", name, state, makeResourceOptions(options, id), false);
    }

    private static DefaultDrgRouteTableArgs makeArgs(DefaultDrgRouteTableArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? DefaultDrgRouteTableArgs.Empty : args;
    }
     ...
     */
    public static DefaultDrgRouteTable get(java.lang.String name, Output<java.lang.String> id, @Nullable DefaultDrgRouteTableState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
