...
public class Drg extends com.pulumi.resources.CustomResource {
     ...
     */
    public Drg(java.lang.String name) {
     ...
     */
    public Drg(java.lang.String name, DrgArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Drg(java.lang.String name, DrgArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/drg:Drg", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Drg(java.lang.String name, Output<java.lang.String> id, @Nullable DrgState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/drg:Drg", name, state, makeResourceOptions(options, id), false);
    }

    private static DrgArgs makeArgs(DrgArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? DrgArgs.Empty : args;
    }
     ...
     */
    public static Drg get(java.lang.String name, Output<java.lang.String> id, @Nullable DrgState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
