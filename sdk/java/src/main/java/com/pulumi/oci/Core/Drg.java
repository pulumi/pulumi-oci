...
public class Drg extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ List<DrgDefaultDrgRouteTable>> defaultDrgRouteTables;

    /**
     * @return The default DRG route table for this DRG. Each network type has a default DRG route table.
     * 
     */
    public Output<Optional<List<DrgDefaultDrgRouteTable>>> defaultDrgRouteTables() {
        return Codegen.optional(this.defaultDrgRouteTables);
    }
    /**
    ...
    private Output</* @Nullable */ String> defaultExportDrgRouteDistributionId;
     ...
     * 
     */
    public Output<Optional<String>> defaultExportDrgRouteDistributionId() {
        return Codegen.optional(this.defaultExportDrgRouteDistributionId);
    }
    /**
    ...
    private Output</* @Nullable */ String> redundancyStatus;

    /**
     * @return The redundancy status of the DRG specified.
     * 
     */
    public Output<Optional<String>> redundancyStatus() {
        return Codegen.optional(this.redundancyStatus);
    }
    /**
