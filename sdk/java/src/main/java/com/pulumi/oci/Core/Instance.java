...
import com.pulumi.oci.Core.outputs.InstancePlacementConstraintDetails;
...
public class Instance extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="isAiEnterpriseEnabled", refs={Boolean.class}, tree="[0]")
    private Output<Boolean> isAiEnterpriseEnabled;

    /**
     * @return (Updatable) Whether to enable AI enterprise on the instance.
     * 
     */
    public Output<Boolean> isAiEnterpriseEnabled() {
     ...
     * 
     */
    @Export(name="placementConstraintDetails", refs={InstancePlacementConstraintDetails.class}, tree="[0]")
    private Output<InstancePlacementConstraintDetails> placementConstraintDetails;
     ...
     * 
     */
    public Output<InstancePlacementConstraintDetails> placementConstraintDetails() {
    ...
    public Instance(java.lang.String name, InstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/instance:Instance", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Instance(java.lang.String name, Output<java.lang.String> id, @Nullable InstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/instance:Instance", name, state, makeResourceOptions(options, id), false);
    }
