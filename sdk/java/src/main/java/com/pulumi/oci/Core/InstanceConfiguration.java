...
import com.pulumi.oci.Core.outputs.InstanceConfigurationGmcConfigs;
...
public class InstanceConfiguration extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="gmcConfigs", refs={InstanceConfigurationGmcConfigs.class}, tree="[0]")
    private Output</* @Nullable */ InstanceConfigurationGmcConfigs> gmcConfigs;

    /**
     * @return The GPU Memory Cluster configuration entries for.
     * 
     */
    public Output<Optional<InstanceConfigurationGmcConfigs>> gmcConfigs() {
        return Codegen.optional(this.gmcConfigs);
    }
