...
public class IpsecConnectionTunnelManagement extends com.pulumi.resources.CustomResource {
     ...
     */
    public IpsecConnectionTunnelManagement(java.lang.String name) {
     ...
     */
    public IpsecConnectionTunnelManagement(java.lang.String name, IpsecConnectionTunnelManagementArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public IpsecConnectionTunnelManagement(java.lang.String name, IpsecConnectionTunnelManagementArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/ipsecConnectionTunnelManagement:IpsecConnectionTunnelManagement", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private IpsecConnectionTunnelManagement(java.lang.String name, Output<java.lang.String> id, @Nullable IpsecConnectionTunnelManagementState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/ipsecConnectionTunnelManagement:IpsecConnectionTunnelManagement", name, state, makeResourceOptions(options, id), false);
    }

    private static IpsecConnectionTunnelManagementArgs makeArgs(IpsecConnectionTunnelManagementArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? IpsecConnectionTunnelManagementArgs.Empty : args;
    }
     ...
     */
    public static IpsecConnectionTunnelManagement get(java.lang.String name, Output<java.lang.String> id, @Nullable IpsecConnectionTunnelManagementState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
