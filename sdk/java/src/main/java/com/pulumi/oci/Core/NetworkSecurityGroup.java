...
import com.pulumi.oci.Core.inputs.NetworkSecurityGroupState;
 ...
 * 
 */
@ResourceType(type="oci:Core/networkSecurityGroup:NetworkSecurityGroup")
public class NetworkSecurityGroup extends com.pulumi.resources.CustomResource {
    ...
    public NetworkSecurityGroup(String name, NetworkSecurityGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/networkSecurityGroup:NetworkSecurityGroup", name, args == null ? NetworkSecurityGroupArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private NetworkSecurityGroup(String name, Output<String> id, @Nullable NetworkSecurityGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/networkSecurityGroup:NetworkSecurityGroup", name, state, makeResourceOptions(options, id));
    }
