...
public class PrivateIp extends com.pulumi.resources.CustomResource {
     ...
     */
    public PrivateIp(java.lang.String name) {
     ...
     */
    public PrivateIp(java.lang.String name, @Nullable PrivateIpArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public PrivateIp(java.lang.String name, @Nullable PrivateIpArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/privateIp:PrivateIp", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private PrivateIp(java.lang.String name, Output<java.lang.String> id, @Nullable PrivateIpState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/privateIp:PrivateIp", name, state, makeResourceOptions(options, id), false);
    }

    private static PrivateIpArgs makeArgs(@Nullable PrivateIpArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? PrivateIpArgs.Empty : args;
    }
     ...
     */
    public static PrivateIp get(java.lang.String name, Output<java.lang.String> id, @Nullable PrivateIpState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
