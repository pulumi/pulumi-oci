...
public class Vcn extends com.pulumi.resources.CustomResource {
     ...
     */
    public Vcn(java.lang.String name) {
     ...
     */
    public Vcn(java.lang.String name, VcnArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Vcn(java.lang.String name, VcnArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/vcn:Vcn", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Vcn(java.lang.String name, Output<java.lang.String> id, @Nullable VcnState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/vcn:Vcn", name, state, makeResourceOptions(options, id), false);
    }

    private static VcnArgs makeArgs(VcnArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? VcnArgs.Empty : args;
    }
     ...
     */
    public static Vcn get(java.lang.String name, Output<java.lang.String> id, @Nullable VcnState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
