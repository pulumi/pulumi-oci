...
public class VolumeBackup extends com.pulumi.resources.CustomResource {
     ...
     */
    public VolumeBackup(java.lang.String name, @Nullable VolumeBackupArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public VolumeBackup(java.lang.String name, @Nullable VolumeBackupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/volumeBackup:VolumeBackup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private VolumeBackup(java.lang.String name, Output<java.lang.String> id, @Nullable VolumeBackupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Core/volumeBackup:VolumeBackup", name, state, makeResourceOptions(options, id), false);
    }

    private static VolumeBackupArgs makeArgs(@Nullable VolumeBackupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
