...
public final class BootVolumeAutotunePolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final BootVolumeAutotunePolicyArgs Empty = new BootVolumeAutotunePolicyArgs();
    ...
    private BootVolumeAutotunePolicyArgs() {}

    private BootVolumeAutotunePolicyArgs(BootVolumeAutotunePolicyArgs $) {
    ...
    public static Builder builder(BootVolumeAutotunePolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BootVolumeAutotunePolicyArgs();
        }

        public Builder(BootVolumeAutotunePolicyArgs defaults) {
            $ = new BootVolumeAutotunePolicyArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BootVolumeAutotunePolicyArgs build() {
            if ($.autotuneType == null) {
                throw new MissingRequiredPropertyException("BootVolumeAutotunePolicyArgs", "autotuneType");
            }
            return $;
        }
    }
