...
public final class ClusterNetworkPlacementConfigurationSecondaryVnicSubnetArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<ClusterNetworkPlacementConfigurationSecondaryVnicSubnetIpv6addressIpv6subnetCidrPairDetailArgs>> ipv6addressIpv6subnetCidrPairDetails;
     ...
     * 
     */
    public Optional<Output<List<ClusterNetworkPlacementConfigurationSecondaryVnicSubnetIpv6addressIpv6subnetCidrPairDetailArgs>>> ipv6addressIpv6subnetCidrPairDetails() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder ipv6addressIpv6subnetCidrPairDetails(@Nullable Output<List<ClusterNetworkPlacementConfigurationSecondaryVnicSubnetIpv6addressIpv6subnetCidrPairDetailArgs>> ipv6addressIpv6subnetCidrPairDetails) {
         ...
         * 
         */
        public Builder ipv6addressIpv6subnetCidrPairDetails(List<ClusterNetworkPlacementConfigurationSecondaryVnicSubnetIpv6addressIpv6subnetCidrPairDetailArgs> ipv6addressIpv6subnetCidrPairDetails) {
         ...
         * 
         */
        public Builder ipv6addressIpv6subnetCidrPairDetails(ClusterNetworkPlacementConfigurationSecondaryVnicSubnetIpv6addressIpv6subnetCidrPairDetailArgs... ipv6addressIpv6subnetCidrPairDetails) {
        ...
        public ClusterNetworkPlacementConfigurationSecondaryVnicSubnetArgs build() {
            if ($.subnetId == null) {
                throw new MissingRequiredPropertyException("ClusterNetworkPlacementConfigurationSecondaryVnicSubnetArgs", "subnetId");
            }
            return $;
        }
    }
