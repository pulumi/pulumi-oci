...
public final class CpeState extends com.pulumi.resources.ResourceArgs {

    public static final CpeState Empty = new CpeState();
    ...
    public static Builder builder(CpeState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(CpeState defaults) {
            $ = new CpeState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param timeCreated The date and time the CPE was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
         * 
         * @return builder
         * 
         */
