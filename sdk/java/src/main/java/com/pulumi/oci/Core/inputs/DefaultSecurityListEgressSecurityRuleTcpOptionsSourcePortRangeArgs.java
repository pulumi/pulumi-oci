...
public final class DefaultSecurityListEgressSecurityRuleTcpOptionsSourcePortRangeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public DefaultSecurityListEgressSecurityRuleTcpOptionsSourcePortRangeArgs build() {
            if ($.max == null) {
                throw new MissingRequiredPropertyException("DefaultSecurityListEgressSecurityRuleTcpOptionsSourcePortRangeArgs", "max");
            }
            if ($.min == null) {
                throw new MissingRequiredPropertyException("DefaultSecurityListEgressSecurityRuleTcpOptionsSourcePortRangeArgs", "min");
            }
            return $;
        }
    }
