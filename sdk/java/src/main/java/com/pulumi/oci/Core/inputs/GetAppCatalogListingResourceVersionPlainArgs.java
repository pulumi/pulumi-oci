...
public final class GetAppCatalogListingResourceVersionPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetAppCatalogListingResourceVersionPlainArgs build() {
            if ($.listingId == null) {
                throw new MissingRequiredPropertyException("GetAppCatalogListingResourceVersionPlainArgs", "listingId");
            }
            if ($.resourceVersion == null) {
                throw new MissingRequiredPropertyException("GetAppCatalogListingResourceVersionPlainArgs", "resourceVersion");
            }
            return $;
        }
    }
