...
import com.pulumi.oci.Core.inputs.GetBlockVolumeReplicasFilterArgs;
...
public final class GetBlockVolumeReplicasArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetBlockVolumeReplicasArgs Empty = new GetBlockVolumeReplicasArgs();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetBlockVolumeReplicasFilterArgs>> filters;

    public Optional<Output<List<GetBlockVolumeReplicasFilterArgs>>> filters() {
    ...
    private GetBlockVolumeReplicasArgs(GetBlockVolumeReplicasArgs $) {
    ...
    public static Builder builder(GetBlockVolumeReplicasArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetBlockVolumeReplicasArgs();
        }

        public Builder(GetBlockVolumeReplicasArgs defaults) {
            $ = new GetBlockVolumeReplicasArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetBlockVolumeReplicasFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetBlockVolumeReplicasFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetBlockVolumeReplicasFilterArgs... filters) {
        ...
        public GetBlockVolumeReplicasArgs build() {
            return $;
        }
    }
