    ...
    public static final class Builder {
        ...
        public GetBootVolumeAttachmentsArgs build() {
            if ($.availabilityDomain == null) {
                throw new MissingRequiredPropertyException("GetBootVolumeAttachmentsArgs", "availabilityDomain");
            }
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetBootVolumeAttachmentsArgs", "compartmentId");
            }
            return $;
        }
    }
