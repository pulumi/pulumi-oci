    ...
    public static final class Builder {
        ...
        public GetBootVolumeAttachmentsPlainArgs build() {
            if ($.availabilityDomain == null) {
                throw new MissingRequiredPropertyException("GetBootVolumeAttachmentsPlainArgs", "availabilityDomain");
            }
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetBootVolumeAttachmentsPlainArgs", "compartmentId");
            }
            return $;
        }
    }
