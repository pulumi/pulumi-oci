...
public final class GetIpsecConnectionTunnelArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetIpsecConnectionTunnelArgs build() {
            if ($.ipsecId == null) {
                throw new MissingRequiredPropertyException("GetIpsecConnectionTunnelArgs", "ipsecId");
            }
            if ($.tunnelId == null) {
                throw new MissingRequiredPropertyException("GetIpsecConnectionTunnelArgs", "tunnelId");
            }
            return $;
        }
    }
