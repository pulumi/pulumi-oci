...
public final class GetIpsecConnectionTunnelErrorArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetIpsecConnectionTunnelErrorArgs build() {
            if ($.ipsecId == null) {
                throw new MissingRequiredPropertyException("GetIpsecConnectionTunnelErrorArgs", "ipsecId");
            }
            if ($.tunnelId == null) {
                throw new MissingRequiredPropertyException("GetIpsecConnectionTunnelErrorArgs", "tunnelId");
            }
            return $;
        }
    }
