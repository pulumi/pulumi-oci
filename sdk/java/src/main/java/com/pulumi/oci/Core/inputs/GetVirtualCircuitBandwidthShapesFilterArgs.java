...
public final class GetVirtualCircuitBandwidthShapesFilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public GetVirtualCircuitBandwidthShapesFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetVirtualCircuitBandwidthShapesFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetVirtualCircuitBandwidthShapesFilterArgs", "values");
            }
            return $;
        }
    }
