...
import com.pulumi.oci.Core.inputs.InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsAutotunePolicyArgs;
import com.pulumi.oci.Core.inputs.InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsBlockVolumeReplicasArgs;
import com.pulumi.oci.Core.inputs.InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsSourceDetailsArgs;
...
public final class InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsArgs Empty = new InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsArgs();
    ...
    private @Nullable Output<List<InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsAutotunePolicyArgs>> autotunePolicies;

    /**
     * @return The list of autotune policies enabled for this volume.
     * 
     */
    public Optional<Output<List<InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsAutotunePolicyArgs>>> autotunePolicies() {
    ...
    private @Nullable Output<InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsBlockVolumeReplicasArgs> blockVolumeReplicas;

    /**
     * @return The list of block volume replicas to be enabled for this volume in the specified destination availability domains.
     * 
     */
    public Optional<Output<InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsBlockVolumeReplicasArgs>> blockVolumeReplicas() {
    ...
    private @Nullable Output<InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsSourceDetailsArgs> sourceDetails;

    public Optional<Output<InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsSourceDetailsArgs>> sourceDetails() {
    ...
    private InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsArgs() {}

    private InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsArgs(InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsArgs $) {
    ...
    public static Builder builder(InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsArgs();
        }

        public Builder(InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsArgs defaults) {
            $ = new InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder autotunePolicies(@Nullable Output<List<InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsAutotunePolicyArgs>> autotunePolicies) {
         ...
         * 
         */
        public Builder autotunePolicies(List<InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsAutotunePolicyArgs> autotunePolicies) {
         ...
         * 
         */
        public Builder autotunePolicies(InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsAutotunePolicyArgs... autotunePolicies) {
            return autotunePolicies(List.of(autotunePolicies));
        }

        /**
         * @param availabilityDomain The availability domain of the volume.  Example: `Uocm:PHX-AD-1`
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder blockVolumeReplicas(@Nullable Output<InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsBlockVolumeReplicasArgs> blockVolumeReplicas) {
         ...
         * 
         */
        public Builder blockVolumeReplicas(InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsBlockVolumeReplicasArgs blockVolumeReplicas) {
        ...
        public Builder sourceDetails(@Nullable Output<InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsSourceDetailsArgs> sourceDetails) {
            $.sourceDetails = sourceDetails;
            return this;
        }

        public Builder sourceDetails(InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsSourceDetailsArgs sourceDetails) {
        ...
        public InstanceConfigurationInstanceDetailsOptionBlockVolumeCreateDetailsArgs build() {
            return $;
        }
    }
