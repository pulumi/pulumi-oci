...
public final class InstanceConfigurationInstanceDetailsOptionLaunchDetailsInstanceOptionsArgs extends com.pulumi.resources.ResourceArgs {

    public static final InstanceConfigurationInstanceDetailsOptionLaunchDetailsInstanceOptionsArgs Empty = new InstanceConfigurationInstanceDetailsOptionLaunchDetailsInstanceOptionsArgs();
    ...
    private InstanceConfigurationInstanceDetailsOptionLaunchDetailsInstanceOptionsArgs() {}

    private InstanceConfigurationInstanceDetailsOptionLaunchDetailsInstanceOptionsArgs(InstanceConfigurationInstanceDetailsOptionLaunchDetailsInstanceOptionsArgs $) {
    ...
    public static Builder builder(InstanceConfigurationInstanceDetailsOptionLaunchDetailsInstanceOptionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigurationInstanceDetailsOptionLaunchDetailsInstanceOptionsArgs();
        }

        public Builder(InstanceConfigurationInstanceDetailsOptionLaunchDetailsInstanceOptionsArgs defaults) {
            $ = new InstanceConfigurationInstanceDetailsOptionLaunchDetailsInstanceOptionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InstanceConfigurationInstanceDetailsOptionLaunchDetailsInstanceOptionsArgs build() {
            return $;
        }
    }
