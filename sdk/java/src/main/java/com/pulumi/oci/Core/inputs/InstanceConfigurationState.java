...
public final class InstanceConfigurationState extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="deferredFields")
    private @Nullable Output<List<String>> deferredFields;
     ...
     * 
     */
    public Optional<Output<List<String>>> deferredFields() {
        return Optional.ofNullable(this.deferredFields);
    }
    ...
    private InstanceConfigurationState() {}

    private InstanceConfigurationState(InstanceConfigurationState $) {
    ...
    public static Builder builder(InstanceConfigurationState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InstanceConfigurationState();
        }

        public Builder(InstanceConfigurationState defaults) {
            $ = new InstanceConfigurationState(Objects.requireNonNull(defaults));
        }
        ...
        public Builder deferredFields(List<String> deferredFields) {
            return deferredFields(Output.of(deferredFields));
        }
        ...
        /**
         * @param timeCreated The date and time the instance configuration was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
         * 
         * @return builder
         * 
         */
        ...
        public InstanceConfigurationState build() {
            return $;
        }
    }
