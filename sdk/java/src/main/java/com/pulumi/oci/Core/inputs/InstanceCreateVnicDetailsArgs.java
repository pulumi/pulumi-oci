...
public final class InstanceCreateVnicDetailsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<InstanceCreateVnicDetailsIpv6addressIpv6subnetCidrPairDetailArgs>> ipv6addressIpv6subnetCidrPairDetails;
     ...
     * 
     */
    public Optional<Output<List<InstanceCreateVnicDetailsIpv6addressIpv6subnetCidrPairDetailArgs>>> ipv6addressIpv6subnetCidrPairDetails() {
    ...
    public static final class Builder {
        ...
        /**
         * @param assignPrivateDnsRecord Whether the VNIC should be assigned a DNS record. If set to false, there will be no DNS record registration for the VNIC. If set to true, the DNS record will be registered. The default value is true.
         * If you specify a `hostnameLabel`, the `assignPrivateDnsRecord` is require to be set to true.
         * 
         * @return builder
         * 
         ...
         * 
         */
        public Builder ipv6addressIpv6subnetCidrPairDetails(@Nullable Output<List<InstanceCreateVnicDetailsIpv6addressIpv6subnetCidrPairDetailArgs>> ipv6addressIpv6subnetCidrPairDetails) {
         ...
         * 
         */
        public Builder ipv6addressIpv6subnetCidrPairDetails(List<InstanceCreateVnicDetailsIpv6addressIpv6subnetCidrPairDetailArgs> ipv6addressIpv6subnetCidrPairDetails) {
         ...
         * 
         */
        public Builder ipv6addressIpv6subnetCidrPairDetails(InstanceCreateVnicDetailsIpv6addressIpv6subnetCidrPairDetailArgs... ipv6addressIpv6subnetCidrPairDetails) {
        ...
        /**
         * @param securityAttributes Security Attributes for this resource. This is unique to ZPR, and helps identify which resources are allowed to be accessed by what permission controls.  Example: `{&#34;Oracle-DataSecurity-ZPR.MaxEgressCount.value&#34;: &#34;42&#34;, &#34;Oracle-DataSecurity-ZPR.MaxEgressCount.mode&#34;: &#34;audit&#34;}`
         * 
         * @return builder
         * 
         */
