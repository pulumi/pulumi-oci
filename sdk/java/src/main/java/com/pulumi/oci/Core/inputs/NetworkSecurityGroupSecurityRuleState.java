...
public final class NetworkSecurityGroupSecurityRuleState extends com.pulumi.resources.ResourceArgs {

    public static final NetworkSecurityGroupSecurityRuleState Empty = new NetworkSecurityGroupSecurityRuleState();
    ...
    private NetworkSecurityGroupSecurityRuleState() {}

    private NetworkSecurityGroupSecurityRuleState(NetworkSecurityGroupSecurityRuleState $) {
    ...
    public static Builder builder(NetworkSecurityGroupSecurityRuleState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new NetworkSecurityGroupSecurityRuleState();
        }

        public Builder(NetworkSecurityGroupSecurityRuleState defaults) {
            $ = new NetworkSecurityGroupSecurityRuleState(Objects.requireNonNull(defaults));
        }

        /**
         * @param description An optional description of your choice for the rule.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param isValid Whether the rule is valid. The value is `True` when the rule is first created. If the rule&#39;s `source` or `destination` is a network security group, the value changes to `False` if that network security group is deleted.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param timeCreated The date and time the security rule was created. Format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
         * 
         * @return builder
         * 
         */
        ...
        public NetworkSecurityGroupSecurityRuleState build() {
            return $;
        }
    }
