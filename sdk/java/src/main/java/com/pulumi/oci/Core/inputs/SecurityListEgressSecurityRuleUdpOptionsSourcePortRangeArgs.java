...
public final class SecurityListEgressSecurityRuleUdpOptionsSourcePortRangeArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public SecurityListEgressSecurityRuleUdpOptionsSourcePortRangeArgs build() {
            if ($.max == null) {
                throw new MissingRequiredPropertyException("SecurityListEgressSecurityRuleUdpOptionsSourcePortRangeArgs", "max");
            }
            if ($.min == null) {
                throw new MissingRequiredPropertyException("SecurityListEgressSecurityRuleUdpOptionsSourcePortRangeArgs", "min");
            }
            return $;
        }
    }
