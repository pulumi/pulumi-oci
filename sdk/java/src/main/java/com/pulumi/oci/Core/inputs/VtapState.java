...
public final class VtapState extends com.pulumi.resources.ResourceArgs {

    public static final VtapState Empty = new VtapState();

    /**
     * (Updatable) The capture filter&#39;s Oracle ID ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)).
     * 
     */
    @Import(name="captureFilterId")
    private @Nullable Output<String> captureFilterId;
     ...
     * 
     */
    public Optional<Output<String>> captureFilterId() {
    ...
    public static Builder builder(VtapState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(VtapState defaults) {
            $ = new VtapState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder captureFilterId(@Nullable Output<String> captureFilterId) {
        ...
        /**
         * @param lifecycleStateDetails The VTAP&#39;s current running state.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param state The VTAP&#39;s administrative lifecycle state.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param timeCreated The date and time the VTAP was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2020-08-25T21:10:29.600Z`
         * 
         * @return builder
         * 
         */
