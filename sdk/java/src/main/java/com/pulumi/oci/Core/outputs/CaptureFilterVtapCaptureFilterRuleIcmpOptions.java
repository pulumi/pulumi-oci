...
@CustomType
public final class CaptureFilterVtapCaptureFilterRuleIcmpOptions {
    /**
    ...
    public static final class Builder {
        ...
        public Builder type(Integer type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("CaptureFilterVtapCaptureFilterRuleIcmpOptions", "type");
            }
            this.type = type;
            return this;
        }
