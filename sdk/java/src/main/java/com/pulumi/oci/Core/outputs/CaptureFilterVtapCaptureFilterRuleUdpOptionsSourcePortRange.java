...
@CustomType
public final class CaptureFilterVtapCaptureFilterRuleUdpOptionsSourcePortRange {
    /**
    ...
    public static final class Builder {
        ...
        public Builder max(Integer max) {
            if (max == null) {
              throw new MissingRequiredPropertyException("CaptureFilterVtapCaptureFilterRuleUdpOptionsSourcePortRange", "max");
            }
            this.max = max;
            return this;
        }
        ...
        public Builder min(Integer min) {
            if (min == null) {
              throw new MissingRequiredPropertyException("CaptureFilterVtapCaptureFilterRuleUdpOptionsSourcePortRange", "min");
            }
            this.min = min;
            return this;
        }
        public CaptureFilterVtapCaptureFilterRuleUdpOptionsSourcePortRange build() {
            final var _resultValue = new CaptureFilterVtapCaptureFilterRuleUdpOptionsSourcePortRange();
