...
import com.pulumi.oci.Core.outputs.ClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnetIpv6addressIpv6subnetCidrPairDetail;
...
@CustomType
public final class ClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnet {
    /**
     ...
     * 
     */
    private @Nullable List<ClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnetIpv6addressIpv6subnetCidrPairDetail> ipv6addressIpv6subnetCidrPairDetails;
    /**
    ...
    private ClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnet() {}
    /**
     * @return A list of IPv6 prefix ranges from which the VNIC should be assigned an IPv6 address. You can provide only the prefix ranges and Oracle Cloud Infrastructure will select an available address from the range. You can optionally choose to leave the prefix range empty and instead provide the specific IPv6 address that should be used from within that range.
     * 
     */
    public List<ClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnetIpv6addressIpv6subnetCidrPairDetail> ipv6addressIpv6subnetCidrPairDetails() {
    ...
    public static Builder builder(ClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnet defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subnetId;
        public Builder() {}
        public Builder(ClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnet defaults) {
        ...
        public Builder ipv6addressIpv6subnetCidrPairDetails(ClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnetIpv6addressIpv6subnetCidrPairDetail... ipv6addressIpv6subnetCidrPairDetails) {
        ...
        public ClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnet build() {
            final var _resultValue = new ClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnet();
