...
@CustomType
public final class ClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnetIpv6addressIpv6subnetCidrPairDetail {
    /**
    ...
    private ClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnetIpv6addressIpv6subnetCidrPairDetail() {}
    /**
     * @return Optional. Used to disambiguate which subnet prefix should be used to create an IPv6 allocation.
     * 
     */
    ...
    public static Builder builder(ClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnetIpv6addressIpv6subnetCidrPairDetail defaults) {
    ...
    public static final class Builder {
        private @Nullable String ipv6subnetCidr;
        public Builder() {}
        public Builder(ClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnetIpv6addressIpv6subnetCidrPairDetail defaults) {
