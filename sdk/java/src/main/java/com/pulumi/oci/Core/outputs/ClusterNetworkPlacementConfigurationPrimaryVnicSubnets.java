...
@CustomType
public final class ClusterNetworkPlacementConfigurationPrimaryVnicSubnets {
    /**
     ...
     * 
     */
    private @Nullable List<ClusterNetworkPlacementConfigurationPrimaryVnicSubnetsIpv6addressIpv6subnetCidrPairDetail> ipv6addressIpv6subnetCidrPairDetails;
    /**
    ...
    private ClusterNetworkPlacementConfigurationPrimaryVnicSubnets() {}
    /**
     * @return A list of IPv6 prefix ranges from which the VNIC should be assigned an IPv6 address. You can provide only the prefix ranges and Oracle Cloud Infrastructure will select an available address from the range. You can optionally choose to leave the prefix range empty and instead provide the specific IPv6 address that should be used from within that range.
     * 
     */
    public List<ClusterNetworkPlacementConfigurationPrimaryVnicSubnetsIpv6addressIpv6subnetCidrPairDetail> ipv6addressIpv6subnetCidrPairDetails() {
    ...
    public static Builder builder(ClusterNetworkPlacementConfigurationPrimaryVnicSubnets defaults) {
    ...
    public static final class Builder {
        ...
        private String subnetId;
        public Builder() {}
        public Builder(ClusterNetworkPlacementConfigurationPrimaryVnicSubnets defaults) {
        ...
        public Builder ipv6addressIpv6subnetCidrPairDetails(ClusterNetworkPlacementConfigurationPrimaryVnicSubnetsIpv6addressIpv6subnetCidrPairDetail... ipv6addressIpv6subnetCidrPairDetails) {
        ...
        public ClusterNetworkPlacementConfigurationPrimaryVnicSubnets build() {
            final var _resultValue = new ClusterNetworkPlacementConfigurationPrimaryVnicSubnets();
