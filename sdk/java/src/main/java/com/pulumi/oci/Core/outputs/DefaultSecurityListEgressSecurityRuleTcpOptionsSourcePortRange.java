...
public final class DefaultSecurityListEgressSecurityRuleTcpOptionsSourcePortRange {
    ...
    public static final class Builder {
        ...
        public Builder max(Integer max) {
            if (max == null) {
              throw new MissingRequiredPropertyException("DefaultSecurityListEgressSecurityRuleTcpOptionsSourcePortRange", "max");
            }
            this.max = max;
            return this;
        }
        ...
        public Builder min(Integer min) {
            if (min == null) {
              throw new MissingRequiredPropertyException("DefaultSecurityListEgressSecurityRuleTcpOptionsSourcePortRange", "min");
            }
            this.min = min;
            return this;
        }
        public DefaultSecurityListEgressSecurityRuleTcpOptionsSourcePortRange build() {
            final var _resultValue = new DefaultSecurityListEgressSecurityRuleTcpOptionsSourcePortRange();
