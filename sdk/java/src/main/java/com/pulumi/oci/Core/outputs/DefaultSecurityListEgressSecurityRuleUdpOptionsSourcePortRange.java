...
public final class DefaultSecurityListEgressSecurityRuleUdpOptionsSourcePortRange {
    ...
    public static final class Builder {
        ...
        public Builder max(Integer max) {
            if (max == null) {
              throw new MissingRequiredPropertyException("DefaultSecurityListEgressSecurityRuleUdpOptionsSourcePortRange", "max");
            }
            this.max = max;
            return this;
        }
        ...
        public Builder min(Integer min) {
            if (min == null) {
              throw new MissingRequiredPropertyException("DefaultSecurityListEgressSecurityRuleUdpOptionsSourcePortRange", "min");
            }
            this.min = min;
            return this;
        }
        public DefaultSecurityListEgressSecurityRuleUdpOptionsSourcePortRange build() {
            final var _resultValue = new DefaultSecurityListEgressSecurityRuleUdpOptionsSourcePortRange();
