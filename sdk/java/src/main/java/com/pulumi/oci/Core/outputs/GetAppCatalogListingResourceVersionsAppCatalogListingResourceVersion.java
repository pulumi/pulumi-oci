    ...
    public static final class Builder {
        ...
        public Builder accessiblePorts(List<Integer> accessiblePorts) {
            if (accessiblePorts == null) {
              throw new MissingRequiredPropertyException("GetAppCatalogListingResourceVersionsAppCatalogListingResourceVersion", "accessiblePorts");
            }
        ...
        public Builder allowedActions(List<String> allowedActions) {
            if (allowedActions == null) {
              throw new MissingRequiredPropertyException("GetAppCatalogListingResourceVersionsAppCatalogListingResourceVersion", "allowedActions");
            }
        ...
        public Builder availableRegions(List<String> availableRegions) {
            if (availableRegions == null) {
              throw new MissingRequiredPropertyException("GetAppCatalogListingResourceVersionsAppCatalogListingResourceVersion", "availableRegions");
            }
        ...
        public Builder compatibleShapes(List<String> compatibleShapes) {
            if (compatibleShapes == null) {
              throw new MissingRequiredPropertyException("GetAppCatalogListingResourceVersionsAppCatalogListingResourceVersion", "compatibleShapes");
            }
        ...
        public Builder listingId(String listingId) {
            if (listingId == null) {
              throw new MissingRequiredPropertyException("GetAppCatalogListingResourceVersionsAppCatalogListingResourceVersion", "listingId");
            }
        ...
        public Builder listingResourceId(String listingResourceId) {
            if (listingResourceId == null) {
              throw new MissingRequiredPropertyException("GetAppCatalogListingResourceVersionsAppCatalogListingResourceVersion", "listingResourceId");
            }
        ...
        public Builder listingResourceVersion(String listingResourceVersion) {
            if (listingResourceVersion == null) {
              throw new MissingRequiredPropertyException("GetAppCatalogListingResourceVersionsAppCatalogListingResourceVersion", "listingResourceVersion");
            }
        ...
        public Builder timePublished(String timePublished) {
            if (timePublished == null) {
              throw new MissingRequiredPropertyException("GetAppCatalogListingResourceVersionsAppCatalogListingResourceVersion", "timePublished");
            }
            this.timePublished = timePublished;
            return this;
        }
        public GetAppCatalogListingResourceVersionsAppCatalogListingResourceVersion build() {
            final var _resultValue = new GetAppCatalogListingResourceVersionsAppCatalogListingResourceVersion();
