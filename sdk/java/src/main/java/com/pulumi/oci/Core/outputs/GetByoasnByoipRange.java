...
@CustomType
public final class GetByoasnByoipRange {
    /**
    ...
    public static Builder builder(GetByoasnByoipRange defaults) {
    ...
    public static final class Builder {
        ...
        private String ipv6cidrBlock;
        public Builder() {}
        public Builder(GetByoasnByoipRange defaults) {
        ...
        public Builder asPathPrependLength(Integer asPathPrependLength) {
            if (asPathPrependLength == null) {
              throw new MissingRequiredPropertyException("GetByoasnByoipRange", "asPathPrependLength");
            }
        ...
        public Builder byoipRangeId(String byoipRangeId) {
            if (byoipRangeId == null) {
              throw new MissingRequiredPropertyException("GetByoasnByoipRange", "byoipRangeId");
            }
        ...
        public Builder cidrBlock(String cidrBlock) {
            if (cidrBlock == null) {
              throw new MissingRequiredPropertyException("GetByoasnByoipRange", "cidrBlock");
            }
        ...
        public Builder ipv6cidrBlock(String ipv6cidrBlock) {
            if (ipv6cidrBlock == null) {
              throw new MissingRequiredPropertyException("GetByoasnByoipRange", "ipv6cidrBlock");
            }
            this.ipv6cidrBlock = ipv6cidrBlock;
            return this;
        }
        public GetByoasnByoipRange build() {
            final var _resultValue = new GetByoasnByoipRange();
