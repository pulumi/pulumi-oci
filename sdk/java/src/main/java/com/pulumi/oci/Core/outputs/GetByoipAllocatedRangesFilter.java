...
@CustomType
public final class GetByoipAllocatedRangesFilter {
    private String name;
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetByoipAllocatedRangesFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetByoipAllocatedRangesFilter", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetByoipAllocatedRangesFilter build() {
            final var _resultValue = new GetByoipAllocatedRangesFilter();
