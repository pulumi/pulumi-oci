...
@CustomType
public final class GetByoipRangesByoipRangeCollectionItemOriginAsn {
    /**
    ...
    private GetByoipRangesByoipRangeCollectionItemOriginAsn() {}
    /**
     * @return The as path prepend length.
     * 
     */
    ...
    public static Builder builder(GetByoipRangesByoipRangeCollectionItemOriginAsn defaults) {
    ...
    public static final class Builder {
        ...
        private String byoasnId;
        public Builder() {}
        public Builder(GetByoipRangesByoipRangeCollectionItemOriginAsn defaults) {
        ...
        public Builder asPathPrependLength(Integer asPathPrependLength) {
            if (asPathPrependLength == null) {
              throw new MissingRequiredPropertyException("GetByoipRangesByoipRangeCollectionItemOriginAsn", "asPathPrependLength");
            }
        ...
        public Builder asn(String asn) {
            if (asn == null) {
              throw new MissingRequiredPropertyException("GetByoipRangesByoipRangeCollectionItemOriginAsn", "asn");
            }
            this.asn = asn;
            return this;
        }
        ...
        public Builder byoasnId(String byoasnId) {
            if (byoasnId == null) {
              throw new MissingRequiredPropertyException("GetByoipRangesByoipRangeCollectionItemOriginAsn", "byoasnId");
            }
            this.byoasnId = byoasnId;
            return this;
        }
        public GetByoipRangesByoipRangeCollectionItemOriginAsn build() {
            final var _resultValue = new GetByoipRangesByoipRangeCollectionItemOriginAsn();
