...
public final class GetCaptureFilterVtapCaptureFilterRuleUdpOptionSourcePortRange {
    ...
    public static Builder builder(GetCaptureFilterVtapCaptureFilterRuleUdpOptionSourcePortRange defaults) {
    ...
    public static final class Builder {
        ...
        public Builder max(Integer max) {
            if (max == null) {
              throw new MissingRequiredPropertyException("GetCaptureFilterVtapCaptureFilterRuleUdpOptionSourcePortRange", "max");
            }
            this.max = max;
            return this;
        }
        ...
        public Builder min(Integer min) {
            if (min == null) {
              throw new MissingRequiredPropertyException("GetCaptureFilterVtapCaptureFilterRuleUdpOptionSourcePortRange", "min");
            }
            this.min = min;
            return this;
        }
        public GetCaptureFilterVtapCaptureFilterRuleUdpOptionSourcePortRange build() {
            final var _resultValue = new GetCaptureFilterVtapCaptureFilterRuleUdpOptionSourcePortRange();
