...
public final class GetClusterNetworkInstancePoolPlacementConfigurationSecondaryVnicSubnet {
    ...
    public static final class Builder {
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworkInstancePoolPlacementConfigurationSecondaryVnicSubnet", "displayName");
            }
        ...
        public Builder ipv6addressIpv6subnetCidrPairDetails(List<GetClusterNetworkInstancePoolPlacementConfigurationSecondaryVnicSubnetIpv6addressIpv6subnetCidrPairDetail> ipv6addressIpv6subnetCidrPairDetails) {
            if (ipv6addressIpv6subnetCidrPairDetails == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworkInstancePoolPlacementConfigurationSecondaryVnicSubnet", "ipv6addressIpv6subnetCidrPairDetails");
            }
        ...
        public Builder isAssignIpv6ip(Boolean isAssignIpv6ip) {
            if (isAssignIpv6ip == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworkInstancePoolPlacementConfigurationSecondaryVnicSubnet", "isAssignIpv6ip");
            }
        ...
        public Builder subnetId(String subnetId) {
            if (subnetId == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworkInstancePoolPlacementConfigurationSecondaryVnicSubnet", "subnetId");
            }
            this.subnetId = subnetId;
            return this;
        }
        public GetClusterNetworkInstancePoolPlacementConfigurationSecondaryVnicSubnet build() {
            final var _resultValue = new GetClusterNetworkInstancePoolPlacementConfigurationSecondaryVnicSubnet();
