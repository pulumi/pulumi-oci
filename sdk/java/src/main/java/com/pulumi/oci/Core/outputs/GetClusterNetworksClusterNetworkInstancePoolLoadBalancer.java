...
@CustomType
public final class GetClusterNetworksClusterNetworkInstancePoolLoadBalancer {
    /**
    ...
    private GetClusterNetworksClusterNetworkInstancePoolLoadBalancer() {}
    /**
     * @return The name of the backend set on the load balancer.
     * 
     */
    ...
    public static Builder builder(GetClusterNetworksClusterNetworkInstancePoolLoadBalancer defaults) {
    ...
    public static final class Builder {
        ...
        private String vnicSelection;
        public Builder() {}
        public Builder(GetClusterNetworksClusterNetworkInstancePoolLoadBalancer defaults) {
        ...
        public Builder backendSetName(String backendSetName) {
            if (backendSetName == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworksClusterNetworkInstancePoolLoadBalancer", "backendSetName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworksClusterNetworkInstancePoolLoadBalancer", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder instancePoolId(String instancePoolId) {
            if (instancePoolId == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworksClusterNetworkInstancePoolLoadBalancer", "instancePoolId");
            }
        ...
        public Builder loadBalancerId(String loadBalancerId) {
            if (loadBalancerId == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworksClusterNetworkInstancePoolLoadBalancer", "loadBalancerId");
            }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworksClusterNetworkInstancePoolLoadBalancer", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworksClusterNetworkInstancePoolLoadBalancer", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder vnicSelection(String vnicSelection) {
            if (vnicSelection == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworksClusterNetworkInstancePoolLoadBalancer", "vnicSelection");
            }
            this.vnicSelection = vnicSelection;
            return this;
        }
        public GetClusterNetworksClusterNetworkInstancePoolLoadBalancer build() {
            final var _resultValue = new GetClusterNetworksClusterNetworkInstancePoolLoadBalancer();
