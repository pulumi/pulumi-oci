...
import com.pulumi.oci.Core.outputs.GetClusterNetworksClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnetIpv6addressIpv6subnetCidrPairDetail;
...
public final class GetClusterNetworksClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnet {
    ...
    public static Builder builder(GetClusterNetworksClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnet defaults) {
    ...
    public static final class Builder {
        ...
        public Builder ipv6addressIpv6subnetCidrPairDetails(List<GetClusterNetworksClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnetIpv6addressIpv6subnetCidrPairDetail> ipv6addressIpv6subnetCidrPairDetails) {
            if (ipv6addressIpv6subnetCidrPairDetails == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworksClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnet", "ipv6addressIpv6subnetCidrPairDetails");
            }
        ...
        public Builder isAssignIpv6ip(Boolean isAssignIpv6ip) {
            if (isAssignIpv6ip == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworksClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnet", "isAssignIpv6ip");
            }
        ...
        public Builder subnetId(String subnetId) {
            if (subnetId == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworksClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnet", "subnetId");
            }
            this.subnetId = subnetId;
            return this;
        }
        public GetClusterNetworksClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnet build() {
            final var _resultValue = new GetClusterNetworksClusterNetworkInstancePoolPlacementConfigurationPrimaryVnicSubnet();
