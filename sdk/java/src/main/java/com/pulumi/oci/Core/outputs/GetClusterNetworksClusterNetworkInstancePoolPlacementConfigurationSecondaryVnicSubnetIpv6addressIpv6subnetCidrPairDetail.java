...
public final class GetClusterNetworksClusterNetworkInstancePoolPlacementConfigurationSecondaryVnicSubnetIpv6addressIpv6subnetCidrPairDetail {
    ...
    public static Builder builder(GetClusterNetworksClusterNetworkInstancePoolPlacementConfigurationSecondaryVnicSubnetIpv6addressIpv6subnetCidrPairDetail defaults) {
    ...
    public static final class Builder {
        ...
        public Builder ipv6subnetCidr(String ipv6subnetCidr) {
            if (ipv6subnetCidr == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworksClusterNetworkInstancePoolPlacementConfigurationSecondaryVnicSubnetIpv6addressIpv6subnetCidrPairDetail", "ipv6subnetCidr");
            }
        ...
        public GetClusterNetworksClusterNetworkInstancePoolPlacementConfigurationSecondaryVnicSubnetIpv6addressIpv6subnetCidrPairDetail build() {
            final var _resultValue = new GetClusterNetworksClusterNetworkInstancePoolPlacementConfigurationSecondaryVnicSubnetIpv6addressIpv6subnetCidrPairDetail();
