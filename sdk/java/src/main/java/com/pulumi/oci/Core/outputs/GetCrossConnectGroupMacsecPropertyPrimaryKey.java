    ...
    public static final class Builder {
        ...
        public Builder connectivityAssociationKeySecretId(String connectivityAssociationKeySecretId) {
            if (connectivityAssociationKeySecretId == null) {
              throw new MissingRequiredPropertyException("GetCrossConnectGroupMacsecPropertyPrimaryKey", "connectivityAssociationKeySecretId");
            }
        ...
        public Builder connectivityAssociationKeySecretVersion(String connectivityAssociationKeySecretVersion) {
            if (connectivityAssociationKeySecretVersion == null) {
              throw new MissingRequiredPropertyException("GetCrossConnectGroupMacsecPropertyPrimaryKey", "connectivityAssociationKeySecretVersion");
            }
        ...
        public Builder connectivityAssociationNameSecretId(String connectivityAssociationNameSecretId) {
            if (connectivityAssociationNameSecretId == null) {
              throw new MissingRequiredPropertyException("GetCrossConnectGroupMacsecPropertyPrimaryKey", "connectivityAssociationNameSecretId");
            }
        ...
        public Builder connectivityAssociationNameSecretVersion(String connectivityAssociationNameSecretVersion) {
            if (connectivityAssociationNameSecretVersion == null) {
              throw new MissingRequiredPropertyException("GetCrossConnectGroupMacsecPropertyPrimaryKey", "connectivityAssociationNameSecretVersion");
            }
        ...
        public GetCrossConnectGroupMacsecPropertyPrimaryKey build() {
            final var _resultValue = new GetCrossConnectGroupMacsecPropertyPrimaryKey();
