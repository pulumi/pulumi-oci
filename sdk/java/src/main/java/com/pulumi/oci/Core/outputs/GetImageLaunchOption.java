    ...
    public static final class Builder {
        ...
        public Builder bootVolumeType(String bootVolumeType) {
            if (bootVolumeType == null) {
              throw new MissingRequiredPropertyException("GetImageLaunchOption", "bootVolumeType");
            }
        ...
        public Builder firmware(String firmware) {
            if (firmware == null) {
              throw new MissingRequiredPropertyException("GetImageLaunchOption", "firmware");
            }
        ...
        public Builder isConsistentVolumeNamingEnabled(Boolean isConsistentVolumeNamingEnabled) {
            if (isConsistentVolumeNamingEnabled == null) {
              throw new MissingRequiredPropertyException("GetImageLaunchOption", "isConsistentVolumeNamingEnabled");
            }
        ...
        public Builder isPvEncryptionInTransitEnabled(Boolean isPvEncryptionInTransitEnabled) {
            if (isPvEncryptionInTransitEnabled == null) {
              throw new MissingRequiredPropertyException("GetImageLaunchOption", "isPvEncryptionInTransitEnabled");
            }
        ...
        public Builder networkType(String networkType) {
            if (networkType == null) {
              throw new MissingRequiredPropertyException("GetImageLaunchOption", "networkType");
            }
        ...
        public Builder remoteDataVolumeType(String remoteDataVolumeType) {
            if (remoteDataVolumeType == null) {
              throw new MissingRequiredPropertyException("GetImageLaunchOption", "remoteDataVolumeType");
            }
