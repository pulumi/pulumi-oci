    ...
    public static final class Builder {
        ...
        public Builder bootVolumeType(String bootVolumeType) {
            if (bootVolumeType == null) {
              throw new MissingRequiredPropertyException("GetImagesImageLaunchOption", "bootVolumeType");
            }
        ...
        public Builder firmware(String firmware) {
            if (firmware == null) {
              throw new MissingRequiredPropertyException("GetImagesImageLaunchOption", "firmware");
            }
        ...
        public Builder isConsistentVolumeNamingEnabled(Boolean isConsistentVolumeNamingEnabled) {
            if (isConsistentVolumeNamingEnabled == null) {
              throw new MissingRequiredPropertyException("GetImagesImageLaunchOption", "isConsistentVolumeNamingEnabled");
            }
        ...
        public Builder isPvEncryptionInTransitEnabled(Boolean isPvEncryptionInTransitEnabled) {
            if (isPvEncryptionInTransitEnabled == null) {
              throw new MissingRequiredPropertyException("GetImagesImageLaunchOption", "isPvEncryptionInTransitEnabled");
            }
        ...
        public Builder networkType(String networkType) {
            if (networkType == null) {
              throw new MissingRequiredPropertyException("GetImagesImageLaunchOption", "networkType");
            }
        ...
        public Builder remoteDataVolumeType(String remoteDataVolumeType) {
            if (remoteDataVolumeType == null) {
              throw new MissingRequiredPropertyException("GetImagesImageLaunchOption", "remoteDataVolumeType");
            }
            this.remoteDataVolumeType = remoteDataVolumeType;
            return this;
        }
        public GetImagesImageLaunchOption build() {
            final var _resultValue = new GetImagesImageLaunchOption();
