    ...
    public static final class Builder {
        ...
        public Builder isLiveMigrationPreferred(Boolean isLiveMigrationPreferred) {
            if (isLiveMigrationPreferred == null) {
              throw new MissingRequiredPropertyException("GetInstanceAvailabilityConfig", "isLiveMigrationPreferred");
            }
        ...
        public Builder recoveryAction(String recoveryAction) {
            if (recoveryAction == null) {
              throw new MissingRequiredPropertyException("GetInstanceAvailabilityConfig", "recoveryAction");
            }
            this.recoveryAction = recoveryAction;
            return this;
        }
        public GetInstanceAvailabilityConfig build() {
            final var _resultValue = new GetInstanceAvailabilityConfig();
