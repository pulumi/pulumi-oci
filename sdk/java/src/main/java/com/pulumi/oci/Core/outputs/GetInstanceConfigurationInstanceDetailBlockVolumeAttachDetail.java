...
public final class GetInstanceConfigurationInstanceDetailBlockVolumeAttachDetail {
    ...
    public static final class Builder {
        ...
        public Builder device(String device) {
            if (device == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailBlockVolumeAttachDetail", "device");
            }
            this.device = device;
            return this;
        }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailBlockVolumeAttachDetail", "displayName");
            }
        ...
        public Builder isPvEncryptionInTransitEnabled(Boolean isPvEncryptionInTransitEnabled) {
            if (isPvEncryptionInTransitEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailBlockVolumeAttachDetail", "isPvEncryptionInTransitEnabled");
            }
        ...
        public Builder isReadOnly(Boolean isReadOnly) {
            if (isReadOnly == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailBlockVolumeAttachDetail", "isReadOnly");
            }
        ...
        public Builder isShareable(Boolean isShareable) {
            if (isShareable == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailBlockVolumeAttachDetail", "isShareable");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailBlockVolumeAttachDetail", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder useChap(Boolean useChap) {
            if (useChap == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailBlockVolumeAttachDetail", "useChap");
            }
