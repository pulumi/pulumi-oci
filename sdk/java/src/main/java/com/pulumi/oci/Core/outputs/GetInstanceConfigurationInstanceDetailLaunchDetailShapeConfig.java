    ...
    public static final class Builder {
        ...
        public Builder baselineOcpuUtilization(String baselineOcpuUtilization) {
            if (baselineOcpuUtilization == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailLaunchDetailShapeConfig", "baselineOcpuUtilization");
            }
        ...
        public Builder localVolumeSizeInGbs(Integer localVolumeSizeInGbs) {
            if (localVolumeSizeInGbs == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailLaunchDetailShapeConfig", "localVolumeSizeInGbs");
            }
        ...
        public Builder memoryInGbs(Double memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailLaunchDetailShapeConfig", "memoryInGbs");
            }
        ...
        public Builder nvmes(Integer nvmes) {
            if (nvmes == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailLaunchDetailShapeConfig", "nvmes");
            }
            this.nvmes = nvmes;
            return this;
        }
        ...
        public Builder ocpus(Double ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailLaunchDetailShapeConfig", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
        ...
        public Builder resourceManagement(String resourceManagement) {
            if (resourceManagement == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailLaunchDetailShapeConfig", "resourceManagement");
            }
        ...
        public Builder vcpus(Integer vcpus) {
            if (vcpus == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailLaunchDetailShapeConfig", "vcpus");
            }
            this.vcpus = vcpus;
            return this;
        }
