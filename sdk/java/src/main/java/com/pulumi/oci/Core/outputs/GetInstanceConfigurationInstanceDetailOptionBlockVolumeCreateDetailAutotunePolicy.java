    ...
    public static final class Builder {
        ...
        public Builder autotuneType(String autotuneType) {
            if (autotuneType == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionBlockVolumeCreateDetailAutotunePolicy", "autotuneType");
            }
        ...
        public Builder maxVpusPerGb(String maxVpusPerGb) {
            if (maxVpusPerGb == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionBlockVolumeCreateDetailAutotunePolicy", "maxVpusPerGb");
            }
