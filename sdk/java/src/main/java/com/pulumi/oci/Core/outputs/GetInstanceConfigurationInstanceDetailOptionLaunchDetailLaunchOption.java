...
@CustomType
public final class GetInstanceConfigurationInstanceDetailOptionLaunchDetailLaunchOption {
    /**
    ...
    private GetInstanceConfigurationInstanceDetailOptionLaunchDetailLaunchOption() {}
    /**
     * @return Emulation type for the boot volume.
     * * `ISCSI` - ISCSI attached block storage device.
     * * `SCSI` - Emulated SCSI disk.
    ...
    public static Builder builder(GetInstanceConfigurationInstanceDetailOptionLaunchDetailLaunchOption defaults) {
    ...
    public static final class Builder {
        ...
        private String remoteDataVolumeType;
        public Builder() {}
        public Builder(GetInstanceConfigurationInstanceDetailOptionLaunchDetailLaunchOption defaults) {
        ...
        public Builder bootVolumeType(String bootVolumeType) {
            if (bootVolumeType == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailLaunchOption", "bootVolumeType");
            }
        ...
        public Builder firmware(String firmware) {
            if (firmware == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailLaunchOption", "firmware");
            }
        ...
        public Builder isConsistentVolumeNamingEnabled(Boolean isConsistentVolumeNamingEnabled) {
            if (isConsistentVolumeNamingEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailLaunchOption", "isConsistentVolumeNamingEnabled");
            }
        ...
        public Builder isPvEncryptionInTransitEnabled(Boolean isPvEncryptionInTransitEnabled) {
            if (isPvEncryptionInTransitEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailLaunchOption", "isPvEncryptionInTransitEnabled");
            }
        ...
        public Builder networkType(String networkType) {
            if (networkType == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailLaunchOption", "networkType");
            }
        ...
        public Builder remoteDataVolumeType(String remoteDataVolumeType) {
            if (remoteDataVolumeType == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailLaunchOption", "remoteDataVolumeType");
            }
            this.remoteDataVolumeType = remoteDataVolumeType;
            return this;
        }
        public GetInstanceConfigurationInstanceDetailOptionLaunchDetailLaunchOption build() {
            final var _resultValue = new GetInstanceConfigurationInstanceDetailOptionLaunchDetailLaunchOption();
