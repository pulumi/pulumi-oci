...
public final class GetInstanceConfigurationInstanceDetailOptionLaunchDetailPlatformConfig {
    ...
    public static Builder builder(GetInstanceConfigurationInstanceDetailOptionLaunchDetailPlatformConfig defaults) {
    ...
    public static final class Builder {
        ...
        public Builder areVirtualInstructionsEnabled(Boolean areVirtualInstructionsEnabled) {
            if (areVirtualInstructionsEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailPlatformConfig", "areVirtualInstructionsEnabled");
            }
        ...
        public Builder isAccessControlServiceEnabled(Boolean isAccessControlServiceEnabled) {
            if (isAccessControlServiceEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailPlatformConfig", "isAccessControlServiceEnabled");
            }
        ...
        public Builder isInputOutputMemoryManagementUnitEnabled(Boolean isInputOutputMemoryManagementUnitEnabled) {
            if (isInputOutputMemoryManagementUnitEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailPlatformConfig", "isInputOutputMemoryManagementUnitEnabled");
            }
        ...
        public Builder isMeasuredBootEnabled(Boolean isMeasuredBootEnabled) {
            if (isMeasuredBootEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailPlatformConfig", "isMeasuredBootEnabled");
            }
        ...
        public Builder isMemoryEncryptionEnabled(Boolean isMemoryEncryptionEnabled) {
            if (isMemoryEncryptionEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailPlatformConfig", "isMemoryEncryptionEnabled");
            }
        ...
        public Builder isSecureBootEnabled(Boolean isSecureBootEnabled) {
            if (isSecureBootEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailPlatformConfig", "isSecureBootEnabled");
            }
        ...
        public Builder isSymmetricMultiThreadingEnabled(Boolean isSymmetricMultiThreadingEnabled) {
            if (isSymmetricMultiThreadingEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailPlatformConfig", "isSymmetricMultiThreadingEnabled");
            }
        ...
        public Builder isTrustedPlatformModuleEnabled(Boolean isTrustedPlatformModuleEnabled) {
            if (isTrustedPlatformModuleEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailPlatformConfig", "isTrustedPlatformModuleEnabled");
            }
        ...
        public Builder numaNodesPerSocket(String numaNodesPerSocket) {
            if (numaNodesPerSocket == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailPlatformConfig", "numaNodesPerSocket");
            }
        ...
        public Builder percentageOfCoresEnabled(Integer percentageOfCoresEnabled) {
            if (percentageOfCoresEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailPlatformConfig", "percentageOfCoresEnabled");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailPlatformConfig", "type");
            }
            this.type = type;
            return this;
        }
        public GetInstanceConfigurationInstanceDetailOptionLaunchDetailPlatformConfig build() {
            final var _resultValue = new GetInstanceConfigurationInstanceDetailOptionLaunchDetailPlatformConfig();
