...
@CustomType
public final class GetInstanceConfigurationInstanceDetailOptionLaunchDetailShapeConfig {
    /**
    ...
    private GetInstanceConfigurationInstanceDetailOptionLaunchDetailShapeConfig() {}
    /**
     * @return The baseline OCPU utilization for a subcore burstable VM instance. Leave this attribute blank for a non-burstable instance, or explicitly specify non-burstable with `BASELINE_1_1`.
     * 
     */
    ...
    public static Builder builder(GetInstanceConfigurationInstanceDetailOptionLaunchDetailShapeConfig defaults) {
    ...
    public static final class Builder {
        ...
        public Builder baselineOcpuUtilization(String baselineOcpuUtilization) {
            if (baselineOcpuUtilization == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailShapeConfig", "baselineOcpuUtilization");
            }
        ...
        public Builder localVolumeSizeInGbs(Integer localVolumeSizeInGbs) {
            if (localVolumeSizeInGbs == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailShapeConfig", "localVolumeSizeInGbs");
            }
        ...
        public Builder memoryInGbs(Double memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailShapeConfig", "memoryInGbs");
            }
        ...
        public Builder nvmes(Integer nvmes) {
            if (nvmes == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailShapeConfig", "nvmes");
            }
            this.nvmes = nvmes;
            return this;
        }
        ...
        public Builder ocpus(Double ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailShapeConfig", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
