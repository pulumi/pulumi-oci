...
@CustomType
public final class GetInstanceConfigurationInstanceDetailOptionLaunchDetailSourceDetailInstanceSourceImageFilterDetail {
    /**
    ...
    private GetInstanceConfigurationInstanceDetailOptionLaunchDetailSourceDetailInstanceSourceImageFilterDetail() {}
    /**
     * @return The OCID of the compartment containing images to search
     * 
     */
    ...
    public static Builder builder(GetInstanceConfigurationInstanceDetailOptionLaunchDetailSourceDetailInstanceSourceImageFilterDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String operatingSystemVersion;
        public Builder() {}
        public Builder(GetInstanceConfigurationInstanceDetailOptionLaunchDetailSourceDetailInstanceSourceImageFilterDetail defaults) {
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailSourceDetailInstanceSourceImageFilterDetail", "compartmentId");
            }
        ...
        public Builder definedTagsFilter(Map<String,Object> definedTagsFilter) {
            if (definedTagsFilter == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailSourceDetailInstanceSourceImageFilterDetail", "definedTagsFilter");
            }
        ...
        public Builder operatingSystem(String operatingSystem) {
            if (operatingSystem == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailSourceDetailInstanceSourceImageFilterDetail", "operatingSystem");
            }
        ...
        public Builder operatingSystemVersion(String operatingSystemVersion) {
            if (operatingSystemVersion == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationInstanceDetailOptionLaunchDetailSourceDetailInstanceSourceImageFilterDetail", "operatingSystemVersion");
            }
