...
@CustomType
public final class GetInstanceConfigurationsFilter {
    /**
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationsFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationsFilter", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetInstanceConfigurationsFilter build() {
            final var _resultValue = new GetInstanceConfigurationsFilter();
