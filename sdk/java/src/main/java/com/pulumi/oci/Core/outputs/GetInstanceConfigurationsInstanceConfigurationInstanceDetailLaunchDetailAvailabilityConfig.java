    ...
    public static final class Builder {
        ...
        public Builder isLiveMigrationPreferred(Boolean isLiveMigrationPreferred) {
            if (isLiveMigrationPreferred == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationsInstanceConfigurationInstanceDetailLaunchDetailAvailabilityConfig", "isLiveMigrationPreferred");
            }
        ...
        public Builder recoveryAction(String recoveryAction) {
            if (recoveryAction == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationsInstanceConfigurationInstanceDetailLaunchDetailAvailabilityConfig", "recoveryAction");
            }
            this.recoveryAction = recoveryAction;
            return this;
        }
        public GetInstanceConfigurationsInstanceConfigurationInstanceDetailLaunchDetailAvailabilityConfig build() {
            final var _resultValue = new GetInstanceConfigurationsInstanceConfigurationInstanceDetailLaunchDetailAvailabilityConfig();
