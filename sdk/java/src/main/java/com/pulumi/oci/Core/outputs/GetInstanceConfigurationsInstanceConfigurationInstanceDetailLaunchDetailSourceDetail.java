    ...
    public static final class Builder {
        ...
        public Builder bootVolumeId(String bootVolumeId) {
            if (bootVolumeId == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationsInstanceConfigurationInstanceDetailLaunchDetailSourceDetail", "bootVolumeId");
            }
        ...
        public Builder bootVolumeSizeInGbs(String bootVolumeSizeInGbs) {
            if (bootVolumeSizeInGbs == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationsInstanceConfigurationInstanceDetailLaunchDetailSourceDetail", "bootVolumeSizeInGbs");
            }
        ...
        public Builder bootVolumeVpusPerGb(String bootVolumeVpusPerGb) {
            if (bootVolumeVpusPerGb == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationsInstanceConfigurationInstanceDetailLaunchDetailSourceDetail", "bootVolumeVpusPerGb");
            }
        ...
        public Builder imageId(String imageId) {
            if (imageId == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationsInstanceConfigurationInstanceDetailLaunchDetailSourceDetail", "imageId");
            }
        ...
        public Builder instanceSourceImageFilterDetails(List<GetInstanceConfigurationsInstanceConfigurationInstanceDetailLaunchDetailSourceDetailInstanceSourceImageFilterDetail> instanceSourceImageFilterDetails) {
            if (instanceSourceImageFilterDetails == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationsInstanceConfigurationInstanceDetailLaunchDetailSourceDetail", "instanceSourceImageFilterDetails");
            }
        ...
        public Builder kmsKeyId(String kmsKeyId) {
            if (kmsKeyId == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationsInstanceConfigurationInstanceDetailLaunchDetailSourceDetail", "kmsKeyId");
            }
        ...
        public Builder sourceType(String sourceType) {
            if (sourceType == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationsInstanceConfigurationInstanceDetailLaunchDetailSourceDetail", "sourceType");
            }
            this.sourceType = sourceType;
            return this;
        }
        public GetInstanceConfigurationsInstanceConfigurationInstanceDetailLaunchDetailSourceDetail build() {
            final var _resultValue = new GetInstanceConfigurationsInstanceConfigurationInstanceDetailLaunchDetailSourceDetail();
