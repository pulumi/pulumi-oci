...
import com.pulumi.oci.Core.outputs.GetInstanceConfigurationsInstanceConfigurationInstanceDetailOptionLaunchDetailAgentConfigPluginsConfig;
...
public final class GetInstanceConfigurationsInstanceConfigurationInstanceDetailOptionLaunchDetailAgentConfig {
    ...
    public static Builder builder(GetInstanceConfigurationsInstanceConfigurationInstanceDetailOptionLaunchDetailAgentConfig defaults) {
    ...
    public static final class Builder {
        ...
        public Builder areAllPluginsDisabled(Boolean areAllPluginsDisabled) {
            if (areAllPluginsDisabled == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationsInstanceConfigurationInstanceDetailOptionLaunchDetailAgentConfig", "areAllPluginsDisabled");
            }
        ...
        public Builder isManagementDisabled(Boolean isManagementDisabled) {
            if (isManagementDisabled == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationsInstanceConfigurationInstanceDetailOptionLaunchDetailAgentConfig", "isManagementDisabled");
            }
        ...
        public Builder isMonitoringDisabled(Boolean isMonitoringDisabled) {
            if (isMonitoringDisabled == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationsInstanceConfigurationInstanceDetailOptionLaunchDetailAgentConfig", "isMonitoringDisabled");
            }
        ...
        public Builder pluginsConfigs(List<GetInstanceConfigurationsInstanceConfigurationInstanceDetailOptionLaunchDetailAgentConfigPluginsConfig> pluginsConfigs) {
            if (pluginsConfigs == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationsInstanceConfigurationInstanceDetailOptionLaunchDetailAgentConfig", "pluginsConfigs");
            }
        ...
        public GetInstanceConfigurationsInstanceConfigurationInstanceDetailOptionLaunchDetailAgentConfig build() {
            final var _resultValue = new GetInstanceConfigurationsInstanceConfigurationInstanceDetailOptionLaunchDetailAgentConfig();
