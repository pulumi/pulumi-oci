...
@CustomType
public final class GetInstanceConfigurationsInstanceConfigurationInstanceDetailOptionLaunchDetailAvailabilityConfig {
    /**
    ...
    private GetInstanceConfigurationsInstanceConfigurationInstanceDetailOptionLaunchDetailAvailabilityConfig() {}
    /**
     * @return Whether to live migrate supported VM instances to a healthy physical VM host without disrupting running instances during infrastructure maintenance events. If null, Oracle chooses the best option for migrating the VM during infrastructure maintenance events.
     * 
     */
    ...
    public static Builder builder(GetInstanceConfigurationsInstanceConfigurationInstanceDetailOptionLaunchDetailAvailabilityConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String recoveryAction;
        public Builder() {}
        public Builder(GetInstanceConfigurationsInstanceConfigurationInstanceDetailOptionLaunchDetailAvailabilityConfig defaults) {
        ...
        public Builder isLiveMigrationPreferred(Boolean isLiveMigrationPreferred) {
            if (isLiveMigrationPreferred == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationsInstanceConfigurationInstanceDetailOptionLaunchDetailAvailabilityConfig", "isLiveMigrationPreferred");
            }
        ...
        public Builder recoveryAction(String recoveryAction) {
            if (recoveryAction == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationsInstanceConfigurationInstanceDetailOptionLaunchDetailAvailabilityConfig", "recoveryAction");
            }
            this.recoveryAction = recoveryAction;
            return this;
        }
        public GetInstanceConfigurationsInstanceConfigurationInstanceDetailOptionLaunchDetailAvailabilityConfig build() {
            final var _resultValue = new GetInstanceConfigurationsInstanceConfigurationInstanceDetailOptionLaunchDetailAvailabilityConfig();
