    ...
    public static final class Builder {
        ...
        public Builder localVolumeSizeInGbs(Integer localVolumeSizeInGbs) {
            if (localVolumeSizeInGbs == null) {
              throw new MissingRequiredPropertyException("GetInstanceConfigurationsInstanceConfigurationInstanceDetailOptionLaunchDetailShapeConfig", "localVolumeSizeInGbs");
            }
