...
public final class GetInstancePoolPlacementConfigurationPrimaryVnicSubnet {
     ...
     * 
     */
    private List<GetInstancePoolPlacementConfigurationPrimaryVnicSubnetIpv6addressIpv6subnetCidrPairDetail> ipv6addressIpv6subnetCidrPairDetails;
    /**
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder ipv6addressIpv6subnetCidrPairDetails(List<GetInstancePoolPlacementConfigurationPrimaryVnicSubnetIpv6addressIpv6subnetCidrPairDetail> ipv6addressIpv6subnetCidrPairDetails) {
            if (ipv6addressIpv6subnetCidrPairDetails == null) {
              throw new MissingRequiredPropertyException("GetInstancePoolPlacementConfigurationPrimaryVnicSubnet", "ipv6addressIpv6subnetCidrPairDetails");
            }
        ...
        public Builder isAssignIpv6ip(Boolean isAssignIpv6ip) {
            if (isAssignIpv6ip == null) {
              throw new MissingRequiredPropertyException("GetInstancePoolPlacementConfigurationPrimaryVnicSubnet", "isAssignIpv6ip");
            }
        ...
        public Builder subnetId(String subnetId) {
            if (subnetId == null) {
              throw new MissingRequiredPropertyException("GetInstancePoolPlacementConfigurationPrimaryVnicSubnet", "subnetId");
            }
