...
@CustomType
public final class GetInstancePoolsInstancePoolLoadBalancer {
    /**
    ...
    private GetInstancePoolsInstancePoolLoadBalancer() {}
    /**
     * @return The name of the backend set on the load balancer.
     * 
     */
    ...
    public static Builder builder(GetInstancePoolsInstancePoolLoadBalancer defaults) {
    ...
    public static final class Builder {
        ...
        private String vnicSelection;
        public Builder() {}
        public Builder(GetInstancePoolsInstancePoolLoadBalancer defaults) {
        ...
        public Builder backendSetName(String backendSetName) {
            if (backendSetName == null) {
              throw new MissingRequiredPropertyException("GetInstancePoolsInstancePoolLoadBalancer", "backendSetName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetInstancePoolsInstancePoolLoadBalancer", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder instancePoolId(String instancePoolId) {
            if (instancePoolId == null) {
              throw new MissingRequiredPropertyException("GetInstancePoolsInstancePoolLoadBalancer", "instancePoolId");
            }
        ...
        public Builder loadBalancerId(String loadBalancerId) {
            if (loadBalancerId == null) {
              throw new MissingRequiredPropertyException("GetInstancePoolsInstancePoolLoadBalancer", "loadBalancerId");
            }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetInstancePoolsInstancePoolLoadBalancer", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetInstancePoolsInstancePoolLoadBalancer", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder vnicSelection(String vnicSelection) {
            if (vnicSelection == null) {
              throw new MissingRequiredPropertyException("GetInstancePoolsInstancePoolLoadBalancer", "vnicSelection");
            }
            this.vnicSelection = vnicSelection;
            return this;
        }
        public GetInstancePoolsInstancePoolLoadBalancer build() {
            final var _resultValue = new GetInstancePoolsInstancePoolLoadBalancer();
