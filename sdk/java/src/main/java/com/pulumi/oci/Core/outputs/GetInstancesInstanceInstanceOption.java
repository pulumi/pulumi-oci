    ...
    public static final class Builder {
        ...
        public Builder areLegacyImdsEndpointsDisabled(Boolean areLegacyImdsEndpointsDisabled) {
            if (areLegacyImdsEndpointsDisabled == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstanceInstanceOption", "areLegacyImdsEndpointsDisabled");
            }
            this.areLegacyImdsEndpointsDisabled = areLegacyImdsEndpointsDisabled;
            return this;
        }
        public GetInstancesInstanceInstanceOption build() {
            final var _resultValue = new GetInstancesInstanceInstanceOption();
