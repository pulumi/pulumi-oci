    ...
    public static final class Builder {
        ...
        public Builder bootVolumeType(String bootVolumeType) {
            if (bootVolumeType == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstanceLaunchOption", "bootVolumeType");
            }
        ...
        public Builder firmware(String firmware) {
            if (firmware == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstanceLaunchOption", "firmware");
            }
        ...
        public Builder isConsistentVolumeNamingEnabled(Boolean isConsistentVolumeNamingEnabled) {
            if (isConsistentVolumeNamingEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstanceLaunchOption", "isConsistentVolumeNamingEnabled");
            }
        ...
        public Builder isPvEncryptionInTransitEnabled(Boolean isPvEncryptionInTransitEnabled) {
            if (isPvEncryptionInTransitEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstanceLaunchOption", "isPvEncryptionInTransitEnabled");
            }
        ...
        public Builder networkType(String networkType) {
            if (networkType == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstanceLaunchOption", "networkType");
            }
        ...
        public Builder remoteDataVolumeType(String remoteDataVolumeType) {
            if (remoteDataVolumeType == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstanceLaunchOption", "remoteDataVolumeType");
            }
            this.remoteDataVolumeType = remoteDataVolumeType;
            return this;
        }
        public GetInstancesInstanceLaunchOption build() {
            final var _resultValue = new GetInstancesInstanceLaunchOption();
