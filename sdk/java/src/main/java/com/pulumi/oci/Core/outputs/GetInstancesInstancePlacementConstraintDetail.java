...
@CustomType
public final class GetInstancesInstancePlacementConstraintDetail {
    /**
    ...
    private GetInstancesInstancePlacementConstraintDetail() {}
    /**
     * @return The OCID of the compute bare metal host.
     * 
     */
    ...
    public static Builder builder(GetInstancesInstancePlacementConstraintDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetInstancesInstancePlacementConstraintDetail defaults) {
        ...
        public Builder computeBareMetalHostId(String computeBareMetalHostId) {
            if (computeBareMetalHostId == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstancePlacementConstraintDetail", "computeBareMetalHostId");
            }
        ...
        public Builder computeHostGroupId(String computeHostGroupId) {
            if (computeHostGroupId == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstancePlacementConstraintDetail", "computeHostGroupId");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstancePlacementConstraintDetail", "type");
            }
            this.type = type;
            return this;
        }
        public GetInstancesInstancePlacementConstraintDetail build() {
            final var _resultValue = new GetInstancesInstancePlacementConstraintDetail();
