    ...
    public static final class Builder {
        ...
        public Builder areVirtualInstructionsEnabled(Boolean areVirtualInstructionsEnabled) {
            if (areVirtualInstructionsEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstancePlatformConfig", "areVirtualInstructionsEnabled");
            }
        ...
        public Builder configMap(Map<String,String> configMap) {
            if (configMap == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstancePlatformConfig", "configMap");
            }
        ...
        public Builder isAccessControlServiceEnabled(Boolean isAccessControlServiceEnabled) {
            if (isAccessControlServiceEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstancePlatformConfig", "isAccessControlServiceEnabled");
            }
        ...
        public Builder isInputOutputMemoryManagementUnitEnabled(Boolean isInputOutputMemoryManagementUnitEnabled) {
            if (isInputOutputMemoryManagementUnitEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstancePlatformConfig", "isInputOutputMemoryManagementUnitEnabled");
            }
        ...
        public Builder isMeasuredBootEnabled(Boolean isMeasuredBootEnabled) {
            if (isMeasuredBootEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstancePlatformConfig", "isMeasuredBootEnabled");
            }
        ...
        public Builder isMemoryEncryptionEnabled(Boolean isMemoryEncryptionEnabled) {
            if (isMemoryEncryptionEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstancePlatformConfig", "isMemoryEncryptionEnabled");
            }
        ...
        public Builder isSecureBootEnabled(Boolean isSecureBootEnabled) {
            if (isSecureBootEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstancePlatformConfig", "isSecureBootEnabled");
            }
        ...
        public Builder isSymmetricMultiThreadingEnabled(Boolean isSymmetricMultiThreadingEnabled) {
            if (isSymmetricMultiThreadingEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstancePlatformConfig", "isSymmetricMultiThreadingEnabled");
            }
        ...
        public Builder isTrustedPlatformModuleEnabled(Boolean isTrustedPlatformModuleEnabled) {
            if (isTrustedPlatformModuleEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstancePlatformConfig", "isTrustedPlatformModuleEnabled");
            }
        ...
        public Builder numaNodesPerSocket(String numaNodesPerSocket) {
            if (numaNodesPerSocket == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstancePlatformConfig", "numaNodesPerSocket");
            }
        ...
        public Builder percentageOfCoresEnabled(Integer percentageOfCoresEnabled) {
            if (percentageOfCoresEnabled == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstancePlatformConfig", "percentageOfCoresEnabled");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetInstancesInstancePlatformConfig", "type");
            }
            this.type = type;
            return this;
        }
        public GetInstancesInstancePlatformConfig build() {
            final var _resultValue = new GetInstancesInstancePlatformConfig();
