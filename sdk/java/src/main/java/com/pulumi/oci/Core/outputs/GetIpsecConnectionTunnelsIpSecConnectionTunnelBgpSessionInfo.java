    ...
    public static final class Builder {
        ...
        public Builder bgpIpv6State(String bgpIpv6State) {
            if (bgpIpv6State == null) {
              throw new MissingRequiredPropertyException("GetIpsecConnectionTunnelsIpSecConnectionTunnelBgpSessionInfo", "bgpIpv6State");
            }
        ...
        public Builder bgpState(String bgpState) {
            if (bgpState == null) {
              throw new MissingRequiredPropertyException("GetIpsecConnectionTunnelsIpSecConnectionTunnelBgpSessionInfo", "bgpState");
            }
        ...
        public Builder customerBgpAsn(String customerBgpAsn) {
            if (customerBgpAsn == null) {
              throw new MissingRequiredPropertyException("GetIpsecConnectionTunnelsIpSecConnectionTunnelBgpSessionInfo", "customerBgpAsn");
            }
        ...
        public Builder customerInterfaceIp(String customerInterfaceIp) {
            if (customerInterfaceIp == null) {
              throw new MissingRequiredPropertyException("GetIpsecConnectionTunnelsIpSecConnectionTunnelBgpSessionInfo", "customerInterfaceIp");
            }
        ...
        public Builder customerInterfaceIpv6(String customerInterfaceIpv6) {
            if (customerInterfaceIpv6 == null) {
              throw new MissingRequiredPropertyException("GetIpsecConnectionTunnelsIpSecConnectionTunnelBgpSessionInfo", "customerInterfaceIpv6");
            }
        ...
        public Builder oracleBgpAsn(String oracleBgpAsn) {
            if (oracleBgpAsn == null) {
              throw new MissingRequiredPropertyException("GetIpsecConnectionTunnelsIpSecConnectionTunnelBgpSessionInfo", "oracleBgpAsn");
            }
        ...
        public Builder oracleInterfaceIp(String oracleInterfaceIp) {
            if (oracleInterfaceIp == null) {
              throw new MissingRequiredPropertyException("GetIpsecConnectionTunnelsIpSecConnectionTunnelBgpSessionInfo", "oracleInterfaceIp");
            }
        ...
        public Builder oracleInterfaceIpv6(String oracleInterfaceIpv6) {
            if (oracleInterfaceIpv6 == null) {
              throw new MissingRequiredPropertyException("GetIpsecConnectionTunnelsIpSecConnectionTunnelBgpSessionInfo", "oracleInterfaceIpv6");
            }
