    ...
    public static final class Builder {
        ...
        public Builder cpeTrafficSelectors(List<String> cpeTrafficSelectors) {
            if (cpeTrafficSelectors == null) {
              throw new MissingRequiredPropertyException("GetIpsecConnectionTunnelsIpSecConnectionTunnelEncryptionDomainConfig", "cpeTrafficSelectors");
            }
        ...
        public Builder oracleTrafficSelectors(List<String> oracleTrafficSelectors) {
            if (oracleTrafficSelectors == null) {
              throw new MissingRequiredPropertyException("GetIpsecConnectionTunnelsIpSecConnectionTunnelEncryptionDomainConfig", "oracleTrafficSelectors");
            }
