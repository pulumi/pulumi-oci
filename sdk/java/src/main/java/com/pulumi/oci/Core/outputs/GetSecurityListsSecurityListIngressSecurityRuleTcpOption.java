...
public final class GetSecurityListsSecurityListIngressSecurityRuleTcpOption {
    ...
    public static final class Builder {
        ...
        public Builder max(Integer max) {
            if (max == null) {
              throw new MissingRequiredPropertyException("GetSecurityListsSecurityListIngressSecurityRuleTcpOption", "max");
            }
            this.max = max;
            return this;
        }
        ...
        public Builder min(Integer min) {
            if (min == null) {
              throw new MissingRequiredPropertyException("GetSecurityListsSecurityListIngressSecurityRuleTcpOption", "min");
            }
            this.min = min;
            return this;
        }
        ...
        public Builder sourcePortRanges(List<GetSecurityListsSecurityListIngressSecurityRuleTcpOptionSourcePortRange> sourcePortRanges) {
            if (sourcePortRanges == null) {
              throw new MissingRequiredPropertyException("GetSecurityListsSecurityListIngressSecurityRuleTcpOption", "sourcePortRanges");
            }
