    ...
    public static final class Builder {
        ...
        public Builder allowedValues(List<Boolean> allowedValues) {
            if (allowedValues == null) {
              throw new MissingRequiredPropertyException("GetShapesShapePlatformConfigOptionSymmetricMultiThreadingOption", "allowedValues");
            }
        ...
        public Builder isDefaultEnabled(Boolean isDefaultEnabled) {
            if (isDefaultEnabled == null) {
              throw new MissingRequiredPropertyException("GetShapesShapePlatformConfigOptionSymmetricMultiThreadingOption", "isDefaultEnabled");
            }
