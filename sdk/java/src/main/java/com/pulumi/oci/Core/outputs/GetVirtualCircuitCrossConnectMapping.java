...
@CustomType
public final class GetVirtualCircuitCrossConnectMapping {
    /**
    ...
    private GetVirtualCircuitCrossConnectMapping() {}
    /**
     * @return The key for BGP MD5 authentication. Only applicable if your system requires MD5 authentication. If empty or not set (null), that means you don&#39;t use BGP MD5 authentication.
     * 
     */
    ...
    public static Builder builder(GetVirtualCircuitCrossConnectMapping defaults) {
    ...
    public static final class Builder {
        ...
        private Integer vlan;
        public Builder() {}
        public Builder(GetVirtualCircuitCrossConnectMapping defaults) {
        ...
        public GetVirtualCircuitCrossConnectMapping build() {
            final var _resultValue = new GetVirtualCircuitCrossConnectMapping();
