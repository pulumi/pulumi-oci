...
@CustomType
public final class GetVolumeAutotunePolicy {
    /**
    ...
    private GetVolumeAutotunePolicy() {}
    /**
     * @return This specifies the type of autotunes supported by OCI.
     * 
     */
    ...
    public static Builder builder(GetVolumeAutotunePolicy defaults) {
    ...
    public static final class Builder {
        ...
        private String maxVpusPerGb;
        public Builder() {}
        public Builder(GetVolumeAutotunePolicy defaults) {
        ...
        public Builder autotuneType(String autotuneType) {
            if (autotuneType == null) {
              throw new MissingRequiredPropertyException("GetVolumeAutotunePolicy", "autotuneType");
            }
        ...
        public Builder maxVpusPerGb(String maxVpusPerGb) {
            if (maxVpusPerGb == null) {
              throw new MissingRequiredPropertyException("GetVolumeAutotunePolicy", "maxVpusPerGb");
            }
            this.maxVpusPerGb = maxVpusPerGb;
            return this;
        }
        public GetVolumeAutotunePolicy build() {
            final var _resultValue = new GetVolumeAutotunePolicy();
