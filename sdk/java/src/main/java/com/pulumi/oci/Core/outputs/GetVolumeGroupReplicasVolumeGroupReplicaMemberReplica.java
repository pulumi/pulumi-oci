    ...
    public static final class Builder {
        ...
        public Builder membershipState(String membershipState) {
            if (membershipState == null) {
              throw new MissingRequiredPropertyException("GetVolumeGroupReplicasVolumeGroupReplicaMemberReplica", "membershipState");
            }
        ...
        public Builder volumeReplicaId(String volumeReplicaId) {
            if (volumeReplicaId == null) {
              throw new MissingRequiredPropertyException("GetVolumeGroupReplicasVolumeGroupReplicaMemberReplica", "volumeReplicaId");
            }
            this.volumeReplicaId = volumeReplicaId;
            return this;
        }
        public GetVolumeGroupReplicasVolumeGroupReplicaMemberReplica build() {
            final var _resultValue = new GetVolumeGroupReplicasVolumeGroupReplicaMemberReplica();
