...
@CustomType
public final class GetVolumesVolumeAutotunePolicy {
    /**
    ...
    private GetVolumesVolumeAutotunePolicy() {}
    /**
     * @return This specifies the type of autotunes supported by OCI.
     * 
     */
    ...
    public static Builder builder(GetVolumesVolumeAutotunePolicy defaults) {
    ...
    public static final class Builder {
        ...
        private String maxVpusPerGb;
        public Builder() {}
        public Builder(GetVolumesVolumeAutotunePolicy defaults) {
        ...
        public Builder autotuneType(String autotuneType) {
            if (autotuneType == null) {
              throw new MissingRequiredPropertyException("GetVolumesVolumeAutotunePolicy", "autotuneType");
            }
        ...
        public Builder maxVpusPerGb(String maxVpusPerGb) {
            if (maxVpusPerGb == null) {
              throw new MissingRequiredPropertyException("GetVolumesVolumeAutotunePolicy", "maxVpusPerGb");
            }
