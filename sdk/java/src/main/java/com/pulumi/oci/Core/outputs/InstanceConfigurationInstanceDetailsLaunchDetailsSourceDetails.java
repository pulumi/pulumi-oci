...
public final class InstanceConfigurationInstanceDetailsLaunchDetailsSourceDetails {
    ...
    public static final class Builder {
        ...
        public Builder sourceType(String sourceType) {
            if (sourceType == null) {
              throw new MissingRequiredPropertyException("InstanceConfigurationInstanceDetailsLaunchDetailsSourceDetails", "sourceType");
            }
            this.sourceType = sourceType;
            return this;
        }
        public InstanceConfigurationInstanceDetailsLaunchDetailsSourceDetails build() {
            final var _resultValue = new InstanceConfigurationInstanceDetailsLaunchDetailsSourceDetails();
