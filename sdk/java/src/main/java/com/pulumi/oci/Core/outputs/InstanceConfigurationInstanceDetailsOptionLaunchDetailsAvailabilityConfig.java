...
@CustomType
public final class InstanceConfigurationInstanceDetailsOptionLaunchDetailsAvailabilityConfig {
    /**
    ...
    private InstanceConfigurationInstanceDetailsOptionLaunchDetailsAvailabilityConfig() {}
    /**
     * @return Whether to live migrate supported VM instances to a healthy physical VM host without disrupting running instances during infrastructure maintenance events. If null, Oracle chooses the best option for migrating the VM during infrastructure maintenance events.
     * 
     */
    ...
    public static Builder builder(InstanceConfigurationInstanceDetailsOptionLaunchDetailsAvailabilityConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String recoveryAction;
        public Builder() {}
        public Builder(InstanceConfigurationInstanceDetailsOptionLaunchDetailsAvailabilityConfig defaults) {
