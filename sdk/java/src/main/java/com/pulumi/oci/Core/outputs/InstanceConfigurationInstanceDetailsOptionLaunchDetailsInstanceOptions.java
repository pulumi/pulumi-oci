...
@CustomType
public final class InstanceConfigurationInstanceDetailsOptionLaunchDetailsInstanceOptions {
    /**
    ...
    private InstanceConfigurationInstanceDetailsOptionLaunchDetailsInstanceOptions() {}
    /**
     * @return Whether to disable the legacy (/v1) instance metadata service endpoints. Customers who have migrated to /v2 should set this to true for added security. Default is false.
     * 
     */
    ...
    public static Builder builder(InstanceConfigurationInstanceDetailsOptionLaunchDetailsInstanceOptions defaults) {
    ...
    public static final class Builder {
        private @Nullable Boolean areLegacyImdsEndpointsDisabled;
        public Builder() {}
        public Builder(InstanceConfigurationInstanceDetailsOptionLaunchDetailsInstanceOptions defaults) {
        ...
        public InstanceConfigurationInstanceDetailsOptionLaunchDetailsInstanceOptions build() {
            final var _resultValue = new InstanceConfigurationInstanceDetailsOptionLaunchDetailsInstanceOptions();
