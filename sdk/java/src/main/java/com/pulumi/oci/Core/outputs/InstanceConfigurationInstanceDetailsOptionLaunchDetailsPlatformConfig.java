...
@CustomType
public final class InstanceConfigurationInstanceDetailsOptionLaunchDetailsPlatformConfig {
    /**
    ...
    public static Builder builder(InstanceConfigurationInstanceDetailsOptionLaunchDetailsPlatformConfig defaults) {
    ...
    public static final class Builder {
        ...
        public InstanceConfigurationInstanceDetailsOptionLaunchDetailsPlatformConfig build() {
            final var o = new InstanceConfigurationInstanceDetailsOptionLaunchDetailsPlatformConfig();
