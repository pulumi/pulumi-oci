...
import com.pulumi.oci.Core.outputs.InstanceConfigurationInstanceDetailsOptionSecondaryVnicCreateVnicDetailsIpv6addressIpv6subnetCidrPairDetail;
...
public final class InstanceConfigurationInstanceDetailsOptionSecondaryVnicCreateVnicDetails {
     ...
     * 
     */
    public List<InstanceConfigurationInstanceDetailsOptionSecondaryVnicCreateVnicDetailsIpv6addressIpv6subnetCidrPairDetail> ipv6addressIpv6subnetCidrPairDetails() {
    ...
    public static Builder builder(InstanceConfigurationInstanceDetailsOptionSecondaryVnicCreateVnicDetails defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subnetId;
        public Builder() {}
        public Builder(InstanceConfigurationInstanceDetailsOptionSecondaryVnicCreateVnicDetails defaults) {
        ...
        @CustomType.Setter
        public Builder ipv6addressIpv6subnetCidrPairDetails(@Nullable List<InstanceConfigurationInstanceDetailsOptionSecondaryVnicCreateVnicDetailsIpv6addressIpv6subnetCidrPairDetail> ipv6addressIpv6subnetCidrPairDetails) {

            this.ipv6addressIpv6subnetCidrPairDetails = ipv6addressIpv6subnetCidrPairDetails;
            return this;
        }
        public Builder ipv6addressIpv6subnetCidrPairDetails(InstanceConfigurationInstanceDetailsOptionSecondaryVnicCreateVnicDetailsIpv6addressIpv6subnetCidrPairDetail... ipv6addressIpv6subnetCidrPairDetails) {
        ...
        public InstanceConfigurationInstanceDetailsOptionSecondaryVnicCreateVnicDetails build() {
            final var _resultValue = new InstanceConfigurationInstanceDetailsOptionSecondaryVnicCreateVnicDetails();
