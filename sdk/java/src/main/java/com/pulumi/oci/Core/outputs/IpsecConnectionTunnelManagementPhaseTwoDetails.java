...
@CustomType
public final class IpsecConnectionTunnelManagementPhaseTwoDetails {
    /**
    ...
    public static Builder builder(IpsecConnectionTunnelManagementPhaseTwoDetails defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String remainingLifetimeLastRetrieved;
        public Builder() {}
        public Builder(IpsecConnectionTunnelManagementPhaseTwoDetails defaults) {
        ...
        public IpsecConnectionTunnelManagementPhaseTwoDetails build() {
            final var _resultValue = new IpsecConnectionTunnelManagementPhaseTwoDetails();
