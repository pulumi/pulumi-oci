...
public final class NetworkSecurityGroupSecurityRuleIcmpOptions {
    ...
    public static final class Builder {
        ...
        public Builder type(Integer type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("NetworkSecurityGroupSecurityRuleIcmpOptions", "type");
            }
            this.type = type;
            return this;
        }
        public NetworkSecurityGroupSecurityRuleIcmpOptions build() {
            final var _resultValue = new NetworkSecurityGroupSecurityRuleIcmpOptions();
