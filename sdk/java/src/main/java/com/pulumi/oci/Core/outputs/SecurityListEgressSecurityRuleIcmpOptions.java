...
public final class SecurityListEgressSecurityRuleIcmpOptions {
    ...
    public static final class Builder {
        ...
        public Builder type(Integer type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("SecurityListEgressSecurityRuleIcmpOptions", "type");
            }
            this.type = type;
            return this;
        }
        public SecurityListEgressSecurityRuleIcmpOptions build() {
            final var _resultValue = new SecurityListEgressSecurityRuleIcmpOptions();
