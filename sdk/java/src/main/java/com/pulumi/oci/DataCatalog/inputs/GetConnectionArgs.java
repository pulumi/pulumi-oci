...
public final class GetConnectionArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetConnectionArgs build() {
            if ($.catalogId == null) {
                throw new MissingRequiredPropertyException("GetConnectionArgs", "catalogId");
            }
            if ($.connectionKey == null) {
                throw new MissingRequiredPropertyException("GetConnectionArgs", "connectionKey");
            }
            if ($.dataAssetKey == null) {
                throw new MissingRequiredPropertyException("GetConnectionArgs", "dataAssetKey");
            }
            return $;
        }
    }
