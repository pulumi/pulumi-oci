...
@CustomType
public final class CatalogLock {
    /**
    ...
    public static Builder builder(CatalogLock defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(CatalogLock defaults) {
        ...
        public CatalogLock build() {
            final var _resultValue = new CatalogLock();
