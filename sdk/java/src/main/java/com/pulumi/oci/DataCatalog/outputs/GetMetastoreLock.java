...
@CustomType
public final class GetMetastoreLock {
    /**
    ...
    public static Builder builder(GetMetastoreLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetMetastoreLock defaults) {
        ...
        public GetMetastoreLock build() {
            final var _resultValue = new GetMetastoreLock();
