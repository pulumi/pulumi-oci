...
@CustomType
public final class MetastoreLock {
    /**
    ...
    public static Builder builder(MetastoreLock defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(MetastoreLock defaults) {
        ...
        public MetastoreLock build() {
            final var _resultValue = new MetastoreLock();
