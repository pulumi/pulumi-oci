...
public final class RegistryDataAssetDefaultConnectionMetadataAggregatorArgs extends com.pulumi.resources.ResourceArgs {

    public static final RegistryDataAssetDefaultConnectionMetadataAggregatorArgs Empty = new RegistryDataAssetDefaultConnectionMetadataAggregatorArgs();
    ...
    private RegistryDataAssetDefaultConnectionMetadataAggregatorArgs() {}

    private RegistryDataAssetDefaultConnectionMetadataAggregatorArgs(RegistryDataAssetDefaultConnectionMetadataAggregatorArgs $) {
    ...
    public static Builder builder(RegistryDataAssetDefaultConnectionMetadataAggregatorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegistryDataAssetDefaultConnectionMetadataAggregatorArgs();
        }

        public Builder(RegistryDataAssetDefaultConnectionMetadataAggregatorArgs defaults) {
            $ = new RegistryDataAssetDefaultConnectionMetadataAggregatorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RegistryDataAssetDefaultConnectionMetadataAggregatorArgs build() {
            return $;
        }
    }
