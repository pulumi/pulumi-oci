...
public final class RegistryFolderDataAssetDefaultConnectionMetadataArgs extends com.pulumi.resources.ResourceArgs {

    public static final RegistryFolderDataAssetDefaultConnectionMetadataArgs Empty = new RegistryFolderDataAssetDefaultConnectionMetadataArgs();
    ...
    private @Nullable Output<RegistryFolderDataAssetDefaultConnectionMetadataAggregatorArgs> aggregator;
     ...
     * 
     */
    public Optional<Output<RegistryFolderDataAssetDefaultConnectionMetadataAggregatorArgs>> aggregator() {
    ...
    private RegistryFolderDataAssetDefaultConnectionMetadataArgs() {}

    private RegistryFolderDataAssetDefaultConnectionMetadataArgs(RegistryFolderDataAssetDefaultConnectionMetadataArgs $) {
    ...
    public static Builder builder(RegistryFolderDataAssetDefaultConnectionMetadataArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegistryFolderDataAssetDefaultConnectionMetadataArgs();
        }

        public Builder(RegistryFolderDataAssetDefaultConnectionMetadataArgs defaults) {
            $ = new RegistryFolderDataAssetDefaultConnectionMetadataArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder aggregator(@Nullable Output<RegistryFolderDataAssetDefaultConnectionMetadataAggregatorArgs> aggregator) {
         ...
         * 
         */
        public Builder aggregator(RegistryFolderDataAssetDefaultConnectionMetadataAggregatorArgs aggregator) {
        ...
        public RegistryFolderDataAssetDefaultConnectionMetadataArgs build() {
            return $;
        }
    }
