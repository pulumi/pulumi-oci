...
public final class RegistryFolderDataAssetDefaultConnectionPrimarySchemaArgs extends com.pulumi.resources.ResourceArgs {

    public static final RegistryFolderDataAssetDefaultConnectionPrimarySchemaArgs Empty = new RegistryFolderDataAssetDefaultConnectionPrimarySchemaArgs();
    ...
    private RegistryFolderDataAssetDefaultConnectionPrimarySchemaArgs() {}

    private RegistryFolderDataAssetDefaultConnectionPrimarySchemaArgs(RegistryFolderDataAssetDefaultConnectionPrimarySchemaArgs $) {
    ...
    public static Builder builder(RegistryFolderDataAssetDefaultConnectionPrimarySchemaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegistryFolderDataAssetDefaultConnectionPrimarySchemaArgs();
        }

        public Builder(RegistryFolderDataAssetDefaultConnectionPrimarySchemaArgs defaults) {
            $ = new RegistryFolderDataAssetDefaultConnectionPrimarySchemaArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder metadata(@Nullable Output<RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataArgs> metadata) {
            $.metadata = metadata;
            return this;
        }
         ...
         * 
         */
        public Builder metadata(RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataArgs metadata) {
         ...
         * 
         */
        public Builder parentRef(@Nullable Output<RegistryFolderDataAssetDefaultConnectionPrimarySchemaParentRefArgs> parentRef) {
            $.parentRef = parentRef;
            return this;
        }
         ...
         * 
         */
        public Builder parentRef(RegistryFolderDataAssetDefaultConnectionPrimarySchemaParentRefArgs parentRef) {
        ...
        public RegistryFolderDataAssetDefaultConnectionPrimarySchemaArgs build() {
