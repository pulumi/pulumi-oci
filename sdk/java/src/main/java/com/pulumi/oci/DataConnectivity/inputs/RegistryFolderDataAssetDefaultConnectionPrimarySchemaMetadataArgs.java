...
public final class RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataArgs extends com.pulumi.resources.ResourceArgs {

    public static final RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataArgs Empty = new RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataArgs();
    ...
    private @Nullable Output<RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataAggregatorArgs> aggregator;
     ...
     * 
     */
    public Optional<Output<RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataAggregatorArgs>> aggregator() {
    ...
    private RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataArgs() {}

    private RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataArgs(RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataArgs $) {
    ...
    public static Builder builder(RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataArgs();
        }

        public Builder(RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataArgs defaults) {
            $ = new RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder aggregator(@Nullable Output<RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataAggregatorArgs> aggregator) {
         ...
         * 
         */
        public Builder aggregator(RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataAggregatorArgs aggregator) {
        ...
        public RegistryFolderDataAssetDefaultConnectionPrimarySchemaMetadataArgs build() {
            return $;
        }
    }
