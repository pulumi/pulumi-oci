...
public final class RegistryFolderDataAssetMetadataAggregatorArgs extends com.pulumi.resources.ResourceArgs {

    public static final RegistryFolderDataAssetMetadataAggregatorArgs Empty = new RegistryFolderDataAssetMetadataAggregatorArgs();
    ...
    private RegistryFolderDataAssetMetadataAggregatorArgs() {}

    private RegistryFolderDataAssetMetadataAggregatorArgs(RegistryFolderDataAssetMetadataAggregatorArgs $) {
    ...
    public static Builder builder(RegistryFolderDataAssetMetadataAggregatorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RegistryFolderDataAssetMetadataAggregatorArgs();
        }

        public Builder(RegistryFolderDataAssetMetadataAggregatorArgs defaults) {
            $ = new RegistryFolderDataAssetMetadataAggregatorArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RegistryFolderDataAssetMetadataAggregatorArgs build() {
            return $;
        }
    }
