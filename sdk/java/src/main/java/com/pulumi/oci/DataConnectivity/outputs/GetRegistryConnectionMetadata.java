...
import com.pulumi.oci.DataConnectivity.outputs.GetRegistryConnectionMetadataAggregator;
...
@CustomType
public final class GetRegistryConnectionMetadata {
    /**
     ...
     * 
     */
    private List<GetRegistryConnectionMetadataAggregator> aggregators;
    /**
    ...
    private GetRegistryConnectionMetadata() {}
    /**
     * @return The owning object&#39;s key for this object.
     * 
     */
     ...
     * 
     */
    public List<GetRegistryConnectionMetadataAggregator> aggregators() {
    ...
    public static Builder builder(GetRegistryConnectionMetadata defaults) {
    ...
    public static final class Builder {
        ...
        private String updatedByName;
        public Builder() {}
        public Builder(GetRegistryConnectionMetadata defaults) {
        ...
        @CustomType.Setter
        public Builder aggregators(List<GetRegistryConnectionMetadataAggregator> aggregators) {
            this.aggregators = Objects.requireNonNull(aggregators);
            return this;
        }
        public Builder aggregators(GetRegistryConnectionMetadataAggregator... aggregators) {
        ...
        public GetRegistryConnectionMetadata build() {
            final var o = new GetRegistryConnectionMetadata();
