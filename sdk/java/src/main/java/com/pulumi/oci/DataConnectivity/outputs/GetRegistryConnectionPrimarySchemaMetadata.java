...
import com.pulumi.oci.DataConnectivity.outputs.GetRegistryConnectionPrimarySchemaMetadataAggregator;
...
@CustomType
public final class GetRegistryConnectionPrimarySchemaMetadata {
    /**
     ...
     * 
     */
    private List<GetRegistryConnectionPrimarySchemaMetadataAggregator> aggregators;
    /**
    ...
    private GetRegistryConnectionPrimarySchemaMetadata() {}
    /**
     * @return The owning object&#39;s key for this object.
     * 
     */
     ...
     * 
     */
    public List<GetRegistryConnectionPrimarySchemaMetadataAggregator> aggregators() {
    ...
    public static Builder builder(GetRegistryConnectionPrimarySchemaMetadata defaults) {
    ...
    public static final class Builder {
        ...
        private String updatedByName;
        public Builder() {}
        public Builder(GetRegistryConnectionPrimarySchemaMetadata defaults) {
        ...
        @CustomType.Setter
        public Builder aggregators(List<GetRegistryConnectionPrimarySchemaMetadataAggregator> aggregators) {
            this.aggregators = Objects.requireNonNull(aggregators);
            return this;
        }
        public Builder aggregators(GetRegistryConnectionPrimarySchemaMetadataAggregator... aggregators) {
        ...
        public GetRegistryConnectionPrimarySchemaMetadata build() {
            final var o = new GetRegistryConnectionPrimarySchemaMetadata();
