...
import com.pulumi.oci.DataConnectivity.outputs.RegistryDataAssetDefaultConnectionPrimarySchemaMetadataAggregator;
...
@CustomType
public final class RegistryDataAssetDefaultConnectionPrimarySchemaMetadata {
    /**
     ...
     * 
     */
    private @Nullable RegistryDataAssetDefaultConnectionPrimarySchemaMetadataAggregator aggregator;
    /**
    ...
    private RegistryDataAssetDefaultConnectionPrimarySchemaMetadata() {}
    /**
     * @return (Updatable) A summary type containing information about the object&#39;s aggregator including its type, key, name, and description.
     * 
     */
    public Optional<RegistryDataAssetDefaultConnectionPrimarySchemaMetadataAggregator> aggregator() {
    ...
    public static Builder builder(RegistryDataAssetDefaultConnectionPrimarySchemaMetadata defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String updatedByName;
        public Builder() {}
        public Builder(RegistryDataAssetDefaultConnectionPrimarySchemaMetadata defaults) {
        ...
        @CustomType.Setter
        public Builder aggregator(@Nullable RegistryDataAssetDefaultConnectionPrimarySchemaMetadataAggregator aggregator) {
        ...
        public RegistryDataAssetDefaultConnectionPrimarySchemaMetadata build() {
            final var o = new RegistryDataAssetDefaultConnectionPrimarySchemaMetadata();
