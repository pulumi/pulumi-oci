...
public final class InvokeRunDriverShapeConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final InvokeRunDriverShapeConfigArgs Empty = new InvokeRunDriverShapeConfigArgs();
    ...
    private InvokeRunDriverShapeConfigArgs() {}

    private InvokeRunDriverShapeConfigArgs(InvokeRunDriverShapeConfigArgs $) {
    ...
    public static Builder builder(InvokeRunDriverShapeConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new InvokeRunDriverShapeConfigArgs();
        }

        public Builder(InvokeRunDriverShapeConfigArgs defaults) {
            $ = new InvokeRunDriverShapeConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public InvokeRunDriverShapeConfigArgs build() {
            return $;
        }
    }
