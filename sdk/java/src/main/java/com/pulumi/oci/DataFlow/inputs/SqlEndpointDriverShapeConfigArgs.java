...
public final class SqlEndpointDriverShapeConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final SqlEndpointDriverShapeConfigArgs Empty = new SqlEndpointDriverShapeConfigArgs();
    ...
    private SqlEndpointDriverShapeConfigArgs() {}

    private SqlEndpointDriverShapeConfigArgs(SqlEndpointDriverShapeConfigArgs $) {
    ...
    public static Builder builder(SqlEndpointDriverShapeConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SqlEndpointDriverShapeConfigArgs();
        }

        public Builder(SqlEndpointDriverShapeConfigArgs defaults) {
            $ = new SqlEndpointDriverShapeConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SqlEndpointDriverShapeConfigArgs build() {
            return $;
        }
    }
