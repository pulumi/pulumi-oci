...
public final class GetApplicationApplicationLogConfig {
    ...
    public static final class Builder {
        ...
        public Builder logGroupId(String logGroupId) {
            if (logGroupId == null) {
              throw new MissingRequiredPropertyException("GetApplicationApplicationLogConfig", "logGroupId");
            }
        ...
        public Builder logId(String logId) {
            if (logId == null) {
              throw new MissingRequiredPropertyException("GetApplicationApplicationLogConfig", "logId");
            }
            this.logId = logId;
            return this;
        }
