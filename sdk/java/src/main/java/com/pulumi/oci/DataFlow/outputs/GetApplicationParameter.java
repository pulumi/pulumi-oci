...
public final class GetApplicationParameter {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetApplicationParameter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetApplicationParameter", "value");
            }
            this.value = value;
            return this;
        }
        public GetApplicationParameter build() {
            final var _resultValue = new GetApplicationParameter();
