...
@CustomType
public final class GetApplicationsApplicationDriverShapeConfig {
    /**
    ...
    private GetApplicationsApplicationDriverShapeConfig() {}
    /**
     * @return The amount of memory used for the driver or executors.
     * 
     */
    ...
    public static Builder builder(GetApplicationsApplicationDriverShapeConfig defaults) {
    ...
    public static final class Builder {
        ...
        private Double ocpus;
        public Builder() {}
        public Builder(GetApplicationsApplicationDriverShapeConfig defaults) {
        ...
        public Builder memoryInGbs(Double memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetApplicationsApplicationDriverShapeConfig", "memoryInGbs");
            }
        ...
        public Builder ocpus(Double ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetApplicationsApplicationDriverShapeConfig", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
