...
@CustomType
public final class GetApplicationsApplicationExecutorShapeConfig {
    /**
    ...
    private GetApplicationsApplicationExecutorShapeConfig() {}
    /**
     * @return The amount of memory used for the driver or executors.
     * 
     */
    ...
    public static Builder builder(GetApplicationsApplicationExecutorShapeConfig defaults) {
    ...
    public static final class Builder {
        ...
        private Double ocpus;
        public Builder() {}
        public Builder(GetApplicationsApplicationExecutorShapeConfig defaults) {
        ...
        public Builder memoryInGbs(Double memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetApplicationsApplicationExecutorShapeConfig", "memoryInGbs");
            }
        ...
        public Builder ocpus(Double ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetApplicationsApplicationExecutorShapeConfig", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
