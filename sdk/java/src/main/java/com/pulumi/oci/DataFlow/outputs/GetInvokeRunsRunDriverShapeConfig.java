...
@CustomType
public final class GetInvokeRunsRunDriverShapeConfig {
    /**
    ...
    public static final class Builder {
        ...
        public Builder memoryInGbs(Double memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetInvokeRunsRunDriverShapeConfig", "memoryInGbs");
            }
        ...
        public Builder ocpus(Double ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetInvokeRunsRunDriverShapeConfig", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
