...
@CustomType
public final class GetInvokeRunsRunExecutorShapeConfig {
    /**
    ...
    private GetInvokeRunsRunExecutorShapeConfig() {}
    /**
     * @return The amount of memory used for the driver or executors.
     * 
     */
    ...
    public static Builder builder(GetInvokeRunsRunExecutorShapeConfig defaults) {
    ...
    public static final class Builder {
        ...
        private Double ocpus;
        public Builder() {}
        public Builder(GetInvokeRunsRunExecutorShapeConfig defaults) {
        ...
        public Builder memoryInGbs(Double memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetInvokeRunsRunExecutorShapeConfig", "memoryInGbs");
            }
        ...
        public Builder ocpus(Double ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetInvokeRunsRunExecutorShapeConfig", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
