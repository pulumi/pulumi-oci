...
@CustomType
public final class GetPoolConfigurationShapeConfig {
    /**
    ...
    private GetPoolConfigurationShapeConfig() {}
    /**
     * @return The amount of memory used for the driver or executors.
     * 
     */
    ...
    public static Builder builder(GetPoolConfigurationShapeConfig defaults) {
    ...
    public static final class Builder {
        ...
        private Double ocpus;
        public Builder() {}
        public Builder(GetPoolConfigurationShapeConfig defaults) {
        ...
        public Builder memoryInGbs(Double memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetPoolConfigurationShapeConfig", "memoryInGbs");
            }
        ...
        public Builder ocpus(Double ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetPoolConfigurationShapeConfig", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
