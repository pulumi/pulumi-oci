...
@CustomType
public final class GetSqlEndpointDriverShapeConfig {
    /**
    ...
    private GetSqlEndpointDriverShapeConfig() {}
    /**
     * @return The amount of memory used for the driver or executors.
     * 
     */
    ...
    public static Builder builder(GetSqlEndpointDriverShapeConfig defaults) {
    ...
    public static final class Builder {
        ...
        private Double ocpus;
        public Builder() {}
        public Builder(GetSqlEndpointDriverShapeConfig defaults) {
        ...
        public Builder memoryInGbs(Double memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetSqlEndpointDriverShapeConfig", "memoryInGbs");
            }
        ...
        public Builder ocpus(Double ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetSqlEndpointDriverShapeConfig", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
