...
@CustomType
public final class GetSqlEndpointExecutorShapeConfig {
    /**
    ...
    private GetSqlEndpointExecutorShapeConfig() {}
    /**
     * @return The amount of memory used for the driver or executors.
     * 
     */
    ...
    public static Builder builder(GetSqlEndpointExecutorShapeConfig defaults) {
    ...
    public static final class Builder {
        ...
        private Double ocpus;
        public Builder() {}
        public Builder(GetSqlEndpointExecutorShapeConfig defaults) {
        ...
        public Builder memoryInGbs(Double memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetSqlEndpointExecutorShapeConfig", "memoryInGbs");
            }
        ...
        public Builder ocpus(Double ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetSqlEndpointExecutorShapeConfig", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
