...
import com.pulumi.oci.DataFlow.outputs.PoolPoolMetricActivelyUsedNodeCount;
...
@CustomType
public final class PoolPoolMetric {
    /**
     ...
     * 
     */
    private @Nullable List<PoolPoolMetricActivelyUsedNodeCount> activelyUsedNodeCounts;
    /**
     ...
     * 
     */
    public List<PoolPoolMetricActivelyUsedNodeCount> activelyUsedNodeCounts() {
    ...
    public static Builder builder(PoolPoolMetric defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String timeLastUsed;
        public Builder() {}
        public Builder(PoolPoolMetric defaults) {
        ...
        public Builder activelyUsedNodeCounts(PoolPoolMetricActivelyUsedNodeCount... activelyUsedNodeCounts) {
