...
@CustomType
public final class SqlEndpointDriverShapeConfig {
    /**
    ...
    private SqlEndpointDriverShapeConfig() {}
    /**
     * @return The amount of memory used for the driver or executors.
     * 
     */
    ...
    public static Builder builder(SqlEndpointDriverShapeConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double ocpus;
        public Builder() {}
        public Builder(SqlEndpointDriverShapeConfig defaults) {
        ...
        public SqlEndpointDriverShapeConfig build() {
            final var _resultValue = new SqlEndpointDriverShapeConfig();
