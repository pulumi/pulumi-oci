...
@CustomType
public final class SqlEndpointExecutorShapeConfig {
    /**
    ...
    public static Builder builder(SqlEndpointExecutorShapeConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double ocpus;
        public Builder() {}
        public Builder(SqlEndpointExecutorShapeConfig defaults) {
        ...
        public SqlEndpointExecutorShapeConfig build() {
            final var _resultValue = new SqlEndpointExecutorShapeConfig();
