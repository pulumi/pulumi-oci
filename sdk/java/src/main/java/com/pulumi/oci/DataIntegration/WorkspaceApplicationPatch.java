 ...
 *             .identifier(var_.workspace_application_patch_identifier())
 *             .objectKeys(var_.workspace_application_patch_object_keys())
 *             .patchType(var_.workspace_application_patch_patch_type())
 *             .workspaceId(oci_dataintegration_workspace.test_workspace().id())
 *             .description(var_.workspace_application_patch_description())
 *             .key(var_.workspace_application_patch_key())
 *             .modelVersion(var_.workspace_application_patch_model_version())
 *             .objectStatus(var_.workspace_application_patch_object_status())
 *             .registryMetadata(WorkspaceApplicationPatchRegistryMetadataArgs.builder()
 *                 .aggregatorKey(var_.workspace_application_patch_registry_metadata_aggregator_key())
 *                 .isFavorite(var_.workspace_application_patch_registry_metadata_is_favorite())
 *                 .key(var_.workspace_application_patch_registry_metadata_key())
 *                 .labels(var_.workspace_application_patch_registry_metadata_labels())
 *                 .registryVersion(var_.workspace_application_patch_registry_metadata_registry_version())
 *                 .build())
 *             .build());
 * 
 *     }
