 ...
 *             .identifier(var_.workspace_application_task_schedule_identifier())
 *             .workspaceId(oci_dataintegration_workspace.test_workspace().id())
 *             .authMode(var_.workspace_application_task_schedule_auth_mode())
 *             .configProviderDelegate(var_.workspace_application_task_schedule_config_provider_delegate())
 *             .description(var_.workspace_application_task_schedule_description())
 *             .endTimeMillis(var_.workspace_application_task_schedule_end_time_millis())
 *             .expectedDuration(var_.workspace_application_task_schedule_expected_duration())
 *             .expectedDurationUnit(var_.workspace_application_task_schedule_expected_duration_unit())
 *             .isBackfillEnabled(var_.workspace_application_task_schedule_is_backfill_enabled())
 *             .isConcurrentAllowed(var_.workspace_application_task_schedule_is_concurrent_allowed())
 *             .isEnabled(var_.workspace_application_task_schedule_is_enabled())
 *             .key(var_.workspace_application_task_schedule_key())
 *             .modelVersion(var_.workspace_application_task_schedule_model_version())
 *             .numberOfRetries(var_.workspace_application_task_schedule_number_of_retries())
 *             .objectStatus(var_.workspace_application_task_schedule_object_status())
 *             .objectVersion(var_.workspace_application_task_schedule_object_version())
 *             .parentRef(WorkspaceApplicationTaskScheduleParentRefArgs.builder()
 *                 .parent(var_.workspace_application_task_schedule_parent_ref_parent())
 ...
 *                 .aggregatorKey(var_.workspace_application_task_schedule_registry_metadata_aggregator_key())
 *                 .isFavorite(var_.workspace_application_task_schedule_registry_metadata_is_favorite())
 *                 .key(var_.workspace_application_task_schedule_registry_metadata_key())
 *                 .labels(var_.workspace_application_task_schedule_registry_metadata_labels())
 *                 .registryVersion(var_.workspace_application_task_schedule_registry_metadata_registry_version())
 *                 .build())
 *             .retryDelay(var_.workspace_application_task_schedule_retry_delay())
 *             .retryDelayUnit(var_.workspace_application_task_schedule_retry_delay_unit())
 *             .scheduleRef(WorkspaceApplicationTaskScheduleScheduleRefArgs.builder()
 *                 .description(var_.workspace_application_task_schedule_schedule_ref_description())
 *                 .frequencyDetails(WorkspaceApplicationTaskScheduleScheduleRefFrequencyDetailsArgs.builder()
 *                     .modelType(var_.workspace_application_task_schedule_schedule_ref_frequency_details_model_type())
 *                     .customExpression(var_.workspace_application_task_schedule_schedule_ref_frequency_details_custom_expression())
 *                     .dayOfWeek(var_.workspace_application_task_schedule_schedule_ref_frequency_details_day_of_week())
 *                     .days(var_.workspace_application_task_schedule_schedule_ref_frequency_details_days())
 *                     .frequency(var_.workspace_application_task_schedule_schedule_ref_frequency_details_frequency())
 *                     .interval(var_.workspace_application_task_schedule_schedule_ref_frequency_details_interval())
 *                     .time(WorkspaceApplicationTaskScheduleScheduleRefFrequencyDetailsTimeArgs.builder()
 *                         .hour(var_.workspace_application_task_schedule_schedule_ref_frequency_details_time_hour())
 *                         .minute(var_.workspace_application_task_schedule_schedule_ref_frequency_details_time_minute())
 *                         .second(var_.workspace_application_task_schedule_schedule_ref_frequency_details_time_second())
 *                         .build())
 *                     .weekOfMonth(var_.workspace_application_task_schedule_schedule_ref_frequency_details_week_of_month())
 *                     .build())
 *                 .identifier(var_.workspace_application_task_schedule_schedule_ref_identifier())
 *                 .isDaylightAdjustmentEnabled(var_.workspace_application_task_schedule_schedule_ref_is_daylight_adjustment_enabled())
 *                 .key(var_.workspace_application_task_schedule_schedule_ref_key())
 ...
 *                         .description(var_.workspace_application_task_schedule_schedule_ref_metadata_aggregator_description())
 *                         .identifier(var_.workspace_application_task_schedule_schedule_ref_metadata_aggregator_identifier())
 *                         .key(var_.workspace_application_task_schedule_schedule_ref_metadata_aggregator_key())
 *                         .name(var_.workspace_application_task_schedule_schedule_ref_metadata_aggregator_name())
 *                         .type(var_.workspace_application_task_schedule_schedule_ref_metadata_aggregator_type())
 *                         .build())
 *                     .aggregatorKey(var_.workspace_application_task_schedule_schedule_ref_metadata_aggregator_key())
 ...
 *                             .objectCount(var_.workspace_application_task_schedule_schedule_ref_metadata_count_statistics_object_type_count_list_object_count())
 *                             .objectType(var_.workspace_application_task_schedule_schedule_ref_metadata_count_statistics_object_type_count_list_object_type())
 *                             .build())
 *                         .build())
 *                     .createdBy(var_.workspace_application_task_schedule_schedule_ref_metadata_created_by())
 *                     .createdByName(var_.workspace_application_task_schedule_schedule_ref_metadata_created_by_name())
 *                     .identifierPath(var_.workspace_application_task_schedule_schedule_ref_metadata_identifier_path())
 *                     .infoFields(var_.workspace_application_task_schedule_schedule_ref_metadata_info_fields())
 *                     .isFavorite(var_.workspace_application_task_schedule_schedule_ref_metadata_is_favorite())
 *                     .labels(var_.workspace_application_task_schedule_schedule_ref_metadata_labels())
 *                     .registryVersion(var_.workspace_application_task_schedule_schedule_ref_metadata_registry_version())
 *                     .timeCreated(var_.workspace_application_task_schedule_schedule_ref_metadata_time_created())
 *                     .timeUpdated(var_.workspace_application_task_schedule_schedule_ref_metadata_time_updated())
 *                     .updatedBy(var_.workspace_application_task_schedule_schedule_ref_metadata_updated_by())
 *                     .updatedByName(var_.workspace_application_task_schedule_schedule_ref_metadata_updated_by_name())
 *                     .build())
 *                 .modelType(var_.workspace_application_task_schedule_schedule_ref_model_type())
 *                 .modelVersion(var_.workspace_application_task_schedule_schedule_ref_model_version())
 *                 .name(var_.workspace_application_task_schedule_schedule_ref_name())
 *                 .objectStatus(var_.workspace_application_task_schedule_schedule_ref_object_status())
 *                 .objectVersion(var_.workspace_application_task_schedule_schedule_ref_object_version())
 *                 .parentRef(WorkspaceApplicationTaskScheduleScheduleRefParentRefArgs.builder()
 *                     .parent(var_.workspace_application_task_schedule_schedule_ref_parent_ref_parent())
 *                     .rootDocId(oci_dataintegration_root_doc.test_root_doc().id())
 *                     .build())
 *                 .timezone(var_.workspace_application_task_schedule_schedule_ref_timezone())
 *                 .build())
 *             .startTimeMillis(var_.workspace_application_task_schedule_start_time_millis())
 *             .build());
 * 
 *     }
 * }
