...
public class WorkspaceExportRequest extends com.pulumi.resources.CustomResource {
    ...
    public WorkspaceExportRequest(String name, WorkspaceExportRequestArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DataIntegration/workspaceExportRequest:WorkspaceExportRequest", name, args == null ? WorkspaceExportRequestArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
