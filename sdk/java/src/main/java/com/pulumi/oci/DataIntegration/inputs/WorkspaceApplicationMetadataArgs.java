...
import com.pulumi.oci.DataIntegration.inputs.WorkspaceApplicationMetadataAggregatorArgs;
import com.pulumi.oci.DataIntegration.inputs.WorkspaceApplicationMetadataCountStatisticArgs;
...
public final class WorkspaceApplicationMetadataArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<WorkspaceApplicationMetadataAggregatorArgs>> aggregators;

    /**
     * @return A summary type containing information about the object&#39;s aggregator including its type, key, name and description.
     * 
     */
    public Optional<Output<List<WorkspaceApplicationMetadataAggregatorArgs>>> aggregators() {
    ...
    private @Nullable Output<List<WorkspaceApplicationMetadataCountStatisticArgs>> countStatistics;

    /**
     * @return A count statistics.
     * 
     */
    public Optional<Output<List<WorkspaceApplicationMetadataCountStatisticArgs>>> countStatistics() {
    ...
    private WorkspaceApplicationMetadataArgs() {}

    private WorkspaceApplicationMetadataArgs(WorkspaceApplicationMetadataArgs $) {
    ...
    public static Builder builder(WorkspaceApplicationMetadataArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkspaceApplicationMetadataArgs();
        }

        public Builder(WorkspaceApplicationMetadataArgs defaults) {
            $ = new WorkspaceApplicationMetadataArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder aggregators(@Nullable Output<List<WorkspaceApplicationMetadataAggregatorArgs>> aggregators) {
         ...
         * 
         */
        public Builder aggregators(List<WorkspaceApplicationMetadataAggregatorArgs> aggregators) {
         ...
         * 
         */
        public Builder aggregators(WorkspaceApplicationMetadataAggregatorArgs... aggregators) {
         ...
         * 
         */
        public Builder countStatistics(@Nullable Output<List<WorkspaceApplicationMetadataCountStatisticArgs>> countStatistics) {
         ...
         * 
         */
        public Builder countStatistics(List<WorkspaceApplicationMetadataCountStatisticArgs> countStatistics) {
         ...
         * 
         */
        public Builder countStatistics(WorkspaceApplicationMetadataCountStatisticArgs... countStatistics) {
        ...
        public WorkspaceApplicationMetadataArgs build() {
            return $;
        }
    }
