...
public final class WorkspaceApplicationPatchDependentObjectMetadataArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkspaceApplicationPatchDependentObjectMetadataArgs Empty = new WorkspaceApplicationPatchDependentObjectMetadataArgs();
    ...
    private WorkspaceApplicationPatchDependentObjectMetadataArgs() {}

    private WorkspaceApplicationPatchDependentObjectMetadataArgs(WorkspaceApplicationPatchDependentObjectMetadataArgs $) {
        this.action = $.action;
    ...
    public static Builder builder(WorkspaceApplicationPatchDependentObjectMetadataArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkspaceApplicationPatchDependentObjectMetadataArgs();
        }

        public Builder(WorkspaceApplicationPatchDependentObjectMetadataArgs defaults) {
            $ = new WorkspaceApplicationPatchDependentObjectMetadataArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WorkspaceApplicationPatchDependentObjectMetadataArgs build() {
            return $;
        }
    }
