...
import com.pulumi.oci.DataIntegration.inputs.WorkspaceApplicationPatchMetadataAggregatorArgs;
import com.pulumi.oci.DataIntegration.inputs.WorkspaceApplicationPatchMetadataCountStatisticArgs;
...
public final class WorkspaceApplicationPatchMetadataArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkspaceApplicationPatchMetadataArgs Empty = new WorkspaceApplicationPatchMetadataArgs();
    ...
    private @Nullable Output<List<WorkspaceApplicationPatchMetadataAggregatorArgs>> aggregators;

    /**
     * @return A summary type containing information about the object&#39;s aggregator including its type, key, name and description.
     * 
     */
    public Optional<Output<List<WorkspaceApplicationPatchMetadataAggregatorArgs>>> aggregators() {
    ...
    private @Nullable Output<List<WorkspaceApplicationPatchMetadataCountStatisticArgs>> countStatistics;

    /**
     * @return A count statistics.
     * 
     */
    public Optional<Output<List<WorkspaceApplicationPatchMetadataCountStatisticArgs>>> countStatistics() {
    ...
    private WorkspaceApplicationPatchMetadataArgs() {}

    private WorkspaceApplicationPatchMetadataArgs(WorkspaceApplicationPatchMetadataArgs $) {
    ...
    public static Builder builder(WorkspaceApplicationPatchMetadataArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkspaceApplicationPatchMetadataArgs();
        }

        public Builder(WorkspaceApplicationPatchMetadataArgs defaults) {
            $ = new WorkspaceApplicationPatchMetadataArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder aggregators(@Nullable Output<List<WorkspaceApplicationPatchMetadataAggregatorArgs>> aggregators) {
         ...
         * 
         */
        public Builder aggregators(List<WorkspaceApplicationPatchMetadataAggregatorArgs> aggregators) {
         ...
         * 
         */
        public Builder aggregators(WorkspaceApplicationPatchMetadataAggregatorArgs... aggregators) {
         ...
         * 
         */
        public Builder countStatistics(@Nullable Output<List<WorkspaceApplicationPatchMetadataCountStatisticArgs>> countStatistics) {
         ...
         * 
         */
        public Builder countStatistics(List<WorkspaceApplicationPatchMetadataCountStatisticArgs> countStatistics) {
         ...
         * 
         */
        public Builder countStatistics(WorkspaceApplicationPatchMetadataCountStatisticArgs... countStatistics) {
        ...
        public WorkspaceApplicationPatchMetadataArgs build() {
            return $;
        }
    }
