...
import com.pulumi.oci.DataIntegration.inputs.WorkspaceApplicationScheduleMetadataAggregatorArgs;
import com.pulumi.oci.DataIntegration.inputs.WorkspaceApplicationScheduleMetadataCountStatisticArgs;
...
public final class WorkspaceApplicationScheduleMetadataArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkspaceApplicationScheduleMetadataArgs Empty = new WorkspaceApplicationScheduleMetadataArgs();
    ...
    private @Nullable Output<List<WorkspaceApplicationScheduleMetadataAggregatorArgs>> aggregators;

    /**
     * @return A summary type containing information about the object&#39;s aggregator including its type, key, name and description.
     * 
     */
    public Optional<Output<List<WorkspaceApplicationScheduleMetadataAggregatorArgs>>> aggregators() {
    ...
    private @Nullable Output<List<WorkspaceApplicationScheduleMetadataCountStatisticArgs>> countStatistics;

    /**
     * @return A count statistics.
     * 
     */
    public Optional<Output<List<WorkspaceApplicationScheduleMetadataCountStatisticArgs>>> countStatistics() {
    ...
    private WorkspaceApplicationScheduleMetadataArgs() {}

    private WorkspaceApplicationScheduleMetadataArgs(WorkspaceApplicationScheduleMetadataArgs $) {
    ...
    public static Builder builder(WorkspaceApplicationScheduleMetadataArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkspaceApplicationScheduleMetadataArgs();
        }

        public Builder(WorkspaceApplicationScheduleMetadataArgs defaults) {
            $ = new WorkspaceApplicationScheduleMetadataArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder aggregators(@Nullable Output<List<WorkspaceApplicationScheduleMetadataAggregatorArgs>> aggregators) {
         ...
         * 
         */
        public Builder aggregators(List<WorkspaceApplicationScheduleMetadataAggregatorArgs> aggregators) {
         ...
         * 
         */
        public Builder aggregators(WorkspaceApplicationScheduleMetadataAggregatorArgs... aggregators) {
         ...
         * 
         */
        public Builder countStatistics(@Nullable Output<List<WorkspaceApplicationScheduleMetadataCountStatisticArgs>> countStatistics) {
         ...
         * 
         */
        public Builder countStatistics(List<WorkspaceApplicationScheduleMetadataCountStatisticArgs> countStatistics) {
         ...
         * 
         */
        public Builder countStatistics(WorkspaceApplicationScheduleMetadataCountStatisticArgs... countStatistics) {
        ...
        public WorkspaceApplicationScheduleMetadataArgs build() {
            return $;
        }
    }
