...
public final class WorkspaceApplicationTaskScheduleScheduleRefFrequencyDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkspaceApplicationTaskScheduleScheduleRefFrequencyDetailsArgs Empty = new WorkspaceApplicationTaskScheduleScheduleRefFrequencyDetailsArgs();
     ...
     */
    @Import(name="time")
    private @Nullable Output<WorkspaceApplicationTaskScheduleScheduleRefFrequencyDetailsTimeArgs> time;

    /**
     * @return (Updatable) A model to hold time in hour:minute:second format.
     * 
     */
    public Optional<Output<WorkspaceApplicationTaskScheduleScheduleRefFrequencyDetailsTimeArgs>> time() {
    ...
    private WorkspaceApplicationTaskScheduleScheduleRefFrequencyDetailsArgs() {}

    private WorkspaceApplicationTaskScheduleScheduleRefFrequencyDetailsArgs(WorkspaceApplicationTaskScheduleScheduleRefFrequencyDetailsArgs $) {
    ...
    public static Builder builder(WorkspaceApplicationTaskScheduleScheduleRefFrequencyDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkspaceApplicationTaskScheduleScheduleRefFrequencyDetailsArgs();
        }

        public Builder(WorkspaceApplicationTaskScheduleScheduleRefFrequencyDetailsArgs defaults) {
            $ = new WorkspaceApplicationTaskScheduleScheduleRefFrequencyDetailsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder time(@Nullable Output<WorkspaceApplicationTaskScheduleScheduleRefFrequencyDetailsTimeArgs> time) {
            $.time = time;
            return this;
        }
         ...
         * 
         */
        public Builder time(WorkspaceApplicationTaskScheduleScheduleRefFrequencyDetailsTimeArgs time) {
        ...
        public WorkspaceApplicationTaskScheduleScheduleRefFrequencyDetailsArgs build() {
            if ($.modelType == null) {
                throw new MissingRequiredPropertyException("WorkspaceApplicationTaskScheduleScheduleRefFrequencyDetailsArgs", "modelType");
            }
            return $;
        }
    }
