...
import com.pulumi.oci.DataIntegration.inputs.WorkspaceFolderMetadataAggregatorArgs;
...
public final class WorkspaceFolderMetadataArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkspaceFolderMetadataArgs Empty = new WorkspaceFolderMetadataArgs();
    ...
    private @Nullable Output<List<WorkspaceFolderMetadataAggregatorArgs>> aggregators;

    /**
     * @return A summary type containing information about the object&#39;s aggregator including its type, key, name and description.
     * 
     */
    public Optional<Output<List<WorkspaceFolderMetadataAggregatorArgs>>> aggregators() {
    ...
    private @Nullable Output<List<WorkspaceFolderMetadataCountStatisticArgs>> countStatistics;

    /**
     * @return A count statistics.
     * 
     */
    public Optional<Output<List<WorkspaceFolderMetadataCountStatisticArgs>>> countStatistics() {
    ...
    private WorkspaceFolderMetadataArgs() {}

    private WorkspaceFolderMetadataArgs(WorkspaceFolderMetadataArgs $) {
    ...
    public static Builder builder(WorkspaceFolderMetadataArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkspaceFolderMetadataArgs();
        }

        public Builder(WorkspaceFolderMetadataArgs defaults) {
            $ = new WorkspaceFolderMetadataArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder aggregators(@Nullable Output<List<WorkspaceFolderMetadataAggregatorArgs>> aggregators) {
         ...
         * 
         */
        public Builder aggregators(List<WorkspaceFolderMetadataAggregatorArgs> aggregators) {
         ...
         * 
         */
        public Builder aggregators(WorkspaceFolderMetadataAggregatorArgs... aggregators) {
         ...
         * 
         */
        public Builder countStatistics(@Nullable Output<List<WorkspaceFolderMetadataCountStatisticArgs>> countStatistics) {
         ...
         * 
         */
        public Builder countStatistics(List<WorkspaceFolderMetadataCountStatisticArgs> countStatistics) {
         ...
         * 
         */
        public Builder countStatistics(WorkspaceFolderMetadataCountStatisticArgs... countStatistics) {
        ...
        public WorkspaceFolderMetadataArgs build() {
            return $;
        }
    }
