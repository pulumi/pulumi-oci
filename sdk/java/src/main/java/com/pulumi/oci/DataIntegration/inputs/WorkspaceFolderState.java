...
import com.pulumi.oci.DataIntegration.inputs.WorkspaceFolderMetadataArgs;
import com.pulumi.oci.DataIntegration.inputs.WorkspaceFolderParentRefArgs;
...
public final class WorkspaceFolderState extends com.pulumi.resources.ResourceArgs {

    public static final WorkspaceFolderState Empty = new WorkspaceFolderState();
    ...
    private @Nullable Output<List<WorkspaceFolderMetadataArgs>> metadatas;

    /**
     * @return A summary type containing information about the object including its key, name and when/who created/updated it.
     * 
     */
    public Optional<Output<List<WorkspaceFolderMetadataArgs>>> metadatas() {
    ...
    private @Nullable Output<List<WorkspaceFolderParentRefArgs>> parentReves;

    /**
     * @return A reference to the object&#39;s parent.
     * 
     */
    public Optional<Output<List<WorkspaceFolderParentRefArgs>>> parentReves() {
    ...
    private @Nullable Output<WorkspaceFolderRegistryMetadataArgs> registryMetadata;

    /**
     * @return (Updatable) Information about the object and its parent.
     * 
     */
    public Optional<Output<WorkspaceFolderRegistryMetadataArgs>> registryMetadata() {
    ...
    private WorkspaceFolderState() {}

    private WorkspaceFolderState(WorkspaceFolderState $) {
    ...
    public static Builder builder(WorkspaceFolderState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkspaceFolderState();
        }

        public Builder(WorkspaceFolderState defaults) {
            $ = new WorkspaceFolderState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder metadatas(@Nullable Output<List<WorkspaceFolderMetadataArgs>> metadatas) {
            $.metadatas = metadatas;
            return this;
        }
         ...
         * 
         */
        public Builder metadatas(List<WorkspaceFolderMetadataArgs> metadatas) {
         ...
         * 
         */
        public Builder metadatas(WorkspaceFolderMetadataArgs... metadatas) {
         ...
         * 
         */
        public Builder parentReves(@Nullable Output<List<WorkspaceFolderParentRefArgs>> parentReves) {
         ...
         * 
         */
        public Builder parentReves(List<WorkspaceFolderParentRefArgs> parentReves) {
         ...
         * 
         */
        public Builder parentReves(WorkspaceFolderParentRefArgs... parentReves) {
         ...
         * 
         */
        public Builder registryMetadata(@Nullable Output<WorkspaceFolderRegistryMetadataArgs> registryMetadata) {
        ...
        public WorkspaceFolderState build() {
            return $;
        }
    }
