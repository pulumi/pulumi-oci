...
public final class WorkspaceTaskConfigProviderDelegateBindingParameterValuesRootObjectValueArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkspaceTaskConfigProviderDelegateBindingParameterValuesRootObjectValueArgs Empty = new WorkspaceTaskConfigProviderDelegateBindingParameterValuesRootObjectValueArgs();
    ...
    private WorkspaceTaskConfigProviderDelegateBindingParameterValuesRootObjectValueArgs() {}

    private WorkspaceTaskConfigProviderDelegateBindingParameterValuesRootObjectValueArgs(WorkspaceTaskConfigProviderDelegateBindingParameterValuesRootObjectValueArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(WorkspaceTaskConfigProviderDelegateBindingParameterValuesRootObjectValueArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkspaceTaskConfigProviderDelegateBindingParameterValuesRootObjectValueArgs();
        }

        public Builder(WorkspaceTaskConfigProviderDelegateBindingParameterValuesRootObjectValueArgs defaults) {
            $ = new WorkspaceTaskConfigProviderDelegateBindingParameterValuesRootObjectValueArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WorkspaceTaskConfigProviderDelegateBindingParameterValuesRootObjectValueArgs build() {
            return $;
        }
    }
