...
public final class WorkspaceTaskExecuteRestCallConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkspaceTaskExecuteRestCallConfigArgs Empty = new WorkspaceTaskExecuteRestCallConfigArgs();
    ...
    private @Nullable Output<WorkspaceTaskExecuteRestCallConfigConfigValuesArgs> configValues;

    /**
     * @return (Updatable) Configuration values can be string, objects, or parameters.
     * 
     */
    public Optional<Output<WorkspaceTaskExecuteRestCallConfigConfigValuesArgs>> configValues() {
    ...
    private WorkspaceTaskExecuteRestCallConfigArgs() {}

    private WorkspaceTaskExecuteRestCallConfigArgs(WorkspaceTaskExecuteRestCallConfigArgs $) {
    ...
    public static Builder builder(WorkspaceTaskExecuteRestCallConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkspaceTaskExecuteRestCallConfigArgs();
        }

        public Builder(WorkspaceTaskExecuteRestCallConfigArgs defaults) {
            $ = new WorkspaceTaskExecuteRestCallConfigArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder configValues(@Nullable Output<WorkspaceTaskExecuteRestCallConfigConfigValuesArgs> configValues) {
         ...
         * 
         */
        public Builder configValues(WorkspaceTaskExecuteRestCallConfigConfigValuesArgs configValues) {
        ...
        public WorkspaceTaskExecuteRestCallConfigArgs build() {
            return $;
        }
    }
