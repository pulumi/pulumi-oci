...
public final class WorkspaceTaskInputPortParentRefArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkspaceTaskInputPortParentRefArgs Empty = new WorkspaceTaskInputPortParentRefArgs();
    ...
    private WorkspaceTaskInputPortParentRefArgs() {}

    private WorkspaceTaskInputPortParentRefArgs(WorkspaceTaskInputPortParentRefArgs $) {
        this.parent = $.parent;
    ...
    public static Builder builder(WorkspaceTaskInputPortParentRefArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkspaceTaskInputPortParentRefArgs();
        }

        public Builder(WorkspaceTaskInputPortParentRefArgs defaults) {
            $ = new WorkspaceTaskInputPortParentRefArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WorkspaceTaskInputPortParentRefArgs build() {
            return $;
        }
    }
