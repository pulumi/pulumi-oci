...
import com.pulumi.oci.DataIntegration.inputs.WorkspaceTaskMetadataAggregatorArgs;
import com.pulumi.oci.DataIntegration.inputs.WorkspaceTaskMetadataCountStatisticArgs;
...
public final class WorkspaceTaskMetadataArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkspaceTaskMetadataArgs Empty = new WorkspaceTaskMetadataArgs();
    ...
    private @Nullable Output<List<WorkspaceTaskMetadataAggregatorArgs>> aggregators;

    /**
     * @return A summary type containing information about the object&#39;s aggregator including its type, key, name and description.
     * 
     */
    public Optional<Output<List<WorkspaceTaskMetadataAggregatorArgs>>> aggregators() {
    ...
    private @Nullable Output<List<WorkspaceTaskMetadataCountStatisticArgs>> countStatistics;

    /**
     * @return A count statistics.
     * 
     */
    public Optional<Output<List<WorkspaceTaskMetadataCountStatisticArgs>>> countStatistics() {
    ...
    private WorkspaceTaskMetadataArgs() {}

    private WorkspaceTaskMetadataArgs(WorkspaceTaskMetadataArgs $) {
    ...
    public static Builder builder(WorkspaceTaskMetadataArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkspaceTaskMetadataArgs();
        }

        public Builder(WorkspaceTaskMetadataArgs defaults) {
            $ = new WorkspaceTaskMetadataArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder aggregators(@Nullable Output<List<WorkspaceTaskMetadataAggregatorArgs>> aggregators) {
         ...
         * 
         */
        public Builder aggregators(List<WorkspaceTaskMetadataAggregatorArgs> aggregators) {
         ...
         * 
         */
        public Builder aggregators(WorkspaceTaskMetadataAggregatorArgs... aggregators) {
         ...
         * 
         */
        public Builder countStatistics(@Nullable Output<List<WorkspaceTaskMetadataCountStatisticArgs>> countStatistics) {
         ...
         * 
         */
        public Builder countStatistics(List<WorkspaceTaskMetadataCountStatisticArgs> countStatistics) {
         ...
         * 
         */
        public Builder countStatistics(WorkspaceTaskMetadataCountStatisticArgs... countStatistics) {
        ...
        public WorkspaceTaskMetadataArgs build() {
            return $;
        }
    }
