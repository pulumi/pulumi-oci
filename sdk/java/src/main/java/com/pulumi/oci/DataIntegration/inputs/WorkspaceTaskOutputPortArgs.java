...
public final class WorkspaceTaskOutputPortArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkspaceTaskOutputPortArgs Empty = new WorkspaceTaskOutputPortArgs();
    ...
    private @Nullable Output<WorkspaceTaskOutputPortConfigValuesArgs> configValues;

    /**
     * @return (Updatable) Configuration values can be string, objects, or parameters.
     * 
     */
    public Optional<Output<WorkspaceTaskOutputPortConfigValuesArgs>> configValues() {
    ...
    private @Nullable Output<WorkspaceTaskOutputPortParentRefArgs> parentRef;

    /**
     * @return (Updatable) A reference to the object&#39;s parent.
     * 
     */
    public Optional<Output<WorkspaceTaskOutputPortParentRefArgs>> parentRef() {
    ...
    private WorkspaceTaskOutputPortArgs() {}

    private WorkspaceTaskOutputPortArgs(WorkspaceTaskOutputPortArgs $) {
    ...
    public static Builder builder(WorkspaceTaskOutputPortArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkspaceTaskOutputPortArgs();
        }

        public Builder(WorkspaceTaskOutputPortArgs defaults) {
            $ = new WorkspaceTaskOutputPortArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder configValues(@Nullable Output<WorkspaceTaskOutputPortConfigValuesArgs> configValues) {
         ...
         * 
         */
        public Builder configValues(WorkspaceTaskOutputPortConfigValuesArgs configValues) {
         ...
         * 
         */
        public Builder parentRef(@Nullable Output<WorkspaceTaskOutputPortParentRefArgs> parentRef) {
            $.parentRef = parentRef;
            return this;
        }
         ...
         * 
         */
        public Builder parentRef(WorkspaceTaskOutputPortParentRefArgs parentRef) {
        ...
        public WorkspaceTaskOutputPortArgs build() {
            if ($.modelType == null) {
                throw new MissingRequiredPropertyException("WorkspaceTaskOutputPortArgs", "modelType");
            }
            return $;
        }
    }
