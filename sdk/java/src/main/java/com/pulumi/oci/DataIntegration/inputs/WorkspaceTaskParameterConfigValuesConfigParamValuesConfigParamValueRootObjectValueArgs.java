...
public final class WorkspaceTaskParameterConfigValuesConfigParamValuesConfigParamValueRootObjectValueArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkspaceTaskParameterConfigValuesConfigParamValuesConfigParamValueRootObjectValueArgs Empty = new WorkspaceTaskParameterConfigValuesConfigParamValuesConfigParamValueRootObjectValueArgs();
    ...
    private WorkspaceTaskParameterConfigValuesConfigParamValuesConfigParamValueRootObjectValueArgs() {}

    private WorkspaceTaskParameterConfigValuesConfigParamValuesConfigParamValueRootObjectValueArgs(WorkspaceTaskParameterConfigValuesConfigParamValuesConfigParamValueRootObjectValueArgs $) {
        this.key = $.key;
    ...
    public static Builder builder(WorkspaceTaskParameterConfigValuesConfigParamValuesConfigParamValueRootObjectValueArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkspaceTaskParameterConfigValuesConfigParamValuesConfigParamValueRootObjectValueArgs();
        }

        public Builder(WorkspaceTaskParameterConfigValuesConfigParamValuesConfigParamValueRootObjectValueArgs defaults) {
            $ = new WorkspaceTaskParameterConfigValuesConfigParamValuesConfigParamValueRootObjectValueArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WorkspaceTaskParameterConfigValuesConfigParamValuesConfigParamValueRootObjectValueArgs build() {
            return $;
        }
    }
