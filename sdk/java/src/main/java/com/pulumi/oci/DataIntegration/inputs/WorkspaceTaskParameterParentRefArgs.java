...
public final class WorkspaceTaskParameterParentRefArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkspaceTaskParameterParentRefArgs Empty = new WorkspaceTaskParameterParentRefArgs();
    ...
    private WorkspaceTaskParameterParentRefArgs() {}

    private WorkspaceTaskParameterParentRefArgs(WorkspaceTaskParameterParentRefArgs $) {
        this.parent = $.parent;
    ...
    public static Builder builder(WorkspaceTaskParameterParentRefArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkspaceTaskParameterParentRefArgs();
        }

        public Builder(WorkspaceTaskParameterParentRefArgs defaults) {
            $ = new WorkspaceTaskParameterParentRefArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WorkspaceTaskParameterParentRefArgs build() {
            return $;
        }
    }
