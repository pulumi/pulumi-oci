...
public final class WorkspaceTaskParentRefArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkspaceTaskParentRefArgs Empty = new WorkspaceTaskParentRefArgs();
    ...
    private WorkspaceTaskParentRefArgs() {}

    private WorkspaceTaskParentRefArgs(WorkspaceTaskParentRefArgs $) {
        this.parent = $.parent;
    ...
    public static Builder builder(WorkspaceTaskParentRefArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkspaceTaskParentRefArgs();
        }

        public Builder(WorkspaceTaskParentRefArgs defaults) {
            $ = new WorkspaceTaskParentRefArgs(Objects.requireNonNull(defaults));
        }
        ...
        public WorkspaceTaskParentRefArgs build() {
            return $;
        }
    }
