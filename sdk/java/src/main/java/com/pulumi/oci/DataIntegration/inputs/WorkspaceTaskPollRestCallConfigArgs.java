...
public final class WorkspaceTaskPollRestCallConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkspaceTaskPollRestCallConfigArgs Empty = new WorkspaceTaskPollRestCallConfigArgs();
    ...
    private @Nullable Output<WorkspaceTaskPollRestCallConfigConfigValuesArgs> configValues;

    /**
     * @return (Updatable) Configuration values can be string, objects, or parameters.
     * 
     */
    public Optional<Output<WorkspaceTaskPollRestCallConfigConfigValuesArgs>> configValues() {
    ...
    private WorkspaceTaskPollRestCallConfigArgs() {}

    private WorkspaceTaskPollRestCallConfigArgs(WorkspaceTaskPollRestCallConfigArgs $) {
    ...
    public static Builder builder(WorkspaceTaskPollRestCallConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkspaceTaskPollRestCallConfigArgs();
        }

        public Builder(WorkspaceTaskPollRestCallConfigArgs defaults) {
            $ = new WorkspaceTaskPollRestCallConfigArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder configValues(@Nullable Output<WorkspaceTaskPollRestCallConfigConfigValuesArgs> configValues) {
         ...
         * 
         */
        public Builder configValues(WorkspaceTaskPollRestCallConfigConfigValuesArgs configValues) {
        ...
        public WorkspaceTaskPollRestCallConfigArgs build() {
            return $;
        }
    }
