...
public final class WorkspaceTaskRegistryMetadataArgs extends com.pulumi.resources.ResourceArgs {

    public static final WorkspaceTaskRegistryMetadataArgs Empty = new WorkspaceTaskRegistryMetadataArgs();

    /**
     * (Updatable) The owning object&#39;s key for this object.
     * 
     */
    @Import(name="aggregatorKey", required=true)
    private Output<String> aggregatorKey;

    /**
     * @return (Updatable) The owning object&#39;s key for this object.
     * 
     */
    public Output<String> aggregatorKey() {
    ...
    private WorkspaceTaskRegistryMetadataArgs() {}

    private WorkspaceTaskRegistryMetadataArgs(WorkspaceTaskRegistryMetadataArgs $) {
    ...
    public static Builder builder(WorkspaceTaskRegistryMetadataArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new WorkspaceTaskRegistryMetadataArgs();
        }

        public Builder(WorkspaceTaskRegistryMetadataArgs defaults) {
            $ = new WorkspaceTaskRegistryMetadataArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder aggregatorKey(Output<String> aggregatorKey) {
        ...
        public WorkspaceTaskRegistryMetadataArgs build() {
            if ($.aggregatorKey == null) {
                throw new MissingRequiredPropertyException("WorkspaceTaskRegistryMetadataArgs", "aggregatorKey");
            }
            return $;
        }
    }
