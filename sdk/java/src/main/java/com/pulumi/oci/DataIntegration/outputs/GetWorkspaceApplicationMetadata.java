...
import com.pulumi.oci.DataIntegration.outputs.GetWorkspaceApplicationMetadataAggregator;
import com.pulumi.oci.DataIntegration.outputs.GetWorkspaceApplicationMetadataCountStatistic;
...
public final class GetWorkspaceApplicationMetadata {
    ...
    public static Builder builder(GetWorkspaceApplicationMetadata defaults) {
    ...
    public static final class Builder {
        ...
        public Builder aggregatorKey(String aggregatorKey) {
            if (aggregatorKey == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceApplicationMetadata", "aggregatorKey");
            }
        ...
        public Builder aggregators(List<GetWorkspaceApplicationMetadataAggregator> aggregators) {
            if (aggregators == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceApplicationMetadata", "aggregators");
            }
        ...
        public Builder countStatistics(List<GetWorkspaceApplicationMetadataCountStatistic> countStatistics) {
            if (countStatistics == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceApplicationMetadata", "countStatistics");
            }
        ...
        public Builder createdBy(String createdBy) {
            if (createdBy == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceApplicationMetadata", "createdBy");
            }
        ...
        public Builder createdByName(String createdByName) {
            if (createdByName == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceApplicationMetadata", "createdByName");
            }
        ...
        public Builder identifierPath(String identifierPath) {
            if (identifierPath == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceApplicationMetadata", "identifierPath");
            }
        ...
        public Builder infoFields(Map<String,String> infoFields) {
            if (infoFields == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceApplicationMetadata", "infoFields");
            }
        ...
        public Builder isFavorite(Boolean isFavorite) {
            if (isFavorite == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceApplicationMetadata", "isFavorite");
            }
        ...
        public Builder labels(List<String> labels) {
            if (labels == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceApplicationMetadata", "labels");
            }
            this.labels = labels;
            return this;
        }
        ...
        public Builder registryVersion(Integer registryVersion) {
            if (registryVersion == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceApplicationMetadata", "registryVersion");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceApplicationMetadata", "timeCreated");
            }
        ...
        public Builder timeUpdated(String timeUpdated) {
            if (timeUpdated == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceApplicationMetadata", "timeUpdated");
            }
        ...
        public Builder updatedBy(String updatedBy) {
            if (updatedBy == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceApplicationMetadata", "updatedBy");
            }
        ...
        public Builder updatedByName(String updatedByName) {
            if (updatedByName == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceApplicationMetadata", "updatedByName");
            }
            this.updatedByName = updatedByName;
            return this;
        }
        public GetWorkspaceApplicationMetadata build() {
            final var _resultValue = new GetWorkspaceApplicationMetadata();
