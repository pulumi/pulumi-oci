    ...
    public static final class Builder {
        ...
        public Builder aggregatorKey(String aggregatorKey) {
            if (aggregatorKey == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceApplicationRegistryMetadata", "aggregatorKey");
            }
        ...
        public Builder isFavorite(Boolean isFavorite) {
            if (isFavorite == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceApplicationRegistryMetadata", "isFavorite");
            }
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceApplicationRegistryMetadata", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder labels(List<String> labels) {
            if (labels == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceApplicationRegistryMetadata", "labels");
            }
            this.labels = labels;
            return this;
        }
        ...
        public Builder registryVersion(Integer registryVersion) {
            if (registryVersion == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceApplicationRegistryMetadata", "registryVersion");
            }
