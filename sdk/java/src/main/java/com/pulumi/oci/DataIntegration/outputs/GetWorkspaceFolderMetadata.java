...
import com.pulumi.oci.DataIntegration.outputs.GetWorkspaceFolderMetadataAggregator;
import com.pulumi.oci.DataIntegration.outputs.GetWorkspaceFolderMetadataCountStatistic;
...
@CustomType
public final class GetWorkspaceFolderMetadata {
    /**
     ...
     * 
     */
    private List<GetWorkspaceFolderMetadataAggregator> aggregators;
    /**
     * @return A count statistics.
     * 
     */
    private List<GetWorkspaceFolderMetadataCountStatistic> countStatistics;
    /**
    ...
    private GetWorkspaceFolderMetadata() {}
    /**
     * @return The owning object key for this object.
     * 
     */
     ...
     * 
     */
    public List<GetWorkspaceFolderMetadataAggregator> aggregators() {
     ...
     * 
     */
    public List<GetWorkspaceFolderMetadataCountStatistic> countStatistics() {
    ...
    public static Builder builder(GetWorkspaceFolderMetadata defaults) {
    ...
    public static final class Builder {
        ...
        private String updatedByName;
        public Builder() {}
        public Builder(GetWorkspaceFolderMetadata defaults) {
        ...
        public Builder aggregatorKey(String aggregatorKey) {
            if (aggregatorKey == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceFolderMetadata", "aggregatorKey");
            }
            this.aggregatorKey = aggregatorKey;
            return this;
        }
        @CustomType.Setter
        public Builder aggregators(List<GetWorkspaceFolderMetadataAggregator> aggregators) {
            if (aggregators == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceFolderMetadata", "aggregators");
            }
            this.aggregators = aggregators;
            return this;
        }
        public Builder aggregators(GetWorkspaceFolderMetadataAggregator... aggregators) {
            return aggregators(List.of(aggregators));
        }
        @CustomType.Setter
        public Builder countStatistics(List<GetWorkspaceFolderMetadataCountStatistic> countStatistics) {
            if (countStatistics == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceFolderMetadata", "countStatistics");
            }
            this.countStatistics = countStatistics;
            return this;
        }
        public Builder countStatistics(GetWorkspaceFolderMetadataCountStatistic... countStatistics) {
            return countStatistics(List.of(countStatistics));
        }
        @CustomType.Setter
        public Builder createdBy(String createdBy) {
            if (createdBy == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceFolderMetadata", "createdBy");
            }
        ...
        public Builder createdByName(String createdByName) {
            if (createdByName == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceFolderMetadata", "createdByName");
            }
        ...
        public Builder identifierPath(String identifierPath) {
            if (identifierPath == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceFolderMetadata", "identifierPath");
            }
        ...
        public Builder infoFields(Map<String,String> infoFields) {
            if (infoFields == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceFolderMetadata", "infoFields");
            }
        ...
        public Builder isFavorite(Boolean isFavorite) {
            if (isFavorite == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceFolderMetadata", "isFavorite");
            }
        ...
        public Builder labels(List<String> labels) {
            if (labels == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceFolderMetadata", "labels");
            }
            this.labels = labels;
            return this;
        }
        ...
        public Builder registryVersion(Integer registryVersion) {
            if (registryVersion == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceFolderMetadata", "registryVersion");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceFolderMetadata", "timeCreated");
            }
        ...
        public Builder timeUpdated(String timeUpdated) {
            if (timeUpdated == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceFolderMetadata", "timeUpdated");
            }
        ...
        public Builder updatedBy(String updatedBy) {
            if (updatedBy == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceFolderMetadata", "updatedBy");
            }
        ...
        public Builder updatedByName(String updatedByName) {
            if (updatedByName == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceFolderMetadata", "updatedByName");
            }
            this.updatedByName = updatedByName;
            return this;
        }
        public GetWorkspaceFolderMetadata build() {
            final var _resultValue = new GetWorkspaceFolderMetadata();
