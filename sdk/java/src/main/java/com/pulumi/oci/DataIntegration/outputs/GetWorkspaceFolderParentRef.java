...
@CustomType
public final class GetWorkspaceFolderParentRef {
    /**
    ...
    private GetWorkspaceFolderParentRef() {}
    /**
     * @return Key of the parent object.
     * 
     */
    ...
    public static Builder builder(GetWorkspaceFolderParentRef defaults) {
    ...
    public static final class Builder {
        ...
        private String rootDocId;
        public Builder() {}
        public Builder(GetWorkspaceFolderParentRef defaults) {
        ...
        public Builder parent(String parent) {
            if (parent == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceFolderParentRef", "parent");
            }
            this.parent = parent;
            return this;
        }
        ...
        public Builder rootDocId(String rootDocId) {
            if (rootDocId == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceFolderParentRef", "rootDocId");
            }
