...
public final class GetWorkspaceProjectsProjectSummaryCollectionItemParentRef {
    ...
    public static final class Builder {
        ...
        public Builder parent(String parent) {
            if (parent == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceProjectsProjectSummaryCollectionItemParentRef", "parent");
            }
            this.parent = parent;
            return this;
        }
        ...
        public Builder rootDocId(String rootDocId) {
            if (rootDocId == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceProjectsProjectSummaryCollectionItemParentRef", "rootDocId");
            }
