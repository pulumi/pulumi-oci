...
@CustomType
public final class GetWorkspaceTaskRegistryMetadata {
    /**
    ...
    private GetWorkspaceTaskRegistryMetadata() {}
    /**
     * @return The owning object&#39;s key for this object.
     * 
     */
    ...
    public static Builder builder(GetWorkspaceTaskRegistryMetadata defaults) {
    ...
    public static final class Builder {
        ...
        private Integer registryVersion;
        public Builder() {}
        public Builder(GetWorkspaceTaskRegistryMetadata defaults) {
        ...
        public Builder aggregatorKey(String aggregatorKey) {
            if (aggregatorKey == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceTaskRegistryMetadata", "aggregatorKey");
            }
        ...
        public Builder isFavorite(Boolean isFavorite) {
            if (isFavorite == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceTaskRegistryMetadata", "isFavorite");
            }
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceTaskRegistryMetadata", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder labels(List<String> labels) {
            if (labels == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceTaskRegistryMetadata", "labels");
            }
            this.labels = labels;
            return this;
        }
        ...
        public Builder registryVersion(Integer registryVersion) {
            if (registryVersion == null) {
              throw new MissingRequiredPropertyException("GetWorkspaceTaskRegistryMetadata", "registryVersion");
            }
            this.registryVersion = registryVersion;
            return this;
        }
        public GetWorkspaceTaskRegistryMetadata build() {
            final var _resultValue = new GetWorkspaceTaskRegistryMetadata();
