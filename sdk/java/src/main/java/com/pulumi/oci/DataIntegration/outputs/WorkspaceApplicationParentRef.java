...
@CustomType
public final class WorkspaceApplicationParentRef {
    /**
    ...
    private WorkspaceApplicationParentRef() {}
    /**
     * @return Key of the parent object.
     * 
     */
    ...
    public static Builder builder(WorkspaceApplicationParentRef defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String rootDocId;
        public Builder() {}
        public Builder(WorkspaceApplicationParentRef defaults) {
        ...
        public WorkspaceApplicationParentRef build() {
            final var _resultValue = new WorkspaceApplicationParentRef();
