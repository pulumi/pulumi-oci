...
@CustomType
public final class WorkspaceApplicationRegistryMetadata {
    /**
    ...
    private WorkspaceApplicationRegistryMetadata() {}
    /**
     * @return The owning object&#39;s key for this object.
     * 
     */
    ...
    public static Builder builder(WorkspaceApplicationRegistryMetadata defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer registryVersion;
        public Builder() {}
        public Builder(WorkspaceApplicationRegistryMetadata defaults) {
        ...
        public WorkspaceApplicationRegistryMetadata build() {
            final var _resultValue = new WorkspaceApplicationRegistryMetadata();
