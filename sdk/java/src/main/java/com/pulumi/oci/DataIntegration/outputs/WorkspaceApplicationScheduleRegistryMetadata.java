...
@CustomType
public final class WorkspaceApplicationScheduleRegistryMetadata {
    /**
    ...
    private WorkspaceApplicationScheduleRegistryMetadata() {}
    /**
     * @return (Updatable) The owning object&#39;s key for this object.
     * 
     */
    ...
    public static Builder builder(WorkspaceApplicationScheduleRegistryMetadata defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer registryVersion;
        public Builder() {}
        public Builder(WorkspaceApplicationScheduleRegistryMetadata defaults) {
        ...
        public WorkspaceApplicationScheduleRegistryMetadata build() {
            final var _resultValue = new WorkspaceApplicationScheduleRegistryMetadata();
