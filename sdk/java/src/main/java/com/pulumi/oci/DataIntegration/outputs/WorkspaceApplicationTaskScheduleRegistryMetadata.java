...
public final class WorkspaceApplicationTaskScheduleRegistryMetadata {
    ...
    public static Builder builder(WorkspaceApplicationTaskScheduleRegistryMetadata defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer registryVersion;
        public Builder() {}
        public Builder(WorkspaceApplicationTaskScheduleRegistryMetadata defaults) {
        ...
        public WorkspaceApplicationTaskScheduleRegistryMetadata build() {
            final var _resultValue = new WorkspaceApplicationTaskScheduleRegistryMetadata();
