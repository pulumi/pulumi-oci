...
import com.pulumi.oci.DataIntegration.outputs.WorkspaceFolderMetadataAggregator;
import com.pulumi.oci.DataIntegration.outputs.WorkspaceFolderMetadataCountStatistic;
...
@CustomType
public final class WorkspaceFolderMetadata {
    /**
     ...
     * 
     */
    private @Nullable List<WorkspaceFolderMetadataAggregator> aggregators;
    /**
     * @return A count statistics.
     * 
     */
    private @Nullable List<WorkspaceFolderMetadataCountStatistic> countStatistics;
    /**
    ...
    private WorkspaceFolderMetadata() {}
    /**
     * @return (Updatable) The owning object&#39;s key for this object.
     * 
     */
     ...
     * 
     */
    public List<WorkspaceFolderMetadataAggregator> aggregators() {
     ...
     * 
     */
    public List<WorkspaceFolderMetadataCountStatistic> countStatistics() {
    ...
    public static Builder builder(WorkspaceFolderMetadata defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String updatedByName;
        public Builder() {}
        public Builder(WorkspaceFolderMetadata defaults) {
        ...
        public Builder aggregators(WorkspaceFolderMetadataAggregator... aggregators) {
        ...
        public Builder countStatistics(WorkspaceFolderMetadataCountStatistic... countStatistics) {
        ...
        public WorkspaceFolderMetadata build() {
            final var _resultValue = new WorkspaceFolderMetadata();
