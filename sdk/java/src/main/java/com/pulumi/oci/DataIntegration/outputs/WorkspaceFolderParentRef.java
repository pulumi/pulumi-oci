...
@CustomType
public final class WorkspaceFolderParentRef {
    /**
    ...
    public static Builder builder(WorkspaceFolderParentRef defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String rootDocId;
        public Builder() {}
        public Builder(WorkspaceFolderParentRef defaults) {
        ...
        public WorkspaceFolderParentRef build() {
            final var _resultValue = new WorkspaceFolderParentRef();
