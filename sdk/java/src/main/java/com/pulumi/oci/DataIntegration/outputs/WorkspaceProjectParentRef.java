...
@CustomType
public final class WorkspaceProjectParentRef {
    /**
    ...
    public static Builder builder(WorkspaceProjectParentRef defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String rootDocId;
        public Builder() {}
        public Builder(WorkspaceProjectParentRef defaults) {
