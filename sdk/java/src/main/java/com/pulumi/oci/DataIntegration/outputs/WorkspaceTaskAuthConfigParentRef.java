...
@CustomType
public final class WorkspaceTaskAuthConfigParentRef {
    /**
    ...
    public static Builder builder(WorkspaceTaskAuthConfigParentRef defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String rootDocId;
        public Builder() {}
        public Builder(WorkspaceTaskAuthConfigParentRef defaults) {
        ...
        public WorkspaceTaskAuthConfigParentRef build() {
            final var _resultValue = new WorkspaceTaskAuthConfigParentRef();
