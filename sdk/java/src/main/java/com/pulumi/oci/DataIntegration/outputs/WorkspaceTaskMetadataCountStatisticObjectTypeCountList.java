...
@CustomType
public final class WorkspaceTaskMetadataCountStatisticObjectTypeCountList {
    /**
    ...
    private WorkspaceTaskMetadataCountStatisticObjectTypeCountList() {}
    /**
     * @return The value for the count statistic object.
     * 
     */
    ...
    public static Builder builder(WorkspaceTaskMetadataCountStatisticObjectTypeCountList defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String objectType;
        public Builder() {}
        public Builder(WorkspaceTaskMetadataCountStatisticObjectTypeCountList defaults) {
        ...
        public WorkspaceTaskMetadataCountStatisticObjectTypeCountList build() {
            final var _resultValue = new WorkspaceTaskMetadataCountStatisticObjectTypeCountList();
