...
@CustomType
public final class WorkspaceTaskParameterParentRef {
    /**
    ...
    private WorkspaceTaskParameterParentRef() {}
    /**
     * @return (Updatable) Key of the parent object.
     * 
     */
    ...
    public static Builder builder(WorkspaceTaskParameterParentRef defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String rootDocId;
        public Builder() {}
        public Builder(WorkspaceTaskParameterParentRef defaults) {
        ...
        public WorkspaceTaskParameterParentRef build() {
            final var _resultValue = new WorkspaceTaskParameterParentRef();
