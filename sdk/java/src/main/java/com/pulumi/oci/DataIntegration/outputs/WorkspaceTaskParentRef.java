...
@CustomType
public final class WorkspaceTaskParentRef {
    /**
    ...
    public static Builder builder(WorkspaceTaskParentRef defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String rootDocId;
        public Builder() {}
        public Builder(WorkspaceTaskParentRef defaults) {
        ...
        public WorkspaceTaskParentRef build() {
            final var _resultValue = new WorkspaceTaskParentRef();
