...
public final class WorkspaceTaskTypedExpressionConfigValuesConfigParamValuesScale {
    ...
    public static Builder builder(WorkspaceTaskTypedExpressionConfigValuesConfigParamValuesScale defaults) {
    ...
    public static final class Builder {
        private @Nullable Integer intValue;
        public Builder() {}
        public Builder(WorkspaceTaskTypedExpressionConfigValuesConfigParamValuesScale defaults) {
        ...
        public WorkspaceTaskTypedExpressionConfigValuesConfigParamValuesScale build() {
            final var _resultValue = new WorkspaceTaskTypedExpressionConfigValuesConfigParamValuesScale();
