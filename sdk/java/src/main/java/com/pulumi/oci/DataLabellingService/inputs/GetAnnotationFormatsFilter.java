...
public final class GetAnnotationFormatsFilter extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetAnnotationFormatsFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetAnnotationFormatsFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetAnnotationFormatsFilter", "values");
            }
            return $;
        }
    }
