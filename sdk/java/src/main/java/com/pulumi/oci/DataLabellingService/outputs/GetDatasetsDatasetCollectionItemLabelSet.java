...
public final class GetDatasetsDatasetCollectionItemLabelSet {
     ...
     * 
     */
    private @Nullable List<GetDatasetsDatasetCollectionItemLabelSetItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetDatasetsDatasetCollectionItemLabelSetItem> items) {
            this.items = items;
            return this;
        }
        ...
        public GetDatasetsDatasetCollectionItemLabelSet build() {
            final var o = new GetDatasetsDatasetCollectionItemLabelSet();
            o.items = items;
            return o;
        }
    }
