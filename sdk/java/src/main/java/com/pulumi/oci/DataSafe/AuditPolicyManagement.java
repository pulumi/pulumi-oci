...
public class AuditPolicyManagement extends com.pulumi.resources.CustomResource {
     ...
     */
    public AuditPolicyManagement(String name) {
     ...
     */
    public AuditPolicyManagement(String name, @Nullable AuditPolicyManagementArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AuditPolicyManagement(String name, @Nullable AuditPolicyManagementArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DataSafe/auditPolicyManagement:AuditPolicyManagement", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private AuditPolicyManagement(String name, Output<String> id, @Nullable AuditPolicyManagementState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DataSafe/auditPolicyManagement:AuditPolicyManagement", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static AuditPolicyManagement get(String name, Output<String> id, @Nullable AuditPolicyManagementState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
