...
public class LibraryMasingFormat extends com.pulumi.resources.CustomResource {
     ...
     */
    public LibraryMasingFormat(java.lang.String name) {
     ...
     */
    public LibraryMasingFormat(java.lang.String name, LibraryMasingFormatArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LibraryMasingFormat(java.lang.String name, LibraryMasingFormatArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DataSafe/libraryMasingFormat:LibraryMasingFormat", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LibraryMasingFormat(java.lang.String name, Output<java.lang.String> id, @Nullable LibraryMasingFormatState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DataSafe/libraryMasingFormat:LibraryMasingFormat", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static LibraryMasingFormat get(java.lang.String name, Output<java.lang.String> id, @Nullable LibraryMasingFormatState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
