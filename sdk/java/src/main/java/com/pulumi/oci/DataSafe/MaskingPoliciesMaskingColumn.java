...
public class MaskingPoliciesMaskingColumn extends com.pulumi.resources.CustomResource {
     ...
     */
    public MaskingPoliciesMaskingColumn(java.lang.String name) {
     ...
     */
    public MaskingPoliciesMaskingColumn(java.lang.String name, MaskingPoliciesMaskingColumnArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public MaskingPoliciesMaskingColumn(java.lang.String name, MaskingPoliciesMaskingColumnArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DataSafe/maskingPoliciesMaskingColumn:MaskingPoliciesMaskingColumn", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private MaskingPoliciesMaskingColumn(java.lang.String name, Output<java.lang.String> id, @Nullable MaskingPoliciesMaskingColumnState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DataSafe/maskingPoliciesMaskingColumn:MaskingPoliciesMaskingColumn", name, state, makeResourceOptions(options, id), false);
    }

    private static MaskingPoliciesMaskingColumnArgs makeArgs(MaskingPoliciesMaskingColumnArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? MaskingPoliciesMaskingColumnArgs.Empty : args;
    }
     ...
     */
    public static MaskingPoliciesMaskingColumn get(java.lang.String name, Output<java.lang.String> id, @Nullable MaskingPoliciesMaskingColumnState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
