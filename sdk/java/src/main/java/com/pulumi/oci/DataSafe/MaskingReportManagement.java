...
public class MaskingReportManagement extends com.pulumi.resources.CustomResource {
     ...
     */
    public MaskingReportManagement(String name) {
     ...
     */
    public MaskingReportManagement(String name, @Nullable MaskingReportManagementArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public MaskingReportManagement(String name, @Nullable MaskingReportManagementArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DataSafe/maskingReportManagement:MaskingReportManagement", name, args == null ? MaskingReportManagementArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private MaskingReportManagement(String name, Output<String> id, @Nullable MaskingReportManagementState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DataSafe/maskingReportManagement:MaskingReportManagement", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static MaskingReportManagement get(String name, Output<String> id, @Nullable MaskingReportManagementState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
