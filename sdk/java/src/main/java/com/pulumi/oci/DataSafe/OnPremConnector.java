...
public class OnPremConnector extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ String> availableVersion;

    /**
     * @return Latest available version of the on-premises connector.
     * 
     */
    public Output<Optional<String>> availableVersion() {
        return Codegen.optional(this.availableVersion);
    }
    /**
    ...
    private Output</* @Nullable */ String> createdVersion;

    /**
     * @return Created version of the on-premises connector.
     * 
     */
    public Output<Optional<String>> createdVersion() {
        return Codegen.optional(this.createdVersion);
    }
    /**
