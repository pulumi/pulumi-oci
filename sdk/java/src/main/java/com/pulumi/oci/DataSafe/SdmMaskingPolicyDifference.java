...
public class SdmMaskingPolicyDifference extends com.pulumi.resources.CustomResource {
     ...
     */
    public SdmMaskingPolicyDifference(java.lang.String name) {
     ...
     */
    public SdmMaskingPolicyDifference(java.lang.String name, SdmMaskingPolicyDifferenceArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SdmMaskingPolicyDifference(java.lang.String name, SdmMaskingPolicyDifferenceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DataSafe/sdmMaskingPolicyDifference:SdmMaskingPolicyDifference", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SdmMaskingPolicyDifference(java.lang.String name, Output<java.lang.String> id, @Nullable SdmMaskingPolicyDifferenceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DataSafe/sdmMaskingPolicyDifference:SdmMaskingPolicyDifference", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static SdmMaskingPolicyDifference get(java.lang.String name, Output<java.lang.String> id, @Nullable SdmMaskingPolicyDifferenceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
