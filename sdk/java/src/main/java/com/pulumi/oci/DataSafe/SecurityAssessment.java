...
public class SecurityAssessment extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ List<String>> ignoredTargets;

    /**
     * @return List containing maps as values. Example: `{&#34;Operations&#34;: [ {&#34;CostCenter&#34;: &#34;42&#34;} ] }`
     * 
     */
    public Output<Optional<List<String>>> ignoredTargets() {
    ...
    private Output</* @Nullable */ String> scheduleSecurityAssessmentId;

    /**
     * @return The OCID of the security assessment that is responsible for creating this scheduled save assessment.
     * 
     */
    public Output<Optional<String>> scheduleSecurityAssessmentId() {
        return Codegen.optional(this.scheduleSecurityAssessmentId);
    }
    /**
    ...
    private Output</* @Nullable */ List<SecurityAssessmentStatistic>> statistics;
     ...
     * 
     */
    public Output<Optional<List<SecurityAssessmentStatistic>>> statistics() {
