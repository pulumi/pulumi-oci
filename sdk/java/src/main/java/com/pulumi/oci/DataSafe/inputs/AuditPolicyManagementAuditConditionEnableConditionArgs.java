...
public final class AuditPolicyManagementAuditConditionEnableConditionArgs extends com.pulumi.resources.ResourceArgs {

    public static final AuditPolicyManagementAuditConditionEnableConditionArgs Empty = new AuditPolicyManagementAuditConditionEnableConditionArgs();
    ...
    private AuditPolicyManagementAuditConditionEnableConditionArgs() {}

    private AuditPolicyManagementAuditConditionEnableConditionArgs(AuditPolicyManagementAuditConditionEnableConditionArgs $) {
    ...
    public static Builder builder(AuditPolicyManagementAuditConditionEnableConditionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AuditPolicyManagementAuditConditionEnableConditionArgs();
        }

        public Builder(AuditPolicyManagementAuditConditionEnableConditionArgs defaults) {
            $ = new AuditPolicyManagementAuditConditionEnableConditionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AuditPolicyManagementAuditConditionEnableConditionArgs build() {
            return $;
        }
    }
