...
public final class GetAuditProfileAvailableAuditVolumesPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetAuditProfileAvailableAuditVolumesPlainArgs Empty = new GetAuditProfileAvailableAuditVolumesPlainArgs();
    ...
    private GetAuditProfileAvailableAuditVolumesPlainArgs() {}

    private GetAuditProfileAvailableAuditVolumesPlainArgs(GetAuditProfileAvailableAuditVolumesPlainArgs $) {
    ...
    public static Builder builder(GetAuditProfileAvailableAuditVolumesPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAuditProfileAvailableAuditVolumesPlainArgs();
        }

        public Builder(GetAuditProfileAvailableAuditVolumesPlainArgs defaults) {
            $ = new GetAuditProfileAvailableAuditVolumesPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetAuditProfileAvailableAuditVolumesPlainArgs build() {
            if ($.auditProfileId == null) {
                throw new MissingRequiredPropertyException("GetAuditProfileAvailableAuditVolumesPlainArgs", "auditProfileId");
            }
            if ($.workRequestId == null) {
                throw new MissingRequiredPropertyException("GetAuditProfileAvailableAuditVolumesPlainArgs", "workRequestId");
            }
            return $;
        }
    }
