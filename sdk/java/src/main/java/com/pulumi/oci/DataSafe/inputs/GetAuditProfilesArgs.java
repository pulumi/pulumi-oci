...
public final class GetAuditProfilesArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param targetType A optional filter to return only resources that belong to the specified audit profile type.
         * 
         * @return builder
         * 
         */
        ...
        public GetAuditProfilesArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetAuditProfilesArgs", "compartmentId");
            }
            return $;
        }
    }
