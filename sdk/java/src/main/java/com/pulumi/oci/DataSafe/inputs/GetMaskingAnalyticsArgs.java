...
import com.pulumi.oci.DataSafe.inputs.GetMaskingAnalyticsFilterArgs;
...
public final class GetMaskingAnalyticsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetMaskingAnalyticsArgs Empty = new GetMaskingAnalyticsArgs();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetMaskingAnalyticsFilterArgs>> filters;

    public Optional<Output<List<GetMaskingAnalyticsFilterArgs>>> filters() {
    ...
    private GetMaskingAnalyticsArgs() {}

    private GetMaskingAnalyticsArgs(GetMaskingAnalyticsArgs $) {
    ...
    public static Builder builder(GetMaskingAnalyticsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMaskingAnalyticsArgs();
        }

        public Builder(GetMaskingAnalyticsArgs defaults) {
            $ = new GetMaskingAnalyticsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetMaskingAnalyticsFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetMaskingAnalyticsFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetMaskingAnalyticsFilterArgs... filters) {
        ...
        public GetMaskingAnalyticsArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetMaskingAnalyticsArgs", "compartmentId");
            }
            return $;
        }
    }
