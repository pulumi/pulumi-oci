...
import com.pulumi.oci.DataSafe.inputs.GetSecurityPolicyReportDatabaseViewAccessEntriesFilter;
...
public final class GetSecurityPolicyReportDatabaseViewAccessEntriesPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSecurityPolicyReportDatabaseViewAccessEntriesPlainArgs Empty = new GetSecurityPolicyReportDatabaseViewAccessEntriesPlainArgs();

    @Import(name="filters")
    private @Nullable List<GetSecurityPolicyReportDatabaseViewAccessEntriesFilter> filters;

    public Optional<List<GetSecurityPolicyReportDatabaseViewAccessEntriesFilter>> filters() {
    ...
    private GetSecurityPolicyReportDatabaseViewAccessEntriesPlainArgs() {}

    private GetSecurityPolicyReportDatabaseViewAccessEntriesPlainArgs(GetSecurityPolicyReportDatabaseViewAccessEntriesPlainArgs $) {
    ...
    public static Builder builder(GetSecurityPolicyReportDatabaseViewAccessEntriesPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSecurityPolicyReportDatabaseViewAccessEntriesPlainArgs();
        }

        public Builder(GetSecurityPolicyReportDatabaseViewAccessEntriesPlainArgs defaults) {
            $ = new GetSecurityPolicyReportDatabaseViewAccessEntriesPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetSecurityPolicyReportDatabaseViewAccessEntriesPlainArgs build() {
            if ($.securityPolicyReportId == null) {
                throw new MissingRequiredPropertyException("GetSecurityPolicyReportDatabaseViewAccessEntriesPlainArgs", "securityPolicyReportId");
            }
            return $;
        }
    }
