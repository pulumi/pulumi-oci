...
import com.pulumi.oci.DataSafe.inputs.GetTargetDatabaseGroupsFilterArgs;
...
public final class GetTargetDatabaseGroupsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetTargetDatabaseGroupsArgs Empty = new GetTargetDatabaseGroupsArgs();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetTargetDatabaseGroupsFilterArgs>> filters;

    public Optional<Output<List<GetTargetDatabaseGroupsFilterArgs>>> filters() {
    ...
    private @Nullable Output<String> targetDatabaseGroupFilter;

    /**
     * @return The scim query filter parameter accepts filter expressions that use the syntax described in Section 3.2.2.2 of the System for Cross-Domain Identity Management (SCIM) specification, which is available at [RFC3339](https://tools.ietf.org/html/draft-ietf-scim-api-12). In SCIM filtering expressions, text, date, and time values must be enclosed in quotation marks, with date and time values using ISO-8601 format. (Numeric and boolean values should not be quoted.) Ex:** filter=(targetDatabaseId eq &#39;ocid1.datasafetargetdatabase.oc1.iad.abuwcljr3u2va4ba5wek53idpe5qq5kkbigzclscc6mysfecxzjt5dgmxqza&#39;)
     * 
     */
    public Optional<Output<String>> targetDatabaseGroupFilter() {
    ...
    private GetTargetDatabaseGroupsArgs() {}

    private GetTargetDatabaseGroupsArgs(GetTargetDatabaseGroupsArgs $) {
    ...
    public static Builder builder(GetTargetDatabaseGroupsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTargetDatabaseGroupsArgs();
        }

        public Builder(GetTargetDatabaseGroupsArgs defaults) {
            $ = new GetTargetDatabaseGroupsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetTargetDatabaseGroupsFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetTargetDatabaseGroupsFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetTargetDatabaseGroupsFilterArgs... filters) {
         ...
         * 
         */
        public Builder targetDatabaseGroupFilter(@Nullable Output<String> targetDatabaseGroupFilter) {
         ...
         * 
         */
        public Builder targetDatabaseGroupFilter(String targetDatabaseGroupFilter) {
            return targetDatabaseGroupFilter(Output.of(targetDatabaseGroupFilter));
        }
        ...
        public GetTargetDatabaseGroupsArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetTargetDatabaseGroupsArgs", "compartmentId");
            }
            return $;
        }
    }
