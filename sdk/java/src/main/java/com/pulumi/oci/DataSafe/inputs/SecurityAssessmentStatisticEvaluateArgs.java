...
public final class SecurityAssessmentStatisticEvaluateArgs extends com.pulumi.resources.ResourceArgs {

    public static final SecurityAssessmentStatisticEvaluateArgs Empty = new SecurityAssessmentStatisticEvaluateArgs();
    ...
    private SecurityAssessmentStatisticEvaluateArgs() {}

    private SecurityAssessmentStatisticEvaluateArgs(SecurityAssessmentStatisticEvaluateArgs $) {
    ...
    public static Builder builder(SecurityAssessmentStatisticEvaluateArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SecurityAssessmentStatisticEvaluateArgs();
        }

        public Builder(SecurityAssessmentStatisticEvaluateArgs defaults) {
            $ = new SecurityAssessmentStatisticEvaluateArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SecurityAssessmentStatisticEvaluateArgs build() {
            return $;
        }
    }
