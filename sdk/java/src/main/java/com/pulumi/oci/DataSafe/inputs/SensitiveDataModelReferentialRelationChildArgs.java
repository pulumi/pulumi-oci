...
public final class SensitiveDataModelReferentialRelationChildArgs extends com.pulumi.resources.ResourceArgs {

    public static final SensitiveDataModelReferentialRelationChildArgs Empty = new SensitiveDataModelReferentialRelationChildArgs();
    ...
    private SensitiveDataModelReferentialRelationChildArgs() {}

    private SensitiveDataModelReferentialRelationChildArgs(SensitiveDataModelReferentialRelationChildArgs $) {
    ...
    public static Builder builder(SensitiveDataModelReferentialRelationChildArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SensitiveDataModelReferentialRelationChildArgs();
        }

        public Builder(SensitiveDataModelReferentialRelationChildArgs defaults) {
            $ = new SensitiveDataModelReferentialRelationChildArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SensitiveDataModelReferentialRelationChildArgs build() {
            if ($.appName == null) {
                throw new MissingRequiredPropertyException("SensitiveDataModelReferentialRelationChildArgs", "appName");
            }
            if ($.columnGroups == null) {
                throw new MissingRequiredPropertyException("SensitiveDataModelReferentialRelationChildArgs", "columnGroups");
            }
            if ($.object == null) {
                throw new MissingRequiredPropertyException("SensitiveDataModelReferentialRelationChildArgs", "object");
            }
            if ($.objectType == null) {
                throw new MissingRequiredPropertyException("SensitiveDataModelReferentialRelationChildArgs", "objectType");
            }
            if ($.schemaName == null) {
                throw new MissingRequiredPropertyException("SensitiveDataModelReferentialRelationChildArgs", "schemaName");
            }
            return $;
        }
    }
