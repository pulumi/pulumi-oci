...
public final class TargetDatabasePeerTargetDatabaseTlsConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final TargetDatabasePeerTargetDatabaseTlsConfigArgs Empty = new TargetDatabasePeerTargetDatabaseTlsConfigArgs();
    ...
    private TargetDatabasePeerTargetDatabaseTlsConfigArgs() {}

    private TargetDatabasePeerTargetDatabaseTlsConfigArgs(TargetDatabasePeerTargetDatabaseTlsConfigArgs $) {
    ...
    public static Builder builder(TargetDatabasePeerTargetDatabaseTlsConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TargetDatabasePeerTargetDatabaseTlsConfigArgs();
        }

        public Builder(TargetDatabasePeerTargetDatabaseTlsConfigArgs defaults) {
            $ = new TargetDatabasePeerTargetDatabaseTlsConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TargetDatabasePeerTargetDatabaseTlsConfigArgs build() {
            if ($.status == null) {
                throw new MissingRequiredPropertyException("TargetDatabasePeerTargetDatabaseTlsConfigArgs", "status");
            }
            return $;
        }
    }
