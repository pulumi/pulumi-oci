...
@CustomType
public final class AuditPolicyManagementAuditConditionEnableCondition {
    /**
    ...
    public static Builder builder(AuditPolicyManagementAuditConditionEnableCondition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String operationStatus;
        public Builder() {}
        public Builder(AuditPolicyManagementAuditConditionEnableCondition defaults) {
        ...
        public AuditPolicyManagementAuditConditionEnableCondition build() {
            final var _resultValue = new AuditPolicyManagementAuditConditionEnableCondition();
