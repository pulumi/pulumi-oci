...
@CustomType
public final class AuditProfileManagementAuditTrail {
    /**
    ...
    public static Builder builder(AuditProfileManagementAuditTrail defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String workRequestId;
        public Builder() {}
        public Builder(AuditProfileManagementAuditTrail defaults) {
        ...
        public AuditProfileManagementAuditTrail build() {
            final var _resultValue = new AuditProfileManagementAuditTrail();
