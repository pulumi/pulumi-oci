...
@CustomType
public final class DatabaseSecurityConfigSqlFirewallConfig {
    /**
    ...
    private DatabaseSecurityConfigSqlFirewallConfig() {}
    /**
     * @return (Updatable) Specifies whether the firewall should include or exclude the database internal job activities.
     * 
     */
    ...
    public static Builder builder(DatabaseSecurityConfigSqlFirewallConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String violationLogAutoPurge;
        public Builder() {}
        public Builder(DatabaseSecurityConfigSqlFirewallConfig defaults) {
