...
@CustomType
public final class DiscoveryJobsResultConfidenceLevelDetail {
    ...
    private DiscoveryJobsResultConfidenceLevelDetail() {}
    ...
    public static Builder builder(DiscoveryJobsResultConfidenceLevelDetail defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean isSensitiveTypeFromSameContextFoundInSameOrRelatedTables;
        public Builder() {}
        public Builder(DiscoveryJobsResultConfidenceLevelDetail defaults) {
        ...
        public DiscoveryJobsResultConfidenceLevelDetail build() {
            final var _resultValue = new DiscoveryJobsResultConfidenceLevelDetail();
