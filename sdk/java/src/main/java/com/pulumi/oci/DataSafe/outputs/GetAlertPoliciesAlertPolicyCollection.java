...
public final class GetAlertPoliciesAlertPolicyCollection {
    ...
    public static final class Builder {
        ...
        public Builder items(List<GetAlertPoliciesAlertPolicyCollectionItem> items) {
            if (items == null) {
              throw new MissingRequiredPropertyException("GetAlertPoliciesAlertPolicyCollection", "items");
            }
            this.items = items;
            return this;
        }
        ...
        public GetAlertPoliciesAlertPolicyCollection build() {
            final var _resultValue = new GetAlertPoliciesAlertPolicyCollection();
