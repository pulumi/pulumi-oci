...
public final class GetAuditArchiveRetrievalsAuditArchiveRetrievalCollection {
    private @Nullable List<GetAuditArchiveRetrievalsAuditArchiveRetrievalCollectionItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetAuditArchiveRetrievalsAuditArchiveRetrievalCollectionItem> items) {
            this.items = items;
            return this;
        }
