...
public final class GetAuditPoliciesAuditPolicyCollection {
    private @Nullable List<GetAuditPoliciesAuditPolicyCollectionItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetAuditPoliciesAuditPolicyCollectionItem> items) {
            this.items = items;
            return this;
        }
