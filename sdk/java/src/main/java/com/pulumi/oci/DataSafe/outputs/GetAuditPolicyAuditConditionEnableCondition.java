...
public final class GetAuditPolicyAuditConditionEnableCondition {
    ...
    public static final class Builder {
        ...
        public Builder entityNames(List<String> entityNames) {
            if (entityNames == null) {
              throw new MissingRequiredPropertyException("GetAuditPolicyAuditConditionEnableCondition", "entityNames");
            }
        ...
        public Builder entitySelection(String entitySelection) {
            if (entitySelection == null) {
              throw new MissingRequiredPropertyException("GetAuditPolicyAuditConditionEnableCondition", "entitySelection");
            }
        ...
        public Builder entityType(String entityType) {
            if (entityType == null) {
              throw new MissingRequiredPropertyException("GetAuditPolicyAuditConditionEnableCondition", "entityType");
            }
        ...
        public Builder operationStatus(String operationStatus) {
            if (operationStatus == null) {
              throw new MissingRequiredPropertyException("GetAuditPolicyAuditConditionEnableCondition", "operationStatus");
            }
