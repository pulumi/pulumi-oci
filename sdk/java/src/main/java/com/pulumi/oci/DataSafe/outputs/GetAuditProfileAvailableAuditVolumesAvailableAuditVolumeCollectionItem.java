    ...
    public static final class Builder {
        ...
        public Builder auditProfileId(String auditProfileId) {
            if (auditProfileId == null) {
              throw new MissingRequiredPropertyException("GetAuditProfileAvailableAuditVolumesAvailableAuditVolumeCollectionItem", "auditProfileId");
            }
        ...
        public Builder auditTrailId(String auditTrailId) {
            if (auditTrailId == null) {
              throw new MissingRequiredPropertyException("GetAuditProfileAvailableAuditVolumesAvailableAuditVolumeCollectionItem", "auditTrailId");
            }
        ...
        public Builder databaseUniqueName(String databaseUniqueName) {
            if (databaseUniqueName == null) {
              throw new MissingRequiredPropertyException("GetAuditProfileAvailableAuditVolumesAvailableAuditVolumeCollectionItem", "databaseUniqueName");
            }
        ...
        public Builder monthInConsideration(String monthInConsideration) {
            if (monthInConsideration == null) {
              throw new MissingRequiredPropertyException("GetAuditProfileAvailableAuditVolumesAvailableAuditVolumeCollectionItem", "monthInConsideration");
            }
        ...
        public Builder trailLocation(String trailLocation) {
            if (trailLocation == null) {
              throw new MissingRequiredPropertyException("GetAuditProfileAvailableAuditVolumesAvailableAuditVolumeCollectionItem", "trailLocation");
            }
        ...
        public Builder volume(String volume) {
            if (volume == null) {
              throw new MissingRequiredPropertyException("GetAuditProfileAvailableAuditVolumesAvailableAuditVolumeCollectionItem", "volume");
            }
            this.volume = volume;
            return this;
        }
