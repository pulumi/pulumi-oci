    ...
    public static final class Builder {
        ...
        public Builder archivedVolume(String archivedVolume) {
            if (archivedVolume == null) {
              throw new MissingRequiredPropertyException("GetAuditProfileCollectedAuditVolumeItem", "archivedVolume");
            }
        ...
        public Builder auditProfileId(String auditProfileId) {
            if (auditProfileId == null) {
              throw new MissingRequiredPropertyException("GetAuditProfileCollectedAuditVolumeItem", "auditProfileId");
            }
        ...
        public Builder monthInConsideration(String monthInConsideration) {
            if (monthInConsideration == null) {
              throw new MissingRequiredPropertyException("GetAuditProfileCollectedAuditVolumeItem", "monthInConsideration");
            }
        ...
        public Builder onlineVolume(String onlineVolume) {
            if (onlineVolume == null) {
              throw new MissingRequiredPropertyException("GetAuditProfileCollectedAuditVolumeItem", "onlineVolume");
            }
