...
public final class GetAuditProfileCollectedAuditVolumesCollectedAuditVolumeCollection {
     ...
     * 
     */
    private @Nullable List<GetAuditProfileCollectedAuditVolumesCollectedAuditVolumeCollectionItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetAuditProfileCollectedAuditVolumesCollectedAuditVolumeCollectionItem> items) {
            this.items = items;
            return this;
        }
