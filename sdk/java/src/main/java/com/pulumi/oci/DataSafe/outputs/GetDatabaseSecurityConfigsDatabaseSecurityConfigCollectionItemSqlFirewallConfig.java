...
public final class GetDatabaseSecurityConfigsDatabaseSecurityConfigCollectionItemSqlFirewallConfig {
    ...
    public static Builder builder(GetDatabaseSecurityConfigsDatabaseSecurityConfigCollectionItemSqlFirewallConfig defaults) {
    ...
    public static final class Builder {
        ...
        public Builder excludeJob(String excludeJob) {
            if (excludeJob == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSecurityConfigsDatabaseSecurityConfigCollectionItemSqlFirewallConfig", "excludeJob");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSecurityConfigsDatabaseSecurityConfigCollectionItemSqlFirewallConfig", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder timeStatusUpdated(String timeStatusUpdated) {
            if (timeStatusUpdated == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSecurityConfigsDatabaseSecurityConfigCollectionItemSqlFirewallConfig", "timeStatusUpdated");
            }
        ...
        public Builder violationLogAutoPurge(String violationLogAutoPurge) {
            if (violationLogAutoPurge == null) {
              throw new MissingRequiredPropertyException("GetDatabaseSecurityConfigsDatabaseSecurityConfigCollectionItemSqlFirewallConfig", "violationLogAutoPurge");
            }
        ...
        public GetDatabaseSecurityConfigsDatabaseSecurityConfigCollectionItemSqlFirewallConfig build() {
            final var _resultValue = new GetDatabaseSecurityConfigsDatabaseSecurityConfigCollectionItemSqlFirewallConfig();
