...
public final class GetLibraryMaskingFormatsLibraryMaskingFormatCollection {
    private @Nullable List<GetLibraryMaskingFormatsLibraryMaskingFormatCollectionItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetLibraryMaskingFormatsLibraryMaskingFormatCollectionItem> items) {
            this.items = items;
            return this;
        }
