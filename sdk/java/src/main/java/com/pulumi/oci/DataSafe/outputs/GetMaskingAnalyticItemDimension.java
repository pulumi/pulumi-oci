...
public final class GetMaskingAnalyticItemDimension {
    ...
    public static final class Builder {
        ...
        public Builder policyId(String policyId) {
            if (policyId == null) {
              throw new MissingRequiredPropertyException("GetMaskingAnalyticItemDimension", "policyId");
            }
        ...
        public Builder targetId(String targetId) {
            if (targetId == null) {
              throw new MissingRequiredPropertyException("GetMaskingAnalyticItemDimension", "targetId");
            }
