...
public final class GetMaskingPoliciesMaskingPolicyCollection {
    ...
    public static final class Builder {
        ...
        public Builder items(List<GetMaskingPoliciesMaskingPolicyCollectionItem> items) {
            if (items == null) {
              throw new MissingRequiredPropertyException("GetMaskingPoliciesMaskingPolicyCollection", "items");
            }
            this.items = items;
            return this;
        }
        ...
        public GetMaskingPoliciesMaskingPolicyCollection build() {
            final var _resultValue = new GetMaskingPoliciesMaskingPolicyCollection();
