...
public final class GetReportDefinitionSummary {
    ...
    public static final class Builder {
        ...
        public Builder countOf(String countOf) {
            if (countOf == null) {
              throw new MissingRequiredPropertyException("GetReportDefinitionSummary", "countOf");
            }
        ...
        public Builder displayOrder(Integer displayOrder) {
            if (displayOrder == null) {
              throw new MissingRequiredPropertyException("GetReportDefinitionSummary", "displayOrder");
            }
        ...
        public Builder groupByFieldName(String groupByFieldName) {
            if (groupByFieldName == null) {
              throw new MissingRequiredPropertyException("GetReportDefinitionSummary", "groupByFieldName");
            }
        ...
        public Builder isHidden(Boolean isHidden) {
            if (isHidden == null) {
              throw new MissingRequiredPropertyException("GetReportDefinitionSummary", "isHidden");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetReportDefinitionSummary", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder scimFilter(String scimFilter) {
            if (scimFilter == null) {
              throw new MissingRequiredPropertyException("GetReportDefinitionSummary", "scimFilter");
            }
