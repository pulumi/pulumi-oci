...
import com.pulumi.oci.DataSafe.outputs.GetSecurityAssessmentCheckReference;
import java.lang.String;
import java.util.List;
import java.util.Objects;

@CustomType
public final class GetSecurityAssessmentCheck {
    /**
     ...
     * 
     */
    private List<GetSecurityAssessmentCheckReference> references;
    /**
    ...
    private GetSecurityAssessmentCheck() {}
    /**
     * @return The category to which the check belongs to.
     * 
     */
     ...
     * 
     */
    public List<GetSecurityAssessmentCheckReference> references() {
    ...
    public static Builder builder(GetSecurityAssessmentCheck defaults) {
    ...
    public static final class Builder {
        ...
        private String title;
        public Builder() {}
        public Builder(GetSecurityAssessmentCheck defaults) {
        ...
        public Builder category(String category) {
            if (category == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentCheck", "category");
            }
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentCheck", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder oneline(String oneline) {
            if (oneline == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentCheck", "oneline");
            }
            this.oneline = oneline;
            return this;
        }
        @CustomType.Setter
        public Builder references(List<GetSecurityAssessmentCheckReference> references) {
            if (references == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentCheck", "references");
            }
            this.references = references;
            return this;
        }
        public Builder references(GetSecurityAssessmentCheckReference... references) {
            return references(List.of(references));
        }
        @CustomType.Setter
        public Builder remarks(String remarks) {
            if (remarks == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentCheck", "remarks");
            }
        ...
        public Builder suggestedSeverity(String suggestedSeverity) {
            if (suggestedSeverity == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentCheck", "suggestedSeverity");
            }
        ...
        public Builder title(String title) {
            if (title == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentCheck", "title");
            }
            this.title = title;
            return this;
        }
        public GetSecurityAssessmentCheck build() {
            final var _resultValue = new GetSecurityAssessmentCheck();
