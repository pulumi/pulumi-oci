...
public final class GetSecurityAssessmentComparisonTargetAuditing {
    ...
    public static final class Builder {
        ...
        public Builder addedItems(List<String> addedItems) {
            if (addedItems == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentComparisonTargetAuditing", "addedItems");
            }
        ...
        public Builder baselines(List<GetSecurityAssessmentComparisonTargetAuditingBaseline> baselines) {
            if (baselines == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentComparisonTargetAuditing", "baselines");
            }
        ...
        public Builder currents(List<GetSecurityAssessmentComparisonTargetAuditingCurrent> currents) {
            if (currents == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentComparisonTargetAuditing", "currents");
            }
        ...
        public Builder modifiedItems(List<String> modifiedItems) {
            if (modifiedItems == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentComparisonTargetAuditing", "modifiedItems");
            }
        ...
        public Builder removedItems(List<String> removedItems) {
            if (removedItems == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentComparisonTargetAuditing", "removedItems");
            }
        ...
        public Builder severity(String severity) {
            if (severity == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentComparisonTargetAuditing", "severity");
            }
