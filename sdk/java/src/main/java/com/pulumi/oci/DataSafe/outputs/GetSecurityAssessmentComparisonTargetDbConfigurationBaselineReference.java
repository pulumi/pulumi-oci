...
public final class GetSecurityAssessmentComparisonTargetDbConfigurationBaselineReference {
    ...
    public static final class Builder {
        ...
        public Builder cis(String cis) {
            if (cis == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentComparisonTargetDbConfigurationBaselineReference", "cis");
            }
            this.cis = cis;
            return this;
        }
        ...
        public Builder gdpr(String gdpr) {
            if (gdpr == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentComparisonTargetDbConfigurationBaselineReference", "gdpr");
            }
            this.gdpr = gdpr;
            return this;
        }
        ...
        public Builder orp(String orp) {
            if (orp == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentComparisonTargetDbConfigurationBaselineReference", "orp");
            }
            this.orp = orp;
            return this;
        }
