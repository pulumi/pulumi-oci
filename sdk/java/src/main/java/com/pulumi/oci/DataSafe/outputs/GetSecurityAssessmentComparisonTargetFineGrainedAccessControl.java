...
public final class GetSecurityAssessmentComparisonTargetFineGrainedAccessControl {
    ...
    public static final class Builder {
        ...
        public Builder addedItems(List<String> addedItems) {
            if (addedItems == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentComparisonTargetFineGrainedAccessControl", "addedItems");
            }
        ...
        public Builder baselines(List<GetSecurityAssessmentComparisonTargetFineGrainedAccessControlBaseline> baselines) {
            if (baselines == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentComparisonTargetFineGrainedAccessControl", "baselines");
            }
        ...
        public Builder currents(List<GetSecurityAssessmentComparisonTargetFineGrainedAccessControlCurrent> currents) {
            if (currents == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentComparisonTargetFineGrainedAccessControl", "currents");
            }
        ...
        public Builder modifiedItems(List<String> modifiedItems) {
            if (modifiedItems == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentComparisonTargetFineGrainedAccessControl", "modifiedItems");
            }
        ...
        public Builder removedItems(List<String> removedItems) {
            if (removedItems == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentComparisonTargetFineGrainedAccessControl", "removedItems");
            }
        ...
        public Builder severity(String severity) {
            if (severity == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentComparisonTargetFineGrainedAccessControl", "severity");
            }
            this.severity = severity;
            return this;
        }
        public GetSecurityAssessmentComparisonTargetFineGrainedAccessControl build() {
            final var _resultValue = new GetSecurityAssessmentComparisonTargetFineGrainedAccessControl();
