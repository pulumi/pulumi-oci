...
public final class GetSecurityAssessmentComparisonTargetUserAccountCurrentReference {
    ...
    public static final class Builder {
        ...
        public Builder cis(String cis) {
            if (cis == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentComparisonTargetUserAccountCurrentReference", "cis");
            }
            this.cis = cis;
            return this;
        }
        ...
        public Builder gdpr(String gdpr) {
            if (gdpr == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentComparisonTargetUserAccountCurrentReference", "gdpr");
            }
            this.gdpr = gdpr;
            return this;
        }
        ...
        public Builder obp(String obp) {
            if (obp == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentComparisonTargetUserAccountCurrentReference", "obp");
            }
            this.obp = obp;
            return this;
        }
        ...
        public Builder orp(String orp) {
            if (orp == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentComparisonTargetUserAccountCurrentReference", "orp");
            }
            this.orp = orp;
            return this;
        }
        ...
        public Builder stig(String stig) {
            if (stig == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentComparisonTargetUserAccountCurrentReference", "stig");
            }
            this.stig = stig;
            return this;
        }
        public GetSecurityAssessmentComparisonTargetUserAccountCurrentReference build() {
            final var _resultValue = new GetSecurityAssessmentComparisonTargetUserAccountCurrentReference();
