...
@CustomType
public final class GetSecurityAssessmentStatisticDeferred {
    /**
    ...
    private GetSecurityAssessmentStatisticDeferred() {}
    /**
     * @return The number of findings in the Auditing category.
     * 
     */
    ...
    public static Builder builder(GetSecurityAssessmentStatisticDeferred defaults) {
    ...
    public static final class Builder {
        ...
        private Integer userAccountsFindingsCount;
        public Builder() {}
        public Builder(GetSecurityAssessmentStatisticDeferred defaults) {
        ...
        public Builder auditingFindingsCount(Integer auditingFindingsCount) {
            if (auditingFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentStatisticDeferred", "auditingFindingsCount");
            }
        ...
        public Builder authorizationControlFindingsCount(Integer authorizationControlFindingsCount) {
            if (authorizationControlFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentStatisticDeferred", "authorizationControlFindingsCount");
            }
        ...
        public Builder dataEncryptionFindingsCount(Integer dataEncryptionFindingsCount) {
            if (dataEncryptionFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentStatisticDeferred", "dataEncryptionFindingsCount");
            }
        ...
        public Builder dbConfigurationFindingsCount(Integer dbConfigurationFindingsCount) {
            if (dbConfigurationFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentStatisticDeferred", "dbConfigurationFindingsCount");
            }
        ...
        public Builder fineGrainedAccessControlFindingsCount(Integer fineGrainedAccessControlFindingsCount) {
            if (fineGrainedAccessControlFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentStatisticDeferred", "fineGrainedAccessControlFindingsCount");
            }
        ...
        public Builder privilegesAndRolesFindingsCount(Integer privilegesAndRolesFindingsCount) {
            if (privilegesAndRolesFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentStatisticDeferred", "privilegesAndRolesFindingsCount");
            }
        ...
        public Builder targetsCount(Integer targetsCount) {
            if (targetsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentStatisticDeferred", "targetsCount");
            }
        ...
        public Builder userAccountsFindingsCount(Integer userAccountsFindingsCount) {
            if (userAccountsFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentStatisticDeferred", "userAccountsFindingsCount");
            }
            this.userAccountsFindingsCount = userAccountsFindingsCount;
            return this;
        }
        public GetSecurityAssessmentStatisticDeferred build() {
            final var _resultValue = new GetSecurityAssessmentStatisticDeferred();
