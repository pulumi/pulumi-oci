    ...
    public static final class Builder {
        ...
        public Builder auditingFindingsCount(Integer auditingFindingsCount) {
            if (auditingFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentStatisticMediumRisk", "auditingFindingsCount");
            }
        ...
        public Builder authorizationControlFindingsCount(Integer authorizationControlFindingsCount) {
            if (authorizationControlFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentStatisticMediumRisk", "authorizationControlFindingsCount");
            }
        ...
        public Builder dataEncryptionFindingsCount(Integer dataEncryptionFindingsCount) {
            if (dataEncryptionFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentStatisticMediumRisk", "dataEncryptionFindingsCount");
            }
        ...
        public Builder dbConfigurationFindingsCount(Integer dbConfigurationFindingsCount) {
            if (dbConfigurationFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentStatisticMediumRisk", "dbConfigurationFindingsCount");
            }
        ...
        public Builder fineGrainedAccessControlFindingsCount(Integer fineGrainedAccessControlFindingsCount) {
            if (fineGrainedAccessControlFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentStatisticMediumRisk", "fineGrainedAccessControlFindingsCount");
            }
        ...
        public Builder privilegesAndRolesFindingsCount(Integer privilegesAndRolesFindingsCount) {
            if (privilegesAndRolesFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentStatisticMediumRisk", "privilegesAndRolesFindingsCount");
            }
        ...
        public Builder targetsCount(Integer targetsCount) {
            if (targetsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentStatisticMediumRisk", "targetsCount");
            }
        ...
        public Builder userAccountsFindingsCount(Integer userAccountsFindingsCount) {
            if (userAccountsFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentStatisticMediumRisk", "userAccountsFindingsCount");
            }
            this.userAccountsFindingsCount = userAccountsFindingsCount;
            return this;
        }
        public GetSecurityAssessmentStatisticMediumRisk build() {
            final var _resultValue = new GetSecurityAssessmentStatisticMediumRisk();
