...
@CustomType
public final class GetSecurityAssessmentsSecurityAssessmentStatisticDeferred {
    /**
    ...
    private GetSecurityAssessmentsSecurityAssessmentStatisticDeferred() {}
    /**
     * @return The number of findings in the Auditing category.
     * 
     */
    ...
    public static Builder builder(GetSecurityAssessmentsSecurityAssessmentStatisticDeferred defaults) {
    ...
    public static final class Builder {
        ...
        private Integer userAccountsFindingsCount;
        public Builder() {}
        public Builder(GetSecurityAssessmentsSecurityAssessmentStatisticDeferred defaults) {
        ...
        public Builder auditingFindingsCount(Integer auditingFindingsCount) {
            if (auditingFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticDeferred", "auditingFindingsCount");
            }
        ...
        public Builder authorizationControlFindingsCount(Integer authorizationControlFindingsCount) {
            if (authorizationControlFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticDeferred", "authorizationControlFindingsCount");
            }
        ...
        public Builder dataEncryptionFindingsCount(Integer dataEncryptionFindingsCount) {
            if (dataEncryptionFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticDeferred", "dataEncryptionFindingsCount");
            }
        ...
        public Builder dbConfigurationFindingsCount(Integer dbConfigurationFindingsCount) {
            if (dbConfigurationFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticDeferred", "dbConfigurationFindingsCount");
            }
        ...
        public Builder fineGrainedAccessControlFindingsCount(Integer fineGrainedAccessControlFindingsCount) {
            if (fineGrainedAccessControlFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticDeferred", "fineGrainedAccessControlFindingsCount");
            }
        ...
        public Builder privilegesAndRolesFindingsCount(Integer privilegesAndRolesFindingsCount) {
            if (privilegesAndRolesFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticDeferred", "privilegesAndRolesFindingsCount");
            }
        ...
        public Builder targetsCount(Integer targetsCount) {
            if (targetsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticDeferred", "targetsCount");
            }
        ...
        public Builder userAccountsFindingsCount(Integer userAccountsFindingsCount) {
            if (userAccountsFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticDeferred", "userAccountsFindingsCount");
            }
            this.userAccountsFindingsCount = userAccountsFindingsCount;
            return this;
        }
        public GetSecurityAssessmentsSecurityAssessmentStatisticDeferred build() {
            final var _resultValue = new GetSecurityAssessmentsSecurityAssessmentStatisticDeferred();
