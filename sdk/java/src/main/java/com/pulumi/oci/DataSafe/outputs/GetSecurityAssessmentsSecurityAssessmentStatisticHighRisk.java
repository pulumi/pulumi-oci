...
@CustomType
public final class GetSecurityAssessmentsSecurityAssessmentStatisticHighRisk {
    /**
    ...
    private GetSecurityAssessmentsSecurityAssessmentStatisticHighRisk() {}
    /**
     * @return The number of findings in the Auditing category.
     * 
     */
    ...
    public static Builder builder(GetSecurityAssessmentsSecurityAssessmentStatisticHighRisk defaults) {
    ...
    public static final class Builder {
        ...
        private Integer userAccountsFindingsCount;
        public Builder() {}
        public Builder(GetSecurityAssessmentsSecurityAssessmentStatisticHighRisk defaults) {
        ...
        public Builder auditingFindingsCount(Integer auditingFindingsCount) {
            if (auditingFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticHighRisk", "auditingFindingsCount");
            }
        ...
        public Builder authorizationControlFindingsCount(Integer authorizationControlFindingsCount) {
            if (authorizationControlFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticHighRisk", "authorizationControlFindingsCount");
            }
        ...
        public Builder dataEncryptionFindingsCount(Integer dataEncryptionFindingsCount) {
            if (dataEncryptionFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticHighRisk", "dataEncryptionFindingsCount");
            }
        ...
        public Builder dbConfigurationFindingsCount(Integer dbConfigurationFindingsCount) {
            if (dbConfigurationFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticHighRisk", "dbConfigurationFindingsCount");
            }
        ...
        public Builder fineGrainedAccessControlFindingsCount(Integer fineGrainedAccessControlFindingsCount) {
            if (fineGrainedAccessControlFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticHighRisk", "fineGrainedAccessControlFindingsCount");
            }
        ...
        public Builder privilegesAndRolesFindingsCount(Integer privilegesAndRolesFindingsCount) {
            if (privilegesAndRolesFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticHighRisk", "privilegesAndRolesFindingsCount");
            }
        ...
        public Builder targetsCount(Integer targetsCount) {
            if (targetsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticHighRisk", "targetsCount");
            }
        ...
        public Builder userAccountsFindingsCount(Integer userAccountsFindingsCount) {
            if (userAccountsFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticHighRisk", "userAccountsFindingsCount");
            }
            this.userAccountsFindingsCount = userAccountsFindingsCount;
            return this;
        }
        public GetSecurityAssessmentsSecurityAssessmentStatisticHighRisk build() {
            final var _resultValue = new GetSecurityAssessmentsSecurityAssessmentStatisticHighRisk();
