...
@CustomType
public final class GetSecurityAssessmentsSecurityAssessmentStatisticMediumRisk {
    /**
    ...
    private GetSecurityAssessmentsSecurityAssessmentStatisticMediumRisk() {}
    /**
     * @return The number of findings in the Auditing category.
     * 
     */
    ...
    public static Builder builder(GetSecurityAssessmentsSecurityAssessmentStatisticMediumRisk defaults) {
    ...
    public static final class Builder {
        ...
        private Integer userAccountsFindingsCount;
        public Builder() {}
        public Builder(GetSecurityAssessmentsSecurityAssessmentStatisticMediumRisk defaults) {
        ...
        public Builder auditingFindingsCount(Integer auditingFindingsCount) {
            if (auditingFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticMediumRisk", "auditingFindingsCount");
            }
        ...
        public Builder authorizationControlFindingsCount(Integer authorizationControlFindingsCount) {
            if (authorizationControlFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticMediumRisk", "authorizationControlFindingsCount");
            }
        ...
        public Builder dataEncryptionFindingsCount(Integer dataEncryptionFindingsCount) {
            if (dataEncryptionFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticMediumRisk", "dataEncryptionFindingsCount");
            }
        ...
        public Builder dbConfigurationFindingsCount(Integer dbConfigurationFindingsCount) {
            if (dbConfigurationFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticMediumRisk", "dbConfigurationFindingsCount");
            }
        ...
        public Builder fineGrainedAccessControlFindingsCount(Integer fineGrainedAccessControlFindingsCount) {
            if (fineGrainedAccessControlFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticMediumRisk", "fineGrainedAccessControlFindingsCount");
            }
        ...
        public Builder privilegesAndRolesFindingsCount(Integer privilegesAndRolesFindingsCount) {
            if (privilegesAndRolesFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticMediumRisk", "privilegesAndRolesFindingsCount");
            }
        ...
        public Builder targetsCount(Integer targetsCount) {
            if (targetsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticMediumRisk", "targetsCount");
            }
        ...
        public Builder userAccountsFindingsCount(Integer userAccountsFindingsCount) {
            if (userAccountsFindingsCount == null) {
              throw new MissingRequiredPropertyException("GetSecurityAssessmentsSecurityAssessmentStatisticMediumRisk", "userAccountsFindingsCount");
            }
            this.userAccountsFindingsCount = userAccountsFindingsCount;
            return this;
        }
        public GetSecurityAssessmentsSecurityAssessmentStatisticMediumRisk build() {
            final var _resultValue = new GetSecurityAssessmentsSecurityAssessmentStatisticMediumRisk();
