...
@CustomType
public final class GetSensitiveDataModelReferentialRelationChild {
    /**
    ...
    private GetSensitiveDataModelReferentialRelationChild() {}
    /**
     * @return The application name.
     * 
     */
    ...
    public static Builder builder(GetSensitiveDataModelReferentialRelationChild defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> sensitiveTypeIds;
        public Builder() {}
        public Builder(GetSensitiveDataModelReferentialRelationChild defaults) {
        ...
        public Builder appName(String appName) {
            if (appName == null) {
              throw new MissingRequiredPropertyException("GetSensitiveDataModelReferentialRelationChild", "appName");
            }
        ...
        public Builder columnGroups(List<String> columnGroups) {
            if (columnGroups == null) {
              throw new MissingRequiredPropertyException("GetSensitiveDataModelReferentialRelationChild", "columnGroups");
            }
        ...
        public Builder object(String object) {
            if (object == null) {
              throw new MissingRequiredPropertyException("GetSensitiveDataModelReferentialRelationChild", "object");
            }
            this.object = object;
            return this;
        }
        ...
        public Builder objectType(String objectType) {
            if (objectType == null) {
              throw new MissingRequiredPropertyException("GetSensitiveDataModelReferentialRelationChild", "objectType");
            }
        ...
        public Builder schemaName(String schemaName) {
            if (schemaName == null) {
              throw new MissingRequiredPropertyException("GetSensitiveDataModelReferentialRelationChild", "schemaName");
            }
        ...
        public Builder sensitiveTypeIds(List<String> sensitiveTypeIds) {
            if (sensitiveTypeIds == null) {
              throw new MissingRequiredPropertyException("GetSensitiveDataModelReferentialRelationChild", "sensitiveTypeIds");
            }
        ...
        public GetSensitiveDataModelReferentialRelationChild build() {
            final var _resultValue = new GetSensitiveDataModelReferentialRelationChild();
