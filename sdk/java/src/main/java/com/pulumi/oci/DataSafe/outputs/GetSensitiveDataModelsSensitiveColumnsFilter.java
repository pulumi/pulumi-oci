...
public final class GetSensitiveDataModelsSensitiveColumnsFilter {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetSensitiveDataModelsSensitiveColumnsFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetSensitiveDataModelsSensitiveColumnsFilter", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetSensitiveDataModelsSensitiveColumnsFilter build() {
            final var _resultValue = new GetSensitiveDataModelsSensitiveColumnsFilter();
