...
@CustomType
public final class GetSqlFirewallAllowedSqlResult {
    /**
    ...
    public static Builder builder(GetSqlFirewallAllowedSqlResult defaults) {
    ...
    public static final class Builder {
        ...
        private Double version;
        public Builder() {}
        public Builder(GetSqlFirewallAllowedSqlResult defaults) {
    	      ...
    	      this.sqlFirewallAllowedSqlId = defaults.sqlFirewallAllowedSqlId;
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallAllowedSqlResult", "compartmentId");
            }
        ...
        public Builder currentUser(String currentUser) {
            if (currentUser == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallAllowedSqlResult", "currentUser");
            }
        ...
        public Builder dbUserName(String dbUserName) {
            if (dbUserName == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallAllowedSqlResult", "dbUserName");
            }
        ...
        public Builder definedTags(Map<String,String> definedTags) {
            if (definedTags == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallAllowedSqlResult", "definedTags");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallAllowedSqlResult", "description");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallAllowedSqlResult", "displayName");
            }
        ...
        public Builder freeformTags(Map<String,String> freeformTags) {
            if (freeformTags == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallAllowedSqlResult", "freeformTags");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallAllowedSqlResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder sqlAccessedObjects(List<String> sqlAccessedObjects) {
            if (sqlAccessedObjects == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallAllowedSqlResult", "sqlAccessedObjects");
            }
        ...
        public Builder sqlFirewallAllowedSqlId(String sqlFirewallAllowedSqlId) {
            if (sqlFirewallAllowedSqlId == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallAllowedSqlResult", "sqlFirewallAllowedSqlId");
            }
        ...
        public Builder sqlFirewallPolicyId(String sqlFirewallPolicyId) {
            if (sqlFirewallPolicyId == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallAllowedSqlResult", "sqlFirewallPolicyId");
            }
        ...
        public Builder sqlLevel(String sqlLevel) {
            if (sqlLevel == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallAllowedSqlResult", "sqlLevel");
            }
        ...
        public Builder sqlText(String sqlText) {
            if (sqlText == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallAllowedSqlResult", "sqlText");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallAllowedSqlResult", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder systemTags(Map<String,String> systemTags) {
            if (systemTags == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallAllowedSqlResult", "systemTags");
            }
        ...
        public Builder timeCollected(String timeCollected) {
            if (timeCollected == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallAllowedSqlResult", "timeCollected");
            }
        ...
        public Builder timeUpdated(String timeUpdated) {
            if (timeUpdated == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallAllowedSqlResult", "timeUpdated");
            }
        ...
        public Builder version(Double version) {
            if (version == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallAllowedSqlResult", "version");
            }
            this.version = version;
            return this;
        }
        public GetSqlFirewallAllowedSqlResult build() {
            final var _resultValue = new GetSqlFirewallAllowedSqlResult();
            ...
            _resultValue.sqlFirewallAllowedSqlId = sqlFirewallAllowedSqlId;
