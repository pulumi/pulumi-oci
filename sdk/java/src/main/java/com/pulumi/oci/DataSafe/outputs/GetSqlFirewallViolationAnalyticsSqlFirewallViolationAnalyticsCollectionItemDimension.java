...
public final class GetSqlFirewallViolationAnalyticsSqlFirewallViolationAnalyticsCollectionItemDimension {
    ...
    public static final class Builder {
        ...
        public Builder clientIps(List<String> clientIps) {
            if (clientIps == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallViolationAnalyticsSqlFirewallViolationAnalyticsCollectionItemDimension", "clientIps");
            }
        ...
        public Builder clientOsUserNames(List<String> clientOsUserNames) {
            if (clientOsUserNames == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallViolationAnalyticsSqlFirewallViolationAnalyticsCollectionItemDimension", "clientOsUserNames");
            }
        ...
        public Builder clientPrograms(List<String> clientPrograms) {
            if (clientPrograms == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallViolationAnalyticsSqlFirewallViolationAnalyticsCollectionItemDimension", "clientPrograms");
            }
        ...
        public Builder dbUserNames(List<String> dbUserNames) {
            if (dbUserNames == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallViolationAnalyticsSqlFirewallViolationAnalyticsCollectionItemDimension", "dbUserNames");
            }
        ...
        public Builder operationTimes(List<String> operationTimes) {
            if (operationTimes == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallViolationAnalyticsSqlFirewallViolationAnalyticsCollectionItemDimension", "operationTimes");
            }
        ...
        public Builder operations(List<String> operations) {
            if (operations == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallViolationAnalyticsSqlFirewallViolationAnalyticsCollectionItemDimension", "operations");
            }
        ...
        public Builder sqlLevels(List<String> sqlLevels) {
            if (sqlLevels == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallViolationAnalyticsSqlFirewallViolationAnalyticsCollectionItemDimension", "sqlLevels");
            }
        ...
        public Builder targetIds(List<String> targetIds) {
            if (targetIds == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallViolationAnalyticsSqlFirewallViolationAnalyticsCollectionItemDimension", "targetIds");
            }
        ...
        public Builder targetNames(List<String> targetNames) {
            if (targetNames == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallViolationAnalyticsSqlFirewallViolationAnalyticsCollectionItemDimension", "targetNames");
            }
        ...
        public Builder violationActions(List<String> violationActions) {
            if (violationActions == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallViolationAnalyticsSqlFirewallViolationAnalyticsCollectionItemDimension", "violationActions");
            }
        ...
        public Builder violationCauses(List<String> violationCauses) {
            if (violationCauses == null) {
              throw new MissingRequiredPropertyException("GetSqlFirewallViolationAnalyticsSqlFirewallViolationAnalyticsCollectionItemDimension", "violationCauses");
            }
        ...
        public GetSqlFirewallViolationAnalyticsSqlFirewallViolationAnalyticsCollectionItemDimension build() {
            final var _resultValue = new GetSqlFirewallViolationAnalyticsSqlFirewallViolationAnalyticsCollectionItemDimension();
            _resultValue.clientIps = clientIps;
            _resultValue.clientOsUserNames = clientOsUserNames;
            _resultValue.clientPrograms = clientPrograms;
            _resultValue.dbUserNames = dbUserNames;
            _resultValue.operationTimes = operationTimes;
            _resultValue.operations = operations;
            _resultValue.sqlLevels = sqlLevels;
            _resultValue.targetIds = targetIds;
            _resultValue.targetNames = targetNames;
            _resultValue.violationActions = violationActions;
            _resultValue.violationCauses = violationCauses;
            return _resultValue;
        }
    }
}
