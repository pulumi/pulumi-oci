...
@CustomType
public final class GetTargetDatabasePeerTargetDatabaseDetailDatabaseDetail {
    /**
    ...
    private GetTargetDatabasePeerTargetDatabaseDetailDatabaseDetail() {}
    /**
     * @return The OCID of the Autonomous Database registered as a target database in Data Safe.
     * 
     */
    ...
    public static Builder builder(GetTargetDatabasePeerTargetDatabaseDetailDatabaseDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String vmClusterId;
        public Builder() {}
        public Builder(GetTargetDatabasePeerTargetDatabaseDetailDatabaseDetail defaults) {
        ...
        public Builder autonomousDatabaseId(String autonomousDatabaseId) {
            if (autonomousDatabaseId == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasePeerTargetDatabaseDetailDatabaseDetail", "autonomousDatabaseId");
            }
        ...
        public Builder databaseType(String databaseType) {
            if (databaseType == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasePeerTargetDatabaseDetailDatabaseDetail", "databaseType");
            }
        ...
        public Builder dbSystemId(String dbSystemId) {
            if (dbSystemId == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasePeerTargetDatabaseDetailDatabaseDetail", "dbSystemId");
            }
        ...
        public Builder infrastructureType(String infrastructureType) {
            if (infrastructureType == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasePeerTargetDatabaseDetailDatabaseDetail", "infrastructureType");
            }
        ...
        public Builder instanceId(String instanceId) {
            if (instanceId == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasePeerTargetDatabaseDetailDatabaseDetail", "instanceId");
            }
        ...
        public Builder ipAddresses(List<String> ipAddresses) {
            if (ipAddresses == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasePeerTargetDatabaseDetailDatabaseDetail", "ipAddresses");
            }
        ...
        public Builder listenerPort(Integer listenerPort) {
            if (listenerPort == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasePeerTargetDatabaseDetailDatabaseDetail", "listenerPort");
            }
        ...
        public Builder pluggableDatabaseId(String pluggableDatabaseId) {
            if (pluggableDatabaseId == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasePeerTargetDatabaseDetailDatabaseDetail", "pluggableDatabaseId");
            }
        ...
        public Builder serviceName(String serviceName) {
            if (serviceName == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasePeerTargetDatabaseDetailDatabaseDetail", "serviceName");
            }
        ...
        public Builder vmClusterId(String vmClusterId) {
            if (vmClusterId == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasePeerTargetDatabaseDetailDatabaseDetail", "vmClusterId");
            }
            this.vmClusterId = vmClusterId;
            return this;
        }
        public GetTargetDatabasePeerTargetDatabaseDetailDatabaseDetail build() {
            final var _resultValue = new GetTargetDatabasePeerTargetDatabaseDetailDatabaseDetail();
