...
@CustomType
public final class GetTargetDatabasePeerTargetDatabaseDetailTlsConfig {
    /**
    ...
    private GetTargetDatabasePeerTargetDatabaseDetailTlsConfig() {}
    /**
     * @return The format of the certificate store.
     * 
     */
    ...
    public static Builder builder(GetTargetDatabasePeerTargetDatabaseDetailTlsConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String trustStoreContent;
        public Builder() {}
        public Builder(GetTargetDatabasePeerTargetDatabaseDetailTlsConfig defaults) {
        ...
        public Builder certificateStoreType(String certificateStoreType) {
            if (certificateStoreType == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasePeerTargetDatabaseDetailTlsConfig", "certificateStoreType");
            }
        ...
        public Builder keyStoreContent(String keyStoreContent) {
            if (keyStoreContent == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasePeerTargetDatabaseDetailTlsConfig", "keyStoreContent");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasePeerTargetDatabaseDetailTlsConfig", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder storePassword(String storePassword) {
            if (storePassword == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasePeerTargetDatabaseDetailTlsConfig", "storePassword");
            }
        ...
        public Builder trustStoreContent(String trustStoreContent) {
            if (trustStoreContent == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasePeerTargetDatabaseDetailTlsConfig", "trustStoreContent");
            }
            this.trustStoreContent = trustStoreContent;
            return this;
        }
        public GetTargetDatabasePeerTargetDatabaseDetailTlsConfig build() {
            final var _resultValue = new GetTargetDatabasePeerTargetDatabaseDetailTlsConfig();
