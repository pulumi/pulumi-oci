...
@CustomType
public final class GetTargetDatabasePeerTargetDatabaseTlsConfig {
    /**
    ...
    private GetTargetDatabasePeerTargetDatabaseTlsConfig() {}
    /**
     * @return The format of the certificate store.
     * 
     */
    ...
    public static Builder builder(GetTargetDatabasePeerTargetDatabaseTlsConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String trustStoreContent;
        public Builder() {}
        public Builder(GetTargetDatabasePeerTargetDatabaseTlsConfig defaults) {
        ...
        public Builder certificateStoreType(String certificateStoreType) {
            if (certificateStoreType == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasePeerTargetDatabaseTlsConfig", "certificateStoreType");
            }
        ...
        public Builder keyStoreContent(String keyStoreContent) {
            if (keyStoreContent == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasePeerTargetDatabaseTlsConfig", "keyStoreContent");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasePeerTargetDatabaseTlsConfig", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder storePassword(String storePassword) {
            if (storePassword == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasePeerTargetDatabaseTlsConfig", "storePassword");
            }
        ...
        public Builder trustStoreContent(String trustStoreContent) {
            if (trustStoreContent == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasePeerTargetDatabaseTlsConfig", "trustStoreContent");
            }
            this.trustStoreContent = trustStoreContent;
            return this;
        }
        public GetTargetDatabasePeerTargetDatabaseTlsConfig build() {
            final var _resultValue = new GetTargetDatabasePeerTargetDatabaseTlsConfig();
