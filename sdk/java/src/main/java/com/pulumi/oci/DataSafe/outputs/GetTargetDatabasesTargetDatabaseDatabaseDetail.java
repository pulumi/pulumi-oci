    ...
    public static final class Builder {
        ...
        public Builder pluggableDatabaseId(String pluggableDatabaseId) {
            if (pluggableDatabaseId == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasesTargetDatabaseDatabaseDetail", "pluggableDatabaseId");
            }
        ...
        public GetTargetDatabasesTargetDatabaseDatabaseDetail build() {
            final var _resultValue = new GetTargetDatabasesTargetDatabaseDatabaseDetail();
