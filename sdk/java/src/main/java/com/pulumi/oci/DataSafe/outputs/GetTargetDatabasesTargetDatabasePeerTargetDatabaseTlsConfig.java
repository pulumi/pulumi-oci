...
@CustomType
public final class GetTargetDatabasesTargetDatabasePeerTargetDatabaseTlsConfig {
    /**
    ...
    private GetTargetDatabasesTargetDatabasePeerTargetDatabaseTlsConfig() {}
    /**
     * @return The format of the certificate store.
     * 
     */
    ...
    public static Builder builder(GetTargetDatabasesTargetDatabasePeerTargetDatabaseTlsConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String trustStoreContent;
        public Builder() {}
        public Builder(GetTargetDatabasesTargetDatabasePeerTargetDatabaseTlsConfig defaults) {
        ...
        public Builder certificateStoreType(String certificateStoreType) {
            if (certificateStoreType == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasesTargetDatabasePeerTargetDatabaseTlsConfig", "certificateStoreType");
            }
        ...
        public Builder keyStoreContent(String keyStoreContent) {
            if (keyStoreContent == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasesTargetDatabasePeerTargetDatabaseTlsConfig", "keyStoreContent");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasesTargetDatabasePeerTargetDatabaseTlsConfig", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder storePassword(String storePassword) {
            if (storePassword == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasesTargetDatabasePeerTargetDatabaseTlsConfig", "storePassword");
            }
        ...
        public Builder trustStoreContent(String trustStoreContent) {
            if (trustStoreContent == null) {
              throw new MissingRequiredPropertyException("GetTargetDatabasesTargetDatabasePeerTargetDatabaseTlsConfig", "trustStoreContent");
            }
            this.trustStoreContent = trustStoreContent;
            return this;
        }
        public GetTargetDatabasesTargetDatabasePeerTargetDatabaseTlsConfig build() {
            final var _resultValue = new GetTargetDatabasesTargetDatabasePeerTargetDatabaseTlsConfig();
