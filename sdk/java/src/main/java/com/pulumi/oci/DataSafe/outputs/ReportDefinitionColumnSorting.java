...
public final class ReportDefinitionColumnSorting {
    ...
    public static final class Builder {
        ...
        public Builder fieldName(String fieldName) {
            if (fieldName == null) {
              throw new MissingRequiredPropertyException("ReportDefinitionColumnSorting", "fieldName");
            }
        ...
        public Builder isAscending(Boolean isAscending) {
            if (isAscending == null) {
              throw new MissingRequiredPropertyException("ReportDefinitionColumnSorting", "isAscending");
            }
        ...
        public Builder sortingOrder(Integer sortingOrder) {
            if (sortingOrder == null) {
              throw new MissingRequiredPropertyException("ReportDefinitionColumnSorting", "sortingOrder");
            }
