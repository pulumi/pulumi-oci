...
@CustomType
public final class SecurityAssessmentFindingReference {
    /**
    ...
    public static Builder builder(SecurityAssessmentFindingReference defaults) {
    ...
    public static final class Builder {
        ...
        public SecurityAssessmentFindingReference build() {
            final var _resultValue = new SecurityAssessmentFindingReference();
