...
@CustomType
public final class SensitiveDataModelReferentialRelationChild {
    /**
    ...
    public static Builder builder(SensitiveDataModelReferentialRelationChild defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> sensitiveTypeIds;
        public Builder() {}
        public Builder(SensitiveDataModelReferentialRelationChild defaults) {
        ...
        public Builder appName(String appName) {
            if (appName == null) {
              throw new MissingRequiredPropertyException("SensitiveDataModelReferentialRelationChild", "appName");
            }
        ...
        public Builder columnGroups(List<String> columnGroups) {
            if (columnGroups == null) {
              throw new MissingRequiredPropertyException("SensitiveDataModelReferentialRelationChild", "columnGroups");
            }
        ...
        public Builder object(String object) {
            if (object == null) {
              throw new MissingRequiredPropertyException("SensitiveDataModelReferentialRelationChild", "object");
            }
            this.object = object;
            return this;
        }
        ...
        public Builder objectType(String objectType) {
            if (objectType == null) {
              throw new MissingRequiredPropertyException("SensitiveDataModelReferentialRelationChild", "objectType");
            }
        ...
        public Builder schemaName(String schemaName) {
            if (schemaName == null) {
              throw new MissingRequiredPropertyException("SensitiveDataModelReferentialRelationChild", "schemaName");
            }
        ...
        public SensitiveDataModelReferentialRelationChild build() {
            final var _resultValue = new SensitiveDataModelReferentialRelationChild();
