...
import com.pulumi.oci.DataScience.inputs.ModelCustomMetadataArtifactState;
 ...
 * 
 */
@ResourceType(type="oci:DataScience/modelCustomMetadataArtifact:ModelCustomMetadataArtifact")
public class ModelCustomMetadataArtifact extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="modelCustomMetadatumArtifact", refs={String.class}, tree="[0]")
     ...
     */
    public ModelCustomMetadataArtifact(java.lang.String name) {
        this(name, ModelCustomMetadataArtifactArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ModelCustomMetadataArtifact(java.lang.String name, ModelCustomMetadataArtifactArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ModelCustomMetadataArtifact(java.lang.String name, ModelCustomMetadataArtifactArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DataScience/modelCustomMetadataArtifact:ModelCustomMetadataArtifact", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ModelCustomMetadataArtifact(java.lang.String name, Output<java.lang.String> id, @Nullable ModelCustomMetadataArtifactState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DataScience/modelCustomMetadataArtifact:ModelCustomMetadataArtifact", name, state, makeResourceOptions(options, id), false);
    }

    private static ModelCustomMetadataArtifactArgs makeArgs(ModelCustomMetadataArtifactArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ModelCustomMetadataArtifactArgs.Empty : args;
    }
     ...
     */
    public static ModelCustomMetadataArtifact get(java.lang.String name, Output<java.lang.String> id, @Nullable ModelCustomMetadataArtifactState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
