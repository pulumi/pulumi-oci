...
public class ModelDeployment extends com.pulumi.resources.CustomResource {
     ...
     */
    public ModelDeployment(java.lang.String name) {
     ...
     */
    public ModelDeployment(java.lang.String name, ModelDeploymentArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ModelDeployment(java.lang.String name, ModelDeploymentArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DataScience/modelDeployment:ModelDeployment", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ModelDeployment(java.lang.String name, Output<java.lang.String> id, @Nullable ModelDeploymentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DataScience/modelDeployment:ModelDeployment", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ModelDeployment get(java.lang.String name, Output<java.lang.String> id, @Nullable ModelDeploymentState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
