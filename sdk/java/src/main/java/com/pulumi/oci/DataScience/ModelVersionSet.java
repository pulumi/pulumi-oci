...
public class ModelVersionSet extends com.pulumi.resources.CustomResource {
     ...
     */
    public ModelVersionSet(java.lang.String name) {
     ...
     */
    public ModelVersionSet(java.lang.String name, ModelVersionSetArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ModelVersionSet(java.lang.String name, ModelVersionSetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DataScience/modelVersionSet:ModelVersionSet", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ModelVersionSet(java.lang.String name, Output<java.lang.String> id, @Nullable ModelVersionSetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DataScience/modelVersionSet:ModelVersionSet", name, state, makeResourceOptions(options, id), false);
    }

    private static ModelVersionSetArgs makeArgs(ModelVersionSetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ModelVersionSetArgs.Empty : args;
    }
     ...
     */
    public static ModelVersionSet get(java.lang.String name, Output<java.lang.String> id, @Nullable ModelVersionSetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
