...
public final class GetModelDefinedMetadataArtifactContentArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetModelDefinedMetadataArtifactContentArgs Empty = new GetModelDefinedMetadataArtifactContentArgs();
    ...
    private GetModelDefinedMetadataArtifactContentArgs() {}

    private GetModelDefinedMetadataArtifactContentArgs(GetModelDefinedMetadataArtifactContentArgs $) {
    ...
    public static Builder builder(GetModelDefinedMetadataArtifactContentArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetModelDefinedMetadataArtifactContentArgs();
        }

        public Builder(GetModelDefinedMetadataArtifactContentArgs defaults) {
            $ = new GetModelDefinedMetadataArtifactContentArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetModelDefinedMetadataArtifactContentArgs build() {
            if ($.metadatumKeyName == null) {
                throw new MissingRequiredPropertyException("GetModelDefinedMetadataArtifactContentArgs", "metadatumKeyName");
            }
            if ($.modelId == null) {
                throw new MissingRequiredPropertyException("GetModelDefinedMetadataArtifactContentArgs", "modelId");
            }
            return $;
        }
    }
