...
public final class GetModelDefinedMetadataArtifactContentPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetModelDefinedMetadataArtifactContentPlainArgs Empty = new GetModelDefinedMetadataArtifactContentPlainArgs();
    ...
    private GetModelDefinedMetadataArtifactContentPlainArgs() {}

    private GetModelDefinedMetadataArtifactContentPlainArgs(GetModelDefinedMetadataArtifactContentPlainArgs $) {
    ...
    public static Builder builder(GetModelDefinedMetadataArtifactContentPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetModelDefinedMetadataArtifactContentPlainArgs();
        }

        public Builder(GetModelDefinedMetadataArtifactContentPlainArgs defaults) {
            $ = new GetModelDefinedMetadataArtifactContentPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetModelDefinedMetadataArtifactContentPlainArgs build() {
            if ($.metadatumKeyName == null) {
                throw new MissingRequiredPropertyException("GetModelDefinedMetadataArtifactContentPlainArgs", "metadatumKeyName");
            }
            if ($.modelId == null) {
                throw new MissingRequiredPropertyException("GetModelDefinedMetadataArtifactContentPlainArgs", "modelId");
            }
            return $;
        }
    }
