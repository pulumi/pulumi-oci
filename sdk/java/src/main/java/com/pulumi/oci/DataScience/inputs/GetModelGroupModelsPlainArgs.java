...
import com.pulumi.oci.DataScience.inputs.GetModelGroupModelsFilter;
...
public final class GetModelGroupModelsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetModelGroupModelsPlainArgs Empty = new GetModelGroupModelsPlainArgs();
    ...
    public Optional<List<GetModelGroupModelsFilter>> filters() {
    ...
    private GetModelGroupModelsPlainArgs() {}

    private GetModelGroupModelsPlainArgs(GetModelGroupModelsPlainArgs $) {
    ...
    public static Builder builder(GetModelGroupModelsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetModelGroupModelsPlainArgs();
        }

        public Builder(GetModelGroupModelsPlainArgs defaults) {
            $ = new GetModelGroupModelsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetModelGroupModelsPlainArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetModelGroupModelsPlainArgs", "compartmentId");
            }
            if ($.modelGroupId == null) {
                throw new MissingRequiredPropertyException("GetModelGroupModelsPlainArgs", "modelGroupId");
            }
            return $;
        }
    }
