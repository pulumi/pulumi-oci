...
public final class JobJobConfigurationDetailsStartupProbeDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobJobConfigurationDetailsStartupProbeDetailsArgs Empty = new JobJobConfigurationDetailsStartupProbeDetailsArgs();
    ...
    private JobJobConfigurationDetailsStartupProbeDetailsArgs() {}

    private JobJobConfigurationDetailsStartupProbeDetailsArgs(JobJobConfigurationDetailsStartupProbeDetailsArgs $) {
    ...
    public static Builder builder(JobJobConfigurationDetailsStartupProbeDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobJobConfigurationDetailsStartupProbeDetailsArgs();
        }

        public Builder(JobJobConfigurationDetailsStartupProbeDetailsArgs defaults) {
            $ = new JobJobConfigurationDetailsStartupProbeDetailsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public JobJobConfigurationDetailsStartupProbeDetailsArgs build() {
            if ($.commands == null) {
                throw new MissingRequiredPropertyException("JobJobConfigurationDetailsStartupProbeDetailsArgs", "commands");
            }
            if ($.jobProbeCheckType == null) {
                throw new MissingRequiredPropertyException("JobJobConfigurationDetailsStartupProbeDetailsArgs", "jobProbeCheckType");
            }
            return $;
        }
    }
