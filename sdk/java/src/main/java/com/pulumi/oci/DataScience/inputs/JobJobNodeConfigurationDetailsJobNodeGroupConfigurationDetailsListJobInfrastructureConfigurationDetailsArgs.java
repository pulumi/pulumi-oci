...
public final class JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsArgs Empty = new JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsArgs();
    ...
    private @Nullable Output<JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsJobShapeConfigDetailsArgs> jobShapeConfigDetails;

    /**
     * @return Details for the job run shape configuration. Specify only when a flex shape is selected.
     * 
     */
    public Optional<Output<JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsJobShapeConfigDetailsArgs>> jobShapeConfigDetails() {
    ...
    private @Nullable Output<JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsResourceConfigurationArgs> resourceConfiguration;

    /**
     * @return Details for the compute target job resource configuration.
     * 
     */
    public Optional<Output<JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsResourceConfigurationArgs>> resourceConfiguration() {
    ...
    private JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsArgs() {}

    private JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsArgs(JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsArgs $) {
    ...
    public static Builder builder(JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsArgs();
        }

        public Builder(JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsArgs defaults) {
            $ = new JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder jobShapeConfigDetails(@Nullable Output<JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsJobShapeConfigDetailsArgs> jobShapeConfigDetails) {
         ...
         * 
         */
        public Builder jobShapeConfigDetails(JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsJobShapeConfigDetailsArgs jobShapeConfigDetails) {
         ...
         * 
         */
        public Builder resourceConfiguration(@Nullable Output<JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsResourceConfigurationArgs> resourceConfiguration) {
         ...
         * 
         */
        public Builder resourceConfiguration(JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsResourceConfigurationArgs resourceConfiguration) {
        ...
        public JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsArgs build() {
            if ($.jobInfrastructureType == null) {
                throw new MissingRequiredPropertyException("JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsArgs", "jobInfrastructureType");
            }
            return $;
        }
    }
