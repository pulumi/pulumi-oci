...
public final class JobRunJobConfigurationOverrideDetailsStartupProbeDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobRunJobConfigurationOverrideDetailsStartupProbeDetailsArgs Empty = new JobRunJobConfigurationOverrideDetailsStartupProbeDetailsArgs();
    ...
    private JobRunJobConfigurationOverrideDetailsStartupProbeDetailsArgs() {}

    private JobRunJobConfigurationOverrideDetailsStartupProbeDetailsArgs(JobRunJobConfigurationOverrideDetailsStartupProbeDetailsArgs $) {
    ...
    public static Builder builder(JobRunJobConfigurationOverrideDetailsStartupProbeDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobRunJobConfigurationOverrideDetailsStartupProbeDetailsArgs();
        }

        public Builder(JobRunJobConfigurationOverrideDetailsStartupProbeDetailsArgs defaults) {
            $ = new JobRunJobConfigurationOverrideDetailsStartupProbeDetailsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public JobRunJobConfigurationOverrideDetailsStartupProbeDetailsArgs build() {
            if ($.commands == null) {
                throw new MissingRequiredPropertyException("JobRunJobConfigurationOverrideDetailsStartupProbeDetailsArgs", "commands");
            }
            if ($.jobProbeCheckType == null) {
                throw new MissingRequiredPropertyException("JobRunJobConfigurationOverrideDetailsStartupProbeDetailsArgs", "jobProbeCheckType");
            }
            return $;
        }
    }
