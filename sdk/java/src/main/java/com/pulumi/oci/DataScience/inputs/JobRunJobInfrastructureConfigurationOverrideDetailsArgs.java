...
public final class JobRunJobInfrastructureConfigurationOverrideDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobRunJobInfrastructureConfigurationOverrideDetailsArgs Empty = new JobRunJobInfrastructureConfigurationOverrideDetailsArgs();
    ...
    private @Nullable Output<JobRunJobInfrastructureConfigurationOverrideDetailsJobShapeConfigDetailsArgs> jobShapeConfigDetails;

    /**
     * @return Details for the job run shape configuration. Specify only when a flex shape is selected.
     * 
     */
    public Optional<Output<JobRunJobInfrastructureConfigurationOverrideDetailsJobShapeConfigDetailsArgs>> jobShapeConfigDetails() {
    ...
    private @Nullable Output<JobRunJobInfrastructureConfigurationOverrideDetailsResourceConfigurationArgs> resourceConfiguration;

    /**
     * @return Details for the compute target job resource configuration.
     * 
     */
    public Optional<Output<JobRunJobInfrastructureConfigurationOverrideDetailsResourceConfigurationArgs>> resourceConfiguration() {
    ...
    private JobRunJobInfrastructureConfigurationOverrideDetailsArgs() {}

    private JobRunJobInfrastructureConfigurationOverrideDetailsArgs(JobRunJobInfrastructureConfigurationOverrideDetailsArgs $) {
    ...
    public static Builder builder(JobRunJobInfrastructureConfigurationOverrideDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobRunJobInfrastructureConfigurationOverrideDetailsArgs();
        }

        public Builder(JobRunJobInfrastructureConfigurationOverrideDetailsArgs defaults) {
            $ = new JobRunJobInfrastructureConfigurationOverrideDetailsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder jobShapeConfigDetails(@Nullable Output<JobRunJobInfrastructureConfigurationOverrideDetailsJobShapeConfigDetailsArgs> jobShapeConfigDetails) {
         ...
         * 
         */
        public Builder jobShapeConfigDetails(JobRunJobInfrastructureConfigurationOverrideDetailsJobShapeConfigDetailsArgs jobShapeConfigDetails) {
            return jobShapeConfigDetails(Output.of(jobShapeConfigDetails));
        }

        /**
         * @param resourceConfiguration Details for the compute target job resource configuration.
         * 
         * @return builder
         * 
         */
        public Builder resourceConfiguration(@Nullable Output<JobRunJobInfrastructureConfigurationOverrideDetailsResourceConfigurationArgs> resourceConfiguration) {
         ...
         * 
         */
        public Builder resourceConfiguration(JobRunJobInfrastructureConfigurationOverrideDetailsResourceConfigurationArgs resourceConfiguration) {
        ...
        public JobRunJobInfrastructureConfigurationOverrideDetailsArgs build() {
            if ($.jobInfrastructureType == null) {
                throw new MissingRequiredPropertyException("JobRunJobInfrastructureConfigurationOverrideDetailsArgs", "jobInfrastructureType");
            }
            return $;
        }
    }
