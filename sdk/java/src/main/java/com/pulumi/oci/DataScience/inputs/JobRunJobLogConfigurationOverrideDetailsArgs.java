...
public final class JobRunJobLogConfigurationOverrideDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobRunJobLogConfigurationOverrideDetailsArgs Empty = new JobRunJobLogConfigurationOverrideDetailsArgs();
    ...
    private JobRunJobLogConfigurationOverrideDetailsArgs() {}

    private JobRunJobLogConfigurationOverrideDetailsArgs(JobRunJobLogConfigurationOverrideDetailsArgs $) {
    ...
    public static Builder builder(JobRunJobLogConfigurationOverrideDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobRunJobLogConfigurationOverrideDetailsArgs();
        }

        public Builder(JobRunJobLogConfigurationOverrideDetailsArgs defaults) {
            $ = new JobRunJobLogConfigurationOverrideDetailsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public JobRunJobLogConfigurationOverrideDetailsArgs build() {
            return $;
        }
    }
