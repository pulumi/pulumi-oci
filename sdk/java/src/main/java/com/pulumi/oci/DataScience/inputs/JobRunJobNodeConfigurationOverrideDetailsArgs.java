...
import com.pulumi.oci.DataScience.inputs.JobRunJobNodeConfigurationOverrideDetailsJobNodeGroupConfigurationDetailsListArgs;
...
public final class JobRunJobNodeConfigurationOverrideDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final JobRunJobNodeConfigurationOverrideDetailsArgs Empty = new JobRunJobNodeConfigurationOverrideDetailsArgs();
    ...
    private @Nullable Output<JobRunJobNodeConfigurationOverrideDetailsJobNetworkConfigurationArgs> jobNetworkConfiguration;

    /**
     * @return The job network configuration details
     * 
     */
    public Optional<Output<JobRunJobNodeConfigurationOverrideDetailsJobNetworkConfigurationArgs>> jobNetworkConfiguration() {
    ...
    private @Nullable Output<List<JobRunJobNodeConfigurationOverrideDetailsJobNodeGroupConfigurationDetailsListArgs>> jobNodeGroupConfigurationDetailsLists;

    /**
     * @return List of JobNodeGroupConfigurationDetails
     * 
     */
    public Optional<Output<List<JobRunJobNodeConfigurationOverrideDetailsJobNodeGroupConfigurationDetailsListArgs>>> jobNodeGroupConfigurationDetailsLists() {
    ...
    private JobRunJobNodeConfigurationOverrideDetailsArgs() {}

    private JobRunJobNodeConfigurationOverrideDetailsArgs(JobRunJobNodeConfigurationOverrideDetailsArgs $) {
    ...
    public static Builder builder(JobRunJobNodeConfigurationOverrideDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new JobRunJobNodeConfigurationOverrideDetailsArgs();
        }

        public Builder(JobRunJobNodeConfigurationOverrideDetailsArgs defaults) {
            $ = new JobRunJobNodeConfigurationOverrideDetailsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder jobNetworkConfiguration(@Nullable Output<JobRunJobNodeConfigurationOverrideDetailsJobNetworkConfigurationArgs> jobNetworkConfiguration) {
         ...
         * 
         */
        public Builder jobNetworkConfiguration(JobRunJobNodeConfigurationOverrideDetailsJobNetworkConfigurationArgs jobNetworkConfiguration) {
         ...
         * 
         */
        public Builder jobNodeGroupConfigurationDetailsLists(@Nullable Output<List<JobRunJobNodeConfigurationOverrideDetailsJobNodeGroupConfigurationDetailsListArgs>> jobNodeGroupConfigurationDetailsLists) {
         ...
         * 
         */
        public Builder jobNodeGroupConfigurationDetailsLists(List<JobRunJobNodeConfigurationOverrideDetailsJobNodeGroupConfigurationDetailsListArgs> jobNodeGroupConfigurationDetailsLists) {
         ...
         * 
         */
        public Builder jobNodeGroupConfigurationDetailsLists(JobRunJobNodeConfigurationOverrideDetailsJobNodeGroupConfigurationDetailsListArgs... jobNodeGroupConfigurationDetailsLists) {
        ...
        public JobRunJobNodeConfigurationOverrideDetailsArgs build() {
            if ($.jobNodeType == null) {
                throw new MissingRequiredPropertyException("JobRunJobNodeConfigurationOverrideDetailsArgs", "jobNodeType");
            }
            return $;
        }
    }
