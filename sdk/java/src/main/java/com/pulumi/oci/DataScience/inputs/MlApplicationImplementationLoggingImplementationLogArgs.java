...
public final class MlApplicationImplementationLoggingImplementationLogArgs extends com.pulumi.resources.ResourceArgs {

    public static final MlApplicationImplementationLoggingImplementationLogArgs Empty = new MlApplicationImplementationLoggingImplementationLogArgs();
    ...
    private MlApplicationImplementationLoggingImplementationLogArgs() {}

    private MlApplicationImplementationLoggingImplementationLogArgs(MlApplicationImplementationLoggingImplementationLogArgs $) {
    ...
    public static Builder builder(MlApplicationImplementationLoggingImplementationLogArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MlApplicationImplementationLoggingImplementationLogArgs();
        }

        public Builder(MlApplicationImplementationLoggingImplementationLogArgs defaults) {
            $ = new MlApplicationImplementationLoggingImplementationLogArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MlApplicationImplementationLoggingImplementationLogArgs build() {
            return $;
        }
    }
