...
public final class PipelineRunStepOverrideDetailStepConfigurationDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final PipelineRunStepOverrideDetailStepConfigurationDetailsArgs Empty = new PipelineRunStepOverrideDetailStepConfigurationDetailsArgs();
    ...
    private PipelineRunStepOverrideDetailStepConfigurationDetailsArgs() {}

    private PipelineRunStepOverrideDetailStepConfigurationDetailsArgs(PipelineRunStepOverrideDetailStepConfigurationDetailsArgs $) {
    ...
    public static Builder builder(PipelineRunStepOverrideDetailStepConfigurationDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PipelineRunStepOverrideDetailStepConfigurationDetailsArgs();
        }

        public Builder(PipelineRunStepOverrideDetailStepConfigurationDetailsArgs defaults) {
            $ = new PipelineRunStepOverrideDetailStepConfigurationDetailsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PipelineRunStepOverrideDetailStepConfigurationDetailsArgs build() {
            return $;
        }
    }
