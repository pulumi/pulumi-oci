...
public final class PipelineRunStorageMountConfigurationOverrideDetailsListArgs extends com.pulumi.resources.ResourceArgs {

    public static final PipelineRunStorageMountConfigurationOverrideDetailsListArgs Empty = new PipelineRunStorageMountConfigurationOverrideDetailsListArgs();
    ...
    private PipelineRunStorageMountConfigurationOverrideDetailsListArgs() {}

    private PipelineRunStorageMountConfigurationOverrideDetailsListArgs(PipelineRunStorageMountConfigurationOverrideDetailsListArgs $) {
        this.bucket = $.bucket;
    ...
    public static Builder builder(PipelineRunStorageMountConfigurationOverrideDetailsListArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PipelineRunStorageMountConfigurationOverrideDetailsListArgs();
        }

        public Builder(PipelineRunStorageMountConfigurationOverrideDetailsListArgs defaults) {
            $ = new PipelineRunStorageMountConfigurationOverrideDetailsListArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PipelineRunStorageMountConfigurationOverrideDetailsListArgs build() {
            if ($.destinationDirectoryName == null) {
                throw new MissingRequiredPropertyException("PipelineRunStorageMountConfigurationOverrideDetailsListArgs", "destinationDirectoryName");
            }
            if ($.storageType == null) {
                throw new MissingRequiredPropertyException("PipelineRunStorageMountConfigurationOverrideDetailsListArgs", "storageType");
            }
            return $;
        }
    }
