...
public final class PipelineStepDetailStepDataflowConfigurationDetailsDriverShapeConfigDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final PipelineStepDetailStepDataflowConfigurationDetailsDriverShapeConfigDetailsArgs Empty = new PipelineStepDetailStepDataflowConfigurationDetailsDriverShapeConfigDetailsArgs();
    ...
    private PipelineStepDetailStepDataflowConfigurationDetailsDriverShapeConfigDetailsArgs() {}

    private PipelineStepDetailStepDataflowConfigurationDetailsDriverShapeConfigDetailsArgs(PipelineStepDetailStepDataflowConfigurationDetailsDriverShapeConfigDetailsArgs $) {
    ...
    public static Builder builder(PipelineStepDetailStepDataflowConfigurationDetailsDriverShapeConfigDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PipelineStepDetailStepDataflowConfigurationDetailsDriverShapeConfigDetailsArgs();
        }

        public Builder(PipelineStepDetailStepDataflowConfigurationDetailsDriverShapeConfigDetailsArgs defaults) {
            $ = new PipelineStepDetailStepDataflowConfigurationDetailsDriverShapeConfigDetailsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PipelineStepDetailStepDataflowConfigurationDetailsDriverShapeConfigDetailsArgs build() {
            return $;
        }
    }
