...
@CustomType
public final class GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration {
    /**
    ...
    private GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration() {}
    /**
     * @return The value is used for adjusting the count of instances by.
     * 
     */
    ...
    public static Builder builder(GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer threshold;
        public Builder() {}
        public Builder(GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration defaults) {
        ...
        public Builder instanceCountAdjustment(Integer instanceCountAdjustment) {
            if (instanceCountAdjustment == null) {
              throw new MissingRequiredPropertyException("GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration", "instanceCountAdjustment");
            }
        ...
        public Builder pendingDuration(String pendingDuration) {
            if (pendingDuration == null) {
              throw new MissingRequiredPropertyException("GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration", "pendingDuration");
            }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration", "query");
            }
            this.query = query;
            return this;
        }
        ...
        public Builder scalingConfigurationType(String scalingConfigurationType) {
            if (scalingConfigurationType == null) {
              throw new MissingRequiredPropertyException("GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration", "scalingConfigurationType");
            }
        ...
        public Builder threshold(Integer threshold) {
            if (threshold == null) {
              throw new MissingRequiredPropertyException("GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration", "threshold");
            }
            this.threshold = threshold;
            return this;
        }
        public GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration build() {
            final var _resultValue = new GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration();
