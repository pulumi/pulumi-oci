...
@CustomType
public final class GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration {
    /**
    ...
    private GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration() {}
    /**
     * @return The value is used for adjusting the count of instances by.
     * 
     */
    ...
    public static Builder builder(GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer threshold;
        public Builder() {}
        public Builder(GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration defaults) {
        ...
        public Builder instanceCountAdjustment(Integer instanceCountAdjustment) {
            if (instanceCountAdjustment == null) {
              throw new MissingRequiredPropertyException("GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration", "instanceCountAdjustment");
            }
        ...
        public Builder pendingDuration(String pendingDuration) {
            if (pendingDuration == null) {
              throw new MissingRequiredPropertyException("GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration", "pendingDuration");
            }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration", "query");
            }
            this.query = query;
            return this;
        }
        ...
        public Builder scalingConfigurationType(String scalingConfigurationType) {
            if (scalingConfigurationType == null) {
              throw new MissingRequiredPropertyException("GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration", "scalingConfigurationType");
            }
        ...
        public Builder threshold(Integer threshold) {
            if (threshold == null) {
              throw new MissingRequiredPropertyException("GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration", "threshold");
            }
            this.threshold = threshold;
            return this;
        }
        public GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration build() {
            final var _resultValue = new GetComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration();
