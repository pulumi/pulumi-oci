...
@CustomType
public final class GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration {
    /**
    ...
    private GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration() {}
    /**
     * @return The value is used for adjusting the count of instances by.
     * 
     */
    ...
    public static Builder builder(GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer threshold;
        public Builder() {}
        public Builder(GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration defaults) {
        ...
        public Builder instanceCountAdjustment(Integer instanceCountAdjustment) {
            if (instanceCountAdjustment == null) {
              throw new MissingRequiredPropertyException("GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration", "instanceCountAdjustment");
            }
        ...
        public Builder pendingDuration(String pendingDuration) {
            if (pendingDuration == null) {
              throw new MissingRequiredPropertyException("GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration", "pendingDuration");
            }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration", "query");
            }
            this.query = query;
            return this;
        }
        ...
        public Builder scalingConfigurationType(String scalingConfigurationType) {
            if (scalingConfigurationType == null) {
              throw new MissingRequiredPropertyException("GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration", "scalingConfigurationType");
            }
        ...
        public Builder threshold(Integer threshold) {
            if (threshold == null) {
              throw new MissingRequiredPropertyException("GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration", "threshold");
            }
            this.threshold = threshold;
            return this;
        }
        public GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration build() {
            final var _resultValue = new GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleInConfiguration();
