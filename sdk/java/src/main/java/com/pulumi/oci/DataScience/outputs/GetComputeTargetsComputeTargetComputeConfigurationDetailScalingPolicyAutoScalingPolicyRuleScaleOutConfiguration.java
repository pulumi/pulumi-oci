...
@CustomType
public final class GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration {
    /**
    ...
    private GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration() {}
    /**
     * @return The value is used for adjusting the count of instances by.
     * 
     */
    ...
    public static Builder builder(GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer threshold;
        public Builder() {}
        public Builder(GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration defaults) {
        ...
        public Builder instanceCountAdjustment(Integer instanceCountAdjustment) {
            if (instanceCountAdjustment == null) {
              throw new MissingRequiredPropertyException("GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration", "instanceCountAdjustment");
            }
        ...
        public Builder pendingDuration(String pendingDuration) {
            if (pendingDuration == null) {
              throw new MissingRequiredPropertyException("GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration", "pendingDuration");
            }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration", "query");
            }
            this.query = query;
            return this;
        }
        ...
        public Builder scalingConfigurationType(String scalingConfigurationType) {
            if (scalingConfigurationType == null) {
              throw new MissingRequiredPropertyException("GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration", "scalingConfigurationType");
            }
        ...
        public Builder threshold(Integer threshold) {
            if (threshold == null) {
              throw new MissingRequiredPropertyException("GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration", "threshold");
            }
            this.threshold = threshold;
            return this;
        }
        public GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration build() {
            final var _resultValue = new GetComputeTargetsComputeTargetComputeConfigurationDetailScalingPolicyAutoScalingPolicyRuleScaleOutConfiguration();
