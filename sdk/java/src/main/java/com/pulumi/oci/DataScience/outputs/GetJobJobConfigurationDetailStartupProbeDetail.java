...
@CustomType
public final class GetJobJobConfigurationDetailStartupProbeDetail {
    /**
    ...
    private GetJobJobConfigurationDetailStartupProbeDetail() {}
    /**
     * @return The commands to run in the target job run to perform the startup probe
     * 
     */
    ...
    public static Builder builder(GetJobJobConfigurationDetailStartupProbeDetail defaults) {
    ...
    public static final class Builder {
        ...
        private Integer periodInSeconds;
        public Builder() {}
        public Builder(GetJobJobConfigurationDetailStartupProbeDetail defaults) {
        ...
        public Builder commands(List<String> commands) {
            if (commands == null) {
              throw new MissingRequiredPropertyException("GetJobJobConfigurationDetailStartupProbeDetail", "commands");
            }
        ...
        public Builder failureThreshold(Integer failureThreshold) {
            if (failureThreshold == null) {
              throw new MissingRequiredPropertyException("GetJobJobConfigurationDetailStartupProbeDetail", "failureThreshold");
            }
        ...
        public Builder initialDelayInSeconds(Integer initialDelayInSeconds) {
            if (initialDelayInSeconds == null) {
              throw new MissingRequiredPropertyException("GetJobJobConfigurationDetailStartupProbeDetail", "initialDelayInSeconds");
            }
        ...
        public Builder jobProbeCheckType(String jobProbeCheckType) {
            if (jobProbeCheckType == null) {
              throw new MissingRequiredPropertyException("GetJobJobConfigurationDetailStartupProbeDetail", "jobProbeCheckType");
            }
        ...
        public Builder periodInSeconds(Integer periodInSeconds) {
            if (periodInSeconds == null) {
              throw new MissingRequiredPropertyException("GetJobJobConfigurationDetailStartupProbeDetail", "periodInSeconds");
            }
            this.periodInSeconds = periodInSeconds;
            return this;
        }
        public GetJobJobConfigurationDetailStartupProbeDetail build() {
            final var _resultValue = new GetJobJobConfigurationDetailStartupProbeDetail();
