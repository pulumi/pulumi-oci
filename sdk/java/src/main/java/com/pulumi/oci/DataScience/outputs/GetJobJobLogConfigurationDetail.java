    ...
    public static final class Builder {
        ...
        public Builder enableAutoLogCreation(Boolean enableAutoLogCreation) {
            if (enableAutoLogCreation == null) {
              throw new MissingRequiredPropertyException("GetJobJobLogConfigurationDetail", "enableAutoLogCreation");
            }
        ...
        public Builder enableLogging(Boolean enableLogging) {
            if (enableLogging == null) {
              throw new MissingRequiredPropertyException("GetJobJobLogConfigurationDetail", "enableLogging");
            }
        ...
        public Builder logGroupId(String logGroupId) {
            if (logGroupId == null) {
              throw new MissingRequiredPropertyException("GetJobJobLogConfigurationDetail", "logGroupId");
            }
        ...
        public Builder logId(String logId) {
            if (logId == null) {
              throw new MissingRequiredPropertyException("GetJobJobLogConfigurationDetail", "logId");
            }
            this.logId = logId;
            return this;
        }
        public GetJobJobLogConfigurationDetail build() {
            final var _resultValue = new GetJobJobLogConfigurationDetail();
