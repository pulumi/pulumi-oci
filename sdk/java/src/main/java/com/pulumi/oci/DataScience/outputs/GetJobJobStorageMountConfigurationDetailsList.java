...
public final class GetJobJobStorageMountConfigurationDetailsList {
    ...
    public static Builder builder(GetJobJobStorageMountConfigurationDetailsList defaults) {
    ...
    public static final class Builder {
        ...
        public Builder bucket(String bucket) {
            if (bucket == null) {
              throw new MissingRequiredPropertyException("GetJobJobStorageMountConfigurationDetailsList", "bucket");
            }
            this.bucket = bucket;
            return this;
        }
        ...
        public Builder destinationDirectoryName(String destinationDirectoryName) {
            if (destinationDirectoryName == null) {
              throw new MissingRequiredPropertyException("GetJobJobStorageMountConfigurationDetailsList", "destinationDirectoryName");
            }
        ...
        public Builder destinationPath(String destinationPath) {
            if (destinationPath == null) {
              throw new MissingRequiredPropertyException("GetJobJobStorageMountConfigurationDetailsList", "destinationPath");
            }
        ...
        public Builder exportId(String exportId) {
            if (exportId == null) {
              throw new MissingRequiredPropertyException("GetJobJobStorageMountConfigurationDetailsList", "exportId");
            }
        ...
        public Builder mountTargetId(String mountTargetId) {
            if (mountTargetId == null) {
              throw new MissingRequiredPropertyException("GetJobJobStorageMountConfigurationDetailsList", "mountTargetId");
            }
        ...
        public Builder namespace(String namespace) {
            if (namespace == null) {
              throw new MissingRequiredPropertyException("GetJobJobStorageMountConfigurationDetailsList", "namespace");
            }
        ...
        public Builder prefix(String prefix) {
            if (prefix == null) {
              throw new MissingRequiredPropertyException("GetJobJobStorageMountConfigurationDetailsList", "prefix");
            }
            this.prefix = prefix;
            return this;
        }
        ...
        public Builder storageType(String storageType) {
            if (storageType == null) {
              throw new MissingRequiredPropertyException("GetJobJobStorageMountConfigurationDetailsList", "storageType");
            }
            this.storageType = storageType;
            return this;
        }
        public GetJobJobStorageMountConfigurationDetailsList build() {
            final var _resultValue = new GetJobJobStorageMountConfigurationDetailsList();
