...
@CustomType
public final class GetJobRunJobConfigurationOverrideDetailStartupProbeDetail {
    /**
    ...
    private GetJobRunJobConfigurationOverrideDetailStartupProbeDetail() {}
    /**
     * @return The commands to run in the target job run to perform the startup probe
     * 
     */
    ...
    public static Builder builder(GetJobRunJobConfigurationOverrideDetailStartupProbeDetail defaults) {
    ...
    public static final class Builder {
        ...
        private Integer periodInSeconds;
        public Builder() {}
        public Builder(GetJobRunJobConfigurationOverrideDetailStartupProbeDetail defaults) {
        ...
        public Builder commands(List<String> commands) {
            if (commands == null) {
              throw new MissingRequiredPropertyException("GetJobRunJobConfigurationOverrideDetailStartupProbeDetail", "commands");
            }
        ...
        public Builder failureThreshold(Integer failureThreshold) {
            if (failureThreshold == null) {
              throw new MissingRequiredPropertyException("GetJobRunJobConfigurationOverrideDetailStartupProbeDetail", "failureThreshold");
            }
        ...
        public Builder initialDelayInSeconds(Integer initialDelayInSeconds) {
            if (initialDelayInSeconds == null) {
              throw new MissingRequiredPropertyException("GetJobRunJobConfigurationOverrideDetailStartupProbeDetail", "initialDelayInSeconds");
            }
        ...
        public Builder jobProbeCheckType(String jobProbeCheckType) {
            if (jobProbeCheckType == null) {
              throw new MissingRequiredPropertyException("GetJobRunJobConfigurationOverrideDetailStartupProbeDetail", "jobProbeCheckType");
            }
        ...
        public Builder periodInSeconds(Integer periodInSeconds) {
            if (periodInSeconds == null) {
              throw new MissingRequiredPropertyException("GetJobRunJobConfigurationOverrideDetailStartupProbeDetail", "periodInSeconds");
            }
            this.periodInSeconds = periodInSeconds;
            return this;
        }
        public GetJobRunJobConfigurationOverrideDetailStartupProbeDetail build() {
            final var _resultValue = new GetJobRunJobConfigurationOverrideDetailStartupProbeDetail();
