...
@CustomType
public final class GetJobRunJobEnvironmentConfigurationOverrideDetail {
    /**
    ...
    private GetJobRunJobEnvironmentConfigurationOverrideDetail() {}
    /**
     * @return The container image run [CMD](https://docs.docker.com/engine/reference/builder/#cmd) as a list of strings. Use `CMD` as arguments to the `ENTRYPOINT` or the only command to run in the absence of an `ENTRYPOINT`. The combined size of `CMD` and `ENTRYPOINT` must be less than 2048 bytes.
     * 
     */
    ...
    public static Builder builder(GetJobRunJobEnvironmentConfigurationOverrideDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String jobEnvironmentType;
        public Builder() {}
        public Builder(GetJobRunJobEnvironmentConfigurationOverrideDetail defaults) {
        ...
        public Builder cmds(List<String> cmds) {
            if (cmds == null) {
              throw new MissingRequiredPropertyException("GetJobRunJobEnvironmentConfigurationOverrideDetail", "cmds");
            }
            this.cmds = cmds;
            return this;
        }
        ...
        public Builder entrypoints(List<String> entrypoints) {
            if (entrypoints == null) {
              throw new MissingRequiredPropertyException("GetJobRunJobEnvironmentConfigurationOverrideDetail", "entrypoints");
            }
        ...
        public Builder image(String image) {
            if (image == null) {
              throw new MissingRequiredPropertyException("GetJobRunJobEnvironmentConfigurationOverrideDetail", "image");
            }
            this.image = image;
            return this;
        }
        ...
        public Builder imageDigest(String imageDigest) {
            if (imageDigest == null) {
              throw new MissingRequiredPropertyException("GetJobRunJobEnvironmentConfigurationOverrideDetail", "imageDigest");
            }
        ...
        public Builder imageSignatureId(String imageSignatureId) {
            if (imageSignatureId == null) {
              throw new MissingRequiredPropertyException("GetJobRunJobEnvironmentConfigurationOverrideDetail", "imageSignatureId");
            }
        ...
        public Builder jobEnvironmentType(String jobEnvironmentType) {
            if (jobEnvironmentType == null) {
              throw new MissingRequiredPropertyException("GetJobRunJobEnvironmentConfigurationOverrideDetail", "jobEnvironmentType");
            }
            this.jobEnvironmentType = jobEnvironmentType;
            return this;
        }
        public GetJobRunJobEnvironmentConfigurationOverrideDetail build() {
            final var _resultValue = new GetJobRunJobEnvironmentConfigurationOverrideDetail();
