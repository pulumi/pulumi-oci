...
@CustomType
public final class GetJobRunsJobRunJobConfigurationOverrideDetailStartupProbeDetail {
    /**
    ...
    private GetJobRunsJobRunJobConfigurationOverrideDetailStartupProbeDetail() {}
    /**
     * @return The commands to run in the target job run to perform the startup probe
     * 
     */
    ...
    public static Builder builder(GetJobRunsJobRunJobConfigurationOverrideDetailStartupProbeDetail defaults) {
    ...
    public static final class Builder {
        ...
        private Integer periodInSeconds;
        public Builder() {}
        public Builder(GetJobRunsJobRunJobConfigurationOverrideDetailStartupProbeDetail defaults) {
        ...
        public Builder commands(List<String> commands) {
            if (commands == null) {
              throw new MissingRequiredPropertyException("GetJobRunsJobRunJobConfigurationOverrideDetailStartupProbeDetail", "commands");
            }
        ...
        public Builder failureThreshold(Integer failureThreshold) {
            if (failureThreshold == null) {
              throw new MissingRequiredPropertyException("GetJobRunsJobRunJobConfigurationOverrideDetailStartupProbeDetail", "failureThreshold");
            }
        ...
        public Builder initialDelayInSeconds(Integer initialDelayInSeconds) {
            if (initialDelayInSeconds == null) {
              throw new MissingRequiredPropertyException("GetJobRunsJobRunJobConfigurationOverrideDetailStartupProbeDetail", "initialDelayInSeconds");
            }
        ...
        public Builder jobProbeCheckType(String jobProbeCheckType) {
            if (jobProbeCheckType == null) {
              throw new MissingRequiredPropertyException("GetJobRunsJobRunJobConfigurationOverrideDetailStartupProbeDetail", "jobProbeCheckType");
            }
        ...
        public Builder periodInSeconds(Integer periodInSeconds) {
            if (periodInSeconds == null) {
              throw new MissingRequiredPropertyException("GetJobRunsJobRunJobConfigurationOverrideDetailStartupProbeDetail", "periodInSeconds");
            }
            this.periodInSeconds = periodInSeconds;
            return this;
        }
        public GetJobRunsJobRunJobConfigurationOverrideDetailStartupProbeDetail build() {
            final var _resultValue = new GetJobRunsJobRunJobConfigurationOverrideDetailStartupProbeDetail();
