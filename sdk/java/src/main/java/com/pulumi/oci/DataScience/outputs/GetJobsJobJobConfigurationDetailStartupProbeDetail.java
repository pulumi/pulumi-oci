...
@CustomType
public final class GetJobsJobJobConfigurationDetailStartupProbeDetail {
    /**
    ...
    private GetJobsJobJobConfigurationDetailStartupProbeDetail() {}
    /**
     * @return The commands to run in the target job run to perform the startup probe
     * 
     */
    ...
    public static Builder builder(GetJobsJobJobConfigurationDetailStartupProbeDetail defaults) {
    ...
    public static final class Builder {
        ...
        private Integer periodInSeconds;
        public Builder() {}
        public Builder(GetJobsJobJobConfigurationDetailStartupProbeDetail defaults) {
        ...
        public Builder commands(List<String> commands) {
            if (commands == null) {
              throw new MissingRequiredPropertyException("GetJobsJobJobConfigurationDetailStartupProbeDetail", "commands");
            }
        ...
        public Builder failureThreshold(Integer failureThreshold) {
            if (failureThreshold == null) {
              throw new MissingRequiredPropertyException("GetJobsJobJobConfigurationDetailStartupProbeDetail", "failureThreshold");
            }
        ...
        public Builder initialDelayInSeconds(Integer initialDelayInSeconds) {
            if (initialDelayInSeconds == null) {
              throw new MissingRequiredPropertyException("GetJobsJobJobConfigurationDetailStartupProbeDetail", "initialDelayInSeconds");
            }
        ...
        public Builder jobProbeCheckType(String jobProbeCheckType) {
            if (jobProbeCheckType == null) {
              throw new MissingRequiredPropertyException("GetJobsJobJobConfigurationDetailStartupProbeDetail", "jobProbeCheckType");
            }
        ...
        public Builder periodInSeconds(Integer periodInSeconds) {
            if (periodInSeconds == null) {
              throw new MissingRequiredPropertyException("GetJobsJobJobConfigurationDetailStartupProbeDetail", "periodInSeconds");
            }
            this.periodInSeconds = periodInSeconds;
            return this;
        }
        public GetJobsJobJobConfigurationDetailStartupProbeDetail build() {
            final var _resultValue = new GetJobsJobJobConfigurationDetailStartupProbeDetail();
