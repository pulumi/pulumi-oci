...
@CustomType
public final class GetJobsJobJobEnvironmentConfigurationDetail {
    /**
    ...
    private GetJobsJobJobEnvironmentConfigurationDetail() {}
    /**
     * @return The container image run [CMD](https://docs.docker.com/engine/reference/builder/#cmd) as a list of strings. Use `CMD` as arguments to the `ENTRYPOINT` or the only command to run in the absence of an `ENTRYPOINT`. The combined size of `CMD` and `ENTRYPOINT` must be less than 2048 bytes.
     * 
     */
    ...
    public static Builder builder(GetJobsJobJobEnvironmentConfigurationDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String jobEnvironmentType;
        public Builder() {}
        public Builder(GetJobsJobJobEnvironmentConfigurationDetail defaults) {
        ...
        public Builder cmds(List<String> cmds) {
            if (cmds == null) {
              throw new MissingRequiredPropertyException("GetJobsJobJobEnvironmentConfigurationDetail", "cmds");
            }
            this.cmds = cmds;
            return this;
        }
        ...
        public Builder entrypoints(List<String> entrypoints) {
            if (entrypoints == null) {
              throw new MissingRequiredPropertyException("GetJobsJobJobEnvironmentConfigurationDetail", "entrypoints");
            }
        ...
        public Builder image(String image) {
            if (image == null) {
              throw new MissingRequiredPropertyException("GetJobsJobJobEnvironmentConfigurationDetail", "image");
            }
            this.image = image;
            return this;
        }
        ...
        public Builder imageDigest(String imageDigest) {
            if (imageDigest == null) {
              throw new MissingRequiredPropertyException("GetJobsJobJobEnvironmentConfigurationDetail", "imageDigest");
            }
        ...
        public Builder imageSignatureId(String imageSignatureId) {
            if (imageSignatureId == null) {
              throw new MissingRequiredPropertyException("GetJobsJobJobEnvironmentConfigurationDetail", "imageSignatureId");
            }
        ...
        public Builder jobEnvironmentType(String jobEnvironmentType) {
            if (jobEnvironmentType == null) {
              throw new MissingRequiredPropertyException("GetJobsJobJobEnvironmentConfigurationDetail", "jobEnvironmentType");
            }
            this.jobEnvironmentType = jobEnvironmentType;
            return this;
        }
        public GetJobsJobJobEnvironmentConfigurationDetail build() {
            final var _resultValue = new GetJobsJobJobEnvironmentConfigurationDetail();
