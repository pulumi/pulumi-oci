...
import com.pulumi.oci.DataScience.outputs.GetJobsJobJobInfrastructureConfigurationDetailResourceConfiguration;
...
public final class GetJobsJobJobInfrastructureConfigurationDetail {
     ...
     * 
     */
    private List<GetJobsJobJobInfrastructureConfigurationDetailResourceConfiguration> resourceConfigurations;
    /**
     ...
     * 
     */
    public List<GetJobsJobJobInfrastructureConfigurationDetailResourceConfiguration> resourceConfigurations() {
    ...
    public static final class Builder {
        ...
        public Builder computeTargetId(String computeTargetId) {
            if (computeTargetId == null) {
              throw new MissingRequiredPropertyException("GetJobsJobJobInfrastructureConfigurationDetail", "computeTargetId");
            }
        ...
        @CustomType.Setter
        public Builder resourceConfigurations(List<GetJobsJobJobInfrastructureConfigurationDetailResourceConfiguration> resourceConfigurations) {
            if (resourceConfigurations == null) {
              throw new MissingRequiredPropertyException("GetJobsJobJobInfrastructureConfigurationDetail", "resourceConfigurations");
            }
            this.resourceConfigurations = resourceConfigurations;
            return this;
        }
        public Builder resourceConfigurations(GetJobsJobJobInfrastructureConfigurationDetailResourceConfiguration... resourceConfigurations) {
