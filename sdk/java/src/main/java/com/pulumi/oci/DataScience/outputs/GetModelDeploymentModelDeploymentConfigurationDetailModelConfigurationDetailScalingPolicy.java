...
import com.pulumi.oci.DataScience.outputs.GetModelDeploymentModelDeploymentConfigurationDetailModelConfigurationDetailScalingPolicyAutoScalingPolicy;
...
public final class GetModelDeploymentModelDeploymentConfigurationDetailModelConfigurationDetailScalingPolicy {
     ...
     * 
     */
    private List<GetModelDeploymentModelDeploymentConfigurationDetailModelConfigurationDetailScalingPolicyAutoScalingPolicy> autoScalingPolicies;
    /**
     ...
     * 
     */
    public List<GetModelDeploymentModelDeploymentConfigurationDetailModelConfigurationDetailScalingPolicyAutoScalingPolicy> autoScalingPolicies() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder autoScalingPolicies(List<GetModelDeploymentModelDeploymentConfigurationDetailModelConfigurationDetailScalingPolicyAutoScalingPolicy> autoScalingPolicies) {
            if (autoScalingPolicies == null) {
              throw new MissingRequiredPropertyException("GetModelDeploymentModelDeploymentConfigurationDetailModelConfigurationDetailScalingPolicy", "autoScalingPolicies");
            }
            this.autoScalingPolicies = autoScalingPolicies;
            return this;
        }
        public Builder autoScalingPolicies(GetModelDeploymentModelDeploymentConfigurationDetailModelConfigurationDetailScalingPolicyAutoScalingPolicy... autoScalingPolicies) {
        ...
        public Builder coolDownInSeconds(Integer coolDownInSeconds) {
            if (coolDownInSeconds == null) {
              throw new MissingRequiredPropertyException("GetModelDeploymentModelDeploymentConfigurationDetailModelConfigurationDetailScalingPolicy", "coolDownInSeconds");
            }
        ...
        public Builder isEnabled(Boolean isEnabled) {
            if (isEnabled == null) {
              throw new MissingRequiredPropertyException("GetModelDeploymentModelDeploymentConfigurationDetailModelConfigurationDetailScalingPolicy", "isEnabled");
            }
