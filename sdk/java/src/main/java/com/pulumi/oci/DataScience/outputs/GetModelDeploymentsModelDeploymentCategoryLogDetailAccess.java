...
public final class GetModelDeploymentsModelDeploymentCategoryLogDetailAccess {
    ...
    public static final class Builder {
        ...
        public Builder logGroupId(String logGroupId) {
            if (logGroupId == null) {
              throw new MissingRequiredPropertyException("GetModelDeploymentsModelDeploymentCategoryLogDetailAccess", "logGroupId");
            }
        ...
        public Builder logId(String logId) {
            if (logId == null) {
              throw new MissingRequiredPropertyException("GetModelDeploymentsModelDeploymentCategoryLogDetailAccess", "logId");
            }
            this.logId = logId;
            return this;
        }
