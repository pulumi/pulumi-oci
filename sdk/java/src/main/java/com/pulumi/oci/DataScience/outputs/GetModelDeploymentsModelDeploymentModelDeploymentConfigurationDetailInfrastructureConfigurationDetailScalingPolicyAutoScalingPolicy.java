...
@CustomType
public final class GetModelDeploymentsModelDeploymentModelDeploymentConfigurationDetailInfrastructureConfigurationDetailScalingPolicyAutoScalingPolicy {
    /**
    ...
    public static Builder builder(GetModelDeploymentsModelDeploymentModelDeploymentConfigurationDetailInfrastructureConfigurationDetailScalingPolicyAutoScalingPolicy defaults) {
    ...
    public static final class Builder {
        ...
        public Builder autoScalingPolicyType(String autoScalingPolicyType) {
            if (autoScalingPolicyType == null) {
              throw new MissingRequiredPropertyException("GetModelDeploymentsModelDeploymentModelDeploymentConfigurationDetailInfrastructureConfigurationDetailScalingPolicyAutoScalingPolicy", "autoScalingPolicyType");
            }
        ...
        public Builder initialInstanceCount(Integer initialInstanceCount) {
            if (initialInstanceCount == null) {
              throw new MissingRequiredPropertyException("GetModelDeploymentsModelDeploymentModelDeploymentConfigurationDetailInfrastructureConfigurationDetailScalingPolicyAutoScalingPolicy", "initialInstanceCount");
            }
        ...
        public Builder maximumInstanceCount(Integer maximumInstanceCount) {
            if (maximumInstanceCount == null) {
              throw new MissingRequiredPropertyException("GetModelDeploymentsModelDeploymentModelDeploymentConfigurationDetailInfrastructureConfigurationDetailScalingPolicyAutoScalingPolicy", "maximumInstanceCount");
            }
        ...
        public Builder minimumInstanceCount(Integer minimumInstanceCount) {
            if (minimumInstanceCount == null) {
              throw new MissingRequiredPropertyException("GetModelDeploymentsModelDeploymentModelDeploymentConfigurationDetailInfrastructureConfigurationDetailScalingPolicyAutoScalingPolicy", "minimumInstanceCount");
            }
            this.minimumInstanceCount = minimumInstanceCount;
            return this;
        }
        @CustomType.Setter
        public Builder rules(List<GetModelDeploymentsModelDeploymentModelDeploymentConfigurationDetailInfrastructureConfigurationDetailScalingPolicyAutoScalingPolicyRule> rules) {
            if (rules == null) {
              throw new MissingRequiredPropertyException("GetModelDeploymentsModelDeploymentModelDeploymentConfigurationDetailInfrastructureConfigurationDetailScalingPolicyAutoScalingPolicy", "rules");
            }
            this.rules = rules;
            return this;
        }
