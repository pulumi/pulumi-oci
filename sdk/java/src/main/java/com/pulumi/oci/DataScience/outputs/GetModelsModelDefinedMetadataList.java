...
public final class GetModelsModelDefinedMetadataList {
    ...
    public static final class Builder {
        ...
        public Builder category(String category) {
            if (category == null) {
              throw new MissingRequiredPropertyException("GetModelsModelDefinedMetadataList", "category");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetModelsModelDefinedMetadataList", "description");
            }
        ...
        public Builder hasArtifact(Boolean hasArtifact) {
            if (hasArtifact == null) {
              throw new MissingRequiredPropertyException("GetModelsModelDefinedMetadataList", "hasArtifact");
            }
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetModelsModelDefinedMetadataList", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder keywords(List<String> keywords) {
            if (keywords == null) {
              throw new MissingRequiredPropertyException("GetModelsModelDefinedMetadataList", "keywords");
            }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetModelsModelDefinedMetadataList", "value");
            }
            this.value = value;
            return this;
        }
        public GetModelsModelDefinedMetadataList build() {
            final var _resultValue = new GetModelsModelDefinedMetadataList();
