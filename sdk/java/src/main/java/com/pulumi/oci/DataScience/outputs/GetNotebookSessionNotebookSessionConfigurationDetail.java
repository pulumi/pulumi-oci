    ...
    public static final class Builder {
        ...
        public Builder blockStorageSizeInGbs(Integer blockStorageSizeInGbs) {
            if (blockStorageSizeInGbs == null) {
              throw new MissingRequiredPropertyException("GetNotebookSessionNotebookSessionConfigurationDetail", "blockStorageSizeInGbs");
            }
        ...
        public Builder capacityReservationId(String capacityReservationId) {
            if (capacityReservationId == null) {
              throw new MissingRequiredPropertyException("GetNotebookSessionNotebookSessionConfigurationDetail", "capacityReservationId");
            }
        ...
        public Builder notebookSessionShapeConfigDetails(List<GetNotebookSessionNotebookSessionConfigurationDetailNotebookSessionShapeConfigDetail> notebookSessionShapeConfigDetails) {
            if (notebookSessionShapeConfigDetails == null) {
              throw new MissingRequiredPropertyException("GetNotebookSessionNotebookSessionConfigurationDetail", "notebookSessionShapeConfigDetails");
            }
        ...
        public Builder privateEndpointId(String privateEndpointId) {
            if (privateEndpointId == null) {
              throw new MissingRequiredPropertyException("GetNotebookSessionNotebookSessionConfigurationDetail", "privateEndpointId");
            }
        ...
        public Builder shape(String shape) {
            if (shape == null) {
              throw new MissingRequiredPropertyException("GetNotebookSessionNotebookSessionConfigurationDetail", "shape");
            }
            this.shape = shape;
            return this;
        }
        ...
        public Builder subnetId(String subnetId) {
            if (subnetId == null) {
              throw new MissingRequiredPropertyException("GetNotebookSessionNotebookSessionConfigurationDetail", "subnetId");
            }
            this.subnetId = subnetId;
            return this;
        }
        public GetNotebookSessionNotebookSessionConfigurationDetail build() {
            final var _resultValue = new GetNotebookSessionNotebookSessionConfigurationDetail();
