    ...
    public static final class Builder {
        ...
        public Builder commandLineArguments(String commandLineArguments) {
            if (commandLineArguments == null) {
              throw new MissingRequiredPropertyException("GetPipelineConfigurationDetail", "commandLineArguments");
            }
        ...
        public Builder environmentVariables(Map<String,String> environmentVariables) {
            if (environmentVariables == null) {
              throw new MissingRequiredPropertyException("GetPipelineConfigurationDetail", "environmentVariables");
            }
        ...
        public Builder maximumRuntimeInMinutes(String maximumRuntimeInMinutes) {
            if (maximumRuntimeInMinutes == null) {
              throw new MissingRequiredPropertyException("GetPipelineConfigurationDetail", "maximumRuntimeInMinutes");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetPipelineConfigurationDetail", "type");
            }
            this.type = type;
            return this;
        }
