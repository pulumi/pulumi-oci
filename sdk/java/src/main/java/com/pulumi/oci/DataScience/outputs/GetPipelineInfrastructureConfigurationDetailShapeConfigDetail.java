...
public final class GetPipelineInfrastructureConfigurationDetailShapeConfigDetail {
    ...
    public static Builder builder(GetPipelineInfrastructureConfigurationDetailShapeConfigDetail defaults) {
    ...
    public static final class Builder {
        ...
        public Builder cpuBaseline(String cpuBaseline) {
            if (cpuBaseline == null) {
              throw new MissingRequiredPropertyException("GetPipelineInfrastructureConfigurationDetailShapeConfigDetail", "cpuBaseline");
            }
        ...
        public Builder memoryInGbs(Double memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetPipelineInfrastructureConfigurationDetailShapeConfigDetail", "memoryInGbs");
            }
