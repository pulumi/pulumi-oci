...
@CustomType
public final class GetPipelineRunConfigurationOverrideDetail {
    /**
    ...
    private GetPipelineRunConfigurationOverrideDetail() {}
    /**
     * @return The command line arguments to set for step.
     * 
     */
    ...
    public static Builder builder(GetPipelineRunConfigurationOverrideDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetPipelineRunConfigurationOverrideDetail defaults) {
        ...
        public Builder commandLineArguments(String commandLineArguments) {
            if (commandLineArguments == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunConfigurationOverrideDetail", "commandLineArguments");
            }
        ...
        public Builder environmentVariables(Map<String,Object> environmentVariables) {
            if (environmentVariables == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunConfigurationOverrideDetail", "environmentVariables");
            }
        ...
        public Builder maximumRuntimeInMinutes(String maximumRuntimeInMinutes) {
            if (maximumRuntimeInMinutes == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunConfigurationOverrideDetail", "maximumRuntimeInMinutes");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunConfigurationOverrideDetail", "type");
            }
            this.type = type;
            return this;
        }
