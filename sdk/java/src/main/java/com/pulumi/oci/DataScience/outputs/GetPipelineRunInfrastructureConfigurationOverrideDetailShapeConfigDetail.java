...
public final class GetPipelineRunInfrastructureConfigurationOverrideDetailShapeConfigDetail {
    ...
    public static final class Builder {
        ...
        public Builder cpuBaseline(String cpuBaseline) {
            if (cpuBaseline == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunInfrastructureConfigurationOverrideDetailShapeConfigDetail", "cpuBaseline");
            }
        ...
        public Builder memoryInGbsParameterized(String memoryInGbsParameterized) {
            if (memoryInGbsParameterized == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunInfrastructureConfigurationOverrideDetailShapeConfigDetail", "memoryInGbsParameterized");
            }
        ...
        public Builder ocpusParameterized(String ocpusParameterized) {
            if (ocpusParameterized == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunInfrastructureConfigurationOverrideDetailShapeConfigDetail", "ocpusParameterized");
            }
