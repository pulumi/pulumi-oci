    ...
    public static final class Builder {
        ...
        public Builder commandLineArguments(String commandLineArguments) {
            if (commandLineArguments == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunStepOverrideDetailStepConfigurationDetail", "commandLineArguments");
            }
        ...
        public Builder environmentVariables(Map<String,Object> environmentVariables) {
            if (environmentVariables == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunStepOverrideDetailStepConfigurationDetail", "environmentVariables");
            }
        ...
        public Builder maximumRuntimeInMinutes(String maximumRuntimeInMinutes) {
            if (maximumRuntimeInMinutes == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunStepOverrideDetailStepConfigurationDetail", "maximumRuntimeInMinutes");
            }
