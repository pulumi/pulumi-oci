    ...
    public static final class Builder {
        ...
        public Builder memoryInGbsParameterized(String memoryInGbsParameterized) {
            if (memoryInGbsParameterized == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunStepOverrideDetailStepDataflowConfigurationDetailDriverShapeConfigDetail", "memoryInGbsParameterized");
            }
        ...
        public Builder ocpusParameterized(String ocpusParameterized) {
            if (ocpusParameterized == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunStepOverrideDetailStepDataflowConfigurationDetailDriverShapeConfigDetail", "ocpusParameterized");
            }
