...
@CustomType
public final class GetPipelineRunsPipelineRunInfrastructureConfigurationOverrideDetailShapeConfigDetail {
    /**
    ...
    private GetPipelineRunsPipelineRunInfrastructureConfigurationOverrideDetailShapeConfigDetail() {}
    /**
     * @return The baseline OCPU utilization for a subcore burstable VM instance. If this attribute is left blank, it will default to `BASELINE_1_1`. The following values are supported: BASELINE_1_8 - baseline usage is 1/8 of an OCPU. BASELINE_1_2 - baseline usage is 1/2 of an OCPU. BASELINE_1_1 - baseline usage is an entire OCPU. This represents a non-burstable instance.
     * 
     */
    ...
    public static Builder builder(GetPipelineRunsPipelineRunInfrastructureConfigurationOverrideDetailShapeConfigDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String ocpusParameterized;
        public Builder() {}
        public Builder(GetPipelineRunsPipelineRunInfrastructureConfigurationOverrideDetailShapeConfigDetail defaults) {
        ...
        public Builder cpuBaseline(String cpuBaseline) {
            if (cpuBaseline == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunsPipelineRunInfrastructureConfigurationOverrideDetailShapeConfigDetail", "cpuBaseline");
            }
        ...
        public Builder memoryInGbs(Double memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunsPipelineRunInfrastructureConfigurationOverrideDetailShapeConfigDetail", "memoryInGbs");
            }
        ...
        public Builder memoryInGbsParameterized(String memoryInGbsParameterized) {
            if (memoryInGbsParameterized == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunsPipelineRunInfrastructureConfigurationOverrideDetailShapeConfigDetail", "memoryInGbsParameterized");
            }
        ...
        public Builder ocpus(Double ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunsPipelineRunInfrastructureConfigurationOverrideDetailShapeConfigDetail", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
        ...
        public Builder ocpusParameterized(String ocpusParameterized) {
            if (ocpusParameterized == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunsPipelineRunInfrastructureConfigurationOverrideDetailShapeConfigDetail", "ocpusParameterized");
            }
            this.ocpusParameterized = ocpusParameterized;
            return this;
        }
        public GetPipelineRunsPipelineRunInfrastructureConfigurationOverrideDetailShapeConfigDetail build() {
            final var _resultValue = new GetPipelineRunsPipelineRunInfrastructureConfigurationOverrideDetailShapeConfigDetail();
