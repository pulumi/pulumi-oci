...
@CustomType
public final class GetPipelineRunsPipelineRunStepOverrideDetailStepConfigurationDetail {
    /**
    ...
    private GetPipelineRunsPipelineRunStepOverrideDetailStepConfigurationDetail() {}
    /**
     * @return The command line arguments to set for step.
     * 
     */
    ...
    public static Builder builder(GetPipelineRunsPipelineRunStepOverrideDetailStepConfigurationDetail defaults) {
    ...
    public static final class Builder {
        ...
        public Builder commandLineArguments(String commandLineArguments) {
            if (commandLineArguments == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunsPipelineRunStepOverrideDetailStepConfigurationDetail", "commandLineArguments");
            }
        ...
        public Builder maximumRuntimeInMinutes(String maximumRuntimeInMinutes) {
            if (maximumRuntimeInMinutes == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunsPipelineRunStepOverrideDetailStepConfigurationDetail", "maximumRuntimeInMinutes");
            }
            this.maximumRuntimeInMinutes = maximumRuntimeInMinutes;
            return this;
        }
        public GetPipelineRunsPipelineRunStepOverrideDetailStepConfigurationDetail build() {
            final var _resultValue = new GetPipelineRunsPipelineRunStepOverrideDetailStepConfigurationDetail();
