...
@CustomType
public final class GetPipelineRunsPipelineRunStepOverrideDetailStepContainerConfigurationDetail {
    /**
    ...
    private GetPipelineRunsPipelineRunStepOverrideDetailStepContainerConfigurationDetail() {}
    /**
     * @return The container image run [CMD](https://docs.docker.com/engine/reference/builder/#cmd) as a list of strings. Use `CMD` as arguments to the `ENTRYPOINT` or the only command to run in the absence of an `ENTRYPOINT`. The combined size of `CMD` and `ENTRYPOINT` must be less than 2048 bytes.
     * 
     */
    ...
    public static Builder builder(GetPipelineRunsPipelineRunStepOverrideDetailStepContainerConfigurationDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String imageSignatureId;
        public Builder() {}
        public Builder(GetPipelineRunsPipelineRunStepOverrideDetailStepContainerConfigurationDetail defaults) {
        ...
        public Builder cmds(List<String> cmds) {
            if (cmds == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunsPipelineRunStepOverrideDetailStepContainerConfigurationDetail", "cmds");
            }
            this.cmds = cmds;
            return this;
        }
        ...
        public Builder containerType(String containerType) {
            if (containerType == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunsPipelineRunStepOverrideDetailStepContainerConfigurationDetail", "containerType");
            }
        ...
        public Builder entrypoints(List<String> entrypoints) {
            if (entrypoints == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunsPipelineRunStepOverrideDetailStepContainerConfigurationDetail", "entrypoints");
            }
        ...
        public Builder image(String image) {
            if (image == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunsPipelineRunStepOverrideDetailStepContainerConfigurationDetail", "image");
            }
            this.image = image;
            return this;
        }
        ...
        public Builder imageDigest(String imageDigest) {
            if (imageDigest == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunsPipelineRunStepOverrideDetailStepContainerConfigurationDetail", "imageDigest");
            }
        ...
        public Builder imageSignatureId(String imageSignatureId) {
            if (imageSignatureId == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunsPipelineRunStepOverrideDetailStepContainerConfigurationDetail", "imageSignatureId");
            }
            this.imageSignatureId = imageSignatureId;
            return this;
        }
        public GetPipelineRunsPipelineRunStepOverrideDetailStepContainerConfigurationDetail build() {
            final var _resultValue = new GetPipelineRunsPipelineRunStepOverrideDetailStepContainerConfigurationDetail();
