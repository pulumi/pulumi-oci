...
@CustomType
public final class GetPipelineRunsPipelineRunStepOverrideDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail {
    /**
    ...
    private GetPipelineRunsPipelineRunStepOverrideDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail() {}
    /**
     * @return The total amount of memory available to the pipeline step run instance GBs.
     * 
     */
    ...
    public static Builder builder(GetPipelineRunsPipelineRunStepOverrideDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String ocpusParameterized;
        public Builder() {}
        public Builder(GetPipelineRunsPipelineRunStepOverrideDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail defaults) {
        ...
        public Builder memoryInGbs(Double memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunsPipelineRunStepOverrideDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail", "memoryInGbs");
            }
        ...
        public Builder memoryInGbsParameterized(String memoryInGbsParameterized) {
            if (memoryInGbsParameterized == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunsPipelineRunStepOverrideDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail", "memoryInGbsParameterized");
            }
        ...
        public Builder ocpus(Double ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunsPipelineRunStepOverrideDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
        ...
        public Builder ocpusParameterized(String ocpusParameterized) {
            if (ocpusParameterized == null) {
              throw new MissingRequiredPropertyException("GetPipelineRunsPipelineRunStepOverrideDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail", "ocpusParameterized");
            }
            this.ocpusParameterized = ocpusParameterized;
            return this;
        }
        public GetPipelineRunsPipelineRunStepOverrideDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail build() {
            final var _resultValue = new GetPipelineRunsPipelineRunStepOverrideDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail();
