...
@CustomType
public final class GetPipelineStepDetailStepContainerConfigurationDetail {
    /**
    ...
    private GetPipelineStepDetailStepContainerConfigurationDetail() {}
    /**
     * @return The container image run [CMD](https://docs.docker.com/engine/reference/builder/#cmd) as a list of strings. Use `CMD` as arguments to the `ENTRYPOINT` or the only command to run in the absence of an `ENTRYPOINT`. The combined size of `CMD` and `ENTRYPOINT` must be less than 2048 bytes.
     * 
     */
    ...
    public static Builder builder(GetPipelineStepDetailStepContainerConfigurationDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String imageSignatureId;
        public Builder() {}
        public Builder(GetPipelineStepDetailStepContainerConfigurationDetail defaults) {
        ...
        public Builder cmds(List<String> cmds) {
            if (cmds == null) {
              throw new MissingRequiredPropertyException("GetPipelineStepDetailStepContainerConfigurationDetail", "cmds");
            }
            this.cmds = cmds;
            return this;
        }
        ...
        public Builder containerType(String containerType) {
            if (containerType == null) {
              throw new MissingRequiredPropertyException("GetPipelineStepDetailStepContainerConfigurationDetail", "containerType");
            }
        ...
        public Builder entrypoints(List<String> entrypoints) {
            if (entrypoints == null) {
              throw new MissingRequiredPropertyException("GetPipelineStepDetailStepContainerConfigurationDetail", "entrypoints");
            }
        ...
        public Builder image(String image) {
            if (image == null) {
              throw new MissingRequiredPropertyException("GetPipelineStepDetailStepContainerConfigurationDetail", "image");
            }
            this.image = image;
            return this;
        }
        ...
        public Builder imageDigest(String imageDigest) {
            if (imageDigest == null) {
              throw new MissingRequiredPropertyException("GetPipelineStepDetailStepContainerConfigurationDetail", "imageDigest");
            }
        ...
        public Builder imageSignatureId(String imageSignatureId) {
            if (imageSignatureId == null) {
              throw new MissingRequiredPropertyException("GetPipelineStepDetailStepContainerConfigurationDetail", "imageSignatureId");
            }
            this.imageSignatureId = imageSignatureId;
            return this;
        }
        public GetPipelineStepDetailStepContainerConfigurationDetail build() {
            final var _resultValue = new GetPipelineStepDetailStepContainerConfigurationDetail();
