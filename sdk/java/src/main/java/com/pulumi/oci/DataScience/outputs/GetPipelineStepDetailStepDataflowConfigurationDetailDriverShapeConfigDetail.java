...
@CustomType
public final class GetPipelineStepDetailStepDataflowConfigurationDetailDriverShapeConfigDetail {
    /**
    ...
    private GetPipelineStepDetailStepDataflowConfigurationDetailDriverShapeConfigDetail() {}
    /**
     * @return The total amount of memory available to the pipeline step run instance GBs.
     * 
     */
    ...
    public static Builder builder(GetPipelineStepDetailStepDataflowConfigurationDetailDriverShapeConfigDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String ocpusParameterized;
        public Builder() {}
        public Builder(GetPipelineStepDetailStepDataflowConfigurationDetailDriverShapeConfigDetail defaults) {
        ...
        public Builder memoryInGbs(Double memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetPipelineStepDetailStepDataflowConfigurationDetailDriverShapeConfigDetail", "memoryInGbs");
            }
        ...
        public Builder memoryInGbsParameterized(String memoryInGbsParameterized) {
            if (memoryInGbsParameterized == null) {
              throw new MissingRequiredPropertyException("GetPipelineStepDetailStepDataflowConfigurationDetailDriverShapeConfigDetail", "memoryInGbsParameterized");
            }
        ...
        public Builder ocpus(Double ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetPipelineStepDetailStepDataflowConfigurationDetailDriverShapeConfigDetail", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
        ...
        public Builder ocpusParameterized(String ocpusParameterized) {
            if (ocpusParameterized == null) {
              throw new MissingRequiredPropertyException("GetPipelineStepDetailStepDataflowConfigurationDetailDriverShapeConfigDetail", "ocpusParameterized");
            }
            this.ocpusParameterized = ocpusParameterized;
            return this;
        }
        public GetPipelineStepDetailStepDataflowConfigurationDetailDriverShapeConfigDetail build() {
            final var _resultValue = new GetPipelineStepDetailStepDataflowConfigurationDetailDriverShapeConfigDetail();
