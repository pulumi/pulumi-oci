...
@CustomType
public final class GetPipelineStepDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail {
    /**
    ...
    private GetPipelineStepDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail() {}
    /**
     * @return The total amount of memory available to the pipeline step run instance GBs.
     * 
     */
    ...
    public static Builder builder(GetPipelineStepDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String ocpusParameterized;
        public Builder() {}
        public Builder(GetPipelineStepDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail defaults) {
        ...
        public Builder memoryInGbs(Double memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetPipelineStepDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail", "memoryInGbs");
            }
        ...
        public Builder memoryInGbsParameterized(String memoryInGbsParameterized) {
            if (memoryInGbsParameterized == null) {
              throw new MissingRequiredPropertyException("GetPipelineStepDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail", "memoryInGbsParameterized");
            }
        ...
        public Builder ocpus(Double ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetPipelineStepDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
        ...
        public Builder ocpusParameterized(String ocpusParameterized) {
            if (ocpusParameterized == null) {
              throw new MissingRequiredPropertyException("GetPipelineStepDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail", "ocpusParameterized");
            }
            this.ocpusParameterized = ocpusParameterized;
            return this;
        }
        public GetPipelineStepDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail build() {
            final var _resultValue = new GetPipelineStepDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail();
