...
@CustomType
public final class GetPipelinesPipelineConfigurationDetail {
    /**
    ...
    private GetPipelinesPipelineConfigurationDetail() {}
    /**
     * @return The command line arguments to set for step.
     * 
     */
    ...
    public static Builder builder(GetPipelinesPipelineConfigurationDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetPipelinesPipelineConfigurationDetail defaults) {
        ...
        public Builder commandLineArguments(String commandLineArguments) {
            if (commandLineArguments == null) {
              throw new MissingRequiredPropertyException("GetPipelinesPipelineConfigurationDetail", "commandLineArguments");
            }
        ...
        public Builder environmentVariables(Map<String,Object> environmentVariables) {
            if (environmentVariables == null) {
              throw new MissingRequiredPropertyException("GetPipelinesPipelineConfigurationDetail", "environmentVariables");
            }
        ...
        public Builder maximumRuntimeInMinutes(String maximumRuntimeInMinutes) {
            if (maximumRuntimeInMinutes == null) {
              throw new MissingRequiredPropertyException("GetPipelinesPipelineConfigurationDetail", "maximumRuntimeInMinutes");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetPipelinesPipelineConfigurationDetail", "type");
            }
            this.type = type;
            return this;
        }
