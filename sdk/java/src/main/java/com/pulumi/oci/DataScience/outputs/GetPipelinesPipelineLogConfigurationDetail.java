...
@CustomType
public final class GetPipelinesPipelineLogConfigurationDetail {
    /**
    ...
    private GetPipelinesPipelineLogConfigurationDetail() {}
    /**
     * @return If automatic on-behalf-of log object creation is enabled for pipeline runs.
     * 
     */
    ...
    public static Builder builder(GetPipelinesPipelineLogConfigurationDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String logId;
        public Builder() {}
        public Builder(GetPipelinesPipelineLogConfigurationDetail defaults) {
        ...
        public Builder enableAutoLogCreation(Boolean enableAutoLogCreation) {
            if (enableAutoLogCreation == null) {
              throw new MissingRequiredPropertyException("GetPipelinesPipelineLogConfigurationDetail", "enableAutoLogCreation");
            }
        ...
        public Builder enableLogging(Boolean enableLogging) {
            if (enableLogging == null) {
              throw new MissingRequiredPropertyException("GetPipelinesPipelineLogConfigurationDetail", "enableLogging");
            }
        ...
        public Builder logGroupId(String logGroupId) {
            if (logGroupId == null) {
              throw new MissingRequiredPropertyException("GetPipelinesPipelineLogConfigurationDetail", "logGroupId");
            }
        ...
        public Builder logId(String logId) {
            if (logId == null) {
              throw new MissingRequiredPropertyException("GetPipelinesPipelineLogConfigurationDetail", "logId");
            }
            this.logId = logId;
            return this;
        }
        public GetPipelinesPipelineLogConfigurationDetail build() {
            final var _resultValue = new GetPipelinesPipelineLogConfigurationDetail();
