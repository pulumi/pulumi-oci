    ...
    public static final class Builder {
        ...
        public Builder commandLineArguments(String commandLineArguments) {
            if (commandLineArguments == null) {
              throw new MissingRequiredPropertyException("GetPipelinesPipelineStepDetailStepConfigurationDetail", "commandLineArguments");
            }
        ...
        public Builder environmentVariables(Map<String,Object> environmentVariables) {
            if (environmentVariables == null) {
              throw new MissingRequiredPropertyException("GetPipelinesPipelineStepDetailStepConfigurationDetail", "environmentVariables");
            }
        ...
        public Builder maximumRuntimeInMinutes(String maximumRuntimeInMinutes) {
            if (maximumRuntimeInMinutes == null) {
              throw new MissingRequiredPropertyException("GetPipelinesPipelineStepDetailStepConfigurationDetail", "maximumRuntimeInMinutes");
            }
            this.maximumRuntimeInMinutes = maximumRuntimeInMinutes;
            return this;
        }
        public GetPipelinesPipelineStepDetailStepConfigurationDetail build() {
            final var _resultValue = new GetPipelinesPipelineStepDetailStepConfigurationDetail();
