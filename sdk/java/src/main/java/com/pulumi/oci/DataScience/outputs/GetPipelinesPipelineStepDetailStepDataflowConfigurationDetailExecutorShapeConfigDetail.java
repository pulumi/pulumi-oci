...
public final class GetPipelinesPipelineStepDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail {
    ...
    public static Builder builder(GetPipelinesPipelineStepDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail defaults) {
    ...
    public static final class Builder {
        ...
        public Builder ocpus(Double ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetPipelinesPipelineStepDetailStepDataflowConfigurationDetailExecutorShapeConfigDetail", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
