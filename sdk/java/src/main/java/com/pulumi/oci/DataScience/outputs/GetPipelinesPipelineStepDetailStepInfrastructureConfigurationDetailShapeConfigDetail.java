...
public final class GetPipelinesPipelineStepDetailStepInfrastructureConfigurationDetailShapeConfigDetail {
    ...
    public static final class Builder {
        ...
        public Builder cpuBaseline(String cpuBaseline) {
            if (cpuBaseline == null) {
              throw new MissingRequiredPropertyException("GetPipelinesPipelineStepDetailStepInfrastructureConfigurationDetailShapeConfigDetail", "cpuBaseline");
            }
        ...
        public Builder memoryInGbs(Double memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetPipelinesPipelineStepDetailStepInfrastructureConfigurationDetailShapeConfigDetail", "memoryInGbs");
            }
        ...
        public Builder memoryInGbsParameterized(String memoryInGbsParameterized) {
            if (memoryInGbsParameterized == null) {
              throw new MissingRequiredPropertyException("GetPipelinesPipelineStepDetailStepInfrastructureConfigurationDetailShapeConfigDetail", "memoryInGbsParameterized");
            }
        ...
        public Builder ocpus(Double ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetPipelinesPipelineStepDetailStepInfrastructureConfigurationDetailShapeConfigDetail", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
        ...
        public Builder ocpusParameterized(String ocpusParameterized) {
            if (ocpusParameterized == null) {
              throw new MissingRequiredPropertyException("GetPipelinesPipelineStepDetailStepInfrastructureConfigurationDetailShapeConfigDetail", "ocpusParameterized");
            }
        ...
        public GetPipelinesPipelineStepDetailStepInfrastructureConfigurationDetailShapeConfigDetail build() {
            final var _resultValue = new GetPipelinesPipelineStepDetailStepInfrastructureConfigurationDetailShapeConfigDetail();
