...
import com.pulumi.oci.DataScience.outputs.GetSchedulesScheduleAction;
import com.pulumi.oci.DataScience.outputs.GetSchedulesScheduleLogDetail;
import com.pulumi.oci.DataScience.outputs.GetSchedulesScheduleTrigger;
...
public final class GetSchedulesSchedule {
     ...
     * 
     */
    private List<GetSchedulesScheduleAction> actions;
    /**
     ...
     * 
     */
    private List<GetSchedulesScheduleLogDetail> logDetails;
    /**
     ...
     * 
     */
    private List<GetSchedulesScheduleTrigger> triggers;
     ...
     * 
     */
    public List<GetSchedulesScheduleAction> actions() {
        return this.actions;
    }
    /**
     * @return &lt;b&gt;Filter&lt;/b&gt; results by the [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
     ...
     * 
     */
    public List<GetSchedulesScheduleLogDetail> logDetails() {
     ...
     * 
     */
    public List<GetSchedulesScheduleTrigger> triggers() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder actions(List<GetSchedulesScheduleAction> actions) {
            if (actions == null) {
              throw new MissingRequiredPropertyException("GetSchedulesSchedule", "actions");
            }
            this.actions = actions;
            return this;
        }
        public Builder actions(GetSchedulesScheduleAction... actions) {
            return actions(List.of(actions));
        }
        @CustomType.Setter
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetSchedulesSchedule", "compartmentId");
            }
        ...
        public Builder createdBy(String createdBy) {
            if (createdBy == null) {
              throw new MissingRequiredPropertyException("GetSchedulesSchedule", "createdBy");
            }
        ...
        public Builder definedTags(Map<String,String> definedTags) {
            if (definedTags == null) {
              throw new MissingRequiredPropertyException("GetSchedulesSchedule", "definedTags");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetSchedulesSchedule", "displayName");
            }
        ...
        public Builder freeformTags(Map<String,String> freeformTags) {
            if (freeformTags == null) {
              throw new MissingRequiredPropertyException("GetSchedulesSchedule", "freeformTags");
            }
        ...
        public Builder lastScheduleRunDetails(String lastScheduleRunDetails) {
            if (lastScheduleRunDetails == null) {
              throw new MissingRequiredPropertyException("GetSchedulesSchedule", "lastScheduleRunDetails");
            }
        ...
        public Builder lifecycleDetails(String lifecycleDetails) {
            if (lifecycleDetails == null) {
              throw new MissingRequiredPropertyException("GetSchedulesSchedule", "lifecycleDetails");
            }
            this.lifecycleDetails = lifecycleDetails;
            return this;
        }
        @CustomType.Setter
        public Builder logDetails(List<GetSchedulesScheduleLogDetail> logDetails) {
            if (logDetails == null) {
              throw new MissingRequiredPropertyException("GetSchedulesSchedule", "logDetails");
            }
            this.logDetails = logDetails;
            return this;
        }
        public Builder logDetails(GetSchedulesScheduleLogDetail... logDetails) {
            return logDetails(List.of(logDetails));
        }
        @CustomType.Setter
        public Builder projectId(String projectId) {
            if (projectId == null) {
              throw new MissingRequiredPropertyException("GetSchedulesSchedule", "projectId");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetSchedulesSchedule", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder systemTags(Map<String,String> systemTags) {
            if (systemTags == null) {
              throw new MissingRequiredPropertyException("GetSchedulesSchedule", "systemTags");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetSchedulesSchedule", "timeCreated");
            }
        ...
        public Builder timeLastScheduleRun(String timeLastScheduleRun) {
            if (timeLastScheduleRun == null) {
              throw new MissingRequiredPropertyException("GetSchedulesSchedule", "timeLastScheduleRun");
            }
        ...
        public Builder timeNextScheduledRun(String timeNextScheduledRun) {
            if (timeNextScheduledRun == null) {
              throw new MissingRequiredPropertyException("GetSchedulesSchedule", "timeNextScheduledRun");
            }
        ...
        public Builder timeUpdated(String timeUpdated) {
            if (timeUpdated == null) {
              throw new MissingRequiredPropertyException("GetSchedulesSchedule", "timeUpdated");
            }
            this.timeUpdated = timeUpdated;
            return this;
        }
        @CustomType.Setter
        public Builder triggers(List<GetSchedulesScheduleTrigger> triggers) {
            if (triggers == null) {
              throw new MissingRequiredPropertyException("GetSchedulesSchedule", "triggers");
            }
            this.triggers = triggers;
            return this;
        }
        public Builder triggers(GetSchedulesScheduleTrigger... triggers) {
