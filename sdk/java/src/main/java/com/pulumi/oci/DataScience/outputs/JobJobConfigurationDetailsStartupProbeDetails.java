...
@CustomType
public final class JobJobConfigurationDetailsStartupProbeDetails {
    /**
    ...
    public static Builder builder(JobJobConfigurationDetailsStartupProbeDetails defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer periodInSeconds;
        public Builder() {}
        public Builder(JobJobConfigurationDetailsStartupProbeDetails defaults) {
        ...
        public Builder commands(List<String> commands) {
            if (commands == null) {
              throw new MissingRequiredPropertyException("JobJobConfigurationDetailsStartupProbeDetails", "commands");
            }
        ...
        public Builder jobProbeCheckType(String jobProbeCheckType) {
            if (jobProbeCheckType == null) {
              throw new MissingRequiredPropertyException("JobJobConfigurationDetailsStartupProbeDetails", "jobProbeCheckType");
            }
        ...
        public JobJobConfigurationDetailsStartupProbeDetails build() {
            final var _resultValue = new JobJobConfigurationDetailsStartupProbeDetails();
