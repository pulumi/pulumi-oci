...
@CustomType
public final class JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobEnvironmentConfigurationDetails {
    /**
    ...
    private JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobEnvironmentConfigurationDetails() {}
    /**
     * @return The container image run [CMD](https://docs.docker.com/engine/reference/builder/#cmd) as a list of strings. Use `CMD` as arguments to the `ENTRYPOINT` or the only command to run in the absence of an `ENTRYPOINT`. The combined size of `CMD` and `ENTRYPOINT` must be less than 2048 bytes.
     * 
     */
    ...
    public static Builder builder(JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobEnvironmentConfigurationDetails defaults) {
    ...
    public static final class Builder {
        ...
        private String jobEnvironmentType;
        public Builder() {}
        public Builder(JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobEnvironmentConfigurationDetails defaults) {
        ...
        public Builder image(String image) {
            if (image == null) {
              throw new MissingRequiredPropertyException("JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobEnvironmentConfigurationDetails", "image");
            }
            this.image = image;
            return this;
        }
        ...
        public Builder jobEnvironmentType(String jobEnvironmentType) {
            if (jobEnvironmentType == null) {
              throw new MissingRequiredPropertyException("JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobEnvironmentConfigurationDetails", "jobEnvironmentType");
            }
            this.jobEnvironmentType = jobEnvironmentType;
            return this;
        }
        public JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobEnvironmentConfigurationDetails build() {
            final var _resultValue = new JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobEnvironmentConfigurationDetails();
