...
@CustomType
public final class JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetails {
    /**
    ...
    public static Builder builder(JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetails defaults) {
    ...
    public static final class Builder {
        ...
        public Builder jobInfrastructureType(String jobInfrastructureType) {
            if (jobInfrastructureType == null) {
              throw new MissingRequiredPropertyException("JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetails", "jobInfrastructureType");
            }
            this.jobInfrastructureType = jobInfrastructureType;
            return this;
        }
        @CustomType.Setter
        public Builder jobShapeConfigDetails(@Nullable JobJobNodeConfigurationDetailsJobNodeGroupConfigurationDetailsListJobInfrastructureConfigurationDetailsJobShapeConfigDetails jobShapeConfigDetails) {
