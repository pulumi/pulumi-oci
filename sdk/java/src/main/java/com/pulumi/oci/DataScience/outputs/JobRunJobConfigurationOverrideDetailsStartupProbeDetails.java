...
@CustomType
public final class JobRunJobConfigurationOverrideDetailsStartupProbeDetails {
    /**
    ...
    private JobRunJobConfigurationOverrideDetailsStartupProbeDetails() {}
    /**
     * @return The commands to run in the target job run to perform the startup probe
     * 
     */
    ...
    public static Builder builder(JobRunJobConfigurationOverrideDetailsStartupProbeDetails defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer periodInSeconds;
        public Builder() {}
        public Builder(JobRunJobConfigurationOverrideDetailsStartupProbeDetails defaults) {
        ...
        public Builder commands(List<String> commands) {
            if (commands == null) {
              throw new MissingRequiredPropertyException("JobRunJobConfigurationOverrideDetailsStartupProbeDetails", "commands");
            }
        ...
        public Builder jobProbeCheckType(String jobProbeCheckType) {
            if (jobProbeCheckType == null) {
              throw new MissingRequiredPropertyException("JobRunJobConfigurationOverrideDetailsStartupProbeDetails", "jobProbeCheckType");
            }
        ...
        public JobRunJobConfigurationOverrideDetailsStartupProbeDetails build() {
            final var _resultValue = new JobRunJobConfigurationOverrideDetailsStartupProbeDetails();
