...
@CustomType
public final class JobRunJobInfrastructureConfigurationDetailJobShapeConfigDetail {
    /**
    ...
    private JobRunJobInfrastructureConfigurationDetailJobShapeConfigDetail(
    ...
    public static Builder builder(JobRunJobInfrastructureConfigurationDetailJobShapeConfigDetail defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(JobRunJobInfrastructureConfigurationDetailJobShapeConfigDetail defaults) {
        ...
        public Builder ocpus(@Nullable Double ocpus) {
            this.ocpus = ocpus;
            return this;
        }        public JobRunJobInfrastructureConfigurationDetailJobShapeConfigDetail build() {
            return new JobRunJobInfrastructureConfigurationDetailJobShapeConfigDetail(memoryInGbs, ocpus);
        }
    }
}
