...
@CustomType
public final class MlApplicationImplementationLoggingImplementationLog {
    /**
    ...
    private MlApplicationImplementationLoggingImplementationLog() {}
    /**
     * @return (Updatable) If logging is enabled.
     * 
     */
    ...
    public static Builder builder(MlApplicationImplementationLoggingImplementationLog defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String logId;
        public Builder() {}
        public Builder(MlApplicationImplementationLoggingImplementationLog defaults) {
        ...
        public MlApplicationImplementationLoggingImplementationLog build() {
            final var _resultValue = new MlApplicationImplementationLoggingImplementationLog();
