...
public final class ModelDeploymentCategoryLogDetailsAccess {
    ...
    public static final class Builder {
        ...
        public Builder logGroupId(String logGroupId) {
            if (logGroupId == null) {
              throw new MissingRequiredPropertyException("ModelDeploymentCategoryLogDetailsAccess", "logGroupId");
            }
        ...
        public Builder logId(String logId) {
            if (logId == null) {
              throw new MissingRequiredPropertyException("ModelDeploymentCategoryLogDetailsAccess", "logId");
            }
            this.logId = logId;
            return this;
        }
