...
@CustomType
public final class PipelineRunStepOverrideDetailStepConfigurationDetails {
    /**
    ...
    private PipelineRunStepOverrideDetailStepConfigurationDetails() {}
    /**
     * @return The command line arguments to set for step.
     * 
     */
    ...
    public static Builder builder(PipelineRunStepOverrideDetailStepConfigurationDetails defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String maximumRuntimeInMinutes;
        public Builder() {}
        public Builder(PipelineRunStepOverrideDetailStepConfigurationDetails defaults) {
