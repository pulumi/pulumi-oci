...
@CustomType
public final class PipelineRunStepOverrideDetailStepStorageMountConfigurationDetailsList {
    /**
    ...
    private PipelineRunStepOverrideDetailStepStorageMountConfigurationDetailsList() {}
    /**
     * @return The object storage bucket
     * 
     */
    ...
    public static Builder builder(PipelineRunStepOverrideDetailStepStorageMountConfigurationDetailsList defaults) {
    ...
    public static final class Builder {
        ...
        private String storageType;
        public Builder() {}
        public Builder(PipelineRunStepOverrideDetailStepStorageMountConfigurationDetailsList defaults) {
        ...
        public Builder destinationDirectoryName(String destinationDirectoryName) {
            if (destinationDirectoryName == null) {
              throw new MissingRequiredPropertyException("PipelineRunStepOverrideDetailStepStorageMountConfigurationDetailsList", "destinationDirectoryName");
            }
        ...
        public Builder storageType(String storageType) {
            if (storageType == null) {
              throw new MissingRequiredPropertyException("PipelineRunStepOverrideDetailStepStorageMountConfigurationDetailsList", "storageType");
            }
            this.storageType = storageType;
            return this;
        }
        public PipelineRunStepOverrideDetailStepStorageMountConfigurationDetailsList build() {
            final var _resultValue = new PipelineRunStepOverrideDetailStepStorageMountConfigurationDetailsList();
