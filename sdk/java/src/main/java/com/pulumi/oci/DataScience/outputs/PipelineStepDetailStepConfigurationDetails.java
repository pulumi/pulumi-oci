...
@CustomType
public final class PipelineStepDetailStepConfigurationDetails {
    /**
    ...
    public static Builder builder(PipelineStepDetailStepConfigurationDetails defaults) {
    ...
    public static final class Builder {
        ...
        public PipelineStepDetailStepConfigurationDetails build() {
            final var _resultValue = new PipelineStepDetailStepConfigurationDetails();
