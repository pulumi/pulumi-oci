...
@CustomType
public final class PipelineStepDetailStepStorageMountConfigurationDetailsList {
    /**
    ...
    private PipelineStepDetailStepStorageMountConfigurationDetailsList() {}
    /**
     * @return (Updatable) The object storage bucket
     * 
     */
    ...
    public static Builder builder(PipelineStepDetailStepStorageMountConfigurationDetailsList defaults) {
    ...
    public static final class Builder {
        ...
        private String storageType;
        public Builder() {}
        public Builder(PipelineStepDetailStepStorageMountConfigurationDetailsList defaults) {
        ...
        public Builder destinationDirectoryName(String destinationDirectoryName) {
            if (destinationDirectoryName == null) {
              throw new MissingRequiredPropertyException("PipelineStepDetailStepStorageMountConfigurationDetailsList", "destinationDirectoryName");
            }
        ...
        public Builder storageType(String storageType) {
            if (storageType == null) {
              throw new MissingRequiredPropertyException("PipelineStepDetailStepStorageMountConfigurationDetailsList", "storageType");
            }
            this.storageType = storageType;
            return this;
        }
        public PipelineStepDetailStepStorageMountConfigurationDetailsList build() {
            final var _resultValue = new PipelineStepDetailStepStorageMountConfigurationDetailsList();
