...
@CustomType
public final class ScheduleActionActionDetailsCreatePipelineRunDetailsConfigurationOverrideDetails {
    /**
    ...
    public static Builder builder(ScheduleActionActionDetailsCreatePipelineRunDetailsConfigurationOverrideDetails defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(ScheduleActionActionDetailsCreatePipelineRunDetailsConfigurationOverrideDetails defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("ScheduleActionActionDetailsCreatePipelineRunDetailsConfigurationOverrideDetails", "type");
            }
            this.type = type;
            return this;
        }
        public ScheduleActionActionDetailsCreatePipelineRunDetailsConfigurationOverrideDetails build() {
            final var _resultValue = new ScheduleActionActionDetailsCreatePipelineRunDetailsConfigurationOverrideDetails();
