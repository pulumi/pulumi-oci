...
public class AutonomousVmClusterSslCertificateManagement extends com.pulumi.resources.CustomResource {
     ...
     */
    public AutonomousVmClusterSslCertificateManagement(java.lang.String name) {
     ...
     */
    public AutonomousVmClusterSslCertificateManagement(java.lang.String name, AutonomousVmClusterSslCertificateManagementArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AutonomousVmClusterSslCertificateManagement(java.lang.String name, AutonomousVmClusterSslCertificateManagementArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Database/autonomousVmClusterSslCertificateManagement:AutonomousVmClusterSslCertificateManagement", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AutonomousVmClusterSslCertificateManagement(java.lang.String name, Output<java.lang.String> id, @Nullable AutonomousVmClusterSslCertificateManagementState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Database/autonomousVmClusterSslCertificateManagement:AutonomousVmClusterSslCertificateManagement", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static AutonomousVmClusterSslCertificateManagement get(java.lang.String name, Output<java.lang.String> id, @Nullable AutonomousVmClusterSslCertificateManagementState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
