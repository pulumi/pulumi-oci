...
public final class AutonomousVmClusterSslCertificateManagementArgs extends com.pulumi.resources.ResourceArgs {

    public static final AutonomousVmClusterSslCertificateManagementArgs Empty = new AutonomousVmClusterSslCertificateManagementArgs();
    ...
    private AutonomousVmClusterSslCertificateManagementArgs() {}

    private AutonomousVmClusterSslCertificateManagementArgs(AutonomousVmClusterSslCertificateManagementArgs $) {
    ...
    public static Builder builder(AutonomousVmClusterSslCertificateManagementArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AutonomousVmClusterSslCertificateManagementArgs();
        }

        public Builder(AutonomousVmClusterSslCertificateManagementArgs defaults) {
            $ = new AutonomousVmClusterSslCertificateManagementArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AutonomousVmClusterSslCertificateManagementArgs build() {
            if ($.autonomousVmClusterId == null) {
                throw new MissingRequiredPropertyException("AutonomousVmClusterSslCertificateManagementArgs", "autonomousVmClusterId");
            }
            if ($.certificateGenerationType == null) {
                throw new MissingRequiredPropertyException("AutonomousVmClusterSslCertificateManagementArgs", "certificateGenerationType");
            }
            return $;
        }
    }
