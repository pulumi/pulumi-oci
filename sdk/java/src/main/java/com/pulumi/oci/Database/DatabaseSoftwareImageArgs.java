    ...
    public static final class Builder {
        ...
        public DatabaseSoftwareImageArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("DatabaseSoftwareImageArgs", "compartmentId");
            }
            if ($.displayName == null) {
                throw new MissingRequiredPropertyException("DatabaseSoftwareImageArgs", "displayName");
            }
            return $;
        }
    }
