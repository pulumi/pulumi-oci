...
public class DbNodeConsoleHistory extends com.pulumi.resources.CustomResource {
    ...
    public DbNodeConsoleHistory(String name, DbNodeConsoleHistoryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Database/dbNodeConsoleHistory:DbNodeConsoleHistory", name, args == null ? DbNodeConsoleHistoryArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
