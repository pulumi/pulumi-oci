    ...
    public static final class Builder {
        ...
        public ExadataInfrastructureStorageArgs build() {
            if ($.adminNetworkCidr == null) {
                throw new MissingRequiredPropertyException("ExadataInfrastructureStorageArgs", "adminNetworkCidr");
            }
            if ($.cloudControlPlaneServer1 == null) {
                throw new MissingRequiredPropertyException("ExadataInfrastructureStorageArgs", "cloudControlPlaneServer1");
            }
            if ($.cloudControlPlaneServer2 == null) {
                throw new MissingRequiredPropertyException("ExadataInfrastructureStorageArgs", "cloudControlPlaneServer2");
            }
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("ExadataInfrastructureStorageArgs", "compartmentId");
            }
            if ($.displayName == null) {
                throw new MissingRequiredPropertyException("ExadataInfrastructureStorageArgs", "displayName");
            }
            if ($.dnsServers == null) {
                throw new MissingRequiredPropertyException("ExadataInfrastructureStorageArgs", "dnsServers");
            }
            if ($.gateway == null) {
                throw new MissingRequiredPropertyException("ExadataInfrastructureStorageArgs", "gateway");
            }
            if ($.infiniBandNetworkCidr == null) {
                throw new MissingRequiredPropertyException("ExadataInfrastructureStorageArgs", "infiniBandNetworkCidr");
            }
            if ($.netmask == null) {
                throw new MissingRequiredPropertyException("ExadataInfrastructureStorageArgs", "netmask");
            }
            if ($.ntpServers == null) {
                throw new MissingRequiredPropertyException("ExadataInfrastructureStorageArgs", "ntpServers");
            }
            if ($.shape == null) {
                throw new MissingRequiredPropertyException("ExadataInfrastructureStorageArgs", "shape");
            }
            if ($.timeZone == null) {
                throw new MissingRequiredPropertyException("ExadataInfrastructureStorageArgs", "timeZone");
            }
            return $;
        }
    }
