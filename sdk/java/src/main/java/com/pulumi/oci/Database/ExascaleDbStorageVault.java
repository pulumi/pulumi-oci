...
public class ExascaleDbStorageVault extends com.pulumi.resources.CustomResource {
     ...
     */
    public ExascaleDbStorageVault(String name) {
     ...
     */
    public static ExascaleDbStorageVault get(String name, Output<String> id, @Nullable ExascaleDbStorageVaultState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
