...
public class ExternalNonContainerDatabase extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    public Output<List<ExternalNonContainerDatabaseDatabaseManagementConfig>> databaseManagementConfigs() {
     ...
     */
    public ExternalNonContainerDatabase(java.lang.String name) {
     ...
     */
    public ExternalNonContainerDatabase(java.lang.String name, ExternalNonContainerDatabaseArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ExternalNonContainerDatabase(java.lang.String name, ExternalNonContainerDatabaseArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Database/externalNonContainerDatabase:ExternalNonContainerDatabase", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ExternalNonContainerDatabase(java.lang.String name, Output<java.lang.String> id, @Nullable ExternalNonContainerDatabaseState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Database/externalNonContainerDatabase:ExternalNonContainerDatabase", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ExternalNonContainerDatabase get(java.lang.String name, Output<java.lang.String> id, @Nullable ExternalNonContainerDatabaseState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
