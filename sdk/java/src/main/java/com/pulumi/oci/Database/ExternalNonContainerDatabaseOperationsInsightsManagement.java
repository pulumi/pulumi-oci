...
public class ExternalNonContainerDatabaseOperationsInsightsManagement extends com.pulumi.resources.CustomResource {
     ...
     */
    public ExternalNonContainerDatabaseOperationsInsightsManagement(java.lang.String name) {
     ...
     */
    public ExternalNonContainerDatabaseOperationsInsightsManagement(java.lang.String name, ExternalNonContainerDatabaseOperationsInsightsManagementArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ExternalNonContainerDatabaseOperationsInsightsManagement(java.lang.String name, ExternalNonContainerDatabaseOperationsInsightsManagementArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Database/externalNonContainerDatabaseOperationsInsightsManagement:ExternalNonContainerDatabaseOperationsInsightsManagement", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ExternalNonContainerDatabaseOperationsInsightsManagement(java.lang.String name, Output<java.lang.String> id, @Nullable ExternalNonContainerDatabaseOperationsInsightsManagementState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Database/externalNonContainerDatabaseOperationsInsightsManagement:ExternalNonContainerDatabaseOperationsInsightsManagement", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ExternalNonContainerDatabaseOperationsInsightsManagement get(java.lang.String name, Output<java.lang.String> id, @Nullable ExternalNonContainerDatabaseOperationsInsightsManagementState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
