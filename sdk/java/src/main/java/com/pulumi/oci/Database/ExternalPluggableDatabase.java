...
public class ExternalPluggableDatabase extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ List<ExternalPluggableDatabaseDatabaseManagementConfig>> databaseManagementConfigs;

    /**
     * @return The configuration of the Database Management service.
     * 
     */
    public Output<Optional<List<ExternalPluggableDatabaseDatabaseManagementConfig>>> databaseManagementConfigs() {
    ...
    private Output</* @Nullable */ List<ExternalPluggableDatabaseOperationsInsightsConfig>> operationsInsightsConfigs;

    /**
     * @return The configuration of Operations Insights for the external database
     * 
     */
    public Output<Optional<List<ExternalPluggableDatabaseOperationsInsightsConfig>>> operationsInsightsConfigs() {
    ...
    private Output</* @Nullable */ List<ExternalPluggableDatabaseStackMonitoringConfig>> stackMonitoringConfigs;

    /**
     * @return The configuration of Stack Monitoring for the external database.
     * 
     */
    public Output<Optional<List<ExternalPluggableDatabaseStackMonitoringConfig>>> stackMonitoringConfigs() {
