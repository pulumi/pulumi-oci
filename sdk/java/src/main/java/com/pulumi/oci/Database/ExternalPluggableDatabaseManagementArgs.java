    ...
    public static final class Builder {
        ...
        public ExternalPluggableDatabaseManagementArgs build() {
            if ($.enableManagement == null) {
                throw new MissingRequiredPropertyException("ExternalPluggableDatabaseManagementArgs", "enableManagement");
            }
            if ($.externalDatabaseConnectorId == null) {
                throw new MissingRequiredPropertyException("ExternalPluggableDatabaseManagementArgs", "externalDatabaseConnectorId");
            }
            if ($.externalPluggableDatabaseId == null) {
                throw new MissingRequiredPropertyException("ExternalPluggableDatabaseManagementArgs", "externalPluggableDatabaseId");
            }
            return $;
        }
    }
