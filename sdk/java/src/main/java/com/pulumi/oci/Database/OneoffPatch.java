...
public class OneoffPatch extends com.pulumi.resources.CustomResource {
     ...
     */
    public OneoffPatch(String name) {
     ...
     */
    public static OneoffPatch get(String name, Output<String> id, @Nullable OneoffPatchState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
