...
public class PluggableDatabasesLocalClone extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ List<PluggableDatabasesLocalCloneConnectionString>> connectionStrings;

    /**
     * @return Connection strings to connect to an Oracle Pluggable Database.
     * 
     */
    public Output<Optional<List<PluggableDatabasesLocalCloneConnectionString>>> connectionStrings() {
    ...
    private Output</* @Nullable */ List<PluggableDatabasesLocalClonePdbNodeLevelDetail>> pdbNodeLevelDetails;
     ...
     * 
     */
    public Output<Optional<List<PluggableDatabasesLocalClonePdbNodeLevelDetail>>> pdbNodeLevelDetails() {
    ...
    private Output</* @Nullable */ List<PluggableDatabasesLocalClonePluggableDatabaseManagementConfig>> pluggableDatabaseManagementConfigs;

    /**
     * @return The configuration of the Pluggable Database Management service.
     * 
     */
    public Output<Optional<List<PluggableDatabasesLocalClonePluggableDatabaseManagementConfig>>> pluggableDatabaseManagementConfigs() {
    ...
    private Output</* @Nullable */ List<PluggableDatabasesLocalCloneRefreshableCloneConfig>> refreshableCloneConfigs;

    /**
     * @return Pluggable Database Refreshable Clone Configuration.
     * 
     */
    public Output<Optional<List<PluggableDatabasesLocalCloneRefreshableCloneConfig>>> refreshableCloneConfigs() {
