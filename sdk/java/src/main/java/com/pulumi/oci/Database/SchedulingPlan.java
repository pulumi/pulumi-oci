...
import com.pulumi.oci.Database.inputs.SchedulingPlanState;
 ...
 * 
 */
@ResourceType(type="oci:Database/schedulingPlan:SchedulingPlan")
public class SchedulingPlan extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="isUsingRecommendedScheduledActions", refs={Boolean.class}, tree="[0]")
    private Output<Boolean> isUsingRecommendedScheduledActions;

    /**
     * @return If true, recommended scheduled actions will be generated for the scheduling plan.
     * 
     */
    public Output<Boolean> isUsingRecommendedScheduledActions() {
     ...
     * 
     */
    @Export(name="planIntent", refs={String.class}, tree="[0]")
     ...
     */
    public SchedulingPlan(java.lang.String name) {
        this(name, SchedulingPlanArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public SchedulingPlan(java.lang.String name, SchedulingPlanArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public SchedulingPlan(java.lang.String name, SchedulingPlanArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Database/schedulingPlan:SchedulingPlan", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private SchedulingPlan(java.lang.String name, Output<java.lang.String> id, @Nullable SchedulingPlanState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Database/schedulingPlan:SchedulingPlan", name, state, makeResourceOptions(options, id), false);
    }

    private static SchedulingPlanArgs makeArgs(SchedulingPlanArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? SchedulingPlanArgs.Empty : args;
    }
     ...
     */
    public static SchedulingPlan get(java.lang.String name, Output<java.lang.String> id, @Nullable SchedulingPlanState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
