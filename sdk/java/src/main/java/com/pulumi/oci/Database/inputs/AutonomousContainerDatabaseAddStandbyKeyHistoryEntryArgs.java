...
public final class AutonomousContainerDatabaseAddStandbyKeyHistoryEntryArgs extends com.pulumi.resources.ResourceArgs {

    public static final AutonomousContainerDatabaseAddStandbyKeyHistoryEntryArgs Empty = new AutonomousContainerDatabaseAddStandbyKeyHistoryEntryArgs();
    ...
    private AutonomousContainerDatabaseAddStandbyKeyHistoryEntryArgs() {}

    private AutonomousContainerDatabaseAddStandbyKeyHistoryEntryArgs(AutonomousContainerDatabaseAddStandbyKeyHistoryEntryArgs $) {
        this.id = $.id;
    ...
    public static Builder builder(AutonomousContainerDatabaseAddStandbyKeyHistoryEntryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AutonomousContainerDatabaseAddStandbyKeyHistoryEntryArgs();
        }

        public Builder(AutonomousContainerDatabaseAddStandbyKeyHistoryEntryArgs defaults) {
            $ = new AutonomousContainerDatabaseAddStandbyKeyHistoryEntryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AutonomousContainerDatabaseAddStandbyKeyHistoryEntryArgs build() {
            return $;
        }
    }
