...
import com.pulumi.oci.Database.inputs.AutonomousContainerDatabaseAddStandbyMaintenanceWindowDaysOfWeekArgs;
import com.pulumi.oci.Database.inputs.AutonomousContainerDatabaseAddStandbyMaintenanceWindowMonthArgs;
...
public final class AutonomousContainerDatabaseAddStandbyMaintenanceWindowArgs extends com.pulumi.resources.ResourceArgs {

    public static final AutonomousContainerDatabaseAddStandbyMaintenanceWindowArgs Empty = new AutonomousContainerDatabaseAddStandbyMaintenanceWindowArgs();
    ...
    private @Nullable Output<List<AutonomousContainerDatabaseAddStandbyMaintenanceWindowDaysOfWeekArgs>> daysOfWeeks;

    /**
     * @return Days during the week when maintenance should be performed.
     * 
     */
    public Optional<Output<List<AutonomousContainerDatabaseAddStandbyMaintenanceWindowDaysOfWeekArgs>>> daysOfWeeks() {
     ...
     */
    @Import(name="months")
    private @Nullable Output<List<AutonomousContainerDatabaseAddStandbyMaintenanceWindowMonthArgs>> months;

    /**
     * @return Months during the year when maintenance should be performed.
     * 
     */
    public Optional<Output<List<AutonomousContainerDatabaseAddStandbyMaintenanceWindowMonthArgs>>> months() {
    ...
    private AutonomousContainerDatabaseAddStandbyMaintenanceWindowArgs() {}

    private AutonomousContainerDatabaseAddStandbyMaintenanceWindowArgs(AutonomousContainerDatabaseAddStandbyMaintenanceWindowArgs $) {
    ...
    public static Builder builder(AutonomousContainerDatabaseAddStandbyMaintenanceWindowArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AutonomousContainerDatabaseAddStandbyMaintenanceWindowArgs();
        }

        public Builder(AutonomousContainerDatabaseAddStandbyMaintenanceWindowArgs defaults) {
            $ = new AutonomousContainerDatabaseAddStandbyMaintenanceWindowArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder daysOfWeeks(@Nullable Output<List<AutonomousContainerDatabaseAddStandbyMaintenanceWindowDaysOfWeekArgs>> daysOfWeeks) {
         ...
         * 
         */
        public Builder daysOfWeeks(List<AutonomousContainerDatabaseAddStandbyMaintenanceWindowDaysOfWeekArgs> daysOfWeeks) {
         ...
         * 
         */
        public Builder daysOfWeeks(AutonomousContainerDatabaseAddStandbyMaintenanceWindowDaysOfWeekArgs... daysOfWeeks) {
         ...
         * 
         */
        public Builder months(@Nullable Output<List<AutonomousContainerDatabaseAddStandbyMaintenanceWindowMonthArgs>> months) {
            $.months = months;
            return this;
        }
         ...
         * 
         */
        public Builder months(List<AutonomousContainerDatabaseAddStandbyMaintenanceWindowMonthArgs> months) {
         ...
         * 
         */
        public Builder months(AutonomousContainerDatabaseAddStandbyMaintenanceWindowMonthArgs... months) {
        ...
        public AutonomousContainerDatabaseAddStandbyMaintenanceWindowArgs build() {
            return $;
        }
    }
