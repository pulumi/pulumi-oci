...
public final class AutonomousContainerDatabaseDataguardArgs extends com.pulumi.resources.ResourceArgs {

    public static final AutonomousContainerDatabaseDataguardArgs Empty = new AutonomousContainerDatabaseDataguardArgs();
    ...
    private AutonomousContainerDatabaseDataguardArgs() {}

    private AutonomousContainerDatabaseDataguardArgs(AutonomousContainerDatabaseDataguardArgs $) {
    ...
    public static Builder builder(AutonomousContainerDatabaseDataguardArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AutonomousContainerDatabaseDataguardArgs();
        }

        public Builder(AutonomousContainerDatabaseDataguardArgs defaults) {
            $ = new AutonomousContainerDatabaseDataguardArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param autonomousContainerDatabaseId The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Autonomous Container Database that has a relationship with the peer Autonomous Container Database. Used only by Autonomous AI Database on Dedicated Exadata Infrastructure.
         * 
         * @return builder
         * 
         */
        ...
        public AutonomousContainerDatabaseDataguardArgs build() {
            return $;
        }
    }
