...
public final class AutonomousContainerDatabaseKeyHistoryEntryArgs extends com.pulumi.resources.ResourceArgs {

    public static final AutonomousContainerDatabaseKeyHistoryEntryArgs Empty = new AutonomousContainerDatabaseKeyHistoryEntryArgs();
    ...
    private AutonomousContainerDatabaseKeyHistoryEntryArgs() {}

    private AutonomousContainerDatabaseKeyHistoryEntryArgs(AutonomousContainerDatabaseKeyHistoryEntryArgs $) {
        this.id = $.id;
    ...
    public static Builder builder(AutonomousContainerDatabaseKeyHistoryEntryArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AutonomousContainerDatabaseKeyHistoryEntryArgs();
        }

        public Builder(AutonomousContainerDatabaseKeyHistoryEntryArgs defaults) {
            $ = new AutonomousContainerDatabaseKeyHistoryEntryArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AutonomousContainerDatabaseKeyHistoryEntryArgs build() {
            return $;
        }
    }
