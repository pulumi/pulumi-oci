...
public final class AutonomousContainerDatabaseMaintenanceWindowDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AutonomousContainerDatabaseMaintenanceWindowDetailsArgs Empty = new AutonomousContainerDatabaseMaintenanceWindowDetailsArgs();
    ...
    private @Nullable Output<List<AutonomousContainerDatabaseMaintenanceWindowDetailsDaysOfWeekArgs>> daysOfWeeks;

    /**
     * @return (Updatable) Days during the week when maintenance should be performed.
     * 
     */
    public Optional<Output<List<AutonomousContainerDatabaseMaintenanceWindowDetailsDaysOfWeekArgs>>> daysOfWeeks() {
     ...
     */
    @Import(name="months")
    private @Nullable Output<List<AutonomousContainerDatabaseMaintenanceWindowDetailsMonthArgs>> months;

    /**
     * @return (Updatable) Months during the year when maintenance should be performed.
     * 
     */
    public Optional<Output<List<AutonomousContainerDatabaseMaintenanceWindowDetailsMonthArgs>>> months() {
    ...
    private AutonomousContainerDatabaseMaintenanceWindowDetailsArgs() {}

    private AutonomousContainerDatabaseMaintenanceWindowDetailsArgs(AutonomousContainerDatabaseMaintenanceWindowDetailsArgs $) {
    ...
    public static Builder builder(AutonomousContainerDatabaseMaintenanceWindowDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AutonomousContainerDatabaseMaintenanceWindowDetailsArgs();
        }

        public Builder(AutonomousContainerDatabaseMaintenanceWindowDetailsArgs defaults) {
            $ = new AutonomousContainerDatabaseMaintenanceWindowDetailsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder daysOfWeeks(@Nullable Output<List<AutonomousContainerDatabaseMaintenanceWindowDetailsDaysOfWeekArgs>> daysOfWeeks) {
         ...
         * 
         */
        public Builder daysOfWeeks(List<AutonomousContainerDatabaseMaintenanceWindowDetailsDaysOfWeekArgs> daysOfWeeks) {
         ...
         * 
         */
        public Builder daysOfWeeks(AutonomousContainerDatabaseMaintenanceWindowDetailsDaysOfWeekArgs... daysOfWeeks) {
            return daysOfWeeks(List.of(daysOfWeeks));
        }

        /**
         * @param hoursOfDays (Updatable) The window of hours during the day when maintenance should be performed. The window is a 4 hour slot. Valid values are - 0 - represents time slot 0:00 - 3:59 UTC - 4 - represents time slot 4:00 - 7:59 UTC - 8 - represents time slot 8:00 - 11:59 UTC - 12 - represents time slot 12:00 - 15:59 UTC - 16 - represents time slot 16:00 - 19:59 UTC - 20 - represents time slot 20:00 - 23:59 UTC
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder months(@Nullable Output<List<AutonomousContainerDatabaseMaintenanceWindowDetailsMonthArgs>> months) {
            $.months = months;
            return this;
        }
         ...
         * 
         */
        public Builder months(List<AutonomousContainerDatabaseMaintenanceWindowDetailsMonthArgs> months) {
         ...
         * 
         */
        public Builder months(AutonomousContainerDatabaseMaintenanceWindowDetailsMonthArgs... months) {
        ...
        public AutonomousContainerDatabaseMaintenanceWindowDetailsArgs build() {
            return $;
        }
    }
