...
public final class AutonomousDatabaseBackupBackupDestinationDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AutonomousDatabaseBackupBackupDestinationDetailsArgs Empty = new AutonomousDatabaseBackupBackupDestinationDetailsArgs();
    ...
    private AutonomousDatabaseBackupBackupDestinationDetailsArgs() {}

    private AutonomousDatabaseBackupBackupDestinationDetailsArgs(AutonomousDatabaseBackupBackupDestinationDetailsArgs $) {
        this.id = $.id;
    ...
    public static Builder builder(AutonomousDatabaseBackupBackupDestinationDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AutonomousDatabaseBackupBackupDestinationDetailsArgs();
        }

        public Builder(AutonomousDatabaseBackupBackupDestinationDetailsArgs defaults) {
            $ = new AutonomousDatabaseBackupBackupDestinationDetailsArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param id The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Autonomous Database backup.
         * 
         * @return builder
         * 
         */
