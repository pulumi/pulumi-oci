...
public final class CloudExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfigurationArgs extends com.pulumi.resources.ResourceArgs {

    public static final CloudExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfigurationArgs Empty = new CloudExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfigurationArgs();
    ...
    private CloudExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfigurationArgs() {}

    private CloudExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfigurationArgs(CloudExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfigurationArgs $) {
    ...
    public static Builder builder(CloudExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfigurationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CloudExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfigurationArgs();
        }

        public Builder(CloudExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfigurationArgs defaults) {
            $ = new CloudExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfigurationArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CloudExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfigurationArgs build() {
            return $;
        }
    }
