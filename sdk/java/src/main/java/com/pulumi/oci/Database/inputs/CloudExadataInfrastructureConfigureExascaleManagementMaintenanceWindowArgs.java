...
import com.pulumi.oci.Database.inputs.CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowDaysOfWeekArgs;
import com.pulumi.oci.Database.inputs.CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowMonthArgs;
...
public final class CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs extends com.pulumi.resources.ResourceArgs {

    public static final CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs Empty = new CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs();
    ...
    private @Nullable Output<List<CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowDaysOfWeekArgs>> daysOfWeeks;

    /**
     * @return Days during the week when maintenance should be performed.
     * 
     */
    public Optional<Output<List<CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowDaysOfWeekArgs>>> daysOfWeeks() {
     ...
     */
    @Import(name="months")
    private @Nullable Output<List<CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowMonthArgs>> months;

    /**
     * @return Months during the year when maintenance should be performed.
     * 
     */
    public Optional<Output<List<CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowMonthArgs>>> months() {
    ...
    private CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs() {}

    private CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs(CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs $) {
    ...
    public static Builder builder(CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs();
        }

        public Builder(CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs defaults) {
            $ = new CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder daysOfWeeks(@Nullable Output<List<CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowDaysOfWeekArgs>> daysOfWeeks) {
         ...
         * 
         */
        public Builder daysOfWeeks(List<CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowDaysOfWeekArgs> daysOfWeeks) {
         ...
         * 
         */
        public Builder daysOfWeeks(CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowDaysOfWeekArgs... daysOfWeeks) {
         ...
         * 
         */
        public Builder months(@Nullable Output<List<CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowMonthArgs>> months) {
            $.months = months;
            return this;
        }
         ...
         * 
         */
        public Builder months(List<CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowMonthArgs> months) {
         ...
         * 
         */
        public Builder months(CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowMonthArgs... months) {
        ...
        public CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs build() {
            return $;
        }
    }
