...
import com.pulumi.oci.Database.inputs.CloudVmClusterIormConfigCacheDbPlanArgs;
...
public final class CloudVmClusterIormConfigCacheArgs extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="dbPlans")
    private @Nullable Output<List<CloudVmClusterIormConfigCacheDbPlanArgs>> dbPlans;

    /**
     * @return An array of IORM settings for all the database in the Exadata DB system.
     * 
     */
    public Optional<Output<List<CloudVmClusterIormConfigCacheDbPlanArgs>>> dbPlans() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder dbPlans(@Nullable Output<List<CloudVmClusterIormConfigCacheDbPlanArgs>> dbPlans) {
            $.dbPlans = dbPlans;
            return this;
        }
