...
public final class DbSystemIormConfigCacheDbPlanArgs extends com.pulumi.resources.ResourceArgs {

    public static final DbSystemIormConfigCacheDbPlanArgs Empty = new DbSystemIormConfigCacheDbPlanArgs();
    ...
    private DbSystemIormConfigCacheDbPlanArgs() {}

    private DbSystemIormConfigCacheDbPlanArgs(DbSystemIormConfigCacheDbPlanArgs $) {
        this.dbName = $.dbName;
    ...
    public static Builder builder(DbSystemIormConfigCacheDbPlanArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DbSystemIormConfigCacheDbPlanArgs();
        }

        public Builder(DbSystemIormConfigCacheDbPlanArgs defaults) {
            $ = new DbSystemIormConfigCacheDbPlanArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DbSystemIormConfigCacheDbPlanArgs build() {
            return $;
        }
    }
