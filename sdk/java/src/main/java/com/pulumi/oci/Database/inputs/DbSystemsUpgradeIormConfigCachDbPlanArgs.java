...
public final class DbSystemsUpgradeIormConfigCachDbPlanArgs extends com.pulumi.resources.ResourceArgs {

    public static final DbSystemsUpgradeIormConfigCachDbPlanArgs Empty = new DbSystemsUpgradeIormConfigCachDbPlanArgs();
    ...
    private DbSystemsUpgradeIormConfigCachDbPlanArgs() {}

    private DbSystemsUpgradeIormConfigCachDbPlanArgs(DbSystemsUpgradeIormConfigCachDbPlanArgs $) {
        this.dbName = $.dbName;
    ...
    public static Builder builder(DbSystemsUpgradeIormConfigCachDbPlanArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DbSystemsUpgradeIormConfigCachDbPlanArgs();
        }

        public Builder(DbSystemsUpgradeIormConfigCachDbPlanArgs defaults) {
            $ = new DbSystemsUpgradeIormConfigCachDbPlanArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DbSystemsUpgradeIormConfigCachDbPlanArgs build() {
            return $;
        }
    }
