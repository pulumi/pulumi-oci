...
public final class DbSystemsUpgradeIormConfigCacheDbPlanArgs extends com.pulumi.resources.ResourceArgs {

    public static final DbSystemsUpgradeIormConfigCacheDbPlanArgs Empty = new DbSystemsUpgradeIormConfigCacheDbPlanArgs();
    ...
    private DbSystemsUpgradeIormConfigCacheDbPlanArgs() {}

    private DbSystemsUpgradeIormConfigCacheDbPlanArgs(DbSystemsUpgradeIormConfigCacheDbPlanArgs $) {
        this.dbName = $.dbName;
    ...
    public static Builder builder(DbSystemsUpgradeIormConfigCacheDbPlanArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DbSystemsUpgradeIormConfigCacheDbPlanArgs();
        }

        public Builder(DbSystemsUpgradeIormConfigCacheDbPlanArgs defaults) {
            $ = new DbSystemsUpgradeIormConfigCacheDbPlanArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DbSystemsUpgradeIormConfigCacheDbPlanArgs build() {
            return $;
        }
    }
