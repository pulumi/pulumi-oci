...
import com.pulumi.oci.Database.inputs.ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowDaysOfWeekArgs;
import com.pulumi.oci.Database.inputs.ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowMonthArgs;
...
public final class ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs extends com.pulumi.resources.ResourceArgs {

    public static final ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs Empty = new ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs();
    ...
    private @Nullable Output<List<ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowDaysOfWeekArgs>> daysOfWeeks;

    /**
     * @return Days during the week when maintenance should be performed.
     * 
     */
    public Optional<Output<List<ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowDaysOfWeekArgs>>> daysOfWeeks() {
     ...
     */
    @Import(name="months")
    private @Nullable Output<List<ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowMonthArgs>> months;

    /**
     * @return Months during the year when maintenance should be performed.
     * 
     */
    public Optional<Output<List<ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowMonthArgs>>> months() {
    ...
    private ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs() {}

    private ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs(ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs $) {
    ...
    public static Builder builder(ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs();
        }

        public Builder(ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs defaults) {
            $ = new ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder daysOfWeeks(@Nullable Output<List<ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowDaysOfWeekArgs>> daysOfWeeks) {
         ...
         * 
         */
        public Builder daysOfWeeks(List<ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowDaysOfWeekArgs> daysOfWeeks) {
         ...
         * 
         */
        public Builder daysOfWeeks(ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowDaysOfWeekArgs... daysOfWeeks) {
         ...
         * 
         */
        public Builder months(@Nullable Output<List<ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowMonthArgs>> months) {
            $.months = months;
            return this;
        }
         ...
         * 
         */
        public Builder months(List<ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowMonthArgs> months) {
         ...
         * 
         */
        public Builder months(ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowMonthArgs... months) {
        ...
        public ExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs build() {
            return $;
        }
    }
