...
public final class ExadbVmClusterIormConfigCachDbPlanArgs extends com.pulumi.resources.ResourceArgs {

    public static final ExadbVmClusterIormConfigCachDbPlanArgs Empty = new ExadbVmClusterIormConfigCachDbPlanArgs();
    ...
    private ExadbVmClusterIormConfigCachDbPlanArgs() {}

    private ExadbVmClusterIormConfigCachDbPlanArgs(ExadbVmClusterIormConfigCachDbPlanArgs $) {
        this.dbName = $.dbName;
    ...
    public static Builder builder(ExadbVmClusterIormConfigCachDbPlanArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ExadbVmClusterIormConfigCachDbPlanArgs();
        }

        public Builder(ExadbVmClusterIormConfigCachDbPlanArgs defaults) {
            $ = new ExadbVmClusterIormConfigCachDbPlanArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ExadbVmClusterIormConfigCachDbPlanArgs build() {
            return $;
        }
    }
