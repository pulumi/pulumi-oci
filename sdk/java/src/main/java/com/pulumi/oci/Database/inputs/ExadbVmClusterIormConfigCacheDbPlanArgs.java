...
public final class ExadbVmClusterIormConfigCacheDbPlanArgs extends com.pulumi.resources.ResourceArgs {

    public static final ExadbVmClusterIormConfigCacheDbPlanArgs Empty = new ExadbVmClusterIormConfigCacheDbPlanArgs();
    ...
    private ExadbVmClusterIormConfigCacheDbPlanArgs() {}

    private ExadbVmClusterIormConfigCacheDbPlanArgs(ExadbVmClusterIormConfigCacheDbPlanArgs $) {
        this.dbName = $.dbName;
    ...
    public static Builder builder(ExadbVmClusterIormConfigCacheDbPlanArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ExadbVmClusterIormConfigCacheDbPlanArgs();
        }

        public Builder(ExadbVmClusterIormConfigCacheDbPlanArgs defaults) {
            $ = new ExadbVmClusterIormConfigCacheDbPlanArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ExadbVmClusterIormConfigCacheDbPlanArgs build() {
            return $;
        }
    }
