...
public final class ExternalContainerDatabaseDatabaseManagementConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final ExternalContainerDatabaseDatabaseManagementConfigArgs Empty = new ExternalContainerDatabaseDatabaseManagementConfigArgs();
    ...
    private ExternalContainerDatabaseDatabaseManagementConfigArgs() {}

    private ExternalContainerDatabaseDatabaseManagementConfigArgs(ExternalContainerDatabaseDatabaseManagementConfigArgs $) {
    ...
    public static Builder builder(ExternalContainerDatabaseDatabaseManagementConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ExternalContainerDatabaseDatabaseManagementConfigArgs();
        }

        public Builder(ExternalContainerDatabaseDatabaseManagementConfigArgs defaults) {
            $ = new ExternalContainerDatabaseDatabaseManagementConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ExternalContainerDatabaseDatabaseManagementConfigArgs build() {
            return $;
        }
    }
