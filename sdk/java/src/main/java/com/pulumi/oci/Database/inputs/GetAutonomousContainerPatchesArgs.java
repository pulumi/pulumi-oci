    ...
    public static final class Builder {
        ...
        public GetAutonomousContainerPatchesArgs build() {
            if ($.autonomousContainerDatabaseId == null) {
                throw new MissingRequiredPropertyException("GetAutonomousContainerPatchesArgs", "autonomousContainerDatabaseId");
            }
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetAutonomousContainerPatchesArgs", "compartmentId");
            }
            return $;
        }
    }
