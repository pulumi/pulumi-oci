...
public final class GetDbServerPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetDbServerPlainArgs build() {
            if ($.dbServerId == null) {
                throw new MissingRequiredPropertyException("GetDbServerPlainArgs", "dbServerId");
            }
            if ($.exadataInfrastructureId == null) {
                throw new MissingRequiredPropertyException("GetDbServerPlainArgs", "exadataInfrastructureId");
            }
            return $;
        }
    }
