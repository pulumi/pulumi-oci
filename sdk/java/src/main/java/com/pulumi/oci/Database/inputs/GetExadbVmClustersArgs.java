...
import com.pulumi.oci.Database.inputs.GetExadbVmClustersFilterArgs;
...
public final class GetExadbVmClustersArgs extends com.pulumi.resources.InvokeArgs {
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetExadbVmClustersFilterArgs>> filters;

    public Optional<Output<List<GetExadbVmClustersFilterArgs>>> filters() {
    ...
    public static Builder builder(GetExadbVmClustersArgs defaults) {
    ...
    public static final class Builder {
        ...
        /**
         * @param exascaleDbStorageVaultId A filter to return only Exadata VM clusters on Exascale Infrastructure that match the given Exascale Database Storage Vault ID.
         * 
         * @return builder
         * 
         */
        ...
        public Builder filters(@Nullable Output<List<GetExadbVmClustersFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetExadbVmClustersFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetExadbVmClustersFilterArgs... filters) {
            return filters(List.of(filters));
        }

        /**
         * @param state A filter to return only Exadata VM clusters on Exascale Infrastructure that match the given lifecycle state exactly.
         * 
         * @return builder
         * 
         */
        ...
        public GetExadbVmClustersArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetExadbVmClustersArgs", "compartmentId");
            }
            return $;
        }
    }
