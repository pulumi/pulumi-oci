...
public final class GetExascaleDbStorageVaultsPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public Optional<List<GetExascaleDbStorageVaultsFilter>> filters() {
    ...
    public static final class Builder {
        ...
        public GetExascaleDbStorageVaultsPlainArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetExascaleDbStorageVaultsPlainArgs", "compartmentId");
            }
            return $;
        }
    }
