    ...
    public static final class Builder {
        ...
        public GetExternalDatabaseConnectorsArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetExternalDatabaseConnectorsArgs", "compartmentId");
            }
            if ($.externalDatabaseId == null) {
                throw new MissingRequiredPropertyException("GetExternalDatabaseConnectorsArgs", "externalDatabaseId");
            }
            return $;
        }
    }
