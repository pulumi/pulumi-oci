    ...
    public static final class Builder {
        ...
        public GetVmClusterPatchHistoryEntryArgs build() {
            if ($.patchHistoryEntryId == null) {
                throw new MissingRequiredPropertyException("GetVmClusterPatchHistoryEntryArgs", "patchHistoryEntryId");
            }
            if ($.vmClusterId == null) {
                throw new MissingRequiredPropertyException("GetVmClusterPatchHistoryEntryArgs", "vmClusterId");
            }
            return $;
        }
    }
