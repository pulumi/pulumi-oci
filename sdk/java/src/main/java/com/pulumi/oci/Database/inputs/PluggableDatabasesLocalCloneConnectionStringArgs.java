...
public final class PluggableDatabasesLocalCloneConnectionStringArgs extends com.pulumi.resources.ResourceArgs {

    public static final PluggableDatabasesLocalCloneConnectionStringArgs Empty = new PluggableDatabasesLocalCloneConnectionStringArgs();
    ...
    private PluggableDatabasesLocalCloneConnectionStringArgs() {}

    private PluggableDatabasesLocalCloneConnectionStringArgs(PluggableDatabasesLocalCloneConnectionStringArgs $) {
    ...
    public static Builder builder(PluggableDatabasesLocalCloneConnectionStringArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PluggableDatabasesLocalCloneConnectionStringArgs();
        }

        public Builder(PluggableDatabasesLocalCloneConnectionStringArgs defaults) {
            $ = new PluggableDatabasesLocalCloneConnectionStringArgs(Objects.requireNonNull(defaults));
        }
        ...
        public PluggableDatabasesLocalCloneConnectionStringArgs build() {
            return $;
        }
    }
