...
@CustomType
public final class AutonomousContainerDatabaseAddStandbyEncryptionKeyLocationDetail {
    /**
    ...
    public static Builder builder(AutonomousContainerDatabaseAddStandbyEncryptionKeyLocationDetail defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String providerType;
        public Builder() {}
        public Builder(AutonomousContainerDatabaseAddStandbyEncryptionKeyLocationDetail defaults) {
        ...
        public AutonomousContainerDatabaseAddStandbyEncryptionKeyLocationDetail build() {
            final var _resultValue = new AutonomousContainerDatabaseAddStandbyEncryptionKeyLocationDetail();
