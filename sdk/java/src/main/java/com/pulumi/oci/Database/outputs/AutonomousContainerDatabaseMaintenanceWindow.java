...
import com.pulumi.oci.Database.outputs.AutonomousContainerDatabaseMaintenanceWindowDaysOfWeek;
import com.pulumi.oci.Database.outputs.AutonomousContainerDatabaseMaintenanceWindowMonth;
...
@CustomType
public final class AutonomousContainerDatabaseMaintenanceWindow {
    /**
     ...
     * 
     */
    private @Nullable List<AutonomousContainerDatabaseMaintenanceWindowMonth> months;
    /**
    ...
    private AutonomousContainerDatabaseMaintenanceWindow() {}
    /**
     * @return (Updatable) Determines the amount of time the system will wait before the start of each database server patching operation. Custom action timeout is in minutes and valid value is between 15 to 120 (inclusive).
     * 
     */
     ...
     * 
     */
    public List<AutonomousContainerDatabaseMaintenanceWindowDaysOfWeek> daysOfWeeks() {
     ...
     * 
     */
    public List<AutonomousContainerDatabaseMaintenanceWindowMonth> months() {
    ...
    public static Builder builder(AutonomousContainerDatabaseMaintenanceWindow defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<Integer> weeksOfMonths;
        public Builder() {}
        public Builder(AutonomousContainerDatabaseMaintenanceWindow defaults) {
        ...
        @CustomType.Setter
        public Builder daysOfWeeks(@Nullable List<AutonomousContainerDatabaseMaintenanceWindowDaysOfWeek> daysOfWeeks) {
            this.daysOfWeeks = daysOfWeeks;
            return this;
        }
        public Builder daysOfWeeks(AutonomousContainerDatabaseMaintenanceWindowDaysOfWeek... daysOfWeeks) {
        ...
        @CustomType.Setter
        public Builder months(@Nullable List<AutonomousContainerDatabaseMaintenanceWindowMonth> months) {
            this.months = months;
            return this;
        }
        public Builder months(AutonomousContainerDatabaseMaintenanceWindowMonth... months) {
        ...
        public AutonomousContainerDatabaseMaintenanceWindow build() {
            final var _resultValue = new AutonomousContainerDatabaseMaintenanceWindow();
