...
@CustomType
public final class AutonomousDatabasePublicConnectionUrl {
    /**
    ...
    public static Builder builder(AutonomousDatabasePublicConnectionUrl defaults) {
    ...
    public static final class Builder {
        ...
        public AutonomousDatabasePublicConnectionUrl build() {
            final var _resultValue = new AutonomousDatabasePublicConnectionUrl();
