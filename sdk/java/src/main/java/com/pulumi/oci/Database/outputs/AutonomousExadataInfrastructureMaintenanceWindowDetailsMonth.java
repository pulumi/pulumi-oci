...
public final class AutonomousExadataInfrastructureMaintenanceWindowDetailsMonth {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("AutonomousExadataInfrastructureMaintenanceWindowDetailsMonth", "name");
            }
            this.name = name;
            return this;
        }
        public AutonomousExadataInfrastructureMaintenanceWindowDetailsMonth build() {
            final var _resultValue = new AutonomousExadataInfrastructureMaintenanceWindowDetailsMonth();
