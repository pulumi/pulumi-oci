...
@CustomType
public final class CloudExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfiguration {
    /**
    ...
    private CloudExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfiguration() {}
    /**
     * @return If true, the file system is used to create a backup prior to Exadata VM OS update.
     * 
     */
    ...
    public static Builder builder(CloudExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String mountPoint;
        public Builder() {}
        public Builder(CloudExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfiguration defaults) {
        ...
        public CloudExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfiguration build() {
            final var _resultValue = new CloudExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfiguration();
