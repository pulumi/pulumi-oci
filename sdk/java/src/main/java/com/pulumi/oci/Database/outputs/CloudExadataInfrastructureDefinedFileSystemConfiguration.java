...
@CustomType
public final class CloudExadataInfrastructureDefinedFileSystemConfiguration {
    /**
    ...
    private CloudExadataInfrastructureDefinedFileSystemConfiguration() {}
    /**
     * @return If true, the file system is used to create a backup prior to Exadata VM OS update.
     * 
     */
    ...
    public static Builder builder(CloudExadataInfrastructureDefinedFileSystemConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String mountPoint;
        public Builder() {}
        public Builder(CloudExadataInfrastructureDefinedFileSystemConfiguration defaults) {
        ...
        public CloudExadataInfrastructureDefinedFileSystemConfiguration build() {
