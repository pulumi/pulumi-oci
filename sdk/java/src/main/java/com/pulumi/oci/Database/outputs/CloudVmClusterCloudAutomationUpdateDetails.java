...
import com.pulumi.oci.Database.outputs.CloudVmClusterCloudAutomationUpdateDetailsApplyUpdateTimePreference;
import com.pulumi.oci.Database.outputs.CloudVmClusterCloudAutomationUpdateDetailsFreezePeriod;
...
@CustomType
public final class CloudVmClusterCloudAutomationUpdateDetails {
    /**
     ...
     * 
     */
    private @Nullable CloudVmClusterCloudAutomationUpdateDetailsApplyUpdateTimePreference applyUpdateTimePreference;
    /**
     ...
     * 
     */
    private @Nullable CloudVmClusterCloudAutomationUpdateDetailsFreezePeriod freezePeriod;
    /**
     ...
     * 
     */
    public Optional<CloudVmClusterCloudAutomationUpdateDetailsApplyUpdateTimePreference> applyUpdateTimePreference() {
     ...
     * 
     */
    public Optional<CloudVmClusterCloudAutomationUpdateDetailsFreezePeriod> freezePeriod() {
    ...
    public static Builder builder(CloudVmClusterCloudAutomationUpdateDetails defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean isFreezePeriodEnabled;
        public Builder() {}
        public Builder(CloudVmClusterCloudAutomationUpdateDetails defaults) {
        ...
        @CustomType.Setter
        public Builder applyUpdateTimePreference(@Nullable CloudVmClusterCloudAutomationUpdateDetailsApplyUpdateTimePreference applyUpdateTimePreference) {

            this.applyUpdateTimePreference = applyUpdateTimePreference;
            return this;
        }
        @CustomType.Setter
        public Builder freezePeriod(@Nullable CloudVmClusterCloudAutomationUpdateDetailsFreezePeriod freezePeriod) {
        ...
        public CloudVmClusterCloudAutomationUpdateDetails build() {
            final var _resultValue = new CloudVmClusterCloudAutomationUpdateDetails();
