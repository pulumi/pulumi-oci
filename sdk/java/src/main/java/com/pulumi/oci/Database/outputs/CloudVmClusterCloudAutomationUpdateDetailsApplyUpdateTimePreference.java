...
@CustomType
public final class CloudVmClusterCloudAutomationUpdateDetailsApplyUpdateTimePreference {
    /**
    ...
    private CloudVmClusterCloudAutomationUpdateDetailsApplyUpdateTimePreference() {}
    /**
     * @return (Updatable) End time for polling VM cloud automation software updates for the cluster. If the endTime is not specified, 2 AM UTC is used by default.
     * 
     */
    ...
    public static Builder builder(CloudVmClusterCloudAutomationUpdateDetailsApplyUpdateTimePreference defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String applyUpdatePreferredStartTime;
        public Builder() {}
        public Builder(CloudVmClusterCloudAutomationUpdateDetailsApplyUpdateTimePreference defaults) {
        ...
        public CloudVmClusterCloudAutomationUpdateDetailsApplyUpdateTimePreference build() {
            final var _resultValue = new CloudVmClusterCloudAutomationUpdateDetailsApplyUpdateTimePreference();
