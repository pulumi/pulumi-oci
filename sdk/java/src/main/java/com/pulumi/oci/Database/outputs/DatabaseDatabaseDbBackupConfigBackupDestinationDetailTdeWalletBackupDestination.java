...
@CustomType
public final class DatabaseDatabaseDbBackupConfigBackupDestinationDetailTdeWalletBackupDestination {
    /**
    ...
    private DatabaseDatabaseDbBackupConfigBackupDestinationDetailTdeWalletBackupDestination() {}
    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the backup destination.
     * 
     */
    ...
    public static Builder builder(DatabaseDatabaseDbBackupConfigBackupDestinationDetailTdeWalletBackupDestination defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String backupDestinationType;
        public Builder() {}
        public Builder(DatabaseDatabaseDbBackupConfigBackupDestinationDetailTdeWalletBackupDestination defaults) {
        ...
        public DatabaseDatabaseDbBackupConfigBackupDestinationDetailTdeWalletBackupDestination build() {
            final var _resultValue = new DatabaseDatabaseDbBackupConfigBackupDestinationDetailTdeWalletBackupDestination();
