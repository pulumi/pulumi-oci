...
@CustomType
public final class DatabaseDbBackupConfigBackupDestinationDetailTdeWalletBackupDestination {
    /**
    ...
    public static Builder builder(DatabaseDbBackupConfigBackupDestinationDetailTdeWalletBackupDestination defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String backupDestinationType;
        public Builder() {}
        public Builder(DatabaseDbBackupConfigBackupDestinationDetailTdeWalletBackupDestination defaults) {
        ...
        public DatabaseDbBackupConfigBackupDestinationDetailTdeWalletBackupDestination build() {
            final var _resultValue = new DatabaseDbBackupConfigBackupDestinationDetailTdeWalletBackupDestination();
