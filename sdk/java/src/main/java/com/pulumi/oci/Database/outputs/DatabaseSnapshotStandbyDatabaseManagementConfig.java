...
@CustomType
public final class DatabaseSnapshotStandbyDatabaseManagementConfig {
    /**
    ...
    private DatabaseSnapshotStandbyDatabaseManagementConfig() {}
    /**
     * @return The status of the Database Management service.
     * 
     */
    ...
    public static Builder builder(DatabaseSnapshotStandbyDatabaseManagementConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String managementType;
        public Builder() {}
        public Builder(DatabaseSnapshotStandbyDatabaseManagementConfig defaults) {
        ...
        public DatabaseSnapshotStandbyDatabaseManagementConfig build() {
            final var _resultValue = new DatabaseSnapshotStandbyDatabaseManagementConfig();
