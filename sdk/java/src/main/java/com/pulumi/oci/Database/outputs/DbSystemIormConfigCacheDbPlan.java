...
@CustomType
public final class DbSystemIormConfigCacheDbPlan {
    /**
    ...
    public static Builder builder(DbSystemIormConfigCacheDbPlan defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer share;
        public Builder() {}
        public Builder(DbSystemIormConfigCacheDbPlan defaults) {
        ...
        public DbSystemIormConfigCacheDbPlan build() {
            final var _resultValue = new DbSystemIormConfigCacheDbPlan();
