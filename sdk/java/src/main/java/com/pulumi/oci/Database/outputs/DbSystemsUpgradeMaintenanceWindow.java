...
import com.pulumi.oci.Database.outputs.DbSystemsUpgradeMaintenanceWindowDaysOfWeek;
import com.pulumi.oci.Database.outputs.DbSystemsUpgradeMaintenanceWindowMonth;
...
@CustomType
public final class DbSystemsUpgradeMaintenanceWindow {
    /**
     * @return Days during the week when maintenance should be performed.
     * 
     */
    private final @Nullable List<DbSystemsUpgradeMaintenanceWindowDaysOfWeek> daysOfWeeks;
    /**
     ...
     * 
     */
    private final @Nullable List<DbSystemsUpgradeMaintenanceWindowMonth> months;
    /**
    ...
    private DbSystemsUpgradeMaintenanceWindow(
        @CustomType.Parameter("daysOfWeeks") @Nullable List<DbSystemsUpgradeMaintenanceWindowDaysOfWeek> daysOfWeeks,
        ...
        @CustomType.Parameter("months") @Nullable List<DbSystemsUpgradeMaintenanceWindowMonth> months,
     ...
     * 
     */
    public List<DbSystemsUpgradeMaintenanceWindowDaysOfWeek> daysOfWeeks() {
     ...
     * 
     */
    public List<DbSystemsUpgradeMaintenanceWindowMonth> months() {
    ...
    public static Builder builder(DbSystemsUpgradeMaintenanceWindow defaults) {
        return new Builder(defaults);
    }

    public static final class Builder {
        private @Nullable List<DbSystemsUpgradeMaintenanceWindowDaysOfWeek> daysOfWeeks;
        private @Nullable List<Integer> hoursOfDays;
        private @Nullable Integer leadTimeInWeeks;
        private @Nullable List<DbSystemsUpgradeMaintenanceWindowMonth> months;
        ...
        public Builder(DbSystemsUpgradeMaintenanceWindow defaults) {
        ...
        public Builder daysOfWeeks(DbSystemsUpgradeMaintenanceWindowDaysOfWeek... daysOfWeeks) {
        ...
        public Builder months(DbSystemsUpgradeMaintenanceWindowMonth... months) {
        ...
        public Builder weeksOfMonths(Integer... weeksOfMonths) {
            ...
            return new DbSystemsUpgradeMaintenanceWindow(daysOfWeeks, hoursOfDays, leadTimeInWeeks, months, preference, weeksOfMonths);
        }
    }
}
