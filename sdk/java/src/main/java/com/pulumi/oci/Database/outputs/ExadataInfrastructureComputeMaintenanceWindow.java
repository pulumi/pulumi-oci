...
import com.pulumi.oci.Database.outputs.ExadataInfrastructureComputeMaintenanceWindowDaysOfWeek;
import com.pulumi.oci.Database.outputs.ExadataInfrastructureComputeMaintenanceWindowMonth;
...
@CustomType
public final class ExadataInfrastructureComputeMaintenanceWindow {
    /**
     ...
     * 
     */
    private @Nullable List<ExadataInfrastructureComputeMaintenanceWindowDaysOfWeek> daysOfWeeks;
    /**
     ...
     * 
     */
    private @Nullable List<ExadataInfrastructureComputeMaintenanceWindowMonth> months;
    /**
    ...
    private ExadataInfrastructureComputeMaintenanceWindow() {}
    /**
     * @return Determines the amount of time the system will wait before the start of each database server patching operation. Custom action timeout is in minutes and valid value is between 15 to 120 (inclusive).
     * 
     */
     ...
     * 
     */
    public List<ExadataInfrastructureComputeMaintenanceWindowDaysOfWeek> daysOfWeeks() {
     ...
     * 
     */
    public List<ExadataInfrastructureComputeMaintenanceWindowMonth> months() {
    ...
    public static Builder builder(ExadataInfrastructureComputeMaintenanceWindow defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<Integer> weeksOfMonths;
        public Builder() {}
        public Builder(ExadataInfrastructureComputeMaintenanceWindow defaults) {
        ...
        @CustomType.Setter
        public Builder daysOfWeeks(@Nullable List<ExadataInfrastructureComputeMaintenanceWindowDaysOfWeek> daysOfWeeks) {
            this.daysOfWeeks = daysOfWeeks;
            return this;
        }
        public Builder daysOfWeeks(ExadataInfrastructureComputeMaintenanceWindowDaysOfWeek... daysOfWeeks) {
        ...
        @CustomType.Setter
        public Builder months(@Nullable List<ExadataInfrastructureComputeMaintenanceWindowMonth> months) {
            this.months = months;
            return this;
        }
        public Builder months(ExadataInfrastructureComputeMaintenanceWindowMonth... months) {
        ...
        public ExadataInfrastructureComputeMaintenanceWindow build() {
            final var _resultValue = new ExadataInfrastructureComputeMaintenanceWindow();
