...
public final class ExadataIormConfigDbPlan {
    ...
    public static final class Builder {
        ...
        public Builder dbName(String dbName) {
            if (dbName == null) {
              throw new MissingRequiredPropertyException("ExadataIormConfigDbPlan", "dbName");
            }
            this.dbName = dbName;
            return this;
        }
        ...
        public Builder share(Integer share) {
            if (share == null) {
              throw new MissingRequiredPropertyException("ExadataIormConfigDbPlan", "share");
            }
            this.share = share;
            return this;
        }
        public ExadataIormConfigDbPlan build() {
            final var _resultValue = new ExadataIormConfigDbPlan();
