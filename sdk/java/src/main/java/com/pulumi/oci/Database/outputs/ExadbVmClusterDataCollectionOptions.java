...
@CustomType
public final class ExadbVmClusterDataCollectionOptions {
    /**
    ...
    private ExadbVmClusterDataCollectionOptions() {}
    /**
     * @return (Updatable) Indicates whether diagnostic collection is enabled for the VM cluster/Cloud VM cluster/VMBM DBCS. Enabling diagnostic collection allows you to receive Events service notifications for guest VM issues. Diagnostic collection also allows Oracle to provide enhanced service and proactive support for your Exadata system. You can enable diagnostic collection during VM cluster/Cloud VM cluster provisioning. You can also disable or enable it at any time using the `UpdateVmCluster` or `updateCloudVmCluster` API.
     * 
     */
    ...
    public static Builder builder(ExadbVmClusterDataCollectionOptions defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean isIncidentLogsEnabled;
        public Builder() {}
        public Builder(ExadbVmClusterDataCollectionOptions defaults) {
        ...
        public ExadbVmClusterDataCollectionOptions build() {
            final var _resultValue = new ExadbVmClusterDataCollectionOptions();
