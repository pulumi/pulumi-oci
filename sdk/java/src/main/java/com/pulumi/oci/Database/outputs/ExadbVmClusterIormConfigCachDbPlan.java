...
@CustomType
public final class ExadbVmClusterIormConfigCachDbPlan {
    /**
    ...
    private ExadbVmClusterIormConfigCachDbPlan() {}
    /**
     * @return The database name. For the default `DbPlan`, the `dbName` is `default`.
     * 
     */
    ...
    public static Builder builder(ExadbVmClusterIormConfigCachDbPlan defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer share;
        public Builder() {}
        public Builder(ExadbVmClusterIormConfigCachDbPlan defaults) {
        ...
        public ExadbVmClusterIormConfigCachDbPlan build() {
            final var _resultValue = new ExadbVmClusterIormConfigCachDbPlan();
