...
@CustomType
public final class ExadbVmClusterIormConfigCacheDbPlan {
    /**
    ...
    private ExadbVmClusterIormConfigCacheDbPlan() {}
    /**
     * @return The database name. For the default `DbPlan`, the `dbName` is `default`.
     * 
     */
    ...
    public static Builder builder(ExadbVmClusterIormConfigCacheDbPlan defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer share;
        public Builder() {}
        public Builder(ExadbVmClusterIormConfigCacheDbPlan defaults) {
        ...
        public ExadbVmClusterIormConfigCacheDbPlan build() {
            final var _resultValue = new ExadbVmClusterIormConfigCacheDbPlan();
