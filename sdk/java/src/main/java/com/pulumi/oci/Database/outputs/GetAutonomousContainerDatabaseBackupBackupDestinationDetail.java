...
@CustomType
public final class GetAutonomousContainerDatabaseBackupBackupDestinationDetail {
    /**
    ...
    private GetAutonomousContainerDatabaseBackupBackupDestinationDetail() {}
    /**
     * @return Defines the automatic and manual backup retention policy for the Autonomous AI Database termination.  The retention policy set on the Autonomous Container Database is not applicable for cross region remote backups and backups hosted on recovery Appliance backup destination. Options are &#39;RETAIN_PER_RETENTION_WINDOW&#39; or &#39;RETAIN_FOR_72_HOURS&#39;.The default value is &#39;RETAIN_FOR_72_HOURS&#39;.
     * 
     */
    ...
    public static Builder builder(GetAutonomousContainerDatabaseBackupBackupDestinationDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String vpcUser;
        public Builder() {}
        public Builder(GetAutonomousContainerDatabaseBackupBackupDestinationDetail defaults) {
        ...
        public Builder backupRetentionPolicyOnTerminate(String backupRetentionPolicyOnTerminate) {
            if (backupRetentionPolicyOnTerminate == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseBackupBackupDestinationDetail", "backupRetentionPolicyOnTerminate");
            }
        ...
        public Builder dbrsPolicyId(String dbrsPolicyId) {
            if (dbrsPolicyId == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseBackupBackupDestinationDetail", "dbrsPolicyId");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseBackupBackupDestinationDetail", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder internetProxy(String internetProxy) {
            if (internetProxy == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseBackupBackupDestinationDetail", "internetProxy");
            }
        ...
        public Builder isRemote(Boolean isRemote) {
            if (isRemote == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseBackupBackupDestinationDetail", "isRemote");
            }
        ...
        public Builder isRetentionLockEnabled(Boolean isRetentionLockEnabled) {
            if (isRetentionLockEnabled == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseBackupBackupDestinationDetail", "isRetentionLockEnabled");
            }
        ...
        public Builder isZeroDataLossEnabled(Boolean isZeroDataLossEnabled) {
            if (isZeroDataLossEnabled == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseBackupBackupDestinationDetail", "isZeroDataLossEnabled");
            }
        ...
        public Builder remoteRegion(String remoteRegion) {
            if (remoteRegion == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseBackupBackupDestinationDetail", "remoteRegion");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseBackupBackupDestinationDetail", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder vpcPassword(String vpcPassword) {
            if (vpcPassword == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseBackupBackupDestinationDetail", "vpcPassword");
            }
        ...
        public Builder vpcUser(String vpcUser) {
            if (vpcUser == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseBackupBackupDestinationDetail", "vpcUser");
            }
            this.vpcUser = vpcUser;
            return this;
        }
        public GetAutonomousContainerDatabaseBackupBackupDestinationDetail build() {
            final var _resultValue = new GetAutonomousContainerDatabaseBackupBackupDestinationDetail();
