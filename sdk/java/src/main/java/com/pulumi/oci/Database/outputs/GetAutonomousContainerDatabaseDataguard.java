...
@CustomType
public final class GetAutonomousContainerDatabaseDataguard {
    /**
    ...
    private GetAutonomousContainerDatabaseDataguard() {}
    /**
     * @return The lag time between updates to the primary Autonomous Container Database and application of the redo data on the standby Autonomous Container Database, as computed by the reporting database. Example: `9 seconds`
     * 
     */
    ...
    public static Builder builder(GetAutonomousContainerDatabaseDataguard defaults) {
    ...
    public static final class Builder {
        ...
        private String transportLag;
        public Builder() {}
        public Builder(GetAutonomousContainerDatabaseDataguard defaults) {
        ...
        public Builder applyLag(String applyLag) {
            if (applyLag == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguard", "applyLag");
            }
        ...
        public Builder applyRate(String applyRate) {
            if (applyRate == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguard", "applyRate");
            }
        ...
        public Builder automaticFailoverTarget(String automaticFailoverTarget) {
            if (automaticFailoverTarget == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguard", "automaticFailoverTarget");
            }
        ...
        public Builder autonomousContainerDatabaseId(String autonomousContainerDatabaseId) {
            if (autonomousContainerDatabaseId == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguard", "autonomousContainerDatabaseId");
            }
        ...
        public Builder availabilityDomain(String availabilityDomain) {
            if (availabilityDomain == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguard", "availabilityDomain");
            }
        ...
        public Builder fastStartFailOverLagLimitInSeconds(Integer fastStartFailOverLagLimitInSeconds) {
            if (fastStartFailOverLagLimitInSeconds == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguard", "fastStartFailOverLagLimitInSeconds");
            }
        ...
        public Builder isAutomaticFailoverEnabled(Boolean isAutomaticFailoverEnabled) {
            if (isAutomaticFailoverEnabled == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguard", "isAutomaticFailoverEnabled");
            }
        ...
        public Builder lifecycleDetails(String lifecycleDetails) {
            if (lifecycleDetails == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguard", "lifecycleDetails");
            }
        ...
        public Builder protectionMode(String protectionMode) {
            if (protectionMode == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguard", "protectionMode");
            }
        ...
        public Builder redoTransportMode(String redoTransportMode) {
            if (redoTransportMode == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguard", "redoTransportMode");
            }
        ...
        public Builder role(String role) {
            if (role == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguard", "role");
            }
            this.role = role;
            return this;
        }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguard", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguard", "timeCreated");
            }
        ...
        public Builder timeLagRefreshedOn(String timeLagRefreshedOn) {
            if (timeLagRefreshedOn == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguard", "timeLagRefreshedOn");
            }
        ...
        public Builder timeLastRoleChanged(String timeLastRoleChanged) {
            if (timeLastRoleChanged == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguard", "timeLastRoleChanged");
            }
        ...
        public Builder timeLastSynced(String timeLastSynced) {
            if (timeLastSynced == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguard", "timeLastSynced");
            }
        ...
        public Builder transportLag(String transportLag) {
            if (transportLag == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguard", "transportLag");
            }
            this.transportLag = transportLag;
            return this;
        }
        public GetAutonomousContainerDatabaseDataguard build() {
            final var _resultValue = new GetAutonomousContainerDatabaseDataguard();
