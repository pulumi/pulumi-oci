...
@CustomType
public final class GetAutonomousContainerDatabaseDataguardGroupMember {
    /**
    ...
    private GetAutonomousContainerDatabaseDataguardGroupMember() {}
    /**
     * @return The lag time between updates to the primary Autonomous Container Database and application of the redo data on the standby Autonomous Container Database, as computed by the reporting database. Example: `9 seconds`
     * 
     */
    ...
    public static Builder builder(GetAutonomousContainerDatabaseDataguardGroupMember defaults) {
    ...
    public static final class Builder {
        ...
        private String transportLag;
        public Builder() {}
        public Builder(GetAutonomousContainerDatabaseDataguardGroupMember defaults) {
        ...
        public Builder applyLag(String applyLag) {
            if (applyLag == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguardGroupMember", "applyLag");
            }
        ...
        public Builder applyRate(String applyRate) {
            if (applyRate == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguardGroupMember", "applyRate");
            }
        ...
        public Builder automaticFailoverTarget(String automaticFailoverTarget) {
            if (automaticFailoverTarget == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguardGroupMember", "automaticFailoverTarget");
            }
        ...
        public Builder autonomousContainerDatabaseId(String autonomousContainerDatabaseId) {
            if (autonomousContainerDatabaseId == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguardGroupMember", "autonomousContainerDatabaseId");
            }
        ...
        public Builder availabilityDomain(String availabilityDomain) {
            if (availabilityDomain == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguardGroupMember", "availabilityDomain");
            }
        ...
        public Builder fastStartFailOverLagLimitInSeconds(Integer fastStartFailOverLagLimitInSeconds) {
            if (fastStartFailOverLagLimitInSeconds == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguardGroupMember", "fastStartFailOverLagLimitInSeconds");
            }
        ...
        public Builder isAutomaticFailoverEnabled(Boolean isAutomaticFailoverEnabled) {
            if (isAutomaticFailoverEnabled == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguardGroupMember", "isAutomaticFailoverEnabled");
            }
        ...
        public Builder lifecycleDetails(String lifecycleDetails) {
            if (lifecycleDetails == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguardGroupMember", "lifecycleDetails");
            }
        ...
        public Builder protectionMode(String protectionMode) {
            if (protectionMode == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguardGroupMember", "protectionMode");
            }
        ...
        public Builder redoTransportMode(String redoTransportMode) {
            if (redoTransportMode == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguardGroupMember", "redoTransportMode");
            }
        ...
        public Builder role(String role) {
            if (role == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguardGroupMember", "role");
            }
            this.role = role;
            return this;
        }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguardGroupMember", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguardGroupMember", "timeCreated");
            }
        ...
        public Builder timeLagRefreshedOn(String timeLagRefreshedOn) {
            if (timeLagRefreshedOn == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguardGroupMember", "timeLagRefreshedOn");
            }
        ...
        public Builder timeLastRoleChanged(String timeLastRoleChanged) {
            if (timeLastRoleChanged == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguardGroupMember", "timeLastRoleChanged");
            }
        ...
        public Builder timeLastSynced(String timeLastSynced) {
            if (timeLastSynced == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguardGroupMember", "timeLastSynced");
            }
        ...
        public Builder transportLag(String transportLag) {
            if (transportLag == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseDataguardGroupMember", "transportLag");
            }
            this.transportLag = transportLag;
            return this;
        }
        public GetAutonomousContainerDatabaseDataguardGroupMember build() {
            final var _resultValue = new GetAutonomousContainerDatabaseDataguardGroupMember();
