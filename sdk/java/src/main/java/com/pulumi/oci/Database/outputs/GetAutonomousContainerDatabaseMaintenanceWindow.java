...
public final class GetAutonomousContainerDatabaseMaintenanceWindow {
    ...
    public static final class Builder {
        ...
        public Builder skipRus(List<Boolean> skipRus) {
            if (skipRus == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabaseMaintenanceWindow", "skipRus");
            }
        ...
        public GetAutonomousContainerDatabaseMaintenanceWindow build() {
            final var _resultValue = new GetAutonomousContainerDatabaseMaintenanceWindow();
