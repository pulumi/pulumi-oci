...
@CustomType
public final class GetAutonomousContainerDatabasesAutonomousContainerDatabaseBackupDestinationPropertiesList {
    /**
    ...
    private GetAutonomousContainerDatabasesAutonomousContainerDatabaseBackupDestinationPropertiesList() {}
    /**
     * @return The timestamps at which this backup destination is used as the preferred destination to host the Autonomous Container Database backups.
     * 
     */
    ...
    public static Builder builder(GetAutonomousContainerDatabasesAutonomousContainerDatabaseBackupDestinationPropertiesList defaults) {
    ...
    public static final class Builder {
        ...
        private String timeAtWhichStorageDetailsAreUpdated;
        public Builder() {}
        public Builder(GetAutonomousContainerDatabasesAutonomousContainerDatabaseBackupDestinationPropertiesList defaults) {
        ...
        public Builder backupDestinationAttachHistories(List<String> backupDestinationAttachHistories) {
            if (backupDestinationAttachHistories == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabasesAutonomousContainerDatabaseBackupDestinationPropertiesList", "backupDestinationAttachHistories");
            }
        ...
        public Builder spaceUtilizedInGbs(Integer spaceUtilizedInGbs) {
            if (spaceUtilizedInGbs == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabasesAutonomousContainerDatabaseBackupDestinationPropertiesList", "spaceUtilizedInGbs");
            }
        ...
        public Builder timeAtWhichStorageDetailsAreUpdated(String timeAtWhichStorageDetailsAreUpdated) {
            if (timeAtWhichStorageDetailsAreUpdated == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabasesAutonomousContainerDatabaseBackupDestinationPropertiesList", "timeAtWhichStorageDetailsAreUpdated");
            }
            this.timeAtWhichStorageDetailsAreUpdated = timeAtWhichStorageDetailsAreUpdated;
            return this;
        }
        public GetAutonomousContainerDatabasesAutonomousContainerDatabaseBackupDestinationPropertiesList build() {
            final var _resultValue = new GetAutonomousContainerDatabasesAutonomousContainerDatabaseBackupDestinationPropertiesList();
