...
import com.pulumi.oci.Database.outputs.GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindowDaysOfWeek;
import com.pulumi.oci.Database.outputs.GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindowMonth;
...
@CustomType
public final class GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindow {
    /**
     ...
     * 
     */
    private List<GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindowDaysOfWeek> daysOfWeeks;
    /**
     ...
     * 
     */
    private List<GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindowMonth> months;
    /**
    ...
    private GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindow() {}
    /**
     * @return Determines the amount of time the system will wait before the start of each database server patching operation. Custom action timeout is in minutes and valid value is between 15 to 120 (inclusive).
     * 
     */
     ...
     * 
     */
    public List<GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindowDaysOfWeek> daysOfWeeks() {
     ...
     * 
     */
    public List<GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindowMonth> months() {
        return this.months;
    }
    /**
     * @return Cloud Exadata infrastructure node patching method, either &#34;ROLLING&#34; or &#34;NONROLLING&#34;. Default value is ROLLING.
    ...
    public static Builder builder(GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindow defaults) {
    ...
    public static final class Builder {
        ...
        private List<Integer> weeksOfMonths;
        public Builder() {}
        public Builder(GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindow defaults) {
        ...
        public Builder customActionTimeoutInMins(Integer customActionTimeoutInMins) {
            if (customActionTimeoutInMins == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindow", "customActionTimeoutInMins");
            }
            this.customActionTimeoutInMins = customActionTimeoutInMins;
            return this;
        }
        @CustomType.Setter
        public Builder daysOfWeeks(List<GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindowDaysOfWeek> daysOfWeeks) {
            if (daysOfWeeks == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindow", "daysOfWeeks");
            }
            this.daysOfWeeks = daysOfWeeks;
            return this;
        }
        public Builder daysOfWeeks(GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindowDaysOfWeek... daysOfWeeks) {
            return daysOfWeeks(List.of(daysOfWeeks));
        }
        @CustomType.Setter
        public Builder hoursOfDays(List<Integer> hoursOfDays) {
            if (hoursOfDays == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindow", "hoursOfDays");
            }
        ...
        public Builder isCustomActionTimeoutEnabled(Boolean isCustomActionTimeoutEnabled) {
            if (isCustomActionTimeoutEnabled == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindow", "isCustomActionTimeoutEnabled");
            }
        ...
        public Builder isMonthlyPatchingEnabled(Boolean isMonthlyPatchingEnabled) {
            if (isMonthlyPatchingEnabled == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindow", "isMonthlyPatchingEnabled");
            }
        ...
        public Builder leadTimeInWeeks(Integer leadTimeInWeeks) {
            if (leadTimeInWeeks == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindow", "leadTimeInWeeks");
            }
            this.leadTimeInWeeks = leadTimeInWeeks;
            return this;
        }
        @CustomType.Setter
        public Builder months(List<GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindowMonth> months) {
            if (months == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindow", "months");
            }
            this.months = months;
            return this;
        }
        public Builder months(GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindowMonth... months) {
            return months(List.of(months));
        }
        @CustomType.Setter
        public Builder patchingMode(String patchingMode) {
            if (patchingMode == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindow", "patchingMode");
            }
        ...
        public Builder preference(String preference) {
            if (preference == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindow", "preference");
            }
        ...
        public Builder skipRus(List<Boolean> skipRus) {
            if (skipRus == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindow", "skipRus");
            }
        ...
        public Builder weeksOfMonths(List<Integer> weeksOfMonths) {
            if (weeksOfMonths == null) {
              throw new MissingRequiredPropertyException("GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindow", "weeksOfMonths");
            }
        ...
        public GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindow build() {
            final var _resultValue = new GetAutonomousContainerDatabasesAutonomousContainerDatabaseMaintenanceWindow();
