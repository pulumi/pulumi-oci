    ...
    public static final class Builder {
        ...
        public Builder backupRetentionPolicyOnTerminate(String backupRetentionPolicyOnTerminate) {
            if (backupRetentionPolicyOnTerminate == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseBackupBackupDestinationDetail", "backupRetentionPolicyOnTerminate");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseBackupBackupDestinationDetail", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder internetProxy(String internetProxy) {
            if (internetProxy == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseBackupBackupDestinationDetail", "internetProxy");
            }
        ...
        public Builder isRemote(Boolean isRemote) {
            if (isRemote == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseBackupBackupDestinationDetail", "isRemote");
            }
        ...
        public Builder isRetentionLockEnabled(Boolean isRetentionLockEnabled) {
            if (isRetentionLockEnabled == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseBackupBackupDestinationDetail", "isRetentionLockEnabled");
            }
        ...
        public Builder remoteRegion(String remoteRegion) {
            if (remoteRegion == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseBackupBackupDestinationDetail", "remoteRegion");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseBackupBackupDestinationDetail", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder vpcPassword(String vpcPassword) {
            if (vpcPassword == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseBackupBackupDestinationDetail", "vpcPassword");
            }
        ...
        public Builder vpcUser(String vpcUser) {
            if (vpcUser == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseBackupBackupDestinationDetail", "vpcUser");
            }
            this.vpcUser = vpcUser;
            return this;
        }
        public GetAutonomousDatabaseBackupBackupDestinationDetail build() {
            final var _resultValue = new GetAutonomousDatabaseBackupBackupDestinationDetail();
