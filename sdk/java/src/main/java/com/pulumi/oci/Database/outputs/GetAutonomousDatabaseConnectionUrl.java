...
public final class GetAutonomousDatabaseConnectionUrl {
    ...
    public static final class Builder {
        ...
        public Builder apexUrl(String apexUrl) {
            if (apexUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseConnectionUrl", "apexUrl");
            }
        ...
        public Builder databaseTransformsUrl(String databaseTransformsUrl) {
            if (databaseTransformsUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseConnectionUrl", "databaseTransformsUrl");
            }
        ...
        public Builder graphStudioUrl(String graphStudioUrl) {
            if (graphStudioUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseConnectionUrl", "graphStudioUrl");
            }
        ...
        public Builder machineLearningNotebookUrl(String machineLearningNotebookUrl) {
            if (machineLearningNotebookUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseConnectionUrl", "machineLearningNotebookUrl");
            }
        ...
        public Builder machineLearningUserManagementUrl(String machineLearningUserManagementUrl) {
            if (machineLearningUserManagementUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseConnectionUrl", "machineLearningUserManagementUrl");
            }
        ...
        public Builder mongoDbUrl(String mongoDbUrl) {
            if (mongoDbUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseConnectionUrl", "mongoDbUrl");
            }
        ...
        public Builder ordsUrl(String ordsUrl) {
            if (ordsUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseConnectionUrl", "ordsUrl");
            }
        ...
        public Builder spatialStudioUrl(String spatialStudioUrl) {
            if (spatialStudioUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseConnectionUrl", "spatialStudioUrl");
            }
        ...
        public Builder sqlDevWebUrl(String sqlDevWebUrl) {
            if (sqlDevWebUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseConnectionUrl", "sqlDevWebUrl");
            }
            this.sqlDevWebUrl = sqlDevWebUrl;
            return this;
        }
        public GetAutonomousDatabaseConnectionUrl build() {
            final var _resultValue = new GetAutonomousDatabaseConnectionUrl();
