...
@CustomType
public final class GetAutonomousDatabaseDbToolsDetail {
    /**
    ...
    private GetAutonomousDatabaseDbToolsDetail() {}
    /**
     * @return Compute used by database tools.
     * 
     */
    ...
    public static Builder builder(GetAutonomousDatabaseDbToolsDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String name;
        public Builder() {}
        public Builder(GetAutonomousDatabaseDbToolsDetail defaults) {
        ...
        public Builder computeCount(Double computeCount) {
            if (computeCount == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseDbToolsDetail", "computeCount");
            }
        ...
        public Builder isEnabled(Boolean isEnabled) {
            if (isEnabled == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseDbToolsDetail", "isEnabled");
            }
        ...
        public Builder maxIdleTimeInMinutes(Integer maxIdleTimeInMinutes) {
            if (maxIdleTimeInMinutes == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseDbToolsDetail", "maxIdleTimeInMinutes");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseDbToolsDetail", "name");
            }
            this.name = name;
            return this;
        }
        public GetAutonomousDatabaseDbToolsDetail build() {
            final var _resultValue = new GetAutonomousDatabaseDbToolsDetail();
