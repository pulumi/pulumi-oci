...
public final class GetAutonomousDatabaseKeyHistoryEntry {
    ...
    public static final class Builder {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseKeyHistoryEntry", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder kmsKeyVersionId(String kmsKeyVersionId) {
            if (kmsKeyVersionId == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseKeyHistoryEntry", "kmsKeyVersionId");
            }
        ...
        public Builder timeActivated(String timeActivated) {
            if (timeActivated == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseKeyHistoryEntry", "timeActivated");
            }
        ...
        public Builder vaultId(String vaultId) {
            if (vaultId == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseKeyHistoryEntry", "vaultId");
            }
            this.vaultId = vaultId;
            return this;
        }
        public GetAutonomousDatabaseKeyHistoryEntry build() {
            final var _resultValue = new GetAutonomousDatabaseKeyHistoryEntry();
            _resultValue.id = id;
