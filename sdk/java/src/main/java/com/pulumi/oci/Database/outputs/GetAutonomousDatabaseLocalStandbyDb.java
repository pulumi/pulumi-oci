...
@CustomType
public final class GetAutonomousDatabaseLocalStandbyDb {
    /**
    ...
    private GetAutonomousDatabaseLocalStandbyDb() {}
    /**
     * @return The availability domain of a local Autonomous Data Guard standby database of an Autonomous AI Database Serverless instance.
     * 
     */
    ...
    public static Builder builder(GetAutonomousDatabaseLocalStandbyDb defaults) {
    ...
    public static final class Builder {
        ...
        private String timeMaintenanceEnd;
        public Builder() {}
        public Builder(GetAutonomousDatabaseLocalStandbyDb defaults) {
        ...
        public Builder availabilityDomain(String availabilityDomain) {
            if (availabilityDomain == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseLocalStandbyDb", "availabilityDomain");
            }
        ...
        public Builder externalLocationZone(String externalLocationZone) {
            if (externalLocationZone == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseLocalStandbyDb", "externalLocationZone");
            }
        ...
        public Builder lagTimeInSeconds(Integer lagTimeInSeconds) {
            if (lagTimeInSeconds == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseLocalStandbyDb", "lagTimeInSeconds");
            }
        ...
        public Builder lifecycleDetails(String lifecycleDetails) {
            if (lifecycleDetails == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseLocalStandbyDb", "lifecycleDetails");
            }
        ...
        public Builder maintenanceTargetComponent(String maintenanceTargetComponent) {
            if (maintenanceTargetComponent == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseLocalStandbyDb", "maintenanceTargetComponent");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseLocalStandbyDb", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder timeDataGuardRoleChanged(String timeDataGuardRoleChanged) {
            if (timeDataGuardRoleChanged == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseLocalStandbyDb", "timeDataGuardRoleChanged");
            }
        ...
        public Builder timeDisasterRecoveryRoleChanged(String timeDisasterRecoveryRoleChanged) {
            if (timeDisasterRecoveryRoleChanged == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseLocalStandbyDb", "timeDisasterRecoveryRoleChanged");
            }
        ...
        public Builder timeMaintenanceBegin(String timeMaintenanceBegin) {
            if (timeMaintenanceBegin == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseLocalStandbyDb", "timeMaintenanceBegin");
            }
        ...
        public Builder timeMaintenanceEnd(String timeMaintenanceEnd) {
            if (timeMaintenanceEnd == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseLocalStandbyDb", "timeMaintenanceEnd");
            }
            this.timeMaintenanceEnd = timeMaintenanceEnd;
            return this;
        }
        public GetAutonomousDatabaseLocalStandbyDb build() {
            final var _resultValue = new GetAutonomousDatabaseLocalStandbyDb();
