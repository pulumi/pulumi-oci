...
@CustomType
public final class GetAutonomousDatabasePublicConnectionUrl {
    /**
    ...
    private GetAutonomousDatabasePublicConnectionUrl() {}
    /**
     * @return Oracle Application Express (APEX) URL.
     * 
     */
    ...
    public static Builder builder(GetAutonomousDatabasePublicConnectionUrl defaults) {
    ...
    public static final class Builder {
        ...
        public Builder apexUrl(String apexUrl) {
            if (apexUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasePublicConnectionUrl", "apexUrl");
            }
        ...
        public Builder databaseTransformsUrl(String databaseTransformsUrl) {
            if (databaseTransformsUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasePublicConnectionUrl", "databaseTransformsUrl");
            }
        ...
        public Builder graphStudioUrl(String graphStudioUrl) {
            if (graphStudioUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasePublicConnectionUrl", "graphStudioUrl");
            }
        ...
        public Builder machineLearningNotebookUrl(String machineLearningNotebookUrl) {
            if (machineLearningNotebookUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasePublicConnectionUrl", "machineLearningNotebookUrl");
            }
        ...
        public Builder machineLearningUserManagementUrl(String machineLearningUserManagementUrl) {
            if (machineLearningUserManagementUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasePublicConnectionUrl", "machineLearningUserManagementUrl");
            }
        ...
        public Builder mongoDbUrl(String mongoDbUrl) {
            if (mongoDbUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasePublicConnectionUrl", "mongoDbUrl");
            }
        ...
        public Builder ordsUrl(String ordsUrl) {
            if (ordsUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasePublicConnectionUrl", "ordsUrl");
            }
        ...
        public GetAutonomousDatabasePublicConnectionUrl build() {
            final var _resultValue = new GetAutonomousDatabasePublicConnectionUrl();
