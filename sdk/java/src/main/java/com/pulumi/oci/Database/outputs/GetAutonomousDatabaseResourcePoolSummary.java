    ...
    public static final class Builder {
        ...
        public Builder availableComputeCapacity(Integer availableComputeCapacity) {
            if (availableComputeCapacity == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseResourcePoolSummary", "availableComputeCapacity");
            }
        ...
        public Builder availableStorageCapacityInTbs(Double availableStorageCapacityInTbs) {
            if (availableStorageCapacityInTbs == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseResourcePoolSummary", "availableStorageCapacityInTbs");
            }
        ...
        public Builder isDisabled(Boolean isDisabled) {
            if (isDisabled == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseResourcePoolSummary", "isDisabled");
            }
        ...
        public Builder poolSize(Integer poolSize) {
            if (poolSize == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseResourcePoolSummary", "poolSize");
            }
        ...
        public Builder poolStorageSizeInTbs(Integer poolStorageSizeInTbs) {
            if (poolStorageSizeInTbs == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseResourcePoolSummary", "poolStorageSizeInTbs");
            }
        ...
        public Builder totalComputeCapacity(Integer totalComputeCapacity) {
            if (totalComputeCapacity == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabaseResourcePoolSummary", "totalComputeCapacity");
            }
            this.totalComputeCapacity = totalComputeCapacity;
            return this;
        }
        public GetAutonomousDatabaseResourcePoolSummary build() {
            final var _resultValue = new GetAutonomousDatabaseResourcePoolSummary();
