...
public final class GetAutonomousDatabasesAutonomousDatabaseLongTermBackupSchedule {
    ...
    public static final class Builder {
        ...
        public Builder isDisabled(Boolean isDisabled) {
            if (isDisabled == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseLongTermBackupSchedule", "isDisabled");
            }
        ...
        public Builder repeatCadence(String repeatCadence) {
            if (repeatCadence == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseLongTermBackupSchedule", "repeatCadence");
            }
        ...
        public Builder retentionPeriodInDays(Integer retentionPeriodInDays) {
            if (retentionPeriodInDays == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseLongTermBackupSchedule", "retentionPeriodInDays");
            }
        ...
        public Builder timeOfBackup(String timeOfBackup) {
            if (timeOfBackup == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseLongTermBackupSchedule", "timeOfBackup");
            }
            this.timeOfBackup = timeOfBackup;
            return this;
        }
        public GetAutonomousDatabasesAutonomousDatabaseLongTermBackupSchedule build() {
            final var _resultValue = new GetAutonomousDatabasesAutonomousDatabaseLongTermBackupSchedule();
