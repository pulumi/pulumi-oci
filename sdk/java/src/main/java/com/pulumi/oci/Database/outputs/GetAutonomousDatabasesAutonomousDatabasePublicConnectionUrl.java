...
@CustomType
public final class GetAutonomousDatabasesAutonomousDatabasePublicConnectionUrl {
    /**
    ...
    private GetAutonomousDatabasesAutonomousDatabasePublicConnectionUrl() {}
    /**
     * @return Oracle Application Express (APEX) URL.
     * 
     */
    ...
    public static Builder builder(GetAutonomousDatabasesAutonomousDatabasePublicConnectionUrl defaults) {
    ...
    public static final class Builder {
        ...
        private String sqlDevWebUrl;
        public Builder() {}
        public Builder(GetAutonomousDatabasesAutonomousDatabasePublicConnectionUrl defaults) {
        ...
        public Builder apexUrl(String apexUrl) {
            if (apexUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabasePublicConnectionUrl", "apexUrl");
            }
        ...
        public Builder databaseTransformsUrl(String databaseTransformsUrl) {
            if (databaseTransformsUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabasePublicConnectionUrl", "databaseTransformsUrl");
            }
        ...
        public Builder graphStudioUrl(String graphStudioUrl) {
            if (graphStudioUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabasePublicConnectionUrl", "graphStudioUrl");
            }
        ...
        public Builder machineLearningNotebookUrl(String machineLearningNotebookUrl) {
            if (machineLearningNotebookUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabasePublicConnectionUrl", "machineLearningNotebookUrl");
            }
        ...
        public Builder machineLearningUserManagementUrl(String machineLearningUserManagementUrl) {
            if (machineLearningUserManagementUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabasePublicConnectionUrl", "machineLearningUserManagementUrl");
            }
        ...
        public Builder mongoDbUrl(String mongoDbUrl) {
            if (mongoDbUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabasePublicConnectionUrl", "mongoDbUrl");
            }
        ...
        public Builder ordsUrl(String ordsUrl) {
            if (ordsUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabasePublicConnectionUrl", "ordsUrl");
            }
        ...
        public Builder spatialStudioUrl(String spatialStudioUrl) {
            if (spatialStudioUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabasePublicConnectionUrl", "spatialStudioUrl");
            }
        ...
        public Builder sqlDevWebUrl(String sqlDevWebUrl) {
            if (sqlDevWebUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabasePublicConnectionUrl", "sqlDevWebUrl");
            }
            this.sqlDevWebUrl = sqlDevWebUrl;
            return this;
        }
        public GetAutonomousDatabasesAutonomousDatabasePublicConnectionUrl build() {
            final var _resultValue = new GetAutonomousDatabasesAutonomousDatabasePublicConnectionUrl();
