    ...
    public static final class Builder {
        ...
        public Builder availabilityDomain(String availabilityDomain) {
            if (availabilityDomain == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseStandbyDb", "availabilityDomain");
            }
        ...
        public Builder externalLocationZone(String externalLocationZone) {
            if (externalLocationZone == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseStandbyDb", "externalLocationZone");
            }
        ...
        public Builder lagTimeInSeconds(Integer lagTimeInSeconds) {
            if (lagTimeInSeconds == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseStandbyDb", "lagTimeInSeconds");
            }
        ...
        public Builder lifecycleDetails(String lifecycleDetails) {
            if (lifecycleDetails == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseStandbyDb", "lifecycleDetails");
            }
        ...
        public Builder maintenanceTargetComponent(String maintenanceTargetComponent) {
            if (maintenanceTargetComponent == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseStandbyDb", "maintenanceTargetComponent");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseStandbyDb", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder timeDataGuardRoleChanged(String timeDataGuardRoleChanged) {
            if (timeDataGuardRoleChanged == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseStandbyDb", "timeDataGuardRoleChanged");
            }
        ...
        public Builder timeDisasterRecoveryRoleChanged(String timeDisasterRecoveryRoleChanged) {
            if (timeDisasterRecoveryRoleChanged == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseStandbyDb", "timeDisasterRecoveryRoleChanged");
            }
        ...
        public Builder timeMaintenanceBegin(String timeMaintenanceBegin) {
            if (timeMaintenanceBegin == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseStandbyDb", "timeMaintenanceBegin");
            }
        ...
        public Builder timeMaintenanceEnd(String timeMaintenanceEnd) {
            if (timeMaintenanceEnd == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseStandbyDb", "timeMaintenanceEnd");
            }
            this.timeMaintenanceEnd = timeMaintenanceEnd;
            return this;
        }
        public GetAutonomousDatabasesAutonomousDatabaseStandbyDb build() {
            final var _resultValue = new GetAutonomousDatabasesAutonomousDatabaseStandbyDb();
