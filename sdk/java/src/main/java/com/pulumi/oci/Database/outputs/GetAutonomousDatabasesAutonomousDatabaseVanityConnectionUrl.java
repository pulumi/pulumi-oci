...
@CustomType
public final class GetAutonomousDatabasesAutonomousDatabaseVanityConnectionUrl {
    /**
    ...
    private GetAutonomousDatabasesAutonomousDatabaseVanityConnectionUrl() {}
    /**
     * @return Oracle Application Express (APEX) URL.
     * 
     */
    ...
    public static Builder builder(GetAutonomousDatabasesAutonomousDatabaseVanityConnectionUrl defaults) {
    ...
    public static final class Builder {
        ...
        private String sqlDevWebUrl;
        public Builder() {}
        public Builder(GetAutonomousDatabasesAutonomousDatabaseVanityConnectionUrl defaults) {
        ...
        public Builder apexUrl(String apexUrl) {
            if (apexUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseVanityConnectionUrl", "apexUrl");
            }
        ...
        public Builder databaseTransformsUrl(String databaseTransformsUrl) {
            if (databaseTransformsUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseVanityConnectionUrl", "databaseTransformsUrl");
            }
        ...
        public Builder graphStudioUrl(String graphStudioUrl) {
            if (graphStudioUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseVanityConnectionUrl", "graphStudioUrl");
            }
        ...
        public Builder machineLearningNotebookUrl(String machineLearningNotebookUrl) {
            if (machineLearningNotebookUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseVanityConnectionUrl", "machineLearningNotebookUrl");
            }
        ...
        public Builder machineLearningUserManagementUrl(String machineLearningUserManagementUrl) {
            if (machineLearningUserManagementUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseVanityConnectionUrl", "machineLearningUserManagementUrl");
            }
        ...
        public Builder mongoDbUrl(String mongoDbUrl) {
            if (mongoDbUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseVanityConnectionUrl", "mongoDbUrl");
            }
        ...
        public Builder ordsUrl(String ordsUrl) {
            if (ordsUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseVanityConnectionUrl", "ordsUrl");
            }
        ...
        public Builder sqlDevWebUrl(String sqlDevWebUrl) {
            if (sqlDevWebUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesAutonomousDatabaseVanityConnectionUrl", "sqlDevWebUrl");
            }
            this.sqlDevWebUrl = sqlDevWebUrl;
            return this;
        }
        public GetAutonomousDatabasesAutonomousDatabaseVanityConnectionUrl build() {
            final var _resultValue = new GetAutonomousDatabasesAutonomousDatabaseVanityConnectionUrl();
