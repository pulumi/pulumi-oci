...
@CustomType
public final class GetAutonomousDatabasesClonesAutonomousDatabasePublicConnectionUrl {
    /**
    ...
    private GetAutonomousDatabasesClonesAutonomousDatabasePublicConnectionUrl() {}
    /**
     * @return Oracle Application Express (APEX) URL.
     * 
     */
    ...
    public static Builder builder(GetAutonomousDatabasesClonesAutonomousDatabasePublicConnectionUrl defaults) {
    ...
    public static final class Builder {
        ...
        private String sqlDevWebUrl;
        public Builder() {}
        public Builder(GetAutonomousDatabasesClonesAutonomousDatabasePublicConnectionUrl defaults) {
        ...
        public Builder apexUrl(String apexUrl) {
            if (apexUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesClonesAutonomousDatabasePublicConnectionUrl", "apexUrl");
            }
        ...
        public Builder databaseTransformsUrl(String databaseTransformsUrl) {
            if (databaseTransformsUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesClonesAutonomousDatabasePublicConnectionUrl", "databaseTransformsUrl");
            }
        ...
        public Builder graphStudioUrl(String graphStudioUrl) {
            if (graphStudioUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesClonesAutonomousDatabasePublicConnectionUrl", "graphStudioUrl");
            }
        ...
        public Builder machineLearningNotebookUrl(String machineLearningNotebookUrl) {
            if (machineLearningNotebookUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesClonesAutonomousDatabasePublicConnectionUrl", "machineLearningNotebookUrl");
            }
        ...
        public Builder machineLearningUserManagementUrl(String machineLearningUserManagementUrl) {
            if (machineLearningUserManagementUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesClonesAutonomousDatabasePublicConnectionUrl", "machineLearningUserManagementUrl");
            }
        ...
        public Builder mongoDbUrl(String mongoDbUrl) {
            if (mongoDbUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesClonesAutonomousDatabasePublicConnectionUrl", "mongoDbUrl");
            }
        ...
        public Builder ordsUrl(String ordsUrl) {
            if (ordsUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesClonesAutonomousDatabasePublicConnectionUrl", "ordsUrl");
            }
        ...
        public Builder spatialStudioUrl(String spatialStudioUrl) {
            if (spatialStudioUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesClonesAutonomousDatabasePublicConnectionUrl", "spatialStudioUrl");
            }
        ...
        public Builder sqlDevWebUrl(String sqlDevWebUrl) {
            if (sqlDevWebUrl == null) {
              throw new MissingRequiredPropertyException("GetAutonomousDatabasesClonesAutonomousDatabasePublicConnectionUrl", "sqlDevWebUrl");
            }
            this.sqlDevWebUrl = sqlDevWebUrl;
            return this;
        }
        public GetAutonomousDatabasesClonesAutonomousDatabasePublicConnectionUrl build() {
            final var _resultValue = new GetAutonomousDatabasesClonesAutonomousDatabasePublicConnectionUrl();
