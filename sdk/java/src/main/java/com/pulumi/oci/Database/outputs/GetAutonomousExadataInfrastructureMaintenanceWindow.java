...
import com.pulumi.oci.Database.outputs.GetAutonomousExadataInfrastructureMaintenanceWindowDaysOfWeek;
import com.pulumi.oci.Database.outputs.GetAutonomousExadataInfrastructureMaintenanceWindowMonth;
...
@CustomType
public final class GetAutonomousExadataInfrastructureMaintenanceWindow {
    /**
     ...
     * 
     */
    private List<GetAutonomousExadataInfrastructureMaintenanceWindowDaysOfWeek> daysOfWeeks;
    /**
     ...
     * 
     */
    private List<GetAutonomousExadataInfrastructureMaintenanceWindowMonth> months;
    /**
    ...
    private GetAutonomousExadataInfrastructureMaintenanceWindow() {}
    /**
     * @return Determines the amount of time the system will wait before the start of each database server patching operation. Custom action timeout is in minutes and valid value is between 15 to 120 (inclusive).
     * 
     */
     ...
     * 
     */
    public List<GetAutonomousExadataInfrastructureMaintenanceWindowDaysOfWeek> daysOfWeeks() {
     ...
     * 
     */
    public List<GetAutonomousExadataInfrastructureMaintenanceWindowMonth> months() {
        return this.months;
    }
    /**
     * @return Cloud Exadata infrastructure node patching method, either &#34;ROLLING&#34; or &#34;NONROLLING&#34;. Default value is ROLLING.
    ...
    public static Builder builder(GetAutonomousExadataInfrastructureMaintenanceWindow defaults) {
    ...
    public static final class Builder {
        ...
        private List<Integer> weeksOfMonths;
        public Builder() {}
        public Builder(GetAutonomousExadataInfrastructureMaintenanceWindow defaults) {
        ...
        public Builder customActionTimeoutInMins(Integer customActionTimeoutInMins) {
            if (customActionTimeoutInMins == null) {
              throw new MissingRequiredPropertyException("GetAutonomousExadataInfrastructureMaintenanceWindow", "customActionTimeoutInMins");
            }
            this.customActionTimeoutInMins = customActionTimeoutInMins;
            return this;
        }
        @CustomType.Setter
        public Builder daysOfWeeks(List<GetAutonomousExadataInfrastructureMaintenanceWindowDaysOfWeek> daysOfWeeks) {
            if (daysOfWeeks == null) {
              throw new MissingRequiredPropertyException("GetAutonomousExadataInfrastructureMaintenanceWindow", "daysOfWeeks");
            }
            this.daysOfWeeks = daysOfWeeks;
            return this;
        }
        public Builder daysOfWeeks(GetAutonomousExadataInfrastructureMaintenanceWindowDaysOfWeek... daysOfWeeks) {
            return daysOfWeeks(List.of(daysOfWeeks));
        }
        @CustomType.Setter
        public Builder hoursOfDays(List<Integer> hoursOfDays) {
            if (hoursOfDays == null) {
              throw new MissingRequiredPropertyException("GetAutonomousExadataInfrastructureMaintenanceWindow", "hoursOfDays");
            }
        ...
        public Builder isCustomActionTimeoutEnabled(Boolean isCustomActionTimeoutEnabled) {
            if (isCustomActionTimeoutEnabled == null) {
              throw new MissingRequiredPropertyException("GetAutonomousExadataInfrastructureMaintenanceWindow", "isCustomActionTimeoutEnabled");
            }
        ...
        public Builder isMonthlyPatchingEnabled(Boolean isMonthlyPatchingEnabled) {
            if (isMonthlyPatchingEnabled == null) {
              throw new MissingRequiredPropertyException("GetAutonomousExadataInfrastructureMaintenanceWindow", "isMonthlyPatchingEnabled");
            }
        ...
        public Builder leadTimeInWeeks(Integer leadTimeInWeeks) {
            if (leadTimeInWeeks == null) {
              throw new MissingRequiredPropertyException("GetAutonomousExadataInfrastructureMaintenanceWindow", "leadTimeInWeeks");
            }
            this.leadTimeInWeeks = leadTimeInWeeks;
            return this;
        }
        @CustomType.Setter
        public Builder months(List<GetAutonomousExadataInfrastructureMaintenanceWindowMonth> months) {
            if (months == null) {
              throw new MissingRequiredPropertyException("GetAutonomousExadataInfrastructureMaintenanceWindow", "months");
            }
            this.months = months;
            return this;
        }
        public Builder months(GetAutonomousExadataInfrastructureMaintenanceWindowMonth... months) {
            return months(List.of(months));
        }
        @CustomType.Setter
        public Builder patchingMode(String patchingMode) {
            if (patchingMode == null) {
              throw new MissingRequiredPropertyException("GetAutonomousExadataInfrastructureMaintenanceWindow", "patchingMode");
            }
        ...
        public Builder preference(String preference) {
            if (preference == null) {
              throw new MissingRequiredPropertyException("GetAutonomousExadataInfrastructureMaintenanceWindow", "preference");
            }
        ...
        public Builder skipRus(List<Boolean> skipRus) {
            if (skipRus == null) {
              throw new MissingRequiredPropertyException("GetAutonomousExadataInfrastructureMaintenanceWindow", "skipRus");
            }
        ...
        public Builder weeksOfMonths(List<Integer> weeksOfMonths) {
            if (weeksOfMonths == null) {
              throw new MissingRequiredPropertyException("GetAutonomousExadataInfrastructureMaintenanceWindow", "weeksOfMonths");
            }
        ...
        public GetAutonomousExadataInfrastructureMaintenanceWindow build() {
            final var _resultValue = new GetAutonomousExadataInfrastructureMaintenanceWindow();
