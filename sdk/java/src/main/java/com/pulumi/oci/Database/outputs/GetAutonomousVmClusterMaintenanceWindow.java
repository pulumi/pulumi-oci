...
public final class GetAutonomousVmClusterMaintenanceWindow {
    ...
    public static final class Builder {
        ...
        public Builder skipRus(List<Boolean> skipRus) {
            if (skipRus == null) {
              throw new MissingRequiredPropertyException("GetAutonomousVmClusterMaintenanceWindow", "skipRus");
            }
        ...
        public GetAutonomousVmClusterMaintenanceWindow build() {
            final var _resultValue = new GetAutonomousVmClusterMaintenanceWindow();
