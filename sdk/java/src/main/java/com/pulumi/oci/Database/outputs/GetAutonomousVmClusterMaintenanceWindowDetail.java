...
import com.pulumi.oci.Database.outputs.GetAutonomousVmClusterMaintenanceWindowDetailDaysOfWeek;
import com.pulumi.oci.Database.outputs.GetAutonomousVmClusterMaintenanceWindowDetailMonth;
...
public final class GetAutonomousVmClusterMaintenanceWindowDetail {
     ...
     * 
     */
    public List<GetAutonomousVmClusterMaintenanceWindowDetailDaysOfWeek> daysOfWeeks() {
     ...
     * 
     */
    public List<GetAutonomousVmClusterMaintenanceWindowDetailMonth> months() {
        return this.months;
    }
    ...
    public static final class Builder {
        ...
        public Builder customActionTimeoutInMins(Integer customActionTimeoutInMins) {
            if (customActionTimeoutInMins == null) {
              throw new MissingRequiredPropertyException("GetAutonomousVmClusterMaintenanceWindowDetail", "customActionTimeoutInMins");
            }
        ...
        public Builder daysOfWeeks(List<GetAutonomousVmClusterMaintenanceWindowDetailDaysOfWeek> daysOfWeeks) {
            if (daysOfWeeks == null) {
              throw new MissingRequiredPropertyException("GetAutonomousVmClusterMaintenanceWindowDetail", "daysOfWeeks");
            }
        ...
        public Builder hoursOfDays(List<Integer> hoursOfDays) {
            if (hoursOfDays == null) {
              throw new MissingRequiredPropertyException("GetAutonomousVmClusterMaintenanceWindowDetail", "hoursOfDays");
            }
        ...
        public Builder isCustomActionTimeoutEnabled(Boolean isCustomActionTimeoutEnabled) {
            if (isCustomActionTimeoutEnabled == null) {
              throw new MissingRequiredPropertyException("GetAutonomousVmClusterMaintenanceWindowDetail", "isCustomActionTimeoutEnabled");
            }
        ...
        public Builder isMonthlyPatchingEnabled(Boolean isMonthlyPatchingEnabled) {
            if (isMonthlyPatchingEnabled == null) {
              throw new MissingRequiredPropertyException("GetAutonomousVmClusterMaintenanceWindowDetail", "isMonthlyPatchingEnabled");
            }
        ...
        public Builder leadTimeInWeeks(Integer leadTimeInWeeks) {
            if (leadTimeInWeeks == null) {
              throw new MissingRequiredPropertyException("GetAutonomousVmClusterMaintenanceWindowDetail", "leadTimeInWeeks");
            }
        ...
        public Builder months(List<GetAutonomousVmClusterMaintenanceWindowDetailMonth> months) {
            if (months == null) {
              throw new MissingRequiredPropertyException("GetAutonomousVmClusterMaintenanceWindowDetail", "months");
            }
            this.months = months;
            return this;
        }
        ...
        public Builder patchingMode(String patchingMode) {
            if (patchingMode == null) {
              throw new MissingRequiredPropertyException("GetAutonomousVmClusterMaintenanceWindowDetail", "patchingMode");
            }
        ...
        public Builder preference(String preference) {
            if (preference == null) {
              throw new MissingRequiredPropertyException("GetAutonomousVmClusterMaintenanceWindowDetail", "preference");
            }
        ...
        public Builder skipRus(List<Boolean> skipRus) {
            if (skipRus == null) {
              throw new MissingRequiredPropertyException("GetAutonomousVmClusterMaintenanceWindowDetail", "skipRus");
            }
        ...
        public Builder weeksOfMonths(List<Integer> weeksOfMonths) {
            if (weeksOfMonths == null) {
              throw new MissingRequiredPropertyException("GetAutonomousVmClusterMaintenanceWindowDetail", "weeksOfMonths");
            }
        ...
        public GetAutonomousVmClusterMaintenanceWindowDetail build() {
            final var _resultValue = new GetAutonomousVmClusterMaintenanceWindowDetail();
