...
public final class GetAutonomousVmClustersAutonomousVmClusterMaintenanceWindowDaysOfWeek {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetAutonomousVmClustersAutonomousVmClusterMaintenanceWindowDaysOfWeek", "name");
            }
            this.name = name;
            return this;
        }
        public GetAutonomousVmClustersAutonomousVmClusterMaintenanceWindowDaysOfWeek build() {
            final var _resultValue = new GetAutonomousVmClustersAutonomousVmClusterMaintenanceWindowDaysOfWeek();
