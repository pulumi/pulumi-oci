    ...
    public static final class Builder {
        ...
        public Builder localMountPointPath(String localMountPointPath) {
            if (localMountPointPath == null) {
              throw new MissingRequiredPropertyException("GetBackupDestinationMountTypeDetail", "localMountPointPath");
            }
        ...
        public Builder mountType(String mountType) {
            if (mountType == null) {
              throw new MissingRequiredPropertyException("GetBackupDestinationMountTypeDetail", "mountType");
            }
        ...
        public Builder nfsServerExport(String nfsServerExport) {
            if (nfsServerExport == null) {
              throw new MissingRequiredPropertyException("GetBackupDestinationMountTypeDetail", "nfsServerExport");
            }
        ...
        public Builder nfsServers(List<String> nfsServers) {
            if (nfsServers == null) {
              throw new MissingRequiredPropertyException("GetBackupDestinationMountTypeDetail", "nfsServers");
            }
        ...
        public GetBackupDestinationMountTypeDetail build() {
            final var _resultValue = new GetBackupDestinationMountTypeDetail();
