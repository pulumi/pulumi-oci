...
import com.pulumi.oci.Database.outputs.GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDaysOfWeek;
import com.pulumi.oci.Database.outputs.GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowMonth;
...
@CustomType
public final class GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindow {
    /**
     ...
     * 
     */
    private List<GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDaysOfWeek> daysOfWeeks;
    /**
     ...
     * 
     */
    private List<GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowMonth> months;
    /**
    ...
    private GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindow() {}
    /**
     * @return Determines the amount of time the system will wait before the start of each database server patching operation. Custom action timeout is in minutes and valid value is between 15 to 120 (inclusive).
     * 
     */
     ...
     * 
     */
    public List<GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDaysOfWeek> daysOfWeeks() {
     ...
     * 
     */
    public List<GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowMonth> months() {
        return this.months;
    }
    /**
     * @return Cloud Exadata infrastructure node patching method, either &#34;ROLLING&#34; or &#34;NONROLLING&#34;. Default value is ROLLING.
    ...
    public static Builder builder(GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindow defaults) {
    ...
    public static final class Builder {
        ...
        private List<Integer> weeksOfMonths;
        public Builder() {}
        public Builder(GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindow defaults) {
        ...
        public Builder customActionTimeoutInMins(Integer customActionTimeoutInMins) {
            if (customActionTimeoutInMins == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindow", "customActionTimeoutInMins");
            }
            this.customActionTimeoutInMins = customActionTimeoutInMins;
            return this;
        }
        @CustomType.Setter
        public Builder daysOfWeeks(List<GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDaysOfWeek> daysOfWeeks) {
            if (daysOfWeeks == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindow", "daysOfWeeks");
            }
            this.daysOfWeeks = daysOfWeeks;
            return this;
        }
        public Builder daysOfWeeks(GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDaysOfWeek... daysOfWeeks) {
            return daysOfWeeks(List.of(daysOfWeeks));
        }
        @CustomType.Setter
        public Builder hoursOfDays(List<Integer> hoursOfDays) {
            if (hoursOfDays == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindow", "hoursOfDays");
            }
        ...
        public Builder isCustomActionTimeoutEnabled(Boolean isCustomActionTimeoutEnabled) {
            if (isCustomActionTimeoutEnabled == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindow", "isCustomActionTimeoutEnabled");
            }
        ...
        public Builder isMonthlyPatchingEnabled(Boolean isMonthlyPatchingEnabled) {
            if (isMonthlyPatchingEnabled == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindow", "isMonthlyPatchingEnabled");
            }
        ...
        public Builder leadTimeInWeeks(Integer leadTimeInWeeks) {
            if (leadTimeInWeeks == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindow", "leadTimeInWeeks");
            }
            this.leadTimeInWeeks = leadTimeInWeeks;
            return this;
        }
        @CustomType.Setter
        public Builder months(List<GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowMonth> months) {
            if (months == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindow", "months");
            }
            this.months = months;
            return this;
        }
        public Builder months(GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowMonth... months) {
            return months(List.of(months));
        }
        @CustomType.Setter
        public Builder patchingMode(String patchingMode) {
            if (patchingMode == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindow", "patchingMode");
            }
        ...
        public Builder preference(String preference) {
            if (preference == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindow", "preference");
            }
        ...
        public Builder skipRus(List<Boolean> skipRus) {
            if (skipRus == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindow", "skipRus");
            }
        ...
        public Builder weeksOfMonths(List<Integer> weeksOfMonths) {
            if (weeksOfMonths == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindow", "weeksOfMonths");
            }
        ...
        public GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindow build() {
            final var _resultValue = new GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindow();
