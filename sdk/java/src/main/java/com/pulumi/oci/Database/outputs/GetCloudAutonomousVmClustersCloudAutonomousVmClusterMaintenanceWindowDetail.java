...
import com.pulumi.oci.Database.outputs.GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetailDaysOfWeek;
import com.pulumi.oci.Database.outputs.GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetailMonth;
...
@CustomType
public final class GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetail {
    /**
     ...
     * 
     */
    private List<GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetailDaysOfWeek> daysOfWeeks;
    /**
     ...
     * 
     */
    private List<GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetailMonth> months;
    /**
    ...
    private GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetail() {}
    /**
     * @return Determines the amount of time the system will wait before the start of each database server patching operation. Custom action timeout is in minutes and valid value is between 15 to 120 (inclusive).
     * 
     */
     ...
     * 
     */
    public List<GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetailDaysOfWeek> daysOfWeeks() {
     ...
     * 
     */
    public List<GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetailMonth> months() {
        return this.months;
    }
    /**
     * @return Cloud Exadata infrastructure node patching method, either &#34;ROLLING&#34; or &#34;NONROLLING&#34;. Default value is ROLLING.
    ...
    public static Builder builder(GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetail defaults) {
    ...
    public static final class Builder {
        ...
        private List<Integer> weeksOfMonths;
        public Builder() {}
        public Builder(GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetail defaults) {
        ...
        public Builder customActionTimeoutInMins(Integer customActionTimeoutInMins) {
            if (customActionTimeoutInMins == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetail", "customActionTimeoutInMins");
            }
            this.customActionTimeoutInMins = customActionTimeoutInMins;
            return this;
        }
        @CustomType.Setter
        public Builder daysOfWeeks(List<GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetailDaysOfWeek> daysOfWeeks) {
            if (daysOfWeeks == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetail", "daysOfWeeks");
            }
            this.daysOfWeeks = daysOfWeeks;
            return this;
        }
        public Builder daysOfWeeks(GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetailDaysOfWeek... daysOfWeeks) {
            return daysOfWeeks(List.of(daysOfWeeks));
        }
        @CustomType.Setter
        public Builder hoursOfDays(List<Integer> hoursOfDays) {
            if (hoursOfDays == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetail", "hoursOfDays");
            }
        ...
        public Builder isCustomActionTimeoutEnabled(Boolean isCustomActionTimeoutEnabled) {
            if (isCustomActionTimeoutEnabled == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetail", "isCustomActionTimeoutEnabled");
            }
        ...
        public Builder isMonthlyPatchingEnabled(Boolean isMonthlyPatchingEnabled) {
            if (isMonthlyPatchingEnabled == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetail", "isMonthlyPatchingEnabled");
            }
        ...
        public Builder leadTimeInWeeks(Integer leadTimeInWeeks) {
            if (leadTimeInWeeks == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetail", "leadTimeInWeeks");
            }
            this.leadTimeInWeeks = leadTimeInWeeks;
            return this;
        }
        @CustomType.Setter
        public Builder months(List<GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetailMonth> months) {
            if (months == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetail", "months");
            }
            this.months = months;
            return this;
        }
        public Builder months(GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetailMonth... months) {
            return months(List.of(months));
        }
        @CustomType.Setter
        public Builder patchingMode(String patchingMode) {
            if (patchingMode == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetail", "patchingMode");
            }
        ...
        public Builder preference(String preference) {
            if (preference == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetail", "preference");
            }
        ...
        public Builder skipRus(List<Boolean> skipRus) {
            if (skipRus == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetail", "skipRus");
            }
        ...
        public Builder weeksOfMonths(List<Integer> weeksOfMonths) {
            if (weeksOfMonths == null) {
              throw new MissingRequiredPropertyException("GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetail", "weeksOfMonths");
            }
        ...
        public GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetail build() {
            final var _resultValue = new GetCloudAutonomousVmClustersCloudAutonomousVmClusterMaintenanceWindowDetail();
