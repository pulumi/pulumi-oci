...
public final class GetCloudExadataInfrastructureMaintenanceWindowMonth {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetCloudExadataInfrastructureMaintenanceWindowMonth", "name");
            }
            this.name = name;
            return this;
        }
        public GetCloudExadataInfrastructureMaintenanceWindowMonth build() {
            final var _resultValue = new GetCloudExadataInfrastructureMaintenanceWindowMonth();
