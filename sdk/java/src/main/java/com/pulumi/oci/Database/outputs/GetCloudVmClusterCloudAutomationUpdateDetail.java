...
import com.pulumi.oci.Database.outputs.GetCloudVmClusterCloudAutomationUpdateDetailApplyUpdateTimePreference;
import com.pulumi.oci.Database.outputs.GetCloudVmClusterCloudAutomationUpdateDetailFreezePeriod;
import java.lang.Boolean;
import java.util.List;
import java.util.Objects;

@CustomType
public final class GetCloudVmClusterCloudAutomationUpdateDetail {
    /**
     ...
     * 
     */
    private List<GetCloudVmClusterCloudAutomationUpdateDetailApplyUpdateTimePreference> applyUpdateTimePreferences;
    /**
     ...
     * 
     */
    private List<GetCloudVmClusterCloudAutomationUpdateDetailFreezePeriod> freezePeriods;
    /**
    ...
    private GetCloudVmClusterCloudAutomationUpdateDetail() {}
    /**
     * @return Configure the time slot for applying VM cloud automation software updates to the cluster. When nothing is selected, the default time slot is 12 AM to 2 AM UTC. Any 2-hour slot is available starting at 12 AM.
     * 
     */
    public List<GetCloudVmClusterCloudAutomationUpdateDetailApplyUpdateTimePreference> applyUpdateTimePreferences() {
     ...
     * 
     */
    public List<GetCloudVmClusterCloudAutomationUpdateDetailFreezePeriod> freezePeriods() {
    ...
    public static Builder builder(GetCloudVmClusterCloudAutomationUpdateDetail defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean isFreezePeriodEnabled;
        public Builder() {}
        public Builder(GetCloudVmClusterCloudAutomationUpdateDetail defaults) {
        ...
        @CustomType.Setter
        public Builder applyUpdateTimePreferences(List<GetCloudVmClusterCloudAutomationUpdateDetailApplyUpdateTimePreference> applyUpdateTimePreferences) {
            if (applyUpdateTimePreferences == null) {
              throw new MissingRequiredPropertyException("GetCloudVmClusterCloudAutomationUpdateDetail", "applyUpdateTimePreferences");
            }
            this.applyUpdateTimePreferences = applyUpdateTimePreferences;
            return this;
        }
        public Builder applyUpdateTimePreferences(GetCloudVmClusterCloudAutomationUpdateDetailApplyUpdateTimePreference... applyUpdateTimePreferences) {
            return applyUpdateTimePreferences(List.of(applyUpdateTimePreferences));
        }
        @CustomType.Setter
        public Builder freezePeriods(List<GetCloudVmClusterCloudAutomationUpdateDetailFreezePeriod> freezePeriods) {
            if (freezePeriods == null) {
              throw new MissingRequiredPropertyException("GetCloudVmClusterCloudAutomationUpdateDetail", "freezePeriods");
            }
            this.freezePeriods = freezePeriods;
            return this;
        }
        public Builder freezePeriods(GetCloudVmClusterCloudAutomationUpdateDetailFreezePeriod... freezePeriods) {
        ...
        public Builder isEarlyAdoptionEnabled(Boolean isEarlyAdoptionEnabled) {
            if (isEarlyAdoptionEnabled == null) {
              throw new MissingRequiredPropertyException("GetCloudVmClusterCloudAutomationUpdateDetail", "isEarlyAdoptionEnabled");
            }
        ...
        public Builder isFreezePeriodEnabled(Boolean isFreezePeriodEnabled) {
            if (isFreezePeriodEnabled == null) {
              throw new MissingRequiredPropertyException("GetCloudVmClusterCloudAutomationUpdateDetail", "isFreezePeriodEnabled");
            }
            this.isFreezePeriodEnabled = isFreezePeriodEnabled;
            return this;
        }
        public GetCloudVmClusterCloudAutomationUpdateDetail build() {
            final var _resultValue = new GetCloudVmClusterCloudAutomationUpdateDetail();
