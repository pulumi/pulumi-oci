...
@CustomType
public final class GetCloudVmClusterCloudAutomationUpdateDetailApplyUpdateTimePreference {
    /**
    ...
    private GetCloudVmClusterCloudAutomationUpdateDetailApplyUpdateTimePreference() {}
    /**
     * @return End time for polling VM cloud automation software updates for the cluster. If the endTime is not specified, 2 AM UTC is used by default.
     * 
     */
    ...
    public static Builder builder(GetCloudVmClusterCloudAutomationUpdateDetailApplyUpdateTimePreference defaults) {
    ...
    public static final class Builder {
        ...
        private String applyUpdatePreferredStartTime;
        public Builder() {}
        public Builder(GetCloudVmClusterCloudAutomationUpdateDetailApplyUpdateTimePreference defaults) {
        ...
        public Builder applyUpdatePreferredEndTime(String applyUpdatePreferredEndTime) {
            if (applyUpdatePreferredEndTime == null) {
              throw new MissingRequiredPropertyException("GetCloudVmClusterCloudAutomationUpdateDetailApplyUpdateTimePreference", "applyUpdatePreferredEndTime");
            }
        ...
        public Builder applyUpdatePreferredStartTime(String applyUpdatePreferredStartTime) {
            if (applyUpdatePreferredStartTime == null) {
              throw new MissingRequiredPropertyException("GetCloudVmClusterCloudAutomationUpdateDetailApplyUpdateTimePreference", "applyUpdatePreferredStartTime");
            }
            this.applyUpdatePreferredStartTime = applyUpdatePreferredStartTime;
            return this;
        }
        public GetCloudVmClusterCloudAutomationUpdateDetailApplyUpdateTimePreference build() {
            final var _resultValue = new GetCloudVmClusterCloudAutomationUpdateDetailApplyUpdateTimePreference();
