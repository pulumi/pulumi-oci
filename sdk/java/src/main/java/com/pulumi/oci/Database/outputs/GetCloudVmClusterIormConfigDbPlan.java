...
public final class GetCloudVmClusterIormConfigDbPlan {
    ...
    public static final class Builder {
        ...
        public Builder dbName(String dbName) {
            if (dbName == null) {
              throw new MissingRequiredPropertyException("GetCloudVmClusterIormConfigDbPlan", "dbName");
            }
            this.dbName = dbName;
            return this;
        }
        ...
        public Builder flashCacheLimit(String flashCacheLimit) {
            if (flashCacheLimit == null) {
              throw new MissingRequiredPropertyException("GetCloudVmClusterIormConfigDbPlan", "flashCacheLimit");
            }
        ...
        public Builder share(Integer share) {
            if (share == null) {
              throw new MissingRequiredPropertyException("GetCloudVmClusterIormConfigDbPlan", "share");
            }
            this.share = share;
            return this;
        }
        public GetCloudVmClusterIormConfigDbPlan build() {
            final var _resultValue = new GetCloudVmClusterIormConfigDbPlan();
