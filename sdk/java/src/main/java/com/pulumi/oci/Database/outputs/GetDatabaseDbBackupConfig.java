    ...
    public static final class Builder {
        ...
        public Builder autoBackupEnabled(Boolean autoBackupEnabled) {
            if (autoBackupEnabled == null) {
              throw new MissingRequiredPropertyException("GetDatabaseDbBackupConfig", "autoBackupEnabled");
            }
        ...
        public Builder autoBackupWindow(String autoBackupWindow) {
            if (autoBackupWindow == null) {
              throw new MissingRequiredPropertyException("GetDatabaseDbBackupConfig", "autoBackupWindow");
            }
        ...
        public Builder autoFullBackupDay(String autoFullBackupDay) {
            if (autoFullBackupDay == null) {
              throw new MissingRequiredPropertyException("GetDatabaseDbBackupConfig", "autoFullBackupDay");
            }
        ...
        public Builder autoFullBackupWindow(String autoFullBackupWindow) {
            if (autoFullBackupWindow == null) {
              throw new MissingRequiredPropertyException("GetDatabaseDbBackupConfig", "autoFullBackupWindow");
            }
        ...
        public Builder backupDeletionPolicy(String backupDeletionPolicy) {
            if (backupDeletionPolicy == null) {
              throw new MissingRequiredPropertyException("GetDatabaseDbBackupConfig", "backupDeletionPolicy");
            }
        ...
        public Builder backupDestinationDetails(List<GetDatabaseDbBackupConfigBackupDestinationDetail> backupDestinationDetails) {
            if (backupDestinationDetails == null) {
              throw new MissingRequiredPropertyException("GetDatabaseDbBackupConfig", "backupDestinationDetails");
            }
        ...
        public Builder recoveryWindowInDays(Integer recoveryWindowInDays) {
            if (recoveryWindowInDays == null) {
              throw new MissingRequiredPropertyException("GetDatabaseDbBackupConfig", "recoveryWindowInDays");
            }
        ...
        public Builder runImmediateFullBackup(Boolean runImmediateFullBackup) {
            if (runImmediateFullBackup == null) {
              throw new MissingRequiredPropertyException("GetDatabaseDbBackupConfig", "runImmediateFullBackup");
            }
            this.runImmediateFullBackup = runImmediateFullBackup;
            return this;
        }
        public GetDatabaseDbBackupConfig build() {
            final var _resultValue = new GetDatabaseDbBackupConfig();
