    ...
    public static final class Builder {
        ...
        public Builder estimatedPatchDuration(Integer estimatedPatchDuration) {
            if (estimatedPatchDuration == null) {
              throw new MissingRequiredPropertyException("GetDatabaseMaintenanceRunHistoryDbServersHistoryDetailDbServerPatchingDetail", "estimatedPatchDuration");
            }
        ...
        public Builder patchingStatus(String patchingStatus) {
            if (patchingStatus == null) {
              throw new MissingRequiredPropertyException("GetDatabaseMaintenanceRunHistoryDbServersHistoryDetailDbServerPatchingDetail", "patchingStatus");
            }
        ...
        public Builder timePatchingEnded(String timePatchingEnded) {
            if (timePatchingEnded == null) {
              throw new MissingRequiredPropertyException("GetDatabaseMaintenanceRunHistoryDbServersHistoryDetailDbServerPatchingDetail", "timePatchingEnded");
            }
        ...
        public Builder timePatchingStarted(String timePatchingStarted) {
            if (timePatchingStarted == null) {
              throw new MissingRequiredPropertyException("GetDatabaseMaintenanceRunHistoryDbServersHistoryDetailDbServerPatchingDetail", "timePatchingStarted");
            }
        ...
        public GetDatabaseMaintenanceRunHistoryDbServersHistoryDetailDbServerPatchingDetail build() {
            final var _resultValue = new GetDatabaseMaintenanceRunHistoryDbServersHistoryDetailDbServerPatchingDetail();
