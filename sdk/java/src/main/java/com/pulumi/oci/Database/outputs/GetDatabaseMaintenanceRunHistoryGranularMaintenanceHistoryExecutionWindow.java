    ...
    public static final class Builder {
        ...
        public Builder deferredExecutionWindowId(String deferredExecutionWindowId) {
            if (deferredExecutionWindowId == null) {
              throw new MissingRequiredPropertyException("GetDatabaseMaintenanceRunHistoryGranularMaintenanceHistoryExecutionWindow", "deferredExecutionWindowId");
            }
        ...
        public Builder windowDetails(String windowDetails) {
            if (windowDetails == null) {
              throw new MissingRequiredPropertyException("GetDatabaseMaintenanceRunHistoryGranularMaintenanceHistoryExecutionWindow", "windowDetails");
            }
