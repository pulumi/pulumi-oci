...
@CustomType
public final class GetDatabaseStorageSizeDetail {
    /**
    ...
    private GetDatabaseStorageSizeDetail() {}
    /**
     * @return The DATA storage size, in gigabytes, that is applicable for the database.
     * 
     */
    ...
    public static Builder builder(GetDatabaseStorageSizeDetail defaults) {
    ...
    public static final class Builder {
        ...
        private Integer redoLogStorageSizeInGbs;
        public Builder() {}
        public Builder(GetDatabaseStorageSizeDetail defaults) {
        ...
        public Builder dataStorageSizeInGb(Integer dataStorageSizeInGb) {
            if (dataStorageSizeInGb == null) {
              throw new MissingRequiredPropertyException("GetDatabaseStorageSizeDetail", "dataStorageSizeInGb");
            }
        ...
        public Builder recoStorageSizeInGbs(Integer recoStorageSizeInGbs) {
            if (recoStorageSizeInGbs == null) {
              throw new MissingRequiredPropertyException("GetDatabaseStorageSizeDetail", "recoStorageSizeInGbs");
            }
        ...
        public Builder redoLogStorageSizeInGbs(Integer redoLogStorageSizeInGbs) {
            if (redoLogStorageSizeInGbs == null) {
              throw new MissingRequiredPropertyException("GetDatabaseStorageSizeDetail", "redoLogStorageSizeInGbs");
            }
            this.redoLogStorageSizeInGbs = redoLogStorageSizeInGbs;
            return this;
        }
        public GetDatabaseStorageSizeDetail build() {
            final var _resultValue = new GetDatabaseStorageSizeDetail();
