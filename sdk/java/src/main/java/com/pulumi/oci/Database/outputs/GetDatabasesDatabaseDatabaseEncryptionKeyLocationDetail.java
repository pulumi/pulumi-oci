...
@CustomType
public final class GetDatabasesDatabaseDatabaseEncryptionKeyLocationDetail {
    /**
    ...
    private GetDatabasesDatabaseDatabaseEncryptionKeyLocationDetail() {}
    /**
     * @return Provide the key OCID of a registered AWS key.
     * 
     */
    ...
    public static Builder builder(GetDatabasesDatabaseDatabaseEncryptionKeyLocationDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String providerType;
        public Builder() {}
        public Builder(GetDatabasesDatabaseDatabaseEncryptionKeyLocationDetail defaults) {
        ...
        public Builder awsEncryptionKeyId(String awsEncryptionKeyId) {
            if (awsEncryptionKeyId == null) {
              throw new MissingRequiredPropertyException("GetDatabasesDatabaseDatabaseEncryptionKeyLocationDetail", "awsEncryptionKeyId");
            }
        ...
        public Builder azureEncryptionKeyId(String azureEncryptionKeyId) {
            if (azureEncryptionKeyId == null) {
              throw new MissingRequiredPropertyException("GetDatabasesDatabaseDatabaseEncryptionKeyLocationDetail", "azureEncryptionKeyId");
            }
        ...
        public Builder googleCloudProviderEncryptionKeyId(String googleCloudProviderEncryptionKeyId) {
            if (googleCloudProviderEncryptionKeyId == null) {
              throw new MissingRequiredPropertyException("GetDatabasesDatabaseDatabaseEncryptionKeyLocationDetail", "googleCloudProviderEncryptionKeyId");
            }
        ...
        public Builder hsmPassword(String hsmPassword) {
            if (hsmPassword == null) {
              throw new MissingRequiredPropertyException("GetDatabasesDatabaseDatabaseEncryptionKeyLocationDetail", "hsmPassword");
            }
        ...
        public Builder providerType(String providerType) {
            if (providerType == null) {
              throw new MissingRequiredPropertyException("GetDatabasesDatabaseDatabaseEncryptionKeyLocationDetail", "providerType");
            }
            this.providerType = providerType;
            return this;
        }
        public GetDatabasesDatabaseDatabaseEncryptionKeyLocationDetail build() {
            final var _resultValue = new GetDatabasesDatabaseDatabaseEncryptionKeyLocationDetail();
