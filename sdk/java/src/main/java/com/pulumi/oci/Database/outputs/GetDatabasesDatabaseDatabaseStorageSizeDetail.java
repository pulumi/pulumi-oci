...
@CustomType
public final class GetDatabasesDatabaseDatabaseStorageSizeDetail {
    /**
    ...
    private GetDatabasesDatabaseDatabaseStorageSizeDetail() {}
    /**
     * @return The DATA storage size, in gigabytes, that is applicable for the database.
     * 
     */
    ...
    public static Builder builder(GetDatabasesDatabaseDatabaseStorageSizeDetail defaults) {
    ...
    public static final class Builder {
        ...
        private Integer redoLogStorageSizeInGbs;
        public Builder() {}
        public Builder(GetDatabasesDatabaseDatabaseStorageSizeDetail defaults) {
        ...
        public Builder dataStorageSizeInGb(Integer dataStorageSizeInGb) {
            if (dataStorageSizeInGb == null) {
              throw new MissingRequiredPropertyException("GetDatabasesDatabaseDatabaseStorageSizeDetail", "dataStorageSizeInGb");
            }
        ...
        public Builder recoStorageSizeInGbs(Integer recoStorageSizeInGbs) {
            if (recoStorageSizeInGbs == null) {
              throw new MissingRequiredPropertyException("GetDatabasesDatabaseDatabaseStorageSizeDetail", "recoStorageSizeInGbs");
            }
        ...
        public Builder redoLogStorageSizeInGbs(Integer redoLogStorageSizeInGbs) {
            if (redoLogStorageSizeInGbs == null) {
              throw new MissingRequiredPropertyException("GetDatabasesDatabaseDatabaseStorageSizeDetail", "redoLogStorageSizeInGbs");
            }
            this.redoLogStorageSizeInGbs = redoLogStorageSizeInGbs;
            return this;
        }
        public GetDatabasesDatabaseDatabaseStorageSizeDetail build() {
            final var _resultValue = new GetDatabasesDatabaseDatabaseStorageSizeDetail();
