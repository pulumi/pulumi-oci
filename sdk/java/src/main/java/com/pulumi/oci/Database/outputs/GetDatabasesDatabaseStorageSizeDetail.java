...
@CustomType
public final class GetDatabasesDatabaseStorageSizeDetail {
    /**
    ...
    private GetDatabasesDatabaseStorageSizeDetail() {}
    /**
     * @return The DATA storage size, in gigabytes, that is applicable for the database.
     * 
     */
    ...
    public static Builder builder(GetDatabasesDatabaseStorageSizeDetail defaults) {
    ...
    public static final class Builder {
        ...
        private Integer redoLogStorageSizeInGbs;
        public Builder() {}
        public Builder(GetDatabasesDatabaseStorageSizeDetail defaults) {
        ...
        public Builder dataStorageSizeInGb(Integer dataStorageSizeInGb) {
            if (dataStorageSizeInGb == null) {
              throw new MissingRequiredPropertyException("GetDatabasesDatabaseStorageSizeDetail", "dataStorageSizeInGb");
            }
        ...
        public Builder recoStorageSizeInGbs(Integer recoStorageSizeInGbs) {
            if (recoStorageSizeInGbs == null) {
              throw new MissingRequiredPropertyException("GetDatabasesDatabaseStorageSizeDetail", "recoStorageSizeInGbs");
            }
        ...
        public Builder redoLogStorageSizeInGbs(Integer redoLogStorageSizeInGbs) {
            if (redoLogStorageSizeInGbs == null) {
              throw new MissingRequiredPropertyException("GetDatabasesDatabaseStorageSizeDetail", "redoLogStorageSizeInGbs");
            }
            this.redoLogStorageSizeInGbs = redoLogStorageSizeInGbs;
            return this;
        }
        public GetDatabasesDatabaseStorageSizeDetail build() {
            final var _resultValue = new GetDatabasesDatabaseStorageSizeDetail();
