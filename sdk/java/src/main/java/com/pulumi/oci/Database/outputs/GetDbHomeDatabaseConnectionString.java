    ...
    public static final class Builder {
        ...
        public Builder allConnectionStrings(Map<String,String> allConnectionStrings) {
            if (allConnectionStrings == null) {
              throw new MissingRequiredPropertyException("GetDbHomeDatabaseConnectionString", "allConnectionStrings");
            }
        ...
        public Builder cdbDefault(String cdbDefault) {
            if (cdbDefault == null) {
              throw new MissingRequiredPropertyException("GetDbHomeDatabaseConnectionString", "cdbDefault");
            }
        ...
        public Builder cdbIpDefault(String cdbIpDefault) {
            if (cdbIpDefault == null) {
              throw new MissingRequiredPropertyException("GetDbHomeDatabaseConnectionString", "cdbIpDefault");
            }
            this.cdbIpDefault = cdbIpDefault;
            return this;
        }
        public GetDbHomeDatabaseConnectionString build() {
            final var _resultValue = new GetDbHomeDatabaseConnectionString();
