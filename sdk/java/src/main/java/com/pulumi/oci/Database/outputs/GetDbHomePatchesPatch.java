    ...
    public static final class Builder {
        ...
        public Builder availableActions(List<String> availableActions) {
            if (availableActions == null) {
              throw new MissingRequiredPropertyException("GetDbHomePatchesPatch", "availableActions");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetDbHomePatchesPatch", "description");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetDbHomePatchesPatch", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder lastAction(String lastAction) {
            if (lastAction == null) {
              throw new MissingRequiredPropertyException("GetDbHomePatchesPatch", "lastAction");
            }
        ...
        public Builder lifecycleDetails(String lifecycleDetails) {
            if (lifecycleDetails == null) {
              throw new MissingRequiredPropertyException("GetDbHomePatchesPatch", "lifecycleDetails");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetDbHomePatchesPatch", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder timeReleased(String timeReleased) {
            if (timeReleased == null) {
              throw new MissingRequiredPropertyException("GetDbHomePatchesPatch", "timeReleased");
            }
        ...
        public Builder version(String version) {
            if (version == null) {
              throw new MissingRequiredPropertyException("GetDbHomePatchesPatch", "version");
            }
            this.version = version;
            return this;
        }
        public GetDbHomePatchesPatch build() {
            final var _resultValue = new GetDbHomePatchesPatch();
