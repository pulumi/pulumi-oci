    ...
    public static final class Builder {
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetDbNodeConsoleConnectionsConsoleConnection", "compartmentId");
            }
        ...
        public Builder connectionString(String connectionString) {
            if (connectionString == null) {
              throw new MissingRequiredPropertyException("GetDbNodeConsoleConnectionsConsoleConnection", "connectionString");
            }
        ...
        public Builder dbNodeId(String dbNodeId) {
            if (dbNodeId == null) {
              throw new MissingRequiredPropertyException("GetDbNodeConsoleConnectionsConsoleConnection", "dbNodeId");
            }
        ...
        public Builder definedTags(Map<String,String> definedTags) {
            if (definedTags == null) {
              throw new MissingRequiredPropertyException("GetDbNodeConsoleConnectionsConsoleConnection", "definedTags");
            }
        ...
        public Builder fingerprint(String fingerprint) {
            if (fingerprint == null) {
              throw new MissingRequiredPropertyException("GetDbNodeConsoleConnectionsConsoleConnection", "fingerprint");
            }
        ...
        public Builder freeformTags(Map<String,String> freeformTags) {
            if (freeformTags == null) {
              throw new MissingRequiredPropertyException("GetDbNodeConsoleConnectionsConsoleConnection", "freeformTags");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetDbNodeConsoleConnectionsConsoleConnection", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder lifecycleDetails(String lifecycleDetails) {
            if (lifecycleDetails == null) {
              throw new MissingRequiredPropertyException("GetDbNodeConsoleConnectionsConsoleConnection", "lifecycleDetails");
            }
        ...
        public Builder publicKey(String publicKey) {
            if (publicKey == null) {
              throw new MissingRequiredPropertyException("GetDbNodeConsoleConnectionsConsoleConnection", "publicKey");
            }
        ...
        public Builder serviceHostKeyFingerprint(String serviceHostKeyFingerprint) {
            if (serviceHostKeyFingerprint == null) {
              throw new MissingRequiredPropertyException("GetDbNodeConsoleConnectionsConsoleConnection", "serviceHostKeyFingerprint");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetDbNodeConsoleConnectionsConsoleConnection", "state");
            }
            this.state = state;
            return this;
        }
