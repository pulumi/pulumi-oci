...
public final class GetDbSystemStoragePerformancesDbSystemStoragePerformanceDataStoragePerformanceListBalancedDiskPerformance {
    ...
    public static final class Builder {
        ...
        public Builder diskIops(Double diskIops) {
            if (diskIops == null) {
              throw new MissingRequiredPropertyException("GetDbSystemStoragePerformancesDbSystemStoragePerformanceDataStoragePerformanceListBalancedDiskPerformance", "diskIops");
            }
        ...
        public Builder diskThroughputInMbps(Double diskThroughputInMbps) {
            if (diskThroughputInMbps == null) {
              throw new MissingRequiredPropertyException("GetDbSystemStoragePerformancesDbSystemStoragePerformanceDataStoragePerformanceListBalancedDiskPerformance", "diskThroughputInMbps");
            }
        ...
        public GetDbSystemStoragePerformancesDbSystemStoragePerformanceDataStoragePerformanceListBalancedDiskPerformance build() {
            final var _resultValue = new GetDbSystemStoragePerformancesDbSystemStoragePerformanceDataStoragePerformanceListBalancedDiskPerformance();
