...
import com.pulumi.oci.Database.outputs.GetDbSystemsDbSystemMaintenanceWindowDaysOfWeek;
import com.pulumi.oci.Database.outputs.GetDbSystemsDbSystemMaintenanceWindowMonth;
...
@CustomType
public final class GetDbSystemsDbSystemMaintenanceWindow {
    /**
     ...
     * 
     */
    private List<GetDbSystemsDbSystemMaintenanceWindowDaysOfWeek> daysOfWeeks;
    /**
     ...
     * 
     */
    private List<GetDbSystemsDbSystemMaintenanceWindowMonth> months;
    /**
    ...
    private GetDbSystemsDbSystemMaintenanceWindow() {}
    /**
     * @return Determines the amount of time the system will wait before the start of each database server patching operation. Custom action timeout is in minutes and valid value is between 15 to 120 (inclusive).
     * 
     */
     ...
     * 
     */
    public List<GetDbSystemsDbSystemMaintenanceWindowDaysOfWeek> daysOfWeeks() {
     ...
     * 
     */
    public List<GetDbSystemsDbSystemMaintenanceWindowMonth> months() {
        return this.months;
    }
    /**
     * @return Cloud Exadata infrastructure node patching method, either &#34;ROLLING&#34; or &#34;NONROLLING&#34;. Default value is ROLLING.
    ...
    public static Builder builder(GetDbSystemsDbSystemMaintenanceWindow defaults) {
    ...
    public static final class Builder {
        ...
        private List<Integer> weeksOfMonths;
        public Builder() {}
        public Builder(GetDbSystemsDbSystemMaintenanceWindow defaults) {
        ...
        public Builder customActionTimeoutInMins(Integer customActionTimeoutInMins) {
            if (customActionTimeoutInMins == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindow", "customActionTimeoutInMins");
            }
            this.customActionTimeoutInMins = customActionTimeoutInMins;
            return this;
        }
        @CustomType.Setter
        public Builder daysOfWeeks(List<GetDbSystemsDbSystemMaintenanceWindowDaysOfWeek> daysOfWeeks) {
            if (daysOfWeeks == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindow", "daysOfWeeks");
            }
            this.daysOfWeeks = daysOfWeeks;
            return this;
        }
        public Builder daysOfWeeks(GetDbSystemsDbSystemMaintenanceWindowDaysOfWeek... daysOfWeeks) {
            return daysOfWeeks(List.of(daysOfWeeks));
        }
        @CustomType.Setter
        public Builder hoursOfDays(List<Integer> hoursOfDays) {
            if (hoursOfDays == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindow", "hoursOfDays");
            }
        ...
        public Builder isCustomActionTimeoutEnabled(Boolean isCustomActionTimeoutEnabled) {
            if (isCustomActionTimeoutEnabled == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindow", "isCustomActionTimeoutEnabled");
            }
        ...
        public Builder isMonthlyPatchingEnabled(Boolean isMonthlyPatchingEnabled) {
            if (isMonthlyPatchingEnabled == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindow", "isMonthlyPatchingEnabled");
            }
        ...
        public Builder leadTimeInWeeks(Integer leadTimeInWeeks) {
            if (leadTimeInWeeks == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindow", "leadTimeInWeeks");
            }
            this.leadTimeInWeeks = leadTimeInWeeks;
            return this;
        }
        @CustomType.Setter
        public Builder months(List<GetDbSystemsDbSystemMaintenanceWindowMonth> months) {
            if (months == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindow", "months");
            }
            this.months = months;
            return this;
        }
        public Builder months(GetDbSystemsDbSystemMaintenanceWindowMonth... months) {
            return months(List.of(months));
        }
        @CustomType.Setter
        public Builder patchingMode(String patchingMode) {
            if (patchingMode == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindow", "patchingMode");
            }
        ...
        public Builder preference(String preference) {
            if (preference == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindow", "preference");
            }
        ...
        public Builder skipRus(List<Boolean> skipRus) {
            if (skipRus == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindow", "skipRus");
            }
        ...
        public Builder weeksOfMonths(List<Integer> weeksOfMonths) {
            if (weeksOfMonths == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindow", "weeksOfMonths");
            }
        ...
        public GetDbSystemsDbSystemMaintenanceWindow build() {
            final var _resultValue = new GetDbSystemsDbSystemMaintenanceWindow();
