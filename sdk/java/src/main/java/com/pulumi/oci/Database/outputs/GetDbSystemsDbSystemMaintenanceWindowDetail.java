    ...
    public static final class Builder {
        ...
        public Builder customActionTimeoutInMins(Integer customActionTimeoutInMins) {
            if (customActionTimeoutInMins == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindowDetail", "customActionTimeoutInMins");
            }
        ...
        public Builder daysOfWeeks(List<GetDbSystemsDbSystemMaintenanceWindowDetailDaysOfWeek> daysOfWeeks) {
            if (daysOfWeeks == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindowDetail", "daysOfWeeks");
            }
        ...
        public Builder hoursOfDays(List<Integer> hoursOfDays) {
            if (hoursOfDays == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindowDetail", "hoursOfDays");
            }
        ...
        public Builder isCustomActionTimeoutEnabled(Boolean isCustomActionTimeoutEnabled) {
            if (isCustomActionTimeoutEnabled == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindowDetail", "isCustomActionTimeoutEnabled");
            }
        ...
        public Builder isMonthlyPatchingEnabled(Boolean isMonthlyPatchingEnabled) {
            if (isMonthlyPatchingEnabled == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindowDetail", "isMonthlyPatchingEnabled");
            }
        ...
        public Builder leadTimeInWeeks(Integer leadTimeInWeeks) {
            if (leadTimeInWeeks == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindowDetail", "leadTimeInWeeks");
            }
        ...
        public Builder months(List<GetDbSystemsDbSystemMaintenanceWindowDetailMonth> months) {
            if (months == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindowDetail", "months");
            }
            this.months = months;
            return this;
        }
        ...
        public Builder patchingMode(String patchingMode) {
            if (patchingMode == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindowDetail", "patchingMode");
            }
        ...
        public Builder preference(String preference) {
            if (preference == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindowDetail", "preference");
            }
        ...
        public Builder skipRus(List<Boolean> skipRus) {
            if (skipRus == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindowDetail", "skipRus");
            }
        ...
        public Builder weeksOfMonths(List<Integer> weeksOfMonths) {
            if (weeksOfMonths == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemMaintenanceWindowDetail", "weeksOfMonths");
            }
        ...
        public GetDbSystemsDbSystemMaintenanceWindowDetail build() {
            final var _resultValue = new GetDbSystemsDbSystemMaintenanceWindowDetail();
