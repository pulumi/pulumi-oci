    ...
    public static final class Builder {
        ...
        public Builder isBackupPartition(Boolean isBackupPartition) {
            if (isBackupPartition == null) {
              throw new MissingRequiredPropertyException("GetExadataInfrastructureDefinedFileSystemConfiguration", "isBackupPartition");
            }
        ...
        public Builder minSizeGb(Integer minSizeGb) {
            if (minSizeGb == null) {
              throw new MissingRequiredPropertyException("GetExadataInfrastructureDefinedFileSystemConfiguration", "minSizeGb");
            }
