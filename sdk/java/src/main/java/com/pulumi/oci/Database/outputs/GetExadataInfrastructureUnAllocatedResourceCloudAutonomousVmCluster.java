...
@CustomType
public final class GetExadataInfrastructureUnAllocatedResourceCloudAutonomousVmCluster {
    /**
    ...
    private GetExadataInfrastructureUnAllocatedResourceCloudAutonomousVmCluster() {}
    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Cloud Exadata infrastructure.
     * 
     */
    ...
    public static Builder builder(GetExadataInfrastructureUnAllocatedResourceCloudAutonomousVmCluster defaults) {
    ...
    public static final class Builder {
        ...
        private Double unAllocatedAdbStorageInTbs;
        public Builder() {}
        public Builder(GetExadataInfrastructureUnAllocatedResourceCloudAutonomousVmCluster defaults) {
        ...
        public GetExadataInfrastructureUnAllocatedResourceCloudAutonomousVmCluster build() {
            final var o = new GetExadataInfrastructureUnAllocatedResourceCloudAutonomousVmCluster();
            o.id = id;
