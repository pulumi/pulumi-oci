...
import com.pulumi.oci.Database.outputs.GetExecutionActionActionMember;
...
@CustomType
public final class GetExecutionActionResult {
    /**
     * @return List of action members of this execution action.
     * 
     */
    private List<GetExecutionActionActionMember> actionMembers;
    /**
     ...
     * 
     */
    public List<GetExecutionActionActionMember> actionMembers() {
    ...
    public static Builder builder(GetExecutionActionResult defaults) {
    ...
    public static final class Builder {
        ...
        private Integer totalTimeTakenInMins;
        public Builder() {}
        public Builder(GetExecutionActionResult defaults) {
    	      ...
    	      this.executionActionId = defaults.executionActionId;
        ...
        @CustomType.Setter
        public Builder actionMembers(List<GetExecutionActionActionMember> actionMembers) {
            if (actionMembers == null) {
              throw new MissingRequiredPropertyException("GetExecutionActionResult", "actionMembers");
            }
            this.actionMembers = actionMembers;
            return this;
        }
        public Builder actionMembers(GetExecutionActionActionMember... actionMembers) {
            return actionMembers(List.of(actionMembers));
        }
        @CustomType.Setter
        public Builder actionParams(Map<String,String> actionParams) {
            if (actionParams == null) {
              throw new MissingRequiredPropertyException("GetExecutionActionResult", "actionParams");
            }
        ...
        public Builder actionType(String actionType) {
            if (actionType == null) {
              throw new MissingRequiredPropertyException("GetExecutionActionResult", "actionType");
            }
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetExecutionActionResult", "compartmentId");
            }
        ...
        public Builder definedTags(Map<String,String> definedTags) {
            if (definedTags == null) {
              throw new MissingRequiredPropertyException("GetExecutionActionResult", "definedTags");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetExecutionActionResult", "description");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetExecutionActionResult", "displayName");
            }
        ...
        public Builder estimatedTimeInMins(Integer estimatedTimeInMins) {
            if (estimatedTimeInMins == null) {
              throw new MissingRequiredPropertyException("GetExecutionActionResult", "estimatedTimeInMins");
            }
        ...
        public Builder executionActionId(String executionActionId) {
            if (executionActionId == null) {
              throw new MissingRequiredPropertyException("GetExecutionActionResult", "executionActionId");
            }
        ...
        public Builder executionActionOrder(Integer executionActionOrder) {
            if (executionActionOrder == null) {
              throw new MissingRequiredPropertyException("GetExecutionActionResult", "executionActionOrder");
            }
        ...
        public Builder executionWindowId(String executionWindowId) {
            if (executionWindowId == null) {
              throw new MissingRequiredPropertyException("GetExecutionActionResult", "executionWindowId");
            }
        ...
        public Builder freeformTags(Map<String,String> freeformTags) {
            if (freeformTags == null) {
              throw new MissingRequiredPropertyException("GetExecutionActionResult", "freeformTags");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetExecutionActionResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder lifecycleDetails(String lifecycleDetails) {
            if (lifecycleDetails == null) {
              throw new MissingRequiredPropertyException("GetExecutionActionResult", "lifecycleDetails");
            }
        ...
        public Builder lifecycleSubstate(String lifecycleSubstate) {
            if (lifecycleSubstate == null) {
              throw new MissingRequiredPropertyException("GetExecutionActionResult", "lifecycleSubstate");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetExecutionActionResult", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetExecutionActionResult", "timeCreated");
            }
        ...
        public Builder timeUpdated(String timeUpdated) {
            if (timeUpdated == null) {
              throw new MissingRequiredPropertyException("GetExecutionActionResult", "timeUpdated");
            }
        ...
        public Builder totalTimeTakenInMins(Integer totalTimeTakenInMins) {
            if (totalTimeTakenInMins == null) {
              throw new MissingRequiredPropertyException("GetExecutionActionResult", "totalTimeTakenInMins");
            }
            this.totalTimeTakenInMins = totalTimeTakenInMins;
            return this;
        }
        public GetExecutionActionResult build() {
            final var _resultValue = new GetExecutionActionResult();
            ...
            _resultValue.executionActionId = executionActionId;
