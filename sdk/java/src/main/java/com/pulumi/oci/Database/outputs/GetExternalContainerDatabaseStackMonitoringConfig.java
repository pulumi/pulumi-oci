...
@CustomType
public final class GetExternalContainerDatabaseStackMonitoringConfig {
    /**
    ...
    private GetExternalContainerDatabaseStackMonitoringConfig() {}
    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the [external database connector](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/datatypes/CreateExternalDatabaseConnectorDetails).
     * 
     */
    ...
    public static Builder builder(GetExternalContainerDatabaseStackMonitoringConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String stackMonitoringStatus;
        public Builder() {}
        public Builder(GetExternalContainerDatabaseStackMonitoringConfig defaults) {
        ...
        public Builder stackMonitoringConnectorId(String stackMonitoringConnectorId) {
            if (stackMonitoringConnectorId == null) {
              throw new MissingRequiredPropertyException("GetExternalContainerDatabaseStackMonitoringConfig", "stackMonitoringConnectorId");
            }
        ...
        public Builder stackMonitoringStatus(String stackMonitoringStatus) {
            if (stackMonitoringStatus == null) {
              throw new MissingRequiredPropertyException("GetExternalContainerDatabaseStackMonitoringConfig", "stackMonitoringStatus");
            }
            this.stackMonitoringStatus = stackMonitoringStatus;
            return this;
        }
        public GetExternalContainerDatabaseStackMonitoringConfig build() {
            final var _resultValue = new GetExternalContainerDatabaseStackMonitoringConfig();
