...
public final class GetExternalDatabaseConnectorsExternalDatabaseConnector {
    ...
    public static final class Builder {
        ...
        public Builder systemTags(Map<String,String> systemTags) {
            if (systemTags == null) {
              throw new MissingRequiredPropertyException("GetExternalDatabaseConnectorsExternalDatabaseConnector", "systemTags");
            }
        ...
        public GetExternalDatabaseConnectorsExternalDatabaseConnector build() {
            final var _resultValue = new GetExternalDatabaseConnectorsExternalDatabaseConnector();
