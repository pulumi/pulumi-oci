    ...
    public static final class Builder {
        ...
        public Builder databaseManagementConnectionId(String databaseManagementConnectionId) {
            if (databaseManagementConnectionId == null) {
              throw new MissingRequiredPropertyException("GetExternalNonContainerDatabasesExternalNonContainerDatabaseDatabaseManagementConfig", "databaseManagementConnectionId");
            }
        ...
        public Builder databaseManagementStatus(String databaseManagementStatus) {
            if (databaseManagementStatus == null) {
              throw new MissingRequiredPropertyException("GetExternalNonContainerDatabasesExternalNonContainerDatabaseDatabaseManagementConfig", "databaseManagementStatus");
            }
        ...
        public Builder licenseModel(String licenseModel) {
            if (licenseModel == null) {
              throw new MissingRequiredPropertyException("GetExternalNonContainerDatabasesExternalNonContainerDatabaseDatabaseManagementConfig", "licenseModel");
            }
