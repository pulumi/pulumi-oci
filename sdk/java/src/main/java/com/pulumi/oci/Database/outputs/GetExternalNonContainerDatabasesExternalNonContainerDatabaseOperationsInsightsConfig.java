    ...
    public static final class Builder {
        ...
        public Builder operationsInsightsConnectorId(String operationsInsightsConnectorId) {
            if (operationsInsightsConnectorId == null) {
              throw new MissingRequiredPropertyException("GetExternalNonContainerDatabasesExternalNonContainerDatabaseOperationsInsightsConfig", "operationsInsightsConnectorId");
            }
        ...
        public Builder operationsInsightsStatus(String operationsInsightsStatus) {
            if (operationsInsightsStatus == null) {
              throw new MissingRequiredPropertyException("GetExternalNonContainerDatabasesExternalNonContainerDatabaseOperationsInsightsConfig", "operationsInsightsStatus");
            }
