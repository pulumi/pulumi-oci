    ...
    public static final class Builder {
        ...
        public Builder databaseManagementConnectionId(String databaseManagementConnectionId) {
            if (databaseManagementConnectionId == null) {
              throw new MissingRequiredPropertyException("GetExternalPluggableDatabaseDatabaseManagementConfig", "databaseManagementConnectionId");
            }
        ...
        public Builder databaseManagementStatus(String databaseManagementStatus) {
            if (databaseManagementStatus == null) {
              throw new MissingRequiredPropertyException("GetExternalPluggableDatabaseDatabaseManagementConfig", "databaseManagementStatus");
            }
        ...
        public Builder licenseModel(String licenseModel) {
            if (licenseModel == null) {
              throw new MissingRequiredPropertyException("GetExternalPluggableDatabaseDatabaseManagementConfig", "licenseModel");
            }
            this.licenseModel = licenseModel;
            return this;
        }
        public GetExternalPluggableDatabaseDatabaseManagementConfig build() {
            final var _resultValue = new GetExternalPluggableDatabaseDatabaseManagementConfig();
