    ...
    public static final class Builder {
        ...
        public Builder operationsInsightsConnectorId(String operationsInsightsConnectorId) {
            if (operationsInsightsConnectorId == null) {
              throw new MissingRequiredPropertyException("GetExternalPluggableDatabaseOperationsInsightsConfig", "operationsInsightsConnectorId");
            }
        ...
        public Builder operationsInsightsStatus(String operationsInsightsStatus) {
            if (operationsInsightsStatus == null) {
              throw new MissingRequiredPropertyException("GetExternalPluggableDatabaseOperationsInsightsConfig", "operationsInsightsStatus");
            }
            this.operationsInsightsStatus = operationsInsightsStatus;
            return this;
        }
        public GetExternalPluggableDatabaseOperationsInsightsConfig build() {
            final var _resultValue = new GetExternalPluggableDatabaseOperationsInsightsConfig();
