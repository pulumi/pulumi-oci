...
public final class GetExternalPluggableDatabasesExternalPluggableDatabase {
    ...
    public static final class Builder {
        ...
        public Builder systemTags(Map<String,String> systemTags) {
            if (systemTags == null) {
              throw new MissingRequiredPropertyException("GetExternalPluggableDatabasesExternalPluggableDatabase", "systemTags");
            }
        ...
        public GetExternalPluggableDatabasesExternalPluggableDatabase build() {
            final var _resultValue = new GetExternalPluggableDatabasesExternalPluggableDatabase();
