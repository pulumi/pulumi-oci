...
@CustomType
public final class GetExternalPluggableDatabasesExternalPluggableDatabaseDatabaseManagementConfig {
    /**
    ...
    private GetExternalPluggableDatabasesExternalPluggableDatabaseDatabaseManagementConfig() {}
    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the [external database connector](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/datatypes/CreateExternalDatabaseConnectorDetails).
     * 
     */
    ...
    public static Builder builder(GetExternalPluggableDatabasesExternalPluggableDatabaseDatabaseManagementConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String licenseModel;
        public Builder() {}
        public Builder(GetExternalPluggableDatabasesExternalPluggableDatabaseDatabaseManagementConfig defaults) {
        ...
        public Builder databaseManagementConnectionId(String databaseManagementConnectionId) {
            if (databaseManagementConnectionId == null) {
              throw new MissingRequiredPropertyException("GetExternalPluggableDatabasesExternalPluggableDatabaseDatabaseManagementConfig", "databaseManagementConnectionId");
            }
        ...
        public Builder databaseManagementStatus(String databaseManagementStatus) {
            if (databaseManagementStatus == null) {
              throw new MissingRequiredPropertyException("GetExternalPluggableDatabasesExternalPluggableDatabaseDatabaseManagementConfig", "databaseManagementStatus");
            }
        ...
        public Builder licenseModel(String licenseModel) {
            if (licenseModel == null) {
              throw new MissingRequiredPropertyException("GetExternalPluggableDatabasesExternalPluggableDatabaseDatabaseManagementConfig", "licenseModel");
            }
