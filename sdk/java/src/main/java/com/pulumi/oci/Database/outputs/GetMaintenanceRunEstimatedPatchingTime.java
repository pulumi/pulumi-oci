    ...
    public static final class Builder {
        ...
        public Builder estimatedDbServerPatchingTime(Integer estimatedDbServerPatchingTime) {
            if (estimatedDbServerPatchingTime == null) {
              throw new MissingRequiredPropertyException("GetMaintenanceRunEstimatedPatchingTime", "estimatedDbServerPatchingTime");
            }
        ...
        public Builder estimatedNetworkSwitchesPatchingTime(Integer estimatedNetworkSwitchesPatchingTime) {
            if (estimatedNetworkSwitchesPatchingTime == null) {
              throw new MissingRequiredPropertyException("GetMaintenanceRunEstimatedPatchingTime", "estimatedNetworkSwitchesPatchingTime");
            }
        ...
        public Builder estimatedStorageServerPatchingTime(Integer estimatedStorageServerPatchingTime) {
            if (estimatedStorageServerPatchingTime == null) {
              throw new MissingRequiredPropertyException("GetMaintenanceRunEstimatedPatchingTime", "estimatedStorageServerPatchingTime");
            }
        ...
        public Builder totalEstimatedPatchingTime(Integer totalEstimatedPatchingTime) {
            if (totalEstimatedPatchingTime == null) {
              throw new MissingRequiredPropertyException("GetMaintenanceRunEstimatedPatchingTime", "totalEstimatedPatchingTime");
            }
            this.totalEstimatedPatchingTime = totalEstimatedPatchingTime;
            return this;
        }
        public GetMaintenanceRunEstimatedPatchingTime build() {
            final var _resultValue = new GetMaintenanceRunEstimatedPatchingTime();
