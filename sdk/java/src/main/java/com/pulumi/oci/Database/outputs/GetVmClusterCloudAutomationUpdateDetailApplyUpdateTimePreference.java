...
@CustomType
public final class GetVmClusterCloudAutomationUpdateDetailApplyUpdateTimePreference {
    /**
    ...
    private GetVmClusterCloudAutomationUpdateDetailApplyUpdateTimePreference() {}
    /**
     * @return End time for polling VM cloud automation software updates for the cluster. If the endTime is not specified, 2 AM UTC is used by default.
     * 
     */
    ...
    public static Builder builder(GetVmClusterCloudAutomationUpdateDetailApplyUpdateTimePreference defaults) {
    ...
    public static final class Builder {
        ...
        private String applyUpdatePreferredStartTime;
        public Builder() {}
        public Builder(GetVmClusterCloudAutomationUpdateDetailApplyUpdateTimePreference defaults) {
        ...
        public Builder applyUpdatePreferredEndTime(String applyUpdatePreferredEndTime) {
            if (applyUpdatePreferredEndTime == null) {
              throw new MissingRequiredPropertyException("GetVmClusterCloudAutomationUpdateDetailApplyUpdateTimePreference", "applyUpdatePreferredEndTime");
            }
        ...
        public Builder applyUpdatePreferredStartTime(String applyUpdatePreferredStartTime) {
            if (applyUpdatePreferredStartTime == null) {
              throw new MissingRequiredPropertyException("GetVmClusterCloudAutomationUpdateDetailApplyUpdateTimePreference", "applyUpdatePreferredStartTime");
            }
            this.applyUpdatePreferredStartTime = applyUpdatePreferredStartTime;
            return this;
        }
        public GetVmClusterCloudAutomationUpdateDetailApplyUpdateTimePreference build() {
            final var _resultValue = new GetVmClusterCloudAutomationUpdateDetailApplyUpdateTimePreference();
