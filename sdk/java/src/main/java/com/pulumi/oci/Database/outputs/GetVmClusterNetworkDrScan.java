...
public final class GetVmClusterNetworkDrScan {
    ...
    public static final class Builder {
        ...
        public Builder hostname(String hostname) {
            if (hostname == null) {
              throw new MissingRequiredPropertyException("GetVmClusterNetworkDrScan", "hostname");
            }
        ...
        public Builder ips(List<String> ips) {
            if (ips == null) {
              throw new MissingRequiredPropertyException("GetVmClusterNetworkDrScan", "ips");
            }
            this.ips = ips;
            return this;
        }
        ...
        public Builder scanListenerPortTcp(Integer scanListenerPortTcp) {
            if (scanListenerPortTcp == null) {
              throw new MissingRequiredPropertyException("GetVmClusterNetworkDrScan", "scanListenerPortTcp");
            }
        ...
        public Builder scanListenerPortTcpSsl(Integer scanListenerPortTcpSsl) {
            if (scanListenerPortTcpSsl == null) {
              throw new MissingRequiredPropertyException("GetVmClusterNetworkDrScan", "scanListenerPortTcpSsl");
            }
