...
public final class GetVmClusterNetworksVmClusterNetworkDrScan {
    ...
    public static final class Builder {
        ...
        public Builder hostname(String hostname) {
            if (hostname == null) {
              throw new MissingRequiredPropertyException("GetVmClusterNetworksVmClusterNetworkDrScan", "hostname");
            }
        ...
        public Builder ips(List<String> ips) {
            if (ips == null) {
              throw new MissingRequiredPropertyException("GetVmClusterNetworksVmClusterNetworkDrScan", "ips");
            }
            this.ips = ips;
            return this;
        }
        ...
        public Builder scanListenerPortTcp(Integer scanListenerPortTcp) {
            if (scanListenerPortTcp == null) {
              throw new MissingRequiredPropertyException("GetVmClusterNetworksVmClusterNetworkDrScan", "scanListenerPortTcp");
            }
        ...
        public Builder scanListenerPortTcpSsl(Integer scanListenerPortTcpSsl) {
            if (scanListenerPortTcpSsl == null) {
              throw new MissingRequiredPropertyException("GetVmClusterNetworksVmClusterNetworkDrScan", "scanListenerPortTcpSsl");
            }
            this.scanListenerPortTcpSsl = scanListenerPortTcpSsl;
            return this;
        }
        public GetVmClusterNetworksVmClusterNetworkDrScan build() {
            final var _resultValue = new GetVmClusterNetworksVmClusterNetworkDrScan();
