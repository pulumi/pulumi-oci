...
public final class GetVmClusterNetworksVmClusterNetworkScan {
    ...
    public static final class Builder {
        ...
        public Builder hostname(String hostname) {
            if (hostname == null) {
              throw new MissingRequiredPropertyException("GetVmClusterNetworksVmClusterNetworkScan", "hostname");
            }
        ...
        public Builder ips(List<String> ips) {
            if (ips == null) {
              throw new MissingRequiredPropertyException("GetVmClusterNetworksVmClusterNetworkScan", "ips");
            }
            this.ips = ips;
            return this;
        }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetVmClusterNetworksVmClusterNetworkScan", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder scanListenerPortTcp(Integer scanListenerPortTcp) {
            if (scanListenerPortTcp == null) {
              throw new MissingRequiredPropertyException("GetVmClusterNetworksVmClusterNetworkScan", "scanListenerPortTcp");
            }
        ...
        public Builder scanListenerPortTcpSsl(Integer scanListenerPortTcpSsl) {
            if (scanListenerPortTcpSsl == null) {
              throw new MissingRequiredPropertyException("GetVmClusterNetworksVmClusterNetworkScan", "scanListenerPortTcpSsl");
            }
            this.scanListenerPortTcpSsl = scanListenerPortTcpSsl;
            return this;
        }
        public GetVmClusterNetworksVmClusterNetworkScan build() {
            final var _resultValue = new GetVmClusterNetworksVmClusterNetworkScan();
