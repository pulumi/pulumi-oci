...
public final class GetVmClusterRecommendedNetworkScan {
    ...
    public static final class Builder {
        ...
        public Builder hostname(String hostname) {
            if (hostname == null) {
              throw new MissingRequiredPropertyException("GetVmClusterRecommendedNetworkScan", "hostname");
            }
        ...
        public Builder ips(List<String> ips) {
            if (ips == null) {
              throw new MissingRequiredPropertyException("GetVmClusterRecommendedNetworkScan", "ips");
            }
            this.ips = ips;
            return this;
        }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetVmClusterRecommendedNetworkScan", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder scanListenerPortTcp(Integer scanListenerPortTcp) {
            if (scanListenerPortTcp == null) {
              throw new MissingRequiredPropertyException("GetVmClusterRecommendedNetworkScan", "scanListenerPortTcp");
            }
        ...
        public Builder scanListenerPortTcpSsl(Integer scanListenerPortTcpSsl) {
            if (scanListenerPortTcpSsl == null) {
              throw new MissingRequiredPropertyException("GetVmClusterRecommendedNetworkScan", "scanListenerPortTcpSsl");
            }
