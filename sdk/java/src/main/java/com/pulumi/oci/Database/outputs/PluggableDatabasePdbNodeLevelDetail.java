...
@CustomType
public final class PluggableDatabasePdbNodeLevelDetail {
    /**
    ...
    private PluggableDatabasePdbNodeLevelDetail() {}
    /**
     * @return The Node name of the Database Instance.
     * 
     */
    ...
    public static Builder builder(PluggableDatabasePdbNodeLevelDetail defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String openMode;
        public Builder() {}
        public Builder(PluggableDatabasePdbNodeLevelDetail defaults) {
        ...
        public PluggableDatabasePdbNodeLevelDetail build() {
            final var _resultValue = new PluggableDatabasePdbNodeLevelDetail();
