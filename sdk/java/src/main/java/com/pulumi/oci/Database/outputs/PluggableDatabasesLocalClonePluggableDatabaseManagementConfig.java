...
@CustomType
public final class PluggableDatabasesLocalClonePluggableDatabaseManagementConfig {
    /**
    ...
    private PluggableDatabasesLocalClonePluggableDatabaseManagementConfig() {}
    /**
     * @return The status of the Pluggable Database Management service.
     * 
     */
    ...
    public static Builder builder(PluggableDatabasesLocalClonePluggableDatabaseManagementConfig defaults) {
    ...
    public static final class Builder {
        private @Nullable String managementStatus;
        public Builder() {}
        public Builder(PluggableDatabasesLocalClonePluggableDatabaseManagementConfig defaults) {
