...
@CustomType
public final class VmClusterRemoveVirtualMachineCloudAutomationUpdateDetailApplyUpdateTimePreference {
    /**
    ...
    public static Builder builder(VmClusterRemoveVirtualMachineCloudAutomationUpdateDetailApplyUpdateTimePreference defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String applyUpdatePreferredStartTime;
        public Builder() {}
        public Builder(VmClusterRemoveVirtualMachineCloudAutomationUpdateDetailApplyUpdateTimePreference defaults) {
        ...
        public VmClusterRemoveVirtualMachineCloudAutomationUpdateDetailApplyUpdateTimePreference build() {
            final var _resultValue = new VmClusterRemoveVirtualMachineCloudAutomationUpdateDetailApplyUpdateTimePreference();
