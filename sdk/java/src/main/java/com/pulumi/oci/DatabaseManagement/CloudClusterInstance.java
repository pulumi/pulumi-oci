...
import com.pulumi.oci.DatabaseManagement.CloudClusterInstanceArgs;
import com.pulumi.oci.DatabaseManagement.inputs.CloudClusterInstanceState;
 ...
 * 
 */
@ResourceType(type="oci:DatabaseManagement/cloudClusterInstance:CloudClusterInstance")
public class CloudClusterInstance extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="cloudClusterInstanceId", refs={String.class}, tree="[0]")
     ...
     */
    public CloudClusterInstance(java.lang.String name) {
        this(name, CloudClusterInstanceArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public CloudClusterInstance(java.lang.String name, CloudClusterInstanceArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CloudClusterInstance(java.lang.String name, CloudClusterInstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DatabaseManagement/cloudClusterInstance:CloudClusterInstance", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CloudClusterInstance(java.lang.String name, Output<java.lang.String> id, @Nullable CloudClusterInstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DatabaseManagement/cloudClusterInstance:CloudClusterInstance", name, state, makeResourceOptions(options, id), false);
    }

    private static CloudClusterInstanceArgs makeArgs(CloudClusterInstanceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? CloudClusterInstanceArgs.Empty : args;
    }
     ...
     */
    public static CloudClusterInstance get(java.lang.String name, Output<java.lang.String> id, @Nullable CloudClusterInstanceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
