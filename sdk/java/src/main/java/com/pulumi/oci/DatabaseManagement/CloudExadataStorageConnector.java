...
import com.pulumi.oci.DatabaseManagement.inputs.CloudExadataStorageConnectorState;
import com.pulumi.oci.DatabaseManagement.outputs.CloudExadataStorageConnectorCredentialInfo;
 ...
 * 
 */
@ResourceType(type="oci:DatabaseManagement/cloudExadataStorageConnector:CloudExadataStorageConnector")
public class CloudExadataStorageConnector extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="credentialInfo", refs={CloudExadataStorageConnectorCredentialInfo.class}, tree="[0]")
    private Output<CloudExadataStorageConnectorCredentialInfo> credentialInfo;

    /**
     * @return (Updatable) The user credential information.
     * 
     */
    public Output<CloudExadataStorageConnectorCredentialInfo> credentialInfo() {
     ...
     */
    public CloudExadataStorageConnector(java.lang.String name) {
        this(name, CloudExadataStorageConnectorArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public CloudExadataStorageConnector(java.lang.String name, CloudExadataStorageConnectorArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public CloudExadataStorageConnector(java.lang.String name, CloudExadataStorageConnectorArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DatabaseManagement/cloudExadataStorageConnector:CloudExadataStorageConnector", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private CloudExadataStorageConnector(java.lang.String name, Output<java.lang.String> id, @Nullable CloudExadataStorageConnectorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DatabaseManagement/cloudExadataStorageConnector:CloudExadataStorageConnector", name, state, makeResourceOptions(options, id), false);
    }

    private static CloudExadataStorageConnectorArgs makeArgs(CloudExadataStorageConnectorArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? CloudExadataStorageConnectorArgs.Empty : args;
    }
     ...
     */
    public static CloudExadataStorageConnector get(java.lang.String name, Output<java.lang.String> id, @Nullable CloudExadataStorageConnectorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
