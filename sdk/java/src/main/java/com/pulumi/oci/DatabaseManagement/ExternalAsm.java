...
import com.pulumi.oci.DatabaseManagement.ExternalAsmArgs;
import com.pulumi.oci.DatabaseManagement.inputs.ExternalAsmState;
import com.pulumi.oci.DatabaseManagement.outputs.ExternalAsmServicedDatabase;
 ...
 * 
 */
@ResourceType(type="oci:DatabaseManagement/externalAsm:ExternalAsm")
public class ExternalAsm extends com.pulumi.resources.CustomResource {
    /**
    ...
    public ExternalAsm(String name, ExternalAsmArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DatabaseManagement/externalAsm:ExternalAsm", name, args == null ? ExternalAsmArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
