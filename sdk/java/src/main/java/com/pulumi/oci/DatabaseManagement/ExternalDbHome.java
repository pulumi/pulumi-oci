...
import com.pulumi.oci.DatabaseManagement.ExternalDbHomeArgs;
import com.pulumi.oci.DatabaseManagement.inputs.ExternalDbHomeState;
 ...
 * 
 */
@ResourceType(type="oci:DatabaseManagement/externalDbHome:ExternalDbHome")
public class ExternalDbHome extends com.pulumi.resources.CustomResource {
    /**
     ...
     */
    public ExternalDbHome(java.lang.String name) {
        this(name, ExternalDbHomeArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public ExternalDbHome(java.lang.String name, ExternalDbHomeArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ExternalDbHome(java.lang.String name, ExternalDbHomeArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DatabaseManagement/externalDbHome:ExternalDbHome", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ExternalDbHome(java.lang.String name, Output<java.lang.String> id, @Nullable ExternalDbHomeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DatabaseManagement/externalDbHome:ExternalDbHome", name, state, makeResourceOptions(options, id), false);
    }

    private static ExternalDbHomeArgs makeArgs(ExternalDbHomeArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? ExternalDbHomeArgs.Empty : args;
    }
     ...
     */
    public static ExternalDbHome get(java.lang.String name, Output<java.lang.String> id, @Nullable ExternalDbHomeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
