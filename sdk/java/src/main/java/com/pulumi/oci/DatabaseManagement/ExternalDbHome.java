...
public class ExternalDbHome extends com.pulumi.resources.CustomResource {
     ...
     */
    public ExternalDbHome(String name) {
     ...
     */
    public ExternalDbHome(String name, ExternalDbHomeArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DatabaseManagement/externalDbHome:ExternalDbHome", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }

    private ExternalDbHome(String name, Output<String> id, @Nullable ExternalDbHomeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DatabaseManagement/externalDbHome:ExternalDbHome", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static ExternalDbHome get(String name, Output<String> id, @Nullable ExternalDbHomeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
