...
public class ExternalExadataStorageServer extends com.pulumi.resources.CustomResource {
    ...
    public ExternalExadataStorageServer(String name, ExternalExadataStorageServerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DatabaseManagement/externalExadataStorageServer:ExternalExadataStorageServer", name, args == null ? ExternalExadataStorageServerArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
