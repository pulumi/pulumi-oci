...
public class ExternalnoncontainerdatabaseExternalNonContainerDbmFeaturesManagement extends com.pulumi.resources.CustomResource {
    ...
    public ExternalnoncontainerdatabaseExternalNonContainerDbmFeaturesManagement(String name, ExternalnoncontainerdatabaseExternalNonContainerDbmFeaturesManagementArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DatabaseManagement/externalnoncontainerdatabaseExternalNonContainerDbmFeaturesManagement:ExternalnoncontainerdatabaseExternalNonContainerDbmFeaturesManagement", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()));
    }
