 ...
 *                 .credentialType(var_.named_credential_content_credential_type())
 *                 .passwordSecretAccessMode(var_.named_credential_content_password_secret_access_mode())
 *                 .passwordSecretId(oci_vault_secret.test_secret().id())
 *                 .role(var_.named_credential_content_role())
