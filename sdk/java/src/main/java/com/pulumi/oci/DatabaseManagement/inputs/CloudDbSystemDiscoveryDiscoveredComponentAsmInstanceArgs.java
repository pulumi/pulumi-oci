...
public final class CloudDbSystemDiscoveryDiscoveredComponentAsmInstanceArgs extends com.pulumi.resources.ResourceArgs {

    public static final CloudDbSystemDiscoveryDiscoveredComponentAsmInstanceArgs Empty = new CloudDbSystemDiscoveryDiscoveredComponentAsmInstanceArgs();
    ...
    private CloudDbSystemDiscoveryDiscoveredComponentAsmInstanceArgs() {}

    private CloudDbSystemDiscoveryDiscoveredComponentAsmInstanceArgs(CloudDbSystemDiscoveryDiscoveredComponentAsmInstanceArgs $) {
    ...
    public static Builder builder(CloudDbSystemDiscoveryDiscoveredComponentAsmInstanceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CloudDbSystemDiscoveryDiscoveredComponentAsmInstanceArgs();
        }

        public Builder(CloudDbSystemDiscoveryDiscoveredComponentAsmInstanceArgs defaults) {
            $ = new CloudDbSystemDiscoveryDiscoveredComponentAsmInstanceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CloudDbSystemDiscoveryDiscoveredComponentAsmInstanceArgs build() {
            return $;
        }
    }
