...
public final class CloudDbSystemDiscoveryDiscoveredComponentDbInstanceArgs extends com.pulumi.resources.ResourceArgs {

    public static final CloudDbSystemDiscoveryDiscoveredComponentDbInstanceArgs Empty = new CloudDbSystemDiscoveryDiscoveredComponentDbInstanceArgs();
    ...
    private CloudDbSystemDiscoveryDiscoveredComponentDbInstanceArgs() {}

    private CloudDbSystemDiscoveryDiscoveredComponentDbInstanceArgs(CloudDbSystemDiscoveryDiscoveredComponentDbInstanceArgs $) {
    ...
    public static Builder builder(CloudDbSystemDiscoveryDiscoveredComponentDbInstanceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CloudDbSystemDiscoveryDiscoveredComponentDbInstanceArgs();
        }

        public Builder(CloudDbSystemDiscoveryDiscoveredComponentDbInstanceArgs defaults) {
            $ = new CloudDbSystemDiscoveryDiscoveredComponentDbInstanceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CloudDbSystemDiscoveryDiscoveredComponentDbInstanceArgs build() {
            return $;
        }
    }
