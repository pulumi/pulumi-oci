...
public final class CloudExadataStorageConnectorCredentialInfoArgs extends com.pulumi.resources.ResourceArgs {

    public static final CloudExadataStorageConnectorCredentialInfoArgs Empty = new CloudExadataStorageConnectorCredentialInfoArgs();
    ...
    private CloudExadataStorageConnectorCredentialInfoArgs() {}

    private CloudExadataStorageConnectorCredentialInfoArgs(CloudExadataStorageConnectorCredentialInfoArgs $) {
    ...
    public static Builder builder(CloudExadataStorageConnectorCredentialInfoArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CloudExadataStorageConnectorCredentialInfoArgs();
        }

        public Builder(CloudExadataStorageConnectorCredentialInfoArgs defaults) {
            $ = new CloudExadataStorageConnectorCredentialInfoArgs(Objects.requireNonNull(defaults));
        }
        ...
        public CloudExadataStorageConnectorCredentialInfoArgs build() {
            if ($.password == null) {
                throw new MissingRequiredPropertyException("CloudExadataStorageConnectorCredentialInfoArgs", "password");
            }
            if ($.username == null) {
                throw new MissingRequiredPropertyException("CloudExadataStorageConnectorCredentialInfoArgs", "username");
            }
            return $;
        }
    }
