...
import com.pulumi.oci.DatabaseManagement.inputs.CloudExadataStorageServerConnectorArgs;
...
public final class CloudExadataStorageServerState extends com.pulumi.resources.ResourceArgs {

    public static final CloudExadataStorageServerState Empty = new CloudExadataStorageServerState();
     ...
     * 
     */
    @Import(name="cloudExadataStorageServerId")
    private @Nullable Output<String> cloudExadataStorageServerId;

    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata storage server.
     * 
     */
    public Optional<Output<String>> cloudExadataStorageServerId() {
        return Optional.ofNullable(this.cloudExadataStorageServerId);
    }
    ...
    private @Nullable Output<List<CloudExadataStorageServerConnectorArgs>> connectors;

    /**
     * @return The connector of the Exadata storage server.
     * 
     */
    public Optional<Output<List<CloudExadataStorageServerConnectorArgs>>> connectors() {
    ...
    private CloudExadataStorageServerState() {}

    private CloudExadataStorageServerState(CloudExadataStorageServerState $) {
    ...
    public static Builder builder(CloudExadataStorageServerState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new CloudExadataStorageServerState();
        }

        public Builder(CloudExadataStorageServerState defaults) {
            $ = new CloudExadataStorageServerState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder cloudExadataStorageServerId(@Nullable Output<String> cloudExadataStorageServerId) {
         ...
         * 
         */
        public Builder connectors(@Nullable Output<List<CloudExadataStorageServerConnectorArgs>> connectors) {
         ...
         * 
         */
        public Builder connectors(List<CloudExadataStorageServerConnectorArgs> connectors) {
         ...
         * 
         */
        public Builder connectors(CloudExadataStorageServerConnectorArgs... connectors) {
        ...
        public CloudExadataStorageServerState build() {
            return $;
        }
    }
