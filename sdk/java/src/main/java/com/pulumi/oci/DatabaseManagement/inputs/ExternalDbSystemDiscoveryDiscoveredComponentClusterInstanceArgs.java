...
import com.pulumi.oci.DatabaseManagement.inputs.ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs;
...
public final class ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<List<ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs>> connectors;

    /**
     * @return The connector details used to connect to the external DB system component.
     * 
     */
    public Optional<Output<List<ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs>>> connectors() {
    ...
    private ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceArgs() {}

    private ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceArgs(ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceArgs $) {
    ...
    public static Builder builder(ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceArgs();
        }

        public Builder(ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceArgs defaults) {
            $ = new ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder connectors(@Nullable Output<List<ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs>> connectors) {
         ...
         * 
         */
        public Builder connectors(List<ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs> connectors) {
         ...
         * 
         */
        public Builder connectors(ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs... connectors) {
        ...
        public ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceArgs build() {
            return $;
        }
    }
