...
import com.pulumi.oci.DatabaseManagement.inputs.ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfoArgs;
...
public final class ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs extends com.pulumi.resources.ResourceArgs {

    public static final ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs Empty = new ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs();
    ...
    private @Nullable Output<List<ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfoArgs>> connectionInfos;

    /**
     * @return The connection details required to connect to an external DB system component.
     * 
     */
    public Optional<Output<List<ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfoArgs>>> connectionInfos() {
    ...
    private ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs() {}

    private ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs(ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs $) {
    ...
    public static Builder builder(ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs();
        }

        public Builder(ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs defaults) {
            $ = new ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder connectionInfos(@Nullable Output<List<ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfoArgs>> connectionInfos) {
         ...
         * 
         */
        public Builder connectionInfos(List<ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfoArgs> connectionInfos) {
         ...
         * 
         */
        public Builder connectionInfos(ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfoArgs... connectionInfos) {
        ...
        public ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs build() {
            return $;
        }
    }
