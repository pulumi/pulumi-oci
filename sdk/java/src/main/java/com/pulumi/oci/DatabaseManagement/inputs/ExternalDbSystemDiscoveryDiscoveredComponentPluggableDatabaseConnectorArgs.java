...
import com.pulumi.oci.DatabaseManagement.inputs.ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorConnectionInfoArgs;
...
public final class ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorArgs extends com.pulumi.resources.ResourceArgs {

    public static final ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorArgs Empty = new ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorArgs();
    ...
    private @Nullable Output<List<ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorConnectionInfoArgs>> connectionInfos;

    /**
     * @return The connection details required to connect to an external DB system component.
     * 
     */
    public Optional<Output<List<ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorConnectionInfoArgs>>> connectionInfos() {
    ...
    private ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorArgs() {}

    private ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorArgs(ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorArgs $) {
    ...
    public static Builder builder(ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorArgs();
        }

        public Builder(ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorArgs defaults) {
            $ = new ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder connectionInfos(@Nullable Output<List<ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorConnectionInfoArgs>> connectionInfos) {
         ...
         * 
         */
        public Builder connectionInfos(List<ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorConnectionInfoArgs> connectionInfos) {
         ...
         * 
         */
        public Builder connectionInfos(ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorConnectionInfoArgs... connectionInfos) {
        ...
        public ExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorArgs build() {
            return $;
        }
    }
