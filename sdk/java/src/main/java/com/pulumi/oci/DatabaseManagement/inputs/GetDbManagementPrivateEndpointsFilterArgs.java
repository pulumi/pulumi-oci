...
public final class GetDbManagementPrivateEndpointsFilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public GetDbManagementPrivateEndpointsFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetDbManagementPrivateEndpointsFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetDbManagementPrivateEndpointsFilterArgs", "values");
            }
            return $;
        }
    }
