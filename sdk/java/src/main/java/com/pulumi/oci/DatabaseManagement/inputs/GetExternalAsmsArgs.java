...
import com.pulumi.oci.DatabaseManagement.inputs.GetExternalAsmsFilterArgs;
...
public final class GetExternalAsmsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetExternalAsmsArgs Empty = new GetExternalAsmsArgs();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetExternalAsmsFilterArgs>> filters;

    public Optional<Output<List<GetExternalAsmsFilterArgs>>> filters() {
        return Optional.ofNullable(this.filters);
    }

    private GetExternalAsmsArgs() {}

    private GetExternalAsmsArgs(GetExternalAsmsArgs $) {
    ...
    public static Builder builder(GetExternalAsmsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetExternalAsmsArgs();
        }

        public Builder(GetExternalAsmsArgs defaults) {
            $ = new GetExternalAsmsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetExternalAsmsFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetExternalAsmsFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetExternalAsmsFilterArgs... filters) {
            return filters(List.of(filters));
        }

        public GetExternalAsmsArgs build() {
            return $;
        }
    }
