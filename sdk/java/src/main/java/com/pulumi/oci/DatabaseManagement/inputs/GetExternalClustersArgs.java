...
import com.pulumi.oci.DatabaseManagement.inputs.GetExternalClustersFilterArgs;
...
public final class GetExternalClustersArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetExternalClustersArgs Empty = new GetExternalClustersArgs();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetExternalClustersFilterArgs>> filters;

    public Optional<Output<List<GetExternalClustersFilterArgs>>> filters() {
        return Optional.ofNullable(this.filters);
    }

    private GetExternalClustersArgs() {}

    private GetExternalClustersArgs(GetExternalClustersArgs $) {
    ...
    public static Builder builder(GetExternalClustersArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetExternalClustersArgs();
        }

        public Builder(GetExternalClustersArgs defaults) {
            $ = new GetExternalClustersArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetExternalClustersFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetExternalClustersFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetExternalClustersFilterArgs... filters) {
            return filters(List.of(filters));
        }

        public GetExternalClustersArgs build() {
            return $;
        }
    }
