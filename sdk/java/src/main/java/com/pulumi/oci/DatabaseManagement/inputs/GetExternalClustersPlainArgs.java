...
import com.pulumi.oci.DatabaseManagement.inputs.GetExternalClustersFilter;
...
public final class GetExternalClustersPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetExternalClustersPlainArgs Empty = new GetExternalClustersPlainArgs();
    ...
    public Optional<List<GetExternalClustersFilter>> filters() {
        return Optional.ofNullable(this.filters);
    }

    private GetExternalClustersPlainArgs() {}

    private GetExternalClustersPlainArgs(GetExternalClustersPlainArgs $) {
    ...
    public static Builder builder(GetExternalClustersPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetExternalClustersPlainArgs();
        }

        public Builder(GetExternalClustersPlainArgs defaults) {
            $ = new GetExternalClustersPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetExternalClustersPlainArgs build() {
            return $;
        }
    }
