...
import com.pulumi.oci.DatabaseManagement.inputs.GetExternalDbHomesFilterArgs;
...
public final class GetExternalDbHomesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetExternalDbHomesArgs Empty = new GetExternalDbHomesArgs();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetExternalDbHomesFilterArgs>> filters;

    public Optional<Output<List<GetExternalDbHomesFilterArgs>>> filters() {
        return Optional.ofNullable(this.filters);
    }

    private GetExternalDbHomesArgs() {}

    private GetExternalDbHomesArgs(GetExternalDbHomesArgs $) {
    ...
    public static Builder builder(GetExternalDbHomesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetExternalDbHomesArgs();
        }

        public Builder(GetExternalDbHomesArgs defaults) {
            $ = new GetExternalDbHomesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetExternalDbHomesFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetExternalDbHomesFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetExternalDbHomesFilterArgs... filters) {
            return filters(List.of(filters));
        }

        public GetExternalDbHomesArgs build() {
            return $;
        }
    }
