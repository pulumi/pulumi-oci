...
import com.pulumi.oci.DatabaseManagement.inputs.GetExternalDbHomesFilter;
...
public final class GetExternalDbHomesPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetExternalDbHomesPlainArgs Empty = new GetExternalDbHomesPlainArgs();
    ...
    public Optional<List<GetExternalDbHomesFilter>> filters() {
        return Optional.ofNullable(this.filters);
    }

    private GetExternalDbHomesPlainArgs() {}

    private GetExternalDbHomesPlainArgs(GetExternalDbHomesPlainArgs $) {
    ...
    public static Builder builder(GetExternalDbHomesPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetExternalDbHomesPlainArgs();
        }

        public Builder(GetExternalDbHomesPlainArgs defaults) {
            $ = new GetExternalDbHomesPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetExternalDbHomesPlainArgs build() {
            return $;
        }
    }
