...
import com.pulumi.oci.DatabaseManagement.inputs.GetExternalDbSystemConnectorsFilter;
...
public final class GetExternalDbSystemConnectorsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetExternalDbSystemConnectorsPlainArgs Empty = new GetExternalDbSystemConnectorsPlainArgs();
    ...
    public Optional<List<GetExternalDbSystemConnectorsFilter>> filters() {
        return Optional.ofNullable(this.filters);
    }

    private GetExternalDbSystemConnectorsPlainArgs() {}

    private GetExternalDbSystemConnectorsPlainArgs(GetExternalDbSystemConnectorsPlainArgs $) {
    ...
    public static Builder builder(GetExternalDbSystemConnectorsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetExternalDbSystemConnectorsPlainArgs();
        }

        public Builder(GetExternalDbSystemConnectorsPlainArgs defaults) {
            $ = new GetExternalDbSystemConnectorsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetExternalDbSystemConnectorsPlainArgs build() {
            return $;
        }
    }
