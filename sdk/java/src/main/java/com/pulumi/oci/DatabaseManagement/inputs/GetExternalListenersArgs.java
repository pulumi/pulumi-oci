...
import com.pulumi.oci.DatabaseManagement.inputs.GetExternalListenersFilterArgs;
...
public final class GetExternalListenersArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetExternalListenersArgs Empty = new GetExternalListenersArgs();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetExternalListenersFilterArgs>> filters;

    public Optional<Output<List<GetExternalListenersFilterArgs>>> filters() {
        return Optional.ofNullable(this.filters);
    }

    private GetExternalListenersArgs() {}

    private GetExternalListenersArgs(GetExternalListenersArgs $) {
    ...
    public static Builder builder(GetExternalListenersArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetExternalListenersArgs();
        }

        public Builder(GetExternalListenersArgs defaults) {
            $ = new GetExternalListenersArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetExternalListenersFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetExternalListenersFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetExternalListenersFilterArgs... filters) {
            return filters(List.of(filters));
        }

        public GetExternalListenersArgs build() {
            return $;
        }
    }
