    ...
    public static final class Builder {
        ...
        public GetJobExecutionsStatusesPlainArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetJobExecutionsStatusesPlainArgs", "compartmentId");
            }
            if ($.endTime == null) {
                throw new MissingRequiredPropertyException("GetJobExecutionsStatusesPlainArgs", "endTime");
            }
            if ($.startTime == null) {
                throw new MissingRequiredPropertyException("GetJobExecutionsStatusesPlainArgs", "startTime");
            }
            return $;
        }
    }
