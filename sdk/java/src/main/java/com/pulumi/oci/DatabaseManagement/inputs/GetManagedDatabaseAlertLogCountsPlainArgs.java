...
import com.pulumi.oci.DatabaseManagement.inputs.GetManagedDatabaseAlertLogCountsFilter;
...
public final class GetManagedDatabaseAlertLogCountsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetManagedDatabaseAlertLogCountsPlainArgs Empty = new GetManagedDatabaseAlertLogCountsPlainArgs();

    @Import(name="filters")
    private @Nullable List<GetManagedDatabaseAlertLogCountsFilter> filters;

    public Optional<List<GetManagedDatabaseAlertLogCountsFilter>> filters() {
    ...
    private GetManagedDatabaseAlertLogCountsPlainArgs() {}

    private GetManagedDatabaseAlertLogCountsPlainArgs(GetManagedDatabaseAlertLogCountsPlainArgs $) {
    ...
    public static Builder builder(GetManagedDatabaseAlertLogCountsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetManagedDatabaseAlertLogCountsPlainArgs();
        }

        public Builder(GetManagedDatabaseAlertLogCountsPlainArgs defaults) {
            $ = new GetManagedDatabaseAlertLogCountsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetManagedDatabaseAlertLogCountsPlainArgs build() {
            if ($.managedDatabaseId == null) {
                throw new MissingRequiredPropertyException("GetManagedDatabaseAlertLogCountsPlainArgs", "managedDatabaseId");
            }
            return $;
        }
    }
