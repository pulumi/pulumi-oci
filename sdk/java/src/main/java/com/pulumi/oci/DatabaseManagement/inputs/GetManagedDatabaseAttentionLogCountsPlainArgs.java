...
import com.pulumi.oci.DatabaseManagement.inputs.GetManagedDatabaseAttentionLogCountsFilter;
...
public final class GetManagedDatabaseAttentionLogCountsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetManagedDatabaseAttentionLogCountsPlainArgs Empty = new GetManagedDatabaseAttentionLogCountsPlainArgs();

    @Import(name="filters")
    private @Nullable List<GetManagedDatabaseAttentionLogCountsFilter> filters;

    public Optional<List<GetManagedDatabaseAttentionLogCountsFilter>> filters() {
    ...
    private GetManagedDatabaseAttentionLogCountsPlainArgs() {}

    private GetManagedDatabaseAttentionLogCountsPlainArgs(GetManagedDatabaseAttentionLogCountsPlainArgs $) {
    ...
    public static Builder builder(GetManagedDatabaseAttentionLogCountsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetManagedDatabaseAttentionLogCountsPlainArgs();
        }

        public Builder(GetManagedDatabaseAttentionLogCountsPlainArgs defaults) {
            $ = new GetManagedDatabaseAttentionLogCountsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetManagedDatabaseAttentionLogCountsPlainArgs build() {
            if ($.managedDatabaseId == null) {
                throw new MissingRequiredPropertyException("GetManagedDatabaseAttentionLogCountsPlainArgs", "managedDatabaseId");
            }
            return $;
        }
    }
