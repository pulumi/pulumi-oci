...
public final class GetManagedDatabaseOptimizerStatisticsAdvisorExecutionArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetManagedDatabaseOptimizerStatisticsAdvisorExecutionArgs Empty = new GetManagedDatabaseOptimizerStatisticsAdvisorExecutionArgs();
    ...
    private GetManagedDatabaseOptimizerStatisticsAdvisorExecutionArgs() {}

    private GetManagedDatabaseOptimizerStatisticsAdvisorExecutionArgs(GetManagedDatabaseOptimizerStatisticsAdvisorExecutionArgs $) {
    ...
    public static Builder builder(GetManagedDatabaseOptimizerStatisticsAdvisorExecutionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetManagedDatabaseOptimizerStatisticsAdvisorExecutionArgs();
        }

        public Builder(GetManagedDatabaseOptimizerStatisticsAdvisorExecutionArgs defaults) {
            $ = new GetManagedDatabaseOptimizerStatisticsAdvisorExecutionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetManagedDatabaseOptimizerStatisticsAdvisorExecutionArgs build() {
            if ($.executionName == null) {
                throw new MissingRequiredPropertyException("GetManagedDatabaseOptimizerStatisticsAdvisorExecutionArgs", "executionName");
            }
            if ($.managedDatabaseId == null) {
                throw new MissingRequiredPropertyException("GetManagedDatabaseOptimizerStatisticsAdvisorExecutionArgs", "managedDatabaseId");
            }
            if ($.taskName == null) {
                throw new MissingRequiredPropertyException("GetManagedDatabaseOptimizerStatisticsAdvisorExecutionArgs", "taskName");
            }
            return $;
        }
    }
