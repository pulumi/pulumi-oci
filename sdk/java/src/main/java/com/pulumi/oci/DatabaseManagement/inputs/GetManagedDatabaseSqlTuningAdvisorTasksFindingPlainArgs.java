...
public final class GetManagedDatabaseSqlTuningAdvisorTasksFindingPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetManagedDatabaseSqlTuningAdvisorTasksFindingPlainArgs Empty = new GetManagedDatabaseSqlTuningAdvisorTasksFindingPlainArgs();
    ...
    private GetManagedDatabaseSqlTuningAdvisorTasksFindingPlainArgs() {}

    private GetManagedDatabaseSqlTuningAdvisorTasksFindingPlainArgs(GetManagedDatabaseSqlTuningAdvisorTasksFindingPlainArgs $) {
    ...
    public static Builder builder(GetManagedDatabaseSqlTuningAdvisorTasksFindingPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetManagedDatabaseSqlTuningAdvisorTasksFindingPlainArgs();
        }

        public Builder(GetManagedDatabaseSqlTuningAdvisorTasksFindingPlainArgs defaults) {
            $ = new GetManagedDatabaseSqlTuningAdvisorTasksFindingPlainArgs(Objects.requireNonNull(defaults));
        }
