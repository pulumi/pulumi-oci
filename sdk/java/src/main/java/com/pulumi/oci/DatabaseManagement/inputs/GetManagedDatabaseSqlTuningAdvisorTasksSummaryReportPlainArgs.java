    ...
    public static final class Builder {
        ...
        public GetManagedDatabaseSqlTuningAdvisorTasksSummaryReportPlainArgs build() {
            if ($.managedDatabaseId == null) {
                throw new MissingRequiredPropertyException("GetManagedDatabaseSqlTuningAdvisorTasksSummaryReportPlainArgs", "managedDatabaseId");
            }
            if ($.sqlTuningAdvisorTaskId == null) {
                throw new MissingRequiredPropertyException("GetManagedDatabaseSqlTuningAdvisorTasksSummaryReportPlainArgs", "sqlTuningAdvisorTaskId");
            }
            return $;
        }
    }
