    ...
    public static final class Builder {
        ...
        public GetManagedDatabaseUserConsumerGroupPrivilegesArgs build() {
            if ($.managedDatabaseId == null) {
                throw new MissingRequiredPropertyException("GetManagedDatabaseUserConsumerGroupPrivilegesArgs", "managedDatabaseId");
            }
            if ($.userName == null) {
                throw new MissingRequiredPropertyException("GetManagedDatabaseUserConsumerGroupPrivilegesArgs", "userName");
            }
            return $;
        }
    }
