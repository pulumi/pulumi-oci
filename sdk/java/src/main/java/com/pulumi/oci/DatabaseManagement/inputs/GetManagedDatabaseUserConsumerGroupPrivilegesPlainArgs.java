    ...
    public static final class Builder {
        ...
        public GetManagedDatabaseUserConsumerGroupPrivilegesPlainArgs build() {
            if ($.managedDatabaseId == null) {
                throw new MissingRequiredPropertyException("GetManagedDatabaseUserConsumerGroupPrivilegesPlainArgs", "managedDatabaseId");
            }
            if ($.userName == null) {
                throw new MissingRequiredPropertyException("GetManagedDatabaseUserConsumerGroupPrivilegesPlainArgs", "userName");
            }
            return $;
        }
    }
