    ...
    public static final class Builder {
        ...
        public GetManagedDatabaseUserProxiedForUsersArgs build() {
            if ($.managedDatabaseId == null) {
                throw new MissingRequiredPropertyException("GetManagedDatabaseUserProxiedForUsersArgs", "managedDatabaseId");
            }
            if ($.userName == null) {
                throw new MissingRequiredPropertyException("GetManagedDatabaseUserProxiedForUsersArgs", "userName");
            }
            return $;
        }
    }
