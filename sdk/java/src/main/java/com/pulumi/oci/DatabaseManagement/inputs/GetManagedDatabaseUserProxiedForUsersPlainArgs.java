...
public final class GetManagedDatabaseUserProxiedForUsersPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetManagedDatabaseUserProxiedForUsersPlainArgs Empty = new GetManagedDatabaseUserProxiedForUsersPlainArgs();
    ...
    private GetManagedDatabaseUserProxiedForUsersPlainArgs() {}

    private GetManagedDatabaseUserProxiedForUsersPlainArgs(GetManagedDatabaseUserProxiedForUsersPlainArgs $) {
    ...
    public static Builder builder(GetManagedDatabaseUserProxiedForUsersPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetManagedDatabaseUserProxiedForUsersPlainArgs();
        }

        public Builder(GetManagedDatabaseUserProxiedForUsersPlainArgs defaults) {
            $ = new GetManagedDatabaseUserProxiedForUsersPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetManagedDatabaseUserProxiedForUsersPlainArgs build() {
            if ($.managedDatabaseId == null) {
                throw new MissingRequiredPropertyException("GetManagedDatabaseUserProxiedForUsersPlainArgs", "managedDatabaseId");
            }
            if ($.userName == null) {
                throw new MissingRequiredPropertyException("GetManagedDatabaseUserProxiedForUsersPlainArgs", "userName");
            }
            return $;
        }
    }
