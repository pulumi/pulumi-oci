...
import com.pulumi.oci.DatabaseManagement.inputs.GetManagedDatabaseUserRolesFilter;
...
public final class GetManagedDatabaseUserRolesPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetManagedDatabaseUserRolesPlainArgs Empty = new GetManagedDatabaseUserRolesPlainArgs();

    @Import(name="filters")
    private @Nullable List<GetManagedDatabaseUserRolesFilter> filters;

    public Optional<List<GetManagedDatabaseUserRolesFilter>> filters() {
    ...
    private GetManagedDatabaseUserRolesPlainArgs() {}

    private GetManagedDatabaseUserRolesPlainArgs(GetManagedDatabaseUserRolesPlainArgs $) {
    ...
    public static Builder builder(GetManagedDatabaseUserRolesPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetManagedDatabaseUserRolesPlainArgs();
        }

        public Builder(GetManagedDatabaseUserRolesPlainArgs defaults) {
            $ = new GetManagedDatabaseUserRolesPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetManagedDatabaseUserRolesPlainArgs build() {
            if ($.managedDatabaseId == null) {
                throw new MissingRequiredPropertyException("GetManagedDatabaseUserRolesPlainArgs", "managedDatabaseId");
            }
            if ($.userName == null) {
                throw new MissingRequiredPropertyException("GetManagedDatabaseUserRolesPlainArgs", "userName");
            }
            return $;
        }
    }
