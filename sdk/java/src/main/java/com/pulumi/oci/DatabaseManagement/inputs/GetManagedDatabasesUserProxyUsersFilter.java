...
public final class GetManagedDatabasesUserProxyUsersFilter extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetManagedDatabasesUserProxyUsersFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetManagedDatabasesUserProxyUsersFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetManagedDatabasesUserProxyUsersFilter", "values");
            }
            return $;
        }
    }
