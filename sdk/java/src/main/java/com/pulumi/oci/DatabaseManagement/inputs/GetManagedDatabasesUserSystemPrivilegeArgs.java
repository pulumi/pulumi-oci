    ...
    public static final class Builder {
        ...
        public GetManagedDatabasesUserSystemPrivilegeArgs build() {
            if ($.managedDatabaseId == null) {
                throw new MissingRequiredPropertyException("GetManagedDatabasesUserSystemPrivilegeArgs", "managedDatabaseId");
            }
            if ($.userName == null) {
                throw new MissingRequiredPropertyException("GetManagedDatabasesUserSystemPrivilegeArgs", "userName");
            }
            return $;
        }
    }
