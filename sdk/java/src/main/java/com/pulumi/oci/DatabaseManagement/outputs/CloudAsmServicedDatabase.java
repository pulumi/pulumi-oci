...
@CustomType
public final class CloudAsmServicedDatabase {
    /**
     ...
     * 
     */
    private @Nullable List<String> diskGroups;
    /**
    ...
    private CloudAsmServicedDatabase() {}
    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which the cloud database resides.
     * 
     */
    ...
    public static Builder builder(CloudAsmServicedDatabase defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean isManaged;
        public Builder() {}
        public Builder(CloudAsmServicedDatabase defaults) {
        ...
        @CustomType.Setter
        public Builder dbaasId(@Nullable String dbaasId) {
        ...
        public CloudAsmServicedDatabase build() {
            final var _resultValue = new CloudAsmServicedDatabase();
