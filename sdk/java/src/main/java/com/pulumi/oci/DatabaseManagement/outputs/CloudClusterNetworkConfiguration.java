...
public final class CloudClusterNetworkConfiguration {
    ...
    private CloudClusterNetworkConfiguration() {}
    /**
     * @return The network number from which VIPs are obtained.
     * 
     */
    ...
    public static Builder builder(CloudClusterNetworkConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String subnet;
        public Builder() {}
        public Builder(CloudClusterNetworkConfiguration defaults) {
        ...
        public CloudClusterNetworkConfiguration build() {
            final var _resultValue = new CloudClusterNetworkConfiguration();
