...
@CustomType
public final class CloudClusterScanConfiguration {
    /**
    ...
    private CloudClusterScanConfiguration() {}
    /**
     * @return The network number from which VIPs are obtained.
     * 
     */
    ...
    public static Builder builder(CloudClusterScanConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String scanProtocol;
        public Builder() {}
        public Builder(CloudClusterScanConfiguration defaults) {
        ...
        public CloudClusterScanConfiguration build() {
            final var _resultValue = new CloudClusterScanConfiguration();
