...
import com.pulumi.oci.DatabaseManagement.outputs.CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnector;
...
@CustomType
public final class CloudDbSystemDiscoveryDiscoveredComponentClusterInstance {
    /**
     ...
     * 
     */
    private @Nullable List<CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnector> connectors;
    /**
    ...
    private CloudDbSystemDiscoveryDiscoveredComponentClusterInstance() {}
    /**
     * @return The Automatic Diagnostic Repository (ADR) home directory for the DB instance.
     * 
     */
     ...
     * 
     */
    public List<CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnector> connectors() {
    ...
    public static Builder builder(CloudDbSystemDiscoveryDiscoveredComponentClusterInstance defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String nodeRole;
        public Builder() {}
        public Builder(CloudDbSystemDiscoveryDiscoveredComponentClusterInstance defaults) {
        ...
        @CustomType.Setter
        public Builder connectors(@Nullable List<CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnector> connectors) {

            this.connectors = connectors;
            return this;
        }
        public Builder connectors(CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnector... connectors) {
        ...
        public CloudDbSystemDiscoveryDiscoveredComponentClusterInstance build() {
            final var _resultValue = new CloudDbSystemDiscoveryDiscoveredComponentClusterInstance();
