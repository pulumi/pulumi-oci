...
import com.pulumi.oci.DatabaseManagement.outputs.CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfo;
...
@CustomType
public final class CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnector {
    /**
     ...
     * 
     */
    private @Nullable List<CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfo> connectionInfos;
    /**
    ...
    private CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnector() {}
    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management agent used for the cloud DB system discovery.
     * 
     */
     ...
     * 
     */
    public List<CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfo> connectionInfos() {
    ...
    public static Builder builder(CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnector defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String timeConnectionStatusLastUpdated;
        public Builder() {}
        public Builder(CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnector defaults) {
        ...
        @CustomType.Setter
        public Builder connectionInfos(@Nullable List<CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfo> connectionInfos) {

            this.connectionInfos = connectionInfos;
            return this;
        }
        public Builder connectionInfos(CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfo... connectionInfos) {
        ...
        public CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnector build() {
            final var _resultValue = new CloudDbSystemDiscoveryDiscoveredComponentClusterInstanceConnector();
