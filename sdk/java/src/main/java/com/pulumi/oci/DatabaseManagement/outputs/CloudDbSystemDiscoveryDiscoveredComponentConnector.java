...
import com.pulumi.oci.DatabaseManagement.outputs.CloudDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfo;
...
@CustomType
public final class CloudDbSystemDiscoveryDiscoveredComponentConnector {
    /**
     ...
     * 
     */
    private @Nullable List<CloudDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfo> connectionInfos;
    /**
    ...
    private CloudDbSystemDiscoveryDiscoveredComponentConnector() {}
    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management agent used for the cloud DB system discovery.
     * 
     */
     ...
     * 
     */
    public List<CloudDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfo> connectionInfos() {
    ...
    public static Builder builder(CloudDbSystemDiscoveryDiscoveredComponentConnector defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String timeConnectionStatusLastUpdated;
        public Builder() {}
        public Builder(CloudDbSystemDiscoveryDiscoveredComponentConnector defaults) {
        ...
        @CustomType.Setter
        public Builder connectionInfos(@Nullable List<CloudDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfo> connectionInfos) {

            this.connectionInfos = connectionInfos;
            return this;
        }
        public Builder connectionInfos(CloudDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfo... connectionInfos) {
        ...
        public CloudDbSystemDiscoveryDiscoveredComponentConnector build() {
            final var _resultValue = new CloudDbSystemDiscoveryDiscoveredComponentConnector();
