...
@CustomType
public final class CloudExadataStorageConnectorCredentialInfo {
    /**
    ...
    private CloudExadataStorageConnectorCredentialInfo() {}
    /**
     * @return (Updatable) The password of the user.
     * 
     */
    ...
    public static Builder builder(CloudExadataStorageConnectorCredentialInfo defaults) {
    ...
    public static final class Builder {
        ...
        private String username;
        public Builder() {}
        public Builder(CloudExadataStorageConnectorCredentialInfo defaults) {
        ...
        public Builder password(String password) {
            if (password == null) {
              throw new MissingRequiredPropertyException("CloudExadataStorageConnectorCredentialInfo", "password");
            }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("CloudExadataStorageConnectorCredentialInfo", "username");
            }
            this.username = username;
            return this;
        }
        public CloudExadataStorageConnectorCredentialInfo build() {
            final var _resultValue = new CloudExadataStorageConnectorCredentialInfo();
