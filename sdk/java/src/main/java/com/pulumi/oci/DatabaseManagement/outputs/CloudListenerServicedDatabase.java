...
@CustomType
public final class CloudListenerServicedDatabase {
    /**
    ...
    private CloudListenerServicedDatabase() {}
    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which the cloud database resides.
     * 
     */
    ...
    public static Builder builder(CloudListenerServicedDatabase defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean isManaged;
        public Builder() {}
        public Builder(CloudListenerServicedDatabase defaults) {
        ...
        public CloudListenerServicedDatabase build() {
            final var _resultValue = new CloudListenerServicedDatabase();
