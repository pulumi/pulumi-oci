...
public final class ExternalClusterVipConfiguration {
    ...
    public static Builder builder(ExternalClusterVipConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String nodeName;
        public Builder() {}
        public Builder(ExternalClusterVipConfiguration defaults) {
        ...
        public ExternalClusterVipConfiguration build() {
            final var _resultValue = new ExternalClusterVipConfiguration();
