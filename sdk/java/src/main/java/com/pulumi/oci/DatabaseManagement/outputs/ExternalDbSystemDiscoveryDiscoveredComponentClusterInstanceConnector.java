...
import com.pulumi.oci.DatabaseManagement.outputs.ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfo;
...
@CustomType
public final class ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnector {
    /**
     ...
     * 
     */
    private @Nullable List<ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfo> connectionInfos;
    /**
     ...
     * 
     */
    public List<ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfo> connectionInfos() {
    ...
    public static Builder builder(ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnector defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String timeConnectionStatusLastUpdated;
        public Builder() {}
        public Builder(ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnector defaults) {
        ...
        @CustomType.Setter
        public Builder connectionInfos(@Nullable List<ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfo> connectionInfos) {
            this.connectionInfos = connectionInfos;
            return this;
        }
        public Builder connectionInfos(ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorConnectionInfo... connectionInfos) {
        ...
        public ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnector build() {
            final var _resultValue = new ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnector();
