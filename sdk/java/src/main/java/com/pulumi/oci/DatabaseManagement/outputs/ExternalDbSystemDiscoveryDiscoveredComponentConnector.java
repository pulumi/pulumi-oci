...
import com.pulumi.oci.DatabaseManagement.outputs.ExternalDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfo;
...
@CustomType
public final class ExternalDbSystemDiscoveryDiscoveredComponentConnector {
    /**
     ...
     * 
     */
    private @Nullable List<ExternalDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfo> connectionInfos;
    /**
    ...
    private ExternalDbSystemDiscoveryDiscoveredComponentConnector() {}
    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management agent used for the external DB system discovery.
     * 
     */
     ...
     * 
     */
    public List<ExternalDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfo> connectionInfos() {
    ...
    public static Builder builder(ExternalDbSystemDiscoveryDiscoveredComponentConnector defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String timeConnectionStatusLastUpdated;
        public Builder() {}
        public Builder(ExternalDbSystemDiscoveryDiscoveredComponentConnector defaults) {
        ...
        @CustomType.Setter
        public Builder connectionInfos(@Nullable List<ExternalDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfo> connectionInfos) {
            this.connectionInfos = connectionInfos;
            return this;
        }
        public Builder connectionInfos(ExternalDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfo... connectionInfos) {
