...
@CustomType
public final class ExternalDbSystemDiscoveryDiscoveredComponentDbInstance {
    /**
    ...
    public static Builder builder(ExternalDbSystemDiscoveryDiscoveredComponentDbInstance defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String oracleHome;
        public Builder() {}
        public Builder(ExternalDbSystemDiscoveryDiscoveredComponentDbInstance defaults) {
        ...
        public ExternalDbSystemDiscoveryDiscoveredComponentDbInstance build() {
            final var _resultValue = new ExternalDbSystemDiscoveryDiscoveredComponentDbInstance();
