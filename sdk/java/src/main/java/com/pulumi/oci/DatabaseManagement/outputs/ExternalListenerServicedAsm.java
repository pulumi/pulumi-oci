...
@CustomType
public final class ExternalListenerServicedAsm {
    /**
    ...
    public static Builder builder(ExternalListenerServicedAsm defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String id;
        public Builder() {}
        public Builder(ExternalListenerServicedAsm defaults) {
