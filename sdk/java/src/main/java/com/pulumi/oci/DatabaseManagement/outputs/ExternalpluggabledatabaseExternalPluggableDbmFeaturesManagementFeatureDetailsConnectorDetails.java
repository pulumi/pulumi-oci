...
@CustomType
public final class ExternalpluggabledatabaseExternalPluggableDbmFeaturesManagementFeatureDetailsConnectorDetails {
    /**
    ...
    private ExternalpluggabledatabaseExternalPluggableDbmFeaturesManagementFeatureDetailsConnectorDetails() {}
    /**
     * @return The list of supported connection types:
     * * PE: Private endpoint
     * * MACS: Management agent
    ...
    public static Builder builder(ExternalpluggabledatabaseExternalPluggableDbmFeaturesManagementFeatureDetailsConnectorDetails defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String privateEndPointId;
        public Builder() {}
        public Builder(ExternalpluggabledatabaseExternalPluggableDbmFeaturesManagementFeatureDetailsConnectorDetails defaults) {
        ...
        public ExternalpluggabledatabaseExternalPluggableDbmFeaturesManagementFeatureDetailsConnectorDetails build() {
            final var _resultValue = new ExternalpluggabledatabaseExternalPluggableDbmFeaturesManagementFeatureDetailsConnectorDetails();
