...
@CustomType
public final class GetCloudAsmDiskGroupsCloudAsmDiskGroupCollectionItem {
    /**
    ...
    private GetCloudAsmDiskGroupsCloudAsmDiskGroupCollectionItem() {}
    /**
     * @return The unique names of the databases using the disk group.
     * 
     */
    ...
    public static Builder builder(GetCloudAsmDiskGroupsCloudAsmDiskGroupCollectionItem defaults) {
    ...
    public static final class Builder {
        ...
        private String usedSizeInMbs;
        public Builder() {}
        public Builder(GetCloudAsmDiskGroupsCloudAsmDiskGroupCollectionItem defaults) {
        ...
        public Builder databases(List<String> databases) {
            if (databases == null) {
              throw new MissingRequiredPropertyException("GetCloudAsmDiskGroupsCloudAsmDiskGroupCollectionItem", "databases");
            }
        ...
        public Builder dismountingInstanceCount(Integer dismountingInstanceCount) {
            if (dismountingInstanceCount == null) {
              throw new MissingRequiredPropertyException("GetCloudAsmDiskGroupsCloudAsmDiskGroupCollectionItem", "dismountingInstanceCount");
            }
        ...
        public Builder isSparse(Boolean isSparse) {
            if (isSparse == null) {
              throw new MissingRequiredPropertyException("GetCloudAsmDiskGroupsCloudAsmDiskGroupCollectionItem", "isSparse");
            }
        ...
        public Builder mountingInstanceCount(Integer mountingInstanceCount) {
            if (mountingInstanceCount == null) {
              throw new MissingRequiredPropertyException("GetCloudAsmDiskGroupsCloudAsmDiskGroupCollectionItem", "mountingInstanceCount");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetCloudAsmDiskGroupsCloudAsmDiskGroupCollectionItem", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder redundancyType(String redundancyType) {
            if (redundancyType == null) {
              throw new MissingRequiredPropertyException("GetCloudAsmDiskGroupsCloudAsmDiskGroupCollectionItem", "redundancyType");
            }
        ...
        public Builder totalSizeInMbs(String totalSizeInMbs) {
            if (totalSizeInMbs == null) {
              throw new MissingRequiredPropertyException("GetCloudAsmDiskGroupsCloudAsmDiskGroupCollectionItem", "totalSizeInMbs");
            }
        ...
        public Builder usedPercent(Double usedPercent) {
            if (usedPercent == null) {
              throw new MissingRequiredPropertyException("GetCloudAsmDiskGroupsCloudAsmDiskGroupCollectionItem", "usedPercent");
            }
        ...
        public Builder usedSizeInMbs(String usedSizeInMbs) {
            if (usedSizeInMbs == null) {
              throw new MissingRequiredPropertyException("GetCloudAsmDiskGroupsCloudAsmDiskGroupCollectionItem", "usedSizeInMbs");
            }
            this.usedSizeInMbs = usedSizeInMbs;
            return this;
        }
        public GetCloudAsmDiskGroupsCloudAsmDiskGroupCollectionItem build() {
            final var _resultValue = new GetCloudAsmDiskGroupsCloudAsmDiskGroupCollectionItem();
