...
@CustomType
public final class GetCloudAsmServicedDatabase {
    /**
    ...
    private GetCloudAsmServicedDatabase() {}
    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which the cloud database resides.
     * 
     */
    ...
    public static Builder builder(GetCloudAsmServicedDatabase defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean isManaged;
        public Builder() {}
        public Builder(GetCloudAsmServicedDatabase defaults) {
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetCloudAsmServicedDatabase", "compartmentId");
            }
        ...
        public Builder databaseSubType(String databaseSubType) {
            if (databaseSubType == null) {
              throw new MissingRequiredPropertyException("GetCloudAsmServicedDatabase", "databaseSubType");
            }
        ...
        public Builder databaseType(String databaseType) {
            if (databaseType == null) {
              throw new MissingRequiredPropertyException("GetCloudAsmServicedDatabase", "databaseType");
            }
        ...
        public Builder dbUniqueName(String dbUniqueName) {
            if (dbUniqueName == null) {
              throw new MissingRequiredPropertyException("GetCloudAsmServicedDatabase", "dbUniqueName");
            }
        ...
        public Builder dbaasId(String dbaasId) {
            if (dbaasId == null) {
              throw new MissingRequiredPropertyException("GetCloudAsmServicedDatabase", "dbaasId");
            }
        ...
        public Builder diskGroups(List<String> diskGroups) {
            if (diskGroups == null) {
              throw new MissingRequiredPropertyException("GetCloudAsmServicedDatabase", "diskGroups");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetCloudAsmServicedDatabase", "displayName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetCloudAsmServicedDatabase", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isManaged(Boolean isManaged) {
            if (isManaged == null) {
              throw new MissingRequiredPropertyException("GetCloudAsmServicedDatabase", "isManaged");
            }
            this.isManaged = isManaged;
            return this;
        }
        public GetCloudAsmServicedDatabase build() {
            final var _resultValue = new GetCloudAsmServicedDatabase();
