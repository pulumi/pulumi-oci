...
@CustomType
public final class GetCloudClusterScanConfiguration {
    /**
    ...
    private GetCloudClusterScanConfiguration() {}
    /**
     * @return The network number from which VIPs are obtained.
     * 
     */
    ...
    public static Builder builder(GetCloudClusterScanConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private String scanProtocol;
        public Builder() {}
        public Builder(GetCloudClusterScanConfiguration defaults) {
        ...
        public Builder networkNumber(Integer networkNumber) {
            if (networkNumber == null) {
              throw new MissingRequiredPropertyException("GetCloudClusterScanConfiguration", "networkNumber");
            }
        ...
        public Builder scanName(String scanName) {
            if (scanName == null) {
              throw new MissingRequiredPropertyException("GetCloudClusterScanConfiguration", "scanName");
            }
        ...
        public Builder scanPort(Integer scanPort) {
            if (scanPort == null) {
              throw new MissingRequiredPropertyException("GetCloudClusterScanConfiguration", "scanPort");
            }
        ...
        public Builder scanProtocol(String scanProtocol) {
            if (scanProtocol == null) {
              throw new MissingRequiredPropertyException("GetCloudClusterScanConfiguration", "scanProtocol");
            }
            this.scanProtocol = scanProtocol;
            return this;
        }
        public GetCloudClusterScanConfiguration build() {
            final var _resultValue = new GetCloudClusterScanConfiguration();
