...
import com.pulumi.oci.DatabaseManagement.outputs.GetCloudDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfo;
import java.lang.String;
import java.util.List;
import java.util.Objects;

@CustomType
public final class GetCloudDbSystemDiscoveryDiscoveredComponentConnector {
    /**
     ...
     * 
     */
    private List<GetCloudDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfo> connectionInfos;
    /**
    ...
    private GetCloudDbSystemDiscoveryDiscoveredComponentConnector() {}
    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management agent used for the cloud DB system connector.
     * 
     */
     ...
     * 
     */
    public List<GetCloudDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfo> connectionInfos() {
    ...
    public static Builder builder(GetCloudDbSystemDiscoveryDiscoveredComponentConnector defaults) {
    ...
    public static final class Builder {
        ...
        private String timeConnectionStatusLastUpdated;
        public Builder() {}
        public Builder(GetCloudDbSystemDiscoveryDiscoveredComponentConnector defaults) {
        ...
        public Builder agentId(String agentId) {
            if (agentId == null) {
              throw new MissingRequiredPropertyException("GetCloudDbSystemDiscoveryDiscoveredComponentConnector", "agentId");
            }
        ...
        public Builder connectionFailureMessage(String connectionFailureMessage) {
            if (connectionFailureMessage == null) {
              throw new MissingRequiredPropertyException("GetCloudDbSystemDiscoveryDiscoveredComponentConnector", "connectionFailureMessage");
            }
            this.connectionFailureMessage = connectionFailureMessage;
            return this;
        }
        @CustomType.Setter
        public Builder connectionInfos(List<GetCloudDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfo> connectionInfos) {
            if (connectionInfos == null) {
              throw new MissingRequiredPropertyException("GetCloudDbSystemDiscoveryDiscoveredComponentConnector", "connectionInfos");
            }
            this.connectionInfos = connectionInfos;
            return this;
        }
        public Builder connectionInfos(GetCloudDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfo... connectionInfos) {
            return connectionInfos(List.of(connectionInfos));
        }
        @CustomType.Setter
        public Builder connectionStatus(String connectionStatus) {
            if (connectionStatus == null) {
              throw new MissingRequiredPropertyException("GetCloudDbSystemDiscoveryDiscoveredComponentConnector", "connectionStatus");
            }
        ...
        public Builder connectorType(String connectorType) {
            if (connectorType == null) {
              throw new MissingRequiredPropertyException("GetCloudDbSystemDiscoveryDiscoveredComponentConnector", "connectorType");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetCloudDbSystemDiscoveryDiscoveredComponentConnector", "displayName");
            }
        ...
        public Builder timeConnectionStatusLastUpdated(String timeConnectionStatusLastUpdated) {
            if (timeConnectionStatusLastUpdated == null) {
              throw new MissingRequiredPropertyException("GetCloudDbSystemDiscoveryDiscoveredComponentConnector", "timeConnectionStatusLastUpdated");
            }
            this.timeConnectionStatusLastUpdated = timeConnectionStatusLastUpdated;
            return this;
        }
        public GetCloudDbSystemDiscoveryDiscoveredComponentConnector build() {
            final var _resultValue = new GetCloudDbSystemDiscoveryDiscoveredComponentConnector();
