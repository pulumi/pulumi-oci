...
@CustomType
public final class GetCloudListenerServicedDatabase {
    /**
    ...
    private GetCloudListenerServicedDatabase() {}
    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which the cloud database resides.
     * 
     */
    ...
    public static Builder builder(GetCloudListenerServicedDatabase defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean isManaged;
        public Builder() {}
        public Builder(GetCloudListenerServicedDatabase defaults) {
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetCloudListenerServicedDatabase", "compartmentId");
            }
        ...
        public Builder databaseSubType(String databaseSubType) {
            if (databaseSubType == null) {
              throw new MissingRequiredPropertyException("GetCloudListenerServicedDatabase", "databaseSubType");
            }
        ...
        public Builder databaseType(String databaseType) {
            if (databaseType == null) {
              throw new MissingRequiredPropertyException("GetCloudListenerServicedDatabase", "databaseType");
            }
        ...
        public Builder dbUniqueName(String dbUniqueName) {
            if (dbUniqueName == null) {
              throw new MissingRequiredPropertyException("GetCloudListenerServicedDatabase", "dbUniqueName");
            }
        ...
        public Builder dbaasId(String dbaasId) {
            if (dbaasId == null) {
              throw new MissingRequiredPropertyException("GetCloudListenerServicedDatabase", "dbaasId");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetCloudListenerServicedDatabase", "displayName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetCloudListenerServicedDatabase", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isManaged(Boolean isManaged) {
            if (isManaged == null) {
              throw new MissingRequiredPropertyException("GetCloudListenerServicedDatabase", "isManaged");
            }
            this.isManaged = isManaged;
            return this;
        }
        public GetCloudListenerServicedDatabase build() {
            final var _resultValue = new GetCloudListenerServicedDatabase();
