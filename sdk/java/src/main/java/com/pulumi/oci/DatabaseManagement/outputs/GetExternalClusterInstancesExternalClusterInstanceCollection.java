...
public final class GetExternalClusterInstancesExternalClusterInstanceCollection {
    private @Nullable List<GetExternalClusterInstancesExternalClusterInstanceCollectionItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetExternalClusterInstancesExternalClusterInstanceCollectionItem> items) {
            this.items = items;
            return this;
        }
