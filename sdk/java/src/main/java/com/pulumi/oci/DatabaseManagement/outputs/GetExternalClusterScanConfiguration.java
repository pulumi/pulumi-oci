    ...
    public static final class Builder {
        ...
        public Builder networkNumber(Integer networkNumber) {
            if (networkNumber == null) {
              throw new MissingRequiredPropertyException("GetExternalClusterScanConfiguration", "networkNumber");
            }
        ...
        public Builder scanName(String scanName) {
            if (scanName == null) {
              throw new MissingRequiredPropertyException("GetExternalClusterScanConfiguration", "scanName");
            }
        ...
        public Builder scanPort(Integer scanPort) {
            if (scanPort == null) {
              throw new MissingRequiredPropertyException("GetExternalClusterScanConfiguration", "scanPort");
            }
        ...
        public Builder scanProtocol(String scanProtocol) {
            if (scanProtocol == null) {
              throw new MissingRequiredPropertyException("GetExternalClusterScanConfiguration", "scanProtocol");
            }
