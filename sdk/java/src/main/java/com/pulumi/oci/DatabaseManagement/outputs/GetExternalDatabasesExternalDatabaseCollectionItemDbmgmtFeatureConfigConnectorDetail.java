...
public final class GetExternalDatabasesExternalDatabaseCollectionItemDbmgmtFeatureConfigConnectorDetail {
    ...
    private GetExternalDatabasesExternalDatabaseCollectionItemDbmgmtFeatureConfigConnectorDetail() {}
    /**
     * @return The list of supported connection types:
     * * PE: Private endpoint
     * * MACS: Management agent
    ...
    public static Builder builder(GetExternalDatabasesExternalDatabaseCollectionItemDbmgmtFeatureConfigConnectorDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String privateEndPointId;
        public Builder() {}
        public Builder(GetExternalDatabasesExternalDatabaseCollectionItemDbmgmtFeatureConfigConnectorDetail defaults) {
        ...
        public Builder connectorType(String connectorType) {
            if (connectorType == null) {
              throw new MissingRequiredPropertyException("GetExternalDatabasesExternalDatabaseCollectionItemDbmgmtFeatureConfigConnectorDetail", "connectorType");
            }
        ...
        public Builder databaseConnectorId(String databaseConnectorId) {
            if (databaseConnectorId == null) {
              throw new MissingRequiredPropertyException("GetExternalDatabasesExternalDatabaseCollectionItemDbmgmtFeatureConfigConnectorDetail", "databaseConnectorId");
            }
        ...
        public Builder managementAgentId(String managementAgentId) {
            if (managementAgentId == null) {
              throw new MissingRequiredPropertyException("GetExternalDatabasesExternalDatabaseCollectionItemDbmgmtFeatureConfigConnectorDetail", "managementAgentId");
            }
        ...
        public Builder privateEndPointId(String privateEndPointId) {
            if (privateEndPointId == null) {
              throw new MissingRequiredPropertyException("GetExternalDatabasesExternalDatabaseCollectionItemDbmgmtFeatureConfigConnectorDetail", "privateEndPointId");
            }
            this.privateEndPointId = privateEndPointId;
            return this;
        }
        public GetExternalDatabasesExternalDatabaseCollectionItemDbmgmtFeatureConfigConnectorDetail build() {
            final var _resultValue = new GetExternalDatabasesExternalDatabaseCollectionItemDbmgmtFeatureConfigConnectorDetail();
