...
import com.pulumi.oci.DatabaseManagement.outputs.GetExternalDbSystemDiscoveryDiscoveredComponentDbInstance;
...
public final class GetExternalDbSystemDiscoveryDiscoveredComponent {
    ...
    private List<GetExternalDbSystemDiscoveryDiscoveredComponentAsmInstance> asmInstances;
    /**
     * @return The list of associated components.
     * 
     */
    private List<GetExternalDbSystemDiscoveryDiscoveredComponentAssociatedComponent> associatedComponents;
    /**
    ...
    private List<GetExternalDbSystemDiscoveryDiscoveredComponentClusterInstance> clusterInstances;
    /**
     ...
     * 
     */
    private List<GetExternalDbSystemDiscoveryDiscoveredComponentConnector> connectors;
    /**
     ...
     * 
     */
    private List<GetExternalDbSystemDiscoveryDiscoveredComponentDbInstance> dbInstances;
    /**
     ...
     * 
     */
    private List<GetExternalDbSystemDiscoveryDiscoveredComponentEndpoint> endpoints;
    /**
     ...
     * 
     */
    private List<GetExternalDbSystemDiscoveryDiscoveredComponentNetworkConfiguration> networkConfigurations;
    /**
     ...
     * 
     */
    private List<GetExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabase> pluggableDatabases;
    /**
     ...
     * 
     */
    private List<GetExternalDbSystemDiscoveryDiscoveredComponentScanConfiguration> scanConfigurations;
    /**
     ...
     * 
     */
    private List<GetExternalDbSystemDiscoveryDiscoveredComponentVipConfiguration> vipConfigurations;
     ...
     * 
     */
    public List<GetExternalDbSystemDiscoveryDiscoveredComponentDbInstance> dbInstances() {
    ...
    public static final class Builder {
        ...
        public Builder canEnableAllCurrentPdbs(Boolean canEnableAllCurrentPdbs) {
            if (canEnableAllCurrentPdbs == null) {
              throw new MissingRequiredPropertyException("GetExternalDbSystemDiscoveryDiscoveredComponent", "canEnableAllCurrentPdbs");
            }
        ...
        @CustomType.Setter
        public Builder dbInstances(List<GetExternalDbSystemDiscoveryDiscoveredComponentDbInstance> dbInstances) {
            if (dbInstances == null) {
              throw new MissingRequiredPropertyException("GetExternalDbSystemDiscoveryDiscoveredComponent", "dbInstances");
            }
            this.dbInstances = dbInstances;
            return this;
        }
        public Builder dbInstances(GetExternalDbSystemDiscoveryDiscoveredComponentDbInstance... dbInstances) {
        ...
        public Builder isAutoEnablePluggableDatabase(Boolean isAutoEnablePluggableDatabase) {
            if (isAutoEnablePluggableDatabase == null) {
              throw new MissingRequiredPropertyException("GetExternalDbSystemDiscoveryDiscoveredComponent", "isAutoEnablePluggableDatabase");
            }
        ...
        public Builder nodeName(String nodeName) {
            if (nodeName == null) {
              throw new MissingRequiredPropertyException("GetExternalDbSystemDiscoveryDiscoveredComponent", "nodeName");
            }
        ...
        public GetExternalDbSystemDiscoveryDiscoveredComponent build() {
            final var _resultValue = new GetExternalDbSystemDiscoveryDiscoveredComponent();
