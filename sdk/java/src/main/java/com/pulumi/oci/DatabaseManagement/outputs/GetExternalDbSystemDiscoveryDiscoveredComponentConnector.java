...
import com.pulumi.oci.DatabaseManagement.outputs.GetExternalDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfo;
import java.lang.String;
import java.util.List;
import java.util.Objects;

@CustomType
public final class GetExternalDbSystemDiscoveryDiscoveredComponentConnector {
    /**
     ...
     * 
     */
    private List<GetExternalDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfo> connectionInfos;
    /**
    ...
    private GetExternalDbSystemDiscoveryDiscoveredComponentConnector() {}
    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management agent used for the external DB system connector.
     * 
     */
     ...
     * 
     */
    public List<GetExternalDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfo> connectionInfos() {
    ...
    public static Builder builder(GetExternalDbSystemDiscoveryDiscoveredComponentConnector defaults) {
    ...
    public static final class Builder {
        ...
        private String timeConnectionStatusLastUpdated;
        public Builder() {}
        public Builder(GetExternalDbSystemDiscoveryDiscoveredComponentConnector defaults) {
        ...
        public Builder agentId(String agentId) {
            if (agentId == null) {
              throw new MissingRequiredPropertyException("GetExternalDbSystemDiscoveryDiscoveredComponentConnector", "agentId");
            }
        ...
        public Builder connectionFailureMessage(String connectionFailureMessage) {
            if (connectionFailureMessage == null) {
              throw new MissingRequiredPropertyException("GetExternalDbSystemDiscoveryDiscoveredComponentConnector", "connectionFailureMessage");
            }
            this.connectionFailureMessage = connectionFailureMessage;
            return this;
        }
        @CustomType.Setter
        public Builder connectionInfos(List<GetExternalDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfo> connectionInfos) {
            if (connectionInfos == null) {
              throw new MissingRequiredPropertyException("GetExternalDbSystemDiscoveryDiscoveredComponentConnector", "connectionInfos");
            }
            this.connectionInfos = connectionInfos;
            return this;
        }
        public Builder connectionInfos(GetExternalDbSystemDiscoveryDiscoveredComponentConnectorConnectionInfo... connectionInfos) {
            return connectionInfos(List.of(connectionInfos));
        }
        @CustomType.Setter
        public Builder connectionStatus(String connectionStatus) {
            if (connectionStatus == null) {
              throw new MissingRequiredPropertyException("GetExternalDbSystemDiscoveryDiscoveredComponentConnector", "connectionStatus");
            }
        ...
        public Builder connectorType(String connectorType) {
            if (connectorType == null) {
              throw new MissingRequiredPropertyException("GetExternalDbSystemDiscoveryDiscoveredComponentConnector", "connectorType");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetExternalDbSystemDiscoveryDiscoveredComponentConnector", "displayName");
            }
        ...
        public Builder timeConnectionStatusLastUpdated(String timeConnectionStatusLastUpdated) {
            if (timeConnectionStatusLastUpdated == null) {
              throw new MissingRequiredPropertyException("GetExternalDbSystemDiscoveryDiscoveredComponentConnector", "timeConnectionStatusLastUpdated");
            }
            this.timeConnectionStatusLastUpdated = timeConnectionStatusLastUpdated;
            return this;
        }
        public GetExternalDbSystemDiscoveryDiscoveredComponentConnector build() {
            final var _resultValue = new GetExternalDbSystemDiscoveryDiscoveredComponentConnector();
