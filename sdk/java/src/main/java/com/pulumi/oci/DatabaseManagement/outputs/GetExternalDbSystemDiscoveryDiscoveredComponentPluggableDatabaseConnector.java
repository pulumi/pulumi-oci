...
@CustomType
public final class GetExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnector {
    /**
     ...
     * 
     */
    private @Nullable List<GetExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorConnectionInfo> connectionInfos;
    /**
    ...
    private GetExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnector() {}
    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management agent used for the external DB system connector.
     * 
     */
     ...
     * 
     */
    public List<GetExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorConnectionInfo> connectionInfos() {
    ...
    public static Builder builder(GetExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnector defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String timeConnectionStatusLastUpdated;
        public Builder() {}
        public Builder(GetExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnector defaults) {
        ...
        @CustomType.Setter
        public Builder connectionInfos(@Nullable List<GetExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnectorConnectionInfo> connectionInfos) {
        ...
        public GetExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnector build() {
            final var o = new GetExternalDbSystemDiscoveryDiscoveredComponentPluggableDatabaseConnector();
            o.agentId = agentId;
