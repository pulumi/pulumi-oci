...
public final class GetExternalDbSystemStackMonitoringConfig {
    ...
    public static final class Builder {
        ...
        public Builder isEnabled(Boolean isEnabled) {
            if (isEnabled == null) {
              throw new MissingRequiredPropertyException("GetExternalDbSystemStackMonitoringConfig", "isEnabled");
            }
        ...
        public Builder metadata(String metadata) {
            if (metadata == null) {
              throw new MissingRequiredPropertyException("GetExternalDbSystemStackMonitoringConfig", "metadata");
            }
            this.metadata = metadata;
            return this;
        }
        public GetExternalDbSystemStackMonitoringConfig build() {
            final var _resultValue = new GetExternalDbSystemStackMonitoringConfig();
