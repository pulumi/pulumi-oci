...
public final class GetExternalExadataStorageConnectorResult {
    ...
    public static final class Builder {
        ...
        public Builder systemTags(Map<String,String> systemTags) {
            if (systemTags == null) {
              throw new MissingRequiredPropertyException("GetExternalExadataStorageConnectorResult", "systemTags");
            }
        ...
        public GetExternalExadataStorageConnectorResult build() {
            final var _resultValue = new GetExternalExadataStorageConnectorResult();
