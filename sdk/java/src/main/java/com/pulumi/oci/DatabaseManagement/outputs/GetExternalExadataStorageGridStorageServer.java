...
public final class GetExternalExadataStorageGridStorageServer {
    ...
    public static final class Builder {
        ...
        public Builder systemTags(Map<String,String> systemTags) {
            if (systemTags == null) {
              throw new MissingRequiredPropertyException("GetExternalExadataStorageGridStorageServer", "systemTags");
            }
        ...
        public GetExternalExadataStorageGridStorageServer build() {
            final var _resultValue = new GetExternalExadataStorageGridStorageServer();
