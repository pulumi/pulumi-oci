...
public final class GetManagedDatabaseAddmTasksAddmTasksCollectionItem {
    ...
    public static final class Builder {
        ...
        public Builder timeCreated(String timeCreated) {
            ...
            return new GetManagedDatabaseAddmTasksAddmTasksCollectionItem(beginSnapshotId, dbUser, description, endSnapshotId, endSnapshotTime, findings, howCreated, startSnapshotTime, status, taskId, taskName, timeCreated);
        }
    }
}
