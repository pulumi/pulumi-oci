    ...
    public static final class Builder {
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetManagedDatabaseOptimizerStatisticsAdvisorExecutionDatabase", "compartmentId");
            }
        ...
        public Builder dbDeploymentType(String dbDeploymentType) {
            if (dbDeploymentType == null) {
              throw new MissingRequiredPropertyException("GetManagedDatabaseOptimizerStatisticsAdvisorExecutionDatabase", "dbDeploymentType");
            }
        ...
        public Builder dbSubType(String dbSubType) {
            if (dbSubType == null) {
              throw new MissingRequiredPropertyException("GetManagedDatabaseOptimizerStatisticsAdvisorExecutionDatabase", "dbSubType");
            }
        ...
        public Builder dbType(String dbType) {
            if (dbType == null) {
              throw new MissingRequiredPropertyException("GetManagedDatabaseOptimizerStatisticsAdvisorExecutionDatabase", "dbType");
            }
            this.dbType = dbType;
            return this;
        }
        ...
        public Builder dbVersion(String dbVersion) {
            if (dbVersion == null) {
              throw new MissingRequiredPropertyException("GetManagedDatabaseOptimizerStatisticsAdvisorExecutionDatabase", "dbVersion");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetManagedDatabaseOptimizerStatisticsAdvisorExecutionDatabase", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetManagedDatabaseOptimizerStatisticsAdvisorExecutionDatabase", "name");
            }
            this.name = name;
            return this;
        }
        public GetManagedDatabaseOptimizerStatisticsAdvisorExecutionDatabase build() {
            final var _resultValue = new GetManagedDatabaseOptimizerStatisticsAdvisorExecutionDatabase();
