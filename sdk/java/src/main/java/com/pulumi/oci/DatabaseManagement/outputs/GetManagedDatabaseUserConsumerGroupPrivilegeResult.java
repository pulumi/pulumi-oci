...
public final class GetManagedDatabaseUserConsumerGroupPrivilegeResult {
    ...
    public static final class Builder {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetManagedDatabaseUserConsumerGroupPrivilegeResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder items(List<GetManagedDatabaseUserConsumerGroupPrivilegeItem> items) {
            if (items == null) {
              throw new MissingRequiredPropertyException("GetManagedDatabaseUserConsumerGroupPrivilegeResult", "items");
            }
            this.items = items;
            return this;
        }
        ...
        public Builder managedDatabaseId(String managedDatabaseId) {
            if (managedDatabaseId == null) {
              throw new MissingRequiredPropertyException("GetManagedDatabaseUserConsumerGroupPrivilegeResult", "managedDatabaseId");
            }
        ...
        public Builder userName(String userName) {
            if (userName == null) {
              throw new MissingRequiredPropertyException("GetManagedDatabaseUserConsumerGroupPrivilegeResult", "userName");
            }
