...
public final class GetManagedDatabasesManagedDatabaseCollection {
    private @Nullable List<GetManagedDatabasesManagedDatabaseCollectionItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetManagedDatabasesManagedDatabaseCollectionItem> items) {
            this.items = items;
            return this;
        }
