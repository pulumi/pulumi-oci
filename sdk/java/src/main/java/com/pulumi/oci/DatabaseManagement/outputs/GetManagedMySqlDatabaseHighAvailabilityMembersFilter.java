...
@CustomType
public final class GetManagedMySqlDatabaseHighAvailabilityMembersFilter {
    private String name;
    ...
    public static final class Builder {
        ...
        public GetManagedMySqlDatabaseHighAvailabilityMembersFilter build() {
            final var _resultValue = new GetManagedMySqlDatabaseHighAvailabilityMembersFilter();
