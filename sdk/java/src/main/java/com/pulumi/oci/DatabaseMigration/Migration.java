...
public class Migration extends com.pulumi.resources.CustomResource {
    ...
    public Migration(java.lang.String name, MigrationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DatabaseMigration/migration:Migration", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Migration(java.lang.String name, Output<java.lang.String> id, @Nullable MigrationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DatabaseMigration/migration:Migration", name, state, makeResourceOptions(options, id), false);
    }
