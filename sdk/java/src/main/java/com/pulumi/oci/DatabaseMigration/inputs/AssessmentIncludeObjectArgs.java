...
public final class AssessmentIncludeObjectArgs extends com.pulumi.resources.ResourceArgs {

    public static final AssessmentIncludeObjectArgs Empty = new AssessmentIncludeObjectArgs();
    ...
    private AssessmentIncludeObjectArgs() {}

    private AssessmentIncludeObjectArgs(AssessmentIncludeObjectArgs $) {
    ...
    public static Builder builder(AssessmentIncludeObjectArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AssessmentIncludeObjectArgs();
        }

        public Builder(AssessmentIncludeObjectArgs defaults) {
            $ = new AssessmentIncludeObjectArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AssessmentIncludeObjectArgs build() {
            if ($.object == null) {
                throw new MissingRequiredPropertyException("AssessmentIncludeObjectArgs", "object");
            }
            return $;
        }
    }
