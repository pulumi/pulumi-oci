...
public final class ConnectionAdminCredentialsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ConnectionAdminCredentialsArgs build() {
            if ($.password == null) {
                throw new MissingRequiredPropertyException("ConnectionAdminCredentialsArgs", "password");
            }
            if ($.username == null) {
                throw new MissingRequiredPropertyException("ConnectionAdminCredentialsArgs", "username");
            }
            return $;
        }
    }
