...
public final class GetMigrationObjectTypesFilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public GetMigrationObjectTypesFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetMigrationObjectTypesFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetMigrationObjectTypesFilterArgs", "values");
            }
            return $;
        }
    }
