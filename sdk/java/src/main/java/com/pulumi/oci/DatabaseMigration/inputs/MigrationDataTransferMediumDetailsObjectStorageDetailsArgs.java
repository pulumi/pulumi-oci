...
public final class MigrationDataTransferMediumDetailsObjectStorageDetailsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public MigrationDataTransferMediumDetailsObjectStorageDetailsArgs build() {
            if ($.bucket == null) {
                throw new MissingRequiredPropertyException("MigrationDataTransferMediumDetailsObjectStorageDetailsArgs", "bucket");
            }
            if ($.namespace == null) {
                throw new MissingRequiredPropertyException("MigrationDataTransferMediumDetailsObjectStorageDetailsArgs", "namespace");
            }
            return $;
        }
    }
