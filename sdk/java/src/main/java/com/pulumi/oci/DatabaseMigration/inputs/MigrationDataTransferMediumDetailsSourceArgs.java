...
public final class MigrationDataTransferMediumDetailsSourceArgs extends com.pulumi.resources.ResourceArgs {

    public static final MigrationDataTransferMediumDetailsSourceArgs Empty = new MigrationDataTransferMediumDetailsSourceArgs();
    ...
    private MigrationDataTransferMediumDetailsSourceArgs() {}

    private MigrationDataTransferMediumDetailsSourceArgs(MigrationDataTransferMediumDetailsSourceArgs $) {
        this.kind = $.kind;
    ...
    public static Builder builder(MigrationDataTransferMediumDetailsSourceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MigrationDataTransferMediumDetailsSourceArgs();
        }

        public Builder(MigrationDataTransferMediumDetailsSourceArgs defaults) {
            $ = new MigrationDataTransferMediumDetailsSourceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MigrationDataTransferMediumDetailsSourceArgs build() {
            if ($.kind == null) {
                throw new MissingRequiredPropertyException("MigrationDataTransferMediumDetailsSourceArgs", "kind");
            }
            return $;
        }
    }
