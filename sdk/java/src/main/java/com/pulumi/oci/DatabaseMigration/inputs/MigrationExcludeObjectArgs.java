...
public final class MigrationExcludeObjectArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public MigrationExcludeObjectArgs build() {
            if ($.object == null) {
                throw new MissingRequiredPropertyException("MigrationExcludeObjectArgs", "object");
            }
            if ($.owner == null) {
                throw new MissingRequiredPropertyException("MigrationExcludeObjectArgs", "owner");
            }
            return $;
        }
    }
