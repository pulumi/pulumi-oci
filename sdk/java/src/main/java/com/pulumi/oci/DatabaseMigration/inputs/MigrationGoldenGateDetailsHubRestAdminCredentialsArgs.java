...
public final class MigrationGoldenGateDetailsHubRestAdminCredentialsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public MigrationGoldenGateDetailsHubRestAdminCredentialsArgs build() {
            if ($.password == null) {
                throw new MissingRequiredPropertyException("MigrationGoldenGateDetailsHubRestAdminCredentialsArgs", "password");
            }
            if ($.username == null) {
                throw new MissingRequiredPropertyException("MigrationGoldenGateDetailsHubRestAdminCredentialsArgs", "username");
            }
            return $;
        }
    }
