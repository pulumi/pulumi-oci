...
public final class MigrationGoldenGateServiceDetailsSettingsReplicatArgs extends com.pulumi.resources.ResourceArgs {

    public static final MigrationGoldenGateServiceDetailsSettingsReplicatArgs Empty = new MigrationGoldenGateServiceDetailsSettingsReplicatArgs();
    ...
    private MigrationGoldenGateServiceDetailsSettingsReplicatArgs() {}

    private MigrationGoldenGateServiceDetailsSettingsReplicatArgs(MigrationGoldenGateServiceDetailsSettingsReplicatArgs $) {
    ...
    public static Builder builder(MigrationGoldenGateServiceDetailsSettingsReplicatArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MigrationGoldenGateServiceDetailsSettingsReplicatArgs();
        }

        public Builder(MigrationGoldenGateServiceDetailsSettingsReplicatArgs defaults) {
            $ = new MigrationGoldenGateServiceDetailsSettingsReplicatArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MigrationGoldenGateServiceDetailsSettingsReplicatArgs build() {
            return $;
        }
    }
