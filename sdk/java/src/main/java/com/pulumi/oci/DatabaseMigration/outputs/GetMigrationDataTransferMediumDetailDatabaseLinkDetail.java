...
public final class GetMigrationDataTransferMediumDetailDatabaseLinkDetail {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetMigrationDataTransferMediumDetailDatabaseLinkDetail", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder walletBuckets(List<GetMigrationDataTransferMediumDetailDatabaseLinkDetailWalletBucket> walletBuckets) {
            if (walletBuckets == null) {
              throw new MissingRequiredPropertyException("GetMigrationDataTransferMediumDetailDatabaseLinkDetail", "walletBuckets");
            }
        ...
        public GetMigrationDataTransferMediumDetailDatabaseLinkDetail build() {
            final var _resultValue = new GetMigrationDataTransferMediumDetailDatabaseLinkDetail();
