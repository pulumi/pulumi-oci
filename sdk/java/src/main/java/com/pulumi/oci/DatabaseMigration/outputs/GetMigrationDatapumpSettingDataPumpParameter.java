...
public final class GetMigrationDatapumpSettingDataPumpParameter {
    ...
    public static final class Builder {
        ...
        public Builder estimate(String estimate) {
            if (estimate == null) {
              throw new MissingRequiredPropertyException("GetMigrationDatapumpSettingDataPumpParameter", "estimate");
            }
        ...
        public Builder excludeParameters(List<String> excludeParameters) {
            if (excludeParameters == null) {
              throw new MissingRequiredPropertyException("GetMigrationDatapumpSettingDataPumpParameter", "excludeParameters");
            }
        ...
        public Builder exportParallelismDegree(Integer exportParallelismDegree) {
            if (exportParallelismDegree == null) {
              throw new MissingRequiredPropertyException("GetMigrationDatapumpSettingDataPumpParameter", "exportParallelismDegree");
            }
        ...
        public Builder importParallelismDegree(Integer importParallelismDegree) {
            if (importParallelismDegree == null) {
              throw new MissingRequiredPropertyException("GetMigrationDatapumpSettingDataPumpParameter", "importParallelismDegree");
            }
        ...
        public Builder isCluster(Boolean isCluster) {
            if (isCluster == null) {
              throw new MissingRequiredPropertyException("GetMigrationDatapumpSettingDataPumpParameter", "isCluster");
            }
        ...
        public Builder tableExistsAction(String tableExistsAction) {
            if (tableExistsAction == null) {
              throw new MissingRequiredPropertyException("GetMigrationDatapumpSettingDataPumpParameter", "tableExistsAction");
            }
            this.tableExistsAction = tableExistsAction;
            return this;
        }
        public GetMigrationDatapumpSettingDataPumpParameter build() {
            final var _resultValue = new GetMigrationDatapumpSettingDataPumpParameter();
