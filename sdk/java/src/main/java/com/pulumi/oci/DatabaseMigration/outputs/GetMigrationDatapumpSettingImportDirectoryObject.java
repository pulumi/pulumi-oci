...
public final class GetMigrationDatapumpSettingImportDirectoryObject {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetMigrationDatapumpSettingImportDirectoryObject", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder path(String path) {
            if (path == null) {
              throw new MissingRequiredPropertyException("GetMigrationDatapumpSettingImportDirectoryObject", "path");
            }
            this.path = path;
            return this;
        }
