...
@CustomType
public final class GetMigrationGgsDetailExtract {
    /**
    ...
    private GetMigrationGgsDetailExtract() {}
    /**
     * @return Length of time (in seconds) that a transaction can be open before Extract generates a warning message that the transaction is long-running. If not specified, Extract will not generate a warning on long-running transactions.
     * 
     */
    ...
    public static Builder builder(GetMigrationGgsDetailExtract defaults) {
    ...
    public static final class Builder {
        ...
        private String performanceProfile;
        public Builder() {}
        public Builder(GetMigrationGgsDetailExtract defaults) {
        ...
        public Builder longTransDuration(Integer longTransDuration) {
            if (longTransDuration == null) {
              throw new MissingRequiredPropertyException("GetMigrationGgsDetailExtract", "longTransDuration");
            }
        ...
        public Builder performanceProfile(String performanceProfile) {
            if (performanceProfile == null) {
              throw new MissingRequiredPropertyException("GetMigrationGgsDetailExtract", "performanceProfile");
            }
            this.performanceProfile = performanceProfile;
            return this;
        }
        public GetMigrationGgsDetailExtract build() {
            final var _resultValue = new GetMigrationGgsDetailExtract();
