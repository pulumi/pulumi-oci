...
public final class GetMigrationGoldenGateDetailHubSourceDbAdminCredential {
    ...
    public static final class Builder {
        ...
        public Builder password(String password) {
            if (password == null) {
              throw new MissingRequiredPropertyException("GetMigrationGoldenGateDetailHubSourceDbAdminCredential", "password");
            }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("GetMigrationGoldenGateDetailHubSourceDbAdminCredential", "username");
            }
            this.username = username;
            return this;
        }
        public GetMigrationGoldenGateDetailHubSourceDbAdminCredential build() {
            final var _resultValue = new GetMigrationGoldenGateDetailHubSourceDbAdminCredential();
