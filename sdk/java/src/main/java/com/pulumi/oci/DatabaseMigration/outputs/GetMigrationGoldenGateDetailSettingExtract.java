    ...
    public static final class Builder {
        ...
        public Builder longTransDuration(Integer longTransDuration) {
            if (longTransDuration == null) {
              throw new MissingRequiredPropertyException("GetMigrationGoldenGateDetailSettingExtract", "longTransDuration");
            }
        ...
        public Builder performanceProfile(String performanceProfile) {
            if (performanceProfile == null) {
              throw new MissingRequiredPropertyException("GetMigrationGoldenGateDetailSettingExtract", "performanceProfile");
            }
            this.performanceProfile = performanceProfile;
            return this;
        }
        public GetMigrationGoldenGateDetailSettingExtract build() {
            final var _resultValue = new GetMigrationGoldenGateDetailSettingExtract();
