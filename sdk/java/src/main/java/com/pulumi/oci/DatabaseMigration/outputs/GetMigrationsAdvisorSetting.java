...
@CustomType
public final class GetMigrationsAdvisorSetting {
    /**
    ...
    private GetMigrationsAdvisorSetting() {}
    /**
     * @return True to not interrupt migration execution due to Pre-Migration Advisor errors. Default is false.
     * 
     */
    ...
    public static Builder builder(GetMigrationsAdvisorSetting defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean isSkipAdvisor;
        public Builder() {}
        public Builder(GetMigrationsAdvisorSetting defaults) {
        ...
        public Builder isIgnoreErrors(Boolean isIgnoreErrors) {
            if (isIgnoreErrors == null) {
              throw new MissingRequiredPropertyException("GetMigrationsAdvisorSetting", "isIgnoreErrors");
            }
        ...
        public Builder isSkipAdvisor(Boolean isSkipAdvisor) {
            if (isSkipAdvisor == null) {
              throw new MissingRequiredPropertyException("GetMigrationsAdvisorSetting", "isSkipAdvisor");
            }
            this.isSkipAdvisor = isSkipAdvisor;
            return this;
        }
        public GetMigrationsAdvisorSetting build() {
            final var _resultValue = new GetMigrationsAdvisorSetting();
