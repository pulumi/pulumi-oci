...
@CustomType
public final class GetMigrationsHubDetailExtract {
    /**
    ...
    private GetMigrationsHubDetailExtract() {}
    /**
     * @return Length of time (in seconds) that a transaction can be open before Extract generates a warning message that the transaction is long-running. If not specified, Extract will not generate a warning on long-running transactions.
     * 
     */
    ...
    public static Builder builder(GetMigrationsHubDetailExtract defaults) {
    ...
    public static final class Builder {
        ...
        private String performanceProfile;
        public Builder() {}
        public Builder(GetMigrationsHubDetailExtract defaults) {
        ...
        public Builder longTransDuration(Integer longTransDuration) {
            if (longTransDuration == null) {
              throw new MissingRequiredPropertyException("GetMigrationsHubDetailExtract", "longTransDuration");
            }
        ...
        public Builder performanceProfile(String performanceProfile) {
            if (performanceProfile == null) {
              throw new MissingRequiredPropertyException("GetMigrationsHubDetailExtract", "performanceProfile");
            }
            this.performanceProfile = performanceProfile;
            return this;
        }
        public GetMigrationsHubDetailExtract build() {
            final var _resultValue = new GetMigrationsHubDetailExtract();
