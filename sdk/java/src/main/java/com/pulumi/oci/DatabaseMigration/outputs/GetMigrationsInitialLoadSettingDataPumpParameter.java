...
@CustomType
public final class GetMigrationsInitialLoadSettingDataPumpParameter {
    /**
    ...
    private GetMigrationsInitialLoadSettingDataPumpParameter() {}
    /**
     * @return Estimate size of dumps that will be generated.
     * 
     */
    ...
    public static Builder builder(GetMigrationsInitialLoadSettingDataPumpParameter defaults) {
    ...
    public static final class Builder {
        ...
        private String tableExistsAction;
        public Builder() {}
        public Builder(GetMigrationsInitialLoadSettingDataPumpParameter defaults) {
        ...
        public Builder estimate(String estimate) {
            if (estimate == null) {
              throw new MissingRequiredPropertyException("GetMigrationsInitialLoadSettingDataPumpParameter", "estimate");
            }
        ...
        public Builder excludeParameters(List<String> excludeParameters) {
            if (excludeParameters == null) {
              throw new MissingRequiredPropertyException("GetMigrationsInitialLoadSettingDataPumpParameter", "excludeParameters");
            }
        ...
        public Builder exportParallelismDegree(Integer exportParallelismDegree) {
            if (exportParallelismDegree == null) {
              throw new MissingRequiredPropertyException("GetMigrationsInitialLoadSettingDataPumpParameter", "exportParallelismDegree");
            }
        ...
        public Builder importParallelismDegree(Integer importParallelismDegree) {
            if (importParallelismDegree == null) {
              throw new MissingRequiredPropertyException("GetMigrationsInitialLoadSettingDataPumpParameter", "importParallelismDegree");
            }
        ...
        public Builder isCluster(Boolean isCluster) {
            if (isCluster == null) {
              throw new MissingRequiredPropertyException("GetMigrationsInitialLoadSettingDataPumpParameter", "isCluster");
            }
        ...
        public Builder tableExistsAction(String tableExistsAction) {
            if (tableExistsAction == null) {
              throw new MissingRequiredPropertyException("GetMigrationsInitialLoadSettingDataPumpParameter", "tableExistsAction");
            }
            this.tableExistsAction = tableExistsAction;
            return this;
        }
        public GetMigrationsInitialLoadSettingDataPumpParameter build() {
            final var _resultValue = new GetMigrationsInitialLoadSettingDataPumpParameter();
