    ...
    public static final class Builder {
        ...
        public Builder isIgnoreErrors(Boolean isIgnoreErrors) {
            if (isIgnoreErrors == null) {
              throw new MissingRequiredPropertyException("GetMigrationsMigrationCollectionItemAdvisorSetting", "isIgnoreErrors");
            }
        ...
        public Builder isSkipAdvisor(Boolean isSkipAdvisor) {
            if (isSkipAdvisor == null) {
              throw new MissingRequiredPropertyException("GetMigrationsMigrationCollectionItemAdvisorSetting", "isSkipAdvisor");
            }
