...
public final class GetMigrationsMigrationCollectionItemDatapumpSettingMetadataRemap {
    ...
    public static final class Builder {
        ...
        public Builder newValue(String newValue) {
            if (newValue == null) {
              throw new MissingRequiredPropertyException("GetMigrationsMigrationCollectionItemDatapumpSettingMetadataRemap", "newValue");
            }
        ...
        public Builder oldValue(String oldValue) {
            if (oldValue == null) {
              throw new MissingRequiredPropertyException("GetMigrationsMigrationCollectionItemDatapumpSettingMetadataRemap", "oldValue");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetMigrationsMigrationCollectionItemDatapumpSettingMetadataRemap", "type");
            }
            this.type = type;
            return this;
        }
