...
public final class GetMigrationsMigrationCollectionItemDumpTransferDetailSource {
    ...
    public static final class Builder {
        ...
        public Builder kind(String kind) {
            if (kind == null) {
              throw new MissingRequiredPropertyException("GetMigrationsMigrationCollectionItemDumpTransferDetailSource", "kind");
            }
            this.kind = kind;
            return this;
        }
        ...
        public Builder ociHome(String ociHome) {
            if (ociHome == null) {
              throw new MissingRequiredPropertyException("GetMigrationsMigrationCollectionItemDumpTransferDetailSource", "ociHome");
            }
        ...
        public Builder walletLocation(String walletLocation) {
            if (walletLocation == null) {
              throw new MissingRequiredPropertyException("GetMigrationsMigrationCollectionItemDumpTransferDetailSource", "walletLocation");
            }
            this.walletLocation = walletLocation;
            return this;
        }
        public GetMigrationsMigrationCollectionItemDumpTransferDetailSource build() {
            final var _resultValue = new GetMigrationsMigrationCollectionItemDumpTransferDetailSource();
