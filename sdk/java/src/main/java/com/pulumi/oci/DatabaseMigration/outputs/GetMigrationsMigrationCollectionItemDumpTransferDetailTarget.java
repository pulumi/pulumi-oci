...
public final class GetMigrationsMigrationCollectionItemDumpTransferDetailTarget {
    ...
    public static final class Builder {
        ...
        public Builder kind(String kind) {
            if (kind == null) {
              throw new MissingRequiredPropertyException("GetMigrationsMigrationCollectionItemDumpTransferDetailTarget", "kind");
            }
            this.kind = kind;
            return this;
        }
        ...
        public Builder ociHome(String ociHome) {
            if (ociHome == null) {
              throw new MissingRequiredPropertyException("GetMigrationsMigrationCollectionItemDumpTransferDetailTarget", "ociHome");
            }
        ...
        public Builder walletLocation(String walletLocation) {
            if (walletLocation == null) {
              throw new MissingRequiredPropertyException("GetMigrationsMigrationCollectionItemDumpTransferDetailTarget", "walletLocation");
            }
            this.walletLocation = walletLocation;
            return this;
        }
        public GetMigrationsMigrationCollectionItemDumpTransferDetailTarget build() {
            final var _resultValue = new GetMigrationsMigrationCollectionItemDumpTransferDetailTarget();
