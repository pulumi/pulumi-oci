...
public final class GetMigrationsMigrationCollectionItemGoldenGateDetailHubTargetDbAdminCredential {
    ...
    public static final class Builder {
        ...
        public Builder password(String password) {
            if (password == null) {
              throw new MissingRequiredPropertyException("GetMigrationsMigrationCollectionItemGoldenGateDetailHubTargetDbAdminCredential", "password");
            }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("GetMigrationsMigrationCollectionItemGoldenGateDetailHubTargetDbAdminCredential", "username");
            }
            this.username = username;
            return this;
        }
        public GetMigrationsMigrationCollectionItemGoldenGateDetailHubTargetDbAdminCredential build() {
            final var _resultValue = new GetMigrationsMigrationCollectionItemGoldenGateDetailHubTargetDbAdminCredential();
