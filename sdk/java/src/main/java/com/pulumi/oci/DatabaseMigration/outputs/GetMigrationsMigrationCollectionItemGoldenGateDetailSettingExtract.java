    ...
    public static final class Builder {
        ...
        public Builder longTransDuration(Integer longTransDuration) {
            if (longTransDuration == null) {
              throw new MissingRequiredPropertyException("GetMigrationsMigrationCollectionItemGoldenGateDetailSettingExtract", "longTransDuration");
            }
        ...
        public Builder performanceProfile(String performanceProfile) {
            if (performanceProfile == null) {
              throw new MissingRequiredPropertyException("GetMigrationsMigrationCollectionItemGoldenGateDetailSettingExtract", "performanceProfile");
            }
