    ...
    public static final class Builder {
        ...
        public Builder longTransDuration(Integer longTransDuration) {
            if (longTransDuration == null) {
              throw new MissingRequiredPropertyException("GetMigrationsMigrationCollectionItemGoldenGateServiceDetailSettingExtract", "longTransDuration");
            }
        ...
        public Builder performanceProfile(String performanceProfile) {
            if (performanceProfile == null) {
              throw new MissingRequiredPropertyException("GetMigrationsMigrationCollectionItemGoldenGateServiceDetailSettingExtract", "performanceProfile");
            }
            this.performanceProfile = performanceProfile;
            return this;
        }
        public GetMigrationsMigrationCollectionItemGoldenGateServiceDetailSettingExtract build() {
            final var _resultValue = new GetMigrationsMigrationCollectionItemGoldenGateServiceDetailSettingExtract();
