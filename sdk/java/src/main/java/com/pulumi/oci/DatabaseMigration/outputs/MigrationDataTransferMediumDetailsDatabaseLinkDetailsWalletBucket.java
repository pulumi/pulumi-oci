...
public final class MigrationDataTransferMediumDetailsDatabaseLinkDetailsWalletBucket {
    ...
    public static final class Builder {
        ...
        public Builder bucket(String bucket) {
            if (bucket == null) {
              throw new MissingRequiredPropertyException("MigrationDataTransferMediumDetailsDatabaseLinkDetailsWalletBucket", "bucket");
            }
            this.bucket = bucket;
            return this;
        }
        ...
        public Builder namespace(String namespace) {
            if (namespace == null) {
              throw new MissingRequiredPropertyException("MigrationDataTransferMediumDetailsDatabaseLinkDetailsWalletBucket", "namespace");
            }
