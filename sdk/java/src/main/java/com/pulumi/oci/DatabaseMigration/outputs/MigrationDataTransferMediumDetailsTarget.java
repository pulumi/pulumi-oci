...
@CustomType
public final class MigrationDataTransferMediumDetailsTarget {
    /**
    ...
    private MigrationDataTransferMediumDetailsTarget() {}
    /**
     * @return (Updatable) Type of dump transfer to use during migration in source or target host. Default kind is CURL
     * 
     */
    ...
    public static Builder builder(MigrationDataTransferMediumDetailsTarget defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String walletLocation;
        public Builder() {}
        public Builder(MigrationDataTransferMediumDetailsTarget defaults) {
        ...
        public Builder kind(String kind) {
            if (kind == null) {
              throw new MissingRequiredPropertyException("MigrationDataTransferMediumDetailsTarget", "kind");
            }
            this.kind = kind;
            return this;
        }
        ...
        public MigrationDataTransferMediumDetailsTarget build() {
            final var _resultValue = new MigrationDataTransferMediumDetailsTarget();
