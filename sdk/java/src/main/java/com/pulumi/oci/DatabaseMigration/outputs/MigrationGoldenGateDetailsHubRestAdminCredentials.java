...
public final class MigrationGoldenGateDetailsHubRestAdminCredentials {
    ...
    public static final class Builder {
        ...
        public Builder password(String password) {
            if (password == null) {
              throw new MissingRequiredPropertyException("MigrationGoldenGateDetailsHubRestAdminCredentials", "password");
            }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("MigrationGoldenGateDetailsHubRestAdminCredentials", "username");
            }
            this.username = username;
            return this;
        }
        public MigrationGoldenGateDetailsHubRestAdminCredentials build() {
            final var _resultValue = new MigrationGoldenGateDetailsHubRestAdminCredentials();
