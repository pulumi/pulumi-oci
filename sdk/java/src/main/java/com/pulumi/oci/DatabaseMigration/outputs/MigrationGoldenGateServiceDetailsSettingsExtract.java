...
@CustomType
public final class MigrationGoldenGateServiceDetailsSettingsExtract {
    /**
    ...
    private MigrationGoldenGateServiceDetailsSettingsExtract() {}
    /**
     * @return (Updatable) Length of time (in seconds) that a transaction can be open before Extract generates a warning message that the transaction is long-running. If not specified, Extract will not generate a warning on long-running transactions.
     * 
     */
    ...
    public static Builder builder(MigrationGoldenGateServiceDetailsSettingsExtract defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String performanceProfile;
        public Builder() {}
        public Builder(MigrationGoldenGateServiceDetailsSettingsExtract defaults) {
        ...
        public MigrationGoldenGateServiceDetailsSettingsExtract build() {
            final var _resultValue = new MigrationGoldenGateServiceDetailsSettingsExtract();
