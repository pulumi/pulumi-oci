...
public final class MigrationIncludeObject {
    ...
    public static final class Builder {
        ...
        public Builder object(String object) {
            if (object == null) {
              throw new MissingRequiredPropertyException("MigrationIncludeObject", "object");
            }
            this.object = object;
            return this;
        }
        ...
        public Builder owner(String owner) {
            if (owner == null) {
              throw new MissingRequiredPropertyException("MigrationIncludeObject", "owner");
            }
            this.owner = owner;
            return this;
        }
        ...
        public MigrationIncludeObject build() {
            final var _resultValue = new MigrationIncludeObject();
