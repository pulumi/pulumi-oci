...
public final class DatabaseToolsDatabaseApiGatewayConfigLockArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatabaseToolsDatabaseApiGatewayConfigLockArgs Empty = new DatabaseToolsDatabaseApiGatewayConfigLockArgs();
    ...
    private DatabaseToolsDatabaseApiGatewayConfigLockArgs() {}

    private DatabaseToolsDatabaseApiGatewayConfigLockArgs(DatabaseToolsDatabaseApiGatewayConfigLockArgs $) {
    ...
    public static Builder builder(DatabaseToolsDatabaseApiGatewayConfigLockArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatabaseToolsDatabaseApiGatewayConfigLockArgs();
        }

        public Builder(DatabaseToolsDatabaseApiGatewayConfigLockArgs defaults) {
            $ = new DatabaseToolsDatabaseApiGatewayConfigLockArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DatabaseToolsDatabaseApiGatewayConfigLockArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("DatabaseToolsDatabaseApiGatewayConfigLockArgs", "type");
            }
            return $;
        }
    }
