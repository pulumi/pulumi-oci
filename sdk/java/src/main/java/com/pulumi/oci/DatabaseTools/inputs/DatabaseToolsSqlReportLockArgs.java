...
public final class DatabaseToolsSqlReportLockArgs extends com.pulumi.resources.ResourceArgs {

    public static final DatabaseToolsSqlReportLockArgs Empty = new DatabaseToolsSqlReportLockArgs();
    ...
    private DatabaseToolsSqlReportLockArgs() {}

    private DatabaseToolsSqlReportLockArgs(DatabaseToolsSqlReportLockArgs $) {
    ...
    public static Builder builder(DatabaseToolsSqlReportLockArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DatabaseToolsSqlReportLockArgs();
        }

        public Builder(DatabaseToolsSqlReportLockArgs defaults) {
            $ = new DatabaseToolsSqlReportLockArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DatabaseToolsSqlReportLockArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("DatabaseToolsSqlReportLockArgs", "type");
            }
            return $;
        }
    }
