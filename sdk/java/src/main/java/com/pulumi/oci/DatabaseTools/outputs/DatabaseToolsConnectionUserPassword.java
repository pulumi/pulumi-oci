...
public final class DatabaseToolsConnectionUserPassword {
    ...
    public static final class Builder {
        ...
        public Builder secretId(String secretId) {
            if (secretId == null) {
              throw new MissingRequiredPropertyException("DatabaseToolsConnectionUserPassword", "secretId");
            }
        ...
        public Builder valueType(String valueType) {
            if (valueType == null) {
              throw new MissingRequiredPropertyException("DatabaseToolsConnectionUserPassword", "valueType");
            }
