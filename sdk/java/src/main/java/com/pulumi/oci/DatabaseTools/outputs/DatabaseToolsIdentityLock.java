...
@CustomType
public final class DatabaseToolsIdentityLock {
    /**
    ...
    public static Builder builder(DatabaseToolsIdentityLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(DatabaseToolsIdentityLock defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("DatabaseToolsIdentityLock", "type");
            }
            this.type = type;
            return this;
        }
        public DatabaseToolsIdentityLock build() {
            final var _resultValue = new DatabaseToolsIdentityLock();
