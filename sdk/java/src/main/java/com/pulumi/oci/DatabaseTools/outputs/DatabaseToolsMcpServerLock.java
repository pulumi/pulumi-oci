...
@CustomType
public final class DatabaseToolsMcpServerLock {
    /**
    ...
    private DatabaseToolsMcpServerLock() {}
    /**
     * @return A message added by the creator of the lock. This is typically used to give an indication of why the resource is locked.
     * 
     */
    ...
    public static Builder builder(DatabaseToolsMcpServerLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(DatabaseToolsMcpServerLock defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("DatabaseToolsMcpServerLock", "type");
            }
            this.type = type;
            return this;
        }
        public DatabaseToolsMcpServerLock build() {
            final var _resultValue = new DatabaseToolsMcpServerLock();
