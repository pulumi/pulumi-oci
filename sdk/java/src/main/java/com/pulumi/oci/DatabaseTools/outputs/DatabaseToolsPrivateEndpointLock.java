...
@CustomType
public final class DatabaseToolsPrivateEndpointLock {
    /**
    ...
    private DatabaseToolsPrivateEndpointLock() {}
    /**
     * @return A message added by the creator of the lock. This is typically used to give an indication of why the resource is locked.
     * 
     */
    ...
    public static Builder builder(DatabaseToolsPrivateEndpointLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(DatabaseToolsPrivateEndpointLock defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("DatabaseToolsPrivateEndpointLock", "type");
            }
            this.type = type;
            return this;
        }
        public DatabaseToolsPrivateEndpointLock build() {
            final var _resultValue = new DatabaseToolsPrivateEndpointLock();
