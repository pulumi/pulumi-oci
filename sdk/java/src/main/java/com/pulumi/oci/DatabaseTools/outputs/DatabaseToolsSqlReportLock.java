...
@CustomType
public final class DatabaseToolsSqlReportLock {
    /**
    ...
    public static Builder builder(DatabaseToolsSqlReportLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(DatabaseToolsSqlReportLock defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("DatabaseToolsSqlReportLock", "type");
            }
            this.type = type;
            return this;
        }
        public DatabaseToolsSqlReportLock build() {
            final var _resultValue = new DatabaseToolsSqlReportLock();
