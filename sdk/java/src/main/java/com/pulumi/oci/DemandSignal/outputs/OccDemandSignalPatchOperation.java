...
@CustomType
public final class OccDemandSignalPatchOperation {
    /**
     * @return (Updatable)
     * 
     */
    ...
    public static Builder builder(OccDemandSignalPatchOperation defaults) {
    ...
    public static final class Builder {
        ...
        private Map<String,String> value;
        public Builder() {}
        public Builder(OccDemandSignalPatchOperation defaults) {
        ...
        public Builder from(String from) {
            if (from == null) {
              throw new MissingRequiredPropertyException("OccDemandSignalPatchOperation", "from");
            }
            this.from = from;
            return this;
        }
        ...
        public Builder operation(String operation) {
            if (operation == null) {
              throw new MissingRequiredPropertyException("OccDemandSignalPatchOperation", "operation");
            }
        ...
        public Builder selection(String selection) {
            if (selection == null) {
              throw new MissingRequiredPropertyException("OccDemandSignalPatchOperation", "selection");
            }
        ...
        public Builder value(Map<String,String> value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("OccDemandSignalPatchOperation", "value");
            }
            this.value = value;
            return this;
        }
        public OccDemandSignalPatchOperation build() {
            final var _resultValue = new OccDemandSignalPatchOperation();
