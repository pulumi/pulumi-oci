...
import com.pulumi.oci.Desktops.inputs.GetDesktopsFilterArgs;
...
public final class GetDesktopsArgs extends com.pulumi.resources.InvokeArgs {
    ...
    private @Nullable Output<String> desktopPoolId;

    /**
     * @return The OCID of the desktop pool.
     * 
     */
    public Optional<Output<String>> desktopPoolId() {
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetDesktopsFilterArgs>> filters;

    public Optional<Output<List<GetDesktopsFilterArgs>>> filters() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder desktopPoolId(@Nullable Output<String> desktopPoolId) {
        ...
        public Builder filters(@Nullable Output<List<GetDesktopsFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetDesktopsFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetDesktopsFilterArgs... filters) {
        ...
        public GetDesktopsArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetDesktopsArgs", "compartmentId");
            }
            return $;
        }
    }
