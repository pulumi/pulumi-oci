...
@CustomType
public final class GetDesktopPoolDevicePolicy {
    /**
    ...
    private GetDesktopPoolDevicePolicy() {}
    /**
     * @return The audio mode. NONE: No access to the local audio devices is permitted. TODESKTOP: The user may record audio on their desktop.  FROMDESKTOP: The user may play audio on their desktop. FULL: The user may play and record audio on their desktop.
     * 
     */
    ...
    public static Builder builder(GetDesktopPoolDevicePolicy defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean isVideoInputEnabled;
        public Builder() {}
        public Builder(GetDesktopPoolDevicePolicy defaults) {
        ...
        public Builder audioMode(String audioMode) {
            if (audioMode == null) {
              throw new MissingRequiredPropertyException("GetDesktopPoolDevicePolicy", "audioMode");
            }
        ...
        public Builder cdmMode(String cdmMode) {
            if (cdmMode == null) {
              throw new MissingRequiredPropertyException("GetDesktopPoolDevicePolicy", "cdmMode");
            }
        ...
        public Builder clipboardMode(String clipboardMode) {
            if (clipboardMode == null) {
              throw new MissingRequiredPropertyException("GetDesktopPoolDevicePolicy", "clipboardMode");
            }
        ...
        public Builder isDisplayEnabled(Boolean isDisplayEnabled) {
            if (isDisplayEnabled == null) {
              throw new MissingRequiredPropertyException("GetDesktopPoolDevicePolicy", "isDisplayEnabled");
            }
        ...
        public Builder isKeyboardEnabled(Boolean isKeyboardEnabled) {
            if (isKeyboardEnabled == null) {
              throw new MissingRequiredPropertyException("GetDesktopPoolDevicePolicy", "isKeyboardEnabled");
            }
        ...
        public Builder isPointerEnabled(Boolean isPointerEnabled) {
            if (isPointerEnabled == null) {
              throw new MissingRequiredPropertyException("GetDesktopPoolDevicePolicy", "isPointerEnabled");
            }
        ...
        public Builder isPrintingEnabled(Boolean isPrintingEnabled) {
            if (isPrintingEnabled == null) {
              throw new MissingRequiredPropertyException("GetDesktopPoolDevicePolicy", "isPrintingEnabled");
            }
        ...
        public Builder isVideoInputEnabled(Boolean isVideoInputEnabled) {
            if (isVideoInputEnabled == null) {
              throw new MissingRequiredPropertyException("GetDesktopPoolDevicePolicy", "isVideoInputEnabled");
            }
            this.isVideoInputEnabled = isVideoInputEnabled;
            return this;
        }
        public GetDesktopPoolDevicePolicy build() {
            final var _resultValue = new GetDesktopPoolDevicePolicy();
