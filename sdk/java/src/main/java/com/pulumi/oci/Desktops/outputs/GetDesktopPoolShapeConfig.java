...
@CustomType
public final class GetDesktopPoolShapeConfig {
    /**
    ...
    private GetDesktopPoolShapeConfig() {}
    /**
     * @return The baseline OCPU utilization for a subcore burstable VM instance used for each desktop compute instance in the desktop pool. Leave this attribute blank for a non-burstable instance, or explicitly specify non-burstable with `BASELINE_1_1`. The following values are supported:
     * * `BASELINE_1_8` - baseline usage is 1/8 of an OCPU.
     * * `BASELINE_1_2` - baseline usage is 1/2 of an OCPU.
    ...
    public static Builder builder(GetDesktopPoolShapeConfig defaults) {
    ...
    public static final class Builder {
        ...
        private String ocpus;
        public Builder() {}
        public Builder(GetDesktopPoolShapeConfig defaults) {
        ...
        public Builder baselineOcpuUtilization(String baselineOcpuUtilization) {
            if (baselineOcpuUtilization == null) {
              throw new MissingRequiredPropertyException("GetDesktopPoolShapeConfig", "baselineOcpuUtilization");
            }
        ...
        public Builder memoryInGbs(String memoryInGbs) {
            if (memoryInGbs == null) {
              throw new MissingRequiredPropertyException("GetDesktopPoolShapeConfig", "memoryInGbs");
            }
        ...
        public Builder ocpus(String ocpus) {
            if (ocpus == null) {
              throw new MissingRequiredPropertyException("GetDesktopPoolShapeConfig", "ocpus");
            }
            this.ocpus = ocpus;
            return this;
        }
        public GetDesktopPoolShapeConfig build() {
            final var _resultValue = new GetDesktopPoolShapeConfig();
