...
public final class DeployStageTestLoadBalancerConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final DeployStageTestLoadBalancerConfigArgs Empty = new DeployStageTestLoadBalancerConfigArgs();
    ...
    private DeployStageTestLoadBalancerConfigArgs() {}

    private DeployStageTestLoadBalancerConfigArgs(DeployStageTestLoadBalancerConfigArgs $) {
    ...
    public static Builder builder(DeployStageTestLoadBalancerConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeployStageTestLoadBalancerConfigArgs();
        }

        public Builder(DeployStageTestLoadBalancerConfigArgs defaults) {
            $ = new DeployStageTestLoadBalancerConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DeployStageTestLoadBalancerConfigArgs build() {
            return $;
        }
    }
