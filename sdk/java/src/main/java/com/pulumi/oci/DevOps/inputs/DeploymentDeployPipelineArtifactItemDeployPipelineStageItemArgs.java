...
public final class DeploymentDeployPipelineArtifactItemDeployPipelineStageItemArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private DeploymentDeployPipelineArtifactItemDeployPipelineStageItemArgs() {}

    private DeploymentDeployPipelineArtifactItemDeployPipelineStageItemArgs(DeploymentDeployPipelineArtifactItemDeployPipelineStageItemArgs $) {
    ...
    public static Builder builder(DeploymentDeployPipelineArtifactItemDeployPipelineStageItemArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DeploymentDeployPipelineArtifactItemDeployPipelineStageItemArgs();
        }

        public Builder(DeploymentDeployPipelineArtifactItemDeployPipelineStageItemArgs defaults) {
            $ = new DeploymentDeployPipelineArtifactItemDeployPipelineStageItemArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DeploymentDeployPipelineArtifactItemDeployPipelineStageItemArgs build() {
            return $;
        }
    }
