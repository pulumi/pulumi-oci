...
import com.pulumi.oci.DevOps.inputs.GetDeployArtifactsFilter;
...
public final class GetDeployArtifactsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDeployArtifactsPlainArgs Empty = new GetDeployArtifactsPlainArgs();
    ...
    public Optional<List<GetDeployArtifactsFilter>> filters() {
    ...
    private GetDeployArtifactsPlainArgs() {}

    private GetDeployArtifactsPlainArgs(GetDeployArtifactsPlainArgs $) {
    ...
    public static Builder builder(GetDeployArtifactsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDeployArtifactsPlainArgs();
        }

        public Builder(GetDeployArtifactsPlainArgs defaults) {
            $ = new GetDeployArtifactsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetDeployArtifactsPlainArgs build() {
            return $;
        }
    }
