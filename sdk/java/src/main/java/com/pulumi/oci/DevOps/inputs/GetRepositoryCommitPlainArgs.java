...
public final class GetRepositoryCommitPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetRepositoryCommitPlainArgs build() {
            if ($.commitId == null) {
                throw new MissingRequiredPropertyException("GetRepositoryCommitPlainArgs", "commitId");
            }
            if ($.repositoryId == null) {
                throw new MissingRequiredPropertyException("GetRepositoryCommitPlainArgs", "repositoryId");
            }
            return $;
        }
    }
