...
public final class GetRepositoryFileDiffArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetRepositoryFileDiffArgs build() {
            if ($.baseVersion == null) {
                throw new MissingRequiredPropertyException("GetRepositoryFileDiffArgs", "baseVersion");
            }
            if ($.filePath == null) {
                throw new MissingRequiredPropertyException("GetRepositoryFileDiffArgs", "filePath");
            }
            if ($.repositoryId == null) {
                throw new MissingRequiredPropertyException("GetRepositoryFileDiffArgs", "repositoryId");
            }
            if ($.targetVersion == null) {
                throw new MissingRequiredPropertyException("GetRepositoryFileDiffArgs", "targetVersion");
            }
            return $;
        }
    }
