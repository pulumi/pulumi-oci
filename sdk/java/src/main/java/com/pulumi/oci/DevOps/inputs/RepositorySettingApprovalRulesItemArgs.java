...
import com.pulumi.oci.DevOps.inputs.RepositorySettingApprovalRulesItemReviewerArgs;
...
public final class RepositorySettingApprovalRulesItemArgs extends com.pulumi.resources.ResourceArgs {

    public static final RepositorySettingApprovalRulesItemArgs Empty = new RepositorySettingApprovalRulesItemArgs();
    ...
    private @Nullable Output<List<RepositorySettingApprovalRulesItemReviewerArgs>> reviewers;
     ...
     * 
     */
    public Optional<Output<List<RepositorySettingApprovalRulesItemReviewerArgs>>> reviewers() {
        return Optional.ofNullable(this.reviewers);
    }

    private RepositorySettingApprovalRulesItemArgs() {}

    private RepositorySettingApprovalRulesItemArgs(RepositorySettingApprovalRulesItemArgs $) {
    ...
    public static Builder builder(RepositorySettingApprovalRulesItemArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RepositorySettingApprovalRulesItemArgs();
        }

        public Builder(RepositorySettingApprovalRulesItemArgs defaults) {
            $ = new RepositorySettingApprovalRulesItemArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder reviewers(@Nullable Output<List<RepositorySettingApprovalRulesItemReviewerArgs>> reviewers) {
            $.reviewers = reviewers;
            return this;
        }
         ...
         * 
         */
        public Builder reviewers(List<RepositorySettingApprovalRulesItemReviewerArgs> reviewers) {
         ...
         * 
         */
        public Builder reviewers(RepositorySettingApprovalRulesItemReviewerArgs... reviewers) {
            return reviewers(List.of(reviewers));
        }

        public RepositorySettingApprovalRulesItemArgs build() {
            if ($.minApprovalsCount == null) {
                throw new MissingRequiredPropertyException("RepositorySettingApprovalRulesItemArgs", "minApprovalsCount");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("RepositorySettingApprovalRulesItemArgs", "name");
            }
            return $;
        }
    }
