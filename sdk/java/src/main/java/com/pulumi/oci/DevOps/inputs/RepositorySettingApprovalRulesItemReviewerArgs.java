...
public final class RepositorySettingApprovalRulesItemReviewerArgs extends com.pulumi.resources.ResourceArgs {

    public static final RepositorySettingApprovalRulesItemReviewerArgs Empty = new RepositorySettingApprovalRulesItemReviewerArgs();
    ...
    private RepositorySettingApprovalRulesItemReviewerArgs() {}

    private RepositorySettingApprovalRulesItemReviewerArgs(RepositorySettingApprovalRulesItemReviewerArgs $) {
    ...
    public static Builder builder(RepositorySettingApprovalRulesItemReviewerArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RepositorySettingApprovalRulesItemReviewerArgs();
        }

        public Builder(RepositorySettingApprovalRulesItemReviewerArgs defaults) {
            $ = new RepositorySettingApprovalRulesItemReviewerArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RepositorySettingApprovalRulesItemReviewerArgs build() {
            if ($.principalId == null) {
                throw new MissingRequiredPropertyException("RepositorySettingApprovalRulesItemReviewerArgs", "principalId");
            }
            return $;
        }
    }
