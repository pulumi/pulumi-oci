...
public final class RepositorySettingMergeSettingsArgs extends com.pulumi.resources.ResourceArgs {

    public static final RepositorySettingMergeSettingsArgs Empty = new RepositorySettingMergeSettingsArgs();
    ...
    private RepositorySettingMergeSettingsArgs() {}

    private RepositorySettingMergeSettingsArgs(RepositorySettingMergeSettingsArgs $) {
    ...
    public static Builder builder(RepositorySettingMergeSettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RepositorySettingMergeSettingsArgs();
        }

        public Builder(RepositorySettingMergeSettingsArgs defaults) {
            $ = new RepositorySettingMergeSettingsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RepositorySettingMergeSettingsArgs build() {
            if ($.allowedMergeStrategies == null) {
                throw new MissingRequiredPropertyException("RepositorySettingMergeSettingsArgs", "allowedMergeStrategies");
            }
            if ($.defaultMergeStrategy == null) {
                throw new MissingRequiredPropertyException("RepositorySettingMergeSettingsArgs", "defaultMergeStrategy");
            }
            return $;
        }
    }
