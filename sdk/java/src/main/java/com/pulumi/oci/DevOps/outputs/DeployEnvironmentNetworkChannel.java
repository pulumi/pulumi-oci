    ...
    public static final class Builder {
        ...
        public Builder networkChannelType(String networkChannelType) {
            if (networkChannelType == null) {
              throw new MissingRequiredPropertyException("DeployEnvironmentNetworkChannel", "networkChannelType");
            }
        ...
        public Builder subnetId(String subnetId) {
            if (subnetId == null) {
              throw new MissingRequiredPropertyException("DeployEnvironmentNetworkChannel", "subnetId");
            }
            this.subnetId = subnetId;
            return this;
        }
        public DeployEnvironmentNetworkChannel build() {
            final var _resultValue = new DeployEnvironmentNetworkChannel();
