...
@CustomType
public final class DeployStageContainerConfigNetworkChannel {
    /**
    ...
    public static Builder builder(DeployStageContainerConfigNetworkChannel defaults) {
    ...
    public static final class Builder {
        ...
        private String subnetId;
        public Builder() {}
        public Builder(DeployStageContainerConfigNetworkChannel defaults) {
        ...
        public Builder networkChannelType(String networkChannelType) {
            if (networkChannelType == null) {
              throw new MissingRequiredPropertyException("DeployStageContainerConfigNetworkChannel", "networkChannelType");
            }
        ...
        public Builder subnetId(String subnetId) {
            if (subnetId == null) {
              throw new MissingRequiredPropertyException("DeployStageContainerConfigNetworkChannel", "subnetId");
            }
