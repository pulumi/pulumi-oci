    ...
    public static final class Builder {
        ...
        public Builder waitDuration(String waitDuration) {
            if (waitDuration == null) {
              throw new MissingRequiredPropertyException("GetBuildPipelineStageWaitCriteria", "waitDuration");
            }
        ...
        public Builder waitType(String waitType) {
            if (waitType == null) {
              throw new MissingRequiredPropertyException("GetBuildPipelineStageWaitCriteria", "waitType");
            }
            this.waitType = waitType;
            return this;
        }
        public GetBuildPipelineStageWaitCriteria build() {
            final var _resultValue = new GetBuildPipelineStageWaitCriteria();
