...
public final class GetBuildPipelineStagesBuildPipelineStageCollectionItemDeliverArtifactCollection {
     ...
     * 
     */
    private @Nullable List<GetBuildPipelineStagesBuildPipelineStageCollectionItemDeliverArtifactCollectionItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetBuildPipelineStagesBuildPipelineStageCollectionItemDeliverArtifactCollectionItem> items) {
            this.items = items;
            return this;
        }
