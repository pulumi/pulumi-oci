...
public final class GetBuildPipelinesResult {
    ...
    public static final class Builder {
        ...
        public Builder buildPipelineCollections(List<GetBuildPipelinesBuildPipelineCollection> buildPipelineCollections) {
            if (buildPipelineCollections == null) {
              throw new MissingRequiredPropertyException("GetBuildPipelinesResult", "buildPipelineCollections");
            }
        ...
        public GetBuildPipelinesResult build() {
            final var _resultValue = new GetBuildPipelinesResult();
            _resultValue.buildPipelineCollections = buildPipelineCollections;
