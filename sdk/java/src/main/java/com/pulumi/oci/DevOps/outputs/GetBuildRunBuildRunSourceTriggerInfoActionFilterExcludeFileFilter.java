...
public final class GetBuildRunBuildRunSourceTriggerInfoActionFilterExcludeFileFilter {
    ...
    public static final class Builder {
        ...
        public Builder filePaths(List<String> filePaths) {
            if (filePaths == null) {
              throw new MissingRequiredPropertyException("GetBuildRunBuildRunSourceTriggerInfoActionFilterExcludeFileFilter", "filePaths");
            }
        ...
        public GetBuildRunBuildRunSourceTriggerInfoActionFilterExcludeFileFilter build() {
            final var _resultValue = new GetBuildRunBuildRunSourceTriggerInfoActionFilterExcludeFileFilter();
