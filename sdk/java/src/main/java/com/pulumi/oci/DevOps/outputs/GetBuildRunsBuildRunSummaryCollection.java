...
public final class GetBuildRunsBuildRunSummaryCollection {
     ...
     * 
     */
    private @Nullable List<GetBuildRunsBuildRunSummaryCollectionItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetBuildRunsBuildRunSummaryCollectionItem> items) {
            this.items = items;
            return this;
        }
