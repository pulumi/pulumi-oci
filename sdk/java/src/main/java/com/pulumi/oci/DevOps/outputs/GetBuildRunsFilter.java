...
public final class GetBuildRunsFilter {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetBuildRunsFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetBuildRunsFilter", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetBuildRunsFilter build() {
            final var _resultValue = new GetBuildRunsFilter();
