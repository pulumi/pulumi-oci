    ...
    public static final class Builder {
        ...
        public Builder currentPublicKey(String currentPublicKey) {
            if (currentPublicKey == null) {
              throw new MissingRequiredPropertyException("GetDeployArtifactDeployArtifactSourceHelmVerificationKeySource", "currentPublicKey");
            }
        ...
        public Builder previousPublicKey(String previousPublicKey) {
            if (previousPublicKey == null) {
              throw new MissingRequiredPropertyException("GetDeployArtifactDeployArtifactSourceHelmVerificationKeySource", "previousPublicKey");
            }
        ...
        public Builder vaultSecretId(String vaultSecretId) {
            if (vaultSecretId == null) {
              throw new MissingRequiredPropertyException("GetDeployArtifactDeployArtifactSourceHelmVerificationKeySource", "vaultSecretId");
            }
        ...
        public Builder verificationKeySourceType(String verificationKeySourceType) {
            if (verificationKeySourceType == null) {
              throw new MissingRequiredPropertyException("GetDeployArtifactDeployArtifactSourceHelmVerificationKeySource", "verificationKeySourceType");
            }
