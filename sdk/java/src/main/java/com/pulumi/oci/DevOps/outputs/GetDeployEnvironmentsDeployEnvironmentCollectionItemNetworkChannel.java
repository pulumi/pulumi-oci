...
@CustomType
public final class GetDeployEnvironmentsDeployEnvironmentCollectionItemNetworkChannel {
    /**
    ...
    public static final class Builder {
        ...
        public Builder networkChannelType(String networkChannelType) {
            if (networkChannelType == null) {
              throw new MissingRequiredPropertyException("GetDeployEnvironmentsDeployEnvironmentCollectionItemNetworkChannel", "networkChannelType");
            }
        ...
        public Builder nsgIds(List<String> nsgIds) {
            if (nsgIds == null) {
              throw new MissingRequiredPropertyException("GetDeployEnvironmentsDeployEnvironmentCollectionItemNetworkChannel", "nsgIds");
            }
            this.nsgIds = nsgIds;
            return this;
        }
        ...
        public Builder subnetId(String subnetId) {
            if (subnetId == null) {
              throw new MissingRequiredPropertyException("GetDeployEnvironmentsDeployEnvironmentCollectionItemNetworkChannel", "subnetId");
            }
            this.subnetId = subnetId;
            return this;
        }
        public GetDeployEnvironmentsDeployEnvironmentCollectionItemNetworkChannel build() {
            final var _resultValue = new GetDeployEnvironmentsDeployEnvironmentCollectionItemNetworkChannel();
