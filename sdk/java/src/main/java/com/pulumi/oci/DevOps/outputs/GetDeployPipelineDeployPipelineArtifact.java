...
public final class GetDeployPipelineDeployPipelineArtifact {
    ...
    public static final class Builder {
        ...
        public Builder items(List<GetDeployPipelineDeployPipelineArtifactItem> items) {
            if (items == null) {
              throw new MissingRequiredPropertyException("GetDeployPipelineDeployPipelineArtifact", "items");
            }
            this.items = items;
            return this;
        }
        ...
        public GetDeployPipelineDeployPipelineArtifact build() {
            final var _resultValue = new GetDeployPipelineDeployPipelineArtifact();
