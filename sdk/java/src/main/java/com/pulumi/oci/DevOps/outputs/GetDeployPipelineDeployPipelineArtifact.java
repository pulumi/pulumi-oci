...
public final class GetDeployPipelineDeployPipelineArtifact {
     ...
     * 
     */
    private @Nullable List<GetDeployPipelineDeployPipelineArtifactItem> items;

    private GetDeployPipelineDeployPipelineArtifact() {}
    /**
     * @return List of parameters defined for a deployment pipeline.
     * 
     */
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetDeployPipelineDeployPipelineArtifactItem> items) {
            this.items = items;
            return this;
        }
        ...
        public GetDeployPipelineDeployPipelineArtifact build() {
            final var o = new GetDeployPipelineDeployPipelineArtifact();
            o.items = items;
            return o;
        }
    }
