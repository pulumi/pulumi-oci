...
public final class GetDeployPipelinesDeployPipelineCollection {
    ...
    public static final class Builder {
        ...
        public Builder items(List<GetDeployPipelinesDeployPipelineCollectionItem> items) {
            if (items == null) {
              throw new MissingRequiredPropertyException("GetDeployPipelinesDeployPipelineCollection", "items");
            }
            this.items = items;
            return this;
        }
        ...
        public GetDeployPipelinesDeployPipelineCollection build() {
            final var _resultValue = new GetDeployPipelinesDeployPipelineCollection();
