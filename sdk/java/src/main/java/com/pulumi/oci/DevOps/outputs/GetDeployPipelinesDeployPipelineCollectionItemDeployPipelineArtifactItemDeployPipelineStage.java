...
public final class GetDeployPipelinesDeployPipelineCollectionItemDeployPipelineArtifactItemDeployPipelineStage {
    ...
    public static final class Builder {
        ...
        public Builder items(List<GetDeployPipelinesDeployPipelineCollectionItemDeployPipelineArtifactItemDeployPipelineStageItem> items) {
            if (items == null) {
              throw new MissingRequiredPropertyException("GetDeployPipelinesDeployPipelineCollectionItemDeployPipelineArtifactItemDeployPipelineStage", "items");
            }
            this.items = items;
            return this;
        }
        ...
        public GetDeployPipelinesDeployPipelineCollectionItemDeployPipelineArtifactItemDeployPipelineStage build() {
            final var _resultValue = new GetDeployPipelinesDeployPipelineCollectionItemDeployPipelineArtifactItemDeployPipelineStage();
