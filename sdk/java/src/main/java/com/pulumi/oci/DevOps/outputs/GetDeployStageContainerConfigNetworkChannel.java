    ...
    public static final class Builder {
        ...
        public Builder networkChannelType(String networkChannelType) {
            if (networkChannelType == null) {
              throw new MissingRequiredPropertyException("GetDeployStageContainerConfigNetworkChannel", "networkChannelType");
            }
        ...
        public Builder nsgIds(List<String> nsgIds) {
            if (nsgIds == null) {
              throw new MissingRequiredPropertyException("GetDeployStageContainerConfigNetworkChannel", "nsgIds");
            }
            this.nsgIds = nsgIds;
            return this;
        }
        ...
        public Builder subnetId(String subnetId) {
            if (subnetId == null) {
              throw new MissingRequiredPropertyException("GetDeployStageContainerConfigNetworkChannel", "subnetId");
            }
            this.subnetId = subnetId;
            return this;
        }
        public GetDeployStageContainerConfigNetworkChannel build() {
            final var _resultValue = new GetDeployStageContainerConfigNetworkChannel();
