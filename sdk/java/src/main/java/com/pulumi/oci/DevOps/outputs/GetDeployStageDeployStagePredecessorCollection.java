...
public final class GetDeployStageDeployStagePredecessorCollection {
    ...
    public static final class Builder {
        ...
        public Builder items(List<GetDeployStageDeployStagePredecessorCollectionItem> items) {
            if (items == null) {
              throw new MissingRequiredPropertyException("GetDeployStageDeployStagePredecessorCollection", "items");
            }
            this.items = items;
            return this;
        }
        ...
        public GetDeployStageDeployStagePredecessorCollection build() {
            final var _resultValue = new GetDeployStageDeployStagePredecessorCollection();
