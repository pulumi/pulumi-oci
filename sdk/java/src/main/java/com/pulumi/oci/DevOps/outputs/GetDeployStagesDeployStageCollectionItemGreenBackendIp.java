...
public final class GetDeployStagesDeployStageCollectionItemGreenBackendIp {
    ...
    private GetDeployStagesDeployStageCollectionItemGreenBackendIp() {}
    /**
     * @return List of parameters defined to set helm value.
     * 
     */
    ...
    public static final class Builder {
        ...
        public Builder items(List<String> items) {
            if (items == null) {
              throw new MissingRequiredPropertyException("GetDeployStagesDeployStageCollectionItemGreenBackendIp", "items");
            }
            this.items = items;
            return this;
        }
