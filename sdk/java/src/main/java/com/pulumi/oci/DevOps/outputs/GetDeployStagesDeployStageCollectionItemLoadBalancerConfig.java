...
public final class GetDeployStagesDeployStageCollectionItemLoadBalancerConfig {
    ...
    public static final class Builder {
        ...
        public Builder backendPort(Integer backendPort) {
            if (backendPort == null) {
              throw new MissingRequiredPropertyException("GetDeployStagesDeployStageCollectionItemLoadBalancerConfig", "backendPort");
            }
        ...
        public Builder listenerName(String listenerName) {
            if (listenerName == null) {
              throw new MissingRequiredPropertyException("GetDeployStagesDeployStageCollectionItemLoadBalancerConfig", "listenerName");
            }
        ...
        public Builder loadBalancerId(String loadBalancerId) {
            if (loadBalancerId == null) {
              throw new MissingRequiredPropertyException("GetDeployStagesDeployStageCollectionItemLoadBalancerConfig", "loadBalancerId");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetDeployStagesDeployStageCollectionItemLoadBalancerConfig", "state");
            }
            this.state = state;
            return this;
        }
        public GetDeployStagesDeployStageCollectionItemLoadBalancerConfig build() {
            final var _resultValue = new GetDeployStagesDeployStageCollectionItemLoadBalancerConfig();
