...
public final class GetDeployStagesDeployStageCollectionItemRolloutPolicy {
    ...
    public static final class Builder {
        ...
        public Builder batchCount(Integer batchCount) {
            if (batchCount == null) {
              throw new MissingRequiredPropertyException("GetDeployStagesDeployStageCollectionItemRolloutPolicy", "batchCount");
            }
        ...
        public Builder batchDelayInSeconds(Integer batchDelayInSeconds) {
            if (batchDelayInSeconds == null) {
              throw new MissingRequiredPropertyException("GetDeployStagesDeployStageCollectionItemRolloutPolicy", "batchDelayInSeconds");
            }
        ...
        public Builder batchPercentage(Integer batchPercentage) {
            if (batchPercentage == null) {
              throw new MissingRequiredPropertyException("GetDeployStagesDeployStageCollectionItemRolloutPolicy", "batchPercentage");
            }
        ...
        public Builder policyType(String policyType) {
            if (policyType == null) {
              throw new MissingRequiredPropertyException("GetDeployStagesDeployStageCollectionItemRolloutPolicy", "policyType");
            }
        ...
        public Builder rampLimitPercent(Double rampLimitPercent) {
            if (rampLimitPercent == null) {
              throw new MissingRequiredPropertyException("GetDeployStagesDeployStageCollectionItemRolloutPolicy", "rampLimitPercent");
            }
