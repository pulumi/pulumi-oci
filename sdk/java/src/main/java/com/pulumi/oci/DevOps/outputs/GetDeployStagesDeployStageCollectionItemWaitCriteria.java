    ...
    public static final class Builder {
        ...
        public Builder waitDuration(String waitDuration) {
            if (waitDuration == null) {
              throw new MissingRequiredPropertyException("GetDeployStagesDeployStageCollectionItemWaitCriteria", "waitDuration");
            }
        ...
        public Builder waitType(String waitType) {
            if (waitType == null) {
              throw new MissingRequiredPropertyException("GetDeployStagesDeployStageCollectionItemWaitCriteria", "waitType");
            }
