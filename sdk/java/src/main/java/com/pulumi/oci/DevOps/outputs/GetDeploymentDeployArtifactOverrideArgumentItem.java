    ...
    public static final class Builder {
        ...
        public Builder deployArtifactId(String deployArtifactId) {
            if (deployArtifactId == null) {
              throw new MissingRequiredPropertyException("GetDeploymentDeployArtifactOverrideArgumentItem", "deployArtifactId");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetDeploymentDeployArtifactOverrideArgumentItem", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetDeploymentDeployArtifactOverrideArgumentItem", "value");
            }
            this.value = value;
            return this;
        }
