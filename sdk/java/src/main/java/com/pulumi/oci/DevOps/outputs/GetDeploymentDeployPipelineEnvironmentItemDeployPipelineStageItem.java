    ...
    public static final class Builder {
        ...
        public Builder deployStageId(String deployStageId) {
            if (deployStageId == null) {
              throw new MissingRequiredPropertyException("GetDeploymentDeployPipelineEnvironmentItemDeployPipelineStageItem", "deployStageId");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetDeploymentDeployPipelineEnvironmentItemDeployPipelineStageItem", "displayName");
            }
            this.displayName = displayName;
            return this;
        }
        public GetDeploymentDeployPipelineEnvironmentItemDeployPipelineStageItem build() {
            final var _resultValue = new GetDeploymentDeployPipelineEnvironmentItemDeployPipelineStageItem();
