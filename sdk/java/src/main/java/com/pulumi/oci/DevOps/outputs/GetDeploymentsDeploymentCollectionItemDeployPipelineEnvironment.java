...
public final class GetDeploymentsDeploymentCollectionItemDeployPipelineEnvironment {
     ...
     * 
     */
    private @Nullable List<GetDeploymentsDeploymentCollectionItemDeployPipelineEnvironmentItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetDeploymentsDeploymentCollectionItemDeployPipelineEnvironmentItem> items) {
            this.items = items;
            return this;
        }
