...
@CustomType
public final class GetProjectRepositorySettingMergeSetting {
    /**
     * @return List of merge strategies which are allowed for a Project or Repository.
     * 
     */
    private List<String> allowedMergeStrategies;
    /**
     * @return Default type of merge strategy associated with the a Project or Repository.
     * 
     */
    private String defaultMergeStrategy;

    private GetProjectRepositorySettingMergeSetting() {}
    /**
     * @return List of merge strategies which are allowed for a Project or Repository.
     * 
     */
    ...
    public static Builder builder(GetProjectRepositorySettingMergeSetting defaults) {
    ...
    public static final class Builder {
        ...
        private String defaultMergeStrategy;
        public Builder() {}
        public Builder(GetProjectRepositorySettingMergeSetting defaults) {
        ...
        public Builder allowedMergeStrategies(List<String> allowedMergeStrategies) {
            if (allowedMergeStrategies == null) {
              throw new MissingRequiredPropertyException("GetProjectRepositorySettingMergeSetting", "allowedMergeStrategies");
            }
        ...
        public Builder defaultMergeStrategy(String defaultMergeStrategy) {
            if (defaultMergeStrategy == null) {
              throw new MissingRequiredPropertyException("GetProjectRepositorySettingMergeSetting", "defaultMergeStrategy");
            }
            this.defaultMergeStrategy = defaultMergeStrategy;
            return this;
        }
        public GetProjectRepositorySettingMergeSetting build() {
            final var _resultValue = new GetProjectRepositorySettingMergeSetting();
