...
public final class GetRepositoryAuthorsRepositoryAuthorCollection {
     ...
     * 
     */
    private @Nullable List<GetRepositoryAuthorsRepositoryAuthorCollectionItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetRepositoryAuthorsRepositoryAuthorCollectionItem> items) {
            this.items = items;
            return this;
        }
