...
public final class GetRepositoryDiffChangeDiffSectionLine {
    ...
    public static final class Builder {
        ...
        public Builder baseLine(Integer baseLine) {
            if (baseLine == null) {
              throw new MissingRequiredPropertyException("GetRepositoryDiffChangeDiffSectionLine", "baseLine");
            }
        ...
        public Builder conflictMarker(String conflictMarker) {
            if (conflictMarker == null) {
              throw new MissingRequiredPropertyException("GetRepositoryDiffChangeDiffSectionLine", "conflictMarker");
            }
        ...
        public Builder lineContent(String lineContent) {
            if (lineContent == null) {
              throw new MissingRequiredPropertyException("GetRepositoryDiffChangeDiffSectionLine", "lineContent");
            }
        ...
        public Builder targetLine(Integer targetLine) {
            if (targetLine == null) {
              throw new MissingRequiredPropertyException("GetRepositoryDiffChangeDiffSectionLine", "targetLine");
            }
            this.targetLine = targetLine;
            return this;
        }
        public GetRepositoryDiffChangeDiffSectionLine build() {
            final var _resultValue = new GetRepositoryDiffChangeDiffSectionLine();
