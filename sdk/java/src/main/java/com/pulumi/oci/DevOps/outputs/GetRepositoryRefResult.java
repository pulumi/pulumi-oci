...
public final class GetRepositoryRefResult {
    ...
    public static final class Builder {
        ...
        public Builder commitId(String commitId) {
            if (commitId == null) {
              throw new MissingRequiredPropertyException("GetRepositoryRefResult", "commitId");
            }
        ...
        public Builder definedTags(Map<String,String> definedTags) {
            if (definedTags == null) {
              throw new MissingRequiredPropertyException("GetRepositoryRefResult", "definedTags");
            }
        ...
        public Builder freeformTags(Map<String,String> freeformTags) {
            if (freeformTags == null) {
              throw new MissingRequiredPropertyException("GetRepositoryRefResult", "freeformTags");
            }
        ...
        public Builder fullRefName(String fullRefName) {
            if (fullRefName == null) {
              throw new MissingRequiredPropertyException("GetRepositoryRefResult", "fullRefName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetRepositoryRefResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder objectId(String objectId) {
            if (objectId == null) {
              throw new MissingRequiredPropertyException("GetRepositoryRefResult", "objectId");
            }
        ...
        public Builder refName(String refName) {
            if (refName == null) {
              throw new MissingRequiredPropertyException("GetRepositoryRefResult", "refName");
            }
        ...
        public Builder refType(String refType) {
            if (refType == null) {
              throw new MissingRequiredPropertyException("GetRepositoryRefResult", "refType");
            }
        ...
        public Builder repositoryId(String repositoryId) {
            if (repositoryId == null) {
              throw new MissingRequiredPropertyException("GetRepositoryRefResult", "repositoryId");
            }
