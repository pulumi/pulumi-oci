...
@CustomType
public final class GetRepositorySettingMergeSetting {
    /**
    ...
    private GetRepositorySettingMergeSetting() {}
    /**
     * @return List of merge strategies which are allowed for a Project or Repository.
     * 
     */
    ...
    public static Builder builder(GetRepositorySettingMergeSetting defaults) {
    ...
    public static final class Builder {
        ...
        private String defaultMergeStrategy;
        public Builder() {}
        public Builder(GetRepositorySettingMergeSetting defaults) {
        ...
        public Builder allowedMergeStrategies(List<String> allowedMergeStrategies) {
            if (allowedMergeStrategies == null) {
              throw new MissingRequiredPropertyException("GetRepositorySettingMergeSetting", "allowedMergeStrategies");
            }
        ...
        public Builder defaultMergeStrategy(String defaultMergeStrategy) {
            if (defaultMergeStrategy == null) {
              throw new MissingRequiredPropertyException("GetRepositorySettingMergeSetting", "defaultMergeStrategy");
            }
            this.defaultMergeStrategy = defaultMergeStrategy;
            return this;
        }
        public GetRepositorySettingMergeSetting build() {
            final var _resultValue = new GetRepositorySettingMergeSetting();
