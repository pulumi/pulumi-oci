...
@CustomType
public final class ProjectRepositorySettingApprovalRulesItemReviewer {
    /**
    ...
    private ProjectRepositorySettingApprovalRulesItemReviewer() {}
    /**
     * @return (Updatable) Pull Request reviewer id
     * 
     */
    ...
    public static Builder builder(ProjectRepositorySettingApprovalRulesItemReviewer defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String principalType;
        public Builder() {}
        public Builder(ProjectRepositorySettingApprovalRulesItemReviewer defaults) {
        ...
        public Builder principalId(String principalId) {
            if (principalId == null) {
              throw new MissingRequiredPropertyException("ProjectRepositorySettingApprovalRulesItemReviewer", "principalId");
            }
        ...
        public ProjectRepositorySettingApprovalRulesItemReviewer build() {
            final var _resultValue = new ProjectRepositorySettingApprovalRulesItemReviewer();
