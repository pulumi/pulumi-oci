...
@CustomType
public final class ProjectRepositorySettingMergeSettings {
    /**
    ...
    private ProjectRepositorySettingMergeSettings() {}
    /**
     * @return (Updatable) List of merge strategies which are allowed for a Project or Repository.
     * 
     */
    ...
    public static Builder builder(ProjectRepositorySettingMergeSettings defaults) {
    ...
    public static final class Builder {
        ...
        private String defaultMergeStrategy;
        public Builder() {}
        public Builder(ProjectRepositorySettingMergeSettings defaults) {
        ...
        public Builder allowedMergeStrategies(List<String> allowedMergeStrategies) {
            if (allowedMergeStrategies == null) {
              throw new MissingRequiredPropertyException("ProjectRepositorySettingMergeSettings", "allowedMergeStrategies");
            }
        ...
        public Builder defaultMergeStrategy(String defaultMergeStrategy) {
            if (defaultMergeStrategy == null) {
              throw new MissingRequiredPropertyException("ProjectRepositorySettingMergeSettings", "defaultMergeStrategy");
            }
            this.defaultMergeStrategy = defaultMergeStrategy;
            return this;
        }
        public ProjectRepositorySettingMergeSettings build() {
            final var _resultValue = new ProjectRepositorySettingMergeSettings();
