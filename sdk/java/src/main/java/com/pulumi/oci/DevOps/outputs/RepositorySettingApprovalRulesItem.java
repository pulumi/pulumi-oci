...
import com.pulumi.oci.DevOps.outputs.RepositorySettingApprovalRulesItemReviewer;
...
@CustomType
public final class RepositorySettingApprovalRulesItem {
    /**
     ...
     * 
     */
    private @Nullable List<RepositorySettingApprovalRulesItemReviewer> reviewers;

    private RepositorySettingApprovalRulesItem() {}
    /**
     * @return (Updatable) Branch name where pull requests targeting the branch must satisfy the approval rule. This value being null means the rule applies to all pull requests
     * 
     */
     ...
     * 
     */
    public List<RepositorySettingApprovalRulesItemReviewer> reviewers() {
    ...
    public static Builder builder(RepositorySettingApprovalRulesItem defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<RepositorySettingApprovalRulesItemReviewer> reviewers;
        public Builder() {}
        public Builder(RepositorySettingApprovalRulesItem defaults) {
        ...
        public Builder minApprovalsCount(Integer minApprovalsCount) {
            if (minApprovalsCount == null) {
              throw new MissingRequiredPropertyException("RepositorySettingApprovalRulesItem", "minApprovalsCount");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("RepositorySettingApprovalRulesItem", "name");
            }
            this.name = name;
            return this;
        }
        @CustomType.Setter
        public Builder reviewers(@Nullable List<RepositorySettingApprovalRulesItemReviewer> reviewers) {

            this.reviewers = reviewers;
            return this;
        }
        public Builder reviewers(RepositorySettingApprovalRulesItemReviewer... reviewers) {
            return reviewers(List.of(reviewers));
        }
        public RepositorySettingApprovalRulesItem build() {
            final var _resultValue = new RepositorySettingApprovalRulesItem();
