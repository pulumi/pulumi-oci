...
public class DrProtectionGroup extends com.pulumi.resources.CustomResource {
     ...
     */
    public DrProtectionGroup(java.lang.String name) {
     ...
     */
    public DrProtectionGroup(java.lang.String name, DrProtectionGroupArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DrProtectionGroup(java.lang.String name, DrProtectionGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DisasterRecovery/drProtectionGroup:DrProtectionGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DrProtectionGroup(java.lang.String name, Output<java.lang.String> id, @Nullable DrProtectionGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:DisasterRecovery/drProtectionGroup:DrProtectionGroup", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static DrProtectionGroup get(java.lang.String name, Output<java.lang.String> id, @Nullable DrProtectionGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
