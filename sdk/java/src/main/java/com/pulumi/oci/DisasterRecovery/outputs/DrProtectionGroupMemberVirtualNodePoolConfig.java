...
@CustomType
public final class DrProtectionGroupMemberVirtualNodePoolConfig {
    /**
    ...
    private DrProtectionGroupMemberVirtualNodePoolConfig() {}
    /**
     * @return (Updatable) The OCID of the virtual node pool in OKE cluster.
     * 
     */
    ...
    public static Builder builder(DrProtectionGroupMemberVirtualNodePoolConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer minimum;
        public Builder() {}
        public Builder(DrProtectionGroupMemberVirtualNodePoolConfig defaults) {
        ...
        public DrProtectionGroupMemberVirtualNodePoolConfig build() {
            final var _resultValue = new DrProtectionGroupMemberVirtualNodePoolConfig();
            _resultValue.id = id;
