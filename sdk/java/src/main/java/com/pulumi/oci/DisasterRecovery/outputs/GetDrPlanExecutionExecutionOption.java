    ...
    public static final class Builder {
        ...
        public Builder arePrechecksEnabled(Boolean arePrechecksEnabled) {
            if (arePrechecksEnabled == null) {
              throw new MissingRequiredPropertyException("GetDrPlanExecutionExecutionOption", "arePrechecksEnabled");
            }
        ...
        public Builder areWarningsIgnored(Boolean areWarningsIgnored) {
            if (areWarningsIgnored == null) {
              throw new MissingRequiredPropertyException("GetDrPlanExecutionExecutionOption", "areWarningsIgnored");
            }
        ...
        public Builder planExecutionType(String planExecutionType) {
            if (planExecutionType == null) {
              throw new MissingRequiredPropertyException("GetDrPlanExecutionExecutionOption", "planExecutionType");
            }
