...
public final class GetDrProtectionGroupMemberBlockVolumeOperationMountDetail {
    ...
    public static final class Builder {
        ...
        public Builder mountPoint(String mountPoint) {
            if (mountPoint == null) {
              throw new MissingRequiredPropertyException("GetDrProtectionGroupMemberBlockVolumeOperationMountDetail", "mountPoint");
            }
            this.mountPoint = mountPoint;
            return this;
        }
        public GetDrProtectionGroupMemberBlockVolumeOperationMountDetail build() {
            final var _resultValue = new GetDrProtectionGroupMemberBlockVolumeOperationMountDetail();
