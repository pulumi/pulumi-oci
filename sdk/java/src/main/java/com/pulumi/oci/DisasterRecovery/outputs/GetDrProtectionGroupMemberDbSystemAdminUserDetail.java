...
@CustomType
public final class GetDrProtectionGroupMemberDbSystemAdminUserDetail {
    /**
    ...
    private GetDrProtectionGroupMemberDbSystemAdminUserDetail() {}
    /**
     * @return The OCID of the vault secret where the database SYSDBA password is stored. This password is required and used for performing database DR Drill operations when using full clone.  Example: `ocid1.vaultsecret.oc1..uniqueID`
     * 
     */
    ...
    public static Builder builder(GetDrProtectionGroupMemberDbSystemAdminUserDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String username;
        public Builder() {}
        public Builder(GetDrProtectionGroupMemberDbSystemAdminUserDetail defaults) {
        ...
        public Builder passwordVaultSecretId(String passwordVaultSecretId) {
            if (passwordVaultSecretId == null) {
              throw new MissingRequiredPropertyException("GetDrProtectionGroupMemberDbSystemAdminUserDetail", "passwordVaultSecretId");
            }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("GetDrProtectionGroupMemberDbSystemAdminUserDetail", "username");
            }
            this.username = username;
            return this;
        }
        public GetDrProtectionGroupMemberDbSystemAdminUserDetail build() {
            final var _resultValue = new GetDrProtectionGroupMemberDbSystemAdminUserDetail();
