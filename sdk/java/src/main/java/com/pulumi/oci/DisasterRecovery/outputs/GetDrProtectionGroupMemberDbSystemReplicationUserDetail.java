...
@CustomType
public final class GetDrProtectionGroupMemberDbSystemReplicationUserDetail {
    /**
    ...
    private GetDrProtectionGroupMemberDbSystemReplicationUserDetail() {}
    /**
     * @return The OCID of the vault secret where the database SYSDBA password is stored. This password is required and used for performing database DR Drill operations when using full clone.  Example: `ocid1.vaultsecret.oc1..uniqueID`
     * 
     */
    ...
    public static Builder builder(GetDrProtectionGroupMemberDbSystemReplicationUserDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String username;
        public Builder() {}
        public Builder(GetDrProtectionGroupMemberDbSystemReplicationUserDetail defaults) {
        ...
        public Builder passwordVaultSecretId(String passwordVaultSecretId) {
            if (passwordVaultSecretId == null) {
              throw new MissingRequiredPropertyException("GetDrProtectionGroupMemberDbSystemReplicationUserDetail", "passwordVaultSecretId");
            }
        ...
        public Builder username(String username) {
            if (username == null) {
              throw new MissingRequiredPropertyException("GetDrProtectionGroupMemberDbSystemReplicationUserDetail", "username");
            }
            this.username = username;
            return this;
        }
        public GetDrProtectionGroupMemberDbSystemReplicationUserDetail build() {
            final var _resultValue = new GetDrProtectionGroupMemberDbSystemReplicationUserDetail();
