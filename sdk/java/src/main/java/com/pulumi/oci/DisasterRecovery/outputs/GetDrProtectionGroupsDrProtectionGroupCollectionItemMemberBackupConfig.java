...
@CustomType
public final class GetDrProtectionGroupsDrProtectionGroupCollectionItemMemberBackupConfig {
    /**
    ...
    private GetDrProtectionGroupsDrProtectionGroupCollectionItemMemberBackupConfig() {}
    /**
     * @return The schedule for backing up namespaces to the destination region. If a backup schedule is not specified, only a single backup will be created. This format of the string specifying the backup schedule must conform with RFC-5545. This schedule will use the UTC timezone. This property applies to the OKE cluster member in primary region.  Example: FREQ=WEEKLY;BYDAY=MO,TU,WE,TH;BYHOUR=10;INTERVAL=1
     * 
     */
    ...
    public static Builder builder(GetDrProtectionGroupsDrProtectionGroupCollectionItemMemberBackupConfig defaults) {
    ...
    public static final class Builder {
        ...
        public Builder backupSchedule(String backupSchedule) {
            if (backupSchedule == null) {
              throw new MissingRequiredPropertyException("GetDrProtectionGroupsDrProtectionGroupCollectionItemMemberBackupConfig", "backupSchedule");
            }
        ...
        public Builder imageReplicationVaultSecretId(String imageReplicationVaultSecretId) {
            if (imageReplicationVaultSecretId == null) {
              throw new MissingRequiredPropertyException("GetDrProtectionGroupsDrProtectionGroupCollectionItemMemberBackupConfig", "imageReplicationVaultSecretId");
            }
        ...
        public Builder maxNumberOfBackupsRetained(Integer maxNumberOfBackupsRetained) {
            if (maxNumberOfBackupsRetained == null) {
              throw new MissingRequiredPropertyException("GetDrProtectionGroupsDrProtectionGroupCollectionItemMemberBackupConfig", "maxNumberOfBackupsRetained");
            }
        ...
        public Builder namespaces(List<String> namespaces) {
            if (namespaces == null) {
              throw new MissingRequiredPropertyException("GetDrProtectionGroupsDrProtectionGroupCollectionItemMemberBackupConfig", "namespaces");
            }
        ...
        public Builder replicateImages(String replicateImages) {
            if (replicateImages == null) {
              throw new MissingRequiredPropertyException("GetDrProtectionGroupsDrProtectionGroupCollectionItemMemberBackupConfig", "replicateImages");
            }
