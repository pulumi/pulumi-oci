...
@CustomType
public final class GetDrProtectionGroupsDrProtectionGroupCollectionItemMemberLoadBalancerMapping {
    /**
    ...
    private GetDrProtectionGroupsDrProtectionGroupCollectionItemMemberLoadBalancerMapping() {}
    /**
     * @return The OCID of the destination Load Balancer.  Example: `ocid1.loadbalancer.oc1..uniqueID`
     * 
     */
    ...
    public static Builder builder(GetDrProtectionGroupsDrProtectionGroupCollectionItemMemberLoadBalancerMapping defaults) {
    ...
    public static final class Builder {
        ...
        private String sourceLoadBalancerId;
        public Builder() {}
        public Builder(GetDrProtectionGroupsDrProtectionGroupCollectionItemMemberLoadBalancerMapping defaults) {
        ...
        public Builder destinationLoadBalancerId(String destinationLoadBalancerId) {
            if (destinationLoadBalancerId == null) {
              throw new MissingRequiredPropertyException("GetDrProtectionGroupsDrProtectionGroupCollectionItemMemberLoadBalancerMapping", "destinationLoadBalancerId");
            }
        ...
        public Builder sourceLoadBalancerId(String sourceLoadBalancerId) {
            if (sourceLoadBalancerId == null) {
              throw new MissingRequiredPropertyException("GetDrProtectionGroupsDrProtectionGroupCollectionItemMemberLoadBalancerMapping", "sourceLoadBalancerId");
            }
            this.sourceLoadBalancerId = sourceLoadBalancerId;
            return this;
        }
        public GetDrProtectionGroupsDrProtectionGroupCollectionItemMemberLoadBalancerMapping build() {
            final var _resultValue = new GetDrProtectionGroupsDrProtectionGroupCollectionItemMemberLoadBalancerMapping();
