...
public class ActionCreateZoneFromZoneFile extends com.pulumi.resources.CustomResource {
    ...
    public ActionCreateZoneFromZoneFile(String name, ActionCreateZoneFromZoneFileArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Dns/actionCreateZoneFromZoneFile:ActionCreateZoneFromZoneFile", name, args == null ? ActionCreateZoneFromZoneFileArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
