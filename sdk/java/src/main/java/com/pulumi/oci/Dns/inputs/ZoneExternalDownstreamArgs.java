...
public final class ZoneExternalDownstreamArgs extends com.pulumi.resources.ResourceArgs {

    public static final ZoneExternalDownstreamArgs Empty = new ZoneExternalDownstreamArgs();
    ...
    private ZoneExternalDownstreamArgs() {}

    private ZoneExternalDownstreamArgs(ZoneExternalDownstreamArgs $) {
    ...
    public static Builder builder(ZoneExternalDownstreamArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ZoneExternalDownstreamArgs();
        }

        public Builder(ZoneExternalDownstreamArgs defaults) {
            $ = new ZoneExternalDownstreamArgs(Objects.requireNonNull(defaults));
        }
