...
@CustomType
public final class ActionCreateZoneFromZoneFileExternalDownstream {
    /**
    ...
    private ActionCreateZoneFromZoneFileExternalDownstream() {}
    /**
     * @return The server&#39;s IP address (IPv4 or IPv6).
     * 
     */
    ...
    public static Builder builder(ActionCreateZoneFromZoneFileExternalDownstream defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String tsigKeyId;
        public Builder() {}
        public Builder(ActionCreateZoneFromZoneFileExternalDownstream defaults) {
