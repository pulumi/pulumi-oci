...
public final class GetSteeringPolicyAnswer {
    ...
    public static final class Builder {
        ...
        public Builder isDisabled(Boolean isDisabled) {
            if (isDisabled == null) {
              throw new MissingRequiredPropertyException("GetSteeringPolicyAnswer", "isDisabled");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetSteeringPolicyAnswer", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder pool(String pool) {
            if (pool == null) {
              throw new MissingRequiredPropertyException("GetSteeringPolicyAnswer", "pool");
            }
            this.pool = pool;
            return this;
        }
        ...
        public Builder rdata(String rdata) {
            if (rdata == null) {
              throw new MissingRequiredPropertyException("GetSteeringPolicyAnswer", "rdata");
            }
            this.rdata = rdata;
            return this;
        }
        ...
        public Builder rtype(String rtype) {
            if (rtype == null) {
              throw new MissingRequiredPropertyException("GetSteeringPolicyAnswer", "rtype");
            }
            this.rtype = rtype;
            return this;
        }
        public GetSteeringPolicyAnswer build() {
            final var _resultValue = new GetSteeringPolicyAnswer();
