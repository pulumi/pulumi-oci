...
public final class GetTsigKeyResult {
    ...
    public static final class Builder {
        ...
        public Builder algorithm(String algorithm) {
            if (algorithm == null) {
              throw new MissingRequiredPropertyException("GetTsigKeyResult", "algorithm");
            }
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetTsigKeyResult", "compartmentId");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetTsigKeyResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetTsigKeyResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder secret(String secret) {
            if (secret == null) {
              throw new MissingRequiredPropertyException("GetTsigKeyResult", "secret");
            }
            this.secret = secret;
            return this;
        }
        ...
        public Builder self(String self) {
            if (self == null) {
              throw new MissingRequiredPropertyException("GetTsigKeyResult", "self");
            }
            this.self = self;
            return this;
        }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetTsigKeyResult", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetTsigKeyResult", "timeCreated");
            }
        ...
        public Builder timeUpdated(String timeUpdated) {
            if (timeUpdated == null) {
              throw new MissingRequiredPropertyException("GetTsigKeyResult", "timeUpdated");
            }
        ...
        public Builder tsigKeyId(String tsigKeyId) {
            if (tsigKeyId == null) {
              throw new MissingRequiredPropertyException("GetTsigKeyResult", "tsigKeyId");
            }
