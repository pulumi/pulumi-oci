...
@CustomType
public final class GetZonesZoneExternalDownstream {
    /**
    ...
    private GetZonesZoneExternalDownstream() {}
    /**
     * @return The server&#39;s IP address (IPv4 or IPv6).
     * 
     */
    ...
    public static Builder builder(GetZonesZoneExternalDownstream defaults) {
    ...
    public static final class Builder {
        ...
        private String tsigKeyId;
        public Builder() {}
        public Builder(GetZonesZoneExternalDownstream defaults) {
        ...
        public Builder address(String address) {
            if (address == null) {
              throw new MissingRequiredPropertyException("GetZonesZoneExternalDownstream", "address");
            }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetZonesZoneExternalDownstream", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder tsigKeyId(String tsigKeyId) {
            if (tsigKeyId == null) {
              throw new MissingRequiredPropertyException("GetZonesZoneExternalDownstream", "tsigKeyId");
            }
