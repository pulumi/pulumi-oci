...
public final class ZoneZoneTransferServer {
    ...
    public static Builder builder(ZoneZoneTransferServer defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer port;
        public Builder() {}
        public Builder(ZoneZoneTransferServer defaults) {
        ...
        public ZoneZoneTransferServer build() {
            final var _resultValue = new ZoneZoneTransferServer();
