...
public class Sender extends com.pulumi.resources.CustomResource {
     ...
     */
    public Sender(java.lang.String name, SenderArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Sender(java.lang.String name, SenderArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Email/sender:Sender", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Sender(java.lang.String name, Output<java.lang.String> id, @Nullable SenderState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Email/sender:Sender", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static Sender get(java.lang.String name, Output<java.lang.String> id, @Nullable SenderState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
