...
@CustomType
public final class EmailIpPoolLock {
    /**
    ...
    public static Builder builder(EmailIpPoolLock defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(EmailIpPoolLock defaults) {
        ...
        public EmailIpPoolLock build() {
            final var _resultValue = new EmailIpPoolLock();
