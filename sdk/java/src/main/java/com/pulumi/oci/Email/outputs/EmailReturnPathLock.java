...
@CustomType
public final class EmailReturnPathLock {
    /**
    ...
    public static Builder builder(EmailReturnPathLock defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String type;
        public Builder() {}
        public Builder(EmailReturnPathLock defaults) {
        ...
        public EmailReturnPathLock build() {
            final var _resultValue = new EmailReturnPathLock();
