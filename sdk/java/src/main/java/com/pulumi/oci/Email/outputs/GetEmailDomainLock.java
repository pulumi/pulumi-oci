...
@CustomType
public final class GetEmailDomainLock {
    /**
    ...
    public static Builder builder(GetEmailDomainLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetEmailDomainLock defaults) {
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetEmailDomainLock", "compartmentId");
            }
        ...
        public Builder message(String message) {
            if (message == null) {
              throw new MissingRequiredPropertyException("GetEmailDomainLock", "message");
            }
        ...
        public Builder relatedResourceId(String relatedResourceId) {
            if (relatedResourceId == null) {
              throw new MissingRequiredPropertyException("GetEmailDomainLock", "relatedResourceId");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetEmailDomainLock", "timeCreated");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetEmailDomainLock", "type");
            }
            this.type = type;
            return this;
        }
        public GetEmailDomainLock build() {
            final var _resultValue = new GetEmailDomainLock();
