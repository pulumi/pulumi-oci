...
@CustomType
public final class GetEmailOutboundIpsEmailOutboundIpCollectionItem {
    /**
    ...
    private GetEmailOutboundIpsEmailOutboundIpCollectionItem() {}
    /**
     * @return Filter returned list by specified assignment state.
     * 
     */
    ...
    public static Builder builder(GetEmailOutboundIpsEmailOutboundIpCollectionItem defaults) {
    ...
    public static final class Builder {
        ...
        private String timeUnassigned;
        public Builder() {}
        public Builder(GetEmailOutboundIpsEmailOutboundIpCollectionItem defaults) {
        ...
        public Builder assignmentState(String assignmentState) {
            if (assignmentState == null) {
              throw new MissingRequiredPropertyException("GetEmailOutboundIpsEmailOutboundIpCollectionItem", "assignmentState");
            }
        ...
        public Builder lifecycleDetails(String lifecycleDetails) {
            if (lifecycleDetails == null) {
              throw new MissingRequiredPropertyException("GetEmailOutboundIpsEmailOutboundIpCollectionItem", "lifecycleDetails");
            }
        ...
        public Builder outboundIp(String outboundIp) {
            if (outboundIp == null) {
              throw new MissingRequiredPropertyException("GetEmailOutboundIpsEmailOutboundIpCollectionItem", "outboundIp");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetEmailOutboundIpsEmailOutboundIpCollectionItem", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder timeUnassigned(String timeUnassigned) {
            if (timeUnassigned == null) {
              throw new MissingRequiredPropertyException("GetEmailOutboundIpsEmailOutboundIpCollectionItem", "timeUnassigned");
            }
            this.timeUnassigned = timeUnassigned;
            return this;
        }
        public GetEmailOutboundIpsEmailOutboundIpCollectionItem build() {
            final var _resultValue = new GetEmailOutboundIpsEmailOutboundIpCollectionItem();
