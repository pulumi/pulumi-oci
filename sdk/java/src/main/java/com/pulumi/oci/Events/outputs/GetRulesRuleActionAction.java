...
public final class GetRulesRuleActionAction {
    ...
    public static final class Builder {
        ...
        public Builder actionType(String actionType) {
            if (actionType == null) {
              throw new MissingRequiredPropertyException("GetRulesRuleActionAction", "actionType");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetRulesRuleActionAction", "description");
            }
        ...
        public Builder functionId(String functionId) {
            if (functionId == null) {
              throw new MissingRequiredPropertyException("GetRulesRuleActionAction", "functionId");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetRulesRuleActionAction", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isEnabled(Boolean isEnabled) {
            if (isEnabled == null) {
              throw new MissingRequiredPropertyException("GetRulesRuleActionAction", "isEnabled");
            }
        ...
        public Builder lifecycleMessage(String lifecycleMessage) {
            if (lifecycleMessage == null) {
              throw new MissingRequiredPropertyException("GetRulesRuleActionAction", "lifecycleMessage");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetRulesRuleActionAction", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder streamId(String streamId) {
            if (streamId == null) {
              throw new MissingRequiredPropertyException("GetRulesRuleActionAction", "streamId");
            }
        ...
        public Builder topicId(String topicId) {
            if (topicId == null) {
              throw new MissingRequiredPropertyException("GetRulesRuleActionAction", "topicId");
            }
            this.topicId = topicId;
            return this;
        }
        public GetRulesRuleActionAction build() {
            final var _resultValue = new GetRulesRuleActionAction();
