...
public class ExportSet extends com.pulumi.resources.CustomResource {
     ...
     */
    public ExportSet(java.lang.String name) {
     ...
     */
    public ExportSet(java.lang.String name, ExportSetArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ExportSet(java.lang.String name, ExportSetArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:FileStorage/exportSet:ExportSet", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ExportSet(java.lang.String name, Output<java.lang.String> id, @Nullable ExportSetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:FileStorage/exportSet:ExportSet", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ExportSet get(java.lang.String name, Output<java.lang.String> id, @Nullable ExportSetState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
