...
public class OutboundConnector extends com.pulumi.resources.CustomResource {
     ...
     */
    public OutboundConnector(java.lang.String name) {
     ...
     */
    public OutboundConnector(java.lang.String name, OutboundConnectorArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public OutboundConnector(java.lang.String name, OutboundConnectorArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:FileStorage/outboundConnector:OutboundConnector", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private OutboundConnector(java.lang.String name, Output<java.lang.String> id, @Nullable OutboundConnectorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:FileStorage/outboundConnector:OutboundConnector", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static OutboundConnector get(java.lang.String name, Output<java.lang.String> id, @Nullable OutboundConnectorState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
