...
public final class ExportLockArgs extends com.pulumi.resources.ResourceArgs {

    public static final ExportLockArgs Empty = new ExportLockArgs();
    ...
    private ExportLockArgs() {}

    private ExportLockArgs(ExportLockArgs $) {
    ...
    public static Builder builder(ExportLockArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(ExportLockArgs defaults) {
            $ = new ExportLockArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ExportLockArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("ExportLockArgs", "type");
            }
            return $;
        }
    }
