...
public final class FileSystemLockArgs extends com.pulumi.resources.ResourceArgs {

    public static final FileSystemLockArgs Empty = new FileSystemLockArgs();
    ...
    private FileSystemLockArgs() {}

    private FileSystemLockArgs(FileSystemLockArgs $) {
    ...
    public static Builder builder(FileSystemLockArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FileSystemLockArgs();
        }

        public Builder(FileSystemLockArgs defaults) {
            $ = new FileSystemLockArgs(Objects.requireNonNull(defaults));
        }
        ...
        public FileSystemLockArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("FileSystemLockArgs", "type");
            }
            return $;
        }
    }
