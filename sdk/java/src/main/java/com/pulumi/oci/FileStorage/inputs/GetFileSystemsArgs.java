    ...
    public static final class Builder {
        ...
        public GetFileSystemsArgs build() {
            if ($.availabilityDomain == null) {
                throw new MissingRequiredPropertyException("GetFileSystemsArgs", "availabilityDomain");
            }
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetFileSystemsArgs", "compartmentId");
            }
            return $;
        }
    }
