...
import com.pulumi.oci.FileStorage.inputs.GetFilesystemSnapshotPoliciesFilter;
...
public final class GetFilesystemSnapshotPoliciesPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetFilesystemSnapshotPoliciesPlainArgs Empty = new GetFilesystemSnapshotPoliciesPlainArgs();
    ...
    public Optional<List<GetFilesystemSnapshotPoliciesFilter>> filters() {
    ...
    private GetFilesystemSnapshotPoliciesPlainArgs() {}

    private GetFilesystemSnapshotPoliciesPlainArgs(GetFilesystemSnapshotPoliciesPlainArgs $) {
    ...
    public static Builder builder(GetFilesystemSnapshotPoliciesPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFilesystemSnapshotPoliciesPlainArgs();
        }

        public Builder(GetFilesystemSnapshotPoliciesPlainArgs defaults) {
            $ = new GetFilesystemSnapshotPoliciesPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetFilesystemSnapshotPoliciesPlainArgs build() {
            if ($.availabilityDomain == null) {
                throw new MissingRequiredPropertyException("GetFilesystemSnapshotPoliciesPlainArgs", "availabilityDomain");
            }
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetFilesystemSnapshotPoliciesPlainArgs", "compartmentId");
            }
            return $;
        }
    }
