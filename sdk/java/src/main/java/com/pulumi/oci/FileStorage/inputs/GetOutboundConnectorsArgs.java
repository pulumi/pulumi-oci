...
import com.pulumi.oci.FileStorage.inputs.GetOutboundConnectorsFilterArgs;
...
public final class GetOutboundConnectorsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetOutboundConnectorsArgs Empty = new GetOutboundConnectorsArgs();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetOutboundConnectorsFilterArgs>> filters;

    public Optional<Output<List<GetOutboundConnectorsFilterArgs>>> filters() {
    ...
    private GetOutboundConnectorsArgs() {}

    private GetOutboundConnectorsArgs(GetOutboundConnectorsArgs $) {
    ...
    public static Builder builder(GetOutboundConnectorsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetOutboundConnectorsArgs();
        }

        public Builder(GetOutboundConnectorsArgs defaults) {
            $ = new GetOutboundConnectorsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetOutboundConnectorsFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetOutboundConnectorsFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetOutboundConnectorsFilterArgs... filters) {
        ...
        public GetOutboundConnectorsArgs build() {
            if ($.availabilityDomain == null) {
                throw new MissingRequiredPropertyException("GetOutboundConnectorsArgs", "availabilityDomain");
            }
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetOutboundConnectorsArgs", "compartmentId");
            }
            return $;
        }
    }
