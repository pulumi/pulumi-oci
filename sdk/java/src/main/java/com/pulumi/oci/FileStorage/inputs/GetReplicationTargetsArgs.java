...
import com.pulumi.oci.FileStorage.inputs.GetReplicationTargetsFilterArgs;
...
public final class GetReplicationTargetsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetReplicationTargetsArgs Empty = new GetReplicationTargetsArgs();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetReplicationTargetsFilterArgs>> filters;

    public Optional<Output<List<GetReplicationTargetsFilterArgs>>> filters() {
    ...
    private GetReplicationTargetsArgs() {}

    private GetReplicationTargetsArgs(GetReplicationTargetsArgs $) {
    ...
    public static Builder builder(GetReplicationTargetsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetReplicationTargetsArgs();
        }

        public Builder(GetReplicationTargetsArgs defaults) {
            $ = new GetReplicationTargetsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetReplicationTargetsFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetReplicationTargetsFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetReplicationTargetsFilterArgs... filters) {
        ...
        public GetReplicationTargetsArgs build() {
            if ($.availabilityDomain == null) {
                throw new MissingRequiredPropertyException("GetReplicationTargetsArgs", "availabilityDomain");
            }
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetReplicationTargetsArgs", "compartmentId");
            }
            return $;
        }
    }
