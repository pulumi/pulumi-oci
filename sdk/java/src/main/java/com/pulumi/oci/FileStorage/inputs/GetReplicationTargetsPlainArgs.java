...
import com.pulumi.oci.FileStorage.inputs.GetReplicationTargetsFilter;
...
public final class GetReplicationTargetsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetReplicationTargetsPlainArgs Empty = new GetReplicationTargetsPlainArgs();
    ...
    public Optional<List<GetReplicationTargetsFilter>> filters() {
    ...
    private GetReplicationTargetsPlainArgs() {}

    private GetReplicationTargetsPlainArgs(GetReplicationTargetsPlainArgs $) {
    ...
    public static Builder builder(GetReplicationTargetsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetReplicationTargetsPlainArgs();
        }

        public Builder(GetReplicationTargetsPlainArgs defaults) {
            $ = new GetReplicationTargetsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetReplicationTargetsPlainArgs build() {
            if ($.availabilityDomain == null) {
                throw new MissingRequiredPropertyException("GetReplicationTargetsPlainArgs", "availabilityDomain");
            }
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetReplicationTargetsPlainArgs", "compartmentId");
            }
            return $;
        }
    }
