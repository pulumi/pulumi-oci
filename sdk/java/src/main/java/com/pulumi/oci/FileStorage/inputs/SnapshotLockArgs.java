...
public final class SnapshotLockArgs extends com.pulumi.resources.ResourceArgs {

    public static final SnapshotLockArgs Empty = new SnapshotLockArgs();
    ...
    private SnapshotLockArgs() {}

    private SnapshotLockArgs(SnapshotLockArgs $) {
    ...
    public static Builder builder(SnapshotLockArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SnapshotLockArgs();
        }

        public Builder(SnapshotLockArgs defaults) {
            $ = new SnapshotLockArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SnapshotLockArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("SnapshotLockArgs", "type");
            }
            return $;
        }
    }
