...
public final class ExportLock {
    ...
    public static Builder builder(ExportLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(ExportLock defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("ExportLock", "type");
            }
            this.type = type;
            return this;
        }
        public ExportLock build() {
            final var _resultValue = new ExportLock();
