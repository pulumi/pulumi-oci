...
@CustomType
public final class FileSystemLock {
    /**
    ...
    public static Builder builder(FileSystemLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(FileSystemLock defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("FileSystemLock", "type");
            }
            this.type = type;
            return this;
        }
        public FileSystemLock build() {
            final var _resultValue = new FileSystemLock();
