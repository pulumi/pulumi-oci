...
@CustomType
public final class GetExportsExportLock {
    /**
    ...
    public static Builder builder(GetExportsExportLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetExportsExportLock defaults) {
        ...
        public Builder message(String message) {
            if (message == null) {
              throw new MissingRequiredPropertyException("GetExportsExportLock", "message");
            }
        ...
        public Builder relatedResourceId(String relatedResourceId) {
            if (relatedResourceId == null) {
              throw new MissingRequiredPropertyException("GetExportsExportLock", "relatedResourceId");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetExportsExportLock", "timeCreated");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetExportsExportLock", "type");
            }
            this.type = type;
            return this;
        }
        public GetExportsExportLock build() {
            final var _resultValue = new GetExportsExportLock();
