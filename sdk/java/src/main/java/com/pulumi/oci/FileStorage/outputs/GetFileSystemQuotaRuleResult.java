...
@CustomType
public final class GetFileSystemQuotaRuleResult {
    ...
    public static Builder builder(GetFileSystemQuotaRuleResult defaults) {
    ...
    public static final class Builder {
        ...
        private String timeUpdated;
        public Builder() {}
        public Builder(GetFileSystemQuotaRuleResult defaults) {
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetFileSystemQuotaRuleResult", "displayName");
            }
        ...
        public Builder fileSystemId(String fileSystemId) {
            if (fileSystemId == null) {
              throw new MissingRequiredPropertyException("GetFileSystemQuotaRuleResult", "fileSystemId");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetFileSystemQuotaRuleResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isHardQuota(Boolean isHardQuota) {
            if (isHardQuota == null) {
              throw new MissingRequiredPropertyException("GetFileSystemQuotaRuleResult", "isHardQuota");
            }
        ...
        public Builder principalId(Integer principalId) {
            if (principalId == null) {
              throw new MissingRequiredPropertyException("GetFileSystemQuotaRuleResult", "principalId");
            }
        ...
        public Builder principalType(String principalType) {
            if (principalType == null) {
              throw new MissingRequiredPropertyException("GetFileSystemQuotaRuleResult", "principalType");
            }
        ...
        public Builder quotaLimitInGigabytes(Integer quotaLimitInGigabytes) {
            if (quotaLimitInGigabytes == null) {
              throw new MissingRequiredPropertyException("GetFileSystemQuotaRuleResult", "quotaLimitInGigabytes");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetFileSystemQuotaRuleResult", "timeCreated");
            }
        ...
        public Builder timeUpdated(String timeUpdated) {
            if (timeUpdated == null) {
              throw new MissingRequiredPropertyException("GetFileSystemQuotaRuleResult", "timeUpdated");
            }
            this.timeUpdated = timeUpdated;
            return this;
        }
        public GetFileSystemQuotaRuleResult build() {
            final var _resultValue = new GetFileSystemQuotaRuleResult();
