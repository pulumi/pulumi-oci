...
@CustomType
public final class GetFilesystemSnapshotPolicyLock {
    /**
    ...
    private GetFilesystemSnapshotPolicyLock() {}
    /**
     * @return A message added by the creator of the lock. This is typically used to give an indication of why the resource is locked.
     * 
     */
    ...
    public static Builder builder(GetFilesystemSnapshotPolicyLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetFilesystemSnapshotPolicyLock defaults) {
        ...
        public Builder message(String message) {
            if (message == null) {
              throw new MissingRequiredPropertyException("GetFilesystemSnapshotPolicyLock", "message");
            }
        ...
        public Builder relatedResourceId(String relatedResourceId) {
            if (relatedResourceId == null) {
              throw new MissingRequiredPropertyException("GetFilesystemSnapshotPolicyLock", "relatedResourceId");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetFilesystemSnapshotPolicyLock", "timeCreated");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetFilesystemSnapshotPolicyLock", "type");
            }
            this.type = type;
            return this;
        }
        public GetFilesystemSnapshotPolicyLock build() {
            final var _resultValue = new GetFilesystemSnapshotPolicyLock();
