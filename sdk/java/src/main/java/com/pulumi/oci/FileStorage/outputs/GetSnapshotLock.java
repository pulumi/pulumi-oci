...
@CustomType
public final class GetSnapshotLock {
    /**
    ...
    public static Builder builder(GetSnapshotLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetSnapshotLock defaults) {
        ...
        public Builder message(String message) {
            if (message == null) {
              throw new MissingRequiredPropertyException("GetSnapshotLock", "message");
            }
        ...
        public Builder relatedResourceId(String relatedResourceId) {
            if (relatedResourceId == null) {
              throw new MissingRequiredPropertyException("GetSnapshotLock", "relatedResourceId");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetSnapshotLock", "timeCreated");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetSnapshotLock", "type");
            }
            this.type = type;
            return this;
        }
        public GetSnapshotLock build() {
            final var _resultValue = new GetSnapshotLock();
