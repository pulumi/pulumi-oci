...
@CustomType
public final class GetSnapshotsSnapshotLock {
    /**
    ...
    private GetSnapshotsSnapshotLock() {}
    /**
     * @return A message added by the creator of the lock. This is typically used to give an indication of why the resource is locked.
     * 
     */
    ...
    public static Builder builder(GetSnapshotsSnapshotLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetSnapshotsSnapshotLock defaults) {
        ...
        public Builder message(String message) {
            if (message == null) {
              throw new MissingRequiredPropertyException("GetSnapshotsSnapshotLock", "message");
            }
        ...
        public Builder relatedResourceId(String relatedResourceId) {
            if (relatedResourceId == null) {
              throw new MissingRequiredPropertyException("GetSnapshotsSnapshotLock", "relatedResourceId");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetSnapshotsSnapshotLock", "timeCreated");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetSnapshotsSnapshotLock", "type");
            }
            this.type = type;
            return this;
        }
        public GetSnapshotsSnapshotLock build() {
            final var _resultValue = new GetSnapshotsSnapshotLock();
