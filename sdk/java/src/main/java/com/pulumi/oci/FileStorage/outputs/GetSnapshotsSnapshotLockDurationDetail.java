...
@CustomType
public final class GetSnapshotsSnapshotLockDurationDetail {
    /**
    ...
    private GetSnapshotsSnapshotLockDurationDetail() {}
    /**
     * @return For snapshots in compliance mode, a cooling-off period (measured in days) begins. During this time, you can still edit or remove the lock. Once this period ends, the snapshot becomes immutable until the specified retention date expires, permanently preventing any deletion or modification. The cool off duration can be set for a minimum of 0 days and a maximum of 365. It defaults to 14 days if not set.
     * 
     */
    ...
    public static Builder builder(GetSnapshotsSnapshotLockDurationDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String lockMode;
        public Builder() {}
        public Builder(GetSnapshotsSnapshotLockDurationDetail defaults) {
        ...
        public Builder coolOffDuration(Integer coolOffDuration) {
            if (coolOffDuration == null) {
              throw new MissingRequiredPropertyException("GetSnapshotsSnapshotLockDurationDetail", "coolOffDuration");
            }
        ...
        public Builder lockDuration(Integer lockDuration) {
            if (lockDuration == null) {
              throw new MissingRequiredPropertyException("GetSnapshotsSnapshotLockDurationDetail", "lockDuration");
            }
        ...
        public Builder lockMode(String lockMode) {
            if (lockMode == null) {
              throw new MissingRequiredPropertyException("GetSnapshotsSnapshotLockDurationDetail", "lockMode");
            }
            this.lockMode = lockMode;
            return this;
        }
        public GetSnapshotsSnapshotLockDurationDetail build() {
            final var _resultValue = new GetSnapshotsSnapshotLockDurationDetail();
