...
@CustomType
public final class MountTargetLock {
    /**
    ...
    public static Builder builder(MountTargetLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(MountTargetLock defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("MountTargetLock", "type");
            }
            this.type = type;
            return this;
        }
        public MountTargetLock build() {
            final var _resultValue = new MountTargetLock();
