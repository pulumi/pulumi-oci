...
@CustomType
public final class ReplicationLock {
    /**
    ...
    public static Builder builder(ReplicationLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(ReplicationLock defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("ReplicationLock", "type");
            }
            this.type = type;
            return this;
        }
        public ReplicationLock build() {
            final var _resultValue = new ReplicationLock();
