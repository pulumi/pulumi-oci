...
@CustomType
public final class SnapshotLock {
    /**
    ...
    public static Builder builder(SnapshotLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(SnapshotLock defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("SnapshotLock", "type");
            }
            this.type = type;
            return this;
        }
        public SnapshotLock build() {
            final var _resultValue = new SnapshotLock();
