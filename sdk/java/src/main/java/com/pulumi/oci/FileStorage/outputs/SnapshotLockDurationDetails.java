...
@CustomType
public final class SnapshotLockDurationDetails {
    /**
     ...
     * 
     */
    private @Nullable Integer coolOffDuration;
    /**
     ...
     * 
     */
    public Optional<Integer> coolOffDuration() {
    ...
    public static Builder builder(SnapshotLockDurationDetails defaults) {
    ...
    public static final class Builder {
        ...
        private String lockMode;
        public Builder() {}
        public Builder(SnapshotLockDurationDetails defaults) {
        ...
        @CustomType.Setter
        public Builder coolOffDuration(@Nullable Integer coolOffDuration) {
        ...
        public Builder lockDuration(Integer lockDuration) {
            if (lockDuration == null) {
              throw new MissingRequiredPropertyException("SnapshotLockDurationDetails", "lockDuration");
            }
        ...
        public Builder lockMode(String lockMode) {
            if (lockMode == null) {
              throw new MissingRequiredPropertyException("SnapshotLockDurationDetails", "lockMode");
            }
            this.lockMode = lockMode;
            return this;
        }
        public SnapshotLockDurationDetails build() {
            final var _resultValue = new SnapshotLockDurationDetails();
