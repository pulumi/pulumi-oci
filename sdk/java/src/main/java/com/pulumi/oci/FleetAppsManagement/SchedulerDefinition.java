...
public class SchedulerDefinition extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="activityInitiationCutOff", refs={Integer.class}, tree="[0]")
    private Output<Integer> activityInitiationCutOff;

    /**
     * @return (Updatable) Activity Initiation Cut Off
     * 
     */
    public Output<Integer> activityInitiationCutOff() {
