...
public final class CompliancePolicyRuleState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder patchTypes(@Nullable Output<List<String>> patchTypes) {
