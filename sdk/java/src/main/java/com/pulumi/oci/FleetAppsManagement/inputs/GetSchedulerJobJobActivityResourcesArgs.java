...
import com.pulumi.oci.FleetAppsManagement.inputs.GetSchedulerJobJobActivityResourcesFilterArgs;
...
public final class GetSchedulerJobJobActivityResourcesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSchedulerJobJobActivityResourcesArgs Empty = new GetSchedulerJobJobActivityResourcesArgs();

    @Import(name="filters")
    private @Nullable Output<List<GetSchedulerJobJobActivityResourcesFilterArgs>> filters;

    public Optional<Output<List<GetSchedulerJobJobActivityResourcesFilterArgs>>> filters() {
    ...
    private GetSchedulerJobJobActivityResourcesArgs() {}

    private GetSchedulerJobJobActivityResourcesArgs(GetSchedulerJobJobActivityResourcesArgs $) {
    ...
    public static Builder builder(GetSchedulerJobJobActivityResourcesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSchedulerJobJobActivityResourcesArgs();
        }

        public Builder(GetSchedulerJobJobActivityResourcesArgs defaults) {
            $ = new GetSchedulerJobJobActivityResourcesArgs(Objects.requireNonNull(defaults));
        }

        public Builder filters(@Nullable Output<List<GetSchedulerJobJobActivityResourcesFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetSchedulerJobJobActivityResourcesFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetSchedulerJobJobActivityResourcesFilterArgs... filters) {
        ...
        public GetSchedulerJobJobActivityResourcesArgs build() {
            if ($.jobActivityId == null) {
                throw new MissingRequiredPropertyException("GetSchedulerJobJobActivityResourcesArgs", "jobActivityId");
            }
            if ($.schedulerJobId == null) {
                throw new MissingRequiredPropertyException("GetSchedulerJobJobActivityResourcesArgs", "schedulerJobId");
            }
            return $;
        }
    }
