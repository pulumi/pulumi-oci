...
public final class RunbookAssociationsGroupPropertiesNotificationPreferencesArgs extends com.pulumi.resources.ResourceArgs {

    public static final RunbookAssociationsGroupPropertiesNotificationPreferencesArgs Empty = new RunbookAssociationsGroupPropertiesNotificationPreferencesArgs();
    ...
    private RunbookAssociationsGroupPropertiesNotificationPreferencesArgs() {}

    private RunbookAssociationsGroupPropertiesNotificationPreferencesArgs(RunbookAssociationsGroupPropertiesNotificationPreferencesArgs $) {
    ...
    public static Builder builder(RunbookAssociationsGroupPropertiesNotificationPreferencesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RunbookAssociationsGroupPropertiesNotificationPreferencesArgs();
        }

        public Builder(RunbookAssociationsGroupPropertiesNotificationPreferencesArgs defaults) {
            $ = new RunbookAssociationsGroupPropertiesNotificationPreferencesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RunbookAssociationsGroupPropertiesNotificationPreferencesArgs build() {
            return $;
        }
    }
