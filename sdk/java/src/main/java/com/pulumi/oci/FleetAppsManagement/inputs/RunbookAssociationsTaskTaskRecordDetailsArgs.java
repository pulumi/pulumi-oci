...
import com.pulumi.oci.FleetAppsManagement.inputs.RunbookAssociationsTaskTaskRecordDetailsExecutionDetailsArgs;
import com.pulumi.oci.FleetAppsManagement.inputs.RunbookAssociationsTaskTaskRecordDetailsPropertiesArgs;
...
public final class RunbookAssociationsTaskTaskRecordDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final RunbookAssociationsTaskTaskRecordDetailsArgs Empty = new RunbookAssociationsTaskTaskRecordDetailsArgs();
    ...
    private @Nullable Output<RunbookAssociationsTaskTaskRecordDetailsExecutionDetailsArgs> executionDetails;

    /**
     * @return (Updatable) Execution details.
     * 
     */
    public Optional<Output<RunbookAssociationsTaskTaskRecordDetailsExecutionDetailsArgs>> executionDetails() {
    ...
    private @Nullable Output<RunbookAssociationsTaskTaskRecordDetailsPropertiesArgs> properties;

    /**
     * @return (Updatable) The properties of the task.
     * 
     */
    public Optional<Output<RunbookAssociationsTaskTaskRecordDetailsPropertiesArgs>> properties() {
    ...
    private RunbookAssociationsTaskTaskRecordDetailsArgs() {}

    private RunbookAssociationsTaskTaskRecordDetailsArgs(RunbookAssociationsTaskTaskRecordDetailsArgs $) {
    ...
    public static Builder builder(RunbookAssociationsTaskTaskRecordDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RunbookAssociationsTaskTaskRecordDetailsArgs();
        }

        public Builder(RunbookAssociationsTaskTaskRecordDetailsArgs defaults) {
            $ = new RunbookAssociationsTaskTaskRecordDetailsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder executionDetails(@Nullable Output<RunbookAssociationsTaskTaskRecordDetailsExecutionDetailsArgs> executionDetails) {
         ...
         * 
         */
        public Builder executionDetails(RunbookAssociationsTaskTaskRecordDetailsExecutionDetailsArgs executionDetails) {
         ...
         * 
         */
        public Builder properties(@Nullable Output<RunbookAssociationsTaskTaskRecordDetailsPropertiesArgs> properties) {
         ...
         * 
         */
        public Builder properties(RunbookAssociationsTaskTaskRecordDetailsPropertiesArgs properties) {
        ...
        public RunbookAssociationsTaskTaskRecordDetailsArgs build() {
            if ($.scope == null) {
                throw new MissingRequiredPropertyException("RunbookAssociationsTaskTaskRecordDetailsArgs", "scope");
            }
            return $;
        }
    }
