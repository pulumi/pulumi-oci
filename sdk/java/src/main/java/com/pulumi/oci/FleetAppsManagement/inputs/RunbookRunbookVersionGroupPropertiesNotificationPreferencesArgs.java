...
public final class RunbookRunbookVersionGroupPropertiesNotificationPreferencesArgs extends com.pulumi.resources.ResourceArgs {

    public static final RunbookRunbookVersionGroupPropertiesNotificationPreferencesArgs Empty = new RunbookRunbookVersionGroupPropertiesNotificationPreferencesArgs();
    ...
    private RunbookRunbookVersionGroupPropertiesNotificationPreferencesArgs() {}

    private RunbookRunbookVersionGroupPropertiesNotificationPreferencesArgs(RunbookRunbookVersionGroupPropertiesNotificationPreferencesArgs $) {
    ...
    public static Builder builder(RunbookRunbookVersionGroupPropertiesNotificationPreferencesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RunbookRunbookVersionGroupPropertiesNotificationPreferencesArgs();
        }

        public Builder(RunbookRunbookVersionGroupPropertiesNotificationPreferencesArgs defaults) {
            $ = new RunbookRunbookVersionGroupPropertiesNotificationPreferencesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RunbookRunbookVersionGroupPropertiesNotificationPreferencesArgs build() {
            return $;
        }
    }
