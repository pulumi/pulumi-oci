...
public final class RunbookVersionGroupPropertiesNotificationPreferencesArgs extends com.pulumi.resources.ResourceArgs {

    public static final RunbookVersionGroupPropertiesNotificationPreferencesArgs Empty = new RunbookVersionGroupPropertiesNotificationPreferencesArgs();
    ...
    private RunbookVersionGroupPropertiesNotificationPreferencesArgs() {}

    private RunbookVersionGroupPropertiesNotificationPreferencesArgs(RunbookVersionGroupPropertiesNotificationPreferencesArgs $) {
    ...
    public static Builder builder(RunbookVersionGroupPropertiesNotificationPreferencesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RunbookVersionGroupPropertiesNotificationPreferencesArgs();
        }

        public Builder(RunbookVersionGroupPropertiesNotificationPreferencesArgs defaults) {
            $ = new RunbookVersionGroupPropertiesNotificationPreferencesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public RunbookVersionGroupPropertiesNotificationPreferencesArgs build() {
            return $;
        }
    }
