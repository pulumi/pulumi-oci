...
public final class TaskRecordDetailsExecutionDetailsContentArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public TaskRecordDetailsExecutionDetailsContentArgs build() {
            if ($.bucket == null) {
                throw new MissingRequiredPropertyException("TaskRecordDetailsExecutionDetailsContentArgs", "bucket");
            }
            if ($.checksum == null) {
                throw new MissingRequiredPropertyException("TaskRecordDetailsExecutionDetailsContentArgs", "checksum");
            }
            if ($.namespace == null) {
                throw new MissingRequiredPropertyException("TaskRecordDetailsExecutionDetailsContentArgs", "namespace");
            }
            if ($.object == null) {
                throw new MissingRequiredPropertyException("TaskRecordDetailsExecutionDetailsContentArgs", "object");
            }
            if ($.sourceType == null) {
