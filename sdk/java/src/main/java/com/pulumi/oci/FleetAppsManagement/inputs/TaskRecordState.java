...
public final class TaskRecordState extends com.pulumi.resources.ResourceArgs {

    public static final TaskRecordState Empty = new TaskRecordState();
     ...
     */
    @Import(name="details")
    private @Nullable Output<TaskRecordDetailsArgs> details;

    /**
     * @return (Updatable) The details of the task.
     * 
     */
    public Optional<Output<TaskRecordDetailsArgs>> details() {
    ...
    private TaskRecordState() {}

    private TaskRecordState(TaskRecordState $) {
    ...
    public static Builder builder(TaskRecordState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(TaskRecordState defaults) {
            $ = new TaskRecordState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder details(@Nullable Output<TaskRecordDetailsArgs> details) {
            $.details = details;
            return this;
        }
        ...
        /**
         * @param state The current state of the TaskRecord.
         * 
         * @return builder
         * 
         */
