...
public final class FleetCredentialPassword {
    ...
    public static Builder builder(FleetCredentialPassword defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String vaultId;
        public Builder() {}
        public Builder(FleetCredentialPassword defaults) {
        ...
        public Builder credentialType(String credentialType) {
            if (credentialType == null) {
              throw new MissingRequiredPropertyException("FleetCredentialPassword", "credentialType");
            }
        ...
        public FleetCredentialPassword build() {
            final var _resultValue = new FleetCredentialPassword();
