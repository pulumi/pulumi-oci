...
import com.pulumi.oci.FleetAppsManagement.outputs.GetOnboardingsOnboardingCollectionItemItemAppliedPolicy;
...
@CustomType
public final class GetOnboardingsOnboardingCollectionItemItem {
    /**
     * @return Summary of the Fleet Application Management Onboard Policy.
     * 
     */
    private List<GetOnboardingsOnboardingCollectionItemItemAppliedPolicy> appliedPolicies;
    /**
    ...
    private GetOnboardingsOnboardingCollectionItemItem() {}
    /**
     * @return Summary of the Fleet Application Management Onboard Policy.
     * 
     */
    public List<GetOnboardingsOnboardingCollectionItemItemAppliedPolicy> appliedPolicies() {
    ...
    public static Builder builder(GetOnboardingsOnboardingCollectionItemItem defaults) {
    ...
    public static final class Builder {
        ...
        private String version;
        public Builder() {}
        public Builder(GetOnboardingsOnboardingCollectionItemItem defaults) {
        ...
        @CustomType.Setter
        public Builder appliedPolicies(List<GetOnboardingsOnboardingCollectionItemItemAppliedPolicy> appliedPolicies) {
            if (appliedPolicies == null) {
              throw new MissingRequiredPropertyException("GetOnboardingsOnboardingCollectionItemItem", "appliedPolicies");
            }
            this.appliedPolicies = appliedPolicies;
            return this;
        }
        public Builder appliedPolicies(GetOnboardingsOnboardingCollectionItemItemAppliedPolicy... appliedPolicies) {
            return appliedPolicies(List.of(appliedPolicies));
        }
        @CustomType.Setter
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetOnboardingsOnboardingCollectionItemItem", "compartmentId");
            }
        ...
        public Builder discoveryFrequency(String discoveryFrequency) {
            if (discoveryFrequency == null) {
              throw new MissingRequiredPropertyException("GetOnboardingsOnboardingCollectionItemItem", "discoveryFrequency");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetOnboardingsOnboardingCollectionItemItem", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isCostTrackingTagEnabled(Boolean isCostTrackingTagEnabled) {
            if (isCostTrackingTagEnabled == null) {
              throw new MissingRequiredPropertyException("GetOnboardingsOnboardingCollectionItemItem", "isCostTrackingTagEnabled");
            }
        ...
        public Builder isFamsTagEnabled(Boolean isFamsTagEnabled) {
            if (isFamsTagEnabled == null) {
              throw new MissingRequiredPropertyException("GetOnboardingsOnboardingCollectionItemItem", "isFamsTagEnabled");
            }
        ...
        public Builder resourceRegion(String resourceRegion) {
            if (resourceRegion == null) {
              throw new MissingRequiredPropertyException("GetOnboardingsOnboardingCollectionItemItem", "resourceRegion");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetOnboardingsOnboardingCollectionItemItem", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder systemTags(Map<String,String> systemTags) {
            if (systemTags == null) {
              throw new MissingRequiredPropertyException("GetOnboardingsOnboardingCollectionItemItem", "systemTags");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetOnboardingsOnboardingCollectionItemItem", "timeCreated");
            }
        ...
        public Builder timeUpdated(String timeUpdated) {
            if (timeUpdated == null) {
              throw new MissingRequiredPropertyException("GetOnboardingsOnboardingCollectionItemItem", "timeUpdated");
            }
        ...
        public Builder version(String version) {
            if (version == null) {
              throw new MissingRequiredPropertyException("GetOnboardingsOnboardingCollectionItemItem", "version");
            }
            this.version = version;
            return this;
        }
        public GetOnboardingsOnboardingCollectionItemItem build() {
            final var _resultValue = new GetOnboardingsOnboardingCollectionItemItem();
