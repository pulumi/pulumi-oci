...
@CustomType
public final class GetPatchPatchType {
    /**
    ...
    public static Builder builder(GetPatchPatchType defaults) {
    ...
    public static final class Builder {
        private String platformConfigurationId;
        public Builder() {}
        public Builder(GetPatchPatchType defaults) {
        ...
        public Builder platformConfigurationId(String platformConfigurationId) {
            if (platformConfigurationId == null) {
              throw new MissingRequiredPropertyException("GetPatchPatchType", "platformConfigurationId");
            }
            this.platformConfigurationId = platformConfigurationId;
            return this;
        }
        public GetPatchPatchType build() {
            final var _resultValue = new GetPatchPatchType();
