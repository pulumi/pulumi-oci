...
@CustomType
public final class GetRunbookAssociationTaskStepPropertyNotificationPreference {
    /**
    ...
    private GetRunbookAssociationTaskStepPropertyNotificationPreference() {}
    /**
     * @return Enables notification on pause.
     * 
     */
    ...
    public static Builder builder(GetRunbookAssociationTaskStepPropertyNotificationPreference defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean shouldNotifyOnTaskSuccess;
        public Builder() {}
        public Builder(GetRunbookAssociationTaskStepPropertyNotificationPreference defaults) {
        ...
        public Builder shouldNotifyOnPause(Boolean shouldNotifyOnPause) {
            if (shouldNotifyOnPause == null) {
              throw new MissingRequiredPropertyException("GetRunbookAssociationTaskStepPropertyNotificationPreference", "shouldNotifyOnPause");
            }
        ...
        public Builder shouldNotifyOnTaskFailure(Boolean shouldNotifyOnTaskFailure) {
            if (shouldNotifyOnTaskFailure == null) {
              throw new MissingRequiredPropertyException("GetRunbookAssociationTaskStepPropertyNotificationPreference", "shouldNotifyOnTaskFailure");
            }
        ...
        public Builder shouldNotifyOnTaskSuccess(Boolean shouldNotifyOnTaskSuccess) {
            if (shouldNotifyOnTaskSuccess == null) {
              throw new MissingRequiredPropertyException("GetRunbookAssociationTaskStepPropertyNotificationPreference", "shouldNotifyOnTaskSuccess");
            }
            this.shouldNotifyOnTaskSuccess = shouldNotifyOnTaskSuccess;
            return this;
        }
        public GetRunbookAssociationTaskStepPropertyNotificationPreference build() {
            final var _resultValue = new GetRunbookAssociationTaskStepPropertyNotificationPreference();
