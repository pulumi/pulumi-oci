...
@CustomType
public final class GetRunbookRunbookVersionGroupPropertyNotificationPreference {
    /**
    ...
    private GetRunbookRunbookVersionGroupPropertyNotificationPreference() {}
    /**
     * @return Enables notification on pause.
     * 
     */
    ...
    public static Builder builder(GetRunbookRunbookVersionGroupPropertyNotificationPreference defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean shouldNotifyOnTaskSuccess;
        public Builder() {}
        public Builder(GetRunbookRunbookVersionGroupPropertyNotificationPreference defaults) {
        ...
        public Builder shouldNotifyOnPause(Boolean shouldNotifyOnPause) {
            if (shouldNotifyOnPause == null) {
              throw new MissingRequiredPropertyException("GetRunbookRunbookVersionGroupPropertyNotificationPreference", "shouldNotifyOnPause");
            }
        ...
        public Builder shouldNotifyOnTaskFailure(Boolean shouldNotifyOnTaskFailure) {
            if (shouldNotifyOnTaskFailure == null) {
              throw new MissingRequiredPropertyException("GetRunbookRunbookVersionGroupPropertyNotificationPreference", "shouldNotifyOnTaskFailure");
            }
        ...
        public Builder shouldNotifyOnTaskSuccess(Boolean shouldNotifyOnTaskSuccess) {
            if (shouldNotifyOnTaskSuccess == null) {
              throw new MissingRequiredPropertyException("GetRunbookRunbookVersionGroupPropertyNotificationPreference", "shouldNotifyOnTaskSuccess");
            }
            this.shouldNotifyOnTaskSuccess = shouldNotifyOnTaskSuccess;
            return this;
        }
        public GetRunbookRunbookVersionGroupPropertyNotificationPreference build() {
            final var _resultValue = new GetRunbookRunbookVersionGroupPropertyNotificationPreference();
