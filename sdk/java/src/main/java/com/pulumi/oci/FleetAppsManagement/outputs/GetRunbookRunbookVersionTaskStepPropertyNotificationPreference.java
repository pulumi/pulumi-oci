...
@CustomType
public final class GetRunbookRunbookVersionTaskStepPropertyNotificationPreference {
    /**
    ...
    private GetRunbookRunbookVersionTaskStepPropertyNotificationPreference() {}
    /**
     * @return Enables notification on pause.
     * 
     */
    ...
    public static Builder builder(GetRunbookRunbookVersionTaskStepPropertyNotificationPreference defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean shouldNotifyOnTaskSuccess;
        public Builder() {}
        public Builder(GetRunbookRunbookVersionTaskStepPropertyNotificationPreference defaults) {
        ...
        public Builder shouldNotifyOnPause(Boolean shouldNotifyOnPause) {
            if (shouldNotifyOnPause == null) {
              throw new MissingRequiredPropertyException("GetRunbookRunbookVersionTaskStepPropertyNotificationPreference", "shouldNotifyOnPause");
            }
        ...
        public Builder shouldNotifyOnTaskFailure(Boolean shouldNotifyOnTaskFailure) {
            if (shouldNotifyOnTaskFailure == null) {
              throw new MissingRequiredPropertyException("GetRunbookRunbookVersionTaskStepPropertyNotificationPreference", "shouldNotifyOnTaskFailure");
            }
        ...
        public Builder shouldNotifyOnTaskSuccess(Boolean shouldNotifyOnTaskSuccess) {
            if (shouldNotifyOnTaskSuccess == null) {
              throw new MissingRequiredPropertyException("GetRunbookRunbookVersionTaskStepPropertyNotificationPreference", "shouldNotifyOnTaskSuccess");
            }
            this.shouldNotifyOnTaskSuccess = shouldNotifyOnTaskSuccess;
            return this;
        }
        public GetRunbookRunbookVersionTaskStepPropertyNotificationPreference build() {
            final var _resultValue = new GetRunbookRunbookVersionTaskStepPropertyNotificationPreference();
