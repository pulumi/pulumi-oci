...
@CustomType
public final class GetRunbookVersionTaskStepPropertyNotificationPreference {
    /**
    ...
    private GetRunbookVersionTaskStepPropertyNotificationPreference() {}
    /**
     * @return Enables notification on pause.
     * 
     */
    ...
    public static Builder builder(GetRunbookVersionTaskStepPropertyNotificationPreference defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean shouldNotifyOnTaskSuccess;
        public Builder() {}
        public Builder(GetRunbookVersionTaskStepPropertyNotificationPreference defaults) {
        ...
        public Builder shouldNotifyOnPause(Boolean shouldNotifyOnPause) {
            if (shouldNotifyOnPause == null) {
              throw new MissingRequiredPropertyException("GetRunbookVersionTaskStepPropertyNotificationPreference", "shouldNotifyOnPause");
            }
        ...
        public Builder shouldNotifyOnTaskFailure(Boolean shouldNotifyOnTaskFailure) {
            if (shouldNotifyOnTaskFailure == null) {
              throw new MissingRequiredPropertyException("GetRunbookVersionTaskStepPropertyNotificationPreference", "shouldNotifyOnTaskFailure");
            }
        ...
        public Builder shouldNotifyOnTaskSuccess(Boolean shouldNotifyOnTaskSuccess) {
            if (shouldNotifyOnTaskSuccess == null) {
              throw new MissingRequiredPropertyException("GetRunbookVersionTaskStepPropertyNotificationPreference", "shouldNotifyOnTaskSuccess");
            }
            this.shouldNotifyOnTaskSuccess = shouldNotifyOnTaskSuccess;
            return this;
        }
        public GetRunbookVersionTaskStepPropertyNotificationPreference build() {
            final var _resultValue = new GetRunbookVersionTaskStepPropertyNotificationPreference();
