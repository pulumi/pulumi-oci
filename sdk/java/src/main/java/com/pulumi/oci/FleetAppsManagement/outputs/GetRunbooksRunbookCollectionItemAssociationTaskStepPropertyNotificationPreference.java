...
@CustomType
public final class GetRunbooksRunbookCollectionItemAssociationTaskStepPropertyNotificationPreference {
    /**
    ...
    private GetRunbooksRunbookCollectionItemAssociationTaskStepPropertyNotificationPreference() {}
    /**
     * @return Enables notification on pause.
     * 
     */
    ...
    public static Builder builder(GetRunbooksRunbookCollectionItemAssociationTaskStepPropertyNotificationPreference defaults) {
    ...
    public static final class Builder {
        ...
        private Boolean shouldNotifyOnTaskSuccess;
        public Builder() {}
        public Builder(GetRunbooksRunbookCollectionItemAssociationTaskStepPropertyNotificationPreference defaults) {
        ...
        public Builder shouldNotifyOnPause(Boolean shouldNotifyOnPause) {
            if (shouldNotifyOnPause == null) {
              throw new MissingRequiredPropertyException("GetRunbooksRunbookCollectionItemAssociationTaskStepPropertyNotificationPreference", "shouldNotifyOnPause");
            }
        ...
        public Builder shouldNotifyOnTaskFailure(Boolean shouldNotifyOnTaskFailure) {
            if (shouldNotifyOnTaskFailure == null) {
              throw new MissingRequiredPropertyException("GetRunbooksRunbookCollectionItemAssociationTaskStepPropertyNotificationPreference", "shouldNotifyOnTaskFailure");
            }
        ...
        public Builder shouldNotifyOnTaskSuccess(Boolean shouldNotifyOnTaskSuccess) {
            if (shouldNotifyOnTaskSuccess == null) {
              throw new MissingRequiredPropertyException("GetRunbooksRunbookCollectionItemAssociationTaskStepPropertyNotificationPreference", "shouldNotifyOnTaskSuccess");
            }
            this.shouldNotifyOnTaskSuccess = shouldNotifyOnTaskSuccess;
            return this;
        }
        public GetRunbooksRunbookCollectionItemAssociationTaskStepPropertyNotificationPreference build() {
            final var _resultValue = new GetRunbooksRunbookCollectionItemAssociationTaskStepPropertyNotificationPreference();
