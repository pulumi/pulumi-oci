...
@CustomType
public final class PatchPatchType {
    /**
    ...
    public static Builder builder(PatchPatchType defaults) {
    ...
    public static final class Builder {
        private String platformConfigurationId;
        public Builder() {}
        public Builder(PatchPatchType defaults) {
        ...
        public Builder platformConfigurationId(String platformConfigurationId) {
            if (platformConfigurationId == null) {
              throw new MissingRequiredPropertyException("PatchPatchType", "platformConfigurationId");
            }
            this.platformConfigurationId = platformConfigurationId;
            return this;
        }
        public PatchPatchType build() {
            final var _resultValue = new PatchPatchType();
