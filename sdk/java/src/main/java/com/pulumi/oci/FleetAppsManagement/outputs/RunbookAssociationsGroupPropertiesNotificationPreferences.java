...
@CustomType
public final class RunbookAssociationsGroupPropertiesNotificationPreferences {
    /**
    ...
    public static Builder builder(RunbookAssociationsGroupPropertiesNotificationPreferences defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean shouldNotifyOnTaskSuccess;
        public Builder() {}
        public Builder(RunbookAssociationsGroupPropertiesNotificationPreferences defaults) {
        ...
        public RunbookAssociationsGroupPropertiesNotificationPreferences build() {
            final var _resultValue = new RunbookAssociationsGroupPropertiesNotificationPreferences();
