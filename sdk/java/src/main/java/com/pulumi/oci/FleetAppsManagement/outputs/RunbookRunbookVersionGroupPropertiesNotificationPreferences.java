...
@CustomType
public final class RunbookRunbookVersionGroupPropertiesNotificationPreferences {
    /**
    ...
    public static Builder builder(RunbookRunbookVersionGroupPropertiesNotificationPreferences defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean shouldNotifyOnTaskSuccess;
        public Builder() {}
        public Builder(RunbookRunbookVersionGroupPropertiesNotificationPreferences defaults) {
        ...
        public RunbookRunbookVersionGroupPropertiesNotificationPreferences build() {
            final var _resultValue = new RunbookRunbookVersionGroupPropertiesNotificationPreferences();
