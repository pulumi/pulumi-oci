...
@CustomType
public final class RunbookRunbookVersionTaskStepPropertiesNotificationPreferences {
    /**
    ...
    private RunbookRunbookVersionTaskStepPropertiesNotificationPreferences() {}
    /**
     * @return Enables notification on pause.
     * 
     */
    ...
    public static Builder builder(RunbookRunbookVersionTaskStepPropertiesNotificationPreferences defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean shouldNotifyOnTaskSuccess;
        public Builder() {}
        public Builder(RunbookRunbookVersionTaskStepPropertiesNotificationPreferences defaults) {
        ...
        public RunbookRunbookVersionTaskStepPropertiesNotificationPreferences build() {
            final var _resultValue = new RunbookRunbookVersionTaskStepPropertiesNotificationPreferences();
