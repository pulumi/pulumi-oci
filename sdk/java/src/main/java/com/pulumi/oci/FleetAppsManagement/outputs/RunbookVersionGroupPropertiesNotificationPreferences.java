...
@CustomType
public final class RunbookVersionGroupPropertiesNotificationPreferences {
    /**
    ...
    private RunbookVersionGroupPropertiesNotificationPreferences() {}
    /**
     * @return (Updatable) Enables notification on pause.
     * 
     */
    ...
    public static Builder builder(RunbookVersionGroupPropertiesNotificationPreferences defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean shouldNotifyOnTaskSuccess;
        public Builder() {}
        public Builder(RunbookVersionGroupPropertiesNotificationPreferences defaults) {
        ...
        public RunbookVersionGroupPropertiesNotificationPreferences build() {
            final var _resultValue = new RunbookVersionGroupPropertiesNotificationPreferences();
