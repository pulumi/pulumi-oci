...
@CustomType
public final class RunbookVersionTaskStepPropertiesNotificationPreferences {
    /**
    ...
    private RunbookVersionTaskStepPropertiesNotificationPreferences() {}
    /**
     * @return (Updatable) Enables notification on pause.
     * 
     */
    ...
    public static Builder builder(RunbookVersionTaskStepPropertiesNotificationPreferences defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Boolean shouldNotifyOnTaskSuccess;
        public Builder() {}
        public Builder(RunbookVersionTaskStepPropertiesNotificationPreferences defaults) {
        ...
        public RunbookVersionTaskStepPropertiesNotificationPreferences build() {
            final var _resultValue = new RunbookVersionTaskStepPropertiesNotificationPreferences();
