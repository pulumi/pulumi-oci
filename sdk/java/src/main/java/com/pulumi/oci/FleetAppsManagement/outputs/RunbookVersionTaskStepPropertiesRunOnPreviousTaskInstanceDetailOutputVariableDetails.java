...
public final class RunbookVersionTaskStepPropertiesRunOnPreviousTaskInstanceDetailOutputVariableDetails {
    ...
    public static Builder builder(RunbookVersionTaskStepPropertiesRunOnPreviousTaskInstanceDetailOutputVariableDetails defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String stepName;
        public Builder() {}
        public Builder(RunbookVersionTaskStepPropertiesRunOnPreviousTaskInstanceDetailOutputVariableDetails defaults) {
        ...
        public RunbookVersionTaskStepPropertiesRunOnPreviousTaskInstanceDetailOutputVariableDetails build() {
            final var _resultValue = new RunbookVersionTaskStepPropertiesRunOnPreviousTaskInstanceDetailOutputVariableDetails();
