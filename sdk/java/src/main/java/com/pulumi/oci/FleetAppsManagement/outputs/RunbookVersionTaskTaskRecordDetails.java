...
import com.pulumi.oci.FleetAppsManagement.outputs.RunbookVersionTaskTaskRecordDetailsExecutionDetails;
import com.pulumi.oci.FleetAppsManagement.outputs.RunbookVersionTaskTaskRecordDetailsProperties;
...
@CustomType
public final class RunbookVersionTaskTaskRecordDetails {
    /**
     ...
     * 
     */
    private @Nullable RunbookVersionTaskTaskRecordDetailsProperties properties;
    /**
     ...
     * 
     */
    public Optional<RunbookVersionTaskTaskRecordDetailsExecutionDetails> executionDetails() {
     ...
     * 
     */
    public Optional<RunbookVersionTaskTaskRecordDetailsProperties> properties() {
    ...
    public static Builder builder(RunbookVersionTaskTaskRecordDetails defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String taskRecordId;
        public Builder() {}
        public Builder(RunbookVersionTaskTaskRecordDetails defaults) {
        ...
        @CustomType.Setter
        public Builder executionDetails(@Nullable RunbookVersionTaskTaskRecordDetailsExecutionDetails executionDetails) {
        ...
        @CustomType.Setter
        public Builder properties(@Nullable RunbookVersionTaskTaskRecordDetailsProperties properties) {
        ...
        public Builder scope(String scope) {
            if (scope == null) {
              throw new MissingRequiredPropertyException("RunbookVersionTaskTaskRecordDetails", "scope");
            }
            this.scope = scope;
            return this;
        }
        ...
        public RunbookVersionTaskTaskRecordDetails build() {
            final var _resultValue = new RunbookVersionTaskTaskRecordDetails();
