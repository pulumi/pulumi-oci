...
public final class SchedulerDefinitionSchedule {
    ...
    /**
     * @return (Updatable) Provide MaintenanceWindowId if Schedule Type is Maintenance Window
     * 
     */
    private @Nullable String maintenanceWindowId;
    /**
     * @return (Updatable) Recurrence rule specification if Schedule Type is Custom and Recurring
     * 
     */
