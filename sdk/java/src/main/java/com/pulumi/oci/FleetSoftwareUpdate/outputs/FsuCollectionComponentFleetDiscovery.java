...
import com.pulumi.oci.FleetSoftwareUpdate.outputs.FsuCollectionComponentFleetDiscoveryFilter;
...
@CustomType
public final class FsuCollectionComponentFleetDiscovery {
    /**
     * @return Filters to perform the target discovery.
     * 
     */
    private @Nullable List<FsuCollectionComponentFleetDiscoveryFilter> filters;
    /**
    ...
    private FsuCollectionComponentFleetDiscovery() {}
    /**
     * @return Filters to perform the target discovery.
     * 
     */
    public List<FsuCollectionComponentFleetDiscoveryFilter> filters() {
    ...
    public static Builder builder(FsuCollectionComponentFleetDiscovery defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> targets;
        public Builder() {}
        public Builder(FsuCollectionComponentFleetDiscovery defaults) {
        ...
        @CustomType.Setter
        public Builder filters(@Nullable List<FsuCollectionComponentFleetDiscoveryFilter> filters) {

            this.filters = filters;
            return this;
        }
        public Builder filters(FsuCollectionComponentFleetDiscoveryFilter... filters) {
        ...
        public Builder strategy(String strategy) {
            if (strategy == null) {
              throw new MissingRequiredPropertyException("FsuCollectionComponentFleetDiscovery", "strategy");
            }
        ...
        public FsuCollectionComponentFleetDiscovery build() {
            final var _resultValue = new FsuCollectionComponentFleetDiscovery();
