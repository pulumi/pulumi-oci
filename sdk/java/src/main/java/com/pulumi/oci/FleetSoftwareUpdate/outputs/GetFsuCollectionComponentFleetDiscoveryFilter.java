...
import com.pulumi.oci.FleetSoftwareUpdate.outputs.GetFsuCollectionComponentFleetDiscoveryFilterTag;
import java.lang.String;
import java.util.List;
import java.util.Objects;

@CustomType
public final class GetFsuCollectionComponentFleetDiscoveryFilter {
    /**
     ...
     * 
     */
    private List<GetFsuCollectionComponentFleetDiscoveryFilterTag> tags;
    /**
    ...
    private GetFsuCollectionComponentFleetDiscoveryFilter() {}
    /**
     * @return Type of resource to match in the discovery.
     * 
     */
     ...
     * 
     */
    public List<GetFsuCollectionComponentFleetDiscoveryFilterTag> tags() {
        return this.tags;
    }
    /**
     * @return Exadata Fleet Update Collection type.
    ...
    public static Builder builder(GetFsuCollectionComponentFleetDiscoveryFilter defaults) {
    ...
    public static final class Builder {
        ...
        private List<String> versions;
        public Builder() {}
        public Builder(GetFsuCollectionComponentFleetDiscoveryFilter defaults) {
        ...
        public Builder entityType(String entityType) {
            if (entityType == null) {
              throw new MissingRequiredPropertyException("GetFsuCollectionComponentFleetDiscoveryFilter", "entityType");
            }
        ...
        public Builder exadataReleases(List<String> exadataReleases) {
            if (exadataReleases == null) {
              throw new MissingRequiredPropertyException("GetFsuCollectionComponentFleetDiscoveryFilter", "exadataReleases");
            }
        ...
        public Builder identifiers(List<String> identifiers) {
            if (identifiers == null) {
              throw new MissingRequiredPropertyException("GetFsuCollectionComponentFleetDiscoveryFilter", "identifiers");
            }
        ...
        public Builder mode(String mode) {
            if (mode == null) {
              throw new MissingRequiredPropertyException("GetFsuCollectionComponentFleetDiscoveryFilter", "mode");
            }
            this.mode = mode;
            return this;
        }
        ...
        public Builder operator(String operator) {
            if (operator == null) {
              throw new MissingRequiredPropertyException("GetFsuCollectionComponentFleetDiscoveryFilter", "operator");
            }
            this.operator = operator;
            return this;
        }
        @CustomType.Setter
        public Builder tags(List<GetFsuCollectionComponentFleetDiscoveryFilterTag> tags) {
            if (tags == null) {
              throw new MissingRequiredPropertyException("GetFsuCollectionComponentFleetDiscoveryFilter", "tags");
            }
            this.tags = tags;
            return this;
        }
        public Builder tags(GetFsuCollectionComponentFleetDiscoveryFilterTag... tags) {
            return tags(List.of(tags));
        }
        @CustomType.Setter
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetFsuCollectionComponentFleetDiscoveryFilter", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder versions(List<String> versions) {
            if (versions == null) {
              throw new MissingRequiredPropertyException("GetFsuCollectionComponentFleetDiscoveryFilter", "versions");
            }
        ...
        public GetFsuCollectionComponentFleetDiscoveryFilter build() {
            final var _resultValue = new GetFsuCollectionComponentFleetDiscoveryFilter();
