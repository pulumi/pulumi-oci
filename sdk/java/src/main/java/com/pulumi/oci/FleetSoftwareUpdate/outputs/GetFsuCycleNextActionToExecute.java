...
public final class GetFsuCycleNextActionToExecute {
    ...
    private GetFsuCycleNextActionToExecute() {}
    /**
     * @return The date and time the Exadata Fleet Update Action is expected to start. [RFC 3339](https://tools.ietf.org/rfc/rfc3339), section 14.29.
     * 
     */
    ...
    public static Builder builder(GetFsuCycleNextActionToExecute defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetFsuCycleNextActionToExecute defaults) {
        ...
        public Builder timeToStart(String timeToStart) {
            if (timeToStart == null) {
              throw new MissingRequiredPropertyException("GetFsuCycleNextActionToExecute", "timeToStart");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetFsuCycleNextActionToExecute", "type");
            }
            this.type = type;
            return this;
        }
        public GetFsuCycleNextActionToExecute build() {
            final var _resultValue = new GetFsuCycleNextActionToExecute();
