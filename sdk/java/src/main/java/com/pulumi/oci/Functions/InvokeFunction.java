...
public class InvokeFunction extends com.pulumi.resources.CustomResource {
     ...
     */
    public InvokeFunction(java.lang.String name) {
     ...
     */
    public InvokeFunction(java.lang.String name, InvokeFunctionArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public InvokeFunction(java.lang.String name, InvokeFunctionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Functions/invokeFunction:InvokeFunction", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private InvokeFunction(java.lang.String name, Output<java.lang.String> id, @Nullable InvokeFunctionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Functions/invokeFunction:InvokeFunction", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static InvokeFunction get(java.lang.String name, Output<java.lang.String> id, @Nullable InvokeFunctionState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
