...
public final class FunctionFailureDestinationArgs extends com.pulumi.resources.ResourceArgs {

    public static final FunctionFailureDestinationArgs Empty = new FunctionFailureDestinationArgs();
    ...
    private FunctionFailureDestinationArgs() {}

    private FunctionFailureDestinationArgs(FunctionFailureDestinationArgs $) {
    ...
    public static Builder builder(FunctionFailureDestinationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new FunctionFailureDestinationArgs();
        }

        public Builder(FunctionFailureDestinationArgs defaults) {
            $ = new FunctionFailureDestinationArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param kind (Updatable) The type of destination for the response to a failed detached function invocation.
         * 
         * @return builder
         * 
         */
        ...
        public FunctionFailureDestinationArgs build() {
            if ($.kind == null) {
                throw new MissingRequiredPropertyException("FunctionFailureDestinationArgs", "kind");
            }
            return $;
        }
    }
