...
import com.pulumi.oci.Functions.inputs.GetFusionEnvironmentRefreshActivitiesFilterArgs;
...
public final class GetFusionEnvironmentRefreshActivitiesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetFusionEnvironmentRefreshActivitiesArgs Empty = new GetFusionEnvironmentRefreshActivitiesArgs();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetFusionEnvironmentRefreshActivitiesFilterArgs>> filters;

    public Optional<Output<List<GetFusionEnvironmentRefreshActivitiesFilterArgs>>> filters() {
    ...
    private GetFusionEnvironmentRefreshActivitiesArgs() {}

    private GetFusionEnvironmentRefreshActivitiesArgs(GetFusionEnvironmentRefreshActivitiesArgs $) {
    ...
    public static Builder builder(GetFusionEnvironmentRefreshActivitiesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFusionEnvironmentRefreshActivitiesArgs();
        }

        public Builder(GetFusionEnvironmentRefreshActivitiesArgs defaults) {
            $ = new GetFusionEnvironmentRefreshActivitiesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetFusionEnvironmentRefreshActivitiesFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetFusionEnvironmentRefreshActivitiesFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetFusionEnvironmentRefreshActivitiesFilterArgs... filters) {
        ...
        public GetFusionEnvironmentRefreshActivitiesArgs build() {
            if ($.fusionEnvironmentId == null) {
                throw new MissingRequiredPropertyException("GetFusionEnvironmentRefreshActivitiesArgs", "fusionEnvironmentId");
            }
            return $;
        }
    }
