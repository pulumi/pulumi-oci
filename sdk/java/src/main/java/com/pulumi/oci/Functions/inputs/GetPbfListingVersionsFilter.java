...
public final class GetPbfListingVersionsFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetPbfListingVersionsFilter Empty = new GetPbfListingVersionsFilter();
    ...
    private GetPbfListingVersionsFilter(GetPbfListingVersionsFilter $) {
        this.name = $.name;
        this.regex = $.regex;
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPbfListingVersionsFilter();
        }

        public Builder(GetPbfListingVersionsFilter defaults) {
            $ = new GetPbfListingVersionsFilter(Objects.requireNonNull(defaults));
        }
