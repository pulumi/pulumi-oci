...
public final class GetPbfListingVersionsFilterArgs extends com.pulumi.resources.ResourceArgs {

    public static final GetPbfListingVersionsFilterArgs Empty = new GetPbfListingVersionsFilterArgs();
    ...
    private GetPbfListingVersionsFilterArgs() {}

    private GetPbfListingVersionsFilterArgs(GetPbfListingVersionsFilterArgs $) {
        this.name = $.name;
        this.regex = $.regex;
        this.values = $.values;
    }
    ...
    public static Builder builder(GetPbfListingVersionsFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetPbfListingVersionsFilterArgs();
        }

        public Builder(GetPbfListingVersionsFilterArgs defaults) {
            $ = new GetPbfListingVersionsFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetPbfListingVersionsFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetPbfListingVersionsFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetPbfListingVersionsFilterArgs", "values");
            }
            return $;
        }
    }
