...
@CustomType
public final class GetApplicationsFilter {
    private String name;
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetApplicationsFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetApplicationsFilter", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetApplicationsFilter build() {
            final var _resultValue = new GetApplicationsFilter();
