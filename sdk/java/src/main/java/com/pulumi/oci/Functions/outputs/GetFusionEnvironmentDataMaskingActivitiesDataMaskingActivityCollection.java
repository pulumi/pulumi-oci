...
public final class GetFusionEnvironmentDataMaskingActivitiesDataMaskingActivityCollection {
    ...
    public static final class Builder {
        ...
        public Builder items(List<GetFusionEnvironmentDataMaskingActivitiesDataMaskingActivityCollectionItem> items) {
            if (items == null) {
              throw new MissingRequiredPropertyException("GetFusionEnvironmentDataMaskingActivitiesDataMaskingActivityCollection", "items");
            }
            this.items = items;
            return this;
        }
        ...
        public GetFusionEnvironmentDataMaskingActivitiesDataMaskingActivityCollection build() {
            final var _resultValue = new GetFusionEnvironmentDataMaskingActivitiesDataMaskingActivityCollection();
