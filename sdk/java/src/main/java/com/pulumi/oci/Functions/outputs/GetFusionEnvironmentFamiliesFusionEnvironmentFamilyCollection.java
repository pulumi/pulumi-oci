...
public final class GetFusionEnvironmentFamiliesFusionEnvironmentFamilyCollection {
    ...
    public static final class Builder {
        ...
        public Builder items(List<GetFusionEnvironmentFamiliesFusionEnvironmentFamilyCollectionItem> items) {
            if (items == null) {
              throw new MissingRequiredPropertyException("GetFusionEnvironmentFamiliesFusionEnvironmentFamilyCollection", "items");
            }
            this.items = items;
            return this;
        }
        ...
        public GetFusionEnvironmentFamiliesFusionEnvironmentFamilyCollection build() {
            final var _resultValue = new GetFusionEnvironmentFamiliesFusionEnvironmentFamilyCollection();
