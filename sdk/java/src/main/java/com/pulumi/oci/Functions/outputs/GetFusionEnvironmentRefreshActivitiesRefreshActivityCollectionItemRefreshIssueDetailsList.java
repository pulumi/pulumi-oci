...
public final class GetFusionEnvironmentRefreshActivitiesRefreshActivityCollectionItemRefreshIssueDetailsList {
    ...
    public static Builder builder(GetFusionEnvironmentRefreshActivitiesRefreshActivityCollectionItemRefreshIssueDetailsList defaults) {
    ...
    public static final class Builder {
        ...
        public Builder refreshIssues(String refreshIssues) {
            if (refreshIssues == null) {
              throw new MissingRequiredPropertyException("GetFusionEnvironmentRefreshActivitiesRefreshActivityCollectionItemRefreshIssueDetailsList", "refreshIssues");
            }
