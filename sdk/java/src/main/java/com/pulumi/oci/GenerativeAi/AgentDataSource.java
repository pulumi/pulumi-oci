...
import com.pulumi.oci.GenerativeAi.inputs.AgentDataSourceState;
import com.pulumi.oci.GenerativeAi.outputs.AgentDataSourceDataSourceConfig;
 ...
 * 
 */
@ResourceType(type="oci:GenerativeAi/agentDataSource:AgentDataSource")
public class AgentDataSource extends com.pulumi.resources.CustomResource {
    ...
    public AgentDataSource(java.lang.String name, AgentDataSourceArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:GenerativeAi/agentDataSource:AgentDataSource", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private AgentDataSource(java.lang.String name, Output<java.lang.String> id, @Nullable AgentDataSourceState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:GenerativeAi/agentDataSource:AgentDataSource", name, state, makeResourceOptions(options, id), false);
    }
