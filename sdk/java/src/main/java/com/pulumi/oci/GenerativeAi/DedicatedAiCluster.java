...
public class DedicatedAiCluster extends com.pulumi.resources.CustomResource {
     ...
     */
    public DedicatedAiCluster(String name) {
     ...
     */
    public static DedicatedAiCluster get(String name, Output<String> id, @Nullable DedicatedAiClusterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
