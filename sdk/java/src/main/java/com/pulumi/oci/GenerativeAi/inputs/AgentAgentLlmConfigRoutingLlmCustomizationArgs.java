...
public final class AgentAgentLlmConfigRoutingLlmCustomizationArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private @Nullable Output<AgentAgentLlmConfigRoutingLlmCustomizationLlmSelectionArgs> llmSelection;

    /**
     * @return (Updatable) LLM selection configuration - either DEFAULT or CUSTOM.
     * 
     */
    public Optional<Output<AgentAgentLlmConfigRoutingLlmCustomizationLlmSelectionArgs>> llmSelection() {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder llmSelection(@Nullable Output<AgentAgentLlmConfigRoutingLlmCustomizationLlmSelectionArgs> llmSelection) {
         ...
         * 
         */
        public Builder llmSelection(AgentAgentLlmConfigRoutingLlmCustomizationLlmSelectionArgs llmSelection) {
