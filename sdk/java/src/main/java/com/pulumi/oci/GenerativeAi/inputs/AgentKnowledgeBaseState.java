...
public final class AgentKnowledgeBaseState extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder indexConfig(@Nullable Output<AgentKnowledgeBaseIndexConfigArgs> indexConfig) {
        ...
        /**
         * @param lifecycleDetails A message that describes the current state of the knowledge base in more detail. For example, can be used to provide actionable information for a resource in the Failed state.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param state The current state of the knowledge base.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param timeCreated The date and time the knowledge base was created, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param timeUpdated The date and time the knowledge base was updated, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
         * 
         * @return builder
         * 
         */
