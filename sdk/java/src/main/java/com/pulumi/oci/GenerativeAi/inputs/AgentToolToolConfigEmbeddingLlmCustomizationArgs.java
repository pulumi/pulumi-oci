...
public final class AgentToolToolConfigEmbeddingLlmCustomizationArgs extends com.pulumi.resources.ResourceArgs {

    public static final AgentToolToolConfigEmbeddingLlmCustomizationArgs Empty = new AgentToolToolConfigEmbeddingLlmCustomizationArgs();
    ...
    private @Nullable Output<AgentToolToolConfigEmbeddingLlmCustomizationLlmSelectionArgs> llmSelection;

    /**
     * @return (Updatable) LLM selection configuration - either DEFAULT or CUSTOM.
     * 
     */
    public Optional<Output<AgentToolToolConfigEmbeddingLlmCustomizationLlmSelectionArgs>> llmSelection() {
        return Optional.ofNullable(this.llmSelection);
    }

    private AgentToolToolConfigEmbeddingLlmCustomizationArgs() {}

    private AgentToolToolConfigEmbeddingLlmCustomizationArgs(AgentToolToolConfigEmbeddingLlmCustomizationArgs $) {
    ...
    public static Builder builder(AgentToolToolConfigEmbeddingLlmCustomizationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AgentToolToolConfigEmbeddingLlmCustomizationArgs();
        }

        public Builder(AgentToolToolConfigEmbeddingLlmCustomizationArgs defaults) {
            $ = new AgentToolToolConfigEmbeddingLlmCustomizationArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder llmSelection(@Nullable Output<AgentToolToolConfigEmbeddingLlmCustomizationLlmSelectionArgs> llmSelection) {
         ...
         * 
         */
        public Builder llmSelection(AgentToolToolConfigEmbeddingLlmCustomizationLlmSelectionArgs llmSelection) {
            return llmSelection(Output.of(llmSelection));
        }

        public AgentToolToolConfigEmbeddingLlmCustomizationArgs build() {
            return $;
        }
    }
