...
public final class AgentToolToolConfigReasoningLlmCustomizationArgs extends com.pulumi.resources.ResourceArgs {

    public static final AgentToolToolConfigReasoningLlmCustomizationArgs Empty = new AgentToolToolConfigReasoningLlmCustomizationArgs();
    ...
    private @Nullable Output<AgentToolToolConfigReasoningLlmCustomizationLlmSelectionArgs> llmSelection;

    /**
     * @return (Updatable) LLM selection configuration - either DEFAULT or CUSTOM.
     * 
     */
    public Optional<Output<AgentToolToolConfigReasoningLlmCustomizationLlmSelectionArgs>> llmSelection() {
        return Optional.ofNullable(this.llmSelection);
    }

    private AgentToolToolConfigReasoningLlmCustomizationArgs() {}

    private AgentToolToolConfigReasoningLlmCustomizationArgs(AgentToolToolConfigReasoningLlmCustomizationArgs $) {
    ...
    public static Builder builder(AgentToolToolConfigReasoningLlmCustomizationArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AgentToolToolConfigReasoningLlmCustomizationArgs();
        }

        public Builder(AgentToolToolConfigReasoningLlmCustomizationArgs defaults) {
            $ = new AgentToolToolConfigReasoningLlmCustomizationArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder llmSelection(@Nullable Output<AgentToolToolConfigReasoningLlmCustomizationLlmSelectionArgs> llmSelection) {
         ...
         * 
         */
        public Builder llmSelection(AgentToolToolConfigReasoningLlmCustomizationLlmSelectionArgs llmSelection) {
            return llmSelection(Output.of(llmSelection));
        }

        public AgentToolToolConfigReasoningLlmCustomizationArgs build() {
            return $;
        }
    }
