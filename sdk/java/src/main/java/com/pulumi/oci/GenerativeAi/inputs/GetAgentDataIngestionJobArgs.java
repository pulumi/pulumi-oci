...
public final class GetAgentDataIngestionJobArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetAgentDataIngestionJobArgs Empty = new GetAgentDataIngestionJobArgs();
    ...
    private GetAgentDataIngestionJobArgs() {}

    private GetAgentDataIngestionJobArgs(GetAgentDataIngestionJobArgs $) {
    ...
    public static Builder builder(GetAgentDataIngestionJobArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAgentDataIngestionJobArgs();
        }

        public Builder(GetAgentDataIngestionJobArgs defaults) {
            $ = new GetAgentDataIngestionJobArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetAgentDataIngestionJobArgs build() {
            if ($.dataIngestionJobId == null) {
                throw new MissingRequiredPropertyException("GetAgentDataIngestionJobArgs", "dataIngestionJobId");
            }
            return $;
        }
    }
