...
import com.pulumi.oci.GenerativeAi.inputs.GetAgentDataIngestionJobsFilterArgs;
...
public final class GetAgentDataIngestionJobsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetAgentDataIngestionJobsArgs Empty = new GetAgentDataIngestionJobsArgs();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetAgentDataIngestionJobsFilterArgs>> filters;

    public Optional<Output<List<GetAgentDataIngestionJobsFilterArgs>>> filters() {
    ...
    private GetAgentDataIngestionJobsArgs() {}

    private GetAgentDataIngestionJobsArgs(GetAgentDataIngestionJobsArgs $) {
    ...
    public static Builder builder(GetAgentDataIngestionJobsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetAgentDataIngestionJobsArgs();
        }

        public Builder(GetAgentDataIngestionJobsArgs defaults) {
            $ = new GetAgentDataIngestionJobsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetAgentDataIngestionJobsFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetAgentDataIngestionJobsFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetAgentDataIngestionJobsFilterArgs... filters) {
        ...
        public GetAgentDataIngestionJobsArgs build() {
            return $;
        }
    }
