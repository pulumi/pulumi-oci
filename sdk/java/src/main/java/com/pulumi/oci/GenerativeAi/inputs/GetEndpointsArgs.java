...
import com.pulumi.oci.GenerativeAi.inputs.GetEndpointsFilterArgs;
...
public final class GetEndpointsArgs extends com.pulumi.resources.InvokeArgs {
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetEndpointsFilterArgs>> filters;

    public Optional<Output<List<GetEndpointsFilterArgs>>> filters() {
    ...
    public static final class Builder {
        ...
        public Builder filters(@Nullable Output<List<GetEndpointsFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetEndpointsFilterArgs> filters) {
        ...
        public GetEndpointsArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetEndpointsArgs", "compartmentId");
            }
            return $;
        }
    }
