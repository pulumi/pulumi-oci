...
import com.pulumi.oci.GenerativeAi.inputs.GetImportedModelsFilterArgs;
...
public final class GetImportedModelsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetImportedModelsArgs Empty = new GetImportedModelsArgs();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetImportedModelsFilterArgs>> filters;

    public Optional<Output<List<GetImportedModelsFilterArgs>>> filters() {
    ...
    private GetImportedModelsArgs() {}

    private GetImportedModelsArgs(GetImportedModelsArgs $) {
    ...
    public static Builder builder(GetImportedModelsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImportedModelsArgs();
        }

        public Builder(GetImportedModelsArgs defaults) {
            $ = new GetImportedModelsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetImportedModelsFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetImportedModelsFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetImportedModelsFilterArgs... filters) {
            return filters(List.of(filters));
        }

        /**
         * @param id The ID of the importedModel.
         * 
         * @return builder
         * 
         */
        ...
        public GetImportedModelsArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetImportedModelsArgs", "compartmentId");
            }
            return $;
        }
    }
