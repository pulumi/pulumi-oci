...
import com.pulumi.oci.GenerativeAi.inputs.GetImportedModelsFilter;
...
public final class GetImportedModelsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetImportedModelsPlainArgs Empty = new GetImportedModelsPlainArgs();
    ...
    @Import(name="filters")
    private @Nullable List<GetImportedModelsFilter> filters;

    public Optional<List<GetImportedModelsFilter>> filters() {
    ...
    private GetImportedModelsPlainArgs() {}

    private GetImportedModelsPlainArgs(GetImportedModelsPlainArgs $) {
    ...
    public static Builder builder(GetImportedModelsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetImportedModelsPlainArgs();
        }

        public Builder(GetImportedModelsPlainArgs defaults) {
            $ = new GetImportedModelsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable List<GetImportedModelsFilter> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(GetImportedModelsFilter... filters) {
        ...
        public GetImportedModelsPlainArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetImportedModelsPlainArgs", "compartmentId");
            }
            return $;
        }
    }
