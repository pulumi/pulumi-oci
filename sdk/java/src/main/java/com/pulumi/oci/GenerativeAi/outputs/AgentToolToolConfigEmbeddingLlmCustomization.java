...
import com.pulumi.oci.GenerativeAi.outputs.AgentToolToolConfigEmbeddingLlmCustomizationLlmSelection;
...
@CustomType
public final class AgentToolToolConfigEmbeddingLlmCustomization {
    /**
     ...
     * 
     */
    private @Nullable AgentToolToolConfigEmbeddingLlmCustomizationLlmSelection llmSelection;
     ...
     * 
     */
    public Optional<AgentToolToolConfigEmbeddingLlmCustomizationLlmSelection> llmSelection() {
    ...
    public static Builder builder(AgentToolToolConfigEmbeddingLlmCustomization defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable AgentToolToolConfigEmbeddingLlmCustomizationLlmSelection llmSelection;
        public Builder() {}
        public Builder(AgentToolToolConfigEmbeddingLlmCustomization defaults) {
        ...
        @CustomType.Setter
        public Builder llmSelection(@Nullable AgentToolToolConfigEmbeddingLlmCustomizationLlmSelection llmSelection) {

            this.llmSelection = llmSelection;
            return this;
        }
        public AgentToolToolConfigEmbeddingLlmCustomization build() {
            final var _resultValue = new AgentToolToolConfigEmbeddingLlmCustomization();
