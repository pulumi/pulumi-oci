...
import com.pulumi.oci.GenerativeAi.outputs.AgentToolToolConfigReasoningLlmCustomizationLlmSelection;
...
@CustomType
public final class AgentToolToolConfigReasoningLlmCustomization {
    /**
     ...
     * 
     */
    private @Nullable AgentToolToolConfigReasoningLlmCustomizationLlmSelection llmSelection;

    private AgentToolToolConfigReasoningLlmCustomization() {}
    /**
     * @return (Updatable) If specified, the default instruction is replaced with provided instruction.
     * 
     */
     ...
     * 
     */
    public Optional<AgentToolToolConfigReasoningLlmCustomizationLlmSelection> llmSelection() {
    ...
    public static Builder builder(AgentToolToolConfigReasoningLlmCustomization defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable AgentToolToolConfigReasoningLlmCustomizationLlmSelection llmSelection;
        public Builder() {}
        public Builder(AgentToolToolConfigReasoningLlmCustomization defaults) {
        ...
        @CustomType.Setter
        public Builder llmSelection(@Nullable AgentToolToolConfigReasoningLlmCustomizationLlmSelection llmSelection) {

            this.llmSelection = llmSelection;
            return this;
        }
        public AgentToolToolConfigReasoningLlmCustomization build() {
            final var _resultValue = new AgentToolToolConfigReasoningLlmCustomization();
