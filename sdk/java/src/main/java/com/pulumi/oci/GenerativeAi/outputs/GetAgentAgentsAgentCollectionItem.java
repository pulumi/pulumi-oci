...
@CustomType
public final class GetAgentAgentsAgentCollectionItem {
    /**
    ...
    private GetAgentAgentsAgentCollectionItem() {}
    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which to list resources.
     * 
     */
    ...
    public static Builder builder(GetAgentAgentsAgentCollectionItem defaults) {
    ...
    public static final class Builder {
        ...
        private String welcomeMessage;
        public Builder() {}
        public Builder(GetAgentAgentsAgentCollectionItem defaults) {
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetAgentAgentsAgentCollectionItem", "compartmentId");
            }
        ...
        public Builder definedTags(Map<String,String> definedTags) {
            if (definedTags == null) {
              throw new MissingRequiredPropertyException("GetAgentAgentsAgentCollectionItem", "definedTags");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetAgentAgentsAgentCollectionItem", "description");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetAgentAgentsAgentCollectionItem", "displayName");
            }
        ...
        public Builder freeformTags(Map<String,String> freeformTags) {
            if (freeformTags == null) {
              throw new MissingRequiredPropertyException("GetAgentAgentsAgentCollectionItem", "freeformTags");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetAgentAgentsAgentCollectionItem", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder knowledgeBaseIds(List<String> knowledgeBaseIds) {
            if (knowledgeBaseIds == null) {
              throw new MissingRequiredPropertyException("GetAgentAgentsAgentCollectionItem", "knowledgeBaseIds");
            }
        ...
        public Builder lifecycleDetails(String lifecycleDetails) {
            if (lifecycleDetails == null) {
              throw new MissingRequiredPropertyException("GetAgentAgentsAgentCollectionItem", "lifecycleDetails");
            }
        ...
        public Builder systemTags(Map<String,String> systemTags) {
            if (systemTags == null) {
              throw new MissingRequiredPropertyException("GetAgentAgentsAgentCollectionItem", "systemTags");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetAgentAgentsAgentCollectionItem", "timeCreated");
            }
        ...
        public Builder timeUpdated(String timeUpdated) {
            if (timeUpdated == null) {
              throw new MissingRequiredPropertyException("GetAgentAgentsAgentCollectionItem", "timeUpdated");
            }
        ...
        public Builder welcomeMessage(String welcomeMessage) {
            if (welcomeMessage == null) {
              throw new MissingRequiredPropertyException("GetAgentAgentsAgentCollectionItem", "welcomeMessage");
            }
            this.welcomeMessage = welcomeMessage;
            return this;
        }
        public GetAgentAgentsAgentCollectionItem build() {
            final var _resultValue = new GetAgentAgentsAgentCollectionItem();
