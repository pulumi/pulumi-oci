...
@CustomType
public final class GetAgentDataIngestionJobsDataIngestionJobCollectionItem {
    /**
    ...
    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DataIngestionJob.
     * 
     */
    private String id;
    ...
    private GetAgentDataIngestionJobsDataIngestionJobCollectionItem() {}
    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which to list resources.
     * 
     */
     ...
     * 
     */
    public List<GetAgentDataIngestionJobsDataIngestionJobCollectionItemDataIngestionJobStatistic> dataIngestionJobStatistics() {
    ...
    public static Builder builder(GetAgentDataIngestionJobsDataIngestionJobCollectionItem defaults) {
    ...
    public static final class Builder {
        ...
        private String timeUpdated;
        public Builder() {}
        public Builder(GetAgentDataIngestionJobsDataIngestionJobCollectionItem defaults) {
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetAgentDataIngestionJobsDataIngestionJobCollectionItem", "compartmentId");
            }
            this.compartmentId = compartmentId;
            return this;
        }
        @CustomType.Setter
        public Builder dataIngestionJobStatistics(List<GetAgentDataIngestionJobsDataIngestionJobCollectionItemDataIngestionJobStatistic> dataIngestionJobStatistics) {
            if (dataIngestionJobStatistics == null) {
              throw new MissingRequiredPropertyException("GetAgentDataIngestionJobsDataIngestionJobCollectionItem", "dataIngestionJobStatistics");
            }
        ...
        public Builder dataSourceId(String dataSourceId) {
            if (dataSourceId == null) {
              throw new MissingRequiredPropertyException("GetAgentDataIngestionJobsDataIngestionJobCollectionItem", "dataSourceId");
            }
        ...
        public Builder definedTags(Map<String,String> definedTags) {
            if (definedTags == null) {
              throw new MissingRequiredPropertyException("GetAgentDataIngestionJobsDataIngestionJobCollectionItem", "definedTags");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetAgentDataIngestionJobsDataIngestionJobCollectionItem", "description");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetAgentDataIngestionJobsDataIngestionJobCollectionItem", "displayName");
            }
        ...
        public Builder freeformTags(Map<String,String> freeformTags) {
            if (freeformTags == null) {
              throw new MissingRequiredPropertyException("GetAgentDataIngestionJobsDataIngestionJobCollectionItem", "freeformTags");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetAgentDataIngestionJobsDataIngestionJobCollectionItem", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetAgentDataIngestionJobsDataIngestionJobCollectionItem", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder systemTags(Map<String,String> systemTags) {
            if (systemTags == null) {
              throw new MissingRequiredPropertyException("GetAgentDataIngestionJobsDataIngestionJobCollectionItem", "systemTags");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetAgentDataIngestionJobsDataIngestionJobCollectionItem", "timeCreated");
            }
        ...
        public Builder timeUpdated(String timeUpdated) {
            if (timeUpdated == null) {
              throw new MissingRequiredPropertyException("GetAgentDataIngestionJobsDataIngestionJobCollectionItem", "timeUpdated");
            }
            this.timeUpdated = timeUpdated;
            return this;
        }
        public GetAgentDataIngestionJobsDataIngestionJobCollectionItem build() {
