...
@CustomType
public final class RoutingProfileRegionRoutingPolicy {
    /**
    ...
    private RoutingProfileRegionRoutingPolicy() {}
    /**
     * @return (Updatable) The ordered list of regions that routing is allowed to reach. Each entry is a region identifier (for example, `us-chicago-1`).
     * 
     * The order of entries is preserved. Duplicate entries are not allowed.
    ...
    public static Builder builder(RoutingProfileRegionRoutingPolicy defaults) {
    ...
    public static final class Builder {
        private @Nullable List<String> allowedRegions;
        public Builder() {}
        public Builder(RoutingProfileRegionRoutingPolicy defaults) {
        ...
        public RoutingProfileRegionRoutingPolicy build() {
            final var _resultValue = new RoutingProfileRegionRoutingPolicy();
