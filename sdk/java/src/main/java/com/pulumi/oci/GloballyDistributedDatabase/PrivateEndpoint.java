...
public class PrivateEndpoint extends com.pulumi.resources.CustomResource {
    ...
    public PrivateEndpoint(String name, PrivateEndpointArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:GloballyDistributedDatabase/privateEndpoint:PrivateEndpoint", name, args == null ? PrivateEndpointArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private PrivateEndpoint(String name, Output<String> id, @Nullable PrivateEndpointState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:GloballyDistributedDatabase/privateEndpoint:PrivateEndpoint", name, state, makeResourceOptions(options, id));
    }
