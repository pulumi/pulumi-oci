...
public class ShardedDatabase extends com.pulumi.resources.CustomResource {
    @Export(name="caSignedCertificate", refs={String.class}, tree="[0]")
    private Output</* @Nullable */ String> caSignedCertificate;

    public Output<Optional<String>> caSignedCertificate() {
        return Codegen.optional(this.caSignedCertificate);
    }
    /**
    ...
    private Output</* @Nullable */ Integer> configureGsmsTrigger;

    /**
     * @return (Updatable) An optional property when incremented triggers Configure Gsms. Could be set to any integer value.
     * 
     */
    public Output<Optional<Integer>> configureGsmsTrigger() {
        return Codegen.optional(this.configureGsmsTrigger);
    }
    @Export(name="configureGsmsTriggerIsLatestGsmImage", refs={Boolean.class}, tree="[0]")
    private Output</* @Nullable */ Boolean> configureGsmsTriggerIsLatestGsmImage;

    public Output<Optional<Boolean>> configureGsmsTriggerIsLatestGsmImage() {
        return Codegen.optional(this.configureGsmsTriggerIsLatestGsmImage);
    }
    @Export(name="configureGsmsTriggerOldGsmNames", refs={List.class,String.class}, tree="[0,1]")
    private Output</* @Nullable */ List<String>> configureGsmsTriggerOldGsmNames;

    public Output<Optional<List<String>>> configureGsmsTriggerOldGsmNames() {
        return Codegen.optional(this.configureGsmsTriggerOldGsmNames);
    }
    /**
    ...
    /**
     * @return The Replication method for sharded database.
     * 
     */
