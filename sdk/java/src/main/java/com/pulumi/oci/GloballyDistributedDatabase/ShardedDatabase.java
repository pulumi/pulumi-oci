...
public class ShardedDatabase extends com.pulumi.resources.CustomResource {
    ...
    public ShardedDatabase(String name, ShardedDatabaseArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:GloballyDistributedDatabase/shardedDatabase:ShardedDatabase", name, args == null ? ShardedDatabaseArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
