...
public final class ShardedDatabaseCatalogDetailArgs extends com.pulumi.resources.ResourceArgs {

    public static final ShardedDatabaseCatalogDetailArgs Empty = new ShardedDatabaseCatalogDetailArgs();
    ...
    /**
     * @return Admin password for the catalog database.
     * 
     */
    ...
    /**
     * @return The compute count for the catalog database. It has to be in multiple of 2.
     * 
     */
    ...
    private @Nullable Output<ShardedDatabaseCatalogDetailEncryptionKeyDetailsArgs> encryptionKeyDetails;
     ...
     * 
     */
    public Optional<Output<ShardedDatabaseCatalogDetailEncryptionKeyDetailsArgs>> encryptionKeyDetails() {
    ...
    private ShardedDatabaseCatalogDetailArgs(ShardedDatabaseCatalogDetailArgs $) {
    ...
    public static Builder builder(ShardedDatabaseCatalogDetailArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ShardedDatabaseCatalogDetailArgs();
        }

        public Builder(ShardedDatabaseCatalogDetailArgs defaults) {
            $ = new ShardedDatabaseCatalogDetailArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param adminPassword Admin password for the catalog database.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param computeCount The compute count for the catalog database. It has to be in multiple of 2.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder encryptionKeyDetails(@Nullable Output<ShardedDatabaseCatalogDetailEncryptionKeyDetailsArgs> encryptionKeyDetails) {
         ...
         * 
         */
        public Builder encryptionKeyDetails(ShardedDatabaseCatalogDetailEncryptionKeyDetailsArgs encryptionKeyDetails) {
        ...
        public ShardedDatabaseCatalogDetailArgs build() {
            if ($.adminPassword == null) {
                throw new MissingRequiredPropertyException("ShardedDatabaseCatalogDetailArgs", "adminPassword");
            }
            if ($.cloudAutonomousVmClusterId == null) {
                throw new MissingRequiredPropertyException("ShardedDatabaseCatalogDetailArgs", "cloudAutonomousVmClusterId");
            }
            if ($.computeCount == null) {
                throw new MissingRequiredPropertyException("ShardedDatabaseCatalogDetailArgs", "computeCount");
            }
            if ($.dataStorageSizeInGbs == null) {
                throw new MissingRequiredPropertyException("ShardedDatabaseCatalogDetailArgs", "dataStorageSizeInGbs");
            }
            if ($.isAutoScalingEnabled == null) {
                throw new MissingRequiredPropertyException("ShardedDatabaseCatalogDetailArgs", "isAutoScalingEnabled");
            }
            return $;
        }
    }
