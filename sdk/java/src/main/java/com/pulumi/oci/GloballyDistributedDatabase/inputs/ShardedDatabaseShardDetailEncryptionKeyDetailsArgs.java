...
public final class ShardedDatabaseShardDetailEncryptionKeyDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ShardedDatabaseShardDetailEncryptionKeyDetailsArgs Empty = new ShardedDatabaseShardDetailEncryptionKeyDetailsArgs();
    ...
    private ShardedDatabaseShardDetailEncryptionKeyDetailsArgs() {}

    private ShardedDatabaseShardDetailEncryptionKeyDetailsArgs(ShardedDatabaseShardDetailEncryptionKeyDetailsArgs $) {
    ...
    public static Builder builder(ShardedDatabaseShardDetailEncryptionKeyDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ShardedDatabaseShardDetailEncryptionKeyDetailsArgs();
        }

        public Builder(ShardedDatabaseShardDetailEncryptionKeyDetailsArgs defaults) {
            $ = new ShardedDatabaseShardDetailEncryptionKeyDetailsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ShardedDatabaseShardDetailEncryptionKeyDetailsArgs build() {
            if ($.kmsKeyId == null) {
                throw new MissingRequiredPropertyException("ShardedDatabaseShardDetailEncryptionKeyDetailsArgs", "kmsKeyId");
            }
            if ($.vaultId == null) {
                throw new MissingRequiredPropertyException("ShardedDatabaseShardDetailEncryptionKeyDetailsArgs", "vaultId");
            }
            return $;
        }
    }
