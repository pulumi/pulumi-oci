...
public final class ShardedDatabaseState extends com.pulumi.resources.ResourceArgs {
    ...
    @Import(name="caSignedCertificate")
    private @Nullable Output<String> caSignedCertificate;

    public Optional<Output<String>> caSignedCertificate() {
        return Optional.ofNullable(this.caSignedCertificate);
    }
    ...
    @Import(name="configureGsmsTriggerIsLatestGsmImage")
    private @Nullable Output<Boolean> configureGsmsTriggerIsLatestGsmImage;

    public Optional<Output<Boolean>> configureGsmsTriggerIsLatestGsmImage() {
        return Optional.ofNullable(this.configureGsmsTriggerIsLatestGsmImage);
    }

    @Import(name="configureGsmsTriggerOldGsmNames")
    private @Nullable Output<List<String>> configureGsmsTriggerOldGsmNames;

    public Optional<Output<List<String>>> configureGsmsTriggerOldGsmNames() {
        return Optional.ofNullable(this.configureGsmsTriggerOldGsmNames);
    }
    ...
    public static final class Builder {
        ...
        public Builder caSignedCertificate(@Nullable Output<String> caSignedCertificate) {
            $.caSignedCertificate = caSignedCertificate;
            return this;
        }

        public Builder caSignedCertificate(String caSignedCertificate) {
            return caSignedCertificate(Output.of(caSignedCertificate));
        }
        ...
        public Builder configureGsmsTriggerIsLatestGsmImage(@Nullable Output<Boolean> configureGsmsTriggerIsLatestGsmImage) {
        ...
        public Builder configureGsmsTriggerIsLatestGsmImage(Boolean configureGsmsTriggerIsLatestGsmImage) {
            return configureGsmsTriggerIsLatestGsmImage(Output.of(configureGsmsTriggerIsLatestGsmImage));
        }

        public Builder configureGsmsTriggerOldGsmNames(@Nullable Output<List<String>> configureGsmsTriggerOldGsmNames) {
        ...
        public Builder configureGsmsTriggerOldGsmNames(List<String> configureGsmsTriggerOldGsmNames) {
            return configureGsmsTriggerOldGsmNames(Output.of(configureGsmsTriggerOldGsmNames));
        }
        ...
        /**
         * @param replicationFactor The Replication factor for RAFT replication based sharded database. Currently supported values are 3, 5 and 7.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param replicationMethod The Replication method for sharded database.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param replicationUnit For RAFT replication based sharded database, the value should be atleast twice the number of shards.
         * 
         * @return builder
         * 
         */
