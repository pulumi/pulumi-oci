...
@CustomType
public final class ShardedDatabaseCatalogDetailEncryptionKeyDetails {
    /**
    ...
    public static Builder builder(ShardedDatabaseCatalogDetailEncryptionKeyDetails defaults) {
    ...
    public static final class Builder {
        ...
        private String vaultId;
        public Builder() {}
        public Builder(ShardedDatabaseCatalogDetailEncryptionKeyDetails defaults) {
        ...
        public Builder kmsKeyId(String kmsKeyId) {
            if (kmsKeyId == null) {
              throw new MissingRequiredPropertyException("ShardedDatabaseCatalogDetailEncryptionKeyDetails", "kmsKeyId");
            }
        ...
        public Builder vaultId(String vaultId) {
            if (vaultId == null) {
              throw new MissingRequiredPropertyException("ShardedDatabaseCatalogDetailEncryptionKeyDetails", "vaultId");
            }
            this.vaultId = vaultId;
            return this;
        }
        public ShardedDatabaseCatalogDetailEncryptionKeyDetails build() {
            final var _resultValue = new ShardedDatabaseCatalogDetailEncryptionKeyDetails();
