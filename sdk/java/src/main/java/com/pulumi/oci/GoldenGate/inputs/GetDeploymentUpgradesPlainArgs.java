...
public final class GetDeploymentUpgradesPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param state A filter to return only the deployment upgrades having the &#39;lifecycleState&#39; given.
         * 
         * @return builder
         * 
         */
        ...
        public GetDeploymentUpgradesPlainArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetDeploymentUpgradesPlainArgs", "compartmentId");
            }
            return $;
        }
    }
