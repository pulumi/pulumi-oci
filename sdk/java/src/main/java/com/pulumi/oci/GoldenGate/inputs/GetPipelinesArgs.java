...
import com.pulumi.oci.GoldenGate.inputs.GetPipelinesFilterArgs;
...
public final class GetPipelinesArgs extends com.pulumi.resources.InvokeArgs {
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetPipelinesFilterArgs>> filters;

    public Optional<Output<List<GetPipelinesFilterArgs>>> filters() {
    ...
    public static final class Builder {
        ...
        public Builder filters(@Nullable Output<List<GetPipelinesFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetPipelinesFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetPipelinesFilterArgs... filters) {
        ...
        public GetPipelinesArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetPipelinesArgs", "compartmentId");
            }
            return $;
        }
    }
