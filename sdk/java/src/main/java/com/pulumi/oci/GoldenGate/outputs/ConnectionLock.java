...
public final class ConnectionLock {
    ...
    public static Builder builder(ConnectionLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(ConnectionLock defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("ConnectionLock", "type");
            }
            this.type = type;
            return this;
        }
        public ConnectionLock build() {
            final var _resultValue = new ConnectionLock();
