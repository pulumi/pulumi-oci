...
public final class DeploymentLock {
    ...
    public static Builder builder(DeploymentLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(DeploymentLock defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("DeploymentLock", "type");
            }
            this.type = type;
            return this;
        }
        public DeploymentLock build() {
            final var _resultValue = new DeploymentLock();
