...
public final class GetConnectionAssignmentResult {
    ...
    public static final class Builder {
        ...
        public Builder aliasName(String aliasName) {
            if (aliasName == null) {
              throw new MissingRequiredPropertyException("GetConnectionAssignmentResult", "aliasName");
            }
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetConnectionAssignmentResult", "compartmentId");
            }
        ...
        public Builder connectionAssignmentId(String connectionAssignmentId) {
            if (connectionAssignmentId == null) {
              throw new MissingRequiredPropertyException("GetConnectionAssignmentResult", "connectionAssignmentId");
            }
        ...
        public Builder deploymentId(String deploymentId) {
            if (deploymentId == null) {
              throw new MissingRequiredPropertyException("GetConnectionAssignmentResult", "deploymentId");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetConnectionAssignmentResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetConnectionAssignmentResult", "timeCreated");
            }
        ...
        public Builder timeUpdated(String timeUpdated) {
            if (timeUpdated == null) {
              throw new MissingRequiredPropertyException("GetConnectionAssignmentResult", "timeUpdated");
            }
