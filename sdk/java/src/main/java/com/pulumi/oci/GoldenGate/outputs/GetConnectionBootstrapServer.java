...
public final class GetConnectionBootstrapServer {
    ...
    public static Builder builder(GetConnectionBootstrapServer defaults) {
    ...
    public static final class Builder {
        ...
        public Builder host(String host) {
            if (host == null) {
              throw new MissingRequiredPropertyException("GetConnectionBootstrapServer", "host");
            }
            this.host = host;
            return this;
        }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetConnectionBootstrapServer", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder privateIp(String privateIp) {
            if (privateIp == null) {
              throw new MissingRequiredPropertyException("GetConnectionBootstrapServer", "privateIp");
            }
            this.privateIp = privateIp;
            return this;
        }
        public GetConnectionBootstrapServer build() {
            final var _resultValue = new GetConnectionBootstrapServer();
