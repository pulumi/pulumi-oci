    ...
    public static final class Builder {
        ...
        public Builder clientSecret(String clientSecret) {
            if (clientSecret == null) {
              throw new MissingRequiredPropertyException("GetConnectionCatalog", "clientSecret");
            }
        ...
        public Builder properties(String properties) {
            if (properties == null) {
              throw new MissingRequiredPropertyException("GetConnectionCatalog", "properties");
            }
