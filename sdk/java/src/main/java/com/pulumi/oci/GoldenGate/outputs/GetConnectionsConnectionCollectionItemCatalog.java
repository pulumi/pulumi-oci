...
@CustomType
public final class GetConnectionsConnectionCollectionItemCatalog {
    /**
    ...
    private GetConnectionsConnectionCollectionItemCatalog() {}
    /**
     * @return The active branch of the Nessie catalog from which Iceberg reads and writes table metadata.
     * 
     */
    ...
    public static Builder builder(GetConnectionsConnectionCollectionItemCatalog defaults) {
    ...
    public static final class Builder {
        ...
        private String uri;
        public Builder() {}
        public Builder(GetConnectionsConnectionCollectionItemCatalog defaults) {
        ...
        public Builder branch(String branch) {
            if (branch == null) {
              throw new MissingRequiredPropertyException("GetConnectionsConnectionCollectionItemCatalog", "branch");
            }
            this.branch = branch;
            return this;
        }
        ...
        public Builder catalogType(String catalogType) {
            if (catalogType == null) {
              throw new MissingRequiredPropertyException("GetConnectionsConnectionCollectionItemCatalog", "catalogType");
            }
        ...
        public Builder clientSecretSecretId(String clientSecretSecretId) {
            if (clientSecretSecretId == null) {
              throw new MissingRequiredPropertyException("GetConnectionsConnectionCollectionItemCatalog", "clientSecretSecretId");
            }
        ...
        public Builder glueId(String glueId) {
            if (glueId == null) {
              throw new MissingRequiredPropertyException("GetConnectionsConnectionCollectionItemCatalog", "glueId");
            }
            this.glueId = glueId;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetConnectionsConnectionCollectionItemCatalog", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder principalRole(String principalRole) {
            if (principalRole == null) {
              throw new MissingRequiredPropertyException("GetConnectionsConnectionCollectionItemCatalog", "principalRole");
            }
        ...
        public Builder uri(String uri) {
            if (uri == null) {
              throw new MissingRequiredPropertyException("GetConnectionsConnectionCollectionItemCatalog", "uri");
            }
            this.uri = uri;
            return this;
        }
        public GetConnectionsConnectionCollectionItemCatalog build() {
            final var _resultValue = new GetConnectionsConnectionCollectionItemCatalog();
