...
@CustomType
public final class GetConnectionsConnectionCollectionItemStorage {
    /**
    ...
    private GetConnectionsConnectionCollectionItemStorage() {}
    /**
     * @return Access key ID to access the Amazon S3 bucket.
     * 
     */
    ...
    public static Builder builder(GetConnectionsConnectionCollectionItemStorage defaults) {
    ...
    public static final class Builder {
        ...
        public Builder accountKeySecretId(String accountKeySecretId) {
            if (accountKeySecretId == null) {
              throw new MissingRequiredPropertyException("GetConnectionsConnectionCollectionItemStorage", "accountKeySecretId");
            }
        ...
        public Builder accountName(String accountName) {
            if (accountName == null) {
              throw new MissingRequiredPropertyException("GetConnectionsConnectionCollectionItemStorage", "accountName");
            }
        ...
        public Builder bucket(String bucket) {
            if (bucket == null) {
              throw new MissingRequiredPropertyException("GetConnectionsConnectionCollectionItemStorage", "bucket");
            }
            this.bucket = bucket;
            return this;
        }
        ...
        public Builder container(String container) {
            if (container == null) {
              throw new MissingRequiredPropertyException("GetConnectionsConnectionCollectionItemStorage", "container");
            }
        ...
        public Builder endpoint(String endpoint) {
            if (endpoint == null) {
              throw new MissingRequiredPropertyException("GetConnectionsConnectionCollectionItemStorage", "endpoint");
            }
        ...
        public Builder projectId(String projectId) {
            if (projectId == null) {
              throw new MissingRequiredPropertyException("GetConnectionsConnectionCollectionItemStorage", "projectId");
            }
        ...
        public Builder region(String region) {
            if (region == null) {
              throw new MissingRequiredPropertyException("GetConnectionsConnectionCollectionItemStorage", "region");
            }
            this.region = region;
            return this;
        }
        ...
        public Builder schemeType(String schemeType) {
            if (schemeType == null) {
              throw new MissingRequiredPropertyException("GetConnectionsConnectionCollectionItemStorage", "schemeType");
            }
        ...
        public Builder serviceAccountKeyFileSecretId(String serviceAccountKeyFileSecretId) {
            if (serviceAccountKeyFileSecretId == null) {
              throw new MissingRequiredPropertyException("GetConnectionsConnectionCollectionItemStorage", "serviceAccountKeyFileSecretId");
            }
        ...
        public Builder storageType(String storageType) {
            if (storageType == null) {
              throw new MissingRequiredPropertyException("GetConnectionsConnectionCollectionItemStorage", "storageType");
            }
