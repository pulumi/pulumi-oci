...
@CustomType
public final class GetDeploymentBackupLock {
    /**
    ...
    private GetDeploymentBackupLock() {}
    /**
     * @return A message added by the creator of the lock. This is typically used to give an indication of why the resource is locked.
     * 
     */
    ...
    public static Builder builder(GetDeploymentBackupLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetDeploymentBackupLock defaults) {
        ...
        public Builder message(String message) {
            if (message == null) {
              throw new MissingRequiredPropertyException("GetDeploymentBackupLock", "message");
            }
        ...
        public Builder relatedResourceId(String relatedResourceId) {
            if (relatedResourceId == null) {
              throw new MissingRequiredPropertyException("GetDeploymentBackupLock", "relatedResourceId");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetDeploymentBackupLock", "timeCreated");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetDeploymentBackupLock", "type");
            }
            this.type = type;
            return this;
        }
        public GetDeploymentBackupLock build() {
            final var _resultValue = new GetDeploymentBackupLock();
