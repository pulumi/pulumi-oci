...
@CustomType
public final class GetDeploymentDeploymentDiagnosticData {
    /**
    ...
    private GetDeploymentDeploymentDiagnosticData() {}
    /**
     * @return Name of the bucket where the object is to be uploaded in the object storage
     * 
     */
    ...
    public static Builder builder(GetDeploymentDeploymentDiagnosticData defaults) {
    ...
    public static final class Builder {
        ...
        private String timeDiagnosticStart;
        public Builder() {}
        public Builder(GetDeploymentDeploymentDiagnosticData defaults) {
        ...
        public Builder bucket(String bucket) {
            if (bucket == null) {
              throw new MissingRequiredPropertyException("GetDeploymentDeploymentDiagnosticData", "bucket");
            }
            this.bucket = bucket;
            return this;
        }
        ...
        public Builder diagnosticState(String diagnosticState) {
            if (diagnosticState == null) {
              throw new MissingRequiredPropertyException("GetDeploymentDeploymentDiagnosticData", "diagnosticState");
            }
        ...
        public Builder namespace(String namespace) {
            if (namespace == null) {
              throw new MissingRequiredPropertyException("GetDeploymentDeploymentDiagnosticData", "namespace");
            }
        ...
        public Builder object(String object) {
            if (object == null) {
              throw new MissingRequiredPropertyException("GetDeploymentDeploymentDiagnosticData", "object");
            }
            this.object = object;
            return this;
        }
        ...
        public Builder timeDiagnosticEnd(String timeDiagnosticEnd) {
            if (timeDiagnosticEnd == null) {
              throw new MissingRequiredPropertyException("GetDeploymentDeploymentDiagnosticData", "timeDiagnosticEnd");
            }
        ...
        public Builder timeDiagnosticStart(String timeDiagnosticStart) {
            if (timeDiagnosticStart == null) {
              throw new MissingRequiredPropertyException("GetDeploymentDeploymentDiagnosticData", "timeDiagnosticStart");
            }
            this.timeDiagnosticStart = timeDiagnosticStart;
            return this;
        }
        public GetDeploymentDeploymentDiagnosticData build() {
            final var _resultValue = new GetDeploymentDeploymentDiagnosticData();
