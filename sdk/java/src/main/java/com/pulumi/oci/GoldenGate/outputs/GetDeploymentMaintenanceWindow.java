...
public final class GetDeploymentMaintenanceWindow {
    ...
    public static final class Builder {
        ...
        public Builder day(String day) {
            if (day == null) {
              throw new MissingRequiredPropertyException("GetDeploymentMaintenanceWindow", "day");
            }
            this.day = day;
            return this;
        }
        ...
        public Builder startHour(Integer startHour) {
            if (startHour == null) {
              throw new MissingRequiredPropertyException("GetDeploymentMaintenanceWindow", "startHour");
            }
