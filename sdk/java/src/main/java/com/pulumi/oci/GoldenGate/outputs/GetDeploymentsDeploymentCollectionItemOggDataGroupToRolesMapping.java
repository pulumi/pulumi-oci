...
@CustomType
public final class GetDeploymentsDeploymentCollectionItemOggDataGroupToRolesMapping {
    /**
    ...
    private GetDeploymentsDeploymentCollectionItemOggDataGroupToRolesMapping() {}
    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the IDP group which will be mapped to goldengate role administratorGroup. It grants full access to the user, including the ability to alter general, non-security related operational parameters and profiles of the server.
     * 
     */
    ...
    public static Builder builder(GetDeploymentsDeploymentCollectionItemOggDataGroupToRolesMapping defaults) {
    ...
    public static final class Builder {
        ...
        private String userGroupId;
        public Builder() {}
        public Builder(GetDeploymentsDeploymentCollectionItemOggDataGroupToRolesMapping defaults) {
        ...
        public Builder administratorGroupId(String administratorGroupId) {
            if (administratorGroupId == null) {
              throw new MissingRequiredPropertyException("GetDeploymentsDeploymentCollectionItemOggDataGroupToRolesMapping", "administratorGroupId");
            }
        ...
        public Builder operatorGroupId(String operatorGroupId) {
            if (operatorGroupId == null) {
              throw new MissingRequiredPropertyException("GetDeploymentsDeploymentCollectionItemOggDataGroupToRolesMapping", "operatorGroupId");
            }
        ...
        public Builder securityGroupId(String securityGroupId) {
            if (securityGroupId == null) {
              throw new MissingRequiredPropertyException("GetDeploymentsDeploymentCollectionItemOggDataGroupToRolesMapping", "securityGroupId");
            }
        ...
        public Builder userGroupId(String userGroupId) {
            if (userGroupId == null) {
              throw new MissingRequiredPropertyException("GetDeploymentsDeploymentCollectionItemOggDataGroupToRolesMapping", "userGroupId");
            }
            this.userGroupId = userGroupId;
            return this;
        }
        public GetDeploymentsDeploymentCollectionItemOggDataGroupToRolesMapping build() {
            final var _resultValue = new GetDeploymentsDeploymentCollectionItemOggDataGroupToRolesMapping();
