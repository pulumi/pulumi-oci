...
@CustomType
public final class GetPipelineProcessOptionReplicateSchemaChange {
    /**
    ...
    private GetPipelineProcessOptionReplicateSchemaChange() {}
    /**
     * @return Action upon DDL Error (active only if &#39;Replicate schema changes (DDL)&#39; is selected) i.e canReplicateSchemaChange=true
     * 
     */
    ...
    public static Builder builder(GetPipelineProcessOptionReplicateSchemaChange defaults) {
    ...
    public static final class Builder {
        ...
        private String canReplicateSchemaChange;
        public Builder() {}
        public Builder(GetPipelineProcessOptionReplicateSchemaChange defaults) {
        ...
        public Builder actionOnDdlError(String actionOnDdlError) {
            if (actionOnDdlError == null) {
              throw new MissingRequiredPropertyException("GetPipelineProcessOptionReplicateSchemaChange", "actionOnDdlError");
            }
        ...
        public Builder actionOnDmlError(String actionOnDmlError) {
            if (actionOnDmlError == null) {
              throw new MissingRequiredPropertyException("GetPipelineProcessOptionReplicateSchemaChange", "actionOnDmlError");
            }
        ...
        public Builder canReplicateSchemaChange(String canReplicateSchemaChange) {
            if (canReplicateSchemaChange == null) {
              throw new MissingRequiredPropertyException("GetPipelineProcessOptionReplicateSchemaChange", "canReplicateSchemaChange");
            }
            this.canReplicateSchemaChange = canReplicateSchemaChange;
            return this;
        }
        public GetPipelineProcessOptionReplicateSchemaChange build() {
            final var _resultValue = new GetPipelineProcessOptionReplicateSchemaChange();
