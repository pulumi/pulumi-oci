...
@CustomType
public final class GetTrailSequencesTrailSequenceCollectionItem {
    /**
    ...
    private GetTrailSequencesTrailSequenceCollectionItem() {}
    /**
     * @return A filter to return only the resources that match the entire &#39;displayName&#39; given.
     * 
     */
    ...
    public static Builder builder(GetTrailSequencesTrailSequenceCollectionItem defaults) {
    ...
    public static final class Builder {
        ...
        private String timeLastUpdated;
        public Builder() {}
        public Builder(GetTrailSequencesTrailSequenceCollectionItem defaults) {
