...
@CustomType
public final class PipelineIngressIp {
    /**
    ...
    public static Builder builder(PipelineIngressIp defaults) {
    ...
    public static final class Builder {
        private @Nullable String ingressIp;
        public Builder() {}
        public Builder(PipelineIngressIp defaults) {
        ...
        public PipelineIngressIp build() {
            final var _resultValue = new PipelineIngressIp();
