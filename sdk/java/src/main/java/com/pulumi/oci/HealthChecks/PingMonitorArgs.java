    ...
    public static final class Builder {
        ...
        public PingMonitorArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("PingMonitorArgs", "compartmentId");
            }
            if ($.displayName == null) {
                throw new MissingRequiredPropertyException("PingMonitorArgs", "displayName");
            }
            if ($.intervalInSeconds == null) {
                throw new MissingRequiredPropertyException("PingMonitorArgs", "intervalInSeconds");
            }
            if ($.protocol == null) {
                throw new MissingRequiredPropertyException("PingMonitorArgs", "protocol");
            }
            if ($.targets == null) {
                throw new MissingRequiredPropertyException("PingMonitorArgs", "targets");
            }
            return $;
        }
    }
