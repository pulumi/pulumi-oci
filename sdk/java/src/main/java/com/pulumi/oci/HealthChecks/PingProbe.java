...
public class PingProbe extends com.pulumi.resources.CustomResource {
     ...
     */
    public PingProbe(java.lang.String name) {
     ...
     */
    public PingProbe(java.lang.String name, PingProbeArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public PingProbe(java.lang.String name, PingProbeArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:HealthChecks/pingProbe:PingProbe", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private PingProbe(java.lang.String name, Output<java.lang.String> id, @Nullable PingProbeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:HealthChecks/pingProbe:PingProbe", name, state, makeResourceOptions(options, id), false);
    }

    private static PingProbeArgs makeArgs(PingProbeArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? PingProbeArgs.Empty : args;
    }
     ...
     */
    public static PingProbe get(java.lang.String name, Output<java.lang.String> id, @Nullable PingProbeState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
