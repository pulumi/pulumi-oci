...
public class DomainsApiKey extends com.pulumi.resources.CustomResource {
     ...
     */
    public DomainsApiKey(java.lang.String name) {
     ...
     */
    public DomainsApiKey(java.lang.String name, DomainsApiKeyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DomainsApiKey(java.lang.String name, DomainsApiKeyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Identity/domainsApiKey:DomainsApiKey", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DomainsApiKey(java.lang.String name, Output<java.lang.String> id, @Nullable DomainsApiKeyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Identity/domainsApiKey:DomainsApiKey", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static DomainsApiKey get(java.lang.String name, Output<java.lang.String> id, @Nullable DomainsApiKeyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
