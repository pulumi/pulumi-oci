...
public class DomainsApprovalWorkflow extends com.pulumi.resources.CustomResource {
     ...
     */
    public DomainsApprovalWorkflow(java.lang.String name) {
     ...
     */
    public DomainsApprovalWorkflow(java.lang.String name, DomainsApprovalWorkflowArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DomainsApprovalWorkflow(java.lang.String name, DomainsApprovalWorkflowArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Identity/domainsApprovalWorkflow:DomainsApprovalWorkflow", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DomainsApprovalWorkflow(java.lang.String name, Output<java.lang.String> id, @Nullable DomainsApprovalWorkflowState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Identity/domainsApprovalWorkflow:DomainsApprovalWorkflow", name, state, makeResourceOptions(options, id), false);
    }

    private static DomainsApprovalWorkflowArgs makeArgs(DomainsApprovalWorkflowArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? DomainsApprovalWorkflowArgs.Empty : args;
    }
     ...
     */
    public static DomainsApprovalWorkflow get(java.lang.String name, Output<java.lang.String> id, @Nullable DomainsApprovalWorkflowState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
