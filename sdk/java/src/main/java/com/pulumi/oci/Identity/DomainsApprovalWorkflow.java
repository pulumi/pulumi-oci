...
import com.pulumi.oci.Identity.inputs.DomainsApprovalWorkflowState;
import com.pulumi.oci.Identity.outputs.DomainsApprovalWorkflowApprovalWorkflowStep;
import com.pulumi.oci.Identity.outputs.DomainsApprovalWorkflowIdcsCreatedBy;
import com.pulumi.oci.Identity.outputs.DomainsApprovalWorkflowIdcsLastModifiedBy;
import com.pulumi.oci.Identity.outputs.DomainsApprovalWorkflowMaxDuration;
import com.pulumi.oci.Identity.outputs.DomainsApprovalWorkflowMeta;
import com.pulumi.oci.Identity.outputs.DomainsApprovalWorkflowTag;
 ...
 *                 .unit(var_.approval_workflow_max_duration_unit())
 *                 .value(var_.approval_workflow_max_duration_value())
 *                 .build())
 ...
 *                 .type(var_.approval_workflow_approval_workflow_steps_type())
 *                 .value(var_.approval_workflow_approval_workflow_steps_value())
 *                 .ocid(var_.approval_workflow_approval_workflow_steps_ocid())
 *                 .build())
 *             .attributeSets(&#34;all&#34;)
 *             .attributes(&#34;&#34;)
 *             .authorization(var_.approval_workflow_authorization())
 *             .description(var_.approval_workflow_description())
 *             .id(var_.approval_workflow_id())
 *             .ocid(var_.approval_workflow_ocid())
 *             .resourceTypeSchemaVersion(var_.approval_workflow_resource_type_schema_version())
 *             .tags(DomainsApprovalWorkflowTagArgs.builder()
 *                 .key(var_.approval_workflow_tags_key())
 *                 .value(var_.approval_workflow_tags_value())
 *                 .build())
 *             .build());
 * 
 *     }
 ...
 * 
 */
@ResourceType(type="oci:Identity/domainsApprovalWorkflow:DomainsApprovalWorkflow")
public class DomainsApprovalWorkflow extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="approvalWorkflowSteps", refs={List.class,DomainsApprovalWorkflowApprovalWorkflowStep.class}, tree="[0,1]")
    private Output<List<DomainsApprovalWorkflowApprovalWorkflowStep>> approvalWorkflowSteps;
     ...
     * 
     */
    public Output<List<DomainsApprovalWorkflowApprovalWorkflowStep>> approvalWorkflowSteps() {
     ...
     * 
     */
    @Export(name="idcsCreatedBies", refs={List.class,DomainsApprovalWorkflowIdcsCreatedBy.class}, tree="[0,1]")
    private Output<List<DomainsApprovalWorkflowIdcsCreatedBy>> idcsCreatedBies;
     ...
     * 
     */
    public Output<List<DomainsApprovalWorkflowIdcsCreatedBy>> idcsCreatedBies() {
     ...
     * 
     */
    @Export(name="idcsLastModifiedBies", refs={List.class,DomainsApprovalWorkflowIdcsLastModifiedBy.class}, tree="[0,1]")
    private Output<List<DomainsApprovalWorkflowIdcsLastModifiedBy>> idcsLastModifiedBies;
     ...
     * 
     */
    public Output<List<DomainsApprovalWorkflowIdcsLastModifiedBy>> idcsLastModifiedBies() {
     ...
     * 
     */
    @Export(name="maxDuration", refs={DomainsApprovalWorkflowMaxDuration.class}, tree="[0]")
    private Output<DomainsApprovalWorkflowMaxDuration> maxDuration;
     ...
     * 
     */
    public Output<DomainsApprovalWorkflowMaxDuration> maxDuration() {
     ...
     * 
     */
    @Export(name="metas", refs={List.class,DomainsApprovalWorkflowMeta.class}, tree="[0,1]")
    private Output<List<DomainsApprovalWorkflowMeta>> metas;
     ...
     * 
     */
    public Output<List<DomainsApprovalWorkflowMeta>> metas() {
        return this.metas;
    }
    /**
     ...
     * 
     */
    @Export(name="tags", refs={List.class,DomainsApprovalWorkflowTag.class}, tree="[0,1]")
    private Output<List<DomainsApprovalWorkflowTag>> tags;
     ...
     * 
     */
    public Output<List<DomainsApprovalWorkflowTag>> tags() {
        return this.tags;
    }
    /**
     ...
     */
    public DomainsApprovalWorkflow(String name) {
        this(name, DomainsApprovalWorkflowArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public DomainsApprovalWorkflow(String name, DomainsApprovalWorkflowArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DomainsApprovalWorkflow(String name, DomainsApprovalWorkflowArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Identity/domainsApprovalWorkflow:DomainsApprovalWorkflow", name, args == null ? DomainsApprovalWorkflowArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DomainsApprovalWorkflow(String name, Output<String> id, @Nullable DomainsApprovalWorkflowState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Identity/domainsApprovalWorkflow:DomainsApprovalWorkflow", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static DomainsApprovalWorkflow get(String name, Output<String> id, @Nullable DomainsApprovalWorkflowState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
