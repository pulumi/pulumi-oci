...
import com.pulumi.oci.Identity.inputs.DomainsApprovalWorkflowStepState;
import com.pulumi.oci.Identity.outputs.DomainsApprovalWorkflowStepApprover;
import com.pulumi.oci.Identity.outputs.DomainsApprovalWorkflowStepIdcsCreatedBy;
import com.pulumi.oci.Identity.outputs.DomainsApprovalWorkflowStepIdcsLastModifiedBy;
import com.pulumi.oci.Identity.outputs.DomainsApprovalWorkflowStepMeta;
import com.pulumi.oci.Identity.outputs.DomainsApprovalWorkflowStepTag;
 ...
 *             .order(var_.approval_workflow_step_order())
 *             .schemas(&#34;urn:ietf:params:scim:schemas:oracle:idcs:ApprovalWorkflowStep&#34;)
 *             .type(var_.approval_workflow_step_type())
 *             .approvers(DomainsApprovalWorkflowStepApproverArgs.builder()
 *                 .type(var_.approval_workflow_step_approvers_type())
 *                 .value(var_.approval_workflow_step_approvers_value())
 *                 .ocid(var_.approval_workflow_step_approvers_ocid())
 *                 .build())
 *             .approversExpressions(var_.approval_workflow_step_approvers_expressions())
 *             .attributeSets(&#34;all&#34;)
 *             .attributes(&#34;&#34;)
 *             .authorization(var_.approval_workflow_step_authorization())
 *             .id(var_.approval_workflow_step_id())
 *             .minimumApprovals(var_.approval_workflow_step_minimum_approvals())
 *             .ocid(var_.approval_workflow_step_ocid())
 ...
 *                 .key(var_.approval_workflow_step_tags_key())
 *                 .value(var_.approval_workflow_step_tags_value())
 *                 .build())
 *             .build());
 * 
 *     }
 ...
 * 
 */
@ResourceType(type="oci:Identity/domainsApprovalWorkflowStep:DomainsApprovalWorkflowStep")
public class DomainsApprovalWorkflowStep extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="approvers", refs={List.class,DomainsApprovalWorkflowStepApprover.class}, tree="[0,1]")
    private Output<List<DomainsApprovalWorkflowStepApprover>> approvers;
     ...
     * 
     */
    public Output<List<DomainsApprovalWorkflowStepApprover>> approvers() {
     ...
     * 
     */
    @Export(name="approversExpressions", refs={List.class,String.class}, tree="[0,1]")
    private Output<List<String>> approversExpressions;
     ...
     * 
     */
    public Output<List<String>> approversExpressions() {
     ...
     * 
     */
    @Export(name="idcsCreatedBies", refs={List.class,DomainsApprovalWorkflowStepIdcsCreatedBy.class}, tree="[0,1]")
    private Output<List<DomainsApprovalWorkflowStepIdcsCreatedBy>> idcsCreatedBies;
     ...
     * 
     */
    public Output<List<DomainsApprovalWorkflowStepIdcsCreatedBy>> idcsCreatedBies() {
     ...
     * 
     */
    @Export(name="idcsLastModifiedBies", refs={List.class,DomainsApprovalWorkflowStepIdcsLastModifiedBy.class}, tree="[0,1]")
    private Output<List<DomainsApprovalWorkflowStepIdcsLastModifiedBy>> idcsLastModifiedBies;
     ...
     * 
     */
    public Output<List<DomainsApprovalWorkflowStepIdcsLastModifiedBy>> idcsLastModifiedBies() {
     ...
     * 
     */
    @Export(name="metas", refs={List.class,DomainsApprovalWorkflowStepMeta.class}, tree="[0,1]")
    private Output<List<DomainsApprovalWorkflowStepMeta>> metas;
     ...
     * 
     */
    public Output<List<DomainsApprovalWorkflowStepMeta>> metas() {
        return this.metas;
    }
    /**
     ...
     * 
     */
    @Export(name="minimumApprovals", refs={Integer.class}, tree="[0]")
     ...
     * 
     */
    @Export(name="tags", refs={List.class,DomainsApprovalWorkflowStepTag.class}, tree="[0,1]")
    private Output<List<DomainsApprovalWorkflowStepTag>> tags;
     ...
     * 
     */
    public Output<List<DomainsApprovalWorkflowStepTag>> tags() {
        return this.tags;
    }
    /**
    ...
    public DomainsApprovalWorkflowStep(String name, DomainsApprovalWorkflowStepArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Identity/domainsApprovalWorkflowStep:DomainsApprovalWorkflowStep", name, args == null ? DomainsApprovalWorkflowStepArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
