...
public class DomainsAuthToken extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="idcsCreatedBies", type=List.class, parameters={DomainsAuthTokenIdcsCreatedBy.class})
     ...
     * 
     */
    @Export(name="idcsLastModifiedBies", type=List.class, parameters={DomainsAuthTokenIdcsLastModifiedBy.class})
     ...
     * 
     */
    @Export(name="metas", type=List.class, parameters={DomainsAuthTokenMeta.class})
     ...
     * 
     */
    @Export(name="tags", type=List.class, parameters={DomainsAuthTokenTag.class})
     ...
     * 
     */
    @Export(name="urnietfparamsscimschemasoracleidcsextensionselfChangeUser", type=DomainsAuthTokenUrnietfparamsscimschemasoracleidcsextensionselfChangeUser.class, parameters={})
     ...
     * 
     */
    @Export(name="user", type=DomainsAuthTokenUser.class, parameters={})
