 ...
 *                 .value(var_.cloud_gate_mapping_cloud_gate_value())
 *                 .build())
 *             .gatewayApp(DomainsCloudGateMappingGatewayAppArgs.builder()
 *                 .name(var_.cloud_gate_mapping_gateway_app_name())
 *                 .value(var_.cloud_gate_mapping_gateway_app_value())
 *                 .build())
 *             .idcsEndpoint(data.oci_identity_domain().test_domain().url())
 *             .policyName(oci_identity_policy.test_policy().name())
 *             .resourcePrefix(var_.cloud_gate_mapping_resource_prefix())
 *             .schemas(&#34;urn:ietf:params:scim:schemas:oracle:idcs:CloudGateMapping&#34;)
 *             .server(DomainsCloudGateMappingServerArgs.builder()
 *                 .value(var_.cloud_gate_mapping_server_value())
 *                 .build())
 *             .attributeSets(&#34;all&#34;)
 *             .attributes(&#34;&#34;)
 *             .authorization(var_.cloud_gate_mapping_authorization())
 *             .description(var_.cloud_gate_mapping_description())
 *             .id(var_.cloud_gate_mapping_id())
 *             .isOpcService(var_.cloud_gate_mapping_is_opc_service())
 *             .nginxSettings(var_.cloud_gate_mapping_nginx_settings())
 *             .ocid(var_.cloud_gate_mapping_ocid())
 *             .proxyPass(var_.cloud_gate_mapping_proxy_pass())
 ...
 *                 .key(var_.cloud_gate_mapping_tags_key())
 *                 .value(var_.cloud_gate_mapping_tags_value())
 *                 .build())
 *             .upstreamServerGroup(DomainsCloudGateMappingUpstreamServerGroupArgs.builder()
 *                 .ssl(var_.cloud_gate_mapping_upstream_server_group_ssl())
 *                 .value(var_.cloud_gate_mapping_upstream_server_group_value())
 *                 .build())
 *             .build());
 * 
 *     }
...
public class DomainsCloudGateMapping extends com.pulumi.resources.CustomResource {
     ...
     */
    public DomainsCloudGateMapping(String name) {
     ...
     */
    public DomainsCloudGateMapping(String name, DomainsCloudGateMappingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public static DomainsCloudGateMapping get(String name, Output<String> id, @Nullable DomainsCloudGateMappingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
