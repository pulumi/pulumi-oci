...
import com.pulumi.oci.Identity.inputs.DomainsCloudGateServerState;
import com.pulumi.oci.Identity.outputs.DomainsCloudGateServerCloudGate;
import com.pulumi.oci.Identity.outputs.DomainsCloudGateServerIdcsCreatedBy;
import com.pulumi.oci.Identity.outputs.DomainsCloudGateServerIdcsLastModifiedBy;
import com.pulumi.oci.Identity.outputs.DomainsCloudGateServerMeta;
import com.pulumi.oci.Identity.outputs.DomainsCloudGateServerTag;
 ...
 *                 .value(var_.cloud_gate_server_cloud_gate_value())
 *                 .build())
 *             .displayName(var_.cloud_gate_server_display_name())
 *             .hostName(var_.cloud_gate_server_host_name())
 *             .idcsEndpoint(data.oci_identity_domain().test_domain().url())
 *             .port(var_.cloud_gate_server_port())
 *             .schemas(&#34;urn:ietf:params:scim:schemas:oracle:idcs:CloudGateServer&#34;)
 *             .ssl(var_.cloud_gate_server_ssl())
 *             .attributeSets(&#34;all&#34;)
 *             .attributes(&#34;&#34;)
 *             .authorization(var_.cloud_gate_server_authorization())
 *             .description(var_.cloud_gate_server_description())
 *             .id(var_.cloud_gate_server_id())
 *             .nginxSettings(var_.cloud_gate_server_nginx_settings())
 *             .ocid(var_.cloud_gate_server_ocid())
 *             .resourceTypeSchemaVersion(var_.cloud_gate_server_resource_type_schema_version())
 *             .tags(DomainsCloudGateServerTagArgs.builder()
 *                 .key(var_.cloud_gate_server_tags_key())
 *                 .value(var_.cloud_gate_server_tags_value())
 *                 .build())
 *             .build());
 * 
 *     }
 ...
 * 
 */
@ResourceType(type="oci:Identity/domainsCloudGateServer:DomainsCloudGateServer")
public class DomainsCloudGateServer extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="cloudGate", refs={DomainsCloudGateServerCloudGate.class}, tree="[0]")
    private Output<DomainsCloudGateServerCloudGate> cloudGate;
     ...
     * 
     */
    public Output<DomainsCloudGateServerCloudGate> cloudGate() {
     ...
     * 
     */
    @Export(name="idcsCreatedBies", refs={List.class,DomainsCloudGateServerIdcsCreatedBy.class}, tree="[0,1]")
    private Output<List<DomainsCloudGateServerIdcsCreatedBy>> idcsCreatedBies;
     ...
     * 
     */
    public Output<List<DomainsCloudGateServerIdcsCreatedBy>> idcsCreatedBies() {
     ...
     * 
     */
    @Export(name="idcsLastModifiedBies", refs={List.class,DomainsCloudGateServerIdcsLastModifiedBy.class}, tree="[0,1]")
    private Output<List<DomainsCloudGateServerIdcsLastModifiedBy>> idcsLastModifiedBies;
     ...
     * 
     */
    public Output<List<DomainsCloudGateServerIdcsLastModifiedBy>> idcsLastModifiedBies() {
     ...
     * 
     */
    @Export(name="metas", refs={List.class,DomainsCloudGateServerMeta.class}, tree="[0,1]")
    private Output<List<DomainsCloudGateServerMeta>> metas;
     ...
     * 
     */
    public Output<List<DomainsCloudGateServerMeta>> metas() {
        return this.metas;
    }
    /**
     ...
     * 
     */
    @Export(name="tags", refs={List.class,DomainsCloudGateServerTag.class}, tree="[0,1]")
    private Output<List<DomainsCloudGateServerTag>> tags;
     ...
     * 
     */
    public Output<List<DomainsCloudGateServerTag>> tags() {
        return this.tags;
    }
    /**
     ...
     */
    public DomainsCloudGateServer(String name) {
        this(name, DomainsCloudGateServerArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public DomainsCloudGateServer(String name, DomainsCloudGateServerArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DomainsCloudGateServer(String name, DomainsCloudGateServerArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Identity/domainsCloudGateServer:DomainsCloudGateServer", name, args == null ? DomainsCloudGateServerArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private DomainsCloudGateServer(String name, Output<String> id, @Nullable DomainsCloudGateServerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Identity/domainsCloudGateServer:DomainsCloudGateServer", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static DomainsCloudGateServer get(String name, Output<String> id, @Nullable DomainsCloudGateServerState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
