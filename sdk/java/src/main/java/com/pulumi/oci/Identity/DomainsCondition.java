 ...
 *             .attributeName(var_.condition_attribute_name())
 *             .attributeValue(var_.condition_attribute_value())
 *             .idcsEndpoint(data.oci_identity_domain().test_domain().url())
 *             .operator(var_.condition_operator())
 *             .schemas(&#34;urn:ietf:params:scim:schemas:oracle:idcs:Condition&#34;)
 *             .attributeSets(&#34;all&#34;)
 *             .attributes(&#34;&#34;)
 *             .authorization(var_.condition_authorization())
 *             .description(var_.condition_description())
 *             .evaluateConditionIf(var_.condition_evaluate_condition_if())
 *             .externalId(&#34;externalId&#34;)
 *             .ocid(var_.condition_ocid())
 *             .resourceTypeSchemaVersion(var_.condition_resource_type_schema_version())
 *             .tags(DomainsConditionTagArgs.builder()
 *                 .key(var_.condition_tags_key())
 *                 .value(var_.condition_tags_value())
 *                 .build())
 *             .build());
 * 
 *     }
