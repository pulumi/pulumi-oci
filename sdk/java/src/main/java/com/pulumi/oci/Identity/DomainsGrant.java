 ...
 *             .grantMechanism(var_.grant_grant_mechanism())
 *             .grantee(DomainsGrantGranteeArgs.builder()
 *                 .type(var_.grant_grantee_type())
 *                 .value(var_.grant_grantee_value())
 *                 .build())
 *             .idcsEndpoint(data.oci_identity_domain().test_domain().url())
 *             .schemas(&#34;urn:ietf:params:scim:schemas:oracle:idcs:Grant&#34;)
 *             .app(DomainsGrantAppArgs.builder()
 *                 .value(var_.grant_app_value())
 *                 .build())
 *             .appEntitlementCollection(DomainsGrantAppEntitlementCollectionArgs.builder()
 *                 .value(var_.grant_app_entitlement_collection_value())
 *                 .build())
 *             .attributeSets(&#34;all&#34;)
 *             .attributes(&#34;&#34;)
 ...
 *                 .attributeValue(var_.grant_entitlement_attribute_value())
 *                 .build())
 *             .grantedAttributeValuesJson(var_.grant_granted_attribute_values_json())
 *             .id(var_.grant_id())
 *             .ocid(var_.grant_ocid())
 *             .resourceTypeSchemaVersion(var_.grant_resource_type_schema_version())
 *             .tags(DomainsGrantTagArgs.builder()
 *                 .key(var_.grant_tags_key())
 *                 .value(var_.grant_tags_value())
 *                 .build())
 *             .build());
 * 
 *     }
...
public class DomainsGrant extends com.pulumi.resources.CustomResource {
     ...
     */
    public DomainsGrant(String name) {
     ...
     */
    public static DomainsGrant get(String name, Output<String> id, @Nullable DomainsGrantState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
