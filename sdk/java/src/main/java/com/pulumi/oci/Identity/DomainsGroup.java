...
public class DomainsGroup extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="urnietfparamsscimschemasoracleidcsextensionOciTags", type=DomainsGroupUrnietfparamsscimschemasoracleidcsextensionOciTags.class, parameters={})
     ...
     * 
     */
    @Export(name="urnietfparamsscimschemasoracleidcsextensiondbcsGroups", type=List.class, parameters={DomainsGroupUrnietfparamsscimschemasoracleidcsextensiondbcsGroup.class})
     ...
     * 
     */
    @Export(name="urnietfparamsscimschemasoracleidcsextensiondynamicGroup", type=DomainsGroupUrnietfparamsscimschemasoracleidcsextensiondynamicGroup.class, parameters={})
     ...
     * 
     */
    @Export(name="urnietfparamsscimschemasoracleidcsextensionposixGroup", type=DomainsGroupUrnietfparamsscimschemasoracleidcsextensionposixGroup.class, parameters={})
     ...
     * 
     */
    @Export(name="urnietfparamsscimschemasoracleidcsextensionrequestableGroup", type=DomainsGroupUrnietfparamsscimschemasoracleidcsextensionrequestableGroup.class, parameters={})
    ...
    public DomainsGroup(String name, DomainsGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Identity/domainsGroup:DomainsGroup", name, args == null ? DomainsGroupArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
