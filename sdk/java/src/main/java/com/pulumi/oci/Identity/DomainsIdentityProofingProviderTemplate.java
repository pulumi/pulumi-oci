...
import com.pulumi.oci.Identity.DomainsIdentityProofingProviderTemplateArgs;
import com.pulumi.oci.Identity.inputs.DomainsIdentityProofingProviderTemplateState;
import com.pulumi.oci.Identity.outputs.DomainsIdentityProofingProviderTemplateConfiguration;
import com.pulumi.oci.Identity.outputs.DomainsIdentityProofingProviderTemplateIdcsCreatedBy;
import com.pulumi.oci.Identity.outputs.DomainsIdentityProofingProviderTemplateIdcsLastModifiedBy;
import com.pulumi.oci.Identity.outputs.DomainsIdentityProofingProviderTemplateIdcsLockedBy;
import com.pulumi.oci.Identity.outputs.DomainsIdentityProofingProviderTemplateMeta;
 ...
 * import com.pulumi.core.Output;
 * import com.pulumi.oci.Identity.DomainsIdentityProofingProviderTemplate;
 * import com.pulumi.oci.Identity.DomainsIdentityProofingProviderTemplateArgs;
 ...
 *         var testIdentityProofingProviderTemplate = new DomainsIdentityProofingProviderTemplate("testIdentityProofingProviderTemplate", DomainsIdentityProofingProviderTemplateArgs.builder()
 ...
 *             .configurations(DomainsIdentityProofingProviderTemplateConfigurationArgs.builder()
 ...
 * 
 */
@ResourceType(type="oci:Identity/domainsIdentityProofingProviderTemplate:DomainsIdentityProofingProviderTemplate")
public class DomainsIdentityProofingProviderTemplate extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="configurations", refs={List.class,DomainsIdentityProofingProviderTemplateConfiguration.class}, tree="[0,1]")
    private Output<List<DomainsIdentityProofingProviderTemplateConfiguration>> configurations;
     ...
     * 
     */
    public Output<List<DomainsIdentityProofingProviderTemplateConfiguration>> configurations() {
     ...
     * 
     */
    @Export(name="idcsCreatedBies", refs={List.class,DomainsIdentityProofingProviderTemplateIdcsCreatedBy.class}, tree="[0,1]")
    private Output<List<DomainsIdentityProofingProviderTemplateIdcsCreatedBy>> idcsCreatedBies;
     ...
     * 
     */
    public Output<List<DomainsIdentityProofingProviderTemplateIdcsCreatedBy>> idcsCreatedBies() {
     ...
     * 
     */
    @Export(name="idcsLastModifiedBies", refs={List.class,DomainsIdentityProofingProviderTemplateIdcsLastModifiedBy.class}, tree="[0,1]")
    private Output<List<DomainsIdentityProofingProviderTemplateIdcsLastModifiedBy>> idcsLastModifiedBies;
     ...
     * 
     */
    public Output<List<DomainsIdentityProofingProviderTemplateIdcsLastModifiedBy>> idcsLastModifiedBies() {
     ...
     * 
     */
    @Export(name="idcsLockedBies", refs={List.class,DomainsIdentityProofingProviderTemplateIdcsLockedBy.class}, tree="[0,1]")
    private Output<List<DomainsIdentityProofingProviderTemplateIdcsLockedBy>> idcsLockedBies;
     ...
     * 
     */
    public Output<List<DomainsIdentityProofingProviderTemplateIdcsLockedBy>> idcsLockedBies() {
     ...
     * 
     */
    @Export(name="identityProofingProviderTemplateProvider", refs={String.class}, tree="[0]")
     ...
     * 
     */
    @Export(name="metas", refs={List.class,DomainsIdentityProofingProviderTemplateMeta.class}, tree="[0,1]")
    private Output<List<DomainsIdentityProofingProviderTemplateMeta>> metas;
     ...
     * 
     */
    public Output<List<DomainsIdentityProofingProviderTemplateMeta>> metas() {
        return this.metas;
    }
    /**
     ...
     * 
     */
    @Export(name="verificationUrl", refs={String.class}, tree="[0]")
     ...
     */
    public DomainsIdentityProofingProviderTemplate(java.lang.String name) {
        this(name, DomainsIdentityProofingProviderTemplateArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public DomainsIdentityProofingProviderTemplate(java.lang.String name, DomainsIdentityProofingProviderTemplateArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DomainsIdentityProofingProviderTemplate(java.lang.String name, DomainsIdentityProofingProviderTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Identity/domainsIdentityProofingProviderTemplate:DomainsIdentityProofingProviderTemplate", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DomainsIdentityProofingProviderTemplate(java.lang.String name, Output<java.lang.String> id, @Nullable DomainsIdentityProofingProviderTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Identity/domainsIdentityProofingProviderTemplate:DomainsIdentityProofingProviderTemplate", name, state, makeResourceOptions(options, id), false);
    }

    private static DomainsIdentityProofingProviderTemplateArgs makeArgs(DomainsIdentityProofingProviderTemplateArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? DomainsIdentityProofingProviderTemplateArgs.Empty : args;
    }
     ...
     */
    public static DomainsIdentityProofingProviderTemplate get(java.lang.String name, Output<java.lang.String> id, @Nullable DomainsIdentityProofingProviderTemplateState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
