...
public class DomainsIdentitySetting extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="identitySettingId", refs={String.class}, tree="[0]")
     ...
     */
    public DomainsIdentitySetting(java.lang.String name) {
     ...
     */
    public DomainsIdentitySetting(java.lang.String name, DomainsIdentitySettingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DomainsIdentitySetting(java.lang.String name, DomainsIdentitySettingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Identity/domainsIdentitySetting:DomainsIdentitySetting", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DomainsIdentitySetting(java.lang.String name, Output<java.lang.String> id, @Nullable DomainsIdentitySettingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Identity/domainsIdentitySetting:DomainsIdentitySetting", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static DomainsIdentitySetting get(java.lang.String name, Output<java.lang.String> id, @Nullable DomainsIdentitySettingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
