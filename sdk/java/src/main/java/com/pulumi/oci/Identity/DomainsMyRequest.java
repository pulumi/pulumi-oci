...
public class DomainsMyRequest extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ List<DomainsMyRequestIdcsCreatedBy>> idcsCreatedBies;
     ...
     * 
     */
    public Output<Optional<List<DomainsMyRequestIdcsCreatedBy>>> idcsCreatedBies() {
    ...
    private Output</* @Nullable */ List<DomainsMyRequestIdcsLastModifiedBy>> idcsLastModifiedBies;
     ...
     * 
     */
    public Output<Optional<List<DomainsMyRequestIdcsLastModifiedBy>>> idcsLastModifiedBies() {
    ...
    private Output</* @Nullable */ List<DomainsMyRequestMeta>> metas;
     ...
     * 
     */
    public Output<Optional<List<DomainsMyRequestMeta>>> metas() {
    ...
    private Output</* @Nullable */ DomainsMyRequestRequestor> requestor;
     ...
     * 
     */
    public Output<Optional<DomainsMyRequestRequestor>> requestor() {
        return Codegen.optional(this.requestor);
    }
    /**
    ...
    private Output</* @Nullable */ List<DomainsMyRequestTag>> tags;
     ...
     * 
     */
    public Output<Optional<List<DomainsMyRequestTag>>> tags() {
