...
public class DomainsRule extends com.pulumi.resources.CustomResource {
     ...
     */
    public DomainsRule(java.lang.String name) {
     ...
     */
    public DomainsRule(java.lang.String name, DomainsRuleArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DomainsRule(java.lang.String name, DomainsRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Identity/domainsRule:DomainsRule", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DomainsRule(java.lang.String name, Output<java.lang.String> id, @Nullable DomainsRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Identity/domainsRule:DomainsRule", name, state, makeResourceOptions(options, id), false);
    }

    private static DomainsRuleArgs makeArgs(DomainsRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? DomainsRuleArgs.Empty : args;
    }
     ...
     */
    public static DomainsRule get(java.lang.String name, Output<java.lang.String> id, @Nullable DomainsRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
