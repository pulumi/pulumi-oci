 ...
 *             .active(var_.security_question_active())
 *             .idcsEndpoint(data.oci_identity_domain().test_domain().url())
 *             .questionTexts(DomainsSecurityQuestionQuestionTextArgs.builder()
 *                 .locale(&#34;en&#34;)
 *                 .value(var_.security_question_question_text_value())
 *                 .default_(&#34;true&#34;)
 *                 .build())
 ...
 *             .id(var_.security_question_id())
 *             .ocid(var_.security_question_ocid())
 *             .resourceTypeSchemaVersion(var_.security_question_resource_type_schema_version())
 *             .tags(DomainsSecurityQuestionTagArgs.builder()
 *                 .key(var_.security_question_tags_key())
 *                 .value(var_.security_question_tags_value())
 *                 .build())
 *             .build());
 * 
 *     }
...
public class DomainsSecurityQuestion extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ List<DomainsSecurityQuestionIdcsCreatedBy>> idcsCreatedBies;
     ...
     * 
     */
    public Output<Optional<List<DomainsSecurityQuestionIdcsCreatedBy>>> idcsCreatedBies() {
    ...
    private Output</* @Nullable */ List<DomainsSecurityQuestionIdcsLastModifiedBy>> idcsLastModifiedBies;
     ...
     * 
     */
    public Output<Optional<List<DomainsSecurityQuestionIdcsLastModifiedBy>>> idcsLastModifiedBies() {
    ...
    private Output</* @Nullable */ List<DomainsSecurityQuestionMeta>> metas;
     ...
     * 
     */
    public Output<Optional<List<DomainsSecurityQuestionMeta>>> metas() {
    ...
    private Output</* @Nullable */ List<DomainsSecurityQuestionTag>> tags;
     ...
     * 
     */
    public Output<Optional<List<DomainsSecurityQuestionTag>>> tags() {
    ...
    public DomainsSecurityQuestion(String name, DomainsSecurityQuestionArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Identity/domainsSecurityQuestion:DomainsSecurityQuestion", name, args == null ? DomainsSecurityQuestionArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
