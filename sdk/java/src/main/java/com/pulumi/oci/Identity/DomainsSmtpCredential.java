...
import com.pulumi.oci.Identity.inputs.DomainsSmtpCredentialState;
import com.pulumi.oci.Identity.outputs.DomainsSmtpCredentialIdcsCreatedBy;
import com.pulumi.oci.Identity.outputs.DomainsSmtpCredentialIdcsLastModifiedBy;
import com.pulumi.oci.Identity.outputs.DomainsSmtpCredentialMeta;
import com.pulumi.oci.Identity.outputs.DomainsSmtpCredentialTag;
import com.pulumi.oci.Identity.outputs.DomainsSmtpCredentialUrnietfparamsscimschemasoracleidcsextensionselfChangeUser;
import com.pulumi.oci.Identity.outputs.DomainsSmtpCredentialUser;
 ...
 *             .expiresOn(var_.smtp_credential_expires_on())
 *             .id(var_.smtp_credential_id())
 *             .ocid(var_.smtp_credential_ocid())
 *             .resourceTypeSchemaVersion(var_.smtp_credential_resource_type_schema_version())
 *             .status(var_.smtp_credential_status())
 *             .tags(DomainsSmtpCredentialTagArgs.builder()
 *                 .key(var_.smtp_credential_tags_key())
 *                 .value(var_.smtp_credential_tags_value())
 *                 .build())
 ...
 *                 .allowSelfChange(var_.smtp_credential_urnietfparamsscimschemasoracleidcsextensionself_change_user_allow_self_change())
 *                 .build())
 ...
 * 
 */
@ResourceType(type="oci:Identity/domainsSmtpCredential:DomainsSmtpCredential")
public class DomainsSmtpCredential extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="idcsCreatedBies", type=List.class, parameters={DomainsSmtpCredentialIdcsCreatedBy.class})
     ...
     * 
     */
    @Export(name="idcsLastModifiedBies", type=List.class, parameters={DomainsSmtpCredentialIdcsLastModifiedBy.class})
     ...
     * 
     */
    @Export(name="metas", type=List.class, parameters={DomainsSmtpCredentialMeta.class})
     ...
     * 
     */
    @Export(name="tags", type=List.class, parameters={DomainsSmtpCredentialTag.class})
     ...
     * 
     */
    @Export(name="urnietfparamsscimschemasoracleidcsextensionselfChangeUser", type=DomainsSmtpCredentialUrnietfparamsscimschemasoracleidcsextensionselfChangeUser.class, parameters={})
     ...
     * 
     */
    @Export(name="user", type=DomainsSmtpCredentialUser.class, parameters={})
    ...
    public DomainsSmtpCredential(String name, DomainsSmtpCredentialArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Identity/domainsSmtpCredential:DomainsSmtpCredential", name, args == null ? DomainsSmtpCredentialArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
