...
public class ImportStandardTagsManagement extends com.pulumi.resources.CustomResource {
     ...
     */
    public ImportStandardTagsManagement(java.lang.String name) {
     ...
     */
    public ImportStandardTagsManagement(java.lang.String name, ImportStandardTagsManagementArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public ImportStandardTagsManagement(java.lang.String name, ImportStandardTagsManagementArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Identity/importStandardTagsManagement:ImportStandardTagsManagement", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private ImportStandardTagsManagement(java.lang.String name, Output<java.lang.String> id, @Nullable ImportStandardTagsManagementState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Identity/importStandardTagsManagement:ImportStandardTagsManagement", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static ImportStandardTagsManagement get(java.lang.String name, Output<java.lang.String> id, @Nullable ImportStandardTagsManagementState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
