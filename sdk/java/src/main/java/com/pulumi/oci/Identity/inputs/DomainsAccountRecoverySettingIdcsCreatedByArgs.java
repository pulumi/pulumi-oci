...
public final class DomainsAccountRecoverySettingIdcsCreatedByArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsAccountRecoverySettingIdcsCreatedByArgs Empty = new DomainsAccountRecoverySettingIdcsCreatedByArgs();
    ...
    private DomainsAccountRecoverySettingIdcsCreatedByArgs() {}

    private DomainsAccountRecoverySettingIdcsCreatedByArgs(DomainsAccountRecoverySettingIdcsCreatedByArgs $) {
    ...
    public static Builder builder(DomainsAccountRecoverySettingIdcsCreatedByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsAccountRecoverySettingIdcsCreatedByArgs();
        }

        public Builder(DomainsAccountRecoverySettingIdcsCreatedByArgs defaults) {
            $ = new DomainsAccountRecoverySettingIdcsCreatedByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsAccountRecoverySettingIdcsCreatedByArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsAccountRecoverySettingIdcsCreatedByArgs", "value");
            }
            return $;
        }
    }
