...
public final class DomainsAccountRecoverySettingIdcsLastModifiedByArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsAccountRecoverySettingIdcsLastModifiedByArgs Empty = new DomainsAccountRecoverySettingIdcsLastModifiedByArgs();
    ...
    private DomainsAccountRecoverySettingIdcsLastModifiedByArgs() {}

    private DomainsAccountRecoverySettingIdcsLastModifiedByArgs(DomainsAccountRecoverySettingIdcsLastModifiedByArgs $) {
    ...
    public static Builder builder(DomainsAccountRecoverySettingIdcsLastModifiedByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsAccountRecoverySettingIdcsLastModifiedByArgs();
        }

        public Builder(DomainsAccountRecoverySettingIdcsLastModifiedByArgs defaults) {
            $ = new DomainsAccountRecoverySettingIdcsLastModifiedByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsAccountRecoverySettingIdcsLastModifiedByArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsAccountRecoverySettingIdcsLastModifiedByArgs", "value");
            }
            return $;
        }
    }
