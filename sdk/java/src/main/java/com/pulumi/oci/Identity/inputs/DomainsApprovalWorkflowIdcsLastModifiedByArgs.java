...
public final class DomainsApprovalWorkflowIdcsLastModifiedByArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsApprovalWorkflowIdcsLastModifiedByArgs Empty = new DomainsApprovalWorkflowIdcsLastModifiedByArgs();
    ...
    private DomainsApprovalWorkflowIdcsLastModifiedByArgs() {}

    private DomainsApprovalWorkflowIdcsLastModifiedByArgs(DomainsApprovalWorkflowIdcsLastModifiedByArgs $) {
    ...
    public static Builder builder(DomainsApprovalWorkflowIdcsLastModifiedByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsApprovalWorkflowIdcsLastModifiedByArgs();
        }

        public Builder(DomainsApprovalWorkflowIdcsLastModifiedByArgs defaults) {
            $ = new DomainsApprovalWorkflowIdcsLastModifiedByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsApprovalWorkflowIdcsLastModifiedByArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsApprovalWorkflowIdcsLastModifiedByArgs", "value");
            }
            return $;
        }
    }
