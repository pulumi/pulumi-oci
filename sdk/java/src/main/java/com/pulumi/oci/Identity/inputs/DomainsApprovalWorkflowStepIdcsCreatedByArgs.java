...
public final class DomainsApprovalWorkflowStepIdcsCreatedByArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsApprovalWorkflowStepIdcsCreatedByArgs Empty = new DomainsApprovalWorkflowStepIdcsCreatedByArgs();
    ...
    private DomainsApprovalWorkflowStepIdcsCreatedByArgs() {}

    private DomainsApprovalWorkflowStepIdcsCreatedByArgs(DomainsApprovalWorkflowStepIdcsCreatedByArgs $) {
    ...
    public static Builder builder(DomainsApprovalWorkflowStepIdcsCreatedByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsApprovalWorkflowStepIdcsCreatedByArgs();
        }

        public Builder(DomainsApprovalWorkflowStepIdcsCreatedByArgs defaults) {
            $ = new DomainsApprovalWorkflowStepIdcsCreatedByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsApprovalWorkflowStepIdcsCreatedByArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsApprovalWorkflowStepIdcsCreatedByArgs", "value");
            }
            return $;
        }
    }
