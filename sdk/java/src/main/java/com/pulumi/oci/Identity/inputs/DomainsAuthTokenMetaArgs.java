...
public final class DomainsAuthTokenMetaArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsAuthTokenMetaArgs Empty = new DomainsAuthTokenMetaArgs();
    ...
    private DomainsAuthTokenMetaArgs() {}

    private DomainsAuthTokenMetaArgs(DomainsAuthTokenMetaArgs $) {
    ...
    public static Builder builder(DomainsAuthTokenMetaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsAuthTokenMetaArgs();
        }

        public Builder(DomainsAuthTokenMetaArgs defaults) {
            $ = new DomainsAuthTokenMetaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsAuthTokenMetaArgs build() {
            return $;
        }
    }
