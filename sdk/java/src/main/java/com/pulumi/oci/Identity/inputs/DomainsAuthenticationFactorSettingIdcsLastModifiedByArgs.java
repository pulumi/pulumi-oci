...
public final class DomainsAuthenticationFactorSettingIdcsLastModifiedByArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsAuthenticationFactorSettingIdcsLastModifiedByArgs Empty = new DomainsAuthenticationFactorSettingIdcsLastModifiedByArgs();
    ...
    private DomainsAuthenticationFactorSettingIdcsLastModifiedByArgs() {}

    private DomainsAuthenticationFactorSettingIdcsLastModifiedByArgs(DomainsAuthenticationFactorSettingIdcsLastModifiedByArgs $) {
    ...
    public static Builder builder(DomainsAuthenticationFactorSettingIdcsLastModifiedByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsAuthenticationFactorSettingIdcsLastModifiedByArgs();
        }

        public Builder(DomainsAuthenticationFactorSettingIdcsLastModifiedByArgs defaults) {
            $ = new DomainsAuthenticationFactorSettingIdcsLastModifiedByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsAuthenticationFactorSettingIdcsLastModifiedByArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsAuthenticationFactorSettingIdcsLastModifiedByArgs", "value");
            }
            return $;
        }
    }
