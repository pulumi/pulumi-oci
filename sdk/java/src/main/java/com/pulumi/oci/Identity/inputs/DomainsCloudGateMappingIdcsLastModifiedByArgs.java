...
public final class DomainsCloudGateMappingIdcsLastModifiedByArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsCloudGateMappingIdcsLastModifiedByArgs Empty = new DomainsCloudGateMappingIdcsLastModifiedByArgs();
    ...
    private DomainsCloudGateMappingIdcsLastModifiedByArgs() {}

    private DomainsCloudGateMappingIdcsLastModifiedByArgs(DomainsCloudGateMappingIdcsLastModifiedByArgs $) {
    ...
    public static Builder builder(DomainsCloudGateMappingIdcsLastModifiedByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsCloudGateMappingIdcsLastModifiedByArgs();
        }

        public Builder(DomainsCloudGateMappingIdcsLastModifiedByArgs defaults) {
            $ = new DomainsCloudGateMappingIdcsLastModifiedByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsCloudGateMappingIdcsLastModifiedByArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsCloudGateMappingIdcsLastModifiedByArgs", "value");
            }
            return $;
        }
    }
