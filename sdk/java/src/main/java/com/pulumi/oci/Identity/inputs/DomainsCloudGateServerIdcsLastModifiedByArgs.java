...
public final class DomainsCloudGateServerIdcsLastModifiedByArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsCloudGateServerIdcsLastModifiedByArgs Empty = new DomainsCloudGateServerIdcsLastModifiedByArgs();
    ...
    private DomainsCloudGateServerIdcsLastModifiedByArgs() {}

    private DomainsCloudGateServerIdcsLastModifiedByArgs(DomainsCloudGateServerIdcsLastModifiedByArgs $) {
    ...
    public static Builder builder(DomainsCloudGateServerIdcsLastModifiedByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsCloudGateServerIdcsLastModifiedByArgs();
        }

        public Builder(DomainsCloudGateServerIdcsLastModifiedByArgs defaults) {
            $ = new DomainsCloudGateServerIdcsLastModifiedByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsCloudGateServerIdcsLastModifiedByArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsCloudGateServerIdcsLastModifiedByArgs", "value");
            }
            return $;
        }
    }
