...
public final class DomainsIdentityProofingProviderIdcsLastModifiedByArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsIdentityProofingProviderIdcsLastModifiedByArgs Empty = new DomainsIdentityProofingProviderIdcsLastModifiedByArgs();
    ...
    private DomainsIdentityProofingProviderIdcsLastModifiedByArgs() {}

    private DomainsIdentityProofingProviderIdcsLastModifiedByArgs(DomainsIdentityProofingProviderIdcsLastModifiedByArgs $) {
    ...
    public static Builder builder(DomainsIdentityProofingProviderIdcsLastModifiedByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsIdentityProofingProviderIdcsLastModifiedByArgs();
        }

        public Builder(DomainsIdentityProofingProviderIdcsLastModifiedByArgs defaults) {
            $ = new DomainsIdentityProofingProviderIdcsLastModifiedByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsIdentityProofingProviderIdcsLastModifiedByArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsIdentityProofingProviderIdcsLastModifiedByArgs", "value");
            }
            return $;
        }
    }
