...
public final class DomainsIdentityProofingProviderTemplateIdcsCreatedByArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsIdentityProofingProviderTemplateIdcsCreatedByArgs Empty = new DomainsIdentityProofingProviderTemplateIdcsCreatedByArgs();
    ...
    private DomainsIdentityProofingProviderTemplateIdcsCreatedByArgs() {}

    private DomainsIdentityProofingProviderTemplateIdcsCreatedByArgs(DomainsIdentityProofingProviderTemplateIdcsCreatedByArgs $) {
    ...
    public static Builder builder(DomainsIdentityProofingProviderTemplateIdcsCreatedByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsIdentityProofingProviderTemplateIdcsCreatedByArgs();
        }

        public Builder(DomainsIdentityProofingProviderTemplateIdcsCreatedByArgs defaults) {
            $ = new DomainsIdentityProofingProviderTemplateIdcsCreatedByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsIdentityProofingProviderTemplateIdcsCreatedByArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsIdentityProofingProviderTemplateIdcsCreatedByArgs", "value");
            }
            return $;
        }
    }
