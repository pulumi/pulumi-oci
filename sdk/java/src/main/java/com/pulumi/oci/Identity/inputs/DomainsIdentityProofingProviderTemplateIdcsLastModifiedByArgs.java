...
public final class DomainsIdentityProofingProviderTemplateIdcsLastModifiedByArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsIdentityProofingProviderTemplateIdcsLastModifiedByArgs Empty = new DomainsIdentityProofingProviderTemplateIdcsLastModifiedByArgs();
    ...
    private DomainsIdentityProofingProviderTemplateIdcsLastModifiedByArgs() {}

    private DomainsIdentityProofingProviderTemplateIdcsLastModifiedByArgs(DomainsIdentityProofingProviderTemplateIdcsLastModifiedByArgs $) {
    ...
    public static Builder builder(DomainsIdentityProofingProviderTemplateIdcsLastModifiedByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsIdentityProofingProviderTemplateIdcsLastModifiedByArgs();
        }

        public Builder(DomainsIdentityProofingProviderTemplateIdcsLastModifiedByArgs defaults) {
            $ = new DomainsIdentityProofingProviderTemplateIdcsLastModifiedByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsIdentityProofingProviderTemplateIdcsLastModifiedByArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsIdentityProofingProviderTemplateIdcsLastModifiedByArgs", "value");
            }
            return $;
        }
    }
