...
public final class DomainsIdentityPropagationTrustIdcsLastModifiedByArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsIdentityPropagationTrustIdcsLastModifiedByArgs Empty = new DomainsIdentityPropagationTrustIdcsLastModifiedByArgs();
    ...
    private DomainsIdentityPropagationTrustIdcsLastModifiedByArgs() {}

    private DomainsIdentityPropagationTrustIdcsLastModifiedByArgs(DomainsIdentityPropagationTrustIdcsLastModifiedByArgs $) {
    ...
    public static Builder builder(DomainsIdentityPropagationTrustIdcsLastModifiedByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsIdentityPropagationTrustIdcsLastModifiedByArgs();
        }

        public Builder(DomainsIdentityPropagationTrustIdcsLastModifiedByArgs defaults) {
            $ = new DomainsIdentityPropagationTrustIdcsLastModifiedByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsIdentityPropagationTrustIdcsLastModifiedByArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsIdentityPropagationTrustIdcsLastModifiedByArgs", "value");
            }
            return $;
        }
    }
