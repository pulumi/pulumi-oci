...
public final class DomainsIdentitySettingIdcsLastModifiedByArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsIdentitySettingIdcsLastModifiedByArgs Empty = new DomainsIdentitySettingIdcsLastModifiedByArgs();
    ...
    private DomainsIdentitySettingIdcsLastModifiedByArgs() {}

    private DomainsIdentitySettingIdcsLastModifiedByArgs(DomainsIdentitySettingIdcsLastModifiedByArgs $) {
    ...
    public static Builder builder(DomainsIdentitySettingIdcsLastModifiedByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsIdentitySettingIdcsLastModifiedByArgs();
        }

        public Builder(DomainsIdentitySettingIdcsLastModifiedByArgs defaults) {
            $ = new DomainsIdentitySettingIdcsLastModifiedByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsIdentitySettingIdcsLastModifiedByArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsIdentitySettingIdcsLastModifiedByArgs", "value");
            }
            return $;
        }
    }
