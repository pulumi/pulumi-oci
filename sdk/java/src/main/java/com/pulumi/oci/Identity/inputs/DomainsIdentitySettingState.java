...
import com.pulumi.oci.Identity.inputs.DomainsIdentitySettingIdcsCreatedByArgs;
import com.pulumi.oci.Identity.inputs.DomainsIdentitySettingIdcsLastModifiedByArgs;
import com.pulumi.oci.Identity.inputs.DomainsIdentitySettingMetaArgs;
...
public final class DomainsIdentitySettingState extends com.pulumi.resources.ResourceArgs {

    public static final DomainsIdentitySettingState Empty = new DomainsIdentitySettingState();
    ...
    private @Nullable Output<List<DomainsIdentitySettingIdcsCreatedByArgs>> idcsCreatedBies;
     ...
     * 
     */
    public Optional<Output<List<DomainsIdentitySettingIdcsCreatedByArgs>>> idcsCreatedBies() {
    ...
    private @Nullable Output<List<DomainsIdentitySettingIdcsLastModifiedByArgs>> idcsLastModifiedBies;
     ...
     * 
     */
    public Optional<Output<List<DomainsIdentitySettingIdcsLastModifiedByArgs>>> idcsLastModifiedBies() {
     ...
     * 
     */
    @Import(name="identitySettingId")
    private @Nullable Output<String> identitySettingId;

    /**
     * @return ID of the resource
     * 
     */
    public Optional<Output<String>> identitySettingId() {
     ...
     */
    @Import(name="metas")
    private @Nullable Output<List<DomainsIdentitySettingMetaArgs>> metas;
     ...
     * 
     */
    public Optional<Output<List<DomainsIdentitySettingMetaArgs>>> metas() {
     ...
     * 
     */
    @Import(name="removeInvalidEmails")
    private @Nullable Output<Boolean> removeInvalidEmails;
     ...
     * 
     */
    public Optional<Output<Boolean>> removeInvalidEmails() {
    ...
    private DomainsIdentitySettingState() {}

    private DomainsIdentitySettingState(DomainsIdentitySettingState $) {
    ...
    public static Builder builder(DomainsIdentitySettingState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsIdentitySettingState();
        }

        public Builder(DomainsIdentitySettingState defaults) {
            $ = new DomainsIdentitySettingState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder idcsCreatedBies(@Nullable Output<List<DomainsIdentitySettingIdcsCreatedByArgs>> idcsCreatedBies) {
         ...
         * 
         */
        public Builder idcsCreatedBies(List<DomainsIdentitySettingIdcsCreatedByArgs> idcsCreatedBies) {
         ...
         * 
         */
        public Builder idcsCreatedBies(DomainsIdentitySettingIdcsCreatedByArgs... idcsCreatedBies) {
         ...
         * 
         */
        public Builder idcsLastModifiedBies(@Nullable Output<List<DomainsIdentitySettingIdcsLastModifiedByArgs>> idcsLastModifiedBies) {
         ...
         * 
         */
        public Builder idcsLastModifiedBies(List<DomainsIdentitySettingIdcsLastModifiedByArgs> idcsLastModifiedBies) {
         ...
         * 
         */
        public Builder idcsLastModifiedBies(DomainsIdentitySettingIdcsLastModifiedByArgs... idcsLastModifiedBies) {
         ...
         * 
         */
        public Builder identitySettingId(@Nullable Output<String> identitySettingId) {
         ...
         * 
         */
        public Builder metas(@Nullable Output<List<DomainsIdentitySettingMetaArgs>> metas) {
            $.metas = metas;
            return this;
        }
         ...
         * 
         */
        public Builder metas(List<DomainsIdentitySettingMetaArgs> metas) {
         ...
         * 
         */
        public Builder metas(DomainsIdentitySettingMetaArgs... metas) {
        ...
        /**
         * @param removeInvalidEmails (Updatable) Indicates whether to remove non-RFC5322 compliant emails before creating a user.
         * 
         * **Added In:** 2106170416
         * 
         * **SCIM++ Properties:**
         ...
         * 
         */
        public Builder removeInvalidEmails(@Nullable Output<Boolean> removeInvalidEmails) {
        ...
        public Builder removeInvalidEmails(Boolean removeInvalidEmails) {
            return removeInvalidEmails(Output.of(removeInvalidEmails));
        }
        ...
        public DomainsIdentitySettingState build() {
            return $;
        }
    }
