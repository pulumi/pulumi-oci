...
public final class DomainsMappedAttributeIdcsCreatedByArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsMappedAttributeIdcsCreatedByArgs Empty = new DomainsMappedAttributeIdcsCreatedByArgs();
    ...
    private DomainsMappedAttributeIdcsCreatedByArgs() {}

    private DomainsMappedAttributeIdcsCreatedByArgs(DomainsMappedAttributeIdcsCreatedByArgs $) {
    ...
    public static Builder builder(DomainsMappedAttributeIdcsCreatedByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsMappedAttributeIdcsCreatedByArgs();
        }

        public Builder(DomainsMappedAttributeIdcsCreatedByArgs defaults) {
            $ = new DomainsMappedAttributeIdcsCreatedByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsMappedAttributeIdcsCreatedByArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsMappedAttributeIdcsCreatedByArgs", "value");
            }
            return $;
        }
    }
