...
public final class DomainsMappedAttributeIdcsLastModifiedByArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsMappedAttributeIdcsLastModifiedByArgs Empty = new DomainsMappedAttributeIdcsLastModifiedByArgs();
    ...
    private DomainsMappedAttributeIdcsLastModifiedByArgs() {}

    private DomainsMappedAttributeIdcsLastModifiedByArgs(DomainsMappedAttributeIdcsLastModifiedByArgs $) {
    ...
    public static Builder builder(DomainsMappedAttributeIdcsLastModifiedByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsMappedAttributeIdcsLastModifiedByArgs();
        }

        public Builder(DomainsMappedAttributeIdcsLastModifiedByArgs defaults) {
            $ = new DomainsMappedAttributeIdcsLastModifiedByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsMappedAttributeIdcsLastModifiedByArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsMappedAttributeIdcsLastModifiedByArgs", "value");
            }
            return $;
        }
    }
