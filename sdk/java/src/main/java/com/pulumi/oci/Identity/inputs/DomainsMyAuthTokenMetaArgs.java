...
public final class DomainsMyAuthTokenMetaArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsMyAuthTokenMetaArgs Empty = new DomainsMyAuthTokenMetaArgs();
    ...
    private DomainsMyAuthTokenMetaArgs() {}

    private DomainsMyAuthTokenMetaArgs(DomainsMyAuthTokenMetaArgs $) {
    ...
    public static Builder builder(DomainsMyAuthTokenMetaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsMyAuthTokenMetaArgs();
        }

        public Builder(DomainsMyAuthTokenMetaArgs defaults) {
            $ = new DomainsMyAuthTokenMetaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsMyAuthTokenMetaArgs build() {
            return $;
        }
    }
