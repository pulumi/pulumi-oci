...
public final class DomainsMyOauth2clientCredentialIdcsCreatedByArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsMyOauth2clientCredentialIdcsCreatedByArgs Empty = new DomainsMyOauth2clientCredentialIdcsCreatedByArgs();
    ...
    private DomainsMyOauth2clientCredentialIdcsCreatedByArgs() {}

    private DomainsMyOauth2clientCredentialIdcsCreatedByArgs(DomainsMyOauth2clientCredentialIdcsCreatedByArgs $) {
    ...
    public static Builder builder(DomainsMyOauth2clientCredentialIdcsCreatedByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsMyOauth2clientCredentialIdcsCreatedByArgs();
        }

        public Builder(DomainsMyOauth2clientCredentialIdcsCreatedByArgs defaults) {
            $ = new DomainsMyOauth2clientCredentialIdcsCreatedByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsMyOauth2clientCredentialIdcsCreatedByArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsMyOauth2clientCredentialIdcsCreatedByArgs", "value");
            }
            return $;
        }
    }
