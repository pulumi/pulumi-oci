...
public final class DomainsMyOauth2clientCredentialMetaArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsMyOauth2clientCredentialMetaArgs Empty = new DomainsMyOauth2clientCredentialMetaArgs();
    ...
    private DomainsMyOauth2clientCredentialMetaArgs() {}

    private DomainsMyOauth2clientCredentialMetaArgs(DomainsMyOauth2clientCredentialMetaArgs $) {
    ...
    public static Builder builder(DomainsMyOauth2clientCredentialMetaArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsMyOauth2clientCredentialMetaArgs();
        }

        public Builder(DomainsMyOauth2clientCredentialMetaArgs defaults) {
            $ = new DomainsMyOauth2clientCredentialMetaArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsMyOauth2clientCredentialMetaArgs build() {
            return $;
        }
    }
