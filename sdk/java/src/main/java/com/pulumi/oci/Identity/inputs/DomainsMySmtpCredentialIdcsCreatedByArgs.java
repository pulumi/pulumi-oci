...
public final class DomainsMySmtpCredentialIdcsCreatedByArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsMySmtpCredentialIdcsCreatedByArgs Empty = new DomainsMySmtpCredentialIdcsCreatedByArgs();
    ...
    private DomainsMySmtpCredentialIdcsCreatedByArgs() {}

    private DomainsMySmtpCredentialIdcsCreatedByArgs(DomainsMySmtpCredentialIdcsCreatedByArgs $) {
    ...
    public static Builder builder(DomainsMySmtpCredentialIdcsCreatedByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsMySmtpCredentialIdcsCreatedByArgs();
        }

        public Builder(DomainsMySmtpCredentialIdcsCreatedByArgs defaults) {
            $ = new DomainsMySmtpCredentialIdcsCreatedByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsMySmtpCredentialIdcsCreatedByArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsMySmtpCredentialIdcsCreatedByArgs", "value");
            }
            return $;
        }
    }
