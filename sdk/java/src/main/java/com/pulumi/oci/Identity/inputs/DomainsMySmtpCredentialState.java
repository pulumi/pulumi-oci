...
import com.pulumi.oci.Identity.inputs.DomainsMySmtpCredentialIdcsCreatedByArgs;
import com.pulumi.oci.Identity.inputs.DomainsMySmtpCredentialIdcsLastModifiedByArgs;
import com.pulumi.oci.Identity.inputs.DomainsMySmtpCredentialMetaArgs;
...
public final class DomainsMySmtpCredentialState extends com.pulumi.resources.ResourceArgs {

    public static final DomainsMySmtpCredentialState Empty = new DomainsMySmtpCredentialState();
    ...
    private @Nullable Output<List<DomainsMySmtpCredentialIdcsCreatedByArgs>> idcsCreatedBies;

    /**
     * @return (Updatable) The User or App who created the Resource
     * 
     */
    public Optional<Output<List<DomainsMySmtpCredentialIdcsCreatedByArgs>>> idcsCreatedBies() {
    ...
    private @Nullable Output<List<DomainsMySmtpCredentialIdcsLastModifiedByArgs>> idcsLastModifiedBies;

    /**
     * @return (Updatable) The User or App who modified the Resource
     * 
     */
    public Optional<Output<List<DomainsMySmtpCredentialIdcsLastModifiedByArgs>>> idcsLastModifiedBies() {
     ...
     */
    @Import(name="metas")
    private @Nullable Output<List<DomainsMySmtpCredentialMetaArgs>> metas;

    /**
     * @return (Updatable) A complex attribute that contains resource metadata. All sub-attributes are OPTIONAL.
     * 
     */
    public Optional<Output<List<DomainsMySmtpCredentialMetaArgs>>> metas() {
    ...
    private DomainsMySmtpCredentialState() {}

    private DomainsMySmtpCredentialState(DomainsMySmtpCredentialState $) {
    ...
    public static Builder builder(DomainsMySmtpCredentialState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsMySmtpCredentialState();
        }

        public Builder(DomainsMySmtpCredentialState defaults) {
            $ = new DomainsMySmtpCredentialState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder idcsCreatedBies(@Nullable Output<List<DomainsMySmtpCredentialIdcsCreatedByArgs>> idcsCreatedBies) {
         ...
         * 
         */
        public Builder idcsCreatedBies(List<DomainsMySmtpCredentialIdcsCreatedByArgs> idcsCreatedBies) {
         ...
         * 
         */
        public Builder idcsCreatedBies(DomainsMySmtpCredentialIdcsCreatedByArgs... idcsCreatedBies) {
         ...
         * 
         */
        public Builder idcsLastModifiedBies(@Nullable Output<List<DomainsMySmtpCredentialIdcsLastModifiedByArgs>> idcsLastModifiedBies) {
         ...
         * 
         */
        public Builder idcsLastModifiedBies(List<DomainsMySmtpCredentialIdcsLastModifiedByArgs> idcsLastModifiedBies) {
         ...
         * 
         */
        public Builder idcsLastModifiedBies(DomainsMySmtpCredentialIdcsLastModifiedByArgs... idcsLastModifiedBies) {
         ...
         * 
         */
        public Builder metas(@Nullable Output<List<DomainsMySmtpCredentialMetaArgs>> metas) {
            $.metas = metas;
            return this;
        }
         ...
         * 
         */
        public Builder metas(List<DomainsMySmtpCredentialMetaArgs> metas) {
         ...
         * 
         */
        public Builder metas(DomainsMySmtpCredentialMetaArgs... metas) {
        ...
        public DomainsMySmtpCredentialState build() {
            return $;
        }
    }
