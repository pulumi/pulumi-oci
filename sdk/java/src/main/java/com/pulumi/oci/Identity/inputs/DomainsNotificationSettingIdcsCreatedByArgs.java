...
public final class DomainsNotificationSettingIdcsCreatedByArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsNotificationSettingIdcsCreatedByArgs Empty = new DomainsNotificationSettingIdcsCreatedByArgs();
    ...
    private DomainsNotificationSettingIdcsCreatedByArgs() {}

    private DomainsNotificationSettingIdcsCreatedByArgs(DomainsNotificationSettingIdcsCreatedByArgs $) {
    ...
    public static Builder builder(DomainsNotificationSettingIdcsCreatedByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsNotificationSettingIdcsCreatedByArgs();
        }

        public Builder(DomainsNotificationSettingIdcsCreatedByArgs defaults) {
            $ = new DomainsNotificationSettingIdcsCreatedByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsNotificationSettingIdcsCreatedByArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsNotificationSettingIdcsCreatedByArgs", "value");
            }
            return $;
        }
    }
