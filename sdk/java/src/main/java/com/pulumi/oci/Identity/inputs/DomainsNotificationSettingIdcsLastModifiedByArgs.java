...
public final class DomainsNotificationSettingIdcsLastModifiedByArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsNotificationSettingIdcsLastModifiedByArgs Empty = new DomainsNotificationSettingIdcsLastModifiedByArgs();
    ...
    private DomainsNotificationSettingIdcsLastModifiedByArgs() {}

    private DomainsNotificationSettingIdcsLastModifiedByArgs(DomainsNotificationSettingIdcsLastModifiedByArgs $) {
    ...
    public static Builder builder(DomainsNotificationSettingIdcsLastModifiedByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsNotificationSettingIdcsLastModifiedByArgs();
        }

        public Builder(DomainsNotificationSettingIdcsLastModifiedByArgs defaults) {
            $ = new DomainsNotificationSettingIdcsLastModifiedByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsNotificationSettingIdcsLastModifiedByArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsNotificationSettingIdcsLastModifiedByArgs", "value");
            }
            return $;
        }
    }
