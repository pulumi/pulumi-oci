...
public final class DomainsOauth2clientCredentialUserArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsOauth2clientCredentialUserArgs Empty = new DomainsOauth2clientCredentialUserArgs();
    ...
    private DomainsOauth2clientCredentialUserArgs() {}

    private DomainsOauth2clientCredentialUserArgs(DomainsOauth2clientCredentialUserArgs $) {
    ...
    public static Builder builder(DomainsOauth2clientCredentialUserArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsOauth2clientCredentialUserArgs();
        }

        public Builder(DomainsOauth2clientCredentialUserArgs defaults) {
            $ = new DomainsOauth2clientCredentialUserArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsOauth2clientCredentialUserArgs build() {
            return $;
        }
    }
