...
public final class DomainsOauthPartnerCertificateIdcsCreatedByArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsOauthPartnerCertificateIdcsCreatedByArgs Empty = new DomainsOauthPartnerCertificateIdcsCreatedByArgs();
    ...
    private DomainsOauthPartnerCertificateIdcsCreatedByArgs() {}

    private DomainsOauthPartnerCertificateIdcsCreatedByArgs(DomainsOauthPartnerCertificateIdcsCreatedByArgs $) {
    ...
    public static Builder builder(DomainsOauthPartnerCertificateIdcsCreatedByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsOauthPartnerCertificateIdcsCreatedByArgs();
        }

        public Builder(DomainsOauthPartnerCertificateIdcsCreatedByArgs defaults) {
            $ = new DomainsOauthPartnerCertificateIdcsCreatedByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsOauthPartnerCertificateIdcsCreatedByArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsOauthPartnerCertificateIdcsCreatedByArgs", "value");
            }
            return $;
        }
    }
