...
import com.pulumi.oci.Identity.inputs.DomainsOauthPartnerCertificateIdcsCreatedByArgs;
import com.pulumi.oci.Identity.inputs.DomainsOauthPartnerCertificateIdcsLastModifiedByArgs;
import com.pulumi.oci.Identity.inputs.DomainsOauthPartnerCertificateMetaArgs;
...
public final class DomainsOauthPartnerCertificateState extends com.pulumi.resources.ResourceArgs {

    public static final DomainsOauthPartnerCertificateState Empty = new DomainsOauthPartnerCertificateState();
     ...
     * 
     */
    @Import(name="certEndDate")
    private @Nullable Output<String> certEndDate;
     ...
     * 
     */
    public Optional<Output<String>> certEndDate() {
        return Optional.ofNullable(this.certEndDate);
    }
     ...
     * 
     */
    @Import(name="certStartDate")
    private @Nullable Output<String> certStartDate;
     ...
     * 
     */
    public Optional<Output<String>> certStartDate() {
        return Optional.ofNullable(this.certStartDate);
    }
     ...
     * 
     */
    @Import(name="certificateAlias")
    private @Nullable Output<String> certificateAlias;
     ...
     * 
     */
    public Optional<Output<String>> certificateAlias() {
        return Optional.ofNullable(this.certificateAlias);
    }
    ...
    private @Nullable Output<List<DomainsOauthPartnerCertificateIdcsCreatedByArgs>> idcsCreatedBies;
     ...
     * 
     */
    public Optional<Output<List<DomainsOauthPartnerCertificateIdcsCreatedByArgs>>> idcsCreatedBies() {
    ...
    private @Nullable Output<List<DomainsOauthPartnerCertificateIdcsLastModifiedByArgs>> idcsLastModifiedBies;
     ...
     * 
     */
    public Optional<Output<List<DomainsOauthPartnerCertificateIdcsLastModifiedByArgs>>> idcsLastModifiedBies() {
     ...
     */
    @Import(name="metas")
    private @Nullable Output<List<DomainsOauthPartnerCertificateMetaArgs>> metas;
     ...
     * 
     */
    public Optional<Output<List<DomainsOauthPartnerCertificateMetaArgs>>> metas() {
     ...
     * 
     */
    @Import(name="sha256thumbprint")
    private @Nullable Output<String> sha256thumbprint;
     ...
     * 
     */
    public Optional<Output<String>> sha256thumbprint() {
        return Optional.ofNullable(this.sha256thumbprint);
    }
     ...
     */
    @Import(name="tags")
    private @Nullable Output<List<DomainsOauthPartnerCertificateTagArgs>> tags;
     ...
     * 
     */
    public Optional<Output<List<DomainsOauthPartnerCertificateTagArgs>>> tags() {
    ...
    private DomainsOauthPartnerCertificateState() {}

    private DomainsOauthPartnerCertificateState(DomainsOauthPartnerCertificateState $) {
    ...
    public static Builder builder(DomainsOauthPartnerCertificateState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsOauthPartnerCertificateState();
        }

        public Builder(DomainsOauthPartnerCertificateState defaults) {
            $ = new DomainsOauthPartnerCertificateState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param certEndDate (Updatable) Certificate end date
         * 
         * **SCIM++ Properties:**
         * * type: dateTime
         * * multiValued: false
         ...
         * 
         */
        public Builder certEndDate(@Nullable Output<String> certEndDate) {
        ...
        public Builder certEndDate(String certEndDate) {
            return certEndDate(Output.of(certEndDate));
        }

        /**
         * @param certStartDate (Updatable) Certificate start date
         * 
         * **SCIM++ Properties:**
         * * type: dateTime
         * * multiValued: false
         ...
         * 
         */
        public Builder certStartDate(@Nullable Output<String> certStartDate) {
        ...
        public Builder certStartDate(String certStartDate) {
            return certStartDate(Output.of(certStartDate));
        }
         ...
         * 
         */
        public Builder certificateAlias(@Nullable Output<String> certificateAlias) {
         ...
         * 
         */
        public Builder idcsCreatedBies(@Nullable Output<List<DomainsOauthPartnerCertificateIdcsCreatedByArgs>> idcsCreatedBies) {
         ...
         * 
         */
        public Builder idcsCreatedBies(List<DomainsOauthPartnerCertificateIdcsCreatedByArgs> idcsCreatedBies) {
         ...
         * 
         */
        public Builder idcsCreatedBies(DomainsOauthPartnerCertificateIdcsCreatedByArgs... idcsCreatedBies) {
         ...
         * 
         */
        public Builder idcsLastModifiedBies(@Nullable Output<List<DomainsOauthPartnerCertificateIdcsLastModifiedByArgs>> idcsLastModifiedBies) {
         ...
         * 
         */
        public Builder idcsLastModifiedBies(List<DomainsOauthPartnerCertificateIdcsLastModifiedByArgs> idcsLastModifiedBies) {
         ...
         * 
         */
        public Builder idcsLastModifiedBies(DomainsOauthPartnerCertificateIdcsLastModifiedByArgs... idcsLastModifiedBies) {
         ...
         * 
         */
        public Builder metas(@Nullable Output<List<DomainsOauthPartnerCertificateMetaArgs>> metas) {
            $.metas = metas;
            return this;
        }
         ...
         * 
         */
        public Builder metas(List<DomainsOauthPartnerCertificateMetaArgs> metas) {
         ...
         * 
         */
        public Builder metas(DomainsOauthPartnerCertificateMetaArgs... metas) {
        ...
        /**
         * @param sha1thumbprint (Updatable) SHA-1 Thumbprint
         * 
         * **SCIM++ Properties:**
         * * type: string
         * * multiValued: false
        ...
        /**
         * @param sha256thumbprint (Updatable) SHA-256 Thumbprint
         * 
         * **SCIM++ Properties:**
         * * type: string
         * * multiValued: false
         ...
         * 
         */
        public Builder sha256thumbprint(@Nullable Output<String> sha256thumbprint) {
        ...
        public Builder sha256thumbprint(String sha256thumbprint) {
            return sha256thumbprint(Output.of(sha256thumbprint));
        }
         ...
         * 
         */
        public Builder tags(@Nullable Output<List<DomainsOauthPartnerCertificateTagArgs>> tags) {
            $.tags = tags;
            return this;
        }
         ...
         * 
         */
        public Builder tags(List<DomainsOauthPartnerCertificateTagArgs> tags) {
         ...
         * 
         */
        public Builder tags(DomainsOauthPartnerCertificateTagArgs... tags) {
        ...
        public DomainsOauthPartnerCertificateState build() {
            return $;
        }
    }
