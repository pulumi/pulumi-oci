...
public final class DomainsSettingDefaultCompanyNameArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public DomainsSettingDefaultCompanyNameArgs build() {
            if ($.locale == null) {
                throw new MissingRequiredPropertyException("DomainsSettingDefaultCompanyNameArgs", "locale");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsSettingDefaultCompanyNameArgs", "value");
            }
            return $;
        }
    }
