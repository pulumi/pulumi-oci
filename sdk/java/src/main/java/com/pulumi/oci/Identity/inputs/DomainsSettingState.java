...
import com.pulumi.oci.Identity.inputs.DomainsSettingDefaultCompanyNameArgs;
import com.pulumi.oci.Identity.inputs.DomainsSettingDefaultImageArgs;
import com.pulumi.oci.Identity.inputs.DomainsSettingDefaultLoginTextArgs;
import com.pulumi.oci.Identity.inputs.DomainsSettingIdcsCreatedByArgs;
import com.pulumi.oci.Identity.inputs.DomainsSettingIdcsLastModifiedByArgs;
...
import com.pulumi.oci.Identity.inputs.DomainsSettingMetaArgs;
...
public final class DomainsSettingState extends com.pulumi.resources.ResourceArgs {

    public static final DomainsSettingState Empty = new DomainsSettingState();
     ...
     * 
     */
    @Import(name="csrAccess")
    private @Nullable Output<String> csrAccess;
     ...
     * 
     */
    public Optional<Output<String>> csrAccess() {
        return Optional.ofNullable(this.csrAccess);
    }
     ...
     * 
     */
    @Import(name="defaultCompanyNames")
    private @Nullable Output<List<DomainsSettingDefaultCompanyNameArgs>> defaultCompanyNames;
     ...
     * 
     */
    public Optional<Output<List<DomainsSettingDefaultCompanyNameArgs>>> defaultCompanyNames() {
        return Optional.ofNullable(this.defaultCompanyNames);
    }
     ...
     * 
     */
    @Import(name="defaultImages")
    private @Nullable Output<List<DomainsSettingDefaultImageArgs>> defaultImages;
     ...
     * 
     */
    public Optional<Output<List<DomainsSettingDefaultImageArgs>>> defaultImages() {
        return Optional.ofNullable(this.defaultImages);
    }
     ...
     * 
     */
    @Import(name="defaultLoginTexts")
    private @Nullable Output<List<DomainsSettingDefaultLoginTextArgs>> defaultLoginTexts;
     ...
     * 
     */
    public Optional<Output<List<DomainsSettingDefaultLoginTextArgs>>> defaultLoginTexts() {
        return Optional.ofNullable(this.defaultLoginTexts);
    }
     ...
     * 
     */
    @Import(name="diagnosticTracingUpto")
    private @Nullable Output<String> diagnosticTracingUpto;
     ...
     * 
     */
    public Optional<Output<String>> diagnosticTracingUpto() {
        return Optional.ofNullable(this.diagnosticTracingUpto);
    }
    ...
    private @Nullable Output<List<DomainsSettingIdcsCreatedByArgs>> idcsCreatedBies;
     ...
     * 
     */
    public Optional<Output<List<DomainsSettingIdcsCreatedByArgs>>> idcsCreatedBies() {
    ...
    private @Nullable Output<List<DomainsSettingIdcsLastModifiedByArgs>> idcsLastModifiedBies;
     ...
     * 
     */
    public Optional<Output<List<DomainsSettingIdcsLastModifiedByArgs>>> idcsLastModifiedBies() {
     ...
     */
    @Import(name="metas")
    private @Nullable Output<List<DomainsSettingMetaArgs>> metas;
     ...
     * 
     */
    public Optional<Output<List<DomainsSettingMetaArgs>>> metas() {
     ...
     * 
     */
    @Import(name="migrationStatus")
    private @Nullable Output<String> migrationStatus;
     ...
     * 
     */
    public Optional<Output<String>> migrationStatus() {
     ...
     * 
     */
    @Import(name="onPremisesProvisioning")
    private @Nullable Output<Boolean> onPremisesProvisioning;
     ...
     * 
     */
    public Optional<Output<Boolean>> onPremisesProvisioning() {
        return Optional.ofNullable(this.onPremisesProvisioning);
    }
    ...
    private DomainsSettingState() {}

    private DomainsSettingState(DomainsSettingState $) {
    ...
    public static Builder builder(DomainsSettingState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsSettingState();
        }

        public Builder(DomainsSettingState defaults) {
            $ = new DomainsSettingState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param cloudAccountName (Updatable) The attribute to store the cloud account name
         * 
         * **Deprecated Since: 2011192329**
         * 
         * **SCIM++ Properties:**
         ...
         * 
         */
        public Builder csrAccess(@Nullable Output<String> csrAccess) {
            $.csrAccess = csrAccess;
            return this;
        }
        ...
        /**
         * @param defaultCompanyNames (Updatable) Default name of the Company in different locales
         * 
         * **Added In:** 18.2.2
         * 
         * **SCIM++ Properties:**
         ...
         * 
         */
        public Builder defaultCompanyNames(@Nullable Output<List<DomainsSettingDefaultCompanyNameArgs>> defaultCompanyNames) {
         ...
         * 
         */
        public Builder defaultCompanyNames(List<DomainsSettingDefaultCompanyNameArgs> defaultCompanyNames) {
            return defaultCompanyNames(Output.of(defaultCompanyNames));
        }
         ...
         * 
         */
        public Builder defaultCompanyNames(DomainsSettingDefaultCompanyNameArgs... defaultCompanyNames) {
            return defaultCompanyNames(List.of(defaultCompanyNames));
        }

        /**
         * @param defaultImages (Updatable) References to various images
         * 
         * **Added In:** 18.2.2
         * 
         * **SCIM++ Properties:**
         ...
         * 
         */
        public Builder defaultImages(@Nullable Output<List<DomainsSettingDefaultImageArgs>> defaultImages) {
         ...
         * 
         */
        public Builder defaultImages(List<DomainsSettingDefaultImageArgs> defaultImages) {
            return defaultImages(Output.of(defaultImages));
        }
         ...
         * 
         */
        public Builder defaultImages(DomainsSettingDefaultImageArgs... defaultImages) {
            return defaultImages(List.of(defaultImages));
        }

        /**
         * @param defaultLoginTexts (Updatable) Default Login text in different locales
         * 
         * **Added In:** 18.2.2
         * 
         * **SCIM++ Properties:**
         ...
         * 
         */
        public Builder defaultLoginTexts(@Nullable Output<List<DomainsSettingDefaultLoginTextArgs>> defaultLoginTexts) {
         ...
         * 
         */
        public Builder defaultLoginTexts(List<DomainsSettingDefaultLoginTextArgs> defaultLoginTexts) {
            return defaultLoginTexts(Output.of(defaultLoginTexts));
        }
         ...
         * 
         */
        public Builder defaultLoginTexts(DomainsSettingDefaultLoginTextArgs... defaultLoginTexts) {
        ...
        /**
         * @param diagnosticTracingUpto (Updatable) The end time up to which diagnostic recording is switched on
         * 
         * **SCIM++ Properties:**
         * * caseExact: false
         * * idcsSearchable: false
         ...
         * 
         */
        public Builder diagnosticTracingUpto(@Nullable Output<String> diagnosticTracingUpto) {
        ...
        public Builder diagnosticTracingUpto(String diagnosticTracingUpto) {
            return diagnosticTracingUpto(Output.of(diagnosticTracingUpto));
        }
         ...
         * 
         */
        public Builder idcsCreatedBies(@Nullable Output<List<DomainsSettingIdcsCreatedByArgs>> idcsCreatedBies) {
         ...
         * 
         */
        public Builder idcsCreatedBies(List<DomainsSettingIdcsCreatedByArgs> idcsCreatedBies) {
         ...
         * 
         */
        public Builder idcsCreatedBies(DomainsSettingIdcsCreatedByArgs... idcsCreatedBies) {
         ...
         * 
         */
        public Builder idcsLastModifiedBies(@Nullable Output<List<DomainsSettingIdcsLastModifiedByArgs>> idcsLastModifiedBies) {
         ...
         * 
         */
        public Builder idcsLastModifiedBies(List<DomainsSettingIdcsLastModifiedByArgs> idcsLastModifiedBies) {
         ...
         * 
         */
        public Builder idcsLastModifiedBies(DomainsSettingIdcsLastModifiedByArgs... idcsLastModifiedBies) {
         ...
         * 
         */
        public Builder metas(@Nullable Output<List<DomainsSettingMetaArgs>> metas) {
            $.metas = metas;
            return this;
        }
         ...
         * 
         */
        public Builder metas(List<DomainsSettingMetaArgs> metas) {
         ...
         * 
         */
        public Builder metas(DomainsSettingMetaArgs... metas) {
            return metas(List.of(metas));
        }

        /**
         * @param migrationStatus (Updatable) Database Migration Status
         * 
         * **Added In:** 19.2.1
         * 
         * **SCIM++ Properties:**
         ...
         * 
         */
        public Builder migrationStatus(@Nullable Output<String> migrationStatus) {
        ...
        public Builder migrationStatus(String migrationStatus) {
            return migrationStatus(Output.of(migrationStatus));
        }
        ...
        /**
         * @param onPremisesProvisioning (Updatable) On-Premises provisioning feature toggle.
         * 
         * **Added In:** 19.2.1
         * 
         * **SCIM++ Properties:**
         ...
         * 
         */
        public Builder onPremisesProvisioning(@Nullable Output<Boolean> onPremisesProvisioning) {
        ...
        public Builder onPremisesProvisioning(Boolean onPremisesProvisioning) {
            return onPremisesProvisioning(Output.of(onPremisesProvisioning));
        }
        ...
        public DomainsSettingState build() {
            return $;
        }
    }
