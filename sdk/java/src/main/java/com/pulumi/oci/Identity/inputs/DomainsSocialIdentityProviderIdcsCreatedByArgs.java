...
public final class DomainsSocialIdentityProviderIdcsCreatedByArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsSocialIdentityProviderIdcsCreatedByArgs Empty = new DomainsSocialIdentityProviderIdcsCreatedByArgs();
    ...
    private DomainsSocialIdentityProviderIdcsCreatedByArgs() {}

    private DomainsSocialIdentityProviderIdcsCreatedByArgs(DomainsSocialIdentityProviderIdcsCreatedByArgs $) {
    ...
    public static Builder builder(DomainsSocialIdentityProviderIdcsCreatedByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsSocialIdentityProviderIdcsCreatedByArgs();
        }

        public Builder(DomainsSocialIdentityProviderIdcsCreatedByArgs defaults) {
            $ = new DomainsSocialIdentityProviderIdcsCreatedByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsSocialIdentityProviderIdcsCreatedByArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsSocialIdentityProviderIdcsCreatedByArgs", "value");
            }
            return $;
        }
    }
