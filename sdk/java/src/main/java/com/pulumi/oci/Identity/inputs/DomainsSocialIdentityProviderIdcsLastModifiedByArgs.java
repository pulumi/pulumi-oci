...
public final class DomainsSocialIdentityProviderIdcsLastModifiedByArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsSocialIdentityProviderIdcsLastModifiedByArgs Empty = new DomainsSocialIdentityProviderIdcsLastModifiedByArgs();
    ...
    private DomainsSocialIdentityProviderIdcsLastModifiedByArgs() {}

    private DomainsSocialIdentityProviderIdcsLastModifiedByArgs(DomainsSocialIdentityProviderIdcsLastModifiedByArgs $) {
    ...
    public static Builder builder(DomainsSocialIdentityProviderIdcsLastModifiedByArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsSocialIdentityProviderIdcsLastModifiedByArgs();
        }

        public Builder(DomainsSocialIdentityProviderIdcsLastModifiedByArgs defaults) {
            $ = new DomainsSocialIdentityProviderIdcsLastModifiedByArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DomainsSocialIdentityProviderIdcsLastModifiedByArgs build() {
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsSocialIdentityProviderIdcsLastModifiedByArgs", "value");
            }
            return $;
        }
    }
