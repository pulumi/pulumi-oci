...
public final class DomainsUserEntitlementArgs extends com.pulumi.resources.ResourceArgs {

    public static final DomainsUserEntitlementArgs Empty = new DomainsUserEntitlementArgs();
    ...
    private DomainsUserEntitlementArgs() {}

    private DomainsUserEntitlementArgs(DomainsUserEntitlementArgs $) {
    ...
    public static Builder builder(DomainsUserEntitlementArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DomainsUserEntitlementArgs();
        }

        public Builder(DomainsUserEntitlementArgs defaults) {
            $ = new DomainsUserEntitlementArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param value (Updatable) The value of an entitlement.
         * 
         * **SCIM++ Properties:**
         * * caseExact: false
         * * idcsSearchable: true
        ...
        public DomainsUserEntitlementArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("DomainsUserEntitlementArgs", "type");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("DomainsUserEntitlementArgs", "value");
            }
            return $;
        }
    }
