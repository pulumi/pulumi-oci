...
public final class GetDomainsAccountMgmtInfosPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsAccountMgmtInfosPlainArgs Empty = new GetDomainsAccountMgmtInfosPlainArgs();

    /**
     * OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
     * 
     */
    @Import(name="accountMgmtInfoCount")
     ...
     * 
     */
    @Import(name="accountMgmtInfoFilter")
    ...
    private GetDomainsAccountMgmtInfosPlainArgs() {}

    private GetDomainsAccountMgmtInfosPlainArgs(GetDomainsAccountMgmtInfosPlainArgs $) {
    ...
    public static Builder builder(GetDomainsAccountMgmtInfosPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsAccountMgmtInfosPlainArgs();
        }

        public Builder(GetDomainsAccountMgmtInfosPlainArgs defaults) {
            $ = new GetDomainsAccountMgmtInfosPlainArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param accountMgmtInfoCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder accountMgmtInfoCount(@Nullable Integer accountMgmtInfoCount) {
            $.accountMgmtInfoCount = accountMgmtInfoCount;
            return this;
        }

        /**
         * @param accountMgmtInfoFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder accountMgmtInfoFilter(@Nullable String accountMgmtInfoFilter) {
            $.accountMgmtInfoFilter = accountMgmtInfoFilter;
            return this;
        }
        ...
        public GetDomainsAccountMgmtInfosPlainArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsAccountMgmtInfosPlainArgs", "idcsEndpoint");
            }
            return $;
        }
    }
