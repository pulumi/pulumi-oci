...
public final class GetDomainsApiKeysPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsApiKeysPlainArgs Empty = new GetDomainsApiKeysPlainArgs();

    /**
     * OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
     * 
     */
    @Import(name="apiKeyCount")
    ...
    private GetDomainsApiKeysPlainArgs() {}

    private GetDomainsApiKeysPlainArgs(GetDomainsApiKeysPlainArgs $) {
    ...
    public static Builder builder(GetDomainsApiKeysPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsApiKeysPlainArgs();
        }

        public Builder(GetDomainsApiKeysPlainArgs defaults) {
            $ = new GetDomainsApiKeysPlainArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param apiKeyCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        ...
        public GetDomainsApiKeysPlainArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsApiKeysPlainArgs", "idcsEndpoint");
            }
            return $;
        }
    }
