...
public final class GetDomainsAppArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsAppArgs Empty = new GetDomainsAppArgs();
    ...
    private GetDomainsAppArgs() {}

    private GetDomainsAppArgs(GetDomainsAppArgs $) {
        this.appId = $.appId;
    ...
    public static Builder builder(GetDomainsAppArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsAppArgs();
        }

        public Builder(GetDomainsAppArgs defaults) {
            $ = new GetDomainsAppArgs(Objects.requireNonNull(defaults));
        }
