...
public final class GetDomainsAppRolesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsAppRolesArgs Empty = new GetDomainsAppRolesArgs();

    /**
     * OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
     * 
     */
    @Import(name="appRoleCount")
    private @Nullable Output<Integer> appRoleCount;
     ...
     * 
     */
    public Optional<Output<Integer>> appRoleCount() {
        return Optional.ofNullable(this.appRoleCount);
    }
     ...
     * 
     */
    @Import(name="appRoleFilter")
    private @Nullable Output<String> appRoleFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> appRoleFilter() {
        return Optional.ofNullable(this.appRoleFilter);
    }
    ...
    private GetDomainsAppRolesArgs() {}

    private GetDomainsAppRolesArgs(GetDomainsAppRolesArgs $) {
        this.appRoleCount = $.appRoleCount;
        this.appRoleFilter = $.appRoleFilter;
    ...
    public static Builder builder(GetDomainsAppRolesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsAppRolesArgs();
        }

        public Builder(GetDomainsAppRolesArgs defaults) {
            $ = new GetDomainsAppRolesArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param appRoleCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder appRoleCount(@Nullable Output<Integer> appRoleCount) {
         ...
         * 
         */
        public Builder appRoleCount(Integer appRoleCount) {
            return appRoleCount(Output.of(appRoleCount));
        }

        /**
         * @param appRoleFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder appRoleFilter(@Nullable Output<String> appRoleFilter) {
         ...
         * 
         */
        public Builder appRoleFilter(String appRoleFilter) {
            return appRoleFilter(Output.of(appRoleFilter));
        }
        ...
        public GetDomainsAppRolesArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsAppRolesArgs", "idcsEndpoint");
            }
            return $;
        }
    }
