...
public final class GetDomainsApprovalWorkflowAssignmentsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsApprovalWorkflowAssignmentsArgs Empty = new GetDomainsApprovalWorkflowAssignmentsArgs();
    ...
    private @Nullable Output<Integer> approvalWorkflowAssignmentCount;
     ...
     * 
     */
    public Optional<Output<Integer>> approvalWorkflowAssignmentCount() {
    ...
    private @Nullable Output<String> approvalWorkflowAssignmentFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> approvalWorkflowAssignmentFilter() {
    ...
    private GetDomainsApprovalWorkflowAssignmentsArgs() {}

    private GetDomainsApprovalWorkflowAssignmentsArgs(GetDomainsApprovalWorkflowAssignmentsArgs $) {
    ...
    public static Builder builder(GetDomainsApprovalWorkflowAssignmentsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsApprovalWorkflowAssignmentsArgs();
        }

        public Builder(GetDomainsApprovalWorkflowAssignmentsArgs defaults) {
            $ = new GetDomainsApprovalWorkflowAssignmentsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder approvalWorkflowAssignmentCount(@Nullable Output<Integer> approvalWorkflowAssignmentCount) {
         ...
         * 
         */
        public Builder approvalWorkflowAssignmentCount(Integer approvalWorkflowAssignmentCount) {
            return approvalWorkflowAssignmentCount(Output.of(approvalWorkflowAssignmentCount));
        }
         ...
         * 
         */
        public Builder approvalWorkflowAssignmentFilter(@Nullable Output<String> approvalWorkflowAssignmentFilter) {
         ...
         * 
         */
        public Builder approvalWorkflowAssignmentFilter(String approvalWorkflowAssignmentFilter) {
            return approvalWorkflowAssignmentFilter(Output.of(approvalWorkflowAssignmentFilter));
        }
        ...
        public GetDomainsApprovalWorkflowAssignmentsArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsApprovalWorkflowAssignmentsArgs", "idcsEndpoint");
            }
            return $;
        }
    }
