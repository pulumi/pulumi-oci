...
public final class GetDomainsApprovalWorkflowAssignmentsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsApprovalWorkflowAssignmentsPlainArgs Empty = new GetDomainsApprovalWorkflowAssignmentsPlainArgs();

    /**
     * OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
     * 
     */
    @Import(name="approvalWorkflowAssignmentCount")
     ...
     * 
     */
    @Import(name="approvalWorkflowAssignmentFilter")
    ...
    private GetDomainsApprovalWorkflowAssignmentsPlainArgs() {}

    private GetDomainsApprovalWorkflowAssignmentsPlainArgs(GetDomainsApprovalWorkflowAssignmentsPlainArgs $) {
    ...
    public static Builder builder(GetDomainsApprovalWorkflowAssignmentsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsApprovalWorkflowAssignmentsPlainArgs();
        }

        public Builder(GetDomainsApprovalWorkflowAssignmentsPlainArgs defaults) {
            $ = new GetDomainsApprovalWorkflowAssignmentsPlainArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param approvalWorkflowAssignmentCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder approvalWorkflowAssignmentCount(@Nullable Integer approvalWorkflowAssignmentCount) {
            $.approvalWorkflowAssignmentCount = approvalWorkflowAssignmentCount;
            return this;
        }

        /**
         * @param approvalWorkflowAssignmentFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder approvalWorkflowAssignmentFilter(@Nullable String approvalWorkflowAssignmentFilter) {
            $.approvalWorkflowAssignmentFilter = approvalWorkflowAssignmentFilter;
            return this;
        }
        ...
        public GetDomainsApprovalWorkflowAssignmentsPlainArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsApprovalWorkflowAssignmentsPlainArgs", "idcsEndpoint");
            }
            return $;
        }
    }
