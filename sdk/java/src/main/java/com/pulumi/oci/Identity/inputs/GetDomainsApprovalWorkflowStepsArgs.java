...
public final class GetDomainsApprovalWorkflowStepsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsApprovalWorkflowStepsArgs Empty = new GetDomainsApprovalWorkflowStepsArgs();

    /**
     * OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
     * 
     */
    @Import(name="approvalWorkflowStepCount")
    private @Nullable Output<Integer> approvalWorkflowStepCount;
     ...
     * 
     */
    public Optional<Output<Integer>> approvalWorkflowStepCount() {
     ...
     * 
     */
    @Import(name="approvalWorkflowStepFilter")
    private @Nullable Output<String> approvalWorkflowStepFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> approvalWorkflowStepFilter() {
    ...
    private GetDomainsApprovalWorkflowStepsArgs() {}

    private GetDomainsApprovalWorkflowStepsArgs(GetDomainsApprovalWorkflowStepsArgs $) {
    ...
    public static Builder builder(GetDomainsApprovalWorkflowStepsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsApprovalWorkflowStepsArgs();
        }

        public Builder(GetDomainsApprovalWorkflowStepsArgs defaults) {
            $ = new GetDomainsApprovalWorkflowStepsArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param approvalWorkflowStepCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder approvalWorkflowStepCount(@Nullable Output<Integer> approvalWorkflowStepCount) {
            $.approvalWorkflowStepCount = approvalWorkflowStepCount;
            return this;
        }
         ...
         * 
         */
        public Builder approvalWorkflowStepCount(Integer approvalWorkflowStepCount) {
            return approvalWorkflowStepCount(Output.of(approvalWorkflowStepCount));
        }

        /**
         * @param approvalWorkflowStepFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder approvalWorkflowStepFilter(@Nullable Output<String> approvalWorkflowStepFilter) {
            $.approvalWorkflowStepFilter = approvalWorkflowStepFilter;
            return this;
        }
         ...
         * 
         */
        public Builder approvalWorkflowStepFilter(String approvalWorkflowStepFilter) {
            return approvalWorkflowStepFilter(Output.of(approvalWorkflowStepFilter));
        }
        ...
        public GetDomainsApprovalWorkflowStepsArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsApprovalWorkflowStepsArgs", "idcsEndpoint");
            }
            return $;
        }
    }
