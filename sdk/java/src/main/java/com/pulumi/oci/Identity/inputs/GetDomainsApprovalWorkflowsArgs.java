...
public final class GetDomainsApprovalWorkflowsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsApprovalWorkflowsArgs Empty = new GetDomainsApprovalWorkflowsArgs();

    /**
     * OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
     * 
     */
    @Import(name="approvalWorkflowCount")
    private @Nullable Output<Integer> approvalWorkflowCount;
     ...
     * 
     */
    public Optional<Output<Integer>> approvalWorkflowCount() {
     ...
     * 
     */
    @Import(name="approvalWorkflowFilter")
    private @Nullable Output<String> approvalWorkflowFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> approvalWorkflowFilter() {
    ...
    private GetDomainsApprovalWorkflowsArgs() {}

    private GetDomainsApprovalWorkflowsArgs(GetDomainsApprovalWorkflowsArgs $) {
    ...
    public static Builder builder(GetDomainsApprovalWorkflowsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsApprovalWorkflowsArgs();
        }

        public Builder(GetDomainsApprovalWorkflowsArgs defaults) {
            $ = new GetDomainsApprovalWorkflowsArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param approvalWorkflowCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder approvalWorkflowCount(@Nullable Output<Integer> approvalWorkflowCount) {
         ...
         * 
         */
        public Builder approvalWorkflowCount(Integer approvalWorkflowCount) {
            return approvalWorkflowCount(Output.of(approvalWorkflowCount));
        }

        /**
         * @param approvalWorkflowFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder approvalWorkflowFilter(@Nullable Output<String> approvalWorkflowFilter) {
         ...
         * 
         */
        public Builder approvalWorkflowFilter(String approvalWorkflowFilter) {
            return approvalWorkflowFilter(Output.of(approvalWorkflowFilter));
        }
