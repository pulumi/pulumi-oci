...
public final class GetDomainsAppsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsAppsPlainArgs Empty = new GetDomainsAppsPlainArgs();
    ...
    private @Nullable Integer appCount;
     ...
     * 
     */
    public Optional<Integer> appCount() {
     ...
     * 
     */
    @Import(name="appFilter")
    private @Nullable String appFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<String> appFilter() {
        return Optional.ofNullable(this.appFilter);
    }
    ...
    private GetDomainsAppsPlainArgs() {}

    private GetDomainsAppsPlainArgs(GetDomainsAppsPlainArgs $) {
    ...
    public static Builder builder(GetDomainsAppsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsAppsPlainArgs();
        }

        public Builder(GetDomainsAppsPlainArgs defaults) {
            $ = new GetDomainsAppsPlainArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param appCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder appCount(@Nullable Integer appCount) {
            $.appCount = appCount;
            return this;
        }

        /**
         * @param appFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder appFilter(@Nullable String appFilter) {
            $.appFilter = appFilter;
            return this;
        }
        ...
        public GetDomainsAppsPlainArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsAppsPlainArgs", "idcsEndpoint");
            }
            return $;
        }
    }
