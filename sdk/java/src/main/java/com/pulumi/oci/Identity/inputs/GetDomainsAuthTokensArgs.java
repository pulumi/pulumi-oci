...
public final class GetDomainsAuthTokensArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsAuthTokensArgs Empty = new GetDomainsAuthTokensArgs();
     ...
     * 
     */
    @Import(name="authTokenCount")
    private @Nullable Output<Integer> authTokenCount;
     ...
     * 
     */
    public Optional<Output<Integer>> authTokenCount() {
     ...
     * 
     */
    @Import(name="authTokenFilter")
    private @Nullable Output<String> authTokenFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> authTokenFilter() {
    ...
    private GetDomainsAuthTokensArgs() {}

    private GetDomainsAuthTokensArgs(GetDomainsAuthTokensArgs $) {
    ...
    public static Builder builder(GetDomainsAuthTokensArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsAuthTokensArgs();
        }

        public Builder(GetDomainsAuthTokensArgs defaults) {
            $ = new GetDomainsAuthTokensArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param authTokenCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder authTokenCount(@Nullable Output<Integer> authTokenCount) {
         ...
         * 
         */
        public Builder authTokenCount(Integer authTokenCount) {
            return authTokenCount(Output.of(authTokenCount));
        }

        /**
         * @param authTokenFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder authTokenFilter(@Nullable Output<String> authTokenFilter) {
         ...
         * 
         */
        public Builder authTokenFilter(String authTokenFilter) {
            return authTokenFilter(Output.of(authTokenFilter));
        }
        ...
        public GetDomainsAuthTokensArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsAuthTokensArgs", "idcsEndpoint");
            }
            return $;
        }
    }
