...
public final class GetDomainsConditionsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsConditionsArgs Empty = new GetDomainsConditionsArgs();
     ...
     * 
     */
    @Import(name="conditionCount")
    private @Nullable Output<Integer> conditionCount;
     ...
     * 
     */
    public Optional<Output<Integer>> conditionCount() {
        return Optional.ofNullable(this.conditionCount);
    }
     ...
     * 
     */
    @Import(name="conditionFilter")
    private @Nullable Output<String> conditionFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> conditionFilter() {
        return Optional.ofNullable(this.conditionFilter);
    }
    ...
    private GetDomainsConditionsArgs() {}

    private GetDomainsConditionsArgs(GetDomainsConditionsArgs $) {
    ...
    public static Builder builder(GetDomainsConditionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsConditionsArgs();
        }

        public Builder(GetDomainsConditionsArgs defaults) {
            $ = new GetDomainsConditionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param conditionCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder conditionCount(@Nullable Output<Integer> conditionCount) {
         ...
         * 
         */
        public Builder conditionCount(Integer conditionCount) {
            return conditionCount(Output.of(conditionCount));
        }

        /**
         * @param conditionFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder conditionFilter(@Nullable Output<String> conditionFilter) {
         ...
         * 
         */
        public Builder conditionFilter(String conditionFilter) {
            return conditionFilter(Output.of(conditionFilter));
        }
        ...
        public GetDomainsConditionsArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsConditionsArgs", "idcsEndpoint");
            }
            return $;
        }
    }
