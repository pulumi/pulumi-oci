...
public final class GetDomainsCustomerSecretKeysArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsCustomerSecretKeysArgs Empty = new GetDomainsCustomerSecretKeysArgs();
     ...
     * 
     */
    @Import(name="customerSecretKeyCount")
    private @Nullable Output<Integer> customerSecretKeyCount;
     ...
     * 
     */
    public Optional<Output<Integer>> customerSecretKeyCount() {
        return Optional.ofNullable(this.customerSecretKeyCount);
    }
     ...
     * 
     */
    @Import(name="customerSecretKeyFilter")
    private @Nullable Output<String> customerSecretKeyFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> customerSecretKeyFilter() {
        return Optional.ofNullable(this.customerSecretKeyFilter);
    }
    ...
    private GetDomainsCustomerSecretKeysArgs() {}

    private GetDomainsCustomerSecretKeysArgs(GetDomainsCustomerSecretKeysArgs $) {
        this.attributeSets = $.attributeSets;
        this.attributes = $.attributes;
        this.authorization = $.authorization;
        this.compartmentId = $.compartmentId;
        this.customerSecretKeyCount = $.customerSecretKeyCount;
        this.customerSecretKeyFilter = $.customerSecretKeyFilter;
    ...
    public static Builder builder(GetDomainsCustomerSecretKeysArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsCustomerSecretKeysArgs();
        }

        public Builder(GetDomainsCustomerSecretKeysArgs defaults) {
            $ = new GetDomainsCustomerSecretKeysArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param customerSecretKeyCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder customerSecretKeyCount(@Nullable Output<Integer> customerSecretKeyCount) {
         ...
         * 
         */
        public Builder customerSecretKeyCount(Integer customerSecretKeyCount) {
            return customerSecretKeyCount(Output.of(customerSecretKeyCount));
        }

        /**
         * @param customerSecretKeyFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder customerSecretKeyFilter(@Nullable Output<String> customerSecretKeyFilter) {
         ...
         * 
         */
        public Builder customerSecretKeyFilter(String customerSecretKeyFilter) {
            return customerSecretKeyFilter(Output.of(customerSecretKeyFilter));
        }
        ...
        public GetDomainsCustomerSecretKeysArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsCustomerSecretKeysArgs", "idcsEndpoint");
            }
            return $;
        }
    }
