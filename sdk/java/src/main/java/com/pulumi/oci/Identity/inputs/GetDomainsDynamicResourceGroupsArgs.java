...
public final class GetDomainsDynamicResourceGroupsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsDynamicResourceGroupsArgs Empty = new GetDomainsDynamicResourceGroupsArgs();
     ...
     * 
     */
    @Import(name="dynamicResourceGroupCount")
    private @Nullable Output<Integer> dynamicResourceGroupCount;
     ...
     * 
     */
    public Optional<Output<Integer>> dynamicResourceGroupCount() {
     ...
     * 
     */
    @Import(name="dynamicResourceGroupFilter")
    private @Nullable Output<String> dynamicResourceGroupFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> dynamicResourceGroupFilter() {
    ...
    private GetDomainsDynamicResourceGroupsArgs() {}

    private GetDomainsDynamicResourceGroupsArgs(GetDomainsDynamicResourceGroupsArgs $) {
    ...
    public static Builder builder(GetDomainsDynamicResourceGroupsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsDynamicResourceGroupsArgs();
        }

        public Builder(GetDomainsDynamicResourceGroupsArgs defaults) {
            $ = new GetDomainsDynamicResourceGroupsArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param dynamicResourceGroupCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder dynamicResourceGroupCount(@Nullable Output<Integer> dynamicResourceGroupCount) {
            $.dynamicResourceGroupCount = dynamicResourceGroupCount;
            return this;
        }
         ...
         * 
         */
        public Builder dynamicResourceGroupCount(Integer dynamicResourceGroupCount) {
            return dynamicResourceGroupCount(Output.of(dynamicResourceGroupCount));
        }

        /**
         * @param dynamicResourceGroupFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder dynamicResourceGroupFilter(@Nullable Output<String> dynamicResourceGroupFilter) {
            $.dynamicResourceGroupFilter = dynamicResourceGroupFilter;
            return this;
        }
         ...
         * 
         */
        public Builder dynamicResourceGroupFilter(String dynamicResourceGroupFilter) {
            return dynamicResourceGroupFilter(Output.of(dynamicResourceGroupFilter));
        }
        ...
        public GetDomainsDynamicResourceGroupsArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsDynamicResourceGroupsArgs", "idcsEndpoint");
            }
            return $;
        }
    }
