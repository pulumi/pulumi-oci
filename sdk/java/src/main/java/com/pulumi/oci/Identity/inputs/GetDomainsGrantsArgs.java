...
public final class GetDomainsGrantsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsGrantsArgs Empty = new GetDomainsGrantsArgs();
     ...
     * 
     */
    @Import(name="grantCount")
    private @Nullable Output<Integer> grantCount;
     ...
     * 
     */
    public Optional<Output<Integer>> grantCount() {
        return Optional.ofNullable(this.grantCount);
    }
     ...
     * 
     */
    @Import(name="grantFilter")
    private @Nullable Output<String> grantFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> grantFilter() {
        return Optional.ofNullable(this.grantFilter);
    }
    ...
    private GetDomainsGrantsArgs() {}

    private GetDomainsGrantsArgs(GetDomainsGrantsArgs $) {
    ...
    public static Builder builder(GetDomainsGrantsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsGrantsArgs();
        }

        public Builder(GetDomainsGrantsArgs defaults) {
            $ = new GetDomainsGrantsArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param grantCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder grantCount(@Nullable Output<Integer> grantCount) {
         ...
         * 
         */
        public Builder grantCount(Integer grantCount) {
            return grantCount(Output.of(grantCount));
        }

        /**
         * @param grantFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder grantFilter(@Nullable Output<String> grantFilter) {
         ...
         * 
         */
        public Builder grantFilter(String grantFilter) {
            return grantFilter(Output.of(grantFilter));
        }
        ...
        public GetDomainsGrantsArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsGrantsArgs", "idcsEndpoint");
            }
            return $;
        }
    }
