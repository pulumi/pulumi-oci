...
public final class GetDomainsIdentityProofingProviderTemplatesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsIdentityProofingProviderTemplatesArgs Empty = new GetDomainsIdentityProofingProviderTemplatesArgs();
     ...
     * 
     */
    @Import(name="identityProofingProviderTemplateCount")
    private @Nullable Output<Integer> identityProofingProviderTemplateCount;
     ...
     * 
     */
    public Optional<Output<Integer>> identityProofingProviderTemplateCount() {
     ...
     * 
     */
    @Import(name="identityProofingProviderTemplateFilter")
    private @Nullable Output<String> identityProofingProviderTemplateFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> identityProofingProviderTemplateFilter() {
    ...
    private GetDomainsIdentityProofingProviderTemplatesArgs() {}

    private GetDomainsIdentityProofingProviderTemplatesArgs(GetDomainsIdentityProofingProviderTemplatesArgs $) {
    ...
    public static Builder builder(GetDomainsIdentityProofingProviderTemplatesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsIdentityProofingProviderTemplatesArgs();
        }

        public Builder(GetDomainsIdentityProofingProviderTemplatesArgs defaults) {
            $ = new GetDomainsIdentityProofingProviderTemplatesArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param identityProofingProviderTemplateCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder identityProofingProviderTemplateCount(@Nullable Output<Integer> identityProofingProviderTemplateCount) {
            $.identityProofingProviderTemplateCount = identityProofingProviderTemplateCount;
            return this;
        }
         ...
         * 
         */
        public Builder identityProofingProviderTemplateCount(Integer identityProofingProviderTemplateCount) {
            return identityProofingProviderTemplateCount(Output.of(identityProofingProviderTemplateCount));
        }

        /**
         * @param identityProofingProviderTemplateFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder identityProofingProviderTemplateFilter(@Nullable Output<String> identityProofingProviderTemplateFilter) {
            $.identityProofingProviderTemplateFilter = identityProofingProviderTemplateFilter;
            return this;
        }
         ...
         * 
         */
        public Builder identityProofingProviderTemplateFilter(String identityProofingProviderTemplateFilter) {
            return identityProofingProviderTemplateFilter(Output.of(identityProofingProviderTemplateFilter));
        }
        ...
        public GetDomainsIdentityProofingProviderTemplatesArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsIdentityProofingProviderTemplatesArgs", "idcsEndpoint");
            }
            return $;
        }
    }
