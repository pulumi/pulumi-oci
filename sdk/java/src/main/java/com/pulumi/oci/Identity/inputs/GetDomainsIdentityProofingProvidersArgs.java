...
public final class GetDomainsIdentityProofingProvidersArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsIdentityProofingProvidersArgs Empty = new GetDomainsIdentityProofingProvidersArgs();
     ...
     * 
     */
    @Import(name="identityProofingProviderCount")
    private @Nullable Output<Integer> identityProofingProviderCount;
     ...
     * 
     */
    public Optional<Output<Integer>> identityProofingProviderCount() {
     ...
     * 
     */
    @Import(name="identityProofingProviderFilter")
    private @Nullable Output<String> identityProofingProviderFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> identityProofingProviderFilter() {
    ...
    private GetDomainsIdentityProofingProvidersArgs() {}

    private GetDomainsIdentityProofingProvidersArgs(GetDomainsIdentityProofingProvidersArgs $) {
    ...
    public static Builder builder(GetDomainsIdentityProofingProvidersArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsIdentityProofingProvidersArgs();
        }

        public Builder(GetDomainsIdentityProofingProvidersArgs defaults) {
            $ = new GetDomainsIdentityProofingProvidersArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param identityProofingProviderCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder identityProofingProviderCount(@Nullable Output<Integer> identityProofingProviderCount) {
            $.identityProofingProviderCount = identityProofingProviderCount;
            return this;
        }
         ...
         * 
         */
        public Builder identityProofingProviderCount(Integer identityProofingProviderCount) {
            return identityProofingProviderCount(Output.of(identityProofingProviderCount));
        }

        /**
         * @param identityProofingProviderFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder identityProofingProviderFilter(@Nullable Output<String> identityProofingProviderFilter) {
            $.identityProofingProviderFilter = identityProofingProviderFilter;
            return this;
        }
         ...
         * 
         */
        public Builder identityProofingProviderFilter(String identityProofingProviderFilter) {
            return identityProofingProviderFilter(Output.of(identityProofingProviderFilter));
        }
        ...
        public GetDomainsIdentityProofingProvidersArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsIdentityProofingProvidersArgs", "idcsEndpoint");
            }
            return $;
        }
    }
