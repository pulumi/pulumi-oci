...
public final class GetDomainsIdentityPropagationTrustsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsIdentityPropagationTrustsArgs Empty = new GetDomainsIdentityPropagationTrustsArgs();
     ...
     * 
     */
    @Import(name="identityPropagationTrustCount")
    private @Nullable Output<Integer> identityPropagationTrustCount;
     ...
     * 
     */
    public Optional<Output<Integer>> identityPropagationTrustCount() {
     ...
     * 
     */
    @Import(name="identityPropagationTrustFilter")
    private @Nullable Output<String> identityPropagationTrustFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> identityPropagationTrustFilter() {
    ...
    private GetDomainsIdentityPropagationTrustsArgs() {}

    private GetDomainsIdentityPropagationTrustsArgs(GetDomainsIdentityPropagationTrustsArgs $) {
    ...
    public static Builder builder(GetDomainsIdentityPropagationTrustsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsIdentityPropagationTrustsArgs();
        }

        public Builder(GetDomainsIdentityPropagationTrustsArgs defaults) {
            $ = new GetDomainsIdentityPropagationTrustsArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param identityPropagationTrustCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder identityPropagationTrustCount(@Nullable Output<Integer> identityPropagationTrustCount) {
         ...
         * 
         */
        public Builder identityPropagationTrustCount(Integer identityPropagationTrustCount) {
            return identityPropagationTrustCount(Output.of(identityPropagationTrustCount));
        }

        /**
         * @param identityPropagationTrustFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder identityPropagationTrustFilter(@Nullable Output<String> identityPropagationTrustFilter) {
         ...
         * 
         */
        public Builder identityPropagationTrustFilter(String identityPropagationTrustFilter) {
            return identityPropagationTrustFilter(Output.of(identityPropagationTrustFilter));
        }
        ...
        public GetDomainsIdentityPropagationTrustsArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsIdentityPropagationTrustsArgs", "idcsEndpoint");
            }
            return $;
        }
    }
