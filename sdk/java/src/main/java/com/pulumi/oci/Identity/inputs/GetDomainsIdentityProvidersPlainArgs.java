...
public final class GetDomainsIdentityProvidersPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsIdentityProvidersPlainArgs Empty = new GetDomainsIdentityProvidersPlainArgs();
     ...
     * 
     */
    @Import(name="identityProviderCount")
     ...
     * 
     */
    @Import(name="identityProviderFilter")
    ...
    private GetDomainsIdentityProvidersPlainArgs() {}

    private GetDomainsIdentityProvidersPlainArgs(GetDomainsIdentityProvidersPlainArgs $) {
    ...
    public static Builder builder(GetDomainsIdentityProvidersPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsIdentityProvidersPlainArgs();
        }

        public Builder(GetDomainsIdentityProvidersPlainArgs defaults) {
            $ = new GetDomainsIdentityProvidersPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param identityProviderCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param identityProviderFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder identityProviderFilter(@Nullable String identityProviderFilter) {
            $.identityProviderFilter = identityProviderFilter;
            return this;
        }
        ...
        public GetDomainsIdentityProvidersPlainArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsIdentityProvidersPlainArgs", "idcsEndpoint");
            }
            return $;
        }
    }
