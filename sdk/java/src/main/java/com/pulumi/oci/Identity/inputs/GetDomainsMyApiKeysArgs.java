...
public final class GetDomainsMyApiKeysArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsMyApiKeysArgs Empty = new GetDomainsMyApiKeysArgs();
     ...
     * 
     */
    @Import(name="myApiKeyCount")
    private @Nullable Output<Integer> myApiKeyCount;
     ...
     * 
     */
    public Optional<Output<Integer>> myApiKeyCount() {
     ...
     * 
     */
    @Import(name="myApiKeyFilter")
    private @Nullable Output<String> myApiKeyFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> myApiKeyFilter() {
    ...
    private GetDomainsMyApiKeysArgs() {}

    private GetDomainsMyApiKeysArgs(GetDomainsMyApiKeysArgs $) {
    ...
    public static Builder builder(GetDomainsMyApiKeysArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsMyApiKeysArgs();
        }

        public Builder(GetDomainsMyApiKeysArgs defaults) {
            $ = new GetDomainsMyApiKeysArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param myApiKeyCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder myApiKeyCount(@Nullable Output<Integer> myApiKeyCount) {
         ...
         * 
         */
        public Builder myApiKeyCount(Integer myApiKeyCount) {
            return myApiKeyCount(Output.of(myApiKeyCount));
        }

        /**
         * @param myApiKeyFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder myApiKeyFilter(@Nullable Output<String> myApiKeyFilter) {
         ...
         * 
         */
        public Builder myApiKeyFilter(String myApiKeyFilter) {
            return myApiKeyFilter(Output.of(myApiKeyFilter));
        }
        ...
        public GetDomainsMyApiKeysArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsMyApiKeysArgs", "idcsEndpoint");
            }
            return $;
        }
    }
