...
public final class GetDomainsMyAppsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsMyAppsArgs Empty = new GetDomainsMyAppsArgs();
     ...
     * 
     */
    @Import(name="myAppCount")
    private @Nullable Output<Integer> myAppCount;
     ...
     * 
     */
    public Optional<Output<Integer>> myAppCount() {
        return Optional.ofNullable(this.myAppCount);
    }
     ...
     * 
     */
    @Import(name="myAppFilter")
    private @Nullable Output<String> myAppFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> myAppFilter() {
        return Optional.ofNullable(this.myAppFilter);
    }
    ...
    private GetDomainsMyAppsArgs() {}

    private GetDomainsMyAppsArgs(GetDomainsMyAppsArgs $) {
        this.authorization = $.authorization;
        this.compartmentId = $.compartmentId;
        this.idcsEndpoint = $.idcsEndpoint;
        this.myAppCount = $.myAppCount;
        this.myAppFilter = $.myAppFilter;
    ...
    public static Builder builder(GetDomainsMyAppsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsMyAppsArgs();
        }

        public Builder(GetDomainsMyAppsArgs defaults) {
            $ = new GetDomainsMyAppsArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param myAppCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder myAppCount(@Nullable Output<Integer> myAppCount) {
         ...
         * 
         */
        public Builder myAppCount(Integer myAppCount) {
            return myAppCount(Output.of(myAppCount));
        }

        /**
         * @param myAppFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder myAppFilter(@Nullable Output<String> myAppFilter) {
         ...
         * 
         */
        public Builder myAppFilter(String myAppFilter) {
            return myAppFilter(Output.of(myAppFilter));
        }
        ...
        public GetDomainsMyAppsArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsMyAppsArgs", "idcsEndpoint");
            }
            return $;
        }
    }
