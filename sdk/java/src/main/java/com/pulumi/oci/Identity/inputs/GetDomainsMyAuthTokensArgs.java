...
public final class GetDomainsMyAuthTokensArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsMyAuthTokensArgs Empty = new GetDomainsMyAuthTokensArgs();
     ...
     * 
     */
    @Import(name="myAuthTokenCount")
    private @Nullable Output<Integer> myAuthTokenCount;
     ...
     * 
     */
    public Optional<Output<Integer>> myAuthTokenCount() {
        return Optional.ofNullable(this.myAuthTokenCount);
    }
     ...
     * 
     */
    @Import(name="myAuthTokenFilter")
    private @Nullable Output<String> myAuthTokenFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> myAuthTokenFilter() {
        return Optional.ofNullable(this.myAuthTokenFilter);
    }
    ...
    private GetDomainsMyAuthTokensArgs() {}

    private GetDomainsMyAuthTokensArgs(GetDomainsMyAuthTokensArgs $) {
        this.authorization = $.authorization;
        this.compartmentId = $.compartmentId;
        this.idcsEndpoint = $.idcsEndpoint;
        this.myAuthTokenCount = $.myAuthTokenCount;
        this.myAuthTokenFilter = $.myAuthTokenFilter;
    ...
    public static Builder builder(GetDomainsMyAuthTokensArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsMyAuthTokensArgs();
        }

        public Builder(GetDomainsMyAuthTokensArgs defaults) {
            $ = new GetDomainsMyAuthTokensArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param myAuthTokenCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder myAuthTokenCount(@Nullable Output<Integer> myAuthTokenCount) {
            $.myAuthTokenCount = myAuthTokenCount;
            return this;
        }
         ...
         * 
         */
        public Builder myAuthTokenCount(Integer myAuthTokenCount) {
            return myAuthTokenCount(Output.of(myAuthTokenCount));
        }

        /**
         * @param myAuthTokenFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder myAuthTokenFilter(@Nullable Output<String> myAuthTokenFilter) {
            $.myAuthTokenFilter = myAuthTokenFilter;
            return this;
        }
         ...
         * 
         */
        public Builder myAuthTokenFilter(String myAuthTokenFilter) {
            return myAuthTokenFilter(Output.of(myAuthTokenFilter));
        }
        ...
        public GetDomainsMyAuthTokensArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsMyAuthTokensArgs", "idcsEndpoint");
            }
            return $;
        }
    }
