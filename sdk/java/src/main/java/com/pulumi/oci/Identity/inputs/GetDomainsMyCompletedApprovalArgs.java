...
public final class GetDomainsMyCompletedApprovalArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsMyCompletedApprovalArgs Empty = new GetDomainsMyCompletedApprovalArgs();
     ...
     * 
     */
    @Import(name="myCompletedApprovalId", required=true)
    private Output<String> myCompletedApprovalId;

    /**
     * @return ID of the resource
     * 
     */
    public Output<String> myCompletedApprovalId() {
    ...
    private GetDomainsMyCompletedApprovalArgs() {}

    private GetDomainsMyCompletedApprovalArgs(GetDomainsMyCompletedApprovalArgs $) {
    ...
    public static Builder builder(GetDomainsMyCompletedApprovalArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsMyCompletedApprovalArgs();
        }

        public Builder(GetDomainsMyCompletedApprovalArgs defaults) {
            $ = new GetDomainsMyCompletedApprovalArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param myCompletedApprovalId ID of the resource
         * 
         * @return builder
         * 
         */
        public Builder myCompletedApprovalId(Output<String> myCompletedApprovalId) {
        ...
        public Builder myCompletedApprovalId(String myCompletedApprovalId) {
            return myCompletedApprovalId(Output.of(myCompletedApprovalId));
        }
        ...
        public GetDomainsMyCompletedApprovalArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsMyCompletedApprovalArgs", "idcsEndpoint");
            }
            if ($.myCompletedApprovalId == null) {
                throw new MissingRequiredPropertyException("GetDomainsMyCompletedApprovalArgs", "myCompletedApprovalId");
            }
            return $;
        }
    }
