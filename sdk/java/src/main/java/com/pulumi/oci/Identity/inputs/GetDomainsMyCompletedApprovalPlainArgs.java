...
public final class GetDomainsMyCompletedApprovalPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsMyCompletedApprovalPlainArgs Empty = new GetDomainsMyCompletedApprovalPlainArgs();
    ...
    private GetDomainsMyCompletedApprovalPlainArgs() {}

    private GetDomainsMyCompletedApprovalPlainArgs(GetDomainsMyCompletedApprovalPlainArgs $) {
    ...
    public static Builder builder(GetDomainsMyCompletedApprovalPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsMyCompletedApprovalPlainArgs();
        }

        public Builder(GetDomainsMyCompletedApprovalPlainArgs defaults) {
            $ = new GetDomainsMyCompletedApprovalPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetDomainsMyCompletedApprovalPlainArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsMyCompletedApprovalPlainArgs", "idcsEndpoint");
            }
            if ($.myCompletedApprovalId == null) {
                throw new MissingRequiredPropertyException("GetDomainsMyCompletedApprovalPlainArgs", "myCompletedApprovalId");
            }
            return $;
        }
    }
