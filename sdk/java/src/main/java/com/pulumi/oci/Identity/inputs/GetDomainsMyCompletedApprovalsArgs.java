...
public final class GetDomainsMyCompletedApprovalsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsMyCompletedApprovalsArgs Empty = new GetDomainsMyCompletedApprovalsArgs();
     ...
     * 
     */
    @Import(name="myCompletedApprovalCount")
    private @Nullable Output<Integer> myCompletedApprovalCount;
     ...
     * 
     */
    public Optional<Output<Integer>> myCompletedApprovalCount() {
     ...
     * 
     */
    @Import(name="myCompletedApprovalFilter")
    private @Nullable Output<String> myCompletedApprovalFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> myCompletedApprovalFilter() {
    ...
    private GetDomainsMyCompletedApprovalsArgs() {}

    private GetDomainsMyCompletedApprovalsArgs(GetDomainsMyCompletedApprovalsArgs $) {
    ...
    public static Builder builder(GetDomainsMyCompletedApprovalsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsMyCompletedApprovalsArgs();
        }

        public Builder(GetDomainsMyCompletedApprovalsArgs defaults) {
            $ = new GetDomainsMyCompletedApprovalsArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param myCompletedApprovalCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder myCompletedApprovalCount(@Nullable Output<Integer> myCompletedApprovalCount) {
         ...
         * 
         */
        public Builder myCompletedApprovalCount(Integer myCompletedApprovalCount) {
            return myCompletedApprovalCount(Output.of(myCompletedApprovalCount));
        }

        /**
         * @param myCompletedApprovalFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder myCompletedApprovalFilter(@Nullable Output<String> myCompletedApprovalFilter) {
         ...
         * 
         */
        public Builder myCompletedApprovalFilter(String myCompletedApprovalFilter) {
            return myCompletedApprovalFilter(Output.of(myCompletedApprovalFilter));
        }
        ...
        public GetDomainsMyCompletedApprovalsArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsMyCompletedApprovalsArgs", "idcsEndpoint");
            }
            return $;
        }
    }
