...
public final class GetDomainsMyDevicesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsMyDevicesArgs Empty = new GetDomainsMyDevicesArgs();
     ...
     * 
     */
    @Import(name="myDeviceCount")
    private @Nullable Output<Integer> myDeviceCount;
     ...
     * 
     */
    public Optional<Output<Integer>> myDeviceCount() {
        return Optional.ofNullable(this.myDeviceCount);
    }
     ...
     * 
     */
    @Import(name="myDeviceFilter")
    private @Nullable Output<String> myDeviceFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> myDeviceFilter() {
        return Optional.ofNullable(this.myDeviceFilter);
    }
    ...
    private GetDomainsMyDevicesArgs() {}

    private GetDomainsMyDevicesArgs(GetDomainsMyDevicesArgs $) {
        ...
        this.myDeviceFilter = $.myDeviceFilter;
    ...
    public static Builder builder(GetDomainsMyDevicesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsMyDevicesArgs();
        }

        public Builder(GetDomainsMyDevicesArgs defaults) {
            $ = new GetDomainsMyDevicesArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param myDeviceCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder myDeviceCount(@Nullable Output<Integer> myDeviceCount) {
         ...
         * 
         */
        public Builder myDeviceCount(Integer myDeviceCount) {
            return myDeviceCount(Output.of(myDeviceCount));
        }

        /**
         * @param myDeviceFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder myDeviceFilter(@Nullable Output<String> myDeviceFilter) {
         ...
         * 
         */
        public Builder myDeviceFilter(String myDeviceFilter) {
            return myDeviceFilter(Output.of(myDeviceFilter));
        }
        ...
        public GetDomainsMyDevicesArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsMyDevicesArgs", "idcsEndpoint");
            }
            return $;
        }
    }
