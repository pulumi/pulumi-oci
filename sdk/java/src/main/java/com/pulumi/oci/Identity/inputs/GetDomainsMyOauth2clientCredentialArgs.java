...
public final class GetDomainsMyOauth2clientCredentialArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsMyOauth2clientCredentialArgs Empty = new GetDomainsMyOauth2clientCredentialArgs();
    ...
    private Output<String> myOauth2clientCredentialId;

    /**
     * @return ID of the resource
     * 
     */
    public Output<String> myOauth2clientCredentialId() {
    ...
    private GetDomainsMyOauth2clientCredentialArgs() {}

    private GetDomainsMyOauth2clientCredentialArgs(GetDomainsMyOauth2clientCredentialArgs $) {
    ...
    public static Builder builder(GetDomainsMyOauth2clientCredentialArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsMyOauth2clientCredentialArgs();
        }

        public Builder(GetDomainsMyOauth2clientCredentialArgs defaults) {
            $ = new GetDomainsMyOauth2clientCredentialArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder myOauth2clientCredentialId(Output<String> myOauth2clientCredentialId) {
        ...
        public Builder myOauth2clientCredentialId(String myOauth2clientCredentialId) {
            return myOauth2clientCredentialId(Output.of(myOauth2clientCredentialId));
        }
        ...
        public GetDomainsMyOauth2clientCredentialArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsMyOauth2clientCredentialArgs", "idcsEndpoint");
            }
            if ($.myOauth2clientCredentialId == null) {
                throw new MissingRequiredPropertyException("GetDomainsMyOauth2clientCredentialArgs", "myOauth2clientCredentialId");
            }
            return $;
        }
    }
