...
public final class GetDomainsMyRequestsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsMyRequestsArgs Empty = new GetDomainsMyRequestsArgs();
     ...
     * 
     */
    @Import(name="myRequestCount")
    private @Nullable Output<Integer> myRequestCount;
     ...
     * 
     */
    public Optional<Output<Integer>> myRequestCount() {
     ...
     * 
     */
    @Import(name="myRequestFilter")
    private @Nullable Output<String> myRequestFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> myRequestFilter() {
    ...
    private GetDomainsMyRequestsArgs() {}

    private GetDomainsMyRequestsArgs(GetDomainsMyRequestsArgs $) {
    ...
    public static Builder builder(GetDomainsMyRequestsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsMyRequestsArgs();
        }

        public Builder(GetDomainsMyRequestsArgs defaults) {
            $ = new GetDomainsMyRequestsArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param myRequestCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder myRequestCount(@Nullable Output<Integer> myRequestCount) {
         ...
         * 
         */
        public Builder myRequestCount(Integer myRequestCount) {
            return myRequestCount(Output.of(myRequestCount));
        }

        /**
         * @param myRequestFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder myRequestFilter(@Nullable Output<String> myRequestFilter) {
         ...
         * 
         */
        public Builder myRequestFilter(String myRequestFilter) {
            return myRequestFilter(Output.of(myRequestFilter));
        }
        ...
        public GetDomainsMyRequestsArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsMyRequestsArgs", "idcsEndpoint");
            }
            return $;
        }
    }
