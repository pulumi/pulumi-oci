...
public final class GetDomainsMyTrustedUserAgentsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsMyTrustedUserAgentsArgs Empty = new GetDomainsMyTrustedUserAgentsArgs();
     ...
     * 
     */
    @Import(name="myTrustedUserAgentCount")
    private @Nullable Output<Integer> myTrustedUserAgentCount;
     ...
     * 
     */
    public Optional<Output<Integer>> myTrustedUserAgentCount() {
        return Optional.ofNullable(this.myTrustedUserAgentCount);
    }
     ...
     * 
     */
    @Import(name="myTrustedUserAgentFilter")
    private @Nullable Output<String> myTrustedUserAgentFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> myTrustedUserAgentFilter() {
        return Optional.ofNullable(this.myTrustedUserAgentFilter);
    }
    ...
    private GetDomainsMyTrustedUserAgentsArgs() {}

    private GetDomainsMyTrustedUserAgentsArgs(GetDomainsMyTrustedUserAgentsArgs $) {
    ...
    public static Builder builder(GetDomainsMyTrustedUserAgentsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsMyTrustedUserAgentsArgs();
        }

        public Builder(GetDomainsMyTrustedUserAgentsArgs defaults) {
            $ = new GetDomainsMyTrustedUserAgentsArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param myTrustedUserAgentCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder myTrustedUserAgentCount(@Nullable Output<Integer> myTrustedUserAgentCount) {
            $.myTrustedUserAgentCount = myTrustedUserAgentCount;
            return this;
        }
         ...
         * 
         */
        public Builder myTrustedUserAgentCount(Integer myTrustedUserAgentCount) {
            return myTrustedUserAgentCount(Output.of(myTrustedUserAgentCount));
        }

        /**
         * @param myTrustedUserAgentFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder myTrustedUserAgentFilter(@Nullable Output<String> myTrustedUserAgentFilter) {
            $.myTrustedUserAgentFilter = myTrustedUserAgentFilter;
            return this;
        }
         ...
         * 
         */
        public Builder myTrustedUserAgentFilter(String myTrustedUserAgentFilter) {
            return myTrustedUserAgentFilter(Output.of(myTrustedUserAgentFilter));
        }
        ...
        public GetDomainsMyTrustedUserAgentsArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsMyTrustedUserAgentsArgs", "idcsEndpoint");
            }
            return $;
        }
    }
