...
public final class GetDomainsMyUserDbCredentialsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsMyUserDbCredentialsPlainArgs Empty = new GetDomainsMyUserDbCredentialsPlainArgs();
     ...
     * 
     */
    @Import(name="myUserDbCredentialCount")
     ...
     * 
     */
    @Import(name="myUserDbCredentialFilter")
    ...
    private GetDomainsMyUserDbCredentialsPlainArgs() {}

    private GetDomainsMyUserDbCredentialsPlainArgs(GetDomainsMyUserDbCredentialsPlainArgs $) {
    ...
    public static Builder builder(GetDomainsMyUserDbCredentialsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsMyUserDbCredentialsPlainArgs();
        }

        public Builder(GetDomainsMyUserDbCredentialsPlainArgs defaults) {
            $ = new GetDomainsMyUserDbCredentialsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param myUserDbCredentialCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder myUserDbCredentialCount(@Nullable Integer myUserDbCredentialCount) {
            $.myUserDbCredentialCount = myUserDbCredentialCount;
            return this;
        }

        /**
         * @param myUserDbCredentialFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder myUserDbCredentialFilter(@Nullable String myUserDbCredentialFilter) {
            $.myUserDbCredentialFilter = myUserDbCredentialFilter;
            return this;
        }
        ...
        public GetDomainsMyUserDbCredentialsPlainArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsMyUserDbCredentialsPlainArgs", "idcsEndpoint");
            }
            return $;
        }
    }
