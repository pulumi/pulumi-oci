...
public final class GetDomainsNetworkPerimetersArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsNetworkPerimetersArgs Empty = new GetDomainsNetworkPerimetersArgs();
     ...
     * 
     */
    @Import(name="networkPerimeterCount")
    private @Nullable Output<Integer> networkPerimeterCount;
     ...
     * 
     */
    public Optional<Output<Integer>> networkPerimeterCount() {
        return Optional.ofNullable(this.networkPerimeterCount);
    }
     ...
     * 
     */
    @Import(name="networkPerimeterFilter")
    private @Nullable Output<String> networkPerimeterFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> networkPerimeterFilter() {
        return Optional.ofNullable(this.networkPerimeterFilter);
    }
    ...
    private GetDomainsNetworkPerimetersArgs() {}

    private GetDomainsNetworkPerimetersArgs(GetDomainsNetworkPerimetersArgs $) {
        this.attributeSets = $.attributeSets;
        this.attributes = $.attributes;
        this.authorization = $.authorization;
        this.compartmentId = $.compartmentId;
        this.idcsEndpoint = $.idcsEndpoint;
        this.networkPerimeterCount = $.networkPerimeterCount;
        this.networkPerimeterFilter = $.networkPerimeterFilter;
    ...
    public static Builder builder(GetDomainsNetworkPerimetersArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsNetworkPerimetersArgs();
        }

        public Builder(GetDomainsNetworkPerimetersArgs defaults) {
            $ = new GetDomainsNetworkPerimetersArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param networkPerimeterCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder networkPerimeterCount(@Nullable Output<Integer> networkPerimeterCount) {
            $.networkPerimeterCount = networkPerimeterCount;
            return this;
        }
         ...
         * 
         */
        public Builder networkPerimeterCount(Integer networkPerimeterCount) {
            return networkPerimeterCount(Output.of(networkPerimeterCount));
        }

        /**
         * @param networkPerimeterFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder networkPerimeterFilter(@Nullable Output<String> networkPerimeterFilter) {
            $.networkPerimeterFilter = networkPerimeterFilter;
            return this;
        }
         ...
         * 
         */
        public Builder networkPerimeterFilter(String networkPerimeterFilter) {
            return networkPerimeterFilter(Output.of(networkPerimeterFilter));
        }
        ...
        public GetDomainsNetworkPerimetersArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsNetworkPerimetersArgs", "idcsEndpoint");
            }
            return $;
        }
    }
