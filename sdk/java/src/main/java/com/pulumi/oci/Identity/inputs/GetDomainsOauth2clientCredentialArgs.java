...
public final class GetDomainsOauth2clientCredentialArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsOauth2clientCredentialArgs Empty = new GetDomainsOauth2clientCredentialArgs();
     ...
     * 
     */
    @Import(name="oAuth2clientCredentialId", required=true)
    private Output<String> oAuth2clientCredentialId;

    /**
     * @return ID of the resource
     * 
     */
    public Output<String> oAuth2clientCredentialId() {
    ...
    private GetDomainsOauth2clientCredentialArgs() {}

    private GetDomainsOauth2clientCredentialArgs(GetDomainsOauth2clientCredentialArgs $) {
    ...
    public static Builder builder(GetDomainsOauth2clientCredentialArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsOauth2clientCredentialArgs();
        }

        public Builder(GetDomainsOauth2clientCredentialArgs defaults) {
            $ = new GetDomainsOauth2clientCredentialArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param oAuth2clientCredentialId ID of the resource
         * 
         * @return builder
         * 
         */
        public Builder oAuth2clientCredentialId(Output<String> oAuth2clientCredentialId) {
        ...
        public Builder oAuth2clientCredentialId(String oAuth2clientCredentialId) {
            return oAuth2clientCredentialId(Output.of(oAuth2clientCredentialId));
        }
        ...
        public GetDomainsOauth2clientCredentialArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsOauth2clientCredentialArgs", "idcsEndpoint");
            }
            if ($.oAuth2clientCredentialId == null) {
                throw new MissingRequiredPropertyException("GetDomainsOauth2clientCredentialArgs", "oAuth2clientCredentialId");
            }
            return $;
        }
    }
