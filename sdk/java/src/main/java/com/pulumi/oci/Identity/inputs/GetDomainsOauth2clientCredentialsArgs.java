...
public final class GetDomainsOauth2clientCredentialsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsOauth2clientCredentialsArgs Empty = new GetDomainsOauth2clientCredentialsArgs();
    ...
    private @Nullable Output<Integer> oauth2clientCredentialCount;
     ...
     * 
     */
    public Optional<Output<Integer>> oauth2clientCredentialCount() {
    ...
    private @Nullable Output<String> oauth2clientCredentialFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> oauth2clientCredentialFilter() {
    ...
    private GetDomainsOauth2clientCredentialsArgs() {}

    private GetDomainsOauth2clientCredentialsArgs(GetDomainsOauth2clientCredentialsArgs $) {
    ...
    public static Builder builder(GetDomainsOauth2clientCredentialsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsOauth2clientCredentialsArgs();
        }

        public Builder(GetDomainsOauth2clientCredentialsArgs defaults) {
            $ = new GetDomainsOauth2clientCredentialsArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder oauth2clientCredentialCount(@Nullable Output<Integer> oauth2clientCredentialCount) {
         ...
         * 
         */
        public Builder oauth2clientCredentialCount(Integer oauth2clientCredentialCount) {
            return oauth2clientCredentialCount(Output.of(oauth2clientCredentialCount));
        }
         ...
         * 
         */
        public Builder oauth2clientCredentialFilter(@Nullable Output<String> oauth2clientCredentialFilter) {
         ...
         * 
         */
        public Builder oauth2clientCredentialFilter(String oauth2clientCredentialFilter) {
            return oauth2clientCredentialFilter(Output.of(oauth2clientCredentialFilter));
        }
        ...
        public GetDomainsOauth2clientCredentialsArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsOauth2clientCredentialsArgs", "idcsEndpoint");
            }
            return $;
        }
    }
