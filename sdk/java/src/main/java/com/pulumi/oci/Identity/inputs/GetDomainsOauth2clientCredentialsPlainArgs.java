...
public final class GetDomainsOauth2clientCredentialsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsOauth2clientCredentialsPlainArgs Empty = new GetDomainsOauth2clientCredentialsPlainArgs();
     ...
     * 
     */
    @Import(name="oauth2clientCredentialCount")
     ...
     * 
     */
    @Import(name="oauth2clientCredentialFilter")
    ...
    private GetDomainsOauth2clientCredentialsPlainArgs() {}

    private GetDomainsOauth2clientCredentialsPlainArgs(GetDomainsOauth2clientCredentialsPlainArgs $) {
    ...
    public static Builder builder(GetDomainsOauth2clientCredentialsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsOauth2clientCredentialsPlainArgs();
        }

        public Builder(GetDomainsOauth2clientCredentialsPlainArgs defaults) {
            $ = new GetDomainsOauth2clientCredentialsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param oauth2clientCredentialCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder oauth2clientCredentialCount(@Nullable Integer oauth2clientCredentialCount) {
            $.oauth2clientCredentialCount = oauth2clientCredentialCount;
            return this;
        }

        /**
         * @param oauth2clientCredentialFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder oauth2clientCredentialFilter(@Nullable String oauth2clientCredentialFilter) {
            $.oauth2clientCredentialFilter = oauth2clientCredentialFilter;
            return this;
        }
        ...
        public GetDomainsOauth2clientCredentialsPlainArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsOauth2clientCredentialsPlainArgs", "idcsEndpoint");
            }
            return $;
        }
    }
