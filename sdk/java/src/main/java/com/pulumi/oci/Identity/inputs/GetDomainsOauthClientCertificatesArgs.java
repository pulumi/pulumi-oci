...
public final class GetDomainsOauthClientCertificatesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsOauthClientCertificatesArgs Empty = new GetDomainsOauthClientCertificatesArgs();
    ...
    private @Nullable Output<Integer> oauthClientCertificateCount;
     ...
     * 
     */
    public Optional<Output<Integer>> oauthClientCertificateCount() {
    ...
    private @Nullable Output<String> oauthClientCertificateFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> oauthClientCertificateFilter() {
    ...
    private GetDomainsOauthClientCertificatesArgs() {}

    private GetDomainsOauthClientCertificatesArgs(GetDomainsOauthClientCertificatesArgs $) {
    ...
    public static Builder builder(GetDomainsOauthClientCertificatesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsOauthClientCertificatesArgs();
        }

        public Builder(GetDomainsOauthClientCertificatesArgs defaults) {
            $ = new GetDomainsOauthClientCertificatesArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder oauthClientCertificateCount(@Nullable Output<Integer> oauthClientCertificateCount) {
         ...
         * 
         */
        public Builder oauthClientCertificateCount(Integer oauthClientCertificateCount) {
            return oauthClientCertificateCount(Output.of(oauthClientCertificateCount));
        }
         ...
         * 
         */
        public Builder oauthClientCertificateFilter(@Nullable Output<String> oauthClientCertificateFilter) {
         ...
         * 
         */
        public Builder oauthClientCertificateFilter(String oauthClientCertificateFilter) {
            return oauthClientCertificateFilter(Output.of(oauthClientCertificateFilter));
        }
        ...
        public GetDomainsOauthClientCertificatesArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsOauthClientCertificatesArgs", "idcsEndpoint");
            }
            return $;
        }
    }
