...
public final class GetDomainsOauthClientCertificatesPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsOauthClientCertificatesPlainArgs Empty = new GetDomainsOauthClientCertificatesPlainArgs();
     ...
     * 
     */
    @Import(name="oauthClientCertificateCount")
    private @Nullable Integer oauthClientCertificateCount;
     ...
     * 
     */
    public Optional<Integer> oauthClientCertificateCount() {
        return Optional.ofNullable(this.oauthClientCertificateCount);
    }
     ...
     * 
     */
    @Import(name="oauthClientCertificateFilter")
    private @Nullable String oauthClientCertificateFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<String> oauthClientCertificateFilter() {
        return Optional.ofNullable(this.oauthClientCertificateFilter);
    }
    ...
    private GetDomainsOauthClientCertificatesPlainArgs() {}

    private GetDomainsOauthClientCertificatesPlainArgs(GetDomainsOauthClientCertificatesPlainArgs $) {
        this.authorization = $.authorization;
        this.compartmentId = $.compartmentId;
        this.idcsEndpoint = $.idcsEndpoint;
        this.oauthClientCertificateCount = $.oauthClientCertificateCount;
        this.oauthClientCertificateFilter = $.oauthClientCertificateFilter;
    ...
    public static Builder builder(GetDomainsOauthClientCertificatesPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsOauthClientCertificatesPlainArgs();
        }

        public Builder(GetDomainsOauthClientCertificatesPlainArgs defaults) {
            $ = new GetDomainsOauthClientCertificatesPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param oauthClientCertificateCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder oauthClientCertificateCount(@Nullable Integer oauthClientCertificateCount) {
            $.oauthClientCertificateCount = oauthClientCertificateCount;
            return this;
        }

        /**
         * @param oauthClientCertificateFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder oauthClientCertificateFilter(@Nullable String oauthClientCertificateFilter) {
            $.oauthClientCertificateFilter = oauthClientCertificateFilter;
            return this;
        }
        ...
        public GetDomainsOauthClientCertificatesPlainArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsOauthClientCertificatesPlainArgs", "idcsEndpoint");
            }
            return $;
        }
    }
