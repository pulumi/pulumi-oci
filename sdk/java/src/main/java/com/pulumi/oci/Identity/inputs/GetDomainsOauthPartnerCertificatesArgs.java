...
public final class GetDomainsOauthPartnerCertificatesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsOauthPartnerCertificatesArgs Empty = new GetDomainsOauthPartnerCertificatesArgs();
     ...
     * 
     */
    @Import(name="oauthPartnerCertificateCount")
    private @Nullable Output<Integer> oauthPartnerCertificateCount;
     ...
     * 
     */
    public Optional<Output<Integer>> oauthPartnerCertificateCount() {
     ...
     * 
     */
    @Import(name="oauthPartnerCertificateFilter")
    private @Nullable Output<String> oauthPartnerCertificateFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> oauthPartnerCertificateFilter() {
    ...
    private GetDomainsOauthPartnerCertificatesArgs() {}

    private GetDomainsOauthPartnerCertificatesArgs(GetDomainsOauthPartnerCertificatesArgs $) {
    ...
    public static Builder builder(GetDomainsOauthPartnerCertificatesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsOauthPartnerCertificatesArgs();
        }

        public Builder(GetDomainsOauthPartnerCertificatesArgs defaults) {
            $ = new GetDomainsOauthPartnerCertificatesArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param oauthPartnerCertificateCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder oauthPartnerCertificateCount(@Nullable Output<Integer> oauthPartnerCertificateCount) {
            $.oauthPartnerCertificateCount = oauthPartnerCertificateCount;
            return this;
        }
         ...
         * 
         */
        public Builder oauthPartnerCertificateCount(Integer oauthPartnerCertificateCount) {
            return oauthPartnerCertificateCount(Output.of(oauthPartnerCertificateCount));
        }

        /**
         * @param oauthPartnerCertificateFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder oauthPartnerCertificateFilter(@Nullable Output<String> oauthPartnerCertificateFilter) {
            $.oauthPartnerCertificateFilter = oauthPartnerCertificateFilter;
            return this;
        }
         ...
         * 
         */
        public Builder oauthPartnerCertificateFilter(String oauthPartnerCertificateFilter) {
            return oauthPartnerCertificateFilter(Output.of(oauthPartnerCertificateFilter));
        }
        ...
        public GetDomainsOauthPartnerCertificatesArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsOauthPartnerCertificatesArgs", "idcsEndpoint");
            }
            return $;
        }
    }
