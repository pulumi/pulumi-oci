...
import com.pulumi.oci.Identity.inputs.GetDomainsOciConsoleSignOnPolicyConsentsFilterArgs;
...
public final class GetDomainsOciConsoleSignOnPolicyConsentsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsOciConsoleSignOnPolicyConsentsArgs Empty = new GetDomainsOciConsoleSignOnPolicyConsentsArgs();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetDomainsOciConsoleSignOnPolicyConsentsFilterArgs>> filters;

    public Optional<Output<List<GetDomainsOciConsoleSignOnPolicyConsentsFilterArgs>>> filters() {
    ...
    private @Nullable Output<Integer> ociConsoleSignOnPolicyConsentCount;
     ...
     * 
     */
    public Optional<Output<Integer>> ociConsoleSignOnPolicyConsentCount() {
    ...
    private @Nullable Output<String> ociConsoleSignOnPolicyConsentFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> ociConsoleSignOnPolicyConsentFilter() {
    ...
    private GetDomainsOciConsoleSignOnPolicyConsentsArgs() {}

    private GetDomainsOciConsoleSignOnPolicyConsentsArgs(GetDomainsOciConsoleSignOnPolicyConsentsArgs $) {
    ...
    public static Builder builder(GetDomainsOciConsoleSignOnPolicyConsentsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsOciConsoleSignOnPolicyConsentsArgs();
        }

        public Builder(GetDomainsOciConsoleSignOnPolicyConsentsArgs defaults) {
            $ = new GetDomainsOciConsoleSignOnPolicyConsentsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetDomainsOciConsoleSignOnPolicyConsentsFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetDomainsOciConsoleSignOnPolicyConsentsFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetDomainsOciConsoleSignOnPolicyConsentsFilterArgs... filters) {
         ...
         * 
         */
        public Builder ociConsoleSignOnPolicyConsentCount(@Nullable Output<Integer> ociConsoleSignOnPolicyConsentCount) {
         ...
         * 
         */
        public Builder ociConsoleSignOnPolicyConsentCount(Integer ociConsoleSignOnPolicyConsentCount) {
            return ociConsoleSignOnPolicyConsentCount(Output.of(ociConsoleSignOnPolicyConsentCount));
        }
         ...
         * 
         */
        public Builder ociConsoleSignOnPolicyConsentFilter(@Nullable Output<String> ociConsoleSignOnPolicyConsentFilter) {
         ...
         * 
         */
        public Builder ociConsoleSignOnPolicyConsentFilter(String ociConsoleSignOnPolicyConsentFilter) {
            return ociConsoleSignOnPolicyConsentFilter(Output.of(ociConsoleSignOnPolicyConsentFilter));
        }
        ...
        public GetDomainsOciConsoleSignOnPolicyConsentsArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsOciConsoleSignOnPolicyConsentsArgs", "idcsEndpoint");
            }
            return $;
        }
    }
