...
import com.pulumi.oci.Identity.inputs.GetDomainsOciConsoleSignOnPolicyConsentsFilter;
...
public final class GetDomainsOciConsoleSignOnPolicyConsentsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsOciConsoleSignOnPolicyConsentsPlainArgs Empty = new GetDomainsOciConsoleSignOnPolicyConsentsPlainArgs();
    ...
    public Optional<List<GetDomainsOciConsoleSignOnPolicyConsentsFilter>> filters() {
     ...
     * 
     */
    @Import(name="ociConsoleSignOnPolicyConsentCount")
     ...
     * 
     */
    @Import(name="ociConsoleSignOnPolicyConsentFilter")
    ...
    private GetDomainsOciConsoleSignOnPolicyConsentsPlainArgs() {}

    private GetDomainsOciConsoleSignOnPolicyConsentsPlainArgs(GetDomainsOciConsoleSignOnPolicyConsentsPlainArgs $) {
    ...
    public static Builder builder(GetDomainsOciConsoleSignOnPolicyConsentsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsOciConsoleSignOnPolicyConsentsPlainArgs();
        }

        public Builder(GetDomainsOciConsoleSignOnPolicyConsentsPlainArgs defaults) {
            $ = new GetDomainsOciConsoleSignOnPolicyConsentsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param ociConsoleSignOnPolicyConsentCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder ociConsoleSignOnPolicyConsentCount(@Nullable Integer ociConsoleSignOnPolicyConsentCount) {
            $.ociConsoleSignOnPolicyConsentCount = ociConsoleSignOnPolicyConsentCount;
            return this;
        }
        ...
        public GetDomainsOciConsoleSignOnPolicyConsentsPlainArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsOciConsoleSignOnPolicyConsentsPlainArgs", "idcsEndpoint");
            }
            return $;
        }
    }
