...
public final class GetDomainsPasswordPoliciesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsPasswordPoliciesArgs Empty = new GetDomainsPasswordPoliciesArgs();
     ...
     * 
     */
    @Import(name="passwordPolicyCount")
    private @Nullable Output<Integer> passwordPolicyCount;
     ...
     * 
     */
    public Optional<Output<Integer>> passwordPolicyCount() {
     ...
     * 
     */
    @Import(name="passwordPolicyFilter")
    private @Nullable Output<String> passwordPolicyFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> passwordPolicyFilter() {
    ...
    private GetDomainsPasswordPoliciesArgs() {}

    private GetDomainsPasswordPoliciesArgs(GetDomainsPasswordPoliciesArgs $) {
    ...
    public static Builder builder(GetDomainsPasswordPoliciesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsPasswordPoliciesArgs();
        }

        public Builder(GetDomainsPasswordPoliciesArgs defaults) {
            $ = new GetDomainsPasswordPoliciesArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param passwordPolicyCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder passwordPolicyCount(@Nullable Output<Integer> passwordPolicyCount) {
         ...
         * 
         */
        public Builder passwordPolicyCount(Integer passwordPolicyCount) {
            return passwordPolicyCount(Output.of(passwordPolicyCount));
        }

        /**
         * @param passwordPolicyFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder passwordPolicyFilter(@Nullable Output<String> passwordPolicyFilter) {
         ...
         * 
         */
        public Builder passwordPolicyFilter(String passwordPolicyFilter) {
            return passwordPolicyFilter(Output.of(passwordPolicyFilter));
        }
        ...
        public GetDomainsPasswordPoliciesArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsPasswordPoliciesArgs", "idcsEndpoint");
            }
            return $;
        }
    }
