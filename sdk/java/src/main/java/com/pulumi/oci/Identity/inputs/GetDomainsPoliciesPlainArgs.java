...
public final class GetDomainsPoliciesPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsPoliciesPlainArgs Empty = new GetDomainsPoliciesPlainArgs();
    ...
    private GetDomainsPoliciesPlainArgs() {}

    private GetDomainsPoliciesPlainArgs(GetDomainsPoliciesPlainArgs $) {
    ...
    public static Builder builder(GetDomainsPoliciesPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsPoliciesPlainArgs();
        }

        public Builder(GetDomainsPoliciesPlainArgs defaults) {
            $ = new GetDomainsPoliciesPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param policyCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        ...
        public GetDomainsPoliciesPlainArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsPoliciesPlainArgs", "idcsEndpoint");
            }
            return $;
        }
    }
