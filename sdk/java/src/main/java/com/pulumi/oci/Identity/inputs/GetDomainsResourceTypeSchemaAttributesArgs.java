...
public final class GetDomainsResourceTypeSchemaAttributesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsResourceTypeSchemaAttributesArgs Empty = new GetDomainsResourceTypeSchemaAttributesArgs();
     ...
     * 
     */
    @Import(name="resourceTypeSchemaAttributeCount")
    private @Nullable Output<Integer> resourceTypeSchemaAttributeCount;
     ...
     * 
     */
    public Optional<Output<Integer>> resourceTypeSchemaAttributeCount() {
        return Optional.ofNullable(this.resourceTypeSchemaAttributeCount);
    }
     ...
     * 
     */
    @Import(name="resourceTypeSchemaAttributeFilter")
    private @Nullable Output<String> resourceTypeSchemaAttributeFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> resourceTypeSchemaAttributeFilter() {
        return Optional.ofNullable(this.resourceTypeSchemaAttributeFilter);
    }
    ...
    private GetDomainsResourceTypeSchemaAttributesArgs() {}

    private GetDomainsResourceTypeSchemaAttributesArgs(GetDomainsResourceTypeSchemaAttributesArgs $) {
        this.attributeSets = $.attributeSets;
        this.attributes = $.attributes;
        this.authorization = $.authorization;
        this.compartmentId = $.compartmentId;
        this.idcsEndpoint = $.idcsEndpoint;
        this.resourceTypeSchemaAttributeCount = $.resourceTypeSchemaAttributeCount;
        this.resourceTypeSchemaAttributeFilter = $.resourceTypeSchemaAttributeFilter;
    ...
    public static Builder builder(GetDomainsResourceTypeSchemaAttributesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsResourceTypeSchemaAttributesArgs();
        }

        public Builder(GetDomainsResourceTypeSchemaAttributesArgs defaults) {
            $ = new GetDomainsResourceTypeSchemaAttributesArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param resourceTypeSchemaAttributeCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder resourceTypeSchemaAttributeCount(@Nullable Output<Integer> resourceTypeSchemaAttributeCount) {
         ...
         * 
         */
        public Builder resourceTypeSchemaAttributeCount(Integer resourceTypeSchemaAttributeCount) {
            return resourceTypeSchemaAttributeCount(Output.of(resourceTypeSchemaAttributeCount));
        }

        /**
         * @param resourceTypeSchemaAttributeFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder resourceTypeSchemaAttributeFilter(@Nullable Output<String> resourceTypeSchemaAttributeFilter) {
         ...
         * 
         */
        public Builder resourceTypeSchemaAttributeFilter(String resourceTypeSchemaAttributeFilter) {
            return resourceTypeSchemaAttributeFilter(Output.of(resourceTypeSchemaAttributeFilter));
        }
        ...
        public GetDomainsResourceTypeSchemaAttributesArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsResourceTypeSchemaAttributesArgs", "idcsEndpoint");
            }
            return $;
        }
    }
