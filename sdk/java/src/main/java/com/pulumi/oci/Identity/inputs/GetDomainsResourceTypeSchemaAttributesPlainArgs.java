...
public final class GetDomainsResourceTypeSchemaAttributesPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsResourceTypeSchemaAttributesPlainArgs Empty = new GetDomainsResourceTypeSchemaAttributesPlainArgs();
    ...
    private @Nullable Integer resourceTypeSchemaAttributeCount;
     ...
     * 
     */
    public Optional<Integer> resourceTypeSchemaAttributeCount() {
    ...
    private @Nullable String resourceTypeSchemaAttributeFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<String> resourceTypeSchemaAttributeFilter() {
    ...
    private GetDomainsResourceTypeSchemaAttributesPlainArgs() {}

    private GetDomainsResourceTypeSchemaAttributesPlainArgs(GetDomainsResourceTypeSchemaAttributesPlainArgs $) {
    ...
    public static Builder builder(GetDomainsResourceTypeSchemaAttributesPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsResourceTypeSchemaAttributesPlainArgs();
        }

        public Builder(GetDomainsResourceTypeSchemaAttributesPlainArgs defaults) {
            $ = new GetDomainsResourceTypeSchemaAttributesPlainArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder resourceTypeSchemaAttributeCount(@Nullable Integer resourceTypeSchemaAttributeCount) {
         ...
         * 
         */
        public Builder resourceTypeSchemaAttributeFilter(@Nullable String resourceTypeSchemaAttributeFilter) {
        ...
        public GetDomainsResourceTypeSchemaAttributesPlainArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsResourceTypeSchemaAttributesPlainArgs", "idcsEndpoint");
            }
            return $;
        }
    }
