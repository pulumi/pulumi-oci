...
public final class GetDomainsRulesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsRulesArgs Empty = new GetDomainsRulesArgs();
    ...
    private GetDomainsRulesArgs() {}

    private GetDomainsRulesArgs(GetDomainsRulesArgs $) {
    ...
    public static Builder builder(GetDomainsRulesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsRulesArgs();
        }

        public Builder(GetDomainsRulesArgs defaults) {
            $ = new GetDomainsRulesArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param ruleCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param ruleFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder ruleFilter(@Nullable Output<String> ruleFilter) {
         ...
         * 
         */
        public Builder ruleFilter(String ruleFilter) {
            return ruleFilter(Output.of(ruleFilter));
        }
        ...
        public GetDomainsRulesArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsRulesArgs", "idcsEndpoint");
            }
            return $;
        }
    }
