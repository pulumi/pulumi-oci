...
public final class GetDomainsSecurityQuestionsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsSecurityQuestionsArgs Empty = new GetDomainsSecurityQuestionsArgs();
     ...
     * 
     */
    @Import(name="securityQuestionCount")
    private @Nullable Output<Integer> securityQuestionCount;
     ...
     * 
     */
    public Optional<Output<Integer>> securityQuestionCount() {
     ...
     * 
     */
    @Import(name="securityQuestionFilter")
    private @Nullable Output<String> securityQuestionFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> securityQuestionFilter() {
        return Optional.ofNullable(this.securityQuestionFilter);
    }
    ...
    private GetDomainsSecurityQuestionsArgs() {}

    private GetDomainsSecurityQuestionsArgs(GetDomainsSecurityQuestionsArgs $) {
    ...
    public static Builder builder(GetDomainsSecurityQuestionsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsSecurityQuestionsArgs();
        }

        public Builder(GetDomainsSecurityQuestionsArgs defaults) {
            $ = new GetDomainsSecurityQuestionsArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param securityQuestionCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder securityQuestionCount(@Nullable Output<Integer> securityQuestionCount) {
         ...
         * 
         */
        public Builder securityQuestionCount(Integer securityQuestionCount) {
            return securityQuestionCount(Output.of(securityQuestionCount));
        }

        /**
         * @param securityQuestionFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder securityQuestionFilter(@Nullable Output<String> securityQuestionFilter) {
            $.securityQuestionFilter = securityQuestionFilter;
            return this;
        }
         ...
         * 
         */
        public Builder securityQuestionFilter(String securityQuestionFilter) {
            return securityQuestionFilter(Output.of(securityQuestionFilter));
        }
        ...
        public GetDomainsSecurityQuestionsArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsSecurityQuestionsArgs", "idcsEndpoint");
            }
            return $;
        }
    }
