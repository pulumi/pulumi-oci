...
public final class GetDomainsSelfRegistrationProfilesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsSelfRegistrationProfilesArgs Empty = new GetDomainsSelfRegistrationProfilesArgs();
     ...
     * 
     */
    @Import(name="selfRegistrationProfileCount")
    private @Nullable Output<Integer> selfRegistrationProfileCount;
     ...
     * 
     */
    public Optional<Output<Integer>> selfRegistrationProfileCount() {
        return Optional.ofNullable(this.selfRegistrationProfileCount);
    }
     ...
     * 
     */
    @Import(name="selfRegistrationProfileFilter")
    private @Nullable Output<String> selfRegistrationProfileFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> selfRegistrationProfileFilter() {
        return Optional.ofNullable(this.selfRegistrationProfileFilter);
    }
    ...
    private GetDomainsSelfRegistrationProfilesArgs() {}

    private GetDomainsSelfRegistrationProfilesArgs(GetDomainsSelfRegistrationProfilesArgs $) {
        ...
        this.selfRegistrationProfileCount = $.selfRegistrationProfileCount;
        this.selfRegistrationProfileFilter = $.selfRegistrationProfileFilter;
        this.sortBy = $.sortBy;
    ...
    public static Builder builder(GetDomainsSelfRegistrationProfilesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsSelfRegistrationProfilesArgs();
        }

        public Builder(GetDomainsSelfRegistrationProfilesArgs defaults) {
            $ = new GetDomainsSelfRegistrationProfilesArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param selfRegistrationProfileCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder selfRegistrationProfileCount(@Nullable Output<Integer> selfRegistrationProfileCount) {
            $.selfRegistrationProfileCount = selfRegistrationProfileCount;
            return this;
        }
         ...
         * 
         */
        public Builder selfRegistrationProfileCount(Integer selfRegistrationProfileCount) {
            return selfRegistrationProfileCount(Output.of(selfRegistrationProfileCount));
        }

        /**
         * @param selfRegistrationProfileFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder selfRegistrationProfileFilter(@Nullable Output<String> selfRegistrationProfileFilter) {
            $.selfRegistrationProfileFilter = selfRegistrationProfileFilter;
            return this;
        }
         ...
         * 
         */
        public Builder selfRegistrationProfileFilter(String selfRegistrationProfileFilter) {
            return selfRegistrationProfileFilter(Output.of(selfRegistrationProfileFilter));
        }
        ...
        public GetDomainsSelfRegistrationProfilesArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsSelfRegistrationProfilesArgs", "idcsEndpoint");
            }
            return $;
        }
    }
