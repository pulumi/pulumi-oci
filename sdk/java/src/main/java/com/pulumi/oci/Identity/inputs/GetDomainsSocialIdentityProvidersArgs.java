...
public final class GetDomainsSocialIdentityProvidersArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsSocialIdentityProvidersArgs Empty = new GetDomainsSocialIdentityProvidersArgs();
    ...
    private @Nullable Output<Integer> socialIdentityProviderCount;
     ...
     * 
     */
    public Optional<Output<Integer>> socialIdentityProviderCount() {
    ...
    private @Nullable Output<String> socialIdentityProviderFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> socialIdentityProviderFilter() {
    ...
    private GetDomainsSocialIdentityProvidersArgs() {}

    private GetDomainsSocialIdentityProvidersArgs(GetDomainsSocialIdentityProvidersArgs $) {
    ...
    public static Builder builder(GetDomainsSocialIdentityProvidersArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsSocialIdentityProvidersArgs();
        }

        public Builder(GetDomainsSocialIdentityProvidersArgs defaults) {
            $ = new GetDomainsSocialIdentityProvidersArgs(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder socialIdentityProviderCount(@Nullable Output<Integer> socialIdentityProviderCount) {
         ...
         * 
         */
        public Builder socialIdentityProviderCount(Integer socialIdentityProviderCount) {
            return socialIdentityProviderCount(Output.of(socialIdentityProviderCount));
        }
         ...
         * 
         */
        public Builder socialIdentityProviderFilter(@Nullable Output<String> socialIdentityProviderFilter) {
         ...
         * 
         */
        public Builder socialIdentityProviderFilter(String socialIdentityProviderFilter) {
            return socialIdentityProviderFilter(Output.of(socialIdentityProviderFilter));
        }
        ...
        public GetDomainsSocialIdentityProvidersArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsSocialIdentityProvidersArgs", "idcsEndpoint");
            }
            return $;
        }
    }
