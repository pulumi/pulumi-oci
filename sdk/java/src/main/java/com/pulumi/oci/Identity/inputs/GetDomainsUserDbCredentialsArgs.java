...
public final class GetDomainsUserDbCredentialsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetDomainsUserDbCredentialsArgs Empty = new GetDomainsUserDbCredentialsArgs();
     ...
     * 
     */
    @Import(name="userDbCredentialCount")
    private @Nullable Output<Integer> userDbCredentialCount;
     ...
     * 
     */
    public Optional<Output<Integer>> userDbCredentialCount() {
     ...
     * 
     */
    @Import(name="userDbCredentialFilter")
    private @Nullable Output<String> userDbCredentialFilter;

    /**
     * @return OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
     * 
     */
    public Optional<Output<String>> userDbCredentialFilter() {
        return Optional.ofNullable(this.userDbCredentialFilter);
    }

    private GetDomainsUserDbCredentialsArgs() {}

    private GetDomainsUserDbCredentialsArgs(GetDomainsUserDbCredentialsArgs $) {
    ...
    public static Builder builder(GetDomainsUserDbCredentialsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetDomainsUserDbCredentialsArgs();
        }

        public Builder(GetDomainsUserDbCredentialsArgs defaults) {
            $ = new GetDomainsUserDbCredentialsArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param userDbCredentialCount OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
         * 
         * @return builder
         * 
         */
        public Builder userDbCredentialCount(@Nullable Output<Integer> userDbCredentialCount) {
            $.userDbCredentialCount = userDbCredentialCount;
            return this;
        }
         ...
         * 
         */
        public Builder userDbCredentialCount(Integer userDbCredentialCount) {
            return userDbCredentialCount(Output.of(userDbCredentialCount));
        }

        /**
         * @param userDbCredentialFilter OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
         * 
         * @return builder
         * 
         */
        public Builder userDbCredentialFilter(@Nullable Output<String> userDbCredentialFilter) {
            $.userDbCredentialFilter = userDbCredentialFilter;
            return this;
        }
         ...
         * 
         */
        public Builder userDbCredentialFilter(String userDbCredentialFilter) {
            return userDbCredentialFilter(Output.of(userDbCredentialFilter));
        }

        public GetDomainsUserDbCredentialsArgs build() {
            if ($.idcsEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDomainsUserDbCredentialsArgs", "idcsEndpoint");
            }
            return $;
        }
    }
