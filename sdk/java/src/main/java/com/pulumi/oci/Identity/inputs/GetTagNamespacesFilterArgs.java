...
public final class GetTagNamespacesFilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public GetTagNamespacesFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetTagNamespacesFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetTagNamespacesFilterArgs", "values");
            }
            return $;
        }
    }
