...
public final class GetTagNamespacesPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetTagNamespacesPlainArgs Empty = new GetTagNamespacesPlainArgs();
    ...
    private GetTagNamespacesPlainArgs() {}

    private GetTagNamespacesPlainArgs(GetTagNamespacesPlainArgs $) {
    ...
    public static Builder builder(GetTagNamespacesPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetTagNamespacesPlainArgs();
        }

        public Builder(GetTagNamespacesPlainArgs defaults) {
            $ = new GetTagNamespacesPlainArgs(Objects.requireNonNull(defaults));
        }
