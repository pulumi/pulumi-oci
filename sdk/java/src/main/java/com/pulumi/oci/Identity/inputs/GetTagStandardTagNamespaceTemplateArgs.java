    ...
    public static final class Builder {
        ...
        public GetTagStandardTagNamespaceTemplateArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetTagStandardTagNamespaceTemplateArgs", "compartmentId");
            }
            if ($.standardTagNamespaceName == null) {
                throw new MissingRequiredPropertyException("GetTagStandardTagNamespaceTemplateArgs", "standardTagNamespaceName");
            }
            return $;
        }
    }
