...
@CustomType
public final class DomainsApiKeyMeta {
    /**
    ...
    public static Builder builder(DomainsApiKeyMeta defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(DomainsApiKeyMeta defaults) {
