...
public final class DomainsAppIdcsCreatedBy {
    ...
    public static Builder builder(DomainsAppIdcsCreatedBy defaults) {
    ...
    public static final class Builder {
        ...
        private String value;
        public Builder() {}
        public Builder(DomainsAppIdcsCreatedBy defaults) {
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DomainsAppIdcsCreatedBy", "value");
            }
            this.value = value;
            return this;
        }
        public DomainsAppIdcsCreatedBy build() {
            final var _resultValue = new DomainsAppIdcsCreatedBy();
