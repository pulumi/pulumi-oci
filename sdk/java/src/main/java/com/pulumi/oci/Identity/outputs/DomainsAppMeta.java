...
@CustomType
public final class DomainsAppMeta {
    /**
    ...
    public static Builder builder(DomainsAppMeta defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(DomainsAppMeta defaults) {
        ...
        public DomainsAppMeta build() {
            final var _resultValue = new DomainsAppMeta();
