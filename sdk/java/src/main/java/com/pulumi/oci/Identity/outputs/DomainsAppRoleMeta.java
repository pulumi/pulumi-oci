...
@CustomType
public final class DomainsAppRoleMeta {
    /**
    ...
    public static Builder builder(DomainsAppRoleMeta defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(DomainsAppRoleMeta defaults) {
        ...
        public DomainsAppRoleMeta build() {
            final var _resultValue = new DomainsAppRoleMeta();
