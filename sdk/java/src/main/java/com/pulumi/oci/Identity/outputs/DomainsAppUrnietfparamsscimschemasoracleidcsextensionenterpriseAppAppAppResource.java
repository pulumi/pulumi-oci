...
public final class DomainsAppUrnietfparamsscimschemasoracleidcsextensionenterpriseAppAppAppResource {
    ...
    public static Builder builder(DomainsAppUrnietfparamsscimschemasoracleidcsextensionenterpriseAppAppAppResource defaults) {
    ...
    public static final class Builder {
        ...
        private String value;
        public Builder() {}
        public Builder(DomainsAppUrnietfparamsscimschemasoracleidcsextensionenterpriseAppAppAppResource defaults) {
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DomainsAppUrnietfparamsscimschemasoracleidcsextensionenterpriseAppAppAppResource", "value");
            }
            this.value = value;
            return this;
        }
