...
public final class DomainsAuthTokenIdcsLastModifiedBy {
    ...
    public static Builder builder(DomainsAuthTokenIdcsLastModifiedBy defaults) {
    ...
    public static final class Builder {
        ...
        private String value;
        public Builder() {}
        public Builder(DomainsAuthTokenIdcsLastModifiedBy defaults) {
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DomainsAuthTokenIdcsLastModifiedBy", "value");
            }
            this.value = value;
            return this;
        }
        public DomainsAuthTokenIdcsLastModifiedBy build() {
            final var _resultValue = new DomainsAuthTokenIdcsLastModifiedBy();
