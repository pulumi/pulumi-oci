...
@CustomType
public final class DomainsAuthTokenMeta {
    /**
    ...
    public static Builder builder(DomainsAuthTokenMeta defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(DomainsAuthTokenMeta defaults) {
        ...
        public DomainsAuthTokenMeta build() {
            final var _resultValue = new DomainsAuthTokenMeta();
