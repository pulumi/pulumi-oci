...
public final class DomainsCloudGateIdcsCreatedBy {
    ...
    public static Builder builder(DomainsCloudGateIdcsCreatedBy defaults) {
    ...
    public static final class Builder {
        ...
        private String value;
        public Builder() {}
        public Builder(DomainsCloudGateIdcsCreatedBy defaults) {
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DomainsCloudGateIdcsCreatedBy", "value");
            }
            this.value = value;
            return this;
        }
        public DomainsCloudGateIdcsCreatedBy build() {
            final var _resultValue = new DomainsCloudGateIdcsCreatedBy();
