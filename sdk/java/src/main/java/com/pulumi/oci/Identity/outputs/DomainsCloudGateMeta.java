...
@CustomType
public final class DomainsCloudGateMeta {
    /**
    ...
    public static Builder builder(DomainsCloudGateMeta defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(DomainsCloudGateMeta defaults) {
        ...
        public DomainsCloudGateMeta build() {
            final var _resultValue = new DomainsCloudGateMeta();
