...
public final class DomainsCloudGateServerIdcsLastModifiedBy {
    ...
    public static final class Builder {
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DomainsCloudGateServerIdcsLastModifiedBy", "value");
            }
            this.value = value;
            return this;
        }
        public DomainsCloudGateServerIdcsLastModifiedBy build() {
            final var _resultValue = new DomainsCloudGateServerIdcsLastModifiedBy();
