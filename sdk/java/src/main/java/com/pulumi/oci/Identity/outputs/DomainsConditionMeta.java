...
@CustomType
public final class DomainsConditionMeta {
    /**
    ...
    public static Builder builder(DomainsConditionMeta defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(DomainsConditionMeta defaults) {
        ...
        public DomainsConditionMeta build() {
            final var _resultValue = new DomainsConditionMeta();
