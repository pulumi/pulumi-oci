...
@CustomType
public final class DomainsCustomerSecretKeyMeta {
    /**
    ...
    public static Builder builder(DomainsCustomerSecretKeyMeta defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(DomainsCustomerSecretKeyMeta defaults) {
        ...
        public DomainsCustomerSecretKeyMeta build() {
            final var _resultValue = new DomainsCustomerSecretKeyMeta();
