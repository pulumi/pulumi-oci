...
public final class DomainsDynamicResourceGroupTag {
    ...
    public static Builder builder(DomainsDynamicResourceGroupTag defaults) {
    ...
    public static final class Builder {
        ...
        private String value;
        public Builder() {}
        public Builder(DomainsDynamicResourceGroupTag defaults) {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("DomainsDynamicResourceGroupTag", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DomainsDynamicResourceGroupTag", "value");
            }
            this.value = value;
            return this;
        }
