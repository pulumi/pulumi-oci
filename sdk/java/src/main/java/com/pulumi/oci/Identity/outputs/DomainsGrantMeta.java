...
@CustomType
public final class DomainsGrantMeta {
    /**
    ...
    public static Builder builder(DomainsGrantMeta defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(DomainsGrantMeta defaults) {
        ...
        public DomainsGrantMeta build() {
            final var _resultValue = new DomainsGrantMeta();
