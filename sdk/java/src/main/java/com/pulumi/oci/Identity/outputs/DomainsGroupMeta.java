...
@CustomType
public final class DomainsGroupMeta {
    /**
    ...
    public static Builder builder(DomainsGroupMeta defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(DomainsGroupMeta defaults) {
        ...
        public DomainsGroupMeta build() {
            final var _resultValue = new DomainsGroupMeta();
