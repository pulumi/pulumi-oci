...
public final class DomainsIdentityProviderIdcsLastModifiedBy {
    ...
    public static Builder builder(DomainsIdentityProviderIdcsLastModifiedBy defaults) {
    ...
    public static final class Builder {
        ...
        private String value;
        public Builder() {}
        public Builder(DomainsIdentityProviderIdcsLastModifiedBy defaults) {
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DomainsIdentityProviderIdcsLastModifiedBy", "value");
            }
            this.value = value;
            return this;
        }
        public DomainsIdentityProviderIdcsLastModifiedBy build() {
            final var _resultValue = new DomainsIdentityProviderIdcsLastModifiedBy();
