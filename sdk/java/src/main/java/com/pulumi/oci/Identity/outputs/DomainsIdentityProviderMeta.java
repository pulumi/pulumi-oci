...
@CustomType
public final class DomainsIdentityProviderMeta {
    /**
    ...
    public static Builder builder(DomainsIdentityProviderMeta defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(DomainsIdentityProviderMeta defaults) {
        ...
        public DomainsIdentityProviderMeta build() {
            final var _resultValue = new DomainsIdentityProviderMeta();
