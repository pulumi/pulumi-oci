...
@CustomType
public final class DomainsIdentitySettingPosixUid {
    /**
    ...
    public static Builder builder(DomainsIdentitySettingPosixUid defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Integer manualAssignmentStartsFrom;
        public Builder() {}
        public Builder(DomainsIdentitySettingPosixUid defaults) {
