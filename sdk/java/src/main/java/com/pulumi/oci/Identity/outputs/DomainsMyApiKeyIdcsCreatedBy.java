...
@CustomType
public final class DomainsMyApiKeyIdcsCreatedBy {
    /**
    ...
    private DomainsMyApiKeyIdcsCreatedBy() {}
    /**
     * @return (Updatable) The user&#39;s display name.
     * 
     * **SCIM++ Properties:**
    ...
    public static Builder builder(DomainsMyApiKeyIdcsCreatedBy defaults) {
    ...
    public static final class Builder {
        ...
        private String value;
        public Builder() {}
        public Builder(DomainsMyApiKeyIdcsCreatedBy defaults) {
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DomainsMyApiKeyIdcsCreatedBy", "value");
            }
            this.value = value;
            return this;
        }
        public DomainsMyApiKeyIdcsCreatedBy build() {
            final var _resultValue = new DomainsMyApiKeyIdcsCreatedBy();
