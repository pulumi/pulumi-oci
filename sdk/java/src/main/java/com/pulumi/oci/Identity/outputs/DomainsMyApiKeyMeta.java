...
@CustomType
public final class DomainsMyApiKeyMeta {
    /**
    ...
    public static Builder builder(DomainsMyApiKeyMeta defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(DomainsMyApiKeyMeta defaults) {
        ...
        public DomainsMyApiKeyMeta build() {
            final var _resultValue = new DomainsMyApiKeyMeta();
