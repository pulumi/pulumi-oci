...
@CustomType
public final class DomainsMyAuthTokenMeta {
    /**
    ...
    private DomainsMyAuthTokenMeta() {}
    /**
     * @return The DateTime the Resource was added to the Service Provider
     * 
     * **SCIM++ Properties:**
    ...
    public static Builder builder(DomainsMyAuthTokenMeta defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(DomainsMyAuthTokenMeta defaults) {
        ...
        public DomainsMyAuthTokenMeta build() {
            final var _resultValue = new DomainsMyAuthTokenMeta();
