...
public final class DomainsMyCustomerSecretKeyIdcsLastModifiedBy {
    ...
    public static final class Builder {
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DomainsMyCustomerSecretKeyIdcsLastModifiedBy", "value");
            }
            this.value = value;
            return this;
        }
        public DomainsMyCustomerSecretKeyIdcsLastModifiedBy build() {
            final var _resultValue = new DomainsMyCustomerSecretKeyIdcsLastModifiedBy();
