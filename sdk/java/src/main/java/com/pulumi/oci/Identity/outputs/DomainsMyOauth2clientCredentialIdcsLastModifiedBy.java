...
public final class DomainsMyOauth2clientCredentialIdcsLastModifiedBy {
    ...
    public static Builder builder(DomainsMyOauth2clientCredentialIdcsLastModifiedBy defaults) {
    ...
    public static final class Builder {
        ...
        private String value;
        public Builder() {}
        public Builder(DomainsMyOauth2clientCredentialIdcsLastModifiedBy defaults) {
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DomainsMyOauth2clientCredentialIdcsLastModifiedBy", "value");
            }
            this.value = value;
            return this;
        }
        public DomainsMyOauth2clientCredentialIdcsLastModifiedBy build() {
            final var _resultValue = new DomainsMyOauth2clientCredentialIdcsLastModifiedBy();
