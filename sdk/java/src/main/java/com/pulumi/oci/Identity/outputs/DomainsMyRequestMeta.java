...
@CustomType
public final class DomainsMyRequestMeta {
    /**
    ...
    public static Builder builder(DomainsMyRequestMeta defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(DomainsMyRequestMeta defaults) {
        ...
        public DomainsMyRequestMeta build() {
            final var _resultValue = new DomainsMyRequestMeta();
