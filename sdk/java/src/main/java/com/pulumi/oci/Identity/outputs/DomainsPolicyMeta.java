...
@CustomType
public final class DomainsPolicyMeta {
    /**
    ...
    public static Builder builder(DomainsPolicyMeta defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(DomainsPolicyMeta defaults) {
        ...
        public DomainsPolicyMeta build() {
            final var _resultValue = new DomainsPolicyMeta();
