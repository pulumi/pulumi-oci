...
@CustomType
public final class DomainsRuleMeta {
    /**
    ...
    public static Builder builder(DomainsRuleMeta defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(DomainsRuleMeta defaults) {
        ...
        public DomainsRuleMeta build() {
            final var _resultValue = new DomainsRuleMeta();
