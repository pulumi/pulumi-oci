...
@CustomType
public final class DomainsSettingMeta {
    /**
    ...
    public static Builder builder(DomainsSettingMeta defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(DomainsSettingMeta defaults) {
        ...
        public DomainsSettingMeta build() {
            final var _resultValue = new DomainsSettingMeta();
