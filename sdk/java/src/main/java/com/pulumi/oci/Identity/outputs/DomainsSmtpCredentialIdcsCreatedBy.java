...
public final class DomainsSmtpCredentialIdcsCreatedBy {
    ...
    public static Builder builder(DomainsSmtpCredentialIdcsCreatedBy defaults) {
    ...
    public static final class Builder {
        ...
        private String value;
        public Builder() {}
        public Builder(DomainsSmtpCredentialIdcsCreatedBy defaults) {
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DomainsSmtpCredentialIdcsCreatedBy", "value");
            }
            this.value = value;
            return this;
        }
        public DomainsSmtpCredentialIdcsCreatedBy build() {
            final var _resultValue = new DomainsSmtpCredentialIdcsCreatedBy();
