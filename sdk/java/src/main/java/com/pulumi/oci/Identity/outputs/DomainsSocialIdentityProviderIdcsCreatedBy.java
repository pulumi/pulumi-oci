...
@CustomType
public final class DomainsSocialIdentityProviderIdcsCreatedBy {
    /**
    ...
    private DomainsSocialIdentityProviderIdcsCreatedBy() {}
    /**
     * @return (Updatable) The displayName of the User or App who created this Resource
     * 
     * **SCIM++ Properties:**
    ...
    public static Builder builder(DomainsSocialIdentityProviderIdcsCreatedBy defaults) {
    ...
    public static final class Builder {
        ...
        private String value;
        public Builder() {}
        public Builder(DomainsSocialIdentityProviderIdcsCreatedBy defaults) {
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DomainsSocialIdentityProviderIdcsCreatedBy", "value");
            }
            this.value = value;
            return this;
        }
        public DomainsSocialIdentityProviderIdcsCreatedBy build() {
            final var _resultValue = new DomainsSocialIdentityProviderIdcsCreatedBy();
