...
@CustomType
public final class DomainsUserDbCredentialMeta {
    /**
    ...
    public static Builder builder(DomainsUserDbCredentialMeta defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(DomainsUserDbCredentialMeta defaults) {
        ...
        public DomainsUserDbCredentialMeta build() {
            final var _resultValue = new DomainsUserDbCredentialMeta();
