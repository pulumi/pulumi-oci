...
public final class DomainsUserIdcsCreatedBy {
    ...
    public static Builder builder(DomainsUserIdcsCreatedBy defaults) {
    ...
    public static final class Builder {
        ...
        private String value;
        public Builder() {}
        public Builder(DomainsUserIdcsCreatedBy defaults) {
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("DomainsUserIdcsCreatedBy", "value");
            }
            this.value = value;
            return this;
        }
        public DomainsUserIdcsCreatedBy build() {
            final var _resultValue = new DomainsUserIdcsCreatedBy();
