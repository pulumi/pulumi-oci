...
@CustomType
public final class DomainsUserMeta {
    /**
    ...
    public static Builder builder(DomainsUserMeta defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String version;
        public Builder() {}
        public Builder(DomainsUserMeta defaults) {
        ...
        public DomainsUserMeta build() {
            final var _resultValue = new DomainsUserMeta();
