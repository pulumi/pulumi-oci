...
@CustomType
public final class GetDomainsApiKeyMeta {
    /**
    ...
    public static Builder builder(GetDomainsApiKeyMeta defaults) {
    ...
    public static final class Builder {
        ...
        private String version;
        public Builder() {}
        public Builder(GetDomainsApiKeyMeta defaults) {
        ...
        public Builder created(String created) {
            if (created == null) {
              throw new MissingRequiredPropertyException("GetDomainsApiKeyMeta", "created");
            }
        ...
        public Builder lastModified(String lastModified) {
            if (lastModified == null) {
              throw new MissingRequiredPropertyException("GetDomainsApiKeyMeta", "lastModified");
            }
        ...
        public Builder location(String location) {
            if (location == null) {
              throw new MissingRequiredPropertyException("GetDomainsApiKeyMeta", "location");
            }
        ...
        public Builder resourceType(String resourceType) {
            if (resourceType == null) {
              throw new MissingRequiredPropertyException("GetDomainsApiKeyMeta", "resourceType");
            }
        ...
        public Builder version(String version) {
            if (version == null) {
              throw new MissingRequiredPropertyException("GetDomainsApiKeyMeta", "version");
            }
            this.version = version;
            return this;
        }
        public GetDomainsApiKeyMeta build() {
            final var _resultValue = new GetDomainsApiKeyMeta();
