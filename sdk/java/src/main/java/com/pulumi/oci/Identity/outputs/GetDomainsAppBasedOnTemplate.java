...
public final class GetDomainsAppBasedOnTemplate {
    ...
    public static Builder builder(GetDomainsAppBasedOnTemplate defaults) {
    ...
    public static final class Builder {
        ...
        public Builder lastModified(String lastModified) {
            if (lastModified == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppBasedOnTemplate", "lastModified");
            }
        ...
        public Builder ref(String ref) {
            if (ref == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppBasedOnTemplate", "ref");
            }
            this.ref = ref;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppBasedOnTemplate", "value");
            }
            this.value = value;
            return this;
        }
        ...
        public Builder wellKnownId(String wellKnownId) {
            if (wellKnownId == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppBasedOnTemplate", "wellKnownId");
            }
