...
public final class GetDomainsAppGrantedAppRole {
    ...
    public static final class Builder {
        ...
        public Builder adminRole(Boolean adminRole) {
            if (adminRole == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppGrantedAppRole", "adminRole");
            }
        ...
        public Builder appId(String appId) {
            if (appId == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppGrantedAppRole", "appId");
            }
            this.appId = appId;
            return this;
        }
        ...
        public Builder appName(String appName) {
            if (appName == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppGrantedAppRole", "appName");
            }
        ...
        public Builder display(String display) {
            if (display == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppGrantedAppRole", "display");
            }
        ...
        public Builder legacyGroupName(String legacyGroupName) {
            if (legacyGroupName == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppGrantedAppRole", "legacyGroupName");
            }
        ...
        public Builder readOnly(Boolean readOnly) {
            if (readOnly == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppGrantedAppRole", "readOnly");
            }
        ...
        public Builder ref(String ref) {
            if (ref == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppGrantedAppRole", "ref");
            }
            this.ref = ref;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppGrantedAppRole", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppGrantedAppRole", "value");
            }
            this.value = value;
            return this;
        }
