...
import com.pulumi.oci.Identity.outputs.GetDomainsAppUrnietfparamsscimschemasoracleidcsextensionformFillAppTemplateAppTemplateFormFillUrlMatch;
...
@CustomType
public final class GetDomainsAppUrnietfparamsscimschemasoracleidcsextensionformFillAppTemplateAppTemplate {
    /**
     ...
     * 
     */
    private List<GetDomainsAppUrnietfparamsscimschemasoracleidcsextensionformFillAppTemplateAppTemplateFormFillUrlMatch> formFillUrlMatches;
    /**
    ...
    private GetDomainsAppUrnietfparamsscimschemasoracleidcsextensionformFillAppTemplateAppTemplate() {}
    /**
     * @return FormFill Application Configuration CLOB which has to be maintained in Form-Fill APP for legacy code to do Form-Fill injection
     * 
     */
     ...
     * 
     */
    public List<GetDomainsAppUrnietfparamsscimschemasoracleidcsextensionformFillAppTemplateAppTemplateFormFillUrlMatch> formFillUrlMatches() {
    ...
    public static Builder builder(GetDomainsAppUrnietfparamsscimschemasoracleidcsextensionformFillAppTemplateAppTemplate defaults) {
    ...
    public static final class Builder {
        ...
        private String userNameFormTemplate;
        public Builder() {}
        public Builder(GetDomainsAppUrnietfparamsscimschemasoracleidcsextensionformFillAppTemplateAppTemplate defaults) {
        ...
        public Builder configuration(String configuration) {
            if (configuration == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppUrnietfparamsscimschemasoracleidcsextensionformFillAppTemplateAppTemplate", "configuration");
            }
        ...
        public Builder formCredMethod(String formCredMethod) {
            if (formCredMethod == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppUrnietfparamsscimschemasoracleidcsextensionformFillAppTemplateAppTemplate", "formCredMethod");
            }
        ...
        public Builder formCredentialSharingGroupId(String formCredentialSharingGroupId) {
            if (formCredentialSharingGroupId == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppUrnietfparamsscimschemasoracleidcsextensionformFillAppTemplateAppTemplate", "formCredentialSharingGroupId");
            }
            this.formCredentialSharingGroupId = formCredentialSharingGroupId;
            return this;
        }
        @CustomType.Setter
        public Builder formFillUrlMatches(List<GetDomainsAppUrnietfparamsscimschemasoracleidcsextensionformFillAppTemplateAppTemplateFormFillUrlMatch> formFillUrlMatches) {
            if (formFillUrlMatches == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppUrnietfparamsscimschemasoracleidcsextensionformFillAppTemplateAppTemplate", "formFillUrlMatches");
            }
            this.formFillUrlMatches = formFillUrlMatches;
            return this;
        }
        public Builder formFillUrlMatches(GetDomainsAppUrnietfparamsscimschemasoracleidcsextensionformFillAppTemplateAppTemplateFormFillUrlMatch... formFillUrlMatches) {
            return formFillUrlMatches(List.of(formFillUrlMatches));
        }
        @CustomType.Setter
        public Builder formType(String formType) {
            if (formType == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppUrnietfparamsscimschemasoracleidcsextensionformFillAppTemplateAppTemplate", "formType");
            }
        ...
        public Builder revealPasswordOnForm(Boolean revealPasswordOnForm) {
            if (revealPasswordOnForm == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppUrnietfparamsscimschemasoracleidcsextensionformFillAppTemplateAppTemplate", "revealPasswordOnForm");
            }
        ...
        public Builder syncFromTemplate(Boolean syncFromTemplate) {
            if (syncFromTemplate == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppUrnietfparamsscimschemasoracleidcsextensionformFillAppTemplateAppTemplate", "syncFromTemplate");
            }
        ...
        public Builder userNameFormExpression(String userNameFormExpression) {
            if (userNameFormExpression == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppUrnietfparamsscimschemasoracleidcsextensionformFillAppTemplateAppTemplate", "userNameFormExpression");
            }
        ...
        public Builder userNameFormTemplate(String userNameFormTemplate) {
            if (userNameFormTemplate == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppUrnietfparamsscimschemasoracleidcsextensionformFillAppTemplateAppTemplate", "userNameFormTemplate");
            }
