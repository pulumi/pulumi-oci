...
public final class GetDomainsAppsAppAllowedScope {
    ...
    public static final class Builder {
        ...
        public Builder fqs(String fqs) {
            if (fqs == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppAllowedScope", "fqs");
            }
            this.fqs = fqs;
            return this;
        }
        ...
        public Builder idOfDefiningApp(String idOfDefiningApp) {
            if (idOfDefiningApp == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppAllowedScope", "idOfDefiningApp");
            }
        ...
        public Builder readOnly(Boolean readOnly) {
            if (readOnly == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppAllowedScope", "readOnly");
            }
            this.readOnly = readOnly;
            return this;
        }
        public GetDomainsAppsAppAllowedScope build() {
            final var _resultValue = new GetDomainsAppsAppAllowedScope();
