...
public final class GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp {
     ...
     * 
     */
    private List<GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderAppGroupAssertionAttribute> groupAssertionAttributes;
    /**
     ...
     * 
     */
    private List<GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderAppOutboundAssertionAttribute> outboundAssertionAttributes;
    /**
     ...
     * 
     */
    private List<GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderAppUserAssertionAttribute> userAssertionAttributes;
    ...
    public static final class Builder {
        ...
        public Builder assertionConsumerUrl(String assertionConsumerUrl) {
            if (assertionConsumerUrl == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "assertionConsumerUrl");
            }
        ...
        public Builder encryptAssertion(Boolean encryptAssertion) {
            if (encryptAssertion == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "encryptAssertion");
            }
        ...
        public Builder encryptionAlgorithm(String encryptionAlgorithm) {
            if (encryptionAlgorithm == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "encryptionAlgorithm");
            }
        ...
        public Builder encryptionCertificate(String encryptionCertificate) {
            if (encryptionCertificate == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "encryptionCertificate");
            }
        ...
        public Builder federationProtocol(String federationProtocol) {
            if (federationProtocol == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "federationProtocol");
            }
            this.federationProtocol = federationProtocol;
            return this;
        }
        @CustomType.Setter
        public Builder groupAssertionAttributes(List<GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderAppGroupAssertionAttribute> groupAssertionAttributes) {
            if (groupAssertionAttributes == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "groupAssertionAttributes");
            }
        ...
        public Builder hokAcsUrl(String hokAcsUrl) {
            if (hokAcsUrl == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "hokAcsUrl");
            }
        ...
        public Builder hokRequired(Boolean hokRequired) {
            if (hokRequired == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "hokRequired");
            }
        ...
        public Builder includeSigningCertInSignature(Boolean includeSigningCertInSignature) {
            if (includeSigningCertInSignature == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "includeSigningCertInSignature");
            }
        ...
        public Builder keyEncryptionAlgorithm(String keyEncryptionAlgorithm) {
            if (keyEncryptionAlgorithm == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "keyEncryptionAlgorithm");
            }
        ...
        public Builder lastNotificationSentTime(String lastNotificationSentTime) {
            if (lastNotificationSentTime == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "lastNotificationSentTime");
            }
        ...
        public Builder logoutBinding(String logoutBinding) {
            if (logoutBinding == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "logoutBinding");
            }
        ...
        public Builder logoutEnabled(Boolean logoutEnabled) {
            if (logoutEnabled == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "logoutEnabled");
            }
        ...
        public Builder logoutRequestUrl(String logoutRequestUrl) {
            if (logoutRequestUrl == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "logoutRequestUrl");
            }
        ...
        public Builder logoutResponseUrl(String logoutResponseUrl) {
            if (logoutResponseUrl == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "logoutResponseUrl");
            }
        ...
        public Builder metadata(String metadata) {
            if (metadata == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "metadata");
            }
        ...
        public Builder nameIdFormat(String nameIdFormat) {
            if (nameIdFormat == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "nameIdFormat");
            }
        ...
        public Builder nameIdUserstoreAttribute(String nameIdUserstoreAttribute) {
            if (nameIdUserstoreAttribute == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "nameIdUserstoreAttribute");
            }
            this.nameIdUserstoreAttribute = nameIdUserstoreAttribute;
            return this;
        }
        @CustomType.Setter
        public Builder outboundAssertionAttributes(List<GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderAppOutboundAssertionAttribute> outboundAssertionAttributes) {
            if (outboundAssertionAttributes == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "outboundAssertionAttributes");
            }
        ...
        public Builder partnerProviderId(String partnerProviderId) {
            if (partnerProviderId == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "partnerProviderId");
            }
        ...
        public Builder partnerProviderPattern(String partnerProviderPattern) {
            if (partnerProviderPattern == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "partnerProviderPattern");
            }
        ...
        public Builder signResponseOrAssertion(String signResponseOrAssertion) {
            if (signResponseOrAssertion == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "signResponseOrAssertion");
            }
        ...
        public Builder signatureHashAlgorithm(String signatureHashAlgorithm) {
            if (signatureHashAlgorithm == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "signatureHashAlgorithm");
            }
        ...
        public Builder signingCertificate(String signingCertificate) {
            if (signingCertificate == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "signingCertificate");
            }
        ...
        public Builder succinctId(String succinctId) {
            if (succinctId == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "succinctId");
            }
        ...
        public Builder tenantProviderId(String tenantProviderId) {
            if (tenantProviderId == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "tenantProviderId");
            }
            this.tenantProviderId = tenantProviderId;
            return this;
        }
        @CustomType.Setter
        public Builder userAssertionAttributes(List<GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderAppUserAssertionAttribute> userAssertionAttributes) {
            if (userAssertionAttributes == null) {
              throw new MissingRequiredPropertyException("GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp", "userAssertionAttributes");
            }
        ...
        public GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp build() {
            final var _resultValue = new GetDomainsAppsAppUrnietfparamsscimschemasoracleidcsextensionsamlServiceProviderApp();
