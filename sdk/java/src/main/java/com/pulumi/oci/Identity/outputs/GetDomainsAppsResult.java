...
public final class GetDomainsAppsResult {
     ...
     * 
     */
    private @Nullable List<GetDomainsAppsApp> apps;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder apps(@Nullable List<GetDomainsAppsApp> apps) {
            this.apps = apps;
            return this;
        }
        ...
        public GetDomainsAppsResult build() {
            final var o = new GetDomainsAppsResult();
            o.appCount = appCount;
            o.appFilter = appFilter;
            o.apps = apps;
