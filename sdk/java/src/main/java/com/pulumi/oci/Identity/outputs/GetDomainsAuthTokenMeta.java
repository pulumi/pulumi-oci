...
@CustomType
public final class GetDomainsAuthTokenMeta {
    /**
    ...
    private GetDomainsAuthTokenMeta() {}
    /**
     * @return The DateTime the Resource was added to the Service Provider
     * 
     */
    ...
    public static Builder builder(GetDomainsAuthTokenMeta defaults) {
    ...
    public static final class Builder {
        ...
        private String version;
        public Builder() {}
        public Builder(GetDomainsAuthTokenMeta defaults) {
        ...
        public Builder created(String created) {
            if (created == null) {
              throw new MissingRequiredPropertyException("GetDomainsAuthTokenMeta", "created");
            }
        ...
        public Builder lastModified(String lastModified) {
            if (lastModified == null) {
              throw new MissingRequiredPropertyException("GetDomainsAuthTokenMeta", "lastModified");
            }
        ...
        public Builder location(String location) {
            if (location == null) {
              throw new MissingRequiredPropertyException("GetDomainsAuthTokenMeta", "location");
            }
        ...
        public Builder resourceType(String resourceType) {
            if (resourceType == null) {
              throw new MissingRequiredPropertyException("GetDomainsAuthTokenMeta", "resourceType");
            }
        ...
        public Builder version(String version) {
            if (version == null) {
              throw new MissingRequiredPropertyException("GetDomainsAuthTokenMeta", "version");
            }
