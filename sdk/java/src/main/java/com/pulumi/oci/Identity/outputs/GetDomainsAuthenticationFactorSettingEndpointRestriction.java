    ...
    public static final class Builder {
        ...
        public Builder maxEndpointTrustDurationInDays(Integer maxEndpointTrustDurationInDays) {
            if (maxEndpointTrustDurationInDays == null) {
              throw new MissingRequiredPropertyException("GetDomainsAuthenticationFactorSettingEndpointRestriction", "maxEndpointTrustDurationInDays");
            }
        ...
        public Builder maxEnrolledDevices(Integer maxEnrolledDevices) {
            if (maxEnrolledDevices == null) {
              throw new MissingRequiredPropertyException("GetDomainsAuthenticationFactorSettingEndpointRestriction", "maxEnrolledDevices");
            }
        ...
        public Builder maxIncorrectAttempts(Integer maxIncorrectAttempts) {
            if (maxIncorrectAttempts == null) {
              throw new MissingRequiredPropertyException("GetDomainsAuthenticationFactorSettingEndpointRestriction", "maxIncorrectAttempts");
            }
        ...
        public Builder maxTrustedEndpoints(Integer maxTrustedEndpoints) {
            if (maxTrustedEndpoints == null) {
              throw new MissingRequiredPropertyException("GetDomainsAuthenticationFactorSettingEndpointRestriction", "maxTrustedEndpoints");
            }
        ...
        public Builder trustedEndpointsEnabled(Boolean trustedEndpointsEnabled) {
            if (trustedEndpointsEnabled == null) {
              throw new MissingRequiredPropertyException("GetDomainsAuthenticationFactorSettingEndpointRestriction", "trustedEndpointsEnabled");
            }
