...
public final class GetDomainsAuthenticationFactorSettingsAuthenticationFactorSettingMeta {
    ...
    public static Builder builder(GetDomainsAuthenticationFactorSettingsAuthenticationFactorSettingMeta defaults) {
    ...
    public static final class Builder {
        ...
        public Builder created(String created) {
            if (created == null) {
              throw new MissingRequiredPropertyException("GetDomainsAuthenticationFactorSettingsAuthenticationFactorSettingMeta", "created");
            }
        ...
        public Builder lastModified(String lastModified) {
            if (lastModified == null) {
              throw new MissingRequiredPropertyException("GetDomainsAuthenticationFactorSettingsAuthenticationFactorSettingMeta", "lastModified");
            }
        ...
        public Builder location(String location) {
            if (location == null) {
              throw new MissingRequiredPropertyException("GetDomainsAuthenticationFactorSettingsAuthenticationFactorSettingMeta", "location");
            }
        ...
        public Builder resourceType(String resourceType) {
            if (resourceType == null) {
              throw new MissingRequiredPropertyException("GetDomainsAuthenticationFactorSettingsAuthenticationFactorSettingMeta", "resourceType");
            }
        ...
        public Builder version(String version) {
            if (version == null) {
              throw new MissingRequiredPropertyException("GetDomainsAuthenticationFactorSettingsAuthenticationFactorSettingMeta", "version");
            }
            this.version = version;
            return this;
        }
        public GetDomainsAuthenticationFactorSettingsAuthenticationFactorSettingMeta build() {
            final var _resultValue = new GetDomainsAuthenticationFactorSettingsAuthenticationFactorSettingMeta();
