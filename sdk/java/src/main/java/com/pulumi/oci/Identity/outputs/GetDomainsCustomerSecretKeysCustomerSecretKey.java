...
public final class GetDomainsCustomerSecretKeysCustomerSecretKey {
     ...
     * 
     */
    private @Nullable List<GetDomainsCustomerSecretKeysCustomerSecretKeyIdcsCreatedBy> idcsCreatedBies;
    /**
     ...
     * 
     */
    private @Nullable List<GetDomainsCustomerSecretKeysCustomerSecretKeyIdcsLastModifiedBy> idcsLastModifiedBies;
    /**
     ...
     * 
     */
    private @Nullable List<GetDomainsCustomerSecretKeysCustomerSecretKeyMeta> metas;
    /**
     ...
     * 
     */
    private @Nullable List<GetDomainsCustomerSecretKeysCustomerSecretKeyTag> tags;
    /**
     ...
     * 
     */
    private @Nullable List<GetDomainsCustomerSecretKeysCustomerSecretKeyUrnietfparamsscimschemasoracleidcsextensionselfChangeUser> urnietfparamsscimschemasoracleidcsextensionselfChangeUsers;
    /**
     * @return User linked to customer secret key
     * 
     */
    private @Nullable List<GetDomainsCustomerSecretKeysCustomerSecretKeyUser> users;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder idcsCreatedBies(@Nullable List<GetDomainsCustomerSecretKeysCustomerSecretKeyIdcsCreatedBy> idcsCreatedBies) {
        ...
        @CustomType.Setter
        public Builder idcsLastModifiedBies(@Nullable List<GetDomainsCustomerSecretKeysCustomerSecretKeyIdcsLastModifiedBy> idcsLastModifiedBies) {
        ...
        @CustomType.Setter
        public Builder metas(@Nullable List<GetDomainsCustomerSecretKeysCustomerSecretKeyMeta> metas) {
            this.metas = metas;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder tags(@Nullable List<GetDomainsCustomerSecretKeysCustomerSecretKeyTag> tags) {
            this.tags = tags;
            return this;
        }
        ...
        @CustomType.Setter
        public Builder urnietfparamsscimschemasoracleidcsextensionselfChangeUsers(@Nullable List<GetDomainsCustomerSecretKeysCustomerSecretKeyUrnietfparamsscimschemasoracleidcsextensionselfChangeUser> urnietfparamsscimschemasoracleidcsextensionselfChangeUsers) {
        ...
        @CustomType.Setter
        public Builder users(@Nullable List<GetDomainsCustomerSecretKeysCustomerSecretKeyUser> users) {
            this.users = users;
            return this;
        }
        ...
        public GetDomainsCustomerSecretKeysCustomerSecretKey build() {
            final var o = new GetDomainsCustomerSecretKeysCustomerSecretKey();
