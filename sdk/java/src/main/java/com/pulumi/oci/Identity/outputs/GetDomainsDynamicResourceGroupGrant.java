...
public final class GetDomainsDynamicResourceGroupGrant {
    ...
    public static final class Builder {
        ...
        public Builder appId(String appId) {
            if (appId == null) {
              throw new MissingRequiredPropertyException("GetDomainsDynamicResourceGroupGrant", "appId");
            }
            this.appId = appId;
            return this;
        }
        ...
        public Builder grantMechanism(String grantMechanism) {
            if (grantMechanism == null) {
              throw new MissingRequiredPropertyException("GetDomainsDynamicResourceGroupGrant", "grantMechanism");
            }
        ...
        public Builder ref(String ref) {
            if (ref == null) {
              throw new MissingRequiredPropertyException("GetDomainsDynamicResourceGroupGrant", "ref");
            }
            this.ref = ref;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetDomainsDynamicResourceGroupGrant", "value");
            }
            this.value = value;
            return this;
        }
