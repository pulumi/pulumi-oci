...
@CustomType
public final class GetDomainsGrantMeta {
    /**
    ...
    public static Builder builder(GetDomainsGrantMeta defaults) {
    ...
    public static final class Builder {
        ...
        private String version;
        public Builder() {}
        public Builder(GetDomainsGrantMeta defaults) {
        ...
        public Builder created(String created) {
            if (created == null) {
              throw new MissingRequiredPropertyException("GetDomainsGrantMeta", "created");
            }
        ...
        public Builder lastModified(String lastModified) {
            if (lastModified == null) {
              throw new MissingRequiredPropertyException("GetDomainsGrantMeta", "lastModified");
            }
        ...
        public Builder location(String location) {
            if (location == null) {
              throw new MissingRequiredPropertyException("GetDomainsGrantMeta", "location");
            }
        ...
        public Builder resourceType(String resourceType) {
            if (resourceType == null) {
              throw new MissingRequiredPropertyException("GetDomainsGrantMeta", "resourceType");
            }
        ...
        public Builder version(String version) {
            if (version == null) {
              throw new MissingRequiredPropertyException("GetDomainsGrantMeta", "version");
            }
            this.version = version;
            return this;
        }
        public GetDomainsGrantMeta build() {
            final var _resultValue = new GetDomainsGrantMeta();
