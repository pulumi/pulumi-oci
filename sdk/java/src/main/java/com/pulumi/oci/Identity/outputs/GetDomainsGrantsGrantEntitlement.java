...
@CustomType
public final class GetDomainsGrantsGrantEntitlement {
    /**
    ...
    private GetDomainsGrantsGrantEntitlement() {}
    /**
     * @return The name of the attribute whose value (specified by attributeValue) confers privilege within the service-instance (specified by app).
     * 
     */
    ...
    public static Builder builder(GetDomainsGrantsGrantEntitlement defaults) {
    ...
    public static final class Builder {
        ...
        private String attributeValue;
        public Builder() {}
        public Builder(GetDomainsGrantsGrantEntitlement defaults) {
        ...
        public Builder attributeName(String attributeName) {
            if (attributeName == null) {
              throw new MissingRequiredPropertyException("GetDomainsGrantsGrantEntitlement", "attributeName");
            }
        ...
        public Builder attributeValue(String attributeValue) {
            if (attributeValue == null) {
              throw new MissingRequiredPropertyException("GetDomainsGrantsGrantEntitlement", "attributeValue");
            }
