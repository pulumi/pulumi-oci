...
@CustomType
public final class GetDomainsGroupMeta {
    /**
    ...
    public static Builder builder(GetDomainsGroupMeta defaults) {
    ...
    public static final class Builder {
        ...
        private String version;
        public Builder() {}
        public Builder(GetDomainsGroupMeta defaults) {
        ...
        public Builder created(String created) {
            if (created == null) {
              throw new MissingRequiredPropertyException("GetDomainsGroupMeta", "created");
            }
        ...
        public Builder lastModified(String lastModified) {
            if (lastModified == null) {
              throw new MissingRequiredPropertyException("GetDomainsGroupMeta", "lastModified");
            }
        ...
        public Builder location(String location) {
            if (location == null) {
              throw new MissingRequiredPropertyException("GetDomainsGroupMeta", "location");
            }
        ...
        public Builder resourceType(String resourceType) {
            if (resourceType == null) {
              throw new MissingRequiredPropertyException("GetDomainsGroupMeta", "resourceType");
            }
        ...
        public Builder version(String version) {
            if (version == null) {
              throw new MissingRequiredPropertyException("GetDomainsGroupMeta", "version");
            }
            this.version = version;
            return this;
        }
        public GetDomainsGroupMeta build() {
            final var _resultValue = new GetDomainsGroupMeta();
