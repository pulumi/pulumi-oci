...
import com.pulumi.oci.Identity.outputs.GetDomainsGroupsGroup;
...
@CustomType
public final class GetDomainsGroupsResult {
     ...
     * 
     */
    private List<GetDomainsGroupsGroup> groups;
    /**
     ...
     * 
     */
    public List<GetDomainsGroupsGroup> groups() {
        return this.groups;
    }
    /**
     * @return The provider-assigned unique ID for this managed resource.
    ...
    public static Builder builder(GetDomainsGroupsResult defaults) {
    ...
    public static final class Builder {
        ...
        private Integer totalResults;
        public Builder() {}
        public Builder(GetDomainsGroupsResult defaults) {
        ...
        @CustomType.Setter
        public Builder groups(List<GetDomainsGroupsGroup> groups) {
            if (groups == null) {
              throw new MissingRequiredPropertyException("GetDomainsGroupsResult", "groups");
            }
            this.groups = groups;
            return this;
        }
        public Builder groups(GetDomainsGroupsGroup... groups) {
            return groups(List.of(groups));
        }
        @CustomType.Setter
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetDomainsGroupsResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder idcsEndpoint(String idcsEndpoint) {
            if (idcsEndpoint == null) {
              throw new MissingRequiredPropertyException("GetDomainsGroupsResult", "idcsEndpoint");
            }
        ...
        public Builder itemsPerPage(Integer itemsPerPage) {
            if (itemsPerPage == null) {
              throw new MissingRequiredPropertyException("GetDomainsGroupsResult", "itemsPerPage");
            }
        ...
        public Builder schemas(List<String> schemas) {
            if (schemas == null) {
              throw new MissingRequiredPropertyException("GetDomainsGroupsResult", "schemas");
            }
        ...
        public Builder totalResults(Integer totalResults) {
            if (totalResults == null) {
              throw new MissingRequiredPropertyException("GetDomainsGroupsResult", "totalResults");
            }
            this.totalResults = totalResults;
            return this;
        }
        public GetDomainsGroupsResult build() {
            final var _resultValue = new GetDomainsGroupsResult();
