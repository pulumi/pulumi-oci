...
public final class GetDomainsIdentityProvidersIdentityProviderCorrelationPolicy {
    ...
    public static final class Builder {
        ...
        public Builder display(String display) {
            if (display == null) {
              throw new MissingRequiredPropertyException("GetDomainsIdentityProvidersIdentityProviderCorrelationPolicy", "display");
            }
        ...
        public Builder ref(String ref) {
            if (ref == null) {
              throw new MissingRequiredPropertyException("GetDomainsIdentityProvidersIdentityProviderCorrelationPolicy", "ref");
            }
            this.ref = ref;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetDomainsIdentityProvidersIdentityProviderCorrelationPolicy", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetDomainsIdentityProvidersIdentityProviderCorrelationPolicy", "value");
            }
            this.value = value;
            return this;
        }
        public GetDomainsIdentityProvidersIdentityProviderCorrelationPolicy build() {
            final var _resultValue = new GetDomainsIdentityProvidersIdentityProviderCorrelationPolicy();
