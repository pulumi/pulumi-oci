    ...
    public static final class Builder {
        ...
        public Builder manualAssignmentEndsAt(Integer manualAssignmentEndsAt) {
            if (manualAssignmentEndsAt == null) {
              throw new MissingRequiredPropertyException("GetDomainsIdentitySettingsIdentitySettingPosixGid", "manualAssignmentEndsAt");
            }
        ...
        public Builder manualAssignmentStartsFrom(Integer manualAssignmentStartsFrom) {
            if (manualAssignmentStartsFrom == null) {
              throw new MissingRequiredPropertyException("GetDomainsIdentitySettingsIdentitySettingPosixGid", "manualAssignmentStartsFrom");
            }
