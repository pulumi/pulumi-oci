...
public final class GetDomainsIdentitySettingsIdentitySettingPosixUid {
    ...
    public static Builder builder(GetDomainsIdentitySettingsIdentitySettingPosixUid defaults) {
    ...
    public static final class Builder {
        ...
        public Builder manualAssignmentEndsAt(Integer manualAssignmentEndsAt) {
            if (manualAssignmentEndsAt == null) {
              throw new MissingRequiredPropertyException("GetDomainsIdentitySettingsIdentitySettingPosixUid", "manualAssignmentEndsAt");
            }
        ...
        public Builder manualAssignmentStartsFrom(Integer manualAssignmentStartsFrom) {
            if (manualAssignmentStartsFrom == null) {
              throw new MissingRequiredPropertyException("GetDomainsIdentitySettingsIdentitySettingPosixUid", "manualAssignmentStartsFrom");
            }
            this.manualAssignmentStartsFrom = manualAssignmentStartsFrom;
            return this;
        }
        public GetDomainsIdentitySettingsIdentitySettingPosixUid build() {
            final var _resultValue = new GetDomainsIdentitySettingsIdentitySettingPosixUid();
