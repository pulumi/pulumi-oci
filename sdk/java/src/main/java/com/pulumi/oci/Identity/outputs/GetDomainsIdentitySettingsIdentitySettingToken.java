    ...
    public static final class Builder {
        ...
        public Builder expiresAfter(Integer expiresAfter) {
            if (expiresAfter == null) {
              throw new MissingRequiredPropertyException("GetDomainsIdentitySettingsIdentitySettingToken", "expiresAfter");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetDomainsIdentitySettingsIdentitySettingToken", "type");
            }
            this.type = type;
            return this;
        }
