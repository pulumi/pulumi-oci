...
public final class GetDomainsMyDevicesMyDeviceNonCompliance {
    ...
    public static final class Builder {
        ...
        public Builder action(String action) {
            if (action == null) {
              throw new MissingRequiredPropertyException("GetDomainsMyDevicesMyDeviceNonCompliance", "action");
            }
            this.action = action;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetDomainsMyDevicesMyDeviceNonCompliance", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetDomainsMyDevicesMyDeviceNonCompliance", "value");
            }
            this.value = value;
            return this;
        }
