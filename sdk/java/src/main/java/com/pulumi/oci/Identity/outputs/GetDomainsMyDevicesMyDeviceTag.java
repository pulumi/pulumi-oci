...
public final class GetDomainsMyDevicesMyDeviceTag {
    ...
    public static Builder builder(GetDomainsMyDevicesMyDeviceTag defaults) {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetDomainsMyDevicesMyDeviceTag", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetDomainsMyDevicesMyDeviceTag", "value");
            }
            this.value = value;
            return this;
        }
