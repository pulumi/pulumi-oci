...
public final class GetDomainsMyGroupsMyGroupUrnietfparamsscimschemasoracleidcsextensionposixGroup {
    ...
    public static Builder builder(GetDomainsMyGroupsMyGroupUrnietfparamsscimschemasoracleidcsextensionposixGroup defaults) {
    ...
    public static final class Builder {
        ...
        public GetDomainsMyGroupsMyGroupUrnietfparamsscimschemasoracleidcsextensionposixGroup build() {
            final var _resultValue = new GetDomainsMyGroupsMyGroupUrnietfparamsscimschemasoracleidcsextensionposixGroup();
