...
@CustomType
public final class GetDomainsMyOauth2clientCredentialMeta {
    /**
    ...
    private GetDomainsMyOauth2clientCredentialMeta() {}
    /**
     * @return The DateTime the Resource was added to the Service Provider
     * 
     */
    ...
    public static Builder builder(GetDomainsMyOauth2clientCredentialMeta defaults) {
    ...
    public static final class Builder {
        ...
        private String version;
        public Builder() {}
        public Builder(GetDomainsMyOauth2clientCredentialMeta defaults) {
        ...
        public Builder created(String created) {
            if (created == null) {
              throw new MissingRequiredPropertyException("GetDomainsMyOauth2clientCredentialMeta", "created");
            }
        ...
        public Builder lastModified(String lastModified) {
            if (lastModified == null) {
              throw new MissingRequiredPropertyException("GetDomainsMyOauth2clientCredentialMeta", "lastModified");
            }
        ...
        public Builder location(String location) {
            if (location == null) {
              throw new MissingRequiredPropertyException("GetDomainsMyOauth2clientCredentialMeta", "location");
            }
        ...
        public Builder resourceType(String resourceType) {
            if (resourceType == null) {
              throw new MissingRequiredPropertyException("GetDomainsMyOauth2clientCredentialMeta", "resourceType");
            }
        ...
        public Builder version(String version) {
            if (version == null) {
              throw new MissingRequiredPropertyException("GetDomainsMyOauth2clientCredentialMeta", "version");
            }
