...
public final class GetDomainsMyTrustedUserAgentIdcsCreatedBy {
    ...
    public static final class Builder {
        ...
        public Builder display(String display) {
            if (display == null) {
              throw new MissingRequiredPropertyException("GetDomainsMyTrustedUserAgentIdcsCreatedBy", "display");
            }
        ...
        public Builder ocid(String ocid) {
            if (ocid == null) {
              throw new MissingRequiredPropertyException("GetDomainsMyTrustedUserAgentIdcsCreatedBy", "ocid");
            }
            this.ocid = ocid;
            return this;
        }
        ...
        public Builder ref(String ref) {
            if (ref == null) {
              throw new MissingRequiredPropertyException("GetDomainsMyTrustedUserAgentIdcsCreatedBy", "ref");
            }
            this.ref = ref;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetDomainsMyTrustedUserAgentIdcsCreatedBy", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetDomainsMyTrustedUserAgentIdcsCreatedBy", "value");
            }
            this.value = value;
            return this;
        }
