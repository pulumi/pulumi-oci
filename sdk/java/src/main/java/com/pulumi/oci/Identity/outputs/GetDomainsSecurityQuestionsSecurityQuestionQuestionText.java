...
public final class GetDomainsSecurityQuestionsSecurityQuestionQuestionText {
    ...
    public static final class Builder {
        ...
        public Builder default_(Boolean default_) {
            if (default_ == null) {
              throw new MissingRequiredPropertyException("GetDomainsSecurityQuestionsSecurityQuestionQuestionText", "default_");
            }
        ...
        public Builder locale(String locale) {
            if (locale == null) {
              throw new MissingRequiredPropertyException("GetDomainsSecurityQuestionsSecurityQuestionQuestionText", "locale");
            }
            this.locale = locale;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetDomainsSecurityQuestionsSecurityQuestionQuestionText", "value");
            }
            this.value = value;
            return this;
        }
        public GetDomainsSecurityQuestionsSecurityQuestionQuestionText build() {
            final var _resultValue = new GetDomainsSecurityQuestionsSecurityQuestionQuestionText();
