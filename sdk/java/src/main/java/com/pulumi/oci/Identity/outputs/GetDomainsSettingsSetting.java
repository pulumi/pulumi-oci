...
public final class GetDomainsSettingsSetting {
    ...
    public static final class Builder {
        ...
        public GetDomainsSettingsSetting build() {
            final var o = new GetDomainsSettingsSetting();
            o.accountAlwaysTrustScope = accountAlwaysTrustScope;
            o.allowedDomains = allowedDomains;
            o.allowedForgotPasswordFlowReturnUrls = allowedForgotPasswordFlowReturnUrls;
            o.allowedNotificationRedirectUrls = allowedNotificationRedirectUrls;
            o.attributeSets = attributeSets;
            o.attributes = attributes;
            o.auditEventRetentionPeriod = auditEventRetentionPeriod;
            o.authorization = authorization;
            o.certificateValidations = certificateValidations;
            o.cloudAccountName = cloudAccountName;
            o.cloudGateCorsSettings = cloudGateCorsSettings;
            o.cloudMigrationCustomUrl = cloudMigrationCustomUrl;
            o.cloudMigrationUrlEnabled = cloudMigrationUrlEnabled;
            o.companyNames = companyNames;
            o.compartmentOcid = compartmentOcid;
            o.contactEmails = contactEmails;
            o.csrAccess = csrAccess;
            ...
            o.defaultTrustScope = defaultTrustScope;
            o.deleteInProgress = deleteInProgress;
            o.diagnosticLevel = diagnosticLevel;
            o.diagnosticRecordForSearchIdentifiesReturnedResources = diagnosticRecordForSearchIdentifiesReturnedResources;
            o.diagnosticTracingUpto = diagnosticTracingUpto;
            o.domainOcid = domainOcid;
            o.enableTermsOfUse = enableTermsOfUse;
            o.externalId = externalId;
            o.iamUpstSessionExpiry = iamUpstSessionExpiry;
            o.id = id;
            ...
            o.maxNoOfAppCmvaToReturn = maxNoOfAppCmvaToReturn;
            o.maxNoOfAppRoleMembersToReturn = maxNoOfAppRoleMembersToReturn;
            o.metas = metas;
            o.migrationStatus = migrationStatus;
            o.ocid = ocid;
            o.onPremisesProvisioning = onPremisesProvisioning;
            o.preferredLanguage = preferredLanguage;
            o.prevIssuer = prevIssuer;
            o.privacyPolicyUrl = privacyPolicyUrl;
            o.purgeConfigs = purgeConfigs;
            o.reAuthFactors = reAuthFactors;
            o.reAuthWhenChangingMyAuthenticationFactors = reAuthWhenChangingMyAuthenticationFactors;
            o.resourceTypeSchemaVersion = resourceTypeSchemaVersion;
            o.schemas = schemas;
            o.serviceAdminCannotListOtherUsers = serviceAdminCannotListOtherUsers;
            o.settingId = settingId;
            o.signingCertPublicAccess = signingCertPublicAccess;
            o.subMappingAttr = subMappingAttr;
            o.tags = tags;
            o.tenancyOcid = tenancyOcid;
            o.tenantCustomClaims = tenantCustomClaims;
