...
@CustomType
public final class GetDomainsUserUrnietfparamsscimschemasoracleidcsextensionselfChangeUser {
    /**
    ...
    private GetDomainsUserUrnietfparamsscimschemasoracleidcsextensionselfChangeUser() {}
    /**
     * @return If true, allows requesting user to update themselves. If false, requesting user can&#39;t update themself (default).
     * 
     */
    ...
    public static Builder builder(GetDomainsUserUrnietfparamsscimschemasoracleidcsextensionselfChangeUser defaults) {
    ...
    public static final class Builder {
        private Boolean allowSelfChange;
        public Builder() {}
        public Builder(GetDomainsUserUrnietfparamsscimschemasoracleidcsextensionselfChangeUser defaults) {
        ...
        public Builder allowSelfChange(Boolean allowSelfChange) {
            if (allowSelfChange == null) {
              throw new MissingRequiredPropertyException("GetDomainsUserUrnietfparamsscimschemasoracleidcsextensionselfChangeUser", "allowSelfChange");
            }
