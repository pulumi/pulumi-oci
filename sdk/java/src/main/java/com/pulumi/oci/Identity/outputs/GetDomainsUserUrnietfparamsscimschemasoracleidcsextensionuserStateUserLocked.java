...
public final class GetDomainsUserUrnietfparamsscimschemasoracleidcsextensionuserStateUserLocked {
    ...
    public static final class Builder {
        ...
        public Builder expired(Boolean expired) {
            if (expired == null) {
              throw new MissingRequiredPropertyException("GetDomainsUserUrnietfparamsscimschemasoracleidcsextensionuserStateUserLocked", "expired");
            }
        ...
        public Builder lockDate(String lockDate) {
            if (lockDate == null) {
              throw new MissingRequiredPropertyException("GetDomainsUserUrnietfparamsscimschemasoracleidcsextensionuserStateUserLocked", "lockDate");
            }
        ...
        public Builder on(Boolean on) {
            if (on == null) {
              throw new MissingRequiredPropertyException("GetDomainsUserUrnietfparamsscimschemasoracleidcsextensionuserStateUserLocked", "on");
            }
            this.on = on;
            return this;
        }
        ...
        public Builder reason(Integer reason) {
            if (reason == null) {
              throw new MissingRequiredPropertyException("GetDomainsUserUrnietfparamsscimschemasoracleidcsextensionuserStateUserLocked", "reason");
            }
            this.reason = reason;
            return this;
        }
        public GetDomainsUserUrnietfparamsscimschemasoracleidcsextensionuserStateUserLocked build() {
            final var _resultValue = new GetDomainsUserUrnietfparamsscimschemasoracleidcsextensionuserStateUserLocked();
