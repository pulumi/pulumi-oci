...
public final class GetIamWorkRequestResource {
    ...
    public static final class Builder {
        ...
        public Builder actionType(String actionType) {
            if (actionType == null) {
              throw new MissingRequiredPropertyException("GetIamWorkRequestResource", "actionType");
            }
        ...
        public Builder entityType(String entityType) {
            if (entityType == null) {
              throw new MissingRequiredPropertyException("GetIamWorkRequestResource", "entityType");
            }
        ...
        public Builder entityUri(String entityUri) {
            if (entityUri == null) {
              throw new MissingRequiredPropertyException("GetIamWorkRequestResource", "entityUri");
            }
        ...
        public Builder identifier(String identifier) {
            if (identifier == null) {
              throw new MissingRequiredPropertyException("GetIamWorkRequestResource", "identifier");
            }
