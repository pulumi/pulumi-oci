...
public final class GetIdentityProviderGroupsFilter {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetIdentityProviderGroupsFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetIdentityProviderGroupsFilter", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetIdentityProviderGroupsFilter build() {
            final var _resultValue = new GetIdentityProviderGroupsFilter();
