...
public final class IntegrationInstanceAttachment {
     ...
     * 
     */
    private final @Nullable Boolean isImplicit;
    /**
     ...
     * 
     */
    private final @Nullable String targetInstanceUrl;
    /**
     * @return The role of the target attachment.
     * 
     */
    private final @Nullable String targetRole;
    /**
     * @return The type of the target instance, such as &#34;FUSION&#34;.
     * 
     */
    private final @Nullable String targetServiceType;

    @CustomType.Constructor
    private IntegrationInstanceAttachment(
        @CustomType.Parameter("isImplicit") @Nullable Boolean isImplicit,
        @CustomType.Parameter("targetId") @Nullable String targetId,
        @CustomType.Parameter("targetInstanceUrl") @Nullable String targetInstanceUrl,
        @CustomType.Parameter("targetRole") @Nullable String targetRole,
        @CustomType.Parameter("targetServiceType") @Nullable String targetServiceType) {
    ...
    public static final class Builder {
        ...
        public Builder targetServiceType(@Nullable String targetServiceType) {
            ...
            return new IntegrationInstanceAttachment(isImplicit, targetId, targetInstanceUrl, targetRole, targetServiceType);
        }
    }
}
