...
@CustomType
public final class IntegrationInstanceNetworkEndpointDetailsRuntimeAllowlistedHttpVcn {
    /**
    ...
    private IntegrationInstanceNetworkEndpointDetailsRuntimeAllowlistedHttpVcn() {}
    /**
     * @return Source IP addresses or IP address ranges ingress rules. (ex: &#34;168.122.59.5&#34;, &#34;10.20.30.0/26&#34;) An invalid IP or CIDR block will result in a 400 response.
     * 
     */
    ...
    public static Builder builder(IntegrationInstanceNetworkEndpointDetailsRuntimeAllowlistedHttpVcn defaults) {
    ...
    public static final class Builder {
        ...
        private String id;
        public Builder() {}
        public Builder(IntegrationInstanceNetworkEndpointDetailsRuntimeAllowlistedHttpVcn defaults) {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("IntegrationInstanceNetworkEndpointDetailsRuntimeAllowlistedHttpVcn", "id");
            }
            this.id = id;
            return this;
        }
        public IntegrationInstanceNetworkEndpointDetailsRuntimeAllowlistedHttpVcn build() {
            final var _resultValue = new IntegrationInstanceNetworkEndpointDetailsRuntimeAllowlistedHttpVcn();
