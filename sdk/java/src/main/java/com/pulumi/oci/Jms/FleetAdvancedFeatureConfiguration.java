...
public class FleetAdvancedFeatureConfiguration extends com.pulumi.resources.CustomResource {
    ...
    public FleetAdvancedFeatureConfiguration(String name, FleetAdvancedFeatureConfigurationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Jms/fleetAdvancedFeatureConfiguration:FleetAdvancedFeatureConfiguration", name, args == null ? FleetAdvancedFeatureConfigurationArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
