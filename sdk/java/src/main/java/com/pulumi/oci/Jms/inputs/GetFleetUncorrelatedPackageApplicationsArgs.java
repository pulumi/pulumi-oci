...
import com.pulumi.oci.Jms.inputs.GetFleetUncorrelatedPackageApplicationsFilterArgs;
...
public final class GetFleetUncorrelatedPackageApplicationsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetFleetUncorrelatedPackageApplicationsArgs Empty = new GetFleetUncorrelatedPackageApplicationsArgs();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetFleetUncorrelatedPackageApplicationsFilterArgs>> filters;

    public Optional<Output<List<GetFleetUncorrelatedPackageApplicationsFilterArgs>>> filters() {
    ...
    private GetFleetUncorrelatedPackageApplicationsArgs() {}

    private GetFleetUncorrelatedPackageApplicationsArgs(GetFleetUncorrelatedPackageApplicationsArgs $) {
    ...
    public static Builder builder(GetFleetUncorrelatedPackageApplicationsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFleetUncorrelatedPackageApplicationsArgs();
        }

        public Builder(GetFleetUncorrelatedPackageApplicationsArgs defaults) {
            $ = new GetFleetUncorrelatedPackageApplicationsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetFleetUncorrelatedPackageApplicationsFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetFleetUncorrelatedPackageApplicationsFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetFleetUncorrelatedPackageApplicationsFilterArgs... filters) {
        ...
        public GetFleetUncorrelatedPackageApplicationsArgs build() {
            if ($.fleetId == null) {
                throw new MissingRequiredPropertyException("GetFleetUncorrelatedPackageApplicationsArgs", "fleetId");
            }
            if ($.packageName == null) {
                throw new MissingRequiredPropertyException("GetFleetUncorrelatedPackageApplicationsArgs", "packageName");
            }
            return $;
        }
    }
