...
import com.pulumi.oci.Jms.inputs.GetFleetUncorrelatedPackagesFilterArgs;
...
public final class GetFleetUncorrelatedPackagesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetFleetUncorrelatedPackagesArgs Empty = new GetFleetUncorrelatedPackagesArgs();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetFleetUncorrelatedPackagesFilterArgs>> filters;

    public Optional<Output<List<GetFleetUncorrelatedPackagesFilterArgs>>> filters() {
    ...
    private GetFleetUncorrelatedPackagesArgs() {}

    private GetFleetUncorrelatedPackagesArgs(GetFleetUncorrelatedPackagesArgs $) {
    ...
    public static Builder builder(GetFleetUncorrelatedPackagesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetFleetUncorrelatedPackagesArgs();
        }

        public Builder(GetFleetUncorrelatedPackagesArgs defaults) {
            $ = new GetFleetUncorrelatedPackagesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetFleetUncorrelatedPackagesFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetFleetUncorrelatedPackagesFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetFleetUncorrelatedPackagesFilterArgs... filters) {
        ...
        public GetFleetUncorrelatedPackagesArgs build() {
            if ($.fleetId == null) {
                throw new MissingRequiredPropertyException("GetFleetUncorrelatedPackagesArgs", "fleetId");
            }
            return $;
        }
    }
