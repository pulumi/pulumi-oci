...
public final class GetInstallationSitePlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetInstallationSitePlainArgs Empty = new GetInstallationSitePlainArgs();
    ...
    public static Builder builder(GetInstallationSitePlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetInstallationSitePlainArgs();
        }

        public Builder(GetInstallationSitePlainArgs defaults) {
            $ = new GetInstallationSitePlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetInstallationSitePlainArgs build() {
            if ($.fleetId == null) {
                throw new MissingRequiredPropertyException("GetInstallationSitePlainArgs", "fleetId");
            }
            return $;
        }
    }
