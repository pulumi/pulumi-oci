...
public final class TaskScheduleTaskDetailsJfrTaskRequestTargetArgs extends com.pulumi.resources.ResourceArgs {

    public static final TaskScheduleTaskDetailsJfrTaskRequestTargetArgs Empty = new TaskScheduleTaskDetailsJfrTaskRequestTargetArgs();
    ...
    private TaskScheduleTaskDetailsJfrTaskRequestTargetArgs() {}

    private TaskScheduleTaskDetailsJfrTaskRequestTargetArgs(TaskScheduleTaskDetailsJfrTaskRequestTargetArgs $) {
    ...
    public static Builder builder(TaskScheduleTaskDetailsJfrTaskRequestTargetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TaskScheduleTaskDetailsJfrTaskRequestTargetArgs();
        }

        public Builder(TaskScheduleTaskDetailsJfrTaskRequestTargetArgs defaults) {
            $ = new TaskScheduleTaskDetailsJfrTaskRequestTargetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TaskScheduleTaskDetailsJfrTaskRequestTargetArgs build() {
            return $;
        }
    }
