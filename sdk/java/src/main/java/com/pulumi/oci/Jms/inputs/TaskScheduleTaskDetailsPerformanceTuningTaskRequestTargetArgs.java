...
public final class TaskScheduleTaskDetailsPerformanceTuningTaskRequestTargetArgs extends com.pulumi.resources.ResourceArgs {

    public static final TaskScheduleTaskDetailsPerformanceTuningTaskRequestTargetArgs Empty = new TaskScheduleTaskDetailsPerformanceTuningTaskRequestTargetArgs();
    ...
    private TaskScheduleTaskDetailsPerformanceTuningTaskRequestTargetArgs() {}

    private TaskScheduleTaskDetailsPerformanceTuningTaskRequestTargetArgs(TaskScheduleTaskDetailsPerformanceTuningTaskRequestTargetArgs $) {
    ...
    public static Builder builder(TaskScheduleTaskDetailsPerformanceTuningTaskRequestTargetArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new TaskScheduleTaskDetailsPerformanceTuningTaskRequestTargetArgs();
        }

        public Builder(TaskScheduleTaskDetailsPerformanceTuningTaskRequestTargetArgs defaults) {
            $ = new TaskScheduleTaskDetailsPerformanceTuningTaskRequestTargetArgs(Objects.requireNonNull(defaults));
        }
        ...
        public TaskScheduleTaskDetailsPerformanceTuningTaskRequestTargetArgs build() {
            return $;
        }
    }
