...
public final class FleetInventoryLog {
    ...
    public static final class Builder {
        ...
        public Builder logGroupId(String logGroupId) {
            if (logGroupId == null) {
              throw new MissingRequiredPropertyException("FleetInventoryLog", "logGroupId");
            }
        ...
        public Builder logId(String logId) {
            if (logId == null) {
              throw new MissingRequiredPropertyException("FleetInventoryLog", "logId");
            }
            this.logId = logId;
            return this;
        }
        public FleetInventoryLog build() {
            final var _resultValue = new FleetInventoryLog();
