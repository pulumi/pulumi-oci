...
public final class GetInstallationSitesInstallationSiteCollectionItem {
     ...
     * 
     */
    private @Nullable List<GetInstallationSitesInstallationSiteCollectionItemItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetInstallationSitesInstallationSiteCollectionItemItem> items) {
            this.items = items;
            return this;
        }
