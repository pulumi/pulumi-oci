...
@CustomType
public final class GetJavaReleaseFamilyDetailLatestReleaseArtifact {
    /**
    ...
    private GetJavaReleaseFamilyDetailLatestReleaseArtifact() {}
    /**
     * @return Approximate compressed file size in bytes.
     * 
     */
    ...
    public static Builder builder(GetJavaReleaseFamilyDetailLatestReleaseArtifact defaults) {
    ...
    public static final class Builder {
        ...
        private String sha256;
        public Builder() {}
        public Builder(GetJavaReleaseFamilyDetailLatestReleaseArtifact defaults) {
        ...
        public Builder approximateFileSizeInBytes(String approximateFileSizeInBytes) {
            if (approximateFileSizeInBytes == null) {
              throw new MissingRequiredPropertyException("GetJavaReleaseFamilyDetailLatestReleaseArtifact", "approximateFileSizeInBytes");
            }
        ...
        public Builder architecture(String architecture) {
            if (architecture == null) {
              throw new MissingRequiredPropertyException("GetJavaReleaseFamilyDetailLatestReleaseArtifact", "architecture");
            }
        ...
        public Builder artifactContentType(String artifactContentType) {
            if (artifactContentType == null) {
              throw new MissingRequiredPropertyException("GetJavaReleaseFamilyDetailLatestReleaseArtifact", "artifactContentType");
            }
        ...
        public Builder artifactDescription(String artifactDescription) {
            if (artifactDescription == null) {
              throw new MissingRequiredPropertyException("GetJavaReleaseFamilyDetailLatestReleaseArtifact", "artifactDescription");
            }
        ...
        public Builder artifactFileName(String artifactFileName) {
            if (artifactFileName == null) {
              throw new MissingRequiredPropertyException("GetJavaReleaseFamilyDetailLatestReleaseArtifact", "artifactFileName");
            }
        ...
        public Builder artifactId(String artifactId) {
            if (artifactId == null) {
              throw new MissingRequiredPropertyException("GetJavaReleaseFamilyDetailLatestReleaseArtifact", "artifactId");
            }
        ...
        public Builder downloadUrl(String downloadUrl) {
            if (downloadUrl == null) {
              throw new MissingRequiredPropertyException("GetJavaReleaseFamilyDetailLatestReleaseArtifact", "downloadUrl");
            }
        ...
        public Builder osFamily(String osFamily) {
            if (osFamily == null) {
              throw new MissingRequiredPropertyException("GetJavaReleaseFamilyDetailLatestReleaseArtifact", "osFamily");
            }
        ...
        public Builder packageType(String packageType) {
            if (packageType == null) {
              throw new MissingRequiredPropertyException("GetJavaReleaseFamilyDetailLatestReleaseArtifact", "packageType");
            }
        ...
        public Builder packageTypeDetail(String packageTypeDetail) {
            if (packageTypeDetail == null) {
              throw new MissingRequiredPropertyException("GetJavaReleaseFamilyDetailLatestReleaseArtifact", "packageTypeDetail");
            }
        ...
        public Builder scriptChecksumUrl(String scriptChecksumUrl) {
            if (scriptChecksumUrl == null) {
              throw new MissingRequiredPropertyException("GetJavaReleaseFamilyDetailLatestReleaseArtifact", "scriptChecksumUrl");
            }
        ...
        public Builder scriptDownloadUrl(String scriptDownloadUrl) {
            if (scriptDownloadUrl == null) {
              throw new MissingRequiredPropertyException("GetJavaReleaseFamilyDetailLatestReleaseArtifact", "scriptDownloadUrl");
            }
        ...
        public Builder sha256(String sha256) {
            if (sha256 == null) {
              throw new MissingRequiredPropertyException("GetJavaReleaseFamilyDetailLatestReleaseArtifact", "sha256");
            }
            this.sha256 = sha256;
            return this;
        }
        public GetJavaReleaseFamilyDetailLatestReleaseArtifact build() {
            final var _resultValue = new GetJavaReleaseFamilyDetailLatestReleaseArtifact();
