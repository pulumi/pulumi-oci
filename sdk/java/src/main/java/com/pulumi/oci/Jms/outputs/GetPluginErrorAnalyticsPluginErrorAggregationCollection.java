...
public final class GetPluginErrorAnalyticsPluginErrorAggregationCollection {
     ...
     * 
     */
    private List<GetPluginErrorAnalyticsPluginErrorAggregationCollectionItem> items;
     ...
     * 
     */
    public List<GetPluginErrorAnalyticsPluginErrorAggregationCollectionItem> items() {
        return this.items;
    }
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(List<GetPluginErrorAnalyticsPluginErrorAggregationCollectionItem> items) {
            if (items == null) {
