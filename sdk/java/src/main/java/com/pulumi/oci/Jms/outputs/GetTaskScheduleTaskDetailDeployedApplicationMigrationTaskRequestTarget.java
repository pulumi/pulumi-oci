...
@CustomType
public final class GetTaskScheduleTaskDetailDeployedApplicationMigrationTaskRequestTarget {
    /**
    ...
    private GetTaskScheduleTaskDetailDeployedApplicationMigrationTaskRequestTarget() {}
    /**
     * @return The unique key that identifies the deployed application&#39;s installation path that is to be used for the Java migration analyses.
     * 
     */
    ...
    public static Builder builder(GetTaskScheduleTaskDetailDeployedApplicationMigrationTaskRequestTarget defaults) {
    ...
    public static final class Builder {
        ...
        private String targetJdkVersion;
        public Builder() {}
        public Builder(GetTaskScheduleTaskDetailDeployedApplicationMigrationTaskRequestTarget defaults) {
        ...
        public Builder deployedApplicationInstallationKey(String deployedApplicationInstallationKey) {
            if (deployedApplicationInstallationKey == null) {
              throw new MissingRequiredPropertyException("GetTaskScheduleTaskDetailDeployedApplicationMigrationTaskRequestTarget", "deployedApplicationInstallationKey");
            }
        ...
        public Builder excludePackagePrefixes(List<String> excludePackagePrefixes) {
            if (excludePackagePrefixes == null) {
              throw new MissingRequiredPropertyException("GetTaskScheduleTaskDetailDeployedApplicationMigrationTaskRequestTarget", "excludePackagePrefixes");
            }
        ...
        public Builder includePackagePrefixes(List<String> includePackagePrefixes) {
            if (includePackagePrefixes == null) {
              throw new MissingRequiredPropertyException("GetTaskScheduleTaskDetailDeployedApplicationMigrationTaskRequestTarget", "includePackagePrefixes");
            }
        ...
        public Builder managedInstanceId(String managedInstanceId) {
            if (managedInstanceId == null) {
              throw new MissingRequiredPropertyException("GetTaskScheduleTaskDetailDeployedApplicationMigrationTaskRequestTarget", "managedInstanceId");
            }
        ...
        public Builder sourceJdkVersion(String sourceJdkVersion) {
            if (sourceJdkVersion == null) {
              throw new MissingRequiredPropertyException("GetTaskScheduleTaskDetailDeployedApplicationMigrationTaskRequestTarget", "sourceJdkVersion");
            }
        ...
        public Builder targetJdkVersion(String targetJdkVersion) {
            if (targetJdkVersion == null) {
              throw new MissingRequiredPropertyException("GetTaskScheduleTaskDetailDeployedApplicationMigrationTaskRequestTarget", "targetJdkVersion");
            }
            this.targetJdkVersion = targetJdkVersion;
            return this;
        }
        public GetTaskScheduleTaskDetailDeployedApplicationMigrationTaskRequestTarget build() {
            final var _resultValue = new GetTaskScheduleTaskDetailDeployedApplicationMigrationTaskRequestTarget();
