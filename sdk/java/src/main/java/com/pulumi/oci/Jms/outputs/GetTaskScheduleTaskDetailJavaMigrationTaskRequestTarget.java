...
@CustomType
public final class GetTaskScheduleTaskDetailJavaMigrationTaskRequestTarget {
    /**
    ...
    private GetTaskScheduleTaskDetailJavaMigrationTaskRequestTarget() {}
    /**
     * @return Unique key that identifies the application installation for JFR data collection.
     * 
     */
    ...
    public static Builder builder(GetTaskScheduleTaskDetailJavaMigrationTaskRequestTarget defaults) {
    ...
    public static final class Builder {
        ...
        private String targetJdkVersion;
        public Builder() {}
        public Builder(GetTaskScheduleTaskDetailJavaMigrationTaskRequestTarget defaults) {
        ...
        public Builder applicationInstallationKey(String applicationInstallationKey) {
            if (applicationInstallationKey == null) {
              throw new MissingRequiredPropertyException("GetTaskScheduleTaskDetailJavaMigrationTaskRequestTarget", "applicationInstallationKey");
            }
        ...
        public Builder excludePackagePrefixes(List<String> excludePackagePrefixes) {
            if (excludePackagePrefixes == null) {
              throw new MissingRequiredPropertyException("GetTaskScheduleTaskDetailJavaMigrationTaskRequestTarget", "excludePackagePrefixes");
            }
        ...
        public Builder includePackagePrefixes(List<String> includePackagePrefixes) {
            if (includePackagePrefixes == null) {
              throw new MissingRequiredPropertyException("GetTaskScheduleTaskDetailJavaMigrationTaskRequestTarget", "includePackagePrefixes");
            }
        ...
        public Builder managedInstanceId(String managedInstanceId) {
            if (managedInstanceId == null) {
              throw new MissingRequiredPropertyException("GetTaskScheduleTaskDetailJavaMigrationTaskRequestTarget", "managedInstanceId");
            }
        ...
        public Builder sourceJdkVersion(String sourceJdkVersion) {
            if (sourceJdkVersion == null) {
              throw new MissingRequiredPropertyException("GetTaskScheduleTaskDetailJavaMigrationTaskRequestTarget", "sourceJdkVersion");
            }
        ...
        public Builder targetJdkVersion(String targetJdkVersion) {
            if (targetJdkVersion == null) {
              throw new MissingRequiredPropertyException("GetTaskScheduleTaskDetailJavaMigrationTaskRequestTarget", "targetJdkVersion");
            }
            this.targetJdkVersion = targetJdkVersion;
            return this;
        }
        public GetTaskScheduleTaskDetailJavaMigrationTaskRequestTarget build() {
            final var _resultValue = new GetTaskScheduleTaskDetailJavaMigrationTaskRequestTarget();
