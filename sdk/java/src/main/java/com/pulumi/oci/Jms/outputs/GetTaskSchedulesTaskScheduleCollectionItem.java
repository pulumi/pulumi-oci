...
import com.pulumi.oci.Jms.outputs.GetTaskSchedulesTaskScheduleCollectionItemTaskDetail;
import java.lang.String;
import java.util.List;
import java.util.Objects;

@CustomType
public final class GetTaskSchedulesTaskScheduleCollectionItem {
    /**
     ...
     * 
     */
    private List<GetTaskSchedulesTaskScheduleCollectionItemTaskDetail> taskDetails;
    /**
    ...
    private GetTaskSchedulesTaskScheduleCollectionItem() {}
    /**
     * @return Name of the task creator.
     * 
     */
     ...
     * 
     */
    public List<GetTaskSchedulesTaskScheduleCollectionItemTaskDetail> taskDetails() {
    ...
    public static Builder builder(GetTaskSchedulesTaskScheduleCollectionItem defaults) {
    ...
    public static final class Builder {
        ...
        private String timeNextRun;
        public Builder() {}
        public Builder(GetTaskSchedulesTaskScheduleCollectionItem defaults) {
        ...
        public Builder createdBy(String createdBy) {
            if (createdBy == null) {
              throw new MissingRequiredPropertyException("GetTaskSchedulesTaskScheduleCollectionItem", "createdBy");
            }
        ...
        public Builder executionRecurrences(String executionRecurrences) {
            if (executionRecurrences == null) {
              throw new MissingRequiredPropertyException("GetTaskSchedulesTaskScheduleCollectionItem", "executionRecurrences");
            }
        ...
        public Builder fleetId(String fleetId) {
            if (fleetId == null) {
              throw new MissingRequiredPropertyException("GetTaskSchedulesTaskScheduleCollectionItem", "fleetId");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetTaskSchedulesTaskScheduleCollectionItem", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetTaskSchedulesTaskScheduleCollectionItem", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetTaskSchedulesTaskScheduleCollectionItem", "state");
            }
            this.state = state;
            return this;
        }
        @CustomType.Setter
        public Builder taskDetails(List<GetTaskSchedulesTaskScheduleCollectionItemTaskDetail> taskDetails) {
            if (taskDetails == null) {
              throw new MissingRequiredPropertyException("GetTaskSchedulesTaskScheduleCollectionItem", "taskDetails");
            }
            this.taskDetails = taskDetails;
            return this;
        }
        public Builder taskDetails(GetTaskSchedulesTaskScheduleCollectionItemTaskDetail... taskDetails) {
            return taskDetails(List.of(taskDetails));
        }
        @CustomType.Setter
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetTaskSchedulesTaskScheduleCollectionItem", "timeCreated");
            }
        ...
        public Builder timeLastRun(String timeLastRun) {
            if (timeLastRun == null) {
              throw new MissingRequiredPropertyException("GetTaskSchedulesTaskScheduleCollectionItem", "timeLastRun");
            }
        ...
        public Builder timeLastUpdated(String timeLastUpdated) {
            if (timeLastUpdated == null) {
              throw new MissingRequiredPropertyException("GetTaskSchedulesTaskScheduleCollectionItem", "timeLastUpdated");
            }
        ...
        public Builder timeNextRun(String timeNextRun) {
            if (timeNextRun == null) {
              throw new MissingRequiredPropertyException("GetTaskSchedulesTaskScheduleCollectionItem", "timeNextRun");
            }
            this.timeNextRun = timeNextRun;
            return this;
        }
        public GetTaskSchedulesTaskScheduleCollectionItem build() {
            final var _resultValue = new GetTaskSchedulesTaskScheduleCollectionItem();
