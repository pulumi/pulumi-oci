...
import com.pulumi.oci.Jms.outputs.GetTaskSchedulesTaskScheduleCollectionItemTaskDetailJfrTaskRequestTarget;
...
@CustomType
public final class GetTaskSchedulesTaskScheduleCollectionItemTaskDetailJfrTaskRequest {
    /**
     ...
     * 
     */
    private List<GetTaskSchedulesTaskScheduleCollectionItemTaskDetailJfrTaskRequestTarget> targets;
    /**
    ...
    private GetTaskSchedulesTaskScheduleCollectionItemTaskDetailJfrTaskRequest() {}
    /**
     * @return The profile used for JFR events selection. If the name isn&#39;t recognized, the settings from jfcV1 or jfcV2 will be used depending on the JVM version. Both jfcV2 and jfcV1 should be provided to ensure JFR collection on different JVM versions.
     * 
     */
     ...
     * 
     */
    public List<GetTaskSchedulesTaskScheduleCollectionItemTaskDetailJfrTaskRequestTarget> targets() {
        return this.targets;
    }
    /**
     * @return Period to looking for JVMs. In addition to attach to running JVMs when given the command, JVM started within the waiting period will also be attached for JFR. The value should be larger than the agent polling interval setting for the fleet to ensure agent can get the instructions. If not specified, the agent polling interval for the fleet is used.
    ...
    public static Builder builder(GetTaskSchedulesTaskScheduleCollectionItemTaskDetailJfrTaskRequest defaults) {
    ...
    public static final class Builder {
        ...
        private Integer waitingPeriodInMinutes;
        public Builder() {}
        public Builder(GetTaskSchedulesTaskScheduleCollectionItemTaskDetailJfrTaskRequest defaults) {
        ...
        public Builder jfcProfileName(String jfcProfileName) {
            if (jfcProfileName == null) {
              throw new MissingRequiredPropertyException("GetTaskSchedulesTaskScheduleCollectionItemTaskDetailJfrTaskRequest", "jfcProfileName");
            }
        ...
        public Builder jfcV1(String jfcV1) {
            if (jfcV1 == null) {
              throw new MissingRequiredPropertyException("GetTaskSchedulesTaskScheduleCollectionItemTaskDetailJfrTaskRequest", "jfcV1");
            }
            this.jfcV1 = jfcV1;
            return this;
        }
        ...
        public Builder jfcV2(String jfcV2) {
            if (jfcV2 == null) {
              throw new MissingRequiredPropertyException("GetTaskSchedulesTaskScheduleCollectionItemTaskDetailJfrTaskRequest", "jfcV2");
            }
            this.jfcV2 = jfcV2;
            return this;
        }
        ...
        public Builder recordingDurationInMinutes(Integer recordingDurationInMinutes) {
            if (recordingDurationInMinutes == null) {
              throw new MissingRequiredPropertyException("GetTaskSchedulesTaskScheduleCollectionItemTaskDetailJfrTaskRequest", "recordingDurationInMinutes");
            }
        ...
        public Builder recordingSizeInMb(Integer recordingSizeInMb) {
            if (recordingSizeInMb == null) {
              throw new MissingRequiredPropertyException("GetTaskSchedulesTaskScheduleCollectionItemTaskDetailJfrTaskRequest", "recordingSizeInMb");
            }
            this.recordingSizeInMb = recordingSizeInMb;
            return this;
        }
        @CustomType.Setter
        public Builder targets(List<GetTaskSchedulesTaskScheduleCollectionItemTaskDetailJfrTaskRequestTarget> targets) {
            if (targets == null) {
              throw new MissingRequiredPropertyException("GetTaskSchedulesTaskScheduleCollectionItemTaskDetailJfrTaskRequest", "targets");
            }
            this.targets = targets;
            return this;
        }
        public Builder targets(GetTaskSchedulesTaskScheduleCollectionItemTaskDetailJfrTaskRequestTarget... targets) {
            return targets(List.of(targets));
        }
        @CustomType.Setter
        public Builder waitingPeriodInMinutes(Integer waitingPeriodInMinutes) {
            if (waitingPeriodInMinutes == null) {
              throw new MissingRequiredPropertyException("GetTaskSchedulesTaskScheduleCollectionItemTaskDetailJfrTaskRequest", "waitingPeriodInMinutes");
            }
            this.waitingPeriodInMinutes = waitingPeriodInMinutes;
            return this;
        }
        public GetTaskSchedulesTaskScheduleCollectionItemTaskDetailJfrTaskRequest build() {
            final var _resultValue = new GetTaskSchedulesTaskScheduleCollectionItemTaskDetailJfrTaskRequest();
