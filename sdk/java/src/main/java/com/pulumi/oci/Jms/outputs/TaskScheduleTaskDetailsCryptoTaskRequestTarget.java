...
@CustomType
public final class TaskScheduleTaskDetailsCryptoTaskRequestTarget {
    /**
    ...
    private TaskScheduleTaskDetailsCryptoTaskRequestTarget() {}
    /**
     * @return (Updatable) Unique key that identifies the application installation for JFR data collection.
     * 
     */
    ...
    public static Builder builder(TaskScheduleTaskDetailsCryptoTaskRequestTarget defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String managedInstanceId;
        public Builder() {}
        public Builder(TaskScheduleTaskDetailsCryptoTaskRequestTarget defaults) {
        ...
        public TaskScheduleTaskDetailsCryptoTaskRequestTarget build() {
            final var _resultValue = new TaskScheduleTaskDetailsCryptoTaskRequestTarget();
