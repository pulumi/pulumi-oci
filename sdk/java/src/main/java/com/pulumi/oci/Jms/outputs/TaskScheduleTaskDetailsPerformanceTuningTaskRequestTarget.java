...
@CustomType
public final class TaskScheduleTaskDetailsPerformanceTuningTaskRequestTarget {
    /**
    ...
    public static Builder builder(TaskScheduleTaskDetailsPerformanceTuningTaskRequestTarget defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String managedInstanceId;
        public Builder() {}
        public Builder(TaskScheduleTaskDetailsPerformanceTuningTaskRequestTarget defaults) {
        ...
        public TaskScheduleTaskDetailsPerformanceTuningTaskRequestTarget build() {
            final var _resultValue = new TaskScheduleTaskDetailsPerformanceTuningTaskRequestTarget();
