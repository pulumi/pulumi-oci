...
public class Verify extends com.pulumi.resources.CustomResource {
     ...
     */
    public Verify(java.lang.String name) {
     ...
     */
    public Verify(java.lang.String name, VerifyArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Verify(java.lang.String name, VerifyArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Kms/verify:Verify", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private Verify(java.lang.String name, Output<java.lang.String> id, @Nullable VerifyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Kms/verify:Verify", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static Verify get(java.lang.String name, Output<java.lang.String> id, @Nullable VerifyState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
