...
public final class GetDecryptedDataPlainArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetDecryptedDataPlainArgs build() {
            if ($.ciphertext == null) {
                throw new MissingRequiredPropertyException("GetDecryptedDataPlainArgs", "ciphertext");
            }
            if ($.cryptoEndpoint == null) {
                throw new MissingRequiredPropertyException("GetDecryptedDataPlainArgs", "cryptoEndpoint");
            }
            if ($.keyId == null) {
                throw new MissingRequiredPropertyException("GetDecryptedDataPlainArgs", "keyId");
            }
            return $;
        }
    }
