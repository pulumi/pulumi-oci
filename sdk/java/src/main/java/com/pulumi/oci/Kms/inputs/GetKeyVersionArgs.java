...
public final class GetKeyVersionArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetKeyVersionArgs build() {
            if ($.keyId == null) {
                throw new MissingRequiredPropertyException("GetKeyVersionArgs", "keyId");
            }
            if ($.keyVersionId == null) {
                throw new MissingRequiredPropertyException("GetKeyVersionArgs", "keyVersionId");
            }
            if ($.managementEndpoint == null) {
                throw new MissingRequiredPropertyException("GetKeyVersionArgs", "managementEndpoint");
            }
            return $;
        }
    }
