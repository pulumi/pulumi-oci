...
@CustomType
public final class GetKeyExternalKeyReference {
    /**
    ...
    private GetKeyExternalKeyReference() {}
    /**
     * @return ExternalKeyId refers to the globally unique key Id associated with the key created in external vault in CTM.
     * 
     */
    ...
    public static Builder builder(GetKeyExternalKeyReference defaults) {
    ...
    public static final class Builder {
        private String externalKeyId;
        public Builder() {}
        public Builder(GetKeyExternalKeyReference defaults) {
        ...
        public Builder externalKeyId(String externalKeyId) {
            if (externalKeyId == null) {
              throw new MissingRequiredPropertyException("GetKeyExternalKeyReference", "externalKeyId");
            }
            this.externalKeyId = externalKeyId;
            return this;
        }
        public GetKeyExternalKeyReference build() {
            final var _resultValue = new GetKeyExternalKeyReference();
