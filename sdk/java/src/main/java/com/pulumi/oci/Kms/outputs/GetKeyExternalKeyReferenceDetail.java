    ...
    public static final class Builder {
        ...
        public Builder externalKeyId(String externalKeyId) {
            if (externalKeyId == null) {
              throw new MissingRequiredPropertyException("GetKeyExternalKeyReferenceDetail", "externalKeyId");
            }
        ...
        public Builder externalKeyVersionId(String externalKeyVersionId) {
            if (externalKeyVersionId == null) {
              throw new MissingRequiredPropertyException("GetKeyExternalKeyReferenceDetail", "externalKeyVersionId");
            }
            this.externalKeyVersionId = externalKeyVersionId;
            return this;
        }
        public GetKeyExternalKeyReferenceDetail build() {
            final var _resultValue = new GetKeyExternalKeyReferenceDetail();
