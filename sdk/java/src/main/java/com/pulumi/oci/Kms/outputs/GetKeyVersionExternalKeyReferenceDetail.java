...
@CustomType
public final class GetKeyVersionExternalKeyReferenceDetail {
    /**
    ...
    private GetKeyVersionExternalKeyReferenceDetail() {}
    /**
     * @return ExternalKeyId refers to the globally unique key Id associated with the key created in external vault in CTM.
     * 
     */
    ...
    public static Builder builder(GetKeyVersionExternalKeyReferenceDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String externalKeyVersionId;
        public Builder() {}
        public Builder(GetKeyVersionExternalKeyReferenceDetail defaults) {
        ...
        public Builder externalKeyId(String externalKeyId) {
            if (externalKeyId == null) {
              throw new MissingRequiredPropertyException("GetKeyVersionExternalKeyReferenceDetail", "externalKeyId");
            }
        ...
        public Builder externalKeyVersionId(String externalKeyVersionId) {
            if (externalKeyVersionId == null) {
              throw new MissingRequiredPropertyException("GetKeyVersionExternalKeyReferenceDetail", "externalKeyVersionId");
            }
            this.externalKeyVersionId = externalKeyVersionId;
            return this;
        }
        public GetKeyVersionExternalKeyReferenceDetail build() {
            final var _resultValue = new GetKeyVersionExternalKeyReferenceDetail();
