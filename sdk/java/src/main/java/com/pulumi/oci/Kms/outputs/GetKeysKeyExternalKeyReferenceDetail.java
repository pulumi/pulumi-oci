...
public final class GetKeysKeyExternalKeyReferenceDetail {
    ...
    public static Builder builder(GetKeysKeyExternalKeyReferenceDetail defaults) {
    ...
    public static final class Builder {
        ...
        public Builder externalKeyId(String externalKeyId) {
            if (externalKeyId == null) {
              throw new MissingRequiredPropertyException("GetKeysKeyExternalKeyReferenceDetail", "externalKeyId");
            }
        ...
        public Builder externalKeyVersionId(String externalKeyVersionId) {
            if (externalKeyVersionId == null) {
              throw new MissingRequiredPropertyException("GetKeysKeyExternalKeyReferenceDetail", "externalKeyVersionId");
            }
