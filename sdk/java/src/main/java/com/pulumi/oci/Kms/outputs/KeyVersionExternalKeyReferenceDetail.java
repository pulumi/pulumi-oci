...
@CustomType
public final class KeyVersionExternalKeyReferenceDetail {
    /**
    ...
    private KeyVersionExternalKeyReferenceDetail() {}
    /**
     * @return ExternalKeyId refers to the globally unique key Id associated with the key created in external vault in CTM.
     * 
     */
    ...
    public static Builder builder(KeyVersionExternalKeyReferenceDetail defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String externalKeyVersionId;
        public Builder() {}
        public Builder(KeyVersionExternalKeyReferenceDetail defaults) {
        ...
        public KeyVersionExternalKeyReferenceDetail build() {
            final var _resultValue = new KeyVersionExternalKeyReferenceDetail();
