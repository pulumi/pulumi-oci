...
public final class GetLicenseMetricArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetLicenseMetricArgs Empty = new GetLicenseMetricArgs();
    ...
    private GetLicenseMetricArgs() {}

    private GetLicenseMetricArgs(GetLicenseMetricArgs $) {
    ...
    public static Builder builder(GetLicenseMetricArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetLicenseMetricArgs();
        }

        public Builder(GetLicenseMetricArgs defaults) {
            $ = new GetLicenseMetricArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetLicenseMetricArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetLicenseMetricArgs", "compartmentId");
            }
            return $;
        }
    }
