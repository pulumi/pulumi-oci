...
public final class GetProductLicensesProductLicenseCollection {
    private @Nullable List<GetProductLicensesProductLicenseCollectionItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetProductLicensesProductLicenseCollectionItem> items) {
            this.items = items;
            return this;
        }
