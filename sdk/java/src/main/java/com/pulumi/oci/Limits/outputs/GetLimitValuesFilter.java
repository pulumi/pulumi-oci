...
@CustomType
public final class GetLimitValuesFilter {
    /**
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetLimitValuesFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetLimitValuesFilter", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetLimitValuesFilter build() {
            final var _resultValue = new GetLimitValuesFilter();
