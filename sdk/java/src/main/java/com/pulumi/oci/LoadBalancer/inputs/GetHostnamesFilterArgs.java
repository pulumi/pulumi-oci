...
public final class GetHostnamesFilterArgs extends com.pulumi.resources.ResourceArgs {
    ...
    private GetHostnamesFilterArgs() {}

    private GetHostnamesFilterArgs(GetHostnamesFilterArgs $) {
        this.name = $.name;
        this.regex = $.regex;
        this.values = $.values;
    }
    ...
    public static Builder builder(GetHostnamesFilterArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetHostnamesFilterArgs();
        }

        public Builder(GetHostnamesFilterArgs defaults) {
            $ = new GetHostnamesFilterArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetHostnamesFilterArgs build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetHostnamesFilterArgs", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetHostnamesFilterArgs", "values");
            }
            return $;
        }
    }
