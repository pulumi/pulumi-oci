...
import com.pulumi.oci.LoadBalancer.outputs.GetRuleSetsRuleSetItemIpMaxConnection;
...
public final class GetRuleSetsRuleSetItem {
     ...
     * 
     */
    public List<GetRuleSetsRuleSetItemIpMaxConnection> ipMaxConnections() {
    ...
    public static final class Builder {
        ...
        public Builder action(String action) {
            if (action == null) {
              throw new MissingRequiredPropertyException("GetRuleSetsRuleSetItem", "action");
            }
            this.action = action;
            return this;
        }
        ...
        public Builder allowedMethods(List<String> allowedMethods) {
            if (allowedMethods == null) {
              throw new MissingRequiredPropertyException("GetRuleSetsRuleSetItem", "allowedMethods");
            }
        ...
        public Builder areInvalidCharactersAllowed(Boolean areInvalidCharactersAllowed) {
            if (areInvalidCharactersAllowed == null) {
              throw new MissingRequiredPropertyException("GetRuleSetsRuleSetItem", "areInvalidCharactersAllowed");
            }
        ...
        public Builder conditions(List<GetRuleSetsRuleSetItemCondition> conditions) {
            if (conditions == null) {
              throw new MissingRequiredPropertyException("GetRuleSetsRuleSetItem", "conditions");
            }
        ...
        public Builder defaultMaxConnections(Integer defaultMaxConnections) {
            if (defaultMaxConnections == null) {
              throw new MissingRequiredPropertyException("GetRuleSetsRuleSetItem", "defaultMaxConnections");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetRuleSetsRuleSetItem", "description");
            }
        ...
        public Builder header(String header) {
            if (header == null) {
              throw new MissingRequiredPropertyException("GetRuleSetsRuleSetItem", "header");
            }
            this.header = header;
            return this;
        }
        ...
        public Builder httpLargeHeaderSizeInKb(Integer httpLargeHeaderSizeInKb) {
            if (httpLargeHeaderSizeInKb == null) {
              throw new MissingRequiredPropertyException("GetRuleSetsRuleSetItem", "httpLargeHeaderSizeInKb");
            }
            this.httpLargeHeaderSizeInKb = httpLargeHeaderSizeInKb;
            return this;
        }
        @CustomType.Setter
        public Builder ipMaxConnections(List<GetRuleSetsRuleSetItemIpMaxConnection> ipMaxConnections) {
            if (ipMaxConnections == null) {
              throw new MissingRequiredPropertyException("GetRuleSetsRuleSetItem", "ipMaxConnections");
            }
            this.ipMaxConnections = ipMaxConnections;
            return this;
        }
        public Builder ipMaxConnections(GetRuleSetsRuleSetItemIpMaxConnection... ipMaxConnections) {
            return ipMaxConnections(List.of(ipMaxConnections));
        }
        @CustomType.Setter
        public Builder prefix(String prefix) {
            if (prefix == null) {
              throw new MissingRequiredPropertyException("GetRuleSetsRuleSetItem", "prefix");
            }
            this.prefix = prefix;
            return this;
        }
        ...
        public Builder redirectUris(List<GetRuleSetsRuleSetItemRedirectUri> redirectUris) {
            if (redirectUris == null) {
              throw new MissingRequiredPropertyException("GetRuleSetsRuleSetItem", "redirectUris");
            }
        ...
        public Builder responseCode(Integer responseCode) {
            if (responseCode == null) {
              throw new MissingRequiredPropertyException("GetRuleSetsRuleSetItem", "responseCode");
            }
        ...
        public Builder statusCode(Integer statusCode) {
            if (statusCode == null) {
              throw new MissingRequiredPropertyException("GetRuleSetsRuleSetItem", "statusCode");
            }
        ...
        public Builder suffix(String suffix) {
            if (suffix == null) {
              throw new MissingRequiredPropertyException("GetRuleSetsRuleSetItem", "suffix");
            }
            this.suffix = suffix;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetRuleSetsRuleSetItem", "value");
            }
            this.value = value;
            return this;
        }
        public GetRuleSetsRuleSetItem build() {
            final var _resultValue = new GetRuleSetsRuleSetItem();
