...
@CustomType
public final class GetSslCipherSuitesFilter {
    /**
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetSslCipherSuitesFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetSslCipherSuitesFilter", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetSslCipherSuitesFilter build() {
            final var _resultValue = new GetSslCipherSuitesFilter();
