    ...
    public static final class Builder {
        ...
        public GetLogAnalyticsLogGroupsSummaryArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetLogAnalyticsLogGroupsSummaryArgs", "compartmentId");
            }
            if ($.namespace == null) {
                throw new MissingRequiredPropertyException("GetLogAnalyticsLogGroupsSummaryArgs", "namespace");
            }
            return $;
        }
    }
