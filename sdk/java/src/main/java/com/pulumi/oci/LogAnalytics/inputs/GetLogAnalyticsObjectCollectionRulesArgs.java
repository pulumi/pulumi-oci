    ...
    public static final class Builder {
        ...
        public GetLogAnalyticsObjectCollectionRulesArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetLogAnalyticsObjectCollectionRulesArgs", "compartmentId");
            }
            if ($.namespace == null) {
                throw new MissingRequiredPropertyException("GetLogAnalyticsObjectCollectionRulesArgs", "namespace");
            }
            return $;
        }
    }
