    ...
    public static final class Builder {
        ...
        public GetLogAnalyticsObjectCollectionRulesPlainArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetLogAnalyticsObjectCollectionRulesPlainArgs", "compartmentId");
            }
            if ($.namespace == null) {
                throw new MissingRequiredPropertyException("GetLogAnalyticsObjectCollectionRulesPlainArgs", "namespace");
            }
            return $;
        }
    }
