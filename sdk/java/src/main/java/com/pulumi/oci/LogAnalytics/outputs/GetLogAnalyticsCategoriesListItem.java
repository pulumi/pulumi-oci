...
public final class GetLogAnalyticsCategoriesListItem {
    ...
    public static final class Builder {
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetLogAnalyticsCategoriesListItem", "description");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetLogAnalyticsCategoriesListItem", "displayName");
            }
        ...
        public Builder isSystem(Boolean isSystem) {
            if (isSystem == null) {
              throw new MissingRequiredPropertyException("GetLogAnalyticsCategoriesListItem", "isSystem");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetLogAnalyticsCategoriesListItem", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetLogAnalyticsCategoriesListItem", "type");
            }
            this.type = type;
            return this;
        }
