    ...
    public static final class Builder {
        ...
        public Builder conditionField(String conditionField) {
            if (conditionField == null) {
              throw new MissingRequiredPropertyException("GetNamespaceIngestTimeRuleConditionAdditionalCondition", "conditionField");
            }
        ...
        public Builder conditionOperator(String conditionOperator) {
            if (conditionOperator == null) {
              throw new MissingRequiredPropertyException("GetNamespaceIngestTimeRuleConditionAdditionalCondition", "conditionOperator");
            }
        ...
        public Builder conditionValue(String conditionValue) {
            if (conditionValue == null) {
              throw new MissingRequiredPropertyException("GetNamespaceIngestTimeRuleConditionAdditionalCondition", "conditionValue");
            }
