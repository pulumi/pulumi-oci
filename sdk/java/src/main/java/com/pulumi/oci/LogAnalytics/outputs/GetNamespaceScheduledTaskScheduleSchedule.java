    ...
    public static final class Builder {
        ...
        public Builder queryOffsetSecs(Integer queryOffsetSecs) {
            if (queryOffsetSecs == null) {
              throw new MissingRequiredPropertyException("GetNamespaceScheduledTaskScheduleSchedule", "queryOffsetSecs");
            }
        ...
        public Builder timeEnd(String timeEnd) {
            if (timeEnd == null) {
              throw new MissingRequiredPropertyException("GetNamespaceScheduledTaskScheduleSchedule", "timeEnd");
            }
