...
public class LogGroup extends com.pulumi.resources.CustomResource {
     ...
     */
    public LogGroup(java.lang.String name, LogGroupArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LogGroup(java.lang.String name, LogGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Logging/logGroup:LogGroup", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private LogGroup(java.lang.String name, Output<java.lang.String> id, @Nullable LogGroupState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Logging/logGroup:LogGroup", name, state, makeResourceOptions(options, id), false);
    }

    private static LogGroupArgs makeArgs(LogGroupArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
