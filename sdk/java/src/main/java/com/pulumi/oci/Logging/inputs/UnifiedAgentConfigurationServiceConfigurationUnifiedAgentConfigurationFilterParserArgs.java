...
import com.pulumi.oci.Logging.inputs.UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserNestedParserArgs;
import com.pulumi.oci.Logging.inputs.UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserPatternArgs;
import com.pulumi.oci.Logging.inputs.UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserRecordInputArgs;
...
public final class UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserArgs extends com.pulumi.resources.ResourceArgs {

    public static final UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserArgs Empty = new UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserArgs();
    ...
    private @Nullable Output<UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserNestedParserArgs> nestedParser;

    /**
     * @return (Updatable) Optional nested JSON Parser for CRI. Supported fields are fieldTimeKey, timeFormat, and isKeepTimeKey.
     * 
     */
    public Optional<Output<UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserNestedParserArgs>> nestedParser() {
    ...
    private @Nullable Output<List<UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserPatternArgs>> patterns;

    /**
     * @return (Updatable) Grok pattern object.
     * 
     */
    public Optional<Output<List<UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserPatternArgs>>> patterns() {
    ...
    private @Nullable Output<UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserRecordInputArgs> recordInput;

    /**
     * @return (Updatable) record section of openmetrics parser.
     * 
     */
    public Optional<Output<UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserRecordInputArgs>> recordInput() {
    ...
    /**
     * (Updatable) Specify types for converting a field into another type. For example, With this configuration: &lt;parse&gt; {@literal @}type csv keys time,host,req_id,user timeKey time &lt;/parse&gt;
     * 
    ...
    private UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserArgs() {}

    private UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserArgs(UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserArgs $) {
    ...
    public static Builder builder(UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserArgs();
        }

        public Builder(UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserArgs defaults) {
            $ = new UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserArgs(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param isEstimateCurrentEvent (Updatable) If true, use Fluent::EventTime.now(current time) as a timestamp when the timeKey is specified.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param isSupportColonlessIdent (Updatable) Specifies whether or not to support colonless ident. Corresponds to the Fluentd supportColonlessIdent parameter.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param isWithPriority (Updatable) Specifies with priority or not. Corresponds to the Fluentd withPriority parameter.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder nestedParser(@Nullable Output<UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserNestedParserArgs> nestedParser) {
         ...
         * 
         */
        public Builder nestedParser(UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserNestedParserArgs nestedParser) {
         ...
         * 
         */
        public Builder patterns(@Nullable Output<List<UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserPatternArgs>> patterns) {
            $.patterns = patterns;
            return this;
        }
         ...
         * 
         */
        public Builder patterns(List<UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserPatternArgs> patterns) {
         ...
         * 
         */
        public Builder patterns(UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserPatternArgs... patterns) {
         ...
         * 
         */
        public Builder recordInput(@Nullable Output<UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserRecordInputArgs> recordInput) {
         ...
         * 
         */
        public Builder recordInput(UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserRecordInputArgs recordInput) {
        ...
        /**
         * @param types (Updatable) Specify types for converting a field into another type. For example, With this configuration: &lt;parse&gt; {@literal @}type csv keys time,host,req_id,user timeKey time &lt;/parse&gt;
         * 
         * This incoming event: &#34;2013/02/28 12:00:00,192.168.0.1,111,-&#34;
         * 
         * is parsed as: 1362020400 (2013/02/28/ 12:00:00)
        ...
        public UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserArgs build() {
            if ($.parserType == null) {
                throw new MissingRequiredPropertyException("UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterParserArgs", "parserType");
            }
            return $;
        }
    }
