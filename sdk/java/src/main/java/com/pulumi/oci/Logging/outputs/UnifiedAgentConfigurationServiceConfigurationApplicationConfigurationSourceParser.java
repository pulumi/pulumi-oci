...
import com.pulumi.oci.Logging.outputs.UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParserNestedParser;
import com.pulumi.oci.Logging.outputs.UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParserPattern;
...
@CustomType
public final class UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParser {
    /**
     ...
     * 
     */
    private @Nullable UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParserNestedParser nestedParser;
    /**
     ...
     * 
     */
    private @Nullable List<UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParserPattern> patterns;
    /**
     * @return (Updatable) record section of openmetrics parser.
     * 
     */
    private @Nullable UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParserRecordInput recordInput;
    /**
     ...
     * 
     */
    public Optional<UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParserNestedParser> nestedParser() {
     ...
     * 
     */
    public List<UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParserPattern> patterns() {
     ...
     * 
     */
    public Optional<UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParserRecordInput> recordInput() {
    ...
    public static Builder builder(UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParser defaults) {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder nestedParser(@Nullable UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParserNestedParser nestedParser) {
        ...
        public Builder parserType(String parserType) {
            if (parserType == null) {
              throw new MissingRequiredPropertyException("UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParser", "parserType");
            }
            this.parserType = parserType;
            return this;
        }
        @CustomType.Setter
        public Builder patterns(@Nullable List<UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParserPattern> patterns) {

            this.patterns = patterns;
            return this;
        }
        public Builder patterns(UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParserPattern... patterns) {
            return patterns(List.of(patterns));
        }
        @CustomType.Setter
        public Builder recordInput(@Nullable UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParserRecordInput recordInput) {
        ...
        public UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParser build() {
            final var _resultValue = new UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParser();
