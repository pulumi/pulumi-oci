...
@CustomType
public final class GetFileStorageLustreFileSystemsLustreFileSystemCollectionItemRootSquashConfiguration {
    /**
    ...
    private GetFileStorageLustreFileSystemsLustreFileSystemCollectionItemRootSquashConfiguration() {}
    /**
     * @return A list of NIDs allowed with this lustre file system not to be squashed. A maximum of 10 is allowed.
     * 
     */
    ...
    public static Builder builder(GetFileStorageLustreFileSystemsLustreFileSystemCollectionItemRootSquashConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private String squashUid;
        public Builder() {}
        public Builder(GetFileStorageLustreFileSystemsLustreFileSystemCollectionItemRootSquashConfiguration defaults) {
        ...
        public Builder clientExceptions(List<String> clientExceptions) {
            if (clientExceptions == null) {
              throw new MissingRequiredPropertyException("GetFileStorageLustreFileSystemsLustreFileSystemCollectionItemRootSquashConfiguration", "clientExceptions");
            }
        ...
        public Builder identitySquash(String identitySquash) {
            if (identitySquash == null) {
              throw new MissingRequiredPropertyException("GetFileStorageLustreFileSystemsLustreFileSystemCollectionItemRootSquashConfiguration", "identitySquash");
            }
        ...
        public Builder squashGid(String squashGid) {
            if (squashGid == null) {
              throw new MissingRequiredPropertyException("GetFileStorageLustreFileSystemsLustreFileSystemCollectionItemRootSquashConfiguration", "squashGid");
            }
        ...
        public Builder squashUid(String squashUid) {
            if (squashUid == null) {
              throw new MissingRequiredPropertyException("GetFileStorageLustreFileSystemsLustreFileSystemCollectionItemRootSquashConfiguration", "squashUid");
            }
            this.squashUid = squashUid;
            return this;
        }
        public GetFileStorageLustreFileSystemsLustreFileSystemCollectionItemRootSquashConfiguration build() {
            final var _resultValue = new GetFileStorageLustreFileSystemsLustreFileSystemCollectionItemRootSquashConfiguration();
