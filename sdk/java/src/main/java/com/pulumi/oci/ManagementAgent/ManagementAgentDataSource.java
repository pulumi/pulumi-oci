 ...
 *             .type(var_.management_agent_data_source_type())
 *             .url(var_.management_agent_data_source_url())
 *             .allowMetrics(var_.management_agent_data_source_allow_metrics())
 *             .connectionTimeout(var_.management_agent_data_source_connection_timeout())
 *             .metricDimensions(ManagementAgentDataSourceMetricDimensionArgs.builder()
 *                 .name(var_.management_agent_data_source_metric_dimensions_name())
 *                 .value(var_.management_agent_data_source_metric_dimensions_value())
 *                 .build())
 *             .namespace(var_.management_agent_data_source_namespace())
 *             .proxyUrl(var_.management_agent_data_source_proxy_url())
 *             .readDataLimitInKilobytes(var_.management_agent_data_source_read_data_limit_in_kilobytes())
 *             .readTimeout(var_.management_agent_data_source_read_timeout())
 *             .resourceGroup(var_.management_agent_data_source_resource_group())
 *             .scheduleMins(var_.management_agent_data_source_schedule_mins())
 *             .build());
 * 
 *     }
 * }
