    ...
    public static final class Builder {
        ...
        public GetManagementAgentCountArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetManagementAgentCountArgs", "compartmentId");
            }
            if ($.groupBies == null) {
                throw new MissingRequiredPropertyException("GetManagementAgentCountArgs", "groupBies");
            }
            return $;
        }
    }
