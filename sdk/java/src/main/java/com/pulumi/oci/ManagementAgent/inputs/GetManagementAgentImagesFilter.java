...
public final class GetManagementAgentImagesFilter extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetManagementAgentImagesFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetManagementAgentImagesFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetManagementAgentImagesFilter", "values");
            }
            return $;
        }
    }
