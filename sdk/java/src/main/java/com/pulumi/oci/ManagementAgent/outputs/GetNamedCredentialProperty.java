...
@CustomType
public final class GetNamedCredentialProperty {
    /**
    ...
    private GetNamedCredentialProperty() {}
    /**
     * @return Name of the property
     * 
     */
    ...
    public static Builder builder(GetNamedCredentialProperty defaults) {
    ...
    public static final class Builder {
        ...
        private String valueCategory;
        public Builder() {}
        public Builder(GetNamedCredentialProperty defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetNamedCredentialProperty", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetNamedCredentialProperty", "value");
            }
            this.value = value;
            return this;
        }
        ...
        public Builder valueCategory(String valueCategory) {
            if (valueCategory == null) {
              throw new MissingRequiredPropertyException("GetNamedCredentialProperty", "valueCategory");
            }
            this.valueCategory = valueCategory;
            return this;
        }
        public GetNamedCredentialProperty build() {
            final var _resultValue = new GetNamedCredentialProperty();
