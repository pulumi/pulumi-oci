...
@CustomType
public final class ManagementAgentManagementAgentProperty {
    /**
    ...
    private ManagementAgentManagementAgentProperty() {}
    /**
     * @return Name of the property
     * 
     */
    ...
    public static Builder builder(ManagementAgentManagementAgentProperty defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> values;
        public Builder() {}
        public Builder(ManagementAgentManagementAgentProperty defaults) {
