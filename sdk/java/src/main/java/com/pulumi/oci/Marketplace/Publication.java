...
public class Publication extends com.pulumi.resources.CustomResource {
     ...
     */
    public Publication(java.lang.String name, PublicationArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Publication(java.lang.String name, PublicationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Marketplace/publication:Publication", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Publication(java.lang.String name, Output<java.lang.String> id, @Nullable PublicationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Marketplace/publication:Publication", name, state, makeResourceOptions(options, id), false);
    }

    private static PublicationArgs makeArgs(PublicationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
