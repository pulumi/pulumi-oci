    ...
    public static final class Builder {
        ...
        public Builder documentCategory(String documentCategory) {
            if (documentCategory == null) {
              throw new MissingRequiredPropertyException("GetListingDocumentationLink", "documentCategory");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetListingDocumentationLink", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder url(String url) {
            if (url == null) {
              throw new MissingRequiredPropertyException("GetListingDocumentationLink", "url");
            }
            this.url = url;
            return this;
        }
