...
@CustomType
public final class GetListingIcon {
    /**
    ...
    public static final class Builder {
        ...
        public Builder contentUrl(String contentUrl) {
            if (contentUrl == null) {
              throw new MissingRequiredPropertyException("GetListingIcon", "contentUrl");
            }
        ...
        public Builder fileExtension(String fileExtension) {
            if (fileExtension == null) {
              throw new MissingRequiredPropertyException("GetListingIcon", "fileExtension");
            }
        ...
        public Builder mimeType(String mimeType) {
            if (mimeType == null) {
              throw new MissingRequiredPropertyException("GetListingIcon", "mimeType");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetListingIcon", "name");
            }
            this.name = name;
            return this;
        }
        public GetListingIcon build() {
            final var _resultValue = new GetListingIcon();
