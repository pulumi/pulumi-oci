...
public final class GetListingPackageRegionCountry {
    ...
    public static final class Builder {
        ...
        public Builder code(String code) {
            if (code == null) {
              throw new MissingRequiredPropertyException("GetListingPackageRegionCountry", "code");
            }
            this.code = code;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetListingPackageRegionCountry", "name");
            }
            this.name = name;
            return this;
        }
