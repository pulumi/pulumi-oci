...
public final class GetPublicationsPublicationSupportedOperatingSystem {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetPublicationsPublicationSupportedOperatingSystem", "name");
            }
            this.name = name;
            return this;
        }
        public GetPublicationsPublicationSupportedOperatingSystem build() {
            final var _resultValue = new GetPublicationsPublicationSupportedOperatingSystem();
