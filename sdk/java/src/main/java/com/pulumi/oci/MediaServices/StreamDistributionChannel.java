...
public class StreamDistributionChannel extends com.pulumi.resources.CustomResource {
    ...
    public StreamDistributionChannel(String name, StreamDistributionChannelArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:MediaServices/streamDistributionChannel:StreamDistributionChannel", name, args == null ? StreamDistributionChannelArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
