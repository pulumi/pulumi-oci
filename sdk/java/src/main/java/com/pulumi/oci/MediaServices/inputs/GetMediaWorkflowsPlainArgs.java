...
import com.pulumi.oci.MediaServices.inputs.GetMediaWorkflowsFilter;
...
public final class GetMediaWorkflowsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetMediaWorkflowsPlainArgs Empty = new GetMediaWorkflowsPlainArgs();
    ...
    public Optional<List<GetMediaWorkflowsFilter>> filters() {
    ...
    private GetMediaWorkflowsPlainArgs() {}

    private GetMediaWorkflowsPlainArgs(GetMediaWorkflowsPlainArgs $) {
    ...
    public static Builder builder(GetMediaWorkflowsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetMediaWorkflowsPlainArgs();
        }

        public Builder(GetMediaWorkflowsPlainArgs defaults) {
            $ = new GetMediaWorkflowsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetMediaWorkflowsPlainArgs build() {
            return $;
        }
    }
