...
public final class StreamCdnConfigState extends com.pulumi.resources.ResourceArgs {
     ...
     */
    @Import(name="config")
    private @Nullable Output<StreamCdnConfigConfigArgs> config;

    /**
     * @return (Updatable) Base fields of the StreamCdnConfig configuration object.
     * 
     */
    public Optional<Output<StreamCdnConfigConfigArgs>> config() {
    ...
    private StreamCdnConfigState() {}

    private StreamCdnConfigState(StreamCdnConfigState $) {
    ...
    public static Builder builder(StreamCdnConfigState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StreamCdnConfigState();
        }

        public Builder(StreamCdnConfigState defaults) {
            $ = new StreamCdnConfigState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder config(@Nullable Output<StreamCdnConfigConfigArgs> config) {
            $.config = config;
            return this;
        }
        ...
        /**
         * @param state The current state of the CDN Configuration.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param timeUpdated The time when the CDN Config was updated. An RFC3339 formatted datetime string.
         * 
         * @return builder
         * 
         */
        ...
        public StreamCdnConfigState build() {
            return $;
        }
    }
