...
@CustomType
public final class GetMediaAssetLock {
    /**
    ...
    public static Builder builder(GetMediaAssetLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetMediaAssetLock defaults) {
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetMediaAssetLock", "compartmentId");
            }
        ...
        public Builder message(String message) {
            if (message == null) {
              throw new MissingRequiredPropertyException("GetMediaAssetLock", "message");
            }
        ...
        public Builder relatedResourceId(String relatedResourceId) {
            if (relatedResourceId == null) {
              throw new MissingRequiredPropertyException("GetMediaAssetLock", "relatedResourceId");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetMediaAssetLock", "timeCreated");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetMediaAssetLock", "type");
            }
            this.type = type;
            return this;
        }
        public GetMediaAssetLock build() {
            final var _resultValue = new GetMediaAssetLock();
