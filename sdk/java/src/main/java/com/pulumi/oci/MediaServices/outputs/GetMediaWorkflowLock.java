...
@CustomType
public final class GetMediaWorkflowLock {
    /**
    ...
    public static Builder builder(GetMediaWorkflowLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetMediaWorkflowLock defaults) {
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowLock", "compartmentId");
            }
        ...
        public Builder message(String message) {
            if (message == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowLock", "message");
            }
        ...
        public Builder relatedResourceId(String relatedResourceId) {
            if (relatedResourceId == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowLock", "relatedResourceId");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowLock", "timeCreated");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowLock", "type");
            }
            this.type = type;
            return this;
        }
        public GetMediaWorkflowLock build() {
            final var _resultValue = new GetMediaWorkflowLock();
