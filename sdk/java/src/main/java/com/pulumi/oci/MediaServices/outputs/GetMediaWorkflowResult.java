...
import com.pulumi.oci.MediaServices.outputs.GetMediaWorkflowLock;
...
public final class GetMediaWorkflowResult {
     ...
     * 
     */
    private List<GetMediaWorkflowLock> locks;
    /**
     ...
     * 
     */
    public List<GetMediaWorkflowLock> locks() {
        return this.locks;
    }
    /**
     * @return Configurations to be applied to all the runs of this workflow. Parameters in these configurations are overridden by parameters in the MediaWorkflowConfigurations of the MediaWorkflowJob and the parameters of the MediaWorkflowJob. If the same parameter appears in multiple configurations, the values that appear in the configuration at the highest index will be used.
    ...
    public static final class Builder {
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowResult", "compartmentId");
            }
        ...
        public Builder definedTags(Map<String,String> definedTags) {
            if (definedTags == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowResult", "definedTags");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowResult", "displayName");
            }
        ...
        public Builder freeformTags(Map<String,String> freeformTags) {
            if (freeformTags == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowResult", "freeformTags");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isLockOverride(Boolean isLockOverride) {
            if (isLockOverride == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowResult", "isLockOverride");
            }
        ...
        public Builder lifecyleDetails(String lifecyleDetails) {
            if (lifecyleDetails == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowResult", "lifecyleDetails");
            }
            this.lifecyleDetails = lifecyleDetails;
            return this;
        }
        @CustomType.Setter
        public Builder locks(List<GetMediaWorkflowLock> locks) {
            if (locks == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowResult", "locks");
            }
            this.locks = locks;
            return this;
        }
        public Builder locks(GetMediaWorkflowLock... locks) {
        ...
        public Builder mediaWorkflowConfigurationIds(List<String> mediaWorkflowConfigurationIds) {
            if (mediaWorkflowConfigurationIds == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowResult", "mediaWorkflowConfigurationIds");
            }
        ...
        public Builder mediaWorkflowId(String mediaWorkflowId) {
            if (mediaWorkflowId == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowResult", "mediaWorkflowId");
            }
        ...
        public Builder parameters(String parameters) {
            if (parameters == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowResult", "parameters");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowResult", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder systemTags(Map<String,String> systemTags) {
            if (systemTags == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowResult", "systemTags");
            }
        ...
        public Builder tasks(List<GetMediaWorkflowTask> tasks) {
            if (tasks == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowResult", "tasks");
            }
            this.tasks = tasks;
            return this;
        }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowResult", "timeCreated");
            }
        ...
        public Builder timeUpdated(String timeUpdated) {
            if (timeUpdated == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowResult", "timeUpdated");
            }
        ...
        public Builder version(String version) {
            if (version == null) {
              throw new MissingRequiredPropertyException("GetMediaWorkflowResult", "version");
            }
            this.version = version;
            return this;
        }
        public GetMediaWorkflowResult build() {
            final var _resultValue = new GetMediaWorkflowResult();
