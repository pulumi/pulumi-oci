...
public final class GetStreamPackagingConfigsStreamPackagingConfigCollectionItemEncryption {
    ...
    public static final class Builder {
        ...
        public Builder algorithm(String algorithm) {
            if (algorithm == null) {
              throw new MissingRequiredPropertyException("GetStreamPackagingConfigsStreamPackagingConfigCollectionItemEncryption", "algorithm");
            }
        ...
        public Builder kmsKeyId(String kmsKeyId) {
            if (kmsKeyId == null) {
              throw new MissingRequiredPropertyException("GetStreamPackagingConfigsStreamPackagingConfigCollectionItemEncryption", "kmsKeyId");
            }
            this.kmsKeyId = kmsKeyId;
            return this;
        }
        public GetStreamPackagingConfigsStreamPackagingConfigCollectionItemEncryption build() {
            final var _resultValue = new GetStreamPackagingConfigsStreamPackagingConfigCollectionItemEncryption();
