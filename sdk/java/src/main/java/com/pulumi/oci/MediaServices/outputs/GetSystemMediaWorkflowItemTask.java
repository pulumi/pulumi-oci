...
@CustomType
public final class GetSystemMediaWorkflowItemTask {
    /**
    ...
    private String type;
    /**
     * @return The version of the MediaWorkflowTaskDeclaration.
     * 
     */
    private String version;

    private GetSystemMediaWorkflowItemTask() {}
    /**
     * @return Allows this task to be conditionally enabled.  If no value or a blank value is given, the task is unconditionally enbled.  Otherwise the given string specifies a parameter of the job created for this task&#39;s workflow using the JSON pointer syntax. The JSON pointer is validated when a job is created from the workflow of this task.
     * 
     */
    ...
    public static Builder builder(GetSystemMediaWorkflowItemTask defaults) {
    ...
    public static final class Builder {
        ...
        private String version;
        public Builder() {}
        public Builder(GetSystemMediaWorkflowItemTask defaults) {
        ...
        public GetSystemMediaWorkflowItemTask build() {
            final var _resultValue = new GetSystemMediaWorkflowItemTask();
