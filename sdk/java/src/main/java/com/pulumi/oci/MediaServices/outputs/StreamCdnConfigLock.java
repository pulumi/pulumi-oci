...
@CustomType
public final class StreamCdnConfigLock {
    /**
    ...
    public static Builder builder(StreamCdnConfigLock defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(StreamCdnConfigLock defaults) {
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("StreamCdnConfigLock", "compartmentId");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("StreamCdnConfigLock", "type");
            }
            this.type = type;
            return this;
        }
        public StreamCdnConfigLock build() {
            final var _resultValue = new StreamCdnConfigLock();
