...
public class UsageCarbonEmissionsQuery extends com.pulumi.resources.CustomResource {
     ...
     */
    public UsageCarbonEmissionsQuery(java.lang.String name) {
     ...
     */
    public UsageCarbonEmissionsQuery(java.lang.String name, UsageCarbonEmissionsQueryArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public UsageCarbonEmissionsQuery(java.lang.String name, UsageCarbonEmissionsQueryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:MeteringComputation/usageCarbonEmissionsQuery:UsageCarbonEmissionsQuery", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private UsageCarbonEmissionsQuery(java.lang.String name, Output<java.lang.String> id, @Nullable UsageCarbonEmissionsQueryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:MeteringComputation/usageCarbonEmissionsQuery:UsageCarbonEmissionsQuery", name, state, makeResourceOptions(options, id), false);
    }

    private static UsageCarbonEmissionsQueryArgs makeArgs(UsageCarbonEmissionsQueryArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? UsageCarbonEmissionsQueryArgs.Empty : args;
    }
     ...
     */
    public static UsageCarbonEmissionsQuery get(java.lang.String name, Output<java.lang.String> id, @Nullable UsageCarbonEmissionsQueryState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
