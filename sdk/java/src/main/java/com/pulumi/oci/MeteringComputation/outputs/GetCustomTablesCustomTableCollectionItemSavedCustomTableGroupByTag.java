...
public final class GetCustomTablesCustomTableCollectionItemSavedCustomTableGroupByTag {
    ...
    public static final class Builder {
        ...
        public Builder key(String key) {
            if (key == null) {
              throw new MissingRequiredPropertyException("GetCustomTablesCustomTableCollectionItemSavedCustomTableGroupByTag", "key");
            }
            this.key = key;
            return this;
        }
        ...
        public Builder namespace(String namespace) {
            if (namespace == null) {
              throw new MissingRequiredPropertyException("GetCustomTablesCustomTableCollectionItemSavedCustomTableGroupByTag", "namespace");
            }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetCustomTablesCustomTableCollectionItemSavedCustomTableGroupByTag", "value");
            }
            this.value = value;
            return this;
        }
