...
public final class GetQueriesQueryCollectionItemQueryDefinitionCostAnalysisUi {
    ...
    public static final class Builder {
        ...
        public Builder graph(String graph) {
            if (graph == null) {
              throw new MissingRequiredPropertyException("GetQueriesQueryCollectionItemQueryDefinitionCostAnalysisUi", "graph");
            }
            this.graph = graph;
            return this;
        }
        ...
        public Builder isCumulativeGraph(Boolean isCumulativeGraph) {
            if (isCumulativeGraph == null) {
              throw new MissingRequiredPropertyException("GetQueriesQueryCollectionItemQueryDefinitionCostAnalysisUi", "isCumulativeGraph");
            }
