...
@CustomType
public final class ScheduleResultLocation {
    /**
    ...
    public static Builder builder(ScheduleResultLocation defaults) {
    ...
    public static final class Builder {
        ...
        private String region;
        public Builder() {}
        public Builder(ScheduleResultLocation defaults) {
        ...
        public Builder bucket(String bucket) {
            if (bucket == null) {
              throw new MissingRequiredPropertyException("ScheduleResultLocation", "bucket");
            }
            this.bucket = bucket;
            return this;
        }
        ...
        public Builder locationType(String locationType) {
            if (locationType == null) {
              throw new MissingRequiredPropertyException("ScheduleResultLocation", "locationType");
            }
        ...
        public Builder namespace(String namespace) {
            if (namespace == null) {
              throw new MissingRequiredPropertyException("ScheduleResultLocation", "namespace");
            }
        ...
        public Builder region(String region) {
            if (region == null) {
              throw new MissingRequiredPropertyException("ScheduleResultLocation", "region");
            }
            this.region = region;
            return this;
        }
