    ...
    public static final class Builder {
        ...
        public GetMetricDataPlainArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetMetricDataPlainArgs", "compartmentId");
            }
            if ($.namespace == null) {
                throw new MissingRequiredPropertyException("GetMetricDataPlainArgs", "namespace");
            }
            if ($.query == null) {
                throw new MissingRequiredPropertyException("GetMetricDataPlainArgs", "query");
            }
            return $;
        }
    }
