...
@CustomType
public final class GetAlarmOverride {
    /**
    ...
    public static Builder builder(GetAlarmOverride defaults) {
    ...
    public static final class Builder {
        ...
        private String severity;
        public Builder() {}
        public Builder(GetAlarmOverride defaults) {
        ...
        public Builder body(String body) {
            if (body == null) {
              throw new MissingRequiredPropertyException("GetAlarmOverride", "body");
            }
            this.body = body;
            return this;
        }
        ...
        public Builder pendingDuration(String pendingDuration) {
            if (pendingDuration == null) {
              throw new MissingRequiredPropertyException("GetAlarmOverride", "pendingDuration");
            }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("GetAlarmOverride", "query");
            }
            this.query = query;
            return this;
        }
        ...
        public Builder ruleName(String ruleName) {
            if (ruleName == null) {
              throw new MissingRequiredPropertyException("GetAlarmOverride", "ruleName");
            }
        ...
        public Builder severity(String severity) {
            if (severity == null) {
              throw new MissingRequiredPropertyException("GetAlarmOverride", "severity");
            }
            this.severity = severity;
            return this;
        }
        public GetAlarmOverride build() {
            final var _resultValue = new GetAlarmOverride();
