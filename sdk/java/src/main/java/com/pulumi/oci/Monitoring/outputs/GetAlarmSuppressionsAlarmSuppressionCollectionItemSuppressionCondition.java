...
@CustomType
public final class GetAlarmSuppressionsAlarmSuppressionCollectionItemSuppressionCondition {
    /**
    ...
    private GetAlarmSuppressionsAlarmSuppressionCollectionItemSuppressionCondition() {}
    /**
     * @return Type of suppression condition.
     * 
     */
    ...
    public static Builder builder(GetAlarmSuppressionsAlarmSuppressionCollectionItemSuppressionCondition defaults) {
    ...
    public static final class Builder {
        ...
        private String suppressionRecurrence;
        public Builder() {}
        public Builder(GetAlarmSuppressionsAlarmSuppressionCollectionItemSuppressionCondition defaults) {
        ...
        public Builder conditionType(String conditionType) {
            if (conditionType == null) {
              throw new MissingRequiredPropertyException("GetAlarmSuppressionsAlarmSuppressionCollectionItemSuppressionCondition", "conditionType");
            }
        ...
        public Builder suppressionDuration(String suppressionDuration) {
            if (suppressionDuration == null) {
              throw new MissingRequiredPropertyException("GetAlarmSuppressionsAlarmSuppressionCollectionItemSuppressionCondition", "suppressionDuration");
            }
        ...
        public Builder suppressionRecurrence(String suppressionRecurrence) {
            if (suppressionRecurrence == null) {
              throw new MissingRequiredPropertyException("GetAlarmSuppressionsAlarmSuppressionCollectionItemSuppressionCondition", "suppressionRecurrence");
            }
            this.suppressionRecurrence = suppressionRecurrence;
            return this;
        }
        public GetAlarmSuppressionsAlarmSuppressionCollectionItemSuppressionCondition build() {
            final var _resultValue = new GetAlarmSuppressionsAlarmSuppressionCollectionItemSuppressionCondition();
