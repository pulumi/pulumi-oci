...
import com.pulumi.oci.Mysql.inputs.GetrRplicasFilter;
...
public final class GetrRplicasPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetrRplicasPlainArgs Empty = new GetrRplicasPlainArgs();
    ...
    @Import(name="filters")
    private @Nullable List<GetrRplicasFilter> filters;

    public Optional<List<GetrRplicasFilter>> filters() {
    ...
    private GetrRplicasPlainArgs() {}

    private GetrRplicasPlainArgs(GetrRplicasPlainArgs $) {
    ...
    public static Builder builder(GetrRplicasPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetrRplicasPlainArgs();
        }

        public Builder(GetrRplicasPlainArgs defaults) {
            $ = new GetrRplicasPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable List<GetrRplicasFilter> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(GetrRplicasFilter... filters) {
        ...
        public GetrRplicasPlainArgs build() {
