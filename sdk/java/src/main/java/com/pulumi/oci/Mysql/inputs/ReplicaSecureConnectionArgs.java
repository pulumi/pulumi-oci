...
public final class ReplicaSecureConnectionArgs extends com.pulumi.resources.ResourceArgs {

    public static final ReplicaSecureConnectionArgs Empty = new ReplicaSecureConnectionArgs();
    ...
    private ReplicaSecureConnectionArgs() {}

    private ReplicaSecureConnectionArgs(ReplicaSecureConnectionArgs $) {
    ...
    public static Builder builder(ReplicaSecureConnectionArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ReplicaSecureConnectionArgs();
        }

        public Builder(ReplicaSecureConnectionArgs defaults) {
            $ = new ReplicaSecureConnectionArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ReplicaSecureConnectionArgs build() {
            return $;
        }
    }
