...
import com.pulumi.oci.Mysql.outputs.GetChannelTargetFilter;
    ...
    public static final class Builder {
        ...
        public Builder applierUsername(String applierUsername) {
            if (applierUsername == null) {
              throw new MissingRequiredPropertyException("GetChannelTarget", "applierUsername");
            }
        ...
        public Builder channelName(String channelName) {
            if (channelName == null) {
              throw new MissingRequiredPropertyException("GetChannelTarget", "channelName");
            }
        ...
        public Builder dbSystemId(String dbSystemId) {
            if (dbSystemId == null) {
              throw new MissingRequiredPropertyException("GetChannelTarget", "dbSystemId");
            }
        ...
        public Builder delayInSeconds(Integer delayInSeconds) {
            if (delayInSeconds == null) {
              throw new MissingRequiredPropertyException("GetChannelTarget", "delayInSeconds");
            }
        ...
        public Builder filters(List<GetChannelTargetFilter> filters) {
            if (filters == null) {
              throw new MissingRequiredPropertyException("GetChannelTarget", "filters");
            }
        ...
        public Builder tablesWithoutPrimaryKeyHandling(String tablesWithoutPrimaryKeyHandling) {
            if (tablesWithoutPrimaryKeyHandling == null) {
              throw new MissingRequiredPropertyException("GetChannelTarget", "tablesWithoutPrimaryKeyHandling");
            }
        ...
        public Builder targetType(String targetType) {
            if (targetType == null) {
              throw new MissingRequiredPropertyException("GetChannelTarget", "targetType");
            }
            this.targetType = targetType;
            return this;
        }
        public GetChannelTarget build() {
            final var _resultValue = new GetChannelTarget();
