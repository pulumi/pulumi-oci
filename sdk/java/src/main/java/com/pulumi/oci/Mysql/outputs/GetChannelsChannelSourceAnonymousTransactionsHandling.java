    ...
    public static final class Builder {
        ...
        public Builder lastConfiguredLogFilename(String lastConfiguredLogFilename) {
            if (lastConfiguredLogFilename == null) {
              throw new MissingRequiredPropertyException("GetChannelsChannelSourceAnonymousTransactionsHandling", "lastConfiguredLogFilename");
            }
        ...
        public Builder lastConfiguredLogOffset(String lastConfiguredLogOffset) {
            if (lastConfiguredLogOffset == null) {
              throw new MissingRequiredPropertyException("GetChannelsChannelSourceAnonymousTransactionsHandling", "lastConfiguredLogOffset");
            }
        ...
        public Builder policy(String policy) {
            if (policy == null) {
              throw new MissingRequiredPropertyException("GetChannelsChannelSourceAnonymousTransactionsHandling", "policy");
            }
            this.policy = policy;
            return this;
        }
        ...
        public Builder uuid(String uuid) {
            if (uuid == null) {
              throw new MissingRequiredPropertyException("GetChannelsChannelSourceAnonymousTransactionsHandling", "uuid");
            }
            this.uuid = uuid;
            return this;
        }
