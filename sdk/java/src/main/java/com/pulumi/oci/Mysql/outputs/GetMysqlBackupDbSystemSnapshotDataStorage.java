...
@CustomType
public final class GetMysqlBackupDbSystemSnapshotDataStorage {
    /**
    ...
    private GetMysqlBackupDbSystemSnapshotDataStorage() {}
    /**
     * @return The actual allocated storage size for the DB System. This may be higher than dataStorageSizeInGBs if an automatic storage expansion has occurred.
     * 
     */
    ...
    public static Builder builder(GetMysqlBackupDbSystemSnapshotDataStorage defaults) {
    ...
    public static final class Builder {
        ...
        private Integer maxStorageSizeInGbs;
        public Builder() {}
        public Builder(GetMysqlBackupDbSystemSnapshotDataStorage defaults) {
        ...
        public Builder allocatedStorageSizeInGbs(Integer allocatedStorageSizeInGbs) {
            if (allocatedStorageSizeInGbs == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupDbSystemSnapshotDataStorage", "allocatedStorageSizeInGbs");
            }
        ...
        public Builder dataStorageSizeInGb(Integer dataStorageSizeInGb) {
            if (dataStorageSizeInGb == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupDbSystemSnapshotDataStorage", "dataStorageSizeInGb");
            }
        ...
        public Builder dataStorageSizeLimitInGbs(Integer dataStorageSizeLimitInGbs) {
            if (dataStorageSizeLimitInGbs == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupDbSystemSnapshotDataStorage", "dataStorageSizeLimitInGbs");
            }
        ...
        public Builder isAutoExpandStorageEnabled(Boolean isAutoExpandStorageEnabled) {
            if (isAutoExpandStorageEnabled == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupDbSystemSnapshotDataStorage", "isAutoExpandStorageEnabled");
            }
        ...
        public Builder maxStorageSizeInGbs(Integer maxStorageSizeInGbs) {
            if (maxStorageSizeInGbs == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupDbSystemSnapshotDataStorage", "maxStorageSizeInGbs");
            }
            this.maxStorageSizeInGbs = maxStorageSizeInGbs;
            return this;
        }
        public GetMysqlBackupDbSystemSnapshotDataStorage build() {
            final var _resultValue = new GetMysqlBackupDbSystemSnapshotDataStorage();
