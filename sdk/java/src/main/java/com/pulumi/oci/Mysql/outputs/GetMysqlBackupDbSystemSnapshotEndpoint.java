    ...
    public static final class Builder {
        ...
        public Builder ipAddressVersion(String ipAddressVersion) {
            if (ipAddressVersion == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupDbSystemSnapshotEndpoint", "ipAddressVersion");
            }
        ...
        public GetMysqlBackupDbSystemSnapshotEndpoint build() {
            final var _resultValue = new GetMysqlBackupDbSystemSnapshotEndpoint();
