...
import com.pulumi.oci.Mysql.outputs.GetMysqlBackupDbSystemSnapshotMaintenanceMaintenanceDisabledWindow;
...
public final class GetMysqlBackupDbSystemSnapshotMaintenance {
     ...
     * 
     */
    private List<GetMysqlBackupDbSystemSnapshotMaintenanceMaintenanceDisabledWindow> maintenanceDisabledWindows;
    /**
     ...
     * 
     */
    public List<GetMysqlBackupDbSystemSnapshotMaintenanceMaintenanceDisabledWindow> maintenanceDisabledWindows() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder maintenanceDisabledWindows(List<GetMysqlBackupDbSystemSnapshotMaintenanceMaintenanceDisabledWindow> maintenanceDisabledWindows) {
            if (maintenanceDisabledWindows == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupDbSystemSnapshotMaintenance", "maintenanceDisabledWindows");
            }
            this.maintenanceDisabledWindows = maintenanceDisabledWindows;
            return this;
        }
        public Builder maintenanceDisabledWindows(GetMysqlBackupDbSystemSnapshotMaintenanceMaintenanceDisabledWindow... maintenanceDisabledWindows) {
        ...
        public Builder maintenanceScheduleType(String maintenanceScheduleType) {
            if (maintenanceScheduleType == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupDbSystemSnapshotMaintenance", "maintenanceScheduleType");
            }
        ...
        public Builder targetVersion(String targetVersion) {
            if (targetVersion == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupDbSystemSnapshotMaintenance", "targetVersion");
            }
        ...
        public Builder timeScheduled(String timeScheduled) {
            if (timeScheduled == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupDbSystemSnapshotMaintenance", "timeScheduled");
            }
        ...
        public Builder versionPreference(String versionPreference) {
            if (versionPreference == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupDbSystemSnapshotMaintenance", "versionPreference");
            }
        ...
        public Builder versionTrackPreference(String versionTrackPreference) {
            if (versionTrackPreference == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupDbSystemSnapshotMaintenance", "versionTrackPreference");
            }
        ...
        public Builder windowStartTime(String windowStartTime) {
            if (windowStartTime == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupDbSystemSnapshotMaintenance", "windowStartTime");
            }
            this.windowStartTime = windowStartTime;
            return this;
        }
        public GetMysqlBackupDbSystemSnapshotMaintenance build() {
            final var _resultValue = new GetMysqlBackupDbSystemSnapshotMaintenance();
