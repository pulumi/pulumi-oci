...
@CustomType
public final class GetMysqlBackupDbSystemSnapshotReadEndpoint {
    /**
    ...
    public static Builder builder(GetMysqlBackupDbSystemSnapshotReadEndpoint defaults) {
    ...
    public static final class Builder {
        ...
        public Builder excludeIps(List<String> excludeIps) {
            if (excludeIps == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupDbSystemSnapshotReadEndpoint", "excludeIps");
            }
        ...
        public Builder isEnabled(Boolean isEnabled) {
            if (isEnabled == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupDbSystemSnapshotReadEndpoint", "isEnabled");
            }
        ...
        public Builder readEndpointHostnameLabel(String readEndpointHostnameLabel) {
            if (readEndpointHostnameLabel == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupDbSystemSnapshotReadEndpoint", "readEndpointHostnameLabel");
            }
        ...
        public Builder readEndpointIpAddress(String readEndpointIpAddress) {
            if (readEndpointIpAddress == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupDbSystemSnapshotReadEndpoint", "readEndpointIpAddress");
            }
