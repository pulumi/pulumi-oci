...
@CustomType
public final class GetMysqlBackupsBackupDbSystemSnapshotDataStorage {
    /**
    ...
    private GetMysqlBackupsBackupDbSystemSnapshotDataStorage() {}
    /**
     * @return The actual allocated storage size for the DB System. This may be higher than dataStorageSizeInGBs if an automatic storage expansion has occurred.
     * 
     */
    ...
    public static Builder builder(GetMysqlBackupsBackupDbSystemSnapshotDataStorage defaults) {
    ...
    public static final class Builder {
        ...
        private Integer maxStorageSizeInGbs;
        public Builder() {}
        public Builder(GetMysqlBackupsBackupDbSystemSnapshotDataStorage defaults) {
        ...
        public Builder allocatedStorageSizeInGbs(Integer allocatedStorageSizeInGbs) {
            if (allocatedStorageSizeInGbs == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupsBackupDbSystemSnapshotDataStorage", "allocatedStorageSizeInGbs");
            }
        ...
        public Builder dataStorageSizeInGb(Integer dataStorageSizeInGb) {
            if (dataStorageSizeInGb == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupsBackupDbSystemSnapshotDataStorage", "dataStorageSizeInGb");
            }
        ...
        public Builder dataStorageSizeLimitInGbs(Integer dataStorageSizeLimitInGbs) {
            if (dataStorageSizeLimitInGbs == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupsBackupDbSystemSnapshotDataStorage", "dataStorageSizeLimitInGbs");
            }
        ...
        public Builder isAutoExpandStorageEnabled(Boolean isAutoExpandStorageEnabled) {
            if (isAutoExpandStorageEnabled == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupsBackupDbSystemSnapshotDataStorage", "isAutoExpandStorageEnabled");
            }
        ...
        public Builder maxStorageSizeInGbs(Integer maxStorageSizeInGbs) {
            if (maxStorageSizeInGbs == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupsBackupDbSystemSnapshotDataStorage", "maxStorageSizeInGbs");
            }
            this.maxStorageSizeInGbs = maxStorageSizeInGbs;
            return this;
        }
        public GetMysqlBackupsBackupDbSystemSnapshotDataStorage build() {
            final var _resultValue = new GetMysqlBackupsBackupDbSystemSnapshotDataStorage();
