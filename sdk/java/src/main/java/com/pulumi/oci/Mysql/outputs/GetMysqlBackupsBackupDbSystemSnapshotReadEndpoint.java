...
@CustomType
public final class GetMysqlBackupsBackupDbSystemSnapshotReadEndpoint {
    /**
    ...
    private GetMysqlBackupsBackupDbSystemSnapshotReadEndpoint() {}
    /**
     * @return A list of IP addresses of read replicas that are excluded from serving read requests.
     * 
     */
    ...
    public static Builder builder(GetMysqlBackupsBackupDbSystemSnapshotReadEndpoint defaults) {
    ...
    public static final class Builder {
        ...
        private String readEndpointIpAddress;
        public Builder() {}
        public Builder(GetMysqlBackupsBackupDbSystemSnapshotReadEndpoint defaults) {
        ...
        public Builder excludeIps(List<String> excludeIps) {
            if (excludeIps == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupsBackupDbSystemSnapshotReadEndpoint", "excludeIps");
            }
        ...
        public Builder isEnabled(Boolean isEnabled) {
            if (isEnabled == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupsBackupDbSystemSnapshotReadEndpoint", "isEnabled");
            }
        ...
        public Builder readEndpointHostnameLabel(String readEndpointHostnameLabel) {
            if (readEndpointHostnameLabel == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupsBackupDbSystemSnapshotReadEndpoint", "readEndpointHostnameLabel");
            }
        ...
        public Builder readEndpointIpAddress(String readEndpointIpAddress) {
            if (readEndpointIpAddress == null) {
              throw new MissingRequiredPropertyException("GetMysqlBackupsBackupDbSystemSnapshotReadEndpoint", "readEndpointIpAddress");
            }
            this.readEndpointIpAddress = readEndpointIpAddress;
            return this;
        }
        public GetMysqlBackupsBackupDbSystemSnapshotReadEndpoint build() {
            final var _resultValue = new GetMysqlBackupsBackupDbSystemSnapshotReadEndpoint();
