    ...
    public static final class Builder {
        ...
        public Builder automaticBackupRetention(String automaticBackupRetention) {
            if (automaticBackupRetention == null) {
              throw new MissingRequiredPropertyException("GetMysqlDbSystemDeletionPolicy", "automaticBackupRetention");
            }
        ...
        public Builder finalBackup(String finalBackup) {
            if (finalBackup == null) {
              throw new MissingRequiredPropertyException("GetMysqlDbSystemDeletionPolicy", "finalBackup");
            }
        ...
        public Builder isDeleteProtected(Boolean isDeleteProtected) {
            if (isDeleteProtected == null) {
              throw new MissingRequiredPropertyException("GetMysqlDbSystemDeletionPolicy", "isDeleteProtected");
            }
            this.isDeleteProtected = isDeleteProtected;
            return this;
        }
        public GetMysqlDbSystemDeletionPolicy build() {
            final var _resultValue = new GetMysqlDbSystemDeletionPolicy();
