...
public final class GetMysqlDbSystemEndpoint {
    ...
    public static final class Builder {
        ...
        public Builder hostname(String hostname) {
            if (hostname == null) {
              throw new MissingRequiredPropertyException("GetMysqlDbSystemEndpoint", "hostname");
            }
        ...
        public Builder modes(List<String> modes) {
            if (modes == null) {
              throw new MissingRequiredPropertyException("GetMysqlDbSystemEndpoint", "modes");
            }
            this.modes = modes;
            return this;
        }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetMysqlDbSystemEndpoint", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder portX(Integer portX) {
            if (portX == null) {
              throw new MissingRequiredPropertyException("GetMysqlDbSystemEndpoint", "portX");
            }
            this.portX = portX;
            return this;
        }
        ...
        public Builder resourceId(String resourceId) {
            if (resourceId == null) {
              throw new MissingRequiredPropertyException("GetMysqlDbSystemEndpoint", "resourceId");
            }
        ...
        public Builder resourceType(String resourceType) {
            if (resourceType == null) {
              throw new MissingRequiredPropertyException("GetMysqlDbSystemEndpoint", "resourceType");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetMysqlDbSystemEndpoint", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder statusDetails(String statusDetails) {
            if (statusDetails == null) {
              throw new MissingRequiredPropertyException("GetMysqlDbSystemEndpoint", "statusDetails");
            }
