...
@CustomType
public final class GetMysqlDbSystemsDbSystemChannelSourceAnonymousTransactionsHandling {
    /**
    ...
    private GetMysqlDbSystemsDbSystemChannelSourceAnonymousTransactionsHandling() {}
    /**
     * @return Specifies one of the coordinates (file) at which the replica should begin reading the source&#39;s log. As this value specifies the point where replication starts from, it is only used once, when it starts. It is never used again, unless a new UpdateChannel operation modifies it.
     * 
     */
    ...
    public static Builder builder(GetMysqlDbSystemsDbSystemChannelSourceAnonymousTransactionsHandling defaults) {
    ...
    public static final class Builder {
        ...
        private String uuid;
        public Builder() {}
        public Builder(GetMysqlDbSystemsDbSystemChannelSourceAnonymousTransactionsHandling defaults) {
        ...
        public Builder lastConfiguredLogFilename(String lastConfiguredLogFilename) {
            if (lastConfiguredLogFilename == null) {
              throw new MissingRequiredPropertyException("GetMysqlDbSystemsDbSystemChannelSourceAnonymousTransactionsHandling", "lastConfiguredLogFilename");
            }
        ...
        public Builder lastConfiguredLogOffset(String lastConfiguredLogOffset) {
            if (lastConfiguredLogOffset == null) {
              throw new MissingRequiredPropertyException("GetMysqlDbSystemsDbSystemChannelSourceAnonymousTransactionsHandling", "lastConfiguredLogOffset");
            }
        ...
        public Builder policy(String policy) {
            if (policy == null) {
              throw new MissingRequiredPropertyException("GetMysqlDbSystemsDbSystemChannelSourceAnonymousTransactionsHandling", "policy");
            }
            this.policy = policy;
            return this;
        }
        ...
        public Builder uuid(String uuid) {
            if (uuid == null) {
              throw new MissingRequiredPropertyException("GetMysqlDbSystemsDbSystemChannelSourceAnonymousTransactionsHandling", "uuid");
            }
            this.uuid = uuid;
            return this;
        }
        public GetMysqlDbSystemsDbSystemChannelSourceAnonymousTransactionsHandling build() {
            final var _resultValue = new GetMysqlDbSystemsDbSystemChannelSourceAnonymousTransactionsHandling();
