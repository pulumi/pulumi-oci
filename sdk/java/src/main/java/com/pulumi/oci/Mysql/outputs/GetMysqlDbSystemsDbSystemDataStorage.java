...
@CustomType
public final class GetMysqlDbSystemsDbSystemDataStorage {
    /**
    ...
    private GetMysqlDbSystemsDbSystemDataStorage() {}
    /**
     * @return The actual allocated storage size for the DB System. This may be higher than dataStorageSizeInGBs if an automatic storage expansion has occurred.
     * 
     */
    ...
    public static Builder builder(GetMysqlDbSystemsDbSystemDataStorage defaults) {
    ...
    public static final class Builder {
        ...
        private Integer maxStorageSizeInGbs;
        public Builder() {}
        public Builder(GetMysqlDbSystemsDbSystemDataStorage defaults) {
        ...
        public Builder allocatedStorageSizeInGbs(Integer allocatedStorageSizeInGbs) {
            if (allocatedStorageSizeInGbs == null) {
              throw new MissingRequiredPropertyException("GetMysqlDbSystemsDbSystemDataStorage", "allocatedStorageSizeInGbs");
            }
        ...
        public Builder dataStorageSizeInGb(Integer dataStorageSizeInGb) {
            if (dataStorageSizeInGb == null) {
              throw new MissingRequiredPropertyException("GetMysqlDbSystemsDbSystemDataStorage", "dataStorageSizeInGb");
            }
        ...
        public Builder dataStorageSizeLimitInGbs(Integer dataStorageSizeLimitInGbs) {
            if (dataStorageSizeLimitInGbs == null) {
              throw new MissingRequiredPropertyException("GetMysqlDbSystemsDbSystemDataStorage", "dataStorageSizeLimitInGbs");
            }
        ...
        public Builder isAutoExpandStorageEnabled(Boolean isAutoExpandStorageEnabled) {
            if (isAutoExpandStorageEnabled == null) {
              throw new MissingRequiredPropertyException("GetMysqlDbSystemsDbSystemDataStorage", "isAutoExpandStorageEnabled");
            }
        ...
        public Builder maxStorageSizeInGbs(Integer maxStorageSizeInGbs) {
            if (maxStorageSizeInGbs == null) {
              throw new MissingRequiredPropertyException("GetMysqlDbSystemsDbSystemDataStorage", "maxStorageSizeInGbs");
            }
            this.maxStorageSizeInGbs = maxStorageSizeInGbs;
            return this;
        }
        public GetMysqlDbSystemsDbSystemDataStorage build() {
            final var _resultValue = new GetMysqlDbSystemsDbSystemDataStorage();
