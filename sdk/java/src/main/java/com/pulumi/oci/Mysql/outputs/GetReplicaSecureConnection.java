...
@CustomType
public final class GetReplicaSecureConnection {
    /**
    ...
    private GetReplicaSecureConnection() {}
    /**
     * @return Select whether to use MySQL Database Service-managed certificate (SYSTEM) or your own certificate (BYOC).
     * 
     */
    ...
    public static Builder builder(GetReplicaSecureConnection defaults) {
    ...
    public static final class Builder {
        ...
        private String certificateId;
        public Builder() {}
        public Builder(GetReplicaSecureConnection defaults) {
        ...
        public Builder certificateGenerationType(String certificateGenerationType) {
            if (certificateGenerationType == null) {
              throw new MissingRequiredPropertyException("GetReplicaSecureConnection", "certificateGenerationType");
            }
        ...
        public Builder certificateId(String certificateId) {
            if (certificateId == null) {
              throw new MissingRequiredPropertyException("GetReplicaSecureConnection", "certificateId");
            }
            this.certificateId = certificateId;
            return this;
        }
        public GetReplicaSecureConnection build() {
            final var _resultValue = new GetReplicaSecureConnection();
