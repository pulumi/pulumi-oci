...
@CustomType
public final class GetReplicasReplicaSecureConnection {
    /**
    ...
    private GetReplicasReplicaSecureConnection() {}
    /**
     * @return Select whether to use MySQL Database Service-managed certificate (SYSTEM) or your own certificate (BYOC).
     * 
     */
    ...
    public static Builder builder(GetReplicasReplicaSecureConnection defaults) {
    ...
    public static final class Builder {
        ...
        private String certificateId;
        public Builder() {}
        public Builder(GetReplicasReplicaSecureConnection defaults) {
        ...
        public Builder certificateGenerationType(String certificateGenerationType) {
            if (certificateGenerationType == null) {
              throw new MissingRequiredPropertyException("GetReplicasReplicaSecureConnection", "certificateGenerationType");
            }
        ...
        public Builder certificateId(String certificateId) {
            if (certificateId == null) {
              throw new MissingRequiredPropertyException("GetReplicasReplicaSecureConnection", "certificateId");
            }
            this.certificateId = certificateId;
            return this;
        }
        public GetReplicasReplicaSecureConnection build() {
            final var _resultValue = new GetReplicasReplicaSecureConnection();
