...
public final class NetworkFirewallPolicyApplicationGroupArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public NetworkFirewallPolicyApplicationGroupArgs build() {
            if ($.apps == null) {
                throw new MissingRequiredPropertyException("NetworkFirewallPolicyApplicationGroupArgs", "apps");
            }
            if ($.networkFirewallPolicyId == null) {
                throw new MissingRequiredPropertyException("NetworkFirewallPolicyApplicationGroupArgs", "networkFirewallPolicyId");
            }
            return $;
        }
    }
