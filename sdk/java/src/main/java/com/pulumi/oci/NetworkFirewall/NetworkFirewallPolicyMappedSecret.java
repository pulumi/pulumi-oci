...
public class NetworkFirewallPolicyMappedSecret extends com.pulumi.resources.CustomResource {
    ...
    public NetworkFirewallPolicyMappedSecret(String name, NetworkFirewallPolicyMappedSecretArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:NetworkFirewall/networkFirewallPolicyMappedSecret:NetworkFirewallPolicyMappedSecret", name, args == null ? NetworkFirewallPolicyMappedSecretArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
