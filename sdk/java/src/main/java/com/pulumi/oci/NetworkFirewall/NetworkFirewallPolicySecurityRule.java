 ...
 *             .action(var_.network_firewall_policy_security_rule_action())
 *             .condition(NetworkFirewallPolicySecurityRuleConditionArgs.builder()
 *                 .applications(var_.network_firewall_policy_security_rule_condition_application())
 *                 .destinationAddresses(var_.network_firewall_policy_security_rule_condition_destination_address())
 *                 .services(var_.network_firewall_policy_security_rule_condition_service())
 *                 .sourceAddresses(var_.network_firewall_policy_security_rule_condition_source_address())
 *                 .urls(var_.network_firewall_policy_security_rule_condition_url())
 *                 .build())
 *             .networkFirewallPolicyId(oci_network_firewall_network_firewall_policy.test_network_firewall_policy().id())
 *             .inspection(var_.network_firewall_policy_security_rule_inspection())
 *             .positions(NetworkFirewallPolicySecurityRulePositionArgs.builder()
 *                 .afterRule(var_.network_firewall_policy_security_rule_position_after_rule())
 *                 .beforeRule(var_.network_firewall_policy_security_rule_position_before_rule())
 *                 .build())
 *             .build());
 * 
 *     }
...
public class NetworkFirewallPolicySecurityRule extends com.pulumi.resources.CustomResource {
     ...
     */
    public NetworkFirewallPolicySecurityRule(String name) {
     ...
     */
    public NetworkFirewallPolicySecurityRule(String name, NetworkFirewallPolicySecurityRuleArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:NetworkFirewall/networkFirewallPolicySecurityRule:NetworkFirewallPolicySecurityRule", name, args == null ? NetworkFirewallPolicySecurityRuleArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }

    private NetworkFirewallPolicySecurityRule(String name, Output<String> id, @Nullable NetworkFirewallPolicySecurityRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:NetworkFirewall/networkFirewallPolicySecurityRule:NetworkFirewallPolicySecurityRule", name, state, makeResourceOptions(options, id));
    }
     ...
     */
    public static NetworkFirewallPolicySecurityRule get(String name, Output<String> id, @Nullable NetworkFirewallPolicySecurityRuleState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
