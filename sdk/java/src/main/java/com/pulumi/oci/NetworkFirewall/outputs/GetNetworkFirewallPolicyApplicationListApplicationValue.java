...
@CustomType
public final class GetNetworkFirewallPolicyApplicationListApplicationValue {
    ...
    private GetNetworkFirewallPolicyApplicationListApplicationValue() {}
    ...
    public static Builder builder(GetNetworkFirewallPolicyApplicationListApplicationValue defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetNetworkFirewallPolicyApplicationListApplicationValue defaults) {
        ...
        public GetNetworkFirewallPolicyApplicationListApplicationValue build() {
            final var o = new GetNetworkFirewallPolicyApplicationListApplicationValue();
            o.icmpCode = icmpCode;
            o.icmpType = icmpType;
