...
public final class GetNetworkFirewallPolicyDecryptionRulePosition {
    ...
    public static final class Builder {
        ...
        public Builder afterRule(String afterRule) {
            if (afterRule == null) {
              throw new MissingRequiredPropertyException("GetNetworkFirewallPolicyDecryptionRulePosition", "afterRule");
            }
        ...
        public Builder beforeRule(String beforeRule) {
            if (beforeRule == null) {
              throw new MissingRequiredPropertyException("GetNetworkFirewallPolicyDecryptionRulePosition", "beforeRule");
            }
