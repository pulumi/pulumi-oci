...
public final class GetNetworkFirewallPolicyDecryptionRulesDecryptionRuleSummaryCollectionItemPosition {
    ...
    public static final class Builder {
        ...
        public Builder afterRule(String afterRule) {
            if (afterRule == null) {
              throw new MissingRequiredPropertyException("GetNetworkFirewallPolicyDecryptionRulesDecryptionRuleSummaryCollectionItemPosition", "afterRule");
            }
        ...
        public Builder beforeRule(String beforeRule) {
            if (beforeRule == null) {
              throw new MissingRequiredPropertyException("GetNetworkFirewallPolicyDecryptionRulesDecryptionRuleSummaryCollectionItemPosition", "beforeRule");
            }
