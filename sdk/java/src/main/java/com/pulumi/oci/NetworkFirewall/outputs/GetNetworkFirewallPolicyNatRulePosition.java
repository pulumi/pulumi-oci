...
@CustomType
public final class GetNetworkFirewallPolicyNatRulePosition {
    /**
    ...
    private GetNetworkFirewallPolicyNatRulePosition() {}
    /**
     * @return Identifier for rule after which this rule lies.
     * 
     */
    ...
    public static Builder builder(GetNetworkFirewallPolicyNatRulePosition defaults) {
    ...
    public static final class Builder {
        ...
        private String beforeRule;
        public Builder() {}
        public Builder(GetNetworkFirewallPolicyNatRulePosition defaults) {
        ...
        public Builder afterRule(String afterRule) {
            if (afterRule == null) {
              throw new MissingRequiredPropertyException("GetNetworkFirewallPolicyNatRulePosition", "afterRule");
            }
        ...
        public Builder beforeRule(String beforeRule) {
            if (beforeRule == null) {
              throw new MissingRequiredPropertyException("GetNetworkFirewallPolicyNatRulePosition", "beforeRule");
            }
            this.beforeRule = beforeRule;
            return this;
        }
        public GetNetworkFirewallPolicyNatRulePosition build() {
            final var _resultValue = new GetNetworkFirewallPolicyNatRulePosition();
