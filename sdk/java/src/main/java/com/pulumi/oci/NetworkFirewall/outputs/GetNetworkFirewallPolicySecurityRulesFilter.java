...
@CustomType
public final class GetNetworkFirewallPolicySecurityRulesFilter {
    /**
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetNetworkFirewallPolicySecurityRulesFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetNetworkFirewallPolicySecurityRulesFilter", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetNetworkFirewallPolicySecurityRulesFilter build() {
            final var _resultValue = new GetNetworkFirewallPolicySecurityRulesFilter();
