...
public final class GetNetworkFirewallPolicyServiceListsServiceListSummaryCollectionItem {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetNetworkFirewallPolicyServiceListsServiceListSummaryCollectionItem", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder networkFirewallPolicyId(String networkFirewallPolicyId) {
            if (networkFirewallPolicyId == null) {
              throw new MissingRequiredPropertyException("GetNetworkFirewallPolicyServiceListsServiceListSummaryCollectionItem", "networkFirewallPolicyId");
            }
        ...
        public Builder parentResourceId(String parentResourceId) {
            if (parentResourceId == null) {
              throw new MissingRequiredPropertyException("GetNetworkFirewallPolicyServiceListsServiceListSummaryCollectionItem", "parentResourceId");
            }
        ...
        public Builder services(List<String> services) {
            if (services == null) {
              throw new MissingRequiredPropertyException("GetNetworkFirewallPolicyServiceListsServiceListSummaryCollectionItem", "services");
            }
        ...
        public Builder totalServices(Integer totalServices) {
            if (totalServices == null) {
              throw new MissingRequiredPropertyException("GetNetworkFirewallPolicyServiceListsServiceListSummaryCollectionItem", "totalServices");
            }
