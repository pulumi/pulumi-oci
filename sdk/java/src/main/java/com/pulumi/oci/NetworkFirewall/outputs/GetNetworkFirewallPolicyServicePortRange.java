...
public final class GetNetworkFirewallPolicyServicePortRange {
    ...
    public static final class Builder {
        ...
        public Builder maximumPort(Integer maximumPort) {
            if (maximumPort == null) {
              throw new MissingRequiredPropertyException("GetNetworkFirewallPolicyServicePortRange", "maximumPort");
            }
        ...
        public Builder minimumPort(Integer minimumPort) {
            if (minimumPort == null) {
              throw new MissingRequiredPropertyException("GetNetworkFirewallPolicyServicePortRange", "minimumPort");
            }
