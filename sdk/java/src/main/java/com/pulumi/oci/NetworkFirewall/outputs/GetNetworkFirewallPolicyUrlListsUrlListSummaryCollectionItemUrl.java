...
@CustomType
public final class GetNetworkFirewallPolicyUrlListsUrlListSummaryCollectionItemUrl {
    /**
    ...
    private GetNetworkFirewallPolicyUrlListsUrlListSummaryCollectionItemUrl() {}
    /**
     * @return A string consisting of a concatenation of optional host component and optional path component. The host component may start with `*.` to match the case-insensitive domain and all its subdomains. The path component must start with a `/`, and may end with `*` to match all paths of which it is a case-sensitive prefix. A missing host component matches all request domains, and a missing path component matches all request paths. An empty value matches all requests.
     * 
     */
    ...
    public static Builder builder(GetNetworkFirewallPolicyUrlListsUrlListSummaryCollectionItemUrl defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetNetworkFirewallPolicyUrlListsUrlListSummaryCollectionItemUrl defaults) {
        ...
        public Builder pattern(String pattern) {
            if (pattern == null) {
              throw new MissingRequiredPropertyException("GetNetworkFirewallPolicyUrlListsUrlListSummaryCollectionItemUrl", "pattern");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetNetworkFirewallPolicyUrlListsUrlListSummaryCollectionItemUrl", "type");
            }
            this.type = type;
            return this;
        }
