...
@CustomType
public final class NetworkFirewallPolicyDecryptionRulePosition {
    /**
    ...
    public static Builder builder(NetworkFirewallPolicyDecryptionRulePosition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String beforeRule;
        public Builder() {}
        public Builder(NetworkFirewallPolicyDecryptionRulePosition defaults) {
        ...
        public NetworkFirewallPolicyDecryptionRulePosition build() {
            final var _resultValue = new NetworkFirewallPolicyDecryptionRulePosition();
