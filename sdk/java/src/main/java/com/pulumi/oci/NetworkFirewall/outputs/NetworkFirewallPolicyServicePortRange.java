...
@CustomType
public final class NetworkFirewallPolicyServicePortRange {
    /**
    ...
    public static Builder builder(NetworkFirewallPolicyServicePortRange defaults) {
    ...
    public static final class Builder {
        ...
        private Integer minimumPort;
        public Builder() {}
        public Builder(NetworkFirewallPolicyServicePortRange defaults) {
        ...
        public NetworkFirewallPolicyServicePortRange build() {
            final var _resultValue = new NetworkFirewallPolicyServicePortRange();
