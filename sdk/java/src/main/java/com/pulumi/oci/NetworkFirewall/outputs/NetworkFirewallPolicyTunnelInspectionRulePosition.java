...
@CustomType
public final class NetworkFirewallPolicyTunnelInspectionRulePosition {
    /**
    ...
    public static Builder builder(NetworkFirewallPolicyTunnelInspectionRulePosition defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String beforeRule;
        public Builder() {}
        public Builder(NetworkFirewallPolicyTunnelInspectionRulePosition defaults) {
        ...
        public NetworkFirewallPolicyTunnelInspectionRulePosition build() {
            final var _resultValue = new NetworkFirewallPolicyTunnelInspectionRulePosition();
