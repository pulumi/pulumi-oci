...
public final class BackendSetHealthCheckerDnsArgs extends com.pulumi.resources.ResourceArgs {

    public static final BackendSetHealthCheckerDnsArgs Empty = new BackendSetHealthCheckerDnsArgs();
    ...
    private BackendSetHealthCheckerDnsArgs() {}

    private BackendSetHealthCheckerDnsArgs(BackendSetHealthCheckerDnsArgs $) {
    ...
    public static Builder builder(BackendSetHealthCheckerDnsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new BackendSetHealthCheckerDnsArgs();
        }

        public Builder(BackendSetHealthCheckerDnsArgs defaults) {
            $ = new BackendSetHealthCheckerDnsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public BackendSetHealthCheckerDnsArgs build() {
            if ($.domainName == null) {
                throw new MissingRequiredPropertyException("BackendSetHealthCheckerDnsArgs", "domainName");
            }
            return $;
        }
    }
