    ...
    public static final class Builder {
        ...
        public GetListenerArgs build() {
            if ($.listenerName == null) {
                throw new MissingRequiredPropertyException("GetListenerArgs", "listenerName");
            }
            if ($.networkLoadBalancerId == null) {
                throw new MissingRequiredPropertyException("GetListenerArgs", "networkLoadBalancerId");
            }
            return $;
        }
    }
