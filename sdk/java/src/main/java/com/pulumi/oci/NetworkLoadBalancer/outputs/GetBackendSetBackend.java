...
public final class GetBackendSetBackend {
    ...
    /**
     * @return The network load balancing policy weight assigned to the server. Backend servers with a higher weight receive a larger proportion of incoming traffic. For example, a server weighted &#39;3&#39; receives three times the number of new connections as a server weighted &#39;1&#39;. For more information about network load balancing policies, see [Network Load Balancer Policies](https://docs.cloud.oracle.com/iaas/Content/NetworkLoadBalancer/introduction.htm#Policies).  Example: `3`
     * 
     */
    ...
    public static final class Builder {
        ...
        public Builder ipAddress(String ipAddress) {
            if (ipAddress == null) {
              throw new MissingRequiredPropertyException("GetBackendSetBackend", "ipAddress");
            }
        ...
        public Builder isBackup(Boolean isBackup) {
            if (isBackup == null) {
              throw new MissingRequiredPropertyException("GetBackendSetBackend", "isBackup");
            }
        ...
        public Builder isDrain(Boolean isDrain) {
            if (isDrain == null) {
              throw new MissingRequiredPropertyException("GetBackendSetBackend", "isDrain");
            }
        ...
        public Builder isOffline(Boolean isOffline) {
            if (isOffline == null) {
              throw new MissingRequiredPropertyException("GetBackendSetBackend", "isOffline");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetBackendSetBackend", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetBackendSetBackend", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder targetId(String targetId) {
            if (targetId == null) {
              throw new MissingRequiredPropertyException("GetBackendSetBackend", "targetId");
            }
        ...
        public Builder weight(Integer weight) {
            if (weight == null) {
              throw new MissingRequiredPropertyException("GetBackendSetBackend", "weight");
            }
            this.weight = weight;
            return this;
        }
        public GetBackendSetBackend build() {
            final var _resultValue = new GetBackendSetBackend();
