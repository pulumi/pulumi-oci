...
@CustomType
public final class GetBackendSetHealthCheckerDn {
    /**
    ...
    private GetBackendSetHealthCheckerDn() {}
    /**
     * @return The absolute fully-qualified domain name to perform periodic DNS queries. If not provided, an extra dot will be added at the end of a domain name during the query.
     * 
     */
    ...
    public static Builder builder(GetBackendSetHealthCheckerDn defaults) {
    ...
    public static final class Builder {
        ...
        private String transportProtocol;
        public Builder() {}
        public Builder(GetBackendSetHealthCheckerDn defaults) {
        ...
        public Builder domainName(String domainName) {
            if (domainName == null) {
              throw new MissingRequiredPropertyException("GetBackendSetHealthCheckerDn", "domainName");
            }
        ...
        public Builder queryClass(String queryClass) {
            if (queryClass == null) {
              throw new MissingRequiredPropertyException("GetBackendSetHealthCheckerDn", "queryClass");
            }
        ...
        public Builder queryType(String queryType) {
            if (queryType == null) {
              throw new MissingRequiredPropertyException("GetBackendSetHealthCheckerDn", "queryType");
            }
        ...
        public Builder rcodes(List<String> rcodes) {
            if (rcodes == null) {
              throw new MissingRequiredPropertyException("GetBackendSetHealthCheckerDn", "rcodes");
            }
            this.rcodes = rcodes;
            return this;
        }
        ...
        public Builder transportProtocol(String transportProtocol) {
            if (transportProtocol == null) {
              throw new MissingRequiredPropertyException("GetBackendSetHealthCheckerDn", "transportProtocol");
            }
            this.transportProtocol = transportProtocol;
            return this;
        }
        public GetBackendSetHealthCheckerDn build() {
            final var _resultValue = new GetBackendSetHealthCheckerDn();
