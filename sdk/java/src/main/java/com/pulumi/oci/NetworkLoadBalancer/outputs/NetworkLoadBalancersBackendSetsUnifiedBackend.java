...
@CustomType
public final class NetworkLoadBalancersBackendSetsUnifiedBackend {
    /**
    ...
    public static final class Builder {
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("NetworkLoadBalancersBackendSetsUnifiedBackend", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public NetworkLoadBalancersBackendSetsUnifiedBackend build() {
            final var _resultValue = new NetworkLoadBalancersBackendSetsUnifiedBackend();
