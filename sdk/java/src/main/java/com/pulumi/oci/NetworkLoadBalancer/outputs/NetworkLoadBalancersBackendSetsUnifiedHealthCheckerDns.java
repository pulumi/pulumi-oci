...
@CustomType
public final class NetworkLoadBalancersBackendSetsUnifiedHealthCheckerDns {
    /**
    ...
    private NetworkLoadBalancersBackendSetsUnifiedHealthCheckerDns() {}
    /**
     * @return (Updatable) The absolute fully-qualified domain name to perform periodic DNS queries. If not provided, an extra dot will be added at the end of a domain name during the query.
     * 
     */
    ...
    public static Builder builder(NetworkLoadBalancersBackendSetsUnifiedHealthCheckerDns defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String transportProtocol;
        public Builder() {}
        public Builder(NetworkLoadBalancersBackendSetsUnifiedHealthCheckerDns defaults) {
        ...
        public Builder domainName(String domainName) {
            if (domainName == null) {
              throw new MissingRequiredPropertyException("NetworkLoadBalancersBackendSetsUnifiedHealthCheckerDns", "domainName");
            }
        ...
        public NetworkLoadBalancersBackendSetsUnifiedHealthCheckerDns build() {
            final var _resultValue = new NetworkLoadBalancersBackendSetsUnifiedHealthCheckerDns();
