...
public final class TableSchemaColumnArgs extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="isAsUuid")
    private @Nullable Output<Boolean> isAsUuid;

    /**
     * @return True if the STRING column was declared AS UUID.
     * 
     */
    public Optional<Output<Boolean>> isAsUuid() {
     ...
     * 
     */
    @Import(name="isGenerated")
    private @Nullable Output<Boolean> isGenerated;

    /**
     * @return True if the STRING AS UUID column is also GENERATED BY DEFAULT.
     * 
     */
    public Optional<Output<Boolean>> isGenerated() {
    ...
    public static final class Builder {
        ...
        /**
         * @param isAsUuid True if the STRING column was declared AS UUID.
         * 
         * @return builder
         * 
         */
        public Builder isAsUuid(@Nullable Output<Boolean> isAsUuid) {
            $.isAsUuid = isAsUuid;
            return this;
        }
        ...
        public Builder isAsUuid(Boolean isAsUuid) {
            return isAsUuid(Output.of(isAsUuid));
        }

        /**
         * @param isGenerated True if the STRING AS UUID column is also GENERATED BY DEFAULT.
         * 
         * @return builder
         * 
         */
        public Builder isGenerated(@Nullable Output<Boolean> isGenerated) {
        ...
        public Builder isGenerated(Boolean isGenerated) {
            return isGenerated(Output.of(isGenerated));
        }
