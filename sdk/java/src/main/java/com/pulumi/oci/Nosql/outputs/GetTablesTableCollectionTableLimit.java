    ...
    public static final class Builder {
        ...
        public Builder capacityMode(String capacityMode) {
            if (capacityMode == null) {
              throw new MissingRequiredPropertyException("GetTablesTableCollectionTableLimit", "capacityMode");
            }
        ...
        public Builder maxReadUnits(Integer maxReadUnits) {
            if (maxReadUnits == null) {
              throw new MissingRequiredPropertyException("GetTablesTableCollectionTableLimit", "maxReadUnits");
            }
        ...
        public Builder maxStorageInGbs(Integer maxStorageInGbs) {
            if (maxStorageInGbs == null) {
              throw new MissingRequiredPropertyException("GetTablesTableCollectionTableLimit", "maxStorageInGbs");
            }
        ...
        public Builder maxWriteUnits(Integer maxWriteUnits) {
            if (maxWriteUnits == null) {
              throw new MissingRequiredPropertyException("GetTablesTableCollectionTableLimit", "maxWriteUnits");
            }
