...
public final class ReplicationPolicyArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public ReplicationPolicyArgs build() {
            if ($.bucket == null) {
                throw new MissingRequiredPropertyException("ReplicationPolicyArgs", "bucket");
            }
            if ($.destinationBucketName == null) {
                throw new MissingRequiredPropertyException("ReplicationPolicyArgs", "destinationBucketName");
            }
            if ($.destinationRegionName == null) {
                throw new MissingRequiredPropertyException("ReplicationPolicyArgs", "destinationRegionName");
            }
            if ($.namespace == null) {
                throw new MissingRequiredPropertyException("ReplicationPolicyArgs", "namespace");
            }
            return $;
        }
    }
