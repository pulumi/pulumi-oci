    ...
    public static final class Builder {
        ...
        public GetBucketSummariesArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetBucketSummariesArgs", "compartmentId");
            }
            if ($.namespace == null) {
                throw new MissingRequiredPropertyException("GetBucketSummariesArgs", "namespace");
            }
            return $;
        }
    }
