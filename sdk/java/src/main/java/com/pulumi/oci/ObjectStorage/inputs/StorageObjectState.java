...
public final class StorageObjectState extends com.pulumi.resources.ResourceArgs {
    ...
    public static Builder builder(StorageObjectState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new StorageObjectState();
        }

        public Builder(StorageObjectState defaults) {
            $ = new StorageObjectState(Objects.requireNonNull(defaults));
        }
        ...
        public StorageObjectState build() {
            return $;
        }
    }
