...
import com.pulumi.oci.ObjectStorage.outputs.GetPrivateEndpointAccessTarget;
...
public final class GetPrivateEndpointResult {
    private List<GetPrivateEndpointAccessTarget> accessTargets;
    ...
    public List<GetPrivateEndpointAccessTarget> accessTargets() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder accessTargets(List<GetPrivateEndpointAccessTarget> accessTargets) {
            if (accessTargets == null) {
              throw new MissingRequiredPropertyException("GetPrivateEndpointResult", "accessTargets");
            }
            this.accessTargets = accessTargets;
            return this;
        }
        public Builder accessTargets(GetPrivateEndpointAccessTarget... accessTargets) {
            return accessTargets(List.of(accessTargets));
        }
        @CustomType.Setter
        public Builder additionalPrefixes(List<String> additionalPrefixes) {
            if (additionalPrefixes == null) {
              throw new MissingRequiredPropertyException("GetPrivateEndpointResult", "additionalPrefixes");
            }
        ...
        public Builder createdBy(String createdBy) {
            if (createdBy == null) {
              throw new MissingRequiredPropertyException("GetPrivateEndpointResult", "createdBy");
            }
        ...
        public Builder fqdns(Map<String,Map<String,Map<String,String>>> fqdns) {
            if (fqdns == null) {
              throw new MissingRequiredPropertyException("GetPrivateEndpointResult", "fqdns");
            }
            this.fqdns = fqdns;
            return this;
        }
        ...
        public Builder namespace(String namespace) {
            if (namespace == null) {
              throw new MissingRequiredPropertyException("GetPrivateEndpointResult", "namespace");
            }
        ...
        public Builder prefix(String prefix) {
            if (prefix == null) {
              throw new MissingRequiredPropertyException("GetPrivateEndpointResult", "prefix");
            }
            this.prefix = prefix;
            return this;
        }
        ...
        public Builder privateEndpointIp(String privateEndpointIp) {
            if (privateEndpointIp == null) {
              throw new MissingRequiredPropertyException("GetPrivateEndpointResult", "privateEndpointIp");
            }
        ...
        public Builder timeModified(String timeModified) {
            if (timeModified == null) {
              throw new MissingRequiredPropertyException("GetPrivateEndpointResult", "timeModified");
            }
