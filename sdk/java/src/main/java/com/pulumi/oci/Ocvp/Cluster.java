 ...
 *             .computeAvailabilityDomain(var_.cluster_compute_availability_domain())
 *             .esxiHostsCount(var_.cluster_esxi_hosts_count())
 ...
 *                 .blockVolumeIds(var_.cluster_datastores_block_volume_ids())
 *                 .datastoreType(var_.cluster_datastores_datastore_type())
 *                 .build())
 *             .definedTags(Map.of(&#34;Operations.CostCenter&#34;, &#34;42&#34;))
 *             .displayName(var_.cluster_display_name())
 *             .esxiSoftwareVersion(var_.cluster_esxi_software_version())
 *             .freeformTags(Map.of(&#34;Department&#34;, &#34;Finance&#34;))
 *             .initialCommitment(var_.cluster_initial_commitment())
 *             .initialHostOcpuCount(var_.cluster_initial_host_ocpu_count())
 *             .initialHostShapeName(oci_core_shape.test_shape().name())
 *             .instanceDisplayNamePrefix(var_.cluster_instance_display_name_prefix())
 *             .isShieldedInstanceEnabled(var_.cluster_is_shielded_instance_enabled())
 *             .vmwareSoftwareVersion(var_.cluster_vmware_software_version())
 *             .workloadNetworkCidr(var_.cluster_workload_network_cidr())
 *             .build());
 * 
 *     }
 * }
...
public class Cluster extends com.pulumi.resources.CustomResource {
    ...
    public Cluster(String name, ClusterArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Ocvp/cluster:Cluster", name, args == null ? ClusterArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
    ...
    private Cluster(String name, Output<String> id, @Nullable ClusterState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Ocvp/cluster:Cluster", name, state, makeResourceOptions(options, id));
    }
