...
import com.pulumi.oci.Ocvp.inputs.DatastoreState;
import com.pulumi.oci.Ocvp.outputs.DatastoreBlockVolumeDetail;
 ...
 * 
 */
@ResourceType(type="oci:Ocvp/datastore:Datastore")
public class Datastore extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="blockVolumeDetails", refs={List.class,DatastoreBlockVolumeDetail.class}, tree="[0,1]")
    private Output<List<DatastoreBlockVolumeDetail>> blockVolumeDetails;

    /**
     * @return The list of Block Volume details that belong to the datastore.
     * 
     */
    public Output<List<DatastoreBlockVolumeDetail>> blockVolumeDetails() {
     ...
     * 
     */
    @Export(name="blockVolumeIds", refs={List.class,String.class}, tree="[0,1]")
    ...
    public Datastore(java.lang.String name, DatastoreArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Ocvp/datastore:Datastore", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Datastore(java.lang.String name, Output<java.lang.String> id, @Nullable DatastoreState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Ocvp/datastore:Datastore", name, state, makeResourceOptions(options, id), false);
    }
