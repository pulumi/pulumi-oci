...
public final class ClusterDatastoreArgs extends com.pulumi.resources.ResourceArgs {

    public static final ClusterDatastoreArgs Empty = new ClusterDatastoreArgs();
    ...
    private ClusterDatastoreArgs() {}

    private ClusterDatastoreArgs(ClusterDatastoreArgs $) {
    ...
    public static Builder builder(ClusterDatastoreArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ClusterDatastoreArgs();
        }

        public Builder(ClusterDatastoreArgs defaults) {
            $ = new ClusterDatastoreArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ClusterDatastoreArgs build() {
            if ($.blockVolumeIds == null) {
                throw new MissingRequiredPropertyException("ClusterDatastoreArgs", "blockVolumeIds");
            }
            if ($.datastoreType == null) {
                throw new MissingRequiredPropertyException("ClusterDatastoreArgs", "datastoreType");
            }
            return $;
        }
    }
