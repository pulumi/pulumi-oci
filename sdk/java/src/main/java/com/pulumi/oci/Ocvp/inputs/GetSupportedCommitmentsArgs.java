...
public final class GetSupportedCommitmentsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetSupportedCommitmentsArgs Empty = new GetSupportedCommitmentsArgs();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetSupportedCommitmentsFilterArgs>> filters;

    public Optional<Output<List<GetSupportedCommitmentsFilterArgs>>> filters() {
    ...
    private GetSupportedCommitmentsArgs() {}

    private GetSupportedCommitmentsArgs(GetSupportedCommitmentsArgs $) {
    ...
    public static Builder builder(GetSupportedCommitmentsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSupportedCommitmentsArgs();
        }

        public Builder(GetSupportedCommitmentsArgs defaults) {
            $ = new GetSupportedCommitmentsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetSupportedCommitmentsFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetSupportedCommitmentsFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetSupportedCommitmentsFilterArgs... filters) {
