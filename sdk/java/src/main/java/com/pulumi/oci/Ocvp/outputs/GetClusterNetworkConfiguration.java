...
public final class GetClusterNetworkConfiguration {
    ...
    public static final class Builder {
        ...
        public Builder hcxVlanId(String hcxVlanId) {
            if (hcxVlanId == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworkConfiguration", "hcxVlanId");
            }
        ...
        public Builder nsxEdgeUplink1vlanId(String nsxEdgeUplink1vlanId) {
            if (nsxEdgeUplink1vlanId == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworkConfiguration", "nsxEdgeUplink1vlanId");
            }
        ...
        public Builder nsxEdgeUplink2vlanId(String nsxEdgeUplink2vlanId) {
            if (nsxEdgeUplink2vlanId == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworkConfiguration", "nsxEdgeUplink2vlanId");
            }
        ...
        public Builder nsxEdgeVtepVlanId(String nsxEdgeVtepVlanId) {
            if (nsxEdgeVtepVlanId == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworkConfiguration", "nsxEdgeVtepVlanId");
            }
        ...
        public Builder nsxVtepVlanId(String nsxVtepVlanId) {
            if (nsxVtepVlanId == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworkConfiguration", "nsxVtepVlanId");
            }
        ...
        public Builder provisioningSubnetId(String provisioningSubnetId) {
            if (provisioningSubnetId == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworkConfiguration", "provisioningSubnetId");
            }
        ...
        public Builder provisioningVlanId(String provisioningVlanId) {
            if (provisioningVlanId == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworkConfiguration", "provisioningVlanId");
            }
        ...
        public Builder replicationVlanId(String replicationVlanId) {
            if (replicationVlanId == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworkConfiguration", "replicationVlanId");
            }
        ...
        public Builder vmotionVlanId(String vmotionVlanId) {
            if (vmotionVlanId == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworkConfiguration", "vmotionVlanId");
            }
        ...
        public Builder vsanVlanId(String vsanVlanId) {
            if (vsanVlanId == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworkConfiguration", "vsanVlanId");
            }
        ...
        public Builder vsphereVlanId(String vsphereVlanId) {
            if (vsphereVlanId == null) {
              throw new MissingRequiredPropertyException("GetClusterNetworkConfiguration", "vsphereVlanId");
            }
            this.vsphereVlanId = vsphereVlanId;
            return this;
        }
        public GetClusterNetworkConfiguration build() {
            final var _resultValue = new GetClusterNetworkConfiguration();
