...
@CustomType
public final class GetClustersClusterCollectionItemDatastore {
    /**
    ...
    private GetClustersClusterCollectionItemDatastore() {}
    /**
     * @return A list of [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)s of Block Storage Volumes.
     * 
     */
    ...
    public static Builder builder(GetClustersClusterCollectionItemDatastore defaults) {
    ...
    public static final class Builder {
        ...
        private String datastoreType;
        public Builder() {}
        public Builder(GetClustersClusterCollectionItemDatastore defaults) {
        ...
        public Builder blockVolumeIds(List<String> blockVolumeIds) {
            if (blockVolumeIds == null) {
              throw new MissingRequiredPropertyException("GetClustersClusterCollectionItemDatastore", "blockVolumeIds");
            }
        ...
        public Builder capacity(Double capacity) {
            if (capacity == null) {
              throw new MissingRequiredPropertyException("GetClustersClusterCollectionItemDatastore", "capacity");
            }
        ...
        public Builder datastoreType(String datastoreType) {
            if (datastoreType == null) {
              throw new MissingRequiredPropertyException("GetClustersClusterCollectionItemDatastore", "datastoreType");
            }
            this.datastoreType = datastoreType;
            return this;
        }
        public GetClustersClusterCollectionItemDatastore build() {
            final var _resultValue = new GetClustersClusterCollectionItemDatastore();
