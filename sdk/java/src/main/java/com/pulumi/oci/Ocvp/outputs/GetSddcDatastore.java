    ...
    public static final class Builder {
        ...
        public Builder blockVolumeIds(List<String> blockVolumeIds) {
            if (blockVolumeIds == null) {
              throw new MissingRequiredPropertyException("GetSddcDatastore", "blockVolumeIds");
            }
        ...
        public Builder capacity(Double capacity) {
            if (capacity == null) {
              throw new MissingRequiredPropertyException("GetSddcDatastore", "capacity");
            }
        ...
        public Builder datastoreType(String datastoreType) {
            if (datastoreType == null) {
              throw new MissingRequiredPropertyException("GetSddcDatastore", "datastoreType");
            }
            this.datastoreType = datastoreType;
            return this;
        }
        public GetSddcDatastore build() {
            final var _resultValue = new GetSddcDatastore();
