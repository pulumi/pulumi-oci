...
@CustomType
public final class SddcDatastore {
    /**
    ...
    public static Builder builder(SddcDatastore defaults) {
    ...
    public static final class Builder {
        ...
        private String datastoreType;
        public Builder() {}
        public Builder(SddcDatastore defaults) {
        ...
        public Builder blockVolumeIds(List<String> blockVolumeIds) {
            if (blockVolumeIds == null) {
              throw new MissingRequiredPropertyException("SddcDatastore", "blockVolumeIds");
            }
        ...
        public Builder datastoreType(String datastoreType) {
            if (datastoreType == null) {
              throw new MissingRequiredPropertyException("SddcDatastore", "datastoreType");
            }
