...
public class OdaInstance extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ List<String>> attachmentIds;
     ...
     * 
     */
    public Output<Optional<List<String>>> attachmentIds() {
        return Codegen.optional(this.attachmentIds);
    }
    /**
    ...
    private Output</* @Nullable */ List<String>> attachmentTypes;

    /**
     * @return A list of attachment types for this instance (if any). Use attachmentIds to get the details of the attachments.
     * 
     */
    public Output<Optional<List<String>>> attachmentTypes() {
        return Codegen.optional(this.attachmentTypes);
    }
    /**
    ...
    private Output</* @Nullable */ String> connectorUrl;

    /**
     * @return URL for the connector&#39;s endpoint.
     * 
     */
    public Output<Optional<String>> connectorUrl() {
        return Codegen.optional(this.connectorUrl);
    }
    /**
    ...
    private Output</* @Nullable */ String> identityAppConsoleUrl;
     ...
     * 
     */
    public Output<Optional<String>> identityAppConsoleUrl() {
        return Codegen.optional(this.identityAppConsoleUrl);
    }
    /**
    ...
    private Output</* @Nullable */ String> identityDomain;
     ...
     * 
     */
    public Output<Optional<String>> identityDomain() {
        return Codegen.optional(this.identityDomain);
    }
    /**
    ...
    private Output</* @Nullable */ List<String>> importedPackageIds;
     ...
     * 
     */
    public Output<Optional<List<String>>> importedPackageIds() {
        return Codegen.optional(this.importedPackageIds);
    }
    /**
    ...
    private Output</* @Nullable */ List<String>> importedPackageNames;
     ...
     * 
     */
    public Output<Optional<List<String>>> importedPackageNames() {
        return Codegen.optional(this.importedPackageNames);
    }
    /**
    ...
    private Output</* @Nullable */ Boolean> isRoleBasedAccess;
     ...
     * 
     */
    public Output<Optional<Boolean>> isRoleBasedAccess() {
        return Codegen.optional(this.isRoleBasedAccess);
    }
    /**
    ...
    private Output</* @Nullable */ List<OdaInstanceRestrictedOperation>> restrictedOperations;
     ...
     * 
     */
    public Output<Optional<List<OdaInstanceRestrictedOperation>>> restrictedOperations() {
        return Codegen.optional(this.restrictedOperations);
    }
    /**
    ...
    private Output</* @Nullable */ String> webAppUrl;

    /**
     * @return URL for the Digital Assistant web application that&#39;s associated with the instance.
     * 
     */
    public Output<Optional<String>> webAppUrl() {
        return Codegen.optional(this.webAppUrl);
    }
