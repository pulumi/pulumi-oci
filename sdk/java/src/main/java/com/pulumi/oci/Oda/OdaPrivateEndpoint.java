...
public class OdaPrivateEndpoint extends com.pulumi.resources.CustomResource {
     ...
     */
    public OdaPrivateEndpoint(java.lang.String name) {
     ...
     */
    public OdaPrivateEndpoint(java.lang.String name, OdaPrivateEndpointArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public OdaPrivateEndpoint(java.lang.String name, OdaPrivateEndpointArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Oda/odaPrivateEndpoint:OdaPrivateEndpoint", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private OdaPrivateEndpoint(java.lang.String name, Output<java.lang.String> id, @Nullable OdaPrivateEndpointState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Oda/odaPrivateEndpoint:OdaPrivateEndpoint", name, state, makeResourceOptions(options, id), false);
    }

    private static OdaPrivateEndpointArgs makeArgs(OdaPrivateEndpointArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? OdaPrivateEndpointArgs.Empty : args;
    }
     ...
     */
    public static OdaPrivateEndpoint get(java.lang.String name, Output<java.lang.String> id, @Nullable OdaPrivateEndpointState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
