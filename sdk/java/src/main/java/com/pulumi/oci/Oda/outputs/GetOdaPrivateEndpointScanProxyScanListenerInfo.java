...
@CustomType
public final class GetOdaPrivateEndpointScanProxyScanListenerInfo {
    /**
    ...
    private GetOdaPrivateEndpointScanProxyScanListenerInfo() {}
    /**
     * @return FQDN of the customer&#39;s Real Application Cluster (RAC)&#39;s SCAN listeners.
     * 
     */
    ...
    public static Builder builder(GetOdaPrivateEndpointScanProxyScanListenerInfo defaults) {
    ...
    public static final class Builder {
        ...
        private Integer scanListenerPort;
        public Builder() {}
        public Builder(GetOdaPrivateEndpointScanProxyScanListenerInfo defaults) {
        ...
        public GetOdaPrivateEndpointScanProxyScanListenerInfo build() {
            final var _resultValue = new GetOdaPrivateEndpointScanProxyScanListenerInfo();
