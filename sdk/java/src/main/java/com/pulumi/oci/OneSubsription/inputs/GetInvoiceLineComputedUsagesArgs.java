    ...
    public static final class Builder {
        ...
        public GetInvoiceLineComputedUsagesArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetInvoiceLineComputedUsagesArgs", "compartmentId");
            }
            if ($.invoiceLineId == null) {
                throw new MissingRequiredPropertyException("GetInvoiceLineComputedUsagesArgs", "invoiceLineId");
            }
            return $;
        }
    }
