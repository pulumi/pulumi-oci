    ...
    public static final class Builder {
        ...
        public Builder billingCategory(String billingCategory) {
            if (billingCategory == null) {
              throw new MissingRequiredPropertyException("GetAggregatedComputedUsagesAggregatedComputedUsageAggregatedComputedUsageProduct", "billingCategory");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetAggregatedComputedUsagesAggregatedComputedUsageAggregatedComputedUsageProduct", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder partNumber(String partNumber) {
            if (partNumber == null) {
              throw new MissingRequiredPropertyException("GetAggregatedComputedUsagesAggregatedComputedUsageAggregatedComputedUsageProduct", "partNumber");
            }
        ...
        public Builder productCategory(String productCategory) {
            if (productCategory == null) {
              throw new MissingRequiredPropertyException("GetAggregatedComputedUsagesAggregatedComputedUsageAggregatedComputedUsageProduct", "productCategory");
            }
        ...
        public Builder provisioningGroup(String provisioningGroup) {
            if (provisioningGroup == null) {
              throw new MissingRequiredPropertyException("GetAggregatedComputedUsagesAggregatedComputedUsageAggregatedComputedUsageProduct", "provisioningGroup");
            }
        ...
        public Builder ucmRateCardPartType(String ucmRateCardPartType) {
            if (ucmRateCardPartType == null) {
              throw new MissingRequiredPropertyException("GetAggregatedComputedUsagesAggregatedComputedUsageAggregatedComputedUsageProduct", "ucmRateCardPartType");
            }
        ...
        public Builder unitOfMeasure(String unitOfMeasure) {
            if (unitOfMeasure == null) {
              throw new MissingRequiredPropertyException("GetAggregatedComputedUsagesAggregatedComputedUsageAggregatedComputedUsageProduct", "unitOfMeasure");
            }
