    ...
    public static final class Builder {
        ...
        public Builder billingCategory(String billingCategory) {
            if (billingCategory == null) {
              throw new MissingRequiredPropertyException("GetComputedUsagesComputedUsageParentProduct", "billingCategory");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetComputedUsagesComputedUsageParentProduct", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder partNumber(String partNumber) {
            if (partNumber == null) {
              throw new MissingRequiredPropertyException("GetComputedUsagesComputedUsageParentProduct", "partNumber");
            }
        ...
        public Builder productCategory(String productCategory) {
            if (productCategory == null) {
              throw new MissingRequiredPropertyException("GetComputedUsagesComputedUsageParentProduct", "productCategory");
            }
        ...
        public Builder provisioningGroup(String provisioningGroup) {
            if (provisioningGroup == null) {
              throw new MissingRequiredPropertyException("GetComputedUsagesComputedUsageParentProduct", "provisioningGroup");
            }
        ...
        public Builder ucmRateCardPartType(String ucmRateCardPartType) {
            if (ucmRateCardPartType == null) {
              throw new MissingRequiredPropertyException("GetComputedUsagesComputedUsageParentProduct", "ucmRateCardPartType");
            }
        ...
        public Builder unitOfMeasure(String unitOfMeasure) {
            if (unitOfMeasure == null) {
              throw new MissingRequiredPropertyException("GetComputedUsagesComputedUsageParentProduct", "unitOfMeasure");
            }
            this.unitOfMeasure = unitOfMeasure;
            return this;
        }
        public GetComputedUsagesComputedUsageParentProduct build() {
            final var _resultValue = new GetComputedUsagesComputedUsageParentProduct();
