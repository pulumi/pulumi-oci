...
@CustomType
public final class GetInvoicesInvoiceCurrency {
    /**
    ...
    private GetInvoicesInvoiceCurrency() {}
    /**
     * @return Currency Code
     * 
     */
    ...
    public static Builder builder(GetInvoicesInvoiceCurrency defaults) {
    ...
    public static final class Builder {
        ...
        private String stdPrecision;
        public Builder() {}
        public Builder(GetInvoicesInvoiceCurrency defaults) {
        ...
        public Builder isoCode(String isoCode) {
            if (isoCode == null) {
              throw new MissingRequiredPropertyException("GetInvoicesInvoiceCurrency", "isoCode");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetInvoicesInvoiceCurrency", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder stdPrecision(String stdPrecision) {
            if (stdPrecision == null) {
              throw new MissingRequiredPropertyException("GetInvoicesInvoiceCurrency", "stdPrecision");
            }
