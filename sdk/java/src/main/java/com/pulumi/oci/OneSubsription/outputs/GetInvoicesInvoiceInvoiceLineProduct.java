...
@CustomType
public final class GetInvoicesInvoiceInvoiceLineProduct {
    /**
    ...
    private GetInvoicesInvoiceInvoiceLineProduct() {}
    /**
     * @return Metered service billing category
     * 
     */
    ...
    public static Builder builder(GetInvoicesInvoiceInvoiceLineProduct defaults) {
    ...
    public static final class Builder {
        ...
        private String unitOfMeasure;
        public Builder() {}
        public Builder(GetInvoicesInvoiceInvoiceLineProduct defaults) {
        ...
        public Builder billingCategory(String billingCategory) {
            if (billingCategory == null) {
              throw new MissingRequiredPropertyException("GetInvoicesInvoiceInvoiceLineProduct", "billingCategory");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetInvoicesInvoiceInvoiceLineProduct", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder partNumber(String partNumber) {
            if (partNumber == null) {
              throw new MissingRequiredPropertyException("GetInvoicesInvoiceInvoiceLineProduct", "partNumber");
            }
        ...
        public Builder productCategory(String productCategory) {
            if (productCategory == null) {
              throw new MissingRequiredPropertyException("GetInvoicesInvoiceInvoiceLineProduct", "productCategory");
            }
        ...
        public Builder ucmRateCardPartType(String ucmRateCardPartType) {
            if (ucmRateCardPartType == null) {
              throw new MissingRequiredPropertyException("GetInvoicesInvoiceInvoiceLineProduct", "ucmRateCardPartType");
            }
        ...
        public Builder unitOfMeasure(String unitOfMeasure) {
            if (unitOfMeasure == null) {
              throw new MissingRequiredPropertyException("GetInvoicesInvoiceInvoiceLineProduct", "unitOfMeasure");
            }
            this.unitOfMeasure = unitOfMeasure;
            return this;
        }
        public GetInvoicesInvoiceInvoiceLineProduct build() {
            final var _resultValue = new GetInvoicesInvoiceInvoiceLineProduct();
