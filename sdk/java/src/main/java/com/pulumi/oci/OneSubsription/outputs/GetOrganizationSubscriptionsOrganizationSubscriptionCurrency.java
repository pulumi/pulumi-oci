...
@CustomType
public final class GetOrganizationSubscriptionsOrganizationSubscriptionCurrency {
    /**
    ...
    public static final class Builder {
        ...
        public Builder isoCode(String isoCode) {
            if (isoCode == null) {
              throw new MissingRequiredPropertyException("GetOrganizationSubscriptionsOrganizationSubscriptionCurrency", "isoCode");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetOrganizationSubscriptionsOrganizationSubscriptionCurrency", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder stdPrecision(String stdPrecision) {
            if (stdPrecision == null) {
              throw new MissingRequiredPropertyException("GetOrganizationSubscriptionsOrganizationSubscriptionCurrency", "stdPrecision");
            }
            this.stdPrecision = stdPrecision;
            return this;
        }
        public GetOrganizationSubscriptionsOrganizationSubscriptionCurrency build() {
            final var _resultValue = new GetOrganizationSubscriptionsOrganizationSubscriptionCurrency();
