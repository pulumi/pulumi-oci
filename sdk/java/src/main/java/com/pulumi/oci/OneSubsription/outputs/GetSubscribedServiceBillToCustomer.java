...
@CustomType
public final class GetSubscribedServiceBillToCustomer {
    /**
    ...
    public static final class Builder {
        ...
        public Builder customerChainType(String customerChainType) {
            if (customerChainType == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceBillToCustomer", "customerChainType");
            }
        ...
        public Builder isChainCustomer(Boolean isChainCustomer) {
            if (isChainCustomer == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceBillToCustomer", "isChainCustomer");
            }
        ...
        public Builder isPublicSector(Boolean isPublicSector) {
            if (isPublicSector == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceBillToCustomer", "isPublicSector");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceBillToCustomer", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder namePhonetic(String namePhonetic) {
            if (namePhonetic == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceBillToCustomer", "namePhonetic");
            }
        ...
        public Builder tcaCustAccountNumber(String tcaCustAccountNumber) {
            if (tcaCustAccountNumber == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceBillToCustomer", "tcaCustAccountNumber");
            }
        ...
        public Builder tcaCustomerAccountId(String tcaCustomerAccountId) {
            if (tcaCustomerAccountId == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceBillToCustomer", "tcaCustomerAccountId");
            }
        ...
        public Builder tcaPartyId(String tcaPartyId) {
            if (tcaPartyId == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceBillToCustomer", "tcaPartyId");
            }
        ...
        public Builder tcaPartyNumber(String tcaPartyNumber) {
            if (tcaPartyNumber == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceBillToCustomer", "tcaPartyNumber");
            }
            this.tcaPartyNumber = tcaPartyNumber;
            return this;
        }
        public GetSubscribedServiceBillToCustomer build() {
            final var _resultValue = new GetSubscribedServiceBillToCustomer();
