...
@CustomType
public final class GetSubscribedServiceEndUserCustomer {
    /**
    ...
    private GetSubscribedServiceEndUserCustomer() {}
    /**
     * @return Customer chain type.
     * 
     */
    ...
    public static Builder builder(GetSubscribedServiceEndUserCustomer defaults) {
    ...
    public static final class Builder {
        ...
        private String tcaPartyNumber;
        public Builder() {}
        public Builder(GetSubscribedServiceEndUserCustomer defaults) {
        ...
        public Builder customerChainType(String customerChainType) {
            if (customerChainType == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceEndUserCustomer", "customerChainType");
            }
        ...
        public Builder isChainCustomer(Boolean isChainCustomer) {
            if (isChainCustomer == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceEndUserCustomer", "isChainCustomer");
            }
        ...
        public Builder isPublicSector(Boolean isPublicSector) {
            if (isPublicSector == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceEndUserCustomer", "isPublicSector");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceEndUserCustomer", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder namePhonetic(String namePhonetic) {
            if (namePhonetic == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceEndUserCustomer", "namePhonetic");
            }
        ...
        public Builder tcaCustAccountNumber(String tcaCustAccountNumber) {
            if (tcaCustAccountNumber == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceEndUserCustomer", "tcaCustAccountNumber");
            }
        ...
        public Builder tcaCustomerAccountId(String tcaCustomerAccountId) {
            if (tcaCustomerAccountId == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceEndUserCustomer", "tcaCustomerAccountId");
            }
        ...
        public Builder tcaPartyId(String tcaPartyId) {
            if (tcaPartyId == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceEndUserCustomer", "tcaPartyId");
            }
        ...
        public Builder tcaPartyNumber(String tcaPartyNumber) {
            if (tcaPartyNumber == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceEndUserCustomer", "tcaPartyNumber");
            }
            this.tcaPartyNumber = tcaPartyNumber;
            return this;
        }
        public GetSubscribedServiceEndUserCustomer build() {
            final var _resultValue = new GetSubscribedServiceEndUserCustomer();
