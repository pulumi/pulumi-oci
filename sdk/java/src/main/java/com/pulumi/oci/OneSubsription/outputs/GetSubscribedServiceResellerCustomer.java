...
@CustomType
public final class GetSubscribedServiceResellerCustomer {
    /**
    ...
    private GetSubscribedServiceResellerCustomer() {}
    /**
     * @return Customer chain type.
     * 
     */
    ...
    public static Builder builder(GetSubscribedServiceResellerCustomer defaults) {
    ...
    public static final class Builder {
        ...
        private String tcaPartyNumber;
        public Builder() {}
        public Builder(GetSubscribedServiceResellerCustomer defaults) {
        ...
        public Builder customerChainType(String customerChainType) {
            if (customerChainType == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceResellerCustomer", "customerChainType");
            }
        ...
        public Builder isChainCustomer(Boolean isChainCustomer) {
            if (isChainCustomer == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceResellerCustomer", "isChainCustomer");
            }
        ...
        public Builder isPublicSector(Boolean isPublicSector) {
            if (isPublicSector == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceResellerCustomer", "isPublicSector");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceResellerCustomer", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder namePhonetic(String namePhonetic) {
            if (namePhonetic == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceResellerCustomer", "namePhonetic");
            }
        ...
        public Builder tcaCustAccountNumber(String tcaCustAccountNumber) {
            if (tcaCustAccountNumber == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceResellerCustomer", "tcaCustAccountNumber");
            }
        ...
        public Builder tcaCustomerAccountId(String tcaCustomerAccountId) {
            if (tcaCustomerAccountId == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceResellerCustomer", "tcaCustomerAccountId");
            }
        ...
        public Builder tcaPartyId(String tcaPartyId) {
            if (tcaPartyId == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceResellerCustomer", "tcaPartyId");
            }
        ...
        public Builder tcaPartyNumber(String tcaPartyNumber) {
            if (tcaPartyNumber == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServiceResellerCustomer", "tcaPartyNumber");
            }
            this.tcaPartyNumber = tcaPartyNumber;
            return this;
        }
        public GetSubscribedServiceResellerCustomer build() {
            final var _resultValue = new GetSubscribedServiceResellerCustomer();
