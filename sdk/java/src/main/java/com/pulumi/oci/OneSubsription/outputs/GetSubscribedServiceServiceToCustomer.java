...
public final class GetSubscribedServiceServiceToCustomer {
    ...
    public static final class Builder {
        ...
        public Builder tcaPartyNumber(String tcaPartyNumber) {
            ...
            return new GetSubscribedServiceServiceToCustomer(customerChainType, isChainCustomer, isPublicSector, name, namePhonetic, tcaCustAccountNumber, tcaCustomerAccountId, tcaPartyId, tcaPartyNumber);
        }
    }
}
