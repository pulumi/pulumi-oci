...
@CustomType
public final class GetSubscribedServicesSubscribedServiceBillToCustomer {
    /**
    ...
    private GetSubscribedServicesSubscribedServiceBillToCustomer() {}
    /**
     * @return Customer chain type.
     * 
     */
    ...
    public static Builder builder(GetSubscribedServicesSubscribedServiceBillToCustomer defaults) {
    ...
    public static final class Builder {
        ...
        private String tcaPartyNumber;
        public Builder() {}
        public Builder(GetSubscribedServicesSubscribedServiceBillToCustomer defaults) {
        ...
        public Builder customerChainType(String customerChainType) {
            if (customerChainType == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceBillToCustomer", "customerChainType");
            }
        ...
        public Builder isChainCustomer(Boolean isChainCustomer) {
            if (isChainCustomer == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceBillToCustomer", "isChainCustomer");
            }
        ...
        public Builder isPublicSector(Boolean isPublicSector) {
            if (isPublicSector == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceBillToCustomer", "isPublicSector");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceBillToCustomer", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder namePhonetic(String namePhonetic) {
            if (namePhonetic == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceBillToCustomer", "namePhonetic");
            }
        ...
        public Builder tcaCustAccountNumber(String tcaCustAccountNumber) {
            if (tcaCustAccountNumber == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceBillToCustomer", "tcaCustAccountNumber");
            }
        ...
        public Builder tcaCustomerAccountId(String tcaCustomerAccountId) {
            if (tcaCustomerAccountId == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceBillToCustomer", "tcaCustomerAccountId");
            }
        ...
        public Builder tcaPartyId(String tcaPartyId) {
            if (tcaPartyId == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceBillToCustomer", "tcaPartyId");
            }
        ...
        public Builder tcaPartyNumber(String tcaPartyNumber) {
            if (tcaPartyNumber == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceBillToCustomer", "tcaPartyNumber");
            }
            this.tcaPartyNumber = tcaPartyNumber;
            return this;
        }
        public GetSubscribedServicesSubscribedServiceBillToCustomer build() {
            final var _resultValue = new GetSubscribedServicesSubscribedServiceBillToCustomer();
