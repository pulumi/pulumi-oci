...
@CustomType
public final class GetSubscribedServicesSubscribedServiceCommitmentService {
    /**
    ...
    private GetSubscribedServicesSubscribedServiceCommitmentService() {}
    /**
     * @return Commitment available amount
     * 
     */
    ...
    public static Builder builder(GetSubscribedServicesSubscribedServiceCommitmentService defaults) {
    ...
    public static final class Builder {
        ...
        private String timeStart;
        public Builder() {}
        public Builder(GetSubscribedServicesSubscribedServiceCommitmentService defaults) {
        ...
        public Builder availableAmount(String availableAmount) {
            if (availableAmount == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceCommitmentService", "availableAmount");
            }
        ...
        public Builder fundedAllocationValue(String fundedAllocationValue) {
            if (fundedAllocationValue == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceCommitmentService", "fundedAllocationValue");
            }
        ...
        public Builder lineNetAmount(String lineNetAmount) {
            if (lineNetAmount == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceCommitmentService", "lineNetAmount");
            }
        ...
        public Builder quantity(String quantity) {
            if (quantity == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceCommitmentService", "quantity");
            }
        ...
        public Builder timeEnd(String timeEnd) {
            if (timeEnd == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceCommitmentService", "timeEnd");
            }
        ...
        public Builder timeStart(String timeStart) {
            if (timeStart == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceCommitmentService", "timeStart");
            }
            this.timeStart = timeStart;
            return this;
        }
        public GetSubscribedServicesSubscribedServiceCommitmentService build() {
            final var _resultValue = new GetSubscribedServicesSubscribedServiceCommitmentService();
