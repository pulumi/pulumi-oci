    ...
    public static final class Builder {
        ...
        public Builder customerChainType(String customerChainType) {
            if (customerChainType == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceEndUserCustomer", "customerChainType");
            }
        ...
        public Builder isChainCustomer(Boolean isChainCustomer) {
            if (isChainCustomer == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceEndUserCustomer", "isChainCustomer");
            }
        ...
        public Builder isPublicSector(Boolean isPublicSector) {
            if (isPublicSector == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceEndUserCustomer", "isPublicSector");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceEndUserCustomer", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder namePhonetic(String namePhonetic) {
            if (namePhonetic == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceEndUserCustomer", "namePhonetic");
            }
        ...
        public Builder tcaCustAccountNumber(String tcaCustAccountNumber) {
            if (tcaCustAccountNumber == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceEndUserCustomer", "tcaCustAccountNumber");
            }
        ...
        public Builder tcaCustomerAccountId(String tcaCustomerAccountId) {
            if (tcaCustomerAccountId == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceEndUserCustomer", "tcaCustomerAccountId");
            }
        ...
        public Builder tcaPartyId(String tcaPartyId) {
            if (tcaPartyId == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceEndUserCustomer", "tcaPartyId");
            }
        ...
        public Builder tcaPartyNumber(String tcaPartyNumber) {
            if (tcaPartyNumber == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceEndUserCustomer", "tcaPartyNumber");
            }
            this.tcaPartyNumber = tcaPartyNumber;
            return this;
        }
        public GetSubscribedServicesSubscribedServiceEndUserCustomer build() {
            final var _resultValue = new GetSubscribedServicesSubscribedServiceEndUserCustomer();
