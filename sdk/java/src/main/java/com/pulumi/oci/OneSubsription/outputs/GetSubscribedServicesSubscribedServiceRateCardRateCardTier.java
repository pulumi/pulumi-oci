    ...
    public static final class Builder {
        ...
        public Builder netUnitPrice(String netUnitPrice) {
            if (netUnitPrice == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceRateCardRateCardTier", "netUnitPrice");
            }
        ...
        public Builder overagePrice(String overagePrice) {
            if (overagePrice == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceRateCardRateCardTier", "overagePrice");
            }
        ...
        public Builder upToQuantity(String upToQuantity) {
            if (upToQuantity == null) {
              throw new MissingRequiredPropertyException("GetSubscribedServicesSubscribedServiceRateCardRateCardTier", "upToQuantity");
            }
