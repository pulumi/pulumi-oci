...
public class NotificationTopic extends com.pulumi.resources.CustomResource {
     ...
     */
    public NotificationTopic(java.lang.String name) {
     ...
     */
    public NotificationTopic(java.lang.String name, NotificationTopicArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public NotificationTopic(java.lang.String name, NotificationTopicArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Ons/notificationTopic:NotificationTopic", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private NotificationTopic(java.lang.String name, Output<java.lang.String> id, @Nullable NotificationTopicState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Ons/notificationTopic:NotificationTopic", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static NotificationTopic get(java.lang.String name, Output<java.lang.String> id, @Nullable NotificationTopicState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
