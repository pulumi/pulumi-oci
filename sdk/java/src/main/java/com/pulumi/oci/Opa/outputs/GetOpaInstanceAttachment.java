...
@CustomType
public final class GetOpaInstanceAttachment {
    /**
    ...
    private GetOpaInstanceAttachment() {}
    /**
     * @return * If role == `PARENT`, the attached instance was created by this service instance
     * * If role == `CHILD`, this instance was created from attached instance on behalf of a user
     * 
    ...
    public static Builder builder(GetOpaInstanceAttachment defaults) {
    ...
    public static final class Builder {
        ...
        private String targetServiceType;
        public Builder() {}
        public Builder(GetOpaInstanceAttachment defaults) {
        ...
        public Builder isImplicit(Boolean isImplicit) {
            if (isImplicit == null) {
              throw new MissingRequiredPropertyException("GetOpaInstanceAttachment", "isImplicit");
            }
        ...
        public Builder targetId(String targetId) {
            if (targetId == null) {
              throw new MissingRequiredPropertyException("GetOpaInstanceAttachment", "targetId");
            }
        ...
        public Builder targetInstanceUrl(String targetInstanceUrl) {
            if (targetInstanceUrl == null) {
              throw new MissingRequiredPropertyException("GetOpaInstanceAttachment", "targetInstanceUrl");
            }
        ...
        public Builder targetRole(String targetRole) {
            if (targetRole == null) {
              throw new MissingRequiredPropertyException("GetOpaInstanceAttachment", "targetRole");
            }
        ...
        public Builder targetServiceType(String targetServiceType) {
            if (targetServiceType == null) {
              throw new MissingRequiredPropertyException("GetOpaInstanceAttachment", "targetServiceType");
            }
            this.targetServiceType = targetServiceType;
            return this;
        }
        public GetOpaInstanceAttachment build() {
            final var _resultValue = new GetOpaInstanceAttachment();
