...
@CustomType
public final class GetOpaInstancesOpaInstanceCollectionItemAttachment {
    /**
    ...
    private GetOpaInstancesOpaInstanceCollectionItemAttachment() {}
    /**
     * @return * If role == `PARENT`, the attached instance was created by this service instance
     * * If role == `CHILD`, this instance was created from attached instance on behalf of a user
     * 
    ...
    public static Builder builder(GetOpaInstancesOpaInstanceCollectionItemAttachment defaults) {
    ...
    public static final class Builder {
        ...
        private String targetServiceType;
        public Builder() {}
        public Builder(GetOpaInstancesOpaInstanceCollectionItemAttachment defaults) {
        ...
        public Builder isImplicit(Boolean isImplicit) {
            if (isImplicit == null) {
              throw new MissingRequiredPropertyException("GetOpaInstancesOpaInstanceCollectionItemAttachment", "isImplicit");
            }
        ...
        public Builder targetId(String targetId) {
            if (targetId == null) {
              throw new MissingRequiredPropertyException("GetOpaInstancesOpaInstanceCollectionItemAttachment", "targetId");
            }
        ...
        public Builder targetInstanceUrl(String targetInstanceUrl) {
            if (targetInstanceUrl == null) {
              throw new MissingRequiredPropertyException("GetOpaInstancesOpaInstanceCollectionItemAttachment", "targetInstanceUrl");
            }
        ...
        public Builder targetRole(String targetRole) {
            if (targetRole == null) {
              throw new MissingRequiredPropertyException("GetOpaInstancesOpaInstanceCollectionItemAttachment", "targetRole");
            }
        ...
        public Builder targetServiceType(String targetServiceType) {
            if (targetServiceType == null) {
              throw new MissingRequiredPropertyException("GetOpaInstancesOpaInstanceCollectionItemAttachment", "targetServiceType");
            }
