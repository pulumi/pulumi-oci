...
public class OperatorControl extends com.pulumi.resources.CustomResource {
     ...
     */
    public OperatorControl(java.lang.String name) {
     ...
     */
    public OperatorControl(java.lang.String name, OperatorControlArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public OperatorControl(java.lang.String name, OperatorControlArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:OperatorAccessControl/operatorControl:OperatorControl", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private OperatorControl(java.lang.String name, Output<java.lang.String> id, @Nullable OperatorControlState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:OperatorAccessControl/operatorControl:OperatorControl", name, state, makeResourceOptions(options, id), false);
    }

    private static OperatorControlArgs makeArgs(OperatorControlArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? OperatorControlArgs.Empty : args;
    }
     ...
     */
    public static OperatorControl get(java.lang.String name, Output<java.lang.String> id, @Nullable OperatorControlState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
