...
public class AwrHub extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="awrMailboxUrl", refs={String.class}, tree="[0]")
     ...
     */
    public AwrHub(java.lang.String name) {
     ...
     */
    public AwrHub(java.lang.String name, AwrHubArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AwrHub(java.lang.String name, AwrHubArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Opsi/awrHub:AwrHub", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AwrHub(java.lang.String name, Output<java.lang.String> id, @Nullable AwrHubState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Opsi/awrHub:AwrHub", name, state, makeResourceOptions(options, id), false);
    }

    private static AwrHubArgs makeArgs(AwrHubArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? AwrHubArgs.Empty : args;
    }
     ...
     */
    public static AwrHub get(java.lang.String name, Output<java.lang.String> id, @Nullable AwrHubState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
