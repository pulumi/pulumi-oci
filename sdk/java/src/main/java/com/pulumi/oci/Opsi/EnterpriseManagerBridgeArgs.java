    ...
    public static final class Builder {
        ...
        public EnterpriseManagerBridgeArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("EnterpriseManagerBridgeArgs", "compartmentId");
            }
            if ($.displayName == null) {
                throw new MissingRequiredPropertyException("EnterpriseManagerBridgeArgs", "displayName");
            }
            if ($.objectStorageBucketName == null) {
                throw new MissingRequiredPropertyException("EnterpriseManagerBridgeArgs", "objectStorageBucketName");
            }
            return $;
        }
    }
