...
public final class DatabaseInsightCredentialDetailsArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        /**
         * @param credentialSourceName Credential source name that had been added in Management Agent wallet. This value is only required when credential set by CREDENTIALS_BY_SOURCE and is optional properties for the others.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param namedCredentialId The credential [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) stored in the Management Agent to connect the Autonomous Database.
         * 
         * @return builder
         * 
         */
