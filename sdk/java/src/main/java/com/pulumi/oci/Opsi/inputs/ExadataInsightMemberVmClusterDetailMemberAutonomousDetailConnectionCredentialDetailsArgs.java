...
public final class ExadataInsightMemberVmClusterDetailMemberAutonomousDetailConnectionCredentialDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ExadataInsightMemberVmClusterDetailMemberAutonomousDetailConnectionCredentialDetailsArgs Empty = new ExadataInsightMemberVmClusterDetailMemberAutonomousDetailConnectionCredentialDetailsArgs();
    ...
    private ExadataInsightMemberVmClusterDetailMemberAutonomousDetailConnectionCredentialDetailsArgs() {}

    private ExadataInsightMemberVmClusterDetailMemberAutonomousDetailConnectionCredentialDetailsArgs(ExadataInsightMemberVmClusterDetailMemberAutonomousDetailConnectionCredentialDetailsArgs $) {
    ...
    public static Builder builder(ExadataInsightMemberVmClusterDetailMemberAutonomousDetailConnectionCredentialDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ExadataInsightMemberVmClusterDetailMemberAutonomousDetailConnectionCredentialDetailsArgs();
        }

        public Builder(ExadataInsightMemberVmClusterDetailMemberAutonomousDetailConnectionCredentialDetailsArgs defaults) {
            $ = new ExadataInsightMemberVmClusterDetailMemberAutonomousDetailConnectionCredentialDetailsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ExadataInsightMemberVmClusterDetailMemberAutonomousDetailConnectionCredentialDetailsArgs build() {
            if ($.credentialType == null) {
                throw new MissingRequiredPropertyException("ExadataInsightMemberVmClusterDetailMemberAutonomousDetailConnectionCredentialDetailsArgs", "credentialType");
            }
            return $;
        }
    }
