...
public final class ExadataInsightMemberVmClusterDetailMemberAutonomousDetailCredentialDetailsArgs extends com.pulumi.resources.ResourceArgs {

    public static final ExadataInsightMemberVmClusterDetailMemberAutonomousDetailCredentialDetailsArgs Empty = new ExadataInsightMemberVmClusterDetailMemberAutonomousDetailCredentialDetailsArgs();
    ...
    private ExadataInsightMemberVmClusterDetailMemberAutonomousDetailCredentialDetailsArgs() {}

    private ExadataInsightMemberVmClusterDetailMemberAutonomousDetailCredentialDetailsArgs(ExadataInsightMemberVmClusterDetailMemberAutonomousDetailCredentialDetailsArgs $) {
    ...
    public static Builder builder(ExadataInsightMemberVmClusterDetailMemberAutonomousDetailCredentialDetailsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ExadataInsightMemberVmClusterDetailMemberAutonomousDetailCredentialDetailsArgs();
        }

        public Builder(ExadataInsightMemberVmClusterDetailMemberAutonomousDetailCredentialDetailsArgs defaults) {
            $ = new ExadataInsightMemberVmClusterDetailMemberAutonomousDetailCredentialDetailsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ExadataInsightMemberVmClusterDetailMemberAutonomousDetailCredentialDetailsArgs build() {
            if ($.credentialType == null) {
                throw new MissingRequiredPropertyException("ExadataInsightMemberVmClusterDetailMemberAutonomousDetailCredentialDetailsArgs", "credentialType");
            }
            return $;
        }
    }
