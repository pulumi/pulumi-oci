...
public final class GetAwrHubAwrSnapshotArgs extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetAwrHubAwrSnapshotArgs build() {
            if ($.awrHubId == null) {
                throw new MissingRequiredPropertyException("GetAwrHubAwrSnapshotArgs", "awrHubId");
            }
            if ($.awrSourceDatabaseIdentifier == null) {
                throw new MissingRequiredPropertyException("GetAwrHubAwrSnapshotArgs", "awrSourceDatabaseIdentifier");
            }
            return $;
        }
    }
