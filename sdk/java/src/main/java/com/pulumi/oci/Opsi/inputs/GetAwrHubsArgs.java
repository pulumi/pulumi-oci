...
import com.pulumi.oci.Opsi.inputs.GetAwrHubsFilterArgs;
...
public final class GetAwrHubsArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetAwrHubsArgs Empty = new GetAwrHubsArgs();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetAwrHubsFilterArgs>> filters;

    public Optional<Output<List<GetAwrHubsFilterArgs>>> filters() {
    ...
    private GetAwrHubsArgs(GetAwrHubsArgs $) {
    ...
    public static Builder builder(GetAwrHubsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetAwrHubsArgs defaults) {
            $ = new GetAwrHubsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetAwrHubsFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetAwrHubsFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetAwrHubsFilterArgs... filters) {
        ...
        public GetAwrHubsArgs build() {
            if ($.operationsInsightsWarehouseId == null) {
                throw new MissingRequiredPropertyException("GetAwrHubsArgs", "operationsInsightsWarehouseId");
            }
            return $;
        }
    }
