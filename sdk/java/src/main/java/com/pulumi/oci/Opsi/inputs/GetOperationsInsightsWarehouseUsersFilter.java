...
public final class GetOperationsInsightsWarehouseUsersFilter extends com.pulumi.resources.InvokeArgs {
    ...
    public static final class Builder {
        ...
        public GetOperationsInsightsWarehouseUsersFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetOperationsInsightsWarehouseUsersFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetOperationsInsightsWarehouseUsersFilter", "values");
            }
            return $;
        }
    }
