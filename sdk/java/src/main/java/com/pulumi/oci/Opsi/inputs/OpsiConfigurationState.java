...
public final class OpsiConfigurationState extends com.pulumi.resources.ResourceArgs {

    public static final OpsiConfigurationState Empty = new OpsiConfigurationState();
     ...
     * 
     */
    @Import(name="opsiConfigType")
    private @Nullable Output<String> opsiConfigType;

    /**
     * @return (Updatable) OPSI configuration type.
     * 
     */
    public Optional<Output<String>> opsiConfigType() {
    ...
    private OpsiConfigurationState() {}

    private OpsiConfigurationState(OpsiConfigurationState $) {
    ...
    public static Builder builder(OpsiConfigurationState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new OpsiConfigurationState();
        }

        public Builder(OpsiConfigurationState defaults) {
            $ = new OpsiConfigurationState(Objects.requireNonNull(defaults));
        }
         ...
         * 
         */
        public Builder opsiConfigType(@Nullable Output<String> opsiConfigType) {
        ...
        /**
         * @param state OPSI configuration resource lifecycle state.
         * 
         * @return builder
         * 
         */
        ...
        public OpsiConfigurationState build() {
            return $;
        }
    }
