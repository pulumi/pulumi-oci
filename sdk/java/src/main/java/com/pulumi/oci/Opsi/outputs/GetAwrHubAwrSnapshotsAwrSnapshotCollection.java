...
public final class GetAwrHubAwrSnapshotsAwrSnapshotCollection {
     ...
     * 
     */
    private @Nullable List<GetAwrHubAwrSnapshotsAwrSnapshotCollectionItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetAwrHubAwrSnapshotsAwrSnapshotCollectionItem> items) {
            this.items = items;
            return this;
        }
