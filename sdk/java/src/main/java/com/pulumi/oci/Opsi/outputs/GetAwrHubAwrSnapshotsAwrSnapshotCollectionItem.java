...
public final class GetAwrHubAwrSnapshotsAwrSnapshotCollectionItem {
     ...
     * 
     */
    private @Nullable List<GetAwrHubAwrSnapshotsAwrSnapshotCollectionItemItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetAwrHubAwrSnapshotsAwrSnapshotCollectionItemItem> items) {
            this.items = items;
            return this;
        }
