...
public final class GetHostInsightsHostInsightSummaryCollection {
    private @Nullable List<GetHostInsightsHostInsightSummaryCollectionItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetHostInsightsHostInsightSummaryCollectionItem> items) {
            this.items = items;
            return this;
        }
