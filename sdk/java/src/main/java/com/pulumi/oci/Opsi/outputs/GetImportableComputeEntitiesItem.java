    ...
    public static final class Builder {
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetImportableComputeEntitiesItem", "compartmentId");
            }
        ...
        public Builder computeDisplayName(String computeDisplayName) {
            if (computeDisplayName == null) {
              throw new MissingRequiredPropertyException("GetImportableComputeEntitiesItem", "computeDisplayName");
            }
        ...
        public Builder computeId(String computeId) {
            if (computeId == null) {
              throw new MissingRequiredPropertyException("GetImportableComputeEntitiesItem", "computeId");
            }
        ...
        public Builder entitySource(String entitySource) {
            if (entitySource == null) {
              throw new MissingRequiredPropertyException("GetImportableComputeEntitiesItem", "entitySource");
            }
        ...
        public Builder hostName(String hostName) {
            if (hostName == null) {
              throw new MissingRequiredPropertyException("GetImportableComputeEntitiesItem", "hostName");
            }
        ...
        public Builder platformType(String platformType) {
            if (platformType == null) {
              throw new MissingRequiredPropertyException("GetImportableComputeEntitiesItem", "platformType");
            }
