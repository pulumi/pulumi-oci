...
public final class GetOperationsInsightsWarehouseUsersOperationsInsightsWarehouseUserSummaryCollection {
    private @Nullable List<GetOperationsInsightsWarehouseUsersOperationsInsightsWarehouseUserSummaryCollectionItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetOperationsInsightsWarehouseUsersOperationsInsightsWarehouseUserSummaryCollectionItem> items) {
            this.items = items;
            return this;
        }
