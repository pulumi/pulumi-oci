...
public final class GetHistoriesFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetHistoriesFilter Empty = new GetHistoriesFilter();
    ...
    private GetHistoriesFilter(GetHistoriesFilter $) {
        this.name = $.name;
        this.regex = $.regex;
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetHistoriesFilter();
        }

        public Builder(GetHistoriesFilter defaults) {
            $ = new GetHistoriesFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetHistoriesFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetHistoriesFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetHistoriesFilter", "values");
            }
            return $;
        }
    }
