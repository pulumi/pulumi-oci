...
public final class GetProfileLevelPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetProfileLevelPlainArgs Empty = new GetProfileLevelPlainArgs();
    ...
    private GetProfileLevelPlainArgs() {}

    private GetProfileLevelPlainArgs(GetProfileLevelPlainArgs $) {
    ...
    public static Builder builder(GetProfileLevelPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetProfileLevelPlainArgs();
        }

        public Builder(GetProfileLevelPlainArgs defaults) {
            $ = new GetProfileLevelPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetProfileLevelPlainArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetProfileLevelPlainArgs", "compartmentId");
            }
            if ($.compartmentIdInSubtree == null) {
                throw new MissingRequiredPropertyException("GetProfileLevelPlainArgs", "compartmentIdInSubtree");
            }
            return $;
        }
    }
