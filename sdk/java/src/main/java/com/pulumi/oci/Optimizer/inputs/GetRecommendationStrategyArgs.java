    ...
    public static final class Builder {
        ...
        public GetRecommendationStrategyArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetRecommendationStrategyArgs", "compartmentId");
            }
            if ($.compartmentIdInSubtree == null) {
                throw new MissingRequiredPropertyException("GetRecommendationStrategyArgs", "compartmentIdInSubtree");
            }
            return $;
        }
    }
