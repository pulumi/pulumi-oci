    ...
    public static final class Builder {
        ...
        public GetRecommendationsArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetRecommendationsArgs", "compartmentId");
            }
            if ($.compartmentIdInSubtree == null) {
                throw new MissingRequiredPropertyException("GetRecommendationsArgs", "compartmentIdInSubtree");
            }
            return $;
        }
    }
