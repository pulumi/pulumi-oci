...
public final class GetRecommendationsRecommendationCollectionItemSupportedLevel {
     ...
     * 
     */
    private @Nullable List<GetRecommendationsRecommendationCollectionItemSupportedLevelItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetRecommendationsRecommendationCollectionItemSupportedLevelItem> items) {
            this.items = items;
            return this;
        }
