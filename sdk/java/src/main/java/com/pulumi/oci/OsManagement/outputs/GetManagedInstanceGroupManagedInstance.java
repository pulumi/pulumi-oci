...
public final class GetManagedInstanceGroupManagedInstance {
    ...
    public static final class Builder {
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetManagedInstanceGroupManagedInstance", "displayName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetManagedInstanceGroupManagedInstance", "id");
            }
            this.id = id;
            return this;
        }
