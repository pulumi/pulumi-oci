...
public final class GetManagedInstanceGroupsManagedInstanceGroupManagedInstance {
    ...
    public static final class Builder {
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetManagedInstanceGroupsManagedInstanceGroupManagedInstance", "displayName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetManagedInstanceGroupsManagedInstanceGroupManagedInstance", "id");
            }
            this.id = id;
            return this;
        }
        public GetManagedInstanceGroupsManagedInstanceGroupManagedInstance build() {
            final var _resultValue = new GetManagedInstanceGroupsManagedInstanceGroupManagedInstance();
