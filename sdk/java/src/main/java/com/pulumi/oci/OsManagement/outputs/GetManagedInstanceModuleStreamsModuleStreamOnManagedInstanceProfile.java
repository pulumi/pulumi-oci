...
public final class GetManagedInstanceModuleStreamsModuleStreamOnManagedInstanceProfile {
    ...
    public static final class Builder {
        ...
        public Builder moduleName(String moduleName) {
            if (moduleName == null) {
              throw new MissingRequiredPropertyException("GetManagedInstanceModuleStreamsModuleStreamOnManagedInstanceProfile", "moduleName");
            }
        ...
        public Builder profileName(String profileName) {
            if (profileName == null) {
              throw new MissingRequiredPropertyException("GetManagedInstanceModuleStreamsModuleStreamOnManagedInstanceProfile", "profileName");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetManagedInstanceModuleStreamsModuleStreamOnManagedInstanceProfile", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder streamName(String streamName) {
            if (streamName == null) {
              throw new MissingRequiredPropertyException("GetManagedInstanceModuleStreamsModuleStreamOnManagedInstanceProfile", "streamName");
            }
        ...
        public Builder timeModified(String timeModified) {
            if (timeModified == null) {
              throw new MissingRequiredPropertyException("GetManagedInstanceModuleStreamsModuleStreamOnManagedInstanceProfile", "timeModified");
            }
            this.timeModified = timeModified;
            return this;
        }
        public GetManagedInstanceModuleStreamsModuleStreamOnManagedInstanceProfile build() {
            final var _resultValue = new GetManagedInstanceModuleStreamsModuleStreamOnManagedInstanceProfile();
