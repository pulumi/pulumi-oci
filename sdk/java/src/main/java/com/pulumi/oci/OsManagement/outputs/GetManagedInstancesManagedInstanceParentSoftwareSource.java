...
public final class GetManagedInstancesManagedInstanceParentSoftwareSource {
    ...
    public static Builder builder(GetManagedInstancesManagedInstanceParentSoftwareSource defaults) {
    ...
    public static final class Builder {
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetManagedInstancesManagedInstanceParentSoftwareSource", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetManagedInstancesManagedInstanceParentSoftwareSource", "name");
            }
            this.name = name;
            return this;
        }
        public GetManagedInstancesManagedInstanceParentSoftwareSource build() {
            final var _resultValue = new GetManagedInstancesManagedInstanceParentSoftwareSource();
            _resultValue.id = id;
