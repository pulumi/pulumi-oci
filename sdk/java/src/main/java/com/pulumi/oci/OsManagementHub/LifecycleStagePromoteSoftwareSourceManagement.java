...
public class LifecycleStagePromoteSoftwareSourceManagement extends com.pulumi.resources.CustomResource {
    ...
    public LifecycleStagePromoteSoftwareSourceManagement(String name, LifecycleStagePromoteSoftwareSourceManagementArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:OsManagementHub/lifecycleStagePromoteSoftwareSourceManagement:LifecycleStagePromoteSoftwareSourceManagement", name, args == null ? LifecycleStagePromoteSoftwareSourceManagementArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
