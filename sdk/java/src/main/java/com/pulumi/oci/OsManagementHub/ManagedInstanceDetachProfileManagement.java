...
public class ManagedInstanceDetachProfileManagement extends com.pulumi.resources.CustomResource {
     ...
     */
    public ManagedInstanceDetachProfileManagement(String name) {
     ...
     */
    public static ManagedInstanceDetachProfileManagement get(String name, Output<String> id, @Nullable ManagedInstanceDetachProfileManagementState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
