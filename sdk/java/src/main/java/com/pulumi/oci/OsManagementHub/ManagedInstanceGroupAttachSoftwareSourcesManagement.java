...
public class ManagedInstanceGroupAttachSoftwareSourcesManagement extends com.pulumi.resources.CustomResource {
     ...
     */
    public ManagedInstanceGroupAttachSoftwareSourcesManagement(String name) {
     ...
     */
    public static ManagedInstanceGroupAttachSoftwareSourcesManagement get(String name, Output<String> id, @Nullable ManagedInstanceGroupAttachSoftwareSourcesManagementState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
