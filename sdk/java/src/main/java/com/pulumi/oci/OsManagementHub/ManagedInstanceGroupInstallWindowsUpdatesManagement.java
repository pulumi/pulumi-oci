...
public class ManagedInstanceGroupInstallWindowsUpdatesManagement extends com.pulumi.resources.CustomResource {
    ...
    public ManagedInstanceGroupInstallWindowsUpdatesManagement(String name, ManagedInstanceGroupInstallWindowsUpdatesManagementArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:OsManagementHub/managedInstanceGroupInstallWindowsUpdatesManagement:ManagedInstanceGroupInstallWindowsUpdatesManagement", name, args == null ? ManagedInstanceGroupInstallWindowsUpdatesManagementArgs.Empty : args, makeResourceOptions(options, Codegen.empty()));
    }
