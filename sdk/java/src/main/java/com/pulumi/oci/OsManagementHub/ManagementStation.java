 ...
 *             .hostname(var_.management_station_hostname())
 *             .mirror(ManagementStationMirrorArgs.builder()
 *                 .directory(var_.management_station_mirror_directory())
 *                 .port(var_.management_station_mirror_port())
 *                 .sslport(var_.management_station_mirror_sslport())
 *                 .sslcert(var_.management_station_mirror_sslcert())
 *                 .build())
 *             .proxy(ManagementStationProxyArgs.builder()
 *                 .isEnabled(var_.management_station_proxy_is_enabled())
 *                 .forward(var_.management_station_proxy_forward())
 *                 .hosts(var_.management_station_proxy_hosts())
 *                 .port(var_.management_station_proxy_port())
 *                 .build())
 *             .definedTags(Map.of(&#34;Operations.CostCenter&#34;, &#34;42&#34;))
 *             .description(var_.management_station_description())
