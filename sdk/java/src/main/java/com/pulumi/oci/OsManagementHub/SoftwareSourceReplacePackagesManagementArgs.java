...
public final class SoftwareSourceReplacePackagesManagementArgs extends com.pulumi.resources.ResourceArgs {

    public static final SoftwareSourceReplacePackagesManagementArgs Empty = new SoftwareSourceReplacePackagesManagementArgs();
    ...
    private SoftwareSourceReplacePackagesManagementArgs() {}

    private SoftwareSourceReplacePackagesManagementArgs(SoftwareSourceReplacePackagesManagementArgs $) {
    ...
    public static Builder builder(SoftwareSourceReplacePackagesManagementArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SoftwareSourceReplacePackagesManagementArgs();
        }

        public Builder(SoftwareSourceReplacePackagesManagementArgs defaults) {
            $ = new SoftwareSourceReplacePackagesManagementArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SoftwareSourceReplacePackagesManagementArgs build() {
            if ($.packages == null) {
                throw new MissingRequiredPropertyException("SoftwareSourceReplacePackagesManagementArgs", "packages");
            }
            if ($.softwareSourceId == null) {
                throw new MissingRequiredPropertyException("SoftwareSourceReplacePackagesManagementArgs", "softwareSourceId");
            }
            return $;
        }
    }
