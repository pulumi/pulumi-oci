...
import com.pulumi.oci.OsManagementHub.inputs.GetManagedInstanceAvailablePackagesFilterArgs;
...
public final class GetManagedInstanceAvailablePackagesArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetManagedInstanceAvailablePackagesArgs Empty = new GetManagedInstanceAvailablePackagesArgs();
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetManagedInstanceAvailablePackagesFilterArgs>> filters;

    public Optional<Output<List<GetManagedInstanceAvailablePackagesFilterArgs>>> filters() {
    ...
    private GetManagedInstanceAvailablePackagesArgs() {}

    private GetManagedInstanceAvailablePackagesArgs(GetManagedInstanceAvailablePackagesArgs $) {
    ...
    public static Builder builder(GetManagedInstanceAvailablePackagesArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetManagedInstanceAvailablePackagesArgs();
        }

        public Builder(GetManagedInstanceAvailablePackagesArgs defaults) {
            $ = new GetManagedInstanceAvailablePackagesArgs(Objects.requireNonNull(defaults));
        }
        ...
        public Builder filters(@Nullable Output<List<GetManagedInstanceAvailablePackagesFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetManagedInstanceAvailablePackagesFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetManagedInstanceAvailablePackagesFilterArgs... filters) {
        ...
        public GetManagedInstanceAvailablePackagesArgs build() {
            if ($.managedInstanceId == null) {
                throw new MissingRequiredPropertyException("GetManagedInstanceAvailablePackagesArgs", "managedInstanceId");
            }
            return $;
        }
    }
