...
public final class ManagedInstanceGroupManageModuleStreamsManagementDisableArgs extends com.pulumi.resources.ResourceArgs {

    public static final ManagedInstanceGroupManageModuleStreamsManagementDisableArgs Empty = new ManagedInstanceGroupManageModuleStreamsManagementDisableArgs();
    ...
    private ManagedInstanceGroupManageModuleStreamsManagementDisableArgs() {}

    private ManagedInstanceGroupManageModuleStreamsManagementDisableArgs(ManagedInstanceGroupManageModuleStreamsManagementDisableArgs $) {
    ...
    public static Builder builder(ManagedInstanceGroupManageModuleStreamsManagementDisableArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ManagedInstanceGroupManageModuleStreamsManagementDisableArgs();
        }

        public Builder(ManagedInstanceGroupManageModuleStreamsManagementDisableArgs defaults) {
            $ = new ManagedInstanceGroupManageModuleStreamsManagementDisableArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ManagedInstanceGroupManageModuleStreamsManagementDisableArgs build() {
            if ($.moduleName == null) {
                throw new MissingRequiredPropertyException("ManagedInstanceGroupManageModuleStreamsManagementDisableArgs", "moduleName");
            }
            if ($.streamName == null) {
                throw new MissingRequiredPropertyException("ManagedInstanceGroupManageModuleStreamsManagementDisableArgs", "streamName");
            }
            return $;
        }
    }
