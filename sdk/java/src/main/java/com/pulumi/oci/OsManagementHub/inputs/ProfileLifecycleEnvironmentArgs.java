...
public final class ProfileLifecycleEnvironmentArgs extends com.pulumi.resources.ResourceArgs {

    public static final ProfileLifecycleEnvironmentArgs Empty = new ProfileLifecycleEnvironmentArgs();
    ...
    private ProfileLifecycleEnvironmentArgs() {}

    private ProfileLifecycleEnvironmentArgs(ProfileLifecycleEnvironmentArgs $) {
    ...
    public static Builder builder(ProfileLifecycleEnvironmentArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ProfileLifecycleEnvironmentArgs();
        }

        public Builder(ProfileLifecycleEnvironmentArgs defaults) {
            $ = new ProfileLifecycleEnvironmentArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ProfileLifecycleEnvironmentArgs build() {
            return $;
        }
    }
