...
@CustomType
public final class GetErratumPackageSoftwareSource {
    /**
    ...
    private GetErratumPackageSoftwareSource() {}
    /**
     * @return Software source description.
     * 
     */
    ...
    public static Builder builder(GetErratumPackageSoftwareSource defaults) {
    ...
    public static final class Builder {
        ...
        private String softwareSourceType;
        public Builder() {}
        public Builder(GetErratumPackageSoftwareSource defaults) {
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetErratumPackageSoftwareSource", "description");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetErratumPackageSoftwareSource", "displayName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetErratumPackageSoftwareSource", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isMandatoryForAutonomousLinux(Boolean isMandatoryForAutonomousLinux) {
            if (isMandatoryForAutonomousLinux == null) {
              throw new MissingRequiredPropertyException("GetErratumPackageSoftwareSource", "isMandatoryForAutonomousLinux");
            }
        ...
        public Builder softwareSourceType(String softwareSourceType) {
            if (softwareSourceType == null) {
              throw new MissingRequiredPropertyException("GetErratumPackageSoftwareSource", "softwareSourceType");
            }
            this.softwareSourceType = softwareSourceType;
            return this;
        }
        public GetErratumPackageSoftwareSource build() {
            final var _resultValue = new GetErratumPackageSoftwareSource();
