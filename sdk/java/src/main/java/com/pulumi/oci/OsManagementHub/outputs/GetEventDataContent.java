...
@CustomType
public final class GetEventDataContent {
    /**
    ...
    public static Builder builder(GetEventDataContent defaults) {
    ...
    public static final class Builder {
        ...
        private String type;
        public Builder() {}
        public Builder(GetEventDataContent defaults) {
        ...
        public Builder contentAvailability(String contentAvailability) {
            if (contentAvailability == null) {
              throw new MissingRequiredPropertyException("GetEventDataContent", "contentAvailability");
            }
        ...
        public Builder contentLocation(String contentLocation) {
            if (contentLocation == null) {
              throw new MissingRequiredPropertyException("GetEventDataContent", "contentLocation");
            }
        ...
        public Builder exploitDetectionLogContent(String exploitDetectionLogContent) {
            if (exploitDetectionLogContent == null) {
              throw new MissingRequiredPropertyException("GetEventDataContent", "exploitDetectionLogContent");
            }
        ...
        public Builder exploitObjectStoreLocation(String exploitObjectStoreLocation) {
            if (exploitObjectStoreLocation == null) {
              throw new MissingRequiredPropertyException("GetEventDataContent", "exploitObjectStoreLocation");
            }
        ...
        public Builder size(Integer size) {
            if (size == null) {
              throw new MissingRequiredPropertyException("GetEventDataContent", "size");
            }
            this.size = size;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetEventDataContent", "type");
            }
            this.type = type;
            return this;
        }
        public GetEventDataContent build() {
            final var _resultValue = new GetEventDataContent();
