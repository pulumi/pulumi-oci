...
@CustomType
public final class GetLifecycleEnvironmentStageSoftwareSourceId {
    /**
    ...
    private GetLifecycleEnvironmentStageSoftwareSourceId() {}
    /**
     * @return Software source description.
     * 
     */
    ...
    public static Builder builder(GetLifecycleEnvironmentStageSoftwareSourceId defaults) {
    ...
    public static final class Builder {
        ...
        private String softwareSourceType;
        public Builder() {}
        public Builder(GetLifecycleEnvironmentStageSoftwareSourceId defaults) {
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetLifecycleEnvironmentStageSoftwareSourceId", "description");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetLifecycleEnvironmentStageSoftwareSourceId", "displayName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetLifecycleEnvironmentStageSoftwareSourceId", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isMandatoryForAutonomousLinux(Boolean isMandatoryForAutonomousLinux) {
            if (isMandatoryForAutonomousLinux == null) {
              throw new MissingRequiredPropertyException("GetLifecycleEnvironmentStageSoftwareSourceId", "isMandatoryForAutonomousLinux");
            }
        ...
        public Builder softwareSourceType(String softwareSourceType) {
            if (softwareSourceType == null) {
              throw new MissingRequiredPropertyException("GetLifecycleEnvironmentStageSoftwareSourceId", "softwareSourceType");
            }
