    ...
    public static final class Builder {
        ...
        public Builder isMandatoryForAutonomousLinux(Boolean isMandatoryForAutonomousLinux) {
            if (isMandatoryForAutonomousLinux == null) {
              throw new MissingRequiredPropertyException("GetLifecycleEnvironmentsLifecycleEnvironmentCollectionItemStageSoftwareSourceId", "isMandatoryForAutonomousLinux");
            }
