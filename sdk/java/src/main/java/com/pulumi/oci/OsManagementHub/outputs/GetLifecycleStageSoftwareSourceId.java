...
@CustomType
public final class GetLifecycleStageSoftwareSourceId {
    /**
    ...
    private GetLifecycleStageSoftwareSourceId() {}
    /**
     * @return Software source description.
     * 
     */
    ...
    public static Builder builder(GetLifecycleStageSoftwareSourceId defaults) {
    ...
    public static final class Builder {
        ...
        private String softwareSourceType;
        public Builder() {}
        public Builder(GetLifecycleStageSoftwareSourceId defaults) {
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetLifecycleStageSoftwareSourceId", "description");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetLifecycleStageSoftwareSourceId", "displayName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetLifecycleStageSoftwareSourceId", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isMandatoryForAutonomousLinux(Boolean isMandatoryForAutonomousLinux) {
            if (isMandatoryForAutonomousLinux == null) {
              throw new MissingRequiredPropertyException("GetLifecycleStageSoftwareSourceId", "isMandatoryForAutonomousLinux");
            }
        ...
        public Builder softwareSourceType(String softwareSourceType) {
            if (softwareSourceType == null) {
              throw new MissingRequiredPropertyException("GetLifecycleStageSoftwareSourceId", "softwareSourceType");
            }
            this.softwareSourceType = softwareSourceType;
            return this;
        }
        public GetLifecycleStageSoftwareSourceId build() {
            final var _resultValue = new GetLifecycleStageSoftwareSourceId();
