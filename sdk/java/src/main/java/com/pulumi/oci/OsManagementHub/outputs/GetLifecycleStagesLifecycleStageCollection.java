...
public final class GetLifecycleStagesLifecycleStageCollection {
    private @Nullable List<GetLifecycleStagesLifecycleStageCollectionItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetLifecycleStagesLifecycleStageCollectionItem> items) {
            this.items = items;
            return this;
        }
