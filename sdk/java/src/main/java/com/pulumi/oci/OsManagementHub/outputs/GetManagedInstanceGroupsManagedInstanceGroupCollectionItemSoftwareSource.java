...
@CustomType
public final class GetManagedInstanceGroupsManagedInstanceGroupCollectionItemSoftwareSource {
    /**
    ...
    private GetManagedInstanceGroupsManagedInstanceGroupCollectionItemSoftwareSource() {}
    /**
     * @return Software source description.
     * 
     */
    ...
    public static Builder builder(GetManagedInstanceGroupsManagedInstanceGroupCollectionItemSoftwareSource defaults) {
    ...
    public static final class Builder {
        ...
        private String softwareSourceType;
        public Builder() {}
        public Builder(GetManagedInstanceGroupsManagedInstanceGroupCollectionItemSoftwareSource defaults) {
        ...
        public Builder isMandatoryForAutonomousLinux(Boolean isMandatoryForAutonomousLinux) {
            if (isMandatoryForAutonomousLinux == null) {
              throw new MissingRequiredPropertyException("GetManagedInstanceGroupsManagedInstanceGroupCollectionItemSoftwareSource", "isMandatoryForAutonomousLinux");
            }
        ...
        public GetManagedInstanceGroupsManagedInstanceGroupCollectionItemSoftwareSource build() {
            final var _resultValue = new GetManagedInstanceGroupsManagedInstanceGroupCollectionItemSoftwareSource();
