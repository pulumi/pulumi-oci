...
@CustomType
public final class GetManagedInstancesManagedInstanceCollectionItemSoftwareSource {
    /**
    ...
    private GetManagedInstancesManagedInstanceCollectionItemSoftwareSource() {}
    /**
     * @return Software source description.
     * 
     */
    ...
    public static Builder builder(GetManagedInstancesManagedInstanceCollectionItemSoftwareSource defaults) {
    ...
    public static final class Builder {
        ...
        private String softwareSourceType;
        public Builder() {}
        public Builder(GetManagedInstancesManagedInstanceCollectionItemSoftwareSource defaults) {
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetManagedInstancesManagedInstanceCollectionItemSoftwareSource", "description");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetManagedInstancesManagedInstanceCollectionItemSoftwareSource", "displayName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetManagedInstancesManagedInstanceCollectionItemSoftwareSource", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isMandatoryForAutonomousLinux(Boolean isMandatoryForAutonomousLinux) {
            if (isMandatoryForAutonomousLinux == null) {
              throw new MissingRequiredPropertyException("GetManagedInstancesManagedInstanceCollectionItemSoftwareSource", "isMandatoryForAutonomousLinux");
            }
        ...
        public Builder softwareSourceType(String softwareSourceType) {
            if (softwareSourceType == null) {
              throw new MissingRequiredPropertyException("GetManagedInstancesManagedInstanceCollectionItemSoftwareSource", "softwareSourceType");
            }
            this.softwareSourceType = softwareSourceType;
            return this;
        }
        public GetManagedInstancesManagedInstanceCollectionItemSoftwareSource build() {
            final var _resultValue = new GetManagedInstancesManagedInstanceCollectionItemSoftwareSource();
