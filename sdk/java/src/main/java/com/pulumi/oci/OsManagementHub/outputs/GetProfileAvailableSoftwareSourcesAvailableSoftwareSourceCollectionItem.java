...
@CustomType
public final class GetProfileAvailableSoftwareSourcesAvailableSoftwareSourceCollectionItem {
    /**
    ...
    public static Builder builder(GetProfileAvailableSoftwareSourcesAvailableSoftwareSourceCollectionItem defaults) {
    ...
    public static final class Builder {
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetProfileAvailableSoftwareSourcesAvailableSoftwareSourceCollectionItem", "displayName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetProfileAvailableSoftwareSourcesAvailableSoftwareSourceCollectionItem", "id");
            }
            this.id = id;
            return this;
        }
