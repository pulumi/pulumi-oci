...
@CustomType
public final class GetProfileSoftwareSource {
    /**
    ...
    private GetProfileSoftwareSource() {}
    /**
     * @return Software source description.
     * 
     */
    ...
    public static Builder builder(GetProfileSoftwareSource defaults) {
    ...
    public static final class Builder {
        ...
        private String softwareSourceType;
        public Builder() {}
        public Builder(GetProfileSoftwareSource defaults) {
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetProfileSoftwareSource", "description");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetProfileSoftwareSource", "displayName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetProfileSoftwareSource", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isMandatoryForAutonomousLinux(Boolean isMandatoryForAutonomousLinux) {
            if (isMandatoryForAutonomousLinux == null) {
              throw new MissingRequiredPropertyException("GetProfileSoftwareSource", "isMandatoryForAutonomousLinux");
            }
        ...
        public Builder softwareSourceType(String softwareSourceType) {
            if (softwareSourceType == null) {
              throw new MissingRequiredPropertyException("GetProfileSoftwareSource", "softwareSourceType");
            }
            this.softwareSourceType = softwareSourceType;
            return this;
        }
        public GetProfileSoftwareSource build() {
            final var _resultValue = new GetProfileSoftwareSource();
