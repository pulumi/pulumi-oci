...
@CustomType
public final class GetProfilesProfileCollectionItemSoftwareSource {
    /**
    ...
    private GetProfilesProfileCollectionItemSoftwareSource() {}
    /**
     * @return Software source description.
     * 
     */
    ...
    public static Builder builder(GetProfilesProfileCollectionItemSoftwareSource defaults) {
    ...
    public static final class Builder {
        ...
        private String softwareSourceType;
        public Builder() {}
        public Builder(GetProfilesProfileCollectionItemSoftwareSource defaults) {
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetProfilesProfileCollectionItemSoftwareSource", "description");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetProfilesProfileCollectionItemSoftwareSource", "displayName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetProfilesProfileCollectionItemSoftwareSource", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isMandatoryForAutonomousLinux(Boolean isMandatoryForAutonomousLinux) {
            if (isMandatoryForAutonomousLinux == null) {
              throw new MissingRequiredPropertyException("GetProfilesProfileCollectionItemSoftwareSource", "isMandatoryForAutonomousLinux");
            }
        ...
        public Builder softwareSourceType(String softwareSourceType) {
            if (softwareSourceType == null) {
              throw new MissingRequiredPropertyException("GetProfilesProfileCollectionItemSoftwareSource", "softwareSourceType");
            }
