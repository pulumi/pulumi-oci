...
@CustomType
public final class GetSoftwarePackagesSoftwarePackageCollectionItemSoftwareSource {
    /**
    ...
    private GetSoftwarePackagesSoftwarePackageCollectionItemSoftwareSource() {}
    /**
     * @return Software source description.
     * 
     */
    ...
    public static Builder builder(GetSoftwarePackagesSoftwarePackageCollectionItemSoftwareSource defaults) {
    ...
    public static final class Builder {
        ...
        private String softwareSourceType;
        public Builder() {}
        public Builder(GetSoftwarePackagesSoftwarePackageCollectionItemSoftwareSource defaults) {
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetSoftwarePackagesSoftwarePackageCollectionItemSoftwareSource", "description");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetSoftwarePackagesSoftwarePackageCollectionItemSoftwareSource", "displayName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetSoftwarePackagesSoftwarePackageCollectionItemSoftwareSource", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isMandatoryForAutonomousLinux(Boolean isMandatoryForAutonomousLinux) {
            if (isMandatoryForAutonomousLinux == null) {
              throw new MissingRequiredPropertyException("GetSoftwarePackagesSoftwarePackageCollectionItemSoftwareSource", "isMandatoryForAutonomousLinux");
            }
        ...
        public Builder softwareSourceType(String softwareSourceType) {
            if (softwareSourceType == null) {
              throw new MissingRequiredPropertyException("GetSoftwarePackagesSoftwarePackageCollectionItemSoftwareSource", "softwareSourceType");
            }
            this.softwareSourceType = softwareSourceType;
            return this;
        }
        public GetSoftwarePackagesSoftwarePackageCollectionItemSoftwareSource build() {
            final var _resultValue = new GetSoftwarePackagesSoftwarePackageCollectionItemSoftwareSource();
