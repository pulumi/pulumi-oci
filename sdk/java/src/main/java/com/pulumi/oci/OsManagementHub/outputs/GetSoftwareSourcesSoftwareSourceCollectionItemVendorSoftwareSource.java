...
public final class GetSoftwareSourcesSoftwareSourceCollectionItemVendorSoftwareSource {
    ...
    public static Builder builder(GetSoftwareSourcesSoftwareSourceCollectionItemVendorSoftwareSource defaults) {
    ...
    public static final class Builder {
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetSoftwareSourcesSoftwareSourceCollectionItemVendorSoftwareSource", "displayName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetSoftwareSourcesSoftwareSourceCollectionItemVendorSoftwareSource", "id");
            }
            this.id = id;
            return this;
        }
        public GetSoftwareSourcesSoftwareSourceCollectionItemVendorSoftwareSource build() {
            final var _resultValue = new GetSoftwareSourcesSoftwareSourceCollectionItemVendorSoftwareSource();
