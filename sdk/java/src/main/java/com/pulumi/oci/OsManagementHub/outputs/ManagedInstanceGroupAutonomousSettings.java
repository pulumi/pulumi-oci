...
@CustomType
public final class ManagedInstanceGroupAutonomousSettings {
    /**
    ...
    private ManagedInstanceGroupAutonomousSettings() {}
    /**
     * @return (Updatable) Indicates whether Autonomous Linux will collect crash files.
     * 
     */
    ...
    public static Builder builder(ManagedInstanceGroupAutonomousSettings defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String scheduledJobId;
        public Builder() {}
        public Builder(ManagedInstanceGroupAutonomousSettings defaults) {
        ...
        public ManagedInstanceGroupAutonomousSettings build() {
            final var _resultValue = new ManagedInstanceGroupAutonomousSettings();
