...
@CustomType
public final class ManagedInstanceSoftwareSource {
    /**
    ...
    private ManagedInstanceSoftwareSource() {}
    /**
     * @return (Updatable) User-specified description of the managed instance. Avoid entering confidential information.
     * 
     */
    ...
    public static Builder builder(ManagedInstanceSoftwareSource defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String softwareSourceType;
        public Builder() {}
        public Builder(ManagedInstanceSoftwareSource defaults) {
        ...
        public ManagedInstanceSoftwareSource build() {
            final var _resultValue = new ManagedInstanceSoftwareSource();
