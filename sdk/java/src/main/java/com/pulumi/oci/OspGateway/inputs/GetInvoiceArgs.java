...
public final class GetInvoiceArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetInvoiceArgs Empty = new GetInvoiceArgs();
    ...
    private GetInvoiceArgs() {}

    private GetInvoiceArgs(GetInvoiceArgs $) {
    ...
    public static Builder builder(GetInvoiceArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder(GetInvoiceArgs defaults) {
            $ = new GetInvoiceArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetInvoiceArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetInvoiceArgs", "compartmentId");
            }
            if ($.internalInvoiceId == null) {
                throw new MissingRequiredPropertyException("GetInvoiceArgs", "internalInvoiceId");
            }
            if ($.ospHomeRegion == null) {
                throw new MissingRequiredPropertyException("GetInvoiceArgs", "ospHomeRegion");
            }
            return $;
        }
    }
