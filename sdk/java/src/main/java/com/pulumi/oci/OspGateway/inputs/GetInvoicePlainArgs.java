    ...
    public static final class Builder {
        ...
        public GetInvoicePlainArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetInvoicePlainArgs", "compartmentId");
            }
            if ($.internalInvoiceId == null) {
                throw new MissingRequiredPropertyException("GetInvoicePlainArgs", "internalInvoiceId");
            }
            if ($.ospHomeRegion == null) {
                throw new MissingRequiredPropertyException("GetInvoicePlainArgs", "ospHomeRegion");
            }
            return $;
        }
    }
