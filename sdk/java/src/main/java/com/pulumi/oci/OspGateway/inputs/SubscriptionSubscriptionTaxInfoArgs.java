...
public final class SubscriptionSubscriptionTaxInfoArgs extends com.pulumi.resources.ResourceArgs {

    public static final SubscriptionSubscriptionTaxInfoArgs Empty = new SubscriptionSubscriptionTaxInfoArgs();
    ...
    private SubscriptionSubscriptionTaxInfoArgs() {}

    private SubscriptionSubscriptionTaxInfoArgs(SubscriptionSubscriptionTaxInfoArgs $) {
    ...
    public static Builder builder(SubscriptionSubscriptionTaxInfoArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new SubscriptionSubscriptionTaxInfoArgs();
        }

        public Builder(SubscriptionSubscriptionTaxInfoArgs defaults) {
            $ = new SubscriptionSubscriptionTaxInfoArgs(Objects.requireNonNull(defaults));
        }
        ...
        public SubscriptionSubscriptionTaxInfoArgs build() {
            return $;
        }
    }
