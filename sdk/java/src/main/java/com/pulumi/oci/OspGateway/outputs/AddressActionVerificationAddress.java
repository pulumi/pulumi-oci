...
@CustomType
public final class AddressActionVerificationAddress {
    /**
    ...
    public static Builder builder(AddressActionVerificationAddress defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String streetNumber;
        public Builder() {}
        public Builder(AddressActionVerificationAddress defaults) {
        ...
        public AddressActionVerificationAddress build() {
            final var _resultValue = new AddressActionVerificationAddress();
