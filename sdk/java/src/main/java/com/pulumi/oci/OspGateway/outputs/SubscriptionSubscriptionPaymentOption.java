    ...
    public static final class Builder {
        ...
        public Builder paymentMethod(String paymentMethod) {
            if (paymentMethod == null) {
              throw new MissingRequiredPropertyException("SubscriptionSubscriptionPaymentOption", "paymentMethod");
            }
        ...
        public SubscriptionSubscriptionPaymentOption build() {
            final var _resultValue = new SubscriptionSubscriptionPaymentOption();
