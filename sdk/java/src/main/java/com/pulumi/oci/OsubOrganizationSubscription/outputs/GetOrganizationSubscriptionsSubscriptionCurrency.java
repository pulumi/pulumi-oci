...
public final class GetOrganizationSubscriptionsSubscriptionCurrency {
    ...
    public static final class Builder {
        ...
        public Builder isoCode(String isoCode) {
            if (isoCode == null) {
              throw new MissingRequiredPropertyException("GetOrganizationSubscriptionsSubscriptionCurrency", "isoCode");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetOrganizationSubscriptionsSubscriptionCurrency", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder stdPrecision(String stdPrecision) {
            if (stdPrecision == null) {
              throw new MissingRequiredPropertyException("GetOrganizationSubscriptionsSubscriptionCurrency", "stdPrecision");
            }
            this.stdPrecision = stdPrecision;
            return this;
        }
        public GetOrganizationSubscriptionsSubscriptionCurrency build() {
            final var _resultValue = new GetOrganizationSubscriptionsSubscriptionCurrency();
