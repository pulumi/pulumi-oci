...
@CustomType
public final class GetComputedUsageParentProduct {
    /**
    ...
    private GetComputedUsageParentProduct() {}
    /**
     * @return Metered service billing category
     * 
     */
    ...
    public static Builder builder(GetComputedUsageParentProduct defaults) {
    ...
    public static final class Builder {
        ...
        private String unitOfMeasure;
        public Builder() {}
        public Builder(GetComputedUsageParentProduct defaults) {
        ...
        public Builder billingCategory(String billingCategory) {
            if (billingCategory == null) {
              throw new MissingRequiredPropertyException("GetComputedUsageParentProduct", "billingCategory");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetComputedUsageParentProduct", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder partNumber(String partNumber) {
            if (partNumber == null) {
              throw new MissingRequiredPropertyException("GetComputedUsageParentProduct", "partNumber");
            }
        ...
        public Builder productCategory(String productCategory) {
            if (productCategory == null) {
              throw new MissingRequiredPropertyException("GetComputedUsageParentProduct", "productCategory");
            }
        ...
        public Builder provisioningGroup(String provisioningGroup) {
            if (provisioningGroup == null) {
              throw new MissingRequiredPropertyException("GetComputedUsageParentProduct", "provisioningGroup");
            }
        ...
        public Builder ucmRateCardPartType(String ucmRateCardPartType) {
            if (ucmRateCardPartType == null) {
              throw new MissingRequiredPropertyException("GetComputedUsageParentProduct", "ucmRateCardPartType");
            }
        ...
        public Builder unitOfMeasure(String unitOfMeasure) {
            if (unitOfMeasure == null) {
              throw new MissingRequiredPropertyException("GetComputedUsageParentProduct", "unitOfMeasure");
            }
            this.unitOfMeasure = unitOfMeasure;
            return this;
        }
        public GetComputedUsageParentProduct build() {
            final var _resultValue = new GetComputedUsageParentProduct();
