...
public final class GetConfigurationDbConfigurationOverrideItem {
    ...
    public static final class Builder {
        ...
        public Builder configKey(String configKey) {
            if (configKey == null) {
              throw new MissingRequiredPropertyException("GetConfigurationDbConfigurationOverrideItem", "configKey");
            }
        ...
        public Builder overridenConfigValue(String overridenConfigValue) {
            if (overridenConfigValue == null) {
              throw new MissingRequiredPropertyException("GetConfigurationDbConfigurationOverrideItem", "overridenConfigValue");
            }
