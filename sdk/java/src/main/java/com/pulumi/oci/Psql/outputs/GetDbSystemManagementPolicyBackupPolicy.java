...
import com.pulumi.oci.Psql.outputs.GetDbSystemManagementPolicyBackupPolicyCopyPolicy;
...
public final class GetDbSystemManagementPolicyBackupPolicy {
     ...
     * 
     */
    private List<GetDbSystemManagementPolicyBackupPolicyCopyPolicy> copyPolicies;
    /**
     ...
     * 
     */
    public List<GetDbSystemManagementPolicyBackupPolicyCopyPolicy> copyPolicies() {
    ...
    public static Builder builder(GetDbSystemManagementPolicyBackupPolicy defaults) {
    ...
    public static final class Builder {
        ...
        private Integer retentionDays;
        public Builder() {}
        public Builder(GetDbSystemManagementPolicyBackupPolicy defaults) {
        ...
        @CustomType.Setter
        public Builder copyPolicies(List<GetDbSystemManagementPolicyBackupPolicyCopyPolicy> copyPolicies) {
            if (copyPolicies == null) {
              throw new MissingRequiredPropertyException("GetDbSystemManagementPolicyBackupPolicy", "copyPolicies");
            }
            this.copyPolicies = copyPolicies;
            return this;
        }
        public Builder copyPolicies(GetDbSystemManagementPolicyBackupPolicyCopyPolicy... copyPolicies) {
