    ...
    public static final class Builder {
        ...
        public Builder availabilityDomain(String availabilityDomain) {
            if (availabilityDomain == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemCollectionItemStorageDetail", "availabilityDomain");
            }
        ...
        public Builder iops(String iops) {
            if (iops == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemCollectionItemStorageDetail", "iops");
            }
            this.iops = iops;
            return this;
        }
        ...
        public Builder isRegionallyDurable(Boolean isRegionallyDurable) {
            if (isRegionallyDurable == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemCollectionItemStorageDetail", "isRegionallyDurable");
            }
        ...
        public Builder kmsKeyId(String kmsKeyId) {
            if (kmsKeyId == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemCollectionItemStorageDetail", "kmsKeyId");
            }
        ...
        public Builder systemType(String systemType) {
            if (systemType == null) {
              throw new MissingRequiredPropertyException("GetDbSystemsDbSystemCollectionItemStorageDetail", "systemType");
            }
