...
public final class GetShapesFilter {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetShapesFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetShapesFilter", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetShapesFilter build() {
            final var _resultValue = new GetShapesFilter();
