...
public final class GetProtectionPoliciesProtectionPolicyCollection {
    ...
    public static final class Builder {
        ...
        public Builder items(List<GetProtectionPoliciesProtectionPolicyCollectionItem> items) {
            if (items == null) {
              throw new MissingRequiredPropertyException("GetProtectionPoliciesProtectionPolicyCollection", "items");
            }
            this.items = items;
            return this;
        }
        ...
        public GetProtectionPoliciesProtectionPolicyCollection build() {
            final var _resultValue = new GetProtectionPoliciesProtectionPolicyCollection();
