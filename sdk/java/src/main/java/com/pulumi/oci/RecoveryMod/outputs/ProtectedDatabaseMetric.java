...
@CustomType
public final class ProtectedDatabaseMetric {
    /**
    ...
    public static Builder builder(ProtectedDatabaseMetric defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable Double unprotectedWindowInSeconds;
        public Builder() {}
        public Builder(ProtectedDatabaseMetric defaults) {
