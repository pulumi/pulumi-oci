...
public final class GetRedisClustersRedisClusterCollectionItemNodeCollectionItem {
    ...
    public static final class Builder {
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetRedisClustersRedisClusterCollectionItemNodeCollectionItem", "displayName");
            }
        ...
        public Builder privateEndpointFqdn(String privateEndpointFqdn) {
            if (privateEndpointFqdn == null) {
              throw new MissingRequiredPropertyException("GetRedisClustersRedisClusterCollectionItemNodeCollectionItem", "privateEndpointFqdn");
            }
        ...
        public Builder privateEndpointIpAddress(String privateEndpointIpAddress) {
            if (privateEndpointIpAddress == null) {
              throw new MissingRequiredPropertyException("GetRedisClustersRedisClusterCollectionItemNodeCollectionItem", "privateEndpointIpAddress");
            }
