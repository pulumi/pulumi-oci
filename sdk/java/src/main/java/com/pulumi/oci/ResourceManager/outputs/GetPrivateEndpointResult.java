...
public final class GetPrivateEndpointResult {
    ...
    public static final class Builder {
        ...
        public Builder vcnId(String vcnId) {
            ...
            return new GetPrivateEndpointResult(compartmentId, definedTags, description, displayName, dnsZones, freeformTags, id, isUsedWithConfigurationSourceProvider, nsgIdLists, privateEndpointId, sourceIps, state, subnetId, timeCreated, vcnId);
        }
    }
}
