...
public final class ConnectorTaskPrivateEndpointMetadataArgs extends com.pulumi.resources.ResourceArgs {

    public static final ConnectorTaskPrivateEndpointMetadataArgs Empty = new ConnectorTaskPrivateEndpointMetadataArgs();
    ...
    private ConnectorTaskPrivateEndpointMetadataArgs() {}

    private ConnectorTaskPrivateEndpointMetadataArgs(ConnectorTaskPrivateEndpointMetadataArgs $) {
    ...
    public static Builder builder(ConnectorTaskPrivateEndpointMetadataArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new ConnectorTaskPrivateEndpointMetadataArgs();
        }

        public Builder(ConnectorTaskPrivateEndpointMetadataArgs defaults) {
            $ = new ConnectorTaskPrivateEndpointMetadataArgs(Objects.requireNonNull(defaults));
        }
        ...
        public ConnectorTaskPrivateEndpointMetadataArgs build() {
            return $;
        }
    }
