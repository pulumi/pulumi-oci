...
public final class GetServiceConnectorsFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetServiceConnectorsFilter Empty = new GetServiceConnectorsFilter();
    ...
    private GetServiceConnectorsFilter(GetServiceConnectorsFilter $) {
        this.name = $.name;
        this.regex = $.regex;
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetServiceConnectorsFilter();
        }

        public Builder(GetServiceConnectorsFilter defaults) {
            $ = new GetServiceConnectorsFilter(Objects.requireNonNull(defaults));
        }
        ...
        public GetServiceConnectorsFilter build() {
            if ($.name == null) {
                throw new MissingRequiredPropertyException("GetServiceConnectorsFilter", "name");
            }
            if ($.values == null) {
                throw new MissingRequiredPropertyException("GetServiceConnectorsFilter", "values");
            }
            return $;
        }
    }
