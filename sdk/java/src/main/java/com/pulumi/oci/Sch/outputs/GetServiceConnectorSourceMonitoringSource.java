    ...
    public static final class Builder {
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetServiceConnectorSourceMonitoringSource", "compartmentId");
            }
        ...
        public Builder namespaceDetails(List<GetServiceConnectorSourceMonitoringSourceNamespaceDetail> namespaceDetails) {
            if (namespaceDetails == null) {
              throw new MissingRequiredPropertyException("GetServiceConnectorSourceMonitoringSource", "namespaceDetails");
            }
        ...
        public GetServiceConnectorSourceMonitoringSource build() {
            final var _resultValue = new GetServiceConnectorSourceMonitoringSource();
