...
public final class GetSecurityAttributesFilter extends com.pulumi.resources.InvokeArgs {

    public static final GetSecurityAttributesFilter Empty = new GetSecurityAttributesFilter();
    ...
    private GetSecurityAttributesFilter(GetSecurityAttributesFilter $) {
        this.name = $.name;
        this.regex = $.regex;
        this.values = $.values;
    }
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSecurityAttributesFilter();
        }

        public Builder(GetSecurityAttributesFilter defaults) {
            $ = new GetSecurityAttributesFilter(Objects.requireNonNull(defaults));
        }
