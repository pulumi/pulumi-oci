...
public final class GetPrivateApplicationsPrivateApplicationCollectionItemPackageDetail {
    ...
    public static final class Builder {
        ...
        public Builder packageType(String packageType) {
            if (packageType == null) {
              throw new MissingRequiredPropertyException("GetPrivateApplicationsPrivateApplicationCollectionItemPackageDetail", "packageType");
            }
        ...
        public Builder version(String version) {
            if (version == null) {
              throw new MissingRequiredPropertyException("GetPrivateApplicationsPrivateApplicationCollectionItemPackageDetail", "version");
            }
        ...
        public Builder zipFileBase64encoded(String zipFileBase64encoded) {
            if (zipFileBase64encoded == null) {
              throw new MissingRequiredPropertyException("GetPrivateApplicationsPrivateApplicationCollectionItemPackageDetail", "zipFileBase64encoded");
            }
