...
public final class GetServiceCatalogsServiceCatalogCollection {
    private @Nullable List<GetServiceCatalogsServiceCatalogCollectionItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetServiceCatalogsServiceCatalogCollectionItem> items) {
            this.items = items;
            return this;
        }
