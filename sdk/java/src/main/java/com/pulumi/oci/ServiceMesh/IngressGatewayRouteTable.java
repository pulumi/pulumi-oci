...
public class IngressGatewayRouteTable extends com.pulumi.resources.CustomResource {
     ...
     */
    public IngressGatewayRouteTable(java.lang.String name) {
     ...
     */
    public IngressGatewayRouteTable(java.lang.String name, IngressGatewayRouteTableArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public IngressGatewayRouteTable(java.lang.String name, IngressGatewayRouteTableArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:ServiceMesh/ingressGatewayRouteTable:IngressGatewayRouteTable", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private IngressGatewayRouteTable(java.lang.String name, Output<java.lang.String> id, @Nullable IngressGatewayRouteTableState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:ServiceMesh/ingressGatewayRouteTable:IngressGatewayRouteTable", name, state, makeResourceOptions(options, id), false);
    }

    private static IngressGatewayRouteTableArgs makeArgs(IngressGatewayRouteTableArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? IngressGatewayRouteTableArgs.Empty : args;
    }
     ...
     */
    public static IngressGatewayRouteTable get(java.lang.String name, Output<java.lang.String> id, @Nullable IngressGatewayRouteTableState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
