...
public class Mesh extends com.pulumi.resources.CustomResource {
     ...
     */
    public Mesh(java.lang.String name, MeshArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public Mesh(java.lang.String name, MeshArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:ServiceMesh/mesh:Mesh", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }
    ...
    private Mesh(java.lang.String name, Output<java.lang.String> id, @Nullable MeshState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:ServiceMesh/mesh:Mesh", name, state, makeResourceOptions(options, id), false);
    }

    private static MeshArgs makeArgs(MeshArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
