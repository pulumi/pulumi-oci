...
public class VirtualDeployment extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ VirtualDeploymentAccessLogging> accessLogging;

    /**
     * @return (Updatable) This configuration determines if logging is enabled and where the logs will be output.
     * 
     */
    public Output<Optional<VirtualDeploymentAccessLogging>> accessLogging() {
    ...
    private Output</* @Nullable */ List<VirtualDeploymentListener>> listeners;

    /**
     * @return (Updatable) The listeners for the virtual deployment.
     * 
     */
    public Output<Optional<List<VirtualDeploymentListener>>> listeners() {
    ...
    private Output</* @Nullable */ VirtualDeploymentServiceDiscovery> serviceDiscovery;

    /**
     * @return (Updatable) Service Discovery configuration for virtual deployments.
     * 
     */
    public Output<Optional<VirtualDeploymentServiceDiscovery>> serviceDiscovery() {
