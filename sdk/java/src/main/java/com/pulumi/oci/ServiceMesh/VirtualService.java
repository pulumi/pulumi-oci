...
public class VirtualService extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ VirtualServiceDefaultRoutingPolicy> defaultRoutingPolicy;

    /**
     * @return (Updatable) Routing policy for the virtual service.
     * 
     */
    public Output<Optional<VirtualServiceDefaultRoutingPolicy>> defaultRoutingPolicy() {
        return Codegen.optional(this.defaultRoutingPolicy);
    }
    /**
    ...
    private Output</* @Nullable */ VirtualServiceMtls> mtls;
     ...
     * 
     */
    public Output<Optional<VirtualServiceMtls>> mtls() {
