...
import com.pulumi.oci.ServiceMesh.inputs.GetIngressGatewaysFilter;
...
public final class GetIngressGatewaysPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetIngressGatewaysPlainArgs Empty = new GetIngressGatewaysPlainArgs();
    ...
    public Optional<List<GetIngressGatewaysFilter>> filters() {
    ...
    private GetIngressGatewaysPlainArgs() {}

    private GetIngressGatewaysPlainArgs(GetIngressGatewaysPlainArgs $) {
    ...
    public static Builder builder(GetIngressGatewaysPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetIngressGatewaysPlainArgs();
        }

        public Builder(GetIngressGatewaysPlainArgs defaults) {
            $ = new GetIngressGatewaysPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetIngressGatewaysPlainArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetIngressGatewaysPlainArgs", "compartmentId");
            }
            return $;
        }
    }
