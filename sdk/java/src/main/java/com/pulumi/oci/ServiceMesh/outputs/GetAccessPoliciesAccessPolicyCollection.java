...
public final class GetAccessPoliciesAccessPolicyCollection {
    ...
    public static final class Builder {
        ...
        public Builder items(List<GetAccessPoliciesAccessPolicyCollectionItem> items) {
            if (items == null) {
              throw new MissingRequiredPropertyException("GetAccessPoliciesAccessPolicyCollection", "items");
            }
            this.items = items;
            return this;
        }
        ...
        public GetAccessPoliciesAccessPolicyCollection build() {
            final var _resultValue = new GetAccessPoliciesAccessPolicyCollection();
