...
public final class GetAccessPoliciesAccessPolicyCollectionItemRuleSource {
    ...
    public static final class Builder {
        ...
        public Builder hostnames(List<String> hostnames) {
            if (hostnames == null) {
              throw new MissingRequiredPropertyException("GetAccessPoliciesAccessPolicyCollectionItemRuleSource", "hostnames");
            }
        ...
        public Builder ingressGatewayId(String ingressGatewayId) {
            if (ingressGatewayId == null) {
              throw new MissingRequiredPropertyException("GetAccessPoliciesAccessPolicyCollectionItemRuleSource", "ingressGatewayId");
            }
        ...
        public Builder ipAddresses(List<String> ipAddresses) {
            if (ipAddresses == null) {
              throw new MissingRequiredPropertyException("GetAccessPoliciesAccessPolicyCollectionItemRuleSource", "ipAddresses");
            }
        ...
        public Builder ports(List<Integer> ports) {
            if (ports == null) {
              throw new MissingRequiredPropertyException("GetAccessPoliciesAccessPolicyCollectionItemRuleSource", "ports");
            }
            this.ports = ports;
            return this;
        }
        ...
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("GetAccessPoliciesAccessPolicyCollectionItemRuleSource", "protocol");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetAccessPoliciesAccessPolicyCollectionItemRuleSource", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder virtualServiceId(String virtualServiceId) {
            if (virtualServiceId == null) {
              throw new MissingRequiredPropertyException("GetAccessPoliciesAccessPolicyCollectionItemRuleSource", "virtualServiceId");
            }
