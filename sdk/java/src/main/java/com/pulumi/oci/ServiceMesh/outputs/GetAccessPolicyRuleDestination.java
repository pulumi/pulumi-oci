...
public final class GetAccessPolicyRuleDestination {
    ...
    public static final class Builder {
        ...
        public Builder hostnames(List<String> hostnames) {
            if (hostnames == null) {
              throw new MissingRequiredPropertyException("GetAccessPolicyRuleDestination", "hostnames");
            }
        ...
        public Builder ingressGatewayId(String ingressGatewayId) {
            if (ingressGatewayId == null) {
              throw new MissingRequiredPropertyException("GetAccessPolicyRuleDestination", "ingressGatewayId");
            }
        ...
        public Builder ipAddresses(List<String> ipAddresses) {
            if (ipAddresses == null) {
              throw new MissingRequiredPropertyException("GetAccessPolicyRuleDestination", "ipAddresses");
            }
        ...
        public Builder ports(List<Integer> ports) {
            if (ports == null) {
              throw new MissingRequiredPropertyException("GetAccessPolicyRuleDestination", "ports");
            }
            this.ports = ports;
            return this;
        }
        ...
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("GetAccessPolicyRuleDestination", "protocol");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetAccessPolicyRuleDestination", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder virtualServiceId(String virtualServiceId) {
            if (virtualServiceId == null) {
              throw new MissingRequiredPropertyException("GetAccessPolicyRuleDestination", "virtualServiceId");
            }
            this.virtualServiceId = virtualServiceId;
            return this;
        }
        public GetAccessPolicyRuleDestination build() {
            final var _resultValue = new GetAccessPolicyRuleDestination();
