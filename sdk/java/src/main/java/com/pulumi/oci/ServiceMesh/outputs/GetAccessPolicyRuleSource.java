...
public final class GetAccessPolicyRuleSource {
    ...
    public static final class Builder {
        ...
        public Builder hostnames(List<String> hostnames) {
            if (hostnames == null) {
              throw new MissingRequiredPropertyException("GetAccessPolicyRuleSource", "hostnames");
            }
        ...
        public Builder ingressGatewayId(String ingressGatewayId) {
            if (ingressGatewayId == null) {
              throw new MissingRequiredPropertyException("GetAccessPolicyRuleSource", "ingressGatewayId");
            }
        ...
        public Builder ipAddresses(List<String> ipAddresses) {
            if (ipAddresses == null) {
              throw new MissingRequiredPropertyException("GetAccessPolicyRuleSource", "ipAddresses");
            }
        ...
        public Builder ports(List<Integer> ports) {
            if (ports == null) {
              throw new MissingRequiredPropertyException("GetAccessPolicyRuleSource", "ports");
            }
            this.ports = ports;
            return this;
        }
        ...
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("GetAccessPolicyRuleSource", "protocol");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetAccessPolicyRuleSource", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder virtualServiceId(String virtualServiceId) {
            if (virtualServiceId == null) {
              throw new MissingRequiredPropertyException("GetAccessPolicyRuleSource", "virtualServiceId");
            }
            this.virtualServiceId = virtualServiceId;
            return this;
        }
        public GetAccessPolicyRuleSource build() {
            final var _resultValue = new GetAccessPolicyRuleSource();
