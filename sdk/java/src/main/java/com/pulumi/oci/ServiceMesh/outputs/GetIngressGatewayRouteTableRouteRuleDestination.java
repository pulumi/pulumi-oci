...
public final class GetIngressGatewayRouteTableRouteRuleDestination {
    ...
    public static final class Builder {
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetIngressGatewayRouteTableRouteRuleDestination", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder virtualServiceId(String virtualServiceId) {
            if (virtualServiceId == null) {
              throw new MissingRequiredPropertyException("GetIngressGatewayRouteTableRouteRuleDestination", "virtualServiceId");
            }
        ...
        public Builder weight(Integer weight) {
            if (weight == null) {
              throw new MissingRequiredPropertyException("GetIngressGatewayRouteTableRouteRuleDestination", "weight");
            }
            this.weight = weight;
            return this;
        }
        public GetIngressGatewayRouteTableRouteRuleDestination build() {
            final var _resultValue = new GetIngressGatewayRouteTableRouteRuleDestination();
