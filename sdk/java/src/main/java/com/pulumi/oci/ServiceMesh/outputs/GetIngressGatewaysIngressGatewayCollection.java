...
public final class GetIngressGatewaysIngressGatewayCollection {
    private @Nullable List<GetIngressGatewaysIngressGatewayCollectionItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetIngressGatewaysIngressGatewayCollectionItem> items) {
            this.items = items;
            return this;
        }
