    ...
    public static final class Builder {
        ...
        public Builder idleTimeoutInMs(String idleTimeoutInMs) {
            if (idleTimeoutInMs == null) {
              throw new MissingRequiredPropertyException("GetVirtualDeploymentsVirtualDeploymentCollectionItemListener", "idleTimeoutInMs");
            }
        ...
        public Builder port(Integer port) {
            if (port == null) {
              throw new MissingRequiredPropertyException("GetVirtualDeploymentsVirtualDeploymentCollectionItemListener", "port");
            }
            this.port = port;
            return this;
        }
        ...
        public Builder protocol(String protocol) {
            if (protocol == null) {
              throw new MissingRequiredPropertyException("GetVirtualDeploymentsVirtualDeploymentCollectionItemListener", "protocol");
            }
        ...
        public Builder requestTimeoutInMs(String requestTimeoutInMs) {
            if (requestTimeoutInMs == null) {
              throw new MissingRequiredPropertyException("GetVirtualDeploymentsVirtualDeploymentCollectionItemListener", "requestTimeoutInMs");
            }
