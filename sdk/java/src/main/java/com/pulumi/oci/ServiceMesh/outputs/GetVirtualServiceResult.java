    ...
    public static final class Builder {
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetVirtualServiceResult", "compartmentId");
            }
        ...
        public Builder defaultRoutingPolicies(List<GetVirtualServiceDefaultRoutingPolicy> defaultRoutingPolicies) {
            if (defaultRoutingPolicies == null) {
              throw new MissingRequiredPropertyException("GetVirtualServiceResult", "defaultRoutingPolicies");
            }
        ...
        public Builder definedTags(Map<String,Object> definedTags) {
            if (definedTags == null) {
              throw new MissingRequiredPropertyException("GetVirtualServiceResult", "definedTags");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetVirtualServiceResult", "description");
            }
        ...
        public Builder freeformTags(Map<String,Object> freeformTags) {
            if (freeformTags == null) {
              throw new MissingRequiredPropertyException("GetVirtualServiceResult", "freeformTags");
            }
        ...
        public Builder hosts(List<String> hosts) {
            if (hosts == null) {
              throw new MissingRequiredPropertyException("GetVirtualServiceResult", "hosts");
            }
            this.hosts = hosts;
            return this;
        }
        ...
        public Builder lifecycleDetails(String lifecycleDetails) {
            if (lifecycleDetails == null) {
              throw new MissingRequiredPropertyException("GetVirtualServiceResult", "lifecycleDetails");
            }
        ...
        public Builder meshId(String meshId) {
            if (meshId == null) {
              throw new MissingRequiredPropertyException("GetVirtualServiceResult", "meshId");
            }
            this.meshId = meshId;
            return this;
        }
        ...
        public Builder mtls(List<GetVirtualServiceMtl> mtls) {
            if (mtls == null) {
              throw new MissingRequiredPropertyException("GetVirtualServiceResult", "mtls");
            }
            this.mtls = mtls;
            return this;
        }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetVirtualServiceResult", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder systemTags(Map<String,Object> systemTags) {
            if (systemTags == null) {
              throw new MissingRequiredPropertyException("GetVirtualServiceResult", "systemTags");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetVirtualServiceResult", "timeCreated");
            }
        ...
        public Builder timeUpdated(String timeUpdated) {
            if (timeUpdated == null) {
              throw new MissingRequiredPropertyException("GetVirtualServiceResult", "timeUpdated");
            }
        ...
        public Builder virtualServiceId(String virtualServiceId) {
            if (virtualServiceId == null) {
              throw new MissingRequiredPropertyException("GetVirtualServiceResult", "virtualServiceId");
            }
