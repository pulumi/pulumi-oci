...
public final class GetVirtualServicesVirtualServiceCollectionItemDefaultRoutingPolicy {
    ...
    public static final class Builder {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetVirtualServicesVirtualServiceCollectionItemDefaultRoutingPolicy", "type");
            }
            this.type = type;
            return this;
        }
        public GetVirtualServicesVirtualServiceCollectionItemDefaultRoutingPolicy build() {
            final var _resultValue = new GetVirtualServicesVirtualServiceCollectionItemDefaultRoutingPolicy();
