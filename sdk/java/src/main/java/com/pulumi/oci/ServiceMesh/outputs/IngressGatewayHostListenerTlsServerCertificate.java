...
public final class IngressGatewayHostListenerTlsServerCertificate {
    ...
    public static final class Builder {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("IngressGatewayHostListenerTlsServerCertificate", "type");
            }
            this.type = type;
            return this;
        }
        public IngressGatewayHostListenerTlsServerCertificate build() {
            final var _resultValue = new IngressGatewayHostListenerTlsServerCertificate();
