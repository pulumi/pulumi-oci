 ...
 *                 .consolePathPrefix(var_.monitored_resource_task_task_details_console_path_prefix())
 *                 .externalIdMapping(var_.monitored_resource_task_task_details_external_id_mapping())
 *                 .lifecycleStatusMappingsForUpStatuses(var_.monitored_resource_task_task_details_lifecycle_status_mappings_for_up_status())
 *                 .resourceGroup(var_.monitored_resource_task_task_details_resource_group())
 *                 .resourceNameFilter(var_.monitored_resource_task_task_details_resource_name_filter())
 *                 .resourceNameMapping(var_.monitored_resource_task_task_details_resource_name_mapping())
 *                 .resourceTypeFilter(var_.monitored_resource_task_task_details_resource_type_filter())
 *                 .resourceTypeMapping(var_.monitored_resource_task_task_details_resource_type_mapping())
 *                 .serviceBaseUrl(var_.monitored_resource_task_task_details_service_base_url())
 *                 .shouldUseMetricsFlowForStatus(var_.monitored_resource_task_task_details_should_use_metrics_flow_for_status())
 *                 .build())
