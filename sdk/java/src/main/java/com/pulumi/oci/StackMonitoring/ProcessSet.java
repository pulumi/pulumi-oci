 ...
 *                     .label(var_.process_set_specification_items_label())
 *                     .processCommand(var_.process_set_specification_items_process_command())
 *                     .processLineRegexPattern(var_.process_set_specification_items_process_line_regex_pattern())
 *                     .processUser(var_.process_set_specification_items_process_user())
 *                     .build())
 *                 .build())
