...
public final class MonitoredResourceTypeHandlerConfigMetricMappingArgs extends com.pulumi.resources.ResourceArgs {

    public static final MonitoredResourceTypeHandlerConfigMetricMappingArgs Empty = new MonitoredResourceTypeHandlerConfigMetricMappingArgs();
    ...
    private MonitoredResourceTypeHandlerConfigMetricMappingArgs() {}

    private MonitoredResourceTypeHandlerConfigMetricMappingArgs(MonitoredResourceTypeHandlerConfigMetricMappingArgs $) {
    ...
    public static Builder builder(MonitoredResourceTypeHandlerConfigMetricMappingArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MonitoredResourceTypeHandlerConfigMetricMappingArgs();
        }

        public Builder(MonitoredResourceTypeHandlerConfigMetricMappingArgs defaults) {
            $ = new MonitoredResourceTypeHandlerConfigMetricMappingArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MonitoredResourceTypeHandlerConfigMetricMappingArgs build() {
            return $;
        }
    }
