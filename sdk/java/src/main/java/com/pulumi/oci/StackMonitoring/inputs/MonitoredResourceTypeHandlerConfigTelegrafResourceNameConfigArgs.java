...
public final class MonitoredResourceTypeHandlerConfigTelegrafResourceNameConfigArgs extends com.pulumi.resources.ResourceArgs {

    public static final MonitoredResourceTypeHandlerConfigTelegrafResourceNameConfigArgs Empty = new MonitoredResourceTypeHandlerConfigTelegrafResourceNameConfigArgs();
    ...
    private MonitoredResourceTypeHandlerConfigTelegrafResourceNameConfigArgs() {}

    private MonitoredResourceTypeHandlerConfigTelegrafResourceNameConfigArgs(MonitoredResourceTypeHandlerConfigTelegrafResourceNameConfigArgs $) {
    ...
    public static Builder builder(MonitoredResourceTypeHandlerConfigTelegrafResourceNameConfigArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new MonitoredResourceTypeHandlerConfigTelegrafResourceNameConfigArgs();
        }

        public Builder(MonitoredResourceTypeHandlerConfigTelegrafResourceNameConfigArgs defaults) {
            $ = new MonitoredResourceTypeHandlerConfigTelegrafResourceNameConfigArgs(Objects.requireNonNull(defaults));
        }
        ...
        public MonitoredResourceTypeHandlerConfigTelegrafResourceNameConfigArgs build() {
            return $;
        }
    }
