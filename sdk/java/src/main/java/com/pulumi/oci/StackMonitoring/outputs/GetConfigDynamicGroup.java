...
@CustomType
public final class GetConfigDynamicGroup {
    /**
    ...
    public static Builder builder(GetConfigDynamicGroup defaults) {
    ...
    public static final class Builder {
        ...
        private String stackMonitoringAssignment;
        public Builder() {}
        public Builder(GetConfigDynamicGroup defaults) {
        ...
        public Builder domain(String domain) {
            if (domain == null) {
              throw new MissingRequiredPropertyException("GetConfigDynamicGroup", "domain");
            }
            this.domain = domain;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetConfigDynamicGroup", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder stackMonitoringAssignment(String stackMonitoringAssignment) {
            if (stackMonitoringAssignment == null) {
              throw new MissingRequiredPropertyException("GetConfigDynamicGroup", "stackMonitoringAssignment");
            }
            this.stackMonitoringAssignment = stackMonitoringAssignment;
            return this;
        }
        public GetConfigDynamicGroup build() {
            final var _resultValue = new GetConfigDynamicGroup();
