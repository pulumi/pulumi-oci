...
public final class GetDefinedMonitoringTemplatesDefinedMonitoringTemplateCollectionItemDefinedAlarmConditionCondition {
    ...
    private GetDefinedMonitoringTemplatesDefinedMonitoringTemplateCollectionItemDefinedAlarmConditionCondition() {}
    /**
     * @return The human-readable content of the delivered alarm notification. Oracle recommends providing guidance to operators for resolving the alarm condition. Consider adding links to standard runbook practices. Avoid entering confidential information.
     * 
     */
    ...
    public static Builder builder(GetDefinedMonitoringTemplatesDefinedMonitoringTemplateCollectionItemDefinedAlarmConditionCondition defaults) {
    ...
    public static final class Builder {
        ...
        private String triggerDelay;
        public Builder() {}
        public Builder(GetDefinedMonitoringTemplatesDefinedMonitoringTemplateCollectionItemDefinedAlarmConditionCondition defaults) {
        ...
        public Builder body(String body) {
            if (body == null) {
              throw new MissingRequiredPropertyException("GetDefinedMonitoringTemplatesDefinedMonitoringTemplateCollectionItemDefinedAlarmConditionCondition", "body");
            }
            this.body = body;
            return this;
        }
        ...
        public Builder query(String query) {
            if (query == null) {
              throw new MissingRequiredPropertyException("GetDefinedMonitoringTemplatesDefinedMonitoringTemplateCollectionItemDefinedAlarmConditionCondition", "query");
            }
            this.query = query;
            return this;
        }
        ...
        public Builder severity(String severity) {
            if (severity == null) {
              throw new MissingRequiredPropertyException("GetDefinedMonitoringTemplatesDefinedMonitoringTemplateCollectionItemDefinedAlarmConditionCondition", "severity");
            }
        ...
        public Builder shouldAppendNote(Boolean shouldAppendNote) {
            if (shouldAppendNote == null) {
              throw new MissingRequiredPropertyException("GetDefinedMonitoringTemplatesDefinedMonitoringTemplateCollectionItemDefinedAlarmConditionCondition", "shouldAppendNote");
            }
        ...
        public Builder shouldAppendUrl(Boolean shouldAppendUrl) {
            if (shouldAppendUrl == null) {
              throw new MissingRequiredPropertyException("GetDefinedMonitoringTemplatesDefinedMonitoringTemplateCollectionItemDefinedAlarmConditionCondition", "shouldAppendUrl");
            }
        ...
        public Builder triggerDelay(String triggerDelay) {
            if (triggerDelay == null) {
              throw new MissingRequiredPropertyException("GetDefinedMonitoringTemplatesDefinedMonitoringTemplateCollectionItemDefinedAlarmConditionCondition", "triggerDelay");
            }
            this.triggerDelay = triggerDelay;
            return this;
        }
        public GetDefinedMonitoringTemplatesDefinedMonitoringTemplateCollectionItemDefinedAlarmConditionCondition build() {
            final var _resultValue = new GetDefinedMonitoringTemplatesDefinedMonitoringTemplateCollectionItemDefinedAlarmConditionCondition();
