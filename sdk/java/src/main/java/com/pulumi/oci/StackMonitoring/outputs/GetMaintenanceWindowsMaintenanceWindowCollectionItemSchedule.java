...
@CustomType
public final class GetMaintenanceWindowsMaintenanceWindowCollectionItemSchedule {
    /**
    ...
    private GetMaintenanceWindowsMaintenanceWindowCollectionItemSchedule() {}
    /**
     * @return Duration time of each recurrence of each Maintenance Window. It must be specified as a string in ISO 8601 extended format.
     * 
     */
    ...
    public static Builder builder(GetMaintenanceWindowsMaintenanceWindowCollectionItemSchedule defaults) {
    ...
    public static final class Builder {
        ...
        private String timeMaintenanceWindowStart;
        public Builder() {}
        public Builder(GetMaintenanceWindowsMaintenanceWindowCollectionItemSchedule defaults) {
        ...
        public Builder maintenanceWindowDuration(String maintenanceWindowDuration) {
            if (maintenanceWindowDuration == null) {
              throw new MissingRequiredPropertyException("GetMaintenanceWindowsMaintenanceWindowCollectionItemSchedule", "maintenanceWindowDuration");
            }
        ...
        public Builder maintenanceWindowRecurrences(String maintenanceWindowRecurrences) {
            if (maintenanceWindowRecurrences == null) {
              throw new MissingRequiredPropertyException("GetMaintenanceWindowsMaintenanceWindowCollectionItemSchedule", "maintenanceWindowRecurrences");
            }
        ...
        public Builder scheduleType(String scheduleType) {
            if (scheduleType == null) {
              throw new MissingRequiredPropertyException("GetMaintenanceWindowsMaintenanceWindowCollectionItemSchedule", "scheduleType");
            }
        ...
        public Builder timeMaintenanceWindowEnd(String timeMaintenanceWindowEnd) {
            if (timeMaintenanceWindowEnd == null) {
              throw new MissingRequiredPropertyException("GetMaintenanceWindowsMaintenanceWindowCollectionItemSchedule", "timeMaintenanceWindowEnd");
            }
        ...
        public Builder timeMaintenanceWindowStart(String timeMaintenanceWindowStart) {
            if (timeMaintenanceWindowStart == null) {
              throw new MissingRequiredPropertyException("GetMaintenanceWindowsMaintenanceWindowCollectionItemSchedule", "timeMaintenanceWindowStart");
            }
            this.timeMaintenanceWindowStart = timeMaintenanceWindowStart;
            return this;
        }
        public GetMaintenanceWindowsMaintenanceWindowCollectionItemSchedule build() {
            final var _resultValue = new GetMaintenanceWindowsMaintenanceWindowCollectionItemSchedule();
