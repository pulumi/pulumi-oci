    ...
    public static final class Builder {
        ...
        public Builder outParamPosition(Integer outParamPosition) {
            if (outParamPosition == null) {
              throw new MissingRequiredPropertyException("GetMetricExtensionQueryPropertyOutParamDetail", "outParamPosition");
            }
        ...
        public Builder outParamType(String outParamType) {
            if (outParamType == null) {
              throw new MissingRequiredPropertyException("GetMetricExtensionQueryPropertyOutParamDetail", "outParamType");
            }
