    ...
    public static final class Builder {
        ...
        public Builder credentialType(String credentialType) {
            if (credentialType == null) {
              throw new MissingRequiredPropertyException("GetMonitoredResourceCredential", "credentialType");
            }
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetMonitoredResourceCredential", "description");
            }
        ...
        public Builder keyId(String keyId) {
            if (keyId == null) {
              throw new MissingRequiredPropertyException("GetMonitoredResourceCredential", "keyId");
            }
            this.keyId = keyId;
            return this;
        }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetMonitoredResourceCredential", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder properties(List<GetMonitoredResourceCredentialProperty> properties) {
            if (properties == null) {
              throw new MissingRequiredPropertyException("GetMonitoredResourceCredential", "properties");
            }
        ...
        public Builder source(String source) {
            if (source == null) {
              throw new MissingRequiredPropertyException("GetMonitoredResourceCredential", "source");
            }
            this.source = source;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetMonitoredResourceCredential", "type");
            }
            this.type = type;
            return this;
        }
        public GetMonitoredResourceCredential build() {
            final var _resultValue = new GetMonitoredResourceCredential();
