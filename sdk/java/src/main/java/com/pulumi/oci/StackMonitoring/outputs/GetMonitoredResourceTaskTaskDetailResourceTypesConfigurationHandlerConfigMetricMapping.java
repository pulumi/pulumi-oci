...
@CustomType
public final class GetMonitoredResourceTaskTaskDetailResourceTypesConfigurationHandlerConfigMetricMapping {
    /**
    ...
    private GetMonitoredResourceTaskTaskDetailResourceTypesConfigurationHandlerConfigMetricMapping() {}
    /**
     * @return Metric name as defined by the collector.
     * 
     */
    ...
    public static Builder builder(GetMonitoredResourceTaskTaskDetailResourceTypesConfigurationHandlerConfigMetricMapping defaults) {
    ...
    public static final class Builder {
        ...
        private String telemetryMetricName;
        public Builder() {}
        public Builder(GetMonitoredResourceTaskTaskDetailResourceTypesConfigurationHandlerConfigMetricMapping defaults) {
        ...
        public Builder collectorMetricName(String collectorMetricName) {
            if (collectorMetricName == null) {
              throw new MissingRequiredPropertyException("GetMonitoredResourceTaskTaskDetailResourceTypesConfigurationHandlerConfigMetricMapping", "collectorMetricName");
            }
        ...
        public Builder isSkipUpload(Boolean isSkipUpload) {
            if (isSkipUpload == null) {
              throw new MissingRequiredPropertyException("GetMonitoredResourceTaskTaskDetailResourceTypesConfigurationHandlerConfigMetricMapping", "isSkipUpload");
            }
        ...
        public Builder metricUploadIntervalInSeconds(Integer metricUploadIntervalInSeconds) {
            if (metricUploadIntervalInSeconds == null) {
              throw new MissingRequiredPropertyException("GetMonitoredResourceTaskTaskDetailResourceTypesConfigurationHandlerConfigMetricMapping", "metricUploadIntervalInSeconds");
            }
        ...
        public Builder telemetryMetricName(String telemetryMetricName) {
            if (telemetryMetricName == null) {
              throw new MissingRequiredPropertyException("GetMonitoredResourceTaskTaskDetailResourceTypesConfigurationHandlerConfigMetricMapping", "telemetryMetricName");
            }
            this.telemetryMetricName = telemetryMetricName;
            return this;
        }
        public GetMonitoredResourceTaskTaskDetailResourceTypesConfigurationHandlerConfigMetricMapping build() {
            final var _resultValue = new GetMonitoredResourceTaskTaskDetailResourceTypesConfigurationHandlerConfigMetricMapping();
