...
@CustomType
public final class GetMonitoredResourceTasksMonitoredResourceTasksCollectionItemTaskDetailResourceTypesConfigurationHandlerConfigMetricMapping {
    /**
    ...
    private GetMonitoredResourceTasksMonitoredResourceTasksCollectionItemTaskDetailResourceTypesConfigurationHandlerConfigMetricMapping() {}
    /**
     * @return Metric name as defined by the collector.
     * 
     */
    ...
    public static Builder builder(GetMonitoredResourceTasksMonitoredResourceTasksCollectionItemTaskDetailResourceTypesConfigurationHandlerConfigMetricMapping defaults) {
    ...
    public static final class Builder {
        ...
        private String telemetryMetricName;
        public Builder() {}
        public Builder(GetMonitoredResourceTasksMonitoredResourceTasksCollectionItemTaskDetailResourceTypesConfigurationHandlerConfigMetricMapping defaults) {
        ...
        public Builder collectorMetricName(String collectorMetricName) {
            if (collectorMetricName == null) {
              throw new MissingRequiredPropertyException("GetMonitoredResourceTasksMonitoredResourceTasksCollectionItemTaskDetailResourceTypesConfigurationHandlerConfigMetricMapping", "collectorMetricName");
            }
        ...
        public Builder isSkipUpload(Boolean isSkipUpload) {
            if (isSkipUpload == null) {
              throw new MissingRequiredPropertyException("GetMonitoredResourceTasksMonitoredResourceTasksCollectionItemTaskDetailResourceTypesConfigurationHandlerConfigMetricMapping", "isSkipUpload");
            }
        ...
        public Builder metricUploadIntervalInSeconds(Integer metricUploadIntervalInSeconds) {
            if (metricUploadIntervalInSeconds == null) {
              throw new MissingRequiredPropertyException("GetMonitoredResourceTasksMonitoredResourceTasksCollectionItemTaskDetailResourceTypesConfigurationHandlerConfigMetricMapping", "metricUploadIntervalInSeconds");
            }
        ...
        public Builder telemetryMetricName(String telemetryMetricName) {
            if (telemetryMetricName == null) {
              throw new MissingRequiredPropertyException("GetMonitoredResourceTasksMonitoredResourceTasksCollectionItemTaskDetailResourceTypesConfigurationHandlerConfigMetricMapping", "telemetryMetricName");
            }
            this.telemetryMetricName = telemetryMetricName;
            return this;
        }
        public GetMonitoredResourceTasksMonitoredResourceTasksCollectionItemTaskDetailResourceTypesConfigurationHandlerConfigMetricMapping build() {
            final var _resultValue = new GetMonitoredResourceTasksMonitoredResourceTasksCollectionItemTaskDetailResourceTypesConfigurationHandlerConfigMetricMapping();
