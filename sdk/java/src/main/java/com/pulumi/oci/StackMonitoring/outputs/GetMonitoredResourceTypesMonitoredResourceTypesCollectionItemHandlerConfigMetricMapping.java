...
@CustomType
public final class GetMonitoredResourceTypesMonitoredResourceTypesCollectionItemHandlerConfigMetricMapping {
    /**
    ...
    private GetMonitoredResourceTypesMonitoredResourceTypesCollectionItemHandlerConfigMetricMapping() {}
    /**
     * @return Metric name as defined by the collector.
     * 
     */
    ...
    public static Builder builder(GetMonitoredResourceTypesMonitoredResourceTypesCollectionItemHandlerConfigMetricMapping defaults) {
    ...
    public static final class Builder {
        ...
        private String telemetryMetricName;
        public Builder() {}
        public Builder(GetMonitoredResourceTypesMonitoredResourceTypesCollectionItemHandlerConfigMetricMapping defaults) {
        ...
        public Builder collectorMetricName(String collectorMetricName) {
            if (collectorMetricName == null) {
              throw new MissingRequiredPropertyException("GetMonitoredResourceTypesMonitoredResourceTypesCollectionItemHandlerConfigMetricMapping", "collectorMetricName");
            }
        ...
        public Builder isSkipUpload(Boolean isSkipUpload) {
            if (isSkipUpload == null) {
              throw new MissingRequiredPropertyException("GetMonitoredResourceTypesMonitoredResourceTypesCollectionItemHandlerConfigMetricMapping", "isSkipUpload");
            }
        ...
        public Builder metricUploadIntervalInSeconds(Integer metricUploadIntervalInSeconds) {
            if (metricUploadIntervalInSeconds == null) {
              throw new MissingRequiredPropertyException("GetMonitoredResourceTypesMonitoredResourceTypesCollectionItemHandlerConfigMetricMapping", "metricUploadIntervalInSeconds");
            }
        ...
        public Builder telemetryMetricName(String telemetryMetricName) {
            if (telemetryMetricName == null) {
              throw new MissingRequiredPropertyException("GetMonitoredResourceTypesMonitoredResourceTypesCollectionItemHandlerConfigMetricMapping", "telemetryMetricName");
            }
            this.telemetryMetricName = telemetryMetricName;
            return this;
        }
        public GetMonitoredResourceTypesMonitoredResourceTypesCollectionItemHandlerConfigMetricMapping build() {
            final var _resultValue = new GetMonitoredResourceTypesMonitoredResourceTypesCollectionItemHandlerConfigMetricMapping();
