...
@CustomType
public final class GetProcessSetSpecificationItem {
    /**
    ...
    private GetProcessSetSpecificationItem() {}
    /**
     * @return Optional label used to identify a single filter.
     * 
     */
    ...
    public static Builder builder(GetProcessSetSpecificationItem defaults) {
    ...
    public static final class Builder {
        ...
        private String processUser;
        public Builder() {}
        public Builder(GetProcessSetSpecificationItem defaults) {
        ...
        public Builder label(String label) {
            if (label == null) {
              throw new MissingRequiredPropertyException("GetProcessSetSpecificationItem", "label");
            }
            this.label = label;
            return this;
        }
        ...
        public Builder processCommand(String processCommand) {
            if (processCommand == null) {
              throw new MissingRequiredPropertyException("GetProcessSetSpecificationItem", "processCommand");
            }
        ...
        public Builder processLineRegexPattern(String processLineRegexPattern) {
            if (processLineRegexPattern == null) {
              throw new MissingRequiredPropertyException("GetProcessSetSpecificationItem", "processLineRegexPattern");
            }
        ...
        public Builder processUser(String processUser) {
            if (processUser == null) {
              throw new MissingRequiredPropertyException("GetProcessSetSpecificationItem", "processUser");
            }
            this.processUser = processUser;
            return this;
        }
        public GetProcessSetSpecificationItem build() {
            final var _resultValue = new GetProcessSetSpecificationItem();
