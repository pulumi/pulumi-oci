...
public final class MonitoredResourceAdditionalAliasCredential {
    ...
    public static Builder builder(MonitoredResourceAdditionalAliasCredential defaults) {
    ...
    public static final class Builder {
        ...
        private String source;
        public Builder() {}
        public Builder(MonitoredResourceAdditionalAliasCredential defaults) {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("MonitoredResourceAdditionalAliasCredential", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder service(String service) {
            if (service == null) {
              throw new MissingRequiredPropertyException("MonitoredResourceAdditionalAliasCredential", "service");
            }
        ...
        public Builder source(String source) {
            if (source == null) {
              throw new MissingRequiredPropertyException("MonitoredResourceAdditionalAliasCredential", "source");
            }
            this.source = source;
            return this;
        }
