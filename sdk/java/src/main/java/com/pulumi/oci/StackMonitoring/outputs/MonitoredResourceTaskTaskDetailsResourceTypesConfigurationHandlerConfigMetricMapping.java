...
@CustomType
public final class MonitoredResourceTaskTaskDetailsResourceTypesConfigurationHandlerConfigMetricMapping {
    /**
    ...
    private MonitoredResourceTaskTaskDetailsResourceTypesConfigurationHandlerConfigMetricMapping() {}
    /**
     * @return Metric name as defined by the collector.
     * 
     */
    ...
    public static Builder builder(MonitoredResourceTaskTaskDetailsResourceTypesConfigurationHandlerConfigMetricMapping defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String telemetryMetricName;
        public Builder() {}
        public Builder(MonitoredResourceTaskTaskDetailsResourceTypesConfigurationHandlerConfigMetricMapping defaults) {
        ...
        public MonitoredResourceTaskTaskDetailsResourceTypesConfigurationHandlerConfigMetricMapping build() {
            final var _resultValue = new MonitoredResourceTaskTaskDetailsResourceTypesConfigurationHandlerConfigMetricMapping();
