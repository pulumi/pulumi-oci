...
@CustomType
public final class MonitoredResourceTypeAvailabilityMetricsConfig {
    /**
    ...
    public static Builder builder(MonitoredResourceTypeAvailabilityMetricsConfig defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> metrics;
        public Builder() {}
        public Builder(MonitoredResourceTypeAvailabilityMetricsConfig defaults) {
        ...
        public MonitoredResourceTypeAvailabilityMetricsConfig build() {
            final var _resultValue = new MonitoredResourceTypeAvailabilityMetricsConfig();
