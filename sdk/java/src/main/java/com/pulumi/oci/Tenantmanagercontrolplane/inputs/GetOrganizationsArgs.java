...
import com.pulumi.oci.Tenantmanagercontrolplane.inputs.GetOrganizationsFilterArgs;
...
public final class GetOrganizationsArgs extends com.pulumi.resources.InvokeArgs {
    ...
    @Import(name="filters")
    private @Nullable Output<List<GetOrganizationsFilterArgs>> filters;

    public Optional<Output<List<GetOrganizationsFilterArgs>>> filters() {
    ...
    public static final class Builder {
        ...
        public Builder filters(@Nullable Output<List<GetOrganizationsFilterArgs>> filters) {
            $.filters = filters;
            return this;
        }

        public Builder filters(List<GetOrganizationsFilterArgs> filters) {
            return filters(Output.of(filters));
        }

        public Builder filters(GetOrganizationsFilterArgs... filters) {
            return filters(List.of(filters));
        }

        public GetOrganizationsArgs build() {
            if ($.compartmentId == null) {
                throw new MissingRequiredPropertyException("GetOrganizationsArgs", "compartmentId");
            }
            return $;
        }
    }
