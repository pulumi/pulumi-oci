...
public final class GetAssignedSubscriptionPromotion {
    ...
    private GetAssignedSubscriptionPromotion() {}
    /**
     * @return If a subscription is present, indicates the total amount of promotional subscription credits.
     * 
     */
    ...
    public static Builder builder(GetAssignedSubscriptionPromotion defaults) {
    ...
    public static final class Builder {
        ...
        private String timeStarted;
        public Builder() {}
        public Builder(GetAssignedSubscriptionPromotion defaults) {
        ...
        public Builder amount(Double amount) {
            if (amount == null) {
              throw new MissingRequiredPropertyException("GetAssignedSubscriptionPromotion", "amount");
            }
            this.amount = amount;
            return this;
        }
        ...
        public Builder currencyUnit(String currencyUnit) {
            if (currencyUnit == null) {
              throw new MissingRequiredPropertyException("GetAssignedSubscriptionPromotion", "currencyUnit");
            }
        ...
        public Builder duration(Integer duration) {
            if (duration == null) {
              throw new MissingRequiredPropertyException("GetAssignedSubscriptionPromotion", "duration");
            }
        ...
        public Builder durationUnit(String durationUnit) {
            if (durationUnit == null) {
              throw new MissingRequiredPropertyException("GetAssignedSubscriptionPromotion", "durationUnit");
            }
        ...
        public Builder isIntentToPay(Boolean isIntentToPay) {
            if (isIntentToPay == null) {
              throw new MissingRequiredPropertyException("GetAssignedSubscriptionPromotion", "isIntentToPay");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetAssignedSubscriptionPromotion", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder timeExpired(String timeExpired) {
            if (timeExpired == null) {
              throw new MissingRequiredPropertyException("GetAssignedSubscriptionPromotion", "timeExpired");
            }
        ...
        public Builder timeStarted(String timeStarted) {
            if (timeStarted == null) {
              throw new MissingRequiredPropertyException("GetAssignedSubscriptionPromotion", "timeStarted");
            }
            this.timeStarted = timeStarted;
            return this;
        }
        public GetAssignedSubscriptionPromotion build() {
            final var _resultValue = new GetAssignedSubscriptionPromotion();
