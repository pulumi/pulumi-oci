...
@CustomType
public final class GetAssignedSubscriptionSkus {
    /**
    ...
    private GetAssignedSubscriptionSkus() {}
    /**
     * @return Description of the stock units.
     * 
     */
    ...
    public static Builder builder(GetAssignedSubscriptionSkus defaults) {
    ...
    public static final class Builder {
        ...
        private String startDate;
        public Builder() {}
        public Builder(GetAssignedSubscriptionSkus defaults) {
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetAssignedSubscriptionSkus", "description");
            }
        ...
        public Builder endDate(String endDate) {
            if (endDate == null) {
              throw new MissingRequiredPropertyException("GetAssignedSubscriptionSkus", "endDate");
            }
        ...
        public Builder gsiOrderLineId(String gsiOrderLineId) {
            if (gsiOrderLineId == null) {
              throw new MissingRequiredPropertyException("GetAssignedSubscriptionSkus", "gsiOrderLineId");
            }
        ...
        public Builder isAdditionalInstance(Boolean isAdditionalInstance) {
            if (isAdditionalInstance == null) {
              throw new MissingRequiredPropertyException("GetAssignedSubscriptionSkus", "isAdditionalInstance");
            }
        ...
        public Builder isBaseServiceComponent(Boolean isBaseServiceComponent) {
            if (isBaseServiceComponent == null) {
              throw new MissingRequiredPropertyException("GetAssignedSubscriptionSkus", "isBaseServiceComponent");
            }
        ...
        public Builder licensePartDescription(String licensePartDescription) {
            if (licensePartDescription == null) {
              throw new MissingRequiredPropertyException("GetAssignedSubscriptionSkus", "licensePartDescription");
            }
        ...
        public Builder metricName(String metricName) {
            if (metricName == null) {
              throw new MissingRequiredPropertyException("GetAssignedSubscriptionSkus", "metricName");
            }
        ...
        public Builder quantity(Integer quantity) {
            if (quantity == null) {
              throw new MissingRequiredPropertyException("GetAssignedSubscriptionSkus", "quantity");
            }
        ...
        public Builder sku(String sku) {
            if (sku == null) {
              throw new MissingRequiredPropertyException("GetAssignedSubscriptionSkus", "sku");
            }
            this.sku = sku;
            return this;
        }
        ...
        public Builder startDate(String startDate) {
            if (startDate == null) {
              throw new MissingRequiredPropertyException("GetAssignedSubscriptionSkus", "startDate");
            }
            this.startDate = startDate;
            return this;
        }
        public GetAssignedSubscriptionSkus build() {
            final var _resultValue = new GetAssignedSubscriptionSkus();
