...
@CustomType
public final class GetOrganizationTenancyResult {
    /**
    ...
    public static Builder builder(GetOrganizationTenancyResult defaults) {
    ...
    public static final class Builder {
        ...
        private String timeLeft;
        public Builder() {}
        public Builder(GetOrganizationTenancyResult defaults) {
        ...
        public Builder governanceStatus(String governanceStatus) {
            if (governanceStatus == null) {
              throw new MissingRequiredPropertyException("GetOrganizationTenancyResult", "governanceStatus");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetOrganizationTenancyResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isApprovedForTransfer(Boolean isApprovedForTransfer) {
            if (isApprovedForTransfer == null) {
              throw new MissingRequiredPropertyException("GetOrganizationTenancyResult", "isApprovedForTransfer");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetOrganizationTenancyResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder organizationId(String organizationId) {
            if (organizationId == null) {
              throw new MissingRequiredPropertyException("GetOrganizationTenancyResult", "organizationId");
            }
        ...
        public Builder role(String role) {
            if (role == null) {
              throw new MissingRequiredPropertyException("GetOrganizationTenancyResult", "role");
            }
            this.role = role;
            return this;
        }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetOrganizationTenancyResult", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder tenancyId(String tenancyId) {
            if (tenancyId == null) {
              throw new MissingRequiredPropertyException("GetOrganizationTenancyResult", "tenancyId");
            }
        ...
        public Builder timeJoined(String timeJoined) {
            if (timeJoined == null) {
              throw new MissingRequiredPropertyException("GetOrganizationTenancyResult", "timeJoined");
            }
        ...
        public Builder timeLeft(String timeLeft) {
            if (timeLeft == null) {
              throw new MissingRequiredPropertyException("GetOrganizationTenancyResult", "timeLeft");
            }
            this.timeLeft = timeLeft;
            return this;
        }
        public GetOrganizationTenancyResult build() {
            final var _resultValue = new GetOrganizationTenancyResult();
