...
@CustomType
public final class GetSubscriptionMappingResult {
    /**
    ...
    public static Builder builder(GetSubscriptionMappingResult defaults) {
    ...
    public static final class Builder {
        ...
        private String timeUpdated;
        public Builder() {}
        public Builder(GetSubscriptionMappingResult defaults) {
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionMappingResult", "compartmentId");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionMappingResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isExplicitlyAssigned(Boolean isExplicitlyAssigned) {
            if (isExplicitlyAssigned == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionMappingResult", "isExplicitlyAssigned");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionMappingResult", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder subscriptionId(String subscriptionId) {
            if (subscriptionId == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionMappingResult", "subscriptionId");
            }
        ...
        public Builder subscriptionMappingId(String subscriptionMappingId) {
            if (subscriptionMappingId == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionMappingResult", "subscriptionMappingId");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionMappingResult", "timeCreated");
            }
        ...
        public Builder timeTerminated(String timeTerminated) {
            if (timeTerminated == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionMappingResult", "timeTerminated");
            }
        ...
        public Builder timeUpdated(String timeUpdated) {
            if (timeUpdated == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionMappingResult", "timeUpdated");
            }
            this.timeUpdated = timeUpdated;
            return this;
        }
        public GetSubscriptionMappingResult build() {
            final var _resultValue = new GetSubscriptionMappingResult();
