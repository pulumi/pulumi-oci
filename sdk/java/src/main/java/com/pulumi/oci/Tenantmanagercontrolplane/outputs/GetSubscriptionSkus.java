...
@CustomType
public final class GetSubscriptionSkus {
    /**
    ...
    public static Builder builder(GetSubscriptionSkus defaults) {
    ...
    public static final class Builder {
        ...
        private String startDate;
        public Builder() {}
        public Builder(GetSubscriptionSkus defaults) {
        ...
        public Builder description(String description) {
            if (description == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionSkus", "description");
            }
        ...
        public Builder endDate(String endDate) {
            if (endDate == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionSkus", "endDate");
            }
        ...
        public Builder gsiOrderLineId(String gsiOrderLineId) {
            if (gsiOrderLineId == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionSkus", "gsiOrderLineId");
            }
        ...
        public Builder isAdditionalInstance(Boolean isAdditionalInstance) {
            if (isAdditionalInstance == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionSkus", "isAdditionalInstance");
            }
        ...
        public Builder isBaseServiceComponent(Boolean isBaseServiceComponent) {
            if (isBaseServiceComponent == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionSkus", "isBaseServiceComponent");
            }
        ...
        public Builder licensePartDescription(String licensePartDescription) {
            if (licensePartDescription == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionSkus", "licensePartDescription");
            }
        ...
        public Builder metricName(String metricName) {
            if (metricName == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionSkus", "metricName");
            }
        ...
        public Builder quantity(Integer quantity) {
            if (quantity == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionSkus", "quantity");
            }
        ...
        public Builder sku(String sku) {
            if (sku == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionSkus", "sku");
            }
            this.sku = sku;
            return this;
        }
        ...
        public Builder startDate(String startDate) {
            if (startDate == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionSkus", "startDate");
            }
            this.startDate = startDate;
            return this;
        }
        public GetSubscriptionSkus build() {
            final var _resultValue = new GetSubscriptionSkus();
