...
@CustomType
public final class GetSubscriptionsSubscriptionCollectionItemPromotion {
    /**
    ...
    private GetSubscriptionsSubscriptionCollectionItemPromotion() {}
    /**
     * @return If a subscription is present, indicates the total amount of promotional subscription credits.
     * 
     */
    ...
    public static Builder builder(GetSubscriptionsSubscriptionCollectionItemPromotion defaults) {
    ...
    public static final class Builder {
        ...
        private String timeStarted;
        public Builder() {}
        public Builder(GetSubscriptionsSubscriptionCollectionItemPromotion defaults) {
        ...
        public Builder amount(Double amount) {
            if (amount == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionsSubscriptionCollectionItemPromotion", "amount");
            }
            this.amount = amount;
            return this;
        }
        ...
        public Builder currencyUnit(String currencyUnit) {
            if (currencyUnit == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionsSubscriptionCollectionItemPromotion", "currencyUnit");
            }
        ...
        public Builder duration(Integer duration) {
            if (duration == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionsSubscriptionCollectionItemPromotion", "duration");
            }
        ...
        public Builder durationUnit(String durationUnit) {
            if (durationUnit == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionsSubscriptionCollectionItemPromotion", "durationUnit");
            }
        ...
        public Builder isIntentToPay(Boolean isIntentToPay) {
            if (isIntentToPay == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionsSubscriptionCollectionItemPromotion", "isIntentToPay");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionsSubscriptionCollectionItemPromotion", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder timeExpired(String timeExpired) {
            if (timeExpired == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionsSubscriptionCollectionItemPromotion", "timeExpired");
            }
        ...
        public Builder timeStarted(String timeStarted) {
            if (timeStarted == null) {
              throw new MissingRequiredPropertyException("GetSubscriptionsSubscriptionCollectionItemPromotion", "timeStarted");
            }
            this.timeStarted = timeStarted;
            return this;
        }
        public GetSubscriptionsSubscriptionCollectionItemPromotion build() {
            final var _resultValue = new GetSubscriptionsSubscriptionCollectionItemPromotion();
