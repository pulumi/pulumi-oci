    ...
    public static final class Builder {
        ...
        public GetSubscriptionProductsPlainArgs build() {
            if ($.subscriptionId == null) {
                throw new MissingRequiredPropertyException("GetSubscriptionProductsPlainArgs", "subscriptionId");
            }
            if ($.tenancyId == null) {
                throw new MissingRequiredPropertyException("GetSubscriptionProductsPlainArgs", "tenancyId");
            }
            if ($.usagePeriodKey == null) {
                throw new MissingRequiredPropertyException("GetSubscriptionProductsPlainArgs", "usagePeriodKey");
            }
            return $;
        }
    }
