    ...
    public static final class Builder {
        ...
        public GetSubscriptionRedeemableUsersArgs build() {
            if ($.subscriptionId == null) {
                throw new MissingRequiredPropertyException("GetSubscriptionRedeemableUsersArgs", "subscriptionId");
            }
            if ($.tenancyId == null) {
                throw new MissingRequiredPropertyException("GetSubscriptionRedeemableUsersArgs", "tenancyId");
            }
            return $;
        }
    }
