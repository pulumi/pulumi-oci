    ...
    public static final class Builder {
        ...
        public GetSubscriptionRewardsPlainArgs build() {
            if ($.subscriptionId == null) {
                throw new MissingRequiredPropertyException("GetSubscriptionRewardsPlainArgs", "subscriptionId");
            }
            if ($.tenancyId == null) {
                throw new MissingRequiredPropertyException("GetSubscriptionRewardsPlainArgs", "tenancyId");
            }
            return $;
        }
    }
