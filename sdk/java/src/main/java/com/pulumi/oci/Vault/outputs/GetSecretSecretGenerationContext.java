...
public final class GetSecretSecretGenerationContext {
    ...
    private GetSecretSecretGenerationContext() {}
    /**
     * @return Name of random bytes generation template for generating random byte type secret.
     * 
     */
    ...
    public static Builder builder(GetSecretSecretGenerationContext defaults) {
    ...
    public static final class Builder {
        ...
        private String secretTemplate;
        public Builder() {}
        public Builder(GetSecretSecretGenerationContext defaults) {
        ...
        public Builder generationTemplate(String generationTemplate) {
            if (generationTemplate == null) {
              throw new MissingRequiredPropertyException("GetSecretSecretGenerationContext", "generationTemplate");
            }
        ...
        public Builder generationType(String generationType) {
            if (generationType == null) {
              throw new MissingRequiredPropertyException("GetSecretSecretGenerationContext", "generationType");
            }
        ...
        public Builder passphraseLength(Integer passphraseLength) {
            if (passphraseLength == null) {
              throw new MissingRequiredPropertyException("GetSecretSecretGenerationContext", "passphraseLength");
            }
        ...
        public Builder secretTemplate(String secretTemplate) {
            if (secretTemplate == null) {
              throw new MissingRequiredPropertyException("GetSecretSecretGenerationContext", "secretTemplate");
            }
            this.secretTemplate = secretTemplate;
            return this;
        }
        public GetSecretSecretGenerationContext build() {
            final var _resultValue = new GetSecretSecretGenerationContext();
