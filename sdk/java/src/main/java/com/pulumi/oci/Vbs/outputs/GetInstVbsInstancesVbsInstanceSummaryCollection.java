...
public final class GetInstVbsInstancesVbsInstanceSummaryCollection {
    private @Nullable List<GetInstVbsInstancesVbsInstanceSummaryCollectionItem> items;
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder items(@Nullable List<GetInstVbsInstancesVbsInstanceSummaryCollectionItem> items) {
            this.items = items;
            return this;
        }
