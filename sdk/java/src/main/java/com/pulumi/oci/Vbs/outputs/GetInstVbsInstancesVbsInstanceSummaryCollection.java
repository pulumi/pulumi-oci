...
public final class GetInstVbsInstancesVbsInstanceSummaryCollection {
    ...
    public static final class Builder {
        ...
        public Builder items(List<GetInstVbsInstancesVbsInstanceSummaryCollectionItem> items) {
            if (items == null) {
              throw new MissingRequiredPropertyException("GetInstVbsInstancesVbsInstanceSummaryCollection", "items");
            }
            this.items = items;
            return this;
        }
        ...
        public GetInstVbsInstancesVbsInstanceSummaryCollection build() {
            final var _resultValue = new GetInstVbsInstancesVbsInstanceSummaryCollection();
