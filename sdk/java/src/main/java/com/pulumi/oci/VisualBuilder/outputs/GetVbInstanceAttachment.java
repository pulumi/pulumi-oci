...
public final class GetVbInstanceAttachment {
    ...
    public static Builder builder(GetVbInstanceAttachment defaults) {
    ...
    public static final class Builder {
        ...
        public Builder isImplicit(Boolean isImplicit) {
            if (isImplicit == null) {
              throw new MissingRequiredPropertyException("GetVbInstanceAttachment", "isImplicit");
            }
        ...
        public Builder targetId(String targetId) {
            if (targetId == null) {
              throw new MissingRequiredPropertyException("GetVbInstanceAttachment", "targetId");
            }
        ...
        public Builder targetInstanceUrl(String targetInstanceUrl) {
            if (targetInstanceUrl == null) {
              throw new MissingRequiredPropertyException("GetVbInstanceAttachment", "targetInstanceUrl");
            }
        ...
        public Builder targetRole(String targetRole) {
            if (targetRole == null) {
              throw new MissingRequiredPropertyException("GetVbInstanceAttachment", "targetRole");
            }
        ...
        public Builder targetServiceType(String targetServiceType) {
            if (targetServiceType == null) {
              throw new MissingRequiredPropertyException("GetVbInstanceAttachment", "targetServiceType");
            }
            this.targetServiceType = targetServiceType;
            return this;
        }
        public GetVbInstanceAttachment build() {
            final var _resultValue = new GetVbInstanceAttachment();
