    ...
    public static final class Builder {
        ...
        public Builder certificateSecretId(String certificateSecretId) {
            if (certificateSecretId == null) {
              throw new MissingRequiredPropertyException("GetVbInstanceCustomEndpoint", "certificateSecretId");
            }
        ...
        public Builder certificateSecretVersion(Integer certificateSecretVersion) {
            if (certificateSecretVersion == null) {
              throw new MissingRequiredPropertyException("GetVbInstanceCustomEndpoint", "certificateSecretVersion");
            }
        ...
        public Builder hostname(String hostname) {
            if (hostname == null) {
              throw new MissingRequiredPropertyException("GetVbInstanceCustomEndpoint", "hostname");
            }
            this.hostname = hostname;
            return this;
        }
        public GetVbInstanceCustomEndpoint build() {
            final var _resultValue = new GetVbInstanceCustomEndpoint();
