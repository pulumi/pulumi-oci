...
public class PathAnalyzerTest extends com.pulumi.resources.CustomResource {
     ...
     */
    public PathAnalyzerTest(java.lang.String name) {
     ...
     */
    public PathAnalyzerTest(java.lang.String name, PathAnalyzerTestArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public PathAnalyzerTest(java.lang.String name, PathAnalyzerTestArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:VnMonitoring/pathAnalyzerTest:PathAnalyzerTest", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private PathAnalyzerTest(java.lang.String name, Output<java.lang.String> id, @Nullable PathAnalyzerTestState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:VnMonitoring/pathAnalyzerTest:PathAnalyzerTest", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static PathAnalyzerTest get(java.lang.String name, Output<java.lang.String> id, @Nullable PathAnalyzerTestState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
