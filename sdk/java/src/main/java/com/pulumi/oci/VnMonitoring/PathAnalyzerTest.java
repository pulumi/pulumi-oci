...
public class PathAnalyzerTest extends com.pulumi.resources.CustomResource {
    ...
    private Output</* @Nullable */ PathAnalyzerTestProtocolParameters> protocolParameters;

    /**
     * @return (Updatable) Defines the IP protocol parameters for a `PathAnalyzerTest` resource.
     * 
     */
    public Output<Optional<PathAnalyzerTestProtocolParameters>> protocolParameters() {
    ...
    private Output</* @Nullable */ PathAnalyzerTestQueryOptions> queryOptions;

    /**
     * @return (Updatable) Defines the query options required for a `PathAnalyzerTest` resource.
     * 
     */
    public Output<Optional<PathAnalyzerTestQueryOptions>> queryOptions() {
