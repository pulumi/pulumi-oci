...
public final class PathAnalysiState extends com.pulumi.resources.ResourceArgs {

    public static final PathAnalysiState Empty = new PathAnalysiState();
    ...
    private PathAnalysiState() {}

    private PathAnalysiState(PathAnalysiState $) {
    ...
    public static Builder builder(PathAnalysiState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new PathAnalysiState();
        }

        public Builder(PathAnalysiState defaults) {
            $ = new PathAnalysiState(Objects.requireNonNull(defaults));
        }
