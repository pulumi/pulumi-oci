...
@CustomType
public final class PathAnalysiDestinationEndpoint {
    /**
    ...
    public static final class Builder {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("PathAnalysiDestinationEndpoint", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public PathAnalysiDestinationEndpoint build() {
            final var _resultValue = new PathAnalysiDestinationEndpoint();
