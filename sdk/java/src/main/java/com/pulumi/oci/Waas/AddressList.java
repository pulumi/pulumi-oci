...
public class AddressList extends com.pulumi.resources.CustomResource {
     ...
     */
    public AddressList(java.lang.String name) {
     ...
     */
    public AddressList(java.lang.String name, AddressListArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public AddressList(java.lang.String name, AddressListArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Waas/addressList:AddressList", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private AddressList(java.lang.String name, Output<java.lang.String> id, @Nullable AddressListState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:Waas/addressList:AddressList", name, state, makeResourceOptions(options, id), false);
    }
     ...
     */
    public static AddressList get(java.lang.String name, Output<java.lang.String> id, @Nullable AddressListState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
