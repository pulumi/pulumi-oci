...
public final class PolicyWafConfigAccessRuleCriteriaArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public PolicyWafConfigAccessRuleCriteriaArgs build() {
            if ($.condition == null) {
                throw new MissingRequiredPropertyException("PolicyWafConfigAccessRuleCriteriaArgs", "condition");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PolicyWafConfigAccessRuleCriteriaArgs", "value");
            }
            return $;
        }
    }
