...
public final class PolicyWafConfigJsChallengeCriteriaArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public PolicyWafConfigJsChallengeCriteriaArgs build() {
            if ($.condition == null) {
                throw new MissingRequiredPropertyException("PolicyWafConfigJsChallengeCriteriaArgs", "condition");
            }
            if ($.value == null) {
                throw new MissingRequiredPropertyException("PolicyWafConfigJsChallengeCriteriaArgs", "value");
            }
            return $;
        }
    }
