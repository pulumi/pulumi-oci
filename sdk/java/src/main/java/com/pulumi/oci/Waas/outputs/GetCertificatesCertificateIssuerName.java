...
public final class GetCertificatesCertificateIssuerName {
    ...
    public static final class Builder {
        ...
        public Builder commonName(String commonName) {
            if (commonName == null) {
              throw new MissingRequiredPropertyException("GetCertificatesCertificateIssuerName", "commonName");
            }
        ...
        public Builder country(String country) {
            if (country == null) {
              throw new MissingRequiredPropertyException("GetCertificatesCertificateIssuerName", "country");
            }
        ...
        public Builder emailAddress(String emailAddress) {
            if (emailAddress == null) {
              throw new MissingRequiredPropertyException("GetCertificatesCertificateIssuerName", "emailAddress");
            }
        ...
        public Builder locality(String locality) {
            if (locality == null) {
              throw new MissingRequiredPropertyException("GetCertificatesCertificateIssuerName", "locality");
            }
        ...
        public Builder organization(String organization) {
            if (organization == null) {
              throw new MissingRequiredPropertyException("GetCertificatesCertificateIssuerName", "organization");
            }
        ...
        public Builder organizationalUnit(String organizationalUnit) {
            if (organizationalUnit == null) {
              throw new MissingRequiredPropertyException("GetCertificatesCertificateIssuerName", "organizationalUnit");
            }
        ...
        public Builder stateProvince(String stateProvince) {
            if (stateProvince == null) {
              throw new MissingRequiredPropertyException("GetCertificatesCertificateIssuerName", "stateProvince");
            }
