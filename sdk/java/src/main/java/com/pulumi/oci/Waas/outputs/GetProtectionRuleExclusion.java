...
public final class GetProtectionRuleExclusion {
    ...
    public static final class Builder {
        ...
        public Builder exclusions(List<String> exclusions) {
            if (exclusions == null) {
              throw new MissingRequiredPropertyException("GetProtectionRuleExclusion", "exclusions");
            }
        ...
        public Builder target(String target) {
            if (target == null) {
              throw new MissingRequiredPropertyException("GetProtectionRuleExclusion", "target");
            }
            this.target = target;
            return this;
        }
        public GetProtectionRuleExclusion build() {
            final var _resultValue = new GetProtectionRuleExclusion();
