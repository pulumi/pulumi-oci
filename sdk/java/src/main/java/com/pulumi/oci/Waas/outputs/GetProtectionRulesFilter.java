...
public final class GetProtectionRulesFilter {
    ...
    public static final class Builder {
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetProtectionRulesFilter", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder values(List<String> values) {
            if (values == null) {
              throw new MissingRequiredPropertyException("GetProtectionRulesFilter", "values");
            }
            this.values = values;
            return this;
        }
        ...
        public GetProtectionRulesFilter build() {
            final var _resultValue = new GetProtectionRulesFilter();
