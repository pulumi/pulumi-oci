...
public final class GetProtectionRulesProtectionRuleExclusion {
    ...
    public static final class Builder {
        ...
        public Builder exclusions(List<String> exclusions) {
            if (exclusions == null) {
              throw new MissingRequiredPropertyException("GetProtectionRulesProtectionRuleExclusion", "exclusions");
            }
        ...
        public Builder target(String target) {
            if (target == null) {
              throw new MissingRequiredPropertyException("GetProtectionRulesProtectionRuleExclusion", "target");
            }
            this.target = target;
            return this;
        }
