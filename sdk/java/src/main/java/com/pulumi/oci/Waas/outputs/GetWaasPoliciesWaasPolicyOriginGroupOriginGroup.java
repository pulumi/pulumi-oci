...
public final class GetWaasPoliciesWaasPolicyOriginGroupOriginGroup {
    ...
    public static final class Builder {
        ...
        public Builder origin(String origin) {
            if (origin == null) {
              throw new MissingRequiredPropertyException("GetWaasPoliciesWaasPolicyOriginGroupOriginGroup", "origin");
            }
            this.origin = origin;
            return this;
        }
        ...
        public Builder weight(Integer weight) {
            if (weight == null) {
              throw new MissingRequiredPropertyException("GetWaasPoliciesWaasPolicyOriginGroupOriginGroup", "weight");
            }
            this.weight = weight;
            return this;
        }
