...
@CustomType
public final class GetWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeChallengeSetting {
    /**
    ...
    private GetWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeChallengeSetting() {}
    /**
     * @return If `action` is set to `BLOCK`, this specifies how the traffic is blocked when detected as malicious by a protection rule. If unspecified, defaults to `SET_RESPONSE_CODE`.
     * 
     */
    ...
    public static Builder builder(GetWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeChallengeSetting defaults) {
    ...
    public static final class Builder {
        ...
        private String captchaTitle;
        public Builder() {}
        public Builder(GetWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeChallengeSetting defaults) {
        ...
        public Builder blockAction(String blockAction) {
            if (blockAction == null) {
              throw new MissingRequiredPropertyException("GetWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeChallengeSetting", "blockAction");
            }
        ...
        public Builder blockErrorPageCode(String blockErrorPageCode) {
            if (blockErrorPageCode == null) {
              throw new MissingRequiredPropertyException("GetWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeChallengeSetting", "blockErrorPageCode");
            }
        ...
        public Builder blockErrorPageDescription(String blockErrorPageDescription) {
            if (blockErrorPageDescription == null) {
              throw new MissingRequiredPropertyException("GetWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeChallengeSetting", "blockErrorPageDescription");
            }
        ...
        public Builder blockErrorPageMessage(String blockErrorPageMessage) {
            if (blockErrorPageMessage == null) {
              throw new MissingRequiredPropertyException("GetWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeChallengeSetting", "blockErrorPageMessage");
            }
        ...
        public Builder blockResponseCode(Integer blockResponseCode) {
            if (blockResponseCode == null) {
              throw new MissingRequiredPropertyException("GetWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeChallengeSetting", "blockResponseCode");
            }
        ...
        public Builder captchaFooter(String captchaFooter) {
            if (captchaFooter == null) {
              throw new MissingRequiredPropertyException("GetWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeChallengeSetting", "captchaFooter");
            }
        ...
        public Builder captchaHeader(String captchaHeader) {
            if (captchaHeader == null) {
              throw new MissingRequiredPropertyException("GetWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeChallengeSetting", "captchaHeader");
            }
        ...
        public Builder captchaSubmitLabel(String captchaSubmitLabel) {
            if (captchaSubmitLabel == null) {
              throw new MissingRequiredPropertyException("GetWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeChallengeSetting", "captchaSubmitLabel");
            }
        ...
        public Builder captchaTitle(String captchaTitle) {
            if (captchaTitle == null) {
              throw new MissingRequiredPropertyException("GetWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeChallengeSetting", "captchaTitle");
            }
            this.captchaTitle = captchaTitle;
            return this;
        }
        public GetWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeChallengeSetting build() {
            final var _resultValue = new GetWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeChallengeSetting();
