...
public final class GetWaasPoliciesWaasPolicyWafConfigJsChallengeChallengeSetting {
    ...
    public static final class Builder {
        ...
        public Builder blockAction(String blockAction) {
            if (blockAction == null) {
              throw new MissingRequiredPropertyException("GetWaasPoliciesWaasPolicyWafConfigJsChallengeChallengeSetting", "blockAction");
            }
        ...
        public Builder blockErrorPageCode(String blockErrorPageCode) {
            if (blockErrorPageCode == null) {
              throw new MissingRequiredPropertyException("GetWaasPoliciesWaasPolicyWafConfigJsChallengeChallengeSetting", "blockErrorPageCode");
            }
        ...
        public Builder blockErrorPageDescription(String blockErrorPageDescription) {
            if (blockErrorPageDescription == null) {
              throw new MissingRequiredPropertyException("GetWaasPoliciesWaasPolicyWafConfigJsChallengeChallengeSetting", "blockErrorPageDescription");
            }
        ...
        public Builder blockErrorPageMessage(String blockErrorPageMessage) {
            if (blockErrorPageMessage == null) {
              throw new MissingRequiredPropertyException("GetWaasPoliciesWaasPolicyWafConfigJsChallengeChallengeSetting", "blockErrorPageMessage");
            }
        ...
        public Builder blockResponseCode(Integer blockResponseCode) {
            if (blockResponseCode == null) {
              throw new MissingRequiredPropertyException("GetWaasPoliciesWaasPolicyWafConfigJsChallengeChallengeSetting", "blockResponseCode");
            }
        ...
        public Builder captchaFooter(String captchaFooter) {
            if (captchaFooter == null) {
              throw new MissingRequiredPropertyException("GetWaasPoliciesWaasPolicyWafConfigJsChallengeChallengeSetting", "captchaFooter");
            }
        ...
        public Builder captchaHeader(String captchaHeader) {
            if (captchaHeader == null) {
              throw new MissingRequiredPropertyException("GetWaasPoliciesWaasPolicyWafConfigJsChallengeChallengeSetting", "captchaHeader");
            }
        ...
        public Builder captchaSubmitLabel(String captchaSubmitLabel) {
            if (captchaSubmitLabel == null) {
              throw new MissingRequiredPropertyException("GetWaasPoliciesWaasPolicyWafConfigJsChallengeChallengeSetting", "captchaSubmitLabel");
            }
        ...
        public Builder captchaTitle(String captchaTitle) {
            if (captchaTitle == null) {
              throw new MissingRequiredPropertyException("GetWaasPoliciesWaasPolicyWafConfigJsChallengeChallengeSetting", "captchaTitle");
            }
            this.captchaTitle = captchaTitle;
            return this;
        }
        public GetWaasPoliciesWaasPolicyWafConfigJsChallengeChallengeSetting build() {
            final var _resultValue = new GetWaasPoliciesWaasPolicyWafConfigJsChallengeChallengeSetting();
