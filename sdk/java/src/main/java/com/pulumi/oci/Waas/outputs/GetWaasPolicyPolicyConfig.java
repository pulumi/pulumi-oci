...
public final class GetWaasPolicyPolicyConfig {
     ...
     * 
     */
    private @Nullable GetWaasPolicyPolicyConfigHealthChecks healthChecks;
    /**
     ...
     * 
     */
    private @Nullable GetWaasPolicyPolicyConfigLoadBalancingMethod loadBalancingMethod;
    /**
     ...
     * 
     */
    public Optional<GetWaasPolicyPolicyConfigHealthChecks> healthChecks() {
     ...
     * 
     */
    public Optional<GetWaasPolicyPolicyConfigLoadBalancingMethod> loadBalancingMethod() {
    ...
    public static final class Builder {
        ...
        @CustomType.Setter
        public Builder healthChecks(@Nullable GetWaasPolicyPolicyConfigHealthChecks healthChecks) {
        ...
        @CustomType.Setter
        public Builder loadBalancingMethod(@Nullable GetWaasPolicyPolicyConfigLoadBalancingMethod loadBalancingMethod) {
