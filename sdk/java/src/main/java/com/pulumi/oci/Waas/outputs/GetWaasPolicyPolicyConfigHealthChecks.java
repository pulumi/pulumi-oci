...
@CustomType
public final class GetWaasPolicyPolicyConfigHealthChecks {
    /**
    ...
    private GetWaasPolicyPolicyConfigHealthChecks() {}
    /**
     * @return The HTTP response codes that signify a healthy state.
     * * **2XX:** Success response code group.
     * * **3XX:** Redirection response code group.
    ...
    public static Builder builder(GetWaasPolicyPolicyConfigHealthChecks defaults) {
    ...
    public static final class Builder {
        ...
        private Integer unhealthyThreshold;
        public Builder() {}
        public Builder(GetWaasPolicyPolicyConfigHealthChecks defaults) {
        ...
        public GetWaasPolicyPolicyConfigHealthChecks build() {
            final var _resultValue = new GetWaasPolicyPolicyConfigHealthChecks();
