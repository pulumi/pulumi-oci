...
public final class GetWaasPolicyWafConfigAccessRuleCriteria {
    ...
    public static final class Builder {
        ...
        public Builder condition(String condition) {
            if (condition == null) {
              throw new MissingRequiredPropertyException("GetWaasPolicyWafConfigAccessRuleCriteria", "condition");
            }
        ...
        public Builder isCaseSensitive(Boolean isCaseSensitive) {
            if (isCaseSensitive == null) {
              throw new MissingRequiredPropertyException("GetWaasPolicyWafConfigAccessRuleCriteria", "isCaseSensitive");
            }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetWaasPolicyWafConfigAccessRuleCriteria", "value");
            }
            this.value = value;
            return this;
        }
        public GetWaasPolicyWafConfigAccessRuleCriteria build() {
            final var _resultValue = new GetWaasPolicyWafConfigAccessRuleCriteria();
