...
@CustomType
public final class GetWaasPolicyWafConfigCachingRuleCriteria {
    /**
    ...
    private GetWaasPolicyWafConfigCachingRuleCriteria() {}
    /**
     * @return The criteria the access rule and JavaScript Challenge uses to determine if action should be taken on a request.
     * * **URL_IS:** Matches if the concatenation of request URL path and query is identical to the contents of the `value` field. URL must start with a `/`.
     * * **URL_IS_NOT:** Matches if the concatenation of request URL path and query is not identical to the contents of the `value` field. URL must start with a `/`.
    ...
    public static Builder builder(GetWaasPolicyWafConfigCachingRuleCriteria defaults) {
    ...
    public static final class Builder {
        ...
        private String value;
        public Builder() {}
        public Builder(GetWaasPolicyWafConfigCachingRuleCriteria defaults) {
        ...
        public Builder condition(String condition) {
            if (condition == null) {
              throw new MissingRequiredPropertyException("GetWaasPolicyWafConfigCachingRuleCriteria", "condition");
            }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetWaasPolicyWafConfigCachingRuleCriteria", "value");
            }
            this.value = value;
            return this;
        }
