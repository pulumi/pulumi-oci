...
public final class GetWaasPolicyWafConfigDeviceFingerprintChallengeChallengeSettings {
    ...
    public static final class Builder {
        ...
        public Builder blockAction(String blockAction) {
            if (blockAction == null) {
              throw new MissingRequiredPropertyException("GetWaasPolicyWafConfigDeviceFingerprintChallengeChallengeSettings", "blockAction");
            }
        ...
        public Builder blockErrorPageCode(String blockErrorPageCode) {
            if (blockErrorPageCode == null) {
              throw new MissingRequiredPropertyException("GetWaasPolicyWafConfigDeviceFingerprintChallengeChallengeSettings", "blockErrorPageCode");
            }
        ...
        public Builder blockErrorPageDescription(String blockErrorPageDescription) {
            if (blockErrorPageDescription == null) {
              throw new MissingRequiredPropertyException("GetWaasPolicyWafConfigDeviceFingerprintChallengeChallengeSettings", "blockErrorPageDescription");
            }
        ...
        public Builder blockErrorPageMessage(String blockErrorPageMessage) {
            if (blockErrorPageMessage == null) {
              throw new MissingRequiredPropertyException("GetWaasPolicyWafConfigDeviceFingerprintChallengeChallengeSettings", "blockErrorPageMessage");
            }
        ...
        public Builder blockResponseCode(Integer blockResponseCode) {
            if (blockResponseCode == null) {
              throw new MissingRequiredPropertyException("GetWaasPolicyWafConfigDeviceFingerprintChallengeChallengeSettings", "blockResponseCode");
            }
        ...
        public Builder captchaFooter(String captchaFooter) {
            if (captchaFooter == null) {
              throw new MissingRequiredPropertyException("GetWaasPolicyWafConfigDeviceFingerprintChallengeChallengeSettings", "captchaFooter");
            }
        ...
        public Builder captchaHeader(String captchaHeader) {
            if (captchaHeader == null) {
              throw new MissingRequiredPropertyException("GetWaasPolicyWafConfigDeviceFingerprintChallengeChallengeSettings", "captchaHeader");
            }
        ...
        public Builder captchaSubmitLabel(String captchaSubmitLabel) {
            if (captchaSubmitLabel == null) {
              throw new MissingRequiredPropertyException("GetWaasPolicyWafConfigDeviceFingerprintChallengeChallengeSettings", "captchaSubmitLabel");
            }
        ...
        public Builder captchaTitle(String captchaTitle) {
            if (captchaTitle == null) {
              throw new MissingRequiredPropertyException("GetWaasPolicyWafConfigDeviceFingerprintChallengeChallengeSettings", "captchaTitle");
            }
            this.captchaTitle = captchaTitle;
            return this;
        }
        public GetWaasPolicyWafConfigDeviceFingerprintChallengeChallengeSettings build() {
            final var _resultValue = new GetWaasPolicyWafConfigDeviceFingerprintChallengeChallengeSettings();
