...
public final class GetWaasPolicyWafConfigJsChallengeCriteria {
    ...
    public static final class Builder {
        ...
        public Builder condition(String condition) {
            if (condition == null) {
              throw new MissingRequiredPropertyException("GetWaasPolicyWafConfigJsChallengeCriteria", "condition");
            }
        ...
        public Builder isCaseSensitive(Boolean isCaseSensitive) {
            if (isCaseSensitive == null) {
              throw new MissingRequiredPropertyException("GetWaasPolicyWafConfigJsChallengeCriteria", "isCaseSensitive");
            }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("GetWaasPolicyWafConfigJsChallengeCriteria", "value");
            }
            this.value = value;
            return this;
        }
        public GetWaasPolicyWafConfigJsChallengeCriteria build() {
            final var _resultValue = new GetWaasPolicyWafConfigJsChallengeCriteria();
