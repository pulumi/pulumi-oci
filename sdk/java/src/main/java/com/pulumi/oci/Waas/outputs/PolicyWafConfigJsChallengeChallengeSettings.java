...
@CustomType
public final class PolicyWafConfigJsChallengeChallengeSettings {
    /**
    ...
    private PolicyWafConfigJsChallengeChallengeSettings() {}
    /**
     * @return (Updatable) If `action` is set to `BLOCK`, this specifies how the traffic is blocked when detected as malicious by a protection rule. If unspecified, defaults to `SET_RESPONSE_CODE`.
     * 
     */
    ...
    public static Builder builder(PolicyWafConfigJsChallengeChallengeSettings defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String captchaTitle;
        public Builder() {}
        public Builder(PolicyWafConfigJsChallengeChallengeSettings defaults) {
        ...
        public PolicyWafConfigJsChallengeChallengeSettings build() {
            final var _resultValue = new PolicyWafConfigJsChallengeChallengeSettings();
