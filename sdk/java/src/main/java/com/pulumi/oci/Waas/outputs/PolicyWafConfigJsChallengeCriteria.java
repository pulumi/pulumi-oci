...
public final class PolicyWafConfigJsChallengeCriteria {
    ...
    public static final class Builder {
        ...
        public Builder condition(String condition) {
            if (condition == null) {
              throw new MissingRequiredPropertyException("PolicyWafConfigJsChallengeCriteria", "condition");
            }
        ...
        public Builder value(String value) {
            if (value == null) {
              throw new MissingRequiredPropertyException("PolicyWafConfigJsChallengeCriteria", "value");
            }
            this.value = value;
            return this;
        }
