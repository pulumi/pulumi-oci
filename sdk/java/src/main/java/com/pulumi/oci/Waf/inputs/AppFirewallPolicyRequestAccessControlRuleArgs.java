...
public final class AppFirewallPolicyRequestAccessControlRuleArgs extends com.pulumi.resources.ResourceArgs {
    ...
    public static final class Builder {
        ...
        public AppFirewallPolicyRequestAccessControlRuleArgs build() {
            if ($.actionName == null) {
                throw new MissingRequiredPropertyException("AppFirewallPolicyRequestAccessControlRuleArgs", "actionName");
            }
            if ($.name == null) {
                throw new MissingRequiredPropertyException("AppFirewallPolicyRequestAccessControlRuleArgs", "name");
            }
            if ($.type == null) {
                throw new MissingRequiredPropertyException("AppFirewallPolicyRequestAccessControlRuleArgs", "type");
            }
            return $;
        }
    }
