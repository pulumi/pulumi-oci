...
public final class AppFirewallPolicyRequestProtectionRuleProtectionCapabilitySettingsArgs extends com.pulumi.resources.ResourceArgs {

    public static final AppFirewallPolicyRequestProtectionRuleProtectionCapabilitySettingsArgs Empty = new AppFirewallPolicyRequestProtectionRuleProtectionCapabilitySettingsArgs();
    ...
    private AppFirewallPolicyRequestProtectionRuleProtectionCapabilitySettingsArgs() {}

    private AppFirewallPolicyRequestProtectionRuleProtectionCapabilitySettingsArgs(AppFirewallPolicyRequestProtectionRuleProtectionCapabilitySettingsArgs $) {
    ...
    public static Builder builder(AppFirewallPolicyRequestProtectionRuleProtectionCapabilitySettingsArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppFirewallPolicyRequestProtectionRuleProtectionCapabilitySettingsArgs();
        }

        public Builder(AppFirewallPolicyRequestProtectionRuleProtectionCapabilitySettingsArgs defaults) {
            $ = new AppFirewallPolicyRequestProtectionRuleProtectionCapabilitySettingsArgs(Objects.requireNonNull(defaults));
        }
        ...
        public AppFirewallPolicyRequestProtectionRuleProtectionCapabilitySettingsArgs build() {
            return $;
        }
    }
