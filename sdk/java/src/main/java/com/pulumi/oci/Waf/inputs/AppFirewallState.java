...
public final class AppFirewallState extends com.pulumi.resources.ResourceArgs {

    public static final AppFirewallState Empty = new AppFirewallState();
    ...
    private AppFirewallState() {}

    private AppFirewallState(AppFirewallState $) {
    ...
    public static Builder builder(AppFirewallState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AppFirewallState();
        }

        public Builder(AppFirewallState defaults) {
            $ = new AppFirewallState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param state The current state of the WebAppFirewall.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param timeCreated The time the WebAppFirewall was created. An RFC3339 formatted datetime string.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param timeUpdated The time the WebAppFirewall was updated. An RFC3339 formatted datetime string.
         * 
         * @return builder
         * 
         */
