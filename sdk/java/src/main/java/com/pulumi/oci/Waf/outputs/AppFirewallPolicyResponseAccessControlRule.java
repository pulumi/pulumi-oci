...
public final class AppFirewallPolicyResponseAccessControlRule {
    ...
    public static final class Builder {
        ...
        public Builder actionName(String actionName) {
            if (actionName == null) {
              throw new MissingRequiredPropertyException("AppFirewallPolicyResponseAccessControlRule", "actionName");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("AppFirewallPolicyResponseAccessControlRule", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("AppFirewallPolicyResponseAccessControlRule", "type");
            }
            this.type = type;
            return this;
        }
        public AppFirewallPolicyResponseAccessControlRule build() {
            final var _resultValue = new AppFirewallPolicyResponseAccessControlRule();
