    ...
    public static final class Builder {
        ...
        public Builder allowedHttpMethods(List<String> allowedHttpMethods) {
            if (allowedHttpMethods == null) {
              throw new MissingRequiredPropertyException("GetWebAppFirewallPolicyRequestProtectionRuleProtectionCapabilitySetting", "allowedHttpMethods");
            }
        ...
        public Builder maxHttpRequestHeaderLength(Integer maxHttpRequestHeaderLength) {
            if (maxHttpRequestHeaderLength == null) {
              throw new MissingRequiredPropertyException("GetWebAppFirewallPolicyRequestProtectionRuleProtectionCapabilitySetting", "maxHttpRequestHeaderLength");
            }
        ...
        public Builder maxHttpRequestHeaders(Integer maxHttpRequestHeaders) {
            if (maxHttpRequestHeaders == null) {
              throw new MissingRequiredPropertyException("GetWebAppFirewallPolicyRequestProtectionRuleProtectionCapabilitySetting", "maxHttpRequestHeaders");
            }
        ...
        public Builder maxNumberOfArguments(Integer maxNumberOfArguments) {
            if (maxNumberOfArguments == null) {
              throw new MissingRequiredPropertyException("GetWebAppFirewallPolicyRequestProtectionRuleProtectionCapabilitySetting", "maxNumberOfArguments");
            }
        ...
        public Builder maxSingleArgumentLength(Integer maxSingleArgumentLength) {
            if (maxSingleArgumentLength == null) {
              throw new MissingRequiredPropertyException("GetWebAppFirewallPolicyRequestProtectionRuleProtectionCapabilitySetting", "maxSingleArgumentLength");
            }
        ...
        public Builder maxTotalArgumentLength(Integer maxTotalArgumentLength) {
            if (maxTotalArgumentLength == null) {
              throw new MissingRequiredPropertyException("GetWebAppFirewallPolicyRequestProtectionRuleProtectionCapabilitySetting", "maxTotalArgumentLength");
            }
