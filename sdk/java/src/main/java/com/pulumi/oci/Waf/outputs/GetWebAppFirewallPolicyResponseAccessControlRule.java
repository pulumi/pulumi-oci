...
public final class GetWebAppFirewallPolicyResponseAccessControlRule {
    ...
    public static final class Builder {
        ...
        public Builder actionName(String actionName) {
            if (actionName == null) {
              throw new MissingRequiredPropertyException("GetWebAppFirewallPolicyResponseAccessControlRule", "actionName");
            }
        ...
        public Builder condition(String condition) {
            if (condition == null) {
              throw new MissingRequiredPropertyException("GetWebAppFirewallPolicyResponseAccessControlRule", "condition");
            }
        ...
        public Builder conditionLanguage(String conditionLanguage) {
            if (conditionLanguage == null) {
              throw new MissingRequiredPropertyException("GetWebAppFirewallPolicyResponseAccessControlRule", "conditionLanguage");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetWebAppFirewallPolicyResponseAccessControlRule", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetWebAppFirewallPolicyResponseAccessControlRule", "type");
            }
            this.type = type;
            return this;
        }
