...
public final class GetWebAppFirewallPolicyResponseProtectionRuleProtectionCapabilityExclusion {
    ...
    public static final class Builder {
        ...
        public Builder args(List<String> args) {
            if (args == null) {
              throw new MissingRequiredPropertyException("GetWebAppFirewallPolicyResponseProtectionRuleProtectionCapabilityExclusion", "args");
            }
            this.args = args;
            return this;
        }
        ...
        public Builder requestCookies(List<String> requestCookies) {
            if (requestCookies == null) {
              throw new MissingRequiredPropertyException("GetWebAppFirewallPolicyResponseProtectionRuleProtectionCapabilityExclusion", "requestCookies");
            }
        ...
        public GetWebAppFirewallPolicyResponseProtectionRuleProtectionCapabilityExclusion build() {
            final var _resultValue = new GetWebAppFirewallPolicyResponseProtectionRuleProtectionCapabilityExclusion();
