...
import com.pulumi.oci.oci.inputs.DbmulticloudOracleDbAzureVaultAssociationState;
...
public class DbmulticloudOracleDbAzureVaultAssociation extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="oracleDbAzureVaultId", refs={String.class}, tree="[0]")
     ...
     */
    public DbmulticloudOracleDbAzureVaultAssociation(java.lang.String name) {
        this(name, DbmulticloudOracleDbAzureVaultAssociationArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public DbmulticloudOracleDbAzureVaultAssociation(java.lang.String name, DbmulticloudOracleDbAzureVaultAssociationArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DbmulticloudOracleDbAzureVaultAssociation(java.lang.String name, DbmulticloudOracleDbAzureVaultAssociationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:oci/dbmulticloudOracleDbAzureVaultAssociation:DbmulticloudOracleDbAzureVaultAssociation", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DbmulticloudOracleDbAzureVaultAssociation(java.lang.String name, Output<java.lang.String> id, @Nullable DbmulticloudOracleDbAzureVaultAssociationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:oci/dbmulticloudOracleDbAzureVaultAssociation:DbmulticloudOracleDbAzureVaultAssociation", name, state, makeResourceOptions(options, id), false);
    }

    private static DbmulticloudOracleDbAzureVaultAssociationArgs makeArgs(DbmulticloudOracleDbAzureVaultAssociationArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? DbmulticloudOracleDbAzureVaultAssociationArgs.Empty : args;
    }
     ...
     */
    public static DbmulticloudOracleDbAzureVaultAssociation get(java.lang.String name, Output<java.lang.String> id, @Nullable DbmulticloudOracleDbAzureVaultAssociationState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
