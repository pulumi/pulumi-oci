...
public class DbmulticloudOracleDbGcpKeyRing extends com.pulumi.resources.CustomResource {
     ...
     * 
     */
    @Export(name="gcpKeyRingId", refs={String.class}, tree="[0]")
    private Output<String> gcpKeyRingId;

    /**
     * @return GCP Key Ring ID.
     * 
     */
    public Output<String> gcpKeyRingId() {
     ...
     */
    public DbmulticloudOracleDbGcpKeyRing(java.lang.String name) {
        this(name, DbmulticloudOracleDbGcpKeyRingArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public DbmulticloudOracleDbGcpKeyRing(java.lang.String name, DbmulticloudOracleDbGcpKeyRingArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public DbmulticloudOracleDbGcpKeyRing(java.lang.String name, DbmulticloudOracleDbGcpKeyRingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:oci/dbmulticloudOracleDbGcpKeyRing:DbmulticloudOracleDbGcpKeyRing", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private DbmulticloudOracleDbGcpKeyRing(java.lang.String name, Output<java.lang.String> id, @Nullable DbmulticloudOracleDbGcpKeyRingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:oci/dbmulticloudOracleDbGcpKeyRing:DbmulticloudOracleDbGcpKeyRing", name, state, makeResourceOptions(options, id), false);
    }

    private static DbmulticloudOracleDbGcpKeyRingArgs makeArgs(DbmulticloudOracleDbGcpKeyRingArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? DbmulticloudOracleDbGcpKeyRingArgs.Empty : args;
    }
     ...
     */
    public static DbmulticloudOracleDbGcpKeyRing get(java.lang.String name, Output<java.lang.String> id, @Nullable DbmulticloudOracleDbGcpKeyRingState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
