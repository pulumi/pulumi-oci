...
import com.pulumi.oci.oci.LustreFileStorageLustreFileSystemArgs;
import com.pulumi.oci.oci.inputs.LustreFileStorageLustreFileSystemState;
import com.pulumi.oci.oci.outputs.LustreFileStorageLustreFileSystemMaintenanceWindow;
import com.pulumi.oci.oci.outputs.LustreFileStorageLustreFileSystemRootSquashConfiguration;
 ...
 * 
 * @deprecated
 * oci.oci/lustrefilestoragelustrefilesystem.LustreFileStorageLustreFileSystem has been deprecated in favor of oci.lustre/filestoragelustrefilesystem.FileStorageLustreFileSystem
 * 
 */
...
@ResourceType(type="oci:oci/lustreFileStorageLustreFileSystem:LustreFileStorageLustreFileSystem")
public class LustreFileStorageLustreFileSystem extends com.pulumi.resources.CustomResource {
    /**
     ...
     * 
     */
    @Export(name="maintenanceWindows", refs={List.class,LustreFileStorageLustreFileSystemMaintenanceWindow.class}, tree="[0,1]")
    private Output<List<LustreFileStorageLustreFileSystemMaintenanceWindow>> maintenanceWindows;

    /**
     * @return The preferred day and time to perform maintenance.
     * 
     */
    public Output<List<LustreFileStorageLustreFileSystemMaintenanceWindow>> maintenanceWindows() {
     ...
     * 
     */
    @Export(name="rootSquashConfiguration", refs={LustreFileStorageLustreFileSystemRootSquashConfiguration.class}, tree="[0]")
    private Output<LustreFileStorageLustreFileSystemRootSquashConfiguration> rootSquashConfiguration;
     ...
     * 
     */
    public Output<LustreFileStorageLustreFileSystemRootSquashConfiguration> rootSquashConfiguration() {
     ...
     */
    public LustreFileStorageLustreFileSystem(java.lang.String name) {
        this(name, LustreFileStorageLustreFileSystemArgs.Empty);
    }
    /**
     *
     * @param name The _unique_ name of the resulting resource.
     ...
     */
    public LustreFileStorageLustreFileSystem(java.lang.String name, LustreFileStorageLustreFileSystemArgs args) {
        this(name, args, null);
    }
    /**
     *
     ...
     */
    public LustreFileStorageLustreFileSystem(java.lang.String name, LustreFileStorageLustreFileSystemArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:oci/lustreFileStorageLustreFileSystem:LustreFileStorageLustreFileSystem", name, makeArgs(args, options), makeResourceOptions(options, Codegen.empty()), false);
    }

    private LustreFileStorageLustreFileSystem(java.lang.String name, Output<java.lang.String> id, @Nullable LustreFileStorageLustreFileSystemState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        super("oci:oci/lustreFileStorageLustreFileSystem:LustreFileStorageLustreFileSystem", name, state, makeResourceOptions(options, id), false);
    }

    private static LustreFileStorageLustreFileSystemArgs makeArgs(LustreFileStorageLustreFileSystemArgs args, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        if (options != null && options.getUrn().isPresent()) {
            return null;
        }
        return args == null ? LustreFileStorageLustreFileSystemArgs.Empty : args;
    }
     ...
     */
    public static LustreFileStorageLustreFileSystem get(java.lang.String name, Output<java.lang.String> id, @Nullable LustreFileStorageLustreFileSystemState state, @Nullable com.pulumi.resources.CustomResourceOptions options) {
        return new LustreFileStorageLustreFileSystem(name, id, state, options);
    }
}
