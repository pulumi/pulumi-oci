...
public final class DataccVmClusterNetworkVmNetworkNodeArgs extends com.pulumi.resources.ResourceArgs {

    public static final DataccVmClusterNetworkVmNetworkNodeArgs Empty = new DataccVmClusterNetworkVmNetworkNodeArgs();
    ...
    private DataccVmClusterNetworkVmNetworkNodeArgs() {}

    private DataccVmClusterNetworkVmNetworkNodeArgs(DataccVmClusterNetworkVmNetworkNodeArgs $) {
    ...
    public static Builder builder(DataccVmClusterNetworkVmNetworkNodeArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DataccVmClusterNetworkVmNetworkNodeArgs();
        }

        public Builder(DataccVmClusterNetworkVmNetworkNodeArgs defaults) {
            $ = new DataccVmClusterNetworkVmNetworkNodeArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DataccVmClusterNetworkVmNetworkNodeArgs build() {
            if ($.hostname == null) {
                throw new MissingRequiredPropertyException("DataccVmClusterNetworkVmNetworkNodeArgs", "hostname");
            }
            if ($.ip == null) {
                throw new MissingRequiredPropertyException("DataccVmClusterNetworkVmNetworkNodeArgs", "ip");
            }
            return $;
        }
    }
