...
public final class DbmulticloudOracleDbAzureBlobContainerState extends com.pulumi.resources.ResourceArgs {

    public static final DbmulticloudOracleDbAzureBlobContainerState Empty = new DbmulticloudOracleDbAzureBlobContainerState();
    ...
    private DbmulticloudOracleDbAzureBlobContainerState() {}

    private DbmulticloudOracleDbAzureBlobContainerState(DbmulticloudOracleDbAzureBlobContainerState $) {
    ...
    public static Builder builder(DbmulticloudOracleDbAzureBlobContainerState defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DbmulticloudOracleDbAzureBlobContainerState();
        }

        public Builder(DbmulticloudOracleDbAzureBlobContainerState defaults) {
            $ = new DbmulticloudOracleDbAzureBlobContainerState(Objects.requireNonNull(defaults));
        }
        ...
        /**
         * @param lastModification Description of the latest modification of the Oracle DB Azure Blob Container Resource.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param state The current lifecycle state of the Oracle DB Azure Blob Container Resource.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param timeCreated Time when the Oracle DB Azure Blob Container was created in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format, e.g. &#39;2020-05-22T21:10:29.600Z&#39;
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param timeUpdated Time when the Oracle DB Azure Blob Container was last modified, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format, e.g. &#39;2020-05-22T21:10:29.600Z&#39;
         * 
         * @return builder
         * 
         */
        ...
        public DbmulticloudOracleDbAzureBlobContainerState build() {
            return $;
        }
    }
