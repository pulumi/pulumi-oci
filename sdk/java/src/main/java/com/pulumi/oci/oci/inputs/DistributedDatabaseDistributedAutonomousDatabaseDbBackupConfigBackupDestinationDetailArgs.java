...
public final class DistributedDatabaseDistributedAutonomousDatabaseDbBackupConfigBackupDestinationDetailArgs extends com.pulumi.resources.ResourceArgs {

    public static final DistributedDatabaseDistributedAutonomousDatabaseDbBackupConfigBackupDestinationDetailArgs Empty = new DistributedDatabaseDistributedAutonomousDatabaseDbBackupConfigBackupDestinationDetailArgs();
    ...
    private DistributedDatabaseDistributedAutonomousDatabaseDbBackupConfigBackupDestinationDetailArgs() {}

    private DistributedDatabaseDistributedAutonomousDatabaseDbBackupConfigBackupDestinationDetailArgs(DistributedDatabaseDistributedAutonomousDatabaseDbBackupConfigBackupDestinationDetailArgs $) {
    ...
    public static Builder builder(DistributedDatabaseDistributedAutonomousDatabaseDbBackupConfigBackupDestinationDetailArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DistributedDatabaseDistributedAutonomousDatabaseDbBackupConfigBackupDestinationDetailArgs();
        }

        public Builder(DistributedDatabaseDistributedAutonomousDatabaseDbBackupConfigBackupDestinationDetailArgs defaults) {
            $ = new DistributedDatabaseDistributedAutonomousDatabaseDbBackupConfigBackupDestinationDetailArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DistributedDatabaseDistributedAutonomousDatabaseDbBackupConfigBackupDestinationDetailArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("DistributedDatabaseDistributedAutonomousDatabaseDbBackupConfigBackupDestinationDetailArgs", "type");
            }
            return $;
        }
    }
