...
import com.pulumi.oci.oci.inputs.DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailMetadataArgs;
...
public final class DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailArgs extends com.pulumi.resources.ResourceArgs {

    public static final DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailArgs Empty = new DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailArgs();
    ...
    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the cloud Autonomous VM Cluster for the peer shard.
     * 
     */
    ...
    private @Nullable Output<List<DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailMetadataArgs>> metadatas;

    /**
     * @return Additional metadata related to Globally distributed autonomous database resources.
     * 
     */
    public Optional<Output<List<DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailMetadataArgs>>> metadatas() {
    ...
    private DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailArgs() {}

    private DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailArgs(DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailArgs $) {
    ...
    public static Builder builder(DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailArgs();
        }

        public Builder(DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailArgs defaults) {
            $ = new DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param cloudAutonomousVmClusterId The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the cloud Autonomous VM Cluster for the peer shard.
         * 
         * @return builder
         * 
         */
         ...
         * 
         */
        public Builder metadatas(@Nullable Output<List<DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailMetadataArgs>> metadatas) {
            $.metadatas = metadatas;
            return this;
        }
         ...
         * 
         */
        public Builder metadatas(List<DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailMetadataArgs> metadatas) {
         ...
         * 
         */
        public Builder metadatas(DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailMetadataArgs... metadatas) {
        ...
        public DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailArgs build() {
            if ($.cloudAutonomousVmClusterId == null) {
                throw new MissingRequiredPropertyException("DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailArgs", "cloudAutonomousVmClusterId");
            }
            return $;
        }
    }
