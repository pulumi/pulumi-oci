...
public final class DistributedDatabaseDistributedDatabaseDbBackupConfigBackupDestinationDetailArgs extends com.pulumi.resources.ResourceArgs {

    public static final DistributedDatabaseDistributedDatabaseDbBackupConfigBackupDestinationDetailArgs Empty = new DistributedDatabaseDistributedDatabaseDbBackupConfigBackupDestinationDetailArgs();
    ...
    private DistributedDatabaseDistributedDatabaseDbBackupConfigBackupDestinationDetailArgs() {}

    private DistributedDatabaseDistributedDatabaseDbBackupConfigBackupDestinationDetailArgs(DistributedDatabaseDistributedDatabaseDbBackupConfigBackupDestinationDetailArgs $) {
    ...
    public static Builder builder(DistributedDatabaseDistributedDatabaseDbBackupConfigBackupDestinationDetailArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new DistributedDatabaseDistributedDatabaseDbBackupConfigBackupDestinationDetailArgs();
        }

        public Builder(DistributedDatabaseDistributedDatabaseDbBackupConfigBackupDestinationDetailArgs defaults) {
            $ = new DistributedDatabaseDistributedDatabaseDbBackupConfigBackupDestinationDetailArgs(Objects.requireNonNull(defaults));
        }
        ...
        public DistributedDatabaseDistributedDatabaseDbBackupConfigBackupDestinationDetailArgs build() {
            if ($.type == null) {
                throw new MissingRequiredPropertyException("DistributedDatabaseDistributedDatabaseDbBackupConfigBackupDestinationDetailArgs", "type");
            }
            return $;
        }
    }
