...
import com.pulumi.oci.oci.inputs.GetApiaccesscontrolPrivilegedApiControlsFilter;
...
public final class GetApiaccesscontrolPrivilegedApiControlsPlainArgs extends com.pulumi.resources.InvokeArgs {

    public static final GetApiaccesscontrolPrivilegedApiControlsPlainArgs Empty = new GetApiaccesscontrolPrivilegedApiControlsPlainArgs();
    ...
    public Optional<List<GetApiaccesscontrolPrivilegedApiControlsFilter>> filters() {
    ...
    private GetApiaccesscontrolPrivilegedApiControlsPlainArgs() {}

    private GetApiaccesscontrolPrivilegedApiControlsPlainArgs(GetApiaccesscontrolPrivilegedApiControlsPlainArgs $) {
    ...
    public static Builder builder(GetApiaccesscontrolPrivilegedApiControlsPlainArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetApiaccesscontrolPrivilegedApiControlsPlainArgs();
        }

        public Builder(GetApiaccesscontrolPrivilegedApiControlsPlainArgs defaults) {
            $ = new GetApiaccesscontrolPrivilegedApiControlsPlainArgs(Objects.requireNonNull(defaults));
        }
        ...
        public GetApiaccesscontrolPrivilegedApiControlsPlainArgs build() {
            return $;
        }
    }
