...
public final class LustreFileStorageLustreFileSystemMaintenanceWindowArgs extends com.pulumi.resources.ResourceArgs {

    public static final LustreFileStorageLustreFileSystemMaintenanceWindowArgs Empty = new LustreFileStorageLustreFileSystemMaintenanceWindowArgs();
    ...
    private LustreFileStorageLustreFileSystemMaintenanceWindowArgs() {}

    private LustreFileStorageLustreFileSystemMaintenanceWindowArgs(LustreFileStorageLustreFileSystemMaintenanceWindowArgs $) {
    ...
    public static Builder builder(LustreFileStorageLustreFileSystemMaintenanceWindowArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new LustreFileStorageLustreFileSystemMaintenanceWindowArgs();
        }

        public Builder(LustreFileStorageLustreFileSystemMaintenanceWindowArgs defaults) {
            $ = new LustreFileStorageLustreFileSystemMaintenanceWindowArgs(Objects.requireNonNull(defaults));
        }
        ...
        public LustreFileStorageLustreFileSystemMaintenanceWindowArgs build() {
            return $;
        }
    }
