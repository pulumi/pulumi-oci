...
public final class BatchBatchContextLoggingConfiguration {
    ...
    public static Builder builder(BatchBatchContextLoggingConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        public Builder logGroupId(String logGroupId) {
            if (logGroupId == null) {
              throw new MissingRequiredPropertyException("BatchBatchContextLoggingConfiguration", "logGroupId");
            }
        ...
        public Builder logId(String logId) {
            if (logId == null) {
              throw new MissingRequiredPropertyException("BatchBatchContextLoggingConfiguration", "logId");
            }
            this.logId = logId;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("BatchBatchContextLoggingConfiguration", "type");
            }
            this.type = type;
            return this;
        }
