...
@CustomType
public final class DistributedDatabaseDistributedAutonomousDatabaseDbBackupConfigBackupDestinationDetail {
    /**
    ...
    private DistributedDatabaseDistributedAutonomousDatabaseDbBackupConfigBackupDestinationDetail() {}
    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DBRS policy used for backup.
     * 
     */
    ...
    public static Builder builder(DistributedDatabaseDistributedAutonomousDatabaseDbBackupConfigBackupDestinationDetail defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String vpcUser;
        public Builder() {}
        public Builder(DistributedDatabaseDistributedAutonomousDatabaseDbBackupConfigBackupDestinationDetail defaults) {
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("DistributedDatabaseDistributedAutonomousDatabaseDbBackupConfigBackupDestinationDetail", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public DistributedDatabaseDistributedAutonomousDatabaseDbBackupConfigBackupDestinationDetail build() {
            final var _resultValue = new DistributedDatabaseDistributedAutonomousDatabaseDbBackupConfigBackupDestinationDetail();
