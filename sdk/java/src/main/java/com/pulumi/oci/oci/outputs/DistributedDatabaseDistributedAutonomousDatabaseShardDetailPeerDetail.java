...
import com.pulumi.oci.oci.outputs.DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailMetadata;
...
@CustomType
public final class DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetail {
    /**
     ...
     * 
     */
    private @Nullable List<DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailMetadata> metadatas;
    /**
     ...
     * 
     */
    public List<DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailMetadata> metadatas() {
    ...
    public static Builder builder(DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetail defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable String timeUpdated;
        public Builder() {}
        public Builder(DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetail defaults) {
        ...
        public Builder cloudAutonomousVmClusterId(String cloudAutonomousVmClusterId) {
            if (cloudAutonomousVmClusterId == null) {
              throw new MissingRequiredPropertyException("DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetail", "cloudAutonomousVmClusterId");
            }
        ...
        @CustomType.Setter
        public Builder metadatas(@Nullable List<DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailMetadata> metadatas) {

            this.metadatas = metadatas;
            return this;
        }
        public Builder metadatas(DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetailMetadata... metadatas) {
        ...
        public DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetail build() {
            final var _resultValue = new DistributedDatabaseDistributedAutonomousDatabaseShardDetailPeerDetail();
