...
public final class GetBatchBatchContextLoggingConfiguration {
    ...
    public static Builder builder(GetBatchBatchContextLoggingConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        public Builder logGroupId(String logGroupId) {
            if (logGroupId == null) {
              throw new MissingRequiredPropertyException("GetBatchBatchContextLoggingConfiguration", "logGroupId");
            }
        ...
        public Builder logId(String logId) {
            if (logId == null) {
              throw new MissingRequiredPropertyException("GetBatchBatchContextLoggingConfiguration", "logId");
            }
            this.logId = logId;
            return this;
        }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetBatchBatchContextLoggingConfiguration", "type");
            }
            this.type = type;
            return this;
        }
