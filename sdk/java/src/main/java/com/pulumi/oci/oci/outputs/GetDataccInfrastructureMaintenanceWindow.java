...
@CustomType
public final class GetDataccInfrastructureMaintenanceWindow {
    /**
    ...
    private GetDataccInfrastructureMaintenanceWindow() {}
    /**
     * @return Determines the amount of time the system will wait before the start of each Database Infrastructure server patching operation. Custom action timeout is in minutes and valid value is between 15 to 120 (inclusive).
     * 
     */
    ...
    public static Builder builder(GetDataccInfrastructureMaintenanceWindow defaults) {
    ...
    public static final class Builder {
        ...
        private List<Integer> weeksOfMonths;
        public Builder() {}
        public Builder(GetDataccInfrastructureMaintenanceWindow defaults) {
        ...
        public Builder customActionTimeoutInMins(Integer customActionTimeoutInMins) {
            if (customActionTimeoutInMins == null) {
              throw new MissingRequiredPropertyException("GetDataccInfrastructureMaintenanceWindow", "customActionTimeoutInMins");
            }
        ...
        public Builder daysOfWeeks(List<String> daysOfWeeks) {
            if (daysOfWeeks == null) {
              throw new MissingRequiredPropertyException("GetDataccInfrastructureMaintenanceWindow", "daysOfWeeks");
            }
        ...
        public Builder hoursOfDays(List<Integer> hoursOfDays) {
            if (hoursOfDays == null) {
              throw new MissingRequiredPropertyException("GetDataccInfrastructureMaintenanceWindow", "hoursOfDays");
            }
        ...
        public Builder isCustomActionTimeoutEnabled(Boolean isCustomActionTimeoutEnabled) {
            if (isCustomActionTimeoutEnabled == null) {
              throw new MissingRequiredPropertyException("GetDataccInfrastructureMaintenanceWindow", "isCustomActionTimeoutEnabled");
            }
        ...
        public Builder isMonthlyPatchingEnabled(Boolean isMonthlyPatchingEnabled) {
            if (isMonthlyPatchingEnabled == null) {
              throw new MissingRequiredPropertyException("GetDataccInfrastructureMaintenanceWindow", "isMonthlyPatchingEnabled");
            }
        ...
        public Builder leadTimeInWeeks(Integer leadTimeInWeeks) {
            if (leadTimeInWeeks == null) {
              throw new MissingRequiredPropertyException("GetDataccInfrastructureMaintenanceWindow", "leadTimeInWeeks");
            }
        ...
        public Builder months(List<String> months) {
            if (months == null) {
              throw new MissingRequiredPropertyException("GetDataccInfrastructureMaintenanceWindow", "months");
            }
            this.months = months;
            return this;
        }
        ...
        public Builder patchingMode(String patchingMode) {
            if (patchingMode == null) {
              throw new MissingRequiredPropertyException("GetDataccInfrastructureMaintenanceWindow", "patchingMode");
            }
        ...
        public Builder preference(String preference) {
            if (preference == null) {
              throw new MissingRequiredPropertyException("GetDataccInfrastructureMaintenanceWindow", "preference");
            }
        ...
        public Builder weeksOfMonths(List<Integer> weeksOfMonths) {
            if (weeksOfMonths == null) {
              throw new MissingRequiredPropertyException("GetDataccInfrastructureMaintenanceWindow", "weeksOfMonths");
            }
        ...
        public GetDataccInfrastructureMaintenanceWindow build() {
            final var _resultValue = new GetDataccInfrastructureMaintenanceWindow();
