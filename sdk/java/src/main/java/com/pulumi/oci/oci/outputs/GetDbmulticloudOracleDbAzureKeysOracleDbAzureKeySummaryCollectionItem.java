...
public final class GetDbmulticloudOracleDbAzureKeysOracleDbAzureKeySummaryCollectionItem {
    ...
    public static Builder builder(GetDbmulticloudOracleDbAzureKeysOracleDbAzureKeySummaryCollectionItem defaults) {
    ...
    public static final class Builder {
        ...
        private String timeUpdated;
        public Builder() {}
        public Builder(GetDbmulticloudOracleDbAzureKeysOracleDbAzureKeySummaryCollectionItem defaults) {
        ...
        public Builder azureKeyId(String azureKeyId) {
            if (azureKeyId == null) {
              throw new MissingRequiredPropertyException("GetDbmulticloudOracleDbAzureKeysOracleDbAzureKeySummaryCollectionItem", "azureKeyId");
            }
        ...
        public Builder compartmentId(String compartmentId) {
            if (compartmentId == null) {
              throw new MissingRequiredPropertyException("GetDbmulticloudOracleDbAzureKeysOracleDbAzureKeySummaryCollectionItem", "compartmentId");
            }
        ...
        public Builder definedTags(Map<String,String> definedTags) {
            if (definedTags == null) {
              throw new MissingRequiredPropertyException("GetDbmulticloudOracleDbAzureKeysOracleDbAzureKeySummaryCollectionItem", "definedTags");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetDbmulticloudOracleDbAzureKeysOracleDbAzureKeySummaryCollectionItem", "displayName");
            }
        ...
        public Builder freeformTags(Map<String,String> freeformTags) {
            if (freeformTags == null) {
              throw new MissingRequiredPropertyException("GetDbmulticloudOracleDbAzureKeysOracleDbAzureKeySummaryCollectionItem", "freeformTags");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetDbmulticloudOracleDbAzureKeysOracleDbAzureKeySummaryCollectionItem", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder lifecycleStateDetails(String lifecycleStateDetails) {
            if (lifecycleStateDetails == null) {
              throw new MissingRequiredPropertyException("GetDbmulticloudOracleDbAzureKeysOracleDbAzureKeySummaryCollectionItem", "lifecycleStateDetails");
            }
        ...
        public Builder state(String state) {
            if (state == null) {
              throw new MissingRequiredPropertyException("GetDbmulticloudOracleDbAzureKeysOracleDbAzureKeySummaryCollectionItem", "state");
            }
            this.state = state;
            return this;
        }
        ...
        public Builder systemTags(Map<String,String> systemTags) {
            if (systemTags == null) {
              throw new MissingRequiredPropertyException("GetDbmulticloudOracleDbAzureKeysOracleDbAzureKeySummaryCollectionItem", "systemTags");
            }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetDbmulticloudOracleDbAzureKeysOracleDbAzureKeySummaryCollectionItem", "timeCreated");
            }
        ...
        public Builder timeUpdated(String timeUpdated) {
            if (timeUpdated == null) {
              throw new MissingRequiredPropertyException("GetDbmulticloudOracleDbAzureKeysOracleDbAzureKeySummaryCollectionItem", "timeUpdated");
            }
            this.timeUpdated = timeUpdated;
            return this;
        }
        public GetDbmulticloudOracleDbAzureKeysOracleDbAzureKeySummaryCollectionItem build() {
            final var _resultValue = new GetDbmulticloudOracleDbAzureKeysOracleDbAzureKeySummaryCollectionItem();
