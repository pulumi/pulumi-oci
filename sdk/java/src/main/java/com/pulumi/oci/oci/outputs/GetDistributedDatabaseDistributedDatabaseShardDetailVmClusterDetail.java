...
@CustomType
public final class GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail {
    /**
    ...
    private GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail() {}
    /**
     * @return A list of the [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the network security groups (NSGs) that the backup network of this DB system belongs to.  Setting this to an empty array after the list is created removes the resource from all NSGs.  For more information about NSGs, see [Security Rules](https://docs.cloud.oracle.com/iaas/Content/Network/Concepts/securityrules.htm). Applicable only to Exadata systems.
     * 
     */
    ...
    public static Builder builder(GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail defaults) {
    ...
    public static final class Builder {
        ...
        private Integer vmFileSystemStorageSize;
        public Builder() {}
        public Builder(GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail defaults) {
        ...
        public Builder backupNetworkNsgIds(List<String> backupNetworkNsgIds) {
            if (backupNetworkNsgIds == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail", "backupNetworkNsgIds");
            }
        ...
        public Builder backupSubnetId(String backupSubnetId) {
            if (backupSubnetId == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail", "backupSubnetId");
            }
        ...
        public Builder displayName(String displayName) {
            if (displayName == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail", "displayName");
            }
        ...
        public Builder domain(String domain) {
            if (domain == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail", "domain");
            }
            this.domain = domain;
            return this;
        }
        ...
        public Builder enabledEcpuCount(Integer enabledEcpuCount) {
            if (enabledEcpuCount == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail", "enabledEcpuCount");
            }
        ...
        public Builder isDiagnosticsEventsEnabled(Boolean isDiagnosticsEventsEnabled) {
            if (isDiagnosticsEventsEnabled == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail", "isDiagnosticsEventsEnabled");
            }
        ...
        public Builder isHealthMonitoringEnabled(Boolean isHealthMonitoringEnabled) {
            if (isHealthMonitoringEnabled == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail", "isHealthMonitoringEnabled");
            }
        ...
        public Builder isIncidentLogsEnabled(Boolean isIncidentLogsEnabled) {
            if (isIncidentLogsEnabled == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail", "isIncidentLogsEnabled");
            }
        ...
        public Builder licenseModel(String licenseModel) {
            if (licenseModel == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail", "licenseModel");
            }
        ...
        public Builder nsgIds(List<String> nsgIds) {
            if (nsgIds == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail", "nsgIds");
            }
            this.nsgIds = nsgIds;
            return this;
        }
        ...
        public Builder privateZoneId(String privateZoneId) {
            if (privateZoneId == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail", "privateZoneId");
            }
        ...
        public Builder sshPublicKeys(List<String> sshPublicKeys) {
            if (sshPublicKeys == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail", "sshPublicKeys");
            }
        ...
        public Builder subnetId(String subnetId) {
            if (subnetId == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail", "subnetId");
            }
        ...
        public Builder totalEcpuCount(Integer totalEcpuCount) {
            if (totalEcpuCount == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail", "totalEcpuCount");
            }
        ...
        public Builder vmClusterId(String vmClusterId) {
            if (vmClusterId == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail", "vmClusterId");
            }
        ...
        public Builder vmFileSystemStorageSize(Integer vmFileSystemStorageSize) {
            if (vmFileSystemStorageSize == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail", "vmFileSystemStorageSize");
            }
            this.vmFileSystemStorageSize = vmFileSystemStorageSize;
            return this;
        }
        public GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail build() {
            final var _resultValue = new GetDistributedDatabaseDistributedDatabaseShardDetailVmClusterDetail();
