...
@CustomType
public final class GetDistributedDatabaseDistributedDatabasesDistributedDatabaseCollectionItemDbBackupConfigBackupDestinationDetail {
    /**
    ...
    private GetDistributedDatabaseDistributedDatabasesDistributedDatabaseCollectionItemDbBackupConfigBackupDestinationDetail() {}
    /**
     * @return The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DBRS policy used for backup.
     * 
     */
    ...
    public static Builder builder(GetDistributedDatabaseDistributedDatabasesDistributedDatabaseCollectionItemDbBackupConfigBackupDestinationDetail defaults) {
    ...
    public static final class Builder {
        ...
        private String vpcUser;
        public Builder() {}
        public Builder(GetDistributedDatabaseDistributedDatabasesDistributedDatabaseCollectionItemDbBackupConfigBackupDestinationDetail defaults) {
        ...
        public Builder dbrsPolicyId(String dbrsPolicyId) {
            if (dbrsPolicyId == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabasesDistributedDatabaseCollectionItemDbBackupConfigBackupDestinationDetail", "dbrsPolicyId");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabasesDistributedDatabaseCollectionItemDbBackupConfigBackupDestinationDetail", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder internetProxy(String internetProxy) {
            if (internetProxy == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabasesDistributedDatabaseCollectionItemDbBackupConfigBackupDestinationDetail", "internetProxy");
            }
        ...
        public Builder isRemote(Boolean isRemote) {
            if (isRemote == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabasesDistributedDatabaseCollectionItemDbBackupConfigBackupDestinationDetail", "isRemote");
            }
        ...
        public Builder isZeroDataLossEnabled(Boolean isZeroDataLossEnabled) {
            if (isZeroDataLossEnabled == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabasesDistributedDatabaseCollectionItemDbBackupConfigBackupDestinationDetail", "isZeroDataLossEnabled");
            }
        ...
        public Builder remoteRegion(String remoteRegion) {
            if (remoteRegion == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabasesDistributedDatabaseCollectionItemDbBackupConfigBackupDestinationDetail", "remoteRegion");
            }
        ...
        public Builder type(String type) {
            if (type == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabasesDistributedDatabaseCollectionItemDbBackupConfigBackupDestinationDetail", "type");
            }
            this.type = type;
            return this;
        }
        ...
        public Builder vpcPassword(String vpcPassword) {
            if (vpcPassword == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabasesDistributedDatabaseCollectionItemDbBackupConfigBackupDestinationDetail", "vpcPassword");
            }
        ...
        public Builder vpcUser(String vpcUser) {
            if (vpcUser == null) {
              throw new MissingRequiredPropertyException("GetDistributedDatabaseDistributedDatabasesDistributedDatabaseCollectionItemDbBackupConfigBackupDestinationDetail", "vpcUser");
            }
            this.vpcUser = vpcUser;
            return this;
        }
        public GetDistributedDatabaseDistributedDatabasesDistributedDatabaseCollectionItemDbBackupConfigBackupDestinationDetail build() {
            final var _resultValue = new GetDistributedDatabaseDistributedDatabasesDistributedDatabaseCollectionItemDbBackupConfigBackupDestinationDetail();
