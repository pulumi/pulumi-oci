...
@CustomType
public final class GetLustreFileStorageLustreFileSystemsLustreFileSystemCollectionItemRootSquashConfiguration {
    /**
    ...
    private GetLustreFileStorageLustreFileSystemsLustreFileSystemCollectionItemRootSquashConfiguration() {}
    /**
     * @return A list of NIDs allowed with this lustre file system not to be squashed. A maximum of 10 is allowed.
     * 
     */
    ...
    public static Builder builder(GetLustreFileStorageLustreFileSystemsLustreFileSystemCollectionItemRootSquashConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private String squashUid;
        public Builder() {}
        public Builder(GetLustreFileStorageLustreFileSystemsLustreFileSystemCollectionItemRootSquashConfiguration defaults) {
        ...
        public Builder clientExceptions(List<String> clientExceptions) {
            if (clientExceptions == null) {
              throw new MissingRequiredPropertyException("GetLustreFileStorageLustreFileSystemsLustreFileSystemCollectionItemRootSquashConfiguration", "clientExceptions");
            }
        ...
        public Builder identitySquash(String identitySquash) {
            if (identitySquash == null) {
              throw new MissingRequiredPropertyException("GetLustreFileStorageLustreFileSystemsLustreFileSystemCollectionItemRootSquashConfiguration", "identitySquash");
            }
        ...
        public Builder squashGid(String squashGid) {
            if (squashGid == null) {
              throw new MissingRequiredPropertyException("GetLustreFileStorageLustreFileSystemsLustreFileSystemCollectionItemRootSquashConfiguration", "squashGid");
            }
        ...
        public Builder squashUid(String squashUid) {
            if (squashUid == null) {
              throw new MissingRequiredPropertyException("GetLustreFileStorageLustreFileSystemsLustreFileSystemCollectionItemRootSquashConfiguration", "squashUid");
            }
            this.squashUid = squashUid;
            return this;
        }
        public GetLustreFileStorageLustreFileSystemsLustreFileSystemCollectionItemRootSquashConfiguration build() {
            final var _resultValue = new GetLustreFileStorageLustreFileSystemsLustreFileSystemCollectionItemRootSquashConfiguration();
