...
@CustomType
public final class GetWlmsWlsDomainConfiguration {
    /**
    ...
    private GetWlmsWlsDomainConfiguration() {}
    /**
     * @return Whether to manage the admin server using Node Manager or scripts.
     * 
     */
    ...
    public static Builder builder(GetWlmsWlsDomainConfiguration defaults) {
    ...
    public static final class Builder {
        ...
        private Integer serversShutdownTimeout;
        public Builder() {}
        public Builder(GetWlmsWlsDomainConfiguration defaults) {
        ...
        public Builder adminServerControlMode(String adminServerControlMode) {
            if (adminServerControlMode == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainConfiguration", "adminServerControlMode");
            }
        ...
        public Builder adminServerStartScriptPath(String adminServerStartScriptPath) {
            if (adminServerStartScriptPath == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainConfiguration", "adminServerStartScriptPath");
            }
        ...
        public Builder adminServerStopScriptPath(String adminServerStopScriptPath) {
            if (adminServerStopScriptPath == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainConfiguration", "adminServerStopScriptPath");
            }
        ...
        public Builder isPatchEnabled(Boolean isPatchEnabled) {
            if (isPatchEnabled == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainConfiguration", "isPatchEnabled");
            }
        ...
        public Builder isRollbackOnFailure(Boolean isRollbackOnFailure) {
            if (isRollbackOnFailure == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainConfiguration", "isRollbackOnFailure");
            }
        ...
        public Builder managedServerControlMode(String managedServerControlMode) {
            if (managedServerControlMode == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainConfiguration", "managedServerControlMode");
            }
        ...
        public Builder managedServerStartScriptPath(String managedServerStartScriptPath) {
            if (managedServerStartScriptPath == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainConfiguration", "managedServerStartScriptPath");
            }
        ...
        public Builder managedServerStopScriptPath(String managedServerStopScriptPath) {
            if (managedServerStopScriptPath == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainConfiguration", "managedServerStopScriptPath");
            }
        ...
        public Builder serversShutdownTimeout(Integer serversShutdownTimeout) {
            if (serversShutdownTimeout == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainConfiguration", "serversShutdownTimeout");
            }
            this.serversShutdownTimeout = serversShutdownTimeout;
            return this;
        }
        public GetWlmsWlsDomainConfiguration build() {
            final var _resultValue = new GetWlmsWlsDomainConfiguration();
