...
@CustomType
public final class GetWlmsWlsDomainServerResult {
    /**
    ...
    public static Builder builder(GetWlmsWlsDomainServerResult defaults) {
    ...
    public static final class Builder {
        ...
        private String wlsDomainPath;
        public Builder() {}
        public Builder(GetWlmsWlsDomainServerResult defaults) {
        ...
        public Builder hostName(String hostName) {
            if (hostName == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainServerResult", "hostName");
            }
        ...
        public Builder id(String id) {
            if (id == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainServerResult", "id");
            }
            this.id = id;
            return this;
        }
        ...
        public Builder isAdmin(Boolean isAdmin) {
            if (isAdmin == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainServerResult", "isAdmin");
            }
        ...
        public Builder jdkPath(String jdkPath) {
            if (jdkPath == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainServerResult", "jdkPath");
            }
        ...
        public Builder jdkVersion(String jdkVersion) {
            if (jdkVersion == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainServerResult", "jdkVersion");
            }
        ...
        public Builder latestPatchesStatus(String latestPatchesStatus) {
            if (latestPatchesStatus == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainServerResult", "latestPatchesStatus");
            }
        ...
        public Builder managedInstanceId(String managedInstanceId) {
            if (managedInstanceId == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainServerResult", "managedInstanceId");
            }
        ...
        public Builder middlewarePath(String middlewarePath) {
            if (middlewarePath == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainServerResult", "middlewarePath");
            }
        ...
        public Builder middlewareType(String middlewareType) {
            if (middlewareType == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainServerResult", "middlewareType");
            }
        ...
        public Builder name(String name) {
            if (name == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainServerResult", "name");
            }
            this.name = name;
            return this;
        }
        ...
        public Builder patchReadinessStatus(String patchReadinessStatus) {
            if (patchReadinessStatus == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainServerResult", "patchReadinessStatus");
            }
        ...
        public Builder restartOrder(Integer restartOrder) {
            if (restartOrder == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainServerResult", "restartOrder");
            }
        ...
        public Builder serverId(String serverId) {
            if (serverId == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainServerResult", "serverId");
            }
        ...
        public Builder status(String status) {
            if (status == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainServerResult", "status");
            }
            this.status = status;
            return this;
        }
        ...
        public Builder timeCreated(String timeCreated) {
            if (timeCreated == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainServerResult", "timeCreated");
            }
        ...
        public Builder timeUpdated(String timeUpdated) {
            if (timeUpdated == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainServerResult", "timeUpdated");
            }
        ...
        public Builder weblogicVersion(String weblogicVersion) {
            if (weblogicVersion == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainServerResult", "weblogicVersion");
            }
        ...
        public Builder wlsDomainId(String wlsDomainId) {
            if (wlsDomainId == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainServerResult", "wlsDomainId");
            }
        ...
        public Builder wlsDomainName(String wlsDomainName) {
            if (wlsDomainName == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainServerResult", "wlsDomainName");
            }
        ...
        public Builder wlsDomainPath(String wlsDomainPath) {
            if (wlsDomainPath == null) {
              throw new MissingRequiredPropertyException("GetWlmsWlsDomainServerResult", "wlsDomainPath");
            }
            this.wlsDomainPath = wlsDomainPath;
            return this;
        }
        public GetWlmsWlsDomainServerResult build() {
            final var _resultValue = new GetWlmsWlsDomainServerResult();
