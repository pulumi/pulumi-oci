...
export function getCertificatesOutput(args?: GetCertificatesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCertificatesResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("oci:CertificatesManagement/getCertificates:getCertificates", {
        "certificateId": args.certificateId,
        "compartmentId": args.compartmentId,
        "filters": args.filters,
        "issuerCertificateAuthorityId": args.issuerCertificateAuthorityId,
...
export interface GetCertificatesOutputArgs {
    ...
    filters?: pulumi.Input<pulumi.Input<inputs.CertificatesManagement.GetCertificatesFilterArgs>[] | undefined>;
    /**
     * The OCID of the certificate authority (CA). If the parameter is set to null, the service lists all CAs.
     */
