 ...
 * ```
 */
export function getInventoriesOutput(args: GetInventoriesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetInventoriesResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
export interface GetInventoriesOutputArgs {
    ...
    filters?: pulumi.Input<pulumi.Input<inputs.CloudBridge.GetInventoriesFilterArgs>[] | undefined>;
    /**
     * A filter to return inventory if the lifecycleState matches the given lifecycleState.
     */
