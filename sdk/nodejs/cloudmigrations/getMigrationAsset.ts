 ...
 * ```
 */
export function getMigrationAssetOutput(args: GetMigrationAssetOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetMigrationAssetResult> {
    return pulumi.output(args).apply((a: any) => getMigrationAsset(a, opts))
}
