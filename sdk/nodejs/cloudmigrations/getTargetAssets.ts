 ...
 * ```
 */
export function getTargetAssetsOutput(args?: GetTargetAssetsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetTargetAssetsResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
export interface GetTargetAssetsOutputArgs {
    ...
    filters?: pulumi.Input<pulumi.Input<inputs.CloudMigrations.GetTargetAssetsFilterArgs>[] | undefined>;
    /**
     * Unique migration plan identifier
     */
     ...
     * Unique target asset identifier
     */
    targetAssetId?: pulumi.Input<string | undefined>;
}
