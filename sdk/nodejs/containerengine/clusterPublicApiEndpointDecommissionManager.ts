...
export class ClusterPublicApiEndpointDecommissionManager extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ClusterPublicApiEndpointDecommissionManagerState, opts?: pulumi.CustomResourceOptions): ClusterPublicApiEndpointDecommissionManager {
        return new ClusterPublicApiEndpointDecommissionManager(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:ContainerEngine/clusterPublicApiEndpointDecommissionManager:ClusterPublicApiEndpointDecommissionManager';
     ...
     */
    public static isInstance(obj: any): obj is ClusterPublicApiEndpointDecommissionManager {
    ...
    declare public readonly isPublicApiEndpointDecommissioned: pulumi.Output<boolean>;
    declare public readonly rollbackDeadlineDelay: pulumi.Output<string | undefined>;
    ...
    constructor(name: string, argsOrState?: ClusterPublicApiEndpointDecommissionManagerArgs | ClusterPublicApiEndpointDecommissionManagerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ClusterPublicApiEndpointDecommissionManagerState | undefined;
            ...
            const args = argsOrState as ClusterPublicApiEndpointDecommissionManagerArgs | undefined;
