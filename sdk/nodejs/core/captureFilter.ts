...
export class CaptureFilter extends pulumi.CustomResource {
     ...
     */
    public readonly flowLogCaptureFilterRules!: pulumi.Output<outputs.Core.CaptureFilterFlowLogCaptureFilterRule[] | undefined>;
    /**
     ...
     */
    public readonly vtapCaptureFilterRules!: pulumi.Output<outputs.Core.CaptureFilterVtapCaptureFilterRule[] | undefined>;
