 ...
 *
 * const testVolumeBackup = new oci.core.VolumeBackup("testVolumeBackup", {
...
export class VolumeBackup extends pulumi.CustomResource {
     ...
     */
    public readonly sourceDetails!: pulumi.Output<outputs.Core.VolumeBackupSourceDetails | undefined>;
    /**
