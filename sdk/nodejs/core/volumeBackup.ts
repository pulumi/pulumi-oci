 ...
 *         Department: "Finance",
 *     },
 *     isIndefiniteRetentionEnabled: volumeBackupIsIndefiniteRetentionEnabled === "true",
 *     isPreventDeletionEnabled: volumeBackupIsPreventDeletionEnabled === "true",
 *     isRetentionLockEnabled: volumeBackupIsRetentionLockEnabled === "true",
 *     kmsKeyId: testKey.id,
 *     retentionPeriod: {
 *         retentionTimeAmount: Number(volumeBackupRetentionPeriodRetentionTimeAmount),
...
export class VolumeBackup extends pulumi.CustomResource {
     ...
     */
    declare public readonly retentionPeriod: pulumi.Output<outputs.Core.VolumeBackupRetentionPeriod>;
    /**
...
export interface VolumeBackupState {
     ...
     * (Updatable) This field is used to define the retention period for backups. This is an optional field. If it is not specified, it is set to null, no retention period will be applied to the backups.
     */
    retentionPeriod?: pulumi.Input<inputs.Core.VolumeBackupRetentionPeriod | undefined>;
    /**
     * The size of the volume, in GBs.
     */
     ...
     * Details of the volume backup source in the cloud.
     */
    sourceDetails?: pulumi.Input<inputs.Core.VolumeBackupSourceDetails | undefined>;
    /**
     * Specifies whether the backup was created manually, or via scheduled backup policy.
     */
