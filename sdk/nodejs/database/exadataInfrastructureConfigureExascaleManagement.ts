 ...
 *     totalStorageInGbs: Number(exadataInfrastructureConfigureExascaleManagementTotalStorageInGbs),
 * });
 * ```
 *
 * ## Import
...
export interface ExadataInfrastructureConfigureExascaleManagementState {
     ...
     * The list of contacts for the Exadata infrastructure.
     */
    contacts?: pulumi.Input<pulumi.Input<inputs.Database.ExadataInfrastructureConfigureExascaleManagementContact>[] | undefined>;
    /**
     * The corporate network proxy for access to the control plane network.
     */
     ...
     * Details of the file system configuration of the Exadata infrastructure.
     */
    definedFileSystemConfigurations?: pulumi.Input<pulumi.Input<inputs.Database.ExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfiguration>[] | undefined>;
    /**
     * Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
     */
     ...
     * The exascale config response details for the Exadata Cloud@Customer infrastructure or cloud Exadata infrastructure . Applies to both Exadata Cloud@Customer instances and Exadata Cloud Service instances.
     */
    exascaleConfigs?: pulumi.Input<pulumi.Input<inputs.Database.ExadataInfrastructureConfigureExascaleManagementExascaleConfig>[] | undefined>;
    /**
     * Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
     */
     ...
     * The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
     */
    maintenanceWindows?: pulumi.Input<pulumi.Input<inputs.Database.ExadataInfrastructureConfigureExascaleManagementMaintenanceWindow>[] | undefined>;
    /**
     * The total number of CPU cores available.
     */
     ...
     * Details of bonding mode for Client and Backup and DR networks of an Exadata infrastructure.
     */
    networkBondingModeDetails?: pulumi.Input<pulumi.Input<inputs.Database.ExadataInfrastructureConfigureExascaleManagementNetworkBondingModeDetail>[] | undefined>;
    /**
     * The list of NTP server IP addresses. Maximum of 3 allowed.
     */
