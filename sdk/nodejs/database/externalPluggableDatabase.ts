...
export class ExternalPluggableDatabase extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly databaseManagementConfigs: pulumi.Output<outputs.Database.ExternalPluggableDatabaseDatabaseManagementConfig[]>;
    /**
     ...
     */
    declare public /*out*/ readonly operationsInsightsConfigs: pulumi.Output<outputs.Database.ExternalPluggableDatabaseOperationsInsightsConfig[]>;
    /**
     ...
     */
    declare public /*out*/ readonly stackMonitoringConfigs: pulumi.Output<outputs.Database.ExternalPluggableDatabaseStackMonitoringConfig[]>;
    /**
...
export interface ExternalPluggableDatabaseState {
     ...
     * The configuration of the Database Management service.
     */
    databaseManagementConfigs?: pulumi.Input<pulumi.Input<inputs.Database.ExternalPluggableDatabaseDatabaseManagementConfig>[] | undefined>;
    /**
     * The Oracle Database version.
     */
     ...
     * The configuration of Operations Insights for the external database
     */
    operationsInsightsConfigs?: pulumi.Input<pulumi.Input<inputs.Database.ExternalPluggableDatabaseOperationsInsightsConfig>[] | undefined>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the the non-container database that was converted to a pluggable database to create this resource.
     *
     * ** IMPORTANT **
     ...
     * The configuration of Stack Monitoring for the external database.
     */
    stackMonitoringConfigs?: pulumi.Input<pulumi.Input<inputs.Database.ExternalPluggableDatabaseStackMonitoringConfig>[] | undefined>;
    /**
     * The current state of the Oracle Cloud Infrastructure external database resource.
     */
