 ...
 * ```
 */
export function getBackupDestinationsOutput(args: GetBackupDestinationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetBackupDestinationsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
export interface GetBackupDestinationsOutputArgs {
    ...
    filters?: pulumi.Input<pulumi.Input<inputs.Database.GetBackupDestinationsFilterArgs>[] | undefined>;
    /**
     * A filter to return only resources that match the given type of the Backup Destination.
     */
