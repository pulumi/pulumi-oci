...
export class PluggableDatabasesRemoteClone extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly connectionStrings: pulumi.Output<outputs.Database.PluggableDatabasesRemoteCloneConnectionString[]>;
    /**
     ...
     */
    declare public /*out*/ readonly pdbNodeLevelDetails: pulumi.Output<outputs.Database.PluggableDatabasesRemoteClonePdbNodeLevelDetail[]>;
    /**
     ...
     */
    declare public /*out*/ readonly pluggableDatabaseManagementConfigs: pulumi.Output<outputs.Database.PluggableDatabasesRemoteClonePluggableDatabaseManagementConfig[]>;
    /**
     * Pluggable Database Refreshable Clone Configuration.
     */
    declare public /*out*/ readonly refreshableCloneConfigs: pulumi.Output<outputs.Database.PluggableDatabasesRemoteCloneRefreshableCloneConfig[]>;
    /**
     ...
     */
    declare public readonly sourceContainerDbAdminPassword: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly targetContainerDatabaseId: pulumi.Output<string>;
    /**
...
export interface PluggableDatabasesRemoteCloneState {
     ...
     * Connection strings to connect to an Oracle Pluggable Database.
     */
    connectionStrings?: pulumi.Input<pulumi.Input<inputs.Database.PluggableDatabasesRemoteCloneConnectionString>[] | undefined>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the CDB.
     */
     ...
     * Pluggable Database Node Level Details. Example: [{"nodeName" : "node1", "openMode" : "READ_WRITE"}, {"nodeName" : "node2", "openMode" : "READ_ONLY"}]
     */
    pdbNodeLevelDetails?: pulumi.Input<pulumi.Input<inputs.Database.PluggableDatabasesRemoteClonePdbNodeLevelDetail>[] | undefined>;
    /**
     * The database [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
     */
     ...
     * The configuration of the Pluggable Database Management service.
     */
    pluggableDatabaseManagementConfigs?: pulumi.Input<pulumi.Input<inputs.Database.PluggableDatabasesRemoteClonePluggableDatabaseManagementConfig>[] | undefined>;
    /**
     * Pluggable Database Refreshable Clone Configuration.
     */
    refreshableCloneConfigs?: pulumi.Input<pulumi.Input<inputs.Database.PluggableDatabasesRemoteCloneRefreshableCloneConfig>[] | undefined>;
    /**
     * The locked mode of the pluggable database admin account. If false, the user needs to provide the PDB Admin Password to connect to it. If true, the pluggable database will be locked and user cannot login to it.
     */
     ...
     * The DB system administrator password of the source CDB.
     */
    sourceContainerDbAdminPassword?: pulumi.Input<string | undefined>;
    /**
     * The current state of the pluggable database.
     */
     ...
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the target CDB
     */
    targetContainerDatabaseId?: pulumi.Input<string | undefined>;
    /**
     * The existing TDE wallet password of the target CDB.
     *
     *
