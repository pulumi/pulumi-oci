...
export class VmClusterRemoveVirtualMachine extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly cloudAutomationUpdateDetails: pulumi.Output<outputs.Database.VmClusterRemoveVirtualMachineCloudAutomationUpdateDetail[]>;
    /**
     ...
     */
    declare public /*out*/ readonly dataCollectionOptions: pulumi.Output<outputs.Database.VmClusterRemoveVirtualMachineDataCollectionOption[]>;
    /**
     ...
     */
    declare public readonly dbServers: pulumi.Output<outputs.Database.VmClusterRemoveVirtualMachineDbServer[]>;
    /**
     ...
     */
    declare public /*out*/ readonly fileSystemConfigurationDetails: pulumi.Output<outputs.Database.VmClusterRemoveVirtualMachineFileSystemConfigurationDetail[]>;
    /**
...
export interface VmClusterRemoveVirtualMachineState {
     ...
     * Specifies the properties necessary for cloud automation updates. This includes modifying the apply update time preference, enabling or disabling early adoption, and enabling, modifying, or disabling the update freeze period.
     */
    cloudAutomationUpdateDetails?: pulumi.Input<pulumi.Input<inputs.Database.VmClusterRemoveVirtualMachineCloudAutomationUpdateDetail>[] | undefined>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
     */
     ...
     * Indicates user preferences for the various diagnostic collection options for the VM cluster/Cloud VM cluster/VMBM DBCS.
     */
    dataCollectionOptions?: pulumi.Input<pulumi.Input<inputs.Database.VmClusterRemoveVirtualMachineDataCollectionOption>[] | undefined>;
    /**
     * The percentage assigned to DATA storage (user data and database files). See [Storage Configuration](https://docs.cloud.oracle.com/iaas/Content/Database/Concepts/exaoverview.htm#Exadata) in the Exadata documentation for details on the impact of the configuration settings on storage.
     */
     ...
     * The list of Exacc DB servers for the cluster to be removed.
     */
    dbServers?: pulumi.Input<pulumi.Input<inputs.Database.VmClusterRemoveVirtualMachineDbServer>[] | undefined>;
    /**
     * Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
     */
     ...
     * Details of the file system configuration of the VM cluster.
     */
    fileSystemConfigurationDetails?: pulumi.Input<pulumi.Input<inputs.Database.VmClusterRemoveVirtualMachineFileSystemConfigurationDetail>[] | undefined>;
    /**
     * Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
     */
