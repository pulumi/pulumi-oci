 ...
 * ```
 */
export class CloudAsmInstance extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudAsmInstanceState, opts?: pulumi.CustomResourceOptions): CloudAsmInstance {
        return new CloudAsmInstance(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:DatabaseManagement/cloudAsmInstance:CloudAsmInstance';

    /**
     * Returns true if the given object is an instance of CloudAsmInstance.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CloudAsmInstance {
    ...
    constructor(name: string, argsOrState?: CloudAsmInstanceArgs | CloudAsmInstanceState, opts?: pulumi.CustomResourceOptions) {
...
export interface CloudAsmInstanceState {
     ...
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the cloud ASM instance.
     */
    cloudAsmInstanceId?: pulumi.Input<string | undefined>;
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the cloud DB node on which the ASM instance is running.
     */
