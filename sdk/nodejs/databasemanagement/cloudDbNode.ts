...
export class CloudDbNode extends pulumi.CustomResource {
     ...
     */
    public readonly cloudDbNodeId!: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: CloudDbNodeArgs | CloudDbNodeState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if ((!args || args.cloudDbNodeId === undefined) && !opts.urn) {
            ...
            resourceInputs["cloudDbNodeId"] = args ? args.cloudDbNodeId : undefined;
