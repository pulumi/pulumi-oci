 ...
 * ```
 */
export class CloudExadataStorageConnector extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudExadataStorageConnectorState, opts?: pulumi.CustomResourceOptions): CloudExadataStorageConnector {
        return new CloudExadataStorageConnector(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:DatabaseManagement/cloudExadataStorageConnector:CloudExadataStorageConnector';
     ...
     */
    public static isInstance(obj: any): obj is CloudExadataStorageConnector {
     ...
     */
    declare public readonly credentialInfo: pulumi.Output<outputs.DatabaseManagement.CloudExadataStorageConnectorCredentialInfo>;
    /**
    ...
    constructor(name: string, argsOrState?: CloudExadataStorageConnectorArgs | CloudExadataStorageConnectorState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CloudExadataStorageConnectorState | undefined;
            ...
            const args = argsOrState as CloudExadataStorageConnectorArgs | undefined;
...
export interface CloudExadataStorageConnectorState {
     ...
     * (Updatable) The user credential information.
     */
    credentialInfo?: pulumi.Input<inputs.DatabaseManagement.CloudExadataStorageConnectorCredentialInfo | undefined>;
    /**
     * (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
     */
