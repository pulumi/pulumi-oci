 ...
 * ```
 */
export class CloudExadataStorageGrid extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudExadataStorageGridState, opts?: pulumi.CustomResourceOptions): CloudExadataStorageGrid {
        return new CloudExadataStorageGrid(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:DatabaseManagement/cloudExadataStorageGrid:CloudExadataStorageGrid';

    /**
     * Returns true if the given object is an instance of CloudExadataStorageGrid.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is CloudExadataStorageGrid {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CloudExadataStorageGrid.__pulumiType;
    }
     ...
     */
    declare public readonly cloudExadataStorageGridId: pulumi.Output<string>;
    /**
     ...
     */
    declare public /*out*/ readonly storageServers: pulumi.Output<outputs.DatabaseManagement.CloudExadataStorageGridStorageServer[]>;
    /**
    ...
    constructor(name: string, argsOrState?: CloudExadataStorageGridArgs | CloudExadataStorageGridState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CloudExadataStorageGridState | undefined;
            resourceInputs["additionalDetails"] = state?.additionalDetails;
            resourceInputs["cloudExadataStorageGridId"] = state?.cloudExadataStorageGridId;
            ...
            const args = argsOrState as CloudExadataStorageGridArgs | undefined;
            if (args?.cloudExadataStorageGridId === undefined && !opts.urn) {
                throw new Error("Missing required property 'cloudExadataStorageGridId'");
            }
            resourceInputs["cloudExadataStorageGridId"] = args?.cloudExadataStorageGridId;
        ...
        super(CloudExadataStorageGrid.__pulumiType, name, resourceInputs, opts);
    }
}
...
export interface CloudExadataStorageGridState {
     ...
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata storage grid.
     */
    cloudExadataStorageGridId?: pulumi.Input<string | undefined>;
    /**
     * (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
     */
     ...
     * A list of monitored Exadata storage servers.
     */
    storageServers?: pulumi.Input<pulumi.Input<inputs.DatabaseManagement.CloudExadataStorageGridStorageServer>[] | undefined>;
    /**
     * System tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). System tags can be viewed by users, but can only be created by the system.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
     */
