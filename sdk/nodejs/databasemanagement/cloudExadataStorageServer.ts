 ...
 * ```
 */
export class CloudExadataStorageServer extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: CloudExadataStorageServerState, opts?: pulumi.CustomResourceOptions): CloudExadataStorageServer {
        return new CloudExadataStorageServer(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:DatabaseManagement/cloudExadataStorageServer:CloudExadataStorageServer';
     ...
     */
    public static isInstance(obj: any): obj is CloudExadataStorageServer {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === CloudExadataStorageServer.__pulumiType;
    }
     ...
     */
    declare public readonly cloudExadataStorageServerId: pulumi.Output<string>;
    /**
     * The connector of the Exadata storage server.
     */
    declare public /*out*/ readonly connectors: pulumi.Output<outputs.DatabaseManagement.CloudExadataStorageServerConnector[]>;
    /**
    ...
    constructor(name: string, argsOrState?: CloudExadataStorageServerArgs | CloudExadataStorageServerState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as CloudExadataStorageServerState | undefined;
            resourceInputs["additionalDetails"] = state?.additionalDetails;
            resourceInputs["cloudExadataStorageServerId"] = state?.cloudExadataStorageServerId;
            ...
            const args = argsOrState as CloudExadataStorageServerArgs | undefined;
            if (args?.cloudExadataStorageServerId === undefined && !opts.urn) {
                throw new Error("Missing required property 'cloudExadataStorageServerId'");
            }
            resourceInputs["cloudExadataStorageServerId"] = args?.cloudExadataStorageServerId;
        ...
        super(CloudExadataStorageServer.__pulumiType, name, resourceInputs, opts);
    }
}
