 ...
 * ```
 */
export function getCloudDbHomes(args?: GetCloudDbHomesArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudDbHomesResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("oci:DatabaseManagement/getCloudDbHomes:getCloudDbHomes", {
 ...
 */
export interface GetCloudDbHomesArgs {
    /**
     ...
     */
    displayName?: string;
    filters?: inputs.DatabaseManagement.GetCloudDbHomesFilter[];
}

/**
 * A collection of values returned by getCloudDbHomes.
 */
export interface GetCloudDbHomesResult {
    /**
     * The list of cloud_db_home_collection.
     */
    readonly cloudDbHomeCollections: outputs.DatabaseManagement.GetCloudDbHomesCloudDbHomeCollection[];
    /**
    ...
    readonly filters?: outputs.DatabaseManagement.GetCloudDbHomesFilter[];
    /**
 ...
 * ```
 */
export function getCloudDbHomesOutput(args?: GetCloudDbHomesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCloudDbHomesResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("oci:DatabaseManagement/getCloudDbHomes:getCloudDbHomes", {
        "cloudDbSystemId": args.cloudDbSystemId,
        "compartmentId": args.compartmentId,
        "displayName": args.displayName,
        "filters": args.filters,
 ...
 * A collection of arguments for invoking getCloudDbHomes.
 */
export interface GetCloudDbHomesOutputArgs {
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the cloud DB system.
     */
