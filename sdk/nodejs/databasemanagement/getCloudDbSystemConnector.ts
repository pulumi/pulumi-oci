 ...
 * ```
 */
export function getCloudDbSystemConnector(args: GetCloudDbSystemConnectorArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudDbSystemConnectorResult> {
 ...
 * ```
 */
export function getCloudDbSystemConnectorOutput(args: GetCloudDbSystemConnectorOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCloudDbSystemConnectorResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
