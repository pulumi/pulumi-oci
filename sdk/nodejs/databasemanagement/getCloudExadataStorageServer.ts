 ...
 * ```
 */
export function getCloudExadataStorageServer(args: GetCloudExadataStorageServerArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudExadataStorageServerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("oci:DatabaseManagement/getCloudExadataStorageServer:getCloudExadataStorageServer", {
 ...
 */
export interface GetCloudExadataStorageServerArgs {
    /**
 ...
 */
export interface GetCloudExadataStorageServerResult {
    /**
     ...
     */
    readonly connectors: outputs.DatabaseManagement.GetCloudExadataStorageServerConnector[];
    /**
 ...
 * ```
 */
export function getCloudExadataStorageServerOutput(args: GetCloudExadataStorageServerOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCloudExadataStorageServerResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("oci:DatabaseManagement/getCloudExadataStorageServer:getCloudExadataStorageServer", {
        "cloudExadataStorageServerId": args.cloudExadataStorageServerId,
    }, opts);
}
 ...
 * A collection of arguments for invoking getCloudExadataStorageServer.
 */
export interface GetCloudExadataStorageServerOutputArgs {
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata storage server.
     */
