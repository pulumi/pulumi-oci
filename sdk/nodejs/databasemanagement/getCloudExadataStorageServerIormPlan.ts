 ...
 * ```
 */
export function getCloudExadataStorageServerIormPlan(args: GetCloudExadataStorageServerIormPlanArgs, opts?: pulumi.InvokeOptions): Promise<GetCloudExadataStorageServerIormPlanResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("oci:DatabaseManagement/getCloudExadataStorageServerIormPlan:getCloudExadataStorageServerIormPlan", {
 ...
 */
export interface GetCloudExadataStorageServerIormPlanArgs {
    /**
 ...
 */
export interface GetCloudExadataStorageServerIormPlanResult {
     ...
     */
    readonly dbPlans: outputs.DatabaseManagement.GetCloudExadataStorageServerIormPlanDbPlan[];
    /**
 ...
 * ```
 */
export function getCloudExadataStorageServerIormPlanOutput(args: GetCloudExadataStorageServerIormPlanOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCloudExadataStorageServerIormPlanResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("oci:DatabaseManagement/getCloudExadataStorageServerIormPlan:getCloudExadataStorageServerIormPlan", {
        "cloudExadataStorageServerId": args.cloudExadataStorageServerId,
    }, opts);
}
 ...
 * A collection of arguments for invoking getCloudExadataStorageServerIormPlan.
 */
export interface GetCloudExadataStorageServerIormPlanOutputArgs {
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata storage server.
     */
