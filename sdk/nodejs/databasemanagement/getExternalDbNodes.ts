 ...
 * ```
 */
export function getExternalDbNodesOutput(args?: GetExternalDbNodesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetExternalDbNodesResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
export interface GetExternalDbNodesOutputArgs {
    ...
    filters?: pulumi.Input<pulumi.Input<inputs.DatabaseManagement.GetExternalDbNodesFilterArgs>[] | undefined>;
}
