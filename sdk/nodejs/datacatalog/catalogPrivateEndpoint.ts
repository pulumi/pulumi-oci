...
export class CatalogPrivateEndpoint extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly attachedCatalogs: pulumi.Output<string[]>;
    /**
     ...
     */
    declare public /*out*/ readonly locks: pulumi.Output<outputs.DataCatalog.CatalogPrivateEndpointLock[]>;
    /**
    ...
    constructor(name: string, argsOrState?: CatalogPrivateEndpointArgs | CatalogPrivateEndpointState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["attachedCatalogs"] = state?.attachedCatalogs;
            ...
            if (args?.dnsZones === undefined && !opts.urn) {
...
export interface CatalogPrivateEndpointState {
     ...
     * The list of catalogs using the private reverse connection endpoint
     */
    attachedCatalogs?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    /**
     * (Updatable) Compartment identifier.
     */
     ...
     * (Updatable) List of DNS zones to be used by the data assets to be harvested. Example: custpvtsubnet.oraclevcn.com for data asset: db.custpvtsubnet.oraclevcn.com
     */
    dnsZones?: pulumi.Input<pulumi.Input<string>[] | undefined>;
    /**
     * (Updatable) Simple key-value pair that is applied without any predefined name, type, or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
     */
     ...
     * Locks associated with this resource.
     */
    locks?: pulumi.Input<pulumi.Input<inputs.DataCatalog.CatalogPrivateEndpointLock>[] | undefined>;
    /**
     * (Updatable) Security attributes for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Oracle-ZPR": {"MaxEgressCount": {"value": "42", "mode": "enforce"}}}`
     */
