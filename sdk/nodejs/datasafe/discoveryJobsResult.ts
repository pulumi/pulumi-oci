...
export class DiscoveryJobsResult extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly appDefinedChildColumnKeys!: pulumi.Output<string[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly appName!: pulumi.Output<string | undefined>;
    /**
     * The name of the sensitive column.
     */
    public /*out*/ readonly columnName!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public /*out*/ readonly dbDefinedChildColumnKeys!: pulumi.Output<string[] | undefined>;
    /**
     ...
     * @deprecated The 'oci_data_safe_discovery_jobs_result' resource has been deprecated. It is no longer supported.
     */
    public /*out*/ readonly discoveryType!: pulumi.Output<string | undefined>;
    /**
     * The estimated number of data values the column has in the associated database.
     */
    public /*out*/ readonly estimatedDataValueCount!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public /*out*/ readonly isResultApplied!: pulumi.Output<boolean | undefined>;
    /**
     ...
     */
    public /*out*/ readonly modifiedAttributes!: pulumi.Output<outputs.DataSafe.DiscoveryJobsResultModifiedAttribute[] | undefined>;
    /**
     * The database object that contains the sensitive column.
     */
    public /*out*/ readonly object!: pulumi.Output<string | undefined>;
    /**
     * The type of the database object that contains the sensitive column.
     */
    public /*out*/ readonly objectType!: pulumi.Output<string | undefined>;
    /**
     * Unique keys identifying the columns that are parents of the sensitive column. At present, it tracks a single parent only.
     */
    public /*out*/ readonly parentColumnKeys!: pulumi.Output<string[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly plannedAction!: pulumi.Output<string | undefined>;
    /**
     * The type of referential relationship the sensitive column has with its parent. NONE indicates that the sensitive column does not have a parent. DB_DEFINED indicates that the relationship is defined in the database dictionary. APP_DEFINED indicates that the relationship is defined at the application level and not in the database dictionary.
     */
    public /*out*/ readonly relationType!: pulumi.Output<string | undefined>;
    /**
     * Original data values collected for the sensitive column from the associated database. Sample data helps review the column and ensure that it actually contains sensitive data. Note that sample data is retrieved by a data discovery job only if the isSampleDataCollectionEnabled attribute is set to true. At present, only one data value is collected per sensitive column.
     */
    public /*out*/ readonly sampleDataValues!: pulumi.Output<string[] | undefined>;
    /**
     * The database schema that contains the sensitive column.
     */
    public /*out*/ readonly schemaName!: pulumi.Output<string | undefined>;
    /**
     * The unique key that identifies the sensitive column represented by the discovery result.
     */
    public /*out*/ readonly sensitiveColumnkey!: pulumi.Output<string | undefined>;
    /**
     * The OCID of the sensitive type associated with the sensitive column.
     */
    public /*out*/ readonly sensitiveTypeId!: pulumi.Output<string | undefined>;
