 ...
 * ```
 */
export function getSqlFirewallPolicyAnalyticsOutput(args: GetSqlFirewallPolicyAnalyticsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetSqlFirewallPolicyAnalyticsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
export interface GetSqlFirewallPolicyAnalyticsOutputArgs {
    ...
    filters?: pulumi.Input<pulumi.Input<inputs.DataSafe.GetSqlFirewallPolicyAnalyticsFilterArgs>[] | undefined>;
    /**
     * The group by parameter to summarize SQL Firewall policy aggregation.
     */
