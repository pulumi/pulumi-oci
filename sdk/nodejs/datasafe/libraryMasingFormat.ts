...
export class LibraryMasingFormat extends pulumi.CustomResource {
     ...
     */
    declare public readonly formatEntries: pulumi.Output<outputs.DataSafe.LibraryMasingFormatFormatEntry[]>;
    /**
     ...
     */
    declare public readonly sensitiveTypeIds: pulumi.Output<string[]>;
    /**
    ...
    constructor(name: string, argsOrState?: LibraryMasingFormatArgs | LibraryMasingFormatState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["formatEntries"] = state?.formatEntries;
            resourceInputs["freeformTags"] = state?.freeformTags;
            resourceInputs["sensitiveTypeIds"] = state?.sensitiveTypeIds;
            ...
            if (args?.formatEntries === undefined && !opts.urn) {
            ...
            resourceInputs["formatEntries"] = args?.formatEntries;
            resourceInputs["freeformTags"] = args?.freeformTags;
            resourceInputs["sensitiveTypeIds"] = args?.sensitiveTypeIds;
...
export interface LibraryMasingFormatState {
     ...
     * (Updatable) An array of format entries. The combined output of all the format entries is used for masking.
     */
    formatEntries?: pulumi.Input<pulumi.Input<inputs.DataSafe.LibraryMasingFormatFormatEntry>[] | undefined>;
    /**
     * (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
     */
