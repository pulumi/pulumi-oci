...
export class SensitiveTypeGroup extends pulumi.CustomResource {
     ...
     */
    declare public /*out*/ readonly sensitiveTypeCount: pulumi.Output<number>;
    /**
    ...
    constructor(name: string, argsOrState?: SensitiveTypeGroupArgs | SensitiveTypeGroupState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["sensitiveTypeCount"] = state?.sensitiveTypeCount;
...
export interface SensitiveTypeGroupState {
     ...
     * The number of sensitive types in the specified sensitive type group.
     */
    sensitiveTypeCount?: pulumi.Input<number | undefined>;
    /**
     * The current state of the sensitive type group.
     */
