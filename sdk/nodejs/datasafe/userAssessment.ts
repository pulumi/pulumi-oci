...
export class UserAssessment extends pulumi.CustomResource {
     ...
     * List containing maps as values. Example: `{"Operations": [ {"CostCenter": "42"} ] }`
     */
    public /*out*/ readonly ignoredTargets!: pulumi.Output<outputs.DataSafe.UserAssessmentIgnoredTarget[] | undefined>;
    /**
     ...
     */
    public /*out*/ readonly scheduleAssessmentId!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public /*out*/ readonly statistics!: pulumi.Output<string | undefined>;
    /**
