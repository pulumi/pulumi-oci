 ...
 * ```
 */
export function getDesktopPoolsOutput(args: GetDesktopPoolsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDesktopPoolsResult> {
    return pulumi.output(args).apply((a: any) => getDesktopPools(a, opts))
}
