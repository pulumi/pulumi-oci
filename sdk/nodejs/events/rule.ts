 ...
 *             isEnabled: ruleActionsActionIsEnabled === "true",
...
export class Rule extends pulumi.CustomResource {
     ...
     */
    declare public readonly actions: pulumi.Output<outputs.Events.RuleActions>;
    /**
     ...
     */
    declare public readonly conditionDetails: pulumi.Output<outputs.Events.RuleConditionDetails | undefined>;
    /**
     ...
     */
    declare public /*out*/ readonly lifecycleMessage: pulumi.Output<string>;
    /**
    ...
    constructor(name: string, argsOrState?: RuleArgs | RuleState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["conditionDetails"] = state?.conditionDetails;
            resourceInputs["definedTags"] = state?.definedTags;
            resourceInputs["description"] = state?.description;
            resourceInputs["displayName"] = state?.displayName;
            resourceInputs["freeformTags"] = state?.freeformTags;
            resourceInputs["isEnabled"] = state?.isEnabled;
            resourceInputs["lifecycleMessage"] = state?.lifecycleMessage;
            ...
            resourceInputs["conditionDetails"] = args?.conditionDetails;
...
export interface RuleState {
     ...
     * (Updatable) A list of ActionDetails objects to create for a rule.
     */
    actions?: pulumi.Input<inputs.Events.RuleActions | undefined>;
    /**
     * (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to which this rule belongs.
     */
     ...
     * (Updatable) A structured helper for building the rule condition JSON. Use either `condition` or `conditionDetails`. This is the recommended form for new configurations.
     */
    conditionDetails?: pulumi.Input<inputs.Events.RuleConditionDetails | undefined>;
    /**
     * (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
     */
     ...
     * A message generated by the Events service about the current state of this rule.
     */
    lifecycleMessage?: pulumi.Input<string | undefined>;
    /**
     * The current state of the rule.
     */
