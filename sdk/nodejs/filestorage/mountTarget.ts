...
export class MountTarget extends pulumi.CustomResource {
     ...
     */
    public /*out*/ readonly exportSetId!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public readonly idmapType!: pulumi.Output<string | undefined>;
    /**
     ...
     */
    public /*out*/ readonly privateIpIds!: pulumi.Output<string[] | undefined>;
    /**
