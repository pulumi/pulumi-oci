...
export class AgentDataSource extends pulumi.CustomResource {
     ...
     */
    declare public readonly dataSourceConfig: pulumi.Output<outputs.GenerativeAi.AgentDataSourceDataSourceConfig>;
    /**
...
export interface AgentDataSourceState {
     ...
     * (Updatable) The details of data source.
     */
    dataSourceConfig?: pulumi.Input<inputs.GenerativeAi.AgentDataSourceDataSourceConfig | undefined>;
    /**
     * (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
     */
