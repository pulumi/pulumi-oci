...
export class AgentKnowledgeBase extends pulumi.CustomResource {
     ...
     */
    declare public readonly indexConfig: pulumi.Output<outputs.GenerativeAi.AgentKnowledgeBaseIndexConfig>;
    /**
     * Statistics for Default Knowledge Base.
     */
    declare public /*out*/ readonly knowledgeBaseStatistics: pulumi.Output<outputs.GenerativeAi.AgentKnowledgeBaseKnowledgeBaseStatistic[]>;
    /**
...
export interface AgentKnowledgeBaseState {
     ...
     * (Updatable) The index configuration of Knowledge bases.
     */
    indexConfig?: pulumi.Input<inputs.GenerativeAi.AgentKnowledgeBaseIndexConfig | undefined>;
    /**
     * Statistics for Default Knowledge Base.
     */
    knowledgeBaseStatistics?: pulumi.Input<pulumi.Input<inputs.GenerativeAi.AgentKnowledgeBaseKnowledgeBaseStatistic>[] | undefined>;
    /**
     * A message that describes the current state of the knowledge base in more detail. For example, can be used to provide actionable information for a resource in the Failed state.
     */
