 ...
 * ```
 */
export function getAgentTools(args?: GetAgentToolsArgs, opts?: pulumi.InvokeOptions): Promise<GetAgentToolsResult> {
    args = args || {};
 ...
 * ```
 */
export function getAgentToolsOutput(args?: GetAgentToolsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetAgentToolsResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
export interface GetAgentToolsOutputArgs {
    ...
    filters?: pulumi.Input<pulumi.Input<inputs.GenerativeAi.GetAgentToolsFilterArgs>[] | undefined>;
    /**
     * A filter to return only resources that match the given lifecycle state. The state value is case-insensitive.
     */
