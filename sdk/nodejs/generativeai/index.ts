...
export { GetHostedApplicationIamArgs, GetHostedApplicationIamResult, GetHostedApplicationIamOutputArgs } from "./getHostedApplicationIam";
export const getHostedApplicationIam: typeof import("./getHostedApplicationIam").getHostedApplicationIam = null as any;
export const getHostedApplicationIamOutput: typeof import("./getHostedApplicationIam").getHostedApplicationIamOutput = null as any;
utilities.lazyLoad(exports, ["getHostedApplicationIam","getHostedApplicationIamOutput"], () => require("./getHostedApplicationIam"));

export { GetHostedApplicationIamsArgs, GetHostedApplicationIamsResult, GetHostedApplicationIamsOutputArgs } from "./getHostedApplicationIams";
export const getHostedApplicationIams: typeof import("./getHostedApplicationIams").getHostedApplicationIams = null as any;
export const getHostedApplicationIamsOutput: typeof import("./getHostedApplicationIams").getHostedApplicationIamsOutput = null as any;
utilities.lazyLoad(exports, ["getHostedApplicationIams","getHostedApplicationIamsOutput"], () => require("./getHostedApplicationIams"));
...
export { HostedApplicationIamArgs, HostedApplicationIamState } from "./hostedApplicationIam";
export type HostedApplicationIam = import("./hostedApplicationIam").HostedApplicationIam;
export const HostedApplicationIam: typeof import("./hostedApplicationIam").HostedApplicationIam = null as any;
utilities.lazyLoad(exports, ["HostedApplicationIam"], () => require("./hostedApplicationIam"));
...
const _module = {
    ...
    construct: (name: string, type: string, urn: string): pulumi.Resource => {
        switch (type) {
            ...
            case "oci:GenerativeAi/hostedApplicationIam:HostedApplicationIam":
                return new HostedApplicationIam(name, <any>undefined, { urn })
...
pulumi.runtime.registerResourceModule("oci", "GenerativeAi/hostedApplicationIam", _module)
