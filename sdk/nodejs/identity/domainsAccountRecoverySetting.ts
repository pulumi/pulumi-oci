...
export class DomainsAccountRecoverySetting extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DomainsAccountRecoverySettingState, opts?: pulumi.CustomResourceOptions): DomainsAccountRecoverySetting {
        return new DomainsAccountRecoverySetting(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:Identity/domainsAccountRecoverySetting:DomainsAccountRecoverySetting';

    /**
     * Returns true if the given object is an instance of DomainsAccountRecoverySetting.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DomainsAccountRecoverySetting {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DomainsAccountRecoverySetting.__pulumiType;
    }

    /**
     * ID of the resource
     */
    declare public readonly accountRecoverySettingId: pulumi.Output<string>;
    /**
     ...
     * * uniqueness: none
     */
    declare public readonly factors: pulumi.Output<string[]>;
    /**
     ...
     * * type: complex
     */
    declare public /*out*/ readonly idcsCreatedBies: pulumi.Output<outputs.Identity.DomainsAccountRecoverySettingIdcsCreatedBy[]>;
    /**
     ...
     * * type: complex
     */
    declare public /*out*/ readonly idcsLastModifiedBies: pulumi.Output<outputs.Identity.DomainsAccountRecoverySettingIdcsLastModifiedBy[]>;
    /**
     ...
     * * type: complex
     */
    declare public /*out*/ readonly metas: pulumi.Output<outputs.Identity.DomainsAccountRecoverySettingMeta[]>;
    /**
     ...
     * * uniqueness: none
     */
    declare public readonly tags: pulumi.Output<outputs.Identity.DomainsAccountRecoverySettingTag[]>;
    /**
     ...
     */
    constructor(name: string, args: DomainsAccountRecoverySettingArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DomainsAccountRecoverySettingArgs | DomainsAccountRecoverySettingState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DomainsAccountRecoverySettingState | undefined;
            resourceInputs["accountRecoverySettingId"] = state?.accountRecoverySettingId;
            ...
            resourceInputs["factors"] = state?.factors;
            ...
            const args = argsOrState as DomainsAccountRecoverySettingArgs | undefined;
            if (args?.accountRecoverySettingId === undefined && !opts.urn) {
                throw new Error("Missing required property 'accountRecoverySettingId'");
            }
            if (args?.factors === undefined && !opts.urn) {
            ...
            if (args?.lockoutDuration === undefined && !opts.urn) {
                throw new Error("Missing required property 'lockoutDuration'");
            }
            if (args?.maxIncorrectAttempts === undefined && !opts.urn) {
            ...
            resourceInputs["accountRecoverySettingId"] = args?.accountRecoverySettingId;
            ...
            resourceInputs["factors"] = args?.factors;
        ...
        super(DomainsAccountRecoverySetting.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DomainsAccountRecoverySettingState {
    /**
     * ID of the resource
     */
    accountRecoverySettingId?: pulumi.Input<string | undefined>;
    /**
     * (Updatable) A multi-valued list of strings indicating the return type of attribute definition. The specified set of attributes can be fetched by the return type of the attribute. One or more values can be given together to fetch more than one group of attributes. If 'attributes' query parameter is also available, union of the two is fetched. Valid values - all, always, never, request, default. Values are case-insensitive.
     */
     ...
     * * type: complex
     */
    idcsCreatedBies?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsAccountRecoverySettingIdcsCreatedBy>[] | undefined>;
    /**
     * The basic endpoint for the identity domain
     */
     ...
     * * type: complex
     */
    idcsLastModifiedBies?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsAccountRecoverySettingIdcsLastModifiedBy>[] | undefined>;
    /**
     * (Updatable) The release number when the resource was upgraded.
     *
     * **SCIM++ Properties:**
     ...
     * * type: complex
     */
    metas?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsAccountRecoverySettingMeta>[] | undefined>;
    /**
     * (Updatable) Unique Oracle Cloud Infrastructure identifier for the SCIM Resource.
     *
     * **SCIM++ Properties:**
     ...
     * * uniqueness: none
     */
    tags?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsAccountRecoverySettingTag>[] | undefined>;
    /**
     * (Updatable) Oracle Cloud Infrastructure Tenant Id (ocid) in which the resource lives.
     *
     * **SCIM++ Properties:**
 ...
 */
export interface DomainsAccountRecoverySettingArgs {
    /**
     * ID of the resource
     */
