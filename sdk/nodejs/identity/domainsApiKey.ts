...
export class DomainsApiKey extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DomainsApiKeyState, opts?: pulumi.CustomResourceOptions): DomainsApiKey {
        return new DomainsApiKey(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:Identity/domainsApiKey:DomainsApiKey';

    /**
     * Returns true if the given object is an instance of DomainsApiKey.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DomainsApiKey {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === DomainsApiKey.__pulumiType;
    }
     ...
     * * type: complex
     */
    declare public /*out*/ readonly idcsCreatedBies: pulumi.Output<outputs.Identity.DomainsApiKeyIdcsCreatedBy[]>;
    /**
     ...
     * * type: complex
     */
    declare public /*out*/ readonly idcsLastModifiedBies: pulumi.Output<outputs.Identity.DomainsApiKeyIdcsLastModifiedBy[]>;
    /**
     ...
     * * type: complex
     */
    declare public /*out*/ readonly metas: pulumi.Output<outputs.Identity.DomainsApiKeyMeta[]>;
    /**
     ...
     * * uniqueness: none
     */
    declare public readonly tags: pulumi.Output<outputs.Identity.DomainsApiKeyTag[]>;
    /**
     ...
     */
    declare public readonly urnietfparamsscimschemasoracleidcsextensionselfChangeUser: pulumi.Output<outputs.Identity.DomainsApiKeyUrnietfparamsscimschemasoracleidcsextensionselfChangeUser>;
    /**
     ...
     * * uniqueness: none
     */
    declare public readonly user: pulumi.Output<outputs.Identity.DomainsApiKeyUser>;

    /**
     * Create a DomainsApiKey resource with the given unique name, arguments, and options.
     *
     * @param name The _unique_ name of the resource.
     * @param args The arguments to use to populate this resource's properties.
     * @param opts A bag of options that control this resource's behavior.
     */
    constructor(name: string, args: DomainsApiKeyArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: DomainsApiKeyArgs | DomainsApiKeyState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DomainsApiKeyState | undefined;
            ...
            const args = argsOrState as DomainsApiKeyArgs | undefined;
        ...
        super(DomainsApiKey.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface DomainsApiKeyState {
    /**
     * A multi-valued list of strings indicating the return type of attribute definition. The specified set of attributes can be fetched by the return type of the attribute. One or more values can be given together to fetch more than one group of attributes. If 'attributes' query parameter is also available, union of the two is fetched. Valid values - all, always, never, request, default. Values are case-insensitive.
     */
     ...
     * * type: complex
     */
    idcsCreatedBies?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsApiKeyIdcsCreatedBy>[] | undefined>;
    /**
     * The basic endpoint for the identity domain
     */
     ...
     * * type: complex
     */
    idcsLastModifiedBies?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsApiKeyIdcsLastModifiedBy>[] | undefined>;
    /**
     * (Updatable) The release number when the resource was upgraded.
     *
     * **SCIM++ Properties:**
     ...
     * * type: complex
     */
    metas?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsApiKeyMeta>[] | undefined>;
    /**
     * Unique Oracle Cloud Infrastructure identifier for the SCIM Resource.
     *
     * **SCIM++ Properties:**
     ...
     * * uniqueness: none
     */
    tags?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsApiKeyTag>[] | undefined>;
    /**
     * (Updatable) Oracle Cloud Infrastructure Tenant Id (ocid) in which the resource lives.
     *
     * **SCIM++ Properties:**
     ...
     * Controls whether a user can update themselves or not via User related APIs
     */
    urnietfparamsscimschemasoracleidcsextensionselfChangeUser?: pulumi.Input<inputs.Identity.DomainsApiKeyUrnietfparamsscimschemasoracleidcsextensionselfChangeUser | undefined>;
    /**
     * The user linked to the API key.
     *
     * **SCIM++ Properties:**
     ...
     * * uniqueness: none
     */
    user?: pulumi.Input<inputs.Identity.DomainsApiKeyUser | undefined>;
}

/**
 * The set of arguments for constructing a DomainsApiKey resource.
 */
export interface DomainsApiKeyArgs {
    /**
     * A multi-valued list of strings indicating the return type of attribute definition. The specified set of attributes can be fetched by the return type of the attribute. One or more values can be given together to fetch more than one group of attributes. If 'attributes' query parameter is also available, union of the two is fetched. Valid values - all, always, never, request, default. Values are case-insensitive.
     */
    attributeSets?: pulumi.Input<pulumi.Input<string>[] | undefined>;
