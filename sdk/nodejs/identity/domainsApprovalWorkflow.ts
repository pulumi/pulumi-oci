 ...
 * ```
 */
export class DomainsApprovalWorkflow extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DomainsApprovalWorkflowState, opts?: pulumi.CustomResourceOptions): DomainsApprovalWorkflow {
        return new DomainsApprovalWorkflow(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:Identity/domainsApprovalWorkflow:DomainsApprovalWorkflow';

    /**
     * Returns true if the given object is an instance of DomainsApprovalWorkflow.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DomainsApprovalWorkflow {
     ...
     * * uniqueness: none
     */
    declare public readonly approvalWorkflowSteps: pulumi.Output<outputs.Identity.DomainsApprovalWorkflowApprovalWorkflowStep[]>;
    /**
     ...
     * * type: complex
     */
    declare public /*out*/ readonly idcsCreatedBies: pulumi.Output<outputs.Identity.DomainsApprovalWorkflowIdcsCreatedBy[]>;
    /**
     ...
     * * type: complex
     */
    declare public /*out*/ readonly idcsLastModifiedBies: pulumi.Output<outputs.Identity.DomainsApprovalWorkflowIdcsLastModifiedBy[]>;
    /**
     ...
     * * uniqueness: none
     */
    declare public readonly maxDuration: pulumi.Output<outputs.Identity.DomainsApprovalWorkflowMaxDuration>;
    /**
     ...
     * * type: complex
     */
    declare public /*out*/ readonly metas: pulumi.Output<outputs.Identity.DomainsApprovalWorkflowMeta[]>;
    /**
     ...
     * * uniqueness: none
     */
    declare public readonly tags: pulumi.Output<outputs.Identity.DomainsApprovalWorkflowTag[]>;
    /**
    ...
    constructor(name: string, argsOrState?: DomainsApprovalWorkflowArgs | DomainsApprovalWorkflowState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DomainsApprovalWorkflowState | undefined;
            ...
            const args = argsOrState as DomainsApprovalWorkflowArgs | undefined;
