...
export class DomainsApprovalWorkflowAssignment extends pulumi.CustomResource {
     ...
     * * uniqueness: none
     */
    declare public readonly approvalWorkflow: pulumi.Output<outputs.Identity.DomainsApprovalWorkflowAssignmentApprovalWorkflow>;
    /**
     ...
     * * uniqueness: none
     */
    declare public readonly assignedTo: pulumi.Output<outputs.Identity.DomainsApprovalWorkflowAssignmentAssignedTo>;
    /**
     ...
     * * type: complex
     */
    declare public /*out*/ readonly idcsCreatedBies: pulumi.Output<outputs.Identity.DomainsApprovalWorkflowAssignmentIdcsCreatedBy[]>;
    /**
     ...
     * * type: complex
     */
    declare public /*out*/ readonly idcsLastModifiedBies: pulumi.Output<outputs.Identity.DomainsApprovalWorkflowAssignmentIdcsLastModifiedBy[]>;
    /**
     ...
     * * type: complex
     */
    declare public /*out*/ readonly metas: pulumi.Output<outputs.Identity.DomainsApprovalWorkflowAssignmentMeta[]>;
    /**
     ...
     * * uniqueness: none
     */
    declare public readonly tags: pulumi.Output<outputs.Identity.DomainsApprovalWorkflowAssignmentTag[]>;
    /**
    ...
    constructor(name: string, argsOrState?: DomainsApprovalWorkflowAssignmentArgs | DomainsApprovalWorkflowAssignmentState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            if (args?.approvalWorkflow === undefined && !opts.urn) {
                throw new Error("Missing required property 'approvalWorkflow'");
            }
            if (args?.assignedTo === undefined && !opts.urn) {
...
export interface DomainsApprovalWorkflowAssignmentState {
     ...
     * * uniqueness: none
     */
    approvalWorkflow?: pulumi.Input<inputs.Identity.DomainsApprovalWorkflowAssignmentApprovalWorkflow | undefined>;
    /**
     * Details of resource for which Approval Workflow is assigned
     *
     * **SCIM++ Properties:**
     ...
     * * uniqueness: none
     */
    assignedTo?: pulumi.Input<inputs.Identity.DomainsApprovalWorkflowAssignmentAssignedTo | undefined>;
    /**
     * Type of approval workflow assignment to the resource. Resources like Group have only one workflow associated (default assignment type is membership), but resources like TemporalBusinessRole can have atleast 2 AWs attached, one for membership to TPR, another for activation of that TPR membership
     *
     * **SCIM++ Properties:**
     ...
     * * type: complex
     */
    idcsCreatedBies?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsApprovalWorkflowAssignmentIdcsCreatedBy>[] | undefined>;
    /**
     * The basic endpoint for the identity domain
     */
     ...
     * * type: complex
     */
    idcsLastModifiedBies?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsApprovalWorkflowAssignmentIdcsLastModifiedBy>[] | undefined>;
    /**
     * (Updatable) The release number when the resource was upgraded.
     *
     * **SCIM++ Properties:**
     ...
     * * type: complex
     */
    metas?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsApprovalWorkflowAssignmentMeta>[] | undefined>;
    /**
     * Unique Oracle Cloud Infrastructure identifier for the SCIM Resource.
     *
     * **SCIM++ Properties:**
     ...
     * * uniqueness: none
     */
    tags?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsApprovalWorkflowAssignmentTag>[] | undefined>;
    /**
     * (Updatable) Oracle Cloud Infrastructure Tenant Id (ocid) in which the resource lives.
     *
     * **SCIM++ Properties:**
