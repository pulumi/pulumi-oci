...
export class DomainsNetworkPerimeter extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DomainsNetworkPerimeterState, opts?: pulumi.CustomResourceOptions): DomainsNetworkPerimeter {
        return new DomainsNetworkPerimeter(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:Identity/domainsNetworkPerimeter:DomainsNetworkPerimeter';

    /**
     * Returns true if the given object is an instance of DomainsNetworkPerimeter.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DomainsNetworkPerimeter {
     ...
     * * type: complex
     */
    declare public /*out*/ readonly idcsCreatedBies: pulumi.Output<outputs.Identity.DomainsNetworkPerimeterIdcsCreatedBy[]>;
    /**
     ...
     * * type: complex
     */
    declare public /*out*/ readonly idcsLastModifiedBies: pulumi.Output<outputs.Identity.DomainsNetworkPerimeterIdcsLastModifiedBy[]>;
    /**
     ...
     * * uniqueness: none
     */
    declare public readonly ipAddresses: pulumi.Output<outputs.Identity.DomainsNetworkPerimeterIpAddress[]>;
    /**
     ...
     * * type: complex
     */
    declare public /*out*/ readonly metas: pulumi.Output<outputs.Identity.DomainsNetworkPerimeterMeta[]>;
    /**
     ...
     * * uniqueness: none
     */
    declare public readonly tags: pulumi.Output<outputs.Identity.DomainsNetworkPerimeterTag[]>;
    /**
    ...
    constructor(name: string, argsOrState?: DomainsNetworkPerimeterArgs | DomainsNetworkPerimeterState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DomainsNetworkPerimeterState | undefined;
            ...
            const args = argsOrState as DomainsNetworkPerimeterArgs | undefined;
...
export interface DomainsNetworkPerimeterState {
     ...
     * * type: complex
     */
    idcsCreatedBies?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsNetworkPerimeterIdcsCreatedBy>[] | undefined>;
    /**
     * The basic endpoint for the identity domain
     */
     ...
     * * type: complex
     */
    idcsLastModifiedBies?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsNetworkPerimeterIdcsLastModifiedBy>[] | undefined>;
    /**
     * (Updatable) The release number when the resource was upgraded.
     *
     * **SCIM++ Properties:**
     ...
     * * uniqueness: none
     */
    ipAddresses?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsNetworkPerimeterIpAddress>[] | undefined>;
    /**
     * (Updatable) A complex attribute that contains resource metadata. All sub-attributes are OPTIONAL.
     *
     * **SCIM++ Properties:**
     ...
     * * type: complex
     */
    metas?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsNetworkPerimeterMeta>[] | undefined>;
    /**
     * (Updatable) NetworkPerimeter name
     *
     * **SCIM++ Properties:**
     ...
     * * uniqueness: none
     */
    tags?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsNetworkPerimeterTag>[] | undefined>;
    /**
     * (Updatable) Oracle Cloud Infrastructure Tenant Id (ocid) in which the resource lives.
     *
     * **SCIM++ Properties:**
