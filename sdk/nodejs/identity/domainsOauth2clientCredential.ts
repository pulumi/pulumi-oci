...
export class DomainsOauth2clientCredential extends pulumi.CustomResource {
     ...
     * * type: complex
     */
    declare public /*out*/ readonly idcsCreatedBies: pulumi.Output<outputs.Identity.DomainsOauth2clientCredentialIdcsCreatedBy[]>;
    /**
     ...
     * * type: complex
     */
    declare public /*out*/ readonly idcsLastModifiedBies: pulumi.Output<outputs.Identity.DomainsOauth2clientCredentialIdcsLastModifiedBy[]>;
    /**
     ...
     * * uniqueness: none
     */
    declare public readonly isResetSecret: pulumi.Output<boolean>;
    /**
     ...
     * * type: complex
     */
    declare public /*out*/ readonly metas: pulumi.Output<outputs.Identity.DomainsOauth2clientCredentialMeta[]>;
    /**
     * Name
     *
     * **SCIM++ Properties:**
     ...
     * * returned: default
     */
    declare public readonly scopes: pulumi.Output<outputs.Identity.DomainsOauth2clientCredentialScope[]>;
    /**
     * (Updatable) Secret
     *
     * **SCIM++ Properties:**
     ...
     * * uniqueness: none
     */
    declare public readonly tags: pulumi.Output<outputs.Identity.DomainsOauth2clientCredentialTag[]>;
    /**
     ...
     */
    declare public readonly urnietfparamsscimschemasoracleidcsextensionselfChangeUser: pulumi.Output<outputs.Identity.DomainsOauth2clientCredentialUrnietfparamsscimschemasoracleidcsextensionselfChangeUser>;
    /**
     ...
     * * uniqueness: none
     */
    declare public readonly user: pulumi.Output<outputs.Identity.DomainsOauth2clientCredentialUser>;
    ...
    constructor(name: string, argsOrState?: DomainsOauth2clientCredentialArgs | DomainsOauth2clientCredentialState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            resourceInputs["isResetSecret"] = state?.isResetSecret;
            ...
            resourceInputs["isResetSecret"] = args?.isResetSecret;
...
export interface DomainsOauth2clientCredentialState {
     ...
     * * type: complex
     */
    idcsCreatedBies?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsOauth2clientCredentialIdcsCreatedBy>[] | undefined>;
    /**
     * The basic endpoint for the identity domain
     */
     ...
     * * type: complex
     */
    idcsLastModifiedBies?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsOauth2clientCredentialIdcsLastModifiedBy>[] | undefined>;
    /**
     * (Updatable) The release number when the resource was upgraded.
     *
     * **SCIM++ Properties:**
     ...
     * * type: complex
     */
    metas?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsOauth2clientCredentialMeta>[] | undefined>;
    /**
     * Name
     *
     * **SCIM++ Properties:**
     ...
     * * returned: default
     */
    scopes?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsOauth2clientCredentialScope>[] | undefined>;
    /**
     * (Updatable) Secret
     *
     * **SCIM++ Properties:**
     ...
     * * uniqueness: none
     */
    tags?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsOauth2clientCredentialTag>[] | undefined>;
    /**
     * (Updatable) Oracle Cloud Infrastructure Tenant Id (ocid) in which the resource lives.
     *
     * **SCIM++ Properties:**
     ...
     * Controls whether a user can update themselves or not via User related APIs
     */
    urnietfparamsscimschemasoracleidcsextensionselfChangeUser?: pulumi.Input<inputs.Identity.DomainsOauth2clientCredentialUrnietfparamsscimschemasoracleidcsextensionselfChangeUser | undefined>;
    /**
     * The user linked to the OAuth2 client credential.
     *
     * **SCIM++ Properties:**
     ...
     * * uniqueness: none
     */
    user?: pulumi.Input<inputs.Identity.DomainsOauth2clientCredentialUser | undefined>;
}
