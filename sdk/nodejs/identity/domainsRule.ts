...
export class DomainsRule extends pulumi.CustomResource {
     ...
     * * uniqueness: none
     */
    declare public readonly conditionGroup: pulumi.Output<outputs.Identity.DomainsRuleConditionGroup>;
    /**
     ...
     * * type: complex
     */
    declare public /*out*/ readonly idcsCreatedBies: pulumi.Output<outputs.Identity.DomainsRuleIdcsCreatedBy[]>;
    /**
     ...
     * * type: complex
     */
    declare public /*out*/ readonly idcsLastModifiedBies: pulumi.Output<outputs.Identity.DomainsRuleIdcsLastModifiedBy[]>;
    /**
     ...
     * * type: complex
     */
    declare public /*out*/ readonly metas: pulumi.Output<outputs.Identity.DomainsRuleMeta[]>;
    /**
     * (Updatable) Rule name
     *
     * **SCIM++ Properties:**
     ...
     * * uniqueness: none
     */
    declare public readonly policyType: pulumi.Output<outputs.Identity.DomainsRulePolicyType>;
    /**
     ...
     * * uniqueness: none
     */
    declare public readonly returns: pulumi.Output<outputs.Identity.DomainsRuleReturn[]>;
    /**
     ...
     * * uniqueness: none
     */
    declare public readonly ruleGroovy: pulumi.Output<string>;
    /**
     ...
     * * uniqueness: none
     */
    declare public readonly tags: pulumi.Output<outputs.Identity.DomainsRuleTag[]>;
    /**
...
export interface DomainsRuleState {
     ...
     * * uniqueness: none
     */
    conditionGroup?: pulumi.Input<inputs.Identity.DomainsRuleConditionGroup | undefined>;
    /**
     * (Updatable) A boolean flag indicating this resource in the process of being deleted. Usually set to true when synchronous deletion of the resource would take too long.
     *
     * **SCIM++ Properties:**
     ...
     * * type: complex
     */
    idcsCreatedBies?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsRuleIdcsCreatedBy>[] | undefined>;
    /**
     * The basic endpoint for the identity domain
     */
     ...
     * * type: complex
     */
    idcsLastModifiedBies?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsRuleIdcsLastModifiedBy>[] | undefined>;
    /**
     * (Updatable) The release number when the resource was upgraded.
     *
     * **SCIM++ Properties:**
     ...
     * * type: complex
     */
    metas?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsRuleMeta>[] | undefined>;
    /**
     * (Updatable) Rule name
     *
     * **SCIM++ Properties:**
     ...
     * * uniqueness: none
     */
    policyType?: pulumi.Input<inputs.Identity.DomainsRulePolicyType | undefined>;
    /**
     * (Updatable) An endpoint-specific schema version number to use in the Request. Allowed version values are Earliest Version or Latest Version as specified in each REST API endpoint description, or any sequential number inbetween. All schema attributes/body parameters are a part of version 1. After version 1, any attributes added or deprecated will be tagged with the version that they were added to or deprecated in. If no version is provided, the latest schema version is returned.
     */
     ...
     * * uniqueness: none
     */
    returns?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsRuleReturn>[] | undefined>;
    /**
     * (Updatable) The Groovy script that is run instead of the rule, if policy type allows the rule to be a Groovy script.
     *
     * **SCIM++ Properties:**
     ...
     * * uniqueness: none
     */
    ruleGroovy?: pulumi.Input<string | undefined>;
    /**
     * (Updatable) REQUIRED. The schemas attribute is an array of Strings which allows introspection of the supported schema version for a SCIM representation as well any schema extensions supported by that representation. Each String value must be a unique URI. This specification defines URIs for User, Group, and a standard \"enterprise\" extension. All representations of SCIM schema MUST include a non-zero value array with value(s) of the URIs supported by that representation. Duplicate values MUST NOT be included. Value order is not specified and MUST not impact behavior.
     *
     * **SCIM++ Properties:**
     ...
     * * uniqueness: none
     */
    tags?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsRuleTag>[] | undefined>;
    /**
     * (Updatable) Oracle Cloud Infrastructure Tenant Id (ocid) in which the resource lives.
     *
     * **SCIM++ Properties:**
