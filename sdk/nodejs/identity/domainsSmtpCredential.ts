...
export class DomainsSmtpCredential extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: DomainsSmtpCredentialState, opts?: pulumi.CustomResourceOptions): DomainsSmtpCredential {
        return new DomainsSmtpCredential(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:Identity/domainsSmtpCredential:DomainsSmtpCredential';

    /**
     * Returns true if the given object is an instance of DomainsSmtpCredential.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is DomainsSmtpCredential {
     ...
     * * type: complex
     */
    declare public /*out*/ readonly idcsCreatedBies: pulumi.Output<outputs.Identity.DomainsSmtpCredentialIdcsCreatedBy[]>;
    /**
     ...
     * * type: complex
     */
    declare public /*out*/ readonly idcsLastModifiedBies: pulumi.Output<outputs.Identity.DomainsSmtpCredentialIdcsLastModifiedBy[]>;
    /**
     ...
     * * type: complex
     */
    declare public /*out*/ readonly metas: pulumi.Output<outputs.Identity.DomainsSmtpCredentialMeta[]>;
    /**
     ...
     * * uniqueness: none
     */
    declare public readonly tags: pulumi.Output<outputs.Identity.DomainsSmtpCredentialTag[]>;
    /**
     ...
     */
    declare public readonly urnietfparamsscimschemasoracleidcsextensionselfChangeUser: pulumi.Output<outputs.Identity.DomainsSmtpCredentialUrnietfparamsscimschemasoracleidcsextensionselfChangeUser>;
    /**
     ...
     * * uniqueness: none
     */
    declare public readonly user: pulumi.Output<outputs.Identity.DomainsSmtpCredentialUser>;
    /**
     * (Updatable) User name
     *
     * **SCIM++ Properties:**
    ...
    constructor(name: string, argsOrState?: DomainsSmtpCredentialArgs | DomainsSmtpCredentialState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as DomainsSmtpCredentialState | undefined;
            ...
            const args = argsOrState as DomainsSmtpCredentialArgs | undefined;
...
export interface DomainsSmtpCredentialState {
     ...
     * * type: complex
     */
    idcsCreatedBies?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsSmtpCredentialIdcsCreatedBy>[] | undefined>;
    /**
     * The basic endpoint for the identity domain
     */
     ...
     * * type: complex
     */
    idcsLastModifiedBies?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsSmtpCredentialIdcsLastModifiedBy>[] | undefined>;
    /**
     * (Updatable) The release number when the resource was upgraded.
     *
     * **SCIM++ Properties:**
     ...
     * * type: complex
     */
    metas?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsSmtpCredentialMeta>[] | undefined>;
    /**
     * Unique Oracle Cloud Infrastructure identifier for the SCIM Resource.
     *
     * **SCIM++ Properties:**
     ...
     * * uniqueness: none
     */
    tags?: pulumi.Input<pulumi.Input<inputs.Identity.DomainsSmtpCredentialTag>[] | undefined>;
    /**
     * (Updatable) Oracle Cloud Infrastructure Tenant Id (ocid) in which the resource lives.
     *
     * **SCIM++ Properties:**
     ...
     * Controls whether a user can update themselves or not via User related APIs
     */
    urnietfparamsscimschemasoracleidcsextensionselfChangeUser?: pulumi.Input<inputs.Identity.DomainsSmtpCredentialUrnietfparamsscimschemasoracleidcsextensionselfChangeUser | undefined>;
    /**
     * User linked to smtp credential
     *
     * **SCIM++ Properties:**
     ...
     * * uniqueness: none
     */
    user?: pulumi.Input<inputs.Identity.DomainsSmtpCredentialUser | undefined>;
    /**
     * (Updatable) User name
     *
     * **SCIM++ Properties:**
