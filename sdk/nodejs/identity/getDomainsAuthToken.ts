 ...
 */
export interface GetDomainsAuthTokenArgs {
    /**
 ...
 */
export interface GetDomainsAuthTokenResult {
     ...
     */
    readonly idcsCreatedBies: outputs.Identity.GetDomainsAuthTokenIdcsCreatedBy[];
    readonly idcsEndpoint: string;
    /**
     * The User or App who modified the Resource
     */
    readonly idcsLastModifiedBies: outputs.Identity.GetDomainsAuthTokenIdcsLastModifiedBy[];
    /**
     ...
     */
    readonly metas: outputs.Identity.GetDomainsAuthTokenMeta[];
    /**
     * The user's OCID.
     */
     ...
     */
    readonly tags: outputs.Identity.GetDomainsAuthTokenTag[];
    /**
     ...
     */
    readonly users: outputs.Identity.GetDomainsAuthTokenUser[];
}
/**
 * This data source provides details about a specific Auth Token resource in Oracle Cloud Infrastructure Identity Domains service.
 *
 ...
 * ```
 */
export function getDomainsAuthTokenOutput(args: GetDomainsAuthTokenOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsAuthTokenResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
 ...
 * A collection of arguments for invoking getDomainsAuthToken.
 */
export interface GetDomainsAuthTokenOutputArgs {
    /**
     * A multi-valued list of strings indicating the return type of attribute definition. The specified set of attributes can be fetched by the return type of the attribute. One or more values can be given together to fetch more than one group of attributes. If 'attributes' query parameter is also available, union of the two is fetched. Valid values - all, always, never, request, default. Values are case-insensitive.
     */
