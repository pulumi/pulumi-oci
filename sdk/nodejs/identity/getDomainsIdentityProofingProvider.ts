 ...
 * ```
 */
export function getDomainsIdentityProofingProvider(args: GetDomainsIdentityProofingProviderArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsIdentityProofingProviderResult> {
 ...
 * ```
 */
export function getDomainsIdentityProofingProviderOutput(args: GetDomainsIdentityProofingProviderOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsIdentityProofingProviderResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
