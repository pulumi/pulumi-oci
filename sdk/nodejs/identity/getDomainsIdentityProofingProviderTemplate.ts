 ...
 * ```
 */
export function getDomainsIdentityProofingProviderTemplate(args: GetDomainsIdentityProofingProviderTemplateArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsIdentityProofingProviderTemplateResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("oci:Identity/getDomainsIdentityProofingProviderTemplate:getDomainsIdentityProofingProviderTemplate", {
        "attributeSets": args.attributeSets,
        "attributes": args.attributes,
        "authorization": args.authorization,
        "idcsEndpoint": args.idcsEndpoint,
        "identityProofingProviderTemplateId": args.identityProofingProviderTemplateId,
 ...
 * ```
 */
export function getDomainsIdentityProofingProviderTemplateOutput(args: GetDomainsIdentityProofingProviderTemplateOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsIdentityProofingProviderTemplateResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("oci:Identity/getDomainsIdentityProofingProviderTemplate:getDomainsIdentityProofingProviderTemplate", {
        "attributeSets": args.attributeSets,
        "attributes": args.attributes,
        "authorization": args.authorization,
        "idcsEndpoint": args.idcsEndpoint,
