 ...
 * ```
 */
export function getDomainsMappedAttribute(args: GetDomainsMappedAttributeArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsMappedAttributeResult> {
 ...
 * ```
 */
export function getDomainsMappedAttributeOutput(args: GetDomainsMappedAttributeOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsMappedAttributeResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
