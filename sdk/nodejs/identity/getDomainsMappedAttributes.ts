 ...
 * ```
 */
export function getDomainsMappedAttributes(args: GetDomainsMappedAttributesArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsMappedAttributesResult> {
 ...
 * ```
 */
export function getDomainsMappedAttributesOutput(args: GetDomainsMappedAttributesOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsMappedAttributesResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
