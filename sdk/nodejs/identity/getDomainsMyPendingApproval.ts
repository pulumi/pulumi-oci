 ...
 * ```
 */
export function getDomainsMyPendingApproval(args: GetDomainsMyPendingApprovalArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsMyPendingApprovalResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("oci:Identity/getDomainsMyPendingApproval:getDomainsMyPendingApproval", {
 ...
 */
export interface GetDomainsMyPendingApprovalArgs {
    /**
 ...
 */
export interface GetDomainsMyPendingApprovalResult {
     ...
     */
    readonly idcsCreatedBies: outputs.Identity.GetDomainsMyPendingApprovalIdcsCreatedBy[];
    readonly idcsEndpoint: string;
    /**
     * The User or App who modified the Resource
     */
    readonly idcsLastModifiedBies: outputs.Identity.GetDomainsMyPendingApprovalIdcsLastModifiedBy[];
    /**
     ...
     */
    readonly metas: outputs.Identity.GetDomainsMyPendingApprovalMeta[];
     ...
     */
    readonly tags: outputs.Identity.GetDomainsMyPendingApprovalTag[];
    /**
 ...
 * ```
 */
export function getDomainsMyPendingApprovalOutput(args: GetDomainsMyPendingApprovalOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsMyPendingApprovalResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("oci:Identity/getDomainsMyPendingApproval:getDomainsMyPendingApproval", {
        "authorization": args.authorization,
        "idcsEndpoint": args.idcsEndpoint,
        "myPendingApprovalId": args.myPendingApprovalId,
        "resourceTypeSchemaVersion": args.resourceTypeSchemaVersion,
 ...
 * A collection of arguments for invoking getDomainsMyPendingApproval.
 */
export interface GetDomainsMyPendingApprovalOutputArgs {
    /**
     * The Authorization field value consists of credentials containing the authentication information of the user agent for the realm of the resource being requested.
     */
