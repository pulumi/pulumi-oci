 ...
 * ```
 */
export function getDomainsPolicy(args: GetDomainsPolicyArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsPolicyResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("oci:Identity/getDomainsPolicy:getDomainsPolicy", {
 ...
 */
export interface GetDomainsPolicyArgs {
    /**
 ...
 */
export interface GetDomainsPolicyResult {
    /**
     ...
     */
    readonly idcsCreatedBies: outputs.Identity.GetDomainsPolicyIdcsCreatedBy[];
    readonly idcsEndpoint: string;
    /**
     * The User or App who modified the Resource
     */
    readonly idcsLastModifiedBies: outputs.Identity.GetDomainsPolicyIdcsLastModifiedBy[];
    /**
     ...
     */
    readonly metas: outputs.Identity.GetDomainsPolicyMeta[];
    /**
     * Rule name
     */
     ...
     */
    readonly policyTypes: outputs.Identity.GetDomainsPolicyPolicyType[];
    readonly resourceTypeSchemaVersion?: string;
    /**
     * Rules assigned to this policy
     */
    readonly rules: outputs.Identity.GetDomainsPolicyRule[];
    /**
     ...
     */
    readonly tags: outputs.Identity.GetDomainsPolicyTag[];
    /**
 ...
 * ```
 */
export function getDomainsPolicyOutput(args: GetDomainsPolicyOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDomainsPolicyResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("oci:Identity/getDomainsPolicy:getDomainsPolicy", {
        "attributeSets": args.attributeSets,
        "attributes": args.attributes,
        "authorization": args.authorization,
        "idcsEndpoint": args.idcsEndpoint,
 ...
 * A collection of arguments for invoking getDomainsPolicy.
 */
export interface GetDomainsPolicyOutputArgs {
    /**
     * A multi-valued list of strings indicating the return type of attribute definition. The specified set of attributes can be fetched by the return type of the attribute. One or more values can be given together to fetch more than one group of attributes. If 'attributes' query parameter is also available, union of the two is fetched. Valid values - all, always, never, request, default. Values are case-insensitive.
     */
