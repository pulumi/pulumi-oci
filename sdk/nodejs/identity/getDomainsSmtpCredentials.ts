 ...
 *     smtpCredentialCount: _var.smtp_credential_smtp_credential_count,
 *     smtpCredentialFilter: _var.smtp_credential_smtp_credential_filter,
 *     attributeSets: [],
 *     attributes: "",
 ...
 *     startIndex: _var.smtp_credential_start_index,
 * });
 * ```
 */
export function getDomainsSmtpCredentials(args: GetDomainsSmtpCredentialsArgs, opts?: pulumi.InvokeOptions): Promise<GetDomainsSmtpCredentialsResult> {

    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("oci:Identity/getDomainsSmtpCredentials:getDomainsSmtpCredentials", {
 ...
 */
export interface GetDomainsSmtpCredentialsArgs {
    /**
 ...
 */
export interface GetDomainsSmtpCredentialsResult {
     ...
     */
    readonly smtpCredentials?: outputs.Identity.GetDomainsSmtpCredentialsSmtpCredential[];
...
export function getDomainsSmtpCredentialsOutput(args: GetDomainsSmtpCredentialsOutputArgs, opts?: pulumi.InvokeOptions): pulumi.Output<GetDomainsSmtpCredentialsResult> {
    return pulumi.output(args).apply((a: any) => getDomainsSmtpCredentials(a, opts))
}

/**
 * A collection of arguments for invoking getDomainsSmtpCredentials.
 */
export interface GetDomainsSmtpCredentialsOutputArgs {
    /**
     * A multi-valued list of strings indicating the return type of attribute definition. The specified set of attributes can be fetched by the return type of the attribute. One or more values can be given together to fetch more than one group of attributes. If 'attributes' query parameter is also available, union of the two is fetched. Valid values - all, always, never, request, default. Values are case-insensitive.
     */
