...
export interface KeyVersionState {
     ...
     * Key reference data to be returned to the customer as a response.
     */
    externalKeyReferenceDetails?: pulumi.Input<pulumi.Input<inputs.Kms.KeyVersionExternalKeyReferenceDetail>[] | undefined>;
    /**
     * Key version ID associated with the external key.
     */
    externalKeyVersionId?: pulumi.Input<string | undefined>;
    /**
     * An optional property indicating whether this keyversion is generated from auto rotatation.
     */
    isAutoRotated?: pulumi.Input<boolean | undefined>;
    /**
     * A Boolean value that indicates whether the KeyVersion belongs to primary Vault or replica Vault.
     */
     ...
     * KeyVersion replica details
     */
    replicaDetails?: pulumi.Input<pulumi.Input<inputs.Kms.KeyVersionReplicaDetail>[] | undefined>;
    restoredFromKeyId?: pulumi.Input<string | undefined>;
    /**
     * The OCID of the key version from which this key version was restored.
     */
    restoredFromKeyVersionId?: pulumi.Input<string | undefined>;
    /**
     * The key version's current lifecycle state.  Example: `ENABLED`
     */
