 ...
 * ```
 */
export class LogAnalyticsEntityAssociationsAdd extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: LogAnalyticsEntityAssociationsAddState, opts?: pulumi.CustomResourceOptions): LogAnalyticsEntityAssociationsAdd {
        return new LogAnalyticsEntityAssociationsAdd(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:LogAnalytics/logAnalyticsEntityAssociationsAdd:LogAnalyticsEntityAssociationsAdd';
     ...
     */
    public static isInstance(obj: any): obj is LogAnalyticsEntityAssociationsAdd {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === LogAnalyticsEntityAssociationsAdd.__pulumiType;
    }
    ...
    constructor(name: string, argsOrState?: LogAnalyticsEntityAssociationsAddArgs | LogAnalyticsEntityAssociationsAddState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as LogAnalyticsEntityAssociationsAddState | undefined;
            ...
            const args = argsOrState as LogAnalyticsEntityAssociationsAddArgs | undefined;
        ...
        super(LogAnalyticsEntityAssociationsAdd.__pulumiType, name, resourceInputs, opts);
    }
}
