...
export class FileStorageLustreFileSystem extends pulumi.CustomResource {
     ...
     */
    declare public readonly capacityInGbs: pulumi.Output<number>;
    /**
     ...
     */
    declare public readonly fileSystemDescription: pulumi.Output<string>;
    /**
     ...
     */
    declare public /*out*/ readonly majorVersion: pulumi.Output<string>;
    /**
     * The IPv4 address of MGS (Lustre Management Service) used by clients to mount the file system. For example '10.0.0.4'.
     */
    declare public /*out*/ readonly managementServiceAddress: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly performanceTier: pulumi.Output<string>;
    /**
     ...
     */
    declare public readonly rootSquashConfiguration: pulumi.Output<outputs.Lustre.FileStorageLustreFileSystemRootSquashConfiguration>;
    /**
