 ...
 * ```
 */
export function getFileStorageLustreFileSystem(args: GetFileStorageLustreFileSystemArgs, opts?: pulumi.InvokeOptions): Promise<GetFileStorageLustreFileSystemResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("oci:Lustre/getFileStorageLustreFileSystem:getFileStorageLustreFileSystem", {
 ...
 */
export interface GetFileStorageLustreFileSystemArgs {
    /**
 ...
 */
export interface GetFileStorageLustreFileSystemResult {
    /**
     ...
     */
    readonly rootSquashConfigurations: outputs.Lustre.GetFileStorageLustreFileSystemRootSquashConfiguration[];
    /**
 ...
 * ```
 */
export function getFileStorageLustreFileSystemOutput(args: GetFileStorageLustreFileSystemOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFileStorageLustreFileSystemResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("oci:Lustre/getFileStorageLustreFileSystem:getFileStorageLustreFileSystem", {
        "lustreFileSystemId": args.lustreFileSystemId,
    }, opts);
}
 ...
 * A collection of arguments for invoking getFileStorageLustreFileSystem.
 */
export interface GetFileStorageLustreFileSystemOutputArgs {
    /**
     * The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Lustre file system.
     */
