 ...
 * ```
 */
export function getFileStorageLustreFileSystems(args?: GetFileStorageLustreFileSystemsArgs, opts?: pulumi.InvokeOptions): Promise<GetFileStorageLustreFileSystemsResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("oci:Lustre/getFileStorageLustreFileSystems:getFileStorageLustreFileSystems", {
 ...
 * ```
 */
export function getFileStorageLustreFileSystemsOutput(args?: GetFileStorageLustreFileSystemsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetFileStorageLustreFileSystemsResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("oci:Lustre/getFileStorageLustreFileSystems:getFileStorageLustreFileSystems", {
        "availabilityDomain": args.availabilityDomain,
        "compartmentId": args.compartmentId,
        "displayName": args.displayName,
        "filters": args.filters,
