 ...
 * ```
 */
export function getMediaWorkflowsOutput(args?: GetMediaWorkflowsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetMediaWorkflowsResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
export interface GetMediaWorkflowsOutputArgs {
    ...
    filters?: pulumi.Input<pulumi.Input<inputs.MediaServices.GetMediaWorkflowsFilterArgs>[] | undefined>;
    /**
     * Unique MediaWorkflow identifier.
     */
