 ...
 * ```
 */
export class StreamDistributionChannel extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: StreamDistributionChannelState, opts?: pulumi.CustomResourceOptions): StreamDistributionChannel {
        return new StreamDistributionChannel(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:MediaServices/streamDistributionChannel:StreamDistributionChannel';
     ...
     */
    public static isInstance(obj: any): obj is StreamDistributionChannel {
     ...
     */
    declare public readonly locks: pulumi.Output<outputs.MediaServices.StreamDistributionChannelLock[]>;
    /**
    ...
    constructor(name: string, argsOrState?: StreamDistributionChannelArgs | StreamDistributionChannelState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as StreamDistributionChannelState | undefined;
            ...
            const args = argsOrState as StreamDistributionChannelArgs | undefined;
...
export interface StreamDistributionChannelState {
     ...
     * Locks associated with this resource.
     */
    locks?: pulumi.Input<pulumi.Input<inputs.MediaServices.StreamDistributionChannelLock>[] | undefined>;
    /**
     * The current state of the Stream Distribution Channel.
     */
