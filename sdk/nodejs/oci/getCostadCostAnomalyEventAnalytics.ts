 ...
 *
 * const testCostAnomalyEventAnalytics = oci.oci.getCostadCostAnomalyEventAnalytics({
 ...
 * ```
 */
export function getCostadCostAnomalyEventAnalytics(args: GetCostadCostAnomalyEventAnalyticsArgs, opts?: pulumi.InvokeOptions): Promise<GetCostadCostAnomalyEventAnalyticsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("oci:oci/getCostadCostAnomalyEventAnalytics:getCostadCostAnomalyEventAnalytics", {
 ...
 */
export interface GetCostadCostAnomalyEventAnalyticsArgs {
    /**
    ...
    filters?: inputs.oci.GetCostadCostAnomalyEventAnalyticsFilter[];
    /**
 ...
 */
export interface GetCostadCostAnomalyEventAnalyticsResult {
    readonly compartmentId: string;
    /**
     * The list of cost_anomaly_event_analytic_collection.
     */
    readonly costAnomalyEventAnalyticCollections: outputs.oci.GetCostadCostAnomalyEventAnalyticsCostAnomalyEventAnalyticCollection[];
    readonly costAnomalyMonitorId?: string;
    readonly costImpact?: number;
    readonly costImpactPercentage?: number;
    readonly filters?: outputs.oci.GetCostadCostAnomalyEventAnalyticsFilter[];
    /**
 ...
 * ```
 */
export function getCostadCostAnomalyEventAnalyticsOutput(args: GetCostadCostAnomalyEventAnalyticsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetCostadCostAnomalyEventAnalyticsResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("oci:oci/getCostadCostAnomalyEventAnalytics:getCostadCostAnomalyEventAnalytics", {
        "compartmentId": args.compartmentId,
        "costAnomalyMonitorId": args.costAnomalyMonitorId,
        "costImpact": args.costImpact,
        "costImpactPercentage": args.costImpactPercentage,
 ...
 * A collection of arguments for invoking getCostadCostAnomalyEventAnalytics.
 */
export interface GetCostadCostAnomalyEventAnalyticsOutputArgs {
    /**
     * The ID of the compartment in which to list resources.
     */
    ...
    filters?: pulumi.Input<pulumi.Input<inputs.oci.GetCostadCostAnomalyEventAnalyticsFilterArgs>[] | undefined>;
    /**
     * Unique, non-changeable resource name.
     */
