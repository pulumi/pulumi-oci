 ...
 * ```
 */
export function getDbmulticloudOracleDbAzureBlobMount(args: GetDbmulticloudOracleDbAzureBlobMountArgs, opts?: pulumi.InvokeOptions): Promise<GetDbmulticloudOracleDbAzureBlobMountResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invoke("oci:oci/getDbmulticloudOracleDbAzureBlobMount:getDbmulticloudOracleDbAzureBlobMount", {
 ...
 * ```
 */
export function getDbmulticloudOracleDbAzureBlobMountOutput(args: GetDbmulticloudOracleDbAzureBlobMountOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetDbmulticloudOracleDbAzureBlobMountResult> {
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
    return pulumi.runtime.invokeOutput("oci:oci/getDbmulticloudOracleDbAzureBlobMount:getDbmulticloudOracleDbAzureBlobMount", {
        "oracleDbAzureBlobMountId": args.oracleDbAzureBlobMountId,
    }, opts);
}
