 ...
 * ```
 */
export class ManagedKafkaKafkaClusterConfig extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedKafkaKafkaClusterConfigState, opts?: pulumi.CustomResourceOptions): ManagedKafkaKafkaClusterConfig {
        return new ManagedKafkaKafkaClusterConfig(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:oci/managedKafkaKafkaClusterConfig:ManagedKafkaKafkaClusterConfig';

    /**
     * Returns true if the given object is an instance of ManagedKafkaKafkaClusterConfig.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is ManagedKafkaKafkaClusterConfig {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === ManagedKafkaKafkaClusterConfig.__pulumiType;
    }
     ...
     */
    declare public readonly latestConfig: pulumi.Output<outputs.oci.ManagedKafkaKafkaClusterConfigLatestConfig>;
    /**
     ...
     */
    constructor(name: string, args: ManagedKafkaKafkaClusterConfigArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: ManagedKafkaKafkaClusterConfigArgs | ManagedKafkaKafkaClusterConfigState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ManagedKafkaKafkaClusterConfigState | undefined;
            resourceInputs["compartmentId"] = state?.compartmentId;
            resourceInputs["definedTags"] = state?.definedTags;
            resourceInputs["displayName"] = state?.displayName;
            resourceInputs["freeformTags"] = state?.freeformTags;
            resourceInputs["latestConfig"] = state?.latestConfig;
            ...
            const args = argsOrState as ManagedKafkaKafkaClusterConfigArgs | undefined;
            if (args?.compartmentId === undefined && !opts.urn) {
                throw new Error("Missing required property 'compartmentId'");
            }
            if (args?.latestConfig === undefined && !opts.urn) {
                throw new Error("Missing required property 'latestConfig'");
            }
            resourceInputs["compartmentId"] = args?.compartmentId;
            resourceInputs["definedTags"] = args?.definedTags;
            resourceInputs["displayName"] = args?.displayName;
            resourceInputs["freeformTags"] = args?.freeformTags;
            resourceInputs["latestConfig"] = args?.latestConfig;
        ...
        super(ManagedKafkaKafkaClusterConfig.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface ManagedKafkaKafkaClusterConfigState {
    /**
     * (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to create the KafkaClusterConfig in.
     */
     ...
     * (Updatable) A shared configuration object used by 0 or more kafka clusters.
     */
    latestConfig?: pulumi.Input<inputs.oci.ManagedKafkaKafkaClusterConfigLatestConfig | undefined>;
    /**
     * A message that describes the current state of the KafkaClusterConfig in more detail. For example, can be used to provide actionable information for a resource in the Failed state.
     */
 ...
 */
export interface ManagedKafkaKafkaClusterConfigArgs {
    /**
     * (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to create the KafkaClusterConfig in.
     */
     ...
     * (Updatable) A shared configuration object used by 0 or more kafka clusters.
     */
    latestConfig: pulumi.Input<inputs.oci.ManagedKafkaKafkaClusterConfigLatestConfig>;
}
