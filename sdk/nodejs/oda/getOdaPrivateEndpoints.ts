...
export function getOdaPrivateEndpoints(args: GetOdaPrivateEndpointsArgs, opts?: pulumi.InvokeOptions): Promise<GetOdaPrivateEndpointsResult> {
    ...
    return pulumi.runtime.invoke("oci:Oda/getOdaPrivateEndpoints:getOdaPrivateEndpoints", {
 ...
 */
export interface GetOdaPrivateEndpointsArgs {
    /**
     ...
     */
    displayName?: string;
    filters?: inputs.Oda.GetOdaPrivateEndpointsFilter[];
    /**
 ...
 */
export interface GetOdaPrivateEndpointsResult {
    /**
    ...
    readonly filters?: outputs.Oda.GetOdaPrivateEndpointsFilter[];
    /**
 ...
 * A collection of arguments for invoking getOdaPrivateEndpoints.
 */
export interface GetOdaPrivateEndpointsOutputArgs {
    /**
     * List the ODA Private Endpoints that belong to this compartment.
     */
    ...
    filters?: pulumi.Input<pulumi.Input<inputs.Oda.GetOdaPrivateEndpointsFilterArgs>[] | undefined>;
    /**
     * List only the ODA Private Endpoints that are in this lifecycle state.
     */
