 ...
 * ```
 */
export class ManagedInstanceGroupDetachManagedInstancesManagement extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedInstanceGroupDetachManagedInstancesManagementState, opts?: pulumi.CustomResourceOptions): ManagedInstanceGroupDetachManagedInstancesManagement {
        return new ManagedInstanceGroupDetachManagedInstancesManagement(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:OsManagementHub/managedInstanceGroupDetachManagedInstancesManagement:ManagedInstanceGroupDetachManagedInstancesManagement';
     ...
     */
    public static isInstance(obj: any): obj is ManagedInstanceGroupDetachManagedInstancesManagement {
    ...
    constructor(name: string, argsOrState?: ManagedInstanceGroupDetachManagedInstancesManagementArgs | ManagedInstanceGroupDetachManagedInstancesManagementState, opts?: pulumi.CustomResourceOptions) {
