 ...
 * ```
 */
export class ManagedInstanceGroupInstallPackagesManagement extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedInstanceGroupInstallPackagesManagementState, opts?: pulumi.CustomResourceOptions): ManagedInstanceGroupInstallPackagesManagement {
        return new ManagedInstanceGroupInstallPackagesManagement(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:OsManagementHub/managedInstanceGroupInstallPackagesManagement:ManagedInstanceGroupInstallPackagesManagement';
     ...
     */
    public static isInstance(obj: any): obj is ManagedInstanceGroupInstallPackagesManagement {
     ...
     */
    declare public readonly isLatest: pulumi.Output<boolean>;
    /**
     ...
     */
    declare public readonly workRequestDetails: pulumi.Output<outputs.OsManagementHub.ManagedInstanceGroupInstallPackagesManagementWorkRequestDetails>;
    ...
    constructor(name: string, argsOrState?: ManagedInstanceGroupInstallPackagesManagementArgs | ManagedInstanceGroupInstallPackagesManagementState, opts?: pulumi.CustomResourceOptions) {
        ...
        if (opts.id) {
            ...
            const args = argsOrState as ManagedInstanceGroupInstallPackagesManagementArgs | undefined;
