 ...
 * ```
 */
export class ManagedInstanceInstallPackagesManagement extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: ManagedInstanceInstallPackagesManagementState, opts?: pulumi.CustomResourceOptions): ManagedInstanceInstallPackagesManagement {
        return new ManagedInstanceInstallPackagesManagement(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:OsManagementHub/managedInstanceInstallPackagesManagement:ManagedInstanceInstallPackagesManagement';
     ...
     */
    public static isInstance(obj: any): obj is ManagedInstanceInstallPackagesManagement {
     ...
     */
    declare public readonly workRequestDetails: pulumi.Output<outputs.OsManagementHub.ManagedInstanceInstallPackagesManagementWorkRequestDetails>;
    ...
    constructor(name: string, argsOrState?: ManagedInstanceInstallPackagesManagementArgs | ManagedInstanceInstallPackagesManagementState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as ManagedInstanceInstallPackagesManagementState | undefined;
            ...
            const args = argsOrState as ManagedInstanceInstallPackagesManagementArgs | undefined;
...
export interface ManagedInstanceInstallPackagesManagementState {
     ...
     * Provides the name and description of the job.
     */
    workRequestDetails?: pulumi.Input<inputs.OsManagementHub.ManagedInstanceInstallPackagesManagementWorkRequestDetails | undefined>;
}
