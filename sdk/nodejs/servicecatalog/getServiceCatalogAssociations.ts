 ...
 * ```
 */
export function getServiceCatalogAssociationsOutput(args?: GetServiceCatalogAssociationsOutputArgs, opts?: pulumi.InvokeOutputOptions): pulumi.Output<GetServiceCatalogAssociationsResult> {
    args = args || {};
    opts = pulumi.mergeOptions(utilities.resourceOptsDefaults(), opts || {});
...
export interface GetServiceCatalogAssociationsOutputArgs {
    ...
    filters?: pulumi.Input<pulumi.Input<inputs.ServiceCatalog.GetServiceCatalogAssociationsFilterArgs>[] | undefined>;
    /**
     * The unique identifier for the service catalog association.
     */
    serviceCatalogAssociationId?: pulumi.Input<string | undefined>;
    /**
     * The unique identifier for the service catalog.
     */
