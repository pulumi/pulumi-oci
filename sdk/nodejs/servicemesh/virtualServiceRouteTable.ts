 ...
 * ```
 */
export class VirtualServiceRouteTable extends pulumi.CustomResource {
    /**
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: VirtualServiceRouteTableState, opts?: pulumi.CustomResourceOptions): VirtualServiceRouteTable {
        return new VirtualServiceRouteTable(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'oci:ServiceMesh/virtualServiceRouteTable:VirtualServiceRouteTable';

    /**
     * Returns true if the given object is an instance of VirtualServiceRouteTable.  This is designed to work even
     * when multiple copies of the Pulumi SDK have been loaded into the same process.
     */
    public static isInstance(obj: any): obj is VirtualServiceRouteTable {
        if (obj === undefined || obj === null) {
            return false;
        }
        return obj['__pulumiType'] === VirtualServiceRouteTable.__pulumiType;
    }
     ...
     */
    public readonly routeRules!: pulumi.Output<outputs.ServiceMesh.VirtualServiceRouteTableRouteRule[]>;
    /**
     ...
     */
    constructor(name: string, args: VirtualServiceRouteTableArgs, opts?: pulumi.CustomResourceOptions)
    constructor(name: string, argsOrState?: VirtualServiceRouteTableArgs | VirtualServiceRouteTableState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as VirtualServiceRouteTableState | undefined;
            ...
            const args = argsOrState as VirtualServiceRouteTableArgs | undefined;
        ...
        super(VirtualServiceRouteTable.__pulumiType, name, resourceInputs, opts);
    }
}
 ...
 */
export interface VirtualServiceRouteTableState {
    /**
     * (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
     */
 ...
 */
export interface VirtualServiceRouteTableArgs {
    /**
     * (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
     */
    compartmentId: pulumi.Input<string>;
