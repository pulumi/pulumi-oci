...
class RemediationRecipeDetectConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 max_permissible_cvss_v2score: Optional[pulumi.Input[builtins.float]] = None,
                 max_permissible_cvss_v3score: Optional[pulumi.Input[builtins.float]] = None,
                 max_permissible_severity: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def max_permissible_cvss_v2score(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def max_permissible_cvss_v3score(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def max_permissible_severity(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "max_permissible_severity", value)

    @property
    @pulumi.getter(name="upgradePolicy")
    def upgrade_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The upgrade policy for recommendations. The `Nearest` upgrade policy upgrades a dependency to the oldest version that meets both of the following criteria: it is newer than the current version and it is not affected by a vulnerability.
        """
    ...
    def upgrade_policy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RemediationRecipeNetworkConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] subnet_id: (Updatable) The Oracle Cloud Identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of the subnet.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] nsg_ids: (Updatable) The list of Oracle Cloud Identifiers ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) corresponding to Network Security Groups.
        """
...
if not MYPY:
    class RemediationRecipeScmConfigurationArgsDict(TypedDict):
        ...
        """
        is_automerge_enabled: pulumi.Input[builtins.bool]
        """
        ...
        """
        scm_type: pulumi.Input[builtins.str]
        """
        (Updatable) The type of Source Code Management.
        """
        build_file_location: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        external_scm_type: NotRequired[pulumi.Input[builtins.str]]
        """
        (Updatable) The type of External Source Code Management.
        """
        oci_code_repository_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        pat_secret_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RemediationRecipeScmConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 is_automerge_enabled: pulumi.Input[builtins.bool],
                 scm_type: pulumi.Input[builtins.str],
                 build_file_location: Optional[pulumi.Input[builtins.str]] = None,
                 external_scm_type: Optional[pulumi.Input[builtins.str]] = None,
                 oci_code_repository_id: Optional[pulumi.Input[builtins.str]] = None,
                 pat_secret_id: Optional[pulumi.Input[builtins.str]] = None,
                 repository_url: Optional[pulumi.Input[builtins.str]] = None,
                 username: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] branch: (Updatable) The branch used by ADM to patch vulnerabilities.
        :param pulumi.Input[builtins.bool] is_automerge_enabled: (Updatable) If true, the Pull Request (PR) will be merged after the verify stage completes successfully     If false, the PR with the proposed changes must be reviewed and manually merged.
        :param pulumi.Input[builtins.str] scm_type: (Updatable) The type of Source Code Management.
        :param pulumi.Input[builtins.str] build_file_location: (Updatable) The location of the build file relative to the root of the repository. Only Maven build files (POM) are currently supported. If this property is not specified, ADM will use the build file located at the root of the repository.
        :param pulumi.Input[builtins.str] external_scm_type: (Updatable) The type of External Source Code Management.
        :param pulumi.Input[builtins.str] oci_code_repository_id: (Updatable) The Oracle Cloud Identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of the Oracle Cloud Infrastructure DevOps repository.
        :param pulumi.Input[builtins.str] pat_secret_id: (Updatable) The Oracle Cloud Identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of the Private Access Token (PAT) Secret. The secret provides the credentials necessary to authenticate against the SCM.
        :param pulumi.Input[builtins.str] repository_url: (Updatable) The repository URL for the SCM. For Non-Enterprise GitHub the expected format is https://github.com/[owner]/[repoName] For Enterprise GitHub the expected format is http(s)://[hostname]/api/v3/repos/[owner]/[repoName] For GitLab the expected format is https://gitlab.com/[groupName]/[repoName]
        :param pulumi.Input[builtins.str] username: (Updatable) The username for the SCM (to perform operations such as cloning or pushing via HTTP).
        """
    ...
    def is_automerge_enabled(self) -> pulumi.Input[builtins.bool]:
        """
        (Updatable) If true, the Pull Request (PR) will be merged after the verify stage completes successfully     If false, the PR with the proposed changes must be reviewed and manually merged.
        """
    ...
    def is_automerge_enabled(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "is_automerge_enabled", value)

    @property
    @pulumi.getter(name="scmType")
    def scm_type(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The type of Source Code Management.
        """
    ...
    @scm_type.setter
    def scm_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "scm_type", value)

    @property
    @pulumi.getter(name="buildFileLocation")
    def build_file_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The location of the build file relative to the root of the repository. Only Maven build files (POM) are currently supported. If this property is not specified, ADM will use the build file located at the root of the repository.
        """
    ...
    def build_file_location(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "build_file_location", value)

    @property
    @pulumi.getter(name="externalScmType")
    def external_scm_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The type of External Source Code Management.
        """
    ...
    def external_scm_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "external_scm_type", value)

    @property
    @pulumi.getter(name="ociCodeRepositoryId")
    def oci_code_repository_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The Oracle Cloud Identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of the Oracle Cloud Infrastructure DevOps repository.
        """
    ...
    def oci_code_repository_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "oci_code_repository_id", value)

    @property
    @pulumi.getter(name="patSecretId")
    def pat_secret_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The Oracle Cloud Identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of the Private Access Token (PAT) Secret. The secret provides the credentials necessary to authenticate against the SCM.
        """
    ...
    def pat_secret_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class RemediationRecipeVerifyConfigurationArgsDict(TypedDict):
        build_service_type: pulumi.Input[builtins.str]
        """
        (Updatable) The type of Build Service.
        """
        additional_parameters: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        (Updatable) Additional key-value pairs passed as parameters to the build service when running an experiment.
        """
        jenkins_url: NotRequired[pulumi.Input[builtins.str]]
        """
        (Updatable) The URL that locates the Jenkins pipeline.
        """
        job_name: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        trigger_secret_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RemediationRecipeVerifyConfigurationArgs:
    def __init__(__self__, *,
                 build_service_type: pulumi.Input[builtins.str],
                 additional_parameters: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 ...
                 repository_url: Optional[pulumi.Input[builtins.str]] = None,
                 trigger_secret_id: Optional[pulumi.Input[builtins.str]] = None,
                 username: Optional[pulumi.Input[builtins.str]] = None,
                 workflow_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] build_service_type: (Updatable) The type of Build Service.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] additional_parameters: (Updatable) Additional key-value pairs passed as parameters to the build service when running an experiment.
        :param pulumi.Input[builtins.str] jenkins_url: (Updatable) The URL that locates the Jenkins pipeline.
        :param pulumi.Input[builtins.str] job_name: (Updatable) The name of the Jenkins pipeline job that identifies the build pipeline.
        :param pulumi.Input[builtins.str] pat_secret_id: (Updatable) The Oracle Cloud Identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of the Private Access Token (PAT) Secret. The PAT provides the credentials to access the Jenkins Pipeline.
        :param pulumi.Input[builtins.str] pipeline_id: (Updatable) The Oracle Cloud Identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of the user's DevOps Build Pipeline.
        :param pulumi.Input[builtins.str] repository_url: (Updatable) The location of the repository where the GitHub Actions is defined. For Non-Enterprise GitHub the expected format is https://github.com/[owner]/[repoName] For Enterprise GitHub the expected format is http(s)://[hostname]/api/v3/repos/[owner]/[repoName]
        :param pulumi.Input[builtins.str] trigger_secret_id: (Updatable) The Oracle Cloud Identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of the trigger Secret. The Secret provides access to the trigger for a GitLab pipeline.
        :param pulumi.Input[builtins.str] username: (Updatable) The username that will be used to authenticate with Jenkins.
        :param pulumi.Input[builtins.str] workflow_name: (Updatable) The name of the GitHub Actions workflow that defines the build pipeline.
        """
    ...
    def build_service_type(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The type of Build Service.
        """
    ...
    def build_service_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "build_service_type", value)

    @property
    @pulumi.getter(name="additionalParameters")
    def additional_parameters(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        (Updatable) Additional key-value pairs passed as parameters to the build service when running an experiment.
        """
    ...
    def additional_parameters(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def trigger_secret_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The Oracle Cloud Identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of the trigger Secret. The Secret provides access to the trigger for a GitLab pipeline.
        """
    ...
    def trigger_secret_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class RemediationRunStageArgsDict(TypedDict):
        ...
        """
        time_finished: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RemediationRunStageArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] summary: Information about the current step within the given stage.
        :param pulumi.Input[builtins.str] time_created: The creation date and time of the remediation run (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)).
        :param pulumi.Input[builtins.str] time_finished: The date and time of the finish of the remediation run (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)).
        :param pulumi.Input[builtins.str] time_started: The date and time of the start of the remediation run (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)).
        :param pulumi.Input[builtins.str] type: The type of stage.
        """
...
if not MYPY:
    class VulnerabilityAuditApplicationDependencyArgsDict(TypedDict):
        ...
        """
        application_dependency_node_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        List of application dependencies on which this application dependency depends, each identified by its nodeId.
        """
        gav: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VulnerabilityAuditApplicationDependencyArgs:
    def __init__(__self__, *,
                 node_id: pulumi.Input[builtins.str],
                 application_dependency_node_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 gav: Optional[pulumi.Input[builtins.str]] = None,
                 purl: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def application_dependency_node_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List of application dependencies on which this application dependency depends, each identified by its nodeId.
        """
    ...
    def application_dependency_node_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "application_dependency_node_ids", value)

    @property
    @pulumi.getter
    def gav(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Group Artifact Version (GAV) identifier (Group:Artifact:Version). Example: org.graalvm.nativeimage:svm:21.1.0. "N/A" for non-maven artifacts.
        """
    ...
    @gav.setter
    def gav(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @purl.setter
    def purl(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VulnerabilityAuditConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 max_permissible_severity: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclusions: A vulnerable application dependency is ignored if its name matches any of the items in `exclusions`. An asterisk (*) in the dependency pattern acts as a wildcard and matches zero or more characters.
        :param pulumi.Input[builtins.float] max_permissible_cvss_v2score: A vulnerable application dependency is ignored if the score of its associated Vulnerability is below maxPermissibleCvssV2Score and below maxPermissibleCvssV3Score.
        :param pulumi.Input[builtins.float] max_permissible_cvss_v3score: A vulnerable application dependency is ignored if the score of its associated Vulnerability is below maxPermissibleCvssV2Score and below maxPermissibleCvssV3Score.
        :param pulumi.Input[builtins.str] max_permissible_severity: A vulnerable application dependency is ignored if the score of its associated Vulnerability is below maxPermissibleSeverity.
        """
        if exclusions is not None:
            pulumi.set(__self__, "exclusions", exclusions)
        if max_permissible_cvss_v2score is not None:
...
if not MYPY:
    class VulnerabilityAuditSourceArgsDict(TypedDict):
        ...
        """
        oci_resource_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VulnerabilityAuditSourceArgs:
    def __init__(__self__, *,
                 ...
                 oci_resource_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: Source type of the vulnerability audit.
        :param pulumi.Input[builtins.str] description: Description of the external resource source.
        :param pulumi.Input[builtins.str] oci_resource_id: The Oracle Cloud identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of the Oracle Cloud Infrastructure resource that triggered the vulnerability audit.
        """
        pulumi.set(__self__, "type", type)
    ...
    def oci_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Oracle Cloud identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of the Oracle Cloud Infrastructure resource that triggered the vulnerability audit.
        """
    ...
    def oci_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VulnerabilityAuditUsageDataArgs:
    def __init__(__self__, *,
                 ...
                 source_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] bucket: The Object Storage bucket to read the usage data from.
        :param pulumi.Input[builtins.str] namespace: The Object Storage namespace to read the usage data from.
        :param pulumi.Input[builtins.str] object: The Object Storage object name to read the usage data from.
        :param pulumi.Input[builtins.str] source_type: The destination type. Use `objectStorageTuple` when specifying the namespace, bucket name, and object name. 
...
if not MYPY:
    class VulnerabilityAuditVulnerabilityArgsDict(TypedDict):
        ...
        """
        is_false_positive: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        is_ignored: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class VulnerabilityAuditVulnerabilityArgs:
    def __init__(__self__, *,
                 cvss_v2score: Optional[pulumi.Input[builtins.float]] = None,
                 cvss_v3score: Optional[pulumi.Input[builtins.float]] = None,
                 id: Optional[pulumi.Input[builtins.str]] = None,
                 is_false_positive: Optional[pulumi.Input[builtins.bool]] = None,
                 is_ignored: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] severity: ADM qualitative severity score. Can be either NONE, LOW, MEDIUM, HIGH or CRITICAL.
        :param pulumi.Input[builtins.str] source: vulnerability audit source.
        """
    ...
    @cvss_v2score.setter
    def cvss_v2score(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    @cvss_v3score.setter
    def cvss_v3score(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def is_false_positive(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates if the vulnerability is a false positive according to the usage data. If no usage data was provided or the service cannot infer usage of the vulnerable code then this property is `null`.
        """
    ...
    def is_false_positive(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_false_positive", value)

    @property
    @pulumi.getter(name="isIgnored")
    def is_ignored(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates if the vulnerability was ignored according to the audit configuration.
        """
    ...
    @is_ignored.setter
    def is_ignored(self, value: Optional[pulumi.Input[builtins.bool]]):
