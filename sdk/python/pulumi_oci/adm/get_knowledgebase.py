...
class GetKnowledgebaseResult:
    ...
    """
    def __init__(__self__, compartment_id=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, knowledge_base_id=None, state=None, system_tags=None, time_created=None, time_updated=None):
...
def get_knowledgebase(knowledge_base_id: Optional[builtins.str] = None,
    ...
    :param builtins.str knowledge_base_id: The Oracle Cloud Identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of a Knowledge Base, as a URL path parameter.
    """
    __args__ = dict()
    __args__['knowledgeBaseId'] = knowledge_base_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:Adm/getKnowledgebase:getKnowledgebase', __args__, opts=opts, typ=GetKnowledgebaseResult).value
...
def get_knowledgebase_output(knowledge_base_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Adm/getKnowledgebase:getKnowledgebase', __args__, opts=opts, typ=GetKnowledgebaseResult)
