...
def get_knowledgebase(knowledge_base_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str knowledge_base_id: The Oracle Cloud Identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of a Knowledge Base, as a URL path parameter.
    """
    __args__ = dict()
