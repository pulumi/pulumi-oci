...
def get_knowledgebases(compartment_id: Optional[builtins.str] = None,
...
def get_knowledgebases_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
