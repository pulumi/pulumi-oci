...
def get_knowledgebases(compartment_id: Optional[str] = None,
                       ...
                       filters: Optional[Sequence[pulumi.InputType['GetKnowledgebasesFilterArgs']]] = None,
    ...
    return AwaitableGetKnowledgebasesResult(
        ...
        id=__ret__.id,
        knowledge_base_collections=__ret__.knowledge_base_collections,
        state=__ret__.state)


@_utilities.lift_output_func(get_knowledgebases)
def get_knowledgebases_output(compartment_id: Optional[pulumi.Input[Optional[str]]] = None,
                              display_name: Optional[pulumi.Input[Optional[str]]] = None,
                              filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetKnowledgebasesFilterArgs']]]]] = None,
