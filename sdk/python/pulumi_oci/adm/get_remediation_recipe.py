...
def get_remediation_recipe(remediation_recipe_id: Optional[builtins.str] = None,
    ...
    :param builtins.str remediation_recipe_id: The Oracle Cloud Identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of a Remediation Recipe, as a URL path parameter.
    """
    __args__ = dict()
...
def get_remediation_recipe_output(remediation_recipe_id: Optional[pulumi.Input[builtins.str]] = None,
