...
def get_remediation_recipes(compartment_id: Optional[builtins.str] = None,
...
def get_remediation_recipes_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
