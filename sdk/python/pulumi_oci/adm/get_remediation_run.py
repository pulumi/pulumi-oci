...
def get_remediation_run(remediation_run_id: Optional[builtins.str] = None,
...
def get_remediation_run_output(remediation_run_id: Optional[pulumi.Input[builtins.str]] = None,
