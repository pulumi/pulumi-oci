...
def get_remediation_run_stage(remediation_run_id: Optional[builtins.str] = None,
                              stage_type: Optional[builtins.str] = None,
    ...
    :param builtins.str stage_type: The type of Remediation Run Stage, as a URL path parameter.
    """
    __args__ = dict()
...
def get_remediation_run_stage_output(remediation_run_id: Optional[pulumi.Input[builtins.str]] = None,
                                     stage_type: Optional[pulumi.Input[builtins.str]] = None,
