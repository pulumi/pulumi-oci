...
class RemediationRecipeDetectConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.float max_permissible_cvss_v2score: (Updatable) The maximum Common Vulnerability Scoring System Version 2 (CVSS V2) score. A vulnerability with a CVSS V2 score below this value is not considered for remediation.
        :param builtins.float max_permissible_cvss_v3score: (Updatable) The maximum Common Vulnerability Scoring System Version 3 (CVSS V3) score. A vulnerability with a CVSS V3 score below this value is not considered for patching.
        :param builtins.str max_permissible_severity: (Updatable) The maximum ADM Severity. A vulnerability with an severity below this value is not considered for remediation.
...
class VulnerabilityAuditApplicationDependency(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str purl: Package URL identifier, e.g. pkg:maven/org.graalvm.nativeimage/svm@21.1.0
        """
...
class VulnerabilityAuditVulnerability(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.float cvss_v2score: Common Vulnerability Scoring System (CVSS) Version 2, calculated from the metrics provided in the CVSS vector provided from the vulnerability source. This field is deprecated and will be removed in the future. The cvssV2Score can be obtained from the metrics field of the listVulnerabilities endpoint.
        :param builtins.float cvss_v3score: Common Vulnerability Scoring System (CVSS) Version 3, calculated from the metrics provided in the CVSS vector provided from the vulnerability source. This field is deprecated and will be removed in the future. The cvssV3Score can be obtained from the metrics field of the listVulnerabilities endpoint.
...
class GetRemediationRecipeDetectConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.float max_permissible_cvss_v2score: The maximum Common Vulnerability Scoring System Version 2 (CVSS V2) score. A vulnerability with a CVSS V2 score below this value is not considered for remediation.
        :param builtins.float max_permissible_cvss_v3score: The maximum Common Vulnerability Scoring System Version 3 (CVSS V3) score. A vulnerability with a CVSS V3 score below this value is not considered for patching.
        :param builtins.str max_permissible_severity: The maximum ADM Severity. A vulnerability with an severity below this value is not considered for remediation.
...
class GetVulnerabilityAuditApplicationDependencyVulnerabilitiesApplicationDependencyVulnerabilityCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] application_dependency_node_ids: List of application dependencies on which this application dependency depends, each identified by its nodeId.
        :param builtins.str gav: A filter to return only resources that match the entire GAV (Group Artifact Version) identifier given.
        :param builtins.bool is_found_in_knowledge_base: Indicates if the artifact is found in the knowledge base, this field is deprecated and will be removed in the future.
        ...
        :param Sequence[builtins.str] warnings: Potential issues in the artifact identifiers (purls) provided by the user, that the user is alerted about. ADM supports the following warnings:
