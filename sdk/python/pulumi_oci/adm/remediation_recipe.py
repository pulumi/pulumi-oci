...
class RemediationRecipeArgs:
    def __init__(__self__, *,
                 ...
                 is_run_triggered_on_kb_change: pulumi.Input[builtins.bool],
    ...
    def is_run_triggered_on_kb_change(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def is_run_triggered_on_kb_change(self, value: pulumi.Input[builtins.bool]):
...
class _RemediationRecipeState:
    def __init__(__self__, *,
                 ...
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_run_triggered_on_kb_change: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] time_created: The creation date and time of the Remediation Recipe (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)).
        :param pulumi.Input[builtins.str] time_updated: The date and time the Remediation Recipe was last updated (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)).
        :param pulumi.Input['RemediationRecipeVerifyConfigurationArgs'] verify_configuration: (Updatable) The Verify stage configuration specifies a build service to run a pipeline for the recommended code changes. The build pipeline will be initiated to ensure that there is no breaking change after the dependency versions have been updated in source to avoid vulnerabilities.
        """
    ...
    @property
    @pulumi.getter(name="isRunTriggeredOnKbChange")
    def is_run_triggered_on_kb_change(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) Boolean indicating if a run should be automatically triggered once the knowledge base is updated.
        """
        return pulumi.get(self, "is_run_triggered_on_kb_change")
    ...
    @is_run_triggered_on_kb_change.setter
    def is_run_triggered_on_kb_change(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_run_triggered_on_kb_change", value)
...
class RemediationRecipe(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="isRunTriggeredOnKbChange")
    def is_run_triggered_on_kb_change(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Boolean indicating if a run should be automatically triggered once the knowledge base is updated.
        """
        return pulumi.get(self, "is_run_triggered_on_kb_change")
