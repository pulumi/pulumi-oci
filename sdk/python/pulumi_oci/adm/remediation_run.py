...
class RemediationRunArgs:
    def __init__(__self__, *,
                 remediation_recipe_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] remediation_recipe_id: The Oracle Cloud identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of the Remediation Recipe.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The compartment Oracle Cloud Identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of the remediation run.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The name of the remediation run.
    ...
    def remediation_recipe_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def remediation_recipe_id(self, value: pulumi.Input[builtins.str]):
...
class _RemediationRunState:
    def __init__(__self__, *,
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 current_stage_type: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 remediation_recipe_id: Optional[pulumi.Input[builtins.str]] = None,
                 remediation_run_source: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The compartment Oracle Cloud Identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of the remediation run.
        :param pulumi.Input[builtins.str] current_stage_type: The type of the current stage of the remediation run.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] display_name: (Updatable) The name of the remediation run.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.str] remediation_recipe_id: The Oracle Cloud identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of the Remediation Recipe.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] remediation_run_source: The source that triggered the Remediation Recipe.
        :param pulumi.Input[Sequence[pulumi.Input['RemediationRunStageArgs']]] stages: The list of remediation run stage summaries.
        :param pulumi.Input[builtins.str] state: The current lifecycle state of the remediation run.
        ...
        :param pulumi.Input[builtins.str] time_updated: The date and time the remediation run was last updated (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)).
        """
        if compartment_id is not None:
            pulumi.set(__self__, "compartment_id", compartment_id)
    ...
    def current_stage_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def current_stage_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="remediationRecipeId")
    def remediation_recipe_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Oracle Cloud identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of the Remediation Recipe.
    ...
    @remediation_recipe_id.setter
    def remediation_recipe_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "remediation_recipe_id", value)

    @property
    @pulumi.getter(name="remediationRunSource")
    def remediation_run_source(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def remediation_run_source(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RemediationRun(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_finished: Optional[pulumi.Input[builtins.str]] = None,
            time_started: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'RemediationRun':
        """
    ...
    @property
    @pulumi.getter(name="currentStageType")
    def current_stage_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the current stage of the remediation run.
        """
        return pulumi.get(self, "current_stage_type")
    ...
    @property
    @pulumi.getter(name="remediationRecipeId")
    def remediation_recipe_id(self) -> pulumi.Output[builtins.str]:
        """
        The Oracle Cloud identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of the Remediation Recipe.
    ...
    @property
    @pulumi.getter(name="remediationRunSource")
    def remediation_run_source(self) -> pulumi.Output[builtins.str]:
        """
        The source that triggered the Remediation Recipe.
        """
        return pulumi.get(self, "remediation_run_source")
