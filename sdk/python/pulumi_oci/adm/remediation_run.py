...
class _RemediationRunState:
    def __init__(__self__, *,
                 compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                 current_stage_type: pulumi.Input[Optional[_builtins.str]] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 ...
                 stages: pulumi.Input[Optional[Sequence[pulumi.Input['RemediationRunStageArgs']]]] = None,
    ...
    def current_stage_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def current_stage_type(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    @_builtins.property
    @pulumi.getter(name="remediationRecipeId")
    def remediation_recipe_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The Oracle Cloud identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of the Remediation Recipe.
    ...
    @remediation_recipe_id.setter
    def remediation_recipe_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "remediation_recipe_id", value)

    @_builtins.property
    @pulumi.getter(name="remediationRunSource")
    def remediation_run_source(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def remediation_run_source(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "remediation_run_source", value)

    @_builtins.property
    @pulumi.getter
    def stages(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['RemediationRunStageArgs']]]]:
        """
    ...
    @stages.setter
    def stages(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['RemediationRunStageArgs']]]]):
...
class RemediationRun(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_finished: pulumi.Input[Optional[_builtins.str]] = None,
            time_started: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None) -> 'RemediationRun':
        """
