...
class DataAssetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] compartment_id: (Updatable) The OCID for the data asset's compartment.
        ...
        :param pulumi.Input[_builtins.str] description: (Updatable) A short description of the Ai data asset
...
class _DataAssetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] project_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the project to associate with the data asset.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] state: The lifecycle state of the Data Asset.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param pulumi.Input[_builtins.str] time_created: The time the the DataAsset was created. An RFC3339 formatted datetime string
        :param pulumi.Input[_builtins.str] time_updated: The time the the DataAsset was updated. An RFC3339 formatted datetime string
        """
...
class DataAsset(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_data_asset = oci.aianomalydetection.DataAsset("test_data_asset",
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[_builtins.str]] = None,
            time_updated: Optional[pulumi.Input[_builtins.str]] = None) -> 'DataAsset':
        """
