...
class DataAssetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID for the data asset's compartment.
        :param pulumi.Input['DataAssetDataSourceDetailsArgs'] data_source_details: Possible data sources
        :param pulumi.Input[builtins.str] project_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the project to associate with the data asset.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) A short description of the Ai data asset
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly display name for the resource. It does not have to be unique and can be modified. Avoid entering confidential information.
        ...
        :param pulumi.Input[builtins.str] private_endpoint_id: OCID of Private Endpoint.
        """
...
class _DataAssetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] project_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the project to associate with the data asset.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The lifecycle state of the Data Asset.
        ...
        :param pulumi.Input[builtins.str] time_created: The time the the DataAsset was created. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.str] time_updated: The time the the DataAsset was updated. An RFC3339 formatted datetime string
        """
...
class DataAsset(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'DataAsset':
        """
