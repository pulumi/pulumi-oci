...
class DataAsset(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_data_asset = oci.ai_anomaly_detection.DataAsset("testDataAsset",
            ...
            data_source_details=oci.ai.anomaly.detection.DataAssetDataSourceDetailsArgs(
                ...
                version_specific_details=oci.ai.anomaly.detection.DataAssetDataSourceDetailsVersionSpecificDetailsArgs(
