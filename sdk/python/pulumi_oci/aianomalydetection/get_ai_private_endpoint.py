...
class GetAiPrivateEndpointResult:
    ...
    def ai_private_endpoint_id(self) -> builtins.str:
...
def get_ai_private_endpoint(ai_private_endpoint_id: Optional[builtins.str] = None,
    ...
    :param builtins.str ai_private_endpoint_id: Unique private reverse connection identifier.
    """
    __args__ = dict()
...
def get_ai_private_endpoint_output(ai_private_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
