...
class GetDetectAnomalyJobResult:
    ...
    def detect_anomaly_job_id(self) -> builtins.str:
...
def get_detect_anomaly_job(detect_anomaly_job_id: Optional[builtins.str] = None,
    ...
    :param builtins.str detect_anomaly_job_id: Unique asynchronous job identifier.
    """
    __args__ = dict()
...
def get_detect_anomaly_job_output(detect_anomaly_job_id: Optional[pulumi.Input[builtins.str]] = None,
