...
class GetDetectAnomalyJobsResult:
    ...
    def detect_anomaly_job_id(self) -> Optional[builtins.str]:
...
def get_detect_anomaly_jobs(compartment_id: Optional[builtins.str] = None,
                            detect_anomaly_job_id: Optional[builtins.str] = None,
    ...
    :param builtins.str detect_anomaly_job_id: Unique Async Job identifier
...
def get_detect_anomaly_jobs_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                   detect_anomaly_job_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
