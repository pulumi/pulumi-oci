...
class GetDetectionDataAssetResult:
    ...
    def data_asset_id(self) -> builtins.str:
...
def get_detection_data_asset(data_asset_id: Optional[builtins.str] = None,
    ...
    :param builtins.str data_asset_id: The OCID of the Data Asset.
    """
    __args__ = dict()
...
def get_detection_data_asset_output(data_asset_id: Optional[pulumi.Input[builtins.str]] = None,
