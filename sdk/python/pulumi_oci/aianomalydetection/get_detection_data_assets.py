...
def get_detection_data_assets(compartment_id: Optional[builtins.str] = None,
...
def get_detection_data_assets_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
