...
def get_detection_model(model_id: Optional[builtins.str] = None,
    ...
    :param builtins.str model_id: The OCID of the Model.
    """
    __args__ = dict()
...
def get_detection_model_output(model_id: Optional[pulumi.Input[builtins.str]] = None,
