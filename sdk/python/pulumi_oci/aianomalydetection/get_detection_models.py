...
def get_detection_models(compartment_id: Optional[builtins.str] = None,
...
def get_detection_models_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
