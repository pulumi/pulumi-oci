...
def get_detection_project(project_id: Optional[builtins.str] = None,
    ...
    :param builtins.str project_id: The OCID of the Project.
    """
    __args__ = dict()
...
def get_detection_project_output(project_id: Optional[pulumi.Input[builtins.str]] = None,
