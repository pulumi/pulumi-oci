...
def get_detection_projects(compartment_id: Optional[builtins.str] = None,
...
def get_detection_projects_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
