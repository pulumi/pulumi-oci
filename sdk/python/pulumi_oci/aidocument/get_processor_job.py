...
class GetProcessorJobResult:
    ...
    def processor_job_id(self) -> _builtins.str:
...
def get_processor_job(processor_job_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str processor_job_id: Processor job id.
    """
    __args__ = dict()
