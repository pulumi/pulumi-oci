...
def get_project(project_id: Optional[builtins.str] = None,
    ...
    :param builtins.str project_id: A unique project identifier.
    """
    __args__ = dict()
    __args__['projectId'] = project_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:AiDocument/getProject:getProject', __args__, opts=opts, typ=GetProjectResult).value
...
def get_project_output(project_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:AiDocument/getProject:getProject', __args__, opts=opts, typ=GetProjectResult)
