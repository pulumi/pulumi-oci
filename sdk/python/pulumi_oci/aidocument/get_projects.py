...
def get_projects(compartment_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('oci:AiDocument/getProjects:getProjects', __args__, opts=opts, typ=GetProjectsResult).value
...
def get_projects_output(compartment_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:AiDocument/getProjects:getProjects', __args__, opts=opts, typ=GetProjectsResult)
