...
class ModelArgs:
    def __init__(__self__, *,
                 ...
                 max_training_time_in_hours: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input[builtins.str] project_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the project that contains the model.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) An optional description of the model.
        :param pulumi.Input[builtins.str] display_name: (Updatable) A human-friendly name for the model, which can be changed.
        ...
        :param pulumi.Input[builtins.bool] is_quick_mode: Set to true when experimenting with a new model type or dataset, so the model training is quick, with a predefined low number of passes through the training data.
        :param pulumi.Input[builtins.float] max_training_time_in_hours: The maximum model training time in hours, expressed as a decimal fraction.
        :param pulumi.Input[builtins.str] model_version: The model version
    ...
    def max_training_time_in_hours(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def max_training_time_in_hours(self, value: Optional[pulumi.Input[builtins.float]]):
...
class _ModelState:
    def __init__(__self__, *,
                 ...
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_composed_model: Optional[pulumi.Input[builtins.bool]] = None,
                 is_quick_mode: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 trained_time_in_hours: Optional[pulumi.Input[builtins.float]] = None,
                 training_dataset: Optional[pulumi.Input['ModelTrainingDatasetArgs']] = None,
                 validation_dataset: Optional[pulumi.Input['ModelValidationDatasetArgs']] = None):
        """
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) A human-friendly name for the model, which can be changed.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) A simple key-value pair that is applied without any predefined name, type, or scope. It exists for cross-compatibility only. For example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.bool] is_composed_model: Set to true when the model is created by using multiple key value extraction models.
        :param pulumi.Input[builtins.bool] is_quick_mode: Set to true when experimenting with a new model type or dataset, so the model training is quick, with a predefined low number of passes through the training data.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] labels: The collection of labels used to train the custom model.
        :param pulumi.Input[builtins.str] lifecycle_details: A message describing the current state in more detail, that can provide actionable information if training failed.
        :param pulumi.Input[builtins.float] max_training_time_in_hours: The maximum model training time in hours, expressed as a decimal fraction.
        ...
        :param pulumi.Input[builtins.str] tenancy_id: The tenancy id of the model.
        :param pulumi.Input['ModelTestingDatasetArgs'] testing_dataset: The base entity which is the input for creating and training a model.
        :param pulumi.Input[builtins.str] time_created: When the model was created, as an RFC3339 datetime string.
        :param pulumi.Input[builtins.str] time_updated: When the model was updated, as an RFC3339 datetime string.
        :param pulumi.Input[builtins.float] trained_time_in_hours: The total hours actually used for model training.
        :param pulumi.Input['ModelTrainingDatasetArgs'] training_dataset: The base entity which is the input for creating and training a model.
        :param pulumi.Input['ModelValidationDatasetArgs'] validation_dataset: The base entity which is the input for creating and training a model.
        """
    ...
    def is_composed_model(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_composed_model(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def trained_time_in_hours(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def trained_time_in_hours(self, value: Optional[pulumi.Input[builtins.float]]):
...
class Model(pulumi.CustomResource):
    ...
    pulumi_type = "oci:AiDocument/model:Model"
    ...
    @property
    @pulumi.getter(name="isComposedModel")
    def is_composed_model(self) -> pulumi.Output[builtins.bool]:
        """
        Set to true when the model is created by using multiple key value extraction models.
        """
        return pulumi.get(self, "is_composed_model")
    ...
    @property
    @pulumi.getter(name="maxTrainingTimeInHours")
    def max_training_time_in_hours(self) -> pulumi.Output[builtins.float]:
        """
        The maximum model training time in hours, expressed as a decimal fraction.
        """
        return pulumi.get(self, "max_training_time_in_hours")
    ...
    @property
    @pulumi.getter(name="modelId")
    def model_id(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "model_id")
    ...
    @property
    @pulumi.getter(name="trainedTimeInHours")
    def trained_time_in_hours(self) -> pulumi.Output[builtins.float]:
        """
        The total hours actually used for model training.
        """
        return pulumi.get(self, "trained_time_in_hours")
