...
class ProcessorJobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: The compartment identifier.
        ...
        :param pulumi.Input[builtins.str] display_name: The display name of the processor job.
        """
...
class _ProcessorJobState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: The display name of the processor job.
        :param pulumi.Input['ProcessorJobInputLocationArgs'] input_location: The location of the inputs.
        :param pulumi.Input[builtins.str] lifecycle_details: The detailed status of FAILED state.
        :param pulumi.Input['ProcessorJobOutputLocationArgs'] output_location: The object storage location where to store analysis results.
        :param pulumi.Input[builtins.float] percent_complete: How much progress the operation has made, compared to the total amount of work to be performed.
        :param pulumi.Input['ProcessorJobProcessorConfigArgs'] processor_config: The configuration of a processor.
        :param pulumi.Input[builtins.str] state: The current state of the processor job.
        :param pulumi.Input[builtins.str] time_accepted: The job acceptance time.
        :param pulumi.Input[builtins.str] time_finished: The job finish time.
        :param pulumi.Input[builtins.str] time_started: The job start time.
        """
...
class ProcessorJob(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_accepted: Optional[pulumi.Input[builtins.str]] = None,
            time_finished: Optional[pulumi.Input[builtins.str]] = None,
            time_started: Optional[pulumi.Input[builtins.str]] = None) -> 'ProcessorJob':
        """
    ...
    @property
    @pulumi.getter(name="percentComplete")
    def percent_complete(self) -> pulumi.Output[builtins.float]:
        """
        How much progress the operation has made, compared to the total amount of work to be performed.
        """
        return pulumi.get(self, "percent_complete")
