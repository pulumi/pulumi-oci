...
class ModelEvaluationResultArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] labels: labels
...
class ModelEvaluationResultClassMetricArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] precision: Precision refers to the number of true positives divided by the total number of positive predictions (i.e., the number of true positives plus the number of false positives)
        :param pulumi.Input[_builtins.float] recall: Measures the model's ability to predict actual positive classes. It is the ratio between the predicted true positives and what was actually tagged. The recall metric reveals how many of the predicted classes are correct.
        :param pulumi.Input[_builtins.float] support: number of samples in the test set
        """
        if f1 is not None:
...
class ModelEvaluationResultMetricArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] macro_precision: Precision refers to the number of true positives divided by the total number of positive predictions (i.e., the number of true positives plus the number of false positives)
        :param pulumi.Input[_builtins.float] macro_recall: Measures the model's ability to predict actual positive classes. It is the ratio between the predicted true positives and what was actually tagged. The recall metric reveals how many of the predicted classes are correct.
        :param pulumi.Input[_builtins.float] micro_f1: F1-score, is a measure of a model’s accuracy on a dataset
        :param pulumi.Input[_builtins.float] micro_precision: Precision refers to the number of true positives divided by the total number of positive predictions (i.e., the number of true positives plus the number of false positives)
        :param pulumi.Input[_builtins.float] micro_recall: Measures the model's ability to predict actual positive classes. It is the ratio between the predicted true positives and what was actually tagged. The recall metric reveals how many of the predicted classes are correct.
        :param pulumi.Input[_builtins.float] weighted_f1: F1-score, is a measure of a model’s accuracy on a dataset
        :param pulumi.Input[_builtins.float] weighted_precision: Precision refers to the number of true positives divided by the total number of positive predictions (i.e., the number of true positives plus the number of false positives)
        :param pulumi.Input[_builtins.float] weighted_recall: Measures the model's ability to predict actual positive classes. It is the ratio between the predicted true positives and what was actually tagged. The recall metric reveals how many of the predicted classes are correct.
        """
...
class ModelModelDetailsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] language_code: supported language default value is en
        :param pulumi.Input[_builtins.str] version: Optional pre trained model version. if nothing specified latest pre trained model will be used.  Supported versions can be found at /modelTypes/{modelType}
        """
        pulumi.set(__self__, "model_type", model_type)
...
class ModelModelDetailsClassificationModeArgs:
    ...
    @_builtins.property
    @pulumi.getter(name="classificationMode")
    def classification_mode(self) -> pulumi.Input[_builtins.str]:
        """
        classification Modes
        """
        return pulumi.get(self, "classification_mode")
    ...
    @classification_mode.setter
    def classification_mode(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "classification_mode", value)
...
class ModelTestStrategyTestingDatasetLocationDetailsArgs:
    ...
    @object_names.setter
    def object_names(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
