...
class EndpointArgs:
    def __init__(__self__, *,
                 ...
                 inference_units: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Endpoint resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) compartment identifier for the endpoint
        :param pulumi.Input[builtins.str] model_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the model to associate with the endpoint.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) A short description of the an endpoint.
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly display name for the resource. It should be unique and can be modified. Avoid entering confidential information.
        ...
        :param pulumi.Input[builtins.int] inference_units: (Updatable) Number of replicas required for this endpoint. This will be optional parameter. Default will be 1.
        """
    ...
    def inference_units(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def inference_units(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _EndpointState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] model_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the model to associate with the endpoint.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] project_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the project to associate with the Endpoint.
        :param pulumi.Input[builtins.str] state: The state of the endpoint.
        ...
        :param pulumi.Input[builtins.str] time_created: The time the the endpoint was created. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The time the endpoint was updated. An RFC3339 formatted datetime string.
        """
...
class Endpoint(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="inferenceUnits")
    def inference_units(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) Number of replicas required for this endpoint. This will be optional parameter. Default will be 1.
        """
        return pulumi.get(self, "inference_units")
