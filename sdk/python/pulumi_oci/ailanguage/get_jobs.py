...
class GetJobsResult:
    ...
    """
    def __init__(__self__, compartment_id=None, display_name=None, filters=None, id=None, job_collections=None, state=None):
...
def get_jobs(compartment_id: Optional[_builtins.str] = None,
             ...
             filters: Optional[Sequence[Union['GetJobsFilterArgs', 'GetJobsFilterArgsDict', 'outputs.GetJobsFilterResult']]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('oci:AiLanguage/getJobs:getJobs', __args__, opts=opts, typ=GetJobsResult).value
...
def get_jobs_output(compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                    ...
                    filters: pulumi.Input[Optional[Optional[Sequence[Union['GetJobsFilterArgs', 'GetJobsFilterArgsDict', 'outputs.GetJobsFilterResult']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:AiLanguage/getJobs:getJobs', __args__, opts=opts, typ=GetJobsResult)
    return __ret__.apply(lambda __response__: GetJobsResult(
        compartment_id=pulumi.get(__response__, 'compartment_id'),
        display_name=pulumi.get(__response__, 'display_name'),
        filters=pulumi.get(__response__, 'filters'),
        id=pulumi.get(__response__, 'id'),
        job_collections=pulumi.get(__response__, 'job_collections'),
