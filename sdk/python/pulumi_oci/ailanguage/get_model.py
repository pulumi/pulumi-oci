...
class GetModelResult:
    ...
    """
    def __init__(__self__, compartment_id=None, defined_tags=None, description=None, display_name=None, evaluation_results=None, freeform_tags=None, id=None, lifecycle_details=None, model_details=None, project_id=None, state=None, system_tags=None, test_strategies=None, time_created=None, time_updated=None, training_datasets=None, version=None):
        ...
        if evaluation_results and not isinstance(evaluation_results, list):
            raise TypeError("Expected argument 'evaluation_results' to be a list")
        ...
        if model_details and not isinstance(model_details, list):
            raise TypeError("Expected argument 'model_details' to be a list")
        ...
        if test_strategies and not isinstance(test_strategies, list):
            raise TypeError("Expected argument 'test_strategies' to be a list")
...
def get_model(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('oci:AiLanguage/getModel:getModel', __args__, opts=opts, typ=GetModelResult).value
    ...
    return AwaitableGetModelResult(
        ...
        evaluation_results=pulumi.get(__ret__, 'evaluation_results'),
        freeform_tags=pulumi.get(__ret__, 'freeform_tags'),
        id=pulumi.get(__ret__, 'id'),
        lifecycle_details=pulumi.get(__ret__, 'lifecycle_details'),
        model_details=pulumi.get(__ret__, 'model_details'),
        project_id=pulumi.get(__ret__, 'project_id'),
        state=pulumi.get(__ret__, 'state'),
        system_tags=pulumi.get(__ret__, 'system_tags'),
        test_strategies=pulumi.get(__ret__, 'test_strategies'),
        time_created=pulumi.get(__ret__, 'time_created'),
        time_updated=pulumi.get(__ret__, 'time_updated'),
        training_datasets=pulumi.get(__ret__, 'training_datasets'),
        version=pulumi.get(__ret__, 'version'))
def get_model_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:AiLanguage/getModel:getModel', __args__, opts=opts, typ=GetModelResult)
    return __ret__.apply(lambda __response__: GetModelResult(
        compartment_id=pulumi.get(__response__, 'compartment_id'),
        defined_tags=pulumi.get(__response__, 'defined_tags'),
        description=pulumi.get(__response__, 'description'),
        display_name=pulumi.get(__response__, 'display_name'),
        evaluation_results=pulumi.get(__response__, 'evaluation_results'),
        freeform_tags=pulumi.get(__response__, 'freeform_tags'),
        id=pulumi.get(__response__, 'id'),
        lifecycle_details=pulumi.get(__response__, 'lifecycle_details'),
        model_details=pulumi.get(__response__, 'model_details'),
        project_id=pulumi.get(__response__, 'project_id'),
        state=pulumi.get(__response__, 'state'),
        system_tags=pulumi.get(__response__, 'system_tags'),
        test_strategies=pulumi.get(__response__, 'test_strategies'),
