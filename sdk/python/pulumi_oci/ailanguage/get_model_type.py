...
def get_model_type(model_type: Optional[_builtins.str] = None,
    ...
    :param _builtins.str model_type: Results like version and model supported info by specifying model type
    """
    __args__ = dict()
