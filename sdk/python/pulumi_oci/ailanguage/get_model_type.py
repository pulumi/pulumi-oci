...
def get_model_type(model_type: Optional[builtins.str] = None,
    ...
    :param builtins.str model_type: Results like version and model supported info by specifying model type
    """
    __args__ = dict()
...
def get_model_type_output(model_type: Optional[pulumi.Input[builtins.str]] = None,
