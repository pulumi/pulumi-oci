...
def get_models(compartment_id: Optional[builtins.str] = None,
...
def get_models_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:AiLanguage/getModels:getModels', __args__, opts=opts, typ=GetModelsResult)
