...
class ProjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for the project's compartment.
...
class _ProjectState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] state: The state of the project.
...
class Project(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(Project, __self__).__init__(
            'oci:AiLanguage/project:Project',
            resource_name,
            __props__,
            opts)
