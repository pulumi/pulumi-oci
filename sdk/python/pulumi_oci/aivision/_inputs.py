...
class ModelTestingDatasetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] dataset_type: Type of the Dataset.
        :param pulumi.Input[builtins.str] bucket: The name of the ObjectStorage bucket that contains the input data file.
        :param pulumi.Input[builtins.str] dataset_id: The OCID of the Data Science Labeling Dataset.
        :param pulumi.Input[builtins.str] namespace_name: The namespace name of the ObjectStorage bucket that contains the input data file.
