...
def get_project(project_id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('oci:AiVision/getProject:getProject', __args__, opts=opts, typ=GetProjectResult).value
...
def get_project_output(project_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:AiVision/getProject:getProject', __args__, opts=opts, typ=GetProjectResult)
