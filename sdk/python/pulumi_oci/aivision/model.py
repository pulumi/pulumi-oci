...
class ModelArgs:
    def __init__(__self__, *,
                 ...
                 is_quick_mode: Optional[pulumi.Input[builtins.bool]] = None,
                 max_training_duration_in_hours: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input[builtins.str] model_type: The  type of the model.
        :param pulumi.Input[builtins.str] project_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the project to associate with the model.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) A short description of the Model.
        :param pulumi.Input[builtins.str] display_name: (Updatable) Model Identifier
        ...
        :param pulumi.Input[builtins.bool] is_quick_mode: If It's true, Training is set for recommended epochs needed for quick training.
        :param pulumi.Input[builtins.float] max_training_duration_in_hours: The maximum duration in hours for which the training will run.
        :param pulumi.Input[builtins.str] model_version: Model version.
    ...
    def is_quick_mode(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_quick_mode(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_quick_mode", value)

    @property
    @pulumi.getter(name="maxTrainingDurationInHours")
    def max_training_duration_in_hours(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def max_training_duration_in_hours(self, value: Optional[pulumi.Input[builtins.float]]):
...
class _ModelState:
    def __init__(__self__, *,
                 average_precision: Optional[pulumi.Input[builtins.float]] = None,
                 ...
                 test_image_count: Optional[pulumi.Input[builtins.int]] = None,
                 testing_dataset: Optional[pulumi.Input['ModelTestingDatasetArgs']] = None,
                 time_created: Optional[pulumi.Input[builtins.str]] = None,
                 time_updated: Optional[pulumi.Input[builtins.str]] = None,
                 total_image_count: Optional[pulumi.Input[builtins.int]] = None,
                 trained_duration_in_hours: Optional[pulumi.Input[builtins.float]] = None,
                 training_dataset: Optional[pulumi.Input['ModelTrainingDatasetArgs']] = None,
                 validation_dataset: Optional[pulumi.Input['ModelValidationDatasetArgs']] = None):
        """
        Input properties used for looking up and filtering Model resources.
        :param pulumi.Input[builtins.float] average_precision: Average precision of the trained model
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) Compartment Identifier
        :param pulumi.Input[builtins.float] confidence_threshold: Confidence ratio of the calculation
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] description: (Updatable) A short description of the Model.
        :param pulumi.Input[builtins.str] display_name: (Updatable) Model Identifier
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        ...
        :param pulumi.Input[builtins.float] max_training_duration_in_hours: The maximum duration in hours for which the training will run.
        :param pulumi.Input[builtins.str] metrics: Complete Training Metrics for successful trained model
        :param pulumi.Input[builtins.str] model_type: The  type of the model.
        :param pulumi.Input[builtins.str] model_version: Model version.
        :param pulumi.Input[builtins.float] precision: Precision of the trained model
        :param pulumi.Input[builtins.str] project_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the project to associate with the model.
        :param pulumi.Input[builtins.float] recall: Recall of the trained model
        :param pulumi.Input[builtins.str] state: The current state of the Model.
        ...
        :param pulumi.Input[builtins.int] test_image_count: Total number of testing Images
        :param pulumi.Input['ModelTestingDatasetArgs'] testing_dataset: The base entity for a Dataset, which is the input for Model creation.
        :param pulumi.Input[builtins.str] time_created: The time the Model was created. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.str] time_updated: The time the Model was updated. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.int] total_image_count: Total number of training Images
        :param pulumi.Input[builtins.float] trained_duration_in_hours: Total hours actually used for training
        :param pulumi.Input['ModelTrainingDatasetArgs'] training_dataset: The base entity for a Dataset, which is the input for Model creation.
        :param pulumi.Input['ModelValidationDatasetArgs'] validation_dataset: The base entity for a Dataset, which is the input for Model creation.
        """
    ...
    def average_precision(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def average_precision(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def test_image_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def test_image_count(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def total_image_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def total_image_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "total_image_count", value)

    @property
    @pulumi.getter(name="trainedDurationInHours")
    def trained_duration_in_hours(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def trained_duration_in_hours(self, value: Optional[pulumi.Input[builtins.float]]):
...
class Model(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="averagePrecision")
    def average_precision(self) -> pulumi.Output[builtins.float]:
        """
        Average precision of the trained model
        """
        return pulumi.get(self, "average_precision")
    ...
    @property
    @pulumi.getter(name="confidenceThreshold")
    def confidence_threshold(self) -> pulumi.Output[builtins.float]:
        """
        Confidence ratio of the calculation
        """
        return pulumi.get(self, "confidence_threshold")
    ...
    @property
    @pulumi.getter(name="isQuickMode")
    def is_quick_mode(self) -> pulumi.Output[builtins.bool]:
        """
        If It's true, Training is set for recommended epochs needed for quick training.
        """
        return pulumi.get(self, "is_quick_mode")
    ...
    @property
    @pulumi.getter(name="maxTrainingDurationInHours")
    def max_training_duration_in_hours(self) -> pulumi.Output[builtins.float]:
        """
        The maximum duration in hours for which the training will run.
        """
        return pulumi.get(self, "max_training_duration_in_hours")
    ...
    @property
    @pulumi.getter
    def metrics(self) -> pulumi.Output[builtins.str]:
        """
        Complete Training Metrics for successful trained model
        """
        return pulumi.get(self, "metrics")
    ...
    @property
    @pulumi.getter
    def precision(self) -> pulumi.Output[builtins.float]:
        """
        Precision of the trained model
        """
        return pulumi.get(self, "precision")
    ...
    @property
    @pulumi.getter
    def recall(self) -> pulumi.Output[builtins.float]:
        """
        Recall of the trained model
        """
        return pulumi.get(self, "recall")
    ...
    @property
    @pulumi.getter(name="testImageCount")
    def test_image_count(self) -> pulumi.Output[builtins.int]:
        """
        Total number of testing Images
        """
        return pulumi.get(self, "test_image_count")
    ...
    @property
    @pulumi.getter(name="totalImageCount")
    def total_image_count(self) -> pulumi.Output[builtins.int]:
        """
        Total number of training Images
        """
        return pulumi.get(self, "total_image_count")
    ...
    @property
    @pulumi.getter(name="trainedDurationInHours")
    def trained_duration_in_hours(self) -> pulumi.Output[builtins.float]:
        """
        Total hours actually used for training
        """
        return pulumi.get(self, "trained_duration_in_hours")
