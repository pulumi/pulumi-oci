...
class ModelTestingDataset(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str dataset_type: Type of the Dataset.
        :param builtins.str bucket: The name of the ObjectStorage bucket that contains the input data file.
        :param builtins.str dataset_id: The OCID of the Data Science Labeling Dataset.
        :param builtins.str namespace_name: The namespace name of the ObjectStorage bucket that contains the input data file.
...
class GetModelsModelCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 max_training_duration_in_hours: builtins.float,
                 ...
                 test_image_count: builtins.int,
                 testing_datasets: Sequence['outputs.GetModelsModelCollectionItemTestingDatasetResult'],
                 time_created: builtins.str,
                 time_updated: builtins.str,
                 total_image_count: builtins.int,
                 trained_duration_in_hours: builtins.float,
        ...
        """
        :param builtins.float average_precision: Average precision of the trained model
        :param builtins.str compartment_id: The ID of the compartment in which to list resources.
        :param builtins.float confidence_threshold: Confidence ratio of the calculation
        ...
        :param builtins.str id: unique Model identifier
        :param builtins.bool is_quick_mode: If It's true, Training is set for recommended epochs needed for quick training.
        ...
        :param builtins.float max_training_duration_in_hours: The maximum duration in hours for which the training will run.
        :param builtins.str metrics: Complete Training Metrics for successful trained model
        :param builtins.str model_type: Type of the Model.
        :param builtins.str model_version: The version of the model
        :param builtins.float precision: Precision of the trained model
        :param builtins.str project_id: The ID of the project for which to list the objects.
        :param builtins.float recall: Recall of the trained model
        ...
        :param builtins.int test_image_count: Total number of testing Images
        ...
        :param builtins.str time_created: The time the Model was created. An RFC3339 formatted datetime string
        :param builtins.str time_updated: The time the Model was updated. An RFC3339 formatted datetime string
        :param builtins.int total_image_count: Total number of training Images
        :param builtins.float trained_duration_in_hours: Total hours actually used for training
    ...
    def average_precision(self) -> builtins.float:
        """
    ...
    def confidence_threshold(self) -> builtins.float:
        """
    ...
    def max_training_duration_in_hours(self) -> builtins.float:
        """
    ...
    def test_image_count(self) -> builtins.int:
        """
    ...
    def total_image_count(self) -> builtins.int:
        """
    ...
    def trained_duration_in_hours(self) -> builtins.float:
        """
...
class GetProjectsProjectCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: unique Project identifier
        :param builtins.str lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        :param builtins.str state: A filter to return only resources their lifecycleState matches the given lifecycleState.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The time the Project was created. An RFC3339 formatted datetime string
        :param builtins.str time_updated: The time the Project was updated. An RFC3339 formatted datetime string
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
        pulumi.set(__self__, "description", description)
