...
class ProjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) Project Identifier
...
class _ProjectState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] time_created: The time the Project was created. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.str] time_updated: The time the Project was updated. An RFC3339 formatted datetime string
        """
...
@pulumi.type_token("oci:AiVision/project:Project")
