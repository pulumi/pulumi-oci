...
if not MYPY:
    class AnalyticsInstanceCapacityArgsDict(TypedDict):
        capacity_type: pulumi.Input[builtins.str]
        """
        The capacity model to use. Accepted values are: OLPU_COUNT, USER_COUNT
        """
        capacity_value: pulumi.Input[builtins.int]
        """
...
class AnalyticsInstanceCapacityArgs:
    def __init__(__self__, *,
                 ...
                 capacity_value: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] capacity_type: The capacity model to use. Accepted values are: OLPU_COUNT, USER_COUNT
        :param pulumi.Input[builtins.int] capacity_value: (Updatable) The capacity value selected, either the number of OCPUs (OLPU_COUNT) or the number of users (USER_COUNT). This parameter affects the number of OCPUs, amount of memory, and other resources allocated to the instance.
        """
    ...
    def capacity_type(self) -> pulumi.Input[builtins.str]:
        """
        The capacity model to use. Accepted values are: OLPU_COUNT, USER_COUNT
        """
    ...
    def capacity_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "capacity_type", value)

    @property
    @pulumi.getter(name="capacityValue")
    def capacity_value(self) -> pulumi.Input[builtins.int]:
        """
        (Updatable) The capacity value selected, either the number of OCPUs (OLPU_COUNT) or the number of users (USER_COUNT). This parameter affects the number of OCPUs, amount of memory, and other resources allocated to the instance.
        """
    ...
    def capacity_value(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class AnalyticsInstanceNetworkEndpointDetailsArgsDict(TypedDict):
        ...
        """
        whitelisted_ips: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Source IP addresses or IP address ranges in ingress rules.
        """
        whitelisted_services: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class AnalyticsInstanceNetworkEndpointDetailsArgs:
    def __init__(__self__, *,
                 ...
                 whitelisted_ips: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 whitelisted_services: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] network_security_group_ids: Network Security Group OCIDs for an Analytics instance.
        :param pulumi.Input[builtins.str] subnet_id: The subnet OCID for the private endpoint.
        :param pulumi.Input[builtins.str] vcn_id: The VCN OCID for the private endpoint.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] whitelisted_ips: Source IP addresses or IP address ranges in ingress rules.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] whitelisted_services: Oracle Cloud Services that are allowed to access this Analytics instance.
    ...
    def whitelisted_ips(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Source IP addresses or IP address ranges in ingress rules.
        """
    ...
    def whitelisted_ips(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "whitelisted_ips", value)

    @property
    @pulumi.getter(name="whitelistedServices")
    def whitelisted_services(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Oracle Cloud Services that are allowed to access this Analytics instance.
        """
    ...
    def whitelisted_services(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class AnalyticsInstancePrivateAccessChannelPrivateSourceDnsZoneArgsDict(TypedDict):
        dns_zone: pulumi.Input[builtins.str]
        """
...
class AnalyticsInstancePrivateAccessChannelPrivateSourceDnsZoneArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] dns_zone: (Updatable) Private Source DNS Zone. Ex: example-vcn.oraclevcn.com, corp.example.com.
        :param pulumi.Input[builtins.str] description: (Updatable) Description of private source dns zone.
        """
    ...
    def dns_zone(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) Private Source DNS Zone. Ex: example-vcn.oraclevcn.com, corp.example.com.
        """
    ...
    @dns_zone.setter
    def dns_zone(self, value: pulumi.Input[builtins.str]):
...
class AnalyticsInstancePrivateAccessChannelPrivateSourceScanHostArgs:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] scan_hostname: (Updatable) Private Source Scan hostname. Ex: db01-scan.corp.example.com, prd-db01-scan.mycompany.com.
        :param pulumi.Input[builtins.int] scan_port: (Updatable) Private Source Scan host port. This is the source port where SCAN protocol will get connected (e.g. 1521).
        :param pulumi.Input[builtins.str] description: (Updatable) Description of private source scan host zone.
        """
    ...
    def scan_hostname(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) Private Source Scan hostname. Ex: db01-scan.corp.example.com, prd-db01-scan.mycompany.com.
        """
    ...
    def scan_hostname(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "scan_hostname", value)

    @property
    @pulumi.getter(name="scanPort")
    def scan_port(self) -> pulumi.Input[builtins.int]:
        """
        (Updatable) Private Source Scan host port. This is the source port where SCAN protocol will get connected (e.g. 1521).
        """
    ...
    @scan_port.setter
    def scan_port(self, value: pulumi.Input[builtins.int]):
