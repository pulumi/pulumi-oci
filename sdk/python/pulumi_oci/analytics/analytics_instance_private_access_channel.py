...
class AnalyticsInstancePrivateAccessChannelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) Display Name of the Private Access Channel.
        ...
        :param pulumi.Input[builtins.str] subnet_id: (Updatable) OCID of the customer subnet connected to private access channel.
        :param pulumi.Input[builtins.str] vcn_id: (Updatable) OCID of the customer VCN peered with private access channel. 
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] network_security_group_ids: (Updatable) Network Security Group OCIDs for an Analytics instance.
    ...
    def network_security_group_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _AnalyticsInstancePrivateAccessChannelState:
    def __init__(__self__, *,
                 ...
                 egress_source_ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] analytics_instance_id: The OCID of the AnalyticsInstance.
        :param pulumi.Input[builtins.str] display_name: (Updatable) Display Name of the Private Access Channel.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] egress_source_ip_addresses: The list of IP addresses from the customer subnet connected to private access channel, used as a source Ip by Private Access Channel for network traffic from the AnalyticsInstance to Private Sources.
        :param pulumi.Input[builtins.str] ip_address: IP Address of the Private Access channel.
        :param pulumi.Input[builtins.str] key: Private Access Channel unique identifier key.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] network_security_group_ids: (Updatable) Network Security Group OCIDs for an Analytics instance.
        :param pulumi.Input[Sequence[pulumi.Input['AnalyticsInstancePrivateAccessChannelPrivateSourceDnsZoneArgs']]] private_source_dns_zones: (Updatable) List of Private Source DNS zones registered with Private Access Channel, where datasource hostnames from these dns zones / domains will be resolved in the peered VCN for access from Analytics Instance. Min of 1 is required and Max of 30 Private Source DNS zones can be registered.
        :param pulumi.Input[Sequence[pulumi.Input['AnalyticsInstancePrivateAccessChannelPrivateSourceScanHostArgs']]] private_source_scan_hosts: (Updatable) List of Private Source DB SCAN hosts registered with Private Access Channel for access from Analytics Instance.
        :param pulumi.Input[builtins.str] subnet_id: (Updatable) OCID of the customer subnet connected to private access channel.
    ...
    def egress_source_ip_addresses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def egress_source_ip_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class AnalyticsInstancePrivateAccessChannel(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            private_source_scan_hosts: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AnalyticsInstancePrivateAccessChannelPrivateSourceScanHostArgs', 'AnalyticsInstancePrivateAccessChannelPrivateSourceScanHostArgsDict']]]]] = None,
            subnet_id: Optional[pulumi.Input[builtins.str]] = None,
            vcn_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AnalyticsInstancePrivateAccessChannel':
        """
    ...
    @property
    @pulumi.getter(name="egressSourceIpAddresses")
    def egress_source_ip_addresses(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The list of IP addresses from the customer subnet connected to private access channel, used as a source Ip by Private Access Channel for network traffic from the AnalyticsInstance to Private Sources.
        """
        return pulumi.get(self, "egress_source_ip_addresses")
    ...
    @property
    @pulumi.getter(name="networkSecurityGroupIds")
    def network_security_group_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) Network Security Group OCIDs for an Analytics instance.
        """
        return pulumi.get(self, "network_security_group_ids")
