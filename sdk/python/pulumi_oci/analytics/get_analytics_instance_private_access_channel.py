...
class GetAnalyticsInstancePrivateAccessChannelResult:
    ...
    def analytics_instance_id(self) -> builtins.str:
    ...
    def egress_source_ip_addresses(self) -> Sequence[builtins.str]:
        """
    ...
    def private_access_channel_key(self) -> builtins.str:
...
def get_analytics_instance_private_access_channel(analytics_instance_id: Optional[builtins.str] = None,
                                                  private_access_channel_key: Optional[builtins.str] = None,
    ...
    :param builtins.str analytics_instance_id: The OCID of the AnalyticsInstance.
    :param builtins.str private_access_channel_key: The unique identifier key of the Private Access Channel.
    """
    __args__ = dict()
...
def get_analytics_instance_private_access_channel_output(analytics_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                                                         private_access_channel_key: Optional[pulumi.Input[builtins.str]] = None,
