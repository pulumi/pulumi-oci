...
class AnnouncementSubscriptionsActionsChangeCompartmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment into which you want to move the announcement subscription. 
...
class AnnouncementSubscriptionsActionsChangeCompartment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            announcement_subscription_id: Optional[pulumi.Input[builtins.str]] = None,
            compartment_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AnnouncementSubscriptionsActionsChangeCompartment':
        """
