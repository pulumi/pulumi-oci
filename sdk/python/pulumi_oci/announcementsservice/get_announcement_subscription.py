...
class GetAnnouncementSubscriptionResult:
    ...
    def announcement_subscription_id(self) -> _builtins.str:
...
def get_announcement_subscription(announcement_subscription_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str announcement_subscription_id: The OCID of the announcement subscription.
    """
    __args__ = dict()
