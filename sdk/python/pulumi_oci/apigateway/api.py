...
class ApiArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] content: (Updatable) API Specification content in json or yaml format
...
class _ApiState:
    def __init__(__self__, *,
                 ...
                 specification_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}` 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] lifecycle_details: A message describing the current lifecycleState in more detail. For ACTIVE state it describes if the document has been validated and the possible values are:
        ...
        :param pulumi.Input[builtins.str] specification_type: Type of API Specification file.
        :param pulumi.Input[builtins.str] state: The current state of the API.
    ...
    def specification_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def specification_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Api(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="specificationType")
    def specification_type(self) -> pulumi.Output[builtins.str]:
        """
        Type of API Specification file.
        """
        return pulumi.get(self, "specification_type")
