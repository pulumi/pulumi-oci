...
class CertificateArgs:
    def __init__(__self__, *,
                 ...
                 intermediate_certificates: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Certificate resource.
        :param pulumi.Input[builtins.str] certificate: The data of the leaf certificate in pem format.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which the resource is created.
        :param pulumi.Input[builtins.str] private_key: The private key associated with the certificate in pem format.
        ...
        :param pulumi.Input[builtins.str] intermediate_certificates: The intermediate certificate data associated with the certificate in pem format.
        """
    ...
    def intermediate_certificates(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def intermediate_certificates(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _CertificateState:
    def __init__(__self__, *,
                 ...
                 subject_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] private_key: The private key associated with the certificate in pem format.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The current state of the certificate.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subject_names: The entity to be secured by the certificate and additional host names.
        :param pulumi.Input[builtins.str] time_created: The time this resource was created. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_not_valid_after: The date and time the certificate will expire.
    ...
    def subject_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def subject_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
@pulumi.type_token("oci:ApiGateway/certificate:Certificate")
class Certificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_not_valid_after: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'Certificate':
        """
    ...
    @property
    @pulumi.getter(name="intermediateCertificates")
    def intermediate_certificates(self) -> pulumi.Output[builtins.str]:
        """
        The intermediate certificate data associated with the certificate in pem format.
        """
        return pulumi.get(self, "intermediate_certificates")
    ...
    @property
    @pulumi.getter(name="subjectNames")
    def subject_names(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The entity to be secured by the certificate and additional host names.
        """
        return pulumi.get(self, "subject_names")
