...
def get_api_deployment_specification(api_id: Optional[builtins.str] = None,
...
def get_api_deployment_specification_output(api_id: Optional[pulumi.Input[builtins.str]] = None,
