...
def get_certificates(compartment_id: Optional[str] = None,
    ...
    test_certificates = oci.ApiGateway.get_certificates(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
