...
def get_deployment(deployment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str deployment_id: The ocid of the deployment.
    """
    __args__ = dict()
...
def get_deployment_output(deployment_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:ApiGateway/getDeployment:getDeployment', __args__, opts=opts, typ=GetDeploymentResult)
