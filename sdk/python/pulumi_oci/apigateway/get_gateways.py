...
def get_gateways(certificate_id: Optional[builtins.str] = None,
    ...
    :param builtins.str certificate_id: Filter gateways by the certificate ocid.
...
def get_gateways_output(certificate_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
