...
class GetSubscriberResult:
    ...
    def usage_plans(self) -> Sequence[builtins.str]:
        """
...
def get_subscriber(subscriber_id: Optional[builtins.str] = None,
    ...
    :param builtins.str subscriber_id: The ocid of the subscriber.
    """
    __args__ = dict()
...
def get_subscriber_output(subscriber_id: Optional[pulumi.Input[builtins.str]] = None,
