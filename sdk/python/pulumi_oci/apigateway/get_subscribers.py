...
def get_subscribers(compartment_id: Optional[str] = None,
                    ...
                    filters: Optional[Sequence[pulumi.InputType['GetSubscribersFilterArgs']]] = None,
    ...
    test_subscribers = oci.ApiGateway.get_subscribers(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetSubscribersResult(
        ...
        id=__ret__.id,
        state=__ret__.state,
        subscriber_collections=__ret__.subscriber_collections)


@_utilities.lift_output_func(get_subscribers)
def get_subscribers_output(compartment_id: Optional[pulumi.Input[str]] = None,
                           display_name: Optional[pulumi.Input[Optional[str]]] = None,
                           filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetSubscribersFilterArgs']]]]] = None,
                           state: Optional[pulumi.Input[Optional[str]]] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetSubscribersResult]:
    """
    This data source provides the list of Subscribers in Oracle Cloud Infrastructure API Gateway service.
