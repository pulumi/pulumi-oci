...
def get_usage_plan(usage_plan_id: Optional[builtins.str] = None,
    ...
    :param builtins.str usage_plan_id: The ocid of the usage plan.
    """
    __args__ = dict()
...
def get_usage_plan_output(usage_plan_id: Optional[pulumi.Input[builtins.str]] = None,
