...
class GetDataKeysResult:
    ...
    def data_key_type(self) -> Optional[builtins.str]:
...
def get_data_keys(apm_domain_id: Optional[builtins.str] = None,
                  data_key_type: Optional[builtins.str] = None,
    ...
    :param builtins.str apm_domain_id: The OCID of the APM domain
    :param builtins.str data_key_type: Data key type.
    """
    __args__ = dict()
...
def get_data_keys_output(apm_domain_id: Optional[pulumi.Input[builtins.str]] = None,
                         data_key_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
