...
class GetApmDomainsApmDomainResult(dict):
    def __init__(__self__, *,
                 ...
                 data_upload_endpoint: builtins.str,
        ...
        :param builtins.str data_upload_endpoint: The endpoint where the APM agents upload their observations and metrics.
        ...
        :param builtins.str description: Description of the APM domain.
        ...
        :param builtins.bool is_free_tier: Indicates if this is an Always Free resource.
        :param builtins.str state: A filter to return only resources that match the given life-cycle state.
        :param builtins.str time_created: The time the APM domain was created, expressed in RFC 3339 timestamp format.
        :param builtins.str time_updated: The time the APM domain was updated, expressed in RFC 3339 timestamp format.
        """
    ...
    def data_upload_endpoint(self) -> builtins.str:
        """
...
class GetDataKeysDataKeyResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str type: Type of the Data Key.
        :param builtins.str value: Value of the Data Key.
        """
        pulumi.set(__self__, "name", name)
