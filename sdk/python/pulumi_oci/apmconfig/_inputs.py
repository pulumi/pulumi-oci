...
if not MYPY:
    class ConfigDimensionArgsDict(TypedDict):
        ...
        """
        value_source: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ConfigDimensionArgs:
    def __init__(__self__, *,
                 ...
                 value_source: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: (Updatable) The name of the dimension.
        :param pulumi.Input[builtins.str] value_source: (Updatable) The source to populate the dimension. This must not be specified.
        """
        if name is not None:
    ...
    def value_source(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The source to populate the dimension. This must not be specified.
        """
    ...
    @value_source.setter
    def value_source(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "value_source", value)


if not MYPY:
    class ConfigInUseByArgsDict(TypedDict):
        config_type: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        options_group: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ConfigInUseByArgs:
    def __init__(__self__, *,
                 ...
                 options_group: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] config_type: (Updatable) The type of configuration item.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The name by which a configuration entity is displayed to the end user.
        :param pulumi.Input[builtins.str] id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the configuration item. An OCID is generated when the item is created.
        :param pulumi.Input[builtins.str] options_group: A string that specifies the group that an OPTIONS item belongs to.
        """
    ...
    def options_group(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A string that specifies the group that an OPTIONS item belongs to.
        """
    ...
    def options_group(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ConfigMetricArgs:
    def __init__(__self__, *,
                 ...
                 value_source: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] description: (Updatable) A description of the metric.
        :param pulumi.Input[builtins.str] name: (Updatable) The name of the metric. This must be a known metric name.
        :param pulumi.Input[builtins.str] unit: (Updatable) The unit of the metric.
        :param pulumi.Input[builtins.str] value_source: (Updatable) This must not be set.
        """
...
if not MYPY:
    class ConfigRuleArgsDict(TypedDict):
        ...
        (Updatable) The name by which a configuration entity is displayed to the end user.
        """
        filter_text: NotRequired[pulumi.Input[builtins.str]]
        """
        (Updatable) The string that defines the Span Filter expression.
        """
        is_apply_to_error_spans: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        satisfied_response_time: NotRequired[pulumi.Input[builtins.int]]
        """
        (Updatable) The maximum response time in milliseconds that is considered "satisfactory" for the end user.
        """
        tolerating_response_time: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ConfigRuleArgs:
    def __init__(__self__, *,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 filter_text: Optional[pulumi.Input[builtins.str]] = None,
                 is_apply_to_error_spans: Optional[pulumi.Input[builtins.bool]] = None,
                 is_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 priority: Optional[pulumi.Input[builtins.int]] = None,
                 satisfied_response_time: Optional[pulumi.Input[builtins.int]] = None,
                 tolerating_response_time: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] display_name: (Updatable) The name by which a configuration entity is displayed to the end user.
        :param pulumi.Input[builtins.str] filter_text: (Updatable) The string that defines the Span Filter expression.
        :param pulumi.Input[builtins.bool] is_apply_to_error_spans: (Updatable) Specifies whether an Apdex score should be computed for error spans. Setting it to "true" means that the Apdex score is computed in the usual way. Setting it to "false" skips the Apdex computation and sets the Apdex score to "frustrating" regardless of the configured thresholds. The default is "false".
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) Specifies whether the Apdex score should be computed for spans matching the rule. This can be used to disable Apdex score for spans that do not need or require it. The default is "true".
        :param pulumi.Input[builtins.int] priority: (Updatable) The priority controls the order in which multiple rules in a rule set are applied. Lower values indicate higher priorities. Rules with higher priority are applied first, and once a match is found, the rest of the rules are ignored. Rules within the same rule set cannot have the same priority.
        :param pulumi.Input[builtins.int] satisfied_response_time: (Updatable) The maximum response time in milliseconds that is considered "satisfactory" for the end user.
        :param pulumi.Input[builtins.int] tolerating_response_time: (Updatable) The maximum response time in milliseconds that is considered "tolerable" for the end user. A response time beyond this threshold is considered "frustrating". This value cannot be lower than "satisfiedResponseTime". 
    ...
    def filter_text(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The string that defines the Span Filter expression.
        """
    ...
    @filter_text.setter
    def filter_text(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "filter_text", value)

    @property
    @pulumi.getter(name="isApplyToErrorSpans")
    def is_apply_to_error_spans(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) Specifies whether an Apdex score should be computed for error spans. Setting it to "true" means that the Apdex score is computed in the usual way. Setting it to "false" skips the Apdex computation and sets the Apdex score to "frustrating" regardless of the configured thresholds. The default is "false".
        """
    ...
    def is_apply_to_error_spans(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def satisfied_response_time(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The maximum response time in milliseconds that is considered "satisfactory" for the end user.
        """
    ...
    def satisfied_response_time(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "satisfied_response_time", value)

    @property
    @pulumi.getter(name="toleratingResponseTime")
    def tolerating_response_time(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The maximum response time in milliseconds that is considered "tolerable" for the end user. A response time beyond this threshold is considered "frustrating". This value cannot be lower than "satisfiedResponseTime". 
    ...
    def tolerating_response_time(self, value: Optional[pulumi.Input[builtins.int]]):
