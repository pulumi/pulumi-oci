...
class ConfigArgs:
    def __init__(__self__, *,
                 ...
                 filter_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 opc_dry_run: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) An optional string that describes what the options are intended or used for.
        ...
        :param pulumi.Input[builtins.str] filter_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a Span Filter. The filterId is mandatory for the creation of MetricGroups. A filterId is generated when a Span Filter is created.
        ...
        :param pulumi.Input[builtins.str] group: (Updatable) A string that specifies the group that an OPTIONS item belongs to.
        ...
        :param pulumi.Input[builtins.str] namespace: (Updatable) The namespace to which the metrics are published. It must be one of several predefined namespaces.
        :param pulumi.Input[builtins.str] opc_dry_run: (Updatable) Indicates that the request is a dry run, if set to "true". A dry run request does not modify the configuration item details and is used only to perform validation on the submitted data.
        :param pulumi.Input[builtins.str] options: (Updatable) The options are stored here as JSON.
    ...
    def filter_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @filter_id.setter
    def filter_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def opc_dry_run(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @opc_dry_run.setter
    def opc_dry_run(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ConfigState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] apm_domain_id: (Updatable) The APM Domain ID the request is intended for.
        :param pulumi.Input[builtins.str] config_type: (Updatable) The type of configuration item.
        :param pulumi.Input[builtins.str] created_by: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a user.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] description: (Updatable) An optional string that describes what the options are intended or used for.
        :param pulumi.Input[Sequence[pulumi.Input['ConfigDimensionArgs']]] dimensions: (Updatable) A list of dimensions for the metric. This variable should not be used.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The name by which a configuration entity is displayed to the end user.
        :param pulumi.Input[builtins.str] etag: For optimistic concurrency control. See `if-match`.
        :param pulumi.Input[builtins.str] filter_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a Span Filter. The filterId is mandatory for the creation of MetricGroups. A filterId is generated when a Span Filter is created.
        :param pulumi.Input[builtins.str] filter_text: (Updatable) The string that defines the Span Filter expression.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.str] group: (Updatable) A string that specifies the group that an OPTIONS item belongs to.
        ...
        :param pulumi.Input[builtins.str] updated_by: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a user.
        """
...
class Config(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            updated_by: Optional[pulumi.Input[builtins.str]] = None) -> 'Config':
        """
    ...
    @property
    @pulumi.getter(name="filterId")
    def filter_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a Span Filter. The filterId is mandatory for the creation of MetricGroups. A filterId is generated when a Span Filter is created.
        """
        return pulumi.get(self, "filter_id")
    ...
    @property
    @pulumi.getter(name="filterText")
    def filter_text(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The string that defines the Span Filter expression.
        """
        return pulumi.get(self, "filter_text")
    ...
    @property
    @pulumi.getter(name="opcDryRun")
    def opc_dry_run(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Indicates that the request is a dry run, if set to "true". A dry run request does not modify the configuration item details and is used only to perform validation on the submitted data.
        """
        return pulumi.get(self, "opc_dry_run")
    ...
    @property
    @pulumi.getter
    def options(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The options are stored here as JSON.
        """
        return pulumi.get(self, "options")
