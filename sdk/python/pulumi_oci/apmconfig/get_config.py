...
def get_config(apm_domain_id: Optional[builtins.str] = None,
    ...
    :param builtins.str config_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the configuration item.
    """
    __args__ = dict()
...
def get_config_output(apm_domain_id: Optional[pulumi.Input[builtins.str]] = None,
