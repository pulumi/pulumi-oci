...
class ConfigConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] connection_string: (Updatable) Database connection string.
        ...
        :param pulumi.Input[_builtins.str] database_connection_type: (Updatable) Database connection type. Only CUSTOM_JDBC is supported for MYSQL database type.
        :param pulumi.Input[_builtins.str] database_role: (Updatable) Database role.
        :param pulumi.Input[_builtins.str] database_type: (Updatable) Database type.
        ...
        :param pulumi.Input[_builtins.int] download_size_limit_in_bytes: (Updatable) Download size limit in Bytes, at which to stop the transfer. Maximum download size limit is 5 MiB.
        ...
        :param pulumi.Input[_builtins.str] ftp_protocol: (Updatable) FTP protocol type.
        :param pulumi.Input[_builtins.str] ftp_request_type: (Updatable) FTP monitor request type.
        :param pulumi.Input[_builtins.bool] is_active_mode: (Updatable) If enabled, Active mode will be used for the FTP connection. Not supported for SFTP protocol.
        :param pulumi.Input[_builtins.bool] is_certificate_validation_enabled: (Updatable) If certificate validation is enabled, then the call will fail in case of certification errors.
        :param pulumi.Input[_builtins.bool] is_default_snapshot_enabled: (Updatable) If disabled, auto snapshots are not collected.
        :param pulumi.Input[_builtins.bool] is_failure_retried: (Updatable) If isFailureRetried is enabled, then a failed call will be retried.
        :param pulumi.Input[_builtins.bool] is_query_recursive: (Updatable) If isQueryRecursive is enabled, then queries will be sent recursively to the target server.
        :param pulumi.Input[_builtins.bool] is_redirection_enabled: (Updatable) If redirection is enabled, then redirects will be allowed while accessing target URL.
        :param pulumi.Input[_builtins.str] name_server: (Updatable) Name of the server that will be used to perform DNS lookup.
        ...
        :param pulumi.Input[_builtins.str] protocol: (Updatable) Type of protocol.
        :param pulumi.Input[_builtins.str] query: (Updatable) SQL query to be executed.
        :param pulumi.Input[_builtins.str] record_type: (Updatable) DNS record type.
        ...
        :param pulumi.Input[_builtins.str] req_authentication_scheme: (Updatable) Request HTTP authentication scheme.
        ...
        :param pulumi.Input[_builtins.str] request_method: (Updatable) Request HTTP method.
        :param pulumi.Input[_builtins.str] request_post_body: (Updatable) Request post body content.
        ...
        :param pulumi.Input[_builtins.int] upload_file_size_in_bytes: (Updatable) File upload size in Bytes, at which to stop the transfer. Maximum upload size is 5 MiB.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] verify_response_codes: (Updatable) Expected HTTP response codes. For status code range, set values such as 2xx, 3xx.
        :param pulumi.Input[_builtins.str] verify_response_content: (Updatable) Verify response content against regular expression based string. If response content does not match the verifyResponseContent value, then it will be considered a failure.
...
class ConfigConfigurationDatabaseAuthenticationDetailsPasswordArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] vault_secret_id: (Updatable) Vault secret OCID.
        """
        if password is not None:
            pulumi.set(__self__, "password", password)
...
class ConfigConfigurationDnsConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] override_dns_ip: (Updatable) Attribute to override the DNS IP value. This value is required only if isOverrideDns is set to true.
        """
...
class ConfigConfigurationNetworkConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] probe_per_hop: (Updatable) Number of probes per hop.
        :param pulumi.Input[_builtins.str] protocol: (Updatable) Type of protocol.
        :param pulumi.Input[_builtins.int] transmission_rate: (Updatable) Number of probe packets sent out simultaneously.
        """
...
class ConfigConfigurationReqAuthenticationDetailsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] auth_request_post_body: (Updatable) Request post body.
        :param pulumi.Input[_builtins.str] auth_token: (Updatable) Authentication token.
        :param pulumi.Input[_builtins.str] auth_url: (Updatable) URL to get authentication token.
        :param pulumi.Input[_builtins.str] auth_user_name: (Updatable) User name for authentication.
        :param pulumi.Input[_builtins.str] auth_user_password: (Updatable) User password for authentication.
        :param pulumi.Input[_builtins.str] oauth_scheme: (Updatable) Request HTTP OAuth scheme.
        """
...
class ConfigMaintenanceWindowScheduleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] recurrence_type: (Updatable) Type of recurrence for a recurring maintenance window.
        :param pulumi.Input[_builtins.str] schedule_type: (Updatable) Type of maintenance window schedule. If not provided, a schedule with timeStarted and timeEnded is treated as ONE_TIME.
...
class ConfigScriptParameterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_secret: Describes if  the parameter value is secret and should be kept confidential. isSecret is specified in either CreateScript or UpdateScript API.
...
class ConfigVantagePointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] worker_lists: List of workers running the assigned monitor.
        """
...
class DedicatedVantagePointDvpStackDetailsArgs:
    def __init__(__self__, *,
                 ...
                 dvp_version: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] dvp_stack_id: (Updatable) Stack [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Resource Manager stack for dedicated vantage point.
        :param pulumi.Input[_builtins.str] dvp_stack_type: (Updatable) Type of stack.
        :param pulumi.Input[_builtins.str] dvp_stream_id: (Updatable) Stream [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Resource Manager stack for dedicated vantage point.
        :param pulumi.Input[_builtins.str] dvp_version: (Updatable) Version of the dedicated vantage point.
        """
    ...
    def dvp_stack_id(self) -> pulumi.Input[_builtins.str]:
        """
        (Updatable) Stack [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Resource Manager stack for dedicated vantage point.
        """
    ...
    @dvp_stack_id.setter
    def dvp_stack_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "dvp_stack_id", value)

    @_builtins.property
    @pulumi.getter(name="dvpStackType")
    def dvp_stack_type(self) -> pulumi.Input[_builtins.str]:
        """
        (Updatable) Type of stack.
        """
    ...
    def dvp_stack_type(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "dvp_stack_type", value)

    @_builtins.property
    @pulumi.getter(name="dvpStreamId")
    def dvp_stream_id(self) -> pulumi.Input[_builtins.str]:
        """
        (Updatable) Stream [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Resource Manager stack for dedicated vantage point.
        """
    ...
    def dvp_stream_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "dvp_stream_id", value)

    @_builtins.property
    @pulumi.getter(name="dvpVersion")
    def dvp_version(self) -> pulumi.Input[_builtins.str]:
        """
        (Updatable) Version of the dedicated vantage point.
        """
    ...
    @dvp_version.setter
    def dvp_version(self, value: pulumi.Input[_builtins.str]):
...
class DedicatedVantagePointMonitorStatusCountMapArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] invalid: Number of invalid monitors using the script.
        :param pulumi.Input[_builtins.int] total: Total number of monitors using the script.
        """
...
class OnPremiseVantagePointWorkerIdentityInfoArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] region_name: Domain region of the On-premise VP worker.
        """
...
class OnPremiseVantagePointWorkerMonitorListArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_run_now: If isRunNow is enabled, then the monitor will run immediately.
        :param pulumi.Input[_builtins.str] monitor_type: Type of monitor.
        :param pulumi.Input[_builtins.str] time_assigned: The time the resource was last assigned to an On-premise vantage point worker, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2020-02-12T22:47:12.613Z`
        """
        if display_name is not None:
            pulumi.set(__self__, "display_name", display_name)
        if id is not None:
...
class OnPremiseVantagePointWorkersSummaryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] disabled: Number of disabled workers in a specific On-premise vantage point.
        :param pulumi.Input[_builtins.str] min_version: Minimum version among the workers in a specific On-premise vantage point.
        :param pulumi.Input[_builtins.int] total: Total number of workers in a specific On-premise vantage point.
        :param pulumi.Input[_builtins.int] used: Number of occupied workers in a specific On-premise vantage point.
        """
