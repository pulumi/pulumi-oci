...
class GetDedicatedVantagePointResult:
    ...
    def dedicated_vantage_point_id(self) -> _builtins.str:
...
def get_dedicated_vantage_point(apm_domain_id: Optional[_builtins.str] = None,
                                dedicated_vantage_point_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dedicated_vantage_point_id: The OCID of the dedicated vantage point.
    """
    __args__ = dict()
