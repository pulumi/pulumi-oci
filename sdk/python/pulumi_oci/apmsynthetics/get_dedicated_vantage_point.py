...
class GetDedicatedVantagePointResult:
    ...
    def dedicated_vantage_point_id(self) -> builtins.str:
...
def get_dedicated_vantage_point(apm_domain_id: Optional[builtins.str] = None,
                                dedicated_vantage_point_id: Optional[builtins.str] = None,
    ...
    :param builtins.str dedicated_vantage_point_id: The OCID of the dedicated vantage point.
    """
    __args__ = dict()
...
def get_dedicated_vantage_point_output(apm_domain_id: Optional[pulumi.Input[builtins.str]] = None,
                                       dedicated_vantage_point_id: Optional[pulumi.Input[builtins.str]] = None,
