...
def get_dedicated_vantage_points(apm_domain_id: Optional[builtins.str] = None,
...
def get_dedicated_vantage_points_output(apm_domain_id: Optional[pulumi.Input[builtins.str]] = None,
