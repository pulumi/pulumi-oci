...
class GetMonitorsResult:
    ...
    def is_maintenance_window_active(self) -> Optional[_builtins.bool]:
        return pulumi.get(self, "is_maintenance_window_active")

    @_builtins.property
    @pulumi.getter(name="isMaintenanceWindowSet")
    def is_maintenance_window_set(self) -> Optional[_builtins.bool]:
    ...
    def vantage_point(self) -> Optional[_builtins.str]:
...
def get_monitors(apm_domain_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.bool is_maintenance_window_active: A filter to return the monitors whose maintenance window is currently active.
    :param _builtins.bool is_maintenance_window_set: A filter to return the monitors whose maintenance window is set.
    ...
    :param _builtins.str vantage_point: The name of the public or dedicated vantage point.
    """
    __args__ = dict()
