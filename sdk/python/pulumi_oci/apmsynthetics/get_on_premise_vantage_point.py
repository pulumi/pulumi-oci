...
def get_on_premise_vantage_point(apm_domain_id: Optional[builtins.str] = None,
...
def get_on_premise_vantage_point_output(apm_domain_id: Optional[pulumi.Input[builtins.str]] = None,
