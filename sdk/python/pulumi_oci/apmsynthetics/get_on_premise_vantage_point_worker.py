...
def get_on_premise_vantage_point_worker(apm_domain_id: Optional[builtins.str] = None,
    ...
    :param builtins.str worker_id: The OCID of the On-premise vantage point worker.
    """
    __args__ = dict()
...
def get_on_premise_vantage_point_worker_output(apm_domain_id: Optional[pulumi.Input[builtins.str]] = None,
