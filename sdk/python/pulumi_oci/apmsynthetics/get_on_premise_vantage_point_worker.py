...
def get_on_premise_vantage_point_worker(apm_domain_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str worker_id: The OCID of the On-premise vantage point worker.
    """
    __args__ = dict()
