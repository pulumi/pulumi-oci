...
def get_on_premise_vantage_point_workers(apm_domain_id: Optional[_builtins.str] = None,
                                         capability: Optional[_builtins.str] = None,
                                         display_name: Optional[_builtins.str] = None,
                                         filters: Optional[Sequence[Union['GetOnPremiseVantagePointWorkersFilterArgs', 'GetOnPremiseVantagePointWorkersFilterArgsDict', 'outputs.GetOnPremiseVantagePointWorkersFilterResult']]] = None,
    ...
    :param _builtins.str capability: A filter to return only On-premise VP workers that match the capability given.
...
def get_on_premise_vantage_point_workers_output(apm_domain_id: pulumi.Input[Optional[_builtins.str]] = None,
                                                ...
                                                filters: pulumi.Input[Optional[Optional[Sequence[Union['GetOnPremiseVantagePointWorkersFilterArgs', 'GetOnPremiseVantagePointWorkersFilterArgsDict', 'outputs.GetOnPremiseVantagePointWorkersFilterResult']]]]] = None,
