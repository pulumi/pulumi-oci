...
def get_script(apm_domain_id: Optional[builtins.str] = None,
               script_id: Optional[builtins.str] = None,
    ...
    :param builtins.str script_id: The OCID of the script.
    """
    __args__ = dict()
...
def get_script_output(apm_domain_id: Optional[pulumi.Input[builtins.str]] = None,
