...
class OnPremiseVantagePointWorkerArgs:
    def __init__(__self__, *,
                 ...
                 on_premise_vantage_point_id: pulumi.Input[builtins.str],
                 resource_principal_token_public_key: pulumi.Input[builtins.str],
                 version: pulumi.Input[builtins.str],
                 configuration_details: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] on_premise_vantage_point_id: The OCID of the On-premise vantage point.
        :param pulumi.Input[builtins.str] resource_principal_token_public_key: public key for resource Principal Token based validation to be used in further calls.
        :param pulumi.Input[builtins.str] version: Image version of the On-premise VP worker.
        :param pulumi.Input[builtins.str] configuration_details: (Updatable) Configuration details of the On-premise VP worker.
        ...
        :param pulumi.Input[builtins.str] name: Unique On-premise VP worker name that cannot be edited. The name should not contain any confidential information.
        :param pulumi.Input[builtins.int] priority: (Updatable) Priority of the On-premise VP worker to schedule monitors.
        :param pulumi.Input[builtins.str] status: (Updatable) Enables or disables the On-premise VP worker.
        :param pulumi.Input[builtins.str] worker_type: Type of the On-premise VP worker.
    ...
    def on_premise_vantage_point_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def on_premise_vantage_point_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "on_premise_vantage_point_id", value)

    @property
    @pulumi.getter(name="resourcePrincipalTokenPublicKey")
    def resource_principal_token_public_key(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def resource_principal_token_public_key(self, value: pulumi.Input[builtins.str]):
    ...
    def configuration_details(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def configuration_details(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _OnPremiseVantagePointWorkerState:
    def __init__(__self__, *,
                 ...
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 geo_info: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 opvp_id: Optional[pulumi.Input[builtins.str]] = None,
                 opvp_name: Optional[pulumi.Input[builtins.str]] = None,
                 priority: Optional[pulumi.Input[builtins.int]] = None,
                 resource_principal_token_public_key: Optional[pulumi.Input[builtins.str]] = None,
                 runtime_id: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 time_created: Optional[pulumi.Input[builtins.str]] = None,
                 time_last_sync_up: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] configuration_details: (Updatable) Configuration details of the On-premise VP worker.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] display_name: Unique name that can be edited. The name should not contain any confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.str] geo_info: Geographical information of the On-premise VP worker.
        ...
        :param pulumi.Input[builtins.str] name: Unique On-premise VP worker name that cannot be edited. The name should not contain any confidential information.
        :param pulumi.Input[builtins.str] on_premise_vantage_point_id: The OCID of the On-premise vantage point.
        :param pulumi.Input[builtins.str] opvp_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the On-premise vantage point.
        :param pulumi.Input[builtins.str] opvp_name: On-premise vantage point name.
        :param pulumi.Input[builtins.int] priority: (Updatable) Priority of the On-premise VP worker to schedule monitors.
        :param pulumi.Input[builtins.str] resource_principal_token_public_key: public key for resource Principal Token based validation to be used in further calls.
        :param pulumi.Input[builtins.str] runtime_id: The runtime assigned id of the On-premise VP worker.
        :param pulumi.Input[builtins.str] status: (Updatable) Enables or disables the On-premise VP worker.
        ...
        :param pulumi.Input[builtins.str] time_last_sync_up: The time the resource was last synced, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2020-02-12T22:47:12.613Z`
    ...
    def geo_info(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @geo_info.setter
    def geo_info(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="onPremiseVantagePointId")
    def on_premise_vantage_point_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The OCID of the On-premise vantage point.
        """
        return pulumi.get(self, "on_premise_vantage_point_id")
    ...
    @on_premise_vantage_point_id.setter
    def on_premise_vantage_point_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "on_premise_vantage_point_id", value)

    @property
    @pulumi.getter(name="opvpId")
    def opvp_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @opvp_id.setter
    def opvp_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "opvp_id", value)

    @property
    @pulumi.getter(name="opvpName")
    def opvp_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @opvp_name.setter
    def opvp_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="resourcePrincipalTokenPublicKey")
    def resource_principal_token_public_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        public key for resource Principal Token based validation to be used in further calls.
        """
        return pulumi.get(self, "resource_principal_token_public_key")
    ...
    @resource_principal_token_public_key.setter
    def resource_principal_token_public_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "resource_principal_token_public_key", value)

    @property
    @pulumi.getter(name="runtimeId")
    def runtime_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @runtime_id.setter
    def runtime_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_last_sync_up(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_last_sync_up(self, value: Optional[pulumi.Input[builtins.str]]):
...
class OnPremiseVantagePointWorker(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            worker_type: Optional[pulumi.Input[builtins.str]] = None) -> 'OnPremiseVantagePointWorker':
        """
    ...
    @property
    @pulumi.getter(name="configurationDetails")
    def configuration_details(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Configuration details of the On-premise VP worker.
        """
        return pulumi.get(self, "configuration_details")
    ...
    @property
    @pulumi.getter(name="geoInfo")
    def geo_info(self) -> pulumi.Output[builtins.str]:
        """
        Geographical information of the On-premise VP worker.
        """
        return pulumi.get(self, "geo_info")
    ...
    @property
    @pulumi.getter(name="onPremiseVantagePointId")
    def on_premise_vantage_point_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the On-premise vantage point.
        """
        return pulumi.get(self, "on_premise_vantage_point_id")
    ...
    @property
    @pulumi.getter(name="opvpId")
    def opvp_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the On-premise vantage point.
        """
        return pulumi.get(self, "opvp_id")
    ...
    @property
    @pulumi.getter(name="opvpName")
    def opvp_name(self) -> pulumi.Output[builtins.str]:
        """
        On-premise vantage point name.
        """
        return pulumi.get(self, "opvp_name")
    ...
    @property
    @pulumi.getter(name="resourcePrincipalTokenPublicKey")
    def resource_principal_token_public_key(self) -> pulumi.Output[builtins.str]:
        """
        public key for resource Principal Token based validation to be used in further calls.
        """
        return pulumi.get(self, "resource_principal_token_public_key")
    ...
    @property
    @pulumi.getter(name="runtimeId")
    def runtime_id(self) -> pulumi.Output[builtins.str]:
        """
        The runtime assigned id of the On-premise VP worker.
        """
        return pulumi.get(self, "runtime_id")
    ...
    @property
    @pulumi.getter(name="timeLastSyncUp")
    def time_last_sync_up(self) -> pulumi.Output[builtins.str]:
        """
        The time the resource was last synced, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2020-02-12T22:47:12.613Z`
        """
        return pulumi.get(self, "time_last_sync_up")
