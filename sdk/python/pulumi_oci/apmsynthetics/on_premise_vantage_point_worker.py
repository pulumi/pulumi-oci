...
class OnPremiseVantagePointWorkerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Unique On-premise VP worker name that cannot be edited. The name should not contain any confidential information.
        :param pulumi.Input[_builtins.int] priority: (Updatable) Priority of the On-premise VP worker to schedule monitors.
    ...
    def on_premise_vantage_point_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def on_premise_vantage_point_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "on_premise_vantage_point_id", value)

    @_builtins.property
    @pulumi.getter(name="resourcePrincipalTokenPublicKey")
    def resource_principal_token_public_key(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def resource_principal_token_public_key(self, value: pulumi.Input[_builtins.str]):
...
class _OnPremiseVantagePointWorkerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[_builtins.str] geo_info: Geographical information of the On-premise VP worker.
        ...
        :param pulumi.Input[_builtins.str] name: Unique On-premise VP worker name that cannot be edited. The name should not contain any confidential information.
        :param pulumi.Input[_builtins.str] on_premise_vantage_point_id: The OCID of the On-premise vantage point.
        :param pulumi.Input[_builtins.str] opvp_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the On-premise vantage point.
        :param pulumi.Input[_builtins.str] opvp_name: On-premise vantage point name.
        :param pulumi.Input[_builtins.int] priority: (Updatable) Priority of the On-premise VP worker to schedule monitors.
        :param pulumi.Input[_builtins.str] resource_principal_token_public_key: public key for resource Principal Token based validation to be used in further calls.
        :param pulumi.Input[_builtins.str] runtime_id: The runtime assigned id of the On-premise VP worker.
        :param pulumi.Input[_builtins.str] status: (Updatable) Enables or disables the On-premise VP worker.
        ...
        :param pulumi.Input[_builtins.str] time_last_sync_up: The time the resource was last synced, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2020-02-12T22:47:12.613Z`
...
class OnPremiseVantagePointWorker(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            geo_info: pulumi.Input[Optional[_builtins.str]] = None,
            identity_infos: pulumi.Input[Optional[Sequence[pulumi.Input[Union['OnPremiseVantagePointWorkerIdentityInfoArgs', 'OnPremiseVantagePointWorkerIdentityInfoArgsDict', 'outputs.OnPremiseVantagePointWorkerIdentityInfo']]]]] = None,
            monitor_lists: pulumi.Input[Optional[Sequence[pulumi.Input[Union['OnPremiseVantagePointWorkerMonitorListArgs', 'OnPremiseVantagePointWorkerMonitorListArgsDict', 'outputs.OnPremiseVantagePointWorkerMonitorList']]]]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            on_premise_vantage_point_id: pulumi.Input[Optional[_builtins.str]] = None,
            opvp_id: pulumi.Input[Optional[_builtins.str]] = None,
            opvp_name: pulumi.Input[Optional[_builtins.str]] = None,
            ...
            time_updated: pulumi.Input[Optional[_builtins.str]] = None,
            version: pulumi.Input[Optional[_builtins.str]] = None,
            version_details: pulumi.Input[Optional[Sequence[pulumi.Input[Union['OnPremiseVantagePointWorkerVersionDetailArgs', 'OnPremiseVantagePointWorkerVersionDetailArgsDict', 'outputs.OnPremiseVantagePointWorkerVersionDetail']]]]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[_builtins.str] geo_info: Geographical information of the On-premise VP worker.
        :param pulumi.Input[Sequence[pulumi.Input[Union['OnPremiseVantagePointWorkerIdentityInfoArgs', 'OnPremiseVantagePointWorkerIdentityInfoArgsDict', 'outputs.OnPremiseVantagePointWorkerIdentityInfo']]]] identity_infos: Domain details of the On-premise VP worker.
        :param pulumi.Input[Sequence[pulumi.Input[Union['OnPremiseVantagePointWorkerMonitorListArgs', 'OnPremiseVantagePointWorkerMonitorListArgsDict', 'outputs.OnPremiseVantagePointWorkerMonitorList']]]] monitor_lists: Monitors list assigned to the On-premise VP worker.
        :param pulumi.Input[_builtins.str] name: Unique On-premise VP worker name that cannot be edited. The name should not contain any confidential information.
        :param pulumi.Input[_builtins.str] on_premise_vantage_point_id: The OCID of the On-premise vantage point.
        :param pulumi.Input[_builtins.str] opvp_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the On-premise vantage point.
        :param pulumi.Input[_builtins.str] opvp_name: On-premise vantage point name.
        ...
        :param pulumi.Input[_builtins.str] time_updated: The time the resource was updated, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2020-02-13T22:47:12.613Z`
        :param pulumi.Input[_builtins.str] version: Image version of the On-premise VP worker.
        :param pulumi.Input[Sequence[pulumi.Input[Union['OnPremiseVantagePointWorkerVersionDetailArgs', 'OnPremiseVantagePointWorkerVersionDetailArgsDict', 'outputs.OnPremiseVantagePointWorkerVersionDetail']]]] version_details: Image version details of the On-premise VP worker.
        :param pulumi.Input[_builtins.str] worker_type: Type of the On-premise VP worker.
    ...
    @_builtins.property
    @pulumi.getter(name="configurationDetails")
    def configuration_details(self) -> pulumi.Output[_builtins.str]:
        """
        (Updatable) Configuration details of the On-premise VP worker.
        """
        return pulumi.get(self, "configuration_details")
    ...
    @_builtins.property
    @pulumi.getter(name="geoInfo")
    def geo_info(self) -> pulumi.Output[_builtins.str]:
        """
        Geographical information of the On-premise VP worker.
        """
        return pulumi.get(self, "geo_info")
    ...
    @_builtins.property
    @pulumi.getter(name="onPremiseVantagePointId")
    def on_premise_vantage_point_id(self) -> pulumi.Output[_builtins.str]:
        """
        The OCID of the On-premise vantage point.
        """
        return pulumi.get(self, "on_premise_vantage_point_id")
    ...
    @_builtins.property
    @pulumi.getter(name="opvpId")
    def opvp_id(self) -> pulumi.Output[_builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the On-premise vantage point.
        """
        return pulumi.get(self, "opvp_id")
    ...
    @_builtins.property
    @pulumi.getter(name="opvpName")
    def opvp_name(self) -> pulumi.Output[_builtins.str]:
        """
        On-premise vantage point name.
        """
        return pulumi.get(self, "opvp_name")
    ...
    @_builtins.property
    @pulumi.getter(name="resourcePrincipalTokenPublicKey")
    def resource_principal_token_public_key(self) -> pulumi.Output[_builtins.str]:
        """
        public key for resource Principal Token based validation to be used in further calls.
        """
        return pulumi.get(self, "resource_principal_token_public_key")
    ...
    @_builtins.property
    @pulumi.getter(name="runtimeId")
    def runtime_id(self) -> pulumi.Output[_builtins.str]:
        """
        The runtime assigned id of the On-premise VP worker.
        """
        return pulumi.get(self, "runtime_id")
    ...
    @_builtins.property
    @pulumi.getter(name="timeLastSyncUp")
    def time_last_sync_up(self) -> pulumi.Output[_builtins.str]:
        """
        The time the resource was last synced, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2020-02-12T22:47:12.613Z`
        """
        return pulumi.get(self, "time_last_sync_up")
