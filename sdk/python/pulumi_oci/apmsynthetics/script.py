...
class ScriptArgs:
    def __init__(__self__, *,
                 ...
                 content_file_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] content_file_name: (Updatable) File name of uploaded script content.
    ...
    def content_file_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def content_file_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ScriptState:
    def __init__(__self__, *,
                 ...
                 content_file_name: Optional[pulumi.Input[builtins.str]] = None,
                 content_size_in_bytes: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 time_uploaded: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Script resources.
        :param pulumi.Input[builtins.str] apm_domain_id: (Updatable) The APM domain ID the request is intended for.
        :param pulumi.Input[builtins.str] content: (Updatable) The content of the script. It may contain custom-defined tags that can be used for setting dynamic parameters. The format to set dynamic parameters is: `<ORAP><ON>param name</ON><OV>param value</OV><OS>isParamValueSecret(true/false)</OS></ORAP>`. Param value and isParamValueSecret are optional, the default value for isParamValueSecret is false. Examples: With mandatory param name : `<ORAP><ON>param name</ON></ORAP>` With parameter name and value : `<ORAP><ON>param name</ON><OV>param value</OV></ORAP>` Note that the content is valid if it matches the given content type. For example, if the content type is SIDE, then the content should be in Side script format. If the content type is JS, then the content should be in JavaScript format.
        :param pulumi.Input[builtins.str] content_file_name: (Updatable) File name of uploaded script content.
        :param pulumi.Input[builtins.int] content_size_in_bytes: Size of the script content.
        :param pulumi.Input[builtins.str] content_type: (Updatable) Content type of script.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] display_name: (Updatable) Unique name that can be edited. The name should not contain any confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        ...
        :param pulumi.Input[builtins.str] time_uploaded: The time the script was uploaded.
        """
    ...
    def content_size_in_bytes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def content_size_in_bytes(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def time_uploaded(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_uploaded(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Script(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            time_uploaded: Optional[pulumi.Input[builtins.str]] = None) -> 'Script':
        """
    ...
    @property
    @pulumi.getter(name="contentFileName")
    def content_file_name(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) File name of uploaded script content.
        """
        return pulumi.get(self, "content_file_name")
    ...
    @property
    @pulumi.getter(name="contentSizeInBytes")
    def content_size_in_bytes(self) -> pulumi.Output[builtins.int]:
        """
        Size of the script content.
        """
        return pulumi.get(self, "content_size_in_bytes")
    ...
    @property
    @pulumi.getter(name="timeUploaded")
    def time_uploaded(self) -> pulumi.Output[builtins.str]:
        """
        The time the script was uploaded.
        """
        return pulumi.get(self, "time_uploaded")
