...
def get_query_quick_picks(apm_domain_id: Optional[builtins.str] = None,
...
def get_query_quick_picks_output(apm_domain_id: Optional[pulumi.Input[builtins.str]] = None,
