...
class GetTraceResult:
    ...
    def time_trace_started_greater_than_or_equal_to(self) -> Optional[builtins.str]:
        return pulumi.get(self, "time_trace_started_greater_than_or_equal_to")

    @property
    @pulumi.getter(name="timeTraceStartedLessThan")
    def time_trace_started_less_than(self) -> Optional[builtins.str]:
    ...
    def trace_namespace(self) -> Optional[builtins.str]:
...
def get_trace(apm_domain_id: Optional[builtins.str] = None,
              time_trace_started_greater_than_or_equal_to: Optional[builtins.str] = None,
              time_trace_started_less_than: Optional[builtins.str] = None,
              trace_key: Optional[builtins.str] = None,
              trace_namespace: Optional[builtins.str] = None,
    ...
    :param builtins.str time_trace_started_greater_than_or_equal_to: Include traces that have a `minTraceStartTime` equal to or greater than this value.
    :param builtins.str time_trace_started_less_than: Include traces that have a `minTraceStartTime` less than this value.
    :param builtins.str trace_key: Unique Application Performance Monitoring trace identifier (traceId).
    :param builtins.str trace_namespace: Name space from which the trace details need to be retrieved.
    """
    __args__ = dict()
...
def get_trace_output(apm_domain_id: Optional[pulumi.Input[builtins.str]] = None,
                     time_trace_started_greater_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     time_trace_started_less_than: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     trace_key: Optional[pulumi.Input[builtins.str]] = None,
                     trace_namespace: Optional[pulumi.Input[Optional[builtins.str]]] = None,
