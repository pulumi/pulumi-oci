...
class GetTraceResult:
    ...
    def time_trace_started_greater_than_or_equal_to(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "time_trace_started_greater_than_or_equal_to")

    @_builtins.property
    @pulumi.getter(name="timeTraceStartedLessThan")
    def time_trace_started_less_than(self) -> Optional[_builtins.str]:
    ...
    def trace_namespace(self) -> Optional[_builtins.str]:
...
def get_trace(apm_domain_id: Optional[_builtins.str] = None,
              time_trace_started_greater_than_or_equal_to: Optional[_builtins.str] = None,
              time_trace_started_less_than: Optional[_builtins.str] = None,
              trace_key: Optional[_builtins.str] = None,
              trace_namespace: Optional[_builtins.str] = None,
