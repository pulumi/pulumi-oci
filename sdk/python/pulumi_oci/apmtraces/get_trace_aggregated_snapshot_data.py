...
class GetTraceAggregatedSnapshotDataResult:
    ...
    def span_key(self) -> Optional[builtins.str]:
        return pulumi.get(self, "span_key")

    @property
    @pulumi.getter(name="spanName")
    def span_name(self) -> Optional[builtins.str]:
...
def get_trace_aggregated_snapshot_data(apm_domain_id: Optional[builtins.str] = None,
                                       server_name: Optional[builtins.str] = None,
                                       service_name: Optional[builtins.str] = None,
                                       span_key: Optional[builtins.str] = None,
                                       span_name: Optional[builtins.str] = None,
    ...
    :param builtins.str service_name: Name associated with the service.
    :param builtins.str span_key: Unique Application Performance Monitoring span identifier (spanId).
    :param builtins.str span_name: Name of the span associated with the trace.
...
def get_trace_aggregated_snapshot_data_output(apm_domain_id: Optional[pulumi.Input[builtins.str]] = None,
                                              ...
                                              span_key: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                              span_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
