...
class GetTraceAggregatedSnapshotDataResult:
    ...
    def span_key(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "span_key")

    @_builtins.property
    @pulumi.getter(name="spanName")
    def span_name(self) -> Optional[_builtins.str]:
...
def get_trace_aggregated_snapshot_data(apm_domain_id: Optional[_builtins.str] = None,
                                       server_name: Optional[_builtins.str] = None,
                                       service_name: Optional[_builtins.str] = None,
                                       span_key: Optional[_builtins.str] = None,
                                       span_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str service_name: Name associated with the service.
    :param _builtins.str span_key: Unique Application Performance Monitoring span identifier (spanId).
    :param _builtins.str span_name: Name of the span associated with the trace.
