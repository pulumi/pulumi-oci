...
class GetTraceSnapshotDataResult:
    ...
    def is_summarized(self) -> Optional[builtins.bool]:
    ...
    def thread_id(self) -> Optional[builtins.str]:
...
def get_trace_snapshot_data(apm_domain_id: Optional[builtins.str] = None,
                            is_summarized: Optional[builtins.bool] = None,
                            snapshot_time: Optional[builtins.str] = None,
                            thread_id: Optional[builtins.str] = None,
                            trace_key: Optional[builtins.str] = None,
    ...
    :param builtins.str apm_domain_id: The APM Domain ID for the intended request.
    :param builtins.bool is_summarized: If enabled, only span level details are sent.
    :param builtins.str snapshot_time: Epoch time of snapshot.
    :param builtins.str thread_id: Thread ID for which snapshots need to be retrieved. This identifier of a thread is a long positive number generated when a thread is created.
...
def get_trace_snapshot_data_output(apm_domain_id: Optional[pulumi.Input[builtins.str]] = None,
                                   is_summarized: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                   snapshot_time: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                   thread_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                   trace_key: Optional[pulumi.Input[builtins.str]] = None,
