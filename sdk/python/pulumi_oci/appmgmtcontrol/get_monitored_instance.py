...
class GetMonitoredInstanceResult:
    ...
    def monitored_instance_id(self) -> builtins.str:
...
def get_monitored_instance(monitored_instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str monitored_instance_id: OCID of monitored instance.
    """
    __args__ = dict()
...
def get_monitored_instance_output(monitored_instance_id: Optional[pulumi.Input[builtins.str]] = None,
