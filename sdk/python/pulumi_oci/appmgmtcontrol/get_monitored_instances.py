...
def get_monitored_instances(compartment_id: Optional[builtins.str] = None,
...
def get_monitored_instances_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
