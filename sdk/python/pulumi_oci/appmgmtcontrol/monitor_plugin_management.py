...
class MonitorPluginManagementArgs:
    def __init__(__self__, *,
                 monitored_instance_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a MonitorPluginManagement resource.
        :param pulumi.Input[builtins.str] monitored_instance_id: OCID of monitored instance.
    ...
    def monitored_instance_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def monitored_instance_id(self, value: pulumi.Input[builtins.str]):
...
class _MonitorPluginManagementState:
    def __init__(__self__, *,
                 ...
                 monitored_instance_description: Optional[pulumi.Input[builtins.str]] = None,
                 monitored_instance_display_name: Optional[pulumi.Input[builtins.str]] = None,
                 monitored_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 monitored_instance_management_agent_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def monitored_instance_description(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "monitored_instance_description")

    @monitored_instance_description.setter
    def monitored_instance_description(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "monitored_instance_description", value)

    @property
    @pulumi.getter(name="monitoredInstanceDisplayName")
    def monitored_instance_display_name(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "monitored_instance_display_name")

    @monitored_instance_display_name.setter
    def monitored_instance_display_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "monitored_instance_display_name", value)

    @property
    @pulumi.getter(name="monitoredInstanceId")
    def monitored_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        OCID of monitored instance.
    ...
    @monitored_instance_id.setter
    def monitored_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "monitored_instance_id", value)

    @property
    @pulumi.getter(name="monitoredInstanceManagementAgentId")
    def monitored_instance_management_agent_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "monitored_instance_management_agent_id")

    @monitored_instance_management_agent_id.setter
    def monitored_instance_management_agent_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MonitorPluginManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            monitored_instance_id: Optional[pulumi.Input[builtins.str]] = None,
            monitored_instance_management_agent_id: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None) -> 'MonitorPluginManagement':
        """
    ...
    @property
    @pulumi.getter(name="monitoredInstanceDescription")
    def monitored_instance_description(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "monitored_instance_description")

    @property
    @pulumi.getter(name="monitoredInstanceDisplayName")
    def monitored_instance_display_name(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "monitored_instance_display_name")

    @property
    @pulumi.getter(name="monitoredInstanceId")
    def monitored_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        OCID of monitored instance.
    ...
    @property
    @pulumi.getter(name="monitoredInstanceManagementAgentId")
    def monitored_instance_management_agent_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "monitored_instance_management_agent_id")
