...
class ContainerRepositoryArgs:
    def __init__(__self__, *,
                 ...
                 is_immutable: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which to create the resource.
        :param pulumi.Input[builtins.str] display_name: The container repository name.
        ...
        :param pulumi.Input[builtins.bool] is_immutable: (Updatable) Whether the repository is immutable. Images cannot be overwritten in an immutable repository.
        :param pulumi.Input[builtins.bool] is_public: (Updatable) Whether the repository is public. A public repository allows unauthenticated access.
    ...
    def is_immutable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_immutable.setter
    def is_immutable(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ContainerRepositoryState:
    def __init__(__self__, *,
                 ...
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 image_count: Optional[pulumi.Input[builtins.int]] = None,
                 is_immutable: Optional[pulumi.Input[builtins.bool]] = None,
                 is_public: Optional[pulumi.Input[builtins.bool]] = None,
                 layer_count: Optional[pulumi.Input[builtins.int]] = None,
                 layers_size_in_bytes: Optional[pulumi.Input[builtins.str]] = None,
                 namespace: Optional[pulumi.Input[builtins.str]] = None,
                 readme: Optional[pulumi.Input['ContainerRepositoryReadmeArgs']] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 time_created: Optional[pulumi.Input[builtins.str]] = None,
                 time_last_pushed: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering ContainerRepository resources.
        :param pulumi.Input[builtins.str] billable_size_in_gbs: Total storage size in GBs that will be charged.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which to create the resource.
        :param pulumi.Input[builtins.str] created_by: The id of the user or principal that created the resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] display_name: The container repository name.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.int] image_count: Total number of images.
        :param pulumi.Input[builtins.bool] is_immutable: (Updatable) Whether the repository is immutable. Images cannot be overwritten in an immutable repository.
        :param pulumi.Input[builtins.bool] is_public: (Updatable) Whether the repository is public. A public repository allows unauthenticated access.
        :param pulumi.Input[builtins.int] layer_count: Total number of layers.
        :param pulumi.Input[builtins.str] layers_size_in_bytes: Total storage in bytes consumed by layers.
        :param pulumi.Input[builtins.str] namespace: The tenancy namespace used in the container repository path.
        :param pulumi.Input['ContainerRepositoryReadmeArgs'] readme: (Updatable) Container repository readme.
        :param pulumi.Input[builtins.str] state: The current state of the container repository.
        ...
        :param pulumi.Input[builtins.str] time_last_pushed: An RFC 3339 timestamp indicating when an image was last pushed to the repository.
        """
    ...
    def image_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @image_count.setter
    def image_count(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def layer_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @layer_count.setter
    def layer_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "layer_count", value)

    @property
    @pulumi.getter(name="layersSizeInBytes")
    def layers_size_in_bytes(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def layers_size_in_bytes(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_last_pushed(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_last_pushed(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ContainerRepository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_last_pushed: Optional[pulumi.Input[builtins.str]] = None) -> 'ContainerRepository':
        """
    ...
    @property
    @pulumi.getter(name="imageCount")
    def image_count(self) -> pulumi.Output[builtins.int]:
        """
        Total number of images.
        """
        return pulumi.get(self, "image_count")
    ...
    @property
    @pulumi.getter(name="isImmutable")
    def is_immutable(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Whether the repository is immutable. Images cannot be overwritten in an immutable repository.
        """
        return pulumi.get(self, "is_immutable")
    ...
    @property
    @pulumi.getter(name="layerCount")
    def layer_count(self) -> pulumi.Output[builtins.int]:
        """
        Total number of layers.
        """
        return pulumi.get(self, "layer_count")
    ...
    @property
    @pulumi.getter(name="layersSizeInBytes")
    def layers_size_in_bytes(self) -> pulumi.Output[builtins.str]:
        """
        Total storage in bytes consumed by layers.
        """
        return pulumi.get(self, "layers_size_in_bytes")
    ...
    @property
    @pulumi.getter(name="timeLastPushed")
    def time_last_pushed(self) -> pulumi.Output[builtins.str]:
        """
        An RFC 3339 timestamp indicating when an image was last pushed to the repository.
        """
        return pulumi.get(self, "time_last_pushed")
