...
def get_container_image(image_id: Optional[builtins.str] = None,
    ...
    :param builtins.str image_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the container image.  Example: `ocid1.containerimage.oc1..exampleuniqueID`
    """
    __args__ = dict()
...
def get_container_image_output(image_id: Optional[pulumi.Input[builtins.str]] = None,
