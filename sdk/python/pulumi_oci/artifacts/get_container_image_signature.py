...
def get_container_image_signature(image_signature_id: Optional[builtins.str] = None,
    ...
    :param builtins.str image_signature_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the container image signature.  Example: `ocid1.containersignature.oc1..exampleuniqueID`
    """
    __args__ = dict()
...
def get_container_image_signature_output(image_signature_id: Optional[pulumi.Input[builtins.str]] = None,
