...
def get_container_image_signature(image_signature_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str image_signature_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the container image signature.  Example: `ocid1.containersignature.oc1..exampleuniqueID`
    """
    __args__ = dict()
