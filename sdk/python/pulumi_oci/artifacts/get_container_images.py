...
class GetContainerImagesResult:
    ...
    def is_versioned(self) -> Optional[builtins.bool]:
...
def get_container_images(compartment_id: Optional[builtins.str] = None,
                         ...
                         is_versioned: Optional[builtins.bool] = None,
    ...
    :param builtins.bool is_versioned: A filter to return container images based on whether there are any associated versions.
...
def get_container_images_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                ...
                                is_versioned: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
