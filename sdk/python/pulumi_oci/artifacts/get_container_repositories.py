...
def get_container_repositories(compartment_id: Optional[builtins.str] = None,
...
def get_container_repositories_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
