...
def get_container_signatures(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.bool compartment_id_in_subtree: When set to true, the hierarchy of compartments is traversed and all compartments and subcompartments in the tenancy are inspected depending on the the setting of `accessLevel`. Default is false. Can only be set to true when calling the API on the tenancy (root compartment).
    :param builtins.str display_name: A filter to return only resources that match the given display name exactly.
    :param builtins.str image_digest: The digest of the container image.  Example: `sha256:e7d38b3517548a1c71e41bffe9c8ae6d6d29546ce46bf62159837aad072c90aa`
...
def get_container_signatures_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                    ...
                                    image_digest: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    image_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    kms_key_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    kms_key_version_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    repository_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    repository_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    signing_algorithm: Optional[pulumi.Input[Optional[builtins.str]]] = None,
