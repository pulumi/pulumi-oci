...
class GetGenericArtifactsResult:
    ...
    def artifact_path(self) -> Optional[builtins.str]:
        """
...
def get_generic_artifacts(artifact_path: Optional[builtins.str] = None,
...
def get_generic_artifacts_output(artifact_path: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 ...
                                 sha256: Optional[pulumi.Input[Optional[builtins.str]]] = None,
