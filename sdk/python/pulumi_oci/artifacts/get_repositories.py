...
class GetRepositoriesResult:
    ...
    def is_immutable(self) -> Optional[builtins.bool]:
        """
...
def get_repositories_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                            ...
                            is_immutable: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
