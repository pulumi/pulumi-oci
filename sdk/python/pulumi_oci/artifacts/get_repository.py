...
def get_repository(repository_id: Optional[builtins.str] = None,
    ...
    :param builtins.str repository_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the repository.  Example: `ocid1.artifactrepository.oc1..exampleuniqueID`
    """
    __args__ = dict()
...
def get_repository_output(repository_id: Optional[pulumi.Input[builtins.str]] = None,
