...
class RepositoryArgs:
    def __init__(__self__, *,
                 ...
                 is_immutable: pulumi.Input[builtins.bool],
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the repository's compartment.
        :param pulumi.Input[builtins.bool] is_immutable: Whether to make the repository immutable. The artifacts of an immutable repository cannot be overwritten.
        :param pulumi.Input[builtins.str] repository_type: (Updatable) The repository's supported artifact type.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) A short description of the repository. It can be updated later.
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly display name for the repository. If not present, will be auto-generated. It can be modified later. Avoid entering confidential information.
    ...
    def is_immutable(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @is_immutable.setter
    def is_immutable(self, value: pulumi.Input[builtins.bool]):
...
class Repository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            repository_type: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'Repository':
        """
