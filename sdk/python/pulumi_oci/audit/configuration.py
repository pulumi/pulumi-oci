...
class ConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 retention_period_days: pulumi.Input[builtins.int]):
        """
        The set of arguments for constructing a Configuration resource.
        :param pulumi.Input[builtins.str] compartment_id: ID of the root compartment (tenancy)
        :param pulumi.Input[builtins.int] retention_period_days: (Updatable) The retention period setting, specified in days. The minimum is 90, the maximum 365.  Example: `90` 
    ...
    def retention_period_days(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def retention_period_days(self, value: pulumi.Input[builtins.int]):
...
class Configuration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            compartment_id: Optional[pulumi.Input[builtins.str]] = None,
            retention_period_days: Optional[pulumi.Input[builtins.int]] = None) -> 'Configuration':
        """
    ...
    @property
    @pulumi.getter(name="retentionPeriodDays")
    def retention_period_days(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The retention period setting, specified in days. The minimum is 90, the maximum 365.  Example: `90` 
