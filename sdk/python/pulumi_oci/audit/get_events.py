...
def get_events(compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str end_time: Returns events that were processed before this end date and time, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.
    ...
    :param _builtins.str start_time: Returns events that were processed at or after this start date and time, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.
