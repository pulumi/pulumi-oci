...
def get_events(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str end_time: Returns events that were processed before this end date and time, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.
    ...
    :param builtins.str start_time: Returns events that were processed at or after this start date and time, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.
...
def get_events_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
