...
class GetEventsAuditEventResult(dict):
    def __init__(__self__, *,
                 cloud_events_version: builtins.str,
                 content_type: builtins.str,
                 datas: Sequence['outputs.GetEventsAuditEventDataResult'],
                 event_id: builtins.str,
                 event_time: builtins.str,
                 event_type: builtins.str,
                 event_type_version: builtins.str,
                 source: builtins.str):
        """
        :param builtins.str cloud_events_version: The version of the CloudEvents specification. The structure of the envelope follows the  [CloudEvents](https://github.com/cloudevents/spec) industry standard format hosted by the [Cloud Native Computing Foundation ( CNCF)](https://www.cncf.io/).
        :param builtins.str content_type: The content type of the data contained in `data`.  Example: `application/json`
        ...
        :param builtins.str event_id: The GUID of the event.
        :param builtins.str event_time: The time the event occurred, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.  Example: `2019-09-18T00:10:59.252Z`
        :param builtins.str event_type: The type of event that happened.
        :param builtins.str event_type_version: The version of the event type. This version applies to the payload of the event, not the envelope. Use `cloudEventsVersion` to determine the version of the envelope.  Example: `2.0`
        :param builtins.str source: The source of the event.  Example: `ComputeApi`
        """
    ...
    def cloud_events_version(self) -> builtins.str:
        """
    ...
    def event_type_version(self) -> builtins.str:
        """
...
class GetEventsAuditEventDataResult(dict):
    def __init__(__self__, *,
                 additional_details: Mapping[str, builtins.str],
                 availability_domain: builtins.str,
                 compartment_id: builtins.str,
                 compartment_name: builtins.str,
                 defined_tags: Mapping[str, builtins.str],
                 event_grouping_id: builtins.str,
        ...
        """
        :param Mapping[str, builtins.str] additional_details: A container object for attribues unique to the resource emitting the event.
        :param builtins.str availability_domain: The availability domain where the resource resides.
        ...
        :param builtins.str compartment_name: The name of the compartment. This value is the friendly name associated with compartmentId. This value can change, but the service logs the value that appeared at the time of the audit event.  Example: `CompartmentA`
        ...
        :param builtins.str event_grouping_id: This value links multiple audit events that are part of the same API operation. For example,  a long running API operations that emit an event at the start and the end of an operation would use the same value in this field for both events.
        :param builtins.str event_name: Name of the API operation that generated this event.  Example: `GetInstance`
        :param Mapping[str, builtins.str] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name,  type, or namespace. Exists for cross-compatibility only. For more information,  see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        ...
        :param builtins.str resource_id: An [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) or some other ID for the resource emitting the event.
        :param builtins.str resource_name: The name of the resource emitting the event.
    ...
    def event_grouping_id(self) -> builtins.str:
        """
...
class GetEventsAuditEventDataIdentityResult(dict):
    def __init__(__self__, *,
                 ...
                 caller_name: builtins.str,
                 console_session_id: builtins.str,
        ...
        """
        :param builtins.str auth_type: The type of authentication used.  Example: `natv`
        :param builtins.str caller_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the caller. The caller that made a  request on behalf of the prinicpal.
        :param builtins.str caller_name: The name of the user or service. This value is the friendly name associated with `callerId`.
        :param builtins.str console_session_id: This value identifies any Console session associated with this request.
        :param builtins.str credentials: The credential ID of the user. This value is extracted from the HTTP 'Authorization' request header. It consists of the tenantId, userId, and user fingerprint, all delimited by a slash (/).
        :param builtins.str ip_address: The IP address of the source of the request.  Example: `172.24.80.88`
        :param builtins.str principal_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the principal.
        :param builtins.str principal_name: The name of the user or service. This value is the friendly name associated with `principalId`.  Example: `ExampleName`
        :param builtins.str tenant_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the tenant.
        :param builtins.str user_agent: The user agent of the client that made the request.  Example: `Jersey/2.23 (HttpUrlConnection 1.8.0_212)`
        """
    ...
    def caller_id(self) -> builtins.str:
        """
    ...
    def caller_name(self) -> builtins.str:
        """
    ...
    def console_session_id(self) -> builtins.str:
        """
...
class GetEventsAuditEventDataRequestResult(dict):
    def __init__(__self__, *,
                 ...
                 path: builtins.str):
        """
        :param builtins.str action: The HTTP method of the request.  Example: `GET`
        :param Mapping[str, builtins.str] headers: The headers of the response.
        :param builtins.str id: The opc-request-id of the request.
        :param Mapping[str, builtins.str] parameters: The parameters supplied by the caller during this operation.
        :param builtins.str path: The full path of the API request.  Example: `/20160918/instances/ocid1.instance.oc1.phx.<unique_ID>`
        """
...
class GetEventsAuditEventDataResponseResult(dict):
    def __init__(__self__, *,
                 ...
                 payload: Mapping[str, builtins.str],
                 response_time: builtins.str,
                 status: builtins.str):
        """
        :param Mapping[str, builtins.str] headers: The headers of the response.
        :param builtins.str message: A friendly description of what happened during the operation. Use this for troubleshooting.
        :param Mapping[str, builtins.str] payload: This value is included for backward compatibility with the Audit version 1 schema, where  it contained metadata of interest from the response payload.
        :param builtins.str response_time: The time of the response to the audited request, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.  Example: `2019-09-18T00:10:59.278Z`
        :param builtins.str status: The status code of the response.  Example: `200`
        """
        pulumi.set(__self__, "headers", headers)
    ...
    @property
    @pulumi.getter
    def payload(self) -> Mapping[str, builtins.str]:
        """
...
class GetEventsAuditEventDataStateChangeResult(dict):
    def __init__(__self__, *,
                 current: Mapping[str, builtins.str],
                 previous: Mapping[str, builtins.str]):
        """
        :param Mapping[str, builtins.str] current: Provides the current state of fields that may have changed during an operation. To determine how the current operation changed a resource, compare the information in this attribute to  `previous`.
        :param Mapping[str, builtins.str] previous: Provides the previous state of fields that may have changed during an operation. To determine how the current operation changed a resource, compare the information in this attribute to  `current`.
        """
    ...
    @property
    @pulumi.getter
    def current(self) -> Mapping[str, builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def previous(self) -> Mapping[str, builtins.str]:
        """
