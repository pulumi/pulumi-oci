...
class AutoScalingConfigurationAutoScalingResourcesArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the resource that is managed by the autoscaling configuration.
        :param pulumi.Input[builtins.str] type: The type of resource.
        """
...
class AutoScalingConfigurationPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] policy_type: The type of autoscaling policy.
        ...
        :param pulumi.Input[builtins.str] id: ID of the condition that is assigned after creation.
        :param pulumi.Input[builtins.bool] is_enabled: Whether the autoscaling policy is enabled.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the autoscaling configuration was created, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
        """
...
class AutoScalingConfigurationPolicyCapacityArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] initial: For a threshold-based autoscaling policy, this value is the initial number of instances to launch in the instance pool immediately after autoscaling is enabled. After autoscaling retrieves performance metrics, the number of instances is automatically adjusted from this initial number to a number that is based on the limits that you set.
               
               For a schedule-based autoscaling policy, this value is the target pool size to scale to when executing the schedule that's defined in the autoscaling policy.
        :param pulumi.Input[builtins.int] max: For a threshold-based autoscaling policy, this value is the maximum number of instances the instance pool is allowed to increase to (scale out).
               
               For a schedule-based autoscaling policy, this value is not used.
        :param pulumi.Input[builtins.int] min: For a threshold-based autoscaling policy, this value is the minimum number of instances the instance pool is allowed to decrease to (scale in).
...
class AutoScalingConfigurationPolicyExecutionScheduleArgs:
    def __init__(__self__, *,
                 ...
                 type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] expression: A cron expression that represents the time at which to execute the autoscaling policy.
               ...
               Example: `0 15 10 ? * *`
        :param pulumi.Input[builtins.str] timezone: The time zone for the execution schedule.
        :param pulumi.Input[builtins.str] type: The type of execution schedule.
        """
...
class AutoScalingConfigurationPolicyResourceActionArgs:
    def __init__(__self__, *,
                 ...
                 action_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] action_type: The type of resource action.
        """
...
class AutoScalingConfigurationPolicyRuleActionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: The type of action to take.
        :param pulumi.Input[builtins.int] value: To scale out (increase the number of instances), provide a positive value. To scale in (decrease the number of instances), provide a negative value.
        """
        if type is not None:
            pulumi.set(__self__, "type", type)
...
class AutoScalingConfigurationPolicyRuleMetricThresholdArgs:
    def __init__(__self__, *,
                 ...
                 value: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] operator: The comparison operator to use. Options are greater than (`GT`), greater than or equal to (`GTE`), less than (`LT`), and less than or equal to (`LTE`).
        :param pulumi.Input[builtins.int] value: ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        """
