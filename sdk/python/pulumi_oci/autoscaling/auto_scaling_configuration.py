...
class AutoScalingConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 cool_down_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the autoscaling configuration.
        ...
        :param pulumi.Input[builtins.int] cool_down_in_seconds: (Updatable) For threshold-based autoscaling policies, this value is the minimum period of time to wait between scaling actions. The cooldown period gives the system time to stabilize before rescaling. The minimum value is 300 seconds, which is also the default. The cooldown period starts when the instance pool reaches the running state.
        ...
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) Whether the autoscaling configuration is enabled.
        """
    ...
    def cool_down_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def cool_down_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _AutoScalingConfigurationState:
    def __init__(__self__, *,
                 ...
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 max_resource_count: Optional[pulumi.Input[builtins.int]] = None,
                 min_resource_count: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) Whether the autoscaling configuration is enabled.
        :param pulumi.Input[builtins.int] max_resource_count: The maximum number of resources to scale out to.
        :param pulumi.Input[builtins.int] min_resource_count: The minimum number of resources to scale in to.
        :param pulumi.Input[Sequence[pulumi.Input['AutoScalingConfigurationPolicyArgs']]] policies: Autoscaling policy definitions for the autoscaling configuration. An autoscaling policy defines the criteria that trigger autoscaling actions and the actions to take.
    ...
    def max_resource_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_resource_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_resource_count", value)

    @property
    @pulumi.getter(name="minResourceCount")
    def min_resource_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def min_resource_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class AutoScalingConfiguration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            min_resource_count: Optional[pulumi.Input[builtins.int]] = None,
            policies: Optional[pulumi.Input[Sequence[pulumi.Input[Union['AutoScalingConfigurationPolicyArgs', 'AutoScalingConfigurationPolicyArgsDict']]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'AutoScalingConfiguration':
        """
    ...
    @property
    @pulumi.getter(name="coolDownInSeconds")
    def cool_down_in_seconds(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) For threshold-based autoscaling policies, this value is the minimum period of time to wait between scaling actions. The cooldown period gives the system time to stabilize before rescaling. The minimum value is 300 seconds, which is also the default. The cooldown period starts when the instance pool reaches the running state.
    ...
    @property
    @pulumi.getter(name="maxResourceCount")
    def max_resource_count(self) -> pulumi.Output[builtins.int]:
        """
        The maximum number of resources to scale out to.
        """
        return pulumi.get(self, "max_resource_count")
    ...
    @property
    @pulumi.getter(name="minResourceCount")
    def min_resource_count(self) -> pulumi.Output[builtins.int]:
        """
        The minimum number of resources to scale in to.
        """
        return pulumi.get(self, "min_resource_count")
