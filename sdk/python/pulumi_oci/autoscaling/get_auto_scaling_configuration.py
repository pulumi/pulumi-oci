...
def get_auto_scaling_configuration(auto_scaling_configuration_id: Optional[builtins.str] = None,
    ...
    :param builtins.str auto_scaling_configuration_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the autoscaling configuration.
    """
    __args__ = dict()
