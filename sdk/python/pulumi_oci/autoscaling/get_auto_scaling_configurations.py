...
def get_auto_scaling_configurations(compartment_id: Optional[builtins.str] = None,
...
def get_auto_scaling_configurations_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
