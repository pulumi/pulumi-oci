...
class BastionArgs:
    def __init__(__self__, *,
                 bastion_type: pulumi.Input[builtins.str],
                 compartment_id: pulumi.Input[builtins.str],
                 target_subnet_id: pulumi.Input[builtins.str],
                 client_cidr_block_allow_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 dns_proxy_status: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 max_session_ttl_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 phone_book_entry: Optional[pulumi.Input[builtins.str]] = None,
                 static_jump_host_ip_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Bastion resource.
        :param pulumi.Input[builtins.str] bastion_type: The type of bastion. Use `standard`.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The unique identifier (OCID) of the compartment where the bastion is located.
        :param pulumi.Input[builtins.str] target_subnet_id: The unique identifier (OCID) of the subnet that the bastion connects to.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] client_cidr_block_allow_lists: (Updatable) A list of address ranges in CIDR notation that you want to allow to connect to sessions hosted by this bastion.
        ...
        :param pulumi.Input[builtins.str] dns_proxy_status: Flag to enable FQDN and SOCKS5 Proxy Support. Example: `ENABLED`, `DISABLED`
        ...
        :param pulumi.Input[builtins.int] max_session_ttl_in_seconds: (Updatable) The maximum amount of time that any session on the bastion can remain active.
        :param pulumi.Input[builtins.str] name: The name of the bastion, which can't be changed after creation.
        :param pulumi.Input[builtins.str] phone_book_entry: The phonebook entry of the customer's team, which can't be changed after creation. Not applicable to `standard` bastions.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] static_jump_host_ip_addresses: (Updatable) A list of IP addresses of the hosts that the bastion has access to. Not applicable to `standard` bastions.
        """
    ...
    def bastion_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @bastion_type.setter
    def bastion_type(self, value: pulumi.Input[builtins.str]):
    ...
    def target_subnet_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_subnet_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "target_subnet_id", value)

    @property
    @pulumi.getter(name="clientCidrBlockAllowLists")
    def client_cidr_block_allow_lists(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def client_cidr_block_allow_lists(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def dns_proxy_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dns_proxy_status(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def max_session_ttl_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_session_ttl_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def phone_book_entry(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def phone_book_entry(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "phone_book_entry", value)

    @property
    @pulumi.getter(name="staticJumpHostIpAddresses")
    def static_jump_host_ip_addresses(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def static_jump_host_ip_addresses(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _BastionState:
    def __init__(__self__, *,
                 bastion_type: Optional[pulumi.Input[builtins.str]] = None,
                 client_cidr_block_allow_lists: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 max_session_ttl_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 max_sessions_allowed: Optional[pulumi.Input[builtins.int]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 phone_book_entry: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 target_subnet_id: Optional[pulumi.Input[builtins.str]] = None,
                 target_vcn_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] max_session_ttl_in_seconds: (Updatable) The maximum amount of time that any session on the bastion can remain active.
        :param pulumi.Input[builtins.int] max_sessions_allowed: The maximum number of active sessions allowed on the bastion.
        :param pulumi.Input[builtins.str] name: The name of the bastion, which can't be changed after creation.
        :param pulumi.Input[builtins.str] phone_book_entry: The phonebook entry of the customer's team, which can't be changed after creation. Not applicable to `standard` bastions.
        :param pulumi.Input[builtins.str] private_endpoint_ip_address: The private IP address of the created private endpoint.
        :param pulumi.Input[builtins.str] state: The current state of the bastion.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] static_jump_host_ip_addresses: (Updatable) A list of IP addresses of the hosts that the bastion has access to. Not applicable to `standard` bastions.
        ...
        :param pulumi.Input[builtins.str] target_subnet_id: The unique identifier (OCID) of the subnet that the bastion connects to.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] target_vcn_id: The unique identifier (OCID) of the virtual cloud network (VCN) that the bastion connects to.
        :param pulumi.Input[builtins.str] time_created: The time the bastion was created. Format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339). Example: `2020-01-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_updated: The time the bastion was updated. Format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339). Example: `2020-01-25T21:10:29.600Z`
        """
    ...
    @property
    @pulumi.getter(name="bastionType")
    def bastion_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of bastion. Use `standard`.
        """
        return pulumi.get(self, "bastion_type")
    ...
    @bastion_type.setter
    def bastion_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bastion_type", value)
    ...
    def max_sessions_allowed(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_sessions_allowed(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    @property
    @pulumi.getter(name="targetSubnetId")
    def target_subnet_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The unique identifier (OCID) of the subnet that the bastion connects to.
    ...
    @target_subnet_id.setter
    def target_subnet_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_subnet_id", value)

    @property
    @pulumi.getter(name="targetVcnId")
    def target_vcn_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def target_vcn_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Bastion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target_vcn_id: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'Bastion':
        """
    ...
    @property
    @pulumi.getter(name="bastionType")
    def bastion_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of bastion. Use `standard`.
        """
        return pulumi.get(self, "bastion_type")
    ...
    @property
    @pulumi.getter(name="clientCidrBlockAllowLists")
    def client_cidr_block_allow_lists(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) A list of address ranges in CIDR notation that you want to allow to connect to sessions hosted by this bastion.
        """
        return pulumi.get(self, "client_cidr_block_allow_lists")
    ...
    @property
    @pulumi.getter(name="dnsProxyStatus")
    def dns_proxy_status(self) -> pulumi.Output[builtins.str]:
        """
        Flag to enable FQDN and SOCKS5 Proxy Support. Example: `ENABLED`, `DISABLED`
        """
        return pulumi.get(self, "dns_proxy_status")
    ...
    @property
    @pulumi.getter(name="maxSessionTtlInSeconds")
    def max_session_ttl_in_seconds(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The maximum amount of time that any session on the bastion can remain active.
        """
        return pulumi.get(self, "max_session_ttl_in_seconds")
    ...
    @property
    @pulumi.getter(name="maxSessionsAllowed")
    def max_sessions_allowed(self) -> pulumi.Output[builtins.int]:
        """
        The maximum number of active sessions allowed on the bastion.
        """
        return pulumi.get(self, "max_sessions_allowed")
    ...
    @property
    @pulumi.getter(name="phoneBookEntry")
    def phone_book_entry(self) -> pulumi.Output[builtins.str]:
        """
        The phonebook entry of the customer's team, which can't be changed after creation. Not applicable to `standard` bastions.
        """
        return pulumi.get(self, "phone_book_entry")
    ...
    @property
    @pulumi.getter(name="privateEndpointIpAddress")
    def private_endpoint_ip_address(self) -> pulumi.Output[builtins.str]:
        """
        The private IP address of the created private endpoint.
        """
        return pulumi.get(self, "private_endpoint_ip_address")
    ...
    @property
    @pulumi.getter(name="staticJumpHostIpAddresses")
    def static_jump_host_ip_addresses(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) A list of IP addresses of the hosts that the bastion has access to. Not applicable to `standard` bastions.
        """
        return pulumi.get(self, "static_jump_host_ip_addresses")
    ...
    @property
    @pulumi.getter(name="targetSubnetId")
    def target_subnet_id(self) -> pulumi.Output[builtins.str]:
        """
        The unique identifier (OCID) of the subnet that the bastion connects to.
    ...
    @property
    @pulumi.getter(name="targetVcnId")
    def target_vcn_id(self) -> pulumi.Output[builtins.str]:
        """
        The unique identifier (OCID) of the virtual cloud network (VCN) that the bastion connects to.
        """
        return pulumi.get(self, "target_vcn_id")
