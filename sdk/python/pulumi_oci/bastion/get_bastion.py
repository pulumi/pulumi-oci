...
def get_bastion(bastion_id: Optional[str] = None,
    ...
    return AwaitableGetBastionResult(
        ...
        bastion_type=__ret__.bastion_type,
        ...
        max_session_ttl_in_seconds=__ret__.max_session_ttl_in_seconds,
        max_sessions_allowed=__ret__.max_sessions_allowed,
        name=__ret__.name,
        phone_book_entry=__ret__.phone_book_entry,
        private_endpoint_ip_address=__ret__.private_endpoint_ip_address,
        state=__ret__.state,
        static_jump_host_ip_addresses=__ret__.static_jump_host_ip_addresses,
        system_tags=__ret__.system_tags,
        target_subnet_id=__ret__.target_subnet_id,
        target_vcn_id=__ret__.target_vcn_id,
