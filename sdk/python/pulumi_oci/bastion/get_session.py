...
def get_session(session_id: Optional[builtins.str] = None,
    ...
    :param builtins.str session_id: The unique identifier (OCID) of the session.
    """
    __args__ = dict()
...
def get_session_output(session_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Bastion/getSession:getSession', __args__, opts=opts, typ=GetSessionResult)
    return __ret__.apply(lambda __response__: GetSessionResult(
        bastion_id=pulumi.get(__response__, 'bastion_id'),
        bastion_name=pulumi.get(__response__, 'bastion_name'),
        bastion_public_host_key_info=pulumi.get(__response__, 'bastion_public_host_key_info'),
        bastion_user_name=pulumi.get(__response__, 'bastion_user_name'),
        ...
        session_ttl_in_seconds=pulumi.get(__response__, 'session_ttl_in_seconds'),
        ssh_metadata=pulumi.get(__response__, 'ssh_metadata'),
        state=pulumi.get(__response__, 'state'),
        target_resource_details=pulumi.get(__response__, 'target_resource_details'),
