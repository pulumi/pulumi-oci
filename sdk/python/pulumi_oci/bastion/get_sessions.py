...
class GetSessionsResult:
    ...
    def session_lifecycle_state(self) -> Optional[builtins.str]:
...
def get_sessions(bastion_id: Optional[builtins.str] = None,
                 ...
                 session_lifecycle_state: Optional[builtins.str] = None,
    ...
    :param builtins.str session_id: The unique identifier (OCID) of the session in which to list resources.
    :param builtins.str session_lifecycle_state: A filter to return only resources their lifecycleState matches the given lifecycleState.
    """
    __args__ = dict()
...
def get_sessions_output(bastion_id: Optional[pulumi.Input[builtins.str]] = None,
                        display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        filters: Optional[pulumi.Input[Optional[Sequence[Union['GetSessionsFilterArgs', 'GetSessionsFilterArgsDict']]]]] = None,
                        session_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        session_lifecycle_state: Optional[pulumi.Input[Optional[builtins.str]]] = None,
