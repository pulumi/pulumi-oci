...
class SessionArgs:
    def __init__(__self__, *,
                 bastion_id: pulumi.Input[builtins.str],
                 ...
                 session_ttl_in_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Session resource.
        :param pulumi.Input[builtins.str] bastion_id: The unique identifier (OCID) of the bastion on which to create this session.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The name of the session.
        :param pulumi.Input[builtins.str] key_type: The type of the key used to connect to the session. PUB is a standard public key in OpenSSH format.
        :param pulumi.Input[builtins.int] session_ttl_in_seconds: The amount of time the session can remain active.
        """
    ...
    def bastion_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @bastion_id.setter
    def bastion_id(self, value: pulumi.Input[builtins.str]):
    ...
    def session_ttl_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def session_ttl_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _SessionState:
    def __init__(__self__, *,
                 bastion_id: Optional[pulumi.Input[builtins.str]] = None,
                 bastion_name: Optional[pulumi.Input[builtins.str]] = None,
                 bastion_public_host_key_info: Optional[pulumi.Input[builtins.str]] = None,
                 bastion_user_name: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 key_details: Optional[pulumi.Input['SessionKeyDetailsArgs']] = None,
                 key_type: Optional[pulumi.Input[builtins.str]] = None,
                 lifecycle_details: Optional[pulumi.Input[builtins.str]] = None,
                 session_ttl_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 ssh_metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] bastion_id: The unique identifier (OCID) of the bastion on which to create this session.
        :param pulumi.Input[builtins.str] bastion_name: The name of the bastion that is hosting this session.
        :param pulumi.Input[builtins.str] bastion_public_host_key_info: The public key of the bastion host. You can use this to verify that you're connecting to the correct bastion.
        :param pulumi.Input[builtins.str] bastion_user_name: The username that the session uses to connect to the target resource.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The name of the session.
        :param pulumi.Input['SessionKeyDetailsArgs'] key_details: Public key details for a bastion session.
        :param pulumi.Input[builtins.str] key_type: The type of the key used to connect to the session. PUB is a standard public key in OpenSSH format.
        :param pulumi.Input[builtins.str] lifecycle_details: A message describing the current session state in more detail.
        :param pulumi.Input[builtins.int] session_ttl_in_seconds: The amount of time the session can remain active.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] ssh_metadata: The connection message for the session.
        :param pulumi.Input[builtins.str] state: The current state of the session.
        :param pulumi.Input['SessionTargetResourceDetailsArgs'] target_resource_details: Details about a bastion session's target resource.
        :param pulumi.Input[builtins.str] time_created: The time the session was created. Format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339). Example: `2020-01-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_updated: The time the session was updated. Format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339). Example: `2020-01-25T21:10:29.600Z`
        """
    ...
    @property
    @pulumi.getter(name="bastionId")
    def bastion_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The unique identifier (OCID) of the bastion on which to create this session.
        """
        return pulumi.get(self, "bastion_id")
    ...
    @bastion_id.setter
    def bastion_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bastion_id", value)

    @property
    @pulumi.getter(name="bastionName")
    def bastion_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @bastion_name.setter
    def bastion_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bastion_name", value)

    @property
    @pulumi.getter(name="bastionPublicHostKeyInfo")
    def bastion_public_host_key_info(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def bastion_public_host_key_info(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bastion_public_host_key_info", value)

    @property
    @pulumi.getter(name="bastionUserName")
    def bastion_user_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def bastion_user_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ssh_metadata(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    @ssh_metadata.setter
    def ssh_metadata(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class Session(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target_resource_details: Optional[pulumi.Input[Union['SessionTargetResourceDetailsArgs', 'SessionTargetResourceDetailsArgsDict']]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'Session':
        """
    ...
    @property
    @pulumi.getter(name="bastionId")
    def bastion_id(self) -> pulumi.Output[builtins.str]:
        """
        The unique identifier (OCID) of the bastion on which to create this session.
        """
        return pulumi.get(self, "bastion_id")
    ...
    @property
    @pulumi.getter(name="bastionName")
    def bastion_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the bastion that is hosting this session.
        """
        return pulumi.get(self, "bastion_name")
    ...
    @property
    @pulumi.getter(name="bastionPublicHostKeyInfo")
    def bastion_public_host_key_info(self) -> pulumi.Output[builtins.str]:
        """
        The public key of the bastion host. You can use this to verify that you're connecting to the correct bastion.
        """
        return pulumi.get(self, "bastion_public_host_key_info")
    ...
    @property
    @pulumi.getter(name="bastionUserName")
    def bastion_user_name(self) -> pulumi.Output[builtins.str]:
        """
        The username that the session uses to connect to the target resource.
        """
        return pulumi.get(self, "bastion_user_name")
    ...
    @property
    @pulumi.getter(name="sessionTtlInSeconds")
    def session_ttl_in_seconds(self) -> pulumi.Output[builtins.int]:
        """
        The amount of time the session can remain active.
        """
        return pulumi.get(self, "session_ttl_in_seconds")
    ...
    @property
    @pulumi.getter(name="sshMetadata")
    def ssh_metadata(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        The connection message for the session.
        """
        return pulumi.get(self, "ssh_metadata")
