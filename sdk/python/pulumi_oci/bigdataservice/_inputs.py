...
class AutoScalingConfigurationPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] policy_type: (Updatable) Types of autoscale policies. Options are SCHEDULE-BASED or THRESHOLD-BASED. (Only THRESHOLD-BASED is supported in this release.)
...
class AutoScalingConfigurationPolicyDetailsScaleDownConfigMetricThresholdArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] value: (Updatable) Integer non-negative value. 0 < value < 100
        """
...
class AutoScalingConfigurationPolicyDetailsScaleInConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] step_size: (Updatable) This value is the number of nodes to remove during a scale-in event.
        """
        if metric is not None:
            pulumi.set(__self__, "metric", metric)
...
class AutoScalingConfigurationPolicyDetailsScaleOutConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] step_size: (Updatable) This value is the number of nodes to add during a scale-out event.
        """
...
class AutoScalingConfigurationPolicyDetailsScheduleDetailTimeAndVerticalScalingConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] target_shape: (Updatable) For nodes with [fixed compute shapes](https://docs.cloud.oracle.com/iaas/Content/bigdata/create-cluster.htm#cluster-plan-shape), this value is the desired shape of each node. This value is not used for nodes with flexible compute shapes.
        :param pulumi.Input[_builtins.str] time_recurrence: (Updatable) Day/time recurrence (specified following RFC 5545) at which to trigger autoscaling action. Currently only WEEKLY frequency is supported. Days of the week are specified using BYDAY field. Time of the day is specified using BYHOUR and BYMINUTE fields. Other fields are not supported.
        """
...
class AutoScalingConfigurationPolicyRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] action: (Updatable) The valid value are CHANGE_SHAPE_SCALE_UP or CHANGE_SHAPE_SCALE_DOWN.
...
class BdsCapacityReportShapeAvailabilityDomainLevelCapacityReportArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] domain_type: Type of domain level for the capacity report.
        :param pulumi.Input[_builtins.str] fault_domain: The fault domain for the capacity report.
        """
...
class BdsInstanceClusterDetailArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] bda_version: BDA version installed in the cluster
        :param pulumi.Input[_builtins.str] bdm_version: Big Data Manager version installed in the cluster.
        :param pulumi.Input[_builtins.str] bds_version: Big Data Service version installed in the cluster.
        :param pulumi.Input[_builtins.str] big_data_manager_url: The URL of Big Data Manager.
        :param pulumi.Input[_builtins.str] cloudera_manager_url: The URL of Cloudera Manager
        :param pulumi.Input[_builtins.str] csql_cell_version: Big Data SQL version.
        :param pulumi.Input[_builtins.str] db_version: Cloud SQL query server database version.
        :param pulumi.Input[_builtins.str] hue_server_url: The URL of the Hue server.
...
class BdsInstanceComputeOnlyWorkerNodeArgs:
    ...
    def number_of_nodes(self, value: pulumi.Input[_builtins.int]):
...
class BdsInstanceIdentityConfigurationUpstConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] time_updated: Time when this UPST config was updated, shown as an RFC 3339 formatted datetime string.
        :param pulumi.Input[_builtins.str] token_exchange_principal_name: Token exchange kerberos Principal name in cluster
        :param pulumi.Input[_builtins.str] vault_id: The instance OCID of the node, which is the resource from which the node backup was acquired.
        """
...
class BdsInstanceKafkaBrokerNodeArgs:
    ...
    def number_of_kafka_nodes(self) -> pulumi.Input[_builtins.int]:
        return pulumi.get(self, "number_of_kafka_nodes")

    @number_of_kafka_nodes.setter
    def number_of_kafka_nodes(self, value: pulumi.Input[_builtins.int]):
...
class BdsInstanceNodeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] memory_in_gbs: The total amount of memory available to the node, in gigabytes.
        :param pulumi.Input[_builtins.str] node_type: The Big Data Service cluster node type.
        :param pulumi.Input[_builtins.int] nvmes: The number of NVMe drives to be used for storage. A single drive has 6.8 TB available.
        :param pulumi.Input[_builtins.int] ocpus: The total number of OCPUs available to the node.
        :param pulumi.Input[_builtins.str] odh_version: Version of the ODH (Oracle Distribution including Apache Hadoop) for the node.
        :param pulumi.Input[_builtins.str] os_version: BDS-assigned Operating System version for the node.
...
class BdsInstanceNodeBackupConfigurationLevelTypeDetailsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] node_type: (Updatable) Type of the node or nodes of the node backup configuration or node replacement configuration which are going to be created. Accepted values are MASTER and UTILITY.
        """
    ...
    def level_type(self) -> pulumi.Input[_builtins.str]:
        """
        (Updatable) Type of level used to trigger the creation of a new node backup configuration or node replacement configuration.
        """
    ...
    @level_type.setter
    def level_type(self, value: pulumi.Input[_builtins.str]):
...
class BdsInstanceNodeReplaceConfigurationLevelTypeDetailsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] node_host_name: (Updatable) Host name of the node to create backup configuration.
        :param pulumi.Input[_builtins.str] node_type: (Updatable) Type of the node or nodes of the node backup configuration or node replacement configuration which are going to be created.
        """
        pulumi.set(__self__, "level_type", level_type)
        if node_host_name is not None:
            pulumi.set(__self__, "node_host_name", node_host_name)
...
class BdsInstanceOperationCertificateManagementsManagementHostCertDetailArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] private_key: Private key of the provided certificate
        """
...
class BdsInstanceOsPatchActionPatchingConfigsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] tolerance_threshold_per_batch: Acceptable number of failed-to-be-patched nodes in each batch. The maximum number of failed-to-patch nodes cannot exceed 20% of the number of nodes.
        :param pulumi.Input[_builtins.int] tolerance_threshold_per_domain: Acceptable number of failed-to-be-patched nodes in each domain. The maximum number of failed-to-patch nodes cannot exceed 20% of the number of nodes.
        :param pulumi.Input[_builtins.int] wait_time_between_batch_in_seconds: The wait time between batches in seconds.
        :param pulumi.Input[_builtins.int] wait_time_between_domain_in_seconds: The wait time between AD/FD in seconds.
        """
    ...
    def patching_config_strategy(self) -> pulumi.Input[_builtins.str]:
        """
        Type of strategy used for detailed patching configuration
        """
    ...
    def patching_config_strategy(self, value: pulumi.Input[_builtins.str]):
...
class BdsInstancePatchActionPatchingConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] patching_config_strategy: Type of strategy used for detailed patching configuration
        :param pulumi.Input[_builtins.int] batch_size: How many nodes to be patched in each iteration.
        :param pulumi.Input[_builtins.int] tolerance_threshold_per_batch: Acceptable number of failed-to-be-patched nodes in each batch. The maximum number of failed-to-patch nodes cannot exceed 20% of the number of non-utility and non-master nodes.
        :param pulumi.Input[_builtins.int] tolerance_threshold_per_domain: Acceptable number of failed-to-be-patched nodes in each domain. The maximum number of failed-to-patch nodes cannot exceed 20% of the number of non-utility and non-master nodes.
        :param pulumi.Input[_builtins.int] wait_time_between_batch_in_seconds: The wait time between batches in seconds.
        :param pulumi.Input[_builtins.int] wait_time_between_domain_in_seconds: The wait time between AD/FD in seconds.
        """
        pulumi.set(__self__, "patching_config_strategy", patching_config_strategy)
