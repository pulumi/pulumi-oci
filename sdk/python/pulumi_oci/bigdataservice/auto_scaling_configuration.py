...
class AutoScalingConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cluster_admin_password: (Updatable) Base-64 encoded password for the cluster (and Cloudera Manager) admin user.
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) Whether the autoscale configuration is enabled.
        :param pulumi.Input[builtins.str] node_type: A node type that is managed by an autoscale configuration. The only supported types are WORKER, COMPUTE_ONLY_WORKER and KAFKA_BROKER.
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name. The name does not have to be unique, and it may be changed. Avoid entering confidential information.
    ...
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AutoScalingConfigurationPolicyDetailsArgs'] policy_details: (Updatable) Policy definition for the autoscale configuration.
               ...
               * **ScheduleBasedHorizontalScalingPolicy:** Horizontal autoscaling action is triggered at the specific times that you schedule.
               ...
               An autoscaling configuration can have one of above supported policies.
        :param pulumi.Input[builtins.str] state: The state of the autoscale configuration.
        :param pulumi.Input[builtins.str] time_created: The time the cluster was created, shown as an RFC 3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The time the autoscale configuration was updated, shown as an RFC 3339 formatted datetime string.
        """
...
@pulumi.type_token("oci:BigDataService/autoScalingConfiguration:AutoScalingConfiguration")
class AutoScalingConfiguration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'AutoScalingConfiguration':
        """
