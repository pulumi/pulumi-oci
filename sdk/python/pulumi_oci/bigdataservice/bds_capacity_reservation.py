...
__all__ = ['BdsCapacityReservationArgs', 'BdsCapacityReservation']

@pulumi.input_type
class BdsCapacityReservationArgs:
    def __init__(__self__, *,
                 compartment_id: pulumi.Input[_builtins.str],
                 compute_capacity_reservations: pulumi.Input['BdsCapacityReservationComputeCapacityReservationsArgs'],
    ...
    def compute_capacity_reservations(self) -> pulumi.Input['BdsCapacityReservationComputeCapacityReservationsArgs']:
        """
        (Updatable) Compute capacity reservation ID mappings by domain. For a multi-AD region, domain1, domain2, and domain3 correspond to AD1, AD2, and AD3 respectively. For a single-AD region, domain1, domain2, and domain3 correspond to FD1, FD2, and FD3 respectively.
        """
    ...
    def compute_capacity_reservations(self, value: pulumi.Input['BdsCapacityReservationComputeCapacityReservationsArgs']):
        pulumi.set(self, "compute_capacity_reservations", value)
...
@pulumi.input_type
class _BdsCapacityReservationState:
    def __init__(__self__, *,
                 compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                 compute_capacity_reservations: pulumi.Input[Optional['BdsCapacityReservationComputeCapacityReservationsArgs']] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type, or scope. Exists for cross-compatibility only. For example, `{"bar-key": "value"}`
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] state: The lifecycle state of the BDS capacity reservation.
        ...
        :param pulumi.Input[_builtins.str] time_created: The time the BDS capacity reservation was created, shown as an RFC 3339 formatted datetime string.
        :param pulumi.Input[_builtins.str] time_updated: The time the BDS capacity reservation was updated, shown as an RFC 3339 formatted datetime string.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="computeCapacityReservations")
    def compute_capacity_reservations(self) -> pulumi.Input[Optional['BdsCapacityReservationComputeCapacityReservationsArgs']]:
        """
        (Updatable) Compute capacity reservation ID mappings by domain. For a multi-AD region, domain1, domain2, and domain3 correspond to AD1, AD2, and AD3 respectively. For a single-AD region, domain1, domain2, and domain3 correspond to FD1, FD2, and FD3 respectively.
        """
        return pulumi.get(self, "compute_capacity_reservations")
    ...
    @compute_capacity_reservations.setter
    def compute_capacity_reservations(self, value: pulumi.Input[Optional['BdsCapacityReservationComputeCapacityReservationsArgs']]):
        pulumi.set(self, "compute_capacity_reservations", value)
...
@pulumi.type_token("oci:BigDataService/bdsCapacityReservation:BdsCapacityReservation")
class BdsCapacityReservation(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param BdsCapacityReservationArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(BdsCapacityReservationArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = BdsCapacityReservationArgs.__new__(BdsCapacityReservationArgs)

            if compartment_id is None and not opts.urn:
                raise TypeError("Missing required property 'compartment_id'")
            __props__.__dict__["compartment_id"] = compartment_id
            if compute_capacity_reservations is None and not opts.urn:
                raise TypeError("Missing required property 'compute_capacity_reservations'")
            __props__.__dict__["compute_capacity_reservations"] = compute_capacity_reservations
        ...
        super(BdsCapacityReservation, __self__).__init__(
            'oci:BigDataService/bdsCapacityReservation:BdsCapacityReservation',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None) -> 'BdsCapacityReservation':
        """
        ...
        __props__ = _BdsCapacityReservationState.__new__(_BdsCapacityReservationState)
        ...
        return BdsCapacityReservation(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="computeCapacityReservations")
    def compute_capacity_reservations(self) -> pulumi.Output['outputs.BdsCapacityReservationComputeCapacityReservations']:
        """
        (Updatable) Compute capacity reservation ID mappings by domain. For a multi-AD region, domain1, domain2, and domain3 correspond to AD1, AD2, and AD3 respectively. For a single-AD region, domain1, domain2, and domain3 correspond to FD1, FD2, and FD3 respectively.
        """
        return pulumi.get(self, "compute_capacity_reservations")
