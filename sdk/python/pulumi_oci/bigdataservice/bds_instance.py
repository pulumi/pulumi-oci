...
class BdsInstanceArgs:
    def __init__(__self__, *,
                 ...
                 cluster_public_key: pulumi.Input[builtins.str],
                 cluster_version: pulumi.Input[builtins.str],
                 compartment_id: pulumi.Input[builtins.str],
                 display_name: pulumi.Input[builtins.str],
                 is_high_availability: pulumi.Input[builtins.bool],
                 is_secure: pulumi.Input[builtins.bool],
                 ...
                 bootstrap_script_url: Optional[pulumi.Input[builtins.str]] = None,
                 cloud_sql_details: Optional[pulumi.Input[Sequence[pulumi.Input['BdsInstanceCloudSqlDetailArgs']]]] = None,
                 cluster_profile: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 ignore_existing_nodes_shapes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 is_cloud_sql_configured: Optional[pulumi.Input[builtins.bool]] = None,
                 is_force_remove_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_force_stop_jobs: Optional[pulumi.Input[builtins.bool]] = None,
                 is_kafka_configured: Optional[pulumi.Input[builtins.bool]] = None,
                 kafka_broker_node: Optional[pulumi.Input['BdsInstanceKafkaBrokerNodeArgs']] = None,
                 kerberos_realm_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 remove_node: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] cluster_admin_password: Base-64 encoded password for the cluster (and Cloudera Manager) admin user.
        :param pulumi.Input[builtins.str] cluster_public_key: The SSH public key used to authenticate the cluster connection.
        :param pulumi.Input[builtins.str] cluster_version: Version of the Hadoop distribution
        ...
        :param pulumi.Input[builtins.bool] is_high_availability: Boolean flag specifying whether or not the cluster is HA
        :param pulumi.Input[builtins.bool] is_secure: Boolean flag specifying whether or not the cluster should be setup as secure.
        ...
        :param pulumi.Input[builtins.str] bootstrap_script_url: (Updatable) Pre-authenticated URL of the script in Object Store that is downloaded and executed.
        ...
        :param pulumi.Input[builtins.str] cluster_profile: Profile of the Big Data Service cluster.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ignore_existing_nodes_shapes: Tag to ignore changing the shape of existing worker, master, utility, compute_only_worker, edge, kafka_broker nodes, in a list format, when new nodes are added with a different shape.
        :param pulumi.Input[builtins.bool] is_cloud_sql_configured: (Updatable) Boolean flag specifying whether we configure Cloud SQL or not
        :param pulumi.Input[builtins.bool] is_force_stop_jobs: (Updatable) When setting state as `INACTIVE` for stopping a cluster, setting this flag to true forcefully stops the bds instance.
        :param pulumi.Input[builtins.bool] is_kafka_configured: Boolean flag specifying whether or not Kafka should be configured.
        :param pulumi.Input['BdsInstanceKafkaBrokerNodeArgs'] kafka_broker_node: The kafka broker node in the BDS instance
        :param pulumi.Input[builtins.str] kerberos_realm_name: The user-defined kerberos realm name.
    ...
    def cluster_public_key(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def cluster_public_key(self, value: pulumi.Input[builtins.str]):
    ...
    def is_high_availability(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def is_high_availability(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "is_high_availability", value)

    @property
    @pulumi.getter(name="isSecure")
    def is_secure(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @is_secure.setter
    def is_secure(self, value: pulumi.Input[builtins.bool]):
    ...
    def bootstrap_script_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def bootstrap_script_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def cluster_profile(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cluster_profile(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def ignore_existing_nodes_shapes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def ignore_existing_nodes_shapes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "ignore_existing_nodes_shapes", value)

    @property
    @pulumi.getter(name="isCloudSqlConfigured")
    def is_cloud_sql_configured(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_cloud_sql_configured(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_cloud_sql_configured", value)

    @property
    @pulumi.getter(name="isForceRemoveEnabled")
    def is_force_remove_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "is_force_remove_enabled")

    @is_force_remove_enabled.setter
    def is_force_remove_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_force_remove_enabled", value)

    @property
    @pulumi.getter(name="isForceStopJobs")
    def is_force_stop_jobs(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_force_stop_jobs(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_force_stop_jobs", value)

    @property
    @pulumi.getter(name="isKafkaConfigured")
    def is_kafka_configured(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_kafka_configured(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def kerberos_realm_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def kerberos_realm_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @remove_node.setter
    def remove_node(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _BdsInstanceState:
    def __init__(__self__, *,
                 ...
                 is_force_remove_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_force_stop_jobs: Optional[pulumi.Input[builtins.bool]] = None,
                 is_high_availability: Optional[pulumi.Input[builtins.bool]] = None,
                 is_kafka_configured: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 number_of_nodes_requiring_maintenance_reboot: Optional[pulumi.Input[builtins.int]] = None,
                 os_patch_version: Optional[pulumi.Input[builtins.str]] = None,
                 remove_node: Optional[pulumi.Input[builtins.str]] = None,
                 start_cluster_shape_configs: Optional[pulumi.Input[Sequence[pulumi.Input['BdsInstanceStartClusterShapeConfigArgs']]]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] cluster_version: Version of the Hadoop distribution
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment
        :param pulumi.Input[builtins.str] created_by: The user who created the cluster.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] display_name: (Updatable) Name of the BDS instance
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ignore_existing_nodes_shapes: Tag to ignore changing the shape of existing worker, master, utility, compute_only_worker, edge, kafka_broker nodes, in a list format, when new nodes are added with a different shape.
    ...
    @property
    @pulumi.getter(name="isHighAvailability")
    def is_high_availability(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Boolean flag specifying whether or not the cluster is HA
        """
        return pulumi.get(self, "is_high_availability")
    ...
    @is_high_availability.setter
    def is_high_availability(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_high_availability", value)
    ...
    def number_of_nodes_requiring_maintenance_reboot(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def number_of_nodes_requiring_maintenance_reboot(self, value: Optional[pulumi.Input[builtins.int]]):
...
class BdsInstance(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="bootstrapScriptUrl")
    def bootstrap_script_url(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Pre-authenticated URL of the script in Object Store that is downloaded and executed.
        """
        return pulumi.get(self, "bootstrap_script_url")
    ...
    @property
    @pulumi.getter(name="clusterProfile")
    def cluster_profile(self) -> pulumi.Output[builtins.str]:
        """
        Profile of the Big Data Service cluster.
        """
        return pulumi.get(self, "cluster_profile")
    ...
    @property
    @pulumi.getter(name="ignoreExistingNodesShapes")
    def ignore_existing_nodes_shapes(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        Tag to ignore changing the shape of existing worker, master, utility, compute_only_worker, edge, kafka_broker nodes, in a list format, when new nodes are added with a different shape.
        """
        return pulumi.get(self, "ignore_existing_nodes_shapes")
    ...
    @property
    @pulumi.getter(name="isCloudSqlConfigured")
    def is_cloud_sql_configured(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Boolean flag specifying whether we configure Cloud SQL or not
        """
        return pulumi.get(self, "is_cloud_sql_configured")
    ...
    @property
    @pulumi.getter(name="isForceRemoveEnabled")
    def is_force_remove_enabled(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "is_force_remove_enabled")

    @property
    @pulumi.getter(name="isForceStopJobs")
    def is_force_stop_jobs(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        (Updatable) When setting state as `INACTIVE` for stopping a cluster, setting this flag to true forcefully stops the bds instance.
        """
        return pulumi.get(self, "is_force_stop_jobs")
    ...
    @property
    @pulumi.getter(name="isHighAvailability")
    def is_high_availability(self) -> pulumi.Output[builtins.bool]:
        """
        Boolean flag specifying whether or not the cluster is HA
        """
        return pulumi.get(self, "is_high_availability")
    ...
    @property
    @pulumi.getter(name="isKafkaConfigured")
    def is_kafka_configured(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Boolean flag specifying whether or not Kafka should be configured.
        """
        return pulumi.get(self, "is_kafka_configured")
    ...
    @property
    @pulumi.getter(name="isSecure")
    def is_secure(self) -> pulumi.Output[builtins.bool]:
        """
        Boolean flag specifying whether or not the cluster should be setup as secure.
        """
        return pulumi.get(self, "is_secure")
    ...
    @property
    @pulumi.getter(name="kerberosRealmName")
    def kerberos_realm_name(self) -> pulumi.Output[builtins.str]:
        """
        The user-defined kerberos realm name.
        """
        return pulumi.get(self, "kerberos_realm_name")
    ...
    @property
    @pulumi.getter(name="numberOfNodesRequiringMaintenanceReboot")
    def number_of_nodes_requiring_maintenance_reboot(self) -> pulumi.Output[builtins.int]:
        """
        Number of nodes that require a maintenance reboot
        """
        return pulumi.get(self, "number_of_nodes_requiring_maintenance_reboot")
    ...
    @property
    @pulumi.getter(name="osPatchVersion")
    def os_patch_version(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (Updatable) The version of the patch to be upated.
        """
        return pulumi.get(self, "os_patch_version")
