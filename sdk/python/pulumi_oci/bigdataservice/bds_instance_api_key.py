...
class BdsInstanceApiKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key_alias: User friendly identifier used to uniquely differentiate between different API keys associated with this Big Data Service cluster. Only ASCII alphanumeric characters with no spaces allowed.
        :param pulumi.Input[builtins.str] passphrase: Base64 passphrase used to secure the private key which will be created on user behalf.
        :param pulumi.Input[builtins.str] user_id: The OCID of the user for whom this new generated API key pair will be created.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] default_region: The name of the region to establish the Object Storage endpoint. See https://docs.oracle.com/en-us/iaas/api/#/en/identity/20160918/Region/ for additional information.
        :param pulumi.Input[builtins.str] domain_ocid: Identity domain OCID , where user is present. For default domain , this field will be optional.
        """
...
class _BdsInstanceApiKeyState:
    def __init__(__self__, *,
                 ...
                 pemfilepath: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] default_region: The name of the region to establish the Object Storage endpoint. See https://docs.oracle.com/en-us/iaas/api/#/en/identity/20160918/Region/ for additional information.
        :param pulumi.Input[builtins.str] domain_ocid: Identity domain OCID , where user is present. For default domain , this field will be optional.
        :param pulumi.Input[builtins.str] fingerprint: The fingerprint that corresponds to the public API key requested.
        :param pulumi.Input[builtins.str] key_alias: User friendly identifier used to uniquely differentiate between different API keys associated with this Big Data Service cluster. Only ASCII alphanumeric characters with no spaces allowed.
        :param pulumi.Input[builtins.str] passphrase: Base64 passphrase used to secure the private key which will be created on user behalf.
        :param pulumi.Input[builtins.str] pemfilepath: The full path and file name of the private key used for authentication. This location will be automatically selected on the BDS local file system.
        :param pulumi.Input[builtins.str] state: The current status of the API key.
        :param pulumi.Input[builtins.str] tenant_id: The OCID of your tenancy.
        :param pulumi.Input[builtins.str] time_created: The time the API key was created, shown as an RFC 3339 formatted datetime string.
        :param pulumi.Input[builtins.str] user_id: The OCID of the user for whom this new generated API key pair will be created.
    ...
    @property
    @pulumi.getter
    def pemfilepath(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @pemfilepath.setter
    def pemfilepath(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BdsInstanceApiKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tenant_id: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BdsInstanceApiKey':
        """
    ...
    @property
    @pulumi.getter(name="defaultRegion")
    def default_region(self) -> pulumi.Output[builtins.str]:
        """
        The name of the region to establish the Object Storage endpoint. See https://docs.oracle.com/en-us/iaas/api/#/en/identity/20160918/Region/ for additional information.
        """
        return pulumi.get(self, "default_region")
    ...
    @property
    @pulumi.getter
    def pemfilepath(self) -> pulumi.Output[builtins.str]:
        """
        The full path and file name of the private key used for authentication. This location will be automatically selected on the BDS local file system.
        """
        return pulumi.get(self, "pemfilepath")
