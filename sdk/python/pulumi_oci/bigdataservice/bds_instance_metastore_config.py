...
class BdsInstanceMetastoreConfigArgs:
    def __init__(__self__, *,
                 bds_api_key_id: pulumi.Input[_builtins.str],
                 bds_api_key_passphrase: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] metastore_id: The OCID of the Data Catalog metastore.
        ...
        :param pulumi.Input[_builtins.str] display_name: (Updatable) The display name of the metastore configuration
        """
    ...
    def bds_api_key_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def bds_api_key_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "bds_api_key_id", value)

    @_builtins.property
    @pulumi.getter(name="bdsApiKeyPassphrase")
    def bds_api_key_passphrase(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def bds_api_key_passphrase(self, value: pulumi.Input[_builtins.str]):
...
class _BdsInstanceMetastoreConfigState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] display_name: (Updatable) The display name of the metastore configuration
        :param pulumi.Input[_builtins.str] metastore_id: The OCID of the Data Catalog metastore.
        :param pulumi.Input[_builtins.str] metastore_type: The type of the metastore in the metastore configuration.
        :param pulumi.Input[_builtins.str] state: the lifecycle state of the metastore configuration.
        :param pulumi.Input[_builtins.str] time_created: The time when the configuration was created, shown as an RFC 3339 formatted datetime string.
        :param pulumi.Input[_builtins.str] time_updated: The time when the configuration was updated, shown as an RFC 3339 formatted datetime string.
        """
        if activate_trigger is not None:
            pulumi.set(__self__, "activate_trigger", activate_trigger)
...
class BdsInstanceMetastoreConfig(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="bdsApiKeyId")
    def bds_api_key_id(self) -> pulumi.Output[_builtins.str]:
        """
        (Updatable) The ID of BDS Api Key used for Data Catalog metastore integration.
        """
        return pulumi.get(self, "bds_api_key_id")
    ...
    @_builtins.property
    @pulumi.getter(name="bdsApiKeyPassphrase")
    def bds_api_key_passphrase(self) -> pulumi.Output[_builtins.str]:
        """
        (Updatable) Base-64 encoded passphrase of the BDS Api Key.
        """
        return pulumi.get(self, "bds_api_key_passphrase")
    ...
    @_builtins.property
    @pulumi.getter(name="metastoreType")
    def metastore_type(self) -> pulumi.Output[_builtins.str]:
        """
        The type of the metastore in the metastore configuration.
        """
        return pulumi.get(self, "metastore_type")
