...
class BdsInstanceMetastoreConfigArgs:
    def __init__(__self__, *,
                 bds_api_key_id: pulumi.Input[builtins.str],
                 bds_api_key_passphrase: pulumi.Input[builtins.str],
                 ...
                 activate_trigger: Optional[pulumi.Input[builtins.int]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a BdsInstanceMetastoreConfig resource.
        :param pulumi.Input[builtins.str] bds_api_key_id: (Updatable) The ID of BDS Api Key used for Data Catalog metastore integration.
        :param pulumi.Input[builtins.str] bds_api_key_passphrase: (Updatable) Base-64 encoded passphrase of the BDS Api Key.
        ...
        :param pulumi.Input[builtins.str] metastore_id: The OCID of the Data Catalog metastore.
        :param pulumi.Input[builtins.int] activate_trigger: (Updatable) An optional integer, when flipped triggers activation of metastore config.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the metastore configuration
        """
    ...
    def bds_api_key_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def bds_api_key_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "bds_api_key_id", value)

    @property
    @pulumi.getter(name="bdsApiKeyPassphrase")
    def bds_api_key_passphrase(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def bds_api_key_passphrase(self, value: pulumi.Input[builtins.str]):
    ...
    def activate_trigger(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def activate_trigger(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _BdsInstanceMetastoreConfigState:
    def __init__(__self__, *,
                 activate_trigger: Optional[pulumi.Input[builtins.int]] = None,
                 bds_api_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 bds_api_key_passphrase: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 metastore_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the metastore configuration
        :param pulumi.Input[builtins.str] metastore_id: The OCID of the Data Catalog metastore.
        :param pulumi.Input[builtins.str] metastore_type: The type of the metastore in the metastore configuration.
        :param pulumi.Input[builtins.str] state: the lifecycle state of the metastore configuration.
        :param pulumi.Input[builtins.str] time_created: The time when the configuration was created, shown as an RFC 3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The time when the configuration was updated, shown as an RFC 3339 formatted datetime string.
        """
        if activate_trigger is not None:
            pulumi.set(__self__, "activate_trigger", activate_trigger)
    ...
    @property
    @pulumi.getter(name="bdsApiKeyId")
    def bds_api_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The ID of BDS Api Key used for Data Catalog metastore integration.
        """
        return pulumi.get(self, "bds_api_key_id")
    ...
    @bds_api_key_id.setter
    def bds_api_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bds_api_key_id", value)

    @property
    @pulumi.getter(name="bdsApiKeyPassphrase")
    def bds_api_key_passphrase(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Base-64 encoded passphrase of the BDS Api Key.
        """
        return pulumi.get(self, "bds_api_key_passphrase")
    ...
    @bds_api_key_passphrase.setter
    def bds_api_key_passphrase(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bds_api_key_passphrase", value)
    ...
    def metastore_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def metastore_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BdsInstanceMetastoreConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'BdsInstanceMetastoreConfig':
        """
    ...
    @property
    @pulumi.getter(name="activateTrigger")
    def activate_trigger(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        (Updatable) An optional integer, when flipped triggers activation of metastore config.
    ...
    @property
    @pulumi.getter(name="bdsApiKeyId")
    def bds_api_key_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The ID of BDS Api Key used for Data Catalog metastore integration.
        """
        return pulumi.get(self, "bds_api_key_id")
    ...
    @property
    @pulumi.getter(name="bdsApiKeyPassphrase")
    def bds_api_key_passphrase(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Base-64 encoded passphrase of the BDS Api Key.
        """
        return pulumi.get(self, "bds_api_key_passphrase")
    ...
    @property
    @pulumi.getter(name="metastoreType")
    def metastore_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the metastore in the metastore configuration.
        """
        return pulumi.get(self, "metastore_type")
