...
class BdsInstanceResourcePrincipalConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 force_refresh_resource_principal_trigger: Optional[pulumi.Input[builtins.int]] = None,
                 session_token_life_span_duration_in_hours: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] cluster_admin_password: Base-64 encoded Cluster Admin Password for cluster admin user.
        ...
        :param pulumi.Input[builtins.int] force_refresh_resource_principal_trigger: (Updatable) An optional property when incremented triggers Force Refresh Resource Principal. Could be set to any integer value.
        :param pulumi.Input[builtins.int] session_token_life_span_duration_in_hours: (Updatable) Life span in hours for the resource principal session token.
        """
    ...
    def force_refresh_resource_principal_trigger(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def force_refresh_resource_principal_trigger(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "force_refresh_resource_principal_trigger", value)

    @property
    @pulumi.getter(name="sessionTokenLifeSpanDurationInHours")
    def session_token_life_span_duration_in_hours(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def session_token_life_span_duration_in_hours(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _BdsInstanceResourcePrincipalConfigurationState:
    def __init__(__self__, *,
                 ...
                 time_token_expiry: Optional[pulumi.Input[builtins.str]] = None,
                 time_token_refreshed: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] force_refresh_resource_principal_trigger: (Updatable) An optional property when incremented triggers Force Refresh Resource Principal. Could be set to any integer value.
        :param pulumi.Input[builtins.int] session_token_life_span_duration_in_hours: (Updatable) Life span in hours for the resource principal session token.
        :param pulumi.Input[builtins.str] state: The state of the ResourcePrincipalConfiguration.
        :param pulumi.Input[builtins.str] time_created: The time the ResourcePrincipalConfiguration was created, shown as an RFC 3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_token_expiry: the time the resource principal session token will expired, shown as an rfc 3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_token_refreshed: the time the resource principal session token was refreshed, shown as an rfc 3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The time the ResourcePrincipalConfiguration was updated, shown as an RFC 3339 formatted datetime string.
        """
    ...
    def time_token_expiry(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_token_expiry(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_token_expiry", value)

    @property
    @pulumi.getter(name="timeTokenRefreshed")
    def time_token_refreshed(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_token_refreshed(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BdsInstanceResourcePrincipalConfiguration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_token_expiry: Optional[pulumi.Input[builtins.str]] = None,
            time_token_refreshed: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'BdsInstanceResourcePrincipalConfiguration':
        """
    ...
    @property
    @pulumi.getter(name="forceRefreshResourcePrincipalTrigger")
    def force_refresh_resource_principal_trigger(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        (Updatable) An optional property when incremented triggers Force Refresh Resource Principal. Could be set to any integer value.
        """
        return pulumi.get(self, "force_refresh_resource_principal_trigger")
    ...
    @property
    @pulumi.getter(name="sessionTokenLifeSpanDurationInHours")
    def session_token_life_span_duration_in_hours(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) Life span in hours for the resource principal session token.
        """
        return pulumi.get(self, "session_token_life_span_duration_in_hours")
    ...
    @property
    @pulumi.getter(name="timeTokenExpiry")
    def time_token_expiry(self) -> pulumi.Output[builtins.str]:
        """
        the time the resource principal session token will expired, shown as an rfc 3339 formatted datetime string.
        """
        return pulumi.get(self, "time_token_expiry")
    ...
    @property
    @pulumi.getter(name="timeTokenRefreshed")
    def time_token_refreshed(self) -> pulumi.Output[builtins.str]:
        """
        the time the resource principal session token was refreshed, shown as an rfc 3339 formatted datetime string.
        """
        return pulumi.get(self, "time_token_refreshed")
