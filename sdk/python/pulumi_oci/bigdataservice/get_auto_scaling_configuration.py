...
class GetAutoScalingConfigurationResult:
    ...
    def auto_scaling_configuration_id(self) -> builtins.str:
...
def get_auto_scaling_configuration(auto_scaling_configuration_id: Optional[builtins.str] = None,
    ...
    :param builtins.str auto_scaling_configuration_id: Unique Oracle-assigned identifier of the autoscale configuration.
...
def get_auto_scaling_configuration_output(auto_scaling_configuration_id: Optional[pulumi.Input[builtins.str]] = None,
