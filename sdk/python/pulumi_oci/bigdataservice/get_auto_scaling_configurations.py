...
def get_auto_scaling_configurations(bds_instance_id: Optional[builtins.str] = None,
...
def get_auto_scaling_configurations_output(bds_instance_id: Optional[pulumi.Input[builtins.str]] = None,
