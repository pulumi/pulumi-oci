...
class GetBdsInstanceResult:
    ...
    def bootstrap_script_url(self) -> builtins.str:
        """
    ...
    def cluster_profile(self) -> builtins.str:
        """
    ...
    def ignore_existing_nodes_shapes(self) -> Sequence[builtins.str]:
        return pulumi.get(self, "ignore_existing_nodes_shapes")

    @property
    @pulumi.getter(name="isCloudSqlConfigured")
    def is_cloud_sql_configured(self) -> builtins.bool:
        """
    ...
    def is_force_remove_enabled(self) -> builtins.bool:
        return pulumi.get(self, "is_force_remove_enabled")

    @property
    @pulumi.getter(name="isForceStopJobs")
    def is_force_stop_jobs(self) -> builtins.bool:
    ...
    def is_kafka_configured(self) -> builtins.bool:
        """
    ...
    def kerberos_realm_name(self) -> builtins.str:
    ...
    def number_of_nodes_requiring_maintenance_reboot(self) -> builtins.int:
        """
    ...
    def os_patch_version(self) -> builtins.str:
        return pulumi.get(self, "os_patch_version")

    @property
    @pulumi.getter(name="removeNode")
    def remove_node(self) -> builtins.str:
...
def get_bds_instance(bds_instance_id: Optional[builtins.str] = None,
...
def get_bds_instance_output(bds_instance_id: Optional[pulumi.Input[builtins.str]] = None,
