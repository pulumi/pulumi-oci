...
def get_bds_instance_api_key(api_key_id: Optional[builtins.str] = None,
    ...
    :param builtins.str api_key_id: The API key identifier.
...
def get_bds_instance_api_key_output(api_key_id: Optional[pulumi.Input[builtins.str]] = None,
