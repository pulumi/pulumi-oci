...
def get_bds_instance_api_keys(bds_instance_id: Optional[builtins.str] = None,
...
def get_bds_instance_api_keys_output(bds_instance_id: Optional[pulumi.Input[builtins.str]] = None,
