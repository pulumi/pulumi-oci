...
class GetBdsInstanceGetOsPatchResult:
    ...
    def min_bds_version(self) -> builtins.str:
        """
    ...
    def min_compatible_odh_version_map(self) -> Mapping[str, builtins.str]:
        """
...
def get_bds_instance_get_os_patch(bds_instance_id: Optional[builtins.str] = None,
                                  filters: Optional[Sequence[Union['GetBdsInstanceGetOsPatchFilterArgs', 'GetBdsInstanceGetOsPatchFilterArgsDict']]] = None,
                                  os_patch_version: Optional[builtins.str] = None,
    ...
    :param builtins.str os_patch_version: The version of the OS patch.
    """
    __args__ = dict()
...
def get_bds_instance_get_os_patch_output(bds_instance_id: Optional[pulumi.Input[builtins.str]] = None,
