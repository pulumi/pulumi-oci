...
class GetBdsInstanceIdentityConfigurationResult:
    ...
    def activate_iam_user_sync_configuration_trigger(self) -> builtins.str:
        return pulumi.get(self, "activate_iam_user_sync_configuration_trigger")

    @property
    @pulumi.getter(name="activateUpstConfigurationTrigger")
    def activate_upst_configuration_trigger(self) -> builtins.str:
    ...
    def confidential_application_id(self) -> builtins.str:
        """
    ...
    def identity_configuration_id(self) -> builtins.str:
    ...
    def refresh_confidential_application_trigger(self) -> builtins.str:
        return pulumi.get(self, "refresh_confidential_application_trigger")

    @property
    @pulumi.getter(name="refreshUpstTokenExchangeKeytabTrigger")
    def refresh_upst_token_exchange_keytab_trigger(self) -> builtins.str:
...
def get_bds_instance_identity_configuration(bds_instance_id: Optional[builtins.str] = None,
                                            identity_configuration_id: Optional[builtins.str] = None,
    ...
    :param builtins.str identity_configuration_id: The OCID of the identity configuration
    """
    __args__ = dict()
...
def get_bds_instance_identity_configuration_output(bds_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                                                   identity_configuration_id: Optional[pulumi.Input[builtins.str]] = None,
