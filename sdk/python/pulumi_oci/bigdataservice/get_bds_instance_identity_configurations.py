...
def get_bds_instance_identity_configurations(bds_instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str state: The state of the identity config
    """
    __args__ = dict()
...
def get_bds_instance_identity_configurations_output(bds_instance_id: Optional[pulumi.Input[builtins.str]] = None,
