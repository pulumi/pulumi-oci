...
class GetBdsInstanceMetastoreConfigResult:
    ...
    def metastore_config_id(self) -> _builtins.str:
...
def get_bds_instance_metastore_config(bds_instance_id: Optional[_builtins.str] = None,
                                      metastore_config_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str metastore_config_id: The metastore configuration ID
    """
    __args__ = dict()
