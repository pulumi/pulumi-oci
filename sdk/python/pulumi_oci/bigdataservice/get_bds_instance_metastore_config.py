...
class GetBdsInstanceMetastoreConfigResult:
    ...
    def activate_trigger(self) -> builtins.int:
        return pulumi.get(self, "activate_trigger")

    @property
    @pulumi.getter(name="bdsApiKeyId")
    def bds_api_key_id(self) -> builtins.str:
        """
    ...
    def bds_api_key_passphrase(self) -> builtins.str:
    ...
    def metastore_config_id(self) -> builtins.str:
...
def get_bds_instance_metastore_config(bds_instance_id: Optional[builtins.str] = None,
                                      metastore_config_id: Optional[builtins.str] = None,
    ...
    :param builtins.str metastore_config_id: The metastore configuration ID
    """
    __args__ = dict()
...
def get_bds_instance_metastore_config_output(bds_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                                             metastore_config_id: Optional[pulumi.Input[builtins.str]] = None,
