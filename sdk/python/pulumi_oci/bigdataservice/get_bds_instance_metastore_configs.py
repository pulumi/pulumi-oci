...
class GetBdsInstanceMetastoreConfigsResult:
    ...
    def bds_api_key_id(self) -> Optional[builtins.str]:
        """
    ...
    def metastore_id(self) -> Optional[builtins.str]:
        """
    ...
    def metastore_type(self) -> Optional[builtins.str]:
        """
...
def get_bds_instance_metastore_configs(bds_api_key_id: Optional[builtins.str] = None,
                                       bds_instance_id: Optional[builtins.str] = None,
                                       ...
                                       metastore_type: Optional[builtins.str] = None,
    ...
    :param builtins.str bds_api_key_id: The ID of the API key that is associated with the external metastore in the metastore configuration
    :param builtins.str bds_instance_id: The OCID of the cluster.
    :param builtins.str display_name: A filter to return only resources that match the entire display name given.
    :param builtins.str metastore_id: The OCID of the Data Catalog metastore in the metastore configuration
    :param builtins.str metastore_type: The type of the metastore in the metastore configuration
    :param builtins.str state: The lifecycle state of the metastore in the metastore configuration
    """
    __args__ = dict()
...
def get_bds_instance_metastore_configs_output(bds_api_key_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                              ...
                                              metastore_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                              metastore_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
