...
def get_bds_instance_resource_principal_configurations(bds_instance_id: Optional[builtins.str] = None,
...
def get_bds_instance_resource_principal_configurations_output(bds_instance_id: Optional[pulumi.Input[builtins.str]] = None,
