...
def get_bds_instances(compartment_id: Optional[str] = None,
                      ...
                      filters: Optional[Sequence[pulumi.InputType['GetBdsInstancesFilterArgs']]] = None,
    ...
    test_bds_instances = oci.BigDataService.get_bds_instances(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetBdsInstancesResult(
        bds_instances=__ret__.bds_instances,
...
@_utilities.lift_output_func(get_bds_instances)
def get_bds_instances_output(compartment_id: Optional[pulumi.Input[str]] = None,
                             display_name: Optional[pulumi.Input[Optional[str]]] = None,
                             filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetBdsInstancesFilterArgs']]]]] = None,
