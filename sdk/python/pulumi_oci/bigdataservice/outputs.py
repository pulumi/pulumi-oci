...
class AutoScalingConfigurationPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str policy_type: (Updatable) Types of autoscale policies. Options are SCHEDULE-BASED or THRESHOLD-BASED. (Only THRESHOLD-BASED is supported in this release.)
...
class AutoScalingConfigurationPolicyDetails(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str policy_type: Type of autoscaling policy.
        :param builtins.str action_type: The type of autoscaling action to take.
        ...
        :param builtins.str timezone: (Updatable) The time zone of the execution schedule, in IANA time zone database name format
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param builtins.str trigger_type: The type of autoscaling trigger.
        """
        pulumi.set(__self__, "policy_type", policy_type)
...
class AutoScalingConfigurationPolicyDetailsScaleDownConfig(dict):
    ...
    def memory_step_size(self) -> Optional[builtins.int]:
        """
    ...
    def min_memory_per_node(self) -> Optional[builtins.int]:
        """
    ...
    def min_ocpus_per_node(self) -> Optional[builtins.int]:
        """
    ...
    def ocpu_step_size(self) -> Optional[builtins.int]:
        """
...
class AutoScalingConfigurationPolicyDetailsScaleDownConfigMetric(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str metric_type: (Updatable) Allowed values are CPU_UTILIZATION and MEMORY_UTILIZATION.
...
class AutoScalingConfigurationPolicyDetailsScaleDownConfigMetricThreshold(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int duration_in_minutes: (Updatable) This value is the minimum period of time the metric value exceeds the threshold value before the action is triggered. The value is in minutes.
        :param builtins.str operator: (Updatable) The comparison operator to use. Options are greater than (GT) or less than (LT).
        :param builtins.int value: (Updatable) Integer non-negative value. 0 < value < 100
        """
...
class AutoScalingConfigurationPolicyDetailsScaleInConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 step_size: Optional[builtins.int] = None):
        """
        ...
        :param builtins.int min_node_count: (Updatable) This value is the minimum number of nodes the cluster can be scaled-in to.
        :param builtins.int step_size: (Updatable) This value is the number of nodes to remove during a scale-in event.
        """
        if metric is not None:
            pulumi.set(__self__, "metric", metric)
    ...
    def step_size(self) -> Optional[builtins.int]:
        """
...
class AutoScalingConfigurationPolicyDetailsScaleOutConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 step_size: Optional[builtins.int] = None):
        """
        :param builtins.int max_node_count: (Updatable) This value is the maximum number of nodes the cluster can be scaled-out to.
        ...
        :param builtins.int step_size: (Updatable) This value is the number of nodes to add during a scale-out event.
        """
...
class AutoScalingConfigurationPolicyDetailsScaleUpConfig(dict):
    ...
    def max_memory_per_node(self) -> Optional[builtins.int]:
        """
    ...
    def max_ocpus_per_node(self) -> Optional[builtins.int]:
        """
...
class AutoScalingConfigurationPolicyDetailsScheduleDetail(dict):
    ...
    def __init__(__self__, *,
                 schedule_type: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str schedule_type: (Updatable) The type of schedule.
    ...
    def schedule_type(self) -> Optional[builtins.str]:
        """
...
class AutoScalingConfigurationPolicyDetailsScheduleDetailTimeAndHorizontalScalingConfig(dict):
    ...
    def __init__(__self__, *,
                 target_node_count: Optional[builtins.int] = None,
                 time_recurrence: Optional[builtins.str] = None):
        """
        :param builtins.int target_node_count: (Updatable) This value is the desired number of nodes in the cluster.
        :param builtins.str time_recurrence: (Updatable) Day/time recurrence (specified following RFC 5545) at which to trigger autoscaling action. Currently only WEEKLY frequency is supported. Days of the week are specified using BYDAY field. Time of the day is specified using BYHOUR and BYMINUTE fields. Other fields are not supported.
        """
    ...
    def target_node_count(self) -> Optional[builtins.int]:
        """
    ...
    def time_recurrence(self) -> Optional[builtins.str]:
        """
...
class AutoScalingConfigurationPolicyDetailsScheduleDetailTimeAndVerticalScalingConfig(dict):
    ...
    def __init__(__self__, *,
                 target_memory_per_node: Optional[builtins.int] = None,
                 target_ocpus_per_node: Optional[builtins.int] = None,
                 target_shape: Optional[builtins.str] = None,
                 time_recurrence: Optional[builtins.str] = None):
        """
        :param builtins.int target_memory_per_node: (Updatable) For nodes with [flexible compute shapes](https://docs.cloud.oracle.com/iaas/Content/bigdata/create-cluster.htm#cluster-plan-shape), this value is the desired memory in GBs on each node. This value is not used for nodes with fixed compute shapes.
        :param builtins.int target_ocpus_per_node: (Updatable) For nodes with [flexible compute shapes](https://docs.cloud.oracle.com/iaas/Content/bigdata/create-cluster.htm#cluster-plan-shape), this value is the desired OCPUs count on each node. This value is not used for nodes with fixed compute shapes.
        :param builtins.str target_shape: (Updatable) For nodes with [fixed compute shapes](https://docs.cloud.oracle.com/iaas/Content/bigdata/create-cluster.htm#cluster-plan-shape), this value is the desired shape of each node. This value is not used for nodes with flexible compute shapes.
        :param builtins.str time_recurrence: (Updatable) Day/time recurrence (specified following RFC 5545) at which to trigger autoscaling action. Currently only WEEKLY frequency is supported. Days of the week are specified using BYDAY field. Time of the day is specified using BYHOUR and BYMINUTE fields. Other fields are not supported.
        """
    ...
    def target_memory_per_node(self) -> Optional[builtins.int]:
        """
    ...
    def target_ocpus_per_node(self) -> Optional[builtins.int]:
        """
    ...
    def target_shape(self) -> Optional[builtins.str]:
        """
...
class AutoScalingConfigurationPolicyRule(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: (Updatable) The valid value are CHANGE_SHAPE_SCALE_UP or CHANGE_SHAPE_SCALE_DOWN.
...
class BdsInstanceBdsClusterVersionSummary(dict):
    ...
    def __init__(__self__, *,
                 bds_version: builtins.str,
                 odh_version: Optional[builtins.str] = None):
        """
        :param builtins.str bds_version: BDS version to be used for cluster creation
        :param builtins.str odh_version: ODH version to be used for cluster creation
        """
    ...
    def bds_version(self) -> builtins.str:
        """
    ...
    def odh_version(self) -> Optional[builtins.str]:
        """
...
class BdsInstanceCloudSqlDetail(dict):
    ...
    def __init__(__self__, *,
                 shape: builtins.str,
                 block_volume_size_in_gbs: Optional[builtins.str] = None,
                 ip_address: Optional[builtins.str] = None,
                 is_kerberos_mapped_to_database_users: Optional[builtins.bool] = None,
        ...
        """
        :param builtins.str shape: Shape of the node
        :param builtins.str block_volume_size_in_gbs: The size of block volume in GB that needs to be attached to a given node. All the necessary details needed for attachment are managed by service itself.
        :param builtins.str ip_address: IP address of the node
        :param builtins.bool is_kerberos_mapped_to_database_users: Boolean flag specifying whether or not are Kerberos principals mapped to database users.
        ...
        :param builtins.int nvmes: The number of NVMe drives to be used for storage. A single drive has 6.8 TB available.
    ...
    def block_volume_size_in_gbs(self) -> Optional[builtins.str]:
        """
    ...
    def is_kerberos_mapped_to_database_users(self) -> Optional[builtins.bool]:
        """
...
class BdsInstanceCloudSqlDetailKerberosDetail(dict):
    ...
    def __init__(__self__, *,
                 keytab_file: Optional[builtins.str] = None,
                 principal_name: Optional[builtins.str] = None):
        """
        :param builtins.str keytab_file: Location of the keytab file
        :param builtins.str principal_name: Name of the Kerberos principal
        """
    ...
    def keytab_file(self) -> Optional[builtins.str]:
        """
...
class BdsInstanceClusterDetail(dict):
    ...
    def __init__(__self__, *,
                 ambari_url: Optional[builtins.str] = None,
                 bd_cell_version: Optional[builtins.str] = None,
                 bda_version: Optional[builtins.str] = None,
                 bdm_version: Optional[builtins.str] = None,
                 bds_version: Optional[builtins.str] = None,
                 big_data_manager_url: Optional[builtins.str] = None,
                 cloudera_manager_url: Optional[builtins.str] = None,
                 csql_cell_version: Optional[builtins.str] = None,
                 db_version: Optional[builtins.str] = None,
                 hue_server_url: Optional[builtins.str] = None,
                 jupyter_hub_url: Optional[builtins.str] = None,
                 odh_version: Optional[builtins.str] = None,
                 os_version: Optional[builtins.str] = None,
                 time_created: Optional[builtins.str] = None,
                 time_refreshed: Optional[builtins.str] = None):
        """
        :param builtins.str ambari_url: The URL of Ambari
        :param builtins.str bd_cell_version: Cloud SQL cell version.
        :param builtins.str bda_version: BDA version installed in the cluster
        :param builtins.str bdm_version: Big Data Manager version installed in the cluster.
        :param builtins.str bds_version: Big Data Service version installed in the cluster.
        :param builtins.str big_data_manager_url: The URL of Big Data Manager.
        :param builtins.str cloudera_manager_url: The URL of Cloudera Manager
        :param builtins.str csql_cell_version: Big Data SQL version.
        :param builtins.str db_version: Cloud SQL query server database version.
        :param builtins.str hue_server_url: The URL of the Hue server.
        :param builtins.str jupyter_hub_url: The URL of the Jupyterhub.
        :param builtins.str odh_version: Version of the ODH (Oracle Distribution including Apache Hadoop) for the node.
        :param builtins.str os_version: BDS-assigned Operating System version for the node.
        :param builtins.str time_created: The time the BDS instance was created. An RFC3339 formatted datetime string
        :param builtins.str time_refreshed: The time the cluster was automatically or manually refreshed, shown as an RFC 3339 formatted datetime string.
        """
    ...
    def ambari_url(self) -> Optional[builtins.str]:
        """
        The URL of Ambari
        """
    ...
    def bd_cell_version(self) -> Optional[builtins.str]:
        """
    ...
    def bda_version(self) -> Optional[builtins.str]:
        """
    ...
    def bdm_version(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="bdsVersion")
    def bds_version(self) -> Optional[builtins.str]:
        """
    ...
    def big_data_manager_url(self) -> Optional[builtins.str]:
        """
    ...
    def cloudera_manager_url(self) -> Optional[builtins.str]:
        """
    ...
    def csql_cell_version(self) -> Optional[builtins.str]:
        """
    ...
    def hue_server_url(self) -> Optional[builtins.str]:
        """
    ...
    def jupyter_hub_url(self) -> Optional[builtins.str]:
        """
    ...
    def time_refreshed(self) -> Optional[builtins.str]:
        """
...
class BdsInstanceComputeOnlyWorkerNode(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int number_of_nodes: Number of nodes that forming the cluster
        :param builtins.str shape: Shape of the node
        :param builtins.str subnet_id: The OCID of the subnet in which the node should be created
        :param builtins.str block_volume_size_in_gbs: The size of block volume in GB that needs to be attached to a given node. All the necessary details needed for attachment are managed by service itself.
        """
...
class BdsInstanceIdentityConfigurationIamUserSyncConfiguration(dict):
    ...
    def __init__(__self__, *,
                 is_posix_attributes_addition_required: Optional[builtins.bool] = None,
                 state: Optional[builtins.str] = None,
                 time_created: Optional[builtins.str] = None,
                 time_updated: Optional[builtins.str] = None):
        """
        :param builtins.bool is_posix_attributes_addition_required: whether to append POSIX attributes to IAM users
        :param builtins.str state: Lifecycle state of the UPST config
        :param builtins.str time_created: Time when this UPST config was created, shown as an RFC 3339 formatted datetime string.
        :param builtins.str time_updated: Time when this UPST config was updated, shown as an RFC 3339 formatted datetime string.
        """
    ...
    def is_posix_attributes_addition_required(self) -> Optional[builtins.bool]:
        """
...
class BdsInstanceIdentityConfigurationIamUserSyncConfigurationDetails(dict):
    ...
    def __init__(__self__, *,
                 is_posix_attributes_addition_required: Optional[builtins.bool] = None):
        """
        :param builtins.bool is_posix_attributes_addition_required: (Updatable) whether posix attribute needs to be appended to users, required for updating IAM user sync configuration
        """
        if is_posix_attributes_addition_required is not None:
            pulumi.set(__self__, "is_posix_attributes_addition_required", is_posix_attributes_addition_required)
...
class BdsInstanceIdentityConfigurationUpstConfiguration(dict):
    ...
    def __init__(__self__, *,
                 keytab_content: Optional[builtins.str] = None,
                 master_encryption_key_id: Optional[builtins.str] = None,
                 secret_id: Optional[builtins.str] = None,
                 state: Optional[builtins.str] = None,
                 time_created: Optional[builtins.str] = None,
                 time_token_exchange_keytab_last_refreshed: Optional[builtins.str] = None,
                 time_updated: Optional[builtins.str] = None,
                 token_exchange_principal_name: Optional[builtins.str] = None,
                 vault_id: Optional[builtins.str] = None):
        """
        :param builtins.str keytab_content: The kerberos keytab content used for creating identity propagation trust config, in base64 format
        :param builtins.str master_encryption_key_id: Master Encryption key used for encrypting token exchange keytab.
        :param builtins.str secret_id: Secret ID for token exchange keytab
        :param builtins.str state: Lifecycle state of the UPST config
        :param builtins.str time_created: Time when this UPST config was created, shown as an RFC 3339 formatted datetime string.
        :param builtins.str time_token_exchange_keytab_last_refreshed: Time when the keytab for token exchange principal is last refreshed, shown as an RFC 3339 formatted datetime string.
        :param builtins.str time_updated: Time when this UPST config was updated, shown as an RFC 3339 formatted datetime string.
        :param builtins.str token_exchange_principal_name: Token exchange kerberos Principal name in cluster
        :param builtins.str vault_id: The instance OCID of the node, which is the resource from which the node backup was acquired.
        """
    ...
    def keytab_content(self) -> Optional[builtins.str]:
        """
    ...
    def master_encryption_key_id(self) -> Optional[builtins.str]:
        """
    ...
    def time_token_exchange_keytab_last_refreshed(self) -> Optional[builtins.str]:
        """
    ...
    def token_exchange_principal_name(self) -> Optional[builtins.str]:
        """
...
class BdsInstanceIdentityConfigurationUpstConfigurationDetails(dict):
    ...
    def __init__(__self__, *,
                 ...
                 vault_id: Optional[builtins.str] = None):
        """
        :param builtins.str master_encryption_key_id: (Updatable) OCID of the master encryption key in vault for encrypting token exchange service principal keytab, required for activating UPST config
        :param builtins.str vault_id: (Updatable) OCID of the vault to store token exchange service principal keyta, required for activating UPST config
        """
        if master_encryption_key_id is not None:
            pulumi.set(__self__, "master_encryption_key_id", master_encryption_key_id)
        if vault_id is not None:
...
class BdsInstanceKafkaBrokerNode(dict):
    ...
    def __init__(__self__, *,
                 number_of_kafka_nodes: builtins.int,
                 shape: builtins.str,
                 subnet_id: builtins.str,
                 block_volume_size_in_gbs: Optional[builtins.str] = None,
    ...
    def number_of_kafka_nodes(self) -> builtins.int:
...
class BdsInstanceMasterNode(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int number_of_nodes: The amount of master nodes should be created.
        :param builtins.str shape: Shape of the node
        :param builtins.str subnet_id: The OCID of the subnet in which the node should be created
        :param builtins.str block_volume_size_in_gbs: The size of block volume in GB that needs to be attached to a given node. All the necessary details needed for attachment are managed by service itself.
...
class BdsInstanceNetworkConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_nat_gateway_required: Optional[builtins.bool] = None):
        """
        :param builtins.str cidr_block: (Updatable) The CIDR IP address block of the VCN.
        :param builtins.bool is_nat_gateway_required: (Updatable) A boolean flag whether to configure a NAT gateway.
        """
    ...
    def is_nat_gateway_required(self) -> Optional[builtins.bool]:
        """
...
class BdsInstanceNode(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ip_address: Optional[builtins.str] = None,
                 is_reboot_required: Optional[builtins.bool] = None,
                 local_disks_total_size_in_gbs: Optional[builtins.float] = None,
                 memory_in_gbs: Optional[builtins.int] = None,
                 ...
                 ssh_fingerprint: Optional[builtins.str] = None,
                 state: Optional[builtins.str] = None,
                 subnet_id: Optional[builtins.str] = None,
                 time_created: Optional[builtins.str] = None,
                 time_maintenance_reboot_due: Optional[builtins.str] = None):
        """
        ...
        :param builtins.str availability_domain: The name of the availability domain the node is running in
        :param builtins.str display_name: (Updatable) Name of the BDS instance
        :param builtins.str fault_domain: The name of the fault domain the node is running in
        :param builtins.str hostname: The fully-qualified hostname (FQDN) of the node
        :param builtins.str image_id: The OCID of the image from which the node was created
        :param builtins.str instance_id: The OCID of the underlying compute instance
        :param builtins.str ip_address: IP address of the node
        :param builtins.bool is_reboot_required: Indicates if the node requires a reboot to either reflect the latest os kernel or take actions for maintenance reboot.
        :param builtins.float local_disks_total_size_in_gbs: The aggregate size of all local disks, in gigabytes. If the instance does not have any local disks, this field is null.
        :param builtins.int memory_in_gbs: The total amount of memory available to the node, in gigabytes.
        :param builtins.str node_type: The Big Data Service cluster node type.
        :param builtins.int nvmes: The number of NVMe drives to be used for storage. A single drive has 6.8 TB available.
        :param builtins.int ocpus: The total number of OCPUs available to the node.
        :param builtins.str odh_version: Version of the ODH (Oracle Distribution including Apache Hadoop) for the node.
        :param builtins.str os_version: BDS-assigned Operating System version for the node.
        :param builtins.str shape: (Updatable) Shape of the node.
        :param builtins.str ssh_fingerprint: The fingerprint of the SSH key used for node access
        :param builtins.str state: (Updatable) The target state for the Bds Instance. Could be set to `ACTIVE` or `INACTIVE` to start/stop the bds instance.
        :param builtins.str subnet_id: The OCID of the subnet in which the node will be created.
        :param builtins.str time_created: The time the BDS instance was created. An RFC3339 formatted datetime string
        :param builtins.str time_maintenance_reboot_due: The date and time the instance is expected to be stopped / started, in the format defined by RFC3339.
        """
    ...
    def is_reboot_required(self) -> Optional[builtins.bool]:
        """
    ...
    def local_disks_total_size_in_gbs(self) -> Optional[builtins.float]:
        """
    ...
    def ssh_fingerprint(self) -> Optional[builtins.str]:
        """
    ...
    def time_maintenance_reboot_due(self) -> Optional[builtins.str]:
        """
...
class BdsInstanceNodeAttachedBlockVolume(dict):
    ...
    def __init__(__self__, *,
                 volume_attachment_id: Optional[builtins.str] = None,
                 volume_size_in_gbs: Optional[builtins.str] = None):
        """
        :param builtins.str volume_attachment_id: The OCID of the volume attachment.
        :param builtins.str volume_size_in_gbs: The size of the volume in GBs.
        """
    ...
    def volume_attachment_id(self) -> Optional[builtins.str]:
        """
    ...
    def volume_size_in_gbs(self) -> Optional[builtins.str]:
        """
...
class BdsInstanceOperationCertificateManagementsManagementHostCertDetail(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str certificate: Certificate value in string format
        :param builtins.str host_name: Fully qualified domain name (FQDN) of the host
        :param builtins.str private_key: Private key of the provided certificate
        """
...
class BdsInstanceOsPatchActionPatchingConfig(dict):
    ...
    def __init__(__self__, *,
                 patching_config_strategy: builtins.str,
                 batch_size: Optional[builtins.int] = None,
                 tolerance_threshold_per_batch: Optional[builtins.int] = None,
                 tolerance_threshold_per_domain: Optional[builtins.int] = None,
                 wait_time_between_batch_in_seconds: Optional[builtins.int] = None,
                 wait_time_between_domain_in_seconds: Optional[builtins.int] = None):
        """
        :param builtins.str patching_config_strategy: Type of strategy used for detailed patching configuration
        :param builtins.int batch_size: How many nodes to be patched in each iteration.
        :param builtins.int tolerance_threshold_per_batch: Acceptable number of failed-to-be-patched nodes in each batch. The maximum number of failed-to-patch nodes cannot exceed 20% of the number of nodes.
        :param builtins.int tolerance_threshold_per_domain: Acceptable number of failed-to-be-patched nodes in each domain. The maximum number of failed-to-patch nodes cannot exceed 20% of the number of nodes.
        :param builtins.int wait_time_between_batch_in_seconds: The wait time between batches in seconds.
        :param builtins.int wait_time_between_domain_in_seconds: The wait time between AD/FD in seconds.
        """
    ...
    def patching_config_strategy(self) -> builtins.str:
        """
    ...
    def tolerance_threshold_per_batch(self) -> Optional[builtins.int]:
        """
    ...
    def tolerance_threshold_per_domain(self) -> Optional[builtins.int]:
        """
    ...
    def wait_time_between_batch_in_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def wait_time_between_domain_in_seconds(self) -> Optional[builtins.int]:
        """
...
class BdsInstancePatchActionPatchingConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str patching_config_strategy: Type of strategy used for detailed patching configuration
        :param builtins.int batch_size: How many nodes to be patched in each iteration.
        :param builtins.int tolerance_threshold_per_batch: Acceptable number of failed-to-be-patched nodes in each batch. The maximum number of failed-to-patch nodes cannot exceed 20% of the number of non-utility and non-master nodes.
        :param builtins.int tolerance_threshold_per_domain: Acceptable number of failed-to-be-patched nodes in each domain. The maximum number of failed-to-patch nodes cannot exceed 20% of the number of non-utility and non-master nodes.
        :param builtins.int wait_time_between_batch_in_seconds: The wait time between batches in seconds.
        :param builtins.int wait_time_between_domain_in_seconds: The wait time between AD/FD in seconds.
        """
        pulumi.set(__self__, "patching_config_strategy", patching_config_strategy)
...
class BdsInstanceStartClusterShapeConfigNodeTypeShapeConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 shape: Optional[builtins.str] = None):
        """
        :param builtins.str node_type: BDS instance node type
        :param builtins.str shape: Shape of the node
        """
        if node_type is not None:
            pulumi.set(__self__, "node_type", node_type)
...
class BdsInstanceUtilNode(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int number_of_nodes: The amount of utility nodes should be created.
        :param builtins.str shape: Shape of the node
        :param builtins.str subnet_id: The OCID of the subnet in which the node should be created
        :param builtins.str block_volume_size_in_gbs: The size of block volume in GB that needs to be attached to a given node. All the necessary details needed for attachment are managed by service itself.
...
class GetAutoScalingConfigurationPolicyDetailScaleDownConfigResult(dict):
    def __init__(__self__, *,
                 memory_step_size: builtins.int,
                 metrics: Sequence['outputs.GetAutoScalingConfigurationPolicyDetailScaleDownConfigMetricResult'],
                 min_memory_per_node: builtins.int,
                 min_ocpus_per_node: builtins.int,
                 ocpu_step_size: builtins.int):
        """
        :param builtins.int memory_step_size: For nodes with [flexible compute shapes](https://docs.cloud.oracle.com/iaas/Content/bigdata/create-cluster.htm#cluster-plan-shape), this value is the size of memory in GBs to add to each node during a scale-up event. This value is not used for nodes with fixed compute shapes.
        ...
        :param builtins.int min_memory_per_node: For nodes with [flexible compute shapes](https://docs.cloud.oracle.com/iaas/Content/bigdata/create-cluster.htm#cluster-plan-shape), this value is the minimum memory in GBs each node can be scaled-down to. This value is not used for nodes with fixed compute shapes.
        :param builtins.int min_ocpus_per_node: For nodes with [flexible compute shapes](https://docs.cloud.oracle.com/iaas/Content/bigdata/create-cluster.htm#cluster-plan-shape), this value is the minimum number of OCPUs each node can be scaled-down to. This value is not used for nodes with fixed compute shapes.
        :param builtins.int ocpu_step_size: For nodes with [flexible compute shapes](https://docs.cloud.oracle.com/iaas/Content/bigdata/create-cluster.htm#cluster-plan-shape), this value is the number of OCPUs to add to each node during a scale-up event. This value is not used for nodes with fixed compute shapes.
        """
        pulumi.set(__self__, "memory_step_size", memory_step_size)
    ...
    @property
    @pulumi.getter(name="memoryStepSize")
    def memory_step_size(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="minMemoryPerNode")
    def min_memory_per_node(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="minOcpusPerNode")
    def min_ocpus_per_node(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="ocpuStepSize")
    def ocpu_step_size(self) -> builtins.int:
        """
...
class GetAutoScalingConfigurationPolicyDetailScaleDownConfigMetricResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str metric_type: Allowed values are CPU_UTILIZATION and MEMORY_UTILIZATION.
...
class GetAutoScalingConfigurationPolicyDetailScaleDownConfigMetricThresholdResult(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.int):
        """
        :param builtins.int duration_in_minutes: This value is the minimum period of time the metric value exceeds the threshold value before the action is triggered. The value is in minutes.
        :param builtins.str operator: The comparison operator to use. Options are greater than (GT) or less than (LT).
        :param builtins.int value: Integer non-negative value. 0 < value < 100
        """
        pulumi.set(__self__, "duration_in_minutes", duration_in_minutes)
        pulumi.set(__self__, "operator", operator)
        pulumi.set(__self__, "value", value)
...
class GetAutoScalingConfigurationPolicyDetailScaleInConfigResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.int min_node_count: This value is the minimum number of nodes the cluster can be scaled-in to.
        :param builtins.int step_size: This value is the number of nodes to add during a scale-out event.
        """
        pulumi.set(__self__, "metrics", metrics)
        pulumi.set(__self__, "min_node_count", min_node_count)
        pulumi.set(__self__, "step_size", step_size)
    ...
    @property
    @pulumi.getter(name="stepSize")
    def step_size(self) -> builtins.int:
        """
...
class GetAutoScalingConfigurationPolicyDetailScaleOutConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 step_size: builtins.int):
        """
        :param builtins.int max_node_count: This value is the maximum number of nodes the cluster can be scaled-out to.
...
class GetAutoScalingConfigurationPolicyDetailScaleUpConfigResult(dict):
    def __init__(__self__, *,
                 max_memory_per_node: builtins.int,
                 max_ocpus_per_node: builtins.int,
                 memory_step_size: builtins.int,
                 metrics: Sequence['outputs.GetAutoScalingConfigurationPolicyDetailScaleUpConfigMetricResult'],
                 ocpu_step_size: builtins.int):
        """
        :param builtins.int max_memory_per_node: For nodes with [flexible compute shapes](https://docs.cloud.oracle.com/iaas/Content/bigdata/create-cluster.htm#cluster-plan-shape), this value is the maximum memory in GBs each node can be scaled-up to. This value is not used for nodes with fixed compute shapes.
        :param builtins.int max_ocpus_per_node: For nodes with [flexible compute shapes](https://docs.cloud.oracle.com/iaas/Content/bigdata/create-cluster.htm#cluster-plan-shape), this value is the maximum number of OCPUs each node can be scaled-up to. This value is not used for nodes with fixed compute shapes.
        :param builtins.int memory_step_size: For nodes with [flexible compute shapes](https://docs.cloud.oracle.com/iaas/Content/bigdata/create-cluster.htm#cluster-plan-shape), this value is the size of memory in GBs to add to each node during a scale-up event. This value is not used for nodes with fixed compute shapes.
    ...
    @property
    @pulumi.getter(name="maxMemoryPerNode")
    def max_memory_per_node(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="maxOcpusPerNode")
    def max_ocpus_per_node(self) -> builtins.int:
        """
...
class GetAutoScalingConfigurationPolicyDetailScheduleDetailResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str schedule_type: The type of schedule.
...
class GetAutoScalingConfigurationPolicyDetailScheduleDetailTimeAndHorizontalScalingConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 time_recurrence: builtins.str):
        """
        :param builtins.int target_node_count: This value is the desired number of nodes in the cluster.
        :param builtins.str time_recurrence: Day/time recurrence (specified following RFC 5545) at which to trigger autoscaling action. Currently only WEEKLY frequency is supported. Days of the week are specified using BYDAY field. Time of the day is specified using BYHOUR and BYMINUTE fields. Other fields are not supported.
        """
        pulumi.set(__self__, "target_node_count", target_node_count)
        pulumi.set(__self__, "time_recurrence", time_recurrence)
    ...
    @property
    @pulumi.getter(name="timeRecurrence")
    def time_recurrence(self) -> builtins.str:
        """
...
class GetAutoScalingConfigurationPolicyDetailScheduleDetailTimeAndVerticalScalingConfigResult(dict):
    def __init__(__self__, *,
                 target_memory_per_node: builtins.int,
                 target_ocpus_per_node: builtins.int,
                 target_shape: builtins.str,
                 time_recurrence: builtins.str):
        """
        :param builtins.int target_memory_per_node: For nodes with [flexible compute shapes](https://docs.cloud.oracle.com/iaas/Content/bigdata/create-cluster.htm#cluster-plan-shape), this value is the desired memory in GBs on each node. This value is not used for nodes with fixed compute shapes.
        :param builtins.int target_ocpus_per_node: For nodes with [flexible compute shapes](https://docs.cloud.oracle.com/iaas/Content/bigdata/create-cluster.htm#cluster-plan-shape), this value is the desired OCPUs count on each node. This value is not used for nodes with fixed compute shapes.
        :param builtins.str target_shape: For nodes with [fixed compute shapes](https://docs.cloud.oracle.com/iaas/Content/bigdata/create-cluster.htm#cluster-plan-shape), this value is the desired shape of each node. This value is not used for nodes with flexible compute shapes.
        :param builtins.str time_recurrence: Day/time recurrence (specified following RFC 5545) at which to trigger autoscaling action. Currently only WEEKLY frequency is supported. Days of the week are specified using BYDAY field. Time of the day is specified using BYHOUR and BYMINUTE fields. Other fields are not supported.
        """
        pulumi.set(__self__, "target_memory_per_node", target_memory_per_node)
        pulumi.set(__self__, "target_ocpus_per_node", target_ocpus_per_node)
    ...
    @property
    @pulumi.getter(name="targetMemoryPerNode")
    def target_memory_per_node(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="targetOcpusPerNode")
    def target_ocpus_per_node(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="targetShape")
    def target_shape(self) -> builtins.str:
        """
...
class GetAutoScalingConfigurationPolicyRuleResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: The valid value are CHANGE_SHAPE_SCALE_UP or CHANGE_SHAPE_SCALE_DOWN.
...
class GetBdsClusterVersionsBdsClusterVersionResult(dict):
    ...
    @property
    @pulumi.getter(name="odhVersion")
    def odh_version(self) -> builtins.str:
        """
        ODH version to be used for cluster creation
        """
        return pulumi.get(self, "odh_version")
...
class GetBdsInstanceApiKeysBdsApiKeyResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str default_region: The name of the region to establish the Object Storage endpoint which was set as part of key creation operation. If no region was provided this will be set to be the same region where the cluster lives. Example us-phoenix-1 .
        :param builtins.str domain_ocid: Identity domain OCID ,where user is present. For default domain ,this field will be optional.
        :param builtins.str fingerprint: The fingerprint that corresponds to the public API key requested.
        :param builtins.str id: Identifier of the user's API key.
        :param builtins.str key_alias: User friendly identifier used to uniquely differentiate between different API keys. Only ASCII alphanumeric characters with no spaces allowed.
        :param builtins.str pemfilepath: The full path and file name of the private key used for authentication. This location will be automatically selected on the BDS local file system.
        :param builtins.str state: The current status of the API key.
        :param builtins.str tenant_id: The OCID of your tenancy.
        :param builtins.str time_created: The time the API key was created, shown as an RFC 3339 formatted datetime string.
        :param builtins.str user_id: The user OCID for which this API key was created.
        """
        pulumi.set(__self__, "bds_instance_id", bds_instance_id)
    ...
    @property
    @pulumi.getter
    def pemfilepath(self) -> builtins.str:
        """
...
class GetBdsInstanceCloudSqlDetailResult(dict):
    def __init__(__self__, *,
                 block_volume_size_in_gbs: builtins.str,
                 ip_address: builtins.str,
                 is_kerberos_mapped_to_database_users: builtins.bool,
        ...
        :param builtins.str block_volume_size_in_gbs: The size of block volume in GB that needs to be attached to a given node. All the necessary details needed for attachment are managed by service itself.
        :param builtins.str ip_address: IP address of the node.
        :param builtins.bool is_kerberos_mapped_to_database_users: Boolean flag specifying whether or not Kerberos principals are mapped to database users.
    ...
    @property
    @pulumi.getter(name="blockVolumeSizeInGbs")
    def block_volume_size_in_gbs(self) -> builtins.str:
        """
        The size of block volume in GB that needs to be attached to a given node. All the necessary details needed for attachment are managed by service itself.
        """
        return pulumi.get(self, "block_volume_size_in_gbs")
    ...
    @property
    @pulumi.getter(name="isKerberosMappedToDatabaseUsers")
    def is_kerberos_mapped_to_database_users(self) -> builtins.bool:
        """
...
class GetBdsInstanceCloudSqlDetailKerberosDetailResult(dict):
    ...
    @property
    @pulumi.getter(name="keytabFile")
    def keytab_file(self) -> builtins.str:
        """
        Location of the keytab file
        """
        return pulumi.get(self, "keytab_file")
...
class GetBdsInstanceClusterDetailResult(dict):
    def __init__(__self__, *,
                 ambari_url: builtins.str,
                 bd_cell_version: builtins.str,
                 bda_version: builtins.str,
                 bdm_version: builtins.str,
                 bds_version: builtins.str,
                 big_data_manager_url: builtins.str,
                 cloudera_manager_url: builtins.str,
                 csql_cell_version: builtins.str,
                 db_version: builtins.str,
                 hue_server_url: builtins.str,
                 jupyter_hub_url: builtins.str,
                 odh_version: builtins.str,
                 os_version: builtins.str,
                 time_created: builtins.str,
                 time_refreshed: builtins.str):
        """
        :param builtins.str ambari_url: The URL of Ambari
        :param builtins.str bd_cell_version: Cloud SQL cell version.
        :param builtins.str bda_version: BDA version installed in the cluster
    ...
    @property
    @pulumi.getter(name="ambariUrl")
    def ambari_url(self) -> builtins.str:
        """
        The URL of Ambari
        """
        return pulumi.get(self, "ambari_url")
    ...
    @property
    @pulumi.getter(name="bdCellVersion")
    def bd_cell_version(self) -> builtins.str:
        """
        Cloud SQL cell version.
        """
        return pulumi.get(self, "bd_cell_version")
    ...
    @property
    @pulumi.getter(name="bdaVersion")
    def bda_version(self) -> builtins.str:
        """
        BDA version installed in the cluster
        """
        return pulumi.get(self, "bda_version")
    ...
    @property
    @pulumi.getter(name="bdmVersion")
    def bdm_version(self) -> builtins.str:
        """
        Big Data Manager version installed in the cluster.
        """
        return pulumi.get(self, "bdm_version")
    ...
    @property
    @pulumi.getter(name="bigDataManagerUrl")
    def big_data_manager_url(self) -> builtins.str:
        """
        The URL of Big Data Manager.
        """
        return pulumi.get(self, "big_data_manager_url")
    ...
    @property
    @pulumi.getter(name="clouderaManagerUrl")
    def cloudera_manager_url(self) -> builtins.str:
        """
        The URL of Cloudera Manager
        """
        return pulumi.get(self, "cloudera_manager_url")
    ...
    @property
    @pulumi.getter(name="csqlCellVersion")
    def csql_cell_version(self) -> builtins.str:
        """
        Big Data SQL version.
        """
        return pulumi.get(self, "csql_cell_version")
    ...
    @property
    @pulumi.getter(name="hueServerUrl")
    def hue_server_url(self) -> builtins.str:
        """
        The URL of the Hue server.
        """
        return pulumi.get(self, "hue_server_url")
    ...
    @property
    @pulumi.getter(name="jupyterHubUrl")
    def jupyter_hub_url(self) -> builtins.str:
        """
        The URL of the Jupyterhub.
        """
        return pulumi.get(self, "jupyter_hub_url")
    ...
    @property
    @pulumi.getter(name="timeRefreshed")
    def time_refreshed(self) -> builtins.str:
        """
        The time the cluster was automatically or manually refreshed, shown as an RFC 3339 formatted datetime string.
        """
        return pulumi.get(self, "time_refreshed")
...
class GetBdsInstanceComputeOnlyWorkerNodeResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str block_volume_size_in_gbs: The size of block volume in GB that needs to be attached to a given node. All the necessary details needed for attachment are managed by service itself.
        :param builtins.int number_of_nodes: The number of nodes that form the cluster.
        :param builtins.str shape: Shape of the node.
        :param builtins.str subnet_id: The OCID of the subnet in which the node is to be created.
        """
        pulumi.set(__self__, "block_volume_size_in_gbs", block_volume_size_in_gbs)
        pulumi.set(__self__, "number_of_nodes", number_of_nodes)
        pulumi.set(__self__, "shape", shape)
...
class GetBdsInstanceGetOsPatchTargetPackageResult(dict):
    ...
    def related_cv_es(self) -> Sequence[builtins.str]:
        """
...
class GetBdsInstanceIdentityConfigurationIamUserSyncConfigurationResult(dict):
    def __init__(__self__, *,
                 is_posix_attributes_addition_required: builtins.bool,
                 state: builtins.str,
                 time_created: builtins.str,
                 time_updated: builtins.str):
        """
    ...
    @property
    @pulumi.getter(name="isPosixAttributesAdditionRequired")
    def is_posix_attributes_addition_required(self) -> builtins.bool:
        """
        whether to append POSIX attributes to IAM users
        """
        return pulumi.get(self, "is_posix_attributes_addition_required")
...
class GetBdsInstanceIdentityConfigurationUpstConfigurationResult(dict):
    def __init__(__self__, *,
                 keytab_content: builtins.str,
                 master_encryption_key_id: builtins.str,
                 secret_id: builtins.str,
                 state: builtins.str,
                 time_created: builtins.str,
                 time_token_exchange_keytab_last_refreshed: builtins.str,
                 time_updated: builtins.str,
                 token_exchange_principal_name: builtins.str,
    ...
    @property
    @pulumi.getter(name="keytabContent")
    def keytab_content(self) -> builtins.str:
        """
        The kerberos keytab content used for creating identity propagation trust config, in base64 format
        """
        return pulumi.get(self, "keytab_content")
    ...
    @property
    @pulumi.getter(name="masterEncryptionKeyId")
    def master_encryption_key_id(self) -> builtins.str:
        """
        Master Encryption key used for encrypting token exchange keytab.
        """
        return pulumi.get(self, "master_encryption_key_id")
    ...
    @property
    @pulumi.getter(name="timeTokenExchangeKeytabLastRefreshed")
    def time_token_exchange_keytab_last_refreshed(self) -> builtins.str:
        """
        Time when the keytab for token exchange principal is last refreshed, shown as an RFC 3339 formatted datetime string.
        """
        return pulumi.get(self, "time_token_exchange_keytab_last_refreshed")
    ...
    @property
    @pulumi.getter(name="tokenExchangePrincipalName")
    def token_exchange_principal_name(self) -> builtins.str:
        """
        Token exchange kerberos Principal name in cluster
        """
        return pulumi.get(self, "token_exchange_principal_name")
...
class GetBdsInstanceIdentityConfigurationsIdentityConfigurationResult(dict):
    def __init__(__self__, *,
                 activate_iam_user_sync_configuration_trigger: builtins.str,
                 activate_upst_configuration_trigger: builtins.str,
                 bds_instance_id: builtins.str,
                 cluster_admin_password: builtins.str,
                 confidential_application_id: builtins.str,
                 display_name: builtins.str,
                 ...
                 refresh_confidential_application_trigger: builtins.str,
                 refresh_upst_token_exchange_keytab_trigger: builtins.str,
                 state: builtins.str,
                 time_created: builtins.str,
                 time_updated: builtins.str,
        ...
        """
        :param builtins.str bds_instance_id: The OCID of the cluster.
        :param builtins.str confidential_application_id: identity domain confidential application ID for the identity config
        ...
        :param builtins.str id: The id of the identity config
        :param builtins.str identity_domain_id: Identity domain to use for identity config
...
class GetBdsInstanceListOsPatchesOsPatchResult(dict):
    def __init__(__self__, *,
                 bds_instance_id: builtins.str,
                 os_patch_version: builtins.str,
                 release_date: builtins.str):
        """
        :param builtins.str bds_instance_id: The OCID of the cluster.
        :param builtins.str os_patch_version: Patch version of the os patch.
        :param builtins.str release_date: The time when the OS patch was released.
        """
        pulumi.set(__self__, "bds_instance_id", bds_instance_id)
...
class GetBdsInstanceMetastoreConfigsBdsMetastoreConfigurationResult(dict):
    def __init__(__self__, *,
                 activate_trigger: builtins.int,
                 bds_api_key_id: builtins.str,
                 bds_api_key_passphrase: builtins.str,
                 bds_instance_id: builtins.str,
                 cluster_admin_password: builtins.str,
                 display_name: builtins.str,
                 id: builtins.str,
        ...
        :param builtins.str bds_instance_id: The OCID of the cluster.
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param builtins.str id: The ID of the metastore configuration
        ...
        :param builtins.str time_created: The time when the configuration was created, shown as an RFC 3339 formatted datetime string.
        :param builtins.str time_updated: The time when the configuration was updated, shown as an RFC 3339 formatted datetime string.
        """
...
class GetBdsInstanceNetworkConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 is_nat_gateway_required: builtins.bool):
        """
        :param builtins.str cidr_block: The CIDR IP address block of the VCN.
        :param builtins.bool is_nat_gateway_required: A boolean flag whether to configure a NAT gateway.
        """
        pulumi.set(__self__, "cidr_block", cidr_block)
        pulumi.set(__self__, "is_nat_gateway_required", is_nat_gateway_required)
    ...
    @property
    @pulumi.getter(name="isNatGatewayRequired")
    def is_nat_gateway_required(self) -> builtins.bool:
        """
...
class GetBdsInstanceNodeResult(dict):
    def __init__(__self__, *,
                 ...
                 os_version: builtins.str,
                 shape: builtins.str,
                 ssh_fingerprint: builtins.str,
                 state: builtins.str,
                 subnet_id: builtins.str,
                 time_created: builtins.str,
                 time_maintenance_reboot_due: builtins.str):
        """
        ...
        :param builtins.str availability_domain: The name of the availability domain in which the node is running.
        :param builtins.str display_name: The name of the node.
        :param builtins.str fault_domain: The name of the fault domain in which the node is running.
        :param builtins.str hostname: The fully-qualified hostname (FQDN) of the node.
        :param builtins.str image_id: The OCID of the image from which the node was created.
        :param builtins.str instance_id: The OCID of the underlying Oracle Cloud Infrastructure Compute instance.
        :param builtins.str ip_address: IP address of the node.
        :param builtins.bool is_reboot_required: Indicates if the node requires a reboot to either reflect the latest os kernel or take actions for maintenance reboot.
        :param builtins.float local_disks_total_size_in_gbs: The aggregate size of all local disks, in gigabytes. If the instance does not have any local disks, this field is null.
        :param builtins.int memory_in_gbs: The total amount of memory available to the node, in gigabytes.
        :param builtins.str node_type: Cluster node type.
        :param builtins.int nvmes: The number of NVMe drives to be used for storage. A single drive has 6.8 TB available.
        :param builtins.int ocpus: The total number of OCPUs available to the node.
        :param builtins.str odh_version: Version of the ODH (Oracle Distribution including Apache Hadoop) for the node.
        :param builtins.str os_version: BDS-assigned Operating System version for the node.
    ...
    @property
    @pulumi.getter(name="sshFingerprint")
    def ssh_fingerprint(self) -> builtins.str:
        """
        The fingerprint of the SSH key used for node access.
        """
        return pulumi.get(self, "ssh_fingerprint")
...
class GetBdsInstanceNodeAttachedBlockVolumeResult(dict):
    def __init__(__self__, *,
                 volume_attachment_id: builtins.str,
                 volume_size_in_gbs: builtins.str):
        """
        :param builtins.str volume_attachment_id: The OCID of the volume attachment.
        :param builtins.str volume_size_in_gbs: The size of the volume in GBs.
        """
    ...
    @property
    @pulumi.getter(name="volumeAttachmentId")
    def volume_attachment_id(self) -> builtins.str:
        """
        The OCID of the volume attachment.
        """
        return pulumi.get(self, "volume_attachment_id")
    ...
    @property
    @pulumi.getter(name="volumeSizeInGbs")
    def volume_size_in_gbs(self) -> builtins.str:
        """
        The size of the volume in GBs.
        """
        return pulumi.get(self, "volume_size_in_gbs")
...
class GetBdsInstancePatchHistoriesPatchHistoryResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str patch_type: The type of a BDS patch history entity.
        :param builtins.str state: The status of the patch.
        :param builtins.str time_updated: The time when the patch history was last updated.
        :param builtins.str version: The version of the patch.
        """
...
class GetBdsInstancePatchesPatchResult(dict):
    def __init__(__self__, *,
                 ...
                 version: builtins.str):
        """
        :param builtins.str time_released: The time when the patch was released.
        :param builtins.str version: The version of the patch.
        """
...
class GetBdsInstanceResourcePrincipalConfigurationsResourcePrincipalConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 cluster_admin_password: builtins.str,
                 display_name: builtins.str,
                 force_refresh_resource_principal_trigger: builtins.int,
                 id: builtins.str,
                 session_token_life_span_duration_in_hours: builtins.int,
                 state: builtins.str,
                 time_created: builtins.str,
                 time_token_expiry: builtins.str,
                 time_token_refreshed: builtins.str,
                 time_updated: builtins.str):
        """
        :param builtins.str bds_instance_id: The OCID of the cluster.
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param builtins.str id: The id of the ResourcePrincipalConfiguration.
        :param builtins.int session_token_life_span_duration_in_hours: Life span in hours of each resource principal session token.
        :param builtins.str state: The state of the ResourcePrincipalConfiguration.
        :param builtins.str time_created: The time the ResourcePrincipalConfiguration was created, shown as an RFC 3339 formatted datetime string.
        :param builtins.str time_token_expiry: the time the resource principal session token will expired, shown as an rfc 3339 formatted datetime string.
        :param builtins.str time_token_refreshed: the time the resource principal session token was refreshed, shown as an rfc 3339 formatted datetime string.
        :param builtins.str time_updated: The time the ResourcePrincipalConfiguration was updated, shown as an RFC 3339 formatted datetime string.
        """
        pulumi.set(__self__, "bds_instance_id", bds_instance_id)
        pulumi.set(__self__, "cluster_admin_password", cluster_admin_password)
        pulumi.set(__self__, "display_name", display_name)
...
class GetBdsInstancesBdsInstanceResult(dict):
    def __init__(__self__, *,
                 ...
                 bootstrap_script_url: builtins.str,
                 ...
                 cluster_profile: builtins.str,
                 cluster_public_key: builtins.str,
                 ...
                 id: builtins.str,
                 ignore_existing_nodes_shapes: Sequence[builtins.str],
                 is_cloud_sql_configured: builtins.bool,
                 is_force_remove_enabled: builtins.bool,
                 is_force_stop_jobs: builtins.bool,
                 is_high_availability: builtins.bool,
                 is_kafka_configured: builtins.bool,
                 is_secure: builtins.bool,
                 kafka_broker_nodes: Sequence['outputs.GetBdsInstancesBdsInstanceKafkaBrokerNodeResult'],
                 kerberos_realm_name: builtins.str,
                 ...
                 number_of_nodes: builtins.int,
                 number_of_nodes_requiring_maintenance_reboot: builtins.int,
                 os_patch_version: builtins.str,
                 remove_node: builtins.str,
        ...
        :param builtins.str bootstrap_script_url: pre-authenticated URL of the bootstrap script in Object Store that can be downloaded and executed.
        ...
        :param builtins.str cluster_profile: Profile of the Big Data Service cluster.
        :param builtins.str cluster_version: Version of the Hadoop distribution.
        :param builtins.str compartment_id: The OCID of the compartment.
        :param builtins.str created_by: The user who created the cluster.
        ...
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type, or scope. Exists for cross-compatibility only. For example, `{"bar-key": "value"}`
        :param builtins.str id: The OCID of the Big Data Service resource.
        :param builtins.bool is_cloud_sql_configured: Boolean flag specifying whether or not Cloud SQL should be configured.
        :param builtins.bool is_high_availability: Boolean flag specifying whether or not the cluster is highly available (HA)
        :param builtins.bool is_kafka_configured: Boolean flag specifying whether or not Kafka should be configured.
        :param builtins.bool is_secure: Boolean flag specifying whether or not the cluster should be set up as secure.
        :param builtins.str kms_key_id: The OCID of the Key Management master encryption key.
        ...
        :param builtins.int number_of_nodes: The number of nodes that form the cluster.
        :param builtins.int number_of_nodes_requiring_maintenance_reboot: Number of nodes that require a maintenance reboot
        :param builtins.str state: The state of the cluster.
        :param builtins.str time_created: The time the cluster was created, shown as an RFC 3339 formatted datetime string.
        :param builtins.str time_updated: The time the cluster was updated, shown as an RFC 3339 formatted datetime string.
        """
