...
class BlockchainPlatformArgs:
    def __init__(__self__, *,
                 ...
                 compute_shape: pulumi.Input[builtins.str],
                 display_name: pulumi.Input[builtins.str],
                 idcs_access_token: pulumi.Input[builtins.str],
                 platform_role: pulumi.Input[builtins.str],
                 ca_cert_archive_text: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 federated_user_id: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_byol: Optional[pulumi.Input[builtins.bool]] = None,
                 load_balancer_shape: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 storage_size_in_tbs: Optional[pulumi.Input[builtins.float]] = None,
                 total_ocpu_capacity: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] compute_shape: Compute shape - STANDARD or ENTERPRISE_SMALL or ENTERPRISE_MEDIUM or ENTERPRISE_LARGE or ENTERPRISE_EXTRA_LARGE
        :param pulumi.Input[builtins.str] display_name: Platform Instance Display name, can be renamed
        :param pulumi.Input[builtins.str] idcs_access_token: IDCS access token with Identity Domain Administrator role
        :param pulumi.Input[builtins.str] platform_role: Role of platform - founder or participant
        :param pulumi.Input[builtins.str] ca_cert_archive_text: Base64 encoded text in ASCII character set of a Thirdparty CA Certificates archive file. The Archive file is a zip file containing third part CA Certificates, the ca key and certificate files used when issuing enrollment certificates (ECerts) and transaction certificates (TCerts). The chainfile (if it exists) contains the certificate chain which should be trusted for this CA, where the 1st in the chain is always the root CA certificate. File list in zip file [ca-cert.pem,ca-key.pem,ca-chain.pem(optional)].
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Platform Instance Description
        :param pulumi.Input[builtins.str] federated_user_id: Identifier for a federated user
        ...
        :param pulumi.Input[builtins.bool] is_byol: Bring your own license
        :param pulumi.Input[builtins.str] load_balancer_shape: (Updatable) Type of Load Balancer shape - LB_100_MBPS or LB_400_MBPS. Default is LB_100_MBPS.
        ...
        :param pulumi.Input[builtins.float] storage_size_in_tbs: Storage size in TBs
        :param pulumi.Input[builtins.int] total_ocpu_capacity: Number of total OCPUs allocated to the platform cluster
        """
    ...
    def compute_shape(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def compute_shape(self, value: pulumi.Input[builtins.str]):
    ...
    def platform_role(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def platform_role(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "platform_role", value)

    @property
    @pulumi.getter(name="caCertArchiveText")
    def ca_cert_archive_text(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ca_cert_archive_text(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def federated_user_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def federated_user_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def load_balancer_shape(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def load_balancer_shape(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def storage_size_in_tbs(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Storage size in TBs
        """
    ...
    def storage_size_in_tbs(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "storage_size_in_tbs", value)

    @property
    @pulumi.getter(name="totalOcpuCapacity")
    def total_ocpu_capacity(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def total_ocpu_capacity(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _BlockchainPlatformState:
    def __init__(__self__, *,
                 ...
                 compute_shape: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 is_byol: Optional[pulumi.Input[builtins.bool]] = None,
                 is_multi_ad: Optional[pulumi.Input[builtins.bool]] = None,
                 lifecycle_details: Optional[pulumi.Input[builtins.str]] = None,
                 load_balancer_shape: Optional[pulumi.Input[builtins.str]] = None,
                 platform_role: Optional[pulumi.Input[builtins.str]] = None,
                 platform_shape_type: Optional[pulumi.Input[builtins.str]] = None,
                 platform_version: Optional[pulumi.Input[builtins.str]] = None,
                 replicas: Optional[pulumi.Input['BlockchainPlatformReplicasArgs']] = None,
                 ...
                 storage_size_in_tbs: Optional[pulumi.Input[builtins.float]] = None,
                 storage_used_in_tbs: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input[builtins.str] idcs_access_token: IDCS access token with Identity Domain Administrator role
        :param pulumi.Input[builtins.bool] is_byol: Bring your own license
        :param pulumi.Input[builtins.bool] is_multi_ad: True for multi-AD blockchain plaforms, false for single-AD
        :param pulumi.Input[builtins.str] lifecycle_details: An message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        :param pulumi.Input[builtins.str] load_balancer_shape: (Updatable) Type of Load Balancer shape - LB_100_MBPS or LB_400_MBPS. Default is LB_100_MBPS.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] platform_role: Role of platform - founder or participant
        :param pulumi.Input[builtins.str] platform_shape_type: Type of Platform shape - DEFAULT or CUSTOM
        :param pulumi.Input[builtins.str] platform_version: Platform version
        :param pulumi.Input['BlockchainPlatformReplicasArgs'] replicas: Number of replicas of service components like Rest Proxy, CA and Console
        :param pulumi.Input[builtins.str] service_endpoint: Service endpoint URL, valid post-provisioning
        :param pulumi.Input[builtins.str] service_version: The version of the Platform Instance.
        :param pulumi.Input[builtins.str] state: The current state of the Platform Instance.
        :param pulumi.Input[builtins.float] storage_size_in_tbs: Storage size in TBs
        :param pulumi.Input[builtins.float] storage_used_in_tbs: Storage used in TBs
        :param pulumi.Input[builtins.str] time_created: The time the the Platform Instance was created. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.str] time_updated: The time the Platform Instance was updated. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.int] total_ocpu_capacity: Number of total OCPUs allocated to the platform cluster
        """
        if ca_cert_archive_text is not None:
            pulumi.set(__self__, "ca_cert_archive_text", ca_cert_archive_text)
    ...
    @property
    @pulumi.getter(name="computeShape")
    def compute_shape(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Compute shape - STANDARD or ENTERPRISE_SMALL or ENTERPRISE_MEDIUM or ENTERPRISE_LARGE or ENTERPRISE_EXTRA_LARGE
        """
        return pulumi.get(self, "compute_shape")
    ...
    @compute_shape.setter
    def compute_shape(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "compute_shape", value)
    ...
    def is_multi_ad(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_multi_ad.setter
    def is_multi_ad(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter(name="platformRole")
    def platform_role(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Role of platform - founder or participant
        """
        return pulumi.get(self, "platform_role")
    ...
    @platform_role.setter
    def platform_role(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "platform_role", value)

    @property
    @pulumi.getter(name="platformShapeType")
    def platform_shape_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def platform_shape_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def storage_used_in_tbs(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Storage used in TBs
        """
    ...
    def storage_used_in_tbs(self, value: Optional[pulumi.Input[builtins.float]]):
...
class BlockchainPlatform(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            total_ocpu_capacity: Optional[pulumi.Input[builtins.int]] = None) -> 'BlockchainPlatform':
        """
    ...
    @property
    @pulumi.getter(name="caCertArchiveText")
    def ca_cert_archive_text(self) -> pulumi.Output[builtins.str]:
        """
        Base64 encoded text in ASCII character set of a Thirdparty CA Certificates archive file. The Archive file is a zip file containing third part CA Certificates, the ca key and certificate files used when issuing enrollment certificates (ECerts) and transaction certificates (TCerts). The chainfile (if it exists) contains the certificate chain which should be trusted for this CA, where the 1st in the chain is always the root CA certificate. File list in zip file [ca-cert.pem,ca-key.pem,ca-chain.pem(optional)].
        """
        return pulumi.get(self, "ca_cert_archive_text")
    ...
    @property
    @pulumi.getter(name="computeShape")
    def compute_shape(self) -> pulumi.Output[builtins.str]:
        """
        Compute shape - STANDARD or ENTERPRISE_SMALL or ENTERPRISE_MEDIUM or ENTERPRISE_LARGE or ENTERPRISE_EXTRA_LARGE
        """
        return pulumi.get(self, "compute_shape")
    ...
    @property
    @pulumi.getter(name="federatedUserId")
    def federated_user_id(self) -> pulumi.Output[builtins.str]:
        """
        Identifier for a federated user
        """
        return pulumi.get(self, "federated_user_id")
    ...
    @property
    @pulumi.getter(name="isMultiAd")
    def is_multi_ad(self) -> pulumi.Output[builtins.bool]:
        """
        True for multi-AD blockchain plaforms, false for single-AD
        """
        return pulumi.get(self, "is_multi_ad")
    ...
    @property
    @pulumi.getter(name="loadBalancerShape")
    def load_balancer_shape(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Type of Load Balancer shape - LB_100_MBPS or LB_400_MBPS. Default is LB_100_MBPS.
    ...
    @property
    @pulumi.getter(name="platformRole")
    def platform_role(self) -> pulumi.Output[builtins.str]:
        """
        Role of platform - founder or participant
        """
        return pulumi.get(self, "platform_role")
    ...
    @property
    @pulumi.getter(name="platformShapeType")
    def platform_shape_type(self) -> pulumi.Output[builtins.str]:
        """
        Type of Platform shape - DEFAULT or CUSTOM
        """
        return pulumi.get(self, "platform_shape_type")
    ...
    @property
    @pulumi.getter(name="storageSizeInTbs")
    def storage_size_in_tbs(self) -> pulumi.Output[builtins.float]:
        """
        Storage size in TBs
        """
        return pulumi.get(self, "storage_size_in_tbs")
    ...
    @property
    @pulumi.getter(name="storageUsedInTbs")
    def storage_used_in_tbs(self) -> pulumi.Output[builtins.float]:
        """
        Storage used in TBs
        """
        return pulumi.get(self, "storage_used_in_tbs")
    ...
    @property
    @pulumi.getter(name="totalOcpuCapacity")
    def total_ocpu_capacity(self) -> pulumi.Output[builtins.int]:
        """
        Number of total OCPUs allocated to the platform cluster
        """
        return pulumi.get(self, "total_ocpu_capacity")
