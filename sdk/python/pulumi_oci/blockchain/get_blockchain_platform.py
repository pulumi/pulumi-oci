...
def get_blockchain_platform(blockchain_platform_id: Optional[builtins.str] = None,
...
def get_blockchain_platform_output(blockchain_platform_id: Optional[pulumi.Input[builtins.str]] = None,
