...
def get_blockchain_platform_patches(blockchain_platform_id: Optional[builtins.str] = None,
...
def get_blockchain_platform_patches_output(blockchain_platform_id: Optional[pulumi.Input[builtins.str]] = None,
