...
def get_blockchain_platforms(compartment_id: Optional[str] = None,
    ...
    test_blockchain_platforms = oci.Blockchain.get_blockchain_platforms(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetBlockchainPlatformsResult(
        blockchain_platform_collections=__ret__.blockchain_platform_collections,
