...
def get_osn(blockchain_platform_id: Optional[builtins.str] = None,
            osn_id: Optional[builtins.str] = None,
    ...
    :param builtins.str osn_id: OSN identifier.
    """
    __args__ = dict()
...
def get_osn_output(blockchain_platform_id: Optional[pulumi.Input[builtins.str]] = None,
                   osn_id: Optional[pulumi.Input[builtins.str]] = None,
