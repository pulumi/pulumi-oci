...
def get_peer(blockchain_platform_id: Optional[builtins.str] = None,
    ...
    :param builtins.str peer_id: Peer identifier.
    """
    __args__ = dict()
...
def get_peer_output(blockchain_platform_id: Optional[pulumi.Input[builtins.str]] = None,
