...
class BudgetArgs:
    def __init__(__self__, *,
                 ...
                 reset_period: pulumi.Input[builtins.str],
                 budget_processing_period_start_offset: Optional[pulumi.Input[builtins.int]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 end_date: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 processing_period_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) The description of the budget.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The displayName of the budget. Avoid entering confidential information.
        :param pulumi.Input[builtins.str] end_date: (Updatable) The date when the one-time budget concludes. For example, `2023-03-23`. The date-time format conforms to RFC 3339, and will be truncated to the starting point of the date provided after being converted to UTC time.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] processing_period_type: (Updatable) The type of the budget processing period. Valid values are INVOICE, MONTH, and SINGLE_USE.
        :param pulumi.Input[builtins.str] start_date: (Updatable) The date when the one-time budget begins. For example, `2023-03-23`. The date-time format conforms to RFC 3339, and will be truncated to the starting point of the date provided after being converted to UTC time.
        :param pulumi.Input[builtins.str] target_compartment_id: This is DEPRECATED. Set the target compartment ID in targets instead.
        :param pulumi.Input[builtins.str] target_type: The type of target on which the budget is applied.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] targets: The list of targets on which the budget is applied. If targetType is "COMPARTMENT", the targets contain the list of compartment OCIDs. If targetType is "TAG", the targets contain the list of cost tracking tag identifiers in the form of "{tagNamespace}.{tagKey}.{tagValue}". Curerntly, the array should contain exactly one item. 
    ...
    def reset_period(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @reset_period.setter
    def reset_period(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "reset_period", value)

    @property
    @pulumi.getter(name="budgetProcessingPeriodStartOffset")
    def budget_processing_period_start_offset(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def budget_processing_period_start_offset(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def processing_period_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def processing_period_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _BudgetState:
    def __init__(__self__, *,
                 actual_spend: Optional[pulumi.Input[builtins.float]] = None,
                 alert_rule_count: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 end_date: Optional[pulumi.Input[builtins.str]] = None,
                 forecasted_spend: Optional[pulumi.Input[builtins.float]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 processing_period_type: Optional[pulumi.Input[builtins.str]] = None,
                 reset_period: Optional[pulumi.Input[builtins.str]] = None,
                 start_date: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 time_spend_computed: Optional[pulumi.Input[builtins.str]] = None,
                 time_updated: Optional[pulumi.Input[builtins.str]] = None,
                 version: Optional[pulumi.Input[builtins.int]] = None):
        """
        Input properties used for looking up and filtering Budget resources.
        :param pulumi.Input[builtins.float] actual_spend: The actual spend in currency for the current budget cycle.
        :param pulumi.Input[builtins.int] alert_rule_count: The total number of alert rules in the budget.
        :param pulumi.Input[builtins.int] amount: (Updatable) The amount of the budget expressed as a whole number in the currency of the customer's rate card.
        :param pulumi.Input[builtins.int] budget_processing_period_start_offset: (Updatable) The number of days offset from the first day of the month, at which the budget processing period starts. In months that have fewer days than this value, processing will begin on the last day of that month. For example, for a value of 12, processing starts every month on the 12th at midnight.
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The displayName of the budget. Avoid entering confidential information.
        :param pulumi.Input[builtins.str] end_date: (Updatable) The date when the one-time budget concludes. For example, `2023-03-23`. The date-time format conforms to RFC 3339, and will be truncated to the starting point of the date provided after being converted to UTC time.
        :param pulumi.Input[builtins.float] forecasted_spend: The forecasted spend in currency by the end of the current budget cycle.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] processing_period_type: (Updatable) The type of the budget processing period. Valid values are INVOICE, MONTH, and SINGLE_USE.
        :param pulumi.Input[builtins.str] reset_period: (Updatable) The reset period for the budget. Valid value is MONTHLY.
        :param pulumi.Input[builtins.str] start_date: (Updatable) The date when the one-time budget begins. For example, `2023-03-23`. The date-time format conforms to RFC 3339, and will be truncated to the starting point of the date provided after being converted to UTC time.
        :param pulumi.Input[builtins.str] state: The current state of the budget.
        :param pulumi.Input[builtins.str] target_compartment_id: This is DEPRECATED. Set the target compartment ID in targets instead.
        :param pulumi.Input[builtins.str] target_type: The type of target on which the budget is applied.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] targets: The list of targets on which the budget is applied. If targetType is "COMPARTMENT", the targets contain the list of compartment OCIDs. If targetType is "TAG", the targets contain the list of cost tracking tag identifiers in the form of "{tagNamespace}.{tagKey}.{tagValue}". Curerntly, the array should contain exactly one item. 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] time_created: The time that the budget was created.
        :param pulumi.Input[builtins.str] time_spend_computed: The time that the budget spend was last computed.
        :param pulumi.Input[builtins.str] time_updated: The time that the budget was updated.
        :param pulumi.Input[builtins.int] version: The version of the budget. Starts from 1 and increments by 1.
        """
    ...
    def actual_spend(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    @actual_spend.setter
    def actual_spend(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "actual_spend", value)

    @property
    @pulumi.getter(name="alertRuleCount")
    def alert_rule_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def alert_rule_count(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def forecasted_spend(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def forecasted_spend(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    @property
    @pulumi.getter(name="resetPeriod")
    def reset_period(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The reset period for the budget. Valid value is MONTHLY.
        """
        return pulumi.get(self, "reset_period")
    ...
    @reset_period.setter
    def reset_period(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "reset_period", value)
    ...
    def time_spend_computed(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_spend_computed(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Budget(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_spend_computed: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'Budget':
        """
    ...
    @property
    @pulumi.getter(name="actualSpend")
    def actual_spend(self) -> pulumi.Output[builtins.float]:
        """
        The actual spend in currency for the current budget cycle.
        """
        return pulumi.get(self, "actual_spend")
    ...
    @property
    @pulumi.getter(name="alertRuleCount")
    def alert_rule_count(self) -> pulumi.Output[builtins.int]:
        """
        The total number of alert rules in the budget.
        """
        return pulumi.get(self, "alert_rule_count")
    ...
    @property
    @pulumi.getter(name="budgetProcessingPeriodStartOffset")
    def budget_processing_period_start_offset(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The number of days offset from the first day of the month, at which the budget processing period starts. In months that have fewer days than this value, processing will begin on the last day of that month. For example, for a value of 12, processing starts every month on the 12th at midnight.
        """
        return pulumi.get(self, "budget_processing_period_start_offset")
    ...
    @property
    @pulumi.getter(name="forecastedSpend")
    def forecasted_spend(self) -> pulumi.Output[builtins.float]:
        """
        The forecasted spend in currency by the end of the current budget cycle.
        """
        return pulumi.get(self, "forecasted_spend")
    ...
    @property
    @pulumi.getter(name="processingPeriodType")
    def processing_period_type(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The type of the budget processing period. Valid values are INVOICE, MONTH, and SINGLE_USE.
        """
        return pulumi.get(self, "processing_period_type")
    ...
    @property
    @pulumi.getter(name="resetPeriod")
    def reset_period(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The reset period for the budget. Valid value is MONTHLY.
        """
        return pulumi.get(self, "reset_period")
    ...
    @property
    @pulumi.getter(name="timeSpendComputed")
    def time_spend_computed(self) -> pulumi.Output[builtins.str]:
        """
        The time that the budget spend was last computed.
        """
        return pulumi.get(self, "time_spend_computed")
