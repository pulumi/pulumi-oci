...
class GetAlertRuleResult:
    ...
    def alert_rule_id(self) -> builtins.str:
...
def get_alert_rule(alert_rule_id: Optional[builtins.str] = None,
                   budget_id: Optional[builtins.str] = None,
    ...
    :param builtins.str alert_rule_id: The unique Alert Rule OCID.
...
def get_alert_rule_output(alert_rule_id: Optional[pulumi.Input[builtins.str]] = None,
