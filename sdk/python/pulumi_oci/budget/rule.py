...
class RuleArgs:
    def __init__(__self__, *,
                 budget_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] budget_id: The unique budget OCID.
        :param pulumi.Input[builtins.float] threshold: (Updatable) The threshold for triggering the alert, expressed as a whole number or decimal value. If the thresholdType is ABSOLUTE, the threshold can have at most 12 digits before the decimal point, and up to two digits after the decimal point. If the thresholdType is PERCENTAGE, the maximum value is 10000 and can have up to two digits after the decimal point.
        :param pulumi.Input[builtins.str] threshold_type: (Updatable) The type of threshold.
        :param pulumi.Input[builtins.str] type: (Updatable) The type of the alert. Valid values are ACTUAL (the alert triggers based on actual usage), or FORECAST (the alert triggers based on predicted usage). 
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) The description of the alert rule.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The name of the alert rule. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] message: (Updatable) The message to be sent to the recipients when the alert rule is triggered.
        :param pulumi.Input[builtins.str] recipients: (Updatable) The audience that receives the alert when it triggers. An empty string is interpreted as null.
        """
    ...
    def budget_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @budget_id.setter
    def budget_id(self, value: pulumi.Input[builtins.str]):
...
class _RuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] message: (Updatable) The message to be sent to the recipients when the alert rule is triggered.
        :param pulumi.Input[builtins.str] recipients: (Updatable) The audience that receives the alert when it triggers. An empty string is interpreted as null.
        :param pulumi.Input[builtins.str] state: The current state of the alert rule.
        :param pulumi.Input[builtins.float] threshold: (Updatable) The threshold for triggering the alert, expressed as a whole number or decimal value. If the thresholdType is ABSOLUTE, the threshold can have at most 12 digits before the decimal point, and up to two digits after the decimal point. If the thresholdType is PERCENTAGE, the maximum value is 10000 and can have up to two digits after the decimal point.
        :param pulumi.Input[builtins.str] threshold_type: (Updatable) The type of threshold.
        :param pulumi.Input[builtins.str] time_created: The time when the budget was created.
        :param pulumi.Input[builtins.str] time_updated: The time when the budget was updated.
        :param pulumi.Input[builtins.str] type: (Updatable) The type of the alert. Valid values are ACTUAL (the alert triggers based on actual usage), or FORECAST (the alert triggers based on predicted usage). 
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.int] version: The version of the alert rule. Starts from 1 and increments by 1.
        """
...
class Rule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'Rule':
        """
    ...
    @property
    @pulumi.getter
    def recipients(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (Updatable) The audience that receives the alert when it triggers. An empty string is interpreted as null.
        """
        return pulumi.get(self, "recipients")
    ...
    @property
    @pulumi.getter(name="thresholdType")
    def threshold_type(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The type of threshold.
        """
        return pulumi.get(self, "threshold_type")
