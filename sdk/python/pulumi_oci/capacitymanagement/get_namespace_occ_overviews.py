...
def get_namespace_occ_overviews(compartment_id: Optional[builtins.str] = None,
...
def get_namespace_occ_overviews_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
