...
def get_occ_availability_catalog(occ_availability_catalog_id: Optional[builtins.str] = None,
    ...
    :param builtins.str occ_availability_catalog_id: The OCID of the availability catalog.
    """
    __args__ = dict()
...
def get_occ_availability_catalog_output(occ_availability_catalog_id: Optional[pulumi.Input[builtins.str]] = None,
