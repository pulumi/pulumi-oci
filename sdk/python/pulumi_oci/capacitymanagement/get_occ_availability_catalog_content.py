...
def get_occ_availability_catalog_content(occ_availability_catalog_id: Optional[builtins.str] = None,
...
def get_occ_availability_catalog_content_output(occ_availability_catalog_id: Optional[pulumi.Input[builtins.str]] = None,
