...
def get_occ_availability_catalogs(catalog_state: Optional[builtins.str] = None,
...
def get_occ_availability_catalogs_output(catalog_state: Optional[pulumi.Input[Optional[builtins.str]]] = None,
