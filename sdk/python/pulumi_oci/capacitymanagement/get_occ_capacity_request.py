...
def get_occ_capacity_request(occ_capacity_request_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str occ_capacity_request_id: The OCID of the capacity request.
    """
    __args__ = dict()
