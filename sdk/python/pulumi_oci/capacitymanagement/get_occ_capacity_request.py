...
def get_occ_capacity_request(occ_capacity_request_id: Optional[builtins.str] = None,
    ...
    :param builtins.str occ_capacity_request_id: The OCID of the capacity request.
    """
    __args__ = dict()
...
def get_occ_capacity_request_output(occ_capacity_request_id: Optional[pulumi.Input[builtins.str]] = None,
