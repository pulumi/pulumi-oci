...
def get_occ_customer_group(occ_customer_group_id: Optional[builtins.str] = None,
...
def get_occ_customer_group_output(occ_customer_group_id: Optional[pulumi.Input[builtins.str]] = None,
