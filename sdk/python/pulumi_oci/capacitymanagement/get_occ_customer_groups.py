...
def get_occ_customer_groups(compartment_id: Optional[builtins.str] = None,
...
def get_occ_customer_groups_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
