...
def get_occ_handover_resource_block_details(filters: Optional[Sequence[Union['GetOccHandoverResourceBlockDetailsFilterArgs', 'GetOccHandoverResourceBlockDetailsFilterArgsDict']]] = None,
    ...
    :param builtins.str host_id: This fiter is applicable only for COMPUTE namespace. It helps in fetching of all resource block details for which the hostId is equal to the one provided in this query param.
    :param builtins.str occ_handover_resource_block_id: The OCID of the OccHandoverResource which is a required query parameter for listing OccHandoverResourceDetails.
    """
    __args__ = dict()
