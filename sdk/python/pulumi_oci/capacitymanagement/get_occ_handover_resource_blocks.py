...
def get_occ_handover_resource_blocks(compartment_id: Optional[builtins.str] = None,
...
def get_occ_handover_resource_blocks_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
