...
class OccAvailabilityCatalogArgs:
    def __init__(__self__, *,
                 base64encoded_catalog_details: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] base64encoded_catalog_details: The base 64 encoded string corresponding to the catalog file contents.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the availability catalog.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Additional information about the availability catalog.
    ...
    def base64encoded_catalog_details(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def base64encoded_catalog_details(self, value: pulumi.Input[builtins.str]):
...
class _OccAvailabilityCatalogState:
    def __init__(__self__, *,
                 base64encoded_catalog_details: Optional[pulumi.Input[builtins.str]] = None,
                 catalog_state: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] base64encoded_catalog_details: The base 64 encoded string corresponding to the catalog file contents.
        :param pulumi.Input[builtins.str] catalog_state: The different states associated with the availability catalog.
        :param pulumi.Input[builtins.str] compartment_id: Since all resources are at tenancy level hence this will be the ocid of the tenancy where operation is to be performed.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] description: (Updatable) Additional information about the availability catalog.
        ...
        :param pulumi.Input[builtins.str] time_created: The time when the availability catalog was created.
        :param pulumi.Input[builtins.str] time_updated: The time when the availability catalog was last updated.
        """
    ...
    @property
    @pulumi.getter(name="base64encodedCatalogDetails")
    def base64encoded_catalog_details(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The base 64 encoded string corresponding to the catalog file contents.
        """
        return pulumi.get(self, "base64encoded_catalog_details")
    ...
    @base64encoded_catalog_details.setter
    def base64encoded_catalog_details(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "base64encoded_catalog_details", value)

    @property
    @pulumi.getter(name="catalogState")
    def catalog_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def catalog_state(self, value: Optional[pulumi.Input[builtins.str]]):
...
class OccAvailabilityCatalog(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'OccAvailabilityCatalog':
        """
    ...
    @property
    @pulumi.getter(name="base64encodedCatalogDetails")
    def base64encoded_catalog_details(self) -> pulumi.Output[builtins.str]:
        """
        The base 64 encoded string corresponding to the catalog file contents.
        """
        return pulumi.get(self, "base64encoded_catalog_details")
    ...
    @property
    @pulumi.getter(name="catalogState")
    def catalog_state(self) -> pulumi.Output[builtins.str]:
        """
        The different states associated with the availability catalog.
        """
        return pulumi.get(self, "catalog_state")
