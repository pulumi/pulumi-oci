...
class OccAvailabilityCatalogArgs:
    def __init__(__self__, *,
                 base64encoded_catalog_details: pulumi.Input[_builtins.str],
                 ...
                 metadata_details: pulumi.Input[Optional['OccAvailabilityCatalogMetadataDetailsArgs']] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] description: (Updatable) Additional information about the availability catalog.
    ...
    def base64encoded_catalog_details(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def base64encoded_catalog_details(self, value: pulumi.Input[_builtins.str]):
    ...
    def metadata_details(self) -> pulumi.Input[Optional['OccAvailabilityCatalogMetadataDetailsArgs']]:
        """
    ...
    def metadata_details(self, value: pulumi.Input[Optional['OccAvailabilityCatalogMetadataDetailsArgs']]):
...
class _OccAvailabilityCatalogState:
    def __init__(__self__, *,
                 base64encoded_catalog_details: pulumi.Input[Optional[_builtins.str]] = None,
                 catalog_state: pulumi.Input[Optional[_builtins.str]] = None,
                 compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 details: pulumi.Input[Optional[Sequence[pulumi.Input['OccAvailabilityCatalogDetailArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] time_created: The time when the availability catalog was created.
        :param pulumi.Input[_builtins.str] time_updated: The time when the availability catalog was last updated.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="base64encodedCatalogDetails")
    def base64encoded_catalog_details(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The base 64 encoded string corresponding to the catalog file contents.
        """
        return pulumi.get(self, "base64encoded_catalog_details")
    ...
    @base64encoded_catalog_details.setter
    def base64encoded_catalog_details(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "base64encoded_catalog_details", value)

    @_builtins.property
    @pulumi.getter(name="catalogState")
    def catalog_state(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def catalog_state(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    @_builtins.property
    @pulumi.getter
    def details(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['OccAvailabilityCatalogDetailArgs']]]]:
        """
    ...
    @details.setter
    def details(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['OccAvailabilityCatalogDetailArgs']]]]):
...
class OccAvailabilityCatalog(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 metadata_details: pulumi.Input[Optional[Union['OccAvailabilityCatalogMetadataDetailsArgs', 'OccAvailabilityCatalogMetadataDetailsArgsDict', 'outputs.OccAvailabilityCatalogMetadataDetails']]] = None,
                 namespace: pulumi.Input[Optional[_builtins.str]] = None,
                 occ_customer_group_id: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] display_name: (Updatable) The display name of the availability catalog.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[Union['OccAvailabilityCatalogMetadataDetailsArgs', 'OccAvailabilityCatalogMetadataDetailsArgsDict', 'outputs.OccAvailabilityCatalogMetadataDetails']] metadata_details: Used for representing the metadata of the catalog. This denotes the version and format of the CSV file for parsing.
        :param pulumi.Input[_builtins.str] namespace: The name of the Oracle Cloud Infrastructure service in consideration. For example, Compute, Exadata, and so on.
        :param pulumi.Input[_builtins.str] occ_customer_group_id: The OCID of the customer group.
    ...
    def get(resource_name: str,
            ...
            defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            description: pulumi.Input[Optional[_builtins.str]] = None,
            details: pulumi.Input[Optional[Sequence[pulumi.Input[Union['OccAvailabilityCatalogDetailArgs', 'OccAvailabilityCatalogDetailArgsDict', 'outputs.OccAvailabilityCatalogDetail']]]]] = None,
            display_name: pulumi.Input[Optional[_builtins.str]] = None,
            freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            lifecycle_details: pulumi.Input[Optional[_builtins.str]] = None,
            metadata_details: pulumi.Input[Optional[Union['OccAvailabilityCatalogMetadataDetailsArgs', 'OccAvailabilityCatalogMetadataDetailsArgsDict', 'outputs.OccAvailabilityCatalogMetadataDetails']]] = None,
            ...
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None) -> 'OccAvailabilityCatalog':
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[_builtins.str] description: (Updatable) Additional information about the availability catalog.
        :param pulumi.Input[Sequence[pulumi.Input[Union['OccAvailabilityCatalogDetailArgs', 'OccAvailabilityCatalogDetailArgsDict', 'outputs.OccAvailabilityCatalogDetail']]]] details: Details about capacity available for different resources in catalog.
        :param pulumi.Input[_builtins.str] display_name: (Updatable) The display name of the availability catalog.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[_builtins.str] lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in a Failed State.
        :param pulumi.Input[Union['OccAvailabilityCatalogMetadataDetailsArgs', 'OccAvailabilityCatalogMetadataDetailsArgsDict', 'outputs.OccAvailabilityCatalogMetadataDetails']] metadata_details: Used for representing the metadata of the catalog. This denotes the version and format of the CSV file for parsing.
    ...
    @_builtins.property
    @pulumi.getter(name="base64encodedCatalogDetails")
    def base64encoded_catalog_details(self) -> pulumi.Output[_builtins.str]:
        """
        The base 64 encoded string corresponding to the catalog file contents.
        """
        return pulumi.get(self, "base64encoded_catalog_details")
    ...
    @_builtins.property
    @pulumi.getter(name="catalogState")
    def catalog_state(self) -> pulumi.Output[_builtins.str]:
        """
        The different states associated with the availability catalog.
        """
        return pulumi.get(self, "catalog_state")
