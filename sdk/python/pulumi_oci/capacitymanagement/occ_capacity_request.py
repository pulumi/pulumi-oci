...
class OccCapacityRequestArgs:
    def __init__(__self__, *,
                 ...
                 date_expected_capacity_handover: pulumi.Input[builtins.str],
                 details: pulumi.Input[Sequence[pulumi.Input['OccCapacityRequestDetailArgs']]],
                 display_name: pulumi.Input[builtins.str],
                 namespace: pulumi.Input[builtins.str],
                 occ_availability_catalog_id: pulumi.Input[builtins.str],
                 ...
                 request_state: Optional[pulumi.Input[builtins.str]] = None,
                 request_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a OccCapacityRequest resource.
        :param pulumi.Input[builtins.str] compartment_id: Since all resources are at tenancy level hence this will be the ocid of the tenancy where operation is to be performed.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) An user-friendly name for the capacity request. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        ...
        :param pulumi.Input[builtins.str] occ_availability_catalog_id: The OCID of the availability catalog against which capacity request is made.
        :param pulumi.Input[builtins.str] region: The name of the region for which the capacity request is made.
        :param pulumi.Input[builtins.str] availability_domain: The availability domain (AD) in which the new resource is to be placed. If this is specified then the capacity will be validated and fulfilled within the scope of this AD. Note that this field is NOT required for Capacity request Transfer requests.
        ...
        :param pulumi.Input[builtins.str] description: Meaningful text about the capacity request.
        ...
        :param pulumi.Input[builtins.str] lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in a Failed State.
        :param pulumi.Input[Sequence[pulumi.Input['OccCapacityRequestPatchOperationArgs']]] patch_operations: (Updatable)
        :param pulumi.Input[builtins.str] request_state: (Updatable) The subset of request states available for creating the capacity request.
        :param pulumi.Input[builtins.str] request_type: Type of Capacity Request(New or Transfer)
    ...
    def date_expected_capacity_handover(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def date_expected_capacity_handover(self, value: pulumi.Input[builtins.str]):
    ...
    def occ_availability_catalog_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def occ_availability_catalog_id(self, value: pulumi.Input[builtins.str]):
    ...
    def request_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def request_state(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _OccCapacityRequestState:
    def __init__(__self__, *,
                 ...
                 occ_availability_catalog_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] namespace: The name of the Oracle Cloud Infrastructure service in consideration. For example, Compute, Exadata, and so on.
        :param pulumi.Input[builtins.str] occ_availability_catalog_id: The OCID of the availability catalog against which capacity request is made.
        :param pulumi.Input[builtins.str] occ_customer_group_id: The OCID of the customer group to which this customer belongs to.
        :param pulumi.Input[Sequence[pulumi.Input['OccCapacityRequestPatchOperationArgs']]] patch_operations: (Updatable)
        :param pulumi.Input[builtins.str] region: The name of the region for which the capacity request is made.
        :param pulumi.Input[builtins.str] request_state: (Updatable) The subset of request states available for creating the capacity request.
        :param pulumi.Input[builtins.str] request_type: Type of Capacity Request(New or Transfer)
        ...
        :param pulumi.Input[builtins.str] time_created: The time when the capacity request was created.
        :param pulumi.Input[builtins.str] time_updated: The time when the capacity request was updated.
        """
        if availability_domain is not None:
            pulumi.set(__self__, "availability_domain", availability_domain)
    ...
    @property
    @pulumi.getter(name="occAvailabilityCatalogId")
    def occ_availability_catalog_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The OCID of the availability catalog against which capacity request is made.
        """
        return pulumi.get(self, "occ_availability_catalog_id")
    ...
    @occ_availability_catalog_id.setter
    def occ_availability_catalog_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "occ_availability_catalog_id", value)
...
class OccCapacityRequest(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'OccCapacityRequest':
        """
    ...
    @property
    @pulumi.getter(name="dateExpectedCapacityHandover")
    def date_expected_capacity_handover(self) -> pulumi.Output[builtins.str]:
        """
        The date by which the capacity requested by customers before dateFinalCustomerOrder needs to be fulfilled.
        """
        return pulumi.get(self, "date_expected_capacity_handover")
    ...
    @property
    @pulumi.getter(name="occAvailabilityCatalogId")
    def occ_availability_catalog_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the availability catalog against which capacity request is made.
        """
        return pulumi.get(self, "occ_availability_catalog_id")
    ...
    @property
    @pulumi.getter(name="requestState")
    def request_state(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The subset of request states available for creating the capacity request.
        """
        return pulumi.get(self, "request_state")
