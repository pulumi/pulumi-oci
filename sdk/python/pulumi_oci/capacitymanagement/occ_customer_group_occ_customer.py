...
class OccCustomerGroupOccCustomerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name for the customer.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) The description about the customer group.
        :param pulumi.Input[builtins.str] status: (Updatable) To determine whether the customer is enabled/disabled.
        """
...
class OccCustomerGroupOccCustomer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            occ_customer_group_id: Optional[pulumi.Input[builtins.str]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None,
            tenancy_id: Optional[pulumi.Input[builtins.str]] = None) -> 'OccCustomerGroupOccCustomer':
        """
