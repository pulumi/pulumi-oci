...
class _CaBundleState:
    def __init__(__self__, *,
                 ca_bundle_pem: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="caBundlePem")
    def ca_bundle_pem(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        (Updatable) Certificates (in PEM format) to include in the CA bundle.
        """
        return pulumi.get(self, "ca_bundle_pem")
    ...
    @ca_bundle_pem.setter
    def ca_bundle_pem(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "ca_bundle_pem", value)
...
class CaBundle(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: pulumi.Input[Optional[_builtins.str]] = None,
            state: pulumi.Input[Optional[_builtins.str]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None) -> 'CaBundle':
        """
