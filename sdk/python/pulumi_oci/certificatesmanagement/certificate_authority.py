...
class CertificateAuthorityArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The compartment in which you want to create the CA.
        :param pulumi.Input[builtins.str] kms_key_id: The OCID of the Oracle Cloud Infrastructure Vault key used to encrypt the CA.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) A brief description of the CA.
        ...
        :param pulumi.Input[builtins.str] name: A user-friendly name for the CA. Names are unique within a compartment. Avoid entering confidential information. Valid characters include uppercase or lowercase letters, numbers, hyphens, underscores, and periods.
...
class _CertificateAuthorityState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['CertificateAuthorityCertificateRevocationListDetailsArgs'] certificate_revocation_list_details: (Updatable) The details of the certificate revocation list (CRL).
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The compartment in which you want to create the CA.
        :param pulumi.Input[builtins.str] config_type: The origin of the CA.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) A brief description of the CA.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.str] issuer_certificate_authority_id: The OCID of the parent CA that issued this CA. If this is the root CA, then this value is null.
        :param pulumi.Input[builtins.str] kms_key_id: The OCID of the Oracle Cloud Infrastructure Vault key used to encrypt the CA.
        :param pulumi.Input[builtins.str] lifecycle_details: Additional information about the current CA lifecycle state.
        :param pulumi.Input[builtins.str] name: A user-friendly name for the CA. Names are unique within a compartment. Avoid entering confidential information. Valid characters include uppercase or lowercase letters, numbers, hyphens, underscores, and periods.
        ...
        :param pulumi.Input[builtins.str] state: The current lifecycle state of the certificate authority.
...
class CertificateAuthority(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_of_deletion: Optional[pulumi.Input[builtins.str]] = None) -> 'CertificateAuthority':
        """
