...
def get_association(association_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str association_id: The OCID of an association between a certificate-related resource and another Oracle Cloud Infrastructure resource.
    """
    __args__ = dict()
