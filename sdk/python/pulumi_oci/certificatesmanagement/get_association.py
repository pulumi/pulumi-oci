...
def get_association(association_id: Optional[builtins.str] = None,
    ...
    :param builtins.str association_id: The OCID of an association between a certificate-related resource and another Oracle Cloud Infrastructure resource.
    """
    __args__ = dict()
...
def get_association_output(association_id: Optional[pulumi.Input[builtins.str]] = None,
