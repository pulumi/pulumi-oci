...
class GetAssociationsResult:
    ...
    def associated_resource_id(self) -> Optional[builtins.str]:
        """
    ...
    def certificates_resource_id(self) -> Optional[builtins.str]:
        """
...
def get_associations(associated_resource_id: Optional[builtins.str] = None,
                     association_id: Optional[builtins.str] = None,
                     association_type: Optional[builtins.str] = None,
                     certificates_resource_id: Optional[builtins.str] = None,
    ...
    :param builtins.str associated_resource_id: A filter that returns only resources that match the given OCID of an associated Oracle Cloud Infrastructure resource.
    :param builtins.str association_id: The OCID of the association. If the parameter is set to null, the service lists all associations.
    :param builtins.str association_type: Type of associations to list. If the parameter is set to null, the service lists all types of associations.
    :param builtins.str certificates_resource_id: A filter that returns only resources that match the given OCID of a certificate-related resource.
    :param builtins.str compartment_id: A filter that returns only resources that match the given compartment OCID.
    :param builtins.str name: A filter that returns only resources that match the specified name.
    """
    __args__ = dict()
...
def get_associations_output(associated_resource_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            association_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            association_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            certificates_resource_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
