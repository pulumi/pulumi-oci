...
def get_ca_bundles(ca_bundle_id: Optional[builtins.str] = None,
    ...
    :param builtins.str ca_bundle_id: The OCID of the CA bundle.
    ...
    :param builtins.str state: A filter that returns only resources that match the given lifecycle state. The state value is case-insensitive.
    """
    __args__ = dict()
...
def get_ca_bundles_output(ca_bundle_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
