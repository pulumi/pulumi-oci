...
def get_certificate(certificate_id: Optional[str] = None,
    ...
    test_certificate = oci.CertificatesManagement.get_certificate(certificate_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
    ```
    ...
    return AwaitableGetCertificateResult(
        certificate_configs=__ret__.certificate_configs,
        certificate_id=__ret__.certificate_id,
        certificate_profile_type=__ret__.certificate_profile_type,
        certificate_revocation_list_details=__ret__.certificate_revocation_list_details,
        certificate_rules=__ret__.certificate_rules,
