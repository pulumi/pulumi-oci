...
def get_certificate_authorities(certificate_authority_id: Optional[builtins.str] = None,
...
def get_certificate_authorities_output(certificate_authority_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
