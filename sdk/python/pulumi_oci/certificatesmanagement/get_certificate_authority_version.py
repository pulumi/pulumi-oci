...
def get_certificate_authority_version(certificate_authority_id: Optional[_builtins.str] = None,
                                      certificate_authority_version_number: Optional[_builtins.str] = None,
