...
class GetCertificateAuthorityVersionResult:
    ...
    def certificate_authority_version_number(self) -> builtins.str:
...
def get_certificate_authority_version(certificate_authority_id: Optional[builtins.str] = None,
                                      certificate_authority_version_number: Optional[builtins.str] = None,
...
def get_certificate_authority_version_output(certificate_authority_id: Optional[pulumi.Input[builtins.str]] = None,
                                             certificate_authority_version_number: Optional[pulumi.Input[builtins.str]] = None,
