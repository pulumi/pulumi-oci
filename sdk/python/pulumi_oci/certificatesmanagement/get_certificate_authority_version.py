...
def get_certificate_authority_version(certificate_authority_id: Optional[str] = None,
    ...
    test_certificate_authority_version = oci.CertificatesManagement.get_certificate_authority_version(certificate_authority_id=oci_certificates_management_certificate_authority["test_certificate_authority"]["id"],
    ...
    return AwaitableGetCertificateAuthorityVersionResult(
        ...
        certificate_authority_version_number=__ret__.certificate_authority_version_number,
        id=__ret__.id,
