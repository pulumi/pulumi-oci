...
class GetCertificateVersionResult:
    ...
    def certificate_version_number(self) -> _builtins.str:
...
def get_certificate_version(certificate_id: Optional[_builtins.str] = None,
                            certificate_version_number: Optional[_builtins.str] = None,
    ...
    :param _builtins.str certificate_version_number: The version number of the certificate.
    """
    __args__ = dict()
...
def get_certificate_version_output(certificate_id: Optional[pulumi.Input[_builtins.str]] = None,
                                   certificate_version_number: Optional[pulumi.Input[_builtins.str]] = None,
