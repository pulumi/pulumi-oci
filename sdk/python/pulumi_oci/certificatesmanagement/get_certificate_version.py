...
class GetCertificateVersionResult:
    ...
    def certificate_version_number(self) -> builtins.str:
...
def get_certificate_version(certificate_id: Optional[builtins.str] = None,
                            certificate_version_number: Optional[builtins.str] = None,
    ...
    :param builtins.str certificate_version_number: The version number of the certificate.
    """
    __args__ = dict()
...
def get_certificate_version_output(certificate_id: Optional[pulumi.Input[builtins.str]] = None,
                                   certificate_version_number: Optional[pulumi.Input[builtins.str]] = None,
