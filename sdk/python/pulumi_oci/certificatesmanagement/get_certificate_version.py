...
def get_certificate_version_output(certificate_id: pulumi.Input[Optional[_builtins.str]] = None,
                                   certificate_version_number: pulumi.Input[Optional[_builtins.str]] = None,
