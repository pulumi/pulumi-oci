...
def get_certificate_versions(certificate_id: Optional[builtins.str] = None,
...
def get_certificate_versions_output(certificate_id: Optional[pulumi.Input[builtins.str]] = None,
