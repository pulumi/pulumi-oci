...
class AgentArgs:
    def __init__(__self__, *,
                 agent_type: pulumi.Input[builtins.str],
                 agent_version: pulumi.Input[builtins.str],
                 compartment_id: pulumi.Input[builtins.str],
                 display_name: pulumi.Input[builtins.str],
                 environment_id: pulumi.Input[builtins.str],
                 os_version: pulumi.Input[builtins.str],
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Agent resource.
        :param pulumi.Input[builtins.str] agent_type: Agent identifier.
        :param pulumi.Input[builtins.str] agent_version: Agent identifier.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) Compartment identifier.
        :param pulumi.Input[builtins.str] display_name: (Updatable) Agent identifier.
        :param pulumi.Input[builtins.str] environment_id: Environment identifier.
        :param pulumi.Input[builtins.str] os_version: OS version.
    ...
    def agent_type(self) -> pulumi.Input[builtins.str]:
        """
        Agent identifier.
        """
    ...
    @agent_type.setter
    def agent_type(self, value: pulumi.Input[builtins.str]):
    ...
    def os_version(self) -> pulumi.Input[builtins.str]:
        """
        OS version.
    ...
    @os_version.setter
    def os_version(self, value: pulumi.Input[builtins.str]):
...
class _AgentState:
    def __init__(__self__, *,
                 agent_pub_key: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 heart_beat_status: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 time_expire_agent_key_in_ms: Optional[pulumi.Input[builtins.str]] = None,
                 time_last_sync_received: Optional[pulumi.Input[builtins.str]] = None,
                 time_updated: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Agent resources.
        :param pulumi.Input[builtins.str] agent_pub_key: Resource principal public key.
        :param pulumi.Input[builtins.str] agent_type: Agent identifier.
        :param pulumi.Input[builtins.str] agent_version: Agent identifier.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) Compartment identifier.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) The defined tags associated with this resource, if any. Each key is predefined and scoped to namespaces. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        ...
        :param pulumi.Input[builtins.str] environment_id: Environment identifier.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) The freeform tags associated with this resource, if any. Each tag is a simple key-value pair with no predefined name, type, or namespace/scope. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] heart_beat_status: The current heartbeat status of the Agent based on its timeLastSyncReceived value.
        ...
        :param pulumi.Input[builtins.str] time_expire_agent_key_in_ms: The time since epoch for when the public key will expire. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_last_sync_received: The time when the last heartbeat of the Agent was noted. An RFC3339 formatted datetime string.
    ...
    def agent_pub_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def agent_pub_key(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def heart_beat_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def heart_beat_status(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_expire_agent_key_in_ms(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_expire_agent_key_in_ms(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_expire_agent_key_in_ms", value)

    @property
    @pulumi.getter(name="timeLastSyncReceived")
    def time_last_sync_received(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_last_sync_received(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Agent(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_expire_agent_key_in_ms: Optional[pulumi.Input[builtins.str]] = None,
            time_last_sync_received: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'Agent':
        """
    ...
    @property
    @pulumi.getter(name="agentPubKey")
    def agent_pub_key(self) -> pulumi.Output[builtins.str]:
        """
        Resource principal public key.
        """
        return pulumi.get(self, "agent_pub_key")
    ...
    @property
    @pulumi.getter(name="heartBeatStatus")
    def heart_beat_status(self) -> pulumi.Output[builtins.str]:
        """
        The current heartbeat status of the Agent based on its timeLastSyncReceived value.
        """
        return pulumi.get(self, "heart_beat_status")
    ...
    @property
    @pulumi.getter(name="timeExpireAgentKeyInMs")
    def time_expire_agent_key_in_ms(self) -> pulumi.Output[builtins.str]:
        """
        The time since epoch for when the public key will expire. An RFC3339 formatted datetime string.
        """
        return pulumi.get(self, "time_expire_agent_key_in_ms")
    ...
    @property
    @pulumi.getter(name="timeLastSyncReceived")
    def time_last_sync_received(self) -> pulumi.Output[builtins.str]:
        """
        The time when the last heartbeat of the Agent was noted. An RFC3339 formatted datetime string.
        """
        return pulumi.get(self, "time_last_sync_received")
