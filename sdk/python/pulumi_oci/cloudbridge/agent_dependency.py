...
class AgentDependencyArgs:
    def __init__(__self__, *,
                 ...
                 dependency_name: pulumi.Input[_builtins.str],
                 display_name: pulumi.Input[_builtins.str],
                 namespace: pulumi.Input[_builtins.str],
                 object: pulumi.Input[_builtins.str],
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 dependency_version: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] display_name: (Updatable) Display name of the Agent dependency.
        :param pulumi.Input[_builtins.str] namespace: (Updatable) Object storage namespace associated with the customer's tenancy.
        :param pulumi.Input[_builtins.str] object: (Updatable) Name of the dependency object uploaded by the customer.
        ...
        :param pulumi.Input[_builtins.str] dependency_version: (Updatable) Version of the Agent dependency.
        :param pulumi.Input[_builtins.str] description: (Updatable) Description about the Agent dependency.
    ...
    def dependency_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def dependency_name(self, value: pulumi.Input[_builtins.str]):
    ...
    def dependency_version(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    def dependency_version(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class _AgentDependencyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: (Updatable) Description about the Agent dependency.
        :param pulumi.Input[_builtins.str] display_name: (Updatable) Display name of the Agent dependency.
        :param pulumi.Input[_builtins.str] e_tag: The eTag associated with the dependency object returned by Object Storage.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) The freeform tags associated with this resource, if any. Each tag is a simple key-value pair with no predefined name, type, or namespace/scope. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        ...
        :param pulumi.Input[_builtins.str] namespace: (Updatable) Object storage namespace associated with the customer's tenancy.
        :param pulumi.Input[_builtins.str] object: (Updatable) Name of the dependency object uploaded by the customer.
        :param pulumi.Input[_builtins.str] state: The current state of AgentDependency.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] system_tags: (Updatable) The system tags associated with this resource, if any. The system tags are set by Oracle cloud infrastructure services. Each key is predefined and scoped to namespaces. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{orcl-cloud: {free-tier-retain: true}}` 
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] time_created: The time when the AgentDependency was created. An RFC3339 formatted datetime string.
        """
...
class AgentDependency(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[_builtins.str]] = None,
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[_builtins.str]] = None) -> 'AgentDependency':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dependencyName")
    def dependency_name(self) -> pulumi.Output[_builtins.str]:
        """
        (Updatable) Name of the dependency type. This should match the whitelisted enum of dependency names.
        """
        return pulumi.get(self, "dependency_name")
    ...
    @_builtins.property
    @pulumi.getter(name="dependencyVersion")
    def dependency_version(self) -> pulumi.Output[_builtins.str]:
        """
        (Updatable) Version of the Agent dependency.
        """
        return pulumi.get(self, "dependency_version")
