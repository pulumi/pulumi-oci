...
class AgentPluginArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] agent_id: Unique Agent identifier path parameter.
        :param pulumi.Input[builtins.str] plugin_name: Unique plugin identifier path parameter.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] desired_state: (Updatable) State to which the customer wants the plugin to move to.
        """
...
class _AgentPluginState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] agent_id: Unique Agent identifier path parameter.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: The defined tags associated with this resource, if any. Each key is predefined and scoped to namespaces. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] desired_state: (Updatable) State to which the customer wants the plugin to move to.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: The freeform tags associated with this resource, if any. Each tag is a simple key-value pair with no predefined name, type, or namespace/scope. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        ...
        :param pulumi.Input[builtins.str] state: The current state of the plugin.
...
class AgentPlugin(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'AgentPlugin':
        """
