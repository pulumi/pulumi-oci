...
class AssetArgs:
    def __init__(__self__, *,
                 asset_type: pulumi.Input[builtins.str],
                 compartment_id: pulumi.Input[builtins.str],
                 external_asset_key: pulumi.Input[builtins.str],
                 inventory_id: pulumi.Input[builtins.str],
                 source_key: pulumi.Input[builtins.str],
                 asset_source_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] asset_type: (Updatable) The type of asset.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment that the asset belongs to.
        :param pulumi.Input[builtins.str] external_asset_key: The key of the asset from the external environment.
        :param pulumi.Input[builtins.str] inventory_id: Inventory ID to which an asset belongs.
        :param pulumi.Input[builtins.str] source_key: The source key to which the asset belongs.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] asset_source_ids: (Updatable) List of asset source OCID.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) Asset display name.
    ...
    def asset_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @asset_type.setter
    def asset_type(self, value: pulumi.Input[builtins.str]):
    ...
    def external_asset_key(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def external_asset_key(self, value: pulumi.Input[builtins.str]):
    ...
    def source_key(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @source_key.setter
    def source_key(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "source_key", value)

    @property
    @pulumi.getter(name="assetSourceIds")
    def asset_source_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def asset_source_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _AssetState:
    def __init__(__self__, *,
                 ...
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 external_asset_key: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 inventory_id: Optional[pulumi.Input[builtins.str]] = None,
                 source_key: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] inventory_id: Inventory ID to which an asset belongs.
        :param pulumi.Input[builtins.str] source_key: The source key to which the asset belongs.
        :param pulumi.Input[builtins.str] state: The current state of the asset.
        ...
        :param pulumi.Input[builtins.str] time_created: The time when the asset was created. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The time when the asset was updated. An RFC3339 formatted datetime string.
        :param pulumi.Input['AssetVmArgs'] vm: (Updatable) Virtual machine related properties.
        :param pulumi.Input['AssetVmwareVcenterArgs'] vmware_vcenter: (Updatable) VMware vCenter related properties.
        :param pulumi.Input['AssetVmwareVmArgs'] vmware_vm: (Updatable) VMware virtual machine related properties.
        """
    ...
    @property
    @pulumi.getter(name="externalAssetKey")
    def external_asset_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The key of the asset from the external environment.
        """
        return pulumi.get(self, "external_asset_key")
    ...
    @external_asset_key.setter
    def external_asset_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "external_asset_key", value)
    ...
    @property
    @pulumi.getter(name="sourceKey")
    def source_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The source key to which the asset belongs.
        """
        return pulumi.get(self, "source_key")
    ...
    @source_key.setter
    def source_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_key", value)
...
class Asset(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="assetSourceIds")
    def asset_source_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) List of asset source OCID.
        """
        return pulumi.get(self, "asset_source_ids")
    ...
    @property
    @pulumi.getter(name="assetType")
    def asset_type(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The type of asset.
        """
        return pulumi.get(self, "asset_type")
    ...
    @property
    @pulumi.getter(name="externalAssetKey")
    def external_asset_key(self) -> pulumi.Output[builtins.str]:
        """
        The key of the asset from the external environment.
        """
        return pulumi.get(self, "external_asset_key")
    ...
    @property
    @pulumi.getter(name="sourceKey")
    def source_key(self) -> pulumi.Output[builtins.str]:
        """
        The source key to which the asset belongs.
        """
        return pulumi.get(self, "source_key")
