...
class AssetSourceArgs:
    def __init__(__self__, *,
                 assets_compartment_id: pulumi.Input[builtins.str],
                 ...
                 vcenter_endpoint: pulumi.Input[builtins.str],
                 are_historical_metrics_collected: Optional[pulumi.Input[builtins.bool]] = None,
                 are_realtime_metrics_collected: Optional[pulumi.Input[builtins.bool]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 discovery_schedule_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] assets_compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that is going to be used to create assets.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment for the resource.
        :param pulumi.Input['AssetSourceDiscoveryCredentialsArgs'] discovery_credentials: (Updatable) Credentials for an asset source.
        :param pulumi.Input[builtins.str] environment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the environment.
        :param pulumi.Input[builtins.str] inventory_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the inventory that will contain created assets.
        :param pulumi.Input[builtins.str] type: (Updatable) Asset source type.
        :param pulumi.Input[builtins.str] vcenter_endpoint: (Updatable) Endpoint for VMware asset discovery and replication in the form of ```https://<host>:<port>/sdk```
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.bool] are_historical_metrics_collected: (Updatable) Flag indicating whether historical metrics are collected for assets, originating from this asset source.
        :param pulumi.Input[builtins.bool] are_realtime_metrics_collected: (Updatable) Flag indicating whether real-time metrics are collected for assets, originating from this asset source.
        ...
        :param pulumi.Input[builtins.str] discovery_schedule_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the discovery schedule that is going to be attached to the created asset.
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name for the asset source. Does not have to be unique, and it's mutable. Avoid entering confidential information. The name is generated by the service if it is not explicitly provided.
    ...
    def assets_compartment_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def assets_compartment_id(self, value: pulumi.Input[builtins.str]):
    ...
    def vcenter_endpoint(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def vcenter_endpoint(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "vcenter_endpoint", value)

    @property
    @pulumi.getter(name="areHistoricalMetricsCollected")
    def are_historical_metrics_collected(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def are_historical_metrics_collected(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "are_historical_metrics_collected", value)

    @property
    @pulumi.getter(name="areRealtimeMetricsCollected")
    def are_realtime_metrics_collected(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def are_realtime_metrics_collected(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def discovery_schedule_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def discovery_schedule_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AssetSourceState:
    def __init__(__self__, *,
                 are_historical_metrics_collected: Optional[pulumi.Input[builtins.bool]] = None,
                 are_realtime_metrics_collected: Optional[pulumi.Input[builtins.bool]] = None,
                 assets_compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 vcenter_endpoint: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) The freeform tags associated with this resource, if any. Each tag is a simple key-value pair with no predefined name, type, or namespace/scope. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] inventory_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the inventory that will contain created assets.
        :param pulumi.Input[builtins.str] lifecycle_details: The detailed state of the asset source.
        :param pulumi.Input['AssetSourceReplicationCredentialsArgs'] replication_credentials: (Updatable) Credentials for an asset source.
        :param pulumi.Input[builtins.str] state: The current state of the asset source.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] system_tags: (Updatable) The system tags associated with this resource, if any. The system tags are set by Oracle cloud infrastructure services. Each key is predefined and scoped to namespaces. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{orcl-cloud: {free-tier-retain: true}}`
        :param pulumi.Input[builtins.str] time_created: The time when the asset source was created in the RFC3339 format.
        :param pulumi.Input[builtins.str] time_updated: The point in time that the asset source was last updated in the RFC3339 format.
        :param pulumi.Input[builtins.str] type: (Updatable) Asset source type.
        :param pulumi.Input[builtins.str] vcenter_endpoint: (Updatable) Endpoint for VMware asset discovery and replication in the form of ```https://<host>:<port>/sdk```
    ...
    @property
    @pulumi.getter(name="assetsCompartmentId")
    def assets_compartment_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that is going to be used to create assets.
        """
        return pulumi.get(self, "assets_compartment_id")
    ...
    @assets_compartment_id.setter
    def assets_compartment_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "assets_compartment_id", value)
    ...
    @property
    @pulumi.getter(name="vcenterEndpoint")
    def vcenter_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Endpoint for VMware asset discovery and replication in the form of ```https://<host>:<port>/sdk```
    ...
    @vcenter_endpoint.setter
    def vcenter_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vcenter_endpoint", value)
...
class AssetSource(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment for the resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) The defined tags associated with this resource, if any. Each key is predefined and scoped to namespaces. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[Union['AssetSourceDiscoveryCredentialsArgs', 'AssetSourceDiscoveryCredentialsArgsDict']] discovery_credentials: (Updatable) Credentials for an asset source.
        :param pulumi.Input[builtins.str] discovery_schedule_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the discovery schedule that is going to be attached to the created asset.
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name for the asset source. Does not have to be unique, and it's mutable. Avoid entering confidential information. The name is generated by the service if it is not explicitly provided.
        :param pulumi.Input[builtins.str] environment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the environment.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) The freeform tags associated with this resource, if any. Each tag is a simple key-value pair with no predefined name, type, or namespace/scope. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] inventory_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the inventory that will contain created assets.
        :param pulumi.Input[Union['AssetSourceReplicationCredentialsArgs', 'AssetSourceReplicationCredentialsArgsDict']] replication_credentials: (Updatable) Credentials for an asset source.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] system_tags: (Updatable) The system tags associated with this resource, if any. The system tags are set by Oracle cloud infrastructure services. Each key is predefined and scoped to namespaces. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{orcl-cloud: {free-tier-retain: true}}`
        :param pulumi.Input[builtins.str] type: (Updatable) Asset source type.
        :param pulumi.Input[builtins.str] vcenter_endpoint: (Updatable) Endpoint for VMware asset discovery and replication in the form of ```https://<host>:<port>/sdk```
    ...
    def get(resource_name: str,
            ...
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            vcenter_endpoint: Optional[pulumi.Input[builtins.str]] = None) -> 'AssetSource':
        """
    ...
    @property
    @pulumi.getter(name="areHistoricalMetricsCollected")
    def are_historical_metrics_collected(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Flag indicating whether historical metrics are collected for assets, originating from this asset source.
        """
        return pulumi.get(self, "are_historical_metrics_collected")
    ...
    @property
    @pulumi.getter(name="areRealtimeMetricsCollected")
    def are_realtime_metrics_collected(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Flag indicating whether real-time metrics are collected for assets, originating from this asset source.
        """
        return pulumi.get(self, "are_realtime_metrics_collected")
    ...
    @property
    @pulumi.getter(name="assetsCompartmentId")
    def assets_compartment_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that is going to be used to create assets.
        """
        return pulumi.get(self, "assets_compartment_id")
    ...
    @property
    @pulumi.getter(name="discoveryScheduleId")
    def discovery_schedule_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the discovery schedule that is going to be attached to the created asset.
        """
        return pulumi.get(self, "discovery_schedule_id")
    ...
    @property
    @pulumi.getter(name="vcenterEndpoint")
    def vcenter_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Endpoint for VMware asset discovery and replication in the form of ```https://<host>:<port>/sdk```
