...
class AssetSourceArgs:
    def __init__(__self__, *,
                 assets_compartment_id: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] environment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the environment.
        :param pulumi.Input[_builtins.str] inventory_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the inventory that will contain created assets.
        ...
        :param pulumi.Input[_builtins.str] aws_account_key: The key of customer's aws account to be discovered/migrated.
        :param pulumi.Input[_builtins.str] aws_region: AWS region information, from where the resources are discovered.
        ...
        :param pulumi.Input[_builtins.str] discovery_schedule_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the discovery schedule that is going to be attached to the created asset.
        :param pulumi.Input[_builtins.str] display_name: (Updatable) A user-friendly name for the asset source. Does not have to be unique, and it's mutable. Avoid entering confidential information. The name is generated by the service if it is not explicitly provided.
        :param pulumi.Input[_builtins.str] environment_type: (Updatable) Specifies if this is the Source or Destination point for migration - different assets may be discovered depending on setting.
        ...
        :param pulumi.Input[_builtins.bool] is_cost_information_collected: (Updatable) Flag indicating whether cost data collection is enabled for assets, originating from this asset source.
        :param pulumi.Input[_builtins.str] olvm_endpoint: (Updatable) Endpoint for OLVM asset discovery and replication in the form of ```https://<host>:<port>```
    ...
    def assets_compartment_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def assets_compartment_id(self, value: pulumi.Input[_builtins.str]):
...
class _AssetSourceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] inventory_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the inventory that will contain created assets.
        :param pulumi.Input[_builtins.bool] is_cost_information_collected: (Updatable) Flag indicating whether cost data collection is enabled for assets, originating from this asset source.
        :param pulumi.Input[_builtins.str] lifecycle_details: The detailed state of the asset source.
        :param pulumi.Input[_builtins.str] olvm_endpoint: (Updatable) Endpoint for OLVM asset discovery and replication in the form of ```https://<host>:<port>```
        :param pulumi.Input['AssetSourceReplicationCredentialsArgs'] replication_credentials: (Updatable) Credentials for an asset source.
        :param pulumi.Input[_builtins.str] state: The current state of the asset source.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] system_tags: (Updatable) The system tags associated with this resource, if any. The system tags are set by Oracle cloud infrastructure services. Each key is predefined and scoped to namespaces. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{orcl-cloud: {free-tier-retain: true}}`
        :param pulumi.Input[_builtins.str] time_created: The time when the asset source was created in the RFC3339 format.
...
class AssetSource(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 discovery_credentials: pulumi.Input[Optional[Union['AssetSourceDiscoveryCredentialsArgs', 'AssetSourceDiscoveryCredentialsArgsDict', 'outputs.AssetSourceDiscoveryCredentials']]] = None,
                 discovery_schedule_id: pulumi.Input[Optional[_builtins.str]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 environment_id: pulumi.Input[Optional[_builtins.str]] = None,
                 environment_type: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 is_cost_information_collected: pulumi.Input[Optional[_builtins.bool]] = None,
                 olvm_endpoint: pulumi.Input[Optional[_builtins.str]] = None,
                 replication_credentials: pulumi.Input[Optional[Union['AssetSourceReplicationCredentialsArgs', 'AssetSourceReplicationCredentialsArgsDict', 'outputs.AssetSourceReplicationCredentials']]] = None,
                 system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 type: pulumi.Input[Optional[_builtins.str]] = None,
                 vcenter_endpoint: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        ...
        :param pulumi.Input[_builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment for the resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] defined_tags: (Updatable) The defined tags associated with this resource, if any. Each key is predefined and scoped to namespaces. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[Union['AssetSourceDiscoveryCredentialsArgs', 'AssetSourceDiscoveryCredentialsArgsDict', 'outputs.AssetSourceDiscoveryCredentials']] discovery_credentials: (Updatable) Credentials for an asset source.
        :param pulumi.Input[_builtins.str] discovery_schedule_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the discovery schedule that is going to be attached to the created asset.
        :param pulumi.Input[_builtins.str] display_name: (Updatable) A user-friendly name for the asset source. Does not have to be unique, and it's mutable. Avoid entering confidential information. The name is generated by the service if it is not explicitly provided.
        :param pulumi.Input[_builtins.str] environment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the environment.
        :param pulumi.Input[_builtins.str] environment_type: (Updatable) Specifies if this is the Source or Destination point for migration - different assets may be discovered depending on setting.
        ...
        :param pulumi.Input[_builtins.bool] is_cost_information_collected: (Updatable) Flag indicating whether cost data collection is enabled for assets, originating from this asset source.
        :param pulumi.Input[_builtins.str] olvm_endpoint: (Updatable) Endpoint for OLVM asset discovery and replication in the form of ```https://<host>:<port>```
        :param pulumi.Input[Union['AssetSourceReplicationCredentialsArgs', 'AssetSourceReplicationCredentialsArgsDict', 'outputs.AssetSourceReplicationCredentials']] replication_credentials: (Updatable) Credentials for an asset source.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] system_tags: (Updatable) The system tags associated with this resource, if any. The system tags are set by Oracle cloud infrastructure services. Each key is predefined and scoped to namespaces. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{orcl-cloud: {free-tier-retain: true}}`
        :param pulumi.Input[_builtins.str] type: (Updatable) Asset source type.
        :param pulumi.Input[_builtins.str] vcenter_endpoint: (Updatable) Endpoint for VMware asset discovery and replication in the form of ```https://<host>:<port>/sdk```
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["aws_account_key"] = aws_account_key
            ...
            __props__.__dict__["is_cost_information_collected"] = is_cost_information_collected
            __props__.__dict__["olvm_endpoint"] = olvm_endpoint
    ...
    @_builtins.property
    @pulumi.getter(name="areHistoricalMetricsCollected")
    def are_historical_metrics_collected(self) -> pulumi.Output[_builtins.bool]:
        """
        (Updatable) Flag indicating whether historical metrics are collected for assets, originating from this asset source.
        """
        return pulumi.get(self, "are_historical_metrics_collected")
    ...
    @_builtins.property
    @pulumi.getter(name="areRealtimeMetricsCollected")
    def are_realtime_metrics_collected(self) -> pulumi.Output[_builtins.bool]:
        """
        (Updatable) Flag indicating whether real-time metrics are collected for assets, originating from this asset source.
        """
        return pulumi.get(self, "are_realtime_metrics_collected")
    ...
    @_builtins.property
    @pulumi.getter(name="assetsCompartmentId")
    def assets_compartment_id(self) -> pulumi.Output[_builtins.str]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that is going to be used to create assets.
        """
        return pulumi.get(self, "assets_compartment_id")
    ...
    @_builtins.property
    @pulumi.getter(name="awsAccountKey")
    def aws_account_key(self) -> pulumi.Output[_builtins.str]:
        """
        The key of customer's aws account to be discovered/migrated.
        """
        return pulumi.get(self, "aws_account_key")
    ...
    @_builtins.property
    @pulumi.getter(name="discoveryScheduleId")
    def discovery_schedule_id(self) -> pulumi.Output[_builtins.str]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the discovery schedule that is going to be attached to the created asset.
        """
        return pulumi.get(self, "discovery_schedule_id")
    ...
    @_builtins.property
    @pulumi.getter(name="isCostInformationCollected")
    def is_cost_information_collected(self) -> pulumi.Output[_builtins.bool]:
        """
        (Updatable) Flag indicating whether cost data collection is enabled for assets, originating from this asset source.
        """
        return pulumi.get(self, "is_cost_information_collected")
    ...
    @_builtins.property
    @pulumi.getter(name="olvmEndpoint")
    def olvm_endpoint(self) -> pulumi.Output[_builtins.str]:
        """
        (Updatable) Endpoint for OLVM asset discovery and replication in the form of ```https://<host>:<port>```
        """
        return pulumi.get(self, "olvm_endpoint")
