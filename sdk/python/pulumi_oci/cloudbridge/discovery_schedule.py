...
class DiscoveryScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which the discovery schedule is created.
        :param pulumi.Input[_builtins.str] execution_recurrences: (Updatable) Recurrence specification for the discovery schedule execution.
        ...
        :param pulumi.Input[_builtins.str] display_name: (Updatable) A user-friendly name for the discovery schedule. Does not have to be unique, and it's mutable. Avoid entering confidential information. The name is generated by the service if it is not explicitly provided.
...
class _DiscoveryScheduleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) The freeform tags associated with this resource, if any. Each tag is a simple key-value pair with no predefined name, type, or namespace/scope. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}` 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] lifecycle_details: The detailed state of the discovery schedule.
        :param pulumi.Input[_builtins.str] state: Current state of the discovery schedule.
        ...
        :param pulumi.Input[_builtins.str] time_created: The time when the discovery schedule was created in RFC3339 format.
        :param pulumi.Input[_builtins.str] time_updated: The time when the discovery schedule was last updated in RFC3339 format.
        """
...
class DiscoverySchedule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[_builtins.str]] = None,
            time_updated: Optional[pulumi.Input[_builtins.str]] = None) -> 'DiscoverySchedule':
        """
