...
def get_agent(agent_id: Optional[str] = None,
    ...
    return AwaitableGetAgentResult(
        ...
        agent_pub_key=__ret__.agent_pub_key,
        agent_type=__ret__.agent_type,
        ...
        heart_beat_status=__ret__.heart_beat_status,
        id=__ret__.id,
        ...
        time_expire_agent_key_in_ms=__ret__.time_expire_agent_key_in_ms,
        time_last_sync_received=__ret__.time_last_sync_received,
