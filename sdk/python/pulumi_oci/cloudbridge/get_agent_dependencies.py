...
def get_agent_dependencies(agent_id: Optional[builtins.str] = None,
...
def get_agent_dependencies_output(agent_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
