...
class GetAgentDependencyResult:
    ...
    def agent_dependency_id(self) -> builtins.str:
...
def get_agent_dependency(agent_dependency_id: Optional[builtins.str] = None,
    ...
    :param builtins.str agent_dependency_id: A unique AgentDependency identifier.
    """
    __args__ = dict()
...
def get_agent_dependency_output(agent_dependency_id: Optional[pulumi.Input[builtins.str]] = None,
