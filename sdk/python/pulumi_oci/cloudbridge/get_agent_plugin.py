...
def get_agent_plugin(agent_id: Optional[builtins.str] = None,
    ...
    :param builtins.str plugin_name: Unique plugin identifier path parameter.
    """
    __args__ = dict()
...
def get_agent_plugin_output(agent_id: Optional[pulumi.Input[builtins.str]] = None,
