...
def get_appliance_image(compartment_id: Optional[builtins.str] = None,
...
def get_appliance_image_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
