...
class GetAssetSourceResult:
    ...
    def asset_source_id(self) -> builtins.str:
...
def get_asset_source(asset_source_id: Optional[builtins.str] = None,
...
def get_asset_source_output(asset_source_id: Optional[pulumi.Input[builtins.str]] = None,
