...
class GetAssetSourcesResult:
    ...
    def asset_source_id(self) -> Optional[builtins.str]:
...
def get_asset_sources(asset_source_id: Optional[builtins.str] = None,
    ...
    :param builtins.str asset_source_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the asset source.
...
def get_asset_sources_output(asset_source_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
