...
def get_discovery_schedule(discovery_schedule_id: Optional[builtins.str] = None,
...
def get_discovery_schedule_output(discovery_schedule_id: Optional[pulumi.Input[builtins.str]] = None,
