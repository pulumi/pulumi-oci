...
class GetDiscoverySchedulesResult:
    ...
    def discovery_schedule_id(self) -> Optional[builtins.str]:
...
def get_discovery_schedules(compartment_id: Optional[builtins.str] = None,
                            discovery_schedule_id: Optional[builtins.str] = None,
    ...
    :param builtins.str discovery_schedule_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the discovery schedule.
...
def get_discovery_schedules_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                   discovery_schedule_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
