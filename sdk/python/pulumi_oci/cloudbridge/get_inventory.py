...
def get_inventory(inventory_id: Optional[builtins.str] = None,
    ...
    :param builtins.str inventory_id: Inventory OCID.
    """
    __args__ = dict()
...
def get_inventory_output(inventory_id: Optional[pulumi.Input[builtins.str]] = None,
