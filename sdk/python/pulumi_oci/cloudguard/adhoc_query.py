...
class AdhocQueryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: Compartment OCID of adhoc query
...
class _AdhocQueryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: Compartment OCID of adhoc query
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] error_message: Error message to show on UI in case of failure
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        ...
        :param pulumi.Input[builtins.str] status: Status of the adhoc query
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the adhoc query was created. Format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_updated: The date and time the adhoc query was updated. Format defined by RFC3339.
        """
...
class AdhocQuery(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'AdhocQuery':
        """
