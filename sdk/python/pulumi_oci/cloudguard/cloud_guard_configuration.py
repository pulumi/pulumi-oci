...
class CloudGuardConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 reporting_region: pulumi.Input[builtins.str],
                 status: pulumi.Input[builtins.str],
                 self_manage_resources: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a CloudGuardConfiguration resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment in which to list resources.
        :param pulumi.Input[builtins.str] reporting_region: (Updatable) The reporting region
        :param pulumi.Input[builtins.str] status: (Updatable) Status of Cloud Guard tenant
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.bool] self_manage_resources: (Updatable) Identifies if Oracle managed resources will be created by customers. If no value is specified false is the default.
        """
    ...
    def reporting_region(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def reporting_region(self, value: pulumi.Input[builtins.str]):
    ...
    def self_manage_resources(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def self_manage_resources(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _CloudGuardConfigurationState:
    def __init__(__self__, *,
                 ...
                 reporting_region: Optional[pulumi.Input[builtins.str]] = None,
                 self_manage_resources: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="reportingRegion")
    def reporting_region(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The reporting region
        """
        return pulumi.get(self, "reporting_region")
    ...
    @reporting_region.setter
    def reporting_region(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "reporting_region", value)
...
class CloudGuardConfiguration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            reporting_region: Optional[pulumi.Input[builtins.str]] = None,
            self_manage_resources: Optional[pulumi.Input[builtins.bool]] = None,
            status: Optional[pulumi.Input[builtins.str]] = None) -> 'CloudGuardConfiguration':
        """
    ...
    @property
    @pulumi.getter(name="reportingRegion")
    def reporting_region(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The reporting region
        """
        return pulumi.get(self, "reporting_region")
    ...
    @property
    @pulumi.getter(name="selfManageResources")
    def self_manage_resources(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Identifies if Oracle managed resources will be created by customers. If no value is specified false is the default.
        """
        return pulumi.get(self, "self_manage_resources")
