...
class DataMaskRuleArgs:
    def __init__(__self__, *,
                 ...
                 data_mask_categories: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 display_name: pulumi.Input[builtins.str],
                 iam_group_id: pulumi.Input[builtins.str],
                 target_selected: pulumi.Input['DataMaskRuleTargetSelectedArgs'],
                 data_mask_rule_status: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) Compartment OCID where the resource is created
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] data_mask_categories: (Updatable) Data mask rule categories
        :param pulumi.Input[builtins.str] display_name: (Updatable) Data mask rule display name
               
               Avoid entering confidential information.
        :param pulumi.Input[builtins.str] iam_group_id: (Updatable) IAM group ID associated with the data mask rule
        :param pulumi.Input['DataMaskRuleTargetSelectedArgs'] target_selected: (Updatable) Specification of how targets are to be selected (select ALL, or select by TargetResourceType or TargetId).
        :param pulumi.Input[builtins.str] data_mask_rule_status: (Updatable) The current status of the data mask rule
        ...
        :param pulumi.Input[builtins.str] description: The data mask rule description Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
               ...
               Avoid entering confidential information.
        :param pulumi.Input[builtins.str] state: The current lifecycle state of the data mask rule
        """
    ...
    def data_mask_categories(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def data_mask_categories(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def iam_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @iam_group_id.setter
    def iam_group_id(self, value: pulumi.Input[builtins.str]):
    ...
    def data_mask_rule_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def data_mask_rule_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DataMaskRuleState:
    def __init__(__self__, *,
                 ...
                 data_mask_categories: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 data_mask_rule_status: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 iam_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 lifecyle_details: Optional[pulumi.Input[builtins.str]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
               ...
               Avoid entering confidential information.
        :param pulumi.Input[builtins.str] iam_group_id: (Updatable) IAM group ID associated with the data mask rule
        :param pulumi.Input[builtins.str] lifecyle_details: Additional details on the substate of the lifecycle state [DEPRECATE]
        :param pulumi.Input[builtins.str] state: The current lifecycle state of the data mask rule
        ...
        :param pulumi.Input[builtins.str] time_updated: The date and time the target was updated. Format defined by RFC3339.
        """
    ...
    @property
    @pulumi.getter(name="dataMaskCategories")
    def data_mask_categories(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        (Updatable) Data mask rule categories
        """
        return pulumi.get(self, "data_mask_categories")
    ...
    @data_mask_categories.setter
    def data_mask_categories(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "data_mask_categories", value)
    ...
    @property
    @pulumi.getter(name="iamGroupId")
    def iam_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) IAM group ID associated with the data mask rule
        """
        return pulumi.get(self, "iam_group_id")
    ...
    @iam_group_id.setter
    def iam_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "iam_group_id", value)

    @property
    @pulumi.getter(name="lifecyleDetails")
    def lifecyle_details(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def lifecyle_details(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DataMaskRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target_selected: Optional[pulumi.Input[Union['DataMaskRuleTargetSelectedArgs', 'DataMaskRuleTargetSelectedArgsDict']]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'DataMaskRule':
        """
    ...
    @property
    @pulumi.getter(name="dataMaskCategories")
    def data_mask_categories(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) Data mask rule categories
        """
        return pulumi.get(self, "data_mask_categories")
    ...
    @property
    @pulumi.getter(name="dataMaskRuleStatus")
    def data_mask_rule_status(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The current status of the data mask rule
        """
        return pulumi.get(self, "data_mask_rule_status")
    ...
    @property
    @pulumi.getter(name="iamGroupId")
    def iam_group_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) IAM group ID associated with the data mask rule
        """
        return pulumi.get(self, "iam_group_id")
    ...
    @property
    @pulumi.getter(name="lifecyleDetails")
    def lifecyle_details(self) -> pulumi.Output[builtins.str]:
        """
        Additional details on the substate of the lifecycle state [DEPRECATE]
        """
        return pulumi.get(self, "lifecyle_details")
