...
class DetectorRecipeArgs:
    def __init__(__self__, *,
                 ...
                 source_detector_recipe_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
               ...
               Avoid entering confidential information.
        :param pulumi.Input[builtins.str] source_detector_recipe_id: The ID of the source detector recipe
    ...
    def source_detector_recipe_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_detector_recipe_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DetectorRecipeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
               ...
               Avoid entering confidential information.
        :param pulumi.Input[builtins.str] owner: Owner of detector recipe
        :param pulumi.Input[builtins.str] source_detector_recipe_id: The ID of the source detector recipe
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] target_ids: List of target IDs to which the recipe is attached
...
class DetectorRecipe(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'DetectorRecipe':
        """
    ...
    @property
    @pulumi.getter
    def detector(self) -> pulumi.Output[builtins.str]:
        """
        Detector for the rule
        """
        return pulumi.get(self, "detector")
    ...
    @property
    @pulumi.getter(name="detectorRecipeType")
    def detector_recipe_type(self) -> pulumi.Output[builtins.str]:
        """
        Recipe type ( STANDARD, ENTERPRISE )
        """
        return pulumi.get(self, "detector_recipe_type")
    ...
    @property
    @pulumi.getter(name="sourceDetectorRecipeId")
    def source_detector_recipe_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the source detector recipe
