...
class GetAdhocQueriesResult:
    ...
    def adhoc_query_status(self) -> Optional[_builtins.str]:
    ...
    def time_ended_filter_query_param(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "time_ended_filter_query_param")

    @_builtins.property
    @pulumi.getter(name="timeStartedFilterQueryParam")
    def time_started_filter_query_param(self) -> Optional[_builtins.str]:
...
def get_adhoc_queries(access_level: Optional[_builtins.str] = None,
    ...
    :param _builtins.str adhoc_query_status: The status of the adhoc query created. Default value for state is provisioning. If no value is specified state is provisioning.
    ...
    :param _builtins.str time_ended_filter_query_param: End time for a filter. If end time is not specified, end time will be set to current time.
    :param _builtins.str time_started_filter_query_param: Start time for a filter. If start time is not specified, start time will be set to current time - 30 days.
    """
    __args__ = dict()
