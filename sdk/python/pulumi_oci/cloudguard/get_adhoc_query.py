...
class GetAdhocQueryResult:
    ...
    def adhoc_query_id(self) -> _builtins.str:
...
def get_adhoc_query(adhoc_query_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str adhoc_query_id: Adhoc query OCID.
    """
    __args__ = dict()
