...
class GetCloudGuardConfigurationResult:
    ...
    def reporting_region(self) -> builtins.str:
        """
    ...
    def self_manage_resources(self) -> builtins.bool:
        """
...
def get_cloud_guard_configuration(compartment_id: Optional[builtins.str] = None,
...
def get_cloud_guard_configuration_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
