...
class GetDataMaskRuleResult:
    ...
    def data_mask_rule_id(self) -> builtins.str:
...
def get_data_mask_rule(data_mask_rule_id: Optional[builtins.str] = None,
    ...
    :param builtins.str data_mask_rule_id: OCID of the data mask rule
    """
    __args__ = dict()
...
def get_data_mask_rule_output(data_mask_rule_id: Optional[pulumi.Input[builtins.str]] = None,
