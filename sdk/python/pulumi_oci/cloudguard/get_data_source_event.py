...
def get_data_source_event(data_source_id: Optional[builtins.str] = None,
...
def get_data_source_event_output(data_source_id: Optional[pulumi.Input[builtins.str]] = None,
