...
def get_data_source_events(data_source_id: Optional[builtins.str] = None,
...
def get_data_source_events_output(data_source_id: Optional[pulumi.Input[builtins.str]] = None,
