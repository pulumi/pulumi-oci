...
def get_detector_recipe(detector_recipe_id: Optional[builtins.str] = None,
    ...
    :param builtins.str detector_recipe_id: Detector recipe OCID
    """
    __args__ = dict()
...
def get_detector_recipe_output(detector_recipe_id: Optional[pulumi.Input[builtins.str]] = None,
