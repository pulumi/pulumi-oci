...
def get_detector_recipes(access_level: Optional[builtins.str] = None,
...
def get_detector_recipes_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:CloudGuard/getDetectorRecipes:getDetectorRecipes', __args__, opts=opts, typ=GetDetectorRecipesResult)
    return __ret__.apply(lambda __response__: GetDetectorRecipesResult(
        access_level=pulumi.get(__response__, 'access_level'),
        compartment_id=pulumi.get(__response__, 'compartment_id'),
        compartment_id_in_subtree=pulumi.get(__response__, 'compartment_id_in_subtree'),
        detector_recipe_collections=pulumi.get(__response__, 'detector_recipe_collections'),
