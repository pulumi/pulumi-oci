...
def get_guard_target(target_id: Optional[builtins.str] = None,
    ...
    :param builtins.str target_id: OCID of the target
    """
    __args__ = dict()
...
def get_guard_target_output(target_id: Optional[pulumi.Input[builtins.str]] = None,
