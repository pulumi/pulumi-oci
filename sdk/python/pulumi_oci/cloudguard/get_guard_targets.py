...
class GetGuardTargetsResult:
    ...
    def is_non_security_zone_targets_only_query(self) -> Optional[builtins.bool]:
...
def get_guard_targets(access_level: Optional[builtins.str] = None,
                      ...
                      is_non_security_zone_targets_only_query: Optional[builtins.bool] = None,
    ...
    :param builtins.bool is_non_security_zone_targets_only_query: Default is false. When set to true, only the targets that would be deleted as part of security zone creation will be returned.
...
def get_guard_targets_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             ...
                             is_non_security_zone_targets_only_query: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
