...
class GetManagedListResult:
    ...
    def managed_list_id(self) -> _builtins.str:
...
def get_managed_list(managed_list_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str managed_list_id: The managed list OCID to be passed in the request.
    """
    __args__ = dict()
...
def get_managed_list_output(managed_list_id: Optional[pulumi.Input[_builtins.str]] = None,
