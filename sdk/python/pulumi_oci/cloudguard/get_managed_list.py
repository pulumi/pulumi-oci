...
class GetManagedListResult:
    ...
    def managed_list_id(self) -> builtins.str:
...
def get_managed_list(managed_list_id: Optional[builtins.str] = None,
    ...
    :param builtins.str managed_list_id: The managed list OCID to be passed in the request.
    """
    __args__ = dict()
...
def get_managed_list_output(managed_list_id: Optional[pulumi.Input[builtins.str]] = None,
