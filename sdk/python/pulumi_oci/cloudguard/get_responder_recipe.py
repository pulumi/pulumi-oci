...
def get_responder_recipe(responder_recipe_id: Optional[builtins.str] = None,
    ...
    :param builtins.str responder_recipe_id: OCID of the responder recipe.
    """
    __args__ = dict()
...
def get_responder_recipe_output(responder_recipe_id: Optional[pulumi.Input[builtins.str]] = None,
