...
def get_responder_recipes(access_level: Optional[builtins.str] = None,
...
def get_responder_recipes_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
