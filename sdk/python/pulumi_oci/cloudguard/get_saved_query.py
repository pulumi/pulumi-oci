...
class GetSavedQueryResult:
    ...
    def saved_query_id(self) -> _builtins.str:
...
def get_saved_query(saved_query_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str saved_query_id: Saved query OCID
    """
    __args__ = dict()
