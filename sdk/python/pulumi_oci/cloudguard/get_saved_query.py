...
class GetSavedQueryResult:
    ...
    def saved_query_id(self) -> builtins.str:
...
def get_saved_query(saved_query_id: Optional[builtins.str] = None,
    ...
    :param builtins.str saved_query_id: Saved query OCID
    """
    __args__ = dict()
...
def get_saved_query_output(saved_query_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:CloudGuard/getSavedQuery:getSavedQuery', __args__, opts=opts, typ=GetSavedQueryResult)
    return __ret__.apply(lambda __response__: GetSavedQueryResult(
        ...
        saved_query_id=pulumi.get(__response__, 'saved_query_id'),
