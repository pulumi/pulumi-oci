...
class GetSecurityRecipeResult:
    ...
    def security_recipe_id(self) -> builtins.str:
...
def get_security_recipe(security_recipe_id: Optional[builtins.str] = None,
    ...
    :param builtins.str security_recipe_id: The unique identifier of the security zone recipe. (`SecurityRecipe`)
    """
    __args__ = dict()
...
def get_security_recipe_output(security_recipe_id: Optional[pulumi.Input[builtins.str]] = None,
