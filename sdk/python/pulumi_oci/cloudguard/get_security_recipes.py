...
def get_security_recipes(compartment_id: Optional[builtins.str] = None,
...
def get_security_recipes_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
