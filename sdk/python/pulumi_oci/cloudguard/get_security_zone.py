...
def get_security_zone(security_zone_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str security_zone_id: The unique identifier of the security zone (`SecurityZone` resource).
    """
    __args__ = dict()
