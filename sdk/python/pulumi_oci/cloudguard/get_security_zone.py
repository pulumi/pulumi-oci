...
def get_security_zone(security_zone_id: Optional[builtins.str] = None,
    ...
    :param builtins.str security_zone_id: The unique identifier of the security zone (`SecurityZone` resource).
    """
    __args__ = dict()
...
def get_security_zone_output(security_zone_id: Optional[pulumi.Input[builtins.str]] = None,
