...
class GetSecurityZonesResult:
    ...
    def is_required_security_zones_in_subtree(self) -> Optional[_builtins.bool]:
        return pulumi.get(self, "is_required_security_zones_in_subtree")

    @_builtins.property
    @pulumi.getter(name="securityRecipeId")
    def security_recipe_id(self) -> Optional[_builtins.str]:
...
def get_security_zones(compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.bool is_required_security_zones_in_subtree: Is security zones in the subtree?
    :param _builtins.str security_recipe_id: The unique identifier of the security zone recipe. (`SecurityRecipe` resource).
