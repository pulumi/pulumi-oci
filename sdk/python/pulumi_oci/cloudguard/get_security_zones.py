...
class GetSecurityZonesResult:
    ...
    def is_required_security_zones_in_subtree(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "is_required_security_zones_in_subtree")

    @property
    @pulumi.getter(name="securityRecipeId")
    def security_recipe_id(self) -> Optional[builtins.str]:
...
def get_security_zones(compartment_id: Optional[builtins.str] = None,
                       display_name: Optional[builtins.str] = None,
                       filters: Optional[Sequence[Union['GetSecurityZonesFilterArgs', 'GetSecurityZonesFilterArgsDict']]] = None,
                       id: Optional[builtins.str] = None,
                       is_required_security_zones_in_subtree: Optional[builtins.bool] = None,
                       security_recipe_id: Optional[builtins.str] = None,
    ...
    :param builtins.bool is_required_security_zones_in_subtree: Is security zones in the subtree?
    :param builtins.str security_recipe_id: The unique identifier of the security zone recipe. (`SecurityRecipe` resource).
...
def get_security_zones_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                              ...
                              is_required_security_zones_in_subtree: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                              security_recipe_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
