...
class GetWlpAgentResult:
    ...
    def wlp_agent_id(self) -> builtins.str:
...
def get_wlp_agent(wlp_agent_id: Optional[builtins.str] = None,
    ...
    :param builtins.str wlp_agent_id: WLP agent OCID.
    """
    __args__ = dict()
...
def get_wlp_agent_output(wlp_agent_id: Optional[pulumi.Input[builtins.str]] = None,
