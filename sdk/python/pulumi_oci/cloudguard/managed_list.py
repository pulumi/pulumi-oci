...
class ManagedListArgs:
    def __init__(__self__, *,
                 ...
                 list_items: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 list_type: Optional[pulumi.Input[builtins.str]] = None,
                 source_managed_list_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) Managed list display name.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Managed list description
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
               ...
               Avoid entering confidential information.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] list_items: (Updatable) List of items in the managed list
        :param pulumi.Input[builtins.str] list_type: Type of information stored in the list
        :param pulumi.Input[builtins.str] source_managed_list_id: OCID of the source managed list
    ...
    def list_items(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @list_items.setter
    def list_items(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def source_managed_list_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_managed_list_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ManagedListState:
    def __init__(__self__, *,
                 ...
                 feed_provider: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) Managed list display name.
               ...
               Avoid entering confidential information.
        :param pulumi.Input[builtins.str] feed_provider: Provider of the managed list feed
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
               
               Avoid entering confidential information.
        :param pulumi.Input[builtins.bool] is_editable: Is this list editable?
        :param pulumi.Input[builtins.str] lifecyle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state. [DEPRECATE]
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] list_items: (Updatable) List of items in the managed list
        :param pulumi.Input[builtins.str] list_type: Type of information stored in the list
        :param pulumi.Input[builtins.str] source_managed_list_id: OCID of the source managed list
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the managed list was created. Format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_updated: The date and time the managed list was last updated. Format defined by RFC3339.
        """
    ...
    def feed_provider(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def feed_provider(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ManagedList(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'ManagedList':
        """
    ...
    @property
    @pulumi.getter(name="feedProvider")
    def feed_provider(self) -> pulumi.Output[builtins.str]:
        """
        Provider of the managed list feed
        """
        return pulumi.get(self, "feed_provider")
    ...
    @property
    @pulumi.getter(name="listItems")
    def list_items(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) List of items in the managed list
        """
        return pulumi.get(self, "list_items")
    ...
    @property
    @pulumi.getter(name="listType")
    def list_type(self) -> pulumi.Output[builtins.str]:
        """
        Type of information stored in the list
        """
        return pulumi.get(self, "list_type")
    ...
    @property
    @pulumi.getter(name="sourceManagedListId")
    def source_managed_list_id(self) -> pulumi.Output[builtins.str]:
        """
        OCID of the source managed list
