...
class AdhocQueryAdhocQueryDetails(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str query: The adhoc query expression that is run
        """
...
class AdhocQueryAdhocQueryDetailsAdhocQueryResource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str region: Region in which adhoc query needs to be run
        :param Sequence[builtins.str] resource_ids: List of OCIDs on which query needs to be run
        :param builtins.str resource_type: Type of resource
        """
...
class AdhocQueryAdhocQueryRegionalDetail(dict):
    ...
    def __init__(__self__, *,
                 expected_count: Optional[builtins.str] = None,
                 expired_count: Optional[builtins.str] = None,
                 failed_count: Optional[builtins.str] = None,
                 region: Optional[builtins.str] = None,
                 regional_error: Optional[builtins.str] = None,
                 regional_status: Optional[builtins.str] = None,
                 succeeded_count: Optional[builtins.str] = None):
        """
        :param builtins.str expected_count: Expected number of instances on which query should run
        :param builtins.str expired_count: Number of instances on which query expired
        :param builtins.str failed_count: Number of instances on which query failed
        :param builtins.str region: Region name
        :param builtins.str regional_error: error message to show if adhoc query fails in a region
        :param builtins.str regional_status: adhoc query status of the region
        :param builtins.str succeeded_count: Number of instances on which query succeeded
        """
    ...
    def expected_count(self) -> Optional[builtins.str]:
        """
    ...
    def expired_count(self) -> Optional[builtins.str]:
        """
    ...
    def failed_count(self) -> Optional[builtins.str]:
        """
    ...
    def regional_error(self) -> Optional[builtins.str]:
        """
    ...
    def regional_status(self) -> Optional[builtins.str]:
        """
    ...
    def succeeded_count(self) -> Optional[builtins.str]:
        """
...
class CloudGuardDataSourceDataSourceDetails(dict):
    ...
    def __init__(__self__, *,
                 data_source_feed_provider: builtins.str,
                 additional_entities_count: Optional[builtins.int] = None,
                 ...
                 logging_query_type: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str data_source_feed_provider: (Updatable) Type of data source feed provider (LoggingQuery)
        :param builtins.int additional_entities_count: (Updatable) The additional entities count used for data source query
        :param builtins.str description: (Updatable) Description text for the query
        :param builtins.int interval_in_minutes: (Updatable) Interval in minutes that query is run periodically.
        :param builtins.int interval_in_seconds: (Updatable) Interval in minutes which query is run periodically.
        ...
        :param builtins.str logging_query_type: (Updatable) Type of logging query for data source (Sighting/Insight)
        :param builtins.str operator: (Updatable) Operator used in data source
        :param builtins.str query: (Updatable) The continuous query expression that is run periodically.
        ...
        :param Sequence[builtins.str] regions: (Updatable) List of logging query regions
        ...
        :param builtins.int threshold: (Updatable) The integer value that must be exceeded, fall below or equal to (depending on the operator), for the query result to trigger an event
        """
    ...
    def additional_entities_count(self) -> Optional[builtins.int]:
        """
    ...
    def logging_query_type(self) -> Optional[builtins.str]:
        """
...
class CloudGuardDataSourceDataSourceDetailsLoggingQueryDetails(dict):
    ...
    def __init__(__self__, *,
                 logging_query_type: builtins.str,
                 key_entities_count: Optional[builtins.int] = None):
        """
        :param builtins.str logging_query_type: (Updatable) Logging query type for data source
        :param builtins.int key_entities_count: (Updatable) The key entities count used for data source query
        """
        pulumi.set(__self__, "logging_query_type", logging_query_type)
    ...
    @property
    @pulumi.getter(name="loggingQueryType")
    def logging_query_type(self) -> builtins.str:
        """
    ...
    def key_entities_count(self) -> Optional[builtins.int]:
        """
...
class CloudGuardDataSourceDataSourceDetailsQueryStartTime(dict):
    ...
    def __init__(__self__, *,
                 start_policy_type: builtins.str,
                 query_start_time: Optional[builtins.str] = None):
        """
        :param builtins.str start_policy_type: (Updatable) Start policy delay timing
        :param builtins.str query_start_time: (Updatable) Time when the query can start. If not specified it can start immediately
        """
    ...
    def start_policy_type(self) -> builtins.str:
        """
...
class CloudGuardDataSourceDataSourceDetailsScheduledQueryScopeDetail(dict):
    ...
    def __init__(__self__, *,
                 ...
                 resource_type: Optional[builtins.str] = None):
        """
        :param builtins.str region: (Updatable) region on which scheduled query needs to be run
        :param Sequence[builtins.str] resource_ids: (Updatable) List of OCIDs on scheduled query needs to run
        :param builtins.str resource_type: (Updatable) Type of resource
        """
        if region is not None:
            pulumi.set(__self__, "region", region)
        if resource_ids is not None:
...
class CloudGuardDataSourceDataSourceDetectorMappingInfo(dict):
    ...
    def __init__(__self__, *,
                 detector_recipe_id: Optional[builtins.str] = None,
                 detector_rule_id: Optional[builtins.str] = None):
        """
        :param builtins.str detector_recipe_id: ID of the detector recipe attached to the data source
        :param builtins.str detector_rule_id: ID of the detector rule attached to the data source
        """
    ...
    def detector_recipe_id(self) -> Optional[builtins.str]:
        """
    ...
    def detector_rule_id(self) -> Optional[builtins.str]:
        """
...
class CloudGuardDataSourceRegionStatusDetail(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str region: Data source replication region
        :param builtins.str status: (Updatable) Enablement status of data source.
...
class DataMaskRuleTargetSelected(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str kind: (Updatable) Kind of target selection to be used
        :param Sequence[builtins.str] values: (Updatable) Types of targets
...
class DetectorRecipeDetectorRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 description: Optional[builtins.str] = None,
                 detector: Optional[builtins.str] = None,
                 ...
                 managed_list_types: Optional[Sequence[builtins.str]] = None,
        ...
        :param builtins.str detector_rule_id: (Updatable) Detector recipe rule ID
        ...
        :param builtins.str data_source_id: The ID of the attached data source
        :param builtins.str description: (Updatable) Detector recipe description.
               
               Avoid entering confidential information.
        :param builtins.str detector: Detector for the rule
        :param builtins.str display_name: (Updatable) Detector recipe display name.
        ...
        :param Sequence[builtins.str] managed_list_types: List of managed list types related to this rule
        :param builtins.str recommendation: Recommendation for DetectorRecipeDetectorRule resource
        :param builtins.str resource_type: Resource type of the configuration to which the rule is applied
        :param builtins.str service_type: Service type of the configuration to which the rule is applied
        :param builtins.str state: The current lifecycle state of the resource
        :param builtins.str time_created: The date and time the detector recipe was created Format defined by RFC3339.
        :param builtins.str time_updated: The date and time the detector recipe was last updated Format defined by RFC3339.
        """
    ...
    @property
    @pulumi.getter(name="detectorRuleId")
    def detector_rule_id(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter
    def detector(self) -> Optional[builtins.str]:
        """
    ...
    def managed_list_types(self) -> Optional[Sequence[builtins.str]]:
        """
...
class DetectorRecipeDetectorRuleCandidateResponderRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_preferred: Optional[builtins.bool] = None):
        """
        :param builtins.str display_name: (Updatable) Detector recipe display name.
               
               Avoid entering confidential information.
        :param builtins.str id: OCID for detector recipe
        :param builtins.bool is_preferred: Is this the preferred state?
        """
        if display_name is not None:
            pulumi.set(__self__, "display_name", display_name)
        if id is not None:
    ...
    def is_preferred(self) -> Optional[builtins.bool]:
        """
...
class DetectorRecipeDetectorRuleDetails(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_configuration_allowed: Optional[builtins.bool] = None,
                 labels: Optional[Sequence[builtins.str]] = None,
                 recommendation: Optional[builtins.str] = None):
        """
        :param builtins.bool is_enabled: (Updatable) Enablement status of the detector rule
        :param builtins.str risk_level: (Updatable) The risk level of the detector rule
        :param builtins.str condition: (Updatable) The base condition resource.
        ...
        :param builtins.str data_source_id: (Updatable) The unique identifier of the attached data source
        :param builtins.str description: (Updatable) Description for the detector rule
        ...
        :param builtins.bool is_configuration_allowed: Can the rule be configured?
        :param Sequence[builtins.str] labels: (Updatable) User-defined labels for a detector rule
        :param builtins.str recommendation: (Updatable) Recommendation for the detector rule
        """
    ...
    def is_configuration_allowed(self) -> Optional[builtins.bool]:
        """
...
class DetectorRecipeDetectorRuleDetailsConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str config_key: (Updatable) Unique identifier of the configuration
        :param builtins.str name: (Updatable) Configuration name
        :param builtins.str data_type: (Updatable) Configuration data type
        :param builtins.str value: (Updatable) Configuration value
...
class DetectorRecipeDetectorRuleDetailsConfigurationValue(dict):
    ...
    def __init__(__self__, *,
                 ...
                 managed_list_type: builtins.str,
                 value: builtins.str):
        """
        :param builtins.str list_type: (Updatable) Configuration list item type (CUSTOM or MANAGED)
        :param builtins.str managed_list_type: (Updatable) Type of content in the managed list
        :param builtins.str value: (Updatable) Configuration value
        """
    ...
    def managed_list_type(self) -> builtins.str:
        """
...
class DetectorRecipeDetectorRuleDetailsEntitiesMapping(dict):
    ...
    def __init__(__self__, *,
                 query_field: builtins.str,
                 display_name: Optional[builtins.str] = None,
                 entity_type: Optional[builtins.str] = None):
        """
        :param builtins.str query_field: (Updatable) The entity value mapped to a data source query
        :param builtins.str display_name: (Updatable) Display name of the entity
        :param builtins.str entity_type: (Updatable) Type of entity
        """
    ...
    def query_field(self) -> builtins.str:
        """
...
class DetectorRecipeDetectorRuleEntitiesMapping(dict):
    ...
    def __init__(__self__, *,
                 display_name: Optional[builtins.str] = None,
                 entity_type: Optional[builtins.str] = None,
                 query_field: Optional[builtins.str] = None):
        """
        :param builtins.str display_name: (Updatable) Detector recipe display name.
               
               Avoid entering confidential information.
        :param builtins.str entity_type: Type of entity
        :param builtins.str query_field: The entity value mapped to a data source query
        """
        if display_name is not None:
            pulumi.set(__self__, "display_name", display_name)
        if entity_type is not None:
    ...
    @property
    @pulumi.getter(name="queryField")
    def query_field(self) -> Optional[builtins.str]:
        """
...
class DetectorRecipeEffectiveDetectorRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str detector: Detector for the rule
        :param builtins.str detector_rule_id: The unique identifier of the detector rule.
        :param builtins.str display_name: (Updatable) Detector recipe display name.
...
class DetectorRecipeEffectiveDetectorRuleDetail(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str condition: The base condition resource.
        ...
        :param builtins.bool is_configuration_allowed: Can the rule be configured?
        :param builtins.bool is_enabled: Enablement status for the rule
        :param Sequence[builtins.str] labels: User-defined labels for a detector rule
        :param builtins.str recommendation: Recommendation for DetectorRecipeDetectorRule resource
        :param builtins.str risk_level: The risk level for the rule
        """
        if condition is not None:
            pulumi.set(__self__, "condition", condition)
        if configurations is not None:
...
class DetectorRecipeEffectiveDetectorRuleDetailConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str config_key: Unique identifier of the configuration
        :param builtins.str data_type: Configuration data type
        :param builtins.str name: Configuration name
        :param builtins.str value: Configuration value
...
class DetectorRecipeEffectiveDetectorRuleDetailConfigurationValue(dict):
    ...
    def __init__(__self__, *,
                 list_type: Optional[builtins.str] = None,
                 managed_list_type: Optional[builtins.str] = None,
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str list_type: Configuration list item type (CUSTOM or MANAGED)
        :param builtins.str managed_list_type: Type of content in the managed list
        :param builtins.str value: Configuration value
        """
    ...
    @property
    @pulumi.getter(name="listType")
    def list_type(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="managedListType")
    def managed_list_type(self) -> Optional[builtins.str]:
        """
...
class ResponderRecipeEffectiveResponderRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 responder_rule_id: Optional[builtins.str] = None,
                 state: Optional[builtins.str] = None,
                 supported_modes: Optional[Sequence[builtins.str]] = None,
                 time_created: Optional[builtins.str] = None,
                 time_updated: Optional[builtins.str] = None,
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str compartment_id: (Updatable) Compartment OCID
        :param builtins.str description: (Updatable) Responder recipe description.
               
               Avoid entering confidential information.
        :param Sequence['ResponderRecipeEffectiveResponderRuleDetailArgs'] details: Detailed information for a responder rule
        :param builtins.str display_name: (Updatable) Responder recipe display name.
               
               Avoid entering confidential information.
        :param builtins.str lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        :param Sequence[builtins.str] policies: List of policies
        :param builtins.str responder_rule_id: Unique identifier for the responder rule
        :param builtins.str state: The current lifecycle state of the example
        :param Sequence[builtins.str] supported_modes: Supported execution modes for the responder rule
        :param builtins.str time_created: The date and time the responder recipe was created. Format defined by RFC3339.
        :param builtins.str time_updated: The date and time the responder recipe was last updated. Format defined by RFC3339.
        :param builtins.str type: Type of responder
        """
    ...
    def responder_rule_id(self) -> Optional[builtins.str]:
        """
    ...
    def supported_modes(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ResponderRecipeEffectiveResponderRuleDetail(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool is_enabled: Enabled state for the responder rule
        :param builtins.str mode: Execution mode for the responder rule
        """
        if condition is not None:
            pulumi.set(__self__, "condition", condition)
        if configurations is not None:
...
class ResponderRecipeResponderRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 responder_rule_id: builtins.str,
                 compartment_id: Optional[builtins.str] = None,
                 description: Optional[builtins.str] = None,
                 display_name: Optional[builtins.str] = None,
                 lifecycle_details: Optional[builtins.str] = None,
        ...
        :param builtins.str responder_rule_id: (Updatable) Unique identifier for the responder rule
        :param builtins.str compartment_id: (Updatable) Compartment OCID
        :param builtins.str description: (Updatable) Responder recipe description.
    ...
    @property
    @pulumi.getter(name="responderRuleId")
    def responder_rule_id(self) -> builtins.str:
        """
...
class ResponderRecipeResponderRuleDetails(dict):
    ...
    def __init__(__self__, *,
                 ...
                 mode: Optional[builtins.str] = None):
        """
        :param builtins.bool is_enabled: (Updatable) Enablement state for the responder rule
        :param builtins.str condition: The base condition resource.
...
class TargetTargetDetail(dict):
    ...
    def __init__(__self__, *,
                 security_zone_display_name: Optional[builtins.str] = None,
                 security_zone_id: Optional[builtins.str] = None,
                 target_resource_type: Optional[builtins.str] = None,
                 target_security_zone_recipes: Optional[Sequence['outputs.TargetTargetDetailTargetSecurityZoneRecipe']] = None):
        """
        :param builtins.str security_zone_display_name: The name of the security zone to associate with this compartment.
        :param builtins.str security_zone_id: The OCID of the security zone to associate with this compartment
        :param builtins.str target_resource_type: Type of resource that target support (COMPARTMENT/FACLOUD)
    ...
    def security_zone_display_name(self) -> Optional[builtins.str]:
        """
    ...
    def security_zone_id(self) -> Optional[builtins.str]:
        """
...
class TargetTargetDetailTargetSecurityZoneRecipe(dict):
    ...
    def __init__(__self__, *,
                 ...
                 security_policies: Optional[Sequence[builtins.str]] = None,
                 state: Optional[builtins.str] = None,
                 system_tags: Optional[Mapping[str, builtins.str]] = None,
                 time_created: Optional[builtins.str] = None,
                 time_updated: Optional[builtins.str] = None):
        """
        :param builtins.str compartment_id: Compartment OCID where the resource is created
        ...
        :param builtins.str description: The target description.
               
               Avoid entering confidential information.
        :param builtins.str display_name: (Updatable) Display name for the target.
        ...
        :param Mapping[str, builtins.str] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
               ...
               Avoid entering confidential information.
        :param builtins.str id: Unique identifier of target responder recipe that can't be changed after creation
        :param builtins.str lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        :param builtins.str owner: Owner of target responder recipe
        :param Sequence[builtins.str] security_policies: The list of security policy IDs that are included in the recipe
        :param builtins.str state: (Updatable) The enablement state of the detector rule
        ...
        :param builtins.str time_created: The date and time the target was created. Format defined by RFC3339.
        :param builtins.str time_updated: The date and time the target was last updated. Format defined by RFC3339.
        """
        if compartment_id is not None:
            pulumi.set(__self__, "compartment_id", compartment_id)
    ...
    def security_policies(self) -> Optional[Sequence[builtins.str]]:
        """
...
class TargetTargetDetectorRecipe(dict):
    ...
    def __init__(__self__, *,
                 detector_recipe_id: builtins.str,
                 compartment_id: Optional[builtins.str] = None,
                 description: Optional[builtins.str] = None,
                 detector: Optional[builtins.str] = None,
                 detector_recipe_type: Optional[builtins.str] = None,
                 ...
                 time_updated: Optional[builtins.str] = None):
        """
        :param builtins.str detector_recipe_id: Unique identifier for the target detector recipe
        :param builtins.str compartment_id: Compartment OCID where the resource is created
        :param builtins.str description: The target description.
               
               Avoid entering confidential information.
        :param builtins.str detector: Detector type for the rule
        :param builtins.str detector_recipe_type: Recipe type ( STANDARD, ENTERPRISE )
    ...
    @property
    @pulumi.getter(name="detectorRecipeId")
    def detector_recipe_id(self) -> builtins.str:
        """
    ...
    def detector_recipe_type(self) -> Optional[builtins.str]:
        """
...
class TargetTargetDetectorRecipeDetectorRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str detector_rule_id: (Updatable) Unique identifier for the detector rule
        :param builtins.str data_source_id: The ID of the attached data source
        :param builtins.str description: The target description.
        ...
        :param builtins.str lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        :param Sequence[builtins.str] managed_list_types: List of managed list types related to this rule
        :param builtins.str recommendation: Recommendation for TargetDetectorRecipeDetectorRule resource
        :param builtins.str resource_type: The type of resource which is monitored by the detector rule. For example, Instance, Database, VCN, Policy. To find the resource type for a particular rule, see [Detector Recipe Reference] (/iaas/cloud-guard/using/detect-recipes.htm#detect-recipes-reference).
        :param builtins.str service_type: Service type of the configuration to which the rule is applied
        :param builtins.str state: (Updatable) The enablement state of the detector rule
        :param builtins.str time_created: The date and time the target was created. Format defined by RFC3339.
        :param builtins.str time_updated: The date and time the target was last updated. Format defined by RFC3339.
...
class TargetTargetDetectorRecipeDetectorRuleDetails(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool is_configuration_allowed: Configuration allowed or not
        :param builtins.bool is_enabled: Enabled state for the responder rule
        :param Sequence[builtins.str] labels: User-defined labels for a detector rule
        :param builtins.str risk_level: The risk level of the detector rule
        """
...
class TargetTargetDetectorRecipeDetectorRuleDetailsConditionGroup(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str compartment_id: (Updatable) Compartment OCID associated with condition
        :param builtins.str condition: (Updatable) The base condition resource.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "condition", condition)
...
class TargetTargetResponderRecipe(dict):
    ...
    def __init__(__self__, *,
                 responder_recipe_id: builtins.str,
                 compartment_id: Optional[builtins.str] = None,
                 description: Optional[builtins.str] = None,
                 display_name: Optional[builtins.str] = None,
                 ...
                 time_updated: Optional[builtins.str] = None):
        """
        :param builtins.str responder_recipe_id: Unique identifier for responder recipe
        :param builtins.str compartment_id: Compartment OCID where the resource is created
        :param builtins.str description: The target description.
    ...
    def responder_recipe_id(self) -> builtins.str:
        """
...
class TargetTargetResponderRecipeResponderRule(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str responder_rule_id: (Updatable) Unique identifier for target detector recipe
...
class TargetTargetResponderRecipeResponderRuleDetails(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool is_enabled: Enabled state for the responder rule
        :param builtins.str mode: (Updatable) Execution mode for the responder rule
        """
        if condition is not None:
            pulumi.set(__self__, "condition", condition)
        if configurations is not None:
...
class GetAdhocQueriesAdhocQueryCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str error_message: Error message to show on UI in case of failure
        ...
        :param builtins.str id: OCID for the adhoc query
        :param builtins.str state: The current lifecycle state of the resource.
        :param builtins.str status: Status of the adhoc query
        :param Mapping[str, builtins.str] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). System tags can be viewed by users, but can only be created by the system.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The date and time the adhoc query was created. Format defined by RFC3339.
        :param builtins.str time_updated: The date and time the adhoc query was updated. Format defined by RFC3339.
        """
...
class GetAdhocQueriesAdhocQueryCollectionItemAdhocQueryRegionalDetailResult(dict):
    def __init__(__self__, *,
                 expected_count: builtins.str,
                 expired_count: builtins.str,
                 failed_count: builtins.str,
                 region: builtins.str,
                 regional_error: builtins.str,
                 regional_status: builtins.str,
                 succeeded_count: builtins.str):
        """
        :param builtins.str expected_count: Expected number of instances on which query should run
        :param builtins.str expired_count: Number of instances on which query expired
        :param builtins.str failed_count: Number of instances on which query failed
    ...
    @property
    @pulumi.getter(name="expectedCount")
    def expected_count(self) -> builtins.str:
        """
        Expected number of instances on which query should run
        """
        return pulumi.get(self, "expected_count")
    ...
    @property
    @pulumi.getter(name="expiredCount")
    def expired_count(self) -> builtins.str:
        """
        Number of instances on which query expired
        """
        return pulumi.get(self, "expired_count")
    ...
    @property
    @pulumi.getter(name="failedCount")
    def failed_count(self) -> builtins.str:
        """
        Number of instances on which query failed
        """
        return pulumi.get(self, "failed_count")
    ...
    @property
    @pulumi.getter(name="regionalError")
    def regional_error(self) -> builtins.str:
        """
        error message to show if adhoc query fails in a region
        """
        return pulumi.get(self, "regional_error")
    ...
    @property
    @pulumi.getter(name="regionalStatus")
    def regional_status(self) -> builtins.str:
        """
        adhoc query status of the region
        """
        return pulumi.get(self, "regional_status")
    ...
    @property
    @pulumi.getter(name="succeededCount")
    def succeeded_count(self) -> builtins.str:
        """
        Number of instances on which query succeeded
        """
        return pulumi.get(self, "succeeded_count")
...
class GetDataMaskRuleTargetSelectedResult(dict):
    def __init__(__self__, *,
                 ...
                 values: Sequence[builtins.str]):
        """
        :param builtins.str kind: Kind of target selection to be used
        :param Sequence[builtins.str] values: Types of targets
        """
        pulumi.set(__self__, "kind", kind)
        pulumi.set(__self__, "values", values)
...
class GetDataMaskRulesDataMaskRuleCollectionItemResult(dict):
    def __init__(__self__, *,
                 compartment_id: builtins.str,
                 data_mask_categories: Sequence[builtins.str],
                 data_mask_rule_status: builtins.str,
                 defined_tags: Mapping[str, builtins.str],
                 description: builtins.str,
                 display_name: builtins.str,
                 freeform_tags: Mapping[str, builtins.str],
                 iam_group_id: builtins.str,
                 id: builtins.str,
        ...
        """
        :param builtins.str compartment_id: The OCID of the compartment in which to list resources.
        :param Sequence[builtins.str] data_mask_categories: List of data mask rule categories
        :param builtins.str data_mask_rule_status: The status of the data mask rule
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str description: The data mask rule description
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str iam_group_id: OCID of the IAM group
        :param builtins.str id: Unique identifier that can't be changed after creation
        :param builtins.str lifecyle_details: Additional details on the substate of the lifecycle state [DEPRECATE]
        ...
        :param builtins.str time_created: The date and time the target was created. Format defined by RFC3339.
        :param builtins.str time_updated: The date and time the target was updated. Format defined by RFC3339.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
    ...
    def data_mask_categories(self) -> Sequence[builtins.str]:
        """
    ...
    def data_mask_rule_status(self) -> builtins.str:
        """
    ...
    def iam_group_id(self) -> builtins.str:
        """
...
class GetDataSourceDataSourceDetailResult(dict):
    def __init__(__self__, *,
                 additional_entities_count: builtins.int,
                 data_source_feed_provider: builtins.str,
                 description: builtins.str,
                 interval_in_minutes: builtins.int,
        ...
        """
        :param builtins.int additional_entities_count: The additional entities count used for data source query
        :param builtins.str data_source_feed_provider: Possible type of dataSourceFeed Provider(LoggingQuery)
        :param builtins.str description: Description text for the query
        :param builtins.int interval_in_minutes: Interval in minutes that query is run periodically.
        :param builtins.int interval_in_seconds: Interval in minutes which query is run periodically.
        ...
        :param builtins.str logging_query_type: Type of logging query for data source (Sighting/Insight)
        :param builtins.str operator: Operator used in data source
        :param builtins.str query: The continuous query expression that is run periodically.
        ...
        :param Sequence[builtins.str] regions: List of logging query regions
        ...
        :param builtins.int threshold: The integer value that must be exceeded, fall below or equal to (depending on the operator), for the query result to trigger an event
        """
        pulumi.set(__self__, "additional_entities_count", additional_entities_count)
        pulumi.set(__self__, "data_source_feed_provider", data_source_feed_provider)
        pulumi.set(__self__, "description", description)
    ...
    @property
    @pulumi.getter(name="additionalEntitiesCount")
    def additional_entities_count(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="intervalInMinutes")
    def interval_in_minutes(self) -> builtins.int:
        """
...
class GetDataSourceDataSourceDetailLoggingQueryDetailResult(dict):
    def __init__(__self__, *,
                 key_entities_count: builtins.int,
                 logging_query_type: builtins.str):
        """
        :param builtins.int key_entities_count: The key entities count used for data source query
        :param builtins.str logging_query_type: Type of logging query for data source (Sighting/Insight)
        """
        pulumi.set(__self__, "key_entities_count", key_entities_count)
        pulumi.set(__self__, "logging_query_type", logging_query_type)
    ...
    @property
    @pulumi.getter(name="keyEntitiesCount")
    def key_entities_count(self) -> builtins.int:
        """
...
class GetDataSourceDataSourceDetailQueryStartTimeResult(dict):
    def __init__(__self__, *,
                 query_start_time: builtins.str,
                 start_policy_type: builtins.str):
        """
        :param builtins.str query_start_time: Time when the query can start. If not specified it can start immediately
        :param builtins.str start_policy_type: Start policy delay timing
        """
        pulumi.set(__self__, "query_start_time", query_start_time)
        pulumi.set(__self__, "start_policy_type", start_policy_type)
    ...
    @property
    @pulumi.getter(name="queryStartTime")
    def query_start_time(self) -> builtins.str:
        """
        Time when the query can start. If not specified it can start immediately
        """
        return pulumi.get(self, "query_start_time")
...
class GetDataSourceDataSourceDetailScheduledQueryScopeDetailResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str region: Data source replication region
        :param Sequence[builtins.str] resource_ids: List of OCIDs on scheduled query needs to run
        :param builtins.str resource_type: Type of resource
        """
        pulumi.set(__self__, "region", region)
        pulumi.set(__self__, "resource_ids", resource_ids)
...
class GetDataSourceEventItemResult(dict):
    def __init__(__self__, *,
                 ...
                 event_date: builtins.str,
                 event_infos: Sequence['outputs.GetDataSourceEventItemEventInfoResult'],
                 region: builtins.str,
                 status: builtins.str,
                 time_created: builtins.str):
        """
        :param builtins.str comments: Data source event comments
        :param builtins.str data_source_id: DataSource OCID
        :param builtins.str event_date: Data source event date time
        :param Sequence['GetDataSourceEventItemEventInfoArgs'] event_infos: Event info of a data source.
        :param builtins.str region: A filter to return only resource their region matches the given region.
        :param builtins.str status: Current data source event info status
        :param builtins.str time_created: Data source event created time
        """
    ...
    def event_date(self) -> builtins.str:
        """
...
class GetDataSourceEventItemEventInfoResult(dict):
    def __init__(__self__, *,
                 data_source_feed_provider: builtins.str,
                 log_result: builtins.str,
                 observed_value: builtins.str,
                 operator: builtins.str,
    ...
    def log_result(self) -> builtins.str:
        return pulumi.get(self, "log_result")

    @property
    @pulumi.getter(name="observedValue")
    def observed_value(self) -> builtins.str:
...
class GetDataSourceEventsDataSourceEventCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str event_date: Data source event date and time
        ...
        :param builtins.str region: A filter to return only resource where their region matches the given region.
        :param builtins.str status: Current data source event info status
        :param builtins.str time_created: Data source event creation date and time
        """
        pulumi.set(__self__, "comments", comments)
        pulumi.set(__self__, "data_source_id", data_source_id)
        pulumi.set(__self__, "event_date", event_date)
...
class GetDataSourceEventsDataSourceEventCollectionItemEventInfoResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str data_source_feed_provider: Possible type of dataSourceFeed Provider (LoggingQuery)
        :param builtins.str log_result: Log result details of DataSource for a Problem
        :param builtins.str observed_value: Observed value of DataSource for a Problem
        :param builtins.str operator: Operator details of DataSource for a Problem
        :param builtins.str trigger_value: Triggered value of DataSource for a Problem
        """
        pulumi.set(__self__, "data_source_feed_provider", data_source_feed_provider)
        pulumi.set(__self__, "log_result", log_result)
        pulumi.set(__self__, "observed_value", observed_value)
...
class GetDataSourceRegionStatusDetailResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str region: Data source replication region
        :param builtins.str status: Enablement status of the data source
        """
        pulumi.set(__self__, "region", region)
        pulumi.set(__self__, "status", status)
...
class GetDataSourcesDataSourceCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str data_source_feed_provider: A filter to return only resources when their feed provider matches the given feed provider (`DataSourceFeedProvider` resource).
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: OCID for the data source
        ...
        :param builtins.str status: Enablement status of the data source
        :param Mapping[str, builtins.str] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). System tags can be viewed by users, but can only be created by the system.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The date and time the Data source was created. Format defined by RFC3339.
        :param builtins.str time_updated: The date and time the data source was updated. Format defined by RFC3339.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
...
class GetDataSourcesDataSourceCollectionItemDataSourceDetailResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str logging_query_type: A filter to return only resources where their query type matches the given LoggingQueryType.
        :param builtins.str operator: Operator used in data source
        :param builtins.str query: The continuous query expression that is run periodically.
...
class GetDetectorRecipeDetectorRuleResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str data_source_id: The ID of the attached data source
        :param builtins.str description: Description for detector recipe detector rule
        :param Sequence['GetDetectorRecipeDetectorRuleDetailArgs'] details: Detailed information for a detector.
        :param builtins.str detector: Detector recipe for the rule
        :param builtins.str detector_rule_id: The unique identifier of the detector rule.
        :param builtins.str display_name: Display name of the entity
    ...
    @property
    @pulumi.getter
    def detector(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="managedListTypes")
    def managed_list_types(self) -> Sequence[builtins.str]:
        """
        List of managed list types related to this rule
        """
        return pulumi.get(self, "managed_list_types")
...
class GetDetectorRecipeDetectorRuleCandidateResponderRuleResult(dict):
    ...
    @property
    @pulumi.getter(name="isPreferred")
    def is_preferred(self) -> builtins.bool:
        """
        Is this the preferred state?
        """
        return pulumi.get(self, "is_preferred")
...
class GetDetectorRecipeDetectorRuleDetailResult(dict):
    def __init__(__self__, *,
                 ...
                 is_configuration_allowed: builtins.bool,
                 is_enabled: builtins.bool,
    ...
    @property
    @pulumi.getter(name="isConfigurationAllowed")
    def is_configuration_allowed(self) -> builtins.bool:
        """
        Can the rule be configured?
        """
        return pulumi.get(self, "is_configuration_allowed")
...
class GetDetectorRecipesDetectorRecipeCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 description: builtins.str,
                 detector: builtins.str,
                 detector_recipe_type: builtins.str,
                 ...
                 id: builtins.str,
                 owner: builtins.str,
                 source_detector_recipe_id: builtins.str,
                 state: builtins.str,
                 system_tags: Mapping[str, builtins.str],
        ...
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: OCID for detector recipe
        :param builtins.str owner: Owner of detector recipe
        :param builtins.str source_detector_recipe_id: Recipe OCID of the source recipe to be cloned
        :param builtins.str state: The field lifecycle state. Only one state can be provided. Default value for state is active. If no value is specified state is active.
        :param Mapping[str, builtins.str] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). System tags can be viewed by users, but can only be created by the system.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param Sequence[builtins.str] target_ids: List of target IDs to which the recipe is attached
        :param builtins.str time_created: The date and time the detector recipe was created Format defined by RFC3339.
        :param builtins.str time_updated: The date and time the detector recipe was last updated Format defined by RFC3339.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
    ...
    @property
    @pulumi.getter(name="detectorRecipeType")
    def detector_recipe_type(self) -> builtins.str:
        """
        Recipe type ( STANDARD, ENTERPRISE )
        """
        return pulumi.get(self, "detector_recipe_type")
    ...
    def source_detector_recipe_id(self) -> builtins.str:
        """
...
class GetDetectorRecipesFilterResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Configuration name
        :param Sequence[builtins.str] values: List of configuration values
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
...
class GetGuardTargetTargetDetailResult(dict):
    def __init__(__self__, *,
                 security_zone_display_name: builtins.str,
                 security_zone_id: builtins.str,
        ...
        :param builtins.str security_zone_display_name: The name of the security zone to associate with this compartment.
        :param builtins.str security_zone_id: The OCID of the security zone to associate with this compartment
        :param builtins.str target_resource_type: Type of target
    ...
    @property
    @pulumi.getter(name="securityZoneDisplayName")
    def security_zone_display_name(self) -> builtins.str:
        """
        The name of the security zone to associate with this compartment.
        """
        return pulumi.get(self, "security_zone_display_name")
    ...
    @property
    @pulumi.getter(name="securityZoneId")
    def security_zone_id(self) -> builtins.str:
        """
        The OCID of the security zone to associate with this compartment
        """
        return pulumi.get(self, "security_zone_id")
...
class GetGuardTargetTargetDetailTargetSecurityZoneRecipeResult(dict):
    def __init__(__self__, *,
                 ...
                 lifecycle_details: builtins.str,
                 owner: builtins.str,
                 security_policies: Sequence[builtins.str],
                 state: builtins.str,
                 system_tags: Mapping[str, builtins.str],
                 time_created: builtins.str,
                 time_updated: builtins.str):
        ...
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str description: Responder rule description
        :param builtins.str display_name: Responder rule display name
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: Unique identifier of target responder recipe that can't be changed after creation
        :param builtins.str lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        :param builtins.str owner: Owner of target responder recipe
        :param Sequence[builtins.str] security_policies: The list of security policy IDs that are included in the recipe
        :param builtins.str state: The current lifecycle state of the responder rule
        :param Mapping[str, builtins.str] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). System tags can be viewed by users, but can only be created by the system.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The date and time the target was created. Format defined by RFC3339.
        :param builtins.str time_updated: The date and time the target was last updated. Format defined by RFC3339.
        """
    ...
    @property
    @pulumi.getter(name="securityPolicies")
    def security_policies(self) -> Sequence[builtins.str]:
        """
        The list of security policy IDs that are included in the recipe
        """
        return pulumi.get(self, "security_policies")
...
class GetGuardTargetTargetDetectorRecipeResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str description: Responder rule description
        :param builtins.str detector: Detector type for the rule
        :param builtins.str detector_recipe_id: Unique identifier for of original Oracle-managed detector recipe on which the TargetDetectorRecipe is based
        :param builtins.str detector_recipe_type: Recipe type ( STANDARD, ENTERPRISE )
...
class GetGuardTargetTargetResponderRecipeResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str id: Unique identifier of target responder recipe that can't be changed after creation
        :param builtins.str owner: Owner of target responder recipe
        :param builtins.str responder_recipe_id: Unique identifier for the Oracle-managed responder recipe from which this recipe was cloned
...
class GetGuardTargetsTargetCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 freeform_tags: Mapping[str, builtins.str],
                 id: builtins.str,
                 inherited_by_compartments: Sequence[builtins.str],
                 lifecyle_details: builtins.str,
                 recipe_count: builtins.int,
                 state: builtins.str,
                 system_tags: Mapping[str, builtins.str],
        ...
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: Unique identifier of target responder recipe that can't be changed after creation
        :param Sequence[builtins.str] inherited_by_compartments: List of inherited compartments
        :param builtins.str lifecyle_details: A message describing the current lifecycle state in more detail. For example, can be used to provide actionable information for a resource in Failed state. [DEPRECATE]
        :param builtins.int recipe_count: Total number of recipes attached to target
        :param builtins.str state: The field lifecycle state. Only one state can be provided. Default value for state is active. If no value is specified state is active.
        :param Mapping[str, builtins.str] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). System tags can be viewed by users, but can only be created by the system.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
        ...
        :param builtins.str target_resource_id: Resource ID which the target uses to monitor
        :param builtins.str target_resource_type: Type of target
    ...
    def inherited_by_compartments(self) -> Sequence[builtins.str]:
        """
    ...
    def recipe_count(self) -> builtins.int:
        """
...
class GetManagedListsManagedListCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 description: builtins.str,
                 display_name: builtins.str,
                 feed_provider: builtins.str,
                 freeform_tags: Mapping[str, builtins.str],
                 id: builtins.str,
                 is_editable: builtins.bool,
                 lifecyle_details: builtins.str,
                 list_items: Sequence[builtins.str],
                 list_type: builtins.str,
                 source_managed_list_id: builtins.str,
                 state: builtins.str,
                 system_tags: Mapping[str, builtins.str],
                 time_created: builtins.str,
                 time_updated: builtins.str):
        ...
        :param builtins.str compartment_id: The OCID of the compartment in which to list resources.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str description: Managed list description
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param builtins.str feed_provider: Provider of the managed list feed
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: Unique identifier that can't be changed after creation
        :param builtins.bool is_editable: Is this list editable?
        :param builtins.str lifecyle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state. [DEPRECATE]
        :param Sequence[builtins.str] list_items: List of items in the managed list
        :param builtins.str list_type: The type of managed list.
        :param builtins.str source_managed_list_id: OCID of the source managed list
        :param builtins.str state: The field lifecycle state. Only one state can be provided. Default value for state is active. If no value is specified state is active.
        :param Mapping[str, builtins.str] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). System tags can be viewed by users, but can only be created by the system.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The date and time the managed list was created. Format defined by RFC3339.
        :param builtins.str time_updated: The date and time the managed list was last updated. Format defined by RFC3339.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
        pulumi.set(__self__, "description", description)
    ...
    def feed_provider(self) -> builtins.str:
        """
    ...
    def list_items(self) -> Sequence[builtins.str]:
        """
    ...
    def source_managed_list_id(self) -> builtins.str:
        """
...
class GetProblemEntitiesProblemEntityCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 problem_id: builtins.str,
                 regions: Sequence[builtins.str],
                 result_url: builtins.str,
                 time_first_detected: builtins.str,
                 time_last_detected: builtins.str):
        """
        ...
        :param builtins.str problem_id: OCID of the problem.
        :param Sequence[builtins.str] regions: Data source problem entities region
        :param builtins.str result_url: Log result query URL for a data source query
        :param builtins.str time_first_detected: Data source problem entities first detected time
        :param builtins.str time_last_detected: Data source problem entities last detected time
        """
    ...
    def problem_id(self) -> builtins.str:
        """
        OCID of the problem.
        """
    ...
    def result_url(self) -> builtins.str:
        """
    ...
    def time_first_detected(self) -> builtins.str:
        """
    ...
    def time_last_detected(self) -> builtins.str:
        """
...
class GetProblemEntitiesProblemEntityCollectionItemEntityDetailResult(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str display_name: The display name of entity
        :param builtins.str type: Type of entity
        :param builtins.str value: The entity value
        """
        pulumi.set(__self__, "display_name", display_name)
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
...
class GetResponderRecipesResponderRecipeCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 source_responder_recipe_id: builtins.str,
                 state: builtins.str,
                 system_tags: Mapping[str, builtins.str],
                 time_created: builtins.str,
                 time_updated: builtins.str):
        ...
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: Unique identifier for the responder recip
        :param builtins.str lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        :param builtins.str owner: Owner of responder recipe
        ...
        :param builtins.str source_responder_recipe_id: The unique identifier of the source responder recipe
        :param builtins.str state: The field lifecycle state. Only one state can be provided. Default value for state is active. If no value is specified state is active.
        :param Mapping[str, builtins.str] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). System tags can be viewed by users, but can only be created by the system.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The date and time the responder recipe was created. Format defined by RFC3339.
        :param builtins.str time_updated: The date and time the responder recipe was last updated. Format defined by RFC3339.
    ...
    def source_responder_recipe_id(self) -> builtins.str:
        """
...
class GetSavedQueriesSavedQueryCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str compartment_id: The OCID of the compartment in which to list resources.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str description: Description of the saved query
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: OCID for the saved query
        :param builtins.str query: The saved query expression
        :param builtins.str state: The current lifecycle state of the resource
        :param Mapping[str, builtins.str] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). System tags can be viewed by users, but can only be created by the system.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The date and time the saved query was created. Format defined by RFC3339.
        :param builtins.str time_updated: The date and time the saved query was updated. Format defined by RFC3339.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
        pulumi.set(__self__, "description", description)
...
class GetSecurityPoliciesSecurityPolicyCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 time_updated: builtins.str):
        """
        :param builtins.str category: The category of the security policy
        :param builtins.str compartment_id: The OCID of the compartment in which to list resources.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str description: The security policy's description
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str friendly_name: A shorter version of the security policy's name
        :param builtins.str id: The unique identifier of the security zone policy. (`SecurityPolicy`)
        :param builtins.str lifecycle_details: A message describing the current state in more detail. For example, this can be used to provide actionable information for a resource in a `Failed` state.
        :param builtins.str owner: The owner of the security policy
        :param Sequence[builtins.str] services: The list of services that the security policy protects
        :param builtins.str state: The field lifecycle state. Only one state can be provided. Default value for state is active. If no value is specified state is active.
        :param builtins.str time_created: The time the security policy was created. An RFC3339 formatted datetime string.
        :param builtins.str time_updated: The time the security policy was last updated. An RFC3339 formatted datetime string.
        """
...
class GetSecurityRecipesSecurityRecipeCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str compartment_id: The OCID of the compartment in which to list resources.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str description: The recipe's description
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: The unique identifier of the security zone recipe. (`SecurityRecipe`)
        :param builtins.str lifecycle_details: A message describing the current state in more detail. For example, this can be used to provide actionable information for a recipe in the `Failed` state.
        :param builtins.str owner: The owner of the recipe
        :param Sequence[builtins.str] security_policies: The list of security policy IDs that are included in the recipe
        :param builtins.str state: The field lifecycle state. Only one state can be provided. Default value for state is active. If no value is specified state is active.
        :param builtins.str time_created: The time the recipe was created. An RFC3339 formatted datetime string.
        :param builtins.str time_updated: The time the recipe was last updated. An RFC3339 formatted datetime string.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
        pulumi.set(__self__, "description", description)
...
class GetSecurityZonesSecurityZoneCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 inherited_by_compartments: Sequence[builtins.str],
                 lifecycle_details: builtins.str,
                 security_zone_recipe_id: builtins.str,
                 security_zone_target_id: builtins.str,
                 state: builtins.str,
                 time_created: builtins.str,
                 time_updated: builtins.str):
        """
        :param builtins.str compartment_id: The OCID of the compartment in which to list resources.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str description: The security zone's description
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: The unique identifier of the security zone (`SecurityZone` resource).
        :param Sequence[builtins.str] inherited_by_compartments: List of inherited compartments
        :param builtins.str lifecycle_details: A message describing the current state in more detail. For example, this can be used to provide actionable information for a zone in the `Failed` state.
        :param builtins.str security_zone_recipe_id: The OCID of the recipe (`SecurityRecipe` resource) for the security zone
        :param builtins.str security_zone_target_id: The OCID of the target associated with the security zone
        :param builtins.str state: The field lifecycle state. Only one state can be provided. Default value for state is active. If no value is specified state is active.
        :param builtins.str time_created: The time the security zone was created. An RFC3339 formatted datetime string.
        :param builtins.str time_updated: The time the security zone was last updated. An RFC3339 formatted datetime string.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
        pulumi.set(__self__, "description", description)
    ...
    def security_zone_recipe_id(self) -> builtins.str:
        """
    ...
    def security_zone_target_id(self) -> builtins.str:
        """
...
class GetWlpAgentsWlpAgentCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 certificate_signed_request: builtins.str,
                 compartment_id: builtins.str,
                 defined_tags: Mapping[str, builtins.str],
                 freeform_tags: Mapping[str, builtins.str],
                 host_id: builtins.str,
                 id: builtins.str,
                 os_info: builtins.str,
                 system_tags: Mapping[str, builtins.str],
                 tenant_id: builtins.str,
                 time_created: builtins.str,
                 time_updated: builtins.str):
        """
        :param builtins.str agent_version: The version of the agent
        :param builtins.str certificate_id: The certificate ID returned by Oracle Cloud Infrastructure certificates service
        :param builtins.str certificate_signed_request: The updated certificate signing request
        :param builtins.str compartment_id: The OCID of the compartment in which to list resources.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str host_id: OCID for instance in which WlpAgent is installed
        :param builtins.str id: OCID for WlpAgent
        :param Mapping[str, builtins.str] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). System tags can be viewed by users, but can only be created by the system.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str tenant_id: TenantId of the host
        :param builtins.str time_created: The date and time the WlpAgent was created. Format defined by RFC3339.
        :param builtins.str time_updated: The date and time the WlpAgent was updated. Format defined by RFC3339.
        """
    ...
    def certificate_signed_request(self) -> builtins.str:
        """
