...
class ResponderRecipeArgs:
    def __init__(__self__, *,
                 ...
                 source_responder_recipe_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] source_responder_recipe_id: The unique identifier of the source responder recipe
    ...
    def source_responder_recipe_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_responder_recipe_id(self, value: pulumi.Input[builtins.str]):
...
class _ResponderRecipeState:
    def __init__(__self__, *,
                 ...
                 responder_rules: Optional[pulumi.Input[Sequence[pulumi.Input['ResponderRecipeResponderRuleArgs']]]] = None,
                 source_responder_recipe_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] owner: Owner of responder recipe
        :param pulumi.Input[Sequence[pulumi.Input['ResponderRecipeResponderRuleArgs']]] responder_rules: (Updatable) List of responder rules to override from source responder recipe
        :param pulumi.Input[builtins.str] source_responder_recipe_id: The unique identifier of the source responder recipe
    ...
    @property
    @pulumi.getter(name="sourceResponderRecipeId")
    def source_responder_recipe_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The unique identifier of the source responder recipe
    ...
    @source_responder_recipe_id.setter
    def source_responder_recipe_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_responder_recipe_id", value)
...
class ResponderRecipe(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'ResponderRecipe':
        """
    ...
    @property
    @pulumi.getter(name="sourceResponderRecipeId")
    def source_responder_recipe_id(self) -> pulumi.Output[builtins.str]:
        """
        The unique identifier of the source responder recipe
