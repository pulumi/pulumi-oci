...
class SavedQueryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) Compartment OCID of the saved query
        :param pulumi.Input[builtins.str] display_name: (Updatable) Display name of the saved query
        :param pulumi.Input[builtins.str] query: (Updatable) The adhoc query expression that is run
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Description of the saved query
...
class _SavedQueryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the saved query was created. Format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_updated: The date and time the saved query was updated. Format defined by RFC3339.
        """
...
class SavedQuery(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'SavedQuery':
        """
