...
class _SavedQueryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] time_created: The date and time the saved query was created. Format defined by RFC3339.
        :param pulumi.Input[_builtins.str] time_updated: The date and time the saved query was updated. Format defined by RFC3339.
        """
...
class SavedQuery(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[_builtins.str]] = None,
            time_updated: Optional[pulumi.Input[_builtins.str]] = None) -> 'SavedQuery':
        """
