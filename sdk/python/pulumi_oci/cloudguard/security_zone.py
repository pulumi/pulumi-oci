...
class SecurityZoneArgs:
    def __init__(__self__, *,
                 ...
                 security_zone_recipe_id: pulumi.Input[builtins.str],
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a SecurityZone resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment for the security zone
        :param pulumi.Input[builtins.str] display_name: (Updatable) The security zone's display name
        :param pulumi.Input[builtins.str] security_zone_recipe_id: (Updatable) The OCID of the security zone recipe (`SecurityRecipe` resource) for the security zone
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) The security zone's description
    ...
    def security_zone_recipe_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def security_zone_recipe_id(self, value: pulumi.Input[builtins.str]):
...
class _SecurityZoneState:
    def __init__(__self__, *,
                 ...
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 inherited_by_compartments: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 lifecycle_details: Optional[pulumi.Input[builtins.str]] = None,
                 security_zone_recipe_id: Optional[pulumi.Input[builtins.str]] = None,
                 security_zone_target_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
               ...
               Avoid entering confidential information.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] inherited_by_compartments: List of inherited compartments
        :param pulumi.Input[builtins.str] lifecycle_details: A message describing the current state in more detail. For example, this can be used to provide actionable information for a zone in the `Failed` state.
        :param pulumi.Input[builtins.str] security_zone_recipe_id: (Updatable) The OCID of the security zone recipe (`SecurityRecipe` resource) for the security zone
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] security_zone_target_id: The OCID of the target associated with the security zone
        :param pulumi.Input[builtins.str] state: The current lifecycle state of the security zone
        :param pulumi.Input[builtins.str] time_created: The time the security zone was created. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The time the security zone was last updated. An RFC3339 formatted datetime string.
        """
    ...
    def inherited_by_compartments(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def inherited_by_compartments(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    @property
    @pulumi.getter(name="securityZoneRecipeId")
    def security_zone_recipe_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The OCID of the security zone recipe (`SecurityRecipe` resource) for the security zone
    ...
    @security_zone_recipe_id.setter
    def security_zone_recipe_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "security_zone_recipe_id", value)

    @property
    @pulumi.getter(name="securityZoneTargetId")
    def security_zone_target_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def security_zone_target_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SecurityZone(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'SecurityZone':
        """
    ...
    @property
    @pulumi.getter(name="inheritedByCompartments")
    def inherited_by_compartments(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List of inherited compartments
        """
        return pulumi.get(self, "inherited_by_compartments")
    ...
    @property
    @pulumi.getter(name="securityZoneRecipeId")
    def security_zone_recipe_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The OCID of the security zone recipe (`SecurityRecipe` resource) for the security zone
    ...
    @property
    @pulumi.getter(name="securityZoneTargetId")
    def security_zone_target_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the target associated with the security zone
        """
        return pulumi.get(self, "security_zone_target_id")
