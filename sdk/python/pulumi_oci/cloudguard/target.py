...
class Target(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_target = oci.cloud_guard.Target("testTarget",
            ...
            target_detector_recipes=[oci.cloud.guard.TargetTargetDetectorRecipeArgs(
                detector_recipe_id=oci_cloud_guard_detector_recipe["test_detector_recipe"]["id"],
                detector_rules=[oci.cloud.guard.TargetTargetDetectorRecipeDetectorRuleArgs(
                    details=oci.cloud.guard.TargetTargetDetectorRecipeDetectorRuleDetailsArgs(
                        condition_groups=[oci.cloud.guard.TargetTargetDetectorRecipeDetectorRuleDetailsConditionGroupArgs(
                            compartment_id=var["compartment_id"],
            ...
            target_responder_recipes=[oci.cloud.guard.TargetTargetResponderRecipeArgs(
                responder_recipe_id=oci_cloud_guard_responder_recipe["test_responder_recipe"]["id"],
                responder_rules=[oci.cloud.guard.TargetTargetResponderRecipeResponderRuleArgs(
                    details=oci.cloud.guard.TargetTargetResponderRecipeResponderRuleDetailsArgs(
                        condition=var["target_target_responder_recipes_responder_rules_details_condition"],
                        configurations=[oci.cloud.guard.TargetTargetResponderRecipeResponderRuleDetailsConfigurationArgs(
