...
class TargetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] target_resource_id: Resource ID which the target uses to monitor
...
class _TargetState:
    def __init__(__self__, *,
                 ...
                 recipe_count: Optional[pulumi.Input[builtins.int]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] lifecyle_details: A message describing the current lifecycle state in more detail. For example, can be used to provide actionable information for a resource in Failed state. [DEPRECATE]
        :param pulumi.Input[builtins.int] recipe_count: Total number of recipes attached to target
        :param pulumi.Input[builtins.str] state: (Updatable) The enablement state of the detector rule
    ...
    def recipe_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @recipe_count.setter
    def recipe_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Target(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target_responder_recipes: Optional[pulumi.Input[Sequence[pulumi.Input[Union['TargetTargetResponderRecipeArgs', 'TargetTargetResponderRecipeArgsDict']]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'Target':
        """
    ...
    @property
    @pulumi.getter(name="recipeCount")
    def recipe_count(self) -> pulumi.Output[builtins.int]:
        """
        Total number of recipes attached to target
        """
        return pulumi.get(self, "recipe_count")
