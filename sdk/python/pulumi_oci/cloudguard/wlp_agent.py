...
class WlpAgentArgs:
    def __init__(__self__, *,
                 ...
                 certificate_signed_request: pulumi.Input[builtins.str],
                 compartment_id: pulumi.Input[builtins.str],
                 os_info: pulumi.Input[builtins.str],
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a WlpAgent resource.
        :param pulumi.Input[builtins.str] agent_version: The version of the agent making the request
        :param pulumi.Input[builtins.str] certificate_signed_request: (Updatable) The certificate signed request containing domain, organization names, organization units, city, state, country, email and public key, among other certificate details, signed by private key
        :param pulumi.Input[builtins.str] compartment_id: Compartment OCID of the host
        :param pulumi.Input[builtins.str] os_info: Concatenated OS name, OS version and agent architecture; for example, ubuntu_22.0_amd64.
    ...
    def certificate_signed_request(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def certificate_signed_request(self, value: pulumi.Input[builtins.str]):
    ...
    def os_info(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @os_info.setter
    def os_info(self, value: pulumi.Input[builtins.str]):
...
class _WlpAgentState:
    def __init__(__self__, *,
                 ...
                 certificate_signed_request: Optional[pulumi.Input[builtins.str]] = None,
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 host_id: Optional[pulumi.Input[builtins.str]] = None,
                 os_info: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] agent_version: The version of the agent making the request
        :param pulumi.Input[builtins.str] certificate_id: The certificate ID returned by Oracle Cloud Infrastructure certificates service
        :param pulumi.Input[builtins.str] certificate_signed_request: (Updatable) The certificate signed request containing domain, organization names, organization units, city, state, country, email and public key, among other certificate details, signed by private key
        :param pulumi.Input[builtins.str] compartment_id: Compartment OCID of the host
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
               ...
               Avoid entering confidential information.
        :param pulumi.Input[builtins.str] host_id: OCID for instance in which WlpAgent is installed
        :param pulumi.Input[builtins.str] os_info: Concatenated OS name, OS version and agent architecture; for example, ubuntu_22.0_amd64.
        ...
        :param pulumi.Input[builtins.str] tenant_id: TenantId of the host
        :param pulumi.Input[builtins.str] time_created: The date and time the WlpAgent was created. Format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_updated: The date and time the WlpAgent was updated. Format defined by RFC3339.
        """
    ...
    @property
    @pulumi.getter(name="certificateSignedRequest")
    def certificate_signed_request(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The certificate signed request containing domain, organization names, organization units, city, state, country, email and public key, among other certificate details, signed by private key
        """
        return pulumi.get(self, "certificate_signed_request")
    ...
    @certificate_signed_request.setter
    def certificate_signed_request(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "certificate_signed_request", value)
    ...
    @property
    @pulumi.getter(name="osInfo")
    def os_info(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Concatenated OS name, OS version and agent architecture; for example, ubuntu_22.0_amd64.
    ...
    @os_info.setter
    def os_info(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "os_info", value)
...
class WlpAgent(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tenant_id: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'WlpAgent':
        """
    ...
    @property
    @pulumi.getter(name="certificateSignedRequest")
    def certificate_signed_request(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The certificate signed request containing domain, organization names, organization units, city, state, country, email and public key, among other certificate details, signed by private key
        """
        return pulumi.get(self, "certificate_signed_request")
    ...
    @property
    @pulumi.getter(name="osInfo")
    def os_info(self) -> pulumi.Output[builtins.str]:
        """
        Concatenated OS name, OS version and agent architecture; for example, ubuntu_22.0_amd64.
