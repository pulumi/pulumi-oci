...
class GetMigrationResult:
    ...
    def __init__(__self__, compartment_id=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, is_completed=None, lifecycle_details=None, migration_id=None, replication_schedule_id=None, state=None, system_tags=None, time_created=None, time_updated=None):
        ...
        if is_completed and not isinstance(is_completed, bool):
            raise TypeError("Expected argument 'is_completed' to be a bool")
...
def get_migration(migration_id: Optional[builtins.str] = None,
...
def get_migration_output(migration_id: Optional[pulumi.Input[builtins.str]] = None,
