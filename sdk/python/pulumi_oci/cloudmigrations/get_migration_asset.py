...
class GetMigrationAssetResult:
    ...
    def migration_asset_id(self) -> _builtins.str:
...
def get_migration_asset(migration_asset_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str migration_asset_id: Unique migration asset identifier
    """
    __args__ = dict()
