...
class GetMigrationAssetResult:
    ...
    def migration_asset_id(self) -> builtins.str:
...
def get_migration_asset(migration_asset_id: Optional[builtins.str] = None,
...
def get_migration_asset_output(migration_asset_id: Optional[pulumi.Input[builtins.str]] = None,
