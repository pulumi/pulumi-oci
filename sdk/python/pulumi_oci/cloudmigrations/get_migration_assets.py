...
class GetMigrationAssetsResult:
    ...
    def migration_asset_id(self) -> Optional[builtins.str]:
...
def get_migration_assets(display_name: Optional[builtins.str] = None,
                         filters: Optional[Sequence[Union['GetMigrationAssetsFilterArgs', 'GetMigrationAssetsFilterArgsDict']]] = None,
                         migration_asset_id: Optional[builtins.str] = None,
    ...
    :param builtins.str migration_asset_id: Unique migration asset identifier
...
def get_migration_assets_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                filters: Optional[pulumi.Input[Optional[Sequence[Union['GetMigrationAssetsFilterArgs', 'GetMigrationAssetsFilterArgsDict']]]]] = None,
                                migration_asset_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
