...
def get_migration_plan(migration_plan_id: Optional[builtins.str] = None,
...
def get_migration_plan_output(migration_plan_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:CloudMigrations/getMigrationPlan:getMigrationPlan', __args__, opts=opts, typ=GetMigrationPlanResult)
    return __ret__.apply(lambda __response__: GetMigrationPlanResult(
        calculated_limits=pulumi.get(__response__, 'calculated_limits'),
        ...
        migration_plan_stats=pulumi.get(__response__, 'migration_plan_stats'),
        reference_to_rms_stack=pulumi.get(__response__, 'reference_to_rms_stack'),
        source_migration_plan_id=pulumi.get(__response__, 'source_migration_plan_id'),
        state=pulumi.get(__response__, 'state'),
        strategies=pulumi.get(__response__, 'strategies'),
        system_tags=pulumi.get(__response__, 'system_tags'),
        target_environments=pulumi.get(__response__, 'target_environments'),
