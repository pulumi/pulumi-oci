...
class GetMigrationPlanAvailableShapesResult:
    ...
    def dvh_host_id(self) -> Optional[builtins.str]:
    ...
    def reserved_capacity_id(self) -> Optional[builtins.str]:
...
def get_migration_plan_available_shapes(availability_domain: Optional[builtins.str] = None,
                                        compartment_id: Optional[builtins.str] = None,
                                        dvh_host_id: Optional[builtins.str] = None,
                                        ...
                                        reserved_capacity_id: Optional[builtins.str] = None,
    ...
    :param builtins.str dvh_host_id: The ID of the Dvh in which to list resources.
    :param builtins.str migration_plan_id: Unique migration plan identifier
    :param builtins.str reserved_capacity_id: The reserved capacity ID for which to list resources.
    """
    __args__ = dict()
...
def get_migration_plan_available_shapes_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                               compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                               dvh_host_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                               ...
                                               reserved_capacity_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
