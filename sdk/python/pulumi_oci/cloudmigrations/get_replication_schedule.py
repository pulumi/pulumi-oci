...
def get_replication_schedule(replication_schedule_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str replication_schedule_id: Unique replication schedule identifier in path
    """
    __args__ = dict()
