...
def get_replication_schedule(replication_schedule_id: Optional[builtins.str] = None,
    ...
    :param builtins.str replication_schedule_id: Unique replication schedule identifier in path
    """
    __args__ = dict()
...
def get_replication_schedule_output(replication_schedule_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:CloudMigrations/getReplicationSchedule:getReplicationSchedule', __args__, opts=opts, typ=GetReplicationScheduleResult)
    return __ret__.apply(lambda __response__: GetReplicationScheduleResult(
