...
def get_replication_schedules(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str replication_schedule_id: Unique replication schedule identifier in query
...
def get_replication_schedules_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     ...
                                     replication_schedule_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
