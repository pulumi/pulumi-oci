...
class GetTargetAssetResult:
    ...
    def compatibility_messages(self) -> Optional[Sequence['outputs.GetTargetAssetCompatibilityMessageResult']]:
    ...
    def estimated_costs(self) -> Optional[Sequence['outputs.GetTargetAssetEstimatedCostResult']]:
    ...
    def migration_assets(self) -> Optional[Sequence['outputs.GetTargetAssetMigrationAssetResult']]:
    ...
    def recommended_specs(self) -> Optional[Sequence['outputs.GetTargetAssetRecommendedSpecResult']]:
    ...
    def test_specs(self) -> Optional[Sequence['outputs.GetTargetAssetTestSpecResult']]:
    ...
    def user_specs(self) -> Optional[Sequence['outputs.GetTargetAssetUserSpecResult']]:
