...
class GetTargetAssetResult:
    ...
    def target_asset_id(self) -> _builtins.str:
...
def get_target_asset(target_asset_id: Optional[_builtins.str] = None,
...
def get_target_asset_output(target_asset_id: Optional[pulumi.Input[_builtins.str]] = None,
