...
def get_target_asset(target_asset_id: Optional[str] = None,
    ...
    return AwaitableGetTargetAssetResult(
        block_volumes_performance=__ret__.block_volumes_performance,
        compartment_id=__ret__.compartment_id,
        compatibility_messages=__ret__.compatibility_messages,
        created_resource_id=__ret__.created_resource_id,
        display_name=__ret__.display_name,
        estimated_costs=__ret__.estimated_costs,
        id=__ret__.id,
        is_excluded_from_execution=__ret__.is_excluded_from_execution,
        lifecycle_details=__ret__.lifecycle_details,
        migration_assets=__ret__.migration_assets,
        migration_plan_id=__ret__.migration_plan_id,
        ms_license=__ret__.ms_license,
        preferred_shape_type=__ret__.preferred_shape_type,
        recommended_specs=__ret__.recommended_specs,
        state=__ret__.state,
        target_asset_id=__ret__.target_asset_id,
        test_specs=__ret__.test_specs,
        time_assessed=__ret__.time_assessed,
        time_created=__ret__.time_created,
        time_updated=__ret__.time_updated,
        type=__ret__.type,
        user_specs=__ret__.user_specs)
