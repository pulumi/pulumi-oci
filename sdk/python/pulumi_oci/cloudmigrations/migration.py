...
class MigrationArgs:
    def __init__(__self__, *,
                 ...
                 is_completed: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) Migration identifier
        ...
        :param pulumi.Input[builtins.bool] is_completed: (Updatable) Indicates whether migration is marked as complete.
        :param pulumi.Input[builtins.str] replication_schedule_id: (Updatable) Replication schedule identifier
    ...
    def is_completed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_completed.setter
    def is_completed(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _MigrationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] replication_schedule_id: (Updatable) Replication schedule identifier
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The current state of migration.
        ...
        :param pulumi.Input[builtins.str] time_created: The time when the migration project was created. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.str] time_updated: The time when the migration project was updated. An RFC3339 formatted datetime string
        """
...
class Migration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'Migration':
        """
    ...
    @property
    @pulumi.getter(name="isCompleted")
    def is_completed(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Indicates whether migration is marked as complete.
        """
        return pulumi.get(self, "is_completed")
    ...
    @property
    @pulumi.getter(name="replicationScheduleId")
    def replication_schedule_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Replication schedule identifier
