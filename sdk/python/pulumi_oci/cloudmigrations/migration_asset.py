...
class MigrationAssetArgs:
    def __init__(__self__, *,
                 ...
                 inventory_asset_id: pulumi.Input[builtins.str],
                 migration_id: pulumi.Input[builtins.str],
                 replication_compartment_id: pulumi.Input[builtins.str],
                 snap_shot_bucket_name: pulumi.Input[builtins.str],
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 migration_asset_depends_ons: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] availability_domain: Availability domain
        :param pulumi.Input[builtins.str] inventory_asset_id: OCID of an asset for an inventory.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name. If empty, then source asset name will be used. Does not have to be unique, and it's changeable. Avoid entering confidential information.
    ...
    def inventory_asset_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def inventory_asset_id(self, value: pulumi.Input[builtins.str]):
    ...
    def replication_compartment_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def replication_compartment_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "replication_compartment_id", value)

    @property
    @pulumi.getter(name="snapShotBucketName")
    def snap_shot_bucket_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def snap_shot_bucket_name(self, value: pulumi.Input[builtins.str]):
    ...
    def migration_asset_depends_ons(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "migration_asset_depends_ons")

    @migration_asset_depends_ons.setter
    def migration_asset_depends_ons(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _MigrationAssetState:
    def __init__(__self__, *,
                 ...
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 inventory_asset_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] state: The current state of the migration asset.
        :param pulumi.Input[builtins.str] tenancy_id: Tenancy identifier
        :param pulumi.Input[builtins.str] time_created: The time when the migration asset was created. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The time when the migration asset was updated. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] type: The type of asset referenced for inventory.
        """
    ...
    @property
    @pulumi.getter(name="inventoryAssetId")
    def inventory_asset_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        OCID of an asset for an inventory.
        """
        return pulumi.get(self, "inventory_asset_id")
    ...
    @inventory_asset_id.setter
    def inventory_asset_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "inventory_asset_id", value)
...
class MigrationAsset(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'MigrationAsset':
        """
    ...
    @property
    @pulumi.getter(name="dependedOnBies")
    def depended_on_bies(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List of migration assets that depend on the asset.
        """
        return pulumi.get(self, "depended_on_bies")
    ...
    @property
    @pulumi.getter(name="inventoryAssetId")
    def inventory_asset_id(self) -> pulumi.Output[builtins.str]:
        """
        OCID of an asset for an inventory.
        """
        return pulumi.get(self, "inventory_asset_id")
    ...
    @property
    @pulumi.getter(name="migrationAssetDependsOns")
    def migration_asset_depends_ons(self) -> pulumi.Output[Sequence[builtins.str]]:
        return pulumi.get(self, "migration_asset_depends_ons")
    ...
    @property
    @pulumi.getter(name="parentSnapshot")
    def parent_snapshot(self) -> pulumi.Output[builtins.str]:
        """
        The parent snapshot of the migration asset to be used by the replication task.
        """
        return pulumi.get(self, "parent_snapshot")
    ...
    @property
    @pulumi.getter(name="replicationCompartmentId")
    def replication_compartment_id(self) -> pulumi.Output[builtins.str]:
        """
        Replication compartment identifier
        """
        return pulumi.get(self, "replication_compartment_id")
    ...
    @property
    @pulumi.getter(name="snapShotBucketName")
    def snap_shot_bucket_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of snapshot bucket
    ...
    @property
    @pulumi.getter
    def snapshots(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        Key-value pair representing disks ID mapped to the OCIDs of replicated or hydration server volume snapshots. Example: `{"bar-key": "value"}`
        """
        return pulumi.get(self, "snapshots")
    ...
    @property
    @pulumi.getter(name="sourceAssetId")
    def source_asset_id(self) -> pulumi.Output[builtins.str]:
        """
        OCID that is referenced to an asset for an inventory.
        """
        return pulumi.get(self, "source_asset_id")
