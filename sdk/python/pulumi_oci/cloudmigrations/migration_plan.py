...
class MigrationPlanArgs:
    def __init__(__self__, *,
                 ...
                 migration_id: pulumi.Input[builtins.str],
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 source_migration_plan_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) Migration plan identifier
        :param pulumi.Input[builtins.str] migration_id: The OCID of the associated migration.
        ...
        :param pulumi.Input[builtins.str] source_migration_plan_id: Source migraiton plan ID to be cloned.
    ...
    def migration_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @migration_id.setter
    def migration_id(self, value: pulumi.Input[builtins.str]):
    ...
    def source_migration_plan_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_migration_plan_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _MigrationPlanState:
    def __init__(__self__, *,
                 calculated_limits: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 ...
                 reference_to_rms_stack: Optional[pulumi.Input[builtins.str]] = None,
                 source_migration_plan_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] calculated_limits: Limits of the resources that are needed for migration. Example: {"BlockVolume": 2, "VCN": 1}
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) Compartment identifier
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] display_name: (Updatable) Migration plan identifier
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. It exists only for cross-compatibility. Example: `{"bar-key": "value"}`
        ...
        :param pulumi.Input[builtins.str] reference_to_rms_stack: OCID of the referenced ORM job.
        :param pulumi.Input[builtins.str] source_migration_plan_id: Source migraiton plan ID to be cloned.
        :param pulumi.Input[builtins.str] state: The current state of the migration plan.
        :param pulumi.Input[Sequence[pulumi.Input['MigrationPlanStrategyArgs']]] strategies: (Updatable) List of strategies for the resources to be migrated.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['MigrationPlanTargetEnvironmentArgs']]] target_environments: (Updatable) List of target environments.
        :param pulumi.Input[builtins.str] time_created: The time when the migration plan was created. An RFC3339 formatted datetime string.
    ...
    def calculated_limits(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def calculated_limits(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def reference_to_rms_stack(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def reference_to_rms_stack(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MigrationPlan(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target_environments: Optional[pulumi.Input[Sequence[pulumi.Input[Union['MigrationPlanTargetEnvironmentArgs', 'MigrationPlanTargetEnvironmentArgsDict']]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'MigrationPlan':
        """
    ...
    @property
    @pulumi.getter(name="calculatedLimits")
    def calculated_limits(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        Limits of the resources that are needed for migration. Example: {"BlockVolume": 2, "VCN": 1}
        """
        return pulumi.get(self, "calculated_limits")
    ...
    @property
    @pulumi.getter(name="referenceToRmsStack")
    def reference_to_rms_stack(self) -> pulumi.Output[builtins.str]:
        """
        OCID of the referenced ORM job.
        """
        return pulumi.get(self, "reference_to_rms_stack")
    ...
    @property
    @pulumi.getter(name="sourceMigrationPlanId")
    def source_migration_plan_id(self) -> pulumi.Output[builtins.str]:
        """
        Source migraiton plan ID to be cloned.
        """
        return pulumi.get(self, "source_migration_plan_id")
