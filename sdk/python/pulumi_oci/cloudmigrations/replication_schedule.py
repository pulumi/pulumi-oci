...
class ReplicationScheduleArgs:
    def __init__(__self__, *,
                 ...
                 execution_recurrences: pulumi.Input[builtins.str],
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a ReplicationSchedule resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which the replication schedule should be created.
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name for a replication schedule. Does not have to be unique, and is mutable. Avoid entering confidential information.
        :param pulumi.Input[builtins.str] execution_recurrences: (Updatable) Recurrence specification for replication schedule execution.
    ...
    def execution_recurrences(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def execution_recurrences(self, value: pulumi.Input[builtins.str]):
...
class _ReplicationScheduleState:
    def __init__(__self__, *,
                 ...
                 execution_recurrences: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. It exists only for cross-compatibility. Example: `{"bar-key": "value"}` 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] lifecycle_details: The detailed state of the replication schedule.
        :param pulumi.Input[builtins.str] state: Current state of the replication schedule.
        ...
        :param pulumi.Input[builtins.str] time_created: The time when the replication schedule was created in RFC3339 format.
        :param pulumi.Input[builtins.str] time_updated: The time when the replication schedule was last updated in RFC3339 format.
        """
    ...
    @property
    @pulumi.getter(name="executionRecurrences")
    def execution_recurrences(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Recurrence specification for replication schedule execution.
        """
        return pulumi.get(self, "execution_recurrences")
    ...
    @execution_recurrences.setter
    def execution_recurrences(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "execution_recurrences", value)
...
class ReplicationSchedule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'ReplicationSchedule':
        """
    ...
    @property
    @pulumi.getter(name="executionRecurrences")
    def execution_recurrences(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Recurrence specification for replication schedule execution.
        """
        return pulumi.get(self, "execution_recurrences")
