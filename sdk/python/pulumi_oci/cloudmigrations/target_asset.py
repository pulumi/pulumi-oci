...
class TargetAssetArgs:
    def __init__(__self__, *,
                 is_excluded_from_execution: pulumi.Input[builtins.bool],
                 migration_plan_id: pulumi.Input[builtins.str],
                 preferred_shape_type: pulumi.Input[builtins.str],
                 type: pulumi.Input[builtins.str],
                 user_spec: pulumi.Input['TargetAssetUserSpecArgs'],
                 block_volumes_performance: Optional[pulumi.Input[builtins.int]] = None,
                 ms_license: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a TargetAsset resource.
        :param pulumi.Input[builtins.bool] is_excluded_from_execution: (Updatable) A boolean indicating whether the asset should be migrated.
        :param pulumi.Input[builtins.str] migration_plan_id: OCID of the associated migration plan.
        :param pulumi.Input[builtins.str] preferred_shape_type: (Updatable) Preferred VM shape type that you provide.
        ...
        :param pulumi.Input[builtins.int] block_volumes_performance: (Updatable) Performance of the block volumes.
    ...
    def is_excluded_from_execution(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def is_excluded_from_execution(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "is_excluded_from_execution", value)

    @property
    @pulumi.getter(name="migrationPlanId")
    def migration_plan_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def migration_plan_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "migration_plan_id", value)

    @property
    @pulumi.getter(name="preferredShapeType")
    def preferred_shape_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def preferred_shape_type(self, value: pulumi.Input[builtins.str]):
    ...
    def block_volumes_performance(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def block_volumes_performance(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _TargetAssetState:
    def __init__(__self__, *,
                 ...
                 time_assessed: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] created_resource_id: Created resource identifier
        ...
        :param pulumi.Input[builtins.str] time_assessed: The time when the assessment was done. An RFC3339 formatted datetime string.
    ...
    def created_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def created_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="isExcludedFromExecution")
    def is_excluded_from_execution(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) A boolean indicating whether the asset should be migrated.
        """
        return pulumi.get(self, "is_excluded_from_execution")
    ...
    @is_excluded_from_execution.setter
    def is_excluded_from_execution(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_excluded_from_execution", value)
    ...
    @property
    @pulumi.getter(name="migrationPlanId")
    def migration_plan_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        OCID of the associated migration plan.
        """
        return pulumi.get(self, "migration_plan_id")
    ...
    @migration_plan_id.setter
    def migration_plan_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "migration_plan_id", value)
    ...
    def time_assessed(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_assessed(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TargetAsset(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="blockVolumesPerformance")
    def block_volumes_performance(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) Performance of the block volumes.
        """
        return pulumi.get(self, "block_volumes_performance")
    ...
    @property
    @pulumi.getter(name="createdResourceId")
    def created_resource_id(self) -> pulumi.Output[builtins.str]:
        """
        Created resource identifier
        """
        return pulumi.get(self, "created_resource_id")
    ...
    @property
    @pulumi.getter(name="isExcludedFromExecution")
    def is_excluded_from_execution(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) A boolean indicating whether the asset should be migrated.
        """
        return pulumi.get(self, "is_excluded_from_execution")
    ...
    @property
    @pulumi.getter(name="migrationPlanId")
    def migration_plan_id(self) -> pulumi.Output[builtins.str]:
        """
        OCID of the associated migration plan.
        """
        return pulumi.get(self, "migration_plan_id")
    ...
    @property
    @pulumi.getter(name="msLicense")
    def ms_license(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Microsoft license for the VM configuration.
        """
        return pulumi.get(self, "ms_license")
    ...
    @property
    @pulumi.getter(name="preferredShapeType")
    def preferred_shape_type(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Preferred VM shape type that you provide.
        """
        return pulumi.get(self, "preferred_shape_type")
    ...
    @property
    @pulumi.getter(name="timeAssessed")
    def time_assessed(self) -> pulumi.Output[builtins.str]:
        """
        The time when the assessment was done. An RFC3339 formatted datetime string.
        """
        return pulumi.get(self, "time_assessed")
