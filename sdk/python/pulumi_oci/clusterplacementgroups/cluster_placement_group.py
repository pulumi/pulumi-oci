...
class ClusterPlacementGroupArgs:
    def __init__(__self__, *,
                 ...
                 cluster_placement_group_type: pulumi.Input[_builtins.str],
                 compartment_id: pulumi.Input[_builtins.str],
                 description: pulumi.Input[_builtins.str],
                 capabilities: pulumi.Input[Optional['ClusterPlacementGroupCapabilitiesArgs']] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 opc_dry_run: pulumi.Input[Optional[_builtins.bool]] = None,
                 placement_instruction: pulumi.Input[Optional['ClusterPlacementGroupPlacementInstructionArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] description: (Updatable) A description of the cluster placement group.
        ...
        :param pulumi.Input[_builtins.str] name: The friendly name of the cluster placement group.
        :param pulumi.Input[_builtins.bool] opc_dry_run: When set to `true`, the request performs validation on the submitted data without modifying configuration item details.
        ...
        :param pulumi.Input[_builtins.str] state: (Updatable) The target state for the Cluster Placement Group. Could be set to `ACTIVE` or `INACTIVE`.
    ...
    def cluster_placement_group_type(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def cluster_placement_group_type(self, value: pulumi.Input[_builtins.str]):
    ...
    @_builtins.property
    @pulumi.getter
    def capabilities(self) -> pulumi.Input[Optional['ClusterPlacementGroupCapabilitiesArgs']]:
        """
    ...
    @capabilities.setter
    def capabilities(self, value: pulumi.Input[Optional['ClusterPlacementGroupCapabilitiesArgs']]):
    ...
    def placement_instruction(self) -> pulumi.Input[Optional['ClusterPlacementGroupPlacementInstructionArgs']]:
        """
    ...
    def placement_instruction(self, value: pulumi.Input[Optional['ClusterPlacementGroupPlacementInstructionArgs']]):
...
class _ClusterPlacementGroupState:
    def __init__(__self__, *,
                 ...
                 capabilities: pulumi.Input[Optional['ClusterPlacementGroupCapabilitiesArgs']] = None,
                 cluster_placement_group_type: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] description: (Updatable) A description of the cluster placement group.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type, or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[_builtins.str] lifecycle_details: A message describing the current state in more detail. For example, lifecycle details for a resource in a Failed state might include information to act on.
        :param pulumi.Input[_builtins.str] name: The friendly name of the cluster placement group.
        :param pulumi.Input[_builtins.bool] opc_dry_run: When set to `true`, the request performs validation on the submitted data without modifying configuration item details.
        :param pulumi.Input['ClusterPlacementGroupPlacementInstructionArgs'] placement_instruction: Details that inform cluster placement group provisioning.
        :param pulumi.Input[_builtins.str] state: (Updatable) The target state for the Cluster Placement Group. Could be set to `ACTIVE` or `INACTIVE`.
        ...
        :param pulumi.Input[_builtins.str] time_created: The time the cluster placement group was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.
        :param pulumi.Input[_builtins.str] time_updated: The time the cluster placement group was updated, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="clusterPlacementGroupType")
    def cluster_placement_group_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ClusterPlacementGroup Identifier.
        """
        return pulumi.get(self, "cluster_placement_group_type")
    ...
    @cluster_placement_group_type.setter
    def cluster_placement_group_type(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "cluster_placement_group_type", value)
...
class ClusterPlacementGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 availability_domain: pulumi.Input[Optional[_builtins.str]] = None,
                 capabilities: pulumi.Input[Optional[Union['ClusterPlacementGroupCapabilitiesArgs', 'ClusterPlacementGroupCapabilitiesArgsDict', 'outputs.ClusterPlacementGroupCapabilities']]] = None,
                 cluster_placement_group_type: pulumi.Input[Optional[_builtins.str]] = None,
                 compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 opc_dry_run: pulumi.Input[Optional[_builtins.bool]] = None,
                 placement_instruction: pulumi.Input[Optional[Union['ClusterPlacementGroupPlacementInstructionArgs', 'ClusterPlacementGroupPlacementInstructionArgsDict', 'outputs.ClusterPlacementGroupPlacementInstruction']]] = None,
                 state: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] availability_domain: The availability domain where you want to create the cluster placement group.
        :param pulumi.Input[Union['ClusterPlacementGroupCapabilitiesArgs', 'ClusterPlacementGroupCapabilitiesArgsDict', 'outputs.ClusterPlacementGroupCapabilities']] capabilities: A list of resources that you can create in a cluster placement group.
        :param pulumi.Input[_builtins.str] cluster_placement_group_type: ClusterPlacementGroup Identifier.
        :param pulumi.Input[_builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment where you want to create the cluster placement group.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[_builtins.str] description: (Updatable) A description of the cluster placement group.
        ...
        :param pulumi.Input[_builtins.str] name: The friendly name of the cluster placement group.
        :param pulumi.Input[_builtins.bool] opc_dry_run: When set to `true`, the request performs validation on the submitted data without modifying configuration item details.
        :param pulumi.Input[Union['ClusterPlacementGroupPlacementInstructionArgs', 'ClusterPlacementGroupPlacementInstructionArgsDict', 'outputs.ClusterPlacementGroupPlacementInstruction']] placement_instruction: Details that inform cluster placement group provisioning.
        :param pulumi.Input[_builtins.str] state: (Updatable) The target state for the Cluster Placement Group. Could be set to `ACTIVE` or `INACTIVE`.
    ...
    def get(resource_name: str,
            ...
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None) -> 'ClusterPlacementGroup':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="clusterPlacementGroupType")
    def cluster_placement_group_type(self) -> pulumi.Output[_builtins.str]:
        """
        ClusterPlacementGroup Identifier.
        """
        return pulumi.get(self, "cluster_placement_group_type")
    ...
    @_builtins.property
    @pulumi.getter(name="opcDryRun")
    def opc_dry_run(self) -> pulumi.Output[_builtins.bool]:
        """
        When set to `true`, the request performs validation on the submitted data without modifying configuration item details.
        """
        return pulumi.get(self, "opc_dry_run")
