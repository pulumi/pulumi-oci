...
def get_cluster_placement_group(cluster_placement_group_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cluster_placement_group_id: A unique cluster placement group identifier.
    """
    __args__ = dict()
...
def get_cluster_placement_group_output(cluster_placement_group_id: Optional[pulumi.Input[_builtins.str]] = None,
