...
class ClusterPlacementGroupCapabilitiesItem(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The type of resource.
        :param builtins.str service: The service that the resource is part of.
        """
...
class ClusterPlacementGroupPlacementInstruction(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str type: The type of placement instruction.
        :param builtins.str value: The value of the token designated for placement of the cluster placement group upon creation.
        """
...
class GetClusterPlacementGroupCapabilityItemResult(dict):
    def __init__(__self__, *,
                 ...
                 service: builtins.str):
        """
        :param builtins.str name: The user-friendly name of the cluster placement group. The display name for a cluster placement must be unique and you cannot change it. Avoid entering confidential information.
        :param builtins.str service: The service that the resource is part of.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "service", service)
...
class GetClusterPlacementGroupsClusterPlacementGroupCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 cluster_placement_group_type: builtins.str,
        ...
        """
        :param builtins.str availability_domain: The availability domain of the cluster placement group.
        ...
        :param builtins.str cluster_placement_group_type: The type of cluster placement group.
        ...
        :param builtins.str description: A description of the cluster placement group.
        ...
        :param builtins.str lifecycle_details: A message describing the current state in more detail. For example, lifecycle details for a resource in a Failed state might include information to act on.
        ...
        :param builtins.str time_created: The time the cluster placement group was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.
        :param builtins.str time_updated: The time the cluster placement group was updated, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.
        """
