...
if not MYPY:
    class AtCustomerCccInfrastructureInfrastructureInventoryArgsDict(TypedDict):
        capacity_storage_tray_count: NotRequired[pulumi.Input[builtins.int]]
        """
        The number of storage trays in the Compute Cloud@Customer infrastructure rack that are designated for capacity storage.
        """
        compute_node_count: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        management_node_count: NotRequired[pulumi.Input[builtins.int]]
        """
        The number of management nodes that are available and in active use on the Compute Cloud@Customer infrastructure rack.
        """
        performance_storage_tray_count: NotRequired[pulumi.Input[builtins.int]]
        """
...
class AtCustomerCccInfrastructureInfrastructureInventoryArgs:
    def __init__(__self__, *,
                 capacity_storage_tray_count: Optional[pulumi.Input[builtins.int]] = None,
                 compute_node_count: Optional[pulumi.Input[builtins.int]] = None,
                 management_node_count: Optional[pulumi.Input[builtins.int]] = None,
                 performance_storage_tray_count: Optional[pulumi.Input[builtins.int]] = None,
                 serial_number: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] capacity_storage_tray_count: The number of storage trays in the Compute Cloud@Customer infrastructure rack that are designated for capacity storage.
        :param pulumi.Input[builtins.int] compute_node_count: The number of compute nodes that are available and usable on the Compute Cloud@Customer infrastructure rack. There is no distinction of compute node type in this information.
        :param pulumi.Input[builtins.int] management_node_count: The number of management nodes that are available and in active use on the Compute Cloud@Customer infrastructure rack.
        :param pulumi.Input[builtins.int] performance_storage_tray_count: The number of storage trays in the Compute Cloud@Customer infrastructure rack that are designated for performance storage.
        :param pulumi.Input[builtins.str] serial_number: The serial number of the Compute Cloud@Customer infrastructure rack.
        """
    ...
    def capacity_storage_tray_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of storage trays in the Compute Cloud@Customer infrastructure rack that are designated for capacity storage.
        """
    ...
    def capacity_storage_tray_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "capacity_storage_tray_count", value)

    @property
    @pulumi.getter(name="computeNodeCount")
    def compute_node_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of compute nodes that are available and usable on the Compute Cloud@Customer infrastructure rack. There is no distinction of compute node type in this information.
        """
    ...
    def compute_node_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "compute_node_count", value)

    @property
    @pulumi.getter(name="managementNodeCount")
    def management_node_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of management nodes that are available and in active use on the Compute Cloud@Customer infrastructure rack.
        """
    ...
    def management_node_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "management_node_count", value)

    @property
    @pulumi.getter(name="performanceStorageTrayCount")
    def performance_storage_tray_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of storage trays in the Compute Cloud@Customer infrastructure rack that are designated for performance storage.
        """
    ...
    def performance_storage_tray_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class AtCustomerCccInfrastructureInfrastructureNetworkConfigurationArgsDict(TypedDict):
        ...
        """
        mgmt_vip_hostname: NotRequired[pulumi.Input[builtins.str]]
        """
        The hostname corresponding to the virtual IP (VIP) address of the management nodes.
        """
        mgmt_vip_ip: NotRequired[pulumi.Input[builtins.str]]
        """
        The IP address used as the virtual IP (VIP) address of the management nodes.
        """
        spine_ips: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Addresses of the network spine switches.
        """
        spine_vip: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AtCustomerCccInfrastructureInfrastructureNetworkConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 mgmt_vip_hostname: Optional[pulumi.Input[builtins.str]] = None,
                 mgmt_vip_ip: Optional[pulumi.Input[builtins.str]] = None,
                 spine_ips: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 spine_vip: Optional[pulumi.Input[builtins.str]] = None,
                 uplink_domain: Optional[pulumi.Input[builtins.str]] = None,
                 uplink_gateway_ip: Optional[pulumi.Input[builtins.str]] = None,
                 uplink_netmask: Optional[pulumi.Input[builtins.str]] = None,
                 uplink_port_count: Optional[pulumi.Input[builtins.int]] = None,
                 uplink_port_forward_error_correction: Optional[pulumi.Input[builtins.str]] = None,
                 uplink_port_speed_in_gbps: Optional[pulumi.Input[builtins.int]] = None,
                 uplink_vlan_mtu: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_ips: The domain name system (DNS) addresses that the Compute Cloud@Customer infrastructure uses for the data center network.
        ...
        :param pulumi.Input[builtins.str] mgmt_vip_hostname: The hostname corresponding to the virtual IP (VIP) address of the management nodes.
        :param pulumi.Input[builtins.str] mgmt_vip_ip: The IP address used as the virtual IP (VIP) address of the management nodes.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] spine_ips: Addresses of the network spine switches.
        :param pulumi.Input[builtins.str] spine_vip: The spine switch public virtual IP (VIP). Traffic routed to the Compute Cloud@Customer infrastructure and  and virtual cloud networks (VCNs) should have this address as next hop.
        :param pulumi.Input[builtins.str] uplink_domain: Domain name to be used as the base domain for the internal network and by  public facing services.
        :param pulumi.Input[builtins.str] uplink_gateway_ip: Uplink gateway in the datacenter network that the Compute Cloud@Customer connects to.
        :param pulumi.Input[builtins.str] uplink_netmask: Netmask of the subnet that the Compute Cloud@Customer infrastructure is connected to.
        :param pulumi.Input[builtins.int] uplink_port_count: Number of uplink ports per spine switch. Connectivity is identical on both spine switches. For example, if input is two 100 gigabyte ports; then port-1 and port-2 on both spines will be configured.
        :param pulumi.Input[builtins.str] uplink_port_forward_error_correction: The port forward error correction (FEC) setting for the uplink port on the Compute Cloud@Customer infrastructure.
        :param pulumi.Input[builtins.int] uplink_port_speed_in_gbps: Uplink port speed defined in gigabytes per second. All uplink ports must have identical speed.
        :param pulumi.Input[builtins.int] uplink_vlan_mtu: The virtual local area network (VLAN) maximum transmission unit (MTU) size for the uplink ports.
        """
    ...
    def mgmt_vip_hostname(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The hostname corresponding to the virtual IP (VIP) address of the management nodes.
        """
    ...
    def mgmt_vip_hostname(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mgmt_vip_hostname", value)

    @property
    @pulumi.getter(name="mgmtVipIp")
    def mgmt_vip_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IP address used as the virtual IP (VIP) address of the management nodes.
        """
    ...
    @mgmt_vip_ip.setter
    def mgmt_vip_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mgmt_vip_ip", value)

    @property
    @pulumi.getter(name="spineIps")
    def spine_ips(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Addresses of the network spine switches.
        """
    ...
    @spine_ips.setter
    def spine_ips(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "spine_ips", value)

    @property
    @pulumi.getter(name="spineVip")
    def spine_vip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The spine switch public virtual IP (VIP). Traffic routed to the Compute Cloud@Customer infrastructure and  and virtual cloud networks (VCNs) should have this address as next hop.
        """
    ...
    @spine_vip.setter
    def spine_vip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "spine_vip", value)

    @property
    @pulumi.getter(name="uplinkDomain")
    def uplink_domain(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Domain name to be used as the base domain for the internal network and by  public facing services.
        """
    ...
    def uplink_domain(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "uplink_domain", value)

    @property
    @pulumi.getter(name="uplinkGatewayIp")
    def uplink_gateway_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Uplink gateway in the datacenter network that the Compute Cloud@Customer connects to.
        """
    ...
    def uplink_gateway_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "uplink_gateway_ip", value)

    @property
    @pulumi.getter(name="uplinkNetmask")
    def uplink_netmask(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Netmask of the subnet that the Compute Cloud@Customer infrastructure is connected to.
        """
    ...
    def uplink_netmask(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "uplink_netmask", value)

    @property
    @pulumi.getter(name="uplinkPortCount")
    def uplink_port_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Number of uplink ports per spine switch. Connectivity is identical on both spine switches. For example, if input is two 100 gigabyte ports; then port-1 and port-2 on both spines will be configured.
        """
    ...
    def uplink_port_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "uplink_port_count", value)

    @property
    @pulumi.getter(name="uplinkPortForwardErrorCorrection")
    def uplink_port_forward_error_correction(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The port forward error correction (FEC) setting for the uplink port on the Compute Cloud@Customer infrastructure.
        """
    ...
    def uplink_port_forward_error_correction(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "uplink_port_forward_error_correction", value)

    @property
    @pulumi.getter(name="uplinkPortSpeedInGbps")
    def uplink_port_speed_in_gbps(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Uplink port speed defined in gigabytes per second. All uplink ports must have identical speed.
        """
    ...
    def uplink_port_speed_in_gbps(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "uplink_port_speed_in_gbps", value)

    @property
    @pulumi.getter(name="uplinkVlanMtu")
    def uplink_vlan_mtu(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The virtual local area network (VLAN) maximum transmission unit (MTU) size for the uplink ports.
        """
    ...
    def uplink_vlan_mtu(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class AtCustomerCccInfrastructureInfrastructureNetworkConfigurationInfrastructureRoutingDynamicArgsDict(TypedDict):
        bgp_topology: NotRequired[pulumi.Input[builtins.str]]
        """
        The topology in use for the Border Gateway Protocol (BGP) configuration.
        """
        oracle_asn: NotRequired[pulumi.Input[builtins.int]]
        """
...
class AtCustomerCccInfrastructureInfrastructureNetworkConfigurationInfrastructureRoutingDynamicArgs:
    def __init__(__self__, *,
                 bgp_topology: Optional[pulumi.Input[builtins.str]] = None,
                 oracle_asn: Optional[pulumi.Input[builtins.int]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] bgp_topology: The topology in use for the Border Gateway Protocol (BGP) configuration.
        :param pulumi.Input[builtins.int] oracle_asn: The Oracle Autonomous System Number (ASN) to control routing and exchange information within the dynamic routing configuration.
    ...
    def bgp_topology(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The topology in use for the Border Gateway Protocol (BGP) configuration.
        """
    ...
    @bgp_topology.setter
    def bgp_topology(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bgp_topology", value)

    @property
    @pulumi.getter(name="oracleAsn")
    def oracle_asn(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The Oracle Autonomous System Number (ASN) to control routing and exchange information within the dynamic routing configuration.
        """
    ...
    @oracle_asn.setter
    def oracle_asn(self, value: Optional[pulumi.Input[builtins.int]]):
...
class AtCustomerCccInfrastructureInfrastructureNetworkConfigurationInfrastructureRoutingDynamicPeerInformationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] asn: The Autonomous System Number (ASN) of the peer network.
        :param pulumi.Input[builtins.str] ip: Address of the management node.
        """
        if asn is not None:
...
class AtCustomerCccInfrastructureInfrastructureNetworkConfigurationInfrastructureRoutingStaticArgs:
    def __init__(__self__, *,
                 uplink_hsrp_group: Optional[pulumi.Input[builtins.int]] = None,
                 uplink_vlan: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] uplink_hsrp_group: The uplink Hot Standby Router Protocol (HSRP) group value for the switch in the Compute Cloud@Customer infrastructure.
        :param pulumi.Input[builtins.int] uplink_vlan: The virtual local area network (VLAN) identifier used to connect to the uplink (only access mode is supported).
        """
    ...
    def uplink_hsrp_group(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The uplink Hot Standby Router Protocol (HSRP) group value for the switch in the Compute Cloud@Customer infrastructure.
        """
    ...
    def uplink_hsrp_group(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "uplink_hsrp_group", value)

    @property
    @pulumi.getter(name="uplinkVlan")
    def uplink_vlan(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The virtual local area network (VLAN) identifier used to connect to the uplink (only access mode is supported).
        """
    ...
    @uplink_vlan.setter
    def uplink_vlan(self, value: Optional[pulumi.Input[builtins.int]]):
...
class AtCustomerCccInfrastructureInfrastructureNetworkConfigurationManagementNodeArgs:
    def __init__(__self__, *,
                 ...
                 ip: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] hostname: Hostname for interface to the management node.
        :param pulumi.Input[builtins.str] ip: Address of the management node.
        """
...
if not MYPY:
    class AtCustomerCccInfrastructureUpgradeInformationArgsDict(TypedDict):
        current_version: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        scheduled_upgrade_duration: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        time_of_scheduled_upgrade: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AtCustomerCccInfrastructureUpgradeInformationArgs:
    def __init__(__self__, *,
                 ...
                 scheduled_upgrade_duration: Optional[pulumi.Input[builtins.str]] = None,
                 time_of_scheduled_upgrade: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] current_version: The current version of software installed on the Compute Cloud@Customer infrastructure.
        :param pulumi.Input[builtins.bool] is_active: Indication that the Compute Cloud@Customer infrastructure is in the process of an upgrade or an upgrade activity (such as preloading upgrade images).
        :param pulumi.Input[builtins.str] scheduled_upgrade_duration: Expected duration of Compute Cloud@Customer infrastructure scheduled upgrade. The actual upgrade time might be longer or shorter than this duration depending on rack activity, this is only an estimate.
        :param pulumi.Input[builtins.str] time_of_scheduled_upgrade: Compute Cloud@Customer infrastructure next upgrade time. The rack might have performance impacts during this time.
        """
    ...
    def scheduled_upgrade_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Expected duration of Compute Cloud@Customer infrastructure scheduled upgrade. The actual upgrade time might be longer or shorter than this duration depending on rack activity, this is only an estimate.
        """
    ...
    def scheduled_upgrade_duration(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "scheduled_upgrade_duration", value)

    @property
    @pulumi.getter(name="timeOfScheduledUpgrade")
    def time_of_scheduled_upgrade(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Compute Cloud@Customer infrastructure next upgrade time. The rack might have performance impacts during this time.
        """
    ...
    def time_of_scheduled_upgrade(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class AtCustomerCccUpgradeScheduleEventArgsDict(TypedDict):
        ...
        """
        schedule_event_recurrences: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AtCustomerCccUpgradeScheduleEventArgs:
    def __init__(__self__, *,
                 ...
                 schedule_event_recurrences: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] description: (Updatable) A description of the Compute Cloud@Customer upgrade schedule time block.
        :param pulumi.Input[builtins.str] schedule_event_duration: (Updatable) The duration of this block of time. The duration must be specified and be of the ISO-8601 format for durations.
        :param pulumi.Input[builtins.str] time_start: (Updatable) The date and time when the Compute Cloud@Customer upgrade schedule event starts, inclusive. An RFC3339 formatted UTC datetime string. For an event with recurrences, this is the date that a recurrence can start being applied.
        :param pulumi.Input[builtins.str] name: Generated name associated with the event.
        :param pulumi.Input[builtins.str] schedule_event_recurrences: (Updatable) Frequency of recurrence of schedule block. When this field is not included, the event is assumed to be a one time occurrence. The frequency field is strictly parsed and must conform to RFC-5545 formatting for recurrences.
        """
    ...
    def schedule_event_duration(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The duration of this block of time. The duration must be specified and be of the ISO-8601 format for durations.
        """
    ...
    def schedule_event_duration(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "schedule_event_duration", value)

    @property
    @pulumi.getter(name="timeStart")
    def time_start(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The date and time when the Compute Cloud@Customer upgrade schedule event starts, inclusive. An RFC3339 formatted UTC datetime string. For an event with recurrences, this is the date that a recurrence can start being applied.
        """
    ...
    @time_start.setter
    def time_start(self, value: pulumi.Input[builtins.str]):
    ...
    def schedule_event_recurrences(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Frequency of recurrence of schedule block. When this field is not included, the event is assumed to be a one time occurrence. The frequency field is strictly parsed and must conform to RFC-5545 formatting for recurrences.
        """
    ...
    def schedule_event_recurrences(self, value: Optional[pulumi.Input[builtins.str]]):
