...
class GetAtCustomerCccInfrastructureResult:
    ...
    def ccc_infrastructure_id(self) -> builtins.str:
...
def get_at_customer_ccc_infrastructure(ccc_infrastructure_id: Optional[builtins.str] = None,
...
def get_at_customer_ccc_infrastructure_output(ccc_infrastructure_id: Optional[pulumi.Input[builtins.str]] = None,
