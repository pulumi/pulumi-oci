...
def get_at_customer_ccc_upgrade_schedule(ccc_upgrade_schedule_id: Optional[builtins.str] = None,
    ...
    :param builtins.str ccc_upgrade_schedule_id: Compute Cloud@Customer upgrade schedule [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    """
    __args__ = dict()
...
def get_at_customer_ccc_upgrade_schedule_output(ccc_upgrade_schedule_id: Optional[pulumi.Input[builtins.str]] = None,
