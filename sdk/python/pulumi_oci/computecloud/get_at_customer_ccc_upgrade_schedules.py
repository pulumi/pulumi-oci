...
class GetAtCustomerCccUpgradeSchedulesResult:
    ...
    def ccc_upgrade_schedule_id(self) -> Optional[builtins.str]:
...
def get_at_customer_ccc_upgrade_schedules(access_level: Optional[builtins.str] = None,
                                          ccc_upgrade_schedule_id: Optional[builtins.str] = None,
...
def get_at_customer_ccc_upgrade_schedules_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                 ccc_upgrade_schedule_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
