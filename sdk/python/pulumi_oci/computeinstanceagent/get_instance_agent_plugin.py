...
class GetInstanceAgentPluginResult:
    ...
    def instanceagent_id(self) -> builtins.str:
    ...
    def time_last_updated_utc(self) -> builtins.str:
        """
...
def get_instance_agent_plugin(compartment_id: Optional[builtins.str] = None,
                              instanceagent_id: Optional[builtins.str] = None,
    ...
    :param builtins.str instanceagent_id: The OCID of the instance.
    :param builtins.str plugin_name: The name of the plugin.
    """
    __args__ = dict()
...
def get_instance_agent_plugin_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                     instanceagent_id: Optional[pulumi.Input[builtins.str]] = None,
