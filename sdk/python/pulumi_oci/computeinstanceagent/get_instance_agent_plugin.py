...
class GetInstanceAgentPluginResult:
    ...
    def instanceagent_id(self) -> _builtins.str:
...
def get_instance_agent_plugin(compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str plugin_name: The name of the plugin.
    """
    __args__ = dict()
...
def get_instance_agent_plugin_output(compartment_id: Optional[pulumi.Input[_builtins.str]] = None,
                                     instanceagent_id: Optional[pulumi.Input[_builtins.str]] = None,
