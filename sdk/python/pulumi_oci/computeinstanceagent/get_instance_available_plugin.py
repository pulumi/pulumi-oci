...
def get_instance_available_plugin(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The plugin name
    :param builtins.str os_name: The OS for which the plugin is supported. Examples of OperatingSystemQueryParam:OperatingSystemVersionQueryParam are as follows: 'CentOS' '6.10' , 'CentOS Linux' '7', 'CentOS Linux' '8', 'Oracle Linux Server' '6.10', 'Oracle Linux Server' '8.0', 'Red Hat Enterprise Linux Server' '7.8', 'Windows' '10', 'Windows' '2008ServerR2', 'Windows' '2012ServerR2', 'Windows' '7', 'Windows' '8.1'
    :param builtins.str os_version: The OS version for which the plugin is supported.
    """
    __args__ = dict()
...
def get_instance_available_plugin_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
