...
class AddonArgs:
    def __init__(__self__, *,
                 ...
                 remove_addon_resources_on_delete: pulumi.Input[builtins.bool],
                 configurations: Optional[pulumi.Input[Sequence[pulumi.Input['AddonConfigurationArgs']]]] = None,
                 override_existing: Optional[pulumi.Input[builtins.bool]] = None,
                 version: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Addon resource.
        :param pulumi.Input[builtins.str] addon_name: The name of the addon.
        :param pulumi.Input[builtins.str] cluster_id: The OCID of the cluster.
        :param pulumi.Input[builtins.bool] remove_addon_resources_on_delete: Whether to remove addon resource in deletion.
        :param pulumi.Input[Sequence[pulumi.Input['AddonConfigurationArgs']]] configurations: (Updatable) Addon configuration details
        :param pulumi.Input[builtins.bool] override_existing: Whether or not to override an existing addon installation. Defaults to false. If set to true, any existing addon installation would be overridden as per new installation details.
        :param pulumi.Input[builtins.str] version: (Updatable) The version of addon to be installed.
    ...
    def remove_addon_resources_on_delete(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def remove_addon_resources_on_delete(self, value: pulumi.Input[builtins.bool]):
    ...
    def override_existing(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def override_existing(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _AddonState:
    def __init__(__self__, *,
                 ...
                 configurations: Optional[pulumi.Input[Sequence[pulumi.Input['AddonConfigurationArgs']]]] = None,
                 current_installed_version: Optional[pulumi.Input[builtins.str]] = None,
                 override_existing: Optional[pulumi.Input[builtins.bool]] = None,
                 remove_addon_resources_on_delete: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] cluster_id: The OCID of the cluster.
        :param pulumi.Input[Sequence[pulumi.Input['AddonConfigurationArgs']]] configurations: (Updatable) Addon configuration details
        :param pulumi.Input[builtins.str] current_installed_version: current installed version of the addon
        :param pulumi.Input[builtins.bool] override_existing: Whether or not to override an existing addon installation. Defaults to false. If set to true, any existing addon installation would be overridden as per new installation details.
        :param pulumi.Input[builtins.bool] remove_addon_resources_on_delete: Whether to remove addon resource in deletion.
        :param pulumi.Input[builtins.str] state: The state of the addon.
    ...
    def current_installed_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def current_installed_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="removeAddonResourcesOnDelete")
    def remove_addon_resources_on_delete(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether to remove addon resource in deletion.
        """
        return pulumi.get(self, "remove_addon_resources_on_delete")
    ...
    @remove_addon_resources_on_delete.setter
    def remove_addon_resources_on_delete(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "remove_addon_resources_on_delete", value)
...
class Addon(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="currentInstalledVersion")
    def current_installed_version(self) -> pulumi.Output[builtins.str]:
        """
        current installed version of the addon
        """
        return pulumi.get(self, "current_installed_version")
    ...
    @property
    @pulumi.getter(name="overrideExisting")
    def override_existing(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Whether or not to override an existing addon installation. Defaults to false. If set to true, any existing addon installation would be overridden as per new installation details.
        """
        return pulumi.get(self, "override_existing")
    ...
    @property
    @pulumi.getter(name="removeAddonResourcesOnDelete")
    def remove_addon_resources_on_delete(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to remove addon resource in deletion.
        """
        return pulumi.get(self, "remove_addon_resources_on_delete")
