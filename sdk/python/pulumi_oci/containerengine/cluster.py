...
class ClusterArgs:
    def __init__(__self__, *,
                 ...
                 kubernetes_version: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment in which to create the cluster.
        :param pulumi.Input[builtins.str] kubernetes_version: (Updatable) The version of Kubernetes to install into the cluster masters.
        :param pulumi.Input[builtins.str] vcn_id: The OCID of the virtual cloud network (VCN) in which to create the cluster.
        ...
        :param pulumi.Input[builtins.str] kms_key_id: The OCID of the KMS key to be used as the master encryption key for Kubernetes secret encryption. When used, `kubernetesVersion` must be at least `v1.13.0`.
    ...
    def kubernetes_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def kubernetes_version(self, value: pulumi.Input[builtins.str]):
...
class _ClusterState:
    def __init__(__self__, *,
                 available_kubernetes_upgrades: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 cluster_pod_network_options: Optional[pulumi.Input[Sequence[pulumi.Input['ClusterClusterPodNetworkOptionArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] available_kubernetes_upgrades: Available Kubernetes versions to which the clusters masters may be upgraded.
        :param pulumi.Input[Sequence[pulumi.Input['ClusterClusterPodNetworkOptionArgs']]] cluster_pod_network_options: Available CNIs and network options for existing and new node pools of the cluster
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment in which to create the cluster.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input['ClusterEndpointConfigArgs'] endpoint_config: The network configuration for access to the Cluster control plane.
        ...
        :param pulumi.Input[builtins.str] kms_key_id: The OCID of the KMS key to be used as the master encryption key for Kubernetes secret encryption. When used, `kubernetesVersion` must be at least `v1.13.0`.
        :param pulumi.Input[builtins.str] kubernetes_version: (Updatable) The version of Kubernetes to install into the cluster masters.
        :param pulumi.Input[builtins.str] lifecycle_details: Details about the state of the cluster masters.
    ...
    def available_kubernetes_upgrades(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def available_kubernetes_upgrades(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def open_id_connect_discovery_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
...
class Cluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            vcn_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Cluster':
        """
    ...
    @property
    @pulumi.getter(name="availableKubernetesUpgrades")
    def available_kubernetes_upgrades(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Available Kubernetes versions to which the clusters masters may be upgraded.
        """
        return pulumi.get(self, "available_kubernetes_upgrades")
    ...
    @property
    @pulumi.getter(name="openIdConnectDiscoveryEndpoint")
    def open_id_connect_discovery_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        The cluster-specific OpenID Connect Discovery endpoint
        """
        return pulumi.get(self, "open_id_connect_discovery_endpoint")
