...
class ClusterStartCredentialRotationManagementArgs:
    def __init__(__self__, *,
                 auto_completion_delay_duration: pulumi.Input[builtins.str],
                 cluster_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a ClusterStartCredentialRotationManagement resource.
        :param pulumi.Input[builtins.str] auto_completion_delay_duration: The duration in days(in ISO 8601 notation eg. P5D) after which the old credentials should be retired. Maximum delay duration is 14 days.
    ...
    def auto_completion_delay_duration(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def auto_completion_delay_duration(self, value: pulumi.Input[builtins.str]):
...
class _ClusterStartCredentialRotationManagementState:
    def __init__(__self__, *,
                 auto_completion_delay_duration: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="autoCompletionDelayDuration")
    def auto_completion_delay_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The duration in days(in ISO 8601 notation eg. P5D) after which the old credentials should be retired. Maximum delay duration is 14 days.
        """
        return pulumi.get(self, "auto_completion_delay_duration")
    ...
    @auto_completion_delay_duration.setter
    def auto_completion_delay_duration(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "auto_completion_delay_duration", value)
...
class ClusterStartCredentialRotationManagement(pulumi.CustomResource):
    ...
    pulumi_type = "oci:ContainerEngine/clusterStartCredentialRotationManagement:ClusterStartCredentialRotationManagement"
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            auto_completion_delay_duration: Optional[pulumi.Input[builtins.str]] = None,
            cluster_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ClusterStartCredentialRotationManagement':
        """
    ...
    @property
    @pulumi.getter(name="autoCompletionDelayDuration")
    def auto_completion_delay_duration(self) -> pulumi.Output[builtins.str]:
        """
        The duration in days(in ISO 8601 notation eg. P5D) after which the old credentials should be retired. Maximum delay duration is 14 days.
        """
        return pulumi.get(self, "auto_completion_delay_duration")
