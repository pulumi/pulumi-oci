...
class ClusterWorkloadMappingArgs:
    def __init__(__self__, *,
                 ...
                 mapped_compartment_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] mapped_compartment_id: (Updatable) The OCID of the mapped customer compartment.
        :param pulumi.Input[builtins.str] namespace: The namespace of the workloadMapping.
    ...
    def mapped_compartment_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def mapped_compartment_id(self, value: pulumi.Input[builtins.str]):
...
class _ClusterWorkloadMappingState:
    def __init__(__self__, *,
                 ...
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 mapped_compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 mapped_tenancy_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] mapped_compartment_id: (Updatable) The OCID of the mapped customer compartment.
        :param pulumi.Input[builtins.str] mapped_tenancy_id: The OCID of the mapped customer tenancy.
        :param pulumi.Input[builtins.str] namespace: The namespace of the workloadMapping.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The state of the workloadMapping.
    ...
    @property
    @pulumi.getter(name="mappedCompartmentId")
    def mapped_compartment_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The OCID of the mapped customer compartment.
        """
        return pulumi.get(self, "mapped_compartment_id")
    ...
    @mapped_compartment_id.setter
    def mapped_compartment_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mapped_compartment_id", value)

    @property
    @pulumi.getter(name="mappedTenancyId")
    def mapped_tenancy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def mapped_tenancy_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ClusterWorkloadMapping(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            namespace: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'ClusterWorkloadMapping':
        """
    ...
    @property
    @pulumi.getter(name="mappedCompartmentId")
    def mapped_compartment_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The OCID of the mapped customer compartment.
        """
        return pulumi.get(self, "mapped_compartment_id")
    ...
    @property
    @pulumi.getter(name="mappedTenancyId")
    def mapped_tenancy_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the mapped customer tenancy.
        """
        return pulumi.get(self, "mapped_tenancy_id")
