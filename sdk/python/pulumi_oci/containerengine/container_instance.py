...
class ContainerInstanceArgs:
    def __init__(__self__, *,
                 ...
                 container_restart_policy: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 graceful_shutdown_timeout_in_seconds: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] shape: The shape of the container instance. The shape determines the resources available to the container instance.
        ...
        :param pulumi.Input[builtins.str] container_restart_policy: Container restart policy
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information. If you don't provide a name, a name is generated automatically.
        ...
        :param pulumi.Input[builtins.str] graceful_shutdown_timeout_in_seconds: The amount of time that processes in a container have to gracefully end when the container must be stopped. For example, when you delete a container instance. After the timeout is reached, the processes are sent a signal to be deleted.
    ...
    def container_restart_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def container_restart_policy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def graceful_shutdown_timeout_in_seconds(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def graceful_shutdown_timeout_in_seconds(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ContainerInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_domain: The availability domain where the container instance runs.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The compartment OCID.
        :param pulumi.Input[builtins.int] container_count: The number of containers on the container instance.
        :param pulumi.Input[builtins.str] container_restart_policy: Container restart policy
        :param pulumi.Input[Sequence[pulumi.Input['ContainerInstanceContainerArgs']]] containers: The containers to create on this container instance.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`.
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information. If you don't provide a name, a name is generated automatically.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ContainerInstanceVnicArgs']]] vnics: The networks available to containers on this container instance.
        :param pulumi.Input[builtins.int] volume_count: The number of volumes that are attached to the container instance.
        :param pulumi.Input[Sequence[pulumi.Input['ContainerInstanceVolumeArgs']]] volumes: A volume is a directory with data that is accessible across multiple containers in a container instance.
...
class ContainerInstance(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="containerRestartPolicy")
    def container_restart_policy(self) -> pulumi.Output[builtins.str]:
        """
        Container restart policy
        """
        return pulumi.get(self, "container_restart_policy")
    ...
    @property
    @pulumi.getter(name="gracefulShutdownTimeoutInSeconds")
    def graceful_shutdown_timeout_in_seconds(self) -> pulumi.Output[builtins.str]:
        """
        The amount of time that processes in a container have to gracefully end when the container must be stopped. For example, when you delete a container instance. After the timeout is reached, the processes are sent a signal to be deleted.
        """
        return pulumi.get(self, "graceful_shutdown_timeout_in_seconds")
