...
def get_addon_options(addon_name: Optional[builtins.str] = None,
    ...
    :param builtins.str kubernetes_version: The kubernetes version to fetch the addons.
    """
    __args__ = dict()
...
def get_addon_options_output(addon_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
