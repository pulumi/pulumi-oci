...
class GetClusterResult:
    ...
    def should_include_oidc_config_file(self) -> Optional[_builtins.bool]:
...
def get_cluster(cluster_id: Optional[_builtins.str] = None,
                should_include_oidc_config_file: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool should_include_oidc_config_file: Boolean value to determine if the OpenIdConnectAuth configuration file should be displayed for the provided cluster.
    """
    __args__ = dict()
