...
class GetClusterKubeConfigResult:
    ...
    @property
    @pulumi.getter
    def expiration(self) -> Optional[builtins.int]:
    ...
    def token_version(self) -> Optional[builtins.str]:
...
def get_cluster_kube_config(cluster_id: Optional[builtins.str] = None,
                            endpoint: Optional[builtins.str] = None,
                            expiration: Optional[builtins.int] = None,
                            token_version: Optional[builtins.str] = None,
    ...
    :param builtins.str endpoint: The endpoint to target. A cluster may have multiple endpoints exposed but the kubeconfig can only target one at a time.
    :param builtins.int expiration: Deprecated. This field is no longer used.
    :param builtins.str token_version: The version of the kubeconfig token. Supported value 2.0.0
    """
    __args__ = dict()
...
def get_cluster_kube_config_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
                                   endpoint: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                   expiration: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                   token_version: Optional[pulumi.Input[Optional[builtins.str]]] = None,
