...
class GetClusterOptionResult:
    ...
    def cluster_option_id(self) -> builtins.str:
...
def get_cluster_option(cluster_option_id: Optional[builtins.str] = None,
    ...
    :param builtins.str cluster_option_id: The id of the option set to retrieve. Use "all" get all options, or use a cluster ID to get options specific to the provided cluster.
...
def get_cluster_option_output(cluster_option_id: Optional[pulumi.Input[builtins.str]] = None,
