...
class GetClusterWorkloadMappingResult:
    ...
    def workload_mapping_id(self) -> builtins.str:
...
def get_cluster_workload_mapping(cluster_id: Optional[builtins.str] = None,
                                 workload_mapping_id: Optional[builtins.str] = None,
    ...
    :param builtins.str workload_mapping_id: The OCID of the workloadMapping.
    """
    __args__ = dict()
...
def get_cluster_workload_mapping_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
                                        workload_mapping_id: Optional[pulumi.Input[builtins.str]] = None,
