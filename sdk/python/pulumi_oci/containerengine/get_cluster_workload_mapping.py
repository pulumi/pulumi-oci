...
class GetClusterWorkloadMappingResult:
    ...
    def workload_mapping_id(self) -> _builtins.str:
...
def get_cluster_workload_mapping(cluster_id: Optional[_builtins.str] = None,
                                 workload_mapping_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str workload_mapping_id: The OCID of the workloadMapping.
    """
    __args__ = dict()
