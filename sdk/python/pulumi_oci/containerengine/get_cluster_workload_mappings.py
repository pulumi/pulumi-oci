...
def get_cluster_workload_mappings(cluster_id: Optional[builtins.str] = None,
...
def get_cluster_workload_mappings_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
