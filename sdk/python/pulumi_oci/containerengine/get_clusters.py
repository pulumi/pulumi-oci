...
def get_clusters(compartment_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] states: A cluster lifecycle state to filter on. Can have multiple parameters of this name.
    """
    __args__ = dict()
...
def get_clusters_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
