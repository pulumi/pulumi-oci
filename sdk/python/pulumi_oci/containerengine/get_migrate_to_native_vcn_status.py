...
class GetMigrateToNativeVcnStatusResult:
    ...
    def time_decommission_scheduled(self) -> builtins.str:
...
def get_migrate_to_native_vcn_status(cluster_id: Optional[builtins.str] = None,
...
def get_migrate_to_native_vcn_status_output(cluster_id: Optional[pulumi.Input[builtins.str]] = None,
