...
class GetNodePoolOptionResult:
    ...
    def kubernetes_versions(self) -> Sequence[builtins.str]:
        """
    ...
    def node_pool_option_id(self) -> builtins.str:
        return pulumi.get(self, "node_pool_option_id")

    @property
    @pulumi.getter
    def shapes(self) -> Sequence[builtins.str]:
        """
...
def get_node_pool_option(compartment_id: Optional[builtins.str] = None,
                         node_pool_option_id: Optional[builtins.str] = None,
    ...
    :param builtins.str node_pool_option_id: The id of the option set to retrieve. Use "all" get all options, or use a cluster ID to get options specific to the provided cluster.
    """
    __args__ = dict()
...
def get_node_pool_option_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                node_pool_option_id: Optional[pulumi.Input[builtins.str]] = None,
