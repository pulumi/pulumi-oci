...
def get_node_pools(cluster_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] states: A list of nodepool lifecycle states on which to filter on, matching any of the list items (OR logic). eg. [ACTIVE, DELETING]
    """
    __args__ = dict()
...
def get_node_pools_output(cluster_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
