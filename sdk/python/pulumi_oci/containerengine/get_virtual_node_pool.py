...
def get_virtual_node_pool(virtual_node_pool_id: Optional[str] = None,
    ...
    return AwaitableGetVirtualNodePoolResult(
        ...
        id=__ret__.id,
        initial_virtual_node_labels=__ret__.initial_virtual_node_labels,
        ...
        pod_configurations=__ret__.pod_configurations,
        size=__ret__.size,
        state=__ret__.state,
        ...
        virtual_node_pool_id=__ret__.virtual_node_pool_id,
        virtual_node_tags=__ret__.virtual_node_tags)
