...
def get_virtual_node_pool(virtual_node_pool_id: Optional[builtins.str] = None,
    ...
    :param builtins.str virtual_node_pool_id: The OCID of the virtual node pool.
    """
    __args__ = dict()
...
def get_virtual_node_pool_output(virtual_node_pool_id: Optional[pulumi.Input[builtins.str]] = None,
