...
def get_virtual_node_pools(cluster_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] states: A virtual node pool lifecycle state to filter on. Can have multiple parameters of this name.
    """
    __args__ = dict()
...
def get_virtual_node_pools_output(cluster_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
