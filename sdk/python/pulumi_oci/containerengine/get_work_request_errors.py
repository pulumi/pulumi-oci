...
def get_work_request_errors(compartment_id: Optional[builtins.str] = None,
...
def get_work_request_errors_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
