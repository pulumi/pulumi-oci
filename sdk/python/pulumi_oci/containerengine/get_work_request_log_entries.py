...
def get_work_request_log_entries(compartment_id: Optional[builtins.str] = None,
...
def get_work_request_log_entries_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
