...
class NodePoolArgs:
    def __init__(__self__, *,
                 ...
                 node_shape: pulumi.Input[builtins.str],
                 ...
                 node_image_name: Optional[pulumi.Input[builtins.str]] = None,
                 node_metadata: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 ...
                 quantity_per_subnet: Optional[pulumi.Input[builtins.int]] = None,
                 ssh_public_key: Optional[pulumi.Input[builtins.str]] = None,
                 subnet_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a NodePool resource.
        :param pulumi.Input[builtins.str] cluster_id: The OCID of the cluster to which this node pool is attached.
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment in which the node pool exists.
        :param pulumi.Input[builtins.str] node_shape: (Updatable) The name of the node shape of the nodes in the node pool.
        ...
        :param pulumi.Input[builtins.str] node_image_id: Deprecated. see `nodeSource`. The OCID of the image running on the nodes in the node pool.
        :param pulumi.Input[builtins.str] node_image_name: Deprecated. Use `nodeSourceDetails` instead. If you specify values for both, this value is ignored. The name of the image running on the nodes in the node pool. Cannot be used when `node_image_id` is specified.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] node_metadata: (Updatable) A list of key/value pairs to add to each underlying Oracle Cloud Infrastructure instance in the node pool on launch.
        ...
        :param pulumi.Input[builtins.int] quantity_per_subnet: (Updatable) Optional, default to 1. The number of nodes to create in each subnet specified in subnetIds property. When used, subnetIds is required. This property is deprecated, use nodeConfigDetails instead.
        :param pulumi.Input[builtins.str] ssh_public_key: (Updatable) The SSH public key on each node in the node pool on launch.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subnet_ids: (Updatable) The OCIDs of the subnets in which to place nodes for this node pool. When used, quantityPerSubnet can be provided. This property is deprecated, use nodeConfigDetails. Exactly one of the subnetIds or nodeConfigDetails properties must be specified. 
    ...
    def node_shape(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @node_shape.setter
    def node_shape(self, value: pulumi.Input[builtins.str]):
    ...
    def node_image_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def node_image_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "node_image_name", value)

    @property
    @pulumi.getter(name="nodeMetadata")
    def node_metadata(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def node_metadata(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def quantity_per_subnet(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def quantity_per_subnet(self, value: Optional[pulumi.Input[builtins.int]]):
...
class NodePool(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ssh_public_key: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            subnet_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'NodePool':
        """
    ...
    @pulumi.getter(name="nodeImageId")
    @_utilities.deprecated("""The 'node_image_id' field has been deprecated. Please use 'node_source_details' instead. If both fields are specified, then 'node_source_details' will be used.""")
    def node_image_id(self) -> pulumi.Output[builtins.str]:
        """
        Deprecated. see `nodeSource`. The OCID of the image running on the nodes in the node pool.
        """
        return pulumi.get(self, "node_image_id")
    ...
    @pulumi.getter(name="nodeImageName")
    @_utilities.deprecated("""The 'node_image_name' field has been deprecated. Please use 'node_source_details' instead. If both fields are specified, then 'node_source_details' will be used.""")
    def node_image_name(self) -> pulumi.Output[builtins.str]:
        """
        Deprecated. Use `nodeSourceDetails` instead. If you specify values for both, this value is ignored. The name of the image running on the nodes in the node pool. Cannot be used when `node_image_id` is specified.
        """
        return pulumi.get(self, "node_image_name")
    ...
    @property
    @pulumi.getter(name="nodeMetadata")
    def node_metadata(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        (Updatable) A list of key/value pairs to add to each underlying Oracle Cloud Infrastructure instance in the node pool on launch.
        """
        return pulumi.get(self, "node_metadata")
    ...
    @property
    @pulumi.getter(name="quantityPerSubnet")
    def quantity_per_subnet(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) Optional, default to 1. The number of nodes to create in each subnet specified in subnetIds property. When used, subnetIds is required. This property is deprecated, use nodeConfigDetails instead.
        """
        return pulumi.get(self, "quantity_per_subnet")
    ...
    @property
    @pulumi.getter(name="sshPublicKey")
    def ssh_public_key(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The SSH public key on each node in the node pool on launch.
        """
        return pulumi.get(self, "ssh_public_key")
