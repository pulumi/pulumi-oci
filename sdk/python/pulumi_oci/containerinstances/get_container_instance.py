...
def get_container_instance(container_instance_id: Optional[builtins.str] = None,
...
def get_container_instance_output(container_instance_id: Optional[pulumi.Input[builtins.str]] = None,
