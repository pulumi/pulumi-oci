...
def get_container_instance_shape(availability_domain: Optional[builtins.str] = None,
...
def get_container_instance_shape_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
