...
def get_container_instance_shapes(availability_domain: Optional[builtins.str] = None,
...
def get_container_instance_shapes_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
