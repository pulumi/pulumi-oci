...
def get_container_instances(availability_domain: Optional[builtins.str] = None,
...
def get_container_instances_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
