...
class GetContainerInstanceContainerResult(dict):
    def __init__(__self__, *,
                 ...
                 is_resource_principal_disabled: builtins.bool,
        ...
        """
        :param builtins.str availability_domain: The availability domain to place the container instance.
        :param builtins.str compartment_id: The OCID of the compartment.
        :param builtins.str container_id: The OCID of the container.
        :param builtins.str container_instance_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the container instance.
        ...
        :param builtins.str fault_domain: The fault domain to place the container instance.
        ...
        :param builtins.str state: The current state of the container instance.
    ...
    def is_resource_principal_disabled(self) -> builtins.bool:
...
class GetContainerInstanceContainerHealthCheckResult(dict):
    def __init__(__self__, *,
                 ...
                 initial_delay_in_seconds: builtins.int,
    ...
    def initial_delay_in_seconds(self) -> builtins.int:
    ...
    def success_threshold(self) -> builtins.int:
...
class GetContainerInstanceContainerResourceConfigResult(dict):
    def __init__(__self__, *,
                 memory_limit_in_gbs: builtins.float,
                 vcpus_limit: builtins.float):
    ...
    def memory_limit_in_gbs(self) -> builtins.float:
        return pulumi.get(self, "memory_limit_in_gbs")

    @property
    @pulumi.getter(name="vcpusLimit")
    def vcpus_limit(self) -> builtins.float:
...
class GetContainerInstanceContainerSecurityContextResult(dict):
    def __init__(__self__, *,
                 ...
                 is_non_root_user_check_enabled: builtins.bool,
                 is_root_file_system_readonly: builtins.bool,
                 run_as_group: builtins.int,
                 run_as_user: builtins.int,
                 security_context_type: builtins.str):
    ...
    def is_non_root_user_check_enabled(self) -> builtins.bool:
        return pulumi.get(self, "is_non_root_user_check_enabled")

    @property
    @pulumi.getter(name="isRootFileSystemReadonly")
    def is_root_file_system_readonly(self) -> builtins.bool:
    ...
    def security_context_type(self) -> builtins.str:
...
class GetContainerInstanceContainerSecurityContextCapabilityResult(dict):
    def __init__(__self__, *,
                 add_capabilities: Sequence[builtins.str],
                 drop_capabilities: Sequence[builtins.str]):
    ...
    def add_capabilities(self) -> Sequence[builtins.str]:
        return pulumi.get(self, "add_capabilities")

    @property
    @pulumi.getter(name="dropCapabilities")
    def drop_capabilities(self) -> Sequence[builtins.str]:
...
class GetContainerInstanceDnsConfigResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] nameservers: IP address of the name server..
        :param Sequence[builtins.str] options: Options allows certain internal resolver variables to be modified.
        :param Sequence[builtins.str] searches: Search list for hostname lookup.
        """
...
class GetContainerInstanceShapeConfigResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.float memory_in_gbs: The total amount of memory available to the container instance, in gigabytes.
...
class GetContainerInstanceShapeItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str name: The name identifying the shape.
        ...
        :param builtins.str processor_description: A short description of the Instance's processor (CPU).
        """
...
class GetContainerInstanceShapesContainerInstanceShapeCollectionItemMemoryOptionResult(dict):
    def __init__(__self__, *,
                 ...
                 min_per_ocpu_in_gbs: builtins.float):
        """
        :param builtins.float default_per_ocpu_in_gbs: The default amount of memory per OCPU available for this shape (GB).
        :param builtins.float max_in_gbs: The maximum amount of memory (GB).
        :param builtins.float max_per_ocpu_in_gbs: The maximum amount of memory per OCPU available for this shape (GB).
        :param builtins.float min_in_gbs: The minimum amount of memory (GB).
        :param builtins.float min_per_ocpu_in_gbs: The minimum amount of memory per OCPU available for this shape (GB).
        """
        pulumi.set(__self__, "default_per_ocpu_in_gbs", default_per_ocpu_in_gbs)
        pulumi.set(__self__, "max_in_gbs", max_in_gbs)
        pulumi.set(__self__, "max_per_ocpu_in_gbs", max_per_ocpu_in_gbs)
...
class GetContainerInstanceVnicResult(dict):
    def __init__(__self__, *,
                 ...
                 is_public_ip_assigned: builtins.bool,
    ...
    def is_public_ip_assigned(self) -> builtins.bool:
...
class GetContainerInstanceVolumeResult(dict):
    ...
    def backing_store(self) -> builtins.str:
        """
...
class GetContainerInstancesContainerInstanceCollectionItemResult(dict):
    def __init__(__self__, *,
                 availability_domain: builtins.str,
                 compartment_id: builtins.str,
                 container_count: builtins.int,
                 container_restart_policy: builtins.str,
                 ...
                 fault_domain: builtins.str,
                 freeform_tags: Mapping[str, builtins.str],
                 graceful_shutdown_timeout_in_seconds: builtins.str,
                 id: builtins.str,
        ...
        :param builtins.int container_count: The number of containers on the container instance.
        :param builtins.str container_restart_policy: The container restart policy is applied for all containers in container instance.
        ...
        :param builtins.str fault_domain: The fault domain to place the container instance.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str graceful_shutdown_timeout_in_seconds: The amount of time that processes in a container have to gracefully end when the container must be stopped. For example, when you delete a container instance. After the timeout is reached, the processes are sent a signal to be deleted.
        :param builtins.str id: An OCID that cannot be changed.
        ...
        :param builtins.str lifecycle_details: A message that describes the current state of the container in more detail. Can be used to provide actionable information.
        :param builtins.str shape: The shape of the container instance. The shape determines the number of OCPUs, amount of memory, and other resources that are allocated to a container instance.
        ...
        :param builtins.int volume_count: The number of volumes that are attached to the container instance.
    ...
    def container_restart_policy(self) -> builtins.str:
        """
    ...
    def graceful_shutdown_timeout_in_seconds(self) -> builtins.str:
        """
