...
class BootVolumeArgs:
    def __init__(__self__, *,
                 ...
                 boot_volume_replicas_deletion: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment that contains the boot volume.
        ...
        :param pulumi.Input[builtins.str] backup_policy_id: If provided, specifies the ID of the boot volume backup policy to assign to the newly created boot volume. If omitted, no policy will be assigned. This field is deprecated. Use the `core_get_volume_backup_policy_assignments` instead to assign a backup policy to a boot volume.
        ...
        :param pulumi.Input[builtins.bool] is_auto_tune_enabled: (Updatable) Specifies whether the auto-tune performance is enabled for this boot volume. This field is deprecated. Use the `DetachedVolumeAutotunePolicy` instead to enable the volume for detached autotune.
        :param pulumi.Input[builtins.str] kms_key_id: (Updatable) The OCID of the Vault service key to assign as the master encryption key for the boot volume.
    ...
    def boot_volume_replicas_deletion(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "boot_volume_replicas_deletion")

    @boot_volume_replicas_deletion.setter
    def boot_volume_replicas_deletion(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _BootVolumeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] auto_tuned_vpus_per_gb: The number of Volume Performance Units per GB that this boot volume is effectively tuned to.
        :param pulumi.Input[Sequence[pulumi.Input['BootVolumeAutotunePolicyArgs']]] autotune_policies: (Updatable) The list of autotune policies to be enabled for this volume.
        :param pulumi.Input[builtins.str] availability_domain: The availability domain of the volume. Omissible for cloning a volume. The new volume will be created in the availability domain of the source volume.  Example: `Uocm:PHX-AD-1`
        :param pulumi.Input[builtins.str] backup_policy_id: If provided, specifies the ID of the boot volume backup policy to assign to the newly created boot volume. If omitted, no policy will be assigned. This field is deprecated. Use the `core_get_volume_backup_policy_assignments` instead to assign a backup policy to a boot volume.
        :param pulumi.Input[Sequence[pulumi.Input['BootVolumeBootVolumeReplicaArgs']]] boot_volume_replicas: (Updatable) The list of boot volume replicas to be enabled for this boot volume in the specified destination availability domains.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] image_id: The image OCID used to create the boot volume.
        :param pulumi.Input[builtins.bool] is_auto_tune_enabled: (Updatable) Specifies whether the auto-tune performance is enabled for this boot volume. This field is deprecated. Use the `DetachedVolumeAutotunePolicy` instead to enable the volume for detached autotune.
        :param pulumi.Input[builtins.bool] is_hydrated: Specifies whether the boot volume's data has finished copying from the source boot volume or boot volume backup.
        :param pulumi.Input[builtins.str] kms_key_id: (Updatable) The OCID of the Vault service key to assign as the master encryption key for the boot volume.
        :param pulumi.Input[builtins.str] size_in_gbs: (Updatable) The size of the volume in GBs.
        :param pulumi.Input[builtins.str] size_in_mbs: The size of the volume in MBs. The value must be a multiple of 1024. This field is deprecated. Please use `size_in_gbs`.
        :param pulumi.Input[builtins.str] state: The current state of a boot volume.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the boot volume was created. Format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
...
class BootVolume(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] availability_domain: The availability domain of the volume. Omissible for cloning a volume. The new volume will be created in the availability domain of the source volume.  Example: `Uocm:PHX-AD-1`
        :param pulumi.Input[builtins.str] backup_policy_id: If provided, specifies the ID of the boot volume backup policy to assign to the newly created boot volume. If omitted, no policy will be assigned. This field is deprecated. Use the `core_get_volume_backup_policy_assignments` instead to assign a backup policy to a boot volume.
        :param pulumi.Input[Sequence[pulumi.Input[Union['BootVolumeBootVolumeReplicaArgs', 'BootVolumeBootVolumeReplicaArgsDict']]]] boot_volume_replicas: (Updatable) The list of boot volume replicas to be enabled for this boot volume in the specified destination availability domains.
        :param pulumi.Input[builtins.str] cluster_placement_group_id: The clusterPlacementGroup Id of the volume for volume placement.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment that contains the boot volume.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
    ...
    def get(resource_name: str,
            ...
            volume_group_id: Optional[pulumi.Input[builtins.str]] = None,
            vpus_per_gb: Optional[pulumi.Input[builtins.str]] = None,
            xrc_kms_key_id: Optional[pulumi.Input[builtins.str]] = None) -> 'BootVolume':
        """
    ...
    @property
    @pulumi.getter(name="bootVolumeReplicasDeletion")
    def boot_volume_replicas_deletion(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "boot_volume_replicas_deletion")
