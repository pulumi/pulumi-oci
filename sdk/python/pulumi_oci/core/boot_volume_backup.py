...
class BootVolumeBackupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] boot_volume_id: The OCID of the boot volume that needs to be backed up. Cannot be defined if `source_details` is defined.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment that contains the boot volume backup.
        ...
        :param pulumi.Input[builtins.str] type: The type of backup to create. If omitted, defaults to incremental. Supported values are 'FULL' or 'INCREMENTAL'.
        """
...
class _BootVolumeBackupState:
    def __init__(__self__, *,
                 ...
                 source_boot_volume_backup_id: Optional[pulumi.Input[builtins.str]] = None,
                 source_details: Optional[pulumi.Input['BootVolumeBackupSourceDetailsArgs']] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] image_id: The image OCID used to create the boot volume the backup is taken from.
        :param pulumi.Input[builtins.str] kms_key_id: (Updatable) The OCID of the Vault service key which is the master encryption key for the volume backup. For more information about the Vault service and encryption keys, see [Overview of Vault service](https://docs.cloud.oracle.com/iaas/Content/KeyManagement/Concepts/keyoverview.htm) and [Using Keys](https://docs.cloud.oracle.com/iaas/Content/KeyManagement/Tasks/usingkeys.htm).
        :param pulumi.Input[builtins.str] size_in_gbs: The size of the boot volume, in GBs.
        :param pulumi.Input[builtins.str] source_boot_volume_backup_id: The OCID of the source boot volume backup.
        :param pulumi.Input['BootVolumeBackupSourceDetailsArgs'] source_details: Details of the volume backup source in the cloud. Cannot be defined if `boot_volume_id` is defined.
        :param pulumi.Input[builtins.str] source_type: Specifies whether the backup was created manually, or via scheduled backup policy.
        :param pulumi.Input[builtins.str] state: The current state of a boot volume backup.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the boot volume backup was created. This is the time the actual point-in-time image of the volume data was taken. Format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] time_request_received: The date and time the request to create the boot volume backup was received. Format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] type: The type of backup to create. If omitted, defaults to incremental. Supported values are 'FULL' or 'INCREMENTAL'.
        :param pulumi.Input[builtins.str] unique_size_in_gbs: The size used by the backup, in GBs. It is typically smaller than sizeInGBs, depending on the space consumed on the boot volume and whether the backup is full or incremental.
        """
        if boot_volume_id is not None:
            pulumi.set(__self__, "boot_volume_id", boot_volume_id)
        if compartment_id is not None:
    ...
    def source_boot_volume_backup_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_boot_volume_backup_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BootVolumeBackup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_request_received: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            unique_size_in_gbs: Optional[pulumi.Input[builtins.str]] = None) -> 'BootVolumeBackup':
        """
    ...
    @property
    @pulumi.getter(name="sourceBootVolumeBackupId")
    def source_boot_volume_backup_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the source boot volume backup.
        """
        return pulumi.get(self, "source_boot_volume_backup_id")
