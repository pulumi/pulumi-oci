...
class BootVolumeBackupArgs:
    def __init__(__self__, *,
                 ...
                 retention_period: pulumi.Input[Optional['BootVolumeBackupRetentionPeriodArgs']] = None,
                 source_details: pulumi.Input[Optional['BootVolumeBackupSourceDetailsArgs']] = None,
        ...
        :param pulumi.Input['BootVolumeBackupRetentionPeriodArgs'] retention_period: (Updatable) This field is used to define the retention period for backups. This is an optional field. If it is not specified, it is set to null, no retention period will be applied to the backups.
    ...
    def retention_period(self) -> pulumi.Input[Optional['BootVolumeBackupRetentionPeriodArgs']]:
        """
    ...
    def retention_period(self, value: pulumi.Input[Optional['BootVolumeBackupRetentionPeriodArgs']]):
        pulumi.set(self, "retention_period", value)

    @_builtins.property
    @pulumi.getter(name="sourceDetails")
    def source_details(self) -> pulumi.Input[Optional['BootVolumeBackupSourceDetailsArgs']]:
        """
    ...
    def source_details(self, value: pulumi.Input[Optional['BootVolumeBackupSourceDetailsArgs']]):
...
class _BootVolumeBackupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[_builtins.str] image_id: The image OCID used to create the boot volume the backup is taken from.
        :param pulumi.Input[_builtins.bool] is_indefinite_retention_enabled: (Updatable) feature that preserves backup data from modification or deletion to ensure it remains available for legal or regulatory investigations or litigation, regardless of standard retention policies. This is an optional field. If it is not specified, it is set to null, no legal hold will be applied to the backups.
        :param pulumi.Input[_builtins.bool] is_prevent_deletion_enabled: (Updatable) Prevent backups from being deleted during the configured retention period. This is an optional field. If it is not specified, it is set to null, prevent deletion will not be applied to the backups.
        :param pulumi.Input[_builtins.bool] is_retention_lock_enabled: (Updatable) feature that prevents deletion or alteration of backup data for a specified period to ensure data protection and regulatory compliance. This is an optional field. If it is not specified, it is set to null, no retention lock will be applied to the backups. This feature should be used in conjunction with the retention-period field.
        :param pulumi.Input[_builtins.str] kms_key_id: (Updatable) The OCID of the Vault service key which is the master encryption key for the volume backup. For more information about the Vault service and encryption keys, see [Overview of Vault service](https://docs.cloud.oracle.com/iaas/Content/KeyManagement/Concepts/keyoverview.htm) and [Using Keys](https://docs.cloud.oracle.com/iaas/Content/KeyManagement/Tasks/usingkeys.htm).
        ...
        :param pulumi.Input[_builtins.str] time_created: The date and time the boot volume backup was created. This is the time the actual point-in-time image of the volume data was taken. Format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[_builtins.str] time_request_received: The date and time the request to create the boot volume backup was received. Format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        ...
        :param pulumi.Input[_builtins.str] type: The type of backup to create. If omitted, defaults to incremental. Supported values are 'FULL' or 'INCREMENTAL'.
        :param pulumi.Input[_builtins.str] unique_size_in_gbs: The size used by the backup, in GBs. It is typically smaller than sizeInGBs, depending on the space consumed on the boot volume and whether the backup is full or incremental.
    ...
    def source_boot_volume_backup_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def source_boot_volume_backup_id(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class BootVolumeBackup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: pulumi.Input[Optional[_builtins.str]] = None,
            unique_size_in_gbs: pulumi.Input[Optional[_builtins.str]] = None,
            volume_group_backup_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'BootVolumeBackup':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="retentionPeriod")
    def retention_period(self) -> pulumi.Output['outputs.BootVolumeBackupRetentionPeriod']:
        """
        (Updatable) This field is used to define the retention period for backups. This is an optional field. If it is not specified, it is set to null, no retention period will be applied to the backups.
        """
        return pulumi.get(self, "retention_period")
    ...
    @_builtins.property
    @pulumi.getter(name="sourceBootVolumeBackupId")
    def source_boot_volume_backup_id(self) -> pulumi.Output[_builtins.str]:
        """
        The OCID of the source boot volume backup.
        """
        return pulumi.get(self, "source_boot_volume_backup_id")
