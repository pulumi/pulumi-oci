...
class _ByoasnState:
    def __init__(__self__, *,
                 asn: pulumi.Input[Optional[_builtins.str]] = None,
                 byoip_ranges: pulumi.Input[Optional[Sequence[pulumi.Input['ByoasnByoipRangeArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def asn(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The Autonomous System Number (ASN) you are importing to the Oracle cloud.
        """
        return pulumi.get(self, "asn")
    ...
    @asn.setter
    def asn(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "asn", value)

    @_builtins.property
    @pulumi.getter(name="byoipRanges")
    def byoip_ranges(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ByoasnByoipRangeArgs']]]]:
        """
    ...
    @byoip_ranges.setter
    def byoip_ranges(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ByoasnByoipRangeArgs']]]]):
...
class Byoasn(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            asn: pulumi.Input[Optional[_builtins.str]] = None,
            byoip_ranges: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ByoasnByoipRangeArgs', 'ByoasnByoipRangeArgsDict', 'outputs.ByoasnByoipRange']]]]] = None,
            compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
            defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            display_name: pulumi.Input[Optional[_builtins.str]] = None,
            freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            ...
            time_updated: pulumi.Input[Optional[_builtins.str]] = None,
            time_validated: pulumi.Input[Optional[_builtins.str]] = None,
            validation_token: pulumi.Input[Optional[_builtins.str]] = None) -> 'Byoasn':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[_builtins.str] asn: The Autonomous System Number (ASN) you are importing to the Oracle cloud.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ByoasnByoipRangeArgs', 'ByoasnByoipRangeArgsDict', 'outputs.ByoasnByoipRange']]]] byoip_ranges: The BYOIP Ranges that has the `Byoasn` as origin.
        :param pulumi.Input[_builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the BYOASN Resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[_builtins.str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
