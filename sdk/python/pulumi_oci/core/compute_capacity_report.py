...
class ComputeCapacityReportArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_domain: The availability domain for the capacity report.  Example: `Uocm:PHX-AD-1`
        :param pulumi.Input[builtins.str] compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for the compartment. This should always be the root compartment.
...
class _ComputeCapacityReportState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for the compartment. This should always be the root compartment.
        :param pulumi.Input[Sequence[pulumi.Input['ComputeCapacityReportShapeAvailabilityArgs']]] shape_availabilities: Information about the shapes in the capacity report.
        :param pulumi.Input[builtins.str] time_created: The date and time the capacity report was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        """
...
class ComputeCapacityReport(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            compartment_id: Optional[pulumi.Input[builtins.str]] = None,
            shape_availabilities: Optional[pulumi.Input[Sequence[pulumi.Input[Union['ComputeCapacityReportShapeAvailabilityArgs', 'ComputeCapacityReportShapeAvailabilityArgsDict']]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'ComputeCapacityReport':
        """
