...
class ComputeCapacityReservationArgs:
    def __init__(__self__, *,
                 ...
                 is_default_reservation: pulumi.Input[Optional[_builtins.bool]] = None):
        """
        The set of arguments for constructing a ComputeCapacityReservation resource.

        :param pulumi.Input[_builtins.str] availability_domain: The availability domain of this compute capacity reservation.  Example: `Uocm:PHX-AD-1`
        :param pulumi.Input[_builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the capacity reservation.
    ...
    def is_default_reservation(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class _ComputeCapacityReservationState:
    def __init__(__self__, *,
                 ...
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 instance_reservation_configs: pulumi.Input[Optional[Sequence[pulumi.Input['ComputeCapacityReservationInstanceReservationConfigArgs']]]] = None,
                 is_default_reservation: pulumi.Input[Optional[_builtins.bool]] = None,
                 reserved_instance_count: pulumi.Input[Optional[_builtins.str]] = None,
                 state: pulumi.Input[Optional[_builtins.str]] = None,
                 time_created: pulumi.Input[Optional[_builtins.str]] = None,
                 time_updated: pulumi.Input[Optional[_builtins.str]] = None,
                 used_instance_count: pulumi.Input[Optional[_builtins.str]] = None):
        """
        ...
        :param pulumi.Input[_builtins.bool] is_default_reservation: (Updatable) Whether this capacity reservation is the default. For more information, see [Capacity Reservations](https://docs.cloud.oracle.com/iaas/Content/Compute/Tasks/reserve-capacity.htm#default).
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] reserved_instance_count: The number of instances for which capacity will be held with this compute capacity reservation. This number is the sum of the values of the `reservedCount` fields for all of the instance capacity configurations under this reservation. The purpose of this field is to calculate the percentage usage of the reservation.
        :param pulumi.Input[_builtins.str] state: The current state of the compute capacity reservation.
        :param pulumi.Input[_builtins.str] time_created: The date and time the compute capacity reservation was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[_builtins.str] time_updated: The date and time the compute capacity reservation was updated, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[_builtins.str] used_instance_count: The total number of instances currently consuming space in this compute capacity reservation. This number is the sum of the values of the `usedCount` fields for all of the instance capacity configurations under this reservation. The purpose of this field is to calculate the percentage usage of the reservation.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="instanceReservationConfigs")
    def instance_reservation_configs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ComputeCapacityReservationInstanceReservationConfigArgs']]]]:
        """
        (Updatable) The capacity configurations for the capacity reservation. (Note: From 6.17.0 instance_reservation_configs field in Core.ComputeCapacityReservation is changed from TypeList to TypeSet - to avoid unnecessary updates. Also, configs cant by accessed by index)
    ...
    @instance_reservation_configs.setter
    def instance_reservation_configs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ComputeCapacityReservationInstanceReservationConfigArgs']]]]):
        pulumi.set(self, "instance_reservation_configs", value)
    ...
    def reserved_instance_count(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The number of instances for which capacity will be held with this compute capacity reservation. This number is the sum of the values of the `reservedCount` fields for all of the instance capacity configurations under this reservation. The purpose of this field is to calculate the percentage usage of the reservation.
        """
    ...
    def reserved_instance_count(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def used_instance_count(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def used_instance_count(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class ComputeCapacityReservation(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 instance_reservation_configs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ComputeCapacityReservationInstanceReservationConfigArgs', 'ComputeCapacityReservationInstanceReservationConfigArgsDict', 'outputs.ComputeCapacityReservationInstanceReservationConfig']]]]] = None,
                 is_default_reservation: pulumi.Input[Optional[_builtins.bool]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[Sequence[pulumi.Input[Union['ComputeCapacityReservationInstanceReservationConfigArgs', 'ComputeCapacityReservationInstanceReservationConfigArgsDict', 'outputs.ComputeCapacityReservationInstanceReservationConfig']]]] instance_reservation_configs: (Updatable) The capacity configurations for the capacity reservation. (Note: From 6.17.0 instance_reservation_configs field in Core.ComputeCapacityReservation is changed from TypeList to TypeSet - to avoid unnecessary updates. Also, configs cant by accessed by index)
    ...
    def get(resource_name: str,
            ...
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None,
            used_instance_count: pulumi.Input[Optional[_builtins.str]] = None) -> 'ComputeCapacityReservation':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="reservedInstanceCount")
    def reserved_instance_count(self) -> pulumi.Output[_builtins.str]:
        """
        The number of instances for which capacity will be held with this compute capacity reservation. This number is the sum of the values of the `reservedCount` fields for all of the instance capacity configurations under this reservation. The purpose of this field is to calculate the percentage usage of the reservation.
        """
        return pulumi.get(self, "reserved_instance_count")
    ...
    @_builtins.property
    @pulumi.getter(name="usedInstanceCount")
    def used_instance_count(self) -> pulumi.Output[_builtins.str]:
        """
        The total number of instances currently consuming space in this compute capacity reservation. This number is the sum of the values of the `usedCount` fields for all of the instance capacity configurations under this reservation. The purpose of this field is to calculate the percentage usage of the reservation.
        """
        return pulumi.get(self, "used_instance_count")
