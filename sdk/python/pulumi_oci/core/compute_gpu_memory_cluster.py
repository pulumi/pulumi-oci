...
class ComputeGpuMemoryClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_domain: The availability domain of the GPU memory cluster.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that contains the compute GPU memory cluster. compartment.
        :param pulumi.Input[builtins.str] compute_cluster_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute cluster.
        :param pulumi.Input[builtins.str] instance_configuration_id: (Updatable) Instance Configuration to be used for this GPU Memory Cluster
        ...
        :param pulumi.Input[builtins.str] gpu_memory_fabric_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the GPU memory fabric.
        :param pulumi.Input[builtins.str] size: (Updatable) The number of instances currently running in the GpuMemoryCluster 
...
class _ComputeGpuMemoryClusterState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] size: (Updatable) The number of instances currently running in the GpuMemoryCluster 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The lifecycle state of the GPU memory cluster
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the GPU memory cluster was created.  Example: `2016-09-15T21:10:29.600Z`
        """
...
class ComputeGpuMemoryCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'ComputeGpuMemoryCluster':
        """
