...
class ComputeGpuMemoryFabricArgs:
    def __init__(__self__, *,
                 compute_gpu_memory_fabric_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] compute_gpu_memory_fabric_id: The OCID of the compute GPU memory fabric.
    ...
    def compute_gpu_memory_fabric_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def compute_gpu_memory_fabric_id(self, value: pulumi.Input[builtins.str]):
...
class _ComputeGpuMemoryFabricState:
    def __init__(__self__, *,
                 ...
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 compute_gpu_memory_fabric_id: Optional[pulumi.Input[builtins.str]] = None,
                 compute_hpc_island_id: Optional[pulumi.Input[builtins.str]] = None,
                 compute_local_block_id: Optional[pulumi.Input[builtins.str]] = None,
                 compute_network_block_id: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 fabric_health: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 healthy_host_count: Optional[pulumi.Input[builtins.str]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 time_created: Optional[pulumi.Input[builtins.str]] = None,
                 total_host_count: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering ComputeGpuMemoryFabric resources.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] additional_data: Additional data that can be exposed to the customer. Right now it will include the switch tray ids.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for the compartment. This should always be the root compartment.
        :param pulumi.Input[builtins.str] compute_gpu_memory_fabric_id: The OCID of the compute GPU memory fabric.
        :param pulumi.Input[builtins.str] compute_hpc_island_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for Customer-unique HPC Island
        :param pulumi.Input[builtins.str] compute_local_block_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for Customer-unique Local Block
        :param pulumi.Input[builtins.str] compute_network_block_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for Customer-unique Network Block
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[builtins.str] fabric_health: The health state of the GPU memory fabric
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}` 
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] healthy_host_count: The total number of healthy bare metal hosts located in this compute GPU memory fabric.
        :param pulumi.Input[builtins.str] state: The lifecycle state of the GPU memory fabric
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time that the compute GPU memory fabric record was created, in the format defined by [RFC3339] (https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] total_host_count: The total number of bare metal hosts located in this compute GPU memory fabric.
        """
    ...
    @property
    @pulumi.getter(name="computeGpuMemoryFabricId")
    def compute_gpu_memory_fabric_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The OCID of the compute GPU memory fabric.
        """
        return pulumi.get(self, "compute_gpu_memory_fabric_id")
    ...
    @compute_gpu_memory_fabric_id.setter
    def compute_gpu_memory_fabric_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "compute_gpu_memory_fabric_id", value)

    @property
    @pulumi.getter(name="computeHpcIslandId")
    def compute_hpc_island_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def compute_hpc_island_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "compute_hpc_island_id", value)

    @property
    @pulumi.getter(name="computeLocalBlockId")
    def compute_local_block_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def compute_local_block_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "compute_local_block_id", value)

    @property
    @pulumi.getter(name="computeNetworkBlockId")
    def compute_network_block_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def compute_network_block_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def fabric_health(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def fabric_health(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def healthy_host_count(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def healthy_host_count(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def total_host_count(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def total_host_count(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ComputeGpuMemoryFabric(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            total_host_count: Optional[pulumi.Input[builtins.str]] = None) -> 'ComputeGpuMemoryFabric':
        """
    ...
    @property
    @pulumi.getter(name="additionalData")
    def additional_data(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        Additional data that can be exposed to the customer. Right now it will include the switch tray ids.
        """
        return pulumi.get(self, "additional_data")
    ...
    @property
    @pulumi.getter(name="computeGpuMemoryFabricId")
    def compute_gpu_memory_fabric_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the compute GPU memory fabric.
        """
        return pulumi.get(self, "compute_gpu_memory_fabric_id")
    ...
    @property
    @pulumi.getter(name="computeHpcIslandId")
    def compute_hpc_island_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for Customer-unique HPC Island
        """
        return pulumi.get(self, "compute_hpc_island_id")
    ...
    @property
    @pulumi.getter(name="computeLocalBlockId")
    def compute_local_block_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for Customer-unique Local Block
        """
        return pulumi.get(self, "compute_local_block_id")
    ...
    @property
    @pulumi.getter(name="computeNetworkBlockId")
    def compute_network_block_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for Customer-unique Network Block
        """
        return pulumi.get(self, "compute_network_block_id")
    ...
    @property
    @pulumi.getter(name="fabricHealth")
    def fabric_health(self) -> pulumi.Output[builtins.str]:
        """
        The health state of the GPU memory fabric
        """
        return pulumi.get(self, "fabric_health")
    ...
    @property
    @pulumi.getter(name="healthyHostCount")
    def healthy_host_count(self) -> pulumi.Output[builtins.str]:
        """
        The total number of healthy bare metal hosts located in this compute GPU memory fabric.
        """
        return pulumi.get(self, "healthy_host_count")
    ...
    @property
    @pulumi.getter(name="totalHostCount")
    def total_host_count(self) -> pulumi.Output[builtins.str]:
        """
        The total number of bare metal hosts located in this compute GPU memory fabric.
        """
        return pulumi.get(self, "total_host_count")
