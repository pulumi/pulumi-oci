...
class ComputeHostGroupArgs:
    def __init__(__self__, *,
                 ...
                 configurations: pulumi.Input[Optional[Sequence[pulumi.Input['ComputeHostGroupConfigurationArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def configurations(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ComputeHostGroupConfigurationArgs']]]]:
        """
    ...
    def configurations(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ComputeHostGroupConfigurationArgs']]]]):
...
class _ComputeHostGroupState:
    def __init__(__self__, *,
                 ...
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 is_targeted_placement_required: pulumi.Input[Optional[_builtins.bool]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="isTargetedPlacementRequired")
    def is_targeted_placement_required(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        (Updatable) A flag that allows customers to restrict placement for hosts attached to the group. If true, the only way to place on hosts is to target the specific host group.
    ...
    @is_targeted_placement_required.setter
    def is_targeted_placement_required(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "is_targeted_placement_required", value)
...
class ComputeHostGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 availability_domain: pulumi.Input[Optional[_builtins.str]] = None,
                 compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                 configurations: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ComputeHostGroupConfigurationArgs', 'ComputeHostGroupConfigurationArgsDict', 'outputs.ComputeHostGroupConfiguration']]]]] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 is_targeted_placement_required: pulumi.Input[Optional[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.str] availability_domain: The availability domain of a host group.  Example: `Uocm:PHX-AD-1`
        :param pulumi.Input[_builtins.str] compartment_id: (Updatable) The OCID of the compartment that contains host group.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ComputeHostGroupConfigurationArgs', 'ComputeHostGroupConfigurationArgsDict', 'outputs.ComputeHostGroupConfiguration']]]] configurations: (Updatable) A list of HostGroupConfiguration objects
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[_builtins.str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[_builtins.bool] is_targeted_placement_required: (Updatable) A flag that allows customers to restrict placement for hosts attached to the group. If true, the only way to place on hosts is to target the specific host group.
    ...
    def get(resource_name: str,
            ...
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None) -> 'ComputeHostGroup':
        """
