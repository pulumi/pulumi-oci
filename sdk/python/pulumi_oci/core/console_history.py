...
class ConsoleHistoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] instance_id: The OCID of the instance to get the console history from.
...
class _ConsoleHistoryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_domain: The availability domain of an instance.  Example: `Uocm:PHX-AD-1`
        ...
        :param pulumi.Input[builtins.str] instance_id: The OCID of the instance to get the console history from.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The current state of the console history.
        :param pulumi.Input[builtins.str] time_created: The date and time the history was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339). Example: `2016-08-25T21:10:29.600Z`
        """
...
class ConsoleHistory(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            instance_id: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'ConsoleHistory':
        """
