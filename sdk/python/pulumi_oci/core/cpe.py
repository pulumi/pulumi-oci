...
class CpeArgs:
    def __init__(__self__, *,
                 ...
                 cpe_device_shape_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] is_private: Indicates whether this CPE is of type `private` or not. 
    ...
    def cpe_device_shape_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the CPE device type. You can provide a value if you want to later generate CPE device configuration content for IPSec connections that use this CPE. You can also call [UpdateCpe](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/Cpe/UpdateCpe) later to provide a value. For a list of possible values, see [ListCpeDeviceShapes](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/CpeDeviceShapeSummary/ListCpeDeviceShapes).
    ...
    def cpe_device_shape_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _CpeState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] is_private: Indicates whether this CPE is of type `private` or not. 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] time_created: The date and time the CPE was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        """
...
class Cpe(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ip_address: Optional[pulumi.Input[builtins.str]] = None,
            is_private: Optional[pulumi.Input[builtins.bool]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'Cpe':
        """
    ...
    @property
    @pulumi.getter(name="cpeDeviceShapeId")
    def cpe_device_shape_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the CPE device type. You can provide a value if you want to later generate CPE device configuration content for IPSec connections that use this CPE. You can also call [UpdateCpe](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/Cpe/UpdateCpe) later to provide a value. For a list of possible values, see [ListCpeDeviceShapes](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/CpeDeviceShapeSummary/ListCpeDeviceShapes).
    ...
    @property
    @pulumi.getter(name="isPrivate")
    def is_private(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether this CPE is of type `private` or not. 
