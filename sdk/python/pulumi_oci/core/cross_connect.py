...
class CrossConnectArgs:
    def __init__(__self__, *,
                 ...
                 port_speed_shape_name: pulumi.Input[_builtins.str],
                 cross_connect_group_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def port_speed_shape_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def port_speed_shape_name(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "port_speed_shape_name", value)

    @_builtins.property
    @pulumi.getter(name="crossConnectGroupId")
    def cross_connect_group_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def cross_connect_group_id(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def far_cross_connect_or_cross_connect_group_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def far_cross_connect_or_cross_connect_group_id(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def macsec_properties(self) -> pulumi.Input[Optional['CrossConnectMacsecPropertiesArgs']]:
        """
    ...
    def macsec_properties(self, value: pulumi.Input[Optional['CrossConnectMacsecPropertiesArgs']]):
        pulumi.set(self, "macsec_properties", value)

    @_builtins.property
    @pulumi.getter(name="nearCrossConnectOrCrossConnectGroupId")
    def near_cross_connect_or_cross_connect_group_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def near_cross_connect_or_cross_connect_group_id(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class _CrossConnectState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] port_speed_shape_name: The port speed for this cross-connect. To get a list of the available port speeds, see [ListCrossConnectPortSpeedShapes](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/CrossConnectPortSpeedShape/ListCrossconnectPortSpeedShapes).  Example: `10 Gbps`
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] state: The cross-connect's current state.
        :param pulumi.Input[_builtins.str] time_created: The date and time the cross-connect was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        """
    ...
    @_builtins.property
    @pulumi.getter(name="portSpeedShapeName")
    def port_speed_shape_name(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The port speed for this cross-connect. To get a list of the available port speeds, see [ListCrossConnectPortSpeedShapes](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/CrossConnectPortSpeedShape/ListCrossconnectPortSpeedShapes).  Example: `10 Gbps`
    ...
    @port_speed_shape_name.setter
    def port_speed_shape_name(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "port_speed_shape_name", value)
...
class CrossConnect(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_cross_connect = oci.core.CrossConnect("test_cross_connect",
            ...
            macsec_properties={
                ...
                "is_unprotected_traffic_allowed": cross_connect_macsec_properties_is_unprotected_traffic_allowed == "true",
                "primary_key": {
    ...
    def get(resource_name: str,
            ...
            port_speed_shape_name: pulumi.Input[Optional[_builtins.str]] = None,
            state: pulumi.Input[Optional[_builtins.str]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None) -> 'CrossConnect':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="crossConnectGroupId")
    def cross_connect_group_id(self) -> pulumi.Output[_builtins.str]:
        """
        The OCID of the cross-connect group to put this cross-connect in.
        """
        return pulumi.get(self, "cross_connect_group_id")
    ...
    @_builtins.property
    @pulumi.getter(name="farCrossConnectOrCrossConnectGroupId")
    def far_cross_connect_or_cross_connect_group_id(self) -> pulumi.Output[_builtins.str]:
        """
        If you already have an existing cross-connect or cross-connect group at this FastConnect location, and you want this new cross-connect to be on a different router (for the purposes of redundancy), provide the [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of that existing cross-connect or cross-connect group.
        """
        return pulumi.get(self, "far_cross_connect_or_cross_connect_group_id")
    ...
    @_builtins.property
    @pulumi.getter(name="nearCrossConnectOrCrossConnectGroupId")
    def near_cross_connect_or_cross_connect_group_id(self) -> pulumi.Output[_builtins.str]:
        """
        If you already have an existing cross-connect or cross-connect group at this FastConnect location, and you want this new cross-connect to be on the same router, provide the [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of that existing cross-connect or cross-connect group.
        """
        return pulumi.get(self, "near_cross_connect_or_cross_connect_group_id")
    ...
    @_builtins.property
    @pulumi.getter(name="portSpeedShapeName")
    def port_speed_shape_name(self) -> pulumi.Output[_builtins.str]:
        """
        The port speed for this cross-connect. To get a list of the available port speeds, see [ListCrossConnectPortSpeedShapes](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/CrossConnectPortSpeedShape/ListCrossconnectPortSpeedShapes).  Example: `10 Gbps`
