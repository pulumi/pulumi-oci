...
class DedicatedVmHostArgs:
    def __init__(__self__, *,
                 ...
                 dedicated_vm_host_shape: pulumi.Input[builtins.str],
    ...
    def dedicated_vm_host_shape(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def dedicated_vm_host_shape(self, value: pulumi.Input[builtins.str]):
...
class _DedicatedVmHostState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the dedicated VM host was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
    ...
    @dedicated_vm_host_shape.setter
    def dedicated_vm_host_shape(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dedicated_vm_host_shape", value)
...
class DedicatedVmHost(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            total_memory_in_gbs: Optional[pulumi.Input[builtins.float]] = None,
            total_ocpus: Optional[pulumi.Input[builtins.float]] = None) -> 'DedicatedVmHost':
        """
    ...
    @property
    @pulumi.getter(name="remainingMemoryInGbs")
    def remaining_memory_in_gbs(self) -> pulumi.Output[builtins.float]:
        """
        The current available memory of the dedicated VM host, in GBs.
        """
        return pulumi.get(self, "remaining_memory_in_gbs")
    ...
    @property
    @pulumi.getter(name="remainingOcpus")
    def remaining_ocpus(self) -> pulumi.Output[builtins.float]:
        """
        The current available OCPUs of the dedicated VM host.
        """
        return pulumi.get(self, "remaining_ocpus")
    ...
    @property
    @pulumi.getter(name="totalMemoryInGbs")
    def total_memory_in_gbs(self) -> pulumi.Output[builtins.float]:
        """
        The current total memory of the dedicated VM host, in GBs.
        """
        return pulumi.get(self, "total_memory_in_gbs")
    ...
    @property
    @pulumi.getter(name="totalOcpus")
    def total_ocpus(self) -> pulumi.Output[builtins.float]:
        """
        The current total OCPUs of the dedicated VM host.
        """
        return pulumi.get(self, "total_ocpus")
