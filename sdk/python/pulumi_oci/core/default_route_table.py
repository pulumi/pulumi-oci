...
class DefaultRouteTableArgs:
    def __init__(__self__, *,
                 manage_default_resource_id: pulumi.Input[builtins.str],
    ...
    def manage_default_resource_id(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "manage_default_resource_id")

    @manage_default_resource_id.setter
    def manage_default_resource_id(self, value: pulumi.Input[builtins.str]):
...
class _DefaultRouteTableState:
    def __init__(__self__, *,
                 ...
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 manage_default_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 route_rules: Optional[pulumi.Input[Sequence[pulumi.Input['DefaultRouteTableRouteRuleArgs']]]] = None,
    ...
    @property
    @pulumi.getter(name="manageDefaultResourceId")
    def manage_default_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "manage_default_resource_id")

    @manage_default_resource_id.setter
    def manage_default_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "manage_default_resource_id", value)
...
class DefaultRouteTable(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            route_rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DefaultRouteTableRouteRuleArgs', 'DefaultRouteTableRouteRuleArgsDict']]]]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'DefaultRouteTable':
        """
    ...
    @property
    @pulumi.getter(name="manageDefaultResourceId")
    def manage_default_resource_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "manage_default_resource_id")
