...
class DhcpOptionsArgs:
    def __init__(__self__, *,
                 ...
                 domain_name_type: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a DhcpOptions resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to contain the set of DHCP options.
        :param pulumi.Input[Sequence[pulumi.Input['DhcpOptionsOptionArgs']]] options: (Updatable) A set of DHCP options.
        :param pulumi.Input[builtins.str] vcn_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VCN the set of DHCP options belongs to.
        ...
        :param pulumi.Input[builtins.str] domain_name_type: (Updatable) The search domain name type of DHCP options
    ...
    def domain_name_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def domain_name_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DhcpOptionsState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[Sequence[pulumi.Input['DhcpOptionsOptionArgs']]] options: (Updatable) A set of DHCP options.
        :param pulumi.Input[builtins.str] state: The current state of the set of DHCP options.
        :param pulumi.Input[builtins.str] time_created: Date and time the set of DHCP options was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] vcn_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VCN the set of DHCP options belongs to.
...
class DhcpOptions(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            vcn_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DhcpOptions':
        """
    ...
    @property
    @pulumi.getter(name="domainNameType")
    def domain_name_type(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The search domain name type of DHCP options
        """
        return pulumi.get(self, "domain_name_type")
