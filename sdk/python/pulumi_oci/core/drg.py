...
class _DrgState:
    def __init__(__self__, *,
                 ...
                 default_drg_route_tables: pulumi.Input[Optional[Sequence[pulumi.Input['DrgDefaultDrgRouteTableArgs']]]] = None,
                 default_export_drg_route_distribution_id: pulumi.Input[Optional[_builtins.str]] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 redundancy_status: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] redundancy_status: The redundancy status of the DRG specified.
        :param pulumi.Input[_builtins.str] state: The DRG's current state.
        :param pulumi.Input[_builtins.str] time_created: The date and time the DRG was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        """
    ...
    def default_drg_route_tables(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DrgDefaultDrgRouteTableArgs']]]]:
        """
    ...
    def default_drg_route_tables(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DrgDefaultDrgRouteTableArgs']]]]):
        pulumi.set(self, "default_drg_route_tables", value)

    @_builtins.property
    @pulumi.getter(name="defaultExportDrgRouteDistributionId")
    def default_export_drg_route_distribution_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def default_export_drg_route_distribution_id(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def redundancy_status(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def redundancy_status(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class Drg(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
            default_drg_route_tables: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DrgDefaultDrgRouteTableArgs', 'DrgDefaultDrgRouteTableArgsDict', 'outputs.DrgDefaultDrgRouteTable']]]]] = None,
            default_export_drg_route_distribution_id: pulumi.Input[Optional[_builtins.str]] = None,
            defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            display_name: pulumi.Input[Optional[_builtins.str]] = None,
            freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            redundancy_status: pulumi.Input[Optional[_builtins.str]] = None,
            state: pulumi.Input[Optional[_builtins.str]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None) -> 'Drg':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[_builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to contain the DRG.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DrgDefaultDrgRouteTableArgs', 'DrgDefaultDrgRouteTableArgsDict', 'outputs.DrgDefaultDrgRouteTable']]]] default_drg_route_tables: The default DRG route table for this DRG. Each network type has a default DRG route table.
        :param pulumi.Input[_builtins.str] default_export_drg_route_distribution_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of this DRG's default export route distribution for the DRG attachments.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[_builtins.str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
    ...
    @_builtins.property
    @pulumi.getter(name="defaultExportDrgRouteDistributionId")
    def default_export_drg_route_distribution_id(self) -> pulumi.Output[_builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of this DRG's default export route distribution for the DRG attachments.
        """
        return pulumi.get(self, "default_export_drg_route_distribution_id")
    ...
    @_builtins.property
    @pulumi.getter(name="redundancyStatus")
    def redundancy_status(self) -> pulumi.Output[_builtins.str]:
        """
        The redundancy status of the DRG specified.
        """
        return pulumi.get(self, "redundancy_status")
