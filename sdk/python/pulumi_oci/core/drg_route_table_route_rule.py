...
class DrgRouteTableRouteRuleArgs:
    def __init__(__self__, *,
                 ...
                 drg_route_table_id: pulumi.Input[builtins.str],
                 next_hop_drg_attachment_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a DrgRouteTableRouteRule resource.
        :param pulumi.Input[builtins.str] destination: (Updatable) This is the range of IP addresses used for matching when routing traffic. Only CIDR_BLOCK values are allowed.
               
               Potential values:
               * IP address range in CIDR notation. This can be an IPv4 or IPv6 CIDR. For example: `192.168.1.0/24` or `2001:0db8:0123:45::/56`.
        :param pulumi.Input[builtins.str] destination_type: Type of destination for the rule. Required if `direction` = `EGRESS`. Allowed values:
               * `CIDR_BLOCK`: If the rule's `destination` is an IP address range in CIDR notation.
        :param pulumi.Input[builtins.str] drg_route_table_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DRG route table.
        ...
        :param pulumi.Input[builtins.str] next_hop_drg_attachment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the next hop DRG attachment. The next hop DRG attachment is responsible for reaching the network destination.
    ...
    def drg_route_table_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def drg_route_table_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "drg_route_table_id", value)

    @property
    @pulumi.getter(name="nextHopDrgAttachmentId")
    def next_hop_drg_attachment_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def next_hop_drg_attachment_id(self, value: pulumi.Input[builtins.str]):
...
class _DrgRouteTableRouteRuleState:
    def __init__(__self__, *,
                 ...
                 is_conflict: Optional[pulumi.Input[builtins.bool]] = None,
                 next_hop_drg_attachment_id: Optional[pulumi.Input[builtins.str]] = None,
                 route_provenance: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] attributes: Additional properties for the route, computed by the service.
        :param pulumi.Input[builtins.str] destination: (Updatable) This is the range of IP addresses used for matching when routing traffic. Only CIDR_BLOCK values are allowed.
        ...
        :param pulumi.Input[builtins.str] drg_route_table_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DRG route table.
               ...
               Potential values:
               * IP address range in CIDR notation. This can be an IPv4 CIDR block or IPv6 prefix. For example: `192.168.1.0/24` or `2001:0db8:0123:45::/56`.
        :param pulumi.Input[builtins.bool] is_blackhole: Indicates that if the next hop attachment does not exist, so traffic for this route is discarded without notification.
        :param pulumi.Input[builtins.bool] is_conflict: Indicates that the route was not imported due to a conflict between route rules.
        :param pulumi.Input[builtins.str] next_hop_drg_attachment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the next hop DRG attachment. The next hop DRG attachment is responsible for reaching the network destination.
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] route_provenance: The earliest origin of a route. If a route is advertised to a DRG through an IPsec tunnel attachment, and is propagated to peered DRGs via RPC attachments, the route's provenance in the peered DRGs remains `IPSEC_TUNNEL`, because that is the earliest origin.
        :param pulumi.Input[builtins.str] route_type: You can specify static routes for the DRG route table using the API. The DRG learns dynamic routes from the DRG attachments using various routing protocols.
        """
    ...
    def is_conflict(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_conflict.setter
    def is_conflict(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_conflict", value)

    @property
    @pulumi.getter(name="nextHopDrgAttachmentId")
    def next_hop_drg_attachment_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the next hop DRG attachment. The next hop DRG attachment is responsible for reaching the network destination.
    ...
    @next_hop_drg_attachment_id.setter
    def next_hop_drg_attachment_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "next_hop_drg_attachment_id", value)

    @property
    @pulumi.getter(name="routeProvenance")
    def route_provenance(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def route_provenance(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DrgRouteTableRouteRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            next_hop_drg_attachment_id: Optional[pulumi.Input[builtins.str]] = None,
            route_provenance: Optional[pulumi.Input[builtins.str]] = None,
            route_type: Optional[pulumi.Input[builtins.str]] = None) -> 'DrgRouteTableRouteRule':
        """
    ...
    @property
    @pulumi.getter(name="isBlackhole")
    def is_blackhole(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates that if the next hop attachment does not exist, so traffic for this route is discarded without notification.
        """
        return pulumi.get(self, "is_blackhole")
    ...
    @property
    @pulumi.getter(name="isConflict")
    def is_conflict(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates that the route was not imported due to a conflict between route rules.
        """
        return pulumi.get(self, "is_conflict")
    ...
    @property
    @pulumi.getter(name="nextHopDrgAttachmentId")
    def next_hop_drg_attachment_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the next hop DRG attachment. The next hop DRG attachment is responsible for reaching the network destination.
    ...
    @property
    @pulumi.getter(name="routeProvenance")
    def route_provenance(self) -> pulumi.Output[builtins.str]:
        """
        The earliest origin of a route. If a route is advertised to a DRG through an IPsec tunnel attachment, and is propagated to peered DRGs via RPC attachments, the route's provenance in the peered DRGs remains `IPSEC_TUNNEL`, because that is the earliest origin.
        """
        return pulumi.get(self, "route_provenance")
