...
def get_app_catalog_listing_resource_version(listing_id: Optional[builtins.str] = None,
    ...
    :param builtins.str resource_version: Listing Resource Version.
    """
    __args__ = dict()
...
def get_app_catalog_listing_resource_version_output(listing_id: Optional[pulumi.Input[builtins.str]] = None,
