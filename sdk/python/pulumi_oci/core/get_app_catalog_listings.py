...
def get_app_catalog_listings(display_name: Optional[builtins.str] = None,
                             ...
                             publisher_type: Optional[builtins.str] = None,
    ...
    :param builtins.str publisher_name: A filter to return only the publisher that matches the given publisher name exactly.
    :param builtins.str publisher_type: A filter to return only publishers that match the given publisher type exactly. Valid types are OCI, ORACLE, TRUSTED, STANDARD.
    """
    __args__ = dict()
...
def get_app_catalog_listings_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    ...
                                    publisher_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    publisher_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
