...
def get_app_catalog_subscriptions(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str listing_id: A filter to return only the listings that matches the given listing id.
    """
    __args__ = dict()
...
def get_app_catalog_subscriptions_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
