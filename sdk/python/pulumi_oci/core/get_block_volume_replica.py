...
class GetBlockVolumeReplicaResult:
    ...
    def block_volume_replica_id(self) -> builtins.str:
...
def get_block_volume_replica(block_volume_replica_id: Optional[builtins.str] = None,
    ...
    :param builtins.str block_volume_replica_id: The OCID of the block volume replica.
    """
    __args__ = dict()
...
def get_block_volume_replica_output(block_volume_replica_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetBlockVolumeReplicaResult(
        ...
        block_volume_id=pulumi.get(__response__, 'block_volume_id'),
        block_volume_replica_id=pulumi.get(__response__, 'block_volume_replica_id'),
