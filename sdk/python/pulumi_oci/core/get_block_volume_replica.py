...
class GetBlockVolumeReplicaResult:
    ...
    def block_volume_replica_id(self) -> _builtins.str:
...
def get_block_volume_replica(block_volume_replica_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str block_volume_replica_id: The OCID of the block volume replica.
    """
    __args__ = dict()
