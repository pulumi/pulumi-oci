...
def get_block_volume_replicas(availability_domain: Optional[builtins.str] = None,
...
def get_block_volume_replicas_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
