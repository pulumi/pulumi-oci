...
class GetBootVolumeResult:
    ...
    def auto_tuned_vpus_per_gb(self) -> builtins.str:
        """
    ...
    def boot_volume_replicas_deletion(self) -> builtins.bool:
    ...
    def is_auto_tune_enabled(self) -> builtins.bool:
        """
    ...
    def vpus_per_gb(self) -> builtins.str:
        """
    ...
    def xrc_kms_key_id(self) -> builtins.str:
...
def get_boot_volume(boot_volume_id: Optional[builtins.str] = None,
...
def get_boot_volume_output(boot_volume_id: Optional[pulumi.Input[builtins.str]] = None,
