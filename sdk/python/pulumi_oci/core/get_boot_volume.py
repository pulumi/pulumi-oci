...
class GetBootVolumeResult:
    ...
    """
    def __init__(__self__, auto_tuned_vpus_per_gb=None, availability_domain=None, backup_policy_id=None, boot_volume_id=None, boot_volume_replicas=None, boot_volume_replicas_deletion=None, compartment_id=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, image_id=None, is_auto_tune_enabled=None, is_hydrated=None, kms_key_id=None, size_in_gbs=None, size_in_mbs=None, source_details=None, state=None, system_tags=None, time_created=None, volume_group_id=None, vpus_per_gb=None):
...
def get_boot_volume(boot_volume_id: Optional[str] = None,
    ...
    return AwaitableGetBootVolumeResult(
        ...
        boot_volume_replicas_deletion=__ret__.boot_volume_replicas_deletion,
...
@_utilities.lift_output_func(get_boot_volume)
