...
def get_boot_volume_attachments(availability_domain: Optional[builtins.str] = None,
...
def get_boot_volume_attachments_output(availability_domain: Optional[pulumi.Input[builtins.str]] = None,
                                       boot_volume_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
