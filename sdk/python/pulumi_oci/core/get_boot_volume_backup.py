...
def get_boot_volume_backup(boot_volume_backup_id: Optional[str] = None,
    ...
    test_boot_volume_backup = oci.Core.get_boot_volume_backup(boot_volume_backup_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
    ```
    ...
    return AwaitableGetBootVolumeBackupResult(
        boot_volume_backup_id=__ret__.boot_volume_backup_id,
        ...
        time_request_received=__ret__.time_request_received,
        type=__ret__.type,
        unique_size_in_gbs=__ret__.unique_size_in_gbs)
