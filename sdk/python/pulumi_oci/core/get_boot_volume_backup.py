...
class GetBootVolumeBackupResult:
    ...
    def boot_volume_backup_id(self) -> builtins.str:
    ...
    def source_boot_volume_backup_id(self) -> builtins.str:
        """
    ...
    def time_request_received(self) -> builtins.str:
        """
    ...
    def unique_size_in_gbs(self) -> builtins.str:
        """
...
def get_boot_volume_backup(boot_volume_backup_id: Optional[builtins.str] = None,
    ...
    :param builtins.str boot_volume_backup_id: The OCID of the boot volume backup.
    """
    __args__ = dict()
...
def get_boot_volume_backup_output(boot_volume_backup_id: Optional[pulumi.Input[builtins.str]] = None,
