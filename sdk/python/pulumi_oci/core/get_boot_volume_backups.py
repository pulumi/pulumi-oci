...
class GetBootVolumeBackupsResult:
    ...
    def source_boot_volume_backup_id(self) -> Optional[builtins.str]:
        """
...
def get_boot_volume_backups(boot_volume_id: Optional[builtins.str] = None,
                            ...
                            source_boot_volume_backup_id: Optional[builtins.str] = None,
    ...
    :param builtins.str boot_volume_id: The OCID of the boot volume.
    ...
    :param builtins.str source_boot_volume_backup_id: A filter to return only resources that originated from the given source boot volume backup.
...
def get_boot_volume_backups_output(boot_volume_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                   ...
                                   source_boot_volume_backup_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
