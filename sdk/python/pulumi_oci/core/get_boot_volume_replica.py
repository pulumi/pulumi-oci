...
class GetBootVolumeReplicaResult:
    ...
    def boot_volume_replica_id(self) -> builtins.str:
...
def get_boot_volume_replica(boot_volume_replica_id: Optional[builtins.str] = None,
    ...
    :param builtins.str boot_volume_replica_id: The OCID of the boot volume replica.
    """
    __args__ = dict()
...
def get_boot_volume_replica_output(boot_volume_replica_id: Optional[pulumi.Input[builtins.str]] = None,
