...
class GetBootVolumeReplicasResult:
    ...
    def volume_group_replica_id(self) -> Optional[builtins.str]:
...
def get_boot_volume_replicas(availability_domain: Optional[builtins.str] = None,
                             ...
                             volume_group_replica_id: Optional[builtins.str] = None,
    ...
    :param builtins.str volume_group_replica_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the volume group replica.
    """
    __args__ = dict()
...
def get_boot_volume_replicas_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    ...
                                    volume_group_replica_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
