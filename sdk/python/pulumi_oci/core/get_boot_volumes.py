...
def get_boot_volumes(availability_domain: Optional[builtins.str] = None,
...
def get_boot_volumes_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
