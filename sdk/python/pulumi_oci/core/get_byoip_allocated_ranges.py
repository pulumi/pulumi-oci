...
def get_byoip_allocated_ranges(byoip_range_id: Optional[builtins.str] = None,
...
def get_byoip_allocated_ranges_output(byoip_range_id: Optional[pulumi.Input[builtins.str]] = None,
