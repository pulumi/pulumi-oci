...
def get_capture_filter(capture_filter_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str capture_filter_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the capture filter.
    """
    __args__ = dict()
