...
def get_capture_filter(capture_filter_id: Optional[builtins.str] = None,
    ...
    :param builtins.str capture_filter_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the capture filter.
    """
    __args__ = dict()
...
def get_capture_filter_output(capture_filter_id: Optional[pulumi.Input[builtins.str]] = None,
