...
def get_capture_filters(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str filter_type: A filter to only return resources that match the given capture filterType. The filterType value is the string representation of enum - VTAP, FLOWLOG.
    :param builtins.str state: A filter to return only resources that match the given capture filter lifecycle state. The state value is case-insensitive.
    """
    __args__ = dict()
...
def get_capture_filters_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                               display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               filter_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
