...
def get_cluster_network_instances(cluster_network_id: Optional[builtins.str] = None,
...
def get_cluster_network_instances_output(cluster_network_id: Optional[pulumi.Input[builtins.str]] = None,
