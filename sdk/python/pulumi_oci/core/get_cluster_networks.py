...
def get_cluster_networks(compartment_id: Optional[builtins.str] = None,
...
def get_cluster_networks_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
