...
def get_cnv_dns_resolver_association(vcn_id: Optional[builtins.str] = None,
...
def get_cnv_dns_resolver_association_output(vcn_id: Optional[pulumi.Input[builtins.str]] = None,
