...
def get_compute_capacity_reservation_instances(availability_domain: Optional[builtins.str] = None,
...
def get_compute_capacity_reservation_instances_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetComputeCapacityReservationInstancesResult(
        ...
        capacity_reservation_instances=pulumi.get(__response__, 'capacity_reservation_instances'),
