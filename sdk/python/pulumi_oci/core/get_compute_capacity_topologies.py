...
def get_compute_capacity_topologies(availability_domain: Optional[builtins.str] = None,
...
def get_compute_capacity_topologies_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
