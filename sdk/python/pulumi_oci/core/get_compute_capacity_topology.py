...
def get_compute_capacity_topology(compute_capacity_topology_id: Optional[builtins.str] = None,
...
def get_compute_capacity_topology_output(compute_capacity_topology_id: Optional[pulumi.Input[builtins.str]] = None,
