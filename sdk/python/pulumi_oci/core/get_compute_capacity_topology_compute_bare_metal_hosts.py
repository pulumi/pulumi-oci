...
class GetComputeCapacityTopologyComputeBareMetalHostsResult:
    ...
    def compute_local_block_id(self) -> Optional[_builtins.str]:
        """
...
def get_compute_capacity_topology_compute_bare_metal_hosts(availability_domain: Optional[_builtins.str] = None,
    ...
    :param _builtins.str compute_local_block_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute local block.
...
def get_compute_capacity_topology_compute_bare_metal_hosts_output(availability_domain: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                                  ...
                                                                  compute_local_block_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
