...
def get_compute_capacity_topology_compute_bare_metal_hosts(availability_domain: Optional[str] = None,
                                                           ...
                                                           filters: Optional[Sequence[pulumi.InputType['GetComputeCapacityTopologyComputeBareMetalHostsFilterArgs']]] = None,
...
@_utilities.lift_output_func(get_compute_capacity_topology_compute_bare_metal_hosts)
def get_compute_capacity_topology_compute_bare_metal_hosts_output(availability_domain: Optional[pulumi.Input[Optional[str]]] = None,
                                                                  ...
                                                                  filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetComputeCapacityTopologyComputeBareMetalHostsFilterArgs']]]]] = None,
