...
def get_compute_capacity_topology_compute_hpc_islands(availability_domain: Optional[builtins.str] = None,
...
def get_compute_capacity_topology_compute_hpc_islands_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
