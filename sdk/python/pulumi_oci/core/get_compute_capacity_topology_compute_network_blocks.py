...
class GetComputeCapacityTopologyComputeNetworkBlocksResult:
    ...
    def compute_capacity_topology_id(self) -> _builtins.str:
        """
...
def get_compute_capacity_topology_compute_network_blocks(availability_domain: Optional[_builtins.str] = None,
    ...
    :param _builtins.str compute_capacity_topology_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute capacity topology.
...
def get_compute_capacity_topology_compute_network_blocks_output(availability_domain: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetComputeCapacityTopologyComputeNetworkBlocksResult(
        ...
        compute_network_block_collections=pulumi.get(__response__, 'compute_network_block_collections'),
