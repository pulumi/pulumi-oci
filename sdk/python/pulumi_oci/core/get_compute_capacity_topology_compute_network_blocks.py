...
def get_compute_capacity_topology_compute_network_blocks(availability_domain: Optional[builtins.str] = None,
...
def get_compute_capacity_topology_compute_network_blocks_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
