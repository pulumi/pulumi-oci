...
def get_compute_cluster(compute_cluster_id: Optional[builtins.str] = None,
...
def get_compute_cluster_output(compute_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
