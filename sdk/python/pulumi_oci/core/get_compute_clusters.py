...
def get_compute_clusters(availability_domain: Optional[builtins.str] = None,
...
def get_compute_clusters_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
