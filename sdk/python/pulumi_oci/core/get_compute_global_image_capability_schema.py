...
def get_compute_global_image_capability_schema(compute_global_image_capability_schema_id: Optional[builtins.str] = None,
...
def get_compute_global_image_capability_schema_output(compute_global_image_capability_schema_id: Optional[pulumi.Input[builtins.str]] = None,
