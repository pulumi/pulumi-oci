...
def get_compute_global_image_capability_schemas(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str compartment_id: A filter to return only resources that match the given compartment OCID exactly.
...
def get_compute_global_image_capability_schemas_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
