...
class GetComputeGlobalImageCapabilitySchemasVersionsResult:
    ...
    def compute_global_image_capability_schema_id(self) -> builtins.str:
        """
...
def get_compute_global_image_capability_schemas_versions(compute_global_image_capability_schema_id: Optional[builtins.str] = None,
    ...
    :param builtins.str compute_global_image_capability_schema_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute global image capability schema
...
def get_compute_global_image_capability_schemas_versions_output(compute_global_image_capability_schema_id: Optional[pulumi.Input[builtins.str]] = None,
