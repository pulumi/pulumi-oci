...
class GetComputeGpuMemoryClusterResult:
    ...
    def compute_gpu_memory_cluster_id(self) -> builtins.str:
    ...
    def gpu_memory_fabric_id(self) -> builtins.str:
        """
...
def get_compute_gpu_memory_cluster(compute_gpu_memory_cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str compute_gpu_memory_cluster_id: The OCID of the compute GPU memory cluster.
    """
    __args__ = dict()
...
def get_compute_gpu_memory_cluster_output(compute_gpu_memory_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
