...
class GetComputeGpuMemoryClustersResult:
    ...
    def compute_cluster_id(self) -> Optional[builtins.str]:
        """
    ...
    def compute_gpu_memory_cluster_id(self) -> Optional[builtins.str]:
...
def get_compute_gpu_memory_clusters(availability_domain: Optional[builtins.str] = None,
                                    compartment_id: Optional[builtins.str] = None,
                                    compute_cluster_id: Optional[builtins.str] = None,
                                    compute_gpu_memory_cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str compute_cluster_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute cluster. A [compute cluster](https://docs.cloud.oracle.com/iaas/Content/Compute/Tasks/compute-clusters.htm) is a remote direct memory access (RDMA) network group.
    :param builtins.str compute_gpu_memory_cluster_id: A filter to return only the listings that matches the given GPU memory cluster id.
...
def get_compute_gpu_memory_clusters_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                           compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                           compute_cluster_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                           compute_gpu_memory_cluster_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
