...
def get_compute_gpu_memory_fabrics(availability_domain: Optional[builtins.str] = None,
                                   compartment_id: Optional[builtins.str] = None,
                                   compute_gpu_memory_fabric_health: Optional[builtins.str] = None,
                                   compute_gpu_memory_fabric_id: Optional[builtins.str] = None,
                                   compute_gpu_memory_fabric_lifecycle_state: Optional[builtins.str] = None,
    ...
    :param builtins.str compute_gpu_memory_fabric_health: A filter to return ComputeGpuMemoryFabricSummary resources that match the given fabric health.
    :param builtins.str compute_gpu_memory_fabric_id: A filter to return only the listings that matches the given GPU memory fabric id.
    :param builtins.str compute_gpu_memory_fabric_lifecycle_state: A filter to return ComputeGpuMemoryFabricSummary resources that match the given lifecycle state.
...
def get_compute_gpu_memory_fabrics_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                          compute_gpu_memory_fabric_health: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          compute_gpu_memory_fabric_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          compute_gpu_memory_fabric_lifecycle_state: Optional[pulumi.Input[Optional[builtins.str]]] = None,
