...
class GetComputeHostResult:
    ...
    def additional_data(self) -> builtins.str:
        """
    ...
    def impacted_component_details(self) -> builtins.str:
        """
    ...
    def network_block_id(self) -> builtins.str:
        """
...
def get_compute_host(compute_host_id: Optional[builtins.str] = None,
    ...
    :param builtins.str compute_host_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute host.
    """
    __args__ = dict()
