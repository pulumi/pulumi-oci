...
class GetComputeImageCapabilitySchemaResult:
    ...
    def compute_global_image_capability_schema_version_name(self) -> builtins.str:
        """
    ...
    def compute_image_capability_schema_id(self) -> builtins.str:
    ...
    def is_merge_enabled(self) -> Optional[builtins.str]:
        return pulumi.get(self, "is_merge_enabled")

    @property
    @pulumi.getter(name="schemaData")
    def schema_data(self) -> Mapping[str, builtins.str]:
        """
...
def get_compute_image_capability_schema(compute_image_capability_schema_id: Optional[builtins.str] = None,
                                        is_merge_enabled: Optional[builtins.str] = None,
    ...
    :param builtins.str compute_image_capability_schema_id: The id of the compute image capability schema or the image ocid
    :param builtins.str is_merge_enabled: Merge the image capability schema with the global image capability schema
    """
    __args__ = dict()
...
def get_compute_image_capability_schema_output(compute_image_capability_schema_id: Optional[pulumi.Input[builtins.str]] = None,
                                               is_merge_enabled: Optional[pulumi.Input[Optional[builtins.str]]] = None,
