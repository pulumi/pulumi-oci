...
def get_compute_image_capability_schemas(compartment_id: Optional[builtins.str] = None,
...
def get_compute_image_capability_schemas_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
