...
def get_console_histories(availability_domain: Optional[builtins.str] = None,
...
def get_console_histories_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
