...
class GetConsoleHistoryDataResult:
    ...
    def console_history_id(self) -> builtins.str:
...
def get_console_history_data(console_history_id: Optional[builtins.str] = None,
    ...
    :param builtins.str console_history_id: The OCID of the console history.
    :param builtins.int length: Length of the snapshot data to retrieve. Cannot be less than 10240.
    :param builtins.int offset: Offset of the snapshot data to retrieve.
    """
    __args__ = dict()
...
def get_console_history_data_output(console_history_id: Optional[pulumi.Input[builtins.str]] = None,
                                    length: Optional[pulumi.Input[Optional[builtins.int]]] = None,
