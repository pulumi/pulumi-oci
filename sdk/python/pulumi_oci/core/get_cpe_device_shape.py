...
class GetCpeDeviceShapeResult:
    ...
    def cpe_device_shape_id(self) -> _builtins.str:
        """
...
def get_cpe_device_shape(cpe_device_shape_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cpe_device_shape_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the CPE device shape.
    """
    __args__ = dict()
...
def get_cpe_device_shape_output(cpe_device_shape_id: Optional[pulumi.Input[_builtins.str]] = None,
