...
def get_cross_connect(cross_connect_id: Optional[str] = None,
    ...
    return AwaitableGetCrossConnectResult(
        ...
        far_cross_connect_or_cross_connect_group_id=__ret__.far_cross_connect_or_cross_connect_group_id,
        freeform_tags=__ret__.freeform_tags,
        id=__ret__.id,
        is_active=__ret__.is_active,
        location_name=__ret__.location_name,
        macsec_properties=__ret__.macsec_properties,
        near_cross_connect_or_cross_connect_group_id=__ret__.near_cross_connect_or_cross_connect_group_id,
        ...
        port_speed_shape_name=__ret__.port_speed_shape_name,
        state=__ret__.state,
