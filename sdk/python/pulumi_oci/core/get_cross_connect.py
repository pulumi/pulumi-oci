...
class GetCrossConnectResult:
    ...
    def far_cross_connect_or_cross_connect_group_id(self) -> _builtins.str:
    ...
    def near_cross_connect_or_cross_connect_group_id(self) -> _builtins.str:
    ...
    def port_speed_shape_name(self) -> _builtins.str:
        """
...
def get_cross_connect(cross_connect_id: Optional[_builtins.str] = None,
...
def get_cross_connect_output(cross_connect_id: Optional[pulumi.Input[_builtins.str]] = None,
