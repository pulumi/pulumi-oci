...
def get_cross_connect_groups(compartment_id: Optional[str] = None,
    ...
    test_cross_connect_groups = oci.Core.get_cross_connect_groups(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
