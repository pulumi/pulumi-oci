...
def get_cross_connect_groups(compartment_id: Optional[builtins.str] = None,
                             display_name: Optional[builtins.str] = None,
                             filters: Optional[Sequence[Union['GetCrossConnectGroupsFilterArgs', 'GetCrossConnectGroupsFilterArgsDict']]] = None,
...
def get_cross_connect_groups_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Core/getCrossConnectGroups:getCrossConnectGroups', __args__, opts=opts, typ=GetCrossConnectGroupsResult)
    return __ret__.apply(lambda __response__: GetCrossConnectGroupsResult(
        compartment_id=pulumi.get(__response__, 'compartment_id'),
        cross_connect_groups=pulumi.get(__response__, 'cross_connect_groups'),
