...
def get_cross_connect_locations(compartment_id: Optional[builtins.str] = None,
...
def get_cross_connect_locations_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
