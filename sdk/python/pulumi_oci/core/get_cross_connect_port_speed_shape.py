...
def get_cross_connect_port_speed_shape(compartment_id: Optional[builtins.str] = None,
...
def get_cross_connect_port_speed_shape_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
