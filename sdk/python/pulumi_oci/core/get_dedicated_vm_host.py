...
def get_dedicated_vm_host(dedicated_vm_host_id: Optional[builtins.str] = None,
...
def get_dedicated_vm_host_output(dedicated_vm_host_id: Optional[pulumi.Input[builtins.str]] = None,
