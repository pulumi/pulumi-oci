...
def get_dedicated_vm_host_instances(availability_domain: Optional[builtins.str] = None,
...
def get_dedicated_vm_host_instances_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
