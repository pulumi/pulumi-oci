...
def get_dedicated_vm_host_shapes(availability_domain: Optional[builtins.str] = None,
...
def get_dedicated_vm_host_shapes_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
