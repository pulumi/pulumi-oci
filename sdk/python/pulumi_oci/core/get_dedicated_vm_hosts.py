...
class GetDedicatedVmHostsResult:
    ...
    def instance_shape_name(self) -> Optional[builtins.str]:
        return pulumi.get(self, "instance_shape_name")

    @property
    @pulumi.getter(name="remainingMemoryInGbsGreaterThanOrEqualTo")
    def remaining_memory_in_gbs_greater_than_or_equal_to(self) -> Optional[builtins.float]:
    ...
    def remaining_ocpus_greater_than_or_equal_to(self) -> Optional[builtins.float]:
...
def get_dedicated_vm_hosts(availability_domain: Optional[builtins.str] = None,
                           ...
                           instance_shape_name: Optional[builtins.str] = None,
                           remaining_memory_in_gbs_greater_than_or_equal_to: Optional[builtins.float] = None,
                           remaining_ocpus_greater_than_or_equal_to: Optional[builtins.float] = None,
    ...
    :param builtins.str instance_shape_name: The name for the instance's shape.
    :param builtins.float remaining_memory_in_gbs_greater_than_or_equal_to: The remaining memory of the dedicated VM host, in GBs.
    :param builtins.float remaining_ocpus_greater_than_or_equal_to: The available OCPUs of the dedicated VM host.
...
def get_dedicated_vm_hosts_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  ...
                                  instance_shape_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  remaining_memory_in_gbs_greater_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.float]]] = None,
                                  remaining_ocpus_greater_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.float]]] = None,
