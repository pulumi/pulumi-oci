...
def get_drg_attachments(attachment_type: Optional[_builtins.str] = None,
    ...
    :param _builtins.str attachment_type: The type for the network resource attached to the DRG.
