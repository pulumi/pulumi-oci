...
def get_drg_route_distribution(drg_route_distribution_id: Optional[builtins.str] = None,
...
def get_drg_route_distribution_output(drg_route_distribution_id: Optional[pulumi.Input[builtins.str]] = None,
