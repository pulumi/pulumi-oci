...
def get_drg_route_distributions(display_name: Optional[builtins.str] = None,
    ...
    :param builtins.str state: A filter that only returns resources that match the specified lifecycle state. The value is case insensitive.
    """
    __args__ = dict()
...
def get_drg_route_distributions_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
