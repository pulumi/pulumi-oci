...
class GetDrgRouteRuleResult:
    ...
    def drg_route_table_id(self) -> builtins.str:
    ...
    def import_drg_route_distribution_id(self) -> builtins.str:
        """
    ...
    def is_ecmp_enabled(self) -> builtins.bool:
        """
    ...
    def remove_import_trigger(self) -> builtins.bool:
...
def get_drg_route_rule(drg_route_table_id: Optional[builtins.str] = None,
    ...
    :param builtins.str drg_route_table_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DRG route table.
    """
    __args__ = dict()
...
def get_drg_route_rule_output(drg_route_table_id: Optional[pulumi.Input[builtins.str]] = None,
