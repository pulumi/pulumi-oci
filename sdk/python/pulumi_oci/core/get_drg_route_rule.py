...
class GetDrgRouteRuleResult:
    ...
    def drg_route_table_id(self) -> _builtins.str:
    ...
    def import_drg_route_distribution_id(self) -> _builtins.str:
        """
    ...
    def is_ecmp_enabled(self) -> _builtins.bool:
        """
    ...
    def remove_import_trigger(self) -> _builtins.bool:
...
def get_drg_route_rule(drg_route_table_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str drg_route_table_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DRG route table.
    """
    __args__ = dict()
