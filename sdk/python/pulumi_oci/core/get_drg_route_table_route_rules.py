...
def get_drg_route_table_route_rules(drg_route_table_id: Optional[builtins.str] = None,
    ...
    :param builtins.str route_type: Static routes are specified through the DRG route table API. Dynamic routes are learned by the DRG from the DRG attachments through various routing protocols.
    """
    __args__ = dict()
...
def get_drg_route_table_route_rules_output(drg_route_table_id: Optional[pulumi.Input[builtins.str]] = None,
                                           ...
                                           route_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
