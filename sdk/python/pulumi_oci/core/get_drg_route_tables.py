...
class GetDrgRouteTablesResult:
    ...
    def import_drg_route_distribution_id(self) -> Optional[builtins.str]:
        """
...
def get_drg_route_tables(display_name: Optional[builtins.str] = None,
                         ...
                         import_drg_route_distribution_id: Optional[builtins.str] = None,
    ...
    :param builtins.str import_drg_route_distribution_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the import route distribution.
    :param builtins.str state: A filter that only returns matches for the specified lifecycle state. The value is case insensitive.
    """
    __args__ = dict()
...
def get_drg_route_tables_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                ...
                                import_drg_route_distribution_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
