...
def get_fast_connect_provider_services(compartment_id: Optional[builtins.str] = None,
...
def get_fast_connect_provider_services_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
