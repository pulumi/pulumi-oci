...
def get_image(image_id: Optional[str] = None,
    ...
    return AwaitableGetImageResult(
        agent_features=__ret__.agent_features,
        base_image_id=__ret__.base_image_id,
        billable_size_in_gbs=__ret__.billable_size_in_gbs,
        compartment_id=__ret__.compartment_id,
        create_image_allowed=__ret__.create_image_allowed,
        defined_tags=__ret__.defined_tags,
        display_name=__ret__.display_name,
        freeform_tags=__ret__.freeform_tags,
        id=__ret__.id,
        image_id=__ret__.image_id,
        image_source_details=__ret__.image_source_details,
