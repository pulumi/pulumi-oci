...
def get_image_shape(image_id: Optional[builtins.str] = None,
    ...
    :param builtins.str image_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the image.
    :param builtins.str shape_name: Shape name.
    """
    __args__ = dict()
...
def get_image_shape_output(image_id: Optional[pulumi.Input[builtins.str]] = None,
