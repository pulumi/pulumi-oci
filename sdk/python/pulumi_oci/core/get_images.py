...
def get_images(compartment_id: Optional[builtins.str] = None,
    ...
    **Caution:** Platform images are refreshed regularly. When new images are released, older versions are replaced.
    ...
    :param builtins.str operating_system: The image's operating system.  Example: `Oracle Linux`
    :param builtins.str operating_system_version: The image's operating system version.  Example: `7.2`
    :param builtins.str shape: Shape name.
    :param builtins.str sort_by: Sort the resources returned, by creation time or display name. Example `TIMECREATED` or `DISPLAYNAME`.
    :param builtins.str sort_order: The sort order to use, either ascending (`ASC`) or descending (`DESC`).
...
def get_images_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                      ...
                      operating_system_version: Optional[pulumi.Input[Optional[builtins.str]]] = None,
