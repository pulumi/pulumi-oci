...
class GetInstanceResult:
    ...
    def is_cross_numa_node(self) -> builtins.bool:
        """
    ...
    def launch_mode(self) -> builtins.str:
        """
    ...
    def preserve_data_volumes_created_at_launch(self) -> builtins.bool:
    ...
    def security_attributes_state(self) -> builtins.str:
        """
    ...
    def time_maintenance_reboot_due(self) -> builtins.str:
        """
    ...
    def update_operation_constraint(self) -> builtins.str:
...
def get_instance(instance_id: Optional[builtins.str] = None,
    ...
    **Note:** To retrieve public and private IP addresses for an instance, use the [ListVnicAttachments](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/VnicAttachment/ListVnicAttachments)
    ...
    :param builtins.str instance_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the instance.
    """
    __args__ = dict()
