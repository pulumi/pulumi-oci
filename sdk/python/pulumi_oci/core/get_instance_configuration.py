...
class GetInstanceConfigurationResult:
    ...
    def deferred_fields(self) -> Sequence[builtins.str]:
        """
...
def get_instance_configuration(instance_configuration_id: Optional[builtins.str] = None,
    ...
    :param builtins.str instance_configuration_id: The OCID of the instance configuration.
    """
    __args__ = dict()
...
def get_instance_configuration_output(instance_configuration_id: Optional[pulumi.Input[builtins.str]] = None,
