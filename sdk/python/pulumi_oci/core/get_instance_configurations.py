...
def get_instance_configurations(compartment_id: Optional[builtins.str] = None,
...
def get_instance_configurations_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
