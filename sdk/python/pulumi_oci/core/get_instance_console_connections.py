...
def get_instance_console_connections(compartment_id: Optional[builtins.str] = None,
...
def get_instance_console_connections_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
