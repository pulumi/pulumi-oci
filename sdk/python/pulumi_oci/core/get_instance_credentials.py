...
def get_instance_credentials(instance_id: Optional[builtins.str] = None,
...
def get_instance_credentials_output(instance_id: Optional[pulumi.Input[builtins.str]] = None,
