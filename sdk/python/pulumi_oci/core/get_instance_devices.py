...
class GetInstanceDevicesResult:
    ...
    def is_available(self) -> Optional[builtins.bool]:
        """
...
def get_instance_devices(filters: Optional[Sequence[Union['GetInstanceDevicesFilterArgs', 'GetInstanceDevicesFilterArgsDict']]] = None,
                         ...
                         is_available: Optional[builtins.bool] = None,
    ...
    :param builtins.bool is_available: A filter to return only available devices or only used devices.
    :param builtins.str name: A filter to return only devices that match the given name exactly.
    """
    __args__ = dict()
...
def get_instance_devices_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetInstanceDevicesFilterArgs', 'GetInstanceDevicesFilterArgsDict']]]]] = None,
                                ...
                                is_available: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
