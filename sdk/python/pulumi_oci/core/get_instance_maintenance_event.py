...
class GetInstanceMaintenanceEventResult:
    ...
    def alternative_resolution_action(self) -> builtins.str:
        return pulumi.get(self, "alternative_resolution_action")

    @property
    @pulumi.getter(name="alternativeResolutionActions")
    def alternative_resolution_actions(self) -> Sequence[builtins.str]:
        """
    ...
    def can_delete_local_storage(self) -> builtins.bool:
        """
    ...
    def can_reschedule(self) -> builtins.bool:
        """
    ...
    def correlation_token(self) -> builtins.str:
        """
    ...
    def estimated_duration(self) -> builtins.str:
        """
    ...
    def instance_action(self) -> builtins.str:
        """
    ...
    def instance_maintenance_event_id(self) -> builtins.str:
        return pulumi.get(self, "instance_maintenance_event_id")

    @property
    @pulumi.getter(name="maintenanceCategory")
    def maintenance_category(self) -> builtins.str:
        """
    ...
    def start_window_duration(self) -> builtins.str:
        """
    ...
    def time_hard_due_date(self) -> builtins.str:
        """
    ...
    def time_window_start(self) -> builtins.str:
        """
...
def get_instance_maintenance_event(instance_maintenance_event_id: Optional[builtins.str] = None,
    ...
    :param builtins.str instance_maintenance_event_id: The OCID of the instance maintenance event.
    """
    __args__ = dict()
...
def get_instance_maintenance_event_output(instance_maintenance_event_id: Optional[pulumi.Input[builtins.str]] = None,
