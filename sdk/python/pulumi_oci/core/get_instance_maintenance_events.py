...
class GetInstanceMaintenanceEventsResult:
    ...
    def correlation_token(self) -> Optional[builtins.str]:
        """
    ...
    def instance_action(self) -> Optional[builtins.str]:
        """
    ...
    def time_window_start_greater_than_or_equal_to(self) -> Optional[builtins.str]:
        return pulumi.get(self, "time_window_start_greater_than_or_equal_to")

    @property
    @pulumi.getter(name="timeWindowStartLessThanOrEqualTo")
    def time_window_start_less_than_or_equal_to(self) -> Optional[builtins.str]:
...
def get_instance_maintenance_events(compartment_id: Optional[builtins.str] = None,
                                    correlation_token: Optional[builtins.str] = None,
                                    filters: Optional[Sequence[Union['GetInstanceMaintenanceEventsFilterArgs', 'GetInstanceMaintenanceEventsFilterArgsDict']]] = None,
                                    instance_action: Optional[builtins.str] = None,
                                    instance_id: Optional[builtins.str] = None,
                                    state: Optional[builtins.str] = None,
                                    time_window_start_greater_than_or_equal_to: Optional[builtins.str] = None,
                                    time_window_start_less_than_or_equal_to: Optional[builtins.str] = None,
    ...
    :param builtins.str correlation_token: A filter to only return resources that have a matching correlationToken.
    :param builtins.str instance_action: A filter to only return resources that match the given instance action.
    ...
    :param builtins.str time_window_start_greater_than_or_equal_to: Starting range to return the maintenances which are not completed (date-time is in [RFC3339](https://tools.ietf.org/html/rfc3339) format).
    :param builtins.str time_window_start_less_than_or_equal_to: Ending range to return the maintenances which are not completed (date-time is in [RFC3339](https://tools.ietf.org/html/rfc3339) format).
    """
    __args__ = dict()
...
def get_instance_maintenance_events_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                           correlation_token: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                           ...
                                           instance_action: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                           instance_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                           state: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                           time_window_start_greater_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                           time_window_start_less_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
