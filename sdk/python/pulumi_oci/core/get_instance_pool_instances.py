...
def get_instance_pool_instances(compartment_id: Optional[builtins.str] = None,
...
def get_instance_pool_instances_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
