...
class GetInstancePoolLoadBalancerAttachmentResult:
    ...
    def instance_pool_load_balancer_attachment_id(self) -> _builtins.str:
    ...
    def vnic_selection(self) -> _builtins.str:
        """
...
def get_instance_pool_load_balancer_attachment(instance_pool_id: Optional[_builtins.str] = None,
                                               instance_pool_load_balancer_attachment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str instance_pool_load_balancer_attachment_id: The OCID of the load balancer attachment.
    """
    __args__ = dict()
