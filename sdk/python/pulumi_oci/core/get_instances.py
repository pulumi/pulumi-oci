...
def get_instances(availability_domain: Optional[builtins.str] = None,
    ...
    **Note:** To retrieve public and private IP addresses for an instance, use the [ListVnicAttachments](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/VnicAttachment/ListVnicAttachments)
    ...
    :param builtins.str capacity_reservation_id: The OCID of the compute capacity reservation.
...
def get_instances_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         capacity_reservation_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
