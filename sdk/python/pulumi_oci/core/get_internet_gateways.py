...
def get_internet_gateways(compartment_id: Optional[builtins.str] = None,
...
def get_internet_gateways_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
