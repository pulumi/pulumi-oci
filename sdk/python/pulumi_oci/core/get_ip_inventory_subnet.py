...
class GetIpInventorySubnetResult:
    ...
    def ip_inventory_subnet_count(self) -> builtins.int:
        """
...
def get_ip_inventory_subnet(subnet_id: Optional[builtins.str] = None,
...
def get_ip_inventory_subnet_output(subnet_id: Optional[pulumi.Input[builtins.str]] = None,
