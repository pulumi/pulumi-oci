...
class GetIpInventorySubnetCidrResult:
    ...
    def ip_inventory_subnet_cidr_count(self) -> builtins.int:
        """
...
def get_ip_inventory_subnet_cidr(subnet_id: Optional[builtins.str] = None,
    ...
    :param builtins.str subnet_id: Specify the [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet.
    """
    __args__ = dict()
...
def get_ip_inventory_subnet_cidr_output(subnet_id: Optional[pulumi.Input[builtins.str]] = None,
