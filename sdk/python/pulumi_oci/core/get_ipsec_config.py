...
def get_ipsec_config(filters: Optional[Sequence[pulumi.InputType['GetIpsecConfigFilterArgs']]] = None,
    ...
    * [GetIPSecConnectionTunnelSharedSecret](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/IPSecConnectionTunnelSharedSecret/GetIPSecConnectionTunnelSharedSecret)
    ...
    test_ip_sec_connection_device_config = oci.Core.get_ipsec_config(ipsec_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
    ```
