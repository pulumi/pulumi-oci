...
class GetIpsecConnectionTunnelResult:
    ...
    def associated_virtual_circuits(self) -> Sequence[builtins.str]:
    ...
    def dpd_mode(self) -> builtins.str:
        """
    ...
    def dpd_timeout_in_sec(self) -> builtins.int:
        """
    ...
    def nat_translation_enabled(self) -> builtins.str:
        """
    ...
    def oracle_can_initiate(self) -> builtins.str:
        """
...
def get_ipsec_connection_tunnel(ipsec_id: Optional[builtins.str] = None,
    ...
    :param builtins.str ipsec_id: The OCID of the IPSec connection.
    :param builtins.str tunnel_id: The OCID of the IPSec connection's tunnel.
    """
    __args__ = dict()
...
def get_ipsec_connection_tunnel_output(ipsec_id: Optional[pulumi.Input[builtins.str]] = None,
