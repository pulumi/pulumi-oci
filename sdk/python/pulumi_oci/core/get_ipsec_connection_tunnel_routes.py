...
class GetIpsecConnectionTunnelRoutesResult:
    ...
    @_builtins.property
    @pulumi.getter
    def advertiser(self) -> Optional[_builtins.str]:
        """
...
def get_ipsec_connection_tunnel_routes(advertiser: Optional[_builtins.str] = None,
    ...
    :param _builtins.str advertiser: Specifies the advertiser of the routes. If set to `ORACLE`, this returns only the routes advertised by Oracle. When set to `CUSTOMER`, this returns only the routes advertised by the CPE.
...
def get_ipsec_connection_tunnel_routes_output(advertiser: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
