...
class GetIpsecConnectionsResult:
    ...
    def cpe_id(self) -> Optional[_builtins.str]:
        """
...
def get_ipsec_connections(compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cpe_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the CPE.
...
def get_ipsec_connections_output(compartment_id: Optional[pulumi.Input[_builtins.str]] = None,
                                 cpe_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
