...
class GetIpsecConnectionsResult:
    ...
    def cpe_id(self) -> Optional[builtins.str]:
        """
...
def get_ipsec_connections(compartment_id: Optional[builtins.str] = None,
                          cpe_id: Optional[builtins.str] = None,
    ...
    :param builtins.str cpe_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the CPE.
...
def get_ipsec_connections_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                 cpe_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
