...
def get_ipv6(ipv6id: Optional[builtins.str] = None,
    ...
    :param builtins.str ipv6id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the IPv6.
    """
    __args__ = dict()
...
def get_ipv6_output(ipv6id: Optional[pulumi.Input[builtins.str]] = None,
