...
class GetLetterOfAuthorityResult:
    ...
    def authorized_entity_name(self) -> builtins.str:
        """
    ...
    def circuit_type(self) -> builtins.str:
        """
    ...
    def cross_connect_id(self) -> builtins.str:
        """
    ...
    def facility_location(self) -> builtins.str:
        """
...
def get_letter_of_authority(cross_connect_id: Optional[builtins.str] = None,
    ...
    :param builtins.str cross_connect_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the cross-connect.
    """
    __args__ = dict()
...
def get_letter_of_authority_output(cross_connect_id: Optional[pulumi.Input[builtins.str]] = None,
