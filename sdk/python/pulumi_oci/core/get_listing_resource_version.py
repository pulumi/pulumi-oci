...
class GetListingResourceVersionResult:
    ...
    def accessible_ports(self) -> Sequence[builtins.int]:
        return pulumi.get(self, "accessible_ports")

    @property
    @pulumi.getter(name="allowedActions")
    def allowed_actions(self) -> Sequence[builtins.str]:
    ...
    def compatible_shapes(self) -> Sequence[builtins.str]:
    ...
    def listing_resource_id(self) -> builtins.str:
        return pulumi.get(self, "listing_resource_id")

    @property
    @pulumi.getter(name="listingResourceVersion")
    def listing_resource_version(self) -> builtins.str:
...
def get_listing_resource_version(listing_id: Optional[builtins.str] = None,
...
def get_listing_resource_version_output(listing_id: Optional[pulumi.Input[builtins.str]] = None,
