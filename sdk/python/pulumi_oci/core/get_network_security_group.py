...
def get_network_security_group(network_security_group_id: Optional[builtins.str] = None,
...
def get_network_security_group_output(network_security_group_id: Optional[pulumi.Input[builtins.str]] = None,
