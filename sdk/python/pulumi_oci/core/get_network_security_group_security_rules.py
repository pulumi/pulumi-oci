...
def get_network_security_group_security_rules(direction: Optional[builtins.str] = None,
    ...
    :param builtins.str direction: Direction of the security rule. Set to `EGRESS` for rules that allow outbound IP packets, or `INGRESS` for rules that allow inbound IP packets.
    :param builtins.str network_security_group_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the network security group.
    """
    __args__ = dict()
...
def get_network_security_group_security_rules_output(direction: Optional[pulumi.Input[Optional[builtins.str]]] = None,
