...
def get_network_security_groups(compartment_id: Optional[builtins.str] = None,
...
def get_network_security_groups_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
