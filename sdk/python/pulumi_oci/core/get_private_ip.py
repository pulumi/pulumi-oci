...
class GetPrivateIpResult:
    ...
    def private_ip_id(self) -> builtins.str:
...
def get_private_ip(private_ip_id: Optional[builtins.str] = None,
    ...
    :param builtins.str private_ip_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the private IP or IPv6.
    """
    __args__ = dict()
...
def get_private_ip_output(private_ip_id: Optional[pulumi.Input[builtins.str]] = None,
