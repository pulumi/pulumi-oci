...
class GetPublicIpPoolResult:
    ...
    def public_ip_pool_id(self) -> builtins.str:
...
def get_public_ip_pool(public_ip_pool_id: Optional[builtins.str] = None,
    ...
    :param builtins.str public_ip_pool_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the public IP pool.
    """
    __args__ = dict()
...
def get_public_ip_pool_output(public_ip_pool_id: Optional[pulumi.Input[builtins.str]] = None,
