...
def get_public_ip_pool(public_ip_pool_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str public_ip_pool_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the public IP pool.
    """
    __args__ = dict()
