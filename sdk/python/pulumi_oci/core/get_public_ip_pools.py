...
class GetPublicIpPoolsResult:
    ...
    def byoip_range_id(self) -> Optional[builtins.str]:
...
def get_public_ip_pools(byoip_range_id: Optional[builtins.str] = None,
    ...
    :param builtins.str byoip_range_id: A filter to return only resources that match the given BYOIP CIDR block.
...
def get_public_ip_pools_output(byoip_range_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
