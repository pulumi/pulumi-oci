...
class GetPublicIpsResult:
    ...
    def public_ip_pool_id(self) -> Optional[builtins.str]:
        """
...
def get_public_ips(availability_domain: Optional[builtins.str] = None,
                   ...
                   public_ip_pool_id: Optional[builtins.str] = None,
    ...
    **Note:** An ephemeral public IP assigned to a private IP
    ...
    :param builtins.str lifetime: A filter to return only public IPs that match given lifetime.
    :param builtins.str public_ip_pool_id: A filter to return only resources that belong to the given public IP pool.
    :param builtins.str scope: Whether the public IP is regional or specific to a particular availability domain.
...
def get_public_ips_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                          ...
                          public_ip_pool_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
