...
def get_security_lists(compartment_id: Optional[builtins.str] = None,
...
def get_security_lists_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Core/getSecurityLists:getSecurityLists', __args__, opts=opts, typ=GetSecurityListsResult)
    return __ret__.apply(lambda __response__: GetSecurityListsResult(
        compartment_id=pulumi.get(__response__, 'compartment_id'),
        display_name=pulumi.get(__response__, 'display_name'),
        filters=pulumi.get(__response__, 'filters'),
        id=pulumi.get(__response__, 'id'),
        security_lists=pulumi.get(__response__, 'security_lists'),
