...
def get_service_gateways(compartment_id: Optional[builtins.str] = None,
...
def get_service_gateways_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
