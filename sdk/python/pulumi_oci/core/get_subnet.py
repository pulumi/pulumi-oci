...
def get_subnet(subnet_id: Optional[str] = None,
    ...
    return AwaitableGetSubnetResult(
        ...
        ipv6virtual_router_ip=__ret__.ipv6virtual_router_ip,
        prohibit_internet_ingress=__ret__.prohibit_internet_ingress,
        prohibit_public_ip_on_vnic=__ret__.prohibit_public_ip_on_vnic,
        route_table_id=__ret__.route_table_id,
        security_list_ids=__ret__.security_list_ids,
        state=__ret__.state,
        subnet_domain_name=__ret__.subnet_domain_name,
        subnet_id=__ret__.subnet_id,
        time_created=__ret__.time_created,
        vcn_id=__ret__.vcn_id,
        virtual_router_ip=__ret__.virtual_router_ip,
        virtual_router_mac=__ret__.virtual_router_mac)
