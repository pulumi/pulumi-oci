...
class GetSubnetsResult:
    ...
    @property
    @pulumi.getter
    def subnets(self) -> Optional[Sequence['outputs.GetSubnetsSubnetResult']]:
...
def get_subnets(compartment_id: Optional[str] = None,
                ...
                filters: Optional[Sequence[pulumi.InputType['GetSubnetsFilterArgs']]] = None,
...
def get_subnets_output(compartment_id: Optional[pulumi.Input[str]] = None,
                       ...
                       filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetSubnetsFilterArgs']]]]] = None,
