...
def get_vcn(vcn_id: Optional[str] = None,
    ...
    return AwaitableGetVcnResult(
        byoipv6cidr_blocks=__ret__.byoipv6cidr_blocks,
        byoipv6cidr_details=__ret__.byoipv6cidr_details,
        ...
        ipv6private_cidr_blocks=__ret__.ipv6private_cidr_blocks,
        is_ipv6enabled=__ret__.is_ipv6enabled,
        is_oracle_gua_allocation_enabled=__ret__.is_oracle_gua_allocation_enabled,
        state=__ret__.state,
