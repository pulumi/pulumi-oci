...
class GetVcnResult:
    ...
    def byoipv6cidr_blocks(self) -> Sequence[builtins.str]:
        """
    ...
    def default_dhcp_options_id(self) -> builtins.str:
        """
    ...
    def default_security_list_id(self) -> builtins.str:
        """
    ...
    def dns_label(self) -> builtins.str:
        """
    ...
    def ipv6cidr_blocks(self) -> Sequence[builtins.str]:
        """
    ...
    def ipv6private_cidr_blocks(self) -> Sequence[builtins.str]:
        """
    ...
    def is_ipv6enabled(self) -> builtins.bool:
        return pulumi.get(self, "is_ipv6enabled")

    @property
    @pulumi.getter(name="isOracleGuaAllocationEnabled")
    def is_oracle_gua_allocation_enabled(self) -> builtins.bool:
    ...
    def vcn_domain_name(self) -> builtins.str:
        """
...
def get_vcn(vcn_id: Optional[builtins.str] = None,
...
def get_vcn_output(vcn_id: Optional[pulumi.Input[builtins.str]] = None,
