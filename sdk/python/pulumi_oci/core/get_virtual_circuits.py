...
def get_virtual_circuits(compartment_id: Optional[builtins.str] = None,
...
def get_virtual_circuits_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Core/getVirtualCircuits:getVirtualCircuits', __args__, opts=opts, typ=GetVirtualCircuitsResult)
    return __ret__.apply(lambda __response__: GetVirtualCircuitsResult(
        compartment_id=pulumi.get(__response__, 'compartment_id'),
        display_name=pulumi.get(__response__, 'display_name'),
        filters=pulumi.get(__response__, 'filters'),
        id=pulumi.get(__response__, 'id'),
        state=pulumi.get(__response__, 'state'),
        virtual_circuits=pulumi.get(__response__, 'virtual_circuits')))
