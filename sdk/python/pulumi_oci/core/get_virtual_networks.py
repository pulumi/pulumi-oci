...
__all__ = [
    'GetVirtualNetworksResult',
    'AwaitableGetVirtualNetworksResult',
    'get_virtual_networks',
    'get_virtual_networks_output',
]

@pulumi.output_type
class GetVirtualNetworksResult:
    """
    ...
    @property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetVirtualNetworksFilterResult']]:
...
class AwaitableGetVirtualNetworksResult(GetVirtualNetworksResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetVirtualNetworksResult(
...
def get_virtual_networks(compartment_id: Optional[str] = None,
                         ...
                         filters: Optional[Sequence[pulumi.InputType['GetVirtualNetworksFilterArgs']]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('oci:Core/getVirtualNetworks:getVirtualNetworks', __args__, opts=opts, typ=GetVirtualNetworksResult).value

    return AwaitableGetVirtualNetworksResult(
...
@_utilities.lift_output_func(get_virtual_networks)
def get_virtual_networks_output(compartment_id: Optional[pulumi.Input[str]] = None,
                                display_name: Optional[pulumi.Input[Optional[str]]] = None,
                                filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetVirtualNetworksFilterArgs']]]]] = None,
