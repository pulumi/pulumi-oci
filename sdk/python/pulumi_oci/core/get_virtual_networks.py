...
def get_virtual_networks(compartment_id: Optional[builtins.str] = None,
...
def get_virtual_networks_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
