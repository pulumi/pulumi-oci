...
class GetVnicResult:
    ...
    @property
    @pulumi.getter
    def ipv6addresses(self) -> Sequence[builtins.str]:
        """
...
def get_vnic(vnic_id: Optional[builtins.str] = None,
...
def get_vnic_output(vnic_id: Optional[pulumi.Input[builtins.str]] = None,
