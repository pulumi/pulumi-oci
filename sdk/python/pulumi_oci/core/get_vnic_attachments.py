...
def get_vnic_attachments(availability_domain: Optional[builtins.str] = None,
...
def get_vnic_attachments_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
