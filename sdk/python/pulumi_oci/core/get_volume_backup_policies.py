...
def get_volume_backup_policies(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str compartment_id: The OCID of the compartment. If no compartment is specified, the Oracle defined backup policies are listed.
    """
    __args__ = dict()
...
def get_volume_backup_policies_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
