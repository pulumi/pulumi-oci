...
def get_volume_backup_policy_assignments(asset_id: Optional[builtins.str] = None,
    ...
    :param builtins.str asset_id: The OCID of an asset (e.g. a volume).
    """
    __args__ = dict()
...
def get_volume_backup_policy_assignments_output(asset_id: Optional[pulumi.Input[builtins.str]] = None,
