...
class GetVolumeGroupBackupsResult:
    ...
    def volume_group_id(self) -> Optional[_builtins.str]:
        """
...
def get_volume_group_backups(compartment_id: Optional[_builtins.str] = None,
                             display_name: Optional[_builtins.str] = None,
                             filters: Optional[Sequence[Union['GetVolumeGroupBackupsFilterArgs', 'GetVolumeGroupBackupsFilterArgsDict', 'outputs.GetVolumeGroupBackupsFilterResult']]] = None,
    ...
    :param _builtins.str volume_group_id: The OCID of the volume group.
    """
    __args__ = dict()
...
def get_volume_group_backups_output(compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                                    display_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                    filters: pulumi.Input[Optional[Optional[Sequence[Union['GetVolumeGroupBackupsFilterArgs', 'GetVolumeGroupBackupsFilterArgsDict', 'outputs.GetVolumeGroupBackupsFilterResult']]]]] = None,
                                    volume_group_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVolumeGroupBackupsResult]:
    """
    This data source provides the list of Volume Group Backups in Oracle Cloud Infrastructure Core service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Core/getVolumeGroupBackups:getVolumeGroupBackups', __args__, opts=opts, typ=GetVolumeGroupBackupsResult)
    return __ret__.apply(lambda __response__: GetVolumeGroupBackupsResult(
        compartment_id=pulumi.get(__response__, 'compartment_id'),
        display_name=pulumi.get(__response__, 'display_name'),
        filters=pulumi.get(__response__, 'filters'),
        id=pulumi.get(__response__, 'id'),
        volume_group_backups=pulumi.get(__response__, 'volume_group_backups'),
