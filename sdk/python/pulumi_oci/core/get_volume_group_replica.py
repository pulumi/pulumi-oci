...
def get_volume_group_replica(volume_group_replica_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str volume_group_replica_id: The OCID of the volume replica group.
    """
    __args__ = dict()
...
def get_volume_group_replica_output(volume_group_replica_id: Optional[pulumi.Input[_builtins.str]] = None,
