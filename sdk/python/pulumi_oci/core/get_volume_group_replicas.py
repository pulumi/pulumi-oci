...
def get_volume_group_replicas(availability_domain: Optional[builtins.str] = None,
...
def get_volume_group_replicas_output(availability_domain: Optional[pulumi.Input[builtins.str]] = None,
