...
class GetVtapResult:
    ...
    def capture_filter_id(self) -> builtins.str:
        """
    ...
    def encapsulation_protocol(self) -> builtins.str:
        """
    ...
    def is_vtap_enabled(self) -> builtins.bool:
        """
    ...
    def max_packet_size(self) -> builtins.int:
        """
    ...
    def source_private_endpoint_ip(self) -> builtins.str:
        """
    ...
    def source_private_endpoint_subnet_id(self) -> builtins.str:
        """
    ...
    def traffic_mode(self) -> builtins.str:
        """
    ...
    def vtap_id(self) -> builtins.str:
        return pulumi.get(self, "vtap_id")

    @property
    @pulumi.getter(name="vxlanNetworkIdentifier")
    def vxlan_network_identifier(self) -> builtins.str:
        """
...
def get_vtap(vtap_id: Optional[builtins.str] = None,
    ...
    :param builtins.str vtap_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VTAP.
    """
    __args__ = dict()
...
def get_vtap_output(vtap_id: Optional[pulumi.Input[builtins.str]] = None,
