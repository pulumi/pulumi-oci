...
def get_vtap(vtap_id: Optional[str] = None,
    ...
    test_vtap = oci.Core.get_vtap(vtap_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
    ```
    ...
    return AwaitableGetVtapResult(
        ...
        encapsulation_protocol=__ret__.encapsulation_protocol,
        freeform_tags=__ret__.freeform_tags,
        id=__ret__.id,
        is_vtap_enabled=__ret__.is_vtap_enabled,
        lifecycle_state_details=__ret__.lifecycle_state_details,
        max_packet_size=__ret__.max_packet_size,
        source_id=__ret__.source_id,
        source_private_endpoint_ip=__ret__.source_private_endpoint_ip,
        source_private_endpoint_subnet_id=__ret__.source_private_endpoint_subnet_id,
        ...
        traffic_mode=__ret__.traffic_mode,
        vcn_id=__ret__.vcn_id,
        vtap_id=__ret__.vtap_id,
        vxlan_network_identifier=__ret__.vxlan_network_identifier)
