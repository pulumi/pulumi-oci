...
class _InstancePoolInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] fault_domain: The fault domain the instance is running in.
        ...
        :param pulumi.Input[_builtins.str] time_created: The date and time the instance pool instance was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339). Example: `2016-08-25T21:10:29.600Z`
        """
        if auto_terminate_instance_on_delete is not None:
            pulumi.set(__self__, "auto_terminate_instance_on_delete", auto_terminate_instance_on_delete)
...
class InstancePoolInstance(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="autoTerminateInstanceOnDelete")
    def auto_terminate_instance_on_delete(self) -> pulumi.Output[Optional[_builtins.bool]]:
        return pulumi.get(self, "auto_terminate_instance_on_delete")
    ...
    @_builtins.property
    @pulumi.getter(name="decrementSizeOnDelete")
    def decrement_size_on_delete(self) -> pulumi.Output[Optional[_builtins.bool]]:
        return pulumi.get(self, "decrement_size_on_delete")
