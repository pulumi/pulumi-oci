...
class InstancePoolInstanceArgs:
    def __init__(__self__, *,
                 ...
                 auto_terminate_instance_on_delete: Optional[pulumi.Input[builtins.bool]] = None,
                 decrement_size_on_delete: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a InstancePoolInstance resource.
        :param pulumi.Input[builtins.str] instance_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the instance.
        :param pulumi.Input[builtins.str] instance_pool_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the instance pool.
    ...
    def auto_terminate_instance_on_delete(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "auto_terminate_instance_on_delete")

    @auto_terminate_instance_on_delete.setter
    def auto_terminate_instance_on_delete(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "auto_terminate_instance_on_delete", value)

    @property
    @pulumi.getter(name="decrementSizeOnDelete")
    def decrement_size_on_delete(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "decrement_size_on_delete")

    @decrement_size_on_delete.setter
    def decrement_size_on_delete(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _InstancePoolInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_domain: The availability domain the instance is running in.
        :param pulumi.Input[builtins.str] compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that contains the instance.
        ...
        :param pulumi.Input[builtins.str] fault_domain: The fault domain the instance is running in.
        :param pulumi.Input[builtins.str] instance_configuration_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the instance configuration used to create the instance.
        :param pulumi.Input[builtins.str] instance_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the instance.
        :param pulumi.Input[builtins.str] instance_pool_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the instance pool.
        ...
        :param pulumi.Input[builtins.str] state: The lifecycle state of the instance. Refer to `lifecycleState` in the [Instance](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/Instance) resource.
        :param pulumi.Input[builtins.str] time_created: The date and time the instance pool instance was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339). Example: `2016-08-25T21:10:29.600Z`
        """
        if auto_terminate_instance_on_delete is not None:
            pulumi.set(__self__, "auto_terminate_instance_on_delete", auto_terminate_instance_on_delete)
...
class InstancePoolInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            shape: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'InstancePoolInstance':
        """
    ...
    @property
    @pulumi.getter(name="autoTerminateInstanceOnDelete")
    def auto_terminate_instance_on_delete(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "auto_terminate_instance_on_delete")
    ...
    @property
    @pulumi.getter(name="decrementSizeOnDelete")
    def decrement_size_on_delete(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "decrement_size_on_delete")
