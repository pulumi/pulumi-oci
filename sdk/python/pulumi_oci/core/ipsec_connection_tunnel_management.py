...
class IpsecConnectionTunnelManagementArgs:
    def __init__(__self__, *,
                 ipsec_id: pulumi.Input[builtins.str],
                 ...
                 nat_translation_enabled: Optional[pulumi.Input[builtins.str]] = None,
                 oracle_can_initiate: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] ipsec_id: The OCID of the IPSec connection.
        :param pulumi.Input[builtins.str] tunnel_id: The OCID of the IPSec connection's tunnel.
        ...
        :param pulumi.Input[builtins.str] ike_version: Internet Key Exchange protocol version.
        :param pulumi.Input[builtins.str] nat_translation_enabled: By default (the `AUTO` setting), IKE sends packets with a source and destination port set to 500, and when it detects that the port used to forward packets has changed (most likely because a NAT device is between the CPE device and the Oracle VPN headend) it will try to negotiate the use of NAT-T.
        ...
        :param pulumi.Input[builtins.str] oracle_can_initiate: Indicates whether Oracle can only respond to a request to start an IPSec tunnel from the CPE device (`RESPONDER_ONLY`), or both respond to and initiate requests (`INITIATOR_OR_RESPONDER`).
    ...
    def ipsec_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @ipsec_id.setter
    def ipsec_id(self, value: pulumi.Input[builtins.str]):
    ...
    def nat_translation_enabled(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nat_translation_enabled(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "nat_translation_enabled", value)

    @property
    @pulumi.getter(name="oracleCanInitiate")
    def oracle_can_initiate(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def oracle_can_initiate(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _IpsecConnectionTunnelManagementState:
    def __init__(__self__, *,
                 associated_virtual_circuits: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 bgp_session_info: Optional[pulumi.Input['IpsecConnectionTunnelManagementBgpSessionInfoArgs']] = None,
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 cpe_ip: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 dpd_configs: Optional[pulumi.Input[Sequence[pulumi.Input['IpsecConnectionTunnelManagementDpdConfigArgs']]]] = None,
                 dpd_mode: Optional[pulumi.Input[builtins.str]] = None,
                 dpd_timeout_in_sec: Optional[pulumi.Input[builtins.int]] = None,
                 encryption_domain_config: Optional[pulumi.Input['IpsecConnectionTunnelManagementEncryptionDomainConfigArgs']] = None,
                 ike_version: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 vpn_ip: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering IpsecConnectionTunnelManagement resources.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] associated_virtual_circuits: The list of virtual circuit [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)s over which your network can reach this tunnel.
        :param pulumi.Input['IpsecConnectionTunnelManagementBgpSessionInfoArgs'] bgp_session_info: Information for establishing a BGP session for the IPSec tunnel. Required if the tunnel uses BGP dynamic routing.
               
               If the tunnel instead uses static routing, you may optionally provide this object and set an IP address for one or both ends of the IPSec tunnel for the purposes of troubleshooting or monitoring the tunnel.
        :param pulumi.Input[builtins.str] compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the tunnel.
        :param pulumi.Input[builtins.str] cpe_ip: The IP address of the CPE device's VPN headend.  Example: `203.0.113.22`
        :param pulumi.Input[builtins.str] display_name: A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[builtins.str] dpd_mode: Dead peer detection (DPD) mode set on the Oracle side of the connection.
        :param pulumi.Input[builtins.int] dpd_timeout_in_sec: DPD timeout in seconds.
        :param pulumi.Input['IpsecConnectionTunnelManagementEncryptionDomainConfigArgs'] encryption_domain_config: Configuration information used by the encryption domain policy. Required if the tunnel uses POLICY routing.
        :param pulumi.Input[builtins.str] ike_version: Internet Key Exchange protocol version.
        :param pulumi.Input[builtins.str] ipsec_id: The OCID of the IPSec connection.
        :param pulumi.Input[builtins.str] nat_translation_enabled: By default (the `AUTO` setting), IKE sends packets with a source and destination port set to 500, and when it detects that the port used to forward packets has changed (most likely because a NAT device is between the CPE device and the Oracle VPN headend) it will try to negotiate the use of NAT-T.
        ...
        :param pulumi.Input[builtins.str] routing: The type of routing to use for this tunnel (either BGP dynamic routing, STATIC routing or POLICY routing).
        :param pulumi.Input[builtins.str] shared_secret: The shared secret (pre-shared key) to use for the IPSec tunnel. If you don't provide a value, Oracle generates a value for you. You can specify your own shared secret later if you like with [UpdateIPSecConnectionTunnelSharedSecret](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/20160918/IPSecConnectionTunnelSharedSecret/UpdateIPSecConnectionTunnelSharedSecret).  Example: `EXAMPLEToUis6j1c.p8G.dVQxcmdfMO0yXMLi.lZTbYCMDGu4V8o`
        :param pulumi.Input[builtins.str] state: The IPSec connection's tunnel's lifecycle state.
        :param pulumi.Input[builtins.str] status: The tunnel's current state.
        :param pulumi.Input[builtins.str] time_created: The date and time the IPSec connection tunnel was created, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_status_updated: When the status of the tunnel last changed, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] tunnel_id: The OCID of the IPSec connection's tunnel.
        :param pulumi.Input[builtins.str] vpn_ip: The IP address of Oracle's VPN headend.  Example: `129.146.17.50`
        """
    ...
    def associated_virtual_circuits(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def associated_virtual_circuits(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def cpe_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @cpe_ip.setter
    def cpe_ip(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def dpd_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @dpd_mode.setter
    def dpd_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dpd_mode", value)

    @property
    @pulumi.getter(name="dpdTimeoutInSec")
    def dpd_timeout_in_sec(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def dpd_timeout_in_sec(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    @property
    @pulumi.getter(name="ipsecId")
    def ipsec_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The OCID of the IPSec connection.
        """
        return pulumi.get(self, "ipsec_id")
    ...
    @ipsec_id.setter
    def ipsec_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ipsec_id", value)
    ...
    def vpn_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @vpn_ip.setter
    def vpn_ip(self, value: Optional[pulumi.Input[builtins.str]]):
...
class IpsecConnectionTunnelManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_status_updated: Optional[pulumi.Input[builtins.str]] = None,
            tunnel_id: Optional[pulumi.Input[builtins.str]] = None,
            vpn_ip: Optional[pulumi.Input[builtins.str]] = None) -> 'IpsecConnectionTunnelManagement':
        """
    ...
    @property
    @pulumi.getter(name="associatedVirtualCircuits")
    def associated_virtual_circuits(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The list of virtual circuit [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)s over which your network can reach this tunnel.
        """
        return pulumi.get(self, "associated_virtual_circuits")
    ...
    @property
    @pulumi.getter(name="cpeIp")
    def cpe_ip(self) -> pulumi.Output[builtins.str]:
        """
        The IP address of the CPE device's VPN headend.  Example: `203.0.113.22`
        """
        return pulumi.get(self, "cpe_ip")
    ...
    @property
    @pulumi.getter(name="dpdMode")
    def dpd_mode(self) -> pulumi.Output[builtins.str]:
        """
        Dead peer detection (DPD) mode set on the Oracle side of the connection.
        """
        return pulumi.get(self, "dpd_mode")
    ...
    @property
    @pulumi.getter(name="dpdTimeoutInSec")
    def dpd_timeout_in_sec(self) -> pulumi.Output[builtins.int]:
        """
        DPD timeout in seconds.
        """
        return pulumi.get(self, "dpd_timeout_in_sec")
    ...
    @property
    @pulumi.getter(name="ikeVersion")
    def ike_version(self) -> pulumi.Output[builtins.str]:
        """
        Internet Key Exchange protocol version.
        """
        return pulumi.get(self, "ike_version")
    ...
    @property
    @pulumi.getter(name="ipsecId")
    def ipsec_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the IPSec connection.
        """
        return pulumi.get(self, "ipsec_id")
    ...
    @property
    @pulumi.getter(name="natTranslationEnabled")
    def nat_translation_enabled(self) -> pulumi.Output[builtins.str]:
        """
        By default (the `AUTO` setting), IKE sends packets with a source and destination port set to 500, and when it detects that the port used to forward packets has changed (most likely because a NAT device is between the CPE device and the Oracle VPN headend) it will try to negotiate the use of NAT-T.
    ...
    @property
    @pulumi.getter(name="oracleCanInitiate")
    def oracle_can_initiate(self) -> pulumi.Output[builtins.str]:
        """
        Indicates whether Oracle can only respond to a request to start an IPSec tunnel from the CPE device (`RESPONDER_ONLY`), or both respond to and initiate requests (`INITIATOR_OR_RESPONDER`).
        """
        return pulumi.get(self, "oracle_can_initiate")
    ...
    @property
    @pulumi.getter
    def routing(self) -> pulumi.Output[builtins.str]:
        """
        The type of routing to use for this tunnel (either BGP dynamic routing, STATIC routing or POLICY routing).
        """
        return pulumi.get(self, "routing")
    ...
    @property
    @pulumi.getter(name="vpnIp")
    def vpn_ip(self) -> pulumi.Output[builtins.str]:
        """
        The IP address of Oracle's VPN headend.  Example: `129.146.17.50`
        """
        return pulumi.get(self, "vpn_ip")
