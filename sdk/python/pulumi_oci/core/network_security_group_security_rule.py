...
class NetworkSecurityGroupSecurityRuleArgs:
    def __init__(__self__, *,
                 ...
                 icmp_options: pulumi.Input[Optional['NetworkSecurityGroupSecurityRuleIcmpOptionsArgs']] = None,
                 source: pulumi.Input[Optional[_builtins.str]] = None,
                 source_type: pulumi.Input[Optional[_builtins.str]] = None,
                 stateless: pulumi.Input[Optional[_builtins.bool]] = None,
                 tcp_options: pulumi.Input[Optional['NetworkSecurityGroupSecurityRuleTcpOptionsArgs']] = None,
                 udp_options: pulumi.Input[Optional['NetworkSecurityGroupSecurityRuleUdpOptionsArgs']] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] source: Conceptually, this is the range of IP addresses that a packet coming into the instance can come from.
        :param pulumi.Input[_builtins.str] source_type: Type of source for the rule. Required if `direction` = `INGRESS`.
        ...
        :param pulumi.Input[_builtins.bool] stateless: A stateless rule allows traffic in one direction. Remember to add a corresponding stateless rule in the other direction if you need to support bidirectional traffic. For example, if egress traffic allows TCP destination port 80, there should be an ingress rule to allow TCP source port 80. Defaults to false, which means the rule is stateful and a corresponding rule is not necessary for bidirectional traffic.
    ...
    def network_security_group_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def network_security_group_id(self, value: pulumi.Input[_builtins.str]):
    ...
    def icmp_options(self) -> pulumi.Input[Optional['NetworkSecurityGroupSecurityRuleIcmpOptionsArgs']]:
        """
    ...
    @icmp_options.setter
    def icmp_options(self, value: pulumi.Input[Optional['NetworkSecurityGroupSecurityRuleIcmpOptionsArgs']]):
    ...
    def tcp_options(self) -> pulumi.Input[Optional['NetworkSecurityGroupSecurityRuleTcpOptionsArgs']]:
        """
    ...
    @tcp_options.setter
    def tcp_options(self, value: pulumi.Input[Optional['NetworkSecurityGroupSecurityRuleTcpOptionsArgs']]):
        pulumi.set(self, "tcp_options", value)

    @_builtins.property
    @pulumi.getter(name="udpOptions")
    def udp_options(self) -> pulumi.Input[Optional['NetworkSecurityGroupSecurityRuleUdpOptionsArgs']]:
        """
    ...
    @udp_options.setter
    def udp_options(self, value: pulumi.Input[Optional['NetworkSecurityGroupSecurityRuleUdpOptionsArgs']]):
...
class _NetworkSecurityGroupSecurityRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['NetworkSecurityGroupSecurityRuleIcmpOptionsArgs'] icmp_options: Optional and valid only for ICMP and ICMPv6. Use to specify a particular ICMP type and code as defined in:
               * [ICMP Parameters](http://www.iana.org/assignments/icmp-parameters/icmp-parameters.xhtml)
               * [ICMPv6 Parameters](https://www.iana.org/assignments/icmpv6-parameters/icmpv6-parameters.xhtml)
        :param pulumi.Input[_builtins.bool] is_valid: Whether the rule is valid. The value is `True` when the rule is first created. If the rule's `source` or `destination` is a network security group, the value changes to `False` if that network security group is deleted.
        :param pulumi.Input[_builtins.str] network_security_group_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the network security group.
        :param pulumi.Input[_builtins.str] protocol: The transport protocol. Specify either `all` or an IPv4 protocol number as defined in [Protocol Numbers](http://www.iana.org/assignments/protocol-numbers/protocol-numbers.xhtml). Options are supported only for ICMP ("1"), TCP ("6"), UDP ("17"), and ICMPv6 ("58").
        :param pulumi.Input[_builtins.str] source: Conceptually, this is the range of IP addresses that a packet coming into the instance can come from.
        :param pulumi.Input[_builtins.str] source_type: Type of source for the rule. Required if `direction` = `INGRESS`.
        ...
        :param pulumi.Input[_builtins.bool] stateless: A stateless rule allows traffic in one direction. Remember to add a corresponding stateless rule in the other direction if you need to support bidirectional traffic. For example, if egress traffic allows TCP destination port 80, there should be an ingress rule to allow TCP source port 80. Defaults to false, which means the rule is stateful and a corresponding rule is not necessary for bidirectional traffic.
        :param pulumi.Input['NetworkSecurityGroupSecurityRuleTcpOptionsArgs'] tcp_options: Optional and valid only for TCP. Use to specify particular destination ports for TCP rules. If you specify TCP as the protocol but omit this object, then all destination ports are allowed.
        :param pulumi.Input[_builtins.str] time_created: The date and time the security rule was created. Format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input['NetworkSecurityGroupSecurityRuleUdpOptionsArgs'] udp_options: Optional and valid only for UDP. Use to specify particular destination ports for UDP rules. If you specify UDP as the protocol but omit this object, then all destination ports are allowed.
        """
        if description is not None:
            pulumi.set(__self__, "description", description)
...
class NetworkSecurityGroupSecurityRule(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 destination_type: pulumi.Input[Optional[_builtins.str]] = None,
                 direction: pulumi.Input[Optional[_builtins.str]] = None,
                 icmp_options: pulumi.Input[Optional[Union['NetworkSecurityGroupSecurityRuleIcmpOptionsArgs', 'NetworkSecurityGroupSecurityRuleIcmpOptionsArgsDict', 'outputs.NetworkSecurityGroupSecurityRuleIcmpOptions']]] = None,
                 network_security_group_id: pulumi.Input[Optional[_builtins.str]] = None,
                 protocol: pulumi.Input[Optional[_builtins.str]] = None,
                 source: pulumi.Input[Optional[_builtins.str]] = None,
                 source_type: pulumi.Input[Optional[_builtins.str]] = None,
                 stateless: pulumi.Input[Optional[_builtins.bool]] = None,
                 tcp_options: pulumi.Input[Optional[Union['NetworkSecurityGroupSecurityRuleTcpOptionsArgs', 'NetworkSecurityGroupSecurityRuleTcpOptionsArgsDict', 'outputs.NetworkSecurityGroupSecurityRuleTcpOptions']]] = None,
                 udp_options: pulumi.Input[Optional[Union['NetworkSecurityGroupSecurityRuleUdpOptionsArgs', 'NetworkSecurityGroupSecurityRuleUdpOptionsArgsDict', 'outputs.NetworkSecurityGroupSecurityRuleUdpOptions']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] destination_type: Type of destination for the rule. Required if `direction` = `EGRESS`.
        :param pulumi.Input[_builtins.str] direction: Direction of the security rule. Set to `EGRESS` for rules to allow outbound IP packets, or `INGRESS` for rules to allow inbound IP packets.
        :param pulumi.Input[Union['NetworkSecurityGroupSecurityRuleIcmpOptionsArgs', 'NetworkSecurityGroupSecurityRuleIcmpOptionsArgsDict', 'outputs.NetworkSecurityGroupSecurityRuleIcmpOptions']] icmp_options: Optional and valid only for ICMP and ICMPv6. Use to specify a particular ICMP type and code as defined in:
               * [ICMP Parameters](http://www.iana.org/assignments/icmp-parameters/icmp-parameters.xhtml)
               * [ICMPv6 Parameters](https://www.iana.org/assignments/icmpv6-parameters/icmpv6-parameters.xhtml)
        :param pulumi.Input[_builtins.str] network_security_group_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the network security group.
        :param pulumi.Input[_builtins.str] protocol: The transport protocol. Specify either `all` or an IPv4 protocol number as defined in [Protocol Numbers](http://www.iana.org/assignments/protocol-numbers/protocol-numbers.xhtml). Options are supported only for ICMP ("1"), TCP ("6"), UDP ("17"), and ICMPv6 ("58").
        ...
        :param pulumi.Input[_builtins.str] source_type: Type of source for the rule. Required if `direction` = `INGRESS`.
               ...
               * `NETWORK_SECURITY_GROUP`: If the rule's `source` is the [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a [NetworkSecurityGroup](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/NetworkSecurityGroup/).
        :param pulumi.Input[_builtins.bool] stateless: A stateless rule allows traffic in one direction. Remember to add a corresponding stateless rule in the other direction if you need to support bidirectional traffic. For example, if egress traffic allows TCP destination port 80, there should be an ingress rule to allow TCP source port 80. Defaults to false, which means the rule is stateful and a corresponding rule is not necessary for bidirectional traffic.
        :param pulumi.Input[Union['NetworkSecurityGroupSecurityRuleTcpOptionsArgs', 'NetworkSecurityGroupSecurityRuleTcpOptionsArgsDict', 'outputs.NetworkSecurityGroupSecurityRuleTcpOptions']] tcp_options: Optional and valid only for TCP. Use to specify particular destination ports for TCP rules. If you specify TCP as the protocol but omit this object, then all destination ports are allowed.
        :param pulumi.Input[Union['NetworkSecurityGroupSecurityRuleUdpOptionsArgs', 'NetworkSecurityGroupSecurityRuleUdpOptionsArgsDict', 'outputs.NetworkSecurityGroupSecurityRuleUdpOptions']] udp_options: Optional and valid only for UDP. Use to specify particular destination ports for UDP rules. If you specify UDP as the protocol but omit this object, then all destination ports are allowed.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            tcp_options: pulumi.Input[Optional[Union['NetworkSecurityGroupSecurityRuleTcpOptionsArgs', 'NetworkSecurityGroupSecurityRuleTcpOptionsArgsDict', 'outputs.NetworkSecurityGroupSecurityRuleTcpOptions']]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            udp_options: pulumi.Input[Optional[Union['NetworkSecurityGroupSecurityRuleUdpOptionsArgs', 'NetworkSecurityGroupSecurityRuleUdpOptionsArgsDict', 'outputs.NetworkSecurityGroupSecurityRuleUdpOptions']]] = None) -> 'NetworkSecurityGroupSecurityRule':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def stateless(self) -> pulumi.Output[_builtins.bool]:
        """
        A stateless rule allows traffic in one direction. Remember to add a corresponding stateless rule in the other direction if you need to support bidirectional traffic. For example, if egress traffic allows TCP destination port 80, there should be an ingress rule to allow TCP source port 80. Defaults to false, which means the rule is stateful and a corresponding rule is not necessary for bidirectional traffic.
        """
        return pulumi.get(self, "stateless")
