...
class PublicIpPoolCapacityArgs:
    def __init__(__self__, *,
                 byoip_id: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] public_ip_pool_id: The OCID of the pool object created by the current tenancy
        """
    ...
    def byoip_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    @byoip_id.setter
    def byoip_id(self, value: pulumi.Input[_builtins.str]):
    ...
    def public_ip_pool_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def public_ip_pool_id(self, value: pulumi.Input[_builtins.str]):
...
class PublicIpPoolCapacity(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        **Note:** When a new `Core.PublicIpPoolCapacity` resource is created or removed, terraform needs to be refreshed to update the `cidr_blocks` of `Core.PublicIpPool` resource in state file.
    ...
    @_builtins.property
    @pulumi.getter(name="byoipId")
    def byoip_id(self) -> pulumi.Output[_builtins.str]:
        """
        The OCID of the Byoip Range Id object to which the cidr block belongs.
        """
        return pulumi.get(self, "byoip_id")
