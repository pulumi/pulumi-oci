...
class RemotePeeringConnectionArgs:
    def __init__(__self__, *,
                 ...
                 peer_region_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a RemotePeeringConnection resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to contain the RPC.
        :param pulumi.Input[builtins.str] drg_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DRG the RPC belongs to.
        ...
        :param pulumi.Input[builtins.str] peer_id: The OCID of the RPC you want to peer with.
        :param pulumi.Input[builtins.str] peer_region_name: The name of the region that contains the RPC you want to peer with.  Example: `us-ashburn-1`
    ...
    def peer_region_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peer_region_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RemotePeeringConnectionState:
    def __init__(__self__, *,
                 ...
                 peer_id: Optional[pulumi.Input[builtins.str]] = None,
                 peer_region_name: Optional[pulumi.Input[builtins.str]] = None,
                 peer_tenancy_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] peer_region_name: The name of the region that contains the RPC you want to peer with.  Example: `us-ashburn-1`
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] peer_tenancy_id: If this RPC is peered, this value is the [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the other RPC's tenancy.
        :param pulumi.Input[builtins.str] peering_status: Whether the RPC is peered with another RPC. `NEW` means the RPC has not yet been peered. `PENDING` means the peering is being established. `REVOKED` means the RPC at the other end of the peering has been deleted.
        :param pulumi.Input[builtins.str] state: The RPC's current lifecycle state.
        :param pulumi.Input[builtins.str] time_created: The date and time the RPC was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        """
    ...
    def peer_tenancy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peer_tenancy_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RemotePeeringConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            peering_status: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'RemotePeeringConnection':
        """
    ...
    @property
    @pulumi.getter(name="peerRegionName")
    def peer_region_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the region that contains the RPC you want to peer with.  Example: `us-ashburn-1`
    ...
    @property
    @pulumi.getter(name="peerTenancyId")
    def peer_tenancy_id(self) -> pulumi.Output[builtins.str]:
        """
        If this RPC is peered, this value is the [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the other RPC's tenancy.
        """
        return pulumi.get(self, "peer_tenancy_id")
