...
class VcnArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['VcnByoipv6cidrDetailArgs']]] byoipv6cidr_details: The list of BYOIPv6 OCIDs and BYOIPv6 CIDR blocks required to create a VCN that uses BYOIPv6 ranges.
...
class _VcnState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] byoipv6cidr_blocks: The list of BYOIPv6 CIDR blocks required to create a VCN that uses BYOIPv6 ranges.
        :param pulumi.Input[Sequence[pulumi.Input['VcnByoipv6cidrDetailArgs']]] byoipv6cidr_details: The list of BYOIPv6 OCIDs and BYOIPv6 CIDR blocks required to create a VCN that uses BYOIPv6 ranges.
        :param pulumi.Input[str] cidr_block: **Deprecated.** Do *not* set this value. Use `cidrBlocks` instead. Example: `10.0.0.0/16`
        :param pulumi.Input[Sequence[pulumi.Input[str]]] cidr_blocks: (Updatable) The list of one or more IPv4 CIDR blocks for the VCN that meet the following criteria:
               * The CIDR blocks must be valid.
...
class Vcn(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        * `Core.VirtualNetwork`
        ...
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['VcnByoipv6cidrDetailArgs']]]] byoipv6cidr_details: The list of BYOIPv6 OCIDs and BYOIPv6 CIDR blocks required to create a VCN that uses BYOIPv6 ranges.
        :param pulumi.Input[str] cidr_block: **Deprecated.** Do *not* set this value. Use `cidrBlocks` instead. Example: `10.0.0.0/16`
        :param pulumi.Input[Sequence[pulumi.Input[str]]] cidr_blocks: (Updatable) The list of one or more IPv4 CIDR blocks for the VCN that meet the following criteria:
               * The CIDR blocks must be valid.
               * They must not overlap with each other or with the on-premises network CIDR block.
