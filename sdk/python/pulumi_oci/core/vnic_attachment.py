...
class VnicAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 nic_index: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.int] nic_index: Which physical network interface card (NIC) the VNIC will use. Defaults to 0. Certain bare metal instance shapes have two active physical NICs (0 and 1). If you add a secondary VNIC to one of these instances, you can specify which NIC the VNIC will use. For more information, see [Virtual Network Interface Cards (VNICs)](https://docs.cloud.oracle.com/iaas/Content/Network/Tasks/managingVNICs.htm). 
    ...
    def nic_index(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @nic_index.setter
    def nic_index(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _VnicAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment the VNIC attachment is in, which is the same compartment the instance is in.
        :param pulumi.Input['VnicAttachmentCreateVnicDetailsArgs'] create_vnic_details: (Updatable) Contains properties for a VNIC. You use this object when creating the primary VNIC during instance launch or when creating a secondary VNIC. For more information about VNICs, see [Virtual Network Interface Cards (VNICs)](https://docs.cloud.oracle.com/iaas/Content/Network/Tasks/managingVNICs.htm).
        :param pulumi.Input[builtins.str] display_name: A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[builtins.str] instance_id: The OCID of the instance.
        :param pulumi.Input[builtins.int] nic_index: Which physical network interface card (NIC) the VNIC will use. Defaults to 0. Certain bare metal instance shapes have two active physical NICs (0 and 1). If you add a secondary VNIC to one of these instances, you can specify which NIC the VNIC will use. For more information, see [Virtual Network Interface Cards (VNICs)](https://docs.cloud.oracle.com/iaas/Content/Network/Tasks/managingVNICs.htm). 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The current state of the VNIC attachment.
        :param pulumi.Input[builtins.str] subnet_id: The OCID of the subnet to create the VNIC in.
        :param pulumi.Input[builtins.str] time_created: The date and time the VNIC attachment was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] vlan_id: The OCID of the VLAN to create the VNIC in. Creating the VNIC in a VLAN (instead of a subnet) is possible only if you are an Oracle Cloud VMware Solution customer. See [Vlan](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/Vlan).
        :param pulumi.Input[builtins.int] vlan_tag: The Oracle-assigned VLAN tag of the attached VNIC. Available after the attachment process is complete.
        :param pulumi.Input[builtins.str] vnic_id: The OCID of the VNIC. Available after the attachment process is complete.
        """
...
class VnicAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vlan_id: Optional[pulumi.Input[builtins.str]] = None,
            vlan_tag: Optional[pulumi.Input[builtins.int]] = None,
            vnic_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VnicAttachment':
        """
    ...
    @property
    @pulumi.getter(name="nicIndex")
    def nic_index(self) -> pulumi.Output[builtins.int]:
        """
        Which physical network interface card (NIC) the VNIC will use. Defaults to 0. Certain bare metal instance shapes have two active physical NICs (0 and 1). If you add a secondary VNIC to one of these instances, you can specify which NIC the VNIC will use. For more information, see [Virtual Network Interface Cards (VNICs)](https://docs.cloud.oracle.com/iaas/Content/Network/Tasks/managingVNICs.htm). 
