        ...
        test_vnic_attachment = oci.core.VnicAttachment("test_vnic_attachment",
            create_vnic_details={
                ...
                "ipv6address_ipv6subnet_cidr_pair_details": [{
                    "ipv6address": vnic_attachment_create_vnic_details_ipv6address_ipv6subnet_cidr_pair_details_ipv6address,
                    "ipv6id": test_ipv6["id"],
                    "ipv6subnet_cidr": vnic_attachment_create_vnic_details_ipv6address_ipv6subnet_cidr_pair_details_ipv6subnet_cidr,
                }],
