...
class VolumeAttachmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_shareable: Whether the attachment should be created in shareable mode. If an attachment is created in shareable mode, then other instances can attach the same volume, provided that they also create their attachments in shareable mode. Only certain volume types can be attached in shareable mode. Defaults to false if not specified.
        :param pulumi.Input[_builtins.bool] use_chap: Whether to use CHAP authentication for the volume attachment. Defaults to false.
        """
...
class _VolumeAttachmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_read_only: Whether the attachment was created in read-only mode.
        :param pulumi.Input[_builtins.bool] is_shareable: Whether the attachment should be created in shareable mode. If an attachment is created in shareable mode, then other instances can attach the same volume, provided that they also create their attachments in shareable mode. Only certain volume types can be attached in shareable mode. Defaults to false if not specified.
        :param pulumi.Input[_builtins.bool] is_volume_created_during_launch: Flag indicating if this volume was created for the customer as part of a simplified launch. Used to determine whether the volume requires deletion on instance termination.
        :param pulumi.Input[_builtins.str] iscsi_login_state: The iscsi login state of the volume attachment. For a Iscsi volume attachment, all iscsi sessions need to be all logged-in or logged-out to be in logged-in or logged-out state.
        ...
        :param pulumi.Input[_builtins.int] port: The volume's iSCSI port, usually port 860 or 3260.  Example: `3260`
        :param pulumi.Input[_builtins.str] state: The current state of the volume attachment.
        :param pulumi.Input[_builtins.str] time_created: The date and time the volume was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[_builtins.bool] use_chap: Whether to use CHAP authentication for the volume attachment. Defaults to false.
        :param pulumi.Input[_builtins.str] volume_id: The OCID of the volume.
...
class VolumeAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            is_volume_created_during_launch: pulumi.Input[Optional[_builtins.bool]] = None,
            iscsi_login_state: pulumi.Input[Optional[_builtins.str]] = None,
            multipath_devices: pulumi.Input[Optional[Sequence[pulumi.Input[Union['VolumeAttachmentMultipathDeviceArgs', 'VolumeAttachmentMultipathDeviceArgsDict', 'outputs.VolumeAttachmentMultipathDevice']]]]] = None,
            port: pulumi.Input[Optional[_builtins.int]] = None,
            state: pulumi.Input[Optional[_builtins.str]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            use_chap: pulumi.Input[Optional[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.bool] is_volume_created_during_launch: Flag indicating if this volume was created for the customer as part of a simplified launch. Used to determine whether the volume requires deletion on instance termination.
        :param pulumi.Input[_builtins.str] iscsi_login_state: The iscsi login state of the volume attachment. For a Iscsi volume attachment, all iscsi sessions need to be all logged-in or logged-out to be in logged-in or logged-out state.
        :param pulumi.Input[Sequence[pulumi.Input[Union['VolumeAttachmentMultipathDeviceArgs', 'VolumeAttachmentMultipathDeviceArgsDict', 'outputs.VolumeAttachmentMultipathDevice']]]] multipath_devices: A list of secondary multipath devices
        :param pulumi.Input[_builtins.int] port: The volume's iSCSI port, usually port 860 or 3260.  Example: `3260`
        :param pulumi.Input[_builtins.str] state: The current state of the volume attachment.
        :param pulumi.Input[_builtins.str] time_created: The date and time the volume was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[_builtins.bool] use_chap: Whether to use CHAP authentication for the volume attachment. Defaults to false.
    ...
    @_builtins.property
    @pulumi.getter(name="chapSecret")
    def chap_secret(self) -> pulumi.Output[_builtins.str]:
        """
        The Challenge-Handshake-Authentication-Protocol (CHAP) secret valid for the associated CHAP user name. (Also called the "CHAP password".)
        """
        return pulumi.get(self, "chap_secret")
    ...
    @_builtins.property
    @pulumi.getter(name="chapUsername")
    def chap_username(self) -> pulumi.Output[_builtins.str]:
        """
        The volume's system-generated Challenge-Handshake-Authentication-Protocol (CHAP) user name. See [RFC 1994](https://tools.ietf.org/html/rfc1994) for more on CHAP.  Example: `ocid1.volume.oc1.phx.<unique_ID>`
        """
        return pulumi.get(self, "chap_username")
    ...
    @_builtins.property
    @pulumi.getter(name="encryptionInTransitType")
    def encryption_in_transit_type(self) -> pulumi.Output[_builtins.str]:
        """
        Refer the top-level definition of encryptionInTransitType. The default value is NONE.
        """
        return pulumi.get(self, "encryption_in_transit_type")
    ...
    @_builtins.property
    @pulumi.getter
    def iqn(self) -> pulumi.Output[_builtins.str]:
        """
        The target volume's iSCSI Qualified Name in the format defined by [RFC 3720](https://tools.ietf.org/html/rfc3720#page-32).  Example: `iqn.2015-12.com.oracleiaas:40b7ee03-883f-46c6-a951-63d2841d2195`
        """
        return pulumi.get(self, "iqn")
    ...
    @_builtins.property
    @pulumi.getter(name="isAgentAutoIscsiLoginEnabled")
    def is_agent_auto_iscsi_login_enabled(self) -> pulumi.Output[_builtins.bool]:
        """
        Whether to enable Oracle Cloud Agent to perform the iSCSI login and logout commands after the volume attach or detach operations for non multipath-enabled iSCSI attachments.
        """
        return pulumi.get(self, "is_agent_auto_iscsi_login_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="isMultipath")
    def is_multipath(self) -> pulumi.Output[_builtins.bool]:
        """
        Whether the Iscsi or Paravirtualized attachment is multipath or not, it is not applicable to NVMe attachment.
        """
        return pulumi.get(self, "is_multipath")
    ...
    @_builtins.property
    @pulumi.getter(name="isVolumeCreatedDuringLaunch")
    def is_volume_created_during_launch(self) -> pulumi.Output[_builtins.bool]:
        """
        Flag indicating if this volume was created for the customer as part of a simplified launch. Used to determine whether the volume requires deletion on instance termination.
        """
        return pulumi.get(self, "is_volume_created_during_launch")
    ...
    @_builtins.property
    @pulumi.getter(name="iscsiLoginState")
    def iscsi_login_state(self) -> pulumi.Output[_builtins.str]:
        """
        The iscsi login state of the volume attachment. For a Iscsi volume attachment, all iscsi sessions need to be all logged-in or logged-out to be in logged-in or logged-out state.
        """
        return pulumi.get(self, "iscsi_login_state")
    ...
    @_builtins.property
    @pulumi.getter(name="useChap")
    def use_chap(self) -> pulumi.Output[_builtins.bool]:
        """
        Whether to use CHAP authentication for the volume attachment. Defaults to false.
        """
        return pulumi.get(self, "use_chap")
