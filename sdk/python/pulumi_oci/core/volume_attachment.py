...
class VolumeAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 encryption_in_transit_type: Optional[pulumi.Input[builtins.str]] = None,
                 is_agent_auto_iscsi_login_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] attachment_type: The type of volume. The only supported values are "iscsi" and "paravirtualized".
        :param pulumi.Input[builtins.str] instance_id: The OCID of the instance.
        :param pulumi.Input[builtins.str] volume_id: The OCID of the volume.
        ...
        :param pulumi.Input[builtins.bool] is_agent_auto_iscsi_login_enabled: Whether to enable Oracle Cloud Agent to perform the iSCSI login and logout commands after the volume attach or detach operations for non multipath-enabled iSCSI attachments.
        :param pulumi.Input[builtins.bool] is_pv_encryption_in_transit_enabled: Whether to enable in-transit encryption for the data volume's paravirtualized attachment. The default value is false.
        :param pulumi.Input[builtins.bool] is_read_only: Whether the attachment was created in read-only mode.
        :param pulumi.Input[builtins.bool] is_shareable: Whether the attachment should be created in shareable mode. If an attachment is created in shareable mode, then other instances can attach the same volume, provided that they also create their attachments in shareable mode. Only certain volume types can be attached in shareable mode. Defaults to false if not specified.
        :param pulumi.Input[builtins.bool] use_chap: Whether to use CHAP authentication for the volume attachment. Defaults to false.
        """
    ...
    def encryption_in_transit_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def encryption_in_transit_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "encryption_in_transit_type", value)

    @property
    @pulumi.getter(name="isAgentAutoIscsiLoginEnabled")
    def is_agent_auto_iscsi_login_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_agent_auto_iscsi_login_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def use_chap(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @use_chap.setter
    def use_chap(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _VolumeAttachmentState:
    def __init__(__self__, *,
                 ...
                 chap_secret: Optional[pulumi.Input[builtins.str]] = None,
                 chap_username: Optional[pulumi.Input[builtins.str]] = None,
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 device: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 encryption_in_transit_type: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 iqn: Optional[pulumi.Input[builtins.str]] = None,
                 is_agent_auto_iscsi_login_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_multipath: Optional[pulumi.Input[builtins.bool]] = None,
                 is_pv_encryption_in_transit_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_read_only: Optional[pulumi.Input[builtins.bool]] = None,
                 is_shareable: Optional[pulumi.Input[builtins.bool]] = None,
                 is_volume_created_during_launch: Optional[pulumi.Input[builtins.bool]] = None,
                 iscsi_login_state: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] chap_secret: The Challenge-Handshake-Authentication-Protocol (CHAP) secret valid for the associated CHAP user name. (Also called the "CHAP password".)
        :param pulumi.Input[builtins.str] chap_username: The volume's system-generated Challenge-Handshake-Authentication-Protocol (CHAP) user name. See [RFC 1994](https://tools.ietf.org/html/rfc1994) for more on CHAP.  Example: `ocid1.volume.oc1.phx.<unique_ID>`
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment.
        :param pulumi.Input[builtins.str] device: The device name. To retrieve a list of devices for a given instance, see [ListInstanceDevices](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/Device/ListInstanceDevices).
        :param pulumi.Input[builtins.str] display_name: A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[builtins.str] encryption_in_transit_type: Refer the top-level definition of encryptionInTransitType. The default value is NONE.
        :param pulumi.Input[builtins.str] instance_id: The OCID of the instance.
        :param pulumi.Input[builtins.str] ipv4: The volume's iSCSI IP address.  Example: `169.254.2.2`
        :param pulumi.Input[builtins.str] iqn: The target volume's iSCSI Qualified Name in the format defined by [RFC 3720](https://tools.ietf.org/html/rfc3720#page-32).  Example: `iqn.2015-12.com.oracleiaas:40b7ee03-883f-46c6-a951-63d2841d2195`
        :param pulumi.Input[builtins.bool] is_agent_auto_iscsi_login_enabled: Whether to enable Oracle Cloud Agent to perform the iSCSI login and logout commands after the volume attach or detach operations for non multipath-enabled iSCSI attachments.
        :param pulumi.Input[builtins.bool] is_multipath: Whether the Iscsi or Paravirtualized attachment is multipath or not, it is not applicable to NVMe attachment.
        :param pulumi.Input[builtins.bool] is_pv_encryption_in_transit_enabled: Whether to enable in-transit encryption for the data volume's paravirtualized attachment. The default value is false.
        :param pulumi.Input[builtins.bool] is_read_only: Whether the attachment was created in read-only mode.
        :param pulumi.Input[builtins.bool] is_shareable: Whether the attachment should be created in shareable mode. If an attachment is created in shareable mode, then other instances can attach the same volume, provided that they also create their attachments in shareable mode. Only certain volume types can be attached in shareable mode. Defaults to false if not specified.
        :param pulumi.Input[builtins.bool] is_volume_created_during_launch: Flag indicating if this volume was created for the customer as part of a simplified launch. Used to determine whether the volume requires deletion on instance termination.
        :param pulumi.Input[builtins.str] iscsi_login_state: The iscsi login state of the volume attachment. For a Iscsi volume attachment, all iscsi sessions need to be all logged-in or logged-out to be in logged-in or logged-out state.
        ...
        :param pulumi.Input[builtins.int] port: The volume's iSCSI port, usually port 860 or 3260.  Example: `3260`
        :param pulumi.Input[builtins.str] state: The current state of the volume attachment.
        :param pulumi.Input[builtins.str] time_created: The date and time the volume was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.bool] use_chap: Whether to use CHAP authentication for the volume attachment. Defaults to false.
        :param pulumi.Input[builtins.str] volume_id: The OCID of the volume.
    ...
    def chap_secret(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @chap_secret.setter
    def chap_secret(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "chap_secret", value)

    @property
    @pulumi.getter(name="chapUsername")
    def chap_username(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def chap_username(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def iqn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @iqn.setter
    def iqn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_multipath(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_multipath.setter
    def is_multipath(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def is_volume_created_during_launch(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_volume_created_during_launch(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_volume_created_during_launch", value)

    @property
    @pulumi.getter(name="iscsiLoginState")
    def iscsi_login_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def iscsi_login_state(self, value: Optional[pulumi.Input[builtins.str]]):
...
class VolumeAttachment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="chapSecret")
    def chap_secret(self) -> pulumi.Output[builtins.str]:
        """
        The Challenge-Handshake-Authentication-Protocol (CHAP) secret valid for the associated CHAP user name. (Also called the "CHAP password".)
        """
        return pulumi.get(self, "chap_secret")
    ...
    @property
    @pulumi.getter(name="chapUsername")
    def chap_username(self) -> pulumi.Output[builtins.str]:
        """
        The volume's system-generated Challenge-Handshake-Authentication-Protocol (CHAP) user name. See [RFC 1994](https://tools.ietf.org/html/rfc1994) for more on CHAP.  Example: `ocid1.volume.oc1.phx.<unique_ID>`
        """
        return pulumi.get(self, "chap_username")
    ...
    @property
    @pulumi.getter(name="encryptionInTransitType")
    def encryption_in_transit_type(self) -> pulumi.Output[builtins.str]:
        """
        Refer the top-level definition of encryptionInTransitType. The default value is NONE.
        """
        return pulumi.get(self, "encryption_in_transit_type")
    ...
    @property
    @pulumi.getter
    def iqn(self) -> pulumi.Output[builtins.str]:
        """
        The target volume's iSCSI Qualified Name in the format defined by [RFC 3720](https://tools.ietf.org/html/rfc3720#page-32).  Example: `iqn.2015-12.com.oracleiaas:40b7ee03-883f-46c6-a951-63d2841d2195`
        """
        return pulumi.get(self, "iqn")
    ...
    @property
    @pulumi.getter(name="isAgentAutoIscsiLoginEnabled")
    def is_agent_auto_iscsi_login_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to enable Oracle Cloud Agent to perform the iSCSI login and logout commands after the volume attach or detach operations for non multipath-enabled iSCSI attachments.
        """
        return pulumi.get(self, "is_agent_auto_iscsi_login_enabled")
    ...
    @property
    @pulumi.getter(name="isMultipath")
    def is_multipath(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the Iscsi or Paravirtualized attachment is multipath or not, it is not applicable to NVMe attachment.
        """
        return pulumi.get(self, "is_multipath")
    ...
    @property
    @pulumi.getter(name="isVolumeCreatedDuringLaunch")
    def is_volume_created_during_launch(self) -> pulumi.Output[builtins.bool]:
        """
        Flag indicating if this volume was created for the customer as part of a simplified launch. Used to determine whether the volume requires deletion on instance termination.
        """
        return pulumi.get(self, "is_volume_created_during_launch")
    ...
    @property
    @pulumi.getter(name="iscsiLoginState")
    def iscsi_login_state(self) -> pulumi.Output[builtins.str]:
        """
        The iscsi login state of the volume attachment. For a Iscsi volume attachment, all iscsi sessions need to be all logged-in or logged-out to be in logged-in or logged-out state.
        """
        return pulumi.get(self, "iscsi_login_state")
    ...
    @property
    @pulumi.getter(name="useChap")
    def use_chap(self) -> pulumi.Output[builtins.bool]:
        """
        Whether to use CHAP authentication for the volume attachment. Defaults to false.
        """
        return pulumi.get(self, "use_chap")
