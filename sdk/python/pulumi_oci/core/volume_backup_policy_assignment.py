...
class VolumeBackupPolicyAssignmentArgs:
    def __init__(__self__, *,
                 asset_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] asset_id: The OCID of the volume or volume group to assign the policy to.
        :param pulumi.Input[builtins.str] policy_id: The OCID of the volume backup policy to assign to the volume.
    ...
    def asset_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @asset_id.setter
    def asset_id(self, value: pulumi.Input[builtins.str]):
...
class _VolumeBackupPolicyAssignmentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] asset_id: The OCID of the volume or volume group to assign the policy to.
        :param pulumi.Input[builtins.str] policy_id: The OCID of the volume backup policy to assign to the volume.
        :param pulumi.Input[builtins.str] time_created: The date and time the volume backup policy was assigned to the volume. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] xrc_kms_key_id: The OCID of the Vault service key which is the master encryption key for the block / boot volume cross region backups, which will be used in the destination region to encrypt the backup's encryption keys. For more information about the Vault service and encryption keys, see [Overview of Vault service](https://docs.cloud.oracle.com/iaas/Content/KeyManagement/Concepts/keyoverview.htm) and [Using Keys](https://docs.cloud.oracle.com/iaas/Content/KeyManagement/Tasks/usingkeys.htm). 
...
class VolumeBackupPolicyAssignment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            policy_id: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            xrc_kms_key_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VolumeBackupPolicyAssignment':
        """
