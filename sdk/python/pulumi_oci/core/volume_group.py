...
class VolumeGroupArgs:
    def __init__(__self__, *,
                 ...
                 preserve_volume_replica: Optional[pulumi.Input[builtins.bool]] = None,
                 volume_group_replicas: Optional[pulumi.Input[Sequence[pulumi.Input['VolumeGroupVolumeGroupReplicaArgs']]]] = None,
                 volume_group_replicas_deletion: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] availability_domain: The availability domain of the volume group.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment that contains the volume group.
        :param pulumi.Input['VolumeGroupSourceDetailsArgs'] source_details: Specifies the source for a volume group.
        :param pulumi.Input[builtins.str] backup_policy_id: If provided, specifies the ID of the volume backup policy to assign to the newly created volume group. If omitted, no policy will be assigned. This field is deprecated. Use the `core_get_volume_backup_policy_assignments` instead to assign a backup policy to a volume group.
        :param pulumi.Input[builtins.str] cluster_placement_group_id: The clusterPlacementGroup Id of the volume group for volume group placement.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] volume_ids: (Updatable) Use this for update operation only. This field is not supported during creation. For create use `volume_ids` under `source_details`.
    ...
    def preserve_volume_replica(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "preserve_volume_replica")

    @preserve_volume_replica.setter
    def preserve_volume_replica(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def volume_group_replicas_deletion(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "volume_group_replicas_deletion")

    @volume_group_replicas_deletion.setter
    def volume_group_replicas_deletion(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _VolumeGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] is_hydrated: Specifies whether the newly created cloned volume group's data has finished copying from the source volume group or backup.
        :param pulumi.Input[builtins.str] size_in_gbs: The aggregate size of the volume group in GBs.
        :param pulumi.Input[builtins.str] size_in_mbs: The aggregate size of the volume group in MBs.
        :param pulumi.Input['VolumeGroupSourceDetailsArgs'] source_details: Specifies the source for a volume group.
        :param pulumi.Input[builtins.str] state: The current state of a volume group.
        :param pulumi.Input[builtins.str] time_created: The date and time the volume group was created. Format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[Sequence[pulumi.Input['VolumeGroupVolumeGroupReplicaArgs']]] volume_group_replicas: (Updatable) The list of volume group replicas that this volume group will be enabled to have in the specified destination availability domains.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] volume_ids: (Updatable) Use this for update operation only. This field is not supported during creation. For create use `volume_ids` under `source_details`.
...
class VolumeGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            volume_group_replicas_deletion: Optional[pulumi.Input[builtins.bool]] = None,
            volume_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            xrc_kms_key_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VolumeGroup':
        """
    ...
    @property
    @pulumi.getter(name="preserveVolumeReplica")
    def preserve_volume_replica(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "preserve_volume_replica")
    ...
    @property
    @pulumi.getter(name="volumeGroupReplicasDeletion")
    def volume_group_replicas_deletion(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "volume_group_replicas_deletion")
