...
class VolumeGroupBackupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment that will contain the volume group backup. This parameter is optional, by default backup will be created in the same compartment and source volume group.
        ...
        :param pulumi.Input[builtins.str] type: The type of backup to create. If omitted, defaults to incremental.
               * Allowed values are :
               * FULL
               * INCREMENTAL
        :param pulumi.Input[builtins.str] volume_group_id: The OCID of the volume group that needs to be backed up.
        """
...
class _VolumeGroupBackupState:
    def __init__(__self__, *,
                 ...
                 source_volume_group_backup_id: Optional[pulumi.Input[builtins.str]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 time_created: Optional[pulumi.Input[builtins.str]] = None,
                 time_request_received: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
                 unique_size_in_gbs: Optional[pulumi.Input[builtins.str]] = None,
                 unique_size_in_mbs: Optional[pulumi.Input[builtins.str]] = None,
                 volume_backup_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 volume_group_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[builtins.str] expiration_time: The date and time the volume group backup will expire and be automatically deleted. Format defined by [RFC3339](https://tools.ietf.org/html/rfc3339). This parameter will always be present for volume group backups that were created automatically by a scheduled-backup policy. For manually created volume group backups, it will be absent, signifying that there is no expiration time and the backup will last forever until manually deleted.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] size_in_gbs: The aggregate size of the volume group backup, in GBs.
        :param pulumi.Input[builtins.str] size_in_mbs: The aggregate size of the volume group backup, in MBs.
        :param pulumi.Input['VolumeGroupBackupSourceDetailsArgs'] source_details: Details of the volume group backup source in the cloud.
        :param pulumi.Input[builtins.str] source_type: Specifies whether the volume group backup was created manually, or via scheduled backup policy.
        :param pulumi.Input[builtins.str] source_volume_group_backup_id: The OCID of the source volume group backup.
        :param pulumi.Input[builtins.str] state: The current state of a volume group backup.
        :param pulumi.Input[builtins.str] time_created: The date and time the volume group backup was created. This is the time the actual point-in-time image of the volume group data was taken. Format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] time_request_received: The date and time the request to create the volume group backup was received. Format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] type: The type of backup to create. If omitted, defaults to incremental.
               * Allowed values are :
               * FULL
               * INCREMENTAL
        :param pulumi.Input[builtins.str] unique_size_in_gbs: The aggregate size used by the volume group backup, in GBs.  It is typically smaller than `size_in_gbs`, depending on the space consumed on the volume group and whether the volume backup is full or incremental.
        :param pulumi.Input[builtins.str] unique_size_in_mbs: The aggregate size used by the volume group backup, in MBs.  It is typically smaller than `size_in_mbs`, depending on the space consumed on the volume group and whether the volume backup is full or incremental.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] volume_backup_ids: OCIDs for the volume backups in this volume group backup.
        :param pulumi.Input[builtins.str] volume_group_id: The OCID of the volume group that needs to be backed up.
        """
        if compartment_id is not None:
            pulumi.set(__self__, "compartment_id", compartment_id)
    ...
    def source_volume_group_backup_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_volume_group_backup_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_request_received(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_request_received(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def unique_size_in_gbs(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def unique_size_in_gbs(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "unique_size_in_gbs", value)

    @property
    @pulumi.getter(name="uniqueSizeInMbs")
    def unique_size_in_mbs(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def unique_size_in_mbs(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "unique_size_in_mbs", value)

    @property
    @pulumi.getter(name="volumeBackupIds")
    def volume_backup_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def volume_backup_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class VolumeGroupBackup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            unique_size_in_mbs: Optional[pulumi.Input[builtins.str]] = None,
            volume_backup_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            volume_group_id: Optional[pulumi.Input[builtins.str]] = None) -> 'VolumeGroupBackup':
        """
    ...
    @property
    @pulumi.getter(name="sourceVolumeGroupBackupId")
    def source_volume_group_backup_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the source volume group backup.
        """
        return pulumi.get(self, "source_volume_group_backup_id")
    ...
    @property
    @pulumi.getter(name="timeRequestReceived")
    def time_request_received(self) -> pulumi.Output[builtins.str]:
        """
        The date and time the request to create the volume group backup was received. Format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        """
        return pulumi.get(self, "time_request_received")
    ...
    @property
    @pulumi.getter(name="uniqueSizeInGbs")
    def unique_size_in_gbs(self) -> pulumi.Output[builtins.str]:
        """
        The aggregate size used by the volume group backup, in GBs.  It is typically smaller than `size_in_gbs`, depending on the space consumed on the volume group and whether the volume backup is full or incremental.
        """
        return pulumi.get(self, "unique_size_in_gbs")
    ...
    @property
    @pulumi.getter(name="uniqueSizeInMbs")
    def unique_size_in_mbs(self) -> pulumi.Output[builtins.str]:
        """
        The aggregate size used by the volume group backup, in MBs.  It is typically smaller than `size_in_mbs`, depending on the space consumed on the volume group and whether the volume backup is full or incremental.
        """
        return pulumi.get(self, "unique_size_in_mbs")
    ...
    @property
    @pulumi.getter(name="volumeBackupIds")
    def volume_backup_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        OCIDs for the volume backups in this volume group backup.
        """
        return pulumi.get(self, "volume_backup_ids")
