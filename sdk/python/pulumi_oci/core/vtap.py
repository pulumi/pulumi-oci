...
class VtapArgs:
    def __init__(__self__, *,
                 capture_filter_id: pulumi.Input[builtins.str],
                 compartment_id: pulumi.Input[builtins.str],
                 source_id: pulumi.Input[builtins.str],
                 vcn_id: pulumi.Input[builtins.str],
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 encapsulation_protocol: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_vtap_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 max_packet_size: Optional[pulumi.Input[builtins.int]] = None,
                 source_private_endpoint_ip: Optional[pulumi.Input[builtins.str]] = None,
                 source_private_endpoint_subnet_id: Optional[pulumi.Input[builtins.str]] = None,
                 source_type: Optional[pulumi.Input[builtins.str]] = None,
                 target_id: Optional[pulumi.Input[builtins.str]] = None,
                 target_ip: Optional[pulumi.Input[builtins.str]] = None,
                 target_type: Optional[pulumi.Input[builtins.str]] = None,
                 traffic_mode: Optional[pulumi.Input[builtins.str]] = None,
                 vxlan_network_identifier: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Vtap resource.
        :param pulumi.Input[builtins.str] capture_filter_id: (Updatable) The capture filter's Oracle ID ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)).
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the `Vtap` resource.
        :param pulumi.Input[builtins.str] source_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the source point where packets are captured.
        :param pulumi.Input[builtins.str] vcn_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VCN containing the `Vtap` resource.
        ...
        :param pulumi.Input[builtins.str] encapsulation_protocol: (Updatable) Defines an encapsulation header type for the VTAP's mirrored traffic.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] is_vtap_enabled: (Updatable) Used to start or stop a `Vtap` resource.
               * `TRUE` directs the VTAP to start mirroring traffic.
               * `FALSE` (Default) directs the VTAP to stop mirroring traffic.
        :param pulumi.Input[builtins.int] max_packet_size: (Updatable) The maximum size of the packets to be included in the filter.
        :param pulumi.Input[builtins.str] source_private_endpoint_ip: (Updatable) The IP Address of the source private endpoint.
        :param pulumi.Input[builtins.str] source_private_endpoint_subnet_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet that source private endpoint belongs to.
        :param pulumi.Input[builtins.str] source_type: (Updatable) The source type for the VTAP.
        :param pulumi.Input[builtins.str] target_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the destination resource where mirrored packets are sent.
        :param pulumi.Input[builtins.str] target_ip: (Updatable) The IP address of the destination resource where mirrored packets are sent.
        :param pulumi.Input[builtins.str] target_type: (Updatable) The target type for the VTAP.
        :param pulumi.Input[builtins.str] traffic_mode: (Updatable) Used to control the priority of traffic. It is an optional field. If it not passed, the value is DEFAULT
        :param pulumi.Input[builtins.str] vxlan_network_identifier: (Updatable) The virtual extensible LAN (VXLAN) network identifier (or VXLAN segment ID) that uniquely identifies the VXLAN. 
    ...
    def capture_filter_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def capture_filter_id(self, value: pulumi.Input[builtins.str]):
    ...
    def encapsulation_protocol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def encapsulation_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_vtap_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_vtap_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_vtap_enabled", value)

    @property
    @pulumi.getter(name="maxPacketSize")
    def max_packet_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_packet_size(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_packet_size", value)

    @property
    @pulumi.getter(name="sourcePrivateEndpointIp")
    def source_private_endpoint_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_private_endpoint_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_private_endpoint_ip", value)

    @property
    @pulumi.getter(name="sourcePrivateEndpointSubnetId")
    def source_private_endpoint_subnet_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_private_endpoint_subnet_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def target_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @target_ip.setter
    def target_ip(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def traffic_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @traffic_mode.setter
    def traffic_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "traffic_mode", value)

    @property
    @pulumi.getter(name="vxlanNetworkIdentifier")
    def vxlan_network_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vxlan_network_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _VtapState:
    def __init__(__self__, *,
                 capture_filter_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] is_vtap_enabled: (Updatable) Used to start or stop a `Vtap` resource.
               * `TRUE` directs the VTAP to start mirroring traffic.
               * `FALSE` (Default) directs the VTAP to stop mirroring traffic.
        :param pulumi.Input[builtins.str] lifecycle_state_details: The VTAP's current running state.
        :param pulumi.Input[builtins.int] max_packet_size: (Updatable) The maximum size of the packets to be included in the filter.
        :param pulumi.Input[builtins.str] source_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the source point where packets are captured.
        :param pulumi.Input[builtins.str] source_private_endpoint_ip: (Updatable) The IP Address of the source private endpoint.
        :param pulumi.Input[builtins.str] source_private_endpoint_subnet_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet that source private endpoint belongs to.
        :param pulumi.Input[builtins.str] source_type: (Updatable) The source type for the VTAP.
        :param pulumi.Input[builtins.str] state: The VTAP's administrative lifecycle state.
        :param pulumi.Input[builtins.str] target_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the destination resource where mirrored packets are sent.
        :param pulumi.Input[builtins.str] target_ip: (Updatable) The IP address of the destination resource where mirrored packets are sent.
        :param pulumi.Input[builtins.str] target_type: (Updatable) The target type for the VTAP.
        :param pulumi.Input[builtins.str] time_created: The date and time the VTAP was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2020-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] traffic_mode: (Updatable) Used to control the priority of traffic. It is an optional field. If it not passed, the value is DEFAULT
        :param pulumi.Input[builtins.str] vcn_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VCN containing the `Vtap` resource.
        :param pulumi.Input[builtins.str] vxlan_network_identifier: (Updatable) The virtual extensible LAN (VXLAN) network identifier (or VXLAN segment ID) that uniquely identifies the VXLAN. 
    ...
    @property
    @pulumi.getter(name="captureFilterId")
    def capture_filter_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The capture filter's Oracle ID ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)).
        """
        return pulumi.get(self, "capture_filter_id")
    ...
    @capture_filter_id.setter
    def capture_filter_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "capture_filter_id", value)
...
class Vtap(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            traffic_mode: Optional[pulumi.Input[builtins.str]] = None,
            vcn_id: Optional[pulumi.Input[builtins.str]] = None,
            vxlan_network_identifier: Optional[pulumi.Input[builtins.str]] = None) -> 'Vtap':
        """
    ...
    @property
    @pulumi.getter(name="captureFilterId")
    def capture_filter_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The capture filter's Oracle ID ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)).
        """
        return pulumi.get(self, "capture_filter_id")
    ...
    @property
    @pulumi.getter(name="encapsulationProtocol")
    def encapsulation_protocol(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Defines an encapsulation header type for the VTAP's mirrored traffic.
        """
        return pulumi.get(self, "encapsulation_protocol")
    ...
    @property
    @pulumi.getter(name="isVtapEnabled")
    def is_vtap_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Used to start or stop a `Vtap` resource.
        * `TRUE` directs the VTAP to start mirroring traffic.
        * `FALSE` (Default) directs the VTAP to stop mirroring traffic.
    ...
    @property
    @pulumi.getter(name="maxPacketSize")
    def max_packet_size(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The maximum size of the packets to be included in the filter.
        """
        return pulumi.get(self, "max_packet_size")
    ...
    @property
    @pulumi.getter(name="sourcePrivateEndpointIp")
    def source_private_endpoint_ip(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The IP Address of the source private endpoint.
        """
        return pulumi.get(self, "source_private_endpoint_ip")
    ...
    @property
    @pulumi.getter(name="sourcePrivateEndpointSubnetId")
    def source_private_endpoint_subnet_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet that source private endpoint belongs to.
        """
        return pulumi.get(self, "source_private_endpoint_subnet_id")
    ...
    @property
    @pulumi.getter(name="targetIp")
    def target_ip(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The IP address of the destination resource where mirrored packets are sent.
        """
        return pulumi.get(self, "target_ip")
    ...
    @property
    @pulumi.getter(name="trafficMode")
    def traffic_mode(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Used to control the priority of traffic. It is an optional field. If it not passed, the value is DEFAULT
        """
        return pulumi.get(self, "traffic_mode")
    ...
    @property
    @pulumi.getter(name="vxlanNetworkIdentifier")
    def vxlan_network_identifier(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The virtual extensible LAN (VXLAN) network identifier (or VXLAN segment ID) that uniquely identifies the VXLAN. 
