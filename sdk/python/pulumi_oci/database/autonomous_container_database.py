...
class AutonomousContainerDatabaseArgs:
    def __init__(__self__, *,
                 ...
                 peer_autonomous_exadata_infrastructure_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name for the Autonomous Container Database.
        :param pulumi.Input[builtins.str] patch_model: (Updatable) Database Patch model preference.
        :param pulumi.Input[builtins.str] autonomous_exadata_infrastructure_id: **No longer used.** This parameter is no longer used for Autonomous Database on dedicated Exadata infrasture. Specify a `cloudAutonomousVmClusterId` instead. Using this parameter will cause the operation to fail.
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the Autonomous Container Database.
        ...
        :param pulumi.Input[builtins.str] db_version: The base version for the Autonomous Container Database.
        ...
        :param pulumi.Input[builtins.str] distribution_affinity: Determines whether an Autonomous Database must be opened across a minimum or maximum of nodes. By default, Minimum nodes is selected.
        ...
        :param pulumi.Input[builtins.str] peer_autonomous_exadata_infrastructure_id: *No longer used.* This parameter is no longer used for Autonomous Database on dedicated Exadata infrasture. Specify a `peerCloudAutonomousVmClusterId` instead. Using this parameter will cause the operation to fail.
        :param pulumi.Input[builtins.str] peer_autonomous_vm_cluster_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the peer Autonomous VM cluster for Autonomous Data Guard. Required to enable Data Guard.
        :param pulumi.Input[builtins.str] peer_cloud_autonomous_vm_cluster_id: The OCID of the peer Autonomous Cloud VM Cluster for autonomous dataguard.
        ...
        :param pulumi.Input[builtins.bool] rotate_key_trigger: (Updatable) An optional property when flipped triggers rotation of KMS key. It is only applicable on dedicated container databases i.e. where `cloud_autonomous_vm_cluster_id` is set.
        ...
        :param pulumi.Input[builtins.str] version_preference: (Updatable) The next maintenance version preference.
    ...
    def patch_model(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def key_version_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def key_version_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def peer_autonomous_exadata_infrastructure_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peer_autonomous_exadata_infrastructure_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def reinstate_trigger(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def reinstate_trigger(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "reinstate_trigger", value)

    @property
    @pulumi.getter(name="rotateKeyTrigger")
    def rotate_key_trigger(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def rotate_key_trigger(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def switchover_trigger(self) -> Optional[pulumi.Input[builtins.int]]:
        """
...
class _AutonomousContainerDatabaseState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.float] available_cpus: Sum of CPUs available on the Autonomous VM Cluster + Sum of reclaimable CPUs available in the Autonomous Container Database.<br> For Autonomous Databases on Dedicated Exadata Infrastructure, the CPU type (OCPUs or ECPUs) is determined by the parent Autonomous Exadata VM Cluster's compute model. See [Compute Models in Autonomous Database on Dedicated Exadata Infrastructure](https://docs.oracle.com/en/cloud/paas/autonomous-database/dedicated/adbak) for more details.
        :param pulumi.Input['AutonomousContainerDatabaseBackupConfigArgs'] backup_config: (Updatable) Backup options for the Autonomous Container Database.
...
class AutonomousContainerDatabase(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vault_id: Optional[pulumi.Input[builtins.str]] = None,
            version_preference: Optional[pulumi.Input[builtins.str]] = None,
            vm_failover_reservation: Optional[pulumi.Input[builtins.int]] = None) -> 'AutonomousContainerDatabase':
        """
    ...
    @property
    @pulumi.getter(name="keyVersionId")
    def key_version_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The OCID of the key version that is used in rotate key operations.
        """
        return pulumi.get(self, "key_version_id")
    ...
    @property
    @pulumi.getter(name="peerAutonomousExadataInfrastructureId")
    def peer_autonomous_exadata_infrastructure_id(self) -> pulumi.Output[builtins.str]:
        """
        *No longer used.* This parameter is no longer used for Autonomous Database on dedicated Exadata infrasture. Specify a `peerCloudAutonomousVmClusterId` instead. Using this parameter will cause the operation to fail.
        """
        return pulumi.get(self, "peer_autonomous_exadata_infrastructure_id")
    ...
    @property
    @pulumi.getter(name="reinstateTrigger")
    def reinstate_trigger(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        (Updatable) An optional property when incremented triggers Reinstate. Could be set to any integer value.
        """
        return pulumi.get(self, "reinstate_trigger")
    ...
    @property
    @pulumi.getter(name="rotateKeyTrigger")
    def rotate_key_trigger(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        (Updatable) An optional property when flipped triggers rotation of KMS key. It is only applicable on dedicated container databases i.e. where `cloud_autonomous_vm_cluster_id` is set.
    ...
    @property
    @pulumi.getter(name="switchoverTrigger")
    def switchover_trigger(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        (Updatable) An optional property when incremented triggers Switchover. Could be set to any integer value.
        """
        return pulumi.get(self, "switchover_trigger")
