...
class AutonomousContainerDatabaseDataguardAssociationOperationArgs:
    def __init__(__self__, *,
                 autonomous_container_database_dataguard_association_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] autonomous_container_database_dataguard_association_id: The Autonomous Container Database Dataguard Association [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm). This attribute is a forcenew attribute.
        :param pulumi.Input[builtins.str] autonomous_container_database_id: The Autonomous Container Database [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm). This attribute is a forcenew attribute.
        :param pulumi.Input[builtins.str] operation: There are three type of supported operations `switchover`, `failover`, `reinstate`. `switchover` can only be used for primary database while `failover` and `reinstate` can only be used for standby database. This attribute is a forcenew attribute.
        """
    ...
    def autonomous_container_database_dataguard_association_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def autonomous_container_database_dataguard_association_id(self, value: pulumi.Input[builtins.str]):
...
class AutonomousContainerDatabaseDataguardAssociationOperation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            autonomous_container_database_dataguard_association_id: Optional[pulumi.Input[builtins.str]] = None,
            autonomous_container_database_id: Optional[pulumi.Input[builtins.str]] = None,
            operation: Optional[pulumi.Input[builtins.str]] = None) -> 'AutonomousContainerDatabaseDataguardAssociationOperation':
        """
