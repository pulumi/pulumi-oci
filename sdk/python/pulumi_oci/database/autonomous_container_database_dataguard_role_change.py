...
class AutonomousContainerDatabaseDataguardRoleChangeArgs:
    def __init__(__self__, *,
                 ...
                 connection_strings_type: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def connection_strings_type(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "connection_strings_type")

    @connection_strings_type.setter
    def connection_strings_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AutonomousContainerDatabaseDataguardRoleChange(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            autonomous_container_database_id: Optional[pulumi.Input[builtins.str]] = None,
            connection_strings_type: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None) -> 'AutonomousContainerDatabaseDataguardRoleChange':
        """
    ...
    @property
    @pulumi.getter(name="connectionStringsType")
    def connection_strings_type(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "connection_strings_type")
