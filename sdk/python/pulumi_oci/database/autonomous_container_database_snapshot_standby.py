...
class AutonomousContainerDatabaseSnapshotStandbyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connection_strings_type: type of connection strings when converting database to snapshot mode
        """
...
class AutonomousContainerDatabaseSnapshotStandby(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            autonomous_container_database_id: Optional[pulumi.Input[builtins.str]] = None,
            connection_strings_type: Optional[pulumi.Input[builtins.str]] = None,
            role: Optional[pulumi.Input[builtins.str]] = None) -> 'AutonomousContainerDatabaseSnapshotStandby':
        """
    ...
    @property
    @pulumi.getter(name="connectionStringsType")
    def connection_strings_type(self) -> pulumi.Output[builtins.str]:
        """
        type of connection strings when converting database to snapshot mode
        """
        return pulumi.get(self, "connection_strings_type")
