...
class AutonomousDatabaseBackupArgs:
    def __init__(__self__, *,
                 ...
                 is_long_term_backup: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] autonomous_database_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Autonomous Database backup.
        ...
        :param pulumi.Input[builtins.bool] is_long_term_backup: Indicates whether the backup is long-term
        :param pulumi.Input[builtins.int] retention_period_in_days: (Updatable) Retention period, in days, for long-term backups
    ...
    def is_long_term_backup(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_long_term_backup(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _AutonomousDatabaseBackupState:
    def __init__(__self__, *,
                 ...
                 database_size_in_tbs: Optional[pulumi.Input[builtins.float]] = None,
                 db_version: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 is_automatic: Optional[pulumi.Input[builtins.bool]] = None,
                 is_long_term_backup: Optional[pulumi.Input[builtins.bool]] = None,
                 is_restorable: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 retention_period_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 size_in_tbs: Optional[pulumi.Input[builtins.float]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 time_available_till: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.float] database_size_in_tbs: The size of the database in terabytes at the time the backup was taken.
        :param pulumi.Input[builtins.str] db_version: A valid Oracle Database version for Autonomous Database.
        :param pulumi.Input[builtins.str] display_name: The user-friendly name for the backup. The name does not have to be unique.
        :param pulumi.Input[builtins.bool] is_automatic: Indicates whether the backup is user-initiated or automatic.
        :param pulumi.Input[builtins.bool] is_long_term_backup: Indicates whether the backup is long-term
        :param pulumi.Input[builtins.bool] is_restorable: Indicates whether the backup can be used to restore the associated Autonomous Database.
        ...
        :param pulumi.Input[builtins.int] retention_period_in_days: (Updatable) Retention period, in days, for long-term backups
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.float] size_in_tbs: The backup size in terrabytes (TB).
        :param pulumi.Input[builtins.str] state: The current state of the backup.
        :param pulumi.Input[builtins.str] time_available_till: Timestamp until when the backup will be available
        :param pulumi.Input[builtins.str] time_ended: The date and time the backup completed.
    ...
    def database_size_in_tbs(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def database_size_in_tbs(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def is_restorable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_restorable(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def size_in_tbs(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    @size_in_tbs.setter
    def size_in_tbs(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def time_available_till(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_available_till(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AutonomousDatabaseBackup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_started: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            vault_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AutonomousDatabaseBackup':
        """
    ...
    @property
    @pulumi.getter(name="databaseSizeInTbs")
    def database_size_in_tbs(self) -> pulumi.Output[builtins.float]:
        """
        The size of the database in terabytes at the time the backup was taken.
        """
        return pulumi.get(self, "database_size_in_tbs")
    ...
    @property
    @pulumi.getter(name="isLongTermBackup")
    def is_long_term_backup(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the backup is long-term
        """
        return pulumi.get(self, "is_long_term_backup")
    ...
    @property
    @pulumi.getter(name="isRestorable")
    def is_restorable(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the backup can be used to restore the associated Autonomous Database.
        """
        return pulumi.get(self, "is_restorable")
    ...
    @property
    @pulumi.getter(name="sizeInTbs")
    def size_in_tbs(self) -> pulumi.Output[builtins.float]:
        """
        The backup size in terrabytes (TB).
        """
        return pulumi.get(self, "size_in_tbs")
    ...
    @property
    @pulumi.getter(name="timeAvailableTill")
    def time_available_till(self) -> pulumi.Output[builtins.str]:
        """
        Timestamp until when the backup will be available
        """
        return pulumi.get(self, "time_available_till")
