...
class AutonomousDatabaseInstanceWalletManagementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] autonomous_database_id: (Updatable) The database [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
...
class AutonomousDatabaseInstanceWalletManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            should_rotate: Optional[pulumi.Input[builtins.bool]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_rotated: Optional[pulumi.Input[builtins.str]] = None) -> 'AutonomousDatabaseInstanceWalletManagement':
        """
