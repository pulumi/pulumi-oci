...
class AutonomousDatabaseSaasAdminUserArgs:
    def __init__(__self__, *,
                 ...
                 time_saas_admin_user_enabled: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] access_type: The access type for the SaaS administrative user. If no access type is specified, the READ_ONLY access type is used.
        :param pulumi.Input[builtins.int] duration: How long, in hours, the SaaS administrative user will stay enabled. If no duration is specified, the default value 1 will be used.
        :param pulumi.Input[builtins.str] password: A strong password for SaaS administrative user. The password must be a minimum of nine (9) characters and contain a minimum of two (2) uppercase, two (2) lowercase, two (2) numbers, and two (2) special characters from _ (underscore), \\# (hashtag), or - (dash). The password is mandatory if "secret_id" is not present.
        :param pulumi.Input[builtins.str] secret_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Oracle Cloud Infrastructure [secret](https://docs.cloud.oracle.com/iaas/Content/KeyManagement/Concepts/keyoverview.htm#concepts). The secret is mandatory if "password" is not present.
        :param pulumi.Input[builtins.int] secret_version_number: The version of the vault secret. If no version is specified, the latest version will be used.
    ...
    def time_saas_admin_user_enabled(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "time_saas_admin_user_enabled")

    @time_saas_admin_user_enabled.setter
    def time_saas_admin_user_enabled(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AutonomousDatabaseSaasAdminUser(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            secret_id: Optional[pulumi.Input[builtins.str]] = None,
            secret_version_number: Optional[pulumi.Input[builtins.int]] = None,
            time_saas_admin_user_enabled: Optional[pulumi.Input[builtins.str]] = None) -> 'AutonomousDatabaseSaasAdminUser':
        """
    ...
    @property
    @pulumi.getter(name="secretVersionNumber")
    def secret_version_number(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The version of the vault secret. If no version is specified, the latest version will be used.
    ...
    @property
    @pulumi.getter(name="timeSaasAdminUserEnabled")
    def time_saas_admin_user_enabled(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "time_saas_admin_user_enabled")
