...
class _AutonomousDatabaseSoftwareImageState:
    def __init__(__self__, *,
                 autonomous_dsi_one_off_patches: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
    ...
    def autonomous_dsi_one_off_patches(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
    ...
    @source_cdb_id.setter
    def source_cdb_id(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "source_cdb_id", value)
...
class AutonomousDatabaseSoftwareImage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[_builtins.str]] = None,
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[_builtins.str]] = None) -> 'AutonomousDatabaseSoftwareImage':
        """
