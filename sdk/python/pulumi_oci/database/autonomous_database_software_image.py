...
class AutonomousDatabaseSoftwareImageArgs:
    def __init__(__self__, *,
                 ...
                 image_shape_family: pulumi.Input[builtins.str],
                 source_cdb_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] display_name: The user-friendly name for the Autonomous Database Software Image. The name does not have to be unique.
        :param pulumi.Input[builtins.str] image_shape_family: To what shape the image is meant for.
        :param pulumi.Input[builtins.str] source_cdb_id: The source Autonomous Container Database [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) from which to create Autonomous Database Software Image.
    ...
    def image_shape_family(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def image_shape_family(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "image_shape_family", value)

    @property
    @pulumi.getter(name="sourceCdbId")
    def source_cdb_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_cdb_id(self, value: pulumi.Input[builtins.str]):
...
class _AutonomousDatabaseSoftwareImageState:
    def __init__(__self__, *,
                 autonomous_dsi_one_off_patches: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] autonomous_dsi_one_off_patches: One-off patches included in the Autonomous Database Software Image
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param pulumi.Input[builtins.str] database_version: The database version with which the Autonomous Database Software Image is to be built.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[builtins.str] display_name: The user-friendly name for the Autonomous Database Software Image. The name does not have to be unique.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] image_shape_family: To what shape the image is meant for.
        :param pulumi.Input[builtins.str] lifecycle_details: Detailed message for the lifecycle state.
        :param pulumi.Input[builtins.str] release_update: The Release Updates.
        :param pulumi.Input[builtins.str] source_cdb_id: The source Autonomous Container Database [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) from which to create Autonomous Database Software Image.
    ...
    def autonomous_dsi_one_off_patches(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def autonomous_dsi_one_off_patches(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    @property
    @pulumi.getter(name="sourceCdbId")
    def source_cdb_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The source Autonomous Container Database [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) from which to create Autonomous Database Software Image.
    ...
    @source_cdb_id.setter
    def source_cdb_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_cdb_id", value)
...
class AutonomousDatabaseSoftwareImage(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="autonomousDsiOneOffPatches")
    def autonomous_dsi_one_off_patches(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        One-off patches included in the Autonomous Database Software Image
        """
        return pulumi.get(self, "autonomous_dsi_one_off_patches")
    ...
    @property
    @pulumi.getter(name="sourceCdbId")
    def source_cdb_id(self) -> pulumi.Output[builtins.str]:
        """
        The source Autonomous Container Database [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) from which to create Autonomous Database Software Image.
