...
class AutonomousDatabaseWalletArgs:
    def __init__(__self__, *,
                 ...
                 generate_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] autonomous_database_id: The database [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param pulumi.Input[builtins.str] password: The password to encrypt the keys inside the wallet. The password must be at least 8 characters long and must include at least 1 letter and either 1 numeric character or 1 special character.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] generate_type: The type of wallet to generate.
        ...
        :param pulumi.Input[builtins.bool] is_regional: True when requesting regional connection strings in PDB connect info, applicable to cross-region DG only.
        """
    ...
    def generate_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def generate_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AutonomousDatabaseWalletState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] autonomous_database_id: The database [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param pulumi.Input[builtins.str] content: content of the downloaded zipped wallet for the Autonomous Database. If `base64_encode_content` is set to `true`, then this content will be base64 encoded.
        :param pulumi.Input[builtins.str] generate_type: The type of wallet to generate.
...
class AutonomousDatabaseWallet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            generate_type: Optional[pulumi.Input[builtins.str]] = None,
            is_regional: Optional[pulumi.Input[builtins.bool]] = None,
            password: Optional[pulumi.Input[builtins.str]] = None) -> 'AutonomousDatabaseWallet':
        """
    ...
    @property
    @pulumi.getter(name="generateType")
    def generate_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The type of wallet to generate.
