...
class AutonomousVmClusterArgs:
    def __init__(__self__, *,
                 ...
                 vm_cluster_network_id: pulumi.Input[builtins.str],
                 ...
                 is_mtls_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: The user-friendly name for the Autonomous VM cluster. The name does not need to be unique.
        ...
        :param pulumi.Input[builtins.str] vm_cluster_network_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VM cluster network.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.float] autonomous_data_storage_size_in_tbs: (Updatable) The data disk group size to be allocated for Autonomous Databases, in TBs.
        :param pulumi.Input[builtins.str] compute_model: The compute model of the Autonomous VM Cluster. ECPU compute model is the recommended model and OCPU compute model is legacy.
        :param pulumi.Input[builtins.int] cpu_core_count_per_node: (Updatable) The number of CPU cores to enable per VM cluster node.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] db_servers: The list of [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Db servers.
        ...
        :param pulumi.Input[builtins.bool] is_local_backup_enabled: If true, database backup on local Exadata storage is configured for the Autonomous VM cluster. If false, database backup on local Exadata storage is not available in the Autonomous VM cluster.
        :param pulumi.Input[builtins.bool] is_mtls_enabled: Enable mutual TLS(mTLS) authentication for database while provisioning a VMCluster. Default is TLS.
        :param pulumi.Input[builtins.str] license_model: (Updatable) The Oracle license model that applies to the Autonomous VM cluster. The default is BRING_YOUR_OWN_LICENSE.
        ...
        :param pulumi.Input[builtins.str] time_zone: The time zone to use for the Autonomous VM cluster. For details, see [DB System Time Zones](https://docs.cloud.oracle.com/iaas/Content/Database/References/timezones.htm).
    ...
    def vm_cluster_network_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def vm_cluster_network_id(self, value: pulumi.Input[builtins.str]):
    ...
    def is_mtls_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_mtls_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _AutonomousVmClusterState:
    def __init__(__self__, *,
                 autonomous_data_storage_percentage: Optional[pulumi.Input[builtins.float]] = None,
                 autonomous_data_storage_size_in_tbs: Optional[pulumi.Input[builtins.float]] = None,
                 available_autonomous_data_storage_size_in_tbs: Optional[pulumi.Input[builtins.float]] = None,
                 available_container_databases: Optional[pulumi.Input[builtins.int]] = None,
                 available_cpus: Optional[pulumi.Input[builtins.int]] = None,
                 available_data_storage_size_in_tbs: Optional[pulumi.Input[builtins.float]] = None,
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 compute_model: Optional[pulumi.Input[builtins.str]] = None,
                 cpu_core_count_per_node: Optional[pulumi.Input[builtins.int]] = None,
                 cpu_percentage: Optional[pulumi.Input[builtins.float]] = None,
                 cpus_enabled: Optional[pulumi.Input[builtins.int]] = None,
                 cpus_lowest_scaled_value: Optional[pulumi.Input[builtins.int]] = None,
                 data_storage_size_in_gb: Optional[pulumi.Input[builtins.float]] = None,
                 ...
                 exadata_storage_in_tbs_lowest_scaled_value: Optional[pulumi.Input[builtins.float]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_local_backup_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_mtls_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 max_acds_lowest_scaled_value: Optional[pulumi.Input[builtins.int]] = None,
                 memory_per_oracle_compute_unit_in_gbs: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 non_provisionable_autonomous_container_databases: Optional[pulumi.Input[builtins.int]] = None,
                 ocpus_enabled: Optional[pulumi.Input[builtins.float]] = None,
                 ...
                 reclaimable_cpus: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 time_zone: Optional[pulumi.Input[builtins.str]] = None,
                 total_autonomous_data_storage_in_tbs: Optional[pulumi.Input[builtins.float]] = None,
                 total_container_databases: Optional[pulumi.Input[builtins.int]] = None,
                 vm_cluster_network_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering AutonomousVmCluster resources.
        :param pulumi.Input[builtins.float] autonomous_data_storage_size_in_tbs: (Updatable) The data disk group size to be allocated for Autonomous Databases, in TBs.
        :param pulumi.Input[builtins.float] available_autonomous_data_storage_size_in_tbs: The data disk group size available for Autonomous Databases, in TBs.
        :param pulumi.Input[builtins.int] available_container_databases: The number of Autonomous Container Databases that can be created with the currently available local storage.
        :param pulumi.Input[builtins.int] available_cpus: The numnber of CPU cores available.
        :param pulumi.Input[builtins.float] available_data_storage_size_in_tbs: **Deprecated.** Use `availableAutonomousDataStorageSizeInTBs` for Autonomous Databases' data storage availability in TBs.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param pulumi.Input[builtins.str] compute_model: The compute model of the Autonomous VM Cluster. ECPU compute model is the recommended model and OCPU compute model is legacy.
        :param pulumi.Input[builtins.int] cpu_core_count_per_node: (Updatable) The number of CPU cores to enable per VM cluster node.
        :param pulumi.Input[builtins.int] cpus_enabled: The number of enabled CPU cores.
        :param pulumi.Input[builtins.float] data_storage_size_in_tbs: The total data storage allocated in TBs
        :param pulumi.Input[builtins.int] db_node_storage_size_in_gbs: The local node storage allocated in GBs.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] db_servers: The list of [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Db servers.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[builtins.str] display_name: The user-friendly name for the Autonomous VM cluster. The name does not need to be unique.
        :param pulumi.Input[builtins.str] exadata_infrastructure_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata infrastructure.
        :param pulumi.Input[builtins.float] exadata_storage_in_tbs_lowest_scaled_value: The lowest value to which exadataStorage(in TBs) can be scaled down.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] is_local_backup_enabled: If true, database backup on local Exadata storage is configured for the Autonomous VM cluster. If false, database backup on local Exadata storage is not available in the Autonomous VM cluster.
        :param pulumi.Input[builtins.bool] is_mtls_enabled: Enable mutual TLS(mTLS) authentication for database while provisioning a VMCluster. Default is TLS.
        ...
        :param pulumi.Input[builtins.int] max_acds_lowest_scaled_value: The lowest value to which maximum number of ACDs can be scaled down.
        :param pulumi.Input[builtins.int] memory_per_oracle_compute_unit_in_gbs: The amount of memory (in GBs) to be enabled per OCPU or ECPU.
        :param pulumi.Input[builtins.int] memory_size_in_gbs: The memory allocated in GBs.
        ...
        :param pulumi.Input[builtins.int] node_count: The number of nodes in the Autonomous VM Cluster.
        :param pulumi.Input[builtins.float] ocpus_enabled: The number of enabled OCPU cores.
        :param pulumi.Input[builtins.int] provisionable_autonomous_container_databases: **Deprecated.** Use field totalContainerDatabases.
        ...
        :param pulumi.Input[builtins.int] reclaimable_cpus: For Autonomous Databases on Dedicated Exadata Infrastructure:
               * These are the CPUs that continue to be included in the count of CPUs available to the Autonomous Container Database even after one of its Autonomous Database is terminated or scaled down. You can release them to the available CPUs at its parent Autonomous VM Cluster level by restarting the Autonomous Container Database.
               * The CPU type (OCPUs or ECPUs) is determined by the parent Autonomous Exadata VM Cluster's compute model.
        :param pulumi.Input[builtins.float] reserved_cpus: The number of CPUs reserved in an Autonomous VM Cluster.
        :param pulumi.Input[builtins.int] scan_listener_port_non_tls: The SCAN Listener Non TLS port number. Default value is 1521.
        :param pulumi.Input[builtins.int] scan_listener_port_tls: The SCAN Listener TLS port number. Default value is 2484.
    ...
    def autonomous_data_storage_percentage(self) -> Optional[pulumi.Input[builtins.float]]:
        return pulumi.get(self, "autonomous_data_storage_percentage")

    @autonomous_data_storage_percentage.setter
    def autonomous_data_storage_percentage(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def available_autonomous_data_storage_size_in_tbs(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def available_autonomous_data_storage_size_in_tbs(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "available_autonomous_data_storage_size_in_tbs", value)

    @property
    @pulumi.getter(name="availableContainerDatabases")
    def available_container_databases(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def available_container_databases(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "available_container_databases", value)

    @property
    @pulumi.getter(name="availableCpus")
    def available_cpus(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def available_cpus(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "available_cpus", value)

    @property
    @pulumi.getter(name="availableDataStorageSizeInTbs")
    def available_data_storage_size_in_tbs(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def available_data_storage_size_in_tbs(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def cpu_percentage(self) -> Optional[pulumi.Input[builtins.float]]:
        return pulumi.get(self, "cpu_percentage")

    @cpu_percentage.setter
    def cpu_percentage(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "cpu_percentage", value)

    @property
    @pulumi.getter(name="cpusEnabled")
    def cpus_enabled(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @cpus_enabled.setter
    def cpus_enabled(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "cpus_enabled", value)

    @property
    @pulumi.getter(name="cpusLowestScaledValue")
    def cpus_lowest_scaled_value(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "cpus_lowest_scaled_value")

    @cpus_lowest_scaled_value.setter
    def cpus_lowest_scaled_value(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "cpus_lowest_scaled_value", value)

    @property
    @pulumi.getter(name="dataStorageSizeInGb")
    def data_storage_size_in_gb(self) -> Optional[pulumi.Input[builtins.float]]:
        return pulumi.get(self, "data_storage_size_in_gb")

    @data_storage_size_in_gb.setter
    def data_storage_size_in_gb(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def exadata_storage_in_tbs_lowest_scaled_value(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def exadata_storage_in_tbs_lowest_scaled_value(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def max_acds_lowest_scaled_value(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_acds_lowest_scaled_value(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def non_provisionable_autonomous_container_databases(self) -> Optional[pulumi.Input[builtins.int]]:
    ...
    def non_provisionable_autonomous_container_databases(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "non_provisionable_autonomous_container_databases", value)

    @property
    @pulumi.getter(name="ocpusEnabled")
    def ocpus_enabled(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def ocpus_enabled(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def provisionable_autonomous_container_databases(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def provisioned_autonomous_container_databases(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def provisioned_autonomous_container_databases(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def reclaimable_cpus(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def reclaimable_cpus(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def time_database_ssl_certificate_expires(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_database_ssl_certificate_expires(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_database_ssl_certificate_expires", value)

    @property
    @pulumi.getter(name="timeOrdsCertificateExpires")
    def time_ords_certificate_expires(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_ords_certificate_expires(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def total_autonomous_data_storage_in_tbs(self) -> Optional[pulumi.Input[builtins.float]]:
        return pulumi.get(self, "total_autonomous_data_storage_in_tbs")

    @total_autonomous_data_storage_in_tbs.setter
    def total_autonomous_data_storage_in_tbs(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    @property
    @pulumi.getter(name="vmClusterNetworkId")
    def vm_cluster_network_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VM cluster network.
    ...
    @vm_cluster_network_id.setter
    def vm_cluster_network_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vm_cluster_network_id", value)
...
class AutonomousVmCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            total_autonomous_data_storage_in_tbs: Optional[pulumi.Input[builtins.float]] = None,
            total_container_databases: Optional[pulumi.Input[builtins.int]] = None,
            vm_cluster_network_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AutonomousVmCluster':
        """
    ...
    @property
    @pulumi.getter(name="autonomousDataStorageSizeInTbs")
    def autonomous_data_storage_size_in_tbs(self) -> pulumi.Output[builtins.float]:
        """
        (Updatable) The data disk group size to be allocated for Autonomous Databases, in TBs.
        """
        return pulumi.get(self, "autonomous_data_storage_size_in_tbs")
    ...
    @property
    @pulumi.getter(name="availableCpus")
    def available_cpus(self) -> pulumi.Output[builtins.int]:
        """
        The numnber of CPU cores available.
        """
        return pulumi.get(self, "available_cpus")
    ...
    @property
    @pulumi.getter(name="availableDataStorageSizeInTbs")
    def available_data_storage_size_in_tbs(self) -> pulumi.Output[builtins.float]:
        """
        **Deprecated.** Use `availableAutonomousDataStorageSizeInTBs` for Autonomous Databases' data storage availability in TBs.
        """
        return pulumi.get(self, "available_data_storage_size_in_tbs")
    ...
    @property
    @pulumi.getter(name="cpuCoreCountPerNode")
    def cpu_core_count_per_node(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The number of CPU cores to enable per VM cluster node.
        """
        return pulumi.get(self, "cpu_core_count_per_node")
    ...
    @property
    @pulumi.getter(name="cpusEnabled")
    def cpus_enabled(self) -> pulumi.Output[builtins.int]:
        """
        The number of enabled CPU cores.
        """
        return pulumi.get(self, "cpus_enabled")
    ...
    @property
    @pulumi.getter(name="cpusLowestScaledValue")
    def cpus_lowest_scaled_value(self) -> pulumi.Output[builtins.int]:
        return pulumi.get(self, "cpus_lowest_scaled_value")

    @property
    @pulumi.getter(name="dataStorageSizeInGb")
    def data_storage_size_in_gb(self) -> pulumi.Output[builtins.float]:
        return pulumi.get(self, "data_storage_size_in_gb")
    ...
    @property
    @pulumi.getter(name="dbServers")
    def db_servers(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The list of [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Db servers.
        """
        return pulumi.get(self, "db_servers")
    ...
    @property
    @pulumi.getter(name="isLocalBackupEnabled")
    def is_local_backup_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        If true, database backup on local Exadata storage is configured for the Autonomous VM cluster. If false, database backup on local Exadata storage is not available in the Autonomous VM cluster.
        """
        return pulumi.get(self, "is_local_backup_enabled")
    ...
    @property
    @pulumi.getter(name="isMtlsEnabled")
    def is_mtls_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Enable mutual TLS(mTLS) authentication for database while provisioning a VMCluster. Default is TLS.
        """
        return pulumi.get(self, "is_mtls_enabled")
    ...
    @property
    @pulumi.getter(name="ocpusEnabled")
    def ocpus_enabled(self) -> pulumi.Output[builtins.float]:
        """
        The number of enabled OCPU cores.
        """
        return pulumi.get(self, "ocpus_enabled")
    ...
    @property
    @pulumi.getter(name="reclaimableCpus")
    def reclaimable_cpus(self) -> pulumi.Output[builtins.int]:
        """
        For Autonomous Databases on Dedicated Exadata Infrastructure:
        * These are the CPUs that continue to be included in the count of CPUs available to the Autonomous Container Database even after one of its Autonomous Database is terminated or scaled down. You can release them to the available CPUs at its parent Autonomous VM Cluster level by restarting the Autonomous Container Database.
        * The CPU type (OCPUs or ECPUs) is determined by the parent Autonomous Exadata VM Cluster's compute model.
    ...
    @property
    @pulumi.getter(name="scanListenerPortNonTls")
    def scan_listener_port_non_tls(self) -> pulumi.Output[builtins.int]:
        """
        The SCAN Listener Non TLS port number. Default value is 1521.
        """
        return pulumi.get(self, "scan_listener_port_non_tls")
    ...
    @property
    @pulumi.getter(name="scanListenerPortTls")
    def scan_listener_port_tls(self) -> pulumi.Output[builtins.int]:
        """
        The SCAN Listener TLS port number. Default value is 2484.
        """
        return pulumi.get(self, "scan_listener_port_tls")
    ...
    @property
    @pulumi.getter(name="timeDatabaseSslCertificateExpires")
    def time_database_ssl_certificate_expires(self) -> pulumi.Output[builtins.str]:
        """
        The date and time of Database SSL certificate expiration.
        """
        return pulumi.get(self, "time_database_ssl_certificate_expires")
    ...
    @property
    @pulumi.getter(name="timeOrdsCertificateExpires")
    def time_ords_certificate_expires(self) -> pulumi.Output[builtins.str]:
        """
        The date and time of ORDS certificate expiration.
        """
        return pulumi.get(self, "time_ords_certificate_expires")
    ...
    @property
    @pulumi.getter(name="totalAutonomousDataStorageInTbs")
    def total_autonomous_data_storage_in_tbs(self) -> pulumi.Output[builtins.float]:
        return pulumi.get(self, "total_autonomous_data_storage_in_tbs")

    @property
    @pulumi.getter(name="totalContainerDatabases")
    def total_container_databases(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The total number of Autonomous Container Databases that can be created.
        """
        return pulumi.get(self, "total_container_databases")
    ...
    @property
    @pulumi.getter(name="vmClusterNetworkId")
    def vm_cluster_network_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VM cluster network.
