...
class AutonomousVmClusterOrdsCertificateManagementArgs:
    def __init__(__self__, *,
        ...
        """
        AutonomousVmClusterOrdsCertificateManagementArgs._configure(
    ...
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] certificate_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the certificate to use. 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        """
        _AutonomousVmClusterOrdsCertificateManagementState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            autonomous_vm_cluster_id=autonomous_vm_cluster_id,
            ca_bundle_id=ca_bundle_id,
            certificate_authority_id=certificate_authority_id,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            AutonomousVmClusterOrdsCertificateManagementArgs._configure(_setter, **kwargs)
