...
class BackupDestinationArgs:
    def __init__(__self__, *,
                 ...
                 local_mount_point_path: Optional[pulumi.Input[builtins.str]] = None,
                 mount_type_details: Optional[pulumi.Input['BackupDestinationMountTypeDetailsArgs']] = None,
                 vpc_users: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] display_name: The user-provided name of the backup destination.
        :param pulumi.Input[builtins.str] type: Type of the backup destination.
        :param pulumi.Input[builtins.str] connection_string: (Updatable) The connection string for connecting to the Recovery Appliance.
        ...
        :param pulumi.Input[builtins.str] local_mount_point_path: (Updatable) **Deprecated.** The local directory path on each VM cluster node where the NFS server location is mounted. The local directory path and the NFS server location must each be the same across all of the VM cluster nodes. Ensure that the NFS mount is maintained continuously on all of the VM cluster nodes. This field is deprecated. Use the mountTypeDetails field instead to specify the mount type for NFS.
        :param pulumi.Input['BackupDestinationMountTypeDetailsArgs'] mount_type_details: Mount type details for backup destination.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vpc_users: (Updatable) The Virtual Private Catalog (VPC) users that are used to access the Recovery Appliance.
    ...
    def local_mount_point_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def local_mount_point_path(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def vpc_users(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @vpc_users.setter
    def vpc_users(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _BackupDestinationState:
    def __init__(__self__, *,
                 ...
                 local_mount_point_path: Optional[pulumi.Input[builtins.str]] = None,
                 mount_type_details: Optional[pulumi.Input['BackupDestinationMountTypeDetailsArgs']] = None,
                 nfs_mount_type: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 utilized_storage_size_in_gbs: Optional[pulumi.Input[builtins.int]] = None,
                 vpc_users: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] display_name: The user-provided name of the backup destination.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] lifecycle_details: A descriptive text associated with the lifecycleState. Typically contains additional displayable text
        :param pulumi.Input[builtins.str] local_mount_point_path: (Updatable) **Deprecated.** The local directory path on each VM cluster node where the NFS server location is mounted. The local directory path and the NFS server location must each be the same across all of the VM cluster nodes. Ensure that the NFS mount is maintained continuously on all of the VM cluster nodes. This field is deprecated. Use the mountTypeDetails field instead to specify the mount type for NFS.
        :param pulumi.Input['BackupDestinationMountTypeDetailsArgs'] mount_type_details: Mount type details for backup destination.
        :param pulumi.Input[builtins.str] nfs_mount_type: NFS Mount type for backup destination.
        ...
        :param pulumi.Input[builtins.str] type: Type of the backup destination.
        :param pulumi.Input[builtins.int] utilized_storage_size_in_gbs: The total amount of space utilized on the backup destination (in GBs), rounded to the nearest integer.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vpc_users: (Updatable) The Virtual Private Catalog (VPC) users that are used to access the Recovery Appliance.
    ...
    def nfs_mount_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nfs_mount_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "nfs_mount_type", value)

    @property
    @pulumi.getter(name="nfsServerExport")
    def nfs_server_export(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nfs_server_export(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "nfs_server_export", value)

    @property
    @pulumi.getter(name="nfsServers")
    def nfs_servers(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @nfs_servers.setter
    def nfs_servers(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def time_at_which_storage_details_are_updated(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_at_which_storage_details_are_updated(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def utilized_storage_size_in_gbs(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def utilized_storage_size_in_gbs(self, value: Optional[pulumi.Input[builtins.int]]):
...
class BackupDestination(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            utilized_storage_size_in_gbs: Optional[pulumi.Input[builtins.int]] = None,
            vpc_users: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'BackupDestination':
        """
    ...
    @pulumi.getter(name="localMountPointPath")
    @_utilities.deprecated("""The 'local_mount_point_path' field has been deprecated. Please use 'local_mount_point_path under mount_type_details' instead.""")
    def local_mount_point_path(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) **Deprecated.** The local directory path on each VM cluster node where the NFS server location is mounted. The local directory path and the NFS server location must each be the same across all of the VM cluster nodes. Ensure that the NFS mount is maintained continuously on all of the VM cluster nodes. This field is deprecated. Use the mountTypeDetails field instead to specify the mount type for NFS.
        """
        return pulumi.get(self, "local_mount_point_path")
    ...
    @property
    @pulumi.getter(name="nfsMountType")
    def nfs_mount_type(self) -> pulumi.Output[builtins.str]:
        """
        NFS Mount type for backup destination.
        """
        return pulumi.get(self, "nfs_mount_type")
    ...
    @property
    @pulumi.getter(name="nfsServerExport")
    def nfs_server_export(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the directory on which to mount the file system
        """
        return pulumi.get(self, "nfs_server_export")
    ...
    @property
    @pulumi.getter(name="nfsServers")
    def nfs_servers(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Host names or IP addresses for NFS Auto mount.
        """
        return pulumi.get(self, "nfs_servers")
    ...
    @property
    @pulumi.getter(name="timeAtWhichStorageDetailsAreUpdated")
    def time_at_which_storage_details_are_updated(self) -> pulumi.Output[builtins.str]:
        """
        The time when the total storage size and the utilized storage size of the backup destination are updated.
        """
        return pulumi.get(self, "time_at_which_storage_details_are_updated")
    ...
    @property
    @pulumi.getter(name="utilizedStorageSizeInGbs")
    def utilized_storage_size_in_gbs(self) -> pulumi.Output[builtins.int]:
        """
        The total amount of space utilized on the backup destination (in GBs), rounded to the nearest integer.
        """
        return pulumi.get(self, "utilized_storage_size_in_gbs")
    ...
    @property
    @pulumi.getter(name="vpcUsers")
    def vpc_users(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        (Updatable) The Virtual Private Catalog (VPC) users that are used to access the Recovery Appliance.
