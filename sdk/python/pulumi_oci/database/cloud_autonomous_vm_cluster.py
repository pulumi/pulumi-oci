...
class CloudAutonomousVmClusterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] cloud_exadata_infrastructure_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the cloud Exadata infrastructure.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The user-friendly name for the cloud Autonomous VM cluster. The name does not need to be unique.
        ...
        :param pulumi.Input[builtins.str] cluster_time_zone: The time zone to use for the Cloud Autonomous VM cluster. For details, see [DB System Time Zones](https://docs.cloud.oracle.com/iaas/Content/Database/References/timezones.htm).
        :param pulumi.Input[builtins.str] compute_model: The compute model of the Cloud Autonomous VM Cluster.
        :param pulumi.Input[builtins.int] cpu_core_count_per_node: (Updatable) The number of CPU cores to be enabled per VM cluster node.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] db_servers: The list of database servers.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) User defined description of the cloud Autonomous VM cluster.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] is_mtls_enabled_vm_cluster: Enable mutual TLS(mTLS) authentication for database at time of provisioning a VMCluster. This is applicable to database TLS Certificates only. Default is TLS
...
class _CloudAutonomousVmClusterState:
    def __init__(__self__, *,
                 ...
                 total_container_databases: Optional[pulumi.Input[builtins.int]] = None,
                 total_cpus: Optional[pulumi.Input[builtins.float]] = None):
        """
        Input properties used for looking up and filtering CloudAutonomousVmCluster resources.
        :param pulumi.Input[builtins.float] autonomous_data_storage_percentage: The percentage of the data storage used for the Autonomous Databases in an Autonomous VM Cluster.
        :param pulumi.Input[builtins.float] autonomous_data_storage_size_in_tbs: (Updatable) The data disk group size to be allocated for Autonomous Databases, in TBs.
        :param pulumi.Input[builtins.str] availability_domain: The name of the availability domain that the cloud Autonomous VM cluster is located in.
        ...
        :param pulumi.Input[builtins.float] available_cpus: CPU cores available for allocation to Autonomous Databases.
        :param pulumi.Input[builtins.str] cloud_exadata_infrastructure_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the cloud Exadata infrastructure.
        :param pulumi.Input[builtins.str] cluster_time_zone: The time zone to use for the Cloud Autonomous VM cluster. For details, see [DB System Time Zones](https://docs.cloud.oracle.com/iaas/Content/Database/References/timezones.htm).
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param pulumi.Input[builtins.str] compute_model: The compute model of the Cloud Autonomous VM Cluster.
        :param pulumi.Input[builtins.int] cpu_core_count: The number of CPU cores on the cloud Autonomous VM cluster.
        :param pulumi.Input[builtins.int] cpu_core_count_per_node: (Updatable) The number of CPU cores to be enabled per VM cluster node.
        :param pulumi.Input[builtins.float] cpu_percentage: The percentage of total number of CPUs used in an Autonomous VM Cluster.
        :param pulumi.Input[builtins.float] data_storage_size_in_gb: The total data storage allocated, in gigabytes (GB).
        :param pulumi.Input[builtins.float] data_storage_size_in_tbs: The total data storage allocated, in terabytes (TB).
        :param pulumi.Input[builtins.int] db_node_storage_size_in_gbs: The local node storage allocated in GBs.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] db_servers: The list of database servers.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[builtins.str] description: (Updatable) User defined description of the cloud Autonomous VM cluster.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The user-friendly name for the cloud Autonomous VM cluster. The name does not need to be unique.
        :param pulumi.Input[builtins.str] domain: The domain name for the cloud Autonomous VM cluster.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] hostname: The hostname for the cloud Autonomous VM cluster.
        :param pulumi.Input[builtins.bool] is_mtls_enabled_vm_cluster: Enable mutual TLS(mTLS) authentication for database at time of provisioning a VMCluster. This is applicable to database TLS Certificates only. Default is TLS
        ...
        :param pulumi.Input[builtins.str] last_update_history_entry_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the last maintenance update history. This value is updated when a maintenance update starts.
        :param pulumi.Input[builtins.str] license_model: (Updatable) The Oracle license model that applies to the Oracle Autonomous Database. Bring your own license (BYOL) allows you to apply your current on-premises Oracle software licenses to equivalent, highly automated Oracle services in the cloud. License Included allows you to subscribe to new Oracle Database software licenses and the Oracle Database service. Note that when provisioning an [Autonomous Database on dedicated Exadata infrastructure](https://docs.oracle.com/en/cloud/paas/autonomous-database/index.html), this attribute must be null. It is already set at the Autonomous Exadata Infrastructure level. When provisioning an [Autonomous Database Serverless] (https://docs.oracle.com/en/cloud/paas/autonomous-database/index.html) database, if a value is not specified, the system defaults the value to `BRING_YOUR_OWN_LICENSE`. Bring your own license (BYOL) also allows you to select the DB edition using the optional parameter.
        ...
        :param pulumi.Input[builtins.int] node_count: The number of database servers in the cloud VM cluster.
        :param pulumi.Input[builtins.int] non_provisionable_autonomous_container_databases: The number of non-provisionable Autonomous Container Databases in an Autonomous VM Cluster.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] nsg_ids: (Updatable) The list of [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for the network security groups (NSGs) to which this resource belongs. Setting this to an empty list removes all resources from all NSGs. For more information about NSGs, see [Security Rules](https://docs.cloud.oracle.com/iaas/Content/Network/Concepts/securityrules.htm). **NsgIds restrictions:**
               * A network security group (NSG) is optional for Autonomous Databases with private access. The nsgIds list can be empty.
        ...
        :param pulumi.Input[builtins.str] time_updated: The last date and time that the cloud Autonomous VM cluster was updated.
        :param pulumi.Input[builtins.float] total_autonomous_data_storage_in_tbs: The total data disk group size for Autonomous Databases, in TBs.
        :param pulumi.Input[builtins.int] total_container_databases: (Updatable) The total number of Autonomous Container Databases that can be created.
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.float] total_cpus: The total number of CPUs in an Autonomous VM Cluster.
        """
    ...
    def ocpus_lowest_scaled_value(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def ocpus_lowest_scaled_value(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def total_cpus(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    @total_cpus.setter
    def total_cpus(self, value: Optional[pulumi.Input[builtins.float]]):
...
class CloudAutonomousVmCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            total_autonomous_data_storage_in_tbs: Optional[pulumi.Input[builtins.float]] = None,
            total_container_databases: Optional[pulumi.Input[builtins.int]] = None,
            total_cpus: Optional[pulumi.Input[builtins.float]] = None) -> 'CloudAutonomousVmCluster':
        """
    ...
    @property
    @pulumi.getter(name="isMtlsEnabledVmCluster")
    def is_mtls_enabled_vm_cluster(self) -> pulumi.Output[builtins.bool]:
        """
        Enable mutual TLS(mTLS) authentication for database at time of provisioning a VMCluster. This is applicable to database TLS Certificates only. Default is TLS
        """
        return pulumi.get(self, "is_mtls_enabled_vm_cluster")
    ...
    @property
    @pulumi.getter(name="ocpusLowestScaledValue")
    def ocpus_lowest_scaled_value(self) -> pulumi.Output[builtins.int]:
        """
        The lowest value to which ocpus can be scaled down.
        """
        return pulumi.get(self, "ocpus_lowest_scaled_value")
    ...
    @property
    @pulumi.getter(name="timeUpdated")
    def time_updated(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The last date and time that the cloud Autonomous VM cluster was updated.
        """
        return pulumi.get(self, "time_updated")
    ...
    @property
    @pulumi.getter(name="totalCpus")
    def total_cpus(self) -> pulumi.Output[builtins.float]:
        """
        The total number of CPUs in an Autonomous VM Cluster.
        """
        return pulumi.get(self, "total_cpus")
