...
class CloudExadataInfrastructureArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] availability_domain: The availability domain where the cloud Exadata infrastructure is located.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The user-friendly name for the cloud Exadata infrastructure resource. The name does not need to be unique.
        :param pulumi.Input[builtins.str] shape: The shape of the cloud Exadata infrastructure resource.
        ...
        :param pulumi.Input[builtins.int] compute_count: (Updatable) The number of compute servers for the cloud Exadata infrastructure.
        ...
        :param pulumi.Input[builtins.str] database_server_type: The database server type of the Exadata infrastructure.
        ...
        :param pulumi.Input[builtins.int] storage_count: (Updatable) The number of storage servers for the cloud Exadata infrastructure.
...
class _CloudExadataInfrastructureState:
    def __init__(__self__, *,
                 activated_storage_count: Optional[pulumi.Input[builtins.int]] = None,
                 additional_storage_count: Optional[pulumi.Input[builtins.int]] = None,
                 availability_domain: Optional[pulumi.Input[builtins.str]] = None,
                 available_storage_size_in_gbs: Optional[pulumi.Input[builtins.int]] = None,
                 cluster_placement_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 db_server_version: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_scheduling_policy_associated: Optional[pulumi.Input[builtins.bool]] = None,
                 last_maintenance_run_id: Optional[pulumi.Input[builtins.str]] = None,
                 lifecycle_details: Optional[pulumi.Input[builtins.str]] = None,
                 maintenance_window: Optional[pulumi.Input['CloudExadataInfrastructureMaintenanceWindowArgs']] = None,
                 max_cpu_count: Optional[pulumi.Input[builtins.int]] = None,
                 max_data_storage_in_tbs: Optional[pulumi.Input[builtins.float]] = None,
                 max_db_node_storage_in_gbs: Optional[pulumi.Input[builtins.int]] = None,
                 max_memory_in_gbs: Optional[pulumi.Input[builtins.int]] = None,
                 memory_size_in_gbs: Optional[pulumi.Input[builtins.int]] = None,
                 monthly_db_server_version: Optional[pulumi.Input[builtins.str]] = None,
                 monthly_storage_server_version: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] availability_domain: The availability domain where the cloud Exadata infrastructure is located.
        :param pulumi.Input[builtins.int] available_storage_size_in_gbs: The available storage can be allocated to the cloud Exadata infrastructure resource, in gigabytes (GB).
        :param pulumi.Input[builtins.str] cluster_placement_group_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the cluster placement group of the Exadata Infrastructure.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param pulumi.Input[builtins.int] compute_count: (Updatable) The number of compute servers for the cloud Exadata infrastructure.
        :param pulumi.Input[builtins.str] compute_model: The compute model of the Exadata infrastructure.
        :param pulumi.Input[builtins.int] cpu_count: The total number of CPU cores allocated.
        :param pulumi.Input[Sequence[pulumi.Input['CloudExadataInfrastructureCustomerContactArgs']]] customer_contacts: (Updatable) Customer contacts.
        :param pulumi.Input[builtins.float] data_storage_size_in_tbs: Size, in terabytes, of the DATA disk group.
        :param pulumi.Input[builtins.str] database_server_type: The database server type of the Exadata infrastructure.
        :param pulumi.Input[builtins.int] db_node_storage_size_in_gbs: The local node storage allocated in GBs.
        :param pulumi.Input[builtins.str] db_server_version: The software version of the database servers (dom0) in the cloud Exadata infrastructure. Example: 20.1.15
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The user-friendly name for the cloud Exadata infrastructure resource. The name does not need to be unique.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] is_scheduling_policy_associated: If true, the infrastructure is using granular maintenance scheduling preference.
        ...
        :param pulumi.Input['CloudExadataInfrastructureMaintenanceWindowArgs'] maintenance_window: (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        :param pulumi.Input[builtins.int] max_cpu_count: The total number of CPU cores available.
        :param pulumi.Input[builtins.float] max_data_storage_in_tbs: The total available DATA disk group size.
        :param pulumi.Input[builtins.int] max_db_node_storage_in_gbs: The total local node storage available in GBs.
        :param pulumi.Input[builtins.int] max_memory_in_gbs: The total memory available in GBs.
        :param pulumi.Input[builtins.int] memory_size_in_gbs: The memory allocated in GBs.
        :param pulumi.Input[builtins.str] monthly_db_server_version: The monthly software version of the database servers (dom0) in the cloud Exadata infrastructure. Example: 20.1.15
        :param pulumi.Input[builtins.str] monthly_storage_server_version: The monthly software version of the storage servers (cells) in the cloud Exadata infrastructure. Example: 20.1.15
        ...
        :param pulumi.Input[builtins.str] shape: The shape of the cloud Exadata infrastructure resource.
        :param pulumi.Input[builtins.str] state: The current lifecycle state of the cloud Exadata infrastructure resource.
        :param pulumi.Input[builtins.int] storage_count: (Updatable) The number of storage servers for the cloud Exadata infrastructure.
        :param pulumi.Input[builtins.str] storage_server_type: The storage server type of the Exadata infrastructure.
        :param pulumi.Input[builtins.str] storage_server_version: The software version of the storage servers (cells) in the cloud Exadata infrastructure. Example: 20.1.15
        :param pulumi.Input[builtins.str] subscription_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subscription with which resource needs to be associated with.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the cloud Exadata infrastructure resource was created.
        :param pulumi.Input[builtins.int] total_storage_size_in_gbs: The total storage allocated to the cloud Exadata infrastructure resource, in gigabytes (GB).
        """
    ...
    def activated_storage_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def activated_storage_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "activated_storage_count", value)

    @property
    @pulumi.getter(name="additionalStorageCount")
    def additional_storage_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def additional_storage_count(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def available_storage_size_in_gbs(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def available_storage_size_in_gbs(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def db_server_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def db_server_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_scheduling_policy_associated(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_scheduling_policy_associated(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def max_cpu_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_cpu_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_cpu_count", value)

    @property
    @pulumi.getter(name="maxDataStorageInTbs")
    def max_data_storage_in_tbs(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def max_data_storage_in_tbs(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "max_data_storage_in_tbs", value)

    @property
    @pulumi.getter(name="maxDbNodeStorageInGbs")
    def max_db_node_storage_in_gbs(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_db_node_storage_in_gbs(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_db_node_storage_in_gbs", value)

    @property
    @pulumi.getter(name="maxMemoryInGbs")
    def max_memory_in_gbs(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_memory_in_gbs(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def monthly_db_server_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def monthly_db_server_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "monthly_db_server_version", value)

    @property
    @pulumi.getter(name="monthlyStorageServerVersion")
    def monthly_storage_server_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def monthly_storage_server_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def storage_server_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def storage_server_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def total_storage_size_in_gbs(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def total_storage_size_in_gbs(self, value: Optional[pulumi.Input[builtins.int]]):
...
class CloudExadataInfrastructure(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            total_storage_size_in_gbs: Optional[pulumi.Input[builtins.int]] = None) -> 'CloudExadataInfrastructure':
        """
    ...
    @property
    @pulumi.getter(name="computeCount")
    def compute_count(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The number of compute servers for the cloud Exadata infrastructure.
        """
        return pulumi.get(self, "compute_count")
    ...
    @property
    @pulumi.getter(name="databaseServerType")
    def database_server_type(self) -> pulumi.Output[builtins.str]:
        """
        The database server type of the Exadata infrastructure.
        """
        return pulumi.get(self, "database_server_type")
    ...
    @property
    @pulumi.getter(name="isSchedulingPolicyAssociated")
    def is_scheduling_policy_associated(self) -> pulumi.Output[builtins.bool]:
        """
        If true, the infrastructure is using granular maintenance scheduling preference.
        """
        return pulumi.get(self, "is_scheduling_policy_associated")
    ...
    @property
    @pulumi.getter(name="maxDbNodeStorageInGbs")
    def max_db_node_storage_in_gbs(self) -> pulumi.Output[builtins.int]:
        """
        The total local node storage available in GBs.
        """
        return pulumi.get(self, "max_db_node_storage_in_gbs")
    ...
    @property
    @pulumi.getter(name="monthlyDbServerVersion")
    def monthly_db_server_version(self) -> pulumi.Output[builtins.str]:
        """
        The monthly software version of the database servers (dom0) in the cloud Exadata infrastructure. Example: 20.1.15
        """
        return pulumi.get(self, "monthly_db_server_version")
    ...
    @property
    @pulumi.getter(name="monthlyStorageServerVersion")
    def monthly_storage_server_version(self) -> pulumi.Output[builtins.str]:
        """
        The monthly software version of the storage servers (cells) in the cloud Exadata infrastructure. Example: 20.1.15
        """
        return pulumi.get(self, "monthly_storage_server_version")
    ...
    @property
    @pulumi.getter(name="storageCount")
    def storage_count(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The number of storage servers for the cloud Exadata infrastructure.
        """
        return pulumi.get(self, "storage_count")
    ...
    @property
    @pulumi.getter(name="storageServerType")
    def storage_server_type(self) -> pulumi.Output[builtins.str]:
        """
        The storage server type of the Exadata infrastructure.
        """
        return pulumi.get(self, "storage_server_type")
