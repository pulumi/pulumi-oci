...
class CloudExadataInfrastructureConfigureExascaleManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            compute_count: pulumi.Input[Optional[_builtins.int]] = None,
            cpu_count: pulumi.Input[Optional[_builtins.int]] = None,
            customer_contacts: pulumi.Input[Optional[Sequence[pulumi.Input[Union['CloudExadataInfrastructureConfigureExascaleManagementCustomerContactArgs', 'CloudExadataInfrastructureConfigureExascaleManagementCustomerContactArgsDict']]]]] = None,
            data_storage_size_in_tbs: pulumi.Input[Optional[_builtins.float]] = None,
            db_node_storage_size_in_gbs: pulumi.Input[Optional[_builtins.int]] = None,
            db_server_version: pulumi.Input[Optional[_builtins.str]] = None,
            defined_file_system_configurations: pulumi.Input[Optional[Sequence[pulumi.Input[Union['CloudExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfigurationArgs', 'CloudExadataInfrastructureConfigureExascaleManagementDefinedFileSystemConfigurationArgsDict']]]]] = None,
            defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            display_name: pulumi.Input[Optional[_builtins.str]] = None,
            exascale_configs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['CloudExadataInfrastructureConfigureExascaleManagementExascaleConfigArgs', 'CloudExadataInfrastructureConfigureExascaleManagementExascaleConfigArgsDict']]]]] = None,
            freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            is_scheduling_policy_associated: pulumi.Input[Optional[_builtins.bool]] = None,
            last_maintenance_run_id: pulumi.Input[Optional[_builtins.str]] = None,
            lifecycle_details: pulumi.Input[Optional[_builtins.str]] = None,
            maintenance_windows: pulumi.Input[Optional[Sequence[pulumi.Input[Union['CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgs', 'CloudExadataInfrastructureConfigureExascaleManagementMaintenanceWindowArgsDict']]]]] = None,
            max_cpu_count: pulumi.Input[Optional[_builtins.int]] = None,
            max_data_storage_in_tbs: pulumi.Input[Optional[_builtins.float]] = None,
            max_db_node_storage_in_gbs: pulumi.Input[Optional[_builtins.int]] = None,
            max_memory_in_gbs: pulumi.Input[Optional[_builtins.int]] = None,
