...
class DatabaseArgs:
    def __init__(__self__, *,
                 ...
                 db_home_id: pulumi.Input[builtins.str],
                 source: pulumi.Input[builtins.str],
                 action_trigger: Optional[pulumi.Input[builtins.int]] = None,
                 data_guard_action: Optional[pulumi.Input[builtins.str]] = None,
                 db_version: Optional[pulumi.Input[builtins.str]] = None,
                 key_store_id: Optional[pulumi.Input[builtins.str]] = None,
                 kms_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 kms_key_migration: Optional[pulumi.Input[builtins.bool]] = None,
                 kms_key_rotation: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] db_home_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Database Home.
        ...
        :param pulumi.Input[builtins.int] action_trigger: (Applicable when source=DATAGUARD)  An optional property when incremented triggers Data Guard operations such as Failover, Switchover, Reinstate, Data Guard Configuration Update and Convert Standby Database to Standalone . Could be set to any integer value.
        :param pulumi.Input[builtins.str] data_guard_action: Describes the Data Guard operation to be triggered. Could be set to a string value ('Switchover', 'Failover', 'Reinstate', 'DgConfig', "ConvertToStandalone').
        ...
        :param pulumi.Input[builtins.bool] kms_key_migration: The value to migrate to the kms version from none. Can only use once by setting value to true. You can not switch back to non-kms once you created or migrated.(https://www.oracle.com/security/cloud-security/key-management/faq/)
        :param pulumi.Input[builtins.int] kms_key_rotation: The value to rotate the key version of current kms_key. Just change this value will trigger the rotation.
    ...
    def db_home_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @db_home_id.setter
    def db_home_id(self, value: pulumi.Input[builtins.str]):
    ...
    def action_trigger(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def action_trigger(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "action_trigger", value)

    @property
    @pulumi.getter(name="dataGuardAction")
    def data_guard_action(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def data_guard_action(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def kms_key_migration(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def kms_key_migration(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "kms_key_migration", value)

    @property
    @pulumi.getter(name="kmsKeyRotation")
    def kms_key_rotation(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def kms_key_rotation(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _DatabaseState:
    def __init__(__self__, *,
                 ...
                 db_home_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 is_cdb: Optional[pulumi.Input[builtins.bool]] = None,
                 key_store_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 kms_key_rotation: Optional[pulumi.Input[builtins.int]] = None,
                 kms_key_version_id: Optional[pulumi.Input[builtins.str]] = None,
                 last_backup_duration_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 last_backup_timestamp: Optional[pulumi.Input[builtins.str]] = None,
                 last_failed_backup_timestamp: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] action_trigger: (Applicable when source=DATAGUARD)  An optional property when incremented triggers Data Guard operations such as Failover, Switchover, Reinstate, Data Guard Configuration Update and Convert Standby Database to Standalone . Could be set to any integer value.
        :param pulumi.Input[builtins.str] character_set: The character set for the database.
        ...
        :param pulumi.Input[builtins.str] db_unique_name: A system-generated name for the database to ensure uniqueness within an Oracle Data Guard group (a primary database and its standby databases). The unique name cannot be changed.
        :param pulumi.Input[builtins.str] db_version: A valid Oracle Database version. For a list of supported versions, use the ListDbVersions operation.
               
               This cannot be updated in parallel with any of the following: licenseModel, dbEdition, cpuCoreCount, computeCount, computeModel, adminPassword, whitelistedIps, isMTLSConnectionRequired, openMode, permissionLevel, dbWorkload, privateEndpointLabel, nsgIds, isRefreshable, dbName, scheduledOperations, dbToolsDetails, isLocalDataGuardEnabled, or isFreeTier.
        :param pulumi.Input[builtins.str] db_workload: **Deprecated.** The dbWorkload field has been deprecated for Exadata Database Service on Dedicated Infrastructure, Exadata Database Service on Cloud@Customer, and Base Database Service. Support for this attribute will end in November 2023. You may choose to update your custom scripts to exclude the dbWorkload attribute. After November 2023 if you pass a value to the dbWorkload attribute, it will be ignored.
        ...
        :param pulumi.Input[builtins.bool] is_cdb: True if the database is a container database.
        :param pulumi.Input[builtins.str] key_store_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the key store of Oracle Vault.
        ...
        :param pulumi.Input[builtins.int] kms_key_rotation: The value to rotate the key version of current kms_key. Just change this value will trigger the rotation.
        :param pulumi.Input[builtins.str] kms_key_version_id: The OCID of the key container version that is used in database transparent data encryption (TDE) operations KMS Key can have multiple key versions. If none is specified, the current key version (latest) of the Key Id is used for the operation.
        :param pulumi.Input[builtins.int] last_backup_duration_in_seconds: The duration when the latest database backup created.
        :param pulumi.Input[builtins.str] last_backup_timestamp: The date and time when the latest database backup was created.
        :param pulumi.Input[builtins.str] last_failed_backup_timestamp: The date and time when the latest database backup failed.
        :param pulumi.Input[builtins.str] lifecycle_details: Additional information about the current lifecycle state.
        :param pulumi.Input[builtins.str] ncharacter_set: The national character set for the database.
        :param pulumi.Input[builtins.str] pdb_name: The name of the pluggable database. The name must begin with an alphabetic character and can contain a maximum of thirty alphanumeric characters. Special characters are not permitted. Pluggable database should not be same as database name.
    ...
    @property
    @pulumi.getter(name="dbHomeId")
    def db_home_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Database Home.
        """
        return pulumi.get(self, "db_home_id")
    ...
    @db_home_id.setter
    def db_home_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "db_home_id", value)
    ...
    def is_cdb(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_cdb.setter
    def is_cdb(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def last_backup_duration_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def last_backup_duration_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "last_backup_duration_in_seconds", value)

    @property
    @pulumi.getter(name="lastBackupTimestamp")
    def last_backup_timestamp(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_backup_timestamp(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "last_backup_timestamp", value)

    @property
    @pulumi.getter(name="lastFailedBackupTimestamp")
    def last_failed_backup_timestamp(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_failed_backup_timestamp(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sid_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sid_prefix.setter
    def sid_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def source_database_point_in_time_recovery_timestamp(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_database_point_in_time_recovery_timestamp(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Database(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="actionTrigger")
    def action_trigger(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        (Applicable when source=DATAGUARD)  An optional property when incremented triggers Data Guard operations such as Failover, Switchover, Reinstate, Data Guard Configuration Update and Convert Standby Database to Standalone . Could be set to any integer value.
        """
        return pulumi.get(self, "action_trigger")
    ...
    @property
    @pulumi.getter(name="dataGuardAction")
    def data_guard_action(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Describes the Data Guard operation to be triggered. Could be set to a string value ('Switchover', 'Failover', 'Reinstate', 'DgConfig', "ConvertToStandalone').
    ...
    @property
    @pulumi.getter(name="dbHomeId")
    def db_home_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Database Home.
        """
        return pulumi.get(self, "db_home_id")
    ...
    @property
    @pulumi.getter(name="isCdb")
    def is_cdb(self) -> pulumi.Output[builtins.bool]:
        """
        True if the database is a container database.
        """
        return pulumi.get(self, "is_cdb")
    ...
    @property
    @pulumi.getter(name="kmsKeyMigration")
    def kms_key_migration(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        The value to migrate to the kms version from none. Can only use once by setting value to true. You can not switch back to non-kms once you created or migrated.(https://www.oracle.com/security/cloud-security/key-management/faq/)
        """
        return pulumi.get(self, "kms_key_migration")
    ...
    @property
    @pulumi.getter(name="kmsKeyRotation")
    def kms_key_rotation(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        The value to rotate the key version of current kms_key. Just change this value will trigger the rotation.
        """
        return pulumi.get(self, "kms_key_rotation")
    ...
    @property
    @pulumi.getter(name="kmsKeyVersionId")
    def kms_key_version_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The OCID of the key container version that is used in database transparent data encryption (TDE) operations KMS Key can have multiple key versions. If none is specified, the current key version (latest) of the Key Id is used for the operation.
        """
        return pulumi.get(self, "kms_key_version_id")
    ...
    @property
    @pulumi.getter(name="lastBackupDurationInSeconds")
    def last_backup_duration_in_seconds(self) -> pulumi.Output[builtins.int]:
        """
        The duration when the latest database backup created.
        """
        return pulumi.get(self, "last_backup_duration_in_seconds")
    ...
    @property
    @pulumi.getter(name="lastBackupTimestamp")
    def last_backup_timestamp(self) -> pulumi.Output[builtins.str]:
        """
        The date and time when the latest database backup was created.
        """
        return pulumi.get(self, "last_backup_timestamp")
    ...
    @property
    @pulumi.getter(name="lastFailedBackupTimestamp")
    def last_failed_backup_timestamp(self) -> pulumi.Output[builtins.str]:
        """
        The date and time when the latest database backup failed.
        """
        return pulumi.get(self, "last_failed_backup_timestamp")
    ...
    @property
    @pulumi.getter(name="sidPrefix")
    def sid_prefix(self) -> pulumi.Output[builtins.str]:
        """
        Specifies a prefix for the `Oracle SID` of the database to be created.
        """
        return pulumi.get(self, "sid_prefix")
    ...
    @property
    @pulumi.getter(name="sourceDatabasePointInTimeRecoveryTimestamp")
    def source_database_point_in_time_recovery_timestamp(self) -> pulumi.Output[builtins.str]:
        """
        Point in time recovery timeStamp of the source database at which cloned database system is cloned from the source database system, as described in [RFC 3339](https://tools.ietf.org/rfc/rfc3339)
        """
        return pulumi.get(self, "source_database_point_in_time_recovery_timestamp")
