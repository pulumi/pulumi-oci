...
class DbNodeConsoleHistoryArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The user-friendly name for the console history. The name does not need to be unique.
...
class _DbNodeConsoleHistoryState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment containing the console history.
        :param pulumi.Input[builtins.str] db_node_id: The database node [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[builtins.str] display_name: (Updatable) The user-friendly name for the console history. The name does not need to be unique.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}` 
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the console history was created.
        """
...
class DbNodeConsoleHistory(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            lifecycle_details: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'DbNodeConsoleHistory':
        """
