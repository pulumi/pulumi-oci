...
class DbSystemsUpgradeArgs:
    def __init__(__self__, *,
                 ...
                 is_snapshot_retention_days_force_updated: Optional[pulumi.Input[builtins.bool]] = None,
                 new_gi_version: Optional[pulumi.Input[builtins.str]] = None,
                 new_os_version: Optional[pulumi.Input[builtins.str]] = None,
                 snapshot_retention_period_in_days: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a DbSystemsUpgrade resource.
        :param pulumi.Input[builtins.str] action: The operating system upgrade action.
        ...
        :param pulumi.Input[builtins.bool] is_snapshot_retention_days_force_updated: If true, rollback time is updated even if operating system upgrade history contains errors.
        :param pulumi.Input[builtins.str] new_gi_version: A valid Oracle Grid Infrastructure (GI) software version.
        :param pulumi.Input[builtins.int] snapshot_retention_period_in_days: The retention period, in days, for the snapshot that allows you to perform a rollback of the upgrade operation. After this number of days passes, you cannot roll back the upgrade.
    ...
    def is_snapshot_retention_days_force_updated(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_snapshot_retention_days_force_updated(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_snapshot_retention_days_force_updated", value)

    @property
    @pulumi.getter(name="newGiVersion")
    def new_gi_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def new_gi_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "new_gi_version", value)

    @property
    @pulumi.getter(name="newOsVersion")
    def new_os_version(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "new_os_version")

    @new_os_version.setter
    def new_os_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "new_os_version", value)

    @property
    @pulumi.getter(name="snapshotRetentionPeriodInDays")
    def snapshot_retention_period_in_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def snapshot_retention_period_in_days(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _DbSystemsUpgradeState:
    def __init__(__self__, *,
                 ...
                 backup_subnet_id: Optional[pulumi.Input[builtins.str]] = None,
                 cluster_name: Optional[pulumi.Input[builtins.str]] = None,
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 cpu_core_count: Optional[pulumi.Input[builtins.int]] = None,
                 data_storage_percentage: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 disk_redundancy: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 point_in_time_data_disk_clone_timestamp: Optional[pulumi.Input[builtins.str]] = None,
                 reco_storage_size_in_gb: Optional[pulumi.Input[builtins.int]] = None,
                 scan_dns_name: Optional[pulumi.Input[builtins.str]] = None,
                 scan_dns_record_id: Optional[pulumi.Input[builtins.str]] = None,
                 scan_ip_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 shape: Optional[pulumi.Input[builtins.str]] = None,
                 snapshot_retention_period_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 source_db_system_id: Optional[pulumi.Input[builtins.str]] = None,
                 sparse_diskgroup: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] action: The operating system upgrade action.
        :param pulumi.Input[builtins.str] availability_domain: The name of the availability domain that the DB system is located in.
        ...
        :param pulumi.Input[builtins.str] backup_subnet_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the backup network subnet the DB system is associated with. Applicable only to Exadata DB systems.
        :param pulumi.Input[builtins.str] cluster_name: The cluster name for Exadata and 2-node RAC virtual machine DB systems. The cluster name must begin with an alphabetic character, and may contain hyphens (-). Underscores (_) are not permitted. The cluster name can be no longer than 11 characters and is not case sensitive.
        ...
        :param pulumi.Input[builtins.int] cpu_core_count: The number of CPU cores enabled on the DB system.
        :param pulumi.Input[builtins.int] data_storage_percentage: The percentage assigned to DATA storage (user data and database files). The remaining percentage is assigned to RECO storage (database redo logs, archive logs, and recovery manager backups). Accepted values are 40 and 80. The default is 80 percent assigned to DATA storage. Not applicable for virtual machine DB systems.
        :param pulumi.Input[builtins.int] data_storage_size_in_gb: The data storage size, in gigabytes, that is currently available to the DB system. Applies only for virtual machine DB systems.
        :param pulumi.Input[builtins.str] database_edition: The Oracle Database edition that applies to all the databases on the DB system.
        :param pulumi.Input[builtins.str] db_system_id: The DB system [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        ...
        :param pulumi.Input[builtins.str] disk_redundancy: The type of redundancy configured for the DB system. NORMAL is 2-way redundancy. HIGH is 3-way redundancy.
        :param pulumi.Input[builtins.str] display_name: The user-friendly name for the DB system. The name does not have to be unique.
        :param pulumi.Input[builtins.str] domain: The domain name for the DB system.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] fault_domains: List of the Fault Domains in which this DB system is provisioned.
        ...
        :param pulumi.Input[builtins.str] hostname: The hostname for the DB system.
        ...
        :param pulumi.Input[builtins.str] last_patch_history_entry_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the last patch history. This value is updated as soon as a patch operation starts.
        :param pulumi.Input[builtins.str] license_model: The Oracle license model that applies to all the databases on the DB system. The default is LICENSE_INCLUDED.
        :param pulumi.Input[builtins.str] lifecycle_details: Additional information about the current lifecycle state.
        :param pulumi.Input[builtins.int] listener_port: The port number configured for the listener on the DB system.
        ...
        :param pulumi.Input[builtins.int] node_count: The number of nodes in the DB system. For RAC DB systems, the value is greater than 1.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] nsg_ids: A list of the [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the network security groups (NSGs) that this resource belongs to. Setting this to an empty array after the list is created removes the resource from all NSGs. For more information about NSGs, see [Security Rules](https://docs.cloud.oracle.com/iaas/Content/Network/Concepts/securityrules.htm). **NsgIds restrictions:**
               * Autonomous Databases with private access require at least 1 Network Security Group (NSG). The nsgIds array cannot be empty.
        :param pulumi.Input[builtins.str] point_in_time_data_disk_clone_timestamp: The point in time for a cloned database system when the data disks were cloned from the source database system, as described in [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        :param pulumi.Input[builtins.int] reco_storage_size_in_gb: The RECO/REDO storage size, in gigabytes, that is currently allocated to the DB system. Applies only for virtual machine DB systems.
        :param pulumi.Input[builtins.str] scan_dns_name: The FQDN of the DNS record for the SCAN IP addresses that are associated with the DB system.
        :param pulumi.Input[builtins.str] scan_dns_record_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DNS record for the SCAN IP addresses that are associated with the DB system.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] scan_ip_ids: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Single Client Access Name (SCAN) IP addresses associated with the DB system. SCAN IP addresses are typically used for load balancing and are not assigned to any interface. Oracle Clusterware directs the requests to the appropriate nodes in the cluster.
        :param pulumi.Input[builtins.str] shape: The shape of the DB system. The shape determines resources to allocate to the DB system.
        ...
        :param pulumi.Input[builtins.int] snapshot_retention_period_in_days: The retention period, in days, for the snapshot that allows you to perform a rollback of the upgrade operation. After this number of days passes, you cannot roll back the upgrade.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] source_db_system_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DB system.
        :param pulumi.Input[builtins.bool] sparse_diskgroup: True, if Sparse Diskgroup is configured for Exadata dbsystem, False, if Sparse diskgroup was not configured.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ssh_public_keys: The public key portion of one or more key pairs used for SSH access to the DB system.
        :param pulumi.Input[builtins.str] state: The current state of the DB system.
        :param pulumi.Input[builtins.str] subnet_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet the DB system is associated with.
        :param pulumi.Input[builtins.str] time_created: The date and time the DB system was created.
        :param pulumi.Input[builtins.str] time_zone: The time zone of the DB system. For details, see [DB System Time Zones](https://docs.cloud.oracle.com/iaas/Content/Database/References/timezones.htm).
        :param pulumi.Input[builtins.str] version: The Oracle Database version of the DB system.
        ...
        :param pulumi.Input[builtins.str] zone_id: The OCID of the zone the DB system is associated with.
        """
    ...
    def backup_subnet_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def backup_subnet_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def data_storage_percentage(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def data_storage_percentage(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def disk_redundancy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def disk_redundancy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def point_in_time_data_disk_clone_timestamp(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def point_in_time_data_disk_clone_timestamp(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "point_in_time_data_disk_clone_timestamp", value)

    @property
    @pulumi.getter(name="recoStorageSizeInGb")
    def reco_storage_size_in_gb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def reco_storage_size_in_gb(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "reco_storage_size_in_gb", value)

    @property
    @pulumi.getter(name="scanDnsName")
    def scan_dns_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def scan_dns_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "scan_dns_name", value)

    @property
    @pulumi.getter(name="scanDnsRecordId")
    def scan_dns_record_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def scan_dns_record_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "scan_dns_record_id", value)

    @property
    @pulumi.getter(name="scanIpIds")
    def scan_ip_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Single Client Access Name (SCAN) IP addresses associated with the DB system. SCAN IP addresses are typically used for load balancing and are not assigned to any interface. Oracle Clusterware directs the requests to the appropriate nodes in the cluster.
        """
    ...
    @scan_ip_ids.setter
    def scan_ip_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def source_db_system_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_db_system_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_db_system_id", value)

    @property
    @pulumi.getter(name="sparseDiskgroup")
    def sparse_diskgroup(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def sparse_diskgroup(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def vip_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the virtual IP (VIP) addresses associated with the DB system. The Cluster Ready Services (CRS) creates and maintains one VIP address for each node in the DB system to enable failover. If one node fails, the VIP is reassigned to another active node in the cluster.
        """
    ...
    @vip_ids.setter
    def vip_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class DbSystemsUpgrade(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            version: Optional[pulumi.Input[builtins.str]] = None,
            vip_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DbSystemsUpgrade':
        """
    ...
    @property
    @pulumi.getter(name="backupNetworkNsgIds")
    def backup_network_nsg_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of the [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the network security groups (NSGs) that the backup network of this DB system belongs to. Setting this to an empty array after the list is created removes the resource from all NSGs. For more information about NSGs, see [Security Rules](https://docs.cloud.oracle.com/iaas/Content/Network/Concepts/securityrules.htm). Applicable only to Exadata systems.
        """
        return pulumi.get(self, "backup_network_nsg_ids")
    ...
    @property
    @pulumi.getter(name="backupSubnetId")
    def backup_subnet_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the backup network subnet the DB system is associated with. Applicable only to Exadata DB systems.
        """
        return pulumi.get(self, "backup_subnet_id")
    ...
    @property
    @pulumi.getter(name="dataStoragePercentage")
    def data_storage_percentage(self) -> pulumi.Output[builtins.int]:
        """
        The percentage assigned to DATA storage (user data and database files). The remaining percentage is assigned to RECO storage (database redo logs, archive logs, and recovery manager backups). Accepted values are 40 and 80. The default is 80 percent assigned to DATA storage. Not applicable for virtual machine DB systems.
        """
        return pulumi.get(self, "data_storage_percentage")
    ...
    @property
    @pulumi.getter(name="dataStorageSizeInGb")
    def data_storage_size_in_gb(self) -> pulumi.Output[builtins.int]:
        """
        The data storage size, in gigabytes, that is currently available to the DB system. Applies only for virtual machine DB systems.
        """
        return pulumi.get(self, "data_storage_size_in_gb")
    ...
    @property
    @pulumi.getter(name="faultDomains")
    def fault_domains(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List of the Fault Domains in which this DB system is provisioned.
        """
        return pulumi.get(self, "fault_domains")
    ...
    @property
    @pulumi.getter(name="isSnapshotRetentionDaysForceUpdated")
    def is_snapshot_retention_days_force_updated(self) -> pulumi.Output[builtins.bool]:
        """
        If true, rollback time is updated even if operating system upgrade history contains errors.
        """
        return pulumi.get(self, "is_snapshot_retention_days_force_updated")
    ...
    @property
    @pulumi.getter(name="newGiVersion")
    def new_gi_version(self) -> pulumi.Output[builtins.str]:
        """
        A valid Oracle Grid Infrastructure (GI) software version.
        """
        return pulumi.get(self, "new_gi_version")
    ...
    @property
    @pulumi.getter(name="newOsVersion")
    def new_os_version(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "new_os_version")
    ...
    @property
    @pulumi.getter(name="pointInTimeDataDiskCloneTimestamp")
    def point_in_time_data_disk_clone_timestamp(self) -> pulumi.Output[builtins.str]:
        """
        The point in time for a cloned database system when the data disks were cloned from the source database system, as described in [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        """
        return pulumi.get(self, "point_in_time_data_disk_clone_timestamp")
    ...
    @property
    @pulumi.getter(name="recoStorageSizeInGb")
    def reco_storage_size_in_gb(self) -> pulumi.Output[builtins.int]:
        """
        The RECO/REDO storage size, in gigabytes, that is currently allocated to the DB system. Applies only for virtual machine DB systems.
        """
        return pulumi.get(self, "reco_storage_size_in_gb")
    ...
    @property
    @pulumi.getter(name="scanDnsRecordId")
    def scan_dns_record_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DNS record for the SCAN IP addresses that are associated with the DB system.
        """
        return pulumi.get(self, "scan_dns_record_id")
    ...
    @property
    @pulumi.getter(name="snapshotRetentionPeriodInDays")
    def snapshot_retention_period_in_days(self) -> pulumi.Output[builtins.int]:
        """
        The retention period, in days, for the snapshot that allows you to perform a rollback of the upgrade operation. After this number of days passes, you cannot roll back the upgrade.
    ...
    @property
    @pulumi.getter(name="sourceDbSystemId")
    def source_db_system_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DB system.
        """
        return pulumi.get(self, "source_db_system_id")
    ...
    @property
    @pulumi.getter(name="sparseDiskgroup")
    def sparse_diskgroup(self) -> pulumi.Output[builtins.bool]:
        """
        True, if Sparse Diskgroup is configured for Exadata dbsystem, False, if Sparse diskgroup was not configured.
        """
        return pulumi.get(self, "sparse_diskgroup")
    ...
    @property
    @pulumi.getter(name="sshPublicKeys")
    def ssh_public_keys(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The public key portion of one or more key pairs used for SSH access to the DB system.
        """
        return pulumi.get(self, "ssh_public_keys")
