...
class ExadataInfrastructureArgs:
    def __init__(__self__, *,
                 admin_network_cidr: pulumi.Input[builtins.str],
                 cloud_control_plane_server1: pulumi.Input[builtins.str],
                 cloud_control_plane_server2: pulumi.Input[builtins.str],
                 compartment_id: pulumi.Input[builtins.str],
                 display_name: pulumi.Input[builtins.str],
                 dns_servers: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 gateway: pulumi.Input[builtins.str],
                 infini_band_network_cidr: pulumi.Input[builtins.str],
                 ...
                 activation_file: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 corporate_proxy: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 is_cps_offline_report_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_multi_rack_deployment: Optional[pulumi.Input[builtins.bool]] = None,
                 maintenance_window: Optional[pulumi.Input['ExadataInfrastructureMaintenanceWindowArgs']] = None,
                 multi_rack_configuration_file: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] admin_network_cidr: (Updatable) The CIDR block for the Exadata administration network.
        :param pulumi.Input[builtins.str] cloud_control_plane_server1: (Updatable) The IP address for the first control plane server.
        :param pulumi.Input[builtins.str] cloud_control_plane_server2: (Updatable) The IP address for the second control plane server.
        ...
        :param pulumi.Input[builtins.str] display_name: The user-friendly name for the Exadata infrastructure. The name does not need to be unique.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_servers: (Updatable) The list of DNS server IP addresses. Maximum of 3 allowed.
        :param pulumi.Input[builtins.str] gateway: (Updatable) The gateway for the control plane network.
        :param pulumi.Input[builtins.str] infini_band_network_cidr: (Updatable) The CIDR block for the Exadata InfiniBand interconnect.
        :param pulumi.Input[builtins.str] netmask: (Updatable) The netmask for the control plane network.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ntp_servers: (Updatable) The list of NTP server IP addresses. Maximum of 3 allowed.
        ...
        :param pulumi.Input[builtins.int] compute_count: The number of compute servers for the Exadata infrastructure.
        ...
        :param pulumi.Input[builtins.str] corporate_proxy: (Updatable) The corporate network proxy for access to the control plane network. Oracle recommends using an HTTPS proxy when possible for enhanced security.
        ...
        :param pulumi.Input[builtins.bool] is_cps_offline_report_enabled: (Updatable) Indicates whether cps offline diagnostic report is enabled for this Exadata infrastructure. This will allow a customer to quickly check status themselves and fix problems on their end, saving time and frustration for both Oracle and the customer when they find the CPS in a disconnected state.You can enable offline diagnostic report during Exadata infrastructure provisioning. You can also disable or enable it at any time using the UpdateExadatainfrastructure API.
        :param pulumi.Input[builtins.bool] is_multi_rack_deployment: (Updatable) Indicates if deployment is Multi-Rack or not.
        ...
        :param pulumi.Input[builtins.str] multi_rack_configuration_file: (Updatable) The base64 encoded Multi-Rack configuration json file.
    ...
    def admin_network_cidr(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def admin_network_cidr(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "admin_network_cidr", value)

    @property
    @pulumi.getter(name="cloudControlPlaneServer1")
    def cloud_control_plane_server1(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def cloud_control_plane_server1(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "cloud_control_plane_server1", value)

    @property
    @pulumi.getter(name="cloudControlPlaneServer2")
    def cloud_control_plane_server2(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def cloud_control_plane_server2(self, value: pulumi.Input[builtins.str]):
    ...
    def infini_band_network_cidr(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def infini_band_network_cidr(self, value: pulumi.Input[builtins.str]):
    ...
    def activation_file(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def corporate_proxy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def corporate_proxy(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_cps_offline_report_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_cps_offline_report_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_cps_offline_report_enabled", value)

    @property
    @pulumi.getter(name="isMultiRackDeployment")
    def is_multi_rack_deployment(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_multi_rack_deployment(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def multi_rack_configuration_file(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def multi_rack_configuration_file(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ExadataInfrastructureState:
    def __init__(__self__, *,
                 ...
                 activation_file: Optional[pulumi.Input[builtins.str]] = None,
                 additional_compute_count: Optional[pulumi.Input[builtins.int]] = None,
                 additional_compute_system_model: Optional[pulumi.Input[builtins.str]] = None,
                 additional_storage_count: Optional[pulumi.Input[builtins.int]] = None,
                 admin_network_cidr: Optional[pulumi.Input[builtins.str]] = None,
                 availability_domain: Optional[pulumi.Input[builtins.str]] = None,
                 cloud_control_plane_server1: Optional[pulumi.Input[builtins.str]] = None,
                 cloud_control_plane_server2: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 create_async: Optional[pulumi.Input[builtins.bool]] = None,
                 csi_number: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 infini_band_network_cidr: Optional[pulumi.Input[builtins.str]] = None,
                 is_cps_offline_report_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_multi_rack_deployment: Optional[pulumi.Input[builtins.bool]] = None,
                 is_scheduling_policy_associated: Optional[pulumi.Input[builtins.bool]] = None,
                 lifecycle_details: Optional[pulumi.Input[builtins.str]] = None,
                 maintenance_slo_status: Optional[pulumi.Input[builtins.str]] = None,
                 maintenance_window: Optional[pulumi.Input['ExadataInfrastructureMaintenanceWindowArgs']] = None,
        ...
        :param pulumi.Input[builtins.str] activation_file: (Updatable) The activation zip file. If provided in config, exadata infrastructure will be activated after creation. Updates are not allowed on activated exadata infrastructure.
        :param pulumi.Input[builtins.int] additional_compute_count: The requested number of additional compute servers for the Exadata infrastructure.
        ...
        :param pulumi.Input[builtins.int] additional_storage_count: The requested number of additional storage servers for the Exadata infrastructure.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] admin_network_cidr: (Updatable) The CIDR block for the Exadata administration network.
        :param pulumi.Input[builtins.str] availability_domain: The name of the availability domain that the Exadata infrastructure is located in.
        :param pulumi.Input[builtins.str] cloud_control_plane_server1: (Updatable) The IP address for the first control plane server.
        :param pulumi.Input[builtins.str] cloud_control_plane_server2: (Updatable) The IP address for the second control plane server.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param pulumi.Input[builtins.int] compute_count: The number of compute servers for the Exadata infrastructure.
        ...
        :param pulumi.Input[builtins.str] csi_number: The CSI Number of the Exadata infrastructure.
        ...
        :param pulumi.Input[builtins.str] db_server_version: The software version of the database servers (dom0) in the Exadata infrastructure.
        ...
        :param pulumi.Input[builtins.str] maintenance_slo_status: A field to capture ‘Maintenance SLO Status’ for the Exadata infrastructure with values ‘OK’, ‘DEGRADED’. Default is ‘OK’ when the infrastructure is provisioned.
        :param pulumi.Input['ExadataInfrastructureMaintenanceWindowArgs'] maintenance_window: (Updatable) The scheduling details for the quarterly maintenance window. Patching and system updates take place during the maintenance window.
        ...
        :param pulumi.Input[builtins.str] monthly_db_server_version: The monthly software version of the database servers (dom0) in the Exadata infrastructure.
        :param pulumi.Input[builtins.str] multi_rack_configuration_file: (Updatable) The base64 encoded Multi-Rack configuration json file.
        :param pulumi.Input[builtins.str] netmask: (Updatable) The netmask for the control plane network.
        :param pulumi.Input['ExadataInfrastructureNetworkBondingModeDetailsArgs'] network_bonding_mode_details: (Updatable) Details of bonding mode for Client and Backup and DR networks of an Exadata infrastructure.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ntp_servers: (Updatable) The list of NTP server IP addresses. Maximum of 3 allowed.
        :param pulumi.Input[builtins.str] rack_serial_number: The serial number for the Exadata infrastructure.
        :param pulumi.Input[builtins.str] shape: The shape of the Exadata infrastructure. The shape determines the amount of CPU, storage, and memory resources allocated to the instance.
        :param pulumi.Input[builtins.str] state: The current lifecycle state of the Exadata infrastructure.
        :param pulumi.Input[builtins.int] storage_count: The number of storage servers for the Exadata infrastructure.
        :param pulumi.Input[builtins.str] storage_server_type: The storage server type of the Exadata infrastructure.
    ...
    def additional_compute_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def additional_compute_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "additional_compute_count", value)

    @property
    @pulumi.getter(name="additionalComputeSystemModel")
    def additional_compute_system_model(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def additional_compute_system_model(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="adminNetworkCidr")
    def admin_network_cidr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The CIDR block for the Exadata administration network.
        """
        return pulumi.get(self, "admin_network_cidr")
    ...
    @admin_network_cidr.setter
    def admin_network_cidr(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "admin_network_cidr", value)
    ...
    @property
    @pulumi.getter(name="cloudControlPlaneServer1")
    def cloud_control_plane_server1(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The IP address for the first control plane server.
        """
        return pulumi.get(self, "cloud_control_plane_server1")
    ...
    @cloud_control_plane_server1.setter
    def cloud_control_plane_server1(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cloud_control_plane_server1", value)

    @property
    @pulumi.getter(name="cloudControlPlaneServer2")
    def cloud_control_plane_server2(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The IP address for the second control plane server.
        """
        return pulumi.get(self, "cloud_control_plane_server2")
    ...
    @cloud_control_plane_server2.setter
    def cloud_control_plane_server2(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "cloud_control_plane_server2", value)
    ...
    def csi_number(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @csi_number.setter
    def csi_number(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="infiniBandNetworkCidr")
    def infini_band_network_cidr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The CIDR block for the Exadata InfiniBand interconnect.
        """
        return pulumi.get(self, "infini_band_network_cidr")
    ...
    @infini_band_network_cidr.setter
    def infini_band_network_cidr(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "infini_band_network_cidr", value)
    ...
    def maintenance_slo_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def maintenance_slo_status(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def rack_serial_number(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def rack_serial_number(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ExadataInfrastructure(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="additionalComputeCount")
    def additional_compute_count(self) -> pulumi.Output[builtins.int]:
        """
        The requested number of additional compute servers for the Exadata infrastructure.
        """
        return pulumi.get(self, "additional_compute_count")
    ...
    @property
    @pulumi.getter(name="additionalComputeSystemModel")
    def additional_compute_system_model(self) -> pulumi.Output[builtins.str]:
        """
        Oracle Exadata System Model specification. The system model determines the amount of compute or storage server resources available for use. For more information, please see [System and Shape Configuration Options] (https://docs.oracle.com/en/engineered-systems/exadata-cloud-at-customer/ecccm/ecc-system-config-options.html#GUID-9E090174-5C57-4EB1-9243-B470F9F10D6B)
        """
        return pulumi.get(self, "additional_compute_system_model")
    ...
    @property
    @pulumi.getter(name="adminNetworkCidr")
    def admin_network_cidr(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The CIDR block for the Exadata administration network.
        """
        return pulumi.get(self, "admin_network_cidr")
    ...
    @property
    @pulumi.getter(name="cloudControlPlaneServer1")
    def cloud_control_plane_server1(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The IP address for the first control plane server.
        """
        return pulumi.get(self, "cloud_control_plane_server1")
    ...
    @property
    @pulumi.getter(name="cloudControlPlaneServer2")
    def cloud_control_plane_server2(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The IP address for the second control plane server.
        """
        return pulumi.get(self, "cloud_control_plane_server2")
    ...
    @property
    @pulumi.getter(name="corporateProxy")
    def corporate_proxy(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The corporate network proxy for access to the control plane network. Oracle recommends using an HTTPS proxy when possible for enhanced security.
        """
        return pulumi.get(self, "corporate_proxy")
    ...
    @property
    @pulumi.getter(name="csiNumber")
    def csi_number(self) -> pulumi.Output[builtins.str]:
        """
        The CSI Number of the Exadata infrastructure.
        """
        return pulumi.get(self, "csi_number")
    ...
    @property
    @pulumi.getter(name="infiniBandNetworkCidr")
    def infini_band_network_cidr(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The CIDR block for the Exadata InfiniBand interconnect.
        """
        return pulumi.get(self, "infini_band_network_cidr")
    ...
    @property
    @pulumi.getter(name="isCpsOfflineReportEnabled")
    def is_cps_offline_report_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Indicates whether cps offline diagnostic report is enabled for this Exadata infrastructure. This will allow a customer to quickly check status themselves and fix problems on their end, saving time and frustration for both Oracle and the customer when they find the CPS in a disconnected state.You can enable offline diagnostic report during Exadata infrastructure provisioning. You can also disable or enable it at any time using the UpdateExadatainfrastructure API.
        """
        return pulumi.get(self, "is_cps_offline_report_enabled")
    ...
    @property
    @pulumi.getter(name="isMultiRackDeployment")
    def is_multi_rack_deployment(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Indicates if deployment is Multi-Rack or not.
        """
        return pulumi.get(self, "is_multi_rack_deployment")
    ...
    @property
    @pulumi.getter(name="maintenanceSloStatus")
    def maintenance_slo_status(self) -> pulumi.Output[builtins.str]:
        """
        A field to capture ‘Maintenance SLO Status’ for the Exadata infrastructure with values ‘OK’, ‘DEGRADED’. Default is ‘OK’ when the infrastructure is provisioned.
        """
        return pulumi.get(self, "maintenance_slo_status")
    ...
    @property
    @pulumi.getter(name="multiRackConfigurationFile")
    def multi_rack_configuration_file(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (Updatable) The base64 encoded Multi-Rack configuration json file.
        """
        return pulumi.get(self, "multi_rack_configuration_file")
