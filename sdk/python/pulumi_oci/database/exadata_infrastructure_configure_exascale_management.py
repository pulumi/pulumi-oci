...
class ExadataInfrastructureConfigureExascaleManagementArgs:
    def __init__(__self__, *,
                 ...
                 total_storage_in_gbs: pulumi.Input[builtins.int]):
        """
        ...
        :param pulumi.Input[builtins.int] total_storage_in_gbs: Storage size needed for Exascale in GBs.
    ...
    def total_storage_in_gbs(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def total_storage_in_gbs(self, value: pulumi.Input[builtins.int]):
...
class _ExadataInfrastructureConfigureExascaleManagementState:
    def __init__(__self__, *,
                 ...
                 total_storage_in_gbs: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] cloud_control_plane_server2: The IP address for the second control plane server.
        ...
        :param pulumi.Input[builtins.str] corporate_proxy: The corporate network proxy for access to the control plane network.
        ...
        :param pulumi.Input[builtins.str] display_name: The user-friendly name for the Exadata Cloud@Customer infrastructure. The name does not need to be unique.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] dns_servers: The list of DNS server IP addresses. Maximum of 3 allowed.
        :param pulumi.Input[builtins.str] exadata_infrastructure_id: The Exadata infrastructure [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        ...
        :param pulumi.Input[builtins.str] gateway: The gateway for the control plane network.
        :param pulumi.Input[builtins.str] infini_band_network_cidr: The CIDR block for the Exadata InfiniBand interconnect.
        :param pulumi.Input[builtins.bool] is_cps_offline_report_enabled: Indicates whether cps offline diagnostic report is enabled for this Exadata infrastructure. This will allow a customer to quickly check status themselves and fix problems on their end, saving time and frustration for both Oracle and the customer when they find the CPS in a disconnected state.You can enable offline diagnostic report during Exadata infrastructure provisioning. You can also disable or enable it at any time using the UpdateExadatainfrastructure API.
        :param pulumi.Input[builtins.bool] is_multi_rack_deployment: Indicates if deployment is Multi-Rack or not.
        ...
        :param pulumi.Input[builtins.str] multi_rack_configuration_file: The base64 encoded Multi-Rack configuration json file.
        :param pulumi.Input[builtins.str] netmask: The netmask for the control plane network.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ntp_servers: The list of NTP server IP addresses. Maximum of 3 allowed.
        ...
        :param pulumi.Input[builtins.int] storage_count: The number of Exadata storage servers for the Exadata infrastructure.
    ...
    @property
    @pulumi.getter(name="totalStorageInGbs")
    def total_storage_in_gbs(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Storage size needed for Exascale in GBs.
    ...
    @total_storage_in_gbs.setter
    def total_storage_in_gbs(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "total_storage_in_gbs", value)
...
class ExadataInfrastructureConfigureExascaleManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_zone: Optional[pulumi.Input[builtins.str]] = None,
            total_storage_in_gbs: Optional[pulumi.Input[builtins.int]] = None) -> 'ExadataInfrastructureConfigureExascaleManagement':
        """
    ...
    @property
    @pulumi.getter(name="multiRackConfigurationFile")
    def multi_rack_configuration_file(self) -> pulumi.Output[builtins.str]:
        """
        The base64 encoded Multi-Rack configuration json file.
        """
        return pulumi.get(self, "multi_rack_configuration_file")
    ...
    @property
    @pulumi.getter(name="totalStorageInGbs")
    def total_storage_in_gbs(self) -> pulumi.Output[builtins.int]:
        """
        Storage size needed for Exascale in GBs.
