...
class ExadbVmClusterArgs:
    def __init__(__self__, *,
                 ...
                 backup_subnet_id: pulumi.Input[builtins.str],
                 compartment_id: pulumi.Input[builtins.str],
                 display_name: pulumi.Input[builtins.str],
                 exascale_db_storage_vault_id: pulumi.Input[builtins.str],
                 grid_image_id: pulumi.Input[builtins.str],
                 hostname: pulumi.Input[builtins.str],
                 node_config: pulumi.Input['ExadbVmClusterNodeConfigArgs'],
                 shape: pulumi.Input[builtins.str],
                 ssh_public_keys: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 ...
                 private_zone_id: Optional[pulumi.Input[builtins.str]] = None,
                 scan_listener_port_tcp: Optional[pulumi.Input[builtins.int]] = None,
                 scan_listener_port_tcp_ssl: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] availability_domain: The name of the availability domain in which the Exadata VM cluster on Exascale Infrastructure is located.
        :param pulumi.Input[builtins.str] backup_subnet_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the backup network subnet associated with the Exadata VM cluster on Exascale Infrastructure.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The user-friendly name for the Exadata VM cluster on Exascale Infrastructure. The name does not need to be unique.
        ...
        :param pulumi.Input[builtins.str] grid_image_id: (Updatable) Grid Setup will be done using this grid image id.
        ...
        :param pulumi.Input[builtins.str] hostname: The hostname for the Exadata VM cluster on Exascale Infrastructure. The hostname must begin with an alphabetic character, and  can contain alphanumeric characters and hyphens (-). For Exadata systems, the maximum length of the hostname is 12 characters.
        ...
        :param pulumi.Input[builtins.str] shape: The shape of the Exadata VM cluster on Exascale Infrastructure resource
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ssh_public_keys: (Updatable) The public key portion of one or more key pairs used for SSH access to the Exadata VM cluster on Exascale Infrastructure.
        :param pulumi.Input[builtins.str] subnet_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet associated with the Exadata VM cluster on Exascale Infrastructure.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] backup_network_nsg_ids: (Updatable) A list of the [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the network security groups (NSGs) that the backup network of this DB system belongs to. Setting this to an empty array after the list is created removes the resource from all NSGs. For more information about NSGs, see [Security Rules](https://docs.cloud.oracle.com/iaas/Content/Network/Concepts/securityrules.htm). Applicable only to Exadata systems.
        ...
        :param pulumi.Input[builtins.str] license_model: (Updatable) The Oracle license model that applies to the Exadata VM cluster on Exascale Infrastructure. The default is BRING_YOUR_OWN_LICENSE.
        ...
        :param pulumi.Input[builtins.str] private_zone_id: The private zone ID in which you want DNS records to be created.
        :param pulumi.Input[builtins.int] scan_listener_port_tcp: The TCP Single Client Access Name (SCAN) port. The default port is 1521.
        :param pulumi.Input[builtins.int] scan_listener_port_tcp_ssl: The Secured Communication (TCPS) protocol Single Client Access Name (SCAN) port. The default port is 2484.
        ...
        :param pulumi.Input[builtins.str] system_version: (Updatable) Operating system version of the image.
        :param pulumi.Input[builtins.str] time_zone: The time zone to use for the Exadata VM cluster on Exascale Infrastructure. For details, see [Time Zones](https://docs.cloud.oracle.com/iaas/Content/Database/References/timezones.htm). 
    ...
    def backup_subnet_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def backup_subnet_id(self, value: pulumi.Input[builtins.str]):
    ...
    def exascale_db_storage_vault_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def exascale_db_storage_vault_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "exascale_db_storage_vault_id", value)

    @property
    @pulumi.getter(name="gridImageId")
    def grid_image_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def grid_image_id(self, value: pulumi.Input[builtins.str]):
    ...
    def ssh_public_keys(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def ssh_public_keys(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def private_zone_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def private_zone_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def scan_listener_port_tcp_ssl(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def scan_listener_port_tcp_ssl(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _ExadbVmClusterState:
    def __init__(__self__, *,
                 ...
                 grid_image_id: Optional[pulumi.Input[builtins.str]] = None,
                 grid_image_type: Optional[pulumi.Input[builtins.str]] = None,
                 hostname: Optional[pulumi.Input[builtins.str]] = None,
                 iorm_config_caches: Optional[pulumi.Input[Sequence[pulumi.Input['ExadbVmClusterIormConfigCachArgs']]]] = None,
                 last_update_history_entry_id: Optional[pulumi.Input[builtins.str]] = None,
                 license_model: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] exascale_db_storage_vault_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata Database Storage Vault.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] gi_version: A valid Oracle Grid Infrastructure (GI) software version.
        :param pulumi.Input[builtins.str] grid_image_id: (Updatable) Grid Setup will be done using this grid image id.
               
               The grid image ID can be obtained using the API /20160918/giVersions/{majorVersion}/minorVersions?compartmentId=<compartmentId>&shapeFamily=EXADB_XS&availabilityDomain=<AD name>. The list of supported major versions can be obtained using the API /20160918/giVersions?compartmentId=<compartmentId>&shape=ExaDbXS&availabilityDomain=<AD name>
        :param pulumi.Input[builtins.str] grid_image_type: The type of Grid Image
        :param pulumi.Input[builtins.str] hostname: The hostname for the Exadata VM cluster on Exascale Infrastructure. The hostname must begin with an alphabetic character, and  can contain alphanumeric characters and hyphens (-). For Exadata systems, the maximum length of the hostname is 12 characters.
        ...
        :param pulumi.Input[builtins.str] last_update_history_entry_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the last maintenance update history entry. This value is updated when a maintenance update starts.
        :param pulumi.Input[builtins.str] license_model: (Updatable) The Oracle license model that applies to the Exadata VM cluster on Exascale Infrastructure. The default is BRING_YOUR_OWN_LICENSE.
        :param pulumi.Input[builtins.str] lifecycle_details: Additional information about the current lifecycle state.
        :param pulumi.Input[builtins.str] listener_port: The port number configured for the listener on the Exadata VM cluster on Exascale Infrastructure.
        :param pulumi.Input['ExadbVmClusterNodeConfigArgs'] node_config: (Updatable) The configuration of each node in the Exadata VM cluster on Exascale Infrastructure.
        :param pulumi.Input[Sequence[pulumi.Input['ExadbVmClusterNodeResourceArgs']]] node_resources: Each `node_resource` represents a node in the Exadata VM cluster on Exascale Infrastructure.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] nsg_ids: (Updatable) The list of [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for the network security groups (NSGs) to which this resource belongs. Setting this to an empty list removes all resources from all NSGs. For more information about NSGs, see [Security Rules](https://docs.cloud.oracle.com/iaas/Content/Network/Concepts/securityrules.htm). **NsgIds restrictions:**
               * A network security group (NSG) is optional for Autonomous Databases with private access. The nsgIds list can be empty.
        :param pulumi.Input[builtins.str] private_zone_id: The private zone ID in which you want DNS records to be created.
        :param pulumi.Input[builtins.str] scan_dns_name: The FQDN of the DNS record for the SCAN IP addresses that are associated with the Exadata VM cluster on Exascale Infrastructure.
        :param pulumi.Input[builtins.str] scan_dns_record_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DNS record for the SCAN IP addresses that are associated with the Exadata VM cluster on Exascale Infrastructure.
        ...
        :param pulumi.Input[builtins.str] shape: The shape of the Exadata VM cluster on Exascale Infrastructure resource
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ssh_public_keys: (Updatable) The public key portion of one or more key pairs used for SSH access to the Exadata VM cluster on Exascale Infrastructure.
        :param pulumi.Input[builtins.str] state: The current state of the Exadata VM cluster on Exascale Infrastructure.
        :param pulumi.Input[builtins.str] subnet_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet associated with the Exadata VM cluster on Exascale Infrastructure.
        :param pulumi.Input[builtins.str] subscription_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subscription with which resource needs to be associated with.
        ...
        :param pulumi.Input[builtins.str] system_version: (Updatable) Operating system version of the image.
        :param pulumi.Input[builtins.str] time_created: The date and time that the Exadata VM cluster on Exascale Infrastructure was created.
        :param pulumi.Input[builtins.str] time_zone: The time zone to use for the Exadata VM cluster on Exascale Infrastructure. For details, see [Time Zones](https://docs.cloud.oracle.com/iaas/Content/Database/References/timezones.htm). 
        ...
        :param pulumi.Input[builtins.str] zone_id: The OCID of the zone with which the Exadata VM cluster on Exascale Infrastructure is associated.
        """
    ...
    @property
    @pulumi.getter(name="gridImageId")
    def grid_image_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Grid Setup will be done using this grid image id.
    ...
    @grid_image_id.setter
    def grid_image_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "grid_image_id", value)

    @property
    @pulumi.getter(name="gridImageType")
    def grid_image_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def grid_image_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def last_update_history_entry_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_update_history_entry_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def listener_port(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def listener_port(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ExadbVmCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_zone: Optional[pulumi.Input[builtins.str]] = None,
            vip_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ExadbVmCluster':
        """
    ...
    @property
    @pulumi.getter(name="gridImageId")
    def grid_image_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Grid Setup will be done using this grid image id.
    ...
    @property
    @pulumi.getter(name="gridImageType")
    def grid_image_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of Grid Image
        """
        return pulumi.get(self, "grid_image_type")
    ...
    @property
    @pulumi.getter(name="lastUpdateHistoryEntryId")
    def last_update_history_entry_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the last maintenance update history entry. This value is updated when a maintenance update starts.
        """
        return pulumi.get(self, "last_update_history_entry_id")
    ...
    @property
    @pulumi.getter(name="listenerPort")
    def listener_port(self) -> pulumi.Output[builtins.str]:
        """
        The port number configured for the listener on the Exadata VM cluster on Exascale Infrastructure.
        """
        return pulumi.get(self, "listener_port")
    ...
    @property
    @pulumi.getter(name="privateZoneId")
    def private_zone_id(self) -> pulumi.Output[builtins.str]:
        """
        The private zone ID in which you want DNS records to be created.
        """
        return pulumi.get(self, "private_zone_id")
    ...
    @property
    @pulumi.getter(name="scanListenerPortTcp")
    def scan_listener_port_tcp(self) -> pulumi.Output[builtins.int]:
        """
        The TCP Single Client Access Name (SCAN) port. The default port is 1521.
        """
        return pulumi.get(self, "scan_listener_port_tcp")
    ...
    @property
    @pulumi.getter(name="scanListenerPortTcpSsl")
    def scan_listener_port_tcp_ssl(self) -> pulumi.Output[builtins.int]:
        """
        The Secured Communication (TCPS) protocol Single Client Access Name (SCAN) port. The default port is 2484.
        """
        return pulumi.get(self, "scan_listener_port_tcp_ssl")
