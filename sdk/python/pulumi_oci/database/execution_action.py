...
class ExecutionActionArgs:
    def __init__(__self__, *,
                 ...
                 execution_window_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] action_type: The action type of the execution action being performed
        :param pulumi.Input[builtins.str] execution_window_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the execution window resource the execution action belongs to.
    ...
    def execution_window_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def execution_window_id(self, value: pulumi.Input[builtins.str]):
...
class _ExecutionActionState:
    def __init__(__self__, *,
                 ...
                 execution_action_order: Optional[pulumi.Input[builtins.int]] = None,
                 execution_window_id: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[builtins.str] description: Description of the execution action.
        :param pulumi.Input[builtins.str] display_name: The user-friendly name for the execution action. The name does not need to be unique.
        :param pulumi.Input[builtins.int] estimated_time_in_mins: The estimated time of the execution action in minutes.
        :param pulumi.Input[builtins.int] execution_action_order: The priority order of the execution action.
        :param pulumi.Input[builtins.str] execution_window_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the execution window resource the execution action belongs to.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}` 
        ...
        :param pulumi.Input[builtins.str] lifecycle_substate: The current sub-state of the execution action. Valid states are DURATION_EXCEEDED, MAINTENANCE_IN_PROGRESS and WAITING.
        :param pulumi.Input[builtins.str] state: The current state of the execution action. Valid states are SCHEDULED, IN_PROGRESS, FAILED, CANCELED, UPDATING, DELETED, SUCCEEDED and PARTIAL_SUCCESS.
        :param pulumi.Input[builtins.str] time_created: The date and time the execution action was created.
        :param pulumi.Input[builtins.str] time_updated: The last date and time that the execution action was updated.
    ...
    def execution_action_order(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def execution_action_order(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "execution_action_order", value)

    @property
    @pulumi.getter(name="executionWindowId")
    def execution_window_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the execution window resource the execution action belongs to.
        """
        return pulumi.get(self, "execution_window_id")
    ...
    @execution_window_id.setter
    def execution_window_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "execution_window_id", value)
...
class ExecutionAction(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            total_time_taken_in_mins: Optional[pulumi.Input[builtins.int]] = None) -> 'ExecutionAction':
        """
    ...
    @property
    @pulumi.getter(name="executionActionOrder")
    def execution_action_order(self) -> pulumi.Output[builtins.int]:
        """
        The priority order of the execution action.
        """
        return pulumi.get(self, "execution_action_order")
    ...
    @property
    @pulumi.getter(name="executionWindowId")
    def execution_window_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the execution window resource the execution action belongs to.
        """
        return pulumi.get(self, "execution_window_id")
