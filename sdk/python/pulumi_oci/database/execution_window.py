...
class ExecutionWindowArgs:
    def __init__(__self__, *,
                 ...
                 execution_resource_id: pulumi.Input[_builtins.str],
                 time_scheduled: pulumi.Input[_builtins.str],
                 window_duration_in_mins: pulumi.Input[_builtins.int],
    ...
    def execution_resource_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def execution_resource_id(self, value: pulumi.Input[_builtins.str]):
    ...
    def window_duration_in_mins(self, value: pulumi.Input[_builtins.int]):
    ...
    def is_enforced_duration(self) -> Optional[pulumi.Input[_builtins.bool]]:
        """
    ...
    def is_enforced_duration(self, value: Optional[pulumi.Input[_builtins.bool]]):
...
class _ExecutionWindowState:
    def __init__(__self__, *,
                 ...
                 execution_resource_id: Optional[pulumi.Input[_builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 is_enforced_duration: Optional[pulumi.Input[_builtins.bool]] = None,
                 ...
                 window_duration_in_mins: Optional[pulumi.Input[_builtins.int]] = None,
        ...
        :param pulumi.Input[_builtins.str] display_name: The user-friendly name for the execution window. The name does not need to be unique.
        :param pulumi.Input[_builtins.int] estimated_time_in_mins: The estimated time of the execution window in minutes.
        :param pulumi.Input[_builtins.str] execution_resource_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the execution resource the execution window belongs to.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[_builtins.bool] is_enforced_duration: (Updatable) Indicates if duration the user plans to allocate for scheduling window is strictly enforced. The default value is `FALSE`.
        :param pulumi.Input[_builtins.str] lifecycle_details: Additional information about the current lifecycle state.
        :param pulumi.Input[_builtins.str] lifecycle_substate: The current sub-state of the execution window. Valid states are DURATION_EXCEEDED, MAINTENANCE_IN_PROGRESS and WAITING.
        :param pulumi.Input[_builtins.str] state: The current state of the Schedule Policy. Valid states are CREATED, SCHEDULED, IN_PROGRESS, FAILED, CANCELED, UPDATING, DELETED, SUCCEEDED and PARTIAL_SUCCESS.
        :param pulumi.Input[_builtins.str] time_created: The date and time the execution window was created.
        :param pulumi.Input[_builtins.str] time_ended: The date and time that the execution window ended.
        :param pulumi.Input[_builtins.str] time_scheduled: (Updatable) The scheduled start date and time of the execution window.
    ...
    @_builtins.property
    @pulumi.getter(name="executionResourceId")
    def execution_resource_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the execution resource the execution window belongs to.
        """
        return pulumi.get(self, "execution_resource_id")
    ...
    @execution_resource_id.setter
    def execution_resource_id(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "execution_resource_id", value)
    ...
    @_builtins.property
    @pulumi.getter(name="windowDurationInMins")
    def window_duration_in_mins(self) -> Optional[pulumi.Input[_builtins.int]]:
        """
        (Updatable) Duration window allows user to set a duration they plan to allocate for Scheduling window. The duration is in minutes. 
    ...
    @window_duration_in_mins.setter
    def window_duration_in_mins(self, value: Optional[pulumi.Input[_builtins.int]]):
        pulumi.set(self, "window_duration_in_mins", value)

    @_builtins.property
    @pulumi.getter(name="windowType")
    def window_type(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
    ...
    @window_type.setter
    def window_type(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class ExecutionWindow(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            total_time_taken_in_mins: Optional[pulumi.Input[_builtins.int]] = None,
            window_duration_in_mins: Optional[pulumi.Input[_builtins.int]] = None,
            window_type: Optional[pulumi.Input[_builtins.str]] = None) -> 'ExecutionWindow':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="executionResourceId")
    def execution_resource_id(self) -> pulumi.Output[_builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the execution resource the execution window belongs to.
        """
        return pulumi.get(self, "execution_resource_id")
    ...
    @_builtins.property
    @pulumi.getter(name="isEnforcedDuration")
    def is_enforced_duration(self) -> pulumi.Output[_builtins.bool]:
        """
        (Updatable) Indicates if duration the user plans to allocate for scheduling window is strictly enforced. The default value is `FALSE`.
        """
        return pulumi.get(self, "is_enforced_duration")
    ...
    @_builtins.property
    @pulumi.getter(name="windowType")
    def window_type(self) -> pulumi.Output[_builtins.str]:
        """
        The execution window is of PLANNED or UNPLANNED type.
        """
        return pulumi.get(self, "window_type")
