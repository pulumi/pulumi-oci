...
class ExternalContainerDatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The user-friendly name for the external database. The name does not have to be unique.
...
class _ExternalContainerDatabaseState:
    def __init__(__self__, *,
                 ...
                 database_configuration: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 db_packs: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] character_set: The character set of the external database.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param pulumi.Input[builtins.str] database_configuration: The Oracle Database configuration
        ...
        :param pulumi.Input[builtins.str] db_id: The Oracle Database ID, which identifies an Oracle Database located outside of Oracle Cloud.
        :param pulumi.Input[builtins.str] db_packs: The database packs licensed for the external Oracle Database.
        :param pulumi.Input[builtins.str] db_unique_name: The `DB_UNIQUE_NAME` of the external database.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[builtins.str] display_name: (Updatable) The user-friendly name for the external database. The name does not have to be unique.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        ...
        :param pulumi.Input[builtins.str] ncharacter_set: The national character of the external database.
    ...
    def database_configuration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def database_configuration(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def db_packs(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @db_packs.setter
    def db_packs(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ExternalContainerDatabase(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_zone: Optional[pulumi.Input[builtins.str]] = None) -> 'ExternalContainerDatabase':
        """
    ...
    @property
    @pulumi.getter(name="databaseConfiguration")
    def database_configuration(self) -> pulumi.Output[builtins.str]:
        """
        The Oracle Database configuration
        """
        return pulumi.get(self, "database_configuration")
    ...
    @property
    @pulumi.getter(name="dbId")
    def db_id(self) -> pulumi.Output[builtins.str]:
        """
        The Oracle Database ID, which identifies an Oracle Database located outside of Oracle Cloud.
        """
        return pulumi.get(self, "db_id")
    ...
    @property
    @pulumi.getter(name="dbPacks")
    def db_packs(self) -> pulumi.Output[builtins.str]:
        """
        The database packs licensed for the external Oracle Database.
        """
        return pulumi.get(self, "db_packs")
