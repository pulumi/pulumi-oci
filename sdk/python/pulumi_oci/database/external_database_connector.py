...
class ExternalDatabaseConnectorArgs:
    def __init__(__self__, *,
                 ...
                 connector_agent_id: pulumi.Input[builtins.str],
                 display_name: pulumi.Input[builtins.str],
                 external_database_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] connector_agent_id: The ID of the agent used for the [external database connector](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/datatypes/CreateExternalDatabaseConnectorDetails).
        :param pulumi.Input[builtins.str] display_name: (Updatable) The user-friendly name for the [external database connector](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/datatypes/CreateExternalDatabaseConnectorDetails). The name does not have to be unique.
        :param pulumi.Input[builtins.str] external_database_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external database resource.
        :param pulumi.Input[builtins.str] connector_type: (Updatable) The type of connector used by the external database resource.
    ...
    def connector_agent_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def connector_agent_id(self, value: pulumi.Input[builtins.str]):
    ...
    def external_database_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def external_database_id(self, value: pulumi.Input[builtins.str]):
...
class _ExternalDatabaseConnectorState:
    def __init__(__self__, *,
                 ...
                 connector_agent_id: Optional[pulumi.Input[builtins.str]] = None,
                 connector_type: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input['ExternalDatabaseConnectorConnectionCredentialsArgs'] connection_credentials: (Updatable) Credentials used to connect to the database. Currently only the `DETAILS` type is supported for creating MACS connector crendentials.
        :param pulumi.Input[builtins.str] connection_status: The status of connectivity to the external database.
        :param pulumi.Input['ExternalDatabaseConnectorConnectionStringArgs'] connection_string: (Updatable) The Oracle Database connection string.
        :param pulumi.Input[builtins.str] connector_agent_id: The ID of the agent used for the [external database connector](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/datatypes/CreateExternalDatabaseConnectorDetails).
        :param pulumi.Input[builtins.str] connector_type: (Updatable) The type of connector used by the external database resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
    ...
    @property
    @pulumi.getter(name="connectorAgentId")
    def connector_agent_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The ID of the agent used for the [external database connector](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/datatypes/CreateExternalDatabaseConnectorDetails).
        """
        return pulumi.get(self, "connector_agent_id")
    ...
    @connector_agent_id.setter
    def connector_agent_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "connector_agent_id", value)
    ...
    def time_connection_status_last_updated(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_connection_status_last_updated(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ExternalDatabaseConnector(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="connectorAgentId")
    def connector_agent_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the agent used for the [external database connector](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/datatypes/CreateExternalDatabaseConnectorDetails).
        """
        return pulumi.get(self, "connector_agent_id")
    ...
    @property
    @pulumi.getter(name="timeConnectionStatusLastUpdated")
    def time_connection_status_last_updated(self) -> pulumi.Output[builtins.str]:
        """
        The date and time the `connectionStatus` of this external connector was last updated.
        """
        return pulumi.get(self, "time_connection_status_last_updated")
