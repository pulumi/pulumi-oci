...
__all__ = ['ExternalNonContainerDatabaseArgs', 'ExternalNonContainerDatabase']

@pulumi.input_type
class ExternalNonContainerDatabaseArgs:
...
@pulumi.input_type
class _ExternalNonContainerDatabaseState:
    def __init__(__self__, *,
                 ...
                 database_management_configs: pulumi.Input[Optional[Sequence[pulumi.Input['ExternalNonContainerDatabaseDatabaseManagementConfigArgs']]]] = None,
                 ...
                 operations_insights_configs: pulumi.Input[Optional[Sequence[pulumi.Input['ExternalNonContainerDatabaseOperationsInsightsConfigArgs']]]] = None,
                 stack_monitoring_configs: pulumi.Input[Optional[Sequence[pulumi.Input['ExternalNonContainerDatabaseStackMonitoringConfigArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['ExternalNonContainerDatabaseOperationsInsightsConfigArgs']]] operations_insights_configs: The configuration of Operations Insights for the external database
        :param pulumi.Input[Sequence[pulumi.Input['ExternalNonContainerDatabaseStackMonitoringConfigArgs']]] stack_monitoring_configs: The configuration of Stack Monitoring for the external database.
    ...
    def database_management_configs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ExternalNonContainerDatabaseDatabaseManagementConfigArgs']]]]:
        """
    ...
    def database_management_configs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ExternalNonContainerDatabaseDatabaseManagementConfigArgs']]]]):
    ...
    def operations_insights_configs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ExternalNonContainerDatabaseOperationsInsightsConfigArgs']]]]:
        """
    ...
    def operations_insights_configs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ExternalNonContainerDatabaseOperationsInsightsConfigArgs']]]]):
        pulumi.set(self, "operations_insights_configs", value)

    @_builtins.property
    @pulumi.getter(name="stackMonitoringConfigs")
    def stack_monitoring_configs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ExternalNonContainerDatabaseStackMonitoringConfigArgs']]]]:
        """
    ...
    def stack_monitoring_configs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ExternalNonContainerDatabaseStackMonitoringConfigArgs']]]]):
...
class ExternalNonContainerDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ExternalNonContainerDatabaseArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ExternalNonContainerDatabaseArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ExternalNonContainerDatabaseArgs.__new__(ExternalNonContainerDatabaseArgs)
        ...
        super(ExternalNonContainerDatabase, __self__).__init__(
            'oci:Database/externalNonContainerDatabase:ExternalNonContainerDatabase',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            database_configuration: pulumi.Input[Optional[_builtins.str]] = None,
            database_edition: pulumi.Input[Optional[_builtins.str]] = None,
            database_management_configs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ExternalNonContainerDatabaseDatabaseManagementConfigArgs', 'ExternalNonContainerDatabaseDatabaseManagementConfigArgsDict', 'outputs.ExternalNonContainerDatabaseDatabaseManagementConfig']]]]] = None,
            database_version: pulumi.Input[Optional[_builtins.str]] = None,
            db_id: pulumi.Input[Optional[_builtins.str]] = None,
            db_packs: pulumi.Input[Optional[_builtins.str]] = None,
            db_unique_name: pulumi.Input[Optional[_builtins.str]] = None,
            ...
            lifecycle_details: pulumi.Input[Optional[_builtins.str]] = None,
            ncharacter_set: pulumi.Input[Optional[_builtins.str]] = None,
            operations_insights_configs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ExternalNonContainerDatabaseOperationsInsightsConfigArgs', 'ExternalNonContainerDatabaseOperationsInsightsConfigArgsDict', 'outputs.ExternalNonContainerDatabaseOperationsInsightsConfig']]]]] = None,
            stack_monitoring_configs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ExternalNonContainerDatabaseStackMonitoringConfigArgs', 'ExternalNonContainerDatabaseStackMonitoringConfigArgsDict', 'outputs.ExternalNonContainerDatabaseStackMonitoringConfig']]]]] = None,
            state: pulumi.Input[Optional[_builtins.str]] = None,
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_zone: pulumi.Input[Optional[_builtins.str]] = None) -> 'ExternalNonContainerDatabase':
        """
        ...
        :param pulumi.Input[_builtins.str] database_configuration: The Oracle Database configuration
        :param pulumi.Input[_builtins.str] database_edition: The Oracle Database Edition that applies to all the databases on the DB system. Exadata DB systems and 2-node RAC DB systems require ENTERPRISE_EDITION_EXTREME_PERFORMANCE.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ExternalNonContainerDatabaseDatabaseManagementConfigArgs', 'ExternalNonContainerDatabaseDatabaseManagementConfigArgsDict', 'outputs.ExternalNonContainerDatabaseDatabaseManagementConfig']]]] database_management_configs: The configuration of the Database Management service.
        :param pulumi.Input[_builtins.str] database_version: The Oracle Database version.
        :param pulumi.Input[_builtins.str] db_id: The Oracle Database ID, which identifies an Oracle Database located outside of Oracle Cloud.
        :param pulumi.Input[_builtins.str] db_packs: The database packs licensed for the external Oracle Database.
        :param pulumi.Input[_builtins.str] db_unique_name: The `DB_UNIQUE_NAME` of the external database.
        ...
        :param pulumi.Input[_builtins.str] lifecycle_details: Additional information about the current lifecycle state.
        :param pulumi.Input[_builtins.str] ncharacter_set: The national character of the external database.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ExternalNonContainerDatabaseOperationsInsightsConfigArgs', 'ExternalNonContainerDatabaseOperationsInsightsConfigArgsDict', 'outputs.ExternalNonContainerDatabaseOperationsInsightsConfig']]]] operations_insights_configs: The configuration of Operations Insights for the external database
        :param pulumi.Input[Sequence[pulumi.Input[Union['ExternalNonContainerDatabaseStackMonitoringConfigArgs', 'ExternalNonContainerDatabaseStackMonitoringConfigArgsDict', 'outputs.ExternalNonContainerDatabaseStackMonitoringConfig']]]] stack_monitoring_configs: The configuration of Stack Monitoring for the external database.
        :param pulumi.Input[_builtins.str] state: The current state of the Oracle Cloud Infrastructure external database resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[_builtins.str] time_created: The date and time the database was created.
        :param pulumi.Input[_builtins.str] time_zone: The time zone of the external database. It is a time zone offset (a character type in the format '[+|-]TZH:TZM') or a time zone region name, depending on how the time zone value was specified when the database was created / last altered.
        ...
        __props__ = _ExternalNonContainerDatabaseState.__new__(_ExternalNonContainerDatabaseState)
        ...
        return ExternalNonContainerDatabase(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="databaseManagementConfigs")
    def database_management_configs(self) -> pulumi.Output[Sequence['outputs.ExternalNonContainerDatabaseDatabaseManagementConfig']]:
        """
        The configuration of the Database Management service.
        """
        return pulumi.get(self, "database_management_configs")
    ...
    @_builtins.property
    @pulumi.getter(name="operationsInsightsConfigs")
    def operations_insights_configs(self) -> pulumi.Output[Sequence['outputs.ExternalNonContainerDatabaseOperationsInsightsConfig']]:
        """
        The configuration of Operations Insights for the external database
        """
        return pulumi.get(self, "operations_insights_configs")
    ...
    @_builtins.property
    @pulumi.getter(name="stackMonitoringConfigs")
    def stack_monitoring_configs(self) -> pulumi.Output[Sequence['outputs.ExternalNonContainerDatabaseStackMonitoringConfig']]:
        """
        The configuration of Stack Monitoring for the external database.
        """
        return pulumi.get(self, "stack_monitoring_configs")
