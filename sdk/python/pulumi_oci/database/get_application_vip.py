...
class GetApplicationVipResult:
    ...
    def application_vip_id(self) -> _builtins.str:
...
def get_application_vip(application_vip_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str application_vip_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the application virtual IP (VIP) address.
    """
    __args__ = dict()
