...
class GetApplicationVipResult:
    ...
    def application_vip_id(self) -> builtins.str:
...
def get_application_vip(application_vip_id: Optional[builtins.str] = None,
    ...
    :param builtins.str application_vip_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the application virtual IP (VIP) address.
    """
    __args__ = dict()
...
def get_application_vip_output(application_vip_id: Optional[pulumi.Input[builtins.str]] = None,
