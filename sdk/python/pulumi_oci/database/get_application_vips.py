...
def get_application_vips(cloud_vm_cluster_id: Optional[builtins.str] = None,
...
def get_application_vips_output(cloud_vm_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
