...
class GetAutonomousCharacterSetsResult:
    ...
    def character_set_type(self) -> Optional[builtins.str]:
    ...
    def is_dedicated(self) -> Optional[builtins.bool]:
...
def get_autonomous_character_sets(character_set_type: Optional[builtins.str] = None,
                                  filters: Optional[Sequence[Union['GetAutonomousCharacterSetsFilterArgs', 'GetAutonomousCharacterSetsFilterArgsDict']]] = None,
                                  is_dedicated: Optional[builtins.bool] = None,
    ...
    :param builtins.str character_set_type: Specifies whether this request pertains to database character sets or national character sets.
    :param builtins.bool is_dedicated: Specifies if the request is for an Autonomous Database Dedicated instance. The default request is for an Autonomous Database Dedicated instance.
    :param builtins.bool is_shared: Specifies whether this request is for Autonomous Database on Shared infrastructure. By default, this request will be for Autonomous Database on Dedicated Exadata Infrastructure.
...
def get_autonomous_character_sets_output(character_set_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                         ...
                                         is_dedicated: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                         is_shared: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
