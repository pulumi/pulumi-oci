...
def get_autonomous_container_database(autonomous_container_database_id: Optional[builtins.str] = None,
...
def get_autonomous_container_database_output(autonomous_container_database_id: Optional[pulumi.Input[builtins.str]] = None,
