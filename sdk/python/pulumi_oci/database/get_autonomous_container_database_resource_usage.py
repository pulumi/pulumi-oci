...
def get_autonomous_container_database_resource_usage(autonomous_container_database_id: Optional[builtins.str] = None,
...
def get_autonomous_container_database_resource_usage_output(autonomous_container_database_id: Optional[pulumi.Input[builtins.str]] = None,
