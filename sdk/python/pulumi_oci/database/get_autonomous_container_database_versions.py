...
class GetAutonomousContainerDatabaseVersionsResult:
    ...
    def service_component(self) -> builtins.str:
...
def get_autonomous_container_database_versions(compartment_id: Optional[builtins.str] = None,
                                               ...
                                               service_component: Optional[builtins.str] = None,
    ...
    :param builtins.str service_component: The service component to use, either ADBD or EXACC.
    """
    __args__ = dict()
...
def get_autonomous_container_database_versions_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                                      ...
                                                      service_component: Optional[pulumi.Input[builtins.str]] = None,
