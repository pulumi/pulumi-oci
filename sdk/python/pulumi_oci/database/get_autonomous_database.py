...
def get_autonomous_database(autonomous_database_id: Optional[builtins.str] = None,
...
def get_autonomous_database_output(autonomous_database_id: Optional[pulumi.Input[builtins.str]] = None,
