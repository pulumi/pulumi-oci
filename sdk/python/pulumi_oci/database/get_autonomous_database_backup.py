...
def get_autonomous_database_backup(autonomous_database_backup_id: Optional[builtins.str] = None,
    ...
    :param builtins.str autonomous_database_backup_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Autonomous Database backup.
    """
    __args__ = dict()
...
def get_autonomous_database_backup_output(autonomous_database_backup_id: Optional[pulumi.Input[builtins.str]] = None,
