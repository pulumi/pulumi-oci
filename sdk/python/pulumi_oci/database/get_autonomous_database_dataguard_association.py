...
class GetAutonomousDatabaseDataguardAssociationResult:
    ...
    def autonomous_database_dataguard_association_id(self) -> _builtins.str:
...
def get_autonomous_database_dataguard_association(autonomous_database_dataguard_association_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str autonomous_database_dataguard_association_id: The Autonomous Database Dataguard Association [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
