...
class GetAutonomousDatabaseDataguardAssociationResult:
    ...
    def autonomous_database_dataguard_association_id(self) -> builtins.str:
...
def get_autonomous_database_dataguard_association(autonomous_database_dataguard_association_id: Optional[builtins.str] = None,
                                                  autonomous_database_id: Optional[builtins.str] = None,
    ...
    :param builtins.str autonomous_database_dataguard_association_id: The Autonomous Database Dataguard Association [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
...
def get_autonomous_database_dataguard_association_output(autonomous_database_dataguard_association_id: Optional[pulumi.Input[builtins.str]] = None,
