...
def get_autonomous_database_peers(autonomous_database_id: Optional[builtins.str] = None,
...
def get_autonomous_database_peers_output(autonomous_database_id: Optional[pulumi.Input[builtins.str]] = None,
