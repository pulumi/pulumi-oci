...
def get_autonomous_database_software_images(compartment_id: Optional[builtins.str] = None,
...
def get_autonomous_database_software_images_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
