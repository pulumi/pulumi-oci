...
class GetAutonomousDatabaseWalletResult:
    ...
    def generate_type(self) -> Optional[builtins.str]:
...
def get_autonomous_database_wallet(autonomous_database_id: Optional[builtins.str] = None,
                                   base64_encode_content: Optional[builtins.bool] = None,
                                   generate_type: Optional[builtins.str] = None,
    ...
    **Deprecated. Use Database.AutonomousDatabaseWallet instead.**
    ...
    :param builtins.str generate_type: The type of wallet to generate.
    ...
    :param builtins.str password: The password to encrypt the keys inside the wallet. The password must be at least 8 characters long and must include at least 1 letter and either 1 numeric character or 1 special character.
    """
    __args__ = dict()
...
def get_autonomous_database_wallet_output(autonomous_database_id: Optional[pulumi.Input[builtins.str]] = None,
                                          base64_encode_content: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                          generate_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
