...
def get_autonomous_databases_clones(autonomous_database_id: Optional[builtins.str] = None,
    ...
    :param builtins.str clone_type: A filter to return only resources that match the given clone type exactly.
...
def get_autonomous_databases_clones_output(autonomous_database_id: Optional[pulumi.Input[builtins.str]] = None,
                                           clone_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
