...
def get_autonomous_db_preview_versions(compartment_id: Optional[builtins.str] = None,
...
def get_autonomous_db_preview_versions_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
