...
class GetAutonomousExadataInfrastructureOcpuResult:
    ...
    def consumed_cpu(self) -> _builtins.float:
        """
    ...
    def total_cpu(self) -> _builtins.float:
        """
...
def get_autonomous_exadata_infrastructure_ocpu(autonomous_exadata_infrastructure_id: Optional[_builtins.str] = None,
