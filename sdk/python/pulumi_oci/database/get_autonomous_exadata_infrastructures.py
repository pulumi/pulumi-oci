...
def get_autonomous_exadata_infrastructures(availability_domain: Optional[builtins.str] = None,
...
def get_autonomous_exadata_infrastructures_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    **Deprecated.** Use the [ListCloudExadataInfrastructures](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/CloudExadataInfrastructure/ListCloudExadataInfrastructures) operation to list Exadata Infrastructures in the Oracle cloud and the  [ListCloudAutonomousVmClusters](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/CloudAutonomousVmCluster/ListCloudAutonomousVmClusters) operation to list Autonomous Exadata VM clusters.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Database/getAutonomousExadataInfrastructures:getAutonomousExadataInfrastructures', __args__, opts=opts, typ=GetAutonomousExadataInfrastructuresResult)
    return __ret__.apply(lambda __response__: GetAutonomousExadataInfrastructuresResult(
        autonomous_exadata_infrastructures=pulumi.get(__response__, 'autonomous_exadata_infrastructures'),
