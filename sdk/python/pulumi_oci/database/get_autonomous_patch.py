...
class GetAutonomousPatchResult:
    ...
    def autonomous_patch_id(self) -> builtins.str:
...
def get_autonomous_patch(autonomous_patch_id: Optional[builtins.str] = None,
    ...
    :param builtins.str autonomous_patch_id: The autonomous patch [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    """
    __args__ = dict()
...
def get_autonomous_patch_output(autonomous_patch_id: Optional[pulumi.Input[builtins.str]] = None,
