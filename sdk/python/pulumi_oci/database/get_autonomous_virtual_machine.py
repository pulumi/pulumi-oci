...
class GetAutonomousVirtualMachineResult:
    ...
    def autonomous_virtual_machine_id(self) -> builtins.str:
...
def get_autonomous_virtual_machine(autonomous_virtual_machine_id: Optional[builtins.str] = None,
    ...
    :param builtins.str autonomous_virtual_machine_id: The Autonomous Virtual machine [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    """
    __args__ = dict()
...
def get_autonomous_virtual_machine_output(autonomous_virtual_machine_id: Optional[pulumi.Input[builtins.str]] = None,
