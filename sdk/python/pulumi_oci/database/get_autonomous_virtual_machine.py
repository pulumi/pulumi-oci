...
class GetAutonomousVirtualMachineResult:
    ...
    def autonomous_virtual_machine_id(self) -> _builtins.str:
...
def get_autonomous_virtual_machine(autonomous_virtual_machine_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str autonomous_virtual_machine_id: The Autonomous Virtual machine [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    """
    __args__ = dict()
