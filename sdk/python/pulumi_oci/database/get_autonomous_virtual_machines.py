...
def get_autonomous_virtual_machines(autonomous_vm_cluster_id: Optional[builtins.str] = None,
...
def get_autonomous_virtual_machines_output(autonomous_vm_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
