...
class GetAutonomousVmClusterResourceUsageResult:
    ...
    def used_autonomous_data_storage_size_in_tbs(self) -> _builtins.float:
        """
...
def get_autonomous_vm_cluster_resource_usage(autonomous_vm_cluster_id: Optional[_builtins.str] = None,
...
def get_autonomous_vm_cluster_resource_usage_output(autonomous_vm_cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
