...
def get_autonomous_vm_clusters(compartment_id: Optional[builtins.str] = None,
...
def get_autonomous_vm_clusters_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
