...
class GetBackupDestinationResult:
    ...
    def backup_destination_id(self) -> builtins.str:
...
def get_backup_destination(backup_destination_id: Optional[builtins.str] = None,
    ...
    :param builtins.str backup_destination_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the backup destination.
    """
    __args__ = dict()
...
def get_backup_destination_output(backup_destination_id: Optional[pulumi.Input[builtins.str]] = None,
