...
def get_backup_destinations(compartment_id: Optional[builtins.str] = None,
...
def get_backup_destinations_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
