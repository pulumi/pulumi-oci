...
class GetBackupsResult:
    ...
    def backup_destination_type(self) -> Optional[_builtins.str]:
        """
    ...
    def time_expiry_scheduled_greater_than_or_equal_to(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "time_expiry_scheduled_greater_than_or_equal_to")

    @_builtins.property
    @pulumi.getter(name="timeExpiryScheduledLessThan")
    def time_expiry_scheduled_less_than(self) -> Optional[_builtins.str]:
...
def get_backups(backup_destination_type: Optional[_builtins.str] = None,
                ...
                time_expiry_scheduled_greater_than_or_equal_to: Optional[_builtins.str] = None,
                time_expiry_scheduled_less_than: Optional[_builtins.str] = None,
    ...
    :param _builtins.str time_expiry_scheduled_greater_than_or_equal_to: The start of date-time range of expiration for the long term backups to be fetched.
    :param _builtins.str time_expiry_scheduled_less_than: The end of date-time range of expiration for the long term backups to be fetched.
