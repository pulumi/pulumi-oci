...
class GetBackupsResult:
    ...
    def backup_destination_type(self) -> Optional[builtins.str]:
        """
    ...
    def shape_family(self) -> Optional[builtins.str]:
    ...
    def time_expiry_scheduled_greater_than_or_equal_to(self) -> Optional[builtins.str]:
        return pulumi.get(self, "time_expiry_scheduled_greater_than_or_equal_to")

    @property
    @pulumi.getter(name="timeExpiryScheduledLessThan")
    def time_expiry_scheduled_less_than(self) -> Optional[builtins.str]:
...
def get_backups(backup_destination_type: Optional[builtins.str] = None,
                ...
                shape_family: Optional[builtins.str] = None,
                state: Optional[builtins.str] = None,
                time_expiry_scheduled_greater_than_or_equal_to: Optional[builtins.str] = None,
                time_expiry_scheduled_less_than: Optional[builtins.str] = None,
    ...
    :param builtins.str shape_family: If provided, filters the results to the set of database versions which are supported for the given shape family.
    :param builtins.str state: A filter to return only resources that match the given lifecycle state exactly.
    :param builtins.str time_expiry_scheduled_greater_than_or_equal_to: The start of date-time range of expiration for the long term backups to be fetched.
    :param builtins.str time_expiry_scheduled_less_than: The end of date-time range of expiration for the long term backups to be fetched.
...
def get_backups_output(backup_destination_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       ...
                       shape_family: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       state: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       time_expiry_scheduled_greater_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       time_expiry_scheduled_less_than: Optional[pulumi.Input[Optional[builtins.str]]] = None,
