...
def get_cloud_exadata_infrastructures(cluster_placement_group_id: Optional[builtins.str] = None,
...
def get_cloud_exadata_infrastructures_output(cluster_placement_group_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
