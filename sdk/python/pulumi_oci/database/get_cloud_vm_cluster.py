...
class GetCloudVmClusterResult:
    ...
    def multi_cloud_identity_connector_configs(self) -> Sequence['outputs.GetCloudVmClusterMultiCloudIdentityConnectorConfigResult']:
        """
...
def get_cloud_vm_cluster(cloud_vm_cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str cloud_vm_cluster_id: The cloud VM cluster [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    """
    __args__ = dict()
...
def get_cloud_vm_cluster_output(cloud_vm_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
