...
def get_cloud_vm_clusters(cloud_exadata_infrastructure_id: Optional[builtins.str] = None,
...
def get_cloud_vm_clusters_output(cloud_exadata_infrastructure_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
