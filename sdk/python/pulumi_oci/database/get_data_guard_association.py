...
class GetDataGuardAssociationResult:
    ...
    def data_guard_association_id(self) -> builtins.str:
...
def get_data_guard_association(data_guard_association_id: Optional[builtins.str] = None,
    ...
    :param builtins.str data_guard_association_id: The Data Guard association's [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
...
def get_data_guard_association_output(data_guard_association_id: Optional[pulumi.Input[builtins.str]] = None,
