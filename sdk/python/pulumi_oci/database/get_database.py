...
class GetDatabaseResult:
    ...
    def __init__(__self__, action_trigger=None, character_set=None, compartment_id=None, connection_strings=None, data_guard_action=None, data_guard_groups=None, database_id=None, database_management_configs=None, database_software_image_id=None, databases=None, db_backup_configs=None, db_home_id=None, db_name=None, db_system_id=None, db_unique_name=None, db_version=None, db_workload=None, defined_tags=None, freeform_tags=None, id=None, is_cdb=None, key_store_id=None, key_store_wallet_name=None, kms_key_id=None, kms_key_migration=None, kms_key_rotation=None, kms_key_version_id=None, last_backup_duration_in_seconds=None, last_backup_timestamp=None, last_failed_backup_timestamp=None, lifecycle_details=None, managed_software_update_details=None, ncharacter_set=None, patch_version=None, pdb_name=None, sid_prefix=None, source=None, source_database_point_in_time_recovery_timestamp=None, state=None, storage_size_details=None, system_tags=None, time_created=None, vault_id=None, vm_cluster_id=None):
        ...
        if managed_software_update_details and not isinstance(managed_software_update_details, list):
            raise TypeError("Expected argument 'managed_software_update_details' to be a list")
    ...
    def managed_software_update_details(self) -> Sequence['outputs.GetDatabaseManagedSoftwareUpdateDetailResult']:
        """
...
class AwaitableGetDatabaseResult(GetDatabaseResult):
    ...
    def __await__(self):
        ...
        return GetDatabaseResult(
            ...
            managed_software_update_details=self.managed_software_update_details,
...
def get_database(database_id: Optional[_builtins.str] = None,
    ...
    return AwaitableGetDatabaseResult(
        ...
        managed_software_update_details=pulumi.get(__ret__, 'managed_software_update_details'),
...
def get_database_output(database_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetDatabaseResult(
        ...
        managed_software_update_details=pulumi.get(__response__, 'managed_software_update_details'),
