...
class GetDatabaseMaintenanceRunHistoryResult:
    ...
    def maintenance_run_history_id(self) -> builtins.str:
...
def get_database_maintenance_run_history(maintenance_run_history_id: Optional[builtins.str] = None,
    ...
    :param builtins.str maintenance_run_history_id: The maintenance run history OCID.
    """
    __args__ = dict()
...
def get_database_maintenance_run_history_output(maintenance_run_history_id: Optional[pulumi.Input[builtins.str]] = None,
