...
class GetDatabasePdbConversionHistoryEntriesResult:
    ...
    def pdb_conversion_action(self) -> Optional[_builtins.str]:
...
def get_database_pdb_conversion_history_entries(database_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str pdb_conversion_action: A filter to return only the pluggable database conversion history entries that match the specified conversion action. For example, you can use this filter to return only entries for the precheck operation.
