...
class GetDatabaseUpgradeHistoryEntryResult:
    ...
    def upgrade_history_entry_id(self) -> builtins.str:
...
def get_database_upgrade_history_entry(database_id: Optional[builtins.str] = None,
                                       upgrade_history_entry_id: Optional[builtins.str] = None,
    ...
    :param builtins.str upgrade_history_entry_id: The database/db system upgrade History [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    """
    __args__ = dict()
...
def get_database_upgrade_history_entry_output(database_id: Optional[pulumi.Input[builtins.str]] = None,
                                              upgrade_history_entry_id: Optional[pulumi.Input[builtins.str]] = None,
