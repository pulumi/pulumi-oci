...
class GetDatabasesResult:
    ...
    def db_home_id(self) -> Optional[builtins.str]:
        """
...
def get_databases(compartment_id: Optional[builtins.str] = None,
                  db_home_id: Optional[builtins.str] = None,
    ...
    :param builtins.str system_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata DB system that you want to filter the database results by. Applies only to Exadata DB systems.
    """
    __args__ = dict()
...
def get_databases_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                         db_home_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                         ...
                         system_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
