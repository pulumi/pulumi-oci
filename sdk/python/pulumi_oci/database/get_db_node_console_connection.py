...
def get_db_node_console_connection(db_node_id: Optional[builtins.str] = None,
...
def get_db_node_console_connection_output(db_node_id: Optional[pulumi.Input[builtins.str]] = None,
