...
def get_db_node_console_connections(db_node_id: Optional[builtins.str] = None,
...
def get_db_node_console_connections_output(db_node_id: Optional[pulumi.Input[builtins.str]] = None,
