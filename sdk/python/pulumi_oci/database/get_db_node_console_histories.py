...
def get_db_node_console_histories(db_node_id: Optional[builtins.str] = None,
...
def get_db_node_console_histories_output(db_node_id: Optional[pulumi.Input[builtins.str]] = None,
