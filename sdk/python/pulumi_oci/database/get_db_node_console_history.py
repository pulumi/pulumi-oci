...
def get_db_node_console_history(console_history_id: Optional[builtins.str] = None,
...
def get_db_node_console_history_output(console_history_id: Optional[pulumi.Input[builtins.str]] = None,
