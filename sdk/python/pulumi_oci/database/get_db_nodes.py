...
def get_db_nodes(compartment_id: Optional[builtins.str] = None,
...
def get_db_nodes_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                        db_server_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
