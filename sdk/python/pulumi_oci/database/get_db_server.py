...
def get_db_server(db_server_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str db_server_id: The DB server [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
