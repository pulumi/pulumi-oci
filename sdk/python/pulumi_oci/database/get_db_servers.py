...
def get_db_servers(compartment_id: Optional[builtins.str] = None,
...
def get_db_servers_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Database/getDbServers:getDbServers', __args__, opts=opts, typ=GetDbServersResult)
