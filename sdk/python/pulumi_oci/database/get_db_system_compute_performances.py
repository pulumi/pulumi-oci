...
def get_db_system_compute_performances(db_system_shape: Optional[builtins.str] = None,
...
def get_db_system_compute_performances_output(db_system_shape: Optional[pulumi.Input[Optional[builtins.str]]] = None,
