...
def get_db_system_history_entries(db_system_id: Optional[builtins.str] = None,
...
def get_db_system_history_entries_output(db_system_id: Optional[pulumi.Input[builtins.str]] = None,
