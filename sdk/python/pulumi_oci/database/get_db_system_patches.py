...
def get_db_system_patches(db_system_id: Optional[builtins.str] = None,
...
def get_db_system_patches_output(db_system_id: Optional[pulumi.Input[builtins.str]] = None,
