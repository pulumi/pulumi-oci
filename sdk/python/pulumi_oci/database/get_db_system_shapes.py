...
def get_db_system_shapes(availability_domain: Optional[builtins.str] = None,
...
def get_db_system_shapes_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
