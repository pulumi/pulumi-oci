...
def get_db_systems_upgrade_history_entry(db_system_id: Optional[builtins.str] = None,
...
def get_db_systems_upgrade_history_entry_output(db_system_id: Optional[pulumi.Input[builtins.str]] = None,
