...
class GetDbVersionsResult:
    ...
    def is_database_software_image_supported(self) -> Optional[_builtins.bool]:
...
def get_db_versions(compartment_id: Optional[_builtins.str] = None,
                    db_system_id: Optional[_builtins.str] = None,
                    db_system_shape: Optional[_builtins.str] = None,
                    filters: Optional[Sequence[Union['GetDbVersionsFilterArgs', 'GetDbVersionsFilterArgsDict', 'outputs.GetDbVersionsFilterResult']]] = None,
...
def get_db_versions_output(compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                           ...
                           filters: pulumi.Input[Optional[Optional[Sequence[Union['GetDbVersionsFilterArgs', 'GetDbVersionsFilterArgsDict', 'outputs.GetDbVersionsFilterResult']]]]] = None,
