...
class GetDbVersionsResult:
    ...
    def db_system_shape(self) -> Optional[builtins.str]:
    ...
    def is_database_software_image_supported(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "is_database_software_image_supported")

    @property
    @pulumi.getter(name="isUpgradeSupported")
    def is_upgrade_supported(self) -> Optional[builtins.bool]:
        """
...
def get_db_versions(compartment_id: Optional[builtins.str] = None,
                    db_system_id: Optional[builtins.str] = None,
                    db_system_shape: Optional[builtins.str] = None,
                    filters: Optional[Sequence[Union['GetDbVersionsFilterArgs', 'GetDbVersionsFilterArgsDict']]] = None,
                    is_database_software_image_supported: Optional[builtins.bool] = None,
                    is_upgrade_supported: Optional[builtins.bool] = None,
    ...
    :param builtins.str db_system_shape: If provided, filters the results to the set of database versions which are supported for the given shape.
    :param builtins.bool is_database_software_image_supported: If true, filters the results to the set of Oracle Database versions that are supported for Oracle Cloud Infrastructure database software images.
...
def get_db_versions_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                           db_system_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           db_system_shape: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           filters: Optional[pulumi.Input[Optional[Sequence[Union['GetDbVersionsFilterArgs', 'GetDbVersionsFilterArgsDict']]]]] = None,
                           is_database_software_image_supported: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                           is_upgrade_supported: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                           storage_management: Optional[pulumi.Input[Optional[builtins.str]]] = None,
