...
class GetExadataInfrastructureResult:
    ...
    def maintenance_version_preferences(self) -> Sequence['outputs.GetExadataInfrastructureMaintenanceVersionPreferenceResult']:
        """
...
def get_exadata_infrastructure(exadata_infrastructure_id: Optional[_builtins.str] = None,
