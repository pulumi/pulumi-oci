...
class GetExadataInfrastructureUnAllocatedResourceResult:
    ...
    def cloud_autonomous_vm_clusters(self) -> Sequence['outputs.GetExadataInfrastructureUnAllocatedResourceCloudAutonomousVmClusterResult']:
        """
...
def get_exadata_infrastructure_un_allocated_resource(cloud_exadata_infrastructure_id: Optional[str] = None,
    ...
    test_cloud_exadata_infrastructure_un_allocated_resource = oci.Database.get_exadata_infrastructure_un_allocated_resource(cloud_exadata_infrastructure_id=oci_database_cloud_exadata_infrastructure["test_cloud_exadata_infrastructure"]["id"])
    ```
...
def get_exadata_infrastructure_un_allocated_resource_output(cloud_exadata_infrastructure_id: Optional[pulumi.Input[str]] = None,
