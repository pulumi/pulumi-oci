...
def get_exadata_infrastructures(compartment_id: Optional[builtins.str] = None,
...
def get_exadata_infrastructures_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
