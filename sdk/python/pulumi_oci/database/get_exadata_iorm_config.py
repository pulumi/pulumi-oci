...
def get_exadata_iorm_config(db_system_id: Optional[builtins.str] = None,
...
def get_exadata_iorm_config_output(db_system_id: Optional[pulumi.Input[builtins.str]] = None,
