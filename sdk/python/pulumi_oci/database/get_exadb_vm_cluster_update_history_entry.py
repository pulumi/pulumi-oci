...
def get_exadb_vm_cluster_update_history_entry(exadb_vm_cluster_id: Optional[builtins.str] = None,
                                              update_history_entry_id: Optional[builtins.str] = None,
...
def get_exadb_vm_cluster_update_history_entry_output(exadb_vm_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
                                                     update_history_entry_id: Optional[pulumi.Input[builtins.str]] = None,
