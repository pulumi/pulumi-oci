...
def get_exadb_vm_cluster_updates(exadb_vm_cluster_id: Optional[builtins.str] = None,
...
def get_exadb_vm_cluster_updates_output(exadb_vm_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
