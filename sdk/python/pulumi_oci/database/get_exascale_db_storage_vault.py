...
def get_exascale_db_storage_vault(exascale_db_storage_vault_id: Optional[builtins.str] = None,
    ...
    :param builtins.str exascale_db_storage_vault_id: The Exadata Database Storage Vault [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    """
    __args__ = dict()
...
def get_exascale_db_storage_vault_output(exascale_db_storage_vault_id: Optional[pulumi.Input[builtins.str]] = None,
