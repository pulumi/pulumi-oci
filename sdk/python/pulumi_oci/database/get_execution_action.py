...
class GetExecutionActionResult:
    ...
    def execution_action_id(self) -> builtins.str:
...
def get_execution_action(execution_action_id: Optional[builtins.str] = None,
    ...
    :param builtins.str execution_action_id: The execution action [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    """
    __args__ = dict()
...
def get_execution_action_output(execution_action_id: Optional[pulumi.Input[builtins.str]] = None,
