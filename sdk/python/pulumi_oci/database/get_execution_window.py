...
def get_execution_window(execution_window_id: Optional[builtins.str] = None,
    ...
    :param builtins.str execution_window_id: The execution window [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    """
    __args__ = dict()
...
def get_execution_window_output(execution_window_id: Optional[pulumi.Input[builtins.str]] = None,
