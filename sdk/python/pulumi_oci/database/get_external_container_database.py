...
class GetExternalContainerDatabaseResult:
    ...
    def database_management_configs(self) -> Optional[Sequence['outputs.GetExternalContainerDatabaseDatabaseManagementConfigResult']]:
    ...
    def stack_monitoring_configs(self) -> Optional[Sequence['outputs.GetExternalContainerDatabaseStackMonitoringConfigResult']]:
...
@_utilities.lift_output_func(get_external_container_database)
