...
def get_external_database_connectors(compartment_id: Optional[builtins.str] = None,
...
def get_external_database_connectors_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
