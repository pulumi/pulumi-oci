...
class GetExternalNonContainerDatabaseResult:
    ...
    def database_management_configs(self) -> Optional[Sequence['outputs.GetExternalNonContainerDatabaseDatabaseManagementConfigResult']]:
    ...
    def operations_insights_configs(self) -> Optional[Sequence['outputs.GetExternalNonContainerDatabaseOperationsInsightsConfigResult']]:
        return pulumi.get(self, "operations_insights_configs")

    @property
    @pulumi.getter(name="stackMonitoringConfigs")
    def stack_monitoring_configs(self) -> Optional[Sequence['outputs.GetExternalNonContainerDatabaseStackMonitoringConfigResult']]:
