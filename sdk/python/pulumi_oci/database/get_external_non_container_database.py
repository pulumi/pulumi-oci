...
class GetExternalNonContainerDatabaseResult:
    ...
    def external_non_container_database_id(self) -> _builtins.str:
...
def get_external_non_container_database(external_non_container_database_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str external_non_container_database_id: The external non-container database [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    """
    __args__ = dict()
...
def get_external_non_container_database_output(external_non_container_database_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetExternalNonContainerDatabaseResult(
        ...
        external_non_container_database_id=pulumi.get(__response__, 'external_non_container_database_id'),
