...
class GetExternalNonContainerDatabaseResult:
    ...
    def external_non_container_database_id(self) -> builtins.str:
...
def get_external_non_container_database(external_non_container_database_id: Optional[builtins.str] = None,
    ...
    :param builtins.str external_non_container_database_id: The external non-container database [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    """
    __args__ = dict()
