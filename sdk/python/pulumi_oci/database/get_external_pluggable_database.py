...
class GetExternalPluggableDatabaseResult:
    ...
    def external_pluggable_database_id(self) -> str:
...
def get_external_pluggable_database(external_pluggable_database_id: Optional[str] = None,
    ...
    test_external_pluggable_database = oci.Database.get_external_pluggable_database(external_pluggable_database_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
    ```
    ...
    return AwaitableGetExternalPluggableDatabaseResult(
        ...
        external_pluggable_database_id=__ret__.external_pluggable_database_id,
