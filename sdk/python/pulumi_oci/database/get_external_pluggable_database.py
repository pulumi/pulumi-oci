...
class GetExternalPluggableDatabaseResult:
    ...
    def external_pluggable_database_id(self) -> builtins.str:
...
def get_external_pluggable_database(external_pluggable_database_id: Optional[builtins.str] = None,
    ...
    :param builtins.str external_pluggable_database_id: The ExternalPluggableDatabaseId [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    """
    __args__ = dict()
...
def get_external_pluggable_database_output(external_pluggable_database_id: Optional[pulumi.Input[builtins.str]] = None,
