...
class GetExternalPluggableDatabasesResult:
    ...
    def external_container_database_id(self) -> Optional[builtins.str]:
        """
...
def get_external_pluggable_databases(compartment_id: Optional[builtins.str] = None,
                                     display_name: Optional[builtins.str] = None,
                                     external_container_database_id: Optional[builtins.str] = None,
...
def get_external_pluggable_databases_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                            display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                            external_container_database_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Database/getExternalPluggableDatabases:getExternalPluggableDatabases', __args__, opts=opts, typ=GetExternalPluggableDatabasesResult)
    return __ret__.apply(lambda __response__: GetExternalPluggableDatabasesResult(
        compartment_id=pulumi.get(__response__, 'compartment_id'),
        display_name=pulumi.get(__response__, 'display_name'),
        external_container_database_id=pulumi.get(__response__, 'external_container_database_id'),
        external_pluggable_databases=pulumi.get(__response__, 'external_pluggable_databases'),
