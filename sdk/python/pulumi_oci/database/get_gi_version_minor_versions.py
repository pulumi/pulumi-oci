...
class GetGiVersionMinorVersionsResult:
    ...
    def is_gi_version_for_provisioning(self) -> Optional[builtins.bool]:
...
def get_gi_version_minor_versions(availability_domain: Optional[builtins.str] = None,
                                  ...
                                  is_gi_version_for_provisioning: Optional[builtins.bool] = None,
    ...
    :param builtins.bool is_gi_version_for_provisioning: If true, returns the Grid Infrastructure versions that can be used for provisioning a cluster
...
def get_gi_version_minor_versions_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                         ...
                                         is_gi_version_for_provisioning: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
