...
class GetMaintenanceRunResult:
    ...
    def maintenance_run_id(self) -> builtins.str:
...
def get_maintenance_run(maintenance_run_id: Optional[builtins.str] = None,
    ...
    :param builtins.str maintenance_run_id: The maintenance run OCID.
    """
    __args__ = dict()
...
def get_maintenance_run_output(maintenance_run_id: Optional[pulumi.Input[builtins.str]] = None,
