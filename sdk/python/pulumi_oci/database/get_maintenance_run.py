...
def get_maintenance_run(maintenance_run_id: Optional[str] = None,
    ...
    return AwaitableGetMaintenanceRunResult(
        ...
        current_custom_action_timeout_in_mins=__ret__.current_custom_action_timeout_in_mins,
        current_patching_component=__ret__.current_patching_component,
        custom_action_timeout_in_mins=__ret__.custom_action_timeout_in_mins,
        description=__ret__.description,
        display_name=__ret__.display_name,
        estimated_component_patching_start_time=__ret__.estimated_component_patching_start_time,
        estimated_patching_times=__ret__.estimated_patching_times,
        id=__ret__.id,
        is_custom_action_timeout_enabled=__ret__.is_custom_action_timeout_enabled,
        is_enabled=__ret__.is_enabled,
        is_patch_now_enabled=__ret__.is_patch_now_enabled,
        is_resume_patching=__ret__.is_resume_patching,
        ...
        patching_end_time=__ret__.patching_end_time,
        patching_mode=__ret__.patching_mode,
        patching_start_time=__ret__.patching_start_time,
        patching_status=__ret__.patching_status,
        peer_maintenance_run_id=__ret__.peer_maintenance_run_id,
        state=__ret__.state,
        target_db_server_version=__ret__.target_db_server_version,
        target_resource_id=__ret__.target_resource_id,
        target_resource_type=__ret__.target_resource_type,
        target_storage_server_version=__ret__.target_storage_server_version,
