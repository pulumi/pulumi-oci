...
class GetMaintenanceRunsResult:
    ...
    def is_local_adg(self) -> Optional[builtins.bool]:
    ...
    def maintenance_subtype(self) -> Optional[builtins.str]:
        """
...
def get_maintenance_runs(availability_domain: Optional[builtins.str] = None,
                         ...
                         is_local_adg: Optional[builtins.bool] = None,
                         maintenance_subtype: Optional[builtins.str] = None,
    ...
    :param builtins.bool is_local_adg: A filter to return the maintenance history results for the local standby Autonomous Database Serverless only.
...
def get_maintenance_runs_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                ...
                                is_local_adg: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                maintenance_subtype: Optional[pulumi.Input[Optional[builtins.str]]] = None,
