...
def get_managed_preferred_credential(credential_name: Optional[builtins.str] = None,
                                     managed_database_id: Optional[builtins.str] = None,
                                     named_credential_id: Optional[builtins.str] = None,
...
def get_managed_preferred_credential_output(credential_name: Optional[pulumi.Input[builtins.str]] = None,
                                            managed_database_id: Optional[pulumi.Input[builtins.str]] = None,
                                            named_credential_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
