...
class GetPluggableDatabaseResult:
    ...
    def pluggable_database_id(self) -> builtins.str:
...
def get_pluggable_database(pluggable_database_id: Optional[builtins.str] = None,
    ...
    :param builtins.str pluggable_database_id: The database [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    """
    __args__ = dict()
