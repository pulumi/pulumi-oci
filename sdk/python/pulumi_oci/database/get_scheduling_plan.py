...
def get_scheduling_plan(scheduling_plan_id: Optional[builtins.str] = None,
    ...
    :param builtins.str scheduling_plan_id: The Schedule Plan [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    """
    __args__ = dict()
...
def get_scheduling_plan_output(scheduling_plan_id: Optional[pulumi.Input[builtins.str]] = None,
