...
class GetSchedulingPlansResult:
    ...
    def scheduling_policy_id(self) -> Optional[builtins.str]:
        """
...
def get_scheduling_plans(compartment_id: Optional[builtins.str] = None,
...
def get_scheduling_plans_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                ...
                                scheduling_policy_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
