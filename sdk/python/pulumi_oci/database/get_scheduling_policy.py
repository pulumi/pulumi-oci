...
def get_scheduling_policy(scheduling_policy_id: Optional[builtins.str] = None,
...
def get_scheduling_policy_output(scheduling_policy_id: Optional[pulumi.Input[builtins.str]] = None,
