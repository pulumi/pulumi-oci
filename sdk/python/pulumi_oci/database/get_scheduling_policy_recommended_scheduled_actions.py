...
class GetSchedulingPolicyRecommendedScheduledActionsResult:
    ...
    def scheduling_policy_target_resource_id(self) -> builtins.str:
...
def get_scheduling_policy_recommended_scheduled_actions(filters: Optional[Sequence[Union['GetSchedulingPolicyRecommendedScheduledActionsFilterArgs', 'GetSchedulingPolicyRecommendedScheduledActionsFilterArgsDict']]] = None,
                                                        plan_intent: Optional[builtins.str] = None,
                                                        scheduling_policy_id: Optional[builtins.str] = None,
                                                        scheduling_policy_target_resource_id: Optional[builtins.str] = None,
    ...
    :param builtins.str plan_intent: The scheduling plan intent the scheduled actions will be for.
    ...
    :param builtins.str scheduling_policy_target_resource_id: The target resource [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) the scheduled actions will be for.
    """
    __args__ = dict()
...
def get_scheduling_policy_recommended_scheduled_actions_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetSchedulingPolicyRecommendedScheduledActionsFilterArgs', 'GetSchedulingPolicyRecommendedScheduledActionsFilterArgsDict']]]]] = None,
                                                               ...
                                                               scheduling_policy_target_resource_id: Optional[pulumi.Input[builtins.str]] = None,
