...
def get_vm_cluster_network(exadata_infrastructure_id: Optional[builtins.str] = None,
                           vm_cluster_network_id: Optional[builtins.str] = None,
    ...
    :param builtins.str vm_cluster_network_id: The VM cluster network [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    """
    __args__ = dict()
...
def get_vm_cluster_network_output(exadata_infrastructure_id: Optional[pulumi.Input[builtins.str]] = None,
