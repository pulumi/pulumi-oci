...
def get_vm_cluster_network_download_config_file(base64_encode_content: Optional[builtins.bool] = None,
...
def get_vm_cluster_network_download_config_file_output(base64_encode_content: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
