...
class GetVmClusterPatchHistoryEntryResult:
    ...
    def patch_history_entry_id(self) -> builtins.str:
...
def get_vm_cluster_patch_history_entry(patch_history_entry_id: Optional[builtins.str] = None,
    ...
    :param builtins.str patch_history_entry_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the patch history entry.
...
def get_vm_cluster_patch_history_entry_output(patch_history_entry_id: Optional[pulumi.Input[builtins.str]] = None,
