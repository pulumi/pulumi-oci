...
def get_vm_cluster_recommended_network(compartment_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] db_servers: The list of Db server Ids to configure network.
...
def get_vm_cluster_recommended_network_output(compartment_id: Optional[pulumi.Input[_builtins.str]] = None,
                                              db_servers: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                              defined_tags: Optional[pulumi.Input[Optional[Mapping[str, _builtins.str]]]] = None,
                                              ...
                                              ntps: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                              scan_listener_port_tcp: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                              scan_listener_port_tcp_ssl: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
