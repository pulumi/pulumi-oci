...
def get_vm_cluster_update(update_id: Optional[builtins.str] = None,
    ...
    :param builtins.str vm_cluster_id: The VM cluster [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    """
    __args__ = dict()
...
def get_vm_cluster_update_output(update_id: Optional[pulumi.Input[builtins.str]] = None,
