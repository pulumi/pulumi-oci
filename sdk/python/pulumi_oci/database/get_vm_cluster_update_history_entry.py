...
class GetVmClusterUpdateHistoryEntryResult:
    ...
    def update_history_entry_id(self) -> builtins.str:
...
def get_vm_cluster_update_history_entry(update_history_entry_id: Optional[builtins.str] = None,
    ...
    :param builtins.str update_history_entry_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the maintenance update history entry.
...
def get_vm_cluster_update_history_entry_output(update_history_entry_id: Optional[pulumi.Input[builtins.str]] = None,
