...
class KeyStoreArgs:
    def __init__(__self__, *,
                 ...
                 confirm_details_trigger: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: The user-friendly name for the key store. The name does not need to be unique.
    ...
    def confirm_details_trigger(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "confirm_details_trigger")

    @confirm_details_trigger.setter
    def confirm_details_trigger(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _KeyStoreState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] state: The current state of the key store.
        :param pulumi.Input[builtins.str] time_created: The date and time that the key store was created.
        :param pulumi.Input['KeyStoreTypeDetailsArgs'] type_details: (Updatable) Key store type details.
        """
...
class KeyStore(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="confirmDetailsTrigger")
    def confirm_details_trigger(self) -> pulumi.Output[Optional[builtins.int]]:
        return pulumi.get(self, "confirm_details_trigger")
