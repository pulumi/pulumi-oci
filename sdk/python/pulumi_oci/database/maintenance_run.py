...
class MaintenanceRunArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] patch_type: Patch type, either "QUARTERLY", "TIMEZONE" or "CUSTOM_DATABASE_SOFTWARE_IMAGE".
        ...
        :param pulumi.Input[builtins.str] time_scheduled: (Updatable) The date and time that update should be scheduled.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the Maintenance Run.
        :param pulumi.Input[builtins.str] database_software_image_id: The Autonomous Database Software Image [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)
        ...
        :param pulumi.Input[builtins.str] patching_mode: (Updatable) Cloud Exadata infrastructure node patching method, either "ROLLING" or "NONROLLING". Default value is ROLLING.
...
class _MaintenanceRunState:
    def __init__(__self__, *,
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 current_custom_action_timeout_in_mins: Optional[pulumi.Input[builtins.int]] = None,
                 current_patching_component: Optional[pulumi.Input[builtins.str]] = None,
                 custom_action_timeout_in_mins: Optional[pulumi.Input[builtins.int]] = None,
                 database_software_image_id: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 estimated_component_patching_start_time: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 is_dst_file_update_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_maintenance_run_granular: Optional[pulumi.Input[builtins.bool]] = None,
                 lifecycle_details: Optional[pulumi.Input[builtins.str]] = None,
                 maintenance_subtype: Optional[pulumi.Input[builtins.str]] = None,
                 maintenance_type: Optional[pulumi.Input[builtins.str]] = None,
                 patch_failure_count: Optional[pulumi.Input[builtins.int]] = None,
                 patch_id: Optional[pulumi.Input[builtins.str]] = None,
                 patch_type: Optional[pulumi.Input[builtins.str]] = None,
                 patching_end_time: Optional[pulumi.Input[builtins.str]] = None,
                 patching_mode: Optional[pulumi.Input[builtins.str]] = None,
                 patching_start_time: Optional[pulumi.Input[builtins.str]] = None,
                 patching_status: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 target_storage_server_version: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the Maintenance Run.
        :param pulumi.Input[builtins.int] current_custom_action_timeout_in_mins: Extend current custom action timeout between the current database servers during waiting state, from 0 (zero) to 30 minutes.
        :param pulumi.Input[builtins.str] current_patching_component: The name of the current infrastruture component that is getting patched.
        :param pulumi.Input[builtins.int] custom_action_timeout_in_mins: Determines the amount of time the system will wait before the start of each database server patching operation. Specify a number of minutes, from 15 to 120.
        :param pulumi.Input[builtins.str] database_software_image_id: The Autonomous Database Software Image [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)
        :param pulumi.Input[builtins.str] description: Description of the maintenance run.
        :param pulumi.Input[builtins.str] display_name: The user-friendly name for the maintenance run.
        :param pulumi.Input[builtins.str] estimated_component_patching_start_time: The estimated start time of the next infrastruture component patching operation.
        ...
        :param pulumi.Input[builtins.bool] is_custom_action_timeout_enabled: If true, enables the configuration of a custom action timeout (waiting period) between database servers patching operations.
        :param pulumi.Input[builtins.bool] is_dst_file_update_enabled: Indicates if an automatic DST Time Zone file update is enabled for the Autonomous Container Database. If enabled along with Release Update, patching will be done in a Non-Rolling manner.
        :param pulumi.Input[builtins.bool] is_maintenance_run_granular: If `FALSE`, the maintenance run doesn't support granular maintenance.
        :param pulumi.Input[builtins.str] lifecycle_details: Additional information about the current lifecycle state.
        :param pulumi.Input[builtins.str] maintenance_subtype: Maintenance sub-type.
        :param pulumi.Input[builtins.str] maintenance_type: Maintenance type.
        :param pulumi.Input[builtins.int] patch_failure_count: Contain the patch failure count.
        :param pulumi.Input[builtins.str] patch_id: The unique identifier of the patch. The identifier string includes the patch type, the Oracle Database version, and the patch creation date (using the format YYMMDD). For example, the identifier `ru_patch_19.9.0.0_201030` is used for an RU patch for Oracle Database 19.9.0.0 that was released October 30, 2020.
        :param pulumi.Input[builtins.str] patch_type: Patch type, either "QUARTERLY", "TIMEZONE" or "CUSTOM_DATABASE_SOFTWARE_IMAGE".
        :param pulumi.Input[builtins.str] patching_end_time: The time when the patching operation ended.
        :param pulumi.Input[builtins.str] patching_mode: (Updatable) Cloud Exadata infrastructure node patching method, either "ROLLING" or "NONROLLING". Default value is ROLLING.
               
               *IMPORTANT*: Non-rolling infrastructure patching involves system down time. See [Oracle-Managed Infrastructure Maintenance Updates](https://docs.cloud.oracle.com/iaas/Content/Database/Concepts/examaintenance.htm#Oracle) for more information.
        :param pulumi.Input[builtins.str] patching_start_time: The time when the patching operation started.
        :param pulumi.Input[builtins.str] patching_status: The status of the patching operation.
        ...
        :param pulumi.Input[builtins.str] target_storage_server_version: The target Cell version that is to be patched to.
        :param pulumi.Input[builtins.str] time_ended: The date and time the maintenance run was completed.
        :param pulumi.Input[builtins.str] time_scheduled: (Updatable) The date and time that update should be scheduled.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] time_started: The date and time the maintenance run starts.
    ...
    def current_custom_action_timeout_in_mins(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def current_custom_action_timeout_in_mins(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "current_custom_action_timeout_in_mins", value)

    @property
    @pulumi.getter(name="currentPatchingComponent")
    def current_patching_component(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def current_patching_component(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def estimated_component_patching_start_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def estimated_component_patching_start_time(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_maintenance_run_granular(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_maintenance_run_granular(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def maintenance_subtype(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def maintenance_subtype(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def patch_failure_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def patch_failure_count(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def patching_end_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def patching_end_time(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def patching_start_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def patching_start_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "patching_start_time", value)

    @property
    @pulumi.getter(name="patchingStatus")
    def patching_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def patching_status(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "patching_status", value)

    @property
    @pulumi.getter(name="peerMaintenanceRunId")
    def peer_maintenance_run_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peer_maintenance_run_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "peer_maintenance_run_id", value)

    @property
    @pulumi.getter(name="peerMaintenanceRunIds")
    def peer_maintenance_run_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def peer_maintenance_run_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def target_db_server_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def target_storage_server_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def target_storage_server_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MaintenanceRun(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_scheduled: Optional[pulumi.Input[builtins.str]] = None,
            time_started: Optional[pulumi.Input[builtins.str]] = None,
            total_time_taken_in_mins: Optional[pulumi.Input[builtins.int]] = None) -> 'MaintenanceRun':
        """
    ...
    @property
    @pulumi.getter(name="currentCustomActionTimeoutInMins")
    def current_custom_action_timeout_in_mins(self) -> pulumi.Output[builtins.int]:
        """
        Extend current custom action timeout between the current database servers during waiting state, from 0 (zero) to 30 minutes.
        """
        return pulumi.get(self, "current_custom_action_timeout_in_mins")
    ...
    @property
    @pulumi.getter(name="currentPatchingComponent")
    def current_patching_component(self) -> pulumi.Output[builtins.str]:
        """
        The name of the current infrastruture component that is getting patched.
        """
        return pulumi.get(self, "current_patching_component")
    ...
    @property
    @pulumi.getter(name="customActionTimeoutInMins")
    def custom_action_timeout_in_mins(self) -> pulumi.Output[builtins.int]:
        """
        Determines the amount of time the system will wait before the start of each database server patching operation. Specify a number of minutes, from 15 to 120.
        """
        return pulumi.get(self, "custom_action_timeout_in_mins")
    ...
    @property
    @pulumi.getter(name="estimatedComponentPatchingStartTime")
    def estimated_component_patching_start_time(self) -> pulumi.Output[builtins.str]:
        """
        The estimated start time of the next infrastruture component patching operation.
        """
        return pulumi.get(self, "estimated_component_patching_start_time")
    ...
    @property
    @pulumi.getter(name="isCustomActionTimeoutEnabled")
    def is_custom_action_timeout_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        If true, enables the configuration of a custom action timeout (waiting period) between database servers patching operations.
        """
        return pulumi.get(self, "is_custom_action_timeout_enabled")
    ...
    @property
    @pulumi.getter(name="isMaintenanceRunGranular")
    def is_maintenance_run_granular(self) -> pulumi.Output[builtins.bool]:
        """
        If `FALSE`, the maintenance run doesn't support granular maintenance.
        """
        return pulumi.get(self, "is_maintenance_run_granular")
    ...
    @property
    @pulumi.getter(name="maintenanceSubtype")
    def maintenance_subtype(self) -> pulumi.Output[builtins.str]:
        """
        Maintenance sub-type.
        """
        return pulumi.get(self, "maintenance_subtype")
    ...
    @property
    @pulumi.getter(name="patchFailureCount")
    def patch_failure_count(self) -> pulumi.Output[builtins.int]:
        """
        Contain the patch failure count.
        """
        return pulumi.get(self, "patch_failure_count")
    ...
    @property
    @pulumi.getter(name="patchType")
    def patch_type(self) -> pulumi.Output[builtins.str]:
        """
        Patch type, either "QUARTERLY", "TIMEZONE" or "CUSTOM_DATABASE_SOFTWARE_IMAGE".
        """
        return pulumi.get(self, "patch_type")
    ...
    @property
    @pulumi.getter(name="patchingEndTime")
    def patching_end_time(self) -> pulumi.Output[builtins.str]:
        """
        The time when the patching operation ended.
        """
        return pulumi.get(self, "patching_end_time")
    ...
    @property
    @pulumi.getter(name="patchingMode")
    def patching_mode(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Cloud Exadata infrastructure node patching method, either "ROLLING" or "NONROLLING". Default value is ROLLING.
    ...
    @property
    @pulumi.getter(name="patchingStartTime")
    def patching_start_time(self) -> pulumi.Output[builtins.str]:
        """
        The time when the patching operation started.
        """
        return pulumi.get(self, "patching_start_time")
    ...
    @property
    @pulumi.getter(name="patchingStatus")
    def patching_status(self) -> pulumi.Output[builtins.str]:
        """
        The status of the patching operation.
        """
        return pulumi.get(self, "patching_status")
    ...
    @property
    @pulumi.getter(name="peerMaintenanceRunId")
    def peer_maintenance_run_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the maintenance run for the Autonomous Data Guard association's peer container database.
        """
        return pulumi.get(self, "peer_maintenance_run_id")
    ...
    @property
    @pulumi.getter(name="peerMaintenanceRunIds")
    def peer_maintenance_run_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The list of OCIDs for the maintenance runs associated with their Autonomous Data Guard peer container databases.
        """
        return pulumi.get(self, "peer_maintenance_run_ids")
    ...
    @property
    @pulumi.getter(name="targetDbServerVersion")
    def target_db_server_version(self) -> pulumi.Output[builtins.str]:
        """
        The target software version for the database server patching operation.
        """
        return pulumi.get(self, "target_db_server_version")
    ...
    @property
    @pulumi.getter(name="targetStorageServerVersion")
    def target_storage_server_version(self) -> pulumi.Output[builtins.str]:
        """
        The target Cell version that is to be patched to.
        """
        return pulumi.get(self, "target_storage_server_version")
