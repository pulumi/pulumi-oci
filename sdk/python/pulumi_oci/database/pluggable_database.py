...
class PluggableDatabaseArgs:
    def __init__(__self__, *,
                 ...
                 container_database_admin_password: pulumi.Input[Optional[_builtins.str]] = None,
                 convert_to_regular_trigger: pulumi.Input[Optional[_builtins.int]] = None,
                 ...
                 pdb_creation_type_details: pulumi.Input[Optional['PluggableDatabasePdbCreationTypeDetailsArgs']] = None,
                 refresh_trigger: pulumi.Input[Optional[_builtins.int]] = None,
                 rotate_key_trigger: pulumi.Input[Optional[_builtins.int]] = None,
                 should_create_pdb_backup: pulumi.Input[Optional[_builtins.bool]] = None,
    ...
    def container_database_admin_password(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def container_database_admin_password(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "container_database_admin_password", value)

    @_builtins.property
    @pulumi.getter(name="convertToRegularTrigger")
    def convert_to_regular_trigger(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def convert_to_regular_trigger(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def pdb_creation_type_details(self) -> pulumi.Input[Optional['PluggableDatabasePdbCreationTypeDetailsArgs']]:
        """
    ...
    def pdb_creation_type_details(self, value: pulumi.Input[Optional['PluggableDatabasePdbCreationTypeDetailsArgs']]):
    ...
    def rotate_key_trigger(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def rotate_key_trigger(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "rotate_key_trigger", value)

    @_builtins.property
    @pulumi.getter(name="shouldCreatePdbBackup")
    def should_create_pdb_backup(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def should_create_pdb_backup(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class _PluggableDatabaseState:
    def __init__(__self__, *,
                 ...
                 connection_strings: pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabaseConnectionStringArgs']]]] = None,
                 container_database_admin_password: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 pdb_node_level_details: pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabasePdbNodeLevelDetailArgs']]]] = None,
                 pluggable_database_management_configs: pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabasePluggableDatabaseManagementConfigArgs']]]] = None,
                 refresh_trigger: pulumi.Input[Optional[_builtins.int]] = None,
                 refreshable_clone_configs: pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabaseRefreshableCloneConfigArgs']]]] = None,
                 rotate_key_trigger: pulumi.Input[Optional[_builtins.int]] = None,
                 should_create_pdb_backup: pulumi.Input[Optional[_builtins.bool]] = None,
                 should_pdb_admin_account_be_locked: pulumi.Input[Optional[_builtins.bool]] = None,
    ...
    def connection_strings(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabaseConnectionStringArgs']]]]:
        """
    ...
    def connection_strings(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabaseConnectionStringArgs']]]]):
    ...
    def pdb_node_level_details(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabasePdbNodeLevelDetailArgs']]]]:
        """
    ...
    def pdb_node_level_details(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabasePdbNodeLevelDetailArgs']]]]):
        pulumi.set(self, "pdb_node_level_details", value)

    @_builtins.property
    @pulumi.getter(name="pluggableDatabaseManagementConfigs")
    def pluggable_database_management_configs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabasePluggableDatabaseManagementConfigArgs']]]]:
        """
    ...
    def pluggable_database_management_configs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabasePluggableDatabaseManagementConfigArgs']]]]):
    ...
    def refreshable_clone_configs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabaseRefreshableCloneConfigArgs']]]]:
        """
    ...
    def refreshable_clone_configs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabaseRefreshableCloneConfigArgs']]]]):
...
class PluggableDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 kms_key_version_id: pulumi.Input[Optional[_builtins.str]] = None,
                 pdb_admin_password: pulumi.Input[Optional[_builtins.str]] = None,
                 pdb_creation_type_details: pulumi.Input[Optional[Union['PluggableDatabasePdbCreationTypeDetailsArgs', 'PluggableDatabasePdbCreationTypeDetailsArgsDict', 'outputs.PluggableDatabasePdbCreationTypeDetails']]] = None,
                 pdb_name: pulumi.Input[Optional[_builtins.str]] = None,
                 refresh_trigger: pulumi.Input[Optional[_builtins.int]] = None,
                 rotate_key_trigger: pulumi.Input[Optional[_builtins.int]] = None,
                 should_create_pdb_backup: pulumi.Input[Optional[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.str] kms_key_version_id: The OCID of the key container version that is used in database transparent data encryption (TDE) operations KMS Key can have multiple key versions. If none is specified, the current key version (latest) of the Key Id is used for the operation. Autonomous AI Database Serverless does not use key versions, hence is not applicable for Autonomous AI Database Serverless instances.
        :param pulumi.Input[_builtins.str] pdb_admin_password: A strong password for PDB Admin. The password must be at least nine characters and contain at least two uppercase, two lowercase, two numbers, and two special characters. The special characters must be _, \\#, or -.
        :param pulumi.Input[Union['PluggableDatabasePdbCreationTypeDetailsArgs', 'PluggableDatabasePdbCreationTypeDetailsArgsDict', 'outputs.PluggableDatabasePdbCreationTypeDetails']] pdb_creation_type_details: The Pluggable Database creation type. Use `LOCAL_CLONE_PDB` for creating a new PDB using Local Clone on Source Pluggable Database. This will Clone and starts a pluggable database (PDB) in the same database (CDB) as the source PDB. The source PDB must be in the `READ_WRITE` openMode to perform the clone operation. isThinClone options are supported for Exadata VM cluster on Exascale Infrastructure, Exadata Cloud@Customer VM Cluster on Exadata Cloud@Customer infrastructure, and Exadata Cloud VM cluster on cloud Exadata infrastructure Use `REMOTE_CLONE_PDB` for creating a new PDB using Remote Clone on Source Pluggable Database. This will Clone a pluggable database (PDB) to a different database from the source PDB. The cloned PDB will be started upon completion of the clone operation. The source PDB must be in the `READ_WRITE` openMode when performing the clone. For Exadata Cloud@Customer instances, the source pluggable database (PDB) must be on the same Exadata Infrastructure as the target container database (CDB) to create a remote clone. isThinClone options are supported for Exadata VM cluster on Exascale Infrastructure, Exadata Cloud@Customer VM Cluster on Exadata Cloud@Customer infrastructure, and Exadata Cloud VM cluster on cloud Exadata infrastructure. Use `RELOCATE_PDB` for relocating the Pluggable Database from Source CDB and creating it in target CDB. This will relocate a pluggable database (PDB) to a different database from the source PDB. The source PDB must be in the `READ_WRITE` openMode when performing the relocate.
        :param pulumi.Input[_builtins.str] pdb_name: The name for the pluggable database (PDB). The name is unique in the context of a [container database](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/Database/). The name must begin with an alphabetic character and can contain a maximum of thirty alphanumeric characters. Special characters are not permitted. The pluggable database name should not be same as the container database name.
        :param pulumi.Input[_builtins.int] refresh_trigger: (Updatable) An optional property when incremented triggers Refresh. Could be set to any integer value.
        :param pulumi.Input[_builtins.int] rotate_key_trigger: (Updatable) An optional property when incremented triggers Rotate Key. Could be set to any integer value.
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
            connection_strings: pulumi.Input[Optional[Sequence[pulumi.Input[Union['PluggableDatabaseConnectionStringArgs', 'PluggableDatabaseConnectionStringArgsDict', 'outputs.PluggableDatabaseConnectionString']]]]] = None,
            container_database_admin_password: pulumi.Input[Optional[_builtins.str]] = None,
            container_database_id: pulumi.Input[Optional[_builtins.str]] = None,
            convert_to_regular_trigger: pulumi.Input[Optional[_builtins.int]] = None,
            defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            ...
            pdb_creation_type_details: pulumi.Input[Optional[Union['PluggableDatabasePdbCreationTypeDetailsArgs', 'PluggableDatabasePdbCreationTypeDetailsArgsDict', 'outputs.PluggableDatabasePdbCreationTypeDetails']]] = None,
            pdb_name: pulumi.Input[Optional[_builtins.str]] = None,
            pdb_node_level_details: pulumi.Input[Optional[Sequence[pulumi.Input[Union['PluggableDatabasePdbNodeLevelDetailArgs', 'PluggableDatabasePdbNodeLevelDetailArgsDict', 'outputs.PluggableDatabasePdbNodeLevelDetail']]]]] = None,
            pluggable_database_management_configs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['PluggableDatabasePluggableDatabaseManagementConfigArgs', 'PluggableDatabasePluggableDatabaseManagementConfigArgsDict', 'outputs.PluggableDatabasePluggableDatabaseManagementConfig']]]]] = None,
            refresh_trigger: pulumi.Input[Optional[_builtins.int]] = None,
            refreshable_clone_configs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['PluggableDatabaseRefreshableCloneConfigArgs', 'PluggableDatabaseRefreshableCloneConfigArgsDict', 'outputs.PluggableDatabaseRefreshableCloneConfig']]]]] = None,
            rotate_key_trigger: pulumi.Input[Optional[_builtins.int]] = None,
            should_create_pdb_backup: pulumi.Input[Optional[_builtins.bool]] = None,
            should_pdb_admin_account_be_locked: pulumi.Input[Optional[_builtins.bool]] = None,
            state: pulumi.Input[Optional[_builtins.str]] = None,
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            tde_wallet_password: pulumi.Input[Optional[_builtins.str]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None) -> 'PluggableDatabase':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[_builtins.str] compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param pulumi.Input[Sequence[pulumi.Input[Union['PluggableDatabaseConnectionStringArgs', 'PluggableDatabaseConnectionStringArgsDict', 'outputs.PluggableDatabaseConnectionString']]]] connection_strings: Connection strings to connect to an Oracle Pluggable Database.
        :param pulumi.Input[_builtins.str] container_database_admin_password: The DB system administrator password of the Container Database.
        :param pulumi.Input[_builtins.str] container_database_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the CDB
        :param pulumi.Input[_builtins.int] convert_to_regular_trigger: (Updatable) An optional property when incremented triggers Convert To Regular. Could be set to any integer value.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        ...
        :param pulumi.Input[Union['PluggableDatabasePdbCreationTypeDetailsArgs', 'PluggableDatabasePdbCreationTypeDetailsArgsDict', 'outputs.PluggableDatabasePdbCreationTypeDetails']] pdb_creation_type_details: The Pluggable Database creation type. Use `LOCAL_CLONE_PDB` for creating a new PDB using Local Clone on Source Pluggable Database. This will Clone and starts a pluggable database (PDB) in the same database (CDB) as the source PDB. The source PDB must be in the `READ_WRITE` openMode to perform the clone operation. isThinClone options are supported for Exadata VM cluster on Exascale Infrastructure, Exadata Cloud@Customer VM Cluster on Exadata Cloud@Customer infrastructure, and Exadata Cloud VM cluster on cloud Exadata infrastructure Use `REMOTE_CLONE_PDB` for creating a new PDB using Remote Clone on Source Pluggable Database. This will Clone a pluggable database (PDB) to a different database from the source PDB. The cloned PDB will be started upon completion of the clone operation. The source PDB must be in the `READ_WRITE` openMode when performing the clone. For Exadata Cloud@Customer instances, the source pluggable database (PDB) must be on the same Exadata Infrastructure as the target container database (CDB) to create a remote clone. isThinClone options are supported for Exadata VM cluster on Exascale Infrastructure, Exadata Cloud@Customer VM Cluster on Exadata Cloud@Customer infrastructure, and Exadata Cloud VM cluster on cloud Exadata infrastructure. Use `RELOCATE_PDB` for relocating the Pluggable Database from Source CDB and creating it in target CDB. This will relocate a pluggable database (PDB) to a different database from the source PDB. The source PDB must be in the `READ_WRITE` openMode when performing the relocate.
        :param pulumi.Input[_builtins.str] pdb_name: The name for the pluggable database (PDB). The name is unique in the context of a [container database](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/Database/). The name must begin with an alphabetic character and can contain a maximum of thirty alphanumeric characters. Special characters are not permitted. The pluggable database name should not be same as the container database name.
        :param pulumi.Input[Sequence[pulumi.Input[Union['PluggableDatabasePdbNodeLevelDetailArgs', 'PluggableDatabasePdbNodeLevelDetailArgsDict', 'outputs.PluggableDatabasePdbNodeLevelDetail']]]] pdb_node_level_details: Pluggable Database Node Level Details. Example: [{"nodeName" : "node1", "openMode" : "READ_WRITE"}, {"nodeName" : "node2", "openMode" : "READ_ONLY"}]
        :param pulumi.Input[Sequence[pulumi.Input[Union['PluggableDatabasePluggableDatabaseManagementConfigArgs', 'PluggableDatabasePluggableDatabaseManagementConfigArgsDict', 'outputs.PluggableDatabasePluggableDatabaseManagementConfig']]]] pluggable_database_management_configs: The configuration of the Pluggable Database Management service.
        :param pulumi.Input[_builtins.int] refresh_trigger: (Updatable) An optional property when incremented triggers Refresh. Could be set to any integer value.
        :param pulumi.Input[Sequence[pulumi.Input[Union['PluggableDatabaseRefreshableCloneConfigArgs', 'PluggableDatabaseRefreshableCloneConfigArgsDict', 'outputs.PluggableDatabaseRefreshableCloneConfig']]]] refreshable_clone_configs: Pluggable Database Refreshable Clone Configuration.
        :param pulumi.Input[_builtins.int] rotate_key_trigger: (Updatable) An optional property when incremented triggers Rotate Key. Could be set to any integer value.
