...
class _PluggableDatabasesLocalCloneState:
    def __init__(__self__, *,
                 ...
                 connection_strings: pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabasesLocalCloneConnectionStringArgs']]]] = None,
                 ...
                 pdb_node_level_details: pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabasesLocalClonePdbNodeLevelDetailArgs']]]] = None,
                 pluggable_database_id: pulumi.Input[Optional[_builtins.str]] = None,
                 pluggable_database_management_configs: pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabasesLocalClonePluggableDatabaseManagementConfigArgs']]]] = None,
                 refreshable_clone_configs: pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabasesLocalCloneRefreshableCloneConfigArgs']]]] = None,
                 should_pdb_admin_account_be_locked: pulumi.Input[Optional[_builtins.bool]] = None,
    ...
    def connection_strings(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabasesLocalCloneConnectionStringArgs']]]]:
        """
    ...
    def connection_strings(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabasesLocalCloneConnectionStringArgs']]]]):
    ...
    def pdb_node_level_details(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabasesLocalClonePdbNodeLevelDetailArgs']]]]:
        """
    ...
    def pdb_node_level_details(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabasesLocalClonePdbNodeLevelDetailArgs']]]]):
    ...
    def pluggable_database_management_configs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabasesLocalClonePluggableDatabaseManagementConfigArgs']]]]:
        """
    ...
    def pluggable_database_management_configs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabasesLocalClonePluggableDatabaseManagementConfigArgs']]]]):
        pulumi.set(self, "pluggable_database_management_configs", value)

    @_builtins.property
    @pulumi.getter(name="refreshableCloneConfigs")
    def refreshable_clone_configs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabasesLocalCloneRefreshableCloneConfigArgs']]]]:
        """
    ...
    def refreshable_clone_configs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['PluggableDatabasesLocalCloneRefreshableCloneConfigArgs']]]]):
...
@pulumi.type_token("oci:Database/pluggableDatabasesLocalClone:PluggableDatabasesLocalClone")
class PluggableDatabasesLocalClone(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            cloned_pdb_name: pulumi.Input[Optional[_builtins.str]] = None,
            compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
            connection_strings: pulumi.Input[Optional[Sequence[pulumi.Input[Union['PluggableDatabasesLocalCloneConnectionStringArgs', 'PluggableDatabasesLocalCloneConnectionStringArgsDict', 'outputs.PluggableDatabasesLocalCloneConnectionString']]]]] = None,
            container_database_id: pulumi.Input[Optional[_builtins.str]] = None,
            defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            is_restricted: pulumi.Input[Optional[_builtins.bool]] = None,
            ...
            pdb_admin_password: pulumi.Input[Optional[_builtins.str]] = None,
            pdb_name: pulumi.Input[Optional[_builtins.str]] = None,
            pdb_node_level_details: pulumi.Input[Optional[Sequence[pulumi.Input[Union['PluggableDatabasesLocalClonePdbNodeLevelDetailArgs', 'PluggableDatabasesLocalClonePdbNodeLevelDetailArgsDict', 'outputs.PluggableDatabasesLocalClonePdbNodeLevelDetail']]]]] = None,
            pluggable_database_id: pulumi.Input[Optional[_builtins.str]] = None,
            pluggable_database_management_configs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['PluggableDatabasesLocalClonePluggableDatabaseManagementConfigArgs', 'PluggableDatabasesLocalClonePluggableDatabaseManagementConfigArgsDict', 'outputs.PluggableDatabasesLocalClonePluggableDatabaseManagementConfig']]]]] = None,
            refreshable_clone_configs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['PluggableDatabasesLocalCloneRefreshableCloneConfigArgs', 'PluggableDatabasesLocalCloneRefreshableCloneConfigArgsDict', 'outputs.PluggableDatabasesLocalCloneRefreshableCloneConfig']]]]] = None,
            should_pdb_admin_account_be_locked: pulumi.Input[Optional[_builtins.bool]] = None,
            state: pulumi.Input[Optional[_builtins.str]] = None,
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            target_tde_wallet_password: pulumi.Input[Optional[_builtins.str]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None) -> 'PluggableDatabasesLocalClone':
        """
        ...
        :param pulumi.Input[_builtins.str] cloned_pdb_name: The name for the pluggable database (PDB). The name is unique in the context of a [container database](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/Database/). The name must begin with an alphabetic character and can contain a maximum of thirty alphanumeric characters. Special characters are not permitted. The pluggable database name should not be same as the container database name.
        :param pulumi.Input[_builtins.str] compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param pulumi.Input[Sequence[pulumi.Input[Union['PluggableDatabasesLocalCloneConnectionStringArgs', 'PluggableDatabasesLocalCloneConnectionStringArgsDict', 'outputs.PluggableDatabasesLocalCloneConnectionString']]]] connection_strings: Connection strings to connect to an Oracle Pluggable Database.
        :param pulumi.Input[_builtins.str] container_database_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the CDB.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[_builtins.bool] is_restricted: The restricted mode of the pluggable database. If a pluggable database is opened in restricted mode, the user needs both create a session and have restricted session privileges to connect to it.
        ...
        :param pulumi.Input[_builtins.str] pdb_admin_password: A strong password for PDB Admin of the newly cloned PDB. The password must be at least nine characters and contain at least two uppercase, two lowercase, two numbers, and two special characters. The special characters must be _, \\#, or -.
        :param pulumi.Input[_builtins.str] pdb_name: The name for the pluggable database (PDB). The name is unique in the context of a [container database](https://docs.cloud.oracle.com/iaas/api/#/en/database/latest/Database/). The name must begin with an alphabetic character and can contain a maximum of thirty alphanumeric characters. Special characters are not permitted. The pluggable database name should not be same as the container database name.
        :param pulumi.Input[Sequence[pulumi.Input[Union['PluggableDatabasesLocalClonePdbNodeLevelDetailArgs', 'PluggableDatabasesLocalClonePdbNodeLevelDetailArgsDict', 'outputs.PluggableDatabasesLocalClonePdbNodeLevelDetail']]]] pdb_node_level_details: Pluggable Database Node Level Details. Example: [{"nodeName" : "node1", "openMode" : "READ_WRITE"}, {"nodeName" : "node2", "openMode" : "READ_ONLY"}]
        :param pulumi.Input[_builtins.str] pluggable_database_id: The database [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param pulumi.Input[Sequence[pulumi.Input[Union['PluggableDatabasesLocalClonePluggableDatabaseManagementConfigArgs', 'PluggableDatabasesLocalClonePluggableDatabaseManagementConfigArgsDict', 'outputs.PluggableDatabasesLocalClonePluggableDatabaseManagementConfig']]]] pluggable_database_management_configs: The configuration of the Pluggable Database Management service.
        :param pulumi.Input[Sequence[pulumi.Input[Union['PluggableDatabasesLocalCloneRefreshableCloneConfigArgs', 'PluggableDatabasesLocalCloneRefreshableCloneConfigArgsDict', 'outputs.PluggableDatabasesLocalCloneRefreshableCloneConfig']]]] refreshable_clone_configs: Pluggable Database Refreshable Clone Configuration.
        :param pulumi.Input[_builtins.bool] should_pdb_admin_account_be_locked: The locked mode of the pluggable database admin account. If false, the user needs to provide the PDB Admin Password to connect to it. If true, the pluggable database will be locked and user cannot login to it.
        :param pulumi.Input[_builtins.str] state: The current state of the pluggable database.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[_builtins.str] target_tde_wallet_password: The existing TDE wallet password of the target CDB.
