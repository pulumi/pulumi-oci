...
class PluggableDatabasesRemoteCloneArgs:
    def __init__(__self__, *,
                 ...
                 source_container_db_admin_password: pulumi.Input[builtins.str],
                 target_container_database_id: pulumi.Input[builtins.str],
    ...
    def source_container_db_admin_password(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_container_db_admin_password(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "source_container_db_admin_password", value)

    @property
    @pulumi.getter(name="targetContainerDatabaseId")
    def target_container_database_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_container_database_id(self, value: pulumi.Input[builtins.str]):
...
class _PluggableDatabasesRemoteCloneState:
    ...
    @property
    @pulumi.getter(name="sourceContainerDbAdminPassword")
    def source_container_db_admin_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The DB system administrator password of the source CDB.
        """
        return pulumi.get(self, "source_container_db_admin_password")
    ...
    @source_container_db_admin_password.setter
    def source_container_db_admin_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_container_db_admin_password", value)
    ...
    @target_container_database_id.setter
    def target_container_database_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_container_database_id", value)
...
class PluggableDatabasesRemoteClone(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="sourceContainerDbAdminPassword")
    def source_container_db_admin_password(self) -> pulumi.Output[builtins.str]:
        """
        The DB system administrator password of the source CDB.
        """
        return pulumi.get(self, "source_container_db_admin_password")
