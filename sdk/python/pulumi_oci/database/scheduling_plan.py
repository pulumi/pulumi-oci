...
class SchedulingPlanArgs:
    def __init__(__self__, *,
                 ...
                 scheduling_policy_id: pulumi.Input[builtins.str],
                 service_type: pulumi.Input[builtins.str],
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_using_recommended_scheduled_actions: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] resource_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the resource.
        :param pulumi.Input[builtins.str] scheduling_policy_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Scheduling Policy.
        :param pulumi.Input[builtins.str] service_type: The service type of the Scheduling Plan.
        ...
        :param pulumi.Input[builtins.bool] is_using_recommended_scheduled_actions: If true, recommended scheduled actions will be generated for the scheduling plan.
        """
    ...
    def scheduling_policy_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def scheduling_policy_id(self, value: pulumi.Input[builtins.str]):
    ...
    def is_using_recommended_scheduled_actions(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_using_recommended_scheduled_actions(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _SchedulingPlanState:
    def __init__(__self__, *,
                 ...
                 plan_intent: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[builtins.str] display_name: The display name of the Scheduling Plan.
        :param pulumi.Input[builtins.int] estimated_time_in_mins: The estimated time for the Scheduling Plan.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] is_using_recommended_scheduled_actions: If true, recommended scheduled actions will be generated for the scheduling plan.
        :param pulumi.Input[builtins.str] lifecycle_details: Additional information about the current lifecycle state.
        :param pulumi.Input[builtins.str] plan_intent: The current intent the Scheduling Plan. Valid states is EXADATA_INFRASTRUCTURE_FULL_SOFTWARE_UPDATE.
        :param pulumi.Input[builtins.str] resource_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the resource.
        :param pulumi.Input[builtins.str] scheduling_policy_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Scheduling Policy.
        :param pulumi.Input[builtins.str] service_type: The service type of the Scheduling Plan.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The current state of the Scheduling Plan. Valid states are CREATING, NEEDS_ATTENTION, AVAILABLE, UPDATING, FAILED, DELETING and DELETED.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the Scheduling Plan Resource was created.
        :param pulumi.Input[builtins.str] time_updated: The date and time the Scheduling Plan Resource was updated.
        """
    ...
    def plan_intent(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @plan_intent.setter
    def plan_intent(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="schedulingPolicyId")
    def scheduling_policy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Scheduling Policy.
        """
        return pulumi.get(self, "scheduling_policy_id")
    ...
    @scheduling_policy_id.setter
    def scheduling_policy_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "scheduling_policy_id", value)
...
class SchedulingPlan(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'SchedulingPlan':
        """
    ...
    @property
    @pulumi.getter(name="isUsingRecommendedScheduledActions")
    def is_using_recommended_scheduled_actions(self) -> pulumi.Output[builtins.bool]:
        """
        If true, recommended scheduled actions will be generated for the scheduling plan.
        """
        return pulumi.get(self, "is_using_recommended_scheduled_actions")
    ...
    @property
    @pulumi.getter(name="planIntent")
    def plan_intent(self) -> pulumi.Output[builtins.str]:
        """
        The current intent the Scheduling Plan. Valid states is EXADATA_INFRASTRUCTURE_FULL_SOFTWARE_UPDATE.
        """
        return pulumi.get(self, "plan_intent")
    ...
    @property
    @pulumi.getter(name="schedulingPolicyId")
    def scheduling_policy_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Scheduling Policy.
        """
        return pulumi.get(self, "scheduling_policy_id")
