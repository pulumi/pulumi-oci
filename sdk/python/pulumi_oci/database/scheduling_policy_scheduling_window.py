...
class SchedulingPolicySchedulingWindowArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] scheduling_policy_id: The Scheduling Policy [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
...
class _SchedulingPolicySchedulingWindowState:
    def __init__(__self__, *,
                 ...
                 time_next_scheduling_window_starts: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
        :param pulumi.Input[builtins.str] display_name: The user-friendly name for the Scheduling Window. The name does not need to be unique.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] lifecycle_details: Additional information about the current lifecycle state.
        :param pulumi.Input[builtins.str] scheduling_policy_id: The Scheduling Policy [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param pulumi.Input[builtins.str] state: The current state of the Scheduling Window. Valid states are CREATING, ACTIVE, UPDATING, FAILED, DELETING and DELETED.
        :param pulumi.Input[builtins.str] time_created: The date and time the Scheduling Window was created.
        :param pulumi.Input[builtins.str] time_next_scheduling_window_starts: The date and time of the next upcoming window associated within the schedulingWindow is planned to start.
        :param pulumi.Input[builtins.str] time_updated: The last date and time that the Scheduling Window was updated.
        :param pulumi.Input['SchedulingPolicySchedulingWindowWindowPreferenceArgs'] window_preference: (Updatable) The Single Scheduling Window details.
        """
        if compartment_id is not None:
            pulumi.set(__self__, "compartment_id", compartment_id)
    ...
    def time_next_scheduling_window_starts(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_next_scheduling_window_starts(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SchedulingPolicySchedulingWindow(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="timeNextSchedulingWindowStarts")
    def time_next_scheduling_window_starts(self) -> pulumi.Output[builtins.str]:
        """
        The date and time of the next upcoming window associated within the schedulingWindow is planned to start.
        """
        return pulumi.get(self, "time_next_scheduling_window_starts")
