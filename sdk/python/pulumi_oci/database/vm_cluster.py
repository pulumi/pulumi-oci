...
class VmClusterArgs:
    def __init__(__self__, *,
                 ...
                 cloud_automation_update_details: pulumi.Input[Optional['VmClusterCloudAutomationUpdateDetailsArgs']] = None,
                 data_collection_options: pulumi.Input[Optional['VmClusterDataCollectionOptionsArgs']] = None,
                 ...
                 file_system_configuration_details: pulumi.Input[Optional[Sequence[pulumi.Input['VmClusterFileSystemConfigurationDetailArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.bool] is_sparse_diskgroup_enabled: (Updatable) If true, the sparse disk group is configured for the VM cluster. If false, the sparse disk group is not created.
    ...
    def cloud_automation_update_details(self) -> pulumi.Input[Optional['VmClusterCloudAutomationUpdateDetailsArgs']]:
        """
    ...
    def cloud_automation_update_details(self, value: pulumi.Input[Optional['VmClusterCloudAutomationUpdateDetailsArgs']]):
        pulumi.set(self, "cloud_automation_update_details", value)

    @_builtins.property
    @pulumi.getter(name="dataCollectionOptions")
    def data_collection_options(self) -> pulumi.Input[Optional['VmClusterDataCollectionOptionsArgs']]:
        """
    ...
    def data_collection_options(self, value: pulumi.Input[Optional['VmClusterDataCollectionOptionsArgs']]):
    ...
    def file_system_configuration_details(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['VmClusterFileSystemConfigurationDetailArgs']]]]:
        """
    ...
    def file_system_configuration_details(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['VmClusterFileSystemConfigurationDetailArgs']]]]):
    ...
    def vm_backup_storage_type(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def vm_file_system_storage_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def vm_file_system_storage_type(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class VmCluster(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_vm_cluster = oci.database.VmCluster("test_vm_cluster",
            ...
            cpu_core_count=int(vm_cluster_cpu_core_count),
            ...
            cloud_automation_update_details={
                ...
                "is_early_adoption_enabled": vm_cluster_cloud_automation_update_details_is_early_adoption_enabled == "true",
                "is_freeze_period_enabled": vm_cluster_cloud_automation_update_details_is_freeze_period_enabled == "true",
            },
            data_collection_options={
                "is_diagnostics_events_enabled": vm_cluster_data_collection_options_is_diagnostics_events_enabled == "true",
                "is_health_monitoring_enabled": vm_cluster_data_collection_options_is_health_monitoring_enabled == "true",
                "is_incident_logs_enabled": vm_cluster_data_collection_options_is_incident_logs_enabled == "true",
            },
            data_storage_percentage=int(vm_cluster_data_storage_percentage),
            data_storage_size_in_tbs=vm_cluster_data_storage_size_in_tbs,
            db_node_storage_size_in_gbs=int(vm_cluster_db_node_storage_size_in_gbs),
            ...
            file_system_configuration_details=[{
                "file_system_size_gb": int(vm_cluster_file_system_configuration_details_file_system_size_gb),
                "mount_point": vm_cluster_file_system_configuration_details_mount_point,
            }],
            freeform_tags={
                "Department": "Finance",
            },
            is_local_backup_enabled=vm_cluster_is_local_backup_enabled == "true",
            is_sparse_diskgroup_enabled=vm_cluster_is_sparse_diskgroup_enabled == "true",
            license_model=vm_cluster_license_model,
            memory_size_in_gbs=int(vm_cluster_memory_size_in_gbs),
            reco_storage_percentage=int(vm_cluster_reco_storage_percentage),
    ...
    def get(resource_name: str,
            ...
            vm_cluster_network_id: pulumi.Input[Optional[_builtins.str]] = None,
            vm_cluster_type: pulumi.Input[Optional[_builtins.str]] = None,
            vm_file_system_storage_type: pulumi.Input[Optional[_builtins.str]] = None) -> 'VmCluster':
        """
