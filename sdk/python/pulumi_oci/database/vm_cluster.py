...
class VmClusterArgs:
    def __init__(__self__, *,
                 ...
                 gi_version: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] display_name: The user-friendly name for the VM cluster. The name does not need to be unique.
        ...
        :param pulumi.Input[builtins.float] data_storage_size_in_gb: (Updatable) The data disk group size to be allocated in GBs.
        :param pulumi.Input[builtins.float] data_storage_size_in_tbs: (Updatable) The data disk group size to be allocated in TBs.
        :param pulumi.Input[builtins.int] db_node_storage_size_in_gbs: (Updatable) The local node storage to be allocated in GBs.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] db_servers: The list of Db server.
        ...
        :param pulumi.Input[builtins.bool] is_sparse_diskgroup_enabled: If true, the sparse disk group is configured for the VM cluster. If false, the sparse disk group is not created.
        :param pulumi.Input[builtins.str] license_model: (Updatable) The Oracle license model that applies to the VM cluster. The default is BRING_YOUR_OWN_LICENSE.
    ...
    def gi_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @gi_version.setter
    def gi_version(self, value: pulumi.Input[builtins.str]):
...
class VmCluster(pulumi.CustomResource):
    ...
    pulumi_type = "oci:Database/vmCluster:VmCluster"
    ...
    def get(resource_name: str,
            ...
            time_zone: Optional[pulumi.Input[builtins.str]] = None,
            vm_cluster_network_id: Optional[pulumi.Input[builtins.str]] = None,
            vm_cluster_type: Optional[pulumi.Input[builtins.str]] = None) -> 'VmCluster':
        """
    ...
    @property
    @pulumi.getter(name="ocpuCount")
    def ocpu_count(self) -> pulumi.Output[builtins.float]:
        return pulumi.get(self, "ocpu_count")
