...
class VmClusterAddVirtualNetworkArgs:
    def __init__(__self__, *,
                 ...
                 vm_cluster_id: pulumi.Input[builtins.str]):
        """
        ...
        :param pulumi.Input[builtins.str] vm_cluster_id: The VM cluster [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    ...
    def vm_cluster_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def vm_cluster_id(self, value: pulumi.Input[builtins.str]):
...
class _VmClusterAddVirtualNetworkState:
    def __init__(__self__, *,
                 ...
                 exascale_db_storage_vault_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] availability_domain: The name of the availability domain that the VM cluster is located in.
        ...
        :param pulumi.Input[builtins.str] compute_model: The compute model of the Autonomous Database. This is required if using the `computeCount` parameter. If using `cpuCoreCount` then it is an error to specify `computeModel` to a non-null value. ECPU compute model is the recommended model and OCPU compute model is legacy.
        ...
        :param pulumi.Input[builtins.float] data_storage_size_in_gb: Size of the DATA disk group in GBs.
        ...
        :param pulumi.Input[builtins.str] display_name: The user-friendly name for the Exadata Cloud@Customer VM cluster. The name does not need to be unique.
        ...
        :param pulumi.Input[builtins.str] exascale_db_storage_vault_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata Database Storage Vault.
        ...
        :param pulumi.Input[builtins.str] gi_version: The Oracle Grid Infrastructure software version for the VM cluster.
        :param pulumi.Input[builtins.bool] is_local_backup_enabled: If true, database backup on local Exadata storage is configured for the VM cluster. If false, database backup on local Exadata storage is not available in the VM cluster.
        :param pulumi.Input[builtins.bool] is_sparse_diskgroup_enabled: If true, sparse disk group is configured for the VM cluster. If false, sparse disk group is not created.
        ...
        :param pulumi.Input[builtins.str] license_model: The Oracle license model that applies to the VM cluster. The default is LICENSE_INCLUDED.
        ...
        :param pulumi.Input[builtins.str] shape: The shape of the Exadata infrastructure. The shape determines the amount of CPU, storage, and memory resources allocated to the instance.
        ...
        :param pulumi.Input[builtins.str] time_zone: The time zone of the Exadata infrastructure. For details, see [Exadata Infrastructure Time Zones](https://docs.cloud.oracle.com/iaas/Content/Database/References/timezones.htm).
        :param pulumi.Input[builtins.str] vm_cluster_id: The VM cluster [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    ...
    def exascale_db_storage_vault_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def exascale_db_storage_vault_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def storage_management_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
...
@pulumi.type_token("oci:Database/vmClusterAddVirtualNetwork:VmClusterAddVirtualNetwork")
class VmClusterAddVirtualNetwork(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vm_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
            vm_cluster_network_id: Optional[pulumi.Input[builtins.str]] = None,
            vm_cluster_type: Optional[pulumi.Input[builtins.str]] = None) -> 'VmClusterAddVirtualNetwork':
        """
    ...
    @property
    @pulumi.getter(name="exascaleDbStorageVaultId")
    def exascale_db_storage_vault_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata Database Storage Vault.
        """
        return pulumi.get(self, "exascale_db_storage_vault_id")
    ...
    @property
    @pulumi.getter(name="giVersion")
    def gi_version(self) -> pulumi.Output[builtins.str]:
        """
        The Oracle Grid Infrastructure software version for the VM cluster.
        """
        return pulumi.get(self, "gi_version")
    ...
    @property
    @pulumi.getter(name="isSparseDiskgroupEnabled")
    def is_sparse_diskgroup_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        If true, sparse disk group is configured for the VM cluster. If false, sparse disk group is not created.
        """
        return pulumi.get(self, "is_sparse_diskgroup_enabled")
    ...
    @property
    @pulumi.getter(name="storageManagementType")
    def storage_management_type(self) -> pulumi.Output[builtins.str]:
        """
        Specifies whether the type of storage management for the VM cluster is ASM or Exascale.
        """
        return pulumi.get(self, "storage_management_type")
    ...
    @property
    @pulumi.getter(name="vmClusterType")
    def vm_cluster_type(self) -> pulumi.Output[builtins.str]:
        """
        The vmcluster type for the VM cluster/Cloud VM cluster.
        """
        return pulumi.get(self, "vm_cluster_type")
