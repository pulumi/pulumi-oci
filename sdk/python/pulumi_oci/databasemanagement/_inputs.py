...
if not MYPY:
    class AutonomousDatabaseAutonomousDatabaseDbmFeaturesManagementFeatureDetailsConnectorDetailsArgsDict(TypedDict):
        connector_type: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        * DIRECT: Direct connection
        """
        database_connector_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        private_end_point_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AutonomousDatabaseAutonomousDatabaseDbmFeaturesManagementFeatureDetailsConnectorDetailsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] connector_type: The list of supported connection types:
               * PE: Private endpoint
               * MACS: Management agent
               * EXTERNAL: External database connector
               * DIRECT: Direct connection
        :param pulumi.Input[builtins.str] database_connector_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external database connector.
...
class AutonomousDatabaseAutonomousDatabaseDbmFeaturesManagementFeatureDetailsDatabaseConnectionDetailsConnectionCredentialsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] credential_name: The name of the credential information that used to connect to the DB system resource. The name should be in "x.y" format, where the length of "x" has a maximum of 64 characters, and length of "y" has a maximum of 199 characters. The name strings can contain letters, numbers and the underscore character only. Other characters are not valid, except for the "." character that separates the "x" and "y" portions of the name. *IMPORTANT* - The name must be unique within the Oracle Cloud Infrastructure region the credential is being created in. If you specify a name that duplicates the name of another credential within the same Oracle Cloud Infrastructure region, you may overwrite or corrupt the credential that is already using the name.
               
               For example: inventorydb.abc112233445566778899
        :param pulumi.Input[builtins.str] credential_type: The type of credential used to connect to the database.
        :param pulumi.Input[builtins.str] password_secret_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the secret containing the user password.
        :param pulumi.Input[builtins.str] role: The role of the user connecting to the database.
        :param pulumi.Input[builtins.str] ssl_secret_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the secret containing the SSL keystore and truststore details.
        :param pulumi.Input[builtins.str] user_name: The user name used to connect to the database.
        """
...
class AutonomousDatabaseAutonomousDatabaseDbmFeaturesManagementFeatureDetailsDatabaseConnectionDetailsConnectionStringArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] connection_type: The list of supported connection types:
               * BASIC: Basic connection details
        :param pulumi.Input[builtins.int] port: The port number used to connect to the database.
        :param pulumi.Input[builtins.str] protocol: The protocol used to connect to the database.
        :param pulumi.Input[builtins.str] service: The service name of the database.
        """
...
if not MYPY:
    class DatabaseDbmFeaturesManagementFeatureDetailsDatabaseConnectionDetailsConnectionCredentialsArgsDict(TypedDict):
        ...
        The type of credential used to connect to the database.
        """
        named_credential_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DatabaseDbmFeaturesManagementFeatureDetailsDatabaseConnectionDetailsConnectionCredentialsArgs:
    def __init__(__self__, *,
                 credential_name: Optional[pulumi.Input[builtins.str]] = None,
                 credential_type: Optional[pulumi.Input[builtins.str]] = None,
                 named_credential_id: Optional[pulumi.Input[builtins.str]] = None,
                 password_secret_id: Optional[pulumi.Input[builtins.str]] = None,
                 role: Optional[pulumi.Input[builtins.str]] = None,
                 ssl_secret_id: Optional[pulumi.Input[builtins.str]] = None,
                 user_name: Optional[pulumi.Input[builtins.str]] = None):
        ...
        :param pulumi.Input[builtins.str] credential_name: The name of the credential information that used to connect to the DB system resource. The name should be in "x.y" format, where the length of "x" has a maximum of 64 characters, and length of "y" has a maximum of 199 characters. The name strings can contain letters, numbers and the underscore character only. Other characters are not valid, except for the "." character that separates the "x" and "y" portions of the name. *IMPORTANT* - The name must be unique within the Oracle Cloud Infrastructure region the credential is being created in. If you specify a name that duplicates the name of another credential within the same Oracle Cloud Infrastructure region, you may overwrite or corrupt the credential that is already using the name.
               ...
               For example: inventorydb.abc112233445566778899
        :param pulumi.Input[builtins.str] credential_type: The type of credential used to connect to the database.
        :param pulumi.Input[builtins.str] named_credential_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Named Credential where the database password metadata is stored.
        :param pulumi.Input[builtins.str] password_secret_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the secret containing the user password.
        :param pulumi.Input[builtins.str] role: The role of the user connecting to the database.
        :param pulumi.Input[builtins.str] ssl_secret_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the secret containing the SSL keystore and truststore details.
        :param pulumi.Input[builtins.str] user_name: The user name used to connect to the database.
    ...
    def named_credential_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Named Credential where the database password metadata is stored.
        """
    ...
    def named_credential_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ExternalAsmServicedDatabaseArgsDict(TypedDict):
        ...
        """
        database_sub_type: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        disk_groups: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ExternalAsmServicedDatabaseArgs:
    def __init__(__self__, *,
                 ...
                 database_sub_type: Optional[pulumi.Input[builtins.str]] = None,
                 database_type: Optional[pulumi.Input[builtins.str]] = None,
                 db_unique_name: Optional[pulumi.Input[builtins.str]] = None,
                 disk_groups: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] database_sub_type: The subtype of Oracle Database. Indicates whether the database is a Container Database, Pluggable Database, Non-container Database, Autonomous Database, or Autonomous Container Database.
        :param pulumi.Input[builtins.str] database_type: The type of Oracle Database installation.
        :param pulumi.Input[builtins.str] db_unique_name: The unique name of the external database.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] disk_groups: The list of ASM disk groups used by the database.
        :param pulumi.Input[builtins.str] display_name: The user-friendly name for the database. The name does not have to be unique.
        :param pulumi.Input[builtins.str] id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external database.
        :param pulumi.Input[builtins.bool] is_managed: Indicates whether the database is a Managed Database or not.
        """
    ...
    def database_sub_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The subtype of Oracle Database. Indicates whether the database is a Container Database, Pluggable Database, Non-container Database, Autonomous Database, or Autonomous Container Database.
        """
    ...
    def database_sub_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def disk_groups(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The list of ASM disk groups used by the database.
        """
    ...
    @disk_groups.setter
    def disk_groups(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class ExternalClusterNetworkConfigurationArgsDict(TypedDict):
        network_number: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ExternalClusterNetworkConfigurationArgs:
    def __init__(__self__, *,
                 network_number: Optional[pulumi.Input[builtins.int]] = None,
                 network_type: Optional[pulumi.Input[builtins.str]] = None,
                 subnet: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] network_number: The network number from which VIPs are obtained.
        :param pulumi.Input[builtins.str] network_type: The network type.
        :param pulumi.Input[builtins.str] subnet: The subnet for the network.
        """
    ...
    def network_number(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The network number from which VIPs are obtained.
        """
    ...
    def network_number(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class ExternalClusterScanConfigurationArgsDict(TypedDict):
        ...
        The network number from which VIPs are obtained.
        """
        scan_name: NotRequired[pulumi.Input[builtins.str]]
        """
        The name of the SCAN listener.
        """
        scan_port: NotRequired[pulumi.Input[builtins.int]]
        """
        The port number of the SCAN listener.
        """
        scan_protocol: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ExternalClusterScanConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 scan_port: Optional[pulumi.Input[builtins.int]] = None,
                 scan_protocol: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] network_number: The network number from which VIPs are obtained.
        :param pulumi.Input[builtins.str] scan_name: The name of the SCAN listener.
        :param pulumi.Input[builtins.int] scan_port: The port number of the SCAN listener.
        :param pulumi.Input[builtins.str] scan_protocol: The protocol of the SCAN listener.
        """
        if network_number is not None:
            pulumi.set(__self__, "network_number", network_number)
    ...
    def scan_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the SCAN listener.
        """
    ...
    @scan_name.setter
    def scan_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "scan_name", value)

    @property
    @pulumi.getter(name="scanPort")
    def scan_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The port number of the SCAN listener.
        """
    ...
    @scan_port.setter
    def scan_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "scan_port", value)

    @property
    @pulumi.getter(name="scanProtocol")
    def scan_protocol(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The protocol of the SCAN listener.
        """
    ...
    def scan_protocol(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ExternalClusterVipConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] address: The VIP name or IP address.
        :param pulumi.Input[builtins.int] network_number: The network number from which VIPs are obtained.
        :param pulumi.Input[builtins.str] node_name: The name of the node with the VIP.
        """
...
class ExternalDbSystemConnectorConnectionInfoArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] component_type: The component type.
...
class ExternalDbSystemConnectorConnectionInfoConnectionCredentialArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] credential_name: The name of the credential information that used to connect to the DB system resource. The name should be in "x.y" format, where the length of "x" has a maximum of 64 characters, and length of "y" has a maximum of 199 characters. The name strings can contain letters, numbers and the underscore character only. Other characters are not valid, except for the "." character that separates the "x" and "y" portions of the name. *IMPORTANT* - The name must be unique within the Oracle Cloud Infrastructure region the credential is being created in. If you specify a name that duplicates the name of another credential within the same Oracle Cloud Infrastructure region, you may overwrite or corrupt the credential that is already using the name.
        :param pulumi.Input[builtins.str] credential_type: The type of the credential for tablespace administration tasks.
        :param pulumi.Input[builtins.str] named_credential_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the named credential where the database password metadata is stored.
        :param pulumi.Input[builtins.str] password_secret_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Secret where the database password is stored.
        :param pulumi.Input[builtins.str] role: The role of the database user.
        :param pulumi.Input[builtins.str] ssl_secret_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the secret containing the SSL keystore and truststore details.
        :param pulumi.Input[builtins.str] user_name: The user name used to connect to the ASM instance.
        """
        if credential_name is not None:
            pulumi.set(__self__, "credential_name", credential_name)
        if credential_type is not None:
...
class ExternalDbSystemConnectorConnectionInfoConnectionStringArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] hosts: The list of host names of the ASM instances.
        :param pulumi.Input[builtins.int] port: The port used to connect to the ASM instance.
        :param pulumi.Input[builtins.str] protocol: The protocol used to connect to the ASM instance.
        :param pulumi.Input[builtins.str] service: The service name of the ASM instance.
        """
...
class ExternalDbSystemConnectorConnectionInfoDatabaseCredentialArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] credential_type: The type of the credential for tablespace administration tasks.
        :param pulumi.Input[builtins.str] named_credential_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the named credential where the database password metadata is stored.
        :param pulumi.Input[builtins.str] password: The database user's password encoded using BASE64 scheme.
        :param pulumi.Input[builtins.str] password_secret_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Secret where the database password is stored.
        :param pulumi.Input[builtins.str] role: The role of the database user.
        :param pulumi.Input[builtins.str] username: The user to connect to the database.
        """
        if credential_type is not None:
            pulumi.set(__self__, "credential_type", credential_type)
        if named_credential_id is not None:
...
if not MYPY:
    class ExternalDbSystemDiscoveryDiscoveredComponentArgsDict(TypedDict):
        adr_home_directory: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        cpu_core_count: NotRequired[pulumi.Input[builtins.float]]
        """
        The number of CPU cores available on the DB node.
        """
        crs_base_directory: NotRequired[pulumi.Input[builtins.str]]
        """
        The Oracle base location of Cluster Ready Services (CRS).
        """
        db_edition: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        db_node_name: NotRequired[pulumi.Input[builtins.str]]
        """
        The name of the DB node.
        """
        db_packs: NotRequired[pulumi.Input[builtins.str]]
        """
        The database packs licensed for the external Oracle Database.
        """
        db_role: NotRequired[pulumi.Input[builtins.str]]
        """
        The role of the Oracle Database in Oracle Data Guard configuration.
        """
        db_type: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        grid_home: NotRequired[pulumi.Input[builtins.str]]
        """
        The directory in which Oracle Grid Infrastructure is installed.
        """
        guid: NotRequired[pulumi.Input[builtins.str]]
        """
        The unique identifier of the PDB.
        """
        home_directory: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        is_flex_cluster: NotRequired[pulumi.Input[builtins.bool]]
        """
        Indicates whether the cluster is an Oracle Flex Cluster or not.
        """
        is_flex_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        Indicates whether Oracle Flex ASM is enabled or not.
        """
        is_selected_for_monitoring: NotRequired[pulumi.Input[builtins.bool]]
        """
        Indicates whether the DB system component should be provisioned as an Oracle Cloud Infrastructure resource or not.
        """
        listener_alias: NotRequired[pulumi.Input[builtins.str]]
        """
        The listener alias.
        """
        listener_type: NotRequired[pulumi.Input[builtins.str]]
        """
        The type of listener.
        """
        log_directory: NotRequired[pulumi.Input[builtins.str]]
        """
        The destination directory of the listener log file.
        """
        memory_size_in_gbs: NotRequired[pulumi.Input[builtins.float]]
        """
        ...
        """
        ocr_file_location: NotRequired[pulumi.Input[builtins.str]]
        """
        The location of the Oracle Cluster Registry (OCR) file.
        """
        oracle_home: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        trace_directory: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ExternalDbSystemDiscoveryDiscoveredComponentArgs:
    def __init__(__self__, *,
                 ...
                 db_edition: Optional[pulumi.Input[builtins.str]] = None,
                 db_id: Optional[pulumi.Input[builtins.str]] = None,
                 db_node_name: Optional[pulumi.Input[builtins.str]] = None,
                 db_packs: Optional[pulumi.Input[builtins.str]] = None,
                 db_role: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 is_selected_for_monitoring: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] component_name: The name of the discovered DB system component.
        :param pulumi.Input[builtins.str] component_type: The component type.
        ...
        :param pulumi.Input[builtins.str] container_database_id: The unique identifier of the parent Container Database (CDB).
        ...
        :param pulumi.Input[builtins.str] db_edition: The Oracle Database edition.
        :param pulumi.Input[builtins.str] db_id: The Oracle Database ID.
        :param pulumi.Input[builtins.str] db_node_name: The name of the DB node.
        :param pulumi.Input[builtins.str] db_packs: The database packs licensed for the external Oracle Database.
        :param pulumi.Input[builtins.str] db_role: The role of the Oracle Database in Oracle Data Guard configuration.
        :param pulumi.Input[builtins.str] db_type: The type of Oracle Database. Indicates whether the database is a Container Database, Pluggable Database, or a Non-container Database.
        :param pulumi.Input[builtins.str] db_unique_name: The `DB_UNIQUE_NAME` of the external database.
        :param pulumi.Input[builtins.str] db_version: The Oracle Database version.
        ...
        :param pulumi.Input[builtins.str] guid: The unique identifier of the PDB.
        ...
        :param pulumi.Input[builtins.bool] is_selected_for_monitoring: Indicates whether the DB system component should be provisioned as an Oracle Cloud Infrastructure resource or not.
        ...
        :param pulumi.Input[builtins.str] ocr_file_location: The location of the Oracle Cluster Registry (OCR) file.
        ...
        :param pulumi.Input[builtins.str] status: The state of the discovered DB system component.
        :param pulumi.Input[builtins.str] trace_directory: The destination directory of the listener trace file.
        :param pulumi.Input[builtins.str] version: The version of Oracle Clusterware running in the cluster.
    ...
    def db_edition(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The Oracle Database edition.
        """
    ...
    @db_edition.setter
    def db_edition(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def db_node_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the DB node.
        """
    ...
    @db_node_name.setter
    def db_node_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def db_role(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The role of the Oracle Database in Oracle Data Guard configuration.
        """
    ...
    @db_role.setter
    def db_role(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_flex_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates whether Oracle Flex ASM is enabled or not.
        """
    ...
    def is_flex_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_flex_enabled", value)

    @property
    @pulumi.getter(name="isSelectedForMonitoring")
    def is_selected_for_monitoring(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Indicates whether the DB system component should be provisioned as an Oracle Cloud Infrastructure resource or not.
        """
    ...
    def is_selected_for_monitoring(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ExternalDbSystemDiscoveryDiscoveredComponentAssociatedComponentArgs:
    def __init__(__self__, *,
                 ...
                 component_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] association_type: The association type.
        :param pulumi.Input[builtins.str] component_id: The identifier of the discovered DB system component.
        :param pulumi.Input[builtins.str] component_type: The component type.
        """
...
if not MYPY:
    class ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgsDict(TypedDict):
        ...
        """
        connection_failure_message: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        (Updatable) The user-friendly name for the DB system. The name does not have to be unique.
        """
        time_connection_status_last_updated: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ExternalDbSystemDiscoveryDiscoveredComponentClusterInstanceConnectorArgs:
    def __init__(__self__, *,
                 ...
                 connection_failure_message: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] connection_failure_message: The error message indicating the reason for connection failure or `null` if the connection was successful.
        ...
        :param pulumi.Input[builtins.str] connection_status: The status of connectivity to the external DB system component.
        :param pulumi.Input[builtins.str] connector_type: The type of connector.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The user-friendly name for the DB system. The name does not have to be unique.
        :param pulumi.Input[builtins.str] time_connection_status_last_updated: The date and time the connectionStatus of the external DB system connector was last updated.
        """
    ...
    def connection_failure_message(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The error message indicating the reason for connection failure or `null` if the connection was successful.
        """
    ...
    def connection_failure_message(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ExternalDbSystemDiscoveryDiscoveredComponentEndpointArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] host: The host name or IP address.
        :param pulumi.Input[builtins.str] key: The unique name of the service.
        :param pulumi.Input[builtins.int] port: The port used to connect to the ASM instance.
        :param pulumi.Input[builtins.str] protocol: The protocol used to connect to the ASM instance.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] services: The list of services registered with the listener.
        """
        if host is not None:
...
class ExternalDbSystemDiscoveryPatchOperationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] operation: (Updatable) The operation can be one of these values: `MERGE`
...
if not MYPY:
    class ExternalExadataInfrastructureDatabaseSystemArgsDict(TypedDict):
        additional_details: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
        ...
        """
        internal_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ExternalExadataInfrastructureDatabaseSystemArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata resource.
...
if not MYPY:
    class ExternalExadataInfrastructureStorageGridArgsDict(TypedDict):
        ...
        The details of the lifecycle state of the Exadata resource.
        """
        server_count: NotRequired[pulumi.Input[builtins.float]]
        """
...
if not MYPY:
    class ExternalExadataStorageConnectorCredentialInfoArgsDict(TypedDict):
        ...
        """
        ssl_trust_store_location: NotRequired[pulumi.Input[builtins.str]]
        """
        (Updatable) The full path of the SSL truststore location in the agent.
        """
        ssl_trust_store_password: NotRequired[pulumi.Input[builtins.str]]
        """
        (Updatable) The password of the SSL truststore location in the agent.
        """
        ssl_trust_store_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ExternalExadataStorageConnectorCredentialInfoArgs:
    def __init__(__self__, *,
                 password: pulumi.Input[builtins.str],
                 username: pulumi.Input[builtins.str],
                 ssl_trust_store_location: Optional[pulumi.Input[builtins.str]] = None,
                 ssl_trust_store_password: Optional[pulumi.Input[builtins.str]] = None,
                 ssl_trust_store_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] password: (Updatable) The password of the user.
        :param pulumi.Input[builtins.str] username: (Updatable) The name of the user.
        :param pulumi.Input[builtins.str] ssl_trust_store_location: (Updatable) The full path of the SSL truststore location in the agent.
        :param pulumi.Input[builtins.str] ssl_trust_store_password: (Updatable) The password of the SSL truststore location in the agent.
        :param pulumi.Input[builtins.str] ssl_trust_store_type: (Updatable) The SSL truststore type.
        """
        pulumi.set(__self__, "password", password)
        pulumi.set(__self__, "username", username)
    ...
    def ssl_trust_store_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The full path of the SSL truststore location in the agent.
        """
    ...
    def ssl_trust_store_location(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ssl_trust_store_location", value)

    @property
    @pulumi.getter(name="sslTrustStorePassword")
    def ssl_trust_store_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The password of the SSL truststore location in the agent.
        """
    ...
    def ssl_trust_store_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ssl_trust_store_password", value)

    @property
    @pulumi.getter(name="sslTrustStoreType")
    def ssl_trust_store_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The SSL truststore type.
        """
    ...
    def ssl_trust_store_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ExternalExadataStorageGridStorageServerArgsDict(TypedDict):
        ...
        ** IMPORTANT **
        ...
        The details of the lifecycle state of the Exadata resource.
        """
        make_model: NotRequired[pulumi.Input[builtins.str]]
        """
        The make model of the Exadata storage server.
        """
        max_flash_disk_iops: NotRequired[pulumi.Input[builtins.int]]
        """
        The maximum flash disk IO operations per second of the Exadata storage server.
        """
        max_flash_disk_throughput: NotRequired[pulumi.Input[builtins.int]]
        """
        The maximum flash disk IO throughput in MB/s of the Exadata storage server.
        """
        max_hard_disk_iops: NotRequired[pulumi.Input[builtins.int]]
        """
        The maximum hard disk IO operations per second of the Exadata storage server.
        """
        max_hard_disk_throughput: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ExternalExadataStorageGridStorageServerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] additional_details: The additional details of the resource defined in `{"key": "value"}` format. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.str] connector_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the connector.
...
if not MYPY:
    class ExternalExadataStorageServerConnectorArgsDict(TypedDict):
        ...
        """
        connection_uri: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        ** IMPORTANT **
        ...
        The status of the Exadata resource.
        """
        storage_server_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ExternalExadataStorageServerConnectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connection_uri: The unique string of the connection. For example, "https://<storage-server-name>/MS/RESTService/".
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] display_name: The name of the Exadata resource. English letters, numbers, "-", "_" and "." only.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}` 
...
class ExternalListenerEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] protocol: The listener protocol.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] services: The list of services registered with the listener.
        """
        if host is not None:
            pulumi.set(__self__, "host", host)
...
if not MYPY:
    class ExternalMySqlDatabaseConnectorConnectorDetailsArgsDict(TypedDict):
        ...
        """
        macs_agent_id: pulumi.Input[builtins.str]
        """
        (Updatable) Agent Id of the MACS agent.
        """
        network_protocol: pulumi.Input[builtins.str]
        """
        ...
        """
        ssl_secret_id: pulumi.Input[builtins.str]
        """
...
class ExternalMySqlDatabaseConnectorConnectorDetailsArgs:
    def __init__(__self__, *,
                 ...
                 ssl_secret_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] credential_type: (Updatable) Type of the credential.
        :param pulumi.Input[builtins.str] display_name: (Updatable) External MySQL Database Connector Name.
        :param pulumi.Input[builtins.str] external_database_id: (Updatable) OCID of MySQL Database resource.
        :param pulumi.Input[builtins.str] host_name: (Updatable) Host name for Connector.
        :param pulumi.Input[builtins.str] macs_agent_id: (Updatable) Agent Id of the MACS agent.
        :param pulumi.Input[builtins.str] network_protocol: (Updatable) Protocol to be used to connect to External MySQL Database; TCP, TCP with SSL or Socket.
        :param pulumi.Input[builtins.int] port: (Updatable) Port number to connect to External MySQL Database.
        :param pulumi.Input[builtins.str] ssl_secret_id: (Updatable) If using existing SSL secret to connect, OCID for the secret resource.
        """
        pulumi.set(__self__, "credential_type", credential_type)
        pulumi.set(__self__, "display_name", display_name)
    ...
    def macs_agent_id(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) Agent Id of the MACS agent.
        """
    ...
    def macs_agent_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "macs_agent_id", value)

    @property
    @pulumi.getter(name="networkProtocol")
    def network_protocol(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) Protocol to be used to connect to External MySQL Database; TCP, TCP with SSL or Socket.
        """
    ...
    def network_protocol(self, value: pulumi.Input[builtins.str]):
    ...
    @property
    @pulumi.getter(name="sslSecretId")
    def ssl_secret_id(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) If using existing SSL secret to connect, OCID for the secret resource.
        """
        return pulumi.get(self, "ssl_secret_id")
    ...
    @ssl_secret_id.setter
    def ssl_secret_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "ssl_secret_id", value)
...
if not MYPY:
    class ManagedDatabaseDbmgmtFeatureConfigArgsDict(TypedDict):
        ...
        The name of the Database Management feature.
        """
        feature_status: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ManagedDatabaseDbmgmtFeatureConfigArgs:
    def __init__(__self__, *,
                 ...
                 feature_status: Optional[pulumi.Input[builtins.str]] = None,
                 license_model: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] feature: The name of the Database Management feature.
        :param pulumi.Input[builtins.str] feature_status: The list of statuses for Database Management features.
        :param pulumi.Input[builtins.str] license_model: The Oracle license model that applies to the external database.
        """
        if connector_details is not None:
            pulumi.set(__self__, "connector_details", connector_details)
    ...
    def feature_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The list of statuses for Database Management features.
        """
    ...
    def feature_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ManagedDatabaseGroupManagedDatabaseArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which the Managed Database Group resides.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the managed database that needs to be added to the Managed Database Group. 
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] name: The name of the Managed Database Group. Valid characters are uppercase or lowercase letters, numbers, and "_". The name of the Managed Database Group cannot be modified. It must be unique in the compartment and must begin with an alphabetic character.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). System tags can be viewed by users, but can only be created by the system.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param pulumi.Input[builtins.str] time_added: The date and time the Managed Database was added to the group.
        :param pulumi.Input[builtins.str] workload_type: The workload type of the Autonomous Database.
        """
        if compartment_id is not None:
            pulumi.set(__self__, "compartment_id", compartment_id)
        if database_sub_type is not None:
...
class ManagedDatabaseManagedDatabaseGroupArgs:
    def __init__(__self__, *,
                 ...
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which the Managed Database Group resides.
        :param pulumi.Input[builtins.str] id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Managed Database Group.
        :param pulumi.Input[builtins.str] name: The name of the Managed Database.
        """
        if compartment_id is not None:
            pulumi.set(__self__, "compartment_id", compartment_id)
        if id is not None:
...
class ManagedDatabasesChangeDatabaseParameterCredentialsArgs:
    def __init__(__self__, *,
                 ...
                 user_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] password: The password for the database user name.
        :param pulumi.Input[builtins.str] role: The role of the database user. Indicates whether the database user is a normal user or sysdba.
        :param pulumi.Input[builtins.str] secret_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the secret containing the user password.
        :param pulumi.Input[builtins.str] user_name: The database user name used to perform management activity.
        """
        if password is not None:
            pulumi.set(__self__, "password", password)
        if role is not None:
...
if not MYPY:
    class ManagedDatabasesChangeDatabaseParameterParameterArgsDict(TypedDict):
        ...
        The parameter value.
        """
        update_comment: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ManagedDatabasesChangeDatabaseParameterParameterArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str],
                 value: pulumi.Input[builtins.str],
                 update_comment: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: The parameter name.
        :param pulumi.Input[builtins.str] value: The parameter value.
        :param pulumi.Input[builtins.str] update_comment: A comment string to associate with the change in parameter value. It cannot contain control characters or a line break.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
    ...
    def update_comment(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A comment string to associate with the change in parameter value. It cannot contain control characters or a line break.
        """
    ...
    def update_comment(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class NamedCredentialContentArgsDict(TypedDict):
        ...
        """
        password_secret_access_mode: pulumi.Input[builtins.str]
        """
...
class NamedCredentialContentArgs:
    def __init__(__self__, *,
                 ...
                 user_name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] credential_type: (Updatable) The type of named credential. Only 'BASIC' is supported currently.
        :param pulumi.Input[builtins.str] password_secret_access_mode: (Updatable) The mechanism used to access the password plain text value.
        :param pulumi.Input[builtins.str] password_secret_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Vault service secret that contains the database user password.
        :param pulumi.Input[builtins.str] role: (Updatable) The role of the database user.
        :param pulumi.Input[builtins.str] user_name: (Updatable) The user name used to connect to the database.
        """
        pulumi.set(__self__, "credential_type", credential_type)
    ...
    def password_secret_access_mode(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The mechanism used to access the password plain text value.
        """
    ...
    def password_secret_access_mode(self, value: pulumi.Input[builtins.str]):
...
class GetExternalAsmDiskGroupsFilterArgs:
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: The name of the ASM disk group.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
...
class GetExternalAsmUsersFilterArgs:
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: The name of the ASM user.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
...
class GetManagedDatabaseGroupsFilterArgs:
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: A filter to return only resources that match the entire name. Only one of the parameters, id or name should be provided
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
...
class GetManagedDatabaseOptimizerStatisticsCollectionOperationsFilterArgs:
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: The name of the Managed Database.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
...
class GetManagedDatabaseSqlTuningSetsFilterArgs:
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: The name of the SQL tuning set.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
...
class GetManagedMySqlDatabaseConfigurationDataFilterArgs:
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: The name of variable
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
...
class GetManagedMySqlDatabasesFilterArgs:
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: The name of the Managed MySQL Database.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
