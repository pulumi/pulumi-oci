...
class CloudCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            is_flex_cluster: pulumi.Input[Optional[_builtins.bool]] = None,
            lifecycle_details: pulumi.Input[Optional[_builtins.str]] = None,
            network_configurations: pulumi.Input[Optional[Sequence[pulumi.Input[Union['CloudClusterNetworkConfigurationArgs', 'CloudClusterNetworkConfigurationArgsDict', 'outputs.CloudClusterNetworkConfiguration']]]]] = None,
            ocr_file_location: pulumi.Input[Optional[_builtins.str]] = None,
            scan_configurations: pulumi.Input[Optional[Sequence[pulumi.Input[Union['CloudClusterScanConfigurationArgs', 'CloudClusterScanConfigurationArgsDict', 'outputs.CloudClusterScanConfiguration']]]]] = None,
            state: pulumi.Input[Optional[_builtins.str]] = None,
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None,
            version: pulumi.Input[Optional[_builtins.str]] = None,
            vip_configurations: pulumi.Input[Optional[Sequence[pulumi.Input[Union['CloudClusterVipConfigurationArgs', 'CloudClusterVipConfigurationArgsDict', 'outputs.CloudClusterVipConfiguration']]]]] = None) -> 'CloudCluster':
        """
        ...
        :param pulumi.Input[_builtins.bool] is_flex_cluster: Indicates whether the cluster is Oracle Flex Cluster or not.
        :param pulumi.Input[_builtins.str] lifecycle_details: Additional information about the current lifecycle state.
        :param pulumi.Input[Sequence[pulumi.Input[Union['CloudClusterNetworkConfigurationArgs', 'CloudClusterNetworkConfigurationArgsDict', 'outputs.CloudClusterNetworkConfiguration']]]] network_configurations: The list of network address configurations of the cloud cluster.
        :param pulumi.Input[_builtins.str] ocr_file_location: The location of the Oracle Cluster Registry (OCR).
        :param pulumi.Input[Sequence[pulumi.Input[Union['CloudClusterScanConfigurationArgs', 'CloudClusterScanConfigurationArgsDict', 'outputs.CloudClusterScanConfiguration']]]] scan_configurations: The list of Single Client Access Name (SCAN) configurations of the cloud cluster.
        :param pulumi.Input[_builtins.str] state: The current lifecycle state of the cloud cluster.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). System tags can be viewed by users, but can only be created by the system.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param pulumi.Input[_builtins.str] time_created: The date and time the cloud cluster was created.
        :param pulumi.Input[_builtins.str] time_updated: The date and time the cloud cluster was last updated.
        :param pulumi.Input[_builtins.str] version: The cluster version.
        :param pulumi.Input[Sequence[pulumi.Input[Union['CloudClusterVipConfigurationArgs', 'CloudClusterVipConfigurationArgsDict', 'outputs.CloudClusterVipConfiguration']]]] vip_configurations: The list of Virtual IP (VIP) configurations of the cloud cluster.
        """
