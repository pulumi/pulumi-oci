...
__all__ = ['CloudDbSystemCloudStackMonitoringsManagementArgs', 'CloudDbSystemCloudStackMonitoringsManagement']

@pulumi.input_type
class CloudDbSystemCloudStackMonitoringsManagementArgs:
    def __init__(__self__, *,
        ...
        pulumi.set(__self__, "enable_cloud_stack_monitoring", enable_cloud_stack_monitoring)
    ...
    def enable_cloud_stack_monitoring(self, value: pulumi.Input[_builtins.bool]):
...
class _CloudDbSystemCloudStackMonitoringsManagementState:
    def __init__(__self__, *,
        ...
        if cloud_db_system_id is not None:
            pulumi.set(__self__, "cloud_db_system_id", cloud_db_system_id)
        if enable_cloud_stack_monitoring is not None:
            pulumi.set(__self__, "enable_cloud_stack_monitoring", enable_cloud_stack_monitoring)
        if is_enabled is not None:
            pulumi.set(__self__, "is_enabled", is_enabled)
        if metadata is not None:
...
@pulumi.type_token("oci:DatabaseManagement/cloudDbSystemCloudStackMonitoringsManagement:CloudDbSystemCloudStackMonitoringsManagement")
class CloudDbSystemCloudStackMonitoringsManagement(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CloudDbSystemCloudStackMonitoringsManagementArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CloudDbSystemCloudStackMonitoringsManagementArgs.__new__(CloudDbSystemCloudStackMonitoringsManagementArgs)
            ...
            if enable_cloud_stack_monitoring is None and not opts.urn:
                raise TypeError("Missing required property 'enable_cloud_stack_monitoring'")
            __props__.__dict__["enable_cloud_stack_monitoring"] = enable_cloud_stack_monitoring
            __props__.__dict__["is_enabled"] = is_enabled
            __props__.__dict__["metadata"] = metadata
        super(CloudDbSystemCloudStackMonitoringsManagement, __self__).__init__(
            'oci:DatabaseManagement/cloudDbSystemCloudStackMonitoringsManagement:CloudDbSystemCloudStackMonitoringsManagement',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__ = _CloudDbSystemCloudStackMonitoringsManagementState.__new__(_CloudDbSystemCloudStackMonitoringsManagementState)

        __props__.__dict__["cloud_db_system_id"] = cloud_db_system_id
        __props__.__dict__["enable_cloud_stack_monitoring"] = enable_cloud_stack_monitoring
        __props__.__dict__["is_enabled"] = is_enabled
        __props__.__dict__["metadata"] = metadata
        return CloudDbSystemCloudStackMonitoringsManagement(resource_name, opts=opts, __props__=__props__)
