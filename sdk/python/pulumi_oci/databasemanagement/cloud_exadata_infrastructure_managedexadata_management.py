...
__all__ = ['CloudExadataInfrastructureManagedexadataManagementArgs', 'CloudExadataInfrastructureManagedexadataManagement']

@pulumi.input_type
class CloudExadataInfrastructureManagedexadataManagementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] license_model: The Oracle license model that applies to the database management resources.
        """
        pulumi.set(__self__, "cloud_exadata_infrastructure_id", cloud_exadata_infrastructure_id)
        pulumi.set(__self__, "enable_managedexadata", enable_managedexadata)
    ...
    def enable_managedexadata(self) -> pulumi.Input[_builtins.bool]:
        """
    ...
    def enable_managedexadata(self, value: pulumi.Input[_builtins.bool]):
...
class _CloudExadataInfrastructureManagedexadataManagementState:
    def __init__(__self__, *,
        ...
        if cloud_exadata_infrastructure_id is not None:
            pulumi.set(__self__, "cloud_exadata_infrastructure_id", cloud_exadata_infrastructure_id)
        if enable_managedexadata is not None:
            pulumi.set(__self__, "enable_managedexadata", enable_managedexadata)
        if license_model is not None:
            pulumi.set(__self__, "license_model", license_model)
...
@pulumi.type_token("oci:DatabaseManagement/cloudExadataInfrastructureManagedexadataManagement:CloudExadataInfrastructureManagedexadataManagement")
class CloudExadataInfrastructureManagedexadataManagement(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(CloudExadataInfrastructureManagedexadataManagementArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = CloudExadataInfrastructureManagedexadataManagementArgs.__new__(CloudExadataInfrastructureManagedexadataManagementArgs)
            ...
            if enable_managedexadata is None and not opts.urn:
                raise TypeError("Missing required property 'enable_managedexadata'")
            __props__.__dict__["enable_managedexadata"] = enable_managedexadata
            __props__.__dict__["license_model"] = license_model
        super(CloudExadataInfrastructureManagedexadataManagement, __self__).__init__(
            'oci:DatabaseManagement/cloudExadataInfrastructureManagedexadataManagement:CloudExadataInfrastructureManagedexadataManagement',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
        ...
        __props__ = _CloudExadataInfrastructureManagedexadataManagementState.__new__(_CloudExadataInfrastructureManagedexadataManagementState)

        __props__.__dict__["cloud_exadata_infrastructure_id"] = cloud_exadata_infrastructure_id
        __props__.__dict__["enable_managedexadata"] = enable_managedexadata
        __props__.__dict__["license_model"] = license_model
        return CloudExadataInfrastructureManagedexadataManagement(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="enableManagedexadata")
    def enable_managedexadata(self) -> pulumi.Output[_builtins.bool]:
        """
        (Updatable) A required field when set to `true` calls enable action and when set to `false` calls disable action.
