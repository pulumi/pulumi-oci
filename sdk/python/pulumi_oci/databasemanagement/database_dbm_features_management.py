...
class DatabaseDbmFeaturesManagementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enable_database_dbm_feature: (Updatable) A required field when set to `true` calls enable action and when set to `false` calls disable action.
    ...
    def enable_database_dbm_feature(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def enable_database_dbm_feature(self, value: pulumi.Input[builtins.bool]):
    ...
    def modify_database_dbm_feature(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "modify_database_dbm_feature")

    @modify_database_dbm_feature.setter
    def modify_database_dbm_feature(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _DatabaseDbmFeaturesManagementState:
    ...
    @property
    @pulumi.getter(name="enableDatabaseDbmFeature")
    def enable_database_dbm_feature(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) A required field when set to `true` calls enable action and when set to `false` calls disable action.
    ...
    @enable_database_dbm_feature.setter
    def enable_database_dbm_feature(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_database_dbm_feature", value)
...
class DatabaseDbmFeaturesManagement(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="enableDatabaseDbmFeature")
    def enable_database_dbm_feature(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) A required field when set to `true` calls enable action and when set to `false` calls disable action.
    ...
    @property
    @pulumi.getter(name="modifyDatabaseDbmFeature")
    def modify_database_dbm_feature(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "modify_database_dbm_feature")
