...
class DbManagementPrivateEndpointArgs:
    def __init__(__self__, *,
                 ...
                 is_dns_resolution_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] subnet_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet.
        ...
        :param pulumi.Input[builtins.bool] is_cluster: Specifies whether the Database Management private endpoint will be used for Oracle Databases in a cluster.
        :param pulumi.Input[builtins.bool] is_dns_resolution_enabled: Specifies whether the Database Management private endpoint has DNS proxy server enabled to resolve private host name.
        :param pulumi.Input[builtins.str] name: (Updatable) The display name of the Database Management private endpoint.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] nsg_ids: (Updatable) The OCIDs of the Network Security Groups to which the Database Management private endpoint belongs.
        """
    ...
    def is_dns_resolution_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_dns_resolution_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _DbManagementPrivateEndpointState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: (Updatable) The display name of the Database Management private endpoint.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] nsg_ids: (Updatable) The OCIDs of the Network Security Groups to which the Database Management private endpoint belongs.
        :param pulumi.Input[builtins.str] private_ip: The IP addresses assigned to the Database Management private endpoint.
        :param pulumi.Input[builtins.str] state: The current lifecycle state of the Database Management private endpoint.
        :param pulumi.Input[builtins.str] subnet_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the Database Managament private endpoint was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
...
class DbManagementPrivateEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            vcn_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DbManagementPrivateEndpoint':
        """
    ...
    @property
    @pulumi.getter(name="isCluster")
    def is_cluster(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether the Database Management private endpoint will be used for Oracle Databases in a cluster.
        """
        return pulumi.get(self, "is_cluster")
    ...
    @property
    @pulumi.getter(name="isDnsResolutionEnabled")
    def is_dns_resolution_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether the Database Management private endpoint has DNS proxy server enabled to resolve private host name.
        """
        return pulumi.get(self, "is_dns_resolution_enabled")
