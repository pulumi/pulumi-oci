...
class ExternalAsm(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a ExternalAsm resource with the given unique name, props, and options.
    ...
    @property
    @pulumi.getter(name="isFlexEnabled")
    def is_flex_enabled(self) -> pulumi.Output[Optional[bool]]:
        return pulumi.get(self, "is_flex_enabled")
    ...
    @property
    @pulumi.getter(name="servicedDatabases")
    def serviced_databases(self) -> pulumi.Output[Optional[Sequence['outputs.ExternalAsmServicedDatabase']]]:
        return pulumi.get(self, "serviced_databases")
