...
class ExternalAsmInstanceArgs:
    def __init__(__self__, *,
                 external_asm_instance_id: pulumi.Input[builtins.str],
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a ExternalAsmInstance resource.
        :param pulumi.Input[builtins.str] external_asm_instance_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external ASM instance.
    ...
    def external_asm_instance_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def external_asm_instance_id(self, value: pulumi.Input[builtins.str]):
...
class _ExternalAsmInstanceState:
    def __init__(__self__, *,
                 ...
                 external_asm_id: Optional[pulumi.Input[builtins.str]] = None,
                 external_asm_instance_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] adr_home_directory: The Automatic Diagnostic Repository (ADR) home directory for the ASM instance.
        ...
        :param pulumi.Input[builtins.str] component_name: The name of the external ASM instance.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] display_name: The user-friendly name for the ASM instance. The name does not have to be unique.
        :param pulumi.Input[builtins.str] external_asm_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external ASM that the ASM instance belongs to.
        :param pulumi.Input[builtins.str] external_asm_instance_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external ASM instance.
        :param pulumi.Input[builtins.str] external_db_node_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external DB node on which the ASM instance is running.
        :param pulumi.Input[builtins.str] external_db_system_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external DB system that the ASM instance is a part of.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}` 
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] host_name: The name of the host on which the ASM instance is running.
        :param pulumi.Input[builtins.str] lifecycle_details: Additional information about the current lifecycle state.
        :param pulumi.Input[builtins.str] state: The current lifecycle state of the external ASM instance.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the external ASM instance was created.
        :param pulumi.Input[builtins.str] time_updated: The date and time the external ASM instance was last updated.
        """
    ...
    def external_asm_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def external_asm_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "external_asm_id", value)

    @property
    @pulumi.getter(name="externalAsmInstanceId")
    def external_asm_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external ASM instance.
        """
        return pulumi.get(self, "external_asm_instance_id")
    ...
    @external_asm_instance_id.setter
    def external_asm_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "external_asm_instance_id", value)
...
class ExternalAsmInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'ExternalAsmInstance':
        """
    ...
    @property
    @pulumi.getter(name="externalAsmId")
    def external_asm_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external ASM that the ASM instance belongs to.
        """
        return pulumi.get(self, "external_asm_id")
    ...
    @property
    @pulumi.getter(name="externalAsmInstanceId")
    def external_asm_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external ASM instance.
        """
        return pulumi.get(self, "external_asm_instance_id")
