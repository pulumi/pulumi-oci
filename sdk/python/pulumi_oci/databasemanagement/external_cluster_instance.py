...
class ExternalClusterInstanceArgs:
    def __init__(__self__, *,
                 external_cluster_instance_id: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] external_cluster_instance_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external cluster instance.
    ...
    def external_cluster_instance_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def external_cluster_instance_id(self, value: pulumi.Input[_builtins.str]):
...
class _ExternalClusterInstanceState:
    def __init__(__self__, *,
                 ...
                 crs_base_directory: pulumi.Input[Optional[_builtins.str]] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 external_cluster_id: pulumi.Input[Optional[_builtins.str]] = None,
                 external_cluster_instance_id: pulumi.Input[Optional[_builtins.str]] = None,
                 external_connector_id: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] component_name: The name of the external cluster instance.
        :param pulumi.Input[_builtins.str] crs_base_directory: The Oracle base location of Cluster Ready Services (CRS).
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[_builtins.str] display_name: The user-friendly name for the cluster instance. The name does not have to be unique.
        :param pulumi.Input[_builtins.str] external_cluster_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external cluster that the cluster instance belongs to.
        :param pulumi.Input[_builtins.str] external_cluster_instance_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external cluster instance.
        :param pulumi.Input[_builtins.str] external_connector_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external connector.
        ...
        :param pulumi.Input[_builtins.str] external_db_system_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external DB system that the cluster instance is a part of.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] host_name: The name of the host on which the cluster instance is running.
        ...
        :param pulumi.Input[_builtins.str] state: The current lifecycle state of the external cluster instance.
        ...
        :param pulumi.Input[_builtins.str] time_created: The date and time the external cluster instance was created.
        :param pulumi.Input[_builtins.str] time_updated: The date and time the external cluster instance was last updated.
        """
    ...
    def crs_base_directory(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def crs_base_directory(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def external_cluster_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def external_cluster_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "external_cluster_id", value)

    @_builtins.property
    @pulumi.getter(name="externalClusterInstanceId")
    def external_cluster_instance_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external cluster instance.
        """
        return pulumi.get(self, "external_cluster_instance_id")
    ...
    @external_cluster_instance_id.setter
    def external_cluster_instance_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "external_cluster_instance_id", value)
...
@pulumi.type_token("oci:DatabaseManagement/externalClusterInstance:ExternalClusterInstance")
class ExternalClusterInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None) -> 'ExternalClusterInstance':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="crsBaseDirectory")
    def crs_base_directory(self) -> pulumi.Output[_builtins.str]:
        """
        The Oracle base location of Cluster Ready Services (CRS).
        """
        return pulumi.get(self, "crs_base_directory")
    ...
    @_builtins.property
    @pulumi.getter(name="externalClusterId")
    def external_cluster_id(self) -> pulumi.Output[_builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external cluster that the cluster instance belongs to.
        """
        return pulumi.get(self, "external_cluster_id")
    ...
    @_builtins.property
    @pulumi.getter(name="externalClusterInstanceId")
    def external_cluster_instance_id(self) -> pulumi.Output[_builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external cluster instance.
        """
        return pulumi.get(self, "external_cluster_instance_id")
    ...
    @_builtins.property
    @pulumi.getter(name="externalDbNodeId")
    def external_db_node_id(self) -> pulumi.Output[_builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external DB node.
        """
        return pulumi.get(self, "external_db_node_id")
