...
class ExternalDbNodeArgs:
    def __init__(__self__, *,
                 external_db_node_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] external_db_node_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external database node.
    ...
    def external_db_node_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def external_db_node_id(self, value: pulumi.Input[builtins.str]):
...
class _ExternalDbNodeState:
    def __init__(__self__, *,
                 ...
                 cpu_core_count: Optional[pulumi.Input[builtins.float]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 ...
                 memory_size_in_gbs: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] additional_details: The additional details of the external DB node defined in `{"key": "value"}` format. Example: `{"bar-key": "value"}`
        ...
        :param pulumi.Input[builtins.str] component_name: The name of the external DB node.
        :param pulumi.Input[builtins.float] cpu_core_count: The number of CPU cores available on the DB node.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] display_name: The user-friendly name for the external DB node. The name does not have to be unique.
        :param pulumi.Input[builtins.str] domain_name: Name of the domain.
        :param pulumi.Input[builtins.str] external_connector_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external connector.
        :param pulumi.Input[builtins.str] external_db_node_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external database node.
        :param pulumi.Input[builtins.str] external_db_system_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external DB system that the DB node is a part of.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}` 
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] host_name: The host name for the DB node.
        :param pulumi.Input[builtins.str] lifecycle_details: Additional information about the current lifecycle state.
        :param pulumi.Input[builtins.float] memory_size_in_gbs: The total memory in gigabytes (GB) on the DB node.
        :param pulumi.Input[builtins.str] state: The current lifecycle state of the external DB node.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the external DB node was created.
        :param pulumi.Input[builtins.str] time_updated: The date and time the external DB node was last updated.
        """
    ...
    def cpu_core_count(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def cpu_core_count(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def memory_size_in_gbs(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def memory_size_in_gbs(self, value: Optional[pulumi.Input[builtins.float]]):
...
class ExternalDbNode(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'ExternalDbNode':
        """
    ...
    @property
    @pulumi.getter(name="cpuCoreCount")
    def cpu_core_count(self) -> pulumi.Output[builtins.float]:
        """
        The number of CPU cores available on the DB node.
        """
        return pulumi.get(self, "cpu_core_count")
    ...
    @property
    @pulumi.getter(name="memorySizeInGbs")
    def memory_size_in_gbs(self) -> pulumi.Output[builtins.float]:
        """
        The total memory in gigabytes (GB) on the DB node.
        """
        return pulumi.get(self, "memory_size_in_gbs")
