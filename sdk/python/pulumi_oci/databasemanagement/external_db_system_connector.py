...
class ExternalDbSystemConnectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] connector_type: (Updatable) The type of connector.
        ...
        :param pulumi.Input[builtins.str] agent_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management agent used for the external DB system connector.
        ...
        :param pulumi.Input[builtins.str] display_name: The user-friendly name for the external connector. The name does not have to be unique.
...
class _ExternalDbSystemConnectorState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] state: The current lifecycle state of the external DB system connector.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the external DB system connector was created.
        :param pulumi.Input[builtins.str] time_updated: The date and time the external DB system connector was last updated.
        """
        if agent_id is not None:
            pulumi.set(__self__, "agent_id", agent_id)
...
class ExternalDbSystemConnector(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_connection_status_last_updated: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'ExternalDbSystemConnector':
        """
    ...
    @property
    @pulumi.getter(name="connectionFailureMessage")
    def connection_failure_message(self) -> pulumi.Output[builtins.str]:
        """
        The error message indicating the reason for connection failure or `null` if the connection was successful.
        """
        return pulumi.get(self, "connection_failure_message")
