...
class ExternalDbSystemDatabaseManagementsManagementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] enable_database_management: (Updatable) A required field when set to `true` calls enable action and when set to `false` calls disable action.
    ...
    def enable_database_management(self) -> pulumi.Input[_builtins.bool]:
        """
    ...
    def enable_database_management(self, value: pulumi.Input[_builtins.bool]):
        pulumi.set(self, "enable_database_management", value)

    @_builtins.property
    @pulumi.getter(name="externalDbSystemId")
    def external_db_system_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def external_db_system_id(self, value: pulumi.Input[_builtins.str]):
...
class ExternalDbSystemDatabaseManagementsManagement(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="enableDatabaseManagement")
    def enable_database_management(self) -> pulumi.Output[_builtins.bool]:
        """
        (Updatable) A required field when set to `true` calls enable action and when set to `false` calls disable action.
