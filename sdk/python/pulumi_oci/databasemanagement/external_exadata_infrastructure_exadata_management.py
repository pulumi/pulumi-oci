...
class ExternalExadataInfrastructureExadataManagementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] external_exadata_infrastructure_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata infrastructure.
        :param pulumi.Input[_builtins.str] license_model: The Oracle license model.
        """
    ...
    def enable_exadata(self) -> pulumi.Input[_builtins.bool]:
        """
    ...
    def enable_exadata(self, value: pulumi.Input[_builtins.bool]):
        pulumi.set(self, "enable_exadata", value)

    @_builtins.property
    @pulumi.getter(name="externalExadataInfrastructureId")
    def external_exadata_infrastructure_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def external_exadata_infrastructure_id(self, value: pulumi.Input[_builtins.str]):
...
class ExternalExadataInfrastructureExadataManagement(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="enableExadata")
    def enable_exadata(self) -> pulumi.Output[_builtins.bool]:
        """
        (Updatable) A required field when set to `true` calls enable action and when set to `false` calls disable action.
    ...
    @_builtins.property
    @pulumi.getter(name="externalExadataInfrastructureId")
    def external_exadata_infrastructure_id(self) -> pulumi.Output[_builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata infrastructure.
        """
        return pulumi.get(self, "external_exadata_infrastructure_id")
