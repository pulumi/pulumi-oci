...
class ExternalListenerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] external_listener_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external listener.
    ...
    def external_listener_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def external_listener_id(self, value: pulumi.Input[_builtins.str]):
...
class _ExternalListenerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] additional_details: The additional details of the external listener defined in `{"key": "value"}` format. Example: `{"bar-key": "value"}`
        ...
        :param pulumi.Input[_builtins.str] external_db_system_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external DB system that the listener is a part of.
        :param pulumi.Input[_builtins.str] external_listener_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external listener.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}` 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] host_name: The name of the host on which the external listener is running.
        ...
        :param pulumi.Input[_builtins.str] time_updated: The date and time the external listener was last updated.
...
class ExternalListener(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="externalListenerId")
    def external_listener_id(self) -> pulumi.Output[_builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external listener.
        """
        return pulumi.get(self, "external_listener_id")
