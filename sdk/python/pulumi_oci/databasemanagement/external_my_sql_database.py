...
class ExternalMySqlDatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: OCID of compartment for the External MySQL Database.
        :param pulumi.Input[builtins.str] db_name: (Updatable) Name of the External MySQL Database.
...
class _ExternalMySqlDatabaseState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] db_name: (Updatable) Name of the External MySQL Database.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] external_database_id: OCID of External MySQL Database.
        """
...
class ExternalMySqlDatabase(pulumi.CustomResource):
    ...
    pulumi_type = "oci:DatabaseManagement/externalMySqlDatabase:ExternalMySqlDatabase"
    ...
    def get(resource_name: str,
            ...
            compartment_id: Optional[pulumi.Input[builtins.str]] = None,
            db_name: Optional[pulumi.Input[builtins.str]] = None,
            external_database_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ExternalMySqlDatabase':
        """
