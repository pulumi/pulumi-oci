...
class ExternalMySqlDatabaseExternalMysqlDatabasesManagementArgs:
    def __init__(__self__, *,
                 enable_external_mysql_database: pulumi.Input[builtins.bool],
                 external_my_sql_database_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.bool] enable_external_mysql_database: (Updatable) A required field when set to `true` calls enable action and when set to `false` calls disable action.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] external_my_sql_database_id: The OCID of the External MySQL Database.
        :param pulumi.Input[builtins.str] connector_id: OCID of External MySQL Database connector.
        """
    ...
    def enable_external_mysql_database(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def enable_external_mysql_database(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "enable_external_mysql_database", value)

    @property
    @pulumi.getter(name="externalMySqlDatabaseId")
    def external_my_sql_database_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def external_my_sql_database_id(self, value: pulumi.Input[builtins.str]):
...
class _ExternalMySqlDatabaseExternalMysqlDatabasesManagementState:
    def __init__(__self__, *,
                 connector_id: Optional[pulumi.Input[builtins.str]] = None,
                 enable_external_mysql_database: Optional[pulumi.Input[builtins.bool]] = None,
                 external_my_sql_database_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="enableExternalMysqlDatabase")
    def enable_external_mysql_database(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) A required field when set to `true` calls enable action and when set to `false` calls disable action.
    ...
    @enable_external_mysql_database.setter
    def enable_external_mysql_database(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_external_mysql_database", value)

    @property
    @pulumi.getter(name="externalMySqlDatabaseId")
    def external_my_sql_database_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The OCID of the External MySQL Database.
        """
        return pulumi.get(self, "external_my_sql_database_id")
    ...
    @external_my_sql_database_id.setter
    def external_my_sql_database_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "external_my_sql_database_id", value)
...
class ExternalMySqlDatabaseExternalMysqlDatabasesManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            connector_id: Optional[pulumi.Input[builtins.str]] = None,
            enable_external_mysql_database: Optional[pulumi.Input[builtins.bool]] = None,
            external_my_sql_database_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ExternalMySqlDatabaseExternalMysqlDatabasesManagement':
        """
    ...
    @property
    @pulumi.getter(name="enableExternalMysqlDatabase")
    def enable_external_mysql_database(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) A required field when set to `true` calls enable action and when set to `false` calls disable action.
    ...
    @property
    @pulumi.getter(name="externalMySqlDatabaseId")
    def external_my_sql_database_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the External MySQL Database.
        """
        return pulumi.get(self, "external_my_sql_database_id")
