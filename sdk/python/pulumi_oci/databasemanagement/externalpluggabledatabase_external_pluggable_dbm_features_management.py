...
class ExternalpluggabledatabaseExternalPluggableDbmFeaturesManagementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] enable_external_pluggable_dbm_feature: (Updatable) A required field when set to `true` calls enable action and when set to `false` calls disable action.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] external_pluggable_database_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external pluggable database.
    ...
    def enable_external_pluggable_dbm_feature(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def enable_external_pluggable_dbm_feature(self, value: pulumi.Input[builtins.bool]):
...
class _ExternalpluggabledatabaseExternalPluggableDbmFeaturesManagementState:
    ...
    @property
    @pulumi.getter(name="enableExternalPluggableDbmFeature")
    def enable_external_pluggable_dbm_feature(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) A required field when set to `true` calls enable action and when set to `false` calls disable action.
    ...
    @enable_external_pluggable_dbm_feature.setter
    def enable_external_pluggable_dbm_feature(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "enable_external_pluggable_dbm_feature", value)
...
class ExternalpluggabledatabaseExternalPluggableDbmFeaturesManagement(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="enableExternalPluggableDbmFeature")
    def enable_external_pluggable_dbm_feature(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) A required field when set to `true` calls enable action and when set to `false` calls disable action.
