...
__all__ = [
    'GetCloudClusterResult',
    'AwaitableGetCloudClusterResult',
    'get_cloud_cluster',
    'get_cloud_cluster_output',
]

@pulumi.output_type
class GetCloudClusterResult:
    """
    A collection of values returned by getCloudCluster.
    """
    def __init__(__self__, additional_details=None, cloud_cluster_id=None, cloud_connector_id=None, cloud_db_system_id=None, compartment_id=None, component_name=None, dbaas_id=None, defined_tags=None, display_name=None, freeform_tags=None, grid_home=None, id=None, is_flex_cluster=None, lifecycle_details=None, network_configurations=None, ocr_file_location=None, scan_configurations=None, state=None, system_tags=None, time_created=None, time_updated=None, version=None, vip_configurations=None):
    ...
    def network_configurations(self) -> Sequence['outputs.GetCloudClusterNetworkConfigurationResult']:
        """
    ...
    def scan_configurations(self) -> Sequence['outputs.GetCloudClusterScanConfigurationResult']:
        """
    ...
    def vip_configurations(self) -> Sequence['outputs.GetCloudClusterVipConfigurationResult']:
        """
...
class AwaitableGetCloudClusterResult(GetCloudClusterResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudClusterResult(
...
def get_cloud_cluster(cloud_cluster_id: Optional[_builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCloudClusterResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('oci:DatabaseManagement/getCloudCluster:getCloudCluster', __args__, opts=opts, typ=GetCloudClusterResult).value

    return AwaitableGetCloudClusterResult(
...
def get_cloud_cluster_output(cloud_cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCloudClusterResult]:
    """
    This data source provides details about a specific Cloud Cluster resource in Oracle Cloud Infrastructure Database Management service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:DatabaseManagement/getCloudCluster:getCloudCluster', __args__, opts=opts, typ=GetCloudClusterResult)
    return __ret__.apply(lambda __response__: GetCloudClusterResult(
