...
__all__ = [
    'GetCloudClustersResult',
    'AwaitableGetCloudClustersResult',
    'get_cloud_clusters',
    'get_cloud_clusters_output',
]

@pulumi.output_type
class GetCloudClustersResult:
    """
    A collection of values returned by getCloudClusters.
    """
    def __init__(__self__, cloud_cluster_collections=None, cloud_db_system_id=None, compartment_id=None, display_name=None, filters=None, id=None):
        if cloud_cluster_collections and not isinstance(cloud_cluster_collections, list):
            raise TypeError("Expected argument 'cloud_cluster_collections' to be a list")
        pulumi.set(__self__, "cloud_cluster_collections", cloud_cluster_collections)
    ...
    @_builtins.property
    @pulumi.getter(name="cloudClusterCollections")
    def cloud_cluster_collections(self) -> Sequence['outputs.GetCloudClustersCloudClusterCollectionResult']:
        """
        The list of cloud_cluster_collection.
        """
        return pulumi.get(self, "cloud_cluster_collections")
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCloudClustersFilterResult']]:
...
class AwaitableGetCloudClustersResult(GetCloudClustersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudClustersResult(
            cloud_cluster_collections=self.cloud_cluster_collections,
...
def get_cloud_clusters(cloud_db_system_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('oci:DatabaseManagement/getCloudClusters:getCloudClusters', __args__, opts=opts, typ=GetCloudClustersResult).value

    return AwaitableGetCloudClustersResult(
        cloud_cluster_collections=pulumi.get(__ret__, 'cloud_cluster_collections'),
        cloud_db_system_id=pulumi.get(__ret__, 'cloud_db_system_id'),
        compartment_id=pulumi.get(__ret__, 'compartment_id'),
        display_name=pulumi.get(__ret__, 'display_name'),
        filters=pulumi.get(__ret__, 'filters'),
        id=pulumi.get(__ret__, 'id'))
def get_cloud_clusters_output(cloud_db_system_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              compartment_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              display_name: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                              filters: Optional[pulumi.Input[Optional[Sequence[Union['GetCloudClustersFilterArgs', 'GetCloudClustersFilterArgsDict']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:DatabaseManagement/getCloudClusters:getCloudClusters', __args__, opts=opts, typ=GetCloudClustersResult)
    return __ret__.apply(lambda __response__: GetCloudClustersResult(
        cloud_cluster_collections=pulumi.get(__response__, 'cloud_cluster_collections'),
