...
__all__ = [
    'GetCloudDbHomesResult',
    'AwaitableGetCloudDbHomesResult',
    'get_cloud_db_homes',
    'get_cloud_db_homes_output',
]

@pulumi.output_type
class GetCloudDbHomesResult:
    """
    A collection of values returned by getCloudDbHomes.
    """
    def __init__(__self__, cloud_db_home_collections=None, cloud_db_system_id=None, compartment_id=None, display_name=None, filters=None, id=None):
        if cloud_db_home_collections and not isinstance(cloud_db_home_collections, list):
            raise TypeError("Expected argument 'cloud_db_home_collections' to be a list")
        pulumi.set(__self__, "cloud_db_home_collections", cloud_db_home_collections)
    ...
    @_builtins.property
    @pulumi.getter(name="cloudDbHomeCollections")
    def cloud_db_home_collections(self) -> Sequence['outputs.GetCloudDbHomesCloudDbHomeCollectionResult']:
        """
        The list of cloud_db_home_collection.
        """
        return pulumi.get(self, "cloud_db_home_collections")
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCloudDbHomesFilterResult']]:
...
class AwaitableGetCloudDbHomesResult(GetCloudDbHomesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudDbHomesResult(
            cloud_db_home_collections=self.cloud_db_home_collections,
...
def get_cloud_db_homes(cloud_db_system_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('oci:DatabaseManagement/getCloudDbHomes:getCloudDbHomes', __args__, opts=opts, typ=GetCloudDbHomesResult).value

    return AwaitableGetCloudDbHomesResult(
        cloud_db_home_collections=pulumi.get(__ret__, 'cloud_db_home_collections'),
...
def get_cloud_db_homes_output(cloud_db_system_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:DatabaseManagement/getCloudDbHomes:getCloudDbHomes', __args__, opts=opts, typ=GetCloudDbHomesResult)
    return __ret__.apply(lambda __response__: GetCloudDbHomesResult(
        cloud_db_home_collections=pulumi.get(__response__, 'cloud_db_home_collections'),
