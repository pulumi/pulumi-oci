...
__all__ = [
    'GetCloudExadataStorageConnectorResult',
    'AwaitableGetCloudExadataStorageConnectorResult',
    'get_cloud_exadata_storage_connector',
    'get_cloud_exadata_storage_connector_output',
]

@pulumi.output_type
class GetCloudExadataStorageConnectorResult:
    """
    A collection of values returned by getCloudExadataStorageConnector.
    """
    def __init__(__self__, additional_details=None, agent_id=None, cloud_exadata_storage_connector_id=None, connection_uri=None, credential_infos=None, defined_tags=None, display_name=None, exadata_infrastructure_id=None, freeform_tags=None, id=None, internal_id=None, lifecycle_details=None, resource_type=None, state=None, status=None, storage_server_id=None, system_tags=None, time_created=None, time_updated=None, version=None):
        ...
        if cloud_exadata_storage_connector_id and not isinstance(cloud_exadata_storage_connector_id, str):
            raise TypeError("Expected argument 'cloud_exadata_storage_connector_id' to be a str")
        pulumi.set(__self__, "cloud_exadata_storage_connector_id", cloud_exadata_storage_connector_id)
    ...
    @_builtins.property
    @pulumi.getter(name="cloudExadataStorageConnectorId")
    def cloud_exadata_storage_connector_id(self) -> _builtins.str:
        return pulumi.get(self, "cloud_exadata_storage_connector_id")
    ...
    def credential_infos(self) -> Sequence['outputs.GetCloudExadataStorageConnectorCredentialInfoResult']:
...
class AwaitableGetCloudExadataStorageConnectorResult(GetCloudExadataStorageConnectorResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudExadataStorageConnectorResult(
            additional_details=self.additional_details,
            agent_id=self.agent_id,
            cloud_exadata_storage_connector_id=self.cloud_exadata_storage_connector_id,
...
def get_cloud_exadata_storage_connector(cloud_exadata_storage_connector_id: Optional[_builtins.str] = None,
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCloudExadataStorageConnectorResult:
    """
    ...
    :param _builtins.str cloud_exadata_storage_connector_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the connector to the Exadata storage server.
    """
    __args__ = dict()
    __args__['cloudExadataStorageConnectorId'] = cloud_exadata_storage_connector_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:DatabaseManagement/getCloudExadataStorageConnector:getCloudExadataStorageConnector', __args__, opts=opts, typ=GetCloudExadataStorageConnectorResult).value

    return AwaitableGetCloudExadataStorageConnectorResult(
        additional_details=pulumi.get(__ret__, 'additional_details'),
        agent_id=pulumi.get(__ret__, 'agent_id'),
        cloud_exadata_storage_connector_id=pulumi.get(__ret__, 'cloud_exadata_storage_connector_id'),
...
def get_cloud_exadata_storage_connector_output(cloud_exadata_storage_connector_id: Optional[pulumi.Input[_builtins.str]] = None,
                                               opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCloudExadataStorageConnectorResult]:
    """
    This data source provides details about a specific Cloud Exadata Storage Connector resource in Oracle Cloud Infrastructure Database Management service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:DatabaseManagement/getCloudExadataStorageConnector:getCloudExadataStorageConnector', __args__, opts=opts, typ=GetCloudExadataStorageConnectorResult)
    return __ret__.apply(lambda __response__: GetCloudExadataStorageConnectorResult(
        additional_details=pulumi.get(__response__, 'additional_details'),
        agent_id=pulumi.get(__response__, 'agent_id'),
        cloud_exadata_storage_connector_id=pulumi.get(__response__, 'cloud_exadata_storage_connector_id'),
