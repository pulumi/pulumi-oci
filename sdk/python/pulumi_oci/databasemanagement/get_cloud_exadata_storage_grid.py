...
__all__ = [
    'GetCloudExadataStorageGridResult',
    'AwaitableGetCloudExadataStorageGridResult',
    'get_cloud_exadata_storage_grid',
    'get_cloud_exadata_storage_grid_output',
]

@pulumi.output_type
class GetCloudExadataStorageGridResult:
    """
    A collection of values returned by getCloudExadataStorageGrid.
    """
    def __init__(__self__, additional_details=None, cloud_exadata_storage_grid_id=None, defined_tags=None, display_name=None, exadata_infrastructure_id=None, freeform_tags=None, id=None, internal_id=None, lifecycle_details=None, resource_type=None, server_count=None, state=None, status=None, storage_servers=None, system_tags=None, time_created=None, time_updated=None, version=None):
        ...
        if cloud_exadata_storage_grid_id and not isinstance(cloud_exadata_storage_grid_id, str):
            raise TypeError("Expected argument 'cloud_exadata_storage_grid_id' to be a str")
    ...
    def cloud_exadata_storage_grid_id(self) -> _builtins.str:
    ...
    def storage_servers(self) -> Sequence['outputs.GetCloudExadataStorageGridStorageServerResult']:
        """
...
class AwaitableGetCloudExadataStorageGridResult(GetCloudExadataStorageGridResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudExadataStorageGridResult(
            additional_details=self.additional_details,
            cloud_exadata_storage_grid_id=self.cloud_exadata_storage_grid_id,
...
def get_cloud_exadata_storage_grid(cloud_exadata_storage_grid_id: Optional[_builtins.str] = None,
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCloudExadataStorageGridResult:
    """
    ...
    :param _builtins.str cloud_exadata_storage_grid_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata storage grid.
    """
    __args__ = dict()
    __args__['cloudExadataStorageGridId'] = cloud_exadata_storage_grid_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:DatabaseManagement/getCloudExadataStorageGrid:getCloudExadataStorageGrid', __args__, opts=opts, typ=GetCloudExadataStorageGridResult).value

    return AwaitableGetCloudExadataStorageGridResult(
        additional_details=pulumi.get(__ret__, 'additional_details'),
        cloud_exadata_storage_grid_id=pulumi.get(__ret__, 'cloud_exadata_storage_grid_id'),
...
def get_cloud_exadata_storage_grid_output(cloud_exadata_storage_grid_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:DatabaseManagement/getCloudExadataStorageGrid:getCloudExadataStorageGrid', __args__, opts=opts, typ=GetCloudExadataStorageGridResult)
    return __ret__.apply(lambda __response__: GetCloudExadataStorageGridResult(
        additional_details=pulumi.get(__response__, 'additional_details'),
        cloud_exadata_storage_grid_id=pulumi.get(__response__, 'cloud_exadata_storage_grid_id'),
