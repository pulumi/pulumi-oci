...
class GetCloudExadataStorageServerResult:
    ...
    @_builtins.property
    @pulumi.getter
    def connectors(self) -> Sequence['outputs.GetCloudExadataStorageServerConnectorResult']:
        """
...
class AwaitableGetCloudExadataStorageServerResult(GetCloudExadataStorageServerResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCloudExadataStorageServerResult(
...
def get_cloud_exadata_storage_server(cloud_exadata_storage_server_id: Optional[_builtins.str] = None,
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCloudExadataStorageServerResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('oci:DatabaseManagement/getCloudExadataStorageServer:getCloudExadataStorageServer', __args__, opts=opts, typ=GetCloudExadataStorageServerResult).value

    return AwaitableGetCloudExadataStorageServerResult(
...
def get_cloud_exadata_storage_server_output(cloud_exadata_storage_server_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:DatabaseManagement/getCloudExadataStorageServer:getCloudExadataStorageServer', __args__, opts=opts, typ=GetCloudExadataStorageServerResult)
    return __ret__.apply(lambda __response__: GetCloudExadataStorageServerResult(
