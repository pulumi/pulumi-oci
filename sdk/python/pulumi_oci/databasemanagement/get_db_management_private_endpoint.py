...
class GetDbManagementPrivateEndpointResult:
    ...
    def is_dns_resolution_enabled(self) -> builtins.bool:
        """
...
def get_db_management_private_endpoint(db_management_private_endpoint_id: Optional[builtins.str] = None,
...
def get_db_management_private_endpoint_output(db_management_private_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
