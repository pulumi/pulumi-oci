...
def get_db_management_private_endpoint_associated_databases(compartment_id: Optional[builtins.str] = None,
...
def get_db_management_private_endpoint_associated_databases_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
