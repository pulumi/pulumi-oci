...
class GetExternalAsmResult:
    ...
    def is_flex_enabled(self) -> builtins.bool:
        """
...
def get_external_asm(external_asm_id: Optional[builtins.str] = None,
...
def get_external_asm_output(external_asm_id: Optional[pulumi.Input[builtins.str]] = None,
