...
def get_external_asm_configuration(external_asm_id: Optional[builtins.str] = None,
...
def get_external_asm_configuration_output(external_asm_id: Optional[pulumi.Input[builtins.str]] = None,
