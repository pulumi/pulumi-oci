...
def get_external_asm_disk_groups(external_asm_id: Optional[builtins.str] = None,
...
def get_external_asm_disk_groups_output(external_asm_id: Optional[pulumi.Input[builtins.str]] = None,
