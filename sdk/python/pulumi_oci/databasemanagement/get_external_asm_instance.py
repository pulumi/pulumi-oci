...
class GetExternalAsmInstanceResult:
    ...
    def external_asm_instance_id(self) -> _builtins.str:
...
def get_external_asm_instance(external_asm_instance_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str external_asm_instance_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external ASM instance.
    """
    __args__ = dict()
...
def get_external_asm_instance_output(external_asm_instance_id: Optional[pulumi.Input[_builtins.str]] = None,
