...
class GetExternalAsmInstanceResult:
    ...
    def adr_home_directory(self) -> builtins.str:
        """
    ...
    def external_asm_id(self) -> builtins.str:
        """
    ...
    def external_asm_instance_id(self) -> builtins.str:
        return pulumi.get(self, "external_asm_instance_id")

    @property
    @pulumi.getter(name="externalDbNodeId")
    def external_db_node_id(self) -> builtins.str:
        """
    ...
    def external_db_system_id(self) -> builtins.str:
        """
...
def get_external_asm_instance(external_asm_instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str external_asm_instance_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external ASM instance.
    """
    __args__ = dict()
...
def get_external_asm_instance_output(external_asm_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetExternalAsmInstanceResult]:
    """
    This data source provides details about a specific External Asm Instance resource in Oracle Cloud Infrastructure Database Management service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:DatabaseManagement/getExternalAsmInstance:getExternalAsmInstance', __args__, opts=opts, typ=GetExternalAsmInstanceResult)
    return __ret__.apply(lambda __response__: GetExternalAsmInstanceResult(
        ...
        external_asm_instance_id=pulumi.get(__response__, 'external_asm_instance_id'),
