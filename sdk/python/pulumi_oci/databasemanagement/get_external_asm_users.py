...
def get_external_asm_users(external_asm_id: Optional[builtins.str] = None,
    ...
    :param builtins.str external_asm_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external ASM.
...
def get_external_asm_users_output(external_asm_id: Optional[pulumi.Input[builtins.str]] = None,
