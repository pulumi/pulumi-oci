...
class GetExternalAsmsResult:
    ...
    def external_db_system_id(self) -> Optional[builtins.str]:
        """
...
def get_external_asms(compartment_id: Optional[builtins.str] = None,
                      display_name: Optional[builtins.str] = None,
                      external_db_system_id: Optional[builtins.str] = None,
    ...
    :param builtins.str display_name: A filter to only return the resources that match the entire display name.
    :param builtins.str external_db_system_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external DB system.
    """
    __args__ = dict()
...
def get_external_asms_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             external_db_system_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             filters: Optional[pulumi.Input[Optional[Sequence[Union['GetExternalAsmsFilterArgs', 'GetExternalAsmsFilterArgsDict']]]]] = None,
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetExternalAsmsResult]:
    """
    This data source provides the list of External Asms in Oracle Cloud Infrastructure Database Management service.
