...
def get_external_cluster(external_cluster_id: Optional[str] = None,
    ...
    test_external_cluster = oci.DatabaseManagement.get_external_cluster(external_cluster_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
    ```
    ...
    return AwaitableGetExternalClusterResult(
        ...
        id=__ret__.id,
        is_flex_cluster=__ret__.is_flex_cluster,
        lifecycle_details=__ret__.lifecycle_details,
        network_configurations=__ret__.network_configurations,
        ocr_file_location=__ret__.ocr_file_location,
        scan_configurations=__ret__.scan_configurations,
        state=__ret__.state,
        time_created=__ret__.time_created,
        time_updated=__ret__.time_updated,
        version=__ret__.version,
        vip_configurations=__ret__.vip_configurations)
