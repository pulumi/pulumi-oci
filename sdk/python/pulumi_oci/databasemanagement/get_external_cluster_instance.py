...
class GetExternalClusterInstanceResult:
    ...
    def crs_base_directory(self) -> builtins.str:
        """
    ...
    def external_cluster_instance_id(self) -> builtins.str:
...
def get_external_cluster_instance(external_cluster_instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str external_cluster_instance_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external cluster instance.
    """
    __args__ = dict()
...
def get_external_cluster_instance_output(external_cluster_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetExternalClusterInstanceResult]:
    """
    This data source provides details about a specific External Cluster Instance resource in Oracle Cloud Infrastructure Database Management service.
