...
def get_external_cluster_instance(external_cluster_instance_id: Optional[str] = None,
    ...
    test_external_cluster_instance = oci.DatabaseManagement.get_external_cluster_instance(external_cluster_instance_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
    ```
    ...
    return AwaitableGetExternalClusterInstanceResult(
        ...
        crs_base_directory=__ret__.crs_base_directory,
        display_name=__ret__.display_name,
        external_cluster_id=__ret__.external_cluster_id,
        external_cluster_instance_id=__ret__.external_cluster_instance_id,
