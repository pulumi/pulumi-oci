...
class GetExternalClusterInstanceResult:
    ...
    def external_cluster_instance_id(self) -> _builtins.str:
...
def get_external_cluster_instance(external_cluster_instance_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str external_cluster_instance_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external cluster instance.
    """
    __args__ = dict()
...
def get_external_cluster_instance_output(external_cluster_instance_id: Optional[pulumi.Input[_builtins.str]] = None,
