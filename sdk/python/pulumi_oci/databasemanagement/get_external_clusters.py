...
def get_external_clusters(compartment_id: Optional[str] = None,
    ...
    test_external_clusters = oci.DatabaseManagement.get_external_clusters(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetExternalClustersResult(
        ...
        external_cluster_collections=__ret__.external_cluster_collections,
        external_db_system_id=__ret__.external_db_system_id,
        filters=__ret__.filters,
        id=__ret__.id)


@_utilities.lift_output_func(get_external_clusters)
