...
def get_external_databases(compartment_id: Optional[str] = None,
    ...
    test_external_databases = oci.DatabaseManagement.get_external_databases(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetExternalDatabasesResult(
        ...
        external_database_collections=__ret__.external_database_collections,
