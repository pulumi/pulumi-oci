...
class GetExternalDatabasesResult:
    ...
    def external_database_id(self) -> Optional[_builtins.str]:
...
def get_external_databases(compartment_id: Optional[_builtins.str] = None,
                           display_name: Optional[_builtins.str] = None,
                           external_database_id: Optional[_builtins.str] = None,
                           external_db_system_id: Optional[_builtins.str] = None,
                           filters: Optional[Sequence[Union['GetExternalDatabasesFilterArgs', 'GetExternalDatabasesFilterArgsDict', 'outputs.GetExternalDatabasesFilterResult']]] = None,
    ...
    :param _builtins.str external_database_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external database.
...
def get_external_databases_output(compartment_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                  ...
                                  filters: pulumi.Input[Optional[Optional[Sequence[Union['GetExternalDatabasesFilterArgs', 'GetExternalDatabasesFilterArgsDict', 'outputs.GetExternalDatabasesFilterResult']]]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetExternalDatabasesResult(
        ...
        external_database_collections=pulumi.get(__response__, 'external_database_collections'),
