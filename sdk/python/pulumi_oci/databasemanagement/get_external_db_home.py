...
def get_external_db_home(external_db_home_id: Optional[str] = None,
    ...
    test_external_db_home = oci.DatabaseManagement.get_external_db_home(external_db_home_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
    ```
    ...
    return AwaitableGetExternalDbHomeResult(
        ...
        external_db_home_id=__ret__.external_db_home_id,
