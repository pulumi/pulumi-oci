...
def get_external_db_home(external_db_home_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str external_db_home_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external database home.
    """
    __args__ = dict()
