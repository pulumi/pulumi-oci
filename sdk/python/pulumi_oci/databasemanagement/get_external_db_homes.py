...
def get_external_db_homes(compartment_id: Optional[builtins.str] = None,
...
def get_external_db_homes_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
