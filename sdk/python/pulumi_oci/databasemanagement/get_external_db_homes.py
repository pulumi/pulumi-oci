...
def get_external_db_homes(compartment_id: Optional[str] = None,
    ...
    test_external_db_homes = oci.DatabaseManagement.get_external_db_homes(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetExternalDbHomesResult(
        ...
        external_db_home_collections=__ret__.external_db_home_collections,
