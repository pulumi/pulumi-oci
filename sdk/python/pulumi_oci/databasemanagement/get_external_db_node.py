...
class GetExternalDbNodeResult:
    ...
    def cpu_core_count(self) -> builtins.float:
        """
    ...
    def external_connector_id(self) -> builtins.str:
        """
    ...
    def memory_size_in_gbs(self) -> builtins.float:
        """
...
def get_external_db_node(external_db_node_id: Optional[builtins.str] = None,
    ...
    :param builtins.str external_db_node_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external database node.
    """
    __args__ = dict()
...
def get_external_db_node_output(external_db_node_id: Optional[pulumi.Input[builtins.str]] = None,
