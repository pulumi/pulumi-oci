...
def get_external_db_node(external_db_node_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str external_db_node_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external database node.
    """
    __args__ = dict()
...
def get_external_db_node_output(external_db_node_id: Optional[pulumi.Input[_builtins.str]] = None,
