...
def get_external_db_system(external_db_system_id: Optional[_builtins.str] = None,
...
def get_external_db_system_output(external_db_system_id: Optional[pulumi.Input[_builtins.str]] = None,
