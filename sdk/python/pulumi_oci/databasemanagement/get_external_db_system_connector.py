...
class GetExternalDbSystemConnectorResult:
    ...
    def connection_failure_message(self) -> builtins.str:
        """
    ...
    def external_db_system_connector_id(self) -> builtins.str:
...
def get_external_db_system_connector(external_db_system_connector_id: Optional[builtins.str] = None,
    ...
    :param builtins.str external_db_system_connector_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external connector.
    """
    __args__ = dict()
...
def get_external_db_system_connector_output(external_db_system_connector_id: Optional[pulumi.Input[builtins.str]] = None,
