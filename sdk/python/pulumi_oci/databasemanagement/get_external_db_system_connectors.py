...
def get_external_db_system_connectors(compartment_id: Optional[builtins.str] = None,
...
def get_external_db_system_connectors_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
