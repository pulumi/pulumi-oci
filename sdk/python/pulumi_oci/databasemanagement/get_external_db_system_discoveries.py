...
def get_external_db_system_discoveries(compartment_id: Optional[builtins.str] = None,
...
def get_external_db_system_discoveries_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
