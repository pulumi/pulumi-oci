...
class GetExternalDbSystemDiscoveryResult:
    ...
    def external_db_system_discovery_id(self) -> _builtins.str:
...
def get_external_db_system_discovery(external_db_system_discovery_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str external_db_system_discovery_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external DB system discovery.
    """
    __args__ = dict()
