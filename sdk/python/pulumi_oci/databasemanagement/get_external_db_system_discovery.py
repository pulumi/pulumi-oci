...
class GetExternalDbSystemDiscoveryResult:
    ...
    def external_db_system_discovery_id(self) -> builtins.str:
    ...
    def grid_home(self) -> builtins.str:
        """
...
def get_external_db_system_discovery(external_db_system_discovery_id: Optional[builtins.str] = None,
    ...
    :param builtins.str external_db_system_discovery_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external DB system discovery.
    """
    __args__ = dict()
...
def get_external_db_system_discovery_output(external_db_system_discovery_id: Optional[pulumi.Input[builtins.str]] = None,
