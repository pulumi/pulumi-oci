...
def get_external_db_systems(compartment_id: Optional[builtins.str] = None,
...
def get_external_db_systems_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
