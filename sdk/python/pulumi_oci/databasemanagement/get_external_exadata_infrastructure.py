...
class GetExternalExadataInfrastructureResult:
    ...
    def database_compartments(self) -> Sequence[builtins.str]:
        """
    ...
    def db_system_ids(self) -> Sequence[builtins.str]:
    ...
    def discovery_key(self) -> builtins.str:
    ...
    def external_exadata_infrastructure_id(self) -> builtins.str:
    ...
    def rack_size(self) -> builtins.str:
        """
    ...
    def storage_server_names(self) -> Sequence[builtins.str]:
...
def get_external_exadata_infrastructure(external_exadata_infrastructure_id: Optional[builtins.str] = None,
    ...
    :param builtins.str external_exadata_infrastructure_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata infrastructure.
    """
    __args__ = dict()
...
def get_external_exadata_infrastructure_output(external_exadata_infrastructure_id: Optional[pulumi.Input[builtins.str]] = None,
