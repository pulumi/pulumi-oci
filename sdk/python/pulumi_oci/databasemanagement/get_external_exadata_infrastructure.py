...
class GetExternalExadataInfrastructureResult:
    ...
    def db_system_ids(self) -> Sequence[_builtins.str]:
...
def get_external_exadata_infrastructure(external_exadata_infrastructure_id: Optional[_builtins.str] = None,
...
def get_external_exadata_infrastructure_output(external_exadata_infrastructure_id: Optional[pulumi.Input[_builtins.str]] = None,
