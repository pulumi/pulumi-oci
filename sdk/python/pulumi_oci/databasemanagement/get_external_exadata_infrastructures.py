...
def get_external_exadata_infrastructures(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str display_name: The optional single value query filter parameter on the entity display name.
    """
    __args__ = dict()
...
def get_external_exadata_infrastructures_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
