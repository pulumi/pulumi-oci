...
class GetExternalExadataStorageConnectorResult:
    ...
    def external_exadata_storage_connector_id(self) -> _builtins.str:
...
def get_external_exadata_storage_connector(external_exadata_storage_connector_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str external_exadata_storage_connector_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the connector to the Exadata storage server.
    """
    __args__ = dict()
...
def get_external_exadata_storage_connector_output(external_exadata_storage_connector_id: Optional[pulumi.Input[_builtins.str]] = None,
