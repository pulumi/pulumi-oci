...
class GetExternalExadataStorageGridResult:
    ...
    def external_exadata_storage_grid_id(self) -> builtins.str:
    ...
    def server_count(self) -> builtins.float:
        """
...
def get_external_exadata_storage_grid(external_exadata_storage_grid_id: Optional[builtins.str] = None,
    ...
    :param builtins.str external_exadata_storage_grid_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata storage grid.
    """
    __args__ = dict()
...
def get_external_exadata_storage_grid_output(external_exadata_storage_grid_id: Optional[pulumi.Input[builtins.str]] = None,
