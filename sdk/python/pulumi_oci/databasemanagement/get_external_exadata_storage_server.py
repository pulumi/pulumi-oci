...
def get_external_exadata_storage_server(external_exadata_storage_server_id: Optional[_builtins.str] = None,
...
def get_external_exadata_storage_server_output(external_exadata_storage_server_id: Optional[pulumi.Input[_builtins.str]] = None,
