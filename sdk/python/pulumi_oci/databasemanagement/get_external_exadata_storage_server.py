...
def get_external_exadata_storage_server(external_exadata_storage_server_id: Optional[str] = None,
    ...
    test_external_exadata_storage_server = oci.DatabaseManagement.get_external_exadata_storage_server(external_exadata_storage_server_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
    ```
    ...
    return AwaitableGetExternalExadataStorageServerResult(
        ...
        make_model=__ret__.make_model,
        max_flash_disk_iops=__ret__.max_flash_disk_iops,
        max_flash_disk_throughput=__ret__.max_flash_disk_throughput,
        max_hard_disk_iops=__ret__.max_hard_disk_iops,
        max_hard_disk_throughput=__ret__.max_hard_disk_throughput,
        memory_gb=__ret__.memory_gb,
        resource_type=__ret__.resource_type,
        state=__ret__.state,
        status=__ret__.status,
        storage_grid_id=__ret__.storage_grid_id,
