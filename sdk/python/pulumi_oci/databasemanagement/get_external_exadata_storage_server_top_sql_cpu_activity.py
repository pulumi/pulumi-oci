...
def get_external_exadata_storage_server_top_sql_cpu_activity(external_exadata_storage_server_id: Optional[builtins.str] = None,
...
def get_external_exadata_storage_server_top_sql_cpu_activity_output(external_exadata_storage_server_id: Optional[pulumi.Input[builtins.str]] = None,
