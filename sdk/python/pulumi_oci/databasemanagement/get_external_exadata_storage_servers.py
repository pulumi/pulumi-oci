...
def get_external_exadata_storage_servers(compartment_id: Optional[builtins.str] = None,
...
def get_external_exadata_storage_servers_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
