...
def get_external_listener(external_listener_id: Optional[str] = None,
    ...
    test_external_listener = oci.DatabaseManagement.get_external_listener(external_listener_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
    ```
    ...
    return AwaitableGetExternalListenerResult(
        ...
        listener_alias=__ret__.listener_alias,
        listener_ora_location=__ret__.listener_ora_location,
        listener_type=__ret__.listener_type,
        log_directory=__ret__.log_directory,
        oracle_home=__ret__.oracle_home,
        serviced_asms=__ret__.serviced_asms,
        serviced_databases=__ret__.serviced_databases,
        state=__ret__.state,
        time_created=__ret__.time_created,
        time_updated=__ret__.time_updated,
        trace_directory=__ret__.trace_directory,
