...
class GetExternalListenerServicesResult:
    ...
    def external_listener_id(self) -> builtins.str:
...
def get_external_listener_services(external_listener_id: Optional[builtins.str] = None,
    ...
    :param builtins.str external_listener_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the external listener.
...
def get_external_listener_services_output(external_listener_id: Optional[pulumi.Input[builtins.str]] = None,
