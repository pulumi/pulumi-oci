...
def get_external_listeners(compartment_id: Optional[builtins.str] = None,
...
def get_external_listeners_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
