...
def get_external_listeners(compartment_id: Optional[str] = None,
    ...
    test_external_listeners = oci.DatabaseManagement.get_external_listeners(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
