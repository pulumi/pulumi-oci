...
class GetExternalMySqlDatabaseResult:
    ...
    def external_my_sql_database_id(self) -> builtins.str:
...
def get_external_my_sql_database(external_my_sql_database_id: Optional[builtins.str] = None,
    ...
    :param builtins.str external_my_sql_database_id: The OCID of the External MySQL Database.
    """
    __args__ = dict()
...
def get_external_my_sql_database_output(external_my_sql_database_id: Optional[pulumi.Input[builtins.str]] = None,
