...
class GetExternalMySqlDatabaseResult:
    ...
    def external_my_sql_database_id(self) -> _builtins.str:
...
def get_external_my_sql_database(external_my_sql_database_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str external_my_sql_database_id: The OCID of the External MySQL Database.
    """
    __args__ = dict()
