...
def get_external_my_sql_databases(compartment_id: Optional[builtins.str] = None,
...
def get_external_my_sql_databases_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
