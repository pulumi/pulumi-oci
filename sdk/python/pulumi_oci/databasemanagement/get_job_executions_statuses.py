...
class GetJobExecutionsStatusesResult:
    ...
    def managed_database_group_id(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "managed_database_group_id")

    @_builtins.property
    @pulumi.getter(name="managedDatabaseId")
    def managed_database_id(self) -> Optional[_builtins.str]:
...
def get_job_executions_statuses(compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str end_time: The end time of the time range to retrieve the status summary of job executions in UTC in ISO-8601 format, which is "yyyy-MM-dd'T'hh:mm:ss.sss'Z'".
    ...
    :param _builtins.str start_time: The start time of the time range to retrieve the status summary of job executions in UTC in ISO-8601 format, which is "yyyy-MM-dd'T'hh:mm:ss.sss'Z'".
    """
    __args__ = dict()
...
def get_job_executions_statuses_output(compartment_id: Optional[pulumi.Input[_builtins.str]] = None,
