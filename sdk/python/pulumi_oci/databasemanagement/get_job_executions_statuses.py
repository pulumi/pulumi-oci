...
def get_job_executions_statuses(compartment_id: Optional[builtins.str] = None,
...
def get_job_executions_statuses_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
