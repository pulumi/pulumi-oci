...
def get_managed_database_addm_task(managed_database_id: Optional[builtins.str] = None,
...
def get_managed_database_addm_task_output(managed_database_id: Optional[pulumi.Input[builtins.str]] = None,
