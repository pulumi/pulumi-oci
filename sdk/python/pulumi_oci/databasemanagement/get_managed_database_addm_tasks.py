...
def get_managed_database_addm_tasks(filters: Optional[Sequence[Union['GetManagedDatabaseAddmTasksFilterArgs', 'GetManagedDatabaseAddmTasksFilterArgsDict']]] = None,
    ...
    :param builtins.str time_end: The end of the time range to search for ADDM tasks as defined by date-time RFC3339 format.
    :param builtins.str time_start: The beginning of the time range to search for ADDM tasks as defined by date-time RFC3339 format.
    """
    __args__ = dict()
