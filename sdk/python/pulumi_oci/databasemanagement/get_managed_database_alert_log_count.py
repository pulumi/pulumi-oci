...
def get_managed_database_alert_log_count(group_by: Optional[str] = None,
    ...
    test_managed_database_alert_log_count = oci.DatabaseManagement.get_managed_database_alert_log_count(managed_database_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
