...
def get_managed_database_alert_log_count(group_by: Optional[builtins.str] = None,
...
def get_managed_database_alert_log_count_output(group_by: Optional[pulumi.Input[Optional[builtins.str]]] = None,
