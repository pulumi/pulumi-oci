...
def get_managed_database_alert_log_counts(filters: Optional[Sequence[pulumi.InputType['GetManagedDatabaseAlertLogCountsFilterArgs']]] = None,
    ...
    test_managed_database_alert_log_counts = oci.DatabaseManagement.get_managed_database_alert_log_counts(managed_database_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        ...
        level_filter=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetManagedDatabaseAlertLogCountsResult(
        alert_log_counts_collections=__ret__.alert_log_counts_collections,
        filters=__ret__.filters,
        group_by=__ret__.group_by,
        id=__ret__.id,
        is_regular_expression=__ret__.is_regular_expression,
        level_filter=__ret__.level_filter,
