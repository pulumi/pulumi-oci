...
class GetManagedDatabaseAlertLogCountsResult:
    ...
    def level_filter(self) -> Optional[builtins.str]:
...
def get_managed_database_alert_log_counts(filters: Optional[Sequence[Union['GetManagedDatabaseAlertLogCountsFilterArgs', 'GetManagedDatabaseAlertLogCountsFilterArgsDict']]] = None,
                                          ...
                                          level_filter: Optional[builtins.str] = None,
    ...
    :param builtins.str group_by: The optional parameter used to group different alert logs.
    :param builtins.bool is_regular_expression: The flag to indicate whether the search text is regular expression or not.
    :param builtins.str level_filter: The optional parameter to filter the alert logs by log level.
...
def get_managed_database_alert_log_counts_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetManagedDatabaseAlertLogCountsFilterArgs', 'GetManagedDatabaseAlertLogCountsFilterArgsDict']]]]] = None,
                                                 ...
                                                 level_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
