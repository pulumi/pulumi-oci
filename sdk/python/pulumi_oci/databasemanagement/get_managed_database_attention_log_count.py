...
class GetManagedDatabaseAttentionLogCountResult:
    ...
    def urgency_filter(self) -> Optional[_builtins.str]:
...
def get_managed_database_attention_log_count(group_by: Optional[_builtins.str] = None,
                                             ...
                                             urgency_filter: Optional[_builtins.str] = None,
    ...
    :param _builtins.str group_by: The optional parameter used to group different attention logs.
    ...
    :param _builtins.str urgency_filter: The optional parameter to filter the attention logs by urgency.
    """
    __args__ = dict()
...
def get_managed_database_attention_log_count_output(group_by: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                    ...
                                                    urgency_filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
