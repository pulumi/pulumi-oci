...
class GetManagedDatabaseAttentionLogCountResult:
    ...
    @property
    @pulumi.getter
    def items(self) -> Optional[Sequence['outputs.GetManagedDatabaseAttentionLogCountItemResult']]:
...
@_utilities.lift_output_func(get_managed_database_attention_log_count)
