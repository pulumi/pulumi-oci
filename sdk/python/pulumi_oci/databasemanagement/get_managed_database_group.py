...
class GetManagedDatabaseGroupResult:
    ...
    def managed_database_group_id(self) -> builtins.str:
...
def get_managed_database_group(managed_database_group_id: Optional[builtins.str] = None,
...
def get_managed_database_group_output(managed_database_group_id: Optional[pulumi.Input[builtins.str]] = None,
