...
def get_managed_database_groups(compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: The identifier of the resource. Only one of the parameters, id or name should be provided.
...
def get_managed_database_groups_output(compartment_id: Optional[pulumi.Input[_builtins.str]] = None,
