...
def get_managed_database_groups(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The identifier of the resource. Only one of the parameters, id or name should be provided.
    ...
    :param builtins.str state: The lifecycle state of a resource.
    """
    __args__ = dict()
...
def get_managed_database_groups_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                       ...
                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetManagedDatabaseGroupsResult]:
    """
    This data source provides the list of Managed Database Groups in Oracle Cloud Infrastructure Database Management service.
