...
class GetManagedDatabaseOptimizerStatisticsAdvisorExecutionResult:
    ...
    @property
    @pulumi.getter
    def findings(self) -> builtins.int:
        """
...
def get_managed_database_optimizer_statistics_advisor_execution(execution_name: Optional[builtins.str] = None,
    ...
    :param builtins.str execution_name: The name of the Optimizer Statistics Advisor execution.
    ...
    :param builtins.str task_name: The name of the optimizer statistics collection execution task.
    """
    __args__ = dict()
...
def get_managed_database_optimizer_statistics_advisor_execution_output(execution_name: Optional[pulumi.Input[builtins.str]] = None,
