...
def get_managed_database_optimizer_statistics_advisor_execution_script(execution_name: Optional[builtins.str] = None,
...
def get_managed_database_optimizer_statistics_advisor_execution_script_output(execution_name: Optional[pulumi.Input[builtins.str]] = None,
