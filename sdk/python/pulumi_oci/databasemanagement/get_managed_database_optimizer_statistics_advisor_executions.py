...
def get_managed_database_optimizer_statistics_advisor_executions(end_time_less_than_or_equal_to: Optional[builtins.str] = None,
...
def get_managed_database_optimizer_statistics_advisor_executions_output(end_time_less_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
