...
def get_managed_database_optimizer_statistics_collection_aggregations(end_time_less_than_or_equal_to: Optional[str] = None,
    ...
    test_managed_database_optimizer_statistics_collection_aggregations = oci.DatabaseManagement.get_managed_database_optimizer_statistics_collection_aggregations(group_type=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetManagedDatabaseOptimizerStatisticsCollectionAggregationsResult(
        ...
        optimizer_statistics_collection_aggregations_collections=__ret__.optimizer_statistics_collection_aggregations_collections,
