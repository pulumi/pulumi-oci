...
def get_managed_database_optimizer_statistics_collection_aggregations(end_time_less_than_or_equal_to: Optional[builtins.str] = None,
    ...
    :param builtins.str group_type: The optimizer statistics tasks grouped by type.
...
def get_managed_database_optimizer_statistics_collection_aggregations_output(end_time_less_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
