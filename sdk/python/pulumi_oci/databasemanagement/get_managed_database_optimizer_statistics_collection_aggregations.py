...
def get_managed_database_optimizer_statistics_collection_aggregations(end_time_less_than_or_equal_to: Optional[_builtins.str] = None,
    ...
    :param _builtins.str group_type: The optimizer statistics tasks grouped by type.
...
def get_managed_database_optimizer_statistics_collection_aggregations_output(end_time_less_than_or_equal_to: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
