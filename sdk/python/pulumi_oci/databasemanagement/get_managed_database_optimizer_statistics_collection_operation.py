...
class GetManagedDatabaseOptimizerStatisticsCollectionOperationResult:
    ...
    def in_progress_count(self) -> builtins.int:
        """
    ...
    def optimizer_statistics_collection_operation_id(self) -> builtins.float:
    ...
    def timed_out_count(self) -> builtins.int:
        """
    ...
    def total_objects_count(self) -> builtins.int:
        """
...
def get_managed_database_optimizer_statistics_collection_operation(managed_database_id: Optional[builtins.str] = None,
                                                                   optimizer_statistics_collection_operation_id: Optional[builtins.float] = None,
    ...
    :param builtins.float optimizer_statistics_collection_operation_id: The ID of the Optimizer Statistics Collection operation.
    """
    __args__ = dict()
...
def get_managed_database_optimizer_statistics_collection_operation_output(managed_database_id: Optional[pulumi.Input[builtins.str]] = None,
                                                                          optimizer_statistics_collection_operation_id: Optional[pulumi.Input[builtins.float]] = None,
