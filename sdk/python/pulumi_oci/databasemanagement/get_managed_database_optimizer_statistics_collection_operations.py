...
class GetManagedDatabaseOptimizerStatisticsCollectionOperationsResult:
    ...
    def end_time_less_than_or_equal_to(self) -> Optional[builtins.str]:
        return pulumi.get(self, "end_time_less_than_or_equal_to")

    @property
    @pulumi.getter(name="filterBy")
    def filter_by(self) -> Optional[builtins.str]:
    ...
    def start_time_greater_than_or_equal_to(self) -> Optional[builtins.str]:
        return pulumi.get(self, "start_time_greater_than_or_equal_to")

    @property
    @pulumi.getter(name="taskType")
    def task_type(self) -> Optional[builtins.str]:
...
def get_managed_database_optimizer_statistics_collection_operations(end_time_less_than_or_equal_to: Optional[builtins.str] = None,
                                                                    filter_by: Optional[builtins.str] = None,
                                                                    ...
                                                                    start_time_greater_than_or_equal_to: Optional[builtins.str] = None,
    ...
    :param builtins.str end_time_less_than_or_equal_to: The end time of the time range to retrieve the optimizer statistics of a Managed Database in UTC in ISO-8601 format, which is "yyyy-MM-dd'T'hh:mm:ss.sss'Z'".
    :param builtins.str filter_by: The parameter used to filter the optimizer statistics operations. Any property of the OptimizerStatisticsCollectionOperationSummary can be used to define the filter condition. The allowed conditional operators are AND or OR, and the allowed binary operators are are >, < and =. Any other operator is regarded invalid. Example: jobName=<replace with job name> AND status=<replace with status>
    ...
    :param builtins.str start_time_greater_than_or_equal_to: The start time of the time range to retrieve the optimizer statistics of a Managed Database in UTC in ISO-8601 format, which is "yyyy-MM-dd'T'hh:mm:ss.sss'Z'".
    :param builtins.str task_type: The filter types of the optimizer statistics tasks.
    """
    __args__ = dict()
...
def get_managed_database_optimizer_statistics_collection_operations_output(end_time_less_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                                           filter_by: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                                           ...
                                                                           start_time_greater_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                                           task_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:DatabaseManagement/getManagedDatabaseOptimizerStatisticsCollectionOperations:getManagedDatabaseOptimizerStatisticsCollectionOperations', __args__, opts=opts, typ=GetManagedDatabaseOptimizerStatisticsCollectionOperationsResult)
    return __ret__.apply(lambda __response__: GetManagedDatabaseOptimizerStatisticsCollectionOperationsResult(
        ...
        optimizer_statistics_collection_operations_collections=pulumi.get(__response__, 'optimizer_statistics_collection_operations_collections'),
