...
class GetManagedDatabaseSqlPlanBaselineResult:
    ...
    @_builtins.property
    @pulumi.getter
    def accepted(self) -> _builtins.str:
        """
    ...
    def auto_purge(self) -> _builtins.str:
        """
    ...
    def execution_plan(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def reproduced(self) -> _builtins.str:
        """
    ...
    def sql_handle(self) -> _builtins.str:
        """
...
def get_managed_database_sql_plan_baseline(managed_database_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str plan_name: The plan name of the SQL plan baseline.
    """
    __args__ = dict()
...
def get_managed_database_sql_plan_baseline_output(managed_database_id: Optional[pulumi.Input[_builtins.str]] = None,
