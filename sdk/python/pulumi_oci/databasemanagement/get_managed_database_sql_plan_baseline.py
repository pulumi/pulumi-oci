...
class GetManagedDatabaseSqlPlanBaselineResult:
    ...
    @property
    @pulumi.getter
    def accepted(self) -> builtins.str:
        """
    ...
    def auto_purge(self) -> builtins.str:
        """
    ...
    def execution_plan(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter
    def reproduced(self) -> builtins.str:
        """
    ...
    def sql_handle(self) -> builtins.str:
        """
...
def get_managed_database_sql_plan_baseline(managed_database_id: Optional[builtins.str] = None,
    ...
    :param builtins.str plan_name: The plan name of the SQL plan baseline.
    """
    __args__ = dict()
...
def get_managed_database_sql_plan_baseline_output(managed_database_id: Optional[pulumi.Input[builtins.str]] = None,
                                                  ...
                                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetManagedDatabaseSqlPlanBaselineResult]:
    """
    This data source provides details about a specific Managed Database Sql Plan Baseline resource in Oracle Cloud Infrastructure Database Management service.
