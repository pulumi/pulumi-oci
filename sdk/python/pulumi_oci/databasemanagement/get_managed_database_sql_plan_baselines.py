...
class GetManagedDatabaseSqlPlanBaselinesResult:
    ...
    def is_accepted(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "is_accepted")

    @property
    @pulumi.getter(name="isAdaptive")
    def is_adaptive(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "is_adaptive")

    @property
    @pulumi.getter(name="isAutoPurged")
    def is_auto_purged(self) -> Optional[builtins.bool]:
    ...
    def sql_handle(self) -> Optional[builtins.str]:
        """
    ...
    def sql_text(self) -> Optional[builtins.str]:
        """
        The SQL text.
        """
...
def get_managed_database_sql_plan_baselines(filters: Optional[Sequence[Union['GetManagedDatabaseSqlPlanBaselinesFilterArgs', 'GetManagedDatabaseSqlPlanBaselinesFilterArgsDict']]] = None,
                                            is_accepted: Optional[builtins.bool] = None,
                                            is_adaptive: Optional[builtins.bool] = None,
                                            is_auto_purged: Optional[builtins.bool] = None,
                                            is_enabled: Optional[builtins.bool] = None,
                                            is_fixed: Optional[builtins.bool] = None,
                                            is_never_executed: Optional[builtins.bool] = None,
                                            is_reproduced: Optional[builtins.bool] = None,
                                            ...
                                            sql_handle: Optional[builtins.str] = None,
                                            sql_text: Optional[builtins.str] = None,
    ...
    :param builtins.bool is_accepted: A filter to return only SQL plan baselines that are either accepted or not accepted. By default, all SQL plan baselines are returned.
    :param builtins.bool is_adaptive: A filter to return only SQL plan baselines that are either adaptive or not adaptive. By default, all SQL plan baselines are returned.
    :param builtins.bool is_auto_purged: A filter to return only SQL plan baselines that are either auto-purged or not auto-purged. By default, all SQL plan baselines are returned.
    :param builtins.bool is_enabled: A filter to return only SQL plan baselines that are either enabled or not enabled. By default, all SQL plan baselines are returned.
    :param builtins.bool is_fixed: A filter to return only SQL plan baselines that are either fixed or not fixed. By default, all SQL plan baselines are returned.
    :param builtins.bool is_never_executed: A filter to return only SQL plan baselines that are not executed till now. By default, all SQL plan baselines are returned.
    :param builtins.bool is_reproduced: A filter to return only SQL plan baselines that were either reproduced or not reproduced by the optimizer. By default, all SQL plan baselines are returned.
    ...
    :param builtins.str origin: A filter to return all the SQL plan baselines that match the origin.
    :param builtins.str plan_name: A filter to return only SQL plan baselines that match the plan name.
    :param builtins.str sql_handle: A filter to return all the SQL plan baselines for the specified SQL handle.
    :param builtins.str sql_text: A filter to return all the SQL plan baselines that match the SQL text. By default, the search is case insensitive. To run an exact or case-sensitive search, double-quote the search string. You may also use the '%' symbol as a wildcard.
    """
    __args__ = dict()
...
def get_managed_database_sql_plan_baselines_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetManagedDatabaseSqlPlanBaselinesFilterArgs', 'GetManagedDatabaseSqlPlanBaselinesFilterArgsDict']]]]] = None,
                                                   is_accepted: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                                   is_adaptive: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                                   is_auto_purged: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                                   is_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                                   is_fixed: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                                   is_never_executed: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                                   is_reproduced: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                                   ...
                                                   sql_handle: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                   sql_text: Optional[pulumi.Input[Optional[builtins.str]]] = None,
