...
def get_managed_database_sql_tuning_advisor_task(managed_database_id: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The optional query parameter to filter the SQL Tuning Advisor task list by name.
    :param builtins.str status: The optional query parameter to filter the SQL Tuning Advisor task list by status.
    :param builtins.str time_greater_than_or_equal_to: The optional greater than or equal to query parameter to filter the timestamp.
    :param builtins.str time_less_than_or_equal_to: The optional less than or equal to query parameter to filter the timestamp.
    """
    __args__ = dict()
...
def get_managed_database_sql_tuning_advisor_task_output(managed_database_id: Optional[pulumi.Input[builtins.str]] = None,
