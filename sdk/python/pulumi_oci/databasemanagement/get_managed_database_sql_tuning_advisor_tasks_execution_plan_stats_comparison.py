...
def get_managed_database_sql_tuning_advisor_tasks_execution_plan_stats_comparison(execution_id: Optional[builtins.str] = None,
...
def get_managed_database_sql_tuning_advisor_tasks_execution_plan_stats_comparison_output(execution_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetManagedDatabaseSqlTuningAdvisorTasksExecutionPlanStatsComparisonResult(
        ...
        modifieds=pulumi.get(__response__, 'modifieds'),
        opc_named_credential_id=pulumi.get(__response__, 'opc_named_credential_id'),
        originals=pulumi.get(__response__, 'originals'),
