...
class GetManagedDatabaseSqlTuningAdvisorTasksFindingResult:
    ...
    def begin_exec_id(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "begin_exec_id")

    @_builtins.property
    @pulumi.getter(name="endExecId")
    def end_exec_id(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "end_exec_id")

    @_builtins.property
    @pulumi.getter(name="findingFilter")
    def finding_filter(self) -> Optional[_builtins.str]:
    ...
    def index_hash_filter(self) -> Optional[_builtins.str]:
    ...
    def stats_hash_filter(self) -> Optional[_builtins.str]:
...
def get_managed_database_sql_tuning_advisor_tasks_finding(begin_exec_id: Optional[_builtins.str] = None,
                                                          ...
                                                          stats_hash_filter: Optional[_builtins.str] = None,
    ...
    :param _builtins.str begin_exec_id: The optional greater than or equal to filter on the execution ID related to a specific SQL Tuning Advisor task.
    :param _builtins.str end_exec_id: The optional less than or equal to query parameter to filter on the execution ID related to a specific SQL Tuning Advisor task.
    :param _builtins.str finding_filter: The filter used to display specific findings in the report.
    :param _builtins.str index_hash_filter: The hash value of the index table name.
    ...
    :param _builtins.str search_period: The search period during which the API will search for begin and end exec id, if not supplied. Unused if beginExecId and endExecId optional query params are both supplied.
    ...
    :param _builtins.str stats_hash_filter: The hash value of the object for the statistic finding search.
    """
    __args__ = dict()
