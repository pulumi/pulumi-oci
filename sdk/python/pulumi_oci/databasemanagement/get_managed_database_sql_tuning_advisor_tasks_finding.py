...
def get_managed_database_sql_tuning_advisor_tasks_finding(begin_exec_id: Optional[builtins.str] = None,
...
def get_managed_database_sql_tuning_advisor_tasks_finding_output(begin_exec_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
