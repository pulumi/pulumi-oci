...
class GetManagedDatabaseSqlTuningAdvisorTasksFindingsResult:
    ...
    def begin_exec_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "begin_exec_id")

    @property
    @pulumi.getter(name="endExecId")
    def end_exec_id(self) -> Optional[builtins.str]:
    ...
    def finding_filter(self) -> Optional[builtins.str]:
    ...
    def index_hash_filter(self) -> Optional[builtins.str]:
    ...
    def stats_hash_filter(self) -> Optional[builtins.str]:
...
def get_managed_database_sql_tuning_advisor_tasks_findings(begin_exec_id: Optional[builtins.str] = None,
                                                           end_exec_id: Optional[builtins.str] = None,
                                                           ...
                                                           finding_filter: Optional[builtins.str] = None,
                                                           index_hash_filter: Optional[builtins.str] = None,
                                                           ...
                                                           stats_hash_filter: Optional[builtins.str] = None,
    ...
    :param builtins.str begin_exec_id: The optional greater than or equal to filter on the execution ID related to a specific SQL Tuning Advisor task.
    :param builtins.str end_exec_id: The optional less than or equal to query parameter to filter on the execution ID related to a specific SQL Tuning Advisor task.
    :param builtins.str finding_filter: The filter used to display specific findings in the report.
    :param builtins.str index_hash_filter: The hash value of the index table name.
    ...
    :param builtins.str search_period: The search period during which the API will search for begin and end exec id, if not supplied. Unused if beginExecId and endExecId optional query params are both supplied.
    ...
    :param builtins.str stats_hash_filter: The hash value of the object for the statistic finding search.
    """
    __args__ = dict()
...
def get_managed_database_sql_tuning_advisor_tasks_findings_output(begin_exec_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                                  end_exec_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                                  ...
                                                                  finding_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                                  index_hash_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                                  ...
                                                                  stats_hash_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
