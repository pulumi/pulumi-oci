...
def get_managed_database_sql_tuning_advisor_tasks_recommendation(execution_id: Optional[builtins.str] = None,
...
def get_managed_database_sql_tuning_advisor_tasks_recommendation_output(execution_id: Optional[pulumi.Input[builtins.str]] = None,
