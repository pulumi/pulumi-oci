...
def get_managed_database_sql_tuning_advisor_tasks_recommendations(execution_id: Optional[str] = None,
    ...
    test_managed_database_sql_tuning_advisor_tasks_recommendations = oci.DatabaseManagement.get_managed_database_sql_tuning_advisor_tasks_recommendations(execution_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
