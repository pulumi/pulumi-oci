...
def get_managed_database_sql_tuning_advisor_tasks_sql_execution_plan(attribute: Optional[builtins.str] = None,
    ...
    :param builtins.str attribute: The attribute of the SQL execution plan.
...
def get_managed_database_sql_tuning_advisor_tasks_sql_execution_plan_output(attribute: Optional[pulumi.Input[builtins.str]] = None,
