...
class GetManagedDatabaseSqlTuningAdvisorTasksSummaryReportResult:
    ...
    def begin_exec_id_greater_than_or_equal_to(self) -> Optional[builtins.str]:
        return pulumi.get(self, "begin_exec_id_greater_than_or_equal_to")

    @property
    @pulumi.getter(name="endExecIdLessThanOrEqualTo")
    def end_exec_id_less_than_or_equal_to(self) -> Optional[builtins.str]:
...
def get_managed_database_sql_tuning_advisor_tasks_summary_report(begin_exec_id_greater_than_or_equal_to: Optional[builtins.str] = None,
                                                                 end_exec_id_less_than_or_equal_to: Optional[builtins.str] = None,
                                                                 managed_database_id: Optional[builtins.str] = None,
                                                                 opc_named_credential_id: Optional[builtins.str] = None,
                                                                 search_period: Optional[builtins.str] = None,
                                                                 sql_tuning_advisor_task_id: Optional[builtins.str] = None,
    ...
    :param builtins.str begin_exec_id_greater_than_or_equal_to: The optional greater than or equal to filter on the execution ID related to a specific SQL Tuning Advisor task. This is applicable only for Auto SQL Tuning tasks.
    :param builtins.str end_exec_id_less_than_or_equal_to: The optional less than or equal to query parameter to filter on the execution ID related to a specific SQL Tuning Advisor task. This is applicable only for Auto SQL Tuning tasks.
    ...
    :param builtins.str opc_named_credential_id: The OCID of the Named Credential.
    :param builtins.str search_period: How far back the API will search for begin and end exec id. Unused if neither exec ids nor time filter query params are supplied. This is applicable only for Auto SQL Tuning tasks.
    :param builtins.str sql_tuning_advisor_task_id: The SQL tuning task identifier. This is not the [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    :param builtins.str time_greater_than_or_equal_to: The optional greater than or equal to query parameter to filter the timestamp. This is applicable only for Auto SQL Tuning tasks.
    :param builtins.str time_less_than_or_equal_to: The optional less than or equal to query parameter to filter the timestamp. This is applicable only for Auto SQL Tuning tasks.
    """
    __args__ = dict()
...
def get_managed_database_sql_tuning_advisor_tasks_summary_report_output(begin_exec_id_greater_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                                        end_exec_id_less_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                                        managed_database_id: Optional[pulumi.Input[builtins.str]] = None,
                                                                        opc_named_credential_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                                        search_period: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                                        sql_tuning_advisor_task_id: Optional[pulumi.Input[builtins.str]] = None,
