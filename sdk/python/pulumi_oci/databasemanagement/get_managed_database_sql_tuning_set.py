...
def get_managed_database_sql_tuning_set(managed_database_id: Optional[builtins.str] = None,
    ...
    :param builtins.str name_contains: Allow searching the name of the SQL tuning set by partial matching. The search is case insensitive.
    :param builtins.str owner: The owner of the SQL tuning set.
    """
    __args__ = dict()
...
def get_managed_database_sql_tuning_set_output(managed_database_id: Optional[pulumi.Input[builtins.str]] = None,
