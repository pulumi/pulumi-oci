...
def get_managed_database_user(managed_database_id: Optional[str] = None,
    ...
    return AwaitableGetManagedDatabaseUserResult(
        all_shared=__ret__.all_shared,
        authentication=__ret__.authentication,
        common=__ret__.common,
        consumer_group=__ret__.consumer_group,
        default_collation=__ret__.default_collation,
        default_tablespace=__ret__.default_tablespace,
        editions_enabled=__ret__.editions_enabled,
        external_name=__ret__.external_name,
        external_shared=__ret__.external_shared,
        id=__ret__.id,
        implicit=__ret__.implicit,
        inherited=__ret__.inherited,
        local_temp_tablespace=__ret__.local_temp_tablespace,
        managed_database_id=__ret__.managed_database_id,
        name=__ret__.name,
        oracle_maintained=__ret__.oracle_maintained,
        password_versions=__ret__.password_versions,
        profile=__ret__.profile,
        proxy_connect=__ret__.proxy_connect,
        status=__ret__.status,
        temp_tablespace=__ret__.temp_tablespace,
        time_created=__ret__.time_created,
        time_expiring=__ret__.time_expiring,
        time_last_login=__ret__.time_last_login,
        time_locked=__ret__.time_locked,
        time_password_changed=__ret__.time_password_changed,
