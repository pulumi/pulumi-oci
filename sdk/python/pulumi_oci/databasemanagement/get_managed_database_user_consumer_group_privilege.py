...
def get_managed_database_user_consumer_group_privilege(managed_database_id: Optional[builtins.str] = None,
...
def get_managed_database_user_consumer_group_privilege_output(managed_database_id: Optional[pulumi.Input[builtins.str]] = None,
