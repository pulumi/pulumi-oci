...
def get_managed_database_user_consumer_group_privilege(managed_database_id: Optional[_builtins.str] = None,
...
def get_managed_database_user_consumer_group_privilege_output(managed_database_id: Optional[pulumi.Input[_builtins.str]] = None,
