...
def get_managed_database_user_consumer_group_privilege(managed_database_id: Optional[str] = None,
    ...
    test_managed_database_user_consumer_group_privilege = oci.DatabaseManagement.get_managed_database_user_consumer_group_privilege(managed_database_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
