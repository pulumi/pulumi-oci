...
def get_managed_database_user_data_access_container(managed_database_id: Optional[str] = None,
    ...
    test_managed_database_user_data_access_container = oci.DatabaseManagement.get_managed_database_user_data_access_container(managed_database_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
