...
def get_managed_database_user_object_privileges(filters: Optional[Sequence[pulumi.InputType['GetManagedDatabaseUserObjectPrivilegesFilterArgs']]] = None,
    ...
    test_managed_database_user_object_privileges = oci.DatabaseManagement.get_managed_database_user_object_privileges(managed_database_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetManagedDatabaseUserObjectPrivilegesResult(
        ...
        name=__ret__.name,
        object_privilege_collections=__ret__.object_privilege_collections,
