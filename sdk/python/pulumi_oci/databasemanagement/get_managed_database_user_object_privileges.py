...
def get_managed_database_user_object_privileges(filters: Optional[Sequence[Union['GetManagedDatabaseUserObjectPrivilegesFilterArgs', 'GetManagedDatabaseUserObjectPrivilegesFilterArgsDict']]] = None,
