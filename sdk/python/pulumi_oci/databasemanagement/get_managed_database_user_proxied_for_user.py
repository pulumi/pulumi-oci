...
def get_managed_database_user_proxied_for_user(managed_database_id: Optional[str] = None,
    ...
    test_managed_database_user_proxied_for_user = oci.DatabaseManagement.get_managed_database_user_proxied_for_user(managed_database_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
