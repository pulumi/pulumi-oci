...
def get_managed_database_user_proxied_for_user(managed_database_id: Optional[builtins.str] = None,
...
def get_managed_database_user_proxied_for_user_output(managed_database_id: Optional[pulumi.Input[builtins.str]] = None,
