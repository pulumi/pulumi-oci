...
def get_managed_database_user_roles_output(filters: pulumi.Input[Optional[Optional[Sequence[Union['GetManagedDatabaseUserRolesFilterArgs', 'GetManagedDatabaseUserRolesFilterArgsDict']]]]] = None,
