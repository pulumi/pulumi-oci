...
def get_managed_database_user_roles(filters: Optional[Sequence[pulumi.InputType['GetManagedDatabaseUserRolesFilterArgs']]] = None,
    ...
    test_managed_database_user_roles = oci.DatabaseManagement.get_managed_database_user_roles(managed_database_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetManagedDatabaseUserRolesResult(
        ...
        name=__ret__.name,
        role_collections=__ret__.role_collections,
