...
class GetManagedDatabasesResult:
    ...
    def external_exadata_infrastructure_id(self) -> Optional[_builtins.str]:
...
def get_managed_databases(compartment_id: Optional[_builtins.str] = None,
                          deployment_type: Optional[_builtins.str] = None,
                          external_exadata_infrastructure_id: Optional[_builtins.str] = None,
                          filters: Optional[Sequence[Union['GetManagedDatabasesFilterArgs', 'GetManagedDatabasesFilterArgsDict', 'outputs.GetManagedDatabasesFilterResult']]] = None,
    ...
    :param _builtins.str deployment_type: A filter to return Managed Databases of the specified deployment type.
    ...
    :param _builtins.str management_option: A filter to return Managed Databases with the specified management option.
...
def get_managed_databases_output(compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                                 ...
                                 filters: pulumi.Input[Optional[Optional[Sequence[Union['GetManagedDatabasesFilterArgs', 'GetManagedDatabasesFilterArgsDict', 'outputs.GetManagedDatabasesFilterResult']]]]] = None,
