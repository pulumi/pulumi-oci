...
def get_managed_databases_asm_properties(filters: Optional[Sequence[pulumi.InputType['GetManagedDatabasesAsmPropertiesFilterArgs']]] = None,
    ...
    test_managed_databases_asm_properties = oci.DatabaseManagement.get_managed_databases_asm_properties(managed_database_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
