...
def get_managed_databases_asm_property(managed_database_id: Optional[builtins.str] = None,
...
def get_managed_databases_asm_property_output(managed_database_id: Optional[pulumi.Input[builtins.str]] = None,
