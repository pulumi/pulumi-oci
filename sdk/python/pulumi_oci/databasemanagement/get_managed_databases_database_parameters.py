...
class GetManagedDatabasesDatabaseParametersResult:
    ...
    def is_allowed_values_included(self) -> Optional[builtins.bool]:
...
def get_managed_databases_database_parameters(filters: Optional[Sequence[Union['GetManagedDatabasesDatabaseParametersFilterArgs', 'GetManagedDatabasesDatabaseParametersFilterArgsDict']]] = None,
                                              is_allowed_values_included: Optional[builtins.bool] = None,
    ...
    :param builtins.bool is_allowed_values_included: When true, results include a list of valid values for parameters (if applicable).
    ...
    :param builtins.str name: A filter to return all parameters that have the text given in their names.
    :param builtins.str opc_named_credential_id: The OCID of the Named Credential.
    :param builtins.str source: The source used to list database parameters. `CURRENT` is used to get the database parameters that are currently in effect for the database instance. `SPFILE` is used to list parameters from the server parameter file. Default is `CURRENT`.
    """
    __args__ = dict()
...
def get_managed_databases_database_parameters_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetManagedDatabasesDatabaseParametersFilterArgs', 'GetManagedDatabasesDatabaseParametersFilterArgsDict']]]]] = None,
                                                     is_allowed_values_included: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
