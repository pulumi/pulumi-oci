...
def get_managed_databases_user_proxy_users(filters: Optional[Sequence[pulumi.InputType['GetManagedDatabasesUserProxyUsersFilterArgs']]] = None,
    ...
    test_managed_databases_user_proxy_users = oci.DatabaseManagement.get_managed_databases_user_proxy_users(managed_database_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetManagedDatabasesUserProxyUsersResult(
        ...
        name=__ret__.name,
        proxy_user_collections=__ret__.proxy_user_collections,
        user_name=__ret__.user_name)


@_utilities.lift_output_func(get_managed_databases_user_proxy_users)
