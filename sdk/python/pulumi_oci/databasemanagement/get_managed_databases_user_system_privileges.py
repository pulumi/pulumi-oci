...
__all__ = [
    'GetManagedDatabasesUserSystemPrivilegesResult',
    'AwaitableGetManagedDatabasesUserSystemPrivilegesResult',
    'get_managed_databases_user_system_privileges',
    'get_managed_databases_user_system_privileges_output',
]

@pulumi.output_type
class GetManagedDatabasesUserSystemPrivilegesResult:
    """
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetManagedDatabasesUserSystemPrivilegesFilterResult']]:
...
class AwaitableGetManagedDatabasesUserSystemPrivilegesResult(GetManagedDatabasesUserSystemPrivilegesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetManagedDatabasesUserSystemPrivilegesResult(
...
def get_managed_databases_user_system_privileges(filters: Optional[Sequence[Union['GetManagedDatabasesUserSystemPrivilegesFilterArgs', 'GetManagedDatabasesUserSystemPrivilegesFilterArgsDict', 'outputs.GetManagedDatabasesUserSystemPrivilegesFilterResult']]] = None,
...
def get_managed_databases_user_system_privileges_output(filters: pulumi.Input[Optional[Optional[Sequence[Union['GetManagedDatabasesUserSystemPrivilegesFilterArgs', 'GetManagedDatabasesUserSystemPrivilegesFilterArgsDict', 'outputs.GetManagedDatabasesUserSystemPrivilegesFilterResult']]]]] = None,
                                                        ...
                                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetManagedDatabasesUserSystemPrivilegesResult]:
    """
    This data source provides the list of Managed Databases User System Privileges in Oracle Cloud Infrastructure Database Management service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:DatabaseManagement/getManagedDatabasesUserSystemPrivileges:getManagedDatabasesUserSystemPrivileges', __args__, opts=opts, typ=GetManagedDatabasesUserSystemPrivilegesResult)
    return __ret__.apply(lambda __response__: GetManagedDatabasesUserSystemPrivilegesResult(
        ...
        system_privilege_collections=pulumi.get(__response__, 'system_privilege_collections'),
