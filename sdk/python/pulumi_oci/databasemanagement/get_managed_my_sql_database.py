...
class GetManagedMySqlDatabaseResult:
    ...
    def heat_wave_cluster_display_name(self) -> builtins.str:
        """
    ...
    def heat_wave_node_shape(self) -> builtins.str:
        """
    ...
    def is_heat_wave_active(self) -> builtins.bool:
        """
    ...
    def is_heat_wave_enabled(self) -> builtins.bool:
        """
    ...
    def management_state(self) -> builtins.str:
        """
    ...
    def time_created_heat_wave(self) -> builtins.str:
        """
...
def get_managed_my_sql_database(managed_my_sql_database_id: Optional[builtins.str] = None,
    ...
    :param builtins.str managed_my_sql_database_id: The OCID of ManagedMySqlDatabase.
    """
    __args__ = dict()
...
def get_managed_my_sql_database_output(managed_my_sql_database_id: Optional[pulumi.Input[builtins.str]] = None,
