...
class GetManagedMySqlDatabaseSqlDataResult:
    ...
    def filter_column(self) -> Optional[builtins.str]:
...
def get_managed_my_sql_database_sql_data(end_time: Optional[builtins.str] = None,
                                         filter_column: Optional[builtins.str] = None,
    ...
    :param builtins.str end_time: The end time of the time range to retrieve the health metrics of a Managed Database in UTC in ISO-8601 format, which is "yyyy-MM-dd'T'hh:mm:ss.sss'Z'".
    :param builtins.str filter_column: The parameter to filter results by key criteria which include :
           * AVG_TIMER_WAIT
           * SUM_TIMER_WAIT
           * COUNT_STAR
           * SUM_ERRORS
    ...
    :param builtins.str start_time: The start time of the time range to retrieve the health metrics of a Managed Database in UTC in ISO-8601 format, which is "yyyy-MM-dd'T'hh:mm:ss.sss'Z'".
    """
    __args__ = dict()
...
def get_managed_my_sql_database_sql_data_output(end_time: Optional[pulumi.Input[builtins.str]] = None,
                                                filter_column: Optional[pulumi.Input[Optional[builtins.str]]] = None,
