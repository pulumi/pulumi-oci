...
class GetManagedMySqlDatabasesResult:
    ...
    def filter_by_my_sql_database_type_param(self) -> Optional[_builtins.str]:
...
def get_managed_my_sql_databases(compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str filter_by_my_sql_database_type_param: The parameter to filter by MySQL database type. Allowed values are EXTERNAL or MDS.
    """
    __args__ = dict()
