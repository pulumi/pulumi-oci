...
class GetNamedCredentialResult:
    ...
    def associated_resource(self) -> _builtins.str:
        """
...
def get_named_credential(named_credential_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str named_credential_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the named credential.
    """
    __args__ = dict()
