...
class GetNamedCredentialsResult:
    ...
    def associated_resource(self) -> Optional[builtins.str]:
        """
...
def get_named_credentials(associated_resource: Optional[builtins.str] = None,
    ...
    :param builtins.str associated_resource: The resource associated to the named credential.
    ...
    :param builtins.str name: The name of the named credential.
    :param builtins.str scope: The scope of named credential.
    :param builtins.str type: The type of database that is associated to the named credential.
    """
    __args__ = dict()
...
def get_named_credentials_output(associated_resource: Optional[pulumi.Input[Optional[builtins.str]]] = None,
