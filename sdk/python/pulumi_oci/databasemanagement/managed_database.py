...
class _ManagedDatabaseState:
    def __init__(__self__, *,
                 ...
                 database_platform_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 management_option: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 parent_container_id: Optional[pulumi.Input[builtins.str]] = None,
                 storage_system_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] additional_details: The additional details specific to a type of database defined in `{"key": "value"}` format. Example: `{"bar-key": "value"}`
        ...
        :param pulumi.Input[builtins.str] database_platform_name: The operating system of database.
        :param pulumi.Input[builtins.str] database_status: The status of the Oracle Database. Indicates whether the status of the database is UP, DOWN, or UNKNOWN at the current time.
        ...
        :param pulumi.Input[builtins.str] managed_database_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Managed Database.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] management_option: The management option used when enabling Database Management.
        :param pulumi.Input[builtins.str] name: The name of the Managed Database.
        :param pulumi.Input[builtins.str] parent_container_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the parent Container Database if Managed Database is a Pluggable Database.
        :param pulumi.Input[builtins.str] storage_system_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the storage DB system.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the Managed Database was created.
    ...
    def database_platform_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def database_platform_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def management_option(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def management_option(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def storage_system_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def storage_system_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ManagedDatabase(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            workload_type: Optional[pulumi.Input[builtins.str]] = None) -> 'ManagedDatabase':
        """
    ...
    @property
    @pulumi.getter(name="databasePlatformName")
    def database_platform_name(self) -> pulumi.Output[builtins.str]:
        """
        The operating system of database.
        """
        return pulumi.get(self, "database_platform_name")
    ...
    @property
    @pulumi.getter(name="databaseSubType")
    def database_sub_type(self) -> pulumi.Output[builtins.str]:
        """
        The subtype of the Oracle Database. Indicates whether the database is a Container Database, Pluggable Database, Non-container Database, Autonomous Database, or Autonomous Container Database.
        """
        return pulumi.get(self, "database_sub_type")
    ...
    @property
    @pulumi.getter(name="managementOption")
    def management_option(self) -> pulumi.Output[builtins.str]:
        """
        The management option used when enabling Database Management.
        """
        return pulumi.get(self, "management_option")
    ...
    @property
    @pulumi.getter(name="storageSystemId")
    def storage_system_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the storage DB system.
        """
        return pulumi.get(self, "storage_system_id")
