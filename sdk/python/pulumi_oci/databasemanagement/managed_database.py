...
class ManagedDatabase(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            database_version: pulumi.Input[Optional[_builtins.str]] = None,
            db_system_id: pulumi.Input[Optional[_builtins.str]] = None,
            dbmgmt_feature_configs: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ManagedDatabaseDbmgmtFeatureConfigArgs', 'ManagedDatabaseDbmgmtFeatureConfigArgsDict', 'outputs.ManagedDatabaseDbmgmtFeatureConfig']]]]] = None,
            defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            deployment_type: pulumi.Input[Optional[_builtins.str]] = None,
            freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            is_cluster: pulumi.Input[Optional[_builtins.bool]] = None,
            managed_database_groups: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ManagedDatabaseManagedDatabaseGroupArgs', 'ManagedDatabaseManagedDatabaseGroupArgsDict', 'outputs.ManagedDatabaseManagedDatabaseGroup']]]]] = None,
            managed_database_id: pulumi.Input[Optional[_builtins.str]] = None,
            management_option: pulumi.Input[Optional[_builtins.str]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            parent_container_id: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] database_version: The Oracle Database version.
        :param pulumi.Input[_builtins.str] db_system_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the DB system that this Managed Database is part of.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ManagedDatabaseDbmgmtFeatureConfigArgs', 'ManagedDatabaseDbmgmtFeatureConfigArgsDict', 'outputs.ManagedDatabaseDbmgmtFeatureConfig']]]] dbmgmt_feature_configs: The list of feature configurations
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[_builtins.str] deployment_type: The infrastructure used to deploy the Oracle Database.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[_builtins.bool] is_cluster: Indicates whether the Oracle Database is part of a cluster.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ManagedDatabaseManagedDatabaseGroupArgs', 'ManagedDatabaseManagedDatabaseGroupArgsDict', 'outputs.ManagedDatabaseManagedDatabaseGroup']]]] managed_database_groups: A list of Managed Database Groups that the Managed Database belongs to.
        :param pulumi.Input[_builtins.str] managed_database_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Managed Database.
