...
class NamedCredentialArgs:
    ...
    def associated_resource(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def associated_resource(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class _NamedCredentialState:
    def __init__(__self__, *,
                 ...
                 content: pulumi.Input[Optional['NamedCredentialContentArgs']] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] description: (Updatable) The information specified by the user about the named credential.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[_builtins.str] lifecycle_details: The details of the lifecycle state.
        :param pulumi.Input[_builtins.str] name: The name of the named credential. Valid characters are uppercase or lowercase letters, numbers, and "_". The name of the named credential cannot be modified. It must be unique in the compartment and must begin with an alphabetic character.
        :param pulumi.Input[_builtins.str] scope: (Updatable) The scope of the named credential.
        :param pulumi.Input[_builtins.str] state: The current lifecycle state of the named credential.
    ...
    @_builtins.property
    @pulumi.getter
    def content(self) -> pulumi.Input[Optional['NamedCredentialContentArgs']]:
        """
        (Updatable) The details of the named credential.
        """
        return pulumi.get(self, "content")
    ...
    @content.setter
    def content(self, value: pulumi.Input[Optional['NamedCredentialContentArgs']]):
        pulumi.set(self, "content", value)
...
class NamedCredential(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None,
            type: pulumi.Input[Optional[_builtins.str]] = None) -> 'NamedCredential':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="associatedResource")
    def associated_resource(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the resource that  is associated to the named credential.
        """
        return pulumi.get(self, "associated_resource")
