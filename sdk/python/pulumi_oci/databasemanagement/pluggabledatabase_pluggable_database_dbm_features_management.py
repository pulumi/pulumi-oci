...
class PluggabledatabasePluggableDatabaseDbmFeaturesManagementArgs:
    ...
    def enable_pluggable_database_dbm_feature(self) -> pulumi.Input[_builtins.bool]:
        """
    ...
    def enable_pluggable_database_dbm_feature(self, value: pulumi.Input[_builtins.bool]):
...
class PluggabledatabasePluggableDatabaseDbmFeaturesManagement(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="enablePluggableDatabaseDbmFeature")
    def enable_pluggable_database_dbm_feature(self) -> pulumi.Output[_builtins.bool]:
        """
        (Updatable) A required field when set to `true` calls enable action and when set to `false` calls disable action.
    ...
    @_builtins.property
    @pulumi.getter(name="modifyPluggableDatabaseDbmFeature")
    def modify_pluggable_database_dbm_feature(self) -> pulumi.Output[Optional[_builtins.bool]]:
        return pulumi.get(self, "modify_pluggable_database_dbm_feature")
