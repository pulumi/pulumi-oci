...
class JobParameterFileVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_current: Return boolean true/false for the currently in-use parameter file (factory or a versioned file)
        :param pulumi.Input[_builtins.bool] is_factory: Return true/false for whether the parameter file is oracle provided (Factory)
        :param pulumi.Input[_builtins.str] kind: Indicator of Parameter File 'kind' (for an EXTRACT or a REPLICAT)
        :param pulumi.Input[_builtins.str] name: Phase name
...
class JobProgressPhaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: Phase name
        :param pulumi.Input[_builtins.int] progress: Percent progress of job phase.
        :param pulumi.Input[_builtins.str] status: Phase status
        """
...
class MigrationDataTransferMediumDetailsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: (Updatable) Name of database link from Oracle Cloud Infrastructure database to on-premise database. ODMS will create link,  if the link does not already exist.
        ...
        :param pulumi.Input[_builtins.str] region: (Updatable) AWS region code where the S3 bucket is located. Region code should match the documented available regions: https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-regions-availability-zones.html#concepts-available-regions
        :param pulumi.Input[_builtins.str] secret_access_key: (Updatable) AWS secret access key credentials Details: https://docs.aws.amazon.com/general/latest/gr/aws-sec-cred-types.html#access-keys-and-secret-access-keys
        :param pulumi.Input[_builtins.str] shared_storage_mount_target_id: (Updatable) OCID of the shared storage mount target
...
class MigrationDataTransferMediumDetailsSourceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] wallet_location: (Updatable) Directory path to Oracle Cloud Infrastructure SSL wallet location on Db server node.
        """
        pulumi.set(__self__, "kind", kind)
...
class MigrationHubDetailsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] url: (Updatable) Endpoint URL.
        :param pulumi.Input[_builtins.str] vault_id: (Updatable) The OCID of the resource being referenced.
        :param pulumi.Input[_builtins.int] acceptable_lag: (Updatable) ODMS will monitor GoldenGate end-to-end latency until the lag time is lower than the specified value in seconds.
        :param pulumi.Input[_builtins.str] compute_id: (Updatable) The OCID of the resource being referenced.
...
class MigrationHubDetailsRestAdminCredentialsArgs:
    def __init__(__self__, *,
                 ...
                 username: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] password: (Updatable) Administrator password
        :param pulumi.Input[_builtins.str] username: (Updatable) Administrator username
        """
...
class MigrationInitialLoadSettingsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] handle_grant_errors: (Updatable) The action taken in the event of errors related to GRANT or REVOKE errors.
        :param pulumi.Input['MigrationInitialLoadSettingsImportDirectoryObjectArgs'] import_directory_object: (Updatable) Directory object details, used to define either import or export directory objects in Data Pump Settings. Import directory is required for Non-Autonomous target connections. If specified for an autonomous target, it will show an error. Export directory will error if there are database link details specified.
        :param pulumi.Input[_builtins.bool] is_consistent: (Updatable) Enable (true) or disable (false) consistent data dumps by locking the instance for backup during the dump.
        :param pulumi.Input[_builtins.bool] is_ignore_existing_objects: (Updatable) Import the dump even if it contains objects that already exist in the target schema in the MySQL instance.
        :param pulumi.Input[_builtins.bool] is_tz_utc: (Updatable) Include a statement at the start of the dump to set the time zone to UTC.
        ...
        :param pulumi.Input[_builtins.str] primary_key_compatibility: (Updatable) Primary key compatibility option
    ...
    def job_mode(self) -> pulumi.Input[_builtins.str]:
        """
        (Updatable) Oracle Job Mode
        """
    ...
    @job_mode.setter
    def job_mode(self, value: pulumi.Input[_builtins.str]):
...
class MigrationInitialLoadSettingsDataPumpParametersArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] export_parallelism_degree: (Updatable) Maximum number of worker processes that can be used for a Data Pump Export job.
        :param pulumi.Input[_builtins.int] import_parallelism_degree: (Updatable) Maximum number of worker processes that can be used for a Data Pump Import job. For an Autonomous Database, ODMS will automatically query its CPU core count and set this property.
        :param pulumi.Input[_builtins.bool] is_cluster: (Updatable) Set to false to force Data Pump worker process to run on one instance.
        :param pulumi.Input[_builtins.str] table_exists_action: (Updatable) IMPORT: Specifies the action to be performed when data is loaded into a preexisting table.
        """
...
class MigrationInitialLoadSettingsMetadataRemapArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] type: (Updatable) Type of remap. Refer to [METADATA_REMAP Procedure ](https://docs.oracle.com/en/database/oracle/oracle-database/19/arpls/DBMS_DATAPUMP.html#GUID-0FC32790-91E6-4781-87A3-229DE024CB3D)
        """
...
class MigrationInitialLoadSettingsTablespaceDetailsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] extend_size_in_mbs: (Updatable) Size to extend the tablespace in MB.  Note: Only applicable if 'isBigFile' property is set to true.
        :param pulumi.Input[_builtins.bool] is_auto_create: (Updatable) Set this property to true to auto-create tablespaces in the target Database. Note: This is not applicable for Autonomous Database Serverless databases.
        :param pulumi.Input[_builtins.bool] is_big_file: (Updatable) Set this property to true to enable tablespace of the type big file.
        :param pulumi.Input[_builtins.str] remap_target: (Updatable) Name of the tablespace on the target database to which the source database tablespace is to be remapped.
        """
