...
class Connection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_connection = oci.database_migration.Connection("testConnection",
            admin_credentials=oci.database.migration.ConnectionAdminCredentialsArgs(
            ...
            vault_details=oci.database.migration.ConnectionVaultDetailsArgs(
                compartment_id=var["compartment_id"],
                key_id=oci_kms_key["test_key"]["id"],
                vault_id=oci_kms_vault["test_vault"]["id"],
            ),
            certificate_tdn=var["connection_certificate_tdn"],
            connect_descriptor=oci.database.migration.ConnectionConnectDescriptorArgs(
            ...
            private_endpoint=oci.database.migration.ConnectionPrivateEndpointArgs(
                compartment_id=var["compartment_id"],
                subnet_id=oci_core_subnet["test_subnet"]["id"],
                vcn_id=oci_core_vcn["test_vcn"]["id"],
            ),
            ssh_details=oci.database.migration.ConnectionSshDetailsArgs(
