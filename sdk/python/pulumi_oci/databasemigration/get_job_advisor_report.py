...
class GetJobAdvisorReportResult:
    ...
    def number_of_fatal(self) -> _builtins.int:
        """
    ...
    def number_of_fatal_blockers(self) -> _builtins.int:
        """
    ...
    def number_of_informational_results(self) -> _builtins.int:
        """
    ...
    def number_of_warnings(self) -> _builtins.int:
        """
...
def get_job_advisor_report_output(job_id: pulumi.Input[Optional[_builtins.str]] = None,
