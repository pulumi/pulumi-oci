...
def get_migration(migration_id: Optional[str] = None,
    ...
    test_migration = oci.DatabaseMigration.get_migration(migration_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
    ```
    ...
    return AwaitableGetMigrationResult(
        advisor_settings=__ret__.advisor_settings,
        ...
        dump_transfer_details=__ret__.dump_transfer_details,
        ...
        id=__ret__.id,
        include_objects=__ret__.include_objects,
