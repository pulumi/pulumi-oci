...
def get_migration_object_types(connection_type: Optional[builtins.str] = None,
    ...
    :param builtins.str connection_type: The connection type for migration objects.
    """
    __args__ = dict()
...
def get_migration_object_types_output(connection_type: Optional[pulumi.Input[builtins.str]] = None,
