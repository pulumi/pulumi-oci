...
class GetMigrationsResult:
    ...
    def bulk_include_exclude_data(self) -> builtins.str:
    ...
    def database_combination(self) -> builtins.str:
        """
    ...
    def executing_job_id(self) -> builtins.str:
        """
        The OCID of the resource being referenced.
        """
    ...
    def source_container_database_connection_id(self) -> builtins.str:
        """
        The OCID of the resource being referenced.
        """
    ...
    def source_database_connection_id(self) -> builtins.str:
        """
        The OCID of the resource being referenced.
        """
    ...
    def target_database_connection_id(self) -> builtins.str:
        """
        The OCID of the resource being referenced.
        """
    ...
    def time_last_migration(self) -> builtins.str:
        """
        An RFC3339 formatted datetime string such as `2016-08-25T21:10:29.600Z`.
        """
    ...
    def wait_after(self) -> builtins.str:
        """
...
def get_migrations(migration_id: Optional[builtins.str] = None,
...
def get_migrations_output(migration_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:DatabaseMigration/getMigrations:getMigrations', __args__, opts=opts, typ=GetMigrationsResult)
