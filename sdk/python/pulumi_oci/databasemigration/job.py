...
class _JobState:
    ...
    def _configure(
        ...
        if unsupported_objects is None and 'unsupportedObjects' in kwargs:
            unsupported_objects = kwargs['unsupportedObjects']
        ...
        if unsupported_objects is not None:
            _setter("unsupported_objects", unsupported_objects)
