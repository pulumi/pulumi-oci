...
class JobArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] job_id: The OCID of the job
        ...
        :param pulumi.Input[builtins.int] suspend_trigger: (Updatable) An optional property when incremented triggers Suspend. Could be set to any integer value.
...
class _JobState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] migration_id: The OCID of the Migration that this job belongs to.
        ...
        :param pulumi.Input[builtins.str] state: The current state of the migration job.
        :param pulumi.Input[builtins.int] suspend_trigger: (Updatable) An optional property when incremented triggers Suspend. Could be set to any integer value.
        ...
        :param pulumi.Input[builtins.str] time_updated: The time the Migration Job was last updated. An RFC3339 formatted datetime string
