...
class MigrationArgs:
    def __init__(__self__, *,
                 ...
                 database_combination: pulumi.Input[builtins.str],
                 source_database_connection_id: pulumi.Input[builtins.str],
                 target_database_connection_id: pulumi.Input[builtins.str],
                 ...
                 bulk_include_exclude_data: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] database_combination: (Updatable) The combination of source and target databases participating in a migration. Example: ORACLE means the migration is meant for migrating Oracle source and target databases.
        ...
        :param pulumi.Input[builtins.str] bulk_include_exclude_data: Specifies the database objects to be excluded from the migration in bulk. The definition accepts input in a CSV format, newline separated for each entry. More details can be found in the documentation.
    ...
    def database_combination(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def database_combination(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "database_combination", value)

    @property
    @pulumi.getter(name="sourceDatabaseConnectionId")
    def source_database_connection_id(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The OCID of the resource being referenced.
        """
    ...
    def source_database_connection_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "source_database_connection_id", value)

    @property
    @pulumi.getter(name="targetDatabaseConnectionId")
    def target_database_connection_id(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The OCID of the resource being referenced.
        """
    ...
    def target_database_connection_id(self, value: pulumi.Input[builtins.str]):
    ...
    def bulk_include_exclude_data(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def bulk_include_exclude_data(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def source_container_database_connection_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The OCID of the resource being referenced.
        """
...
class _MigrationState:
    def __init__(__self__, *,
                 ...
                 data_transfer_medium_details: Optional[pulumi.Input['MigrationDataTransferMediumDetailsArgs']] = None,
                 database_combination: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 exclude_objects: Optional[pulumi.Input[Sequence[pulumi.Input['MigrationExcludeObjectArgs']]]] = None,
                 executing_job_id: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 ggs_details: Optional[pulumi.Input['MigrationGgsDetailsArgs']] = None,
                 hub_details: Optional[pulumi.Input['MigrationHubDetailsArgs']] = None,
                 include_objects: Optional[pulumi.Input[Sequence[pulumi.Input['MigrationIncludeObjectArgs']]]] = None,
                 ...
                 time_last_migration: Optional[pulumi.Input[builtins.str]] = None,
                 time_updated: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None,
                 wait_after: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable.  Avoid entering confidential information.
        :param pulumi.Input[Sequence[pulumi.Input['MigrationExcludeObjectArgs']]] exclude_objects: Database objects to exclude from migration, cannot be specified alongside 'includeObjects'
        :param pulumi.Input[builtins.str] executing_job_id: The OCID of the resource being referenced.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace.  For more information, see Resource Tags. Example: {"Department": "Finance"}
        :param pulumi.Input['MigrationGgsDetailsArgs'] ggs_details: (Updatable) Optional settings for Oracle GoldenGate processes
        :param pulumi.Input['MigrationHubDetailsArgs'] hub_details: (Updatable) Details about Oracle GoldenGate Microservices.
        :param pulumi.Input[Sequence[pulumi.Input['MigrationIncludeObjectArgs']]] include_objects: Database objects to include from migration, cannot be specified alongside 'excludeObjects'
        ...
        :param pulumi.Input[builtins.str] target_database_connection_id: (Updatable) The OCID of the resource being referenced.
        :param pulumi.Input[builtins.str] time_created: An RFC3339 formatted datetime string such as `2016-08-25T21:10:29.600Z`.
        :param pulumi.Input[builtins.str] time_last_migration: An RFC3339 formatted datetime string such as `2016-08-25T21:10:29.600Z`.
        :param pulumi.Input[builtins.str] time_updated: An RFC3339 formatted datetime string such as `2016-08-25T21:10:29.600Z`.
        :param pulumi.Input[builtins.str] type: (Updatable) The type of the migration to be performed. Example: ONLINE if no downtime is preferred for a migration. This method uses Oracle GoldenGate for replication.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] wait_after: You can optionally pause a migration after a job phase. This property allows you to optionally specify the phase after which you can pause the migration.
        """
        if advanced_parameters is not None:
            pulumi.set(__self__, "advanced_parameters", advanced_parameters)
        if advisor_settings is not None:
    ...
    @property
    @pulumi.getter(name="databaseCombination")
    def database_combination(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The combination of source and target databases participating in a migration. Example: ORACLE means the migration is meant for migrating Oracle source and target databases.
        """
        return pulumi.get(self, "database_combination")
    ...
    @database_combination.setter
    def database_combination(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "database_combination", value)
    ...
    def executing_job_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def executing_job_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="sourceDatabaseConnectionId")
    def source_database_connection_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The OCID of the resource being referenced.
        """
        return pulumi.get(self, "source_database_connection_id")
    ...
    @source_database_connection_id.setter
    def source_database_connection_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_database_connection_id", value)
    ...
    @property
    @pulumi.getter(name="targetDatabaseConnectionId")
    def target_database_connection_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The OCID of the resource being referenced.
        """
        return pulumi.get(self, "target_database_connection_id")
    ...
    @target_database_connection_id.setter
    def target_database_connection_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_database_connection_id", value)
    ...
    def time_last_migration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        An RFC3339 formatted datetime string such as `2016-08-25T21:10:29.600Z`.
        """
    ...
    def time_last_migration(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def wait_after(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @wait_after.setter
    def wait_after(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Migration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            wait_after: Optional[pulumi.Input[builtins.str]] = None) -> 'Migration':
        """
    ...
    @property
    @pulumi.getter(name="bulkIncludeExcludeData")
    def bulk_include_exclude_data(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the database objects to be excluded from the migration in bulk. The definition accepts input in a CSV format, newline separated for each entry. More details can be found in the documentation.
        """
        return pulumi.get(self, "bulk_include_exclude_data")
    ...
    @property
    @pulumi.getter(name="databaseCombination")
    def database_combination(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The combination of source and target databases participating in a migration. Example: ORACLE means the migration is meant for migrating Oracle source and target databases.
        """
        return pulumi.get(self, "database_combination")
    ...
    @property
    @pulumi.getter(name="executingJobId")
    def executing_job_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the resource being referenced.
        """
        return pulumi.get(self, "executing_job_id")
    ...
    @property
    @pulumi.getter(name="sourceContainerDatabaseConnectionId")
    def source_container_database_connection_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The OCID of the resource being referenced.
        """
        return pulumi.get(self, "source_container_database_connection_id")
    ...
    @property
    @pulumi.getter(name="sourceDatabaseConnectionId")
    def source_database_connection_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The OCID of the resource being referenced.
        """
        return pulumi.get(self, "source_database_connection_id")
    ...
    @property
    @pulumi.getter(name="targetDatabaseConnectionId")
    def target_database_connection_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The OCID of the resource being referenced.
        """
        return pulumi.get(self, "target_database_connection_id")
    ...
    @property
    @pulumi.getter(name="timeLastMigration")
    def time_last_migration(self) -> pulumi.Output[builtins.str]:
        """
        An RFC3339 formatted datetime string such as `2016-08-25T21:10:29.600Z`.
        """
        return pulumi.get(self, "time_last_migration")
    ...
    @property
    @pulumi.getter(name="waitAfter")
    def wait_after(self) -> pulumi.Output[builtins.str]:
        """
        You can optionally pause a migration after a job phase. This property allows you to optionally specify the phase after which you can pause the migration.
        """
        return pulumi.get(self, "wait_after")
