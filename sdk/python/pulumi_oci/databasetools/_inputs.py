...
if not MYPY:
    class DatabaseToolsConnectionKeyStoreArgsDict(TypedDict):
        ...
        """
        key_store_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DatabaseToolsConnectionKeyStoreArgs:
    def __init__(__self__, *,
                 ...
                 key_store_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] key_store_type: (Updatable) The key store type.
        """
    ...
    def key_store_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The key store type.
        """
    ...
    def key_store_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DatabaseToolsConnectionKeyStoreKeyStoreContentArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] value_type: (Updatable) The value type of the key store content.
        :param pulumi.Input[builtins.str] secret_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the secret containing the key store.
        """
...
class DatabaseToolsConnectionKeyStoreKeyStorePasswordArgs:
    def __init__(__self__, *,
                 ...
                 secret_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] value_type: (Updatable) The value type of the key store password.
        :param pulumi.Input[builtins.str] secret_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the secret containing the key store password.
        """
        pulumi.set(__self__, "value_type", value_type)
        if secret_id is not None:
            pulumi.set(__self__, "secret_id", secret_id)
...
if not MYPY:
    class DatabaseToolsConnectionProxyClientArgsDict(TypedDict):
        proxy_authentication_type: pulumi.Input[builtins.str]
        """
...
class DatabaseToolsConnectionProxyClientArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] proxy_authentication_type: (Updatable) The proxy authentication type.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] roles: (Updatable) A list of database roles for the client. These roles are enabled if the proxy is authorized to use the roles on behalf of the client.
        :param pulumi.Input[builtins.str] user_name: (Updatable) The user name.
    ...
    def proxy_authentication_type(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The proxy authentication type.
        """
    ...
    def proxy_authentication_type(self, value: pulumi.Input[builtins.str]):
...
class DatabaseToolsConnectionProxyClientUserPasswordArgs:
    def __init__(__self__, *,
                 ...
                 value_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] secret_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the secret containing the user password.
        :param pulumi.Input[builtins.str] value_type: (Updatable) The value type of the user password.
        """
        pulumi.set(__self__, "secret_id", secret_id)
        pulumi.set(__self__, "value_type", value_type)
...
class DatabaseToolsConnectionRelatedResourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] entity_type: (Updatable) The resource entity type.
        :param pulumi.Input[builtins.str] identifier: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the related resource.
        """
...
class DatabaseToolsPrivateEndpointReverseConnectionConfigurationReverseConnectionsSourceIpArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] source_ip: The IP address in the customer's VCN to be used as the source IP for reverse connection packets traveling from the customer's VCN to the service's VCN.
        """
