...
class DatabaseToolsConnectionArgs:
    def __init__(__self__, *,
                 ...
                 advanced_properties: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 ...
                 runtime_support: Optional[pulumi.Input[builtins.str]] = None,
                 url: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a DatabaseToolsConnection resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the Database Tools connection.
        ...
        :param pulumi.Input[builtins.str] type: (Updatable) The DatabaseToolsConnection type.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] advanced_properties: (Updatable) The advanced connection properties key-value pair (e.g., `oracle.net.ssl_server_dn_match`).
        :param pulumi.Input[builtins.str] connection_string: (Updatable) The connect descriptor or Easy Connect Naming method use to connect to the database.
        ...
        :param pulumi.Input[builtins.str] private_endpoint_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Database Tools private endpoint used to access the database in the customer VCN.
        ...
        :param pulumi.Input[builtins.str] runtime_support: Specifies whether this connection is supported by the Database Tools Runtime.
        :param pulumi.Input[builtins.str] url: (Updatable) The JDBC URL used to connect to the Generic JDBC database system.
        """
    ...
    def advanced_properties(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def advanced_properties(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
    ...
    def runtime_support(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def runtime_support(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DatabaseToolsConnectionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[Sequence[pulumi.Input['DatabaseToolsConnectionKeyStoreArgs']]] key_stores: (Updatable) Oracle wallet or Java Keystores containing trusted certificates for authenticating the server's public certificate and the client private key and associated certificates required for client authentication.
        :param pulumi.Input[builtins.str] lifecycle_details: A message describing the current state in more detail. For example, this message can be used to provide actionable information for a resource in the Failed state.
        :param pulumi.Input[Sequence[pulumi.Input['DatabaseToolsConnectionLockArgs']]] locks: Locks associated with this resource.
        :param pulumi.Input[builtins.str] private_endpoint_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Database Tools private endpoint used to access the database in the customer VCN.
        :param pulumi.Input['DatabaseToolsConnectionProxyClientArgs'] proxy_client: (Updatable) The proxy client information.
        :param pulumi.Input['DatabaseToolsConnectionRelatedResourceArgs'] related_resource: (Updatable) The related resource
        :param pulumi.Input[builtins.str] runtime_support: Specifies whether this connection is supported by the Database Tools Runtime.
        :param pulumi.Input[builtins.str] state: The current state of the Database Tools connection.
        ...
        :param pulumi.Input[builtins.str] time_created: The time the Database Tools connection was created. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The time the DatabaseToolsConnection was updated. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] type: (Updatable) The DatabaseToolsConnection type.
        :param pulumi.Input[builtins.str] url: (Updatable) The JDBC URL used to connect to the Generic JDBC database system.
        :param pulumi.Input[builtins.str] user_name: (Updatable) The database user name.
        :param pulumi.Input['DatabaseToolsConnectionUserPasswordArgs'] user_password: (Updatable) The user password.
...
class DatabaseToolsConnection(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] url: (Updatable) The JDBC URL used to connect to the Generic JDBC database system.
        :param pulumi.Input[builtins.str] user_name: (Updatable) The database user name.
        :param pulumi.Input[Union['DatabaseToolsConnectionUserPasswordArgs', 'DatabaseToolsConnectionUserPasswordArgsDict']] user_password: (Updatable) The user password.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    @property
    @pulumi.getter(name="advancedProperties")
    def advanced_properties(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        (Updatable) The advanced connection properties key-value pair (e.g., `oracle.net.ssl_server_dn_match`).
        """
        return pulumi.get(self, "advanced_properties")
    ...
    @property
    @pulumi.getter(name="runtimeSupport")
    def runtime_support(self) -> pulumi.Output[builtins.str]:
        """
        Specifies whether this connection is supported by the Database Tools Runtime.
        """
        return pulumi.get(self, "runtime_support")
