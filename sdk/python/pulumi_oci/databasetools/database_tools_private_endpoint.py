...
class DatabaseToolsPrivateEndpointArgs:
    def __init__(__self__, *,
                 ...
                 endpoint_service_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the Database Tools private endpoint.
        ...
        :param pulumi.Input[builtins.str] endpoint_service_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `DatabaseToolsEndpointService`.
        :param pulumi.Input[builtins.str] subnet_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet that the private endpoint belongs to.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) A description of the Database Tools private endpoint.
        ...
        :param pulumi.Input[builtins.str] private_endpoint_ip: The private IP address that represents the access point for the associated endpoint service.
        """
    ...
    def endpoint_service_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def endpoint_service_id(self, value: pulumi.Input[builtins.str]):
...
class _DatabaseToolsPrivateEndpointState:
    def __init__(__self__, *,
                 additional_fqdns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 endpoint_fqdn: Optional[pulumi.Input[builtins.str]] = None,
                 endpoint_service_id: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 lifecycle_details: Optional[pulumi.Input[builtins.str]] = None,
                 locks: Optional[pulumi.Input[Sequence[pulumi.Input['DatabaseToolsPrivateEndpointLockArgs']]]] = None,
                 nsg_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 private_endpoint_ip: Optional[pulumi.Input[builtins.str]] = None,
                 private_endpoint_vnic_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] additional_fqdns: A list of additional FQDNs that can be also be used for the private endpoint.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the Database Tools private endpoint.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] description: (Updatable) A description of the Database Tools private endpoint.
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[builtins.str] endpoint_fqdn: Then FQDN to use for the private endpoint.
        :param pulumi.Input[builtins.str] endpoint_service_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `DatabaseToolsEndpointService`.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] nsg_ids: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the network security groups that the private endpoint's VNIC belongs to.  For more information about NSGs, see [NetworkSecurityGroup](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/20160918/NetworkSecurityGroup/).
        :param pulumi.Input[builtins.str] private_endpoint_ip: The private IP address that represents the access point for the associated endpoint service.
        :param pulumi.Input[builtins.str] private_endpoint_vnic_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the private endpoint's VNIC.
        ...
        :param pulumi.Input[builtins.str] state: The current state of the Database Tools private endpoint.
        :param pulumi.Input[builtins.str] subnet_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet that the private endpoint belongs to.
        ...
        :param pulumi.Input[builtins.str] time_created: The time the Database Tools private endpoint was created. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.str] time_updated: The time the Database Tools private endpoint was updated. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.str] vcn_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VCN that the private endpoint belongs to.
        """
    ...
    def additional_fqdns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def additional_fqdns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def endpoint_fqdn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def endpoint_fqdn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "endpoint_fqdn", value)

    @property
    @pulumi.getter(name="endpointServiceId")
    def endpoint_service_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `DatabaseToolsEndpointService`.
        """
        return pulumi.get(self, "endpoint_service_id")
    ...
    @endpoint_service_id.setter
    def endpoint_service_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "endpoint_service_id", value)
    ...
    def private_endpoint_vnic_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def private_endpoint_vnic_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DatabaseToolsPrivateEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            vcn_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DatabaseToolsPrivateEndpoint':
        """
    ...
    @property
    @pulumi.getter(name="additionalFqdns")
    def additional_fqdns(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        A list of additional FQDNs that can be also be used for the private endpoint.
        """
        return pulumi.get(self, "additional_fqdns")
    ...
    @property
    @pulumi.getter(name="endpointFqdn")
    def endpoint_fqdn(self) -> pulumi.Output[builtins.str]:
        """
        Then FQDN to use for the private endpoint.
        """
        return pulumi.get(self, "endpoint_fqdn")
    ...
    @property
    @pulumi.getter(name="endpointServiceId")
    def endpoint_service_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `DatabaseToolsEndpointService`.
        """
        return pulumi.get(self, "endpoint_service_id")
    ...
    @property
    @pulumi.getter(name="privateEndpointIp")
    def private_endpoint_ip(self) -> pulumi.Output[builtins.str]:
        """
        The private IP address that represents the access point for the associated endpoint service.
        """
        return pulumi.get(self, "private_endpoint_ip")
    ...
    @property
    @pulumi.getter(name="privateEndpointVnicId")
    def private_endpoint_vnic_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the private endpoint's VNIC.
        """
        return pulumi.get(self, "private_endpoint_vnic_id")
