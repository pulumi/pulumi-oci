...
class GetDatabaseToolsConnectionResult:
    ...
    def database_tools_connection_id(self) -> builtins.str:
...
def get_database_tools_connection(database_tools_connection_id: Optional[builtins.str] = None,
    ...
    :param builtins.str database_tools_connection_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a Database Tools connection.
    """
    __args__ = dict()
...
def get_database_tools_connection_output(database_tools_connection_id: Optional[pulumi.Input[builtins.str]] = None,
