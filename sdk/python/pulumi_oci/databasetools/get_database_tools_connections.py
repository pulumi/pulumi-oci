...
class GetDatabaseToolsConnectionsResult:
    ...
    def related_resource_identifier(self) -> Optional[builtins.str]:
        return pulumi.get(self, "related_resource_identifier")

    @property
    @pulumi.getter(name="runtimeSupports")
    def runtime_supports(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_database_tools_connections(compartment_id: Optional[builtins.str] = None,
                                   ...
                                   related_resource_identifier: Optional[builtins.str] = None,
                                   runtime_supports: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.str related_resource_identifier: A filter to return only resources associated to the related resource identifier OCID passed in the query string.
    :param Sequence[builtins.str] runtime_supports: A filter to return only resources with one of the specified runtimeSupport values.
    :param builtins.str state: A filter to return only resources their `lifecycleState` matches the specified `lifecycleState`.
    :param Sequence[builtins.str] types: A filter to return only resources their type matches the specified type.
    """
    __args__ = dict()
...
def get_database_tools_connections_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                          ...
                                          related_resource_identifier: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          runtime_supports: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
