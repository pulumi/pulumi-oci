...
class GetDatabaseToolsEndpointServiceResult:
    ...
    def database_tools_endpoint_service_id(self) -> builtins.str:
...
def get_database_tools_endpoint_service(database_tools_endpoint_service_id: Optional[builtins.str] = None,
    ...
    :param builtins.str database_tools_endpoint_service_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a Database Tools Endpoint Service.
    """
    __args__ = dict()
...
def get_database_tools_endpoint_service_output(database_tools_endpoint_service_id: Optional[pulumi.Input[builtins.str]] = None,
