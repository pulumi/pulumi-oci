...
def get_database_tools_endpoint_services(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str name: A filter to return only resources that match the entire specified name.
...
def get_database_tools_endpoint_services_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
