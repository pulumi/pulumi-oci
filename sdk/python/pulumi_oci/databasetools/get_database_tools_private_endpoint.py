...
class GetDatabaseToolsPrivateEndpointResult:
    ...
    def additional_fqdns(self) -> Sequence[builtins.str]:
        """
    ...
    def database_tools_private_endpoint_id(self) -> builtins.str:
    ...
    def private_endpoint_vnic_id(self) -> builtins.str:
        """
...
def get_database_tools_private_endpoint(database_tools_private_endpoint_id: Optional[builtins.str] = None,
    ...
    :param builtins.str database_tools_private_endpoint_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a Database Tools private endpoint.
    """
    __args__ = dict()
...
def get_database_tools_private_endpoint_output(database_tools_private_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
