...
class GetDatabaseToolsPrivateEndpointResult:
    ...
    def database_tools_private_endpoint_id(self) -> _builtins.str:
...
def get_database_tools_private_endpoint(database_tools_private_endpoint_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str database_tools_private_endpoint_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a Database Tools private endpoint.
    """
    __args__ = dict()
