...
class GetDatabaseToolsPrivateEndpointsResult:
    ...
    def endpoint_service_id(self) -> Optional[builtins.str]:
        """
...
def get_database_tools_private_endpoints(compartment_id: Optional[builtins.str] = None,
                                         display_name: Optional[builtins.str] = None,
                                         endpoint_service_id: Optional[builtins.str] = None,
    ...
    :param builtins.str display_name: A filter to return only resources that match the entire specified display name.
    :param builtins.str endpoint_service_id: A filter to return only resources their `endpointServiceId` matches the specified `endpointServiceId`.
    :param builtins.str state: A filter to return only resources their `lifecycleState` matches the specified `lifecycleState`.
    :param builtins.str subnet_id: A filter to return only resources their `subnetId` matches the specified `subnetId`.
    """
    __args__ = dict()
...
def get_database_tools_private_endpoints_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                                display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                endpoint_service_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
