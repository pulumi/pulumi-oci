...
__all__ = [
    'GetRuntimeDatabaseToolsConnectionCredentialResult',
    'AwaitableGetRuntimeDatabaseToolsConnectionCredentialResult',
    'get_runtime_database_tools_connection_credential',
    'get_runtime_database_tools_connection_credential_output',
]

@pulumi.output_type
class GetRuntimeDatabaseToolsConnectionCredentialResult:
    """
    A collection of values returned by getRuntimeDatabaseToolsConnectionCredential.
    """
    def __init__(__self__, credential_key=None, database_tools_connection_id=None, enabled=None, id=None, key=None, key_type=None, owner=None, password=None, related_resources=None, type=None, user_name=None, windows_domain=None):
    ...
    def related_resources(self) -> Sequence['outputs.GetRuntimeDatabaseToolsConnectionCredentialRelatedResourceResult']:
        """
...
class AwaitableGetRuntimeDatabaseToolsConnectionCredentialResult(GetRuntimeDatabaseToolsConnectionCredentialResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRuntimeDatabaseToolsConnectionCredentialResult(
...
def get_runtime_database_tools_connection_credential(credential_key: Optional[_builtins.str] = None,
                                                     database_tools_connection_id: Optional[_builtins.str] = None,
                                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRuntimeDatabaseToolsConnectionCredentialResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('oci:DatabaseTools/getRuntimeDatabaseToolsConnectionCredential:getRuntimeDatabaseToolsConnectionCredential', __args__, opts=opts, typ=GetRuntimeDatabaseToolsConnectionCredentialResult).value

    return AwaitableGetRuntimeDatabaseToolsConnectionCredentialResult(
...
def get_runtime_database_tools_connection_credential_output(credential_key: pulumi.Input[Optional[_builtins.str]] = None,
                                                            database_tools_connection_id: pulumi.Input[Optional[_builtins.str]] = None,
                                                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetRuntimeDatabaseToolsConnectionCredentialResult]:
    """
    This data source provides details about a specific Database Tools Connection Credential resource in Oracle Cloud Infrastructure Database Tools Runtime service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:DatabaseTools/getRuntimeDatabaseToolsConnectionCredential:getRuntimeDatabaseToolsConnectionCredential', __args__, opts=opts, typ=GetRuntimeDatabaseToolsConnectionCredentialResult)
    return __ret__.apply(lambda __response__: GetRuntimeDatabaseToolsConnectionCredentialResult(
