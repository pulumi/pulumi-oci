...
class DatabaseToolsConnectionKeyStore(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str key_store_type: (Updatable) The key store type.
        """
    ...
    def key_store_type(self) -> Optional[builtins.str]:
        """
...
class DatabaseToolsConnectionKeyStoreKeyStoreContent(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str value_type: (Updatable) The value type of the key store content.
        :param builtins.str secret_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the secret containing the key store.
        """
...
class DatabaseToolsConnectionKeyStoreKeyStorePassword(dict):
    ...
    def __init__(__self__, *,
                 ...
                 secret_id: Optional[builtins.str] = None):
        """
        :param builtins.str value_type: (Updatable) The value type of the key store password.
        :param builtins.str secret_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the secret containing the key store password.
        """
        pulumi.set(__self__, "value_type", value_type)
        if secret_id is not None:
            pulumi.set(__self__, "secret_id", secret_id)
...
class DatabaseToolsConnectionProxyClient(dict):
    ...
    def __init__(__self__, *,
                 proxy_authentication_type: builtins.str,
        ...
        """
        :param builtins.str proxy_authentication_type: (Updatable) The proxy authentication type.
        :param Sequence[builtins.str] roles: (Updatable) A list of database roles for the client. These roles are enabled if the proxy is authorized to use the roles on behalf of the client.
        :param builtins.str user_name: (Updatable) The user name.
    ...
    def proxy_authentication_type(self) -> builtins.str:
        """
...
class DatabaseToolsConnectionProxyClientUserPassword(dict):
    ...
    def __init__(__self__, *,
                 ...
                 value_type: builtins.str):
        """
        :param builtins.str secret_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the secret containing the user password.
        :param builtins.str value_type: (Updatable) The value type of the user password.
        """
        pulumi.set(__self__, "secret_id", secret_id)
        pulumi.set(__self__, "value_type", value_type)
...
class DatabaseToolsConnectionRelatedResource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str entity_type: (Updatable) The resource entity type.
        :param builtins.str identifier: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the related resource.
        """
...
class DatabaseToolsPrivateEndpointReverseConnectionConfigurationReverseConnectionsSourceIp(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str source_ip: The IP address in the customer's VCN to be used as the source IP for reverse connection packets traveling from the customer's VCN to the service's VCN.
        """
...
class GetDatabaseToolsConnectionKeyStoreResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str key_store_type: The key store type.
        """
    ...
    @property
    @pulumi.getter(name="keyStoreType")
    def key_store_type(self) -> builtins.str:
        """
        The key store type.
        """
        return pulumi.get(self, "key_store_type")
...
class GetDatabaseToolsConnectionKeyStoreKeyStoreContentResult(dict):
    def __init__(__self__, *,
                 ...
                 value_type: builtins.str):
        """
        :param builtins.str secret_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the secret containing the user password.
        :param builtins.str value_type: The value type of the user password.
        """
        pulumi.set(__self__, "secret_id", secret_id)
        pulumi.set(__self__, "value_type", value_type)
...
class GetDatabaseToolsConnectionLockResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str message: A message added by the creator of the lock. This is typically used to give an indication of why the resource is locked.
        :param builtins.str related_resource_id: The id of the resource that is locking this resource. Indicates that deleting this resource will remove the lock.
        :param builtins.str time_created: The time the Database Tools connection was created. An RFC3339 formatted datetime string.
        :param builtins.str type: The Database Tools connection type.
        """
        pulumi.set(__self__, "message", message)
        pulumi.set(__self__, "related_resource_id", related_resource_id)
        pulumi.set(__self__, "time_created", time_created)
...
class GetDatabaseToolsConnectionProxyClientResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str proxy_authentication_type: The proxy authentication type.
        :param Sequence[builtins.str] roles: A list of database roles for the client. These roles are enabled if the proxy is authorized to use the roles on behalf of the client.
        :param builtins.str user_name: The database user name.
...
class GetDatabaseToolsConnectionRelatedResourceResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str entity_type: The resource entity type.
        :param builtins.str identifier: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the related resource.
        """
        pulumi.set(__self__, "entity_type", entity_type)
        pulumi.set(__self__, "identifier", identifier)
...
class GetDatabaseToolsConnectionsDatabaseToolsConnectionCollectionItemResult(dict):
    def __init__(__self__, *,
                 advanced_properties: Mapping[str, builtins.str],
        ...
        """
        :param Mapping[str, builtins.str] advanced_properties: The advanced connection properties key-value pair (for example, `oracle.net.ssl_server_dn_match`).
        :param builtins.str compartment_id: The ID of the compartment in which to list resources.
        :param builtins.str connection_string: The connect descriptor or Easy Connect Naming method used to connect to the database.
        ...
        :param builtins.str id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Database Tools connection.
        ...
        :param builtins.str lifecycle_details: A message describing the current state in more detail. For example, this message can be used to provide actionable information for a resource in the Failed state.
        ...
        :param builtins.str private_endpoint_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Database Tools private endpoint used to access the database in the customer VCN.
        ...
        :param builtins.str runtime_support: A filter to return only resources with one of the specified runtimeSupport values.
        ...
        :param builtins.str time_created: The time the Database Tools connection was created. An RFC3339 formatted datetime string.
        :param builtins.str time_updated: The time the DatabaseToolsConnection was updated. An RFC3339 formatted datetime string.
        :param builtins.str type: A filter to return only resources their type matches the specified type.
        :param builtins.str url: The JDBC URL used to connect to the Generic JDBC database system.
        :param builtins.str user_name: The database user name.
    ...
    def advanced_properties(self) -> Mapping[str, builtins.str]:
        """
    ...
    def runtime_support(self) -> builtins.str:
        """
...
class GetDatabaseToolsEndpointServicesDatabaseToolsEndpointServiceCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str compartment_id: The ID of the compartment in which to list resources.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str description: A description of the Database Tools Endpoint Service.
        :param builtins.str display_name: A filter to return only resources that match the entire specified display name.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Database Tools Endpoint Service.
        ...
        :param builtins.str state: A filter to return only resources their `lifecycleState` matches the specified `lifecycleState`.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The time the Database Tools Endpoint Service was created. An RFC3339 formatted datetime string
        :param builtins.str time_updated: The time the Database Tools Endpoint Service was updated. An RFC3339 formatted datetime string
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
...
class GetDatabaseToolsPrivateEndpointLockResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str message: A message added by the creator of the lock. This is typically used to give an indication of why the resource is locked.
        :param builtins.str related_resource_id: The id of the resource that is locking this resource. Indicates that deleting this resource will remove the lock.
        :param builtins.str time_created: The time the Database Tools private endpoint was created. An RFC3339 formatted datetime string
        :param builtins.str type: Type of the lock.
        """
        pulumi.set(__self__, "message", message)
        pulumi.set(__self__, "related_resource_id", related_resource_id)
...
class GetDatabaseToolsPrivateEndpointsDatabaseToolsPrivateEndpointCollectionItemResult(dict):
    def __init__(__self__, *,
                 additional_fqdns: Sequence[builtins.str],
                 compartment_id: builtins.str,
                 defined_tags: Mapping[str, builtins.str],
                 description: builtins.str,
                 display_name: builtins.str,
                 ...
                 private_endpoint_vnic_id: builtins.str,
                 ...
                 vcn_id: builtins.str):
        """
        :param Sequence[builtins.str] additional_fqdns: A list of additional FQDNs that can be also be used for the private endpoint.
        :param builtins.str compartment_id: The ID of the compartment in which to list resources.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str description: A description of the Database Tools private endpoint.
        :param builtins.str display_name: A filter to return only resources that match the entire specified display name.
        :param builtins.str endpoint_fqdn: Then FQDN to use for the private endpoint.
        ...
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Database Tools private endpoint.
        :param builtins.str lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        ...
        :param Sequence[builtins.str] nsg_ids: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the network security groups that the private endpoint's VNIC belongs to.  For more information about NSGs, see [NetworkSecurityGroup](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/20160918/NetworkSecurityGroup/).
        :param builtins.str private_endpoint_ip: The private IP address that represents the access point for the associated endpoint service.
        :param builtins.str private_endpoint_vnic_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the private endpoint's VNIC.
        ...
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The time the Database Tools private endpoint was created. An RFC3339 formatted datetime string
        :param builtins.str time_updated: The time the Database Tools private endpoint was updated. An RFC3339 formatted datetime string
        :param builtins.str vcn_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VCN that the private endpoint belongs to.
        """
