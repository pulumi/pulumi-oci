...
class CatalogLockArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] time_created: The time the data catalog was created. An [RFC3339](https://tools.ietf.org/html/rfc3339) formatted datetime string.
...
class MetastoreLockArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] message: A message added by the creator of the lock. This is typically used to give an indication of why the resource is locked.
        :param pulumi.Input[builtins.str] related_resource_id: The id of the resource that is locking this resource. Indicates that deleting this resource will remove the lock.
        :param pulumi.Input[builtins.str] time_created: Time at which the metastore was created. An [RFC3339](https://tools.ietf.org/html/rfc3339) formatted datetime string.
        :param pulumi.Input[builtins.str] type: Type of the lock.
        """
        if message is not None:
            pulumi.set(__self__, "message", message)
