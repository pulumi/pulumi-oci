...
class CatalogArgs:
    def __init__(__self__, *,
                 ...
                 attached_catalog_private_endpoints: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] attached_catalog_private_endpoints: (Updatable) The list of private reverse connection endpoints attached to the catalog
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) Data catalog identifier.
    ...
    def attached_catalog_private_endpoints(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def attached_catalog_private_endpoints(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _CatalogState:
    def __init__(__self__, *,
                 ...
                 number_of_objects: Optional[pulumi.Input[builtins.int]] = None,
                 service_api_url: Optional[pulumi.Input[builtins.str]] = None,
                 service_console_url: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) Data catalog identifier.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type, or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.str] lifecycle_details: An message describing the current state in more detail. For example, it can be used to provide actionable information for a resource in 'Failed' state.
        :param pulumi.Input[Sequence[pulumi.Input['CatalogLockArgs']]] locks: Locks associated with this resource.
        :param pulumi.Input[builtins.int] number_of_objects: The number of data objects added to the data catalog. Please see the data catalog documentation for further information on how this is calculated.
        :param pulumi.Input[builtins.str] service_api_url: The REST front endpoint URL to the data catalog instance.
        :param pulumi.Input[builtins.str] service_console_url: The console front endpoint URL to the data catalog instance.
        :param pulumi.Input[builtins.str] state: The current state of the data catalog resource.
        ...
        :param pulumi.Input[builtins.str] time_updated: The time the data catalog was updated. An [RFC3339](https://tools.ietf.org/html/rfc3339) formatted datetime string.
        """
        if attached_catalog_private_endpoints is not None:
            pulumi.set(__self__, "attached_catalog_private_endpoints", attached_catalog_private_endpoints)
    ...
    def number_of_objects(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def number_of_objects(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "number_of_objects", value)

    @property
    @pulumi.getter(name="serviceApiUrl")
    def service_api_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def service_api_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_api_url", value)

    @property
    @pulumi.getter(name="serviceConsoleUrl")
    def service_console_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def service_console_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Catalog(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="attachedCatalogPrivateEndpoints")
    def attached_catalog_private_endpoints(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) The list of private reverse connection endpoints attached to the catalog
    ...
    @property
    @pulumi.getter(name="numberOfObjects")
    def number_of_objects(self) -> pulumi.Output[builtins.int]:
        """
        The number of data objects added to the data catalog. Please see the data catalog documentation for further information on how this is calculated.
        """
        return pulumi.get(self, "number_of_objects")
    ...
    @property
    @pulumi.getter(name="serviceApiUrl")
    def service_api_url(self) -> pulumi.Output[builtins.str]:
        """
        The REST front endpoint URL to the data catalog instance.
        """
        return pulumi.get(self, "service_api_url")
    ...
    @property
    @pulumi.getter(name="serviceConsoleUrl")
    def service_console_url(self) -> pulumi.Output[builtins.str]:
        """
        The console front endpoint URL to the data catalog instance.
        """
        return pulumi.get(self, "service_console_url")
