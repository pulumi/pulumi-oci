...
class CatalogArgs:
    def __init__(__self__, *,
                 ...
                 attached_catalog_private_endpoints: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] display_name: (Updatable) Data catalog identifier.
    ...
    def attached_catalog_private_endpoints(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
...
class _CatalogState:
    def __init__(__self__, *,
                 ...
                 locks: pulumi.Input[Optional[Sequence[pulumi.Input['CatalogLockArgs']]]] = None,
                 number_of_objects: pulumi.Input[Optional[_builtins.int]] = None,
                 service_api_url: pulumi.Input[Optional[_builtins.str]] = None,
                 service_console_url: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] display_name: (Updatable) Data catalog identifier.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type, or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[_builtins.str] lifecycle_details: An message describing the current state in more detail. For example, it can be used to provide actionable information for a resource in 'Failed' state.
        :param pulumi.Input[Sequence[pulumi.Input['CatalogLockArgs']]] locks: Locks associated with this resource.
        :param pulumi.Input[_builtins.int] number_of_objects: The number of data objects added to the data catalog. Please see the data catalog documentation for further information on how this is calculated.
        :param pulumi.Input[_builtins.str] service_api_url: The REST front endpoint URL to the data catalog instance.
        :param pulumi.Input[_builtins.str] service_console_url: The console front endpoint URL to the data catalog instance.
        :param pulumi.Input[_builtins.str] state: The current state of the data catalog resource.
        ...
        :param pulumi.Input[_builtins.str] time_updated: The time the data catalog was updated. An [RFC3339](https://tools.ietf.org/html/rfc3339) formatted datetime string.
        """
        if attached_catalog_private_endpoints is not None:
            pulumi.set(__self__, "attached_catalog_private_endpoints", attached_catalog_private_endpoints)
    ...
    @_builtins.property
    @pulumi.getter
    def locks(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['CatalogLockArgs']]]]:
        """
    ...
    @locks.setter
    def locks(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['CatalogLockArgs']]]]):
        pulumi.set(self, "locks", value)

    @_builtins.property
    @pulumi.getter(name="numberOfObjects")
    def number_of_objects(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def number_of_objects(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "number_of_objects", value)

    @_builtins.property
    @pulumi.getter(name="serviceApiUrl")
    def service_api_url(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def service_api_url(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "service_api_url", value)

    @_builtins.property
    @pulumi.getter(name="serviceConsoleUrl")
    def service_console_url(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def service_console_url(self, value: pulumi.Input[Optional[_builtins.str]]):
...
@pulumi.type_token("oci:DataCatalog/catalog:Catalog")
class Catalog(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            lifecycle_details: pulumi.Input[Optional[_builtins.str]] = None,
            locks: pulumi.Input[Optional[Sequence[pulumi.Input[Union['CatalogLockArgs', 'CatalogLockArgsDict', 'outputs.CatalogLock']]]]] = None,
            number_of_objects: pulumi.Input[Optional[_builtins.int]] = None,
            service_api_url: pulumi.Input[Optional[_builtins.str]] = None,
            service_console_url: pulumi.Input[Optional[_builtins.str]] = None,
            state: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type, or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[_builtins.str] lifecycle_details: An message describing the current state in more detail. For example, it can be used to provide actionable information for a resource in 'Failed' state.
        :param pulumi.Input[Sequence[pulumi.Input[Union['CatalogLockArgs', 'CatalogLockArgsDict', 'outputs.CatalogLock']]]] locks: Locks associated with this resource.
        :param pulumi.Input[_builtins.int] number_of_objects: The number of data objects added to the data catalog. Please see the data catalog documentation for further information on how this is calculated.
        :param pulumi.Input[_builtins.str] service_api_url: The REST front endpoint URL to the data catalog instance.
        :param pulumi.Input[_builtins.str] service_console_url: The console front endpoint URL to the data catalog instance.
        :param pulumi.Input[_builtins.str] state: The current state of the data catalog resource.
    ...
    @_builtins.property
    @pulumi.getter(name="numberOfObjects")
    def number_of_objects(self) -> pulumi.Output[_builtins.int]:
        """
        The number of data objects added to the data catalog. Please see the data catalog documentation for further information on how this is calculated.
        """
        return pulumi.get(self, "number_of_objects")
    ...
    @_builtins.property
    @pulumi.getter(name="serviceApiUrl")
    def service_api_url(self) -> pulumi.Output[_builtins.str]:
        """
        The REST front endpoint URL to the data catalog instance.
        """
        return pulumi.get(self, "service_api_url")
