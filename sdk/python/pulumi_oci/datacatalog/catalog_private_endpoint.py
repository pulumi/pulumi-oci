...
class _CatalogPrivateEndpointState:
    def __init__(__self__, *,
                 attached_catalogs: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 dns_zones: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 lifecycle_details: pulumi.Input[Optional[_builtins.str]] = None,
                 locks: pulumi.Input[Optional[Sequence[pulumi.Input['CatalogPrivateEndpointLockArgs']]]] = None,
                 security_attributes: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
    ...
    def attached_catalogs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def attached_catalogs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
    ...
    @_builtins.property
    @pulumi.getter(name="dnsZones")
    def dns_zones(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        (Updatable) List of DNS zones to be used by the data assets to be harvested. Example: custpvtsubnet.oraclevcn.com for data asset: db.custpvtsubnet.oraclevcn.com
        """
        return pulumi.get(self, "dns_zones")
    ...
    @dns_zones.setter
    def dns_zones(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "dns_zones", value)
    ...
    @_builtins.property
    @pulumi.getter
    def locks(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['CatalogPrivateEndpointLockArgs']]]]:
        """
    ...
    @locks.setter
    def locks(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['CatalogPrivateEndpointLockArgs']]]]):
...
class CatalogPrivateEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            lifecycle_details: pulumi.Input[Optional[_builtins.str]] = None,
            locks: pulumi.Input[Optional[Sequence[pulumi.Input[Union['CatalogPrivateEndpointLockArgs', 'CatalogPrivateEndpointLockArgsDict', 'outputs.CatalogPrivateEndpointLock']]]]] = None,
            security_attributes: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            state: pulumi.Input[Optional[_builtins.str]] = None,
            subnet_id: pulumi.Input[Optional[_builtins.str]] = None,
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None) -> 'CatalogPrivateEndpoint':
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type, or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[_builtins.str] lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in 'Failed' state.
        :param pulumi.Input[Sequence[pulumi.Input[Union['CatalogPrivateEndpointLockArgs', 'CatalogPrivateEndpointLockArgsDict', 'outputs.CatalogPrivateEndpointLock']]]] locks: Locks associated with this resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] security_attributes: (Updatable) Security attributes for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Oracle-ZPR": {"MaxEgressCount": {"value": "42", "mode": "enforce"}}}`
        :param pulumi.Input[_builtins.str] state: The current state of the private endpoint resource.
        :param pulumi.Input[_builtins.str] subnet_id: The OCID of subnet to which the reverse connection is to be created
    ...
    @_builtins.property
    @pulumi.getter(name="attachedCatalogs")
    def attached_catalogs(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        The list of catalogs using the private reverse connection endpoint
        """
        return pulumi.get(self, "attached_catalogs")
