...
class DataAssetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type_key: The key of the data asset type. This can be obtained via the '/types' endpoint.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] description: (Updatable) Detailed description of the data asset.
        """
...
class _DataAssetState:
    def __init__(__self__, *,
                 ...
                 time_harvested: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] catalog_id: Unique catalog identifier.
        :param pulumi.Input[builtins.str] created_by_id: OCID of the user who created the data asset.
        :param pulumi.Input[builtins.str] description: (Updatable) Detailed description of the data asset.
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly display name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[builtins.str] external_key: External URI that can be used to reference the object. Format will differ based on the type of object.
        :param pulumi.Input[builtins.str] key: Unique data asset key that is immutable.
        :param pulumi.Input[builtins.str] lifecycle_details: A message describing the current state in more detail. An object not in ACTIVE state may have functional limitations, see service documentation for details.
        :param pulumi.Input[builtins.str] state: The current state of the data asset.
        :param pulumi.Input[builtins.str] time_created: The date and time the data asset was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339). Example: `2019-03-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_harvested: The last time that a harvest was performed on the data asset. An [RFC3339](https://tools.ietf.org/html/rfc3339) formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The last time that any change was made to the data asset. An [RFC3339](https://tools.ietf.org/html/rfc3339) formatted datetime string.
        :param pulumi.Input[builtins.str] type_key: The key of the data asset type. This can be obtained via the '/types' endpoint.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] updated_by_id: OCID of the user who last modified the data asset.
        :param pulumi.Input[builtins.str] uri: URI to the data asset instance in the API.
        """
    ...
    def time_harvested(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_harvested(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DataAsset(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type_key: Optional[pulumi.Input[builtins.str]] = None,
            updated_by_id: Optional[pulumi.Input[builtins.str]] = None,
            uri: Optional[pulumi.Input[builtins.str]] = None) -> 'DataAsset':
        """
    ...
    @property
    @pulumi.getter(name="timeHarvested")
    def time_harvested(self) -> pulumi.Output[builtins.str]:
        """
        The last time that a harvest was performed on the data asset. An [RFC3339](https://tools.ietf.org/html/rfc3339) formatted datetime string.
        """
        return pulumi.get(self, "time_harvested")
