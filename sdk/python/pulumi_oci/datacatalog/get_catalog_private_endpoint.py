...
class GetCatalogPrivateEndpointResult:
    ...
    def catalog_private_endpoint_id(self) -> _builtins.str:
...
def get_catalog_private_endpoint(catalog_private_endpoint_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str catalog_private_endpoint_id: Unique private reverse connection identifier.
    """
    __args__ = dict()
