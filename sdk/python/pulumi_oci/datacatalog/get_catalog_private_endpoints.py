...
def get_catalog_private_endpoints(compartment_id: Optional[str] = None,
    ...
    test_catalog_private_endpoints = oci.DataCatalog.get_catalog_private_endpoints(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetCatalogPrivateEndpointsResult(
        catalog_private_endpoints=__ret__.catalog_private_endpoints,
