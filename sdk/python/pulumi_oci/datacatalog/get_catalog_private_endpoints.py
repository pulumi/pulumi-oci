...
def get_catalog_private_endpoints(compartment_id: Optional[builtins.str] = None,
...
def get_catalog_private_endpoints_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
