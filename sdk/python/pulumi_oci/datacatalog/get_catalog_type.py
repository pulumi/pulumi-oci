...
class GetCatalogTypeResult:
    ...
    def external_type_name(self) -> builtins.str:
        """
    ...
    def is_approved(self) -> builtins.bool:
        """
    ...
    def is_internal(self) -> builtins.bool:
        """
...
def get_catalog_type(catalog_id: Optional[builtins.str] = None,
                     fields: Optional[Sequence[builtins.str]] = None,
                     type_key: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] fields: Specifies the fields to return in a type response.
    :param builtins.str type_key: Unique type key.
    """
    __args__ = dict()
...
def get_catalog_type_output(catalog_id: Optional[pulumi.Input[builtins.str]] = None,
