...
class GetConnectionResult:
    ...
    def connection_key(self) -> builtins.str:
    ...
    def enc_properties(self) -> Mapping[str, builtins.str]:
...
def get_connection(catalog_id: Optional[builtins.str] = None,
                   connection_key: Optional[builtins.str] = None,
    ...
    :param builtins.str connection_key: Unique connection key.
    :param builtins.str data_asset_key: Unique data asset key.
    :param Sequence[builtins.str] fields: Specifies the fields to return in a connection response.
    """
    __args__ = dict()
...
def get_connection_output(catalog_id: Optional[pulumi.Input[builtins.str]] = None,
