...
class GetConnectionsResult:
    ...
    def created_by_id(self) -> Optional[_builtins.str]:
        """
    ...
    def external_key(self) -> Optional[_builtins.str]:
        """
    ...
    def updated_by_id(self) -> Optional[_builtins.str]:
        """
...
def get_connections(catalog_id: Optional[_builtins.str] = None,
                    created_by_id: Optional[_builtins.str] = None,
                    data_asset_key: Optional[_builtins.str] = None,
                    display_name: Optional[_builtins.str] = None,
                    display_name_contains: Optional[_builtins.str] = None,
                    external_key: Optional[_builtins.str] = None,
                    ...
                    updated_by_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str display_name_contains: A filter to return only resources that match display name pattern given. The match is not case sensitive. For Example : /folders?displayNameContains=Cu.* The above would match all folders with display name that starts with "Cu" or has the pattern "Cu" anywhere in between.
    :param _builtins.str external_key: Unique external identifier of this resource in the external source system.
    :param Sequence[_builtins.str] fields: Specifies the fields to return in a connection summary response.
...
def get_connections_output(catalog_id: Optional[pulumi.Input[_builtins.str]] = None,
                           created_by_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           ...
                           external_key: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           ...
                           time_created: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           time_status_updated: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           time_updated: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                           updated_by_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
