...
class GetDataAssetsResult:
    ...
    def type_key(self) -> Optional[builtins.str]:
        """
...
def get_data_assets(catalog_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] fields: Specifies the fields to return in a data asset summary response.
...
def get_data_assets_output(catalog_id: Optional[pulumi.Input[builtins.str]] = None,
                           ...
                           type_key: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDataAssetsResult]:
    """
    This data source provides the list of Data Assets in Oracle Cloud Infrastructure Data Catalog service.
