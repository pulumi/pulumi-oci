...
def get_metastores(compartment_id: Optional[str] = None,
    ...
    test_metastores = oci.DataCatalog.get_metastores(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
