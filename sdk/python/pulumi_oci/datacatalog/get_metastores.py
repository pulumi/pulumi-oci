...
def get_metastores(compartment_id: Optional[_builtins.str] = None,
                   display_name: Optional[_builtins.str] = None,
                   filters: Optional[Sequence[Union['GetMetastoresFilterArgs', 'GetMetastoresFilterArgsDict', 'outputs.GetMetastoresFilterResult']]] = None,
...
def get_metastores_output(compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                          ...
                          filters: pulumi.Input[Optional[Optional[Sequence[Union['GetMetastoresFilterArgs', 'GetMetastoresFilterArgsDict', 'outputs.GetMetastoresFilterResult']]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:DataCatalog/getMetastores:getMetastores', __args__, opts=opts, typ=GetMetastoresResult)
    return __ret__.apply(lambda __response__: GetMetastoresResult(
        compartment_id=pulumi.get(__response__, 'compartment_id'),
        display_name=pulumi.get(__response__, 'display_name'),
        filters=pulumi.get(__response__, 'filters'),
        id=pulumi.get(__response__, 'id'),
        metastores=pulumi.get(__response__, 'metastores'),
