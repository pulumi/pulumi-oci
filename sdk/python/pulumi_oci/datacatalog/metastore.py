...
class MetastoreArgs:
    def __init__(__self__, *,
                 ...
                 default_external_table_location: pulumi.Input[_builtins.str],
                 default_managed_table_location: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] display_name: (Updatable) Mutable name of the metastore.
    ...
    def default_external_table_location(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def default_external_table_location(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "default_external_table_location", value)

    @_builtins.property
    @pulumi.getter(name="defaultManagedTableLocation")
    def default_managed_table_location(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def default_managed_table_location(self, value: pulumi.Input[_builtins.str]):
...
class _MetastoreState:
    def __init__(__self__, *,
                 ...
                 default_external_table_location: pulumi.Input[Optional[_builtins.str]] = None,
                 default_managed_table_location: pulumi.Input[Optional[_builtins.str]] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 lifecycle_details: pulumi.Input[Optional[_builtins.str]] = None,
                 locks: pulumi.Input[Optional[Sequence[pulumi.Input['MetastoreLockArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] state: The current state of the metastore.
        ...
        :param pulumi.Input[_builtins.str] time_updated: Time at which the metastore was last modified. An [RFC3339](https://tools.ietf.org/html/rfc3339) formatted datetime string.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="defaultExternalTableLocation")
    def default_external_table_location(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Location under which external tables will be created by default. This references Object Storage using an HDFS URI format. Example: oci://bucket@namespace/sub-dir/
        """
        return pulumi.get(self, "default_external_table_location")
    ...
    @default_external_table_location.setter
    def default_external_table_location(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "default_external_table_location", value)

    @_builtins.property
    @pulumi.getter(name="defaultManagedTableLocation")
    def default_managed_table_location(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Location under which managed tables will be created by default. This references Object Storage using an HDFS URI format. Example: oci://bucket@namespace/sub-dir/
        """
        return pulumi.get(self, "default_managed_table_location")
    ...
    @default_managed_table_location.setter
    def default_managed_table_location(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "default_managed_table_location", value)
    ...
    @_builtins.property
    @pulumi.getter
    def locks(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MetastoreLockArgs']]]]:
        """
    ...
    @locks.setter
    def locks(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MetastoreLockArgs']]]]):
...
class Metastore(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            lifecycle_details: pulumi.Input[Optional[_builtins.str]] = None,
            locks: pulumi.Input[Optional[Sequence[pulumi.Input[Union['MetastoreLockArgs', 'MetastoreLockArgsDict', 'outputs.MetastoreLock']]]]] = None,
            state: pulumi.Input[Optional[_builtins.str]] = None,
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None) -> 'Metastore':
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        :param pulumi.Input[Sequence[pulumi.Input[Union['MetastoreLockArgs', 'MetastoreLockArgsDict', 'outputs.MetastoreLock']]]] locks: Locks associated with this resource.
        :param pulumi.Input[_builtins.str] state: The current state of the metastore.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). System tags can be viewed by users, but can only be created by the system.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param pulumi.Input[_builtins.str] time_created: Time at which the metastore was created. An [RFC3339](https://tools.ietf.org/html/rfc3339) formatted datetime string.
        :param pulumi.Input[_builtins.str] time_updated: Time at which the metastore was last modified. An [RFC3339](https://tools.ietf.org/html/rfc3339) formatted datetime string.
    ...
    @_builtins.property
    @pulumi.getter(name="defaultExternalTableLocation")
    def default_external_table_location(self) -> pulumi.Output[_builtins.str]:
        """
        Location under which external tables will be created by default. This references Object Storage using an HDFS URI format. Example: oci://bucket@namespace/sub-dir/
        """
        return pulumi.get(self, "default_external_table_location")
    ...
    @_builtins.property
    @pulumi.getter(name="defaultManagedTableLocation")
    def default_managed_table_location(self) -> pulumi.Output[_builtins.str]:
        """
        Location under which managed tables will be created by default. This references Object Storage using an HDFS URI format. Example: oci://bucket@namespace/sub-dir/
        """
        return pulumi.get(self, "default_managed_table_location")
