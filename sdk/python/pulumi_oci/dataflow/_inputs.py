...
if not MYPY:
    class ApplicationApplicationLogConfigArgsDict(TypedDict):
        ...
        """
        log_id: pulumi.Input[builtins.str]
        """
...
class ApplicationApplicationLogConfigArgs:
    def __init__(__self__, *,
                 ...
                 log_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] log_group_id: (Updatable) The log group id for where log objects will be for Data Flow Runs.
        :param pulumi.Input[builtins.str] log_id: (Updatable) The log id of the log object the Application Logs of Data Flow Run will be shipped to.
        """
    ...
    def log_group_id(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The log group id for where log objects will be for Data Flow Runs.
        """
    ...
    def log_id(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The log id of the log object the Application Logs of Data Flow Run will be shipped to.
        """
    ...
    @log_id.setter
    def log_id(self, value: pulumi.Input[builtins.str]):
...
class ApplicationDriverShapeConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.float] memory_in_gbs: (Updatable) The amount of memory used for the driver or executors.
        :param pulumi.Input[builtins.float] ocpus: (Updatable) The total number of OCPUs used for the driver or executors. See [here](https://docs.cloud.oracle.com/en-us/iaas/api/#/en/iaas/20160918/Shape/) for details.
        """
...
class ApplicationParameterArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: (Updatable) The name of the parameter.  It must be a string of one or more word characters (a-z, A-Z, 0-9, _). Examples: "iterations", "input_file"
        :param pulumi.Input[builtins.str] value: (Updatable) The value of the parameter. It must be a string of 0 or more characters of any kind. Examples: "" (empty string), "10", "mydata.xml", "${x}"
        """
...
class InvokeRunApplicationLogConfigArgs:
    def __init__(__self__, *,
                 ...
                 log_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] log_group_id: The log group id for where log objects will be for Data Flow Runs.
        :param pulumi.Input[builtins.str] log_id: The log id of the log object the Application Logs of Data Flow Run will be shipped to.
        """
        pulumi.set(__self__, "log_group_id", log_group_id)
        pulumi.set(__self__, "log_id", log_id)
...
class InvokeRunDriverShapeConfigArgs:
    def __init__(__self__, *,
                 ...
                 ocpus: Optional[pulumi.Input[builtins.float]] = None):
        """
        :param pulumi.Input[builtins.float] memory_in_gbs: The amount of memory used for the driver or executors.
        :param pulumi.Input[builtins.float] ocpus: The total number of OCPUs used for the driver or executors. See [here](https://docs.cloud.oracle.com/en-us/iaas/api/#/en/iaas/20160918/Shape/) for details.
        """
        if memory_in_gbs is not None:
            pulumi.set(__self__, "memory_in_gbs", memory_in_gbs)
        if ocpus is not None:
...
class InvokeRunParameterArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: The name of the parameter.  It must be a string of one or more word characters (a-z, A-Z, 0-9, _). Examples: "iterations", "input_file"
        :param pulumi.Input[builtins.str] value: The value of the parameter. It must be a string of 0 or more characters of any kind. Examples: "" (empty string), "10", "mydata.xml", "${x}"
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class PoolConfigurationArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] max: (Updatable) Maximum number of compute instances in the pool for a given compute shape.
        :param pulumi.Input[builtins.int] min: (Updatable) Minimum number of compute instances in the pool for a given compute shape.
        :param pulumi.Input[builtins.str] shape: (Updatable) The compute shape of the resources you would like to provision.
...
if not MYPY:
    class PoolPoolMetricArgsDict(TypedDict):
        active_runs_count: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        time_last_metrics_updated: NotRequired[pulumi.Input[builtins.str]]
        """
        The last time the mertics were updated for this.
        """
        time_last_started: NotRequired[pulumi.Input[builtins.str]]
        """
        The last time this pool was started.
        """
        time_last_stopped: NotRequired[pulumi.Input[builtins.str]]
        """
        The last time this pool was stopped.
        """
        time_last_used: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PoolPoolMetricArgs:
    def __init__(__self__, *,
                 active_runs_count: Optional[pulumi.Input[builtins.str]] = None,
                 actively_used_node_counts: Optional[pulumi.Input[Sequence[pulumi.Input['PoolPoolMetricActivelyUsedNodeCountArgs']]]] = None,
                 time_last_metrics_updated: Optional[pulumi.Input[builtins.str]] = None,
                 time_last_started: Optional[pulumi.Input[builtins.str]] = None,
                 time_last_stopped: Optional[pulumi.Input[builtins.str]] = None,
                 time_last_used: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] active_runs_count: The number of runs that are currently running that are using this pool.
        ...
        :param pulumi.Input[builtins.str] time_last_metrics_updated: The last time the mertics were updated for this.
        :param pulumi.Input[builtins.str] time_last_started: The last time this pool was started.
        :param pulumi.Input[builtins.str] time_last_stopped: The last time this pool was stopped.
        :param pulumi.Input[builtins.str] time_last_used: The last time a run used this pool.
        """
    ...
    def active_runs_count(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The number of runs that are currently running that are using this pool.
        """
    ...
    def active_runs_count(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_last_metrics_updated(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The last time the mertics were updated for this.
        """
    ...
    def time_last_metrics_updated(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_last_metrics_updated", value)

    @property
    @pulumi.getter(name="timeLastStarted")
    def time_last_started(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The last time this pool was started.
        """
    ...
    def time_last_started(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_last_started", value)

    @property
    @pulumi.getter(name="timeLastStopped")
    def time_last_stopped(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The last time this pool was stopped.
        """
    ...
    def time_last_stopped(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_last_stopped", value)

    @property
    @pulumi.getter(name="timeLastUsed")
    def time_last_used(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The last time a run used this pool.
        """
    ...
    def time_last_used(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_last_used", value)


if not MYPY:
    class PoolPoolMetricActivelyUsedNodeCountArgsDict(TypedDict):
        logical_shape: NotRequired[pulumi.Input[builtins.str]]
        """
        The compute shape of the nodes that the count is for.
        """
        pool_count: NotRequired[pulumi.Input[builtins.int]]
        """
...
class PoolPoolMetricActivelyUsedNodeCountArgs:
    def __init__(__self__, *,
                 logical_shape: Optional[pulumi.Input[builtins.str]] = None,
                 pool_count: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] logical_shape: The compute shape of the nodes that the count is for.
        :param pulumi.Input[builtins.int] pool_count: The node count of this compute shape.
        """
    ...
    def logical_shape(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The compute shape of the nodes that the count is for.
        """
    ...
    def logical_shape(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class PoolScheduleArgsDict(TypedDict):
        ...
        """
        stop_time: NotRequired[pulumi.Input[builtins.int]]
        """
...
class PoolScheduleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] day_of_week: (Updatable) Day of the week SUN-SAT
        :param pulumi.Input[builtins.int] start_time: (Updatable) Hour of the day to start or stop pool.
        :param pulumi.Input[builtins.int] stop_time: (Updatable) Hour of the day to stop the pool.
        """
...
class PrivateEndpointScanDetailArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] fqdn: (Updatable) A fully-qualified domain name (FQDN).
        :param pulumi.Input[builtins.str] port: (Updatable) The port number of the FQDN
        """
        if fqdn is not None:
...
if not MYPY:
    class RunStatementOutputArgsDict(TypedDict):
        ...
        """
        error_name: NotRequired[pulumi.Input[builtins.str]]
        """
        The name of the error in the statement output.
        """
        error_value: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        tracebacks: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class RunStatementOutputArgs:
    def __init__(__self__, *,
                 ...
                 error_name: Optional[pulumi.Input[builtins.str]] = None,
                 error_value: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 tracebacks: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] error_name: The name of the error in the statement output.
        :param pulumi.Input[builtins.str] error_value: The value of the error in the statement output.
        :param pulumi.Input[builtins.str] status: Status of the statement output.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tracebacks: The traceback of the statement output.
        """
    ...
    def error_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the error in the statement output.
        """
    ...
    @error_name.setter
    def error_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "error_name", value)

    @property
    @pulumi.getter(name="errorValue")
    def error_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The value of the error in the statement output.
        """
    ...
    @error_value.setter
    def error_value(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def tracebacks(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The traceback of the statement output.
        """
    ...
    @tracebacks.setter
    def tracebacks(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class RunStatementOutputDataArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: The type of the `StatementOutputData` like `TEXT_PLAIN`, `TEXT_HTML` or `IMAGE_PNG`.
        :param pulumi.Input[builtins.str] value: The statement code execution output in html format.
        """
        if type is not None:
...
if not MYPY:
    class SqlEndpointNetworkConfigurationArgsDict(TypedDict):
        ...
        """
        host_name_prefix: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        public_endpoint_ip: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        The VCN Subnet OCID.
        """
        vcn_id: NotRequired[pulumi.Input[builtins.str]]
        """
        The VCN OCID.
        """
elif False:
...
class SqlEndpointNetworkConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] vcn_id: The VCN OCID.
        """
    ...
    def host_name_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The host name prefix.
        """
    ...
    def private_endpoint_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Ip Address of private endpoint
        """
    ...
    def public_endpoint_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Ip Address of public endpoint
        """
    ...
    def public_endpoint_ip(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class SqlEndpointNetworkConfigurationAccessControlRuleArgsDict(TypedDict):
        ip_notation: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        vcn_ips: NotRequired[pulumi.Input[builtins.str]]
        """
...
class SqlEndpointNetworkConfigurationAccessControlRuleArgs:
    def __init__(__self__, *,
                 ip_notation: Optional[pulumi.Input[builtins.str]] = None,
                 value: Optional[pulumi.Input[builtins.str]] = None,
                 vcn_ips: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] ip_notation: The type of IP notation.
        :param pulumi.Input[builtins.str] value: The associated value of the selected IP notation.
        :param pulumi.Input[builtins.str] vcn_ips: A comma-separated IP or CIDR address for VCN OCID IP notation selection.
        """
    ...
    def ip_notation(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of IP notation.
        """
    ...
    @ip_notation.setter
    def ip_notation(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def vcn_ips(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A comma-separated IP or CIDR address for VCN OCID IP notation selection.
        """
    ...
    @vcn_ips.setter
    def vcn_ips(self, value: Optional[pulumi.Input[builtins.str]]):
