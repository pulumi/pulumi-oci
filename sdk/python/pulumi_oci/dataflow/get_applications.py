...
def get_applications(compartment_id: Optional[str] = None,
    ...
    test_applications = oci.DataFlow.get_applications(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        ...
        spark_version=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
    ```
