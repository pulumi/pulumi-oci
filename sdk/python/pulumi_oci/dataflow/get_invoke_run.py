...
class GetInvokeRunResult:
    ...
    def application_log_configs(self) -> Optional[Sequence['outputs.GetInvokeRunApplicationLogConfigResult']]:
    ...
    def driver_shape_configs(self) -> Optional[Sequence['outputs.GetInvokeRunDriverShapeConfigResult']]:
    ...
    def executor_shape_configs(self) -> Optional[Sequence['outputs.GetInvokeRunExecutorShapeConfigResult']]:
    ...
    @property
    @pulumi.getter
    def parameters(self) -> Optional[Sequence['outputs.GetInvokeRunParameterResult']]:
