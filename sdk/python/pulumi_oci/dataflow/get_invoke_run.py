...
def get_invoke_run(run_id: Optional[str] = None,
    ...
    return AwaitableGetInvokeRunResult(
        ...
        application_log_configs=__ret__.application_log_configs,
        archive_uri=__ret__.archive_uri,
        arguments=__ret__.arguments,
        asynchronous=__ret__.asynchronous,
        class_name=__ret__.class_name,
        compartment_id=__ret__.compartment_id,
        configuration=__ret__.configuration,
        data_read_in_bytes=__ret__.data_read_in_bytes,
        data_written_in_bytes=__ret__.data_written_in_bytes,
        ...
        private_endpoint_nsg_ids=__ret__.private_endpoint_nsg_ids,
        private_endpoint_subnet_id=__ret__.private_endpoint_subnet_id,
        run_duration_in_milliseconds=__ret__.run_duration_in_milliseconds,
        run_id=__ret__.run_id,
        spark_version=__ret__.spark_version,
        state=__ret__.state,
        time_created=__ret__.time_created,
        time_updated=__ret__.time_updated,
        total_ocpu=__ret__.total_ocpu,
        type=__ret__.type,
