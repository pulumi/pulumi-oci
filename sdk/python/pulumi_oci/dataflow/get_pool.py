...
def get_pool(pool_id: Optional[builtins.str] = None,
    ...
    :param builtins.str pool_id: The unique ID for a pool.
    """
    __args__ = dict()
...
def get_pool_output(pool_id: Optional[pulumi.Input[builtins.str]] = None,
