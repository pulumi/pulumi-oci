...
def get_run_log(base64_encode_content: Optional[_builtins.bool] = None,
...
def get_run_log_output(base64_encode_content: Optional[pulumi.Input[Optional[_builtins.bool]]] = None,
