...
def get_run_log(base64_encode_content: Optional[builtins.bool] = None,
    ...
    :param builtins.str name: The name of the log. Avoid entering confidential information.
...
def get_run_log_output(base64_encode_content: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
