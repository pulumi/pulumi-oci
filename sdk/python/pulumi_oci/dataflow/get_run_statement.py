...
class GetRunStatementResult:
    ...
    def statement_id(self) -> _builtins.str:
...
def get_run_statement(run_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str statement_id: The unique ID for the statement.
    """
    __args__ = dict()
