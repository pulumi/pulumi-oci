...
def get_run_statement(run_id: Optional[builtins.str] = None,
                      statement_id: Optional[builtins.str] = None,
    ...
    :param builtins.str statement_id: The unique ID for the statement.
    """
    __args__ = dict()
...
def get_run_statement_output(run_id: Optional[pulumi.Input[builtins.str]] = None,
