...
class GetSqlEndpointResult:
    ...
    def sql_endpoint_id(self) -> _builtins.str:
...
def get_sql_endpoint(sql_endpoint_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str sql_endpoint_id: The unique id of the SQL Endpoint.
    """
    __args__ = dict()
...
def get_sql_endpoint_output(sql_endpoint_id: Optional[pulumi.Input[_builtins.str]] = None,
