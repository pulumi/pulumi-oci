...
def get_sql_endpoint(sql_endpoint_id: Optional[builtins.str] = None,
    ...
    :param builtins.str sql_endpoint_id: The unique id of the SQL Endpoint.
    """
    __args__ = dict()
...
def get_sql_endpoint_output(sql_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
