...
def get_sql_endpoint(sql_endpoint_id: Optional[str] = None,
    ...
    return AwaitableGetSqlEndpointResult(
        ...
        id=__ret__.id,
        jdbc_endpoint_url=__ret__.jdbc_endpoint_url,
        lake_id=__ret__.lake_id,
        last_accepted_request_token=__ret__.last_accepted_request_token,
        max_executor_count=__ret__.max_executor_count,
        metastore_id=__ret__.metastore_id,
        min_executor_count=__ret__.min_executor_count,
        network_configurations=__ret__.network_configurations,
        spark_advanced_configurations=__ret__.spark_advanced_configurations,
        sql_endpoint_id=__ret__.sql_endpoint_id,
        sql_endpoint_version=__ret__.sql_endpoint_version,
        state=__ret__.state,
        state_message=__ret__.state_message,
        system_tags=__ret__.system_tags,
        time_created=__ret__.time_created,
        time_updated=__ret__.time_updated,
        warehouse_bucket_uri=__ret__.warehouse_bucket_uri)
