...
class RunStatementArgs:
    def __init__(__self__, *,
                 ...
                 run_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a RunStatement resource.
        :param pulumi.Input[builtins.str] code: The statement code to execute. Example: `println(sc.version)`
        :param pulumi.Input[builtins.str] run_id: The unique ID for the run 
    ...
    def run_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @run_id.setter
    def run_id(self, value: pulumi.Input[builtins.str]):
...
class _RunStatementState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.float] progress: The execution progress.
        :param pulumi.Input[builtins.str] run_id: The unique ID for the run 
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The current state of this statement.
        :param pulumi.Input[builtins.str] time_completed: The date and time a statement execution was completed, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2022-05-31T21:10:29.600Z`
...
class RunStatement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_completed: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'RunStatement':
        """
