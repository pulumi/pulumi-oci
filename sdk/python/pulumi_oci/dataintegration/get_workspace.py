...
class GetWorkspaceResult:
    ...
    def dns_server_zone(self) -> builtins.str:
        """
    ...
    def endpoint_compartment_id(self) -> builtins.str:
    ...
    def is_force_operation(self) -> builtins.bool:
        return pulumi.get(self, "is_force_operation")

    @property
    @pulumi.getter(name="isPrivateNetworkEnabled")
    def is_private_network_enabled(self) -> builtins.bool:
        """
    ...
    def quiesce_timeout(self) -> builtins.int:
        return pulumi.get(self, "quiesce_timeout")

    @property
    @pulumi.getter(name="registryCompartmentId")
    def registry_compartment_id(self) -> builtins.str:
