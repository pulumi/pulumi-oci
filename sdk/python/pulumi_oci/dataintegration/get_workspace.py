...
class GetWorkspaceResult:
    ...
    def dns_server_zone(self) -> _builtins.str:
        """
    ...
    def endpoint_compartment_id(self) -> _builtins.str:
    ...
    def is_force_operation(self) -> _builtins.bool:
        return pulumi.get(self, "is_force_operation")

    @_builtins.property
    @pulumi.getter(name="isPrivateNetworkEnabled")
    def is_private_network_enabled(self) -> _builtins.bool:
        """
    ...
    def quiesce_timeout(self) -> _builtins.int:
        return pulumi.get(self, "quiesce_timeout")

    @_builtins.property
    @pulumi.getter(name="registryCompartmentId")
    def registry_compartment_id(self) -> _builtins.str:
