...
class GetWorkspaceApplicationPatchResult:
    ...
    def patch_key(self) -> builtins.str:
    ...
    def patch_status(self) -> builtins.str:
        """
...
def get_workspace_application_patch(application_key: Optional[builtins.str] = None,
                                    patch_key: Optional[builtins.str] = None,
    ...
    :param builtins.str patch_key: The patch key.
...
def get_workspace_application_patch_output(application_key: Optional[pulumi.Input[builtins.str]] = None,
                                           patch_key: Optional[pulumi.Input[builtins.str]] = None,
