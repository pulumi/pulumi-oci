...
class GetWorkspaceApplicationPatchResult:
    ...
    def patch_key(self) -> _builtins.str:
...
def get_workspace_application_patch(application_key: Optional[_builtins.str] = None,
                                    patch_key: Optional[_builtins.str] = None,
    ...
    :param _builtins.str patch_key: The patch key.
