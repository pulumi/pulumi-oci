...
def get_workspace_application_patches(application_key: Optional[builtins.str] = None,
...
def get_workspace_application_patches_output(application_key: Optional[pulumi.Input[builtins.str]] = None,
