...
class GetWorkspaceApplicationScheduleResult:
    ...
    def is_daylight_adjustment_enabled(self) -> builtins.bool:
        """
    ...
    def schedule_key(self) -> builtins.str:
...
def get_workspace_application_schedule(application_key: Optional[builtins.str] = None,
                                       schedule_key: Optional[builtins.str] = None,
    ...
    :param builtins.str schedule_key: Schedule Key
...
def get_workspace_application_schedule_output(application_key: Optional[pulumi.Input[builtins.str]] = None,
                                              schedule_key: Optional[pulumi.Input[builtins.str]] = None,
