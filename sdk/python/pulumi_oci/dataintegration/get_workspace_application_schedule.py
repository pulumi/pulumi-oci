...
class GetWorkspaceApplicationScheduleResult:
    ...
    def is_daylight_adjustment_enabled(self) -> _builtins.bool:
        """
    ...
    def schedule_key(self) -> _builtins.str:
...
def get_workspace_application_schedule(application_key: Optional[_builtins.str] = None,
                                       schedule_key: Optional[_builtins.str] = None,
    ...
    :param _builtins.str schedule_key: Schedule Key
