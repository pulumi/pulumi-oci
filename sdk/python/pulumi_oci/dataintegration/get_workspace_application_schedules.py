...
def get_workspace_application_schedules(application_key: Optional[builtins.str] = None,
...
def get_workspace_application_schedules_output(application_key: Optional[pulumi.Input[builtins.str]] = None,
