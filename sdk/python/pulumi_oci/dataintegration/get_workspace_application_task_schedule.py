...
class GetWorkspaceApplicationTaskScheduleResult:
    ...
    def config_provider_delegate(self) -> builtins.str:
    ...
    def end_time_millis(self) -> builtins.str:
        """
    ...
    def expected_duration(self) -> builtins.float:
        """
    ...
    def expected_duration_unit(self) -> builtins.str:
        """
    ...
    def is_backfill_enabled(self) -> builtins.bool:
        """
    ...
    def is_concurrent_allowed(self) -> builtins.bool:
        """
    ...
    def next_run_time_millis(self) -> builtins.str:
    ...
    def object_status(self) -> builtins.int:
        """
    ...
    def retry_attempts(self) -> builtins.int:
        """
    ...
    def retry_delay(self) -> builtins.float:
        """
    ...
    def retry_delay_unit(self) -> builtins.str:
        """
    ...
    def start_time_millis(self) -> builtins.str:
        """
    ...
    def task_schedule_key(self) -> builtins.str:
...
def get_workspace_application_task_schedule(application_key: Optional[builtins.str] = None,
                                            task_schedule_key: Optional[builtins.str] = None,
    ...
    :param builtins.str application_key: The application key.
    :param builtins.str task_schedule_key: TaskSchedule Key
...
def get_workspace_application_task_schedule_output(application_key: Optional[pulumi.Input[builtins.str]] = None,
                                                   task_schedule_key: Optional[pulumi.Input[builtins.str]] = None,
