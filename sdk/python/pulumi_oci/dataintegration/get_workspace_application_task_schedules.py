...
def get_workspace_application_task_schedules(application_key: Optional[builtins.str] = None,
    ...
    :param builtins.bool is_enabled: This filter parameter can be used to filter task schedule by its state.
...
def get_workspace_application_task_schedules_output(application_key: Optional[pulumi.Input[builtins.str]] = None,
                                                    ...
                                                    is_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
