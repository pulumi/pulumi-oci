...
def get_workspace_applications(fields: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] identifiers: Used to filter by the identifier of the published object.
...
def get_workspace_applications_output(fields: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
