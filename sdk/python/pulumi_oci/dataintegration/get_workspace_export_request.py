...
class GetWorkspaceExportRequestResult:
    ...
    def are_references_included(self) -> builtins.bool:
        """
    ...
    def export_request_key(self) -> builtins.str:
    ...
    def is_object_overwrite_enabled(self) -> builtins.bool:
        """
    ...
    def object_keys(self) -> Sequence[builtins.str]:
        """
    ...
    def referenced_items(self) -> builtins.str:
        """
    ...
    def total_exported_object_count(self) -> builtins.int:
        """
...
def get_workspace_export_request(export_request_key: Optional[builtins.str] = None,
    ...
    :param builtins.str export_request_key: The key of the object export object request
...
def get_workspace_export_request_output(export_request_key: Optional[pulumi.Input[builtins.str]] = None,
