...
class GetWorkspaceExportRequestsResult:
    ...
    def export_status(self) -> Optional[_builtins.str]:
...
def get_workspace_export_requests(export_status: Optional[_builtins.str] = None,
    ...
    :param _builtins.str export_status: Specifies export status to use, either -  ALL, SUCCESSFUL, IN_PROGRESS, QUEUED, FAILED .
...
def get_workspace_export_requests_output(export_status: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
