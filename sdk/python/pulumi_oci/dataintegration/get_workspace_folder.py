...
__all__ = [
    ...
    'AwaitableGetWorkspaceFolderResult',
    'get_workspace_folder',
    'get_workspace_folder_output',
]

@pulumi.output_type
class GetWorkspaceFolderResult:
    """
    A collection of values returned by getWorkspaceFolder.
    """
    def __init__(__self__, category_name=None, description=None, folder_key=None, id=None, identifier=None, key=None, key_map=None, metadatas=None, model_type=None, model_version=None, name=None, object_status=None, object_version=None, parent_reves=None, registry_metadatas=None, workspace_id=None):
    ...
    def folder_key(self) -> builtins.str:
    ...
    def key_map(self) -> Mapping[str, builtins.str]:
        """
...
class AwaitableGetWorkspaceFolderResult(GetWorkspaceFolderResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetWorkspaceFolderResult(
...
def get_workspace_folder(folder_key: Optional[builtins.str] = None,
    ...
    :param builtins.str folder_key: The folder key.
...
def get_workspace_folder_output(folder_key: Optional[pulumi.Input[builtins.str]] = None,
