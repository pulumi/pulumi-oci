...
class GetWorkspaceFoldersResult:
    ...
    def aggregator_key(self) -> Optional[builtins.str]:
        """
...
def get_workspace_folders(aggregator_key: Optional[builtins.str] = None,
    ...
    :param builtins.str aggregator_key: Used to filter by the project or the folder object.
...
def get_workspace_folders_output(aggregator_key: Optional[pulumi.Input[Optional[builtins.str]]] = None,
