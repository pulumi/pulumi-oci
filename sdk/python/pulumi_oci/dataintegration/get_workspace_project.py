...
class GetWorkspaceProjectResult:
    ...
    @property
    @pulumi.getter
    def metadatas(self) -> Optional[Sequence['outputs.GetWorkspaceProjectMetadataResult']]:
    ...
    def parent_reves(self) -> Optional[Sequence['outputs.GetWorkspaceProjectParentRefResult']]:
    ...
    def registry_metadatas(self) -> Optional[Sequence['outputs.GetWorkspaceProjectRegistryMetadataResult']]:
