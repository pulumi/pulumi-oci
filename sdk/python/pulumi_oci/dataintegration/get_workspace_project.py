...
def get_workspace_project(project_key: Optional[builtins.str] = None,
    ...
    :param builtins.str project_key: The project key.
...
def get_workspace_project_output(project_key: Optional[pulumi.Input[builtins.str]] = None,
