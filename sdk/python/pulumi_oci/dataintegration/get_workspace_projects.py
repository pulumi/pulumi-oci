...
def get_workspace_projects(fields: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] fields: Specifies the fields to get for an object.
    :param Sequence[builtins.str] identifiers: Used to filter by the identifier of the object.
    :param builtins.str name: Used to filter by the name of the object.
    :param builtins.str name_contains: This parameter can be used to filter objects by the names that match partially or fully with the given value.
...
def get_workspace_projects_output(fields: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                  ...
                                  identifiers: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetWorkspaceProjectsResult(
        ...
        project_summary_collections=pulumi.get(__response__, 'project_summary_collections'),
