...
class GetWorkspaceTaskResult:
    ...
    def api_call_mode(self) -> builtins.str:
        """
    ...
    def expand_references(self) -> builtins.str:
    ...
    def is_single_load(self) -> builtins.bool:
        """
    ...
    def parallel_load_limit(self) -> builtins.int:
        """
...
def get_workspace_task(expand_references: Optional[builtins.str] = None,
...
def get_workspace_task_output(expand_references: Optional[pulumi.Input[builtins.str]] = None,
