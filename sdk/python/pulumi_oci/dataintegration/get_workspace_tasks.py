...
def get_workspace_tasks(fields: Optional[Sequence[builtins.str]] = None,
...
def get_workspace_tasks_output(fields: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
