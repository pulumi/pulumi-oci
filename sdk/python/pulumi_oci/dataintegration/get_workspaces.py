...
def get_workspaces(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str compartment_id: The OCID of the compartment containing the resources you want to list.
    :param builtins.str name: Used to filter by the name of the object.
    :param builtins.str state: The lifecycle state of a resource. When specified, the operation only returns resources that match the given lifecycle state. When not specified, all lifecycle states are processed as a match.
    """
    __args__ = dict()
...
def get_workspaces_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
