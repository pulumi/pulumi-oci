...
class WorkspaceApplicationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] model_type: (Updatable) The type of the application.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) Free form text without any restriction on permitted characters. Name can have letters, numbers, and special characters. The value is editable and is restricted to 1000 characters.
        ...
        :param pulumi.Input[builtins.str] state: (Updatable) The current state of the workspace.
        """
...
class _WorkspaceApplicationState:
    def __init__(__self__, *,
                 ...
                 time_patched: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] application_version: The source application version of the application.
        :param pulumi.Input[builtins.str] compartment_id: OCID of the compartment that this resource belongs to. Defaults to compartment of the Workspace.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        ...
        :param pulumi.Input[builtins.str] time_patched: The date and time the application was patched, in the timestamp format defined by RFC3339.
    ...
    def time_patched(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @time_patched.setter
    def time_patched(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WorkspaceApplication(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_patched: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkspaceApplication':
        """
    ...
    @property
    @pulumi.getter(name="timePatched")
    def time_patched(self) -> pulumi.Output[builtins.str]:
        """
        The date and time the application was patched, in the timestamp format defined by RFC3339.
        """
        return pulumi.get(self, "time_patched")
