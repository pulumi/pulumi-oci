...
class WorkspaceApplicationPatchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] patch_type: The type of the patch applied or being applied on the application.
        ...
        :param pulumi.Input[builtins.str] model_version: The object's model version.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] object_keys: The array of object keys to publish into application.
        :param pulumi.Input[builtins.int] object_status: The status of an object that can be set to value 1 for shallow references across objects, other values reserved.
...
class _WorkspaceApplicationPatchState:
    def __init__(__self__, *,
                 ...
                 patch_status: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] application_key: The application key.
        :param pulumi.Input[builtins.int] application_version: The application version of the patch.
        ...
        :param pulumi.Input[builtins.str] description: Detailed description for the object.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] error_messages: The errors encountered while applying the patch, if any.
        :param pulumi.Input[builtins.str] identifier: Value can only contain upper case letters, underscore and numbers. It should begin with upper case letter or underscore. The value can be modified.
        :param pulumi.Input[builtins.str] key: The object's key.
        ...
        :param pulumi.Input[builtins.str] model_type: The object type.
        :param pulumi.Input[builtins.str] model_version: The object's model version.
        :param pulumi.Input[builtins.str] name: Free form text without any restriction on permitted characters. Name can have letters, numbers, and special characters. The value is editable and is restricted to 1000 characters.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] object_keys: The array of object keys to publish into application.
        :param pulumi.Input[builtins.int] object_status: The status of an object that can be set to value 1 for shallow references across objects, other values reserved.
        ...
        :param pulumi.Input[builtins.str] patch_status: Status of the patch applied or being applied on the application
        :param pulumi.Input[builtins.str] patch_type: The type of the patch applied or being applied on the application.
        :param pulumi.Input['WorkspaceApplicationPatchRegistryMetadataArgs'] registry_metadata: Information about the object and its parent.
        :param pulumi.Input[builtins.str] time_patched: The date and time the patch was applied, in the timestamp format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] workspace_id: The workspace ID.
    ...
    def patch_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @patch_status.setter
    def patch_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WorkspaceApplicationPatch(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            registry_metadata: Optional[pulumi.Input[Union['WorkspaceApplicationPatchRegistryMetadataArgs', 'WorkspaceApplicationPatchRegistryMetadataArgsDict']]] = None,
            time_patched: Optional[pulumi.Input[builtins.str]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkspaceApplicationPatch':
        """
    ...
    @property
    @pulumi.getter(name="patchStatus")
    def patch_status(self) -> pulumi.Output[builtins.str]:
        """
        Status of the patch applied or being applied on the application
        """
        return pulumi.get(self, "patch_status")
