...
class WorkspaceApplicationScheduleArgs:
    def __init__(__self__, *,
                 ...
                 is_daylight_adjustment_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] application_key: The application key.
        ...
        :param pulumi.Input[builtins.bool] is_daylight_adjustment_enabled: (Updatable) A flag to indicate whether daylight adjustment should be considered or not.
        :param pulumi.Input[builtins.str] key: (Updatable) Generated key that can be used in API calls to identify schedule. On scenarios where reference to the schedule is needed, a value can be passed in create.
        :param pulumi.Input[builtins.str] model_version: (Updatable) This is a version number that is used by the service to upgrade objects if needed through releases of the service.
        ...
        :param pulumi.Input[builtins.int] object_version: (Updatable) This is used by the service for optimistic locking of the object, to prevent multiple users from simultaneously updating the object.
        ...
        :param pulumi.Input[builtins.str] timezone: (Updatable) The timezone for the schedule.
        """
    ...
    def is_daylight_adjustment_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_daylight_adjustment_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _WorkspaceApplicationScheduleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] model_type: The type of the object.
        :param pulumi.Input[builtins.str] model_version: (Updatable) This is a version number that is used by the service to upgrade objects if needed through releases of the service.
        :param pulumi.Input[builtins.str] name: (Updatable) Free form text without any restriction on permitted characters. Name can have letters, numbers, and special characters. The value is editable and is restricted to 1000 characters.
        :param pulumi.Input[builtins.int] object_status: (Updatable) The status of an object that can be set to value 1 for shallow references across objects, other values reserved.
        :param pulumi.Input[builtins.int] object_version: (Updatable) This is used by the service for optimistic locking of the object, to prevent multiple users from simultaneously updating the object.
...
class WorkspaceApplicationSchedule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            registry_metadata: Optional[pulumi.Input[Union['WorkspaceApplicationScheduleRegistryMetadataArgs', 'WorkspaceApplicationScheduleRegistryMetadataArgsDict']]] = None,
            timezone: Optional[pulumi.Input[builtins.str]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkspaceApplicationSchedule':
        """
    ...
    @property
    @pulumi.getter(name="isDaylightAdjustmentEnabled")
    def is_daylight_adjustment_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) A flag to indicate whether daylight adjustment should be considered or not.
        """
        return pulumi.get(self, "is_daylight_adjustment_enabled")
