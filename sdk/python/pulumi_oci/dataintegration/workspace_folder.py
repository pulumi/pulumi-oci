...
class WorkspaceFolderArgs:
    def __init__(__self__, *,
                 ...
                 folder_key: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] category_name: (Updatable) The category name.
    ...
    def folder_key(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "folder_key")

    @folder_key.setter
    def folder_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
class WorkspaceFolder(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            registry_metadata: Optional[pulumi.Input[Union['WorkspaceFolderRegistryMetadataArgs', 'WorkspaceFolderRegistryMetadataArgsDict']]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkspaceFolder':
        """
    ...
    @property
    @pulumi.getter(name="folderKey")
    def folder_key(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "folder_key")
