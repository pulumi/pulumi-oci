...
class WorkspaceImportRequestArgs:
    def __init__(__self__, *,
                 ...
                 are_data_asset_references_included: Optional[pulumi.Input[builtins.bool]] = None,
                 import_conflict_resolution: Optional[pulumi.Input['WorkspaceImportRequestImportConflictResolutionArgs']] = None,
                 object_key_for_import: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] bucket: Name of the Object Storage bucket where the object will be imported from.
        :param pulumi.Input[builtins.str] file_name: Name of the zip file to be imported.
        :param pulumi.Input[builtins.str] workspace_id: The workspace ID.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.bool] are_data_asset_references_included: This field controls if the data asset references will be included during import.
        ...
        :param pulumi.Input[builtins.str] object_key_for_import: Key of the object inside which all the objects will be imported
    ...
    def are_data_asset_references_included(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def are_data_asset_references_included(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def object_key_for_import(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def object_key_for_import(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _WorkspaceImportRequestState:
    def __init__(__self__, *,
                 ...
                 total_imported_object_count: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.bool] are_data_asset_references_included: This field controls if the data asset references will be included during import.
        :param pulumi.Input[builtins.str] bucket: Name of the Object Storage bucket where the object will be imported from.
        :param pulumi.Input[builtins.str] created_by: Name of the user who initiated import request.
        ...
        :param pulumi.Input[builtins.str] key: Import object request key
        :param pulumi.Input[builtins.str] name: Name of the import request.
        :param pulumi.Input[builtins.str] object_key_for_import: Key of the object inside which all the objects will be imported
        :param pulumi.Input[builtins.str] object_storage_region: Region of the object storage (if using object storage of different region)
        :param pulumi.Input[builtins.str] object_storage_tenancy_id: Optional parameter to point to object storage tenancy (if using Object Storage of different tenancy)
        :param pulumi.Input[builtins.str] status: Import Objects request status.
        ...
        :param pulumi.Input[builtins.int] total_imported_object_count: Number of objects that are imported.
        :param pulumi.Input[builtins.str] workspace_id: The workspace ID.
    ...
    def total_imported_object_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def total_imported_object_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class WorkspaceImportRequest(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_started_in_millis: Optional[pulumi.Input[builtins.str]] = None,
            total_imported_object_count: Optional[pulumi.Input[builtins.int]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkspaceImportRequest':
        """
    ...
    @property
    @pulumi.getter(name="areDataAssetReferencesIncluded")
    def are_data_asset_references_included(self) -> pulumi.Output[builtins.bool]:
        """
        This field controls if the data asset references will be included during import.
        """
        return pulumi.get(self, "are_data_asset_references_included")
    ...
    @property
    @pulumi.getter(name="objectKeyForImport")
    def object_key_for_import(self) -> pulumi.Output[builtins.str]:
        """
        Key of the object inside which all the objects will be imported
        """
        return pulumi.get(self, "object_key_for_import")
    ...
    @property
    @pulumi.getter(name="totalImportedObjectCount")
    def total_imported_object_count(self) -> pulumi.Output[builtins.int]:
        """
        Number of objects that are imported.
        """
        return pulumi.get(self, "total_imported_object_count")
