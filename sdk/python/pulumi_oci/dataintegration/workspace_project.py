...
class WorkspaceProjectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) A user defined description for the project.
        :param pulumi.Input[builtins.str] key: (Updatable) Generated key that can be used in API calls to identify project.
        :param pulumi.Input[builtins.str] model_version: (Updatable) The model version of an object.
...
class _WorkspaceProjectState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] identifier: (Updatable) Value can only contain upper case letters, underscore, and numbers. It should begin with upper case letter or underscore. The value can be modified.
        :param pulumi.Input[builtins.str] key: (Updatable) Generated key that can be used in API calls to identify project.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] key_map: A key map. If provided, the key is replaced with generated key. This structure provides mapping between user provided key and generated key.
        ...
        :param pulumi.Input[builtins.str] name: (Updatable) Free form text without any restriction on permitted characters. Name can have letters, numbers, and special characters. The value is editable and is restricted to 1000 characters.
        :param pulumi.Input[builtins.int] object_status: (Updatable) The status of an object that can be set to value 1 for shallow references across objects, other values reserved.
        :param pulumi.Input[builtins.int] object_version: The version of the object that is used to track changes in the object instance.
...
class WorkspaceProject(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            project_key: Optional[pulumi.Input[builtins.str]] = None,
            registry_metadata: Optional[pulumi.Input[Union['WorkspaceProjectRegistryMetadataArgs', 'WorkspaceProjectRegistryMetadataArgsDict']]] = None,
            workspace_id: Optional[pulumi.Input[builtins.str]] = None) -> 'WorkspaceProject':
        """
