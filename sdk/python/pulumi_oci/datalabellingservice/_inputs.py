...
class DatasetDatasetFormatDetailsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] format_type: The format type. DOCUMENT format is for record contents that are PDFs or TIFFs. IMAGE format is for record contents that are JPEGs or PNGs. TEXT format is for record contents that are TXT files.
...
if not MYPY:
    class DatasetDatasetFormatDetailsTextFileTypeMetadataArgsDict(TypedDict):
        column_index: pulumi.Input[builtins.int]
        """
        ...
        """
        escape_character: NotRequired[pulumi.Input[builtins.str]]
        """
        An escape character.
        """
        line_delimiter: NotRequired[pulumi.Input[builtins.str]]
        """
        A line delimiter.
        """
elif False:
...
class DatasetDatasetFormatDetailsTextFileTypeMetadataArgs:
    def __init__(__self__, *,
                 ...
                 escape_character: Optional[pulumi.Input[builtins.str]] = None,
                 line_delimiter: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] column_index: The index of a selected column. This is a zero-based index.
        :param pulumi.Input[builtins.str] format_type: It defines the format type of text files.
        :param pulumi.Input[builtins.str] column_delimiter: A column delimiter
        :param pulumi.Input[builtins.str] column_name: The name of a selected column.
        :param pulumi.Input[builtins.str] escape_character: An escape character.
        :param pulumi.Input[builtins.str] line_delimiter: A line delimiter.
        """
    ...
    def column_index(self) -> pulumi.Input[builtins.int]:
        """
        The index of a selected column. This is a zero-based index.
        """
    ...
    @column_index.setter
    def column_index(self, value: pulumi.Input[builtins.int]):
    ...
    def escape_character(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        An escape character.
        """
    ...
    def escape_character(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "escape_character", value)

    @property
    @pulumi.getter(name="lineDelimiter")
    def line_delimiter(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A line delimiter.
        """
    ...
    def line_delimiter(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DatasetDatasetSourceDetailsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] bucket: The object storage bucket that contains the dataset data source.
        :param pulumi.Input[builtins.str] namespace: The namespace of the bucket that contains the dataset data source.
        :param pulumi.Input[builtins.str] source_type: The source type. OBJECT_STORAGE allows the user to describe where in object storage the dataset is.
        :param pulumi.Input[builtins.str] prefix: A common path prefix shared by the objects that make up the dataset. Except for the CSV file type, records are not generated for the objects whose names exactly match with the prefix.
        """
...
class DatasetInitialImportDatasetConfigurationImportFormatArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: Name of import format
        :param pulumi.Input[builtins.str] version: Version of import format
        """
...
class DatasetInitialImportDatasetConfigurationImportMetadataPathArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] namespace: Bucket namespace name
        :param pulumi.Input[builtins.str] path: Path for the metadata file.
        :param pulumi.Input[builtins.str] source_type: The type of data source. OBJECT_STORAGE - The source details for an object storage bucket.
        """
        pulumi.set(__self__, "bucket", bucket)
        pulumi.set(__self__, "namespace", namespace)
...
class DatasetLabelSetItemArgs:
    def __init__(__self__, *,
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: An unique name for a label within its dataset.
        """
        pulumi.set(__self__, "name", name)
