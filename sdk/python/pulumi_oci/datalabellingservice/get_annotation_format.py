...
def get_annotation_format(compartment_id: Optional[_builtins.str] = None,
...
def get_annotation_format_output(compartment_id: Optional[pulumi.Input[_builtins.str]] = None,
