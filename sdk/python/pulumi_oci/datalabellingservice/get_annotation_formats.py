...
def get_annotation_formats(compartment_id: Optional[builtins.str] = None,
...
def get_annotation_formats_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
