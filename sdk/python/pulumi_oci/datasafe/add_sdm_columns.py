...
class AddSdmColumns(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        Create a AddSdmColumns resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param AddSdmColumnsArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(AddSdmColumnsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = AddSdmColumnsArgs.__new__(AddSdmColumnsArgs)
        ...
        super(AddSdmColumns, __self__).__init__(
            'oci:DataSafe/addSdmColumns:AddSdmColumns',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            masking_policy_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AddSdmColumns':
        """
        ...
        __props__ = _AddSdmColumnsState.__new__(_AddSdmColumnsState)

        __props__.__dict__["masking_policy_id"] = masking_policy_id
        return AddSdmColumns(resource_name, opts=opts, __props__=__props__)
