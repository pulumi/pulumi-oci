...
class AlertPolicyArgs:
    def __init__(__self__, *,
                 alert_policy_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] alert_policy_type: Indicates the Data Safe feature the alert policy belongs to
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment where you want to create the alert policy.
        :param pulumi.Input[builtins.str] severity: (Updatable) Severity level of the alert raised by this policy.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) The description of the alert policy.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the alert policy. The name does not have to be unique, and it's changeable.
    ...
    def alert_policy_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def alert_policy_type(self, value: pulumi.Input[builtins.str]):
...
class _AlertPolicyState:
    def __init__(__self__, *,
                 alert_policy_rule_details: Optional[pulumi.Input[Sequence[pulumi.Input['AlertPolicyAlertPolicyRuleDetailArgs']]]] = None,
                 alert_policy_type: Optional[pulumi.Input[builtins.str]] = None,
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_user_defined: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the alert policy. The name does not have to be unique, and it's changeable.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] is_user_defined: Indicates if the alert policy is user-defined (true) or pre-defined (false).
        :param pulumi.Input[builtins.str] lifecycle_details: Details about the current state of the alert policy.
        :param pulumi.Input[builtins.str] severity: (Updatable) Severity level of the alert raised by this policy.
        ...
        :param pulumi.Input[builtins.str] time_created: Creation date and time of the alert policy, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] time_updated: Last date and time the alert policy was updated, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        """
        if alert_policy_rule_details is not None:
            pulumi.set(__self__, "alert_policy_rule_details", alert_policy_rule_details)
    ...
    @property
    @pulumi.getter(name="alertPolicyType")
    def alert_policy_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Indicates the Data Safe feature the alert policy belongs to
        """
        return pulumi.get(self, "alert_policy_type")
    ...
    @alert_policy_type.setter
    def alert_policy_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "alert_policy_type", value)
    ...
    def is_user_defined(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_user_defined(self, value: Optional[pulumi.Input[builtins.bool]]):
...
@pulumi.type_token("oci:DataSafe/alertPolicy:AlertPolicy")
class AlertPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'AlertPolicy':
        """
    ...
    @property
    @pulumi.getter(name="alertPolicyType")
    def alert_policy_type(self) -> pulumi.Output[builtins.str]:
        """
        Indicates the Data Safe feature the alert policy belongs to
        """
        return pulumi.get(self, "alert_policy_type")
    ...
    @property
    @pulumi.getter(name="isUserDefined")
    def is_user_defined(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates if the alert policy is user-defined (true) or pre-defined (false).
        """
        return pulumi.get(self, "is_user_defined")
