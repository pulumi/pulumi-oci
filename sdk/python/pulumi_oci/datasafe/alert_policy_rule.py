...
class _AlertPolicyRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] state: The current state of the alert policy rule.
        :param pulumi.Input[_builtins.str] time_created: Creation date and time of the alert policy rule, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        """
...
class AlertPolicyRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            key: Optional[pulumi.Input[_builtins.str]] = None,
            state: Optional[pulumi.Input[_builtins.str]] = None,
            time_created: Optional[pulumi.Input[_builtins.str]] = None) -> 'AlertPolicyRule':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="alertPolicyId")
    def alert_policy_id(self) -> pulumi.Output[_builtins.str]:
        """
        The OCID of the alert policy.
        """
        return pulumi.get(self, "alert_policy_id")
