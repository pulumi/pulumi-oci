...
class AuditArchiveRetrievalArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment that contains the archival retrieval.
        :param pulumi.Input[builtins.str] end_date: End month of the archive retrieval, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] start_date: Start month of the archive retrieval, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] target_id: The OCID of the target associated with the archive retrieval.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Description of the archive retrieval.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the archive retrieval. The name does not have to be unique, and is changeable.
...
class _AuditArchiveRetrievalState:
    def __init__(__self__, *,
                 audit_event_count: Optional[pulumi.Input[builtins.str]] = None,
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 end_date: Optional[pulumi.Input[builtins.str]] = None,
                 error_info: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 ...
                 time_completed: Optional[pulumi.Input[builtins.str]] = None,
                 time_of_expiry: Optional[pulumi.Input[builtins.str]] = None,
                 time_requested: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering AuditArchiveRetrieval resources.
        :param pulumi.Input[builtins.str] audit_event_count: Total count of audit events to be retrieved from the archive for the specified date range.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment that contains the archival retrieval.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm) Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] description: (Updatable) Description of the archive retrieval.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the archive retrieval. The name does not have to be unique, and is changeable.
        :param pulumi.Input[builtins.str] end_date: End month of the archive retrieval, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] error_info: The Error details of a failed archive retrieval.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] lifecycle_details: Details about the current state of the archive retrieval.
        :param pulumi.Input[builtins.str] start_date: Start month of the archive retrieval, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] state: The current state of the archive retrieval.
        ...
        :param pulumi.Input[builtins.str] target_id: The OCID of the target associated with the archive retrieval.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] time_completed: The date time when archive retrieval request was fulfilled, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_of_expiry: The date time when retrieved archive data will be deleted from Data Safe and unloaded back into archival.
        :param pulumi.Input[builtins.str] time_requested: The date time when archive retrieval was requested, in the format defined by RFC3339.
        """
    ...
    def audit_event_count(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def audit_event_count(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def error_info(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @error_info.setter
    def error_info(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_completed(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_completed(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_completed", value)

    @property
    @pulumi.getter(name="timeOfExpiry")
    def time_of_expiry(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_of_expiry(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_of_expiry", value)

    @property
    @pulumi.getter(name="timeRequested")
    def time_requested(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_requested(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AuditArchiveRetrieval(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_completed: Optional[pulumi.Input[builtins.str]] = None,
            time_of_expiry: Optional[pulumi.Input[builtins.str]] = None,
            time_requested: Optional[pulumi.Input[builtins.str]] = None) -> 'AuditArchiveRetrieval':
        """
    ...
    @property
    @pulumi.getter(name="auditEventCount")
    def audit_event_count(self) -> pulumi.Output[builtins.str]:
        """
        Total count of audit events to be retrieved from the archive for the specified date range.
        """
        return pulumi.get(self, "audit_event_count")
    ...
    @property
    @pulumi.getter(name="errorInfo")
    def error_info(self) -> pulumi.Output[builtins.str]:
        """
        The Error details of a failed archive retrieval.
        """
        return pulumi.get(self, "error_info")
    ...
    @property
    @pulumi.getter(name="timeCompleted")
    def time_completed(self) -> pulumi.Output[builtins.str]:
        """
        The date time when archive retrieval request was fulfilled, in the format defined by RFC3339.
        """
        return pulumi.get(self, "time_completed")
    ...
    @property
    @pulumi.getter(name="timeOfExpiry")
    def time_of_expiry(self) -> pulumi.Output[builtins.str]:
        """
        The date time when retrieved archive data will be deleted from Data Safe and unloaded back into archival.
        """
        return pulumi.get(self, "time_of_expiry")
    ...
    @property
    @pulumi.getter(name="timeRequested")
    def time_requested(self) -> pulumi.Output[builtins.str]:
        """
        The date time when archive retrieval was requested, in the format defined by RFC3339.
        """
        return pulumi.get(self, "time_requested")
