...
class AuditPolicyManagementArgs:
    def __init__(__self__, *,
                 ...
                 is_data_safe_service_account_excluded: Optional[pulumi.Input[builtins.bool]] = None,
                 provision_trigger: Optional[pulumi.Input[builtins.bool]] = None,
                 retrieve_from_target_trigger: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment containing the audit policy.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) The description of the audit policy.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the audit policy. The name does not have to be unique, and it is changeable.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] is_data_safe_service_account_excluded: Option provided to users at the target to indicate whether the Data Safe service account has to be excluded while provisioning the audit policies.
        :param pulumi.Input[builtins.bool] provision_trigger: (Updatable) An optional property when set to true triggers Provision.
        :param pulumi.Input[builtins.bool] retrieve_from_target_trigger: (Updatable) An optional property when set to true triggers Retrieve From Target.
        :param pulumi.Input[builtins.str] target_id: The OCID of the target for which the audit policy is created.
        """
    ...
    def is_data_safe_service_account_excluded(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_data_safe_service_account_excluded(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_data_safe_service_account_excluded", value)

    @property
    @pulumi.getter(name="provisionTrigger")
    def provision_trigger(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def provision_trigger(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "provision_trigger", value)

    @property
    @pulumi.getter(name="retrieveFromTargetTrigger")
    def retrieve_from_target_trigger(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def retrieve_from_target_trigger(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _AuditPolicyManagementState:
    def __init__(__self__, *,
                 ...
                 time_last_provisioned: Optional[pulumi.Input[builtins.str]] = None,
                 time_last_retrieved: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] is_data_safe_service_account_excluded: Option provided to users at the target to indicate whether the Data Safe service account has to be excluded while provisioning the audit policies.
        :param pulumi.Input[builtins.str] lifecycle_details: Details about the current state of the audit policy in Data Safe.
        :param pulumi.Input[builtins.bool] provision_trigger: (Updatable) An optional property when set to true triggers Provision.
        :param pulumi.Input[builtins.bool] retrieve_from_target_trigger: (Updatable) An optional property when set to true triggers Retrieve From Target.
        :param pulumi.Input[builtins.str] state: The current state of the audit policy.
        ...
        :param pulumi.Input[builtins.str] target_id: The OCID of the target for which the audit policy is created.
        :param pulumi.Input[builtins.str] time_created: The time the audit policy was created, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_last_provisioned: Indicates the last provisioning time of audit policies on the target, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_last_retrieved: The time when the audit policies was last retrieved from this target, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_updated: The last date and time the audit policy was updated, in the format defined by RFC3339.
        """
        if audit_conditions is not None:
            pulumi.set(__self__, "audit_conditions", audit_conditions)
    ...
    def time_last_provisioned(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_last_provisioned(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_last_provisioned", value)

    @property
    @pulumi.getter(name="timeLastRetrieved")
    def time_last_retrieved(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_last_retrieved(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AuditPolicyManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_last_provisioned: Optional[pulumi.Input[builtins.str]] = None,
            time_last_retrieved: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'AuditPolicyManagement':
        """
    ...
    @property
    @pulumi.getter(name="isDataSafeServiceAccountExcluded")
    def is_data_safe_service_account_excluded(self) -> pulumi.Output[builtins.bool]:
        """
        Option provided to users at the target to indicate whether the Data Safe service account has to be excluded while provisioning the audit policies.
        """
        return pulumi.get(self, "is_data_safe_service_account_excluded")
    ...
    @property
    @pulumi.getter(name="provisionTrigger")
    def provision_trigger(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        (Updatable) An optional property when set to true triggers Provision.
        """
        return pulumi.get(self, "provision_trigger")
    ...
    @property
    @pulumi.getter(name="retrieveFromTargetTrigger")
    def retrieve_from_target_trigger(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        (Updatable) An optional property when set to true triggers Retrieve From Target.
        """
        return pulumi.get(self, "retrieve_from_target_trigger")
    ...
    @property
    @pulumi.getter(name="timeLastProvisioned")
    def time_last_provisioned(self) -> pulumi.Output[builtins.str]:
        """
        Indicates the last provisioning time of audit policies on the target, in the format defined by RFC3339.
        """
        return pulumi.get(self, "time_last_provisioned")
    ...
    @property
    @pulumi.getter(name="timeLastRetrieved")
    def time_last_retrieved(self) -> pulumi.Output[builtins.str]:
        """
        The time when the audit policies was last retrieved from this target, in the format defined by RFC3339.
        """
        return pulumi.get(self, "time_last_retrieved")
