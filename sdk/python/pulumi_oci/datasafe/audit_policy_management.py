...
class AuditPolicyManagementArgs:
    def __init__(__self__, *,
                 ...
                 provision_trigger: Optional[pulumi.Input[bool]] = None,
                 retrieve_from_target_trigger: Optional[pulumi.Input[bool]] = None,
    ...
    def provision_trigger(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def provision_trigger(self, value: Optional[pulumi.Input[bool]]):
        pulumi.set(self, "provision_trigger", value)

    @property
    @pulumi.getter(name="retrieveFromTargetTrigger")
    def retrieve_from_target_trigger(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def retrieve_from_target_trigger(self, value: Optional[pulumi.Input[bool]]):
...
class AuditPolicyManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_last_provisioned: Optional[pulumi.Input[str]] = None,
            time_last_retrieved: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None) -> 'AuditPolicyManagement':
        """
    ...
    @property
    @pulumi.getter(name="provisionTrigger")
    def provision_trigger(self) -> pulumi.Output[Optional[bool]]:
        """
        (Updatable) An optional property when set to true triggers Provision.
        """
        return pulumi.get(self, "provision_trigger")
    ...
    @property
    @pulumi.getter(name="retrieveFromTargetTrigger")
    def retrieve_from_target_trigger(self) -> pulumi.Output[Optional[bool]]:
        """
        (Updatable) An optional property when set to true triggers Retrieve From Target.
        """
        return pulumi.get(self, "retrieve_from_target_trigger")
