...
class AuditPolicyManagementArgs:
    def __init__(__self__, *,
                 audit_conditions: pulumi.Input[Optional[Sequence[pulumi.Input['AuditPolicyManagementAuditConditionArgs']]]] = None,
                 compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 is_data_safe_service_account_excluded: pulumi.Input[Optional[_builtins.bool]] = None,
                 provision_trigger: pulumi.Input[Optional[_builtins.bool]] = None,
                 retrieve_from_target_trigger: pulumi.Input[Optional[_builtins.bool]] = None,
    ...
    def audit_conditions(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AuditPolicyManagementAuditConditionArgs']]]]:
        """
    ...
    def audit_conditions(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AuditPolicyManagementAuditConditionArgs']]]]):
    ...
    def is_data_safe_service_account_excluded(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def is_data_safe_service_account_excluded(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "is_data_safe_service_account_excluded", value)

    @_builtins.property
    @pulumi.getter(name="provisionTrigger")
    def provision_trigger(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def provision_trigger(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "provision_trigger", value)

    @_builtins.property
    @pulumi.getter(name="retrieveFromTargetTrigger")
    def retrieve_from_target_trigger(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def retrieve_from_target_trigger(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class _AuditPolicyManagementState:
    def __init__(__self__, *,
                 audit_conditions: pulumi.Input[Optional[Sequence[pulumi.Input['AuditPolicyManagementAuditConditionArgs']]]] = None,
                 audit_specifications: pulumi.Input[Optional[Sequence[pulumi.Input['AuditPolicyManagementAuditSpecificationArgs']]]] = None,
                 compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 time_last_provisioned: pulumi.Input[Optional[_builtins.str]] = None,
                 time_last_retrieved: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def audit_specifications(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AuditPolicyManagementAuditSpecificationArgs']]]]:
        """
    ...
    def audit_specifications(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AuditPolicyManagementAuditSpecificationArgs']]]]):
    ...
    def time_last_provisioned(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def time_last_provisioned(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "time_last_provisioned", value)

    @_builtins.property
    @pulumi.getter(name="timeLastRetrieved")
    def time_last_retrieved(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def time_last_retrieved(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class AuditPolicyManagement(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 audit_conditions: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AuditPolicyManagementAuditConditionArgs', 'AuditPolicyManagementAuditConditionArgsDict', 'outputs.AuditPolicyManagementAuditCondition']]]]] = None,
                 compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['AuditPolicyManagementAuditConditionArgs', 'AuditPolicyManagementAuditConditionArgsDict', 'outputs.AuditPolicyManagementAuditCondition']]]] audit_conditions: Required when provision_trigger is set. Lists the audit policy provisioning conditions for the target database.
        :param pulumi.Input[_builtins.str] compartment_id: (Updatable) The OCID of the compartment containing the audit policy.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm) Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[_builtins.str] description: (Updatable) The description of the audit policy.
        :param pulumi.Input[_builtins.str] display_name: (Updatable) The display name of the audit policy. The name does not have to be unique, and it is changeable.
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            audit_conditions: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AuditPolicyManagementAuditConditionArgs', 'AuditPolicyManagementAuditConditionArgsDict', 'outputs.AuditPolicyManagementAuditCondition']]]]] = None,
            audit_specifications: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AuditPolicyManagementAuditSpecificationArgs', 'AuditPolicyManagementAuditSpecificationArgsDict', 'outputs.AuditPolicyManagementAuditSpecification']]]]] = None,
            compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
            defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            description: pulumi.Input[Optional[_builtins.str]] = None,
            display_name: pulumi.Input[Optional[_builtins.str]] = None,
            ...
            time_last_provisioned: pulumi.Input[Optional[_builtins.str]] = None,
            time_last_retrieved: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None) -> 'AuditPolicyManagement':
        """
        ...
        :param pulumi.ResourceOptions opts: Options for the resource.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AuditPolicyManagementAuditConditionArgs', 'AuditPolicyManagementAuditConditionArgsDict', 'outputs.AuditPolicyManagementAuditCondition']]]] audit_conditions: Required when provision_trigger is set. Lists the audit policy provisioning conditions for the target database.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AuditPolicyManagementAuditSpecificationArgs', 'AuditPolicyManagementAuditSpecificationArgsDict', 'outputs.AuditPolicyManagementAuditSpecification']]]] audit_specifications: Represents all available audit policy specifications relevant for the target database. For more details on available audit polcies, refer to [documentation](https://docs.oracle.com/en/cloud/paas/data-safe/udscs/audit-policies.html#GUID-361A9A9A-7C21-4F5A-8945-9B3A0C472827).
        :param pulumi.Input[_builtins.str] compartment_id: (Updatable) The OCID of the compartment containing the audit policy.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm) Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[_builtins.str] description: (Updatable) The description of the audit policy.
        :param pulumi.Input[_builtins.str] display_name: (Updatable) The display name of the audit policy. The name does not have to be unique, and it is changeable.
