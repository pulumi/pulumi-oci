...
class AuditTrailArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] resume_trigger: (Updatable) An optional property when incremented triggers Resume. Could be set to any integer value.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: (Updatable) The target state for the Audit Trail. Could be set to `ACTIVE` or `INACTIVE`.
        """
    ...
    def audit_trail_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def audit_trail_id(self, value: pulumi.Input[builtins.str]):
    ...
    def resume_trigger(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def resume_trigger(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _AuditTrailState:
    def __init__(__self__, *,
                 ...
                 audit_trail_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] audit_trail_id: The OCID of the audit trail.
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment that contains the audit trail and is the same as the compartment of the audit profile resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm) Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] description: (Updatable) The description of the audit trail.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the audit trail. The name does not have to be unique, and it's updatable.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
        ...
        :param pulumi.Input[builtins.str] target_id: The OCID of the Data Safe target for which the audit trail is created.
    ...
    @property
    @pulumi.getter(name="auditTrailId")
    def audit_trail_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The OCID of the audit trail.
        """
        return pulumi.get(self, "audit_trail_id")
    ...
    @audit_trail_id.setter
    def audit_trail_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "audit_trail_id", value)
...
class AuditTrail(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            trail_location: Optional[pulumi.Input[builtins.str]] = None,
            trail_source: Optional[pulumi.Input[builtins.str]] = None,
            work_request_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AuditTrail':
        """
    ...
    @property
    @pulumi.getter(name="auditTrailId")
    def audit_trail_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the audit trail.
        """
        return pulumi.get(self, "audit_trail_id")
    ...
    @property
    @pulumi.getter(name="peerTargetDatabaseKey")
    def peer_target_database_key(self) -> pulumi.Output[builtins.int]:
        """
        The secondary id assigned for the peer database registered with Data Safe.
        """
        return pulumi.get(self, "peer_target_database_key")
    ...
    @property
    @pulumi.getter(name="purgeJobDetails")
    def purge_job_details(self) -> pulumi.Output[builtins.str]:
        """
        The details of the audit trail purge job that ran on the "purgeJobTime".
        """
        return pulumi.get(self, "purge_job_details")
    ...
    @property
    @pulumi.getter(name="purgeJobStatus")
    def purge_job_status(self) -> pulumi.Output[builtins.str]:
        """
        The current status of the audit trail purge job.
        """
        return pulumi.get(self, "purge_job_status")
    ...
    @property
    @pulumi.getter(name="purgeJobTime")
    def purge_job_time(self) -> pulumi.Output[builtins.str]:
        """
        The date and time of the last purge job, which deletes audit data in the target database every seven days so that the database's audit trail does not become too large. In the format defined by RFC3339.
        """
        return pulumi.get(self, "purge_job_time")
    ...
    @property
    @pulumi.getter(name="resumeTrigger")
    def resume_trigger(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        (Updatable) An optional property when incremented triggers Resume. Could be set to any integer value.
    ...
    @property
    @pulumi.getter(name="trailLocation")
    def trail_location(self) -> pulumi.Output[builtins.str]:
        """
        An audit trail location represents the source of audit records that provides documentary evidence of the sequence of activities in the target database.
        """
        return pulumi.get(self, "trail_location")
    ...
    @property
    @pulumi.getter(name="trailSource")
    def trail_source(self) -> pulumi.Output[builtins.str]:
        """
        The underlying source of unified audit trail.
        """
        return pulumi.get(self, "trail_source")
