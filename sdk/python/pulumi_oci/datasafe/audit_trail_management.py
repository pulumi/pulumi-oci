...
class AuditTrailManagementArgs:
    def __init__(__self__, *,
                 ...
                 is_auto_purge_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 resume_trigger: Optional[pulumi.Input[builtins.bool]] = None,
                 start_trigger: Optional[pulumi.Input[builtins.bool]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 stop_trigger: Optional[pulumi.Input[builtins.bool]] = None,
                 target_id: Optional[pulumi.Input[builtins.str]] = None,
                 trail_location: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a AuditTrailManagement resource.
        :param pulumi.Input[builtins.str] audit_collection_start_time: The date from which the audit trail must start collecting data, in the format defined by RFC3339. It is a required field when start_trigger is set.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment that contains the target.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) The description of the audit trail.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the audit trail. The name does not have to be unique, and it's updatable.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] is_auto_purge_enabled: (Updatable) Indicates if auto purge is enabled on the target database, which helps delete audit data in the target database every seven days so that the database's audit trail does not become too large.
        :param pulumi.Input[builtins.bool] resume_trigger: (Updatable) An optional property when set to true triggers Resume.
        :param pulumi.Input[builtins.bool] start_trigger: (Updatable) An optional property when set to true triggers Start.
        :param pulumi.Input[builtins.str] state: (Updatable) The target state for the Audit Trail Management. Could be set to `ACTIVE` or `INACTIVE`.
        :param pulumi.Input[builtins.bool] stop_trigger: (Updatable) An optional property when set to true triggers Stop.
        :param pulumi.Input[builtins.str] target_id: The OCID of the target.
        :param pulumi.Input[builtins.str] trail_location: An audit trail location represents the source of audit records that provides documentary evidence of the sequence of activities in the target database.
        """
    ...
    def is_auto_purge_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_auto_purge_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_auto_purge_enabled", value)

    @property
    @pulumi.getter(name="resumeTrigger")
    def resume_trigger(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def resume_trigger(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "resume_trigger", value)

    @property
    @pulumi.getter(name="startTrigger")
    def start_trigger(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def start_trigger(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def stop_trigger(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @stop_trigger.setter
    def stop_trigger(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def trail_location(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def trail_location(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AuditTrailManagementState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] audit_collection_start_time: The date from which the audit trail must start collecting data, in the format defined by RFC3339. It is a required field when start_trigger is set.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] audit_profile_id: The OCID of the  parent audit.
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment that contains the target.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm) Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] description: (Updatable) The description of the audit trail.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the audit trail. The name does not have to be unique, and it's updatable.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] is_auto_purge_enabled: (Updatable) Indicates if auto purge is enabled on the target database, which helps delete audit data in the target database every seven days so that the database's audit trail does not become too large.
        :param pulumi.Input[builtins.str] lifecycle_details: Details about the current state of the audit trail in Data Safe.
        :param pulumi.Input[builtins.bool] resume_trigger: (Updatable) An optional property when set to true triggers Resume.
        :param pulumi.Input[builtins.bool] start_trigger: (Updatable) An optional property when set to true triggers Start.
        :param pulumi.Input[builtins.str] state: (Updatable) The target state for the Audit Trail Management. Could be set to `ACTIVE` or `INACTIVE`.
        :param pulumi.Input[builtins.str] status: The current sub-state of the audit trail.
        :param pulumi.Input[builtins.bool] stop_trigger: (Updatable) An optional property when set to true triggers Stop.
        ...
        :param pulumi.Input[builtins.str] target_id: The OCID of the target.
        :param pulumi.Input[builtins.str] time_created: The date and time the audit trail was created, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_last_collected: The date and time until when the audit events were collected from the target database by the Data Safe audit trail  collection process, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_updated: The date and time the audit trail was updated, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] trail_location: An audit trail location represents the source of audit records that provides documentary evidence of the sequence of activities in the target database.
        :param pulumi.Input[builtins.str] work_request_id: The OCID of the workrequest for audit trail which collects audit records.
        """
        if audit_collection_start_time is not None:
            pulumi.set(__self__, "audit_collection_start_time", audit_collection_start_time)
...
class AuditTrailManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            trail_location: Optional[pulumi.Input[builtins.str]] = None,
            work_request_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AuditTrailManagement':
        """
    ...
    @property
    @pulumi.getter(name="auditCollectionStartTime")
    def audit_collection_start_time(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The date from which the audit trail must start collecting data, in the format defined by RFC3339. It is a required field when start_trigger is set.
    ...
    @property
    @pulumi.getter(name="isAutoPurgeEnabled")
    def is_auto_purge_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Indicates if auto purge is enabled on the target database, which helps delete audit data in the target database every seven days so that the database's audit trail does not become too large.
        """
        return pulumi.get(self, "is_auto_purge_enabled")
    ...
    @property
    @pulumi.getter(name="resumeTrigger")
    def resume_trigger(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        (Updatable) An optional property when set to true triggers Resume.
        """
        return pulumi.get(self, "resume_trigger")
    ...
    @property
    @pulumi.getter(name="startTrigger")
    def start_trigger(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        (Updatable) An optional property when set to true triggers Start.
        """
        return pulumi.get(self, "start_trigger")
    ...
    @property
    @pulumi.getter(name="stopTrigger")
    def stop_trigger(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        (Updatable) An optional property when set to true triggers Stop.
        """
        return pulumi.get(self, "stop_trigger")
    ...
    @property
    @pulumi.getter(name="timeLastCollected")
    def time_last_collected(self) -> pulumi.Output[builtins.str]:
        """
        The date and time until when the audit events were collected from the target database by the Data Safe audit trail  collection process, in the format defined by RFC3339.
        """
        return pulumi.get(self, "time_last_collected")
    ...
    @property
    @pulumi.getter(name="trailLocation")
    def trail_location(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        An audit trail location represents the source of audit records that provides documentary evidence of the sequence of activities in the target database.
        """
        return pulumi.get(self, "trail_location")
