...
class AuditTrailManagementArgs:
    def __init__(__self__, *,
                 ...
                 resume_trigger: Optional[pulumi.Input[bool]] = None,
        ...
        :param pulumi.Input[bool] start_trigger: (Updatable) An optional property when set to true triggers Start.
        :param pulumi.Input[str] state: (Updatable) The target state for the Audit Trail Management. Could be set to `ACTIVE` or `INACTIVE`.
        :param pulumi.Input[bool] stop_trigger: (Updatable) An optional property when set to true triggers Stop.
    ...
    def resume_trigger(self) -> Optional[pulumi.Input[bool]]:
        """
    ...
    def resume_trigger(self, value: Optional[pulumi.Input[bool]]):
...
class AuditTrailManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_updated: Optional[pulumi.Input[str]] = None,
            trail_location: Optional[pulumi.Input[str]] = None,
            work_request_id: Optional[pulumi.Input[str]] = None) -> 'AuditTrailManagement':
        """
    ...
    @property
    @pulumi.getter(name="resumeTrigger")
    def resume_trigger(self) -> pulumi.Output[Optional[bool]]:
        """
        (Updatable) An optional property when set to true triggers Resume.
        """
        return pulumi.get(self, "resume_trigger")
    ...
    @property
    @pulumi.getter(name="trailLocation")
    def trail_location(self) -> pulumi.Output[Optional[str]]:
        """
        An audit trail location represents the source of audit records that provides documentary evidence of the sequence of activities in the target database.
        """
        return pulumi.get(self, "trail_location")
