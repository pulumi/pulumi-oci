...
class CalculateAuditVolumeCollectedArgs:
    def __init__(__self__, *,
                 ...
                 time_from_month: pulumi.Input[builtins.str],
                 time_to_month: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] time_from_month: The date from which the audit volume collected by data safe has to be calculated, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_to_month: The date from which the audit volume collected by data safe has to be calculated, in the format defined by RFC3339. If not specified, this will default to the current date.
    ...
    def time_from_month(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def time_from_month(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "time_from_month", value)

    @property
    @pulumi.getter(name="timeToMonth")
    def time_to_month(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_to_month(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _CalculateAuditVolumeCollectedState:
    def __init__(__self__, *,
                 ...
                 time_from_month: Optional[pulumi.Input[builtins.str]] = None,
                 time_to_month: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="timeFromMonth")
    def time_from_month(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The date from which the audit volume collected by data safe has to be calculated, in the format defined by RFC3339.
        """
        return pulumi.get(self, "time_from_month")
    ...
    @time_from_month.setter
    def time_from_month(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_from_month", value)
...
class CalculateAuditVolumeCollected(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_from_month: Optional[pulumi.Input[builtins.str]] = None,
            time_to_month: Optional[pulumi.Input[builtins.str]] = None) -> 'CalculateAuditVolumeCollected':
        """
    ...
    @property
    @pulumi.getter(name="timeFromMonth")
    def time_from_month(self) -> pulumi.Output[builtins.str]:
        """
        The date from which the audit volume collected by data safe has to be calculated, in the format defined by RFC3339.
        """
        return pulumi.get(self, "time_from_month")
    ...
    @property
    @pulumi.getter(name="timeToMonth")
    def time_to_month(self) -> pulumi.Output[builtins.str]:
        """
        The date from which the audit volume collected by data safe has to be calculated, in the format defined by RFC3339. If not specified, this will default to the current date.
