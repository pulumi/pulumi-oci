...
class CompareSecurityAssessmentArgs:
    def __init__(__self__, *,
                 comparison_security_assessment_id: pulumi.Input[builtins.str],
                 security_assessment_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a CompareSecurityAssessment resource.
        :param pulumi.Input[builtins.str] comparison_security_assessment_id: The OCID of the security assessment. In this case a security assessment can be another security assessment, a latest assessment or a baseline.
        :param pulumi.Input[builtins.str] security_assessment_id: The OCID of the security assessment.
    ...
    def comparison_security_assessment_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def comparison_security_assessment_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "comparison_security_assessment_id", value)

    @property
    @pulumi.getter(name="securityAssessmentId")
    def security_assessment_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def security_assessment_id(self, value: pulumi.Input[builtins.str]):
...
class _CompareSecurityAssessmentState:
    def __init__(__self__, *,
                 comparison_security_assessment_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="comparisonSecurityAssessmentId")
    def comparison_security_assessment_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The OCID of the security assessment. In this case a security assessment can be another security assessment, a latest assessment or a baseline.
        """
        return pulumi.get(self, "comparison_security_assessment_id")
    ...
    @comparison_security_assessment_id.setter
    def comparison_security_assessment_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "comparison_security_assessment_id", value)
...
class CompareSecurityAssessment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            comparison_security_assessment_id: Optional[pulumi.Input[builtins.str]] = None,
            security_assessment_id: Optional[pulumi.Input[builtins.str]] = None) -> 'CompareSecurityAssessment':
        """
    ...
    @property
    @pulumi.getter(name="comparisonSecurityAssessmentId")
    def comparison_security_assessment_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the security assessment. In this case a security assessment can be another security assessment, a latest assessment or a baseline.
        """
        return pulumi.get(self, "comparison_security_assessment_id")
