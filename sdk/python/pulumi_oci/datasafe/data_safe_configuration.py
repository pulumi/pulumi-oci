...
class DataSafeConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) Indicates if Data Safe is enabled.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) A filter to return only resources that match the specified compartment OCID.
        """
...
class _DataSafeConfigurationState:
    def __init__(__self__, *,
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 data_safe_nat_gateway_ip_address: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 time_enabled: Optional[pulumi.Input[builtins.str]] = None,
                 url: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering DataSafeConfiguration resources.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) A filter to return only resources that match the specified compartment OCID.
        :param pulumi.Input[builtins.str] data_safe_nat_gateway_ip_address: The Oracle Data Safe's NAT Gateway IP Address.
        ...
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) Indicates if Data Safe is enabled.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The current state of Data Safe.
        :param pulumi.Input[builtins.str] time_enabled: The date and time Data Safe was enabled, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] url: The URL of the Data Safe service.
        """
        if compartment_id is not None:
            pulumi.set(__self__, "compartment_id", compartment_id)
    ...
    def data_safe_nat_gateway_ip_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def data_safe_nat_gateway_ip_address(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_enabled(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @time_enabled.setter
    def time_enabled(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DataSafeConfiguration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_enabled: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'DataSafeConfiguration':
        """
    ...
    @property
    @pulumi.getter(name="dataSafeNatGatewayIpAddress")
    def data_safe_nat_gateway_ip_address(self) -> pulumi.Output[builtins.str]:
        """
        The Oracle Data Safe's NAT Gateway IP Address.
        """
        return pulumi.get(self, "data_safe_nat_gateway_ip_address")
    ...
    @property
    @pulumi.getter(name="timeEnabled")
    def time_enabled(self) -> pulumi.Output[builtins.str]:
        """
        The date and time Data Safe was enabled, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        """
        return pulumi.get(self, "time_enabled")
