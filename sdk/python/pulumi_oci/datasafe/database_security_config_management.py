...
class DatabaseSecurityConfigManagementArgs:
    def __init__(__self__, *,
                 ...
                 refresh_trigger: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment containing the database security config.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the database security config. The name does not have to be unique, and it is changeable.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] refresh_trigger: (Updatable) An optional property when incremented triggers Refresh. Could be set to any integer value.
    ...
    def refresh_trigger(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def refresh_trigger(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _DatabaseSecurityConfigManagementState:
    def __init__(__self__, *,
                 ...
                 time_last_refreshed: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the database security config. The name does not have to be unique, and it is changeable.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] lifecycle_details: Details about the current state of the database security config in Data Safe.
        :param pulumi.Input[builtins.bool] refresh_trigger: (Updatable) An optional property when incremented triggers Refresh. Could be set to any integer value.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input['DatabaseSecurityConfigManagementSqlFirewallConfigArgs'] sql_firewall_config: (Updatable) Details to update the SQL firewall config.
        :param pulumi.Input[builtins.str] state: The current state of the database security config.
        ...
        :param pulumi.Input[builtins.str] target_id: Unique target identifier.
        :param pulumi.Input[builtins.str] time_created: The time that the database security config was created, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_last_refreshed: The last date and time the database security config was refreshed, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_updated: The date and time the database security configuration was last updated, in the format defined by RFC3339.
        """
        if compartment_id is not None:
            pulumi.set(__self__, "compartment_id", compartment_id)
        if defined_tags is not None:
    ...
    def time_last_refreshed(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_last_refreshed(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DatabaseSecurityConfigManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_last_refreshed: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'DatabaseSecurityConfigManagement':
        """
    ...
    @property
    @pulumi.getter(name="refreshTrigger")
    def refresh_trigger(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        (Updatable) An optional property when incremented triggers Refresh. Could be set to any integer value.
    ...
    @property
    @pulumi.getter(name="timeLastRefreshed")
    def time_last_refreshed(self) -> pulumi.Output[builtins.str]:
        """
        The last date and time the database security config was refreshed, in the format defined by RFC3339.
        """
        return pulumi.get(self, "time_last_refreshed")
