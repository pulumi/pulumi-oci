...
class DiscoveryJobsResultArgs:
    def __init__(__self__, *,
                 discovery_job_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a DiscoveryJobsResult resource.
        :param pulumi.Input[builtins.str] discovery_job_id: The OCID of the discovery job.
        """
    ...
    def discovery_job_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def discovery_job_id(self, value: pulumi.Input[builtins.str]):
...
class _DiscoveryJobsResultState:
    def __init__(__self__, *,
                 ...
                 is_result_applied: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 planned_action: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 sensitive_columnkey: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] app_name: The name of the application. An application is an entity that is identified by a schema and stores sensitive information for that schema. Its value will be same as schemaName, if no value is passed.
        :param pulumi.Input[builtins.str] column_name: The name of the sensitive column.
        :param pulumi.Input[builtins.str] data_type: The data type of the sensitive column.
        ...
        :param pulumi.Input[builtins.bool] is_result_applied: Indicates if the discovery result has been processed. You can update this attribute using the PatchDiscoveryJobResults operation to track whether the discovery result has already been processed and applied to the sensitive data model.
        :param pulumi.Input[builtins.str] key: The unique key that identifies the discovery result.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] parent_column_keys: Unique keys identifying the columns that are parents of the sensitive column. At present, it tracks a single parent only.
        :param pulumi.Input[builtins.str] planned_action: Specifies how to process the discovery result. It's set to NONE by default. Use the PatchDiscoveryJobResults operation to update this attribute. You can choose one of the following options: ACCEPT: To accept the discovery result and update the sensitive data model to reflect the changes. REJECT: To reject the discovery result so that it doesn't change the sensitive data model. INVALIDATE: To invalidate a newly discovered column. It adds the column to the sensitive data model but marks it as invalid. It helps track false positives and ensure that they aren't reported by future discovery jobs. After specifying the planned action, you can use the ApplyDiscoveryJobResults operation to automatically process the discovery results.
        :param pulumi.Input[builtins.str] relation_type: The type of referential relationship the sensitive column has with its parent. NONE indicates that the sensitive column does not have a parent. DB_DEFINED indicates that the relationship is defined in the database dictionary. APP_DEFINED indicates that the relationship is defined at the application level and not in the database dictionary.
        ...
        :param pulumi.Input[builtins.str] sensitive_columnkey: The unique key that identifies the sensitive column represented by the discovery result.
        :param pulumi.Input[builtins.str] sensitive_type_id: The OCID of the sensitive type associated with the sensitive column.
        """
    ...
    @pulumi.getter(name="discoveryJobId")
    @_utilities.deprecated("""The 'oci_data_safe_discovery_jobs_result' resource has been deprecated. It is no longer supported.""")
    def discovery_job_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The OCID of the discovery job.
        """
        return pulumi.get(self, "discovery_job_id")
    ...
    @discovery_job_id.setter
    def discovery_job_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "discovery_job_id", value)
    ...
    def is_result_applied(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_result_applied(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def planned_action(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def planned_action(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sensitive_columnkey(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def sensitive_columnkey(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DiscoveryJobsResult(pulumi.CustomResource):
    ...
    pulumi_type = "oci:DataSafe/discoveryJobsResult:DiscoveryJobsResult"
    ...
    def get(resource_name: str,
            ...
            schema_name: Optional[pulumi.Input[builtins.str]] = None,
            sensitive_columnkey: Optional[pulumi.Input[builtins.str]] = None,
            sensitive_type_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DiscoveryJobsResult':
        """
    ...
    @pulumi.getter(name="discoveryJobId")
    @_utilities.deprecated("""The 'oci_data_safe_discovery_jobs_result' resource has been deprecated. It is no longer supported.""")
    def discovery_job_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the discovery job.
        """
        return pulumi.get(self, "discovery_job_id")
    ...
    @property
    @pulumi.getter(name="isResultApplied")
    def is_result_applied(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates if the discovery result has been processed. You can update this attribute using the PatchDiscoveryJobResults operation to track whether the discovery result has already been processed and applied to the sensitive data model.
        """
        return pulumi.get(self, "is_result_applied")
    ...
    @property
    @pulumi.getter(name="plannedAction")
    def planned_action(self) -> pulumi.Output[builtins.str]:
        """
        Specifies how to process the discovery result. It's set to NONE by default. Use the PatchDiscoveryJobResults operation to update this attribute. You can choose one of the following options: ACCEPT: To accept the discovery result and update the sensitive data model to reflect the changes. REJECT: To reject the discovery result so that it doesn't change the sensitive data model. INVALIDATE: To invalidate a newly discovered column. It adds the column to the sensitive data model but marks it as invalid. It helps track false positives and ensure that they aren't reported by future discovery jobs. After specifying the planned action, you can use the ApplyDiscoveryJobResults operation to automatically process the discovery results.
        """
        return pulumi.get(self, "planned_action")
    ...
    @property
    @pulumi.getter(name="sensitiveColumnkey")
    def sensitive_columnkey(self) -> pulumi.Output[builtins.str]:
        """
        The unique key that identifies the sensitive column represented by the discovery result.
        """
        return pulumi.get(self, "sensitive_columnkey")
