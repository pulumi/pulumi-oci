...
class DiscoveryModArgs:
    def __init__(__self__, *,
                 ...
                 discovery_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment where the discovery job resource should be created.
        ...
        :param pulumi.Input[builtins.str] discovery_type: The type of the discovery job. It defines the job's scope. NEW identifies new sensitive columns in the target database that are not in the sensitive data model. DELETED identifies columns that are present in the sensitive data model but have been deleted from the target database. MODIFIED identifies columns that are present in the target database as well as the sensitive data model but some of their attributes have been modified. ALL covers all the above three scenarios and reports new, deleted and modified columns.
        :param pulumi.Input[builtins.str] display_name: A user-friendly name for the discovery job. Does not have to be unique, and it is changeable. Avoid entering confidential information.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] schemas_for_discoveries: The schemas to be scanned by the discovery job. If not provided, the schemasForDiscovery attribute of the sensitive data model is used to get the list of schemas.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sensitive_type_group_ids_for_discoveries: The OCIDs of the sensitive type groups to be used by the discovery job. All the sensitive types present in sensitive type group will be used for discovery.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sensitive_type_ids_for_discoveries: The OCIDs of the sensitive types to be used by the discovery job. If not provided, the sensitiveTypeIdsForDiscovery attribute of the sensitive data model is used to get the list of sensitive types.
    ...
    def discovery_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def discovery_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DiscoveryModState:
    def __init__(__self__, *,
                 ...
                 total_columns_scanned: Optional[pulumi.Input[builtins.str]] = None,
                 total_deleted_sensitive_columns: Optional[pulumi.Input[builtins.str]] = None,
                 total_modified_sensitive_columns: Optional[pulumi.Input[builtins.str]] = None,
                 total_new_sensitive_columns: Optional[pulumi.Input[builtins.str]] = None,
                 total_objects_scanned: Optional[pulumi.Input[builtins.str]] = None,
                 total_schemas_scanned: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sensitive_type_group_ids_for_discoveries: The OCIDs of the sensitive type groups to be used by the discovery job. All the sensitive types present in sensitive type group will be used for discovery.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sensitive_type_ids_for_discoveries: The OCIDs of the sensitive types to be used by the discovery job. If not provided, the sensitiveTypeIdsForDiscovery attribute of the sensitive data model is used to get the list of sensitive types.
        :param pulumi.Input[builtins.str] state: The current state of the discovery job.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DiscoveryModTablesForDiscoveryArgs']]] tables_for_discoveries: The data discovery jobs will scan the tables specified here, including both schemas and tables. In the absence  of explicit input, the list of tables is obtained from the tablesForDiscovery attribute of the sensitive data model.
        :param pulumi.Input[builtins.str] target_id: The OCID of the target database associated with the discovery job.
        :param pulumi.Input[builtins.str] time_finished: The date and time the discovery job finished, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339)..
        :param pulumi.Input[builtins.str] time_started: The date and time the discovery job started, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] total_columns_scanned: The total number of columns scanned by the discovery job.
        :param pulumi.Input[builtins.str] total_deleted_sensitive_columns: The total number of deleted sensitive columns identified by the discovery job.
        :param pulumi.Input[builtins.str] total_modified_sensitive_columns: The total number of modified sensitive columns identified by the discovery job.
        :param pulumi.Input[builtins.str] total_new_sensitive_columns: The total number of new sensitive columns identified by the discovery job.
        :param pulumi.Input[builtins.str] total_objects_scanned: The total number of objects (tables and editioning views) scanned by the discovery job.
        :param pulumi.Input[builtins.str] total_schemas_scanned: The total number of schemas scanned by the discovery job.
        """
    ...
    def total_columns_scanned(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def total_columns_scanned(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "total_columns_scanned", value)

    @property
    @pulumi.getter(name="totalDeletedSensitiveColumns")
    def total_deleted_sensitive_columns(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def total_deleted_sensitive_columns(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "total_deleted_sensitive_columns", value)

    @property
    @pulumi.getter(name="totalModifiedSensitiveColumns")
    def total_modified_sensitive_columns(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def total_modified_sensitive_columns(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "total_modified_sensitive_columns", value)

    @property
    @pulumi.getter(name="totalNewSensitiveColumns")
    def total_new_sensitive_columns(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def total_new_sensitive_columns(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "total_new_sensitive_columns", value)

    @property
    @pulumi.getter(name="totalObjectsScanned")
    def total_objects_scanned(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def total_objects_scanned(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "total_objects_scanned", value)

    @property
    @pulumi.getter(name="totalSchemasScanned")
    def total_schemas_scanned(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def total_schemas_scanned(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DiscoveryMod(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            total_new_sensitive_columns: Optional[pulumi.Input[builtins.str]] = None,
            total_objects_scanned: Optional[pulumi.Input[builtins.str]] = None,
            total_schemas_scanned: Optional[pulumi.Input[builtins.str]] = None) -> 'DiscoveryMod':
        """
    ...
    @property
    @pulumi.getter(name="discoveryType")
    def discovery_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the discovery job. It defines the job's scope. NEW identifies new sensitive columns in the target database that are not in the sensitive data model. DELETED identifies columns that are present in the sensitive data model but have been deleted from the target database. MODIFIED identifies columns that are present in the target database as well as the sensitive data model but some of their attributes have been modified. ALL covers all the above three scenarios and reports new, deleted and modified columns.
        """
        return pulumi.get(self, "discovery_type")
    ...
    @property
    @pulumi.getter(name="totalColumnsScanned")
    def total_columns_scanned(self) -> pulumi.Output[builtins.str]:
        """
        The total number of columns scanned by the discovery job.
        """
        return pulumi.get(self, "total_columns_scanned")
    ...
    @property
    @pulumi.getter(name="totalDeletedSensitiveColumns")
    def total_deleted_sensitive_columns(self) -> pulumi.Output[builtins.str]:
        """
        The total number of deleted sensitive columns identified by the discovery job.
        """
        return pulumi.get(self, "total_deleted_sensitive_columns")
    ...
    @property
    @pulumi.getter(name="totalModifiedSensitiveColumns")
    def total_modified_sensitive_columns(self) -> pulumi.Output[builtins.str]:
        """
        The total number of modified sensitive columns identified by the discovery job.
        """
        return pulumi.get(self, "total_modified_sensitive_columns")
    ...
    @property
    @pulumi.getter(name="totalNewSensitiveColumns")
    def total_new_sensitive_columns(self) -> pulumi.Output[builtins.str]:
        """
        The total number of new sensitive columns identified by the discovery job.
        """
        return pulumi.get(self, "total_new_sensitive_columns")
    ...
    @property
    @pulumi.getter(name="totalObjectsScanned")
    def total_objects_scanned(self) -> pulumi.Output[builtins.str]:
        """
        The total number of objects (tables and editioning views) scanned by the discovery job.
        """
        return pulumi.get(self, "total_objects_scanned")
    ...
    @property
    @pulumi.getter(name="totalSchemasScanned")
    def total_schemas_scanned(self) -> pulumi.Output[builtins.str]:
        """
        The total number of schemas scanned by the discovery job.
        """
        return pulumi.get(self, "total_schemas_scanned")
