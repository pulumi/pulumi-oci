...
class GetAlertPoliciesResult:
    ...
    def is_user_defined(self) -> Optional[builtins.bool]:
        """
...
def get_alert_policies(access_level: Optional[builtins.str] = None,
                       ...
                       is_user_defined: Optional[builtins.bool] = None,
    ...
    :param builtins.bool is_user_defined: An optional filter to return only alert policies that are user-defined or not.
    ...
    :param builtins.str time_created_less_than: Search for resources that were created before a specific date. Specifying this parameter corresponding `timeCreatedLessThan` parameter will retrieve all resources created before the specified created date, in "YYYY-MM-ddThh:mmZ" format with a Z offset, as defined by RFC 3339.
           ...
           **Example:** 2016-12-19T16:39:57.600Z
    :param builtins.str type: An optional filter to return only alert policies of a certain type.
    """
    __args__ = dict()
...
def get_alert_policies_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              ...
                              is_user_defined: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
