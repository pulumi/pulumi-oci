...
class GetAlertPolicyRuleResult:
    ...
    def rule_key(self) -> builtins.str:
...
def get_alert_policy_rule(alert_policy_id: Optional[builtins.str] = None,
                          rule_key: Optional[builtins.str] = None,
    ...
    :param builtins.str rule_key: The key of the alert policy rule.
    """
    __args__ = dict()
...
def get_alert_policy_rule_output(alert_policy_id: Optional[pulumi.Input[builtins.str]] = None,
                                 rule_key: Optional[pulumi.Input[builtins.str]] = None,
