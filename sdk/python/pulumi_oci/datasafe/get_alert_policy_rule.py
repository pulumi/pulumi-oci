...
def get_alert_policy_rule(alert_policy_id: Optional[str] = None,
    ...
    test_alert_policy_rule = oci.DataSafe.get_alert_policy_rule(alert_policy_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
    ```
