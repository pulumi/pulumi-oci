...
def get_alert_policy_rules(alert_policy_id: Optional[builtins.str] = None,
...
def get_alert_policy_rules_output(alert_policy_id: Optional[pulumi.Input[builtins.str]] = None,
