...
def get_alerts(access_level: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] fields: Specifies a subset of fields to be returned in the response.
    :param builtins.str id: A filter to return alert by it's OCID.
...
def get_alerts_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
