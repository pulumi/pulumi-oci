...
class GetAuditArchiveRetrievalResult:
    ...
    def audit_archive_retrieval_id(self) -> builtins.str:
        return pulumi.get(self, "audit_archive_retrieval_id")

    @property
    @pulumi.getter(name="auditEventCount")
    def audit_event_count(self) -> builtins.str:
        """
    ...
    def time_requested(self) -> builtins.str:
        """
...
def get_audit_archive_retrieval(audit_archive_retrieval_id: Optional[builtins.str] = None,
...
def get_audit_archive_retrieval_output(audit_archive_retrieval_id: Optional[pulumi.Input[builtins.str]] = None,
