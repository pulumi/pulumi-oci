...
class GetAuditArchiveRetrievalsResult:
    ...
    def audit_archive_retrieval_id(self) -> Optional[builtins.str]:
    ...
    def time_of_expiry(self) -> Optional[builtins.str]:
        """
...
def get_audit_archive_retrievals(access_level: Optional[builtins.str] = None,
                                 audit_archive_retrieval_id: Optional[builtins.str] = None,
                                 ...
                                 time_of_expiry: Optional[builtins.str] = None,
    ...
    :param builtins.str audit_archive_retrieval_id: OCID of the archive retrieval.
    ...
    :param builtins.str state: A filter to return only resources that matches the specified lifecycle state.
    :param builtins.str target_id: The OCID of the target associated with the archive retrieval.
    :param builtins.str time_of_expiry: The date time when retrieved archive data will be deleted from Data Safe and unloaded back into archival.
    """
    __args__ = dict()
...
def get_audit_archive_retrievals_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        audit_archive_retrieval_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        ...
                                        time_of_expiry: Optional[pulumi.Input[Optional[builtins.str]]] = None,
