...
def get_audit_event_analytic(access_level: Optional[builtins.str] = None,
...
def get_audit_event_analytic_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
