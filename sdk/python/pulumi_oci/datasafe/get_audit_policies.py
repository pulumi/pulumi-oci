...
class GetAuditPoliciesResult:
    ...
    def audit_policy_id(self) -> Optional[builtins.str]:
...
def get_audit_policies(access_level: Optional[builtins.str] = None,
                       audit_policy_id: Optional[builtins.str] = None,
    ...
    :param builtins.str audit_policy_id: An optional filter to return only resources that match the specified id.
    ...
    :param builtins.str state: The current state of the audit policy.
...
def get_audit_policies_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              audit_policy_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
