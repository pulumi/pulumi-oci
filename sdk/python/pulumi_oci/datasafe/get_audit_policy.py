...
def get_audit_policy(audit_policy_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str audit_policy_id: Unique audit policy identifier.
    """
    __args__ = dict()
...
def get_audit_policy_output(audit_policy_id: Optional[pulumi.Input[_builtins.str]] = None,
