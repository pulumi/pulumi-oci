...
def get_audit_policy(audit_policy_id: Optional[str] = None,
    ...
    return AwaitableGetAuditPolicyResult(
        audit_conditions=__ret__.audit_conditions,
        audit_policy_id=__ret__.audit_policy_id,
        audit_specifications=__ret__.audit_specifications,
        ...
        id=__ret__.id,
        is_data_safe_service_account_excluded=__ret__.is_data_safe_service_account_excluded,
        lifecycle_details=__ret__.lifecycle_details,
        provision_trigger=__ret__.provision_trigger,
        retrieve_from_target_trigger=__ret__.retrieve_from_target_trigger,
        state=__ret__.state,
        system_tags=__ret__.system_tags,
        target_id=__ret__.target_id,
        time_created=__ret__.time_created,
        time_last_provisioned=__ret__.time_last_provisioned,
        time_last_retrieved=__ret__.time_last_retrieved,
