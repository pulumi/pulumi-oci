...
class GetAuditPolicyResult:
    ...
    def audit_policy_id(self) -> builtins.str:
    ...
    def is_data_safe_service_account_excluded(self) -> builtins.bool:
        """
    ...
    def provision_trigger(self) -> builtins.int:
        return pulumi.get(self, "provision_trigger")

    @property
    @pulumi.getter(name="retrieveFromTargetTrigger")
    def retrieve_from_target_trigger(self) -> builtins.int:
    ...
    def time_last_provisioned(self) -> builtins.str:
        """
    ...
    def time_last_retrieved(self) -> builtins.str:
        """
...
def get_audit_policy(audit_policy_id: Optional[builtins.str] = None,
    ...
    :param builtins.str audit_policy_id: Unique audit policy identifier.
    """
    __args__ = dict()
...
def get_audit_policy_output(audit_policy_id: Optional[pulumi.Input[builtins.str]] = None,
