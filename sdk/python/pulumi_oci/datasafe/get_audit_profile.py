...
class GetAuditProfileResult:
    ...
    def audit_collected_volume(self) -> builtins.str:
        """
    ...
    def change_retention_trigger(self) -> builtins.int:
    ...
    def is_override_global_retention_setting(self) -> builtins.bool:
        """
    ...
    def is_paid_usage_enabled(self) -> builtins.bool:
        """
    ...
    def offline_months(self) -> builtins.int:
        """
    ...
    def online_months(self) -> builtins.int:
        """
...
def get_audit_profile(audit_profile_id: Optional[builtins.str] = None,
...
def get_audit_profile_output(audit_profile_id: Optional[pulumi.Input[builtins.str]] = None,
