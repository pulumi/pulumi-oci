...
def get_audit_profile_analytic(access_level: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] group_bies: The group by parameter for summarize operation on audit.
    """
    __args__ = dict()
...
def get_audit_profile_analytic_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
