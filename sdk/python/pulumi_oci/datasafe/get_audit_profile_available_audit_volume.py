...
class GetAuditProfileAvailableAuditVolumeResult:
    ...
    def month_in_consideration_greater_than(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "month_in_consideration_greater_than")

    @_builtins.property
    @pulumi.getter(name="monthInConsiderationLessThan")
    def month_in_consideration_less_than(self) -> Optional[_builtins.str]:
...
def get_audit_profile_available_audit_volume(audit_profile_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str month_in_consideration_greater_than: Specifying `monthInConsiderationGreaterThan` parameter will retrieve all items for which the event month is greater than the date and time specified, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
           
           **Example:** 2016-12-19T00:00:00.000Z
    :param _builtins.str month_in_consideration_less_than: Specifying `monthInConsiderationLessThan` parameter will retrieve all items for which the event month is less than the date and time specified, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
...
def get_audit_profile_available_audit_volume_output(audit_profile_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                    ...
                                                    trail_location: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
