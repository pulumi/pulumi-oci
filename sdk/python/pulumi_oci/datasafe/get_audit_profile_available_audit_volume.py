...
class GetAuditProfileAvailableAuditVolumeResult:
    ...
    def trail_location(self) -> Optional[builtins.str]:
        """
...
def get_audit_profile_available_audit_volume(audit_profile_id: Optional[builtins.str] = None,
                                             ...
                                             trail_location: Optional[builtins.str] = None,
    ...
    :param builtins.str month_in_consideration_less_than: Specifying `monthInConsiderationLessThan` parameter will retrieve all items for which the event month is less than the date and time specified, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
           ...
           **Example:** 2016-12-19T00:00:00.000Z
    :param builtins.str trail_location: The audit trail location.
...
def get_audit_profile_available_audit_volume_output(audit_profile_id: Optional[pulumi.Input[builtins.str]] = None,
                                                    ...
                                                    trail_location: Optional[pulumi.Input[Optional[builtins.str]]] = None,
