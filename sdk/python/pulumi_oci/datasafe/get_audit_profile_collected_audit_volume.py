...
def get_audit_profile_collected_audit_volume(audit_profile_id: Optional[_builtins.str] = None,
...
def get_audit_profile_collected_audit_volume_output(audit_profile_id: Optional[pulumi.Input[_builtins.str]] = None,
