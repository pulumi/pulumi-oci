...
class GetAuditProfilesResult:
    ...
    def audit_collected_volume_greater_than_or_equal_to(self) -> Optional[builtins.str]:
    ...
    def audit_profile_id(self) -> Optional[builtins.str]:
        """
    ...
    def is_override_global_retention_setting(self) -> Optional[builtins.bool]:
        """
    ...
    def is_paid_usage_enabled(self) -> Optional[builtins.bool]:
        """
...
def get_audit_profiles(access_level: Optional[builtins.str] = None,
                       audit_collected_volume_greater_than_or_equal_to: Optional[builtins.str] = None,
                       audit_profile_id: Optional[builtins.str] = None,
                       ...
                       is_override_global_retention_setting: Optional[builtins.bool] = None,
                       is_paid_usage_enabled: Optional[builtins.bool] = None,
    ...
    :param builtins.str audit_collected_volume_greater_than_or_equal_to: A filter to return only items that have count of audit records collected greater than or equal to the specified value.
    :param builtins.str audit_profile_id: A optional filter to return only resources that match the specified id.
    ...
    :param builtins.bool is_override_global_retention_setting: A optional filter to return only resources that match the specified retention configured value.
    :param builtins.bool is_paid_usage_enabled: Indicates if you want to continue audit record collection beyond the free limit of one million audit records per month per target database, incurring additional charges. The default value is inherited from the global settings. You can change at the global level or at the target level.
...
def get_audit_profiles_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              audit_collected_volume_greater_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              audit_profile_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              ...
                              is_override_global_retention_setting: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                              is_paid_usage_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
