...
def get_audit_trail(audit_trail_id: Optional[str] = None,
    ...
    return AwaitableGetAuditTrailResult(
        audit_collection_start_time=__ret__.audit_collection_start_time,
        ...
        id=__ret__.id,
        is_auto_purge_enabled=__ret__.is_auto_purge_enabled,
        lifecycle_details=__ret__.lifecycle_details,
        resume_trigger=__ret__.resume_trigger,
        state=__ret__.state,
