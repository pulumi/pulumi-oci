...
def get_audit_trail_analytic(access_level: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] group_bies: The group by parameter for summarize operation on audit trail.
