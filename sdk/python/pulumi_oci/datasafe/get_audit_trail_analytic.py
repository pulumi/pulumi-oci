...
def get_audit_trail_analytic(access_level: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] group_bies: The group by parameter for summarize operation on audit trail.
...
def get_audit_trail_analytic_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
