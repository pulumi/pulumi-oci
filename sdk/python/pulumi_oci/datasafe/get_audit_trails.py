...
class GetAuditTrailsResult:
    ...
    def audit_trail_id(self) -> Optional[builtins.str]:
...
def get_audit_trails(access_level: Optional[builtins.str] = None,
                     audit_trail_id: Optional[builtins.str] = None,
    ...
    :param builtins.str audit_trail_id: A optional filter to return only resources that match the specified id.
    ...
    :param builtins.str state: A optional filter to return only resources that match the specified lifecycle state.
    :param builtins.str status: A optional filter to return only resources that match the specified sub-state of audit trail.
...
def get_audit_trails_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            audit_trail_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
