...
def get_compatible_formats_for_sensitive_type(access_level: Optional[builtins.str] = None,
...
def get_compatible_formats_for_sensitive_type_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
