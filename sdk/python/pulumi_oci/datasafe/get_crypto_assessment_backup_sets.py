...
__all__ = [
    'GetCryptoAssessmentBackupSetsResult',
    'AwaitableGetCryptoAssessmentBackupSetsResult',
    'get_crypto_assessment_backup_sets',
    'get_crypto_assessment_backup_sets_output',
]

@pulumi.output_type
class GetCryptoAssessmentBackupSetsResult:
    """
    A collection of values returned by getCryptoAssessmentBackupSets.
    """
    def __init__(__self__, access_level=None, assessment_id=None, assessment_type=None, backup_set_key=None, compartment_id=None, compartment_id_in_subtree=None, crypto_assessment_backup_set_collections=None, filters=None, id=None, is_encrypted=None, target_id=None, target_ids=None):
        ...
        if backup_set_key and not isinstance(backup_set_key, str):
            raise TypeError("Expected argument 'backup_set_key' to be a str")
        ...
        if crypto_assessment_backup_set_collections and not isinstance(crypto_assessment_backup_set_collections, list):
            raise TypeError("Expected argument 'crypto_assessment_backup_set_collections' to be a list")
        pulumi.set(__self__, "crypto_assessment_backup_set_collections", crypto_assessment_backup_set_collections)
    ...
    def backup_set_key(self) -> Optional[_builtins.str]:
        """
        Backup set key.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="cryptoAssessmentBackupSetCollections")
    def crypto_assessment_backup_set_collections(self) -> Sequence['outputs.GetCryptoAssessmentBackupSetsCryptoAssessmentBackupSetCollectionResult']:
        """
        The list of crypto_assessment_backup_set_collection.
        """
        return pulumi.get(self, "crypto_assessment_backup_set_collections")

    @_builtins.property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetCryptoAssessmentBackupSetsFilterResult']]:
...
class AwaitableGetCryptoAssessmentBackupSetsResult(GetCryptoAssessmentBackupSetsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetCryptoAssessmentBackupSetsResult(
            access_level=self.access_level,
            assessment_id=self.assessment_id,
            assessment_type=self.assessment_type,
            backup_set_key=self.backup_set_key,
            compartment_id=self.compartment_id,
            compartment_id_in_subtree=self.compartment_id_in_subtree,
            crypto_assessment_backup_set_collections=self.crypto_assessment_backup_set_collections,
...
def get_crypto_assessment_backup_sets(access_level: Optional[_builtins.str] = None,
                                      assessment_id: Optional[_builtins.str] = None,
                                      assessment_type: Optional[_builtins.str] = None,
                                      backup_set_key: Optional[_builtins.str] = None,
                                      compartment_id: Optional[_builtins.str] = None,
                                      compartment_id_in_subtree: Optional[_builtins.bool] = None,
                                      filters: Optional[Sequence[Union['GetCryptoAssessmentBackupSetsFilterArgs', 'GetCryptoAssessmentBackupSetsFilterArgsDict', 'outputs.GetCryptoAssessmentBackupSetsFilterResult']]] = None,
                                      ...
                                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetCryptoAssessmentBackupSetsResult:
    """
    ...
    __args__['backupSetKey'] = backup_set_key
    __args__['compartmentId'] = compartment_id
    __args__['compartmentIdInSubtree'] = compartment_id_in_subtree
    __args__['filters'] = filters
    __args__['isEncrypted'] = is_encrypted
    __args__['targetId'] = target_id
    __args__['targetIds'] = target_ids
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:DataSafe/getCryptoAssessmentBackupSets:getCryptoAssessmentBackupSets', __args__, opts=opts, typ=GetCryptoAssessmentBackupSetsResult).value

    return AwaitableGetCryptoAssessmentBackupSetsResult(
        access_level=pulumi.get(__ret__, 'access_level'),
        assessment_id=pulumi.get(__ret__, 'assessment_id'),
        assessment_type=pulumi.get(__ret__, 'assessment_type'),
        backup_set_key=pulumi.get(__ret__, 'backup_set_key'),
        compartment_id=pulumi.get(__ret__, 'compartment_id'),
        compartment_id_in_subtree=pulumi.get(__ret__, 'compartment_id_in_subtree'),
        crypto_assessment_backup_set_collections=pulumi.get(__ret__, 'crypto_assessment_backup_set_collections'),
        filters=pulumi.get(__ret__, 'filters'),
        id=pulumi.get(__ret__, 'id'),
        is_encrypted=pulumi.get(__ret__, 'is_encrypted'),
        target_id=pulumi.get(__ret__, 'target_id'),
        target_ids=pulumi.get(__ret__, 'target_ids'))
def get_crypto_assessment_backup_sets_output(access_level: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                             ...
                                             backup_set_key: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                             compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                                             compartment_id_in_subtree: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                             filters: pulumi.Input[Optional[Optional[Sequence[Union['GetCryptoAssessmentBackupSetsFilterArgs', 'GetCryptoAssessmentBackupSetsFilterArgsDict', 'outputs.GetCryptoAssessmentBackupSetsFilterResult']]]]] = None,
                                             is_encrypted: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                             ...
                                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetCryptoAssessmentBackupSetsResult]:
    """
    This data source provides the list of Crypto Assessment Backup Sets in Oracle Cloud Infrastructure Data Safe service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:DataSafe/getCryptoAssessmentBackupSets:getCryptoAssessmentBackupSets', __args__, opts=opts, typ=GetCryptoAssessmentBackupSetsResult)
    return __ret__.apply(lambda __response__: GetCryptoAssessmentBackupSetsResult(
        access_level=pulumi.get(__response__, 'access_level'),
        assessment_id=pulumi.get(__response__, 'assessment_id'),
        assessment_type=pulumi.get(__response__, 'assessment_type'),
        backup_set_key=pulumi.get(__response__, 'backup_set_key'),
        compartment_id=pulumi.get(__response__, 'compartment_id'),
        compartment_id_in_subtree=pulumi.get(__response__, 'compartment_id_in_subtree'),
        crypto_assessment_backup_set_collections=pulumi.get(__response__, 'crypto_assessment_backup_set_collections'),
