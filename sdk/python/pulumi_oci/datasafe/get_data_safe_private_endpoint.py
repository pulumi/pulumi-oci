...
class GetDataSafePrivateEndpointResult:
    ...
    def data_safe_private_endpoint_id(self) -> _builtins.str:
...
def get_data_safe_private_endpoint(data_safe_private_endpoint_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str data_safe_private_endpoint_id: The OCID of the private endpoint.
    """
    __args__ = dict()
...
def get_data_safe_private_endpoint_output(data_safe_private_endpoint_id: Optional[pulumi.Input[_builtins.str]] = None,
