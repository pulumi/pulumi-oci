...
class GetDataSafePrivateEndpointResult:
    ...
    def data_safe_private_endpoint_id(self) -> builtins.str:
...
def get_data_safe_private_endpoint(data_safe_private_endpoint_id: Optional[builtins.str] = None,
    ...
    :param builtins.str data_safe_private_endpoint_id: The OCID of the private endpoint.
    """
    __args__ = dict()
...
def get_data_safe_private_endpoint_output(data_safe_private_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
