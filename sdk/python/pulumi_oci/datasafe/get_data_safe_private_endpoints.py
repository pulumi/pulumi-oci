...
def get_data_safe_private_endpoints(access_level: Optional[builtins.str] = None,
    ...
    :param builtins.str vcn_id: A filter to return only resources that match the specified VCN OCID.
    """
    __args__ = dict()
...
def get_data_safe_private_endpoints_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
