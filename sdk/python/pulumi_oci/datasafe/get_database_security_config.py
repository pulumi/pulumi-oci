...
class GetDatabaseSecurityConfigResult:
    ...
    def database_security_config_id(self) -> builtins.str:
    ...
    def time_last_refreshed(self) -> builtins.str:
        """
...
def get_database_security_config(database_security_config_id: Optional[builtins.str] = None,
    ...
    :param builtins.str database_security_config_id: The OCID of the database security configuration resource.
    """
    __args__ = dict()
...
def get_database_security_config_output(database_security_config_id: Optional[pulumi.Input[builtins.str]] = None,
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDatabaseSecurityConfigResult]:
    """
    This data source provides details about a specific Database Security Config resource in Oracle Cloud Infrastructure Data Safe service.
