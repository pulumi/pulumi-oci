...
def get_database_security_config(database_security_config_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str database_security_config_id: The OCID of the database security configuration resource.
    """
    __args__ = dict()
...
def get_database_security_config_output(database_security_config_id: Optional[pulumi.Input[_builtins.str]] = None,
