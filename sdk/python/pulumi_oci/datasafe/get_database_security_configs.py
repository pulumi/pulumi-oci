...
class GetDatabaseSecurityConfigsResult:
    ...
    def database_security_config_id(self) -> Optional[_builtins.str]:
...
def get_database_security_configs(access_level: Optional[_builtins.str] = None,
                                  compartment_id: Optional[_builtins.str] = None,
                                  compartment_id_in_subtree: Optional[_builtins.bool] = None,
                                  database_security_config_id: Optional[_builtins.str] = None,
                                  display_name: Optional[_builtins.str] = None,
                                  filters: Optional[Sequence[Union['GetDatabaseSecurityConfigsFilterArgs', 'GetDatabaseSecurityConfigsFilterArgsDict', 'outputs.GetDatabaseSecurityConfigsFilterResult']]] = None,
...
def get_database_security_configs_output(access_level: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                         ...
                                         filters: pulumi.Input[Optional[Optional[Sequence[Union['GetDatabaseSecurityConfigsFilterArgs', 'GetDatabaseSecurityConfigsFilterArgsDict', 'outputs.GetDatabaseSecurityConfigsFilterResult']]]]] = None,
