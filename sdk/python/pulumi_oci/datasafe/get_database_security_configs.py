...
class GetDatabaseSecurityConfigsResult:
    ...
    def database_security_config_id(self) -> Optional[builtins.str]:
...
def get_database_security_configs(access_level: Optional[builtins.str] = None,
                                  compartment_id: Optional[builtins.str] = None,
                                  compartment_id_in_subtree: Optional[builtins.bool] = None,
                                  database_security_config_id: Optional[builtins.str] = None,
    ...
    :param builtins.str database_security_config_id: An optional filter to return only resources that match the specified OCID of the database security configuration resource.
    :param builtins.str display_name: A filter to return only resources that match the specified display name.
    :param builtins.str state: The current state of the database security configuration.
...
def get_database_security_configs_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                         compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                         compartment_id_in_subtree: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                         database_security_config_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
