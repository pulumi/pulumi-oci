...
def get_discovery_analytic(compartment_id: Optional[builtins.str] = None,
...
def get_discovery_analytic_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
