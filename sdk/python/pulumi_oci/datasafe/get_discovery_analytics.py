...
def get_discovery_analytics(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str group_by: Attribute by which the discovery analytics data should be grouped.
...
def get_discovery_analytics_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
