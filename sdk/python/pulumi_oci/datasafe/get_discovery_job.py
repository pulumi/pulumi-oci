...
def get_discovery_job(discovery_job_id: Optional[str] = None,
    ...
    return AwaitableGetDiscoveryJobResult(
        ...
        total_columns_scanned=__ret__.total_columns_scanned,
        total_deleted_sensitive_columns=__ret__.total_deleted_sensitive_columns,
        total_modified_sensitive_columns=__ret__.total_modified_sensitive_columns,
        total_new_sensitive_columns=__ret__.total_new_sensitive_columns,
        total_objects_scanned=__ret__.total_objects_scanned,
        total_schemas_scanned=__ret__.total_schemas_scanned)
