...
class GetDiscoveryJobsResultResult:
    ...
    def app_defined_child_column_keys(self) -> Sequence[builtins.str]:
        """
    ...
    def db_defined_child_column_keys(self) -> Sequence[builtins.str]:
        """
    ...
    def estimated_data_value_count(self) -> builtins.str:
        """
    ...
    def is_result_applied(self) -> builtins.bool:
        """
    ...
    def parent_column_keys(self) -> Sequence[builtins.str]:
        """
    ...
    def result_key(self) -> builtins.str:
        return pulumi.get(self, "result_key")

    @property
    @pulumi.getter(name="sampleDataValues")
    def sample_data_values(self) -> Sequence[builtins.str]:
        """
...
def get_discovery_jobs_result(discovery_job_id: Optional[builtins.str] = None,
                              result_key: Optional[builtins.str] = None,
    ...
    :param builtins.str result_key: The unique key that identifies the discovery result.
    """
    __args__ = dict()
...
def get_discovery_jobs_result_output(discovery_job_id: Optional[pulumi.Input[builtins.str]] = None,
                                     result_key: Optional[pulumi.Input[builtins.str]] = None,
