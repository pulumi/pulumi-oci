...
class GetDiscoveryJobsResultResult:
    ...
    def result_key(self) -> _builtins.str:
...
def get_discovery_jobs_result(discovery_job_id: Optional[_builtins.str] = None,
                              result_key: Optional[_builtins.str] = None,
    ...
    :param _builtins.str result_key: The unique key that identifies the discovery result.
    """
    __args__ = dict()
