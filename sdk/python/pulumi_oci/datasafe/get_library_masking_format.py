...
class GetLibraryMaskingFormatResult:
    ...
    def library_masking_format_id(self) -> builtins.str:
        """
        The OCID of the library masking format.
        """
    ...
    def sensitive_type_ids(self) -> Sequence[builtins.str]:
        """
...
def get_library_masking_format(library_masking_format_id: Optional[builtins.str] = None,
    ...
    :param builtins.str library_masking_format_id: The OCID of the library masking format.
    """
    __args__ = dict()
...
def get_library_masking_format_output(library_masking_format_id: Optional[pulumi.Input[builtins.str]] = None,
