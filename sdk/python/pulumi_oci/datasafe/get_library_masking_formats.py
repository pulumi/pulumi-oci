...
def get_library_masking_formats(access_level: Optional[str] = None,
    ...
    test_library_masking_formats = oci.DataSafe.get_library_masking_formats(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        ...
        library_masking_format_source=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetLibraryMaskingFormatsResult(
        ...
        id=__ret__.id,
        library_masking_format_collections=__ret__.library_masking_format_collections,
        library_masking_format_id=__ret__.library_masking_format_id,
        library_masking_format_source=__ret__.library_masking_format_source,
        state=__ret__.state,
