...
class GetLibraryMaskingFormatsResult:
    ...
    def library_masking_format_id(self) -> Optional[builtins.str]:
        """
    ...
    def library_masking_format_source(self) -> Optional[builtins.str]:
...
def get_library_masking_formats(access_level: Optional[builtins.str] = None,
                                ...
                                library_masking_format_id: Optional[builtins.str] = None,
                                library_masking_format_source: Optional[builtins.str] = None,
    ...
    :param builtins.str library_masking_format_id: A filter to return only the resources that match the specified library masking format OCID.
    :param builtins.str library_masking_format_source: A filter to return the library masking format resources based on the value of their source attribute.
...
def get_library_masking_formats_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       ...
                                       library_masking_format_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       library_masking_format_source: Optional[pulumi.Input[Optional[builtins.str]]] = None,
