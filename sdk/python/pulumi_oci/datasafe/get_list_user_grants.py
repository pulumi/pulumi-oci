...
class GetListUserGrantsResult:
    ...
    def depth_level(self) -> Optional[builtins.int]:
        """
    ...
    def depth_level_greater_than_or_equal_to(self) -> Optional[builtins.int]:
        return pulumi.get(self, "depth_level_greater_than_or_equal_to")

    @property
    @pulumi.getter(name="depthLevelLessThan")
    def depth_level_less_than(self) -> Optional[builtins.int]:
    ...
    def grant_key(self) -> Optional[builtins.str]:
    ...
    def privilege_category(self) -> Optional[builtins.str]:
        """
...
def get_list_user_grants(depth_level: Optional[builtins.int] = None,
                         depth_level_greater_than_or_equal_to: Optional[builtins.int] = None,
                         depth_level_less_than: Optional[builtins.int] = None,
                         filters: Optional[Sequence[Union['GetListUserGrantsFilterArgs', 'GetListUserGrantsFilterArgsDict']]] = None,
                         grant_key: Optional[builtins.str] = None,
                         grant_name: Optional[builtins.str] = None,
                         privilege_category: Optional[builtins.str] = None,
    ...
    :param builtins.int depth_level: A filter to return only items that match the specified user grant depth level.
    :param builtins.int depth_level_greater_than_or_equal_to: A filter to return only items that are at a level greater than or equal to the specified user grant depth level.
    :param builtins.int depth_level_less_than: A filter to return only items that are at a level less than the specified user grant depth level.
    :param builtins.str grant_key: A filter to return only items that match the specified user grant key.
    :param builtins.str grant_name: A filter to return only items that match the specified user grant name.
    :param builtins.str privilege_category: A filter to return only items that match the specified user privilege category.
    :param builtins.str privilege_type: A filter to return only items that match the specified privilege grant type.
    :param builtins.str user_assessment_id: The OCID of the user assessment.
    :param builtins.str user_key: The unique user key. This is a system-generated identifier. ListUsers gets the user key for a user.
    """
    __args__ = dict()
...
def get_list_user_grants_output(depth_level: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                depth_level_greater_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                depth_level_less_than: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                filters: Optional[pulumi.Input[Optional[Sequence[Union['GetListUserGrantsFilterArgs', 'GetListUserGrantsFilterArgsDict']]]]] = None,
                                grant_key: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                grant_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                privilege_category: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                privilege_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                user_assessment_id: Optional[pulumi.Input[builtins.str]] = None,
                                user_key: Optional[pulumi.Input[builtins.str]] = None,
