...
def get_masking_analytic(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str group_by: Attribute by which the masking analytics data should be grouped.
...
def get_masking_analytic_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                compartment_id_in_subtree: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                group_by: Optional[pulumi.Input[Optional[builtins.str]]] = None,
