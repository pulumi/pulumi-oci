...
def get_masking_analytics(compartment_id: Optional[str] = None,
    ...
    test_masking_analytics = oci.DataSafe.get_masking_analytics(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
