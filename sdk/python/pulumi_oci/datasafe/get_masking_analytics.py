...
def get_masking_analytics(compartment_id: Optional[builtins.str] = None,
...
def get_masking_analytics_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
