...
def get_masking_policies(access_level: Optional[str] = None,
                         ...
                         filters: Optional[Sequence[pulumi.InputType['GetMaskingPoliciesFilterArgs']]] = None,
    ...
    test_masking_policies = oci.DataSafe.get_masking_policies(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
...
def get_masking_policies_output(access_level: Optional[pulumi.Input[Optional[str]]] = None,
                                ...
                                filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetMaskingPoliciesFilterArgs']]]]] = None,
