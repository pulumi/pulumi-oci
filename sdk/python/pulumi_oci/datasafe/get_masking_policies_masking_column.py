...
class GetMaskingPoliciesMaskingColumnResult:
    ...
    def child_columns(self) -> Sequence[builtins.str]:
        """
    ...
    def is_masking_enabled(self) -> builtins.bool:
        """
    ...
    def masking_column_group(self) -> builtins.str:
        """
    ...
    def masking_column_key(self) -> builtins.str:
...
def get_masking_policies_masking_column(masking_column_key: Optional[builtins.str] = None,
    ...
    :param builtins.str masking_column_key: The unique key that identifies the masking column. It's numeric and unique within a masking policy.
...
def get_masking_policies_masking_column_output(masking_column_key: Optional[pulumi.Input[builtins.str]] = None,
