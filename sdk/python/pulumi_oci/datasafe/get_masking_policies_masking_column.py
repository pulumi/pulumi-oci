...
class GetMaskingPoliciesMaskingColumnResult:
    ...
    def masking_column_key(self) -> _builtins.str:
...
def get_masking_policies_masking_column(masking_column_key: Optional[_builtins.str] = None,
    ...
    :param _builtins.str masking_column_key: The unique key that identifies the masking column. It's numeric and unique within a masking policy.
