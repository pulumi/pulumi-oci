...
class GetMaskingPoliciesMaskingColumnsResult:
    ...
    def is_masking_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def is_seed_required(self) -> Optional[builtins.bool]:
    ...
    def masking_column_lifecycle_state(self) -> Optional[builtins.str]:
...
def get_masking_policies_masking_columns(column_names: Optional[Sequence[builtins.str]] = None,
                                         ...
                                         is_masking_enabled: Optional[builtins.bool] = None,
                                         is_seed_required: Optional[builtins.bool] = None,
                                         masking_column_groups: Optional[Sequence[builtins.str]] = None,
                                         masking_column_lifecycle_state: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] data_types: A filter to return only resources that match the specified data types.
    :param builtins.bool is_masking_enabled: A filter to return the masking column resources based on the value of their isMaskingEnabled attribute. A value of true returns only those columns for which masking is enabled. A value of false returns only those columns for which masking is disabled. Omitting this parameter returns all the masking columns in a masking policy.
    :param builtins.bool is_seed_required: A filter to return masking columns based on whether the assigned masking formats need a seed value for masking. A value of true returns those masking columns that are using Deterministic Encryption or Deterministic Substitution masking format.
    ...
    :param builtins.str masking_column_lifecycle_state: A filter to return only the resources that match the specified lifecycle states.
...
def get_masking_policies_masking_columns_output(column_names: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                                ...
                                                is_masking_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                                is_seed_required: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                                masking_column_groups: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                                masking_column_lifecycle_state: Optional[pulumi.Input[Optional[builtins.str]]] = None,
