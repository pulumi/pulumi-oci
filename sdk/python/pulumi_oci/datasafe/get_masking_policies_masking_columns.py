...
class GetMaskingPoliciesMaskingColumnsResult:
    ...
    def is_masking_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def is_seed_required(self) -> Optional[_builtins.bool]:
    ...
    def masking_column_lifecycle_state(self) -> Optional[_builtins.str]:
...
def get_masking_policies_masking_columns(column_names: Optional[Sequence[_builtins.str]] = None,
                                         ...
                                         masking_column_lifecycle_state: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] data_types: A filter to return only resources that match the specified data types.
    ...
    :param _builtins.bool is_seed_required: A filter to return masking columns based on whether the assigned masking formats need a seed value for masking. A value of true returns those masking columns that are using Deterministic Encryption or Deterministic Substitution masking format.
    ...
    :param _builtins.str masking_column_lifecycle_state: A filter to return only the resources that match the specified lifecycle states.
