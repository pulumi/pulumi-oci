...
def get_masking_policy(masking_policy_id: Optional[str] = None,
    ...
    return AwaitableGetMaskingPolicyResult(
        add_masking_columns_from_sdm_trigger=__ret__.add_masking_columns_from_sdm_trigger,
        column_sources=__ret__.column_sources,
        ...
        post_masking_script=__ret__.post_masking_script,
        pre_masking_script=__ret__.pre_masking_script,
