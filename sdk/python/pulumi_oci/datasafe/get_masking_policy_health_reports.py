...
class GetMaskingPolicyHealthReportsResult:
    ...
    def masking_policy_health_report_id(self) -> Optional[builtins.str]:
...
def get_masking_policy_health_reports(access_level: Optional[builtins.str] = None,
    ...
    :param builtins.str masking_policy_health_report_id: A filter to return only the resources that match the specified masking policy health report OCID.
...
def get_masking_policy_health_reports_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                             ...
                                             masking_policy_health_report_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
