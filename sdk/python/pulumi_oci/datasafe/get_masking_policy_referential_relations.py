...
def get_masking_policy_referential_relations(column_names: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] relation_types: A filter to return columns based on their relationship with their parent columns. If set to NONE, it returns the columns that do not have any parent. The response includes the parent columns as well as the independent columns that are not in any relationship. If set to APP_DEFINED, it returns all the child columns that have application-level (non-dictionary) relationship with their parents. If set to DB_DEFINED, it returns all the child columns that have database-level (dictionary-defined) relationship with their parents.
...
def get_masking_policy_referential_relations_output(column_names: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
