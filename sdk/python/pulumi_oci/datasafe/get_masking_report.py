...
def get_masking_report(masking_report_id: Optional[_builtins.str] = None,
...
def get_masking_report_output(masking_report_id: Optional[pulumi.Input[_builtins.str]] = None,
