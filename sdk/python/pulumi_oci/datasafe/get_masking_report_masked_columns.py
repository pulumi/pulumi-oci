...
def get_masking_report_masked_columns(column_names: Optional[Sequence[builtins.str]] = None,
...
def get_masking_report_masked_columns_output(column_names: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
