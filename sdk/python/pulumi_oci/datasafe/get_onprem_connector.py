...
class GetOnpremConnectorResult:
    ...
    def created_version(self) -> builtins.str:
        """
    ...
    def on_prem_connector_id(self) -> builtins.str:
...
def get_onprem_connector(on_prem_connector_id: Optional[builtins.str] = None,
    ...
    :param builtins.str on_prem_connector_id: The OCID of the on-premises connector.
    """
    __args__ = dict()
...
def get_onprem_connector_output(on_prem_connector_id: Optional[pulumi.Input[builtins.str]] = None,
