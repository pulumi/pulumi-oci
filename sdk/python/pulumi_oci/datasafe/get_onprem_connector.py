...
def get_onprem_connector(on_prem_connector_id: Optional[_builtins.str] = None,
...
def get_onprem_connector_output(on_prem_connector_id: Optional[pulumi.Input[_builtins.str]] = None,
