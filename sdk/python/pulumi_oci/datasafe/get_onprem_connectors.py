...
class GetOnpremConnectorsResult:
    ...
    def on_prem_connector_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "on_prem_connector_id")

    @property
    @pulumi.getter(name="onPremConnectorLifecycleState")
    def on_prem_connector_lifecycle_state(self) -> Optional[builtins.str]:
...
def get_onprem_connectors(access_level: Optional[builtins.str] = None,
                          ...
                          on_prem_connector_id: Optional[builtins.str] = None,
                          on_prem_connector_lifecycle_state: Optional[builtins.str] = None,
    ...
    :param builtins.str on_prem_connector_id: A filter to return only the on-premises connector that matches the specified id.
    :param builtins.str on_prem_connector_lifecycle_state: A filter to return only on-premises connector resources that match the specified lifecycle state.
    """
    __args__ = dict()
...
def get_onprem_connectors_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 ...
                                 on_prem_connector_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 on_prem_connector_lifecycle_state: Optional[pulumi.Input[Optional[builtins.str]]] = None,
