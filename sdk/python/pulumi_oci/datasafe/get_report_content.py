...
def get_report_content(report_id: Optional[builtins.str] = None,
    ...
    :param builtins.str report_id: Unique report identifier
    """
    __args__ = dict()
...
def get_report_content_output(report_id: Optional[pulumi.Input[builtins.str]] = None,
