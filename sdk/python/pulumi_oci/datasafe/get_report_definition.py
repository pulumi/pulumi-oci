...
def get_report_definition(report_definition_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str report_definition_id: Unique report definition identifier
    """
    __args__ = dict()
