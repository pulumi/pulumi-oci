...
class GetReportDefinitionsResult:
    ...
    def is_seeded(self) -> Optional[builtins.bool]:
        """
...
def get_report_definitions(access_level: Optional[builtins.str] = None,
                           ...
                           is_seeded: Optional[builtins.bool] = None,
    ...
    :param builtins.str category: An optional filter to return only resources that match the specified category.
    ...
    :param builtins.str data_source: Specifies the name of a resource that provides data for the report. For example  alerts, events.
    :param builtins.str display_name: The name of the report definition to query.
    :param builtins.bool is_seeded: A boolean flag indicating to list seeded report definitions. Set this parameter to get list of seeded report definitions.
...
def get_report_definitions_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  ...
                                  data_source: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  ...
                                  is_seeded: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
