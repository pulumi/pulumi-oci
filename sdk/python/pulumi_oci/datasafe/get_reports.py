...
class GetReportsResult:
    ...
    def report_definition_id(self) -> Optional[builtins.str]:
        """
    ...
    def time_generated_greater_than_or_equal_to(self) -> Optional[builtins.str]:
        return pulumi.get(self, "time_generated_greater_than_or_equal_to")

    @property
    @pulumi.getter(name="timeGeneratedLessThan")
    def time_generated_less_than(self) -> Optional[builtins.str]:
...
def get_reports(access_level: Optional[builtins.str] = None,
                ...
                report_definition_id: Optional[builtins.str] = None,
                state: Optional[builtins.str] = None,
                time_generated_greater_than_or_equal_to: Optional[builtins.str] = None,
                time_generated_less_than: Optional[builtins.str] = None,
    ...
    :param builtins.str display_name: The name of the report definition to query.
    :param builtins.str mime_type: An optional filter to return only resources that match the specified mime type.
    :param builtins.str report_definition_id: The ID of the report definition to filter the list of reports
    :param builtins.str state: An optional filter to return only resources that match the specified lifecycle state.
    :param builtins.str time_generated_greater_than_or_equal_to: A filter to return only the resources that were generated after the specified date and time, as defined by [RFC3339](https://tools.ietf.org/html/rfc3339). Using TimeGeneratedGreaterThanOrEqualToQueryParam parameter retrieves all resources generated after that date.
           
           **Example:** 2016-12-19T16:39:57.600Z
    :param builtins.str time_generated_less_than: Search for resources that were generated before a specific date. Specifying this parameter corresponding `timeGeneratedLessThan` parameter will retrieve all resources generated before the specified generated date, in "YYYY-MM-ddThh:mmZ" format with a Z offset, as defined by RFC 3339.
           
           **Example:** 2016-12-19T16:39:57.600Z
    :param builtins.str type: An optional filter to return only resources that match the specified type.
    """
    __args__ = dict()
...
def get_reports_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       ...
                       mime_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       report_definition_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       state: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       time_generated_greater_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       time_generated_less_than: Optional[pulumi.Input[Optional[builtins.str]]] = None,
