...
class GetSdmMaskingPolicyDifferenceDifferenceColumnsResult:
    ...
    def difference_type(self) -> Optional[builtins.str]:
        """
...
def get_sdm_masking_policy_difference_difference_columns(column_names: Optional[Sequence[builtins.str]] = None,
                                                         difference_type: Optional[builtins.str] = None,
    ...
    :param builtins.str difference_type: A filter to return only the SDM masking policy difference columns that match the specified difference type
    :param Sequence[builtins.str] objects: A filter to return only items related to a specific object name.
    :param builtins.str planned_action: A filter to return only the SDM masking policy difference columns that match the specified planned action.
    ...
    :param builtins.str sync_status: A filter to return the SDM masking policy difference columns based on the value of their syncStatus attribute.
    """
    __args__ = dict()
...
def get_sdm_masking_policy_difference_difference_columns_output(column_names: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                                                difference_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
