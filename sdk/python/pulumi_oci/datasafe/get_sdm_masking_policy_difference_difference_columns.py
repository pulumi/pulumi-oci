...
class GetSdmMaskingPolicyDifferenceDifferenceColumnsResult:
    ...
    def sdm_masking_policy_difference_column_collections(self) -> Optional[Sequence['outputs.GetSdmMaskingPolicyDifferenceDifferenceColumnsSdmMaskingPolicyDifferenceColumnCollectionResult']]:
