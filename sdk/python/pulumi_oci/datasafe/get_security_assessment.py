...
class GetSecurityAssessmentResult:
    ...
    def ignored_targets(self) -> Sequence[builtins.str]:
        """
        List containing maps as values. Example: `{"Operations": [ {"CostCenter": "42"} ] }`
        """
    ...
    def schedule_security_assessment_id(self) -> builtins.str:
        """
...
def get_security_assessment(security_assessment_id: Optional[builtins.str] = None,
...
def get_security_assessment_output(security_assessment_id: Optional[pulumi.Input[builtins.str]] = None,
