...
class GetSecurityAssessmentComparisonResult:
    ...
    def comparison_security_assessment_id(self) -> builtins.str:
...
def get_security_assessment_comparison(comparison_security_assessment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str comparison_security_assessment_id: The OCID of the security assessment baseline.
...
def get_security_assessment_comparison_output(comparison_security_assessment_id: Optional[pulumi.Input[builtins.str]] = None,
