...
class GetSecurityAssessmentFindingResult:
    ...
    @_builtins.property
    @pulumi.getter
    def references(self) -> Optional[_builtins.str]:
...
def get_security_assessment_finding(access_level: Optional[_builtins.str] = None,
                                    ...
                                    filters: Optional[Sequence[Union['GetSecurityAssessmentFindingFilterArgs', 'GetSecurityAssessmentFindingFilterArgsDict', 'outputs.GetSecurityAssessmentFindingFilterResult']]] = None,
                                    finding_key: Optional[_builtins.str] = None,
                                    is_top_finding: Optional[_builtins.bool] = None,
                                    references: Optional[_builtins.str] = None,
...
def get_security_assessment_finding_output(access_level: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                           ...
                                           filters: pulumi.Input[Optional[Optional[Sequence[Union['GetSecurityAssessmentFindingFilterArgs', 'GetSecurityAssessmentFindingFilterArgsDict', 'outputs.GetSecurityAssessmentFindingFilterResult']]]]] = None,
                                           finding_key: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                           is_top_finding: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                           references: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
