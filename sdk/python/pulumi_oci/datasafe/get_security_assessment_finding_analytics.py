...
class GetSecurityAssessmentFindingAnalyticsResult:
    ...
    def top_finding_status(self) -> Optional[builtins.str]:
        """
...
def get_security_assessment_finding_analytics(access_level: Optional[builtins.str] = None,
                                              ...
                                              top_finding_status: Optional[builtins.str] = None,
    ...
    :param builtins.str group_by: Attribute by which the finding analytics data should be grouped.
    :param builtins.bool is_top_finding: A filter to return only the findings that are marked as top findings.
    :param builtins.str severity: A filter to return only findings of a particular risk level.
    :param builtins.str top_finding_status: An optional filter to return only the top finding that match the specified status.
    """
    __args__ = dict()
...
def get_security_assessment_finding_analytics_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                     ...
                                                     top_finding_status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
