...
def get_security_assessment_findings(access_level: Optional[builtins.str] = None,
    ...
    :param builtins.str finding_key: Each finding in security assessment has an associated key (think of key as a finding's name). For a given finding, the key will be the same across targets. The user can use these keys to filter the findings.
    :param builtins.bool is_top_finding: A filter to return only the findings that are marked as top findings.
    :param builtins.str references: An optional filter to return only findings that match the specified reference.
    ...
    :param builtins.str state: A filter to return only the findings that match the specified lifecycle states.
...
def get_security_assessment_findings_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
