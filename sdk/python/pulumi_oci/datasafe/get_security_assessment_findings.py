...
def get_security_assessment_findings(access_level: Optional[_builtins.str] = None,
                                     ...
                                     filters: Optional[Sequence[Union['GetSecurityAssessmentFindingsFilterArgs', 'GetSecurityAssessmentFindingsFilterArgsDict', 'outputs.GetSecurityAssessmentFindingsFilterResult']]] = None,
    ...
    :param _builtins.str references: An optional filter to return only findings that match the specified reference.
...
def get_security_assessment_findings_output(access_level: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                            ...
                                            filters: pulumi.Input[Optional[Optional[Sequence[Union['GetSecurityAssessmentFindingsFilterArgs', 'GetSecurityAssessmentFindingsFilterArgsDict', 'outputs.GetSecurityAssessmentFindingsFilterResult']]]]] = None,
