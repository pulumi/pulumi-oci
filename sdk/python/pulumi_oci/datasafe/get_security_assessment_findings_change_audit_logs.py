...
class GetSecurityAssessmentFindingsChangeAuditLogsResult:
    ...
    def finding_key(self) -> Optional[builtins.str]:
        """
    ...
    def finding_title(self) -> Optional[builtins.str]:
        """
    ...
    def is_risk_deferred(self) -> Optional[builtins.bool]:
        """
    ...
    def modified_by(self) -> Optional[builtins.str]:
        """
    ...
    def security_assessment_id(self) -> builtins.str:
    ...
    def time_valid_until_greater_than_or_equal_to(self) -> Optional[builtins.str]:
        return pulumi.get(self, "time_valid_until_greater_than_or_equal_to")

    @property
    @pulumi.getter(name="timeValidUntilLessThan")
    def time_valid_until_less_than(self) -> Optional[builtins.str]:
...
def get_security_assessment_findings_change_audit_logs(filters: Optional[Sequence[Union['GetSecurityAssessmentFindingsChangeAuditLogsFilterArgs', 'GetSecurityAssessmentFindingsChangeAuditLogsFilterArgsDict']]] = None,
                                                       finding_key: Optional[builtins.str] = None,
                                                       finding_title: Optional[builtins.str] = None,
                                                       is_risk_deferred: Optional[builtins.bool] = None,
                                                       modified_by: Optional[builtins.str] = None,
                                                       security_assessment_id: Optional[builtins.str] = None,
                                                       ...
                                                       time_valid_until_greater_than_or_equal_to: Optional[builtins.str] = None,
                                                       time_valid_until_less_than: Optional[builtins.str] = None,
    ...
    :param builtins.str finding_key: The unique key that identifies the finding. It is a string and unique within a security assessment.
    :param builtins.str finding_title: The unique title that identifies the finding. It is a string and unique within a security assessment.
    :param builtins.bool is_risk_deferred: A filter to check findings whose risks were deferred by the user.
    :param builtins.str modified_by: A filter to check which user modified the risk level of the finding.
    :param builtins.str security_assessment_id: The OCID of the security assessment.
    :param builtins.str severity: A filter to return only findings of a particular risk level.
    ...
    :param builtins.str time_valid_until_greater_than_or_equal_to: Specifying `TimeValidUntilGreaterThanOrEqualToQueryParam` parameter  will retrieve all items for which the risk level modification by user will  no longer be valid greater than the date and time specified, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
           
           **Example:** 2016-12-19T00:00:00.000Z
    :param builtins.str time_valid_until_less_than: Specifying `TimeValidUntilLessThanQueryParam` parameter will retrieve all items for which the risk level modification by user will  be valid until less than the date and time specified, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
...
def get_security_assessment_findings_change_audit_logs_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetSecurityAssessmentFindingsChangeAuditLogsFilterArgs', 'GetSecurityAssessmentFindingsChangeAuditLogsFilterArgsDict']]]]] = None,
                                                              finding_key: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                              finding_title: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                              is_risk_deferred: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                                              modified_by: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                              security_assessment_id: Optional[pulumi.Input[builtins.str]] = None,
                                                              severity: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                              ...
                                                              time_valid_until_greater_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                              time_valid_until_less_than: Optional[pulumi.Input[Optional[builtins.str]]] = None,
