...
def get_security_assessment_security_feature_analytics(access_level: Optional[builtins.str] = None,
...
def get_security_assessment_security_feature_analytics_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
