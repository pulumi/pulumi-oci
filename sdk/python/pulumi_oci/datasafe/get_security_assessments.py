...
class GetSecurityAssessmentsResult:
    ...
    def is_baseline(self) -> Optional[builtins.bool]:
        """
    ...
    def is_schedule_assessment(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "is_schedule_assessment")

    @property
    @pulumi.getter(name="scheduleAssessmentId")
    def schedule_assessment_id(self) -> Optional[builtins.str]:
    ...
    def triggered_by(self) -> Optional[builtins.str]:
        """
...
def get_security_assessments(access_level: Optional[builtins.str] = None,
                             compartment_id: Optional[builtins.str] = None,
                             compartment_id_in_subtree: Optional[builtins.bool] = None,
                             display_name: Optional[builtins.str] = None,
                             filters: Optional[Sequence[Union['GetSecurityAssessmentsFilterArgs', 'GetSecurityAssessmentsFilterArgsDict']]] = None,
                             is_baseline: Optional[builtins.bool] = None,
                             is_schedule_assessment: Optional[builtins.bool] = None,
                             schedule_assessment_id: Optional[builtins.str] = None,
                             ...
                             triggered_by: Optional[builtins.str] = None,
    ...
    :param builtins.bool is_baseline: A filter to return only the security assessments that are set as a baseline.
    :param builtins.bool is_schedule_assessment: A filter to return only security assessments of type save schedule.
    :param builtins.str schedule_assessment_id: The OCID of the security assessment of type SAVE_SCHEDULE.
    ...
    :param builtins.str time_created_less_than: Search for resources that were created before a specific date. Specifying this parameter corresponding `timeCreatedLessThan` parameter will retrieve all resources created before the specified created date, in "YYYY-MM-ddThh:mmZ" format with a Z offset, as defined by RFC 3339.
           ...
           **Example:** 2016-12-19T16:39:57.600Z
    :param builtins.str triggered_by: A filter to return only security asessments that were created by either user or system.
    :param builtins.str type: A filter to return only items that match the specified security assessment type.
    """
    __args__ = dict()
...
def get_security_assessments_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                    compartment_id_in_subtree: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                    display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    filters: Optional[pulumi.Input[Optional[Sequence[Union['GetSecurityAssessmentsFilterArgs', 'GetSecurityAssessmentsFilterArgsDict']]]]] = None,
                                    is_baseline: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                    is_schedule_assessment: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                    schedule_assessment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    ...
                                    triggered_by: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSecurityAssessmentsResult]:
    """
    This data source provides the list of Security Assessments in Oracle Cloud Infrastructure Data Safe service.
