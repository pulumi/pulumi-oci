...
def get_security_policies(access_level: Optional[builtins.str] = None,
    ...
    :param builtins.str state: The current state of the security policy.
    """
    __args__ = dict()
...
def get_security_policies_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
