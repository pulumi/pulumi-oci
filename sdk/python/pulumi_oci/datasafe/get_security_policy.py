...
def get_security_policy(security_policy_id: Optional[builtins.str] = None,
    ...
    :param builtins.str security_policy_id: The OCID of the security policy resource.
    """
    __args__ = dict()
...
def get_security_policy_output(security_policy_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:DataSafe/getSecurityPolicy:getSecurityPolicy', __args__, opts=opts, typ=GetSecurityPolicyResult)
