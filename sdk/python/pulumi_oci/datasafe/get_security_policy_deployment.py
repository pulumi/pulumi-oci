...
def get_security_policy_deployment(security_policy_deployment_id: Optional[builtins.str] = None,
...
def get_security_policy_deployment_output(security_policy_deployment_id: Optional[pulumi.Input[builtins.str]] = None,
