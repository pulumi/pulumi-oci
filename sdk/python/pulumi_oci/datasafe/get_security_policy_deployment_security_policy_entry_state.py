...
class GetSecurityPolicyDeploymentSecurityPolicyEntryStateResult:
    ...
    def security_policy_entry_id(self) -> builtins.str:
        """
    ...
    def security_policy_entry_state_id(self) -> builtins.str:
...
def get_security_policy_deployment_security_policy_entry_state(security_policy_deployment_id: Optional[builtins.str] = None,
                                                               security_policy_entry_state_id: Optional[builtins.str] = None,
    ...
    :param builtins.str security_policy_entry_state_id: Unique security policy entry state identifier. The unique id for a given security policy entry state can be obtained  from the list api by passing the OCID of the corresponding  security policy deployment resource as the query parameter.
    """
    __args__ = dict()
...
def get_security_policy_deployment_security_policy_entry_state_output(security_policy_deployment_id: Optional[pulumi.Input[builtins.str]] = None,
                                                                      security_policy_entry_state_id: Optional[pulumi.Input[builtins.str]] = None,
