...
class GetSecurityPolicyDeploymentSecurityPolicyEntryStatesResult:
    ...
    def deployment_status(self) -> Optional[builtins.str]:
        """
    ...
    def security_policy_deployment_id(self) -> builtins.str:
        """
    ...
    def security_policy_entry_id(self) -> Optional[builtins.str]:
        """
...
def get_security_policy_deployment_security_policy_entry_states(deployment_status: Optional[builtins.str] = None,
                                                                ...
                                                                security_policy_deployment_id: Optional[builtins.str] = None,
                                                                security_policy_entry_id: Optional[builtins.str] = None,
    ...
    :param builtins.str deployment_status: The current state of the security policy deployment.
    :param builtins.str security_policy_deployment_id: The OCID of the security policy deployment resource.
    :param builtins.str security_policy_entry_id: An optional filter to return only resources that match the specified security policy entry OCID.
    """
    __args__ = dict()
...
def get_security_policy_deployment_security_policy_entry_states_output(deployment_status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                                       ...
                                                                       security_policy_deployment_id: Optional[pulumi.Input[builtins.str]] = None,
                                                                       security_policy_entry_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
