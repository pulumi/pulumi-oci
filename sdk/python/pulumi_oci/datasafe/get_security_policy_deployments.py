...
class GetSecurityPolicyDeploymentsResult:
    ...
    def security_policy_deployment_id(self) -> Optional[builtins.str]:
...
def get_security_policy_deployments(access_level: Optional[builtins.str] = None,
    ...
    :param builtins.str security_policy_deployment_id: An optional filter to return only resources that match the specified OCID of the security policy deployment resource.
    ...
    :param builtins.str state: The current state of the security policy deployment.
...
def get_security_policy_deployments_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                           ...
                                           security_policy_deployment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
