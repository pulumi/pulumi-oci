...
def get_security_policy_report(security_policy_report_id: Optional[builtins.str] = None,
...
def get_security_policy_report_output(security_policy_report_id: Optional[pulumi.Input[builtins.str]] = None,
