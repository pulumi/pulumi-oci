...
class GetSecurityPolicyReportDatabaseViewAccessEntryResult:
    ...
    def database_view_access_entry_key(self) -> _builtins.str:
...
def get_security_policy_report_database_view_access_entry(database_view_access_entry_key: Optional[_builtins.str] = None,
    ...
    :param _builtins.str database_view_access_entry_key: The unique key that identifies the view access object. This is a system-generated identifier.
