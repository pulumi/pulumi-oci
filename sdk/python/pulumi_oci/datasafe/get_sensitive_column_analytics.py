...
def get_sensitive_column_analytics(access_level: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] group_bies: The group by parameter to summarize the sensitive columns.
...
def get_sensitive_column_analytics_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
