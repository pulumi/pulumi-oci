...
def get_sensitive_data_model(sensitive_data_model_id: Optional[str] = None,
    ...
    return AwaitableGetSensitiveDataModelResult(
        app_suite_name=__ret__.app_suite_name,
        ...
        id=__ret__.id,
        is_app_defined_relation_discovery_enabled=__ret__.is_app_defined_relation_discovery_enabled,
        is_include_all_schemas=__ret__.is_include_all_schemas,
        is_include_all_sensitive_types=__ret__.is_include_all_sensitive_types,
        is_sample_data_collection_enabled=__ret__.is_sample_data_collection_enabled,
        schemas_for_discoveries=__ret__.schemas_for_discoveries,
        sensitive_data_model_id=__ret__.sensitive_data_model_id,
        sensitive_type_ids_for_discoveries=__ret__.sensitive_type_ids_for_discoveries,
        state=__ret__.state,
