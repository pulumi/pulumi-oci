...
class GetSensitiveDataModelsResult:
    ...
    def sensitive_data_model_id(self) -> Optional[builtins.str]:
...
def get_sensitive_data_models(access_level: Optional[builtins.str] = None,
                              compartment_id: Optional[builtins.str] = None,
                              compartment_id_in_subtree: Optional[builtins.bool] = None,
                              display_name: Optional[builtins.str] = None,
                              filters: Optional[Sequence[Union['GetSensitiveDataModelsFilterArgs', 'GetSensitiveDataModelsFilterArgsDict']]] = None,
    ...
    :param builtins.str sensitive_data_model_id: A filter to return only the resources that match the specified sensitive data model OCID.
...
def get_sensitive_data_models_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     ...
                                     sensitive_data_model_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:DataSafe/getSensitiveDataModels:getSensitiveDataModels', __args__, opts=opts, typ=GetSensitiveDataModelsResult)
    return __ret__.apply(lambda __response__: GetSensitiveDataModelsResult(
        ...
        sensitive_data_model_collections=pulumi.get(__response__, 'sensitive_data_model_collections'),
