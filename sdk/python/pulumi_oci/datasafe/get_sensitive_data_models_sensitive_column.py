...
class GetSensitiveDataModelsSensitiveColumnResult:
    ...
    def column_groups(self) -> Sequence[builtins.str]:
        """
    ...
    def sensitive_column_key(self) -> builtins.str:
...
def get_sensitive_data_models_sensitive_column(sensitive_column_key: Optional[builtins.str] = None,
    ...
    :param builtins.str sensitive_column_key: The unique key that identifies the sensitive column. It's numeric and unique within a sensitive data model.
...
def get_sensitive_data_models_sensitive_column_output(sensitive_column_key: Optional[pulumi.Input[builtins.str]] = None,
