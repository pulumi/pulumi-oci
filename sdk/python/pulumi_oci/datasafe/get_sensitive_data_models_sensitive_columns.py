...
class GetSensitiveDataModelsSensitiveColumnsResult:
    ...
    def column_group(self) -> Optional[builtins.str]:
    ...
    def is_case_in_sensitive(self) -> Optional[builtins.bool]:
    ...
    def parent_column_keys(self) -> Optional[Sequence[builtins.str]]:
        return pulumi.get(self, "parent_column_keys")

    @property
    @pulumi.getter(name="relationTypes")
    def relation_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def sensitive_column_lifecycle_state(self) -> Optional[builtins.str]:
    ...
    def sensitive_type_ids(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_sensitive_data_models_sensitive_columns(column_group: Optional[builtins.str] = None,
                                                ...
                                                is_case_in_sensitive: Optional[builtins.bool] = None,
                                                object_types: Optional[Sequence[builtins.str]] = None,
                                                objects: Optional[Sequence[builtins.str]] = None,
                                                parent_column_keys: Optional[Sequence[builtins.str]] = None,
                                                relation_types: Optional[Sequence[builtins.str]] = None,
                                                schema_names: Optional[Sequence[builtins.str]] = None,
                                                sensitive_column_lifecycle_state: Optional[builtins.str] = None,
                                                sensitive_data_model_id: Optional[builtins.str] = None,
                                                sensitive_type_ids: Optional[Sequence[builtins.str]] = None,
                                                statuses: Optional[Sequence[builtins.str]] = None,
                                                time_created_greater_than_or_equal_to: Optional[builtins.str] = None,
                                                time_created_less_than: Optional[builtins.str] = None,
                                                time_updated_greater_than_or_equal_to: Optional[builtins.str] = None,
                                                time_updated_less_than: Optional[builtins.str] = None,
    ...
    :param builtins.str column_group: A filter to return only the sensitive columns that belong to the specified column group.
    :param Sequence[builtins.str] column_names: A filter to return only a specific column based on column name.
    :param Sequence[builtins.str] data_types: A filter to return only the resources that match the specified data types.
    :param builtins.bool is_case_in_sensitive: A boolean flag indicating whether the search should be case-insensitive. The search is case-sensitive by default. Set this parameter to true to do case-insensitive search.
    ...
    :param Sequence[builtins.str] parent_column_keys: A filter to return only the sensitive columns that are children of one of the columns identified by the specified keys.
    :param Sequence[builtins.str] relation_types: A filter to return sensitive columns based on their relationship with their parent columns. If set to NONE, it returns the sensitive columns that do not have any parent. The response includes the parent columns as well as the independent columns that are not in any relationship. If set to APP_DEFINED, it returns all the child columns that have application-level (non-dictionary) relationship with their parents. If set to DB_DEFINED, it returns all the child columns that have database-level (dictionary-defined) relationship with their parents.
    :param Sequence[builtins.str] schema_names: A filter to return only items related to specific schema name.
    :param builtins.str sensitive_column_lifecycle_state: Filters the sensitive column resources with the given lifecycle state values.
    :param builtins.str sensitive_data_model_id: The OCID of the sensitive data model.
    :param Sequence[builtins.str] sensitive_type_ids: A filter to return only the sensitive columns that are associated with one of the sensitive types identified by the specified OCIDs.
    :param Sequence[builtins.str] statuses: A filter to return only the sensitive columns that match the specified status.
    :param builtins.str time_created_greater_than_or_equal_to: A filter to return only the resources that were created after the specified date and time, as defined by [RFC3339](https://tools.ietf.org/html/rfc3339). Using TimeCreatedGreaterThanOrEqualToQueryParam parameter retrieves all resources created after that date.
           
           **Example:** 2016-12-19T16:39:57.600Z
    :param builtins.str time_created_less_than: Search for resources that were created before a specific date. Specifying this parameter corresponding `timeCreatedLessThan` parameter will retrieve all resources created before the specified created date, in "YYYY-MM-ddThh:mmZ" format with a Z offset, as defined by RFC 3339.
           
           **Example:** 2016-12-19T16:39:57.600Z
    :param builtins.str time_updated_greater_than_or_equal_to: Search for resources that were updated after a specific date. Specifying this parameter corresponding `timeUpdatedGreaterThanOrEqualTo` parameter will retrieve all resources updated after the specified created date, in "YYYY-MM-ddThh:mmZ" format with a Z offset, as defined by RFC 3339.
    :param builtins.str time_updated_less_than: Search for resources that were updated before a specific date. Specifying this parameter corresponding `timeUpdatedLessThan` parameter will retrieve all resources updated before the specified created date, in "YYYY-MM-ddThh:mmZ" format with a Z offset, as defined by RFC 3339.
    """
    __args__ = dict()
...
def get_sensitive_data_models_sensitive_columns_output(column_group: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                       column_names: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                                       data_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                                       ...
                                                       is_case_in_sensitive: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                                       ...
                                                       parent_column_keys: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                                       relation_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                                       schema_names: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                                       sensitive_column_lifecycle_state: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                       sensitive_data_model_id: Optional[pulumi.Input[builtins.str]] = None,
                                                       sensitive_type_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                                       statuses: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                                       time_created_greater_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                       time_created_less_than: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                       time_updated_greater_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                       time_updated_less_than: Optional[pulumi.Input[Optional[builtins.str]]] = None,
