...
class GetSensitiveTypeResult:
    ...
    def comment_pattern(self) -> builtins.str:
        """
    ...
    def data_pattern(self) -> builtins.str:
        """
    ...
    def default_masking_format_id(self) -> builtins.str:
        """
    ...
    def is_common(self) -> builtins.bool:
        """
    ...
    def parent_category_id(self) -> builtins.str:
        """
...
def get_sensitive_type(sensitive_type_id: Optional[builtins.str] = None,
    ...
    :param builtins.str sensitive_type_id: The OCID of the sensitive type.
    """
    __args__ = dict()
...
def get_sensitive_type_output(sensitive_type_id: Optional[pulumi.Input[builtins.str]] = None,
