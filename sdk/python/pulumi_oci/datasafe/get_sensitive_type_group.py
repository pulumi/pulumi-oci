...
class GetSensitiveTypeGroupResult:
    ...
    def sensitive_type_count(self) -> builtins.int:
        """
    ...
    def sensitive_type_group_id(self) -> builtins.str:
...
def get_sensitive_type_group(sensitive_type_group_id: Optional[builtins.str] = None,
    ...
    :param builtins.str sensitive_type_group_id: The OCID of the sensitive type group.
    """
    __args__ = dict()
...
def get_sensitive_type_group_output(sensitive_type_group_id: Optional[pulumi.Input[builtins.str]] = None,
