...
class GetSensitiveTypeGroupsResult:
    ...
    def sensitive_type_group_id(self) -> Optional[builtins.str]:
...
def get_sensitive_type_groups(access_level: Optional[builtins.str] = None,
                              ...
                              sensitive_type_group_id: Optional[builtins.str] = None,
    ...
    :param builtins.str sensitive_type_group_id: An optional filter to return only resources that match the specified OCID of the sensitive type group resource.
...
def get_sensitive_type_groups_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     ...
                                     sensitive_type_group_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
