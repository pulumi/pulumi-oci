...
class GetSensitiveTypesResult:
    ...
    def default_masking_format_id(self) -> Optional[builtins.str]:
        """
    ...
    def is_common(self) -> Optional[builtins.bool]:
        """
    ...
    def parent_category_id(self) -> Optional[builtins.str]:
        """
    ...
    def sensitive_type_source(self) -> Optional[builtins.str]:
...
def get_sensitive_types(access_level: Optional[builtins.str] = None,
                        compartment_id: Optional[builtins.str] = None,
                        compartment_id_in_subtree: Optional[builtins.bool] = None,
                        default_masking_format_id: Optional[builtins.str] = None,
                        ...
                        is_common: Optional[builtins.bool] = None,
                        parent_category_id: Optional[builtins.str] = None,
                        sensitive_type_id: Optional[builtins.str] = None,
                        sensitive_type_source: Optional[builtins.str] = None,
    ...
    :param builtins.str default_masking_format_id: A filter to return only the sensitive types that have the default masking format identified by the specified OCID.
    :param builtins.str display_name: A filter to return only resources that match the specified display name.
    :param builtins.str entity_type: A filter to return the sensitive type resources based on the value of their entityType attribute.
    :param builtins.bool is_common: A filter to return only the common sensitive type resources. Common sensitive types belong to  library sensitive types which are frequently used to perform sensitive data discovery.
    :param builtins.str parent_category_id: A filter to return only the sensitive types that are children of the sensitive category identified by the specified OCID.
    :param builtins.str sensitive_type_id: A filter to return only items related to a specific sensitive type OCID.
    :param builtins.str sensitive_type_source: A filter to return the sensitive type resources based on the value of their source attribute.
...
def get_sensitive_types_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                               compartment_id_in_subtree: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                               default_masking_format_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               ...
                               is_common: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                               parent_category_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               sensitive_type_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               sensitive_type_source: Optional[pulumi.Input[Optional[builtins.str]]] = None,
