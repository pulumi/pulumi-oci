...
class GetSensitiveTypesExportResult:
    ...
    def sensitive_types_export_id(self) -> _builtins.str:
...
def get_sensitive_types_export(sensitive_types_export_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str sensitive_types_export_id: The OCID of the sensitive types export.
    """
    __args__ = dict()
