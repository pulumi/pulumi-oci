...
class GetSensitiveTypesExportResult:
    ...
    def sensitive_type_ids_for_exports(self) -> Sequence[builtins.str]:
        """
    ...
    def sensitive_types_export_id(self) -> builtins.str:
...
def get_sensitive_types_export(sensitive_types_export_id: Optional[builtins.str] = None,
    ...
    :param builtins.str sensitive_types_export_id: The OCID of the sensitive types export.
    """
    __args__ = dict()
...
def get_sensitive_types_export_output(sensitive_types_export_id: Optional[pulumi.Input[builtins.str]] = None,
