...
class GetSensitiveTypesExportsResult:
    ...
    def sensitive_types_export_id(self) -> Optional[builtins.str]:
...
def get_sensitive_types_exports(access_level: Optional[builtins.str] = None,
                                ...
                                sensitive_types_export_id: Optional[builtins.str] = None,
    ...
    :param builtins.str sensitive_types_export_id: An optional filter to return only resources that match the specified OCID of the sensitive types export resource.
...
def get_sensitive_types_exports_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                       ...
                                       sensitive_types_export_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
