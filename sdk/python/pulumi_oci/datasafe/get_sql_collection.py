...
class GetSqlCollectionResult:
    ...
    def generate_sql_firewall_policy_trigger(self) -> builtins.bool:
    ...
    def start_trigger(self) -> builtins.bool:
    ...
    def stop_trigger(self) -> builtins.bool:
...
def get_sql_collection(sql_collection_id: Optional[builtins.str] = None,
    ...
    :param builtins.str sql_collection_id: The OCID of the SQL collection resource.
    """
    __args__ = dict()
...
def get_sql_collection_output(sql_collection_id: Optional[pulumi.Input[builtins.str]] = None,
