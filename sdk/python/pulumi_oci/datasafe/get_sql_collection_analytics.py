...
def get_sql_collection_analytics(access_level: Optional[str] = None,
                                 ...
                                 filters: Optional[Sequence[pulumi.InputType['GetSqlCollectionAnalyticsFilterArgs']]] = None,
...
@_utilities.lift_output_func(get_sql_collection_analytics)
def get_sql_collection_analytics_output(access_level: Optional[pulumi.Input[Optional[str]]] = None,
                                        compartment_id: Optional[pulumi.Input[str]] = None,
                                        compartment_id_in_subtree: Optional[pulumi.Input[Optional[bool]]] = None,
                                        filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetSqlCollectionAnalyticsFilterArgs']]]]] = None,
