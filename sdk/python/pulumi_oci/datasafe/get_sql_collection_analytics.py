...
def get_sql_collection_analytics(access_level: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] group_bies: The group by parameter to summarize SQL collection aggregation.
    :param builtins.str state: The current state of the SQL collection.
    :param builtins.str target_id: A filter to return only items related to a specific target OCID.
    :param builtins.str time_ended: An optional filter to return the stats of the SQL collection logs collected before the date-time specified, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
    :param builtins.str time_started: An optional filter to return the stats of the SQL collection logs collected after the date-time specified, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
    """
    __args__ = dict()
...
def get_sql_collection_analytics_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
