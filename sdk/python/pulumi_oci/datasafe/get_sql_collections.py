...
class GetSqlCollectionsResult:
    ...
    def sql_collection_id(self) -> Optional[builtins.str]:
...
def get_sql_collections(access_level: Optional[builtins.str] = None,
                        ...
                        sql_collection_id: Optional[builtins.str] = None,
    ...
    :param builtins.str sql_collection_id: An optional filter to return only resources that match the specified OCID of the SQL collection resource.
...
def get_sql_collections_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               ...
                               sql_collection_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
