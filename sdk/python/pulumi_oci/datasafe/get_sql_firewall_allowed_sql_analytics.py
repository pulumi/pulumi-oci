...
def get_sql_firewall_allowed_sql_analytics(access_level: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] group_bies: The group by parameter to summarize the allowed SQL aggregation.
...
def get_sql_firewall_allowed_sql_analytics_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
