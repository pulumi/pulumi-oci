...
def get_sql_firewall_allowed_sqls(access_level: Optional[builtins.str] = None,
...
def get_sql_firewall_allowed_sqls_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
