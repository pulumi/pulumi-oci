...
class GetSqlFirewallPoliciesResult:
    ...
    def sql_firewall_policy_id(self) -> Optional[builtins.str]:
    ...
    def violation_action(self) -> Optional[builtins.str]:
        """
...
def get_sql_firewall_policies(access_level: Optional[builtins.str] = None,
    ...
    :param builtins.str db_user_name: A filter to return only items that match the specified user name.
    ...
    :param builtins.str sql_firewall_policy_id: An optional filter to return only resources that match the specified OCID of the SQL Firewall policy resource.
    ...
    :param builtins.str time_created_less_than: Search for resources that were created before a specific date. Specifying this parameter corresponding `timeCreatedLessThan` parameter will retrieve all resources created before the specified created date, in "YYYY-MM-ddThh:mmZ" format with a Z offset, as defined by RFC 3339.
           ...
           **Example:** 2016-12-19T16:39:57.600Z
    :param builtins.str violation_action: An optional filter to return only resources that match the specified violation action.
    """
    __args__ = dict()
...
def get_sql_firewall_policies_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                     compartment_id_in_subtree: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                     db_user_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     ...
                                     sql_firewall_policy_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     ...
                                     violation_action: Optional[pulumi.Input[Optional[builtins.str]]] = None,
