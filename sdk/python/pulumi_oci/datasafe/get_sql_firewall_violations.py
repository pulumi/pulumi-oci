...
def get_sql_firewall_violations(access_level: Optional[builtins.str] = None,
...
def get_sql_firewall_violations_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
