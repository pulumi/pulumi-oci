...
class GetTargetAlertPolicyAssociationResult:
    ...
    def target_alert_policy_association_id(self) -> builtins.str:
...
def get_target_alert_policy_association(target_alert_policy_association_id: Optional[builtins.str] = None,
    ...
    :param builtins.str target_alert_policy_association_id: The OCID of the target-alert policy association.
    """
    __args__ = dict()
...
def get_target_alert_policy_association_output(target_alert_policy_association_id: Optional[pulumi.Input[builtins.str]] = None,
