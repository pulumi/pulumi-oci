...
class GetTargetAlertPolicyAssociationsResult:
    ...
    def target_alert_policy_association_id(self) -> Optional[_builtins.str]:
...
def get_target_alert_policy_associations(access_level: Optional[_builtins.str] = None,
                                         alert_policy_id: Optional[_builtins.str] = None,
                                         compartment_id: Optional[_builtins.str] = None,
                                         compartment_id_in_subtree: Optional[_builtins.bool] = None,
                                         filters: Optional[Sequence[Union['GetTargetAlertPolicyAssociationsFilterArgs', 'GetTargetAlertPolicyAssociationsFilterArgsDict', 'outputs.GetTargetAlertPolicyAssociationsFilterResult']]] = None,
...
def get_target_alert_policy_associations_output(access_level: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                                ...
                                                filters: pulumi.Input[Optional[Optional[Sequence[Union['GetTargetAlertPolicyAssociationsFilterArgs', 'GetTargetAlertPolicyAssociationsFilterArgsDict', 'outputs.GetTargetAlertPolicyAssociationsFilterResult']]]]] = None,
