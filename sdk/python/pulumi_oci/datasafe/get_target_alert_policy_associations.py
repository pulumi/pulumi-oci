...
class GetTargetAlertPolicyAssociationsResult:
    ...
    def target_alert_policy_association_id(self) -> Optional[builtins.str]:
...
def get_target_alert_policy_associations(access_level: Optional[builtins.str] = None,
                                         ...
                                         target_alert_policy_association_id: Optional[builtins.str] = None,
    ...
    :param builtins.str alert_policy_id: A filter to return policy by it's OCID.
    ...
    :param builtins.str state: An optional filter to return only alert policies that have the given life-cycle state.
    :param builtins.str target_alert_policy_association_id: A filter to return only items related to a specific target-alert policy association ID.
...
def get_target_alert_policy_associations_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                alert_policy_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                ...
                                                target_alert_policy_association_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
