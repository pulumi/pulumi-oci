...
def get_target_database(target_database_id: Optional[builtins.str] = None,
...
def get_target_database_output(target_database_id: Optional[pulumi.Input[builtins.str]] = None,
