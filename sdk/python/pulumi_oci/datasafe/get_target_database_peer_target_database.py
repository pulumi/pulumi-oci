...
class GetTargetDatabasePeerTargetDatabaseResult:
    ...
    def database_unique_name(self) -> builtins.str:
        """
    ...
    def dataguard_association_id(self) -> builtins.str:
        """
    ...
    def peer_target_database_id(self) -> builtins.str:
...
def get_target_database_peer_target_database(peer_target_database_id: Optional[builtins.str] = None,
    ...
    :param builtins.str peer_target_database_id: The unique id of the peer target database.
...
def get_target_database_peer_target_database_output(peer_target_database_id: Optional[pulumi.Input[builtins.str]] = None,
