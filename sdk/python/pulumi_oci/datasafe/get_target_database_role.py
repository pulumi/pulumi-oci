...
def get_target_database_role(authentication_type: Optional[builtins.str] = None,
...
def get_target_database_role_output(authentication_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
