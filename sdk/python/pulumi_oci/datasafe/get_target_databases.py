...
def get_target_databases(access_level: Optional[_builtins.str] = None,
                         associated_resource_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str associated_resource_id: A filter to return the target databases that are associated to the resource id passed in as a parameter value.
