...
class GetTargetDatabasesResult:
    ...
    def target_database_id(self) -> Optional[builtins.str]:
...
def get_target_databases(access_level: Optional[builtins.str] = None,
                         associated_resource_id: Optional[builtins.str] = None,
    ...
    :param builtins.str associated_resource_id: A filter to return the target databases that are associated to the resource id passed in as a parameter value.
    ...
    :param builtins.str database_type: A filter to return only target databases that match the specified database type.
    :param builtins.str display_name: A filter to return only resources that match the specified display name.
    :param builtins.str infrastructure_type: A filter to return only target databases that match the specified infrastructure type.
    :param builtins.str state: A filter to return only target databases that match the specified lifecycle state.
    :param builtins.str target_database_id: A filter to return the target database that matches the specified OCID.
    """
    __args__ = dict()
...
def get_target_databases_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                associated_resource_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                ...
                                target_database_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
