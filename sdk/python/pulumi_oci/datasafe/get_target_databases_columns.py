...
class GetTargetDatabasesColumnsResult:
    ...
    def column_name_contains(self) -> Optional[builtins.str]:
    ...
    @property
    @pulumi.getter
    def datatypes(self) -> Optional[Sequence[builtins.str]]:
...
def get_target_databases_columns(column_name_contains: Optional[builtins.str] = None,
                                 column_names: Optional[Sequence[builtins.str]] = None,
                                 datatypes: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.str column_name_contains: A filter to return only items if column name contains a specific string.
    :param Sequence[builtins.str] column_names: A filter to return only a specific column based on column name.
    :param Sequence[builtins.str] datatypes: A filter to return only items related to specific datatype.
...
def get_target_databases_columns_output(column_name_contains: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        column_names: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                        datatypes: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
