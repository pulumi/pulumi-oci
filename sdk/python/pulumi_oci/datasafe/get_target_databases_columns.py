...
class GetTargetDatabasesColumnsResult:
    ...
    def column_name_contains(self) -> Optional[_builtins.str]:
    ...
    @_builtins.property
    @pulumi.getter
    def datatypes(self) -> Optional[Sequence[_builtins.str]]:
...
def get_target_databases_columns(column_name_contains: Optional[_builtins.str] = None,
                                 column_names: Optional[Sequence[_builtins.str]] = None,
                                 datatypes: Optional[Sequence[_builtins.str]] = None,
                                 filters: Optional[Sequence[Union['GetTargetDatabasesColumnsFilterArgs', 'GetTargetDatabasesColumnsFilterArgsDict', 'outputs.GetTargetDatabasesColumnsFilterResult']]] = None,
    ...
    :param _builtins.str column_name_contains: A filter to return only items if column name contains a specific string.
    :param Sequence[_builtins.str] column_names: A filter to return only a specific column based on column name.
    :param Sequence[_builtins.str] datatypes: A filter to return only items related to specific datatype.
...
def get_target_databases_columns_output(column_name_contains: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        ...
                                        filters: pulumi.Input[Optional[Optional[Sequence[Union['GetTargetDatabasesColumnsFilterArgs', 'GetTargetDatabasesColumnsFilterArgsDict', 'outputs.GetTargetDatabasesColumnsFilterResult']]]]] = None,
