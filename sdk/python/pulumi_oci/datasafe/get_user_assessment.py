...
def get_user_assessment(user_assessment_id: Optional[str] = None,
    ...
    return AwaitableGetUserAssessmentResult(
        ...
        id=__ret__.id,
        ignored_assessment_ids=__ret__.ignored_assessment_ids,
        ignored_targets=__ret__.ignored_targets,
        is_baseline=__ret__.is_baseline,
        is_deviated_from_baseline=__ret__.is_deviated_from_baseline,
        last_compared_baseline_id=__ret__.last_compared_baseline_id,
...
@_utilities.lift_output_func(get_user_assessment)
def get_user_assessment_output(user_assessment_id: Optional[pulumi.Input[str]] = None,
                               opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetUserAssessmentResult]:
    """
    This data source provides details about a specific User Assessment resource in Oracle Cloud Infrastructure Data Safe service.
