...
class GetUserAssessmentComparisonResult:
    ...
    def comparison_user_assessment_id(self) -> builtins.str:
...
def get_user_assessment_comparison(comparison_user_assessment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str comparison_user_assessment_id: The OCID of the baseline user assessment.
...
def get_user_assessment_comparison_output(comparison_user_assessment_id: Optional[pulumi.Input[builtins.str]] = None,
