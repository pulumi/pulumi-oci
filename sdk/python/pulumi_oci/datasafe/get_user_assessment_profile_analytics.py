...
def get_user_assessment_profile_analytics(access_level: Optional[builtins.str] = None,
                                          compartment_id: Optional[builtins.str] = None,
                                          compartment_id_in_subtree: Optional[builtins.bool] = None,
                                          filters: Optional[Sequence[Union['GetUserAssessmentProfileAnalyticsFilterArgs', 'GetUserAssessmentProfileAnalyticsFilterArgsDict']]] = None,
...
def get_user_assessment_profile_analytics_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
