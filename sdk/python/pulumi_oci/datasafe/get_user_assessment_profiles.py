...
class GetUserAssessmentProfilesResult:
    ...
    def failed_login_attempts_greater_than_or_equal(self) -> Optional[builtins.str]:
        return pulumi.get(self, "failed_login_attempts_greater_than_or_equal")

    @property
    @pulumi.getter(name="failedLoginAttemptsLessThan")
    def failed_login_attempts_less_than(self) -> Optional[builtins.str]:
    ...
    def sessions_per_user_greater_than_or_equal(self) -> Optional[builtins.str]:
        return pulumi.get(self, "sessions_per_user_greater_than_or_equal")

    @property
    @pulumi.getter(name="sessionsPerUserLessThan")
    def sessions_per_user_less_than(self) -> Optional[builtins.str]:
    ...
    def user_count_greater_than_or_equal(self) -> Optional[builtins.str]:
        return pulumi.get(self, "user_count_greater_than_or_equal")

    @property
    @pulumi.getter(name="userCountLessThan")
    def user_count_less_than(self) -> Optional[builtins.str]:
...
def get_user_assessment_profiles(access_level: Optional[builtins.str] = None,
                                 compartment_id: Optional[builtins.str] = None,
                                 compartment_id_in_subtree: Optional[builtins.bool] = None,
                                 failed_login_attempts_greater_than_or_equal: Optional[builtins.str] = None,
                                 failed_login_attempts_less_than: Optional[builtins.str] = None,
                                 filters: Optional[Sequence[Union['GetUserAssessmentProfilesFilterArgs', 'GetUserAssessmentProfilesFilterArgsDict']]] = None,
                                 inactive_account_time_greater_than_or_equal: Optional[builtins.str] = None,
                                 inactive_account_time_less_than: Optional[builtins.str] = None,
                                 is_user_created: Optional[builtins.bool] = None,
                                 password_lock_time_greater_than_or_equal: Optional[builtins.str] = None,
                                 password_lock_time_less_than: Optional[builtins.str] = None,
                                 password_verification_function: Optional[builtins.str] = None,
                                 profile_name: Optional[builtins.str] = None,
                                 sessions_per_user_greater_than_or_equal: Optional[builtins.str] = None,
                                 sessions_per_user_less_than: Optional[builtins.str] = None,
                                 target_id: Optional[builtins.str] = None,
                                 user_assessment_id: Optional[builtins.str] = None,
                                 user_count_greater_than_or_equal: Optional[builtins.str] = None,
                                 user_count_less_than: Optional[builtins.str] = None,
    ...
    :param builtins.str failed_login_attempts_greater_than_or_equal: An optional filter to return the profiles having allow failed login attempts number greater than or equal to the provided value. String value is used for accommodating the "UNLIMITED" and "DEFAULT" values.
    :param builtins.str failed_login_attempts_less_than: An optional filter to return the profiles having failed login attempts number less than the provided value. String value is used for accommodating the "UNLIMITED" and "DEFAULT" values.
    :param builtins.str inactive_account_time_greater_than_or_equal: An optional filter to return the profiles allowing inactive account time in days greater than or equal to the provided value. String value is used for accommodating the "UNLIMITED" and "DEFAULT" values.
    :param builtins.str inactive_account_time_less_than: An optional filter to return the profiles  allowing inactive account time in days less than the provided value. String value is used for accommodating the "UNLIMITED" and "DEFAULT" values.
    :param builtins.bool is_user_created: An optional filter to return the user created profiles.
    :param builtins.str password_lock_time_greater_than_or_equal: An optional filter to return the profiles having password lock number greater than or equal to the provided value. String value is used for accommodating the "UNLIMITED" and "DEFAULT" values.
    :param builtins.str password_lock_time_less_than: An optional filter to return the profiles having password lock number less than the provided value. String value is used for accommodating the "UNLIMITED" and "DEFAULT" values.
    :param builtins.str password_verification_function: An optional filter to filter the profiles based on password verification function.
    :param builtins.str profile_name: A filter to return only items that match the specified profile name.
    :param builtins.str sessions_per_user_greater_than_or_equal: An optional filter to return the profiles permitting the user to spawn multiple sessions having count. greater than or equal to the provided value. String value is used for accommodating the "UNLIMITED" and "DEFAULT" values.
    :param builtins.str sessions_per_user_less_than: An optional filter to return the profiles permitting the user to spawn multiple sessions having count less than the provided value. String value is used for accommodating the "UNLIMITED" and "DEFAULT" values.
    ...
    :param builtins.str user_count_greater_than_or_equal: An optional filter to return the profiles having user count greater than or equal to the provided value.
    :param builtins.str user_count_less_than: An optional filter to return the profiles having user count less than the provided value.
    """
    __args__ = dict()
...
def get_user_assessment_profiles_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                        compartment_id_in_subtree: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                        failed_login_attempts_greater_than_or_equal: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        failed_login_attempts_less_than: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        ...
                                        inactive_account_time_greater_than_or_equal: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        inactive_account_time_less_than: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        is_user_created: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                        password_lock_time_greater_than_or_equal: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        password_lock_time_less_than: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        password_verification_function: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        profile_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        sessions_per_user_greater_than_or_equal: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        sessions_per_user_less_than: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        target_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        user_assessment_id: Optional[pulumi.Input[builtins.str]] = None,
                                        user_count_greater_than_or_equal: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        user_count_less_than: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetUserAssessmentProfilesResult]:
    """
    This data source provides the list of User Assessment Profiles in Oracle Cloud Infrastructure Data Safe service.
