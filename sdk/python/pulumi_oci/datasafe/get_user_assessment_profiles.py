...
class GetUserAssessmentProfilesResult:
    ...
    def failed_login_attempts_greater_than_or_equal(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "failed_login_attempts_greater_than_or_equal")

    @_builtins.property
    @pulumi.getter(name="failedLoginAttemptsLessThan")
    def failed_login_attempts_less_than(self) -> Optional[_builtins.str]:
    ...
    def sessions_per_user_greater_than_or_equal(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "sessions_per_user_greater_than_or_equal")

    @_builtins.property
    @pulumi.getter(name="sessionsPerUserLessThan")
    def sessions_per_user_less_than(self) -> Optional[_builtins.str]:
    ...
    def user_count_greater_than_or_equal(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "user_count_greater_than_or_equal")

    @_builtins.property
    @pulumi.getter(name="userCountLessThan")
    def user_count_less_than(self) -> Optional[_builtins.str]:
...
def get_user_assessment_profiles(access_level: Optional[_builtins.str] = None,
                                 compartment_id: Optional[_builtins.str] = None,
                                 compartment_id_in_subtree: Optional[_builtins.bool] = None,
                                 failed_login_attempts_greater_than_or_equal: Optional[_builtins.str] = None,
                                 failed_login_attempts_less_than: Optional[_builtins.str] = None,
                                 filters: Optional[Sequence[Union['GetUserAssessmentProfilesFilterArgs', 'GetUserAssessmentProfilesFilterArgsDict', 'outputs.GetUserAssessmentProfilesFilterResult']]] = None,
                                 inactive_account_time_greater_than_or_equal: Optional[_builtins.str] = None,
                                 inactive_account_time_less_than: Optional[_builtins.str] = None,
                                 is_user_created: Optional[_builtins.bool] = None,
                                 password_lock_time_greater_than_or_equal: Optional[_builtins.str] = None,
                                 password_lock_time_less_than: Optional[_builtins.str] = None,
                                 password_verification_function: Optional[_builtins.str] = None,
                                 profile_name: Optional[_builtins.str] = None,
                                 sessions_per_user_greater_than_or_equal: Optional[_builtins.str] = None,
                                 sessions_per_user_less_than: Optional[_builtins.str] = None,
                                 target_id: Optional[_builtins.str] = None,
                                 user_assessment_id: Optional[_builtins.str] = None,
                                 user_count_greater_than_or_equal: Optional[_builtins.str] = None,
                                 user_count_less_than: Optional[_builtins.str] = None,
    ...
    :param _builtins.str failed_login_attempts_greater_than_or_equal: An optional filter to return the profiles having allow failed login attempts number greater than or equal to the provided value. String value is used for accommodating the "UNLIMITED" and "DEFAULT" values.
    :param _builtins.str failed_login_attempts_less_than: An optional filter to return the profiles having failed login attempts number less than the provided value. String value is used for accommodating the "UNLIMITED" and "DEFAULT" values.
    :param _builtins.str inactive_account_time_greater_than_or_equal: An optional filter to return the profiles allowing inactive account time in days greater than or equal to the provided value. String value is used for accommodating the "UNLIMITED" and "DEFAULT" values.
    :param _builtins.str inactive_account_time_less_than: An optional filter to return the profiles  allowing inactive account time in days less than the provided value. String value is used for accommodating the "UNLIMITED" and "DEFAULT" values.
    :param _builtins.bool is_user_created: An optional filter to return the user created profiles.
    :param _builtins.str password_lock_time_greater_than_or_equal: An optional filter to return the profiles having password lock number greater than or equal to the provided value. String value is used for accommodating the "UNLIMITED" and "DEFAULT" values.
    :param _builtins.str password_lock_time_less_than: An optional filter to return the profiles having password lock number less than the provided value. String value is used for accommodating the "UNLIMITED" and "DEFAULT" values.
    ...
    :param _builtins.str sessions_per_user_greater_than_or_equal: An optional filter to return the profiles permitting the user to spawn multiple sessions having count. greater than or equal to the provided value. String value is used for accommodating the "UNLIMITED" and "DEFAULT" values.
    :param _builtins.str sessions_per_user_less_than: An optional filter to return the profiles permitting the user to spawn multiple sessions having count less than the provided value. String value is used for accommodating the "UNLIMITED" and "DEFAULT" values.
    ...
    :param _builtins.str user_count_greater_than_or_equal: An optional filter to return the profiles having user count greater than or equal to the provided value.
    :param _builtins.str user_count_less_than: An optional filter to return the profiles having user count less than the provided value.
    """
    __args__ = dict()
...
def get_user_assessment_profiles_output(access_level: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                                        compartment_id_in_subtree: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                        failed_login_attempts_greater_than_or_equal: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        failed_login_attempts_less_than: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        filters: pulumi.Input[Optional[Optional[Sequence[Union['GetUserAssessmentProfilesFilterArgs', 'GetUserAssessmentProfilesFilterArgsDict', 'outputs.GetUserAssessmentProfilesFilterResult']]]]] = None,
                                        inactive_account_time_greater_than_or_equal: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        inactive_account_time_less_than: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        is_user_created: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                        password_lock_time_greater_than_or_equal: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        password_lock_time_less_than: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        password_verification_function: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        profile_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        sessions_per_user_greater_than_or_equal: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        sessions_per_user_less_than: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        target_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        user_assessment_id: pulumi.Input[Optional[_builtins.str]] = None,
                                        user_count_greater_than_or_equal: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        user_count_less_than: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
