...
def get_user_assessment_user_analytics(access_level: Optional[_builtins.str] = None,
                                       account_status: Optional[_builtins.str] = None,
                                       authentication_type: Optional[_builtins.str] = None,
                                       compartment_id_in_subtree: Optional[_builtins.bool] = None,
                                       filters: Optional[Sequence[Union['GetUserAssessmentUserAnalyticsFilterArgs', 'GetUserAssessmentUserAnalyticsFilterArgsDict']]] = None,
...
def get_user_assessment_user_analytics_output(access_level: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                              ...
                                              filters: Optional[pulumi.Input[Optional[Sequence[Union['GetUserAssessmentUserAnalyticsFilterArgs', 'GetUserAssessmentUserAnalyticsFilterArgsDict']]]]] = None,
                                              ...
                                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetUserAssessmentUserAnalyticsResult]:
    """
    This data source provides the list of User Assessment User Analytics in Oracle Cloud Infrastructure Data Safe service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:DataSafe/getUserAssessmentUserAnalytics:getUserAssessmentUserAnalytics', __args__, opts=opts, typ=GetUserAssessmentUserAnalyticsResult)
    return __ret__.apply(lambda __response__: GetUserAssessmentUserAnalyticsResult(
