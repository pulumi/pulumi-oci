...
def get_user_assessment_user_analytics(access_level: Optional[builtins.str] = None,
...
def get_user_assessment_user_analytics_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
