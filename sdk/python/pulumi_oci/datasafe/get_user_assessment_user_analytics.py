...
def get_user_assessment_user_analytics(access_level: Optional[str] = None,
    ...
    test_user_assessment_user_analytics = oci.DataSafe.get_user_assessment_user_analytics(user_assessment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetUserAssessmentUserAnalyticsResult(
        ...
        user_aggregations=__ret__.user_aggregations,
