...
class GetUserAssessmentsResult:
    ...
    def schedule_user_assessment_id(self) -> Optional[builtins.str]:
...
def get_user_assessments(access_level: Optional[builtins.str] = None,
                         ...
                         schedule_user_assessment_id: Optional[builtins.str] = None,
    ...
    :param builtins.bool is_baseline: A filter to return only user assessments that are set as baseline.
    :param builtins.bool is_schedule_assessment: A filter to return only user assessments of type SAVE_SCHEDULE.
    :param builtins.str schedule_user_assessment_id: The OCID of the user assessment of type SAVE_SCHEDULE.
    :param builtins.str state: The current state of the user assessment.
    :param builtins.str target_id: A filter to return only items related to a specific target OCID.
    :param builtins.str time_created_greater_than_or_equal_to: A filter to return only user assessments that were created after the specified date and time, as defined by [RFC3339](https://tools.ietf.org/html/rfc3339). Using timeCreatedGreaterThanOrEqualTo parameter retrieves all assessments created after that date.
    ...
    :param builtins.str time_created_less_than: Search for resources that were created before a specific date. Specifying this parameter corresponding `timeCreatedLessThan` parameter will retrieve all resources created before the specified created date, in "YYYY-MM-ddThh:mmZ" format with a Z offset, as defined by RFC 3339.
           ...
           **Example:** 2016-12-19T16:39:57.600Z
    :param builtins.str triggered_by: A filter to return user assessments that were created by either the system or by a user only.
    :param builtins.str type: A filter to return only items that match the specified assessment type.
    """
    __args__ = dict()
...
def get_user_assessments_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                ...
                                schedule_user_assessment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
