...
def get_user_assessments(access_level: Optional[str] = None,
                         ...
                         filters: Optional[Sequence[pulumi.InputType['GetUserAssessmentsFilterArgs']]] = None,
    ...
    return AwaitableGetUserAssessmentsResult(
        ...
        schedule_user_assessment_id=__ret__.schedule_user_assessment_id,
        state=__ret__.state,
        ...
        type=__ret__.type,
        user_assessments=__ret__.user_assessments)


@_utilities.lift_output_func(get_user_assessments)
def get_user_assessments_output(access_level: Optional[pulumi.Input[Optional[str]]] = None,
                                compartment_id: Optional[pulumi.Input[str]] = None,
                                compartment_id_in_subtree: Optional[pulumi.Input[Optional[bool]]] = None,
                                display_name: Optional[pulumi.Input[Optional[str]]] = None,
                                filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetUserAssessmentsFilterArgs']]]]] = None,
