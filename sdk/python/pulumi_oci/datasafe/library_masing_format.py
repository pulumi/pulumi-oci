...
class _LibraryMasingFormatState:
    def __init__(__self__, *,
                 ...
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 format_entries: pulumi.Input[Optional[Sequence[pulumi.Input['LibraryMasingFormatFormatEntryArgs']]]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 sensitive_type_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] sensitive_type_ids: (Updatable) An array of OCIDs of the sensitive types compatible with the library masking format. It helps track the sensitive types for which the library masking format is being created.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] source: Specifies whether the library masking format is user-defined or predefined.
        :param pulumi.Input[_builtins.str] state: The current state of the library masking format.
        :param pulumi.Input[_builtins.str] time_created: The date and time the library masking format was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339)
        :param pulumi.Input[_builtins.str] time_updated: The date and time the library masking format was updated, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339)
        """
    ...
    @_builtins.property
    @pulumi.getter(name="formatEntries")
    def format_entries(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['LibraryMasingFormatFormatEntryArgs']]]]:
        """
        (Updatable) An array of format entries. The combined output of all the format entries is used for masking.
        """
        return pulumi.get(self, "format_entries")
    ...
    @format_entries.setter
    def format_entries(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['LibraryMasingFormatFormatEntryArgs']]]]):
        pulumi.set(self, "format_entries", value)
...
class LibraryMasingFormat(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 format_entries: pulumi.Input[Optional[Sequence[pulumi.Input[Union['LibraryMasingFormatFormatEntryArgs', 'LibraryMasingFormatFormatEntryArgsDict', 'outputs.LibraryMasingFormatFormatEntry']]]]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 sensitive_type_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] description: (Updatable) The description of the library masking format.
        :param pulumi.Input[_builtins.str] display_name: (Updatable) The display name of the library masking format. The name does not have to be unique, and it's changeable.
        :param pulumi.Input[Sequence[pulumi.Input[Union['LibraryMasingFormatFormatEntryArgs', 'LibraryMasingFormatFormatEntryArgsDict', 'outputs.LibraryMasingFormatFormatEntry']]]] format_entries: (Updatable) An array of format entries. The combined output of all the format entries is used for masking.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] sensitive_type_ids: (Updatable) An array of OCIDs of the sensitive types compatible with the library masking format. It helps track the sensitive types for which the library masking format is being created.
    ...
    def get(resource_name: str,
            ...
            state: pulumi.Input[Optional[_builtins.str]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None) -> 'LibraryMasingFormat':
        """
