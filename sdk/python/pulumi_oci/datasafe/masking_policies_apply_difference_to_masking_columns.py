...
class MaskingPoliciesApplyDifferenceToMaskingColumnsArgs:
    def __init__(__self__, *,
                 ...
                 sdm_masking_policy_difference_id: pulumi.Input[_builtins.str]):
        """
    ...
    def sdm_masking_policy_difference_id(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "sdm_masking_policy_difference_id")

    @sdm_masking_policy_difference_id.setter
    def sdm_masking_policy_difference_id(self, value: pulumi.Input[_builtins.str]):
...
class MaskingPoliciesApplyDifferenceToMaskingColumns(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="sdmMaskingPolicyDifferenceId")
    def sdm_masking_policy_difference_id(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "sdm_masking_policy_difference_id")
