...
@pulumi.input_type
class MaskingPoliciesApplyDifferenceToMaskingColumnsArgs:
    def __init__(__self__, *,
                 masking_policy_id: pulumi.Input[builtins.str],
                 sdm_masking_policy_difference_id: pulumi.Input[builtins.str]):
        """
    ...
    def sdm_masking_policy_difference_id(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "sdm_masking_policy_difference_id")

    @sdm_masking_policy_difference_id.setter
    def sdm_masking_policy_difference_id(self, value: pulumi.Input[builtins.str]):
...
class _MaskingPoliciesApplyDifferenceToMaskingColumnsState:
    ...
    @property
    @pulumi.getter(name="sdmMaskingPolicyDifferenceId")
    def sdm_masking_policy_difference_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "sdm_masking_policy_difference_id")

    @sdm_masking_policy_difference_id.setter
    def sdm_masking_policy_difference_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sdm_masking_policy_difference_id", value)
...
class MaskingPoliciesApplyDifferenceToMaskingColumns(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 resource_name: str,
                 args: MaskingPoliciesApplyDifferenceToMaskingColumnsArgs,
                 opts: Optional[pulumi.ResourceOptions] = None):
        """
        Create a MaskingPoliciesApplyDifferenceToMaskingColumns resource with the given unique name, props, and options.
        :param str resource_name: The name of the resource.
        :param MaskingPoliciesApplyDifferenceToMaskingColumnsArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(MaskingPoliciesApplyDifferenceToMaskingColumnsArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = MaskingPoliciesApplyDifferenceToMaskingColumnsArgs.__new__(MaskingPoliciesApplyDifferenceToMaskingColumnsArgs)
            ...
            if sdm_masking_policy_difference_id is None and not opts.urn:
                raise TypeError("Missing required property 'sdm_masking_policy_difference_id'")
            __props__.__dict__["sdm_masking_policy_difference_id"] = sdm_masking_policy_difference_id
        super(MaskingPoliciesApplyDifferenceToMaskingColumns, __self__).__init__(
            'oci:DataSafe/maskingPoliciesApplyDifferenceToMaskingColumns:MaskingPoliciesApplyDifferenceToMaskingColumns',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            masking_policy_id: Optional[pulumi.Input[builtins.str]] = None,
            sdm_masking_policy_difference_id: Optional[pulumi.Input[builtins.str]] = None) -> 'MaskingPoliciesApplyDifferenceToMaskingColumns':
        """
        ...
        __props__ = _MaskingPoliciesApplyDifferenceToMaskingColumnsState.__new__(_MaskingPoliciesApplyDifferenceToMaskingColumnsState)

        __props__.__dict__["masking_policy_id"] = masking_policy_id
        __props__.__dict__["sdm_masking_policy_difference_id"] = sdm_masking_policy_difference_id
        return MaskingPoliciesApplyDifferenceToMaskingColumns(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="sdmMaskingPolicyDifferenceId")
    def sdm_masking_policy_difference_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "sdm_masking_policy_difference_id")
