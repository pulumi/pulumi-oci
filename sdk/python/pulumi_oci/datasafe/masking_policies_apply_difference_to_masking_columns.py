...
class MaskingPoliciesApplyDifferenceToMaskingColumnsArgs:
    ...
    def sdm_masking_policy_difference_id(self) -> pulumi.Input[str]:
        return pulumi.get(self, "sdm_masking_policy_difference_id")

    @sdm_masking_policy_difference_id.setter
    def sdm_masking_policy_difference_id(self, value: pulumi.Input[str]):
...
class _MaskingPoliciesApplyDifferenceToMaskingColumnsState:
    ...
    @property
    @pulumi.getter(name="sdmMaskingPolicyDifferenceId")
    def sdm_masking_policy_difference_id(self) -> Optional[pulumi.Input[str]]:
        return pulumi.get(self, "sdm_masking_policy_difference_id")

    @sdm_masking_policy_difference_id.setter
    def sdm_masking_policy_difference_id(self, value: Optional[pulumi.Input[str]]):
        pulumi.set(self, "sdm_masking_policy_difference_id", value)
...
class MaskingPoliciesApplyDifferenceToMaskingColumns(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            masking_policy_id: Optional[pulumi.Input[str]] = None,
            sdm_masking_policy_difference_id: Optional[pulumi.Input[str]] = None) -> 'MaskingPoliciesApplyDifferenceToMaskingColumns':
        """
    ...
    @property
    @pulumi.getter(name="sdmMaskingPolicyDifferenceId")
    def sdm_masking_policy_difference_id(self) -> pulumi.Output[str]:
        return pulumi.get(self, "sdm_masking_policy_difference_id")
