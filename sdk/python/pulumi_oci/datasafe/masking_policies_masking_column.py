...
class MaskingPoliciesMaskingColumnArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_masking_enabled: (Updatable) Indicates whether data masking is enabled for the masking column. Set it to false if  you don't want to mask the column.
...
class _MaskingPoliciesMaskingColumnState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_masking_enabled: (Updatable) Indicates whether data masking is enabled for the masking column. Set it to false if  you don't want to mask the column.
        :param pulumi.Input[_builtins.str] key: The unique key that identifies the masking column. It's numeric and unique within a masking policy.
        :param pulumi.Input[_builtins.str] lifecycle_details: Details about the current state of the masking column.
        :param pulumi.Input[_builtins.str] masking_column_group: (Updatable) The group of the masking column. It's a masking group identifier and can be any string  of acceptable length. All the columns in a group are masked together to ensure that  the masked data across these columns continue to retain the same logical relationship.  For more details, check  <a href=https://docs.oracle.com/en/cloud/paas/data-safe/udscs/group-masking1.html#GUID-755056B9-9540-48C0-9491-262A44A85037>Group Masking in the Data Safe documentation.</a>
        :param pulumi.Input[Sequence[pulumi.Input['MaskingPoliciesMaskingColumnMaskingFormatArgs']]] masking_formats: (Updatable) The masking formats to be assigned to the masking column. You can specify a condition  as part of each masking format. It enables you to do  <a href="https://docs.oracle.com/en/cloud/paas/data-safe/udscs/conditional-masking.html">conditional masking</a>  so that you can mask the column data values differently using different masking  formats and the associated conditions. A masking format can have one or more format  entries. The combined output of all the format entries is used for masking. It  provides the flexibility to define a masking format that can generate different parts  of a data value separately and then combine them to get the final data value for masking.
        :param pulumi.Input[_builtins.str] masking_policy_id: The OCID of the masking policy.
        :param pulumi.Input[_builtins.str] object: The name of the object (table or editioning view) that contains the database column. This attribute cannot be updated for an existing masking column.
        ...
        :param pulumi.Input[_builtins.str] sensitive_type_id: (Updatable) The OCID of the sensitive type to be associated with the masking column. Note that  if the maskingFormats attribute isn't provided while creating a masking column,   the default masking format associated with the specified sensitive type is assigned  to the masking column.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] state: The current state of the masking column.
        :param pulumi.Input[_builtins.str] time_created: The date and time the masking column was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[_builtins.str] time_updated: The date and time the masking column was last updated, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        """
...
@pulumi.type_token("oci:DataSafe/maskingPoliciesMaskingColumn:MaskingPoliciesMaskingColumn")
class MaskingPoliciesMaskingColumn(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 is_masking_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 masking_column_group: pulumi.Input[Optional[_builtins.str]] = None,
                 masking_formats: pulumi.Input[Optional[Sequence[pulumi.Input[Union['MaskingPoliciesMaskingColumnMaskingFormatArgs', 'MaskingPoliciesMaskingColumnMaskingFormatArgsDict', 'outputs.MaskingPoliciesMaskingColumnMaskingFormat']]]]] = None,
                 masking_policy_id: pulumi.Input[Optional[_builtins.str]] = None,
                 object: pulumi.Input[Optional[_builtins.str]] = None,
                 object_type: pulumi.Input[Optional[_builtins.str]] = None,
                 schema_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="childColumns")
    def child_columns(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        An array of child columns that are in referential relationship with the masking column.
        """
        return pulumi.get(self, "child_columns")
    ...
    @_builtins.property
    @pulumi.getter(name="isMaskingEnabled")
    def is_masking_enabled(self) -> pulumi.Output[_builtins.bool]:
        """
        (Updatable) Indicates whether data masking is enabled for the masking column. Set it to false if  you don't want to mask the column.
        """
        return pulumi.get(self, "is_masking_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="maskingColumnGroup")
    def masking_column_group(self) -> pulumi.Output[_builtins.str]:
        """
        (Updatable) The group of the masking column. It's a masking group identifier and can be any string  of acceptable length. All the columns in a group are masked together to ensure that  the masked data across these columns continue to retain the same logical relationship.  For more details, check  <a href=https://docs.oracle.com/en/cloud/paas/data-safe/udscs/group-masking1.html#GUID-755056B9-9540-48C0-9491-262A44A85037>Group Masking in the Data Safe documentation.</a>
        """
        return pulumi.get(self, "masking_column_group")
