...
class MaskingPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] recompile: (Updatable) Specifies how to recompile invalid objects post data masking. Allowed values are 'SERIAL' (recompile in serial),  'PARALLEL' (recompile in parallel), 'NONE' (do not recompile). If it's set to PARALLEL, the value of parallelDegree attribute is used.
        """
...
class MaskingPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_masking_policy = oci.data_safe.MaskingPolicy("testMaskingPolicy",
            column_sources=[oci.data.safe.MaskingPolicyColumnSourceArgs(
