...
class _MaskingReportManagementState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_refresh_stats_enabled: Indicates if statistics gathering was enabled during the masking operation.
        :param pulumi.Input[_builtins.str] masking_policy_id: The OCID of the masking policy.
        :param pulumi.Input[_builtins.str] masking_work_request_id: The OCID of the masking work request that resulted in this masking report.
        :param pulumi.Input[_builtins.str] parallel_degree: Indicates if parallel execution was enabled during the masking operation.
        :param pulumi.Input[_builtins.str] recompile: Indicates how invalid objects were recompiled post the masking operation.
        :param pulumi.Input[_builtins.str] state: The current state of the masking report.
        :param pulumi.Input[_builtins.str] target_id: The OCID of the target database masked.
        :param pulumi.Input[_builtins.str] time_created: The date and time the masking report was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[_builtins.str] time_masking_finished: The date and time data masking finished, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339)
        :param pulumi.Input[_builtins.str] time_masking_started: The date and time data masking started, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339)
        :param pulumi.Input[_builtins.str] total_masked_columns: The total number of masked columns.
        :param pulumi.Input[_builtins.str] total_masked_objects: The total number of unique objects (tables and editioning views) that contain the masked columns.
        :param pulumi.Input[_builtins.str] total_masked_schemas: The total number of unique schemas that contain the masked columns.
        :param pulumi.Input[_builtins.str] total_masked_sensitive_types: The total number of unique sensitive types associated with the masked columns.
        :param pulumi.Input[_builtins.str] total_masked_values: The total number of masked values.
        """
        if compartment_id is not None:
            pulumi.set(__self__, "compartment_id", compartment_id)
...
class MaskingReportManagement(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="maskingWorkRequestId")
    def masking_work_request_id(self) -> pulumi.Output[_builtins.str]:
        """
        The OCID of the masking work request that resulted in this masking report.
        """
        return pulumi.get(self, "masking_work_request_id")
    ...
    @_builtins.property
    @pulumi.getter(name="timeMaskingFinished")
    def time_masking_finished(self) -> pulumi.Output[_builtins.str]:
        """
        The date and time data masking finished, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339)
        """
        return pulumi.get(self, "time_masking_finished")
    ...
    @_builtins.property
    @pulumi.getter(name="timeMaskingStarted")
    def time_masking_started(self) -> pulumi.Output[_builtins.str]:
        """
        The date and time data masking started, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339)
        """
        return pulumi.get(self, "time_masking_started")
    ...
    @_builtins.property
    @pulumi.getter(name="totalMaskedColumns")
    def total_masked_columns(self) -> pulumi.Output[_builtins.str]:
        """
        The total number of masked columns.
        """
        return pulumi.get(self, "total_masked_columns")
    ...
    @_builtins.property
    @pulumi.getter(name="totalMaskedObjects")
    def total_masked_objects(self) -> pulumi.Output[_builtins.str]:
        """
        The total number of unique objects (tables and editioning views) that contain the masked columns.
        """
        return pulumi.get(self, "total_masked_objects")
    ...
    @_builtins.property
    @pulumi.getter(name="totalMaskedSchemas")
    def total_masked_schemas(self) -> pulumi.Output[_builtins.str]:
        """
        The total number of unique schemas that contain the masked columns.
        """
        return pulumi.get(self, "total_masked_schemas")
    ...
    @_builtins.property
    @pulumi.getter(name="totalMaskedSensitiveTypes")
    def total_masked_sensitive_types(self) -> pulumi.Output[_builtins.str]:
        """
        The total number of unique sensitive types associated with the masked columns.
        """
        return pulumi.get(self, "total_masked_sensitive_types")
    ...
    @_builtins.property
    @pulumi.getter(name="totalMaskedValues")
    def total_masked_values(self) -> pulumi.Output[_builtins.str]:
        """
        The total number of masked values.
        """
        return pulumi.get(self, "total_masked_values")
