...
class OnPremConnectorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment where you want to create the on-premises connector.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) The description of the on-premises connector.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the on-premises connector. The name does not have to be unique, and it's changeable.
...
class _OnPremConnectorState:
    def __init__(__self__, *,
                 ...
                 created_version: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] available_version: Latest available version of the on-premises connector.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment where you want to create the on-premises connector.
        :param pulumi.Input[builtins.str] created_version: Created version of the on-premises connector.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm) Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] description: (Updatable) The description of the on-premises connector.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the on-premises connector. The name does not have to be unique, and it's changeable.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}` 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] lifecycle_details: Details about the current state of the on-premises connector.
        :param pulumi.Input[builtins.str] state: The current state of the on-premises connector.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the on-premises connector was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        """
    ...
    def created_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def created_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class OnPremConnector(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'OnPremConnector':
        """
    ...
    @property
    @pulumi.getter(name="createdVersion")
    def created_version(self) -> pulumi.Output[builtins.str]:
        """
        Created version of the on-premises connector.
        """
        return pulumi.get(self, "created_version")
