...
class ReportArgs:
    def __init__(__self__, *,
                 report_id: pulumi.Input[builtins.str],
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Report resource.
        :param pulumi.Input[builtins.str] report_id: Unique report identifier
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment containing the report.
    ...
    def report_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @report_id.setter
    def report_id(self, value: pulumi.Input[builtins.str]):
...
class _ReportState:
    def __init__(__self__, *,
                 ...
                 report_definition_id: Optional[pulumi.Input[builtins.str]] = None,
                 report_id: Optional[pulumi.Input[builtins.str]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 time_generated: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Report resources.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment containing the report.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm) Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] description: Specifies a description of the report.
        :param pulumi.Input[builtins.str] display_name: Name of the report.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] lifecycle_details: Details about the current state of the report in Data Safe.
        :param pulumi.Input[builtins.str] mime_type: Specifies the format of report to be .xls or .pdf or .json
        :param pulumi.Input[builtins.str] report_definition_id: The OCID of the report definition.
        :param pulumi.Input[builtins.str] report_id: Unique report identifier
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The current state of the audit report.
        ...
        :param pulumi.Input[builtins.str] time_generated: Specifies the date and time the report was generated.
        :param pulumi.Input[builtins.str] type: The type of the audit report.
        """
        if compartment_id is not None:
            pulumi.set(__self__, "compartment_id", compartment_id)
        if defined_tags is not None:
    ...
    def report_definition_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def report_definition_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_generated(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_generated(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Report(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="reportDefinitionId")
    def report_definition_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the report definition.
        """
        return pulumi.get(self, "report_definition_id")
    ...
    @property
    @pulumi.getter(name="reportId")
    def report_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique report identifier
    ...
    @property
    @pulumi.getter(name="timeGenerated")
    def time_generated(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the date and time the report was generated.
        """
        return pulumi.get(self, "time_generated")
