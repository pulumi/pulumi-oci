...
class SdmMaskingPolicyDifferenceArgs:
    def __init__(__self__, *,
                 ...
                 difference_type: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a SdmMaskingPolicyDifference resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment where the SDM masking policy difference resource should be created.
        :param pulumi.Input[builtins.str] masking_policy_id: The OCID of the masking policy. Note that if the masking policy is not associated with an SDM, CreateSdmMaskingPolicyDifference operation won't be allowed. 
        ...
        :param pulumi.Input[builtins.str] difference_type: The type of the SDM masking policy difference. It defines the difference scope. NEW identifies new sensitive columns in the sensitive data model that are not in the masking policy. DELETED identifies columns that are present in the masking policy but have been deleted from the sensitive data model. MODIFIED identifies columns that are present in the sensitive data model as well as the masking policy but some of their attributes have been modified. ALL covers all the above three scenarios and reports new, deleted and modified columns.
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name for the SDM masking policy difference. Does not have to be unique, and it is changeable. Avoid entering confidential information.
    ...
    def difference_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def difference_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SdmMaskingPolicyDifferenceState:
    def __init__(__self__, *,
                 ...
                 time_creation_started: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] masking_policy_id: The OCID of the masking policy. Note that if the masking policy is not associated with an SDM, CreateSdmMaskingPolicyDifference operation won't be allowed. 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] sensitive_data_model_id: The OCID of the sensitive data model associated with the SDM masking policy difference.
        :param pulumi.Input[builtins.str] state: The current state of the SDM masking policy difference.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the SDM masking policy difference was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] time_creation_started: The date and time the SDM masking policy difference creation started, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        """
    ...
    def time_creation_started(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_creation_started(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SdmMaskingPolicyDifference(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_creation_started: Optional[pulumi.Input[builtins.str]] = None) -> 'SdmMaskingPolicyDifference':
        """
    ...
    @property
    @pulumi.getter(name="differenceType")
    def difference_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the SDM masking policy difference. It defines the difference scope. NEW identifies new sensitive columns in the sensitive data model that are not in the masking policy. DELETED identifies columns that are present in the masking policy but have been deleted from the sensitive data model. MODIFIED identifies columns that are present in the sensitive data model as well as the masking policy but some of their attributes have been modified. ALL covers all the above three scenarios and reports new, deleted and modified columns.
        """
        return pulumi.get(self, "difference_type")
    ...
    @property
    @pulumi.getter(name="timeCreationStarted")
    def time_creation_started(self) -> pulumi.Output[builtins.str]:
        """
        The date and time the SDM masking policy difference creation started, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        """
        return pulumi.get(self, "time_creation_started")
