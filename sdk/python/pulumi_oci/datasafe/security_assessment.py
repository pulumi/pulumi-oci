...
class SecurityAssessmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment that contains the security assessment.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Description of the security assessment.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the security assessment.
        ...
        :param pulumi.Input[builtins.str] schedule: (Updatable) To schedule the assessment for running periodically, specify the schedule in this attribute. Create or schedule one assessment per compartment. If not defined, the assessment runs immediately. Format - <version-string>;<version-specific-schedule>
        ...
        :param pulumi.Input[builtins.str] target_id: The OCID of the target database on which security assessment is to be run.
...
class _SecurityAssessmentState:
    def __init__(__self__, *,
                 ...
                 ignored_targets: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 is_assessment_scheduled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 schedule: Optional[pulumi.Input[builtins.str]] = None,
                 schedule_security_assessment_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ignored_targets: List containing maps as values. Example: `{"Operations": [ {"CostCenter": "42"} ] }`
        :param pulumi.Input[builtins.bool] is_assessment_scheduled: (Updatable) Indicates whether the assessment is scheduled to run.
        :param pulumi.Input[builtins.bool] is_baseline: Indicates whether or not the security assessment is set as a baseline. This is applicable only for saved security assessments.
        :param pulumi.Input[builtins.bool] is_deviated_from_baseline: Indicates whether or not the security assessment deviates from the baseline.
        :param pulumi.Input[builtins.str] last_compared_baseline_id: The OCID of the baseline against which the latest security assessment was compared.
        :param pulumi.Input[builtins.str] lifecycle_details: Details about the current state of the security assessment.
        :param pulumi.Input[builtins.str] link: The summary of findings for the security assessment.
        :param pulumi.Input[builtins.str] schedule: (Updatable) To schedule the assessment for running periodically, specify the schedule in this attribute. Create or schedule one assessment per compartment. If not defined, the assessment runs immediately. Format - <version-string>;<version-specific-schedule>
               
               Allowed version strings - "v1" v1's version specific schedule -<ss> <mm> <hh> <day-of-week> <day-of-month> Each of the above fields potentially introduce constraints. A workrequest is created only when clock time satisfies all the constraints. Constraints introduced: 1. seconds = <ss> (So, the allowed range for <ss> is [0, 59]) 2. minutes = <mm> (So, the allowed range for <mm> is [0, 59]) 3. hours = <hh> (So, the allowed range for <hh> is [0, 23]) <day-of-week> can be either '*' (without quotes or a number between 1(Monday) and 7(Sunday)) 4. No constraint introduced when it is '*'. When not, day of week must equal the given value <day-of-month> can be either '*' (without quotes or a number between 1 and 28) 5. No constraint introduced when it is '*'. When not, day of month must equal the given value
        :param pulumi.Input[builtins.str] schedule_security_assessment_id: The OCID of the security assessment that is responsible for creating this scheduled save assessment.
        :param pulumi.Input[builtins.str] state: The current state of the security assessment.
        ...
        :param pulumi.Input[builtins.str] target_version: The version of the target database.
        :param pulumi.Input[builtins.str] time_created: The date and time the security assessment was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] time_last_assessed: The date and time the security assessment was last executed, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] time_updated: The date and time the security assessment was last updated, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] triggered_by: Indicates whether the security assessment was created by system or by a user.
        :param pulumi.Input[builtins.str] type: The type of this security assessment. The possible types are:
        """
    ...
    def ignored_targets(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        List containing maps as values. Example: `{"Operations": [ {"CostCenter": "42"} ] }`
        """
    ...
    def ignored_targets(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def schedule_security_assessment_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def schedule_security_assessment_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SecurityAssessment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            triggered_by: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'SecurityAssessment':
        """
    ...
    @property
    @pulumi.getter(name="ignoredTargets")
    def ignored_targets(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List containing maps as values. Example: `{"Operations": [ {"CostCenter": "42"} ] }`
        """
        return pulumi.get(self, "ignored_targets")
    ...
    @property
    @pulumi.getter(name="scheduleSecurityAssessmentId")
    def schedule_security_assessment_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the security assessment that is responsible for creating this scheduled save assessment.
        """
        return pulumi.get(self, "schedule_security_assessment_id")
