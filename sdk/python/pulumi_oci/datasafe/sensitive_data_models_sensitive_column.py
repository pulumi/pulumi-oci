...
class _SensitiveDataModelsSensitiveColumnState:
    def __init__(__self__, *,
                 ...
                 confidence_level_details: pulumi.Input[Optional[Sequence[pulumi.Input['SensitiveDataModelsSensitiveColumnConfidenceLevelDetailArgs']]]] = None,
                 data_type: pulumi.Input[Optional[_builtins.str]] = None,
                 db_defined_child_column_keys: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] key: The unique key that identifies the sensitive column. It's numeric and unique within a sensitive data model.
        :param pulumi.Input[_builtins.str] lifecycle_details: Details about the current state of the sensitive column.
        :param pulumi.Input[_builtins.str] object: The database object that contains the sensitive column.
        :param pulumi.Input[_builtins.str] object_type: The type of the database object that contains the sensitive column.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] parent_column_keys: (Updatable) Unique keys identifying the columns that are parents of the sensitive column. At present, it accepts only one parent column key. This attribute can be used to establish relationship between columns in a sensitive data model. Note that the parent column must be added to the sensitive data model before its key can be specified here. If this attribute is provided, the appDefinedChildColumnKeys or dbDefinedChildColumnKeys attribute of the parent column is automatically updated to reflect the relationship.
        :param pulumi.Input[_builtins.str] relation_type: (Updatable) The type of referential relationship the sensitive column has with its parent. NONE indicates that the sensitive column does not have a parent. DB_DEFINED indicates that the relationship is defined in the database dictionary. APP_DEFINED indicates that the relationship is defined at the application level and not in the database dictionary.
        ...
        :param pulumi.Input[_builtins.str] sensitive_data_model_id: The OCID of the sensitive data model.
        :param pulumi.Input[_builtins.str] sensitive_type_id: (Updatable) The OCID of the sensitive type to be associated with the sensitive column.
        :param pulumi.Input[_builtins.str] source: The source of the sensitive column. DISCOVERY indicates that the column was added to the sensitive data model using a data discovery job. MANUAL indicates that the column was added manually.
        :param pulumi.Input[_builtins.str] state: The current state of the sensitive column.
        :param pulumi.Input[_builtins.str] status: (Updatable) The status of the sensitive column. VALID means the column is considered sensitive. INVALID means the column is not considered sensitive. Tracking invalid columns in a sensitive data model helps ensure that an incremental data discovery job does not identify these columns as sensitive.
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] time_created: The date and time, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339), the sensitive column was created in the sensitive data model.
        :param pulumi.Input[_builtins.str] time_updated: The date and time, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339), the sensitive column was last updated in the sensitive data model.
        """
        if app_defined_child_column_keys is not None:
            pulumi.set(__self__, "app_defined_child_column_keys", app_defined_child_column_keys)
        if app_name is not None:
    ...
    def column_groups(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def column_groups(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
    ...
    def confidence_level_details(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['SensitiveDataModelsSensitiveColumnConfidenceLevelDetailArgs']]]]:
        """
    ...
    def confidence_level_details(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['SensitiveDataModelsSensitiveColumnConfidenceLevelDetailArgs']]]]):
...
class SensitiveDataModelsSensitiveColumn(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: pulumi.Input[Optional[_builtins.str]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None) -> 'SensitiveDataModelsSensitiveColumn':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="columnGroups")
    def column_groups(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        The composite key groups to which the sensitive column belongs. If the column is part of a composite key, it's assigned a column group. It helps identify and manage referential relationships that involve composite keys.
        """
        return pulumi.get(self, "column_groups")
