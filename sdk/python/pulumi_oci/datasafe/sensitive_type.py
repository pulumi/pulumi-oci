...
class SensitiveTypeArgs:
    def __init__(__self__, *,
                 ...
                 comment_pattern: Optional[pulumi.Input[builtins.str]] = None,
                 data_pattern: Optional[pulumi.Input[builtins.str]] = None,
                 default_masking_format_id: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 name_pattern: Optional[pulumi.Input[builtins.str]] = None,
                 parent_category_id: Optional[pulumi.Input[builtins.str]] = None,
                 search_type: Optional[pulumi.Input[builtins.str]] = None,
                 short_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SensitiveType resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment where the sensitive type should be created.
        :param pulumi.Input[builtins.str] entity_type: (Updatable) The entity type. It can be either a sensitive type with regular expressions or a sensitive category used for grouping similar sensitive types.
        :param pulumi.Input[builtins.str] comment_pattern: (Updatable) A regular expression to be used by data discovery for matching column comments.
        :param pulumi.Input[builtins.str] data_pattern: (Updatable) A regular expression to be used by data discovery for matching column data values.
        :param pulumi.Input[builtins.str] default_masking_format_id: (Updatable) The OCID of the library masking format that should be used to mask the sensitive columns associated with the sensitive type.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) The description of the sensitive type.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the sensitive type. The name does not have to be unique, and it's changeable.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] name_pattern: (Updatable) A regular expression to be used by data discovery for matching column names.
        :param pulumi.Input[builtins.str] parent_category_id: (Updatable) The OCID of the parent sensitive category.
        :param pulumi.Input[builtins.str] search_type: (Updatable) The search type indicating how the column name, comment and data patterns should be used by data discovery. [Learn more](https://docs.oracle.com/en/cloud/paas/data-safe/udscs/sensitive-types.html#GUID-1D1AD98E-B93F-4FF2-80AE-CB7D8A14F6CC).
        :param pulumi.Input[builtins.str] short_name: (Updatable) The short name of the sensitive type.
    ...
    def comment_pattern(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def comment_pattern(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "comment_pattern", value)

    @property
    @pulumi.getter(name="dataPattern")
    def data_pattern(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @data_pattern.setter
    def data_pattern(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "data_pattern", value)

    @property
    @pulumi.getter(name="defaultMaskingFormatId")
    def default_masking_format_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_masking_format_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def parent_category_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def parent_category_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "parent_category_id", value)

    @property
    @pulumi.getter(name="searchType")
    def search_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @search_type.setter
    def search_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SensitiveTypeState:
    def __init__(__self__, *,
                 ...
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_common: Optional[pulumi.Input[builtins.bool]] = None,
                 name_pattern: Optional[pulumi.Input[builtins.str]] = None,
                 parent_category_id: Optional[pulumi.Input[builtins.str]] = None,
                 search_type: Optional[pulumi.Input[builtins.str]] = None,
                 short_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] entity_type: (Updatable) The entity type. It can be either a sensitive type with regular expressions or a sensitive category used for grouping similar sensitive types.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] is_common: Specifies whether the sensitive type is common. Common sensitive types belong to  library sensitive types which are frequently used to perform sensitive data discovery.
        :param pulumi.Input[builtins.str] name_pattern: (Updatable) A regular expression to be used by data discovery for matching column names.
        :param pulumi.Input[builtins.str] parent_category_id: (Updatable) The OCID of the parent sensitive category.
        :param pulumi.Input[builtins.str] search_type: (Updatable) The search type indicating how the column name, comment and data patterns should be used by data discovery. [Learn more](https://docs.oracle.com/en/cloud/paas/data-safe/udscs/sensitive-types.html#GUID-1D1AD98E-B93F-4FF2-80AE-CB7D8A14F6CC).
        :param pulumi.Input[builtins.str] short_name: (Updatable) The short name of the sensitive type.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] source: Specifies whether the sensitive type is user-defined or predefined.
        :param pulumi.Input[builtins.str] state: The current state of the sensitive type.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the sensitive type was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] time_updated: The date and time the sensitive type was last updated, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        """
        if comment_pattern is not None:
            pulumi.set(__self__, "comment_pattern", comment_pattern)
    ...
    def is_common(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_common.setter
    def is_common(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class SensitiveType(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'SensitiveType':
        """
    ...
    @property
    @pulumi.getter(name="commentPattern")
    def comment_pattern(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) A regular expression to be used by data discovery for matching column comments.
        """
        return pulumi.get(self, "comment_pattern")
    ...
    @property
    @pulumi.getter(name="dataPattern")
    def data_pattern(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) A regular expression to be used by data discovery for matching column data values.
        """
        return pulumi.get(self, "data_pattern")
    ...
    @property
    @pulumi.getter(name="defaultMaskingFormatId")
    def default_masking_format_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The OCID of the library masking format that should be used to mask the sensitive columns associated with the sensitive type.
        """
        return pulumi.get(self, "default_masking_format_id")
    ...
    @property
    @pulumi.getter(name="isCommon")
    def is_common(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies whether the sensitive type is common. Common sensitive types belong to  library sensitive types which are frequently used to perform sensitive data discovery.
        """
        return pulumi.get(self, "is_common")
    ...
    @property
    @pulumi.getter(name="namePattern")
    def name_pattern(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) A regular expression to be used by data discovery for matching column names.
        """
        return pulumi.get(self, "name_pattern")
    ...
    @property
    @pulumi.getter(name="parentCategoryId")
    def parent_category_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The OCID of the parent sensitive category.
        """
        return pulumi.get(self, "parent_category_id")
    ...
    @property
    @pulumi.getter(name="searchType")
    def search_type(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The search type indicating how the column name, comment and data patterns should be used by data discovery. [Learn more](https://docs.oracle.com/en/cloud/paas/data-safe/udscs/sensitive-types.html#GUID-1D1AD98E-B93F-4FF2-80AE-CB7D8A14F6CC).
        """
        return pulumi.get(self, "search_type")
