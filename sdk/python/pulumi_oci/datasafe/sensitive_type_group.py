...
class SensitiveTypeGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment where the sensitive type group should be created.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) The description of the sensitive type group.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the sensitive type group. The name does not have to be unique.
...
class _SensitiveTypeGroupState:
    def __init__(__self__, *,
                 ...
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 sensitive_type_count: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}` 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.int] sensitive_type_count: The number of sensitive types in the specified sensitive type group.
        :param pulumi.Input[builtins.str] state: The current state of the sensitive type group.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the sensitive type group was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] time_updated: The date and time the sensitive type group was last updated, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        """
    ...
    def sensitive_type_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def sensitive_type_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class SensitiveTypeGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'SensitiveTypeGroup':
        """
    ...
    @property
    @pulumi.getter(name="sensitiveTypeCount")
    def sensitive_type_count(self) -> pulumi.Output[builtins.int]:
        """
        The number of sensitive types in the specified sensitive type group.
        """
        return pulumi.get(self, "sensitive_type_count")
