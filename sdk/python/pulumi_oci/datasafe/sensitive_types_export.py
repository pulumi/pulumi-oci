...
class SensitiveTypesExportArgs:
    def __init__(__self__, *,
                 ...
                 sensitive_type_ids_for_exports: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a SensitiveTypesExport resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment where the sensitive types export should be created.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) The description of the sensitive types export.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the sensitive types export. The name does not have to be unique, and it's changeable.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] is_include_all_sensitive_types: Indicates if all the existing user-defined sensitive types are used for export. If it's set to true, the sensitiveTypeIdsForExport attribute is ignored and all user-defined sensitive types are used.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sensitive_type_ids_for_exports: The OCIDs of the sensitive types used to create sensitive types export. 
    ...
    def sensitive_type_ids_for_exports(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def sensitive_type_ids_for_exports(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _SensitiveTypesExportState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sensitive_type_ids_for_exports: The OCIDs of the sensitive types used to create sensitive types export. 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The current state of the sensitive types export.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the sensitive types export was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] time_updated: The date and time the sensitive types export was last updated, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        """
...
class SensitiveTypesExport(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'SensitiveTypesExport':
        """
    ...
    @property
    @pulumi.getter(name="sensitiveTypeIdsForExports")
    def sensitive_type_ids_for_exports(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The OCIDs of the sensitive types used to create sensitive types export. 
