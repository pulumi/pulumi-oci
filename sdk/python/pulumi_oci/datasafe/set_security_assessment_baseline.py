...
class SetSecurityAssessmentBaselineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] assessment_ids: The list of OCIDs for the security assessments that need to be updated while setting the baseline.
        """
...
@pulumi.type_token("oci:DataSafe/setSecurityAssessmentBaseline:SetSecurityAssessmentBaseline")
class SetSecurityAssessmentBaseline(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            assessment_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            security_assessment_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SetSecurityAssessmentBaseline':
        """
