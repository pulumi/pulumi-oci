...
class SetSecurityAssessmentBaselineManagementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] target_id: The target OCID for which SA needs to be set as baseline.
        """
...
@pulumi.type_token("oci:DataSafe/setSecurityAssessmentBaselineManagement:SetSecurityAssessmentBaselineManagement")
class SetSecurityAssessmentBaselineManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            compartment_id: Optional[pulumi.Input[_builtins.str]] = None,
            security_assessment_id: Optional[pulumi.Input[_builtins.str]] = None,
            target_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'SetSecurityAssessmentBaselineManagement':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="assessmentIds")
    def assessment_ids(self) -> pulumi.Output[Sequence[_builtins.str]]:
        return pulumi.get(self, "assessment_ids")
