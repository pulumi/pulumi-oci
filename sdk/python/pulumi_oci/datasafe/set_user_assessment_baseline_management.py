...
class SetUserAssessmentBaselineManagementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] target_id: The target OCID for which UA needs to be set as baseline.
        """
...
@pulumi.type_token("oci:DataSafe/setUserAssessmentBaselineManagement:SetUserAssessmentBaselineManagement")
class SetUserAssessmentBaselineManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            compartment_id: Optional[pulumi.Input[builtins.str]] = None,
            target_id: Optional[pulumi.Input[builtins.str]] = None,
            user_assessment_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SetUserAssessmentBaselineManagement':
        """
