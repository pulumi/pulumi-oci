...
class SqlCollectionArgs:
    def __init__(__self__, *,
                 ...
                 generate_sql_firewall_policy_trigger: Optional[pulumi.Input[builtins.bool]] = None,
                 purge_logs_trigger: Optional[pulumi.Input[builtins.bool]] = None,
                 refresh_log_insights_trigger: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment containing the SQL collection.
        :param pulumi.Input[builtins.str] db_user_name: The database user name.
        :param pulumi.Input[builtins.str] target_id: The OCID of the target corresponding to the security policy deployment.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) The description of the SQL collection.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the SQL collection. The name does not have to be unique, and it is changeable.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] generate_sql_firewall_policy_trigger: (Updatable) An optional property when incremented triggers Generate Sql Firewall Policy. Could be set to any integer value.
        :param pulumi.Input[builtins.bool] purge_logs_trigger: (Updatable) An optional property when incremented triggers Purge Logs. Could be set to any integer value.
        :param pulumi.Input[builtins.bool] refresh_log_insights_trigger: (Updatable) An optional property when incremented triggers Refresh Log Insights. Could be set to any integer value.
        :param pulumi.Input[builtins.str] sql_level: Specifies the level of SQL that will be collected. USER_ISSUED_SQL - User issued SQL statements only. ALL_SQL - Includes all SQL statements including SQL statement issued inside PL/SQL units.
        :param pulumi.Input[builtins.bool] start_trigger: (Updatable) An optional property when incremented triggers Start. Could be set to any integer value.
        :param pulumi.Input[builtins.str] status: Specifies if the SqlCollection has to be started after creation. Enabled indicates that the SqlCollection will be started after creation.
        :param pulumi.Input[builtins.bool] stop_trigger: (Updatable) An optional property when incremented triggers Stop. Could be set to any integer value.
    ...
    def generate_sql_firewall_policy_trigger(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def generate_sql_firewall_policy_trigger(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "generate_sql_firewall_policy_trigger", value)

    @property
    @pulumi.getter(name="purgeLogsTrigger")
    def purge_logs_trigger(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def purge_logs_trigger(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "purge_logs_trigger", value)

    @property
    @pulumi.getter(name="refreshLogInsightsTrigger")
    def refresh_log_insights_trigger(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def refresh_log_insights_trigger(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _SqlCollectionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] generate_sql_firewall_policy_trigger: (Updatable) An optional property when incremented triggers Generate Sql Firewall Policy. Could be set to any integer value.
        :param pulumi.Input[builtins.str] lifecycle_details: Details about the current state of the SQL collection in Data Safe.
        :param pulumi.Input[builtins.bool] purge_logs_trigger: (Updatable) An optional property when incremented triggers Purge Logs. Could be set to any integer value.
        :param pulumi.Input[builtins.bool] refresh_log_insights_trigger: (Updatable) An optional property when incremented triggers Refresh Log Insights. Could be set to any integer value.
        :param pulumi.Input[builtins.str] sql_level: Specifies the level of SQL that will be collected. USER_ISSUED_SQL - User issued SQL statements only. ALL_SQL - Includes all SQL statements including SQL statement issued inside PL/SQL units.
        :param pulumi.Input[builtins.bool] start_trigger: (Updatable) An optional property when incremented triggers Start. Could be set to any integer value.
        :param pulumi.Input[builtins.str] state: The current state of the SQL collection.
        :param pulumi.Input[builtins.str] status: Specifies if the SqlCollection has to be started after creation. Enabled indicates that the SqlCollection will be started after creation.
        :param pulumi.Input[builtins.bool] stop_trigger: (Updatable) An optional property when incremented triggers Stop. Could be set to any integer value.
        ...
        :param pulumi.Input[builtins.str] target_id: The OCID of the target corresponding to the security policy deployment.
        :param pulumi.Input[builtins.str] time_created: The time that the SQL collection was created, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_last_started: The timestamp of the most recent SqlCollection start operation, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_last_stopped: The timestamp of the most recent SqlCollection stop operation, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_updated: The last date and time the SQL collection was updated, in the format defined by RFC3339.
        """
...
class SqlCollection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_last_started: Optional[pulumi.Input[builtins.str]] = None,
            time_last_stopped: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'SqlCollection':
        """
    ...
    @property
    @pulumi.getter(name="generateSqlFirewallPolicyTrigger")
    def generate_sql_firewall_policy_trigger(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        (Updatable) An optional property when incremented triggers Generate Sql Firewall Policy. Could be set to any integer value.
        """
        return pulumi.get(self, "generate_sql_firewall_policy_trigger")
    ...
    @property
    @pulumi.getter(name="purgeLogsTrigger")
    def purge_logs_trigger(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        (Updatable) An optional property when incremented triggers Purge Logs. Could be set to any integer value.
        """
        return pulumi.get(self, "purge_logs_trigger")
    ...
    @property
    @pulumi.getter(name="refreshLogInsightsTrigger")
    def refresh_log_insights_trigger(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        (Updatable) An optional property when incremented triggers Refresh Log Insights. Could be set to any integer value.
        """
        return pulumi.get(self, "refresh_log_insights_trigger")
    ...
    @property
    @pulumi.getter(name="timeLastStarted")
    def time_last_started(self) -> pulumi.Output[builtins.str]:
        """
        The timestamp of the most recent SqlCollection start operation, in the format defined by RFC3339.
        """
        return pulumi.get(self, "time_last_started")
    ...
    @property
    @pulumi.getter(name="timeLastStopped")
    def time_last_stopped(self) -> pulumi.Output[builtins.str]:
        """
        The timestamp of the most recent SqlCollection stop operation, in the format defined by RFC3339.
        """
        return pulumi.get(self, "time_last_stopped")
