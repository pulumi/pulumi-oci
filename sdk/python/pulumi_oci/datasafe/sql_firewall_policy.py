...
class SqlFirewallPolicyArgs:
    def __init__(__self__, *,
                 sql_firewall_policy_id: pulumi.Input[builtins.str],
                 allowed_client_ips: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 allowed_client_os_usernames: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 allowed_client_programs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 enforcement_scope: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 violation_action: Optional[pulumi.Input[builtins.str]] = None,
                 violation_audit: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SqlFirewallPolicy resource.
        :param pulumi.Input[builtins.str] sql_firewall_policy_id: The OCID of the SQL Firewall policy resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_client_ips: (Updatable) List of allowed ip addresses for the SQL Firewall policy.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_client_os_usernames: (Updatable) List of allowed operating system user names for the SQL Firewall policy.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_client_programs: (Updatable) List of allowed client programs for the SQL Firewall policy.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment containing the SQL Firewall policy.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) The description of the SQL Firewall policy.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the SQL Firewall policy. The name does not have to be unique, and it is changeable.
        :param pulumi.Input[builtins.str] enforcement_scope: (Updatable) Specifies the SQL Firewall policy enforcement option.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] status: (Updatable) Specifies whether the SQL Firewall policy is enabled or disabled.
        :param pulumi.Input[builtins.str] violation_action: (Updatable) Specifies the SQL Firewall action based on detection of SQL Firewall violations.
        :param pulumi.Input[builtins.str] violation_audit: (Updatable) Specifies whether a unified audit policy should be enabled for auditing the SQL Firewall policy violations.
    ...
    def sql_firewall_policy_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def sql_firewall_policy_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "sql_firewall_policy_id", value)

    @property
    @pulumi.getter(name="allowedClientIps")
    def allowed_client_ips(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def allowed_client_ips(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "allowed_client_ips", value)

    @property
    @pulumi.getter(name="allowedClientOsUsernames")
    def allowed_client_os_usernames(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def allowed_client_os_usernames(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "allowed_client_os_usernames", value)

    @property
    @pulumi.getter(name="allowedClientPrograms")
    def allowed_client_programs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def allowed_client_programs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def enforcement_scope(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def enforcement_scope(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def violation_action(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def violation_action(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "violation_action", value)

    @property
    @pulumi.getter(name="violationAudit")
    def violation_audit(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def violation_audit(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SqlFirewallPolicyState:
    def __init__(__self__, *,
                 ...
                 sql_firewall_policy_id: Optional[pulumi.Input[builtins.str]] = None,
                 sql_level: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] enforcement_scope: (Updatable) Specifies the SQL Firewall policy enforcement option.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] lifecycle_details: Details about the current state of the SQL Firewall policy in Data Safe.
        :param pulumi.Input[builtins.str] security_policy_id: The OCID of the security policy corresponding to the SQL Firewall policy.
        :param pulumi.Input[builtins.str] sql_firewall_policy_id: The OCID of the SQL Firewall policy resource.
        :param pulumi.Input[builtins.str] sql_level: Specifies the level of SQL included for this SQL Firewall policy. USER_ISSUED_SQL - User issued SQL statements only. ALL_SQL - Includes all SQL statements including SQL statement issued inside PL/SQL units.
        :param pulumi.Input[builtins.str] state: The current state of the SQL Firewall policy.
        :param pulumi.Input[builtins.str] status: (Updatable) Specifies whether the SQL Firewall policy is enabled or disabled.
        ...
        :param pulumi.Input[builtins.str] time_created: The time that the SQL Firewall policy was created, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_updated: The date and time the SQL Firewall policy was last updated, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] violation_action: (Updatable) Specifies the SQL Firewall action based on detection of SQL Firewall violations.
        :param pulumi.Input[builtins.str] violation_audit: (Updatable) Specifies whether a unified audit policy should be enabled for auditing the SQL Firewall policy violations.
    ...
    @property
    @pulumi.getter(name="sqlFirewallPolicyId")
    def sql_firewall_policy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The OCID of the SQL Firewall policy resource.
        """
        return pulumi.get(self, "sql_firewall_policy_id")
    ...
    @sql_firewall_policy_id.setter
    def sql_firewall_policy_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "sql_firewall_policy_id", value)

    @property
    @pulumi.getter(name="sqlLevel")
    def sql_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sql_level.setter
    def sql_level(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SqlFirewallPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            violation_action: Optional[pulumi.Input[builtins.str]] = None,
            violation_audit: Optional[pulumi.Input[builtins.str]] = None) -> 'SqlFirewallPolicy':
        """
    ...
    @property
    @pulumi.getter(name="allowedClientIps")
    def allowed_client_ips(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) List of allowed ip addresses for the SQL Firewall policy.
        """
        return pulumi.get(self, "allowed_client_ips")
    ...
    @property
    @pulumi.getter(name="allowedClientOsUsernames")
    def allowed_client_os_usernames(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) List of allowed operating system user names for the SQL Firewall policy.
        """
        return pulumi.get(self, "allowed_client_os_usernames")
    ...
    @property
    @pulumi.getter(name="allowedClientPrograms")
    def allowed_client_programs(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) List of allowed client programs for the SQL Firewall policy.
        """
        return pulumi.get(self, "allowed_client_programs")
    ...
    @property
    @pulumi.getter(name="dbUserName")
    def db_user_name(self) -> pulumi.Output[builtins.str]:
        """
        The database user name.
        """
        return pulumi.get(self, "db_user_name")
    ...
    @property
    @pulumi.getter(name="enforcementScope")
    def enforcement_scope(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Specifies the SQL Firewall policy enforcement option.
        """
        return pulumi.get(self, "enforcement_scope")
    ...
    @property
    @pulumi.getter(name="sqlFirewallPolicyId")
    def sql_firewall_policy_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the SQL Firewall policy resource.
        """
        return pulumi.get(self, "sql_firewall_policy_id")
    ...
    @property
    @pulumi.getter(name="sqlLevel")
    def sql_level(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the level of SQL included for this SQL Firewall policy. USER_ISSUED_SQL - User issued SQL statements only. ALL_SQL - Includes all SQL statements including SQL statement issued inside PL/SQL units.
        """
        return pulumi.get(self, "sql_level")
    ...
    @property
    @pulumi.getter(name="violationAction")
    def violation_action(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Specifies the SQL Firewall action based on detection of SQL Firewall violations.
        """
        return pulumi.get(self, "violation_action")
    ...
    @property
    @pulumi.getter(name="violationAudit")
    def violation_audit(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Specifies whether a unified audit policy should be enabled for auditing the SQL Firewall policy violations.
