...
class TargetAlertPolicyAssociationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment where the target-alert policy association is created.
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) Indicates if the target-alert policy association is enabled or disabled.
        :param pulumi.Input[builtins.str] policy_id: The OCID of the alert policy.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Describes the target-alert policy association.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the target-alert policy association.
...
class _TargetAlertPolicyAssociationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) Indicates if the target-alert policy association is enabled or disabled.
        :param pulumi.Input[builtins.str] lifecycle_details: Details about the current state of the target-alert policy association.
        :param pulumi.Input[builtins.str] policy_id: The OCID of the alert policy.
        :param pulumi.Input[builtins.str] state: The current state of the target-alert policy association.
...
class TargetAlertPolicyAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target_id: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'TargetAlertPolicyAssociation':
        """
