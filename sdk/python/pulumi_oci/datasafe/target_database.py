...
class TargetDatabase(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_target_database = oci.data_safe.TargetDatabase("testTargetDatabase",
            ...
            database_details=oci.data.safe.TargetDatabaseDatabaseDetailsArgs(
            ...
            connection_option=oci.data.safe.TargetDatabaseConnectionOptionArgs(
            ...
            credentials=oci.data.safe.TargetDatabaseCredentialsArgs(
            ...
            tls_config=oci.data.safe.TargetDatabaseTlsConfigArgs(
