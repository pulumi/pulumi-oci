    ...
    def __init__(__self__,
        ...
        test_target_database = oci.data_safe.TargetDatabase("testTargetDatabase",
            ...
            database_details=oci.data_safe.TargetDatabaseDatabaseDetailsArgs(
                ...
                listener_port=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
            ...
            connection_option=oci.data_safe.TargetDatabaseConnectionOptionArgs(
                ...
                datasafe_private_endpoint_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
            ...
            tls_config=oci.data_safe.TargetDatabaseTlsConfigArgs(
                ...
                certificate_store_type=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                key_store_content=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                store_password=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                trust_store_content=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
            ))
        ```
