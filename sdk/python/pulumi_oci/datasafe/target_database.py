...
class TargetDatabaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment in which to create the Data Safe target database.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) The description of the target database in Data Safe.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the target database in Data Safe. The name is modifiable and does not need to be unique.
...
class _TargetDatabaseState:
    def __init__(__self__, *,
                 associated_resource_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] associated_resource_ids: The OCIDs of associated resources like database, Data Safe private endpoint etc.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment in which to create the Data Safe target database.
        :param pulumi.Input['TargetDatabaseConnectionOptionArgs'] connection_option: (Updatable) Types of connection supported by Data Safe.
        :param pulumi.Input['TargetDatabaseCredentialsArgs'] credentials: (Updatable) The database credentials required for Data Safe to connect to the database.
        :param pulumi.Input['TargetDatabaseDatabaseDetailsArgs'] database_details: (Updatable) Details of the database for the registration in Data Safe.
        ...
        :param pulumi.Input[builtins.str] state: The current state of the target database in Data Safe.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the database was registered in Data Safe and created as a target database in Data Safe.
        :param pulumi.Input[builtins.str] time_updated: The date and time of the target database update in Data Safe.
        :param pulumi.Input['TargetDatabaseTlsConfigArgs'] tls_config: (Updatable) The details required to establish a TLS enabled connection.
        """
    ...
    def associated_resource_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def associated_resource_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
