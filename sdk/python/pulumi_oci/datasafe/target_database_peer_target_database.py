...
class TargetDatabasePeerTargetDatabaseInitArgs:
    def __init__(__self__, *,
                 ...
                 target_database_id: pulumi.Input[builtins.str],
                 dataguard_association_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] target_database_id: The OCID of the Data Safe target database.
        :param pulumi.Input[builtins.str] dataguard_association_id: The OCID of the Data Guard Association resource in which the database being registered is considered as peer database to the primary database.
        :param pulumi.Input[builtins.str] description: (Updatable) The description of the peer target database in Data Safe.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the peer target database in Data Safe. The name is modifiable and does not need to be unique.
    ...
    def target_database_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def target_database_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "target_database_id", value)

    @property
    @pulumi.getter(name="dataguardAssociationId")
    def dataguard_association_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def dataguard_association_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _TargetDatabasePeerTargetDatabaseState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 key: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) The description of the peer target database in Data Safe.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the peer target database in Data Safe. The name is modifiable and does not need to be unique.
        :param pulumi.Input[builtins.int] key: The secondary key assigned for the peer target database in Data Safe.
        :param pulumi.Input[builtins.str] lifecycle_details: Details about the current state of the peer target database in Data Safe.
        :param pulumi.Input[builtins.str] role: Role of the database associated to the peer target database.
        :param pulumi.Input[builtins.str] state: The current state of the peer target database in Data Safe.
        :param pulumi.Input[builtins.str] target_database_id: The OCID of the Data Safe target database.
        :param pulumi.Input[builtins.str] time_created: The date and time of the peer target database registration in Data Safe.
        :param pulumi.Input['TargetDatabasePeerTargetDatabaseTlsConfigArgs'] tls_config: (Updatable) The details required to establish a TLS enabled connection.
        """
    ...
    @property
    @pulumi.getter
    def key(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @key.setter
    def key(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    @property
    @pulumi.getter(name="targetDatabaseId")
    def target_database_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The OCID of the Data Safe target database.
        """
        return pulumi.get(self, "target_database_id")
    ...
    @target_database_id.setter
    def target_database_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_database_id", value)
...
class TargetDatabasePeerTargetDatabase(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="dataguardAssociationId")
    def dataguard_association_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the Data Guard Association resource in which the database being registered is considered as peer database to the primary database.
        """
        return pulumi.get(self, "dataguard_association_id")
    ...
    @property
    @pulumi.getter
    def key(self) -> pulumi.Output[builtins.int]:
        """
        The secondary key assigned for the peer target database in Data Safe.
        """
        return pulumi.get(self, "key")
    ...
    @property
    @pulumi.getter(name="targetDatabaseId")
    def target_database_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the Data Safe target database.
        """
        return pulumi.get(self, "target_database_id")
