...
class UnsetSecurityAssessmentBaselineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] target_ids: The list of database target OCIDs for which the user intends to unset the baseline.
...
class UnsetSecurityAssessmentBaseline(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            security_assessment_id: Optional[pulumi.Input[builtins.str]] = None,
            target_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'UnsetSecurityAssessmentBaseline':
        """
