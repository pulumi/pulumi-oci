...
class UnsetUserAssessmentBaselineManagementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: The compartment OCID where the assessment resides.
...
class UnsetUserAssessmentBaselineManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            compartment_id: Optional[pulumi.Input[builtins.str]] = None,
            user_assessment_id: Optional[pulumi.Input[builtins.str]] = None) -> 'UnsetUserAssessmentBaselineManagement':
        """
