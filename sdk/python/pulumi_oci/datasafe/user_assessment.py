...
class UserAssessmentArgs:
    def __init__(__self__, *,
                 ...
                 is_assessment_scheduled: Optional[pulumi.Input[builtins.bool]] = None,
                 schedule: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a UserAssessment resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment that contains the user assessment.
        :param pulumi.Input[builtins.str] target_id: The OCID of the target database on which the user assessment is to be run.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) The description of the user assessment.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the user assessment.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] is_assessment_scheduled: (Updatable) Indicates whether the assessment is scheduled to run.
        :param pulumi.Input[builtins.str] schedule: (Updatable) To schedule the assessment for saving periodically, specify the schedule in this attribute. Create or schedule one assessment per compartment. If not defined, the assessment runs immediately. Format - <version-string>;<version-specific-schedule>
    ...
    def is_assessment_scheduled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_assessment_scheduled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _UserAssessmentState:
    def __init__(__self__, *,
                 ...
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 ignored_assessment_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ignored_targets: Optional[pulumi.Input[Sequence[pulumi.Input['UserAssessmentIgnoredTargetArgs']]]] = None,
                 is_assessment_scheduled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_baseline: Optional[pulumi.Input[builtins.bool]] = None,
                 is_deviated_from_baseline: Optional[pulumi.Input[builtins.bool]] = None,
                 last_compared_baseline_id: Optional[pulumi.Input[builtins.str]] = None,
                 lifecycle_details: Optional[pulumi.Input[builtins.str]] = None,
                 schedule: Optional[pulumi.Input[builtins.str]] = None,
                 schedule_assessment_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 time_last_assessed: Optional[pulumi.Input[builtins.str]] = None,
                 time_updated: Optional[pulumi.Input[builtins.str]] = None,
                 triggered_by: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the user assessment.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm)  Example: `{"Department": "Finance"}`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ignored_assessment_ids: List containing maps as values. Example: `{"Operations": [ {"CostCenter": "42"} ] }`
        ...
        :param pulumi.Input[builtins.bool] is_assessment_scheduled: (Updatable) Indicates whether the assessment is scheduled to run.
        :param pulumi.Input[builtins.bool] is_baseline: Indicates if the user assessment is set as a baseline. This is applicable only to saved user assessments.
        :param pulumi.Input[builtins.bool] is_deviated_from_baseline: Indicates if the user assessment deviates from the baseline.
        :param pulumi.Input[builtins.str] last_compared_baseline_id: The OCID of the last user assessment baseline against which the latest assessment was compared.
        :param pulumi.Input[builtins.str] lifecycle_details: Details about the current state of the user assessment.
        :param pulumi.Input[builtins.str] schedule: (Updatable) To schedule the assessment for saving periodically, specify the schedule in this attribute. Create or schedule one assessment per compartment. If not defined, the assessment runs immediately. Format - <version-string>;<version-specific-schedule>
               
               Allowed version strings - "v1" v1's version specific schedule -<ss> <mm> <hh> <day-of-week> <day-of-month> Each of the above fields potentially introduce constraints. A workrequest is created only when clock time satisfies all the constraints. Constraints introduced: 1. seconds = <ss> (So, the allowed range for <ss> is [0, 59]) 2. minutes = <mm> (So, the allowed range for <mm> is [0, 59]) 3. hours = <hh> (So, the allowed range for <hh> is [0, 23]) <day-of-week> can be either '*' (without quotes or a number between 1(Monday) and 7(Sunday)) 4. No constraint introduced when it is '*'. When not, day of week must equal the given value <day-of-month> can be either '*' (without quotes or a number between 1 and 28) 5. No constraint introduced when it is '*'. When not, day of month must equal the given value
        :param pulumi.Input[builtins.str] schedule_assessment_id: The OCID of the user assessment that is responsible for creating this scheduled save assessment.
        :param pulumi.Input[builtins.str] state: The current state of the user assessment.
        :param pulumi.Input[builtins.str] statistics: Map that contains maps of values. Example: `{"Operations": {"CostCenter": "42"}}`
        ...
        :param pulumi.Input[builtins.str] target_id: The OCID of the target database on which the user assessment is to be run.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] target_ids: Array of database target OCIDs.
        :param pulumi.Input[builtins.str] time_created: The date and time the user assessment was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] time_last_assessed: The date and time the user assessment was last executed, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] time_updated: The date and time the user assessment was last updated, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] triggered_by: Indicates whether the user assessment was created by the system or the user.
        :param pulumi.Input[builtins.str] type: The type of the user assessment. The possible types are:
        """
    ...
    def ignored_assessment_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def ignored_assessment_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def is_baseline(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_baseline.setter
    def is_baseline(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_baseline", value)

    @property
    @pulumi.getter(name="isDeviatedFromBaseline")
    def is_deviated_from_baseline(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_deviated_from_baseline(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_deviated_from_baseline", value)

    @property
    @pulumi.getter(name="lastComparedBaselineId")
    def last_compared_baseline_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_compared_baseline_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def schedule_assessment_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def schedule_assessment_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_last_assessed(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_last_assessed(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def triggered_by(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @triggered_by.setter
    def triggered_by(self, value: Optional[pulumi.Input[builtins.str]]):
...
class UserAssessment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            triggered_by: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'UserAssessment':
        """
    ...
    @property
    @pulumi.getter(name="ignoredAssessmentIds")
    def ignored_assessment_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List containing maps as values. Example: `{"Operations": [ {"CostCenter": "42"} ] }`
        """
        return pulumi.get(self, "ignored_assessment_ids")
    ...
    @property
    @pulumi.getter(name="isAssessmentScheduled")
    def is_assessment_scheduled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Indicates whether the assessment is scheduled to run.
        """
        return pulumi.get(self, "is_assessment_scheduled")
    ...
    @property
    @pulumi.getter(name="isBaseline")
    def is_baseline(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates if the user assessment is set as a baseline. This is applicable only to saved user assessments.
        """
        return pulumi.get(self, "is_baseline")
    ...
    @property
    @pulumi.getter(name="isDeviatedFromBaseline")
    def is_deviated_from_baseline(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates if the user assessment deviates from the baseline.
        """
        return pulumi.get(self, "is_deviated_from_baseline")
    ...
    @property
    @pulumi.getter(name="lastComparedBaselineId")
    def last_compared_baseline_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the last user assessment baseline against which the latest assessment was compared.
        """
        return pulumi.get(self, "last_compared_baseline_id")
    ...
    @property
    @pulumi.getter(name="scheduleAssessmentId")
    def schedule_assessment_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the user assessment that is responsible for creating this scheduled save assessment.
        """
        return pulumi.get(self, "schedule_assessment_id")
    ...
    @property
    @pulumi.getter
    def statistics(self) -> pulumi.Output[builtins.str]:
        """
        Map that contains maps of values. Example: `{"Operations": {"CostCenter": "42"}}`
        """
        return pulumi.get(self, "statistics")
    ...
    @property
    @pulumi.getter(name="timeLastAssessed")
    def time_last_assessed(self) -> pulumi.Output[builtins.str]:
        """
        The date and time the user assessment was last executed, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        """
        return pulumi.get(self, "time_last_assessed")
    ...
    @property
    @pulumi.getter(name="triggeredBy")
    def triggered_by(self) -> pulumi.Output[builtins.str]:
        """
        Indicates whether the user assessment was created by the system or the user.
        """
        return pulumi.get(self, "triggered_by")
