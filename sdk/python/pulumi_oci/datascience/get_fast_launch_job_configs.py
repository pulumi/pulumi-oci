...
def get_fast_launch_job_configs(compartment_id: Optional[builtins.str] = None,
...
def get_fast_launch_job_configs_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
