...
class GetFastLaunchJobConfigsResult:
    ...
    def fast_launch_job_configs(self) -> Optional[Sequence['outputs.GetFastLaunchJobConfigsFastLaunchJobConfigResult']]:
...
def get_fast_launch_job_configs(compartment_id: Optional[str] = None,
                                filters: Optional[Sequence[pulumi.InputType['GetFastLaunchJobConfigsFilterArgs']]] = None,
...
def get_fast_launch_job_configs_output(compartment_id: Optional[pulumi.Input[str]] = None,
                                       filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetFastLaunchJobConfigsFilterArgs']]]]] = None,
