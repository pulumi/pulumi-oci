...
def get_job_run(job_run_id: Optional[builtins.str] = None,
    ...
    :param builtins.str job_run_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the job run.
    """
    __args__ = dict()
...
def get_job_run_output(job_run_id: Optional[pulumi.Input[builtins.str]] = None,
