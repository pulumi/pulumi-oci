...
def get_jobs(compartment_id: Optional[str] = None,
    ...
    test_jobs = oci.DataScience.get_jobs(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
...
def get_jobs_output(compartment_id: Optional[pulumi.Input[str]] = None,
                    ...
                    filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetJobsFilterArgs']]]]] = None,
