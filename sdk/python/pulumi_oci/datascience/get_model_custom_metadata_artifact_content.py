...
def get_model_custom_metadata_artifact_content(metadatum_key_name: Optional[builtins.str] = None,
...
def get_model_custom_metadata_artifact_content_output(metadatum_key_name: Optional[pulumi.Input[builtins.str]] = None,
