...
class GetModelDefinedMetadataArtifactContentResult:
    ...
    def metadatum_key_name(self) -> builtins.str:
...
def get_model_defined_metadata_artifact_content(metadatum_key_name: Optional[builtins.str] = None,
    ...
    :param builtins.str metadatum_key_name: The name of the model metadatum in the metadata.
    :param builtins.str model_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the model.
    :param builtins.str range: Optional byte range to fetch, as described in [RFC 7233](https://tools.ietf.org/html/rfc7232#section-2.1), section 2.1. Note that only a single range of bytes is supported.
    """
    __args__ = dict()
...
def get_model_defined_metadata_artifact_content_output(metadatum_key_name: Optional[pulumi.Input[builtins.str]] = None,
