...
def get_model_deployment_shapes(compartment_id: Optional[builtins.str] = None,
...
def get_model_deployment_shapes_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
