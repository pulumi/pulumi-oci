...
def get_model_deployments(compartment_id: Optional[builtins.str] = None,
...
def get_model_deployments_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
