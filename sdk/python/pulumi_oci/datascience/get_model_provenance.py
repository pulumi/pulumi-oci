...
class GetModelProvenanceResult:
    ...
    def git_commit(self) -> _builtins.str:
        """
    ...
    def training_id(self) -> _builtins.str:
        """
    ...
    def training_script(self) -> _builtins.str:
        """
...
def get_model_provenance(model_id: Optional[_builtins.str] = None,
