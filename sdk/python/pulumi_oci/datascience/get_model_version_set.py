...
def get_model_version_set(model_version_set_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str model_version_set_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the model version set.
    """
    __args__ = dict()
...
def get_model_version_set_output(model_version_set_id: Optional[pulumi.Input[_builtins.str]] = None,
