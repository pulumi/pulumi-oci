...
def get_model_version_sets(category: Optional[builtins.str] = None,
...
def get_model_version_sets_output(category: Optional[pulumi.Input[Optional[builtins.str]]] = None,
