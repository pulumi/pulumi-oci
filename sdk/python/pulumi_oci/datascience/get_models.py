...
def get_models(compartment_id: Optional[str] = None,
    ...
    test_models = oci.DataScience.get_models(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        ...
        model_version_set_name=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
