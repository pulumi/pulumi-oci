...
class GetNotebookSessionResult:
    ...
    def notebook_session_id(self) -> builtins.str:
...
def get_notebook_session(notebook_session_id: Optional[builtins.str] = None,
    ...
    :param builtins.str notebook_session_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the notebook session.
    """
    __args__ = dict()
...
def get_notebook_session_output(notebook_session_id: Optional[pulumi.Input[builtins.str]] = None,
