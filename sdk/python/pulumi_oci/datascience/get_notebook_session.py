...
class GetNotebookSessionResult:
    ...
    def notebook_session_id(self) -> _builtins.str:
    ...
    def notebook_session_url(self) -> _builtins.str:
        """
...
def get_notebook_session(notebook_session_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str notebook_session_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the notebook session.
    """
    __args__ = dict()
