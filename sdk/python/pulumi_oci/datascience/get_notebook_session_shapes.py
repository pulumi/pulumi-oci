...
def get_notebook_session_shapes(compartment_id: Optional[builtins.str] = None,
...
def get_notebook_session_shapes_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
