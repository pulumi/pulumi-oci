...
def get_notebook_sessions(compartment_id: Optional[builtins.str] = None,
...
def get_notebook_sessions_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
