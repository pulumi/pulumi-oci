...
def get_pipeline_run(pipeline_run_id: Optional[str] = None,
    ...
    return AwaitableGetPipelineRunResult(
        ...
        configuration_details=__ret__.configuration_details,
        configuration_override_details=__ret__.configuration_override_details,
        created_by=__ret__.created_by,
        defined_tags=__ret__.defined_tags,
        delete_related_job_runs=__ret__.delete_related_job_runs,
        display_name=__ret__.display_name,
        freeform_tags=__ret__.freeform_tags,
        id=__ret__.id,
        lifecycle_details=__ret__.lifecycle_details,
        log_configuration_override_details=__ret__.log_configuration_override_details,
        log_details=__ret__.log_details,
        pipeline_id=__ret__.pipeline_id,
        pipeline_run_id=__ret__.pipeline_run_id,
        project_id=__ret__.project_id,
        state=__ret__.state,
        step_override_details=__ret__.step_override_details,
        step_runs=__ret__.step_runs,
