...
class GetPipelineRunResult:
    ...
    def configuration_details(self) -> Optional[Sequence['outputs.GetPipelineRunConfigurationDetailResult']]:
        return pulumi.get(self, "configuration_details")

    @property
    @pulumi.getter(name="configurationOverrideDetails")
    def configuration_override_details(self) -> Optional[Sequence['outputs.GetPipelineRunConfigurationOverrideDetailResult']]:
    ...
    def log_configuration_override_details(self) -> Optional[Sequence['outputs.GetPipelineRunLogConfigurationOverrideDetailResult']]:
        return pulumi.get(self, "log_configuration_override_details")

    @property
    @pulumi.getter(name="logDetails")
    def log_details(self) -> Optional[Sequence['outputs.GetPipelineRunLogDetailResult']]:
    ...
    def step_override_details(self) -> Optional[Sequence['outputs.GetPipelineRunStepOverrideDetailResult']]:
        return pulumi.get(self, "step_override_details")

    @property
    @pulumi.getter(name="stepRuns")
    def step_runs(self) -> Optional[Sequence['outputs.GetPipelineRunStepRunResult']]:
