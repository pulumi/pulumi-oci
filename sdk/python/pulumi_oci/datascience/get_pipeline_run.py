...
def get_pipeline_run(pipeline_run_id: Optional[builtins.str] = None,
    ...
    :param builtins.str pipeline_run_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the pipeline run.
    """
    __args__ = dict()
...
def get_pipeline_run_output(pipeline_run_id: Optional[pulumi.Input[builtins.str]] = None,
