...
class GetPrivateEndpointResult:
    ...
    def data_science_private_endpoint_id(self) -> builtins.str:
...
def get_private_endpoint(data_science_private_endpoint_id: Optional[builtins.str] = None,
    ...
    :param builtins.str data_science_private_endpoint_id: The unique ID for a Data Science private endpoint.
    """
    __args__ = dict()
...
def get_private_endpoint_output(data_science_private_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
