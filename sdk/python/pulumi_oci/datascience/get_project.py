...
def get_project(project_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str project_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the project.
    """
    __args__ = dict()
...
def get_project_output(project_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:DataScience/getProject:getProject', __args__, opts=opts, typ=GetProjectResult)
