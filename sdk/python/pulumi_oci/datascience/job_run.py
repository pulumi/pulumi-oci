...
class JobRun(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a JobRun resource with the given unique name, props, and options.
    ...
    @property
    @pulumi.getter(name="jobConfigurationOverrideDetails")
    def job_configuration_override_details(self) -> pulumi.Output[Optional['outputs.JobRunJobConfigurationOverrideDetails']]:
        return pulumi.get(self, "job_configuration_override_details")
    ...
    @property
    @pulumi.getter(name="jobInfrastructureConfigurationDetails")
    def job_infrastructure_configuration_details(self) -> pulumi.Output[Optional[Sequence['outputs.JobRunJobInfrastructureConfigurationDetail']]]:
        return pulumi.get(self, "job_infrastructure_configuration_details")

    @property
    @pulumi.getter(name="jobLogConfigurationOverrideDetails")
    def job_log_configuration_override_details(self) -> pulumi.Output[Optional['outputs.JobRunJobLogConfigurationOverrideDetails']]:
        return pulumi.get(self, "job_log_configuration_override_details")

    @property
    @pulumi.getter(name="jobStorageMountConfigurationDetailsLists")
    def job_storage_mount_configuration_details_lists(self) -> pulumi.Output[Optional[Sequence['outputs.JobRunJobStorageMountConfigurationDetailsList']]]:
        return pulumi.get(self, "job_storage_mount_configuration_details_lists")
    ...
    @property
    @pulumi.getter(name="logDetails")
    def log_details(self) -> pulumi.Output[Optional[Sequence['outputs.JobRunLogDetail']]]:
        return pulumi.get(self, "log_details")
