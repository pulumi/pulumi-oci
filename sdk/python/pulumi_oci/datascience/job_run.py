...
class JobRun(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_job_run = oci.data_science.JobRun("testJobRun",
            ...
            job_configuration_override_details=oci.data.science.JobRunJobConfigurationOverrideDetailsArgs(
            ...
            job_log_configuration_override_details=oci.data.science.JobRunJobLogConfigurationOverrideDetailsArgs(
