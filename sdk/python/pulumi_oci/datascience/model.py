...
class ModelArgs:
    def __init__(__self__, *,
                 artifact_content_length: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] model_artifact: The model artifact to upload. It is a ZIP archive of the files necessary to run the model. This can be done in a separate step or using cli/sdk. The Model will remain in "Creating" state until its artifact is uploaded.
        ...
        :param pulumi.Input[_builtins.str] input_schema: Input schema file content in String format
        :param pulumi.Input[_builtins.str] model_version_set_id: The OCID of the model version set that the model is associated to.
    ...
    def artifact_content_length(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def artifact_content_length(self, value: pulumi.Input[_builtins.str]):
    ...
    def model_artifact(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def model_artifact(self, value: pulumi.Input[_builtins.str]):
...
class _ModelState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[_builtins.str] input_schema: Input schema file content in String format
        :param pulumi.Input[_builtins.bool] is_model_by_reference: Identifier to indicate whether a model artifact resides in the Service Tenancy or Customer Tenancy.
        :param pulumi.Input[_builtins.str] lifecycle_details: Details about the lifecycle state of the model.
        :param pulumi.Input[_builtins.str] model_artifact: The model artifact to upload. It is a ZIP archive of the files necessary to run the model. This can be done in a separate step or using cli/sdk. The Model will remain in "Creating" state until its artifact is uploaded.
        :param pulumi.Input[_builtins.str] model_version_set_id: The OCID of the model version set that the model is associated to.
        :param pulumi.Input[_builtins.str] model_version_set_name: The name of the model version set that the model is associated to.
        :param pulumi.Input[_builtins.str] output_schema: Output schema file content in String format
...
class Model(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="artifactContentDisposition")
    def artifact_content_disposition(self) -> pulumi.Output[_builtins.str]:
        """
        This allows to specify a filename during upload. This file name is used to dispose of the file contents while downloading the file. Example: `attachment; filename=model-artifact.zip`
        """
        return pulumi.get(self, "artifact_content_disposition")
    ...
    @_builtins.property
    @pulumi.getter(name="artifactContentLength")
    def artifact_content_length(self) -> pulumi.Output[_builtins.str]:
        """
        The content length of the model_artifact.
    ...
    @_builtins.property
    @pulumi.getter(name="emptyModel")
    def empty_model(self) -> pulumi.Output[_builtins.bool]:
        return pulumi.get(self, "empty_model")
    ...
    @_builtins.property
    @pulumi.getter(name="isModelByReference")
    def is_model_by_reference(self) -> pulumi.Output[_builtins.bool]:
        """
        Identifier to indicate whether a model artifact resides in the Service Tenancy or Customer Tenancy.
        """
        return pulumi.get(self, "is_model_by_reference")
    ...
    @_builtins.property
    @pulumi.getter(name="modelArtifact")
    def model_artifact(self) -> pulumi.Output[_builtins.str]:
        """
        The model artifact to upload. It is a ZIP archive of the files necessary to run the model. This can be done in a separate step or using cli/sdk. The Model will remain in "Creating" state until its artifact is uploaded.
        """
        return pulumi.get(self, "model_artifact")
    ...
    @_builtins.property
    @pulumi.getter(name="modelVersionSetId")
    def model_version_set_id(self) -> pulumi.Output[_builtins.str]:
        """
        The OCID of the model version set that the model is associated to.
        """
        return pulumi.get(self, "model_version_set_id")
    ...
    @_builtins.property
    @pulumi.getter(name="modelVersionSetName")
    def model_version_set_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the model version set that the model is associated to.
        """
        return pulumi.get(self, "model_version_set_name")
    ...
    @_builtins.property
    @pulumi.getter(name="outputSchema")
    def output_schema(self) -> pulumi.Output[_builtins.str]:
        """
        Output schema file content in String format
        """
        return pulumi.get(self, "output_schema")
