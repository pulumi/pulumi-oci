...
class ModelArgs:
    def __init__(__self__, *,
                 artifact_content_length: pulumi.Input[builtins.str],
                 compartment_id: pulumi.Input[builtins.str],
                 model_artifact: pulumi.Input[builtins.str],
                 ...
                 model_version_set_id: Optional[pulumi.Input[builtins.str]] = None,
                 model_version_set_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] artifact_content_length: The content length of the model_artifact.
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to create the model in.
        :param pulumi.Input[builtins.str] model_artifact: The model artifact to upload. It is a ZIP archive of the files necessary to run the model. This can be done in a separate step or using cli/sdk. The Model will remain in "Creating" state until its artifact is uploaded.
        ...
        :param pulumi.Input[builtins.str] artifact_content_disposition: This allows to specify a filename during upload. This file name is used to dispose of the file contents while downloading the file. Example: `attachment; filename=model-artifact.zip`
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly display name for the resource. It does not have to be unique and can be modified. Avoid entering confidential information. Example: `My Model`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] input_schema: Input schema file content in String format
        :param pulumi.Input[builtins.str] model_version_set_id: The OCID of the model version set that the model is associated to.
        :param pulumi.Input[builtins.str] model_version_set_name: The name of the model version set that the model is associated to.
        :param pulumi.Input[builtins.str] output_schema: Output schema file content in String format
        ...
        :param pulumi.Input[builtins.str] version_label: (Updatable) The version label can add an additional description of the lifecycle state of the model or the application using/training the model.
        """
    ...
    def artifact_content_length(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def artifact_content_length(self, value: pulumi.Input[builtins.str]):
    ...
    def model_artifact(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def model_artifact(self, value: pulumi.Input[builtins.str]):
    ...
    def model_version_set_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def model_version_set_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "model_version_set_id", value)

    @property
    @pulumi.getter(name="modelVersionSetName")
    def model_version_set_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def model_version_set_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ModelState:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 empty_model: Optional[pulumi.Input[builtins.bool]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 input_schema: Optional[pulumi.Input[builtins.str]] = None,
                 is_model_by_reference: Optional[pulumi.Input[builtins.bool]] = None,
                 lifecycle_details: Optional[pulumi.Input[builtins.str]] = None,
                 model_artifact: Optional[pulumi.Input[builtins.str]] = None,
                 model_version_set_id: Optional[pulumi.Input[builtins.str]] = None,
                 model_version_set_name: Optional[pulumi.Input[builtins.str]] = None,
                 output_schema: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['ModelBackupSettingArgs'] backup_setting: (Updatable) Back up setting details of the model.
        :param pulumi.Input[builtins.str] category: Category of model metadata which should be null for defined metadata.For custom metadata is should be one of the following values "Performance,Training Profile,Training and Validation Datasets,Training Environment,Reports,Readme,other".
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to create the model in.
        :param pulumi.Input[builtins.str] created_by: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the user who created the model.
        :param pulumi.Input[Sequence[pulumi.Input['ModelCustomMetadataListArgs']]] custom_metadata_lists: (Updatable) An array of custom metadata details for the model.
        :param pulumi.Input[Sequence[pulumi.Input['ModelDefinedMetadataListArgs']]] defined_metadata_lists: (Updatable) An array of defined metadata details for the model.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] description: (Updatable) A short description of the model.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] input_schema: Input schema file content in String format
        :param pulumi.Input[builtins.bool] is_model_by_reference: Identifier to indicate whether a model artifact resides in the Service Tenancy or Customer Tenancy.
        :param pulumi.Input[builtins.str] lifecycle_details: Details about the lifecycle state of the model.
        :param pulumi.Input[builtins.str] model_artifact: The model artifact to upload. It is a ZIP archive of the files necessary to run the model. This can be done in a separate step or using cli/sdk. The Model will remain in "Creating" state until its artifact is uploaded.
        :param pulumi.Input[builtins.str] model_version_set_id: The OCID of the model version set that the model is associated to.
        :param pulumi.Input[builtins.str] model_version_set_name: The name of the model version set that the model is associated to.
        :param pulumi.Input[builtins.str] output_schema: Output schema file content in String format
    ...
    def empty_model(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "empty_model")

    @empty_model.setter
    def empty_model(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def is_model_by_reference(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_model_by_reference(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter(name="modelArtifact")
    def model_artifact(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The model artifact to upload. It is a ZIP archive of the files necessary to run the model. This can be done in a separate step or using cli/sdk. The Model will remain in "Creating" state until its artifact is uploaded.
        """
        return pulumi.get(self, "model_artifact")
    ...
    @model_artifact.setter
    def model_artifact(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "model_artifact", value)
...
class Model(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            version_label: Optional[pulumi.Input[builtins.str]] = None) -> 'Model':
        """
    ...
    @property
    @pulumi.getter(name="artifactContentDisposition")
    def artifact_content_disposition(self) -> pulumi.Output[builtins.str]:
        """
        This allows to specify a filename during upload. This file name is used to dispose of the file contents while downloading the file. Example: `attachment; filename=model-artifact.zip`
        """
        return pulumi.get(self, "artifact_content_disposition")
    ...
    @property
    @pulumi.getter(name="artifactContentLength")
    def artifact_content_length(self) -> pulumi.Output[builtins.str]:
        """
        The content length of the model_artifact.
    ...
    @property
    @pulumi.getter(name="emptyModel")
    def empty_model(self) -> pulumi.Output[builtins.bool]:
        return pulumi.get(self, "empty_model")
    ...
    @property
    @pulumi.getter(name="isModelByReference")
    def is_model_by_reference(self) -> pulumi.Output[builtins.bool]:
        """
        Identifier to indicate whether a model artifact resides in the Service Tenancy or Customer Tenancy.
        """
        return pulumi.get(self, "is_model_by_reference")
    ...
    @property
    @pulumi.getter(name="modelArtifact")
    def model_artifact(self) -> pulumi.Output[builtins.str]:
        """
        The model artifact to upload. It is a ZIP archive of the files necessary to run the model. This can be done in a separate step or using cli/sdk. The Model will remain in "Creating" state until its artifact is uploaded.
        """
        return pulumi.get(self, "model_artifact")
    ...
    @property
    @pulumi.getter(name="modelVersionSetId")
    def model_version_set_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the model version set that the model is associated to.
        """
        return pulumi.get(self, "model_version_set_id")
    ...
    @property
    @pulumi.getter(name="modelVersionSetName")
    def model_version_set_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the model version set that the model is associated to.
        """
        return pulumi.get(self, "model_version_set_name")
    ...
    @property
    @pulumi.getter(name="outputSchema")
    def output_schema(self) -> pulumi.Output[builtins.str]:
        """
        Output schema file content in String format
        """
        return pulumi.get(self, "output_schema")
