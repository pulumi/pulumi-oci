...
class ModelArtifactImportArgs:
    def __init__(__self__, *,
                 artifact_source_type: pulumi.Input[builtins.str],
                 destination_bucket: pulumi.Input[builtins.str],
                 destination_object_name: pulumi.Input[builtins.str],
...
class _ModelArtifactImportState:
    def __init__(__self__, *,
                 artifact_source_type: Optional[pulumi.Input[builtins.str]] = None,
                 destination_bucket: Optional[pulumi.Input[builtins.str]] = None,
                 destination_object_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="artifactSourceType")
    def artifact_source_type(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "artifact_source_type")

    @artifact_source_type.setter
    def artifact_source_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "artifact_source_type", value)

    @property
    @pulumi.getter(name="destinationBucket")
    def destination_bucket(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "destination_bucket")

    @destination_bucket.setter
    def destination_bucket(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "destination_bucket", value)

    @property
    @pulumi.getter(name="destinationObjectName")
    def destination_object_name(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "destination_object_name")

    @destination_object_name.setter
    def destination_object_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "destination_object_name", value)
...
class ModelArtifactImport(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            destination_region: Optional[pulumi.Input[builtins.str]] = None,
            model_id: Optional[pulumi.Input[builtins.str]] = None,
            namespace: Optional[pulumi.Input[builtins.str]] = None) -> 'ModelArtifactImport':
        """
    ...
    @property
    @pulumi.getter(name="artifactSourceType")
    def artifact_source_type(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "artifact_source_type")

    @property
    @pulumi.getter(name="destinationBucket")
    def destination_bucket(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "destination_bucket")

    @property
    @pulumi.getter(name="destinationObjectName")
    def destination_object_name(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "destination_object_name")
