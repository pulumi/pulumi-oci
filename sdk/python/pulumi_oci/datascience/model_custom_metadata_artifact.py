...
__all__ = ['ModelCustomMetadataArtifactArgs', 'ModelCustomMetadataArtifact']

@pulumi.input_type
class ModelCustomMetadataArtifactArgs:
    def __init__(__self__, *,
                 content_length: pulumi.Input[builtins.str],
                 metadatum_key_name: pulumi.Input[builtins.str],
                 model_custom_metadatum_artifact: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] metadatum_key_name: The name of the model metadatum in the metadata.
        :param pulumi.Input[builtins.str] model_custom_metadatum_artifact: (Updatable) The model custom metadata artifact to upload.
    ...
    def metadatum_key_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def metadatum_key_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "metadatum_key_name", value)

    @property
    @pulumi.getter(name="modelCustomMetadatumArtifact")
    def model_custom_metadatum_artifact(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The model custom metadata artifact to upload.
        """
        return pulumi.get(self, "model_custom_metadatum_artifact")

    @model_custom_metadatum_artifact.setter
    def model_custom_metadatum_artifact(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "model_custom_metadatum_artifact", value)
...
@pulumi.input_type
class _ModelCustomMetadataArtifactState:
    def __init__(__self__, *,
                 content_disposition: Optional[pulumi.Input[builtins.str]] = None,
                 content_length: Optional[pulumi.Input[builtins.str]] = None,
                 metadatum_key_name: Optional[pulumi.Input[builtins.str]] = None,
                 model_custom_metadatum_artifact: Optional[pulumi.Input[builtins.str]] = None,
        ...
        if metadatum_key_name is not None:
            pulumi.set(__self__, "metadatum_key_name", metadatum_key_name)
        if model_custom_metadatum_artifact is not None:
            pulumi.set(__self__, "model_custom_metadatum_artifact", model_custom_metadatum_artifact)
    ...
    @property
    @pulumi.getter(name="metadatumKeyName")
    def metadatum_key_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of the model metadatum in the metadata.
        """
        return pulumi.get(self, "metadatum_key_name")
    ...
    @metadatum_key_name.setter
    def metadatum_key_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "metadatum_key_name", value)

    @property
    @pulumi.getter(name="modelCustomMetadatumArtifact")
    def model_custom_metadatum_artifact(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The model custom metadata artifact to upload.
        """
        return pulumi.get(self, "model_custom_metadatum_artifact")
    ...
    @model_custom_metadatum_artifact.setter
    def model_custom_metadatum_artifact(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "model_custom_metadatum_artifact", value)
...
class ModelCustomMetadataArtifact(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ModelCustomMetadataArtifactArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ModelCustomMetadataArtifactArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ModelCustomMetadataArtifactArgs.__new__(ModelCustomMetadataArtifactArgs)
            ...
            if model_custom_metadatum_artifact is None and not opts.urn:
                raise TypeError("Missing required property 'model_custom_metadatum_artifact'")
            __props__.__dict__["model_custom_metadatum_artifact"] = model_custom_metadatum_artifact
            if model_id is None and not opts.urn:
                raise TypeError("Missing required property 'model_id'")
            __props__.__dict__["model_id"] = model_id
        super(ModelCustomMetadataArtifact, __self__).__init__(
            'oci:DataScience/modelCustomMetadataArtifact:ModelCustomMetadataArtifact',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            metadatum_key_name: Optional[pulumi.Input[builtins.str]] = None,
            model_custom_metadatum_artifact: Optional[pulumi.Input[builtins.str]] = None,
            model_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ModelCustomMetadataArtifact':
        """
        ...
        __props__ = _ModelCustomMetadataArtifactState.__new__(_ModelCustomMetadataArtifactState)
        ...
        __props__.__dict__["model_custom_metadatum_artifact"] = model_custom_metadatum_artifact
        __props__.__dict__["model_id"] = model_id
        return ModelCustomMetadataArtifact(resource_name, opts=opts, __props__=__props__)
    ...
    @property
    @pulumi.getter(name="metadatumKeyName")
    def metadatum_key_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the model metadatum in the metadata.
        """
        return pulumi.get(self, "metadatum_key_name")
    ...
    @property
    @pulumi.getter(name="modelCustomMetadatumArtifact")
    def model_custom_metadatum_artifact(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The model custom metadata artifact to upload.
        """
        return pulumi.get(self, "model_custom_metadatum_artifact")
