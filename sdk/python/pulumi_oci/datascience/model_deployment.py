        ...
        test_model_deployment = oci.data_science.ModelDeployment("testModelDeployment",
            ...
            model_deployment_configuration_details=oci.data_science.ModelDeploymentModelDeploymentConfigurationDetailsArgs(
                ...
                model_configuration_details=oci.data_science.ModelDeploymentModelDeploymentConfigurationDetailsModelConfigurationDetailsArgs(
                    ...
                    bandwidth_mbps=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                    scaling_policy=oci.data_science.ModelDeploymentModelDeploymentConfigurationDetailsModelConfigurationDetailsScalingPolicyArgs(
                        instance_count=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                ...
                environment_configuration_details=oci.data_science.ModelDeploymentModelDeploymentConfigurationDetailsEnvironmentConfigurationDetailsArgs(
                    environment_configuration_type=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                    cmds=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                    entrypoints=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                    environment_variables=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                    health_check_port=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                    ...
                    server_port=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                ),
            ),
