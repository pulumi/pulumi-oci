...
class _ModelGroupArtifactState:
    def __init__(__self__, *,
                 ...
                 model_group_artifact: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="modelGroupArtifact")
    def model_group_artifact(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The model group artifact to upload.
        """
        return pulumi.get(self, "model_group_artifact")
    ...
    @model_group_artifact.setter
    def model_group_artifact(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "model_group_artifact", value)
...
class ModelGroupArtifact(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            content_length: pulumi.Input[Optional[_builtins.str]] = None,
            model_group_artifact: pulumi.Input[Optional[_builtins.str]] = None,
            model_group_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'ModelGroupArtifact':
        """
