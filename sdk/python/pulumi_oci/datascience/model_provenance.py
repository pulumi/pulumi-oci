...
class ModelProvenanceArgs:
    def __init__(__self__, *,
                 ...
                 git_commit: Optional[pulumi.Input[builtins.str]] = None,
                 repository_url: Optional[pulumi.Input[builtins.str]] = None,
                 script_dir: Optional[pulumi.Input[builtins.str]] = None,
                 training_id: Optional[pulumi.Input[builtins.str]] = None,
                 training_script: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ModelProvenance resource.
        :param pulumi.Input[builtins.str] model_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the model.
        :param pulumi.Input[builtins.str] git_branch: (Updatable) For model reproducibility purposes. Branch of the git repository associated with model training.
        :param pulumi.Input[builtins.str] git_commit: (Updatable) For model reproducibility purposes. Commit ID of the git repository associated with model training.
        :param pulumi.Input[builtins.str] repository_url: (Updatable) For model reproducibility purposes. URL of the git repository associated with model training.
        :param pulumi.Input[builtins.str] script_dir: (Updatable) For model reproducibility purposes. Path to model artifacts.
        :param pulumi.Input[builtins.str] training_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a training session(Job or NotebookSession) in which the model was trained. It is used for model reproducibility purposes.
        :param pulumi.Input[builtins.str] training_script: (Updatable) For model reproducibility purposes. Path to the python script or notebook in which the model was trained." 
    ...
    def git_commit(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @git_commit.setter
    def git_commit(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def script_dir(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @script_dir.setter
    def script_dir(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "script_dir", value)

    @property
    @pulumi.getter(name="trainingId")
    def training_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @training_id.setter
    def training_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "training_id", value)

    @property
    @pulumi.getter(name="trainingScript")
    def training_script(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def training_script(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ModelProvenance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            script_dir: Optional[pulumi.Input[builtins.str]] = None,
            training_id: Optional[pulumi.Input[builtins.str]] = None,
            training_script: Optional[pulumi.Input[builtins.str]] = None) -> 'ModelProvenance':
        """
    ...
    @property
    @pulumi.getter(name="gitBranch")
    def git_branch(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) For model reproducibility purposes. Branch of the git repository associated with model training.
        """
        return pulumi.get(self, "git_branch")
    ...
    @property
    @pulumi.getter(name="gitCommit")
    def git_commit(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) For model reproducibility purposes. Commit ID of the git repository associated with model training.
        """
        return pulumi.get(self, "git_commit")
    ...
    @property
    @pulumi.getter(name="scriptDir")
    def script_dir(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) For model reproducibility purposes. Path to model artifacts.
        """
        return pulumi.get(self, "script_dir")
    ...
    @property
    @pulumi.getter(name="trainingId")
    def training_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a training session(Job or NotebookSession) in which the model was trained. It is used for model reproducibility purposes.
        """
        return pulumi.get(self, "training_id")
    ...
    @property
    @pulumi.getter(name="trainingScript")
    def training_script(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) For model reproducibility purposes. Path to the python script or notebook in which the model was trained." 
