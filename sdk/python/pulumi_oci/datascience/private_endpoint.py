...
class PrivateEndpointArgs:
    def __init__(__self__, *,
                 ...
                 data_science_resource_type: pulumi.Input[_builtins.str],
        ...
        :param pulumi.Input[_builtins.str] display_name: (Updatable) A user friendly name. It doesn't have to be unique. Avoid entering confidential information.
    ...
    def data_science_resource_type(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def data_science_resource_type(self, value: pulumi.Input[_builtins.str]):
...
class _PrivateEndpointState:
    def __init__(__self__, *,
                 ...
                 data_science_resource_type: Optional[pulumi.Input[_builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 description: Optional[pulumi.Input[_builtins.str]] = None,
                 display_name: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] description: (Updatable) A user friendly description. Avoid entering confidential information.
        :param pulumi.Input[_builtins.str] display_name: (Updatable) A user friendly name. It doesn't have to be unique. Avoid entering confidential information.
        :param pulumi.Input[_builtins.str] fqdn: Accesing the Data Science resource using FQDN.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[_builtins.str] lifecycle_details: Details of the state of Data Science private endpoint.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] nsg_ids: (Updatable) An array of network security group OCIDs.
        ...
        :param pulumi.Input[_builtins.str] time_created: The date and time that the Data Science private endpoint was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2018-04-03T21:10:29.600Z`
        :param pulumi.Input[_builtins.str] time_updated: The date and time that the Data Science private endpoint was updated expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2018-04-03T21:10:29.600Z`
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dataScienceResourceType")
    def data_science_resource_type(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Data Science resource type.
        """
        return pulumi.get(self, "data_science_resource_type")
    ...
    @data_science_resource_type.setter
    def data_science_resource_type(self, value: Optional[pulumi.Input[_builtins.str]]):
        pulumi.set(self, "data_science_resource_type", value)
...
class PrivateEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[_builtins.str]] = None,
            time_updated: Optional[pulumi.Input[_builtins.str]] = None) -> 'PrivateEndpoint':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="dataScienceResourceType")
    def data_science_resource_type(self) -> pulumi.Output[_builtins.str]:
        """
        Data Science resource type.
        """
        return pulumi.get(self, "data_science_resource_type")
