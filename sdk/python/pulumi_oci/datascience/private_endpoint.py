...
class PrivateEndpointArgs:
    def __init__(__self__, *,
                 ...
                 data_science_resource_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment where you want to create the private endpoint.
        :param pulumi.Input[builtins.str] data_science_resource_type: Data Science resource type.
        :param pulumi.Input[builtins.str] subnet_id: The OCID of the subnet. 
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user friendly name. It doesn't have to be unique. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] nsg_ids: (Updatable) An array of network security group OCIDs.
        :param pulumi.Input[builtins.str] sub_domain: Subdomain for a private endpoint FQDN.
        """
    ...
    def data_science_resource_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def data_science_resource_type(self, value: pulumi.Input[builtins.str]):
...
class _PrivateEndpointState:
    def __init__(__self__, *,
                 ...
                 data_science_resource_type: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment where you want to create the private endpoint.
        :param pulumi.Input[builtins.str] created_by: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the user that created the private endpoint.
        :param pulumi.Input[builtins.str] data_science_resource_type: Data Science resource type.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] description: (Updatable) A user friendly description. Avoid entering confidential information.
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user friendly name. It doesn't have to be unique. Avoid entering confidential information.
        :param pulumi.Input[builtins.str] fqdn: Accesing the Data Science resource using FQDN.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] lifecycle_details: Details of the state of Data Science private endpoint.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] nsg_ids: (Updatable) An array of network security group OCIDs.
        :param pulumi.Input[builtins.str] state: State of the Data Science private endpoint.
        :param pulumi.Input[builtins.str] sub_domain: Subdomain for a private endpoint FQDN.
        :param pulumi.Input[builtins.str] subnet_id: The OCID of the subnet. 
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time that the Data Science private endpoint was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2018-04-03T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_updated: The date and time that the Data Science private endpoint was updated expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2018-04-03T21:10:29.600Z`
        """
    ...
    @property
    @pulumi.getter(name="dataScienceResourceType")
    def data_science_resource_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Data Science resource type.
        """
        return pulumi.get(self, "data_science_resource_type")
    ...
    @data_science_resource_type.setter
    def data_science_resource_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "data_science_resource_type", value)
...
class PrivateEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'PrivateEndpoint':
        """
    ...
    @property
    @pulumi.getter(name="dataScienceResourceType")
    def data_science_resource_type(self) -> pulumi.Output[builtins.str]:
        """
        Data Science resource type.
        """
        return pulumi.get(self, "data_science_resource_type")
