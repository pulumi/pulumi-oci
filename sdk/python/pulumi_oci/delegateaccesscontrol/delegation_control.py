...
class DelegationControlArgs:
    def __init__(__self__, *,
                 ...
                 delegation_subscription_ids: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 display_name: pulumi.Input[builtins.str],
                 notification_message_format: pulumi.Input[builtins.str],
                 ...
                 is_auto_approve_during_maintenance: Optional[pulumi.Input[builtins.bool]] = None,
                 num_approvals_required: Optional[pulumi.Input[builtins.int]] = None,
                 pre_approved_service_provider_action_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 vault_id: Optional[pulumi.Input[builtins.str]] = None,
                 vault_key_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a DelegationControl resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment that contains this Delegation Control.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] delegation_subscription_ids: (Updatable) List of Delegation Subscription OCID that are allowed for this Delegation Control. The allowed subscriptions will determine the available Service Provider Actions. Only support operators for the allowed subscriptions are allowed to create Delegated Resource Access Request.
        :param pulumi.Input[builtins.str] display_name: (Updatable) Name of the Delegation Control. The name does not need to be unique.
        :param pulumi.Input[builtins.str] notification_message_format: (Updatable) The format of the Oracle Cloud Infrastructure Notification messages for this Delegation Control.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resource_ids: (Updatable) The OCID of the selected resources that this Delegation Control is applicable to.
        :param pulumi.Input[builtins.str] resource_type: Resource type for which the Delegation Control is applicable to.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Description of the Delegation Control.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] is_auto_approve_during_maintenance: (Updatable) Set to true to allow all Delegated Resource Access Request to be approved automatically during maintenance.
        :param pulumi.Input[builtins.int] num_approvals_required: (Updatable) number of approvals required.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] pre_approved_service_provider_action_names: (Updatable) List of pre-approved Service Provider Action names. The list of pre-defined Service Provider Actions can be obtained from the ListServiceProviderActions API. Delegated Resource Access Requests associated with a resource governed by this Delegation Control will be automatically approved if the Delegated Resource Access Request only contain Service Provider Actions in the pre-approved list.
        :param pulumi.Input[builtins.str] vault_id: The OCID of the Oracle Cloud Infrastructure Vault that will store the secrets containing the SSH keys to access the resource governed by this Delegation Control by Delegate Access Control Service. This property is required when resourceType is CLOUDVMCLUSTER. Delegate Access Control Service will generate the SSH keys and store them as secrets in the Oracle Cloud Infrastructure Vault.
        :param pulumi.Input[builtins.str] vault_key_id: The OCID of the Master Encryption Key in the Oracle Cloud Infrastructure Vault specified by vaultId. This key will be used to encrypt the SSH keys to access the resource governed by this Delegation Control by Delegate Access Control Service. This property is required when resourceType is CLOUDVMCLUSTER.
    ...
    def delegation_subscription_ids(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def delegation_subscription_ids(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def notification_message_format(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def notification_message_format(self, value: pulumi.Input[builtins.str]):
    ...
    def is_auto_approve_during_maintenance(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_auto_approve_during_maintenance(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_auto_approve_during_maintenance", value)

    @property
    @pulumi.getter(name="numApprovalsRequired")
    def num_approvals_required(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def num_approvals_required(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "num_approvals_required", value)

    @property
    @pulumi.getter(name="preApprovedServiceProviderActionNames")
    def pre_approved_service_provider_action_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        (Updatable) List of pre-approved Service Provider Action names. The list of pre-defined Service Provider Actions can be obtained from the ListServiceProviderActions API. Delegated Resource Access Requests associated with a resource governed by this Delegation Control will be automatically approved if the Delegated Resource Access Request only contain Service Provider Actions in the pre-approved list.
        """
    ...
    def pre_approved_service_provider_action_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def vault_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @vault_key_id.setter
    def vault_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DelegationControlState:
    def __init__(__self__, *,
                 ...
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 delegation_subscription_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_auto_approve_during_maintenance: Optional[pulumi.Input[builtins.bool]] = None,
                 lifecycle_state_details: Optional[pulumi.Input[builtins.str]] = None,
                 notification_message_format: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] resource_ids: (Updatable) The OCID of the selected resources that this Delegation Control is applicable to.
        :param pulumi.Input[builtins.str] resource_type: Resource type for which the Delegation Control is applicable to.
        :param pulumi.Input[builtins.str] state: The current lifecycle state of the Delegation Control.
        ...
        :param pulumi.Input[builtins.str] time_created: Time when the Delegation Control was created expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format, e.g. '2020-05-22T21:10:29.600Z'
        :param pulumi.Input[builtins.str] time_deleted: Time when the Delegation Control was deleted expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339)timestamp format, e.g. '2020-05-22T21:10:29.600Z'. Note a deleted Delegation Control still stays in the system, so that you can still audit Service Provider Actions associated with Delegated Resource Access Requests raised on target resources governed by the deleted Delegation Control.
        :param pulumi.Input[builtins.str] time_updated: Time when the Delegation Control was last modified expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format, e.g. '2020-05-22T21:10:29.600Z'
        :param pulumi.Input[builtins.str] vault_id: The OCID of the Oracle Cloud Infrastructure Vault that will store the secrets containing the SSH keys to access the resource governed by this Delegation Control by Delegate Access Control Service. This property is required when resourceType is CLOUDVMCLUSTER. Delegate Access Control Service will generate the SSH keys and store them as secrets in the Oracle Cloud Infrastructure Vault.
        :param pulumi.Input[builtins.str] vault_key_id: The OCID of the Master Encryption Key in the Oracle Cloud Infrastructure Vault specified by vaultId. This key will be used to encrypt the SSH keys to access the resource governed by this Delegation Control by Delegate Access Control Service. This property is required when resourceType is CLOUDVMCLUSTER.
    ...
    @property
    @pulumi.getter(name="delegationSubscriptionIds")
    def delegation_subscription_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        (Updatable) List of Delegation Subscription OCID that are allowed for this Delegation Control. The allowed subscriptions will determine the available Service Provider Actions. Only support operators for the allowed subscriptions are allowed to create Delegated Resource Access Request.
        """
        return pulumi.get(self, "delegation_subscription_ids")
    ...
    @delegation_subscription_ids.setter
    def delegation_subscription_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "delegation_subscription_ids", value)
    ...
    @property
    @pulumi.getter(name="notificationMessageFormat")
    def notification_message_format(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The format of the Oracle Cloud Infrastructure Notification messages for this Delegation Control.
        """
        return pulumi.get(self, "notification_message_format")
    ...
    @notification_message_format.setter
    def notification_message_format(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "notification_message_format", value)
...
class DelegationControl(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            vault_id: Optional[pulumi.Input[builtins.str]] = None,
            vault_key_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DelegationControl':
        """
    ...
    @property
    @pulumi.getter(name="delegationSubscriptionIds")
    def delegation_subscription_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) List of Delegation Subscription OCID that are allowed for this Delegation Control. The allowed subscriptions will determine the available Service Provider Actions. Only support operators for the allowed subscriptions are allowed to create Delegated Resource Access Request.
        """
        return pulumi.get(self, "delegation_subscription_ids")
    ...
    @property
    @pulumi.getter(name="isAutoApproveDuringMaintenance")
    def is_auto_approve_during_maintenance(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Set to true to allow all Delegated Resource Access Request to be approved automatically during maintenance.
        """
        return pulumi.get(self, "is_auto_approve_during_maintenance")
    ...
    @property
    @pulumi.getter(name="notificationMessageFormat")
    def notification_message_format(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The format of the Oracle Cloud Infrastructure Notification messages for this Delegation Control.
        """
        return pulumi.get(self, "notification_message_format")
    ...
    @property
    @pulumi.getter(name="numApprovalsRequired")
    def num_approvals_required(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) number of approvals required.
        """
        return pulumi.get(self, "num_approvals_required")
    ...
    @property
    @pulumi.getter(name="preApprovedServiceProviderActionNames")
    def pre_approved_service_provider_action_names(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) List of pre-approved Service Provider Action names. The list of pre-defined Service Provider Actions can be obtained from the ListServiceProviderActions API. Delegated Resource Access Requests associated with a resource governed by this Delegation Control will be automatically approved if the Delegated Resource Access Request only contain Service Provider Actions in the pre-approved list.
        """
        return pulumi.get(self, "pre_approved_service_provider_action_names")
    ...
    @property
    @pulumi.getter(name="vaultKeyId")
    def vault_key_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the Master Encryption Key in the Oracle Cloud Infrastructure Vault specified by vaultId. This key will be used to encrypt the SSH keys to access the resource governed by this Delegation Control by Delegate Access Control Service. This property is required when resourceType is CLOUDVMCLUSTER.
