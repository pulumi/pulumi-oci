...
class GetDelegatedResourceAccessRequestResult:
    ...
    def delegated_resource_access_request_id(self) -> builtins.str:
...
def get_delegated_resource_access_request(delegated_resource_access_request_id: Optional[builtins.str] = None,
    ...
    :param builtins.str delegated_resource_access_request_id: Unique Delegated Resource Access Request identifier
    """
    __args__ = dict()
...
def get_delegated_resource_access_request_output(delegated_resource_access_request_id: Optional[pulumi.Input[builtins.str]] = None,
