...
class GetDelegatedResourceAccessRequestAuditLogReportResult:
    ...
    def is_process_tree_enabled(self) -> Optional[_builtins.bool]:
    ...
    def time_report_generated(self) -> _builtins.str:
        """
...
def get_delegated_resource_access_request_audit_log_report(delegated_resource_access_request_id: Optional[_builtins.str] = None,
                                                           is_process_tree_enabled: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool is_process_tree_enabled: Set to true to enable process tree computation in audit report
    """
    __args__ = dict()
