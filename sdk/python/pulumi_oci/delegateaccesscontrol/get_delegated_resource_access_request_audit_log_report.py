...
class GetDelegatedResourceAccessRequestAuditLogReportResult:
    ...
    def is_process_tree_enabled(self) -> Optional[builtins.bool]:
    ...
    def time_report_generated(self) -> builtins.str:
        """
...
def get_delegated_resource_access_request_audit_log_report(delegated_resource_access_request_id: Optional[builtins.str] = None,
                                                           is_process_tree_enabled: Optional[builtins.bool] = None,
    ...
    :param builtins.bool is_process_tree_enabled: Set to true to enable process tree computation in audit report
    """
    __args__ = dict()
...
def get_delegated_resource_access_request_audit_log_report_output(delegated_resource_access_request_id: Optional[pulumi.Input[builtins.str]] = None,
                                                                  is_process_tree_enabled: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
