...
class GetDelegatedResourceAccessRequestsResult:
    ...
    def delegation_control_id(self) -> Optional[builtins.str]:
        """
    ...
    def request_status(self) -> Optional[builtins.str]:
        """
...
def get_delegated_resource_access_requests(compartment_id: Optional[builtins.str] = None,
                                           delegation_control_id: Optional[builtins.str] = None,
                                           ...
                                           request_status: Optional[builtins.str] = None,
    ...
    :param builtins.str delegation_control_id: unique Delegation Control identifier
    :param builtins.str request_status: A filter to return only Delegated Resource Access Requests whose status matches the given Delegated Resource Access Request status.
    :param builtins.str resource_id: A filter to return only Delegated Resource Access Requests for the given resource identifier.
    :param builtins.str state: A filter to return only Delegated Resource Access Requests whose lifecycleState matches the given Delegated Resource Access Request lifecycleState.
    :param builtins.str time_end: Query end time in UTC in ISO 8601 format(inclusive). Example 2019-10-30T00:00:00Z (yyyy-MM-ddThh:mm:ssZ). timeIntervalStart and timeIntervalEnd parameters cannot be used together.
    :param builtins.str time_start: Query start time in UTC in ISO 8601 format(inclusive). Example 2019-10-30T00:00:00Z (yyyy-MM-ddThh:mm:ssZ). timeIntervalStart and timeIntervalEnd parameters cannot be used together.
    """
    __args__ = dict()
...
def get_delegated_resource_access_requests_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                                  delegation_control_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                  ...
                                                  request_status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
