...
class GetDelegatedResourceAccessRequestsResult:
    ...
    def delegation_control_id(self) -> Optional[_builtins.str]:
        """
    ...
    def request_status(self) -> Optional[_builtins.str]:
        """
...
def get_delegated_resource_access_requests(compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str time_end: Query end time in UTC in ISO 8601 format(inclusive). Example 2019-10-30T00:00:00Z (yyyy-MM-ddThh:mm:ssZ). timeIntervalStart and timeIntervalEnd parameters cannot be used together.
    :param _builtins.str time_start: Query start time in UTC in ISO 8601 format(inclusive). Example 2019-10-30T00:00:00Z (yyyy-MM-ddThh:mm:ssZ). timeIntervalStart and timeIntervalEnd parameters cannot be used together.
    """
    __args__ = dict()
...
def get_delegated_resource_access_requests_output(compartment_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                  delegation_control_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                  ...
                                                  request_status: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
