...
def get_delegation_control_resources(delegation_control_id: Optional[builtins.str] = None,
...
def get_delegation_control_resources_output(delegation_control_id: Optional[pulumi.Input[builtins.str]] = None,
