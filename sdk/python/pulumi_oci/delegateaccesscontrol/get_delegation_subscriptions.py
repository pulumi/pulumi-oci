...
def get_delegation_subscriptions(compartment_id: Optional[_builtins.str] = None,
                                 display_name: Optional[_builtins.str] = None,
                                 filters: Optional[Sequence[Union['GetDelegationSubscriptionsFilterArgs', 'GetDelegationSubscriptionsFilterArgsDict', 'outputs.GetDelegationSubscriptionsFilterResult']]] = None,
...
def get_delegation_subscriptions_output(compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                                        display_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        filters: pulumi.Input[Optional[Optional[Sequence[Union['GetDelegationSubscriptionsFilterArgs', 'GetDelegationSubscriptionsFilterArgsDict', 'outputs.GetDelegationSubscriptionsFilterResult']]]]] = None,
                                        state: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDelegationSubscriptionsResult]:
    """
    This data source provides the list of Delegation Subscriptions in Oracle Cloud Infrastructure Delegate Access Control service.
