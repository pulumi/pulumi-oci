...
def get_delegation_subscriptions(compartment_id: Optional[builtins.str] = None,
...
def get_delegation_subscriptions_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
