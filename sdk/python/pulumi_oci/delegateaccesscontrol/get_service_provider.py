...
def get_service_provider(service_provider_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str service_provider_id: unique Service Provider identifier
    """
    __args__ = dict()
...
def get_service_provider_output(service_provider_id: Optional[pulumi.Input[_builtins.str]] = None,
