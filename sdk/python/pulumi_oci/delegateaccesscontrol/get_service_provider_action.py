...
class GetServiceProviderActionResult:
    ...
    def service_provider_action_id(self) -> _builtins.str:
...
def get_service_provider_action(service_provider_action_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str service_provider_action_id: Unique Oracle supplied identifier associated with the Service Provider Action.
    """
    __args__ = dict()
