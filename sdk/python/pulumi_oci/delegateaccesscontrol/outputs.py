...
class GetDelegatedResourceAccessRequestApprovalInfoResult(dict):
    def __init__(__self__, *,
                 ...
                 approver_additional_message: builtins.str,
                 approver_comment: builtins.str,
                 approver_id: builtins.str,
                 time_approved_for_access: builtins.str):
        """
        :param builtins.str approval_action: Indicated whether the request is approved or rejected.
        :param builtins.str approval_type: approval type, initial or extension
        :param builtins.str approver_additional_message: Additional message specified by the approver of the request.
        :param builtins.str approver_comment: Comment specified by the approver of the request.
        :param builtins.str approver_id: User ID of the approver.
        :param builtins.str time_approved_for_access: Access start time that is actually approved by the customer in [RFC 3339](https://tools.ietf.org/html/rfc3339)timestamp format, e.g. '2020-05-22T21:10:29.600Z'.
        """
    ...
    def approver_additional_message(self) -> builtins.str:
        """
...
class GetDelegatedResourceAccessRequestHistoriesDelegatedResourceAccessRequestHistoryCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 request_status: builtins.str,
                 state: builtins.str,
                 timestamp: builtins.str,
                 user_id: builtins.str):
        """
        :param builtins.str comment: Comment about the status change.
        :param builtins.str request_status: The current status of the Delegated Resource Access Request.
        :param builtins.str state: The current lifecycle state of the Delegated Resource Access Request.
        :param builtins.str timestamp: Time when the respective action happened in [RFC 3339](https://tools.ietf.org/html/rfc3339)timestamp format, e.g. '2020-05-22T21:10:29.600Z'.
        :param builtins.str user_id: ID of user who modified the Delegated Resource Access Request. For operator, this field is "Operator".
        """
...
class GetDelegatedResourceAccessRequestsDelegatedResourceAccessRequestSummaryCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 database_name_lists: Sequence[builtins.str],
                 defined_tags: Mapping[str, builtins.str],
                 delegation_control_id: builtins.str,
                 delegation_subscription_ids: Sequence[builtins.str],
                 description: builtins.str,
                 display_name: builtins.str,
                 duration_in_hours: builtins.int,
                 extend_duration_in_hours: builtins.int,
                 freeform_tags: Mapping[str, builtins.str],
                 id: builtins.str,
                 is_auto_approved: builtins.bool,
                 is_pending_more_info: builtins.bool,
                 lifecycle_state_details: builtins.str,
                 num_extension_approvals: builtins.int,
                 num_initial_approvals: builtins.int,
                 provided_service_types: Sequence[builtins.str],
                 reason_for_request: builtins.str,
                 request_status: builtins.str,
                 requested_action_names: Sequence[builtins.str],
                 requester_type: builtins.str,
                 ...
                 time_access_requested: builtins.str,
        ...
        :param Sequence[builtins.str] audit_types: Specifies the type of auditing to be enabled. There are two levels of auditing: command-level and keystroke-level.  By default, both command-level and keystroke-level auditing are enabled, i.e. commands and key strokes issued by the support operator are logged.
        :param builtins.str closure_comment: The comment entered by the support operator while closing the request.
        ...
        :param Sequence[builtins.str] database_name_lists: List of Database unique names for which access is requested. This parameter is required for DLGT_MGMT_SYS_MAINT_ACCESS cage when database access in needed.
        ...
        :param Sequence[builtins.str] delegation_subscription_ids: List of Delegation Subscription OCID that are associated with this Delegated Resource Access Request based on the service types being requested.
        :param builtins.str description: Detailed description of this Delegated Resource Access Request.
        :param builtins.str display_name: Display name. This is generated by the system automatically.
        :param builtins.int duration_in_hours: Duration in hours for which access is sought on the target resource.
        :param builtins.int extend_duration_in_hours: Duration in hours for which extension access is sought on the target resource.
        ...
        :param builtins.str id: The OCID of the Delegated Resource Access Request.
        :param builtins.bool is_auto_approved: Set to true if the request is approved automatically based on preApprovedServiceProviderActionNames or isAutoApproveDuringMaintenance in the associated Delegation Control.
        :param builtins.bool is_pending_more_info: Indicates if the delegated resource access request is waiting on more information from the operator
        :param builtins.str lifecycle_state_details: Description of the current lifecycle state in more detail.
        :param builtins.int num_extension_approvals: Number of extension approvals that have been obtained so far.
        :param builtins.int num_initial_approvals: Number of initial approvals that have been obtained so far.
        :param Sequence[builtins.str] provided_service_types: List of Service Provider Service Types being provided by the support operator user.
        :param builtins.str reason_for_request: A short description explaining why this Delegated Resource Access Request is needed by the support operator.
        ...
        :param Sequence[builtins.str] requested_action_names: List of Service Provider Action names for which approval is sought by the support operator user. The list of pre-defined Service Provider Actions can be obtained from the ListServiceProviderActions API.
        :param builtins.str requester_type: Requester type
        ...
        :param builtins.str resource_name: The name of the target resource associated with the Delegated Resource Access Request. The support operator raises a Delegated Resource Access Request to get approval to  access the target resource.
        :param builtins.str resource_type: Resource type for which the associated Delegation Control is applicable to.
        :param builtins.str severity: Priority assigned to the Delegated Resource Access Request by the support operator
        ...
        :param Sequence[builtins.str] ticket_numbers: A list of ticket numbers related to this Delegated Resource Access Request, e.g. Service Request (SR) number and JIRA ticket number.
        :param builtins.str time_access_requested: Requested access start time in UTC.
        :param builtins.str time_created: Time when the Delegated Resource Access Request was created in [RFC 3339](https://tools.ietf.org/html/rfc3339)timestamp format, e.g. '2020-05-22T21:10:29.600Z'.
        :param builtins.str time_updated: Time when the Delegated Resource Access Request was last modified in [RFC 3339](https://tools.ietf.org/html/rfc3339)timestamp format, e.g. '2020-05-22T21:10:29.600Z'.
        """
    ...
    def database_name_lists(self) -> Sequence[builtins.str]:
        """
    ...
    def delegation_control_id(self) -> builtins.str:
        """
    ...
    def delegation_subscription_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def duration_in_hours(self) -> builtins.int:
        """
    ...
    def extend_duration_in_hours(self) -> builtins.int:
        """
    ...
    def is_pending_more_info(self) -> builtins.bool:
        """
    ...
    def num_extension_approvals(self) -> builtins.int:
        """
    ...
    def num_initial_approvals(self) -> builtins.int:
        """
    ...
    def provided_service_types(self) -> Sequence[builtins.str]:
        """
    ...
    def reason_for_request(self) -> builtins.str:
        """
    ...
    def requested_action_names(self) -> Sequence[builtins.str]:
        """
    ...
    def requester_type(self) -> builtins.str:
        """
        Requester type
        """
    ...
    def time_access_requested(self) -> builtins.str:
        """
...
class GetDelegationControlResourcesDelegationControlResourceCollectionItemResult(dict):
    def __init__(__self__, *,
                 id: builtins.str,
                 resource_status: builtins.str):
        """
        :param builtins.str id: OCID of the resource.
        :param builtins.str resource_status: The current status of the resource in Delegation Control.
        """
        pulumi.set(__self__, "id", id)
...
class GetDelegationControlsDelegationControlSummaryCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 lifecycle_state_details: builtins.str,
                 notification_message_format: builtins.str,
                 notification_topic_id: builtins.str,
                 num_approvals_required: builtins.int,
                 pre_approved_service_provider_action_names: Sequence[builtins.str],
                 ...
                 vault_key_id: builtins.str):
        """
        :param builtins.str compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param Sequence[builtins.str] delegation_subscription_ids: List of Delegation Subscription OCID that are allowed for this Delegation Control. The allowed subscriptions will determine the available Service Provider Actions. Only support operators for the allowed subscriptions are allowed to create Delegated Resource Access Request.
        :param builtins.str description: Description of the Delegation Control.
        :param builtins.str display_name: A filter to return Delegation Control resources that match the given display name.
        :param Mapping[str, builtins.str] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param builtins.str id: The OCID of the Delegation Control.
        :param builtins.bool is_auto_approve_during_maintenance: Set to true to allow all Delegated Resource Access Request to be approved automatically during maintenance.
        :param builtins.str lifecycle_state_details: Description of the current lifecycle state in more detail.
        :param builtins.str notification_message_format: The format of the Oracle Cloud Infrastructure Notification messages for this Delegation Control.
        :param builtins.str notification_topic_id: The OCID of the Oracle Cloud Infrastructure Notification topic to publish messages related to this Delegation Control.
        :param builtins.int num_approvals_required: number of approvals required.
        :param Sequence[builtins.str] pre_approved_service_provider_action_names: List of pre-approved Service Provider Action names. The list of pre-defined Service Provider Actions can be obtained from the ListServiceProviderActions API. Delegated Resource Access Requests associated with a resource governed by this Delegation Control will be automatically approved if the Delegated Resource Access Request only contain Service Provider Actions in the pre-approved list.
        :param Sequence[builtins.str] resource_ids: The OCID of the selected resources that this Delegation Control is applicable to.
        ...
        :param Mapping[str, builtins.str] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: Time when the Delegation Control was created expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format, e.g. '2020-05-22T21:10:29.600Z'
        :param builtins.str time_deleted: Time when the Delegation Control was deleted expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339)timestamp format, e.g. '2020-05-22T21:10:29.600Z'. Note a deleted Delegation Control still stays in the system, so that you can still audit Service Provider Actions associated with Delegated Resource Access Requests raised on target resources governed by the deleted Delegation Control.
        :param builtins.str time_updated: Time when the Delegation Control was last modified expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format, e.g. '2020-05-22T21:10:29.600Z'
        :param builtins.str vault_id: The OCID of the Oracle Cloud Infrastructure Vault that will store the secrets containing the SSH keys to access the resource governed by this Delegation Control by Delegate Access Control Service. This property is required when resourceType is CLOUDVMCLUSTER. Delegate Access Control Service will generate the SSH keys and store them as secrets in the Oracle Cloud Infrastructure Vault.
        :param builtins.str vault_key_id: The OCID of the Master Encryption Key in the Oracle Cloud Infrastructure Vault specified by vaultId. This key will be used to encrypt the SSH keys to access the resource governed by this Delegation Control by Delegate Access Control Service. This property is required when resourceType is CLOUDVMCLUSTER.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
        pulumi.set(__self__, "delegation_subscription_ids", delegation_subscription_ids)
    ...
    def notification_message_format(self) -> builtins.str:
        """
    ...
    def num_approvals_required(self) -> builtins.int:
        """
    ...
    def pre_approved_service_provider_action_names(self) -> Sequence[builtins.str]:
        """
        List of pre-approved Service Provider Action names. The list of pre-defined Service Provider Actions can be obtained from the ListServiceProviderActions API. Delegated Resource Access Requests associated with a resource governed by this Delegation Control will be automatically approved if the Delegated Resource Access Request only contain Service Provider Actions in the pre-approved list.
        """
    ...
    def vault_key_id(self) -> builtins.str:
        """
...
class GetDelegationSubscriptionsDelegationSubscriptionSummaryCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 state: builtins.str,
                 subscribed_service_type: builtins.str,
                 system_tags: Mapping[str, builtins.str],
                 time_created: builtins.str,
                 time_updated: builtins.str):
        """
        :param builtins.str compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param builtins.str description: Description of the Delegation Subscription.
        :param builtins.str display_name: A filter to return Delegation Subscription resources that match the given display name.
        :param Mapping[str, builtins.str] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param builtins.str id: Unique identifier for the Delegation Subscription.
        :param builtins.str lifecycle_state_details: Description of the current lifecycle state in more detail.
        :param builtins.str service_provider_id: Unique identifier of the Service Provider.
        :param builtins.str state: A filter to return only Delegation Subscription resources whose lifecycleState matches the given Delegation Subscription lifecycle state.
        :param builtins.str subscribed_service_type: Subscribed Service Provider Service Type.
        :param Mapping[str, builtins.str] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: Time when the Service Provider was created expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format, e.g. '2020-05-22T21:10:29.600Z'
        :param builtins.str time_updated: Time when the Service Provider was last modified expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format, e.g. '2020-05-22T21:10:29.600Z'
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
        pulumi.set(__self__, "description", description)
...
class GetServiceProviderActionsServiceProviderActionSummaryCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 resource_type: builtins.str,
                 service_provider_service_types: Sequence[builtins.str],
                 state: builtins.str):
        """
        :param builtins.str component: Name of the infrastructure layer associated with the Service Provider Action.
        :param builtins.str customer_display_name: Display Name of the Service Provider Action.
        :param builtins.str description: Description of the Service Provider Action in terms of associated risk profile, and characteristics of the operating system commands made available to the support operator under this Service Provider Action.
        :param builtins.str id: Unique Oracle assigned identifier for the Service Provider Action.
        :param builtins.str name: A filter to return only resources that match the entire name given.
        ...
        :param builtins.str resource_type: A filter to return only resources that match the given resource type.
        :param Sequence[builtins.str] service_provider_service_types: List of Service Provider Service Types that this Service Provider Action is applicable to.
        :param builtins.str state: A filter to return only resources whose lifecycleState matches the given Service Provider Action lifecycleState.
        """
...
class GetServiceProvidersFilterResult(dict):
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: A filter to return Service Provider resources that match the given name.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
...
class GetServiceProvidersServiceProviderSummaryCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 lifecycle_state_details: builtins.str,
                 name: builtins.str,
                 service_provider_type: builtins.str,
                 service_types: Sequence[builtins.str],
                 state: builtins.str,
        ...
        :param Mapping[str, builtins.str] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param builtins.str id: Unique identifier for the Service Provider.
        :param builtins.str lifecycle_state_details: Description of the current lifecycle state in more detail.
        :param builtins.str name: A filter to return Service Provider resources that match the given name.
        :param builtins.str service_provider_type: A filter to return only Service Provider resources whose provider type matches the given provider type.
        :param Sequence[builtins.str] service_types: Types of services offered by this provider.
        :param builtins.str state: A filter to return only Service Provider resources whose lifecycleState matches the given Service Provider lifecycle state.
        :param Sequence[builtins.str] supported_resource_types: Resource types for which this provider will provide service. Default to all if not specified.
        :param Mapping[str, builtins.str] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: Time when the Service Provider was created expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format, e.g. '2020-05-22T21:10:29.600Z'
        :param builtins.str time_updated: Time when the Service Provider was last modified expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format, e.g. '2020-05-22T21:10:29.600Z'
        """
