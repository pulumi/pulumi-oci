...
def get_occ_demand_signal(occ_demand_signal_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str occ_demand_signal_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the OccDemandSignal.
    """
    __args__ = dict()
...
def get_occ_demand_signal_output(occ_demand_signal_id: Optional[pulumi.Input[_builtins.str]] = None,
