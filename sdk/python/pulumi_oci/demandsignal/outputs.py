...
class OccDemandSignalOccDemandSignal(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str resource_type: The name of the resource for the data.
        :param builtins.str units: The units of the data.
...
class OccDemandSignalOccDemandSignalValue(dict):
    ...
    def __init__(__self__, *,
                 time_expected: builtins.str,
                 value: builtins.float,
                 comments: Optional[builtins.str] = None):
        """
        :param builtins.str time_expected: The date of the Demand Signal Value.
        :param builtins.float value: The Demand Signal Value.
        :param builtins.str comments: Space provided for users to make comments regarding the value.
        """
    ...
    def time_expected(self) -> builtins.str:
        """
...
class GetOccDemandSignalPatchOperationResult(dict):
    def __init__(__self__, *,
                 ...
                 value: Mapping[str, builtins.str]):
        """
        :param Mapping[str, builtins.str] value: The Demand Signal Value.
        """
        pulumi.set(__self__, "from_", from_)
        pulumi.set(__self__, "operation", operation)
        pulumi.set(__self__, "position", position)
...
class GetOccDemandSignalsOccDemandSignalCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 occ_demand_signal_id: builtins.str,
        ...
        :param builtins.bool is_active: Indicator of whether to share the data with Oracle.
        :param builtins.str lifecycle_details: A message that describes the current state of the OccDemandSignal in more detail. For example, can be used to provide actionable information for a resource in the Failed state.
        ...
        :param builtins.str time_created: The date and time the OccDemandSignal was created, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param builtins.str time_updated: The date and time the OccDemandSignal was updated, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        """
    ...
    def occ_demand_signal_id(self) -> builtins.str:
