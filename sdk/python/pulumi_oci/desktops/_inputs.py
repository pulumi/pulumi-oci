...
class DesktopPoolAvailabilityPolicyStartScheduleArgs:
    def __init__(__self__, *,
                 ...
                 timezone: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] cron_expression: (Updatable) A cron expression describing the desktop's schedule.
        :param pulumi.Input[builtins.str] timezone: (Updatable) The timezone of the desktop's schedule.
        """
...
if not MYPY:
    class DesktopPoolDevicePolicyArgsDict(TypedDict):
        audio_mode: pulumi.Input[builtins.str]
        """
        ...
        """
        cdm_mode: pulumi.Input[builtins.str]
        """
        ...
        """
        is_display_enabled: pulumi.Input[builtins.bool]
        """
        (Updatable) Indicates whether the display is enabled.
        """
        is_keyboard_enabled: pulumi.Input[builtins.bool]
        """
        (Updatable) Indicates whether the keyboard is enabled.
        """
        is_pointer_enabled: pulumi.Input[builtins.bool]
        """
        (Updatable) Indicates whether the pointer is enabled.
        """
        is_printing_enabled: pulumi.Input[builtins.bool]
        """
...
class DesktopPoolDevicePolicyArgs:
    def __init__(__self__, *,
                 ...
                 is_printing_enabled: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.str] audio_mode: (Updatable) The audio mode. NONE: No access to the local audio devices is permitted. TODESKTOP: The user may record audio on their desktop.  FROMDESKTOP: The user may play audio on their desktop. FULL: The user may play and record audio on their desktop.
        :param pulumi.Input[builtins.str] cdm_mode: (Updatable) The client local drive access mode. NONE: No access to local drives permitted. READONLY: The user may read from local drives on their desktop. FULL: The user may read from and write to their local drives on their desktop.
        :param pulumi.Input[builtins.str] clipboard_mode: (Updatable) The clipboard mode. NONE: No access to the local clipboard is permitted. TODESKTOP: The clipboard can be used to transfer data to the desktop only.  FROMDESKTOP: The clipboard can be used to transfer data from the desktop only. FULL: The clipboard can be used to transfer data to and from the desktop.
        :param pulumi.Input[builtins.bool] is_display_enabled: (Updatable) Indicates whether the display is enabled.
        :param pulumi.Input[builtins.bool] is_keyboard_enabled: (Updatable) Indicates whether the keyboard is enabled.
        :param pulumi.Input[builtins.bool] is_pointer_enabled: (Updatable) Indicates whether the pointer is enabled.
        :param pulumi.Input[builtins.bool] is_printing_enabled: (Updatable) Indicates whether printing is enabled.
        """
    ...
    def audio_mode(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The audio mode. NONE: No access to the local audio devices is permitted. TODESKTOP: The user may record audio on their desktop.  FROMDESKTOP: The user may play audio on their desktop. FULL: The user may play and record audio on their desktop.
        """
    ...
    @audio_mode.setter
    def audio_mode(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "audio_mode", value)

    @property
    @pulumi.getter(name="cdmMode")
    def cdm_mode(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The client local drive access mode. NONE: No access to local drives permitted. READONLY: The user may read from local drives on their desktop. FULL: The user may read from and write to their local drives on their desktop.
        """
    ...
    @cdm_mode.setter
    def cdm_mode(self, value: pulumi.Input[builtins.str]):
    ...
    def is_display_enabled(self) -> pulumi.Input[builtins.bool]:
        """
        (Updatable) Indicates whether the display is enabled.
        """
    ...
    def is_display_enabled(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "is_display_enabled", value)

    @property
    @pulumi.getter(name="isKeyboardEnabled")
    def is_keyboard_enabled(self) -> pulumi.Input[builtins.bool]:
        """
        (Updatable) Indicates whether the keyboard is enabled.
        """
    ...
    def is_keyboard_enabled(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "is_keyboard_enabled", value)

    @property
    @pulumi.getter(name="isPointerEnabled")
    def is_pointer_enabled(self) -> pulumi.Input[builtins.bool]:
        """
        (Updatable) Indicates whether the pointer is enabled.
        """
    ...
    def is_pointer_enabled(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "is_pointer_enabled", value)

    @property
    @pulumi.getter(name="isPrintingEnabled")
    def is_printing_enabled(self) -> pulumi.Input[builtins.bool]:
        """
        (Updatable) Indicates whether printing is enabled.
        """
    ...
    def is_printing_enabled(self, value: pulumi.Input[builtins.bool]):
...
class DesktopPoolImageArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] image_id: The OCID of the desktop image.
        :param pulumi.Input[builtins.str] image_name: The name of the desktop image.
        :param pulumi.Input[builtins.str] operating_system: The operating system of the desktop image, e.g. "Oracle Linux", "Windows".
        """
...
class DesktopPoolNetworkConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 vcn_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] subnet_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet in the customer VCN where the connectivity will be established.
        :param pulumi.Input[builtins.str] vcn_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the customer VCN.
        """
...
if not MYPY:
    class DesktopPoolPrivateAccessDetailsArgsDict(TypedDict):
        ...
        """
        endpoint_fqdn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DesktopPoolPrivateAccessDetailsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] subnet_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the private subnet in the customer VCN where the connectivity will be established.
        :param pulumi.Input[builtins.str] endpoint_fqdn: The three-label FQDN to use for the private endpoint. The customer VCN's DNS records are updated with this FQDN. This enables the customer to use the FQDN instead of the private endpoint's private IP address to access the service (for example, xyz.oraclecloud.com).
...
if not MYPY:
    class DesktopPoolSessionLifecycleActionsDisconnectArgsDict(TypedDict):
        ...
        """
        grace_period_in_minutes: NotRequired[pulumi.Input[builtins.int]]
        """
...
class DesktopPoolSessionLifecycleActionsDisconnectArgs:
    def __init__(__self__, *,
                 action: pulumi.Input[builtins.str],
                 grace_period_in_minutes: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] action: (Updatable) a disconnect action to be triggered. Could be set to NONE or STOP
        :param pulumi.Input[builtins.int] grace_period_in_minutes: (Updatable) The period of time (in minutes) after disconnect before any action occurs. If the value is not provided, a default value is used.
        """
    ...
    def grace_period_in_minutes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The period of time (in minutes) after disconnect before any action occurs. If the value is not provided, a default value is used.
        """
    ...
    def grace_period_in_minutes(self, value: Optional[pulumi.Input[builtins.int]]):
...
class DesktopPoolSessionLifecycleActionsInactivityArgs:
    def __init__(__self__, *,
                 ...
                 grace_period_in_minutes: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] action: (Updatable) an inactivity action to be triggered. Could be set to NONE or DISCONNECT.
        :param pulumi.Input[builtins.int] grace_period_in_minutes: (Updatable) The period of time (in minutes) during which the session must remain inactive before any action occurs. If the value is not provided, a default value is used.
        """
        pulumi.set(__self__, "action", action)
        if grace_period_in_minutes is not None:
            pulumi.set(__self__, "grace_period_in_minutes", grace_period_in_minutes)
...
class DesktopPoolShapeConfigArgs:
    def __init__(__self__, *,
                 ...
                 memory_in_gbs: Optional[pulumi.Input[builtins.str]] = None,
                 ocpus: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] baseline_ocpu_utilization: The baseline OCPU utilization for a subcore burstable VM instance used for each desktop compute instance in the desktop pool. Leave this attribute blank for a non-burstable instance, or explicitly specify non-burstable with `BASELINE_1_1`. The following values are supported:
               * `BASELINE_1_8` - baseline usage is 1/8 of an OCPU.
               * `BASELINE_1_2` - baseline usage is 1/2 of an OCPU.
               * `BASELINE_1_1` - baseline usage is the entire OCPU. This represents a non-burstable instance.
        :param pulumi.Input[builtins.str] memory_in_gbs: The total amount of memory available in gigabytes for each desktop compute instance in the desktop pool.
        :param pulumi.Input[builtins.str] ocpus: The total number of OCPUs available for each desktop compute instance in the desktop pool.
        """
    ...
    def memory_in_gbs(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The total amount of memory available in gigabytes for each desktop compute instance in the desktop pool.
        """
    ...
    def memory_in_gbs(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "memory_in_gbs", value)

    @property
    @pulumi.getter
    def ocpus(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The total number of OCPUs available for each desktop compute instance in the desktop pool.
        """
    ...
    @ocpus.setter
    def ocpus(self, value: Optional[pulumi.Input[builtins.str]]):
