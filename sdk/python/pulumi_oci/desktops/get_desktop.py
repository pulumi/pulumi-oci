...
def get_desktop(desktop_id: Optional[builtins.str] = None,
    ...
    :param builtins.str desktop_id: The OCID of the desktop.
    """
    __args__ = dict()
...
def get_desktop_output(desktop_id: Optional[pulumi.Input[builtins.str]] = None,
