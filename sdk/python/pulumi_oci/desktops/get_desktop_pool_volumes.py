...
def get_desktop_pool_volumes(availability_domain: Optional[builtins.str] = None,
...
def get_desktop_pool_volumes_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
