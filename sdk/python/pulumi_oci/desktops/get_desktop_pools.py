...
def get_desktop_pools(availability_domain: Optional[builtins.str] = None,
...
def get_desktop_pools_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
