...
class DesktopPoolAvailabilityPolicyStartSchedule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str cron_expression: (Updatable) A cron expression describing the desktop's schedule.
        :param builtins.str timezone: (Updatable) The timezone of the desktop's schedule.
        """
...
class DesktopPoolDevicePolicy(dict):
    ...
    def __init__(__self__, *,
                 audio_mode: builtins.str,
                 cdm_mode: builtins.str,
                 clipboard_mode: builtins.str,
                 is_display_enabled: builtins.bool,
                 is_keyboard_enabled: builtins.bool,
                 is_pointer_enabled: builtins.bool,
                 is_printing_enabled: builtins.bool):
        """
        :param builtins.str audio_mode: (Updatable) The audio mode. NONE: No access to the local audio devices is permitted. TODESKTOP: The user may record audio on their desktop.  FROMDESKTOP: The user may play audio on their desktop. FULL: The user may play and record audio on their desktop.
        :param builtins.str cdm_mode: (Updatable) The client local drive access mode. NONE: No access to local drives permitted. READONLY: The user may read from local drives on their desktop. FULL: The user may read from and write to their local drives on their desktop.
        :param builtins.str clipboard_mode: (Updatable) The clipboard mode. NONE: No access to the local clipboard is permitted. TODESKTOP: The clipboard can be used to transfer data to the desktop only.  FROMDESKTOP: The clipboard can be used to transfer data from the desktop only. FULL: The clipboard can be used to transfer data to and from the desktop.
        :param builtins.bool is_display_enabled: (Updatable) Indicates whether the display is enabled.
        :param builtins.bool is_keyboard_enabled: (Updatable) Indicates whether the keyboard is enabled.
        :param builtins.bool is_pointer_enabled: (Updatable) Indicates whether the pointer is enabled.
        :param builtins.bool is_printing_enabled: (Updatable) Indicates whether printing is enabled.
        """
    ...
    def audio_mode(self) -> builtins.str:
        """
    ...
    def cdm_mode(self) -> builtins.str:
        """
    ...
    def is_display_enabled(self) -> builtins.bool:
        """
    ...
    def is_keyboard_enabled(self) -> builtins.bool:
        """
    ...
    def is_pointer_enabled(self) -> builtins.bool:
        """
    ...
    def is_printing_enabled(self) -> builtins.bool:
        """
...
class DesktopPoolImage(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str image_id: The OCID of the desktop image.
        :param builtins.str image_name: The name of the desktop image.
        :param builtins.str operating_system: The operating system of the desktop image, e.g. "Oracle Linux", "Windows".
        """
...
class DesktopPoolNetworkConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 vcn_id: builtins.str):
        """
        :param builtins.str subnet_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet in the customer VCN where the connectivity will be established.
        :param builtins.str vcn_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the customer VCN.
        """
...
class DesktopPoolPrivateAccessDetails(dict):
    ...
    def __init__(__self__, *,
                 subnet_id: builtins.str,
                 endpoint_fqdn: Optional[builtins.str] = None,
                 nsg_ids: Optional[Sequence[builtins.str]] = None,
                 private_ip: Optional[builtins.str] = None,
                 vcn_id: Optional[builtins.str] = None):
        """
        :param builtins.str subnet_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the private subnet in the customer VCN where the connectivity will be established.
        :param builtins.str endpoint_fqdn: The three-label FQDN to use for the private endpoint. The customer VCN's DNS records are updated with this FQDN. This enables the customer to use the FQDN instead of the private endpoint's private IP address to access the service (for example, xyz.oraclecloud.com).
        :param Sequence[builtins.str] nsg_ids: A list of network security groups for the private access.
        :param builtins.str private_ip: The IPv4 address from the provided Oracle Cloud Infrastructure subnet which needs to be assigned to the VNIC. If not provided, it will be auto-assigned with an available IPv4 address from the subnet.
        :param builtins.str vcn_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the customer VCN.
        """
        pulumi.set(__self__, "subnet_id", subnet_id)
    ...
    def endpoint_fqdn(self) -> Optional[builtins.str]:
        """
...
class DesktopPoolSessionLifecycleActionsDisconnect(dict):
    ...
    def __init__(__self__, *,
                 action: builtins.str,
                 grace_period_in_minutes: Optional[builtins.int] = None):
        """
        :param builtins.str action: (Updatable) a disconnect action to be triggered. Could be set to NONE or STOP
        :param builtins.int grace_period_in_minutes: (Updatable) The period of time (in minutes) after disconnect before any action occurs. If the value is not provided, a default value is used.
        """
    ...
    def grace_period_in_minutes(self) -> Optional[builtins.int]:
        """
...
class DesktopPoolSessionLifecycleActionsInactivity(dict):
    ...
    def __init__(__self__, *,
                 ...
                 grace_period_in_minutes: Optional[builtins.int] = None):
        """
        :param builtins.str action: (Updatable) an inactivity action to be triggered. Could be set to NONE or DISCONNECT.
        :param builtins.int grace_period_in_minutes: (Updatable) The period of time (in minutes) during which the session must remain inactive before any action occurs. If the value is not provided, a default value is used.
        """
        pulumi.set(__self__, "action", action)
        if grace_period_in_minutes is not None:
            pulumi.set(__self__, "grace_period_in_minutes", grace_period_in_minutes)
...
class DesktopPoolShapeConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 memory_in_gbs: Optional[builtins.str] = None,
                 ocpus: Optional[builtins.str] = None):
        """
        :param builtins.str baseline_ocpu_utilization: The baseline OCPU utilization for a subcore burstable VM instance used for each desktop compute instance in the desktop pool. Leave this attribute blank for a non-burstable instance, or explicitly specify non-burstable with `BASELINE_1_1`. The following values are supported:
               * `BASELINE_1_8` - baseline usage is 1/8 of an OCPU.
               * `BASELINE_1_2` - baseline usage is 1/2 of an OCPU.
               * `BASELINE_1_1` - baseline usage is the entire OCPU. This represents a non-burstable instance.
        :param builtins.str memory_in_gbs: The total amount of memory available in gigabytes for each desktop compute instance in the desktop pool.
        :param builtins.str ocpus: The total number of OCPUs available for each desktop compute instance in the desktop pool.
        """
    ...
    def memory_in_gbs(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def ocpus(self) -> Optional[builtins.str]:
        """
...
class GetDesktopDevicePolicyResult(dict):
    def __init__(__self__, *,
                 ...
                 is_printing_enabled: builtins.bool):
        """
        :param builtins.str audio_mode: The audio mode. NONE: No access to the local audio devices is permitted. TODESKTOP: The user may record audio on their desktop.  FROMDESKTOP: The user may play audio on their desktop. FULL: The user may play and record audio on their desktop.
        :param builtins.str cdm_mode: The client local drive access mode. NONE: No access to local drives permitted. READONLY: The user may read from local drives on their desktop. FULL: The user may read from and write to their local drives on their desktop.
        :param builtins.str clipboard_mode: The clipboard mode. NONE: No access to the local clipboard is permitted. TODESKTOP: The clipboard can be used to transfer data to the desktop only.  FROMDESKTOP: The clipboard can be used to transfer data from the desktop only. FULL: The clipboard can be used to transfer data to and from the desktop.
        :param builtins.bool is_display_enabled: Indicates whether the display is enabled.
        :param builtins.bool is_keyboard_enabled: Indicates whether the keyboard is enabled.
        :param builtins.bool is_pointer_enabled: Indicates whether the pointer is enabled.
        :param builtins.bool is_printing_enabled: Indicates whether printing is enabled.
        """
        pulumi.set(__self__, "audio_mode", audio_mode)
        pulumi.set(__self__, "cdm_mode", cdm_mode)
        pulumi.set(__self__, "clipboard_mode", clipboard_mode)
...
class GetDesktopHostingOptionResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str connect_address: The connection address of the desktop.
...
class GetDesktopPoolAvailabilityPolicyStartScheduleResult(dict):
    def __init__(__self__, *,
                 ...
                 timezone: builtins.str):
        """
        :param builtins.str cron_expression: A cron expression describing the desktop's schedule.
        :param builtins.str timezone: The timezone of the desktop's schedule.
        """
        pulumi.set(__self__, "cron_expression", cron_expression)
        pulumi.set(__self__, "timezone", timezone)
...
class GetDesktopPoolDesktopsDesktopPoolDesktopCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str instance_id: The OCID of the compute resource used by this desktop.
        :param builtins.bool is_assigned: Indicates whether the desktop is assigned to a user.
        :param builtins.str state: A filter to return only results with the given lifecycleState.
        :param builtins.str time_created: The date and time the resource was created.
        :param builtins.str user_name: The owner of the desktop.
        """
    ...
    def is_assigned(self) -> builtins.bool:
        """
...
class GetDesktopPoolSessionLifecycleActionDisconnectResult(dict):
    def __init__(__self__, *,
                 action: builtins.str,
                 grace_period_in_minutes: builtins.int):
        """
        :param builtins.str action: an inactivity action to be triggered
        :param builtins.int grace_period_in_minutes: The period of time (in minutes) during which the session must remain inactive before any action occurs. If the value is not provided, a default value is used.
        """
        pulumi.set(__self__, "action", action)
        pulumi.set(__self__, "grace_period_in_minutes", grace_period_in_minutes)
    ...
    @property
    @pulumi.getter(name="gracePeriodInMinutes")
    def grace_period_in_minutes(self) -> builtins.int:
        """
...
class GetDesktopPoolShapeConfigResult(dict):
    ...
    @property
    @pulumi.getter(name="memoryInGbs")
    def memory_in_gbs(self) -> builtins.str:
        """
        The total amount of memory available in gigabytes for each desktop compute instance in the desktop pool.
        """
        return pulumi.get(self, "memory_in_gbs")
...
class GetDesktopPoolVolumesDesktopPoolVolumeCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str name: The name of the desktop pool volume.
        :param builtins.str pool_id: The OCID of the desktop pool to which this volume belongs.
        :param builtins.str state: A filter to return only results with the given lifecycleState.
        :param builtins.str user_name: The owner of the desktop pool volume.
        """
...
class GetDesktopPoolsDesktopPoolCollectionItemResult(dict):
    def __init__(__self__, *,
                 active_desktops: builtins.int,
                 are_privileged_users: builtins.bool,
                 are_volumes_preserved: builtins.bool,
                 availability_domain: builtins.str,
                 availability_policies: Sequence['outputs.GetDesktopPoolsDesktopPoolCollectionItemAvailabilityPolicyResult'],
                 compartment_id: builtins.str,
                 contact_details: builtins.str,
                 defined_tags: Mapping[str, builtins.str],
                 ...
                 is_storage_enabled: builtins.bool,
                 maximum_size: builtins.int,
                 ...
                 standby_size: builtins.int,
                 state: builtins.str,
                 storage_backup_policy_id: builtins.str,
                 storage_size_in_gbs: builtins.int,
                 time_created: builtins.str,
                 time_start_scheduled: builtins.str,
                 time_stop_scheduled: builtins.str,
                 use_dedicated_vm_host: builtins.str):
        """
        :param builtins.int active_desktops: The number of active desktops in the desktop pool.
        :param builtins.bool are_privileged_users: Indicates whether desktop pool users have administrative privileges on their desktop.
        :param builtins.str availability_domain: The name of the availability domain.
        ...
        :param builtins.str contact_details: Contact information of the desktop pool administrator. Avoid entering confidential information.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param builtins.str description: A user friendly description providing additional information about the resource. Avoid entering confidential information.
        ...
        :param builtins.bool is_storage_enabled: Indicates whether storage is enabled for the desktop pool.
        :param builtins.int maximum_size: The maximum number of desktops permitted in the desktop pool.
        ...
        :param builtins.str shape_name: The shape of the desktop pool.
        :param builtins.int standby_size: The maximum number of standby desktops available in the desktop pool.
        :param builtins.str state: A filter to return only results with the given lifecycleState.
        :param builtins.str storage_backup_policy_id: The backup policy OCID of the storage.
        :param builtins.int storage_size_in_gbs: The size in GBs of the storage for the desktop pool.
        :param builtins.str time_created: The date and time the resource was created.
        :param builtins.str time_start_scheduled: The start time of the desktop pool.
        :param builtins.str time_stop_scheduled: The stop time of the desktop pool.
        :param builtins.str use_dedicated_vm_host: Indicates whether the desktop pool uses dedicated virtual machine hosts.
        """
    ...
    def active_desktops(self) -> builtins.int:
        """
    ...
    def are_privileged_users(self) -> builtins.bool:
        """
    ...
    def are_volumes_preserved(self) -> builtins.bool:
    ...
    def contact_details(self) -> builtins.str:
        """
    ...
    def is_storage_enabled(self) -> builtins.bool:
        """
    ...
    def maximum_size(self) -> builtins.int:
        """
    ...
    def standby_size(self) -> builtins.int:
        """
    ...
    def storage_backup_policy_id(self) -> builtins.str:
        """
    ...
    def time_start_scheduled(self) -> builtins.str:
        """
    ...
    def time_stop_scheduled(self) -> builtins.str:
        """
    ...
    def use_dedicated_vm_host(self) -> builtins.str:
        """
...
class GetDesktopsDesktopCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param Mapping[str, builtins.str] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param builtins.str id: A filter to return only results with the given OCID.
        :param builtins.str pool_id: The OCID of the desktop pool the desktop is a member of.
        :param builtins.str state: A filter to return only results with the given lifecycleState.
        :param builtins.str time_created: The date and time the resource was created.
        :param builtins.str user_name: The owner of the desktop.
        """
