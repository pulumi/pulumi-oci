...
class BuildPipelineBuildPipelineParametersItemArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] default_value: (Updatable) Default value of the parameter.
        :param pulumi.Input[builtins.str] name: (Updatable) Name of the parameter (case-sensitive). Parameter name must be ^[a-zA-Z][a-zA-Z_0-9]*$. Example: 'Build_Pipeline_param' is not same as 'build_pipeline_Param'
        :param pulumi.Input[builtins.str] description: (Updatable) Description of the parameter.
        """
...
class BuildPipelineStageBuildPipelineStagePredecessorCollectionItemArgs:
    def __init__(__self__, *,
                 id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] id: (Updatable) The OCID of the predecessor stage. If a stage is the first stage in the pipeline, then the ID is the pipeline's OCID.
        """
...
if not MYPY:
    class BuildPipelineStageBuildRunnerShapeConfigArgsDict(TypedDict):
        build_runner_type: pulumi.Input[builtins.str]
        """
...
class BuildPipelineStageBuildRunnerShapeConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] build_runner_type: (Updatable) Name of the build runner shape in which the execution occurs. If not specified, the default shape is chosen.
        :param pulumi.Input[builtins.int] memory_in_gbs: (Updatable) The total amount of memory set for the instance in gigabytes.
        :param pulumi.Input[builtins.int] ocpus: (Updatable) The total number of OCPUs set for the instance.
        """
    ...
    def build_runner_type(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) Name of the build runner shape in which the execution occurs. If not specified, the default shape is chosen.
        """
    ...
    def build_runner_type(self, value: pulumi.Input[builtins.str]):
...
class BuildPipelineStageBuildSourceCollectionItemArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] connection_type: (Updatable) The type of source provider.
        :param pulumi.Input[builtins.str] branch: (Updatable) Branch name.
        :param pulumi.Input[builtins.str] connection_id: (Updatable) Connection identifier pertinent to Bitbucket Server source provider
        :param pulumi.Input[builtins.str] name: (Updatable) Name of the build source. This must be unique within a build source collection. The name can be used by customers to locate the working directory pertinent to this repository.
        :param pulumi.Input[builtins.str] repository_id: (Updatable) The DevOps code repository ID.
        :param pulumi.Input[builtins.str] repository_url: (Updatable) URL for the repository.
        """
...
class BuildPipelineStageDeliverArtifactCollectionItemArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] artifact_id: (Updatable) Artifact identifier that contains the artifact definition.
        :param pulumi.Input[builtins.str] artifact_name: (Updatable) Name of the artifact specified in the build_spec.yaml file.
        """
...
if not MYPY:
    class BuildPipelineStagePrivateAccessConfigArgsDict(TypedDict):
        network_channel_type: pulumi.Input[builtins.str]
        """
...
class BuildPipelineStagePrivateAccessConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] network_channel_type: (Updatable) Network channel type.
        :param pulumi.Input[builtins.str] subnet_id: (Updatable) The OCID of the subnet where VNIC resources will be created for private endpoint.
    ...
    def network_channel_type(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) Network channel type.
        """
    ...
    def network_channel_type(self, value: pulumi.Input[builtins.str]):
...
class BuildPipelineStageWaitCriteriaArgs:
    def __init__(__self__, *,
                 ...
                 wait_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] wait_duration: (Updatable) The absolute wait duration. Minimum wait duration must be 5 seconds. Maximum wait duration can be up to 2 days.
        :param pulumi.Input[builtins.str] wait_type: (Updatable) Wait criteria type.
    ...
    def wait_duration(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The absolute wait duration. Minimum wait duration must be 5 seconds. Maximum wait duration can be up to 2 days.
        """
    ...
    def wait_duration(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "wait_duration", value)

    @property
    @pulumi.getter(name="waitType")
    def wait_type(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) Wait criteria type.
    ...
    @wait_type.setter
    def wait_type(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class BuildRunBuildOutputArtifactOverrideParameterItemArgsDict(TypedDict):
        deploy_artifact_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BuildRunBuildOutputArtifactOverrideParameterItemArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] deploy_artifact_id: The OCID of the deployment artifact definition.
        :param pulumi.Input[builtins.str] name: Name of the step.
        :param pulumi.Input[builtins.str] value: Value of the argument.
        """
...
if not MYPY:
    class BuildRunBuildOutputDeliveredArtifactItemArgsDict(TypedDict):
        artifact_repository_id: NotRequired[pulumi.Input[builtins.str]]
        """
        The OCID of the artifact registry repository used by the DeliverArtifactStage
        """
        artifact_type: NotRequired[pulumi.Input[builtins.str]]
        """
        Type of artifact delivered.
        """
        delivered_artifact_hash: NotRequired[pulumi.Input[builtins.str]]
        """
        The hash of the container registry artifact pushed by the Deliver Artifacts stage.
        """
        delivered_artifact_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        output_artifact_name: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BuildRunBuildOutputDeliveredArtifactItemArgs:
    def __init__(__self__, *,
                 ...
                 delivered_artifact_hash: Optional[pulumi.Input[builtins.str]] = None,
                 delivered_artifact_id: Optional[pulumi.Input[builtins.str]] = None,
                 deploy_artifact_id: Optional[pulumi.Input[builtins.str]] = None,
                 image_uri: Optional[pulumi.Input[builtins.str]] = None,
                 output_artifact_name: Optional[pulumi.Input[builtins.str]] = None,
                 path: Optional[pulumi.Input[builtins.str]] = None,
                 version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] artifact_repository_id: The OCID of the artifact registry repository used by the DeliverArtifactStage
        :param pulumi.Input[builtins.str] artifact_type: Type of artifact delivered.
        :param pulumi.Input[builtins.str] delivered_artifact_hash: The hash of the container registry artifact pushed by the Deliver Artifacts stage.
        :param pulumi.Input[builtins.str] delivered_artifact_id: The OCID of the artifact pushed by the Deliver Artifacts stage.
        :param pulumi.Input[builtins.str] deploy_artifact_id: The OCID of the deployment artifact definition.
        :param pulumi.Input[builtins.str] image_uri: The imageUri of the OCIR artifact pushed by the DeliverArtifactStage
        :param pulumi.Input[builtins.str] output_artifact_name: Name of the output artifact defined in the build specification file.
        :param pulumi.Input[builtins.str] path: Path of the repository where artifact was pushed
        :param pulumi.Input[builtins.str] version: Version of the artifact pushed
        """
    ...
    def delivered_artifact_hash(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The hash of the container registry artifact pushed by the Deliver Artifacts stage.
        """
    ...
    def delivered_artifact_hash(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "delivered_artifact_hash", value)

    @property
    @pulumi.getter(name="deliveredArtifactId")
    def delivered_artifact_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The OCID of the artifact pushed by the Deliver Artifacts stage.
        """
    ...
    def delivered_artifact_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def output_artifact_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name of the output artifact defined in the build specification file.
        """
    ...
    def output_artifact_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class BuildRunBuildOutputVulnerabilityAuditSummaryCollectionItemArgsDict(TypedDict):
        build_stage_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        vulnerability_audit_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BuildRunBuildOutputVulnerabilityAuditSummaryCollectionItemArgs:
    def __init__(__self__, *,
                 build_stage_id: Optional[pulumi.Input[builtins.str]] = None,
                 commit_hash: Optional[pulumi.Input[builtins.str]] = None,
                 vulnerability_audit_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] build_stage_id: Build stage OCID where scan was configured.
        :param pulumi.Input[builtins.str] commit_hash: Commit hash pertinent to the repository URL and the specified branch.
        :param pulumi.Input[builtins.str] vulnerability_audit_id: The OCID of the vulnerability audit.
        """
    ...
    def build_stage_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Build stage OCID where scan was configured.
        """
    ...
    def build_stage_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def vulnerability_audit_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The OCID of the vulnerability audit.
        """
    ...
    def vulnerability_audit_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class BuildRunBuildRunArgumentsItemArgs:
    def __init__(__self__, *,
                 ...
                 value: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] name: Name of the parameter (case-sensitive). Parameter name must be ^[a-zA-Z][a-zA-Z_0-9]*$. Example: 'Build_Pipeline_param' is not same as 'build_pipeline_Param'
        :param pulumi.Input[builtins.str] value: Value of the argument.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
if not MYPY:
    class BuildRunBuildRunProgressArgsDict(TypedDict):
        build_pipeline_stage_run_progress: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class BuildRunBuildRunProgressArgs:
    def __init__(__self__, *,
                 build_pipeline_stage_run_progress: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 time_finished: Optional[pulumi.Input[builtins.str]] = None,
                 time_started: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] build_pipeline_stage_run_progress: Map of stage OCIDs to build pipeline stage run progress model.
        :param pulumi.Input[builtins.str] time_finished: The time the build run finished. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param pulumi.Input[builtins.str] time_started: The time the build run started. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        """
    ...
    def build_pipeline_stage_run_progress(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Map of stage OCIDs to build pipeline stage run progress model.
        """
    ...
    def build_pipeline_stage_run_progress(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class BuildRunBuildRunSourceArgsDict(TypedDict):
        ...
        """
        trigger_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BuildRunBuildRunSourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] repository_id: The DevOps code repository identifier that invoked the build run.
        :param pulumi.Input[builtins.str] source_type: The source from which the build run is triggered.
        :param pulumi.Input[builtins.str] trigger_id: The trigger that invoked the build run.
...
if not MYPY:
    class BuildRunBuildRunSourceTriggerInfoActionArgsDict(TypedDict):
        build_pipeline_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BuildRunBuildRunSourceTriggerInfoActionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: The type of action that will be taken. Allowed value is TRIGGER_BUILD_PIPELINE.
        """
...
if not MYPY:
    class BuildRunBuildRunSourceTriggerInfoActionFilterArgsDict(TypedDict):
        ...
        """
        trigger_source: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BuildRunBuildRunSourceTriggerInfoActionFilterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] events: The events, for example, PUSH, PULL_REQUEST_CREATED, PULL_REQUEST_UPDATED.
        ...
        :param pulumi.Input[builtins.str] trigger_source: Source of the trigger. Allowed values are, GITHUB and GITLAB.
        """
...
if not MYPY:
    class BuildRunBuildRunSourceTriggerInfoActionFilterExcludeFileFilterArgsDict(TypedDict):
        file_paths: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class BuildRunBuildRunSourceTriggerInfoActionFilterExcludeFileFilterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] file_paths: The file paths/glob pattern for files.
        """
...
if not MYPY:
    class BuildRunBuildRunSourceTriggerInfoActionFilterIncludeArgsDict(TypedDict):
        base_ref: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        Attributes to support include/exclude files for triggering build runs.
        """
        head_ref: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BuildRunBuildRunSourceTriggerInfoActionFilterIncludeArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] base_ref: The target branch for pull requests; not applicable for push requests.
        ...
        :param pulumi.Input[builtins.str] head_ref: Branch for push event; source branch for pull requests.
        :param pulumi.Input[builtins.str] repository_name: The repository name for trigger events.
        """
...
if not MYPY:
    class BuildRunCommitInfoArgsDict(TypedDict):
        commit_hash: pulumi.Input[builtins.str]
        """
        Commit hash pertinent to the repository URL and the specified branch.
        """
        repository_branch: pulumi.Input[builtins.str]
        """
...
class BuildRunCommitInfoArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] commit_hash: Commit hash pertinent to the repository URL and the specified branch.
        :param pulumi.Input[builtins.str] repository_branch: Name of the repository branch.
    ...
    @property
    @pulumi.getter(name="commitHash")
    def commit_hash(self) -> pulumi.Input[builtins.str]:
        """
        Commit hash pertinent to the repository URL and the specified branch.
        """
        return pulumi.get(self, "commit_hash")
    ...
    @commit_hash.setter
    def commit_hash(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "commit_hash", value)

    @property
    @pulumi.getter(name="repositoryBranch")
    def repository_branch(self) -> pulumi.Input[builtins.str]:
        """
        Name of the repository branch.
        """
    ...
    def repository_branch(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class ConnectionLastConnectionValidationResultArgsDict(TypedDict):
        ...
        """
        time_validated: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ConnectionLastConnectionValidationResultArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] message: A message describing the result of connection validation in more detail.
        :param pulumi.Input[builtins.str] result: The latest result of whether the credentials pass the validation.
        :param pulumi.Input[builtins.str] time_validated: The latest timestamp when the connection was validated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        """
...
if not MYPY:
    class ConnectionTlsVerifyConfigArgsDict(TypedDict):
        ca_certificate_bundle_id: pulumi.Input[builtins.str]
        """
        (Updatable) The OCID of Oracle Cloud Infrastructure certificate service CA bundle.
        """
        tls_verify_mode: pulumi.Input[builtins.str]
        """
...
class ConnectionTlsVerifyConfigArgs:
    def __init__(__self__, *,
                 ...
                 tls_verify_mode: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] ca_certificate_bundle_id: (Updatable) The OCID of Oracle Cloud Infrastructure certificate service CA bundle.
        :param pulumi.Input[builtins.str] tls_verify_mode: (Updatable) The type of TLS verification.
        """
    ...
    def ca_certificate_bundle_id(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The OCID of Oracle Cloud Infrastructure certificate service CA bundle.
        """
    ...
    def ca_certificate_bundle_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "ca_certificate_bundle_id", value)

    @property
    @pulumi.getter(name="tlsVerifyMode")
    def tls_verify_mode(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The type of TLS verification.
        """
...
class DeployArtifactDeployArtifactSourceArgs:
    def __init__(__self__, *,
                 deploy_artifact_source_type: pulumi.Input[builtins.str],
                 base64encoded_content: Optional[pulumi.Input[builtins.str]] = None,
                 chart_url: Optional[pulumi.Input[builtins.str]] = None,
                 deploy_artifact_path: Optional[pulumi.Input[builtins.str]] = None,
                 deploy_artifact_version: Optional[pulumi.Input[builtins.str]] = None,
                 helm_artifact_source_type: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 repository_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] deploy_artifact_source_type: (Updatable) Specifies types of artifact sources.
        :param pulumi.Input[builtins.str] base64encoded_content: (Updatable) The Helm commands to be executed, base 64 encoded
        :param pulumi.Input[builtins.str] chart_url: (Updatable) The URL of an OCIR repository.
        :param pulumi.Input[builtins.str] deploy_artifact_path: (Updatable) Specifies the artifact path in the repository.
        :param pulumi.Input[builtins.str] deploy_artifact_version: (Updatable) Users can set this as a placeholder value that refers to a pipeline parameter, for example, ${appVersion}.
        :param pulumi.Input[builtins.str] helm_artifact_source_type: (Updatable) Specifies types of artifact sources.
        ...
        :param pulumi.Input[builtins.str] image_digest: (Updatable) Specifies image digest for the version of the image.
        :param pulumi.Input[builtins.str] image_uri: (Updatable) Specifies OCIR Image Path - optionally include tag.
        :param pulumi.Input[builtins.str] repository_id: (Updatable) The OCID of a repository
        """
    ...
    def deploy_artifact_source_type(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) Specifies types of artifact sources.
        """
    ...
    def deploy_artifact_source_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "deploy_artifact_source_type", value)

    @property
    @pulumi.getter(name="base64encodedContent")
    def base64encoded_content(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The Helm commands to be executed, base 64 encoded
        """
    ...
    def base64encoded_content(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "base64encoded_content", value)

    @property
    @pulumi.getter(name="chartUrl")
    def chart_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The URL of an OCIR repository.
        """
    ...
    @chart_url.setter
    def chart_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "chart_url", value)

    @property
    @pulumi.getter(name="deployArtifactPath")
    def deploy_artifact_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Specifies the artifact path in the repository.
        """
    ...
    def deploy_artifact_path(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "deploy_artifact_path", value)

    @property
    @pulumi.getter(name="deployArtifactVersion")
    def deploy_artifact_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Users can set this as a placeholder value that refers to a pipeline parameter, for example, ${appVersion}.
        """
    ...
    def deploy_artifact_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "deploy_artifact_version", value)

    @property
    @pulumi.getter(name="helmArtifactSourceType")
    def helm_artifact_source_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Specifies types of artifact sources.
        """
    ...
    def helm_artifact_source_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DeployArtifactDeployArtifactSourceHelmVerificationKeySourceArgsDict(TypedDict):
        verification_key_source_type: pulumi.Input[builtins.str]
        """
        (Updatable) Specifies type of verification material.
        """
        current_public_key: NotRequired[pulumi.Input[builtins.str]]
        """
        (Updatable) Current version of Base64 encoding of the public key which is in binary GPG exported format.
        """
        previous_public_key: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        vault_secret_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DeployArtifactDeployArtifactSourceHelmVerificationKeySourceArgs:
    def __init__(__self__, *,
                 verification_key_source_type: pulumi.Input[builtins.str],
                 current_public_key: Optional[pulumi.Input[builtins.str]] = None,
                 previous_public_key: Optional[pulumi.Input[builtins.str]] = None,
                 vault_secret_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] verification_key_source_type: (Updatable) Specifies type of verification material.
        :param pulumi.Input[builtins.str] current_public_key: (Updatable) Current version of Base64 encoding of the public key which is in binary GPG exported format.
        :param pulumi.Input[builtins.str] previous_public_key: (Updatable) Previous version of Base64 encoding of the public key which is in binary GPG exported format. This would be used for key rotation scenarios.
        :param pulumi.Input[builtins.str] vault_secret_id: (Updatable) The OCID of the Vault Secret containing the verification key versions.
        """
    ...
    def verification_key_source_type(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) Specifies type of verification material.
        """
    ...
    def verification_key_source_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "verification_key_source_type", value)

    @property
    @pulumi.getter(name="currentPublicKey")
    def current_public_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Current version of Base64 encoding of the public key which is in binary GPG exported format.
        """
    ...
    def current_public_key(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "current_public_key", value)

    @property
    @pulumi.getter(name="previousPublicKey")
    def previous_public_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Previous version of Base64 encoding of the public key which is in binary GPG exported format. This would be used for key rotation scenarios.
        """
    ...
    def previous_public_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DeployEnvironmentComputeInstanceGroupSelectorsItemArgsDict(TypedDict):
        selector_type: pulumi.Input[builtins.str]
        """
        (Updatable) Defines the type of the instance selector for the group.
        """
        compute_instance_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class DeployEnvironmentComputeInstanceGroupSelectorsItemArgs:
    def __init__(__self__, *,
                 selector_type: pulumi.Input[builtins.str],
                 compute_instance_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 query: Optional[pulumi.Input[builtins.str]] = None,
                 region: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] selector_type: (Updatable) Defines the type of the instance selector for the group.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] compute_instance_ids: (Updatable) Compute instance OCID identifiers that are members of this group.
        :param pulumi.Input[builtins.str] query: (Updatable) Query expression confirming to the Oracle Cloud Infrastructure Search Language syntax to select compute instances for the group. The language is documented at https://docs.oracle.com/en-us/iaas/Content/Search/Concepts/querysyntax.htm
        :param pulumi.Input[builtins.str] region: (Updatable) Region identifier referred by the deployment environment. Region identifiers are listed at https://docs.oracle.com/en-us/iaas/Content/General/Concepts/regions.htm
        """
    ...
    def selector_type(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) Defines the type of the instance selector for the group.
        """
    ...
    def selector_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "selector_type", value)

    @property
    @pulumi.getter(name="computeInstanceIds")
    def compute_instance_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        (Updatable) Compute instance OCID identifiers that are members of this group.
        """
    ...
    def compute_instance_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class DeployPipelineDeployPipelineArtifactItemArgs:
    def __init__(__self__, *,
                 ...
                 display_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] deploy_artifact_id: The OCID of an artifact
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) Deployment pipeline display name. Avoid entering confidential information.
        """
        if deploy_artifact_id is not None:
            pulumi.set(__self__, "deploy_artifact_id", deploy_artifact_id)
...
if not MYPY:
    class DeployPipelineDeployPipelineArtifactItemDeployPipelineStageItemArgsDict(TypedDict):
        deploy_stage_id: NotRequired[pulumi.Input[builtins.str]]
        """
        The OCID of a stage
        """
        display_name: NotRequired[pulumi.Input[builtins.str]]
...
class DeployPipelineDeployPipelineArtifactItemDeployPipelineStageItemArgs:
    def __init__(__self__, *,
                 ...
                 display_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] deploy_stage_id: The OCID of a stage
        :param pulumi.Input[builtins.str] display_name: (Updatable) Deployment pipeline display name. Avoid entering confidential information.
        """
...
if not MYPY:
    class DeployPipelineDeployPipelineEnvironmentItemArgsDict(TypedDict):
        deploy_environment_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DeployPipelineDeployPipelineEnvironmentItemArgs:
    def __init__(__self__, *,
                 deploy_environment_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 display_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] deploy_environment_id: The OCID of an Environment
    ...
    def deploy_environment_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The OCID of an Environment
        """
    ...
    def deploy_environment_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DeployPipelineDeployPipelineParametersItemArgs:
    def __init__(__self__, *,
                 ...
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: (Updatable) Name of the parameter (case-sensitive). Parameter name must be ^[a-zA-Z][a-zA-Z_0-9]*$.
        :param pulumi.Input[builtins.str] default_value: (Updatable) Default value of the parameter.
        :param pulumi.Input[builtins.str] description: (Updatable) Description of the parameter.
        """
        pulumi.set(__self__, "name", name)
...
if not MYPY:
    class DeployStageApprovalPolicyArgsDict(TypedDict):
        approval_policy_type: pulumi.Input[builtins.str]
        """
        (Updatable) Approval policy type.
        """
        number_of_approvals_required: pulumi.Input[builtins.int]
        """
...
class DeployStageApprovalPolicyArgs:
    def __init__(__self__, *,
                 ...
                 number_of_approvals_required: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] approval_policy_type: (Updatable) Approval policy type.
        :param pulumi.Input[builtins.int] number_of_approvals_required: (Updatable) A minimum number of approvals required for stage to proceed.
        """
    ...
    def approval_policy_type(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) Approval policy type.
        """
    ...
    def approval_policy_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "approval_policy_type", value)

    @property
    @pulumi.getter(name="numberOfApprovalsRequired")
    def number_of_approvals_required(self) -> pulumi.Input[builtins.int]:
        """
        (Updatable) A minimum number of approvals required for stage to proceed.
        """
    ...
    def number_of_approvals_required(self, value: pulumi.Input[builtins.int]):
...
class DeployStageBlueBackendIpsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] items: (Updatable) The IP address of the backend server. A server could be a compute instance or a load balancer.
        """
        if items is not None:
            pulumi.set(__self__, "items", items)
...
if not MYPY:
    class DeployStageBlueGreenStrategyArgsDict(TypedDict):
        ingress_name: pulumi.Input[builtins.str]
        """
        Name of the Ingress resource.
        """
        namespace_a: pulumi.Input[builtins.str]
        """
        First Namespace for deployment.
        """
        namespace_b: pulumi.Input[builtins.str]
        """
...
class DeployStageBlueGreenStrategyArgs:
    def __init__(__self__, *,
                 ...
                 strategy_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] ingress_name: Name of the Ingress resource.
        :param pulumi.Input[builtins.str] namespace_a: First Namespace for deployment.
        :param pulumi.Input[builtins.str] namespace_b: Second Namespace for deployment.
        :param pulumi.Input[builtins.str] strategy_type: Blue Green strategy type
        """
    ...
    def ingress_name(self) -> pulumi.Input[builtins.str]:
        """
        Name of the Ingress resource.
        """
    ...
    @ingress_name.setter
    def ingress_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "ingress_name", value)

    @property
    @pulumi.getter(name="namespaceA")
    def namespace_a(self) -> pulumi.Input[builtins.str]:
        """
        First Namespace for deployment.
        """
    ...
    @namespace_a.setter
    def namespace_a(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "namespace_a", value)

    @property
    @pulumi.getter(name="namespaceB")
    def namespace_b(self) -> pulumi.Input[builtins.str]:
        """
        Second Namespace for deployment.
        """
    ...
    @namespace_b.setter
    def namespace_b(self, value: pulumi.Input[builtins.str]):
...
class DeployStageCanaryStrategyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] ingress_name: Name of the Ingress resource.
        :param pulumi.Input[builtins.str] namespace: Canary namespace to be used for Kubernetes canary deployment.
        :param pulumi.Input[builtins.str] strategy_type: Canary strategy type.
        """
        pulumi.set(__self__, "ingress_name", ingress_name)
...
if not MYPY:
    class DeployStageContainerConfigArgsDict(TypedDict):
        container_config_type: pulumi.Input[builtins.str]
        """
...
class DeployStageContainerConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] container_config_type: (Updatable) Container configuration type.
        ...
        :param pulumi.Input[builtins.str] shape_name: (Updatable) The shape of the ContainerInstance. The shape determines the resources available to the ContainerInstance.
        :param pulumi.Input[builtins.str] availability_domain: (Updatable) Availability domain where the ContainerInstance will be created.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment where the ContainerInstance will be created.
        """
    ...
    def container_config_type(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) Container configuration type.
        """
    ...
    def container_config_type(self, value: pulumi.Input[builtins.str]):
...
class DeployStageContainerConfigShapeConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.float] memory_in_gbs: (Updatable) The total amount of memory available to the instance, in gigabytes.
        """
        pulumi.set(__self__, "ocpus", ocpus)
        if memory_in_gbs is not None:
            pulumi.set(__self__, "memory_in_gbs", memory_in_gbs)
...
class DeployStageFailurePolicyArgs:
    def __init__(__self__, *,
                 policy_type: pulumi.Input[builtins.str],
                 failure_count: Optional[pulumi.Input[builtins.int]] = None,
                 failure_percentage: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] policy_type: (Updatable) Specifies if the failure instance size is given by absolute number or by percentage.
        :param pulumi.Input[builtins.int] failure_count: (Updatable) The threshold count of failed instances in the group, which when reached or exceeded sets the stage as FAILED.
        :param pulumi.Input[builtins.int] failure_percentage: (Updatable) The failure percentage threshold, which when reached or exceeded sets the stage as FAILED. Percentage is computed as the ceiling value of the number of failed instances over the total count of the instances in the group.
        """
    ...
    def failure_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The threshold count of failed instances in the group, which when reached or exceeded sets the stage as FAILED.
        """
    ...
    def failure_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "failure_count", value)

    @property
    @pulumi.getter(name="failurePercentage")
    def failure_percentage(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The failure percentage threshold, which when reached or exceeded sets the stage as FAILED. Percentage is computed as the ceiling value of the number of failed instances over the total count of the instances in the group.
        """
    ...
    def failure_percentage(self, value: Optional[pulumi.Input[builtins.int]]):
...
class DeployStageLoadBalancerConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] backend_port: (Updatable) Listen port for the backend server.
        :param pulumi.Input[builtins.str] listener_name: (Updatable) Name of the load balancer listener.
        :param pulumi.Input[builtins.str] load_balancer_id: (Updatable) The OCID of the load balancer.
...
class DeployStageProductionLoadBalancerConfigArgs:
    def __init__(__self__, *,
                 ...
                 state: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.int] backend_port: Listen port for the backend server.
        :param pulumi.Input[builtins.str] listener_name: Name of the load balancer listener.
        :param pulumi.Input[builtins.str] load_balancer_id: The OCID of the load balancer.
        :param pulumi.Input[builtins.str] state: The current state of the deployment stage.
        """
        if backend_port is not None:
            pulumi.set(__self__, "backend_port", backend_port)
...
class DeployStageRollbackPolicyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] policy_type: (Updatable) Specifies type of the deployment stage rollback policy.
        """
...
if not MYPY:
    class DeployStageRolloutPolicyArgsDict(TypedDict):
        ...
        """
        batch_delay_in_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
        (Updatable) The duration of delay between batch rollout. The default delay is 1 minute.
        """
        batch_percentage: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        ramp_limit_percent: NotRequired[pulumi.Input[builtins.float]]
        """
...
class DeployStageRolloutPolicyArgs:
    def __init__(__self__, *,
                 ...
                 batch_delay_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 batch_percentage: Optional[pulumi.Input[builtins.int]] = None,
                 policy_type: Optional[pulumi.Input[builtins.str]] = None,
                 ramp_limit_percent: Optional[pulumi.Input[builtins.float]] = None):
        """
        :param pulumi.Input[builtins.int] batch_count: (Updatable) The number that will be used to determine how many instances will be deployed concurrently.
        :param pulumi.Input[builtins.int] batch_delay_in_seconds: (Updatable) The duration of delay between batch rollout. The default delay is 1 minute.
        :param pulumi.Input[builtins.int] batch_percentage: (Updatable) The percentage that will be used to determine how many instances will be deployed concurrently.
        :param pulumi.Input[builtins.str] policy_type: (Updatable) The type of policy used for rolling out a deployment stage.
        :param pulumi.Input[builtins.float] ramp_limit_percent: (Updatable) Indicates the criteria to stop.
        """
    ...
    def batch_delay_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The duration of delay between batch rollout. The default delay is 1 minute.
        """
    ...
    def batch_delay_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "batch_delay_in_seconds", value)

    @property
    @pulumi.getter(name="batchPercentage")
    def batch_percentage(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The percentage that will be used to determine how many instances will be deployed concurrently.
        """
    ...
    def batch_percentage(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def ramp_limit_percent(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        (Updatable) Indicates the criteria to stop.
        """
    ...
    def ramp_limit_percent(self, value: Optional[pulumi.Input[builtins.float]]):
...
class DeployStageSetStringItemArgs:
    def __init__(__self__, *,
                 ...
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] name: (Updatable) Name of the parameter (case-sensitive).
        :param pulumi.Input[builtins.str] value: (Updatable) Value of the parameter.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if value is not None:
...
class DeployStageWaitCriteriaArgs:
    def __init__(__self__, *,
                 ...
                 wait_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] wait_duration: (Updatable) The absolute wait duration. An ISO 8601 formatted duration string. Minimum waitDuration should be 5 seconds. Maximum waitDuration can be up to 2 days.
        :param pulumi.Input[builtins.str] wait_type: (Updatable) Wait criteria type.
...
class DeploymentDeployArtifactOverrideArgumentsItemArgs:
    def __init__(__self__, *,
                 ...
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] deploy_artifact_id: The OCID of the artifact to which this parameter applies.
        :param pulumi.Input[builtins.str] name: Name of the parameter (case-sensitive).
        :param pulumi.Input[builtins.str] value: Value of the parameter.
        """
        if deploy_artifact_id is not None:
            pulumi.set(__self__, "deploy_artifact_id", deploy_artifact_id)
        if name is not None:
...
class DeploymentDeployStageOverrideArgumentsItemArgs:
    def __init__(__self__, *,
                 ...
                 value: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] deploy_stage_id: The OCID of the stage.
        :param pulumi.Input[builtins.str] name: Name of the parameter (case-sensitive).
        :param pulumi.Input[builtins.str] value: Value of the parameter.
        """
        if deploy_stage_id is not None:
...
if not MYPY:
    class DeploymentDeploymentExecutionProgressArgsDict(TypedDict):
        deploy_stage_execution_progress: NotRequired[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]
        """
...
class DeploymentDeploymentExecutionProgressArgs:
    def __init__(__self__, *,
                 deploy_stage_execution_progress: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 time_finished: Optional[pulumi.Input[builtins.str]] = None,
                 time_started: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] deploy_stage_execution_progress: Map of stage OCIDs to deploy stage execution progress model.
        :param pulumi.Input[builtins.str] time_finished: Time the deployment is finished. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param pulumi.Input[builtins.str] time_started: Time the deployment is started. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        """
    ...
    def deploy_stage_execution_progress(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
        Map of stage OCIDs to deploy stage execution progress model.
        """
    ...
    def deploy_stage_execution_progress(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class ProjectNotificationConfigArgs:
    def __init__(__self__, *,
                 topic_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] topic_id: (Updatable) The topic ID for notifications.
...
if not MYPY:
    class ProjectRepositorySettingApprovalRulesItemArgsDict(TypedDict):
        min_approvals_count: pulumi.Input[builtins.int]
        """
        ...
        """
        destination_branch: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ProjectRepositorySettingApprovalRulesItemArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] min_approvals_count: (Updatable) Minimum number of approvals which must be provided by the reviewers specified in the list before the rule can be satisfied
        :param pulumi.Input[builtins.str] name: (Updatable) Name which is used to uniquely identify an approval rule.
        :param pulumi.Input[builtins.str] destination_branch: (Updatable) Branch name where pull requests targeting the branch must satisfy the approval rule. This value being null means the rule applies to all pull requests
    ...
    def min_approvals_count(self) -> pulumi.Input[builtins.int]:
        """
        (Updatable) Minimum number of approvals which must be provided by the reviewers specified in the list before the rule can be satisfied
        """
    ...
    def min_approvals_count(self, value: pulumi.Input[builtins.int]):
...
if not MYPY:
    class ProjectRepositorySettingApprovalRulesItemReviewerArgsDict(TypedDict):
        ...
        """
        principal_state: NotRequired[pulumi.Input[builtins.str]]
        """
        The state of the principal, it can be active or inactive or suppressed for emails
        """
        principal_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ProjectRepositorySettingApprovalRulesItemReviewerArgs:
    def __init__(__self__, *,
                 ...
                 principal_state: Optional[pulumi.Input[builtins.str]] = None,
                 principal_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] principal_id: (Updatable) Pull Request reviewer id
        :param pulumi.Input[builtins.str] principal_name: the name of the principal
        :param pulumi.Input[builtins.str] principal_state: The state of the principal, it can be active or inactive or suppressed for emails
        :param pulumi.Input[builtins.str] principal_type: the type of principal
        """
    ...
    def principal_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The state of the principal, it can be active or inactive or suppressed for emails
        """
    ...
    def principal_state(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ProjectRepositorySettingMergeSettingsArgsDict(TypedDict):
        allowed_merge_strategies: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        (Updatable) List of merge strategies which are allowed for a Project or Repository.
        """
        default_merge_strategy: pulumi.Input[builtins.str]
        """
...
class ProjectRepositorySettingMergeSettingsArgs:
    def __init__(__self__, *,
                 ...
                 default_merge_strategy: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_merge_strategies: (Updatable) List of merge strategies which are allowed for a Project or Repository.
        :param pulumi.Input[builtins.str] default_merge_strategy: (Updatable) Default type of merge strategy associated with the a Project or Repository.
        """
    ...
    def allowed_merge_strategies(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        (Updatable) List of merge strategies which are allowed for a Project or Repository.
        """
    ...
    def allowed_merge_strategies(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "allowed_merge_strategies", value)

    @property
    @pulumi.getter(name="defaultMergeStrategy")
    def default_merge_strategy(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) Default type of merge strategy associated with the a Project or Repository.
        """
    ...
    def default_merge_strategy(self, value: pulumi.Input[builtins.str]):
...
class RepositoryMirrorRepositoryConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] connector_id: (Updatable) Upstream git repository connection identifier.
        :param pulumi.Input[builtins.str] repository_url: (Updatable) URL of external repository you want to mirror.
...
if not MYPY:
    class RepositoryMirrorRepositoryConfigTriggerScheduleArgsDict(TypedDict):
        ...
        """
        custom_schedule: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RepositoryMirrorRepositoryConfigTriggerScheduleArgs:
    def __init__(__self__, *,
                 schedule_type: pulumi.Input[builtins.str],
                 custom_schedule: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] schedule_type: (Updatable) Different types of trigger schedule: NONE - No automated synchronization schedule. DEFAULT - Trigger schedule is every 30 minutes. CUSTOM - Custom triggering schedule.
        :param pulumi.Input[builtins.str] custom_schedule: (Updatable) Valid if type is CUSTOM. Following RFC 5545 recurrence rules, we can specify starting time, occurrence frequency, and interval size. Example for frequency could be DAILY/WEEKLY/HOURLY or any RFC 5545 supported frequency, which is followed by start time of this window. You can control the start time with BYHOUR, BYMINUTE and BYSECONDS. It is followed by the interval size.
        """
    ...
    def custom_schedule(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Valid if type is CUSTOM. Following RFC 5545 recurrence rules, we can specify starting time, occurrence frequency, and interval size. Example for frequency could be DAILY/WEEKLY/HOURLY or any RFC 5545 supported frequency, which is followed by start time of this window. You can control the start time with BYHOUR, BYMINUTE and BYSECONDS. It is followed by the interval size.
        """
    ...
    def custom_schedule(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class RepositorySettingMergeChecksArgsDict(TypedDict):
        last_build_succeeded: pulumi.Input[builtins.str]
        """
...
class RepositorySettingMergeChecksArgs:
    def __init__(__self__, *,
                 last_build_succeeded: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] last_build_succeeded: (Updatable) Indicates whether or not a pull request must have a successful build run and no queued builds before it can be merged
        """
        pulumi.set(__self__, "last_build_succeeded", last_build_succeeded)

    @property
    @pulumi.getter(name="lastBuildSucceeded")
    def last_build_succeeded(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) Indicates whether or not a pull request must have a successful build run and no queued builds before it can be merged
        """
    ...
    def last_build_succeeded(self, value: pulumi.Input[builtins.str]):
...
class TriggerActionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] build_pipeline_id: (Updatable) The OCID of the build pipeline to be triggered.
        :param pulumi.Input[builtins.str] type: (Updatable) The type of action that will be taken. Allowed value is TRIGGER_BUILD_PIPELINE.
        """
        pulumi.set(__self__, "build_pipeline_id", build_pipeline_id)
        pulumi.set(__self__, "type", type)
