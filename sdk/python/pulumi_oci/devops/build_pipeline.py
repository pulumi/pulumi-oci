...
class BuildPipelineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Optional description about the build pipeline.
        :param pulumi.Input[builtins.str] display_name: (Updatable) Build pipeline display name. Avoid entering confidential information.
...
class _BuildPipelineState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['BuildPipelineBuildPipelineParametersArgs'] build_pipeline_parameters: (Updatable) Specifies list of parameters present in a build pipeline. An UPDATE operation replaces the existing parameters list entirely.
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment where the build pipeline is created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] description: (Updatable) Optional description about the build pipeline.
        :param pulumi.Input[builtins.str] display_name: (Updatable) Build pipeline display name. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"bar-key": "value"}`
        ...
        :param pulumi.Input[builtins.str] project_id: The OCID of the DevOps project.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The current state of the build pipeline.
        ...
        :param pulumi.Input[builtins.str] time_created: The time the build pipeline was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param pulumi.Input[builtins.str] time_updated: The time the build pipeline was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        """
        if build_pipeline_parameters is not None:
            pulumi.set(__self__, "build_pipeline_parameters", build_pipeline_parameters)
...
class BuildPipeline(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'BuildPipeline':
        """
