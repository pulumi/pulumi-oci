...
class BuildPipelineStageArgs:
    def __init__(__self__, *,
                 ...
                 build_pipeline_stage_type: pulumi.Input[builtins.str],
                 ...
                 build_spec_file: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 is_pass_all_parameters_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 primary_build_source: Optional[pulumi.Input[builtins.str]] = None,
                 private_access_config: Optional[pulumi.Input['BuildPipelineStagePrivateAccessConfigArgs']] = None,
                 stage_execution_timeout_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] build_pipeline_stage_type: (Updatable) Defines the stage type, which is one of the following: BUILD, DELIVER_ARTIFACT, WAIT, and TRIGGER_DEPLOYMENT_PIPELINE.
        ...
        :param pulumi.Input[builtins.str] build_spec_file: (Updatable) The path to the build specification file for this environment. The default location of the file if not specified is build_spec.yaml.
        ...
        :param pulumi.Input[builtins.str] deploy_pipeline_id: (Updatable) A target deployment pipeline OCID that will run in this stage.
        :param pulumi.Input[builtins.str] description: (Updatable) Optional description about the stage.
        :param pulumi.Input[builtins.str] display_name: (Updatable) Stage display name, which can be renamed and is not necessarily unique. Avoid entering confidential information.
        ...
        :param pulumi.Input[builtins.str] image: (Updatable) Image name for the build environment
        :param pulumi.Input[builtins.bool] is_pass_all_parameters_enabled: (Updatable) A boolean flag that specifies whether all the parameters must be passed when the deployment is triggered.
        :param pulumi.Input[builtins.str] primary_build_source: (Updatable) Name of the build source where the build_spec.yml file is located. If not specified, the first entry in the build source collection is chosen as primary build source.
        ...
        :param pulumi.Input[builtins.int] stage_execution_timeout_in_seconds: (Updatable) Timeout for the build stage execution. Specify value in seconds.
    ...
    def build_pipeline_stage_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def build_pipeline_stage_type(self, value: pulumi.Input[builtins.str]):
    ...
    def build_spec_file(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def build_spec_file(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_pass_all_parameters_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_pass_all_parameters_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_pass_all_parameters_enabled", value)

    @property
    @pulumi.getter(name="primaryBuildSource")
    def primary_build_source(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def primary_build_source(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def stage_execution_timeout_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def stage_execution_timeout_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _BuildPipelineStageState:
    def __init__(__self__, *,
                 ...
                 build_pipeline_stage_type: Optional[pulumi.Input[builtins.str]] = None,
                 build_runner_shape_config: Optional[pulumi.Input['BuildPipelineStageBuildRunnerShapeConfigArgs']] = None,
                 build_source_collection: Optional[pulumi.Input['BuildPipelineStageBuildSourceCollectionArgs']] = None,
                 build_spec_file: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['BuildPipelineStageBuildSourceCollectionArgs'] build_source_collection: (Updatable) Collection of build sources.
        :param pulumi.Input[builtins.str] build_spec_file: (Updatable) The path to the build specification file for this environment. The default location of the file if not specified is build_spec.yaml.
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment where the pipeline is created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input['BuildPipelineStageDeliverArtifactCollectionArgs'] deliver_artifact_collection: (Updatable) Specifies an array of artifacts that need to be pushed to the artifactory stores.
        :param pulumi.Input[builtins.str] deploy_pipeline_id: (Updatable) A target deployment pipeline OCID that will run in this stage.
        :param pulumi.Input[builtins.str] description: (Updatable) Optional description about the stage.
        ...
        :param pulumi.Input[builtins.int] stage_execution_timeout_in_seconds: (Updatable) Timeout for the build stage execution. Specify value in seconds.
        :param pulumi.Input[builtins.str] state: The current state of the stage.
        ...
        :param pulumi.Input[builtins.str] time_created: The time the stage was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param pulumi.Input[builtins.str] time_updated: The time the stage was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param pulumi.Input['BuildPipelineStageWaitCriteriaArgs'] wait_criteria: (Updatable) Specifies wait criteria for the Wait stage.
        """
    ...
    @property
    @pulumi.getter(name="buildPipelineStageType")
    def build_pipeline_stage_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Defines the stage type, which is one of the following: BUILD, DELIVER_ARTIFACT, WAIT, and TRIGGER_DEPLOYMENT_PIPELINE.
        """
        return pulumi.get(self, "build_pipeline_stage_type")
    ...
    @build_pipeline_stage_type.setter
    def build_pipeline_stage_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "build_pipeline_stage_type", value)
...
class BuildPipelineStage(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="buildPipelineStageType")
    def build_pipeline_stage_type(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Defines the stage type, which is one of the following: BUILD, DELIVER_ARTIFACT, WAIT, and TRIGGER_DEPLOYMENT_PIPELINE.
        """
        return pulumi.get(self, "build_pipeline_stage_type")
    ...
    @property
    @pulumi.getter(name="buildSpecFile")
    def build_spec_file(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The path to the build specification file for this environment. The default location of the file if not specified is build_spec.yaml.
        """
        return pulumi.get(self, "build_spec_file")
    ...
    @property
    @pulumi.getter(name="isPassAllParametersEnabled")
    def is_pass_all_parameters_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) A boolean flag that specifies whether all the parameters must be passed when the deployment is triggered.
        """
        return pulumi.get(self, "is_pass_all_parameters_enabled")
    ...
    @property
    @pulumi.getter(name="primaryBuildSource")
    def primary_build_source(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Name of the build source where the build_spec.yml file is located. If not specified, the first entry in the build source collection is chosen as primary build source.
        """
        return pulumi.get(self, "primary_build_source")
    ...
    @property
    @pulumi.getter(name="stageExecutionTimeoutInSeconds")
    def stage_execution_timeout_in_seconds(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) Timeout for the build stage execution. Specify value in seconds.
        """
        return pulumi.get(self, "stage_execution_timeout_in_seconds")
