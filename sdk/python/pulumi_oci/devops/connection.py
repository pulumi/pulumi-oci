...
class ConnectionArgs:
    def __init__(__self__, *,
                 ...
                 app_password: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] connection_type: (Updatable) The type of connection.
        :param pulumi.Input[builtins.str] project_id: The OCID of the DevOps project.
        :param pulumi.Input[builtins.str] access_token: (Updatable) The OCID of personal access token saved in secret store.
        :param pulumi.Input[builtins.str] app_password: (Updatable) OCID of personal Bitbucket Cloud AppPassword saved in secret store
        :param pulumi.Input[builtins.str] base_url: (Updatable) The Base URL of the hosted BitbucketServer.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Optional description about the connection.
        :param pulumi.Input[builtins.str] display_name: (Updatable) Optional connection display name. Avoid entering confidential information.
        ...
        :param pulumi.Input[builtins.str] username: (Updatable) Public Bitbucket Cloud Username in plain text(not more than 30 characters)
    ...
    def app_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @app_password.setter
    def app_password(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ConnectionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] app_password: (Updatable) OCID of personal Bitbucket Cloud AppPassword saved in secret store
        :param pulumi.Input[builtins.str] base_url: (Updatable) The Base URL of the hosted BitbucketServer.
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment containing the connection.
        :param pulumi.Input[builtins.str] connection_type: (Updatable) The type of connection.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] description: (Updatable) Optional description about the connection.
        :param pulumi.Input[builtins.str] display_name: (Updatable) Optional connection display name. Avoid entering confidential information.
        ...
        :param pulumi.Input[builtins.str] time_created: The time the connection was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param pulumi.Input[builtins.str] time_updated: The time the connection was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param pulumi.Input['ConnectionTlsVerifyConfigArgs'] tls_verify_config: (Updatable) TLS configuration used by build service to verify TLS connection.
        :param pulumi.Input[builtins.str] username: (Updatable) Public Bitbucket Cloud Username in plain text(not more than 30 characters)
...
class Connection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            tls_verify_config: Optional[pulumi.Input[Union['ConnectionTlsVerifyConfigArgs', 'ConnectionTlsVerifyConfigArgsDict']]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'Connection':
        """
    ...
    @property
    @pulumi.getter(name="appPassword")
    def app_password(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) OCID of personal Bitbucket Cloud AppPassword saved in secret store
        """
        return pulumi.get(self, "app_password")
