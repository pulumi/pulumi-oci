    ...
    def __init__(__self__,
        ...
        test_deploy_artifact = oci.dev_ops.DeployArtifact("testDeployArtifact",
            ...
            deploy_artifact_source=oci.dev_ops.DeployArtifactDeployArtifactSourceArgs(
                deploy_artifact_source_type=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                base64encoded_content=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                chart_url=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                deploy_artifact_path=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                deploy_artifact_version=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                helm_verification_key_source=oci.dev_ops.DeployArtifactDeployArtifactSourceHelmVerificationKeySourceArgs(
                    verification_key_source_type=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                    current_public_key=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                    previous_public_key=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                    vault_secret_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                ),
