...
class DeployArtifactArgs:
    def __init__(__self__, *,
                 argument_substitution_mode: pulumi.Input[builtins.str],
                 deploy_artifact_source: pulumi.Input['DeployArtifactDeployArtifactSourceArgs'],
                 deploy_artifact_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] argument_substitution_mode: (Updatable) Mode for artifact parameter substitution. Options: `"NONE", "SUBSTITUTE_PLACEHOLDERS"` For Helm Deployments only "NONE" is supported.
        ...
        :param pulumi.Input[builtins.str] deploy_artifact_type: (Updatable) Type of the deployment artifact.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Optional description about the deployment artifact.
        :param pulumi.Input[builtins.str] display_name: (Updatable) Deployment artifact display name. Avoid entering confidential information.
    ...
    def argument_substitution_mode(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def argument_substitution_mode(self, value: pulumi.Input[builtins.str]):
    ...
    def deploy_artifact_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def deploy_artifact_type(self, value: pulumi.Input[builtins.str]):
...
class _DeployArtifactState:
    def __init__(__self__, *,
                 argument_substitution_mode: Optional[pulumi.Input[builtins.str]] = None,
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 deploy_artifact_source: Optional[pulumi.Input['DeployArtifactDeployArtifactSourceArgs']] = None,
                 deploy_artifact_type: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] argument_substitution_mode: (Updatable) Mode for artifact parameter substitution. Options: `"NONE", "SUBSTITUTE_PLACEHOLDERS"` For Helm Deployments only "NONE" is supported.
        :param pulumi.Input[builtins.str] compartment_id: The OCID of a compartment.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input['DeployArtifactDeployArtifactSourceArgs'] deploy_artifact_source: (Updatable) Specifies source of an artifact.
        :param pulumi.Input[builtins.str] deploy_artifact_type: (Updatable) Type of the deployment artifact.
        :param pulumi.Input[builtins.str] description: (Updatable) Optional description about the deployment artifact.
        :param pulumi.Input[builtins.str] display_name: (Updatable) Deployment artifact display name. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.str] lifecycle_details: A detailed message describing the current state. For example, can be used to provide actionable information for a resource in Failed state.
        :param pulumi.Input[builtins.str] project_id: The OCID of a project.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: Current state of the deployment artifact.
        ...
        :param pulumi.Input[builtins.str] time_created: Time the deployment artifact was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param pulumi.Input[builtins.str] time_updated: Time the deployment artifact was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        """
    ...
    @property
    @pulumi.getter(name="argumentSubstitutionMode")
    def argument_substitution_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Mode for artifact parameter substitution. Options: `"NONE", "SUBSTITUTE_PLACEHOLDERS"` For Helm Deployments only "NONE" is supported.
        """
        return pulumi.get(self, "argument_substitution_mode")
    ...
    @argument_substitution_mode.setter
    def argument_substitution_mode(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "argument_substitution_mode", value)
    ...
    @property
    @pulumi.getter(name="deployArtifactType")
    def deploy_artifact_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Type of the deployment artifact.
        """
        return pulumi.get(self, "deploy_artifact_type")
    ...
    @deploy_artifact_type.setter
    def deploy_artifact_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "deploy_artifact_type", value)
...
class DeployArtifact(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'DeployArtifact':
        """
    ...
    @property
    @pulumi.getter(name="argumentSubstitutionMode")
    def argument_substitution_mode(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Mode for artifact parameter substitution. Options: `"NONE", "SUBSTITUTE_PLACEHOLDERS"` For Helm Deployments only "NONE" is supported.
        """
        return pulumi.get(self, "argument_substitution_mode")
    ...
    @property
    @pulumi.getter(name="deployArtifactType")
    def deploy_artifact_type(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Type of the deployment artifact.
        """
        return pulumi.get(self, "deploy_artifact_type")
