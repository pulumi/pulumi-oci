...
class DeployEnvironment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_deploy_environment = oci.dev_ops.DeployEnvironment("testDeployEnvironment",
            ...
            compute_instance_group_selectors=oci.dev.ops.DeployEnvironmentComputeInstanceGroupSelectorsArgs(
                items=[oci.dev.ops.DeployEnvironmentComputeInstanceGroupSelectorsItemArgs(
            ...
            network_channel=oci.dev.ops.DeployEnvironmentNetworkChannelArgs(
