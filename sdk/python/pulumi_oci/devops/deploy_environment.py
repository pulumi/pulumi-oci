...
class DeployEnvironmentArgs:
    def __init__(__self__, *,
                 deploy_environment_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] deploy_environment_type: (Updatable) Deployment environment type.
        :param pulumi.Input[builtins.str] project_id: The OCID of a project.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] cluster_id: (Updatable) The OCID of the Kubernetes cluster.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Optional description about the deployment environment.
        :param pulumi.Input[builtins.str] display_name: (Updatable) Deployment environment display name. Avoid entering confidential information.
        ...
        :param pulumi.Input[builtins.str] function_id: (Updatable) The OCID of the Function.
    ...
    def deploy_environment_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def deploy_environment_type(self, value: pulumi.Input[builtins.str]):
...
class _DeployEnvironmentState:
    def __init__(__self__, *,
                 ...
                 compute_instance_group_selectors: Optional[pulumi.Input['DeployEnvironmentComputeInstanceGroupSelectorsArgs']] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 deploy_environment_type: Optional[pulumi.Input[builtins.str]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 function_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] project_id: The OCID of a project.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The current state of the deployment environment.
        ...
        :param pulumi.Input[builtins.str] time_created: Time the deployment environment was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param pulumi.Input[builtins.str] time_updated: Time the deployment environment was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        """
        if cluster_id is not None:
            pulumi.set(__self__, "cluster_id", cluster_id)
    ...
    @property
    @pulumi.getter(name="deployEnvironmentType")
    def deploy_environment_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Deployment environment type.
        """
        return pulumi.get(self, "deploy_environment_type")
    ...
    @deploy_environment_type.setter
    def deploy_environment_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "deploy_environment_type", value)
...
class DeployEnvironment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'DeployEnvironment':
        """
    ...
    @property
    @pulumi.getter(name="deployEnvironmentType")
    def deploy_environment_type(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Deployment environment type.
        """
        return pulumi.get(self, "deploy_environment_type")
