...
class DeployPipelineArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Optional description about the deployment pipeline.
...
class _DeployPipelineState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] project_id: The OCID of a project.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The current state of the deployment pipeline.
        ...
        :param pulumi.Input[builtins.str] time_created: Time the deployment pipeline was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param pulumi.Input[builtins.str] time_updated: Time the deployment pipeline was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        """
...
class DeployPipeline(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'DeployPipeline':
        """
