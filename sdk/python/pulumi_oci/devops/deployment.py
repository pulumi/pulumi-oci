...
class DeploymentArgs:
    def __init__(__self__, *,
                 ...
                 deploy_stage_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 previous_deployment_id: Optional[pulumi.Input[builtins.str]] = None,
                 trigger_new_devops_deployment: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a Deployment resource.
        :param pulumi.Input[builtins.str] deploy_pipeline_id: The OCID of a pipeline.
        :param pulumi.Input[builtins.str] deployment_type: (Updatable) Specifies type for this deployment.
        ...
        :param pulumi.Input[builtins.str] deploy_stage_id: Specifies the OCID of the stage to be redeployed.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) Deployment display name. Avoid entering confidential information.
    ...
    def deploy_stage_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def deploy_stage_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def previous_deployment_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def previous_deployment_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "previous_deployment_id", value)

    @property
    @pulumi.getter(name="triggerNewDevopsDeployment")
    def trigger_new_devops_deployment(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        A boolean specifying if a new deployment should be created on every apply. As long as this value is set to true in the config, every apply will trigger a new deployment to be created. The existing deployment resource will be replaced with the new one in the state file (deployment resources are never deleted, they persist as a store of records, but your state file will only track the latest one created with this resource block). 
    ...
    def trigger_new_devops_deployment(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _DeploymentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] time_created: Time the deployment was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param pulumi.Input[builtins.str] time_updated: Time the deployment was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param pulumi.Input[builtins.bool] trigger_new_devops_deployment: A boolean specifying if a new deployment should be created on every apply. As long as this value is set to true in the config, every apply will trigger a new deployment to be created. The existing deployment resource will be replaced with the new one in the state file (deployment resources are never deleted, they persist as a store of records, but your state file will only track the latest one created with this resource block). 
...
@pulumi.type_token("oci:DevOps/deployment:Deployment")
class Deployment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            trigger_new_devops_deployment: Optional[pulumi.Input[builtins.bool]] = None) -> 'Deployment':
        """
    ...
    @property
    @pulumi.getter(name="deployStageId")
    def deploy_stage_id(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the OCID of the stage to be redeployed.
        """
        return pulumi.get(self, "deploy_stage_id")
    ...
    @property
    @pulumi.getter(name="previousDeploymentId")
    def previous_deployment_id(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the OCID of the previous deployment to be redeployed.
        """
        return pulumi.get(self, "previous_deployment_id")
    ...
    @property
    @pulumi.getter(name="triggerNewDevopsDeployment")
    def trigger_new_devops_deployment(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        A boolean specifying if a new deployment should be created on every apply. As long as this value is set to true in the config, every apply will trigger a new deployment to be created. The existing deployment resource will be replaced with the new one in the state file (deployment resources are never deleted, they persist as a store of records, but your state file will only track the latest one created with this resource block). 
