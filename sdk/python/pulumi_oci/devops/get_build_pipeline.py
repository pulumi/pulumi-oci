...
def get_build_pipeline(build_pipeline_id: Optional[_builtins.str] = None,
...
def get_build_pipeline_output(build_pipeline_id: Optional[pulumi.Input[_builtins.str]] = None,
