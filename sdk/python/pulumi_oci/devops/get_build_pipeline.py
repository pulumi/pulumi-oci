...
class GetBuildPipelineResult:
    ...
    def build_pipeline_id(self) -> builtins.str:
...
def get_build_pipeline(build_pipeline_id: Optional[builtins.str] = None,
    ...
    :param builtins.str build_pipeline_id: Unique build pipeline identifier.
    """
    __args__ = dict()
...
def get_build_pipeline_output(build_pipeline_id: Optional[pulumi.Input[builtins.str]] = None,
