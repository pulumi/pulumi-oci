...
def get_build_pipeline(build_pipeline_id: Optional[str] = None,
    ...
    test_build_pipeline = oci.DevOps.get_build_pipeline(build_pipeline_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
    ```
