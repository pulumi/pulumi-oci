...
class GetBuildPipelineStageResult:
    ...
    def build_pipeline_stage_id(self) -> _builtins.str:
...
def get_build_pipeline_stage(build_pipeline_stage_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str build_pipeline_stage_id: Unique stage identifier.
    """
    __args__ = dict()
...
def get_build_pipeline_stage_output(build_pipeline_stage_id: Optional[pulumi.Input[_builtins.str]] = None,
