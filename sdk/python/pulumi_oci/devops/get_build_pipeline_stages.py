...
def get_build_pipeline_stages(build_pipeline_id: Optional[builtins.str] = None,
...
def get_build_pipeline_stages_output(build_pipeline_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
