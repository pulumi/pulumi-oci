...
class GetBuildRunResult:
    ...
    def build_run_id(self) -> _builtins.str:
...
def get_build_run(build_run_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str build_run_id: Unique build run identifier.
    """
    __args__ = dict()
