...
class GetBuildRunResult:
    ...
    def build_run_id(self) -> builtins.str:
...
def get_build_run(build_run_id: Optional[builtins.str] = None,
    ...
    :param builtins.str build_run_id: Unique build run identifier.
    """
    __args__ = dict()
...
def get_build_run_output(build_run_id: Optional[pulumi.Input[builtins.str]] = None,
