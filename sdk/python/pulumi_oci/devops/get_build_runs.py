...
class GetBuildRunsResult:
    ...
    def build_pipeline_id(self) -> Optional[builtins.str]:
        """
...
def get_build_runs(build_pipeline_id: Optional[builtins.str] = None,
    ...
    :param builtins.str state: A filter to return only build runs that matches the given lifecycle state.
    """
    __args__ = dict()
...
def get_build_runs_output(build_pipeline_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
