...
def get_connections(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str connection_type: A filter to return only resources that match the given connection type.
    ...
    :param builtins.str state: A filter to return only connections that matches the given lifecycle state.
    """
    __args__ = dict()
...
def get_connections_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           connection_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
