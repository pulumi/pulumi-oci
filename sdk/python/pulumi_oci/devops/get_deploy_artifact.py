...
class GetDeployArtifactResult:
    ...
    def argument_substitution_mode(self) -> builtins.str:
        """
    ...
    def deploy_artifact_id(self) -> builtins.str:
    ...
    def deploy_artifact_type(self) -> builtins.str:
        """
...
def get_deploy_artifact(deploy_artifact_id: Optional[builtins.str] = None,
    ...
    :param builtins.str deploy_artifact_id: Unique artifact identifier.
    """
    __args__ = dict()
...
def get_deploy_artifact_output(deploy_artifact_id: Optional[pulumi.Input[builtins.str]] = None,
