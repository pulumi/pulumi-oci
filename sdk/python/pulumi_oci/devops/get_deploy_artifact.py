...
def get_deploy_artifact(deploy_artifact_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str deploy_artifact_id: Unique artifact identifier.
    """
    __args__ = dict()
...
def get_deploy_artifact_output(deploy_artifact_id: Optional[pulumi.Input[_builtins.str]] = None,
