...
def get_deploy_pipeline(deploy_pipeline_id: Optional[builtins.str] = None,
    ...
    :param builtins.str deploy_pipeline_id: Unique pipeline identifier.
    """
    __args__ = dict()
...
def get_deploy_pipeline_output(deploy_pipeline_id: Optional[pulumi.Input[builtins.str]] = None,
