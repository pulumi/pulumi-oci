...
def get_deploy_stage(deploy_stage_id: Optional[builtins.str] = None,
    ...
    :param builtins.str deploy_stage_id: Unique stage identifier.
    """
    __args__ = dict()
...
def get_deploy_stage_output(deploy_stage_id: Optional[pulumi.Input[builtins.str]] = None,
