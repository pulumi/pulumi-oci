...
def get_projects(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str state: A filter to return only Projects that matches the given lifecycleState.
    """
    __args__ = dict()
...
def get_projects_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
