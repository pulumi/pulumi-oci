...
def get_repo_file_line(file_path: Optional[str] = None,
    ...
    test_repo_file_line = oci.DevOps.get_repo_file_line(repository_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    :param str file_path: (Required) A filter to return file contents of the specified paths.
...
@_utilities.lift_output_func(get_repo_file_line)
