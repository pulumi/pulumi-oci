...
__all__ = [
    'GetRepoFileLineResult',
    'AwaitableGetRepoFileLineResult',
    'get_repo_file_line',
    'get_repo_file_line_output',
]

@pulumi.output_type
class GetRepoFileLineResult:
    """
    ...
    @property
    @pulumi.getter
    def lines(self) -> Sequence['outputs.GetRepoFileLineLineResult']:
        """
...
class AwaitableGetRepoFileLineResult(GetRepoFileLineResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetRepoFileLineResult(
...
def get_repo_file_line(file_path: Optional[builtins.str] = None,
                       repository_id: Optional[builtins.str] = None,
                       revision: Optional[builtins.str] = None,
                       start_line_number: Optional[builtins.int] = None,
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetRepoFileLineResult:
    """
    ...
    :param builtins.str file_path: (Required) A filter to return file contents of the specified paths.
    :param builtins.str repository_id: Unique repository identifier.
    :param builtins.str revision: Retrieve file lines from specific revision.
    :param builtins.int start_line_number: Line number from where to start returning file lines.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('oci:DevOps/getRepoFileLine:getRepoFileLine', __args__, opts=opts, typ=GetRepoFileLineResult).value

    return AwaitableGetRepoFileLineResult(
...
def get_repo_file_line_output(file_path: Optional[pulumi.Input[builtins.str]] = None,
                              repository_id: Optional[pulumi.Input[builtins.str]] = None,
                              revision: Optional[pulumi.Input[builtins.str]] = None,
                              start_line_number: Optional[pulumi.Input[Optional[builtins.int]]] = None,
