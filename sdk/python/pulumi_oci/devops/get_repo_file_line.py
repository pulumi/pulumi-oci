...
def get_repo_file_line(file_path: Optional[_builtins.str] = None,
    ...
    :param _builtins.str file_path: (Required) A filter to return file contents of the specified paths.
    :param _builtins.str repository_id: Unique repository identifier.
    :param _builtins.str revision: Retrieve file lines from specific revision.
    :param _builtins.int start_line_number: Line number from where to start returning file lines.
    """
    __args__ = dict()
...
def get_repo_file_line_output(file_path: Optional[pulumi.Input[_builtins.str]] = None,
