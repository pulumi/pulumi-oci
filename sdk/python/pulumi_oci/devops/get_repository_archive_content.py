...
def get_repository_archive_content(format: Optional[_builtins.str] = None,
    ...
    :param _builtins.str format: The archive format query parameter for downloading repository endpoint.
