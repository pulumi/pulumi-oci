...
def get_repository_archive_content(format: Optional[builtins.str] = None,
    ...
    :param builtins.str format: The archive format query parameter for downloading repository endpoint.
...
def get_repository_archive_content_output(format: Optional[pulumi.Input[Optional[builtins.str]]] = None,
