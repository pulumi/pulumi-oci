...
class GetRepositoryAuthorResult:
    ...
    def ref_name(self) -> Optional[builtins.str]:
...
def get_repository_author(ref_name: Optional[builtins.str] = None,
    ...
    :param builtins.str ref_name: A filter to return only resources that match the given reference name.
...
def get_repository_author_output(ref_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
