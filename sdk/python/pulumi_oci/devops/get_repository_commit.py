...
def get_repository_commit(commit_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str commit_id: A filter to return only resources that match the given commit ID.
