...
def get_repository_commit(commit_id: Optional[builtins.str] = None,
    ...
    :param builtins.str commit_id: A filter to return only resources that match the given commit ID.
...
def get_repository_commit_output(commit_id: Optional[pulumi.Input[builtins.str]] = None,
