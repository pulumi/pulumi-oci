...
class GetRepositoryCommitsResult:
    ...
    def exclude_ref_name(self) -> Optional[_builtins.str]:
    ...
    def timestamp_less_than_or_equal_to(self) -> Optional[_builtins.str]:
...
def get_repository_commits(author_name: Optional[_builtins.str] = None,
                           commit_message: Optional[_builtins.str] = None,
                           exclude_ref_name: Optional[_builtins.str] = None,
                           file_path: Optional[_builtins.str] = None,
                           filters: Optional[Sequence[Union['GetRepositoryCommitsFilterArgs', 'GetRepositoryCommitsFilterArgsDict', 'outputs.GetRepositoryCommitsFilterResult']]] = None,
                           ...
                           timestamp_less_than_or_equal_to: Optional[_builtins.str] = None,
    ...
    :param _builtins.str exclude_ref_name: A filter to exclude commits that match the given reference name.
    ...
    :param _builtins.str timestamp_greater_than_or_equal_to: A filter to return commits only created after the specified timestamp value.
    :param _builtins.str timestamp_less_than_or_equal_to: A filter to return commits only created before the specified timestamp value.
    """
    __args__ = dict()
...
def get_repository_commits_output(author_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                  ...
                                  filters: pulumi.Input[Optional[Optional[Sequence[Union['GetRepositoryCommitsFilterArgs', 'GetRepositoryCommitsFilterArgsDict', 'outputs.GetRepositoryCommitsFilterResult']]]]] = None,
