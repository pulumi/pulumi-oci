...
class GetRepositoryCommitsResult:
    ...
    def exclude_ref_name(self) -> Optional[builtins.str]:
    ...
    def timestamp_less_than_or_equal_to(self) -> Optional[builtins.str]:
...
def get_repository_commits(author_name: Optional[builtins.str] = None,
                           commit_message: Optional[builtins.str] = None,
                           exclude_ref_name: Optional[builtins.str] = None,
    ...
    :param builtins.str exclude_ref_name: A filter to exclude commits that match the given reference name.
    ...
    :param builtins.str timestamp_greater_than_or_equal_to: A filter to return commits only created after the specified timestamp value.
    :param builtins.str timestamp_less_than_or_equal_to: A filter to return commits only created before the specified timestamp value.
    """
    __args__ = dict()
...
def get_repository_commits_output(author_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  commit_message: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  exclude_ref_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  file_path: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  ...
                                  ref_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  ...
                                  timestamp_less_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
