...
def get_repository_diff(base_version: Optional[_builtins.str] = None,
    ...
    :param _builtins.str file_path: Path to a file within a repository.
...
def get_repository_diff_output(base_version: Optional[pulumi.Input[_builtins.str]] = None,
