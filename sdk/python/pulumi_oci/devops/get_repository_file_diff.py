...
def get_repository_file_diff(base_version: Optional[builtins.str] = None,
...
def get_repository_file_diff_output(base_version: Optional[pulumi.Input[builtins.str]] = None,
