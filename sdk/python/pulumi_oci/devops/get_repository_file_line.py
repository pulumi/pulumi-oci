...
def get_repository_file_line(file_path: Optional[_builtins.str] = None,
    ...
    :param _builtins.str file_path: A filter to return file contents of the specified paths.
