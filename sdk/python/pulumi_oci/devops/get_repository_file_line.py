...
def get_repository_file_line(file_path: Optional[builtins.str] = None,
    ...
    :param builtins.str file_path: A filter to return file contents of the specified paths.
...
def get_repository_file_line_output(file_path: Optional[pulumi.Input[builtins.str]] = None,
