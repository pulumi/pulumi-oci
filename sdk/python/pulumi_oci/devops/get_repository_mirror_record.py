...
class GetRepositoryMirrorRecordResult:
    ...
    def mirror_record_type(self) -> _builtins.str:
...
def get_repository_mirror_record(mirror_record_type: Optional[_builtins.str] = None,
    ...
    :param _builtins.str mirror_record_type: The field of mirror record type. Only one mirror record type can be provided: current - The current mirror record. lastSuccessful - The last successful mirror record.
