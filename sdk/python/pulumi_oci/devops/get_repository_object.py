...
def get_repository_object(file_path: Optional[builtins.str] = None,
...
def get_repository_object_output(file_path: Optional[pulumi.Input[Optional[builtins.str]]] = None,
