...
def get_repository_path(display_name: Optional[builtins.str] = None,
...
def get_repository_path_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
