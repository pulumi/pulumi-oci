...
class GetRepositoryPathsResult:
    ...
    def paths_in_subtree(self) -> Optional[builtins.bool]:
...
def get_repository_paths(display_name: Optional[builtins.str] = None,
                         ...
                         paths_in_subtree: Optional[builtins.bool] = None,
    ...
    :param builtins.str folder_path: The fully qualified path to the folder whose contents are returned, including the folder name. For example, /examples is a fully-qualified path to a folder named examples that was created off of the root directory (/) of a repository.
    :param builtins.bool paths_in_subtree: Flag to determine if files must be retrived recursively. Flag is False by default.
    :param builtins.str ref: The name of branch/tag or commit hash it points to. If names conflict, order of preference is commit > branch > tag. You can disambiguate with "heads/foobar" and "tags/foobar". If left blank repository's default branch will be used.
...
def get_repository_paths_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                filters: Optional[pulumi.Input[Optional[Sequence[Union['GetRepositoryPathsFilterArgs', 'GetRepositoryPathsFilterArgsDict']]]]] = None,
                                folder_path: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                paths_in_subtree: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
