...
def get_repository_setting(repository_id: Optional[builtins.str] = None,
...
def get_repository_setting_output(repository_id: Optional[pulumi.Input[builtins.str]] = None,
