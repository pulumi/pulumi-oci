...
class BuildPipelineBuildPipelineParametersItem(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str default_value: (Updatable) Default value of the parameter.
        :param builtins.str name: (Updatable) Name of the parameter (case-sensitive). Parameter name must be ^[a-zA-Z][a-zA-Z_0-9]*$. Example: 'Build_Pipeline_param' is not same as 'build_pipeline_Param'
        :param builtins.str description: (Updatable) Description of the parameter.
        """
...
class BuildPipelineStageBuildPipelineStagePredecessorCollectionItem(dict):
    def __init__(__self__, *,
                 id: builtins.str):
        """
        :param builtins.str id: (Updatable) The OCID of the predecessor stage. If a stage is the first stage in the pipeline, then the ID is the pipeline's OCID.
        """
...
class BuildPipelineStageBuildRunnerShapeConfig(dict):
    ...
    def __init__(__self__, *,
                 build_runner_type: builtins.str,
                 memory_in_gbs: Optional[builtins.int] = None,
                 ocpus: Optional[builtins.int] = None):
        """
        :param builtins.str build_runner_type: (Updatable) Name of the build runner shape in which the execution occurs. If not specified, the default shape is chosen.
        :param builtins.int memory_in_gbs: (Updatable) The total amount of memory set for the instance in gigabytes.
        :param builtins.int ocpus: (Updatable) The total number of OCPUs set for the instance.
        """
    ...
    def build_runner_type(self) -> builtins.str:
        """
...
class BuildPipelineStageBuildSourceCollectionItem(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str connection_type: (Updatable) The type of source provider.
        :param builtins.str branch: (Updatable) Branch name.
        :param builtins.str connection_id: (Updatable) Connection identifier pertinent to Bitbucket Server source provider
        :param builtins.str name: (Updatable) Name of the build source. This must be unique within a build source collection. The name can be used by customers to locate the working directory pertinent to this repository.
        :param builtins.str repository_id: (Updatable) The DevOps code repository ID.
        :param builtins.str repository_url: (Updatable) URL for the repository.
        """
...
class BuildPipelineStageDeliverArtifactCollectionItem(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str artifact_id: (Updatable) Artifact identifier that contains the artifact definition.
        :param builtins.str artifact_name: (Updatable) Name of the artifact specified in the build_spec.yaml file.
        """
...
class BuildPipelineStagePrivateAccessConfig(dict):
    ...
    def __init__(__self__, *,
                 network_channel_type: builtins.str,
                 subnet_id: builtins.str,
                 nsg_ids: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str network_channel_type: (Updatable) Network channel type.
        :param builtins.str subnet_id: (Updatable) The OCID of the subnet where VNIC resources will be created for private endpoint.
        :param Sequence[builtins.str] nsg_ids: (Updatable) An array of network security group OCIDs.
        """
    ...
    def network_channel_type(self) -> builtins.str:
        """
...
class BuildPipelineStageWaitCriteria(dict):
    ...
    def __init__(__self__, *,
                 wait_duration: builtins.str,
                 wait_type: builtins.str):
        """
        :param builtins.str wait_duration: (Updatable) The absolute wait duration. Minimum wait duration must be 5 seconds. Maximum wait duration can be up to 2 days.
        :param builtins.str wait_type: (Updatable) Wait criteria type.
    ...
    def wait_duration(self) -> builtins.str:
        """
    ...
    def wait_type(self) -> builtins.str:
        """
...
class BuildRunBuildOutputArtifactOverrideParameterItem(dict):
    ...
    def __init__(__self__, *,
                 deploy_artifact_id: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str deploy_artifact_id: The OCID of the deployment artifact definition.
        :param builtins.str name: Name of the step.
        :param builtins.str value: Value of the argument.
        """
    ...
    def deploy_artifact_id(self) -> Optional[builtins.str]:
        """
...
class BuildRunBuildOutputDeliveredArtifactItem(dict):
    ...
    def __init__(__self__, *,
                 artifact_repository_id: Optional[builtins.str] = None,
                 artifact_type: Optional[builtins.str] = None,
                 delivered_artifact_hash: Optional[builtins.str] = None,
                 delivered_artifact_id: Optional[builtins.str] = None,
                 deploy_artifact_id: Optional[builtins.str] = None,
                 image_uri: Optional[builtins.str] = None,
                 output_artifact_name: Optional[builtins.str] = None,
                 path: Optional[builtins.str] = None,
                 version: Optional[builtins.str] = None):
        """
        :param builtins.str artifact_repository_id: The OCID of the artifact registry repository used by the DeliverArtifactStage
        :param builtins.str artifact_type: Type of artifact delivered.
        :param builtins.str delivered_artifact_hash: The hash of the container registry artifact pushed by the Deliver Artifacts stage.
        :param builtins.str delivered_artifact_id: The OCID of the artifact pushed by the Deliver Artifacts stage.
        :param builtins.str deploy_artifact_id: The OCID of the deployment artifact definition.
        :param builtins.str image_uri: The imageUri of the OCIR artifact pushed by the DeliverArtifactStage
        :param builtins.str output_artifact_name: Name of the output artifact defined in the build specification file.
        :param builtins.str path: Path of the repository where artifact was pushed
        :param builtins.str version: Version of the artifact pushed
        """
    ...
    def artifact_repository_id(self) -> Optional[builtins.str]:
        """
    ...
    def delivered_artifact_hash(self) -> Optional[builtins.str]:
        """
    ...
    def delivered_artifact_id(self) -> Optional[builtins.str]:
        """
    ...
    def output_artifact_name(self) -> Optional[builtins.str]:
        """
...
class BuildRunBuildOutputVulnerabilityAuditSummaryCollectionItem(dict):
    ...
    def __init__(__self__, *,
                 build_stage_id: Optional[builtins.str] = None,
                 commit_hash: Optional[builtins.str] = None,
                 vulnerability_audit_id: Optional[builtins.str] = None):
        """
        :param builtins.str build_stage_id: Build stage OCID where scan was configured.
        :param builtins.str commit_hash: Commit hash pertinent to the repository URL and the specified branch.
        :param builtins.str vulnerability_audit_id: The OCID of the vulnerability audit.
        """
    ...
    def build_stage_id(self) -> Optional[builtins.str]:
        """
    ...
    def commit_hash(self) -> Optional[builtins.str]:
        """
    ...
    def vulnerability_audit_id(self) -> Optional[builtins.str]:
        """
...
class BuildRunBuildRunArgumentsItem(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: Name of the parameter (case-sensitive). Parameter name must be ^[a-zA-Z][a-zA-Z_0-9]*$. Example: 'Build_Pipeline_param' is not same as 'build_pipeline_Param'
        :param builtins.str value: Value of the argument.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class BuildRunBuildRunProgress(dict):
    ...
    def __init__(__self__, *,
                 build_pipeline_stage_run_progress: Optional[Mapping[str, builtins.str]] = None,
                 time_finished: Optional[builtins.str] = None,
                 time_started: Optional[builtins.str] = None):
        """
        :param Mapping[str, builtins.str] build_pipeline_stage_run_progress: Map of stage OCIDs to build pipeline stage run progress model.
        :param builtins.str time_finished: The time the build run finished. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param builtins.str time_started: The time the build run started. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        """
    ...
    def build_pipeline_stage_run_progress(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class BuildRunBuildRunSource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str repository_id: The DevOps code repository identifier that invoked the build run.
        :param builtins.str source_type: The source from which the build run is triggered.
        :param builtins.str trigger_id: The trigger that invoked the build run.
...
class BuildRunBuildRunSourceTriggerInfo(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str display_name: (Updatable) Build run display name, which can be renamed and is not necessarily unique. Avoid entering confidential information.
        """
...
class BuildRunBuildRunSourceTriggerInfoAction(dict):
    ...
    def __init__(__self__, *,
                 build_pipeline_id: Optional[builtins.str] = None,
                 filters: Optional[Sequence['outputs.BuildRunBuildRunSourceTriggerInfoActionFilter']] = None,
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str build_pipeline_id: The OCID of the build pipeline.
        :param builtins.str type: The type of action that will be taken. Allowed value is TRIGGER_BUILD_PIPELINE.
        """
...
class BuildRunBuildRunSourceTriggerInfoActionFilter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] events: The events, for example, PUSH, PULL_REQUEST_CREATED, PULL_REQUEST_UPDATED.
        ...
        :param builtins.str trigger_source: Source of the trigger. Allowed values are, GITHUB and GITLAB.
        """
...
class BuildRunBuildRunSourceTriggerInfoActionFilterExcludeFileFilter(dict):
    ...
    def __init__(__self__, *,
                 file_paths: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] file_paths: The file paths/glob pattern for files.
        """
    ...
    def file_paths(self) -> Optional[Sequence[builtins.str]]:
        """
...
class BuildRunBuildRunSourceTriggerInfoActionFilterInclude(dict):
    ...
    def __init__(__self__, *,
                 base_ref: Optional[builtins.str] = None,
                 file_filters: Optional[Sequence['outputs.BuildRunBuildRunSourceTriggerInfoActionFilterIncludeFileFilter']] = None,
                 head_ref: Optional[builtins.str] = None,
                 repository_name: Optional[builtins.str] = None):
        """
        :param builtins.str base_ref: The target branch for pull requests; not applicable for push requests.
        ...
        :param builtins.str head_ref: Branch for push event; source branch for pull requests.
        :param builtins.str repository_name: The repository name for trigger events.
        """
    ...
    def base_ref(self) -> Optional[builtins.str]:
        """
    ...
    def head_ref(self) -> Optional[builtins.str]:
        """
...
class BuildRunCommitInfo(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str commit_hash: Commit hash pertinent to the repository URL and the specified branch.
        :param builtins.str repository_branch: Name of the repository branch.
...
class ConnectionLastConnectionValidationResult(dict):
    ...
    def __init__(__self__, *,
                 ...
                 time_validated: Optional[builtins.str] = None):
        """
        :param builtins.str message: A message describing the result of connection validation in more detail.
        :param builtins.str result: The latest result of whether the credentials pass the validation.
        :param builtins.str time_validated: The latest timestamp when the connection was validated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        """
    ...
    def time_validated(self) -> Optional[builtins.str]:
        """
...
class ConnectionTlsVerifyConfig(dict):
    ...
    def __init__(__self__, *,
                 ca_certificate_bundle_id: builtins.str,
                 tls_verify_mode: builtins.str):
        """
        :param builtins.str ca_certificate_bundle_id: (Updatable) The OCID of Oracle Cloud Infrastructure certificate service CA bundle.
        :param builtins.str tls_verify_mode: (Updatable) The type of TLS verification.
        """
    ...
    def ca_certificate_bundle_id(self) -> builtins.str:
        """
    ...
    def tls_verify_mode(self) -> builtins.str:
        """
...
class DeployArtifactDeployArtifactSource(dict):
    ...
    def __init__(__self__, *,
                 deploy_artifact_source_type: builtins.str,
                 base64encoded_content: Optional[builtins.str] = None,
                 chart_url: Optional[builtins.str] = None,
                 deploy_artifact_path: Optional[builtins.str] = None,
                 deploy_artifact_version: Optional[builtins.str] = None,
                 helm_artifact_source_type: Optional[builtins.str] = None,
                 ...
                 repository_id: Optional[builtins.str] = None):
        """
        :param builtins.str deploy_artifact_source_type: (Updatable) Specifies types of artifact sources.
        :param builtins.str base64encoded_content: (Updatable) The Helm commands to be executed, base 64 encoded
        :param builtins.str chart_url: (Updatable) The URL of an OCIR repository.
        :param builtins.str deploy_artifact_path: (Updatable) Specifies the artifact path in the repository.
        :param builtins.str deploy_artifact_version: (Updatable) Users can set this as a placeholder value that refers to a pipeline parameter, for example, ${appVersion}.
        :param builtins.str helm_artifact_source_type: (Updatable) Specifies types of artifact sources.
        ...
        :param builtins.str image_digest: (Updatable) Specifies image digest for the version of the image.
        :param builtins.str image_uri: (Updatable) Specifies OCIR Image Path - optionally include tag.
        :param builtins.str repository_id: (Updatable) The OCID of a repository
        """
    ...
    def deploy_artifact_source_type(self) -> builtins.str:
        """
    ...
    def base64encoded_content(self) -> Optional[builtins.str]:
        """
    ...
    def chart_url(self) -> Optional[builtins.str]:
        """
    ...
    def deploy_artifact_path(self) -> Optional[builtins.str]:
        """
    ...
    def deploy_artifact_version(self) -> Optional[builtins.str]:
        """
    ...
    def helm_artifact_source_type(self) -> Optional[builtins.str]:
        """
        (Updatable) Specifies types of artifact sources.
        """
...
class DeployArtifactDeployArtifactSourceHelmVerificationKeySource(dict):
    ...
    def __init__(__self__, *,
                 verification_key_source_type: builtins.str,
                 current_public_key: Optional[builtins.str] = None,
                 previous_public_key: Optional[builtins.str] = None,
                 vault_secret_id: Optional[builtins.str] = None):
        """
        :param builtins.str verification_key_source_type: (Updatable) Specifies type of verification material.
        :param builtins.str current_public_key: (Updatable) Current version of Base64 encoding of the public key which is in binary GPG exported format.
        :param builtins.str previous_public_key: (Updatable) Previous version of Base64 encoding of the public key which is in binary GPG exported format. This would be used for key rotation scenarios.
        :param builtins.str vault_secret_id: (Updatable) The OCID of the Vault Secret containing the verification key versions.
        """
    ...
    def verification_key_source_type(self) -> builtins.str:
        """
    ...
    def current_public_key(self) -> Optional[builtins.str]:
        """
    ...
    def previous_public_key(self) -> Optional[builtins.str]:
        """
...
class DeployEnvironmentComputeInstanceGroupSelectorsItem(dict):
    ...
    def __init__(__self__, *,
                 selector_type: builtins.str,
                 compute_instance_ids: Optional[Sequence[builtins.str]] = None,
                 query: Optional[builtins.str] = None,
                 region: Optional[builtins.str] = None):
        """
        :param builtins.str selector_type: (Updatable) Defines the type of the instance selector for the group.
        :param Sequence[builtins.str] compute_instance_ids: (Updatable) Compute instance OCID identifiers that are members of this group.
        :param builtins.str query: (Updatable) Query expression confirming to the Oracle Cloud Infrastructure Search Language syntax to select compute instances for the group. The language is documented at https://docs.oracle.com/en-us/iaas/Content/Search/Concepts/querysyntax.htm
        :param builtins.str region: (Updatable) Region identifier referred by the deployment environment. Region identifiers are listed at https://docs.oracle.com/en-us/iaas/Content/General/Concepts/regions.htm
        """
    ...
    def selector_type(self) -> builtins.str:
        """
    ...
    def compute_instance_ids(self) -> Optional[Sequence[builtins.str]]:
        """
...
class DeployPipelineDeployPipelineArtifactItem(dict):
    ...
    def __init__(__self__, *,
                 ...
                 display_name: Optional[builtins.str] = None):
        """
        :param builtins.str deploy_artifact_id: The OCID of an artifact
        :param Sequence['DeployPipelineDeployPipelineArtifactItemDeployPipelineStageArgs'] deploy_pipeline_stages: List of stages.
        :param builtins.str display_name: (Updatable) Deployment pipeline display name. Avoid entering confidential information.
        """
        if deploy_artifact_id is not None:
            pulumi.set(__self__, "deploy_artifact_id", deploy_artifact_id)
...
class DeployPipelineDeployPipelineArtifactItemDeployPipelineStageItem(dict):
    ...
    def __init__(__self__, *,
                 deploy_stage_id: Optional[builtins.str] = None,
                 display_name: Optional[builtins.str] = None):
        """
        :param builtins.str deploy_stage_id: The OCID of a stage
        :param builtins.str display_name: (Updatable) Deployment pipeline display name. Avoid entering confidential information.
        """
    ...
    def deploy_stage_id(self) -> Optional[builtins.str]:
        """
        The OCID of a stage
        """
...
class DeployPipelineDeployPipelineEnvironmentItem(dict):
    ...
    def deploy_environment_id(self) -> Optional[builtins.str]:
        """
...
class DeployPipelineDeployPipelineParametersItem(dict):
    ...
    def __init__(__self__, *,
                 ...
                 description: Optional[builtins.str] = None):
        """
        :param builtins.str name: (Updatable) Name of the parameter (case-sensitive). Parameter name must be ^[a-zA-Z][a-zA-Z_0-9]*$.
        :param builtins.str default_value: (Updatable) Default value of the parameter.
        :param builtins.str description: (Updatable) Description of the parameter.
        """
        pulumi.set(__self__, "name", name)
...
class DeployStageApprovalPolicy(dict):
    ...
    def __init__(__self__, *,
                 approval_policy_type: builtins.str,
                 number_of_approvals_required: builtins.int):
        """
        :param builtins.str approval_policy_type: (Updatable) Approval policy type.
        :param builtins.int number_of_approvals_required: (Updatable) A minimum number of approvals required for stage to proceed.
        """
    ...
    def approval_policy_type(self) -> builtins.str:
        """
    ...
    def number_of_approvals_required(self) -> builtins.int:
        """
...
class DeployStageBlueBackendIps(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] items: (Updatable) The IP address of the backend server. A server could be a compute instance or a load balancer.
        """
        if items is not None:
            pulumi.set(__self__, "items", items)
...
class DeployStageBlueGreenStrategy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 namespace_a: builtins.str,
                 namespace_b: builtins.str,
                 strategy_type: builtins.str):
        """
        :param builtins.str ingress_name: Name of the Ingress resource.
        :param builtins.str namespace_a: First Namespace for deployment.
        :param builtins.str namespace_b: Second Namespace for deployment.
        :param builtins.str strategy_type: Blue Green strategy type
        """
    ...
    def namespace_a(self) -> builtins.str:
        """
    ...
    def namespace_b(self) -> builtins.str:
        """
...
class DeployStageCanaryStrategy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str ingress_name: Name of the Ingress resource.
        :param builtins.str namespace: Canary namespace to be used for Kubernetes canary deployment.
        :param builtins.str strategy_type: Canary strategy type.
        """
        pulumi.set(__self__, "ingress_name", ingress_name)
...
class DeployStageContainerConfig(dict):
    ...
    def __init__(__self__, *,
                 container_config_type: builtins.str,
        ...
        """
        :param builtins.str container_config_type: (Updatable) Container configuration type.
        ...
        :param builtins.str shape_name: (Updatable) The shape of the ContainerInstance. The shape determines the resources available to the ContainerInstance.
        :param builtins.str availability_domain: (Updatable) Availability domain where the ContainerInstance will be created.
        :param builtins.str compartment_id: (Updatable) The OCID of the compartment where the ContainerInstance will be created.
        """
    ...
    def container_config_type(self) -> builtins.str:
        """
...
class DeployStageContainerConfigShapeConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.float memory_in_gbs: (Updatable) The total amount of memory available to the instance, in gigabytes.
        """
        pulumi.set(__self__, "ocpus", ocpus)
        if memory_in_gbs is not None:
            pulumi.set(__self__, "memory_in_gbs", memory_in_gbs)
...
class DeployStageFailurePolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 failure_count: Optional[builtins.int] = None,
                 failure_percentage: Optional[builtins.int] = None):
        """
        :param builtins.str policy_type: (Updatable) Specifies if the failure instance size is given by absolute number or by percentage.
        :param builtins.int failure_count: (Updatable) The threshold count of failed instances in the group, which when reached or exceeded sets the stage as FAILED.
        :param builtins.int failure_percentage: (Updatable) The failure percentage threshold, which when reached or exceeded sets the stage as FAILED. Percentage is computed as the ceiling value of the number of failed instances over the total count of the instances in the group.
        """
    ...
    def failure_count(self) -> Optional[builtins.int]:
        """
    ...
    def failure_percentage(self) -> Optional[builtins.int]:
        """
...
class DeployStageLoadBalancerConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int backend_port: (Updatable) Listen port for the backend server.
        :param builtins.str listener_name: (Updatable) Name of the load balancer listener.
        :param builtins.str load_balancer_id: (Updatable) The OCID of the load balancer.
        :param builtins.str state: The current state of the deployment stage.
        """
...
class DeployStageProductionLoadBalancerConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 state: Optional[builtins.str] = None):
        """
        :param builtins.int backend_port: Listen port for the backend server.
        :param builtins.str listener_name: Name of the load balancer listener.
        :param builtins.str load_balancer_id: The OCID of the load balancer.
        :param builtins.str state: The current state of the deployment stage.
        """
        if backend_port is not None:
            pulumi.set(__self__, "backend_port", backend_port)
...
class DeployStageRollbackPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str policy_type: (Updatable) Specifies type of the deployment stage rollback policy.
        """
...
class DeployStageRolloutPolicy(dict):
    ...
    def __init__(__self__, *,
                 batch_count: Optional[builtins.int] = None,
                 batch_delay_in_seconds: Optional[builtins.int] = None,
                 batch_percentage: Optional[builtins.int] = None,
                 policy_type: Optional[builtins.str] = None,
                 ramp_limit_percent: Optional[builtins.float] = None):
        """
        :param builtins.int batch_count: (Updatable) The number that will be used to determine how many instances will be deployed concurrently.
        :param builtins.int batch_delay_in_seconds: (Updatable) The duration of delay between batch rollout. The default delay is 1 minute.
        :param builtins.int batch_percentage: (Updatable) The percentage that will be used to determine how many instances will be deployed concurrently.
        :param builtins.str policy_type: (Updatable) The type of policy used for rolling out a deployment stage.
        :param builtins.float ramp_limit_percent: (Updatable) Indicates the criteria to stop.
        """
    ...
    def batch_count(self) -> Optional[builtins.int]:
        """
    ...
    def batch_delay_in_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def batch_percentage(self) -> Optional[builtins.int]:
        """
    ...
    def ramp_limit_percent(self) -> Optional[builtins.float]:
        """
...
class DeployStageSetStringItem(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str name: (Updatable) Name of the parameter (case-sensitive).
        :param builtins.str value: (Updatable) Value of the parameter.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if value is not None:
...
class DeployStageWaitCriteria(dict):
    ...
    def __init__(__self__, *,
                 ...
                 wait_type: builtins.str):
        """
        :param builtins.str wait_duration: (Updatable) The absolute wait duration. An ISO 8601 formatted duration string. Minimum waitDuration should be 5 seconds. Maximum waitDuration can be up to 2 days.
        :param builtins.str wait_type: (Updatable) Wait criteria type.
...
class DeploymentDeployArtifactOverrideArgumentsItem(dict):
    ...
    def __init__(__self__, *,
                 ...
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str deploy_artifact_id: The OCID of the artifact to which this parameter applies.
        :param builtins.str name: Name of the parameter (case-sensitive).
...
class DeploymentDeployPipelineArtifactItem(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str display_name: (Updatable) Deployment display name. Avoid entering confidential information.
        """
        if deploy_artifact_id is not None:
            pulumi.set(__self__, "deploy_artifact_id", deploy_artifact_id)
        if deploy_pipeline_stages is not None:
...
class DeploymentDeployPipelineArtifactItemDeployPipelineStageItem(dict):
    ...
    def __init__(__self__, *,
                 ...
                 display_name: Optional[builtins.str] = None):
        """
        :param builtins.str deploy_stage_id: Specifies the OCID of the stage to be redeployed.
        :param builtins.str display_name: (Updatable) Deployment display name. Avoid entering confidential information.
        """
        if deploy_stage_id is not None:
            pulumi.set(__self__, "deploy_stage_id", deploy_stage_id)
...
class DeploymentDeployStageOverrideArgumentsItem(dict):
    ...
    def __init__(__self__, *,
                 ...
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str deploy_stage_id: The OCID of the stage.
        :param builtins.str name: Name of the parameter (case-sensitive).
        :param builtins.str value: Value of the parameter.
        """
        if deploy_stage_id is not None:
...
class DeploymentDeploymentExecutionProgress(dict):
    ...
    def __init__(__self__, *,
                 deploy_stage_execution_progress: Optional[Mapping[str, builtins.str]] = None,
                 time_finished: Optional[builtins.str] = None,
                 time_started: Optional[builtins.str] = None):
        """
        :param Mapping[str, builtins.str] deploy_stage_execution_progress: Map of stage OCIDs to deploy stage execution progress model.
        :param builtins.str time_finished: Time the deployment is finished. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param builtins.str time_started: Time the deployment is started. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        """
    ...
    def deploy_stage_execution_progress(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class ProjectNotificationConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str topic_id: (Updatable) The topic ID for notifications.
...
class ProjectRepositorySettingApprovalRulesItem(dict):
    ...
    def __init__(__self__, *,
                 min_approvals_count: builtins.int,
                 name: builtins.str,
                 destination_branch: Optional[builtins.str] = None,
                 reviewers: Optional[Sequence['outputs.ProjectRepositorySettingApprovalRulesItemReviewer']] = None):
        """
        :param builtins.int min_approvals_count: (Updatable) Minimum number of approvals which must be provided by the reviewers specified in the list before the rule can be satisfied
        :param builtins.str name: (Updatable) Name which is used to uniquely identify an approval rule.
        :param builtins.str destination_branch: (Updatable) Branch name where pull requests targeting the branch must satisfy the approval rule. This value being null means the rule applies to all pull requests
    ...
    def min_approvals_count(self) -> builtins.int:
        """
    ...
    def destination_branch(self) -> Optional[builtins.str]:
        """
...
class ProjectRepositorySettingApprovalRulesItemReviewer(dict):
    ...
    def __init__(__self__, *,
                 ...
                 principal_state: Optional[builtins.str] = None,
                 principal_type: Optional[builtins.str] = None):
        """
        :param builtins.str principal_id: (Updatable) Pull Request reviewer id
        :param builtins.str principal_name: the name of the principal
        :param builtins.str principal_state: The state of the principal, it can be active or inactive or suppressed for emails
        :param builtins.str principal_type: the type of principal
        """
    ...
    def principal_state(self) -> Optional[builtins.str]:
        """
...
class ProjectRepositorySettingMergeSettings(dict):
    ...
    def __init__(__self__, *,
                 allowed_merge_strategies: Sequence[builtins.str],
                 default_merge_strategy: builtins.str):
        """
        :param Sequence[builtins.str] allowed_merge_strategies: (Updatable) List of merge strategies which are allowed for a Project or Repository.
        :param builtins.str default_merge_strategy: (Updatable) Default type of merge strategy associated with the a Project or Repository.
        """
    ...
    def allowed_merge_strategies(self) -> Sequence[builtins.str]:
        """
    ...
    def default_merge_strategy(self) -> builtins.str:
        """
...
class RepositoryMirrorRepositoryConfig(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str connector_id: (Updatable) Upstream git repository connection identifier.
        :param builtins.str repository_url: (Updatable) URL of external repository you want to mirror.
...
class RepositoryMirrorRepositoryConfigTriggerSchedule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 custom_schedule: Optional[builtins.str] = None):
        """
        :param builtins.str schedule_type: (Updatable) Different types of trigger schedule: NONE - No automated synchronization schedule. DEFAULT - Trigger schedule is every 30 minutes. CUSTOM - Custom triggering schedule.
        :param builtins.str custom_schedule: (Updatable) Valid if type is CUSTOM. Following RFC 5545 recurrence rules, we can specify starting time, occurrence frequency, and interval size. Example for frequency could be DAILY/WEEKLY/HOURLY or any RFC 5545 supported frequency, which is followed by start time of this window. You can control the start time with BYHOUR, BYMINUTE and BYSECONDS. It is followed by the interval size.
        """
    ...
    def custom_schedule(self) -> Optional[builtins.str]:
        """
...
class RepositorySettingMergeChecks(dict):
    ...
    def __init__(__self__, *,
                 last_build_succeeded: builtins.str):
        """
        :param builtins.str last_build_succeeded: (Updatable) Indicates whether or not a pull request must have a successful build run and no queued builds before it can be merged
        """
        pulumi.set(__self__, "last_build_succeeded", last_build_succeeded)

    @property
    @pulumi.getter(name="lastBuildSucceeded")
    def last_build_succeeded(self) -> builtins.str:
        """
...
class TriggerAction(dict):
    ...
    def __init__(__self__, *,
                 build_pipeline_id: builtins.str,
                 type: builtins.str,
                 filter: Optional['outputs.TriggerActionFilter'] = None):
        """
        :param builtins.str build_pipeline_id: (Updatable) The OCID of the build pipeline to be triggered.
        :param builtins.str type: (Updatable) The type of action that will be taken. Allowed value is TRIGGER_BUILD_PIPELINE.
        """
        pulumi.set(__self__, "build_pipeline_id", build_pipeline_id)
        pulumi.set(__self__, "type", type)
...
class TriggerActionFilter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str trigger_source: (Updatable) Source of the trigger. Allowed values are,  GITHUB, GITLAB, BITBUCKET_CLOUD, VBS and DEVOPS_CODE_REPOSITORY.
...
class GetBuildPipelineBuildPipelineParameterItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str description: Optional description about the build pipeline.
        :param builtins.str name: Name of the parameter (case-sensitive). Parameter name must be ^[a-zA-Z][a-zA-Z_0-9]*$. Example: 'Build_Pipeline_param' is not same as 'build_pipeline_Param'
        """
        pulumi.set(__self__, "default_value", default_value)
        pulumi.set(__self__, "description", description)
...
class GetBuildPipelineStageBuildRunnerShapeConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 ocpus: builtins.int):
        """
        :param builtins.str build_runner_type: Name of the build runner shape in which the execution occurs. If not specified, the default shape is chosen.
        :param builtins.int memory_in_gbs: The total amount of memory set for the instance in gigabytes.
        :param builtins.int ocpus: The total number of OCPUs set for the instance.
        """
        pulumi.set(__self__, "build_runner_type", build_runner_type)
        pulumi.set(__self__, "memory_in_gbs", memory_in_gbs)
        pulumi.set(__self__, "ocpus", ocpus)
...
class GetBuildPipelineStageBuildSourceCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 repository_url: builtins.str):
        """
        :param builtins.str branch: Branch name.
        :param builtins.str connection_id: Connection identifier pertinent to Bitbucket Server source provider
        :param builtins.str connection_type: The type of source provider.
        :param builtins.str name: Name of the build source. This must be unique within a build source collection. The name can be used by customers to locate the working directory pertinent to this repository.
        :param builtins.str repository_id: The DevOps code repository ID.
        :param builtins.str repository_url: URL for the repository.
        """
        pulumi.set(__self__, "branch", branch)
        pulumi.set(__self__, "connection_id", connection_id)
        pulumi.set(__self__, "connection_type", connection_type)
...
class GetBuildPipelineStageDeliverArtifactCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str artifact_id: Artifact identifier that contains the artifact definition.
        :param builtins.str artifact_name: Name of the artifact specified in the build_spec.yaml file.
        """
        pulumi.set(__self__, "artifact_id", artifact_id)
        pulumi.set(__self__, "artifact_name", artifact_name)
...
class GetBuildPipelineStagePrivateAccessConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 subnet_id: builtins.str):
        """
        :param builtins.str network_channel_type: Network channel type.
        :param Sequence[builtins.str] nsg_ids: An array of network security group OCIDs.
        :param builtins.str subnet_id: The OCID of the subnet where VNIC resources will be created for private endpoint.
        """
        pulumi.set(__self__, "network_channel_type", network_channel_type)
        pulumi.set(__self__, "nsg_ids", nsg_ids)
        pulumi.set(__self__, "subnet_id", subnet_id)
...
class GetBuildPipelineStageWaitCriteriaResult(dict):
    def __init__(__self__, *,
                 ...
                 wait_type: builtins.str):
        """
        :param builtins.str wait_duration: The absolute wait duration. An ISO 8601 formatted duration string. Minimum waitDuration should be 5 seconds. Maximum waitDuration can be up to 2 days.
        :param builtins.str wait_type: Wait criteria type.
        """
        pulumi.set(__self__, "wait_duration", wait_duration)
        pulumi.set(__self__, "wait_type", wait_type)
...
class GetBuildPipelineStagesBuildPipelineStageCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 build_pipeline_stage_type: builtins.str,
                 ...
                 deploy_pipeline_id: builtins.str,
                 description: builtins.str,
                 display_name: builtins.str,
                 freeform_tags: Mapping[str, builtins.str],
                 id: builtins.str,
                 image: builtins.str,
                 is_pass_all_parameters_enabled: builtins.bool,
                 lifecycle_details: builtins.str,
                 primary_build_source: builtins.str,
                 private_access_config: 'outputs.GetBuildPipelineStagesBuildPipelineStageCollectionItemPrivateAccessConfigResult',
                 project_id: builtins.str,
                 stage_execution_timeout_in_seconds: builtins.int,
                 state: builtins.str,
        ...
        """
        :param builtins.str build_pipeline_id: The OCID of the parent build pipeline.
        ...
        :param builtins.str build_pipeline_stage_type: Defines the stage type, which is one of the following: BUILD, DELIVER_ARTIFACT, WAIT, and TRIGGER_DEPLOYMENT_PIPELINE.
        ...
        :param builtins.str build_spec_file: The path to the build specification file for this environment. The default location of the file if not specified is build_spec.yaml.
        ...
        :param builtins.str deploy_pipeline_id: A target deployment pipeline OCID that will run in this stage.
        :param builtins.str description: Optional description about the build stage.
        ...
        :param builtins.str image: Image name for the build environment.
        :param builtins.bool is_pass_all_parameters_enabled: A boolean flag that specifies whether all the parameters must be passed when the deployment is triggered.
        ...
        :param builtins.str primary_build_source: Name of the build source where the build_spec.yml file is located. If not specified, then the first entry in the build source collection is chosen as primary build source.
        ...
        :param builtins.str project_id: The OCID of the DevOps project.
        :param builtins.int stage_execution_timeout_in_seconds: Timeout for the build stage execution. Specify value in seconds.
        :param builtins.str state: A filter to return the stages that matches the given lifecycle state.
        ...
        :param builtins.str time_created: The time the stage was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param builtins.str time_updated: The time the stage was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
    ...
    def build_pipeline_stage_type(self) -> builtins.str:
        """
    ...
    def build_spec_file(self) -> builtins.str:
        """
    ...
    def deploy_pipeline_id(self) -> builtins.str:
        """
    ...
    def is_pass_all_parameters_enabled(self) -> builtins.bool:
        """
    ...
    def primary_build_source(self) -> builtins.str:
        """
    ...
    def stage_execution_timeout_in_seconds(self) -> builtins.int:
        """
...
class GetBuildPipelinesBuildPipelineCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str state: A filter to return only build pipelines that matches the given lifecycle state.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The time the build pipeline was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param builtins.str time_updated: The time the build pipeline was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        """
...
class GetBuildRunBuildOutputArtifactOverrideParameterItemResult(dict):
    def __init__(__self__, *,
                 deploy_artifact_id: builtins.str,
                 name: builtins.str,
                 value: builtins.str):
        """
        :param builtins.str deploy_artifact_id: The OCID of the deployment artifact definition.
...
class GetBuildRunBuildOutputDeliveredArtifactItemResult(dict):
    def __init__(__self__, *,
                 ...
                 delivered_artifact_hash: builtins.str,
                 delivered_artifact_id: builtins.str,
                 deploy_artifact_id: builtins.str,
                 image_uri: builtins.str,
                 output_artifact_name: builtins.str,
                 path: builtins.str,
    ...
    @property
    @pulumi.getter(name="deliveredArtifactHash")
    def delivered_artifact_hash(self) -> builtins.str:
        """
        The hash of the container registry artifact pushed by the Deliver Artifacts stage.
        """
        return pulumi.get(self, "delivered_artifact_hash")
    ...
    @property
    @pulumi.getter(name="deliveredArtifactId")
    def delivered_artifact_id(self) -> builtins.str:
        """
        The OCID of the artifact pushed by the Deliver Artifacts stage.
        """
        return pulumi.get(self, "delivered_artifact_id")
    ...
    @property
    @pulumi.getter(name="outputArtifactName")
    def output_artifact_name(self) -> builtins.str:
        """
        Name of the output artifact defined in the build specification file.
        """
        return pulumi.get(self, "output_artifact_name")
...
class GetBuildRunBuildOutputVulnerabilityAuditSummaryCollectionItemResult(dict):
    def __init__(__self__, *,
                 build_stage_id: builtins.str,
                 commit_hash: builtins.str,
                 vulnerability_audit_id: builtins.str):
        """
        :param builtins.str build_stage_id: Build stage OCID where scan was configured.
        :param builtins.str commit_hash: Commit hash pertinent to the repository URL and the specified branch.
        :param builtins.str vulnerability_audit_id: The OCID of the vulnerability audit.
    ...
    @property
    @pulumi.getter(name="buildStageId")
    def build_stage_id(self) -> builtins.str:
        """
        Build stage OCID where scan was configured.
        """
        return pulumi.get(self, "build_stage_id")
    ...
    @property
    @pulumi.getter(name="vulnerabilityAuditId")
    def vulnerability_audit_id(self) -> builtins.str:
        """
        The OCID of the vulnerability audit.
        """
        return pulumi.get(self, "vulnerability_audit_id")
...
class GetBuildRunBuildRunProgressResult(dict):
    def __init__(__self__, *,
                 build_pipeline_stage_run_progress: Mapping[str, builtins.str],
    ...
    @property
    @pulumi.getter(name="buildPipelineStageRunProgress")
    def build_pipeline_stage_run_progress(self) -> Mapping[str, builtins.str]:
        """
        Map of stage OCIDs to build pipeline stage run progress model.
        """
        return pulumi.get(self, "build_pipeline_stage_run_progress")
...
class GetBuildRunBuildRunSourceTriggerInfoResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str display_name: Build run display name, which can be renamed and is not necessarily unique. Avoid entering confidential information.
        """
        pulumi.set(__self__, "actions", actions)
        pulumi.set(__self__, "display_name", display_name)
...
class GetBuildRunBuildRunSourceTriggerInfoActionResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str build_pipeline_id: The OCID of the build pipeline to be triggered.
        :param builtins.str type: The type of action that will be taken. Allowed value is TRIGGER_BUILD_PIPELINE.
        """
        pulumi.set(__self__, "build_pipeline_id", build_pipeline_id)
        pulumi.set(__self__, "filters", filters)
...
class GetBuildRunBuildRunSourceTriggerInfoActionFilterExcludeFileFilterResult(dict):
    def __init__(__self__, *,
                 file_paths: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] file_paths: The file paths/glob pattern for files.
        """
        pulumi.set(__self__, "file_paths", file_paths)
    ...
    @property
    @pulumi.getter(name="filePaths")
    def file_paths(self) -> Sequence[builtins.str]:
        """
        The file paths/glob pattern for files.
        """
        return pulumi.get(self, "file_paths")
...
class GetBuildRunsBuildRunSummaryCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The time the build run was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param builtins.str time_updated: The time the build run was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        """
        pulumi.set(__self__, "build_pipeline_id", build_pipeline_id)
...
class GetConnectionTlsVerifyConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 tls_verify_mode: builtins.str):
        """
        :param builtins.str ca_certificate_bundle_id: The OCID of Oracle Cloud Infrastructure certificate service CA bundle.
        :param builtins.str tls_verify_mode: The type of TLS verification.
        """
        pulumi.set(__self__, "ca_certificate_bundle_id", ca_certificate_bundle_id)
        pulumi.set(__self__, "tls_verify_mode", tls_verify_mode)
...
class GetConnectionsConnectionCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str access_token: The OCID of personal access token saved in secret store.
        :param builtins.str app_password: OCID of personal Bitbucket Cloud AppPassword saved in secret store
        :param builtins.str base_url: The Base URL of the hosted BitbucketServer/Visual Builder Studio server.
        :param builtins.str compartment_id: The OCID of the compartment in which to list resources.
        :param builtins.str connection_type: A filter to return only resources that match the given connection type.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str description: Optional description about the connection.
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"bar-key": "value"}`
        :param builtins.str id: Unique identifier or OCID for listing a single resource by ID.
        ...
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The time the connection was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param builtins.str time_updated: The time the connection was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        ...
        :param builtins.str username: Public Bitbucket Cloud Username in plain text
        """
...
class GetDeployArtifactDeployArtifactSourceResult(dict):
    def __init__(__self__, *,
                 base64encoded_content: builtins.str,
                 chart_url: builtins.str,
                 deploy_artifact_path: builtins.str,
                 deploy_artifact_source_type: builtins.str,
                 deploy_artifact_version: builtins.str,
                 helm_artifact_source_type: builtins.str,
                 ...
                 repository_id: builtins.str):
        """
        :param builtins.str base64encoded_content: The Helm commands to be executed, base 64 encoded
        :param builtins.str chart_url: The URL of an OCIR repository.
        :param builtins.str deploy_artifact_path: Specifies the artifact path in the repository.
        :param builtins.str deploy_artifact_source_type: Specifies types of artifact sources.
        :param builtins.str deploy_artifact_version: Users can set this as a placeholder value that refers to a pipeline parameter, for example, ${appVersion}.
        :param builtins.str helm_artifact_source_type: Specifies types of artifact sources.
        ...
        :param builtins.str image_digest: Specifies image digest for the version of the image.
        :param builtins.str image_uri: Specifies OCIR Image Path - optionally include tag.
        :param builtins.str repository_id: The OCID of a repository
        """
        pulumi.set(__self__, "base64encoded_content", base64encoded_content)
        pulumi.set(__self__, "chart_url", chart_url)
        pulumi.set(__self__, "deploy_artifact_path", deploy_artifact_path)
    ...
    @property
    @pulumi.getter(name="base64encodedContent")
    def base64encoded_content(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="chartUrl")
    def chart_url(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="deployArtifactPath")
    def deploy_artifact_path(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="deployArtifactVersion")
    def deploy_artifact_version(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="helmArtifactSourceType")
    def helm_artifact_source_type(self) -> builtins.str:
        """
        Specifies types of artifact sources.
        """
        return pulumi.get(self, "helm_artifact_source_type")
...
class GetDeployArtifactDeployArtifactSourceHelmVerificationKeySourceResult(dict):
    def __init__(__self__, *,
                 current_public_key: builtins.str,
                 previous_public_key: builtins.str,
                 vault_secret_id: builtins.str,
                 verification_key_source_type: builtins.str):
        """
        :param builtins.str current_public_key: Current version of Base64 encoding of the public key which is in binary GPG exported format.
        :param builtins.str previous_public_key: Previous version of Base64 encoding of the public key which is in binary GPG exported format. This would be used for key rotation scenarios.
        :param builtins.str vault_secret_id: The OCID of the Vault Secret containing the verification key versions.
        :param builtins.str verification_key_source_type: Specifies type of verification material.
        """
        pulumi.set(__self__, "current_public_key", current_public_key)
        pulumi.set(__self__, "previous_public_key", previous_public_key)
        pulumi.set(__self__, "vault_secret_id", vault_secret_id)
    ...
    @property
    @pulumi.getter(name="currentPublicKey")
    def current_public_key(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="previousPublicKey")
    def previous_public_key(self) -> builtins.str:
        """
...
class GetDeployArtifactsDeployArtifactCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 time_updated: builtins.str):
        """
        :param builtins.str argument_substitution_mode: Mode for artifact parameter substitution. Options: `"NONE", "SUBSTITUTE_PLACEHOLDERS"` For Helm Deployments only "NONE" is supported.
        :param builtins.str compartment_id: The OCID of the compartment in which to list resources.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        ...
        :param builtins.str deploy_artifact_type: Type of the deployment artifact.
        :param builtins.str description: Optional description about the artifact to be deployed.
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"bar-key": "value"}`
        :param builtins.str id: Unique identifier or OCID for listing a single resource by ID.
        :param builtins.str lifecycle_details: A detailed message describing the current state. For example, can be used to provide actionable information for a resource in Failed state.
        :param builtins.str project_id: unique project identifier
        :param builtins.str state: A filter to return only DeployArtifacts that matches the given lifecycleState.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: Time the deployment artifact was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param builtins.str time_updated: Time the deployment artifact was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        """
...
class GetDeployEnvironmentComputeInstanceGroupSelectorItemResult(dict):
    def __init__(__self__, *,
                 compute_instance_ids: Sequence[builtins.str],
                 query: builtins.str,
                 region: builtins.str,
                 selector_type: builtins.str):
        """
        :param Sequence[builtins.str] compute_instance_ids: Compute instance OCID identifiers that are members of this group.
        :param builtins.str query: Query expression confirming to the Oracle Cloud Infrastructure Search Language syntax to select compute instances for the group. The language is documented at https://docs.oracle.com/en-us/iaas/Content/Search/Concepts/querysyntax.htm
        :param builtins.str region: Region identifier referred by the deployment environment. Region identifiers are listed at https://docs.oracle.com/en-us/iaas/Content/General/Concepts/regions.htm
        :param builtins.str selector_type: Defines the type of the instance selector for the group.
        """
        pulumi.set(__self__, "compute_instance_ids", compute_instance_ids)
        pulumi.set(__self__, "query", query)
        pulumi.set(__self__, "region", region)
    ...
    @property
    @pulumi.getter(name="computeInstanceIds")
    def compute_instance_ids(self) -> Sequence[builtins.str]:
        """
...
class GetDeployEnvironmentsDeployEnvironmentCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 defined_tags: Mapping[str, builtins.str],
                 deploy_environment_type: builtins.str,
                 description: builtins.str,
                 display_name: builtins.str,
                 freeform_tags: Mapping[str, builtins.str],
                 ...
                 time_updated: builtins.str):
        """
        :param builtins.str cluster_id: The OCID of the Kubernetes cluster.
        :param builtins.str compartment_id: The OCID of the compartment in which to list resources.
        ...
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str deploy_environment_type: Deployment environment type.
        :param builtins.str description: Optional description about the deployment environment.
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"bar-key": "value"}`
        :param builtins.str function_id: The OCID of the Function.
        :param builtins.str id: Unique identifier or OCID for listing a single resource by ID.
        :param builtins.str lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        ...
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: Time the deployment environment was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param builtins.str time_updated: Time the deployment environment was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        """
    ...
    def deploy_environment_type(self) -> builtins.str:
        """
...
class GetDeployPipelineDeployPipelineArtifactItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str display_name: Deployment pipeline display name, which can be renamed and is not necessarily unique. Avoid entering confidential information.
        """
        pulumi.set(__self__, "deploy_artifact_id", deploy_artifact_id)
        pulumi.set(__self__, "deploy_pipeline_stages", deploy_pipeline_stages)
        pulumi.set(__self__, "display_name", display_name)
...
class GetDeployPipelineDeployPipelineArtifactItemDeployPipelineStageItemResult(dict):
    ...
    @property
    @pulumi.getter(name="deployStageId")
    def deploy_stage_id(self) -> builtins.str:
        """
        The OCID of a stage
        """
        return pulumi.get(self, "deploy_stage_id")
...
class GetDeployPipelineDeployPipelineEnvironmentItemResult(dict):
    def __init__(__self__, *,
                 deploy_environment_id: builtins.str,
    ...
    @property
    @pulumi.getter(name="deployEnvironmentId")
    def deploy_environment_id(self) -> builtins.str:
        """
        The OCID of an Environment
        """
        return pulumi.get(self, "deploy_environment_id")
...
class GetDeployPipelineDeployPipelineParameterItemResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str default_value: Default value of the parameter.
        :param builtins.str description: Optional description about the deployment pipeline.
        :param builtins.str name: Name of the parameter (case-sensitive). Parameter name must be ^[a-zA-Z][a-zA-Z_0-9]*$.
        """
        pulumi.set(__self__, "default_value", default_value)
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "name", name)
...
class GetDeployPipelinesDeployPipelineCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        :param builtins.str project_id: unique project identifier
        :param builtins.str state: A filter to return only DeployPipelines that matches the given lifecycleState.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: Time the deployment pipeline was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param builtins.str time_updated: Time the deployment pipeline was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
...
class GetDeployStageApprovalPolicyResult(dict):
    def __init__(__self__, *,
                 ...
                 number_of_approvals_required: builtins.int):
        """
        :param builtins.str approval_policy_type: Approval policy type.
        :param builtins.int number_of_approvals_required: A minimum number of approvals required for stage to proceed.
        """
        pulumi.set(__self__, "approval_policy_type", approval_policy_type)
        pulumi.set(__self__, "number_of_approvals_required", number_of_approvals_required)
...
class GetDeployStageBlueBackendIpResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] items: List of parameters defined to set helm value.
        """
        pulumi.set(__self__, "items", items)
...
class GetDeployStageCanaryStrategyResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str ingress_name: Name of the Ingress resource.
        :param builtins.str namespace: Default Namespace to be used for Kubernetes deployment when not specified in the manifest.
        :param builtins.str strategy_type: Canary strategy type.
        """
        pulumi.set(__self__, "ingress_name", ingress_name)
        pulumi.set(__self__, "namespace", namespace)
...
class GetDeployStageContainerConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 shape_name: builtins.str):
        """
        :param builtins.str availability_domain: Availability domain where the ContainerInstance will be created.
        :param builtins.str compartment_id: The OCID of the compartment where the ContainerInstance will be created.
        :param builtins.str container_config_type: Container configuration type.
        ...
        :param builtins.str shape_name: The shape of the ContainerInstance. The shape determines the resources available to the ContainerInstance.
        """
        pulumi.set(__self__, "availability_domain", availability_domain)
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "container_config_type", container_config_type)
...
class GetDeployStageContainerConfigShapeConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 ocpus: builtins.float):
        """
        :param builtins.float memory_in_gbs: The total amount of memory available to the instance, in gigabytes.
...
class GetDeployStageFailurePolicyResult(dict):
    def __init__(__self__, *,
                 ...
                 failure_percentage: builtins.int,
                 policy_type: builtins.str):
        """
        :param builtins.int failure_count: The threshold count of failed instances in the group, which when reached or exceeded sets the stage as FAILED.
        :param builtins.int failure_percentage: The failure percentage threshold, which when reached or exceeded sets the stage as FAILED. Percentage is computed as the ceiling value of the number of failed instances over the total count of the instances in the group.
        :param builtins.str policy_type: The type of policy used for rolling out a deployment stage.
        """
        pulumi.set(__self__, "failure_count", failure_count)
        pulumi.set(__self__, "failure_percentage", failure_percentage)
        pulumi.set(__self__, "policy_type", policy_type)
    ...
    @property
    @pulumi.getter(name="failurePercentage")
    def failure_percentage(self) -> builtins.int:
        """
...
class GetDeployStageRolloutPolicyResult(dict):
    def __init__(__self__, *,
                 batch_count: builtins.int,
                 batch_delay_in_seconds: builtins.int,
                 batch_percentage: builtins.int,
                 policy_type: builtins.str,
                 ramp_limit_percent: builtins.float):
        """
        :param builtins.int batch_count: The number that will be used to determine how many instances will be deployed concurrently.
        :param builtins.int batch_delay_in_seconds: The duration of delay between batch rollout. The default delay is 1 minute.
        :param builtins.int batch_percentage: The percentage that will be used to determine how many instances will be deployed concurrently.
        :param builtins.str policy_type: The type of policy used for rolling out a deployment stage.
        :param builtins.float ramp_limit_percent: Indicates the criteria to stop.
        """
        pulumi.set(__self__, "batch_count", batch_count)
        pulumi.set(__self__, "batch_delay_in_seconds", batch_delay_in_seconds)
        pulumi.set(__self__, "batch_percentage", batch_percentage)
    ...
    @property
    @pulumi.getter(name="batchCount")
    def batch_count(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="batchDelayInSeconds")
    def batch_delay_in_seconds(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="batchPercentage")
    def batch_percentage(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="rampLimitPercent")
    def ramp_limit_percent(self) -> builtins.float:
        """
...
class GetDeployStagesDeployStageCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 are_hooks_enabled: builtins.bool,
                 ...
                 command_spec_deploy_artifact_id: builtins.str,
                 compartment_id: builtins.str,
                 compute_instance_group_blue_green_deployment_deploy_stage_id: builtins.str,
                 compute_instance_group_canary_deploy_stage_id: builtins.str,
                 compute_instance_group_canary_traffic_shift_deploy_stage_id: builtins.str,
                 compute_instance_group_deploy_environment_id: builtins.str,
                 ...
                 defined_tags: Mapping[str, builtins.str],
                 deploy_artifact_id: builtins.str,
                 deploy_artifact_ids: Sequence[builtins.str],
                 deploy_environment_id_a: builtins.str,
                 deploy_environment_id_b: builtins.str,
                 deploy_pipeline_id: builtins.str,
                 ...
                 deploy_stage_type: builtins.str,
                 deployment_spec_deploy_artifact_id: builtins.str,
                 description: builtins.str,
                 display_name: builtins.str,
                 docker_image_deploy_artifact_id: builtins.str,
                 failure_policies: Sequence['outputs.GetDeployStagesDeployStageCollectionItemFailurePolicyResult'],
                 freeform_tags: Mapping[str, builtins.str],
                 function_deploy_environment_id: builtins.str,
                 function_timeout_in_seconds: builtins.int,
                 green_backend_ips: Sequence['outputs.GetDeployStagesDeployStageCollectionItemGreenBackendIpResult'],
                 helm_chart_deploy_artifact_id: builtins.str,
                 helm_command_artifact_ids: Sequence[builtins.str],
                 id: builtins.str,
                 is_async: builtins.bool,
                 is_debug_enabled: builtins.bool,
                 is_force_enabled: builtins.bool,
                 is_uninstall_on_stage_delete: builtins.bool,
                 is_validation_enabled: builtins.bool,
                 kubernetes_manifest_deploy_artifact_ids: Sequence[builtins.str],
                 lifecycle_details: builtins.str,
                 load_balancer_configs: Sequence['outputs.GetDeployStagesDeployStageCollectionItemLoadBalancerConfigResult'],
                 max_history: builtins.int,
                 max_memory_in_mbs: builtins.str,
                 namespace: builtins.str,
                 oke_blue_green_deploy_stage_id: builtins.str,
                 oke_canary_deploy_stage_id: builtins.str,
                 oke_canary_traffic_shift_deploy_stage_id: builtins.str,
                 oke_cluster_deploy_environment_id: builtins.str,
                 ...
                 should_cleanup_on_fail: builtins.bool,
                 should_not_wait: builtins.bool,
                 should_reset_values: builtins.bool,
                 should_reuse_values: builtins.bool,
                 should_skip_crds: builtins.bool,
                 should_skip_render_subchart_notes: builtins.bool,
                 state: builtins.str,
                 system_tags: Mapping[str, builtins.str],
                 ...
                 traffic_shift_target: builtins.str,
                 values_artifact_ids: Sequence[builtins.str],
        ...
        :param builtins.bool are_hooks_enabled: Disable pre/post upgrade hooks. Set to false by default.
        ...
        :param builtins.str command_spec_deploy_artifact_id: The OCID of the artifact that contains the command specification.
        :param builtins.str compartment_id: The OCID of the compartment in which to list resources.
        :param builtins.str compute_instance_group_blue_green_deployment_deploy_stage_id: The OCID of the upstream compute instance group blue-green deployment stage in this pipeline.
        :param builtins.str compute_instance_group_canary_deploy_stage_id: The OCID of an upstream compute instance group canary deployment stage ID in this pipeline.
        :param builtins.str compute_instance_group_canary_traffic_shift_deploy_stage_id: A compute instance group canary traffic shift stage OCID for load balancer.
        :param builtins.str compute_instance_group_deploy_environment_id: A compute instance group environment OCID for rolling deployment.
        :param Mapping[str, builtins.str] config: User provided key and value pair configuration, which is assigned through constants or parameter.
        ...
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str deploy_artifact_id: Optional artifact OCID. The artifact will be included in the body for the function invocation during the stage's execution. If the DeployArtifact.argumentSubstituitionMode is set to SUBSTITUTE_PLACEHOLDERS, then the pipeline parameter values will be used to replace the placeholders in the artifact content.
        :param Sequence[builtins.str] deploy_artifact_ids: The list of file artifact OCIDs to deploy.
        :param builtins.str deploy_environment_id_a: First compute instance group environment OCID for deployment.
        :param builtins.str deploy_environment_id_b: Second compute instance group environment OCID for deployment.
        ...
        :param builtins.str deploy_stage_type: Deployment stage type.
        :param builtins.str deployment_spec_deploy_artifact_id: The OCID of the artifact that contains the deployment specification.
        :param builtins.str description: Optional description about the deployment stage.
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param builtins.str docker_image_deploy_artifact_id: A Docker image artifact OCID.
        ...
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"bar-key": "value"}`
        :param builtins.str function_deploy_environment_id: Function environment OCID.
        :param builtins.int function_timeout_in_seconds: Timeout for execution of the Function. Value in seconds.
        ...
        :param builtins.str helm_chart_deploy_artifact_id: Helm chart artifact OCID.
        :param Sequence[builtins.str] helm_command_artifact_ids: List of Helm command artifact OCIDs.
        :param builtins.str id: Unique identifier or OCID for listing a single resource by ID.
        :param builtins.bool is_async: A boolean flag specifies whether this stage executes asynchronously.
        :param builtins.bool is_debug_enabled: Enables helm --debug option to stream output to tf stdout. Set to false by default.
        :param builtins.bool is_force_enabled: Force resource update through delete; or if required, recreate. Set to false by default.
        :param builtins.bool is_uninstall_on_stage_delete: Uninstall the Helm chart release on deleting the stage.
        :param builtins.bool is_validation_enabled: A boolean flag specifies whether the invoked function must be validated.
        :param Sequence[builtins.str] kubernetes_manifest_deploy_artifact_ids: List of Kubernetes manifest artifact OCIDs.
        :param builtins.str lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        ...
        :param builtins.int max_history: Limit the maximum number of revisions saved per release. Use 0 for no limit. Set to 10 by default
        :param builtins.str max_memory_in_mbs: Maximum usable memory for the Function (in MB).
        :param builtins.str namespace: Default Namespace to be used for Kubernetes deployment when not specified in the manifest.
        :param builtins.str oke_blue_green_deploy_stage_id: The OCID of the upstream OKE blue-green deployment stage in this pipeline.
        :param builtins.str oke_canary_deploy_stage_id: The OCID of an upstream OKE canary deployment stage in this pipeline.
        :param builtins.str oke_canary_traffic_shift_deploy_stage_id: The OCID of an upstream OKE canary deployment traffic shift stage in this pipeline.
        :param builtins.str oke_cluster_deploy_environment_id: Kubernetes cluster environment OCID for deployment.
        ...
        :param builtins.str project_id: The OCID of a project.
        :param builtins.str purpose: The purpose of running this Helm stage
        :param builtins.str release_name: Release name of the Helm chart.
        ...
        :param builtins.bool should_cleanup_on_fail: Allow deletion of new resources created during when an upgrade fails. Set to false by default.
        :param builtins.bool should_not_wait: Waits until all the resources are in a ready state to mark the release as successful. Set to false by default.
        :param builtins.bool should_reset_values: During upgrade, reset the values to the ones built into the chart. It overrides shouldReuseValues. Set to false by default.
        :param builtins.bool should_reuse_values: During upgrade, reuse the values of the last release and merge overrides from the command line. Set to false by default.
        :param builtins.bool should_skip_crds: If set, no CRDs are installed. By default, CRDs are installed only if they are not present already. Set to false by default.
        :param builtins.bool should_skip_render_subchart_notes: If set, renders subchart notes along with the parent. Set to false by default.
        ...
        :param builtins.str time_created: Time the deployment stage was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param builtins.str time_updated: Time the deployment stage was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param builtins.int timeout_in_seconds: Time to wait for execution of a Shell/Helm stage. Defaults to 36000 seconds for Shell and 300 seconds for Helm Stage
        :param builtins.str traffic_shift_target: Specifies the target or destination backend set.
        :param Sequence[builtins.str] values_artifact_ids: List of values.yaml file artifact OCIDs.
    ...
    def are_hooks_enabled(self) -> builtins.bool:
        """
    ...
    def command_spec_deploy_artifact_id(self) -> builtins.str:
        """
    ...
    def compute_instance_group_blue_green_deployment_deploy_stage_id(self) -> builtins.str:
        """
    ...
    def compute_instance_group_canary_deploy_stage_id(self) -> builtins.str:
        """
    ...
    def compute_instance_group_canary_traffic_shift_deploy_stage_id(self) -> builtins.str:
        """
    ...
    def compute_instance_group_deploy_environment_id(self) -> builtins.str:
        """
    ...
    def deploy_artifact_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def deploy_environment_id_a(self) -> builtins.str:
        """
    ...
    def deploy_environment_id_b(self) -> builtins.str:
        """
    ...
    def deploy_stage_type(self) -> builtins.str:
        """
    ...
    def deployment_spec_deploy_artifact_id(self) -> builtins.str:
        """
    ...
    def docker_image_deploy_artifact_id(self) -> builtins.str:
        """
    ...
    def function_deploy_environment_id(self) -> builtins.str:
        """
    ...
    def function_timeout_in_seconds(self) -> builtins.int:
        """
    ...
    def helm_chart_deploy_artifact_id(self) -> builtins.str:
        """
    ...
    def helm_command_artifact_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def is_debug_enabled(self) -> builtins.bool:
        """
    ...
    def is_force_enabled(self) -> builtins.bool:
        """
    ...
    def is_uninstall_on_stage_delete(self) -> builtins.bool:
        """
    ...
    def is_validation_enabled(self) -> builtins.bool:
        """
    ...
    def kubernetes_manifest_deploy_artifact_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def max_history(self) -> builtins.int:
        """
    ...
    def max_memory_in_mbs(self) -> builtins.str:
        """
    ...
    def oke_blue_green_deploy_stage_id(self) -> builtins.str:
        """
    ...
    def oke_canary_deploy_stage_id(self) -> builtins.str:
        """
    ...
    def oke_canary_traffic_shift_deploy_stage_id(self) -> builtins.str:
        """
    ...
    def oke_cluster_deploy_environment_id(self) -> builtins.str:
        """
    ...
    def should_cleanup_on_fail(self) -> builtins.bool:
        """
    ...
    def should_not_wait(self) -> builtins.bool:
        """
    ...
    def should_reset_values(self) -> builtins.bool:
        """
    ...
    def should_reuse_values(self) -> builtins.bool:
        """
    ...
    def should_skip_crds(self) -> builtins.bool:
        """
    ...
    def should_skip_render_subchart_notes(self) -> builtins.bool:
        """
    ...
    def traffic_shift_target(self) -> builtins.str:
        """
    ...
    def values_artifact_ids(self) -> Sequence[builtins.str]:
        """
...
class GetDeploymentDeployPipelineArtifactItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str display_name: Deployment identifier which can be renamed and is not necessarily unique. Avoid entering confidential information.
        """
        pulumi.set(__self__, "deploy_artifact_id", deploy_artifact_id)
        pulumi.set(__self__, "deploy_pipeline_stages", deploy_pipeline_stages)
        pulumi.set(__self__, "display_name", display_name)
...
class GetDeploymentDeploymentExecutionProgressResult(dict):
    def __init__(__self__, *,
                 deploy_stage_execution_progress: Mapping[str, builtins.str],
                 time_finished: builtins.str,
                 time_started: builtins.str):
        """
        :param Mapping[str, builtins.str] deploy_stage_execution_progress: Map of stage OCIDs to deploy stage execution progress model.
    ...
    @property
    @pulumi.getter(name="deployStageExecutionProgress")
    def deploy_stage_execution_progress(self) -> Mapping[str, builtins.str]:
        """
        Map of stage OCIDs to deploy stage execution progress model.
        """
        return pulumi.get(self, "deploy_stage_execution_progress")
...
class GetDeploymentsDeploymentCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 lifecycle_details: builtins.str,
                 previous_deployment_id: builtins.str,
                 project_id: builtins.str,
                 state: builtins.str,
                 system_tags: Mapping[str, builtins.str],
                 time_created: builtins.str,
                 time_updated: builtins.str,
                 trigger_new_devops_deployment: builtins.bool):
        """
        :param builtins.str compartment_id: The OCID of the compartment in which to list resources.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        ...
        :param builtins.str deployment_type: Specifies type of Deployment
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"bar-key": "value"}`
        :param builtins.str id: Unique identifier or OCID for listing a single resource by ID.
        :param builtins.str lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        :param builtins.str previous_deployment_id: Specifies the OCID of the previous deployment to be redeployed.
        :param builtins.str project_id: unique project identifier
        :param builtins.str state: A filter to return only Deployments that matches the given lifecycleState.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: Time the deployment was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param builtins.str time_updated: Time the deployment was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
    ...
    def previous_deployment_id(self) -> builtins.str:
        """
    ...
    def trigger_new_devops_deployment(self) -> builtins.bool:
...
class GetProjectNotificationConfigResult(dict):
    def __init__(__self__, *,
                 topic_id: builtins.str):
        """
        :param builtins.str topic_id: The topic ID for notifications.
        """
        pulumi.set(__self__, "topic_id", topic_id)
...
class GetProjectRepositorySettingApprovalRuleItemResult(dict):
    def __init__(__self__, *,
                 destination_branch: builtins.str,
                 min_approvals_count: builtins.int,
                 name: builtins.str,
                 reviewers: Sequence['outputs.GetProjectRepositorySettingApprovalRuleItemReviewerResult']):
        """
        :param builtins.str destination_branch: Branch name where pull requests targeting the branch must satisfy the approval rule. This value being null means the rule applies to all pull requests
        :param builtins.int min_approvals_count: Minimum number of approvals which must be provided by the reviewers specified in the list before the rule can be satisfied
        :param builtins.str name: Name which is used to uniquely identify an approval rule.
...
class GetProjectRepositorySettingApprovalRuleItemReviewerResult(dict):
    def __init__(__self__, *,
                 ...
                 principal_state: builtins.str,
                 principal_type: builtins.str):
        """
        :param builtins.str principal_id: the OCID of the principal
        :param builtins.str principal_name: the name of the principal
        :param builtins.str principal_state: The state of the principal, it can be active or inactive or suppressed for emails
        :param builtins.str principal_type: the type of principal
        """
    ...
    @property
    @pulumi.getter(name="principalState")
    def principal_state(self) -> builtins.str:
        """
        The state of the principal, it can be active or inactive or suppressed for emails
        """
        return pulumi.get(self, "principal_state")
...
class GetProjectRepositorySettingMergeSettingResult(dict):
    def __init__(__self__, *,
                 ...
                 default_merge_strategy: builtins.str):
        """
        :param Sequence[builtins.str] allowed_merge_strategies: List of merge strategies which are allowed for a Project or Repository.
        :param builtins.str default_merge_strategy: Default type of merge strategy associated with the a Project or Repository.
        """
        pulumi.set(__self__, "allowed_merge_strategies", allowed_merge_strategies)
        pulumi.set(__self__, "default_merge_strategy", default_merge_strategy)
...
class GetProjectsProjectCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        :param builtins.str name: A filter to return only resources that match the entire name given.
        :param builtins.str namespace: Namespace associated with the project.
        ...
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: Time the project was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param builtins.str time_updated: Time the project was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
        pulumi.set(__self__, "description", description)
...
class GetRepoFileLineLineResult(dict):
    def __init__(__self__, *,
                 line_content: builtins.str,
                 line_number: builtins.int):
        """
        :param builtins.str line_content: The content of the line.
        :param builtins.int line_number: The line number.
        """
    ...
    def line_content(self) -> builtins.str:
        """
...
class GetRepositoriesRepositoryCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str,
                 namespace: builtins.str,
                 parent_repository_id: builtins.str,
                 project_id: builtins.str,
                 ...
                 time_created: builtins.str,
                 time_updated: builtins.str,
                 trigger_build_events: Sequence[builtins.str]):
        """
        :param builtins.int branch_count: The count of the branches present in the repository.
        :param builtins.int commit_count: The count of the commits present in the repository.
        :param builtins.str compartment_id: The OCID of the compartment in which to list resources.
        :param builtins.str default_branch: The default branch of the repository.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str description: Details of the repository. Avoid entering confidential information.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"bar-key": "value"}`
        :param builtins.str http_url: HTTP URL that you use to git clone, pull and push.
        :param builtins.str id: The OCID of the repository. This value is unique and immutable.
        ...
        :param builtins.str name: A filter to return only resources that match the entire name given.
        :param builtins.str namespace: Tenancy unique namespace.
        :param builtins.str parent_repository_id: The OCID of the parent repository.
        :param builtins.str project_id: unique project identifier
        :param builtins.str project_name: Unique project name in a namespace.
        :param builtins.str repository_type: Type of repository: MIRRORED - Repository created by mirroring an existing repository. HOSTED - Repository created and hosted using Oracle Cloud Infrastructure DevOps code repository. FORKED - Repository created by forking an existing repository.
        :param builtins.str size_in_bytes: The size of the repository in bytes.
        :param builtins.str ssh_url: SSH URL that you use to git clone, pull and push.
        :param builtins.str state: A filter to return only resources whose lifecycle state matches the given lifecycle state.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The time the repository was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param builtins.str time_updated: The time the repository was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param Sequence[builtins.str] trigger_build_events: Trigger build events supported for this repository: PUSH - Build is triggered when a push event occurs. PULL_REQUEST_CREATED - Build is triggered when a pull request is created in the repository. PULL_REQUEST_UPDATED - Build is triggered when a push is made to a branch with an open pull request. COMMIT_UPDATES - Build is triggered when new commits are mirrored into a repository.
        """
...
class GetRepositoriesRepositoryCollectionItemMirrorRepositoryConfigResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str connector_id: Upstream git repository connection identifier.
        :param builtins.str repository_url: URL of external repository you want to mirror.
...
class GetRepositoriesRepositoryCollectionItemMirrorRepositoryConfigTriggerScheduleResult(dict):
    def __init__(__self__, *,
                 custom_schedule: builtins.str,
                 schedule_type: builtins.str):
        """
        :param builtins.str custom_schedule: Valid if type is CUSTOM. Following RFC 5545 recurrence rules, we can specify starting time, occurrence frequency, and interval size. Example for frequency could be DAILY/WEEKLY/HOURLY or any RFC 5545 supported frequency, which is followed by start time of this window. You can control the start time with BYHOUR, BYMINUTE and BYSECONDS. It is followed by the interval size.
        :param builtins.str schedule_type: Different types of trigger schedule: NONE - No automated synchronization schedule. DEFAULT - Trigger schedule is every 30 minutes. CUSTOM - Custom triggering schedule.
        """
        pulumi.set(__self__, "custom_schedule", custom_schedule)
        pulumi.set(__self__, "schedule_type", schedule_type)
    ...
    @property
    @pulumi.getter(name="customSchedule")
    def custom_schedule(self) -> builtins.str:
        """
...
class GetRepositoryAuthorItemResult(dict):
    def __init__(__self__, *,
                 ...
                 freeform_tags: Mapping[str, builtins.str]):
        """
        :param builtins.str author_name: Author name.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"bar-key": "value"}`
        """
...
class GetRepositoryCommitsRepositoryCommitCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 defined_tags: Mapping[str, builtins.str],
                 freeform_tags: Mapping[str, builtins.str],
                 parent_commit_ids: Sequence[builtins.str],
                 time_created: builtins.str,
                 tree_id: builtins.str):
        """
        :param builtins.str author_email: Email of the author of the repository.
        :param builtins.str author_name: A filter to return any commits that are pushed by the requested author.
        :param builtins.str commit_id: Commit hash pointed to by reference name.
        :param builtins.str commit_message: A filter to return any commits that contains the given message.
        :param builtins.str committer_email: Email of who creates the commit.
        :param builtins.str committer_name: Name of who creates the commit.
        :param Sequence[builtins.str] parent_commit_ids: An array of parent commit IDs of created commit.
        :param builtins.str time_created: The time at which commit was created.
        :param builtins.str tree_id: Tree information for the specified commit.
        """
    ...
    def parent_commit_ids(self) -> Sequence[builtins.str]:
        """
...
class GetRepositoryDiffChangeResult(dict):
    def __init__(__self__, *,
                 base_line: builtins.int,
                 base_span: builtins.int,
                 diff_sections: Sequence['outputs.GetRepositoryDiffChangeDiffSectionResult'],
                 target_line: builtins.int,
                 target_span: builtins.int):
        """
        :param builtins.int base_line: The number of a line in the base version.
        :param builtins.int base_span: Number of lines chunk spans in base version.
        :param Sequence['GetRepositoryDiffChangeDiffSectionArgs'] diff_sections: List of difference section.
        :param builtins.int target_line: Line number in target version where changes begin.
        :param builtins.int target_span: Number of lines chunk spans in target version.
        """
    ...
    def base_line(self) -> builtins.int:
        """
    ...
    def base_span(self) -> builtins.int:
        """
    ...
    def target_line(self) -> builtins.int:
        """
    ...
    def target_span(self) -> builtins.int:
        """
...
class GetRepositoryDiffChangeDiffSectionResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str type: Type of change.
        """
...
class GetRepositoryDiffChangeDiffSectionLineResult(dict):
    def __init__(__self__, *,
                 base_line: builtins.int,
                 conflict_marker: builtins.str,
                 line_content: builtins.str,
                 target_line: builtins.int):
        """
        :param builtins.int base_line: The number of a line in the base version.
        :param builtins.str conflict_marker: Indicates whether a line in a conflicted section of the difference is from the base version, the target version, or if its just a marker indicating the beginning, middle, or end of a conflicted section.
        :param builtins.str line_content: The contents of a line.
        :param builtins.int target_line: Line number in target version where changes begin.
        """
        pulumi.set(__self__, "base_line", base_line)
    ...
    def conflict_marker(self) -> builtins.str:
        """
...
class GetRepositoryDiffsDiffCollectionItemResult(dict):
    def __init__(__self__, *,
                 are_conflicts_in_file: builtins.bool,
                 changes: Sequence['outputs.GetRepositoryDiffsDiffCollectionItemChangeResult'],
                 freeform_tags: Mapping[str, builtins.str],
                 is_binary: builtins.bool,
                 is_large: builtins.bool,
                 new_id: builtins.str,
                 new_path: builtins.str,
                 old_id: builtins.str,
                 old_path: builtins.str):
        """
        :param builtins.bool are_conflicts_in_file: Indicates whether the changed file contains conflicts.
        :param Sequence['GetRepositoryDiffsDiffCollectionItemChangeArgs'] changes: List of changed section in the file.
        :param builtins.bool is_binary: Indicates whether the file is binary.
        :param builtins.bool is_large: Indicates whether the file is large.
        :param builtins.str new_id: The ID of the changed object on the target version.
        :param builtins.str new_path: The path on the target version to the changed object.
        :param builtins.str old_id: The ID of the changed object on the base version.
        :param builtins.str old_path: The path on the base version to the changed object.
        """
...
class GetRepositoryMirrorRecordsRepositoryMirrorRecordCollectionItemResult(dict):
    def __init__(__self__, *,
                 freeform_tags: Mapping[str, builtins.str],
                 mirror_status: builtins.str,
                 time_completed: builtins.str,
                 time_enqueued: builtins.str,
                 time_started: builtins.str,
                 work_request_id: builtins.str):
        """
        :param builtins.str mirror_status: Mirror status of current mirror entry. QUEUED - Mirroring Queued RUNNING - Mirroring is Running PASSED - Mirroring Passed FAILED - Mirroring Failed
        :param builtins.str time_enqueued: The time to enqueue a mirror operation.
        :param builtins.str time_started: The time to start a mirror operation.
        :param builtins.str work_request_id: Workrequest ID to track current mirror operation.
        """
        pulumi.set(__self__, "freeform_tags", freeform_tags)
    ...
    def mirror_status(self) -> builtins.str:
        """
    ...
    def time_enqueued(self) -> builtins.str:
        """
...
class GetRepositoryPathItemResult(dict):
    def __init__(__self__, *,
                 ...
                 sha: builtins.str,
                 size_in_bytes: builtins.str,
                 submodule_git_url: builtins.str,
                 type: builtins.str):
        """
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"bar-key": "value"}`
        :param builtins.str name: Name of file or directory.
        :param builtins.str path: Path to file or directory in a repository.
        :param builtins.str sha: SHA-1 checksum of blob or tree.
        :param builtins.str size_in_bytes: Size of file or directory.
        :param builtins.str submodule_git_url: The git URL of the submodule.
        :param builtins.str type: File or directory.
        """
        pulumi.set(__self__, "defined_tags", defined_tags)
        pulumi.set(__self__, "freeform_tags", freeform_tags)
        pulumi.set(__self__, "name", name)
    ...
    def submodule_git_url(self) -> builtins.str:
        """
...
class GetRepositoryProtectedBranchesFilterResult(dict):
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: A filter to return only resources that match the given branch name.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
...
class GetRepositoryProtectedBranchesProtectedBranchCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 defined_tags: Mapping[str, builtins.str],
                 freeform_tags: Mapping[str, builtins.str],
                 protection_levels: Sequence[builtins.str],
                 system_tags: Mapping[str, builtins.str]):
        """
        :param builtins.str branch_name: Branch name inside a repository.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"bar-key": "value"}`
        :param Sequence[builtins.str] protection_levels: Protection level to be added on the branch.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"orcl-cloud.free-tier-retained": "true"}`
        """
    ...
    def protection_levels(self) -> Sequence[builtins.str]:
        """
...
class GetRepositoryRefsRepositoryRefCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 repository_id: builtins.str):
        """
        :param builtins.str commit_id: Commit ID in a repository.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"bar-key": "value"}`
        :param builtins.str full_ref_name: Unique full reference name inside a repository.
        :param builtins.str object_id: SHA-1 hash value of the object pointed to by the tag.
        :param builtins.str ref_name: A filter to return only resources that match the given reference name.
        :param builtins.str ref_type: Reference type to distinguish between branch and tag. If it is not specified, all references are returned.
    ...
    def full_ref_name(self) -> builtins.str:
        """
    ...
    def ref_type(self) -> builtins.str:
        """
...
class GetRepositorySettingMergeCheckResult(dict):
    def __init__(__self__, *,
                 last_build_succeeded: builtins.str):
        """
        :param builtins.str last_build_succeeded: Indicates whether or not a pull request must have a successful build run and no queued builds before it can be merged
        """
        pulumi.set(__self__, "last_build_succeeded", last_build_succeeded)
...
class GetTriggersTriggerCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str compartment_id: The OCID of the compartment in which to list resources.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str description: Description about the trigger.
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"bar-key": "value"}`
        :param builtins.str id: Unique trigger identifier.
        :param builtins.str lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        :param builtins.str project_id: unique project identifier
        :param builtins.str repository_id: The OCID of the DevOps code repository.
        :param builtins.str state: A filter to return only triggers that matches the given lifecycle state.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The time the trigger was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param builtins.str time_updated: The time the trigger was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param builtins.str trigger_source: Source of the trigger. Allowed values are, GITHUB and GITLAB.
        :param builtins.str trigger_url: The endpoint that listens to trigger events.
        """
        pulumi.set(__self__, "actions", actions)
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "connection_id", connection_id)
