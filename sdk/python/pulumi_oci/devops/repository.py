...
class RepositoryArgs:
    def __init__(__self__, *,
                 ...
                 repository_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] project_id: The OCID of the DevOps project containing the repository.
        :param pulumi.Input[builtins.str] repository_type: (Updatable) Type of repository. Allowed values:  `MIRRORED`  `HOSTED` `FORKED` 
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] default_branch: (Updatable) The default branch of the repository.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Details of the repository. Avoid entering confidential information.
        ...
        :param pulumi.Input[builtins.str] name: (Updatable) Name of the repository. Should be unique within the project.
        :param pulumi.Input[builtins.str] parent_repository_id: The OCID of the parent repository.
        """
    ...
    def repository_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def repository_type(self, value: pulumi.Input[builtins.str]):
...
class _RepositoryState:
    def __init__(__self__, *,
                 branch_count: Optional[pulumi.Input[builtins.int]] = None,
                 commit_count: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 repository_type: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 trigger_build_events: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        Input properties used for looking up and filtering Repository resources.
        :param pulumi.Input[builtins.int] branch_count: The count of the branches present in the repository.
        :param pulumi.Input[builtins.int] commit_count: The count of the commits present in the repository.
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the repository's compartment.
        :param pulumi.Input[builtins.str] default_branch: (Updatable) The default branch of the repository.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] description: (Updatable) Details of the repository. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.str] http_url: HTTP URL that you use to git clone, pull and push.
        ...
        :param pulumi.Input['RepositoryMirrorRepositoryConfigArgs'] mirror_repository_config: (Updatable) Configuration information for mirroring the repository.
        :param pulumi.Input[builtins.str] name: (Updatable) Name of the repository. Should be unique within the project.
        :param pulumi.Input[builtins.str] namespace: Tenancy unique namespace.
        :param pulumi.Input[builtins.str] parent_repository_id: The OCID of the parent repository.
        :param pulumi.Input[builtins.str] project_id: The OCID of the DevOps project containing the repository.
        :param pulumi.Input[builtins.str] project_name: Unique project name in a namespace.
        :param pulumi.Input[builtins.str] repository_type: (Updatable) Type of repository. Allowed values:  `MIRRORED`  `HOSTED` `FORKED` 
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] size_in_bytes: The size of the repository in bytes.
        :param pulumi.Input[builtins.str] ssh_url: SSH URL that you use to git clone, pull and push.
        :param pulumi.Input[builtins.str] state: The current state of the repository.
        ...
        :param pulumi.Input[builtins.str] time_created: The time the repository was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param pulumi.Input[builtins.str] time_updated: The time the repository was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] trigger_build_events: Trigger build events supported for this repository: PUSH - Build is triggered when a push event occurs. PULL_REQUEST_CREATED - Build is triggered when a pull request is created in the repository. PULL_REQUEST_UPDATED - Build is triggered when a push is made to a branch with an open pull request. COMMIT_UPDATES - Build is triggered when new commits are mirrored into a repository.
        """
    ...
    def branch_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @branch_count.setter
    def branch_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "branch_count", value)

    @property
    @pulumi.getter(name="commitCount")
    def commit_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @commit_count.setter
    def commit_count(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    @property
    @pulumi.getter(name="repositoryType")
    def repository_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Type of repository. Allowed values:  `MIRRORED`  `HOSTED` `FORKED` 
    ...
    @repository_type.setter
    def repository_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "repository_type", value)
    ...
    def trigger_build_events(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Trigger build events supported for this repository: PUSH - Build is triggered when a push event occurs. PULL_REQUEST_CREATED - Build is triggered when a pull request is created in the repository. PULL_REQUEST_UPDATED - Build is triggered when a push is made to a branch with an open pull request. COMMIT_UPDATES - Build is triggered when new commits are mirrored into a repository.
        """
    ...
    def trigger_build_events(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class Repository(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            trigger_build_events: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Repository':
        """
    ...
    @property
    @pulumi.getter(name="branchCount")
    def branch_count(self) -> pulumi.Output[builtins.int]:
        """
        The count of the branches present in the repository.
        """
        return pulumi.get(self, "branch_count")
    ...
    @property
    @pulumi.getter(name="commitCount")
    def commit_count(self) -> pulumi.Output[builtins.int]:
        """
        The count of the commits present in the repository.
        """
        return pulumi.get(self, "commit_count")
    ...
    @property
    @pulumi.getter(name="httpUrl")
    def http_url(self) -> pulumi.Output[builtins.str]:
        """
        HTTP URL that you use to git clone, pull and push.
        """
        return pulumi.get(self, "http_url")
    ...
    @property
    @pulumi.getter(name="parentRepositoryId")
    def parent_repository_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the parent repository.
        """
        return pulumi.get(self, "parent_repository_id")
    ...
    @property
    @pulumi.getter(name="repositoryType")
    def repository_type(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Type of repository. Allowed values:  `MIRRORED`  `HOSTED` `FORKED` 
    ...
    @property
    @pulumi.getter(name="triggerBuildEvents")
    def trigger_build_events(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Trigger build events supported for this repository: PUSH - Build is triggered when a push event occurs. PULL_REQUEST_CREATED - Build is triggered when a pull request is created in the repository. PULL_REQUEST_UPDATED - Build is triggered when a push is made to a branch with an open pull request. COMMIT_UPDATES - Build is triggered when new commits are mirrored into a repository.
        """
        return pulumi.get(self, "trigger_build_events")
