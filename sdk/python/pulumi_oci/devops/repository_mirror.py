...
class RepositoryMirror(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(RepositoryMirrorArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = RepositoryMirrorArgs.__new__(RepositoryMirrorArgs)

            if repository_id is None and not opts.urn:
                raise TypeError("Missing required property 'repository_id'")
            __props__.__dict__["repository_id"] = repository_id
        super(RepositoryMirror, __self__).__init__(
            'oci:DevOps/repositoryMirror:RepositoryMirror',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            repository_id: Optional[pulumi.Input[builtins.str]] = None) -> 'RepositoryMirror':
        """
        ...
        __props__ = _RepositoryMirrorState.__new__(_RepositoryMirrorState)

        __props__.__dict__["repository_id"] = repository_id
        return RepositoryMirror(resource_name, opts=opts, __props__=__props__)
