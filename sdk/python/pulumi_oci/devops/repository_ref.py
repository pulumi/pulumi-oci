...
class RepositoryRefArgs:
    def __init__(__self__, *,
                 ref_name: pulumi.Input[builtins.str],
                 ref_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] ref_name: A filter to return only resources that match the given reference name.
        :param pulumi.Input[builtins.str] ref_type: (Updatable) The type of reference (BRANCH or TAG).
        :param pulumi.Input[builtins.str] repository_id: Unique repository identifier.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] commit_id: (Updatable) Commit ID pointed to by the new branch.
        :param pulumi.Input[builtins.str] object_id: (Updatable) SHA-1 hash value of the object pointed to by the tag.
        """
    ...
    def ref_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @ref_name.setter
    def ref_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "ref_name", value)

    @property
    @pulumi.getter(name="refType")
    def ref_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @ref_type.setter
    def ref_type(self, value: pulumi.Input[builtins.str]):
...
class _RepositoryRefState:
    def __init__(__self__, *,
                 ...
                 full_ref_name: Optional[pulumi.Input[builtins.str]] = None,
                 object_id: Optional[pulumi.Input[builtins.str]] = None,
                 ref_name: Optional[pulumi.Input[builtins.str]] = None,
                 ref_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] commit_id: (Updatable) Commit ID pointed to by the new branch.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        ...
        :param pulumi.Input[builtins.str] full_ref_name: Unique full reference name inside a repository.
        :param pulumi.Input[builtins.str] object_id: (Updatable) SHA-1 hash value of the object pointed to by the tag.
        :param pulumi.Input[builtins.str] ref_name: A filter to return only resources that match the given reference name.
        :param pulumi.Input[builtins.str] ref_type: (Updatable) The type of reference (BRANCH or TAG).
        :param pulumi.Input[builtins.str] repository_id: Unique repository identifier.
    ...
    def full_ref_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def full_ref_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="refName")
    def ref_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A filter to return only resources that match the given reference name.
        """
        return pulumi.get(self, "ref_name")
    ...
    @ref_name.setter
    def ref_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ref_name", value)

    @property
    @pulumi.getter(name="refType")
    def ref_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The type of reference (BRANCH or TAG).
        """
        return pulumi.get(self, "ref_type")
    ...
    @ref_type.setter
    def ref_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ref_type", value)
...
class RepositoryRef(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ref_name: Optional[pulumi.Input[builtins.str]] = None,
            ref_type: Optional[pulumi.Input[builtins.str]] = None,
            repository_id: Optional[pulumi.Input[builtins.str]] = None) -> 'RepositoryRef':
        """
    ...
    @property
    @pulumi.getter(name="commitId")
    def commit_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Commit ID pointed to by the new branch.
        """
        return pulumi.get(self, "commit_id")
    ...
    @property
    @pulumi.getter(name="fullRefName")
    def full_ref_name(self) -> pulumi.Output[builtins.str]:
        """
        Unique full reference name inside a repository.
        """
        return pulumi.get(self, "full_ref_name")
    ...
    @property
    @pulumi.getter(name="refName")
    def ref_name(self) -> pulumi.Output[builtins.str]:
        """
        A filter to return only resources that match the given reference name.
        """
        return pulumi.get(self, "ref_name")
    ...
    @property
    @pulumi.getter(name="refType")
    def ref_type(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The type of reference (BRANCH or TAG).
        """
        return pulumi.get(self, "ref_type")
