...
class TriggerArgs:
    def __init__(__self__, *,
                 ...
                 trigger_source: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] project_id: The OCID of the DevOps project to which the trigger belongs to.
        :param pulumi.Input[builtins.str] trigger_source: (Updatable) Source of the trigger. Allowed values are,  GITHUB, GITLAB, BITBUCKET_CLOUD, VBS and DEVOPS_CODE_REPOSITORY.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] connection_id: (Updatable) The OCID of the connection resource used to get details for triggered events.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Optional description about the trigger.
        :param pulumi.Input[builtins.str] display_name: (Updatable) Trigger display name. Avoid entering confidential information.
        ...
        :param pulumi.Input[builtins.str] repository_id: (Updatable) The OCID of the DevOps code repository.
        """
    ...
    def trigger_source(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def trigger_source(self, value: pulumi.Input[builtins.str]):
...
class _TriggerState:
    def __init__(__self__, *,
                 ...
                 trigger_source: Optional[pulumi.Input[builtins.str]] = None,
                 trigger_url: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Trigger resources.
        :param pulumi.Input[Sequence[pulumi.Input['TriggerActionArgs']]] actions: (Updatable) The list of actions that are to be performed for this trigger.
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment that contains the trigger.
        :param pulumi.Input[builtins.str] connection_id: (Updatable) The OCID of the connection resource used to get details for triggered events.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. See [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] description: (Updatable) Optional description about the trigger.
        :param pulumi.Input[builtins.str] display_name: (Updatable) Trigger display name. Avoid entering confidential information.
        ...
        :param pulumi.Input[builtins.str] time_created: The time the trigger was created. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param pulumi.Input[builtins.str] time_updated: The time the trigger was updated. Format defined by [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339).
        :param pulumi.Input[builtins.str] trigger_source: (Updatable) Source of the trigger. Allowed values are,  GITHUB, GITLAB, BITBUCKET_CLOUD, VBS and DEVOPS_CODE_REPOSITORY.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] trigger_url: The endpoint that listens to trigger events.
        """
    ...
    @property
    @pulumi.getter(name="triggerSource")
    def trigger_source(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Source of the trigger. Allowed values are,  GITHUB, GITLAB, BITBUCKET_CLOUD, VBS and DEVOPS_CODE_REPOSITORY.
    ...
    @trigger_source.setter
    def trigger_source(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "trigger_source", value)

    @property
    @pulumi.getter(name="triggerUrl")
    def trigger_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @trigger_url.setter
    def trigger_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Trigger(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            trigger_source: Optional[pulumi.Input[builtins.str]] = None,
            trigger_url: Optional[pulumi.Input[builtins.str]] = None) -> 'Trigger':
        """
    ...
    @property
    @pulumi.getter(name="triggerSource")
    def trigger_source(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Source of the trigger. Allowed values are,  GITHUB, GITLAB, BITBUCKET_CLOUD, VBS and DEVOPS_CODE_REPOSITORY.
    ...
    @property
    @pulumi.getter(name="triggerUrl")
    def trigger_url(self) -> pulumi.Output[builtins.str]:
        """
        The endpoint that listens to trigger events.
        """
        return pulumi.get(self, "trigger_url")
