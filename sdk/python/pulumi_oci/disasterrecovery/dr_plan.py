...
class DrPlanArgs:
    def __init__(__self__, *,
                 ...
                 dr_protection_group_id: pulumi.Input[builtins.str],
                 type: pulumi.Input[builtins.str],
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 refresh_trigger: Optional[pulumi.Input[builtins.int]] = None,
                 source_plan_id: Optional[pulumi.Input[builtins.str]] = None,
                 verify_trigger: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] dr_protection_group_id: The OCID of the DR protection group to which this DR plan belongs.  Example: `ocid1.drprotectiongroup.oc1..uniqueID`
        :param pulumi.Input[builtins.str] type: The type of DR plan to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace.  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  Example: `{"Department": "Finance"}`
        ...
        :param pulumi.Input[builtins.str] source_plan_id: The OCID of the source DR plan that should be cloned.  Example: `ocid1.drplan.oc1..uniqueID`
        :param pulumi.Input[builtins.int] verify_trigger: (Updatable) An optional property when incremented triggers Verify. Could be set to any integer value.
    ...
    def dr_protection_group_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def dr_protection_group_id(self, value: pulumi.Input[builtins.str]):
    ...
    def source_plan_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_plan_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_plan_id", value)

    @property
    @pulumi.getter(name="verifyTrigger")
    def verify_trigger(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def verify_trigger(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _DrPlanState:
    def __init__(__self__, *,
                 ...
                 dr_protection_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 life_cycle_details: Optional[pulumi.Input[builtins.str]] = None,
                 lifecycle_sub_state: Optional[pulumi.Input[builtins.str]] = None,
                 peer_dr_protection_group_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment containing the DR plan.  Example: `ocid1.compartment.oc1..uniqueID`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace.  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the DR plan being created.  Example: `EBS Switchover PHX to IAD`
        :param pulumi.Input[builtins.str] dr_protection_group_id: The OCID of the DR protection group to which this DR plan belongs.  Example: `ocid1.drprotectiongroup.oc1..uniqueID`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] life_cycle_details: A message describing the DR plan's current state in more detail.
        :param pulumi.Input[builtins.str] lifecycle_sub_state: The current state of the DR plan.
        :param pulumi.Input[builtins.str] peer_dr_protection_group_id: The OCID of the peer DR protection group associated with this plan's DR protection group.  Example: `ocid1.drprotectiongroup.oc1..uniqueID`
        :param pulumi.Input[builtins.str] peer_region: The region of the peer DR protection group associated with this plan's DR protection group.  Example: `us-ashburn-1`
        :param pulumi.Input[Sequence[pulumi.Input['DrPlanPlanGroupArgs']]] plan_groups: The list of groups in this DR plan.
        :param pulumi.Input[builtins.int] refresh_trigger: (Updatable) An optional property when incremented triggers Refresh. Could be set to any integer value.
        :param pulumi.Input[builtins.str] source_plan_id: The OCID of the source DR plan that should be cloned.  Example: `ocid1.drplan.oc1..uniqueID`
        :param pulumi.Input[builtins.str] state: The current state of the DR plan.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the DR plan was created. An RFC3339 formatted datetime string.  Example: `2019-03-29T09:36:42Z`
        :param pulumi.Input[builtins.str] time_updated: The date and time the DR plan was updated. An RFC3339 formatted datetime string.  Example: `2019-03-29T09:36:42Z`
        :param pulumi.Input[builtins.str] type: The type of DR plan to be created.
        :param pulumi.Input[builtins.int] verify_trigger: (Updatable) An optional property when incremented triggers Verify. Could be set to any integer value.
    ...
    @property
    @pulumi.getter(name="drProtectionGroupId")
    def dr_protection_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The OCID of the DR protection group to which this DR plan belongs.  Example: `ocid1.drprotectiongroup.oc1..uniqueID`
        """
        return pulumi.get(self, "dr_protection_group_id")
    ...
    @dr_protection_group_id.setter
    def dr_protection_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dr_protection_group_id", value)
    ...
    def life_cycle_details(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def life_cycle_details(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def peer_dr_protection_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def peer_dr_protection_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DrPlan(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            verify_trigger: Optional[pulumi.Input[builtins.int]] = None) -> 'DrPlan':
        """
    ...
    @property
    @pulumi.getter(name="drProtectionGroupId")
    def dr_protection_group_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the DR protection group to which this DR plan belongs.  Example: `ocid1.drprotectiongroup.oc1..uniqueID`
        """
        return pulumi.get(self, "dr_protection_group_id")
    ...
    @property
    @pulumi.getter(name="lifeCycleDetails")
    def life_cycle_details(self) -> pulumi.Output[builtins.str]:
        """
        A message describing the DR plan's current state in more detail.
        """
        return pulumi.get(self, "life_cycle_details")
    ...
    @property
    @pulumi.getter(name="peerDrProtectionGroupId")
    def peer_dr_protection_group_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the peer DR protection group associated with this plan's DR protection group.  Example: `ocid1.drprotectiongroup.oc1..uniqueID`
        """
        return pulumi.get(self, "peer_dr_protection_group_id")
    ...
    @property
    @pulumi.getter(name="sourcePlanId")
    def source_plan_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the source DR plan that should be cloned.  Example: `ocid1.drplan.oc1..uniqueID`
        """
        return pulumi.get(self, "source_plan_id")
    ...
    @property
    @pulumi.getter(name="verifyTrigger")
    def verify_trigger(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        (Updatable) An optional property when incremented triggers Verify. Could be set to any integer value.
