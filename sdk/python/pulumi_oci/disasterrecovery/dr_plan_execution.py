...
class DrPlanExecutionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] plan_id: The OCID of the DR plan.  Example: `ocid1.drplan.oc1..uniqueID` 
...
class _DrPlanExecutionState:
    def __init__(__self__, *,
                 ...
                 plan_execution_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment containing this DR plan execution.  Example: `ocid1.compartment.oc1..uniqueID`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace.  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the DR plan execution.  Example: `Execution - EBS Switchover PHX to IAD`
        :param pulumi.Input[builtins.str] dr_protection_group_id: The OCID of the DR protection group to which this DR plan execution belongs.  Example: `ocid1.drprotectiongroup.oc1..uniqueID`
        ...
        :param pulumi.Input[builtins.str] life_cycle_details: A message describing the DR plan execution's current state in more detail.
        ...
        :param pulumi.Input[builtins.str] peer_dr_protection_group_id: The OCID of peer DR protection group associated with this plan's DR protection group.  Example: `ocid1.drprotectiongroup.oc1..uniqueID`
        ...
        :param pulumi.Input[builtins.str] plan_execution_type: The type of the DR plan executed.
        :param pulumi.Input[builtins.str] plan_id: The OCID of the DR plan.  Example: `ocid1.drplan.oc1..uniqueID` 
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The current state of the DR plan execution.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time at which DR plan execution was created. An RFC3339 formatted datetime string.  Example: `2019-03-29T09:36:42Z`
        ...
        :param pulumi.Input[builtins.str] time_updated: The time when DR plan execution was last updated. An RFC3339 formatted datetime string.  Example: `2019-03-29T09:36:42Z`
        """
    ...
    def plan_execution_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def plan_execution_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DrPlanExecution(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_ended: Optional[pulumi.Input[builtins.str]] = None,
            time_started: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'DrPlanExecution':
        """
    ...
    @property
    @pulumi.getter(name="executionDurationInSec")
    def execution_duration_in_sec(self) -> pulumi.Output[builtins.int]:
        """
        The total duration in seconds taken to complete the step execution.  Example: `35`
        """
        return pulumi.get(self, "execution_duration_in_sec")
    ...
    @property
    @pulumi.getter(name="planExecutionType")
    def plan_execution_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of the DR plan executed.
        """
        return pulumi.get(self, "plan_execution_type")
