...
class DrProtectionGroupArgs:
    def __init__(__self__, *,
                 ...
                 disassociate_trigger: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment in which to create the DR protection group.  Example: `ocid1.compartment.oc1..uniqueID`
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the DR protection group.  Example: `EBS PHX Group`
        ...
        :param pulumi.Input[builtins.int] disassociate_trigger: (Updatable) An optional property when incremented triggers Disassociate. Could be set to any integer value.
    ...
    def disassociate_trigger(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def disassociate_trigger(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _DrProtectionGroupState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the DR protection group.  Example: `EBS PHX Group`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] life_cycle_details: A message describing the DR protection group's current state in more detail.
        :param pulumi.Input[builtins.str] lifecycle_sub_state: The current sub-state of the DR protection group.
        :param pulumi.Input['DrProtectionGroupLogLocationArgs'] log_location: (Updatable) The details for creating an object storage log location for a DR protection group.
        :param pulumi.Input[Sequence[pulumi.Input['DrProtectionGroupMemberArgs']]] members: (Updatable) A list of DR protection group members.
        ...
        :param pulumi.Input[builtins.str] role: The role of the DR protection group.
        :param pulumi.Input[builtins.str] state: The current state of the DR protection group.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the DR protection group was created. An RFC3339 formatted datetime string.  Example: `2019-03-29T09:36:42Z`
        :param pulumi.Input[builtins.str] time_updated: The date and time the DR protection group was updated. An RFC3339 formatted datetime string.  Example: `2019-03-29T09:36:42Z`
        """
        if association is not None:
            pulumi.set(__self__, "association", association)
...
class DrProtectionGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'DrProtectionGroup':
        """
    ...
    @property
    @pulumi.getter(name="disassociateTrigger")
    def disassociate_trigger(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        (Updatable) An optional property when incremented triggers Disassociate. Could be set to any integer value.
