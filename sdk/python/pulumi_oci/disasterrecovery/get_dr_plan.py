...
class GetDrPlanResult:
    ...
    def dr_plan_id(self) -> builtins.str:
...
def get_dr_plan(dr_plan_id: Optional[builtins.str] = None,
...
def get_dr_plan_output(dr_plan_id: Optional[pulumi.Input[builtins.str]] = None,
