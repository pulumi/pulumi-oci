...
class GetDrPlanExecutionResult:
    ...
    def dr_plan_execution_id(self) -> builtins.str:
...
def get_dr_plan_execution(dr_plan_execution_id: Optional[builtins.str] = None,
...
def get_dr_plan_execution_output(dr_plan_execution_id: Optional[pulumi.Input[builtins.str]] = None,
