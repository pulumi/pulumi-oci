...
class GetDrPlanExecutionsResult:
    ...
    def dr_plan_execution_id(self) -> Optional[_builtins.str]:
...
def get_dr_plan_executions(display_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dr_plan_execution_id: The OCID of the DR plan execution.  Example: `ocid1.drplanexecution.oc1..uniqueID`
