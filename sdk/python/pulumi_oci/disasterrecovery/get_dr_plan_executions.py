...
class GetDrPlanExecutionsResult:
    ...
    def dr_plan_execution_id(self) -> Optional[builtins.str]:
...
def get_dr_plan_executions(display_name: Optional[builtins.str] = None,
                           dr_plan_execution_id: Optional[builtins.str] = None,
    ...
    :param builtins.str dr_plan_execution_id: The OCID of the DR plan execution.  Example: `ocid1.drplanexecution.oc1..uniqueID`
...
def get_dr_plan_executions_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  dr_plan_execution_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
