...
class GetDrPlansResult:
    ...
    def dr_plan_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "dr_plan_id")

    @property
    @pulumi.getter(name="drPlanType")
    def dr_plan_type(self) -> Optional[builtins.str]:
    ...
    def lifecycle_sub_state(self) -> Optional[builtins.str]:
        """
...
def get_dr_plans(display_name: Optional[builtins.str] = None,
                 dr_plan_id: Optional[builtins.str] = None,
                 dr_plan_type: Optional[builtins.str] = None,
                 dr_protection_group_id: Optional[builtins.str] = None,
                 filters: Optional[Sequence[Union['GetDrPlansFilterArgs', 'GetDrPlansFilterArgsDict']]] = None,
                 lifecycle_sub_state: Optional[builtins.str] = None,
    ...
    :param builtins.str dr_plan_id: The OCID of the DR plan.  Example: `ocid1.drplan.oc1..uniqueID`
    :param builtins.str dr_plan_type: The DR plan type.
...
def get_dr_plans_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        dr_plan_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        dr_plan_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        ...
                        lifecycle_sub_state: Optional[pulumi.Input[Optional[builtins.str]]] = None,
