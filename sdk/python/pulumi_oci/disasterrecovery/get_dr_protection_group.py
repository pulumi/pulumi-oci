...
def get_dr_protection_group(dr_protection_group_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dr_protection_group_id: The OCID of the DR protection group.  Example: `ocid1.drprotectiongroup.oc1..uniqueID`
    """
    __args__ = dict()
...
def get_dr_protection_group_output(dr_protection_group_id: Optional[pulumi.Input[_builtins.str]] = None,
