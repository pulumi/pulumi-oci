...
class GetDrProtectionGroupsResult:
    ...
    def dr_protection_group_id(self) -> Optional[builtins.str]:
...
def get_dr_protection_groups(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str dr_protection_group_id: The OCID of the DR protection group. Optional query param.  Example: `ocid1.drprotectiongroup.oc1..uniqueID`
...
def get_dr_protection_groups_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                    display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    dr_protection_group_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
