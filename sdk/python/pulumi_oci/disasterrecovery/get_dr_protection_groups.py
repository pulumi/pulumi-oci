...
class GetDrProtectionGroupsResult:
    ...
    def dr_protection_group_id(self) -> Optional[_builtins.str]:
...
def get_dr_protection_groups(compartment_id: Optional[_builtins.str] = None,
                             display_name: Optional[_builtins.str] = None,
                             dr_protection_group_id: Optional[_builtins.str] = None,
                             filters: Optional[Sequence[Union['GetDrProtectionGroupsFilterArgs', 'GetDrProtectionGroupsFilterArgsDict', 'outputs.GetDrProtectionGroupsFilterResult']]] = None,
    ...
    :param _builtins.str dr_protection_group_id: The OCID of the DR protection group. Optional query param.  Example: `ocid1.drprotectiongroup.oc1..uniqueID`
...
def get_dr_protection_groups_output(compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                                    display_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                    dr_protection_group_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                    filters: pulumi.Input[Optional[Optional[Sequence[Union['GetDrProtectionGroupsFilterArgs', 'GetDrProtectionGroupsFilterArgsDict', 'outputs.GetDrProtectionGroupsFilterResult']]]]] = None,
