...
if not MYPY:
    class ActionCreateZoneFromZoneFileDnssecConfigKskDnssecKeyVersionArgsDict(TypedDict):
        ...
        length_in_bytes: NotRequired[pulumi.Input[builtins.int]]
        predecessor_dnssec_key_version_uuid: NotRequired[pulumi.Input[builtins.str]]
        successor_dnssec_key_version_uuid: NotRequired[pulumi.Input[builtins.str]]
        time_activated: NotRequired[pulumi.Input[builtins.str]]
        time_created: NotRequired[pulumi.Input[builtins.str]]
        """
        The date and time the resource was created in "YYYY-MM-ddThh:mm:ssZ" format with a Z offset, as defined by RFC 3339.
        """
        time_expired: NotRequired[pulumi.Input[builtins.str]]
        time_inactivated: NotRequired[pulumi.Input[builtins.str]]
        time_promoted: NotRequired[pulumi.Input[builtins.str]]
        time_published: NotRequired[pulumi.Input[builtins.str]]
        time_unpublished: NotRequired[pulumi.Input[builtins.str]]
...
class ActionCreateZoneFromZoneFileDnssecConfigKskDnssecKeyVersionArgs:
    def __init__(__self__, *,
                 ...
                 length_in_bytes: Optional[pulumi.Input[builtins.int]] = None,
                 predecessor_dnssec_key_version_uuid: Optional[pulumi.Input[builtins.str]] = None,
                 successor_dnssec_key_version_uuid: Optional[pulumi.Input[builtins.str]] = None,
                 time_activated: Optional[pulumi.Input[builtins.str]] = None,
                 time_created: Optional[pulumi.Input[builtins.str]] = None,
                 time_expired: Optional[pulumi.Input[builtins.str]] = None,
                 time_inactivated: Optional[pulumi.Input[builtins.str]] = None,
                 time_promoted: Optional[pulumi.Input[builtins.str]] = None,
                 time_published: Optional[pulumi.Input[builtins.str]] = None,
                 time_unpublished: Optional[pulumi.Input[builtins.str]] = None,
    ...
    def length_in_bytes(self) -> Optional[pulumi.Input[builtins.int]]:
        return pulumi.get(self, "length_in_bytes")

    @length_in_bytes.setter
    def length_in_bytes(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def successor_dnssec_key_version_uuid(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "successor_dnssec_key_version_uuid")

    @successor_dnssec_key_version_uuid.setter
    def successor_dnssec_key_version_uuid(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "successor_dnssec_key_version_uuid", value)

    @property
    @pulumi.getter(name="timeActivated")
    def time_activated(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "time_activated")

    @time_activated.setter
    def time_activated(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_expired(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "time_expired")

    @time_expired.setter
    def time_expired(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_expired", value)

    @property
    @pulumi.getter(name="timeInactivated")
    def time_inactivated(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "time_inactivated")

    @time_inactivated.setter
    def time_inactivated(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_inactivated", value)

    @property
    @pulumi.getter(name="timePromoted")
    def time_promoted(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "time_promoted")

    @time_promoted.setter
    def time_promoted(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_promoted", value)

    @property
    @pulumi.getter(name="timePublished")
    def time_published(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "time_published")

    @time_published.setter
    def time_published(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_published", value)

    @property
    @pulumi.getter(name="timeUnpublished")
    def time_unpublished(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "time_unpublished")

    @time_unpublished.setter
    def time_unpublished(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class ActionCreateZoneFromZoneFileExternalDownstreamArgsDict(TypedDict):
        ...
        The server's port.
        """
        tsig_key_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ActionCreateZoneFromZoneFileExternalDownstreamArgs:
    def __init__(__self__, *,
                 ...
                 tsig_key_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] address: The server's IP address (IPv4 or IPv6).
        :param pulumi.Input[builtins.int] port: The server's port.
        :param pulumi.Input[builtins.str] tsig_key_id: The OCID of the TSIG key.
        """
    ...
    def tsig_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The OCID of the TSIG key.
        """
    ...
    @tsig_key_id.setter
    def tsig_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ActionCreateZoneFromZoneFileNameserverArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] hostname: The hostname of the nameserver.
        """
...
if not MYPY:
    class ActionCreateZoneFromZoneFileZoneTransferServerArgsDict(TypedDict):
        ...
        The server's IP address (IPv4 or IPv6).
        """
        is_transfer_destination: NotRequired[pulumi.Input[builtins.bool]]
        """
        A Boolean flag indicating whether or not the server is a zone data transfer destination.
        """
        is_transfer_source: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ActionCreateZoneFromZoneFileZoneTransferServerArgs:
    def __init__(__self__, *,
                 address: Optional[pulumi.Input[builtins.str]] = None,
                 is_transfer_destination: Optional[pulumi.Input[builtins.bool]] = None,
                 is_transfer_source: Optional[pulumi.Input[builtins.bool]] = None,
                 port: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] address: The server's IP address (IPv4 or IPv6).
        :param pulumi.Input[builtins.bool] is_transfer_destination: A Boolean flag indicating whether or not the server is a zone data transfer destination.
        :param pulumi.Input[builtins.bool] is_transfer_source: A Boolean flag indicating whether or not the server is a zone data transfer source.
        :param pulumi.Input[builtins.int] port: The server's port.
        """
        if address is not None:
            pulumi.set(__self__, "address", address)
    ...
    def is_transfer_destination(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        A Boolean flag indicating whether or not the server is a zone data transfer destination.
        """
    ...
    def is_transfer_destination(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_transfer_destination", value)

    @property
    @pulumi.getter(name="isTransferSource")
    def is_transfer_source(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        A Boolean flag indicating whether or not the server is a zone data transfer source.
        """
    ...
    def is_transfer_source(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ResolverAttachedViewArgs:
    def __init__(__self__, *,
                 view_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] view_id: (Updatable) The OCID of the view.
        """
...
if not MYPY:
    class ResolverEndpointArgsDict(TypedDict):
        ...
        """
        forwarding_address: NotRequired[pulumi.Input[builtins.str]]
        """
        An IP address from which forwarded queries may be sent. For VNIC endpoints, this IP address must be part of the subnet and will be assigned by the system if unspecified when isForwarding is true.
        """
        is_forwarding: NotRequired[pulumi.Input[builtins.bool]]
        """
        A Boolean flag indicating whether or not the resolver endpoint is for forwarding.
        """
        is_listening: NotRequired[pulumi.Input[builtins.bool]]
        """
        A Boolean flag indicating whether or not the resolver endpoint is for listening.
        """
        listening_address: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ResolverEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] endpoint_type: The type of resolver endpoint. VNIC is currently the only supported type.
...
if not MYPY:
    class ResolverRuleArgsDict(TypedDict):
        ...
        * `FORWARD` - Matching requests will be forwarded from the source interface to the destination address.
        """
        destination_addresses: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]
        """
        (Updatable) IP addresses to which queries should be forwarded. Currently limited to a single address.
        """
        source_endpoint_name: pulumi.Input[builtins.str]
        """
        ...
        """
        client_address_conditions: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        qname_cover_conditions: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ResolverRuleArgs:
    def __init__(__self__, *,
                 ...
                 destination_addresses: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 source_endpoint_name: pulumi.Input[builtins.str],
                 client_address_conditions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 qname_cover_conditions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] action: (Updatable) The action determines the behavior of the rule. If a query matches a supplied condition, the action will apply. If there are no conditions on the rule, all queries are subject to the specified action.
               * `FORWARD` - Matching requests will be forwarded from the source interface to the destination address.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] destination_addresses: (Updatable) IP addresses to which queries should be forwarded. Currently limited to a single address.
        :param pulumi.Input[builtins.str] source_endpoint_name: (Updatable) Case-insensitive name of an endpoint, that is a sub-resource of the resolver, to use as the forwarding interface. The endpoint must have isForwarding set to true.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] client_address_conditions: (Updatable) A list of CIDR blocks. The query must come from a client within one of the blocks in order for the rule action to apply.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] qname_cover_conditions: (Updatable) A list of domain names. The query must be covered by one of the domains in order for the rule action to apply.
        """
    ...
    def destination_addresses(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
        (Updatable) IP addresses to which queries should be forwarded. Currently limited to a single address.
        """
    ...
    def destination_addresses(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "destination_addresses", value)

    @property
    @pulumi.getter(name="sourceEndpointName")
    def source_endpoint_name(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) Case-insensitive name of an endpoint, that is a sub-resource of the resolver, to use as the forwarding interface. The endpoint must have isForwarding set to true.
        """
    ...
    def source_endpoint_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "source_endpoint_name", value)

    @property
    @pulumi.getter(name="clientAddressConditions")
    def client_address_conditions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        (Updatable) A list of CIDR blocks. The query must come from a client within one of the blocks in order for the rule action to apply.
        """
    ...
    def client_address_conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "client_address_conditions", value)

    @property
    @pulumi.getter(name="qnameCoverConditions")
    def qname_cover_conditions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        (Updatable) A list of domain names. The query must be covered by one of the domains in order for the rule action to apply.
        """
    ...
    def qname_cover_conditions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class RrsetItemArgsDict(TypedDict):
        ...
        """
        rdata: pulumi.Input[builtins.str]
        """
        ...
        """
        is_protected: NotRequired[pulumi.Input[builtins.bool]]
        """
        A Boolean flag indicating whether or not parts of the record are unable to be explicitly managed.
        """
        record_hash: NotRequired[pulumi.Input[builtins.str]]
        """
        A unique identifier for the record within its zone.
        """
        rrset_version: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RrsetItemArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] domain: The fully qualified domain name where the record can be located.
        :param pulumi.Input[builtins.str] rdata: (Updatable) The record's data, as whitespace-delimited tokens in type-specific presentation format. All RDATA is normalized and the returned presentation of your RDATA may differ from its initial input. For more information about RDATA, see [Supported DNS Resource Record Types](https://docs.cloud.oracle.com/iaas/Content/DNS/Reference/supporteddnsresource.htm)
        :param pulumi.Input[builtins.str] rtype: The type of DNS record, such as A or CNAME. For more information, see [Resource Record (RR) TYPEs](https://www.iana.org/assignments/dns-parameters/dns-parameters.xhtml#dns-parameters-4).
        :param pulumi.Input[builtins.int] ttl: (Updatable) The Time To Live for the record, in seconds. Using a TTL lower than 30 seconds is not recommended.
    ...
    @property
    @pulumi.getter
    def rdata(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The record's data, as whitespace-delimited tokens in type-specific presentation format. All RDATA is normalized and the returned presentation of your RDATA may differ from its initial input. For more information about RDATA, see [Supported DNS Resource Record Types](https://docs.cloud.oracle.com/iaas/Content/DNS/Reference/supporteddnsresource.htm)
        """
        return pulumi.get(self, "rdata")
    ...
    @rdata.setter
    def rdata(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "rdata", value)
...
if not MYPY:
    class SteeringPolicyAnswerArgsDict(TypedDict):
        ...
        """
        is_disabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class SteeringPolicyAnswerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: A user-friendly name for the answer, unique within the steering policy. An answer's `name` property can be referenced in `answerCondition` properties of rules using `answer.name`.
        :param pulumi.Input[builtins.str] rdata: The record's data, as whitespace-delimited tokens in type-specific presentation format. All RDATA is normalized and the returned presentation of your RDATA may differ from its initial input. For more information about RDATA, see [Supported DNS Resource Record Types](https://docs.cloud.oracle.com/iaas/Content/DNS/Reference/supporteddnsresource.htm).
        :param pulumi.Input[builtins.str] rtype: The type of DNS record, such as A or CNAME. Only A, AAAA, and CNAME are supported. For more information, see [Supported DNS Resource Record Types](https://docs.cloud.oracle.com/iaas/Content/DNS/Reference/supporteddnsresource.htm).
        :param pulumi.Input[builtins.bool] is_disabled: Set this property to `true` to indicate that the answer is administratively disabled, such as when the corresponding server is down for maintenance. An answer's `isDisabled` property can be referenced in `answerCondition` properties in rules using `answer.isDisabled`.
        :param pulumi.Input[builtins.str] pool: The freeform name of a group of one or more records in which this record is included, such as "LAX data center". An answer's `pool` property can be referenced in `answerCondition` properties of rules using `answer.pool`.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "rdata", rdata)
        pulumi.set(__self__, "rtype", rtype)
...
if not MYPY:
    class SteeringPolicyRuleArgsDict(TypedDict):
        ...
        * `LIMIT` - Filters answers that are too far down the list. Parameter `defaultCount` specifies how many answers to keep. **Example:** If `defaultCount` has a value of `2` and there are five answers left, when the `LIMIT` rule is processed, only the first two answers will remain in the list.
        ...
        """
        default_count: NotRequired[pulumi.Input[builtins.int]]
        """
...
class SteeringPolicyRuleArgs:
    def __init__(__self__, *,
                 ...
                 default_count: Optional[pulumi.Input[builtins.int]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] rule_type: The type of a rule determines its sorting/filtering behavior.
               * `FILTER` - Filters the list of answers based on their defined boolean data. Answers remain only if their `shouldKeep` value is `true`.
               * `HEALTH` - Removes answers from the list if their `rdata` matches a target in the health check monitor referenced by the steering policy and the target is reported down.
               * `WEIGHTED` - Uses a number between 0 and 255 to determine how often an answer will be served in relation to other answers. Anwers with a higher weight will be served more frequently.
               * `PRIORITY` - Uses a defined rank value of answers to determine which answer to serve, moving those with the lowest values to the beginning of the list without changing the relative order of those with the same value. Answers can be given a value between `0` and `255`.
        ...
        :param pulumi.Input[builtins.int] default_count: Defines a default count if `cases` is not defined for the rule or a matching case does not define `count`. `defaultCount` is **not** applied if `cases` is defined and there are no matching cases. In this scenario, the next rule will be processed. If no rules remain to be processed, the answer will be chosen from the remaining list of answers.
        :param pulumi.Input[builtins.str] description: A user-defined description of the rule's purpose or behavior.
        """
    ...
    def default_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Defines a default count if `cases` is not defined for the rule or a matching case does not define `count`. `defaultCount` is **not** applied if `cases` is defined and there are no matching cases. In this scenario, the next rule will be processed. If no rules remain to be processed, the answer will be chosen from the remaining list of answers.
        """
    ...
    def default_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class SteeringPolicyRuleCaseArgsDict(TypedDict):
        ...
        """
        case_condition: NotRequired[pulumi.Input[builtins.str]]
        """
...
class SteeringPolicyRuleCaseArgs:
    def __init__(__self__, *,
                 ...
                 case_condition: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] case_condition: An expression that uses conditions at the time of a DNS query to indicate whether a case matches. Conditions may include the geographical location, IP subnet, or ASN the DNS query originated. **Example:** If you have an office that uses the subnet `192.0.2.0/24` you could use a `caseCondition` expression `query.client.address in ('192.0.2.0/24')` to define a case that matches queries from that office.
        :param pulumi.Input[builtins.int] count: The number of answers allowed to remain after the limit rule has been processed, keeping only the first of the remaining answers in the list. Example: If the `count` property is set to `2` and four answers remain before the limit rule is processed, only the first two answers in the list will remain after the limit rule has been processed.
        """
    ...
    def case_condition(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        An expression that uses conditions at the time of a DNS query to indicate whether a case matches. Conditions may include the geographical location, IP subnet, or ASN the DNS query originated. **Example:** If you have an office that uses the subnet `192.0.2.0/24` you could use a `caseCondition` expression `query.client.address in ('192.0.2.0/24')` to define a case that matches queries from that office.
        """
    ...
    def case_condition(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class SteeringPolicyRuleCaseAnswerDataArgsDict(TypedDict):
        answer_condition: NotRequired[pulumi.Input[builtins.str]]
        """
        An expression that is used to select a set of answers that match a condition. For example, answers with matching pool properties.
        """
        should_keep: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class SteeringPolicyRuleCaseAnswerDataArgs:
    def __init__(__self__, *,
                 answer_condition: Optional[pulumi.Input[builtins.str]] = None,
                 should_keep: Optional[pulumi.Input[builtins.bool]] = None,
                 value: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] answer_condition: An expression that is used to select a set of answers that match a condition. For example, answers with matching pool properties.
        :param pulumi.Input[builtins.bool] should_keep: Keeps the answer only if the value is `true`.
        :param pulumi.Input[builtins.int] value: The rank assigned to the set of answers that match the expression in `answerCondition`. Answers with the lowest values move to the beginning of the list without changing the relative order of those with the same value. Answers can be given a value between `0` and `255`.
        """
    ...
    def answer_condition(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        An expression that is used to select a set of answers that match a condition. For example, answers with matching pool properties.
        """
    ...
    def answer_condition(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "answer_condition", value)

    @property
    @pulumi.getter(name="shouldKeep")
    def should_keep(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Keeps the answer only if the value is `true`.
        """
    ...
    @should_keep.setter
    def should_keep(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ZoneDnssecConfigKskDnssecKeyVersionArgs:
    def __init__(__self__, *,
                 ...
                 uuid: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] algorithm: The signing algorithm used for the key.
        ...
        :param pulumi.Input[builtins.int] key_tag: The key tag associated with the `DnssecKeyVersion`. This key tag will be present in the RRSIG and DS records associated with the key material for this `DnssecKeyVersion`. For more information about key tags, see [RFC 4034](https://tools.ietf.org/html/rfc4034).
        :param pulumi.Input[builtins.int] length_in_bytes: The length of the corresponding private key in bytes, expressed as an integer.
        :param pulumi.Input[builtins.str] predecessor_dnssec_key_version_uuid: When populated, this is the UUID of the `DnssecKeyVersion` that this `DnssecKeyVersion` will replace or has replaced.
        :param pulumi.Input[builtins.str] successor_dnssec_key_version_uuid: When populated, this is the UUID of the `DnssecKeyVersion` that will replace, or has replaced, this `DnssecKeyVersion`.
        :param pulumi.Input[builtins.str] time_activated: The date and time the key version went, or will go, active, expressed in RFC 3339 timestamp format. This is when the key material will be used to generate RRSIGs.
        :param pulumi.Input[builtins.str] time_created: The date and time the resource was created in "YYYY-MM-ddThh:mm:ssZ" format with a Z offset, as defined by RFC 3339.
        :param pulumi.Input[builtins.str] time_expired: The date and time at which the recommended key version publication/activation lifetime ends, expressed in RFC 3339 timestamp format. This is when the corresponding DNSKEY should no longer exist in zone contents and no longer be used to generate RRSIGs. For a key sigining key (KSK), if `PromoteZoneDnssecKeyVersion` has not been called on this `DnssecKeyVersion`'s successor then it will remain active for arbitrarily long past its recommended lifetime. This prevents service disruption at the potential increased risk of key compromise.
        :param pulumi.Input[builtins.str] time_inactivated: The date and time the key version went, or will go, inactive, expressed in RFC 3339 timestamp format. This is when the key material will no longer be used to generate RRSIGs. For a key signing key (KSK) `DnssecKeyVersion`, this is populated after `PromoteZoneDnssecKeyVersion` has been called on its successor `DnssecKeyVersion`.
        :param pulumi.Input[builtins.str] time_promoted: The date and time the key version was promoted expressed in RFC 3339 timestamp format.
        :param pulumi.Input[builtins.str] time_published: The date and time the key version was, or will be, published, expressed in RFC 3339 timestamp format. This is when the zone contents will include a DNSKEY record corresponding to the key material.
        :param pulumi.Input[builtins.str] time_unpublished: The date and time the key version was, or will be, unpublished, expressed in RFC 3339 timestamp format. This is when the corresponding DNSKEY will be removed from zone contents. For a key signing key (KSK) `DnssecKeyVersion`, this is populated after `PromoteZoneDnssecKeyVersion` has been called on its successor `DnssecKeyVersion`.
        :param pulumi.Input[builtins.str] uuid: The UUID of the `DnssecKeyVersion`.
        """
        if algorithm is not None:
            pulumi.set(__self__, "algorithm", algorithm)
        if ds_datas is not None:
...
class ZoneDnssecConfigKskDnssecKeyVersionDsDataArgs:
    def __init__(__self__, *,
                 ...
                 rdata: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] digest_type: The type of the digest associated with the rdata.
        :param pulumi.Input[builtins.str] rdata: Presentation-format DS record data that must be added to the parent zone. For more information about RDATA, see [Supported DNS Resource Record Types](https://docs.cloud.oracle.com/iaas/Content/DNS/Reference/supporteddnsresource.htm)
        """
        if digest_type is not None:
            pulumi.set(__self__, "digest_type", digest_type)
        if rdata is not None:
...
class ZoneExternalDownstreamArgs:
    def __init__(__self__, *,
                 ...
                 tsig_key_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] address: (Updatable) The server's IP address (IPv4 or IPv6).
        :param pulumi.Input[builtins.int] port: (Updatable) The server's port. Port value must be a value of 53, otherwise omit the port value.
        :param pulumi.Input[builtins.str] tsig_key_id: (Updatable) The OCID of the TSIG key. A TSIG key is used to secure DNS messages (in this case, zone transfers) between two systems that both have the (shared) secret.
        """
        pulumi.set(__self__, "address", address)
        if port is not None:
            pulumi.set(__self__, "port", port)
...
class ZoneExternalMasterArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] address: (Updatable) The server's IP address (IPv4 or IPv6).
        :param pulumi.Input[builtins.int] port: (Updatable) The server's port. Port value must be a value of 53, otherwise omit the port value.
        :param pulumi.Input[builtins.str] tsig_key_id: (Updatable) The OCID of the TSIG key.
        """
        pulumi.set(__self__, "address", address)
        if port is not None:
            pulumi.set(__self__, "port", port)
