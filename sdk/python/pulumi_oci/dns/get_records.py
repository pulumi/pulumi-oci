...
def get_records(compartment_id: Optional[_builtins.str] = None,
    ...
    **Deprecated. Use dns_get_rrsets instead.**
    ...
    :param _builtins.str sort_by: The field by which to sort records. Allowed values are: domain|rtype|ttl
    :param _builtins.str sort_order: The order to sort the resources. Allowed values are: ASC|DESC
