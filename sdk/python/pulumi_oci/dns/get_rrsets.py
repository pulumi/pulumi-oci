...
def get_rrsets(domain: Optional[builtins.str] = None,
    ...
    :param builtins.str domain_contains: Matches any rrset whose fully-qualified domain name (FQDN) contains the provided value.
    ...
    :param builtins.str view_id: The OCID of the view the zone is associated with. Required when accessing a private zone by name.
...
def get_rrsets_output(domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
