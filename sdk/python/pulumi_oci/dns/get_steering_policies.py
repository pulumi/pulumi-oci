...
class GetSteeringPoliciesResult:
    ...
    def health_check_monitor_id(self) -> Optional[_builtins.str]:
        """
...
def get_steering_policies(compartment_id: Optional[_builtins.str] = None,
                          display_name: Optional[_builtins.str] = None,
                          display_name_contains: Optional[_builtins.str] = None,
                          filters: Optional[Sequence[Union['GetSteeringPoliciesFilterArgs', 'GetSteeringPoliciesFilterArgsDict', 'outputs.GetSteeringPoliciesFilterResult']]] = None,
                          health_check_monitor_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str display_name_contains: The partial displayName of a resource. Will match any resource whose name (case-insensitive) contains the provided value.
...
def get_steering_policies_output(compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                                 ...
                                 filters: pulumi.Input[Optional[Optional[Sequence[Union['GetSteeringPoliciesFilterArgs', 'GetSteeringPoliciesFilterArgsDict', 'outputs.GetSteeringPoliciesFilterResult']]]]] = None,
