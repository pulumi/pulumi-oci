...
def get_steering_policy(steering_policy_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str steering_policy_id: The OCID of the target steering policy.
    """
    __args__ = dict()
...
def get_steering_policy_output(steering_policy_id: Optional[pulumi.Input[_builtins.str]] = None,
