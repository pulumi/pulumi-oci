...
class GetSteeringPolicyAttachmentResult:
    ...
    def steering_policy_attachment_id(self) -> _builtins.str:
...
def get_steering_policy_attachment(steering_policy_attachment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str steering_policy_attachment_id: The OCID of the target steering policy attachment.
    """
    __args__ = dict()
