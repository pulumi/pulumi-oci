...
def get_tsig_key(tsig_key_id: Optional[builtins.str] = None,
    ...
    :param builtins.str tsig_key_id: The OCID of the target TSIG key.
    """
    __args__ = dict()
...
def get_tsig_key_output(tsig_key_id: Optional[pulumi.Input[builtins.str]] = None,
