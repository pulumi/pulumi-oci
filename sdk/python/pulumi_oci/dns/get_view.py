...
def get_view(scope: Optional[builtins.str] = None,
    ...
    :param builtins.str scope: Value must be `PRIVATE` when listing views for private zones.
    :param builtins.str view_id: The OCID of the target view.
    """
    __args__ = dict()
...
def get_view_output(scope: Optional[pulumi.Input[Optional[builtins.str]]] = None,
