...
class GetZonesResult:
    ...
    def dnssec_state(self) -> Optional[_builtins.str]:
        """
...
def get_zones(compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str name_contains: Search by zone name. Will match any zone whose name (case-insensitive) contains the provided value.
    :param _builtins.str scope: Specifies to operate only on resources that have a matching DNS scope.
    :param _builtins.str sort_by: The field by which to sort zones. Allowed values are: name|zoneType|timeCreated
