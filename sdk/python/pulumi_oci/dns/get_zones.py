...
class GetZonesResult:
    ...
    def dnssec_state(self) -> Optional[builtins.str]:
        """
...
def get_zones(compartment_id: Optional[builtins.str] = None,
              dnssec_state: Optional[builtins.str] = None,
              ...
              zone_type: Optional[builtins.str] = None,
    ...
    :param builtins.str name_contains: Search by zone name. Will match any zone whose name (case-insensitive) contains the provided value.
    :param builtins.str scope: Specifies to operate only on resources that have a matching DNS scope.
    :param builtins.str sort_by: The field by which to sort zones. Allowed values are: name|zoneType|timeCreated
    ...
    :param builtins.str time_created_greater_than_or_equal_to: An [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) timestamp that states all returned resources were created on or after the indicated time.
    :param builtins.str time_created_less_than: An [RFC 3339](https://www.ietf.org/rfc/rfc3339.txt) timestamp that states all returned resources were created before the indicated time.
...
def get_zones_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                     dnssec_state: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     ...
                     tsig_key_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     view_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                     zone_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
