...
class RecordArgs:
    def __init__(__self__, *,
                 ...
                 rtype: pulumi.Input[builtins.str],
                 zone_name_or_id: pulumi.Input[builtins.str],
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 rdata: Optional[pulumi.Input[builtins.str]] = None,
                 ttl: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Record resource.
        :param pulumi.Input[builtins.str] domain: The fully qualified domain name where the record can be located. Domain value is case insensitive.
        :param pulumi.Input[builtins.str] rtype: The canonical name for the record's type, such as A or CNAME. For more information, see [Resource Record (RR) TYPEs](https://www.iana.org/assignments/dns-parameters/dns-parameters.xhtml#dns-parameters-4).
        :param pulumi.Input[builtins.str] zone_name_or_id: The name or OCID of the target zone.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment the resource belongs to. If supplied, it must match the Zone's compartment ocid.
        :param pulumi.Input[builtins.str] rdata: (Updatable) The record's data, as whitespace-delimited tokens in type-specific presentation format. All RDATA is normalized and the returned presentation of your RDATA may differ from its initial input. For more information about RDATA, see [Supported DNS Resource Record Types](https://docs.cloud.oracle.com/iaas/Content/DNS/Reference/supporteddnsresource.htm)
        :param pulumi.Input[builtins.int] ttl: (Updatable) The Time To Live for the record, in seconds.
        """
    ...
    @pulumi.getter
    @_utilities.deprecated("""The 'oci_dns_record' resource has been deprecated. Please use 'oci_dns_rrset' instead.""")
    def rtype(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @rtype.setter
    def rtype(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "rtype", value)

    @property
    @pulumi.getter(name="zoneNameOrId")
    @_utilities.deprecated("""The 'oci_dns_record' resource has been deprecated. Please use 'oci_dns_rrset' instead.""")
    def zone_name_or_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def zone_name_or_id(self, value: pulumi.Input[builtins.str]):
...
class _RecordState:
    def __init__(__self__, *,
                 ...
                 rdata: Optional[pulumi.Input[builtins.str]] = None,
                 record_hash: Optional[pulumi.Input[builtins.str]] = None,
                 rrset_version: Optional[pulumi.Input[builtins.str]] = None,
                 rtype: Optional[pulumi.Input[builtins.str]] = None,
                 ttl: Optional[pulumi.Input[builtins.int]] = None,
                 zone_name_or_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Record resources.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment the resource belongs to. If supplied, it must match the Zone's compartment ocid.
        :param pulumi.Input[builtins.str] domain: The fully qualified domain name where the record can be located. Domain value is case insensitive.
        :param pulumi.Input[builtins.bool] is_protected: A Boolean flag indicating whether or not parts of the record are unable to be explicitly managed.
        :param pulumi.Input[builtins.str] rdata: (Updatable) The record's data, as whitespace-delimited tokens in type-specific presentation format. All RDATA is normalized and the returned presentation of your RDATA may differ from its initial input. For more information about RDATA, see [Supported DNS Resource Record Types](https://docs.cloud.oracle.com/iaas/Content/DNS/Reference/supporteddnsresource.htm)
        :param pulumi.Input[builtins.str] record_hash: A unique identifier for the record within its zone.
        :param pulumi.Input[builtins.str] rrset_version: The latest version of the record's zone in which its RRSet differs from the preceding version.
        :param pulumi.Input[builtins.str] rtype: The canonical name for the record's type, such as A or CNAME. For more information, see [Resource Record (RR) TYPEs](https://www.iana.org/assignments/dns-parameters/dns-parameters.xhtml#dns-parameters-4).
        :param pulumi.Input[builtins.int] ttl: (Updatable) The Time To Live for the record, in seconds.
        :param pulumi.Input[builtins.str] zone_name_or_id: The name or OCID of the target zone.
    ...
    def record_hash(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @record_hash.setter
    def record_hash(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "record_hash", value)

    @property
    @pulumi.getter(name="rrsetVersion")
    def rrset_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def rrset_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "rrset_version", value)

    @property
    @pulumi.getter
    @_utilities.deprecated("""The 'oci_dns_record' resource has been deprecated. Please use 'oci_dns_rrset' instead.""")
    def rtype(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The canonical name for the record's type, such as A or CNAME. For more information, see [Resource Record (RR) TYPEs](https://www.iana.org/assignments/dns-parameters/dns-parameters.xhtml#dns-parameters-4).
        """
        return pulumi.get(self, "rtype")
    ...
    @rtype.setter
    def rtype(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "rtype", value)
    ...
    @pulumi.getter(name="zoneNameOrId")
    @_utilities.deprecated("""The 'oci_dns_record' resource has been deprecated. Please use 'oci_dns_rrset' instead.""")
    def zone_name_or_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name or OCID of the target zone.
    ...
    @zone_name_or_id.setter
    def zone_name_or_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "zone_name_or_id", value)
...
class Record(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            rtype: Optional[pulumi.Input[builtins.str]] = None,
            ttl: Optional[pulumi.Input[builtins.int]] = None,
            zone_name_or_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Record':
        """
    ...
    @property
    @pulumi.getter(name="compartmentId")
    def compartment_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (Updatable) The OCID of the compartment the resource belongs to. If supplied, it must match the Zone's compartment ocid.
        """
        return pulumi.get(self, "compartment_id")
    ...
    @property
    @pulumi.getter
    def rdata(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (Updatable) The record's data, as whitespace-delimited tokens in type-specific presentation format. All RDATA is normalized and the returned presentation of your RDATA may differ from its initial input. For more information about RDATA, see [Supported DNS Resource Record Types](https://docs.cloud.oracle.com/iaas/Content/DNS/Reference/supporteddnsresource.htm)
        """
        return pulumi.get(self, "rdata")
    ...
    @property
    @pulumi.getter(name="recordHash")
    def record_hash(self) -> pulumi.Output[builtins.str]:
        """
        A unique identifier for the record within its zone.
        """
        return pulumi.get(self, "record_hash")
    ...
    @property
    @pulumi.getter(name="rrsetVersion")
    def rrset_version(self) -> pulumi.Output[builtins.str]:
        """
        The latest version of the record's zone in which its RRSet differs from the preceding version.
        """
        return pulumi.get(self, "rrset_version")
    ...
    @pulumi.getter
    @_utilities.deprecated("""The 'oci_dns_record' resource has been deprecated. Please use 'oci_dns_rrset' instead.""")
    def rtype(self) -> pulumi.Output[builtins.str]:
        """
        The canonical name for the record's type, such as A or CNAME. For more information, see [Resource Record (RR) TYPEs](https://www.iana.org/assignments/dns-parameters/dns-parameters.xhtml#dns-parameters-4).
        """
        return pulumi.get(self, "rtype")
    ...
    @pulumi.getter(name="zoneNameOrId")
    @_utilities.deprecated("""The 'oci_dns_record' resource has been deprecated. Please use 'oci_dns_rrset' instead.""")
    def zone_name_or_id(self) -> pulumi.Output[builtins.str]:
        """
        The name or OCID of the target zone.
