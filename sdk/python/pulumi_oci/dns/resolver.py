...
class ResolverArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The display name of the resolver.
...
class _ResolverState:
    def __init__(__self__, *,
                 attached_vcn_id: Optional[pulumi.Input[builtins.str]] = None,
                 attached_views: Optional[pulumi.Input[Sequence[pulumi.Input['ResolverAttachedViewArgs']]]] = None,
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 default_view_id: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] attached_vcn_id: The OCID of the attached VCN.
        :param pulumi.Input[Sequence[pulumi.Input['ResolverAttachedViewArgs']]] attached_views: (Updatable) The attached views. Views are evaluated in order.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the owning compartment.
        :param pulumi.Input[builtins.str] default_view_id: The OCID of the default view.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).
    ...
    def attached_vcn_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def attached_vcn_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def default_view_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def default_view_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Resolver(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'Resolver':
        """
    ...
    @property
    @pulumi.getter(name="attachedVcnId")
    def attached_vcn_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the attached VCN.
        """
        return pulumi.get(self, "attached_vcn_id")
    ...
    @property
    @pulumi.getter(name="defaultViewId")
    def default_view_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the default view.
        """
        return pulumi.get(self, "default_view_id")
