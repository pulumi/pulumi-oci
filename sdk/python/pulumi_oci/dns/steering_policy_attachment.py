...
class SteeringPolicyAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 steering_policy_id: pulumi.Input[builtins.str],
                 zone_id: pulumi.Input[builtins.str],
                 display_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a SteeringPolicyAttachment resource.
        :param pulumi.Input[builtins.str] domain_name: The attached domain within the attached zone. `domain_name` is case insensitive.
        :param pulumi.Input[builtins.str] steering_policy_id: The OCID of the attached steering policy.
        :param pulumi.Input[builtins.str] zone_id: The OCID of the attached zone.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name for the steering policy attachment. Does not have to be unique and can be changed. Avoid entering confidential information.
        """
    ...
    def steering_policy_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def steering_policy_id(self, value: pulumi.Input[builtins.str]):
...
class _SteeringPolicyAttachmentState:
    def __init__(__self__, *,
                 ...
                 rtypes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 self: Optional[pulumi.Input[builtins.str]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 steering_policy_id: Optional[pulumi.Input[builtins.str]] = None,
                 time_created: Optional[pulumi.Input[builtins.str]] = None,
                 zone_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering SteeringPolicyAttachment resources.
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment containing the steering policy attachment.
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name for the steering policy attachment. Does not have to be unique and can be changed. Avoid entering confidential information.
        :param pulumi.Input[builtins.str] domain_name: The attached domain within the attached zone. `domain_name` is case insensitive.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] rtypes: The record types covered by the attachment at the domain. The set of record types is determined by aggregating the record types from the answers defined in the steering policy.
        ...
        :param pulumi.Input[builtins.str] steering_policy_id: The OCID of the attached steering policy.
        :param pulumi.Input[builtins.str] time_created: The date and time the resource was created, expressed in RFC 3339 timestamp format.
        :param pulumi.Input[builtins.str] zone_id: The OCID of the attached zone.
    ...
    @property
    @pulumi.getter
    def rtypes(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @rtypes.setter
    def rtypes(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    @property
    @pulumi.getter(name="steeringPolicyId")
    def steering_policy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The OCID of the attached steering policy.
        """
        return pulumi.get(self, "steering_policy_id")
    ...
    @steering_policy_id.setter
    def steering_policy_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "steering_policy_id", value)
...
class SteeringPolicyAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            steering_policy_id: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            zone_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SteeringPolicyAttachment':
        """
    ...
    @property
    @pulumi.getter
    def rtypes(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The record types covered by the attachment at the domain. The set of record types is determined by aggregating the record types from the answers defined in the steering policy.
        """
        return pulumi.get(self, "rtypes")
    ...
    @property
    @pulumi.getter(name="steeringPolicyId")
    def steering_policy_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the attached steering policy.
        """
        return pulumi.get(self, "steering_policy_id")
