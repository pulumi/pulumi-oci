...
class TsigKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] algorithm: TSIG key algorithms are encoded as domain names, but most consist of only one non-empty label, which is not required to be explicitly absolute. Applicable algorithms include: hmac-sha1, hmac-sha224, hmac-sha256, hmac-sha512. For more information on these algorithms, see [RFC 4635](https://tools.ietf.org/html/rfc4635#section-2).
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment containing the TSIG key.
        :param pulumi.Input[builtins.str] secret: A base64 string encoding the binary shared secret.
        ...
        :param pulumi.Input[builtins.str] name: A globally unique domain name identifying the key for a given pair of hosts.
        """
...
class _TsigKeyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] time_updated: The date and time the resource was last updated, expressed in RFC 3339 timestamp format.
        """
...
class TsigKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'TsigKey':
        """
