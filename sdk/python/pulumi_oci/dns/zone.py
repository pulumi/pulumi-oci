...
class ZoneArgs:
    def __init__(__self__, *,
                 ...
                 zone_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment containing the zone.
        ...
        :param pulumi.Input[builtins.str] dnssec_state: (Updatable) The state of DNSSEC on the zone.
        ...
        :param pulumi.Input[builtins.str] view_id: The OCID of the private view containing the zone. This value will be null for zones in the global DNS, which are publicly resolvable and not part of a private view.
        """
    ...
    def zone_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @zone_type.setter
    def zone_type(self, value: pulumi.Input[builtins.str]):
...
class _ZoneState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] serial: The current serial of the zone. As seen in the zone's SOA record.
