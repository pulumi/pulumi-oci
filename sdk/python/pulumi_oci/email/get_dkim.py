...
class GetDkimResult:
    ...
    def dkim_id(self) -> _builtins.str:
...
def get_dkim(dkim_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dkim_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of this DKIM.
    """
    __args__ = dict()
