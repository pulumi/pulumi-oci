...
def get_dkim(dkim_id: Optional[builtins.str] = None,
    ...
    :param builtins.str dkim_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of this DKIM.
    """
    __args__ = dict()
...
def get_dkim_output(dkim_id: Optional[pulumi.Input[builtins.str]] = None,
