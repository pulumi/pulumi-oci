...
def get_email_domain(email_domain_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str email_domain_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of this email domain.
    """
    __args__ = dict()
