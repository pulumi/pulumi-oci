...
class GetEmailReturnPathResult:
    ...
    def email_return_path_id(self) -> _builtins.str:
...
def get_email_return_path(email_return_path_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str email_return_path_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of this email return path.
    """
    __args__ = dict()
...
def get_email_return_path_output(email_return_path_id: Optional[pulumi.Input[_builtins.str]] = None,
