...
def get_sender(sender_id: Optional[builtins.str] = None,
    ...
    :param builtins.str sender_id: The unique OCID of the sender.
    """
    __args__ = dict()
...
def get_sender_output(sender_id: Optional[pulumi.Input[builtins.str]] = None,
