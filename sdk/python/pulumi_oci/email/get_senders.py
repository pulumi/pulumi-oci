...
def get_senders(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str domain: A filter to only return resources that match the given domain exactly.
...
def get_senders_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                       domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                       email_address: Optional[pulumi.Input[Optional[builtins.str]]] = None,
