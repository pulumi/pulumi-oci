...
class GetSuppressionResult:
    ...
    def suppression_id(self) -> _builtins.str:
...
def get_suppression(suppression_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str suppression_id: The unique OCID of the suppression.
    """
    __args__ = dict()
...
def get_suppression_output(suppression_id: Optional[pulumi.Input[_builtins.str]] = None,
