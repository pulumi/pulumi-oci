...
def get_suppression(suppression_id: Optional[builtins.str] = None,
    ...
    :param builtins.str suppression_id: The unique OCID of the suppression.
    """
    __args__ = dict()
...
def get_suppression_output(suppression_id: Optional[pulumi.Input[builtins.str]] = None,
