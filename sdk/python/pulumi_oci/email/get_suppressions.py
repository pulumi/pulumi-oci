...
def get_suppressions(compartment_id: Optional[builtins.str] = None,
...
def get_suppressions_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
