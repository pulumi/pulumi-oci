...
def get_etl_run(compartment_id: Optional[str] = None,
    ...
    test_em_warehouse_etl_run = oci.EmWarehouse.get_etl_run(em_warehouse_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
