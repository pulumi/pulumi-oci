...
class RuleActionsAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 lifecycle_message: Optional[builtins.str] = None,
                 state: Optional[builtins.str] = None,
                 stream_id: Optional[builtins.str] = None,
                 topic_id: Optional[builtins.str] = None):
        """
        :param builtins.str action_type: (Updatable) The action to perform if the condition in the rule matches an event.
               * **ONS:** Send to an Oracle Notification Service topic.
               * **OSS:** Send to a stream from Oracle Streaming Service.
               * **FAAS:** Send to an Oracle Functions Service endpoint.
        :param builtins.bool is_enabled: (Updatable) Whether or not this action is currently enabled.  Example: `true`
        :param builtins.str description: (Updatable) A string that describes the details of the action. It does not have to be unique, and you can change it. Avoid entering confidential information.
        :param builtins.str function_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a Function hosted by Oracle Functions Service.
        :param builtins.str id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of this rule.
        :param builtins.str lifecycle_message: A message generated by the Events service about the current state of this rule.
        :param builtins.str state: The current state of the rule.
        :param builtins.str stream_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the stream to which messages are delivered.
        :param builtins.str topic_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the topic to which messages are delivered.
        """
    ...
    def lifecycle_message(self) -> Optional[builtins.str]:
        """
...
class GetRuleActionActionResult(dict):
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 is_enabled: builtins.bool,
                 lifecycle_message: builtins.str,
                 state: builtins.str,
                 stream_id: builtins.str,
                 topic_id: builtins.str):
        """
        :param builtins.str action_type: The action to perform if the condition in the rule matches an event.
               * **ONS:** Send to an Oracle Notification Service topic.
               * **OSS:** Send to a stream from Oracle Streaming Service.
               * **FAAS:** Send to an Oracle Functions Service endpoint.
        :param builtins.str description: A string that describes the details of the rule. It does not have to be unique, and you can change it. Avoid entering confidential information.
        :param builtins.str function_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a Function hosted by Oracle Functions Service.
        :param builtins.str id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of this rule.
        :param builtins.bool is_enabled: Whether or not this rule is currently enabled.  Example: `true`
        :param builtins.str lifecycle_message: A message generated by the Events service about the current state of this rule.
        :param builtins.str state: The current state of the rule.
        :param builtins.str stream_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the stream to which messages are delivered.
        :param builtins.str topic_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the topic to which messages are delivered.
        """
        pulumi.set(__self__, "action_type", action_type)
        pulumi.set(__self__, "description", description)
        pulumi.set(__self__, "function_id", function_id)
    ...
    @property
    @pulumi.getter(name="lifecycleMessage")
    def lifecycle_message(self) -> builtins.str:
        """
        A message generated by the Events service about the current state of this rule.
        """
        return pulumi.get(self, "lifecycle_message")
...
class GetRulesRuleResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str condition: A filter that specifies the event that will trigger actions associated with this rule. A few  important things to remember about filters:
        ...
        :param builtins.str time_created: The time this rule was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.  Example: `2018-09-12T22:47:12.613Z`
        """
        pulumi.set(__self__, "actions", actions)
