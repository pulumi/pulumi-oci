...
class ExportExportOptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] allowed_auths: (Updatable) Array of allowed NFS authentication types.
        :param pulumi.Input[_builtins.str] anonymous_gid: (Updatable) GID value to remap to when squashing a client GID (see identitySquash for more details.) If unspecified defaults to `65534`.
        :param pulumi.Input[_builtins.str] anonymous_uid: (Updatable) UID value to remap to when squashing a client UID (see identitySquash for more details.) If unspecified, defaults to `65534`.
        :param pulumi.Input[_builtins.str] identity_squash: (Updatable) Used when clients accessing the file system through this export have their UID and GID remapped to 'anonymousUid' and 'anonymousGid'. If `ALL`, all users and groups are remapped; if `ROOT`, only the root user and group (UID/GID 0) are remapped; if `NONE`, no remapping is done. If unspecified, defaults to `ROOT`.
        :param pulumi.Input[_builtins.bool] is_anonymous_access_allowed: (Updatable) Whether or not to enable anonymous access to the file system through this export in cases where a user isn't found in the LDAP server used for ID mapping. If true, and the user is not found in the LDAP directory, the operation uses the Squash UID and Squash GID.
        :param pulumi.Input[_builtins.bool] require_privileged_source_port: (Updatable) If `true`, clients accessing the file system through this export must connect from a privileged source port. If unspecified, defaults to `true`.
        """
...
class MountTargetKerberosArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] current_key_tab_secret_version: (Updatable) Version of the keytab Secret in the Vault to use.
        :param pulumi.Input[_builtins.bool] is_kerberos_enabled: (Updatable) Specifies whether to enable or disable Kerberos.
        :param pulumi.Input[_builtins.str] key_tab_secret_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the keytab Secret in the Vault.
        """
    ...
    def kerberos_realm(self) -> pulumi.Input[_builtins.str]:
        """
        (Updatable) The Kerberos realm that the mount target will join.
        """
    ...
    def kerberos_realm(self, value: pulumi.Input[_builtins.str]):
...
class MountTargetLdapIdmapArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] group_search_base: (Updatable) All LDAP searches are recursive starting at this group.  Example: `CN=Group,DC=domain,DC=com`
        :param pulumi.Input[_builtins.int] negative_cache_lifetime_seconds: (Updatable) The amount of time that a mount target will maintain information that a user is not found in the ID mapping configuration.
        :param pulumi.Input[_builtins.str] outbound_connector1id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the first connector to use to communicate with the LDAP server.
        :param pulumi.Input[_builtins.str] outbound_connector2id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the second connector to use to communicate with the LDAP server.
        :param pulumi.Input[_builtins.str] schema_type: (Updatable) Schema type of the LDAP account.
        :param pulumi.Input[_builtins.str] user_search_base: (Updatable) All LDAP searches are recursive starting at this user.  Example: `CN=User,DC=domain,DC=com`
        """
...
class OutboundConnectorEndpointArgs:
    def __init__(__self__, *,
                 ...
                 port: pulumi.Input[_builtins.str]):
        """
        :param pulumi.Input[_builtins.str] hostname: Name of the DNS server.
        :param pulumi.Input[_builtins.str] port: Port of the DNS server.
        """
...
class GetSnapshotsFilterArgs:
    def __init__(__self__, *,
                 ...
                 regex: Optional[_builtins.bool] = None):
        """
        :param _builtins.str name: Name of the snapshot. This value is immutable.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
