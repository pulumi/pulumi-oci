...
class FileSystemQuotaRuleArgs:
    def __init__(__self__, *,
                 ...
                 is_hard_quota: pulumi.Input[builtins.bool],
                 principal_type: pulumi.Input[builtins.str],
                 quota_limit_in_gigabytes: pulumi.Input[builtins.int],
                 are_violators_only: Optional[pulumi.Input[builtins.bool]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 principal_id: Optional[pulumi.Input[builtins.int]] = None,
                 quota_rule_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a FileSystemQuotaRule resource.
        :param pulumi.Input[builtins.str] file_system_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the file system.
        :param pulumi.Input[builtins.bool] is_hard_quota: The flag is an identifier to tell whether the quota rule will be enforced. If `isHardQuota` is true, the quota rule will be enforced so the write will be blocked if usage exceeds the hard quota limit. If `isHardQuota` is false, usage can exceed the soft quota limit. An alarm or notification will be sent to the customer, if the specific usage exceeds.
        :param pulumi.Input[builtins.str] principal_type: The type of the owner of this quota rule and usage.
        :param pulumi.Input[builtins.int] quota_limit_in_gigabytes: (Updatable) The value of the quota rule. The unit is Gigabyte. 
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name. It does not have to be unique, and it is changeable. Avoid entering confidential information. Example: `UserXYZ's quota`
        :param pulumi.Input[builtins.int] principal_id: An identifier for the owner of this usage and quota rule. Unix-like operating systems use this integer value to identify a user or group to manage access control.
        """
    ...
    def is_hard_quota(self) -> pulumi.Input[builtins.bool]:
        """
        The flag is an identifier to tell whether the quota rule will be enforced. If `isHardQuota` is true, the quota rule will be enforced so the write will be blocked if usage exceeds the hard quota limit. If `isHardQuota` is false, usage can exceed the soft quota limit. An alarm or notification will be sent to the customer, if the specific usage exceeds.
        """
    ...
    def is_hard_quota(self, value: pulumi.Input[builtins.bool]):
    ...
    def quota_limit_in_gigabytes(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def quota_limit_in_gigabytes(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "quota_limit_in_gigabytes", value)

    @property
    @pulumi.getter(name="areViolatorsOnly")
    def are_violators_only(self) -> Optional[pulumi.Input[builtins.bool]]:
        return pulumi.get(self, "are_violators_only")

    @are_violators_only.setter
    def are_violators_only(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def principal_id(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @principal_id.setter
    def principal_id(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "principal_id", value)

    @property
    @pulumi.getter(name="quotaRuleId")
    def quota_rule_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "quota_rule_id")

    @quota_rule_id.setter
    def quota_rule_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _FileSystemQuotaRuleState:
    def __init__(__self__, *,
                 ...
                 is_hard_quota: Optional[pulumi.Input[builtins.bool]] = None,
                 principal_id: Optional[pulumi.Input[builtins.int]] = None,
                 principal_type: Optional[pulumi.Input[builtins.str]] = None,
                 quota_limit_in_gigabytes: Optional[pulumi.Input[builtins.int]] = None,
                 quota_rule_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] quota_limit_in_gigabytes: (Updatable) The value of the quota rule. The unit is Gigabyte. 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] time_created: The date and time the quota rule was started, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_updated: The date and time the quota rule was last updated, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
        """
        if are_violators_only is not None:
            pulumi.set(__self__, "are_violators_only", are_violators_only)
        if display_name is not None:
    ...
    @property
    @pulumi.getter(name="isHardQuota")
    def is_hard_quota(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        The flag is an identifier to tell whether the quota rule will be enforced. If `isHardQuota` is true, the quota rule will be enforced so the write will be blocked if usage exceeds the hard quota limit. If `isHardQuota` is false, usage can exceed the soft quota limit. An alarm or notification will be sent to the customer, if the specific usage exceeds.
        """
        return pulumi.get(self, "is_hard_quota")
    ...
    @is_hard_quota.setter
    def is_hard_quota(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_hard_quota", value)
    ...
    @property
    @pulumi.getter(name="quotaLimitInGigabytes")
    def quota_limit_in_gigabytes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The value of the quota rule. The unit is Gigabyte. 
    ...
    @quota_limit_in_gigabytes.setter
    def quota_limit_in_gigabytes(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "quota_limit_in_gigabytes", value)
...
class FileSystemQuotaRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            quota_rule_id: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'FileSystemQuotaRule':
        """
    ...
    @property
    @pulumi.getter(name="areViolatorsOnly")
    def are_violators_only(self) -> pulumi.Output[Optional[builtins.bool]]:
        return pulumi.get(self, "are_violators_only")
    ...
    @property
    @pulumi.getter(name="isHardQuota")
    def is_hard_quota(self) -> pulumi.Output[builtins.bool]:
        """
        The flag is an identifier to tell whether the quota rule will be enforced. If `isHardQuota` is true, the quota rule will be enforced so the write will be blocked if usage exceeds the hard quota limit. If `isHardQuota` is false, usage can exceed the soft quota limit. An alarm or notification will be sent to the customer, if the specific usage exceeds.
        """
        return pulumi.get(self, "is_hard_quota")
    ...
    @property
    @pulumi.getter(name="principalId")
    def principal_id(self) -> pulumi.Output[builtins.int]:
        """
        An identifier for the owner of this usage and quota rule. Unix-like operating systems use this integer value to identify a user or group to manage access control.
        """
        return pulumi.get(self, "principal_id")
    ...
    @property
    @pulumi.getter(name="quotaLimitInGigabytes")
    def quota_limit_in_gigabytes(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The value of the quota rule. The unit is Gigabyte. 
    ...
    @property
    @pulumi.getter(name="quotaRuleId")
    def quota_rule_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "quota_rule_id")
