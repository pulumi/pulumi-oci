...
class FilesystemSnapshotPolicyArgs:
    def __init__(__self__, *,
                 ...
                 locks: pulumi.Input[Optional[Sequence[pulumi.Input['FilesystemSnapshotPolicyLockArgs']]]] = None,
                 policy_prefix: pulumi.Input[Optional[_builtins.str]] = None,
                 schedules: pulumi.Input[Optional[Sequence[pulumi.Input['FilesystemSnapshotPolicyScheduleArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def locks(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['FilesystemSnapshotPolicyLockArgs']]]]:
        """
    ...
    @locks.setter
    def locks(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['FilesystemSnapshotPolicyLockArgs']]]]):
        pulumi.set(self, "locks", value)

    @_builtins.property
    @pulumi.getter(name="policyPrefix")
    def policy_prefix(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def policy_prefix(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "policy_prefix", value)

    @_builtins.property
    @pulumi.getter
    def schedules(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['FilesystemSnapshotPolicyScheduleArgs']]]]:
        """
    ...
    @schedules.setter
    def schedules(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['FilesystemSnapshotPolicyScheduleArgs']]]]):
...
class FilesystemSnapshotPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 is_lock_override: pulumi.Input[Optional[_builtins.bool]] = None,
                 locks: pulumi.Input[Optional[Sequence[pulumi.Input[Union['FilesystemSnapshotPolicyLockArgs', 'FilesystemSnapshotPolicyLockArgsDict', 'outputs.FilesystemSnapshotPolicyLock']]]]] = None,
                 policy_prefix: pulumi.Input[Optional[_builtins.str]] = None,
                 schedules: pulumi.Input[Optional[Sequence[pulumi.Input[Union['FilesystemSnapshotPolicyScheduleArgs', 'FilesystemSnapshotPolicyScheduleArgsDict', 'outputs.FilesystemSnapshotPolicySchedule']]]]] = None,
                 state: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        test_filesystem_snapshot_policy = oci.filestorage.FilesystemSnapshotPolicy("test_filesystem_snapshot_policy",
            ...
            schedules=[{
                ...
                "day_of_month": int(filesystem_snapshot_policy_schedules_day_of_month),
                "day_of_week": filesystem_snapshot_policy_schedules_day_of_week,
                "hour_of_day": int(filesystem_snapshot_policy_schedules_hour_of_day),
                "lock_duration_details": {
                    "lock_duration": int(filesystem_snapshot_policy_schedules_lock_duration_details_lock_duration),
                    "lock_mode": filesystem_snapshot_policy_schedules_lock_duration_details_lock_mode,
                    "cool_off_duration": int(filesystem_snapshot_policy_schedules_lock_duration_details_cool_off_duration),
                },
        ...
        :param pulumi.Input[_builtins.str] display_name: (Updatable) A user-friendly name. It does not have to be unique, and it is changeable. Avoid entering confidential information.  Example: `policy1`
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[Sequence[pulumi.Input[Union['FilesystemSnapshotPolicyLockArgs', 'FilesystemSnapshotPolicyLockArgsDict', 'outputs.FilesystemSnapshotPolicyLock']]]] locks: Locks associated with this resource.
        :param pulumi.Input[_builtins.str] policy_prefix: (Updatable) The prefix to apply to all snapshots created by this policy.  Example: `acme`
        :param pulumi.Input[Sequence[pulumi.Input[Union['FilesystemSnapshotPolicyScheduleArgs', 'FilesystemSnapshotPolicyScheduleArgsDict', 'outputs.FilesystemSnapshotPolicySchedule']]]] schedules: (Updatable) The list of associated snapshot schedules. A maximum of 10 schedules can be associated with a policy.
    ...
    def get(resource_name: str,
            ...
            state: pulumi.Input[Optional[_builtins.str]] = None,
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None) -> 'FilesystemSnapshotPolicy':
        """
