...
class FilesystemSnapshotPolicyArgs:
    def __init__(__self__, *,
                 ...
                 policy_prefix: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] availability_domain: The availability domain that the file system snapshot policy is in.  Example: `Uocm:PHX-AD-1`
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that contains the file system snapshot policy.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name. It does not have to be unique, and it is changeable. Avoid entering confidential information.  Example: `policy1`
        ...
        :param pulumi.Input[builtins.str] policy_prefix: (Updatable) The prefix to apply to all snapshots created by this policy.  Example: `acme`
        ...
        :param pulumi.Input[builtins.str] state: (Updatable) The target state for the Filesystem Snapshot Policy. Could be set to `ACTIVE` or `INACTIVE`. 
    ...
    def policy_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def policy_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _FilesystemSnapshotPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the file system snapshot policy was created, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
        """
...
class FilesystemSnapshotPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'FilesystemSnapshotPolicy':
        """
    ...
    @property
    @pulumi.getter(name="policyPrefix")
    def policy_prefix(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The prefix to apply to all snapshots created by this policy.  Example: `acme`
        """
        return pulumi.get(self, "policy_prefix")
