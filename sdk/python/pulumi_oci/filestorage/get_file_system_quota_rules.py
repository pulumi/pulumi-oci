...
class GetFileSystemQuotaRulesResult:
    ...
    def are_violators_only(self) -> Optional[builtins.bool]:
    ...
    def principal_id(self) -> Optional[builtins.int]:
        """
...
def get_file_system_quota_rules(are_violators_only: Optional[builtins.bool] = None,
                                ...
                                principal_id: Optional[builtins.int] = None,
...
def get_file_system_quota_rules_output(are_violators_only: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                       ...
                                       principal_id: Optional[pulumi.Input[Optional[builtins.int]]] = None,
