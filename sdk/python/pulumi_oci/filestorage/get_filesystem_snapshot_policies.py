...
def get_filesystem_snapshot_policies(availability_domain: Optional[builtins.str] = None,
...
def get_filesystem_snapshot_policies_output(availability_domain: Optional[pulumi.Input[builtins.str]] = None,
