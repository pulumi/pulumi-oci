...
def get_filesystem_snapshot_policy(filesystem_snapshot_policy_id: Optional[builtins.str] = None,
    ...
    :param builtins.str filesystem_snapshot_policy_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the file system snapshot policy.
    """
    __args__ = dict()
...
def get_filesystem_snapshot_policy_output(filesystem_snapshot_policy_id: Optional[pulumi.Input[builtins.str]] = None,
