...
def get_mount_targets(availability_domain: Optional[builtins.str] = None,
...
def get_mount_targets_output(availability_domain: Optional[pulumi.Input[builtins.str]] = None,
