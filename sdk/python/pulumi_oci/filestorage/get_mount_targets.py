...
def get_mount_targets(availability_domain: Optional[str] = None,
                      ...
                      filters: Optional[Sequence[pulumi.InputType['GetMountTargetsFilterArgs']]] = None,
    ...
    test_mount_targets = oci.FileStorage.get_mount_targets(availability_domain=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
...
def get_mount_targets_output(availability_domain: Optional[pulumi.Input[str]] = None,
                             ...
                             filters: Optional[pulumi.Input[Optional[Sequence[pulumi.InputType['GetMountTargetsFilterArgs']]]]] = None,
