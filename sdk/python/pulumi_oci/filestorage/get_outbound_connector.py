...
class GetOutboundConnectorResult:
    ...
    def outbound_connector_id(self) -> _builtins.str:
...
def get_outbound_connector(outbound_connector_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str outbound_connector_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the outbound connector.
    """
    __args__ = dict()
...
def get_outbound_connector_output(outbound_connector_id: pulumi.Input[Optional[_builtins.str]] = None,
