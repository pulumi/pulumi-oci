...
def get_replication(replication_id: Optional[builtins.str] = None,
    ...
    :param builtins.str replication_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the replication.
    """
    __args__ = dict()
...
def get_replication_output(replication_id: Optional[pulumi.Input[builtins.str]] = None,
