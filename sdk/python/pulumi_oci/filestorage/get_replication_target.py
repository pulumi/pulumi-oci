...
def get_replication_target(replication_target_id: Optional[builtins.str] = None,
    ...
    :param builtins.str replication_target_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the replication target.
    """
    __args__ = dict()
...
def get_replication_target_output(replication_target_id: Optional[pulumi.Input[builtins.str]] = None,
