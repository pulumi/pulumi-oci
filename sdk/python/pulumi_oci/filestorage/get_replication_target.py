...
class GetReplicationTargetResult:
    ...
    def delta_progress(self) -> _builtins.str:
        """
    ...
    def delta_status(self) -> _builtins.str:
        """
    ...
    def last_snapshot_id(self) -> _builtins.str:
        """
    ...
    def recovery_point_time(self) -> _builtins.str:
        """
    ...
    def replication_target_id(self) -> _builtins.str:
...
def get_replication_target(replication_target_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str replication_target_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the replication target.
    """
    __args__ = dict()
