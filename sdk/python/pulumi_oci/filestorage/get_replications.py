...
def get_replications(availability_domain: Optional[builtins.str] = None,
    ...
    :param builtins.str file_system_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the source file system.
...
def get_replications_output(availability_domain: Optional[pulumi.Input[builtins.str]] = None,
