...
def get_snapshot(snapshot_id: Optional[builtins.str] = None,
    ...
    :param builtins.str snapshot_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the snapshot.
    """
    __args__ = dict()
...
def get_snapshot_output(snapshot_id: Optional[pulumi.Input[builtins.str]] = None,
