...
class OutboundConnectorArgs:
    def __init__(__self__, *,
                 ...
                 bind_distinguished_name: pulumi.Input[builtins.str],
                 ...
                 password_secret_version: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a OutboundConnector resource.
        :param pulumi.Input[builtins.str] availability_domain: The availability domain the outbound connector is in. May be unset as a blank or NULL value.  Example: `Uocm:PHX-AD-1`
        :param pulumi.Input[builtins.str] bind_distinguished_name: The LDAP Distinguished Name of the bind account.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that contains the outbound connector.
        :param pulumi.Input[builtins.str] connector_type: The account type of this outbound connector.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name. It does not have to be unique, and it is changeable. Avoid entering confidential information.  Example: `My outbound connector`
        ...
        :param pulumi.Input[builtins.str] password_secret_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the password for the LDAP bind account in the Vault.
        :param pulumi.Input[builtins.int] password_secret_version: Version of the password secret in the Vault to use.
    ...
    def bind_distinguished_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def bind_distinguished_name(self, value: pulumi.Input[builtins.str]):
    ...
    def password_secret_version(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def password_secret_version(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _OutboundConnectorState:
    def __init__(__self__, *,
                 ...
                 bind_distinguished_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] password_secret_version: Version of the password secret in the Vault to use.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The current state of this outbound connector.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the outbound connector was created in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
        """
    ...
    @property
    @pulumi.getter(name="bindDistinguishedName")
    def bind_distinguished_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The LDAP Distinguished Name of the bind account.
        """
        return pulumi.get(self, "bind_distinguished_name")
    ...
    @bind_distinguished_name.setter
    def bind_distinguished_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "bind_distinguished_name", value)
...
class OutboundConnector(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'OutboundConnector':
        """
    ...
    @property
    @pulumi.getter(name="bindDistinguishedName")
    def bind_distinguished_name(self) -> pulumi.Output[builtins.str]:
        """
        The LDAP Distinguished Name of the bind account.
        """
        return pulumi.get(self, "bind_distinguished_name")
    ...
    @property
    @pulumi.getter(name="passwordSecretId")
    def password_secret_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the password for the LDAP bind account in the Vault.
        """
        return pulumi.get(self, "password_secret_id")
    ...
    @property
    @pulumi.getter(name="passwordSecretVersion")
    def password_secret_version(self) -> pulumi.Output[builtins.int]:
        """
        Version of the password secret in the Vault to use.
