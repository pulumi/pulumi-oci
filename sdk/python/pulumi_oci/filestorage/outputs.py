...
__all__ = [
    ...
    'FilesystemSnapshotPolicyScheduleLockDurationDetails',
    'MountTargetKerberos',
    ...
    'GetFilesystemSnapshotPoliciesFilesystemSnapshotPolicyScheduleLockDurationDetailResult',
    'GetFilesystemSnapshotPoliciesFilterResult',
    'GetFilesystemSnapshotPolicyLockResult',
    'GetFilesystemSnapshotPolicyScheduleResult',
    'GetFilesystemSnapshotPolicyScheduleLockDurationDetailResult',
...
class ExportExportOption(dict):
    ...
    def __init__(__self__, *,
                 ...
                 allowed_auths: Optional[Sequence[_builtins.str]] = None,
        ...
        :param Sequence[_builtins.str] allowed_auths: (Updatable) Array of allowed NFS authentication types.
        :param _builtins.str anonymous_gid: (Updatable) GID value to remap to when squashing a client GID (see identitySquash for more details.) If unspecified defaults to `65534`.
        :param _builtins.str anonymous_uid: (Updatable) UID value to remap to when squashing a client UID (see identitySquash for more details.) If unspecified, defaults to `65534`.
        :param _builtins.str identity_squash: (Updatable) Used when clients accessing the file system through this export have their UID and GID remapped to 'anonymousUid' and 'anonymousGid'. If `ALL`, all users and groups are remapped; if `ROOT`, only the root user and group (UID/GID 0) are remapped; if `NONE`, no remapping is done. If unspecified, defaults to `ROOT`.
        :param _builtins.bool is_anonymous_access_allowed: (Updatable) Whether or not to enable anonymous access to the file system through this export in cases where a user isn't found in the LDAP server used for ID mapping. If true, and the user is not found in the LDAP directory, the operation uses the Squash UID and Squash GID.
        :param _builtins.bool require_privileged_source_port: (Updatable) If `true`, clients accessing the file system through this export must connect from a privileged source port. If unspecified, defaults to `true`.
        """
    ...
    def allowed_auths(self) -> Optional[Sequence[_builtins.str]]:
        """
    ...
    def is_anonymous_access_allowed(self) -> Optional[_builtins.bool]:
        """
    ...
    def require_privileged_source_port(self) -> Optional[_builtins.bool]:
        """
...
class FilesystemSnapshotPolicySchedule(dict):
    ...
    def __key_warning(key: str):
        ...
        if key == "timeZone":
            ...
            suggest = "hour_of_day"
        elif key == "lockDurationDetails":
            suggest = "lock_duration_details"
    ...
    def __init__(__self__, *,
                 ...
                 lock_duration_details: Optional['outputs.FilesystemSnapshotPolicyScheduleLockDurationDetails'] = None,
                 month: Optional[_builtins.str] = None,
                 retention_duration_in_seconds: Optional[_builtins.str] = None,
                 schedule_prefix: Optional[_builtins.str] = None,
                 time_schedule_start: Optional[_builtins.str] = None):
        """
        :param _builtins.str period: (Updatable) The frequency of scheduled snapshots.
        :param _builtins.str time_zone: (Updatable) Time zone used for scheduling the snapshot.
        :param _builtins.int day_of_month: (Updatable) The day of the month to create a scheduled snapshot. If the day does not exist for the month, snapshot creation will be skipped. Used for MONTHLY and YEARLY snapshot schedules. If not set, the system chooses a value at creation time.
        :param _builtins.str day_of_week: (Updatable) The day of the week to create a scheduled snapshot. Used for WEEKLY snapshot schedules. If not set, the system chooses a value at creation time.
        :param _builtins.int hour_of_day: (Updatable) The hour of the day to create a DAILY, WEEKLY, MONTHLY, or YEARLY snapshot. If not set, the system chooses a value at creation time.
        :param 'FilesystemSnapshotPolicyScheduleLockDurationDetailsArgs' lock_duration_details: (Updatable) Details for setting a retention date or legal hold.
        :param _builtins.str month: (Updatable) The month to create a scheduled snapshot. Used only for YEARLY snapshot schedules. If not set, the system chooses a value at creation time.
        :param _builtins.str retention_duration_in_seconds: (Updatable) The number of seconds to retain snapshots created with this schedule. Snapshot expiration time will not be set if this value is empty.
        :param _builtins.str schedule_prefix: (Updatable) A name prefix to be applied to snapshots created by this schedule.  Example: `compliance1`
        :param _builtins.str time_schedule_start: (Updatable) The starting point used to begin the scheduling of the snapshots based upon recurrence string in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format. If no `timeScheduleStart` is provided, the value will be set to the time when the schedule was created.
        """
    ...
    def lock_duration_details(self) -> Optional['outputs.FilesystemSnapshotPolicyScheduleLockDurationDetails']:
        """
    ...
    def retention_duration_in_seconds(self) -> Optional[_builtins.str]:
        """
    ...
    def schedule_prefix(self) -> Optional[_builtins.str]:
        """
    ...
    def time_schedule_start(self) -> Optional[_builtins.str]:
        """
...
@pulumi.output_type
class FilesystemSnapshotPolicyScheduleLockDurationDetails(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "lockDuration":
            ...
            suggest = "lock_mode"
        elif key == "coolOffDuration":
            suggest = "cool_off_duration"

        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in FilesystemSnapshotPolicyScheduleLockDurationDetails. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        FilesystemSnapshotPolicyScheduleLockDurationDetails.__key_warning(key)
        return super().__getitem__(key)
    ...
    def lock_duration(self) -> _builtins.int:
        """
        (Updatable) The retention period (measured in days) defines how long a snapshot remains locked, preventing user modifications or deletions. In governance mode this period can be adjusted, but in compliance mode it becomes permanent after a cool-off period. Snapshots can be locked for a minimum of 0 days and a maximum of 36,500 days. A value of 0 days stands for an indefinite retention period and it is used for a legal hold.
        """
    ...
    def cool_off_duration(self) -> Optional[_builtins.int]:
        """
...
class MountTargetKerberos(dict):
    ...
    def __init__(__self__, *,
                 ...
                 backup_key_tab_secret_version: Optional[_builtins.int] = None,
                 current_key_tab_secret_version: Optional[_builtins.int] = None,
                 is_kerberos_enabled: Optional[_builtins.bool] = None,
                 key_tab_secret_id: Optional[_builtins.str] = None):
        """
        :param _builtins.str kerberos_realm: (Updatable) The Kerberos realm that the mount target will join.
        :param _builtins.int backup_key_tab_secret_version: (Updatable) Version of the keytab Secret in the Vault to use as a backup.
        :param _builtins.int current_key_tab_secret_version: (Updatable) Version of the keytab Secret in the Vault to use.
        :param _builtins.bool is_kerberos_enabled: (Updatable) Specifies whether to enable or disable Kerberos.
        :param _builtins.str key_tab_secret_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the keytab Secret in the Vault.
        """
    ...
    def backup_key_tab_secret_version(self) -> Optional[_builtins.int]:
        """
    ...
    def current_key_tab_secret_version(self) -> Optional[_builtins.int]:
        """
    ...
    def is_kerberos_enabled(self) -> Optional[_builtins.bool]:
        """
    ...
    def key_tab_secret_id(self) -> Optional[_builtins.str]:
        """
...
class MountTargetLdapIdmap(dict):
    ...
    def __init__(__self__, *,
                 cache_lifetime_seconds: Optional[_builtins.int] = None,
                 cache_refresh_interval_seconds: Optional[_builtins.int] = None,
                 group_search_base: Optional[_builtins.str] = None,
                 negative_cache_lifetime_seconds: Optional[_builtins.int] = None,
                 outbound_connector1id: Optional[_builtins.str] = None,
                 outbound_connector2id: Optional[_builtins.str] = None,
                 schema_type: Optional[_builtins.str] = None,
                 user_search_base: Optional[_builtins.str] = None):
        """
        :param _builtins.int cache_lifetime_seconds: (Updatable) The maximum amount of time the mount target is allowed to use a cached entry.
        :param _builtins.int cache_refresh_interval_seconds: (Updatable) The amount of time that the mount target should allow an entry to persist in its cache before attempting to refresh the entry.
        :param _builtins.str group_search_base: (Updatable) All LDAP searches are recursive starting at this group.  Example: `CN=Group,DC=domain,DC=com`
        :param _builtins.int negative_cache_lifetime_seconds: (Updatable) The amount of time that a mount target will maintain information that a user is not found in the ID mapping configuration.
        :param _builtins.str outbound_connector1id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the first connector to use to communicate with the LDAP server.
        :param _builtins.str outbound_connector2id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the second connector to use to communicate with the LDAP server.
        :param _builtins.str schema_type: (Updatable) Schema type of the LDAP account.
        :param _builtins.str user_search_base: (Updatable) All LDAP searches are recursive starting at this user.  Example: `CN=User,DC=domain,DC=com`
        """
    ...
    def cache_lifetime_seconds(self) -> Optional[_builtins.int]:
        """
    ...
    def cache_refresh_interval_seconds(self) -> Optional[_builtins.int]:
        """
    ...
    def group_search_base(self) -> Optional[_builtins.str]:
        """
    ...
    def negative_cache_lifetime_seconds(self) -> Optional[_builtins.int]:
        """
    ...
    def outbound_connector1id(self) -> Optional[_builtins.str]:
        """
    ...
    def outbound_connector2id(self) -> Optional[_builtins.str]:
        """
    ...
    def user_search_base(self) -> Optional[_builtins.str]:
        """
...
class OutboundConnectorEndpoint(dict):
    def __init__(__self__, *,
                 ...
                 port: _builtins.str):
        """
        :param _builtins.str hostname: Name of the DNS server.
        :param _builtins.str port: Port of the DNS server.
        """
...
@pulumi.output_type
class SnapshotLockDurationDetails(dict):
    @staticmethod
    def __key_warning(key: str):
        suggest = None
        if key == "lockDuration":
        ...
        if suggest:
            pulumi.log.warn(f"Key '{key}' not found in SnapshotLockDurationDetails. Access the value via the '{suggest}' property getter instead.")

    def __getitem__(self, key: str) -> Any:
        SnapshotLockDurationDetails.__key_warning(key)
        return super().__getitem__(key)
...
class GetExportSetsExportSetResult(dict):
    def __init__(__self__, *,
                 ...
                 id: _builtins.str,
                 max_fs_stat_bytes: _builtins.str,
                 max_fs_stat_files: _builtins.str,
        ...
        :param _builtins.str max_fs_stat_bytes: Controls the maximum `tbytes`, `fbytes`, and `abytes`, values reported by `NFS FSSTAT` calls through any associated mount targets. This is an advanced feature. For most applications, use the default value. The `tbytes` value reported by `FSSTAT` will be `maxFsStatBytes`. The value of `fbytes` and `abytes` will be `maxFsStatBytes` minus the metered size of the file system. If the metered size is larger than `maxFsStatBytes`, then `fbytes` and `abytes` will both be '0'.
        :param _builtins.str max_fs_stat_files: Controls the maximum `tfiles`, `ffiles`, and `afiles` values reported by `NFS FSSTAT` calls through any associated mount targets. This is an advanced feature. For most applications, use the default value. The `tfiles` value reported by `FSSTAT` will be `maxFsStatFiles`. The value of `ffiles` and `afiles` will be `maxFsStatFiles` minus the metered size of the file system. If the metered size is larger than `maxFsStatFiles`, then `ffiles` and `afiles` will both be '0'.
        :param _builtins.str state: Filter results by the specified lifecycle state. Must be a valid state for the resource type.
        :param _builtins.str time_created: The date and time the export set was created, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
        :param _builtins.str vcn_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the virtual cloud network (VCN) the export set is in.
        """
    ...
    def max_fs_stat_bytes(self) -> _builtins.str:
        """
    ...
    def max_fs_stat_files(self) -> _builtins.str:
        """
        Controls the maximum `tfiles`, `ffiles`, and `afiles` values reported by `NFS FSSTAT` calls through any associated mount targets. This is an advanced feature. For most applications, use the default value. The `tfiles` value reported by `FSSTAT` will be `maxFsStatFiles`. The value of `ffiles` and `afiles` will be `maxFsStatFiles` minus the metered size of the file system. If the metered size is larger than `maxFsStatFiles`, then `ffiles` and `afiles` will both be '0'.
        """
...
class GetExportsExportResult(dict):
    def __init__(__self__, *,
                 ...
                 export_set_id: _builtins.str,
                 file_system_id: _builtins.str,
                 id: _builtins.str,
                 is_idmap_groups_for_sys_auth: _builtins.bool,
        ...
        :param _builtins.str id: Filter results by [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm). Must be an OCID of the correct type for the resouce type.
        :param _builtins.bool is_idmap_groups_for_sys_auth: Whether or not the export should use ID mapping for Unix groups rather than the group list provided within an NFS request's RPC header. When this flag is true the Unix UID from the RPC header is used to retrieve the list of secondary groups from a the ID mapping subsystem. The primary GID is always taken from the RPC header. If ID mapping is not configured, incorrectly configured, unavailable, or cannot be used to determine a list of secondary groups then an empty secondary group list is used for authorization. If the number of groups exceeds the limit of 256 groups, the list retrieved from LDAP is truncated to the first 256 groups read.
        :param Sequence['GetExportsExportLockArgs'] locks: Locks associated with this resource.
        :param _builtins.str path: Path used to access the associated file system.
        :param _builtins.str state: Filter results by the specified lifecycle state. Must be a valid state for the resource type.
        :param _builtins.str time_created: The date and time the export was created, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
        """
    ...
    def export_set_id(self) -> _builtins.str:
        """
    ...
    def is_idmap_groups_for_sys_auth(self) -> _builtins.bool:
        """
        Whether or not the export should use ID mapping for Unix groups rather than the group list provided within an NFS request's RPC header. When this flag is true the Unix UID from the RPC header is used to retrieve the list of secondary groups from a the ID mapping subsystem. The primary GID is always taken from the RPC header. If ID mapping is not configured, incorrectly configured, unavailable, or cannot be used to determine a list of secondary groups then an empty secondary group list is used for authorization. If the number of groups exceeds the limit of 256 groups, the list retrieved from LDAP is truncated to the first 256 groups read.
        """
...
class GetExportsExportExportOptionResult(dict):
    def __init__(__self__, *,
                 ...
                 allowed_auths: Sequence[_builtins.str],
                 anonymous_gid: _builtins.str,
                 anonymous_uid: _builtins.str,
                 identity_squash: _builtins.str,
                 is_anonymous_access_allowed: _builtins.bool,
                 require_privileged_source_port: _builtins.bool,
                 source: _builtins.str):
        """
        :param _builtins.str access: Type of access to grant clients using the file system through this export. If unspecified defaults to `READ_WRITE`.
        :param Sequence[_builtins.str] allowed_auths: Array of allowed NFS authentication types.
        :param _builtins.str anonymous_gid: GID value to remap to when squashing a client GID (see identitySquash for more details.) If unspecified defaults to `65534`.
        :param _builtins.str anonymous_uid: UID value to remap to when squashing a client UID (see identitySquash for more details.) If unspecified, defaults to `65534`.
    ...
    @_builtins.property
    @pulumi.getter(name="allowedAuths")
    def allowed_auths(self) -> Sequence[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="anonymousGid")
    def anonymous_gid(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="anonymousUid")
    def anonymous_uid(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="isAnonymousAccessAllowed")
    def is_anonymous_access_allowed(self) -> _builtins.bool:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="requirePrivilegedSourcePort")
    def require_privileged_source_port(self) -> _builtins.bool:
        """
...
class GetFileSystemQuotaRulesQuotaRuleResult(dict):
    def __init__(__self__, *,
                 are_violators_only: _builtins.bool,
                 display_name: _builtins.str,
                 file_system_id: _builtins.str,
                 id: _builtins.str,
                 is_hard_quota: _builtins.bool,
                 principal_id: _builtins.int,
                 principal_type: _builtins.str,
                 quota_limit_in_gigabytes: _builtins.int,
                 quota_rule_id: _builtins.str,
                 time_created: _builtins.str,
        ...
        :param _builtins.str display_name: A user-friendly name. It does not have to be unique, and it is changeable. Avoid entering confidential information. Example: `UserXYZ's quota`
        :param _builtins.str file_system_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the file system.
        :param _builtins.str id: The identifier of the quota rule. It is the base64 encoded string of the tuple <principalId, principalType, isHardQuota>.
        :param _builtins.bool is_hard_quota: The flag is an identifier to tell whether the quota rule will be enforced. If `isHardQuota` is false, the quota rule will be enforced so the usage cannot exceed the hard quota limit. If `isHardQuota` is true, usage can exceed the soft quota limit. An alarm or notification will be sent to the customer, if the specific usage exceeds.
        ...
        :param _builtins.int quota_limit_in_gigabytes: The value of the quota rule. The unit is Gigabyte.
        :param _builtins.str time_created: The date and time the quota rule was started, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
        :param _builtins.str time_updated: The date and time the quota rule was last updated, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
        """
    ...
    def are_violators_only(self) -> _builtins.bool:
        """
    ...
    def quota_rule_id(self) -> _builtins.str:
...
class GetFileSystemsFileSystemResult(dict):
    def __init__(__self__, *,
                 are_quota_rules_enabled: _builtins.bool,
                 availability_domain: _builtins.str,
                 ...
                 id: _builtins.str,
                 is_clone_parent: _builtins.bool,
                 is_hydrated: _builtins.bool,
                 is_lock_override: _builtins.bool,
                 is_targetable: _builtins.bool,
                 kms_key_id: _builtins.str,
                 lifecycle_details: _builtins.str,
                 locks: Sequence['outputs.GetFileSystemsFileSystemLockResult'],
                 metered_bytes: _builtins.str,
                 quota_enforcement_state: _builtins.str,
                 replication_source_count: _builtins.int,
                 replication_target_id: _builtins.str,
                 source_details: Sequence['outputs.GetFileSystemsFileSystemSourceDetailResult'],
                 source_snapshot_id: _builtins.str,
                 state: _builtins.str,
                 system_tags: Mapping[str, _builtins.str],
                 time_created: _builtins.str):
        """
        :param _builtins.bool are_quota_rules_enabled: Specifies the enforcement of quota rules on the file system.
        :param _builtins.str availability_domain: The name of the availability domain.  Example: `Uocm:PHX-AD-1`
        ...
        :param _builtins.str metered_bytes: The number of bytes consumed by the file system, including any snapshots. This number reflects the metered size of the file system and is updated asynchronously with respect to updates to the file system. For more information, see [File System Usage and Metering](https://docs.cloud.oracle.com/iaas/Content/File/Concepts/FSutilization.htm).
        :param _builtins.str quota_enforcement_state: Displays the state of enforcement of quota rules on the file system.
        :param _builtins.int replication_source_count: Specifies the total number of replications for which this file system is a source.
        :param _builtins.str replication_target_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the replication target associated with the file system. Empty if the file system is not being used as target in a replication.
        ...
        :param _builtins.str time_created: The date and time the file system was created, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
        """
    ...
    def are_quota_rules_enabled(self) -> _builtins.bool:
        """
    ...
    def clone_attach_status(self) -> _builtins.str:
        """
    ...
    def clone_count(self) -> _builtins.int:
        """
    ...
    def detach_clone_trigger(self) -> _builtins.int:
    ...
    def is_clone_parent(self) -> _builtins.bool:
        """
    ...
    def is_targetable(self) -> _builtins.bool:
        """
    ...
    def metered_bytes(self) -> _builtins.str:
        """
    ...
    def quota_enforcement_state(self) -> _builtins.str:
        """
    ...
    def replication_source_count(self) -> _builtins.int:
        """
...
class GetFileSystemsFileSystemSourceDetailResult(dict):
    def __init__(__self__, *,
                 parent_file_system_id: _builtins.str,
                 source_snapshot_id: _builtins.str):
        """
        :param _builtins.str parent_file_system_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the file system that contains the source snapshot of a cloned file system. See [Cloning a File System](https://docs.cloud.oracle.com/iaas/Content/File/Tasks/cloningFS.htm).
        :param _builtins.str source_snapshot_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the snapshot used to create a cloned file system. See [Cloning a File System](https://docs.cloud.oracle.com/iaas/Content/File/Tasks/cloningFS.htm).
    ...
    @_builtins.property
    @pulumi.getter(name="parentFileSystemId")
    def parent_file_system_id(self) -> _builtins.str:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the file system that contains the source snapshot of a cloned file system. See [Cloning a File System](https://docs.cloud.oracle.com/iaas/Content/File/Tasks/cloningFS.htm).
        """
        return pulumi.get(self, "parent_file_system_id")
...
class GetFilesystemSnapshotPoliciesFilesystemSnapshotPolicyResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str policy_prefix: The prefix to apply to all snapshots created by this policy.  Example: `acme`
        ...
        :param _builtins.str state: Filter results by the specified lifecycle state. Must be a valid state for the resource type.
        :param Mapping[str, _builtins.str] system_tags: System tags for this resource. System tags are applied to resources by internal Oracle Cloud Infrastructure services.
        :param _builtins.str time_created: The date and time the file system snapshot policy was created, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
        """
        pulumi.set(__self__, "availability_domain", availability_domain)
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
...
class GetFilesystemSnapshotPoliciesFilesystemSnapshotPolicyScheduleResult(dict):
    def __init__(__self__, *,
                 ...
                 lock_duration_details: Sequence['outputs.GetFilesystemSnapshotPoliciesFilesystemSnapshotPolicyScheduleLockDurationDetailResult'],
                 month: _builtins.str,
                 period: _builtins.str,
                 retention_duration_in_seconds: _builtins.str,
                 schedule_prefix: _builtins.str,
                 time_schedule_start: _builtins.str,
                 time_zone: _builtins.str):
        """
        :param _builtins.int day_of_month: The day of the month to create a scheduled snapshot. If the day does not exist for the month, snapshot creation will be skipped. Used for MONTHLY and YEARLY snapshot schedules. If not set, the system chooses a value at creation time.
        :param _builtins.str day_of_week: The day of the week to create a scheduled snapshot. Used for WEEKLY snapshot schedules. If not set, the system chooses a value at creation time.
        :param _builtins.int hour_of_day: The hour of the day to create a DAILY, WEEKLY, MONTHLY, or YEARLY snapshot. If not set, the system chooses a value at creation time.
        :param Sequence['GetFilesystemSnapshotPoliciesFilesystemSnapshotPolicyScheduleLockDurationDetailArgs'] lock_duration_details: Details for setting a retention date or legal hold.
        :param _builtins.str month: The month to create a scheduled snapshot. Used only for YEARLY snapshot schedules. If not set, the system chooses a value at creation time.
        :param _builtins.str period: The frequency of scheduled snapshots.
        :param _builtins.str retention_duration_in_seconds: The number of seconds to retain snapshots created with this schedule. Snapshot expiration time will not be set if this value is empty.
        :param _builtins.str schedule_prefix: A name prefix to be applied to snapshots created by this schedule.  Example: `compliance1`
        :param _builtins.str time_schedule_start: The starting point used to begin the scheduling of the snapshots based upon recurrence string in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format. If no `timeScheduleStart` is provided, the value will be set to the time when the schedule was created.
        :param _builtins.str time_zone: Time zone used for scheduling the snapshot.
        """
        pulumi.set(__self__, "day_of_month", day_of_month)
        pulumi.set(__self__, "day_of_week", day_of_week)
        pulumi.set(__self__, "hour_of_day", hour_of_day)
    ...
    @_builtins.property
    @pulumi.getter(name="lockDurationDetails")
    def lock_duration_details(self) -> Sequence['outputs.GetFilesystemSnapshotPoliciesFilesystemSnapshotPolicyScheduleLockDurationDetailResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="retentionDurationInSeconds")
    def retention_duration_in_seconds(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="schedulePrefix")
    def schedule_prefix(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="timeScheduleStart")
    def time_schedule_start(self) -> _builtins.str:
        """
...
@pulumi.output_type
class GetFilesystemSnapshotPoliciesFilesystemSnapshotPolicyScheduleLockDurationDetailResult(dict):
    def __init__(__self__, *,
                 cool_off_duration: _builtins.int,
                 lock_duration: _builtins.int,
                 lock_mode: _builtins.str):
        """
        :param _builtins.int cool_off_duration: For snapshots in compliance mode, a cooling-off period (measured in days) begins. During this time, you can still edit or remove the lock. Once this period ends, the snapshot becomes immutable until the specified retention date expires, permanently preventing any deletion or modification. The cool off duration can be set for a minimum of 0 days and a maximum of 365. It defaults to 14 days if not set.
        :param _builtins.int lock_duration: The retention period (measured in days) defines how long a snapshot remains locked, preventing user modifications or deletions. In governance mode this period can be adjusted, but in compliance mode it becomes permanent after a cool-off period. Snapshots can be locked for a minimum of 0 days and a maximum of 36,500 days. A value of 0 days stands for an indefinite retention period and it is used for a legal hold.
        :param _builtins.str lock_mode: Can be GOVERNANCE or COMPLIANCE. GOVERNANCE MODE: locks snapshots based on either a retention period or a legal hold. COMPLIANCE MODE: the customer can only remove the snapshot during its cooling-off period. Once that time ends, the snapshot becomes immutable; customers cannot delete or modify it until its set retention date passes. After the snapshot is locked, customers can only increase its retention period.
        """
        pulumi.set(__self__, "cool_off_duration", cool_off_duration)
        pulumi.set(__self__, "lock_duration", lock_duration)
        pulumi.set(__self__, "lock_mode", lock_mode)
    ...
    @_builtins.property
    @pulumi.getter(name="coolOffDuration")
    def cool_off_duration(self) -> _builtins.int:
        """
...
class GetFilesystemSnapshotPolicyScheduleResult(dict):
    def __init__(__self__, *,
                 ...
                 day_of_week: _builtins.str,
                 hour_of_day: _builtins.int,
                 lock_duration_details: Sequence['outputs.GetFilesystemSnapshotPolicyScheduleLockDurationDetailResult'],
                 month: _builtins.str,
                 period: _builtins.str,
                 retention_duration_in_seconds: _builtins.str,
                 schedule_prefix: _builtins.str,
        ...
        :param _builtins.str day_of_week: The day of the week to create a scheduled snapshot. Used for WEEKLY snapshot schedules. If not set, the system chooses a value at creation time.
        :param _builtins.int hour_of_day: The hour of the day to create a DAILY, WEEKLY, MONTHLY, or YEARLY snapshot. If not set, the system chooses a value at creation time.
        :param Sequence['GetFilesystemSnapshotPolicyScheduleLockDurationDetailArgs'] lock_duration_details: Details for setting a retention date or legal hold.
        :param _builtins.str month: The month to create a scheduled snapshot. Used only for YEARLY snapshot schedules. If not set, the system chooses a value at creation time.
        :param _builtins.str period: The frequency of scheduled snapshots.
        :param _builtins.str retention_duration_in_seconds: The number of seconds to retain snapshots created with this schedule. Snapshot expiration time will not be set if this value is empty.
        :param _builtins.str schedule_prefix: A name prefix to be applied to snapshots created by this schedule.  Example: `compliance1`
    ...
    @_builtins.property
    @pulumi.getter(name="lockDurationDetails")
    def lock_duration_details(self) -> Sequence['outputs.GetFilesystemSnapshotPolicyScheduleLockDurationDetailResult']:
        """
        Details for setting a retention date or legal hold.
        """
        return pulumi.get(self, "lock_duration_details")
...
@pulumi.output_type
class GetFilesystemSnapshotPolicyScheduleLockDurationDetailResult(dict):
    def __init__(__self__, *,
                 cool_off_duration: _builtins.int,
                 lock_duration: _builtins.int,
                 lock_mode: _builtins.str):
...
class GetMountTargetsMountTargetResult(dict):
    def __init__(__self__, *,
        ...
        :param Mapping[str, _builtins.str] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param _builtins.str id: Filter results by [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm). Must be an OCID of the correct type for the resouce type.
        :param _builtins.str idmap_type: The method used to map a Unix UID to secondary groups. If NONE, the mount target will not use the Unix UID for ID mapping.
    ...
    def idmap_type(self) -> _builtins.str:
        """
    ...
    def observed_throughput(self) -> _builtins.str:
        """
    ...
    def requested_throughput(self) -> _builtins.str:
        """
    ...
    def reserved_storage_capacity(self) -> _builtins.str:
        """
...
class GetMountTargetsMountTargetKerberoResult(dict):
    def __init__(__self__, *,
                 backup_key_tab_secret_version: _builtins.int,
                 current_key_tab_secret_version: _builtins.int,
                 is_kerberos_enabled: _builtins.bool,
                 kerberos_realm: _builtins.str,
                 key_tab_secret_id: _builtins.str):
        """
        :param _builtins.int backup_key_tab_secret_version: Version of the keytab secert in the Vault to use as a backup.
        :param _builtins.int current_key_tab_secret_version: Version of the keytab secret in the Vault to use.
        :param _builtins.bool is_kerberos_enabled: Specifies whether to enable or disable Kerberos.
        :param _builtins.str kerberos_realm: The Kerberos realm that the mount target will join.
        :param _builtins.str key_tab_secret_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the keytab secret in the Vault.
        """
        pulumi.set(__self__, "backup_key_tab_secret_version", backup_key_tab_secret_version)
        pulumi.set(__self__, "current_key_tab_secret_version", current_key_tab_secret_version)
        pulumi.set(__self__, "is_kerberos_enabled", is_kerberos_enabled)
    ...
    @_builtins.property
    @pulumi.getter(name="backupKeyTabSecretVersion")
    def backup_key_tab_secret_version(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="currentKeyTabSecretVersion")
    def current_key_tab_secret_version(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="isKerberosEnabled")
    def is_kerberos_enabled(self) -> _builtins.bool:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="keyTabSecretId")
    def key_tab_secret_id(self) -> _builtins.str:
        """
...
class GetMountTargetsMountTargetLdapIdmapResult(dict):
    def __init__(__self__, *,
                 cache_lifetime_seconds: _builtins.int,
                 cache_refresh_interval_seconds: _builtins.int,
                 group_search_base: _builtins.str,
                 negative_cache_lifetime_seconds: _builtins.int,
                 outbound_connector1id: _builtins.str,
                 outbound_connector2id: _builtins.str,
                 schema_type: _builtins.str,
                 user_search_base: _builtins.str):
        """
        :param _builtins.int cache_lifetime_seconds: The maximum amount of time the mount target is allowed to use a cached entry.
        :param _builtins.int cache_refresh_interval_seconds: The amount of time that the mount target should allow an entry to persist in its cache before attempting to refresh the entry.
        :param _builtins.str group_search_base: All LDAP searches are recursive starting at this group.  Example: `CN=Group,DC=domain,DC=com`
        :param _builtins.int negative_cache_lifetime_seconds: The amount of time that a mount target will maintain information that a user is not found in the ID mapping configuration.
        :param _builtins.str outbound_connector1id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the first connector to use to communicate with the LDAP server.
        :param _builtins.str outbound_connector2id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the second connector to use to communicate with the LDAP server.
        :param _builtins.str schema_type: Schema type of the LDAP account.
        :param _builtins.str user_search_base: All LDAP searches are recursive starting at this user.  Example: `CN=User,DC=domain,DC=com`
        """
        pulumi.set(__self__, "cache_lifetime_seconds", cache_lifetime_seconds)
        pulumi.set(__self__, "cache_refresh_interval_seconds", cache_refresh_interval_seconds)
        pulumi.set(__self__, "group_search_base", group_search_base)
    ...
    @_builtins.property
    @pulumi.getter(name="cacheLifetimeSeconds")
    def cache_lifetime_seconds(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="cacheRefreshIntervalSeconds")
    def cache_refresh_interval_seconds(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="groupSearchBase")
    def group_search_base(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="negativeCacheLifetimeSeconds")
    def negative_cache_lifetime_seconds(self) -> _builtins.int:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="outboundConnector1id")
    def outbound_connector1id(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="outboundConnector2id")
    def outbound_connector2id(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="userSearchBase")
    def user_search_base(self) -> _builtins.str:
        """
...
class GetOutboundConnectorsOutboundConnectorResult(dict):
    def __init__(__self__, *,
                 availability_domain: _builtins.str,
                 bind_distinguished_name: _builtins.str,
                 compartment_id: _builtins.str,
        ...
        :param _builtins.str compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param _builtins.str connector_type: The account type of this outbound connector.
        :param Mapping[str, _builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param _builtins.str display_name: A user-friendly name. It does not have to be unique, and it is changeable.  Example: `My resource`
        ...
        :param _builtins.str password_secret_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the password for the LDAP bind account in the Vault.
        :param _builtins.int password_secret_version: Version of the password secret in the Vault to use.
        :param _builtins.str state: Filter results by the specified lifecycle state. Must be a valid state for the resource type.
        :param Mapping[str, _builtins.str] system_tags: System tags for this resource. System tags are applied to resources by internal Oracle Cloud Infrastructure services.
        :param _builtins.str time_created: The date and time the outbound connector was created in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
    ...
    def bind_distinguished_name(self) -> _builtins.str:
        """
    ...
    def password_secret_version(self) -> _builtins.int:
        """
...
class GetReplicationLockResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str message: A message added by the creator of the lock. This is typically used to give an indication of why the resource is locked.
        :param _builtins.str related_resource_id: The ID of the resource that is locking this resource. Indicates that deleting this resource will remove the lock.
        :param _builtins.str time_created: The date and time the replication was created in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2021-01-04T20:01:29.100Z`
        :param _builtins.str type: Type of the lock.
        """
        pulumi.set(__self__, "message", message)
        pulumi.set(__self__, "related_resource_id", related_resource_id)
...
class GetReplicationTargetsReplicationTargetResult(dict):
    def __init__(__self__, *,
                 ...
                 compartment_id: _builtins.str,
                 defined_tags: Mapping[str, _builtins.str],
                 delta_progress: _builtins.str,
                 delta_status: _builtins.str,
                 display_name: _builtins.str,
                 freeform_tags: Mapping[str, _builtins.str],
                 id: _builtins.str,
                 last_snapshot_id: _builtins.str,
                 lifecycle_details: _builtins.str,
                 recovery_point_time: _builtins.str,
        ...
        :param _builtins.str compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param Mapping[str, _builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param _builtins.str delta_progress: Percentage progress of the current replication cycle.
        :param _builtins.str delta_status: The current state of the snapshot during replication operations.
        :param _builtins.str display_name: A user-friendly name. It does not have to be unique, and it is changeable.  Example: `My resource`
        :param Mapping[str, _builtins.str] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param _builtins.str id: Filter results by [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm). Must be an OCID of the correct type for the resouce type.
        :param _builtins.str last_snapshot_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the last snapshot snapshot which was completely applied to the target file system. Empty while the initial snapshot is being applied.
        :param _builtins.str lifecycle_details: Additional information about the current `lifecycleState`.
        :param _builtins.str recovery_point_time: The snapshotTime of the most recent recoverable replication snapshot in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format. Example: `2021-04-04T20:01:29.100Z`
        :param _builtins.str replication_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of replication.
        :param _builtins.str source_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of source filesystem.
        :param _builtins.str state: Filter results by the specified lifecycle state. Must be a valid state for the resource type.
        :param Mapping[str, _builtins.str] system_tags: System tags for this resource. System tags are applied to resources by internal Oracle Cloud Infrastructure services.
        :param _builtins.str target_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of target filesystem.
        :param _builtins.str time_created: The date and time the replication target was created in target region. in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format. Example: `2021-01-04T20:01:29.100Z`
        """
        pulumi.set(__self__, "availability_domain", availability_domain)
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
...
class GetReplicationsReplicationResult(dict):
    def __init__(__self__, *,
                 ...
                 recovery_point_time: _builtins.str,
                 replication_interval: _builtins.str,
                 replication_target_id: _builtins.str,
                 source_id: _builtins.str,
                 state: _builtins.str,
                 system_tags: Mapping[str, _builtins.str],
        ...
        :param Mapping[str, _builtins.str] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param _builtins.str id: Filter results by [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm). Must be an OCID of the correct type for the resouce type.
        :param _builtins.str last_snapshot_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the last snapshot that has been replicated completely. Empty if the copy of the initial snapshot is not complete.
        :param _builtins.str lifecycle_details: Additional information about the current 'lifecycleState'.
        :param Sequence['GetReplicationsReplicationLockArgs'] locks: Locks associated with this resource.
        :param _builtins.str recovery_point_time: The [`snapshotTime`](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/Snapshot/snapshotTime) of the most recent recoverable replication snapshot in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format. Example: `2021-04-04T20:01:29.100Z`
        :param _builtins.str replication_interval: Duration in minutes between replication snapshots.
        :param _builtins.str replication_target_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the [`ReplicationTarget`](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/ReplicationTarget).
        :param _builtins.str source_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the source file system.
        :param _builtins.str state: Filter results by the specified lifecycle state. Must be a valid state for the resource type.
        :param Mapping[str, _builtins.str] system_tags: System tags for this resource. System tags are applied to resources by internal Oracle Cloud Infrastructure services.
        :param _builtins.str target_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the target file system.
        :param _builtins.str time_created: The date and time the replication was created in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2021-01-04T20:01:29.100Z`
        """
        pulumi.set(__self__, "availability_domain", availability_domain)
        pulumi.set(__self__, "compartment_id", compartment_id)
    ...
    def replication_interval(self) -> _builtins.str:
        """
...
class GetSnapshotLockResult(dict):
    def __init__(__self__, *,
        ...
        :param _builtins.str message: A message added by the creator of the lock. This is typically used to give an indication of why the resource is locked.
        :param _builtins.str related_resource_id: The ID of the resource that is locking this resource. Indicates that deleting this resource will remove the lock.
        :param _builtins.str time_created: The date and time the snapshot was created, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
        :param _builtins.str type: Type of the lock.
        """
        pulumi.set(__self__, "message", message)
        pulumi.set(__self__, "related_resource_id", related_resource_id)
...
@pulumi.output_type
class GetSnapshotLockDurationDetailResult(dict):
    def __init__(__self__, *,
                 cool_off_duration: _builtins.int,
                 lock_duration: _builtins.int,
                 lock_mode: _builtins.str):
...
class GetSnapshotsSnapshotResult(dict):
    def __init__(__self__, *,
                 ...
                 freeform_tags: Mapping[str, _builtins.str],
                 id: _builtins.str,
                 is_clone_source: _builtins.bool,
                 is_lock_override: _builtins.bool,
                 lifecycle_details: _builtins.str,
                 lock_duration_details: Sequence['outputs.GetSnapshotsSnapshotLockDurationDetailResult'],
                 locks: Sequence['outputs.GetSnapshotsSnapshotLockResult'],
                 name: _builtins.str,
                 provenance_id: _builtins.str,
        ...
        :param Mapping[str, _builtins.str] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param _builtins.str id: Filter results by [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm). Must be an OCID of the correct type for the resouce type.
        :param _builtins.bool is_clone_source: Specifies whether the snapshot has been cloned. See [Cloning a File System](https://docs.cloud.oracle.com/iaas/Content/File/Tasks/cloningFS.htm).
        :param _builtins.str lifecycle_details: Additional information about the current `lifecycleState`.
        :param Sequence['GetSnapshotsSnapshotLockDurationDetailArgs'] lock_duration_details: Details for setting a retention date or legal hold.
        :param Sequence['GetSnapshotsSnapshotLockArgs'] locks: Locks associated with this resource.
        :param _builtins.str name: Name of the snapshot. This value is immutable.
        :param _builtins.str provenance_id: An [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) identifying the parent from which this snapshot was cloned. If this snapshot was not cloned, then the `provenanceId` is the same as the snapshot `id` value. If this snapshot was cloned, then the `provenanceId` value is the parent's `provenanceId`. See [Cloning a File System](https://docs.cloud.oracle.com/iaas/Content/File/Tasks/cloningFS.htm).
        :param _builtins.str snapshot_time: The date and time the snapshot was taken, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format. This value might be the same or different from `timeCreated` depending on the following factors:
               * If the snapshot is created in the original file system directory.
               * If the snapshot is cloned from a file system.
               * If the snapshot is replicated from a file system.
        :param _builtins.str snapshot_type: Specifies the generation type of the snapshot.
        :param _builtins.str state: Filter results by the specified lifecycle state. Must be a valid state for the resource type.
        :param Mapping[str, _builtins.str] system_tags: System tags for this resource. System tags are applied to resources by internal Oracle Cloud Infrastructure services.
        :param _builtins.str time_created: The date and time the snapshot was created, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
    ...
    @_builtins.property
    @pulumi.getter(name="lockDurationDetails")
    def lock_duration_details(self) -> Sequence['outputs.GetSnapshotsSnapshotLockDurationDetailResult']:
        """
        Details for setting a retention date or legal hold.
        """
        return pulumi.get(self, "lock_duration_details")
...
@pulumi.output_type
class GetSnapshotsSnapshotLockDurationDetailResult(dict):
    def __init__(__self__, *,
                 cool_off_duration: _builtins.int,
                 lock_duration: _builtins.int,
                 lock_mode: _builtins.str):
