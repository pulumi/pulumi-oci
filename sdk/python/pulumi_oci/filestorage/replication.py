...
class ReplicationArgs:
    def __init__(__self__, *,
                 ...
                 locks: pulumi.Input[Optional[Sequence[pulumi.Input['ReplicationLockArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def locks(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ReplicationLockArgs']]]]:
        """
    ...
    @locks.setter
    def locks(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ReplicationLockArgs']]]]):
        pulumi.set(self, "locks", value)

    @_builtins.property
    @pulumi.getter(name="replicationInterval")
    def replication_interval(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def replication_interval(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class _ReplicationState:
    def __init__(__self__, *,
                 ...
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 delta_progress: pulumi.Input[Optional[_builtins.str]] = None,
                 delta_status: pulumi.Input[Optional[_builtins.str]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 is_lock_override: pulumi.Input[Optional[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that contains the replication.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[_builtins.str] delta_progress: Percentage progress of the current replication cycle.
        :param pulumi.Input[_builtins.str] delta_status: The current state of the snapshot during replication operations.
        :param pulumi.Input[_builtins.str] display_name: (Updatable) A user-friendly name. It does not have to be unique, and it is changeable. Avoid entering confidential information. An associated replication target will also created with the same `displayName`. Example: `My replication`
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        ...
        :param pulumi.Input[_builtins.str] source_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the source file system.
        :param pulumi.Input[_builtins.str] state: The current state of this replication. This resource can be in a `FAILED` state if replication target is deleted instead of the replication resource.
        ...
        :param pulumi.Input[_builtins.str] target_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the target file system. 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] time_created: The date and time the replication was created in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2021-01-04T20:01:29.100Z`
        """
    ...
    def delta_progress(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def delta_progress(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "delta_progress", value)

    @_builtins.property
    @pulumi.getter(name="deltaStatus")
    def delta_status(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @delta_status.setter
    def delta_status(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def last_snapshot_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def last_snapshot_id(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def recovery_point_time(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def recovery_point_time(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def replication_target_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def replication_target_id(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class Replication(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            target_id: pulumi.Input[Optional[_builtins.str]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None) -> 'Replication':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="deltaProgress")
    def delta_progress(self) -> pulumi.Output[_builtins.str]:
        """
        Percentage progress of the current replication cycle.
        """
        return pulumi.get(self, "delta_progress")
    ...
    @_builtins.property
    @pulumi.getter(name="deltaStatus")
    def delta_status(self) -> pulumi.Output[_builtins.str]:
        """
        The current state of the snapshot during replication operations.
        """
        return pulumi.get(self, "delta_status")
    ...
    @_builtins.property
    @pulumi.getter(name="lastSnapshotId")
    def last_snapshot_id(self) -> pulumi.Output[_builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the last snapshot that has been replicated completely. Empty if the copy of the initial snapshot is not complete.
        """
        return pulumi.get(self, "last_snapshot_id")
    ...
    @_builtins.property
    @pulumi.getter(name="recoveryPointTime")
    def recovery_point_time(self) -> pulumi.Output[_builtins.str]:
        """
        The [`snapshotTime`](https://docs.cloud.oracle.com/iaas/api/#/en/iaas/latest/Snapshot/snapshotTime) of the most recent recoverable replication snapshot in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format. Example: `2021-04-04T20:01:29.100Z`
        """
        return pulumi.get(self, "recovery_point_time")
    ...
    @_builtins.property
    @pulumi.getter(name="replicationInterval")
    def replication_interval(self) -> pulumi.Output[_builtins.str]:
        """
        (Updatable) Duration in minutes between replication snapshots.
        """
        return pulumi.get(self, "replication_interval")
