...
class CompliancePolicyRuleArgs:
    def __init__(__self__, *,
                 compliance_policy_id: pulumi.Input[_builtins.str],
                 display_name: pulumi.Input[_builtins.str],
                 patch_selection: pulumi.Input['CompliancePolicyRulePatchSelectionArgs'],
                 patch_type_ids: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
    ...
    def compliance_policy_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def compliance_policy_id(self, value: pulumi.Input[_builtins.str]):
    ...
    def patch_type_ids(self) -> pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]:
        """
    ...
    def patch_type_ids(self, value: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]):
...
class _CompliancePolicyRuleState:
    def __init__(__self__, *,
                 ...
                 compliance_policy_id: pulumi.Input[Optional[_builtins.str]] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 grace_period: pulumi.Input[Optional[_builtins.str]] = None,
                 lifecycle_details: pulumi.Input[Optional[_builtins.str]] = None,
                 patch_selection: pulumi.Input[Optional['CompliancePolicyRulePatchSelectionArgs']] = None,
                 patch_type_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 product_version: pulumi.Input[Optional['CompliancePolicyRuleProductVersionArgs']] = None,
                 severities: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[_builtins.str] time_created: The date and time the CompliancePolicyRule was created, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[_builtins.str] time_updated: The date and time the CompliancePolicyRule was updated, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        """
    ...
    @_builtins.property
    @pulumi.getter(name="compliancePolicyId")
    def compliance_policy_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Unique OCID of the CompliancePolicy this CompliancePolicyRule belongs to.
        """
        return pulumi.get(self, "compliance_policy_id")
    ...
    @compliance_policy_id.setter
    def compliance_policy_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "compliance_policy_id", value)
    ...
    @_builtins.property
    @pulumi.getter(name="patchSelection")
    def patch_selection(self) -> pulumi.Input[Optional['CompliancePolicyRulePatchSelectionArgs']]:
        """
        (Updatable) Patch Selection Details
        """
        return pulumi.get(self, "patch_selection")
    ...
    @patch_selection.setter
    def patch_selection(self, value: pulumi.Input[Optional['CompliancePolicyRulePatchSelectionArgs']]):
        pulumi.set(self, "patch_selection", value)

    @_builtins.property
    @pulumi.getter(name="patchTypeIds")
    def patch_type_ids(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        (Updatable) PlatformConfiguration OCID for the patch type to which this CompliancePolicyRule applies.
        """
        return pulumi.get(self, "patch_type_ids")
    ...
    @patch_type_ids.setter
    def patch_type_ids(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "patch_type_ids", value)

    @_builtins.property
    @pulumi.getter(name="productVersion")
    def product_version(self) -> pulumi.Input[Optional['CompliancePolicyRuleProductVersionArgs']]:
        """
        (Updatable) A specific product version or a specific version and succeeding. Example: 12.1 or 12.1 and above for Oracle WebLogic Application server. The policy applies to the next version only, and not to other versions such as, 12.1.x.
        """
        return pulumi.get(self, "product_version")
    ...
    @product_version.setter
    def product_version(self, value: pulumi.Input[Optional['CompliancePolicyRuleProductVersionArgs']]):
        pulumi.set(self, "product_version", value)
...
class CompliancePolicyRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None) -> 'CompliancePolicyRule':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="compliancePolicyId")
    def compliance_policy_id(self) -> pulumi.Output[_builtins.str]:
        """
        Unique OCID of the CompliancePolicy this CompliancePolicyRule belongs to.
        """
        return pulumi.get(self, "compliance_policy_id")
    ...
    @_builtins.property
    @pulumi.getter(name="patchTypeIds")
    def patch_type_ids(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        (Updatable) PlatformConfiguration OCID for the patch type to which this CompliancePolicyRule applies.
        """
        return pulumi.get(self, "patch_type_ids")
