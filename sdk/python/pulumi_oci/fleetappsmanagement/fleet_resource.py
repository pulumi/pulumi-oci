...
class _FleetResourceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] application_type: Application Type associated with the resource when the resource type is fleet. Will only be returned for ENVIRONMENT fleets that are part of a GROUP Fleet.
...
class FleetResource(pulumi.CustomResource):
    ...
    pulumi_type = "oci:FleetAppsManagement/fleetResource:FleetResource"
