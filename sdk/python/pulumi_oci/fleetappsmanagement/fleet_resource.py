...
class FleetResourceInitArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) OCID of the compartment to which the resource belongs to.
        :param pulumi.Input[builtins.str] fleet_id: Unique Fleet identifier.
        :param pulumi.Input[builtins.str] resource_id: The OCID of the resource.
        :param pulumi.Input[builtins.str] tenancy_id: (Updatable) OCID of the tenancy to which the resource belongs to.
...
class _FleetResourceState:
    def __init__(__self__, *,
                 compartment: Optional[pulumi.Input[builtins.str]] = None,
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 compliance_state: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 percent_compliant: Optional[pulumi.Input[builtins.float]] = None,
                 product: Optional[pulumi.Input[builtins.str]] = None,
                 product_count: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment: Resource Compartment name.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) OCID of the compartment to which the resource belongs to.
        :param pulumi.Input[builtins.str] compliance_state: Compliance State of the Resource.
        ...
        :param pulumi.Input[builtins.str] environment_type: Environment Type associated with the Fleet when the resource type is fleet. Will only be returned for ENVIRONMENT fleets that are part of a GROUP Fleet.
        :param pulumi.Input[builtins.str] fleet_id: Unique Fleet identifier.
        ...
        :param pulumi.Input[builtins.float] percent_compliant: The compliance percentage.
        :param pulumi.Input[builtins.str] product: Product associated with the resource when the resource type is fleet. Will only be returned for PRODUCT fleets that are part of a GROUP Fleet.
        :param pulumi.Input[builtins.int] product_count: Count of products within the resource.
        :param pulumi.Input[builtins.str] resource_id: The OCID of the resource.
        :param pulumi.Input[builtins.str] resource_region: Associated region
        :param pulumi.Input[builtins.str] resource_type: Type of the Resource.
        ...
        :param pulumi.Input[builtins.int] target_count: Count of targets within the resource.
        :param pulumi.Input[builtins.str] tenancy_id: (Updatable) OCID of the tenancy to which the resource belongs to.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] tenancy_name: Resource Tenancy Name.
    ...
    @property
    @pulumi.getter
    def compartment(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @compartment.setter
    def compartment(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def compliance_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def compliance_state(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def percent_compliant(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def percent_compliant(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def product_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def product_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class FleetResource(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tenancy_name: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'FleetResource':
        """
    ...
    @property
    @pulumi.getter
    def compartment(self) -> pulumi.Output[builtins.str]:
        """
        Resource Compartment name.
        """
        return pulumi.get(self, "compartment")
    ...
    @property
    @pulumi.getter(name="percentCompliant")
    def percent_compliant(self) -> pulumi.Output[builtins.float]:
        """
        The compliance percentage.
        """
        return pulumi.get(self, "percent_compliant")
    ...
    @property
    @pulumi.getter(name="productCount")
    def product_count(self) -> pulumi.Output[builtins.int]:
        """
        Count of products within the resource.
        """
        return pulumi.get(self, "product_count")
