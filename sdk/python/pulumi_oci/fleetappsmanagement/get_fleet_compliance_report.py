...
class GetFleetComplianceReportResult:
    ...
    def compliance_report_id(self) -> builtins.str:
...
def get_fleet_compliance_report(compliance_report_id: Optional[builtins.str] = None,
    ...
    :param builtins.str compliance_report_id: compliance report identifier.
