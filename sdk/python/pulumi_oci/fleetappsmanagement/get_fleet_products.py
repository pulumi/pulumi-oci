...
def get_fleet_products(compartment_id: Optional[builtins.str] = None,
...
def get_fleet_products_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
