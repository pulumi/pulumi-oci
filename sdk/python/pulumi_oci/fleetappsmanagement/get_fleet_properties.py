...
def get_fleet_properties(compartment_id: Optional[builtins.str] = None,
...
def get_fleet_properties_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
