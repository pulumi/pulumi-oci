...
class GetFleetPropertyResult:
    ...
    def fleet_property_id(self) -> _builtins.str:
    ...
    def selection_type(self) -> _builtins.str:
        """
...
def get_fleet_property(fleet_id: Optional[_builtins.str] = None,
                       fleet_property_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str fleet_property_id: Unique fleetProperty identifier.
    """
    __args__ = dict()
...
def get_fleet_property_output(fleet_id: Optional[pulumi.Input[_builtins.str]] = None,
                              fleet_property_id: Optional[pulumi.Input[_builtins.str]] = None,
