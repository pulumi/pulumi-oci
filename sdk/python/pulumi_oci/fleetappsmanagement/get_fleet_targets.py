...
class GetFleetTargetsResult:
    ...
    def resource_display_name(self) -> Optional[builtins.str]:
        """
        A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.  Example: `My new resource`
        """
...
def get_fleet_targets(display_name: Optional[builtins.str] = None,
                      ...
                      resource_display_name: Optional[builtins.str] = None,
...
def get_fleet_targets_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             ...
                             resource_display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
