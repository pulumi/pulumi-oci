...
class GetFleetsResult:
    ...
    def fleet_type(self) -> Optional[_builtins.str]:
        """
...
def get_fleets(application_type: Optional[_builtins.str] = None,
               ...
               fleet_type: Optional[_builtins.str] = None,
    ...
    :param _builtins.str application_type: A filter to return resources that match the Application Type/Product Stack given..
    ...
    :param _builtins.str environment_type: A filter to return resources that match the Environment Type given.
    :param _builtins.str fleet_type: A filter to return fleets whose fleetType matches the given fleetType.
    :param _builtins.str id: Unique identifier or OCID for listing a single fleet by id. Either compartmentId or id must be provided.
    :param _builtins.str product: A filter to return resources that match the Product/Product Stack given.
