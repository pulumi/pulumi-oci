...
class GetInventoryResourcesResult:
    ...
    def inventory_properties(self) -> Optional[Sequence[_builtins.str]]:
    ...
    def matching_criteria(self) -> Optional[_builtins.str]:
...
def get_inventory_resources(compartment_id: Optional[_builtins.str] = None,
                            defined_tag_equals: Optional[Sequence[_builtins.str]] = None,
                            display_name: Optional[_builtins.str] = None,
                            filters: Optional[Sequence[Union['GetInventoryResourcesFilterArgs', 'GetInventoryResourcesFilterArgsDict', 'outputs.GetInventoryResourcesFilterResult']]] = None,
                            freeform_tag_equals: Optional[Sequence[_builtins.str]] = None,
                            inventory_properties: Optional[Sequence[_builtins.str]] = None,
                            matching_criteria: Optional[_builtins.str] = None,
                            resource_compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str compartment_id: A filter to return only resources whose base Compartment ID(TenancyId) matches the given base Compartment ID.
    ...
    :param Sequence[_builtins.str] inventory_properties: A list of inventory properties filters to apply. The key for each inventory property and value for each resource type is "{resourceType}.{inventoryProperty}={value}". Example: Instance.displayName=TEST_INSTANCE
    :param _builtins.str matching_criteria: Fetch resources matching ANY or ALL criteria passed as params in "tags" and "inventoryProperties". Example: matchingCriteria=ANY
    :param _builtins.str resource_compartment_id: A filter to return only resources whose resource Compartment ID matches the given resource Compartment ID.
...
def get_inventory_resources_output(compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                                   ...
                                   filters: pulumi.Input[Optional[Optional[Sequence[Union['GetInventoryResourcesFilterArgs', 'GetInventoryResourcesFilterArgsDict', 'outputs.GetInventoryResourcesFilterResult']]]]] = None,
