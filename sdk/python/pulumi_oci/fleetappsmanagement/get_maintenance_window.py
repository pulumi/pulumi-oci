...
class GetMaintenanceWindowResult:
    ...
    def is_outage(self) -> _builtins.bool:
        """
    ...
    def is_recurring(self) -> _builtins.bool:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def recurrences(self) -> _builtins.str:
        """
...
def get_maintenance_window(maintenance_window_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str maintenance_window_id: unique MaintenanceWindow identifier
    """
    __args__ = dict()
