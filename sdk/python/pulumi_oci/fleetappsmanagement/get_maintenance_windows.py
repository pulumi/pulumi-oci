...
class GetMaintenanceWindowsResult:
    ...
    def time_schedule_start_greater_than_or_equal_to(self) -> Optional[_builtins.str]:
...
def get_maintenance_windows(compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str id: Unique identifier or OCID for listing a single maintenance window by id. Either compartmentId or id must be provided.
    :param _builtins.str state: A filter to return only resources whose lifecycleState matches the given lifecycleState.
    :param _builtins.str time_schedule_start_greater_than_or_equal_to: A filter to return only resources whose timeScheduleStart is greater than or equal to the provided date and time.
    """
    __args__ = dict()
