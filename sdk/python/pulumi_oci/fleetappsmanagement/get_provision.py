...
class GetProvisionResult:
    ...
    def provision_id(self) -> builtins.str:
...
def get_provision(provision_id: Optional[builtins.str] = None,
    ...
    :param builtins.str provision_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the FamProvision.
    """
    __args__ = dict()
...
def get_provision_output(provision_id: Optional[pulumi.Input[builtins.str]] = None,
