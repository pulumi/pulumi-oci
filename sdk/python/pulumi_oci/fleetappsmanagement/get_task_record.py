...
class GetTaskRecordResult:
    ...
    def task_record_id(self) -> _builtins.str:
...
def get_task_record(task_record_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str task_record_id: The OCID of the task record.
    """
    __args__ = dict()
