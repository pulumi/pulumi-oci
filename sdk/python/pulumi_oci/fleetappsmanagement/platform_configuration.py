...
class _PlatformConfigurationState:
    def __init__(__self__, *,
                 ...
                 config_category_details: pulumi.Input[Optional['PlatformConfigurationConfigCategoryDetailsArgs']] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] state: The current state of the PlatformConfiguration.
        ...
        :param pulumi.Input[_builtins.str] type: The type of the configuration.
        """
    ...
    @_builtins.property
    @pulumi.getter(name="configCategoryDetails")
    def config_category_details(self) -> pulumi.Input[Optional['PlatformConfigurationConfigCategoryDetailsArgs']]:
        """
        (Updatable) Config Category Details.
        """
        return pulumi.get(self, "config_category_details")
    ...
    @config_category_details.setter
    def config_category_details(self, value: pulumi.Input[Optional['PlatformConfigurationConfigCategoryDetailsArgs']]):
        pulumi.set(self, "config_category_details", value)
...
class PlatformConfiguration(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                 config_category_details: pulumi.Input[Optional[Union['PlatformConfigurationConfigCategoryDetailsArgs', 'PlatformConfigurationConfigCategoryDetailsArgsDict', 'outputs.PlatformConfigurationConfigCategoryDetails']]] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
        ...
        test_platform_configuration = oci.fleetappsmanagement.PlatformConfiguration("test_platform_configuration",
            ...
            config_category_details={
                ...
                "is_compliance_policy_required_for_softlink": platform_configuration_config_category_details_is_compliance_policy_required_for_softlink == "true",
                "is_softlink": platform_configuration_config_category_details_is_softlink == "true",
        ...
        :param pulumi.Input[_builtins.str] compartment_id: (Updatable) Compartment OCID
        :param pulumi.Input[Union['PlatformConfigurationConfigCategoryDetailsArgs', 'PlatformConfigurationConfigCategoryDetailsArgsDict', 'outputs.PlatformConfigurationConfigCategoryDetails']] config_category_details: (Updatable) Config Category Details.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[_builtins.str] description: (Updatable) A user-friendly description. To provide some insight about the resource. Avoid entering confidential information.
        :param pulumi.Input[_builtins.str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.  Example: `My new resource`
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
    ...
    def get(resource_name: str,
            ...
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None,
            type: pulumi.Input[Optional[_builtins.str]] = None) -> 'PlatformConfiguration':
        """
