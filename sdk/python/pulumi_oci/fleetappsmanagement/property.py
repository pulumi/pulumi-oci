...
class _PropertyState:
    def __init__(__self__, *,
                 ...
                 selection: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def selection(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        (Updatable) Text selection of the property.
        """
        return pulumi.get(self, "selection")
    ...
    @selection.setter
    def selection(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "selection", value)
...
class Property(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: pulumi.Input[Optional[_builtins.str]] = None,
            value_type: pulumi.Input[Optional[_builtins.str]] = None,
            values: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None) -> 'Property':
        """
