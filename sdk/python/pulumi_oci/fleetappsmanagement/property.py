...
class _PropertyState:
    def __init__(__self__, *,
                 ...
                 selection: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] scope: The scope of the property.
        :param pulumi.Input[builtins.str] selection: (Updatable) Text selection of the property.
        :param pulumi.Input[builtins.str] state: The current state of the Property.
        ...
        :param pulumi.Input[builtins.str] type: The type of the property.
        :param pulumi.Input[builtins.str] value_type: (Updatable) Format of the value.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] values: (Updatable) Values of the property (must be a single value if selection = 'SINGLE_CHOICE').
    ...
    @property
    @pulumi.getter
    def selection(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Text selection of the property.
        """
        return pulumi.get(self, "selection")
    ...
    @selection.setter
    def selection(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "selection", value)
...
class Property(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            value_type: Optional[pulumi.Input[builtins.str]] = None,
            values: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'Property':
        """
    ...
    @property
    @pulumi.getter
    def selection(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Text selection of the property.
        """
        return pulumi.get(self, "selection")
