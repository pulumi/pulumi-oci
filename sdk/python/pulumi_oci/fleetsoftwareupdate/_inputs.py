...
class FsuCollectionActiveFsuCycleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] display_name: (Updatable) Exadata Fleet Update Collection Identifier.
        :param pulumi.Input[builtins.str] id: OCID identifier for the Exadata Fleet Update Collection.
        """
...
if not MYPY:
    class FsuCollectionFleetDiscoveryArgsDict(TypedDict):
        ...
        """
        fsu_discovery_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FsuCollectionFleetDiscoveryArgs:
    def __init__(__self__, *,
                 ...
                 fsu_discovery_id: Optional[pulumi.Input[builtins.str]] = None,
                 query: Optional[pulumi.Input[builtins.str]] = None,
                 targets: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] strategy: Possible fleet discovery strategies.
        ...
        :param pulumi.Input[builtins.str] fsu_discovery_id: OCIDs of Fleet Software Update Discovery.
        :param pulumi.Input[builtins.str] query: Oracle Cloud Infrastructure Search Service query string.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] targets: OCIDs of target resources to include. For EXACC service type Collections only VMClusters are allowed. For EXACS service type Collections only CloudVMClusters are allowed.
        """
    ...
    def fsu_discovery_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        OCIDs of Fleet Software Update Discovery.
        """
    ...
    def fsu_discovery_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FsuCollectionFleetDiscoveryFilterArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: Type of filters supported for Database targets discovery.
        :param pulumi.Input[builtins.str] entity_type: Type of resource to match in the discovery.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] identifiers: Related resource Ids to include in the discovery.  All must match the specified entityType.
        :param pulumi.Input[builtins.str] mode: INCLUDE or EXCLUDE the filter results in the discovery for DB targets. Supported for 'FSUCOLLECTION' RESOURCE_ID filter only.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] names: List of Database unique names to include in the discovery.
        :param pulumi.Input[builtins.str] operator: Type of join for each element in this filter.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] versions: List of Versions strings to include in the discovery.
        """
...
class FsuCollectionFleetDiscoveryFilterTagArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] key: Freeform tag key.
        :param pulumi.Input[builtins.str] value: Freeform tag value.
        :param pulumi.Input[builtins.str] namespace: Defined tag namespace.
        """
...
if not MYPY:
    class FsuCycleApplyActionScheduleArgsDict(TypedDict):
        time_to_start: pulumi.Input[builtins.str]
        """
...
class FsuCycleApplyActionScheduleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: Type of scheduling strategy to use for Fleet Patching Update Action execution.
        """
    ...
    def time_to_start(self) -> pulumi.Input[builtins.str]:
        """
        The date and time the Exadata Fleet Update Action is expected to start. [RFC 3339](https://tools.ietf.org/rfc/rfc3339), section 14.29.
        """
    ...
    def time_to_start(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class FsuCycleBatchingStrategyArgsDict(TypedDict):
        is_force_rolling: NotRequired[pulumi.Input[builtins.bool]]
        """
        (Updatable) True to force rolling patching.
        """
        is_wait_for_batch_resume: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class FsuCycleBatchingStrategyArgs:
    def __init__(__self__, *,
                 is_force_rolling: Optional[pulumi.Input[builtins.bool]] = None,
                 is_wait_for_batch_resume: Optional[pulumi.Input[builtins.bool]] = None,
                 percentage: Optional[pulumi.Input[builtins.int]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] is_force_rolling: (Updatable) True to force rolling patching.
        :param pulumi.Input[builtins.bool] is_wait_for_batch_resume: (Updatable) True to wait for customer to resume the Apply Action once the first half is done. False to automatically patch the second half.
        :param pulumi.Input[builtins.int] percentage: (Updatable) Percentage of availability in the service during the Patch operation.
        :param pulumi.Input[builtins.str] type: (Updatable) Supported batching strategies.
        """
    ...
    def is_force_rolling(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) True to force rolling patching.
        """
    ...
    def is_force_rolling(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_force_rolling", value)

    @property
    @pulumi.getter(name="isWaitForBatchResume")
    def is_wait_for_batch_resume(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) True to wait for customer to resume the Apply Action once the first half is done. False to automatically patch the second half.
        """
    ...
    def is_wait_for_batch_resume(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class FsuCycleDiagnosticsCollectionArgsDict(TypedDict):
        log_collection_mode: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FsuCycleDiagnosticsCollectionArgs:
    def __init__(__self__, *,
                 log_collection_mode: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] log_collection_mode: (Updatable) Enable incident logs and trace collection.  Allow Oracle to collect incident logs and traces to enable fault diagnosis and issue resolution according to the selected mode.
        """
    ...
    def log_collection_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Enable incident logs and trace collection.  Allow Oracle to collect incident logs and traces to enable fault diagnosis and issue resolution according to the selected mode.
        """
    ...
    def log_collection_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class FsuCycleGoalVersionDetailsArgsDict(TypedDict):
        ...
        """
        home_policy: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        new_home_prefix: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        software_image_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FsuCycleGoalVersionDetailsArgs:
    def __init__(__self__, *,
                 type: pulumi.Input[builtins.str],
                 home_policy: Optional[pulumi.Input[builtins.str]] = None,
                 new_home_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 software_image_id: Optional[pulumi.Input[builtins.str]] = None,
                 version: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: (Updatable) Type of goal target version specified
        :param pulumi.Input[builtins.str] home_policy: (Updatable) Goal home policy to use when Staging the Goal Version during patching. CREATE_NEW: Create a new DBHome (for Database Collections) for the specified image or version. USE_EXISTING: All database targets in the same VMCluster or CloudVmCluster will be moved to a shared database home.  If an existing home for the selected image or version is not found in the VM Cluster for a target database, then a new home will be created.  If more than one existing home for the selected image is found, then the home with the least number of databases will be used.  If multiple homes have the least number of databases, then a home will be selected at random.
        :param pulumi.Input[builtins.str] new_home_prefix: (Updatable) Prefix name used for new DB home resources created as part of the Stage Action. Format: <specified_prefix>_<timestamp> If not specified, a default Oracle Cloud Infrastructure DB home resource will be generated for the new DB home resources created.
        :param pulumi.Input[builtins.str] software_image_id: (Updatable) Target database software image OCID.
        :param pulumi.Input[builtins.str] version: (Updatable) Target DB or GI version string for the Exadata Fleet Update Cycle.
        """
        pulumi.set(__self__, "type", type)
    ...
    def home_policy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Goal home policy to use when Staging the Goal Version during patching. CREATE_NEW: Create a new DBHome (for Database Collections) for the specified image or version. USE_EXISTING: All database targets in the same VMCluster or CloudVmCluster will be moved to a shared database home.  If an existing home for the selected image or version is not found in the VM Cluster for a target database, then a new home will be created.  If more than one existing home for the selected image is found, then the home with the least number of databases will be used.  If multiple homes have the least number of databases, then a home will be selected at random.
        """
    ...
    @home_policy.setter
    def home_policy(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "home_policy", value)

    @property
    @pulumi.getter(name="newHomePrefix")
    def new_home_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Prefix name used for new DB home resources created as part of the Stage Action. Format: <specified_prefix>_<timestamp> If not specified, a default Oracle Cloud Infrastructure DB home resource will be generated for the new DB home resources created.
        """
    ...
    def new_home_prefix(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "new_home_prefix", value)

    @property
    @pulumi.getter(name="softwareImageId")
    def software_image_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Target database software image OCID.
        """
    ...
    def software_image_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class FsuCycleNextActionToExecuteArgsDict(TypedDict):
        time_to_start: NotRequired[pulumi.Input[builtins.str]]
        """
        The date and time the Exadata Fleet Update Action is expected to start. [RFC 3339](https://tools.ietf.org/rfc/rfc3339), section 14.29.
        """
        type: NotRequired[pulumi.Input[builtins.str]]
...
class FsuCycleNextActionToExecuteArgs:
    def __init__(__self__, *,
                 time_to_start: Optional[pulumi.Input[builtins.str]] = None,
                 type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] time_to_start: The date and time the Exadata Fleet Update Action is expected to start. [RFC 3339](https://tools.ietf.org/rfc/rfc3339), section 14.29.
    ...
    @property
    @pulumi.getter(name="timeToStart")
    def time_to_start(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The date and time the Exadata Fleet Update Action is expected to start. [RFC 3339](https://tools.ietf.org/rfc/rfc3339), section 14.29.
        """
        return pulumi.get(self, "time_to_start")
    ...
    @time_to_start.setter
    def time_to_start(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_to_start", value)
