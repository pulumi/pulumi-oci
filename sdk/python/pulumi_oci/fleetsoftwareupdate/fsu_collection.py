...
class FsuCollection(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 fleet_discovery: Optional[pulumi.Input[pulumi.InputType['FsuCollectionFleetDiscoveryArgs']]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 service_type: Optional[pulumi.Input[str]] = None,
                 source_major_version: Optional[pulumi.Input[str]] = None,
                 type: Optional[pulumi.Input[str]] = None,
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            active_fsu_cycles: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FsuCollectionActiveFsuCycleArgs']]]]] = None,
            compartment_id: Optional[pulumi.Input[str]] = None,
            defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            display_name: Optional[pulumi.Input[str]] = None,
            fleet_discovery: Optional[pulumi.Input[pulumi.InputType['FsuCollectionFleetDiscoveryArgs']]] = None,
