...
class FsuCollectionArgs:
    def __init__(__self__, *,
                 ...
                 source_major_version: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] service_type: Exadata service type for the target resource members.
        :param pulumi.Input[builtins.str] source_major_version: Database Major Version of targets to be included in the Exadata Fleet Update Collection. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/DbVersionSummary/ListDbVersions Only Database targets that match the version specified in this value would be added to the Exadata Fleet Update Collection.
        :param pulumi.Input[builtins.str] type: Collection type. DB: Only Database entity type resources allowed. GI: CloudVMCluster and VMCluster entity type resources allowed. 
    ...
    def source_major_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_major_version(self, value: pulumi.Input[builtins.str]):
...
class _FsuCollectionState:
    def __init__(__self__, *,
                 ...
                 fleet_discovery: Optional[pulumi.Input['FsuCollectionFleetDiscoveryArgs']] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 last_completed_fsu_cycle_id: Optional[pulumi.Input[builtins.str]] = None,
                 lifecycle_details: Optional[pulumi.Input[builtins.str]] = None,
                 service_type: Optional[pulumi.Input[builtins.str]] = None,
                 source_major_version: Optional[pulumi.Input[builtins.str]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 target_count: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input['FsuCollectionFleetDiscoveryArgs'] fleet_discovery: Supported fleet discovery strategies for DB Collections. If specified on an Update Collection request, this will re-discover the targets of the Collection.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.str] last_completed_fsu_cycle_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of last completed FSU Cycle.
        ...
        :param pulumi.Input[builtins.str] service_type: Exadata service type for the target resource members.
        :param pulumi.Input[builtins.str] source_major_version: Database Major Version of targets to be included in the Exadata Fleet Update Collection. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/DbVersionSummary/ListDbVersions Only Database targets that match the version specified in this value would be added to the Exadata Fleet Update Collection.
        :param pulumi.Input[builtins.str] state: The current state of the Exadata Fleet Update Collection.
        ...
        :param pulumi.Input[builtins.int] target_count: Number of targets that are members of this Collection.
        :param pulumi.Input[builtins.str] time_created: The time the Exadata Fleet Update Collection was created. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The time the Exadata Fleet Update Collection was updated. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] type: Collection type. DB: Only Database entity type resources allowed. GI: CloudVMCluster and VMCluster entity type resources allowed. 
    ...
    def last_completed_fsu_cycle_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_completed_fsu_cycle_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="sourceMajorVersion")
    def source_major_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Database Major Version of targets to be included in the Exadata Fleet Update Collection. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/DbVersionSummary/ListDbVersions Only Database targets that match the version specified in this value would be added to the Exadata Fleet Update Collection.
        """
        return pulumi.get(self, "source_major_version")
    ...
    @source_major_version.setter
    def source_major_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_major_version", value)
    ...
    def target_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @target_count.setter
    def target_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class FsuCollection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'FsuCollection':
        """
    ...
    @property
    @pulumi.getter(name="lastCompletedFsuCycleId")
    def last_completed_fsu_cycle_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of last completed FSU Cycle.
        """
        return pulumi.get(self, "last_completed_fsu_cycle_id")
    ...
    @property
    @pulumi.getter(name="sourceMajorVersion")
    def source_major_version(self) -> pulumi.Output[builtins.str]:
        """
        Database Major Version of targets to be included in the Exadata Fleet Update Collection. https://docs.oracle.com/en-us/iaas/api/#/en/database/20160918/DbVersionSummary/ListDbVersions Only Database targets that match the version specified in this value would be added to the Exadata Fleet Update Collection.
        """
        return pulumi.get(self, "source_major_version")
    ...
    @property
    @pulumi.getter(name="targetCount")
    def target_count(self) -> pulumi.Output[builtins.int]:
        """
        Number of targets that are members of this Collection.
        """
        return pulumi.get(self, "target_count")
