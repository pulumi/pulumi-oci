...
class FsuCycle(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 apply_action_schedule: Optional[pulumi.Input[pulumi.InputType['FsuCycleApplyActionScheduleArgs']]] = None,
                 batching_strategy: Optional[pulumi.Input[pulumi.InputType['FsuCycleBatchingStrategyArgs']]] = None,
                 compartment_id: Optional[pulumi.Input[str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 diagnostics_collection: Optional[pulumi.Input[pulumi.InputType['FsuCycleDiagnosticsCollectionArgs']]] = None,
                 display_name: Optional[pulumi.Input[str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
                 fsu_collection_id: Optional[pulumi.Input[str]] = None,
                 goal_version_details: Optional[pulumi.Input[pulumi.InputType['FsuCycleGoalVersionDetailsArgs']]] = None,
                 is_ignore_missing_patches: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 is_ignore_patches: Optional[pulumi.Input[bool]] = None,
                 is_keep_placement: Optional[pulumi.Input[bool]] = None,
                 max_drain_timeout_in_seconds: Optional[pulumi.Input[int]] = None,
                 stage_action_schedule: Optional[pulumi.Input[pulumi.InputType['FsuCycleStageActionScheduleArgs']]] = None,
                 type: Optional[pulumi.Input[str]] = None,
                 __props__=None):
        """
    ...
    def get(resource_name: str,
            ...
            lifecycle_details: Optional[pulumi.Input[str]] = None,
            max_drain_timeout_in_seconds: Optional[pulumi.Input[int]] = None,
            next_action_to_executes: Optional[pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['FsuCycleNextActionToExecuteArgs']]]]] = None,
            stage_action_schedule: Optional[pulumi.Input[pulumi.InputType['FsuCycleStageActionScheduleArgs']]] = None,
            state: Optional[pulumi.Input[str]] = None,
            system_tags: Optional[pulumi.Input[Mapping[str, Any]]] = None,
            time_created: Optional[pulumi.Input[str]] = None,
