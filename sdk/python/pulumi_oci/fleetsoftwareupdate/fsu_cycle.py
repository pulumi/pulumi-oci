...
class FsuCycleArgs:
    def __init__(__self__, *,
                 ...
                 fsu_collection_id: pulumi.Input[builtins.str],
                 ...
                 is_ignore_missing_patches: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) Exadata Fleet Update Cycle display name.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] is_ignore_missing_patches: (Updatable) List of patch IDs to ignore.
        :param pulumi.Input[builtins.bool] is_ignore_patches: (Updatable) Ignore all patches between the source and target homes during patching.
    ...
    def fsu_collection_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def fsu_collection_id(self, value: pulumi.Input[builtins.str]):
    ...
    def is_ignore_missing_patches(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def is_ignore_missing_patches(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "is_ignore_missing_patches", value)

    @property
    @pulumi.getter(name="isIgnorePatches")
    def is_ignore_patches(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_ignore_patches(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_ignore_patches", value)

    @property
    @pulumi.getter(name="isKeepPlacement")
    def is_keep_placement(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_keep_placement(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_keep_placement", value)

    @property
    @pulumi.getter(name="maxDrainTimeoutInSeconds")
    def max_drain_timeout_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_drain_timeout_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _FsuCycleState:
    def __init__(__self__, *,
                 ...
                 diagnostics_collection: Optional[pulumi.Input['FsuCycleDiagnosticsCollectionArgs']] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 executing_fsu_action_id: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 fsu_collection_id: Optional[pulumi.Input[builtins.str]] = None,
                 goal_version_details: Optional[pulumi.Input['FsuCycleGoalVersionDetailsArgs']] = None,
                 is_ignore_missing_patches: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 is_ignore_patches: Optional[pulumi.Input[builtins.bool]] = None,
                 is_keep_placement: Optional[pulumi.Input[builtins.bool]] = None,
                 last_completed_action: Optional[pulumi.Input[builtins.str]] = None,
                 last_completed_action_id: Optional[pulumi.Input[builtins.str]] = None,
                 lifecycle_details: Optional[pulumi.Input[builtins.str]] = None,
                 max_drain_timeout_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 next_action_to_executes: Optional[pulumi.Input[Sequence[pulumi.Input['FsuCycleNextActionToExecuteArgs']]]] = None,
                 rollback_cycle_state: Optional[pulumi.Input[builtins.str]] = None,
                 stage_action_schedule: Optional[pulumi.Input['FsuCycleStageActionScheduleArgs']] = None,
        ...
        :param pulumi.Input['FsuCycleDiagnosticsCollectionArgs'] diagnostics_collection: (Updatable) Details to configure diagnostics collection for targets affected by this Exadata Fleet Update Maintenance Cycle.
        :param pulumi.Input[builtins.str] display_name: (Updatable) Exadata Fleet Update Cycle display name.
        :param pulumi.Input[builtins.str] executing_fsu_action_id: OCID identifier for the Action that is currently in execution, if applicable.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.str] fsu_collection_id: OCID identifier for the Collection ID the Exadata Fleet Update Cycle will be assigned to.
        :param pulumi.Input['FsuCycleGoalVersionDetailsArgs'] goal_version_details: (Updatable) Goal version or image details for the Exadata Fleet Update Cycle.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] is_ignore_missing_patches: (Updatable) List of patch IDs to ignore.
        :param pulumi.Input[builtins.bool] is_ignore_patches: (Updatable) Ignore all patches between the source and target homes during patching.
        :param pulumi.Input[builtins.bool] is_keep_placement: (Updatable) Ensure that services of administrator-managed Oracle RAC or Oracle RAC One databases are running on the same instances before and after the move operation.
        :param pulumi.Input[builtins.str] last_completed_action: The latest Action type that was completed in the Exadata Fleet Update Cycle. No value would indicate that the Cycle has not completed any Action yet.
        :param pulumi.Input[builtins.str] last_completed_action_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the latest Action  in the Exadata Fleet Update Cycle.
        ...
        :param pulumi.Input[builtins.str] rollback_cycle_state: Current rollback cycle state if rollback maintenance cycle action has been attempted. No value would indicate that the Cycle has not run a rollback maintenance cycle action before.
        :param pulumi.Input['FsuCycleStageActionScheduleArgs'] stage_action_schedule: Scheduling related details for the Exadata Fleet Update Action during create operations. The specified time should not conflict with existing Exadata Infrastructure maintenance windows. Null scheduleDetails for Stage and Apply Actions in Exadata Fleet Update Cycle creation would not create Actions. Null scheduleDetails for CreateAction would execute the Exadata Fleet Update Action as soon as possible.
        :param pulumi.Input[builtins.str] state: The current state of the Exadata Fleet Update Cycle.
    ...
    def executing_fsu_action_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def executing_fsu_action_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="fsuCollectionId")
    def fsu_collection_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        OCID identifier for the Collection ID the Exadata Fleet Update Cycle will be assigned to.
        """
        return pulumi.get(self, "fsu_collection_id")
    ...
    @fsu_collection_id.setter
    def fsu_collection_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "fsu_collection_id", value)
    ...
    def last_completed_action(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_completed_action(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "last_completed_action", value)

    @property
    @pulumi.getter(name="lastCompletedActionId")
    def last_completed_action_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_completed_action_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def rollback_cycle_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def rollback_cycle_state(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FsuCycle(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="executingFsuActionId")
    def executing_fsu_action_id(self) -> pulumi.Output[builtins.str]:
        """
        OCID identifier for the Action that is currently in execution, if applicable.
        """
        return pulumi.get(self, "executing_fsu_action_id")
    ...
    @property
    @pulumi.getter(name="fsuCollectionId")
    def fsu_collection_id(self) -> pulumi.Output[builtins.str]:
        """
        OCID identifier for the Collection ID the Exadata Fleet Update Cycle will be assigned to.
        """
        return pulumi.get(self, "fsu_collection_id")
    ...
    @property
    @pulumi.getter(name="isIgnoreMissingPatches")
    def is_ignore_missing_patches(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) List of patch IDs to ignore.
        """
        return pulumi.get(self, "is_ignore_missing_patches")
    ...
    @property
    @pulumi.getter(name="isIgnorePatches")
    def is_ignore_patches(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Ignore all patches between the source and target homes during patching.
        """
        return pulumi.get(self, "is_ignore_patches")
    ...
    @property
    @pulumi.getter(name="isKeepPlacement")
    def is_keep_placement(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Ensure that services of administrator-managed Oracle RAC or Oracle RAC One databases are running on the same instances before and after the move operation.
        """
        return pulumi.get(self, "is_keep_placement")
    ...
    @property
    @pulumi.getter(name="lastCompletedAction")
    def last_completed_action(self) -> pulumi.Output[builtins.str]:
        """
        The latest Action type that was completed in the Exadata Fleet Update Cycle. No value would indicate that the Cycle has not completed any Action yet.
        """
        return pulumi.get(self, "last_completed_action")
    ...
    @property
    @pulumi.getter(name="lastCompletedActionId")
    def last_completed_action_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the latest Action  in the Exadata Fleet Update Cycle.
        """
        return pulumi.get(self, "last_completed_action_id")
    ...
    @property
    @pulumi.getter(name="maxDrainTimeoutInSeconds")
    def max_drain_timeout_in_seconds(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) Service drain timeout specified in seconds.
        """
        return pulumi.get(self, "max_drain_timeout_in_seconds")
    ...
    @property
    @pulumi.getter(name="rollbackCycleState")
    def rollback_cycle_state(self) -> pulumi.Output[builtins.str]:
        """
        Current rollback cycle state if rollback maintenance cycle action has been attempted. No value would indicate that the Cycle has not run a rollback maintenance cycle action before.
        """
        return pulumi.get(self, "rollback_cycle_state")
