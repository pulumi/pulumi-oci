...
def get_fsu_collection(fsu_collection_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str fsu_collection_id: Unique Exadata Fleet Update Collection identifier.
    """
    __args__ = dict()
...
def get_fsu_collection_output(fsu_collection_id: Optional[pulumi.Input[_builtins.str]] = None,
