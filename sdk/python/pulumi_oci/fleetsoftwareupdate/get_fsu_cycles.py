...
def get_fsu_cycles(collection_type: Optional[_builtins.str] = None,
                   compartment_id: Optional[_builtins.str] = None,
                   display_name: Optional[_builtins.str] = None,
                   filters: Optional[Sequence[Union['GetFsuCyclesFilterArgs', 'GetFsuCyclesFilterArgsDict', 'outputs.GetFsuCyclesFilterResult']]] = None,
                   fsu_collection_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str target_version: A filter to return only entries whose targetVersion matches the given targetVersion.
    """
    __args__ = dict()
...
def get_fsu_cycles_output(collection_type: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                          ...
                          filters: pulumi.Input[Optional[Optional[Sequence[Union['GetFsuCyclesFilterArgs', 'GetFsuCyclesFilterArgsDict', 'outputs.GetFsuCyclesFilterResult']]]]] = None,
