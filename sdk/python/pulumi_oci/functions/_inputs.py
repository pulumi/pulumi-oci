...
if not MYPY:
    class ApplicationImagePolicyConfigArgsDict(TypedDict):
        is_policy_enabled: pulumi.Input[builtins.bool]
        """
...
class ApplicationImagePolicyConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] is_policy_enabled: (Updatable) Define if image signature verification policy is enabled for the application.
    ...
    def is_policy_enabled(self) -> pulumi.Input[builtins.bool]:
        """
        (Updatable) Define if image signature verification policy is enabled for the application.
        """
    ...
    def is_policy_enabled(self, value: pulumi.Input[builtins.bool]):
...
class ApplicationImagePolicyConfigKeyDetailArgs:
    def __init__(__self__, *,
                 kms_key_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] kms_key_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)s of the KMS key that will be used to verify the image signature.
        """
...
class ApplicationTraceConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] domain_id: (Updatable) The OCID of the collector (e.g. an APM Domain) trace events will be sent to.
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) Define if tracing is enabled for the resource. 
...
class FunctionProvisionedConcurrencyConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] strategy: (Updatable) The strategy for provisioned concurrency to be used.
        :param pulumi.Input[builtins.int] count: (Updatable) Configuration specifying a constant amount of provisioned concurrency.
        """
...
if not MYPY:
    class FunctionSourceDetailsArgsDict(TypedDict):
        pbf_listing_id: pulumi.Input[builtins.str]
        """
...
class FunctionSourceDetailsArgs:
    def __init__(__self__, *,
                 ...
                 source_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] pbf_listing_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the PbfListing this function is sourced from.
        :param pulumi.Input[builtins.str] source_type: Type of the Function Source. Possible values: PRE_BUILT_FUNCTIONS.
        """
    ...
    def pbf_listing_id(self) -> pulumi.Input[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the PbfListing this function is sourced from.
        """
    ...
    def pbf_listing_id(self, value: pulumi.Input[builtins.str]):
