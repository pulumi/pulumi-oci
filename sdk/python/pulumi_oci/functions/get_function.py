...
def get_function(function_id: Optional[builtins.str] = None,
    ...
    :param builtins.str function_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of this function.
    """
    __args__ = dict()
...
def get_function_output(function_id: Optional[pulumi.Input[builtins.str]] = None,
