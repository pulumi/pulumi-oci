...
def get_fusion_environment(fusion_environment_id: Optional[builtins.str] = None,
...
def get_fusion_environment_output(fusion_environment_id: Optional[pulumi.Input[builtins.str]] = None,
