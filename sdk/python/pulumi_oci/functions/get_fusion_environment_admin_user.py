...
def get_fusion_environment_admin_user(fusion_environment_id: Optional[_builtins.str] = None,
...
def get_fusion_environment_admin_user_output(fusion_environment_id: pulumi.Input[Optional[_builtins.str]] = None,
