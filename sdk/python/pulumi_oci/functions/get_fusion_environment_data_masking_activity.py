...
class GetFusionEnvironmentDataMaskingActivityResult:
    ...
    def data_masking_activity_id(self) -> builtins.str:
...
def get_fusion_environment_data_masking_activity(data_masking_activity_id: Optional[builtins.str] = None,
    ...
    :param builtins.str data_masking_activity_id: Unique DataMasking run identifier.
...
def get_fusion_environment_data_masking_activity_output(data_masking_activity_id: Optional[pulumi.Input[builtins.str]] = None,
