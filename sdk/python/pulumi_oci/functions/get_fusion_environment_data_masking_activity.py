...
class GetFusionEnvironmentDataMaskingActivityResult:
    ...
    def data_masking_activity_id(self) -> _builtins.str:
...
def get_fusion_environment_data_masking_activity(data_masking_activity_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str data_masking_activity_id: Unique DataMasking run identifier.
