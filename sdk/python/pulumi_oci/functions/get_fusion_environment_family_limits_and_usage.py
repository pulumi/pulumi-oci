...
def get_fusion_environment_family_limits_and_usage(fusion_environment_family_id: Optional[builtins.str] = None,
    ...
    :param builtins.str fusion_environment_family_id: The unique identifier (OCID) of the FusionEnvironmentFamily.
    """
    __args__ = dict()
...
def get_fusion_environment_family_limits_and_usage_output(fusion_environment_family_id: Optional[pulumi.Input[builtins.str]] = None,
