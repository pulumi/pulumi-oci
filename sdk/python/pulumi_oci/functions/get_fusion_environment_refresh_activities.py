...
def get_fusion_environment_refresh_activities(display_name: Optional[str] = None,
    ...
    test_fusion_environment_refresh_activities = oci.Functions.get_fusion_environment_refresh_activities(fusion_environment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetFusionEnvironmentRefreshActivitiesResult(
        ...
        id=__ret__.id,
        refresh_activity_collections=__ret__.refresh_activity_collections,
        state=__ret__.state,
