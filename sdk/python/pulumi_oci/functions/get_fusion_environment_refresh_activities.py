...
class GetFusionEnvironmentRefreshActivitiesResult:
    ...
    def time_expected_finish_less_than_or_equal_to(self) -> Optional[_builtins.str]:
    ...
    def time_scheduled_start_greater_than_or_equal_to(self) -> Optional[_builtins.str]:
...
def get_fusion_environment_refresh_activities(display_name: Optional[_builtins.str] = None,
                                              ...
                                              time_scheduled_start_greater_than_or_equal_to: Optional[_builtins.str] = None,
    ...
    :param _builtins.str time_expected_finish_less_than_or_equal_to: A filter that returns all resources that end before this date
    :param _builtins.str time_scheduled_start_greater_than_or_equal_to: A filter that returns all resources that are scheduled after this date
    """
    __args__ = dict()
