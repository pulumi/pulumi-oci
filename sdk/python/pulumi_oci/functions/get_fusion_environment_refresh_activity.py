...
def get_fusion_environment_refresh_activity(fusion_environment_id: Optional[builtins.str] = None,
                                            refresh_activity_id: Optional[builtins.str] = None,
    ...
    :param builtins.str refresh_activity_id: The unique identifier (OCID) of the Refresh activity.
    """
    __args__ = dict()
...
def get_fusion_environment_refresh_activity_output(fusion_environment_id: Optional[pulumi.Input[builtins.str]] = None,
