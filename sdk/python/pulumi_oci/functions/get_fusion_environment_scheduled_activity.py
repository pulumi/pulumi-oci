...
class GetFusionEnvironmentScheduledActivityResult:
    ...
    def scheduled_activity_id(self) -> builtins.str:
...
def get_fusion_environment_scheduled_activity(fusion_environment_id: Optional[builtins.str] = None,
                                              scheduled_activity_id: Optional[builtins.str] = None,
    ...
    :param builtins.str scheduled_activity_id: Unique ScheduledActivity identifier.
    """
    __args__ = dict()
...
def get_fusion_environment_scheduled_activity_output(fusion_environment_id: Optional[pulumi.Input[builtins.str]] = None,
                                                     scheduled_activity_id: Optional[pulumi.Input[builtins.str]] = None,
