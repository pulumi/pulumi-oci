...
class GetFusionEnvironmentScheduledActivityResult:
    ...
    def scheduled_activity_id(self) -> _builtins.str:
...
def get_fusion_environment_scheduled_activity(fusion_environment_id: Optional[_builtins.str] = None,
                                              scheduled_activity_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str scheduled_activity_id: Unique ScheduledActivity identifier.
    """
    __args__ = dict()
