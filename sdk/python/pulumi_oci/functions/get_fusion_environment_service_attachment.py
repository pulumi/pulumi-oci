...
class GetFusionEnvironmentServiceAttachmentResult:
    ...
    def service_attachment_id(self) -> _builtins.str:
...
def get_fusion_environment_service_attachment(fusion_environment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str service_attachment_id: OCID of the Service Attachment
    """
    __args__ = dict()
