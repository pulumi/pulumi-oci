...
def get_fusion_environment_status(fusion_environment_id: Optional[builtins.str] = None,
...
def get_fusion_environment_status_output(fusion_environment_id: Optional[pulumi.Input[builtins.str]] = None,
