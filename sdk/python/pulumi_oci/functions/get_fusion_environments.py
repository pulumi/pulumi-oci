...
def get_fusion_environments(compartment_id: Optional[builtins.str] = None,
...
def get_fusion_environments_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
