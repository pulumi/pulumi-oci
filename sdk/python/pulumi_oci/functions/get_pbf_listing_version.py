...
class GetPbfListingVersionResult:
    ...
    def pbf_listing_version_id(self) -> builtins.str:
...
def get_pbf_listing_version(pbf_listing_version_id: Optional[builtins.str] = None,
...
def get_pbf_listing_version_output(pbf_listing_version_id: Optional[pulumi.Input[builtins.str]] = None,
