...
class GetPbfListingsResult:
    ...
    def name_starts_with(self) -> Optional[builtins.str]:
        return pulumi.get(self, "name_starts_with")

    @property
    @pulumi.getter(name="pbfListingId")
    def pbf_listing_id(self) -> Optional[builtins.str]:
...
def get_pbf_listings(filters: Optional[Sequence[Union['GetPbfListingsFilterArgs', 'GetPbfListingsFilterArgsDict']]] = None,
                     ...
                     name_starts_with: Optional[builtins.str] = None,
    ...
    :param builtins.str name_contains: A filter to return only resources that contain the supplied filter text in the PBF name given.
    :param builtins.str name_starts_with: A filter to return only resources that start with the supplied filter text in the PBF name given.
    ...
    :param Sequence[builtins.str] triggers: A filter to return only resources that match the service trigger sources of a PBF.
    """
    __args__ = dict()
...
def get_pbf_listings_output(filters: Optional[pulumi.Input[Optional[Sequence[Union['GetPbfListingsFilterArgs', 'GetPbfListingsFilterArgsDict']]]]] = None,
                            ...
                            name_starts_with: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            pbf_listing_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
