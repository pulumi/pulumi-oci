...
def get_pbf_listings(filters: Optional[Sequence[Union['GetPbfListingsFilterArgs', 'GetPbfListingsFilterArgsDict']]] = None,
    ...
    :param _builtins.str name_contains: A filter to return only resources that contain the supplied filter text in the PBF name given.
    :param _builtins.str name_starts_with: A filter to return only resources that start with the supplied filter text in the PBF name given.
    ...
    :param Sequence[_builtins.str] triggers: A filter to return only resources that match the service trigger sources of a PBF.
    """
    __args__ = dict()
