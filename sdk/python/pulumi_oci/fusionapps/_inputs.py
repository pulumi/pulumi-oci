...
if not MYPY:
    class FusionEnvironmentFamilyFamilyMaintenancePolicyArgsDict(TypedDict):
        concurrent_maintenance: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        is_monthly_patching_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        (Updatable) When True, monthly patching is enabled for the environment family.
        """
        quarterly_upgrade_begin_times: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FusionEnvironmentFamilyFamilyMaintenancePolicyArgs:
    def __init__(__self__, *,
                 concurrent_maintenance: Optional[pulumi.Input[builtins.str]] = None,
                 is_monthly_patching_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 quarterly_upgrade_begin_times: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] concurrent_maintenance: (Updatable) Option to upgrade both production and non-production environments at the same time. When set to PROD both types of environnments are upgraded on the production schedule. When set to NON_PROD both types of environments are upgraded on the non-production schedule.
        :param pulumi.Input[builtins.bool] is_monthly_patching_enabled: (Updatable) When True, monthly patching is enabled for the environment family.
        :param pulumi.Input[builtins.str] quarterly_upgrade_begin_times: The quarterly maintenance month group schedule of the Fusion environment family.
        """
    ...
    def concurrent_maintenance(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Option to upgrade both production and non-production environments at the same time. When set to PROD both types of environnments are upgraded on the production schedule. When set to NON_PROD both types of environments are upgraded on the non-production schedule.
        """
    ...
    def concurrent_maintenance(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "concurrent_maintenance", value)

    @property
    @pulumi.getter(name="isMonthlyPatchingEnabled")
    def is_monthly_patching_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) When True, monthly patching is enabled for the environment family.
        """
    ...
    def is_monthly_patching_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_monthly_patching_enabled", value)

    @property
    @pulumi.getter(name="quarterlyUpgradeBeginTimes")
    def quarterly_upgrade_begin_times(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The quarterly maintenance month group schedule of the Fusion environment family.
        """
    ...
    def quarterly_upgrade_begin_times(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "quarterly_upgrade_begin_times", value)


if not MYPY:
    class FusionEnvironmentKmsKeyInfoArgsDict(TypedDict):
        active_key_id: NotRequired[pulumi.Input[builtins.str]]
        active_key_version: NotRequired[pulumi.Input[builtins.str]]
        current_key_lifecycle_state: NotRequired[pulumi.Input[builtins.str]]
        scheduled_key_id: NotRequired[pulumi.Input[builtins.str]]
        scheduled_key_status: NotRequired[pulumi.Input[builtins.str]]
        scheduled_key_version: NotRequired[pulumi.Input[builtins.str]]
        scheduled_lifecycle_state: NotRequired[pulumi.Input[builtins.str]]
elif False:
...
class FusionEnvironmentKmsKeyInfoArgs:
    def __init__(__self__, *,
                 active_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 active_key_version: Optional[pulumi.Input[builtins.str]] = None,
                 current_key_lifecycle_state: Optional[pulumi.Input[builtins.str]] = None,
                 scheduled_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 scheduled_key_status: Optional[pulumi.Input[builtins.str]] = None,
                 scheduled_key_version: Optional[pulumi.Input[builtins.str]] = None,
                 scheduled_lifecycle_state: Optional[pulumi.Input[builtins.str]] = None):
    ...
    def active_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "active_key_id")

    @active_key_id.setter
    def active_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FusionEnvironmentMaintenancePolicyArgs:
    def __init__(__self__, *,
                 environment_maintenance_override: Optional[pulumi.Input[builtins.str]] = None,
                 monthly_patching_override: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] environment_maintenance_override: (Updatable) User choice to upgrade both test and prod pods at the same time. Overrides fusion environment families'.
        :param pulumi.Input[builtins.str] monthly_patching_override: (Updatable) When "ENABLED", the Fusion environment is patched monthly. When "DISABLED", the Fusion environment is not patched monthly. This setting overrides the environment family setting. When not set, the environment follows the environment family policy.
    ...
    def environment_maintenance_override(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) User choice to upgrade both test and prod pods at the same time. Overrides fusion environment families'.
        """
    ...
    def environment_maintenance_override(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "environment_maintenance_override", value)

    @property
    @pulumi.getter(name="monthlyPatchingOverride")
    def monthly_patching_override(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) When "ENABLED", the Fusion environment is patched monthly. When "DISABLED", the Fusion environment is not patched monthly. This setting overrides the environment family setting. When not set, the environment follows the environment family policy.
        """
    ...
    def monthly_patching_override(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class FusionEnvironmentMaintenancePolicyQuarterlyUpgradeBeginTimeArgsDict(TypedDict):
        begin_times_value: NotRequired[pulumi.Input[builtins.str]]
        """
        The frequency and month when maintenance occurs for the Fusion environment.
        """
        override_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FusionEnvironmentMaintenancePolicyQuarterlyUpgradeBeginTimeArgs:
    def __init__(__self__, *,
                 begin_times_value: Optional[pulumi.Input[builtins.str]] = None,
                 override_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] begin_times_value: The frequency and month when maintenance occurs for the Fusion environment.
        :param pulumi.Input[builtins.str] override_type: Determines if the maintenance schedule of the Fusion environment is inherited from the Fusion environment family.
        """
    ...
    def begin_times_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The frequency and month when maintenance occurs for the Fusion environment.
        """
    ...
    def begin_times_value(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "begin_times_value", value)

    @property
    @pulumi.getter(name="overrideType")
    def override_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Determines if the maintenance schedule of the Fusion environment is inherited from the Fusion environment family.
        """
    ...
    def override_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "override_type", value)


if not MYPY:
    class FusionEnvironmentRefreshArgsDict(TypedDict):
        source_fusion_environment_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        time_of_restoration_point: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FusionEnvironmentRefreshArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] source_fusion_environment_id: The source environment id for the last refresh
        :param pulumi.Input[builtins.str] time_finished: The time of when the last refresh finish
        :param pulumi.Input[builtins.str] time_of_restoration_point: The point of time of the latest DB backup for the last refresh
        """
...
if not MYPY:
    class FusionEnvironmentRefreshActivityRefreshIssueDetailsListArgsDict(TypedDict):
        refresh_issues: NotRequired[pulumi.Input[builtins.str]]
        """
...
class FusionEnvironmentRefreshActivityRefreshIssueDetailsListArgs:
    def __init__(__self__, *,
                 refresh_issues: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] refresh_issues: Detail reasons of refresh failure or validation failure that needs to be shown to customer.
        """
    ...
    def refresh_issues(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Detail reasons of refresh failure or validation failure that needs to be shown to customer.
        """
    ...
    def refresh_issues(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FusionEnvironmentRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] action: (Updatable) Rule type
        :param pulumi.Input[Sequence[pulumi.Input['FusionEnvironmentRuleConditionArgs']]] conditions: (Updatable)
        :param pulumi.Input[builtins.str] description: (Updatable) A brief description of the access control rule. Avoid entering confidential information. example: `192.168.0.0/16 and 2001:db8::/32 are trusted clients. Whitelist them.` 
