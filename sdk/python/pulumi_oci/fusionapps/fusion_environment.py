...
class FusionEnvironmentArgs:
    def __init__(__self__, *,
                 ...
                 fusion_environment_family_id: pulumi.Input[builtins.str],
                 fusion_environment_type: pulumi.Input[builtins.str],
                 additional_language_packs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The unique identifier (OCID) of the compartment where the Fusion Environment is located.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) FusionEnvironment Identifier can be renamed.
        :param pulumi.Input[builtins.str] fusion_environment_family_id: The unique identifier (OCID) of the Fusion Environment Family that the Fusion Environment belongs to.
        :param pulumi.Input[builtins.str] fusion_environment_type: The type of environment. Valid values are Production, Test, or Development.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] additional_language_packs: (Updatable) Language packs.
        ...
        :param pulumi.Input[builtins.str] dns_prefix: DNS prefix.
        ...
        :param pulumi.Input[builtins.str] kms_key_id: (Updatable) byok kms keyId
    ...
    def fusion_environment_family_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def fusion_environment_family_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "fusion_environment_family_id", value)

    @property
    @pulumi.getter(name="fusionEnvironmentType")
    def fusion_environment_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def fusion_environment_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "fusion_environment_type", value)

    @property
    @pulumi.getter(name="additionalLanguagePacks")
    def additional_language_packs(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def additional_language_packs(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _FusionEnvironmentState:
    def __init__(__self__, *,
                 additional_language_packs: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 applied_patch_bundles: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ...
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 fusion_environment_family_id: Optional[pulumi.Input[builtins.str]] = None,
                 fusion_environment_type: Optional[pulumi.Input[builtins.str]] = None,
                 idcs_domain_url: Optional[pulumi.Input[builtins.str]] = None,
                 is_break_glass_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 kms_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 kms_key_infos: Optional[pulumi.Input[Sequence[pulumi.Input['FusionEnvironmentKmsKeyInfoArgs']]]] = None,
                 lifecycle_details: Optional[pulumi.Input[builtins.str]] = None,
                 lockbox_id: Optional[pulumi.Input[builtins.str]] = None,
                 maintenance_policy: Optional[pulumi.Input['FusionEnvironmentMaintenancePolicyArgs']] = None,
                 public_url: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 system_name: Optional[pulumi.Input[builtins.str]] = None,
                 time_created: Optional[pulumi.Input[builtins.str]] = None,
                 time_upcoming_maintenance: Optional[pulumi.Input[builtins.str]] = None,
                 time_updated: Optional[pulumi.Input[builtins.str]] = None,
                 version: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering FusionEnvironment resources.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] additional_language_packs: (Updatable) Language packs.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] applied_patch_bundles: Patch bundle names
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The unique identifier (OCID) of the compartment where the Fusion Environment is located.
        :param pulumi.Input['FusionEnvironmentCreateFusionEnvironmentAdminUserDetailsArgs'] create_fusion_environment_admin_user_details: The credentials for the Fusion Applications service administrator.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] display_name: (Updatable) FusionEnvironment Identifier can be renamed.
        :param pulumi.Input[builtins.str] dns_prefix: DNS prefix.
        :param pulumi.Input[builtins.str] domain_id: The IDCS domain created for the fusion instance
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.str] fusion_environment_family_id: The unique identifier (OCID) of the Fusion Environment Family that the Fusion Environment belongs to.
        :param pulumi.Input[builtins.str] fusion_environment_type: The type of environment. Valid values are Production, Test, or Development.
        :param pulumi.Input[builtins.str] idcs_domain_url: The IDCS Domain URL
        :param pulumi.Input[builtins.bool] is_break_glass_enabled: If it's true, then the Break Glass feature is enabled
        :param pulumi.Input[builtins.str] kms_key_id: (Updatable) byok kms keyId
        ...
        :param pulumi.Input[builtins.str] lockbox_id: The lockbox Id of this fusion environment. If there's no lockbox id, this field will be null
        :param pulumi.Input['FusionEnvironmentMaintenancePolicyArgs'] maintenance_policy: (Updatable) The policy that specifies the maintenance and upgrade preferences for an environment. For more information about the options, see [Understanding Environment Maintenance](https://docs.cloud.oracle.com/iaas/Content/fusion-applications/plan-environment-family.htm#about-env-maintenance).
        :param pulumi.Input[builtins.str] public_url: Public URL
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subscription_ids: List of subscription IDs.
        :param pulumi.Input[builtins.str] system_name: Environment Specific Guid/ System Name
        :param pulumi.Input[builtins.str] time_created: The time the the FusionEnvironment was created. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.str] time_upcoming_maintenance: The next maintenance for this environment
        :param pulumi.Input[builtins.str] time_updated: The time the FusionEnvironment was updated. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.str] version: Version of Fusion Apps used by this environment
        """
        if additional_language_packs is not None:
            pulumi.set(__self__, "additional_language_packs", additional_language_packs)
    ...
    def applied_patch_bundles(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Patch bundle names
        """
    ...
    def applied_patch_bundles(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    @property
    @pulumi.getter(name="fusionEnvironmentFamilyId")
    def fusion_environment_family_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The unique identifier (OCID) of the Fusion Environment Family that the Fusion Environment belongs to.
        """
        return pulumi.get(self, "fusion_environment_family_id")
    ...
    @fusion_environment_family_id.setter
    def fusion_environment_family_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "fusion_environment_family_id", value)

    @property
    @pulumi.getter(name="fusionEnvironmentType")
    def fusion_environment_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of environment. Valid values are Production, Test, or Development.
        """
        return pulumi.get(self, "fusion_environment_type")
    ...
    @fusion_environment_type.setter
    def fusion_environment_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "fusion_environment_type", value)

    @property
    @pulumi.getter(name="idcsDomainUrl")
    def idcs_domain_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IDCS Domain URL
        """
    ...
    def idcs_domain_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "idcs_domain_url", value)

    @property
    @pulumi.getter(name="isBreakGlassEnabled")
    def is_break_glass_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_break_glass_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def lockbox_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @lockbox_id.setter
    def lockbox_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def public_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Public URL
        """
    ...
    @public_url.setter
    def public_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def system_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @system_name.setter
    def system_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_upcoming_maintenance(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_upcoming_maintenance(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FusionEnvironment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_upcoming_maintenance: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'FusionEnvironment':
        """
    ...
    @property
    @pulumi.getter(name="additionalLanguagePacks")
    def additional_language_packs(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) Language packs.
        """
        return pulumi.get(self, "additional_language_packs")
    ...
    @property
    @pulumi.getter(name="appliedPatchBundles")
    def applied_patch_bundles(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Patch bundle names
        """
        return pulumi.get(self, "applied_patch_bundles")
    ...
    @property
    @pulumi.getter(name="dnsPrefix")
    def dns_prefix(self) -> pulumi.Output[builtins.str]:
        """
        DNS prefix.
        """
        return pulumi.get(self, "dns_prefix")
    ...
    @property
    @pulumi.getter(name="fusionEnvironmentFamilyId")
    def fusion_environment_family_id(self) -> pulumi.Output[builtins.str]:
        """
        The unique identifier (OCID) of the Fusion Environment Family that the Fusion Environment belongs to.
        """
        return pulumi.get(self, "fusion_environment_family_id")
    ...
    @property
    @pulumi.getter(name="fusionEnvironmentType")
    def fusion_environment_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of environment. Valid values are Production, Test, or Development.
        """
        return pulumi.get(self, "fusion_environment_type")
    ...
    @property
    @pulumi.getter(name="idcsDomainUrl")
    def idcs_domain_url(self) -> pulumi.Output[builtins.str]:
        """
        The IDCS Domain URL
        """
        return pulumi.get(self, "idcs_domain_url")
    ...
    @property
    @pulumi.getter(name="isBreakGlassEnabled")
    def is_break_glass_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        If it's true, then the Break Glass feature is enabled
        """
        return pulumi.get(self, "is_break_glass_enabled")
    ...
    @property
    @pulumi.getter(name="lockboxId")
    def lockbox_id(self) -> pulumi.Output[builtins.str]:
        """
        The lockbox Id of this fusion environment. If there's no lockbox id, this field will be null
        """
        return pulumi.get(self, "lockbox_id")
    ...
    @property
    @pulumi.getter(name="publicUrl")
    def public_url(self) -> pulumi.Output[builtins.str]:
        """
        Public URL
        """
        return pulumi.get(self, "public_url")
    ...
    @property
    @pulumi.getter(name="systemName")
    def system_name(self) -> pulumi.Output[builtins.str]:
        """
        Environment Specific Guid/ System Name
        """
        return pulumi.get(self, "system_name")
    ...
    @property
    @pulumi.getter(name="timeUpcomingMaintenance")
    def time_upcoming_maintenance(self) -> pulumi.Output[builtins.str]:
        """
        The next maintenance for this environment
        """
        return pulumi.get(self, "time_upcoming_maintenance")
