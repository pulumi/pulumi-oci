...
class FusionEnvironmentDataMaskingActivityArgs:
    def __init__(__self__, *,
                 ...
                 is_resume_data_masking: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] is_resume_data_masking: This allows the Data Safe service to resume the previously failed data masking activity.
    ...
    def is_resume_data_masking(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_resume_data_masking(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _FusionEnvironmentDataMaskingActivityState:
    def __init__(__self__, *,
                 ...
                 time_masking_finish: Optional[pulumi.Input[builtins.str]] = None,
                 time_masking_start: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.bool] is_resume_data_masking: This allows the Data Safe service to resume the previously failed data masking activity.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The current state of the DataMaskingActivity.
        :param pulumi.Input[builtins.str] time_masking_finish: The time the data masking activity ended. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_masking_start: The time the data masking activity started. An RFC3339 formatted datetime string.
        """
    ...
    def time_masking_finish(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_masking_finish(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_masking_finish", value)

    @property
    @pulumi.getter(name="timeMaskingStart")
    def time_masking_start(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_masking_start(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FusionEnvironmentDataMaskingActivity(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_masking_finish: Optional[pulumi.Input[builtins.str]] = None,
            time_masking_start: Optional[pulumi.Input[builtins.str]] = None) -> 'FusionEnvironmentDataMaskingActivity':
        """
    ...
    @property
    @pulumi.getter(name="isResumeDataMasking")
    def is_resume_data_masking(self) -> pulumi.Output[builtins.bool]:
        """
        This allows the Data Safe service to resume the previously failed data masking activity.
    ...
    @property
    @pulumi.getter(name="timeMaskingFinish")
    def time_masking_finish(self) -> pulumi.Output[builtins.str]:
        """
        The time the data masking activity ended. An RFC3339 formatted datetime string.
        """
        return pulumi.get(self, "time_masking_finish")
    ...
    @property
    @pulumi.getter(name="timeMaskingStart")
    def time_masking_start(self) -> pulumi.Output[builtins.str]:
        """
        The time the data masking activity started. An RFC3339 formatted datetime string.
        """
        return pulumi.get(self, "time_masking_start")
