...
class _FusionEnvironmentFamilyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] state: The current state of the FusionEnvironmentFamily.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] subscription_ids: (Updatable) The list of the IDs of the applications subscriptions that are associated with the environment family.
        ...
        :param pulumi.Input[_builtins.str] time_created: The time the the FusionEnvironmentFamily was created. An RFC3339 formatted datetime string.
        """
...
class FusionEnvironmentFamily(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="isSubscriptionUpdateNeeded")
    def is_subscription_update_needed(self) -> pulumi.Output[_builtins.bool]:
        """
        When set to True, a subscription update is required for the environment family.
        """
        return pulumi.get(self, "is_subscription_update_needed")
