...
class FusionEnvironmentFamilyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment where the environment family is located.
        :param pulumi.Input[builtins.str] display_name: (Updatable) A friendly name for the environment family. The name must contain only letters, numbers, dashes, and underscores. Can be changed later.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subscription_ids: (Updatable) The list of the IDs of the applications subscriptions that are associated with the environment family.
...
class _FusionEnvironmentFamilyState:
    def __init__(__self__, *,
                 ...
                 family_maintenance_policy: Optional[pulumi.Input['FusionEnvironmentFamilyFamilyMaintenancePolicyArgs']] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_subscription_update_needed: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input['FusionEnvironmentFamilyFamilyMaintenancePolicyArgs'] family_maintenance_policy: (Updatable) The policy that specifies the maintenance and upgrade preferences for an environment. For more information about the options, see [Understanding Environment Maintenance](https://docs.cloud.oracle.com/iaas/Content/fusion-applications/plan-environment-family.htm#about-env-maintenance).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.bool] is_subscription_update_needed: When set to True, a subscription update is required for the environment family.
        ...
        :param pulumi.Input[builtins.str] state: The current state of the FusionEnvironmentFamily.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] subscription_ids: (Updatable) The list of the IDs of the applications subscriptions that are associated with the environment family.
        ...
        :param pulumi.Input[builtins.str] time_created: The time the the FusionEnvironmentFamily was created. An RFC3339 formatted datetime string.
        """
    ...
    def is_subscription_update_needed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_subscription_update_needed(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class FusionEnvironmentFamily(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_name: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'FusionEnvironmentFamily':
        """
    ...
    @property
    @pulumi.getter(name="isSubscriptionUpdateNeeded")
    def is_subscription_update_needed(self) -> pulumi.Output[builtins.bool]:
        """
        When set to True, a subscription update is required for the environment family.
        """
        return pulumi.get(self, "is_subscription_update_needed")
