...
class FusionEnvironmentRefreshActivityArgs:
    def __init__(__self__, *,
                 fusion_environment_id: pulumi.Input[builtins.str],
                 source_fusion_environment_id: pulumi.Input[builtins.str],
                 is_data_masking_opted: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a FusionEnvironmentRefreshActivity resource.
        :param pulumi.Input[builtins.str] fusion_environment_id: unique FusionEnvironment identifier
        :param pulumi.Input[builtins.str] source_fusion_environment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the source environment
        :param pulumi.Input[builtins.bool] is_data_masking_opted: Represents if the customer opted for Data Masking or not during refreshActivity.
        """
    ...
    def fusion_environment_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def fusion_environment_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "fusion_environment_id", value)

    @property
    @pulumi.getter(name="sourceFusionEnvironmentId")
    def source_fusion_environment_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def source_fusion_environment_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "source_fusion_environment_id", value)

    @property
    @pulumi.getter(name="isDataMaskingOpted")
    def is_data_masking_opted(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_data_masking_opted(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _FusionEnvironmentRefreshActivityState:
    def __init__(__self__, *,
                 ...
                 fusion_environment_id: Optional[pulumi.Input[builtins.str]] = None,
                 is_data_masking_opted: Optional[pulumi.Input[builtins.bool]] = None,
                 lifecycle_details: Optional[pulumi.Input[builtins.str]] = None,
                 refresh_activity_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 service_availability: Optional[pulumi.Input[builtins.str]] = None,
                 source_fusion_environment_id: Optional[pulumi.Input[builtins.str]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 time_accepted: Optional[pulumi.Input[builtins.str]] = None,
                 time_expected_finish: Optional[pulumi.Input[builtins.str]] = None,
                 time_finished: Optional[pulumi.Input[builtins.str]] = None,
                 time_of_restoration_point: Optional[pulumi.Input[builtins.str]] = None,
                 time_updated: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering FusionEnvironmentRefreshActivity resources.
        :param pulumi.Input[builtins.str] display_name: A friendly name for the refresh activity. Can be changed later.
        :param pulumi.Input[builtins.str] fusion_environment_id: unique FusionEnvironment identifier
        :param pulumi.Input[builtins.bool] is_data_masking_opted: Represents if the customer opted for Data Masking or not during refreshActivity.
        ...
        :param pulumi.Input[builtins.str] service_availability: Service availability / impact during refresh activity execution up down
        :param pulumi.Input[builtins.str] source_fusion_environment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the source environment
        :param pulumi.Input[builtins.str] state: The current state of the refreshActivity.
        :param pulumi.Input[builtins.str] time_accepted: The time the refresh activity record was created. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_expected_finish: The time the refresh activity is scheduled to end. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_finished: The time the refresh activity actually completed / cancelled / failed. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_of_restoration_point: The date and time of the most recent source environment backup used for the environment refresh.
        :param pulumi.Input[builtins.str] time_updated: The time the refresh activity record was updated. An RFC3339 formatted datetime string.
        """
    ...
    @property
    @pulumi.getter(name="fusionEnvironmentId")
    def fusion_environment_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        unique FusionEnvironment identifier
        """
        return pulumi.get(self, "fusion_environment_id")
    ...
    @fusion_environment_id.setter
    def fusion_environment_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "fusion_environment_id", value)
    ...
    def refresh_activity_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "refresh_activity_id")

    @refresh_activity_id.setter
    def refresh_activity_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def service_availability(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def service_availability(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_availability", value)

    @property
    @pulumi.getter(name="sourceFusionEnvironmentId")
    def source_fusion_environment_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the source environment
        """
        return pulumi.get(self, "source_fusion_environment_id")
    ...
    @source_fusion_environment_id.setter
    def source_fusion_environment_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_fusion_environment_id", value)
    ...
    def time_expected_finish(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_expected_finish(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_of_restoration_point(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_of_restoration_point(self, value: Optional[pulumi.Input[builtins.str]]):
...
class FusionEnvironmentRefreshActivity(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_finished: Optional[pulumi.Input[builtins.str]] = None,
            time_of_restoration_point: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'FusionEnvironmentRefreshActivity':
        """
    ...
    @property
    @pulumi.getter(name="fusionEnvironmentId")
    def fusion_environment_id(self) -> pulumi.Output[builtins.str]:
        """
        unique FusionEnvironment identifier
        """
        return pulumi.get(self, "fusion_environment_id")
    ...
    @property
    @pulumi.getter(name="isDataMaskingOpted")
    def is_data_masking_opted(self) -> pulumi.Output[builtins.bool]:
        """
        Represents if the customer opted for Data Masking or not during refreshActivity.
        """
        return pulumi.get(self, "is_data_masking_opted")
    ...
    @property
    @pulumi.getter(name="refreshActivityId")
    def refresh_activity_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "refresh_activity_id")
    ...
    @property
    @pulumi.getter(name="serviceAvailability")
    def service_availability(self) -> pulumi.Output[builtins.str]:
        """
        Service availability / impact during refresh activity execution up down
        """
        return pulumi.get(self, "service_availability")
    ...
    @property
    @pulumi.getter(name="sourceFusionEnvironmentId")
    def source_fusion_environment_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the source environment
        """
        return pulumi.get(self, "source_fusion_environment_id")
    ...
    @property
    @pulumi.getter(name="timeExpectedFinish")
    def time_expected_finish(self) -> pulumi.Output[builtins.str]:
        """
        The time the refresh activity is scheduled to end. An RFC3339 formatted datetime string.
        """
        return pulumi.get(self, "time_expected_finish")
    ...
    @property
    @pulumi.getter(name="timeOfRestorationPoint")
    def time_of_restoration_point(self) -> pulumi.Output[builtins.str]:
        """
        The date and time of the most recent source environment backup used for the environment refresh.
        """
        return pulumi.get(self, "time_of_restoration_point")
