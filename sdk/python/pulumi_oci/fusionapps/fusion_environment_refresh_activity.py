...
class FusionEnvironmentRefreshActivityArgs:
    ...
    def source_fusion_environment_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def source_fusion_environment_id(self, value: pulumi.Input[_builtins.str]):
...
class _FusionEnvironmentRefreshActivityState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] time_accepted: The time the refresh activity record was created. An RFC3339 formatted datetime string.
        :param pulumi.Input[_builtins.str] time_expected_finish: The time the refresh activity is scheduled to end. An RFC3339 formatted datetime string.
        :param pulumi.Input[_builtins.str] time_finished: The time the refresh activity actually completed / cancelled / failed. An RFC3339 formatted datetime string.
        :param pulumi.Input[_builtins.str] time_of_restoration_point: The date and time of the most recent source environment backup used for the environment refresh.
        :param pulumi.Input[_builtins.str] time_updated: The time the refresh activity record was updated. An RFC3339 formatted datetime string.
        """
...
class FusionEnvironmentRefreshActivity(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="isDataMaskingOpted")
    def is_data_masking_opted(self) -> pulumi.Output[_builtins.bool]:
        """
        Represents if the customer opted for Data Masking or not during refreshActivity.
        """
        return pulumi.get(self, "is_data_masking_opted")
    ...
    @_builtins.property
    @pulumi.getter(name="refreshActivityId")
    def refresh_activity_id(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "refresh_activity_id")
    ...
    @_builtins.property
    @pulumi.getter(name="serviceAvailability")
    def service_availability(self) -> pulumi.Output[_builtins.str]:
        """
        Service availability / impact during refresh activity execution up down
        """
        return pulumi.get(self, "service_availability")
    ...
    @_builtins.property
    @pulumi.getter(name="sourceFusionEnvironmentId")
    def source_fusion_environment_id(self) -> pulumi.Output[_builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the source environment
        """
        return pulumi.get(self, "source_fusion_environment_id")
    ...
    @_builtins.property
    @pulumi.getter(name="timeExpectedFinish")
    def time_expected_finish(self) -> pulumi.Output[_builtins.str]:
        """
        The time the refresh activity is scheduled to end. An RFC3339 formatted datetime string.
        """
        return pulumi.get(self, "time_expected_finish")
    ...
    @_builtins.property
    @pulumi.getter(name="timeOfRestorationPoint")
    def time_of_restoration_point(self) -> pulumi.Output[_builtins.str]:
        """
        The date and time of the most recent source environment backup used for the environment refresh.
        """
        return pulumi.get(self, "time_of_restoration_point")
