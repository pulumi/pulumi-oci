...
class FusionEnvironmentServiceAttachmentArgs:
    def __init__(__self__, *,
                 ...
                 service_instance_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] service_instance_id: The service instance OCID of the instance being attached
        :param pulumi.Input[builtins.str] service_instance_type: Type of the ServiceInstance being attached.
    ...
    def service_instance_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def service_instance_type(self, value: pulumi.Input[builtins.str]):
...
class _FusionEnvironmentServiceAttachmentState:
    def __init__(__self__, *,
                 ...
                 is_sku_based: Optional[pulumi.Input[builtins.bool]] = None,
                 service_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 service_instance_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] display_name: Service Attachment Display name, can be renamed
        ...
        :param pulumi.Input[builtins.str] fusion_environment_id: unique FusionEnvironment identifier
        :param pulumi.Input[builtins.bool] is_sku_based: Whether this service is provisioned due to the customer being subscribed to a specific SKU
        :param pulumi.Input[builtins.str] service_instance_id: The service instance OCID of the instance being attached
        :param pulumi.Input[builtins.str] service_instance_type: Type of the ServiceInstance being attached.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] service_url: Public URL
        :param pulumi.Input[builtins.str] state: The current state of the ServiceInstance.
        :param pulumi.Input[builtins.str] time_created: The time the the ServiceInstance was created. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.str] time_updated: The time the ServiceInstance was updated. An RFC3339 formatted datetime string
        """
    ...
    def is_sku_based(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_sku_based.setter
    def is_sku_based(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter(name="serviceInstanceType")
    def service_instance_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Type of the ServiceInstance being attached.
    ...
    @service_instance_type.setter
    def service_instance_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_instance_type", value)
...
class FusionEnvironmentServiceAttachment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'FusionEnvironmentServiceAttachment':
        """
    ...
    @property
    @pulumi.getter(name="isSkuBased")
    def is_sku_based(self) -> pulumi.Output[builtins.bool]:
        """
        Whether this service is provisioned due to the customer being subscribed to a specific SKU
        """
        return pulumi.get(self, "is_sku_based")
    ...
    @property
    @pulumi.getter(name="serviceInstanceType")
    def service_instance_type(self) -> pulumi.Output[builtins.str]:
        """
        Type of the ServiceInstance being attached.
