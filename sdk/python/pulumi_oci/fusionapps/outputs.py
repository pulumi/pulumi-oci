...
class FusionEnvironmentAdminUserItem(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str email_address: The email address for the administrator.
        :param builtins.str first_name: The administrator's first name.
        :param builtins.str last_name: The administrator's last name.
        :param builtins.str username: The username for the administrator.
...
class FusionEnvironmentCreateFusionEnvironmentAdminUserDetails(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str last_name: The administrator's last name.
        :param builtins.str username: The username for the administrator.
        :param builtins.str password: The password for the administrator.
        """
        pulumi.set(__self__, "email_address", email_address)
        pulumi.set(__self__, "first_name", first_name)
        pulumi.set(__self__, "last_name", last_name)
...
class FusionEnvironmentFamilyFamilyMaintenancePolicy(dict):
    ...
    def __init__(__self__, *,
                 concurrent_maintenance: Optional[builtins.str] = None,
                 is_monthly_patching_enabled: Optional[builtins.bool] = None,
                 quarterly_upgrade_begin_times: Optional[builtins.str] = None):
        """
        :param builtins.str concurrent_maintenance: (Updatable) Option to upgrade both production and non-production environments at the same time. When set to PROD both types of environnments are upgraded on the production schedule. When set to NON_PROD both types of environments are upgraded on the non-production schedule.
        :param builtins.bool is_monthly_patching_enabled: (Updatable) When True, monthly patching is enabled for the environment family.
    ...
    def concurrent_maintenance(self) -> Optional[builtins.str]:
        """
    ...
    def quarterly_upgrade_begin_times(self) -> Optional[builtins.str]:
        """
...
class FusionEnvironmentKmsKeyInfo(dict):
    ...
    def __init__(__self__, *,
                 active_key_id: Optional[builtins.str] = None,
                 active_key_version: Optional[builtins.str] = None,
                 current_key_lifecycle_state: Optional[builtins.str] = None,
                 scheduled_key_id: Optional[builtins.str] = None,
                 scheduled_key_status: Optional[builtins.str] = None,
                 scheduled_key_version: Optional[builtins.str] = None,
                 scheduled_lifecycle_state: Optional[builtins.str] = None):
...
class FusionEnvironmentMaintenancePolicy(dict):
    ...
    def __init__(__self__, *,
                 environment_maintenance_override: Optional[builtins.str] = None,
                 monthly_patching_override: Optional[builtins.str] = None,
                 quarterly_upgrade_begin_times: Optional[Sequence['outputs.FusionEnvironmentMaintenancePolicyQuarterlyUpgradeBeginTime']] = None):
        """
        :param builtins.str environment_maintenance_override: (Updatable) User choice to upgrade both test and prod pods at the same time. Overrides fusion environment families'.
        :param builtins.str monthly_patching_override: (Updatable) When "ENABLED", the Fusion environment is patched monthly. When "DISABLED", the Fusion environment is not patched monthly. This setting overrides the environment family setting. When not set, the environment follows the environment family policy.
    ...
    def environment_maintenance_override(self) -> Optional[builtins.str]:
        """
    ...
    def monthly_patching_override(self) -> Optional[builtins.str]:
        """
...
class FusionEnvironmentMaintenancePolicyQuarterlyUpgradeBeginTime(dict):
    ...
    def __init__(__self__, *,
                 begin_times_value: Optional[builtins.str] = None,
                 override_type: Optional[builtins.str] = None):
        """
    ...
    def begin_times_value(self) -> Optional[builtins.str]:
        """
    ...
    def override_type(self) -> Optional[builtins.str]:
        """
...
class FusionEnvironmentRefresh(dict):
    ...
    def __init__(__self__, *,
                 source_fusion_environment_id: Optional[builtins.str] = None,
                 time_finished: Optional[builtins.str] = None,
                 time_of_restoration_point: Optional[builtins.str] = None):
        """
    ...
    def source_fusion_environment_id(self) -> Optional[builtins.str]:
        """
    ...
    def time_of_restoration_point(self) -> Optional[builtins.str]:
        """
...
class FusionEnvironmentRefreshActivityRefreshIssueDetailsList(dict):
    ...
    def __init__(__self__, *,
                 refresh_issues: Optional[builtins.str] = None):
        """
    ...
    def refresh_issues(self) -> Optional[builtins.str]:
        """
...
class FusionEnvironmentRule(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: (Updatable) Rule type
        :param Sequence['FusionEnvironmentRuleConditionArgs'] conditions: (Updatable)
        :param builtins.str description: (Updatable) A brief description of the access control rule. Avoid entering confidential information. example: `192.168.0.0/16 and 2001:db8::/32 are trusted clients. Whitelist them.` 
