...
if not MYPY:
    class AgentAgentEndpointContentModerationConfigArgsDict(TypedDict):
        should_enable_on_input: NotRequired[pulumi.Input[builtins.bool]]
        """
        (Updatable) A flag to enable or disable content moderation on input.
        """
        should_enable_on_output: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class AgentAgentEndpointContentModerationConfigArgs:
    def __init__(__self__, *,
                 should_enable_on_input: Optional[pulumi.Input[builtins.bool]] = None,
                 should_enable_on_output: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] should_enable_on_input: (Updatable) A flag to enable or disable content moderation on input.
        :param pulumi.Input[builtins.bool] should_enable_on_output: (Updatable) A flag to enable or disable content moderation on output.
        """
    ...
    def should_enable_on_input(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) A flag to enable or disable content moderation on input.
        """
    ...
    def should_enable_on_input(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "should_enable_on_input", value)

    @property
    @pulumi.getter(name="shouldEnableOnOutput")
    def should_enable_on_output(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) A flag to enable or disable content moderation on output.
        """
    ...
    def should_enable_on_output(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class AgentAgentEndpointSessionConfigArgs:
    def __init__(__self__, *,
                 idle_timeout_in_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] idle_timeout_in_seconds: (Updatable) The session will become inactive after this timeout.
        """
    ...
    def idle_timeout_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The session will become inactive after this timeout.
        """
    ...
    def idle_timeout_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class AgentDataIngestionJobDataIngestionJobStatisticArgsDict(TypedDict):
        ...
        """
        number_of_failed_files: NotRequired[pulumi.Input[builtins.int]]
        """
        The number of files that have failed during the ingestion.
        """
        number_of_ingested_files: NotRequired[pulumi.Input[builtins.int]]
        """
...
class AgentDataIngestionJobDataIngestionJobStatisticArgs:
    def __init__(__self__, *,
                 ...
                 number_of_failed_files: Optional[pulumi.Input[builtins.int]] = None,
                 number_of_ingested_files: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] duration_in_seconds: The duration of this ingestion job.
        :param pulumi.Input[builtins.int] number_of_failed_files: The number of files that have failed during the ingestion.
        :param pulumi.Input[builtins.int] number_of_ingested_files: The number of files that have been successfully ingested during the ingestion.
        """
    ...
    def number_of_failed_files(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of files that have failed during the ingestion.
        """
    ...
    def number_of_failed_files(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "number_of_failed_files", value)

    @property
    @pulumi.getter(name="numberOfIngestedFiles")
    def number_of_ingested_files(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of files that have been successfully ingested during the ingestion.
        """
    ...
    def number_of_ingested_files(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "number_of_ingested_files", value)


if not MYPY:
    class AgentDataSourceDataSourceConfigArgsDict(TypedDict):
        data_source_config_type: pulumi.Input[builtins.str]
        """
...
class AgentDataSourceDataSourceConfigArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] data_source_config_type: (Updatable) The type of the tool. The allowed values are:
               * `OCI_OBJECT_STORAGE`: The data source is Oracle Cloud Infrastructure Object Storage.
    ...
    def data_source_config_type(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The type of the tool. The allowed values are:
        * `OCI_OBJECT_STORAGE`: The data source is Oracle Cloud Infrastructure Object Storage.
        """
    ...
    def data_source_config_type(self, value: pulumi.Input[builtins.str]):
...
class AgentDataSourceDataSourceConfigObjectStoragePrefixArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] prefix: (Updatable) The name of the object (file) or prefix (folder).
        """
...
if not MYPY:
    class AgentKnowledgeBaseIndexConfigArgsDict(TypedDict):
        index_config_type: pulumi.Input[builtins.str]
        """
        ...
        * `OCI_DATABASE_CONFIG`: OciDatabaseConfig allows customer to configure their Database.
        ...
        """
        should_enable_hybrid_search: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class AgentKnowledgeBaseIndexConfigArgs:
    def __init__(__self__, *,
                 ...
                 should_enable_hybrid_search: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] index_config_type: (Updatable) The type of index. The allowed values are:
               * `DEFAULT_INDEX_CONFIG`: DefaultIndexConfig allows the service to create and manage vector store on behalf of the customer.
               * `OCI_OPEN_SEARCH_INDEX_CONFIG`: OciOpenSearchIndexConfig allows customer to configure their OpenSearch cluster.
               * `OCI_DATABASE_CONFIG`: OciDatabaseConfig allows customer to configure their Database.
        :param pulumi.Input[builtins.str] cluster_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the OpenSearch Cluster.
        ...
        :param pulumi.Input['AgentKnowledgeBaseIndexConfigSecretDetailArgs'] secret_detail: (Updatable) **SecretDetail**
               ...
               The details of configured security configuration on OpenSearch.
        :param pulumi.Input[builtins.bool] should_enable_hybrid_search: (Updatable) Whether to enable Hybrid search in service managed OpenSearch.
    ...
    def index_config_type(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The type of index. The allowed values are:
        * `DEFAULT_INDEX_CONFIG`: DefaultIndexConfig allows the service to create and manage vector store on behalf of the customer.
        * `OCI_OPEN_SEARCH_INDEX_CONFIG`: OciOpenSearchIndexConfig allows customer to configure their OpenSearch cluster.
    ...
    def index_config_type(self, value: pulumi.Input[builtins.str]):
    ...
    def should_enable_hybrid_search(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) Whether to enable Hybrid search in service managed OpenSearch.
    ...
    def should_enable_hybrid_search(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class AgentKnowledgeBaseIndexConfigDatabaseFunctionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: (Updatable) The name of the Database function.
        """
        if name is not None:
...
class AgentKnowledgeBaseIndexConfigIndexArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: (Updatable) The index name in opensearch.
...
if not MYPY:
    class DedicatedAiClusterCapacityArgsDict(TypedDict):
        capacity_type: NotRequired[pulumi.Input[builtins.str]]
        """
        The type of the dedicated AI cluster capacity.
        """
        total_endpoint_capacity: NotRequired[pulumi.Input[builtins.int]]
        """
        The total number of endpoints that can be hosted on this dedicated AI cluster.
        """
        used_endpoint_capacity: NotRequired[pulumi.Input[builtins.int]]
        """
...
class DedicatedAiClusterCapacityArgs:
    def __init__(__self__, *,
                 ...
                 total_endpoint_capacity: Optional[pulumi.Input[builtins.int]] = None,
                 used_endpoint_capacity: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] capacity_type: The type of the dedicated AI cluster capacity.
        :param pulumi.Input[builtins.int] total_endpoint_capacity: The total number of endpoints that can be hosted on this dedicated AI cluster.
        :param pulumi.Input[builtins.int] used_endpoint_capacity: The number of endpoints hosted on this dedicated AI cluster.
        """
    ...
    def total_endpoint_capacity(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The total number of endpoints that can be hosted on this dedicated AI cluster.
        """
    ...
    def total_endpoint_capacity(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "total_endpoint_capacity", value)

    @property
    @pulumi.getter(name="usedEndpointCapacity")
    def used_endpoint_capacity(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of endpoints hosted on this dedicated AI cluster.
        """
    ...
    def used_endpoint_capacity(self, value: Optional[pulumi.Input[builtins.int]]):
...
class EndpointContentModerationConfigArgs:
    def __init__(__self__, *,
                 is_enabled: pulumi.Input[builtins.bool]):
        """
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) Whether to enable the content moderation feature.
        """
...
class ModelFineTuneDetailsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] dedicated_ai_cluster_id: The OCID of the dedicated AI cluster this fine-tuning runs on.
...
if not MYPY:
    class ModelFineTuneDetailsTrainingConfigArgsDict(TypedDict):
        training_config_type: pulumi.Input[builtins.str]
        """
        The fine-tuning method for training a custom model.
        """
        early_stopping_patience: NotRequired[pulumi.Input[builtins.int]]
        """
        Stop training if the loss metric does not improve beyond 'early_stopping_threshold' for this many times of evaluation.
        """
        early_stopping_threshold: NotRequired[pulumi.Input[builtins.float]]
        """
        How much the loss must improve to prevent early stopping.
        """
        learning_rate: NotRequired[pulumi.Input[builtins.float]]
        """
        The initial learning rate to be used during training
        """
        log_model_metrics_interval_in_steps: NotRequired[pulumi.Input[builtins.int]]
        """
        Determines how frequently to log model metrics. 

        Every step is logged for the first 20 steps and then follows this parameter for log frequency. Set to 0 to disable logging the model metrics.
        """
        lora_alpha: NotRequired[pulumi.Input[builtins.int]]
        """
        This parameter represents the scaling factor for the weight matrices in LoRA.
        """
        lora_dropout: NotRequired[pulumi.Input[builtins.float]]
        """
        This parameter indicates the dropout probability for LoRA layers.
        """
        lora_r: NotRequired[pulumi.Input[builtins.int]]
        """
        This parameter represents the LoRA rank of the update matrices.
        """
        num_of_last_layers: NotRequired[pulumi.Input[builtins.int]]
        """
        The number of last layers to be fine-tuned.
        """
        total_training_epochs: NotRequired[pulumi.Input[builtins.int]]
        """
        The maximum number of training epochs to run for.
        """
        training_batch_size: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ModelFineTuneDetailsTrainingConfigArgs:
    def __init__(__self__, *,
                 training_config_type: pulumi.Input[builtins.str],
                 early_stopping_patience: Optional[pulumi.Input[builtins.int]] = None,
                 early_stopping_threshold: Optional[pulumi.Input[builtins.float]] = None,
                 learning_rate: Optional[pulumi.Input[builtins.float]] = None,
                 log_model_metrics_interval_in_steps: Optional[pulumi.Input[builtins.int]] = None,
                 lora_alpha: Optional[pulumi.Input[builtins.int]] = None,
                 lora_dropout: Optional[pulumi.Input[builtins.float]] = None,
                 lora_r: Optional[pulumi.Input[builtins.int]] = None,
                 num_of_last_layers: Optional[pulumi.Input[builtins.int]] = None,
                 total_training_epochs: Optional[pulumi.Input[builtins.int]] = None,
                 training_batch_size: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] training_config_type: The fine-tuning method for training a custom model.
        :param pulumi.Input[builtins.int] early_stopping_patience: Stop training if the loss metric does not improve beyond 'early_stopping_threshold' for this many times of evaluation.
        :param pulumi.Input[builtins.float] early_stopping_threshold: How much the loss must improve to prevent early stopping.
        :param pulumi.Input[builtins.float] learning_rate: The initial learning rate to be used during training
        :param pulumi.Input[builtins.int] log_model_metrics_interval_in_steps: Determines how frequently to log model metrics. 
               
               Every step is logged for the first 20 steps and then follows this parameter for log frequency. Set to 0 to disable logging the model metrics.
        :param pulumi.Input[builtins.int] lora_alpha: This parameter represents the scaling factor for the weight matrices in LoRA.
        :param pulumi.Input[builtins.float] lora_dropout: This parameter indicates the dropout probability for LoRA layers.
        :param pulumi.Input[builtins.int] lora_r: This parameter represents the LoRA rank of the update matrices.
        :param pulumi.Input[builtins.int] num_of_last_layers: The number of last layers to be fine-tuned.
        :param pulumi.Input[builtins.int] total_training_epochs: The maximum number of training epochs to run for.
        :param pulumi.Input[builtins.int] training_batch_size: The batch size used during training.
        """
    ...
    def training_config_type(self) -> pulumi.Input[builtins.str]:
        """
        The fine-tuning method for training a custom model.
        """
    ...
    def training_config_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "training_config_type", value)

    @property
    @pulumi.getter(name="earlyStoppingPatience")
    def early_stopping_patience(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Stop training if the loss metric does not improve beyond 'early_stopping_threshold' for this many times of evaluation.
        """
    ...
    def early_stopping_patience(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "early_stopping_patience", value)

    @property
    @pulumi.getter(name="earlyStoppingThreshold")
    def early_stopping_threshold(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        How much the loss must improve to prevent early stopping.
        """
    ...
    def early_stopping_threshold(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "early_stopping_threshold", value)

    @property
    @pulumi.getter(name="learningRate")
    def learning_rate(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The initial learning rate to be used during training
        """
    ...
    def learning_rate(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "learning_rate", value)

    @property
    @pulumi.getter(name="logModelMetricsIntervalInSteps")
    def log_model_metrics_interval_in_steps(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        Determines how frequently to log model metrics. 
    ...
    def log_model_metrics_interval_in_steps(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "log_model_metrics_interval_in_steps", value)

    @property
    @pulumi.getter(name="loraAlpha")
    def lora_alpha(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        This parameter represents the scaling factor for the weight matrices in LoRA.
        """
    ...
    @lora_alpha.setter
    def lora_alpha(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "lora_alpha", value)

    @property
    @pulumi.getter(name="loraDropout")
    def lora_dropout(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        This parameter indicates the dropout probability for LoRA layers.
        """
    ...
    @lora_dropout.setter
    def lora_dropout(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "lora_dropout", value)

    @property
    @pulumi.getter(name="loraR")
    def lora_r(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        This parameter represents the LoRA rank of the update matrices.
        """
    ...
    @lora_r.setter
    def lora_r(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "lora_r", value)

    @property
    @pulumi.getter(name="numOfLastLayers")
    def num_of_last_layers(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The number of last layers to be fine-tuned.
        """
    ...
    def num_of_last_layers(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "num_of_last_layers", value)

    @property
    @pulumi.getter(name="totalTrainingEpochs")
    def total_training_epochs(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The maximum number of training epochs to run for.
        """
    ...
    def total_training_epochs(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "total_training_epochs", value)

    @property
    @pulumi.getter(name="trainingBatchSize")
    def training_batch_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The batch size used during training.
        """
    ...
    def training_batch_size(self, value: Optional[pulumi.Input[builtins.int]]):
...
class ModelFineTuneDetailsTrainingDatasetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] dataset_type: The type of the data asset.
...
if not MYPY:
    class ModelModelMetricArgsDict(TypedDict):
        final_accuracy: NotRequired[pulumi.Input[builtins.float]]
        """
        Fine-tuned model accuracy.
        """
        final_loss: NotRequired[pulumi.Input[builtins.float]]
        """
        Fine-tuned model loss.
        """
        model_metrics_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ModelModelMetricArgs:
    def __init__(__self__, *,
                 final_accuracy: Optional[pulumi.Input[builtins.float]] = None,
                 final_loss: Optional[pulumi.Input[builtins.float]] = None,
                 model_metrics_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.float] final_accuracy: Fine-tuned model accuracy.
        :param pulumi.Input[builtins.float] final_loss: Fine-tuned model loss.
        :param pulumi.Input[builtins.str] model_metrics_type: The type of the model metrics. Each type of model can expect a different set of model metrics.
        """
    ...
    def final_accuracy(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Fine-tuned model accuracy.
        """
    ...
    def final_accuracy(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "final_accuracy", value)

    @property
    @pulumi.getter(name="finalLoss")
    def final_loss(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Fine-tuned model loss.
        """
    ...
    @final_loss.setter
    def final_loss(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "final_loss", value)

    @property
    @pulumi.getter(name="modelMetricsType")
    def model_metrics_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the model metrics. Each type of model can expect a different set of model metrics.
        """
    ...
    def model_metrics_type(self, value: Optional[pulumi.Input[builtins.str]]):
