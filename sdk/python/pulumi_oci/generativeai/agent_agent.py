...
class AgentAgentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to create the agent in.
...
class _AgentAgentState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] time_updated: The date and time the agent was updated, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] welcome_message: (Updatable) Details about purpose and responsibility of the agent
...
class AgentAgent(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            welcome_message: Optional[pulumi.Input[builtins.str]] = None) -> 'AgentAgent':
        """
