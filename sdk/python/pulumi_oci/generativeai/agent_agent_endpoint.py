...
class AgentAgentEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AgentAgentEndpointProvisionedCapacityConfigArgs'] provisioned_capacity_config: (Updatable) The configuration includes the provisioned capacity id and component runtime (tool versions, and other relevant information).
        ...
        if provisioned_capacity_config is not None:
            pulumi.set(__self__, "provisioned_capacity_config", provisioned_capacity_config)
...
class AgentAgentEndpoint(pulumi.CustomResource):
        ...
        test_agent_endpoint = oci.generativeai.AgentAgentEndpoint("test_agent_endpoint",
            ...
            provisioned_capacity_config={
                ...
                "platform_runtime_config": {
                    "platform_runtime_config_type": agent_endpoint_provisioned_capacity_config_platform_runtime_config_platform_runtime_config_type,
                    "version": agent_endpoint_provisioned_capacity_config_platform_runtime_config_version,
                },
                "tool_runtime_configs": [{
                    "tool_runtime_config_type": agent_endpoint_provisioned_capacity_config_tool_runtime_configs_tool_runtime_config_type,
                    "version": agent_endpoint_provisioned_capacity_config_tool_runtime_configs_version,
                }],
            },
            session_config={
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["provisioned_capacity_config"] = provisioned_capacity_config
    ...
    @_builtins.property
    @pulumi.getter(name="provisionedCapacityConfig")
    def provisioned_capacity_config(self) -> pulumi.Output['outputs.AgentAgentEndpointProvisionedCapacityConfig']:
        """
        (Updatable) The configuration includes the provisioned capacity id and component runtime (tool versions, and other relevant information).
        """
        return pulumi.get(self, "provisioned_capacity_config")
