...
class _AgentDataIngestionJobState:
    def __init__(__self__, *,
                 ...
                 data_ingestion_job_statistics: pulumi.Input[Optional[Sequence[pulumi.Input['AgentDataIngestionJobDataIngestionJobStatisticArgs']]]] = None,
                 data_ingestion_job_types: pulumi.Input[Optional[Sequence[pulumi.Input['AgentDataIngestionJobDataIngestionJobTypeArgs']]]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}` 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] lifecycle_details: A message that describes the current state of the data ingestion job in more detail. For example, can be used to provide actionable information for a resource in the Failed state.
        :param pulumi.Input[_builtins.str] state: The current state of the data ingestion job.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param pulumi.Input[_builtins.str] time_created: The date and time the data ingestion job was created, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[_builtins.str] time_updated: The date and time the data ingestion job was updated, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        """
    ...
    def data_ingestion_job_statistics(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AgentDataIngestionJobDataIngestionJobStatisticArgs']]]]:
        """
    ...
    def data_ingestion_job_statistics(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AgentDataIngestionJobDataIngestionJobStatisticArgs']]]]):
        pulumi.set(self, "data_ingestion_job_statistics", value)

    @_builtins.property
    @pulumi.getter(name="dataIngestionJobTypes")
    def data_ingestion_job_types(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AgentDataIngestionJobDataIngestionJobTypeArgs']]]]:
        """
    ...
    def data_ingestion_job_types(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AgentDataIngestionJobDataIngestionJobTypeArgs']]]]):
...
class AgentDataIngestionJob(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None) -> 'AgentDataIngestionJob':
        """
