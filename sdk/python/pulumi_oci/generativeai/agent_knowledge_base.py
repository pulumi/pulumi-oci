...
class _AgentKnowledgeBaseState:
    def __init__(__self__, *,
                 ...
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 index_config: pulumi.Input[Optional['AgentKnowledgeBaseIndexConfigArgs']] = None,
                 knowledge_base_statistics: pulumi.Input[Optional[Sequence[pulumi.Input['AgentKnowledgeBaseKnowledgeBaseStatisticArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] time_created: The date and time the knowledge base was created, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[_builtins.str] time_updated: The date and time the knowledge base was updated, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        """
    ...
    @_builtins.property
    @pulumi.getter(name="indexConfig")
    def index_config(self) -> pulumi.Input[Optional['AgentKnowledgeBaseIndexConfigArgs']]:
        """
        (Updatable) The index configuration of Knowledge bases.
        """
        return pulumi.get(self, "index_config")
    ...
    @index_config.setter
    def index_config(self, value: pulumi.Input[Optional['AgentKnowledgeBaseIndexConfigArgs']]):
        pulumi.set(self, "index_config", value)

    @_builtins.property
    @pulumi.getter(name="knowledgeBaseStatistics")
    def knowledge_base_statistics(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['AgentKnowledgeBaseKnowledgeBaseStatisticArgs']]]]:
        """
    ...
    def knowledge_base_statistics(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['AgentKnowledgeBaseKnowledgeBaseStatisticArgs']]]]):
...
class AgentKnowledgeBase(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 index_config: pulumi.Input[Optional[Union['AgentKnowledgeBaseIndexConfigArgs', 'AgentKnowledgeBaseIndexConfigArgsDict', 'outputs.AgentKnowledgeBaseIndexConfig']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[Union['AgentKnowledgeBaseIndexConfigArgs', 'AgentKnowledgeBaseIndexConfigArgsDict', 'outputs.AgentKnowledgeBaseIndexConfig']] index_config: (Updatable) The index configuration of Knowledge bases.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            index_config: pulumi.Input[Optional[Union['AgentKnowledgeBaseIndexConfigArgs', 'AgentKnowledgeBaseIndexConfigArgsDict', 'outputs.AgentKnowledgeBaseIndexConfig']]] = None,
            knowledge_base_statistics: pulumi.Input[Optional[Sequence[pulumi.Input[Union['AgentKnowledgeBaseKnowledgeBaseStatisticArgs', 'AgentKnowledgeBaseKnowledgeBaseStatisticArgsDict', 'outputs.AgentKnowledgeBaseKnowledgeBaseStatistic']]]]] = None,
            lifecycle_details: pulumi.Input[Optional[_builtins.str]] = None,
            state: pulumi.Input[Optional[_builtins.str]] = None,
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None) -> 'AgentKnowledgeBase':
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[Union['AgentKnowledgeBaseIndexConfigArgs', 'AgentKnowledgeBaseIndexConfigArgsDict', 'outputs.AgentKnowledgeBaseIndexConfig']] index_config: (Updatable) The index configuration of Knowledge bases.
        :param pulumi.Input[Sequence[pulumi.Input[Union['AgentKnowledgeBaseKnowledgeBaseStatisticArgs', 'AgentKnowledgeBaseKnowledgeBaseStatisticArgsDict', 'outputs.AgentKnowledgeBaseKnowledgeBaseStatistic']]]] knowledge_base_statistics: Statistics for Default Knowledge Base.
        :param pulumi.Input[_builtins.str] lifecycle_details: A message that describes the current state of the knowledge base in more detail. For example, can be used to provide actionable information for a resource in the Failed state.
        :param pulumi.Input[_builtins.str] state: The current state of the knowledge base.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param pulumi.Input[_builtins.str] time_created: The date and time the knowledge base was created, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
