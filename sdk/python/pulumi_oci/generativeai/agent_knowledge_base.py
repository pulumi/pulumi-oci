...
class AgentKnowledgeBaseArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to create the knowledge base in.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) A user-friendly description of the knowledge base.
...
class _AgentKnowledgeBaseState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AgentKnowledgeBaseIndexConfigArgs'] index_config: (Updatable) **IndexConfig**
               ...
               The index configuration of Knowledge bases.
        :param pulumi.Input[builtins.str] lifecycle_details: A message that describes the current state of the knowledge base in more detail. For example, can be used to provide actionable information for a resource in the Failed state.
        :param pulumi.Input[builtins.str] state: The current state of the knowledge base.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the knowledge base was created, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_updated: The date and time the knowledge base was updated, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        """
...
class AgentKnowledgeBase(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'AgentKnowledgeBase':
        """
