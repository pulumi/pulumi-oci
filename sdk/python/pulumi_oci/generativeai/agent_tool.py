...
class _AgentToolState:
    def __init__(__self__, *,
                 ...
                 tool_config: pulumi.Input[Optional['AgentToolToolConfigArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="toolConfig")
    def tool_config(self) -> pulumi.Input[Optional['AgentToolToolConfigArgs']]:
        """
        (Updatable) The configuration and type of Tool.
        """
        return pulumi.get(self, "tool_config")
    ...
    @tool_config.setter
    def tool_config(self, value: pulumi.Input[Optional['AgentToolToolConfigArgs']]):
        pulumi.set(self, "tool_config", value)
