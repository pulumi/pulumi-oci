...
class DedicatedAiClusterArgs:
    def __init__(__self__, *,
                 ...
                 unit_count: pulumi.Input[builtins.int],
                 unit_shape: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The compartment OCID to create the dedicated AI cluster in.
        :param pulumi.Input[builtins.str] type: The dedicated AI cluster type indicating whether this is a fine-tuning/training processor or hosting/inference processor.
               
               Allowed values are:
               * HOSTING
               * FINE_TUNING
        :param pulumi.Input[builtins.int] unit_count: (Updatable) The number of dedicated units in this AI cluster.
        :param pulumi.Input[builtins.str] unit_shape: The shape of dedicated unit in this AI cluster. The underlying hardware configuration is hidden from customers.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) An optional description of the dedicated AI cluster.
    ...
    def unit_count(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @unit_count.setter
    def unit_count(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "unit_count", value)

    @property
    @pulumi.getter(name="unitShape")
    def unit_shape(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @unit_shape.setter
    def unit_shape(self, value: pulumi.Input[builtins.str]):
...
class _DedicatedAiClusterState:
    def __init__(__self__, *,
                 ...
                 unit_count: Optional[pulumi.Input[builtins.int]] = None,
                 unit_shape: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] lifecycle_details: A message describing the current state with detail that can provide actionable information.
        :param pulumi.Input[builtins.str] state: The current state of the dedicated AI cluster.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the dedicated AI cluster was created, in the format defined by RFC 3339
        :param pulumi.Input[builtins.str] time_updated: The date and time the dedicated AI cluster was updated, in the format defined by RFC 3339
        :param pulumi.Input[builtins.str] type: The dedicated AI cluster type indicating whether this is a fine-tuning/training processor or hosting/inference processor.
    ...
    @property
    @pulumi.getter(name="unitCount")
    def unit_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The number of dedicated units in this AI cluster.
        """
        return pulumi.get(self, "unit_count")
    ...
    @unit_count.setter
    def unit_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "unit_count", value)

    @property
    @pulumi.getter(name="unitShape")
    def unit_shape(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The shape of dedicated unit in this AI cluster. The underlying hardware configuration is hidden from customers.
    ...
    @unit_shape.setter
    def unit_shape(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "unit_shape", value)
...
class DedicatedAiCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            type: Optional[pulumi.Input[builtins.str]] = None,
            unit_count: Optional[pulumi.Input[builtins.int]] = None,
            unit_shape: Optional[pulumi.Input[builtins.str]] = None) -> 'DedicatedAiCluster':
        """
    ...
    @property
    @pulumi.getter(name="unitCount")
    def unit_count(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The number of dedicated units in this AI cluster.
        """
        return pulumi.get(self, "unit_count")
    ...
    @property
    @pulumi.getter(name="unitShape")
    def unit_shape(self) -> pulumi.Output[builtins.str]:
        """
        The shape of dedicated unit in this AI cluster. The underlying hardware configuration is hidden from customers.
