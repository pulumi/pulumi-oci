...
__all__ = ['GenerativeAiPrivateEndpointArgs', 'GenerativeAiPrivateEndpoint']

@pulumi.input_type
class GenerativeAiPrivateEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] nsg_ids: (Updatable) A list of the OCIDs of the network security groups (NSGs) to add the private endpoint's VNIC to.
        :param pulumi.Input[_builtins.str] resource_type: The resource type that Generative AI private endpoint can be used for.
        """
...
@pulumi.input_type
class _GenerativeAiPrivateEndpointState:
    def __init__(__self__, *,
                 ...
                 nsg_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 previous_state: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] display_name: (Updatable) A user friendly name. It doesn't have to be unique. Avoid entering confidential information.
        :param pulumi.Input[_builtins.str] dns_prefix: (Updatable) dnsPrefix of the private endpoint FQDN.
        :param pulumi.Input[_builtins.str] fqdn: Fully qualified domain name the customer will use for access (for eg: xyz.oraclecloud.com)
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[_builtins.str] lifecycle_details: The detailed messages about the lifecycle state
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] nsg_ids: (Updatable) A list of the OCIDs of the network security groups (NSGs) to add the private endpoint's VNIC to.
        :param pulumi.Input[_builtins.str] previous_state: Generative AI private endpoint.
        :param pulumi.Input[_builtins.str] private_endpoint_ip: The private IP address (in the customer's VCN) that represents the access point for the associated endpoint service.
        :param pulumi.Input[_builtins.str] resource_type: The resource type that Generative AI private endpoint can be used for.
        :param pulumi.Input[_builtins.str] state: The current state of the Generative AI Private Endpoint.
        :param pulumi.Input[_builtins.str] subnet_id: The OCID of the customer's subnet where the private endpoint VNIC will reside.
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param pulumi.Input[_builtins.str] time_created: The date and time that the Generative AI private endpoint was created expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2018-04-03T21:10:29.600Z`
        :param pulumi.Input[_builtins.str] time_updated: The date and time that the Generative AI private endpoint was updated expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2018-04-03T21:10:29.600Z`
        """
    ...
    def previous_state(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def previous_state(self, value: pulumi.Input[Optional[_builtins.str]]):
...
@pulumi.type_token("oci:GenerativeAi/generativeAiPrivateEndpoint:GenerativeAiPrivateEndpoint")
class GenerativeAiPrivateEndpoint(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(GenerativeAiPrivateEndpointArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = GenerativeAiPrivateEndpointArgs.__new__(GenerativeAiPrivateEndpointArgs)
        ...
        super(GenerativeAiPrivateEndpoint, __self__).__init__(
            'oci:GenerativeAi/generativeAiPrivateEndpoint:GenerativeAiPrivateEndpoint',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None) -> 'GenerativeAiPrivateEndpoint':
        """
        ...
        __props__ = _GenerativeAiPrivateEndpointState.__new__(_GenerativeAiPrivateEndpointState)
        ...
        return GenerativeAiPrivateEndpoint(resource_name, opts=opts, __props__=__props__)
