...
class GetAgentAgentEndpointResult:
    ...
    def agent_endpoint_id(self) -> builtins.str:
...
def get_agent_agent_endpoint(agent_endpoint_id: Optional[builtins.str] = None,
    ...
    **GetAgentEndpoint**
    ...
    :param builtins.str agent_endpoint_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the endpoint.
    """
    __args__ = dict()
...
def get_agent_agent_endpoint_output(agent_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
