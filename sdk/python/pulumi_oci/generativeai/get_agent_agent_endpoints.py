...
def get_agent_agent_endpoints(agent_id: Optional[builtins.str] = None,
...
def get_agent_agent_endpoints_output(agent_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
