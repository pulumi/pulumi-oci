...
def get_agent_agents(compartment_id: Optional[builtins.str] = None,
...
def get_agent_agents_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
