...
class GetAgentDataIngestionJobLogContentResult:
    ...
    def data_ingestion_job_id(self) -> builtins.str:
...
def get_agent_data_ingestion_job_log_content(data_ingestion_job_id: Optional[builtins.str] = None,
    ...
    **GetDataIngestionJobLogContent**
    ...
    :param builtins.str data_ingestion_job_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the data ingestion job.
    """
    __args__ = dict()
...
def get_agent_data_ingestion_job_log_content_output(data_ingestion_job_id: Optional[pulumi.Input[builtins.str]] = None,
