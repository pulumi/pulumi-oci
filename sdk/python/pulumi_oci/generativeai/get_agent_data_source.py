...
def get_agent_data_source(data_source_id: Optional[builtins.str] = None,
...
def get_agent_data_source_output(data_source_id: Optional[pulumi.Input[builtins.str]] = None,
