...
def get_agent_data_source(data_source_id: Optional[_builtins.str] = None,
...
def get_agent_data_source_output(data_source_id: Optional[pulumi.Input[_builtins.str]] = None,
