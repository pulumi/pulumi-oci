...
def get_agent_knowledge_base(knowledge_base_id: Optional[builtins.str] = None,
...
def get_agent_knowledge_base_output(knowledge_base_id: Optional[pulumi.Input[builtins.str]] = None,
