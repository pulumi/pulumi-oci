...
def get_agent_knowledge_bases(compartment_id: Optional[builtins.str] = None,
...
def get_agent_knowledge_bases_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
