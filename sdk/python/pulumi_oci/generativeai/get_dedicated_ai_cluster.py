...
def get_dedicated_ai_cluster(dedicated_ai_cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str dedicated_ai_cluster_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the dedicated AI cluster.
    """
    __args__ = dict()
...
def get_dedicated_ai_cluster_output(dedicated_ai_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
