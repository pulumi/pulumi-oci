...
def get_dedicated_ai_clusters(compartment_id: Optional[builtins.str] = None,
...
def get_dedicated_ai_clusters_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
