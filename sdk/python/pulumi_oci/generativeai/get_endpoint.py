...
def get_endpoint(endpoint_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str endpoint_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the endpoint.
    """
    __args__ = dict()
...
def get_endpoint_output(endpoint_id: Optional[pulumi.Input[_builtins.str]] = None,
