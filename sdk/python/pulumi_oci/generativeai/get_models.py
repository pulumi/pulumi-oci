...
def get_models(capabilities: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] capabilities: A filter to return only resources their capability matches the given capability.
...
def get_models_output(capabilities: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                      ...
                      vendor: Optional[pulumi.Input[Optional[builtins.str]]] = None,
