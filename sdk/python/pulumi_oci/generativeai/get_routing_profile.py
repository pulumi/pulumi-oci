...
class GetRoutingProfileResult:
    ...
    """
    def __init__(__self__, compartment_id=None, defined_tags=None, description=None, display_name=None, freeform_tags=None, id=None, lifecycle_details=None, model_routing_policies=None, previous_states=None, region_routing_policies=None, routing_profile_id=None, state=None, system_tags=None, time_created=None, time_updated=None):
        ...
        if model_routing_policies and not isinstance(model_routing_policies, list):
            raise TypeError("Expected argument 'model_routing_policies' to be a list")
        pulumi.set(__self__, "model_routing_policies", model_routing_policies)
        if previous_states and not isinstance(previous_states, list):
            raise TypeError("Expected argument 'previous_states' to be a list")
        pulumi.set(__self__, "previous_states", previous_states)
        if region_routing_policies and not isinstance(region_routing_policies, list):
            raise TypeError("Expected argument 'region_routing_policies' to be a list")
    ...
    def model_routing_policies(self) -> Sequence['outputs.GetRoutingProfileModelRoutingPolicyResult']:
        """
    ...
    def previous_states(self) -> Sequence['outputs.GetRoutingProfilePreviousStateResult']:
        """
    ...
    def region_routing_policies(self) -> Sequence['outputs.GetRoutingProfileRegionRoutingPolicyResult']:
        """
...
class AwaitableGetRoutingProfileResult(GetRoutingProfileResult):
    ...
    def __await__(self):
        ...
        return GetRoutingProfileResult(
            ...
            model_routing_policies=self.model_routing_policies,
            previous_states=self.previous_states,
            region_routing_policies=self.region_routing_policies,
...
def get_routing_profile(routing_profile_id: Optional[_builtins.str] = None,
    ...
    test_routing_profile = oci.generativeai.get_routing_profile(routing_profile_id=test_routing_profile_oci_generative_ai_routing_profile["id"])
    ```


    :param _builtins.str routing_profile_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the routing profile.
    """
    __args__ = dict()
    __args__['routingProfileId'] = routing_profile_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:GenerativeAi/getRoutingProfile:getRoutingProfile', __args__, opts=opts, typ=GetRoutingProfileResult).value
    ...
    return AwaitableGetRoutingProfileResult(
        ...
        model_routing_policies=pulumi.get(__ret__, 'model_routing_policies'),
        previous_states=pulumi.get(__ret__, 'previous_states'),
        region_routing_policies=pulumi.get(__ret__, 'region_routing_policies'),
        routing_profile_id=pulumi.get(__ret__, 'routing_profile_id'),
        state=pulumi.get(__ret__, 'state'),
        system_tags=pulumi.get(__ret__, 'system_tags'),
        time_created=pulumi.get(__ret__, 'time_created'),
        time_updated=pulumi.get(__ret__, 'time_updated'))
def get_routing_profile_output(routing_profile_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:GenerativeAi/getRoutingProfile:getRoutingProfile', __args__, opts=opts, typ=GetRoutingProfileResult)
    return __ret__.apply(lambda __response__: GetRoutingProfileResult(
        ...
        model_routing_policies=pulumi.get(__response__, 'model_routing_policies'),
        previous_states=pulumi.get(__response__, 'previous_states'),
        region_routing_policies=pulumi.get(__response__, 'region_routing_policies'),
