...
class ArtifactByPathArgs:
    def __init__(__self__, *,
                 artifact_path: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] artifact_path: A user-defined path to describe the location of an artifact. You can use slashes to organize the repository, but slashes do not create a directory structure. An artifact path does not include an artifact version.
        :param pulumi.Input[builtins.str] repository_id: The [OCID](https://www.terraform.io/iaas/Content/General/Concepts/identifiers.htm) of the repository.
        ...
        :param pulumi.Input[builtins.str] content: Content to be uploaded as the artifact. Cannot be defined if `source` is defined.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] source: A path to a file on the local system to be uploaded as the artifact. Cannot be defined if `content` is defined.
        """
    ...
    def artifact_path(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def artifact_path(self, value: pulumi.Input[builtins.str]):
...
class ArtifactByPath(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'ArtifactByPath':
        """
