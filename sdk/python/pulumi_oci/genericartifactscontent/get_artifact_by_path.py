...
def get_artifact_by_path(artifact_path: Optional[_builtins.str] = None,
    ...
    :param _builtins.str artifact_path: The generic artifact path.  Example: `foo/bar/baz`
    :param _builtins.str repository_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the repository.  Example: `ocid1.repository.oc1..exampleuniqueID`
    :param _builtins.str version: The generic artifact version.  Example: `1.1.2`
    """
    __args__ = dict()
...
def get_artifact_by_path_output(artifact_path: Optional[pulumi.Input[_builtins.str]] = None,
