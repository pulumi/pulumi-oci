...
def get_generic_artifacts_content(artifact_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str artifact_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the artifact.  Example: `ocid1.genericartifact.oc1..exampleuniqueID`
    """
    __args__ = dict()
...
def get_generic_artifacts_content_output(artifact_id: Optional[pulumi.Input[_builtins.str]] = None,
