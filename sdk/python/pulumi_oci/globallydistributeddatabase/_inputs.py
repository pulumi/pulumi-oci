...
if not MYPY:
    class ShardedDatabaseCatalogDetailArgsDict(TypedDict):
        ...
        """
        container_database_parent_id: NotRequired[pulumi.Input[_builtins.str]]
        """
        ...
        Name of the shard.
        """
        peer_cloud_autonomous_vm_cluster_id: NotRequired[pulumi.Input[_builtins.str]]
        """
...
class ShardedDatabaseCatalogDetailArgs:
    def __init__(__self__, *,
                 ...
                 container_database_parent_id: Optional[pulumi.Input[_builtins.str]] = None,
        ...
        """
        :param pulumi.Input[_builtins.str] admin_password: Admin password for the catalog database.
        ...
        :param pulumi.Input[_builtins.float] compute_count: The compute count for the catalog database. It has to be in multiple of 2.
        ...
        :param pulumi.Input[_builtins.str] container_database_id: Identifier of the underlying container database.
        :param pulumi.Input[_builtins.str] container_database_parent_id: Identifier of the underlying container database parent.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] metadata: Additional metadata related to shard's underlying supporting resource.
        ...
        :param pulumi.Input[_builtins.str] shard_group: Name of the shard-group to which the shard belongs.
        :param pulumi.Input[_builtins.str] status: Status of shard or catalog or gsm for the sharded database.
        :param pulumi.Input[_builtins.str] supporting_resource_id: Identifier of the underlying supporting resource.
        ...
        :param pulumi.Input[_builtins.str] time_ssl_certificate_expires: The time the ssl certificate associated with shard expires. An RFC3339 formatted datetime string
    ...
    def container_database_parent_id(self) -> Optional[pulumi.Input[_builtins.str]]:
        """
        Identifier of the underlying container database parent.
        """
    ...
    def container_database_parent_id(self, value: Optional[pulumi.Input[_builtins.str]]):
...
class ShardedDatabaseCatalogDetailEncryptionKeyDetailsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[_builtins.str] kms_key_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the KMS key in vault identified by vaultId in customer tenancy  that is used as the master encryption key.
        :param pulumi.Input[_builtins.str] vault_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the vault in customer tenancy where KMS key is present. For shard or catalog with cross-region data guard enabled, user needs to make sure to provide virtual private vault only, which is also replicated in the region of standby shard.
        :param pulumi.Input[_builtins.str] kms_key_version_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the KMS key version for key identified by kmsKeyId that is used in data encryption (TDE) operations.
        """
...
class ShardedDatabaseGsmArgs:
    def __init__(__self__, *,
                 ...
                 time_updated: Optional[pulumi.Input[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.float] compute_count: The compute amount available to the underlying autonomous database associated with shard.
        :param pulumi.Input[_builtins.float] data_storage_size_in_gbs: The data disk group size to be allocated in GBs.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] metadata: Additional metadata related to shard's underlying supporting resource.
        :param pulumi.Input[_builtins.str] name: Name of the shard.
        :param pulumi.Input[_builtins.str] status: Status of shard or catalog or gsm for the sharded database.
        :param pulumi.Input[_builtins.str] supporting_resource_id: Identifier of the underlying supporting resource.
