...
def get_sharded_databases(compartment_id: Optional[builtins.str] = None,
...
def get_sharded_databases_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
