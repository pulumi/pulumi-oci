...
class PrivateEndpointArgs:
    def __init__(__self__, *,
                 ...
                 reinstate_proxy_instance_trigger: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a PrivateEndpoint resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) Identifier of the compartment where private endpoint is to be created.
        :param pulumi.Input[builtins.str] display_name: (Updatable) Private endpoint display name.
        :param pulumi.Input[builtins.str] subnet_id: Identifier of the customer subnet against which private endpoint is to be created.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) PrivateEndpoint description.
        ...
        :param pulumi.Input[builtins.int] reinstate_proxy_instance_trigger: (Updatable) An optional property when incremented triggers Reinstate Proxy Instance. Could be set to any integer value.
    ...
    def reinstate_proxy_instance_trigger(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def reinstate_proxy_instance_trigger(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _PrivateEndpointState:
    def __init__(__self__, *,
                 ...
                 proxy_compute_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 reinstate_proxy_instance_trigger: Optional[pulumi.Input[builtins.int]] = None,
                 sharded_databases: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] nsg_ids: (Updatable) The OCIDs of the network security groups that the private endpoint belongs to.
        :param pulumi.Input[builtins.str] private_ip: IP address of the Private Endpoint.
        :param pulumi.Input[builtins.str] proxy_compute_instance_id: The identifier of the proxy compute instance.
        :param pulumi.Input[builtins.int] reinstate_proxy_instance_trigger: (Updatable) An optional property when incremented triggers Reinstate Proxy Instance. Could be set to any integer value.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] sharded_databases: The OCIDs of sharded databases that consumes the given private endpoint.
        :param pulumi.Input[builtins.str] state: Lifecycle states for private endpoint.
        :param pulumi.Input[builtins.str] subnet_id: Identifier of the customer subnet against which private endpoint is to be created.
        ...
        :param pulumi.Input[builtins.str] time_created: The time the PrivateEndpoint was first created. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.str] time_updated: The time the Private Endpoint was last updated. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.str] vcn_id: Identifier of the VCN in which subnet exists.
        """
    ...
    def proxy_compute_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def proxy_compute_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sharded_databases(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def sharded_databases(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
@pulumi.type_token("oci:GloballyDistributedDatabase/privateEndpoint:PrivateEndpoint")
class PrivateEndpoint(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="proxyComputeInstanceId")
    def proxy_compute_instance_id(self) -> pulumi.Output[builtins.str]:
        """
        The identifier of the proxy compute instance.
        """
        return pulumi.get(self, "proxy_compute_instance_id")
    ...
    @property
    @pulumi.getter(name="reinstateProxyInstanceTrigger")
    def reinstate_proxy_instance_trigger(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        (Updatable) An optional property when incremented triggers Reinstate Proxy Instance. Could be set to any integer value.
    ...
    @property
    @pulumi.getter(name="shardedDatabases")
    def sharded_databases(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The OCIDs of sharded databases that consumes the given private endpoint.
        """
        return pulumi.get(self, "sharded_databases")
