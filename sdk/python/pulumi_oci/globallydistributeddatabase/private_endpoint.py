...
class PrivateEndpointArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] description: (Updatable) PrivateEndpoint description.
...
class _PrivateEndpointState:
    def __init__(__self__, *,
                 ...
                 reinstate_proxy_instance_trigger: Optional[pulumi.Input[_builtins.int]] = None,
                 sharded_databases: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[_builtins.int] reinstate_proxy_instance_trigger: (Updatable) An optional property when incremented triggers Reinstate Proxy Instance. Could be set to any integer value.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] sharded_databases: The OCIDs of sharded databases that consumes the given private endpoint.
        :param pulumi.Input[_builtins.str] state: Lifecycle states for private endpoint.
        :param pulumi.Input[_builtins.str] subnet_id: Identifier of the customer subnet against which private endpoint is to be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param pulumi.Input[_builtins.str] time_created: The time the PrivateEndpoint was first created. An RFC3339 formatted datetime string
    ...
    def sharded_databases(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def sharded_databases(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
...
class PrivateEndpoint(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_private_endpoint = oci.globallydistributeddatabase.PrivateEndpoint("test_private_endpoint",
    ...
    @_builtins.property
    @pulumi.getter(name="shardedDatabases")
    def sharded_databases(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        The OCIDs of sharded databases that consumes the given private endpoint.
        """
        return pulumi.get(self, "sharded_databases")
