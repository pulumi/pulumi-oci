...
class ConnectionBootstrapServerArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] host: (Updatable) The name or address of a host.
...
if not MYPY:
    class DeploymentBackupScheduleArgsDict(TypedDict):
        ...
        """
        time_backup_scheduled: pulumi.Input[builtins.str]
        """
...
class DeploymentBackupScheduleArgs:
    def __init__(__self__, *,
                 ...
                 time_backup_scheduled: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] bucket: (Updatable) Name of the bucket where the object is to be uploaded in the object storage
        ...
        :param pulumi.Input[builtins.str] frequency_backup_scheduled: (Updatable) The frequency of the deployment backup schedule. Frequency can be DAILY, WEEKLY or MONTHLY.
        :param pulumi.Input[builtins.bool] is_metadata_only: (Updatable) Parameter to allow users to create backup without trails
        :param pulumi.Input[builtins.str] namespace: (Updatable) Name of namespace that serves as a container for all of your buckets
        :param pulumi.Input[builtins.str] time_backup_scheduled: (Updatable) The start timestamp for the deployment backup schedule. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2024-10-25T18:19:29.600Z`.
        """
    ...
    def frequency_backup_scheduled(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The frequency of the deployment backup schedule. Frequency can be DAILY, WEEKLY or MONTHLY.
        """
    ...
    def frequency_backup_scheduled(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "frequency_backup_scheduled", value)

    @property
    @pulumi.getter(name="isMetadataOnly")
    def is_metadata_only(self) -> pulumi.Input[builtins.bool]:
        """
        (Updatable) Parameter to allow users to create backup without trails
        """
    ...
    def is_metadata_only(self, value: pulumi.Input[builtins.bool]):
    ...
    def time_backup_scheduled(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The start timestamp for the deployment backup schedule. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2024-10-25T18:19:29.600Z`.
        """
    ...
    def time_backup_scheduled(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class DeploymentDeploymentDiagnosticDataArgsDict(TypedDict):
        ...
        """
        time_diagnostic_end: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        time_diagnostic_start: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DeploymentDeploymentDiagnosticDataArgs:
    def __init__(__self__, *,
                 ...
                 time_diagnostic_end: Optional[pulumi.Input[builtins.str]] = None,
                 time_diagnostic_start: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] bucket: Name of the bucket where the object is to be uploaded in the object storage
        :param pulumi.Input[builtins.str] diagnostic_state: The state of the deployment diagnostic collection.
        ...
        :param pulumi.Input[builtins.str] time_diagnostic_end: The time until which the diagnostic collection should collect the logs. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2016-08-25T21:10:29.600Z`.
        :param pulumi.Input[builtins.str] time_diagnostic_start: The time from which the diagnostic collection should collect the logs. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2016-08-25T21:10:29.600Z`.
        """
    ...
    def time_diagnostic_end(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The time until which the diagnostic collection should collect the logs. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2016-08-25T21:10:29.600Z`.
        """
    ...
    def time_diagnostic_end(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_diagnostic_end", value)

    @property
    @pulumi.getter(name="timeDiagnosticStart")
    def time_diagnostic_start(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The time from which the diagnostic collection should collect the logs. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2016-08-25T21:10:29.600Z`.
        """
    ...
    def time_diagnostic_start(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DeploymentMaintenanceConfigurationArgsDict(TypedDict):
        bundle_release_upgrade_period_in_days: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        interim_release_upgrade_period_in_days: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        is_interim_release_auto_upgrade_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        major_release_upgrade_period_in_days: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        security_patch_upgrade_period_in_days: NotRequired[pulumi.Input[builtins.int]]
        """
...
class DeploymentMaintenanceConfigurationArgs:
    def __init__(__self__, *,
                 bundle_release_upgrade_period_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 interim_release_upgrade_period_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 is_interim_release_auto_upgrade_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 major_release_upgrade_period_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 security_patch_upgrade_period_in_days: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] bundle_release_upgrade_period_in_days: (Updatable) Defines auto upgrade period for bundle releases. Manually configured period cannot be longer than service defined period for bundle releases. This period must be shorter or equal to major release upgrade period. Not passing this field during create will equate to using the service default.
        :param pulumi.Input[builtins.int] interim_release_upgrade_period_in_days: (Updatable) Defines auto upgrade period for interim releases. This period must be shorter or equal to bundle release upgrade period.
        :param pulumi.Input[builtins.bool] is_interim_release_auto_upgrade_enabled: (Updatable) By default auto upgrade for interim releases are not enabled. If auto-upgrade is enabled for interim release,  you have to specify interimReleaseUpgradePeriodInDays too.
        :param pulumi.Input[builtins.int] major_release_upgrade_period_in_days: (Updatable) Defines auto upgrade period for major releases. Manually configured period cannot be longer than service defined period for major releases. Not passing this field during create will equate to using the service default.
        :param pulumi.Input[builtins.int] security_patch_upgrade_period_in_days: (Updatable) Defines auto upgrade period for releases with security fix. Manually configured period cannot be longer than service defined period for security releases. Not passing this field during create will equate to using the service default.
        """
    ...
    def bundle_release_upgrade_period_in_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) Defines auto upgrade period for bundle releases. Manually configured period cannot be longer than service defined period for bundle releases. This period must be shorter or equal to major release upgrade period. Not passing this field during create will equate to using the service default.
        """
    ...
    def bundle_release_upgrade_period_in_days(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "bundle_release_upgrade_period_in_days", value)

    @property
    @pulumi.getter(name="interimReleaseUpgradePeriodInDays")
    def interim_release_upgrade_period_in_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) Defines auto upgrade period for interim releases. This period must be shorter or equal to bundle release upgrade period.
        """
    ...
    def interim_release_upgrade_period_in_days(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "interim_release_upgrade_period_in_days", value)

    @property
    @pulumi.getter(name="isInterimReleaseAutoUpgradeEnabled")
    def is_interim_release_auto_upgrade_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) By default auto upgrade for interim releases are not enabled. If auto-upgrade is enabled for interim release,  you have to specify interimReleaseUpgradePeriodInDays too.
        """
    ...
    def is_interim_release_auto_upgrade_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_interim_release_auto_upgrade_enabled", value)

    @property
    @pulumi.getter(name="majorReleaseUpgradePeriodInDays")
    def major_release_upgrade_period_in_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) Defines auto upgrade period for major releases. Manually configured period cannot be longer than service defined period for major releases. Not passing this field during create will equate to using the service default.
        """
    ...
    def major_release_upgrade_period_in_days(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "major_release_upgrade_period_in_days", value)

    @property
    @pulumi.getter(name="securityPatchUpgradePeriodInDays")
    def security_patch_upgrade_period_in_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) Defines auto upgrade period for releases with security fix. Manually configured period cannot be longer than service defined period for security releases. Not passing this field during create will equate to using the service default.
        """
    ...
    def security_patch_upgrade_period_in_days(self, value: Optional[pulumi.Input[builtins.int]]):
...
class DeploymentMaintenanceWindowArgs:
    def __init__(__self__, *,
                 ...
                 start_hour: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] day: (Updatable) Days of the week.
        :param pulumi.Input[builtins.int] start_hour: (Updatable) Start hour for maintenance period. Hour is in UTC.
        """
...
if not MYPY:
    class DeploymentOggDataArgsDict(TypedDict):
        ...
        """
        credential_store: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        identity_domain_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        ogg_version: NotRequired[pulumi.Input[builtins.str]]
        """
        Version of OGG
        """
...
class DeploymentOggDataArgs:
    def __init__(__self__, *,
                 ...
                 credential_store: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] deployment_name: The name given to the GoldenGate service deployment. The name must be 1 to 32 characters long, must contain only alphanumeric characters and must start with a letter.
        :param pulumi.Input[builtins.str] admin_password: (Updatable) The password associated with the GoldenGate deployment console username. The password must be 8 to 30 characters long and must contain at least 1 uppercase, 1 lowercase, 1 numeric, and 1 special character. Special characters such as ‘$’, ‘^’, or ‘?’ are not allowed. This field will be deprecated and replaced by "passwordSecretId".
        :param pulumi.Input[builtins.str] admin_username: (Updatable) The GoldenGate deployment console username.
        :param pulumi.Input[builtins.str] certificate: (Updatable) The base64 encoded content of the PEM file containing the SSL certificate.
        :param pulumi.Input[builtins.str] credential_store: (Updatable) The type of credential store for OGG.
        :param pulumi.Input['DeploymentOggDataGroupToRolesMappingArgs'] group_to_roles_mapping: (Updatable) Defines the IDP Groups to GoldenGate roles mapping. This field is used only for IAM deployment and does not have any impact on non-IAM deployments. For IAM deployment, when user does not specify this mapping, then it has null value and default mapping is used. User belonging to each group can only perform the actions according to the role the respective group is mapped to.
        :param pulumi.Input[builtins.str] identity_domain_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Identity Domain when IAM credential store is used.
        :param pulumi.Input[builtins.str] key: (Updatable) The base64 encoded content of the PEM file containing the private key.
        :param pulumi.Input[builtins.str] ogg_version: Version of OGG
        :param pulumi.Input[builtins.str] password_secret_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Secret where the deployment password is stored.
        """
    ...
    def credential_store(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The type of credential store for OGG.
        """
    ...
    def credential_store(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class DeploymentOggDataGroupToRolesMappingArgsDict(TypedDict):
        ...
        """
        administrator_group_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        operator_group_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class DeploymentOggDataGroupToRolesMappingArgs:
    def __init__(__self__, *,
                 security_group_id: pulumi.Input[builtins.str],
                 administrator_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 operator_group_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] administrator_group_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the IDP group which will be mapped to goldengate role administratorGroup. It grants full access to the user, including the ability to alter general, non-security related operational parameters and profiles of the server.
        :param pulumi.Input[builtins.str] operator_group_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the IDP group which will be mapped to goldengate role operatorGroup. It allows users to perform only operational actions, like starting and stopping resources. Operators cannot alter the operational parameters or profiles of the MA server.
        :param pulumi.Input[builtins.str] user_group_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the IDP group which will be mapped to goldengate role userGroup. It allows information-only service requests, which do not alter or affect the operation of either the MA. Examples of query and read-only information include performance metric information and resource status and monitoring information
        """
    ...
    def administrator_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the IDP group which will be mapped to goldengate role administratorGroup. It grants full access to the user, including the ability to alter general, non-security related operational parameters and profiles of the server.
        """
    ...
    def administrator_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "administrator_group_id", value)

    @property
    @pulumi.getter(name="operatorGroupId")
    def operator_group_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the IDP group which will be mapped to goldengate role operatorGroup. It allows users to perform only operational actions, like starting and stopping resources. Operators cannot alter the operational parameters or profiles of the MA server.
        """
    ...
    def operator_group_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class PipelineMappingRuleArgsDict(TypedDict):
        mapping_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PipelineMappingRuleArgs:
    def __init__(__self__, *,
                 mapping_type: Optional[pulumi.Input[builtins.str]] = None,
                 source: Optional[pulumi.Input[builtins.str]] = None,
                 target: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] mapping_type: Defines the exclude/include rules of source and target schemas and tables when replicating from source to target. This option applies when creating and updating a pipeline.
        :param pulumi.Input[builtins.str] source: The source schema/table combination for replication to target.
        :param pulumi.Input[builtins.str] target: The target schema/table combination for replication from the source.
        """
    ...
    def mapping_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Defines the exclude/include rules of source and target schemas and tables when replicating from source to target. This option applies when creating and updating a pipeline.
        """
    ...
    @mapping_type.setter
    def mapping_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PipelineProcessOptionsArgs:
    ...
    def should_restart_on_failure(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) If ENABLED, then the replication process restarts itself upon failure. This option applies when creating or updating a pipeline.
        """
...
class PipelineProcessOptionsInitialDataLoadArgs:
    def __init__(__self__, *,
                 is_initial_load: pulumi.Input[builtins.str],
                 action_on_existing_table: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] is_initial_load: (Updatable) If ENABLED, then existing source data is also synchronized to the target when creating or updating the pipeline.
        :param pulumi.Input[builtins.str] action_on_existing_table: (Updatable) Action upon existing tables in target when initial Data Load is set i.e., isInitialLoad=true.
        """
    ...
    def is_initial_load(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) If ENABLED, then existing source data is also synchronized to the target when creating or updating the pipeline.
        """
    ...
    def is_initial_load(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "is_initial_load", value)

    @property
    @pulumi.getter(name="actionOnExistingTable")
    def action_on_existing_table(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Action upon existing tables in target when initial Data Load is set i.e., isInitialLoad=true.
        """
    ...
    def action_on_existing_table(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "action_on_existing_table", value)


if not MYPY:
    class PipelineProcessOptionsReplicateSchemaChangeArgsDict(TypedDict):
        can_replicate_schema_change: pulumi.Input[builtins.str]
        """
        ...
        """
        action_on_ddl_error: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        action_on_dml_error: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PipelineProcessOptionsReplicateSchemaChangeArgs:
    def __init__(__self__, *,
                 can_replicate_schema_change: pulumi.Input[builtins.str],
                 action_on_ddl_error: Optional[pulumi.Input[builtins.str]] = None,
                 action_on_dml_error: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] can_replicate_schema_change: (Updatable) If ENABLED, then addition or removal of schema is also replicated, apart from individual tables and records when creating or updating the pipeline.
        :param pulumi.Input[builtins.str] action_on_ddl_error: (Updatable) Action upon DDL Error (active only if 'Replicate schema changes (DDL)' is selected) i.e canReplicateSchemaChange=true
        :param pulumi.Input[builtins.str] action_on_dml_error: (Updatable) Action upon DML Error (active only if 'Replicate schema changes (DDL)' is selected) i.e canReplicateSchemaChange=true
        """
    ...
    def can_replicate_schema_change(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) If ENABLED, then addition or removal of schema is also replicated, apart from individual tables and records when creating or updating the pipeline.
        """
    ...
    def can_replicate_schema_change(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "can_replicate_schema_change", value)

    @property
    @pulumi.getter(name="actionOnDdlError")
    def action_on_ddl_error(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Action upon DDL Error (active only if 'Replicate schema changes (DDL)' is selected) i.e canReplicateSchemaChange=true
        """
    ...
    def action_on_ddl_error(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "action_on_ddl_error", value)

    @property
    @pulumi.getter(name="actionOnDmlError")
    def action_on_dml_error(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Action upon DML Error (active only if 'Replicate schema changes (DDL)' is selected) i.e canReplicateSchemaChange=true
        """
    ...
    def action_on_dml_error(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PipelineSourceConnectionDetailsArgs:
    def __init__(__self__, *,
                 connection_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] connection_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the connection being referenced.
        """
