...
class DeploymentArgs:
    ...
    def deployment_backup_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def load_balancer_subnet_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DeploymentState:
    def __init__(__self__, *,
                 ...
                 is_auto_scaling_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_healthy: Optional[pulumi.Input[builtins.bool]] = None,
                 is_latest_version: Optional[pulumi.Input[builtins.bool]] = None,
                 is_lock_override: Optional[pulumi.Input[builtins.bool]] = None,
                 is_public: Optional[pulumi.Input[builtins.bool]] = None,
                 is_storage_utilization_limit_exceeded: Optional[pulumi.Input[builtins.bool]] = None,
                 license_model: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 maintenance_configuration: Optional[pulumi.Input['DeploymentMaintenanceConfigurationArgs']] = None,
                 maintenance_window: Optional[pulumi.Input['DeploymentMaintenanceWindowArgs']] = None,
                 next_maintenance_action_type: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 time_last_backup_scheduled: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] lifecycle_sub_state: Possible GGS lifecycle sub-states.
        :param pulumi.Input[builtins.str] load_balancer_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the loadbalancer in the customer's subnet. The loadbalancer of the public deployment created in the customer subnet.
        :param pulumi.Input[builtins.str] load_balancer_subnet_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a public subnet in the customer tenancy. Can be provided only for public deployments. If provided, the loadbalancer will be created in this subnet instead of the service tenancy. For backward compatibility, this is an optional property. It will become mandatory for public deployments after October 1, 2024.
        :param pulumi.Input[Sequence[pulumi.Input['DeploymentLockArgs']]] locks: Locks associated with this resource.
        :param pulumi.Input['DeploymentMaintenanceConfigurationArgs'] maintenance_configuration: (Updatable) Defines the maintenance configuration for create operation.
        :param pulumi.Input['DeploymentMaintenanceWindowArgs'] maintenance_window: (Updatable) Defines the maintenance window for create operation, when automatic actions can be performed.
        :param pulumi.Input[builtins.str] next_maintenance_action_type: Type of the next maintenance.
        ...
        :param pulumi.Input[builtins.str] time_last_backup_scheduled: The timestamp of last deployment backup scheduled. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2024-10-25T18:19:29.600Z`.
    ...
    def deployment_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def deployment_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_healthy(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_healthy.setter
    def is_healthy(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_healthy", value)

    @property
    @pulumi.getter(name="isLatestVersion")
    def is_latest_version(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_latest_version(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def is_storage_utilization_limit_exceeded(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Deprecated: This field is not updated and will be removed in future versions. If storage utilization exceeds the limit, the respective warning message will appear in deployment messages, which can be accessed through /messages?deploymentId=. Indicator will be true if the amount of storage being utilized exceeds the allowable storage utilization limit.  Exceeding the limit may be an indication of a misconfiguration of the deployment's GoldenGate service.
        """
    ...
    def is_storage_utilization_limit_exceeded(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def next_maintenance_action_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def next_maintenance_action_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "next_maintenance_action_type", value)

    @property
    @pulumi.getter(name="nextMaintenanceDescription")
    def next_maintenance_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def next_maintenance_description(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def storage_utilization_in_bytes(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def storage_utilization_in_bytes(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_last_backup_scheduled(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_last_backup_scheduled(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_last_backup_scheduled", value)

    @property
    @pulumi.getter(name="timeNextBackupScheduled")
    def time_next_backup_scheduled(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_next_backup_scheduled(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_next_backup_scheduled", value)

    @property
    @pulumi.getter(name="timeOfNextMaintenance")
    def time_of_next_maintenance(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_of_next_maintenance(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_of_next_maintenance", value)

    @property
    @pulumi.getter(name="timeOggVersionSupportedUntil")
    def time_ogg_version_supported_until(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_upgrade_required(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Note: Deprecated: Use timeOfNextMaintenance instead, or related upgrade records  to check, when deployment will be forced to upgrade to a newer version. Old description: The date the existing version in use will no longer be considered as usable and an upgrade will be required.  This date is typically 6 months after the version was released for use by GGS.  The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2016-08-25T21:10:29.600Z`.
        """
    ...
    def time_upgrade_required(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Deployment(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="deploymentBackupId")
    def deployment_backup_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the backup being referenced.
        """
        return pulumi.get(self, "deployment_backup_id")
    ...
    @property
    @pulumi.getter(name="deploymentUrl")
    def deployment_url(self) -> pulumi.Output[builtins.str]:
        """
        The URL of a resource.
        """
        return pulumi.get(self, "deployment_url")
    ...
    @property
    @pulumi.getter(name="isHealthy")
    def is_healthy(self) -> pulumi.Output[builtins.bool]:
        """
        True if all of the aggregate resources are working correctly.
        """
        return pulumi.get(self, "is_healthy")
    ...
    @property
    @pulumi.getter(name="isLatestVersion")
    def is_latest_version(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates if the resource is the the latest available version.
        """
        return pulumi.get(self, "is_latest_version")
    ...
    @property
    @pulumi.getter(name="isStorageUtilizationLimitExceeded")
    def is_storage_utilization_limit_exceeded(self) -> pulumi.Output[builtins.bool]:
        """
        Deprecated: This field is not updated and will be removed in future versions. If storage utilization exceeds the limit, the respective warning message will appear in deployment messages, which can be accessed through /messages?deploymentId=. Indicator will be true if the amount of storage being utilized exceeds the allowable storage utilization limit.  Exceeding the limit may be an indication of a misconfiguration of the deployment's GoldenGate service.
        """
        return pulumi.get(self, "is_storage_utilization_limit_exceeded")
    ...
    @property
    @pulumi.getter(name="loadBalancerSubnetId")
    def load_balancer_subnet_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a public subnet in the customer tenancy. Can be provided only for public deployments. If provided, the loadbalancer will be created in this subnet instead of the service tenancy. For backward compatibility, this is an optional property. It will become mandatory for public deployments after October 1, 2024.
        """
        return pulumi.get(self, "load_balancer_subnet_id")
    ...
    @property
    @pulumi.getter(name="nextMaintenanceActionType")
    def next_maintenance_action_type(self) -> pulumi.Output[builtins.str]:
        """
        Type of the next maintenance.
        """
        return pulumi.get(self, "next_maintenance_action_type")
    ...
    @property
    @pulumi.getter(name="nextMaintenanceDescription")
    def next_maintenance_description(self) -> pulumi.Output[builtins.str]:
        """
        Description of the next maintenance.
        """
        return pulumi.get(self, "next_maintenance_description")
    ...
    @property
    @pulumi.getter(name="storageUtilizationInBytes")
    def storage_utilization_in_bytes(self) -> pulumi.Output[builtins.str]:
        """
        The amount of storage being utilized (in bytes)
        """
        return pulumi.get(self, "storage_utilization_in_bytes")
    ...
    @property
    @pulumi.getter(name="timeLastBackupScheduled")
    def time_last_backup_scheduled(self) -> pulumi.Output[builtins.str]:
        """
        The timestamp of last deployment backup scheduled. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2024-10-25T18:19:29.600Z`.
        """
        return pulumi.get(self, "time_last_backup_scheduled")
    ...
    @property
    @pulumi.getter(name="timeNextBackupScheduled")
    def time_next_backup_scheduled(self) -> pulumi.Output[builtins.str]:
        """
        The timestamp of next deployment backup scheduled. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2024-10-26T20:19:29.600Z`.
        """
        return pulumi.get(self, "time_next_backup_scheduled")
    ...
    @property
    @pulumi.getter(name="timeOfNextMaintenance")
    def time_of_next_maintenance(self) -> pulumi.Output[builtins.str]:
        """
        The time of next maintenance schedule. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2016-08-25T21:10:29.600Z`.
        """
        return pulumi.get(self, "time_of_next_maintenance")
    ...
    @property
    @pulumi.getter(name="timeOggVersionSupportedUntil")
    def time_ogg_version_supported_until(self) -> pulumi.Output[builtins.str]:
        """
        The time until OGG version is supported. After this date has passed OGG version will not be available anymore. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2016-08-25T21:10:29.600Z`.
        """
        return pulumi.get(self, "time_ogg_version_supported_until")
    ...
    @property
    @pulumi.getter(name="timeUpgradeRequired")
    def time_upgrade_required(self) -> pulumi.Output[builtins.str]:
        """
        Note: Deprecated: Use timeOfNextMaintenance instead, or related upgrade records  to check, when deployment will be forced to upgrade to a newer version. Old description: The date the existing version in use will no longer be considered as usable and an upgrade will be required.  This date is typically 6 months after the version was released for use by GGS.  The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2016-08-25T21:10:29.600Z`.
        """
        return pulumi.get(self, "time_upgrade_required")
