...
class DeploymentBackupArgs:
    def __init__(__self__, *,
                 ...
                 is_metadata_only: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] deployment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the deployment being referenced.
        :param pulumi.Input[builtins.str] display_name: An object's Display Name.
        :param pulumi.Input[builtins.str] namespace: Name of namespace that serves as a container for all of your buckets
        :param pulumi.Input[builtins.str] object: Name of the object to be uploaded to object storage
        ...
        :param pulumi.Input[builtins.bool] is_metadata_only: Parameter to allow users to create backup without trails
    ...
    def is_metadata_only(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_metadata_only(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _DeploymentBackupState:
    def __init__(__self__, *,
                 backup_source_type: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_automatic: Optional[pulumi.Input[builtins.bool]] = None,
                 is_lock_override: Optional[pulumi.Input[builtins.bool]] = None,
                 is_metadata_only: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 ogg_version: Optional[pulumi.Input[builtins.str]] = None,
                 size_in_bytes: Optional[pulumi.Input[builtins.float]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 time_backup_finished: Optional[pulumi.Input[builtins.str]] = None,
                 time_created: Optional[pulumi.Input[builtins.str]] = None,
                 time_of_backup: Optional[pulumi.Input[builtins.str]] = None,
                 time_updated: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering DeploymentBackup resources.
        :param pulumi.Input[builtins.str] backup_source_type: Possible deployment backup source types.
        :param pulumi.Input[builtins.str] backup_type: Possible Deployment backup types.
        :param pulumi.Input[builtins.str] bucket: Name of the bucket where the object is to be uploaded in the object storage
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment being referenced.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Tags defined for this resource. Each key is predefined and scoped to a namespace.  Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] deployment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the deployment being referenced.
        ...
        :param pulumi.Input[builtins.str] display_name: An object's Display Name.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) A simple key-value pair that is applied without any predefined name, type, or scope. Exists for cross-compatibility only.  Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.bool] is_automatic: True if this object is automatically created
        :param pulumi.Input[builtins.bool] is_metadata_only: Parameter to allow users to create backup without trails
        ...
        :param pulumi.Input[builtins.str] object: Name of the object to be uploaded to object storage
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] ogg_version: Version of OGG
        :param pulumi.Input[builtins.float] size_in_bytes: The size of the backup stored in object storage (in bytes)
        ...
        :param pulumi.Input[builtins.str] time_backup_finished: The time of the resource backup finish. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2016-08-25T21:10:29.600Z`.
        ...
        :param pulumi.Input[builtins.str] time_of_backup: The time of the resource backup. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2016-08-25T21:10:29.600Z`.
    ...
    def backup_source_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def backup_source_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_automatic(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_automatic.setter
    def is_automatic(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def ogg_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Version of OGG
        """
    ...
    @ogg_version.setter
    def ogg_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ogg_version", value)

    @property
    @pulumi.getter(name="sizeInBytes")
    def size_in_bytes(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def size_in_bytes(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def time_backup_finished(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_backup_finished(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_of_backup(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_of_backup(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DeploymentBackup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_of_backup: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'DeploymentBackup':
        """
    ...
    @property
    @pulumi.getter(name="backupSourceType")
    def backup_source_type(self) -> pulumi.Output[builtins.str]:
        """
        Possible deployment backup source types.
        """
        return pulumi.get(self, "backup_source_type")
    ...
    @property
    @pulumi.getter(name="isAutomatic")
    def is_automatic(self) -> pulumi.Output[builtins.bool]:
        """
        True if this object is automatically created
        """
        return pulumi.get(self, "is_automatic")
    ...
    @property
    @pulumi.getter(name="isMetadataOnly")
    def is_metadata_only(self) -> pulumi.Output[builtins.bool]:
        """
        Parameter to allow users to create backup without trails
        """
        return pulumi.get(self, "is_metadata_only")
    ...
    @property
    @pulumi.getter(name="oggVersion")
    def ogg_version(self) -> pulumi.Output[builtins.str]:
        """
        Version of OGG
        """
        return pulumi.get(self, "ogg_version")
    ...
    @property
    @pulumi.getter(name="sizeInBytes")
    def size_in_bytes(self) -> pulumi.Output[builtins.float]:
        """
        The size of the backup stored in object storage (in bytes)
        """
        return pulumi.get(self, "size_in_bytes")
    ...
    @property
    @pulumi.getter(name="timeBackupFinished")
    def time_backup_finished(self) -> pulumi.Output[builtins.str]:
        """
        The time of the resource backup finish. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2016-08-25T21:10:29.600Z`.
        """
        return pulumi.get(self, "time_backup_finished")
    ...
    @property
    @pulumi.getter(name="timeOfBackup")
    def time_of_backup(self) -> pulumi.Output[builtins.str]:
        """
        The time of the resource backup. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2016-08-25T21:10:29.600Z`.
        """
        return pulumi.get(self, "time_of_backup")
