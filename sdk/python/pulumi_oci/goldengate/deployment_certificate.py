...
class DeploymentCertificateArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] certificate_content: The base64 encoded content of the PEM file containing the SSL certificate.
        :param pulumi.Input[builtins.str] deployment_id: A unique Deployment identifier.
        :param pulumi.Input[builtins.str] key: The identifier key (unique name in the scope of the deployment) of the certificate being referenced.  It must be 1 to 32 characters long, must contain only alphanumeric characters and must start with a letter. 
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.bool] is_lock_override: Whether to override locks (if any exist).
        """
...
class _DeploymentCertificateState:
    def __init__(__self__, *,
                 authority_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 certificate_content: Optional[pulumi.Input[builtins.str]] = None,
                 deployment_id: Optional[pulumi.Input[builtins.str]] = None,
                 is_ca: Optional[pulumi.Input[builtins.bool]] = None,
                 is_lock_override: Optional[pulumi.Input[builtins.bool]] = None,
                 is_self_signed: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 public_key_algorithm: Optional[pulumi.Input[builtins.str]] = None,
                 public_key_size: Optional[pulumi.Input[builtins.str]] = None,
                 serial: Optional[pulumi.Input[builtins.str]] = None,
                 sha1hash: Optional[pulumi.Input[builtins.str]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 subject: Optional[pulumi.Input[builtins.str]] = None,
                 subject_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 time_created: Optional[pulumi.Input[builtins.str]] = None,
                 time_valid_from: Optional[pulumi.Input[builtins.str]] = None,
                 time_valid_to: Optional[pulumi.Input[builtins.str]] = None,
                 version: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering DeploymentCertificate resources.
        :param pulumi.Input[builtins.str] authority_key_id: The Certificate authority key id.
        :param pulumi.Input[builtins.str] certificate_content: The base64 encoded content of the PEM file containing the SSL certificate.
        :param pulumi.Input[builtins.str] deployment_id: A unique Deployment identifier.
        :param pulumi.Input[builtins.bool] is_ca: Indicates if the certificate is ca.
        :param pulumi.Input[builtins.bool] is_lock_override: Whether to override locks (if any exist).
        :param pulumi.Input[builtins.bool] is_self_signed: Indicates if the certificate is self signed.
        ...
        :param pulumi.Input[builtins.str] key: The identifier key (unique name in the scope of the deployment) of the certificate being referenced.  It must be 1 to 32 characters long, must contain only alphanumeric characters and must start with a letter. 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] md5hash: The Certificate md5Hash.
        :param pulumi.Input[builtins.str] public_key: The Certificate public key.
        :param pulumi.Input[builtins.str] public_key_algorithm: The Certificate public key algorithm.
        :param pulumi.Input[builtins.str] public_key_size: The Certificate public key size.
        :param pulumi.Input[builtins.str] serial: The Certificate serial.
        :param pulumi.Input[builtins.str] sha1hash: The Certificate sha1 hash.
        :param pulumi.Input[builtins.str] state: Possible certificate lifecycle states.
        :param pulumi.Input[builtins.str] subject: The Certificate subject.
        :param pulumi.Input[builtins.str] subject_key_id: The Certificate subject key id.
        ...
        :param pulumi.Input[builtins.str] time_valid_from: The time the certificate is valid from. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2016-08-25T21:10:29.600Z`.
        :param pulumi.Input[builtins.str] time_valid_to: The time the certificate is valid to. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2016-08-25T21:10:29.600Z`.
        :param pulumi.Input[builtins.str] version: The Certificate version.
        """
    ...
    def authority_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def authority_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_ca(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_ca.setter
    def is_ca(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def is_self_signed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_self_signed(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter
    def md5hash(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_key_algorithm(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_key_algorithm(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "public_key_algorithm", value)

    @property
    @pulumi.getter(name="publicKeySize")
    def public_key_size(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_key_size(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter
    def sha1hash(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @sha1hash.setter
    def sha1hash(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def subject_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def subject_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_valid_from(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_valid_from(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_valid_from", value)

    @property
    @pulumi.getter(name="timeValidTo")
    def time_valid_to(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_valid_to(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("oci:GoldenGate/deploymentCertificate:DeploymentCertificate")
class DeploymentCertificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_valid_from: Optional[pulumi.Input[builtins.str]] = None,
            time_valid_to: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'DeploymentCertificate':
        """
    ...
    @property
    @pulumi.getter(name="authorityKeyId")
    def authority_key_id(self) -> pulumi.Output[builtins.str]:
        """
        The Certificate authority key id.
        """
        return pulumi.get(self, "authority_key_id")
    ...
    @property
    @pulumi.getter(name="isCa")
    def is_ca(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates if the certificate is ca.
        """
        return pulumi.get(self, "is_ca")
    ...
    @property
    @pulumi.getter(name="isSelfSigned")
    def is_self_signed(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates if the certificate is self signed.
        """
        return pulumi.get(self, "is_self_signed")
    ...
    @property
    @pulumi.getter
    def md5hash(self) -> pulumi.Output[builtins.str]:
        """
        The Certificate md5Hash.
        """
        return pulumi.get(self, "md5hash")
    ...
    @property
    @pulumi.getter(name="publicKeyAlgorithm")
    def public_key_algorithm(self) -> pulumi.Output[builtins.str]:
        """
        The Certificate public key algorithm.
        """
        return pulumi.get(self, "public_key_algorithm")
    ...
    @property
    @pulumi.getter(name="publicKeySize")
    def public_key_size(self) -> pulumi.Output[builtins.str]:
        """
        The Certificate public key size.
        """
        return pulumi.get(self, "public_key_size")
    ...
    @property
    @pulumi.getter
    def sha1hash(self) -> pulumi.Output[builtins.str]:
        """
        The Certificate sha1 hash.
        """
        return pulumi.get(self, "sha1hash")
    ...
    @property
    @pulumi.getter(name="subjectKeyId")
    def subject_key_id(self) -> pulumi.Output[builtins.str]:
        """
        The Certificate subject key id.
        """
        return pulumi.get(self, "subject_key_id")
    ...
    @property
    @pulumi.getter(name="timeValidFrom")
    def time_valid_from(self) -> pulumi.Output[builtins.str]:
        """
        The time the certificate is valid from. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2016-08-25T21:10:29.600Z`.
        """
        return pulumi.get(self, "time_valid_from")
    ...
    @property
    @pulumi.getter(name="timeValidTo")
    def time_valid_to(self) -> pulumi.Output[builtins.str]:
        """
        The time the certificate is valid to. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2016-08-25T21:10:29.600Z`.
        """
        return pulumi.get(self, "time_valid_to")
