...
class _DeploymentCertificateState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] certificate_content: The base64 encoded content of the PEM file containing the SSL certificate.
        :param pulumi.Input[_builtins.str] deployment_id: A unique Deployment identifier.
        :param pulumi.Input[_builtins.bool] is_ca: Indicates if the certificate is ca.
        :param pulumi.Input[_builtins.bool] is_lock_override: Whether to override locks (if any exist).
        ...
        :param pulumi.Input[_builtins.str] key: The identifier key (unique name in the scope of the deployment) of the certificate being referenced.  It must be 1 to 32 characters long, must contain only alphanumeric characters and must start with a letter. 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] md5hash: The Certificate md5Hash.
        :param pulumi.Input[_builtins.str] public_key: The Certificate public key.
        :param pulumi.Input[_builtins.str] public_key_algorithm: The Certificate public key algorithm.
        :param pulumi.Input[_builtins.str] public_key_size: The Certificate public key size.
        :param pulumi.Input[_builtins.str] serial: The Certificate serial.
        :param pulumi.Input[_builtins.str] sha1hash: The Certificate sha1 hash.
        :param pulumi.Input[_builtins.str] state: Possible certificate lifecycle states.
        :param pulumi.Input[_builtins.str] subject: The Certificate subject.
        :param pulumi.Input[_builtins.str] subject_key_id: The Certificate subject key id.
        ...
        :param pulumi.Input[_builtins.str] time_valid_from: The time the certificate is valid from. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2016-08-25T21:10:29.600Z`.
        :param pulumi.Input[_builtins.str] time_valid_to: The time the certificate is valid to. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2016-08-25T21:10:29.600Z`.
        :param pulumi.Input[_builtins.str] version: The Certificate version.
        """
...
class DeploymentCertificate(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="authorityKeyId")
    def authority_key_id(self) -> pulumi.Output[_builtins.str]:
        """
        The Certificate authority key id.
        """
        return pulumi.get(self, "authority_key_id")
    ...
    @_builtins.property
    @pulumi.getter(name="isCa")
    def is_ca(self) -> pulumi.Output[_builtins.bool]:
        """
        Indicates if the certificate is ca.
        """
        return pulumi.get(self, "is_ca")
    ...
    @_builtins.property
    @pulumi.getter(name="isSelfSigned")
    def is_self_signed(self) -> pulumi.Output[_builtins.bool]:
        """
        Indicates if the certificate is self signed.
        """
        return pulumi.get(self, "is_self_signed")
    ...
    @_builtins.property
    @pulumi.getter(name="publicKeyAlgorithm")
    def public_key_algorithm(self) -> pulumi.Output[_builtins.str]:
        """
        The Certificate public key algorithm.
        """
        return pulumi.get(self, "public_key_algorithm")
    ...
    @_builtins.property
    @pulumi.getter(name="publicKeySize")
    def public_key_size(self) -> pulumi.Output[_builtins.str]:
        """
        The Certificate public key size.
        """
        return pulumi.get(self, "public_key_size")
    ...
    @_builtins.property
    @pulumi.getter
    def sha1hash(self) -> pulumi.Output[_builtins.str]:
        """
        The Certificate sha1 hash.
        """
        return pulumi.get(self, "sha1hash")
    ...
    @_builtins.property
    @pulumi.getter(name="subjectKeyId")
    def subject_key_id(self) -> pulumi.Output[_builtins.str]:
        """
        The Certificate subject key id.
        """
        return pulumi.get(self, "subject_key_id")
    ...
    @_builtins.property
    @pulumi.getter(name="timeValidFrom")
    def time_valid_from(self) -> pulumi.Output[_builtins.str]:
        """
        The time the certificate is valid from. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2016-08-25T21:10:29.600Z`.
        """
        return pulumi.get(self, "time_valid_from")
    ...
    @_builtins.property
    @pulumi.getter(name="timeValidTo")
    def time_valid_to(self) -> pulumi.Output[_builtins.str]:
        """
        The time the certificate is valid to. The format is defined by [RFC3339](https://tools.ietf.org/html/rfc3339), such as `2016-08-25T21:10:29.600Z`.
        """
        return pulumi.get(self, "time_valid_to")
