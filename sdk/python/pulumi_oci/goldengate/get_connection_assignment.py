...
class GetConnectionAssignmentResult:
    ...
    def connection_assignment_id(self) -> builtins.str:
...
def get_connection_assignment(connection_assignment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str connection_assignment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Connection Assignment.
    """
    __args__ = dict()
...
def get_connection_assignment_output(connection_assignment_id: Optional[pulumi.Input[builtins.str]] = None,
