...
def get_connections(assignable_deployment_id: Optional[builtins.str] = None,
                    assignable_deployment_type: Optional[builtins.str] = None,
                    assigned_deployment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str assignable_deployment_id: Filters for compatible connections which can be, but currently not assigned to the deployment specified by its id.
    :param builtins.str assignable_deployment_type: Filters for connections which can be assigned to the latest version of the specified deployment type.
    :param builtins.str assigned_deployment_id: The OCID of the deployment which for the connection must be assigned.
...
def get_connections_output(assignable_deployment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           assignable_deployment_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           assigned_deployment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
