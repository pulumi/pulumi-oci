...
class GetDatabaseRegistrationResult:
    ...
    def database_registration_id(self) -> _builtins.str:
...
def get_database_registration(database_registration_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str database_registration_id: A unique DatabaseRegistration identifier.
    """
    __args__ = dict()
