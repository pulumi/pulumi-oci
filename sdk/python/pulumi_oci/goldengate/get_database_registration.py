...
class GetDatabaseRegistrationResult:
    ...
    def database_registration_id(self) -> builtins.str:
...
def get_database_registration(database_registration_id: Optional[builtins.str] = None,
    ...
    :param builtins.str database_registration_id: A unique DatabaseRegistration identifier.
    """
    __args__ = dict()
...
def get_database_registration_output(database_registration_id: Optional[pulumi.Input[builtins.str]] = None,
