...
def get_deployment_backup(deployment_backup_id: Optional[builtins.str] = None,
    ...
    :param builtins.str deployment_backup_id: A unique DeploymentBackup identifier.
    """
    __args__ = dict()
...
def get_deployment_backup_output(deployment_backup_id: Optional[pulumi.Input[builtins.str]] = None,
