...
def get_deployment_backup(deployment_backup_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str deployment_backup_id: A unique DeploymentBackup identifier.
    """
    __args__ = dict()
