...
def get_deployment_backups(compartment_id: Optional[builtins.str] = None,
...
def get_deployment_backups_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetDeploymentBackupsResult(
        ...
        deployment_backup_collections=pulumi.get(__response__, 'deployment_backup_collections'),
