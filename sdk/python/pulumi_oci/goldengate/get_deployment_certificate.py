...
class GetDeploymentCertificateResult:
    ...
    def certificate_key(self) -> builtins.str:
...
def get_deployment_certificate(certificate_key: Optional[builtins.str] = None,
    ...
    :param builtins.str certificate_key: A unique certificate identifier.
...
def get_deployment_certificate_output(certificate_key: Optional[pulumi.Input[builtins.str]] = None,
