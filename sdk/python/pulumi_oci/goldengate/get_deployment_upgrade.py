...
class GetDeploymentUpgradeResult:
    ...
    def deployment_upgrade_id(self) -> builtins.str:
...
def get_deployment_upgrade(deployment_upgrade_id: Optional[builtins.str] = None,
    ...
    :param builtins.str deployment_upgrade_id: A unique Deployment Upgrade identifier.
    """
    __args__ = dict()
...
def get_deployment_upgrade_output(deployment_upgrade_id: Optional[pulumi.Input[builtins.str]] = None,
