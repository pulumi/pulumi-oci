...
class GetDeploymentUpgradeResult:
    ...
    def deployment_upgrade_id(self) -> _builtins.str:
...
def get_deployment_upgrade(deployment_upgrade_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str deployment_upgrade_id: A unique Deployment Upgrade identifier.
    """
    __args__ = dict()
