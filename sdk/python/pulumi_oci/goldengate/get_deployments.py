...
class GetDeploymentsResult:
    ...
    def assignable_connection_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "assignable_connection_id")

    @property
    @pulumi.getter(name="assignedConnectionId")
    def assigned_connection_id(self) -> Optional[builtins.str]:
    ...
    def supported_connection_type(self) -> Optional[builtins.str]:
...
def get_deployments(assignable_connection_id: Optional[builtins.str] = None,
                    assigned_connection_id: Optional[builtins.str] = None,
                    ...
                    supported_connection_type: Optional[builtins.str] = None,
    ...
    :param builtins.str assignable_connection_id: Return the deployments to which the specified connectionId may be assigned.
    :param builtins.str assigned_connection_id: The OCID of the connection which for the deployment must be assigned.
    ...
    :param builtins.str supported_connection_type: The connection type which the deployment must support.
    """
    __args__ = dict()
...
def get_deployments_output(assignable_connection_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           assigned_connection_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           ...
                           fqdn: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           lifecycle_sub_state: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           state: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           supported_connection_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
