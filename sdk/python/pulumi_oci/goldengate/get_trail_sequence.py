...
class GetTrailSequenceResult:
    ...
    def trail_sequence_id(self) -> _builtins.str:
...
def get_trail_sequence(deployment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str trail_sequence_id: A Trail Sequence identifier
    """
    __args__ = dict()
...
def get_trail_sequence_output(deployment_id: Optional[pulumi.Input[_builtins.str]] = None,
