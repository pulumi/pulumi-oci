...
def get_trail_sequences(deployment_id: Optional[builtins.str] = None,
...
def get_trail_sequences_output(deployment_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:GoldenGate/getTrailSequences:getTrailSequences', __args__, opts=opts, typ=GetTrailSequencesResult)
    return __ret__.apply(lambda __response__: GetTrailSequencesResult(
        deployment_id=pulumi.get(__response__, 'deployment_id'),
        display_name=pulumi.get(__response__, 'display_name'),
        filters=pulumi.get(__response__, 'filters'),
        id=pulumi.get(__response__, 'id'),
        trail_file_id=pulumi.get(__response__, 'trail_file_id'),
        trail_sequence_collections=pulumi.get(__response__, 'trail_sequence_collections'),
