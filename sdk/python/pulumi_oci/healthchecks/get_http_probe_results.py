...
def get_http_probe_results(filters: Optional[Sequence[pulumi.InputType['GetHttpProbeResultsFilterArgs']]] = None,
    ...
    test_http_probe_results = oci.HealthChecks.get_http_probe_results(probe_configuration_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
