...
__all__ = [
    'GetPingMonitorResult',
    'AwaitableGetPingMonitorResult',
    'get_ping_monitor',
    'get_ping_monitor_output',
]

@pulumi.output_type
class GetPingMonitorResult:
    """
    A collection of values returned by getPingMonitor.
    """
    def __init__(__self__, compartment_id=None, defined_tags=None, display_name=None, freeform_tags=None, home_region=None, id=None, interval_in_seconds=None, is_enabled=None, monitor_id=None, port=None, protocol=None, results_url=None, targets=None, time_created=None, timeout_in_seconds=None, vantage_point_names=None):
...
class AwaitableGetPingMonitorResult(GetPingMonitorResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetPingMonitorResult(
...
def get_ping_monitor(monitor_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str monitor_id: The OCID of a monitor.
    """
    __args__ = dict()
...
def get_ping_monitor_output(monitor_id: Optional[pulumi.Input[_builtins.str]] = None,
