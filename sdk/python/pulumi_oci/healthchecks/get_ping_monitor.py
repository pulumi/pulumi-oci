...
def get_ping_monitor(monitor_id: Optional[builtins.str] = None,
    ...
    :param builtins.str monitor_id: The OCID of a monitor.
    """
    __args__ = dict()
...
def get_ping_monitor_output(monitor_id: Optional[pulumi.Input[builtins.str]] = None,
