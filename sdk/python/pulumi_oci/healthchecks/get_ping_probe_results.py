...
def get_ping_probe_results_output(filters: pulumi.Input[Optional[Optional[Sequence[Union['GetPingProbeResultsFilterArgs', 'GetPingProbeResultsFilterArgsDict']]]]] = None,
