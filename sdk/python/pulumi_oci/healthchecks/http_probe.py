...
class HttpProbeArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] protocol: The supported protocols available for HTTP probes.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] targets: A list of targets (hostnames or IP addresses) of the probe.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] headers: A dictionary of HTTP request headers.
               
               *Note:* Monitors and probes do not support the use of the `Authorization` HTTP header.
        :param pulumi.Input[builtins.str] method: The supported HTTP methods available for probes.
        :param pulumi.Input[builtins.str] path: The optional URL path to probe, including query parameters.
        :param pulumi.Input[builtins.int] port: The port on which to probe endpoints. If unspecified, probes will use the default port of their protocol.
        :param pulumi.Input[builtins.int] timeout_in_seconds: The probe timeout in seconds. Valid values: 10, 20, 30, and 60. The probe timeout must be less than or equal to `intervalInSeconds` for monitors.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] vantage_point_names: A list of names of vantage points from which to execute the probe.
...
class HttpProbe(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            timeout_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
            vantage_point_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'HttpProbe':
        """
