...
class PingMonitorArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] protocol: (Updatable) The protocols for ping probes.
...
class PingMonitor(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            timeout_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
            vantage_point_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'PingMonitor':
        """
