...
class ApiKeyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key_value: The public key.  Must be an RSA key in PEM format.
...
class _ApiKeyState:
    def __init__(__self__, *,
                 ...
                 inactive_status: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] fingerprint: The key's fingerprint (e.g., 12:34:56:78:90:ab:cd:ef:12:34:56:78:90:ab:cd:ef).
        :param pulumi.Input[builtins.str] inactive_status: The detailed status of INACTIVE lifecycleState.
        :param pulumi.Input[builtins.str] key_value: The public key.  Must be an RSA key in PEM format.
        :param pulumi.Input[builtins.str] state: The API key's current state.
        :param pulumi.Input[builtins.str] time_created: Date and time the `ApiKey` object was created, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] user_id: The OCID of the user.
    ...
    def inactive_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def inactive_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ApiKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ApiKey':
        """
    ...
    @property
    @pulumi.getter(name="inactiveStatus")
    def inactive_status(self) -> pulumi.Output[builtins.str]:
        """
        The detailed status of INACTIVE lifecycleState.
        """
        return pulumi.get(self, "inactive_status")
