...
class _AuthTokenState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] time_created: Date and time the `AuthToken` object was created, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
...
class AuthToken(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_expires: Optional[pulumi.Input[_builtins.str]] = None,
            token: Optional[pulumi.Input[_builtins.str]] = None,
            user_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'AuthToken':
        """
