...
class AuthTokenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) The description you assign to the auth token during creation. Does not have to be unique, and it's changeable.
...
class _AuthTokenState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] state: The token's current state.
        :param pulumi.Input[builtins.str] time_created: Date and time the `AuthToken` object was created, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_expires: Date and time when this auth token will expire, in the format defined by RFC3339. Null if it never expires.  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] token: The auth token. The value is available only in the response for `CreateAuthToken`, and not for `ListAuthTokens` or `UpdateAuthToken`.
        :param pulumi.Input[builtins.str] user_id: The OCID of the user.
...
@pulumi.type_token("oci:Identity/authToken:AuthToken")
class AuthToken(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_expires: Optional[pulumi.Input[builtins.str]] = None,
            token: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AuthToken':
        """
