...
class CompartmentArgs:
    def __init__(__self__, *,
                 ...
                 enable_delete: Optional[pulumi.Input[builtins.bool]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Compartment resource.
        :param pulumi.Input[builtins.str] description: (Updatable) The description you assign to the compartment during creation. Does not have to be unique, and it's changeable.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the parent compartment containing the compartment.
    ...
    def enable_delete(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_delete(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _CompartmentState:
    def __init__(__self__, *,
                 ...
                 is_accessible: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] is_accessible: Indicates whether or not the compartment is accessible for the user making the request. Returns true when the user has INSPECT permissions directly on a resource in the compartment or indirectly (permissions can be on a resource in a subcompartment).
        :param pulumi.Input[builtins.str] name: (Updatable) The name you assign to the compartment during creation. The name must be unique across all compartments in the parent compartment. Avoid entering confidential information.
        :param pulumi.Input[builtins.str] state: The compartment's current state.
        :param pulumi.Input[builtins.str] time_created: Date and time the compartment was created, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
        """
        if compartment_id is not None:
            pulumi.set(__self__, "compartment_id", compartment_id)
        if defined_tags is not None:
    ...
    def is_accessible(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_accessible(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Compartment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'Compartment':
        """
    ...
    @property
    @pulumi.getter(name="enableDelete")
    def enable_delete(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        Defaults to false. If omitted or set to false the provider will implicitly import the compartment if there is a name collision, and will not actually delete the compartment on destroy or removal of the resource declaration. If set to true, the provider will throw an error on a name collision with another compartment, and will attempt to delete the compartment on destroy or removal of the resource declaration.
    ...
    @property
    @pulumi.getter(name="isAccessible")
    def is_accessible(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether or not the compartment is accessible for the user making the request. Returns true when the user has INSPECT permissions directly on a resource in the compartment or indirectly (permissions can be on a resource in a subcompartment).
        """
        return pulumi.get(self, "is_accessible")
