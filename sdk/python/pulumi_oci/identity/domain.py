...
class DomainArgs:
    def __init__(__self__, *,
                 ...
                 home_region: pulumi.Input[builtins.str],
                 license_type: pulumi.Input[builtins.str],
                 admin_email: Optional[pulumi.Input[builtins.str]] = None,
                 admin_first_name: Optional[pulumi.Input[builtins.str]] = None,
                 admin_last_name: Optional[pulumi.Input[builtins.str]] = None,
                 admin_user_name: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_hidden_on_login: Optional[pulumi.Input[builtins.bool]] = None,
                 is_notification_bypassed: Optional[pulumi.Input[builtins.bool]] = None,
                 is_primary_email_required: Optional[pulumi.Input[builtins.bool]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Domain resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the Compartment where domain is created
        :param pulumi.Input[builtins.str] description: (Updatable) Domain entity description
        :param pulumi.Input[builtins.str] display_name: (Updatable) The mutable display name of the domain.
        :param pulumi.Input[builtins.str] home_region: The region's name. See [Regions and Availability Domains](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/regions.htm) for the full list of supported region names.  Example: `us-phoenix-1`
        :param pulumi.Input[builtins.str] license_type: The License type of Domain
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] admin_email: The admin email address
        :param pulumi.Input[builtins.str] admin_first_name: The admin first name
        :param pulumi.Input[builtins.str] admin_last_name: The admin last name
        :param pulumi.Input[builtins.str] admin_user_name: The admin user name
        ...
        :param pulumi.Input[builtins.bool] is_hidden_on_login: (Updatable) Indicates whether domain is hidden on login screen or not.
        :param pulumi.Input[builtins.bool] is_notification_bypassed: Indicates if admin user created in IDCS stripe would like to receive notification like welcome email or not. Required field only if admin information is provided, otherwise optional.
        :param pulumi.Input[builtins.bool] is_primary_email_required: Optional field to indicate whether users in the domain are required to have a primary email address or not Defaults to true
    ...
    def home_region(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @home_region.setter
    def home_region(self, value: pulumi.Input[builtins.str]):
    ...
    def admin_first_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def admin_first_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "admin_first_name", value)

    @property
    @pulumi.getter(name="adminLastName")
    def admin_last_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The admin last name
        """
    ...
    def admin_last_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_hidden_on_login(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_hidden_on_login(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_hidden_on_login", value)

    @property
    @pulumi.getter(name="isNotificationBypassed")
    def is_notification_bypassed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_notification_bypassed(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_notification_bypassed", value)

    @property
    @pulumi.getter(name="isPrimaryEmailRequired")
    def is_primary_email_required(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_primary_email_required(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _DomainState:
    def __init__(__self__, *,
                 ...
                 home_region_url: Optional[pulumi.Input[builtins.str]] = None,
                 is_hidden_on_login: Optional[pulumi.Input[builtins.bool]] = None,
                 is_notification_bypassed: Optional[pulumi.Input[builtins.bool]] = None,
                 is_primary_email_required: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] home_region: The region's name. See [Regions and Availability Domains](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/regions.htm) for the full list of supported region names.  Example: `us-phoenix-1`
        :param pulumi.Input[builtins.str] home_region_url: Region specific domain URL.
        :param pulumi.Input[builtins.bool] is_hidden_on_login: (Updatable) Indicates whether domain is hidden on login screen or not.
        :param pulumi.Input[builtins.bool] is_notification_bypassed: Indicates if admin user created in IDCS stripe would like to receive notification like welcome email or not. Required field only if admin information is provided, otherwise optional.
        :param pulumi.Input[builtins.bool] is_primary_email_required: Optional field to indicate whether users in the domain are required to have a primary email address or not Defaults to true
        :param pulumi.Input[builtins.str] license_type: The License type of Domain
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] lifecycle_details: Any additional details about the current state of the Domain.
        :param pulumi.Input[Sequence[pulumi.Input['DomainReplicaRegionArgs']]] replica_regions: The regions domain is replication to.
        :param pulumi.Input[builtins.str] state: The current state.
        :param pulumi.Input[builtins.str] time_created: Date and time the domain was created, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] type: The type of the domain.
        :param pulumi.Input[builtins.str] url: Region agnostic domain URL.
        """
        if admin_email is not None:
            pulumi.set(__self__, "admin_email", admin_email)
        if admin_first_name is not None:
    ...
    def home_region_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def home_region_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Domain(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'Domain':
        """
    ...
    @property
    @pulumi.getter(name="adminFirstName")
    def admin_first_name(self) -> pulumi.Output[builtins.str]:
        """
        The admin first name
        """
        return pulumi.get(self, "admin_first_name")
    ...
    @property
    @pulumi.getter(name="adminLastName")
    def admin_last_name(self) -> pulumi.Output[builtins.str]:
        """
        The admin last name
        """
        return pulumi.get(self, "admin_last_name")
    ...
    @property
    @pulumi.getter(name="adminUserName")
    def admin_user_name(self) -> pulumi.Output[builtins.str]:
        """
        The admin user name
        """
        return pulumi.get(self, "admin_user_name")
    ...
    @property
    @pulumi.getter(name="homeRegionUrl")
    def home_region_url(self) -> pulumi.Output[builtins.str]:
        """
        Region specific domain URL.
        """
        return pulumi.get(self, "home_region_url")
    ...
    @property
    @pulumi.getter(name="isHiddenOnLogin")
    def is_hidden_on_login(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Indicates whether domain is hidden on login screen or not.
        """
        return pulumi.get(self, "is_hidden_on_login")
    ...
    @property
    @pulumi.getter(name="isNotificationBypassed")
    def is_notification_bypassed(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates if admin user created in IDCS stripe would like to receive notification like welcome email or not. Required field only if admin information is provided, otherwise optional.
        """
        return pulumi.get(self, "is_notification_bypassed")
    ...
    @property
    @pulumi.getter(name="isPrimaryEmailRequired")
    def is_primary_email_required(self) -> pulumi.Output[builtins.bool]:
        """
        Optional field to indicate whether users in the domain are required to have a primary email address or not Defaults to true
        """
        return pulumi.get(self, "is_primary_email_required")
