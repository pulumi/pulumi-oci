...
class DomainReplicationToRegionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain_id: The OCID of the domain
        :param pulumi.Input[builtins.str] replica_region: A region for which domain replication is requested for. See [Regions and Availability Domains](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/regions.htm) for the full list of supported region names.  Example: `us-phoenix-1` 
...
class DomainReplicationToRegion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            domain_id: Optional[pulumi.Input[builtins.str]] = None,
            replica_region: Optional[pulumi.Input[builtins.str]] = None) -> 'DomainReplicationToRegion':
        """
