...
class DomainsApiKey(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            urnietfparamsscimschemasoracleidcsextensionself_change_user = _utilities.configure(urnietfparamsscimschemasoracleidcsextensionself_change_user, DomainsApiKeyUrnietfparamsscimschemasoracleidcsextensionselfChangeUserArgs, True)
            ...
            user = _utilities.configure(user, DomainsApiKeyUserArgs, True)
