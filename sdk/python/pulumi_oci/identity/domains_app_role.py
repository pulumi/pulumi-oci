...
class DomainsAppRoleArgs:
    def __init__(__self__, *,
                 ...
                 admin_role: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 available_to_clients: Optional[pulumi.Input[builtins.bool]] = None,
                 available_to_groups: Optional[pulumi.Input[builtins.bool]] = None,
                 available_to_users: Optional[pulumi.Input[builtins.bool]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 legacy_group_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input['DomainsAppRoleAppArgs'] app: A unique identifier for the application that references this role.
               ...
               * type: complex
               * uniqueness: none
        :param pulumi.Input[builtins.str] display_name: AppRole name
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] schemas: REQUIRED. The schemas attribute is an array of Strings which allows introspection of the supported schema version for a SCIM representation as well any schema extensions supported by that representation. Each String value must be a unique URI. This specification defines URIs for User, Group, and a standard \\"enterprise\\" extension. All representations of SCIM schema MUST include a non-zero value array with value(s) of the URIs supported by that representation. Duplicate values MUST NOT be included. Value order is not specified and MUST not impact behavior.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[builtins.bool] admin_role: If true, the role provides administrative access privileges.
        ...
        :param pulumi.Input[builtins.bool] available_to_clients: If true, this AppRole can be granted to Apps.
               ...
               * type: boolean
               * uniqueness: none
        :param pulumi.Input[builtins.bool] available_to_groups: If true, this AppRole can be granted to Groups.
               ...
               * type: boolean
               * uniqueness: none
        :param pulumi.Input[builtins.bool] available_to_users: If true, this AppRole can be granted to Users.
               ...
               * type: boolean
               * uniqueness: none
        :param pulumi.Input[builtins.str] description: AppRole description
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[builtins.str] legacy_group_name: The name of the legacy group associated with this AppRole.
        ...
        :param pulumi.Input[builtins.str] ocid: Unique Oracle Cloud Infrastructure identifier for the SCIM Resource.
               ...
               * type: string
               * uniqueness: global
        :param pulumi.Input[builtins.bool] public: If true, this AppRole is available automatically to every Oracle Identity Cloud Service User in this tenancy. There is no need to grant it to individual Users or Groups.
    ...
    def admin_role(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @admin_role.setter
    def admin_role(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def available_to_clients(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def available_to_clients(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "available_to_clients", value)

    @property
    @pulumi.getter(name="availableToGroups")
    def available_to_groups(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def available_to_groups(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "available_to_groups", value)

    @property
    @pulumi.getter(name="availableToUsers")
    def available_to_users(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def available_to_users(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def legacy_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def legacy_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DomainsAppRoleState:
    def __init__(__self__, *,
                 ...
                 legacy_group_name: Optional[pulumi.Input[builtins.str]] = None,
                 limited_to_one_or_more_groups: Optional[pulumi.Input[builtins.bool]] = None,
                 localized_display_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] legacy_group_name: The name of the legacy group associated with this AppRole.
               ...
               * type: string
               * uniqueness: server
        :param pulumi.Input[builtins.bool] limited_to_one_or_more_groups: (Updatable) If true, indicates that this Oracle Identity Cloud Service AppRole can be granted to a delegated administrator whose scope is limited to users that are members of one or more groups.
               ...
               * type: boolean
               * uniqueness: none
        :param pulumi.Input[builtins.str] localized_display_name: (Updatable) AppRole localization name
        ...
        :param pulumi.Input[builtins.str] tenancy_ocid: (Updatable) Oracle Cloud Infrastructure Tenant Id (ocid) in which the resource lives.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[builtins.str] unique_name: (Updatable) AppRole unique name
    ...
    def limited_to_one_or_more_groups(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def limited_to_one_or_more_groups(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "limited_to_one_or_more_groups", value)

    @property
    @pulumi.getter(name="localizedDisplayName")
    def localized_display_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def localized_display_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("oci:Identity/domainsAppRole:DomainsAppRole")
class DomainsAppRole(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DomainsAppRoleTagArgs', 'DomainsAppRoleTagArgsDict']]]]] = None,
            tenancy_ocid: Optional[pulumi.Input[builtins.str]] = None,
            unique_name: Optional[pulumi.Input[builtins.str]] = None) -> 'DomainsAppRole':
        """
    ...
    @property
    @pulumi.getter(name="adminRole")
    def admin_role(self) -> pulumi.Output[builtins.bool]:
        """
        If true, the role provides administrative access privileges.
    ...
    @property
    @pulumi.getter(name="availableToClients")
    def available_to_clients(self) -> pulumi.Output[builtins.bool]:
        """
        If true, this AppRole can be granted to Apps.
    ...
    @property
    @pulumi.getter(name="availableToGroups")
    def available_to_groups(self) -> pulumi.Output[builtins.bool]:
        """
        If true, this AppRole can be granted to Groups.
    ...
    @property
    @pulumi.getter(name="availableToUsers")
    def available_to_users(self) -> pulumi.Output[builtins.bool]:
        """
        If true, this AppRole can be granted to Users.
    ...
    @property
    @pulumi.getter(name="legacyGroupName")
    def legacy_group_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the legacy group associated with this AppRole.
    ...
    @property
    @pulumi.getter(name="limitedToOneOrMoreGroups")
    def limited_to_one_or_more_groups(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) If true, indicates that this Oracle Identity Cloud Service AppRole can be granted to a delegated administrator whose scope is limited to users that are members of one or more groups.
    ...
    @property
    @pulumi.getter(name="localizedDisplayName")
    def localized_display_name(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) AppRole localization name
