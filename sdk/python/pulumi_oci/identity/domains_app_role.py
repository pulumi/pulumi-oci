...
class DomainsAppRoleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['DomainsAppRoleAppArgs'] app: A unique identifier for the application that references this role.
               ...
               * type: complex
               * uniqueness: none
        :param pulumi.Input[_builtins.str] display_name: AppRole name
        ...
        :param pulumi.Input[_builtins.bool] available_to_clients: If true, this AppRole can be granted to Apps.
               ...
               * type: boolean
               * uniqueness: none
        :param pulumi.Input[_builtins.bool] available_to_groups: If true, this AppRole can be granted to Groups.
               ...
               * type: boolean
               * uniqueness: none
        :param pulumi.Input[_builtins.bool] available_to_users: If true, this AppRole can be granted to Users.
               ...
               * type: boolean
               * uniqueness: none
        :param pulumi.Input[_builtins.str] description: AppRole description
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[_builtins.str] legacy_group_name: The name of the legacy group associated with this AppRole.
        ...
        :param pulumi.Input[_builtins.str] ocid: Unique Oracle Cloud Infrastructure identifier for the SCIM Resource.
               ...
               * type: string
               * uniqueness: global
        :param pulumi.Input[_builtins.bool] public: If true, this AppRole is available automatically to every Oracle Identity Cloud Service User in this tenancy. There is no need to grant it to individual Users or Groups.
...
class _DomainsAppRoleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] legacy_group_name: The name of the legacy group associated with this AppRole.
               ...
               * type: string
               * uniqueness: server
        :param pulumi.Input[_builtins.bool] limited_to_one_or_more_groups: (Updatable) If true, indicates that this Oracle Identity Cloud Service AppRole can be granted to a delegated administrator whose scope is limited to users that are members of one or more groups.
               ...
               * type: boolean
               * uniqueness: none
        :param pulumi.Input[_builtins.str] localized_display_name: (Updatable) AppRole localization name
        ...
        :param pulumi.Input[_builtins.str] tenancy_ocid: (Updatable) Oracle Cloud Infrastructure Tenant Id (ocid) in which the resource lives.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[_builtins.str] unique_name: (Updatable) AppRole unique name
...
class DomainsAppRole(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="adminRole")
    def admin_role(self) -> pulumi.Output[_builtins.bool]:
        """
        If true, the role provides administrative access privileges.
    ...
    @_builtins.property
    @pulumi.getter(name="availableToClients")
    def available_to_clients(self) -> pulumi.Output[_builtins.bool]:
        """
        If true, this AppRole can be granted to Apps.
    ...
    @_builtins.property
    @pulumi.getter(name="availableToGroups")
    def available_to_groups(self) -> pulumi.Output[_builtins.bool]:
        """
        If true, this AppRole can be granted to Groups.
    ...
    @_builtins.property
    @pulumi.getter(name="availableToUsers")
    def available_to_users(self) -> pulumi.Output[_builtins.bool]:
        """
        If true, this AppRole can be granted to Users.
    ...
    @_builtins.property
    @pulumi.getter(name="legacyGroupName")
    def legacy_group_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the legacy group associated with this AppRole.
    ...
    @_builtins.property
    @pulumi.getter(name="limitedToOneOrMoreGroups")
    def limited_to_one_or_more_groups(self) -> pulumi.Output[_builtins.bool]:
        """
        (Updatable) If true, indicates that this Oracle Identity Cloud Service AppRole can be granted to a delegated administrator whose scope is limited to users that are members of one or more groups.
    ...
    @_builtins.property
    @pulumi.getter(name="localizedDisplayName")
    def localized_display_name(self) -> pulumi.Output[_builtins.str]:
        """
        (Updatable) AppRole localization name
