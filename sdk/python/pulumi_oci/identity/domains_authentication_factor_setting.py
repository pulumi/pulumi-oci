...
class DomainsAuthenticationFactorSettingArgs:
    def __init__(__self__, *,
                 authentication_factor_setting_id: pulumi.Input[builtins.str],
                 bypass_code_enabled: pulumi.Input[builtins.bool],
                 ...
                 mfa_enrollment_type: pulumi.Input[builtins.str],
                 notification_settings: pulumi.Input['DomainsAuthenticationFactorSettingNotificationSettingsArgs'],
                 push_enabled: pulumi.Input[builtins.bool],
                 schemas: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 security_questions_enabled: pulumi.Input[builtins.bool],
                 sms_enabled: pulumi.Input[builtins.bool],
                 totp_enabled: pulumi.Input[builtins.bool],
                 ...
                 auto_enroll_email_factor_disabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 fido_authenticator_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 hide_backup_factor_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 phone_call_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 user_enrollment_disabled_factors: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 yubico_otp_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a DomainsAuthenticationFactorSetting resource.
        :param pulumi.Input[builtins.str] authentication_factor_setting_id: ID of the resource
        :param pulumi.Input[builtins.bool] bypass_code_enabled: (Updatable) If true, indicates that Bypass Code is enabled for authentication
        ...
        :param pulumi.Input[builtins.str] mfa_enrollment_type: (Updatable) Specifies if Multi-Factor Authentication enrollment is mandatory or optional for a user
        ...
        :param pulumi.Input['DomainsAuthenticationFactorSettingNotificationSettingsArgs'] notification_settings: (Updatable) Settings related to the Mobile App Notification channel, such as pull
               ...
               * type: complex
               * uniqueness: none
        :param pulumi.Input[builtins.bool] push_enabled: (Updatable) If true, indicates that the Mobile App Push Notification channel is enabled for authentication
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] schemas: (Updatable) REQUIRED. The schemas attribute is an array of Strings which allows introspection of the supported schema version for a SCIM representation as well any schema extensions supported by that representation. Each String value must be a unique URI. This specification defines URIs for User, Group, and a standard \\"enterprise\\" extension. All representations of SCIM schema MUST include a non-zero value array with value(s) of the URIs supported by that representation. Duplicate values MUST NOT be included. Value order is not specified and MUST not impact behavior.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[builtins.bool] security_questions_enabled: (Updatable) If true, indicates that Security Questions are enabled for authentication
               ...
               * type: boolean
               * uniqueness: none
        :param pulumi.Input[builtins.bool] sms_enabled: (Updatable) If true, indicates that the Short Message Service (SMS) channel is enabled for authentication
               ...
               * type: boolean
               * uniqueness: none
        :param pulumi.Input[builtins.bool] totp_enabled: (Updatable) If true, indicates that the Mobile App One Time Passcode channel is enabled for authentication
        ...
        :param pulumi.Input[builtins.bool] auto_enroll_email_factor_disabled: (Updatable) If true, indicates that email will not be enrolled as a MFA factor automatically if it a account recovery factor
               ...
               * type: boolean
               * uniqueness: none
        :param pulumi.Input[builtins.bool] email_enabled: (Updatable) If true, indicates that the EMAIL channel is enabled for authentication
        ...
        :param pulumi.Input['DomainsAuthenticationFactorSettingEmailSettingsArgs'] email_settings: (Updatable) Settings related to Email Factor, such as enabled email magic link factor, custom url for Email Link
               ...
               * type: complex
               * uniqueness: none
        :param pulumi.Input[builtins.bool] fido_authenticator_enabled: (Updatable) If true, indicates that the Fido Authenticator channels are enabled for authentication
               ...
               * type: boolean
               * uniqueness: none
        :param pulumi.Input[builtins.bool] hide_backup_factor_enabled: (Updatable) If true, indicates that 'Show backup factor(s)' button will be hidden during authentication
        ...
        :param pulumi.Input[builtins.str] ocid: (Updatable) Unique Oracle Cloud Infrastructure identifier for the SCIM Resource.
               ...
               * type: string
               * uniqueness: global
        :param pulumi.Input[builtins.bool] phone_call_enabled: (Updatable) If true, indicates that the phone (PHONE_CALL) channel is enabled for authentication
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] user_enrollment_disabled_factors: (Updatable) Factors for which enrollment should be blocked for End User
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[builtins.bool] yubico_otp_enabled: (Updatable) If true, indicates that the Yubico OTP is enabled for authentication
    ...
    def authentication_factor_setting_id(self) -> pulumi.Input[builtins.str]:
        """
        ID of the resource
        """
    ...
    def authentication_factor_setting_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "authentication_factor_setting_id", value)

    @property
    @pulumi.getter(name="bypassCodeEnabled")
    def bypass_code_enabled(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def bypass_code_enabled(self, value: pulumi.Input[builtins.bool]):
    ...
    def mfa_enrollment_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def mfa_enrollment_type(self, value: pulumi.Input[builtins.str]):
    ...
    def push_enabled(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @push_enabled.setter
    def push_enabled(self, value: pulumi.Input[builtins.bool]):
    ...
    def security_questions_enabled(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def security_questions_enabled(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "security_questions_enabled", value)

    @property
    @pulumi.getter(name="smsEnabled")
    def sms_enabled(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @sms_enabled.setter
    def sms_enabled(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "sms_enabled", value)

    @property
    @pulumi.getter(name="totpEnabled")
    def totp_enabled(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @totp_enabled.setter
    def totp_enabled(self, value: pulumi.Input[builtins.bool]):
    ...
    def auto_enroll_email_factor_disabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def auto_enroll_email_factor_disabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def fido_authenticator_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def fido_authenticator_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "fido_authenticator_enabled", value)

    @property
    @pulumi.getter(name="hideBackupFactorEnabled")
    def hide_backup_factor_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def hide_backup_factor_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def phone_call_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def phone_call_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def user_enrollment_disabled_factors(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def user_enrollment_disabled_factors(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "user_enrollment_disabled_factors", value)

    @property
    @pulumi.getter(name="yubicoOtpEnabled")
    def yubico_otp_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def yubico_otp_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _DomainsAuthenticationFactorSettingState:
    def __init__(__self__, *,
                 attribute_sets: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 attributes: Optional[pulumi.Input[builtins.str]] = None,
                 authentication_factor_setting_id: Optional[pulumi.Input[builtins.str]] = None,
                 authorization: Optional[pulumi.Input[builtins.str]] = None,
                 auto_enroll_email_factor_disabled: Optional[pulumi.Input[builtins.bool]] = None,
                 bypass_code_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 mfa_enabled_category: Optional[pulumi.Input[builtins.str]] = None,
                 mfa_enrollment_type: Optional[pulumi.Input[builtins.str]] = None,
                 notification_settings: Optional[pulumi.Input['DomainsAuthenticationFactorSettingNotificationSettingsArgs']] = None,
                 ocid: Optional[pulumi.Input[builtins.str]] = None,
                 phone_call_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 push_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 resource_type_schema_version: Optional[pulumi.Input[builtins.str]] = None,
                 schemas: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 security_questions_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 sms_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 tags: Optional[pulumi.Input[Sequence[pulumi.Input['DomainsAuthenticationFactorSettingTagArgs']]]] = None,
                 tenancy_ocid: Optional[pulumi.Input[builtins.str]] = None,
                 third_party_factor: Optional[pulumi.Input['DomainsAuthenticationFactorSettingThirdPartyFactorArgs']] = None,
                 totp_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DomainsAuthenticationFactorSettingMetaArgs']]] metas: (Updatable) A complex attribute that contains resource metadata. All sub-attributes are OPTIONAL.
               ...
               * type: complex
        :param pulumi.Input[builtins.str] mfa_enabled_category: (Updatable) Specifies the category of people for whom Multi-Factor Authentication is enabled. This is a readOnly attribute which reflects the value of mfaEnabledCategory attribute in SsoSettings
    ...
    @property
    @pulumi.getter(name="authenticationFactorSettingId")
    def authentication_factor_setting_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ID of the resource
        """
        return pulumi.get(self, "authentication_factor_setting_id")
    ...
    @authentication_factor_setting_id.setter
    def authentication_factor_setting_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "authentication_factor_setting_id", value)
    ...
    @property
    @pulumi.getter(name="bypassCodeEnabled")
    def bypass_code_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) If true, indicates that Bypass Code is enabled for authentication
    ...
    @bypass_code_enabled.setter
    def bypass_code_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "bypass_code_enabled", value)
    ...
    def mfa_enabled_category(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def mfa_enabled_category(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mfa_enabled_category", value)

    @property
    @pulumi.getter(name="mfaEnrollmentType")
    def mfa_enrollment_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Specifies if Multi-Factor Authentication enrollment is mandatory or optional for a user
    ...
    @mfa_enrollment_type.setter
    def mfa_enrollment_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mfa_enrollment_type", value)
    ...
    @property
    @pulumi.getter(name="pushEnabled")
    def push_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) If true, indicates that the Mobile App Push Notification channel is enabled for authentication
    ...
    @push_enabled.setter
    def push_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "push_enabled", value)
    ...
    @property
    @pulumi.getter(name="securityQuestionsEnabled")
    def security_questions_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) If true, indicates that Security Questions are enabled for authentication
    ...
    @security_questions_enabled.setter
    def security_questions_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "security_questions_enabled", value)
    ...
    @property
    @pulumi.getter(name="totpEnabled")
    def totp_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) If true, indicates that the Mobile App One Time Passcode channel is enabled for authentication
    ...
    @totp_enabled.setter
    def totp_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "totp_enabled", value)
...
class DomainsAuthenticationFactorSetting(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            urnietfparamsscimschemasoracleidcsextensionthird_party_authentication_factor_settings: Optional[pulumi.Input[Union['DomainsAuthenticationFactorSettingUrnietfparamsscimschemasoracleidcsextensionthirdPartyAuthenticationFactorSettingsArgs', 'DomainsAuthenticationFactorSettingUrnietfparamsscimschemasoracleidcsextensionthirdPartyAuthenticationFactorSettingsArgsDict']]] = None,
            user_enrollment_disabled_factors: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            yubico_otp_enabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'DomainsAuthenticationFactorSetting':
        """
    ...
    @property
    @pulumi.getter(name="authenticationFactorSettingId")
    def authentication_factor_setting_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the resource
        """
        return pulumi.get(self, "authentication_factor_setting_id")
    ...
    @property
    @pulumi.getter(name="autoEnrollEmailFactorDisabled")
    def auto_enroll_email_factor_disabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) If true, indicates that email will not be enrolled as a MFA factor automatically if it a account recovery factor
    ...
    @property
    @pulumi.getter(name="bypassCodeEnabled")
    def bypass_code_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) If true, indicates that Bypass Code is enabled for authentication
    ...
    @property
    @pulumi.getter(name="emailEnabled")
    def email_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) If true, indicates that the EMAIL channel is enabled for authentication
    ...
    @property
    @pulumi.getter(name="fidoAuthenticatorEnabled")
    def fido_authenticator_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) If true, indicates that the Fido Authenticator channels are enabled for authentication
    ...
    @property
    @pulumi.getter(name="hideBackupFactorEnabled")
    def hide_backup_factor_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) If true, indicates that 'Show backup factor(s)' button will be hidden during authentication
    ...
    @property
    @pulumi.getter(name="mfaEnabledCategory")
    def mfa_enabled_category(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Specifies the category of people for whom Multi-Factor Authentication is enabled. This is a readOnly attribute which reflects the value of mfaEnabledCategory attribute in SsoSettings
    ...
    @property
    @pulumi.getter(name="mfaEnrollmentType")
    def mfa_enrollment_type(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Specifies if Multi-Factor Authentication enrollment is mandatory or optional for a user
    ...
    @property
    @pulumi.getter(name="phoneCallEnabled")
    def phone_call_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) If true, indicates that the phone (PHONE_CALL) channel is enabled for authentication
    ...
    @property
    @pulumi.getter(name="pushEnabled")
    def push_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) If true, indicates that the Mobile App Push Notification channel is enabled for authentication
    ...
    @property
    @pulumi.getter(name="securityQuestionsEnabled")
    def security_questions_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) If true, indicates that Security Questions are enabled for authentication
    ...
    @property
    @pulumi.getter(name="smsEnabled")
    def sms_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) If true, indicates that the Short Message Service (SMS) channel is enabled for authentication
    ...
    @property
    @pulumi.getter(name="totpEnabled")
    def totp_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) If true, indicates that the Mobile App One Time Passcode channel is enabled for authentication
    ...
    @property
    @pulumi.getter(name="userEnrollmentDisabledFactors")
    def user_enrollment_disabled_factors(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) Factors for which enrollment should be blocked for End User
    ...
    @property
    @pulumi.getter(name="yubicoOtpEnabled")
    def yubico_otp_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) If true, indicates that the Yubico OTP is enabled for authentication
