...
class DomainsCloudGateServerInitArgs:
    def __init__(__self__, *,
                 ...
                 ssl: pulumi.Input[builtins.bool],
        ...
        :param pulumi.Input['DomainsCloudGateServerCloudGateArgs'] cloud_gate: (Updatable) Reference to owning Cloud Gate
               ...
               * type: complex
               * uniqueness: none
        :param pulumi.Input[builtins.str] display_name: (Updatable) Display name for the Server block
               ...
               * type: string
               * uniqueness: server
        :param pulumi.Input[builtins.str] host_name: (Updatable) Hostname for the Server block
        ...
        :param pulumi.Input[builtins.int] port: (Updatable) Port for the Server Block
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] schemas: (Updatable) REQUIRED. The schemas attribute is an array of Strings which allows introspection of the supported schema version for a SCIM representation as well any schema extensions supported by that representation. Each String value must be a unique URI. This specification defines URIs for User, Group, and a standard \\"enterprise\\" extension. All representations of SCIM schema MUST include a non-zero value array with value(s) of the URIs supported by that representation. Duplicate values MUST NOT be included. Value order is not specified and MUST not impact behavior.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[builtins.bool] ssl: (Updatable) SSL flag for the Server Block
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Brief description for this Cloud Gate server block
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[builtins.str] nginx_settings: (Updatable) More nginx Settings. JSON encoded text block
    ...
    @property
    @pulumi.getter
    def ssl(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @ssl.setter
    def ssl(self, value: pulumi.Input[builtins.bool]):
...
class DomainsCloudGateServer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            ssl: Optional[pulumi.Input[builtins.bool]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DomainsCloudGateServerTagArgs', 'DomainsCloudGateServerTagArgsDict']]]]] = None,
            tenancy_ocid: Optional[pulumi.Input[builtins.str]] = None) -> 'DomainsCloudGateServer':
        """
