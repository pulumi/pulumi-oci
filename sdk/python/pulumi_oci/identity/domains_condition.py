...
class DomainsConditionArgs:
    def __init__(__self__, *,
                 ...
                 evaluate_condition_if: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] attribute_name: (Updatable) AttributeName - RHS of condition
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[builtins.str] attribute_value: (Updatable) attributeValue - RHS of condition
        ...
        :param pulumi.Input[builtins.str] operator: (Updatable) **SCIM++ Properties:**
               * caseExact: true
               * idcsSearchable: false
               * multiValued: false
               * mutability: readWrite
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Condition Description
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[builtins.str] evaluate_condition_if: (Updatable) Evaluate the condition if this expression returns true, else skip condition evaluation
        ...
        :param pulumi.Input[builtins.str] external_id: (Updatable) An identifier for the Resource as defined by the Service Consumer. The externalId may simplify identification of the Resource between Service Consumer and Service provider by allowing the Consumer to refer to the Resource with its own identifier, obviating the need to store a local mapping between the local identifier of the Resource and the identifier used by the Service Provider. Each Resource MAY include a non-empty externalId value.  The value of the externalId attribute is always issued be the Service Consumer and can never be specified by the Service Provider. The Service Provider MUST always interpret the externalId as scoped to the Service Consumer's tenant.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[builtins.str] name: (Updatable) Condition name
    ...
    def evaluate_condition_if(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def evaluate_condition_if(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DomainsCondition(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            schemas: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DomainsConditionTagArgs', 'DomainsConditionTagArgsDict']]]]] = None,
            tenancy_ocid: Optional[pulumi.Input[builtins.str]] = None) -> 'DomainsCondition':
        """
    ...
    @property
    @pulumi.getter(name="evaluateConditionIf")
    def evaluate_condition_if(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Evaluate the condition if this expression returns true, else skip condition evaluation
