...
class DomainsIdentityPropagationTrustArgs:
    def __init__(__self__, *,
                 ...
                 allow_impersonation: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 client_claim_name: Optional[pulumi.Input[builtins.str]] = None,
                 client_claim_values: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 clock_skew_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 oauth_clients: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ocid: Optional[pulumi.Input[builtins.str]] = None,
                 public_certificate: Optional[pulumi.Input[builtins.str]] = None,
                 public_key_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 resource_type_schema_version: Optional[pulumi.Input[builtins.str]] = None,
                 subject_claim_name: Optional[pulumi.Input[builtins.str]] = None,
                 subject_mapping_attribute: Optional[pulumi.Input[builtins.str]] = None,
                 subject_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] issuer: (Updatable) The issuer claim of the Identity provider.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] schemas: (Updatable) REQUIRED. The schemas attribute is an array of Strings which allows introspection of the supported schema version for a SCIM representation as well any schema extensions supported by that representation. Each String value must be a unique URI. This specification defines URIs for User, Group, and a standard \\"enterprise\\" extension. All representations of SCIM schema MUST include a non-zero value array with value(s) of the URIs supported by that representation. Duplicate values MUST NOT be included. Value order is not specified and MUST not impact behavior.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[builtins.str] type: (Updatable) The type of the inbound token from the Identity cloud provider.
        ...
        :param pulumi.Input[builtins.str] account_id: (Updatable) The Identity cloud provider service identifier, for example, the Azure Tenancy ID, AWS Account ID, or GCP Project ID.
               ...
               * idcsSearchable: true
               * uniqueness: none
        :param pulumi.Input[builtins.bool] active: (Updatable) If true, specifies that this Identity Propagation Trust is in an enabled state. The default value is false.
               ...
               * uniqueness: none
               * idcsSearchable: true
        :param pulumi.Input[builtins.bool] allow_impersonation: (Updatable) Allow customers to define whether the resulting token should contain the authenticated user as the subject or whether the token should impersonate another Application Principal in IAM.
        ...
        :param pulumi.Input[builtins.str] client_claim_name: (Updatable) The claim name that identifies to whom the JWT/SAML token is issued. If AWS, then \\"aud\\" or \\"client_id\\". If Azure, then \\"appid\\". If GCP, then \\"aud\\".
               ...
               * uniqueness: none
               * idcsSearchable: false
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] client_claim_values: (Updatable) The value that corresponds to the client claim name used to identify to whom the token is issued.
               ...
               * caseExact: true
               * idcsSearchable: false
        :param pulumi.Input[builtins.int] clock_skew_seconds: (Updatable) The clock skew (in secs) that's allowed for the token issue and expiry time.
               ...
               * type: integer
               * uniqueness: none
        :param pulumi.Input[builtins.str] description: (Updatable) The description of the Identity Propagation Trust.
        ...
        :param pulumi.Input['DomainsIdentityPropagationTrustKeytabArgs'] keytab: (Updatable) The keytab stored in the tenancy's Vault. This is required if the identity propagation type is 'SPNEGO'.
               ...
               * type: complex
               * uniqueness: none
        :param pulumi.Input[builtins.str] name: The name of the the Identity Propagation Trust.
               ...
               * returned: default
               * uniqueness: none
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] oauth_clients: (Updatable) The value of all the authorized OAuth Clients.
        ...
        :param pulumi.Input[builtins.str] ocid: (Updatable) Unique Oracle Cloud Infrastructure identifier for the SCIM Resource.
               ...
               * type: string
               * uniqueness: global
        :param pulumi.Input[builtins.str] public_certificate: (Updatable) Store the public key if public key cert.
               ...
               * uniqueness: none
               * idcsSearchable: false
        :param pulumi.Input[builtins.str] public_key_endpoint: (Updatable) The cloud provider's public key API of SAML and OIDC providers for signature validation.
        ...
        :param pulumi.Input[builtins.str] subject_claim_name: (Updatable) Used for locating the subject claim from the incoming token.
               ...
               * caseExact: true
               * idcsSearchable: false
        :param pulumi.Input[builtins.str] subject_mapping_attribute: (Updatable) Subject Mapping Attribute to which the value from subject claim name value would be used for identity lookup.
               ...
               * returned: default
               * uniqueness: none
        :param pulumi.Input[builtins.str] subject_type: (Updatable) The type of the resource against which lookup will be made in the identity domain in IAM for the incoming subject claim value.
    ...
    def allow_impersonation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def allow_impersonation(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def client_claim_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def client_claim_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "client_claim_name", value)

    @property
    @pulumi.getter(name="clientClaimValues")
    def client_claim_values(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def client_claim_values(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "client_claim_values", value)

    @property
    @pulumi.getter(name="clockSkewSeconds")
    def clock_skew_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def clock_skew_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def oauth_clients(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def oauth_clients(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def public_key_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def public_key_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def subject_claim_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def subject_claim_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "subject_claim_name", value)

    @property
    @pulumi.getter(name="subjectMappingAttribute")
    def subject_mapping_attribute(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def subject_mapping_attribute(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "subject_mapping_attribute", value)

    @property
    @pulumi.getter(name="subjectType")
    def subject_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @subject_type.setter
    def subject_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DomainsIdentityPropagationTrust(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DomainsIdentityPropagationTrustTagArgs', 'DomainsIdentityPropagationTrustTagArgsDict']]]]] = None,
            tenancy_ocid: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'DomainsIdentityPropagationTrust':
        """
    ...
    @property
    @pulumi.getter(name="allowImpersonation")
    def allow_impersonation(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Allow customers to define whether the resulting token should contain the authenticated user as the subject or whether the token should impersonate another Application Principal in IAM.
    ...
    @property
    @pulumi.getter(name="clientClaimName")
    def client_claim_name(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The claim name that identifies to whom the JWT/SAML token is issued. If AWS, then \\"aud\\" or \\"client_id\\". If Azure, then \\"appid\\". If GCP, then \\"aud\\".
    ...
    @property
    @pulumi.getter(name="clientClaimValues")
    def client_claim_values(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) The value that corresponds to the client claim name used to identify to whom the token is issued.
    ...
    @property
    @pulumi.getter(name="clockSkewSeconds")
    def clock_skew_seconds(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The clock skew (in secs) that's allowed for the token issue and expiry time.
    ...
    @property
    @pulumi.getter(name="oauthClients")
    def oauth_clients(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) The value of all the authorized OAuth Clients.
    ...
    @property
    @pulumi.getter(name="publicKeyEndpoint")
    def public_key_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The cloud provider's public key API of SAML and OIDC providers for signature validation.
    ...
    @property
    @pulumi.getter(name="subjectClaimName")
    def subject_claim_name(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Used for locating the subject claim from the incoming token.
    ...
    @property
    @pulumi.getter(name="subjectMappingAttribute")
    def subject_mapping_attribute(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Subject Mapping Attribute to which the value from subject claim name value would be used for identity lookup.
    ...
    @property
    @pulumi.getter(name="subjectType")
    def subject_type(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The type of the resource against which lookup will be made in the identity domain in IAM for the incoming subject claim value.
