...
class DomainsIdentitySettingArgs:
    def __init__(__self__, *,
                 ...
                 identity_setting_id: pulumi.Input[_builtins.str],
                 ...
                 emit_locked_message_when_user_is_locked: pulumi.Input[Optional[_builtins.bool]] = None,
                 external_id: pulumi.Input[Optional[_builtins.str]] = None,
                 my_profile: pulumi.Input[Optional['DomainsIdentitySettingMyProfileArgs']] = None,
                 ocid: pulumi.Input[Optional[_builtins.str]] = None,
                 posix_gid: pulumi.Input[Optional['DomainsIdentitySettingPosixGidArgs']] = None,
                 posix_uid: pulumi.Input[Optional['DomainsIdentitySettingPosixUidArgs']] = None,
                 primary_email_required: pulumi.Input[Optional[_builtins.bool]] = None,
                 resource_type_schema_version: pulumi.Input[Optional[_builtins.str]] = None,
                 return_inactive_over_locked_message: pulumi.Input[Optional[_builtins.bool]] = None,
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsIdentitySettingTagArgs']]]] = None,
                 tokens: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsIdentitySettingTokenArgs']]]] = None,
                 user_allowed_to_set_recovery_email: pulumi.Input[Optional[_builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] identity_setting_id: ID of the resource
        ...
        :param pulumi.Input['DomainsIdentitySettingPosixUidArgs'] posix_uid: (Updatable) A list of Posix Uid settings.
               ...
               * type: complex
               * uniqueness: none
        :param pulumi.Input[_builtins.bool] primary_email_required: (Updatable) Indicates whether the primary email is required.
        ...
        :param pulumi.Input[_builtins.bool] return_inactive_over_locked_message: (Updatable) **Added In:** 2302092332
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DomainsIdentitySettingTokenArgs']]] tokens: (Updatable) A list of tokens and their expiry length.
               ...
               * type: complex
               * uniqueness: none
        :param pulumi.Input[_builtins.bool] user_allowed_to_set_recovery_email: (Updatable) Indicates whether a user is allowed to change their own recovery email.
    ...
    def identity_setting_id(self) -> pulumi.Input[_builtins.str]:
        """
        ID of the resource
        """
    ...
    def identity_setting_id(self, value: pulumi.Input[_builtins.str]):
    ...
    def emit_locked_message_when_user_is_locked(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        (Updatable) Indicates whether to show the 'user-is-locked' message during authentication if the user is already locked. The default value is false, which tells the system to show a generic 'authentication-failure' message. This is the most secure behavior. If the option is set to true, the system shows a more detailed 'error-message' that says the user is locked. This is more helpful but is less secure, for example, because the difference in error-messages could be used to determine which usernames exist and which do not.
    ...
    def emit_locked_message_when_user_is_locked(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def my_profile(self) -> pulumi.Input[Optional['DomainsIdentitySettingMyProfileArgs']]:
        """
    ...
    @my_profile.setter
    def my_profile(self, value: pulumi.Input[Optional['DomainsIdentitySettingMyProfileArgs']]):
    ...
    def posix_gid(self) -> pulumi.Input[Optional['DomainsIdentitySettingPosixGidArgs']]:
        """
    ...
    @posix_gid.setter
    def posix_gid(self, value: pulumi.Input[Optional['DomainsIdentitySettingPosixGidArgs']]):
        pulumi.set(self, "posix_gid", value)

    @_builtins.property
    @pulumi.getter(name="posixUid")
    def posix_uid(self) -> pulumi.Input[Optional['DomainsIdentitySettingPosixUidArgs']]:
        """
    ...
    @posix_uid.setter
    def posix_uid(self, value: pulumi.Input[Optional['DomainsIdentitySettingPosixUidArgs']]):
        pulumi.set(self, "posix_uid", value)

    @_builtins.property
    @pulumi.getter(name="primaryEmailRequired")
    def primary_email_required(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def primary_email_required(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def return_inactive_over_locked_message(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def return_inactive_over_locked_message(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "return_inactive_over_locked_message", value)

    @_builtins.property
    @pulumi.getter
    def tags(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DomainsIdentitySettingTagArgs']]]]:
        """
    ...
    @tags.setter
    def tags(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsIdentitySettingTagArgs']]]]):
        pulumi.set(self, "tags", value)

    @_builtins.property
    @pulumi.getter
    def tokens(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DomainsIdentitySettingTokenArgs']]]]:
        """
    ...
    @tokens.setter
    def tokens(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsIdentitySettingTokenArgs']]]]):
        pulumi.set(self, "tokens", value)

    @_builtins.property
    @pulumi.getter(name="userAllowedToSetRecoveryEmail")
    def user_allowed_to_set_recovery_email(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def user_allowed_to_set_recovery_email(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class _DomainsIdentitySettingState:
    def __init__(__self__, *,
                 ...
                 emit_locked_message_when_user_is_locked: pulumi.Input[Optional[_builtins.bool]] = None,
                 external_id: pulumi.Input[Optional[_builtins.str]] = None,
                 idcs_created_bies: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsIdentitySettingIdcsCreatedByArgs']]]] = None,
                 idcs_endpoint: pulumi.Input[Optional[_builtins.str]] = None,
                 idcs_last_modified_bies: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsIdentitySettingIdcsLastModifiedByArgs']]]] = None,
                 ...
                 identity_setting_id: pulumi.Input[Optional[_builtins.str]] = None,
                 metas: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsIdentitySettingMetaArgs']]]] = None,
                 my_profile: pulumi.Input[Optional['DomainsIdentitySettingMyProfileArgs']] = None,
                 ocid: pulumi.Input[Optional[_builtins.str]] = None,
                 posix_gid: pulumi.Input[Optional['DomainsIdentitySettingPosixGidArgs']] = None,
                 posix_uid: pulumi.Input[Optional['DomainsIdentitySettingPosixUidArgs']] = None,
                 primary_email_required: pulumi.Input[Optional[_builtins.bool]] = None,
                 remove_invalid_emails: pulumi.Input[Optional[_builtins.bool]] = None,
                 resource_type_schema_version: pulumi.Input[Optional[_builtins.str]] = None,
                 return_inactive_over_locked_message: pulumi.Input[Optional[_builtins.bool]] = None,
        ...
        :param pulumi.Input[_builtins.bool] primary_email_required: (Updatable) Indicates whether the primary email is required.
               ...
               * type: boolean
               * uniqueness: none
        :param pulumi.Input[_builtins.bool] remove_invalid_emails: (Updatable) Indicates whether to remove non-RFC5322 compliant emails before creating a user.
    ...
    def idcs_created_bies(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DomainsIdentitySettingIdcsCreatedByArgs']]]]:
        """
    ...
    def idcs_created_bies(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsIdentitySettingIdcsCreatedByArgs']]]]):
    ...
    def idcs_last_modified_bies(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DomainsIdentitySettingIdcsLastModifiedByArgs']]]]:
        """
    ...
    def idcs_last_modified_bies(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsIdentitySettingIdcsLastModifiedByArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter(name="identitySettingId")
    def identity_setting_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ID of the resource
        """
        return pulumi.get(self, "identity_setting_id")
    ...
    @identity_setting_id.setter
    def identity_setting_id(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "identity_setting_id", value)

    @_builtins.property
    @pulumi.getter
    def metas(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DomainsIdentitySettingMetaArgs']]]]:
        """
    ...
    @metas.setter
    def metas(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsIdentitySettingMetaArgs']]]]):
    ...
    def remove_invalid_emails(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def remove_invalid_emails(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class DomainsIdentitySetting(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 idcs_endpoint: pulumi.Input[Optional[_builtins.str]] = None,
                 identity_setting_id: pulumi.Input[Optional[_builtins.str]] = None,
                 my_profile: pulumi.Input[Optional[Union['DomainsIdentitySettingMyProfileArgs', 'DomainsIdentitySettingMyProfileArgsDict', 'outputs.DomainsIdentitySettingMyProfile']]] = None,
                 ocid: pulumi.Input[Optional[_builtins.str]] = None,
                 posix_gid: pulumi.Input[Optional[Union['DomainsIdentitySettingPosixGidArgs', 'DomainsIdentitySettingPosixGidArgsDict', 'outputs.DomainsIdentitySettingPosixGid']]] = None,
                 posix_uid: pulumi.Input[Optional[Union['DomainsIdentitySettingPosixUidArgs', 'DomainsIdentitySettingPosixUidArgsDict', 'outputs.DomainsIdentitySettingPosixUid']]] = None,
                 primary_email_required: pulumi.Input[Optional[_builtins.bool]] = None,
                 resource_type_schema_version: pulumi.Input[Optional[_builtins.str]] = None,
                 return_inactive_over_locked_message: pulumi.Input[Optional[_builtins.bool]] = None,
                 schemas: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DomainsIdentitySettingTagArgs', 'DomainsIdentitySettingTagArgsDict', 'outputs.DomainsIdentitySettingTag']]]]] = None,
                 tokens: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DomainsIdentitySettingTokenArgs', 'DomainsIdentitySettingTokenArgsDict', 'outputs.DomainsIdentitySettingToken']]]]] = None,
                 user_allowed_to_set_recovery_email: pulumi.Input[Optional[_builtins.bool]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] idcs_endpoint: The basic endpoint for the identity domain
        :param pulumi.Input[_builtins.str] identity_setting_id: ID of the resource
        :param pulumi.Input[Union['DomainsIdentitySettingMyProfileArgs', 'DomainsIdentitySettingMyProfileArgsDict', 'outputs.DomainsIdentitySettingMyProfile']] my_profile: (Updatable) Whether to allow users to update their own profile.
        ...
        :param pulumi.Input[_builtins.str] ocid: (Updatable) Unique Oracle Cloud Infrastructure identifier for the SCIM Resource.
               ...
               * type: string
               * uniqueness: global
        :param pulumi.Input[Union['DomainsIdentitySettingPosixGidArgs', 'DomainsIdentitySettingPosixGidArgsDict', 'outputs.DomainsIdentitySettingPosixGid']] posix_gid: (Updatable) A list of Posix Gid settings.
               ...
               * type: complex
               * uniqueness: none
        :param pulumi.Input[Union['DomainsIdentitySettingPosixUidArgs', 'DomainsIdentitySettingPosixUidArgsDict', 'outputs.DomainsIdentitySettingPosixUid']] posix_uid: (Updatable) A list of Posix Uid settings.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] schemas: (Updatable) REQUIRED. The schemas attribute is an array of Strings which allows introspection of the supported schema version for a SCIM representation as well any schema extensions supported by that representation. Each String value must be a unique URI. This specification defines URIs for User, Group, and a standard \\"enterprise\\" extension. All representations of SCIM schema MUST include a non-zero value array with value(s) of the URIs supported by that representation. Duplicate values MUST NOT be included. Value order is not specified and MUST not impact behavior.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[Sequence[pulumi.Input[Union['DomainsIdentitySettingTagArgs', 'DomainsIdentitySettingTagArgsDict', 'outputs.DomainsIdentitySettingTag']]]] tags: (Updatable) A list of tags on this resource.
               ...
               * type: complex
               * uniqueness: none
        :param pulumi.Input[Sequence[pulumi.Input[Union['DomainsIdentitySettingTokenArgs', 'DomainsIdentitySettingTokenArgsDict', 'outputs.DomainsIdentitySettingToken']]]] tokens: (Updatable) A list of tokens and their expiry length.
    ...
    def get(resource_name: str,
            ...
            emit_locked_message_when_user_is_locked: pulumi.Input[Optional[_builtins.bool]] = None,
            external_id: pulumi.Input[Optional[_builtins.str]] = None,
            idcs_created_bies: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DomainsIdentitySettingIdcsCreatedByArgs', 'DomainsIdentitySettingIdcsCreatedByArgsDict', 'outputs.DomainsIdentitySettingIdcsCreatedBy']]]]] = None,
            idcs_endpoint: pulumi.Input[Optional[_builtins.str]] = None,
            idcs_last_modified_bies: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DomainsIdentitySettingIdcsLastModifiedByArgs', 'DomainsIdentitySettingIdcsLastModifiedByArgsDict', 'outputs.DomainsIdentitySettingIdcsLastModifiedBy']]]]] = None,
            idcs_last_upgraded_in_release: pulumi.Input[Optional[_builtins.str]] = None,
            idcs_prevented_operations: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            identity_setting_id: pulumi.Input[Optional[_builtins.str]] = None,
            metas: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DomainsIdentitySettingMetaArgs', 'DomainsIdentitySettingMetaArgsDict', 'outputs.DomainsIdentitySettingMeta']]]]] = None,
            my_profile: pulumi.Input[Optional[Union['DomainsIdentitySettingMyProfileArgs', 'DomainsIdentitySettingMyProfileArgsDict', 'outputs.DomainsIdentitySettingMyProfile']]] = None,
            ocid: pulumi.Input[Optional[_builtins.str]] = None,
            posix_gid: pulumi.Input[Optional[Union['DomainsIdentitySettingPosixGidArgs', 'DomainsIdentitySettingPosixGidArgsDict', 'outputs.DomainsIdentitySettingPosixGid']]] = None,
            posix_uid: pulumi.Input[Optional[Union['DomainsIdentitySettingPosixUidArgs', 'DomainsIdentitySettingPosixUidArgsDict', 'outputs.DomainsIdentitySettingPosixUid']]] = None,
            ...
            tenancy_ocid: pulumi.Input[Optional[_builtins.str]] = None,
            tokens: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DomainsIdentitySettingTokenArgs', 'DomainsIdentitySettingTokenArgsDict', 'outputs.DomainsIdentitySettingToken']]]]] = None,
            user_allowed_to_set_recovery_email: pulumi.Input[Optional[_builtins.bool]] = None) -> 'DomainsIdentitySetting':
        """
        ...
        :param pulumi.Input[_builtins.str] external_id: (Updatable) An identifier for the Resource as defined by the Service Consumer. The externalId may simplify identification of the Resource between Service Consumer and Service Provider by allowing the Consumer to refer to the Resource with its own identifier, obviating the need to store a local mapping between the local identifier of the Resource and the identifier used by the Service Provider. Each Resource MAY include a non-empty externalId value. The value of the externalId attribute is always issued by the Service Consumer and can never be specified by the Service Provider. The Service Provider MUST always interpret the externalId as scoped to the Service Consumer's tenant.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[Sequence[pulumi.Input[Union['DomainsIdentitySettingIdcsCreatedByArgs', 'DomainsIdentitySettingIdcsCreatedByArgsDict', 'outputs.DomainsIdentitySettingIdcsCreatedBy']]]] idcs_created_bies: (Updatable) The User or App who created the Resource
               ...
               * type: complex
        :param pulumi.Input[_builtins.str] idcs_endpoint: The basic endpoint for the identity domain
        :param pulumi.Input[Sequence[pulumi.Input[Union['DomainsIdentitySettingIdcsLastModifiedByArgs', 'DomainsIdentitySettingIdcsLastModifiedByArgsDict', 'outputs.DomainsIdentitySettingIdcsLastModifiedBy']]]] idcs_last_modified_bies: (Updatable) The User or App who modified the Resource
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] idcs_prevented_operations: (Updatable) Each value of this attribute specifies an operation that only an internal client may perform on this particular resource.
               ...
               * uniqueness: none
        :param pulumi.Input[_builtins.str] identity_setting_id: ID of the resource
        :param pulumi.Input[Sequence[pulumi.Input[Union['DomainsIdentitySettingMetaArgs', 'DomainsIdentitySettingMetaArgsDict', 'outputs.DomainsIdentitySettingMeta']]]] metas: (Updatable) A complex attribute that contains resource metadata. All sub-attributes are OPTIONAL.
    ...
    @_builtins.property
    @pulumi.getter(name="emitLockedMessageWhenUserIsLocked")
    def emit_locked_message_when_user_is_locked(self) -> pulumi.Output[_builtins.bool]:
        """
        (Updatable) Indicates whether to show the 'user-is-locked' message during authentication if the user is already locked. The default value is false, which tells the system to show a generic 'authentication-failure' message. This is the most secure behavior. If the option is set to true, the system shows a more detailed 'error-message' that says the user is locked. This is more helpful but is less secure, for example, because the difference in error-messages could be used to determine which usernames exist and which do not.
    ...
    @_builtins.property
    @pulumi.getter(name="identitySettingId")
    def identity_setting_id(self) -> pulumi.Output[_builtins.str]:
        """
        ID of the resource
        """
        return pulumi.get(self, "identity_setting_id")
    ...
    @_builtins.property
    @pulumi.getter(name="primaryEmailRequired")
    def primary_email_required(self) -> pulumi.Output[_builtins.bool]:
        """
        (Updatable) Indicates whether the primary email is required.
    ...
    @_builtins.property
    @pulumi.getter(name="removeInvalidEmails")
    def remove_invalid_emails(self) -> pulumi.Output[_builtins.bool]:
        """
        (Updatable) Indicates whether to remove non-RFC5322 compliant emails before creating a user.
    ...
    @_builtins.property
    @pulumi.getter(name="returnInactiveOverLockedMessage")
    def return_inactive_over_locked_message(self) -> pulumi.Output[_builtins.bool]:
        """
        (Updatable) **Added In:** 2302092332
    ...
    @_builtins.property
    @pulumi.getter(name="userAllowedToSetRecoveryEmail")
    def user_allowed_to_set_recovery_email(self) -> pulumi.Output[_builtins.bool]:
        """
        (Updatable) Indicates whether a user is allowed to change their own recovery email.
