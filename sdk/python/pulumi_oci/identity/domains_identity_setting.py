...
class DomainsIdentitySettingArgs:
    def __init__(__self__, *,
                 ...
                 identity_setting_id: pulumi.Input[builtins.str],
                 ...
                 emit_locked_message_when_user_is_locked: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 primary_email_required: Optional[pulumi.Input[builtins.bool]] = None,
                 resource_type_schema_version: Optional[pulumi.Input[builtins.str]] = None,
                 return_inactive_over_locked_message: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 user_allowed_to_set_recovery_email: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] identity_setting_id: ID of the resource
        ...
        :param pulumi.Input['DomainsIdentitySettingPosixUidArgs'] posix_uid: (Updatable) A list of Posix Uid settings.
               ...
               * type: complex
               * uniqueness: none
        :param pulumi.Input[builtins.bool] primary_email_required: (Updatable) Indicates whether the primary email is required.
        ...
        :param pulumi.Input[builtins.bool] return_inactive_over_locked_message: (Updatable) **Added In:** 2302092332
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DomainsIdentitySettingTokenArgs']]] tokens: (Updatable) A list of tokens and their expiry length.
               ...
               * type: complex
               * uniqueness: none
        :param pulumi.Input[builtins.bool] user_allowed_to_set_recovery_email: (Updatable) Indicates whether a user is allowed to change their own recovery email.
    ...
    def identity_setting_id(self) -> pulumi.Input[builtins.str]:
        """
        ID of the resource
        """
    ...
    def identity_setting_id(self, value: pulumi.Input[builtins.str]):
    ...
    def emit_locked_message_when_user_is_locked(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) Indicates whether to show the 'user-is-locked' message during authentication if the user is already locked. The default value is false, which tells the system to show a generic 'authentication-failure' message. This is the most secure behavior. If the option is set to true, the system shows a more detailed 'error-message' that says the user is locked. This is more helpful but is less secure, for example, because the difference in error-messages could be used to determine which usernames exist and which do not.
    ...
    def emit_locked_message_when_user_is_locked(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def primary_email_required(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def primary_email_required(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def return_inactive_over_locked_message(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def return_inactive_over_locked_message(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def user_allowed_to_set_recovery_email(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def user_allowed_to_set_recovery_email(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _DomainsIdentitySettingState:
    def __init__(__self__, *,
                 ...
                 identity_setting_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 posix_uid: Optional[pulumi.Input['DomainsIdentitySettingPosixUidArgs']] = None,
                 primary_email_required: Optional[pulumi.Input[builtins.bool]] = None,
                 remove_invalid_emails: Optional[pulumi.Input[builtins.bool]] = None,
                 resource_type_schema_version: Optional[pulumi.Input[builtins.str]] = None,
                 return_inactive_over_locked_message: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] primary_email_required: (Updatable) Indicates whether the primary email is required.
               ...
               * type: boolean
               * uniqueness: none
        :param pulumi.Input[builtins.bool] remove_invalid_emails: (Updatable) Indicates whether to remove non-RFC5322 compliant emails before creating a user.
    ...
    @property
    @pulumi.getter(name="identitySettingId")
    def identity_setting_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ID of the resource
        """
        return pulumi.get(self, "identity_setting_id")
    ...
    @identity_setting_id.setter
    def identity_setting_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "identity_setting_id", value)
    ...
    def remove_invalid_emails(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def remove_invalid_emails(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class DomainsIdentitySetting(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tenancy_ocid: Optional[pulumi.Input[builtins.str]] = None,
            tokens: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DomainsIdentitySettingTokenArgs', 'DomainsIdentitySettingTokenArgsDict']]]]] = None,
            user_allowed_to_set_recovery_email: Optional[pulumi.Input[builtins.bool]] = None) -> 'DomainsIdentitySetting':
        """
    ...
    @property
    @pulumi.getter(name="emitLockedMessageWhenUserIsLocked")
    def emit_locked_message_when_user_is_locked(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Indicates whether to show the 'user-is-locked' message during authentication if the user is already locked. The default value is false, which tells the system to show a generic 'authentication-failure' message. This is the most secure behavior. If the option is set to true, the system shows a more detailed 'error-message' that says the user is locked. This is more helpful but is less secure, for example, because the difference in error-messages could be used to determine which usernames exist and which do not.
    ...
    @property
    @pulumi.getter(name="identitySettingId")
    def identity_setting_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the resource
        """
        return pulumi.get(self, "identity_setting_id")
    ...
    @property
    @pulumi.getter(name="primaryEmailRequired")
    def primary_email_required(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Indicates whether the primary email is required.
    ...
    @property
    @pulumi.getter(name="removeInvalidEmails")
    def remove_invalid_emails(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Indicates whether to remove non-RFC5322 compliant emails before creating a user.
    ...
    @property
    @pulumi.getter(name="returnInactiveOverLockedMessage")
    def return_inactive_over_locked_message(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) **Added In:** 2302092332
    ...
    @property
    @pulumi.getter(name="userAllowedToSetRecoveryEmail")
    def user_allowed_to_set_recovery_email(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Indicates whether a user is allowed to change their own recovery email.
