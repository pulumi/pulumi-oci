...
class DomainsKmsiSettingArgs:
    def __init__(__self__, *,
                 ...
                 kmsi_setting_id: pulumi.Input[builtins.str],
                 ...
                 kmsi_feature_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 kmsi_prompt_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 last_enabled_on: Optional[pulumi.Input[builtins.str]] = None,
                 last_used_validity_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 max_allowed_sessions: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 token_validity_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 tou_prompt_disabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] kmsi_setting_id: ID of the resource
        ...
        :param pulumi.Input[builtins.str] external_id: (Updatable) An identifier for the Resource as defined by the Service Consumer. The externalId may simplify identification of the Resource between Service Consumer and Service Provider by allowing the Consumer to refer to the Resource with its own identifier, obviating the need to store a local mapping between the local identifier of the Resource and the identifier used by the Service Provider. Each Resource MAY include a non-empty externalId value. The value of the externalId attribute is always issued by the Service Consumer and can never be specified by the Service Provider. The Service Provider MUST always interpret the externalId as scoped to the Service Consumer's tenant.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[builtins.bool] kmsi_feature_enabled: (Updatable) Identifier represents KMSI feature is enabled or not.
               ...
               * type: boolean
               * uniqueness: none
        :param pulumi.Input[builtins.bool] kmsi_prompt_enabled: (Updatable) Identifier represents KMSI to be prompted to user or not.
               ...
               * type: boolean
               * uniqueness: none
        :param pulumi.Input[builtins.str] last_enabled_on: (Updatable) Timestamp of when the KmsiSettings was enabled last time.
               ...
               * type: dateTime
               * uniqueness: none
        :param pulumi.Input[builtins.int] last_used_validity_in_days: (Updatable) Identifier represents duration in days within which kmsi token must be used.
               ...
               * idcsMinValue: 1
               * uniqueness: none
        :param pulumi.Input[builtins.int] max_allowed_sessions: (Updatable) Identifier represents maximum KMSI sessions allowed in the system.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DomainsKmsiSettingTagArgs']]] tags: (Updatable) A list of tags on this resource.
               ...
               * type: complex
               * uniqueness: none
        :param pulumi.Input[builtins.int] token_validity_in_days: (Updatable) Identifier represents validity duration in days.
               ...
               * idcsMinValue: 1
               * uniqueness: none
        :param pulumi.Input[builtins.bool] tou_prompt_disabled: (Updatable) Identifier represents whether user is prompted for ToU or not.
    ...
    def kmsi_setting_id(self) -> pulumi.Input[builtins.str]:
        """
        ID of the resource
        """
    ...
    def kmsi_setting_id(self, value: pulumi.Input[builtins.str]):
    ...
    def kmsi_feature_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def kmsi_feature_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "kmsi_feature_enabled", value)

    @property
    @pulumi.getter(name="kmsiPromptEnabled")
    def kmsi_prompt_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def kmsi_prompt_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "kmsi_prompt_enabled", value)

    @property
    @pulumi.getter(name="lastEnabledOn")
    def last_enabled_on(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_enabled_on(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "last_enabled_on", value)

    @property
    @pulumi.getter(name="lastUsedValidityInDays")
    def last_used_validity_in_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def last_used_validity_in_days(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "last_used_validity_in_days", value)

    @property
    @pulumi.getter(name="maxAllowedSessions")
    def max_allowed_sessions(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_allowed_sessions(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def token_validity_in_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def token_validity_in_days(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "token_validity_in_days", value)

    @property
    @pulumi.getter(name="touPromptDisabled")
    def tou_prompt_disabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def tou_prompt_disabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _DomainsKmsiSettingState:
    def __init__(__self__, *,
                 ...
                 kmsi_feature_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 kmsi_prompt_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 kmsi_setting_id: Optional[pulumi.Input[builtins.str]] = None,
                 last_enabled_on: Optional[pulumi.Input[builtins.str]] = None,
                 last_used_validity_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 max_allowed_sessions: Optional[pulumi.Input[builtins.int]] = None,
    ...
    @property
    @pulumi.getter(name="kmsiSettingId")
    def kmsi_setting_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ID of the resource
        """
        return pulumi.get(self, "kmsi_setting_id")
    ...
    @kmsi_setting_id.setter
    def kmsi_setting_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "kmsi_setting_id", value)
...
class DomainsKmsiSetting(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tenancy_ocid: Optional[pulumi.Input[builtins.str]] = None,
            token_validity_in_days: Optional[pulumi.Input[builtins.int]] = None,
            tou_prompt_disabled: Optional[pulumi.Input[builtins.bool]] = None) -> 'DomainsKmsiSetting':
        """
    ...
    @property
    @pulumi.getter(name="kmsiFeatureEnabled")
    def kmsi_feature_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Identifier represents KMSI feature is enabled or not.
    ...
    @property
    @pulumi.getter(name="kmsiPromptEnabled")
    def kmsi_prompt_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Identifier represents KMSI to be prompted to user or not.
    ...
    @property
    @pulumi.getter(name="kmsiSettingId")
    def kmsi_setting_id(self) -> pulumi.Output[builtins.str]:
        """
        ID of the resource
        """
        return pulumi.get(self, "kmsi_setting_id")
    ...
    @property
    @pulumi.getter(name="lastEnabledOn")
    def last_enabled_on(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Timestamp of when the KmsiSettings was enabled last time.
    ...
    @property
    @pulumi.getter(name="lastUsedValidityInDays")
    def last_used_validity_in_days(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) Identifier represents duration in days within which kmsi token must be used.
    ...
    @property
    @pulumi.getter(name="maxAllowedSessions")
    def max_allowed_sessions(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) Identifier represents maximum KMSI sessions allowed in the system.
    ...
    @property
    @pulumi.getter(name="tokenValidityInDays")
    def token_validity_in_days(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) Identifier represents validity duration in days.
    ...
    @property
    @pulumi.getter(name="touPromptDisabled")
    def tou_prompt_disabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Identifier represents whether user is prompted for ToU or not.
