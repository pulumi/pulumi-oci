...
class DomainsMyAuthToken(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a DomainsMyAuthToken resource with the given unique name, props, and options.
    ...
    @property
    @pulumi.getter(name="idcsCreatedBies")
    def idcs_created_bies(self) -> pulumi.Output[Optional[Sequence['outputs.DomainsMyAuthTokenIdcsCreatedBy']]]:
        return pulumi.get(self, "idcs_created_bies")
    ...
    @property
    @pulumi.getter(name="idcsLastModifiedBies")
    def idcs_last_modified_bies(self) -> pulumi.Output[Optional[Sequence['outputs.DomainsMyAuthTokenIdcsLastModifiedBy']]]:
        return pulumi.get(self, "idcs_last_modified_bies")
    ...
    @property
    @pulumi.getter
    def metas(self) -> pulumi.Output[Optional[Sequence['outputs.DomainsMyAuthTokenMeta']]]:
        return pulumi.get(self, "metas")
    ...
    @property
    @pulumi.getter
    def tags(self) -> pulumi.Output[Optional[Sequence['outputs.DomainsMyAuthTokenTag']]]:
        return pulumi.get(self, "tags")
    ...
    @property
    @pulumi.getter
    def user(self) -> pulumi.Output[Optional['outputs.DomainsMyAuthTokenUser']]:
        return pulumi.get(self, "user")
