...
class DomainsMyRequestArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] justification: justification
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] schemas: REQUIRED. The schemas attribute is an array of Strings which allows introspection of the supported schema version for a SCIM representation as well any schema extensions supported by that representation. Each String value must be a unique URI. This specification defines URIs for User, Group, and a standard \\"enterprise\\" extension. All representations of SCIM schema MUST include a non-zero value array with value(s) of the URIs supported by that representation. Duplicate values MUST NOT be included. Value order is not specified and MUST not impact behavior.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[builtins.str] action: Requestor can set action to CANCEL to cancel the request or to ESCALATE to escalate the request while the request status is IN_PROGRESS. Requestor can't escalate the request if canceling or escalation is in progress.
...
class _DomainsMyRequestState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] domain_ocid: (Updatable) Oracle Cloud Infrastructure Domain Id (ocid) in which the resource lives.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[builtins.str] expires: (Updatable) Time by when Request expires
    ...
    @property
    @pulumi.getter
    def expires(self) -> Optional[pulumi.Input[builtins.str]]:
        """
...
class DomainsMyRequest(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status: Optional[pulumi.Input[builtins.str]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DomainsMyRequestTagArgs', 'DomainsMyRequestTagArgsDict']]]]] = None,
            tenancy_ocid: Optional[pulumi.Input[builtins.str]] = None) -> 'DomainsMyRequest':
        """
    ...
    @property
    @pulumi.getter
    def expires(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Time by when Request expires
