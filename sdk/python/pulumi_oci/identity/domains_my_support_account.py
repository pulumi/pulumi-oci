...
class DomainsMySupportAccountArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] schemas: REQUIRED. The schemas attribute is an array of Strings which allows introspection of the supported schema version for a SCIM representation as well any schema extensions supported by that representation. Each String value must be a unique URI. This specification defines URIs for User, Group, and a standard \\"enterprise\\" extension. All representations of SCIM schema MUST include a non-zero value array with value(s) of the URIs supported by that representation. Duplicate values MUST NOT be included. Value order is not specified and MUST not impact behavior.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[str] token: User Support Account Token
...
class _DomainsMySupportAccountState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DomainsMySupportAccountMetaArgs']]] metas: (Updatable) A complex attribute that contains resource metadata. All sub-attributes are OPTIONAL.
               ...
               * type: complex
        :param pulumi.Input[str] my_support_account_provider: (Updatable) User Support Account Provider
    ...
    def _configure(
        ...
        if my_support_account_provider is None and 'mySupportAccountProvider' in kwargs:
            my_support_account_provider = kwargs['mySupportAccountProvider']
        if resource_type_schema_version is None and 'resourceTypeSchemaVersion' in kwargs:
            resource_type_schema_version = kwargs['resourceTypeSchemaVersion']
...
class DomainsMySupportAccount(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] schemas: REQUIRED. The schemas attribute is an array of Strings which allows introspection of the supported schema version for a SCIM representation as well any schema extensions supported by that representation. Each String value must be a unique URI. This specification defines URIs for User, Group, and a standard \\"enterprise\\" extension. All representations of SCIM schema MUST include a non-zero value array with value(s) of the URIs supported by that representation. Duplicate values MUST NOT be included. Value order is not specified and MUST not impact behavior.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DomainsMySupportAccountTagArgs']]]] tags: A list of tags on this resource.
        ...
        :param pulumi.Input[str] token: User Support Account Token
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[pulumi.InputType['DomainsMySupportAccountUserArgs']] user: User linked to Support Account
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            user = _utilities.configure(user, DomainsMySupportAccountUserArgs, True)
    ...
    def get(resource_name: str,
        ...
        :param pulumi.Input[str] domain_ocid: (Updatable) Oracle Cloud Infrastructure Domain Id (ocid) in which the resource lives.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DomainsMySupportAccountIdcsCreatedByArgs']]]] idcs_created_bies: (Updatable) The User or App who created the Resource
               ...
               * type: complex
        :param pulumi.Input[str] idcs_endpoint: The basic endpoint for the identity domain
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DomainsMySupportAccountIdcsLastModifiedByArgs']]]] idcs_last_modified_bies: (Updatable) The User or App who modified the Resource
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] idcs_prevented_operations: (Updatable) Each value of this attribute specifies an operation that only an internal client may perform on this particular resource.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[Sequence[pulumi.Input[pulumi.InputType['DomainsMySupportAccountMetaArgs']]]] metas: (Updatable) A complex attribute that contains resource metadata. All sub-attributes are OPTIONAL.
    ...
    @property
    @pulumi.getter(name="mySupportAccountProvider")
    def my_support_account_provider(self) -> pulumi.Output[str]:
        """
        (Updatable) User Support Account Provider
