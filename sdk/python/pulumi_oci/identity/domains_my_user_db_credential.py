...
class DomainsMyUserDbCredentialArgs:
    def __init__(__self__, *,
                 db_password: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] db_password: The user's database password.
        ...
        :param pulumi.Input[builtins.str] description: Description
               ...
               * required: false
               * returned: default
        :param pulumi.Input[builtins.str] expires_on: When the user credential expires.
        ...
        :param pulumi.Input[builtins.str] status: User credential status
    ...
    def db_password(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @db_password.setter
    def db_password(self, value: pulumi.Input[builtins.str]):
...
class _DomainsMyUserDbCredentialState:
    def __init__(__self__, *,
                 ...
                 db_password: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 last_set_date: Optional[pulumi.Input[builtins.str]] = None,
                 metas: Optional[pulumi.Input[Sequence[pulumi.Input['DomainsMyUserDbCredentialMetaArgs']]]] = None,
                 mixed_db_password: Optional[pulumi.Input[builtins.str]] = None,
                 mixed_salt: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] domain_ocid: (Updatable) Oracle Cloud Infrastructure Domain Id (ocid) in which the resource lives.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[builtins.bool] expired: (Updatable) Indicates that the database password has expired.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] idcs_prevented_operations: (Updatable) Each value of this attribute specifies an operation that only an internal client may perform on this particular resource.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[builtins.str] last_set_date: (Updatable) A DateTime that specifies the date and time when the current database password was set.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DomainsMyUserDbCredentialMetaArgs']]] metas: (Updatable) A complex attribute that contains resource metadata. All sub-attributes are OPTIONAL.
               ...
               * type: complex
        :param pulumi.Input[builtins.str] mixed_db_password: (Updatable) The user's database password with mixed salt.
               ...
               * returned: default
               * required: false
        :param pulumi.Input[builtins.str] mixed_salt: (Updatable) The mixed salt of the password.
               ...
               * returned: default
               * required: false
        :param pulumi.Input[builtins.str] name: (Updatable) Name
        ...
        :param pulumi.Input[builtins.str] ocid: Unique Oracle Cloud Infrastructure identifier for the SCIM Resource.
               ...
               * uniqueness: global
        :param pulumi.Input[builtins.str] resource_type_schema_version: An endpoint-specific schema version number to use in the Request. Allowed version values are Earliest Version or Latest Version as specified in each REST API endpoint description, or any sequential number inbetween. All schema attributes/body parameters are a part of version 1. After version 1, any attributes added or deprecated will be tagged with the version that they were added to or deprecated in. If no version is provided, the latest schema version is returned.
        :param pulumi.Input[builtins.str] salt: (Updatable) The salt of the password.
    ...
    @property
    @pulumi.getter(name="dbPassword")
    def db_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The user's database password.
    ...
    @db_password.setter
    def db_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "db_password", value)
    ...
    def last_set_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_set_date(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def mixed_db_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def mixed_db_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mixed_db_password", value)

    @property
    @pulumi.getter(name="mixedSalt")
    def mixed_salt(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @mixed_salt.setter
    def mixed_salt(self, value: Optional[pulumi.Input[builtins.str]]):
...
@pulumi.type_token("oci:Identity/domainsMyUserDbCredential:DomainsMyUserDbCredential")
class DomainsMyUserDbCredential(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="dbPassword")
    def db_password(self) -> pulumi.Output[builtins.str]:
        """
        The user's database password.
    ...
    @property
    @pulumi.getter
    def expired(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Indicates that the database password has expired.
    ...
    @property
    @pulumi.getter(name="lastSetDate")
    def last_set_date(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) A DateTime that specifies the date and time when the current database password was set.
    ...
    @property
    @pulumi.getter(name="mixedDbPassword")
    def mixed_db_password(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The user's database password with mixed salt.
    ...
    @property
    @pulumi.getter(name="mixedSalt")
    def mixed_salt(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The mixed salt of the password.
