...
class DomainsNetworkPerimeterArgs:
    def __init__(__self__, *,
                 ...
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsNetworkPerimeterTagArgs']]]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] description: (Updatable) NetworkPerimeter Description
        ...
        :param pulumi.Input[_builtins.str] external_id: (Updatable) An identifier for the Resource as defined by the Service Consumer. The externalId may simplify identification of the Resource between Service Consumer and Service provider by allowing the Consumer to refer to the Resource with its own identifier, obviating the need to store a local mapping between the local identifier of the Resource and the identifier used by the Service Provider. Each Resource MAY include a non-empty externalId value.  The value of the externalId attribute is always issued be the Service Consumer and can never be specified by the Service Provider. The Service Provider MUST always interpret the externalId as scoped to the Service Consumer's tenant.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[_builtins.str] name: (Updatable) NetworkPerimeter name
    ...
    @_builtins.property
    @pulumi.getter
    def tags(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DomainsNetworkPerimeterTagArgs']]]]:
        """
    ...
    @tags.setter
    def tags(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsNetworkPerimeterTagArgs']]]]):
...
class _DomainsNetworkPerimeterState:
    def __init__(__self__, *,
                 ...
                 external_id: pulumi.Input[Optional[_builtins.str]] = None,
                 idcs_created_bies: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsNetworkPerimeterIdcsCreatedByArgs']]]] = None,
                 idcs_endpoint: pulumi.Input[Optional[_builtins.str]] = None,
                 idcs_last_modified_bies: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsNetworkPerimeterIdcsLastModifiedByArgs']]]] = None,
                 ...
                 ip_addresses: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsNetworkPerimeterIpAddressArgs']]]] = None,
                 metas: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsNetworkPerimeterMetaArgs']]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 ocid: pulumi.Input[Optional[_builtins.str]] = None,
                 resource_type_schema_version: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def idcs_created_bies(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DomainsNetworkPerimeterIdcsCreatedByArgs']]]]:
        """
    ...
    def idcs_created_bies(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsNetworkPerimeterIdcsCreatedByArgs']]]]):
    ...
    def idcs_last_modified_bies(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DomainsNetworkPerimeterIdcsLastModifiedByArgs']]]]:
        """
    ...
    def idcs_last_modified_bies(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsNetworkPerimeterIdcsLastModifiedByArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter(name="ipAddresses")
    def ip_addresses(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DomainsNetworkPerimeterIpAddressArgs']]]]:
        """
        (Updatable) IPAddresses or Ranges assigned to the NetworkPerimeter
    ...
    @ip_addresses.setter
    def ip_addresses(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsNetworkPerimeterIpAddressArgs']]]]):
        pulumi.set(self, "ip_addresses", value)

    @_builtins.property
    @pulumi.getter
    def metas(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DomainsNetworkPerimeterMetaArgs']]]]:
        """
    ...
    @metas.setter
    def metas(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsNetworkPerimeterMetaArgs']]]]):
...
class DomainsNetworkPerimeter(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 external_id: pulumi.Input[Optional[_builtins.str]] = None,
                 idcs_endpoint: pulumi.Input[Optional[_builtins.str]] = None,
                 ip_addresses: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DomainsNetworkPerimeterIpAddressArgs', 'DomainsNetworkPerimeterIpAddressArgsDict', 'outputs.DomainsNetworkPerimeterIpAddress']]]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 ocid: pulumi.Input[Optional[_builtins.str]] = None,
                 resource_type_schema_version: pulumi.Input[Optional[_builtins.str]] = None,
                 schemas: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DomainsNetworkPerimeterTagArgs', 'DomainsNetworkPerimeterTagArgsDict', 'outputs.DomainsNetworkPerimeterTag']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] external_id: (Updatable) An identifier for the Resource as defined by the Service Consumer. The externalId may simplify identification of the Resource between Service Consumer and Service provider by allowing the Consumer to refer to the Resource with its own identifier, obviating the need to store a local mapping between the local identifier of the Resource and the identifier used by the Service Provider. Each Resource MAY include a non-empty externalId value.  The value of the externalId attribute is always issued be the Service Consumer and can never be specified by the Service Provider. The Service Provider MUST always interpret the externalId as scoped to the Service Consumer's tenant.
               ...
               * uniqueness: none
        :param pulumi.Input[_builtins.str] idcs_endpoint: The basic endpoint for the identity domain
        :param pulumi.Input[Sequence[pulumi.Input[Union['DomainsNetworkPerimeterIpAddressArgs', 'DomainsNetworkPerimeterIpAddressArgsDict', 'outputs.DomainsNetworkPerimeterIpAddress']]]] ip_addresses: (Updatable) IPAddresses or Ranges assigned to the NetworkPerimeter
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] schemas: (Updatable) REQUIRED. The schemas attribute is an array of Strings which allows introspection of the supported schema version for a SCIM representation as well any schema extensions supported by that representation. Each String value must be a unique URI. This specification defines URIs for User, Group, and a standard \\"enterprise\\" extension. All representations of SCIM schema MUST include a non-zero value array with value(s) of the URIs supported by that representation. Duplicate values MUST NOT be included. Value order is not specified and MUST not impact behavior.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[Sequence[pulumi.Input[Union['DomainsNetworkPerimeterTagArgs', 'DomainsNetworkPerimeterTagArgsDict', 'outputs.DomainsNetworkPerimeterTag']]]] tags: (Updatable) A list of tags on this resource.
    ...
    def get(resource_name: str,
            ...
            domain_ocid: pulumi.Input[Optional[_builtins.str]] = None,
            external_id: pulumi.Input[Optional[_builtins.str]] = None,
            idcs_created_bies: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DomainsNetworkPerimeterIdcsCreatedByArgs', 'DomainsNetworkPerimeterIdcsCreatedByArgsDict', 'outputs.DomainsNetworkPerimeterIdcsCreatedBy']]]]] = None,
            idcs_endpoint: pulumi.Input[Optional[_builtins.str]] = None,
            idcs_last_modified_bies: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DomainsNetworkPerimeterIdcsLastModifiedByArgs', 'DomainsNetworkPerimeterIdcsLastModifiedByArgsDict', 'outputs.DomainsNetworkPerimeterIdcsLastModifiedBy']]]]] = None,
            idcs_last_upgraded_in_release: pulumi.Input[Optional[_builtins.str]] = None,
            idcs_prevented_operations: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            ip_addresses: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DomainsNetworkPerimeterIpAddressArgs', 'DomainsNetworkPerimeterIpAddressArgsDict', 'outputs.DomainsNetworkPerimeterIpAddress']]]]] = None,
            metas: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DomainsNetworkPerimeterMetaArgs', 'DomainsNetworkPerimeterMetaArgsDict', 'outputs.DomainsNetworkPerimeterMeta']]]]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            ocid: pulumi.Input[Optional[_builtins.str]] = None,
            resource_type_schema_version: pulumi.Input[Optional[_builtins.str]] = None,
            schemas: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            tags: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DomainsNetworkPerimeterTagArgs', 'DomainsNetworkPerimeterTagArgsDict', 'outputs.DomainsNetworkPerimeterTag']]]]] = None,
            tenancy_ocid: pulumi.Input[Optional[_builtins.str]] = None) -> 'DomainsNetworkPerimeter':
        """
        ...
        :param pulumi.Input[_builtins.str] external_id: (Updatable) An identifier for the Resource as defined by the Service Consumer. The externalId may simplify identification of the Resource between Service Consumer and Service provider by allowing the Consumer to refer to the Resource with its own identifier, obviating the need to store a local mapping between the local identifier of the Resource and the identifier used by the Service Provider. Each Resource MAY include a non-empty externalId value.  The value of the externalId attribute is always issued be the Service Consumer and can never be specified by the Service Provider. The Service Provider MUST always interpret the externalId as scoped to the Service Consumer's tenant.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[Sequence[pulumi.Input[Union['DomainsNetworkPerimeterIdcsCreatedByArgs', 'DomainsNetworkPerimeterIdcsCreatedByArgsDict', 'outputs.DomainsNetworkPerimeterIdcsCreatedBy']]]] idcs_created_bies: (Updatable) The User or App who created the Resource
               ...
               * type: complex
        :param pulumi.Input[_builtins.str] idcs_endpoint: The basic endpoint for the identity domain
        :param pulumi.Input[Sequence[pulumi.Input[Union['DomainsNetworkPerimeterIdcsLastModifiedByArgs', 'DomainsNetworkPerimeterIdcsLastModifiedByArgsDict', 'outputs.DomainsNetworkPerimeterIdcsLastModifiedBy']]]] idcs_last_modified_bies: (Updatable) The User or App who modified the Resource
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['DomainsNetworkPerimeterIpAddressArgs', 'DomainsNetworkPerimeterIpAddressArgsDict', 'outputs.DomainsNetworkPerimeterIpAddress']]]] ip_addresses: (Updatable) IPAddresses or Ranges assigned to the NetworkPerimeter
               ...
               * type: complex
               * uniqueness: none
        :param pulumi.Input[Sequence[pulumi.Input[Union['DomainsNetworkPerimeterMetaArgs', 'DomainsNetworkPerimeterMetaArgsDict', 'outputs.DomainsNetworkPerimeterMeta']]]] metas: (Updatable) A complex attribute that contains resource metadata. All sub-attributes are OPTIONAL.
