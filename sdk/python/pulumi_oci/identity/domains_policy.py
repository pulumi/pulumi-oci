...
__all__ = ['DomainsPolicyArgs', 'DomainsPolicy']

@pulumi.input_type
class DomainsPolicyArgs:
    def __init__(__self__, *,
                 idcs_endpoint: pulumi.Input[_builtins.str],
                 policy_type: pulumi.Input['DomainsPolicyPolicyTypeArgs'],
                 ...
                 policy_groovy: pulumi.Input[Optional[_builtins.str]] = None,
                 resource_type_schema_version: pulumi.Input[Optional[_builtins.str]] = None,
                 rules: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsPolicyRuleArgs']]]] = None,
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsPolicyTagArgs']]]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] description: (Updatable) Policy Description
        ...
        :param pulumi.Input[_builtins.str] external_id: (Updatable) An identifier for the Resource as defined by the Service Consumer. The externalId may simplify identification of the Resource between Service Consumer and Service provider by allowing the Consumer to refer to the Resource with its own identifier, obviating the need to store a local mapping between the local identifier of the Resource and the identifier used by the Service Provider. Each Resource MAY include a non-empty externalId value.  The value of the externalId attribute is always issued be the Service Consumer and can never be specified by the Service Provider. The Service Provider MUST always interpret the externalId as scoped to the Service Consumer's tenant.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[_builtins.str] name: (Updatable) Policy name
        ...
        :param pulumi.Input[_builtins.str] ocid: (Updatable) Unique Oracle Cloud Infrastructure identifier for the SCIM Resource.
               ...
               * type: string
               * uniqueness: global
        :param pulumi.Input[_builtins.str] policy_groovy: (Updatable) The Groovy script that is run instead of the policy, if the policy type allows the policy to be a Groovy script.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['DomainsPolicyRuleArgs']]] rules: (Updatable) Rules assigned to this policy
               ...
               * type: complex
               * uniqueness: none
        :param pulumi.Input[Sequence[pulumi.Input['DomainsPolicyTagArgs']]] tags: (Updatable) A list of tags on this resource.
    ...
    def policy_type(self) -> pulumi.Input['DomainsPolicyPolicyTypeArgs']:
        """
    ...
    @policy_type.setter
    def policy_type(self, value: pulumi.Input['DomainsPolicyPolicyTypeArgs']):
    ...
    def policy_groovy(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def policy_groovy(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "policy_groovy", value)
    ...
    @_builtins.property
    @pulumi.getter
    def rules(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DomainsPolicyRuleArgs']]]]:
        """
    ...
    @rules.setter
    def rules(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsPolicyRuleArgs']]]]):
        pulumi.set(self, "rules", value)

    @_builtins.property
    @pulumi.getter
    def tags(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DomainsPolicyTagArgs']]]]:
        """
    ...
    @tags.setter
    def tags(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsPolicyTagArgs']]]]):
        pulumi.set(self, "tags", value)


@pulumi.input_type
class _DomainsPolicyState:
    def __init__(__self__, *,
                 active: pulumi.Input[Optional[_builtins.bool]] = None,
                 attribute_sets: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 attributes: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 external_id: pulumi.Input[Optional[_builtins.str]] = None,
                 idcs_created_bies: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsPolicyIdcsCreatedByArgs']]]] = None,
                 idcs_endpoint: pulumi.Input[Optional[_builtins.str]] = None,
                 idcs_last_modified_bies: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsPolicyIdcsLastModifiedByArgs']]]] = None,
                 ...
                 metas: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsPolicyMetaArgs']]]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 ocid: pulumi.Input[Optional[_builtins.str]] = None,
                 policy_groovy: pulumi.Input[Optional[_builtins.str]] = None,
                 policy_type: pulumi.Input[Optional['DomainsPolicyPolicyTypeArgs']] = None,
                 resource_type_schema_version: pulumi.Input[Optional[_builtins.str]] = None,
                 rules: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsPolicyRuleArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] external_id: (Updatable) An identifier for the Resource as defined by the Service Consumer. The externalId may simplify identification of the Resource between Service Consumer and Service provider by allowing the Consumer to refer to the Resource with its own identifier, obviating the need to store a local mapping between the local identifier of the Resource and the identifier used by the Service Provider. Each Resource MAY include a non-empty externalId value.  The value of the externalId attribute is always issued be the Service Consumer and can never be specified by the Service Provider. The Service Provider MUST always interpret the externalId as scoped to the Service Consumer's tenant.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[Sequence[pulumi.Input['DomainsPolicyIdcsCreatedByArgs']]] idcs_created_bies: (Updatable) The User or App who created the Resource
               ...
               * type: complex
        :param pulumi.Input[_builtins.str] idcs_endpoint: The basic endpoint for the identity domain
        :param pulumi.Input[Sequence[pulumi.Input['DomainsPolicyIdcsLastModifiedByArgs']]] idcs_last_modified_bies: (Updatable) The User or App who modified the Resource
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] idcs_prevented_operations: (Updatable) Each value of this attribute specifies an operation that only an internal client may perform on this particular resource.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[Sequence[pulumi.Input['DomainsPolicyMetaArgs']]] metas: (Updatable) A complex attribute that contains resource metadata. All sub-attributes are OPTIONAL.
    ...
    def idcs_created_bies(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DomainsPolicyIdcsCreatedByArgs']]]]:
        """
    ...
    def idcs_created_bies(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsPolicyIdcsCreatedByArgs']]]]):
    ...
    def idcs_last_modified_bies(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DomainsPolicyIdcsLastModifiedByArgs']]]]:
        """
    ...
    def idcs_last_modified_bies(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsPolicyIdcsLastModifiedByArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def metas(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['DomainsPolicyMetaArgs']]]]:
        """
    ...
    @metas.setter
    def metas(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['DomainsPolicyMetaArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter(name="policyType")
    def policy_type(self) -> pulumi.Input[Optional['DomainsPolicyPolicyTypeArgs']]:
        """
        (Updatable) PolicyType on which the policy is based
    ...
    @policy_type.setter
    def policy_type(self, value: pulumi.Input[Optional['DomainsPolicyPolicyTypeArgs']]):
        pulumi.set(self, "policy_type", value)
...
@pulumi.type_token("oci:Identity/domainsPolicy:DomainsPolicy")
class DomainsPolicy(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 ocid: pulumi.Input[Optional[_builtins.str]] = None,
                 policy_groovy: pulumi.Input[Optional[_builtins.str]] = None,
                 policy_type: pulumi.Input[Optional[Union['DomainsPolicyPolicyTypeArgs', 'DomainsPolicyPolicyTypeArgsDict', 'outputs.DomainsPolicyPolicyType']]] = None,
                 resource_type_schema_version: pulumi.Input[Optional[_builtins.str]] = None,
                 rules: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DomainsPolicyRuleArgs', 'DomainsPolicyRuleArgsDict', 'outputs.DomainsPolicyRule']]]]] = None,
                 schemas: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 tags: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DomainsPolicyTagArgs', 'DomainsPolicyTagArgsDict', 'outputs.DomainsPolicyTag']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] policy_groovy: (Updatable) The Groovy script that is run instead of the policy, if the policy type allows the policy to be a Groovy script.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[Union['DomainsPolicyPolicyTypeArgs', 'DomainsPolicyPolicyTypeArgsDict', 'outputs.DomainsPolicyPolicyType']] policy_type: (Updatable) PolicyType on which the policy is based
               ...
               * uniqueness: none
        :param pulumi.Input[_builtins.str] resource_type_schema_version: (Updatable) An endpoint-specific schema version number to use in the Request. Allowed version values are Earliest Version or Latest Version as specified in each REST API endpoint description, or any sequential number inbetween. All schema attributes/body parameters are a part of version 1. After version 1, any attributes added or deprecated will be tagged with the version that they were added to or deprecated in. If no version is provided, the latest schema version is returned.
        :param pulumi.Input[Sequence[pulumi.Input[Union['DomainsPolicyRuleArgs', 'DomainsPolicyRuleArgsDict', 'outputs.DomainsPolicyRule']]]] rules: (Updatable) Rules assigned to this policy
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] schemas: (Updatable) REQUIRED. The schemas attribute is an array of Strings which allows introspection of the supported schema version for a SCIM representation as well any schema extensions supported by that representation. Each String value must be a unique URI. This specification defines URIs for User, Group, and a standard \\"enterprise\\" extension. All representations of SCIM schema MUST include a non-zero value array with value(s) of the URIs supported by that representation. Duplicate values MUST NOT be included. Value order is not specified and MUST not impact behavior.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[Sequence[pulumi.Input[Union['DomainsPolicyTagArgs', 'DomainsPolicyTagArgsDict', 'outputs.DomainsPolicyTag']]]] tags: (Updatable) A list of tags on this resource.
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DomainsPolicyArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DomainsPolicyArgs.__new__(DomainsPolicyArgs)
            ...
            __props__.__dict__["policy_groovy"] = policy_groovy
        ...
        super(DomainsPolicy, __self__).__init__(
            'oci:Identity/domainsPolicy:DomainsPolicy',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            domain_ocid: pulumi.Input[Optional[_builtins.str]] = None,
            external_id: pulumi.Input[Optional[_builtins.str]] = None,
            idcs_created_bies: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DomainsPolicyIdcsCreatedByArgs', 'DomainsPolicyIdcsCreatedByArgsDict', 'outputs.DomainsPolicyIdcsCreatedBy']]]]] = None,
            idcs_endpoint: pulumi.Input[Optional[_builtins.str]] = None,
            idcs_last_modified_bies: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DomainsPolicyIdcsLastModifiedByArgs', 'DomainsPolicyIdcsLastModifiedByArgsDict', 'outputs.DomainsPolicyIdcsLastModifiedBy']]]]] = None,
            idcs_last_upgraded_in_release: pulumi.Input[Optional[_builtins.str]] = None,
            idcs_prevented_operations: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            metas: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DomainsPolicyMetaArgs', 'DomainsPolicyMetaArgsDict', 'outputs.DomainsPolicyMeta']]]]] = None,
            name: pulumi.Input[Optional[_builtins.str]] = None,
            ocid: pulumi.Input[Optional[_builtins.str]] = None,
            policy_groovy: pulumi.Input[Optional[_builtins.str]] = None,
            policy_type: pulumi.Input[Optional[Union['DomainsPolicyPolicyTypeArgs', 'DomainsPolicyPolicyTypeArgsDict', 'outputs.DomainsPolicyPolicyType']]] = None,
            ...
            schemas: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            tags: pulumi.Input[Optional[Sequence[pulumi.Input[Union['DomainsPolicyTagArgs', 'DomainsPolicyTagArgsDict', 'outputs.DomainsPolicyTag']]]]] = None,
            tenancy_ocid: pulumi.Input[Optional[_builtins.str]] = None) -> 'DomainsPolicy':
        """
        ...
        :param pulumi.Input[_builtins.str] external_id: (Updatable) An identifier for the Resource as defined by the Service Consumer. The externalId may simplify identification of the Resource between Service Consumer and Service provider by allowing the Consumer to refer to the Resource with its own identifier, obviating the need to store a local mapping between the local identifier of the Resource and the identifier used by the Service Provider. Each Resource MAY include a non-empty externalId value.  The value of the externalId attribute is always issued be the Service Consumer and can never be specified by the Service Provider. The Service Provider MUST always interpret the externalId as scoped to the Service Consumer's tenant.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[Sequence[pulumi.Input[Union['DomainsPolicyIdcsCreatedByArgs', 'DomainsPolicyIdcsCreatedByArgsDict', 'outputs.DomainsPolicyIdcsCreatedBy']]]] idcs_created_bies: (Updatable) The User or App who created the Resource
               ...
               * type: complex
        :param pulumi.Input[_builtins.str] idcs_endpoint: The basic endpoint for the identity domain
        :param pulumi.Input[Sequence[pulumi.Input[Union['DomainsPolicyIdcsLastModifiedByArgs', 'DomainsPolicyIdcsLastModifiedByArgsDict', 'outputs.DomainsPolicyIdcsLastModifiedBy']]]] idcs_last_modified_bies: (Updatable) The User or App who modified the Resource
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] idcs_prevented_operations: (Updatable) Each value of this attribute specifies an operation that only an internal client may perform on this particular resource.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[Sequence[pulumi.Input[Union['DomainsPolicyMetaArgs', 'DomainsPolicyMetaArgsDict', 'outputs.DomainsPolicyMeta']]]] metas: (Updatable) A complex attribute that contains resource metadata. All sub-attributes are OPTIONAL.
        ...
        __props__ = _DomainsPolicyState.__new__(_DomainsPolicyState)
        ...
        return DomainsPolicy(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="idcsCreatedBies")
    def idcs_created_bies(self) -> pulumi.Output[Sequence['outputs.DomainsPolicyIdcsCreatedBy']]:
        """
        (Updatable) The User or App who created the Resource
    ...
    @_builtins.property
    @pulumi.getter(name="idcsLastModifiedBies")
    def idcs_last_modified_bies(self) -> pulumi.Output[Sequence['outputs.DomainsPolicyIdcsLastModifiedBy']]:
        """
        (Updatable) The User or App who modified the Resource
    ...
    @_builtins.property
    @pulumi.getter
    def metas(self) -> pulumi.Output[Sequence['outputs.DomainsPolicyMeta']]:
        """
        (Updatable) A complex attribute that contains resource metadata. All sub-attributes are OPTIONAL.
    ...
    @_builtins.property
    @pulumi.getter(name="policyGroovy")
    def policy_groovy(self) -> pulumi.Output[_builtins.str]:
        """
        (Updatable) The Groovy script that is run instead of the policy, if the policy type allows the policy to be a Groovy script.
    ...
    @_builtins.property
    @pulumi.getter(name="policyType")
    def policy_type(self) -> pulumi.Output['outputs.DomainsPolicyPolicyType']:
        """
        (Updatable) PolicyType on which the policy is based
    ...
    @_builtins.property
    @pulumi.getter
    def rules(self) -> pulumi.Output[Sequence['outputs.DomainsPolicyRule']]:
        """
        (Updatable) Rules assigned to this policy
    ...
    @_builtins.property
    @pulumi.getter
    def tags(self) -> pulumi.Output[Sequence['outputs.DomainsPolicyTag']]:
        """
        (Updatable) A list of tags on this resource.
