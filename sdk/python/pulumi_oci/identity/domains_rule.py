...
class DomainsRuleArgs:
    def __init__(__self__, *,
                 ...
                 rule_groovy: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] condition: (Updatable) SCIM filters
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] schemas: (Updatable) REQUIRED. The schemas attribute is an array of Strings which allows introspection of the supported schema version for a SCIM representation as well any schema extensions supported by that representation. Each String value must be a unique URI. This specification defines URIs for User, Group, and a standard \\"enterprise\\" extension. All representations of SCIM schema MUST include a non-zero value array with value(s) of the URIs supported by that representation. Duplicate values MUST NOT be included. Value order is not specified and MUST not impact behavior.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[builtins.bool] active: (Updatable) If true, rule is active
        ...
        :param pulumi.Input['DomainsRuleConditionGroupArgs'] condition_group: (Updatable) Condition or ConditionGroup assigned to the rule
               ...
               * type: complex
               * uniqueness: none
        :param pulumi.Input[builtins.str] description: (Updatable) Rule Description
        ...
        :param pulumi.Input[builtins.str] external_id: (Updatable) An identifier for the Resource as defined by the Service Consumer. The externalId may simplify identification of the Resource between Service Consumer and Service provider by allowing the Consumer to refer to the Resource with its own identifier, obviating the need to store a local mapping between the local identifier of the Resource and the identifier used by the Service Provider. Each Resource MAY include a non-empty externalId value.  The value of the externalId attribute is always issued be the Service Consumer and can never be specified by the Service Provider. The Service Provider MUST always interpret the externalId as scoped to the Service Consumer's tenant.
               ...
               * type: string
               * uniqueness: none
        :param pulumi.Input[builtins.bool] locked: (Updatable) Shows if the rule is locked
               ...
               * type: boolean
               * uniqueness: none
        :param pulumi.Input[builtins.str] name: (Updatable) Rule name
        ...
        :param pulumi.Input[builtins.str] rule_groovy: (Updatable) The Groovy script that is run instead of the rule, if policy type allows the rule to be a Groovy script.
    ...
    def rule_groovy(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @rule_groovy.setter
    def rule_groovy(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DomainsRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            schemas: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            tags: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DomainsRuleTagArgs', 'DomainsRuleTagArgsDict']]]]] = None,
            tenancy_ocid: Optional[pulumi.Input[builtins.str]] = None) -> 'DomainsRule':
        """
    ...
    @property
    @pulumi.getter(name="ruleGroovy")
    def rule_groovy(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The Groovy script that is run instead of the rule, if policy type allows the rule to be a Groovy script.
