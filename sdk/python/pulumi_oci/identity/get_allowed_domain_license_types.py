...
class GetAllowedDomainLicenseTypesResult:
    ...
    def current_license_type_name(self) -> Optional[builtins.str]:
...
def get_allowed_domain_license_types(current_license_type_name: Optional[builtins.str] = None,
    ...
    :param builtins.str current_license_type_name: The domain license type
    """
    __args__ = dict()
...
def get_allowed_domain_license_types_output(current_license_type_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
