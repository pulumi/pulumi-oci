...
class GetAvailabilityDomainResult:
    ...
    def ad_number(self) -> builtins.int:
        """
...
def get_availability_domain(ad_number: Optional[builtins.int] = None,
    ...
    :param builtins.int ad_number: The number of the Availability Domain. Required if `id` is not specified. This number corresponds to the integer in the Availability Domain `name`.
    :param builtins.str compartment_id: The OCID of the tenancy.
    :param builtins.str id: The OCID of the Availability Domain. Required if `ad_number` is not specified.
    """
    __args__ = dict()
...
def get_availability_domain_output(ad_number: Optional[pulumi.Input[Optional[builtins.int]]] = None,
