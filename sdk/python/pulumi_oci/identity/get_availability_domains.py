...
def get_availability_domains(compartment_id: Optional[builtins.str] = None,
...
def get_availability_domains_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
