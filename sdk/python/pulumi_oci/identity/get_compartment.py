...
def get_compartment(id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: The OCID of the compartment.
    """
    __args__ = dict()
    __args__['id'] = id
...
def get_compartment_output(id: Optional[pulumi.Input[builtins.str]] = None,
