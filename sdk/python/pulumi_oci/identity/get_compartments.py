...
def get_compartments(access_level: Optional[builtins.str] = None,
    ...
    :param builtins.bool compartment_id_in_subtree: Default is false. Can only be set to true when performing ListCompartments on the tenancy (root compartment). When set to true, the hierarchy of compartments is traversed and all compartments and subcompartments in the tenancy are returned depending on the the setting of `accessLevel`.
...
def get_compartments_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
