...
def get_domain(domain_id: Optional[str] = None,
    ...
    return AwaitableGetDomainResult(
        ...
        admin_first_name=__ret__.admin_first_name,
        admin_last_name=__ret__.admin_last_name,
        ...
        is_notification_bypassed=__ret__.is_notification_bypassed,
        is_primary_email_required=__ret__.is_primary_email_required,
