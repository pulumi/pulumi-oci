...
class GetDomainResult:
    ...
    def admin_first_name(self) -> builtins.str:
        return pulumi.get(self, "admin_first_name")

    @property
    @pulumi.getter(name="adminLastName")
    def admin_last_name(self) -> builtins.str:
    ...
    def home_region_url(self) -> builtins.str:
        """
    ...
    def is_hidden_on_login(self) -> builtins.bool:
        """
    ...
    def is_notification_bypassed(self) -> builtins.bool:
        return pulumi.get(self, "is_notification_bypassed")

    @property
    @pulumi.getter(name="isPrimaryEmailRequired")
    def is_primary_email_required(self) -> builtins.bool:
...
def get_domain(domain_id: Optional[builtins.str] = None,
    ...
    :param builtins.str domain_id: The OCID of the domain
    """
    __args__ = dict()
