...
class GetDomainsAccountMgmtInfosResult:
    ...
    def account_mgmt_info_count(self) -> Optional[int]:
        return pulumi.get(self, "account_mgmt_info_count")

    @property
    @pulumi.getter(name="accountMgmtInfoFilter")
    def account_mgmt_info_filter(self) -> Optional[str]:
...
def get_domains_account_mgmt_infos_output(account_mgmt_info_count: Optional[pulumi.Input[Optional[int]]] = None,
                                          account_mgmt_info_filter: Optional[pulumi.Input[Optional[str]]] = None,
