...
class GetDomainsAccountMgmtInfosResult:
    ...
    def account_mgmt_info_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "account_mgmt_info_count")

    @_builtins.property
    @pulumi.getter(name="accountMgmtInfoFilter")
    def account_mgmt_info_filter(self) -> Optional[_builtins.str]:
...
def get_domains_account_mgmt_infos(account_mgmt_info_count: Optional[_builtins.int] = None,
                                   account_mgmt_info_filter: Optional[_builtins.str] = None,
...
def get_domains_account_mgmt_infos_output(account_mgmt_info_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                          account_mgmt_info_filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
