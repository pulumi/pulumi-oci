...
class GetDomainsAccountRecoverySettingResult:
    ...
    def account_recovery_setting_id(self) -> _builtins.str:
...
def get_domains_account_recovery_setting(account_recovery_setting_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str account_recovery_setting_id: ID of the resource
