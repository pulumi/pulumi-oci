...
class GetDomainsAccountRecoverySettingResult:
    ...
    def account_recovery_setting_id(self) -> builtins.str:
    ...
    @property
    @pulumi.getter
    def factors(self) -> Sequence[builtins.str]:
        """
...
def get_domains_account_recovery_setting(account_recovery_setting_id: Optional[builtins.str] = None,
    ...
    :param builtins.str account_recovery_setting_id: ID of the resource
...
def get_domains_account_recovery_setting_output(account_recovery_setting_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsAccountRecoverySetting:getDomainsAccountRecoverySetting', __args__, opts=opts, typ=GetDomainsAccountRecoverySettingResult)
    return __ret__.apply(lambda __response__: GetDomainsAccountRecoverySettingResult(
        account_recovery_setting_id=pulumi.get(__response__, 'account_recovery_setting_id'),
        ...
        factors=pulumi.get(__response__, 'factors'),
