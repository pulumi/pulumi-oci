...
__all__ = [
    'GetDomainsAccountRecoverySettingsResult',
    'AwaitableGetDomainsAccountRecoverySettingsResult',
    'get_domains_account_recovery_settings',
    'get_domains_account_recovery_settings_output',
]

@pulumi.output_type
class GetDomainsAccountRecoverySettingsResult:
    """
    A collection of values returned by getDomainsAccountRecoverySettings.
    """
    def __init__(__self__, account_recovery_settings=None, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, resource_type_schema_version=None, schemas=None, start_index=None, total_results=None):
...
class AwaitableGetDomainsAccountRecoverySettingsResult(GetDomainsAccountRecoverySettingsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsAccountRecoverySettingsResult(
...
def get_domains_account_recovery_settings(attribute_sets: Optional[Sequence[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsAccountRecoverySettings:getDomainsAccountRecoverySettings', __args__, opts=opts, typ=GetDomainsAccountRecoverySettingsResult).value

    return AwaitableGetDomainsAccountRecoverySettingsResult(
...
@_utilities.lift_output_func(get_domains_account_recovery_settings)
def get_domains_account_recovery_settings_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
