...
class GetDomainsApiKeyResult:
    ...
    def idcs_created_bies(self) -> Optional[Sequence['outputs.GetDomainsApiKeyIdcsCreatedByResult']]:
    ...
    def idcs_last_modified_bies(self) -> Optional[Sequence['outputs.GetDomainsApiKeyIdcsLastModifiedByResult']]:
    ...
    @property
    @pulumi.getter
    def metas(self) -> Optional[Sequence['outputs.GetDomainsApiKeyMetaResult']]:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GetDomainsApiKeyTagResult']]:
    ...
    def urnietfparamsscimschemasoracleidcsextensionself_change_users(self) -> Optional[Sequence['outputs.GetDomainsApiKeyUrnietfparamsscimschemasoracleidcsextensionselfChangeUserResult']]:
        return pulumi.get(self, "urnietfparamsscimschemasoracleidcsextensionself_change_users")

    @property
    @pulumi.getter
    def users(self) -> Optional[Sequence['outputs.GetDomainsApiKeyUserResult']]:
