...
__all__ = [
    'GetDomainsApiKeysResult',
    'AwaitableGetDomainsApiKeysResult',
    'get_domains_api_keys',
    'get_domains_api_keys_output',
]

@pulumi.output_type
class GetDomainsApiKeysResult:
    """
    A collection of values returned by getDomainsApiKeys.
    """
    def __init__(__self__, api_key_count=None, api_key_filter=None, api_keys=None, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        if api_key_count and not isinstance(api_key_count, int):
            raise TypeError("Expected argument 'api_key_count' to be a int")
        pulumi.set(__self__, "api_key_count", api_key_count)
        if api_key_filter and not isinstance(api_key_filter, str):
            raise TypeError("Expected argument 'api_key_filter' to be a str")
        pulumi.set(__self__, "api_key_filter", api_key_filter)
    ...
    @property
    @pulumi.getter(name="apiKeyCount")
    def api_key_count(self) -> Optional[builtins.int]:
        return pulumi.get(self, "api_key_count")

    @property
    @pulumi.getter(name="apiKeyFilter")
    def api_key_filter(self) -> Optional[builtins.str]:
        return pulumi.get(self, "api_key_filter")

    @property
    @pulumi.getter(name="apiKeys")
    def api_keys(self) -> Sequence['outputs.GetDomainsApiKeysApiKeyResult']:
        """
...
class AwaitableGetDomainsApiKeysResult(GetDomainsApiKeysResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsApiKeysResult(
            api_key_count=self.api_key_count,
            api_key_filter=self.api_key_filter,
...
def get_domains_api_keys(api_key_count: Optional[builtins.int] = None,
                         api_key_filter: Optional[builtins.str] = None,
                         ...
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsApiKeysResult:
    """
    ...
    :param builtins.int api_key_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param builtins.str api_key_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    """
    __args__ = dict()
    __args__['apiKeyCount'] = api_key_count
    __args__['apiKeyFilter'] = api_key_filter
    ...
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsApiKeys:getDomainsApiKeys', __args__, opts=opts, typ=GetDomainsApiKeysResult).value

    return AwaitableGetDomainsApiKeysResult(
        api_key_count=pulumi.get(__ret__, 'api_key_count'),
        api_key_filter=pulumi.get(__ret__, 'api_key_filter'),
...
def get_domains_api_keys_output(api_key_count: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                api_key_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                ...
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsApiKeysResult]:
    """
    This data source provides the list of Api Keys in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsApiKeys:getDomainsApiKeys', __args__, opts=opts, typ=GetDomainsApiKeysResult)
    return __ret__.apply(lambda __response__: GetDomainsApiKeysResult(
        api_key_count=pulumi.get(__response__, 'api_key_count'),
        api_key_filter=pulumi.get(__response__, 'api_key_filter'),
