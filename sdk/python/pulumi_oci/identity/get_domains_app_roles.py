...
def get_domains_app_roles_output(app_role_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                 app_role_filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
