...
__all__ = [
    'GetDomainsAppRolesResult',
    'AwaitableGetDomainsAppRolesResult',
    'get_domains_app_roles',
    'get_domains_app_roles_output',
]

@pulumi.output_type
class GetDomainsAppRolesResult:
    """
    A collection of values returned by getDomainsAppRoles.
    """
    def __init__(__self__, app_role_count=None, app_role_filter=None, app_roles=None, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        if app_role_count and not isinstance(app_role_count, int):
            raise TypeError("Expected argument 'app_role_count' to be a int")
        pulumi.set(__self__, "app_role_count", app_role_count)
        if app_role_filter and not isinstance(app_role_filter, str):
            raise TypeError("Expected argument 'app_role_filter' to be a str")
        pulumi.set(__self__, "app_role_filter", app_role_filter)
    ...
    @_builtins.property
    @pulumi.getter(name="appRoleCount")
    def app_role_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "app_role_count")

    @_builtins.property
    @pulumi.getter(name="appRoleFilter")
    def app_role_filter(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "app_role_filter")

    @_builtins.property
    @pulumi.getter(name="appRoles")
    def app_roles(self) -> Sequence['outputs.GetDomainsAppRolesAppRoleResult']:
        """
...
class AwaitableGetDomainsAppRolesResult(GetDomainsAppRolesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsAppRolesResult(
            app_role_count=self.app_role_count,
            app_role_filter=self.app_role_filter,
...
def get_domains_app_roles(app_role_count: Optional[_builtins.int] = None,
                          app_role_filter: Optional[_builtins.str] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsAppRolesResult:
    """
    ...
    test_app_roles = oci.identity.get_domains_app_roles(idcs_endpoint=test_domain["url"],
        app_role_count=int(app_role_app_role_count),
        ...
        start_index=int(app_role_start_index))
    ```


    :param _builtins.int app_role_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str app_role_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    """
    __args__ = dict()
    __args__['appRoleCount'] = app_role_count
    __args__['appRoleFilter'] = app_role_filter
    ...
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsAppRoles:getDomainsAppRoles', __args__, opts=opts, typ=GetDomainsAppRolesResult).value

    return AwaitableGetDomainsAppRolesResult(
        app_role_count=pulumi.get(__ret__, 'app_role_count'),
        app_role_filter=pulumi.get(__ret__, 'app_role_filter'),
...
def get_domains_app_roles_output(app_role_count: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                 app_role_filter: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetDomainsAppRolesResult(
        ...
        app_role_filter=pulumi.get(__response__, 'app_role_filter'),
