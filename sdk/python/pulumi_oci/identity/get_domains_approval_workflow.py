...
class GetDomainsApprovalWorkflowResult:
    ...
    def approval_workflow_id(self) -> builtins.str:
...
def get_domains_approval_workflow(approval_workflow_id: Optional[builtins.str] = None,
    ...
    :param builtins.str approval_workflow_id: ID of the resource
...
def get_domains_approval_workflow_output(approval_workflow_id: Optional[pulumi.Input[builtins.str]] = None,
