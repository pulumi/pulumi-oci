...
class GetDomainsApprovalWorkflowResult:
    ...
    def approval_workflow_id(self) -> str:
...
def get_domains_approval_workflow(approval_workflow_id: Optional[str] = None,
    ...
    test_approval_workflow = oci.Identity.get_domains_approval_workflow(approval_workflow_id=oci_identity_domains_approval_workflow["test_approval_workflow"]["id"],
...
@_utilities.lift_output_func(get_domains_approval_workflow)
def get_domains_approval_workflow_output(approval_workflow_id: Optional[pulumi.Input[str]] = None,
