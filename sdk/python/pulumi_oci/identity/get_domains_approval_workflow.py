...
__all__ = [
    'GetDomainsApprovalWorkflowResult',
    'AwaitableGetDomainsApprovalWorkflowResult',
    'get_domains_approval_workflow',
    'get_domains_approval_workflow_output',
]

@pulumi.output_type
class GetDomainsApprovalWorkflowResult:
    """
    A collection of values returned by getDomainsApprovalWorkflow.
    """
    def __init__(__self__, approval_workflow_id=None, approval_workflow_steps=None, attribute_sets=None, attributes=None, authorization=None, compartment_ocid=None, delete_in_progress=None, description=None, domain_ocid=None, id=None, idcs_created_bies=None, idcs_endpoint=None, idcs_last_modified_bies=None, idcs_last_upgraded_in_release=None, idcs_prevented_operations=None, max_durations=None, metas=None, name=None, ocid=None, resource_type_schema_version=None, schemas=None, tags=None, tenancy_ocid=None):
        if approval_workflow_id and not isinstance(approval_workflow_id, str):
            raise TypeError("Expected argument 'approval_workflow_id' to be a str")
        pulumi.set(__self__, "approval_workflow_id", approval_workflow_id)
        ...
        if max_durations and not isinstance(max_durations, list):
            raise TypeError("Expected argument 'max_durations' to be a list")
    ...
    @_builtins.property
    @pulumi.getter(name="approvalWorkflowId")
    def approval_workflow_id(self) -> _builtins.str:
        return pulumi.get(self, "approval_workflow_id")

    @_builtins.property
    @pulumi.getter(name="approvalWorkflowSteps")
    def approval_workflow_steps(self) -> Sequence['outputs.GetDomainsApprovalWorkflowApprovalWorkflowStepResult']:
        """
    ...
    def idcs_created_bies(self) -> Sequence['outputs.GetDomainsApprovalWorkflowIdcsCreatedByResult']:
        """
    ...
    def idcs_last_modified_bies(self) -> Sequence['outputs.GetDomainsApprovalWorkflowIdcsLastModifiedByResult']:
        """
    ...
    def max_durations(self) -> Sequence['outputs.GetDomainsApprovalWorkflowMaxDurationResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def metas(self) -> Sequence['outputs.GetDomainsApprovalWorkflowMetaResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def tags(self) -> Sequence['outputs.GetDomainsApprovalWorkflowTagResult']:
        """
...
class AwaitableGetDomainsApprovalWorkflowResult(GetDomainsApprovalWorkflowResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsApprovalWorkflowResult(
...
def get_domains_approval_workflow(approval_workflow_id: Optional[_builtins.str] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsApprovalWorkflowResult:
    """
    ...
    :param _builtins.str approval_workflow_id: ID of the resource
    ...
    """
    __args__ = dict()
    __args__['approvalWorkflowId'] = approval_workflow_id
    ...
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsApprovalWorkflow:getDomainsApprovalWorkflow', __args__, opts=opts, typ=GetDomainsApprovalWorkflowResult).value

    return AwaitableGetDomainsApprovalWorkflowResult(
        approval_workflow_id=pulumi.get(__ret__, 'approval_workflow_id'),
        ...
        max_durations=pulumi.get(__ret__, 'max_durations'),
...
def get_domains_approval_workflow_output(approval_workflow_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetDomainsApprovalWorkflowResult(
        ...
        max_durations=pulumi.get(__response__, 'max_durations'),
