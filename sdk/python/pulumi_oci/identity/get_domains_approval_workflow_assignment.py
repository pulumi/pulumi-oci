...
class GetDomainsApprovalWorkflowAssignmentResult:
    ...
    def approval_workflow_assignment_id(self) -> _builtins.str:
...
def get_domains_approval_workflow_assignment(approval_workflow_assignment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str approval_workflow_assignment_id: ID of the resource
