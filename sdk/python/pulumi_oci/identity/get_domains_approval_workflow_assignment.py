...
__all__ = [
    'GetDomainsApprovalWorkflowAssignmentResult',
    'AwaitableGetDomainsApprovalWorkflowAssignmentResult',
    'get_domains_approval_workflow_assignment',
    'get_domains_approval_workflow_assignment_output',
]

@pulumi.output_type
class GetDomainsApprovalWorkflowAssignmentResult:
    """
    A collection of values returned by getDomainsApprovalWorkflowAssignment.
    """
    def __init__(__self__, approval_workflow_assignment_id=None, approval_workflows=None, assigned_tos=None, assignment_type=None, attribute_sets=None, attributes=None, authorization=None, compartment_ocid=None, delete_in_progress=None, domain_ocid=None, id=None, idcs_created_bies=None, idcs_endpoint=None, idcs_last_modified_bies=None, idcs_last_upgraded_in_release=None, idcs_prevented_operations=None, metas=None, ocid=None, resource_type_schema_version=None, schemas=None, tags=None, tenancy_ocid=None):
        if approval_workflow_assignment_id and not isinstance(approval_workflow_assignment_id, str):
            raise TypeError("Expected argument 'approval_workflow_assignment_id' to be a str")
        pulumi.set(__self__, "approval_workflow_assignment_id", approval_workflow_assignment_id)
        ...
        if assigned_tos and not isinstance(assigned_tos, list):
            raise TypeError("Expected argument 'assigned_tos' to be a list")
        pulumi.set(__self__, "assigned_tos", assigned_tos)
    ...
    @property
    @pulumi.getter(name="approvalWorkflowAssignmentId")
    def approval_workflow_assignment_id(self) -> str:
        return pulumi.get(self, "approval_workflow_assignment_id")

    @property
    @pulumi.getter(name="approvalWorkflows")
    def approval_workflows(self) -> Sequence['outputs.GetDomainsApprovalWorkflowAssignmentApprovalWorkflowResult']:
        """
    ...
    @property
    @pulumi.getter(name="assignedTos")
    def assigned_tos(self) -> Sequence['outputs.GetDomainsApprovalWorkflowAssignmentAssignedToResult']:
        """
        Details of resource for which Approval Workflow is assigned
        """
        return pulumi.get(self, "assigned_tos")
    ...
    def idcs_created_bies(self) -> Sequence['outputs.GetDomainsApprovalWorkflowAssignmentIdcsCreatedByResult']:
        """
    ...
    def idcs_last_modified_bies(self) -> Sequence['outputs.GetDomainsApprovalWorkflowAssignmentIdcsLastModifiedByResult']:
        """
    ...
    @property
    @pulumi.getter
    def metas(self) -> Sequence['outputs.GetDomainsApprovalWorkflowAssignmentMetaResult']:
        """
    ...
    @property
    @pulumi.getter
    def tags(self) -> Sequence['outputs.GetDomainsApprovalWorkflowAssignmentTagResult']:
        """
...
class AwaitableGetDomainsApprovalWorkflowAssignmentResult(GetDomainsApprovalWorkflowAssignmentResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsApprovalWorkflowAssignmentResult(
            approval_workflow_assignment_id=self.approval_workflow_assignment_id,
            approval_workflows=self.approval_workflows,
            assigned_tos=self.assigned_tos,
...
def get_domains_approval_workflow_assignment(approval_workflow_assignment_id: Optional[str] = None,
                                             attribute_sets: Optional[Sequence[str]] = None,
                                             attributes: Optional[str] = None,
                                             authorization: Optional[str] = None,
                                             idcs_endpoint: Optional[str] = None,
                                             resource_type_schema_version: Optional[str] = None,
                                             opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsApprovalWorkflowAssignmentResult:
    """
    ...
    :param str approval_workflow_assignment_id: ID of the resource
    ...
    """
    __args__ = dict()
    __args__['approvalWorkflowAssignmentId'] = approval_workflow_assignment_id
    ...
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsApprovalWorkflowAssignment:getDomainsApprovalWorkflowAssignment', __args__, opts=opts, typ=GetDomainsApprovalWorkflowAssignmentResult).value

    return AwaitableGetDomainsApprovalWorkflowAssignmentResult(
        approval_workflow_assignment_id=pulumi.get(__ret__, 'approval_workflow_assignment_id'),
        approval_workflows=pulumi.get(__ret__, 'approval_workflows'),
        assigned_tos=pulumi.get(__ret__, 'assigned_tos'),
...
def get_domains_approval_workflow_assignment_output(approval_workflow_assignment_id: Optional[pulumi.Input[str]] = None,
                                                    ...
                                                    opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDomainsApprovalWorkflowAssignmentResult]:
    """
    This data source provides details about a specific Approval Workflow Assignment resource in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __args__['resourceTypeSchemaVersion'] = resource_type_schema_version
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsApprovalWorkflowAssignment:getDomainsApprovalWorkflowAssignment', __args__, opts=opts, typ=GetDomainsApprovalWorkflowAssignmentResult)
    return __ret__.apply(lambda __response__: GetDomainsApprovalWorkflowAssignmentResult(
        approval_workflow_assignment_id=pulumi.get(__response__, 'approval_workflow_assignment_id'),
        approval_workflows=pulumi.get(__response__, 'approval_workflows'),
        assigned_tos=pulumi.get(__response__, 'assigned_tos'),
