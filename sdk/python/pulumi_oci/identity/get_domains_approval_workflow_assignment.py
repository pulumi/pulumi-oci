...
class GetDomainsApprovalWorkflowAssignmentResult:
    ...
    def approval_workflow_assignment_id(self) -> builtins.str:
...
def get_domains_approval_workflow_assignment(approval_workflow_assignment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str approval_workflow_assignment_id: ID of the resource
...
def get_domains_approval_workflow_assignment_output(approval_workflow_assignment_id: Optional[pulumi.Input[builtins.str]] = None,
