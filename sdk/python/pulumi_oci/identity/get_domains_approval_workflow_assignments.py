...
__all__ = [
    'GetDomainsApprovalWorkflowAssignmentsResult',
    'AwaitableGetDomainsApprovalWorkflowAssignmentsResult',
    'get_domains_approval_workflow_assignments',
    'get_domains_approval_workflow_assignments_output',
]

@pulumi.output_type
class GetDomainsApprovalWorkflowAssignmentsResult:
    """
    A collection of values returned by getDomainsApprovalWorkflowAssignments.
    """
    def __init__(__self__, approval_workflow_assignment_count=None, approval_workflow_assignment_filter=None, approval_workflow_assignments=None, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        if approval_workflow_assignment_count and not isinstance(approval_workflow_assignment_count, int):
            raise TypeError("Expected argument 'approval_workflow_assignment_count' to be a int")
        pulumi.set(__self__, "approval_workflow_assignment_count", approval_workflow_assignment_count)
        if approval_workflow_assignment_filter and not isinstance(approval_workflow_assignment_filter, str):
            raise TypeError("Expected argument 'approval_workflow_assignment_filter' to be a str")
        pulumi.set(__self__, "approval_workflow_assignment_filter", approval_workflow_assignment_filter)
        if approval_workflow_assignments and not isinstance(approval_workflow_assignments, list):
            raise TypeError("Expected argument 'approval_workflow_assignments' to be a list")
        pulumi.set(__self__, "approval_workflow_assignments", approval_workflow_assignments)
    ...
    @_builtins.property
    @pulumi.getter(name="approvalWorkflowAssignmentCount")
    def approval_workflow_assignment_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "approval_workflow_assignment_count")

    @_builtins.property
    @pulumi.getter(name="approvalWorkflowAssignmentFilter")
    def approval_workflow_assignment_filter(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "approval_workflow_assignment_filter")

    @_builtins.property
    @pulumi.getter(name="approvalWorkflowAssignments")
    def approval_workflow_assignments(self) -> Sequence['outputs.GetDomainsApprovalWorkflowAssignmentsApprovalWorkflowAssignmentResult']:
        """
        The list of approval_workflow_assignments.
        """
        return pulumi.get(self, "approval_workflow_assignments")
...
class AwaitableGetDomainsApprovalWorkflowAssignmentsResult(GetDomainsApprovalWorkflowAssignmentsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsApprovalWorkflowAssignmentsResult(
            approval_workflow_assignment_count=self.approval_workflow_assignment_count,
            approval_workflow_assignment_filter=self.approval_workflow_assignment_filter,
            approval_workflow_assignments=self.approval_workflow_assignments,
...
def get_domains_approval_workflow_assignments(approval_workflow_assignment_count: Optional[_builtins.int] = None,
                                              approval_workflow_assignment_filter: Optional[_builtins.str] = None,
                                              ...
                                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsApprovalWorkflowAssignmentsResult:
    """
    ...
    :param _builtins.int approval_workflow_assignment_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str approval_workflow_assignment_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    """
    __args__ = dict()
    __args__['approvalWorkflowAssignmentCount'] = approval_workflow_assignment_count
    __args__['approvalWorkflowAssignmentFilter'] = approval_workflow_assignment_filter
    ...
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsApprovalWorkflowAssignments:getDomainsApprovalWorkflowAssignments', __args__, opts=opts, typ=GetDomainsApprovalWorkflowAssignmentsResult).value

    return AwaitableGetDomainsApprovalWorkflowAssignmentsResult(
        approval_workflow_assignment_count=pulumi.get(__ret__, 'approval_workflow_assignment_count'),
        approval_workflow_assignment_filter=pulumi.get(__ret__, 'approval_workflow_assignment_filter'),
        approval_workflow_assignments=pulumi.get(__ret__, 'approval_workflow_assignments'),
...
def get_domains_approval_workflow_assignments_output(approval_workflow_assignment_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                                     approval_workflow_assignment_filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                     ...
                                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsApprovalWorkflowAssignmentsResult]:
    """
    This data source provides the list of Approval Workflow Assignments in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsApprovalWorkflowAssignments:getDomainsApprovalWorkflowAssignments', __args__, opts=opts, typ=GetDomainsApprovalWorkflowAssignmentsResult)
    return __ret__.apply(lambda __response__: GetDomainsApprovalWorkflowAssignmentsResult(
        approval_workflow_assignment_count=pulumi.get(__response__, 'approval_workflow_assignment_count'),
        approval_workflow_assignment_filter=pulumi.get(__response__, 'approval_workflow_assignment_filter'),
        approval_workflow_assignments=pulumi.get(__response__, 'approval_workflow_assignments'),
