...
class GetDomainsApprovalWorkflowStepResult:
    ...
    def approval_workflow_step_id(self) -> builtins.str:
    ...
    def approvers_expressions(self) -> Sequence[builtins.str]:
        """
    ...
    def minimum_approvals(self) -> builtins.int:
        """
...
def get_domains_approval_workflow_step(approval_workflow_step_id: Optional[builtins.str] = None,
    ...
    :param builtins.str approval_workflow_step_id: ID of the resource
...
def get_domains_approval_workflow_step_output(approval_workflow_step_id: Optional[pulumi.Input[builtins.str]] = None,
