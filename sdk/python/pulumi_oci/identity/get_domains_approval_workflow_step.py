...
class GetDomainsApprovalWorkflowStepResult:
    ...
    def approval_workflow_step_id(self) -> str:
    ...
    def approvers_expressions(self) -> Sequence[str]:
        """
...
def get_domains_approval_workflow_step(approval_workflow_step_id: Optional[str] = None,
    ...
    :param str approval_workflow_step_id: ID of the resource
...
@_utilities.lift_output_func(get_domains_approval_workflow_step)
def get_domains_approval_workflow_step_output(approval_workflow_step_id: Optional[pulumi.Input[str]] = None,
                                              ...
                                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDomainsApprovalWorkflowStepResult]:
    """
    This data source provides details about a specific Approval Workflow Step resource in Oracle Cloud Infrastructure Identity Domains service.
