...
__all__ = [
    'GetDomainsApprovalWorkflowStepsResult',
    'AwaitableGetDomainsApprovalWorkflowStepsResult',
    'get_domains_approval_workflow_steps',
    'get_domains_approval_workflow_steps_output',
]

@pulumi.output_type
class GetDomainsApprovalWorkflowStepsResult:
    """
    A collection of values returned by getDomainsApprovalWorkflowSteps.
    """
    def __init__(__self__, approval_workflow_step_count=None, approval_workflow_step_filter=None, approval_workflow_steps=None, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        if approval_workflow_step_count and not isinstance(approval_workflow_step_count, int):
            raise TypeError("Expected argument 'approval_workflow_step_count' to be a int")
        pulumi.set(__self__, "approval_workflow_step_count", approval_workflow_step_count)
        if approval_workflow_step_filter and not isinstance(approval_workflow_step_filter, str):
            raise TypeError("Expected argument 'approval_workflow_step_filter' to be a str")
        pulumi.set(__self__, "approval_workflow_step_filter", approval_workflow_step_filter)
    ...
    @_builtins.property
    @pulumi.getter(name="approvalWorkflowStepCount")
    def approval_workflow_step_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "approval_workflow_step_count")

    @_builtins.property
    @pulumi.getter(name="approvalWorkflowStepFilter")
    def approval_workflow_step_filter(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "approval_workflow_step_filter")

    @_builtins.property
    @pulumi.getter(name="approvalWorkflowSteps")
    def approval_workflow_steps(self) -> Sequence['outputs.GetDomainsApprovalWorkflowStepsApprovalWorkflowStepResult']:
        """
...
class AwaitableGetDomainsApprovalWorkflowStepsResult(GetDomainsApprovalWorkflowStepsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsApprovalWorkflowStepsResult(
            approval_workflow_step_count=self.approval_workflow_step_count,
            approval_workflow_step_filter=self.approval_workflow_step_filter,
...
def get_domains_approval_workflow_steps(approval_workflow_step_count: Optional[_builtins.int] = None,
                                        approval_workflow_step_filter: Optional[_builtins.str] = None,
                                        ...
                                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsApprovalWorkflowStepsResult:
    """
    ...
    :param _builtins.int approval_workflow_step_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str approval_workflow_step_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    """
    __args__ = dict()
    __args__['approvalWorkflowStepCount'] = approval_workflow_step_count
    __args__['approvalWorkflowStepFilter'] = approval_workflow_step_filter
    ...
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsApprovalWorkflowSteps:getDomainsApprovalWorkflowSteps', __args__, opts=opts, typ=GetDomainsApprovalWorkflowStepsResult).value

    return AwaitableGetDomainsApprovalWorkflowStepsResult(
        approval_workflow_step_count=pulumi.get(__ret__, 'approval_workflow_step_count'),
        approval_workflow_step_filter=pulumi.get(__ret__, 'approval_workflow_step_filter'),
...
def get_domains_approval_workflow_steps_output(approval_workflow_step_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetDomainsApprovalWorkflowStepsResult(
        ...
        approval_workflow_step_filter=pulumi.get(__response__, 'approval_workflow_step_filter'),
        approval_workflow_steps=pulumi.get(__response__, 'approval_workflow_steps'),
