...
__all__ = [
    'GetDomainsAppsResult',
    'AwaitableGetDomainsAppsResult',
    'get_domains_apps',
    'get_domains_apps_output',
]

@pulumi.output_type
class GetDomainsAppsResult:
    """
    A collection of values returned by getDomainsApps.
    """
    def __init__(__self__, app_count=None, app_filter=None, apps=None, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        ...
        if app_filter and not isinstance(app_filter, str):
            raise TypeError("Expected argument 'app_filter' to be a str")
        pulumi.set(__self__, "app_filter", app_filter)
    ...
    def app_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "app_count")

    @_builtins.property
    @pulumi.getter(name="appFilter")
    def app_filter(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "app_filter")

    @_builtins.property
    @pulumi.getter
    def apps(self) -> Sequence['outputs.GetDomainsAppsAppResult']:
        """
        The list of apps.
        """
...
class AwaitableGetDomainsAppsResult(GetDomainsAppsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsAppsResult(
...
def get_domains_apps(app_count: Optional[_builtins.int] = None,
                     app_filter: Optional[_builtins.str] = None,
                     ...
                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsAppsResult:
    """
    ...
    :param _builtins.int app_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str app_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    """
    __args__ = dict()
    __args__['appCount'] = app_count
    __args__['appFilter'] = app_filter
    ...
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsApps:getDomainsApps', __args__, opts=opts, typ=GetDomainsAppsResult).value

    return AwaitableGetDomainsAppsResult(
        app_count=pulumi.get(__ret__, 'app_count'),
        app_filter=pulumi.get(__ret__, 'app_filter'),
...
def get_domains_apps_output(app_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsApps:getDomainsApps', __args__, opts=opts, typ=GetDomainsAppsResult)
    return __ret__.apply(lambda __response__: GetDomainsAppsResult(
        app_count=pulumi.get(__response__, 'app_count'),
        app_filter=pulumi.get(__response__, 'app_filter'),
