...
class GetDomainsAppsResult:
    ...
    def app_count(self) -> Optional[int]:
        return pulumi.get(self, "app_count")

    @property
    @pulumi.getter(name="appFilter")
    def app_filter(self) -> Optional[str]:
...
def get_domains_apps(app_count: Optional[int] = None,
    ...
    :param str app_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
...
def get_domains_apps_output(app_count: Optional[pulumi.Input[Optional[int]]] = None,
                            app_filter: Optional[pulumi.Input[Optional[str]]] = None,
                            ...
                            opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDomainsAppsResult]:
    """
    This data source provides the list of Apps in Oracle Cloud Infrastructure Identity Domains service.
