...
class GetDomainsAuthTokenResult:
    ...
    def idcs_created_bies(self) -> Optional[Sequence['outputs.GetDomainsAuthTokenIdcsCreatedByResult']]:
    ...
    def idcs_last_modified_bies(self) -> Optional[Sequence['outputs.GetDomainsAuthTokenIdcsLastModifiedByResult']]:
    ...
    @property
    @pulumi.getter
    def metas(self) -> Optional[Sequence['outputs.GetDomainsAuthTokenMetaResult']]:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GetDomainsAuthTokenTagResult']]:
    ...
    def urnietfparamsscimschemasoracleidcsextensionself_change_users(self) -> Optional[Sequence['outputs.GetDomainsAuthTokenUrnietfparamsscimschemasoracleidcsextensionselfChangeUserResult']]:
        return pulumi.get(self, "urnietfparamsscimschemasoracleidcsextensionself_change_users")

    @property
    @pulumi.getter
    def users(self) -> Optional[Sequence['outputs.GetDomainsAuthTokenUserResult']]:
