...
class GetDomainsAuthTokenResult:
    ...
    def auth_token_id(self) -> builtins.str:
...
def get_domains_auth_token(attribute_sets: Optional[Sequence[builtins.str]] = None,
                           attributes: Optional[builtins.str] = None,
                           auth_token_id: Optional[builtins.str] = None,
    ...
    :param builtins.str auth_token_id: ID of the resource
...
def get_domains_auth_token_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                  attributes: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  auth_token_id: Optional[pulumi.Input[builtins.str]] = None,
