...
__all__ = [
    'GetDomainsAuthTokensResult',
    'AwaitableGetDomainsAuthTokensResult',
    'get_domains_auth_tokens',
    'get_domains_auth_tokens_output',
]

@pulumi.output_type
class GetDomainsAuthTokensResult:
    """
    A collection of values returned by getDomainsAuthTokens.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, auth_token_count=None, auth_token_filter=None, auth_tokens=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        ...
        if auth_token_count and not isinstance(auth_token_count, int):
            raise TypeError("Expected argument 'auth_token_count' to be a int")
        pulumi.set(__self__, "auth_token_count", auth_token_count)
        if auth_token_filter and not isinstance(auth_token_filter, str):
            raise TypeError("Expected argument 'auth_token_filter' to be a str")
        pulumi.set(__self__, "auth_token_filter", auth_token_filter)
    ...
    @_builtins.property
    @pulumi.getter(name="authTokenCount")
    def auth_token_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "auth_token_count")

    @_builtins.property
    @pulumi.getter(name="authTokenFilter")
    def auth_token_filter(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "auth_token_filter")

    @_builtins.property
    @pulumi.getter(name="authTokens")
    def auth_tokens(self) -> Sequence['outputs.GetDomainsAuthTokensAuthTokenResult']:
        """
...
class AwaitableGetDomainsAuthTokensResult(GetDomainsAuthTokensResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsAuthTokensResult(
            attribute_sets=self.attribute_sets,
            attributes=self.attributes,
            auth_token_count=self.auth_token_count,
            auth_token_filter=self.auth_token_filter,
...
def get_domains_auth_tokens(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                            attributes: Optional[_builtins.str] = None,
                            auth_token_count: Optional[_builtins.int] = None,
                            auth_token_filter: Optional[_builtins.str] = None,
                            ...
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsAuthTokensResult:
    """
    ...
    test_auth_tokens = oci.identity.get_domains_auth_tokens(idcs_endpoint=test_domain["url"],
        auth_token_count=int(auth_token_auth_token_count),
        ...
        start_index=int(auth_token_start_index))
    ```
    ...
    :param _builtins.int auth_token_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str auth_token_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    __args__['authTokenCount'] = auth_token_count
    __args__['authTokenFilter'] = auth_token_filter
...
def get_domains_auth_tokens_output(attribute_sets: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                                   attributes: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                   auth_token_count: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                   auth_token_filter: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                   ...
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsAuthTokensResult]:
    """
    This data source provides the list of Auth Tokens in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsAuthTokens:getDomainsAuthTokens', __args__, opts=opts, typ=GetDomainsAuthTokensResult)
    return __ret__.apply(lambda __response__: GetDomainsAuthTokensResult(
        attribute_sets=pulumi.get(__response__, 'attribute_sets'),
        attributes=pulumi.get(__response__, 'attributes'),
        auth_token_count=pulumi.get(__response__, 'auth_token_count'),
        auth_token_filter=pulumi.get(__response__, 'auth_token_filter'),
