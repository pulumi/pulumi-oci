...
class GetDomainsAuthTokensResult:
    ...
    def auth_token_count(self) -> Optional[builtins.int]:
        return pulumi.get(self, "auth_token_count")

    @property
    @pulumi.getter(name="authTokenFilter")
    def auth_token_filter(self) -> Optional[builtins.str]:
...
def get_domains_auth_tokens(attribute_sets: Optional[Sequence[builtins.str]] = None,
                            attributes: Optional[builtins.str] = None,
                            auth_token_count: Optional[builtins.int] = None,
                            auth_token_filter: Optional[builtins.str] = None,
    ...
    :param builtins.int auth_token_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param builtins.str auth_token_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
...
def get_domains_auth_tokens_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                   attributes: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                   auth_token_count: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                   auth_token_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
