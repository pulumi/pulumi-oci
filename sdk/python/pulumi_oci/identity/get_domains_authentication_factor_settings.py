...
class GetDomainsAuthenticationFactorSettingsResult:
    ...
    def authentication_factor_settings(self) -> Optional[Sequence['outputs.GetDomainsAuthenticationFactorSettingsAuthenticationFactorSettingResult']]:
...
@_utilities.lift_output_func(get_domains_authentication_factor_settings)
