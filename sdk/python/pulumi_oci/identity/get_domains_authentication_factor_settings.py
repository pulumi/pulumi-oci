...
__all__ = [
    'GetDomainsAuthenticationFactorSettingsResult',
    'AwaitableGetDomainsAuthenticationFactorSettingsResult',
    'get_domains_authentication_factor_settings',
    'get_domains_authentication_factor_settings_output',
]

@pulumi.output_type
class GetDomainsAuthenticationFactorSettingsResult:
    """
    A collection of values returned by getDomainsAuthenticationFactorSettings.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authentication_factor_settings=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, resource_type_schema_version=None, schemas=None, start_index=None, total_results=None):
        ...
        if authentication_factor_settings and not isinstance(authentication_factor_settings, list):
            raise TypeError("Expected argument 'authentication_factor_settings' to be a list")
        pulumi.set(__self__, "authentication_factor_settings", authentication_factor_settings)
    ...
    @_builtins.property
    @pulumi.getter(name="authenticationFactorSettings")
    def authentication_factor_settings(self) -> Sequence['outputs.GetDomainsAuthenticationFactorSettingsAuthenticationFactorSettingResult']:
        """
        The list of authentication_factor_settings.
        """
        return pulumi.get(self, "authentication_factor_settings")
...
class AwaitableGetDomainsAuthenticationFactorSettingsResult(GetDomainsAuthenticationFactorSettingsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsAuthenticationFactorSettingsResult(
            attribute_sets=self.attribute_sets,
            attributes=self.attributes,
            authentication_factor_settings=self.authentication_factor_settings,
...
def get_domains_authentication_factor_settings(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                               ...
                                               opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsAuthenticationFactorSettingsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsAuthenticationFactorSettings:getDomainsAuthenticationFactorSettings', __args__, opts=opts, typ=GetDomainsAuthenticationFactorSettingsResult).value

    return AwaitableGetDomainsAuthenticationFactorSettingsResult(
        attribute_sets=pulumi.get(__ret__, 'attribute_sets'),
        attributes=pulumi.get(__ret__, 'attributes'),
        authentication_factor_settings=pulumi.get(__ret__, 'authentication_factor_settings'),
...
def get_domains_authentication_factor_settings_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                                      ...
                                                      opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsAuthenticationFactorSettingsResult]:
    """
    This data source provides the list of Authentication Factor Settings in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsAuthenticationFactorSettings:getDomainsAuthenticationFactorSettings', __args__, opts=opts, typ=GetDomainsAuthenticationFactorSettingsResult)
    return __ret__.apply(lambda __response__: GetDomainsAuthenticationFactorSettingsResult(
        attribute_sets=pulumi.get(__response__, 'attribute_sets'),
        attributes=pulumi.get(__response__, 'attributes'),
        authentication_factor_settings=pulumi.get(__response__, 'authentication_factor_settings'),
