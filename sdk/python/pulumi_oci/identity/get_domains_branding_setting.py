...
class GetDomainsBrandingSettingResult:
    ...
    def branding_setting_id(self) -> _builtins.str:
...
def get_domains_branding_setting(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                 attributes: Optional[_builtins.str] = None,
                                 authorization: Optional[_builtins.str] = None,
                                 branding_setting_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str branding_setting_id: ID of the resource
