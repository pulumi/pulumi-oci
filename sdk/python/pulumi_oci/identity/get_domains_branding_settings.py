...
__all__ = [
    'GetDomainsBrandingSettingsResult',
    'AwaitableGetDomainsBrandingSettingsResult',
    'get_domains_branding_settings',
    'get_domains_branding_settings_output',
]

@pulumi.output_type
class GetDomainsBrandingSettingsResult:
    """
    A collection of values returned by getDomainsBrandingSettings.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, branding_settings=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, resource_type_schema_version=None, schemas=None, start_index=None, total_results=None):
        ...
        if branding_settings and not isinstance(branding_settings, list):
            raise TypeError("Expected argument 'branding_settings' to be a list")
        pulumi.set(__self__, "branding_settings", branding_settings)
    ...
    @property
    @pulumi.getter(name="brandingSettings")
    def branding_settings(self) -> Sequence['outputs.GetDomainsBrandingSettingsBrandingSettingResult']:
        """
        The list of branding_settings.
        """
        return pulumi.get(self, "branding_settings")
...
class AwaitableGetDomainsBrandingSettingsResult(GetDomainsBrandingSettingsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsBrandingSettingsResult(
...
def get_domains_branding_settings(attribute_sets: Optional[Sequence[builtins.str]] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsBrandingSettingsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsBrandingSettings:getDomainsBrandingSettings', __args__, opts=opts, typ=GetDomainsBrandingSettingsResult).value

    return AwaitableGetDomainsBrandingSettingsResult(
        attribute_sets=pulumi.get(__ret__, 'attribute_sets'),
        attributes=pulumi.get(__ret__, 'attributes'),
        authorization=pulumi.get(__ret__, 'authorization'),
        branding_settings=pulumi.get(__ret__, 'branding_settings'),
...
def get_domains_branding_settings_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsBrandingSettingsResult]:
    """
    This data source provides the list of Branding Settings in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsBrandingSettings:getDomainsBrandingSettings', __args__, opts=opts, typ=GetDomainsBrandingSettingsResult)
    return __ret__.apply(lambda __response__: GetDomainsBrandingSettingsResult(
        attribute_sets=pulumi.get(__response__, 'attribute_sets'),
        attributes=pulumi.get(__response__, 'attributes'),
        authorization=pulumi.get(__response__, 'authorization'),
        branding_settings=pulumi.get(__response__, 'branding_settings'),
