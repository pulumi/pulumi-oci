...
class GetDomainsCloudGateResult:
    ...
    def cloud_gate_id(self) -> _builtins.str:
...
def get_domains_cloud_gate(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                           attributes: Optional[_builtins.str] = None,
                           authorization: Optional[_builtins.str] = None,
                           cloud_gate_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str cloud_gate_id: ID of the resource
