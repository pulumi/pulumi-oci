...
__all__ = [
    'GetDomainsCloudGateResult',
    'AwaitableGetDomainsCloudGateResult',
    'get_domains_cloud_gate',
    'get_domains_cloud_gate_output',
]

@pulumi.output_type
class GetDomainsCloudGateResult:
    """
    A collection of values returned by getDomainsCloudGate.
    """
    def __init__(__self__, active=None, attribute_sets=None, attributes=None, authorization=None, cloud_gate_id=None, compartment_ocid=None, delete_in_progress=None, description=None, display_name=None, domain_ocid=None, id=None, idcs_created_bies=None, idcs_endpoint=None, idcs_last_modified_bies=None, idcs_last_upgraded_in_release=None, idcs_prevented_operations=None, is_opc_service=None, last_modified_time=None, mappings=None, metas=None, oauth_clients=None, ocid=None, resource_type_schema_version=None, schemas=None, servers=None, tags=None, tenancy_ocid=None, type=None, upstream_server_groups=None, upstream_servers=None):
        ...
        if cloud_gate_id and not isinstance(cloud_gate_id, str):
            raise TypeError("Expected argument 'cloud_gate_id' to be a str")
        pulumi.set(__self__, "cloud_gate_id", cloud_gate_id)
        ...
        if upstream_servers and not isinstance(upstream_servers, list):
            raise TypeError("Expected argument 'upstream_servers' to be a list")
    ...
    @property
    @pulumi.getter(name="cloudGateId")
    def cloud_gate_id(self) -> str:
        return pulumi.get(self, "cloud_gate_id")
    ...
    def idcs_created_bies(self) -> Sequence['outputs.GetDomainsCloudGateIdcsCreatedByResult']:
        """
    ...
    def idcs_last_modified_bies(self) -> Sequence['outputs.GetDomainsCloudGateIdcsLastModifiedByResult']:
        """
    ...
    @property
    @pulumi.getter
    def mappings(self) -> Sequence['outputs.GetDomainsCloudGateMappingResult']:
        """
    ...
    @property
    @pulumi.getter
    def metas(self) -> Sequence['outputs.GetDomainsCloudGateMetaResult']:
        """
    ...
    def oauth_clients(self) -> Sequence['outputs.GetDomainsCloudGateOauthClientResult']:
        """
    ...
    @property
    @pulumi.getter
    def servers(self) -> Sequence['outputs.GetDomainsCloudGateServerResult']:
        """
    ...
    @property
    @pulumi.getter
    def tags(self) -> Sequence['outputs.GetDomainsCloudGateTagResult']:
        """
    ...
    def upstream_server_groups(self) -> Sequence['outputs.GetDomainsCloudGateUpstreamServerGroupResult']:
        """
    ...
    def upstream_servers(self) -> Sequence['outputs.GetDomainsCloudGateUpstreamServerResult']:
        """
...
class AwaitableGetDomainsCloudGateResult(GetDomainsCloudGateResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsCloudGateResult(
            active=self.active,
            attribute_sets=self.attribute_sets,
            attributes=self.attributes,
            authorization=self.authorization,
            cloud_gate_id=self.cloud_gate_id,
...
def get_domains_cloud_gate(attribute_sets: Optional[Sequence[str]] = None,
                           attributes: Optional[str] = None,
                           authorization: Optional[str] = None,
                           cloud_gate_id: Optional[str] = None,
                           idcs_endpoint: Optional[str] = None,
                           resource_type_schema_version: Optional[str] = None,
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsCloudGateResult:
    """
    ...
    :param str cloud_gate_id: ID of the resource
    ...
    __args__['cloudGateId'] = cloud_gate_id
    __args__['idcsEndpoint'] = idcs_endpoint
    __args__['resourceTypeSchemaVersion'] = resource_type_schema_version
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsCloudGate:getDomainsCloudGate', __args__, opts=opts, typ=GetDomainsCloudGateResult).value

    return AwaitableGetDomainsCloudGateResult(
        active=pulumi.get(__ret__, 'active'),
        attribute_sets=pulumi.get(__ret__, 'attribute_sets'),
        attributes=pulumi.get(__ret__, 'attributes'),
        authorization=pulumi.get(__ret__, 'authorization'),
        cloud_gate_id=pulumi.get(__ret__, 'cloud_gate_id'),
...
def get_domains_cloud_gate_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                  attributes: Optional[pulumi.Input[Optional[str]]] = None,
                                  authorization: Optional[pulumi.Input[Optional[str]]] = None,
                                  cloud_gate_id: Optional[pulumi.Input[str]] = None,
                                  idcs_endpoint: Optional[pulumi.Input[str]] = None,
                                  resource_type_schema_version: Optional[pulumi.Input[Optional[str]]] = None,
                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDomainsCloudGateResult]:
    """
    This data source provides details about a specific Cloud Gate resource in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __args__['resourceTypeSchemaVersion'] = resource_type_schema_version
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsCloudGate:getDomainsCloudGate', __args__, opts=opts, typ=GetDomainsCloudGateResult)
    return __ret__.apply(lambda __response__: GetDomainsCloudGateResult(
        active=pulumi.get(__response__, 'active'),
        attribute_sets=pulumi.get(__response__, 'attribute_sets'),
        attributes=pulumi.get(__response__, 'attributes'),
        authorization=pulumi.get(__response__, 'authorization'),
        cloud_gate_id=pulumi.get(__response__, 'cloud_gate_id'),
        ...
        upstream_servers=pulumi.get(__response__, 'upstream_servers')))
