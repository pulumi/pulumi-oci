...
def get_domains_cloud_gate(attribute_sets: Optional[Sequence[str]] = None,
    ...
    test_cloud_gate = oci.Identity.get_domains_cloud_gate(cloud_gate_id=oci_identity_domains_cloud_gate["test_cloud_gate"]["id"],
...
@_utilities.lift_output_func(get_domains_cloud_gate)
