...
class GetDomainsCloudGateMappingsResult:
    ...
    def cloud_gate_mapping_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "cloud_gate_mapping_count")

    @_builtins.property
    @pulumi.getter(name="cloudGateMappingFilter")
    def cloud_gate_mapping_filter(self) -> Optional[_builtins.str]:
...
def get_domains_cloud_gate_mappings(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                    attributes: Optional[_builtins.str] = None,
                                    authorization: Optional[_builtins.str] = None,
                                    cloud_gate_mapping_count: Optional[_builtins.int] = None,
                                    cloud_gate_mapping_filter: Optional[_builtins.str] = None,
    ...
    test_cloud_gate_mappings = oci.identity.get_domains_cloud_gate_mappings(idcs_endpoint=test_domain["url"],
        cloud_gate_mapping_count=int(cloud_gate_mapping_cloud_gate_mapping_count),
        ...
        start_index=int(cloud_gate_mapping_start_index))
    ```
    ...
    :param _builtins.int cloud_gate_mapping_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str cloud_gate_mapping_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
...
def get_domains_cloud_gate_mappings_output(attribute_sets: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                                           ...
                                           cloud_gate_mapping_count: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                           cloud_gate_mapping_filter: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                           ...
                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsCloudGateMappingsResult]:
    """
    This data source provides the list of Cloud Gate Mappings in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsCloudGateMappings:getDomainsCloudGateMappings', __args__, opts=opts, typ=GetDomainsCloudGateMappingsResult)
    return __ret__.apply(lambda __response__: GetDomainsCloudGateMappingsResult(
        attribute_sets=pulumi.get(__response__, 'attribute_sets'),
        attributes=pulumi.get(__response__, 'attributes'),
        authorization=pulumi.get(__response__, 'authorization'),
        cloud_gate_mapping_count=pulumi.get(__response__, 'cloud_gate_mapping_count'),
        cloud_gate_mapping_filter=pulumi.get(__response__, 'cloud_gate_mapping_filter'),
        cloud_gate_mappings=pulumi.get(__response__, 'cloud_gate_mappings'),
