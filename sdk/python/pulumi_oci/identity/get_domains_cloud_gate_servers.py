...
def get_domains_cloud_gate_servers(attribute_sets: Optional[Sequence[str]] = None,
    ...
    test_cloud_gate_servers = oci.Identity.get_domains_cloud_gate_servers(idcs_endpoint=data["oci_identity_domain"]["test_domain"]["url"],
...
@_utilities.lift_output_func(get_domains_cloud_gate_servers)
