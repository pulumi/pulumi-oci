...
__all__ = [
    'GetDomainsCloudGatesResult',
    'AwaitableGetDomainsCloudGatesResult',
    'get_domains_cloud_gates',
    'get_domains_cloud_gates_output',
]

@pulumi.output_type
class GetDomainsCloudGatesResult:
    """
    A collection of values returned by getDomainsCloudGates.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, cloud_gate_count=None, cloud_gate_filter=None, cloud_gates=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        ...
        if cloud_gate_count and not isinstance(cloud_gate_count, int):
            raise TypeError("Expected argument 'cloud_gate_count' to be a int")
        pulumi.set(__self__, "cloud_gate_count", cloud_gate_count)
        if cloud_gate_filter and not isinstance(cloud_gate_filter, str):
            raise TypeError("Expected argument 'cloud_gate_filter' to be a str")
        pulumi.set(__self__, "cloud_gate_filter", cloud_gate_filter)
    ...
    @_builtins.property
    @pulumi.getter(name="cloudGateCount")
    def cloud_gate_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "cloud_gate_count")

    @_builtins.property
    @pulumi.getter(name="cloudGateFilter")
    def cloud_gate_filter(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "cloud_gate_filter")

    @_builtins.property
    @pulumi.getter(name="cloudGates")
    def cloud_gates(self) -> Sequence['outputs.GetDomainsCloudGatesCloudGateResult']:
        """
...
class AwaitableGetDomainsCloudGatesResult(GetDomainsCloudGatesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsCloudGatesResult(
            attribute_sets=self.attribute_sets,
            attributes=self.attributes,
            authorization=self.authorization,
            cloud_gate_count=self.cloud_gate_count,
            cloud_gate_filter=self.cloud_gate_filter,
...
def get_domains_cloud_gates(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                            attributes: Optional[_builtins.str] = None,
                            authorization: Optional[_builtins.str] = None,
                            cloud_gate_count: Optional[_builtins.int] = None,
                            cloud_gate_filter: Optional[_builtins.str] = None,
                            ...
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsCloudGatesResult:
    """
    ...
    test_cloud_gates = oci.identity.get_domains_cloud_gates(idcs_endpoint=test_domain["url"],
        cloud_gate_count=int(cloud_gate_cloud_gate_count),
        ...
        start_index=int(cloud_gate_start_index))
    ```
    ...
    :param _builtins.int cloud_gate_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str cloud_gate_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    __args__['cloudGateCount'] = cloud_gate_count
    __args__['cloudGateFilter'] = cloud_gate_filter
    ...
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsCloudGates:getDomainsCloudGates', __args__, opts=opts, typ=GetDomainsCloudGatesResult).value

    return AwaitableGetDomainsCloudGatesResult(
        attribute_sets=pulumi.get(__ret__, 'attribute_sets'),
        attributes=pulumi.get(__ret__, 'attributes'),
        authorization=pulumi.get(__ret__, 'authorization'),
        cloud_gate_count=pulumi.get(__ret__, 'cloud_gate_count'),
        cloud_gate_filter=pulumi.get(__ret__, 'cloud_gate_filter'),
...
def get_domains_cloud_gates_output(attribute_sets: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                                   ...
                                   cloud_gate_count: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                   cloud_gate_filter: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                   ...
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsCloudGatesResult]:
    """
    This data source provides the list of Cloud Gates in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsCloudGates:getDomainsCloudGates', __args__, opts=opts, typ=GetDomainsCloudGatesResult)
    return __ret__.apply(lambda __response__: GetDomainsCloudGatesResult(
        attribute_sets=pulumi.get(__response__, 'attribute_sets'),
        attributes=pulumi.get(__response__, 'attributes'),
        authorization=pulumi.get(__response__, 'authorization'),
        cloud_gate_count=pulumi.get(__response__, 'cloud_gate_count'),
        cloud_gate_filter=pulumi.get(__response__, 'cloud_gate_filter'),
