...
class GetDomainsConditionResult:
    ...
    def evaluate_condition_if(self) -> _builtins.str:
        """
...
def get_domains_condition(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                          attributes: Optional[_builtins.str] = None,
                          authorization: Optional[_builtins.str] = None,
                          condition_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str condition_id: ID of the resource
...
def get_domains_condition_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
