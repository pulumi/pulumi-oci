...
__all__ = [
    'GetDomainsConditionsResult',
    'AwaitableGetDomainsConditionsResult',
    'get_domains_conditions',
    'get_domains_conditions_output',
]

@pulumi.output_type
class GetDomainsConditionsResult:
    """
    A collection of values returned by getDomainsConditions.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, condition_count=None, condition_filter=None, conditions=None, id=None, idcs_endpoint=None, items_per_page=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        ...
        if condition_count and not isinstance(condition_count, int):
            raise TypeError("Expected argument 'condition_count' to be a int")
        pulumi.set(__self__, "condition_count", condition_count)
        if condition_filter and not isinstance(condition_filter, str):
            raise TypeError("Expected argument 'condition_filter' to be a str")
        pulumi.set(__self__, "condition_filter", condition_filter)
    ...
    @_builtins.property
    @pulumi.getter(name="conditionCount")
    def condition_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "condition_count")

    @_builtins.property
    @pulumi.getter(name="conditionFilter")
    def condition_filter(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "condition_filter")

    @_builtins.property
    @pulumi.getter
    def conditions(self) -> Sequence['outputs.GetDomainsConditionsConditionResult']:
        """
...
class AwaitableGetDomainsConditionsResult(GetDomainsConditionsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsConditionsResult(
...
def get_domains_conditions(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                           attributes: Optional[_builtins.str] = None,
                           authorization: Optional[_builtins.str] = None,
                           compartment_id: Optional[_builtins.str] = None,
                           condition_count: Optional[_builtins.int] = None,
                           condition_filter: Optional[_builtins.str] = None,
                           ...
                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsConditionsResult:
    """
    ...
    test_conditions = oci.identity.get_domains_conditions(idcs_endpoint=test_domain["url"],
        condition_count=int(condition_condition_count),
        ...
        start_index=int(condition_start_index))
    ```
    ...
    :param _builtins.int condition_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str condition_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    __args__['conditionCount'] = condition_count
    __args__['conditionFilter'] = condition_filter
    ...
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsConditions:getDomainsConditions', __args__, opts=opts, typ=GetDomainsConditionsResult).value

    return AwaitableGetDomainsConditionsResult(
        attribute_sets=pulumi.get(__ret__, 'attribute_sets'),
        attributes=pulumi.get(__ret__, 'attributes'),
        authorization=pulumi.get(__ret__, 'authorization'),
        compartment_id=pulumi.get(__ret__, 'compartment_id'),
        condition_count=pulumi.get(__ret__, 'condition_count'),
        condition_filter=pulumi.get(__ret__, 'condition_filter'),
...
def get_domains_conditions_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                  ...
                                  condition_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                  condition_filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                  ...
                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsConditionsResult]:
    """
    This data source provides the list of Conditions in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsConditions:getDomainsConditions', __args__, opts=opts, typ=GetDomainsConditionsResult)
    return __ret__.apply(lambda __response__: GetDomainsConditionsResult(
        ...
        condition_count=pulumi.get(__response__, 'condition_count'),
        condition_filter=pulumi.get(__response__, 'condition_filter'),
