...
class GetDomainsCustomerSecretKeyResult:
    ...
    def customer_secret_key_id(self) -> _builtins.str:
...
def get_domains_customer_secret_key(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                    attributes: Optional[_builtins.str] = None,
                                    authorization: Optional[_builtins.str] = None,
                                    customer_secret_key_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str customer_secret_key_id: ID of the resource
