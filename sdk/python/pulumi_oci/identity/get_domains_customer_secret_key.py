...
class GetDomainsCustomerSecretKeyResult:
    ...
    def idcs_created_bies(self) -> Optional[Sequence['outputs.GetDomainsCustomerSecretKeyIdcsCreatedByResult']]:
    ...
    def idcs_last_modified_bies(self) -> Optional[Sequence['outputs.GetDomainsCustomerSecretKeyIdcsLastModifiedByResult']]:
    ...
    @property
    @pulumi.getter
    def metas(self) -> Optional[Sequence['outputs.GetDomainsCustomerSecretKeyMetaResult']]:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GetDomainsCustomerSecretKeyTagResult']]:
    ...
    def urnietfparamsscimschemasoracleidcsextensionself_change_users(self) -> Optional[Sequence['outputs.GetDomainsCustomerSecretKeyUrnietfparamsscimschemasoracleidcsextensionselfChangeUserResult']]:
        return pulumi.get(self, "urnietfparamsscimschemasoracleidcsextensionself_change_users")

    @property
    @pulumi.getter
    def users(self) -> Optional[Sequence['outputs.GetDomainsCustomerSecretKeyUserResult']]:
