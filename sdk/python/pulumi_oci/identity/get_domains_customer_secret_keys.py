...
__all__ = [
    'GetDomainsCustomerSecretKeysResult',
    'AwaitableGetDomainsCustomerSecretKeysResult',
    'get_domains_customer_secret_keys',
    'get_domains_customer_secret_keys_output',
]

@pulumi.output_type
class GetDomainsCustomerSecretKeysResult:
    """
    A collection of values returned by getDomainsCustomerSecretKeys.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, customer_secret_key_count=None, customer_secret_key_filter=None, customer_secret_keys=None, id=None, idcs_endpoint=None, items_per_page=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        ...
        if customer_secret_key_count and not isinstance(customer_secret_key_count, int):
            raise TypeError("Expected argument 'customer_secret_key_count' to be a int")
        pulumi.set(__self__, "customer_secret_key_count", customer_secret_key_count)
        if customer_secret_key_filter and not isinstance(customer_secret_key_filter, str):
            raise TypeError("Expected argument 'customer_secret_key_filter' to be a str")
        pulumi.set(__self__, "customer_secret_key_filter", customer_secret_key_filter)
    ...
    @_builtins.property
    @pulumi.getter(name="customerSecretKeyCount")
    def customer_secret_key_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "customer_secret_key_count")

    @_builtins.property
    @pulumi.getter(name="customerSecretKeyFilter")
    def customer_secret_key_filter(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "customer_secret_key_filter")

    @_builtins.property
    @pulumi.getter(name="customerSecretKeys")
    def customer_secret_keys(self) -> Sequence['outputs.GetDomainsCustomerSecretKeysCustomerSecretKeyResult']:
        """
...
class AwaitableGetDomainsCustomerSecretKeysResult(GetDomainsCustomerSecretKeysResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsCustomerSecretKeysResult(
            attribute_sets=self.attribute_sets,
            attributes=self.attributes,
            authorization=self.authorization,
            compartment_id=self.compartment_id,
            customer_secret_key_count=self.customer_secret_key_count,
            customer_secret_key_filter=self.customer_secret_key_filter,
...
def get_domains_customer_secret_keys(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                     attributes: Optional[_builtins.str] = None,
                                     authorization: Optional[_builtins.str] = None,
                                     compartment_id: Optional[_builtins.str] = None,
                                     customer_secret_key_count: Optional[_builtins.int] = None,
                                     customer_secret_key_filter: Optional[_builtins.str] = None,
                                     ...
                                     opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsCustomerSecretKeysResult:
    """
    ...
    test_customer_secret_keys = oci.identity.get_domains_customer_secret_keys(idcs_endpoint=test_domain["url"],
        customer_secret_key_count=int(customer_secret_key_customer_secret_key_count),
        ...
        start_index=int(customer_secret_key_start_index))
    ```
    ...
    :param _builtins.int customer_secret_key_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str customer_secret_key_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    __args__['customerSecretKeyCount'] = customer_secret_key_count
    __args__['customerSecretKeyFilter'] = customer_secret_key_filter
...
def get_domains_customer_secret_keys_output(attribute_sets: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                                            ...
                                            customer_secret_key_count: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                            customer_secret_key_filter: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                            ...
                                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsCustomerSecretKeysResult]:
    """
    This data source provides the list of Customer Secret Keys in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsCustomerSecretKeys:getDomainsCustomerSecretKeys', __args__, opts=opts, typ=GetDomainsCustomerSecretKeysResult)
    return __ret__.apply(lambda __response__: GetDomainsCustomerSecretKeysResult(
        ...
        customer_secret_key_count=pulumi.get(__response__, 'customer_secret_key_count'),
        customer_secret_key_filter=pulumi.get(__response__, 'customer_secret_key_filter'),
