...
def get_domains_dynamic_resource_group(attribute_sets: Optional[Sequence[str]] = None,
    ...
    test_dynamic_resource_group = oci.Identity.get_domains_dynamic_resource_group(dynamic_resource_group_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetDomainsDynamicResourceGroupResult(
        ...
        dynamic_group_app_roles=__ret__.dynamic_group_app_roles,
        dynamic_resource_group_id=__ret__.dynamic_resource_group_id,
        ...
        matching_rule=__ret__.matching_rule,
        metas=__ret__.metas,
        ocid=__ret__.ocid,
