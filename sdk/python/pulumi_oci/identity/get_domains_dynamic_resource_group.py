...
class GetDomainsDynamicResourceGroupResult:
    ...
    def dynamic_resource_group_id(self) -> _builtins.str:
    ...
    def matching_rule(self) -> _builtins.str:
        """
...
def get_domains_dynamic_resource_group(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                       attributes: Optional[_builtins.str] = None,
                                       authorization: Optional[_builtins.str] = None,
                                       dynamic_resource_group_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str dynamic_resource_group_id: ID of the resource
