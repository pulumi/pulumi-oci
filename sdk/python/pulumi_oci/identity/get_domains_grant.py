...
class GetDomainsGrantResult:
    ...
    def grant_mechanism(self) -> builtins.str:
        """
    ...
    def granted_attribute_values_json(self) -> builtins.str:
        """
    ...
    def is_fulfilled(self) -> builtins.bool:
        """
...
def get_domains_grant(attribute_sets: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.str grant_id: ID of the resource
...
def get_domains_grant_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
