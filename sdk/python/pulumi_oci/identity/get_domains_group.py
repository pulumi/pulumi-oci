...
class GetDomainsGroupResult:
    ...
    def non_unique_display_name(self) -> _builtins.str:
        """
...
def get_domains_group(attribute_sets: Optional[Sequence[_builtins.str]] = None,
    ...
    :param _builtins.str group_id: ID of the resource
