...
__all__ = [
    'GetDomainsGroupsResult',
    'AwaitableGetDomainsGroupsResult',
    'get_domains_groups',
    'get_domains_groups_output',
]

@pulumi.output_type
class GetDomainsGroupsResult:
    """
    A collection of values returned by getDomainsGroups.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, group_count=None, group_filter=None, groups=None, id=None, idcs_endpoint=None, items_per_page=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        ...
        if group_filter and not isinstance(group_filter, str):
            raise TypeError("Expected argument 'group_filter' to be a str")
    ...
    def group_filter(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "group_filter")

    @_builtins.property
    @pulumi.getter
    def groups(self) -> Sequence['outputs.GetDomainsGroupsGroupResult']:
        """
        The list of groups.
        """
...
class AwaitableGetDomainsGroupsResult(GetDomainsGroupsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsGroupsResult(
...
def get_domains_groups(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                       ...
                       group_filter: Optional[_builtins.str] = None,
                       ...
                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsGroupsResult:
    """
    ...
    test_groups = oci.identity.get_domains_groups(idcs_endpoint=test_domain["url"],
        group_count=int(group_group_count),
        ...
        start_index=int(group_start_index))
    ```
    ...
    :param _builtins.int group_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str group_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    __args__['groupCount'] = group_count
    __args__['groupFilter'] = group_filter
    ...
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsGroups:getDomainsGroups', __args__, opts=opts, typ=GetDomainsGroupsResult).value

    return AwaitableGetDomainsGroupsResult(
        attribute_sets=pulumi.get(__ret__, 'attribute_sets'),
        attributes=pulumi.get(__ret__, 'attributes'),
        authorization=pulumi.get(__ret__, 'authorization'),
        compartment_id=pulumi.get(__ret__, 'compartment_id'),
        group_count=pulumi.get(__ret__, 'group_count'),
        group_filter=pulumi.get(__ret__, 'group_filter'),
...
def get_domains_groups_output(attribute_sets: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                              ...
                              group_count: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                              group_filter: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                              ...
                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsGroupsResult]:
    """
    This data source provides the list of Groups in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsGroups:getDomainsGroups', __args__, opts=opts, typ=GetDomainsGroupsResult)
    return __ret__.apply(lambda __response__: GetDomainsGroupsResult(
        ...
        group_filter=pulumi.get(__response__, 'group_filter'),
