...
__all__ = [
    'GetDomainsIdentityProofingProviderResult',
    'AwaitableGetDomainsIdentityProofingProviderResult',
    'get_domains_identity_proofing_provider',
    'get_domains_identity_proofing_provider_output',
]

@pulumi.output_type
class GetDomainsIdentityProofingProviderResult:
    """
    A collection of values returned by getDomainsIdentityProofingProvider.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, claim_mappings=None, compartment_ocid=None, configurations=None, delete_in_progress=None, description=None, domain_ocid=None, id=None, idcs_created_bies=None, idcs_endpoint=None, idcs_last_modified_bies=None, idcs_last_upgraded_in_release=None, idcs_locked_bies=None, idcs_locked_on=None, idcs_locked_operations=None, idcs_prevented_operations=None, identity_proofing_provider_id=None, identity_proofing_provider_provider=None, metas=None, name=None, ocid=None, resource_type_schema_version=None, runtime_datas=None, schemas=None, status=None, tenancy_ocid=None):
        ...
        if claim_mappings and not isinstance(claim_mappings, list):
            raise TypeError("Expected argument 'claim_mappings' to be a list")
        ...
        if idcs_locked_bies and not isinstance(idcs_locked_bies, list):
            raise TypeError("Expected argument 'idcs_locked_bies' to be a list")
        pulumi.set(__self__, "idcs_locked_bies", idcs_locked_bies)
        if idcs_locked_on and not isinstance(idcs_locked_on, str):
            raise TypeError("Expected argument 'idcs_locked_on' to be a str")
        pulumi.set(__self__, "idcs_locked_on", idcs_locked_on)
        if idcs_locked_operations and not isinstance(idcs_locked_operations, list):
            raise TypeError("Expected argument 'idcs_locked_operations' to be a list")
        ...
        if identity_proofing_provider_id and not isinstance(identity_proofing_provider_id, str):
            raise TypeError("Expected argument 'identity_proofing_provider_id' to be a str")
        pulumi.set(__self__, "identity_proofing_provider_id", identity_proofing_provider_id)
        if identity_proofing_provider_provider and not isinstance(identity_proofing_provider_provider, str):
            raise TypeError("Expected argument 'identity_proofing_provider_provider' to be a str")
    ...
    def claim_mappings(self) -> Sequence['outputs.GetDomainsIdentityProofingProviderClaimMappingResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def configurations(self) -> Sequence['outputs.GetDomainsIdentityProofingProviderConfigurationResult']:
        """
    ...
    def idcs_created_bies(self) -> Sequence['outputs.GetDomainsIdentityProofingProviderIdcsCreatedByResult']:
        """
    ...
    def idcs_last_modified_bies(self) -> Sequence['outputs.GetDomainsIdentityProofingProviderIdcsLastModifiedByResult']:
        """
    ...
    def idcs_locked_bies(self) -> Sequence['outputs.GetDomainsIdentityProofingProviderIdcsLockedByResult']:
        """
    ...
    def idcs_locked_on(self) -> _builtins.str:
        """
    ...
    def idcs_locked_operations(self) -> Sequence[_builtins.str]:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="identityProofingProviderId")
    def identity_proofing_provider_id(self) -> _builtins.str:
        return pulumi.get(self, "identity_proofing_provider_id")

    @_builtins.property
    @pulumi.getter(name="identityProofingProviderProvider")
    def identity_proofing_provider_provider(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def metas(self) -> Sequence['outputs.GetDomainsIdentityProofingProviderMetaResult']:
        """
    ...
    def runtime_datas(self) -> Sequence['outputs.GetDomainsIdentityProofingProviderRuntimeDataResult']:
        """
...
class AwaitableGetDomainsIdentityProofingProviderResult(GetDomainsIdentityProofingProviderResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsIdentityProofingProviderResult(
            ...
            idcs_locked_bies=self.idcs_locked_bies,
            idcs_locked_on=self.idcs_locked_on,
            idcs_locked_operations=self.idcs_locked_operations,
            idcs_prevented_operations=self.idcs_prevented_operations,
            identity_proofing_provider_id=self.identity_proofing_provider_id,
            identity_proofing_provider_provider=self.identity_proofing_provider_provider,
            metas=self.metas,
            name=self.name,
            ocid=self.ocid,
...
def get_domains_identity_proofing_provider(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                           attributes: Optional[_builtins.str] = None,
                                           authorization: Optional[_builtins.str] = None,
                                           idcs_endpoint: Optional[_builtins.str] = None,
                                           identity_proofing_provider_id: Optional[_builtins.str] = None,
                                           resource_type_schema_version: Optional[_builtins.str] = None,
                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsIdentityProofingProviderResult:
    """
    ...
    test_identity_proofing_provider = oci.Identity.get_domains_identity_proofing_provider(idcs_endpoint=test_domain["url"],
        identity_proofing_provider_id=test_identity_proofing_provider_oci_identity_domains_identity_proofing_provider["id"],
        attribute_sets=["all"],
        attributes="",
    ...
    :param _builtins.str identity_proofing_provider_id: ID of the resource.
    ...
    __args__['identityProofingProviderId'] = identity_proofing_provider_id
    __args__['resourceTypeSchemaVersion'] = resource_type_schema_version
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsIdentityProofingProvider:getDomainsIdentityProofingProvider', __args__, opts=opts, typ=GetDomainsIdentityProofingProviderResult).value

    return AwaitableGetDomainsIdentityProofingProviderResult(
        attribute_sets=pulumi.get(__ret__, 'attribute_sets'),
        attributes=pulumi.get(__ret__, 'attributes'),
        authorization=pulumi.get(__ret__, 'authorization'),
        claim_mappings=pulumi.get(__ret__, 'claim_mappings'),
        ...
        idcs_locked_bies=pulumi.get(__ret__, 'idcs_locked_bies'),
        idcs_locked_on=pulumi.get(__ret__, 'idcs_locked_on'),
        idcs_locked_operations=pulumi.get(__ret__, 'idcs_locked_operations'),
        idcs_prevented_operations=pulumi.get(__ret__, 'idcs_prevented_operations'),
        identity_proofing_provider_id=pulumi.get(__ret__, 'identity_proofing_provider_id'),
        identity_proofing_provider_provider=pulumi.get(__ret__, 'identity_proofing_provider_provider'),
...
def get_domains_identity_proofing_provider_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                                  ...
                                                  identity_proofing_provider_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                  resource_type_schema_version: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsIdentityProofingProviderResult]:
    """
    This data source provides details about a specific Identity Proofing Provider resource in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsIdentityProofingProvider:getDomainsIdentityProofingProvider', __args__, opts=opts, typ=GetDomainsIdentityProofingProviderResult)
    return __ret__.apply(lambda __response__: GetDomainsIdentityProofingProviderResult(
        attribute_sets=pulumi.get(__response__, 'attribute_sets'),
        attributes=pulumi.get(__response__, 'attributes'),
        authorization=pulumi.get(__response__, 'authorization'),
        claim_mappings=pulumi.get(__response__, 'claim_mappings'),
        ...
        idcs_locked_bies=pulumi.get(__response__, 'idcs_locked_bies'),
        idcs_locked_on=pulumi.get(__response__, 'idcs_locked_on'),
        idcs_locked_operations=pulumi.get(__response__, 'idcs_locked_operations'),
        idcs_prevented_operations=pulumi.get(__response__, 'idcs_prevented_operations'),
        identity_proofing_provider_id=pulumi.get(__response__, 'identity_proofing_provider_id'),
        identity_proofing_provider_provider=pulumi.get(__response__, 'identity_proofing_provider_provider'),
