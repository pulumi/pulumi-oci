...
__all__ = [
    'GetDomainsIdentityProofingProviderTemplateResult',
    'AwaitableGetDomainsIdentityProofingProviderTemplateResult',
    'get_domains_identity_proofing_provider_template',
    'get_domains_identity_proofing_provider_template_output',
]

@pulumi.output_type
class GetDomainsIdentityProofingProviderTemplateResult:
    """
    A collection of values returned by getDomainsIdentityProofingProviderTemplate.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, compartment_ocid=None, configurations=None, delete_in_progress=None, domain_ocid=None, id=None, idcs_created_bies=None, idcs_endpoint=None, idcs_last_modified_bies=None, idcs_last_upgraded_in_release=None, idcs_locked_bies=None, idcs_locked_on=None, idcs_locked_operations=None, idcs_prevented_operations=None, identity_proofing_provider_template_id=None, identity_proofing_provider_template_provider=None, metas=None, ocid=None, resource_type_schema_version=None, schemas=None, service_types=None, tenancy_ocid=None, verification_url=None):
        ...
        if identity_proofing_provider_template_id and not isinstance(identity_proofing_provider_template_id, str):
            raise TypeError("Expected argument 'identity_proofing_provider_template_id' to be a str")
        pulumi.set(__self__, "identity_proofing_provider_template_id", identity_proofing_provider_template_id)
        if identity_proofing_provider_template_provider and not isinstance(identity_proofing_provider_template_provider, str):
            raise TypeError("Expected argument 'identity_proofing_provider_template_provider' to be a str")
        ...
        if verification_url and not isinstance(verification_url, str):
            raise TypeError("Expected argument 'verification_url' to be a str")
    ...
    @_builtins.property
    @pulumi.getter
    def configurations(self) -> Sequence['outputs.GetDomainsIdentityProofingProviderTemplateConfigurationResult']:
        """
    ...
    def idcs_created_bies(self) -> Sequence['outputs.GetDomainsIdentityProofingProviderTemplateIdcsCreatedByResult']:
        """
    ...
    def idcs_last_modified_bies(self) -> Sequence['outputs.GetDomainsIdentityProofingProviderTemplateIdcsLastModifiedByResult']:
        """
    ...
    def idcs_locked_bies(self) -> Sequence['outputs.GetDomainsIdentityProofingProviderTemplateIdcsLockedByResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="identityProofingProviderTemplateId")
    def identity_proofing_provider_template_id(self) -> _builtins.str:
        return pulumi.get(self, "identity_proofing_provider_template_id")

    @_builtins.property
    @pulumi.getter(name="identityProofingProviderTemplateProvider")
    def identity_proofing_provider_template_provider(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def metas(self) -> Sequence['outputs.GetDomainsIdentityProofingProviderTemplateMetaResult']:
        """
    ...
    def verification_url(self) -> _builtins.str:
        """
        verification URL.
        """
...
class AwaitableGetDomainsIdentityProofingProviderTemplateResult(GetDomainsIdentityProofingProviderTemplateResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsIdentityProofingProviderTemplateResult(
            ...
            identity_proofing_provider_template_id=self.identity_proofing_provider_template_id,
            identity_proofing_provider_template_provider=self.identity_proofing_provider_template_provider,
            metas=self.metas,
            ocid=self.ocid,
...
def get_domains_identity_proofing_provider_template(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                                    attributes: Optional[_builtins.str] = None,
                                                    authorization: Optional[_builtins.str] = None,
                                                    idcs_endpoint: Optional[_builtins.str] = None,
                                                    identity_proofing_provider_template_id: Optional[_builtins.str] = None,
                                                    resource_type_schema_version: Optional[_builtins.str] = None,
                                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsIdentityProofingProviderTemplateResult:
    """
    ...
    :param _builtins.str identity_proofing_provider_template_id: ID of the resource.
    ...
    __args__['identityProofingProviderTemplateId'] = identity_proofing_provider_template_id
    __args__['resourceTypeSchemaVersion'] = resource_type_schema_version
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsIdentityProofingProviderTemplate:getDomainsIdentityProofingProviderTemplate', __args__, opts=opts, typ=GetDomainsIdentityProofingProviderTemplateResult).value

    return AwaitableGetDomainsIdentityProofingProviderTemplateResult(
        ...
        identity_proofing_provider_template_id=pulumi.get(__ret__, 'identity_proofing_provider_template_id'),
        identity_proofing_provider_template_provider=pulumi.get(__ret__, 'identity_proofing_provider_template_provider'),
        ...
        verification_url=pulumi.get(__ret__, 'verification_url'))
def get_domains_identity_proofing_provider_template_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                                           ...
                                                           identity_proofing_provider_template_id: Optional[pulumi.Input[_builtins.str]] = None,
                                                           resource_type_schema_version: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsIdentityProofingProviderTemplateResult]:
    """
    This data source provides details about a specific Identity Proofing Provider Template resource in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsIdentityProofingProviderTemplate:getDomainsIdentityProofingProviderTemplate', __args__, opts=opts, typ=GetDomainsIdentityProofingProviderTemplateResult)
    return __ret__.apply(lambda __response__: GetDomainsIdentityProofingProviderTemplateResult(
        ...
        identity_proofing_provider_template_id=pulumi.get(__response__, 'identity_proofing_provider_template_id'),
        identity_proofing_provider_template_provider=pulumi.get(__response__, 'identity_proofing_provider_template_provider'),
        ...
        verification_url=pulumi.get(__response__, 'verification_url')))
