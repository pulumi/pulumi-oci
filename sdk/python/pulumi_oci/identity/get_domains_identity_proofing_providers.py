...
__all__ = [
    'GetDomainsIdentityProofingProvidersResult',
    'AwaitableGetDomainsIdentityProofingProvidersResult',
    'get_domains_identity_proofing_providers',
    'get_domains_identity_proofing_providers_output',
]

@pulumi.output_type
class GetDomainsIdentityProofingProvidersResult:
    """
    A collection of values returned by getDomainsIdentityProofingProviders.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, identity_proofing_provider_count=None, identity_proofing_provider_filter=None, identity_proofing_providers=None, items_per_page=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        ...
        if identity_proofing_provider_count and not isinstance(identity_proofing_provider_count, int):
            raise TypeError("Expected argument 'identity_proofing_provider_count' to be a int")
        pulumi.set(__self__, "identity_proofing_provider_count", identity_proofing_provider_count)
        if identity_proofing_provider_filter and not isinstance(identity_proofing_provider_filter, str):
            raise TypeError("Expected argument 'identity_proofing_provider_filter' to be a str")
        pulumi.set(__self__, "identity_proofing_provider_filter", identity_proofing_provider_filter)
        if identity_proofing_providers and not isinstance(identity_proofing_providers, list):
            raise TypeError("Expected argument 'identity_proofing_providers' to be a list")
        pulumi.set(__self__, "identity_proofing_providers", identity_proofing_providers)
    ...
    @_builtins.property
    @pulumi.getter(name="identityProofingProviderCount")
    def identity_proofing_provider_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "identity_proofing_provider_count")

    @_builtins.property
    @pulumi.getter(name="identityProofingProviderFilter")
    def identity_proofing_provider_filter(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "identity_proofing_provider_filter")

    @_builtins.property
    @pulumi.getter(name="identityProofingProviders")
    def identity_proofing_providers(self) -> Sequence['outputs.GetDomainsIdentityProofingProvidersIdentityProofingProviderResult']:
        """
        The list of identity_proofing_providers.
        """
        return pulumi.get(self, "identity_proofing_providers")
...
class AwaitableGetDomainsIdentityProofingProvidersResult(GetDomainsIdentityProofingProvidersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsIdentityProofingProvidersResult(
            ...
            identity_proofing_provider_count=self.identity_proofing_provider_count,
            identity_proofing_provider_filter=self.identity_proofing_provider_filter,
            identity_proofing_providers=self.identity_proofing_providers,
...
def get_domains_identity_proofing_providers(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                            ...
                                            identity_proofing_provider_count: Optional[_builtins.int] = None,
                                            identity_proofing_provider_filter: Optional[_builtins.str] = None,
                                            ...
                                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsIdentityProofingProvidersResult:
    """
    ...
    :param _builtins.int identity_proofing_provider_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str identity_proofing_provider_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    __args__['identityProofingProviderCount'] = identity_proofing_provider_count
    __args__['identityProofingProviderFilter'] = identity_proofing_provider_filter
    __args__['resourceTypeSchemaVersion'] = resource_type_schema_version
    __args__['sortBy'] = sort_by
    __args__['sortOrder'] = sort_order
    __args__['startIndex'] = start_index
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsIdentityProofingProviders:getDomainsIdentityProofingProviders', __args__, opts=opts, typ=GetDomainsIdentityProofingProvidersResult).value

    return AwaitableGetDomainsIdentityProofingProvidersResult(
        ...
        identity_proofing_provider_count=pulumi.get(__ret__, 'identity_proofing_provider_count'),
        identity_proofing_provider_filter=pulumi.get(__ret__, 'identity_proofing_provider_filter'),
        identity_proofing_providers=pulumi.get(__ret__, 'identity_proofing_providers'),
...
def get_domains_identity_proofing_providers_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                                   ...
                                                   identity_proofing_provider_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                                   identity_proofing_provider_filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                   ...
                                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsIdentityProofingProvidersResult]:
    """
    This data source provides the list of Identity Proofing Providers in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsIdentityProofingProviders:getDomainsIdentityProofingProviders', __args__, opts=opts, typ=GetDomainsIdentityProofingProvidersResult)
    return __ret__.apply(lambda __response__: GetDomainsIdentityProofingProvidersResult(
        ...
        identity_proofing_provider_count=pulumi.get(__response__, 'identity_proofing_provider_count'),
        identity_proofing_provider_filter=pulumi.get(__response__, 'identity_proofing_provider_filter'),
        identity_proofing_providers=pulumi.get(__response__, 'identity_proofing_providers'),
