...
def get_domains_identity_provider(attribute_sets: Optional[Sequence[str]] = None,
    ...
    return AwaitableGetDomainsIdentityProviderResult(
        assertion_attribute=__ret__.assertion_attribute,
        attribute_sets=__ret__.attribute_sets,
        attributes=__ret__.attributes,
        authn_request_binding=__ret__.authn_request_binding,
        authorization=__ret__.authorization,
        compartment_ocid=__ret__.compartment_ocid,
        correlation_policies=__ret__.correlation_policies,
        ...
        idp_sso_url=__ret__.idp_sso_url,
        include_signing_cert_in_signature=__ret__.include_signing_cert_in_signature,
        jit_user_prov_assigned_groups=__ret__.jit_user_prov_assigned_groups,
        jit_user_prov_attribute_update_enabled=__ret__.jit_user_prov_attribute_update_enabled,
        jit_user_prov_attributes=__ret__.jit_user_prov_attributes,
        jit_user_prov_create_user_enabled=__ret__.jit_user_prov_create_user_enabled,
        jit_user_prov_enabled=__ret__.jit_user_prov_enabled,
        jit_user_prov_group_assertion_attribute_enabled=__ret__.jit_user_prov_group_assertion_attribute_enabled,
        jit_user_prov_group_assignment_method=__ret__.jit_user_prov_group_assignment_method,
        jit_user_prov_group_mapping_mode=__ret__.jit_user_prov_group_mapping_mode,
        jit_user_prov_group_mappings=__ret__.jit_user_prov_group_mappings,
        jit_user_prov_group_saml_attribute_name=__ret__.jit_user_prov_group_saml_attribute_name,
        jit_user_prov_group_static_list_enabled=__ret__.jit_user_prov_group_static_list_enabled,
        jit_user_prov_ignore_error_on_absent_groups=__ret__.jit_user_prov_ignore_error_on_absent_groups,
        logout_binding=__ret__.logout_binding,
        logout_enabled=__ret__.logout_enabled,
        logout_request_url=__ret__.logout_request_url,
        logout_response_url=__ret__.logout_response_url,
        metadata=__ret__.metadata,
        metas=__ret__.metas,
        name_id_format=__ret__.name_id_format,
        ocid=__ret__.ocid,
        partner_name=__ret__.partner_name,
        partner_provider_id=__ret__.partner_provider_id,
        requested_authentication_contexts=__ret__.requested_authentication_contexts,
        require_force_authn=__ret__.require_force_authn,
        requires_encrypted_assertion=__ret__.requires_encrypted_assertion,
        resource_type_schema_version=__ret__.resource_type_schema_version,
        saml_ho_krequired=__ret__.saml_ho_krequired,
        schemas=__ret__.schemas,
        service_instance_identifier=__ret__.service_instance_identifier,
        shown_on_login_page=__ret__.shown_on_login_page,
        signature_hash_algorithm=__ret__.signature_hash_algorithm,
        signing_certificate=__ret__.signing_certificate,
        succinct_id=__ret__.succinct_id,
        tags=__ret__.tags,
        tenancy_ocid=__ret__.tenancy_ocid,
        tenant_provider_id=__ret__.tenant_provider_id,
        type=__ret__.type,
        urnietfparamsscimschemasoracleidcsextensionsocial_identity_providers=__ret__.urnietfparamsscimschemasoracleidcsextensionsocial_identity_providers,
        urnietfparamsscimschemasoracleidcsextensionx509identity_providers=__ret__.urnietfparamsscimschemasoracleidcsextensionx509identity_providers,
        user_mapping_method=__ret__.user_mapping_method,
        user_mapping_store_attribute=__ret__.user_mapping_store_attribute)
