...
__all__ = [
    'GetDomainsIdentityProvidersResult',
    'AwaitableGetDomainsIdentityProvidersResult',
    'get_domains_identity_providers',
    'get_domains_identity_providers_output',
]

@pulumi.output_type
class GetDomainsIdentityProvidersResult:
    """
    A collection of values returned by getDomainsIdentityProviders.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, identity_provider_count=None, identity_provider_filter=None, identity_providers=None, items_per_page=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        ...
        if identity_provider_count and not isinstance(identity_provider_count, int):
            raise TypeError("Expected argument 'identity_provider_count' to be a int")
        pulumi.set(__self__, "identity_provider_count", identity_provider_count)
        if identity_provider_filter and not isinstance(identity_provider_filter, str):
            raise TypeError("Expected argument 'identity_provider_filter' to be a str")
        pulumi.set(__self__, "identity_provider_filter", identity_provider_filter)
    ...
    @property
    @pulumi.getter(name="identityProviderCount")
    def identity_provider_count(self) -> Optional[builtins.int]:
        return pulumi.get(self, "identity_provider_count")

    @property
    @pulumi.getter(name="identityProviderFilter")
    def identity_provider_filter(self) -> Optional[builtins.str]:
        return pulumi.get(self, "identity_provider_filter")

    @property
    @pulumi.getter(name="identityProviders")
    def identity_providers(self) -> Sequence['outputs.GetDomainsIdentityProvidersIdentityProviderResult']:
        """
...
class AwaitableGetDomainsIdentityProvidersResult(GetDomainsIdentityProvidersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsIdentityProvidersResult(
            ...
            identity_provider_filter=self.identity_provider_filter,
...
def get_domains_identity_providers(attribute_sets: Optional[Sequence[builtins.str]] = None,
                                   ...
                                   identity_provider_count: Optional[builtins.int] = None,
                                   identity_provider_filter: Optional[builtins.str] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsIdentityProvidersResult:
    """
    ...
    :param builtins.int identity_provider_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param builtins.str identity_provider_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    __args__['identityProviderCount'] = identity_provider_count
    __args__['identityProviderFilter'] = identity_provider_filter
...
def get_domains_identity_providers_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                          ...
                                          identity_provider_count: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                          identity_provider_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          ...
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsIdentityProvidersResult]:
    """
    This data source provides the list of Identity Providers in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsIdentityProviders:getDomainsIdentityProviders', __args__, opts=opts, typ=GetDomainsIdentityProvidersResult)
    return __ret__.apply(lambda __response__: GetDomainsIdentityProvidersResult(
        ...
        identity_provider_count=pulumi.get(__response__, 'identity_provider_count'),
        identity_provider_filter=pulumi.get(__response__, 'identity_provider_filter'),
