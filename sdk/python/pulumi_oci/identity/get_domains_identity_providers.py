...
class GetDomainsIdentityProvidersResult:
    ...
    def identity_provider_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "identity_provider_count")

    @_builtins.property
    @pulumi.getter(name="identityProviderFilter")
    def identity_provider_filter(self) -> Optional[_builtins.str]:
...
def get_domains_identity_providers(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                   ...
                                   identity_provider_count: Optional[_builtins.int] = None,
                                   identity_provider_filter: Optional[_builtins.str] = None,
    ...
    test_identity_providers = oci.identity.get_domains_identity_providers(idcs_endpoint=test_domain["url"],
        identity_provider_count=int(identity_provider_identity_provider_count),
        ...
        start_index=int(identity_provider_start_index))
    ```
    ...
    :param _builtins.int identity_provider_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str identity_provider_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
...
def get_domains_identity_providers_output(attribute_sets: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                                          ...
                                          identity_provider_count: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                          identity_provider_filter: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
