...
def get_domains_identity_providers(attribute_sets: Optional[Sequence[str]] = None,
    ...
    test_identity_providers = oci.Identity.get_domains_identity_providers(idcs_endpoint=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        identity_provider_count=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        identity_provider_filter=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        attribute_sets=[],
        attributes="",
...
def get_domains_identity_providers_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                          ...
                                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDomainsIdentityProvidersResult]:
    """
    This data source provides the list of Identity Providers in Oracle Cloud Infrastructure Identity Domains service.
