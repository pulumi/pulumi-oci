...
class GetDomainsIdentitySettingsResult:
    ...
    def identity_settings(self) -> Optional[Sequence['outputs.GetDomainsIdentitySettingsIdentitySettingResult']]:
...
@_utilities.lift_output_func(get_domains_identity_settings)
