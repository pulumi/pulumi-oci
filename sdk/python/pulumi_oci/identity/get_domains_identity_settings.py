...
__all__ = [
    'GetDomainsIdentitySettingsResult',
    'AwaitableGetDomainsIdentitySettingsResult',
    'get_domains_identity_settings',
    'get_domains_identity_settings_output',
]

@pulumi.output_type
class GetDomainsIdentitySettingsResult:
    """
    A collection of values returned by getDomainsIdentitySettings.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, identity_settings=None, items_per_page=None, resource_type_schema_version=None, schemas=None, start_index=None, total_results=None):
        ...
        if identity_settings and not isinstance(identity_settings, list):
            raise TypeError("Expected argument 'identity_settings' to be a list")
    ...
    def identity_settings(self) -> Sequence['outputs.GetDomainsIdentitySettingsIdentitySettingResult']:
        """
...
class AwaitableGetDomainsIdentitySettingsResult(GetDomainsIdentitySettingsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsIdentitySettingsResult(
            ...
            identity_settings=self.identity_settings,
...
def get_domains_identity_settings(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsIdentitySettingsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsIdentitySettings:getDomainsIdentitySettings', __args__, opts=opts, typ=GetDomainsIdentitySettingsResult).value

    return AwaitableGetDomainsIdentitySettingsResult(
        ...
        identity_settings=pulumi.get(__ret__, 'identity_settings'),
...
def get_domains_identity_settings_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsIdentitySettingsResult]:
    """
    This data source provides the list of Identity Settings in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsIdentitySettings:getDomainsIdentitySettings', __args__, opts=opts, typ=GetDomainsIdentitySettingsResult)
    return __ret__.apply(lambda __response__: GetDomainsIdentitySettingsResult(
        ...
        identity_settings=pulumi.get(__response__, 'identity_settings'),
