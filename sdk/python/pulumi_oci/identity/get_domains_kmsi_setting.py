...
class GetDomainsKmsiSettingResult:
    ...
    def kmsi_feature_enabled(self) -> builtins.bool:
        """
    ...
    def kmsi_prompt_enabled(self) -> builtins.bool:
        """
    ...
    def kmsi_setting_id(self) -> builtins.str:
        return pulumi.get(self, "kmsi_setting_id")

    @property
    @pulumi.getter(name="lastEnabledOn")
    def last_enabled_on(self) -> builtins.str:
        """
    ...
    def last_used_validity_in_days(self) -> builtins.int:
        """
    ...
    def max_allowed_sessions(self) -> builtins.int:
        """
    ...
    def token_validity_in_days(self) -> builtins.int:
        """
    ...
    def tou_prompt_disabled(self) -> builtins.bool:
        """
...
def get_domains_kmsi_setting(attribute_sets: Optional[Sequence[builtins.str]] = None,
                             attributes: Optional[builtins.str] = None,
                             authorization: Optional[builtins.str] = None,
                             idcs_endpoint: Optional[builtins.str] = None,
                             kmsi_setting_id: Optional[builtins.str] = None,
    ...
    :param builtins.str kmsi_setting_id: ID of the resource
...
def get_domains_kmsi_setting_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsKmsiSetting:getDomainsKmsiSetting', __args__, opts=opts, typ=GetDomainsKmsiSettingResult)
    return __ret__.apply(lambda __response__: GetDomainsKmsiSettingResult(
        ...
        kmsi_feature_enabled=pulumi.get(__response__, 'kmsi_feature_enabled'),
        kmsi_prompt_enabled=pulumi.get(__response__, 'kmsi_prompt_enabled'),
        kmsi_setting_id=pulumi.get(__response__, 'kmsi_setting_id'),
        last_enabled_on=pulumi.get(__response__, 'last_enabled_on'),
        last_used_validity_in_days=pulumi.get(__response__, 'last_used_validity_in_days'),
        max_allowed_sessions=pulumi.get(__response__, 'max_allowed_sessions'),
        ...
        token_validity_in_days=pulumi.get(__response__, 'token_validity_in_days'),
        tou_prompt_disabled=pulumi.get(__response__, 'tou_prompt_disabled')))
