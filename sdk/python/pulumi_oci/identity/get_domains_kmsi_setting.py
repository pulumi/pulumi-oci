...
def get_domains_kmsi_setting(attribute_sets: Optional[Sequence[str]] = None,
    ...
    test_kmsi_setting = oci.Identity.get_domains_kmsi_setting(idcs_endpoint=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        kmsi_setting_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        attribute_sets=[],
        attributes="",
    ...
    return AwaitableGetDomainsKmsiSettingResult(
        ...
        kmsi_feature_enabled=__ret__.kmsi_feature_enabled,
        kmsi_prompt_enabled=__ret__.kmsi_prompt_enabled,
        kmsi_setting_id=__ret__.kmsi_setting_id,
        last_enabled_on=__ret__.last_enabled_on,
        last_used_validity_in_days=__ret__.last_used_validity_in_days,
        max_allowed_sessions=__ret__.max_allowed_sessions,
        metas=__ret__.metas,
        ocid=__ret__.ocid,
        ...
        token_validity_in_days=__ret__.token_validity_in_days,
        tou_prompt_disabled=__ret__.tou_prompt_disabled)
