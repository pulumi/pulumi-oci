...
__all__ = [
    'GetDomainsKmsiSettingsResult',
    'AwaitableGetDomainsKmsiSettingsResult',
    'get_domains_kmsi_settings',
    'get_domains_kmsi_settings_output',
]

@pulumi.output_type
class GetDomainsKmsiSettingsResult:
    """
    A collection of values returned by getDomainsKmsiSettings.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, kmsi_settings=None, resource_type_schema_version=None, schemas=None, start_index=None, total_results=None):
        ...
        if kmsi_settings and not isinstance(kmsi_settings, list):
            raise TypeError("Expected argument 'kmsi_settings' to be a list")
        pulumi.set(__self__, "kmsi_settings", kmsi_settings)
    ...
    @property
    @pulumi.getter(name="kmsiSettings")
    def kmsi_settings(self) -> Sequence['outputs.GetDomainsKmsiSettingsKmsiSettingResult']:
        """
        The list of kmsi_settings.
        """
        return pulumi.get(self, "kmsi_settings")
...
class AwaitableGetDomainsKmsiSettingsResult(GetDomainsKmsiSettingsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsKmsiSettingsResult(
            ...
            kmsi_settings=self.kmsi_settings,
...
def get_domains_kmsi_settings(attribute_sets: Optional[Sequence[builtins.str]] = None,
                              ...
                              opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsKmsiSettingsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsKmsiSettings:getDomainsKmsiSettings', __args__, opts=opts, typ=GetDomainsKmsiSettingsResult).value

    return AwaitableGetDomainsKmsiSettingsResult(
        ...
        kmsi_settings=pulumi.get(__ret__, 'kmsi_settings'),
        resource_type_schema_version=pulumi.get(__ret__, 'resource_type_schema_version'),
        schemas=pulumi.get(__ret__, 'schemas'),
        start_index=pulumi.get(__ret__, 'start_index'),
        total_results=pulumi.get(__ret__, 'total_results'))
def get_domains_kmsi_settings_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                     ...
                                     opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsKmsiSettingsResult]:
    """
    This data source provides the list of Kmsi Settings in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsKmsiSettings:getDomainsKmsiSettings', __args__, opts=opts, typ=GetDomainsKmsiSettingsResult)
    return __ret__.apply(lambda __response__: GetDomainsKmsiSettingsResult(
        ...
        kmsi_settings=pulumi.get(__response__, 'kmsi_settings'),
