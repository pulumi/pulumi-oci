...
__all__ = [
    'GetDomainsMappedAttributeResult',
    'AwaitableGetDomainsMappedAttributeResult',
    'get_domains_mapped_attribute',
    'get_domains_mapped_attribute_output',
]

@pulumi.output_type
class GetDomainsMappedAttributeResult:
    """
    A collection of values returned by getDomainsMappedAttribute.
    """
    def __init__(__self__, attribute_mappings=None, attribute_sets=None, attributes=None, authorization=None, compartment_ocid=None, delete_in_progress=None, direction=None, domain_ocid=None, id=None, idcs_created_bies=None, idcs_endpoint=None, idcs_last_modified_bies=None, idcs_last_upgraded_in_release=None, idcs_prevented_operations=None, idcs_resource_type=None, mapped_attribute_id=None, metas=None, ocid=None, ref_resource_id=None, ref_resource_type=None, resource_type_schema_version=None, schemas=None, tags=None, tenancy_ocid=None):
        ...
        if idcs_resource_type and not isinstance(idcs_resource_type, str):
            raise TypeError("Expected argument 'idcs_resource_type' to be a str")
        pulumi.set(__self__, "idcs_resource_type", idcs_resource_type)
        if mapped_attribute_id and not isinstance(mapped_attribute_id, str):
            raise TypeError("Expected argument 'mapped_attribute_id' to be a str")
        ...
        if ref_resource_id and not isinstance(ref_resource_id, str):
            raise TypeError("Expected argument 'ref_resource_id' to be a str")
        pulumi.set(__self__, "ref_resource_id", ref_resource_id)
        if ref_resource_type and not isinstance(ref_resource_type, str):
            raise TypeError("Expected argument 'ref_resource_type' to be a str")
    ...
    def attribute_mappings(self) -> Sequence['outputs.GetDomainsMappedAttributeAttributeMappingResult']:
        """
    ...
    def idcs_created_bies(self) -> Sequence['outputs.GetDomainsMappedAttributeIdcsCreatedByResult']:
        """
    ...
    def idcs_last_modified_bies(self) -> Sequence['outputs.GetDomainsMappedAttributeIdcsLastModifiedByResult']:
        """
    ...
    def idcs_resource_type(self) -> _builtins.str:
        """
    ...
    def mapped_attribute_id(self) -> _builtins.str:
        return pulumi.get(self, "mapped_attribute_id")

    @_builtins.property
    @pulumi.getter
    def metas(self) -> Sequence['outputs.GetDomainsMappedAttributeMetaResult']:
        """
    ...
    def ref_resource_id(self) -> _builtins.str:
        """
    ...
    def ref_resource_type(self) -> _builtins.str:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def tags(self) -> Sequence['outputs.GetDomainsMappedAttributeTagResult']:
        """
...
class AwaitableGetDomainsMappedAttributeResult(GetDomainsMappedAttributeResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsMappedAttributeResult(
            ...
            idcs_resource_type=self.idcs_resource_type,
            mapped_attribute_id=self.mapped_attribute_id,
            metas=self.metas,
            ocid=self.ocid,
            ref_resource_id=self.ref_resource_id,
            ref_resource_type=self.ref_resource_type,
...
def get_domains_mapped_attribute(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                 attributes: Optional[_builtins.str] = None,
                                 authorization: Optional[_builtins.str] = None,
                                 idcs_endpoint: Optional[_builtins.str] = None,
                                 mapped_attribute_id: Optional[_builtins.str] = None,
                                 resource_type_schema_version: Optional[_builtins.str] = None,
                                 opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsMappedAttributeResult:
    """
    ...
    :param _builtins.str mapped_attribute_id: ID of the resource
    ...
    __args__['mappedAttributeId'] = mapped_attribute_id
    __args__['resourceTypeSchemaVersion'] = resource_type_schema_version
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsMappedAttribute:getDomainsMappedAttribute', __args__, opts=opts, typ=GetDomainsMappedAttributeResult).value

    return AwaitableGetDomainsMappedAttributeResult(
        ...
        idcs_resource_type=pulumi.get(__ret__, 'idcs_resource_type'),
        mapped_attribute_id=pulumi.get(__ret__, 'mapped_attribute_id'),
        metas=pulumi.get(__ret__, 'metas'),
        ocid=pulumi.get(__ret__, 'ocid'),
        ref_resource_id=pulumi.get(__ret__, 'ref_resource_id'),
        ref_resource_type=pulumi.get(__ret__, 'ref_resource_type'),
        resource_type_schema_version=pulumi.get(__ret__, 'resource_type_schema_version'),
        schemas=pulumi.get(__ret__, 'schemas'),
        tags=pulumi.get(__ret__, 'tags'),
        tenancy_ocid=pulumi.get(__ret__, 'tenancy_ocid'))
def get_domains_mapped_attribute_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                        ...
                                        opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsMappedAttributeResult]:
    """
    This data source provides details about a specific Mapped Attribute resource in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsMappedAttribute:getDomainsMappedAttribute', __args__, opts=opts, typ=GetDomainsMappedAttributeResult)
    return __ret__.apply(lambda __response__: GetDomainsMappedAttributeResult(
        ...
        idcs_resource_type=pulumi.get(__response__, 'idcs_resource_type'),
        mapped_attribute_id=pulumi.get(__response__, 'mapped_attribute_id'),
        metas=pulumi.get(__response__, 'metas'),
        ocid=pulumi.get(__response__, 'ocid'),
        ref_resource_id=pulumi.get(__response__, 'ref_resource_id'),
        ref_resource_type=pulumi.get(__response__, 'ref_resource_type'),
