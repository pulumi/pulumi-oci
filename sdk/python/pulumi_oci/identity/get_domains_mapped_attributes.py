...
__all__ = [
    'GetDomainsMappedAttributesResult',
    'AwaitableGetDomainsMappedAttributesResult',
    'get_domains_mapped_attributes',
    'get_domains_mapped_attributes_output',
]

@pulumi.output_type
class GetDomainsMappedAttributesResult:
    """
    A collection of values returned by getDomainsMappedAttributes.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, mapped_attribute_count=None, mapped_attribute_filter=None, mapped_attributes=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        ...
        if mapped_attribute_count and not isinstance(mapped_attribute_count, int):
            raise TypeError("Expected argument 'mapped_attribute_count' to be a int")
        pulumi.set(__self__, "mapped_attribute_count", mapped_attribute_count)
        if mapped_attribute_filter and not isinstance(mapped_attribute_filter, str):
            raise TypeError("Expected argument 'mapped_attribute_filter' to be a str")
        pulumi.set(__self__, "mapped_attribute_filter", mapped_attribute_filter)
        if mapped_attributes and not isinstance(mapped_attributes, list):
            raise TypeError("Expected argument 'mapped_attributes' to be a list")
        pulumi.set(__self__, "mapped_attributes", mapped_attributes)
    ...
    @_builtins.property
    @pulumi.getter(name="mappedAttributeCount")
    def mapped_attribute_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "mapped_attribute_count")

    @_builtins.property
    @pulumi.getter(name="mappedAttributeFilter")
    def mapped_attribute_filter(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "mapped_attribute_filter")

    @_builtins.property
    @pulumi.getter(name="mappedAttributes")
    def mapped_attributes(self) -> Sequence['outputs.GetDomainsMappedAttributesMappedAttributeResult']:
        """
        The list of mapped_attributes.
        """
        return pulumi.get(self, "mapped_attributes")
...
class AwaitableGetDomainsMappedAttributesResult(GetDomainsMappedAttributesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsMappedAttributesResult(
            ...
            mapped_attribute_count=self.mapped_attribute_count,
            mapped_attribute_filter=self.mapped_attribute_filter,
...
def get_domains_mapped_attributes(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                  ...
                                  mapped_attribute_count: Optional[_builtins.int] = None,
                                  mapped_attribute_filter: Optional[_builtins.str] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsMappedAttributesResult:
    """
    ...
    :param _builtins.int mapped_attribute_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str mapped_attribute_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    __args__['mappedAttributeCount'] = mapped_attribute_count
    __args__['mappedAttributeFilter'] = mapped_attribute_filter
    __args__['resourceTypeSchemaVersion'] = resource_type_schema_version
    __args__['sortBy'] = sort_by
    __args__['sortOrder'] = sort_order
    __args__['startIndex'] = start_index
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsMappedAttributes:getDomainsMappedAttributes', __args__, opts=opts, typ=GetDomainsMappedAttributesResult).value

    return AwaitableGetDomainsMappedAttributesResult(
        ...
        mapped_attribute_count=pulumi.get(__ret__, 'mapped_attribute_count'),
        mapped_attribute_filter=pulumi.get(__ret__, 'mapped_attribute_filter'),
        mapped_attributes=pulumi.get(__ret__, 'mapped_attributes'),
...
def get_domains_mapped_attributes_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                         ...
                                         mapped_attribute_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                         mapped_attribute_filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsMappedAttributesResult]:
    """
    This data source provides the list of Mapped Attributes in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsMappedAttributes:getDomainsMappedAttributes', __args__, opts=opts, typ=GetDomainsMappedAttributesResult)
    return __ret__.apply(lambda __response__: GetDomainsMappedAttributesResult(
        ...
        mapped_attribute_count=pulumi.get(__response__, 'mapped_attribute_count'),
        mapped_attribute_filter=pulumi.get(__response__, 'mapped_attribute_filter'),
        mapped_attributes=pulumi.get(__response__, 'mapped_attributes'),
