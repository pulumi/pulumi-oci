...
class GetDomainsMyApiKeyResult:
    ...
    def my_api_key_id(self) -> _builtins.str:
...
def get_domains_my_api_key(authorization: Optional[_builtins.str] = None,
                           idcs_endpoint: Optional[_builtins.str] = None,
                           my_api_key_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str my_api_key_id: ID of the resource
