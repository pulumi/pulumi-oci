...
class GetDomainsMyApiKeyResult:
    ...
    def my_api_key_id(self) -> builtins.str:
...
def get_domains_my_api_key(authorization: Optional[builtins.str] = None,
                           idcs_endpoint: Optional[builtins.str] = None,
                           my_api_key_id: Optional[builtins.str] = None,
    ...
    :param builtins.str my_api_key_id: ID of the resource
...
def get_domains_my_api_key_output(authorization: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                  idcs_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                                  my_api_key_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetDomainsMyApiKeyResult(
        ...
        my_api_key_id=pulumi.get(__response__, 'my_api_key_id'),
