...
class GetDomainsMyApiKeyResult:
    ...
    def idcs_created_bies(self) -> Optional[Sequence['outputs.GetDomainsMyApiKeyIdcsCreatedByResult']]:
    ...
    def idcs_last_modified_bies(self) -> Optional[Sequence['outputs.GetDomainsMyApiKeyIdcsLastModifiedByResult']]:
    ...
    @property
    @pulumi.getter
    def metas(self) -> Optional[Sequence['outputs.GetDomainsMyApiKeyMetaResult']]:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GetDomainsMyApiKeyTagResult']]:
    ...
    @property
    @pulumi.getter
    def users(self) -> Optional[Sequence['outputs.GetDomainsMyApiKeyUserResult']]:
