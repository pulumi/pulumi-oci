...
__all__ = [
    'GetDomainsMyApiKeysResult',
    'AwaitableGetDomainsMyApiKeysResult',
    'get_domains_my_api_keys',
    'get_domains_my_api_keys_output',
]

@pulumi.output_type
class GetDomainsMyApiKeysResult:
    """
    A collection of values returned by getDomainsMyApiKeys.
    """
    def __init__(__self__, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, my_api_key_count=None, my_api_key_filter=None, my_api_keys=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        ...
        if my_api_key_count and not isinstance(my_api_key_count, int):
            raise TypeError("Expected argument 'my_api_key_count' to be a int")
        pulumi.set(__self__, "my_api_key_count", my_api_key_count)
        if my_api_key_filter and not isinstance(my_api_key_filter, str):
            raise TypeError("Expected argument 'my_api_key_filter' to be a str")
        pulumi.set(__self__, "my_api_key_filter", my_api_key_filter)
        if my_api_keys and not isinstance(my_api_keys, list):
            raise TypeError("Expected argument 'my_api_keys' to be a list")
        pulumi.set(__self__, "my_api_keys", my_api_keys)
    ...
    @property
    @pulumi.getter(name="myApiKeyCount")
    def my_api_key_count(self) -> Optional[builtins.int]:
        return pulumi.get(self, "my_api_key_count")

    @property
    @pulumi.getter(name="myApiKeyFilter")
    def my_api_key_filter(self) -> Optional[builtins.str]:
        return pulumi.get(self, "my_api_key_filter")

    @property
    @pulumi.getter(name="myApiKeys")
    def my_api_keys(self) -> Sequence['outputs.GetDomainsMyApiKeysMyApiKeyResult']:
        """
        The list of my_api_keys.
        """
        return pulumi.get(self, "my_api_keys")
...
class AwaitableGetDomainsMyApiKeysResult(GetDomainsMyApiKeysResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsMyApiKeysResult(
            authorization=self.authorization,
            compartment_id=self.compartment_id,
            id=self.id,
            idcs_endpoint=self.idcs_endpoint,
            items_per_page=self.items_per_page,
            my_api_key_count=self.my_api_key_count,
            my_api_key_filter=self.my_api_key_filter,
            my_api_keys=self.my_api_keys,
...
def get_domains_my_api_keys(authorization: Optional[builtins.str] = None,
                            compartment_id: Optional[builtins.str] = None,
                            idcs_endpoint: Optional[builtins.str] = None,
                            my_api_key_count: Optional[builtins.int] = None,
                            my_api_key_filter: Optional[builtins.str] = None,
                            ...
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsMyApiKeysResult:
    """
    ...
    :param builtins.int my_api_key_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param builtins.str my_api_key_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    __args__['myApiKeyCount'] = my_api_key_count
    __args__['myApiKeyFilter'] = my_api_key_filter
    __args__['resourceTypeSchemaVersion'] = resource_type_schema_version
    __args__['sortBy'] = sort_by
    __args__['sortOrder'] = sort_order
    __args__['startIndex'] = start_index
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsMyApiKeys:getDomainsMyApiKeys', __args__, opts=opts, typ=GetDomainsMyApiKeysResult).value

    return AwaitableGetDomainsMyApiKeysResult(
        authorization=pulumi.get(__ret__, 'authorization'),
        compartment_id=pulumi.get(__ret__, 'compartment_id'),
        id=pulumi.get(__ret__, 'id'),
        idcs_endpoint=pulumi.get(__ret__, 'idcs_endpoint'),
        items_per_page=pulumi.get(__ret__, 'items_per_page'),
        my_api_key_count=pulumi.get(__ret__, 'my_api_key_count'),
        my_api_key_filter=pulumi.get(__ret__, 'my_api_key_filter'),
        my_api_keys=pulumi.get(__ret__, 'my_api_keys'),
...
def get_domains_my_api_keys_output(authorization: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                   compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                   idcs_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                                   my_api_key_count: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                   my_api_key_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetDomainsMyApiKeysResult(
        ...
        my_api_key_count=pulumi.get(__response__, 'my_api_key_count'),
        my_api_key_filter=pulumi.get(__response__, 'my_api_key_filter'),
        my_api_keys=pulumi.get(__response__, 'my_api_keys'),
