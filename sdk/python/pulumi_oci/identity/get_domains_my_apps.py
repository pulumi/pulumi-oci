...
__all__ = [
    'GetDomainsMyAppsResult',
    'AwaitableGetDomainsMyAppsResult',
    'get_domains_my_apps',
    'get_domains_my_apps_output',
]

@pulumi.output_type
class GetDomainsMyAppsResult:
    """
    A collection of values returned by getDomainsMyApps.
    """
    def __init__(__self__, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, my_app_count=None, my_app_filter=None, my_apps=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        ...
        if my_app_count and not isinstance(my_app_count, int):
            raise TypeError("Expected argument 'my_app_count' to be a int")
        pulumi.set(__self__, "my_app_count", my_app_count)
        if my_app_filter and not isinstance(my_app_filter, str):
            raise TypeError("Expected argument 'my_app_filter' to be a str")
        pulumi.set(__self__, "my_app_filter", my_app_filter)
        if my_apps and not isinstance(my_apps, list):
            raise TypeError("Expected argument 'my_apps' to be a list")
        pulumi.set(__self__, "my_apps", my_apps)
    ...
    @_builtins.property
    @pulumi.getter(name="myAppCount")
    def my_app_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "my_app_count")

    @_builtins.property
    @pulumi.getter(name="myAppFilter")
    def my_app_filter(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "my_app_filter")

    @_builtins.property
    @pulumi.getter(name="myApps")
    def my_apps(self) -> Sequence['outputs.GetDomainsMyAppsMyAppResult']:
        """
        The list of my_apps.
        """
        return pulumi.get(self, "my_apps")
...
class AwaitableGetDomainsMyAppsResult(GetDomainsMyAppsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsMyAppsResult(
            authorization=self.authorization,
            compartment_id=self.compartment_id,
            id=self.id,
            idcs_endpoint=self.idcs_endpoint,
            items_per_page=self.items_per_page,
            my_app_count=self.my_app_count,
            my_app_filter=self.my_app_filter,
            my_apps=self.my_apps,
...
def get_domains_my_apps(authorization: Optional[_builtins.str] = None,
                        compartment_id: Optional[_builtins.str] = None,
                        idcs_endpoint: Optional[_builtins.str] = None,
                        my_app_count: Optional[_builtins.int] = None,
                        my_app_filter: Optional[_builtins.str] = None,
                        ...
                        opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsMyAppsResult:
    """
    ...
    test_my_apps = oci.identity.get_domains_my_apps(idcs_endpoint=test_domain["url"],
        my_app_count=int(my_app_my_app_count),
        ...
        start_index=int(my_app_start_index))
    ```
    ...
    :param _builtins.int my_app_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str my_app_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    __args__['myAppCount'] = my_app_count
    __args__['myAppFilter'] = my_app_filter
    __args__['resourceTypeSchemaVersion'] = resource_type_schema_version
    __args__['sortBy'] = sort_by
    __args__['sortOrder'] = sort_order
    __args__['startIndex'] = start_index
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsMyApps:getDomainsMyApps', __args__, opts=opts, typ=GetDomainsMyAppsResult).value

    return AwaitableGetDomainsMyAppsResult(
        authorization=pulumi.get(__ret__, 'authorization'),
        compartment_id=pulumi.get(__ret__, 'compartment_id'),
        id=pulumi.get(__ret__, 'id'),
        idcs_endpoint=pulumi.get(__ret__, 'idcs_endpoint'),
        items_per_page=pulumi.get(__ret__, 'items_per_page'),
        my_app_count=pulumi.get(__ret__, 'my_app_count'),
        my_app_filter=pulumi.get(__ret__, 'my_app_filter'),
        my_apps=pulumi.get(__ret__, 'my_apps'),
...
def get_domains_my_apps_output(authorization: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               compartment_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                               idcs_endpoint: Optional[pulumi.Input[_builtins.str]] = None,
                               my_app_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                               my_app_filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetDomainsMyAppsResult(
        ...
        my_app_count=pulumi.get(__response__, 'my_app_count'),
        my_app_filter=pulumi.get(__response__, 'my_app_filter'),
        my_apps=pulumi.get(__response__, 'my_apps'),
