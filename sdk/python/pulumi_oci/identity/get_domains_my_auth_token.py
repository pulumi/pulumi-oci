...
class GetDomainsMyAuthTokenResult:
    ...
    def my_auth_token_id(self) -> _builtins.str:
...
def get_domains_my_auth_token(authorization: Optional[_builtins.str] = None,
                              idcs_endpoint: Optional[_builtins.str] = None,
                              my_auth_token_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str my_auth_token_id: ID of the resource
