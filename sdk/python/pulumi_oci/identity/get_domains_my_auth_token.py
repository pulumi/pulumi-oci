...
class GetDomainsMyAuthTokenResult:
    ...
    def my_auth_token_id(self) -> builtins.str:
...
def get_domains_my_auth_token(authorization: Optional[builtins.str] = None,
                              idcs_endpoint: Optional[builtins.str] = None,
                              my_auth_token_id: Optional[builtins.str] = None,
    ...
    :param builtins.str my_auth_token_id: ID of the resource
...
def get_domains_my_auth_token_output(authorization: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     idcs_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                                     my_auth_token_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetDomainsMyAuthTokenResult(
        ...
        my_auth_token_id=pulumi.get(__response__, 'my_auth_token_id'),
