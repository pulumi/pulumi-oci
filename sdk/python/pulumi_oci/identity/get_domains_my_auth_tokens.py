...
class GetDomainsMyAuthTokensResult:
    ...
    def my_auth_token_count(self) -> Optional[int]:
        return pulumi.get(self, "my_auth_token_count")

    @property
    @pulumi.getter(name="myAuthTokenFilter")
    def my_auth_token_filter(self) -> Optional[str]:
...
def get_domains_my_auth_tokens_output(authorization: Optional[pulumi.Input[Optional[str]]] = None,
                                      compartment_id: Optional[pulumi.Input[Optional[str]]] = None,
                                      idcs_endpoint: Optional[pulumi.Input[str]] = None,
                                      my_auth_token_count: Optional[pulumi.Input[Optional[int]]] = None,
                                      my_auth_token_filter: Optional[pulumi.Input[Optional[str]]] = None,
