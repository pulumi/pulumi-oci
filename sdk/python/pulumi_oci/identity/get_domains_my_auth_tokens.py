...
__all__ = [
    'GetDomainsMyAuthTokensResult',
    'AwaitableGetDomainsMyAuthTokensResult',
    'get_domains_my_auth_tokens',
    'get_domains_my_auth_tokens_output',
]

@pulumi.output_type
class GetDomainsMyAuthTokensResult:
    """
    A collection of values returned by getDomainsMyAuthTokens.
    """
    def __init__(__self__, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, my_auth_token_count=None, my_auth_token_filter=None, my_auth_tokens=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        ...
        if my_auth_token_count and not isinstance(my_auth_token_count, int):
            raise TypeError("Expected argument 'my_auth_token_count' to be a int")
        pulumi.set(__self__, "my_auth_token_count", my_auth_token_count)
        if my_auth_token_filter and not isinstance(my_auth_token_filter, str):
            raise TypeError("Expected argument 'my_auth_token_filter' to be a str")
        pulumi.set(__self__, "my_auth_token_filter", my_auth_token_filter)
        if my_auth_tokens and not isinstance(my_auth_tokens, list):
            raise TypeError("Expected argument 'my_auth_tokens' to be a list")
        pulumi.set(__self__, "my_auth_tokens", my_auth_tokens)
    ...
    @_builtins.property
    @pulumi.getter(name="myAuthTokenCount")
    def my_auth_token_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "my_auth_token_count")

    @_builtins.property
    @pulumi.getter(name="myAuthTokenFilter")
    def my_auth_token_filter(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "my_auth_token_filter")
...
class AwaitableGetDomainsMyAuthTokensResult(GetDomainsMyAuthTokensResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsMyAuthTokensResult(
            authorization=self.authorization,
            compartment_id=self.compartment_id,
            id=self.id,
            idcs_endpoint=self.idcs_endpoint,
            items_per_page=self.items_per_page,
            my_auth_token_count=self.my_auth_token_count,
            my_auth_token_filter=self.my_auth_token_filter,
            my_auth_tokens=self.my_auth_tokens,
...
def get_domains_my_auth_tokens(authorization: Optional[_builtins.str] = None,
                               compartment_id: Optional[_builtins.str] = None,
                               idcs_endpoint: Optional[_builtins.str] = None,
                               my_auth_token_count: Optional[_builtins.int] = None,
                               my_auth_token_filter: Optional[_builtins.str] = None,
    ...
    :param _builtins.int my_auth_token_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str my_auth_token_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    __args__['myAuthTokenCount'] = my_auth_token_count
    __args__['myAuthTokenFilter'] = my_auth_token_filter
    __args__['resourceTypeSchemaVersion'] = resource_type_schema_version
    __args__['sortBy'] = sort_by
    __args__['sortOrder'] = sort_order
    __args__['startIndex'] = start_index
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsMyAuthTokens:getDomainsMyAuthTokens', __args__, opts=opts, typ=GetDomainsMyAuthTokensResult).value

    return AwaitableGetDomainsMyAuthTokensResult(
        authorization=pulumi.get(__ret__, 'authorization'),
        compartment_id=pulumi.get(__ret__, 'compartment_id'),
        id=pulumi.get(__ret__, 'id'),
        idcs_endpoint=pulumi.get(__ret__, 'idcs_endpoint'),
        items_per_page=pulumi.get(__ret__, 'items_per_page'),
        my_auth_token_count=pulumi.get(__ret__, 'my_auth_token_count'),
        my_auth_token_filter=pulumi.get(__ret__, 'my_auth_token_filter'),
        my_auth_tokens=pulumi.get(__ret__, 'my_auth_tokens'),
...
def get_domains_my_auth_tokens_output(authorization: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsMyAuthTokens:getDomainsMyAuthTokens', __args__, opts=opts, typ=GetDomainsMyAuthTokensResult)
    return __ret__.apply(lambda __response__: GetDomainsMyAuthTokensResult(
        ...
        my_auth_token_count=pulumi.get(__response__, 'my_auth_token_count'),
        my_auth_token_filter=pulumi.get(__response__, 'my_auth_token_filter'),
        my_auth_tokens=pulumi.get(__response__, 'my_auth_tokens'),
