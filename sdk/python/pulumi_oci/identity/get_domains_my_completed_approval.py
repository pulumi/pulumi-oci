...
class GetDomainsMyCompletedApprovalResult:
    ...
    def my_completed_approval_id(self) -> builtins.str:
...
def get_domains_my_completed_approval(authorization: Optional[builtins.str] = None,
                                      idcs_endpoint: Optional[builtins.str] = None,
                                      my_completed_approval_id: Optional[builtins.str] = None,
    ...
    :param builtins.str my_completed_approval_id: ID of the resource
...
def get_domains_my_completed_approval_output(authorization: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                             idcs_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                                             my_completed_approval_id: Optional[pulumi.Input[builtins.str]] = None,
