...
__all__ = [
    'GetDomainsMyCustomerSecretKeyResult',
    'AwaitableGetDomainsMyCustomerSecretKeyResult',
    'get_domains_my_customer_secret_key',
    'get_domains_my_customer_secret_key_output',
]

@pulumi.output_type
class GetDomainsMyCustomerSecretKeyResult:
    """
    A collection of values returned by getDomainsMyCustomerSecretKey.
    """
    def __init__(__self__, access_key=None, authorization=None, compartment_ocid=None, delete_in_progress=None, description=None, display_name=None, domain_ocid=None, expires_on=None, id=None, idcs_created_bies=None, idcs_endpoint=None, idcs_last_modified_bies=None, idcs_last_upgraded_in_release=None, idcs_prevented_operations=None, metas=None, my_customer_secret_key_id=None, ocid=None, resource_type_schema_version=None, schemas=None, status=None, tags=None, tenancy_ocid=None, users=None):
        ...
        if my_customer_secret_key_id and not isinstance(my_customer_secret_key_id, str):
            raise TypeError("Expected argument 'my_customer_secret_key_id' to be a str")
        pulumi.set(__self__, "my_customer_secret_key_id", my_customer_secret_key_id)
    ...
    def idcs_created_bies(self) -> Sequence['outputs.GetDomainsMyCustomerSecretKeyIdcsCreatedByResult']:
        """
    ...
    def idcs_last_modified_bies(self) -> Sequence['outputs.GetDomainsMyCustomerSecretKeyIdcsLastModifiedByResult']:
        """
    ...
    @property
    @pulumi.getter
    def metas(self) -> Sequence['outputs.GetDomainsMyCustomerSecretKeyMetaResult']:
        """
    ...
    @property
    @pulumi.getter(name="myCustomerSecretKeyId")
    def my_customer_secret_key_id(self) -> str:
        return pulumi.get(self, "my_customer_secret_key_id")
    ...
    @property
    @pulumi.getter
    def tags(self) -> Sequence['outputs.GetDomainsMyCustomerSecretKeyTagResult']:
        """
    ...
    @property
    @pulumi.getter
    def users(self) -> Sequence['outputs.GetDomainsMyCustomerSecretKeyUserResult']:
        """
...
class AwaitableGetDomainsMyCustomerSecretKeyResult(GetDomainsMyCustomerSecretKeyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsMyCustomerSecretKeyResult(
            ...
            metas=self.metas,
            my_customer_secret_key_id=self.my_customer_secret_key_id,
            ocid=self.ocid,
...
def get_domains_my_customer_secret_key(authorization: Optional[str] = None,
                                       ...
                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsMyCustomerSecretKeyResult:
    """
    ...
    test_my_customer_secret_key = oci.Identity.get_domains_my_customer_secret_key(idcs_endpoint=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        my_customer_secret_key_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    :param str my_customer_secret_key_id: ID of the resource
    :param str resource_type_schema_version: An endpoint-specific schema version number to use in the Request. Allowed version values are Earliest Version or Latest Version as specified in each REST API endpoint description, or any sequential number inbetween. All schema attributes/body parameters are a part of version 1. After version 1, any attributes added or deprecated will be tagged with the version that they were added to or deprecated in. If no version is provided, the latest schema version is returned.
    """
    __args__ = dict()
    __args__['authorization'] = authorization
    __args__['idcsEndpoint'] = idcs_endpoint
    __args__['myCustomerSecretKeyId'] = my_customer_secret_key_id
    __args__['resourceTypeSchemaVersion'] = resource_type_schema_version
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsMyCustomerSecretKey:getDomainsMyCustomerSecretKey', __args__, opts=opts, typ=GetDomainsMyCustomerSecretKeyResult).value

    return AwaitableGetDomainsMyCustomerSecretKeyResult(
        ...
        metas=__ret__.metas,
        my_customer_secret_key_id=__ret__.my_customer_secret_key_id,
        ocid=__ret__.ocid,
...
@_utilities.lift_output_func(get_domains_my_customer_secret_key)
def get_domains_my_customer_secret_key_output(authorization: Optional[pulumi.Input[Optional[str]]] = None,
                                              idcs_endpoint: Optional[pulumi.Input[str]] = None,
                                              my_customer_secret_key_id: Optional[pulumi.Input[str]] = None,
                                              resource_type_schema_version: Optional[pulumi.Input[Optional[str]]] = None,
                                              opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDomainsMyCustomerSecretKeyResult]:
    """
    This data source provides details about a specific My Customer Secret Key resource in Oracle Cloud Infrastructure Identity Domains service.
