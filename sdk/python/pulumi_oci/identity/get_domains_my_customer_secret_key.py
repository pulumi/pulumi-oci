...
class GetDomainsMyCustomerSecretKeyResult:
    ...
    def my_customer_secret_key_id(self) -> _builtins.str:
...
def get_domains_my_customer_secret_key(authorization: Optional[_builtins.str] = None,
                                       idcs_endpoint: Optional[_builtins.str] = None,
                                       my_customer_secret_key_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str my_customer_secret_key_id: ID of the resource
