...
class GetDomainsMyCustomerSecretKeyResult:
    ...
    def my_customer_secret_key_id(self) -> builtins.str:
...
def get_domains_my_customer_secret_key(authorization: Optional[builtins.str] = None,
                                       idcs_endpoint: Optional[builtins.str] = None,
                                       my_customer_secret_key_id: Optional[builtins.str] = None,
    ...
    :param builtins.str my_customer_secret_key_id: ID of the resource
    ...
    return AwaitableGetDomainsMyCustomerSecretKeyResult(
        ...
        my_customer_secret_key_id=pulumi.get(__ret__, 'my_customer_secret_key_id'),
...
def get_domains_my_customer_secret_key_output(authorization: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                              idcs_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                                              my_customer_secret_key_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsMyCustomerSecretKey:getDomainsMyCustomerSecretKey', __args__, opts=opts, typ=GetDomainsMyCustomerSecretKeyResult)
    return __ret__.apply(lambda __response__: GetDomainsMyCustomerSecretKeyResult(
        ...
        my_customer_secret_key_id=pulumi.get(__response__, 'my_customer_secret_key_id'),
