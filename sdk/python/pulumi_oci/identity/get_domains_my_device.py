...
def get_domains_my_device(attribute_sets: Optional[Sequence[str]] = None,
    ...
    return AwaitableGetDomainsMyDeviceResult(
        ...
        app_version=__ret__.app_version,
        attribute_sets=__ret__.attribute_sets,
        attributes=__ret__.attributes,
        authentication_factors=__ret__.authentication_factors,
        authentication_method=__ret__.authentication_method,
        authorization=__ret__.authorization,
        base_public_key=__ret__.base_public_key,
        ...
        device_uuid=__ret__.device_uuid,
        ...
        is_acc_rec_enabled=__ret__.is_acc_rec_enabled,
        is_compliant=__ret__.is_compliant,
        last_sync_time=__ret__.last_sync_time,
        last_validated_time=__ret__.last_validated_time,
        metas=__ret__.metas,
        my_device_id=__ret__.my_device_id,
        non_compliances=__ret__.non_compliances,
        ocid=__ret__.ocid,
        package_id=__ret__.package_id,
        phone_number=__ret__.phone_number,
        platform=__ret__.platform,
        push_notification_targets=__ret__.push_notification_targets,
        reason=__ret__.reason,
        resource_type_schema_version=__ret__.resource_type_schema_version,
        schemas=__ret__.schemas,
        seed=__ret__.seed,
        seed_dek_id=__ret__.seed_dek_id,
        status=__ret__.status,
        tags=__ret__.tags,
        tenancy_ocid=__ret__.tenancy_ocid,
        third_party_factors=__ret__.third_party_factors,
        users=__ret__.users)
