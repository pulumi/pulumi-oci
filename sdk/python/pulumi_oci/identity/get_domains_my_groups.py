...
__all__ = [
    'GetDomainsMyGroupsResult',
    'AwaitableGetDomainsMyGroupsResult',
    'get_domains_my_groups',
    'get_domains_my_groups_output',
]

@pulumi.output_type
class GetDomainsMyGroupsResult:
    """
    A collection of values returned by getDomainsMyGroups.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, my_group_count=None, my_group_filter=None, my_groups=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        ...
        if my_group_count and not isinstance(my_group_count, int):
            raise TypeError("Expected argument 'my_group_count' to be a int")
        pulumi.set(__self__, "my_group_count", my_group_count)
        if my_group_filter and not isinstance(my_group_filter, str):
            raise TypeError("Expected argument 'my_group_filter' to be a str")
        pulumi.set(__self__, "my_group_filter", my_group_filter)
        if my_groups and not isinstance(my_groups, list):
            raise TypeError("Expected argument 'my_groups' to be a list")
        pulumi.set(__self__, "my_groups", my_groups)
    ...
    @_builtins.property
    @pulumi.getter(name="myGroupCount")
    def my_group_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "my_group_count")

    @_builtins.property
    @pulumi.getter(name="myGroupFilter")
    def my_group_filter(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "my_group_filter")

    @_builtins.property
    @pulumi.getter(name="myGroups")
    def my_groups(self) -> Sequence['outputs.GetDomainsMyGroupsMyGroupResult']:
        """
        The list of my_groups.
        """
        return pulumi.get(self, "my_groups")
...
class AwaitableGetDomainsMyGroupsResult(GetDomainsMyGroupsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsMyGroupsResult(
            ...
            my_group_count=self.my_group_count,
            my_group_filter=self.my_group_filter,
...
def get_domains_my_groups(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                          ...
                          my_group_count: Optional[_builtins.int] = None,
                          my_group_filter: Optional[_builtins.str] = None,
                          ...
                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsMyGroupsResult:
    """
    ...
    :param _builtins.int my_group_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str my_group_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    __args__['myGroupCount'] = my_group_count
    __args__['myGroupFilter'] = my_group_filter
    __args__['resourceTypeSchemaVersion'] = resource_type_schema_version
    __args__['sortBy'] = sort_by
    __args__['sortOrder'] = sort_order
    __args__['startIndex'] = start_index
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsMyGroups:getDomainsMyGroups', __args__, opts=opts, typ=GetDomainsMyGroupsResult).value

    return AwaitableGetDomainsMyGroupsResult(
        ...
        my_group_count=pulumi.get(__ret__, 'my_group_count'),
        my_group_filter=pulumi.get(__ret__, 'my_group_filter'),
        my_groups=pulumi.get(__ret__, 'my_groups'),
...
def get_domains_my_groups_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsMyGroups:getDomainsMyGroups', __args__, opts=opts, typ=GetDomainsMyGroupsResult)
    return __ret__.apply(lambda __response__: GetDomainsMyGroupsResult(
        ...
        my_group_count=pulumi.get(__response__, 'my_group_count'),
        my_group_filter=pulumi.get(__response__, 'my_group_filter'),
        my_groups=pulumi.get(__response__, 'my_groups'),
