...
class GetDomainsMyGroupsResult:
    ...
    def my_group_count(self) -> Optional[int]:
        return pulumi.get(self, "my_group_count")

    @property
    @pulumi.getter(name="myGroupFilter")
    def my_group_filter(self) -> Optional[str]:
...
def get_domains_my_groups(attribute_sets: Optional[Sequence[str]] = None,
                          attributes: Optional[str] = None,
                          authorization: Optional[str] = None,
                          compartment_id: Optional[str] = None,
                          idcs_endpoint: Optional[str] = None,
                          my_group_count: Optional[int] = None,
                          my_group_filter: Optional[str] = None,
    ...
    test_my_groups = oci.Identity.get_domains_my_groups(idcs_endpoint=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        my_group_count=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        my_group_filter=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        attribute_sets=[],
        attributes="",
    ...
    :param int my_group_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param str my_group_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    return AwaitableGetDomainsMyGroupsResult(
        ...
        my_group_count=__ret__.my_group_count,
        my_group_filter=__ret__.my_group_filter,
        my_groups=__ret__.my_groups,
...
@_utilities.lift_output_func(get_domains_my_groups)
def get_domains_my_groups_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                 ...
                                 my_group_count: Optional[pulumi.Input[Optional[int]]] = None,
                                 my_group_filter: Optional[pulumi.Input[Optional[str]]] = None,
                                 ...
                                 opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDomainsMyGroupsResult]:
    """
    This data source provides the list of My Groups in Oracle Cloud Infrastructure Identity Domains service.
