...
class GetDomainsMyOauth2clientCredentialResult:
    ...
    def idcs_created_bies(self) -> Sequence['outputs.GetDomainsMyOauth2clientCredentialIdcsCreatedByResult']:
        """
    ...
    def idcs_last_modified_bies(self) -> Sequence['outputs.GetDomainsMyOauth2clientCredentialIdcsLastModifiedByResult']:
        """
    ...
    @property
    @pulumi.getter
    def metas(self) -> Sequence['outputs.GetDomainsMyOauth2clientCredentialMetaResult']:
        """
    ...
    @property
    @pulumi.getter
    def scopes(self) -> Sequence['outputs.GetDomainsMyOauth2clientCredentialScopeResult']:
        """
        Scopes
        """
    ...
    @property
    @pulumi.getter
    def tags(self) -> Sequence['outputs.GetDomainsMyOauth2clientCredentialTagResult']:
        """
    ...
    @property
    @pulumi.getter
    def users(self) -> Sequence['outputs.GetDomainsMyOauth2clientCredentialUserResult']:
        """
...
def get_domains_my_oauth2client_credential(authorization: Optional[str] = None,
    ...
    test_my_oauth2client_credential = oci.Identity.get_domains_my_oauth2client_credential(idcs_endpoint=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        my_oauth2client_credential_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    :param str my_oauth2client_credential_id: ID of the resource
    ...
    return AwaitableGetDomainsMyOauth2clientCredentialResult(
        ...
        compartment_ocid=__ret__.compartment_ocid,
        delete_in_progress=__ret__.delete_in_progress,
        description=__ret__.description,
        domain_ocid=__ret__.domain_ocid,
        expires_on=__ret__.expires_on,
        id=__ret__.id,
        idcs_created_bies=__ret__.idcs_created_bies,
        idcs_endpoint=__ret__.idcs_endpoint,
        idcs_last_modified_bies=__ret__.idcs_last_modified_bies,
        idcs_last_upgraded_in_release=__ret__.idcs_last_upgraded_in_release,
        idcs_prevented_operations=__ret__.idcs_prevented_operations,
        is_reset_secret=__ret__.is_reset_secret,
        metas=__ret__.metas,
        my_oauth2client_credential_id=__ret__.my_oauth2client_credential_id,
        name=__ret__.name,
        ocid=__ret__.ocid,
        ...
        tags=__ret__.tags,
        tenancy_ocid=__ret__.tenancy_ocid,
        users=__ret__.users)
