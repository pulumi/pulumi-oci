...
class GetDomainsMyOauth2clientCredentialResult:
    ...
    def is_reset_secret(self) -> builtins.bool:
        """
    ...
    def my_oauth2client_credential_id(self) -> builtins.str:
...
def get_domains_my_oauth2client_credential(authorization: Optional[builtins.str] = None,
                                           idcs_endpoint: Optional[builtins.str] = None,
                                           my_oauth2client_credential_id: Optional[builtins.str] = None,
    ...
    :param builtins.str my_oauth2client_credential_id: ID of the resource
...
def get_domains_my_oauth2client_credential_output(authorization: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                  idcs_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                                                  my_oauth2client_credential_id: Optional[pulumi.Input[builtins.str]] = None,
                                                  resource_type_schema_version: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsMyOauth2clientCredentialResult]:
    """
    This data source provides details about a specific My O Auth2 Client Credential resource in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsMyOauth2clientCredential:getDomainsMyOauth2clientCredential', __args__, opts=opts, typ=GetDomainsMyOauth2clientCredentialResult)
    return __ret__.apply(lambda __response__: GetDomainsMyOauth2clientCredentialResult(
        ...
        my_oauth2client_credential_id=pulumi.get(__response__, 'my_oauth2client_credential_id'),
