...
def get_domains_my_oauth2client_credentials(authorization: Optional[str] = None,
    ...
    test_my_oauth2client_credentials = oci.Identity.get_domains_my_oauth2client_credentials(idcs_endpoint=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        my_oauth2client_credential_count=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        my_oauth2client_credential_filter=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetDomainsMyOauth2clientCredentialsResult(
        ...
        my_oauth2client_credential_count=__ret__.my_oauth2client_credential_count,
        my_oauth2client_credential_filter=__ret__.my_oauth2client_credential_filter,
        my_oauth2client_credentials=__ret__.my_oauth2client_credentials,
