...
class GetDomainsMyPendingApprovalResult:
    ...
    def my_pending_approval_id(self) -> _builtins.str:
...
def get_domains_my_pending_approval(authorization: Optional[_builtins.str] = None,
                                    idcs_endpoint: Optional[_builtins.str] = None,
                                    my_pending_approval_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str my_pending_approval_id: ID of the resource
