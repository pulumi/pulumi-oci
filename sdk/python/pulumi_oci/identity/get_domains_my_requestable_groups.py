...
class GetDomainsMyRequestableGroupsResult:
    ...
    def my_requestable_group_count(self) -> Optional[int]:
        return pulumi.get(self, "my_requestable_group_count")

    @property
    @pulumi.getter(name="myRequestableGroupFilter")
    def my_requestable_group_filter(self) -> Optional[str]:
...
def get_domains_my_requestable_groups_output(authorization: Optional[pulumi.Input[Optional[str]]] = None,
                                             compartment_id: Optional[pulumi.Input[Optional[str]]] = None,
                                             idcs_endpoint: Optional[pulumi.Input[str]] = None,
                                             my_requestable_group_count: Optional[pulumi.Input[Optional[int]]] = None,
                                             my_requestable_group_filter: Optional[pulumi.Input[Optional[str]]] = None,
