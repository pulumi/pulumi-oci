...
__all__ = [
    'GetDomainsMyRequestsResult',
    'AwaitableGetDomainsMyRequestsResult',
    'get_domains_my_requests',
    'get_domains_my_requests_output',
]

@pulumi.output_type
class GetDomainsMyRequestsResult:
    """
    A collection of values returned by getDomainsMyRequests.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, my_request_count=None, my_request_filter=None, my_requests=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        ...
        if my_request_count and not isinstance(my_request_count, int):
            raise TypeError("Expected argument 'my_request_count' to be a int")
        pulumi.set(__self__, "my_request_count", my_request_count)
        if my_request_filter and not isinstance(my_request_filter, str):
            raise TypeError("Expected argument 'my_request_filter' to be a str")
        pulumi.set(__self__, "my_request_filter", my_request_filter)
        if my_requests and not isinstance(my_requests, list):
            raise TypeError("Expected argument 'my_requests' to be a list")
        pulumi.set(__self__, "my_requests", my_requests)
    ...
    @_builtins.property
    @pulumi.getter(name="myRequestCount")
    def my_request_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "my_request_count")

    @_builtins.property
    @pulumi.getter(name="myRequestFilter")
    def my_request_filter(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "my_request_filter")

    @_builtins.property
    @pulumi.getter(name="myRequests")
    def my_requests(self) -> Sequence['outputs.GetDomainsMyRequestsMyRequestResult']:
        """
        The list of my_requests.
        """
        return pulumi.get(self, "my_requests")
...
class AwaitableGetDomainsMyRequestsResult(GetDomainsMyRequestsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsMyRequestsResult(
            ...
            my_request_count=self.my_request_count,
            my_request_filter=self.my_request_filter,
            my_requests=self.my_requests,
...
def get_domains_my_requests(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                            ...
                            my_request_count: Optional[_builtins.int] = None,
                            my_request_filter: Optional[_builtins.str] = None,
                            ...
                            opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsMyRequestsResult:
    """
    ...
    :param _builtins.int my_request_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str my_request_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    __args__['myRequestCount'] = my_request_count
    __args__['myRequestFilter'] = my_request_filter
    __args__['resourceTypeSchemaVersion'] = resource_type_schema_version
    __args__['sortBy'] = sort_by
    __args__['sortOrder'] = sort_order
    __args__['startIndex'] = start_index
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsMyRequests:getDomainsMyRequests', __args__, opts=opts, typ=GetDomainsMyRequestsResult).value

    return AwaitableGetDomainsMyRequestsResult(
        ...
        my_request_count=pulumi.get(__ret__, 'my_request_count'),
        my_request_filter=pulumi.get(__ret__, 'my_request_filter'),
        my_requests=pulumi.get(__ret__, 'my_requests'),
...
def get_domains_my_requests_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                   ...
                                   my_request_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                   my_request_filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                   ...
                                   opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsMyRequestsResult]:
    """
    This data source provides the list of My Requests in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsMyRequests:getDomainsMyRequests', __args__, opts=opts, typ=GetDomainsMyRequestsResult)
    return __ret__.apply(lambda __response__: GetDomainsMyRequestsResult(
        ...
        my_request_count=pulumi.get(__response__, 'my_request_count'),
        my_request_filter=pulumi.get(__response__, 'my_request_filter'),
        my_requests=pulumi.get(__response__, 'my_requests'),
