...
def get_domains_my_smtp_credential(authorization: Optional[str] = None,
    ...
    test_my_smtp_credential = oci.Identity.get_domains_my_smtp_credential(idcs_endpoint=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        my_smtp_credential_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetDomainsMySmtpCredentialResult(
        ...
        metas=__ret__.metas,
        my_smtp_credential_id=__ret__.my_smtp_credential_id,
        ocid=__ret__.ocid,
...
@_utilities.lift_output_func(get_domains_my_smtp_credential)
def get_domains_my_smtp_credential_output(authorization: Optional[pulumi.Input[Optional[str]]] = None,
                                          ...
                                          opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDomainsMySmtpCredentialResult]:
    """
    This data source provides details about a specific My Smtp Credential resource in Oracle Cloud Infrastructure Identity Domains service.
