...
__all__ = [
    'GetDomainsMySupportAccountResult',
    'AwaitableGetDomainsMySupportAccountResult',
    'get_domains_my_support_account',
    'get_domains_my_support_account_output',
]

@pulumi.output_type
class GetDomainsMySupportAccountResult:
    """
    A collection of values returned by getDomainsMySupportAccount.
    """
    def __init__(__self__, authorization=None, compartment_ocid=None, delete_in_progress=None, domain_ocid=None, id=None, idcs_created_bies=None, idcs_endpoint=None, idcs_last_modified_bies=None, idcs_last_upgraded_in_release=None, idcs_prevented_operations=None, metas=None, my_support_account_id=None, my_support_account_provider=None, ocid=None, resource_type_schema_version=None, schemas=None, tags=None, tenancy_ocid=None, token=None, user_id=None, users=None):
        ...
        if my_support_account_id and not isinstance(my_support_account_id, str):
            raise TypeError("Expected argument 'my_support_account_id' to be a str")
        pulumi.set(__self__, "my_support_account_id", my_support_account_id)
        if my_support_account_provider and not isinstance(my_support_account_provider, str):
            raise TypeError("Expected argument 'my_support_account_provider' to be a str")
    ...
    @property
    @pulumi.getter(name="mySupportAccountId")
    def my_support_account_id(self) -> builtins.str:
        return pulumi.get(self, "my_support_account_id")

    @property
    @pulumi.getter(name="mySupportAccountProvider")
    def my_support_account_provider(self) -> builtins.str:
        """
...
class AwaitableGetDomainsMySupportAccountResult(GetDomainsMySupportAccountResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsMySupportAccountResult(
            ...
            metas=self.metas,
            my_support_account_id=self.my_support_account_id,
            my_support_account_provider=self.my_support_account_provider,
            ocid=self.ocid,
...
def get_domains_my_support_account(authorization: Optional[builtins.str] = None,
                                   idcs_endpoint: Optional[builtins.str] = None,
                                   my_support_account_id: Optional[builtins.str] = None,
    ...
    :param builtins.str my_support_account_id: ID of the resource
    ...
    __args__['mySupportAccountId'] = my_support_account_id
    __args__['resourceTypeSchemaVersion'] = resource_type_schema_version
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsMySupportAccount:getDomainsMySupportAccount', __args__, opts=opts, typ=GetDomainsMySupportAccountResult).value

    return AwaitableGetDomainsMySupportAccountResult(
        ...
        my_support_account_id=pulumi.get(__ret__, 'my_support_account_id'),
        my_support_account_provider=pulumi.get(__ret__, 'my_support_account_provider'),
...
def get_domains_my_support_account_output(authorization: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          idcs_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                                          my_support_account_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsMySupportAccount:getDomainsMySupportAccount', __args__, opts=opts, typ=GetDomainsMySupportAccountResult)
    return __ret__.apply(lambda __response__: GetDomainsMySupportAccountResult(
        ...
        my_support_account_id=pulumi.get(__response__, 'my_support_account_id'),
        my_support_account_provider=pulumi.get(__response__, 'my_support_account_provider'),
