...
def get_domains_my_support_account(authorization: Optional[str] = None,
    ...
    test_my_support_account = oci.Identity.get_domains_my_support_account(idcs_endpoint=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        my_support_account_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetDomainsMySupportAccountResult(
        ...
        metas=__ret__.metas,
        my_support_account_id=__ret__.my_support_account_id,
        my_support_account_provider=__ret__.my_support_account_provider,
        ocid=__ret__.ocid,
...
@_utilities.lift_output_func(get_domains_my_support_account)
