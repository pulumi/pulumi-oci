...
class GetDomainsMySupportAccountResult:
    ...
    def my_support_account_id(self) -> _builtins.str:
        return pulumi.get(self, "my_support_account_id")

    @_builtins.property
    @pulumi.getter(name="mySupportAccountProvider")
    def my_support_account_provider(self) -> _builtins.str:
        """
...
def get_domains_my_support_account(authorization: Optional[_builtins.str] = None,
                                   idcs_endpoint: Optional[_builtins.str] = None,
                                   my_support_account_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str my_support_account_id: ID of the resource
