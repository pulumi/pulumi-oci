...
class GetDomainsMySupportAccountResult:
    ...
    def my_support_account_id(self) -> str:
...
def get_domains_my_support_account(authorization: Optional[str] = None,
                                   idcs_endpoint: Optional[str] = None,
                                   my_support_account_id: Optional[str] = None,
...
def get_domains_my_support_account_output(authorization: Optional[pulumi.Input[Optional[str]]] = None,
                                          idcs_endpoint: Optional[pulumi.Input[str]] = None,
                                          my_support_account_id: Optional[pulumi.Input[str]] = None,
