...
class GetDomainsMySupportAccountsResult:
    ...
    def my_support_account_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "my_support_account_count")

    @_builtins.property
    @pulumi.getter(name="mySupportAccountFilter")
    def my_support_account_filter(self) -> Optional[_builtins.str]:
...
def get_domains_my_support_accounts(authorization: Optional[_builtins.str] = None,
                                    compartment_id: Optional[_builtins.str] = None,
                                    idcs_endpoint: Optional[_builtins.str] = None,
                                    my_support_account_count: Optional[_builtins.int] = None,
                                    my_support_account_filter: Optional[_builtins.str] = None,
    ...
    :param _builtins.int my_support_account_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str my_support_account_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
...
def get_domains_my_support_accounts_output(authorization: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                           compartment_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                           idcs_endpoint: Optional[pulumi.Input[_builtins.str]] = None,
                                           my_support_account_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                           my_support_account_filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetDomainsMySupportAccountsResult(
        ...
        my_support_account_count=pulumi.get(__response__, 'my_support_account_count'),
        my_support_account_filter=pulumi.get(__response__, 'my_support_account_filter'),
        my_support_accounts=pulumi.get(__response__, 'my_support_accounts'),
