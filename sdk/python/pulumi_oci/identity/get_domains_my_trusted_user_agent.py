...
def get_domains_my_trusted_user_agent(attribute_sets: Optional[Sequence[str]] = None,
    ...
    return AwaitableGetDomainsMyTrustedUserAgentResult(
        ...
        last_used_on=__ret__.last_used_on,
        location=__ret__.location,
        metas=__ret__.metas,
        my_trusted_user_agent_id=__ret__.my_trusted_user_agent_id,
        name=__ret__.name,
        ocid=__ret__.ocid,
        ...
        trust_token=__ret__.trust_token,
        trusted_factors=__ret__.trusted_factors,
        users=__ret__.users)
