...
def get_domains_my_trusted_user_agents(attribute_sets: Optional[Sequence[str]] = None,
    ...
    return AwaitableGetDomainsMyTrustedUserAgentsResult(
        ...
        my_trusted_user_agent_count=__ret__.my_trusted_user_agent_count,
        my_trusted_user_agent_filter=__ret__.my_trusted_user_agent_filter,
        my_trusted_user_agents=__ret__.my_trusted_user_agents,
