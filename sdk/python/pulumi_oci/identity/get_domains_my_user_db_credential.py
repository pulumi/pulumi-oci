...
def get_domains_my_user_db_credential(authorization: Optional[str] = None,
    ...
    return AwaitableGetDomainsMyUserDbCredentialResult(
        ...
        last_set_date=__ret__.last_set_date,
        metas=__ret__.metas,
        mixed_db_password=__ret__.mixed_db_password,
        mixed_salt=__ret__.mixed_salt,
        my_user_db_credential_id=__ret__.my_user_db_credential_id,
        name=__ret__.name,
        ocid=__ret__.ocid,
