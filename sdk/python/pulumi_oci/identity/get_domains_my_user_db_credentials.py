...
class GetDomainsMyUserDbCredentialsResult:
    ...
    def my_user_db_credential_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "my_user_db_credential_count")

    @_builtins.property
    @pulumi.getter(name="myUserDbCredentialFilter")
    def my_user_db_credential_filter(self) -> Optional[_builtins.str]:
...
def get_domains_my_user_db_credentials(authorization: Optional[_builtins.str] = None,
                                       compartment_id: Optional[_builtins.str] = None,
                                       idcs_endpoint: Optional[_builtins.str] = None,
                                       my_user_db_credential_count: Optional[_builtins.int] = None,
                                       my_user_db_credential_filter: Optional[_builtins.str] = None,
    ...
    test_my_user_db_credentials = oci.identity.get_domains_my_user_db_credentials(idcs_endpoint=test_domain["url"],
        my_user_db_credential_count=int(my_user_db_credential_my_user_db_credential_count),
        ...
        start_index=int(my_user_db_credential_start_index))
    ```
    ...
    :param _builtins.int my_user_db_credential_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str my_user_db_credential_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
...
def get_domains_my_user_db_credentials_output(authorization: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                              compartment_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                              idcs_endpoint: Optional[pulumi.Input[_builtins.str]] = None,
                                              my_user_db_credential_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                              my_user_db_credential_filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                              ...
                                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsMyUserDbCredentialsResult]:
    """
    This data source provides the list of My User Db Credentials in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsMyUserDbCredentials:getDomainsMyUserDbCredentials', __args__, opts=opts, typ=GetDomainsMyUserDbCredentialsResult)
    return __ret__.apply(lambda __response__: GetDomainsMyUserDbCredentialsResult(
        ...
        my_user_db_credential_count=pulumi.get(__response__, 'my_user_db_credential_count'),
        my_user_db_credential_filter=pulumi.get(__response__, 'my_user_db_credential_filter'),
        my_user_db_credentials=pulumi.get(__response__, 'my_user_db_credentials'),
