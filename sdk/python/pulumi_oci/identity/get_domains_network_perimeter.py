...
class GetDomainsNetworkPerimeterResult:
    ...
    def network_perimeter_id(self) -> builtins.str:
...
def get_domains_network_perimeter(attribute_sets: Optional[Sequence[builtins.str]] = None,
                                  attributes: Optional[builtins.str] = None,
                                  authorization: Optional[builtins.str] = None,
                                  idcs_endpoint: Optional[builtins.str] = None,
                                  network_perimeter_id: Optional[builtins.str] = None,
    ...
    :param builtins.str network_perimeter_id: ID of the resource
...
def get_domains_network_perimeter_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                         ...
                                         network_perimeter_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsNetworkPerimeter:getDomainsNetworkPerimeter', __args__, opts=opts, typ=GetDomainsNetworkPerimeterResult)
    return __ret__.apply(lambda __response__: GetDomainsNetworkPerimeterResult(
        ...
        network_perimeter_id=pulumi.get(__response__, 'network_perimeter_id'),
