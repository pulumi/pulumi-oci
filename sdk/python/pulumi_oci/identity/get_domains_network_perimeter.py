...
class GetDomainsNetworkPerimeterResult:
    ...
    def network_perimeter_id(self) -> _builtins.str:
...
def get_domains_network_perimeter(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                  attributes: Optional[_builtins.str] = None,
                                  authorization: Optional[_builtins.str] = None,
                                  idcs_endpoint: Optional[_builtins.str] = None,
                                  network_perimeter_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str network_perimeter_id: ID of the resource
