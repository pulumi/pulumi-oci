...
__all__ = [
    'GetDomainsNetworkPerimetersResult',
    'AwaitableGetDomainsNetworkPerimetersResult',
    'get_domains_network_perimeters',
    'get_domains_network_perimeters_output',
]

@pulumi.output_type
class GetDomainsNetworkPerimetersResult:
    """
    A collection of values returned by getDomainsNetworkPerimeters.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, network_perimeter_count=None, network_perimeter_filter=None, network_perimeters=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        ...
        if network_perimeter_count and not isinstance(network_perimeter_count, int):
            raise TypeError("Expected argument 'network_perimeter_count' to be a int")
        pulumi.set(__self__, "network_perimeter_count", network_perimeter_count)
        if network_perimeter_filter and not isinstance(network_perimeter_filter, str):
            raise TypeError("Expected argument 'network_perimeter_filter' to be a str")
        pulumi.set(__self__, "network_perimeter_filter", network_perimeter_filter)
        if network_perimeters and not isinstance(network_perimeters, list):
            raise TypeError("Expected argument 'network_perimeters' to be a list")
        pulumi.set(__self__, "network_perimeters", network_perimeters)
    ...
    @_builtins.property
    @pulumi.getter(name="networkPerimeterCount")
    def network_perimeter_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "network_perimeter_count")

    @_builtins.property
    @pulumi.getter(name="networkPerimeterFilter")
    def network_perimeter_filter(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "network_perimeter_filter")

    @_builtins.property
    @pulumi.getter(name="networkPerimeters")
    def network_perimeters(self) -> Sequence['outputs.GetDomainsNetworkPerimetersNetworkPerimeterResult']:
        """
        The list of network_perimeters.
        """
        return pulumi.get(self, "network_perimeters")
...
class AwaitableGetDomainsNetworkPerimetersResult(GetDomainsNetworkPerimetersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsNetworkPerimetersResult(
            ...
            network_perimeter_count=self.network_perimeter_count,
            network_perimeter_filter=self.network_perimeter_filter,
            network_perimeters=self.network_perimeters,
...
def get_domains_network_perimeters(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                   ...
                                   network_perimeter_count: Optional[_builtins.int] = None,
                                   network_perimeter_filter: Optional[_builtins.str] = None,
                                   ...
                                   opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsNetworkPerimetersResult:
    """
    ...
    test_network_perimeters = oci.identity.get_domains_network_perimeters(idcs_endpoint=test_domain["url"],
        network_perimeter_count=int(network_perimeter_network_perimeter_count),
        ...
        start_index=int(network_perimeter_start_index))
    ```
    ...
    :param _builtins.int network_perimeter_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str network_perimeter_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    __args__['networkPerimeterCount'] = network_perimeter_count
    __args__['networkPerimeterFilter'] = network_perimeter_filter
    __args__['resourceTypeSchemaVersion'] = resource_type_schema_version
    __args__['sortBy'] = sort_by
    __args__['sortOrder'] = sort_order
    __args__['startIndex'] = start_index
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsNetworkPerimeters:getDomainsNetworkPerimeters', __args__, opts=opts, typ=GetDomainsNetworkPerimetersResult).value

    return AwaitableGetDomainsNetworkPerimetersResult(
        ...
        network_perimeter_count=pulumi.get(__ret__, 'network_perimeter_count'),
        network_perimeter_filter=pulumi.get(__ret__, 'network_perimeter_filter'),
        network_perimeters=pulumi.get(__ret__, 'network_perimeters'),
...
def get_domains_network_perimeters_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                          ...
                                          network_perimeter_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                          network_perimeter_filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                          ...
                                          opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsNetworkPerimetersResult]:
    """
    This data source provides the list of Network Perimeters in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsNetworkPerimeters:getDomainsNetworkPerimeters', __args__, opts=opts, typ=GetDomainsNetworkPerimetersResult)
    return __ret__.apply(lambda __response__: GetDomainsNetworkPerimetersResult(
        ...
        network_perimeter_count=pulumi.get(__response__, 'network_perimeter_count'),
        network_perimeter_filter=pulumi.get(__response__, 'network_perimeter_filter'),
        network_perimeters=pulumi.get(__response__, 'network_perimeters'),
