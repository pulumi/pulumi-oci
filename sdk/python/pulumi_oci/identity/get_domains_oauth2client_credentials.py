...
class GetDomainsOauth2clientCredentialsResult:
    ...
    def oauth2client_credential_count(self) -> Optional[int]:
        return pulumi.get(self, "oauth2client_credential_count")

    @property
    @pulumi.getter(name="oauth2clientCredentialFilter")
    def oauth2client_credential_filter(self) -> Optional[str]:
...
def get_domains_oauth2client_credentials(attribute_sets: Optional[Sequence[str]] = None,
    ...
    :param int oauth2client_credential_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param str oauth2client_credential_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
...
def get_domains_oauth2client_credentials_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                                ...
                                                oauth2client_credential_count: Optional[pulumi.Input[Optional[int]]] = None,
                                                oauth2client_credential_filter: Optional[pulumi.Input[Optional[str]]] = None,
