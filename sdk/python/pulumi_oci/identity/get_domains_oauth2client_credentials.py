...
def get_domains_oauth2client_credentials(attribute_sets: Optional[Sequence[str]] = None,
    ...
    test_oauth2client_credentials = oci.Identity.get_domains_oauth2client_credentials(idcs_endpoint=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        oauth2client_credential_count=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        oauth2client_credential_filter=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
        attribute_sets=[],
        attributes="",
    ...
    return AwaitableGetDomainsOauth2clientCredentialsResult(
        ...
        oauth2client_credential_count=__ret__.oauth2client_credential_count,
        oauth2client_credential_filter=__ret__.oauth2client_credential_filter,
        oauth2client_credentials=__ret__.oauth2client_credentials,
...
@_utilities.lift_output_func(get_domains_oauth2client_credentials)
