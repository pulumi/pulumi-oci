...
__all__ = [
    'GetDomainsOauth2clientCredentialsResult',
    'AwaitableGetDomainsOauth2clientCredentialsResult',
    'get_domains_oauth2client_credentials',
    'get_domains_oauth2client_credentials_output',
]

@pulumi.output_type
class GetDomainsOauth2clientCredentialsResult:
    """
    A collection of values returned by getDomainsOauth2clientCredentials.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, oauth2client_credential_count=None, oauth2client_credential_filter=None, oauth2client_credentials=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        ...
        if oauth2client_credential_count and not isinstance(oauth2client_credential_count, int):
            raise TypeError("Expected argument 'oauth2client_credential_count' to be a int")
        pulumi.set(__self__, "oauth2client_credential_count", oauth2client_credential_count)
        if oauth2client_credential_filter and not isinstance(oauth2client_credential_filter, str):
            raise TypeError("Expected argument 'oauth2client_credential_filter' to be a str")
        pulumi.set(__self__, "oauth2client_credential_filter", oauth2client_credential_filter)
        if oauth2client_credentials and not isinstance(oauth2client_credentials, list):
            raise TypeError("Expected argument 'oauth2client_credentials' to be a list")
        pulumi.set(__self__, "oauth2client_credentials", oauth2client_credentials)
    ...
    @_builtins.property
    @pulumi.getter(name="oauth2clientCredentialCount")
    def oauth2client_credential_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "oauth2client_credential_count")

    @_builtins.property
    @pulumi.getter(name="oauth2clientCredentialFilter")
    def oauth2client_credential_filter(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "oauth2client_credential_filter")

    @_builtins.property
    @pulumi.getter(name="oauth2clientCredentials")
    def oauth2client_credentials(self) -> Sequence['outputs.GetDomainsOauth2clientCredentialsOauth2clientCredentialResult']:
        """
        The list of oauth2client_credentials.
        """
        return pulumi.get(self, "oauth2client_credentials")
...
class AwaitableGetDomainsOauth2clientCredentialsResult(GetDomainsOauth2clientCredentialsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsOauth2clientCredentialsResult(
            ...
            oauth2client_credential_count=self.oauth2client_credential_count,
            oauth2client_credential_filter=self.oauth2client_credential_filter,
            oauth2client_credentials=self.oauth2client_credentials,
...
def get_domains_oauth2client_credentials(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                         ...
                                         oauth2client_credential_count: Optional[_builtins.int] = None,
                                         oauth2client_credential_filter: Optional[_builtins.str] = None,
                                         ...
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsOauth2clientCredentialsResult:
    """
    ...
    :param _builtins.int oauth2client_credential_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str oauth2client_credential_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    __args__['oauth2clientCredentialCount'] = oauth2client_credential_count
    __args__['oauth2clientCredentialFilter'] = oauth2client_credential_filter
    __args__['resourceTypeSchemaVersion'] = resource_type_schema_version
    __args__['sortBy'] = sort_by
    __args__['sortOrder'] = sort_order
    __args__['startIndex'] = start_index
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsOauth2clientCredentials:getDomainsOauth2clientCredentials', __args__, opts=opts, typ=GetDomainsOauth2clientCredentialsResult).value

    return AwaitableGetDomainsOauth2clientCredentialsResult(
        ...
        oauth2client_credential_count=pulumi.get(__ret__, 'oauth2client_credential_count'),
        oauth2client_credential_filter=pulumi.get(__ret__, 'oauth2client_credential_filter'),
        oauth2client_credentials=pulumi.get(__ret__, 'oauth2client_credentials'),
...
def get_domains_oauth2client_credentials_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                                ...
                                                oauth2client_credential_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                                oauth2client_credential_filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                ...
                                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsOauth2clientCredentialsResult]:
    """
    This data source provides the list of O Auth2 Client Credentials in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsOauth2clientCredentials:getDomainsOauth2clientCredentials', __args__, opts=opts, typ=GetDomainsOauth2clientCredentialsResult)
    return __ret__.apply(lambda __response__: GetDomainsOauth2clientCredentialsResult(
        ...
        oauth2client_credential_count=pulumi.get(__response__, 'oauth2client_credential_count'),
        oauth2client_credential_filter=pulumi.get(__response__, 'oauth2client_credential_filter'),
        oauth2client_credentials=pulumi.get(__response__, 'oauth2client_credentials'),
