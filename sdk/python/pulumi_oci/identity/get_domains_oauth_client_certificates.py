...
class GetDomainsOauthClientCertificatesResult:
    ...
    def oauth_client_certificate_count(self) -> Optional[int]:
        return pulumi.get(self, "oauth_client_certificate_count")

    @property
    @pulumi.getter(name="oauthClientCertificateFilter")
    def oauth_client_certificate_filter(self) -> Optional[str]:
...
def get_domains_oauth_client_certificates(authorization: Optional[str] = None,
    ...
    :param int oauth_client_certificate_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param str oauth_client_certificate_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
...
def get_domains_oauth_client_certificates_output(authorization: Optional[pulumi.Input[Optional[str]]] = None,
                                                 compartment_id: Optional[pulumi.Input[Optional[str]]] = None,
                                                 idcs_endpoint: Optional[pulumi.Input[str]] = None,
                                                 oauth_client_certificate_count: Optional[pulumi.Input[Optional[int]]] = None,
                                                 oauth_client_certificate_filter: Optional[pulumi.Input[Optional[str]]] = None,
