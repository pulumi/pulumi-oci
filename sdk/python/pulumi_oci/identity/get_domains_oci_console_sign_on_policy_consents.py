...
class GetDomainsOciConsoleSignOnPolicyConsentsResult:
    ...
    def oci_console_sign_on_policy_consent_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "oci_console_sign_on_policy_consent_count")

    @_builtins.property
    @pulumi.getter(name="ociConsoleSignOnPolicyConsentFilter")
    def oci_console_sign_on_policy_consent_filter(self) -> Optional[_builtins.str]:
...
def get_domains_oci_console_sign_on_policy_consents(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                                    attributes: Optional[_builtins.str] = None,
                                                    authorization: Optional[_builtins.str] = None,
                                                    filters: Optional[Sequence[Union['GetDomainsOciConsoleSignOnPolicyConsentsFilterArgs', 'GetDomainsOciConsoleSignOnPolicyConsentsFilterArgsDict', 'outputs.GetDomainsOciConsoleSignOnPolicyConsentsFilterResult']]] = None,
                                                    idcs_endpoint: Optional[_builtins.str] = None,
                                                    oci_console_sign_on_policy_consent_count: Optional[_builtins.int] = None,
                                                    oci_console_sign_on_policy_consent_filter: Optional[_builtins.str] = None,
    ...
    :param _builtins.int oci_console_sign_on_policy_consent_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str oci_console_sign_on_policy_consent_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
...
def get_domains_oci_console_sign_on_policy_consents_output(attribute_sets: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                                                           ...
                                                           filters: pulumi.Input[Optional[Optional[Sequence[Union['GetDomainsOciConsoleSignOnPolicyConsentsFilterArgs', 'GetDomainsOciConsoleSignOnPolicyConsentsFilterArgsDict', 'outputs.GetDomainsOciConsoleSignOnPolicyConsentsFilterResult']]]]] = None,
                                                           idcs_endpoint: pulumi.Input[Optional[_builtins.str]] = None,
                                                           oci_console_sign_on_policy_consent_count: pulumi.Input[Optional[Optional[_builtins.int]]] = None,
                                                           oci_console_sign_on_policy_consent_filter: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
