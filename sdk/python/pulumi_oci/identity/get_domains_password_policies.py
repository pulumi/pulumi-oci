...
__all__ = [
    'GetDomainsPasswordPoliciesResult',
    'AwaitableGetDomainsPasswordPoliciesResult',
    'get_domains_password_policies',
    'get_domains_password_policies_output',
]

@pulumi.output_type
class GetDomainsPasswordPoliciesResult:
    """
    A collection of values returned by getDomainsPasswordPolicies.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, password_policies=None, password_policy_count=None, password_policy_filter=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        ...
        if password_policy_count and not isinstance(password_policy_count, int):
            raise TypeError("Expected argument 'password_policy_count' to be a int")
        pulumi.set(__self__, "password_policy_count", password_policy_count)
        if password_policy_filter and not isinstance(password_policy_filter, str):
            raise TypeError("Expected argument 'password_policy_filter' to be a str")
        pulumi.set(__self__, "password_policy_filter", password_policy_filter)
    ...
    def password_policies(self) -> Sequence['outputs.GetDomainsPasswordPoliciesPasswordPolicyResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="passwordPolicyCount")
    def password_policy_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "password_policy_count")

    @_builtins.property
    @pulumi.getter(name="passwordPolicyFilter")
    def password_policy_filter(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "password_policy_filter")
...
class AwaitableGetDomainsPasswordPoliciesResult(GetDomainsPasswordPoliciesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsPasswordPoliciesResult(
            ...
            password_policy_count=self.password_policy_count,
            password_policy_filter=self.password_policy_filter,
...
def get_domains_password_policies(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                  ...
                                  password_policy_count: Optional[_builtins.int] = None,
                                  password_policy_filter: Optional[_builtins.str] = None,
                                  ...
                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsPasswordPoliciesResult:
    """
    ...
    :param _builtins.int password_policy_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str password_policy_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    __args__['passwordPolicyCount'] = password_policy_count
    __args__['passwordPolicyFilter'] = password_policy_filter
    __args__['resourceTypeSchemaVersion'] = resource_type_schema_version
    __args__['sortBy'] = sort_by
    __args__['sortOrder'] = sort_order
    __args__['startIndex'] = start_index
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsPasswordPolicies:getDomainsPasswordPolicies', __args__, opts=opts, typ=GetDomainsPasswordPoliciesResult).value

    return AwaitableGetDomainsPasswordPoliciesResult(
        ...
        password_policy_count=pulumi.get(__ret__, 'password_policy_count'),
        password_policy_filter=pulumi.get(__ret__, 'password_policy_filter'),
...
def get_domains_password_policies_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                         ...
                                         password_policy_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                         password_policy_filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                         ...
                                         opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsPasswordPoliciesResult]:
    """
    This data source provides the list of Password Policies in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsPasswordPolicies:getDomainsPasswordPolicies', __args__, opts=opts, typ=GetDomainsPasswordPoliciesResult)
    return __ret__.apply(lambda __response__: GetDomainsPasswordPoliciesResult(
        ...
        password_policy_count=pulumi.get(__response__, 'password_policy_count'),
        password_policy_filter=pulumi.get(__response__, 'password_policy_filter'),
