...
def get_domains_password_policy(attribute_sets: Optional[Sequence[str]] = None,
    ...
    return AwaitableGetDomainsPasswordPolicyResult(
        allowed_chars=__ret__.allowed_chars,
        attribute_sets=__ret__.attribute_sets,
        attributes=__ret__.attributes,
        authorization=__ret__.authorization,
        compartment_ocid=__ret__.compartment_ocid,
        configured_password_policy_rules=__ret__.configured_password_policy_rules,
        delete_in_progress=__ret__.delete_in_progress,
        description=__ret__.description,
        dictionary_delimiter=__ret__.dictionary_delimiter,
        dictionary_location=__ret__.dictionary_location,
        dictionary_word_disallowed=__ret__.dictionary_word_disallowed,
        disallowed_chars=__ret__.disallowed_chars,
        disallowed_substrings=__ret__.disallowed_substrings,
        domain_ocid=__ret__.domain_ocid,
        external_id=__ret__.external_id,
        first_name_disallowed=__ret__.first_name_disallowed,
        force_password_reset=__ret__.force_password_reset,
        ...
        last_name_disallowed=__ret__.last_name_disallowed,
        lockout_duration=__ret__.lockout_duration,
        max_incorrect_attempts=__ret__.max_incorrect_attempts,
        max_length=__ret__.max_length,
        max_repeated_chars=__ret__.max_repeated_chars,
        max_special_chars=__ret__.max_special_chars,
        metas=__ret__.metas,
        min_alpha_numerals=__ret__.min_alpha_numerals,
        min_alphas=__ret__.min_alphas,
        min_length=__ret__.min_length,
        min_lower_case=__ret__.min_lower_case,
        min_numerals=__ret__.min_numerals,
        min_password_age=__ret__.min_password_age,
        min_special_chars=__ret__.min_special_chars,
        min_unique_chars=__ret__.min_unique_chars,
        min_upper_case=__ret__.min_upper_case,
        name=__ret__.name,
        num_passwords_in_history=__ret__.num_passwords_in_history,
        ocid=__ret__.ocid,
        password_expire_warning=__ret__.password_expire_warning,
        password_expires_after=__ret__.password_expires_after,
        password_policy_id=__ret__.password_policy_id,
        password_strength=__ret__.password_strength,
        priority=__ret__.priority,
        required_chars=__ret__.required_chars,
        resource_type_schema_version=__ret__.resource_type_schema_version,
        schemas=__ret__.schemas,
        starts_with_alphabet=__ret__.starts_with_alphabet,
        tags=__ret__.tags,
        tenancy_ocid=__ret__.tenancy_ocid,
        user_name_disallowed=__ret__.user_name_disallowed)
