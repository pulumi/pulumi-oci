...
__all__ = [
    'GetDomainsPoliciesResult',
    'AwaitableGetDomainsPoliciesResult',
    'get_domains_policies',
    'get_domains_policies_output',
]

@pulumi.output_type
class GetDomainsPoliciesResult:
    """
    A collection of values returned by getDomainsPolicies.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, policies=None, policy_count=None, policy_filter=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        ...
        if policy_count and not isinstance(policy_count, int):
            raise TypeError("Expected argument 'policy_count' to be a int")
        pulumi.set(__self__, "policy_count", policy_count)
        if policy_filter and not isinstance(policy_filter, str):
            raise TypeError("Expected argument 'policy_filter' to be a str")
    ...
    @property
    @pulumi.getter
    def policies(self) -> Sequence['outputs.GetDomainsPoliciesPolicyResult']:
        """
    ...
    @property
    @pulumi.getter(name="policyCount")
    def policy_count(self) -> Optional[builtins.int]:
        return pulumi.get(self, "policy_count")

    @property
    @pulumi.getter(name="policyFilter")
    def policy_filter(self) -> Optional[builtins.str]:
...
class AwaitableGetDomainsPoliciesResult(GetDomainsPoliciesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsPoliciesResult(
            ...
            policy_filter=self.policy_filter,
...
def get_domains_policies(attribute_sets: Optional[Sequence[builtins.str]] = None,
                         ...
                         policy_count: Optional[builtins.int] = None,
                         policy_filter: Optional[builtins.str] = None,
                         ...
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsPoliciesResult:
    """
    ...
    :param builtins.int policy_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param builtins.str policy_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    __args__['policyCount'] = policy_count
    __args__['policyFilter'] = policy_filter
    __args__['resourceTypeSchemaVersion'] = resource_type_schema_version
    __args__['sortBy'] = sort_by
    __args__['sortOrder'] = sort_order
    __args__['startIndex'] = start_index
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsPolicies:getDomainsPolicies', __args__, opts=opts, typ=GetDomainsPoliciesResult).value

    return AwaitableGetDomainsPoliciesResult(
        ...
        policy_count=pulumi.get(__ret__, 'policy_count'),
        policy_filter=pulumi.get(__ret__, 'policy_filter'),
...
def get_domains_policies_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                ...
                                policy_count: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                policy_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                ...
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsPoliciesResult]:
    """
    This data source provides the list of Policies in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsPolicies:getDomainsPolicies', __args__, opts=opts, typ=GetDomainsPoliciesResult)
    return __ret__.apply(lambda __response__: GetDomainsPoliciesResult(
        ...
        policy_count=pulumi.get(__response__, 'policy_count'),
        policy_filter=pulumi.get(__response__, 'policy_filter'),
