...
class GetDomainsPolicyResult:
    ...
    def policy_groovy(self) -> builtins.str:
        """
...
def get_domains_policy(attribute_sets: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.str policy_id: ID of the resource
...
def get_domains_policy_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
