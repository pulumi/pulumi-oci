...
class GetDomainsResourceTypeSchemaAttributesResult:
    ...
    def resource_type_schema_attribute_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "resource_type_schema_attribute_count")

    @_builtins.property
    @pulumi.getter(name="resourceTypeSchemaAttributeFilter")
    def resource_type_schema_attribute_filter(self) -> Optional[_builtins.str]:
...
def get_domains_resource_type_schema_attributes(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                                ...
                                                resource_type_schema_attribute_count: Optional[_builtins.int] = None,
                                                resource_type_schema_attribute_filter: Optional[_builtins.str] = None,
    ...
    :param _builtins.int resource_type_schema_attribute_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str resource_type_schema_attribute_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
...
def get_domains_resource_type_schema_attributes_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                                       ...
                                                       resource_type_schema_attribute_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                                       resource_type_schema_attribute_filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                       ...
                                                       opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsResourceTypeSchemaAttributesResult]:
    """
    This data source provides the list of Resource Type Schema Attributes in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsResourceTypeSchemaAttributes:getDomainsResourceTypeSchemaAttributes', __args__, opts=opts, typ=GetDomainsResourceTypeSchemaAttributesResult)
    return __ret__.apply(lambda __response__: GetDomainsResourceTypeSchemaAttributesResult(
        ...
        resource_type_schema_attribute_count=pulumi.get(__response__, 'resource_type_schema_attribute_count'),
        resource_type_schema_attribute_filter=pulumi.get(__response__, 'resource_type_schema_attribute_filter'),
        resource_type_schema_attributes=pulumi.get(__response__, 'resource_type_schema_attributes'),
