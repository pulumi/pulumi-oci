...
class GetDomainsRuleResult:
    ...
    def rule_groovy(self) -> _builtins.str:
        """
...
def get_domains_rule(attribute_sets: Optional[Sequence[_builtins.str]] = None,
    ...
    :param _builtins.str rule_id: ID of the resource
    """
    __args__ = dict()
...
def get_domains_rule_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetDomainsRuleResult(
        ...
        returns=pulumi.get(__response__, 'returns'),
        rule_groovy=pulumi.get(__response__, 'rule_groovy'),
