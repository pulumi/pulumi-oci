...
class GetDomainsRuleResult:
    ...
    def rule_groovy(self) -> builtins.str:
        """
...
def get_domains_rule(attribute_sets: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.str rule_id: ID of the resource
    """
    __args__ = dict()
...
def get_domains_rule_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
