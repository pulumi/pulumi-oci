...
__all__ = [
    'GetDomainsRulesResult',
    'AwaitableGetDomainsRulesResult',
    'get_domains_rules',
    'get_domains_rules_output',
]

@pulumi.output_type
class GetDomainsRulesResult:
    """
    A collection of values returned by getDomainsRules.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, resource_type_schema_version=None, rule_count=None, rule_filter=None, rules=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        ...
        if rule_filter and not isinstance(rule_filter, str):
            raise TypeError("Expected argument 'rule_filter' to be a str")
        pulumi.set(__self__, "rule_filter", rule_filter)
    ...
    @_builtins.property
    @pulumi.getter(name="ruleFilter")
    def rule_filter(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "rule_filter")

    @_builtins.property
    @pulumi.getter
    def rules(self) -> Sequence['outputs.GetDomainsRulesRuleResult']:
        """
        The list of rules.
        """
...
class AwaitableGetDomainsRulesResult(GetDomainsRulesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsRulesResult(
...
def get_domains_rules(attribute_sets: Optional[Sequence[_builtins.str]] = None,
    ...
    :param _builtins.int rule_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str rule_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    __args__['ruleCount'] = rule_count
    __args__['ruleFilter'] = rule_filter
    __args__['sortBy'] = sort_by
    __args__['sortOrder'] = sort_order
    __args__['startIndex'] = start_index
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsRules:getDomainsRules', __args__, opts=opts, typ=GetDomainsRulesResult).value

    return AwaitableGetDomainsRulesResult(
        ...
        rule_filter=pulumi.get(__ret__, 'rule_filter'),
...
def get_domains_rules_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                             ...
                             rule_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                             rule_filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                             ...
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsRulesResult]:
    """
    This data source provides the list of Rules in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsRules:getDomainsRules', __args__, opts=opts, typ=GetDomainsRulesResult)
    return __ret__.apply(lambda __response__: GetDomainsRulesResult(
        ...
        rule_filter=pulumi.get(__response__, 'rule_filter'),
