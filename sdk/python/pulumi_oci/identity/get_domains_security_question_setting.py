...
class GetDomainsSecurityQuestionSettingResult:
    ...
    def idcs_created_bies(self) -> Optional[Sequence['outputs.GetDomainsSecurityQuestionSettingIdcsCreatedByResult']]:
    ...
    def idcs_last_modified_bies(self) -> Optional[Sequence['outputs.GetDomainsSecurityQuestionSettingIdcsLastModifiedByResult']]:
    ...
    @property
    @pulumi.getter
    def metas(self) -> Optional[Sequence['outputs.GetDomainsSecurityQuestionSettingMetaResult']]:
    ...
    @property
    @pulumi.getter
    def tags(self) -> Optional[Sequence['outputs.GetDomainsSecurityQuestionSettingTagResult']]:
...
@_utilities.lift_output_func(get_domains_security_question_setting)
