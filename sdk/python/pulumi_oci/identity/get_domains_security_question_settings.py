...
def get_domains_security_question_settings(attribute_sets: Optional[Sequence[str]] = None,
    ...
    test_security_question_settings = oci.Identity.get_domains_security_question_settings(idcs_endpoint=data["oci_identity_domain"]["test_domain"]["url"],
        attribute_sets=["all"],
        attributes="",
...
@_utilities.lift_output_func(get_domains_security_question_settings)
def get_domains_security_question_settings_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
                                                  ...
                                                  opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetDomainsSecurityQuestionSettingsResult]:
    """
    This data source provides the list of Security Question Settings in Oracle Cloud Infrastructure Identity Domains service.
