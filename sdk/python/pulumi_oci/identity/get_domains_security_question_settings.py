...
def get_domains_security_question_settings(attribute_sets: Optional[Sequence[builtins.str]] = None,
...
def get_domains_security_question_settings_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
