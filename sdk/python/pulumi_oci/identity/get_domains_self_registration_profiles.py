...
__all__ = [
    'GetDomainsSelfRegistrationProfilesResult',
    'AwaitableGetDomainsSelfRegistrationProfilesResult',
    'get_domains_self_registration_profiles',
    'get_domains_self_registration_profiles_output',
]

@pulumi.output_type
class GetDomainsSelfRegistrationProfilesResult:
    """
    A collection of values returned by getDomainsSelfRegistrationProfiles.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, resource_type_schema_version=None, schemas=None, self_registration_profile_count=None, self_registration_profile_filter=None, self_registration_profiles=None, sort_by=None, sort_order=None, start_index=None, total_results=None):
        ...
        if self_registration_profile_count and not isinstance(self_registration_profile_count, int):
            raise TypeError("Expected argument 'self_registration_profile_count' to be a int")
        pulumi.set(__self__, "self_registration_profile_count", self_registration_profile_count)
        if self_registration_profile_filter and not isinstance(self_registration_profile_filter, str):
            raise TypeError("Expected argument 'self_registration_profile_filter' to be a str")
        pulumi.set(__self__, "self_registration_profile_filter", self_registration_profile_filter)
        if self_registration_profiles and not isinstance(self_registration_profiles, list):
            raise TypeError("Expected argument 'self_registration_profiles' to be a list")
    ...
    @_builtins.property
    @pulumi.getter(name="selfRegistrationProfileCount")
    def self_registration_profile_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "self_registration_profile_count")

    @_builtins.property
    @pulumi.getter(name="selfRegistrationProfileFilter")
    def self_registration_profile_filter(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "self_registration_profile_filter")

    @_builtins.property
    @pulumi.getter(name="selfRegistrationProfiles")
    def self_registration_profiles(self) -> Sequence['outputs.GetDomainsSelfRegistrationProfilesSelfRegistrationProfileResult']:
        """
...
class AwaitableGetDomainsSelfRegistrationProfilesResult(GetDomainsSelfRegistrationProfilesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsSelfRegistrationProfilesResult(
            ...
            self_registration_profile_count=self.self_registration_profile_count,
            self_registration_profile_filter=self.self_registration_profile_filter,
            self_registration_profiles=self.self_registration_profiles,
...
def get_domains_self_registration_profiles(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                           ...
                                           self_registration_profile_count: Optional[_builtins.int] = None,
                                           self_registration_profile_filter: Optional[_builtins.str] = None,
                                           sort_by: Optional[_builtins.str] = None,
                                           sort_order: Optional[_builtins.str] = None,
                                           start_index: Optional[_builtins.int] = None,
                                           opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsSelfRegistrationProfilesResult:
    """
    ...
    test_self_registration_profiles = oci.identity.get_domains_self_registration_profiles(idcs_endpoint=test_domain["url"],
        self_registration_profile_count=int(self_registration_profile_self_registration_profile_count),
        ...
        start_index=int(self_registration_profile_start_index))
    ```
    ...
    :param _builtins.int self_registration_profile_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str self_registration_profile_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    ...
    __args__['selfRegistrationProfileCount'] = self_registration_profile_count
    __args__['selfRegistrationProfileFilter'] = self_registration_profile_filter
    __args__['sortBy'] = sort_by
    __args__['sortOrder'] = sort_order
    __args__['startIndex'] = start_index
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsSelfRegistrationProfiles:getDomainsSelfRegistrationProfiles', __args__, opts=opts, typ=GetDomainsSelfRegistrationProfilesResult).value

    return AwaitableGetDomainsSelfRegistrationProfilesResult(
        ...
        self_registration_profile_count=pulumi.get(__ret__, 'self_registration_profile_count'),
        self_registration_profile_filter=pulumi.get(__ret__, 'self_registration_profile_filter'),
        self_registration_profiles=pulumi.get(__ret__, 'self_registration_profiles'),
        sort_by=pulumi.get(__ret__, 'sort_by'),
        sort_order=pulumi.get(__ret__, 'sort_order'),
        start_index=pulumi.get(__ret__, 'start_index'),
        total_results=pulumi.get(__ret__, 'total_results'))
def get_domains_self_registration_profiles_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                                  ...
                                                  self_registration_profile_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                                  self_registration_profile_filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                                                  ...
                                                  opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsSelfRegistrationProfilesResult]:
    """
    This data source provides the list of Self Registration Profiles in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsSelfRegistrationProfiles:getDomainsSelfRegistrationProfiles', __args__, opts=opts, typ=GetDomainsSelfRegistrationProfilesResult)
    return __ret__.apply(lambda __response__: GetDomainsSelfRegistrationProfilesResult(
        ...
        self_registration_profile_count=pulumi.get(__response__, 'self_registration_profile_count'),
        self_registration_profile_filter=pulumi.get(__response__, 'self_registration_profile_filter'),
        self_registration_profiles=pulumi.get(__response__, 'self_registration_profiles'),
