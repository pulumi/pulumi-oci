...
class GetDomainsSocialIdentityProviderResult:
    ...
    def account_linking_enabled(self) -> builtins.bool:
        """
    ...
    def admin_scopes(self) -> Sequence[builtins.str]:
        """
    ...
    def authz_url(self) -> builtins.str:
        """
    ...
    def auto_redirect_enabled(self) -> builtins.bool:
        """
    ...
    def client_credential_in_payload(self) -> builtins.bool:
        """
    ...
    def clock_skew_in_seconds(self) -> builtins.int:
        """
    ...
    def id_attribute(self) -> builtins.str:
        """
    ...
    def jit_prov_group_static_list_enabled(self) -> builtins.bool:
        """
    ...
    def refresh_token_url(self) -> builtins.str:
        """
    ...
    def registration_enabled(self) -> builtins.bool:
        """
    ...
    def show_on_login(self) -> builtins.bool:
        """
    ...
    def social_identity_provider_id(self) -> builtins.str:
        return pulumi.get(self, "social_identity_provider_id")

    @property
    @pulumi.getter(name="socialJitProvisioningEnabled")
    def social_jit_provisioning_enabled(self) -> builtins.bool:
        """
...
def get_domains_social_identity_provider(authorization: Optional[builtins.str] = None,
                                         idcs_endpoint: Optional[builtins.str] = None,
                                         resource_type_schema_version: Optional[builtins.str] = None,
                                         social_identity_provider_id: Optional[builtins.str] = None,
    ...
    :param builtins.str social_identity_provider_id: ID of the resource
    """
    __args__ = dict()
...
def get_domains_social_identity_provider_output(authorization: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                ...
                                                social_identity_provider_id: Optional[pulumi.Input[builtins.str]] = None,
