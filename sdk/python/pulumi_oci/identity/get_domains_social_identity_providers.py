...
class GetDomainsSocialIdentityProvidersResult:
    ...
    def social_identity_provider_count(self) -> Optional[builtins.int]:
        return pulumi.get(self, "social_identity_provider_count")

    @property
    @pulumi.getter(name="socialIdentityProviderFilter")
    def social_identity_provider_filter(self) -> Optional[builtins.str]:
...
def get_domains_social_identity_providers(authorization: Optional[builtins.str] = None,
                                          ...
                                          social_identity_provider_count: Optional[builtins.int] = None,
                                          social_identity_provider_filter: Optional[builtins.str] = None,
...
def get_domains_social_identity_providers_output(authorization: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                 ...
                                                 social_identity_provider_count: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                                 social_identity_provider_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
