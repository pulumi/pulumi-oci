...
def get_domains_user(attribute_sets: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.str user_id: ID of the resource
    """
    __args__ = dict()
...
def get_domains_user_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
