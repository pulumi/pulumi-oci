...
class GetDomainsUserAttributesSettingResult:
    ...
    def user_attributes_setting_id(self) -> _builtins.str:
...
def get_domains_user_attributes_setting(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                        ...
                                        user_attributes_setting_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str user_attributes_setting_id: ID of the resource
    """
    __args__ = dict()
