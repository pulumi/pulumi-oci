...
class GetDomainsUserAttributesSettingResult:
    ...
    def attribute_settings(self) -> Sequence['outputs.GetDomainsUserAttributesSettingAttributeSettingResult']:
        """
    ...
    def idcs_created_bies(self) -> Sequence['outputs.GetDomainsUserAttributesSettingIdcsCreatedByResult']:
        """
    ...
    def idcs_last_modified_bies(self) -> Sequence['outputs.GetDomainsUserAttributesSettingIdcsLastModifiedByResult']:
        """
    ...
    @property
    @pulumi.getter
    def metas(self) -> Sequence['outputs.GetDomainsUserAttributesSettingMetaResult']:
        """
    ...
    @property
    @pulumi.getter
    def tags(self) -> Sequence['outputs.GetDomainsUserAttributesSettingTagResult']:
        """
    ...
    def user_attributes_setting_id(self) -> builtins.str:
...
def get_domains_user_attributes_setting(attribute_sets: Optional[Sequence[builtins.str]] = None,
                                        ...
                                        user_attributes_setting_id: Optional[builtins.str] = None,
    ...
    :param builtins.str user_attributes_setting_id: ID of the resource
    """
    __args__ = dict()
...
def get_domains_user_attributes_setting_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                               ...
                                               user_attributes_setting_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsUserAttributesSetting:getDomainsUserAttributesSetting', __args__, opts=opts, typ=GetDomainsUserAttributesSettingResult)
    return __ret__.apply(lambda __response__: GetDomainsUserAttributesSettingResult(
        attribute_sets=pulumi.get(__response__, 'attribute_sets'),
        attribute_settings=pulumi.get(__response__, 'attribute_settings'),
        ...
        user_attributes_setting_id=pulumi.get(__response__, 'user_attributes_setting_id')))
