...
class GetDomainsUserAttributesSettingsResult:
    ...
    def user_attributes_settings(self) -> Optional[Sequence['outputs.GetDomainsUserAttributesSettingsUserAttributesSettingResult']]:
...
@_utilities.lift_output_func(get_domains_user_attributes_settings)
