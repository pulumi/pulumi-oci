...
__all__ = [
    'GetDomainsUserAttributesSettingsResult',
    'AwaitableGetDomainsUserAttributesSettingsResult',
    'get_domains_user_attributes_settings',
    'get_domains_user_attributes_settings_output',
]

@pulumi.output_type
class GetDomainsUserAttributesSettingsResult:
    """
    A collection of values returned by getDomainsUserAttributesSettings.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, resource_type_schema_version=None, schemas=None, start_index=None, total_results=None, user_attributes_settings=None):
        ...
        if user_attributes_settings and not isinstance(user_attributes_settings, list):
            raise TypeError("Expected argument 'user_attributes_settings' to be a list")
        pulumi.set(__self__, "user_attributes_settings", user_attributes_settings)
    ...
    def start_index(self) -> builtins.int:
    ...
    @property
    @pulumi.getter(name="userAttributesSettings")
    def user_attributes_settings(self) -> Sequence['outputs.GetDomainsUserAttributesSettingsUserAttributesSettingResult']:
        """
        The list of user_attributes_settings.
        """
        return pulumi.get(self, "user_attributes_settings")


class AwaitableGetDomainsUserAttributesSettingsResult(GetDomainsUserAttributesSettingsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsUserAttributesSettingsResult(
            ...
            user_attributes_settings=self.user_attributes_settings)


def get_domains_user_attributes_settings(attribute_sets: Optional[Sequence[builtins.str]] = None,
                                         ...
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsUserAttributesSettingsResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsUserAttributesSettings:getDomainsUserAttributesSettings', __args__, opts=opts, typ=GetDomainsUserAttributesSettingsResult).value

    return AwaitableGetDomainsUserAttributesSettingsResult(
        ...
        user_attributes_settings=pulumi.get(__ret__, 'user_attributes_settings'))
def get_domains_user_attributes_settings_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                                ...
                                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDomainsUserAttributesSettingsResult]:
    """
    This data source provides the list of User Attributes Settings in Oracle Cloud Infrastructure Identity Domains service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getDomainsUserAttributesSettings:getDomainsUserAttributesSettings', __args__, opts=opts, typ=GetDomainsUserAttributesSettingsResult)
    return __ret__.apply(lambda __response__: GetDomainsUserAttributesSettingsResult(
        ...
        user_attributes_settings=pulumi.get(__response__, 'user_attributes_settings')))
