...
class GetDomainsUserDbCredentialResult:
    ...
    def user_db_credential_id(self) -> builtins.str:
...
def get_domains_user_db_credential(attribute_sets: Optional[Sequence[builtins.str]] = None,
                                   ...
                                   user_db_credential_id: Optional[builtins.str] = None,
    ...
    :param builtins.str user_db_credential_id: ID of the resource
    """
    __args__ = dict()
...
def get_domains_user_db_credential_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                          ...
                                          user_db_credential_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetDomainsUserDbCredentialResult(
        ...
        user_db_credential_id=pulumi.get(__response__, 'user_db_credential_id'),
