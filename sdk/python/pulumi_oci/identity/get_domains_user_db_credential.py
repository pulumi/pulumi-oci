...
class GetDomainsUserDbCredentialResult:
    ...
    def user_db_credential_id(self) -> _builtins.str:
...
def get_domains_user_db_credential(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                   ...
                                   user_db_credential_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str user_db_credential_id: ID of the resource
    """
    __args__ = dict()
