...
__all__ = [
    'GetDomainsUserDbCredentialsResult',
    'AwaitableGetDomainsUserDbCredentialsResult',
    'get_domains_user_db_credentials',
    'get_domains_user_db_credentials_output',
]

@pulumi.output_type
class GetDomainsUserDbCredentialsResult:
    """
    A collection of values returned by getDomainsUserDbCredentials.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None, user_db_credential_count=None, user_db_credential_filter=None, user_db_credentials=None):
        ...
        if user_db_credential_count and not isinstance(user_db_credential_count, int):
            raise TypeError("Expected argument 'user_db_credential_count' to be a int")
        pulumi.set(__self__, "user_db_credential_count", user_db_credential_count)
        if user_db_credential_filter and not isinstance(user_db_credential_filter, str):
            raise TypeError("Expected argument 'user_db_credential_filter' to be a str")
        pulumi.set(__self__, "user_db_credential_filter", user_db_credential_filter)
        if user_db_credentials and not isinstance(user_db_credentials, list):
            raise TypeError("Expected argument 'user_db_credentials' to be a list")
        pulumi.set(__self__, "user_db_credentials", user_db_credentials)
    ...
    @_builtins.property
    @pulumi.getter(name="userDbCredentialCount")
    def user_db_credential_count(self) -> Optional[_builtins.int]:
        return pulumi.get(self, "user_db_credential_count")

    @_builtins.property
    @pulumi.getter(name="userDbCredentialFilter")
    def user_db_credential_filter(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "user_db_credential_filter")
...
class AwaitableGetDomainsUserDbCredentialsResult(GetDomainsUserDbCredentialsResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsUserDbCredentialsResult(
            ...
            user_db_credential_count=self.user_db_credential_count,
            user_db_credential_filter=self.user_db_credential_filter,
            user_db_credentials=self.user_db_credentials)


def get_domains_user_db_credentials(attribute_sets: Optional[Sequence[_builtins.str]] = None,
                                    ...
                                    user_db_credential_count: Optional[_builtins.int] = None,
                                    user_db_credential_filter: Optional[_builtins.str] = None,
    ...
    :param _builtins.int user_db_credential_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param _builtins.str user_db_credential_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsUserDbCredentials:getDomainsUserDbCredentials', __args__, opts=opts, typ=GetDomainsUserDbCredentialsResult).value

    return AwaitableGetDomainsUserDbCredentialsResult(
        ...
        user_db_credential_count=pulumi.get(__ret__, 'user_db_credential_count'),
        user_db_credential_filter=pulumi.get(__ret__, 'user_db_credential_filter'),
        user_db_credentials=pulumi.get(__ret__, 'user_db_credentials'))
def get_domains_user_db_credentials_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
                                           ...
                                           user_db_credential_count: Optional[pulumi.Input[Optional[_builtins.int]]] = None,
                                           user_db_credential_filter: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetDomainsUserDbCredentialsResult(
        ...
        user_db_credential_count=pulumi.get(__response__, 'user_db_credential_count'),
        user_db_credential_filter=pulumi.get(__response__, 'user_db_credential_filter'),
        user_db_credentials=pulumi.get(__response__, 'user_db_credentials')))
