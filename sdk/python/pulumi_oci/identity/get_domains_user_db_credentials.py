...
class GetDomainsUserDbCredentialsResult:
    ...
    def user_db_credential_count(self) -> Optional[builtins.int]:
        return pulumi.get(self, "user_db_credential_count")

    @property
    @pulumi.getter(name="userDbCredentialFilter")
    def user_db_credential_filter(self) -> Optional[builtins.str]:
...
def get_domains_user_db_credentials(attribute_sets: Optional[Sequence[builtins.str]] = None,
                                    ...
                                    user_db_credential_count: Optional[builtins.int] = None,
                                    user_db_credential_filter: Optional[builtins.str] = None,
    ...
    :param builtins.int user_db_credential_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param builtins.str user_db_credential_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    """
    __args__ = dict()
...
def get_domains_user_db_credentials_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                           ...
                                           user_db_credential_count: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                                           user_db_credential_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
