...
class GetDomainsUserDbCredentialsResult:
    ...
    def user_db_credential_count(self) -> Optional[int]:
        return pulumi.get(self, "user_db_credential_count")

    @property
    @pulumi.getter(name="userDbCredentialFilter")
    def user_db_credential_filter(self) -> Optional[str]:
...
def get_domains_user_db_credentials_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[str]]]] = None,
