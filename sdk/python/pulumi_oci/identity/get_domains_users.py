...
__all__ = [
    'GetDomainsUsersResult',
    'AwaitableGetDomainsUsersResult',
    'get_domains_users',
    'get_domains_users_output',
]

@pulumi.output_type
class GetDomainsUsersResult:
    """
    A collection of values returned by getDomainsUsers.
    """
    def __init__(__self__, attribute_sets=None, attributes=None, authorization=None, compartment_id=None, id=None, idcs_endpoint=None, items_per_page=None, resource_type_schema_version=None, schemas=None, sort_by=None, sort_order=None, start_index=None, total_results=None, user_count=None, user_filter=None, users=None):
        ...
        if user_filter and not isinstance(user_filter, str):
            raise TypeError("Expected argument 'user_filter' to be a str")
    ...
    def user_count(self) -> Optional[builtins.int]:
        return pulumi.get(self, "user_count")

    @property
    @pulumi.getter(name="userFilter")
    def user_filter(self) -> Optional[builtins.str]:
        return pulumi.get(self, "user_filter")

    @property
    @pulumi.getter
    def users(self) -> Sequence['outputs.GetDomainsUsersUserResult']:
        """
        The list of users.
        """
...
class AwaitableGetDomainsUsersResult(GetDomainsUsersResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDomainsUsersResult(
...
def get_domains_users(attribute_sets: Optional[Sequence[builtins.str]] = None,
                      ...
                      user_count: Optional[builtins.int] = None,
                      user_filter: Optional[builtins.str] = None,
                      opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDomainsUsersResult:
    """
    ...
    :param builtins.int user_count: OPTIONAL. An integer that indicates the desired maximum number of query results per page. 1000 is the largest value that you can use. See the Pagination section of the System for Cross-Domain Identity Management Protocol specification for more information. (Section 3.4.2.4).
    :param builtins.str user_filter: OPTIONAL. The filter string that is used to request a subset of resources. The filter string MUST be a valid filter expression. See the Filtering section of the SCIM specification for more information (Section 3.4.2.2). The string should contain at least one condition that each item must match in order to be returned in the search results. Each condition specifies an attribute, an operator, and a value. Conditions within a filter can be connected by logical operators (such as AND and OR). Sets of conditions can be grouped together using parentheses.
    """
    __args__ = dict()
    ...
    __ret__ = pulumi.runtime.invoke('oci:Identity/getDomainsUsers:getDomainsUsers', __args__, opts=opts, typ=GetDomainsUsersResult).value

    return AwaitableGetDomainsUsersResult(
...
def get_domains_users_output(attribute_sets: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                             ...
                             user_count: Optional[pulumi.Input[Optional[builtins.int]]] = None,
                             user_filter: Optional[pulumi.Input[Optional[builtins.str]]] = None,
