...
def get_group(group_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str group_id: The OCID of the group.
    """
    __args__ = dict()
...
def get_group_output(group_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Identity/getGroup:getGroup', __args__, opts=opts, typ=GetGroupResult)
