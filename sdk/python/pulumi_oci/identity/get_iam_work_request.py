...
def get_iam_work_request(iam_work_request_id: Optional[builtins.str] = None,
...
def get_iam_work_request_output(iam_work_request_id: Optional[pulumi.Input[builtins.str]] = None,
