...
def get_iam_work_requests(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str resource_identifier: The identifier of the resource the work request affects.
    """
    __args__ = dict()
...
def get_iam_work_requests_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                 filters: Optional[pulumi.Input[Optional[Sequence[Union['GetIamWorkRequestsFilterArgs', 'GetIamWorkRequestsFilterArgsDict']]]]] = None,
                                 resource_identifier: Optional[pulumi.Input[Optional[builtins.str]]] = None,
