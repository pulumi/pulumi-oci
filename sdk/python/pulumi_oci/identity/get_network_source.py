...
class GetNetworkSourceResult:
    ...
    def network_source_id(self) -> _builtins.str:
        return pulumi.get(self, "network_source_id")

    @_builtins.property
    @pulumi.getter(name="publicSourceLists")
    def public_source_lists(self) -> Sequence[_builtins.str]:
        """
...
def get_network_source(network_source_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str network_source_id: The OCID of the network source.
    """
    __args__ = dict()
