...
class GetNetworkSourceResult:
    ...
    def inactive_state(self) -> builtins.str:
        """
    ...
    def network_source_id(self) -> builtins.str:
        return pulumi.get(self, "network_source_id")

    @property
    @pulumi.getter(name="publicSourceLists")
    def public_source_lists(self) -> Sequence[builtins.str]:
        """
...
def get_network_source(network_source_id: Optional[builtins.str] = None,
    ...
    :param builtins.str network_source_id: The OCID of the network source.
    """
    __args__ = dict()
...
def get_network_source_output(network_source_id: Optional[pulumi.Input[builtins.str]] = None,
