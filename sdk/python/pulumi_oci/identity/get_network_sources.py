...
def get_network_sources(compartment_id: Optional[builtins.str] = None,
...
def get_network_sources_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
