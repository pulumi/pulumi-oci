...
class GetTagResult:
    ...
    def is_cost_tracking(self) -> builtins.bool:
        """
...
def get_tag(tag_name: Optional[builtins.str] = None,
...
def get_tag_output(tag_name: Optional[pulumi.Input[builtins.str]] = None,
