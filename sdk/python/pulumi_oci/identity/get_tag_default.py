...
class GetTagDefaultResult:
    ...
    def tag_default_id(self) -> _builtins.str:
        return pulumi.get(self, "tag_default_id")

    @_builtins.property
    @pulumi.getter(name="tagDefinitionId")
    def tag_definition_id(self) -> _builtins.str:
        """
...
def get_tag_default(tag_default_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str tag_default_id: The OCID of the tag default.
    """
    __args__ = dict()
...
def get_tag_default_output(tag_default_id: Optional[pulumi.Input[_builtins.str]] = None,
