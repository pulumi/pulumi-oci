...
class GetTagDefaultResult:
    ...
    def tag_default_id(self) -> builtins.str:
        return pulumi.get(self, "tag_default_id")

    @property
    @pulumi.getter(name="tagDefinitionId")
    def tag_definition_id(self) -> builtins.str:
        """
    ...
    def tag_definition_name(self) -> builtins.str:
        """
    ...
    def tag_namespace_id(self) -> builtins.str:
        """
...
def get_tag_default(tag_default_id: Optional[builtins.str] = None,
    ...
    :param builtins.str tag_default_id: The OCID of the tag default.
    """
    __args__ = dict()
...
def get_tag_default_output(tag_default_id: Optional[pulumi.Input[builtins.str]] = None,
