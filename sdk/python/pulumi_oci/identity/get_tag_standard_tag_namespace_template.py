...
class GetTagStandardTagNamespaceTemplateResult:
    ...
    def standard_tag_namespace_name(self) -> _builtins.str:
        """
...
def get_tag_standard_tag_namespace_template(compartment_id: Optional[_builtins.str] = None,
                                            standard_tag_namespace_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str standard_tag_namespace_name: The name of the standard tag namespace tempate that is requested
    """
    __args__ = dict()
