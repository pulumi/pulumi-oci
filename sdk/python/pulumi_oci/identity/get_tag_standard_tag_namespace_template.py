...
class GetTagStandardTagNamespaceTemplateResult:
    ...
    def standard_tag_namespace_name(self) -> builtins.str:
        """
...
def get_tag_standard_tag_namespace_template(compartment_id: Optional[builtins.str] = None,
                                            standard_tag_namespace_name: Optional[builtins.str] = None,
    ...
    :param builtins.str standard_tag_namespace_name: The name of the standard tag namespace tempate that is requested
    """
    __args__ = dict()
...
def get_tag_standard_tag_namespace_template_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                                   standard_tag_namespace_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetTagStandardTagNamespaceTemplateResult(
        ...
        standard_tag_namespace_name=pulumi.get(__response__, 'standard_tag_namespace_name'),
        status=pulumi.get(__response__, 'status'),
        tag_definition_templates=pulumi.get(__response__, 'tag_definition_templates')))
