...
def get_tag_standard_tag_namespace_templates(compartment_id: Optional[builtins.str] = None,
...
def get_tag_standard_tag_namespace_templates_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
