...
class GetTenancyResult:
    ...
    def home_region_key(self) -> builtins.str:
        """
    ...
    def upi_idcs_compatibility_layer_endpoint(self) -> builtins.str:
        """
...
def get_tenancy(tenancy_id: Optional[builtins.str] = None,
...
def get_tenancy_output(tenancy_id: Optional[pulumi.Input[builtins.str]] = None,
