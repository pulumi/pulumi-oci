...
class GetUiPasswordResult:
    ...
    def inactive_status(self) -> builtins.str:
...
def get_ui_password(user_id: Optional[builtins.str] = None,
...
def get_ui_password_output(user_id: Optional[pulumi.Input[builtins.str]] = None,
