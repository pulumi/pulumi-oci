...
def get_user_group_memberships(compartment_id: Optional[builtins.str] = None,
...
def get_user_group_memberships_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
