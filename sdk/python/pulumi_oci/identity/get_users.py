...
class GetUsersResult:
    ...
    def external_identifier(self) -> Optional[builtins.str]:
        """
...
def get_users(compartment_id: Optional[builtins.str] = None,
              external_identifier: Optional[builtins.str] = None,
    ...
    :param builtins.str external_identifier: The id of a user in the identity provider.
    :param builtins.str identity_provider_id: The id of the identity provider.
...
def get_users_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                     external_identifier: Optional[pulumi.Input[Optional[builtins.str]]] = None,
