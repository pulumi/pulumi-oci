...
class IdentityProviderArgs:
    def __init__(__self__, *,
                 ...
                 product_type: pulumi.Input[builtins.str],
                 protocol: pulumi.Input[builtins.str],
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_attributes: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a IdentityProvider resource.
        :param pulumi.Input[builtins.str] compartment_id: The OCID of your tenancy.
        :param pulumi.Input[builtins.str] description: (Updatable) The description you assign to the `IdentityProvider` during creation. Does not have to be unique, and it's changeable.
        :param pulumi.Input[builtins.str] metadata: (Updatable) The XML that contains the information required for federating.
        :param pulumi.Input[builtins.str] metadata_url: (Updatable) The URL for retrieving the identity provider's metadata, which contains information required for federating.
        :param pulumi.Input[builtins.str] product_type: The identity provider service or product. Supported identity providers are Oracle Identity Cloud Service (IDCS) and Microsoft Active Directory Federation Services (ADFS).  Example: `IDCS`
        :param pulumi.Input[builtins.str] protocol: (Updatable) The protocol used for federation.  Example: `SAML2` 
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_attributes: (Updatable) Extra name value pairs associated with this identity provider. Example: `{"clientId": "app_sf3kdjf3"}`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] name: The name you assign to the `IdentityProvider` during creation. The name must be unique across all `IdentityProvider` objects in the tenancy and cannot be changed.
        """
    ...
    def product_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @product_type.setter
    def product_type(self, value: pulumi.Input[builtins.str]):
    ...
    def freeform_attributes(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def freeform_attributes(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class _IdentityProviderState:
    def __init__(__self__, *,
                 ...
                 freeform_attributes: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 inactive_state: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_attributes: (Updatable) Extra name value pairs associated with this identity provider. Example: `{"clientId": "app_sf3kdjf3"}`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] inactive_state: The detailed status of INACTIVE lifecycleState.
        :param pulumi.Input[builtins.str] metadata: (Updatable) The XML that contains the information required for federating.
        :param pulumi.Input[builtins.str] metadata_url: (Updatable) The URL for retrieving the identity provider's metadata, which contains information required for federating.
        :param pulumi.Input[builtins.str] name: The name you assign to the `IdentityProvider` during creation. The name must be unique across all `IdentityProvider` objects in the tenancy and cannot be changed.
        :param pulumi.Input[builtins.str] product_type: The identity provider service or product. Supported identity providers are Oracle Identity Cloud Service (IDCS) and Microsoft Active Directory Federation Services (ADFS).  Example: `IDCS`
        :param pulumi.Input[builtins.str] protocol: (Updatable) The protocol used for federation.  Example: `SAML2` 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] redirect_url: The URL to redirect federated users to for authentication with the identity provider.
        :param pulumi.Input[builtins.str] signing_certificate: The identity provider's signing certificate used by the IAM Service to validate the SAML2 token.
        :param pulumi.Input[builtins.str] state: The current state.
        :param pulumi.Input[builtins.str] time_created: Date and time the `IdentityProvider` was created, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
        """
    ...
    def inactive_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def inactive_state(self, value: Optional[pulumi.Input[builtins.str]]):
...
class IdentityProvider(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            signing_certificate: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'IdentityProvider':
        """
    ...
    @property
    @pulumi.getter(name="freeformAttributes")
    def freeform_attributes(self) -> pulumi.Output[Mapping[str, builtins.str]]:
        """
        (Updatable) Extra name value pairs associated with this identity provider. Example: `{"clientId": "app_sf3kdjf3"}`
        """
        return pulumi.get(self, "freeform_attributes")
    ...
    @property
    @pulumi.getter(name="inactiveState")
    def inactive_state(self) -> pulumi.Output[builtins.str]:
        """
        The detailed status of INACTIVE lifecycleState.
        """
        return pulumi.get(self, "inactive_state")
