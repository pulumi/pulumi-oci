...
class IdpGroupMappingArgs:
    ...
    def idp_group_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def idp_group_name(self, value: pulumi.Input[_builtins.str]):
...
class _IdpGroupMappingState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] state: The mapping's current state.
        :param pulumi.Input[_builtins.str] time_created: Date and time the mapping was created, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
        """
...
class IdpGroupMapping(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="idpGroupName")
    def idp_group_name(self) -> pulumi.Output[_builtins.str]:
        """
        (Updatable) The name of the IdP group you want to map.
