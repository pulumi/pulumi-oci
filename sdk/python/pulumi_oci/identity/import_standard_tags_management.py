...
class ImportStandardTagsManagementArgs:
    def __init__(__self__, *,
                 ...
                 standard_tag_namespace_name: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a ImportStandardTagsManagement resource.
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment where the bulk create request is submitted and where the tag namespaces will be created.
        :param pulumi.Input[builtins.str] standard_tag_namespace_name: The name of standard tag namespace that will be imported in bulk 
    ...
    def standard_tag_namespace_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def standard_tag_namespace_name(self, value: pulumi.Input[builtins.str]):
...
class _ImportStandardTagsManagementState:
    ...
    @property
    @pulumi.getter(name="standardTagNamespaceName")
    def standard_tag_namespace_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The name of standard tag namespace that will be imported in bulk 
    ...
    @standard_tag_namespace_name.setter
    def standard_tag_namespace_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "standard_tag_namespace_name", value)
...
class ImportStandardTagsManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            compartment_id: Optional[pulumi.Input[builtins.str]] = None,
            standard_tag_namespace_name: Optional[pulumi.Input[builtins.str]] = None,
            work_request_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ImportStandardTagsManagement':
        """
    ...
    @property
    @pulumi.getter(name="standardTagNamespaceName")
    def standard_tag_namespace_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of standard tag namespace that will be imported in bulk 
