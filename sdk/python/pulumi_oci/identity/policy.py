...
class PolicyArgs:
    def __init__(__self__, *,
                 ...
                 statements: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 version_date: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Policy resource.
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment containing the policy (either the tenancy or another compartment).
        :param pulumi.Input[builtins.str] description: (Updatable) The description you assign to the policy during creation. Does not have to be unique, and it's changeable.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] statements: (Updatable) An array of policy statements written in the policy language. See [How Policies Work](https://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/policies.htm) and [Common Policies](https://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/commonpolicies.htm).
        ...
        :param pulumi.Input[builtins.str] name: The name you assign to the policy during creation. The name must be unique across all policies in the tenancy and cannot be changed.
        :param pulumi.Input[builtins.str] version_date: (Updatable) The version of the policy. If null or set to an empty string, when a request comes in for authorization, the policy will be evaluated according to the current behavior of the services at that moment. If set to a particular date (YYYY-MM-DD), the policy will be evaluated according to the behavior of the services on that date. 
    ...
    @property
    @pulumi.getter
    def statements(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @statements.setter
    def statements(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def version_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The version of the policy. If null or set to an empty string, when a request comes in for authorization, the policy will be evaluated according to the current behavior of the services at that moment. If set to a particular date (YYYY-MM-DD), the policy will be evaluated according to the behavior of the services on that date. 
    ...
    @version_date.setter
    def version_date(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _PolicyState:
    def __init__(__self__, *,
                 ...
                 last_update_e_tag: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 policy_hash: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] name: The name you assign to the policy during creation. The name must be unique across all policies in the tenancy and cannot be changed.
        :param pulumi.Input[builtins.str] state: The policy's current state.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] statements: (Updatable) An array of policy statements written in the policy language. See [How Policies Work](https://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/policies.htm) and [Common Policies](https://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/commonpolicies.htm).
        :param pulumi.Input[builtins.str] time_created: Date and time the policy was created, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] version_date: (Updatable) The version of the policy. If null or set to an empty string, when a request comes in for authorization, the policy will be evaluated according to the current behavior of the services at that moment. If set to a particular date (YYYY-MM-DD), the policy will be evaluated according to the behavior of the services on that date. 
    ...
    def last_update_e_tag(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "last_update_e_tag")

    @last_update_e_tag.setter
    def last_update_e_tag(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def policy_hash(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "policy_hash")

    @policy_hash.setter
    def policy_hash(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Policy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            statements: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            version_date: Optional[pulumi.Input[builtins.str]] = None) -> 'Policy':
        """
    ...
    @pulumi.getter(name="lastUpdateETag")
    @_utilities.deprecated("""The 'lastUpdateETag' field has been deprecated and may be removed in a future version. Do not use this field.""")
    def last_update_e_tag(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "last_update_e_tag")
    ...
    @property
    @pulumi.getter
    def statements(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) An array of policy statements written in the policy language. See [How Policies Work](https://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/policies.htm) and [Common Policies](https://docs.cloud.oracle.com/iaas/Content/Identity/Concepts/commonpolicies.htm).
        """
        return pulumi.get(self, "statements")
    ...
    @property
    @pulumi.getter(name="versionDate")
    def version_date(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The version of the policy. If null or set to an empty string, when a request comes in for authorization, the policy will be evaluated according to the current behavior of the services at that moment. If set to a particular date (YYYY-MM-DD), the policy will be evaluated according to the behavior of the services on that date. 
