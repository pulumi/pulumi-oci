...
class SmtpCredentialArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) The description you assign to the SMTP credentials during creation. Does not have to be unique, and it's changeable.
...
class _SmtpCredentialState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] password: The SMTP password.
        :param pulumi.Input[builtins.str] state: The credential's current state.
        :param pulumi.Input[builtins.str] time_created: Date and time the `SmtpCredential` object was created, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
        ...
        :param pulumi.Input[builtins.str] user_id: The OCID of the user.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] username: The SMTP user name.
        """
...
class SmtpCredential(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_expires: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None,
            username: Optional[pulumi.Input[builtins.str]] = None) -> 'SmtpCredential':
        """
