...
class TagDefaultArgs:
    ...
    def tag_definition_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def tag_definition_id(self, value: pulumi.Input[_builtins.str]):
    ...
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_required: (Updatable) If you specify that a value is required, a value is set during resource creation (either by the user creating the resource or another tag defualt). If no value is set, resource creation is blocked.
               ...
               * If the `isRequired` flag is set to "false", the value you enter is set during resource creation.
               ...
               Example: `false`
        :param pulumi.Input[_builtins.str] state: The tag default's current state. After creating a `TagDefault`, make sure its `lifecycleState` is ACTIVE before using it.
        :param pulumi.Input[_builtins.str] tag_definition_id: The OCID of the tag definition. The tag default will always assign a default value for this tag definition.
...
class TagDefault(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="isRequired")
    def is_required(self) -> pulumi.Output[_builtins.bool]:
        """
        (Updatable) If you specify that a value is required, a value is set during resource creation (either by the user creating the resource or another tag defualt). If no value is set, resource creation is blocked.
        * If the `isRequired` flag is set to "true", the value is set during resource creation.
        * If the `isRequired` flag is set to "false", the value you enter is set during resource creation.
    ...
    @_builtins.property
    @pulumi.getter(name="tagDefinitionId")
    def tag_definition_id(self) -> pulumi.Output[_builtins.str]:
        """
        The OCID of the tag definition. The tag default will always assign a default value for this tag definition.
        """
        return pulumi.get(self, "tag_definition_id")
    ...
    @_builtins.property
    @pulumi.getter(name="tagDefinitionName")
    def tag_definition_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name used in the tag definition. This field is informational in the context of the tag default.
        """
        return pulumi.get(self, "tag_definition_name")
