...
class TagDefaultArgs:
    def __init__(__self__, *,
                 ...
                 tag_definition_id: pulumi.Input[builtins.str],
                 value: pulumi.Input[builtins.str],
                 is_required: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a TagDefault resource.
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment. The tag default will be applied to all new resources created in this compartment.
        :param pulumi.Input[builtins.str] tag_definition_id: The OCID of the tag definition. The tag default will always assign a default value for this tag definition.
        :param pulumi.Input[builtins.str] value: (Updatable) The default value for the tag definition. This will be applied to all new resources created in the compartment. 
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.bool] is_required: (Updatable) If you specify that a value is required, a value is set during resource creation (either by the user creating the resource or another tag defualt). If no value is set, resource creation is blocked.
    ...
    def tag_definition_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def tag_definition_id(self, value: pulumi.Input[builtins.str]):
...
class _TagDefaultState:
    def __init__(__self__, *,
                 ...
                 tag_definition_id: Optional[pulumi.Input[builtins.str]] = None,
                 tag_definition_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.bool] is_required: (Updatable) If you specify that a value is required, a value is set during resource creation (either by the user creating the resource or another tag defualt). If no value is set, resource creation is blocked.
               ...
               * If the `isRequired` flag is set to "false", the value you enter is set during resource creation.
               ...
               Example: `false`
        :param pulumi.Input[builtins.str] state: The tag default's current state. After creating a `TagDefault`, make sure its `lifecycleState` is ACTIVE before using it.
        :param pulumi.Input[builtins.str] tag_definition_id: The OCID of the tag definition. The tag default will always assign a default value for this tag definition.
        :param pulumi.Input[builtins.str] tag_definition_name: The name used in the tag definition. This field is informational in the context of the tag default.
        :param pulumi.Input[builtins.str] tag_namespace_id: The OCID of the tag namespace that contains the tag definition.
        :param pulumi.Input[builtins.str] time_created: Date and time the `TagDefault` object was created, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] value: (Updatable) The default value for the tag definition. This will be applied to all new resources created in the compartment. 
    ...
    @property
    @pulumi.getter(name="tagDefinitionId")
    def tag_definition_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The OCID of the tag definition. The tag default will always assign a default value for this tag definition.
        """
        return pulumi.get(self, "tag_definition_id")
    ...
    @tag_definition_id.setter
    def tag_definition_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "tag_definition_id", value)

    @property
    @pulumi.getter(name="tagDefinitionName")
    def tag_definition_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def tag_definition_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class TagDefault(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tag_namespace_id: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'TagDefault':
        """
    ...
    @property
    @pulumi.getter(name="isRequired")
    def is_required(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) If you specify that a value is required, a value is set during resource creation (either by the user creating the resource or another tag defualt). If no value is set, resource creation is blocked.
        * If the `isRequired` flag is set to "true", the value is set during resource creation.
        * If the `isRequired` flag is set to "false", the value you enter is set during resource creation.
    ...
    @property
    @pulumi.getter(name="tagDefinitionId")
    def tag_definition_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the tag definition. The tag default will always assign a default value for this tag definition.
        """
        return pulumi.get(self, "tag_definition_id")
    ...
    @property
    @pulumi.getter(name="tagDefinitionName")
    def tag_definition_name(self) -> pulumi.Output[builtins.str]:
        """
        The name used in the tag definition. This field is informational in the context of the tag default.
        """
        return pulumi.get(self, "tag_definition_name")
