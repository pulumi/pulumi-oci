...
class _UiPasswordState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] password: The user's password for the Console.
        :param pulumi.Input[builtins.str] state: The password's current state.
        :param pulumi.Input[builtins.str] time_created: Date and time the password was created, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] user_id: The OCID of the user.
...
class UiPassword(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'UiPassword':
        """
