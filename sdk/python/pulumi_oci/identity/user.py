...
class UserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] email: (Updatable) The email you assign to the user. Has to be unique across the tenancy.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[_builtins.str] name: The name you assign to the user during creation. This is the user's login for the Console. The name must be unique across all users in the tenancy and cannot be changed. 
...
class _UserState:
    def __init__(__self__, *,
                 capabilities: pulumi.Input[Optional[Sequence[pulumi.Input['UserCapabilityArgs']]]] = None,
                 compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 last_successful_login_time: pulumi.Input[Optional[_builtins.str]] = None,
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 previous_successful_login_time: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] description: (Updatable) The description you assign to the user during creation. Does not have to be unique, and it's changeable.
        :param pulumi.Input[_builtins.str] email: (Updatable) The email you assign to the user. Has to be unique across the tenancy.
        :param pulumi.Input[_builtins.bool] email_verified: Whether the email address has been validated.
        :param pulumi.Input[_builtins.str] external_identifier: Identifier of the user in the identity provider
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[_builtins.str] identity_provider_id: The OCID of the `IdentityProvider` this user belongs to.
        :param pulumi.Input[_builtins.str] inactive_state: Returned only if the user's `lifecycleState` is INACTIVE. A 16-bit value showing the reason why the user is inactive:
               * bit 0: SUSPENDED (reserved for future use)
               * bit 1: DISABLED (reserved for future use)
               * bit 2: BLOCKED (the user has exceeded the maximum number of failed login attempts for the Console)
        :param pulumi.Input[_builtins.str] last_successful_login_time: The date and time of when the user most recently logged in the format defined by RFC3339 (ex. `2016-08-25T21:10:29.600Z`). If there is no login history, this field is null.
        :param pulumi.Input[_builtins.str] name: The name you assign to the user during creation. This is the user's login for the Console. The name must be unique across all users in the tenancy and cannot be changed. 
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] previous_successful_login_time: The date and time of when the user most recently logged in the format defined by RFC3339 (ex. `2016-08-25T21:10:29.600Z`). If there is no login history, this field is null.
        :param pulumi.Input[_builtins.str] state: The user's current state.
        :param pulumi.Input[_builtins.str] time_created: Date and time the user was created, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
        """
    ...
    @_builtins.property
    @pulumi.getter
    def capabilities(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['UserCapabilityArgs']]]]:
        """
    ...
    @capabilities.setter
    def capabilities(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['UserCapabilityArgs']]]]):
    ...
    def last_successful_login_time(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def last_successful_login_time(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def previous_successful_login_time(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The date and time of when the user most recently logged in the format defined by RFC3339 (ex. `2016-08-25T21:10:29.600Z`). If there is no login history, this field is null.
        """
    ...
    def previous_successful_login_time(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class User(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            previous_successful_login_time: pulumi.Input[Optional[_builtins.str]] = None,
            state: pulumi.Input[Optional[_builtins.str]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None) -> 'User':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="identityProviderId")
    def identity_provider_id(self) -> pulumi.Output[_builtins.str]:
        """
        The OCID of the `IdentityProvider` this user belongs to.
        """
        return pulumi.get(self, "identity_provider_id")
    ...
    @_builtins.property
    @pulumi.getter(name="lastSuccessfulLoginTime")
    def last_successful_login_time(self) -> pulumi.Output[_builtins.str]:
        """
        The date and time of when the user most recently logged in the format defined by RFC3339 (ex. `2016-08-25T21:10:29.600Z`). If there is no login history, this field is null.
        """
        return pulumi.get(self, "last_successful_login_time")
    ...
    @_builtins.property
    @pulumi.getter(name="previousSuccessfulLoginTime")
    def previous_successful_login_time(self) -> pulumi.Output[_builtins.str]:
        """
        The date and time of when the user most recently logged in the format defined by RFC3339 (ex. `2016-08-25T21:10:29.600Z`). If there is no login history, this field is null.
        """
        return pulumi.get(self, "previous_successful_login_time")
