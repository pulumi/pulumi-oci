...
class UserGroupMembershipArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] group_id: The OCID of the group.
        :param pulumi.Input[builtins.str] user_id: The OCID of the user.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the tenancy containing the user, group, and membership object.
        """
...
class _UserGroupMembershipState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] state: The membership's current state.
        :param pulumi.Input[builtins.str] time_created: Date and time the membership was created, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] user_id: The OCID of the user.
