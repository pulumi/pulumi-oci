...
class GeneratedScopedAccessTokenArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] public_key: A temporary public key, owned by the service. The service also owns the corresponding private key. This public key will by put inside the security token by the auth service after successful validation of the certificate.
        :param pulumi.Input[builtins.str] scope: Scope definition for the scoped access token 
...
class _GeneratedScopedAccessTokenState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] scope: Scope definition for the scoped access token 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] token: The security token, signed by auth service
        """
...
class GeneratedScopedAccessToken(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            public_key: Optional[pulumi.Input[builtins.str]] = None,
            scope: Optional[pulumi.Input[builtins.str]] = None,
            token: Optional[pulumi.Input[builtins.str]] = None) -> 'GeneratedScopedAccessToken':
        """
