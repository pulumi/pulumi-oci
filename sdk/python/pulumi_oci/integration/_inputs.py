...
if not MYPY:
    class IntegrationInstanceAlternateCustomEndpointArgsDict(TypedDict):
        ...
        """
        certificate_secret_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        certificate_secret_version: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        Type of DNS.
        """
        dns_zone_name: NotRequired[pulumi.Input[builtins.str]]
        """
        DNS Zone name
        """
        managed_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class IntegrationInstanceAlternateCustomEndpointArgs:
    def __init__(__self__, *,
                 ...
                 certificate_secret_id: Optional[pulumi.Input[builtins.str]] = None,
                 certificate_secret_version: Optional[pulumi.Input[builtins.int]] = None,
                 dns_type: Optional[pulumi.Input[builtins.str]] = None,
                 dns_zone_name: Optional[pulumi.Input[builtins.str]] = None,
                 managed_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] hostname: (Updatable) A custom hostname to be used for the integration instance URL, in FQDN format.
        :param pulumi.Input[builtins.str] alias: When creating the DNS CNAME record for the custom hostname, this value must be specified in the rdata.
        :param pulumi.Input[builtins.str] certificate_secret_id: (Updatable) Optional OCID of a vault/secret containing a private SSL certificate bundle to be used for the custom hostname. All certificates should be stored in a single base64 encoded secret Note the update will fail if this is not a valid certificate.
        :param pulumi.Input[builtins.int] certificate_secret_version: The secret version used for the certificate-secret-id (if certificate-secret-id is specified).
        :param pulumi.Input[builtins.str] dns_type: Type of DNS.
        :param pulumi.Input[builtins.str] dns_zone_name: DNS Zone name
        :param pulumi.Input[builtins.str] managed_type: Indicates if custom endpoint is managed by oracle or customer.
        """
    ...
    def certificate_secret_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Optional OCID of a vault/secret containing a private SSL certificate bundle to be used for the custom hostname. All certificates should be stored in a single base64 encoded secret Note the update will fail if this is not a valid certificate.
        """
    ...
    def certificate_secret_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "certificate_secret_id", value)

    @property
    @pulumi.getter(name="certificateSecretVersion")
    def certificate_secret_version(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The secret version used for the certificate-secret-id (if certificate-secret-id is specified).
        """
    ...
    def certificate_secret_version(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def dns_zone_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        DNS Zone name
        """
    ...
    def dns_zone_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "dns_zone_name", value)

    @property
    @pulumi.getter(name="managedType")
    def managed_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Indicates if custom endpoint is managed by oracle or customer.
        """
    ...
    @managed_type.setter
    def managed_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "managed_type", value)


if not MYPY:
    class IntegrationInstanceAttachmentArgsDict(TypedDict):
        is_implicit: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        * If role == `CHILD`, this instance was created from attached instance on behalf of a user
        ...
        """
        target_instance_url: NotRequired[pulumi.Input[builtins.str]]
        """
        The dataplane instance URL of the attached instance
        """
        target_role: NotRequired[pulumi.Input[builtins.str]]
        """
        The role of the target attachment.
        * `PARENT` - The target instance is the parent of this attachment.
        * `CHILD` - The target instance is the child of this attachment.
        """
        target_service_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class IntegrationInstanceAttachmentArgs:
    def __init__(__self__, *,
                 is_implicit: Optional[pulumi.Input[builtins.bool]] = None,
                 target_id: Optional[pulumi.Input[builtins.str]] = None,
                 target_instance_url: Optional[pulumi.Input[builtins.str]] = None,
                 target_role: Optional[pulumi.Input[builtins.str]] = None,
                 target_service_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.bool] is_implicit: * If role == `PARENT`, the attached instance was created by this service instance
               * If role == `CHILD`, this instance was created from attached instance on behalf of a user
        :param pulumi.Input[builtins.str] target_id: The OCID of the target instance (which could be any other Oracle Cloud Infrastructure PaaS/SaaS resource), to which this instance is attached.
        :param pulumi.Input[builtins.str] target_instance_url: The dataplane instance URL of the attached instance
        :param pulumi.Input[builtins.str] target_role: The role of the target attachment.
               * `PARENT` - The target instance is the parent of this attachment.
               * `CHILD` - The target instance is the child of this attachment.
        :param pulumi.Input[builtins.str] target_service_type: The type of the target instance, such as "FUSION".
        """
    ...
    def is_implicit(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        * If role == `PARENT`, the attached instance was created by this service instance
        * If role == `CHILD`, this instance was created from attached instance on behalf of a user
        """
    ...
    @is_implicit.setter
    def is_implicit(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def target_instance_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The dataplane instance URL of the attached instance
        """
    ...
    def target_instance_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_instance_url", value)

    @property
    @pulumi.getter(name="targetRole")
    def target_role(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The role of the target attachment.
        * `PARENT` - The target instance is the parent of this attachment.
        * `CHILD` - The target instance is the child of this attachment.
    ...
    @target_role.setter
    def target_role(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_role", value)

    @property
    @pulumi.getter(name="targetServiceType")
    def target_service_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of the target instance, such as "FUSION".
        """
    ...
    def target_service_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "target_service_type", value)


if not MYPY:
    class IntegrationInstanceCustomEndpointArgsDict(TypedDict):
        dns_zone_name: pulumi.Input[builtins.str]
        """
        DNS Zone name
        """
        hostname: pulumi.Input[builtins.str]
...
class IntegrationInstanceCustomEndpointArgs:
    ...
    @property
    @pulumi.getter(name="dnsZoneName")
    def dns_zone_name(self) -> pulumi.Input[builtins.str]:
        """
        DNS Zone name
        """
        return pulumi.get(self, "dns_zone_name")
    ...
    @dns_zone_name.setter
    def dns_zone_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "dns_zone_name", value)
...
if not MYPY:
    class IntegrationInstanceDisasterRecoveryDetailArgsDict(TypedDict):
        ...
        """
        regional_instance_url: NotRequired[pulumi.Input[builtins.str]]
        """
...
class IntegrationInstanceDisasterRecoveryDetailArgs:
    def __init__(__self__, *,
                 ...
                 regional_instance_url: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] regional_instance_url: Region specific instance url for the integration instance in the region
        :param pulumi.Input[builtins.str] role: Role of the integration instance in the region
        """
    ...
    def regional_instance_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Region specific instance url for the integration instance in the region
        """
    ...
    def regional_instance_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class IntegrationInstanceDisasterRecoveryDetailCrossRegionIntegrationInstanceDetailArgsDict(TypedDict):
        ...
        Role of the integration instance in the region
        """
        time_role_changed: NotRequired[pulumi.Input[builtins.str]]
        """
...
class IntegrationInstanceDisasterRecoveryDetailCrossRegionIntegrationInstanceDetailArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: The Virtual Cloud Network OCID.
        :param pulumi.Input[builtins.str] region: Cross region where integration instance is created
        :param pulumi.Input[builtins.str] role: Role of the integration instance in the region
        :param pulumi.Input[builtins.str] time_role_changed: Time when cross region integration instance role was changed
        """
        if id is not None:
...
if not MYPY:
    class IntegrationInstanceIdcsInfoArgsDict(TypedDict):
        idcs_app_display_name: NotRequired[pulumi.Input[builtins.str]]
        """
        The IDCS application display name associated with the instance
        """
        idcs_app_id: NotRequired[pulumi.Input[builtins.str]]
        """
        The IDCS application ID associated with the instance
        """
        idcs_app_location_url: NotRequired[pulumi.Input[builtins.str]]
        """
        URL for the location of the IDCS Application (used by IDCS APIs)
        """
        idcs_app_name: NotRequired[pulumi.Input[builtins.str]]
        """
        The IDCS application name associated with the instance
        """
        instance_primary_audience_url: NotRequired[pulumi.Input[builtins.str]]
        """
...
class IntegrationInstanceIdcsInfoArgs:
    def __init__(__self__, *,
                 idcs_app_display_name: Optional[pulumi.Input[builtins.str]] = None,
                 idcs_app_id: Optional[pulumi.Input[builtins.str]] = None,
                 idcs_app_location_url: Optional[pulumi.Input[builtins.str]] = None,
                 idcs_app_name: Optional[pulumi.Input[builtins.str]] = None,
                 instance_primary_audience_url: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] idcs_app_display_name: The IDCS application display name associated with the instance
        :param pulumi.Input[builtins.str] idcs_app_id: The IDCS application ID associated with the instance
        :param pulumi.Input[builtins.str] idcs_app_location_url: URL for the location of the IDCS Application (used by IDCS APIs)
        :param pulumi.Input[builtins.str] idcs_app_name: The IDCS application name associated with the instance
        :param pulumi.Input[builtins.str] instance_primary_audience_url: The URL used as the primary audience for integration flows in this instance type: string
        """
    ...
    def idcs_app_display_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IDCS application display name associated with the instance
        """
    ...
    def idcs_app_display_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "idcs_app_display_name", value)

    @property
    @pulumi.getter(name="idcsAppId")
    def idcs_app_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IDCS application ID associated with the instance
        """
    ...
    @idcs_app_id.setter
    def idcs_app_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "idcs_app_id", value)

    @property
    @pulumi.getter(name="idcsAppLocationUrl")
    def idcs_app_location_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        URL for the location of the IDCS Application (used by IDCS APIs)
        """
    ...
    def idcs_app_location_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "idcs_app_location_url", value)

    @property
    @pulumi.getter(name="idcsAppName")
    def idcs_app_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The IDCS application name associated with the instance
        """
    ...
    def idcs_app_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "idcs_app_name", value)

    @property
    @pulumi.getter(name="instancePrimaryAudienceUrl")
    def instance_primary_audience_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The URL used as the primary audience for integration flows in this instance type: string
        """
    ...
    def instance_primary_audience_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class IntegrationInstanceNetworkEndpointDetailsArgsDict(TypedDict):
        ...
        """
        is_integration_vcn_allowlisted: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class IntegrationInstanceNetworkEndpointDetailsArgs:
    def __init__(__self__, *,
                 ...
                 is_integration_vcn_allowlisted: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] network_endpoint_type: The type of network endpoint.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowlisted_http_ips: Source IP addresses or IP address ranges ingress rules. (ex: "168.122.59.5", "10.20.30.0/26") An invalid IP or CIDR block will result in a 400 response.
        ...
        :param pulumi.Input[builtins.bool] is_integration_vcn_allowlisted: The Integration service's VCN is allow-listed to allow integrations to call back into other integrations
        """
    ...
    def network_endpoint_type(self, value: pulumi.Input[builtins.str]):
    ...
    def is_integration_vcn_allowlisted(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        The Integration service's VCN is allow-listed to allow integrations to call back into other integrations
        """
    ...
    def is_integration_vcn_allowlisted(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class IntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArgsDict(TypedDict):
        ...
        The Virtual Cloud Network OCID.
        """
        allowlisted_ips: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        Source IP addresses or IP address ranges ingress rules. (ex: "168.122.59.5", "10.20.30.0/26") An invalid IP or CIDR block will result in a 400 response.
        """
elif False:
...
class IntegrationInstanceNetworkEndpointDetailsAllowlistedHttpVcnArgs:
    def __init__(__self__, *,
                 id: pulumi.Input[builtins.str],
                 allowlisted_ips: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[builtins.str] id: The Virtual Cloud Network OCID.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowlisted_ips: Source IP addresses or IP address ranges ingress rules. (ex: "168.122.59.5", "10.20.30.0/26") An invalid IP or CIDR block will result in a 400 response.
        """
        pulumi.set(__self__, "id", id)
    ...
    def allowlisted_ips(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        Source IP addresses or IP address ranges ingress rules. (ex: "168.122.59.5", "10.20.30.0/26") An invalid IP or CIDR block will result in a 400 response.
        """
    ...
    def allowlisted_ips(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class IntegrationInstancePrivateEndpointOutboundConnectionArgsDict(TypedDict):
        ...
        """
        outbound_connection_type: NotRequired[pulumi.Input[builtins.str]]
        """
...
class IntegrationInstancePrivateEndpointOutboundConnectionArgs:
    def __init__(__self__, *,
                 ...
                 outbound_connection_type: Optional[pulumi.Input[builtins.str]] = None,
                 subnet_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] nsg_ids: One or more Network security group Ids. This is an optional argument.
        :param pulumi.Input[builtins.str] outbound_connection_type: The type of Outbound Connection.
        :param pulumi.Input[builtins.str] subnet_id: Customer Private Network VCN Subnet OCID. This is a required argument.
        """
    ...
    def outbound_connection_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The type of Outbound Connection.
        """
    ...
    def outbound_connection_type(self, value: Optional[pulumi.Input[builtins.str]]):
