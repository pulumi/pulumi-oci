...
class GetIntegrationInstanceResult:
    ...
    def integration_instance_id(self) -> builtins.str:
...
def get_integration_instance(integration_instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str integration_instance_id: Unique Integration Instance identifier.
    """
    __args__ = dict()
...
def get_integration_instance_output(integration_instance_id: Optional[pulumi.Input[builtins.str]] = None,
