...
def get_integration_instances(compartment_id: Optional[builtins.str] = None,
...
def get_integration_instances_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
