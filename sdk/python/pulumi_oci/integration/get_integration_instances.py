...
def get_integration_instances(compartment_id: Optional[str] = None,
    ...
    test_integration_instances = oci.Integration.get_integration_instances(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
