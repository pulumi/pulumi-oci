...
class OracleManagedCustomEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            integration_instance_id: Optional[pulumi.Input[builtins.str]] = None,
            managed_type: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None) -> 'OracleManagedCustomEndpoint':
        """
    ...
    @property
    @pulumi.getter(name="dnsType")
    def dns_type(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "dns_type")

    @property
    @pulumi.getter(name="dnsZoneName")
    def dns_zone_name(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "dns_zone_name")
    ...
    @property
    @pulumi.getter(name="managedType")
    def managed_type(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "managed_type")
