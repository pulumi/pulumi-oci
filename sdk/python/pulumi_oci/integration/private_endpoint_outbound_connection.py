...
class PrivateEndpointOutboundConnectionArgs:
    ...
    def integration_instance_id(self) -> pulumi.Input[_builtins.str]:
        return pulumi.get(self, "integration_instance_id")

    @integration_instance_id.setter
    def integration_instance_id(self, value: pulumi.Input[_builtins.str]):
...
class PrivateEndpointOutboundConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            nsg_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            state: Optional[pulumi.Input[_builtins.str]] = None,
            subnet_id: Optional[pulumi.Input[_builtins.str]] = None) -> 'PrivateEndpointOutboundConnection':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="integrationInstanceId")
    def integration_instance_id(self) -> pulumi.Output[_builtins.str]:
        return pulumi.get(self, "integration_instance_id")
