...
class PrivateEndpointOutboundConnectionArgs:
    def __init__(__self__, *,
                 integration_instance_id: pulumi.Input[builtins.str],
    ...
    def integration_instance_id(self) -> pulumi.Input[builtins.str]:
        return pulumi.get(self, "integration_instance_id")

    @integration_instance_id.setter
    def integration_instance_id(self, value: pulumi.Input[builtins.str]):
...
class _PrivateEndpointOutboundConnectionState:
    def __init__(__self__, *,
                 integration_instance_id: Optional[pulumi.Input[builtins.str]] = None,
                 nsg_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="integrationInstanceId")
    def integration_instance_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "integration_instance_id")

    @integration_instance_id.setter
    def integration_instance_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "integration_instance_id", value)
...
class PrivateEndpointOutboundConnection(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            nsg_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            subnet_id: Optional[pulumi.Input[builtins.str]] = None) -> 'PrivateEndpointOutboundConnection':
        """
    ...
    @property
    @pulumi.getter(name="integrationInstanceId")
    def integration_instance_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "integration_instance_id")
