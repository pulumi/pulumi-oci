...
class FleetAdvancedFeatureConfigurationAdvancedUsageTrackingArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) AdvancedUsageTracking flag to store enabled or disabled status.
        """
...
class FleetAdvancedFeatureConfigurationCryptoEventAnalysisArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) CryptoEventAnalysis flag to store enabled or disabled status.
...
class FleetAdvancedFeatureConfigurationJavaMigrationAnalysisArgs:
    def __init__(__self__, *,
                 is_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) JavaMigrationAnalysis flag to store enabled or disabled status.
        """
        if is_enabled is not None:
            pulumi.set(__self__, "is_enabled", is_enabled)
...
class FleetAdvancedFeatureConfigurationJfrRecordingArgs:
    def __init__(__self__, *,
                 is_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) JfrRecording flag to store enabled or disabled status.
        """
        if is_enabled is not None:
            pulumi.set(__self__, "is_enabled", is_enabled)
...
class FleetAdvancedFeatureConfigurationLcmArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) Lifecycle management flag to store enabled or disabled status.
...
if not MYPY:
    class FleetAdvancedFeatureConfigurationLcmPostInstallationActionsArgsDict(TypedDict):
        add_logging_handler: NotRequired[pulumi.Input[builtins.bool]]
        """
        (Updatable) Sets FileHandler and ConsoleHandler as handlers in logging.properties file.
        """
        disabled_tls_versions: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        (Updatable) The following post JRE installation actions are supported by the field:
        * Disable TLS 1.0 , TLS 1.1
        """
        global_logging_level: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        should_replace_certificates_operating_system: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class FleetAdvancedFeatureConfigurationLcmPostInstallationActionsArgs:
    def __init__(__self__, *,
                 add_logging_handler: Optional[pulumi.Input[builtins.bool]] = None,
                 disabled_tls_versions: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 global_logging_level: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 should_replace_certificates_operating_system: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] add_logging_handler: (Updatable) Sets FileHandler and ConsoleHandler as handlers in logging.properties file.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] disabled_tls_versions: (Updatable) The following post JRE installation actions are supported by the field:
               * Disable TLS 1.0 , TLS 1.1
        :param pulumi.Input[builtins.str] global_logging_level: (Updatable) Sets the logging level in logging.properties file.
        ...
        :param pulumi.Input[builtins.bool] should_replace_certificates_operating_system: (Updatable) Restores JDK root certificates with the certificates that are available in the operating system. The following action is supported by the field:
               * Replace JDK root certificates with a list provided by the operating system.
        """
    ...
    def add_logging_handler(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) Sets FileHandler and ConsoleHandler as handlers in logging.properties file.
        """
    ...
    def add_logging_handler(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "add_logging_handler", value)

    @property
    @pulumi.getter(name="disabledTlsVersions")
    def disabled_tls_versions(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        (Updatable) The following post JRE installation actions are supported by the field:
        * Disable TLS 1.0 , TLS 1.1
        """
    ...
    def disabled_tls_versions(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "disabled_tls_versions", value)

    @property
    @pulumi.getter(name="globalLoggingLevel")
    def global_logging_level(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Sets the logging level in logging.properties file.
        """
    ...
    def global_logging_level(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def should_replace_certificates_operating_system(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) Restores JDK root certificates with the certificates that are available in the operating system. The following action is supported by the field:
        * Replace JDK root certificates with a list provided by the operating system.
        """
    ...
    def should_replace_certificates_operating_system(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class FleetAdvancedFeatureConfigurationLcmPostInstallationActionsMinimumKeySizeSettingsCertpathArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.int] key_size: (Updatable) Key size for the encryption algorithm. Allowed values: 256 for EC, 2048 for DH/DSA/RSA
        :param pulumi.Input[builtins.str] name: (Updatable) The algorithm name.
        """
...
if not MYPY:
    class FleetAdvancedFeatureConfigurationLcmPostInstallationActionsProxiesArgsDict(TypedDict):
        ftp_proxy_host: NotRequired[pulumi.Input[builtins.str]]
        """
        (Updatable) Ftp host to be set in net.properties file.
        """
        ftp_proxy_port: NotRequired[pulumi.Input[builtins.int]]
        """
        (Updatable) Ftp port number to be set in net.properties file.
        """
        http_proxy_host: NotRequired[pulumi.Input[builtins.str]]
        """
        (Updatable) Http host to be set in net.properties file.
        """
        http_proxy_port: NotRequired[pulumi.Input[builtins.int]]
        """
        (Updatable) Http port number to be set in net.properties file.
        """
        https_proxy_host: NotRequired[pulumi.Input[builtins.str]]
        """
        (Updatable) Https host to be set in net.properties file.
        """
        https_proxy_port: NotRequired[pulumi.Input[builtins.int]]
        """
        (Updatable) Https port number to be set in net.properties file.
        """
        socks_proxy_host: NotRequired[pulumi.Input[builtins.str]]
        """
        (Updatable) Socks host to be set in net.properties file.
        """
        socks_proxy_port: NotRequired[pulumi.Input[builtins.int]]
        """
        (Updatable) Socks port number to be set in net.properties file.
        """
        use_system_proxies: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class FleetAdvancedFeatureConfigurationLcmPostInstallationActionsProxiesArgs:
    def __init__(__self__, *,
                 ftp_proxy_host: Optional[pulumi.Input[builtins.str]] = None,
                 ftp_proxy_port: Optional[pulumi.Input[builtins.int]] = None,
                 http_proxy_host: Optional[pulumi.Input[builtins.str]] = None,
                 http_proxy_port: Optional[pulumi.Input[builtins.int]] = None,
                 https_proxy_host: Optional[pulumi.Input[builtins.str]] = None,
                 https_proxy_port: Optional[pulumi.Input[builtins.int]] = None,
                 socks_proxy_host: Optional[pulumi.Input[builtins.str]] = None,
                 socks_proxy_port: Optional[pulumi.Input[builtins.int]] = None,
                 use_system_proxies: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] ftp_proxy_host: (Updatable) Ftp host to be set in net.properties file.
        :param pulumi.Input[builtins.int] ftp_proxy_port: (Updatable) Ftp port number to be set in net.properties file.
        :param pulumi.Input[builtins.str] http_proxy_host: (Updatable) Http host to be set in net.properties file.
        :param pulumi.Input[builtins.int] http_proxy_port: (Updatable) Http port number to be set in net.properties file.
        :param pulumi.Input[builtins.str] https_proxy_host: (Updatable) Https host to be set in net.properties file.
        :param pulumi.Input[builtins.int] https_proxy_port: (Updatable) Https port number to be set in net.properties file.
        :param pulumi.Input[builtins.str] socks_proxy_host: (Updatable) Socks host to be set in net.properties file.
        :param pulumi.Input[builtins.int] socks_proxy_port: (Updatable) Socks port number to be set in net.properties file.
        :param pulumi.Input[builtins.bool] use_system_proxies: (Updatable) Sets "java.net.useSystemProxies=true" in net.properties when they exist.
        """
    ...
    def ftp_proxy_host(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Ftp host to be set in net.properties file.
        """
    ...
    def ftp_proxy_host(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ftp_proxy_host", value)

    @property
    @pulumi.getter(name="ftpProxyPort")
    def ftp_proxy_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) Ftp port number to be set in net.properties file.
        """
    ...
    def ftp_proxy_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "ftp_proxy_port", value)

    @property
    @pulumi.getter(name="httpProxyHost")
    def http_proxy_host(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Http host to be set in net.properties file.
        """
    ...
    def http_proxy_host(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "http_proxy_host", value)

    @property
    @pulumi.getter(name="httpProxyPort")
    def http_proxy_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) Http port number to be set in net.properties file.
        """
    ...
    def http_proxy_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "http_proxy_port", value)

    @property
    @pulumi.getter(name="httpsProxyHost")
    def https_proxy_host(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Https host to be set in net.properties file.
        """
    ...
    def https_proxy_host(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "https_proxy_host", value)

    @property
    @pulumi.getter(name="httpsProxyPort")
    def https_proxy_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) Https port number to be set in net.properties file.
        """
    ...
    def https_proxy_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "https_proxy_port", value)

    @property
    @pulumi.getter(name="socksProxyHost")
    def socks_proxy_host(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Socks host to be set in net.properties file.
        """
    ...
    def socks_proxy_host(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "socks_proxy_host", value)

    @property
    @pulumi.getter(name="socksProxyPort")
    def socks_proxy_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) Socks port number to be set in net.properties file.
        """
    ...
    def socks_proxy_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "socks_proxy_port", value)

    @property
    @pulumi.getter(name="useSystemProxies")
    def use_system_proxies(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) Sets "java.net.useSystemProxies=true" in net.properties when they exist.
        """
    ...
    def use_system_proxies(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class FleetAdvancedFeatureConfigurationPerformanceTuningAnalysisArgs:
    def __init__(__self__, *,
                 is_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) PerformanceTuningAnalysis flag to store enabled or disabled status
...
class JavaDownloadsJavaDownloadReportCreatedByArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] email: The email of the principal.
        :param pulumi.Input[builtins.str] id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Java download report.
        """
...
class JavaDownloadsJavaDownloadTokenCreatedByArgs:
    def __init__(__self__, *,
                 ...
                 id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] display_name: (Updatable) User provided display name of the JavaDownloadToken.
        :param pulumi.Input[builtins.str] email: The email of the principal.
        :param pulumi.Input[builtins.str] id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the principal.
        """
        if display_name is not None:
            pulumi.set(__self__, "display_name", display_name)
        if email is not None:
...
class JavaDownloadsJavaLicenseAcceptanceRecordCreatedByArgs:
    def __init__(__self__, *,
                 ...
                 id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] display_name: The name of the principal.
        :param pulumi.Input[builtins.str] email: The email of the principal.
        :param pulumi.Input[builtins.str] id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the principal.
        """
        if display_name is not None:
