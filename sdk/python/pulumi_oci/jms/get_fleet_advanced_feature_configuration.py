...
class GetFleetAdvancedFeatureConfigurationResult:
    ...
    def analytic_bucket_name(self) -> _builtins.str:
        """
    ...
    def analytic_namespace(self) -> _builtins.str:
        """
...
def get_fleet_advanced_feature_configuration(fleet_id: Optional[_builtins.str] = None,
