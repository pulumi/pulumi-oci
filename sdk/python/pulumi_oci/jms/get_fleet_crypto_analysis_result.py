...
class GetFleetCryptoAnalysisResultResult:
    ...
    def crypto_analysis_result_id(self) -> _builtins.str:
...
def get_fleet_crypto_analysis_result(crypto_analysis_result_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str crypto_analysis_result_id: The OCID of the analysis result.
