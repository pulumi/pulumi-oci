...
class GetFleetCryptoAnalysisResultResult:
    ...
    def crypto_analysis_result_id(self) -> builtins.str:
...
def get_fleet_crypto_analysis_result(crypto_analysis_result_id: Optional[builtins.str] = None,
    ...
    :param builtins.str crypto_analysis_result_id: The OCID of the analysis result.
...
def get_fleet_crypto_analysis_result_output(crypto_analysis_result_id: Optional[pulumi.Input[builtins.str]] = None,
