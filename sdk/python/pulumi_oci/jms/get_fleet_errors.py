...
def get_fleet_errors(compartment_id: Optional[builtins.str] = None,
                     ...
                     time_first_seen_greater_than_or_equal_to: Optional[builtins.str] = None,
                     time_first_seen_less_than_or_equal_to: Optional[builtins.str] = None,
                     time_last_seen_greater_than_or_equal_to: Optional[builtins.str] = None,
                     time_last_seen_less_than_or_equal_to: Optional[builtins.str] = None,
    ...
    :param builtins.str time_first_seen_greater_than_or_equal_to: If specified, only errors with a first seen time later than this parameter will be included in the search (formatted according to RFC3339).
    :param builtins.str time_first_seen_less_than_or_equal_to: If specified, only errors with a first seen time earlier than this parameter will be included in the search (formatted according to RFC3339).
    :param builtins.str time_last_seen_greater_than_or_equal_to: If specified, only errors with a last seen time later than this parameter will be included in the search (formatted according to RFC3339).
    :param builtins.str time_last_seen_less_than_or_equal_to: If specified, only errors with a last seen time earlier than this parameter will be included in the search (formatted according to RFC3339).
    """
    __args__ = dict()
...
def get_fleet_errors_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            ...
                            time_first_seen_greater_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            time_first_seen_less_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            time_last_seen_greater_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            time_last_seen_less_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
