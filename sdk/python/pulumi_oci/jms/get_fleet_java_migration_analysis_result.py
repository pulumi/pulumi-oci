...
class GetFleetJavaMigrationAnalysisResultResult:
    ...
    def java_migration_analysis_result_id(self) -> _builtins.str:
...
def get_fleet_java_migration_analysis_result(fleet_id: Optional[_builtins.str] = None,
                                             java_migration_analysis_result_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str java_migration_analysis_result_id: The OCID of the analysis result.
    """
    __args__ = dict()
