...
class GetFleetJavaMigrationAnalysisResultResult:
    ...
    def java_migration_analysis_result_id(self) -> builtins.str:
...
def get_fleet_java_migration_analysis_result(fleet_id: Optional[builtins.str] = None,
                                             java_migration_analysis_result_id: Optional[builtins.str] = None,
    ...
    :param builtins.str java_migration_analysis_result_id: The OCID of the analysis result.
    """
    __args__ = dict()
...
def get_fleet_java_migration_analysis_result_output(fleet_id: Optional[pulumi.Input[builtins.str]] = None,
                                                    java_migration_analysis_result_id: Optional[pulumi.Input[builtins.str]] = None,
