...
class GetFleetPerformanceTuningAnalysisResultResult:
    ...
    def performance_tuning_analysis_result_id(self) -> builtins.str:
...
def get_fleet_performance_tuning_analysis_result(fleet_id: Optional[builtins.str] = None,
                                                 performance_tuning_analysis_result_id: Optional[builtins.str] = None,
    ...
    :param builtins.str performance_tuning_analysis_result_id: The OCID of the performance tuning analysis result.
    """
    __args__ = dict()
...
def get_fleet_performance_tuning_analysis_result_output(fleet_id: Optional[pulumi.Input[builtins.str]] = None,
                                                        performance_tuning_analysis_result_id: Optional[pulumi.Input[builtins.str]] = None,
