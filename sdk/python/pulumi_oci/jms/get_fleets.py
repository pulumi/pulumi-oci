...
def get_fleets(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str display_name_contains: Filter the list with displayName contains the given value.
...
def get_fleets_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
