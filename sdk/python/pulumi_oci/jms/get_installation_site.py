...
def get_installation_site(application_id: Optional[builtins.str] = None,
...
def get_installation_site_output(application_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
