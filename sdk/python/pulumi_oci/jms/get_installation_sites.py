...
class GetInstallationSitesResult:
    ...
    def jre_distribution(self) -> Optional[_builtins.str]:
    ...
    def jre_vendor(self) -> Optional[_builtins.str]:
    ...
    def path_contains(self) -> Optional[_builtins.str]:
...
def get_installation_sites(application_id: Optional[_builtins.str] = None,
                           ...
                           jre_vendor: Optional[_builtins.str] = None,
                           ...
                           path_contains: Optional[_builtins.str] = None,
    ...
    :param _builtins.str installation_path: The file system path of the installation.
    :param _builtins.str jre_distribution: The distribution of the related Java Runtime.
    :param _builtins.str jre_security_status: The security status of the Java Runtime.
    :param _builtins.str jre_vendor: The vendor of the related Java Runtime.
    ...
    :param Sequence[_builtins.str] os_families: The operating system type.
    :param _builtins.str path_contains: Filter the list with path contains the given value.
...
def get_installation_sites_output(application_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
