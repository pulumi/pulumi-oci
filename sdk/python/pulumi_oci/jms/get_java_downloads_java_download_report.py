...
def get_java_downloads_java_download_report(java_download_report_id: Optional[builtins.str] = None,
...
def get_java_downloads_java_download_report_output(java_download_report_id: Optional[pulumi.Input[builtins.str]] = None,
