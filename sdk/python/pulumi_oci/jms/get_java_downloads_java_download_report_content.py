...
class GetJavaDownloadsJavaDownloadReportContentResult:
    ...
    def java_download_report_id(self) -> builtins.str:
...
def get_java_downloads_java_download_report_content(java_download_report_id: Optional[builtins.str] = None,
...
def get_java_downloads_java_download_report_content_output(java_download_report_id: Optional[pulumi.Input[builtins.str]] = None,
