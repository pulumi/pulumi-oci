...
class GetJavaDownloadsJavaDownloadTokenResult:
    ...
    def java_download_token_id(self) -> _builtins.str:
...
def get_java_downloads_java_download_token(java_download_token_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str java_download_token_id: Unique JavaDownloadToken identifier.
    """
    __args__ = dict()
