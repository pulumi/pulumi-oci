...
class GetJavaDownloadsJavaLicenseAcceptanceRecordResult:
    ...
    def java_license_acceptance_record_id(self) -> builtins.str:
...
def get_java_downloads_java_license_acceptance_record(java_license_acceptance_record_id: Optional[builtins.str] = None,
    ...
    :param builtins.str java_license_acceptance_record_id: Unique Java license acceptance record identifier.
    """
    __args__ = dict()
...
def get_java_downloads_java_license_acceptance_record_output(java_license_acceptance_record_id: Optional[pulumi.Input[builtins.str]] = None,
