...
def get_java_downloads_java_license_acceptance_records(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str status: The status of license acceptance.
    """
    __args__ = dict()
...
def get_java_downloads_java_license_acceptance_records_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
