...
def get_java_downloads_java_licenses(display_name: Optional[builtins.str] = None,
...
def get_java_downloads_java_licenses_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
