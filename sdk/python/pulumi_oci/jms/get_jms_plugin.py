...
class GetJmsPluginResult:
    ...
    def jms_plugin_id(self) -> _builtins.str:
...
def get_jms_plugin(jms_plugin_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str jms_plugin_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the JmsPlugin.
    """
    __args__ = dict()
...
def get_jms_plugin_output(jms_plugin_id: Optional[pulumi.Input[_builtins.str]] = None,
