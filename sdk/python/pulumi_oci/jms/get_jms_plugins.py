...
class GetJmsPluginsResult:
    ...
    def agent_type(self) -> Optional[builtins.str]:
        """
        The agent type.
        """
    ...
    def time_registered_less_than_or_equal_to(self) -> Optional[builtins.str]:
...
def get_jms_plugins(agent_id: Optional[builtins.str] = None,
                    agent_type: Optional[builtins.str] = None,
                    ...
                    time_registered_less_than_or_equal_to: Optional[builtins.str] = None,
    ...
    :param builtins.str hostname_contains: Filter the list with hostname contains the given value.
    ...
    :param builtins.str time_last_seen_less_than_or_equal_to: If present, only plugins with a last seen time before this parameter are searched (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)).
    :param builtins.str time_registered_less_than_or_equal_to: If present, only plugins with a registration time before this parameter are searched (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)).
    """
    __args__ = dict()
...
def get_jms_plugins_output(agent_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           agent_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                           ...
                           time_registered_less_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
