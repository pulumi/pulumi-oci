...
def get_list_jre_usage(application_id: Optional[builtins.str] = None,
    ...
    :param builtins.str application_id: The Fleet-unique identifier of the application.
    ...
    :param builtins.str host_id: The host [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the managed instance.
...
def get_list_jre_usage_output(application_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
