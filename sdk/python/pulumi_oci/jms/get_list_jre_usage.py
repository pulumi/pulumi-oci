...
def get_list_jre_usage(application_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str host_id: The host [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the managed instance.
