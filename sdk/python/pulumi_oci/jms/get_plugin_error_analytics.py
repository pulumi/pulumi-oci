...
def get_plugin_error_analytics(compartment_id: Optional[builtins.str] = None,
...
def get_plugin_error_analytics_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
