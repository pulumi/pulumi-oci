...
def get_plugin_errors(compartment_id: Optional[builtins.str] = None,
...
def get_plugin_errors_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
