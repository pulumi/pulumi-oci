...
class GetSummarizeResourceInventoryResult:
    ...
    def active_fleet_count(self) -> _builtins.int:
        """
    ...
    def installation_count(self) -> _builtins.int:
        """
    ...
    def jre_count(self) -> _builtins.int:
        """
...
def get_summarize_resource_inventory(compartment_id: Optional[_builtins.str] = None,
