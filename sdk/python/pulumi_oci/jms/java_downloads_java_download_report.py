...
class JavaDownloadsJavaDownloadReportArgs:
    def __init__(__self__, *,
                 ...
                 time_end: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: The compartment [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) here should be the tenancy OCID.
        :param pulumi.Input[builtins.str] format: The format of the report that is generated.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`. (See [Understanding Free-form Tags](https://docs.cloud.oracle.com/iaas/Content/Tagging/Tasks/managingtagsandtagnamespaces.htm)).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: Simple key-value pair that is applied without any predefined name, type, or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`. (See [Managing Tags and Tag Namespaces](https://docs.cloud.oracle.com/iaas/Content/Tagging/Concepts/understandingfreeformtags.htm).)
        :param pulumi.Input[builtins.str] time_end: The end time until when the download records have to be included (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)).
        :param pulumi.Input[builtins.str] time_start: The start time from when download records have to be included (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)). 
    ...
    def time_end(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @time_end.setter
    def time_end(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _JavaDownloadsJavaDownloadReportState:
    def __init__(__self__, *,
                 ...
                 checksum_value: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 file_size_in_bytes: Optional[pulumi.Input[builtins.str]] = None,
                 format: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 sort_by: Optional[pulumi.Input[builtins.str]] = None,
                 sort_order: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] checksum_type: The algorithm used for calculating the checksum.
        :param pulumi.Input[builtins.str] checksum_value: The checksum value of the Java download report file.
        :param pulumi.Input[builtins.str] compartment_id: The compartment [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) here should be the tenancy OCID.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`. (See [Understanding Free-form Tags](https://docs.cloud.oracle.com/iaas/Content/Tagging/Tasks/managingtagsandtagnamespaces.htm)).
        :param pulumi.Input[builtins.str] display_name: Display name for the Java download report.
        :param pulumi.Input[builtins.str] file_size_in_bytes: Approximate size of the Java download report file in bytes.
        :param pulumi.Input[builtins.str] format: The format of the report that is generated.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: Simple key-value pair that is applied without any predefined name, type, or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`. (See [Managing Tags and Tag Namespaces](https://docs.cloud.oracle.com/iaas/Content/Tagging/Concepts/understandingfreeformtags.htm).)
        :param pulumi.Input[builtins.str] state: The current state of the Java download report.
        ...
        :param pulumi.Input[builtins.str] time_created: The time the Java download report was created, displayed as an [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339) formatted datetime string.
        :param pulumi.Input[builtins.str] time_end: The end time until when the download records have to be included (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)).
        :param pulumi.Input[builtins.str] time_start: The start time from when download records have to be included (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)). 
    ...
    def checksum_value(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def checksum_value(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def file_size_in_bytes(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def file_size_in_bytes(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def sort_order(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "sort_order")

    @sort_order.setter
    def sort_order(self, value: Optional[pulumi.Input[builtins.str]]):
...
class JavaDownloadsJavaDownloadReport(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_end: Optional[pulumi.Input[builtins.str]] = None,
            time_start: Optional[pulumi.Input[builtins.str]] = None) -> 'JavaDownloadsJavaDownloadReport':
        """
    ...
    @property
    @pulumi.getter(name="checksumValue")
    def checksum_value(self) -> pulumi.Output[builtins.str]:
        """
        The checksum value of the Java download report file.
        """
        return pulumi.get(self, "checksum_value")
    ...
    @property
    @pulumi.getter(name="fileSizeInBytes")
    def file_size_in_bytes(self) -> pulumi.Output[builtins.str]:
        """
        Approximate size of the Java download report file in bytes.
        """
        return pulumi.get(self, "file_size_in_bytes")
    ...
    @property
    @pulumi.getter(name="sortBy")
    def sort_by(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "sort_by")

    @property
    @pulumi.getter(name="sortOrder")
    def sort_order(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "sort_order")
    ...
    @property
    @pulumi.getter(name="timeEnd")
    def time_end(self) -> pulumi.Output[builtins.str]:
        """
        The end time until when the download records have to be included (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)).
        """
        return pulumi.get(self, "time_end")
