...
class JavaDownloadsJavaDownloadTokenArgs:
    def __init__(__self__, *,
                 ...
                 java_version: pulumi.Input[builtins.str],
                 license_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 time_expires: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the tenancy scoped to the JavaDownloadToken.
        :param pulumi.Input[builtins.str] description: (Updatable) User provided description of the JavaDownloadToken.
        :param pulumi.Input[builtins.str] display_name: (Updatable) User provided display name of the JavaDownloadToken.
        :param pulumi.Input[builtins.str] java_version: The Java version associated with the token.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] license_types: (Updatable) The license type(s) associated with the JavaDownloadToken.
        :param pulumi.Input[builtins.str] time_expires: (Updatable) Expiry time of the token.
        ...
        :param pulumi.Input[builtins.bool] is_default: (Updatable) The token default attribute.
        """
    ...
    def java_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @java_version.setter
    def java_version(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "java_version", value)

    @property
    @pulumi.getter(name="licenseTypes")
    def license_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def license_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
        pulumi.set(self, "license_types", value)

    @property
    @pulumi.getter(name="timeExpires")
    def time_expires(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @time_expires.setter
    def time_expires(self, value: pulumi.Input[builtins.str]):
...
class _JavaDownloadsJavaDownloadTokenState:
    def __init__(__self__, *,
                 ...
                 license_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] license_types: (Updatable) The license type(s) associated with the JavaDownloadToken.
        :param pulumi.Input[builtins.str] lifecycle_details: Possible lifecycle substates.
        :param pulumi.Input[builtins.str] state: The current state of the JavaDownloadToken.
        ...
        :param pulumi.Input[builtins.str] time_created: The time the JavaDownloadToken was created, displayed as an [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339) formatted datetime string.
        :param pulumi.Input[builtins.str] time_expires: (Updatable) Expiry time of the token.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] time_last_used: The time the JavaDownloadToken was last used for download, displayed as an [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339) formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The time the JavaDownloadToken was updated, displayed as an [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339) formatted datetime string.
        :param pulumi.Input[builtins.str] value: Uniquely generated value for the JavaDownloadToken.
        """
    ...
    @property
    @pulumi.getter(name="licenseTypes")
    def license_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        (Updatable) The license type(s) associated with the JavaDownloadToken.
        """
        return pulumi.get(self, "license_types")
    ...
    @license_types.setter
    def license_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "license_types", value)
...
class JavaDownloadsJavaDownloadToken(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_last_used: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            value: Optional[pulumi.Input[builtins.str]] = None) -> 'JavaDownloadsJavaDownloadToken':
        """
    ...
    @property
    @pulumi.getter(name="javaVersion")
    def java_version(self) -> pulumi.Output[builtins.str]:
        """
        The Java version associated with the token.
        """
        return pulumi.get(self, "java_version")
    ...
    @property
    @pulumi.getter(name="licenseTypes")
    def license_types(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) The license type(s) associated with the JavaDownloadToken.
        """
        return pulumi.get(self, "license_types")
    ...
    @property
    @pulumi.getter(name="timeLastUsed")
    def time_last_used(self) -> pulumi.Output[builtins.str]:
        """
        The time the JavaDownloadToken was last used for download, displayed as an [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339) formatted datetime string.
        """
        return pulumi.get(self, "time_last_used")
