...
class JavaDownloadsJavaLicenseAcceptanceRecordArgs:
    def __init__(__self__, *,
                 ...
                 license_acceptance_status: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] compartment_id: The tenancy [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the user accepting the license.
        :param pulumi.Input[builtins.str] license_acceptance_status: (Updatable) Status of license acceptance.
        :param pulumi.Input[builtins.str] license_type: License type for the Java version.
    ...
    def license_acceptance_status(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def license_acceptance_status(self, value: pulumi.Input[builtins.str]):
...
class _JavaDownloadsJavaLicenseAcceptanceRecordState:
    def __init__(__self__, *,
                 ...
                 license_acceptance_status: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] license_type: License type for the Java version.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The current state of the JavaLicenseAcceptanceRecord.
        ...
        :param pulumi.Input[builtins.str] time_accepted: The date and time of license acceptance (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)).
        :param pulumi.Input[builtins.str] time_last_updated: The date and time of last update (formatted according to [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339)).
        """
    ...
    @property
    @pulumi.getter(name="licenseAcceptanceStatus")
    def license_acceptance_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Status of license acceptance.
        """
        return pulumi.get(self, "license_acceptance_status")
    ...
    @license_acceptance_status.setter
    def license_acceptance_status(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "license_acceptance_status", value)
...
class JavaDownloadsJavaLicenseAcceptanceRecord(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_accepted: Optional[pulumi.Input[builtins.str]] = None,
            time_last_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'JavaDownloadsJavaLicenseAcceptanceRecord':
        """
    ...
    @property
    @pulumi.getter(name="licenseAcceptanceStatus")
    def license_acceptance_status(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Status of license acceptance.
        """
        return pulumi.get(self, "license_acceptance_status")
