...
if not MYPY:
    class GeneratedKeyKeyShapeArgsDict(TypedDict):
        ...
        * ECDSA: 32, 48, or 66
        """
        curve_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class GeneratedKeyKeyShapeArgs:
    def __init__(__self__, *,
                 algorithm: pulumi.Input[builtins.str],
                 length: pulumi.Input[builtins.int],
                 curve_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] algorithm: The algorithm used by a key's key versions to encrypt or decrypt. Only AES algorithm is supported for `External` keys.
        :param pulumi.Input[builtins.int] length: The length of the key in bytes, expressed as an integer. Supported values include the following:
               * AES: 16, 24, or 32
               * RSA: 256, 384, or 512
               * ECDSA: 32, 48, or 66
        :param pulumi.Input[builtins.str] curve_id: Supported curve IDs for ECDSA keys.
        """
    ...
    def curve_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Supported curve IDs for ECDSA keys.
        """
    ...
    @curve_id.setter
    def curve_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "curve_id", value)


if not MYPY:
    class KeyAutoKeyRotationDetailsArgsDict(TypedDict):
        last_rotation_message: NotRequired[pulumi.Input[builtins.str]]
        """
        (Updatable) The last execution status message of auto key rotation.
        """
        last_rotation_status: NotRequired[pulumi.Input[builtins.str]]
        """
        (Updatable) The status of last execution of auto key rotation.
        """
        rotation_interval_in_days: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        time_of_last_rotation: NotRequired[pulumi.Input[builtins.str]]
        """
        (Updatable) A property indicating Last rotation Date. Example: `2023-04-04T00:00:00Z`.
        """
        time_of_next_rotation: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        time_of_schedule_start: NotRequired[pulumi.Input[builtins.str]]
        """
...
class KeyAutoKeyRotationDetailsArgs:
    def __init__(__self__, *,
                 last_rotation_message: Optional[pulumi.Input[builtins.str]] = None,
                 last_rotation_status: Optional[pulumi.Input[builtins.str]] = None,
                 rotation_interval_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 time_of_last_rotation: Optional[pulumi.Input[builtins.str]] = None,
                 time_of_next_rotation: Optional[pulumi.Input[builtins.str]] = None,
                 time_of_schedule_start: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] last_rotation_message: (Updatable) The last execution status message of auto key rotation.
        :param pulumi.Input[builtins.str] last_rotation_status: (Updatable) The status of last execution of auto key rotation.
        :param pulumi.Input[builtins.int] rotation_interval_in_days: (Updatable) The interval of auto key rotation. For auto key rotation the interval should between 60 day and 365 days (1 year). Note: User must specify this parameter when creating a new schedule.
        :param pulumi.Input[builtins.str] time_of_last_rotation: (Updatable) A property indicating Last rotation Date. Example: `2023-04-04T00:00:00Z`.
        :param pulumi.Input[builtins.str] time_of_next_rotation: (Updatable) A property indicating Next estimated scheduled Time, as per the interval, expressed as date YYYY-MM-DD String. Example: `2023-04-04T00:00:00Z`. The time has no significance when scheduling an auto key rotation as this can be done anytime approximately the scheduled day, KMS ignores the time and replaces it with 00:00, for example 2023-04-04T15:14:13Z will be used as 2023-04-04T00:00:00Z.
        :param pulumi.Input[builtins.str] time_of_schedule_start: (Updatable) A property indicating  scheduled start date expressed as date YYYY-MM-DD String. Example: `2023-04-04T00:00:00Z. The time has no significance when scheduling an auto key rotation as this can be done anytime approximately the scheduled day, KMS ignores the time and replaces it with 00:00, for example 2023-04-04T15:14:13Z will be used as 2023-04-04T00:00:00Z . Note : Today’s date will be used if not specified by customer.
        """
    ...
    def last_rotation_message(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The last execution status message of auto key rotation.
        """
    ...
    def last_rotation_message(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "last_rotation_message", value)

    @property
    @pulumi.getter(name="lastRotationStatus")
    def last_rotation_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The status of last execution of auto key rotation.
        """
    ...
    def last_rotation_status(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "last_rotation_status", value)

    @property
    @pulumi.getter(name="rotationIntervalInDays")
    def rotation_interval_in_days(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The interval of auto key rotation. For auto key rotation the interval should between 60 day and 365 days (1 year). Note: User must specify this parameter when creating a new schedule.
        """
    ...
    def rotation_interval_in_days(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "rotation_interval_in_days", value)

    @property
    @pulumi.getter(name="timeOfLastRotation")
    def time_of_last_rotation(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) A property indicating Last rotation Date. Example: `2023-04-04T00:00:00Z`.
        """
    ...
    def time_of_last_rotation(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_of_last_rotation", value)

    @property
    @pulumi.getter(name="timeOfNextRotation")
    def time_of_next_rotation(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) A property indicating Next estimated scheduled Time, as per the interval, expressed as date YYYY-MM-DD String. Example: `2023-04-04T00:00:00Z`. The time has no significance when scheduling an auto key rotation as this can be done anytime approximately the scheduled day, KMS ignores the time and replaces it with 00:00, for example 2023-04-04T15:14:13Z will be used as 2023-04-04T00:00:00Z.
        """
    ...
    def time_of_next_rotation(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_of_next_rotation", value)

    @property
    @pulumi.getter(name="timeOfScheduleStart")
    def time_of_schedule_start(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) A property indicating  scheduled start date expressed as date YYYY-MM-DD String. Example: `2023-04-04T00:00:00Z. The time has no significance when scheduling an auto key rotation as this can be done anytime approximately the scheduled day, KMS ignores the time and replaces it with 00:00, for example 2023-04-04T15:14:13Z will be used as 2023-04-04T00:00:00Z . Note : Today’s date will be used if not specified by customer.
        """
    ...
    def time_of_schedule_start(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_of_schedule_start", value)


if not MYPY:
    class KeyExternalKeyReferenceArgsDict(TypedDict):
        external_key_id: pulumi.Input[builtins.str]
        """
...
class KeyExternalKeyReferenceArgs:
    def __init__(__self__, *,
                 external_key_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] external_key_id: ExternalKeyId refers to the globally unique key Id associated with the key created in external vault in CTM
        """
        pulumi.set(__self__, "external_key_id", external_key_id)

    @property
    @pulumi.getter(name="externalKeyId")
    def external_key_id(self) -> pulumi.Input[builtins.str]:
        """
        ExternalKeyId refers to the globally unique key Id associated with the key created in external vault in CTM
        """
    ...
    def external_key_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "external_key_id", value)


if not MYPY:
    class KeyExternalKeyReferenceDetailArgsDict(TypedDict):
        external_key_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ExternalKeyId refers to the globally unique key Id associated with the key created in external vault in CTM.
        """
        external_key_version_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class KeyExternalKeyReferenceDetailArgs:
    def __init__(__self__, *,
                 external_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 external_key_version_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] external_key_id: ExternalKeyId refers to the globally unique key Id associated with the key created in external vault in CTM.
        :param pulumi.Input[builtins.str] external_key_version_id: Key version ID associated with the external key.
        """
    ...
    @property
    @pulumi.getter(name="externalKeyId")
    def external_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ExternalKeyId refers to the globally unique key Id associated with the key created in external vault in CTM.
        """
        return pulumi.get(self, "external_key_id")
    ...
    @external_key_id.setter
    def external_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "external_key_id", value)

    @property
    @pulumi.getter(name="externalKeyVersionId")
    def external_key_version_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Key version ID associated with the external key.
        """
    ...
    def external_key_version_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class KeyReplicaDetailArgsDict(TypedDict):
        replication_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class KeyReplicaDetailArgs:
    def __init__(__self__, *,
                 replication_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] replication_id: ReplicationId associated with a key operation
        """
    ...
    def replication_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ReplicationId associated with a key operation
        """
    ...
    def replication_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "replication_id", value)


if not MYPY:
    class KeyRestoreFromFileArgsDict(TypedDict):
        content_length: pulumi.Input[builtins.str]
        """
        (Updatable) content length of key's backup binary file
        """
        restore_key_from_file_details: pulumi.Input[builtins.str]
        """
        Key backup file content.
        """
        content_md5: NotRequired[pulumi.Input[builtins.str]]
        """
...
class KeyRestoreFromFileArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] content_length: (Updatable) content length of key's backup binary file
        :param pulumi.Input[builtins.str] restore_key_from_file_details: Key backup file content.
        :param pulumi.Input[builtins.str] content_md5: (Updatable) content md5 hashed value of key's backup file
        """
    ...
    def content_length(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) content length of key's backup binary file
        """
    ...
    def content_length(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "content_length", value)

    @property
    @pulumi.getter(name="restoreKeyFromFileDetails")
    def restore_key_from_file_details(self) -> pulumi.Input[builtins.str]:
        """
        Key backup file content.
        """
    ...
    def restore_key_from_file_details(self, value: pulumi.Input[builtins.str]):
...
class KeyRestoreFromObjectStoreArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] destination: (Updatable) Type of backup to restore from. Values of "BUCKET", "PRE_AUTHENTICATED_REQUEST_URI" are supported
        :param pulumi.Input[builtins.str] bucket: (Updatable) Name of the bucket where key was backed up
        :param pulumi.Input[builtins.str] namespace: (Updatable) Namespace of the bucket where key was backed up
        :param pulumi.Input[builtins.str] object: (Updatable) Object containing the backup
        :param pulumi.Input[builtins.str] uri: (Updatable) Pre-authenticated-request-uri of the backup
        """
...
class KeyVersionReplicaDetailArgs:
    def __init__(__self__, *,
                 replication_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] replication_id: ReplicationId associated with a key version operation
        """
        if replication_id is not None:
            pulumi.set(__self__, "replication_id", replication_id)
...
if not MYPY:
    class VaultExternalKeyManagerMetadataArgsDict(TypedDict):
        external_vault_endpoint_url: pulumi.Input[builtins.str]
        """
...
class VaultExternalKeyManagerMetadataArgs:
    def __init__(__self__, *,
                 ...
                 private_endpoint_id: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] external_vault_endpoint_url: URI of the vault on external key manager.
        ...
        :param pulumi.Input[builtins.str] private_endpoint_id: OCID of private endpoint created by customer.
        """
    ...
    def external_vault_endpoint_url(self) -> pulumi.Input[builtins.str]:
        """
        URI of the vault on external key manager.
        """
    ...
    def external_vault_endpoint_url(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class VaultExternalKeyManagerMetadataOauthMetadataArgsDict(TypedDict):
        client_app_id: pulumi.Input[builtins.str]
        """
        ID of the client app created in IDP.
        """
        client_app_secret: pulumi.Input[builtins.str]
        """
...
class VaultExternalKeyManagerMetadataOauthMetadataArgs:
    def __init__(__self__, *,
                 ...
                 idcs_account_name_url: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] client_app_id: ID of the client app created in IDP.
        :param pulumi.Input[builtins.str] client_app_secret: Secret of the client app created in IDP.
        :param pulumi.Input[builtins.str] idcs_account_name_url: Base URL of the IDCS account where confidential client app is created.
        """
    ...
    def client_app_id(self) -> pulumi.Input[builtins.str]:
        """
        ID of the client app created in IDP.
        """
    ...
    def client_app_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "client_app_id", value)

    @property
    @pulumi.getter(name="clientAppSecret")
    def client_app_secret(self) -> pulumi.Input[builtins.str]:
        """
        Secret of the client app created in IDP.
        """
    ...
    def client_app_secret(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class VaultExternalKeyManagerMetadataSummaryArgsDict(TypedDict):
        external_vault_endpoint_url: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        private_endpoint_id: NotRequired[pulumi.Input[builtins.str]]
        """
        OCID of the private endpoint.
        """
        vendor: NotRequired[pulumi.Input[builtins.str]]
        """
...
class VaultExternalKeyManagerMetadataSummaryArgs:
    def __init__(__self__, *,
                 external_vault_endpoint_url: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] external_vault_endpoint_url: URL of the vault on external key manager.
        ...
        :param pulumi.Input[builtins.str] private_endpoint_id: OCID of the private endpoint.
        :param pulumi.Input[builtins.str] vendor: Vendor of the external key manager.
        """
    ...
    @property
    @pulumi.getter(name="externalVaultEndpointUrl")
    def external_vault_endpoint_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        URL of the vault on external key manager.
        """
        return pulumi.get(self, "external_vault_endpoint_url")
    ...
    @external_vault_endpoint_url.setter
    def external_vault_endpoint_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "external_vault_endpoint_url", value)
...
if not MYPY:
    class VaultExternalKeyManagerMetadataSummaryOauthMetadataSummaryArgsDict(TypedDict):
        client_app_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ID of the client app created in IDP.
        """
        idcs_account_name_url: NotRequired[pulumi.Input[builtins.str]]
        """
        Base URL of the IDCS account where confidential client app is created.
        """
elif False:
...
class VaultExternalKeyManagerMetadataSummaryOauthMetadataSummaryArgs:
    def __init__(__self__, *,
                 client_app_id: Optional[pulumi.Input[builtins.str]] = None,
                 idcs_account_name_url: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] client_app_id: ID of the client app created in IDP.
        :param pulumi.Input[builtins.str] idcs_account_name_url: Base URL of the IDCS account where confidential client app is created.
        """
    ...
    @property
    @pulumi.getter(name="clientAppId")
    def client_app_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        ID of the client app created in IDP.
        """
        return pulumi.get(self, "client_app_id")
    ...
    @client_app_id.setter
    def client_app_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "client_app_id", value)

    @property
    @pulumi.getter(name="idcsAccountNameUrl")
    def idcs_account_name_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Base URL of the IDCS account where confidential client app is created.
        """
        return pulumi.get(self, "idcs_account_name_url")
    ...
    @idcs_account_name_url.setter
    def idcs_account_name_url(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "idcs_account_name_url", value)
...
class VaultReplicaDetailArgs:
    def __init__(__self__, *,
                 replication_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] replication_id: ReplicationId associated with a vault operation
        """
        if replication_id is not None:
            pulumi.set(__self__, "replication_id", replication_id)
...
if not MYPY:
    class VaultRestoreFromFileArgsDict(TypedDict):
        ...
        """
        restore_vault_from_file_details: pulumi.Input[builtins.str]
        """
...
class VaultRestoreFromFileArgs:
    def __init__(__self__, *,
                 ...
                 content_md5: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] content_length: content length of vault's backup binary file
        :param pulumi.Input[builtins.str] restore_vault_from_file_details: Vault backup file content
        :param pulumi.Input[builtins.str] content_md5: (Updatable) content md5 hashed value of vault's backup file
        """
        pulumi.set(__self__, "content_length", content_length)
    ...
    def restore_vault_from_file_details(self) -> pulumi.Input[builtins.str]:
        """
        Vault backup file content
        """
    ...
    def restore_vault_from_file_details(self, value: pulumi.Input[builtins.str]):
...
class VaultRestoreFromObjectStoreArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] destination: (Updatable) Type of backup to restore from. Values of "BUCKET", "PRE_AUTHENTICATED_REQUEST_URI" are supported
        :param pulumi.Input[builtins.str] bucket: (Updatable) Name of the bucket where vault was backed up
        :param pulumi.Input[builtins.str] namespace: (Updatable) Namespace of the bucket where vault was backed up
        :param pulumi.Input[builtins.str] object: (Updatable) Object containing the backup
        :param pulumi.Input[builtins.str] uri: (Updatable) Pre-authenticated-request-uri of the backup* `restore_trigger` - (Optional) (Updatable) An optional property when flipped triggers restore from restore option provided in config file.
        """
        pulumi.set(__self__, "destination", destination)
        if bucket is not None:
            pulumi.set(__self__, "bucket", bucket)
