...
class EkmsPrivateEndpointArgs:
    def __init__(__self__, *,
                 ca_bundle: pulumi.Input[builtins.str],
                 compartment_id: pulumi.Input[builtins.str],
                 display_name: pulumi.Input[builtins.str],
                 external_key_manager_ip: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] ca_bundle: CABundle to validate TLS certificate of the external key manager system in PEM format
        :param pulumi.Input[builtins.str] compartment_id: Compartment identifier.
        :param pulumi.Input[builtins.str] display_name: (Updatable) Display name of the EKMS private endpoint resource being created.
        :param pulumi.Input[builtins.str] external_key_manager_ip: External private IP to connect to from this EKMS private endpoint
        :param pulumi.Input[builtins.str] subnet_id: The OCID of subnet in which the EKMS private endpoint is to be created 
        ...
        :param pulumi.Input[builtins.int] port: The port of the external key manager system
        """
    ...
    def ca_bundle(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @ca_bundle.setter
    def ca_bundle(self, value: pulumi.Input[builtins.str]):
    ...
    def external_key_manager_ip(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def external_key_manager_ip(self, value: pulumi.Input[builtins.str]):
...
class _EkmsPrivateEndpointState:
    def __init__(__self__, *,
                 ...
                 external_key_manager_ip: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.int] port: The port of the external key manager system
        :param pulumi.Input[builtins.str] private_endpoint_ip: The IP address in the customer's VCN for the EKMS private endpoint. This is taken from subnet
        :param pulumi.Input[builtins.str] state: The current state of the EKMS private endpoint resource.
        :param pulumi.Input[builtins.str] subnet_id: The OCID of subnet in which the EKMS private endpoint is to be created 
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] time_created: The time the EKMS private endpoint was created. An [RFC3339](https://tools.ietf.org/html/rfc3339) formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The time the EKMS private endpoint was updated. An [RFC3339](https://tools.ietf.org/html/rfc3339) formatted datetime string.
        """
    ...
    @property
    @pulumi.getter(name="externalKeyManagerIp")
    def external_key_manager_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        External private IP to connect to from this EKMS private endpoint
        """
        return pulumi.get(self, "external_key_manager_ip")
    ...
    @external_key_manager_ip.setter
    def external_key_manager_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "external_key_manager_ip", value)
...
class EkmsPrivateEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            subnet_id: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'EkmsPrivateEndpoint':
        """
    ...
    @property
    @pulumi.getter(name="caBundle")
    def ca_bundle(self) -> pulumi.Output[builtins.str]:
        """
        CABundle to validate TLS certificate of the external key manager system in PEM format
        """
        return pulumi.get(self, "ca_bundle")
    ...
    @property
    @pulumi.getter(name="externalKeyManagerIp")
    def external_key_manager_ip(self) -> pulumi.Output[builtins.str]:
        """
        External private IP to connect to from this EKMS private endpoint
        """
        return pulumi.get(self, "external_key_manager_ip")
