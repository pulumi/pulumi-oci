...
class EncryptedDataArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key_id: The OCID of the key to encrypt with.
        :param pulumi.Input[builtins.str] plaintext: The plaintext data to encrypt.
        ...
        :param pulumi.Input[builtins.str] encryption_algorithm: The encryption algorithm to use to encrypt and decrypt data with a customer-managed key. `AES_256_GCM` indicates that the key is a symmetric key that uses the Advanced Encryption Standard (AES) algorithm and that the mode of encryption is the Galois/Counter Mode (GCM). `RSA_OAEP_SHA_1` indicates that the key is an asymmetric key that uses the RSA encryption algorithm and uses Optimal Asymmetric Encryption Padding (OAEP). `RSA_OAEP_SHA_256` indicates that the key is an asymmetric key that uses the RSA encryption algorithm with a SHA-256 hash and uses OAEP.
        :param pulumi.Input[builtins.str] key_version_id: The OCID of the key version used to encrypt the ciphertext.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] logging_context: Information that provides context for audit logging. You can provide this additional data as key-value pairs to include in the audit logs when audit logging is enabled.
        """
...
class _EncryptedDataState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] associated_data: Information that can be used to provide an encryption context for the encrypted data. The length of the string representation of the associated data must be fewer than 4096 characters.
        :param pulumi.Input[builtins.str] ciphertext: The encrypted data.
        :param pulumi.Input[builtins.str] crypto_endpoint: The service endpoint to perform cryptographic operations against. Cryptographic operations include 'Encrypt,' 'Decrypt,' and 'GenerateDataEncryptionKey' operations. see Vault Crypto endpoint.
        :param pulumi.Input[builtins.str] encryption_algorithm: The encryption algorithm to use to encrypt and decrypt data with a customer-managed key. `AES_256_GCM` indicates that the key is a symmetric key that uses the Advanced Encryption Standard (AES) algorithm and that the mode of encryption is the Galois/Counter Mode (GCM). `RSA_OAEP_SHA_1` indicates that the key is an asymmetric key that uses the RSA encryption algorithm and uses Optimal Asymmetric Encryption Padding (OAEP). `RSA_OAEP_SHA_256` indicates that the key is an asymmetric key that uses the RSA encryption algorithm with a SHA-256 hash and uses OAEP.
        :param pulumi.Input[builtins.str] key_id: The OCID of the key to encrypt with.
        :param pulumi.Input[builtins.str] key_version_id: The OCID of the key version used to encrypt the ciphertext.
...
class EncryptedData(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            key_version_id: Optional[pulumi.Input[builtins.str]] = None,
            logging_context: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            plaintext: Optional[pulumi.Input[builtins.str]] = None) -> 'EncryptedData':
        """
