...
class GeneratedKeyArgs:
    def __init__(__self__, *,
                 crypto_endpoint: pulumi.Input[builtins.str],
                 include_plaintext_key: pulumi.Input[builtins.bool],
                 key_id: pulumi.Input[builtins.str],
                 key_shape: pulumi.Input['GeneratedKeyKeyShapeArgs'],
                 associated_data: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 logging_context: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a GeneratedKey resource.
        :param pulumi.Input[builtins.str] crypto_endpoint: The service endpoint to perform cryptographic operations against. Cryptographic operations include 'Encrypt,' 'Decrypt,' and 'GenerateDataEncryptionKey' operations. see Vault Crypto endpoint.
        :param pulumi.Input[builtins.bool] include_plaintext_key: If true, the generated key is also returned unencrypted.
        :param pulumi.Input[builtins.str] key_id: The OCID of the master encryption key to encrypt the generated data encryption key with.
        :param pulumi.Input['GeneratedKeyKeyShapeArgs'] key_shape: The cryptographic properties of a key.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] associated_data: Information that can be used to provide an encryption context for the encrypted data. The length of the string representation of the associated data must be fewer than 4096 characters.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] logging_context: Information that provides context for audit logging. You can provide this additional data by formatting it as key-value pairs to include in audit logs when audit logging is enabled. 
    ...
    def crypto_endpoint(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def crypto_endpoint(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "crypto_endpoint", value)

    @property
    @pulumi.getter(name="includePlaintextKey")
    def include_plaintext_key(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def include_plaintext_key(self, value: pulumi.Input[builtins.bool]):
    ...
    def associated_data(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def associated_data(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "associated_data", value)

    @property
    @pulumi.getter(name="loggingContext")
    def logging_context(self) -> Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]:
        """
    ...
    def logging_context(self, value: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]]):
...
class _GeneratedKeyState:
    def __init__(__self__, *,
                 ...
                 include_plaintext_key: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 plaintext_checksum: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering GeneratedKey resources.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] associated_data: Information that can be used to provide an encryption context for the encrypted data. The length of the string representation of the associated data must be fewer than 4096 characters.
        :param pulumi.Input[builtins.str] ciphertext: The encrypted data encryption key generated from a master encryption key.
        :param pulumi.Input[builtins.str] crypto_endpoint: The service endpoint to perform cryptographic operations against. Cryptographic operations include 'Encrypt,' 'Decrypt,' and 'GenerateDataEncryptionKey' operations. see Vault Crypto endpoint.
        :param pulumi.Input[builtins.bool] include_plaintext_key: If true, the generated key is also returned unencrypted.
        :param pulumi.Input[builtins.str] key_id: The OCID of the master encryption key to encrypt the generated data encryption key with.
        :param pulumi.Input['GeneratedKeyKeyShapeArgs'] key_shape: The cryptographic properties of a key.
    ...
    @property
    @pulumi.getter(name="includePlaintextKey")
    def include_plaintext_key(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If true, the generated key is also returned unencrypted.
        """
        return pulumi.get(self, "include_plaintext_key")
    ...
    @include_plaintext_key.setter
    def include_plaintext_key(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "include_plaintext_key", value)
    ...
    def plaintext_checksum(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def plaintext_checksum(self, value: Optional[pulumi.Input[builtins.str]]):
...
class GeneratedKey(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            logging_context: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            plaintext: Optional[pulumi.Input[builtins.str]] = None,
            plaintext_checksum: Optional[pulumi.Input[builtins.str]] = None) -> 'GeneratedKey':
        """
    ...
    @property
    @pulumi.getter(name="associatedData")
    def associated_data(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        Information that can be used to provide an encryption context for the encrypted data. The length of the string representation of the associated data must be fewer than 4096 characters.
        """
        return pulumi.get(self, "associated_data")
    ...
    @property
    @pulumi.getter(name="includePlaintextKey")
    def include_plaintext_key(self) -> pulumi.Output[builtins.bool]:
        """
        If true, the generated key is also returned unencrypted.
        """
        return pulumi.get(self, "include_plaintext_key")
    ...
    @property
    @pulumi.getter(name="loggingContext")
    def logging_context(self) -> pulumi.Output[Optional[Mapping[str, builtins.str]]]:
        """
        Information that provides context for audit logging. You can provide this additional data by formatting it as key-value pairs to include in audit logs when audit logging is enabled. 
    ...
    @property
    @pulumi.getter(name="plaintextChecksum")
    def plaintext_checksum(self) -> pulumi.Output[builtins.str]:
        """
        The checksum of the plaintext data encryption key, which is included if the [GenerateDataEncryptionKey](https://docs.cloud.oracle.com/iaas/api/#/en/key/latest/GeneratedKey/GenerateDataEncryptionKey) request includes the `includePlaintextKey` parameter and sets its value to "true".
        """
        return pulumi.get(self, "plaintext_checksum")
