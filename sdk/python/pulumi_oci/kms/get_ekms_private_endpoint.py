...
class GetEkmsPrivateEndpointResult:
    ...
    def ekms_private_endpoint_id(self) -> builtins.str:
...
def get_ekms_private_endpoint(ekms_private_endpoint_id: Optional[builtins.str] = None,
    ...
    :param builtins.str ekms_private_endpoint_id: Unique EKMS private endpoint identifier.
    """
    __args__ = dict()
...
def get_ekms_private_endpoint_output(ekms_private_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
