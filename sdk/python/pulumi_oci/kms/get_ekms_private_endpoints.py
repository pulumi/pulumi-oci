...
def get_ekms_private_endpoints(compartment_id: Optional[builtins.str] = None,
...
def get_ekms_private_endpoints_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
