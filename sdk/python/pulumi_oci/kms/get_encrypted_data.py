...
def get_encrypted_data(associated_data: Optional[Mapping[str, builtins.str]] = None,
    ...
    :param builtins.str key_id: The OCID of the key to encrypt with.
    :param builtins.str plaintext: The plaintext data to encrypt.
    """
    __args__ = dict()
...
def get_encrypted_data_output(associated_data: Optional[pulumi.Input[Optional[Mapping[str, builtins.str]]]] = None,
