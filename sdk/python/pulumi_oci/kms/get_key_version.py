...
def get_key_version(key_id: Optional[builtins.str] = None,
                    key_version_id: Optional[builtins.str] = None,
...
def get_key_version_output(key_id: Optional[pulumi.Input[builtins.str]] = None,
