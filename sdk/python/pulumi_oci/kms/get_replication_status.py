...
def get_replication_status(management_endpoint: Optional[builtins.str] = None,
    ...
    :param builtins.str management_endpoint: The service endpoint to perform management operations against. See Vault Management endpoint.
    :param builtins.str replication_id: replicationId associated with an operation on a resource
    """
    __args__ = dict()
...
def get_replication_status_output(management_endpoint: Optional[pulumi.Input[builtins.str]] = None,
