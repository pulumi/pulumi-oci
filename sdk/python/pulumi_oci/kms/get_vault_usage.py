...
class GetVaultUsageResult:
    ...
    def key_version_count(self) -> builtins.int:
        """
    ...
    def software_key_count(self) -> builtins.int:
        """
    ...
    def software_key_version_count(self) -> builtins.int:
        """
...
def get_vault_usage(vault_id: Optional[builtins.str] = None,
...
def get_vault_usage_output(vault_id: Optional[pulumi.Input[builtins.str]] = None,
