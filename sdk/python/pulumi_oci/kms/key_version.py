...
class KeyVersionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] key_id: The OCID of the key.
        ...
        :param pulumi.Input[builtins.str] time_of_deletion: (Updatable) An optional property for the deletion time of the key version, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
...
class _KeyVersionState:
    def __init__(__self__, *,
                 ...
                 external_key_version_id: Optional[pulumi.Input[builtins.str]] = None,
                 is_auto_rotated: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 restored_from_key_version_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment that contains this key version.
        ...
        :param pulumi.Input[builtins.str] external_key_version_id: Key version ID associated with the external key.
        :param pulumi.Input[builtins.bool] is_auto_rotated: An optional property indicating whether this keyversion is generated from auto rotatation.
        :param pulumi.Input[builtins.bool] is_primary: A Boolean value that indicates whether the KeyVersion belongs to primary Vault or replica Vault.
        :param pulumi.Input[builtins.str] key_id: The OCID of the key.
        :param pulumi.Input[builtins.str] management_endpoint: The service endpoint to perform management operations against. Management operations include 'Create,' 'Update,' 'List,' 'Get,' and 'Delete' operations. See Vault Management endpoint.
        :param pulumi.Input[builtins.str] public_key: The public key in PEM format. (This value pertains only to RSA and ECDSA keys.)
        :param pulumi.Input[Sequence[pulumi.Input['KeyVersionReplicaDetailArgs']]] replica_details: KeyVersion replica details
        :param pulumi.Input[builtins.str] restored_from_key_version_id: The OCID of the key version from which this key version was restored.
        :param pulumi.Input[builtins.str] state: The key version's current lifecycle state.  Example: `ENABLED`
        :param pulumi.Input[builtins.str] time_created: The date and time this key version was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.  Example: "2018-04-03T21:10:29.600Z"
        :param pulumi.Input[builtins.str] time_of_deletion: (Updatable) An optional property for the deletion time of the key version, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] vault_id: The OCID of the vault that contains this key version.
        """
    ...
    def is_auto_rotated(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_auto_rotated(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def restored_from_key_version_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def restored_from_key_version_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class KeyVersion(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_of_deletion: Optional[pulumi.Input[builtins.str]] = None,
            vault_id: Optional[pulumi.Input[builtins.str]] = None) -> 'KeyVersion':
        """
    ...
    @property
    @pulumi.getter(name="externalKeyVersionId")
    def external_key_version_id(self) -> pulumi.Output[builtins.str]:
        """
        Key version ID associated with the external key.
        """
        return pulumi.get(self, "external_key_version_id")
    ...
    @property
    @pulumi.getter(name="isAutoRotated")
    def is_auto_rotated(self) -> pulumi.Output[builtins.bool]:
        """
        An optional property indicating whether this keyversion is generated from auto rotatation.
        """
        return pulumi.get(self, "is_auto_rotated")
    ...
    @property
    @pulumi.getter(name="keyVersionId")
    def key_version_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "key_version_id")
    ...
    @property
    @pulumi.getter(name="restoredFromKeyVersionId")
    def restored_from_key_version_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the key version from which this key version was restored.
        """
        return pulumi.get(self, "restored_from_key_version_id")
