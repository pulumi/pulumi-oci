...
class VerifyArgs:
    def __init__(__self__, *,
                 ...
                 key_version_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] signature: The base64-encoded binary data object denoting the cryptographic signature generated for the message.
    ...
    def key_version_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def key_version_id(self, value: pulumi.Input[builtins.str]):
...
class _VerifyState:
    def __init__(__self__, *,
                 ...
                 is_signature_valid: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] crypto_endpoint: The service endpoint to perform cryptographic operations against. Cryptographic operations include 'Encrypt,' 'Decrypt,', 'GenerateDataEncryptionKey', 'Sign' and 'Verify' operations. see Vault Crypto endpoint.
        :param pulumi.Input[builtins.bool] is_signature_valid: A Boolean value that indicates whether the signature was verified.
        :param pulumi.Input[builtins.str] key_id: The OCID of the key used to sign the message.
        :param pulumi.Input[builtins.str] key_version_id: The OCID of the key version used to sign the message.
        :param pulumi.Input[builtins.str] message: The base64-encoded binary data object denoting the message or message digest to sign. You can have a message up to 4096 bytes in size. To sign a larger message, provide the message digest.
        :param pulumi.Input[builtins.str] message_type: Denotes whether the value of the message parameter is a raw message or a message digest. The default value, `RAW`, indicates a message. To indicate a message digest, use `DIGEST`.
    ...
    def is_signature_valid(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_signature_valid(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Verify(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            message_type: Optional[pulumi.Input[builtins.str]] = None,
            signature: Optional[pulumi.Input[builtins.str]] = None,
            signing_algorithm: Optional[pulumi.Input[builtins.str]] = None) -> 'Verify':
        """
    ...
    @property
    @pulumi.getter(name="isSignatureValid")
    def is_signature_valid(self) -> pulumi.Output[builtins.bool]:
        """
        A Boolean value that indicates whether the signature was verified.
        """
        return pulumi.get(self, "is_signature_valid")
