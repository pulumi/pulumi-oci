...
class GetConfigurationResult:
    ...
    def email_ids(self) -> Sequence[_builtins.str]:
        """
...
def get_configuration_output(compartment_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:LicenseManager/getConfiguration:getConfiguration', __args__, opts=opts, typ=GetConfigurationResult)
