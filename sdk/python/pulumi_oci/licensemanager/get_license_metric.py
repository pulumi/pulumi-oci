...
class GetLicenseMetricResult:
    ...
    def license_record_expiring_soon_count(self) -> builtins.int:
        """
    ...
    def total_byol_instance_count(self) -> builtins.int:
        """
    ...
    def total_license_included_instance_count(self) -> builtins.int:
        """
    ...
    def total_product_license_count(self) -> builtins.int:
        """
...
def get_license_metric(compartment_id: Optional[builtins.str] = None,
...
def get_license_metric_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
