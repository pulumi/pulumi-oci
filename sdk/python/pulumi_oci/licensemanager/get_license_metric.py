...
class GetLicenseMetricResult:
    ...
    def license_record_expiring_soon_count(self) -> _builtins.int:
        """
    ...
    def total_byol_instance_count(self) -> _builtins.int:
        """
    ...
    def total_license_included_instance_count(self) -> _builtins.int:
        """
    ...
    def total_product_license_count(self) -> _builtins.int:
        """
...
def get_license_metric(compartment_id: Optional[_builtins.str] = None,
