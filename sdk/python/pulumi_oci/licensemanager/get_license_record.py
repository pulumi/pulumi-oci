...
def get_license_record(license_record_id: Optional[str] = None,
    ...
    return AwaitableGetLicenseRecordResult(
        ...
        id=__ret__.id,
        is_perpetual=__ret__.is_perpetual,
        is_unlimited=__ret__.is_unlimited,
        license_count=__ret__.license_count,
        license_record_id=__ret__.license_record_id,
        license_unit=__ret__.license_unit,
        product_id=__ret__.product_id,
        product_license=__ret__.product_license,
        product_license_id=__ret__.product_license_id,
        state=__ret__.state,
        support_end_date=__ret__.support_end_date,
