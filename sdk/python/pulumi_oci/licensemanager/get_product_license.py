...
def get_product_license(product_license_id: Optional[str] = None,
    ...
    return AwaitableGetProductLicenseResult(
        active_license_record_count=__ret__.active_license_record_count,
        ...
        is_over_subscribed=__ret__.is_over_subscribed,
        is_unlimited=__ret__.is_unlimited,
        is_vendor_oracle=__ret__.is_vendor_oracle,
        ...
        total_active_license_unit_count=__ret__.total_active_license_unit_count,
        total_license_record_count=__ret__.total_license_record_count,
        total_license_units_consumed=__ret__.total_license_units_consumed,
