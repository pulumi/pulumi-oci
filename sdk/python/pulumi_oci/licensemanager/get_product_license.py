...
def get_product_license(product_license_id: Optional[_builtins.str] = None,
...
def get_product_license_output(product_license_id: Optional[pulumi.Input[_builtins.str]] = None,
