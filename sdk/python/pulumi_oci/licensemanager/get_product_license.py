...
def get_product_license(product_license_id: Optional[builtins.str] = None,
...
def get_product_license_output(product_license_id: Optional[pulumi.Input[builtins.str]] = None,
