...
def get_product_license_consumers(compartment_id: Optional[builtins.str] = None,
...
def get_product_license_consumers_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
