...
def get_product_licenses(compartment_id: Optional[builtins.str] = None,
...
def get_product_licenses_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
