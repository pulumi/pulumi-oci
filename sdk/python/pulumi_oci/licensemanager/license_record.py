...
class LicenseRecordArgs:
    def __init__(__self__, *,
                 ...
                 is_perpetual: pulumi.Input[builtins.bool],
                 is_unlimited: pulumi.Input[builtins.bool],
                 product_license_id: pulumi.Input[builtins.str],
                 ...
                 support_end_date: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a LicenseRecord resource.
        :param pulumi.Input[builtins.str] display_name: (Updatable) License record name.
        :param pulumi.Input[builtins.bool] is_perpetual: (Updatable) Specifies if the license record term is perpertual.
        :param pulumi.Input[builtins.bool] is_unlimited: (Updatable) Specifies if the license count is unlimited.
        :param pulumi.Input[builtins.str] product_license_id: Unique product license identifier.
        ...
        :param pulumi.Input[builtins.str] expiration_date: (Updatable) The license record end date in [RFC 3339](https://tools.ietf.org/html/rfc3339) date format. Example: `2018-09-12`
        ...
        :param pulumi.Input[builtins.int] license_count: (Updatable) The number of license units added by a user in a license record. Default 1
        :param pulumi.Input[builtins.str] product_id: (Updatable) The license record product ID.
        :param pulumi.Input[builtins.str] support_end_date: (Updatable) The license record support end date in [RFC 3339](https://tools.ietf.org/html/rfc3339) date format. Example: `2018-09-12` 
    ...
    def is_perpetual(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @is_perpetual.setter
    def is_perpetual(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "is_perpetual", value)

    @property
    @pulumi.getter(name="isUnlimited")
    def is_unlimited(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @is_unlimited.setter
    def is_unlimited(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "is_unlimited", value)

    @property
    @pulumi.getter(name="productLicenseId")
    def product_license_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def product_license_id(self, value: pulumi.Input[builtins.str]):
    ...
    def support_end_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def support_end_date(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _LicenseRecordState:
    def __init__(__self__, *,
                 ...
                 expiration_date: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_perpetual: Optional[pulumi.Input[builtins.bool]] = None,
                 is_unlimited: Optional[pulumi.Input[builtins.bool]] = None,
                 license_count: Optional[pulumi.Input[builtins.int]] = None,
                 license_unit: Optional[pulumi.Input[builtins.str]] = None,
                 product_id: Optional[pulumi.Input[builtins.str]] = None,
                 product_license: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: The compartment [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) where the license record is created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] display_name: (Updatable) License record name.
        :param pulumi.Input[builtins.str] expiration_date: (Updatable) The license record end date in [RFC 3339](https://tools.ietf.org/html/rfc3339) date format. Example: `2018-09-12`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type, or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        ...
        :param pulumi.Input[builtins.str] product_id: (Updatable) The license record product ID.
        :param pulumi.Input[builtins.str] product_license: The product license name with which the license record is associated.
        :param pulumi.Input[builtins.str] product_license_id: Unique product license identifier.
        :param pulumi.Input[builtins.str] state: The current license record state.
        :param pulumi.Input[builtins.str] support_end_date: (Updatable) The license record support end date in [RFC 3339](https://tools.ietf.org/html/rfc3339) date format. Example: `2018-09-12` 
        ...
        :param pulumi.Input[builtins.str] time_created: The time the license record was created. An [RFC 3339](https://tools.ietf.org/html/rfc3339)-formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The time the license record was updated. An [RFC 3339](https://tools.ietf.org/html/rfc3339)-formatted datetime string.
        """
    ...
    @property
    @pulumi.getter(name="isPerpetual")
    def is_perpetual(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) Specifies if the license record term is perpertual.
        """
        return pulumi.get(self, "is_perpetual")
    ...
    @is_perpetual.setter
    def is_perpetual(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_perpetual", value)
    ...
    def product_license(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def product_license(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "product_license", value)

    @property
    @pulumi.getter(name="productLicenseId")
    def product_license_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Unique product license identifier.
        """
        return pulumi.get(self, "product_license_id")
    ...
    @product_license_id.setter
    def product_license_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "product_license_id", value)
...
class LicenseRecord(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'LicenseRecord':
        """
    ...
    @property
    @pulumi.getter(name="isPerpetual")
    def is_perpetual(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Specifies if the license record term is perpertual.
        """
        return pulumi.get(self, "is_perpetual")
    ...
    @property
    @pulumi.getter(name="licenseCount")
    def license_count(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The number of license units added by a user in a license record. Default 1
        """
        return pulumi.get(self, "license_count")
    ...
    @property
    @pulumi.getter(name="productLicense")
    def product_license(self) -> pulumi.Output[builtins.str]:
        """
        The product license name with which the license record is associated.
        """
        return pulumi.get(self, "product_license")
    ...
    @property
    @pulumi.getter(name="productLicenseId")
    def product_license_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique product license identifier.
        """
        return pulumi.get(self, "product_license_id")
    ...
    @property
    @pulumi.getter(name="supportEndDate")
    def support_end_date(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The license record support end date in [RFC 3339](https://tools.ietf.org/html/rfc3339) date format. Example: `2018-09-12` 
