...
def get_limit_definitions(compartment_id: Optional[builtins.str] = None,
...
def get_limit_definitions_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
