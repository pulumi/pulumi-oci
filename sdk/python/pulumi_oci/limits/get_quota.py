...
def get_quota(quota_id: Optional[builtins.str] = None,
    ...
    :param builtins.str quota_id: The OCID of the quota.
    """
    __args__ = dict()
...
def get_quota_output(quota_id: Optional[pulumi.Input[builtins.str]] = None,
