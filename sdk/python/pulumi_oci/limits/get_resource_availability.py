...
class GetResourceAvailabilityResult:
    ...
    def effective_quota_value(self) -> builtins.float:
        """
    ...
    def fractional_availability(self) -> builtins.float:
        """
    ...
    def fractional_usage(self) -> builtins.float:
        """
...
def get_resource_availability(availability_domain: Optional[builtins.str] = None,
                              compartment_id: Optional[builtins.str] = None,
                              limit_name: Optional[builtins.str] = None,
    ...
    :param builtins.str availability_domain: This field is mandatory if the scopeType of the target resource limit is AD. Otherwise, this field should be omitted. If the above requirements are not met, the API returns a 400 - InvalidParameter response.
    :param builtins.str compartment_id: The OCID of the compartment for which data is being fetched.
    :param builtins.str limit_name: The limit name for which to fetch the data.
    :param builtins.str service_name: The service name of the target quota.
...
def get_resource_availability_output(availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                     limit_name: Optional[pulumi.Input[builtins.str]] = None,
