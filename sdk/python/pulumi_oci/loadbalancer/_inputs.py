...
if not MYPY:
    class BackendSetBackendArgsDict(TypedDict):
        ...
        **Note:** You cannot add a backend server marked as `backup` to a backend set that uses the IP Hash policy.
        ...
        Example: `false`
        """
        drain: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class BackendSetBackendArgs:
    def __init__(__self__, *,
                 ...
                 drain: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.bool] backup: (Updatable) Whether the load balancer should treat this server as a backup unit. If `true`, the load balancer forwards no ingress traffic to this backend server unless all other backend servers not marked as "backup" fail the health check policy.
    ...
    @property
    @pulumi.getter
    def drain(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) Whether the load balancer should drain this server. Servers marked "drain" receive no new incoming traffic.  Example: `false`
        """
    ...
    @drain.setter
    def drain(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class BackendSetHealthCheckerArgsDict(TypedDict):
        ...
        """
        interval_ms: NotRequired[pulumi.Input[builtins.int]]
        """
        (Updatable) The interval between health checks, in milliseconds.  Example: `10000`
        """
        is_force_plain_text: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class BackendSetHealthCheckerArgs:
    def __init__(__self__, *,
                 protocol: pulumi.Input[builtins.str],
                 interval_ms: Optional[pulumi.Input[builtins.int]] = None,
                 is_force_plain_text: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] protocol: (Updatable) The protocol the health check must use; either HTTP or TCP.  Example: `HTTP`
        :param pulumi.Input[builtins.int] interval_ms: (Updatable) The interval between health checks, in milliseconds.  Example: `10000`
        :param pulumi.Input[builtins.bool] is_force_plain_text: (Updatable) Specifies if health checks should always be done using plain text instead of depending on whether or not the associated backend set is using SSL.
               ...
               Example: `false`
        :param pulumi.Input[builtins.int] port: (Updatable) The backend server port against which to run the health check. If the port is not specified, the load balancer uses the port information from the `Backend` object.  Example: `8080`
        ...
        :param pulumi.Input[builtins.int] retries: (Updatable) The number of retries to attempt before a backend server is considered "unhealthy". This number also applies when recovering a server to the "healthy" state.  Example: `3`
        :param pulumi.Input[builtins.int] return_code: (Updatable) The status code a healthy backend server should return.  Example: `200`
        :param pulumi.Input[builtins.int] timeout_in_millis: (Updatable) The maximum time, in milliseconds, to wait for a reply to a health check. A health check is successful only if a reply returns within this timeout period.  Example: `3000`
    ...
    def interval_ms(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The interval between health checks, in milliseconds.  Example: `10000`
        """
    ...
    @interval_ms.setter
    def interval_ms(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "interval_ms", value)

    @property
    @pulumi.getter(name="isForcePlainText")
    def is_force_plain_text(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) Specifies if health checks should always be done using plain text instead of depending on whether or not the associated backend set is using SSL.
    ...
    def is_force_plain_text(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class BackendSetLbCookieSessionPersistenceConfigurationArgsDict(TypedDict):
        ...
        *  If a backend server and the load balancer both insert cookies with the same name, the client or browser behavior can vary depending on the domain and path values associated with the cookie. If the name, domain, and path values of the `Set-cookie` generated by a backend server and the `Set-cookie` generated by the load balancer are all the same, the client or browser treats them as one cookie and returns only one of the cookie values in subsequent requests. If both `Set-cookie` names are the same, but the domain and path names are different, the client or browser treats them as two different cookies.
        """
        disable_fallback: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        *  Ensure that this attribute specifies the correct domain value. If the `Domain` attribute in the `Set-cookie` header does not include the domain to which the original request was made, the client or browser might reject the cookie. As specified in RFC 6265, the client accepts a cookie with the `Domain` attribute value `example.com` or `www.example.com` sent from `www.example.com`. It does not accept a cookie with the `Domain` attribute `abc.example.com` or `www.abc.example.com` sent from `www.example.com`.
        ...
        Example: `example.com`
        """
        is_http_only: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        is_secure: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class BackendSetLbCookieSessionPersistenceConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 disable_fallback: Optional[pulumi.Input[builtins.bool]] = None,
                 domain: Optional[pulumi.Input[builtins.str]] = None,
                 is_http_only: Optional[pulumi.Input[builtins.bool]] = None,
                 is_secure: Optional[pulumi.Input[builtins.bool]] = None,
                 max_age_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 path: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] cookie_name: (Updatable) The name of the cookie inserted by the load balancer. If this field is not configured, the cookie name defaults to "X-Oracle-BMC-LBS-Route".  Example: `example_cookie`
               
               **Notes:**
               *  Ensure that the cookie name used at the backend application servers is different from the cookie name used at the load balancer. To minimize the chance of name collision, Oracle recommends that you use a prefix such as "X-Oracle-OCI-" for this field.
               *  If a backend server and the load balancer both insert cookies with the same name, the client or browser behavior can vary depending on the domain and path values associated with the cookie. If the name, domain, and path values of the `Set-cookie` generated by a backend server and the `Set-cookie` generated by the load balancer are all the same, the client or browser treats them as one cookie and returns only one of the cookie values in subsequent requests. If both `Set-cookie` names are the same, but the domain and path names are different, the client or browser treats them as two different cookies.
        :param pulumi.Input[builtins.bool] disable_fallback: (Updatable) Whether the load balancer is prevented from directing traffic from a persistent session client to a different backend server if the original server is unavailable. Defaults to false.  Example: `false`
        :param pulumi.Input[builtins.str] domain: (Updatable) The domain in which the cookie is valid. The `Set-cookie` header inserted by the load balancer contains a domain attribute with the specified value.
               ...
               *  Ensure that this attribute specifies the correct domain value. If the `Domain` attribute in the `Set-cookie` header does not include the domain to which the original request was made, the client or browser might reject the cookie. As specified in RFC 6265, the client accepts a cookie with the `Domain` attribute value `example.com` or `www.example.com` sent from `www.example.com`. It does not accept a cookie with the `Domain` attribute `abc.example.com` or `www.abc.example.com` sent from `www.example.com`.
               ...
               Example: `example.com`
        :param pulumi.Input[builtins.bool] is_http_only: (Updatable) Whether the `Set-cookie` header should contain the `HttpOnly` attribute. If `true`, the `Set-cookie` header inserted by the load balancer contains the `HttpOnly` attribute, which limits the scope of the cookie to HTTP requests. This attribute directs the client or browser to omit the cookie when providing access to cookies through non-HTTP APIs. For example, it restricts the cookie from JavaScript channels.  Example: `true`
        :param pulumi.Input[builtins.bool] is_secure: (Updatable) Whether the `Set-cookie` header should contain the `Secure` attribute. If `true`, the `Set-cookie` header inserted by the load balancer contains the `Secure` attribute, which directs the client or browser to send the cookie only using a secure protocol.
               
               **Note:** If you set this field to `true`, you cannot associate the corresponding backend set with an HTTP listener.
               
               Example: `true`
        :param pulumi.Input[builtins.int] max_age_in_seconds: (Updatable) The amount of time the cookie remains valid. The `Set-cookie` header inserted by the load balancer contains a `Max-Age` attribute with the specified value.
               
               The specified value must be at least one second. There is no default value for this attribute. If you do not specify a value, the load balancer does not include the `Max-Age` attribute in the `Set-cookie` header. In most cases, the client or browser retains the cookie until the current session ends, as defined by the client.
               
               Example: `3600`
        :param pulumi.Input[builtins.str] path: (Updatable) The path in which the cookie is valid. The `Set-cookie header` inserted by the load balancer contains a `Path` attribute with the specified value.
    ...
    def disable_fallback(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) Whether the load balancer is prevented from directing traffic from a persistent session client to a different backend server if the original server is unavailable. Defaults to false.  Example: `false`
        """
    ...
    def disable_fallback(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def is_http_only(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) Whether the `Set-cookie` header should contain the `HttpOnly` attribute. If `true`, the `Set-cookie` header inserted by the load balancer contains the `HttpOnly` attribute, which limits the scope of the cookie to HTTP requests. This attribute directs the client or browser to omit the cookie when providing access to cookies through non-HTTP APIs. For example, it restricts the cookie from JavaScript channels.  Example: `true`
        """
    ...
    @is_http_only.setter
    def is_http_only(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class BackendSetSessionPersistenceConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 disable_fallback: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.str] cookie_name: (Updatable) The name of the cookie used to detect a session initiated by the backend server. Use '*' to specify that any cookie set by the backend causes the session to persist.  Example: `example_cookie`
        :param pulumi.Input[builtins.bool] disable_fallback: (Updatable) Whether the load balancer is prevented from directing traffic from a persistent session client to a different backend server if the original server is unavailable. Defaults to false.  Example: `false`
        """
        pulumi.set(__self__, "cookie_name", cookie_name)
        if disable_fallback is not None:
...
if not MYPY:
    class BackendSetSslConfigurationArgsDict(TypedDict):
        ...
        """
        cipher_suite_name: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        *  For all existing load balancer listeners and backend sets that predate this feature, the `GET` operation displays a list of SSL protocols currently used by those resources.
        ...
        """
        server_order_preference: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        **Note:** This configuration is applicable only when the load balancer is acting as an SSL/HTTPS server. This field is ignored when the `SSLConfiguration` object is associated with a backend set.
        """
        trusted_certificate_authority_ids: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        """
        verify_depth: NotRequired[pulumi.Input[builtins.int]]
        """
        (Updatable) The maximum depth for peer certificate chain verification.  Example: `3`
        """
        verify_peer_certificate: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class BackendSetSslConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 cipher_suite_name: Optional[pulumi.Input[builtins.str]] = None,
                 protocols: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 server_order_preference: Optional[pulumi.Input[builtins.str]] = None,
                 trusted_certificate_authority_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 verify_depth: Optional[pulumi.Input[builtins.int]] = None,
                 verify_peer_certificate: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] certificate_ids: (Updatable) Ids for Oracle Cloud Infrastructure certificates service certificates. Currently only a single Id may be passed.  Example: `[ocid1.certificate.oc1.us-ashburn-1.amaaaaaaav3bgsaa5o2q7rh5nfmkkukfkogasqhk6af2opufhjlqg7m6jqzq]`
        :param pulumi.Input[builtins.str] certificate_name: (Updatable) A friendly name for the certificate bundle. It must be unique and it cannot be changed. Valid certificate bundle names include only alphanumeric characters, dashes, and underscores. Certificate bundle names cannot contain spaces. Avoid entering confidential information.  Example: `example_certificate_bundle`
        :param pulumi.Input[builtins.str] cipher_suite_name: (Updatable) The name of the cipher suite to use for HTTPS or SSL connections.
               ...
               *  The `oci-customized-ssl-cipher-suite` Oracle reserved cipher suite name is not accepted as valid input for this field.
               ...
               example: `example_cipher_suite`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] protocols: (Updatable) A list of SSL protocols the load balancer must support for HTTPS or SSL connections.
               ...
               *  For all existing load balancer listeners and backend sets that predate this feature, the `GET` operation displays a list of SSL protocols currently used by those resources.
               ...
               example: `["TLSv1.1", "TLSv1.2"]`
        :param pulumi.Input[builtins.str] server_order_preference: (Updatable) When this attribute is set to ENABLED, the system gives preference to the server ciphers over the client ciphers.
               
               **Note:** This configuration is applicable only when the load balancer is acting as an SSL/HTTPS server. This field is ignored when the `SSLConfiguration` object is associated with a backend set.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] trusted_certificate_authority_ids: (Updatable) Ids for Oracle Cloud Infrastructure certificates service CA or CA bundles for the load balancer to trust.  Example: `[ocid1.cabundle.oc1.us-ashburn-1.amaaaaaaav3bgsaagl4zzyqdop5i2vuwoqewdvauuw34llqa74otq2jdsfyq]`
        :param pulumi.Input[builtins.int] verify_depth: (Updatable) The maximum depth for peer certificate chain verification.  Example: `3`
        :param pulumi.Input[builtins.bool] verify_peer_certificate: (Updatable) Whether the load balancer listener should verify peer certificates.  Example: `true` 
    ...
    def cipher_suite_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The name of the cipher suite to use for HTTPS or SSL connections.
    ...
    def cipher_suite_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def server_order_preference(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) When this attribute is set to ENABLED, the system gives preference to the server ciphers over the client ciphers.
    ...
    def server_order_preference(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "server_order_preference", value)

    @property
    @pulumi.getter(name="trustedCertificateAuthorityIds")
    def trusted_certificate_authority_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        (Updatable) Ids for Oracle Cloud Infrastructure certificates service CA or CA bundles for the load balancer to trust.  Example: `[ocid1.cabundle.oc1.us-ashburn-1.amaaaaaaav3bgsaagl4zzyqdop5i2vuwoqewdvauuw34llqa74otq2jdsfyq]`
        """
    ...
    def trusted_certificate_authority_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "trusted_certificate_authority_ids", value)

    @property
    @pulumi.getter(name="verifyDepth")
    def verify_depth(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The maximum depth for peer certificate chain verification.  Example: `3`
        """
    ...
    @verify_depth.setter
    def verify_depth(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "verify_depth", value)

    @property
    @pulumi.getter(name="verifyPeerCertificate")
    def verify_peer_certificate(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) Whether the load balancer listener should verify peer certificates.  Example: `true` 
    ...
    def verify_peer_certificate(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "verify_peer_certificate", value)


if not MYPY:
    class ListenerConnectionConfigurationArgsDict(TypedDict):
        idle_timeout_in_seconds: pulumi.Input[builtins.str]
        """
        ...
        Example: `1200`
        """
        backend_tcp_proxy_protocol_options: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        (Updatable) An array that represents the PPV2 Options that can be enabled on TCP Listeners. Example: ["PP2_TYPE_AUTHORITY"]
        """
        backend_tcp_proxy_protocol_version: NotRequired[pulumi.Input[builtins.int]]
        """
...
class ListenerConnectionConfigurationArgs:
    def __init__(__self__, *,
                 idle_timeout_in_seconds: pulumi.Input[builtins.str],
                 backend_tcp_proxy_protocol_options: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 backend_tcp_proxy_protocol_version: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] idle_timeout_in_seconds: (Updatable) The maximum idle time, in seconds, allowed between two successive receive or two successive send operations between the client and backend servers. A send operation does not reset the timer for receive operations. A receive operation does not reset the timer for send operations.
               
               For more information, see [Connection Configuration](https://docs.cloud.oracle.com/iaas/Content/Balance/Reference/connectionreuse.htm#ConnectionConfiguration).
               
               Example: `1200`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] backend_tcp_proxy_protocol_options: (Updatable) An array that represents the PPV2 Options that can be enabled on TCP Listeners. Example: ["PP2_TYPE_AUTHORITY"]
        :param pulumi.Input[builtins.int] backend_tcp_proxy_protocol_version: (Updatable) The backend TCP Proxy Protocol version.  Example: `1`
        """
    ...
    def idle_timeout_in_seconds(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The maximum idle time, in seconds, allowed between two successive receive or two successive send operations between the client and backend servers. A send operation does not reset the timer for receive operations. A receive operation does not reset the timer for send operations.
    ...
    def idle_timeout_in_seconds(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "idle_timeout_in_seconds", value)

    @property
    @pulumi.getter(name="backendTcpProxyProtocolOptions")
    def backend_tcp_proxy_protocol_options(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        (Updatable) An array that represents the PPV2 Options that can be enabled on TCP Listeners. Example: ["PP2_TYPE_AUTHORITY"]
        """
    ...
    def backend_tcp_proxy_protocol_options(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "backend_tcp_proxy_protocol_options", value)

    @property
    @pulumi.getter(name="backendTcpProxyProtocolVersion")
    def backend_tcp_proxy_protocol_version(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The backend TCP Proxy Protocol version.  Example: `1`
        """
    ...
    def backend_tcp_proxy_protocol_version(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class ListenerSslConfigurationArgsDict(TypedDict):
        ...
        *  The `oci-customized-ssl-cipher-suite` Oracle reserved cipher suite name is not accepted as valid input for this field.
        ...
        example: `example_cipher_suite`
        """
        has_session_resumption: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class ListenerSslConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 certificate_name: Optional[pulumi.Input[builtins.str]] = None,
                 cipher_suite_name: Optional[pulumi.Input[builtins.str]] = None,
                 has_session_resumption: Optional[pulumi.Input[builtins.bool]] = None,
                 protocols: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 server_order_preference: Optional[pulumi.Input[builtins.str]] = None,
                 trusted_certificate_authority_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 verify_depth: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] cipher_suite_name: (Updatable) The name of the cipher suite to use for HTTPS or SSL connections.
               ...
               *  The `oci-customized-ssl-cipher-suite` Oracle reserved cipher suite name is not accepted as valid input for this field.
               ...
               example: `example_cipher_suite`
        :param pulumi.Input[builtins.bool] has_session_resumption: (Updatable) Whether the load balancer listener should resume an encrypted session by reusing the cryptographic parameters of a previous TLS session, without having to perform a full handshake again. If "true", the service resumes the previous TLS encrypted session. If "false", the service starts a new TLS encrypted session. Enabling session resumption improves performance but provides a lower level of security. Disabling session resumption improves security but reduces performance.  Example: `true`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] protocols: (Updatable) A list of SSL protocols the load balancer must support for HTTPS or SSL connections.
    ...
    def has_session_resumption(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) Whether the load balancer listener should resume an encrypted session by reusing the cryptographic parameters of a previous TLS session, without having to perform a full handshake again. If "true", the service resumes the previous TLS encrypted session. If "false", the service starts a new TLS encrypted session. Enabling session resumption improves performance but provides a lower level of security. Disabling session resumption improves security but reduces performance.  Example: `true`
        """
    ...
    def has_session_resumption(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class LoadBalancerIpAddressDetailReservedIpArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] id: Ocid of the Reserved IP/Public Ip created with VCN.
        """
        if id is not None:
...
class LoadBalancerRoutingPolicyRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] condition: (Updatable) A routing rule to evaluate defined conditions against the incoming HTTP request and perform an action.
        :param pulumi.Input[builtins.str] name: (Updatable) A unique name for the routing policy rule. Avoid entering confidential information. 
...
if not MYPY:
    class LoadBalancerRoutingPolicyRuleActionArgsDict(TypedDict):
        backend_set_name: pulumi.Input[builtins.str]
        """
...
class LoadBalancerRoutingPolicyRuleActionArgs:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] backend_set_name: (Updatable) Name of the backend set the listener will forward the traffic to.  Example: `backendSetForImages`
        :param pulumi.Input[builtins.str] name: (Updatable) The name can be one of these values: `FORWARD_TO_BACKENDSET`
        """
    ...
    def backend_set_name(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) Name of the backend set the listener will forward the traffic to.  Example: `backendSetForImages`
        """
    ...
    def backend_set_name(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class LoadBalancerShapeDetailsArgsDict(TypedDict):
        maximum_bandwidth_in_mbps: pulumi.Input[builtins.int]
        """
        ...
        Example: `1500`
        """
        minimum_bandwidth_in_mbps: pulumi.Input[builtins.int]
        """
...
class LoadBalancerShapeDetailsArgs:
    def __init__(__self__, *,
                 ...
                 minimum_bandwidth_in_mbps: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.int] maximum_bandwidth_in_mbps: (Updatable) Bandwidth in Mbps that determines the maximum bandwidth (ingress plus egress) that the load balancer can achieve. This bandwidth cannot be always guaranteed. For a guaranteed bandwidth use the minimumBandwidthInMbps parameter.
               
               The values must be between minimumBandwidthInMbps and 8000 (8Gbps).
               
               Example: `1500`
        :param pulumi.Input[builtins.int] minimum_bandwidth_in_mbps: (Updatable) Bandwidth in Mbps that determines the total pre-provisioned bandwidth (ingress plus egress). The values must be between 10 and the maximumBandwidthInMbps.  Example: `150`
        """
    ...
    def maximum_bandwidth_in_mbps(self) -> pulumi.Input[builtins.int]:
        """
        (Updatable) Bandwidth in Mbps that determines the maximum bandwidth (ingress plus egress) that the load balancer can achieve. This bandwidth cannot be always guaranteed. For a guaranteed bandwidth use the minimumBandwidthInMbps parameter.
    ...
    def maximum_bandwidth_in_mbps(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "maximum_bandwidth_in_mbps", value)

    @property
    @pulumi.getter(name="minimumBandwidthInMbps")
    def minimum_bandwidth_in_mbps(self) -> pulumi.Input[builtins.int]:
        """
        (Updatable) Bandwidth in Mbps that determines the total pre-provisioned bandwidth (ingress plus egress). The values must be between 10 and the maximumBandwidthInMbps.  Example: `150`
        """
    ...
    def minimum_bandwidth_in_mbps(self, value: pulumi.Input[builtins.int]):
...
class PathRouteSetPathRouteArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] backend_set_name: (Updatable) The name of the target backend set for requests where the incoming URI matches the specified path.  Example: `example_backend_set`
        :param pulumi.Input[builtins.str] path: (Updatable) The path string to match against the incoming URI path.
               *  Path strings are case-insensitive.
               *  Asterisk (*) wildcards are not supported.
               *  Regular expressions are not supported.
...
class PathRouteSetPathRoutePathMatchTypeArgs:
    def __init__(__self__, *,
                 match_type: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] match_type: (Updatable) Specifies how the load balancing service compares a [PathRoute](https://docs.cloud.oracle.com/iaas/api/#/en/loadbalancer/20170115/requests/PathRoute) object's `path` string against the incoming URI.
               *  **EXACT_MATCH** - Looks for a `path` string that exactly matches the incoming URI path.
               *  **FORCE_LONGEST_PREFIX_MATCH** - Looks for the `path` string with the best, longest match of the beginning portion of the incoming URI path.
               *  **PREFIX_MATCH** - Looks for a `path` string that matches the beginning portion of the incoming URI path.
               *  **SUFFIX_MATCH** - Looks for a `path` string that matches the ending portion of the incoming URI path.
...
if not MYPY:
    class RuleSetItemArgsDict(TypedDict):
        ...
        """
        are_invalid_characters_allowed: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        (Updatable)
        """
        default_max_connections: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        http_large_header_size_in_kb: NotRequired[pulumi.Input[builtins.int]]
        """
...
class RuleSetItemArgs:
    def __init__(__self__, *,
                 ...
                 are_invalid_characters_allowed: Optional[pulumi.Input[builtins.bool]] = None,
                 conditions: Optional[pulumi.Input[Sequence[pulumi.Input['RuleSetItemConditionArgs']]]] = None,
                 default_max_connections: Optional[pulumi.Input[builtins.int]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 header: Optional[pulumi.Input[builtins.str]] = None,
                 http_large_header_size_in_kb: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_methods: (Updatable) The list of HTTP methods allowed for this listener.
               ...
               Example: ["GET", "PUT", "POST", "PROPFIND"]
        :param pulumi.Input[builtins.bool] are_invalid_characters_allowed: (Updatable) Indicates whether or not invalid characters in client header fields will be allowed. Valid names are composed of English letters, digits, hyphens and underscores. If "true", invalid characters are allowed in the HTTP header. If "false", invalid characters are not allowed in the HTTP header
        :param pulumi.Input[Sequence[pulumi.Input['RuleSetItemConditionArgs']]] conditions: (Updatable)
        :param pulumi.Input[builtins.int] default_max_connections: (Updatable) The maximum number of connections that the any IP can make to a listener unless the IP is mentioned in maxConnections. If no defaultMaxConnections is specified the default is unlimited.
        :param pulumi.Input[builtins.str] description: (Updatable) A brief description of the access control rule. Avoid entering confidential information.
               
               example: `192.168.0.0/16 and 2001:db8::/32 are trusted clients. Whitelist them.`
        :param pulumi.Input[builtins.str] header: (Updatable) A header name that conforms to RFC 7230.  Example: `example_header_name`
        :param pulumi.Input[builtins.int] http_large_header_size_in_kb: (Updatable) The maximum size of each buffer used for reading http client request header. This value indicates the maximum size allowed for each buffer. The allowed values for buffer size are 8, 16, 32 and 64.
        ...
        :param pulumi.Input[builtins.str] prefix: (Updatable) A string to prepend to the header value. The resulting header value must still conform to RFC 7230. With the following exceptions:
               *  value cannot contain `$`
               *  value cannot contain patterns like `{variable_name}`. They are reserved for future extensions. Currently, such values are invalid.
        ...
        :param pulumi.Input['RuleSetItemRedirectUriArgs'] redirect_uri: (Updatable) An object that defines the redirect URI applied to the original request. The object property values compose the redirect URI.
               ...
               *  {query}    : The query string from the incoming HTTP request URI.
               ...
               `/example/video123{path}`
        :param pulumi.Input[builtins.int] response_code: (Updatable) The HTTP status code to return when the incoming request is redirected.
               ...
               *  308
               ...
               Example: `301`
        :param pulumi.Input[builtins.int] status_code: (Updatable) The HTTP status code to return when the requested HTTP method is not in the list of allowed methods. The associated status line returned with the code is mapped from the standard HTTP specification. The default value is `405 (Method Not Allowed)`.  Example: 403
        :param pulumi.Input[builtins.str] suffix: (Updatable) A string to append to the header value. The resulting header value must still conform to RFC 7230. With the following exceptions:
               *  value cannot contain `$`
               *  value cannot contain patterns like `{variable_name}`. They are reserved for future extensions. Currently, such values are invalid.
               
               Example: `example_suffix_value`
        :param pulumi.Input[builtins.str] value: (Updatable) A header value that conforms to RFC 7230. With the following exceptions:
               *  value cannot contain `$`
               *  value cannot contain patterns like `{variable_name}`. They are reserved for future extensions. Currently, such values are invalid.
    ...
    def are_invalid_characters_allowed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) Indicates whether or not invalid characters in client header fields will be allowed. Valid names are composed of English letters, digits, hyphens and underscores. If "true", invalid characters are allowed in the HTTP header. If "false", invalid characters are not allowed in the HTTP header
        """
    ...
    def are_invalid_characters_allowed(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def default_max_connections(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The maximum number of connections that the any IP can make to a listener unless the IP is mentioned in maxConnections. If no defaultMaxConnections is specified the default is unlimited.
        """
    ...
    def default_max_connections(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def http_large_header_size_in_kb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The maximum size of each buffer used for reading http client request header. This value indicates the maximum size allowed for each buffer. The allowed values for buffer size are 8, 16, 32 and 64.
        """
    ...
    def http_large_header_size_in_kb(self, value: Optional[pulumi.Input[builtins.int]]):
...
class RuleSetItemConditionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] attribute_name: (Updatable) The attribute_name can be one of these values: `PATH`, `SOURCE_IP_ADDRESS`, `SOURCE_VCN_ID`, `SOURCE_VCN_IP_ADDRESS`
        :param pulumi.Input[builtins.str] attribute_value: (Updatable) Depends on `attribute_name`:
               - when `attribute_name` = `SOURCE_IP_ADDRESS` | IPv4 or IPv6 address range to which the source IP address of incoming packet would be matched against
               - when `attribute_name` = `SOURCE_VCN_IP_ADDRESS` | IPv4 address range to which the original client IP address (in customer VCN) of incoming packet would be matched against
               - when `attribute_name` = `SOURCE_VCN_ID` | OCID of the customer VCN to which the service gateway embedded VCN ID of incoming packet would be matched against
        :param pulumi.Input[builtins.str] operator: (Updatable) A string that specifies how to compare the PathMatchCondition object's `attributeValue` string to the incoming URI.
               *  **EXACT_MATCH** - The incoming URI path must exactly and completely match the `attributeValue` string.
               *  **FORCE_LONGEST_PREFIX_MATCH** - The system looks for the `attributeValue` string with the best, longest match of the beginning portion of the incoming URI path.
               *  **PREFIX_MATCH** - The beginning portion of the incoming URI path must exactly match the `attributeValue` string.
               *  **SUFFIX_MATCH** - The ending portion of the incoming URI path must exactly match the `attributeValue` string.
...
class RuleSetItemIpMaxConnectionArgs:
    def __init__(__self__, *,
                 ...
                 max_connections: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] ip_addresses: (Updatable) Each element in the list should be valid IPv4 or IPv6 CIDR Block address. Example: '["129.213.176.0/24", "150.136.187.0/24", "2002::1234:abcd:ffff:c0a8:101/64"]'
        :param pulumi.Input[builtins.int] max_connections: (Updatable) The maximum number of simultaneous connections that the specified IPs can make to the Listener. IPs without a maxConnections setting can make either defaultMaxConnections simultaneous connections to a listener or, if no defaultMaxConnections is specified, an unlimited number of simultaneous connections to a listener.
        """
...
class RuleSetItemRedirectUriArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] host: (Updatable) The valid domain name (hostname) or IP address to use in the redirect URI.
               ...
               *  **in{host}** appears as `inexample.com` in the redirect URI if `example.com` is the hostname in the incoming HTTP request URI.
               *  **{port}{host}** appears as `8081example.com` in the redirect URI if `example.com` is the hostname and the port is `8081` in the incoming HTTP request URI.
        :param pulumi.Input[builtins.str] path: (Updatable) The HTTP URI path to use in the redirect URI.
               ...
               *  __/{host}/{port}__ appears as `/example.com/123` in the redirect URI if `example.com` is the hostname and `123` is the port in the incoming HTTP request URI.
               *  __/{query}__ appears as `/lang=en` in the redirect URI if the query is `lang=en` in the incoming HTTP request URI.
        :param pulumi.Input[builtins.int] port: (Updatable) The communication port to use in the redirect URI.
               ...
               Example: `8081`
        :param pulumi.Input[builtins.str] protocol: (Updatable) The HTTP protocol to use in the redirect URI.
               ...
               *  {protocol}
               ...
               Example: `HTTPS`
        :param pulumi.Input[builtins.str] query: (Updatable) The query string to use in the redirect URI.
...
class GetHostnamesFilterArgs:
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: A friendly name for the hostname resource. It must be unique and it cannot be changed. Avoid entering confidential information.  Example: `example_hostname_001`
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
...
class GetListenerRulesFilterArgs:
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: The name of the rule set that the rule belongs to.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
...
class GetLoadBalancerRoutingPoliciesFilterArgs:
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: A unique name for the routing policy rule. Avoid entering confidential information.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
...
class GetLoadBalancersFilterArgs:
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: A friendly name for the SSL cipher suite. It must be unique and it cannot be changed.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
...
class GetPathRouteSetsFilterArgs:
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: The unique name for this set of path route rules. Avoid entering confidential information.  Example: `example_path_route_set`
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
...
class GetPoliciesFilterArgs:
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: The name of a load balancing policy.  Example: 'LEAST_CONNECTIONS'
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
...
class GetProtocolsFilterArgs:
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: The name of a protocol.  Example: 'HTTP'
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
...
class GetRuleSetsFilterArgs:
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: The name for this set of rules. It must be unique and it cannot be changed. Avoid entering confidential information.  Example: `example_rule_set`
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
...
class GetShapesFilterArgs:
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: The name of the shape.  Example: `100Mbps`
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
