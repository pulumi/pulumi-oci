...
class BackendArgs:
    def __init__(__self__, *,
                 backendset_name: pulumi.Input[_builtins.str],
    ...
    def backendset_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def backendset_name(self, value: pulumi.Input[_builtins.str]):
...
class _BackendState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] max_connections: (Updatable) The maximum number of simultaneous connections the load balancer can make to the backend. If this is not set or set to 0 then the maximum number of simultaneous connections the load balancer can make to the backend is unlimited.
               ...
               Example: `300`
        :param pulumi.Input[_builtins.str] name: A read-only field showing the IP address and port that uniquely identify this backend server in the backend set.  Example: `10.0.0.3:8080`
        :param pulumi.Input[_builtins.bool] offline: (Updatable) Whether the load balancer should treat this server as offline. Offline servers receive no incoming traffic.  Example: `false`
        :param pulumi.Input[_builtins.int] port: The communication port for the backend server.  Example: `8080`
        :param pulumi.Input[_builtins.int] weight: (Updatable) The load balancing policy weight assigned to the server. Backend servers with a higher weight receive a larger proportion of incoming traffic. For example, a server weighted '3' receives 3 times the number of new connections as a server weighted '1'. For more information on load balancing policies, see [How Load Balancing Policies Work](https://docs.cloud.oracle.com/iaas/Content/Balance/Reference/lbpolicies.htm).  Example: `3` 
...
class Backend(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="backendsetName")
    def backendset_name(self) -> pulumi.Output[_builtins.str]:
        """
        The name of the backend set to add the backend server to.  Example: `example_backend_set`
        """
        return pulumi.get(self, "backendset_name")
    ...
    @_builtins.property
    @pulumi.getter
    def drain(self) -> pulumi.Output[_builtins.bool]:
        """
        (Updatable) Whether the load balancer should drain this server. Servers marked "drain" receive no new incoming traffic.  Example: `false`
        """
        return pulumi.get(self, "drain")
    ...
    @_builtins.property
    @pulumi.getter
    def offline(self) -> pulumi.Output[_builtins.bool]:
        """
        (Updatable) Whether the load balancer should treat this server as offline. Offline servers receive no incoming traffic.  Example: `false`
        """
        return pulumi.get(self, "offline")
