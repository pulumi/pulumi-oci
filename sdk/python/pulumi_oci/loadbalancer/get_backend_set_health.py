...
class GetBackendSetHealthResult:
    ...
    def critical_state_backend_names(self) -> Sequence[_builtins.str]:
        """
    ...
    def total_backend_count(self) -> _builtins.int:
        """
    ...
    def unknown_state_backend_names(self) -> Sequence[_builtins.str]:
        """
    ...
    def warning_state_backend_names(self) -> Sequence[_builtins.str]:
        """
...
def get_backend_set_health(backend_set_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str backend_set_name: The name of the backend set to retrieve the health status for.  Example: `example_backend_set`
    :param _builtins.str load_balancer_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the load balancer associated with the backend set health status to be retrieved.
    """
    __args__ = dict()
