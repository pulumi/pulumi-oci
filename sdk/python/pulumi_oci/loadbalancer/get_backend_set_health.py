...
class GetBackendSetHealthResult:
    ...
    def critical_state_backend_names(self) -> Sequence[builtins.str]:
        """
    ...
    def total_backend_count(self) -> builtins.int:
        """
    ...
    def unknown_state_backend_names(self) -> Sequence[builtins.str]:
        """
    ...
    def warning_state_backend_names(self) -> Sequence[builtins.str]:
        """
...
def get_backend_set_health(backend_set_name: Optional[builtins.str] = None,
    ...
    :param builtins.str backend_set_name: The name of the backend set to retrieve the health status for.  Example: `example_backend_set`
    :param builtins.str load_balancer_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the load balancer associated with the backend set health status to be retrieved.
    """
    __args__ = dict()
...
def get_backend_set_health_output(backend_set_name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:LoadBalancer/getBackendSetHealth:getBackendSetHealth', __args__, opts=opts, typ=GetBackendSetHealthResult)
