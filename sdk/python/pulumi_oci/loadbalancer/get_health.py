...
def get_health(load_balancer_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str load_balancer_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the load balancer to return health status for.
    """
    __args__ = dict()
...
def get_health_output(load_balancer_id: Optional[pulumi.Input[_builtins.str]] = None,
