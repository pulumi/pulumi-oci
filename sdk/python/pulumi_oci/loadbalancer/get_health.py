...
class GetHealthResult:
    ...
    def critical_state_backend_set_names(self) -> Sequence[builtins.str]:
        """
    ...
    def total_backend_set_count(self) -> builtins.int:
        """
    ...
    def unknown_state_backend_set_names(self) -> Sequence[builtins.str]:
        """
    ...
    def warning_state_backend_set_names(self) -> Sequence[builtins.str]:
        """
...
def get_health(load_balancer_id: Optional[builtins.str] = None,
    ...
    :param builtins.str load_balancer_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the load balancer to return health status for.
    """
    __args__ = dict()
...
def get_health_output(load_balancer_id: Optional[pulumi.Input[builtins.str]] = None,
