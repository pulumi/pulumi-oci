...
def get_listener_rules(filters: Optional[Sequence[Union['GetListenerRulesFilterArgs', 'GetListenerRulesFilterArgsDict']]] = None,
    ...
    *  Response header rules
    ...
    :param _builtins.str listener_name: The name of the listener the rules are associated with. Example: `example_listener`
    :param _builtins.str load_balancer_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the load balancer associated with the listener.
    """
    __args__ = dict()
