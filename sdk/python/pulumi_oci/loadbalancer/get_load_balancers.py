...
class GetLoadBalancersResult:
    ...
    @property
    @pulumi.getter
    def detail(self) -> Optional[builtins.str]:
...
def get_load_balancers(compartment_id: Optional[builtins.str] = None,
                       detail: Optional[builtins.str] = None,
    ...
    * `oci_load_balancers`
    ...
    :param builtins.str compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the load balancers to list.
    :param builtins.str detail: The level of detail to return for each result. Can be `full` or `simple`.  Example: `full`
    :param builtins.str display_name: A filter to return only resources that match the given display name exactly.  Example: `example_load_balancer`
...
def get_load_balancers_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                              detail: Optional[pulumi.Input[Optional[builtins.str]]] = None,
