...
def get_protocols(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the load balancer protocols to list.
    """
    __args__ = dict()
...
def get_protocols_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
