...
def get_rule_set(load_balancer_id: Optional[builtins.str] = None,
    ...
    :param builtins.str load_balancer_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the specified load balancer.
    :param builtins.str name: The name of the rule set to retrieve.  Example: `example_rule_set`
    """
    __args__ = dict()
...
def get_rule_set_output(load_balancer_id: Optional[pulumi.Input[builtins.str]] = None,
