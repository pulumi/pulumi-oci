...
def get_shapes(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the load balancer shapes to list.
    """
    __args__ = dict()
...
def get_shapes_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:LoadBalancer/getShapes:getShapes', __args__, opts=opts, typ=GetShapesResult)
