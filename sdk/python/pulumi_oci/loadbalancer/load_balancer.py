...
class LoadBalancerArgs:
    def __init__(__self__, *,
                 ...
                 is_delete_protection_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 is_private: pulumi.Input[Optional[_builtins.bool]] = None,
                 is_request_id_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 network_security_group_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 request_id_header: pulumi.Input[Optional[_builtins.str]] = None,
                 reserved_ips: pulumi.Input[Optional[Sequence[pulumi.Input['LoadBalancerReservedIpArgs']]]] = None,
                 security_attributes: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 shape_details: pulumi.Input[Optional['LoadBalancerShapeDetailsArgs']] = None):
        """
        The set of arguments for constructing a LoadBalancer resource.

        :param pulumi.Input[_builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which to create the load balancer.
        :param pulumi.Input[_builtins.str] display_name: (Updatable) A user-friendly name. It does not have to be unique, and it is changeable. Avoid entering confidential information.  Example: `example_load_balancer`
        ...
        :param pulumi.Input[_builtins.str] ip_mode: IPv6 is currently supported only in the Government Cloud. Whether the load balancer has an IPv4 or IPv6 IP address.
        ...
        :param pulumi.Input[_builtins.bool] is_delete_protection_enabled: (Updatable) Whether or not the load balancer has delete protection enabled.
        ...
        :param pulumi.Input[_builtins.bool] is_private: Whether the load balancer has a VCN-local (private) IP address.
               ...
               Example: `true`
        :param pulumi.Input[_builtins.bool] is_request_id_enabled: (Updatable) Whether or not the load balancer has the Request Id feature enabled for HTTP listeners.
               ...
               Example: `true`
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] network_security_group_ids: (Updatable) An array of NSG [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) associated with this load balancer.
        ...
        :param pulumi.Input[_builtins.str] request_id_header: (Updatable) If isRequestIdEnabled is true then this field contains the name of the header field that contains the unique request id that is attached to every request from the load balancer to the load balancer backends and to every response from the load balancer.
    ...
    def is_delete_protection_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def is_delete_protection_enabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def is_request_id_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
    ...
    def is_request_id_enabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def request_id_header(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def request_id_header(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "request_id_header", value)

    @_builtins.property
    @pulumi.getter(name="reservedIps")
    def reserved_ips(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['LoadBalancerReservedIpArgs']]]]:
        """
    ...
    @reserved_ips.setter
    def reserved_ips(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['LoadBalancerReservedIpArgs']]]]):
    ...
    def shape_details(self) -> pulumi.Input[Optional['LoadBalancerShapeDetailsArgs']]:
        """
    ...
    def shape_details(self, value: pulumi.Input[Optional['LoadBalancerShapeDetailsArgs']]):
...
class _LoadBalancerState:
    def __init__(__self__, *,
                 ...
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 ip_address_details: pulumi.Input[Optional[Sequence[pulumi.Input['LoadBalancerIpAddressDetailArgs']]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ip_addresses: An array of IP addresses. Deprecated: use ip_address_details instead
               *
        :param pulumi.Input[_builtins.str] ip_mode: IPv6 is currently supported only in the Government Cloud. Whether the load balancer has an IPv4 or IPv6 IP address.
        ...
        :param pulumi.Input[_builtins.str] time_created: The date and time the load balancer was created, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
        """
    ...
    def ip_address_details(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['LoadBalancerIpAddressDetailArgs']]]]:
        """
    ...
    def ip_address_details(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['LoadBalancerIpAddressDetailArgs']]]]):
...
class LoadBalancer(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 network_security_group_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 request_id_header: pulumi.Input[Optional[_builtins.str]] = None,
                 reserved_ips: pulumi.Input[Optional[Sequence[pulumi.Input[Union['LoadBalancerReservedIpArgs', 'LoadBalancerReservedIpArgsDict', 'outputs.LoadBalancerReservedIp']]]]] = None,
                 security_attributes: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 shape: pulumi.Input[Optional[_builtins.str]] = None,
                 shape_details: pulumi.Input[Optional[Union['LoadBalancerShapeDetailsArgs', 'LoadBalancerShapeDetailsArgsDict', 'outputs.LoadBalancerShapeDetails']]] = None,
                 subnet_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 __props__=None):
        """
        ...
        * `oci_load_balancer`
        ...
        :param pulumi.Input[_builtins.str] request_id_header: (Updatable) If isRequestIdEnabled is true then this field contains the name of the header field that contains the unique request id that is attached to every request from the load balancer to the load balancer backends and to every response from the load balancer.
               ...
               * Unless the header name is "" it must start with "X-" prefix.
               * Setting the header name to "" will set it to the default: X-Request-Id.
        :param pulumi.Input[Sequence[pulumi.Input[Union['LoadBalancerReservedIpArgs', 'LoadBalancerReservedIpArgsDict', 'outputs.LoadBalancerReservedIp']]]] reserved_ips: (Updatable) An array of reserved Ips. Pre-created public IP that will be used as the IP of this load balancer. This reserved IP will not be deleted when load balancer is deleted. This ip should not be already mapped to any other resource.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] security_attributes: (Updatable) Extended Defined tags for ZPR for this resource. Each key is predefined and scoped to a namespace.  Example: `{"Oracle-ZPR": {"MaxEgressCount": {"value":"42","mode":"audit", "usagetype" : "zpr"}}}`
        :param pulumi.Input[_builtins.str] shape: (Updatable) A template that determines the total pre-provisioned bandwidth (ingress plus egress). To get a list of available shapes, use the [ListShapes](https://docs.cloud.oracle.com/iaas/api/#/en/loadbalancer/20170115/LoadBalancerShape/ListShapes) operation.  Example: `flexible` NOTE: After May 2023, Fixed shapes - 10Mbps, 100Mbps, 400Mbps, 8000Mbps would be deprecated and only shape allowed would be `Flexible` *Note: When updating shape for a load balancer, all existing connections to the load balancer will be reset during the update process. Also `10Mbps-Micro` shape cannot be updated to any other shape nor can any other shape be updated to `10Mbps-Micro`.
        :param pulumi.Input[Union['LoadBalancerShapeDetailsArgs', 'LoadBalancerShapeDetailsArgsDict', 'outputs.LoadBalancerShapeDetails']] shape_details: (Updatable) The configuration details to create load balancer using Flexible shape. This is required only if shapeName is `Flexible`.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] subnet_ids: An array of subnet [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    ...
    def get(resource_name: str,
            ...
            display_name: pulumi.Input[Optional[_builtins.str]] = None,
            freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            ip_address_details: pulumi.Input[Optional[Sequence[pulumi.Input[Union['LoadBalancerIpAddressDetailArgs', 'LoadBalancerIpAddressDetailArgsDict', 'outputs.LoadBalancerIpAddressDetail']]]]] = None,
            ip_addresses: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            ip_mode: pulumi.Input[Optional[_builtins.str]] = None,
            ipv6subnet_cidr: pulumi.Input[Optional[_builtins.str]] = None,
            is_delete_protection_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
            ...
            subnet_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None) -> 'LoadBalancer':
        """
        ...
        :param pulumi.Input[_builtins.str] display_name: (Updatable) A user-friendly name. It does not have to be unique, and it is changeable. Avoid entering confidential information.  Example: `example_load_balancer`
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[Sequence[pulumi.Input[Union['LoadBalancerIpAddressDetailArgs', 'LoadBalancerIpAddressDetailArgsDict', 'outputs.LoadBalancerIpAddressDetail']]]] ip_address_details: An array of IP addresses.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] ip_addresses: An array of IP addresses. Deprecated: use ip_address_details instead
               *
        :param pulumi.Input[_builtins.str] ip_mode: IPv6 is currently supported only in the Government Cloud. Whether the load balancer has an IPv4 or IPv6 IP address.
    ...
    @_builtins.property
    @pulumi.getter(name="isDeleteProtectionEnabled")
    def is_delete_protection_enabled(self) -> pulumi.Output[_builtins.bool]:
        """
        (Updatable) Whether or not the load balancer has delete protection enabled.
    ...
    @_builtins.property
    @pulumi.getter(name="isRequestIdEnabled")
    def is_request_id_enabled(self) -> pulumi.Output[_builtins.bool]:
        """
        (Updatable) Whether or not the load balancer has the Request Id feature enabled for HTTP listeners.
    ...
    @_builtins.property
    @pulumi.getter(name="requestIdHeader")
    def request_id_header(self) -> pulumi.Output[_builtins.str]:
        """
        (Updatable) If isRequestIdEnabled is true then this field contains the name of the header field that contains the unique request id that is attached to every request from the load balancer to the load balancer backends and to every response from the load balancer.
