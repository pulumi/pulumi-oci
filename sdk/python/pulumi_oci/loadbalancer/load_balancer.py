...
class LoadBalancerArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which to create the load balancer.
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name. It does not have to be unique, and it is changeable. Avoid entering confidential information.  Example: `example_load_balancer`
        ...
        :param pulumi.Input[builtins.bool] is_private: Whether the load balancer has a VCN-local (private) IP address.
               ...
               Example: `true`
        :param pulumi.Input[builtins.bool] is_request_id_enabled: (Updatable) Whether or not the load balancer has the Request Id feature enabled for HTTP listeners.
               ...
               Example: `true`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] network_security_group_ids: (Updatable) An array of NSG [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) associated with this load balancer.
        ...
        :param pulumi.Input[builtins.str] request_id_header: (Updatable) If isRequestIdEnabled is true then this field contains the name of the header field that contains the unique request id that is attached to every request from the load balancer to the load balancer backends and to every response from the load balancer.
    ...
    def ip_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def is_delete_protection_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def is_request_id_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_request_id_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def request_id_header(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def request_id_header(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _LoadBalancerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the load balancer was created, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
        """
...
class LoadBalancer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            subnet_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'LoadBalancer':
        """
    ...
    @property
    @pulumi.getter(name="ipMode")
    def ip_mode(self) -> pulumi.Output[builtins.str]:
        """
        IPv6 is currently supported only in the Government Cloud. Whether the load balancer has an IPv4 or IPv6 IP address.
    ...
    @property
    @pulumi.getter(name="isRequestIdEnabled")
    def is_request_id_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Whether or not the load balancer has the Request Id feature enabled for HTTP listeners.
    ...
    @property
    @pulumi.getter(name="requestIdHeader")
    def request_id_header(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) If isRequestIdEnabled is true then this field contains the name of the header field that contains the unique request id that is attached to every request from the load balancer to the load balancer backends and to every response from the load balancer.
