...
class LoadBalancerRoutingPolicyArgs:
    def __init__(__self__, *,
                 condition_language_version: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] condition_language_version: (Updatable) The version of the language in which `condition` of `rules` are composed.
        :param pulumi.Input[builtins.str] load_balancer_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the load balancer to add the routing policy rule list to.
        :param pulumi.Input[Sequence[pulumi.Input['LoadBalancerRoutingPolicyRuleArgs']]] rules: (Updatable) The list of routing rules.
        :param pulumi.Input[builtins.str] name: The name for this list of routing rules. It must be unique and it cannot be changed. Avoid entering confidential information.  Example: `example_routing_rules`
        """
    ...
    def condition_language_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def condition_language_version(self, value: pulumi.Input[builtins.str]):
...
class _LoadBalancerRoutingPolicyState:
    def __init__(__self__, *,
                 condition_language_version: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="conditionLanguageVersion")
    def condition_language_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The version of the language in which `condition` of `rules` are composed.
        """
        return pulumi.get(self, "condition_language_version")
    ...
    @condition_language_version.setter
    def condition_language_version(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "condition_language_version", value)
...
@pulumi.type_token("oci:LoadBalancer/loadBalancerRoutingPolicy:LoadBalancerRoutingPolicy")
class LoadBalancerRoutingPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            name: Optional[pulumi.Input[builtins.str]] = None,
            rules: Optional[pulumi.Input[Sequence[pulumi.Input[Union['LoadBalancerRoutingPolicyRuleArgs', 'LoadBalancerRoutingPolicyRuleArgsDict']]]]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None) -> 'LoadBalancerRoutingPolicy':
        """
    ...
    @property
    @pulumi.getter(name="conditionLanguageVersion")
    def condition_language_version(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The version of the language in which `condition` of `rules` are composed.
        """
        return pulumi.get(self, "condition_language_version")
