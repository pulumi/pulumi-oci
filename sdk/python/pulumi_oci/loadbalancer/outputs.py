...
class BackendSetBackend(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.bool backup: (Updatable) Whether the load balancer should treat this server as a backup unit. If `true`, the load balancer forwards no ingress traffic to this backend server unless all other backend servers not marked as "backup" fail the health check policy.
        ...
        :param builtins.bool offline: (Updatable) Whether the load balancer should treat this server as offline. Offline servers receive no incoming traffic.  Example: `false`
...
class BackendSetHealthChecker(dict):
    ...
    def __init__(__self__, *,
                 ...
                 interval_ms: Optional[builtins.int] = None,
                 is_force_plain_text: Optional[builtins.bool] = None,
        ...
        """
        :param builtins.str protocol: (Updatable) The protocol the health check must use; either HTTP or TCP.  Example: `HTTP`
        :param builtins.int interval_ms: (Updatable) The interval between health checks, in milliseconds.  Example: `10000`
        :param builtins.bool is_force_plain_text: (Updatable) Specifies if health checks should always be done using plain text instead of depending on whether or not the associated backend set is using SSL.
               ...
               Example: `false`
        :param builtins.int port: (Updatable) The backend server port against which to run the health check. If the port is not specified, the load balancer uses the port information from the `Backend` object.  Example: `8080`
        ...
        :param builtins.int retries: (Updatable) The number of retries to attempt before a backend server is considered "unhealthy". This number also applies when recovering a server to the "healthy" state.  Example: `3`
        :param builtins.int return_code: (Updatable) The status code a healthy backend server should return.  Example: `200`
        :param builtins.int timeout_in_millis: (Updatable) The maximum time, in milliseconds, to wait for a reply to a health check. A health check is successful only if a reply returns within this timeout period.  Example: `3000`
    ...
    def interval_ms(self) -> Optional[builtins.int]:
        """
    ...
    def is_force_plain_text(self) -> Optional[builtins.bool]:
        """
...
class BackendSetLbCookieSessionPersistenceConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disable_fallback: Optional[builtins.bool] = None,
                 domain: Optional[builtins.str] = None,
                 is_http_only: Optional[builtins.bool] = None,
                 is_secure: Optional[builtins.bool] = None,
                 max_age_in_seconds: Optional[builtins.int] = None,
                 path: Optional[builtins.str] = None):
        """
        :param builtins.str cookie_name: (Updatable) The name of the cookie inserted by the load balancer. If this field is not configured, the cookie name defaults to "X-Oracle-BMC-LBS-Route".  Example: `example_cookie`
        ...
        :param builtins.bool disable_fallback: (Updatable) Whether the load balancer is prevented from directing traffic from a persistent session client to a different backend server if the original server is unavailable. Defaults to false.  Example: `false`
        :param builtins.str domain: (Updatable) The domain in which the cookie is valid. The `Set-cookie` header inserted by the load balancer contains a domain attribute with the specified value.
               ...
               *  Ensure that this attribute specifies the correct domain value. If the `Domain` attribute in the `Set-cookie` header does not include the domain to which the original request was made, the client or browser might reject the cookie. As specified in RFC 6265, the client accepts a cookie with the `Domain` attribute value `example.com` or `www.example.com` sent from `www.example.com`. It does not accept a cookie with the `Domain` attribute `abc.example.com` or `www.abc.example.com` sent from `www.example.com`.
               ...
               Example: `example.com`
        :param builtins.bool is_http_only: (Updatable) Whether the `Set-cookie` header should contain the `HttpOnly` attribute. If `true`, the `Set-cookie` header inserted by the load balancer contains the `HttpOnly` attribute, which limits the scope of the cookie to HTTP requests. This attribute directs the client or browser to omit the cookie when providing access to cookies through non-HTTP APIs. For example, it restricts the cookie from JavaScript channels.  Example: `true`
        :param builtins.bool is_secure: (Updatable) Whether the `Set-cookie` header should contain the `Secure` attribute. If `true`, the `Set-cookie` header inserted by the load balancer contains the `Secure` attribute, which directs the client or browser to send the cookie only using a secure protocol.
               
               **Note:** If you set this field to `true`, you cannot associate the corresponding backend set with an HTTP listener.
               
               Example: `true`
        :param builtins.int max_age_in_seconds: (Updatable) The amount of time the cookie remains valid. The `Set-cookie` header inserted by the load balancer contains a `Max-Age` attribute with the specified value.
               ...
               Example: `3600`
        :param builtins.str path: (Updatable) The path in which the cookie is valid. The `Set-cookie header` inserted by the load balancer contains a `Path` attribute with the specified value.
    ...
    def disable_fallback(self) -> Optional[builtins.bool]:
        """
    ...
    def is_http_only(self) -> Optional[builtins.bool]:
        """
    ...
    def is_secure(self) -> Optional[builtins.bool]:
        """
...
class BackendSetSessionPersistenceConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 disable_fallback: Optional[builtins.bool] = None):
        """
        :param builtins.str cookie_name: (Updatable) The name of the cookie used to detect a session initiated by the backend server. Use '*' to specify that any cookie set by the backend causes the session to persist.  Example: `example_cookie`
        :param builtins.bool disable_fallback: (Updatable) Whether the load balancer is prevented from directing traffic from a persistent session client to a different backend server if the original server is unavailable. Defaults to false.  Example: `false`
        """
        pulumi.set(__self__, "cookie_name", cookie_name)
        if disable_fallback is not None:
...
class BackendSetSslConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cipher_suite_name: Optional[builtins.str] = None,
                 protocols: Optional[Sequence[builtins.str]] = None,
                 server_order_preference: Optional[builtins.str] = None,
                 trusted_certificate_authority_ids: Optional[Sequence[builtins.str]] = None,
                 verify_depth: Optional[builtins.int] = None,
                 verify_peer_certificate: Optional[builtins.bool] = None):
        """
        :param Sequence[builtins.str] certificate_ids: (Updatable) Ids for Oracle Cloud Infrastructure certificates service certificates. Currently only a single Id may be passed.  Example: `[ocid1.certificate.oc1.us-ashburn-1.amaaaaaaav3bgsaa5o2q7rh5nfmkkukfkogasqhk6af2opufhjlqg7m6jqzq]`
        :param builtins.str certificate_name: (Updatable) A friendly name for the certificate bundle. It must be unique and it cannot be changed. Valid certificate bundle names include only alphanumeric characters, dashes, and underscores. Certificate bundle names cannot contain spaces. Avoid entering confidential information.  Example: `example_certificate_bundle`
        :param builtins.str cipher_suite_name: (Updatable) The name of the cipher suite to use for HTTPS or SSL connections.
        ...
        :param Sequence[builtins.str] protocols: (Updatable) A list of SSL protocols the load balancer must support for HTTPS or SSL connections.
        ...
        :param builtins.str server_order_preference: (Updatable) When this attribute is set to ENABLED, the system gives preference to the server ciphers over the client ciphers.
        ...
        :param Sequence[builtins.str] trusted_certificate_authority_ids: (Updatable) Ids for Oracle Cloud Infrastructure certificates service CA or CA bundles for the load balancer to trust.  Example: `[ocid1.cabundle.oc1.us-ashburn-1.amaaaaaaav3bgsaagl4zzyqdop5i2vuwoqewdvauuw34llqa74otq2jdsfyq]`
        :param builtins.int verify_depth: (Updatable) The maximum depth for peer certificate chain verification.  Example: `3`
        :param builtins.bool verify_peer_certificate: (Updatable) Whether the load balancer listener should verify peer certificates.  Example: `true` 
    ...
    def cipher_suite_name(self) -> Optional[builtins.str]:
        """
    ...
    def server_order_preference(self) -> Optional[builtins.str]:
        """
    ...
    def trusted_certificate_authority_ids(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def verify_depth(self) -> Optional[builtins.int]:
        """
    ...
    def verify_peer_certificate(self) -> Optional[builtins.bool]:
        """
...
class ListenerConnectionConfiguration(dict):
    ...
    def __init__(__self__, *,
                 idle_timeout_in_seconds: builtins.str,
                 backend_tcp_proxy_protocol_options: Optional[Sequence[builtins.str]] = None,
                 backend_tcp_proxy_protocol_version: Optional[builtins.int] = None):
        """
        :param builtins.str idle_timeout_in_seconds: (Updatable) The maximum idle time, in seconds, allowed between two successive receive or two successive send operations between the client and backend servers. A send operation does not reset the timer for receive operations. A receive operation does not reset the timer for send operations.
               ...
               Example: `1200`
        :param Sequence[builtins.str] backend_tcp_proxy_protocol_options: (Updatable) An array that represents the PPV2 Options that can be enabled on TCP Listeners. Example: ["PP2_TYPE_AUTHORITY"]
        :param builtins.int backend_tcp_proxy_protocol_version: (Updatable) The backend TCP Proxy Protocol version.  Example: `1`
        """
    ...
    def idle_timeout_in_seconds(self) -> builtins.str:
        """
    ...
    def backend_tcp_proxy_protocol_options(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def backend_tcp_proxy_protocol_version(self) -> Optional[builtins.int]:
        """
...
class ListenerSslConfiguration(dict):
    ...
    def __init__(__self__, *,
                 ...
                 certificate_name: Optional[builtins.str] = None,
                 cipher_suite_name: Optional[builtins.str] = None,
                 has_session_resumption: Optional[builtins.bool] = None,
                 protocols: Optional[Sequence[builtins.str]] = None,
                 server_order_preference: Optional[builtins.str] = None,
                 trusted_certificate_authority_ids: Optional[Sequence[builtins.str]] = None,
                 verify_depth: Optional[builtins.int] = None,
    ...
    def has_session_resumption(self) -> Optional[builtins.bool]:
        """
...
class LoadBalancerIpAddressDetailReservedIp(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: Ocid of the Reserved IP/Public Ip created with VCN.
        """
        if id is not None:
...
class LoadBalancerRoutingPolicyRule(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str condition: (Updatable) A routing rule to evaluate defined conditions against the incoming HTTP request and perform an action.
        :param builtins.str name: (Updatable) A unique name for the routing policy rule. Avoid entering confidential information. 
...
class LoadBalancerRoutingPolicyRuleAction(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str backend_set_name: (Updatable) Name of the backend set the listener will forward the traffic to.  Example: `backendSetForImages`
        :param builtins.str name: (Updatable) The name can be one of these values: `FORWARD_TO_BACKENDSET`
        """
...
class LoadBalancerShapeDetails(dict):
    ...
    def __init__(__self__, *,
                 maximum_bandwidth_in_mbps: builtins.int,
                 minimum_bandwidth_in_mbps: builtins.int):
        """
        :param builtins.int maximum_bandwidth_in_mbps: (Updatable) Bandwidth in Mbps that determines the maximum bandwidth (ingress plus egress) that the load balancer can achieve. This bandwidth cannot be always guaranteed. For a guaranteed bandwidth use the minimumBandwidthInMbps parameter.
               
               The values must be between minimumBandwidthInMbps and 8000 (8Gbps).
               
               Example: `1500`
        :param builtins.int minimum_bandwidth_in_mbps: (Updatable) Bandwidth in Mbps that determines the total pre-provisioned bandwidth (ingress plus egress). The values must be between 10 and the maximumBandwidthInMbps.  Example: `150`
        """
    ...
    def maximum_bandwidth_in_mbps(self) -> builtins.int:
        """
    ...
    def minimum_bandwidth_in_mbps(self) -> builtins.int:
        """
...
class PathRouteSetPathRoute(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str backend_set_name: (Updatable) The name of the target backend set for requests where the incoming URI matches the specified path.  Example: `example_backend_set`
        :param builtins.str path: (Updatable) The path string to match against the incoming URI path.
...
class PathRouteSetPathRoutePathMatchType(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str match_type: (Updatable) Specifies how the load balancing service compares a [PathRoute](https://docs.cloud.oracle.com/iaas/api/#/en/loadbalancer/20170115/requests/PathRoute) object's `path` string against the incoming URI.
...
class RuleSetItem(dict):
    ...
    def __init__(__self__, *,
                 ...
                 are_invalid_characters_allowed: Optional[builtins.bool] = None,
                 conditions: Optional[Sequence['outputs.RuleSetItemCondition']] = None,
                 default_max_connections: Optional[builtins.int] = None,
                 description: Optional[builtins.str] = None,
                 header: Optional[builtins.str] = None,
                 http_large_header_size_in_kb: Optional[builtins.int] = None,
        ...
        :param Sequence[builtins.str] allowed_methods: (Updatable) The list of HTTP methods allowed for this listener.
        ...
        :param builtins.bool are_invalid_characters_allowed: (Updatable) Indicates whether or not invalid characters in client header fields will be allowed. Valid names are composed of English letters, digits, hyphens and underscores. If "true", invalid characters are allowed in the HTTP header. If "false", invalid characters are not allowed in the HTTP header
        :param Sequence['RuleSetItemConditionArgs'] conditions: (Updatable)
        :param builtins.int default_max_connections: (Updatable) The maximum number of connections that the any IP can make to a listener unless the IP is mentioned in maxConnections. If no defaultMaxConnections is specified the default is unlimited.
        :param builtins.str description: (Updatable) A brief description of the access control rule. Avoid entering confidential information.
               
               example: `192.168.0.0/16 and 2001:db8::/32 are trusted clients. Whitelist them.`
        :param builtins.str header: (Updatable) A header name that conforms to RFC 7230.  Example: `example_header_name`
        :param builtins.int http_large_header_size_in_kb: (Updatable) The maximum size of each buffer used for reading http client request header. This value indicates the maximum size allowed for each buffer. The allowed values for buffer size are 8, 16, 32 and 64.
        ...
        :param builtins.str prefix: (Updatable) A string to prepend to the header value. The resulting header value must still conform to RFC 7230. With the following exceptions:
        ...
        :param builtins.int response_code: (Updatable) The HTTP status code to return when the incoming request is redirected.
               ...
               *  308
               ...
               Example: `301`
        :param builtins.int status_code: (Updatable) The HTTP status code to return when the requested HTTP method is not in the list of allowed methods. The associated status line returned with the code is mapped from the standard HTTP specification. The default value is `405 (Method Not Allowed)`.  Example: 403
        :param builtins.str suffix: (Updatable) A string to append to the header value. The resulting header value must still conform to RFC 7230. With the following exceptions:
               *  value cannot contain `$`
               *  value cannot contain patterns like `{variable_name}`. They are reserved for future extensions. Currently, such values are invalid.
               
               Example: `example_suffix_value`
        :param builtins.str value: (Updatable) A header value that conforms to RFC 7230. With the following exceptions:
               *  value cannot contain `$`
               *  value cannot contain patterns like `{variable_name}`. They are reserved for future extensions. Currently, such values are invalid.
    ...
    def are_invalid_characters_allowed(self) -> Optional[builtins.bool]:
        """
    ...
    def default_max_connections(self) -> Optional[builtins.int]:
        """
    ...
    def http_large_header_size_in_kb(self) -> Optional[builtins.int]:
        """
...
class RuleSetItemCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str attribute_name: (Updatable) The attribute_name can be one of these values: `PATH`, `SOURCE_IP_ADDRESS`, `SOURCE_VCN_ID`, `SOURCE_VCN_IP_ADDRESS`
        :param builtins.str attribute_value: (Updatable) Depends on `attribute_name`:
        ...
        :param builtins.str operator: (Updatable) A string that specifies how to compare the PathMatchCondition object's `attributeValue` string to the incoming URI.
...
class RuleSetItemRedirectUri(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str host: (Updatable) The valid domain name (hostname) or IP address to use in the redirect URI.
        ...
        :param builtins.str path: (Updatable) The HTTP URI path to use in the redirect URI.
        ...
        :param builtins.int port: (Updatable) The communication port to use in the redirect URI.
               ...
               Example: `8081`
        :param builtins.str protocol: (Updatable) The HTTP protocol to use in the redirect URI.
               ...
               *  {protocol}
               ...
               Example: `HTTPS`
        :param builtins.str query: (Updatable) The query string to use in the redirect URI.
...
class GetBackendHealthHealthCheckResultResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str source_ip_address: The IP address of the health check status report provider. This identifier helps you differentiate same-subnet load balancers that report health check status.  Example: `10.0.0.7`
        :param builtins.str subnet_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet hosting the load balancer that reported this health check status.
        :param builtins.str timestamp: The date and time the data was retrieved, in the format defined by RFC3339.  Example: `2017-06-02T18:28:11+00:00`
        """
...
class GetBackendSetsBackendsetResult(dict):
    def __init__(__self__, *,
                 backend_max_connections: builtins.int,
        ...
        :param builtins.str name: A friendly name for the backend set. It must be unique and it cannot be changed.
        :param builtins.str policy: The load balancer policy for the backend set. To get a list of available policies, use the [ListPolicies](https://docs.cloud.oracle.com/iaas/api/#/en/loadbalancer/20170115/LoadBalancerPolicy/ListPolicies) operation.  Example: `LEAST_CONNECTIONS`
...
class GetBackendSetsBackendsetBackendResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.int weight: The load balancing policy weight assigned to the server. Backend servers with a higher weight receive a larger proportion of incoming traffic. For example, a server weighted '3' receives 3 times the number of new connections as a server weighted '1'. For more information on load balancing policies, see [How Load Balancing Policies Work](https://docs.cloud.oracle.com/iaas/Content/Balance/Reference/lbpolicies.htm).  Example: `3`
        """
        pulumi.set(__self__, "backup", backup)
        pulumi.set(__self__, "drain", drain)
        pulumi.set(__self__, "ip_address", ip_address)
...
class GetBackendSetsBackendsetHealthCheckerResult(dict):
    def __init__(__self__, *,
                 ...
                 is_force_plain_text: builtins.bool,
                 port: builtins.int,
                 protocol: builtins.str,
        ...
        """
        :param builtins.int interval_ms: The interval between health checks, in milliseconds. The default is 10000 (10 seconds).  Example: `10000`
        :param builtins.bool is_force_plain_text: Specifies if health checks should always be done using plain text instead of depending on whether or not the associated backend set is using SSL.
        :param builtins.int port: The backend server port against which to run the health check. If the port is not specified, the load balancer uses the port information from the `Backend` object.  Example: `8080`
        :param builtins.str protocol: The protocol the health check must use; either HTTP or TCP.  Example: `HTTP`
        ...
        :param builtins.int retries: The number of retries to attempt before a backend server is considered "unhealthy". This number also applies when recovering a server to the "healthy" state. Defaults to 3.  Example: `3`
        :param builtins.int return_code: The status code a healthy backend server should return. If you configure the health check policy to use the HTTP protocol, you can use common HTTP status codes such as "200".  Example: `200`
        :param builtins.int timeout_in_millis: The maximum time, in milliseconds, to wait for a reply to a health check. A health check is successful only if a reply returns within this timeout period. Defaults to 3000 (3 seconds).  Example: `3000`
    ...
    @property
    @pulumi.getter(name="isForcePlainText")
    def is_force_plain_text(self) -> builtins.bool:
        """
...
class GetBackendSetsBackendsetLbCookieSessionPersistenceConfigurationResult(dict):
    def __init__(__self__, *,
                 cookie_name: builtins.str,
                 disable_fallback: builtins.bool,
                 domain: builtins.str,
                 is_http_only: builtins.bool,
                 is_secure: builtins.bool,
                 max_age_in_seconds: builtins.int,
                 path: builtins.str):
        """
        :param builtins.str cookie_name: The name of the cookie used to detect a session initiated by the backend server. Use '*' to specify that any cookie set by the backend causes the session to persist.  Example: `example_cookie`
        :param builtins.bool disable_fallback: Whether the load balancer is prevented from directing traffic from a persistent session client to a different backend server if the original server is unavailable. Defaults to false.  Example: `false`
        :param builtins.str domain: The domain in which the cookie is valid. The `Set-cookie` header inserted by the load balancer contains a domain attribute with the specified value.
        :param builtins.bool is_http_only: Whether the `Set-cookie` header should contain the `HttpOnly` attribute. If `true`, the `Set-cookie` header inserted by the load balancer contains the `HttpOnly` attribute, which limits the scope of the cookie to HTTP requests. This attribute directs the client or browser to omit the cookie when providing access to cookies through non-HTTP APIs. For example, it restricts the cookie from JavaScript channels.  Example: `true`
        :param builtins.bool is_secure: Whether the `Set-cookie` header should contain the `Secure` attribute. If `true`, the `Set-cookie` header inserted by the load balancer contains the `Secure` attribute, which directs the client or browser to send the cookie only using a secure protocol.
        :param builtins.int max_age_in_seconds: The amount of time the cookie remains valid. The `Set-cookie` header inserted by the load balancer contains a `Max-Age` attribute with the specified value.
        :param builtins.str path: The path in which the cookie is valid. The `Set-cookie header` inserted by the load balancer contains a `Path` attribute with the specified value.
        """
        pulumi.set(__self__, "cookie_name", cookie_name)
        pulumi.set(__self__, "disable_fallback", disable_fallback)
        pulumi.set(__self__, "domain", domain)
    ...
    @property
    @pulumi.getter(name="disableFallback")
    def disable_fallback(self) -> builtins.bool:
        """
...
class GetBackendSetsBackendsetSslConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 cipher_suite_name: builtins.str,
                 protocols: Sequence[builtins.str],
                 server_order_preference: builtins.str,
                 trusted_certificate_authority_ids: Sequence[builtins.str],
                 verify_depth: builtins.int,
                 verify_peer_certificate: builtins.bool):
        """
        :param Sequence[builtins.str] certificate_ids: Ids for Oracle Cloud Infrastructure certificates service certificates. Currently only a single Id may be passed.  Example: `[ocid1.certificate.oc1.us-ashburn-1.amaaaaaaav3bgsaa5o2q7rh5nfmkkukfkogasqhk6af2opufhjlqg7m6jqzq]`
        :param builtins.str certificate_name: A friendly name for the certificate bundle. It must be unique and it cannot be changed. Valid certificate bundle names include only alphanumeric characters, dashes, and underscores. Certificate bundle names cannot contain spaces. Avoid entering confidential information.  Example: `example_certificate_bundle`
        :param builtins.str cipher_suite_name: The name of the cipher suite to use for HTTPS or SSL connections.
        :param Sequence[builtins.str] protocols: A list of SSL protocols the load balancer must support for HTTPS or SSL connections.
        :param builtins.str server_order_preference: When this attribute is set to ENABLED, the system gives preference to the server ciphers over the client ciphers.
        :param Sequence[builtins.str] trusted_certificate_authority_ids: Ids for Oracle Cloud Infrastructure certificates service CA or CA bundles for the load balancer to trust.  Example: `[ocid1.cabundle.oc1.us-ashburn-1.amaaaaaaav3bgsaagl4zzyqdop5i2vuwoqewdvauuw34llqa74otq2jdsfyq]`
        :param builtins.int verify_depth: The maximum depth for peer certificate chain verification.  Example: `3`
        :param builtins.bool verify_peer_certificate: Whether the load balancer listener should verify peer certificates.  Example: `true`
        """
        pulumi.set(__self__, "certificate_ids", certificate_ids)
        pulumi.set(__self__, "certificate_name", certificate_name)
        pulumi.set(__self__, "cipher_suite_name", cipher_suite_name)
    ...
    @property
    @pulumi.getter(name="cipherSuiteName")
    def cipher_suite_name(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="trustedCertificateAuthorityIds")
    def trusted_certificate_authority_ids(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="verifyDepth")
    def verify_depth(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="verifyPeerCertificate")
    def verify_peer_certificate(self) -> builtins.bool:
        """
...
class GetBackendsBackendResult(dict):
    def __init__(__self__, *,
                 ...
                 backup: Optional[builtins.bool] = None):
        """
        :param builtins.str backendset_name: The name of the backend set associated with the backend servers.  Example: `example_backend_set`
        :param builtins.bool drain: Whether the load balancer should drain this server. Servers marked "drain" receive no new incoming traffic.  Example: `false`
        :param builtins.str ip_address: The IP address of the backend server.  Example: `10.0.0.3`
    ...
    @property
    @pulumi.getter(name="backendsetName")
    def backendset_name(self) -> builtins.str:
        """
...
class GetCertificatesCertificateResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str ca_certificate: The Certificate Authority certificate, or any interim certificate, that you received from your SSL certificate provider.
        :param builtins.str certificate_name: A friendly name for the certificate bundle. It must be unique and it cannot be changed. Valid certificate bundle names include only alphanumeric characters, dashes, and underscores. Certificate bundle names cannot contain spaces. Avoid entering confidential information.  Example: `example_certificate_bundle`
        ...
        :param builtins.str public_certificate: The public certificate, in PEM format, that you received from your SSL certificate provider.
        """
...
class GetHostnamesHostnameResult(dict):
    def __init__(__self__, *,
                 ...
                 state: builtins.str):
        """
        :param builtins.str hostname: A virtual hostname. For more information about virtual hostname string construction, see [Managing Request Routing](https://docs.cloud.oracle.com/iaas/Content/Balance/Tasks/managingrequest.htm#routing).  Example: `app.example.com`
...
class GetListenerRulesListenerRuleRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 are_invalid_characters_allowed: builtins.bool,
                 conditions: Sequence['outputs.GetListenerRulesListenerRuleRuleConditionResult'],
                 default_max_connections: builtins.int,
                 description: builtins.str,
                 header: builtins.str,
                 http_large_header_size_in_kb: builtins.int,
                 ...
                 value: builtins.str):
        """
        :param builtins.str action: The action can be one of these values: `ADD_HTTP_REQUEST_HEADER`, `ADD_HTTP_RESPONSE_HEADER`, `ALLOW`, `CONTROL_ACCESS_USING_HTTP_METHODS`, `EXTEND_HTTP_REQUEST_HEADER_VALUE`, `EXTEND_HTTP_RESPONSE_HEADER_VALUE`, `HTTP_HEADER`, `IP_BASED_MAX_CONNECTIONS`, `REDIRECT`, `REMOVE_HTTP_REQUEST_HEADER`, `REMOVE_HTTP_RESPONSE_HEADER`
        :param Sequence[builtins.str] allowed_methods: The list of HTTP methods allowed for this listener.
        :param builtins.bool are_invalid_characters_allowed: Indicates whether or not invalid characters in client header fields will be allowed. Valid names are composed of English letters, digits, hyphens and underscores. If "true", invalid characters are allowed in the HTTP header. If "false", invalid characters are not allowed in the HTTP header
        :param builtins.int default_max_connections: The maximum number of connections that the any IP can make to a listener unless the IP is mentioned in maxConnections. If no defaultMaxConnections is specified the default is unlimited.
        :param builtins.str description: A brief description of the access control rule. Avoid entering confidential information.
        :param builtins.str header: A header name that conforms to RFC 7230.  Example: `example_header_name`
        :param builtins.int http_large_header_size_in_kb: The maximum size of each buffer used for reading http client request header. This value indicates the maximum size allowed for each buffer. The allowed values for buffer size are 8, 16, 32 and 64.
        ...
        :param builtins.str prefix: A string to prepend to the header value. The resulting header value must still conform to RFC 7230. With the following exceptions:
               *  value cannot contain `$`
               *  value cannot contain patterns like `{variable_name}`. They are reserved for future extensions. Currently, such values are invalid.
        ...
        :param builtins.int response_code: The HTTP status code to return when the incoming request is redirected.
        :param builtins.int status_code: The HTTP status code to return when the requested HTTP method is not in the list of allowed methods. The associated status line returned with the code is mapped from the standard HTTP specification. The default value is `405 (Method Not Allowed)`.  Example: 403
        :param builtins.str suffix: A string to append to the header value. The resulting header value must still conform to RFC 7230. With the following exceptions:
               *  value cannot contain `$`
               *  value cannot contain patterns like `{variable_name}`. They are reserved for future extensions. Currently, such values are invalid.
        :param builtins.str value: A header value that conforms to RFC 7230. With the following exceptions:
               *  value cannot contain `$`
               *  value cannot contain patterns like `{variable_name}`. They are reserved for future extensions. Currently, such values are invalid.
        """
        pulumi.set(__self__, "action", action)
    ...
    @property
    @pulumi.getter(name="areInvalidCharactersAllowed")
    def are_invalid_characters_allowed(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="defaultMaxConnections")
    def default_max_connections(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="httpLargeHeaderSizeInKb")
    def http_large_header_size_in_kb(self) -> builtins.int:
        """
...
class GetListenerRulesListenerRuleRuleConditionResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str attribute_name: The attribute_name can be one of these values: `PATH`, `SOURCE_IP_ADDRESS`, `SOURCE_VCN_ID`, `SOURCE_VCN_IP_ADDRESS`
        :param builtins.str attribute_value: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the originating VCN that an incoming packet must match.
        :param builtins.str operator: A string that specifies how to compare the PathMatchCondition object's `attributeValue` string to the incoming URI.
               *  **EXACT_MATCH** - The incoming URI path must exactly and completely match the `attributeValue` string.
               *  **FORCE_LONGEST_PREFIX_MATCH** - The system looks for the `attributeValue` string with the best, longest match of the beginning portion of the incoming URI path.
               *  **PREFIX_MATCH** - The beginning portion of the incoming URI path must exactly match the `attributeValue` string.
               *  **SUFFIX_MATCH** - The ending portion of the incoming URI path must exactly match the `attributeValue` string.
...
class GetListenerRulesListenerRuleRuleIpMaxConnectionResult(dict):
    def __init__(__self__, *,
                 ...
                 max_connections: builtins.int):
        """
        :param Sequence[builtins.str] ip_addresses: Each element in the list should be valid IPv4 or IPv6 CIDR Block address. Example: '["129.213.176.0/24", "150.136.187.0/24", "2002::1234:abcd:ffff:c0a8:101/64"]'
        :param builtins.int max_connections: The maximum number of simultaneous connections that the specified IPs can make to the Listener. IPs without a maxConnections setting can make either defaultMaxConnections simultaneous connections to a listener or, if no defaultMaxConnections is specified, an unlimited number of simultaneous connections to a listener.
        """
        pulumi.set(__self__, "ip_addresses", ip_addresses)
        pulumi.set(__self__, "max_connections", max_connections)
...
class GetListenerRulesListenerRuleRuleRedirectUriResult(dict):
    def __init__(__self__, *,
                 ...
                 query: builtins.str):
        """
        :param builtins.str host: The valid domain name (hostname) or IP address to use in the redirect URI.
        :param builtins.str path: The HTTP URI path to use in the redirect URI.
        :param builtins.int port: The communication port to use in the redirect URI.
        :param builtins.str protocol: The HTTP protocol to use in the redirect URI.
        :param builtins.str query: The query string to use in the redirect URI.
        """
        pulumi.set(__self__, "host", host)
        pulumi.set(__self__, "path", path)
        pulumi.set(__self__, "port", port)
...
class GetLoadBalancerRoutingPoliciesRoutingPolicyResult(dict):
    def __init__(__self__, *,
                 condition_language_version: builtins.str,
                 load_balancer_id: builtins.str,
                 name: builtins.str,
                 rules: Sequence['outputs.GetLoadBalancerRoutingPoliciesRoutingPolicyRuleResult'],
                 state: builtins.str):
        """
        :param builtins.str condition_language_version: The version of the language in which `condition` of `rules` are composed.
        :param builtins.str load_balancer_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the load balancer associated with the routing policies.
        :param builtins.str name: A unique name for the routing policy rule. Avoid entering confidential information.
...
class GetLoadBalancerRoutingPoliciesRoutingPolicyRuleResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str condition: A routing rule to evaluate defined conditions against the incoming HTTP request and perform an action.
        :param builtins.str name: A unique name for the routing policy rule. Avoid entering confidential information.
        """
        pulumi.set(__self__, "actions", actions)
        pulumi.set(__self__, "condition", condition)
...
class GetLoadBalancerRoutingPoliciesRoutingPolicyRuleActionResult(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str backend_set_name: Name of the backend set the listener will forward the traffic to.  Example: `backendSetForImages`
        :param builtins.str name: A unique name for the routing policy rule. Avoid entering confidential information.
        """
        pulumi.set(__self__, "backend_set_name", backend_set_name)
        pulumi.set(__self__, "name", name)
...
class GetLoadBalancersLoadBalancerResult(dict):
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] ip_addresses: An array of IP addresses. Deprecated: use ip_address_details instead.
        :param builtins.bool is_delete_protection_enabled: Whether or not the load balancer has delete protection enabled.
        :param builtins.bool is_private: Whether the load balancer has a VCN-local (private) IP address.
        ...
        :param Sequence[builtins.str] subnet_ids: An array of subnet [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        ...
        :param builtins.str time_created: The date and time the load balancer was created, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
        """
    ...
    def is_request_id_enabled(self) -> builtins.bool:
        """
    ...
    def request_id_header(self) -> builtins.str:
        """
...
class GetLoadBalancersLoadBalancerShapeDetailResult(dict):
    def __init__(__self__, *,
                 ...
                 minimum_bandwidth_in_mbps: builtins.int):
        """
        :param builtins.int maximum_bandwidth_in_mbps: Bandwidth in Mbps that determines the maximum bandwidth (ingress plus egress) that the load balancer can achieve. This bandwidth cannot be always guaranteed. For a guaranteed bandwidth use the minimumBandwidthInMbps parameter.
        :param builtins.int minimum_bandwidth_in_mbps: Bandwidth in Mbps that determines the total pre-provisioned bandwidth (ingress plus egress). The values must be between 0 and the maximumBandwidthInMbps in multiples of 10. The current allowed maximum value is defined in [Service Limits](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/servicelimits.htm).  Example: `150`
        """
        pulumi.set(__self__, "maximum_bandwidth_in_mbps", maximum_bandwidth_in_mbps)
        pulumi.set(__self__, "minimum_bandwidth_in_mbps", minimum_bandwidth_in_mbps)
...
class GetPathRouteSetsPathRouteSetPathRouteResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str backend_set_name: The name of the target backend set for requests where the incoming URI matches the specified path.  Example: `example_backend_set`
        :param builtins.str path: The path string to match against the incoming URI path.
               *  Path strings are case-insensitive.
               *  Asterisk (*) wildcards are not supported.
               *  Regular expressions are not supported.
...
class GetPathRouteSetsPathRouteSetPathRoutePathMatchTypeResult(dict):
    def __init__(__self__, *,
                 match_type: builtins.str):
        """
        :param builtins.str match_type: Specifies how the load balancing service compares a [PathRoute](https://docs.cloud.oracle.com/iaas/api/#/en/loadbalancer/20170115/requests/PathRoute) object's `path` string against the incoming URI.
               *  **EXACT_MATCH** - Looks for a `path` string that exactly matches the incoming URI path.
               *  **FORCE_LONGEST_PREFIX_MATCH** - Looks for the `path` string with the best, longest match of the beginning portion of the incoming URI path.
               *  **PREFIX_MATCH** - Looks for a `path` string that matches the beginning portion of the incoming URI path.
               *  **SUFFIX_MATCH** - Looks for a `path` string that matches the ending portion of the incoming URI path.
...
class GetRuleSetItemConditionResult(dict):
    def __init__(__self__, *,
                 ...
                 operator: builtins.str):
        """
        :param builtins.str attribute_name: (Required) (Updatable) The attribute_name can be one of these values: `PATH`, `SOURCE_IP_ADDRESS`, `SOURCE_VCN_ID`, `SOURCE_VCN_IP_ADDRESS`
        :param builtins.str attribute_value: (Required) (Updatable) Depends on `attribute_name`:
               - when `attribute_name` = `SOURCE_IP_ADDRESS` | IPv4 or IPv6 address range to which the source IP address of incoming packet would be matched against
               - when `attribute_name` = `SOURCE_VCN_IP_ADDRESS` | IPv4 address range to which the original client IP address (in customer VCN) of incoming packet would be matched against
               - when `attribute_name` = `SOURCE_VCN_ID` | OCID of the customer VCN to which the service gateway embedded VCN ID of incoming packet would be matched against
        :param builtins.str operator: A string that specifies how to compare the PathMatchCondition object's `attributeValue` string to the incoming URI.
...
class GetSslCipherSuitesSslCipherSuiteResult(dict):
    def __init__(__self__, *,
                 ...
                 state: builtins.str):
        """
        :param Sequence[builtins.str] ciphers: A list of SSL ciphers the load balancer must support for HTTPS or SSL connections.
