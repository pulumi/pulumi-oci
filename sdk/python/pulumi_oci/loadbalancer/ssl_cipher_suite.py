...
class SslCipherSuiteArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] load_balancer_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the associated load balancer.
        :param pulumi.Input[builtins.str] name: A friendly name for the SSL cipher suite. It must be unique and it cannot be changed.
...
class SslCipherSuite(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            load_balancer_id: Optional[pulumi.Input[builtins.str]] = None,
            name: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None) -> 'SslCipherSuite':
        """
