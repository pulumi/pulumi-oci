...
class GetLogAnalyticsCategoriesListResult:
    ...
    def category_display_text(self) -> Optional[_builtins.str]:
...
def get_log_analytics_categories_list(category_display_text: Optional[_builtins.str] = None,
    ...
    :param _builtins.str category_display_text: The category display text used for filtering. Only categories matching the specified display name or description will be returned.
    :param _builtins.str category_type: A comma-separated list of category types used for filtering. Only categories of the specified types will be returned.
