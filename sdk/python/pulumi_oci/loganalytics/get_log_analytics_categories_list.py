...
class GetLogAnalyticsCategoriesListResult:
    ...
    def category_display_text(self) -> Optional[builtins.str]:
...
def get_log_analytics_categories_list(category_display_text: Optional[builtins.str] = None,
    ...
    :param builtins.str category_display_text: The category display text used for filtering. Only categories matching the specified display name or description will be returned.
    :param builtins.str category_type: A comma-separated list of category types used for filtering. Only categories of the specified types will be returned.
...
def get_log_analytics_categories_list_output(category_display_text: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                             category_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
