...
def get_log_analytics_category(name: Optional[builtins.str] = None,
    ...
    :param builtins.str name: The category name.
...
def get_log_analytics_category_output(name: Optional[pulumi.Input[builtins.str]] = None,
