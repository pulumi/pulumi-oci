...
class GetLogAnalyticsEntitiesSummaryResult:
    ...
    def active_entities_count(self) -> _builtins.int:
        """
    ...
    def entities_with_has_logs_collected_count(self) -> _builtins.int:
        """
    ...
    def entities_with_management_agent_count(self) -> _builtins.int:
        """
...
def get_log_analytics_entities_summary(compartment_id: Optional[_builtins.str] = None,
