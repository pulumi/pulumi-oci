...
def get_log_analytics_entity(log_analytics_entity_id: Optional[str] = None,
    ...
    return AwaitableGetLogAnalyticsEntityResult(
        are_logs_collected=__ret__.are_logs_collected,
        cloud_resource_id=__ret__.cloud_resource_id,
        compartment_id=__ret__.compartment_id,
        defined_tags=__ret__.defined_tags,
        entity_type_internal_name=__ret__.entity_type_internal_name,
        ...
        management_agent_compartment_id=__ret__.management_agent_compartment_id,
        management_agent_display_name=__ret__.management_agent_display_name,
        ...
        timezone_region=__ret__.timezone_region)
