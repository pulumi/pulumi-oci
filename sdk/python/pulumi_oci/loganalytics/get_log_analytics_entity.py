...
class GetLogAnalyticsEntityResult:
    ...
    def is_show_associated_sources_count(self) -> Optional[_builtins.str]:
...
def get_log_analytics_entity(is_show_associated_sources_count: Optional[_builtins.str] = None,
...
def get_log_analytics_entity_output(is_show_associated_sources_count: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
