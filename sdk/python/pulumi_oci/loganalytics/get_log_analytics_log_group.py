...
class GetLogAnalyticsLogGroupResult:
    ...
    def log_analytics_log_group_id(self) -> builtins.str:
...
def get_log_analytics_log_group(log_analytics_log_group_id: Optional[builtins.str] = None,
    ...
    :param builtins.str log_analytics_log_group_id: unique logAnalytics log group identifier
...
def get_log_analytics_log_group_output(log_analytics_log_group_id: Optional[pulumi.Input[builtins.str]] = None,
