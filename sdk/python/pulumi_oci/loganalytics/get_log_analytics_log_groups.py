...
def get_log_analytics_log_groups(compartment_id: Optional[builtins.str] = None,
...
def get_log_analytics_log_groups_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
