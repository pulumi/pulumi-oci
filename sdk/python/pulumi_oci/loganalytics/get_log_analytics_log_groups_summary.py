...
class GetLogAnalyticsLogGroupsSummaryResult:
    ...
    def log_group_count(self) -> builtins.int:
...
def get_log_analytics_log_groups_summary(compartment_id: Optional[builtins.str] = None,
...
def get_log_analytics_log_groups_summary_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
