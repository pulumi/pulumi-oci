...
class GetLogAnalyticsObjectCollectionRuleResult:
    ...
    def log_analytics_object_collection_rule_id(self) -> builtins.str:
...
def get_log_analytics_object_collection_rule(log_analytics_object_collection_rule_id: Optional[builtins.str] = None,
    ...
    :param builtins.str log_analytics_object_collection_rule_id: The Logging Analytics Object Collection Rule [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)
...
def get_log_analytics_object_collection_rule_output(log_analytics_object_collection_rule_id: Optional[pulumi.Input[builtins.str]] = None,
