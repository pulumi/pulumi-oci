...
def get_log_analytics_object_collection_rule(log_analytics_object_collection_rule_id: Optional[str] = None,
    ...
    return AwaitableGetLogAnalyticsObjectCollectionRuleResult(
        char_encoding=__ret__.char_encoding,
        ...
        object_name_filters=__ret__.object_name_filters,
        os_bucket_name=__ret__.os_bucket_name,
        os_namespace=__ret__.os_namespace,
        overrides=__ret__.overrides,
        poll_since=__ret__.poll_since,
