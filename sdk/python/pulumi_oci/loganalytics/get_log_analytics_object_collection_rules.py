...
def get_log_analytics_object_collection_rules(compartment_id: Optional[builtins.str] = None,
...
def get_log_analytics_object_collection_rules_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
