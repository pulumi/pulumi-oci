...
def get_log_analytics_preference(namespace: Optional[builtins.str] = None,
...
def get_log_analytics_preference_output(namespace: Optional[pulumi.Input[builtins.str]] = None,
