...
class GetNamespaceIngestTimeRuleResult:
    ...
    def ingest_time_rule_id(self) -> builtins.str:
...
def get_namespace_ingest_time_rule(ingest_time_rule_id: Optional[builtins.str] = None,
    ...
    :param builtins.str ingest_time_rule_id: Unique ocid of the ingest time rule.
...
def get_namespace_ingest_time_rule_output(ingest_time_rule_id: Optional[pulumi.Input[builtins.str]] = None,
