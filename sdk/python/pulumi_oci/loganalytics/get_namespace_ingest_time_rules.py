...
class GetNamespaceIngestTimeRulesResult:
    ...
    def condition_kind(self) -> Optional[_builtins.str]:
...
def get_namespace_ingest_time_rules(compartment_id: Optional[_builtins.str] = None,
                                    condition_kind: Optional[_builtins.str] = None,
