...
class GetNamespacePropertiesMetadataResult:
    ...
    @property
    @pulumi.getter
    def constraints(self) -> Optional[builtins.str]:
        """
    ...
    def display_text(self) -> Optional[builtins.str]:
...
def get_namespace_properties_metadata(constraints: Optional[builtins.str] = None,
                                      display_text: Optional[builtins.str] = None,
    ...
    :param builtins.str display_text: The property display text used for filtering. Only properties matching the specified display name or description will be returned.
    :param builtins.str level: The level for which applicable properties are to be listed.
...
def get_namespace_properties_metadata_output(constraints: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                             display_text: Optional[pulumi.Input[Optional[builtins.str]]] = None,
