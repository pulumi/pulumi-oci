...
class GetNamespaceRulesSummaryResult:
    ...
    def ingest_time_rules_count(self) -> builtins.int:
        """
    ...
    def saved_search_rules_count(self) -> builtins.int:
        """
...
def get_namespace_rules_summary(compartment_id: Optional[builtins.str] = None,
...
def get_namespace_rules_summary_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetNamespaceRulesSummaryResult(
        ...
        ingest_time_rules_count=pulumi.get(__response__, 'ingest_time_rules_count'),
        namespace=pulumi.get(__response__, 'namespace'),
        saved_search_rules_count=pulumi.get(__response__, 'saved_search_rules_count'),
