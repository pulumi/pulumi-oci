...
def get_namespace_storage_encryption_key_info(namespace: Optional[builtins.str] = None,
...
def get_namespace_storage_encryption_key_info_output(namespace: Optional[pulumi.Input[builtins.str]] = None,
