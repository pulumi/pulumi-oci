...
class GetNamespaceStorageRecalledDataSizeResult:
    ...
    def not_recalled_data_in_bytes(self) -> _builtins.str:
        """
    ...
    def recalled_data_in_bytes(self) -> _builtins.str:
        """
...
def get_namespace_storage_recalled_data_size(namespace: Optional[_builtins.str] = None,
