...
class LogAnalyticsEntityArgs:
    def __init__(__self__, *,
                 ...
                 entity_type_name: pulumi.Input[builtins.str],
                 ...
                 time_last_discovered: Optional[pulumi.Input[builtins.str]] = None,
                 timezone_region: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] entity_type_name: Log analytics entity type name.
        ...
        :param pulumi.Input[builtins.str] hostname: (Updatable) The hostname where the entity represented here is actually present. This would be the output one would get if they run `echo $HOSTNAME` on Linux or an equivalent OS command. This may be different from management agents host since logs may be collected remotely.
        :param pulumi.Input[builtins.str] management_agent_id: (Updatable) The OCID of the Management Agent.
        :param pulumi.Input['LogAnalyticsEntityMetadataArgs'] metadata: (Updatable) Details of Entity Metadata.
        :param pulumi.Input[builtins.str] name: (Updatable) Log analytics entity name.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: (Updatable) The name/value pairs for parameter values to be used in file patterns specified in log sources.
        :param pulumi.Input[builtins.str] source_id: This indicates the type of source. It is primarily for Enterprise Manager Repository ID.
        :param pulumi.Input[builtins.str] time_last_discovered: (Updatable) The date and time the resource was last discovered, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] timezone_region: (Updatable) The timezone region of the log analytics entity. 
    ...
    def entity_type_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def entity_type_name(self, value: pulumi.Input[builtins.str]):
    ...
    def cloud_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def cloud_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_last_discovered(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_last_discovered(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_last_discovered", value)

    @property
    @pulumi.getter(name="timezoneRegion")
    def timezone_region(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def timezone_region(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _LogAnalyticsEntityState:
    def __init__(__self__, *,
                 ...
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 entity_type_internal_name: Optional[pulumi.Input[builtins.str]] = None,
                 entity_type_name: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 hostname: Optional[pulumi.Input[builtins.str]] = None,
                 lifecycle_details: Optional[pulumi.Input[builtins.str]] = None,
                 management_agent_compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 management_agent_display_name: Optional[pulumi.Input[builtins.str]] = None,
                 management_agent_id: Optional[pulumi.Input[builtins.str]] = None,
                 metadata: Optional[pulumi.Input['LogAnalyticsEntityMetadataArgs']] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) Compartment Identifier [OCID] (https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] entity_type_internal_name: Internal name for the log analytics entity type.
        :param pulumi.Input[builtins.str] entity_type_name: Log analytics entity type name.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.str] hostname: (Updatable) The hostname where the entity represented here is actually present. This would be the output one would get if they run `echo $HOSTNAME` on Linux or an equivalent OS command. This may be different from management agents host since logs may be collected remotely.
        :param pulumi.Input[builtins.str] lifecycle_details: lifecycleDetails has additional information regarding substeps such as management agent plugin deployment.
        :param pulumi.Input[builtins.str] management_agent_compartment_id: Management agent (management-agents resource kind) compartment OCID
        :param pulumi.Input[builtins.str] management_agent_display_name: Management agent (management-agents resource kind) display name
        :param pulumi.Input[builtins.str] management_agent_id: (Updatable) The OCID of the Management Agent.
        :param pulumi.Input['LogAnalyticsEntityMetadataArgs'] metadata: (Updatable) Details of Entity Metadata.
        :param pulumi.Input[builtins.str] name: (Updatable) Log analytics entity name.
        :param pulumi.Input[builtins.str] namespace: The Logging Analytics namespace used for the request.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] properties: (Updatable) The name/value pairs for parameter values to be used in file patterns specified in log sources.
        :param pulumi.Input[builtins.str] source_id: This indicates the type of source. It is primarily for Enterprise Manager Repository ID.
        :param pulumi.Input[builtins.str] state: The current state of the log analytics entity.
        :param pulumi.Input[builtins.str] time_created: The date and time the resource was created, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_last_discovered: (Updatable) The date and time the resource was last discovered, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_updated: The date and time the resource was last updated, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] timezone_region: (Updatable) The timezone region of the log analytics entity. 
    ...
    def are_logs_collected(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def entity_type_internal_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def entity_type_internal_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "entity_type_internal_name", value)

    @property
    @pulumi.getter(name="entityTypeName")
    def entity_type_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Log analytics entity type name.
        """
        return pulumi.get(self, "entity_type_name")
    ...
    @entity_type_name.setter
    def entity_type_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "entity_type_name", value)
    ...
    def management_agent_compartment_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def management_agent_compartment_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "management_agent_compartment_id", value)

    @property
    @pulumi.getter(name="managementAgentDisplayName")
    def management_agent_display_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def management_agent_display_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class LogAnalyticsEntity(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_last_discovered: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            timezone_region: Optional[pulumi.Input[builtins.str]] = None) -> 'LogAnalyticsEntity':
        """
    ...
    @property
    @pulumi.getter(name="areLogsCollected")
    def are_logs_collected(self) -> pulumi.Output[builtins.bool]:
        """
        The Boolean flag to indicate if logs are collected for an entity for log analytics usage.
        """
        return pulumi.get(self, "are_logs_collected")
    ...
    @property
    @pulumi.getter(name="cloudResourceId")
    def cloud_resource_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the Cloud resource which this entity is a representation of. This may be blank when the entity represents a non-cloud resource that the customer may have on their premises.
        """
        return pulumi.get(self, "cloud_resource_id")
    ...
    @property
    @pulumi.getter(name="entityTypeInternalName")
    def entity_type_internal_name(self) -> pulumi.Output[builtins.str]:
        """
        Internal name for the log analytics entity type.
        """
        return pulumi.get(self, "entity_type_internal_name")
    ...
    @property
    @pulumi.getter(name="entityTypeName")
    def entity_type_name(self) -> pulumi.Output[builtins.str]:
        """
        Log analytics entity type name.
        """
        return pulumi.get(self, "entity_type_name")
    ...
    @property
    @pulumi.getter(name="managementAgentCompartmentId")
    def management_agent_compartment_id(self) -> pulumi.Output[builtins.str]:
        """
        Management agent (management-agents resource kind) compartment OCID
        """
        return pulumi.get(self, "management_agent_compartment_id")
    ...
    @property
    @pulumi.getter(name="managementAgentDisplayName")
    def management_agent_display_name(self) -> pulumi.Output[builtins.str]:
        """
        Management agent (management-agents resource kind) display name
        """
        return pulumi.get(self, "management_agent_display_name")
    ...
    @property
    @pulumi.getter(name="timeLastDiscovered")
    def time_last_discovered(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The date and time the resource was last discovered, in the format defined by RFC3339.
        """
        return pulumi.get(self, "time_last_discovered")
    ...
    @property
    @pulumi.getter(name="timezoneRegion")
    def timezone_region(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The timezone region of the log analytics entity. 
