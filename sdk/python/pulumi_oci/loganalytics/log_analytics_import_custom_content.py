...
class LogAnalyticsImportCustomContentArgs:
    def __init__(__self__, *,
                 import_custom_content_file: pulumi.Input[builtins.str],
                 namespace: pulumi.Input[builtins.str],
                 expect: Optional[pulumi.Input[builtins.str]] = None,
                 is_overwrite: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a LogAnalyticsImportCustomContent resource.
        :param pulumi.Input[builtins.str] import_custom_content_file: Path to the file to upload which contains the custom content.
        ...
        :param pulumi.Input[builtins.bool] is_overwrite: A flag indicating whether or not to overwrite existing content if a conflict is found during import content operation.
        """
    ...
    def import_custom_content_file(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def import_custom_content_file(self, value: pulumi.Input[builtins.str]):
    ...
    def is_overwrite(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_overwrite.setter
    def is_overwrite(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _LogAnalyticsImportCustomContentState:
    def __init__(__self__, *,
                 ...
                 content_name: Optional[pulumi.Input[builtins.str]] = None,
                 expect: Optional[pulumi.Input[builtins.str]] = None,
                 field_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 import_custom_content_file: Optional[pulumi.Input[builtins.str]] = None,
                 is_overwrite: Optional[pulumi.Input[builtins.bool]] = None,
                 namespace: Optional[pulumi.Input[builtins.str]] = None,
                 parser_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 source_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] content_name: The content name.
        :param pulumi.Input[builtins.str] expect: A value of `100-continue` requests preliminary verification of the request method, path, and headers before the request body is sent. If no error results from such verification, the server will send a 100 (Continue) interim response to indicate readiness for the request body. The only allowed value for this parameter is "100-Continue" (case-insensitive).
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] field_names: The field names.
        :param pulumi.Input[builtins.str] import_custom_content_file: Path to the file to upload which contains the custom content.
        :param pulumi.Input[builtins.bool] is_overwrite: A flag indicating whether or not to overwrite existing content if a conflict is found during import content operation.
        :param pulumi.Input[builtins.str] namespace: The Logging Analytics namespace used for the request.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] parser_names: The parser names.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] source_names: The source names.
        """
    ...
    def content_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The content name.
        """
    ...
    @content_name.setter
    def content_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="importCustomContentFile")
    def import_custom_content_file(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Path to the file to upload which contains the custom content.
        """
        return pulumi.get(self, "import_custom_content_file")
    ...
    @import_custom_content_file.setter
    def import_custom_content_file(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "import_custom_content_file", value)
    ...
    def parser_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The parser names.
        """
    ...
    @parser_names.setter
    def parser_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "parser_names", value)

    @property
    @pulumi.getter(name="sourceNames")
    def source_names(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        The source names.
        """
    ...
    @source_names.setter
    def source_names(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class LogAnalyticsImportCustomContent(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            namespace: Optional[pulumi.Input[builtins.str]] = None,
            parser_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            source_names: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'LogAnalyticsImportCustomContent':
        """
    ...
    @property
    @pulumi.getter(name="contentName")
    def content_name(self) -> pulumi.Output[builtins.str]:
        """
        The content name.
        """
        return pulumi.get(self, "content_name")
    ...
    @property
    @pulumi.getter(name="fieldNames")
    def field_names(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The field names.
        """
        return pulumi.get(self, "field_names")
    ...
    @property
    @pulumi.getter(name="importCustomContentFile")
    def import_custom_content_file(self) -> pulumi.Output[builtins.str]:
        """
        Path to the file to upload which contains the custom content.
        """
        return pulumi.get(self, "import_custom_content_file")
    ...
    @property
    @pulumi.getter(name="isOverwrite")
    def is_overwrite(self) -> pulumi.Output[builtins.bool]:
        """
        A flag indicating whether or not to overwrite existing content if a conflict is found during import content operation.
        """
        return pulumi.get(self, "is_overwrite")
    ...
    @property
    @pulumi.getter(name="parserNames")
    def parser_names(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The parser names.
        """
        return pulumi.get(self, "parser_names")
    ...
    @property
    @pulumi.getter(name="sourceNames")
    def source_names(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The source names.
        """
        return pulumi.get(self, "source_names")
