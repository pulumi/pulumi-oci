...
class LogAnalyticsObjectCollectionRuleArgs:
    def __init__(__self__, *,
                 ...
                 collection_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] char_encoding: (Updatable) An optional character encoding to aid in detecting the character encoding of the contents of the objects while processing. It is recommended to set this value as ISO_8589_1 when configuring content of the objects having more numeric characters, and very few alphabets. For e.g. this applies when configuring VCN Flow Logs.
        :param pulumi.Input[builtins.str] collection_type: The type of collection. Supported collection types: LIVE, HISTORIC, HISTORIC_LIVE
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) A string that describes the details of the rule. It does not have to be unique, and can be changed. Avoid entering confidential information.
        :param pulumi.Input[builtins.str] entity_id: (Updatable) Logging Analytics entity OCID. Associates the processed logs with the given entity (optional).
    ...
    def os_bucket_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def os_bucket_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "os_bucket_name", value)

    @property
    @pulumi.getter(name="osNamespace")
    def os_namespace(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @os_namespace.setter
    def os_namespace(self, value: pulumi.Input[builtins.str]):
    ...
    def collection_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_force_historic_collection(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def log_set(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The logSet to be associated with the processed logs. The logSet feature can be used by customers with high volume of data  and this feature has to be enabled for a given tenancy prior to its usage. When logSetExtRegex value is provided, it will take precedence over this logSet value and logSet will be computed dynamically  using logSetKey and logSetExtRegex.
        """
    ...
    @log_set.setter
    def log_set(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "log_set", value)

    @property
    @pulumi.getter(name="logSetExtRegex")
    def log_set_ext_regex(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def log_set_ext_regex(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "log_set_ext_regex", value)

    @property
    @pulumi.getter(name="logSetKey")
    def log_set_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @log_set_key.setter
    def log_set_key(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def object_name_filters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def object_name_filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def poll_since(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The oldest time of the file in the bucket to consider for collection. Accepted values are: BEGINNING or CURRENT_TIME or RFC3339 formatted datetime string. Use this for HISTORIC or HISTORIC_LIVE collection types. When collectionType is LIVE, specifying pollSince value other than CURRENT_TIME will result in error.
        """
    ...
    @poll_since.setter
    def poll_since(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "poll_since", value)

    @property
    @pulumi.getter(name="pollTill")
    def poll_till(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @poll_till.setter
    def poll_till(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _LogAnalyticsObjectCollectionRuleState:
    def __init__(__self__, *,
                 ...
                 object_name_filters: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 os_bucket_name: Optional[pulumi.Input[builtins.str]] = None,
                 os_namespace: Optional[pulumi.Input[builtins.str]] = None,
                 overrides: Optional[pulumi.Input[Sequence[pulumi.Input['LogAnalyticsObjectCollectionRuleOverrideArgs']]]] = None,
                 poll_since: Optional[pulumi.Input[builtins.str]] = None,
                 poll_till: Optional[pulumi.Input[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="osBucketName")
    def os_bucket_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Name of the Object Storage bucket.
        """
        return pulumi.get(self, "os_bucket_name")
    ...
    @os_bucket_name.setter
    def os_bucket_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "os_bucket_name", value)

    @property
    @pulumi.getter(name="osNamespace")
    def os_namespace(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Object Storage namespace.
        """
        return pulumi.get(self, "os_namespace")
    ...
    @os_namespace.setter
    def os_namespace(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "os_namespace", value)
...
class LogAnalyticsObjectCollectionRule(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="isForceHistoricCollection")
    def is_force_historic_collection(self) -> pulumi.Output[builtins.bool]:
        """
        Flag to allow historic collection if poll period overlaps with existing ACTIVE collection rule
        """
        return pulumi.get(self, "is_force_historic_collection")
    ...
    @property
    @pulumi.getter(name="logSet")
    def log_set(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The logSet to be associated with the processed logs. The logSet feature can be used by customers with high volume of data  and this feature has to be enabled for a given tenancy prior to its usage. When logSetExtRegex value is provided, it will take precedence over this logSet value and logSet will be computed dynamically  using logSetKey and logSetExtRegex.
        """
        return pulumi.get(self, "log_set")
    ...
    @property
    @pulumi.getter(name="logSetExtRegex")
    def log_set_ext_regex(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The regex to be applied against given logSetKey. Regex has to be in string escaped format.
        """
        return pulumi.get(self, "log_set_ext_regex")
    ...
    @property
    @pulumi.getter(name="logSetKey")
    def log_set_key(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) An optional parameter to indicate from where the logSet to be extracted using logSetExtRegex. Default value is OBJECT_PATH (e.g. /n/<namespace>/b/<bucketname>/o/<objectname>).
        """
        return pulumi.get(self, "log_set_key")
    ...
    @property
    @pulumi.getter(name="logSourceName")
    def log_source_name(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Name of the Logging Analytics Source to use for the processing.
        """
        return pulumi.get(self, "log_source_name")
    ...
    @property
    @pulumi.getter(name="objectNameFilters")
    def object_name_filters(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        (Updatable) When the filters are provided, only the objects matching the filters are picked up for processing. The matchType supported is exact match and accommodates wildcard "*". For more information on filters, see [Event Filters](https://docs.oracle.com/en-us/iaas/Content/Events/Concepts/filterevents.htm).
        """
        return pulumi.get(self, "object_name_filters")
    ...
    @property
    @pulumi.getter(name="osBucketName")
    def os_bucket_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the Object Storage bucket.
        """
        return pulumi.get(self, "os_bucket_name")
    ...
    @property
    @pulumi.getter(name="osNamespace")
    def os_namespace(self) -> pulumi.Output[builtins.str]:
        """
        Object Storage namespace.
        """
        return pulumi.get(self, "os_namespace")
    ...
    @property
    @pulumi.getter(name="pollSince")
    def poll_since(self) -> pulumi.Output[builtins.str]:
        """
        The oldest time of the file in the bucket to consider for collection. Accepted values are: BEGINNING or CURRENT_TIME or RFC3339 formatted datetime string. Use this for HISTORIC or HISTORIC_LIVE collection types. When collectionType is LIVE, specifying pollSince value other than CURRENT_TIME will result in error.
        """
        return pulumi.get(self, "poll_since")
    ...
    @property
    @pulumi.getter(name="pollTill")
    def poll_till(self) -> pulumi.Output[builtins.str]:
        """
        The newest time of the file in the bucket to consider for collection. Accepted values are: CURRENT_TIME or RFC3339 formatted datetime string. Use this for HISTORIC collection type. When collectionType is LIVE or HISTORIC_LIVE, specifying pollTill will result in error.
        """
        return pulumi.get(self, "poll_till")
