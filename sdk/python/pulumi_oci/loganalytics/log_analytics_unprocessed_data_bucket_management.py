...
class LogAnalyticsUnprocessedDataBucketManagementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] bucket: Name of the Object Storage bucket.
        ...
        :param pulumi.Input[builtins.bool] is_enabled: Flag that specifies if this configuration is enabled or not.
        """
...
class _LogAnalyticsUnprocessedDataBucketManagementState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] namespace: The Logging Analytics namespace used for the request. 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] time_created: The time when this record is created. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The latest time when this record is updated. An RFC3339 formatted datetime string.
        """
...
class LogAnalyticsUnprocessedDataBucketManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            namespace: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'LogAnalyticsUnprocessedDataBucketManagement':
        """
