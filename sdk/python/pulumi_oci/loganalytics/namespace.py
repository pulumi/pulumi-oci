...
class NamespaceArgs:
    def __init__(__self__, *,
                 ...
                 is_onboarded: pulumi.Input[_builtins.bool],
    ...
    def is_onboarded(self) -> pulumi.Input[_builtins.bool]:
        """
    ...
    @is_onboarded.setter
    def is_onboarded(self, value: pulumi.Input[_builtins.bool]):
...
class Namespace(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="isOnboarded")
    def is_onboarded(self) -> pulumi.Output[_builtins.bool]:
        """
        Use `true` if tenancy is to be onboarded to logging analytics and `false` if tenancy is to be offboarded
        """
        return pulumi.get(self, "is_onboarded")
