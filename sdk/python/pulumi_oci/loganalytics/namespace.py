...
class NamespaceArgs:
    def __init__(__self__, *,
                 ...
                 is_onboarded: pulumi.Input[builtins.bool],
                 namespace: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a Namespace resource.
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the root compartment i.e. OCID of the tenancy.
        :param pulumi.Input[builtins.bool] is_onboarded: Use `true` if tenancy is to be onboarded to logging analytics and `false` if tenancy is to be offboarded
        :param pulumi.Input[builtins.str] namespace: The Log Analytics namespace used for the request.
        """
    ...
    def is_onboarded(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    @is_onboarded.setter
    def is_onboarded(self, value: pulumi.Input[builtins.bool]):
...
class _NamespaceState:
    def __init__(__self__, *,
                 ...
                 is_onboarded: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    @property
    @pulumi.getter(name="isOnboarded")
    def is_onboarded(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Use `true` if tenancy is to be onboarded to logging analytics and `false` if tenancy is to be offboarded
        """
        return pulumi.get(self, "is_onboarded")
    ...
    @is_onboarded.setter
    def is_onboarded(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_onboarded", value)
...
class Namespace(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            compartment_id: Optional[pulumi.Input[builtins.str]] = None,
            is_onboarded: Optional[pulumi.Input[builtins.bool]] = None,
            namespace: Optional[pulumi.Input[builtins.str]] = None) -> 'Namespace':
        """
    ...
    @property
    @pulumi.getter(name="isOnboarded")
    def is_onboarded(self) -> pulumi.Output[builtins.bool]:
        """
        Use `true` if tenancy is to be onboarded to logging analytics and `false` if tenancy is to be offboarded
        """
        return pulumi.get(self, "is_onboarded")
