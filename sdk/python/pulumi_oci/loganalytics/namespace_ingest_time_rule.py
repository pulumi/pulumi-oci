    ...
    def __init__(__self__,
        ...
        test_namespace_ingest_time_rule = oci.log_analytics.NamespaceIngestTimeRule("testNamespaceIngestTimeRule",
            actions=[oci.log_analytics.NamespaceIngestTimeRuleActionArgs(
                ...
                metric_name=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
            ...
            conditions=oci.log_analytics.NamespaceIngestTimeRuleConditionsArgs(
                ...
                field_operator=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                ...
                additional_conditions=[oci.log_analytics.NamespaceIngestTimeRuleConditionsAdditionalConditionArgs(
                    condition_field=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                    condition_operator=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                    condition_value=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                )],
            ),
