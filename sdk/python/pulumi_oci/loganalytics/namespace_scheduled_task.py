...
class NamespaceScheduledTask(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_namespace_scheduled_task = oci.log_analytics.NamespaceScheduledTask("testNamespaceScheduledTask",
            compartment_id=var["compartment_id"],
            kind=var["namespace_scheduled_task_kind"],
            namespace=var["namespace_scheduled_task_namespace"],
            action=oci.log.analytics.NamespaceScheduledTaskActionArgs(
            ...
            saved_search_id=oci_log_analytics_saved_search["test_saved_search"]["id"],
            schedules=oci.log.analytics.NamespaceScheduledTaskSchedulesArgs(
