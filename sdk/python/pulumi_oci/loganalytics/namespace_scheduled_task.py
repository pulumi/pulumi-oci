...
class NamespaceScheduledTaskArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name that is changeable and that does not have to be unique. Format: a leading alphanumeric, followed by zero or more alphanumerics, underscores, spaces, backslashes, or hyphens in any order). No trailing spaces allowed.
        ...
        :param pulumi.Input[builtins.str] saved_search_id: The ManagementSavedSearch id [OCID] to be accelerated.
        """
...
class _NamespaceScheduledTaskState:
    def __init__(__self__, *,
                 ...
                 num_occurrences: Optional[pulumi.Input[builtins.str]] = None,
                 saved_search_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] kind: (Updatable) Discriminator.
        :param pulumi.Input[builtins.str] namespace: The Logging Analytics namespace used for the request.
        :param pulumi.Input[builtins.str] num_occurrences: Number of execution occurrences.
        :param pulumi.Input[builtins.str] saved_search_id: The ManagementSavedSearch id [OCID] to be accelerated.
        :param pulumi.Input['NamespaceScheduledTaskSchedulesArgs'] schedules: (Updatable) Schedules, typically a single schedule. Note there may only be a single schedule for SAVED_SEARCH and PURGE scheduled tasks.
        :param pulumi.Input[builtins.str] state: The current state of the scheduled task.
        :param pulumi.Input[builtins.str] task_status: Status of the scheduled task. - PURGE_RESOURCE_NOT_FOUND
        :param pulumi.Input[builtins.str] task_type: Task type.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] time_created: The date and time the scheduled task was created, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_updated: The date and time the scheduled task was last updated, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] work_request_id: most recent Work Request Identifier [OCID] (https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for the asynchronous request.
        """
    ...
    def num_occurrences(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def num_occurrences(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def scheduled_task_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "scheduled_task_id")

    @scheduled_task_id.setter
    def scheduled_task_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class NamespaceScheduledTask(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            work_request_id: Optional[pulumi.Input[builtins.str]] = None) -> 'NamespaceScheduledTask':
        """
    ...
    @property
    @pulumi.getter(name="numOccurrences")
    def num_occurrences(self) -> pulumi.Output[builtins.str]:
        """
        Number of execution occurrences.
        """
        return pulumi.get(self, "num_occurrences")
    ...
    @property
    @pulumi.getter(name="savedSearchId")
    def saved_search_id(self) -> pulumi.Output[builtins.str]:
        """
        The ManagementSavedSearch id [OCID] to be accelerated.
        """
        return pulumi.get(self, "saved_search_id")
    ...
    @property
    @pulumi.getter(name="scheduledTaskId")
    def scheduled_task_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "scheduled_task_id")
