...
class GetLogResult:
    ...
    def retention_duration(self) -> builtins.int:
        """
...
def get_log(log_group_id: Optional[builtins.str] = None,
    ...
    :param builtins.str log_id: OCID of a log to work with.
    """
    __args__ = dict()
...
def get_log_output(log_group_id: Optional[pulumi.Input[builtins.str]] = None,
