...
class GetLogSavedSearchResult:
    ...
    def log_saved_search_id(self) -> _builtins.str:
...
def get_log_saved_search(log_saved_search_id: Optional[_builtins.str] = None,
...
def get_log_saved_search_output(log_saved_search_id: Optional[pulumi.Input[_builtins.str]] = None,
