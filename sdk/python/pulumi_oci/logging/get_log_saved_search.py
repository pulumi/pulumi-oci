...
class GetLogSavedSearchResult:
    ...
    def log_saved_search_id(self) -> builtins.str:
...
def get_log_saved_search(log_saved_search_id: Optional[builtins.str] = None,
...
def get_log_saved_search_output(log_saved_search_id: Optional[pulumi.Input[builtins.str]] = None,
