...
class GetLogsResult:
    ...
    def source_resource(self) -> Optional[_builtins.str]:
...
def get_logs(display_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str source_resource: Log object resource, which is a field of LogSummary.Configuration.Source.
    :param _builtins.str source_service: Service that created the log object, which is a field of LogSummary.Configuration.Source.
