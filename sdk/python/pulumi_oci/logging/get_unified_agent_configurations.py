...
def get_unified_agent_configurations(compartment_id: Optional[str] = None,
    ...
    test_unified_agent_configurations = oci.Logging.get_unified_agent_configurations(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
