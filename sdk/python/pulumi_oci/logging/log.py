...
class LogArgs:
    def __init__(__self__, *,
                 ...
                 configuration: pulumi.Input[Optional['LogConfigurationArgs']] = None,
        ...
        :param pulumi.Input[_builtins.int] retention_duration: (Updatable) Log retention duration in 30-day increments (30, 60, 90 and so on until 180).
    ...
    @_builtins.property
    @pulumi.getter
    def configuration(self) -> pulumi.Input[Optional['LogConfigurationArgs']]:
        """
    ...
    def configuration(self, value: pulumi.Input[Optional['LogConfigurationArgs']]):
...
class Log(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 configuration: pulumi.Input[Optional[Union['LogConfigurationArgs', 'LogConfigurationArgsDict', 'outputs.LogConfiguration']]] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 is_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
        ...
        :param pulumi.Input[Union['LogConfigurationArgs', 'LogConfigurationArgsDict', 'outputs.LogConfiguration']] configuration: Log object configuration.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[_builtins.str] display_name: (Updatable) The user-friendly display name. This must be unique within the enclosing resource, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[_builtins.bool] is_enabled: (Updatable) Whether or not this resource is currently enabled.
    ...
    def get(resource_name: str,
            ...
            tenancy_id: pulumi.Input[Optional[_builtins.str]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_last_modified: pulumi.Input[Optional[_builtins.str]] = None) -> 'Log':
        """
