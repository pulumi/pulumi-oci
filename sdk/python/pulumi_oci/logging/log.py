...
class LogArgs:
    def __init__(__self__, *,
                 ...
                 retention_duration: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] log_group_id: (Updatable) OCID of a log group to work with.
        :param pulumi.Input[builtins.str] log_type: The logType that the log object is for, whether custom or service.
        ...
        :param pulumi.Input[builtins.int] retention_duration: (Updatable) Log retention duration in 30-day increments (30, 60, 90 and so on until 180).
    ...
    def retention_duration(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def retention_duration(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _LogState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] tenancy_id: The OCID of the tenancy.
...
class Log(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tenancy_id: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_last_modified: Optional[pulumi.Input[builtins.str]] = None) -> 'Log':
        """
    ...
    @property
    @pulumi.getter(name="retentionDuration")
    def retention_duration(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) Log retention duration in 30-day increments (30, 60, 90 and so on until 180).
