...
class LogSavedSearchArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] query: (Updatable) The search query that is saved. 
        ...
        :param pulumi.Input[builtins.str] name: (Updatable) The user-friendly display name. This must be unique within the enclosing resource, and it's changeable. Avoid entering confidential information.
        """
...
class _LogSavedSearchState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] query: (Updatable) The search query that is saved. 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The state of the LogSavedSearch
...
class LogSavedSearch(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_last_modified: Optional[pulumi.Input[builtins.str]] = None) -> 'LogSavedSearch':
        """
