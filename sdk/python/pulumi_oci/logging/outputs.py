...
class LogConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str compartment_id: The OCID of the compartment that the resource belongs to.
        """
...
class LogConfigurationSource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str category: Log object category.
        :param builtins.str resource: The unique identifier of the resource emitting the log.
        :param builtins.str service: Service generating log.
        :param builtins.str source_type: The log source.
               * **OCISERVICE:** Oracle Service.
        :param Mapping[str, builtins.str] parameters: (Updatable) Log category parameters are stored here.
        """
...
class UnifiedAgentConfigurationGroupAssociation(dict):
    ...
    def __init__(__self__, *,
                 group_lists: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] group_lists: (Updatable) list of group/dynamic group ids associated with this configuration.
        """
    ...
    def group_lists(self) -> Optional[Sequence[builtins.str]]:
        """
...
class UnifiedAgentConfigurationServiceConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str configuration_type: (Updatable) Type of Unified Agent service configuration.
...
class UnifiedAgentConfigurationServiceConfigurationApplicationConfiguration(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str source_type: (Updatable) Type of source of metrics
...
class UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationDestination(dict):
    ...
    def __init__(__self__, *,
                 compartment_id: Optional[builtins.str] = None,
                 metrics_namespace: Optional[builtins.str] = None):
        """
        :param builtins.str compartment_id: (Updatable) The OCID of the compartment that the resource belongs to.
        :param builtins.str metrics_namespace: (Updatable) Namespace to which metrics will be emitted.
        """
        if compartment_id is not None:
            pulumi.set(__self__, "compartment_id", compartment_id)
    ...
    def metrics_namespace(self) -> Optional[builtins.str]:
        """
...
class UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSource(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: (Updatable) Unique name for the source.
        ...
        :param Sequence[builtins.str] paths: (Updatable) Absolute paths for log source files. Wildcards can be used.
        :param builtins.str source_type: (Updatable) Unified schema logging source type.
        """
...
class UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceAdvancedOptions(dict):
    ...
    def __init__(__self__, *,
                 is_read_from_head: Optional[builtins.bool] = None):
        """
        :param builtins.bool is_read_from_head: (Updatable) Starts to read the logs from the head of the file or the last read position recorded in pos_file, not tail.
        """
    ...
    def is_read_from_head(self) -> Optional[builtins.bool]:
        """
...
class UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParser(dict):
    ...
    def __init__(__self__, *,
                 ...
                 field_time_key: Optional[builtins.str] = None,
                 format_firstline: Optional[builtins.str] = None,
                 formats: Optional[Sequence[builtins.str]] = None,
                 grok_failure_key: Optional[builtins.str] = None,
                 grok_name_key: Optional[builtins.str] = None,
                 is_estimate_current_event: Optional[builtins.bool] = None,
                 is_keep_time_key: Optional[builtins.bool] = None,
                 is_merge_cri_fields: Optional[builtins.bool] = None,
                 is_null_empty_string: Optional[builtins.bool] = None,
                 is_support_colonless_ident: Optional[builtins.bool] = None,
                 is_with_priority: Optional[builtins.bool] = None,
                 keys: Optional[Sequence[builtins.str]] = None,
                 message_format: Optional[builtins.str] = None,
                 message_key: Optional[builtins.str] = None,
                 multi_line_start_regexp: Optional[builtins.str] = None,
                 ...
                 null_value_pattern: Optional[builtins.str] = None,
                 parse_nested: Optional[builtins.bool] = None,
                 ...
                 rfc5424time_format: Optional[builtins.str] = None,
                 separator: Optional[builtins.str] = None,
                 syslog_parser_type: Optional[builtins.str] = None,
                 time_format: Optional[builtins.str] = None,
                 time_type: Optional[builtins.str] = None,
                 timeout_in_milliseconds: Optional[builtins.int] = None,
                 types: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.str parser_type: (Updatable) Type of fluent parser.
        :param builtins.str delimiter: (Updatable) CSV delimiter.
        :param builtins.str expression: (Updatable) Regex pattern.
        :param builtins.str field_time_key: (Updatable) Specifies the time field for the event time. If the event doesn't have this field, the current time is used.
        :param builtins.str format_firstline: (Updatable) First line pattern format.
        :param Sequence[builtins.str] formats: (Updatable) Mutiline pattern format.
        :param builtins.str grok_failure_key: (Updatable) Grok failure key.
        :param builtins.str grok_name_key: (Updatable) Grok name key.
        :param builtins.bool is_estimate_current_event: (Updatable) If true, use Fluent::EventTime.now(current time) as a timestamp when the time_key is specified.
        :param builtins.bool is_keep_time_key: (Updatable) If true, keep the time field in the record.
        :param builtins.bool is_merge_cri_fields: (Updatable) If you don't need stream or logtag fields, set this to false.
        :param builtins.bool is_null_empty_string: (Updatable) If true, an empty string field is replaced with a null value.
        :param builtins.bool is_support_colonless_ident: (Updatable) Specifies whether or not to support colonless ident. Corresponds to the Fluentd support_colonless_ident parameter.
        :param builtins.bool is_with_priority: (Updatable) Specifies with priority or not. Corresponds to the Fluentd with_priority parameter.
        :param Sequence[builtins.str] keys: (Updatable) CSV keys.
        :param builtins.str message_format: (Updatable) Syslog message format.
        :param builtins.str message_key: (Updatable) Specifies the field name to contain logs.
        :param builtins.str multi_line_start_regexp: (Updatable) Multiline start regexp pattern.
        ...
        :param builtins.str null_value_pattern: (Updatable) Specify the null value pattern.
        :param builtins.bool parse_nested: (Updatable) If true, a separator parameter can be further defined.
        ...
        :param builtins.str rfc5424time_format: (Updatable) RFC 5424 time format.
        :param builtins.str separator: (Updatable) Keys of adjacent levels are joined by the separator.
        :param builtins.str syslog_parser_type: (Updatable) Syslog parser type.
        :param builtins.str time_format: (Updatable) Process time value using the specified format.
        :param builtins.str time_type: (Updatable) JSON parser time type.
        :param builtins.int timeout_in_milliseconds: (Updatable) Specify the timeout for parse processing. This is mainly for detecting an incorrect regexp pattern.
        :param Mapping[str, builtins.str] types: (Updatable) Specify types for converting a field into another type. For example, With this configuration: <parse> @type csv keys time,host,req_id,user time_key time </parse>
    ...
    def field_time_key(self) -> Optional[builtins.str]:
        """
    ...
    def format_firstline(self) -> Optional[builtins.str]:
        """
    ...
    def grok_failure_key(self) -> Optional[builtins.str]:
        """
    ...
    def grok_name_key(self) -> Optional[builtins.str]:
        """
    ...
    def is_estimate_current_event(self) -> Optional[builtins.bool]:
        """
    ...
    def is_keep_time_key(self) -> Optional[builtins.bool]:
        """
    ...
    def is_merge_cri_fields(self) -> Optional[builtins.bool]:
        """
    ...
    def is_null_empty_string(self) -> Optional[builtins.bool]:
        """
    ...
    def is_support_colonless_ident(self) -> Optional[builtins.bool]:
        """
    ...
    def is_with_priority(self) -> Optional[builtins.bool]:
        """
    ...
    def message_key(self) -> Optional[builtins.str]:
        """
    ...
    def multi_line_start_regexp(self) -> Optional[builtins.str]:
        """
    ...
    def null_value_pattern(self) -> Optional[builtins.str]:
        """
    ...
    def parse_nested(self) -> Optional[builtins.bool]:
        """
    ...
    def rfc5424time_format(self) -> Optional[builtins.str]:
        """
    ...
    def syslog_parser_type(self) -> Optional[builtins.str]:
        """
    ...
    def time_type(self) -> Optional[builtins.str]:
        """
    ...
    def timeout_in_milliseconds(self) -> Optional[builtins.int]:
        """
    ...
    @property
    @pulumi.getter
    def types(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParserNestedParser(dict):
    ...
    def __init__(__self__, *,
                 ...
                 time_type: Optional[builtins.str] = None):
        """
        :param builtins.str field_time_key: Specify the time field for the event time. If the event doesn't have this field, the current time is used.
        :param builtins.bool is_keep_time_key: If true, keep the time field in the record.
        :param builtins.bool parse_nested: (Updatable) If true, a separator parameter can be further defined.
        :param builtins.str separator: (Updatable) Keys of adjacent levels are joined by the separator.
        :param builtins.str time_format: (Updatable) Process time value using the specified format.
        :param builtins.str time_type: (Updatable) JSON parser time type.
...
class UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParserPattern(dict):
    ...
    def __init__(__self__, *,
                 field_time_format: Optional[builtins.str] = None,
                 field_time_key: Optional[builtins.str] = None,
                 field_time_zone: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 pattern: Optional[builtins.str] = None):
        """
        :param builtins.str field_time_format: (Updatable) Process value using the specified format. This is available only when time_type is a string.
        :param builtins.str field_time_key: (Updatable) Specify the time field for the event time. If the event doesn't have this field, the current time is used.
        :param builtins.str field_time_zone: (Updatable) Use the specified time zone. The time value can be parsed or formatted in the specified time zone.
        :param builtins.str name: (Updatable) The name key to tag this Grok pattern.
        :param builtins.str pattern: (Updatable) The Grok pattern.
        """
    ...
    def field_time_format(self) -> Optional[builtins.str]:
        """
    ...
    def field_time_zone(self) -> Optional[builtins.str]:
        """
...
class UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParserRecordInput(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, builtins.str] dimensions: (Updatable) Dimensions to be added for metrics.
        :param builtins.str namespace: (Updatable) Namespace to emit metrics.
        :param builtins.str resource_group: (Updatable) Resource group to emit metrics.
        """
...
class UnifiedAgentConfigurationServiceConfigurationApplicationConfigurationUnifiedAgentConfigurationFilter(dict):
    ...
    def __init__(__self__, *,
                 allow_lists: Optional[Sequence[builtins.str]] = None,
                 deny_lists: Optional[Sequence[builtins.str]] = None,
                 filter_type: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] allow_lists: (Updatable) List of metrics regex to be allowed.
        :param Sequence[builtins.str] deny_lists: (Updatable) List of metrics regex to be denied.
        :param builtins.str filter_type: (Updatable) Unified schema logging filter type.
        :param builtins.str name: (Updatable) Unique name for the filter.
        """
    ...
    def allow_lists(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def deny_lists(self) -> Optional[Sequence[builtins.str]]:
        """
...
class UnifiedAgentConfigurationServiceConfigurationDestination(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str log_object_id: (Updatable) The OCID of the resource.
    ...
    def log_object_id(self) -> builtins.str:
        """
...
class UnifiedAgentConfigurationServiceConfigurationDestinationOperationalMetricsConfigurationSource(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str type: (Updatable) Type of the unified monitoring agent operational metrics source object.
        :param Sequence[builtins.str] metrics: (Updatable) List of unified monitoring agent operational metrics.
        """
        pulumi.set(__self__, "record_input", record_input)
...
class UnifiedAgentConfigurationServiceConfigurationDestinationOperationalMetricsConfigurationSourceRecordInput(dict):
    ...
    def __init__(__self__, *,
                 ...
                 resource_group: Optional[builtins.str] = None):
        """
        :param builtins.str namespace: (Updatable) Namespace to emit the operational metrics.
        :param builtins.str resource_group: (Updatable) Resource group to emit the operational metrics.
        """
        pulumi.set(__self__, "namespace", namespace)
        if resource_group is not None:
            pulumi.set(__self__, "resource_group", resource_group)
...
class UnifiedAgentConfigurationServiceConfigurationSource(dict):
    ...
    def __init__(__self__, *,
                 ...
                 custom_plugin: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
        ...
        :param Sequence[builtins.str] channels: (Updatable) Windows event log channels.
        :param builtins.str custom_plugin: (Updatable) User customized source plugin.
        :param builtins.str name: (Updatable) Unique name for the source.
    ...
    def custom_plugin(self) -> Optional[builtins.str]:
        """
...
class UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilter(dict):
    ...
    def __init__(__self__, *,
                 ...
                 custom_filter_type: Optional[builtins.str] = None,
                 ...
                 emit_invalid_record_to_error: Optional[builtins.bool] = None,
                 hash_value_field: Optional[builtins.str] = None,
                 inject_key_prefix: Optional[builtins.str] = None,
                 is_auto_typecast_enabled: Optional[builtins.bool] = None,
                 is_renew_record_enabled: Optional[builtins.bool] = None,
                 is_ruby_enabled: Optional[builtins.bool] = None,
                 keep_keys: Optional[Sequence[builtins.str]] = None,
                 ...
                 remove_key_name_field: Optional[builtins.bool] = None,
                 remove_keys: Optional[Sequence[builtins.str]] = None,
                 renew_time_key: Optional[builtins.str] = None,
                 replace_invalid_sequence: Optional[builtins.bool] = None,
                 reserve_data: Optional[builtins.bool] = None,
                 reserve_time: Optional[builtins.bool] = None):
        """
        :param builtins.str filter_type: (Updatable) Unified schema logging filter type.
        :param builtins.str name: (Updatable) Unique name for the filter.
        ...
        :param builtins.str custom_filter_type: (Updatable) Type of the custom filter
        ...
        :param builtins.bool emit_invalid_record_to_error: (Updatable) If true, emit invalid record to @ERROR label. Invalid cases are: 1) key does not exist; 2) the format does not match; or 3) an unexpected error. You can rescue unexpected format logs in the @ERROR lable. If you want to ignore these errors, set this to false.
        :param builtins.str hash_value_field: (Updatable) Store the parsed values as a hash value in a field.
        :param builtins.str inject_key_prefix: (Updatable) Store the parsed values with the specified key name prefix.
        :param builtins.bool is_auto_typecast_enabled: (Updatable) If true, automatically casts the field types.
        :param builtins.bool is_renew_record_enabled: (Updatable) If true, it modifies a new empty hash
        :param builtins.bool is_ruby_enabled: (Updatable) When set to true, the full Ruby syntax is enabled in the ${} expression.
        :param Sequence[builtins.str] keep_keys: (Updatable) A list of keys to keep. Only relevant if isRenewRecordEnabled is set to true
        :param builtins.str key_name: (Updatable) The field name in the record to parse.
        :param Mapping[str, builtins.str] params: (Updatable) Parameters of the custom filter
        ...
        :param builtins.bool remove_key_name_field: (Updatable) If true, remove the keyName field when parsing is succeeded.
        :param Sequence[builtins.str] remove_keys: (Updatable) A list of keys to delete
        :param builtins.str renew_time_key: (Updatable) Overwrites the time of logs with this value, this value must be a Unix timestamp.
        :param builtins.bool replace_invalid_sequence: (Updatable) If true, the invalid string is replaced with safe characters and is re-parsed.
        :param builtins.bool reserve_data: (Updatable) If true, keep the original key-value pair in the parsed result.
        :param builtins.bool reserve_time: (Updatable) If true, keep the original event time in the parsed result.
    ...
    def custom_filter_type(self) -> Optional[builtins.str]:
        """
    ...
    def emit_invalid_record_to_error(self) -> Optional[builtins.bool]:
        """
    ...
    def hash_value_field(self) -> Optional[builtins.str]:
        """
    ...
    def inject_key_prefix(self) -> Optional[builtins.str]:
        """
    ...
    def is_auto_typecast_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def is_renew_record_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def is_ruby_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def keep_keys(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def remove_key_name_field(self) -> Optional[builtins.bool]:
        """
    ...
    def remove_keys(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def renew_time_key(self) -> Optional[builtins.str]:
        """
    ...
    def replace_invalid_sequence(self) -> Optional[builtins.bool]:
        """
    ...
    def reserve_data(self) -> Optional[builtins.bool]:
        """
    ...
    def reserve_time(self) -> Optional[builtins.bool]:
        """
...
class UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterAllowList(dict):
    def __init__(__self__, *,
                 ...
                 pattern: Optional[builtins.str] = None):
        """
        :param builtins.str key: (Updatable) The field name to which the regular expression is applied
        :param builtins.str pattern: (Updatable) The regular expression
        """
        if key is not None:
...
class UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterCustomSection(dict):
    def __init__(__self__, *,
                 ...
                 params: Optional[Mapping[str, builtins.str]] = None):
        """
        :param builtins.str name: (Updatable) The name of the custom section
        :param Mapping[str, builtins.str] params: (Updatable) Parameters in the custom section
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if params is not None:
...
class UnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterRecordList(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key: (Updatable) A new key
        :param builtins.str value: (Updatable) A new value
        """
        if key is not None:
            pulumi.set(__self__, "key", key)
...
class GetLogConfigurationSourceResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str category: Log object category.
        :param Mapping[str, builtins.str] parameters: Log category parameters are stored here.
        :param builtins.str resource: The unique identifier of the resource emitting the log.
        :param builtins.str service: Service generating log.
        :param builtins.str source_type: The log source.
               * **OCISERVICE:** Oracle Service.
...
class GetLogGroupsLogGroupResult(dict):
    def __init__(__self__, *,
                 ...
                 time_last_modified: builtins.str):
        """
        ...
        :param builtins.str state: The log group object state.
        :param builtins.str time_created: Time the resource was created.
        :param builtins.str time_last_modified: Time the resource was last modified.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
...
class GetLogSavedSearchesLogSavedSearchSummaryCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str id: The OCID of the resource.
        :param builtins.str name: Resource name.
        :param builtins.str query: The search query that is saved.
        :param builtins.str state: The state of the LogSavedSearch
        :param builtins.str time_created: Time the resource was created.
        :param builtins.str time_last_modified: Time the resource was last modified.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
...
class GetLogsLogResult(dict):
    def __init__(__self__, *,
        ...
        :param Mapping[str, builtins.str] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param builtins.str id: The OCID of the resource.
        :param builtins.bool is_enabled: Whether or not this resource is currently enabled.
        ...
        :param builtins.int retention_duration: Log retention duration in 30-day increments (30, 60, 90 and so on until 180).
...
class GetUnifiedAgentConfigurationGroupAssociationResult(dict):
    def __init__(__self__, *,
                 group_lists: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] group_lists: list of group/dynamic group ids associated with this configuration.
        """
        pulumi.set(__self__, "group_lists", group_lists)

    @property
    @pulumi.getter(name="groupLists")
    def group_lists(self) -> Sequence[builtins.str]:
        """
...
class GetUnifiedAgentConfigurationServiceConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str configuration_type: Type of Unified Agent service configuration.
...
class GetUnifiedAgentConfigurationServiceConfigurationApplicationConfigurationResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str source_type: Unified schema logging source type.
...
class GetUnifiedAgentConfigurationServiceConfigurationApplicationConfigurationDestinationResult(dict):
    def __init__(__self__, *,
                 compartment_id: builtins.str,
                 metrics_namespace: builtins.str):
        """
        :param builtins.str compartment_id: The OCID of the compartment that the resource belongs to.
        :param builtins.str metrics_namespace: Namespace to which metrics will be emitted.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "metrics_namespace", metrics_namespace)
    ...
    @property
    @pulumi.getter(name="metricsNamespace")
    def metrics_namespace(self) -> builtins.str:
        """
...
class GetUnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceResult(dict):
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] paths: Absolute paths for log source files. Wildcards can be used.
        :param builtins.str source_type: Unified schema logging source type.
        """
        pulumi.set(__self__, "advanced_options", advanced_options)
        pulumi.set(__self__, "name", name)
...
class GetUnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceAdvancedOptionResult(dict):
    def __init__(__self__, *,
                 is_read_from_head: builtins.bool):
        """
        :param builtins.bool is_read_from_head: Starts to read the logs from the head of the file or the last read position recorded in pos_file, not tail.
        """
        pulumi.set(__self__, "is_read_from_head", is_read_from_head)

    @property
    @pulumi.getter(name="isReadFromHead")
    def is_read_from_head(self) -> builtins.bool:
        """
...
class GetUnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParserResult(dict):
    def __init__(__self__, *,
                 ...
                 field_time_key: builtins.str,
                 format_firstline: builtins.str,
                 formats: Sequence[builtins.str],
                 grok_failure_key: builtins.str,
                 grok_name_key: builtins.str,
                 is_estimate_current_event: builtins.bool,
                 is_keep_time_key: builtins.bool,
                 is_merge_cri_fields: builtins.bool,
                 is_null_empty_string: builtins.bool,
                 is_support_colonless_ident: builtins.bool,
                 is_with_priority: builtins.bool,
                 keys: Sequence[builtins.str],
                 message_format: builtins.str,
                 message_key: builtins.str,
                 multi_line_start_regexp: builtins.str,
                 ...
                 null_value_pattern: builtins.str,
                 parse_nested: builtins.bool,
                 parser_type: builtins.str,
                 ...
                 rfc5424time_format: builtins.str,
                 separator: builtins.str,
                 syslog_parser_type: builtins.str,
                 time_format: builtins.str,
                 time_type: builtins.str,
                 timeout_in_milliseconds: builtins.int,
                 types: Mapping[str, builtins.str]):
        """
        :param builtins.str delimiter: CSV delimiter.
        :param builtins.str expression: Regex pattern.
        :param builtins.str field_time_key: Specify the time field for the event time. If the event doesn't have this field, the current time is used.
        :param builtins.str format_firstline: First line pattern format.
        :param Sequence[builtins.str] formats: Mutiline pattern format.
        :param builtins.str grok_failure_key: Grok failure key.
        :param builtins.str grok_name_key: Grok name key.
        :param builtins.bool is_estimate_current_event: If true, use Fluent::EventTime.now(current time) as a timestamp when the time_key is specified.
        :param builtins.bool is_keep_time_key: If true, keep the time field in the record.
        :param builtins.bool is_merge_cri_fields: If you don't need stream or logtag fields, set this to false.
        :param builtins.bool is_null_empty_string: If true, an empty string field is replaced with a null value.
        :param builtins.bool is_support_colonless_ident: Specifies whether or not to support colonless ident. Corresponds to the Fluentd support_colonless_ident parameter.
        :param builtins.bool is_with_priority: Specifies with priority or not. Corresponds to the Fluentd with_priority parameter.
        :param Sequence[builtins.str] keys: CSV keys.
        :param builtins.str message_format: Syslog message format.
        :param builtins.str message_key: Specifies the field name to contain logs.
        :param builtins.str multi_line_start_regexp: Multiline start regexp pattern.
        ...
        :param builtins.str null_value_pattern: Specify the null value pattern.
        :param builtins.bool parse_nested: If true, a separator parameter can be further defined.
        :param builtins.str parser_type: Type of fluent parser.
        ...
        :param builtins.str rfc5424time_format: RFC 5424 time format.
        :param builtins.str separator: Keys of adjacent levels are joined by the separator.
        :param builtins.str syslog_parser_type: Syslog parser type.
        :param builtins.str time_format: Process time value using the specified format.
        :param builtins.str time_type: JSON parser time type.
        :param builtins.int timeout_in_milliseconds: Specify the timeout for parse processing. This is mainly for detecting an incorrect regexp pattern.
        :param Mapping[str, builtins.str] types: Specify types for converting a field into another type. For example, With this configuration: <parse> @type csv keys time,host,req_id,user time_key time </parse>
        """
        pulumi.set(__self__, "delimiter", delimiter)
        pulumi.set(__self__, "expression", expression)
        pulumi.set(__self__, "field_time_key", field_time_key)
    ...
    @property
    @pulumi.getter(name="fieldTimeKey")
    def field_time_key(self) -> builtins.str:
        """
        Specify the time field for the event time. If the event doesn't have this field, the current time is used.
        """
        return pulumi.get(self, "field_time_key")
    ...
    @property
    @pulumi.getter(name="formatFirstline")
    def format_firstline(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter
    def formats(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="grokFailureKey")
    def grok_failure_key(self) -> builtins.str:
        """
        Grok failure key.
        """
        return pulumi.get(self, "grok_failure_key")
    ...
    @property
    @pulumi.getter(name="grokNameKey")
    def grok_name_key(self) -> builtins.str:
        """
        Grok name key.
        """
        return pulumi.get(self, "grok_name_key")
    ...
    @property
    @pulumi.getter(name="isEstimateCurrentEvent")
    def is_estimate_current_event(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="isKeepTimeKey")
    def is_keep_time_key(self) -> builtins.bool:
        """
        If true, keep the time field in the record.
        """
        return pulumi.get(self, "is_keep_time_key")
    ...
    @property
    @pulumi.getter(name="isMergeCriFields")
    def is_merge_cri_fields(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="isNullEmptyString")
    def is_null_empty_string(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="isSupportColonlessIdent")
    def is_support_colonless_ident(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="isWithPriority")
    def is_with_priority(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="messageKey")
    def message_key(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="multiLineStartRegexp")
    def multi_line_start_regexp(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="nullValuePattern")
    def null_value_pattern(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="parseNested")
    def parse_nested(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="rfc5424timeFormat")
    def rfc5424time_format(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="syslogParserType")
    def syslog_parser_type(self) -> builtins.str:
        """
        Syslog parser type.
        """
        return pulumi.get(self, "syslog_parser_type")
    ...
    @property
    @pulumi.getter(name="timeType")
    def time_type(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="timeoutInMilliseconds")
    def timeout_in_milliseconds(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter
    def types(self) -> Mapping[str, builtins.str]:
        """
...
class GetUnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParserPatternResult(dict):
    def __init__(__self__, *,
                 field_time_format: builtins.str,
                 field_time_key: builtins.str,
                 field_time_zone: builtins.str,
                 name: builtins.str,
                 pattern: builtins.str):
        """
        :param builtins.str field_time_format: Process value using the specified format. This is available only when time_type is a string.
        :param builtins.str field_time_key: Specify the time field for the event time. If the event doesn't have this field, the current time is used.
        :param builtins.str field_time_zone: Use the specified time zone. The time value can be parsed or formatted in the specified time zone.
        :param builtins.str name: The name key to tag this Grok pattern.
        :param builtins.str pattern: The Grok pattern.
        """
        pulumi.set(__self__, "field_time_format", field_time_format)
        pulumi.set(__self__, "field_time_key", field_time_key)
        pulumi.set(__self__, "field_time_zone", field_time_zone)
    ...
    @property
    @pulumi.getter(name="fieldTimeFormat")
    def field_time_format(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="fieldTimeZone")
    def field_time_zone(self) -> builtins.str:
        """
...
class GetUnifiedAgentConfigurationServiceConfigurationApplicationConfigurationSourceParserRecordInputResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param Mapping[str, builtins.str] dimensions: Dimensions to be added for metrics.
        :param builtins.str namespace: Namespace to emit metrics.
        :param builtins.str resource_group: Resource group to emit metrics.
        """
        pulumi.set(__self__, "dimensions", dimensions)
        pulumi.set(__self__, "namespace", namespace)
        pulumi.set(__self__, "resource_group", resource_group)
...
class GetUnifiedAgentConfigurationServiceConfigurationApplicationConfigurationUnifiedAgentConfigurationFilterResult(dict):
    def __init__(__self__, *,
                 ...
                 deny_lists: Sequence[builtins.str],
                 filter_type: builtins.str,
                 name: builtins.str):
        """
        :param Sequence[builtins.str] allow_lists: A list of filtering rules to include logs
        :param Sequence[builtins.str] deny_lists: A list of filtering rules to reject logs
        :param builtins.str filter_type: Unified schema logging filter type.
        :param builtins.str name: The name key to tag this Grok pattern.
        """
        pulumi.set(__self__, "allow_lists", allow_lists)
        pulumi.set(__self__, "deny_lists", deny_lists)
    ...
    @property
    @pulumi.getter(name="denyLists")
    def deny_lists(self) -> Sequence[builtins.str]:
        """
...
class GetUnifiedAgentConfigurationServiceConfigurationDestinationResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str log_object_id: The OCID of the resource.
...
class GetUnifiedAgentConfigurationServiceConfigurationDestinationOperationalMetricsConfigurationSourceResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param Sequence[builtins.str] metrics: List of unified monitoring agent operational metrics.
        ...
        :param builtins.str type: Type of the unified monitoring agent operational metrics source object.
        """
        pulumi.set(__self__, "metrics", metrics)
        pulumi.set(__self__, "record_inputs", record_inputs)
        pulumi.set(__self__, "type", type)
...
class GetUnifiedAgentConfigurationServiceConfigurationSourceResult(dict):
    def __init__(__self__, *,
                 ...
                 channels: Sequence[builtins.str],
                 custom_plugin: builtins.str,
                 name: builtins.str,
        ...
        :param Sequence[builtins.str] channels: Windows event log channels.
        :param builtins.str custom_plugin: User customized source plugin.
        :param builtins.str name: The name key to tag this Grok pattern.
    ...
    @property
    @pulumi.getter(name="customPlugin")
    def custom_plugin(self) -> builtins.str:
        """
...
class GetUnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterResult(dict):
    def __init__(__self__, *,
                 ...
                 custom_filter_type: builtins.str,
                 ...
                 emit_invalid_record_to_error: builtins.bool,
                 filter_type: builtins.str,
                 hash_value_field: builtins.str,
                 inject_key_prefix: builtins.str,
                 is_auto_typecast_enabled: builtins.bool,
                 is_renew_record_enabled: builtins.bool,
                 is_ruby_enabled: builtins.bool,
                 keep_keys: Sequence[builtins.str],
                 ...
                 remove_key_name_field: builtins.bool,
                 remove_keys: Sequence[builtins.str],
                 renew_time_key: builtins.str,
                 replace_invalid_sequence: builtins.bool,
                 reserve_data: builtins.bool,
                 reserve_time: builtins.bool):
        """
        ...
        :param builtins.str custom_filter_type: Type of the custom filter
        ...
        :param builtins.bool emit_invalid_record_to_error: If true, emit invalid record to @ERROR label. Invalid cases are: 1) key does not exist; 2) the format does not match; or 3) an unexpected error. You can rescue unexpected format logs in the @ERROR lable. If you want to ignore these errors, set this to false.
        :param builtins.str filter_type: Unified schema logging filter type.
        :param builtins.str hash_value_field: Store the parsed values as a hash value in a field.
        :param builtins.str inject_key_prefix: Store the parsed values with the specified key name prefix.
        :param builtins.bool is_auto_typecast_enabled: If true, automatically casts the field types.
        :param builtins.bool is_renew_record_enabled: If true, it modifies a new empty hash
        :param builtins.bool is_ruby_enabled: When set to true, the full Ruby syntax is enabled in the ${} expression.
        :param Sequence[builtins.str] keep_keys: A list of keys to keep. Only relevant if isRenewRecordEnabled is set to true
        :param builtins.str key_name: The field name in the record to parse.
        :param builtins.str name: The name key to tag this Grok pattern.
        :param Mapping[str, builtins.str] params: Parameters of the custom filter
        ...
        :param builtins.bool remove_key_name_field: If true, remove the keyName field when parsing is succeeded.
        :param Sequence[builtins.str] remove_keys: A list of keys to delete
        :param builtins.str renew_time_key: Overwrites the time of logs with this value, this value must be a Unix timestamp.
        :param builtins.bool replace_invalid_sequence: If true, the invalid string is replaced with safe characters and is re-parsed.
        :param builtins.bool reserve_data: If true, keep the original key-value pair in the parsed result.
        :param builtins.bool reserve_time: If true, keep the original event time in the parsed result.
        """
        pulumi.set(__self__, "allow_lists", allow_lists)
        pulumi.set(__self__, "custom_filter_type", custom_filter_type)
        pulumi.set(__self__, "custom_sections", custom_sections)
    ...
    @property
    @pulumi.getter(name="customFilterType")
    def custom_filter_type(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="emitInvalidRecordToError")
    def emit_invalid_record_to_error(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="hashValueField")
    def hash_value_field(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="injectKeyPrefix")
    def inject_key_prefix(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="isAutoTypecastEnabled")
    def is_auto_typecast_enabled(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="isRenewRecordEnabled")
    def is_renew_record_enabled(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="isRubyEnabled")
    def is_ruby_enabled(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="keepKeys")
    def keep_keys(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="removeKeyNameField")
    def remove_key_name_field(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="removeKeys")
    def remove_keys(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="renewTimeKey")
    def renew_time_key(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="replaceInvalidSequence")
    def replace_invalid_sequence(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="reserveData")
    def reserve_data(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="reserveTime")
    def reserve_time(self) -> builtins.bool:
        """
...
class GetUnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterAllowListResult(dict):
    def __init__(__self__, *,
                 ...
                 pattern: builtins.str):
        """
        :param builtins.str key: A new key
        :param builtins.str pattern: The Grok pattern.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "pattern", pattern)
...
class GetUnifiedAgentConfigurationServiceConfigurationUnifiedAgentConfigurationFilterRecordListResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key: A new key
        :param builtins.str value: A new value
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "value", value)
...
class GetUnifiedAgentConfigurationsUnifiedAgentConfigurationCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str compartment_id: Compartment OCID to list resources in. See compartmentIdInSubtree for nested compartments traversal.
        :param builtins.str configuration_state: State of unified agent service configuration.
        :param builtins.str configuration_type: Type of Unified Agent service configuration.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param builtins.str description: Description for this resource.
        :param builtins.str display_name: Resource name.
