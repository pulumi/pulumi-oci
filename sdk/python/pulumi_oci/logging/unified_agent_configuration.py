...
class UnifiedAgentConfigurationArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Description for this resource.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The user-friendly display name. This must be unique within the enclosing resource, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) Whether or not this resource is currently enabled.
...
class _UnifiedAgentConfigurationState:
    def __init__(__self__, *,
                 ...
                 time_last_modified: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering UnifiedAgentConfiguration resources.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment that the resource belongs to.
        :param pulumi.Input[builtins.str] configuration_state: State of unified agent service configuration.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] description: (Updatable) Description for this resource.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The user-friendly display name. This must be unique within the enclosing resource, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        ...
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) Whether or not this resource is currently enabled.
        :param pulumi.Input['UnifiedAgentConfigurationServiceConfigurationArgs'] service_configuration: (Updatable) Top level Unified Agent service configuration object.
        :param pulumi.Input[builtins.str] state: The pipeline state.
        :param pulumi.Input[builtins.str] time_created: Time the resource was created.
        :param pulumi.Input[builtins.str] time_last_modified: Time the resource was last modified.
        """
    ...
    def time_last_modified(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_last_modified(self, value: Optional[pulumi.Input[builtins.str]]):
...
class UnifiedAgentConfiguration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_last_modified: Optional[pulumi.Input[builtins.str]] = None) -> 'UnifiedAgentConfiguration':
        """
    ...
    @property
    @pulumi.getter(name="timeLastModified")
    def time_last_modified(self) -> pulumi.Output[builtins.str]:
        """
        Time the resource was last modified.
        """
        return pulumi.get(self, "time_last_modified")
