...
def get_management_agent(management_agent_id: Optional[_builtins.str] = None,
...
def get_management_agent_output(management_agent_id: Optional[pulumi.Input[_builtins.str]] = None,
