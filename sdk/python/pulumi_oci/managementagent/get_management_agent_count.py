...
class GetManagementAgentCountResult:
    ...
    def has_plugins(self) -> Optional[builtins.bool]:
        """
...
def get_management_agent_count(compartment_id: Optional[builtins.str] = None,
                               group_bies: Optional[Sequence[builtins.str]] = None,
                               has_plugins: Optional[builtins.bool] = None,
    ...
    :param Sequence[builtins.str] group_bies: The field by which to group Management Agents. Currently, only one groupBy dimension is supported at a time.
...
def get_management_agent_count_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                      group_bies: Optional[pulumi.Input[Sequence[builtins.str]]] = None,
                                      has_plugins: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
