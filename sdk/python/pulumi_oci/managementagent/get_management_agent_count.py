...
class GetManagementAgentCountResult:
    ...
    def has_plugins(self) -> Optional[_builtins.bool]:
        """
...
def get_management_agent_count(compartment_id: Optional[_builtins.str] = None,
                               group_bies: Optional[Sequence[_builtins.str]] = None,
                               has_plugins: Optional[_builtins.bool] = None,
    ...
    :param Sequence[_builtins.str] group_bies: The field by which to group Management Agents. Currently, only one groupBy dimension is supported at a time.
