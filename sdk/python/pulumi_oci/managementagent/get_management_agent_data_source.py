...
class GetManagementAgentDataSourceResult:
    ...
    def read_data_limit_in_kilobytes(self) -> builtins.int:
...
def get_management_agent_data_source(data_source_key: Optional[builtins.str] = None,
    ...
    :param builtins.str data_source_key: Data source type and name identifier.
...
def get_management_agent_data_source_output(data_source_key: Optional[pulumi.Input[builtins.str]] = None,
