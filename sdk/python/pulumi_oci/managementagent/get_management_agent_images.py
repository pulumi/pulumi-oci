...
def get_management_agent_images(compartment_id: Optional[builtins.str] = None,
...
def get_management_agent_images_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
