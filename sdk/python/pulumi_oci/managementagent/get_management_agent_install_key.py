...
class GetManagementAgentInstallKeyResult:
    ...
    def management_agent_install_key_id(self) -> builtins.str:
...
def get_management_agent_install_key(management_agent_install_key_id: Optional[builtins.str] = None,
    ...
    :param builtins.str management_agent_install_key_id: Unique Management Agent Install Key identifier
    """
    __args__ = dict()
...
def get_management_agent_install_key_output(management_agent_install_key_id: Optional[pulumi.Input[builtins.str]] = None,
