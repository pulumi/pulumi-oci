...
def get_management_agent_plugin_count(compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str group_by: The field by which to group Management Agent Plugins
    """
    __args__ = dict()
...
def get_management_agent_plugin_count_output(compartment_id: Optional[pulumi.Input[_builtins.str]] = None,
