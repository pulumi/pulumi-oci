...
def get_management_agent_plugins(agent_id: Optional[builtins.str] = None,
    ...
    :param builtins.str agent_id: The ManagementAgentID of the agent from which the Management Agents to be filtered.
...
def get_management_agent_plugins_output(agent_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
