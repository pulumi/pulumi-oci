...
class GetManagementAgentsResult:
    ...
    def data_source_names(self) -> Optional[Sequence[builtins.str]]:
        return pulumi.get(self, "data_source_names")

    @property
    @pulumi.getter(name="dataSourceType")
    def data_source_type(self) -> Optional[builtins.str]:
    ...
    def install_type(self) -> Optional[builtins.str]:
        """
    ...
    def is_customer_deployed(self) -> Optional[builtins.bool]:
        """
    ...
    def platform_types(self) -> Optional[Sequence[builtins.str]]:
        """
        Platform Type
        """
    ...
    def plugin_names(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def wait_for_host_id(self) -> Optional[builtins.int]:
...
def get_management_agents(access_level: Optional[builtins.str] = None,
                          ...
                          data_source_names: Optional[Sequence[builtins.str]] = None,
                          data_source_type: Optional[builtins.str] = None,
                          ...
                          install_type: Optional[builtins.str] = None,
                          is_customer_deployed: Optional[builtins.bool] = None,
                          platform_types: Optional[Sequence[builtins.str]] = None,
                          plugin_names: Optional[Sequence[builtins.str]] = None,
                          state: Optional[builtins.str] = None,
                          versions: Optional[Sequence[builtins.str]] = None,
                          wait_for_host_id: Optional[builtins.int] = None,
    ...
    :param builtins.str access_level: When the value is "ACCESSIBLE", insufficient permissions for a compartment will filter out resources in that compartment without rejecting the request.
    ...
    :param Sequence[builtins.str] data_source_names: Unique name of the dataSource.
    :param builtins.str data_source_type: The type of the dataSource.
    :param builtins.str display_name: Filter to return only Management Agents having the particular display name.
    :param Sequence[builtins.str] gateway_ids: Filter to return only results having the particular gatewayId.
    ...
    :param Sequence[builtins.str] platform_types: Array of PlatformTypes to return only results having the particular platform types. Example: ["LINUX"]
    :param Sequence[builtins.str] plugin_names: Array of pluginName to return only Management Agents having the particular Plugins installed. A special pluginName of 'None' can be provided and this will return only Management Agents having no plugin installed. Example: ["PluginA"]
    :param builtins.str state: Filter to return only Management Agents in the particular lifecycle state.
    :param Sequence[builtins.str] versions: Array of versions to return only Management Agents having the particular agent versions. Example: ["202020.0101","210201.0513"]
    :param builtins.int wait_for_host_id: When host_id argument is set, the data source will wait for the given period of time (in minutes) for this host_id to become available. This can be used when compute instance with Management Agent has been recently created.
    """
    __args__ = dict()
...
def get_management_agents_output(access_level: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 availability_status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                 compartment_id_in_subtree: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                 data_source_names: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                 data_source_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 ...
                                 gateway_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                 host_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 install_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 is_customer_deployed: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                 platform_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                 plugin_names: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                 state: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 versions: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                 wait_for_host_id: Optional[pulumi.Input[Optional[builtins.int]]] = None,
