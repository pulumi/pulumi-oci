...
class ManagementAgentArgs:
    def __init__(__self__, *,
                 managed_agent_id: pulumi.Input[builtins.str],
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 deploy_plugins_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a ManagementAgent resource.
        :param pulumi.Input[builtins.str] managed_agent_id: Unique Management Agent identifier
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) New displayName of Agent.
    ...
    def managed_agent_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def managed_agent_id(self, value: pulumi.Input[builtins.str]):
    ...
    def deploy_plugins_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        return pulumi.get(self, "deploy_plugins_ids")

    @deploy_plugins_ids.setter
    def deploy_plugins_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _ManagementAgentState:
    def __init__(__self__, *,
                 ...
                 install_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 install_path: Optional[pulumi.Input[builtins.str]] = None,
                 install_type: Optional[pulumi.Input[builtins.str]] = None,
                 is_agent_auto_upgradable: Optional[pulumi.Input[builtins.bool]] = None,
                 is_customer_deployed: Optional[pulumi.Input[builtins.bool]] = None,
                 lifecycle_details: Optional[pulumi.Input[builtins.str]] = None,
                 managed_agent_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 resource_artifact_version: Optional[pulumi.Input[builtins.str]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 time_created: Optional[pulumi.Input[builtins.str]] = None,
                 time_last_heartbeat: Optional[pulumi.Input[builtins.str]] = None,
                 time_updated: Optional[pulumi.Input[builtins.str]] = None,
                 version: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering ManagementAgent resources.
        :param pulumi.Input[builtins.str] availability_status: The current availability status of managementAgent
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) New displayName of Agent.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] host: Management Agent host machine name
        :param pulumi.Input[builtins.str] host_id: Host resource ocid
        :param pulumi.Input[builtins.str] install_key_id: agent install key identifier
        :param pulumi.Input[builtins.str] install_path: Path where Management Agent is installed
        :param pulumi.Input[builtins.str] install_type: The install type, either AGENT or GATEWAY
        :param pulumi.Input[builtins.bool] is_agent_auto_upgradable: true if the agent can be upgraded automatically; false if it must be upgraded manually. This flag is derived from the tenancy level auto upgrade preference.
        :param pulumi.Input[builtins.bool] is_customer_deployed: true, if the agent image is manually downloaded and installed. false, if the agent is deployed as a plugin in Oracle Cloud Agent.
        ...
        :param pulumi.Input[builtins.str] resource_artifact_version: Version of the deployment artifact instantiated by this Management Agent. The format for Standalone resourceMode is YYMMDD.HHMM, and the format for other modes (whose artifacts are based upon Standalone but can advance independently) is YYMMDD.HHMM.VVVVVVVVVVVV. VVVVVVVVVVVV is always a numeric value between 000000000000 and 999999999999
        ...
        :param pulumi.Input[builtins.str] time_last_heartbeat: The time the Management Agent has last recorded its health status in telemetry. This value will be null if the agent has not recorded its health status in last 7 days. An RFC3339 formatted datetime string
        ...
        :param pulumi.Input[builtins.str] version: Management Agent Version
        """
    ...
    def install_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def install_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "install_key_id", value)

    @property
    @pulumi.getter(name="installPath")
    def install_path(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @install_path.setter
    def install_path(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "install_path", value)

    @property
    @pulumi.getter(name="installType")
    def install_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @install_type.setter
    def install_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "install_type", value)

    @property
    @pulumi.getter(name="isAgentAutoUpgradable")
    def is_agent_auto_upgradable(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_agent_auto_upgradable(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_agent_auto_upgradable", value)

    @property
    @pulumi.getter(name="isCustomerDeployed")
    def is_customer_deployed(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_customer_deployed(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter(name="managedAgentId")
    def managed_agent_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Unique Management Agent identifier
        """
        return pulumi.get(self, "managed_agent_id")
    ...
    @managed_agent_id.setter
    def managed_agent_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "managed_agent_id", value)
    ...
    def resource_artifact_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def resource_artifact_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_last_heartbeat(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_last_heartbeat(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ManagementAgent(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_last_heartbeat: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.str]] = None) -> 'ManagementAgent':
        """
    ...
    @property
    @pulumi.getter(name="deployPluginsIds")
    def deploy_plugins_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        return pulumi.get(self, "deploy_plugins_ids")
    ...
    @property
    @pulumi.getter(name="installKeyId")
    def install_key_id(self) -> pulumi.Output[builtins.str]:
        """
        agent install key identifier
        """
        return pulumi.get(self, "install_key_id")
    ...
    @property
    @pulumi.getter(name="installPath")
    def install_path(self) -> pulumi.Output[builtins.str]:
        """
        Path where Management Agent is installed
        """
        return pulumi.get(self, "install_path")
    ...
    @property
    @pulumi.getter(name="installType")
    def install_type(self) -> pulumi.Output[builtins.str]:
        """
        The install type, either AGENT or GATEWAY
        """
        return pulumi.get(self, "install_type")
    ...
    @property
    @pulumi.getter(name="isAgentAutoUpgradable")
    def is_agent_auto_upgradable(self) -> pulumi.Output[builtins.bool]:
        """
        true if the agent can be upgraded automatically; false if it must be upgraded manually. This flag is derived from the tenancy level auto upgrade preference.
        """
        return pulumi.get(self, "is_agent_auto_upgradable")
    ...
    @property
    @pulumi.getter(name="isCustomerDeployed")
    def is_customer_deployed(self) -> pulumi.Output[builtins.bool]:
        """
        true, if the agent image is manually downloaded and installed. false, if the agent is deployed as a plugin in Oracle Cloud Agent.
        """
        return pulumi.get(self, "is_customer_deployed")
    ...
    @property
    @pulumi.getter(name="managedAgentId")
    def managed_agent_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique Management Agent identifier
        """
        return pulumi.get(self, "managed_agent_id")
    ...
    @property
    @pulumi.getter(name="resourceArtifactVersion")
    def resource_artifact_version(self) -> pulumi.Output[builtins.str]:
        """
        Version of the deployment artifact instantiated by this Management Agent. The format for Standalone resourceMode is YYMMDD.HHMM, and the format for other modes (whose artifacts are based upon Standalone but can advance independently) is YYMMDD.HHMM.VVVVVVVVVVVV. VVVVVVVVVVVV is always a numeric value between 000000000000 and 999999999999
        """
        return pulumi.get(self, "resource_artifact_version")
    ...
    @property
    @pulumi.getter(name="timeLastHeartbeat")
    def time_last_heartbeat(self) -> pulumi.Output[builtins.str]:
        """
        The time the Management Agent has last recorded its health status in telemetry. This value will be null if the agent has not recorded its health status in last 7 days. An RFC3339 formatted datetime string
        """
        return pulumi.get(self, "time_last_heartbeat")
