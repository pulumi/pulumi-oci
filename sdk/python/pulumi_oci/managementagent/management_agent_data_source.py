...
class ManagementAgentDataSourceArgs:
    def __init__(__self__, *,
                 ...
                 management_agent_id: pulumi.Input[builtins.str],
                 ...
                 read_data_limit_in_kilobytes: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] management_agent_id: Unique Management Agent identifier
        :param pulumi.Input[builtins.str] type: (Updatable) The type of the DataSource. Support types: PROMETHEUS_EMITTER
        :param pulumi.Input[builtins.str] url: (Updatable) The url through which the Prometheus Exporter publishes its metrics. (http only)
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] allow_metrics: (Updatable) Comma separated metric name list. The complete set of desired scraped metrics. Use this property to limit the set of metrics uploaded if required.
        :param pulumi.Input[builtins.int] connection_timeout: (Updatable) Number in milliseconds. The timeout for connecting to the Prometheus Exporter's endpoint.
        ...
        :param pulumi.Input[builtins.str] name: Unique name of the DataSource.
        ...
        :param pulumi.Input[builtins.str] proxy_url: (Updatable) The url of the network proxy that provides access to the Prometheus Exporter's endpoint (url required property).
        :param pulumi.Input[builtins.int] read_data_limit_in_kilobytes: (Updatable) Number in kilobytes. The limit on the data being sent, not to exceed the agent's fixed limit of 400 (KB).
        :param pulumi.Input[builtins.int] read_timeout: (Updatable) Number in milliseconds. The timeout for reading the response from the Prometheus Exporter's endpoint.
        :param pulumi.Input[builtins.str] resource_group: (Updatable) Oracle Cloud Infrastructure monitoring resource group to assign the metric to.
        :param pulumi.Input[builtins.int] schedule_mins: (Updatable) Number in minutes. The scraping occurs at the specified interval.
        """
    ...
    def management_agent_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def management_agent_id(self, value: pulumi.Input[builtins.str]):
    ...
    def read_data_limit_in_kilobytes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def read_data_limit_in_kilobytes(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _ManagementAgentDataSourceState:
    def __init__(__self__, *,
                 ...
                 connection_timeout: Optional[pulumi.Input[builtins.int]] = None,
                 data_source_key: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] resource_group: (Updatable) Oracle Cloud Infrastructure monitoring resource group to assign the metric to.
        :param pulumi.Input[builtins.int] schedule_mins: (Updatable) Number in minutes. The scraping occurs at the specified interval.
        :param pulumi.Input[builtins.str] state: State of the DataSource.
        :param pulumi.Input[builtins.str] time_created: The time the DataSource was created. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.str] time_updated: The time the DataSource data was last received. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.str] type: (Updatable) The type of the DataSource. Support types: PROMETHEUS_EMITTER
        :param pulumi.Input[builtins.str] url: (Updatable) The url through which the Prometheus Exporter publishes its metrics. (http only)
    ...
    def data_source_key(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "data_source_key")

    @data_source_key.setter
    def data_source_key(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ManagementAgentDataSource(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            url: Optional[pulumi.Input[builtins.str]] = None) -> 'ManagementAgentDataSource':
        """
    ...
    @property
    @pulumi.getter(name="allowMetrics")
    def allow_metrics(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Comma separated metric name list. The complete set of desired scraped metrics. Use this property to limit the set of metrics uploaded if required.
        """
        return pulumi.get(self, "allow_metrics")
    ...
    @property
    @pulumi.getter(name="dataSourceKey")
    def data_source_key(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "data_source_key")

    @property
    @pulumi.getter(name="isDaemonSet")
    def is_daemon_set(self) -> pulumi.Output[builtins.bool]:
        """
        If the Kubernetes cluster type is Daemon set then this will be set to true.
        """
        return pulumi.get(self, "is_daemon_set")
    ...
    @property
    @pulumi.getter(name="readDataLimit")
    def read_data_limit(self) -> pulumi.Output[builtins.int]:
        """
        Number in kilobytes. The limit on the data being sent, not to exceed the agent's fixed limit of 400 (KB).
        """
        return pulumi.get(self, "read_data_limit")
    ...
    @property
    @pulumi.getter(name="readDataLimitInKilobytes")
    def read_data_limit_in_kilobytes(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) Number in kilobytes. The limit on the data being sent, not to exceed the agent's fixed limit of 400 (KB).
        """
        return pulumi.get(self, "read_data_limit_in_kilobytes")
    ...
    @property
    @pulumi.getter(name="readTimeout")
    def read_timeout(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) Number in milliseconds. The timeout for reading the response from the Prometheus Exporter's endpoint.
        """
        return pulumi.get(self, "read_timeout")
    ...
    @property
    @pulumi.getter(name="scheduleMins")
    def schedule_mins(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) Number in minutes. The scraping occurs at the specified interval.
        """
        return pulumi.get(self, "schedule_mins")
