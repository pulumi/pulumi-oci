...
class _NamedCredentialState:
    def __init__(__self__, *,
                 ...
                 name: pulumi.Input[Optional[_builtins.str]] = None,
                 properties: pulumi.Input[Optional[Sequence[pulumi.Input['NamedCredentialPropertyArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def properties(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['NamedCredentialPropertyArgs']]]]:
        """
        (Updatable) Properties for the named credential
        """
        return pulumi.get(self, "properties")
    ...
    @properties.setter
    def properties(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['NamedCredentialPropertyArgs']]]]):
        pulumi.set(self, "properties", value)
