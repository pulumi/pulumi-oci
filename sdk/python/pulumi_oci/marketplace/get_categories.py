...
def get_categories(compartment_id: Optional[_builtins.str] = None,
...
def get_categories_output(compartment_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
