...
class GetListingResult:
    ...
    @property
    @pulumi.getter
    def keywords(self) -> builtins.str:
        """
    ...
    def license_model_description(self) -> builtins.str:
        """
    ...
    def system_requirements(self) -> builtins.str:
        """
    ...
    def usage_information(self) -> builtins.str:
        """
...
def get_listing(compartment_id: Optional[builtins.str] = None,
...
def get_listing_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
