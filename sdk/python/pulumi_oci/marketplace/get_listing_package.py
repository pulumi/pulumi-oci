...
def get_listing_package(compartment_id: Optional[builtins.str] = None,
...
def get_listing_package_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
