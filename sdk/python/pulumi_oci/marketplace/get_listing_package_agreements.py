...
def get_listing_package_agreements(compartment_id: Optional[builtins.str] = None,
...
def get_listing_package_agreements_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
