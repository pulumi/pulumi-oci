...
def get_listing_packages(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str package_type: A filter to return only packages that match the given package type exactly.
    :param builtins.str package_version: The version of the package. Package versions are unique within a listing.
    """
    __args__ = dict()
...
def get_listing_packages_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                ...
                                package_version: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Marketplace/getListingPackages:getListingPackages', __args__, opts=opts, typ=GetListingPackagesResult)
    return __ret__.apply(lambda __response__: GetListingPackagesResult(
        compartment_id=pulumi.get(__response__, 'compartment_id'),
        filters=pulumi.get(__response__, 'filters'),
        id=pulumi.get(__response__, 'id'),
        listing_id=pulumi.get(__response__, 'listing_id'),
        listing_packages=pulumi.get(__response__, 'listing_packages'),
