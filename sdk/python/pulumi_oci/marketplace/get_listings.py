...
class GetListingsResult:
    ...
    def listing_types(self) -> Optional[Sequence[_builtins.str]]:
...
def get_listings(categories: Optional[Sequence[_builtins.str]] = None,
                 ...
                 listing_types: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] categories: Name of the product category or categories. If you specify multiple categories, then Marketplace returns any listing with one or more matching categories.
    ...
    :param _builtins.str image_id: The image identifier of the listing.
    ...
    :param Sequence[_builtins.str] listing_types: The type of the listing.
    :param Sequence[_builtins.str] names: The name of the listing.
    ...
    :param Sequence[_builtins.str] pricings: Name of the pricing type. If multiple pricing types are provided, then any listing with one or more matching pricing models will be returned.
    :param _builtins.str publisher_id: Limit results to just this publisher.
    """
    __args__ = dict()
