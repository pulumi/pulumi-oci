...
class GetListingsResult:
    ...
    def is_featured(self) -> Optional[builtins.bool]:
        """
    ...
    def listing_types(self) -> Optional[Sequence[builtins.str]]:
    ...
    @property
    @pulumi.getter
    def pricings(self) -> Optional[Sequence[builtins.str]]:
...
def get_listings(categories: Optional[Sequence[builtins.str]] = None,
                 ...
                 is_featured: Optional[builtins.bool] = None,
                 listing_id: Optional[builtins.str] = None,
                 listing_types: Optional[Sequence[builtins.str]] = None,
                 ...
                 pricings: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] categories: Name of the product category or categories. If you specify multiple categories, then Marketplace returns any listing with one or more matching categories.
    :param builtins.str compartment_id: The unique identifier for the compartment. It is mandatory when used in non-commercial realms.
    :param builtins.str image_id: The image identifier of the listing.
    ...
    :param Sequence[builtins.str] listing_types: The type of the listing.
    :param Sequence[builtins.str] names: The name of the listing.
    ...
    :param Sequence[builtins.str] pricings: Name of the pricing type. If multiple pricing types are provided, then any listing with one or more matching pricing models will be returned.
    :param builtins.str publisher_id: Limit results to just this publisher.
    """
    __args__ = dict()
...
def get_listings_output(categories: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                        ...
                        is_featured: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                        listing_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        listing_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                        ...
                        pricings: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                        publisher_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
