...
class GetPublicationsResult:
    ...
    def publication_id(self) -> Optional[_builtins.str]:
...
def get_publications(compartment_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] names: The name of the publication.
    :param Sequence[_builtins.str] operating_systems: The operating system of the listing.
