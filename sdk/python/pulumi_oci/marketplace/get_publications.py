...
class GetPublicationsResult:
    ...
    def listing_type(self) -> builtins.str:
        """
    ...
    def operating_systems(self) -> Optional[Sequence[builtins.str]]:
        return pulumi.get(self, "operating_systems")

    @property
    @pulumi.getter(name="publicationId")
    def publication_id(self) -> Optional[builtins.str]:
...
def get_publications(compartment_id: Optional[builtins.str] = None,
                     filters: Optional[Sequence[Union['GetPublicationsFilterArgs', 'GetPublicationsFilterArgsDict']]] = None,
                     listing_type: Optional[builtins.str] = None,
                     names: Optional[Sequence[builtins.str]] = None,
                     operating_systems: Optional[Sequence[builtins.str]] = None,
                     publication_id: Optional[builtins.str] = None,
    ...
    :param builtins.str listing_type: The type of the listing.
    :param Sequence[builtins.str] names: The name of the publication.
    :param Sequence[builtins.str] operating_systems: The operating system of the listing.
    :param builtins.str publication_id: The unique identifier for the publication.
    """
    __args__ = dict()
...
def get_publications_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                            ...
                            operating_systems: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                            publication_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
