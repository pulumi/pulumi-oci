...
class ListingPackageAgreementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] agreement_id: The unique identifier for the agreement.
        :param pulumi.Input[builtins.str] listing_id: The unique identifier for the listing.
        :param pulumi.Input[builtins.str] package_version: The version of the package. Package versions are unique within a listing.
        :param pulumi.Input[builtins.str] compartment_id: The unique identifier for the compartment, required in gov regions.
        """
...
class _ListingPackageAgreementState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] agreement_id: The unique identifier for the agreement.
        :param pulumi.Input[builtins.str] author: Who authored the agreement.
        :param pulumi.Input[builtins.str] compartment_id: The unique identifier for the compartment, required in gov regions.
        :param pulumi.Input[builtins.str] content_url: The content URL of the agreement.
        :param pulumi.Input[builtins.str] listing_id: The unique identifier for the listing.
        :param pulumi.Input[builtins.str] package_version: The version of the package. Package versions are unique within a listing.
        :param pulumi.Input[builtins.str] prompt: Textual prompt to read and accept the agreement.
        :param pulumi.Input[builtins.str] signature: A time-based signature that can be used to accept an agreement or remove a previously accepted agreement from the list that Marketplace checks before a deployment.
        """
...
class ListingPackageAgreement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            package_version: Optional[pulumi.Input[builtins.str]] = None,
            prompt: Optional[pulumi.Input[builtins.str]] = None,
            signature: Optional[pulumi.Input[builtins.str]] = None) -> 'ListingPackageAgreement':
        """
    ...
    @property
    @pulumi.getter(name="contentUrl")
    def content_url(self) -> pulumi.Output[builtins.str]:
        """
        The content URL of the agreement.
        """
        return pulumi.get(self, "content_url")
