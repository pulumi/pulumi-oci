...
class PublicationArgs:
    def __init__(__self__, *,
                 ...
                 is_agreement_acknowledged: pulumi.Input[builtins.bool],
                 listing_type: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment where you want to create the publication.
        :param pulumi.Input[builtins.bool] is_agreement_acknowledged: Whether the publisher acknowledged that they have the right and authority to share the contents of the publication and that they accepted the Oracle terms of use agreements required to create a publication.
        :param pulumi.Input[builtins.str] listing_type: The publisher category to which the publication belongs. The publisher category informs where the listing appears for use.
        :param pulumi.Input['PublicationPackageDetailsArgs'] package_details: A base object for creating a publication package.
        :param pulumi.Input[builtins.str] short_description: (Updatable) A short description of the publication to use in the listing.
        ...
        :param pulumi.Input[builtins.str] long_description: (Updatable) A long description of the publication to use in the listing.
        :param pulumi.Input[builtins.str] name: (Updatable) The name of the publication, which is also used in the listing.
        """
    ...
    def is_agreement_acknowledged(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def is_agreement_acknowledged(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "is_agreement_acknowledged", value)

    @property
    @pulumi.getter(name="listingType")
    def listing_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @listing_type.setter
    def listing_type(self, value: pulumi.Input[builtins.str]):
...
class _PublicationState:
    def __init__(__self__, *,
                 ...
                 is_agreement_acknowledged: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] name: (Updatable) The name of the publication, which is also used in the listing.
        :param pulumi.Input['PublicationPackageDetailsArgs'] package_details: A base object for creating a publication package.
        :param pulumi.Input[builtins.str] package_type: The listing's package type.
        :param pulumi.Input[builtins.str] short_description: (Updatable) A short description of the publication to use in the listing.
        :param pulumi.Input[builtins.str] state: The lifecycle state of the publication.
        :param pulumi.Input[Sequence[pulumi.Input['PublicationSupportContactArgs']]] support_contacts: (Updatable) Contact information for getting support from the publisher for the listing.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the publication was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
        """
    ...
    @property
    @pulumi.getter(name="isAgreementAcknowledged")
    def is_agreement_acknowledged(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        Whether the publisher acknowledged that they have the right and authority to share the contents of the publication and that they accepted the Oracle terms of use agreements required to create a publication.
        """
        return pulumi.get(self, "is_agreement_acknowledged")
    ...
    @is_agreement_acknowledged.setter
    def is_agreement_acknowledged(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_agreement_acknowledged", value)
...
class Publication(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'Publication':
        """
    ...
    @property
    @pulumi.getter(name="isAgreementAcknowledged")
    def is_agreement_acknowledged(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the publisher acknowledged that they have the right and authority to share the contents of the publication and that they accepted the Oracle terms of use agreements required to create a publication.
        """
        return pulumi.get(self, "is_agreement_acknowledged")
