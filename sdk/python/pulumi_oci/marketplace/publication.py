        ...
        test_publication = oci.marketplace.Publication("testPublication",
            ...
            package_details=oci.marketplace.PublicationPackageDetailsArgs(
                eulas=[oci.marketplace.PublicationPackageDetailsEulaArgs(
                    eula_type=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                    license_text=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                )],
            ...
            support_contacts=[oci.marketplace.PublicationSupportContactArgs(
                ...
                name=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                phone=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
