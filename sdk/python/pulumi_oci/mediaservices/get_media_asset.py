...
class GetMediaAssetResult:
    ...
    def media_asset_tags(self) -> Optional[Sequence['outputs.GetMediaAssetMediaAssetTagResult']]:
    ...
    @property
    @pulumi.getter
    def metadatas(self) -> Optional[Sequence['outputs.GetMediaAssetMetadataResult']]:
