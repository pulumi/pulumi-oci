...
def get_media_workflow(media_workflow_id: Optional[builtins.str] = None,
...
def get_media_workflow_output(media_workflow_id: Optional[pulumi.Input[builtins.str]] = None,
