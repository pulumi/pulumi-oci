...
def get_media_workflow_configurations(compartment_id: Optional[builtins.str] = None,
...
def get_media_workflow_configurations_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
