...
def get_media_workflow_job_fact(key: Optional[_builtins.str] = None,
    ...
    :param _builtins.str key: Identifier of the MediaWorkflowJobFact within a MediaWorkflowJob.
...
def get_media_workflow_job_fact_output(key: Optional[pulumi.Input[_builtins.str]] = None,
