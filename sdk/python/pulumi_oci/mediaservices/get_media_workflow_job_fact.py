...
def get_media_workflow_job_fact(key: Optional[builtins.str] = None,
    ...
    :param builtins.str key: Identifier of the MediaWorkflowJobFact within a MediaWorkflowJob.
...
def get_media_workflow_job_fact_output(key: Optional[pulumi.Input[builtins.str]] = None,
