...
class GetMediaWorkflowJobsResult:
    ...
    def media_workflow_id(self) -> Optional[builtins.str]:
        """
...
def get_media_workflow_jobs_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                   ...
                                   media_workflow_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
