...
def get_media_workflow_task_declaration(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.bool is_current: A filter to only select the newest version for each MediaWorkflowTaskDeclaration name.
...
def get_media_workflow_task_declaration_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                               is_current: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
