...
def get_media_workflows(compartment_id: Optional[str] = None,
    ...
    test_media_workflows = oci.MediaServices.get_media_workflows(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetMediaWorkflowsResult(
        ...
        id=__ret__.id,
        media_workflow_collections=__ret__.media_workflow_collections,
        state=__ret__.state)
