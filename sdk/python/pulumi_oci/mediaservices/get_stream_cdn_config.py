...
class GetStreamCdnConfigResult:
    ...
    def stream_cdn_config_id(self) -> builtins.str:
...
def get_stream_cdn_config(stream_cdn_config_id: Optional[builtins.str] = None,
    ...
    :param builtins.str stream_cdn_config_id: Unique StreamCdnConfig identifier.
    """
    __args__ = dict()
...
def get_stream_cdn_config_output(stream_cdn_config_id: Optional[pulumi.Input[builtins.str]] = None,
