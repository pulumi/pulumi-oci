...
def get_stream_cdn_configs(display_name: Optional[builtins.str] = None,
...
def get_stream_cdn_configs_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
