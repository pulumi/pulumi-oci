...
class GetStreamDistributionChannelResult:
    ...
    def stream_distribution_channel_id(self) -> _builtins.str:
...
def get_stream_distribution_channel(stream_distribution_channel_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str stream_distribution_channel_id: Unique Stream Distribution Channel path identifier.
    """
    __args__ = dict()
