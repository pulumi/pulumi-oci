...
class GetStreamPackagingConfigResult:
    ...
    def stream_packaging_config_id(self) -> builtins.str:
...
def get_stream_packaging_config(stream_packaging_config_id: Optional[builtins.str] = None,
    ...
    :param builtins.str stream_packaging_config_id: Unique Stream Packaging Configuration path identifier.
    """
    __args__ = dict()
...
def get_stream_packaging_config_output(stream_packaging_config_id: Optional[pulumi.Input[builtins.str]] = None,
