...
class GetStreamPackagingConfigsResult:
    ...
    def stream_packaging_config_id(self) -> Optional[builtins.str]:
...
def get_stream_packaging_configs(display_name: Optional[builtins.str] = None,
                                 ...
                                 stream_packaging_config_id: Optional[builtins.str] = None,
    ...
    :param builtins.str stream_packaging_config_id: Unique Stream Packaging Configuration identifier.
    """
    __args__ = dict()
...
def get_stream_packaging_configs_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        ...
                                        stream_packaging_config_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
