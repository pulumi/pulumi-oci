...
class GetStreamPackagingConfigsResult:
    ...
    def stream_packaging_config_id(self) -> Optional[_builtins.str]:
...
def get_stream_packaging_configs(display_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str stream_packaging_config_id: Unique Stream Packaging Configuration identifier.
    """
    __args__ = dict()
