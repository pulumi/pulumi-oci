...
def get_system_media_workflow(compartment_id: Optional[builtins.str] = None,
...
def get_system_media_workflow_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
