...
class MediaAssetArgs:
    def __init__(__self__, *,
                 ...
                 master_media_asset_id: Optional[pulumi.Input[builtins.str]] = None,
                 media_asset_tags: Optional[pulumi.Input[Sequence[pulumi.Input['MediaAssetMediaAssetTagArgs']]]] = None,
                 media_workflow_job_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 object_etag: Optional[pulumi.Input[builtins.str]] = None,
                 parent_media_asset_id: Optional[pulumi.Input[builtins.str]] = None,
                 segment_range_end_index: Optional[pulumi.Input[builtins.str]] = None,
                 segment_range_start_index: Optional[pulumi.Input[builtins.str]] = None,
                 source_media_workflow_id: Optional[pulumi.Input[builtins.str]] = None,
                 source_media_workflow_version: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] type: (Updatable) The type of the media asset.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] bucket: The name of the object storage bucket where this asset is located.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) Display name for the Media Asset. Does not have to be unique. Avoid entering confidential information.
        ...
        :param pulumi.Input[builtins.str] master_media_asset_id: (Updatable) The ID of the senior most asset from which this asset is derived.
        ...
        :param pulumi.Input[builtins.str] media_workflow_job_id: The ID of the MediaWorkflowJob used to produce this asset.
        :param pulumi.Input[Sequence[pulumi.Input['MediaAssetMetadataArgs']]] metadatas: (Updatable) List of Metadata.
        :param pulumi.Input[builtins.str] namespace: The object storage namespace where this asset is located.
        :param pulumi.Input[builtins.str] object: The object storage object name that identifies this asset.
        :param pulumi.Input[builtins.str] object_etag: eTag of the underlying object storage object.
        :param pulumi.Input[builtins.str] parent_media_asset_id: (Updatable) The ID of the parent asset from which this asset is derived.
        :param pulumi.Input[builtins.str] segment_range_end_index: The end index for video segment files.
        :param pulumi.Input[builtins.str] segment_range_start_index: The start index for video segment files.
        :param pulumi.Input[builtins.str] source_media_workflow_id: The ID of the MediaWorkflow used to produce this asset.
        :param pulumi.Input[builtins.str] source_media_workflow_version: The version of the MediaWorkflow used to produce this asset.
        """
    ...
    def master_media_asset_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def master_media_asset_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def media_workflow_job_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def media_workflow_job_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def object_etag(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @object_etag.setter
    def object_etag(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "object_etag", value)

    @property
    @pulumi.getter(name="parentMediaAssetId")
    def parent_media_asset_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def parent_media_asset_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "parent_media_asset_id", value)

    @property
    @pulumi.getter(name="segmentRangeEndIndex")
    def segment_range_end_index(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def segment_range_end_index(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "segment_range_end_index", value)

    @property
    @pulumi.getter(name="segmentRangeStartIndex")
    def segment_range_start_index(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def segment_range_start_index(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "segment_range_start_index", value)

    @property
    @pulumi.getter(name="sourceMediaWorkflowId")
    def source_media_workflow_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_media_workflow_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_media_workflow_id", value)

    @property
    @pulumi.getter(name="sourceMediaWorkflowVersion")
    def source_media_workflow_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_media_workflow_version(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _MediaAssetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] source_media_workflow_id: The ID of the MediaWorkflow used to produce this asset.
        :param pulumi.Input[builtins.str] source_media_workflow_version: The version of the MediaWorkflow used to produce this asset.
        :param pulumi.Input[builtins.str] state: The current state of the MediaAsset.
        ...
        :param pulumi.Input[builtins.str] time_created: The time when the MediaAsset was created. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The time when the MediaAsset was updated. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] type: (Updatable) The type of the media asset.
...
class MediaAsset(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'MediaAsset':
        """
    ...
    @property
    @pulumi.getter(name="masterMediaAssetId")
    def master_media_asset_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The ID of the senior most asset from which this asset is derived.
        """
        return pulumi.get(self, "master_media_asset_id")
    ...
    @property
    @pulumi.getter(name="mediaWorkflowJobId")
    def media_workflow_job_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the MediaWorkflowJob used to produce this asset.
        """
        return pulumi.get(self, "media_workflow_job_id")
    ...
    @property
    @pulumi.getter(name="objectEtag")
    def object_etag(self) -> pulumi.Output[builtins.str]:
        """
        eTag of the underlying object storage object.
        """
        return pulumi.get(self, "object_etag")
    ...
    @property
    @pulumi.getter(name="parentMediaAssetId")
    def parent_media_asset_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The ID of the parent asset from which this asset is derived.
        """
        return pulumi.get(self, "parent_media_asset_id")
    ...
    @property
    @pulumi.getter(name="segmentRangeEndIndex")
    def segment_range_end_index(self) -> pulumi.Output[builtins.str]:
        """
        The end index for video segment files.
        """
        return pulumi.get(self, "segment_range_end_index")
    ...
    @property
    @pulumi.getter(name="segmentRangeStartIndex")
    def segment_range_start_index(self) -> pulumi.Output[builtins.str]:
        """
        The start index for video segment files.
        """
        return pulumi.get(self, "segment_range_start_index")
    ...
    @property
    @pulumi.getter(name="sourceMediaWorkflowId")
    def source_media_workflow_id(self) -> pulumi.Output[builtins.str]:
        """
        The ID of the MediaWorkflow used to produce this asset.
        """
        return pulumi.get(self, "source_media_workflow_id")
    ...
    @property
    @pulumi.getter(name="sourceMediaWorkflowVersion")
    def source_media_workflow_version(self) -> pulumi.Output[builtins.str]:
        """
        The version of the MediaWorkflow used to produce this asset.
        """
        return pulumi.get(self, "source_media_workflow_version")
