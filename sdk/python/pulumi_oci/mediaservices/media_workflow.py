...
class MediaWorkflowArgs:
    def __init__(__self__, *,
                 ...
                 locks: pulumi.Input[Optional[Sequence[pulumi.Input['MediaWorkflowLockArgs']]]] = None,
                 ...
                 tasks: pulumi.Input[Optional[Sequence[pulumi.Input['MediaWorkflowTaskArgs']]]] = None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] media_workflow_configuration_ids: (Updatable) Configurations to be applied to all the jobs for this workflow. Parameters in these configurations are overridden by parameters in the MediaWorkflowConfigurations of the MediaWorkflowJob and the parameters of the MediaWorkflowJob.
        :param pulumi.Input[_builtins.str] parameters: (Updatable) JSON object representing named parameters and their default values that can be referenced throughout this workflow. The values declared here can be overridden by the MediaWorkflowConfigurations or parameters supplied when creating MediaWorkflowJobs from this MediaWorkflow.
    ...
    @_builtins.property
    @pulumi.getter
    def locks(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MediaWorkflowLockArgs']]]]:
        """
    ...
    @locks.setter
    def locks(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MediaWorkflowLockArgs']]]]):
        pulumi.set(self, "locks", value)

    @_builtins.property
    @pulumi.getter(name="mediaWorkflowConfigurationIds")
    def media_workflow_configuration_ids(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
    ...
    def media_workflow_configuration_ids(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def tasks(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MediaWorkflowTaskArgs']]]]:
        """
    ...
    @tasks.setter
    def tasks(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MediaWorkflowTaskArgs']]]]):
...
class _MediaWorkflowState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] media_workflow_configuration_ids: (Updatable) Configurations to be applied to all the jobs for this workflow. Parameters in these configurations are overridden by parameters in the MediaWorkflowConfigurations of the MediaWorkflowJob and the parameters of the MediaWorkflowJob.
        :param pulumi.Input[_builtins.str] parameters: (Updatable) JSON object representing named parameters and their default values that can be referenced throughout this workflow. The values declared here can be overridden by the MediaWorkflowConfigurations or parameters supplied when creating MediaWorkflowJobs from this MediaWorkflow.
        :param pulumi.Input[_builtins.str] state: The current state of the MediaWorkflow.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param pulumi.Input[Sequence[pulumi.Input['MediaWorkflowTaskArgs']]] tasks: (Updatable) The processing to be done in this workflow. Each key of the MediaWorkflowTasks in this array must be unique within the array. The order of tasks given here will be preserved.
        :param pulumi.Input[_builtins.str] time_created: The time when the MediaWorkflow was created. An RFC3339 formatted datetime string.
        :param pulumi.Input[_builtins.str] time_updated: The time when the MediaWorkflow was updated. An RFC3339 formatted datetime string.
        :param pulumi.Input[_builtins.str] version: The version of the MediaWorkflow.
        """
...
class MediaWorkflow(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 is_lock_override: pulumi.Input[Optional[_builtins.bool]] = None,
                 locks: pulumi.Input[Optional[Sequence[pulumi.Input[Union['MediaWorkflowLockArgs', 'MediaWorkflowLockArgsDict', 'outputs.MediaWorkflowLock']]]]] = None,
                 media_workflow_configuration_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 parameters: pulumi.Input[Optional[_builtins.str]] = None,
                 tasks: pulumi.Input[Optional[Sequence[pulumi.Input[Union['MediaWorkflowTaskArgs', 'MediaWorkflowTaskArgsDict', 'outputs.MediaWorkflowTask']]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] display_name: (Updatable) Name for the MediaWorkflow. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[Sequence[pulumi.Input[Union['MediaWorkflowLockArgs', 'MediaWorkflowLockArgsDict', 'outputs.MediaWorkflowLock']]]] locks: Locks associated with this resource.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] media_workflow_configuration_ids: (Updatable) Configurations to be applied to all the jobs for this workflow. Parameters in these configurations are overridden by parameters in the MediaWorkflowConfigurations of the MediaWorkflowJob and the parameters of the MediaWorkflowJob.
        :param pulumi.Input[_builtins.str] parameters: (Updatable) JSON object representing named parameters and their default values that can be referenced throughout this workflow. The values declared here can be overridden by the MediaWorkflowConfigurations or parameters supplied when creating MediaWorkflowJobs from this MediaWorkflow.
        :param pulumi.Input[Sequence[pulumi.Input[Union['MediaWorkflowTaskArgs', 'MediaWorkflowTaskArgsDict', 'outputs.MediaWorkflowTask']]]] tasks: (Updatable) The processing to be done in this workflow. Each key of the MediaWorkflowTasks in this array must be unique within the array. The order of tasks given here will be preserved.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None,
            version: pulumi.Input[Optional[_builtins.str]] = None) -> 'MediaWorkflow':
        """
    ...
    @_builtins.property
    @pulumi.getter
    def locks(self) -> pulumi.Output[Sequence['outputs.MediaWorkflowLock']]:
        """
        Locks associated with this resource.
        """
        return pulumi.get(self, "locks")
