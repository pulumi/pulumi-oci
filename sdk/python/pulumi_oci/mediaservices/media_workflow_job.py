...
class MediaWorkflowJobArgs:
    def __init__(__self__, *,
                 ...
                 workflow_identifier_type: pulumi.Input[builtins.str],
                 ...
                 media_workflow_configuration_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 media_workflow_id: Optional[pulumi.Input[builtins.str]] = None,
                 media_workflow_name: Optional[pulumi.Input[builtins.str]] = None,
                 parameters: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a MediaWorkflowJob resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) ID of the compartment in which the job should be created.
        :param pulumi.Input[builtins.str] workflow_identifier_type: Discriminate identification of a workflow by name versus a workflow by ID.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) Name of the Media Workflow Job. Does not have to be unique. Avoid entering confidential information.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] media_workflow_configuration_ids: Configurations to be applied to this run of the workflow.
        :param pulumi.Input[builtins.str] media_workflow_id: OCID of the MediaWorkflow that should be run.
        :param pulumi.Input[builtins.str] media_workflow_name: Name of the system MediaWorkflow that should be run.
        :param pulumi.Input[builtins.str] parameters: Parameters that override parameters specified in MediaWorkflowTaskDeclarations, the MediaWorkflow, the MediaWorkflow's MediaWorkflowConfigurations and the MediaWorkflowConfigurations of this MediaWorkflowJob. The parameters are given as JSON. The top level and 2nd level elements must be JSON objects (vs arrays, scalars, etc). The top level keys refer to a task's key and the 2nd level keys refer to a parameter's name.
        """
    ...
    def workflow_identifier_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def workflow_identifier_type(self, value: pulumi.Input[builtins.str]):
    ...
    def media_workflow_configuration_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def media_workflow_configuration_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "media_workflow_configuration_ids", value)

    @property
    @pulumi.getter(name="mediaWorkflowId")
    def media_workflow_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def media_workflow_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "media_workflow_id", value)

    @property
    @pulumi.getter(name="mediaWorkflowName")
    def media_workflow_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def media_workflow_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _MediaWorkflowJobState:
    def __init__(__self__, *,
                 ...
                 parameters: Optional[pulumi.Input[builtins.str]] = None,
                 runnable: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 workflow_identifier_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] parameters: Parameters that override parameters specified in MediaWorkflowTaskDeclarations, the MediaWorkflow, the MediaWorkflow's MediaWorkflowConfigurations and the MediaWorkflowConfigurations of this MediaWorkflowJob. The parameters are given as JSON. The top level and 2nd level elements must be JSON objects (vs arrays, scalars, etc). The top level keys refer to a task's key and the 2nd level keys refer to a parameter's name.
        :param pulumi.Input[builtins.str] runnable: A JSON representation of the job as it will be run by the system. All the task declarations, configurations and parameters are merged. Parameter values are all fully resolved.
        ...
        :param pulumi.Input[builtins.str] time_created: Creation time of the job. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_ended: Time when the job finished. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_started: Time when the job started to execute. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: Updated time of the job. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] workflow_identifier_type: Discriminate identification of a workflow by name versus a workflow by ID.
    ...
    @property
    @pulumi.getter
    def runnable(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @runnable.setter
    def runnable(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="workflowIdentifierType")
    def workflow_identifier_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Discriminate identification of a workflow by name versus a workflow by ID.
    ...
    @workflow_identifier_type.setter
    def workflow_identifier_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "workflow_identifier_type", value)
...
class MediaWorkflowJob(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_started: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            workflow_identifier_type: Optional[pulumi.Input[builtins.str]] = None) -> 'MediaWorkflowJob':
        """
    ...
    @property
    @pulumi.getter(name="mediaWorkflowConfigurationIds")
    def media_workflow_configuration_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        Configurations to be applied to this run of the workflow.
        """
        return pulumi.get(self, "media_workflow_configuration_ids")
    ...
    @property
    @pulumi.getter(name="mediaWorkflowId")
    def media_workflow_id(self) -> pulumi.Output[builtins.str]:
        """
        OCID of the MediaWorkflow that should be run.
        """
        return pulumi.get(self, "media_workflow_id")
    ...
    @property
    @pulumi.getter(name="mediaWorkflowName")
    def media_workflow_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the system MediaWorkflow that should be run.
        """
        return pulumi.get(self, "media_workflow_name")
    ...
    @property
    @pulumi.getter
    def runnable(self) -> pulumi.Output[builtins.str]:
        """
        A JSON representation of the job as it will be run by the system. All the task declarations, configurations and parameters are merged. Parameter values are all fully resolved.
        """
        return pulumi.get(self, "runnable")
    ...
    @property
    @pulumi.getter(name="workflowIdentifierType")
    def workflow_identifier_type(self) -> pulumi.Output[builtins.str]:
        """
        Discriminate identification of a workflow by name versus a workflow by ID.
