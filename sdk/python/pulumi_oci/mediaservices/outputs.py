...
class MediaAssetLock(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str compartment_id: (Updatable) The compartment ID of the lock.
...
class MediaAssetMediaAssetTag(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str value: (Updatable) Tag of the MediaAsset.
        :param builtins.str type: (Updatable) Type of the tag.
        """
...
class MediaAssetMetadata(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str metadata: (Updatable) JSON string containing the technial metadata for the media asset.
        """
...
class MediaWorkflowJobOutput(dict):
    ...
    def __init__(__self__, *,
                 asset_type: Optional[builtins.str] = None,
                 bucket: Optional[builtins.str] = None,
                 id: Optional[builtins.str] = None,
                 namespace: Optional[builtins.str] = None,
                 object: Optional[builtins.str] = None):
        """
        :param builtins.str asset_type: Type of job output.
        :param builtins.str bucket: The bucket name of the job output.
        :param builtins.str id: The ID associated with the job output.
        :param builtins.str namespace: The namespace name of the job output.
        :param builtins.str object: The object name of the job output.
        """
    ...
    def asset_type(self) -> Optional[builtins.str]:
        """
        Type of job output.
        """
...
class MediaWorkflowJobTaskLifecycleState(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key: Unique key within a MediaWorkflowJob for the task.
        :param builtins.str lifecycle_details: The lifecycle details of MediaWorkflowJob task.
        :param builtins.str state: The current state of the MediaWorkflowJob task.
        """
        if key is not None:
...
class MediaWorkflowTask(dict):
    ...
    def __init__(__self__, *,
                 ...
                 enable_parameter_reference: Optional[builtins.str] = None,
                 enable_when_referenced_parameter_equals: Optional[Mapping[str, builtins.str]] = None,
                 prerequisites: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str key: (Updatable) A unique identifier for this task within its workflow. Keys are used to reference a task within workflows and MediaWorkflowJobs. Tasks are referenced as prerequisites and to track output and state.
        :param builtins.str parameters: (Updatable) Data specifiying how this task is to be run. The data is a JSON object that must conform to the JSON Schema specified by the parameters of the MediaWorkflowTaskDeclaration this task references. The parameters may contain values or references to other parameters.
        :param builtins.str type: (Updatable) The type of process to run at this task. Refers to the name of a MediaWorkflowTaskDeclaration.
        :param builtins.str version: (Updatable) The version of the MediaWorkflowTaskDeclaration.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param builtins.str enable_parameter_reference: (Updatable) Allows this task to be conditionally enabled.  If no value or a blank value is given, the task is unconditionally enbled.  Otherwise the given string specifies a parameter of the job created for this task's workflow using the JSON pointer syntax. The JSON pointer is validated when a job is created from the workflow of this task.
        :param Mapping[str, builtins.str] enable_when_referenced_parameter_equals: (Updatable) Used in conjunction with enableParameterReference to conditionally enable a task.  When a job is created from the workflow of this task, the task will only be enabled if the value of the parameter specified by enableParameterReference is equal to the value of this property. This property must be prenset if and only if a enableParameterReference is given. The value is a JSON node.
        :param Sequence[builtins.str] prerequisites: (Updatable) Keys to the other tasks in this workflow that must be completed before execution of this task can begin.
        """
        pulumi.set(__self__, "key", key)
    ...
    def enable_parameter_reference(self) -> Optional[builtins.str]:
        """
        (Updatable) Allows this task to be conditionally enabled.  If no value or a blank value is given, the task is unconditionally enbled.  Otherwise the given string specifies a parameter of the job created for this task's workflow using the JSON pointer syntax. The JSON pointer is validated when a job is created from the workflow of this task.
        """
    ...
    def enable_when_referenced_parameter_equals(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class StreamCdnConfigConfig(dict):
    ...
    def __init__(__self__, *,
                 type: builtins.str,
                 edge_hostname: Optional[builtins.str] = None,
                 edge_path_prefix: Optional[builtins.str] = None,
                 edge_token_key: Optional[builtins.str] = None,
                 edge_token_salt: Optional[builtins.str] = None,
                 is_edge_token_auth: Optional[builtins.bool] = None,
                 origin_auth_secret_key_a: Optional[builtins.str] = None,
                 origin_auth_secret_key_b: Optional[builtins.str] = None,
                 origin_auth_secret_key_nonce_a: Optional[builtins.str] = None,
                 origin_auth_secret_key_nonce_b: Optional[builtins.str] = None,
                 origin_auth_sign_encryption: Optional[builtins.str] = None,
                 origin_auth_sign_type: Optional[builtins.str] = None):
        """
        :param builtins.str type: (Updatable) The name of the CDN configuration type.
        :param builtins.str edge_hostname: (Updatable) The hostname of the CDN edge server to use when building CDN URLs.
        :param builtins.str edge_path_prefix: (Updatable) The path to prepend when building CDN URLs.
        :param builtins.str edge_token_key: (Updatable) The encryption key to use for edge token authentication.
        :param builtins.str edge_token_salt: (Updatable) Salt to use when encrypting authentication token.
        :param builtins.bool is_edge_token_auth: (Updatable) Whether token authentication should be used at the CDN edge.
        :param builtins.str origin_auth_secret_key_a: (Updatable) The shared secret key A, two for errorless key rotation.
        :param builtins.str origin_auth_secret_key_b: (Updatable) The shared secret key B, two for errorless key rotation.
        :param builtins.str origin_auth_secret_key_nonce_a: (Updatable) Nonce identifier for originAuthSecretKeyA (used to determine key used to sign).
        :param builtins.str origin_auth_secret_key_nonce_b: (Updatable) Nonce identifier for originAuthSecretKeyB (used to determine key used to sign).
        :param builtins.str origin_auth_sign_encryption: (Updatable) The type of encryption used to compute the signature.
        :param builtins.str origin_auth_sign_type: (Updatable) The type of data used to compute the signature.
        """
        pulumi.set(__self__, "type", type)
    ...
    def edge_hostname(self) -> Optional[builtins.str]:
        """
    ...
    def edge_path_prefix(self) -> Optional[builtins.str]:
        """
    ...
    def edge_token_key(self) -> Optional[builtins.str]:
        """
    ...
    def edge_token_salt(self) -> Optional[builtins.str]:
        """
    ...
    def is_edge_token_auth(self) -> Optional[builtins.bool]:
        """
    ...
    def origin_auth_secret_key_a(self) -> Optional[builtins.str]:
        """
    ...
    def origin_auth_secret_key_b(self) -> Optional[builtins.str]:
        """
    ...
    def origin_auth_secret_key_nonce_a(self) -> Optional[builtins.str]:
        """
    ...
    def origin_auth_secret_key_nonce_b(self) -> Optional[builtins.str]:
        """
    ...
    def origin_auth_sign_encryption(self) -> Optional[builtins.str]:
        """
    ...
    def origin_auth_sign_type(self) -> Optional[builtins.str]:
        """
...
class StreamCdnConfigLock(dict):
    ...
    def __init__(__self__, *,
                 ...
                 time_created: Optional[builtins.str] = None):
        """
        :param builtins.str compartment_id: The compartment ID of the lock.
        :param builtins.str type: Type of the lock.
...
class StreamPackagingConfigEncryption(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str algorithm: The encryption algorithm for the stream packaging configuration.
        :param builtins.str kms_key_id: The identifier of the customer managed Vault KMS symmetric encryption key (null if Oracle managed).
        """
...
class GetMediaAssetLockResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str message: A message added by the creator of the lock. This is typically used to give an indication of why the resource is locked.
        :param builtins.str related_resource_id: The ID of the resource that is locking this resource. Indicates that deleting this resource will remove the lock.
        :param builtins.str time_created: The time when the MediaAsset was created. An RFC3339 formatted datetime string.
        :param builtins.str type: The type of the media asset.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "message", message)
        pulumi.set(__self__, "related_resource_id", related_resource_id)
...
class GetMediaAssetMediaAssetTagResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: The type of the media asset.
        :param builtins.str value: Tag of the MediaAsset.
        """
        pulumi.set(__self__, "type", type)
        pulumi.set(__self__, "value", value)
...
class GetMediaAssetMetadataResult(dict):
    def __init__(__self__, *,
                 metadata: builtins.str):
        """
        :param builtins.str metadata: JSON string containing the technial metadata for the media asset.
        """
        pulumi.set(__self__, "metadata", metadata)
...
class GetMediaAssetsMediaAssetCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 master_media_asset_id: builtins.str,
                 media_asset_tags: Sequence['outputs.GetMediaAssetsMediaAssetCollectionItemMediaAssetTagResult'],
                 media_workflow_job_id: builtins.str,
                 metadatas: Sequence['outputs.GetMediaAssetsMediaAssetCollectionItemMetadataResult'],
                 namespace: builtins.str,
                 object: builtins.str,
                 object_etag: builtins.str,
                 parent_media_asset_id: builtins.str,
                 segment_range_end_index: builtins.str,
                 segment_range_start_index: builtins.str,
                 source_media_workflow_id: builtins.str,
                 source_media_workflow_version: builtins.str,
                 state: builtins.str,
                 ...
                 type: builtins.str):
        """
        :param builtins.str bucket: Filter MediaAsset by the bucket where the object is stored.
        ...
        :param builtins.str master_media_asset_id: Unique MediaAsset identifier of the first asset upload.
        :param Sequence['GetMediaAssetsMediaAssetCollectionItemMediaAssetTagArgs'] media_asset_tags: List of tags for the MediaAsset.
        :param builtins.str media_workflow_job_id: The ID of the MediaWorkflowJob used to produce this asset, if this parameter is supplied then the workflow ID must also be supplied.
        ...
        :param builtins.str namespace: The object storage namespace where this asset is located.
        :param builtins.str object: Filter MediaAsset by the name of the object in object storage.
        :param builtins.str object_etag: eTag of the underlying object storage object.
        :param builtins.str parent_media_asset_id: Unique MediaAsset identifier of the asset from which this asset is derived.
        :param builtins.str segment_range_end_index: The end index of video segment files.
        :param builtins.str segment_range_start_index: The start index for video segment files.
        :param builtins.str source_media_workflow_id: The ID of the MediaWorkflow used to produce this asset.
        :param builtins.str source_media_workflow_version: The version of the MediaWorkflow used to produce this asset.
        ...
        :param builtins.str time_created: The time when the MediaAsset was created. An RFC3339 formatted datetime string.
        :param builtins.str time_updated: The time when the MediaAsset was updated. An RFC3339 formatted datetime string.
        :param builtins.str type: Filter MediaAsset by the asset type.
        """
        pulumi.set(__self__, "bucket", bucket)
        pulumi.set(__self__, "compartment_id", compartment_id)
    ...
    def master_media_asset_id(self) -> builtins.str:
        """
    ...
    def media_workflow_job_id(self) -> builtins.str:
        """
    ...
    def object_etag(self) -> builtins.str:
        """
    ...
    def parent_media_asset_id(self) -> builtins.str:
        """
    ...
    def segment_range_end_index(self) -> builtins.str:
        """
    ...
    def segment_range_start_index(self) -> builtins.str:
        """
    ...
    def source_media_workflow_id(self) -> builtins.str:
        """
    ...
    def source_media_workflow_version(self) -> builtins.str:
        """
...
class GetMediaWorkflowConfigurationLockResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str message: A message added by the creator of the lock. This is typically used to give an indication of why the resource is locked.
        :param builtins.str related_resource_id: The ID of the resource that is locking this resource. Indicates that deleting this resource will remove the lock.
        :param builtins.str time_created: The time when the the MediaWorkflowConfiguration was created. An RFC3339 formatted datetime string.
        :param builtins.str type: Type of the lock.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "message", message)
...
class GetMediaWorkflowConfigurationsMediaWorkflowConfigurationCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str display_name: A filter to return only the resources that match the entire display name given.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: Unique MediaWorkflowConfiguration identifier.
        :param builtins.str lifecyle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        ...
        :param builtins.str parameters: Reuseable parameter values encoded as a JSON; the top and second level JSON elements are objects. Each key of the top level object refer to a task key that is unqiue to the workflow, each of the second level objects' keys refer to the name of a parameter that is unique to the task. taskKey > parameterName > parameterValue
        :param builtins.str state: A filter to return only the resources with lifecycleState matching the given lifecycleState.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The time when the the MediaWorkflowConfiguration was created. An RFC3339 formatted datetime string.
        :param builtins.str time_updated: The time when the MediaWorkflowConfiguration was updated. An RFC3339 formatted datetime string.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
        pulumi.set(__self__, "display_name", display_name)
...
class GetMediaWorkflowJobFactsFilterResult(dict):
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: Unique name. It is read-only and generated for the fact.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
...
class GetMediaWorkflowJobFactsMediaWorkflowJobFactCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str detail: The body of the detail captured as JSON.
        :param builtins.str key: Filter by MediaWorkflowJob ID and MediaWorkflowJobFact key.
        :param builtins.str media_workflow_job_id: Unique MediaWorkflowJob identifier.
        :param builtins.str name: Unique name. It is read-only and generated for the fact.
        :param builtins.str type: Types of details to include.
        """
...
class GetMediaWorkflowJobLockResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str message: A message added by the creator of the lock. This is typically used to give an indication of why the resource is locked.
        :param builtins.str related_resource_id: The ID of the resource that is locking this resource. Indicates that deleting this resource will remove the lock.
        :param builtins.str time_created: Creation time of the job. An RFC3339 formatted datetime string.
        :param builtins.str type: Type of the lock.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "message", message)
...
class GetMediaWorkflowJobsMediaWorkflowJobCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 media_workflow_configuration_ids: Sequence[builtins.str],
                 media_workflow_id: builtins.str,
                 media_workflow_name: builtins.str,
                 outputs: Sequence['outputs.GetMediaWorkflowJobsMediaWorkflowJobCollectionItemOutputResult'],
                 parameters: builtins.str,
                 runnable: builtins.str,
                 state: builtins.str,
                 system_tags: Mapping[str, builtins.str],
                 ...
                 time_updated: builtins.str,
                 workflow_identifier_type: builtins.str):
        """
        :param builtins.str compartment_id: The ID of the compartment in which to list resources.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str display_name: A filter to return only the resources that match the entire display name given.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: unique MediaWorkflowJob identifier
        :param builtins.str lifecycle_details: The lifecycle details of MediaWorkflowJob task.
        :param Sequence['GetMediaWorkflowJobsMediaWorkflowJobCollectionItemLockArgs'] locks: Locks associated with this resource.
        :param Sequence[builtins.str] media_workflow_configuration_ids: Configurations to be applied to this run of the workflow.
        :param builtins.str media_workflow_id: Unique MediaWorkflow identifier.
        ...
        :param builtins.str parameters: Parameters that override parameters specified in MediaWorkflowTaskDeclarations, the MediaWorkflow, the MediaWorkflow's MediaWorkflowConfigurations and the MediaWorkflowConfigurations of this MediaWorkflowJob. The parameters are given as JSON.  The top level and 2nd level elements must be JSON objects (vs arrays, scalars, etc). The top level keys refer to a task's key and the 2nd level keys refer to a parameter's name.
        :param builtins.str runnable: A JSON representation of the job as it will be run by the system. All the task declarations, configurations and parameters are merged. Parameter values are all fully resolved.
        :param builtins.str state: A filter to return only the resources with lifecycleState matching the given lifecycleState.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        ...
        :param builtins.str time_created: Creation time of the job. An RFC3339 formatted datetime string.
        :param builtins.str time_ended: Time when the job finished. An RFC3339 formatted datetime string.
        :param builtins.str time_started: Time when the job started to execute. An RFC3339 formatted datetime string.
        :param builtins.str time_updated: Updated time of the job. An RFC3339 formatted datetime string.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
        pulumi.set(__self__, "display_name", display_name)
    ...
    def media_workflow_configuration_ids(self) -> Sequence[builtins.str]:
        """
    ...
    def media_workflow_id(self) -> builtins.str:
        """
    ...
    def media_workflow_name(self) -> builtins.str:
    ...
    @property
    @pulumi.getter
    def runnable(self) -> builtins.str:
        """
    ...
    def workflow_identifier_type(self) -> builtins.str:
...
class GetMediaWorkflowLockResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str message: A message added by the creator of the lock. This is typically used to give an indication of why the resource is locked.
        :param builtins.str related_resource_id: The ID of the resource that is locking this resource. Indicates that deleting this resource will remove the lock.
        :param builtins.str time_created: The time when the MediaWorkflow was created. An RFC3339 formatted datetime string.
        :param builtins.str type: The type of process to run at this task. Refers to the name of a MediaWorkflowTaskDeclaration.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "message", message)
        pulumi.set(__self__, "related_resource_id", related_resource_id)
...
class GetMediaWorkflowTaskResult(dict):
    def __init__(__self__, *,
                 enable_parameter_reference: builtins.str,
                 enable_when_referenced_parameter_equals: Mapping[str, builtins.str],
                 key: builtins.str,
                 parameters: builtins.str,
                 ...
                 version: builtins.str):
        """
        :param builtins.str enable_parameter_reference: Allows this task to be conditionally enabled.  If no value or a blank value is given, the task is unconditionally enbled.  Otherwise the given string specifies a parameter of the job created for this task's workflow using the JSON pointer syntax. The JSON pointer is validated when a job is created from the workflow of this task.
        :param Mapping[str, builtins.str] enable_when_referenced_parameter_equals: Used in conjunction with enableParameterReference to conditionally enable a task.  When a job is created from the workflow of this task, the task will only be enabled if the value of the parameter specified by enableParameterReference is equal to the value of this property. This property must be prenset if and only if a enableParameterReference is given. The value is a JSON node.
        :param builtins.str key: A unique identifier for this task within its workflow. Keys are used to reference a task within workflows and MediaWorkflowJobs. Tasks are referenced as prerequisites and to track output and state.
        :param builtins.str parameters: Data specifiying how this task is to be run. The data is a JSON object that must conform to the JSON Schema specified by the parameters of the MediaWorkflowTaskDeclaration this task references. The parameters may contain values or references to other parameters.
        :param Sequence[builtins.str] prerequisites: Keys to the other tasks in this workflow that must be completed before execution of this task can begin.
        :param builtins.str type: The type of process to run at this task. Refers to the name of a MediaWorkflowTaskDeclaration.
        :param builtins.str version: The version of the MediaWorkflow.
        """
        pulumi.set(__self__, "enable_parameter_reference", enable_parameter_reference)
        pulumi.set(__self__, "enable_when_referenced_parameter_equals", enable_when_referenced_parameter_equals)
        pulumi.set(__self__, "key", key)
    ...
    @property
    @pulumi.getter(name="enableParameterReference")
    def enable_parameter_reference(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="enableWhenReferencedParameterEquals")
    def enable_when_referenced_parameter_equals(self) -> Mapping[str, builtins.str]:
        """
...
class GetMediaWorkflowTaskDeclarationItemResult(dict):
    def __init__(__self__, *,
                 ...
                 parameters_schema_allowing_references: builtins.str,
                 version: builtins.int):
        """
        :param builtins.str name: A filter to return only the resources with their system defined, unique name matching the given name.
        :param builtins.str parameters_schema: JSON schema specifying the parameters supported by this type of task. This is used to validate tasks' parameters when jobs are created.
        :param builtins.str parameters_schema_allowing_references: JSON schema similar to the parameterSchema, but permits parameter values to refer to other parameters using the ${/path/to/another/parmeter} syntax.  This is used to validate task parameters when workflows are created.
        :param builtins.int version: A filter to select MediaWorkflowTaskDeclaration by version.
        """
        pulumi.set(__self__, "name", name)
    ...
    def parameters_schema_allowing_references(self) -> builtins.str:
        """
...
class GetMediaWorkflowsMediaWorkflowCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str time_created: The time when the MediaWorkflow was created. An RFC3339 formatted datetime string.
        :param builtins.str time_updated: The time when the MediaWorkflow was updated. An RFC3339 formatted datetime string.
        :param builtins.str version: The version of the MediaWorkflow.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
...
class GetStreamCdnConfigConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 edge_path_prefix: builtins.str,
                 edge_token_key: builtins.str,
                 edge_token_salt: builtins.str,
                 is_edge_token_auth: builtins.bool,
                 origin_auth_secret_key_a: builtins.str,
                 origin_auth_secret_key_b: builtins.str,
                 origin_auth_secret_key_nonce_a: builtins.str,
                 origin_auth_secret_key_nonce_b: builtins.str,
                 origin_auth_sign_encryption: builtins.str,
                 origin_auth_sign_type: builtins.str,
                 type: builtins.str):
        """
        :param builtins.str edge_hostname: The hostname of the CDN edge server to use when building CDN URLs.
        :param builtins.str edge_path_prefix: The path to prepend when building CDN URLs.
        :param builtins.str edge_token_key: The encryption key to use for edge token authentication.
        :param builtins.str edge_token_salt: Salt to use when encrypting authentication token.
        :param builtins.bool is_edge_token_auth: Whether token authentication should be used at the CDN edge.
        :param builtins.str origin_auth_secret_key_a: The shared secret key A, two for errorless key rotation.
        :param builtins.str origin_auth_secret_key_b: The shared secret key B, two for errorless key rotation.
        :param builtins.str origin_auth_secret_key_nonce_a: Nonce identifier for originAuthSecretKeyA (used to determine key used to sign).
        :param builtins.str origin_auth_secret_key_nonce_b: Nonce identifier for originAuthSecretKeyB (used to determine key used to sign).
        :param builtins.str origin_auth_sign_encryption: The type of encryption used to compute the signature.
        :param builtins.str origin_auth_sign_type: The type of data used to compute the signature.
        :param builtins.str type: Type of the lock.
        """
        pulumi.set(__self__, "edge_hostname", edge_hostname)
        pulumi.set(__self__, "edge_path_prefix", edge_path_prefix)
    ...
    @property
    @pulumi.getter(name="edgePathPrefix")
    def edge_path_prefix(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="edgeTokenKey")
    def edge_token_key(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="edgeTokenSalt")
    def edge_token_salt(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="isEdgeTokenAuth")
    def is_edge_token_auth(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="originAuthSecretKeyA")
    def origin_auth_secret_key_a(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="originAuthSecretKeyB")
    def origin_auth_secret_key_b(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="originAuthSecretKeyNonceA")
    def origin_auth_secret_key_nonce_a(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="originAuthSecretKeyNonceB")
    def origin_auth_secret_key_nonce_b(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="originAuthSignEncryption")
    def origin_auth_sign_encryption(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="originAuthSignType")
    def origin_auth_sign_type(self) -> builtins.str:
        """
...
class GetStreamCdnConfigLockResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str message: A message added by the creator of the lock. This is typically used to give an indication of why the resource is locked.
        :param builtins.str related_resource_id: The ID of the resource that is locking this resource. Indicates that deleting this resource will remove the lock.
        :param builtins.str time_created: The time when the CDN Config was created. An RFC3339 formatted datetime string.
        :param builtins.str type: Type of the lock.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "message", message)
...
class GetStreamCdnConfigsStreamCdnConfigCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 defined_tags: Mapping[str, builtins.str],
                 display_name: builtins.str,
                 distribution_channel_id: builtins.str,
                 freeform_tags: Mapping[str, builtins.str],
                 id: builtins.str,
        ...
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str display_name: A filter to return only the resources that match the entire display name given.
        :param builtins.str distribution_channel_id: The Stream Distribution Channel identifier this CdnConfig belongs to.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: Unique StreamCdnConfig identifier.
        :param builtins.bool is_enabled: Whether publishing to CDN is enabled.
        :param builtins.str lifecyle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        :param Sequence['GetStreamCdnConfigsStreamCdnConfigCollectionItemLockArgs'] locks: Locks associated with this resource.
        :param builtins.str state: A filter to return only the resources with lifecycleState matching the given lifecycleState.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The time when the CDN Config was created. An RFC3339 formatted datetime string.
        :param builtins.str time_updated: The time when the CDN Config was updated. An RFC3339 formatted datetime string.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
    ...
    def distribution_channel_id(self) -> builtins.str:
        """
...
class GetStreamDistributionChannelLockResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str message: A message added by the creator of the lock. This is typically used to give an indication of why the resource is locked.
        :param builtins.str related_resource_id: The ID of the resource that is locking this resource. Indicates that deleting this resource will remove the lock.
        :param builtins.str time_created: The time when the Stream Distribution Channel was created. An RFC3339 formatted datetime string.
        :param builtins.str type: Type of the lock.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "message", message)
...
class GetStreamDistributionChannelsStreamDistributionChannelCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str display_name: A filter to return only the resources that match the entire display name given.
        :param builtins.str domain_name: Unique domain name of the Distribution Channel.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: Unique Stream Distribution Channel identifier.
        ...
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The time when the Stream Distribution Channel was created. An RFC3339 formatted datetime string.
        :param builtins.str time_updated: The time when the Stream Distribution Channel was updated. An RFC3339 formatted datetime string.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
        pulumi.set(__self__, "display_name", display_name)
...
class GetStreamPackagingConfigLockResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str message: A message added by the creator of the lock. This is typically used to give an indication of why the resource is locked.
        :param builtins.str related_resource_id: The ID of the resource that is locking this resource. Indicates that deleting this resource will remove the lock.
        :param builtins.str time_created: The time when the Packaging Configuration was created. An RFC3339 formatted datetime string.
        :param builtins.str type: Type of the lock.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "message", message)
...
class GetStreamPackagingConfigsStreamPackagingConfigCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 segment_time_in_seconds: builtins.int,
                 state: builtins.str,
                 stream_packaging_format: builtins.str,
                 system_tags: Mapping[str, builtins.str],
                 time_created: builtins.str,
                 time_updated: builtins.str):
        """
        ...
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str display_name: A filter to return only the resources that match the entire display name given.
        :param builtins.str distribution_channel_id: Unique Stream Distribution Channel identifier.
        ...
        :param builtins.int segment_time_in_seconds: The duration in seconds for each fragment.
        :param builtins.str state: A filter to return only the resources with lifecycleState matching the given lifecycleState.
        :param builtins.str stream_packaging_format: The output format for the package.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The time when the Packaging Configuration was created. An RFC3339 formatted datetime string.
        :param builtins.str time_updated: The time when the Packaging Configuration was updated. An RFC3339 formatted datetime string.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
        pulumi.set(__self__, "display_name", display_name)
    ...
    def segment_time_in_seconds(self) -> builtins.int:
        """
    ...
    def stream_packaging_format(self) -> builtins.str:
        """
...
class GetSystemMediaWorkflowItemResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str description: Description of this workflow's processing and how that processing can be customized by specifying parameter values.
        :param builtins.str name: A filter to return only the resources with their system defined, unique name matching the given name.
        :param builtins.str parameters: Data specifiying how this task is to be run. The data is a JSON object that must conform to the JSON Schema specified by the parameters of the MediaWorkflowTaskDeclaration this task references. The parameters may contain values or references to other parameters.
...
class GetSystemMediaWorkflowItemTaskResult(dict):
    def __init__(__self__, *,
        ...
        :param Sequence[builtins.str] prerequisites: Keys to the other tasks in this workflow that must be completed before execution of this task can begin.
        :param builtins.str type: The type of process to run at this task. Refers to the name of a MediaWorkflowTaskDeclaration.
        :param builtins.str version: The version of the MediaWorkflowTaskDeclaration.
        """
        pulumi.set(__self__, "enable_parameter_reference", enable_parameter_reference)
        pulumi.set(__self__, "enable_when_referenced_parameter_equals", enable_when_referenced_parameter_equals)
        pulumi.set(__self__, "key", key)
