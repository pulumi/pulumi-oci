...
class StreamCdnConfigArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) CDN Config display name, which can be renamed and is not necessarily unique. Avoid entering confidential information.
        :param pulumi.Input[builtins.str] distribution_channel_id: Distribution Channel Identifier.
        ...
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) Whether publishing to CDN is enabled.
...
class _StreamCdnConfigState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) Whether publishing to CDN is enabled.
        :param pulumi.Input[builtins.str] lifecyle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        :param pulumi.Input[Sequence[pulumi.Input['StreamCdnConfigLockArgs']]] locks: Locks associated with this resource.
        :param pulumi.Input[builtins.str] state: The current state of the CDN Configuration.
        ...
        :param pulumi.Input[builtins.str] time_created: The time when the CDN Config was created. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The time when the CDN Config was updated. An RFC3339 formatted datetime string.
        """
...
class StreamCdnConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'StreamCdnConfig':
        """
