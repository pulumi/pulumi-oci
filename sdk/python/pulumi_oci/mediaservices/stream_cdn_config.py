    ...
    def __init__(__self__,
        ...
        test_stream_cdn_config = oci.media_services.StreamCdnConfig("testStreamCdnConfig",
            config=oci.media_services.StreamCdnConfigConfigArgs(
                ...
                edge_hostname=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                edge_path_prefix=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                edge_token_key=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                edge_token_salt=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                is_edge_token_auth=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                origin_auth_secret_key_a=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                origin_auth_secret_key_b=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                origin_auth_secret_key_nonce_a=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                origin_auth_secret_key_nonce_b=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                origin_auth_sign_encryption=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                origin_auth_sign_type=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
            ),
