...
class StreamDistributionChannelArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) Stream Distribution Channel display name. Avoid entering confidential information.
...
class _StreamDistributionChannelState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] display_name: (Updatable) Stream Distribution Channel display name. Avoid entering confidential information.
        :param pulumi.Input[builtins.str] domain_name: Unique domain name of the Distribution Channel.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[Sequence[pulumi.Input['StreamDistributionChannelLockArgs']]] locks: Locks associated with this resource.
        :param pulumi.Input[builtins.str] state: The current state of the Stream Distribution Channel.
        ...
        :param pulumi.Input[builtins.str] time_created: The time when the Stream Distribution Channel was created. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The time when the Stream Distribution Channel was updated. An RFC3339 formatted datetime string.
        """
...
class StreamDistributionChannel(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'StreamDistributionChannel':
        """
