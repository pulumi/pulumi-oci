...
class StreamPackagingConfigArgs:
    def __init__(__self__, *,
                 ...
                 distribution_channel_id: pulumi.Input[builtins.str],
                 segment_time_in_seconds: pulumi.Input[builtins.int],
                 stream_packaging_format: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The name of the stream Packaging Configuration. Avoid entering confidential information.
        :param pulumi.Input[builtins.str] distribution_channel_id: Unique identifier of the Distribution Channel that this stream packaging configuration belongs to.
        :param pulumi.Input[builtins.int] segment_time_in_seconds: The duration in seconds for each fragment.
        :param pulumi.Input[builtins.str] stream_packaging_format: The output format for the package.
    ...
    def distribution_channel_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def distribution_channel_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "distribution_channel_id", value)

    @property
    @pulumi.getter(name="segmentTimeInSeconds")
    def segment_time_in_seconds(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def segment_time_in_seconds(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "segment_time_in_seconds", value)

    @property
    @pulumi.getter(name="streamPackagingFormat")
    def stream_packaging_format(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def stream_packaging_format(self, value: pulumi.Input[builtins.str]):
...
class _StreamPackagingConfigState:
    def __init__(__self__, *,
                 ...
                 distribution_channel_id: Optional[pulumi.Input[builtins.str]] = None,
                 encryption: Optional[pulumi.Input['StreamPackagingConfigEncryptionArgs']] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_lock_override: Optional[pulumi.Input[builtins.bool]] = None,
                 locks: Optional[pulumi.Input[Sequence[pulumi.Input['StreamPackagingConfigLockArgs']]]] = None,
                 segment_time_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 stream_packaging_format: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['StreamPackagingConfigLockArgs']]] locks: Locks associated with this resource.
        :param pulumi.Input[builtins.int] segment_time_in_seconds: The duration in seconds for each fragment.
        :param pulumi.Input[builtins.str] state: The current state of the Packaging Configuration.
        :param pulumi.Input[builtins.str] stream_packaging_format: The output format for the package.
        ...
        :param pulumi.Input[builtins.str] time_created: The time when the Packaging Configuration was created. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The time when the Packaging Configuration was updated. An RFC3339 formatted datetime string.
        """
    ...
    @property
    @pulumi.getter(name="distributionChannelId")
    def distribution_channel_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Unique identifier of the Distribution Channel that this stream packaging configuration belongs to.
        """
        return pulumi.get(self, "distribution_channel_id")
    ...
    @distribution_channel_id.setter
    def distribution_channel_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "distribution_channel_id", value)
    ...
    @property
    @pulumi.getter(name="segmentTimeInSeconds")
    def segment_time_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        The duration in seconds for each fragment.
        """
        return pulumi.get(self, "segment_time_in_seconds")
    ...
    @segment_time_in_seconds.setter
    def segment_time_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "segment_time_in_seconds", value)
    ...
    @property
    @pulumi.getter(name="streamPackagingFormat")
    def stream_packaging_format(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The output format for the package.
    ...
    @stream_packaging_format.setter
    def stream_packaging_format(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "stream_packaging_format", value)
...
class StreamPackagingConfig(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'StreamPackagingConfig':
        """
    ...
    @property
    @pulumi.getter(name="distributionChannelId")
    def distribution_channel_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique identifier of the Distribution Channel that this stream packaging configuration belongs to.
        """
        return pulumi.get(self, "distribution_channel_id")
    ...
    @property
    @pulumi.getter(name="segmentTimeInSeconds")
    def segment_time_in_seconds(self) -> pulumi.Output[builtins.int]:
        """
        The duration in seconds for each fragment.
        """
        return pulumi.get(self, "segment_time_in_seconds")
    ...
    @property
    @pulumi.getter(name="streamPackagingFormat")
    def stream_packaging_format(self) -> pulumi.Output[builtins.str]:
        """
        The output format for the package.
