...
class GetAverageCarbonEmissionResult:
    ...
    def average_carbon_emission(self) -> builtins.float:
        """
...
def get_average_carbon_emission(sku_part_number: Optional[builtins.str] = None,
...
def get_average_carbon_emission_output(sku_part_number: Optional[pulumi.Input[builtins.str]] = None,
