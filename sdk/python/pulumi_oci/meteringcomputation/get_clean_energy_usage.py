...
def get_clean_energy_usage(region: Optional[builtins.str] = None,
    ...
    :param builtins.str region: The region.
    """
    __args__ = dict()
...
def get_clean_energy_usage_output(region: Optional[pulumi.Input[builtins.str]] = None,
