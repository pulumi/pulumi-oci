...
class GetCustomTableResult:
    ...
    def custom_table_id(self) -> builtins.str:
...
def get_custom_table(custom_table_id: Optional[builtins.str] = None,
    ...
    :param builtins.str custom_table_id: The custom table unique OCID.
    """
    __args__ = dict()
...
def get_custom_table_output(custom_table_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:MeteringComputation/getCustomTable:getCustomTable', __args__, opts=opts, typ=GetCustomTableResult)
    return __ret__.apply(lambda __response__: GetCustomTableResult(
        compartment_id=pulumi.get(__response__, 'compartment_id'),
        custom_table_id=pulumi.get(__response__, 'custom_table_id'),
        id=pulumi.get(__response__, 'id'),
        saved_custom_tables=pulumi.get(__response__, 'saved_custom_tables'),
