...
class GetCustomTableResult:
    ...
    def custom_table_id(self) -> _builtins.str:
...
def get_custom_table(custom_table_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str custom_table_id: The custom table unique OCID.
    """
    __args__ = dict()
