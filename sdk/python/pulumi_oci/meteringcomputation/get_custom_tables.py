...
def get_custom_tables(compartment_id: Optional[builtins.str] = None,
                      filters: Optional[Sequence[Union['GetCustomTablesFilterArgs', 'GetCustomTablesFilterArgsDict']]] = None,
                      saved_report_id: Optional[builtins.str] = None,
...
def get_custom_tables_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:MeteringComputation/getCustomTables:getCustomTables', __args__, opts=opts, typ=GetCustomTablesResult)
    return __ret__.apply(lambda __response__: GetCustomTablesResult(
        compartment_id=pulumi.get(__response__, 'compartment_id'),
        custom_table_collections=pulumi.get(__response__, 'custom_table_collections'),
