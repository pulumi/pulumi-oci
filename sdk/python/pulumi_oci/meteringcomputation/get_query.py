...
def get_query(query_id: Optional[builtins.str] = None,
    ...
    :param builtins.str query_id: The query unique OCID.
    """
    __args__ = dict()
...
def get_query_output(query_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:MeteringComputation/getQuery:getQuery', __args__, opts=opts, typ=GetQueryResult)
