...
class GetScheduledRunResult:
    ...
    def scheduled_run_id(self) -> _builtins.str:
...
def get_scheduled_run(scheduled_run_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str scheduled_run_id: The scheduled run unique OCID.
    """
    __args__ = dict()
