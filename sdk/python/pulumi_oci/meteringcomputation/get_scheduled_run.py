...
class GetScheduledRunResult:
    ...
    def scheduled_run_id(self) -> builtins.str:
...
def get_scheduled_run(scheduled_run_id: Optional[builtins.str] = None,
...
def get_scheduled_run_output(scheduled_run_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetScheduledRunResult(
        ...
        scheduled_run_id=pulumi.get(__response__, 'scheduled_run_id'),
