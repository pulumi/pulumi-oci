...
def get_usage_carbon_emissions_config(tenant_id: Optional[_builtins.str] = None,
...
def get_usage_carbon_emissions_config_output(tenant_id: Optional[pulumi.Input[_builtins.str]] = None,
