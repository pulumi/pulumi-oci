...
def get_usage_carbon_emissions_queries(compartment_id: Optional[builtins.str] = None,
...
def get_usage_carbon_emissions_queries_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
