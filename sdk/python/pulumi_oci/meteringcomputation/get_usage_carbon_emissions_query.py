...
class GetUsageCarbonEmissionsQueryResult:
    ...
    def usage_carbon_emissions_query_id(self) -> builtins.str:
...
def get_usage_carbon_emissions_query(usage_carbon_emissions_query_id: Optional[builtins.str] = None,
    ...
    :param builtins.str usage_carbon_emissions_query_id: The query unique OCID.
    """
    __args__ = dict()
...
def get_usage_carbon_emissions_query_output(usage_carbon_emissions_query_id: Optional[pulumi.Input[builtins.str]] = None,
