...
class Query(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_query = oci.metering_computation.Query("testQuery",
            ...
            query_definition=oci.metering.computation.QueryQueryDefinitionArgs(
                cost_analysis_ui=oci.metering.computation.QueryQueryDefinitionCostAnalysisUiArgs(
                ...
                report_query=oci.metering.computation.QueryQueryDefinitionReportQueryArgs(
                    ...
                    forecast=oci.metering.computation.QueryQueryDefinitionReportQueryForecastArgs(
                    ...
                    group_by_tags=[oci.metering.computation.QueryQueryDefinitionReportQueryGroupByTagArgs(
