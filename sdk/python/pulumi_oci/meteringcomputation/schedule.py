...
class ScheduleArgs:
    def __init__(__self__, *,
                 ...
                 schedule_recurrences: pulumi.Input[builtins.str],
                 time_scheduled: pulumi.Input[builtins.str],
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 output_file_format: Optional[pulumi.Input[builtins.str]] = None,
                 query_properties: Optional[pulumi.Input['ScheduleQueryPropertiesArgs']] = None,
                 saved_report_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Schedule resource.
        :param pulumi.Input[builtins.str] compartment_id: The customer tenancy.
        ...
        :param pulumi.Input[builtins.str] schedule_recurrences: Specifies the frequency according to when the schedule will be run, in the x-obmcs-recurring-time format described in [RFC 5545 section 3.3.10](https://datatracker.ietf.org/doc/html/rfc5545#section-3.3.10). Supported values are : ONE_TIME, DAILY, WEEKLY and MONTHLY.
        :param pulumi.Input[builtins.str] time_scheduled: The date and time of the first time job execution.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) The description of the schedule.
        ...
        :param pulumi.Input[builtins.str] name: The unique name of the user-created schedule.
        :param pulumi.Input[builtins.str] output_file_format: (Updatable) Specifies the supported output file format.
        :param pulumi.Input['ScheduleQueryPropertiesArgs'] query_properties: The query properties.
        :param pulumi.Input[builtins.str] saved_report_id: The saved report ID which can also be used to generate a query.
        """
    ...
    def schedule_recurrences(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def schedule_recurrences(self, value: pulumi.Input[builtins.str]):
    ...
    def output_file_format(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def output_file_format(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def saved_report_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def saved_report_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ScheduleState:
    def __init__(__self__, *,
                 ...
                 saved_report_id: Optional[pulumi.Input[builtins.str]] = None,
                 schedule_recurrences: Optional[pulumi.Input[builtins.str]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 time_created: Optional[pulumi.Input[builtins.str]] = None,
                 time_next_run: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] saved_report_id: The saved report ID which can also be used to generate a query.
        :param pulumi.Input[builtins.str] schedule_recurrences: Specifies the frequency according to when the schedule will be run, in the x-obmcs-recurring-time format described in [RFC 5545 section 3.3.10](https://datatracker.ietf.org/doc/html/rfc5545#section-3.3.10). Supported values are : ONE_TIME, DAILY, WEEKLY and MONTHLY.
        :param pulumi.Input[builtins.str] state: The schedule lifecycle state.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the schedule was created.
        :param pulumi.Input[builtins.str] time_next_run: The date and time of the next job execution.
        :param pulumi.Input[builtins.str] time_scheduled: The date and time of the first time job execution.
    ...
    @property
    @pulumi.getter(name="scheduleRecurrences")
    def schedule_recurrences(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Specifies the frequency according to when the schedule will be run, in the x-obmcs-recurring-time format described in [RFC 5545 section 3.3.10](https://datatracker.ietf.org/doc/html/rfc5545#section-3.3.10). Supported values are : ONE_TIME, DAILY, WEEKLY and MONTHLY.
        """
        return pulumi.get(self, "schedule_recurrences")
    ...
    @schedule_recurrences.setter
    def schedule_recurrences(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "schedule_recurrences", value)
    ...
    def time_next_run(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_next_run(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Schedule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_next_run: Optional[pulumi.Input[builtins.str]] = None,
            time_scheduled: Optional[pulumi.Input[builtins.str]] = None) -> 'Schedule':
        """
    ...
    @property
    @pulumi.getter(name="outputFileFormat")
    def output_file_format(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Specifies the supported output file format.
        """
        return pulumi.get(self, "output_file_format")
    ...
    @property
    @pulumi.getter(name="savedReportId")
    def saved_report_id(self) -> pulumi.Output[builtins.str]:
        """
        The saved report ID which can also be used to generate a query.
        """
        return pulumi.get(self, "saved_report_id")
    ...
    @property
    @pulumi.getter(name="scheduleRecurrences")
    def schedule_recurrences(self) -> pulumi.Output[builtins.str]:
        """
        Specifies the frequency according to when the schedule will be run, in the x-obmcs-recurring-time format described in [RFC 5545 section 3.3.10](https://datatracker.ietf.org/doc/html/rfc5545#section-3.3.10). Supported values are : ONE_TIME, DAILY, WEEKLY and MONTHLY.
        """
        return pulumi.get(self, "schedule_recurrences")
    ...
    @property
    @pulumi.getter(name="timeNextRun")
    def time_next_run(self) -> pulumi.Output[builtins.str]:
        """
        The date and time of the next job execution.
        """
        return pulumi.get(self, "time_next_run")
