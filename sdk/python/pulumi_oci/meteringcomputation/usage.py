...
class UsageArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] granularity: The usage granularity. HOURLY - Hourly data aggregation. DAILY - Daily data aggregation. MONTHLY - Monthly data aggregation. TOTAL - Not yet supported.
        ...
        :param pulumi.Input[builtins.float] compartment_depth: The compartment depth level.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] group_bies: Aggregate the result by. example: `["tagNamespace", "tagKey", "tagValue", "service", "skuName", "skuPartNumber", "unit", "compartmentName", "compartmentPath", "compartmentId", "platform", "region", "logicalAd", "resourceId", "tenantId", "tenantName"]`
        ...
        :param pulumi.Input[builtins.bool] is_aggregate_by_time: Whether aggregated by time. If isAggregateByTime is true, all usage/cost over the query time period will be added up.
        :param pulumi.Input[builtins.str] query_type: The query usage type. COST by default if it is missing. Usage - Query the usage data. Cost - Query the cost/billing data. Credit - Query the credit adjustments data. ExpiredCredit - Query the expired credits data. AllCredit - Query the credit adjustments and expired credit.
        """
...
class Usage(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tenant_id: Optional[pulumi.Input[builtins.str]] = None,
            time_usage_ended: Optional[pulumi.Input[builtins.str]] = None,
            time_usage_started: Optional[pulumi.Input[builtins.str]] = None) -> 'Usage':
        """
    ...
    @property
    @pulumi.getter(name="compartmentDepth")
    def compartment_depth(self) -> pulumi.Output[builtins.float]:
        """
        The compartment depth level.
        """
        return pulumi.get(self, "compartment_depth")
    ...
    @property
    @pulumi.getter(name="queryType")
    def query_type(self) -> pulumi.Output[builtins.str]:
        """
        The query usage type. COST by default if it is missing. Usage - Query the usage data. Cost - Query the cost/billing data. Credit - Query the credit adjustments data. ExpiredCredit - Query the expired credits data. AllCredit - Query the credit adjustments and expired credit.
        """
        return pulumi.get(self, "query_type")
