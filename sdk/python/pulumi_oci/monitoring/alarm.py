...
class AlarmArgs:
    def __init__(__self__, *,
                 ...
                 metric_compartment_id: pulumi.Input[builtins.str],
                 namespace: pulumi.Input[builtins.str],
                 query: pulumi.Input[builtins.str],
                 severity: pulumi.Input[builtins.str],
                 alarm_summary: Optional[pulumi.Input[builtins.str]] = None,
                 body: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 evaluation_slack_duration: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_notifications_per_metric_dimension_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 message_format: Optional[pulumi.Input[builtins.str]] = None,
                 metric_compartment_id_in_subtree: Optional[pulumi.Input[builtins.bool]] = None,
                 notification_title: Optional[pulumi.Input[builtins.str]] = None,
                 notification_version: Optional[pulumi.Input[builtins.str]] = None,
                 overrides: Optional[pulumi.Input[Sequence[pulumi.Input['AlarmOverrideArgs']]]] = None,
                 pending_duration: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the alarm.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] destinations: (Updatable) A list of destinations for alarm notifications. Each destination is represented by the [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a related resource, such as a [topic](https://docs.cloud.oracle.com/iaas/api/#/en/notification/latest/NotificationTopic). Supported destination services: Notifications, Streaming. Limit: One destination per supported destination service.
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name for the alarm. It does not have to be unique, and it's changeable. Avoid entering confidential information.
               
               This value determines the title of each alarm notification.
               
               Example: `High CPU Utilization`
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) Whether the alarm is enabled.  Example: `true`
        :param pulumi.Input[builtins.str] metric_compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the metric being evaluated by the alarm.
        :param pulumi.Input[builtins.str] namespace: (Updatable) The source service or application emitting the metric that is evaluated by the alarm.  Example: `oci_computeagent`
        ...
        :param pulumi.Input[builtins.bool] is_notifications_per_metric_dimension_enabled: (Updatable) When set to `true`, splits alarm notifications per metric stream. When set to `false`, groups alarm notifications across metric streams. Example: `true`
        :param pulumi.Input[builtins.str] message_format: (Updatable) The format to use for alarm notifications. The formats are:
        ...
        :param pulumi.Input[builtins.bool] metric_compartment_id_in_subtree: (Updatable) When true, the alarm evaluates metrics from all compartments and subcompartments. The parameter can only be set to true when metricCompartmentId is the tenancy OCID (the tenancy is the root compartment). A true value requires the user to have tenancy-level permissions. If this requirement is not met, then the call is rejected. When false, the alarm evaluates metrics from only the compartment specified in metricCompartmentId. Default is false.  Example: `true`
        :param pulumi.Input[builtins.str] notification_title: (Updatable) Customizable notification title (`title` [alarm message parameter](https://docs.cloud.oracle.com/iaas/Content/Monitoring/alarm-message-format.htm)). Optionally include [dynamic variables](https://docs.cloud.oracle.com/iaas/Content/Monitoring/Tasks/update-alarm-dynamic-variables.htm). The notification title appears as the subject line in a formatted email message and as the title in a Slack message.
        :param pulumi.Input[builtins.str] notification_version: (Updatable) The version of the alarm notification to be delivered. Allowed value: `1.X` The value must start with a number (up to four digits), followed by a period and an uppercase X.
        ...
        :param pulumi.Input[builtins.str] repeat_notification_duration: (Updatable) The frequency for re-submitting alarm notifications, if the alarm keeps firing without interruption. Format defined by ISO 8601. For example, `PT4H` indicates four hours. Minimum: PT1M. Maximum: P30D.
               ...
               Example: `PT2H`
        :param pulumi.Input[builtins.str] resolution: (Updatable) The time between calculated aggregation windows for the alarm. Supported value: `1m`
        :param pulumi.Input[builtins.str] resource_group: (Updatable) Resource group that you want to match. A null value returns only metric data that has no resource groups. The alarm retrieves metric data associated with the specified resource group only. Only one resource group can be applied per metric. A valid resourceGroup value starts with an alphabetical character and includes only alphanumeric characters, periods (.), underscores (_), hyphens (-), and dollar signs ($). Avoid entering confidential information.  Example: `frontend-fleet`
        :param pulumi.Input[builtins.str] rule_name: (Updatable) Identifier of the alarm's base values for alarm evaluation, for use when the alarm contains overrides.  Default value is `BASE`. For information about alarm overrides, see [AlarmOverride](https://docs.cloud.oracle.com/iaas/api/#/en/monitoring/latest/datatypes/AlarmOverride).
    ...
    def metric_compartment_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def metric_compartment_id(self, value: pulumi.Input[builtins.str]):
    ...
    def alarm_summary(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Customizable alarm summary (`alarmSummary` [alarm message parameter](https://docs.cloud.oracle.com/iaas/Content/Monitoring/alarm-message-format.htm)). Optionally include [dynamic variables](https://docs.cloud.oracle.com/iaas/Content/Monitoring/Tasks/update-alarm-dynamic-variables.htm). The alarm summary appears within the body of the alarm message and in responses to  [ListAlarmStatus](https://docs.cloud.oracle.com/iaas/api/#/en/monitoring/latest/AlarmStatusSummary/ListAlarmsStatus)  [GetAlarmHistory](https://docs.cloud.oracle.com/iaas/api/#/en/monitoring/latest/AlarmHistoryCollection/GetAlarmHistory) and [RetrieveDimensionStates](https://docs.cloud.oracle.com/iaas/api/#/en/monitoring/latest/AlarmDimensionStatesCollection/RetrieveDimensionStates).
        """
    ...
    def alarm_summary(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def evaluation_slack_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def evaluation_slack_duration(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_notifications_per_metric_dimension_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_notifications_per_metric_dimension_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def metric_compartment_id_in_subtree(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def metric_compartment_id_in_subtree(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def notification_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def notification_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def pending_duration(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def pending_duration(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AlarmState:
    def __init__(__self__, *,
                 ...
                 is_notifications_per_metric_dimension_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 message_format: Optional[pulumi.Input[builtins.str]] = None,
                 metric_compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 metric_compartment_id_in_subtree: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] rule_name: (Updatable) Identifier of the alarm's base values for alarm evaluation, for use when the alarm contains overrides.  Default value is `BASE`. For information about alarm overrides, see [AlarmOverride](https://docs.cloud.oracle.com/iaas/api/#/en/monitoring/latest/datatypes/AlarmOverride).
        :param pulumi.Input[builtins.str] severity: (Updatable) The perceived type of response required when the alarm is in the "FIRING" state.  Example: `CRITICAL`
        :param pulumi.Input[builtins.str] state: The current lifecycle state of the alarm.  Example: `DELETED`
        :param pulumi.Input['AlarmSuppressionArgs'] suppression: (Updatable) The configuration details for suppressing an alarm.
        :param pulumi.Input[builtins.str] time_created: The date and time the alarm was created. Format defined by RFC3339.  Example: `2023-02-01T01:02:29.600Z`
        :param pulumi.Input[builtins.str] time_updated: The date and time the alarm was last updated. Format defined by RFC3339.  Example: `2023-02-03T01:02:29.600Z`
        """
        if alarm_summary is not None:
            pulumi.set(__self__, "alarm_summary", alarm_summary)
        if body is not None:
    ...
    @property
    @pulumi.getter(name="metricCompartmentId")
    def metric_compartment_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the metric being evaluated by the alarm.
        """
        return pulumi.get(self, "metric_compartment_id")
    ...
    @metric_compartment_id.setter
    def metric_compartment_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "metric_compartment_id", value)
...
class Alarm(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            suppression: Optional[pulumi.Input[Union['AlarmSuppressionArgs', 'AlarmSuppressionArgsDict']]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'Alarm':
        """
    ...
    @property
    @pulumi.getter(name="alarmSummary")
    def alarm_summary(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Customizable alarm summary (`alarmSummary` [alarm message parameter](https://docs.cloud.oracle.com/iaas/Content/Monitoring/alarm-message-format.htm)). Optionally include [dynamic variables](https://docs.cloud.oracle.com/iaas/Content/Monitoring/Tasks/update-alarm-dynamic-variables.htm). The alarm summary appears within the body of the alarm message and in responses to  [ListAlarmStatus](https://docs.cloud.oracle.com/iaas/api/#/en/monitoring/latest/AlarmStatusSummary/ListAlarmsStatus)  [GetAlarmHistory](https://docs.cloud.oracle.com/iaas/api/#/en/monitoring/latest/AlarmHistoryCollection/GetAlarmHistory) and [RetrieveDimensionStates](https://docs.cloud.oracle.com/iaas/api/#/en/monitoring/latest/AlarmDimensionStatesCollection/RetrieveDimensionStates).
        """
        return pulumi.get(self, "alarm_summary")
    ...
    @property
    @pulumi.getter(name="evaluationSlackDuration")
    def evaluation_slack_duration(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Customizable slack period to wait for metric ingestion before evaluating the alarm. Specify a string in ISO 8601 format (`PT10M` for ten minutes or `PT1H` for one hour). Minimum: PT3M. Maximum: PT2H. Default: PT3M. For more information about the slack period, see [About the Internal Reset Period](https://docs.cloud.oracle.com/iaas/Content/Monitoring/Concepts/monitoringoverview.htm#reset).
        """
        return pulumi.get(self, "evaluation_slack_duration")
    ...
    @property
    @pulumi.getter(name="isNotificationsPerMetricDimensionEnabled")
    def is_notifications_per_metric_dimension_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) When set to `true`, splits alarm notifications per metric stream. When set to `false`, groups alarm notifications across metric streams. Example: `true`
        """
        return pulumi.get(self, "is_notifications_per_metric_dimension_enabled")
    ...
    @property
    @pulumi.getter(name="metricCompartmentId")
    def metric_compartment_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the metric being evaluated by the alarm.
        """
        return pulumi.get(self, "metric_compartment_id")
    ...
    @property
    @pulumi.getter(name="metricCompartmentIdInSubtree")
    def metric_compartment_id_in_subtree(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) When true, the alarm evaluates metrics from all compartments and subcompartments. The parameter can only be set to true when metricCompartmentId is the tenancy OCID (the tenancy is the root compartment). A true value requires the user to have tenancy-level permissions. If this requirement is not met, then the call is rejected. When false, the alarm evaluates metrics from only the compartment specified in metricCompartmentId. Default is false.  Example: `true`
        """
        return pulumi.get(self, "metric_compartment_id_in_subtree")
    ...
    @property
    @pulumi.getter(name="notificationTitle")
    def notification_title(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Customizable notification title (`title` [alarm message parameter](https://docs.cloud.oracle.com/iaas/Content/Monitoring/alarm-message-format.htm)). Optionally include [dynamic variables](https://docs.cloud.oracle.com/iaas/Content/Monitoring/Tasks/update-alarm-dynamic-variables.htm). The notification title appears as the subject line in a formatted email message and as the title in a Slack message.
        """
        return pulumi.get(self, "notification_title")
    ...
    @property
    @pulumi.getter(name="notificationVersion")
    def notification_version(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The version of the alarm notification to be delivered. Allowed value: `1.X` The value must start with a number (up to four digits), followed by a period and an uppercase X.
        """
        return pulumi.get(self, "notification_version")
    ...
    @property
    @pulumi.getter(name="pendingDuration")
    def pending_duration(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The period of time that the condition defined in the alarm must persist before the alarm state changes from "OK" to "FIRING". For example, a value of 5 minutes means that the alarm must persist in breaching the condition for five minutes before the alarm updates its state to "FIRING".
