...
class GetAlarmHistoryCollectionResult:
    ...
    def alarm_historytype(self) -> Optional[builtins.str]:
    ...
    def timestamp_greater_than_or_equal_to(self) -> Optional[builtins.str]:
        return pulumi.get(self, "timestamp_greater_than_or_equal_to")

    @property
    @pulumi.getter(name="timestampLessThan")
    def timestamp_less_than(self) -> Optional[builtins.str]:
...
def get_alarm_history_collection(alarm_historytype: Optional[builtins.str] = None,
                                 alarm_id: Optional[builtins.str] = None,
                                 timestamp_greater_than_or_equal_to: Optional[builtins.str] = None,
                                 timestamp_less_than: Optional[builtins.str] = None,
    ...
    :param builtins.str alarm_historytype: The type of history entries to retrieve. State history (STATE_HISTORY), state transition history (STATE_TRANSITION_HISTORY), rule history (RULE_HISTORY) or rule transition history (RULE_TRANSITION_HISTORY). If not specified, entries of all types are retrieved.  Example: `STATE_HISTORY`
    :param builtins.str alarm_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of an alarm.
    :param builtins.str timestamp_greater_than_or_equal_to: A filter to return only alarm history entries with timestamps occurring on or after the specified date and time. Format defined by RFC3339.  Example: `2023-01-01T01:00:00.789Z`
    :param builtins.str timestamp_less_than: A filter to return only alarm history entries with timestamps occurring before the specified date and time. Format defined by RFC3339.  Example: `2023-01-02T01:00:00.789Z`
    """
    __args__ = dict()
...
def get_alarm_history_collection_output(alarm_historytype: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        alarm_id: Optional[pulumi.Input[builtins.str]] = None,
                                        timestamp_greater_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                        timestamp_less_than: Optional[pulumi.Input[Optional[builtins.str]]] = None,
