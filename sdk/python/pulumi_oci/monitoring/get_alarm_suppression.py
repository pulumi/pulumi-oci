...
class GetAlarmSuppressionResult:
    ...
    def alarm_suppression_id(self) -> builtins.str:
...
def get_alarm_suppression(alarm_suppression_id: Optional[builtins.str] = None,
    ...
    :param builtins.str alarm_suppression_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the alarm suppression.
    """
    __args__ = dict()
...
def get_alarm_suppression_output(alarm_suppression_id: Optional[pulumi.Input[builtins.str]] = None,
