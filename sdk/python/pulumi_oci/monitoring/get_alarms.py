...
def get_alarms(compartment_id: Optional[builtins.str] = None,
...
def get_alarms_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Monitoring/getAlarms:getAlarms', __args__, opts=opts, typ=GetAlarmsResult)
