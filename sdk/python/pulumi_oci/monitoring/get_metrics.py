...
class GetMetricsResult:
    ...
    def dimension_filters(self) -> Optional[Mapping[str, builtins.str]]:
...
def get_metrics(compartment_id: Optional[builtins.str] = None,
                compartment_id_in_subtree: Optional[builtins.bool] = None,
                dimension_filters: Optional[Mapping[str, builtins.str]] = None,
...
def get_metrics_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                       compartment_id_in_subtree: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                       dimension_filters: Optional[pulumi.Input[Optional[Mapping[str, builtins.str]]]] = None,
                       ...
                       resource_group: Optional[pulumi.Input[Optional[builtins.str]]] = None,
