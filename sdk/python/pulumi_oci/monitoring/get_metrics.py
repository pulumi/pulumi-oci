...
class GetMetricsResult:
    ...
    def dimension_filters(self) -> Optional[Mapping[str, _builtins.str]]:
...
def get_metrics(compartment_id: Optional[_builtins.str] = None,
                compartment_id_in_subtree: Optional[_builtins.bool] = None,
                dimension_filters: Optional[Mapping[str, _builtins.str]] = None,
                filters: Optional[Sequence[Union['GetMetricsFilterArgs', 'GetMetricsFilterArgsDict', 'outputs.GetMetricsFilterResult']]] = None,
...
def get_metrics_output(compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                       ...
                       filters: pulumi.Input[Optional[Optional[Sequence[Union['GetMetricsFilterArgs', 'GetMetricsFilterArgsDict', 'outputs.GetMetricsFilterResult']]]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetMetricsResult(
        ...
        dimension_filters=pulumi.get(__response__, 'dimension_filters'),
