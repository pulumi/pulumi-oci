...
__all__ = [
    ...
    'MysqlDbSystemSourceChannelArgsDict',
    'MysqlDbSystemSourceChannelSslCaCertificateArgs',
    'MysqlDbSystemSourceChannelSslCaCertificateArgsDict',
...
class ChannelSourceArgs:
    ...
    def anonymous_transactions_handling(self) -> pulumi.Input[Optional['ChannelSourceAnonymousTransactionsHandlingArgs']]:
        """
        (Updatable) Specifies how the replication channel handles replicated transactions without an identifier, enabling replication from a source that does not use transaction-id-based replication to a replica that does.
        """
    ...
    def ssl_ca_certificate(self) -> pulumi.Input[Optional['ChannelSourceSslCaCertificateArgs']]:
        """
        (Updatable) The CA certificate of the server used for VERIFY_IDENTITY and VERIFY_CA ssl modes.
        """
    ...
    def ssl_ca_certificate(self, value: pulumi.Input[Optional['ChannelSourceSslCaCertificateArgs']]):
...
class ChannelSourceAnonymousTransactionsHandlingArgsDict(TypedDict):
    ...
    """
    last_configured_log_filename: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    last_configured_log_offset: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class ChannelSourceAnonymousTransactionsHandlingArgs:
    def __init__(__self__, *,
                 policy: pulumi.Input[_builtins.str],
                 last_configured_log_filename: pulumi.Input[Optional[_builtins.str]] = None,
                 last_configured_log_offset: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def last_configured_log_filename(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        (Updatable) Specifies one of the coordinates (file) at which the replica should begin reading the source's log. As this value specifies the point where replication starts from, it is only used once, when it starts. It is never used again, unless a new UpdateChannel operation modifies it.
        """
    ...
    def last_configured_log_filename(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "last_configured_log_filename", value)

    @_builtins.property
    @pulumi.getter(name="lastConfiguredLogOffset")
    def last_configured_log_offset(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        (Updatable) Specifies one of the coordinates (offset) at which the replica should begin reading the source's log. As this value specifies the point where replication starts from, it is only used once, when it starts. It is never used again, unless a new UpdateChannel operation modifies it.
        """
    ...
    def last_configured_log_offset(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class ChannelTargetArgsDict(TypedDict):
    ...
    ** IMPORTANT **
    ...
    """
    delay_in_seconds: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    tables_without_primary_key_handling: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class ChannelTargetArgs:
    def __init__(__self__, *,
                 ...
                 delay_in_seconds: pulumi.Input[Optional[_builtins.int]] = None,
                 filters: pulumi.Input[Optional[Sequence[pulumi.Input['ChannelTargetFilterArgs']]]] = None,
                 tables_without_primary_key_handling: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def delay_in_seconds(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        (Updatable) Specifies the amount of time, in seconds, that the channel waits before  applying a transaction received from the source.
        """
    ...
    def delay_in_seconds(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "delay_in_seconds", value)

    @_builtins.property
    @pulumi.getter
    def filters(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ChannelTargetFilterArgs']]]]:
        """
        (Updatable) Replication filter rules to be applied at the DB System Channel target.
        """
    ...
    @filters.setter
    def filters(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ChannelTargetFilterArgs']]]]):
        pulumi.set(self, "filters", value)

    @_builtins.property
    @pulumi.getter(name="tablesWithoutPrimaryKeyHandling")
    def tables_without_primary_key_handling(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        (Updatable) Specifies how a replication channel handles the creation and alteration of tables  that do not have a primary key. The default value is set to ALLOW.
        """
    ...
    def tables_without_primary_key_handling(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class MysqlBackupBackupValidationDetailArgsDict(TypedDict):
    backup_preparation_status: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    estimated_restore_duration: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    time_last_validated: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class MysqlBackupBackupValidationDetailArgs:
    def __init__(__self__, *,
                 backup_preparation_status: pulumi.Input[Optional[_builtins.str]] = None,
                 error_message: pulumi.Input[Optional[_builtins.str]] = None,
                 estimated_restore_duration: pulumi.Input[Optional[_builtins.str]] = None,
                 prepared_backup_details: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupBackupValidationDetailPreparedBackupDetailArgs']]]] = None,
                 time_last_validated: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def backup_preparation_status(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Indicates whether the backup has been prepared successfully.  PREPARED: The backup is prepared one. NOT_PREPARED: The backup is not prepared.
        """
    ...
    def backup_preparation_status(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def estimated_restore_duration(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The estimated restore duration of the backup.
        """
    ...
    def estimated_restore_duration(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "estimated_restore_duration", value)

    @_builtins.property
    @pulumi.getter(name="preparedBackupDetails")
    def prepared_backup_details(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupBackupValidationDetailPreparedBackupDetailArgs']]]]:
        """
        Prepared backup details.
        """
    ...
    def prepared_backup_details(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupBackupValidationDetailPreparedBackupDetailArgs']]]]):
        pulumi.set(self, "prepared_backup_details", value)

    @_builtins.property
    @pulumi.getter(name="timeLastValidated")
    def time_last_validated(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The date and time of the most recent validation performed on the backup.
        """
    ...
    def time_last_validated(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class MysqlBackupBackupValidationDetailPreparedBackupDetailArgsDict(TypedDict):
    prepared_backup_restore_reduction_in_minutes: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    The estimated time saving when this prepared backup is restored.
    """
    time_prepared: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class MysqlBackupBackupValidationDetailPreparedBackupDetailArgs:
    def __init__(__self__, *,
                 prepared_backup_restore_reduction_in_minutes: pulumi.Input[Optional[_builtins.int]] = None,
                 time_prepared: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def prepared_backup_restore_reduction_in_minutes(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The estimated time saving when this prepared backup is restored.
        """
    ...
    def prepared_backup_restore_reduction_in_minutes(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "prepared_backup_restore_reduction_in_minutes", value)

    @_builtins.property
    @pulumi.getter(name="timePrepared")
    def time_prepared(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The date and time the backup was prepared.
        """
    ...
    def time_prepared(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class MysqlBackupDbSystemSnapshotArgsDict(TypedDict):
    ...
    """
    crash_recovery: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    database_management: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    mysql_version: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    port_x: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
...
class MysqlBackupDbSystemSnapshotArgs:
    def __init__(__self__, *,
                 ...
                 backup_policies: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotBackupPolicyArgs']]]] = None,
                 ...
                 data_storages: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotDataStorageArgs']]]] = None,
                 database_consoles: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotDatabaseConsoleArgs']]]] = None,
                 database_management: pulumi.Input[Optional[_builtins.str]] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 deletion_policies: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotDeletionPolicyArgs']]]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 encrypt_datas: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotEncryptDataArgs']]]] = None,
                 endpoints: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotEndpointArgs']]]] = None,
                 ...
                 read_endpoints: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotReadEndpointArgs']]]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
                 rests: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotRestArgs']]]] = None,
                 secure_connections: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotSecureConnectionArgs']]]] = None,
                 ...
                 telemetry_configuration: pulumi.Input[Optional['MysqlBackupDbSystemSnapshotTelemetryConfigurationArgs']] = None):
        """
    ...
    def backup_policies(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotBackupPolicyArgs']]]]:
        """
        The Backup policy for the DB System.
        """
    ...
    def backup_policies(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotBackupPolicyArgs']]]]):
    ...
    def data_storages(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotDataStorageArgs']]]]:
        """
        Data Storage information.
        """
    ...
    def data_storages(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotDataStorageArgs']]]]):
        pulumi.set(self, "data_storages", value)

    @_builtins.property
    @pulumi.getter(name="databaseConsoles")
    def database_consoles(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotDatabaseConsoleArgs']]]]:
        """
        Database console configuration details.
        """
    ...
    def database_consoles(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotDatabaseConsoleArgs']]]]):
    ...
    def deletion_policies(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotDeletionPolicyArgs']]]]:
        """
        The Deletion policy for the DB System.
        """
    ...
    def deletion_policies(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotDeletionPolicyArgs']]]]):
    ...
    def encrypt_datas(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotEncryptDataArgs']]]]:
        """
        Encrypt data details.
        """
    ...
    def encrypt_datas(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotEncryptDataArgs']]]]):
        pulumi.set(self, "encrypt_datas", value)

    @_builtins.property
    @pulumi.getter
    def endpoints(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotEndpointArgs']]]]:
        """
        The network endpoints available for this DB System.
        """
    ...
    @endpoints.setter
    def endpoints(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotEndpointArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def maintenances(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotMaintenanceArgs']]]]:
        """
        The Maintenance Policy for the DB System or Read Replica that this model is included in.
        """
    ...
    @maintenances.setter
    def maintenances(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotMaintenanceArgs']]]]):
    ...
    def read_endpoints(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotReadEndpointArgs']]]]:
        """
        The read endpoint of a DB System.
        """
    ...
    def read_endpoints(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotReadEndpointArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def rests(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotRestArgs']]]]:
        """
        REST configuration details.
        """
    ...
    @rests.setter
    def rests(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotRestArgs']]]]):
        pulumi.set(self, "rests", value)

    @_builtins.property
    @pulumi.getter(name="secureConnections")
    def secure_connections(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotSecureConnectionArgs']]]]:
        """
        Secure connection configuration details.
        """
    ...
    def secure_connections(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotSecureConnectionArgs']]]]):
    ...
    def telemetry_configuration(self) -> pulumi.Input[Optional['MysqlBackupDbSystemSnapshotTelemetryConfigurationArgs']]:
        """
        Telemetry configuration details of a DB System or a read replica.
        """
    ...
    def telemetry_configuration(self, value: pulumi.Input[Optional['MysqlBackupDbSystemSnapshotTelemetryConfigurationArgs']]):
...
class MysqlBackupDbSystemSnapshotBackupPolicyArgsDict(TypedDict):
    ...
    """
    soft_delete: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    window_start_time: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class MysqlBackupDbSystemSnapshotBackupPolicyArgs:
    def __init__(__self__, *,
                 copy_policies: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotBackupPolicyCopyPolicyArgs']]]] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 is_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 pitr_policies: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotBackupPolicyPitrPolicyArgs']]]] = None,
                 retention_in_days: pulumi.Input[Optional[_builtins.int]] = None,
                 soft_delete: pulumi.Input[Optional[_builtins.str]] = None,
                 window_start_time: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def copy_policies(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotBackupPolicyCopyPolicyArgs']]]]:
        """
        List of policies of a DB system to schedule cross-region DB system backup copy.
        """
    ...
    def copy_policies(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotBackupPolicyCopyPolicyArgs']]]]):
    ...
    def pitr_policies(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotBackupPolicyPitrPolicyArgs']]]]:
        """
        The PITR policy for the DB System.
        """
    ...
    def pitr_policies(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotBackupPolicyPitrPolicyArgs']]]]):
    ...
    def window_start_time(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The start time of the maintenance window.
        """
    ...
    def window_start_time(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "window_start_time", value)


class MysqlBackupDbSystemSnapshotBackupPolicyCopyPolicyArgsDict(TypedDict):
    backup_copy_retention_in_days: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    Number of days to retain the copied DB system backup.
    """
    copy_to_region: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class MysqlBackupDbSystemSnapshotBackupPolicyCopyPolicyArgs:
    def __init__(__self__, *,
                 backup_copy_retention_in_days: pulumi.Input[Optional[_builtins.int]] = None,
                 copy_to_region: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def backup_copy_retention_in_days(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Number of days to retain the copied DB system backup.
        """
    ...
    def backup_copy_retention_in_days(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "backup_copy_retention_in_days", value)

    @_builtins.property
    @pulumi.getter(name="copyToRegion")
    def copy_to_region(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The destination region name to which the DB system backup will be copied.
        """
    ...
    def copy_to_region(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class MysqlBackupDbSystemSnapshotDataStorageArgsDict(TypedDict):
    allocated_storage_size_in_gbs: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    DEPRECATED: User specified size of the data volume. May be less than current allocatedStorageSizeInGBs. Replaced by dataStorage.dataStorageSizeInGBs.
    """
    data_storage_size_limit_in_gbs: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    is_auto_expand_storage_enabled: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    max_storage_size_in_gbs: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
...
class MysqlBackupDbSystemSnapshotDataStorageArgs:
    def __init__(__self__, *,
                 allocated_storage_size_in_gbs: pulumi.Input[Optional[_builtins.int]] = None,
                 data_storage_size_in_gb: pulumi.Input[Optional[_builtins.int]] = None,
                 data_storage_size_limit_in_gbs: pulumi.Input[Optional[_builtins.int]] = None,
                 is_auto_expand_storage_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 max_storage_size_in_gbs: pulumi.Input[Optional[_builtins.int]] = None):
        """
    ...
    def allocated_storage_size_in_gbs(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The actual allocated storage size for the DB System. This may be higher than dataStorageSizeInGBs if an automatic storage expansion has occurred.
        """
    ...
    def allocated_storage_size_in_gbs(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def data_storage_size_limit_in_gbs(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The absolute limit the DB System's storage size may ever expand to, either manually or automatically. This limit is based based on the initial dataStorageSizeInGBs when the DB System was first created. Both dataStorageSizeInGBs and maxDataStorageSizeInGBs can not exceed this value.
        """
    ...
    def data_storage_size_limit_in_gbs(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "data_storage_size_limit_in_gbs", value)

    @_builtins.property
    @pulumi.getter(name="isAutoExpandStorageEnabled")
    def is_auto_expand_storage_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Enable/disable automatic storage expansion. When set to true, the DB System will automatically add storage incrementally up to the value specified in maxStorageSizeInGBs.
        """
    ...
    def is_auto_expand_storage_enabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "is_auto_expand_storage_enabled", value)

    @_builtins.property
    @pulumi.getter(name="maxStorageSizeInGbs")
    def max_storage_size_in_gbs(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Maximum storage size this DB System can expand to. When isAutoExpandStorageEnabled is set to true, the DB System will add storage incrementally up to this value.
        """
    ...
    def max_storage_size_in_gbs(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class MysqlBackupDbSystemSnapshotDeletionPolicyArgsDict(TypedDict):
    automatic_backup_retention: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    Specifies if any automatic backups created for a DB System should be retained or deleted when the DB System is deleted.
    """
    final_backup: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    is_delete_protected: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class MysqlBackupDbSystemSnapshotDeletionPolicyArgs:
    def __init__(__self__, *,
                 automatic_backup_retention: pulumi.Input[Optional[_builtins.str]] = None,
                 final_backup: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def automatic_backup_retention(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Specifies if any automatic backups created for a DB System should be retained or deleted when the DB System is deleted.
        """
    ...
    def automatic_backup_retention(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "automatic_backup_retention", value)

    @_builtins.property
    @pulumi.getter(name="finalBackup")
    def final_backup(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Specifies whether or not a backup is taken when the DB System is deleted. REQUIRE_FINAL_BACKUP: a backup is taken if the DB System is deleted. SKIP_FINAL_BACKUP: a backup is not taken if the DB System is deleted.
        """
    ...
    @final_backup.setter
    def final_backup(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class MysqlBackupDbSystemSnapshotEncryptDataArgsDict(TypedDict):
    key_generation_type: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class MysqlBackupDbSystemSnapshotEncryptDataArgs:
    def __init__(__self__, *,
                 key_generation_type: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def key_generation_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Select whether to use Oracle-managed key (SYSTEM) or your own key (BYOK).
        """
    ...
    def key_generation_type(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class MysqlBackupDbSystemSnapshotMaintenanceArgsDict(TypedDict):
    ...
    """
    version_track_preference: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class MysqlBackupDbSystemSnapshotMaintenanceArgs:
    def __init__(__self__, *,
                 maintenance_disabled_windows: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotMaintenanceMaintenanceDisabledWindowArgs']]]] = None,
                 ...
                 version_track_preference: pulumi.Input[Optional[_builtins.str]] = None,
                 window_start_time: pulumi.Input[Optional[_builtins.str]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] version_preference: The preferred version to target when performing an automatic MySQL upgrade.
    ...
    def maintenance_disabled_windows(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotMaintenanceMaintenanceDisabledWindowArgs']]]]:
        """
        Time window during which downtime-inducing maintenance shall not be performed. Downtime-free maintenance may be performed to apply required security patches. At most one configured window is supported.
        """
    ...
    def maintenance_disabled_windows(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotMaintenanceMaintenanceDisabledWindowArgs']]]]):
    ...
    def version_track_preference(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The preferred version track to target when performing an automatic MySQL upgrade. LONG_TERM_SUPPORT: No MySQL database behavior changes. INNOVATION:        Provides access to the latest features and all bug fixes. FOLLOW:            Follows the track of the current MySQL version.
        """
    ...
    def version_track_preference(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class MysqlBackupDbSystemSnapshotReadEndpointArgsDict(TypedDict):
    exclude_ips: NotRequired[pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]]
    """
    ...
    Specifies if the DB System read endpoint is enabled or not.
    """
    read_endpoint_hostname_label: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    The hostname for the read endpoint of the DB System. Used for DNS.
    """
    read_endpoint_ip_address: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class MysqlBackupDbSystemSnapshotReadEndpointArgs:
    ...
    def exclude_ips(self) -> pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        A list of IP addresses of read replicas that are excluded from serving read requests.
        """
    ...
    @exclude_ips.setter
    def exclude_ips(self, value: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]]):
    ...
    def read_endpoint_hostname_label(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The hostname for the read endpoint of the DB System. Used for DNS.
        """
    ...
    def read_endpoint_hostname_label(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "read_endpoint_hostname_label", value)

    @_builtins.property
    @pulumi.getter(name="readEndpointIpAddress")
    def read_endpoint_ip_address(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The IP address the DB System read endpoint is configured to listen on. A private IP address of your choice to assign to the read endpoint of the DB System. Must be an available IP address within the subnet's CIDR. If you don't specify a value, Oracle automatically assigns a private IP address from the subnet. This should be a "dotted-quad" style IPv4 address.
        """
...
class MysqlBackupDbSystemSnapshotSecureConnectionArgsDict(TypedDict):
    certificate_generation_type: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class MysqlBackupDbSystemSnapshotTelemetryConfigurationArgs:
    def __init__(__self__, *,
                 logs: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotTelemetryConfigurationLogArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def logs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotTelemetryConfigurationLogArgs']]]]:
        """
        Telemetry configuration details for logging.
        """
    ...
    @logs.setter
    def logs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlBackupDbSystemSnapshotTelemetryConfigurationLogArgs']]]]):
...
class MysqlConfigurationInitVariablesArgsDict(TypedDict):
    lower_case_table_names: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class MysqlConfigurationVariablesArgsDict(TypedDict):
    auto_increment_increment: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    auto_increment_offset: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    autocommit: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ("autocommit")
    """
    big_tables: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    binlog_expire_logs_seconds: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    binlog_group_commit_sync_delay: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    binlog_group_commit_sync_no_delay_count: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    binlog_row_metadata: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    binlog_row_value_options: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    binlog_transaction_compression: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    block_encryption_mode: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    character_set_server: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    collation_server: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    completion_type: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ("completion_type")
    """
    ...
    """
    connection_memory_chunk_size: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    connection_memory_limit: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    cte_max_recursion_depth: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ("cte_max_recursion_depth")
    """
    default_authentication_plugin: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    explain_format: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    explicit_defaults_for_timestamp: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    foreign_key_checks: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ("foreign_key_checks")
    """
    generated_random_password_length: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ("generated_random_password_length") DEPRECATED -- variable should not be settable and will be ignored
    """
    global_connection_memory_limit: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    global_connection_memory_tracking: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    group_concat_max_len: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    group_replication_consistency: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    * BEFORE_AND_AFTER: A RW transaction waits for 1) all preceding transactions to complete before being applied and 2) until its changes have been applied on other members. A RO transaction waits for all preceding transactions to complete before execution takes place. This consistency level also includes the consistency guarantees provided by BEFORE_ON_PRIMARY_FAILOVER.
    """
    information_schema_stats_expiry: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ("information_schema_stats_expiry")
    """
    innodb_adaptive_hash_index: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    innodb_autoinc_lock_mode: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    innodb_buffer_pool_dump_pct: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    innodb_buffer_pool_instances: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ("innodb_buffer_pool_instances")
    """
    innodb_buffer_pool_size: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    innodb_change_buffering: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    innodb_ddl_buffer_size: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    innodb_ddl_threads: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    innodb_ft_result_cache_limit: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    innodb_lock_wait_timeout: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ("innodb_lock_wait_timeout")
    """
    innodb_log_writer_threads: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    innodb_max_purge_lag: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    innodb_max_purge_lag_delay: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    innodb_numa_interleave: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    innodb_online_alter_log_max_size: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    innodb_redo_log_capacity: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    innodb_rollback_on_timeout: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    innodb_sort_buffer_size: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    * The amount by which the temporary log file is extended when recording concurrent DML during an online DDL operation, and the size of the temporary log file read buffer and write buffer.
    ...
    """
    innodb_stats_persistent_sample_pages: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    innodb_stats_transient_sample_pages: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    innodb_strict_mode: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    innodb_undo_log_truncate: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    interactive_timeout: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    join_buffer_size: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    local_infile: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    long_query_time: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    mandatory_roles: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ("mandatory_roles")
    """
    max_allowed_packet: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    The maximum size of one packet or any generated/intermediate string.

    This is the mysql variable "max_allowed_packet".
    """
    max_binlog_cache_size: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    max_connect_errors: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ("max_connect_errors")
    """
    ...
    ("max_connections")
    """
    max_execution_time: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ("max_execution_time")
    """
    max_heap_table_size: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    max_prepared_stmt_count: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ("max_prepared_stmt_count")
    """
    max_seeks_for_key: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    max_user_connections: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    mysql_firewall_mode: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ("mysql_firewall_mode")
    """
    mysql_zstd_default_compression_level: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    DEPRECATED -- typo of mysqlx_zstd_default_compression_level. variable will be ignored.
    """
    mysqlx_connect_timeout: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    mysqlx_deflate_default_compression_level: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    Set the default compression level for the deflate algorithm. ("mysqlx_deflate_default_compression_level")
    """
    mysqlx_deflate_max_client_compression_level: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    Limit the upper bound of accepted compression levels for the deflate algorithm. ("mysqlx_deflate_max_client_compression_level")
    """
    mysqlx_document_id_unique_prefix: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ("mysqlx_document_id_unique_prefix") DEPRECATED -- variable should not be settable and will be ignored
    """
    mysqlx_enable_hello_notice: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ("mysqlx_enable_hello_notice") DEPRECATED -- variable should not be settable and will be ignored
    """
    mysqlx_idle_worker_thread_timeout: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ("mysqlx_idle_worker_thread_timeout") DEPRECATED -- variable should not be settable and will be ignored
    """
    mysqlx_interactive_timeout: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    mysqlx_lz4default_compression_level: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    Set the default compression level for the lz4 algorithm. ("mysqlx_lz4_default_compression_level")
    """
    mysqlx_lz4max_client_compression_level: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    Limit the upper bound of accepted compression levels for the lz4 algorithm. ("mysqlx_lz4_max_client_compression_level")
    """
    mysqlx_max_allowed_packet: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    The maximum size of network packets that can be received by X Plugin.

    This is the mysql variable "mysqlx_max_allowed_packet".
    """
    mysqlx_min_worker_threads: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ("mysqlx_min_worker_threads") DEPRECATED -- variable should not be settable and will be ignored
    """
    mysqlx_read_timeout: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    mysqlx_wait_timeout: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    mysqlx_write_timeout: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    mysqlx_zstd_default_compression_level: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    Set the default compression level for the zstd algorithm. ("mysqlx_zstd_default_compression_level")
    """
    mysqlx_zstd_max_client_compression_level: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    Limit the upper bound of accepted compression levels for the zstd algorithm. ("mysqlx_zstd_max_client_compression_level")
    """
    net_read_timeout: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    parser_max_mem_size: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ("parser_max_mem_size")
    """
    query_alloc_block_size: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ("query_alloc_block_size") DEPRECATED -- variable should not be settable and will be ignored
    """
    query_prealloc_size: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ("query_prealloc_size") DEPRECATED -- variable should not be settable and will be ignored
    """
    range_optimizer_max_mem_size: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    regexp_time_limit: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    relay_log_space_limit: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    replica_net_timeout: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    replica_parallel_workers: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    replica_type_conversions: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    require_secure_transport: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    skip_name_resolve: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    sort_buffer_size: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    sql_generate_invisible_primary_key: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    sql_mode: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ("sql_mode")
    """
    sql_require_primary_key: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ("sql_require_primary_key")
    """
    sql_warnings: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ("sql_warnings")
    """
    table_definition_cache: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    table_open_cache: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    temptable_max_ram: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    thread_pool_dedicated_listeners: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
    ...
    """
    thread_pool_max_transactions_limit: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    thread_pool_query_threads_per_group: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    thread_pool_size: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    """
    thread_pool_transaction_delay: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
    ...
    * As a named time zone, as defined by the "IANA Time Zone database", such as 'Europe/Helsinki', 'US/Eastern', 'MET', or 'UTC'.
    """
    tmp_table_size: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    transaction_isolation: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ("transaction_isolation")
    """
    wait_timeout: NotRequired[pulumi.Input[Optional[_builtins.int]]]
    """
...
class MysqlConfigurationVariablesArgs:
    def __init__(__self__, *,
                 auto_increment_increment: pulumi.Input[Optional[_builtins.int]] = None,
                 auto_increment_offset: pulumi.Input[Optional[_builtins.int]] = None,
                 autocommit: pulumi.Input[Optional[_builtins.bool]] = None,
                 big_tables: pulumi.Input[Optional[_builtins.bool]] = None,
                 binlog_expire_logs_seconds: pulumi.Input[Optional[_builtins.int]] = None,
                 binlog_group_commit_sync_delay: pulumi.Input[Optional[_builtins.int]] = None,
                 binlog_group_commit_sync_no_delay_count: pulumi.Input[Optional[_builtins.int]] = None,
                 binlog_row_metadata: pulumi.Input[Optional[_builtins.str]] = None,
                 binlog_row_value_options: pulumi.Input[Optional[_builtins.str]] = None,
                 binlog_transaction_compression: pulumi.Input[Optional[_builtins.bool]] = None,
                 block_encryption_mode: pulumi.Input[Optional[_builtins.str]] = None,
                 character_set_server: pulumi.Input[Optional[_builtins.str]] = None,
                 collation_server: pulumi.Input[Optional[_builtins.str]] = None,
                 completion_type: pulumi.Input[Optional[_builtins.str]] = None,
                 connect_timeout: pulumi.Input[Optional[_builtins.int]] = None,
                 connection_memory_chunk_size: pulumi.Input[Optional[_builtins.int]] = None,
                 connection_memory_limit: pulumi.Input[Optional[_builtins.str]] = None,
                 cte_max_recursion_depth: pulumi.Input[Optional[_builtins.str]] = None,
                 default_authentication_plugin: pulumi.Input[Optional[_builtins.str]] = None,
                 explain_format: pulumi.Input[Optional[_builtins.str]] = None,
                 explicit_defaults_for_timestamp: pulumi.Input[Optional[_builtins.bool]] = None,
                 foreign_key_checks: pulumi.Input[Optional[_builtins.bool]] = None,
                 generated_random_password_length: pulumi.Input[Optional[_builtins.int]] = None,
                 global_connection_memory_limit: pulumi.Input[Optional[_builtins.str]] = None,
                 global_connection_memory_tracking: pulumi.Input[Optional[_builtins.bool]] = None,
                 group_concat_max_len: pulumi.Input[Optional[_builtins.str]] = None,
                 group_replication_consistency: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 innodb_autoinc_lock_mode: pulumi.Input[Optional[_builtins.int]] = None,
                 innodb_buffer_pool_dump_pct: pulumi.Input[Optional[_builtins.int]] = None,
                 innodb_buffer_pool_instances: pulumi.Input[Optional[_builtins.int]] = None,
                 innodb_buffer_pool_size: pulumi.Input[Optional[_builtins.str]] = None,
                 innodb_change_buffering: pulumi.Input[Optional[_builtins.str]] = None,
                 innodb_ddl_buffer_size: pulumi.Input[Optional[_builtins.str]] = None,
                 innodb_ddl_threads: pulumi.Input[Optional[_builtins.int]] = None,
                 ...
                 innodb_ft_result_cache_limit: pulumi.Input[Optional[_builtins.str]] = None,
                 ...
                 innodb_log_writer_threads: pulumi.Input[Optional[_builtins.bool]] = None,
                 innodb_max_purge_lag: pulumi.Input[Optional[_builtins.str]] = None,
                 innodb_max_purge_lag_delay: pulumi.Input[Optional[_builtins.int]] = None,
                 innodb_numa_interleave: pulumi.Input[Optional[_builtins.bool]] = None,
                 innodb_online_alter_log_max_size: pulumi.Input[Optional[_builtins.str]] = None,
                 innodb_redo_log_capacity: pulumi.Input[Optional[_builtins.str]] = None,
                 innodb_rollback_on_timeout: pulumi.Input[Optional[_builtins.bool]] = None,
                 innodb_sort_buffer_size: pulumi.Input[Optional[_builtins.int]] = None,
                 innodb_stats_persistent_sample_pages: pulumi.Input[Optional[_builtins.str]] = None,
                 innodb_stats_transient_sample_pages: pulumi.Input[Optional[_builtins.str]] = None,
                 innodb_strict_mode: pulumi.Input[Optional[_builtins.bool]] = None,
                 innodb_undo_log_truncate: pulumi.Input[Optional[_builtins.bool]] = None,
                 interactive_timeout: pulumi.Input[Optional[_builtins.int]] = None,
                 join_buffer_size: pulumi.Input[Optional[_builtins.str]] = None,
                 local_infile: pulumi.Input[Optional[_builtins.bool]] = None,
                 long_query_time: pulumi.Input[Optional[_builtins.int]] = None,
                 mandatory_roles: pulumi.Input[Optional[_builtins.str]] = None,
                 max_allowed_packet: pulumi.Input[Optional[_builtins.int]] = None,
                 max_binlog_cache_size: pulumi.Input[Optional[_builtins.str]] = None,
                 max_connect_errors: pulumi.Input[Optional[_builtins.str]] = None,
                 max_connections: pulumi.Input[Optional[_builtins.int]] = None,
                 max_execution_time: pulumi.Input[Optional[_builtins.str]] = None,
                 max_heap_table_size: pulumi.Input[Optional[_builtins.str]] = None,
                 max_prepared_stmt_count: pulumi.Input[Optional[_builtins.int]] = None,
                 max_seeks_for_key: pulumi.Input[Optional[_builtins.str]] = None,
                 max_user_connections: pulumi.Input[Optional[_builtins.str]] = None,
                 mysql_firewall_mode: pulumi.Input[Optional[_builtins.bool]] = None,
                 mysql_zstd_default_compression_level: pulumi.Input[Optional[_builtins.int]] = None,
                 mysqlx_connect_timeout: pulumi.Input[Optional[_builtins.int]] = None,
                 mysqlx_deflate_default_compression_level: pulumi.Input[Optional[_builtins.int]] = None,
                 mysqlx_deflate_max_client_compression_level: pulumi.Input[Optional[_builtins.int]] = None,
                 mysqlx_document_id_unique_prefix: pulumi.Input[Optional[_builtins.int]] = None,
                 mysqlx_enable_hello_notice: pulumi.Input[Optional[_builtins.bool]] = None,
                 mysqlx_idle_worker_thread_timeout: pulumi.Input[Optional[_builtins.int]] = None,
                 mysqlx_interactive_timeout: pulumi.Input[Optional[_builtins.int]] = None,
                 mysqlx_lz4default_compression_level: pulumi.Input[Optional[_builtins.int]] = None,
                 mysqlx_lz4max_client_compression_level: pulumi.Input[Optional[_builtins.int]] = None,
                 mysqlx_max_allowed_packet: pulumi.Input[Optional[_builtins.int]] = None,
                 mysqlx_min_worker_threads: pulumi.Input[Optional[_builtins.int]] = None,
                 mysqlx_read_timeout: pulumi.Input[Optional[_builtins.int]] = None,
                 mysqlx_wait_timeout: pulumi.Input[Optional[_builtins.int]] = None,
                 mysqlx_write_timeout: pulumi.Input[Optional[_builtins.int]] = None,
                 mysqlx_zstd_default_compression_level: pulumi.Input[Optional[_builtins.int]] = None,
                 mysqlx_zstd_max_client_compression_level: pulumi.Input[Optional[_builtins.int]] = None,
                 ...
                 parser_max_mem_size: pulumi.Input[Optional[_builtins.str]] = None,
                 query_alloc_block_size: pulumi.Input[Optional[_builtins.str]] = None,
                 query_prealloc_size: pulumi.Input[Optional[_builtins.str]] = None,
                 range_optimizer_max_mem_size: pulumi.Input[Optional[_builtins.str]] = None,
                 regexp_time_limit: pulumi.Input[Optional[_builtins.int]] = None,
                 relay_log_space_limit: pulumi.Input[Optional[_builtins.str]] = None,
                 replica_net_timeout: pulumi.Input[Optional[_builtins.int]] = None,
                 replica_parallel_workers: pulumi.Input[Optional[_builtins.int]] = None,
                 replica_type_conversions: pulumi.Input[Optional[_builtins.str]] = None,
                 require_secure_transport: pulumi.Input[Optional[_builtins.bool]] = None,
                 skip_name_resolve: pulumi.Input[Optional[_builtins.bool]] = None,
                 sort_buffer_size: pulumi.Input[Optional[_builtins.str]] = None,
                 sql_generate_invisible_primary_key: pulumi.Input[Optional[_builtins.bool]] = None,
                 sql_mode: pulumi.Input[Optional[_builtins.str]] = None,
                 sql_require_primary_key: pulumi.Input[Optional[_builtins.bool]] = None,
                 sql_warnings: pulumi.Input[Optional[_builtins.bool]] = None,
                 table_definition_cache: pulumi.Input[Optional[_builtins.int]] = None,
                 table_open_cache: pulumi.Input[Optional[_builtins.int]] = None,
                 temptable_max_ram: pulumi.Input[Optional[_builtins.str]] = None,
                 thread_pool_dedicated_listeners: pulumi.Input[Optional[_builtins.bool]] = None,
                 thread_pool_max_transactions_limit: pulumi.Input[Optional[_builtins.int]] = None,
                 thread_pool_query_threads_per_group: pulumi.Input[Optional[_builtins.int]] = None,
                 thread_pool_size: pulumi.Input[Optional[_builtins.int]] = None,
                 thread_pool_transaction_delay: pulumi.Input[Optional[_builtins.int]] = None,
                 time_zone: pulumi.Input[Optional[_builtins.str]] = None,
                 tmp_table_size: pulumi.Input[Optional[_builtins.str]] = None,
                 transaction_isolation: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def auto_increment_increment(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        auto_increment_increment and auto_increment_offset are intended for use with circular (source-to-source) replication, and can be used to control the operation of AUTO_INCREMENT columns. Both variables have global and session values, and each can assume an integer value between 1 and 65,535 inclusive.
    ...
    def auto_increment_increment(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "auto_increment_increment", value)

    @_builtins.property
    @pulumi.getter(name="autoIncrementOffset")
    def auto_increment_offset(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        This variable has a default value of 1. If it is left with its default value, and Group Replication is started on the server in multi-primary mode, it is changed to the server ID.
    ...
    def auto_increment_offset(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "auto_increment_offset", value)

    @_builtins.property
    @pulumi.getter
    def autocommit(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        ("autocommit")
        """
    ...
    @autocommit.setter
    def autocommit(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "autocommit", value)

    @_builtins.property
    @pulumi.getter(name="bigTables")
    def big_tables(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        If enabled, the server stores all temporary tables on disk rather than in memory.
    ...
    @big_tables.setter
    def big_tables(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "big_tables", value)

    @_builtins.property
    @pulumi.getter(name="binlogExpireLogsSeconds")
    def binlog_expire_logs_seconds(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Sets the binary log expiration period in seconds. binlogExpireLogsSeconds corresponds to the MySQL binary logging system variable [binlog_expire_logs_seconds](https://dev.mysql.com/doc/refman/8.0/en/replication-options-binary-log.html#sysvar_binlog_expire_logs_seconds).
        """
    ...
    def binlog_expire_logs_seconds(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "binlog_expire_logs_seconds", value)

    @_builtins.property
    @pulumi.getter(name="binlogGroupCommitSyncDelay")
    def binlog_group_commit_sync_delay(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Controls how many microseconds the binary log commit waits before synchronizing the binary log file to disk. There is no delay by default. Setting this variable to a microsecond delay enables more transactions to be synchronized together to disk at once, reducing the overall time to commit a group of transactions because the larger groups required fewer time units per group.
    ...
    def binlog_group_commit_sync_delay(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "binlog_group_commit_sync_delay", value)

    @_builtins.property
    @pulumi.getter(name="binlogGroupCommitSyncNoDelayCount")
    def binlog_group_commit_sync_no_delay_count(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The maximum number of transactions to wait for before aborting the current delay as specified by binlog_group_commit_sync_delay. If binlog_group_commit_sync_delay is set to 0, then this option has no effect.
    ...
    def binlog_group_commit_sync_no_delay_count(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "binlog_group_commit_sync_no_delay_count", value)

    @_builtins.property
    @pulumi.getter(name="binlogRowMetadata")
    def binlog_row_metadata(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Configures the amount of table metadata added to the binary log when using row-based logging. binlogRowMetadata corresponds to the MySQL binary logging system variable [binlog_row_metadata](https://dev.mysql.com/doc/refman/8.0/en/replication-options-binary-log.html#sysvar_binlog_row_metadata).
        """
    ...
    def binlog_row_metadata(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "binlog_row_metadata", value)

    @_builtins.property
    @pulumi.getter(name="binlogRowValueOptions")
    def binlog_row_value_options(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        When set to PARTIAL_JSON, this enables use of a space-efficient binary log format for updates that modify only a small portion of a JSON document. binlogRowValueOptions corresponds to the MySQL binary logging system variable [binlog_row_value_options](https://dev.mysql.com/doc/refman/8.0/en/replication-options-binary-log.html#sysvar_binlog_row_value_options).
        """
    ...
    def binlog_row_value_options(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "binlog_row_value_options", value)

    @_builtins.property
    @pulumi.getter(name="binlogTransactionCompression")
    def binlog_transaction_compression(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Enables compression for transactions that are written to binary log files on this server. binlogTransactionCompression corresponds to the MySQL binary logging system variable [binlog_transaction_compression](https://dev.mysql.com/doc/refman/8.0/en/replication-options-binary-log.html#sysvar_binlog_transaction_compression).
        """
    ...
    def binlog_transaction_compression(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "binlog_transaction_compression", value)

    @_builtins.property
    @pulumi.getter(name="blockEncryptionMode")
    def block_encryption_mode(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        This variable controls the block encryption mode for block-based algorithms such as AES. It affects encryption for AES_ENCRYPT() and AES_DECRYPT(). block_encryption_mode takes a value in aes-keylen-mode format, where keylen is the key length in bits and mode is the encryption mode. The value is not case-sensitive. Permitted keylen values are 128, 192, and 256. Permitted mode values are ECB, CBC, CFB1, CFB8, CFB128, and OFB.
    ...
    def block_encryption_mode(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "block_encryption_mode", value)

    @_builtins.property
    @pulumi.getter(name="characterSetServer")
    def character_set_server(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The server's default character set. If you set this variable, you should also set collation_server to specify the collation for the character set.
    ...
    def character_set_server(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "character_set_server", value)

    @_builtins.property
    @pulumi.getter(name="collationServer")
    def collation_server(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The server's default collation.
    ...
    def collation_server(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "collation_server", value)

    @_builtins.property
    @pulumi.getter(name="completionType")
    def completion_type(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ("completion_type")
        """
    ...
    def completion_type(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def connection_memory_chunk_size(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Set the chunking size for updates to the global memory usage counter Global_connection_memory.
    ...
    def connection_memory_chunk_size(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "connection_memory_chunk_size", value)

    @_builtins.property
    @pulumi.getter(name="connectionMemoryLimit")
    def connection_memory_limit(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Set the maximum amount of memory that can be used by a single user connection.
    ...
    def connection_memory_limit(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "connection_memory_limit", value)

    @_builtins.property
    @pulumi.getter(name="cteMaxRecursionDepth")
    def cte_max_recursion_depth(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ("cte_max_recursion_depth")
        """
    ...
    def cte_max_recursion_depth(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "cte_max_recursion_depth", value)

    @_builtins.property
    @pulumi.getter(name="defaultAuthenticationPlugin")
    def default_authentication_plugin(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The default authentication plugin. This must be a plugin that uses internal credentials storage, so these values are permitted: mysql_native_password, sha256_password, caching_sha2_password.
    ...
    def default_authentication_plugin(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "default_authentication_plugin", value)

    @_builtins.property
    @pulumi.getter(name="explainFormat")
    def explain_format(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        This variable determines the default output format used by EXPLAIN in the absence of a FORMAT option when displaying a query execution plan.
    ...
    def explain_format(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "explain_format", value)

    @_builtins.property
    @pulumi.getter(name="explicitDefaultsForTimestamp")
    def explicit_defaults_for_timestamp(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        This system variable determines whether the server enables certain nonstandard behaviors for default values and NULL-value handling in TIMESTAMP columns. By default, explicit_defaults_for_timestamp is enabled, which disables the nonstandard behaviors. Disabling explicit_defaults_for_timestamp results in a warning.
    ...
    def explicit_defaults_for_timestamp(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "explicit_defaults_for_timestamp", value)

    @_builtins.property
    @pulumi.getter(name="foreignKeyChecks")
    def foreign_key_checks(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        ("foreign_key_checks")
        """
    ...
    def foreign_key_checks(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def generated_random_password_length(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        ("generated_random_password_length") DEPRECATED -- variable should not be settable and will be ignored
        """
    ...
    def generated_random_password_length(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "generated_random_password_length", value)

    @_builtins.property
    @pulumi.getter(name="globalConnectionMemoryLimit")
    def global_connection_memory_limit(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Set the total amount of memory that can be used by all user connections.
    ...
    def global_connection_memory_limit(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "global_connection_memory_limit", value)

    @_builtins.property
    @pulumi.getter(name="globalConnectionMemoryTracking")
    def global_connection_memory_tracking(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Determines whether the MySQL server calculates Global_connection_memory.
    ...
    def global_connection_memory_tracking(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "global_connection_memory_tracking", value)

    @_builtins.property
    @pulumi.getter(name="groupConcatMaxLen")
    def group_concat_max_len(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Specifies the maximum permitted result length in bytes for the GROUP_CONCAT() function.
    ...
    def group_concat_max_len(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "group_concat_max_len", value)

    @_builtins.property
    @pulumi.getter(name="groupReplicationConsistency")
    def group_replication_consistency(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        * EVENTUAL: Both RO and RW transactions do not wait for preceding transactions to be applied before executing. A RW transaction does not wait for other members to apply a transaction. This means that a transaction could be externalized on one member before the others. This also means that in the event of a primary failover, the new primary can accept new RO and RW transactions before the previous primary transactions are all applied. RO transactions could result in outdated values, RW transactions could result in a rollback due to conflicts.
        * BEFORE_ON_PRIMARY_FAILOVER: New RO or RW transactions with a newly elected primary that is applying backlog from the old primary are held (not applied) until any backlog has been applied. This ensures that when a primary failover happens, intentionally or not, clients always see the latest value on the primary. This guarantees consistency, but means that clients must be able to handle the delay in the event that a backlog is being applied. Usually this delay should be minimal, but does depend on the size of the backlog.
        * BEFORE: A RW transaction waits for all preceding transactions to complete before being applied. A RO transaction waits for all preceding transactions to complete before being executed. This ensures that this transaction reads the latest value by only affecting the latency of the transaction. This reduces the overhead of synchronization on every RW transaction, by ensuring synchronization is used only on RO transactions. This consistency level also includes the consistency guarantees provided by BEFORE_ON_PRIMARY_FAILOVER.
    ...
    def group_replication_consistency(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def innodb_adaptive_hash_index(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether the InnoDB adaptive hash index is enabled or disabled. It may be desirable, depending on your workload, to dynamically enable or disable adaptive hash indexing to improve query performance. Because the adaptive hash index may not be useful for all workloads, conduct benchmarks with it both enabled and disabled, using realistic workloads.
    ...
    def innodb_adaptive_hash_index(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "innodb_adaptive_hash_index", value)

    @_builtins.property
    @pulumi.getter(name="innodbAutoincLockMode")
    def innodb_autoinc_lock_mode(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The lock mode to use for generating auto-increment values. Permissible values are 0, 1, or 2, for traditional, consecutive, or interleaved, respectively.
    ...
    def innodb_autoinc_lock_mode(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "innodb_autoinc_lock_mode", value)

    @_builtins.property
    @pulumi.getter(name="innodbBufferPoolDumpPct")
    def innodb_buffer_pool_dump_pct(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Specifies the percentage of the most recently used pages for each buffer pool to read out and dump.
    ...
    def innodb_buffer_pool_dump_pct(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "innodb_buffer_pool_dump_pct", value)

    @_builtins.property
    @pulumi.getter(name="innodbBufferPoolInstances")
    def innodb_buffer_pool_instances(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        ("innodb_buffer_pool_instances")
        """
    ...
    def innodb_buffer_pool_instances(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "innodb_buffer_pool_instances", value)

    @_builtins.property
    @pulumi.getter(name="innodbBufferPoolSize")
    def innodb_buffer_pool_size(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The size (in bytes) of the buffer pool, that is, the memory area where InnoDB caches table and index data.
    ...
    def innodb_buffer_pool_size(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "innodb_buffer_pool_size", value)

    @_builtins.property
    @pulumi.getter(name="innodbChangeBuffering")
    def innodb_change_buffering(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Whether InnoDB performs change buffering, an optimization that delays write operations to secondary indexes so that the I/O operations can be performed sequentially. Permitted values are described in the following table. Values may also be specified numerically.
    ...
    def innodb_change_buffering(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "innodb_change_buffering", value)

    @_builtins.property
    @pulumi.getter(name="innodbDdlBufferSize")
    def innodb_ddl_buffer_size(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        innodbDdlBufferSize corresponds to the MySQL system variable [innodb_ddl_buffer_size] (https://dev.mysql.com/doc/refman/8.0/en/innodb-parameters.html#sysvar_innodb_ddl_buffer_size)
        """
    ...
    def innodb_ddl_buffer_size(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "innodb_ddl_buffer_size", value)

    @_builtins.property
    @pulumi.getter(name="innodbDdlThreads")
    def innodb_ddl_threads(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        innodbDdlThreads corresponds to the MySQL system variable [innodb_ddl_threads] (https://dev.mysql.com/doc/refman/8.0/en/innodb-parameters.html#sysvar_innodb_ddl_threads)
        """
    ...
    def innodb_ddl_threads(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def innodb_ft_result_cache_limit(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ("innodb_ft_result_cache_limit")
        """
    ...
    def innodb_ft_result_cache_limit(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def innodb_log_writer_threads(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Enables dedicated log writer threads for writing redo log records from the log buffer to the system buffers and flushing the system buffers to the redo log files.
    ...
    def innodb_log_writer_threads(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "innodb_log_writer_threads", value)

    @_builtins.property
    @pulumi.getter(name="innodbMaxPurgeLag")
    def innodb_max_purge_lag(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The desired maximum purge lag in terms of transactions.
    ...
    def innodb_max_purge_lag(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "innodb_max_purge_lag", value)

    @_builtins.property
    @pulumi.getter(name="innodbMaxPurgeLagDelay")
    def innodb_max_purge_lag_delay(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The maximum delay in microseconds for the delay imposed when the innodb_max_purge_lag threshold is exceeded.
    ...
    def innodb_max_purge_lag_delay(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "innodb_max_purge_lag_delay", value)

    @_builtins.property
    @pulumi.getter(name="innodbNumaInterleave")
    def innodb_numa_interleave(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Enables the NUMA interleave memory policy for allocation of the InnoDB buffer pool. When innodb_numa_interleave is enabled, the NUMA memory policy is set to MPOL_INTERLEAVE for the mysqld process. After the InnoDB buffer pool is allocated, the NUMA memory policy is set back to MPOL_DEFAULT. For the innodb_numa_interleave option to be available, MySQL must be compiled on a NUMA-enabled Linux system.
    ...
    def innodb_numa_interleave(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "innodb_numa_interleave", value)

    @_builtins.property
    @pulumi.getter(name="innodbOnlineAlterLogMaxSize")
    def innodb_online_alter_log_max_size(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Specifies an upper limit in bytes on the size of the temporary log files used during online DDL operations for InnoDB tables. There is one such log file for each index being created or table being altered. This log file stores data inserted, updated, or deleted in the table during the DDL operation.
    ...
    def innodb_online_alter_log_max_size(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "innodb_online_alter_log_max_size", value)

    @_builtins.property
    @pulumi.getter(name="innodbRedoLogCapacity")
    def innodb_redo_log_capacity(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Defines the amount of disk space occupied by redo log files. innodb_redo_log_capacity supercedes the innodb_log_files_in_group and innodb_log_file_size variables, which are both ignored if innodb_redo_log_capacity is defined. If innodb_redo_log_capacity is not defined, and if neither innodb_log_file_size or innodb_log_files_in_group are defined, then the default innodb_redo_log_capacity value is used.
    ...
    def innodb_redo_log_capacity(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def innodb_sort_buffer_size(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        This variable defines:
        * The sort buffer size for online DDL operations that create or rebuild secondary indexes. However, as of MySQL 8.0.27, this responsibility is subsumed by the innodb_ddl_buffer_size variable.
        * The amount by which the temporary log file is extended when recording concurrent DML during an online DDL operation, and the size of the temporary log file read buffer and write buffer.
    ...
    def innodb_sort_buffer_size(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "innodb_sort_buffer_size", value)

    @_builtins.property
    @pulumi.getter(name="innodbStatsPersistentSamplePages")
    def innodb_stats_persistent_sample_pages(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The number of index pages to sample when estimating cardinality and other statistics for an indexed column, such as those calculated by ANALYZE TABLE.
    ...
    def innodb_stats_persistent_sample_pages(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "innodb_stats_persistent_sample_pages", value)

    @_builtins.property
    @pulumi.getter(name="innodbStatsTransientSamplePages")
    def innodb_stats_transient_sample_pages(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The number of index pages to sample when estimating cardinality and other statistics for an indexed column, such as those calculated by [ANALYZE TABLE](https://dev.mysql.com/doc/refman/8.0/en/analyze-table.html).
    ...
    def innodb_stats_transient_sample_pages(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "innodb_stats_transient_sample_pages", value)

    @_builtins.property
    @pulumi.getter(name="innodbStrictMode")
    def innodb_strict_mode(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        When you enable innodbStrictMode, the InnoDB storage engine returns errors instead of warnings for invalid or incompatible table options.
    ...
    def innodb_strict_mode(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "innodb_strict_mode", value)

    @_builtins.property
    @pulumi.getter(name="innodbUndoLogTruncate")
    def innodb_undo_log_truncate(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        When enabled, undo tablespaces that exceed the threshold value defined by innodb_max_undo_log_size are marked for truncation. Only undo tablespaces can be truncated. Truncating undo logs that reside in the system tablespace is not supported. For truncation to occur, there must be at least two undo tablespaces.
    ...
    def innodb_undo_log_truncate(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def join_buffer_size(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The minimum size of the buffer that is used for plain index scans, range index scans, and joins that do not use indexes and thus perform full table scans. In MySQL 8.0.18 and later, this variable also controls the amount of memory used for hash joins. Normally, the best way to get fast joins is to add indexes. Increase the value of join_buffer_size to get a faster full join when adding indexes is not possible. One join buffer is allocated for each full join between two tables. For a complex join between several tables for which indexes are not used, multiple join buffers might be necessary.
    ...
    def join_buffer_size(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "join_buffer_size", value)

    @_builtins.property
    @pulumi.getter(name="localInfile")
    def local_infile(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        This variable controls server-side LOCAL capability for LOAD DATA statements. Depending on the local_infile setting, the server refuses or permits local data loading by clients that have LOCAL enabled on the client side. 
    ...
    @local_infile.setter
    def local_infile(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "local_infile", value)

    @_builtins.property
    @pulumi.getter(name="longQueryTime")
    def long_query_time(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        If a query takes longer than this many seconds, the server increments the Slow_queries status variable. If the slow query log is enabled, the query is logged to the slow query log file. This value is measured in real time, not CPU time, so a query that is under the threshold on a lightly loaded system might be above the threshold on a heavily loaded one.
    ...
    def long_query_time(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "long_query_time", value)

    @_builtins.property
    @pulumi.getter(name="mandatoryRoles")
    def mandatory_roles(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ("mandatory_roles")
        """
    ...
    def mandatory_roles(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def max_binlog_cache_size(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Sets the size of the transaction cache.
    ...
    def max_binlog_cache_size(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "max_binlog_cache_size", value)

    @_builtins.property
    @pulumi.getter(name="maxConnectErrors")
    def max_connect_errors(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ("max_connect_errors")
        """
    ...
    def max_connect_errors(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def max_execution_time(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ("max_execution_time")
        """
    ...
    def max_execution_time(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "max_execution_time", value)

    @_builtins.property
    @pulumi.getter(name="maxHeapTableSize")
    def max_heap_table_size(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        This variable sets the maximum size to which user-created MEMORY tables are permitted to grow.
    ...
    def max_heap_table_size(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "max_heap_table_size", value)

    @_builtins.property
    @pulumi.getter(name="maxPreparedStmtCount")
    def max_prepared_stmt_count(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        ("max_prepared_stmt_count")
        """
    ...
    def max_prepared_stmt_count(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "max_prepared_stmt_count", value)

    @_builtins.property
    @pulumi.getter(name="maxSeeksForKey")
    def max_seeks_for_key(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Limit the assumed maximum number of seeks when looking up rows based on a key. The MySQL optimizer assumes that no more than this number of key seeks are required when searching for matching rows in a table by scanning an index, regardless of the actual cardinality of the index (see Section 15.7.7.22, “SHOW INDEX Statement”). By setting this to a low value (say, 100), you can force MySQL to prefer indexes instead of table scans.
    ...
    def max_seeks_for_key(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "max_seeks_for_key", value)

    @_builtins.property
    @pulumi.getter(name="maxUserConnections")
    def max_user_connections(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The maximum number of simultaneous connections permitted to any given MySQL user account. A value of 0 (the default) means “no limit.” This variable has a global value that can be set at server startup or runtime. It also has a read-only session value that indicates the effective simultaneous-connection limit that applies to the account associated with the current session.
    ...
    def max_user_connections(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "max_user_connections", value)

    @_builtins.property
    @pulumi.getter(name="mysqlFirewallMode")
    def mysql_firewall_mode(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        ("mysql_firewall_mode")
        """
    ...
    def mysql_firewall_mode(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def mysql_zstd_default_compression_level(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        DEPRECATED -- typo of mysqlx_zstd_default_compression_level. variable will be ignored.
        """
    ...
    def mysql_zstd_default_compression_level(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "mysql_zstd_default_compression_level", value)

    @_builtins.property
    @pulumi.getter(name="mysqlxConnectTimeout")
    def mysqlx_connect_timeout(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The number of seconds X Plugin waits for the first packet to be received from newly connected clients.
    ...
    def mysqlx_connect_timeout(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "mysqlx_connect_timeout", value)

    @_builtins.property
    @pulumi.getter(name="mysqlxDeflateDefaultCompressionLevel")
    def mysqlx_deflate_default_compression_level(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Set the default compression level for the deflate algorithm. ("mysqlx_deflate_default_compression_level")
        """
    ...
    def mysqlx_deflate_default_compression_level(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "mysqlx_deflate_default_compression_level", value)

    @_builtins.property
    @pulumi.getter(name="mysqlxDeflateMaxClientCompressionLevel")
    def mysqlx_deflate_max_client_compression_level(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Limit the upper bound of accepted compression levels for the deflate algorithm. ("mysqlx_deflate_max_client_compression_level")
        """
    ...
    def mysqlx_deflate_max_client_compression_level(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def mysqlx_document_id_unique_prefix(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        ("mysqlx_document_id_unique_prefix") DEPRECATED -- variable should not be settable and will be ignored
        """
    ...
    def mysqlx_document_id_unique_prefix(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "mysqlx_document_id_unique_prefix", value)

    @_builtins.property
    @pulumi.getter(name="mysqlxEnableHelloNotice")
    def mysqlx_enable_hello_notice(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        ("mysqlx_enable_hello_notice") DEPRECATED -- variable should not be settable and will be ignored
        """
    ...
    def mysqlx_enable_hello_notice(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def mysqlx_idle_worker_thread_timeout(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        ("mysqlx_idle_worker_thread_timeout") DEPRECATED -- variable should not be settable and will be ignored
        """
    ...
    def mysqlx_idle_worker_thread_timeout(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "mysqlx_idle_worker_thread_timeout", value)

    @_builtins.property
    @pulumi.getter(name="mysqlxInteractiveTimeout")
    def mysqlx_interactive_timeout(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The number of seconds to wait for interactive clients to timeout.
    ...
    def mysqlx_interactive_timeout(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "mysqlx_interactive_timeout", value)

    @_builtins.property
    @pulumi.getter(name="mysqlxLz4defaultCompressionLevel")
    def mysqlx_lz4default_compression_level(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Set the default compression level for the lz4 algorithm. ("mysqlx_lz4_default_compression_level")
        """
    ...
    def mysqlx_lz4default_compression_level(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "mysqlx_lz4default_compression_level", value)

    @_builtins.property
    @pulumi.getter(name="mysqlxLz4maxClientCompressionLevel")
    def mysqlx_lz4max_client_compression_level(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Limit the upper bound of accepted compression levels for the lz4 algorithm. ("mysqlx_lz4_max_client_compression_level")
        """
    ...
    def mysqlx_lz4max_client_compression_level(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "mysqlx_lz4max_client_compression_level", value)

    @_builtins.property
    @pulumi.getter(name="mysqlxMaxAllowedPacket")
    def mysqlx_max_allowed_packet(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The maximum size of network packets that can be received by X Plugin.
    ...
    def mysqlx_max_allowed_packet(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def mysqlx_min_worker_threads(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        ("mysqlx_min_worker_threads") DEPRECATED -- variable should not be settable and will be ignored
        """
    ...
    def mysqlx_min_worker_threads(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "mysqlx_min_worker_threads", value)

    @_builtins.property
    @pulumi.getter(name="mysqlxReadTimeout")
    def mysqlx_read_timeout(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The number of seconds that X Plugin waits for blocking read operations to complete. After this time, if the read operation is not successful, X Plugin closes the connection and returns a warning notice with the error code ER_IO_READ_ERROR to the client application.
    ...
    def mysqlx_read_timeout(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "mysqlx_read_timeout", value)

    @_builtins.property
    @pulumi.getter(name="mysqlxWaitTimeout")
    def mysqlx_wait_timeout(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The number of seconds that X Plugin waits for activity on a connection.
    ...
    def mysqlx_wait_timeout(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "mysqlx_wait_timeout", value)

    @_builtins.property
    @pulumi.getter(name="mysqlxWriteTimeout")
    def mysqlx_write_timeout(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The number of seconds that X Plugin waits for blocking write operations to complete. After this time, if the write operation is not successful, X Plugin closes the connection.
    ...
    def mysqlx_write_timeout(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "mysqlx_write_timeout", value)

    @_builtins.property
    @pulumi.getter(name="mysqlxZstdDefaultCompressionLevel")
    def mysqlx_zstd_default_compression_level(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Set the default compression level for the zstd algorithm. ("mysqlx_zstd_default_compression_level")
        """
    ...
    def mysqlx_zstd_default_compression_level(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "mysqlx_zstd_default_compression_level", value)

    @_builtins.property
    @pulumi.getter(name="mysqlxZstdMaxClientCompressionLevel")
    def mysqlx_zstd_max_client_compression_level(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Limit the upper bound of accepted compression levels for the zstd algorithm. ("mysqlx_zstd_max_client_compression_level")
        """
    ...
    def mysqlx_zstd_max_client_compression_level(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def parser_max_mem_size(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ("parser_max_mem_size")
        """
    ...
    def parser_max_mem_size(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def query_alloc_block_size(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ("query_alloc_block_size") DEPRECATED -- variable should not be settable and will be ignored
        """
    ...
    def query_alloc_block_size(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def query_prealloc_size(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ("query_prealloc_size") DEPRECATED -- variable should not be settable and will be ignored
        """
    ...
    def query_prealloc_size(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "query_prealloc_size", value)

    @_builtins.property
    @pulumi.getter(name="rangeOptimizerMaxMemSize")
    def range_optimizer_max_mem_size(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The limit on memory consumption for the range optimizer. A value of 0 means “no limit.” If an execution plan considered by the optimizer uses the range access method but the optimizer estimates that the amount of memory needed for this method would exceed the limit, it abandons the plan and considers other plans. 
    ...
    def range_optimizer_max_mem_size(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "range_optimizer_max_mem_size", value)

    @_builtins.property
    @pulumi.getter(name="regexpTimeLimit")
    def regexp_time_limit(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        regexpTimeLimit corresponds to the MySQL system variable [regexp_time_limit] (https://dev.mysql.com/doc/refman/8.0/en/server-system-variables.html#sysvar_regexp_time_limit)
        """
    ...
    def regexp_time_limit(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "regexp_time_limit", value)

    @_builtins.property
    @pulumi.getter(name="relayLogSpaceLimit")
    def relay_log_space_limit(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The maximum amount of space to use for all relay logs.
    ...
    def relay_log_space_limit(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "relay_log_space_limit", value)

    @_builtins.property
    @pulumi.getter(name="replicaNetTimeout")
    def replica_net_timeout(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Specifies the number of seconds to wait for more data or a heartbeat signal from the source before the replica considers the connection broken, aborts the read, and tries to reconnect. Setting this variable has no immediate effect. The state of the variable applies on all subsequent START REPLICA commands.
    ...
    def replica_net_timeout(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "replica_net_timeout", value)

    @_builtins.property
    @pulumi.getter(name="replicaParallelWorkers")
    def replica_parallel_workers(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Beginning with MySQL 8.0.26, slave_parallel_workers is deprecated, and you should use replica_parallel_workers instead. (Prior to MySQL 8.0.26, you must use slave_parallel_workers to set the number of applier threads.)
    ...
    def replica_parallel_workers(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "replica_parallel_workers", value)

    @_builtins.property
    @pulumi.getter(name="replicaTypeConversions")
    def replica_type_conversions(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        From MySQL 8.0.26, use replica_type_conversions in place of slave_type_conversions, which is deprecated from that release. In releases before MySQL 8.0.26, use slave_type_conversions.
    ...
    def replica_type_conversions(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "replica_type_conversions", value)

    @_builtins.property
    @pulumi.getter(name="requireSecureTransport")
    def require_secure_transport(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether client connections to the server are required to use some form of secure transport. When this variable is enabled, the server permits only TCP/IP connections encrypted using TLS/SSL, or connections that use a socket file or shared memory. The server rejects nonsecure connection attempts, which fail with an ER_SECURE_TRANSPORT_REQUIRED error.
    ...
    def require_secure_transport(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "require_secure_transport", value)

    @_builtins.property
    @pulumi.getter(name="skipNameResolve")
    def skip_name_resolve(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether to resolve host names when checking client connections. If this variable is OFF, mysqld resolves host names when checking client connections. If it is ON, mysqld uses only IP numbers; in this case, all Host column values in the grant tables must be IP addresses. See Section 7.1.12.3, “DNS Lookups and the Host Cache”.
    ...
    def skip_name_resolve(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "skip_name_resolve", value)

    @_builtins.property
    @pulumi.getter(name="sortBufferSize")
    def sort_buffer_size(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Each session that must perform a sort allocates a buffer of this size.
    ...
    def sort_buffer_size(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "sort_buffer_size", value)

    @_builtins.property
    @pulumi.getter(name="sqlGenerateInvisiblePrimaryKey")
    def sql_generate_invisible_primary_key(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Whether GIPK mode is in effect, in which case a MySQL replication source server adds a generated invisible primary key to any InnoDB table that is created without one.
    ...
    def sql_generate_invisible_primary_key(self, value: pulumi.Input[Optional[_builtins.bool]]):
    ...
    def sql_warnings(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        ("sql_warnings")
        """
    ...
    @sql_warnings.setter
    def sql_warnings(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "sql_warnings", value)

    @_builtins.property
    @pulumi.getter(name="tableDefinitionCache")
    def table_definition_cache(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The number of table definitions that can be stored in the table definition cache. If you use a large number of tables, you can create a large table definition cache to speed up opening of tables. The table definition cache takes less space and does not use file descriptors, unlike the normal table cache.
    ...
    def table_definition_cache(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "table_definition_cache", value)

    @_builtins.property
    @pulumi.getter(name="tableOpenCache")
    def table_open_cache(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The number of open tables for all threads. Increasing this value increases the number of file descriptors that mysqld requires.
    ...
    def table_open_cache(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "table_open_cache", value)

    @_builtins.property
    @pulumi.getter(name="temptableMaxRam")
    def temptable_max_ram(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Defines the maximum amount of memory that can be occupied by the TempTable storage engine before it starts storing data on disk. The default value is 1073741824 bytes (1GiB). For more information, see Section 10.4.4, “Internal Temporary Table Use in MySQL”.
    ...
    def temptable_max_ram(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "temptable_max_ram", value)

    @_builtins.property
    @pulumi.getter(name="threadPoolDedicatedListeners")
    def thread_pool_dedicated_listeners(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Controls whether the thread pool uses dedicated listener threads. If enabled, a listener thread in each thread group is dedicated to the task of listening for network events from clients, ensuring that the maximum number of query worker threads is no more than the value specified by threadPoolMaxTransactionsLimit. threadPoolDedicatedListeners corresponds to the MySQL Database Service-specific system variable thread_pool_dedicated_listeners.
        """
    ...
    def thread_pool_dedicated_listeners(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "thread_pool_dedicated_listeners", value)

    @_builtins.property
    @pulumi.getter(name="threadPoolMaxTransactionsLimit")
    def thread_pool_max_transactions_limit(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        Limits the maximum number of open transactions to the defined value. The default value is 0, which enforces no limit. threadPoolMaxTransactionsLimit corresponds to the MySQL Database Service-specific system variable thread_pool_max_transactions_limit.
        """
    ...
    def thread_pool_max_transactions_limit(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "thread_pool_max_transactions_limit", value)

    @_builtins.property
    @pulumi.getter(name="threadPoolQueryThreadsPerGroup")
    def thread_pool_query_threads_per_group(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The maximum number of query threads permitted in a thread group. The maximum value is 4096, but if thread_pool_max_transactions_limit is set, thread_pool_query_threads_per_group must not exceed that value. The default value of 1 means there is one active query thread in each thread group, which works well for many loads. When you are using the high concurrency thread pool algorithm (thread_pool_algorithm = 1), consider increasing the value if you experience slower response times due to long-running transactions. 
    ...
    def thread_pool_query_threads_per_group(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "thread_pool_query_threads_per_group", value)

    @_builtins.property
    @pulumi.getter(name="threadPoolSize")
    def thread_pool_size(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The number of thread groups in the thread pool. This is the most important parameter controlling thread pool performance. It affects how many statements can execute simultaneously. If a value outside the range of permissible values is specified, the thread pool plugin does not load and the server writes a message to the error log.
    ...
    def thread_pool_size(self, value: pulumi.Input[Optional[_builtins.int]]):
        pulumi.set(self, "thread_pool_size", value)

    @_builtins.property
    @pulumi.getter(name="threadPoolTransactionDelay")
    def thread_pool_transaction_delay(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
        The delay period before executing a new transaction, in milliseconds. The maximum value is 300000 (5 minutes). A transaction delay can be used in cases where parallel transactions affect the performance of other operations due to resource contention. For example, if parallel transactions affect index creation or an online buffer pool resizing operation, you can configure a transaction delay to reduce resource contention while those operations are running. 
    ...
    def thread_pool_transaction_delay(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def tmp_table_size(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The maximum size of internal in-memory temporary tables. This variable does not apply to user-created MEMORY tables.
    ...
    def tmp_table_size(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "tmp_table_size", value)

    @_builtins.property
    @pulumi.getter(name="transactionIsolation")
    def transaction_isolation(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        ("transaction_isolation")
        """
    ...
    def transaction_isolation(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class MysqlDbSystemBackupPolicyArgs:
    def __init__(__self__, *,
                 copy_policies: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemBackupPolicyCopyPolicyArgs']]]] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 is_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 pitr_policy: pulumi.Input[Optional['MysqlDbSystemBackupPolicyPitrPolicyArgs']] = None,
                 retention_in_days: pulumi.Input[Optional[_builtins.int]] = None,
                 soft_delete: pulumi.Input[Optional[_builtins.str]] = None,
                 window_start_time: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="copyPolicies")
    def copy_policies(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemBackupPolicyCopyPolicyArgs']]]]:
        """
        (Updatable) List of policies of a DB system to schedule cross-region DB system backup copy.
    ...
    @copy_policies.setter
    def copy_policies(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemBackupPolicyCopyPolicyArgs']]]]):
        pulumi.set(self, "copy_policies", value)
    ...
    def pitr_policy(self) -> pulumi.Input[Optional['MysqlDbSystemBackupPolicyPitrPolicyArgs']]:
        """
        (Updatable) The PITR policy for the DB System.
        """
    ...
    @pitr_policy.setter
    def pitr_policy(self, value: pulumi.Input[Optional['MysqlDbSystemBackupPolicyPitrPolicyArgs']]):
...
class MysqlDbSystemChannelArgs:
    def __init__(__self__, *,
                 ...
                 sources: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemChannelSourceArgs']]]] = None,
                 state: pulumi.Input[Optional[_builtins.str]] = None,
                 system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 targets: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemChannelTargetArgs']]]] = None,
                 time_created: pulumi.Input[Optional[_builtins.str]] = None,
                 time_updated: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def sources(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemChannelSourceArgs']]]]:
        """
        Parameters detailing how to provision the initial data of the system.
        """
    ...
    @sources.setter
    def sources(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemChannelSourceArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def targets(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemChannelTargetArgs']]]]:
        """
        Details about the Channel target.
        """
    ...
    @targets.setter
    def targets(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemChannelTargetArgs']]]]):
...
class MysqlDbSystemChannelSourceArgs:
    ...
    def anonymous_transactions_handlings(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemChannelSourceAnonymousTransactionsHandlingArgs']]]]:
        """
        Specifies how the replication channel handles replicated transactions without an identifier, enabling replication from a source that does not use transaction-id-based replication to a replica that does.
        """
    ...
    def anonymous_transactions_handlings(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemChannelSourceAnonymousTransactionsHandlingArgs']]]]):
    ...
    def ssl_ca_certificates(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemChannelSourceSslCaCertificateArgs']]]]:
        """
        The CA certificate of the server used for VERIFY_IDENTITY and VERIFY_CA ssl modes.
        """
    ...
    def ssl_ca_certificates(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemChannelSourceSslCaCertificateArgs']]]]):
...
class MysqlDbSystemChannelSourceSslCaCertificateArgsDict(TypedDict):
    ...
    """
    contents: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class MysqlDbSystemChannelTargetArgs:
    def __init__(__self__, *,
                 ...
                 delay_in_seconds: pulumi.Input[Optional[_builtins.int]] = None,
                 filters: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemChannelTargetFilterArgs']]]] = None,
                 tables_without_primary_key_handling: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemChannelTargetFilterArgs']]]]:
        """
        Replication filter rules to be applied at the DB System Channel target.
        """
        return pulumi.get(self, "filters")
    ...
    @filters.setter
    def filters(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemChannelTargetFilterArgs']]]]):
        pulumi.set(self, "filters", value)
...
class MysqlDbSystemHeatWaveClusterArgsDict(TypedDict):
    ...
    """
    is_lakehouse_enabled: NotRequired[pulumi.Input[Optional[_builtins.bool]]]
    """
...
class MysqlDbSystemHeatWaveClusterArgs:
    def __init__(__self__, *,
                 ...
                 is_lakehouse_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 shape_name: pulumi.Input[Optional[_builtins.str]] = None,
                 state: pulumi.Input[Optional[_builtins.str]] = None,
                 time_created: pulumi.Input[Optional[_builtins.str]] = None,
                 time_updated: pulumi.Input[Optional[_builtins.str]] = None):
    ...
    def is_lakehouse_enabled(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        Lakehouse enabled status for the HeatWave cluster.
        """
    ...
    def is_lakehouse_enabled(self, value: pulumi.Input[Optional[_builtins.bool]]):
...
class MysqlDbSystemMaintenanceArgs:
    def __init__(__self__, *,
                 window_start_time: pulumi.Input[_builtins.str],
                 maintenance_disabled_windows: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemMaintenanceMaintenanceDisabledWindowArgs']]]] = None,
                 maintenance_schedule_type: pulumi.Input[Optional[_builtins.str]] = None,
                 target_version: pulumi.Input[Optional[_builtins.str]] = None,
                 time_scheduled: pulumi.Input[Optional[_builtins.str]] = None,
                 version_preference: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] target_version: The version that is expected to be targeted during the next scheduled maintenance run.
        :param pulumi.Input[_builtins.str] time_scheduled: The time the scheduled maintenance is expected to start, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        :param pulumi.Input[_builtins.str] version_preference: (Updatable) The preferred version to target when performing an automatic MySQL upgrade. Defaults to OLDEST.
    ...
    @_builtins.property
    @pulumi.getter(name="maintenanceDisabledWindows")
    def maintenance_disabled_windows(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemMaintenanceMaintenanceDisabledWindowArgs']]]]:
        """
        (Updatable) Time window during which downtime-inducing maintenance shall not be performed. Downtime-free maintenance may be performed to apply required security patches. At most one configured window is supported.
        """
        return pulumi.get(self, "maintenance_disabled_windows")
    ...
    @maintenance_disabled_windows.setter
    def maintenance_disabled_windows(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemMaintenanceMaintenanceDisabledWindowArgs']]]]):
        pulumi.set(self, "maintenance_disabled_windows", value)
...
class MysqlDbSystemPointInTimeRecoveryDetailArgsDict(TypedDict):
    time_earliest_recovery_point: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    Earliest recovery time point for the DB System, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
    """
    time_latest_recovery_point: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class MysqlDbSystemPointInTimeRecoveryDetailArgs:
    def __init__(__self__, *,
                 time_earliest_recovery_point: pulumi.Input[Optional[_builtins.str]] = None,
                 time_latest_recovery_point: pulumi.Input[Optional[_builtins.str]] = None):
        """
    ...
    def time_earliest_recovery_point(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Earliest recovery time point for the DB System, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        """
    ...
    def time_earliest_recovery_point(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "time_earliest_recovery_point", value)

    @_builtins.property
    @pulumi.getter(name="timeLatestRecoveryPoint")
    def time_latest_recovery_point(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        Latest recovery time point for the DB System, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        """
    ...
    def time_latest_recovery_point(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class MysqlDbSystemSourceArgsDict(TypedDict):
    ...
    The OCID of the DB System from which a backup shall be selected to be restored when creating the new DB System. Use this together with recovery point to perform a point in time recovery operation.
    """
    recovery_point: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
class MysqlDbSystemSourceArgs:
    def __init__(__self__, *,
                 ...
                 channel: pulumi.Input[Optional['MysqlDbSystemSourceChannelArgs']] = None,
                 db_system_id: pulumi.Input[Optional[_builtins.str]] = None,
                 recovery_point: pulumi.Input[Optional[_builtins.str]] = None,
                 region: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input['MysqlDbSystemSourceChannelArgs'] channel: Properties to setup a replication channel with the source (cloned) DB system.
        :param pulumi.Input[_builtins.str] db_system_id: The OCID of the DB System from which a backup shall be selected to be restored when creating the new DB System. Use this together with recovery point to perform a point in time recovery operation.
        ...
        :param pulumi.Input[_builtins.str] region: The region identifier of the source region where the DB system exists, only if it is in a different region. If the source DB system is in the same region, then no region must be specified. For more information, please see [Regions and Availability Domains](https://docs.oracle.com/en-us/iaas/Content/General/Concepts/regions.htm).
    ...
    @_builtins.property
    @pulumi.getter
    def channel(self) -> pulumi.Input[Optional['MysqlDbSystemSourceChannelArgs']]:
        """
        Properties to setup a replication channel with the source (cloned) DB system.
        """
    ...
    @channel.setter
    def channel(self, value: pulumi.Input[Optional['MysqlDbSystemSourceChannelArgs']]):
    ...
    def recovery_point(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The date and time, as per RFC 3339, of the change up to which the new DB System shall be restored to, using a backup and logs from the original DB System. In case no point in time is specified, then this new DB System shall be restored up to the latest change recorded for the original DB System.
        """
    ...
    def recovery_point(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class MysqlDbSystemSourceChannelArgsDict(TypedDict):
    applier_username: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    The username for the replication applier of the created MySQL DB System.
    """
    source_password: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
    ...
    """
    source_username: NotRequired[pulumi.Input[Optional[_builtins.str]]]
    """
...
@pulumi.input_type
class MysqlDbSystemSourceChannelArgs:
    def __init__(__self__, *,
                 applier_username: pulumi.Input[Optional[_builtins.str]] = None,
                 source_password: pulumi.Input[Optional[_builtins.str]] = None,
                 source_username: pulumi.Input[Optional[_builtins.str]] = None,
                 ssl_ca_certificate: pulumi.Input[Optional['MysqlDbSystemSourceChannelSslCaCertificateArgs']] = None,
                 ssl_mode: pulumi.Input[Optional[_builtins.str]] = None):
        """
        :param pulumi.Input[_builtins.str] applier_username: The username for the replication applier of the created MySQL DB System.
        :param pulumi.Input[_builtins.str] source_password: The password for the replication user. The password must be between 8 and 32 characters long, and must contain at least 1 numeric character, 1 lowercase character, 1 uppercase character, and 1 special (nonalphanumeric) character.
        :param pulumi.Input[_builtins.str] source_username: The name of the replication user on the source DB system. The username has a maximum length of 96 characters. For more information, please see the [MySQL documentation](https://dev.mysql.com/doc/en/change-replication-source-to.html)
        :param pulumi.Input['MysqlDbSystemSourceChannelSslCaCertificateArgs'] ssl_ca_certificate: The CA certificate of the server used for VERIFY_IDENTITY and VERIFY_CA ssl modes.
        :param pulumi.Input[_builtins.str] ssl_mode: The SSL mode of the Channel.
        """
        if applier_username is not None:
            pulumi.set(__self__, "applier_username", applier_username)
    ...
    def source_password(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The password for the replication user. The password must be between 8 and 32 characters long, and must contain at least 1 numeric character, 1 lowercase character, 1 uppercase character, and 1 special (nonalphanumeric) character.
        """
    ...
    def source_password(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "source_password", value)

    @_builtins.property
    @pulumi.getter(name="sourceUsername")
    def source_username(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
        The name of the replication user on the source DB system. The username has a maximum length of 96 characters. For more information, please see the [MySQL documentation](https://dev.mysql.com/doc/en/change-replication-source-to.html)
        """
    ...
    def source_username(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "source_username", value)

    @_builtins.property
    @pulumi.getter(name="sslCaCertificate")
    def ssl_ca_certificate(self) -> pulumi.Input[Optional['MysqlDbSystemSourceChannelSslCaCertificateArgs']]:
        """
        The CA certificate of the server used for VERIFY_IDENTITY and VERIFY_CA ssl modes.
        """
        return pulumi.get(self, "ssl_ca_certificate")
    ...
    @ssl_ca_certificate.setter
    def ssl_ca_certificate(self, value: pulumi.Input[Optional['MysqlDbSystemSourceChannelSslCaCertificateArgs']]):
        pulumi.set(self, "ssl_ca_certificate", value)
...
class MysqlDbSystemSourceChannelSslCaCertificateArgsDict(TypedDict):
    certificate_type: pulumi.Input[_builtins.str]
    """
    The type of CA certificate.
    """
...
@pulumi.input_type
class MysqlDbSystemSourceChannelSslCaCertificateArgs:
    def __init__(__self__, *,
                 certificate_type: pulumi.Input[_builtins.str],
                 contents: pulumi.Input[_builtins.str]):
        """
...
class MysqlDbSystemTelemetryConfigurationArgs:
    def __init__(__self__, *,
                 logs: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemTelemetryConfigurationLogArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def logs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemTelemetryConfigurationLogArgs']]]]:
        """
        (Updatable) Telemetry configuration details for logging.
        """
        return pulumi.get(self, "logs")
    ...
    @logs.setter
    def logs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['MysqlDbSystemTelemetryConfigurationLogArgs']]]]):
        pulumi.set(self, "logs", value)
...
class ReplicaReplicaOverridesArgs:
    def __init__(__self__, *,
                 ...
                 security_attributes: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 shape_name: pulumi.Input[Optional[_builtins.str]] = None,
                 telemetry_configuration: pulumi.Input[Optional['ReplicaReplicaOverridesTelemetryConfigurationArgs']] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter(name="telemetryConfiguration")
    def telemetry_configuration(self) -> pulumi.Input[Optional['ReplicaReplicaOverridesTelemetryConfigurationArgs']]:
        """
        (Updatable) Telemetry configuration details of a DB System or a read replica.
        """
        return pulumi.get(self, "telemetry_configuration")
    ...
    @telemetry_configuration.setter
    def telemetry_configuration(self, value: pulumi.Input[Optional['ReplicaReplicaOverridesTelemetryConfigurationArgs']]):
        pulumi.set(self, "telemetry_configuration", value)
...
class ReplicaReplicaOverridesTelemetryConfigurationArgs:
    def __init__(__self__, *,
                 logs: pulumi.Input[Optional[Sequence[pulumi.Input['ReplicaReplicaOverridesTelemetryConfigurationLogArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def logs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ReplicaReplicaOverridesTelemetryConfigurationLogArgs']]]]:
        """
        (Updatable) Telemetry configuration details for logging.
        """
        return pulumi.get(self, "logs")
    ...
    @logs.setter
    def logs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ReplicaReplicaOverridesTelemetryConfigurationLogArgs']]]]):
        pulumi.set(self, "logs", value)
...
class ReplicaTelemetryConfigurationArgs:
    def __init__(__self__, *,
                 logs: pulumi.Input[Optional[Sequence[pulumi.Input['ReplicaTelemetryConfigurationLogArgs']]]] = None):
        """
    ...
    @_builtins.property
    @pulumi.getter
    def logs(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ReplicaTelemetryConfigurationLogArgs']]]]:
        """
        Telemetry configuration details for logging.
        """
        return pulumi.get(self, "logs")
    ...
    @logs.setter
    def logs(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ReplicaTelemetryConfigurationLogArgs']]]]):
        pulumi.set(self, "logs", value)
...
class ReplicaTelemetryConfigurationLogArgs:
    def __init__(__self__, *,
                 ...
                 destination_configurations: pulumi.Input[Optional[Sequence[pulumi.Input['ReplicaTelemetryConfigurationLogDestinationConfigurationArgs']]]] = None,
    ...
    @_builtins.property
    @pulumi.getter(name="destinationConfigurations")
    def destination_configurations(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ReplicaTelemetryConfigurationLogDestinationConfigurationArgs']]]]:
        """
        List of configuration variables for a given destination type.
        """
        return pulumi.get(self, "destination_configurations")
    ...
    @destination_configurations.setter
    def destination_configurations(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ReplicaTelemetryConfigurationLogDestinationConfigurationArgs']]]]):
        pulumi.set(self, "destination_configurations", value)
