...
class ChannelArgs:
    def __init__(__self__, *,
                 source: pulumi.Input['ChannelSourceArgs'],
                 target: pulumi.Input['ChannelTargetArgs'],
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) User provided information about the Channel.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The user-friendly name for the Channel. It does not have to be unique.
        ...
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) Whether the Channel should be enabled upon creation. If set to true, the Channel will be asynchronously started as a result of the create Channel operation.
        """
    ...
    @source.setter
    def source(self, value: pulumi.Input['ChannelSourceArgs']):
    ...
    @target.setter
    def target(self, value: pulumi.Input['ChannelTargetArgs']):
...
class _ChannelState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) Whether the Channel should be enabled upon creation. If set to true, the Channel will be asynchronously started as a result of the create Channel operation.
        :param pulumi.Input[builtins.str] lifecycle_details: A message describing the state of the Channel.
        :param pulumi.Input['ChannelSourceArgs'] source: (Updatable) Parameters detailing how to provision the source for the given Channel.
        :param pulumi.Input[builtins.str] state: The state of the Channel.
        ...
        :param pulumi.Input['ChannelTargetArgs'] target: (Updatable) Parameters detailing how to provision the target for the given Channel.
        :param pulumi.Input[builtins.str] time_created: The date and time the Channel was created, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        :param pulumi.Input[builtins.str] time_updated: The time the Channel was last updated, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        """
        if compartment_id is not None:
            pulumi.set(__self__, "compartment_id", compartment_id)
        if defined_tags is not None:
    ...
    @source.setter
    def source(self, value: Optional[pulumi.Input['ChannelSourceArgs']]):
        pulumi.set(self, "source", value)
    ...
    @target.setter
    def target(self, value: Optional[pulumi.Input['ChannelTargetArgs']]):
        pulumi.set(self, "target", value)
...
class Channel(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            target: Optional[pulumi.Input[Union['ChannelTargetArgs', 'ChannelTargetArgsDict']]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'Channel':
        """
