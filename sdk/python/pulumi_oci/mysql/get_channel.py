...
def get_channel(channel_id: Optional[builtins.str] = None,
    ...
    :param builtins.str channel_id: The Channel [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    """
    __args__ = dict()
...
def get_channel_output(channel_id: Optional[pulumi.Input[builtins.str]] = None,
