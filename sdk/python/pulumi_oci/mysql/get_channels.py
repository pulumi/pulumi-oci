...
def get_channels(channel_id: Optional[builtins.str] = None,
    ...
    :param builtins.str channel_id: The OCID of the Channel.
...
def get_channels_output(channel_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Mysql/getChannels:getChannels', __args__, opts=opts, typ=GetChannelsResult)
