...
def get_heat_wave_cluster(db_system_id: Optional[builtins.str] = None,
...
def get_heat_wave_cluster_output(db_system_id: Optional[pulumi.Input[builtins.str]] = None,
