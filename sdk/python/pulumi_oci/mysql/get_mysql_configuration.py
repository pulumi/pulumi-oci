...
def get_mysql_configuration(configuration_id: Optional[builtins.str] = None,
    ...
    :param builtins.str configuration_id: The OCID of the Configuration.
    """
    __args__ = dict()
...
def get_mysql_configuration_output(configuration_id: Optional[pulumi.Input[builtins.str]] = None,
