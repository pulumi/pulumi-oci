...
def get_replica(replica_id: Optional[builtins.str] = None,
    ...
    :param builtins.str replica_id: The Replica [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    """
    __args__ = dict()
...
def get_replica_output(replica_id: Optional[pulumi.Input[builtins.str]] = None,
