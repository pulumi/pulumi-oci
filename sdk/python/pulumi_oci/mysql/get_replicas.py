...
def get_replicas(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str replica_id: The read replica [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
...
def get_replicas_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                        ...
                        replica_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
