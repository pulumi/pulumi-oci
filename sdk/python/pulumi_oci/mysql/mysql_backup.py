...
class MysqlBackupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] backup_type: The type of backup.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment the backup exists in.
        :param pulumi.Input[builtins.str] db_system_id: The OCID of the DB System the Backup is associated with.
...
class _MysqlBackupState:
    def __init__(__self__, *,
                 backup_size_in_gbs: Optional[pulumi.Input[builtins.int]] = None,
                 backup_type: Optional[pulumi.Input[builtins.str]] = None,
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 original_source_backup_id: Optional[pulumi.Input[builtins.str]] = None,
                 retention_in_days: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 time_copy_created: Optional[pulumi.Input[builtins.str]] = None,
                 time_created: Optional[pulumi.Input[builtins.str]] = None,
                 time_updated: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering MysqlBackup resources.
        :param pulumi.Input[builtins.int] backup_size_in_gbs: The size of the backup in base-2 (IEC) gibibytes. (GiB).
        :param pulumi.Input[builtins.str] backup_type: The type of backup.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment the backup exists in.
        :param pulumi.Input[builtins.str] creation_type: Indicates how the backup was created: manually, automatic, or by an Operator.
        ...
        :param pulumi.Input[builtins.str] original_source_backup_id: The OCID of the original source DB system backup from which this DB system backup was copied.
        :param pulumi.Input[builtins.int] retention_in_days: (Updatable) Number of days to retain this backup.
        :param pulumi.Input[builtins.str] shape_name: The shape of the DB System instance used for backup.
        :param pulumi.Input[builtins.str] soft_delete: (Updatable) Retains the backup to be deleted due to the retention policy in DELETE SCHEDULED state for 7 days before permanently deleting it.
        :param pulumi.Input['MysqlBackupSourceDetailsArgs'] source_details: Details of backup source in the cloud.
        :param pulumi.Input[builtins.str] state: The state of the backup.
        ...
        :param pulumi.Input[builtins.str] time_copy_created: The date and time the DB system backup copy was created, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        :param pulumi.Input[builtins.str] time_created: The time the backup record was created.
        :param pulumi.Input[builtins.str] time_updated: The time at which the backup was updated.
        """
    ...
    def backup_size_in_gbs(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def backup_size_in_gbs(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def immediate_source_backup_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def immediate_source_backup_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def original_source_backup_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def original_source_backup_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_copy_created(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_copy_created(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MysqlBackup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_copy_created: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'MysqlBackup':
        """
    ...
    @property
    @pulumi.getter(name="backupSizeInGbs")
    def backup_size_in_gbs(self) -> pulumi.Output[builtins.int]:
        """
        The size of the backup in base-2 (IEC) gibibytes. (GiB).
        """
        return pulumi.get(self, "backup_size_in_gbs")
    ...
    @property
    @pulumi.getter(name="immediateSourceBackupId")
    def immediate_source_backup_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the immediate source DB system backup from which this DB system backup was copied.
        """
        return pulumi.get(self, "immediate_source_backup_id")
    ...
    @property
    @pulumi.getter(name="originalSourceBackupId")
    def original_source_backup_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the original source DB system backup from which this DB system backup was copied.
        """
        return pulumi.get(self, "original_source_backup_id")
    ...
    @property
    @pulumi.getter(name="softDelete")
    def soft_delete(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Retains the backup to be deleted due to the retention policy in DELETE SCHEDULED state for 7 days before permanently deleting it.
        """
        return pulumi.get(self, "soft_delete")
    ...
    @property
    @pulumi.getter(name="timeCopyCreated")
    def time_copy_created(self) -> pulumi.Output[builtins.str]:
        """
        The date and time the DB system backup copy was created, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        """
        return pulumi.get(self, "time_copy_created")
