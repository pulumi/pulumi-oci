...
class MysqlConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 parent_configuration_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] shape_name: The name of the associated Shape.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) User-provided data about the Configuration.
        ...
        :param pulumi.Input[builtins.str] parent_configuration_id: The OCID of the Configuration from which the new Configuration is derived. The values in CreateConfigurationDetails.variables supersede the variables of the parent Configuration.
    ...
    def parent_configuration_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def parent_configuration_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _MysqlConfigurationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the Configuration was created, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        :param pulumi.Input[builtins.str] time_updated: The date and time the Configuration was last updated, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        :param pulumi.Input[builtins.str] type: The Configuration type, DEFAULT or CUSTOM.
        :param pulumi.Input['MysqlConfigurationVariablesArgs'] variables: User-defined service variables.
        """
...
class MysqlConfiguration(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="parentConfigurationId")
    def parent_configuration_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the Configuration from which the new Configuration is derived. The values in CreateConfigurationDetails.variables supersede the variables of the parent Configuration.
        """
        return pulumi.get(self, "parent_configuration_id")
