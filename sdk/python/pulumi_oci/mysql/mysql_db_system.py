...
class MysqlDbSystemArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] access_mode: (Updatable) The access mode indicating if the database access will be restricted only to administrators or not:
        ...
        :param pulumi.Input[builtins.str] admin_password: The password for the administrative user. The password must be between 8 and 32 characters long, and must contain at least 1 numeric character, 1 lowercase character, 1 uppercase character, and 1 special (nonalphanumeric) character.
        ...
        :param pulumi.Input[builtins.str] configuration_id: (Updatable) The OCID of the Configuration to be used for this DB System.
        :param pulumi.Input[builtins.str] crash_recovery: (Updatable) Whether to run the DB System with InnoDB Redo Logs and the Double Write Buffer enabled or disabled, and whether to enable or disable syncing of the Binary Logs.
        ...
        :param pulumi.Input[builtins.str] hostname_label: (Updatable) The hostname for the primary endpoint of the DB System. Used for DNS.
        ...
        :param pulumi.Input[builtins.bool] is_highly_available: (Updatable) Specifies if the DB System is highly available.
    ...
    def shutdown_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def shutdown_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _MysqlDbSystemState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] hostname_label: (Updatable) The hostname for the primary endpoint of the DB System. Used for DNS.
               ...
               Must be unique across all VNICs in the subnet and comply with RFC 952 and RFC 1123.
        :param pulumi.Input[builtins.str] ip_address: The IP address the DB System is configured to listen on. A private IP address of your choice to assign to the primary endpoint of the DB System. Must be an available IP address within the subnet's CIDR. If you don't specify a value, Oracle automatically assigns a private IP address from the subnet. This should be a "dotted-quad" style IPv4 address.
        :param pulumi.Input[builtins.bool] is_heat_wave_cluster_attached: If the DB System has a HeatWave Cluster attached.
        :param pulumi.Input[builtins.bool] is_highly_available: (Updatable) Specifies if the DB System is highly available.
...
class MysqlDbSystem(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'MysqlDbSystem':
        """
    ...
    @property
    @pulumi.getter(name="crashRecovery")
    def crash_recovery(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Whether to run the DB System with InnoDB Redo Logs and the Double Write Buffer enabled or disabled, and whether to enable or disable syncing of the Binary Logs.
        """
        return pulumi.get(self, "crash_recovery")
    ...
    @property
    @pulumi.getter(name="databaseManagement")
    def database_management(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Whether to enable monitoring via the Database Management service.
        """
        return pulumi.get(self, "database_management")
    ...
    @property
    @pulumi.getter(name="databaseMode")
    def database_mode(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The database mode indicating the types of statements that will be allowed to run in the DB system. This mode will apply only to statements run by user connections. Replicated write statements will continue  to be allowed regardless of the DatabaseMode.
        * READ_WRITE (default): allow running read and write statements on the DB system;
        * READ_ONLY: only allow running read statements on the DB system.
    ...
    @property
    @pulumi.getter(name="mysqlVersion")
    def mysql_version(self) -> pulumi.Output[builtins.str]:
        """
        The specific MySQL version identifier.
        """
        return pulumi.get(self, "mysql_version")
    ...
    @property
    @pulumi.getter(name="portX")
    def port_x(self) -> pulumi.Output[builtins.int]:
        """
        The TCP network port on which X Plugin listens for connections. This is the X Plugin equivalent of port.
        """
        return pulumi.get(self, "port_x")
    ...
    @property
    @pulumi.getter(name="shutdownType")
    def shutdown_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        It is applicable only for stopping a DB System. Could be set to `FAST`, `SLOW` or `IMMEDIATE`. Default value is `FAST`.
