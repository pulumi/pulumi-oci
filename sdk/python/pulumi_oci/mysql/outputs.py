...
class ChannelSource(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str hostname: (Updatable) The network address of the MySQL instance.
        :param builtins.str password: (Updatable) The password for the replication user. The password must be between 8 and 32 characters long, and must contain at least 1 numeric character, 1 lowercase character, 1 uppercase character, and 1 special (nonalphanumeric) character.
        :param builtins.str source_type: (Updatable) The specific source identifier.
        :param builtins.str ssl_mode: (Updatable) The SSL mode of the Channel.
        :param builtins.str username: (Updatable) The name of the replication user on the source MySQL instance. The username has a maximum length of 96 characters. For more information, please see the [MySQL documentation](https://dev.mysql.com/doc/refman/8.0/en/change-master-to.html)
        ...
        :param builtins.int port: (Updatable) The port the source MySQL instance listens on.
...
class ChannelSourceAnonymousTransactionsHandling(dict):
    ...
    def __init__(__self__, *,
                 policy: builtins.str,
                 last_configured_log_filename: Optional[builtins.str] = None,
                 last_configured_log_offset: Optional[builtins.str] = None,
                 uuid: Optional[builtins.str] = None):
        """
        :param builtins.str policy: (Updatable) Specifies how the replication channel handles anonymous transactions.
        :param builtins.str last_configured_log_filename: (Updatable) Specifies one of the coordinates (file) at which the replica should begin reading the source's log. As this value specifies the point where replication starts from, it is only used once, when it starts. It is never used again, unless a new UpdateChannel operation modifies it.
        :param builtins.str last_configured_log_offset: (Updatable) Specifies one of the coordinates (offset) at which the replica should begin reading the source's log. As this value specifies the point where replication starts from, it is only used once, when it starts. It is never used again, unless a new UpdateChannel operation modifies it.
        :param builtins.str uuid: (Updatable) The UUID that is used as a prefix when generating transaction identifiers for anonymous transactions coming from the source. You can change the UUID later.
        """
    ...
    def last_configured_log_filename(self) -> Optional[builtins.str]:
        """
    ...
    def last_configured_log_offset(self) -> Optional[builtins.str]:
        """
...
class ChannelSourceSslCaCertificate(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str certificate_type: (Updatable) The type of CA certificate.
        :param builtins.str contents: (Updatable) The string containing the CA certificate in PEM format.
        """
...
class ChannelTarget(dict):
    ...
    def __init__(__self__, *,
                 ...
                 applier_username: Optional[builtins.str] = None,
                 channel_name: Optional[builtins.str] = None,
                 delay_in_seconds: Optional[builtins.int] = None,
                 filters: Optional[Sequence['outputs.ChannelTargetFilter']] = None,
                 tables_without_primary_key_handling: Optional[builtins.str] = None):
        """
        :param builtins.str db_system_id: The OCID of the target DB System.
        :param builtins.str target_type: (Updatable) The specific target identifier.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param builtins.str applier_username: (Updatable) The username for the replication applier of the target MySQL DB System.
        :param builtins.str channel_name: (Updatable) The case-insensitive name that identifies the replication channel. Channel names must follow the rules defined for [MySQL identifiers](https://dev.mysql.com/doc/refman/8.0/en/identifiers.html). The names of non-Deleted Channels must be unique for each DB System.
        :param builtins.int delay_in_seconds: (Updatable) Specifies the amount of time, in seconds, that the channel waits before  applying a transaction received from the source.
        ...
        :param builtins.str tables_without_primary_key_handling: (Updatable) Specifies how a replication channel handles the creation and alteration of tables  that do not have a primary key. The default value is set to ALLOW.
        """
    ...
    def applier_username(self) -> Optional[builtins.str]:
        """
    ...
    def delay_in_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def tables_without_primary_key_handling(self) -> Optional[builtins.str]:
        """
...
class ChannelTargetFilter(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str type: (Updatable) The type of the filter rule.
               
               For details on each type, see [Replication Filtering Rules](https://dev.mysql.com/doc/refman/8.0/en/replication-rules.html)
        :param builtins.str value: (Updatable) The body of the filter rule. This can represent a database, a table, or a database pair (represented as "db1->db2"). For more information, see [Replication Filtering Rules](https://dev.mysql.com/doc/refman/8.0/en/replication-rules.html).
        """
...
class HeatWaveClusterClusterNode(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str node_id: The ID of the node within MySQL HeatWave cluster.
        :param builtins.str state: (Updatable) The target state for the HeatWave cluster. Could be set to `ACTIVE` or `INACTIVE`.
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param builtins.str time_created: The date and time the HeatWave cluster was created, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        :param builtins.str time_updated: The time the HeatWave cluster was last updated, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        """
...
class MysqlBackupDbSystemSnapshot(dict):
    ...
    def __init__(__self__, *,
                 ...
                 crash_recovery: Optional[builtins.str] = None,
                 data_storage_size_in_gb: Optional[builtins.int] = None,
                 data_storages: Optional[Sequence['outputs.MysqlBackupDbSystemSnapshotDataStorage']] = None,
                 database_management: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str admin_username: The username for the administrative user.
        :param builtins.str availability_domain: The Availability Domain where the primary DB System should be located.
        :param Sequence['MysqlBackupDbSystemSnapshotBackupPolicyArgs'] backup_policies: The Backup policy for the DB System.
        :param builtins.str compartment_id: (Updatable) The OCID of the compartment the backup exists in.
        :param builtins.str configuration_id: The OCID of the Configuration to be used for Instances in this DB System.
        :param builtins.str crash_recovery: Whether to run the DB System with InnoDB Redo Logs and the Double Write Buffer enabled or disabled, and whether to enable or disable syncing of the Binary Logs.
        :param builtins.int data_storage_size_in_gb: DEPRECATED: User specified size of the data volume. May be less than current allocatedStorageSizeInGBs. Replaced by dataStorage.dataStorageSizeInGBs.
        :param Sequence['MysqlBackupDbSystemSnapshotDataStorageArgs'] data_storages: Data Storage information.
        :param builtins.str database_management: Whether to enable monitoring via the Database Management service.
        ...
        :param builtins.str hostname_label: The hostname for the primary endpoint of the DB System. Used for DNS. The value is the hostname portion of the primary private IP's fully qualified domain name (FQDN) (for example, "dbsystem-1" in FQDN "dbsystem-1.subnet123.vcn1.oraclevcn.com"). Must be unique across all VNICs in the subnet and comply with RFC 952 and RFC 1123.
    ...
    def crash_recovery(self) -> Optional[builtins.str]:
        """
    ...
    def data_storage_size_in_gb(self) -> Optional[builtins.int]:
        """
    ...
    def database_management(self) -> Optional[builtins.str]:
        """
    ...
    def is_highly_available(self) -> Optional[builtins.bool]:
        """
    ...
    def port_x(self) -> Optional[builtins.int]:
        """
...
class MysqlBackupDbSystemSnapshotBackupPolicyCopyPolicy(dict):
    ...
    def __init__(__self__, *,
                 backup_copy_retention_in_days: Optional[builtins.int] = None,
                 copy_to_region: Optional[builtins.str] = None):
        """
        :param builtins.int backup_copy_retention_in_days: Number of days to retain the copied DB system backup.
        :param builtins.str copy_to_region: The destination region name to which the DB system backup will be copied.
        """
    ...
    def backup_copy_retention_in_days(self) -> Optional[builtins.int]:
        """
    ...
    def copy_to_region(self) -> Optional[builtins.str]:
        """
...
class MysqlBackupDbSystemSnapshotDataStorage(dict):
    ...
    def __init__(__self__, *,
                 ...
                 data_storage_size_in_gb: Optional[builtins.int] = None,
                 data_storage_size_limit_in_gbs: Optional[builtins.int] = None,
                 is_auto_expand_storage_enabled: Optional[builtins.bool] = None,
                 max_storage_size_in_gbs: Optional[builtins.int] = None):
        """
        :param builtins.int allocated_storage_size_in_gbs: The actual allocated storage size for the DB System. This may be higher than dataStorageSizeInGBs if an automatic storage expansion has occurred.
        :param builtins.int data_storage_size_in_gb: DEPRECATED: User specified size of the data volume. May be less than current allocatedStorageSizeInGBs. Replaced by dataStorage.dataStorageSizeInGBs.
        :param builtins.int data_storage_size_limit_in_gbs: The absolute limit the DB System's storage size may ever expand to, either manually or automatically. This limit is based based on the initial dataStorageSizeInGBs when the DB System was first created. Both dataStorageSizeInGBs and maxDataStorageSizeInGBs can not exceed this value.
        :param builtins.bool is_auto_expand_storage_enabled: Enable/disable automatic storage expansion. When set to true, the DB System will automatically add storage incrementally up to the value specified in maxStorageSizeInGBs.
        :param builtins.int max_storage_size_in_gbs: Maximum storage size this DB System can expand to. When isAutoExpandStorageEnabled is set to true, the DB System will add storage incrementally up to this value.
        """
    ...
    def data_storage_size_limit_in_gbs(self) -> Optional[builtins.int]:
        """
    ...
    def is_auto_expand_storage_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def max_storage_size_in_gbs(self) -> Optional[builtins.int]:
        """
...
class MysqlBackupDbSystemSnapshotDeletionPolicy(dict):
    ...
    def __init__(__self__, *,
                 automatic_backup_retention: Optional[builtins.str] = None,
                 final_backup: Optional[builtins.str] = None,
                 is_delete_protected: Optional[builtins.bool] = None):
        """
        :param builtins.str automatic_backup_retention: Specifies if any automatic backups created for a DB System should be retained or deleted when the DB System is deleted.
        :param builtins.str final_backup: Specifies whether or not a backup is taken when the DB System is deleted. REQUIRE_FINAL_BACKUP: a backup is taken if the DB System is deleted. SKIP_FINAL_BACKUP: a backup is not taken if the DB System is deleted.
        :param builtins.bool is_delete_protected: Specifies whether the DB System can be deleted. Set to true to prevent deletion, false (default) to allow.
        """
    ...
    def automatic_backup_retention(self) -> Optional[builtins.str]:
        """
    ...
    def final_backup(self) -> Optional[builtins.str]:
        """
    ...
    def is_delete_protected(self) -> Optional[builtins.bool]:
        """
...
class MysqlBackupDbSystemSnapshotEndpoint(dict):
    ...
    def __init__(__self__, *,
                 ...
                 ip_address: Optional[builtins.str] = None,
                 modes: Optional[Sequence[builtins.str]] = None,
                 port: Optional[builtins.int] = None,
                 port_x: Optional[builtins.int] = None,
        ...
        :param builtins.str status: The state of the endpoints, as far as it can seen from the DB System. There may be some inconsistency with the actual state of the MySQL service.
        :param builtins.str status_details: Additional information about the current endpoint status.
        """
    ...
    @property
    @pulumi.getter
    def modes(self) -> Optional[Sequence[builtins.str]]:
        """
...
class MysqlBackupDbSystemSnapshotReadEndpoint(dict):
    ...
    def __init__(__self__, *,
                 exclude_ips: Optional[Sequence[builtins.str]] = None,
                 is_enabled: Optional[builtins.bool] = None,
                 read_endpoint_hostname_label: Optional[builtins.str] = None,
                 read_endpoint_ip_address: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] exclude_ips: A list of IP addresses of read replicas that are excluded from serving read requests.
        :param builtins.bool is_enabled: Specifies if the DB System read endpoint is enabled or not.
        :param builtins.str read_endpoint_hostname_label: The hostname for the read endpoint of the DB System. Used for DNS.
        :param builtins.str read_endpoint_ip_address: The IP address the DB System read endpoint is configured to listen on. A private IP address of your choice to assign to the read endpoint of the DB System. Must be an available IP address within the subnet's CIDR. If you don't specify a value, Oracle automatically assigns a private IP address from the subnet. This should be a "dotted-quad" style IPv4 address.
        """
    ...
    def exclude_ips(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def read_endpoint_hostname_label(self) -> Optional[builtins.str]:
        """
    ...
    def read_endpoint_ip_address(self) -> Optional[builtins.str]:
        """
...
class MysqlBackupDbSystemSnapshotSecureConnection(dict):
    ...
    def __init__(__self__, *,
                 certificate_generation_type: Optional[builtins.str] = None,
                 certificate_id: Optional[builtins.str] = None):
        """
        :param builtins.str certificate_generation_type: Select whether to use MySQL Database Service-managed certificate (SYSTEM) or your own certificate (BYOC).
        :param builtins.str certificate_id: The OCID of the certificate to use.
        """
    ...
    def certificate_generation_type(self) -> Optional[builtins.str]:
        """
...
class MysqlBackupSourceDetails(dict):
    ...
    def __init__(__self__, *,
                 ...
                 region: builtins.str):
        """
        :param builtins.str backup_id: The OCID of the source backup.
        :param builtins.str compartment_id: (Updatable) The OCID of the compartment the backup exists in.
        :param builtins.str region: The region of the backup source.
        """
...
class MysqlConfigurationInitVariables(dict):
    ...
    def __init__(__self__, *,
                 lower_case_table_names: Optional[builtins.str] = None):
        """
        :param builtins.str lower_case_table_names: Represents the MySQL server system variable lower_case_table_names (https://dev.mysql.com/doc/refman/8.0/en/server-system-variables.html#sysvar_lower_case_table_names).
    ...
    def lower_case_table_names(self) -> Optional[builtins.str]:
        """
...
class MysqlConfigurationVariables(dict):
    ...
    def __init__(__self__, *,
                 auto_increment_increment: Optional[builtins.int] = None,
                 auto_increment_offset: Optional[builtins.int] = None,
                 autocommit: Optional[builtins.bool] = None,
                 big_tables: Optional[builtins.bool] = None,
                 binlog_expire_logs_seconds: Optional[builtins.int] = None,
                 binlog_group_commit_sync_delay: Optional[builtins.int] = None,
                 binlog_group_commit_sync_no_delay_count: Optional[builtins.int] = None,
                 binlog_row_metadata: Optional[builtins.str] = None,
                 binlog_row_value_options: Optional[builtins.str] = None,
                 binlog_transaction_compression: Optional[builtins.bool] = None,
                 block_encryption_mode: Optional[builtins.str] = None,
                 character_set_server: Optional[builtins.str] = None,
                 collation_server: Optional[builtins.str] = None,
                 completion_type: Optional[builtins.str] = None,
                 connect_timeout: Optional[builtins.int] = None,
                 connection_memory_chunk_size: Optional[builtins.int] = None,
                 connection_memory_limit: Optional[builtins.str] = None,
                 cte_max_recursion_depth: Optional[builtins.str] = None,
                 default_authentication_plugin: Optional[builtins.str] = None,
                 explain_format: Optional[builtins.str] = None,
                 explicit_defaults_for_timestamp: Optional[builtins.bool] = None,
                 foreign_key_checks: Optional[builtins.bool] = None,
                 generated_random_password_length: Optional[builtins.int] = None,
                 global_connection_memory_limit: Optional[builtins.str] = None,
                 global_connection_memory_tracking: Optional[builtins.bool] = None,
                 group_concat_max_len: Optional[builtins.str] = None,
                 group_replication_consistency: Optional[builtins.str] = None,
                 information_schema_stats_expiry: Optional[builtins.int] = None,
                 innodb_adaptive_hash_index: Optional[builtins.bool] = None,
                 innodb_autoinc_lock_mode: Optional[builtins.int] = None,
                 innodb_buffer_pool_dump_pct: Optional[builtins.int] = None,
                 innodb_buffer_pool_instances: Optional[builtins.int] = None,
                 innodb_buffer_pool_size: Optional[builtins.str] = None,
                 innodb_change_buffering: Optional[builtins.str] = None,
                 innodb_ddl_buffer_size: Optional[builtins.str] = None,
                 innodb_ddl_threads: Optional[builtins.int] = None,
                 innodb_ft_enable_stopword: Optional[builtins.bool] = None,
                 innodb_ft_max_token_size: Optional[builtins.int] = None,
                 innodb_ft_min_token_size: Optional[builtins.int] = None,
                 innodb_ft_num_word_optimize: Optional[builtins.int] = None,
                 innodb_ft_result_cache_limit: Optional[builtins.str] = None,
                 innodb_ft_server_stopword_table: Optional[builtins.str] = None,
                 innodb_lock_wait_timeout: Optional[builtins.int] = None,
                 innodb_log_writer_threads: Optional[builtins.bool] = None,
                 innodb_max_purge_lag: Optional[builtins.str] = None,
                 innodb_max_purge_lag_delay: Optional[builtins.int] = None,
                 innodb_numa_interleave: Optional[builtins.bool] = None,
                 innodb_online_alter_log_max_size: Optional[builtins.str] = None,
                 innodb_redo_log_capacity: Optional[builtins.str] = None,
                 innodb_rollback_on_timeout: Optional[builtins.bool] = None,
                 innodb_sort_buffer_size: Optional[builtins.int] = None,
                 innodb_stats_persistent_sample_pages: Optional[builtins.str] = None,
                 innodb_stats_transient_sample_pages: Optional[builtins.str] = None,
                 innodb_strict_mode: Optional[builtins.bool] = None,
                 innodb_undo_log_truncate: Optional[builtins.bool] = None,
                 interactive_timeout: Optional[builtins.int] = None,
                 join_buffer_size: Optional[builtins.str] = None,
                 local_infile: Optional[builtins.bool] = None,
                 long_query_time: Optional[builtins.int] = None,
                 mandatory_roles: Optional[builtins.str] = None,
                 max_allowed_packet: Optional[builtins.int] = None,
                 max_binlog_cache_size: Optional[builtins.str] = None,
                 max_connect_errors: Optional[builtins.str] = None,
                 max_connections: Optional[builtins.int] = None,
                 max_execution_time: Optional[builtins.str] = None,
                 max_heap_table_size: Optional[builtins.str] = None,
                 max_prepared_stmt_count: Optional[builtins.int] = None,
                 max_seeks_for_key: Optional[builtins.str] = None,
                 max_user_connections: Optional[builtins.str] = None,
                 mysql_firewall_mode: Optional[builtins.bool] = None,
                 mysql_zstd_default_compression_level: Optional[builtins.int] = None,
                 mysqlx_connect_timeout: Optional[builtins.int] = None,
                 mysqlx_deflate_default_compression_level: Optional[builtins.int] = None,
                 mysqlx_deflate_max_client_compression_level: Optional[builtins.int] = None,
                 mysqlx_document_id_unique_prefix: Optional[builtins.int] = None,
                 mysqlx_enable_hello_notice: Optional[builtins.bool] = None,
                 mysqlx_idle_worker_thread_timeout: Optional[builtins.int] = None,
                 mysqlx_interactive_timeout: Optional[builtins.int] = None,
                 mysqlx_lz4default_compression_level: Optional[builtins.int] = None,
                 mysqlx_lz4max_client_compression_level: Optional[builtins.int] = None,
                 mysqlx_max_allowed_packet: Optional[builtins.int] = None,
                 mysqlx_min_worker_threads: Optional[builtins.int] = None,
                 mysqlx_read_timeout: Optional[builtins.int] = None,
                 mysqlx_wait_timeout: Optional[builtins.int] = None,
                 mysqlx_write_timeout: Optional[builtins.int] = None,
                 mysqlx_zstd_default_compression_level: Optional[builtins.int] = None,
                 mysqlx_zstd_max_client_compression_level: Optional[builtins.int] = None,
                 net_read_timeout: Optional[builtins.int] = None,
                 net_write_timeout: Optional[builtins.int] = None,
                 optimizer_switch: Optional[builtins.str] = None,
                 parser_max_mem_size: Optional[builtins.str] = None,
                 query_alloc_block_size: Optional[builtins.str] = None,
                 query_prealloc_size: Optional[builtins.str] = None,
                 range_optimizer_max_mem_size: Optional[builtins.str] = None,
                 regexp_time_limit: Optional[builtins.int] = None,
                 relay_log_space_limit: Optional[builtins.str] = None,
                 replica_net_timeout: Optional[builtins.int] = None,
                 replica_parallel_workers: Optional[builtins.int] = None,
                 replica_type_conversions: Optional[builtins.str] = None,
                 require_secure_transport: Optional[builtins.bool] = None,
                 skip_name_resolve: Optional[builtins.bool] = None,
                 sort_buffer_size: Optional[builtins.str] = None,
                 sql_generate_invisible_primary_key: Optional[builtins.bool] = None,
                 sql_mode: Optional[builtins.str] = None,
                 sql_require_primary_key: Optional[builtins.bool] = None,
                 sql_warnings: Optional[builtins.bool] = None,
                 table_definition_cache: Optional[builtins.int] = None,
                 table_open_cache: Optional[builtins.int] = None,
                 temptable_max_ram: Optional[builtins.str] = None,
                 thread_pool_dedicated_listeners: Optional[builtins.bool] = None,
                 thread_pool_max_transactions_limit: Optional[builtins.int] = None,
                 thread_pool_query_threads_per_group: Optional[builtins.int] = None,
                 thread_pool_size: Optional[builtins.int] = None,
                 thread_pool_transaction_delay: Optional[builtins.int] = None,
                 time_zone: Optional[builtins.str] = None,
                 tmp_table_size: Optional[builtins.str] = None,
                 transaction_isolation: Optional[builtins.str] = None,
                 wait_timeout: Optional[builtins.int] = None):
        """
        :param builtins.int auto_increment_increment: auto_increment_increment and auto_increment_offset are intended for use with circular (source-to-source) replication, and can be used to control the operation of AUTO_INCREMENT columns. Both variables have global and session values, and each can assume an integer value between 1 and 65,535 inclusive.
        ...
        :param builtins.int auto_increment_offset: This variable has a default value of 1. If it is left with its default value, and Group Replication is started on the server in multi-primary mode, it is changed to the server ID.
        ...
        :param builtins.bool autocommit: ("autocommit")
        :param builtins.bool big_tables: If enabled, the server stores all temporary tables on disk rather than in memory.
        ...
        :param builtins.int binlog_group_commit_sync_no_delay_count: The maximum number of transactions to wait for before aborting the current delay as specified by binlog_group_commit_sync_delay. If binlog_group_commit_sync_delay is set to 0, then this option has no effect.
        ...
        :param builtins.str binlog_row_metadata: Configures the amount of table metadata added to the binary log when using row-based logging. binlogRowMetadata corresponds to the MySQL binary logging system variable [binlog_row_metadata](https://dev.mysql.com/doc/refman/8.0/en/replication-options-binary-log.html#sysvar_binlog_row_metadata).
        :param builtins.str binlog_row_value_options: When set to PARTIAL_JSON, this enables use of a space-efficient binary log format for updates that modify only a small portion of a JSON document. binlogRowValueOptions corresponds to the MySQL binary logging system variable [binlog_row_value_options](https://dev.mysql.com/doc/refman/8.0/en/replication-options-binary-log.html#sysvar_binlog_row_value_options).
        :param builtins.bool binlog_transaction_compression: Enables compression for transactions that are written to binary log files on this server. binlogTransactionCompression corresponds to the MySQL binary logging system variable [binlog_transaction_compression](https://dev.mysql.com/doc/refman/8.0/en/replication-options-binary-log.html#sysvar_binlog_transaction_compression).
        :param builtins.str block_encryption_mode: This variable controls the block encryption mode for block-based algorithms such as AES. It affects encryption for AES_ENCRYPT() and AES_DECRYPT(). block_encryption_mode takes a value in aes-keylen-mode format, where keylen is the key length in bits and mode is the encryption mode. The value is not case-sensitive. Permitted keylen values are 128, 192, and 256. Permitted mode values are ECB, CBC, CFB1, CFB8, CFB128, and OFB.
        ...
        :param builtins.str character_set_server: The server's default character set. If you set this variable, you should also set collation_server to specify the collation for the character set.
        ...
        :param builtins.str collation_server: The server's default collation.
        ...
        :param builtins.str completion_type: ("completion_type")
        ...
        :param builtins.int connection_memory_chunk_size: Set the chunking size for updates to the global memory usage counter Global_connection_memory.
        ...
        :param builtins.str connection_memory_limit: Set the maximum amount of memory that can be used by a single user connection.
        ...
        :param builtins.str cte_max_recursion_depth: ("cte_max_recursion_depth")
        :param builtins.str default_authentication_plugin: The default authentication plugin. This must be a plugin that uses internal credentials storage, so these values are permitted: mysql_native_password, sha256_password, caching_sha2_password.
        ...
        :param builtins.str explain_format: This variable determines the default output format used by EXPLAIN in the absence of a FORMAT option when displaying a query execution plan.
        ...
        :param builtins.bool foreign_key_checks: ("foreign_key_checks")
        :param builtins.int generated_random_password_length: ("generated_random_password_length") DEPRECATED -- variable should not be settable and will be ignored
        :param builtins.str global_connection_memory_limit: Set the total amount of memory that can be used by all user connections.
        ...
        :param builtins.bool global_connection_memory_tracking: Determines whether the MySQL server calculates Global_connection_memory.
        ...
        :param builtins.str group_concat_max_len: Specifies the maximum permitted result length in bytes for the GROUP_CONCAT() function.
        ...
        :param builtins.str group_replication_consistency: * EVENTUAL: Both RO and RW transactions do not wait for preceding transactions to be applied before executing. A RW transaction does not wait for other members to apply a transaction. This means that a transaction could be externalized on one member before the others. This also means that in the event of a primary failover, the new primary can accept new RO and RW transactions before the previous primary transactions are all applied. RO transactions could result in outdated values, RW transactions could result in a rollback due to conflicts.
        ...
        :param builtins.int innodb_autoinc_lock_mode: The lock mode to use for generating auto-increment values. Permissible values are 0, 1, or 2, for traditional, consecutive, or interleaved, respectively.
        ...
        :param builtins.int innodb_buffer_pool_dump_pct: Specifies the percentage of the most recently used pages for each buffer pool to read out and dump.
        ...
        :param builtins.int innodb_buffer_pool_instances: ("innodb_buffer_pool_instances")
        :param builtins.str innodb_buffer_pool_size: The size (in bytes) of the buffer pool, that is, the memory area where InnoDB caches table and index data.
        ...
        :param builtins.str innodb_ddl_buffer_size: innodbDdlBufferSize corresponds to the MySQL system variable [innodb_ddl_buffer_size] (https://dev.mysql.com/doc/refman/8.0/en/innodb-parameters.html#sysvar_innodb_ddl_buffer_size)
        :param builtins.int innodb_ddl_threads: innodbDdlThreads corresponds to the MySQL system variable [innodb_ddl_threads] (https://dev.mysql.com/doc/refman/8.0/en/innodb-parameters.html#sysvar_innodb_ddl_threads)
        :param builtins.bool innodb_ft_enable_stopword: ("innodb_ft_enable_stopword")
        :param builtins.int innodb_ft_max_token_size: ("innodb_ft_max_token_size")
        :param builtins.int innodb_ft_min_token_size: ("innodb_ft_min_token_size")
        :param builtins.int innodb_ft_num_word_optimize: ("innodb_ft_num_word_optimize")
        :param builtins.str innodb_ft_result_cache_limit: ("innodb_ft_result_cache_limit")
        :param builtins.str innodb_ft_server_stopword_table: ("innodb_ft_server_stopword_table")
        :param builtins.int innodb_lock_wait_timeout: ("innodb_lock_wait_timeout")
        :param builtins.bool innodb_log_writer_threads: Enables dedicated log writer threads for writing redo log records from the log buffer to the system buffers and flushing the system buffers to the redo log files.
        ...
        :param builtins.str innodb_max_purge_lag: The desired maximum purge lag in terms of transactions.
        ...
        :param builtins.int innodb_max_purge_lag_delay: The maximum delay in microseconds for the delay imposed when the innodb_max_purge_lag threshold is exceeded.
        ...
        :param builtins.str innodb_online_alter_log_max_size: Specifies an upper limit in bytes on the size of the temporary log files used during online DDL operations for InnoDB tables. There is one such log file for each index being created or table being altered. This log file stores data inserted, updated, or deleted in the table during the DDL operation.
        ...
        :param builtins.bool innodb_rollback_on_timeout: InnoDB rolls back only the last statement on a transaction timeout by default. If --innodb-rollback-on-timeout is specified, a transaction timeout causes InnoDB to abort and roll back the entire transaction.
        ...
        :param builtins.int innodb_sort_buffer_size: This variable defines:
        ...
        :param builtins.str innodb_stats_persistent_sample_pages: The number of index pages to sample when estimating cardinality and other statistics for an indexed column, such as those calculated by ANALYZE TABLE.
        ...
        :param builtins.str innodb_stats_transient_sample_pages: The number of index pages to sample when estimating cardinality and other statistics for an indexed column, such as those calculated by [ANALYZE TABLE](https://dev.mysql.com/doc/refman/8.0/en/analyze-table.html).
        ...
        :param builtins.bool innodb_strict_mode: When you enable innodbStrictMode, the InnoDB storage engine returns errors instead of warnings for invalid or incompatible table options.
        ...
        :param builtins.str join_buffer_size: The minimum size of the buffer that is used for plain index scans, range index scans, and joins that do not use indexes and thus perform full table scans. In MySQL 8.0.18 and later, this variable also controls the amount of memory used for hash joins. Normally, the best way to get fast joins is to add indexes. Increase the value of join_buffer_size to get a faster full join when adding indexes is not possible. One join buffer is allocated for each full join between two tables. For a complex join between several tables for which indexes are not used, multiple join buffers might be necessary.
        ...
        :param builtins.bool local_infile: This variable controls server-side LOCAL capability for LOAD DATA statements. Depending on the local_infile setting, the server refuses or permits local data loading by clients that have LOCAL enabled on the client side. 
        ...
        :param builtins.str mandatory_roles: ("mandatory_roles")
        :param builtins.int max_allowed_packet: The maximum size of one packet or any generated/intermediate string.
               
               This is the mysql variable "max_allowed_packet".
        :param builtins.str max_binlog_cache_size: Sets the size of the transaction cache.
        ...
        :param builtins.str max_connect_errors: ("max_connect_errors")
        :param builtins.int max_connections: ("max_connections")
        :param builtins.str max_execution_time: ("max_execution_time")
        :param builtins.str max_heap_table_size: This variable sets the maximum size to which user-created MEMORY tables are permitted to grow.
        ...
        :param builtins.int max_prepared_stmt_count: ("max_prepared_stmt_count")
        :param builtins.str max_seeks_for_key: Limit the assumed maximum number of seeks when looking up rows based on a key. The MySQL optimizer assumes that no more than this number of key seeks are required when searching for matching rows in a table by scanning an index, regardless of the actual cardinality of the index (see Section 15.7.7.22, “SHOW INDEX Statement”). By setting this to a low value (say, 100), you can force MySQL to prefer indexes instead of table scans.
        ...
        :param builtins.str max_user_connections: The maximum number of simultaneous connections permitted to any given MySQL user account. A value of 0 (the default) means “no limit.” This variable has a global value that can be set at server startup or runtime. It also has a read-only session value that indicates the effective simultaneous-connection limit that applies to the account associated with the current session.
        ...
        :param builtins.bool mysql_firewall_mode: ("mysql_firewall_mode")
        :param builtins.int mysql_zstd_default_compression_level: DEPRECATED -- typo of mysqlx_zstd_default_compression_level. variable will be ignored.
        :param builtins.int mysqlx_connect_timeout: The number of seconds X Plugin waits for the first packet to be received from newly connected clients.
        ...
        :param builtins.int mysqlx_deflate_default_compression_level: Set the default compression level for the deflate algorithm. ("mysqlx_deflate_default_compression_level")
        :param builtins.int mysqlx_deflate_max_client_compression_level: Limit the upper bound of accepted compression levels for the deflate algorithm. ("mysqlx_deflate_max_client_compression_level")
        :param builtins.int mysqlx_document_id_unique_prefix: ("mysqlx_document_id_unique_prefix") DEPRECATED -- variable should not be settable and will be ignored
        :param builtins.bool mysqlx_enable_hello_notice: ("mysqlx_enable_hello_notice") DEPRECATED -- variable should not be settable and will be ignored
        :param builtins.int mysqlx_idle_worker_thread_timeout: ("mysqlx_idle_worker_thread_timeout") DEPRECATED -- variable should not be settable and will be ignored
        :param builtins.int mysqlx_interactive_timeout: The number of seconds to wait for interactive clients to timeout.
        ...
        :param builtins.int mysqlx_lz4default_compression_level: Set the default compression level for the lz4 algorithm. ("mysqlx_lz4_default_compression_level")
        :param builtins.int mysqlx_lz4max_client_compression_level: Limit the upper bound of accepted compression levels for the lz4 algorithm. ("mysqlx_lz4_max_client_compression_level")
        :param builtins.int mysqlx_max_allowed_packet: The maximum size of network packets that can be received by X Plugin.
               
               This is the mysql variable "mysqlx_max_allowed_packet".
        :param builtins.int mysqlx_min_worker_threads: ("mysqlx_min_worker_threads") DEPRECATED -- variable should not be settable and will be ignored
        :param builtins.int mysqlx_read_timeout: The number of seconds that X Plugin waits for blocking read operations to complete. After this time, if the read operation is not successful, X Plugin closes the connection and returns a warning notice with the error code ER_IO_READ_ERROR to the client application.
        ...
        :param builtins.int mysqlx_wait_timeout: The number of seconds that X Plugin waits for activity on a connection.
        ...
        :param builtins.int mysqlx_write_timeout: The number of seconds that X Plugin waits for blocking write operations to complete. After this time, if the write operation is not successful, X Plugin closes the connection.
        ...
        :param builtins.int mysqlx_zstd_default_compression_level: Set the default compression level for the zstd algorithm. ("mysqlx_zstd_default_compression_level")
        :param builtins.int mysqlx_zstd_max_client_compression_level: Limit the upper bound of accepted compression levels for the zstd algorithm. ("mysqlx_zstd_max_client_compression_level")
        ...
        :param builtins.str optimizer_switch: The optimizer_switch system variable enables control over optimizer behavior. The value of this variable is a set of flags, each of which has a value of on or off to indicate whether the corresponding optimizer behavior is enabled or disabled. This variable has global and session values and can be changed at runtime. The global default can be set at server startup.
        ...
        :param builtins.str parser_max_mem_size: ("parser_max_mem_size")
        :param builtins.str query_alloc_block_size: ("query_alloc_block_size") DEPRECATED -- variable should not be settable and will be ignored
        :param builtins.str query_prealloc_size: ("query_prealloc_size") DEPRECATED -- variable should not be settable and will be ignored
        :param builtins.str range_optimizer_max_mem_size: The limit on memory consumption for the range optimizer. A value of 0 means “no limit.” If an execution plan considered by the optimizer uses the range access method but the optimizer estimates that the amount of memory needed for this method would exceed the limit, it abandons the plan and considers other plans. 
        ...
        :param builtins.int regexp_time_limit: regexpTimeLimit corresponds to the MySQL system variable [regexp_time_limit] (https://dev.mysql.com/doc/refman/8.0/en/server-system-variables.html#sysvar_regexp_time_limit)
        :param builtins.str relay_log_space_limit: The maximum amount of space to use for all relay logs.
        ...
        :param builtins.int replica_parallel_workers: Beginning with MySQL 8.0.26, slave_parallel_workers is deprecated, and you should use replica_parallel_workers instead. (Prior to MySQL 8.0.26, you must use slave_parallel_workers to set the number of applier threads.)
        ...
        :param builtins.str replica_type_conversions: From MySQL 8.0.26, use replica_type_conversions in place of slave_type_conversions, which is deprecated from that release. In releases before MySQL 8.0.26, use slave_type_conversions.
        ...
        :param builtins.str sort_buffer_size: Each session that must perform a sort allocates a buffer of this size.
        ...
        :param builtins.bool sql_generate_invisible_primary_key: Whether GIPK mode is in effect, in which case a MySQL replication source server adds a generated invisible primary key to any InnoDB table that is created without one.
        ...
        :param builtins.str sql_mode: ("sql_mode")
        :param builtins.bool sql_require_primary_key: ("sql_require_primary_key")
        :param builtins.bool sql_warnings: ("sql_warnings")
        :param builtins.int table_definition_cache: The number of table definitions that can be stored in the table definition cache. If you use a large number of tables, you can create a large table definition cache to speed up opening of tables. The table definition cache takes less space and does not use file descriptors, unlike the normal table cache.
        ...
        :param builtins.int table_open_cache: The number of open tables for all threads. Increasing this value increases the number of file descriptors that mysqld requires.
        ...
        :param builtins.str temptable_max_ram: Defines the maximum amount of memory that can be occupied by the TempTable storage engine before it starts storing data on disk. The default value is 1073741824 bytes (1GiB). For more information, see Section 10.4.4, “Internal Temporary Table Use in MySQL”.
        ...
        :param builtins.bool thread_pool_dedicated_listeners: Controls whether the thread pool uses dedicated listener threads. If enabled, a listener thread in each thread group is dedicated to the task of listening for network events from clients, ensuring that the maximum number of query worker threads is no more than the value specified by threadPoolMaxTransactionsLimit. threadPoolDedicatedListeners corresponds to the MySQL Database Service-specific system variable thread_pool_dedicated_listeners.
        :param builtins.int thread_pool_max_transactions_limit: Limits the maximum number of open transactions to the defined value. The default value is 0, which enforces no limit. threadPoolMaxTransactionsLimit corresponds to the MySQL Database Service-specific system variable thread_pool_max_transactions_limit.
        :param builtins.int thread_pool_query_threads_per_group: The maximum number of query threads permitted in a thread group. The maximum value is 4096, but if thread_pool_max_transactions_limit is set, thread_pool_query_threads_per_group must not exceed that value. The default value of 1 means there is one active query thread in each thread group, which works well for many loads. When you are using the high concurrency thread pool algorithm (thread_pool_algorithm = 1), consider increasing the value if you experience slower response times due to long-running transactions. 
        ...
        :param builtins.int thread_pool_size: The number of thread groups in the thread pool. This is the most important parameter controlling thread pool performance. It affects how many statements can execute simultaneously. If a value outside the range of permissible values is specified, the thread pool plugin does not load and the server writes a message to the error log.
        ...
        :param builtins.int thread_pool_transaction_delay: The delay period before executing a new transaction, in milliseconds. The maximum value is 300000 (5 minutes). A transaction delay can be used in cases where parallel transactions affect the performance of other operations due to resource contention. For example, if parallel transactions affect index creation or an online buffer pool resizing operation, you can configure a transaction delay to reduce resource contention while those operations are running. 
        ...
        :param builtins.str time_zone: Initializes the time zone for each client that connects.
        ...
        :param builtins.str tmp_table_size: The maximum size of internal in-memory temporary tables. This variable does not apply to user-created MEMORY tables.
        ...
        :param builtins.str transaction_isolation: ("transaction_isolation")
    ...
    def auto_increment_increment(self) -> Optional[builtins.int]:
        """
    ...
    def auto_increment_offset(self) -> Optional[builtins.int]:
        """
    ...
    @property
    @pulumi.getter
    def autocommit(self) -> Optional[builtins.bool]:
        """
        ("autocommit")
        """
    ...
    def big_tables(self) -> Optional[builtins.bool]:
        """
    ...
    def binlog_expire_logs_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def binlog_group_commit_sync_delay(self) -> Optional[builtins.int]:
        """
    ...
    def binlog_group_commit_sync_no_delay_count(self) -> Optional[builtins.int]:
        """
    ...
    def binlog_row_metadata(self) -> Optional[builtins.str]:
        """
    ...
    def binlog_row_value_options(self) -> Optional[builtins.str]:
        """
    ...
    def binlog_transaction_compression(self) -> Optional[builtins.bool]:
        """
    ...
    def block_encryption_mode(self) -> Optional[builtins.str]:
        """
    ...
    def character_set_server(self) -> Optional[builtins.str]:
        """
    ...
    def collation_server(self) -> Optional[builtins.str]:
        """
    ...
    def completion_type(self) -> Optional[builtins.str]:
        """
        ("completion_type")
        """
    ...
    def connection_memory_chunk_size(self) -> Optional[builtins.int]:
        """
    ...
    def connection_memory_limit(self) -> Optional[builtins.str]:
        """
    ...
    def cte_max_recursion_depth(self) -> Optional[builtins.str]:
        """
    ...
    def default_authentication_plugin(self) -> Optional[builtins.str]:
        """
    ...
    def explain_format(self) -> Optional[builtins.str]:
        """
    ...
    def explicit_defaults_for_timestamp(self) -> Optional[builtins.bool]:
        """
    ...
    def foreign_key_checks(self) -> Optional[builtins.bool]:
        """
        ("foreign_key_checks")
        """
    ...
    def generated_random_password_length(self) -> Optional[builtins.int]:
        """
    ...
    def global_connection_memory_limit(self) -> Optional[builtins.str]:
        """
    ...
    def global_connection_memory_tracking(self) -> Optional[builtins.bool]:
        """
    ...
    def group_concat_max_len(self) -> Optional[builtins.str]:
        """
    ...
    def group_replication_consistency(self) -> Optional[builtins.str]:
        """
    ...
    def innodb_adaptive_hash_index(self) -> Optional[builtins.bool]:
        """
        Whether the InnoDB adaptive hash index is enabled or disabled. It may be desirable, depending on your workload, to dynamically enable or disable adaptive hash indexing to improve query performance. Because the adaptive hash index may not be useful for all workloads, conduct benchmarks with it both enabled and disabled, using realistic workloads.
    ...
    def innodb_autoinc_lock_mode(self) -> Optional[builtins.int]:
        """
    ...
    def innodb_buffer_pool_dump_pct(self) -> Optional[builtins.int]:
        """
    ...
    def innodb_buffer_pool_instances(self) -> Optional[builtins.int]:
        """
    ...
    def innodb_buffer_pool_size(self) -> Optional[builtins.str]:
        """
    ...
    def innodb_change_buffering(self) -> Optional[builtins.str]:
        """
    ...
    def innodb_ddl_buffer_size(self) -> Optional[builtins.str]:
        """
    ...
    def innodb_ddl_threads(self) -> Optional[builtins.int]:
        """
    ...
    def innodb_ft_enable_stopword(self) -> Optional[builtins.bool]:
        """
    ...
    def innodb_ft_max_token_size(self) -> Optional[builtins.int]:
        """
    ...
    def innodb_ft_num_word_optimize(self) -> Optional[builtins.int]:
        """
    ...
    def innodb_ft_result_cache_limit(self) -> Optional[builtins.str]:
        """
    ...
    def innodb_log_writer_threads(self) -> Optional[builtins.bool]:
        """
    ...
    def innodb_max_purge_lag(self) -> Optional[builtins.str]:
        """
    ...
    def innodb_max_purge_lag_delay(self) -> Optional[builtins.int]:
        """
    ...
    def innodb_numa_interleave(self) -> Optional[builtins.bool]:
        """
    ...
    def innodb_online_alter_log_max_size(self) -> Optional[builtins.str]:
        """
    ...
    def innodb_redo_log_capacity(self) -> Optional[builtins.str]:
        """
        Defines the amount of disk space occupied by redo log files. innodb_redo_log_capacity supercedes the innodb_log_files_in_group and innodb_log_file_size variables, which are both ignored if innodb_redo_log_capacity is defined. If innodb_redo_log_capacity is not defined, and if neither innodb_log_file_size or innodb_log_files_in_group are defined, then the default innodb_redo_log_capacity value is used.
    ...
    def innodb_sort_buffer_size(self) -> Optional[builtins.int]:
        """
    ...
    def innodb_stats_persistent_sample_pages(self) -> Optional[builtins.str]:
        """
    ...
    def innodb_stats_transient_sample_pages(self) -> Optional[builtins.str]:
        """
    ...
    def innodb_strict_mode(self) -> Optional[builtins.bool]:
        """
    ...
    def innodb_undo_log_truncate(self) -> Optional[builtins.bool]:
        """
        When enabled, undo tablespaces that exceed the threshold value defined by innodb_max_undo_log_size are marked for truncation. Only undo tablespaces can be truncated. Truncating undo logs that reside in the system tablespace is not supported. For truncation to occur, there must be at least two undo tablespaces.
    ...
    def join_buffer_size(self) -> Optional[builtins.str]:
        """
    ...
    def local_infile(self) -> Optional[builtins.bool]:
        """
    ...
    def long_query_time(self) -> Optional[builtins.int]:
        """
        If a query takes longer than this many seconds, the server increments the Slow_queries status variable. If the slow query log is enabled, the query is logged to the slow query log file. This value is measured in real time, not CPU time, so a query that is under the threshold on a lightly loaded system might be above the threshold on a heavily loaded one.
    ...
    def mandatory_roles(self) -> Optional[builtins.str]:
        """
        ("mandatory_roles")
        """
    ...
    def max_binlog_cache_size(self) -> Optional[builtins.str]:
        """
    ...
    def max_connect_errors(self) -> Optional[builtins.str]:
        """
        ("max_connect_errors")
        """
    ...
    def max_execution_time(self) -> Optional[builtins.str]:
        """
        ("max_execution_time")
        """
    ...
    def max_heap_table_size(self) -> Optional[builtins.str]:
        """
    ...
    def max_prepared_stmt_count(self) -> Optional[builtins.int]:
        """
    ...
    def max_seeks_for_key(self) -> Optional[builtins.str]:
        """
    ...
    def max_user_connections(self) -> Optional[builtins.str]:
        """
    ...
    def mysql_firewall_mode(self) -> Optional[builtins.bool]:
        """
        ("mysql_firewall_mode")
        """
    ...
    def mysql_zstd_default_compression_level(self) -> Optional[builtins.int]:
        """
    ...
    def mysqlx_connect_timeout(self) -> Optional[builtins.int]:
        """
    ...
    def mysqlx_deflate_default_compression_level(self) -> Optional[builtins.int]:
        """
    ...
    def mysqlx_deflate_max_client_compression_level(self) -> Optional[builtins.int]:
        """
    ...
    def mysqlx_document_id_unique_prefix(self) -> Optional[builtins.int]:
        """
    ...
    def mysqlx_enable_hello_notice(self) -> Optional[builtins.bool]:
        """
    ...
    def mysqlx_idle_worker_thread_timeout(self) -> Optional[builtins.int]:
        """
    ...
    def mysqlx_interactive_timeout(self) -> Optional[builtins.int]:
        """
    ...
    def mysqlx_lz4default_compression_level(self) -> Optional[builtins.int]:
        """
    ...
    def mysqlx_lz4max_client_compression_level(self) -> Optional[builtins.int]:
        """
    ...
    def mysqlx_max_allowed_packet(self) -> Optional[builtins.int]:
        """
    ...
    def mysqlx_min_worker_threads(self) -> Optional[builtins.int]:
        """
    ...
    def mysqlx_read_timeout(self) -> Optional[builtins.int]:
        """
    ...
    def mysqlx_wait_timeout(self) -> Optional[builtins.int]:
        """
    ...
    def mysqlx_write_timeout(self) -> Optional[builtins.int]:
        """
    ...
    def mysqlx_zstd_default_compression_level(self) -> Optional[builtins.int]:
        """
    ...
    def mysqlx_zstd_max_client_compression_level(self) -> Optional[builtins.int]:
        """
    ...
    def optimizer_switch(self) -> Optional[builtins.str]:
        """
    ...
    def parser_max_mem_size(self) -> Optional[builtins.str]:
        """
        ("parser_max_mem_size")
        """
    ...
    def query_alloc_block_size(self) -> Optional[builtins.str]:
        """
    ...
    def query_prealloc_size(self) -> Optional[builtins.str]:
        """
    ...
    def range_optimizer_max_mem_size(self) -> Optional[builtins.str]:
        """
    ...
    def regexp_time_limit(self) -> Optional[builtins.int]:
        """
    ...
    def relay_log_space_limit(self) -> Optional[builtins.str]:
        """
    ...
    def replica_net_timeout(self) -> Optional[builtins.int]:
        """
    ...
    def replica_parallel_workers(self) -> Optional[builtins.int]:
        """
    ...
    def replica_type_conversions(self) -> Optional[builtins.str]:
        """
    ...
    def require_secure_transport(self) -> Optional[builtins.bool]:
        """
    ...
    def skip_name_resolve(self) -> Optional[builtins.bool]:
        """
        Whether to resolve host names when checking client connections. If this variable is OFF, mysqld resolves host names when checking client connections. If it is ON, mysqld uses only IP numbers; in this case, all Host column values in the grant tables must be IP addresses. See Section 7.1.12.3, “DNS Lookups and the Host Cache”.
    ...
    def sort_buffer_size(self) -> Optional[builtins.str]:
        """
    ...
    def sql_generate_invisible_primary_key(self) -> Optional[builtins.bool]:
        """
    ...
    def sql_warnings(self) -> Optional[builtins.bool]:
        """
        ("sql_warnings")
        """
    ...
    def table_definition_cache(self) -> Optional[builtins.int]:
        """
    ...
    def table_open_cache(self) -> Optional[builtins.int]:
        """
    ...
    def temptable_max_ram(self) -> Optional[builtins.str]:
        """
    ...
    def thread_pool_dedicated_listeners(self) -> Optional[builtins.bool]:
        """
    ...
    def thread_pool_max_transactions_limit(self) -> Optional[builtins.int]:
        """
    ...
    def thread_pool_query_threads_per_group(self) -> Optional[builtins.int]:
        """
    ...
    def thread_pool_size(self) -> Optional[builtins.int]:
        """
    ...
    def thread_pool_transaction_delay(self) -> Optional[builtins.int]:
        """
    ...
    def tmp_table_size(self) -> Optional[builtins.str]:
        """
    ...
    def transaction_isolation(self) -> Optional[builtins.str]:
        """
...
class MysqlDbSystemBackupPolicy(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Mapping[str, builtins.str] defined_tags: (Updatable) Usage of predefined tag keys. These predefined keys are scoped to namespaces.
               
               Tags defined here will be copied verbatim as tags on the Backup resource created by this BackupPolicy.
               
               Example: `{"foo-namespace.bar-key": "value"}`
        :param Mapping[str, builtins.str] freeform_tags: (Updatable) Simple key-value pair applied without any predefined name, type or scope. Exists for cross-compatibility only.
...
class MysqlDbSystemBackupPolicyCopyPolicy(dict):
    ...
    def __init__(__self__, *,
                 copy_to_region: builtins.str,
                 backup_copy_retention_in_days: Optional[builtins.int] = None):
        """
        :param builtins.str copy_to_region: (Updatable) The destination region name to which the DB system backup will be copied.
        :param builtins.int backup_copy_retention_in_days: (Updatable) Number of days to retain the copied DB system backup.
        """
        pulumi.set(__self__, "copy_to_region", copy_to_region)
        if backup_copy_retention_in_days is not None:
            pulumi.set(__self__, "backup_copy_retention_in_days", backup_copy_retention_in_days)
    ...
    @property
    @pulumi.getter(name="copyToRegion")
    def copy_to_region(self) -> builtins.str:
        """
...
class MysqlDbSystemBackupPolicyPitrPolicy(dict):
    ...
    def __init__(__self__, *,
                 is_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool is_enabled: (Updatable) Specifies if PITR is enabled or disabled.
        """
        if is_enabled is not None:
            pulumi.set(__self__, "is_enabled", is_enabled)
...
class MysqlDbSystemChannel(dict):
    ...
    def __init__(__self__, *,
        ...
        :param Mapping[str, builtins.str] defined_tags: (Updatable) Usage of predefined tag keys. These predefined keys are scoped to namespaces. Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str display_name: (Updatable) The user-friendly name for the DB System. It does not have to be unique.
        :param Mapping[str, builtins.str] freeform_tags: (Updatable) Simple key-value pair applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: The OCID of the DB System.
        :param builtins.bool is_enabled: Specifies if the DB System read endpoint is enabled or not.
        ...
        :param builtins.str state: (Updatable) The target state for the DB System. Could be set to `ACTIVE` or `INACTIVE`.
        ...
        :param builtins.str time_updated: The time the DB System was last updated.
        """
        if compartment_id is not None:
            pulumi.set(__self__, "compartment_id", compartment_id)
        if defined_tags is not None:
...
class MysqlDbSystemChannelSource(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str hostname: The network address of the DB System.
        :param builtins.int port: The port for primary endpoint of the DB System to listen on.
        :param builtins.str source_type: The specific source identifier. Use `BACKUP` for creating a new database by restoring from a backup. Use `IMPORTURL` for creating a new database from a URL Object Storage PAR.
        ...
        :param builtins.str username: The name of the replication user on the source MySQL instance. The username has a maximum length of 96 characters. For more information, please see the [MySQL documentation](https://dev.mysql.com/doc/refman/8.0/en/change-master-to.html)
        """
...
class MysqlDbSystemChannelSourceAnonymousTransactionsHandling(dict):
    ...
    def __init__(__self__, *,
                 ...
                 uuid: Optional[builtins.str] = None):
        """
        :param builtins.str last_configured_log_filename: Specifies one of the coordinates (file) at which the replica should begin reading the source's log. As this value specifies the point where replication starts from, it is only used once, when it starts. It is never used again, unless a new UpdateChannel operation modifies it.
        :param builtins.str last_configured_log_offset: Specifies one of the coordinates (offset) at which the replica should begin reading the source's log. As this value specifies the point where replication starts from, it is only used once, when it starts. It is never used again, unless a new UpdateChannel operation modifies it.
        :param builtins.str policy: Specifies how the replication channel handles anonymous transactions.
        :param builtins.str uuid: The UUID that is used as a prefix when generating transaction identifiers for anonymous transactions coming from the source. You can change the UUID later.
        """
        if last_configured_log_filename is not None:
            pulumi.set(__self__, "last_configured_log_filename", last_configured_log_filename)
        if last_configured_log_offset is not None:
...
class MysqlDbSystemChannelSourceSslCaCertificate(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str certificate_type: The type of CA certificate.
        :param builtins.str contents: The string containing the CA certificate in PEM format.
        """
...
class MysqlDbSystemChannelTarget(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str applier_username: The username for the replication applier of the target MySQL DB System.
        :param builtins.str channel_name: The case-insensitive name that identifies the replication channel. Channel names must follow the rules defined for [MySQL identifiers](https://dev.mysql.com/doc/refman/8.0/en/identifiers.html). The names of non-Deleted Channels must be unique for each DB System.
        :param builtins.str db_system_id: The OCID of the DB System from which a backup shall be selected to be restored when creating the new DB System. Use this together with recovery point to perform a point in time recovery operation.
        :param builtins.int delay_in_seconds: Specifies the amount of time, in seconds, that the channel waits before  applying a transaction received from the source.
        ...
        :param builtins.str tables_without_primary_key_handling: Specifies how a replication channel handles the creation and alteration of tables  that do not have a primary key.
        :param builtins.str target_type: The specific target identifier.
        """
        if applier_username is not None:
            pulumi.set(__self__, "applier_username", applier_username)
        if channel_name is not None:
...
class MysqlDbSystemChannelTargetFilter(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: The type of the filter rule.
        :param builtins.str value: The body of the filter rule. This can represent a database, a table, or a database pair (represented as "db1->db2"). For more information, see [Replication Filtering Rules](https://dev.mysql.com/doc/refman/8.0/en/replication-rules.html).
        """
        if type is not None:
            pulumi.set(__self__, "type", type)
...
class MysqlDbSystemCurrentPlacement(dict):
    ...
    def __init__(__self__, *,
                 ...
                 fault_domain: Optional[builtins.str] = None):
        """
        :param builtins.str availability_domain: The availability domain on which to deploy the Read/Write endpoint. This defines the preferred primary instance.
...
class MysqlDbSystemCustomerContact(dict):
    def __init__(__self__, *,
                 email: builtins.str):
        """
        :param builtins.str email: (Updatable) The email address used by Oracle to send notifications regarding the DB System.
        """
...
class MysqlDbSystemDataStorage(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.int allocated_storage_size_in_gbs: The actual allocated storage size for the DB System. This may be higher than dataStorageSizeInGBs if an automatic storage expansion has occurred.
        :param builtins.int data_storage_size_in_gb: (Updatable) Initial size of the data volume in GBs that will be created and attached. Keep in mind that this only specifies the size of the database data volume, the log volume for the database will be scaled appropriately with its shape. It is required if you are creating a new database. It cannot be set if you are creating a database from a backup.
        :param builtins.int data_storage_size_limit_in_gbs: The absolute limit the DB System's storage size may ever expand to, either manually or automatically. This limit is based based on the initial dataStorageSizeInGBs when the DB System was first created. Both dataStorageSizeInGBs and maxDataStorageSizeInGBs can not exceed this value.
        :param builtins.bool is_auto_expand_storage_enabled: (Updatable) Enable/disable automatic storage expansion. When set to true, the DB System will automatically add storage incrementally up to the value specified in maxStorageSizeInGBs.
        :param builtins.int max_storage_size_in_gbs: (Updatable) Maximum storage size this DB System can expand to. When isAutoExpandStorageEnabled is set to true, the DB System will add storage incrementally up to this value.
...
class MysqlDbSystemDeletionPolicy(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_delete_protected: Optional[builtins.bool] = None):
        """
        :param builtins.str automatic_backup_retention: (Updatable) Specifies if any automatic backups created for a DB System should be retained or deleted when the DB System is deleted.
        :param builtins.str final_backup: (Updatable) Specifies whether or not a backup is taken when the DB System is deleted. REQUIRE_FINAL_BACKUP: a backup is taken if the DB System is deleted. SKIP_FINAL_BACKUP: a backup is not taken if the DB System is deleted.
        :param builtins.bool is_delete_protected: (Updatable) Specifies whether the DB System can be deleted. Set to true to prevent deletion, false (default) to allow.
        """
        if automatic_backup_retention is not None:
            pulumi.set(__self__, "automatic_backup_retention", automatic_backup_retention)
        if final_backup is not None:
...
class MysqlDbSystemEndpoint(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str hostname: The network address of the DB System.
        :param builtins.str ip_address: The IP address the DB System is configured to listen on. A private IP address of your choice to assign to the primary endpoint of the DB System. Must be an available IP address within the subnet's CIDR. If you don't specify a value, Oracle automatically assigns a private IP address from the subnet. This should be a "dotted-quad" style IPv4 address.
        :param Sequence[builtins.str] modes: The access modes from the client that this endpoint supports.
        :param builtins.int port: The port for primary endpoint of the DB System to listen on.
...
class MysqlDbSystemHeatWaveCluster(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_lakehouse_enabled: Optional[builtins.bool] = None,
                 shape_name: Optional[builtins.str] = None,
                 state: Optional[builtins.str] = None,
                 time_created: Optional[builtins.str] = None,
                 time_updated: Optional[builtins.str] = None):
        """
        :param builtins.int cluster_size: The number of analytics-processing compute instances, of the specified shape, in the HeatWave cluster.
        :param builtins.bool is_lakehouse_enabled: Lakehouse enabled status for the HeatWave cluster.
        :param builtins.str shape_name: (Updatable) The name of the shape. The shape determines the resources allocated
    ...
    def is_lakehouse_enabled(self) -> Optional[builtins.bool]:
        """
...
class MysqlDbSystemMaintenance(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str window_start_time: (Updatable) The start of the 2 hour maintenance window.
...
class MysqlDbSystemPointInTimeRecoveryDetail(dict):
    ...
    def __init__(__self__, *,
                 time_earliest_recovery_point: Optional[builtins.str] = None,
                 time_latest_recovery_point: Optional[builtins.str] = None):
        """
        :param builtins.str time_earliest_recovery_point: Earliest recovery time point for the DB System, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        :param builtins.str time_latest_recovery_point: Latest recovery time point for the DB System, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        """
    ...
    def time_earliest_recovery_point(self) -> Optional[builtins.str]:
        """
    ...
    def time_latest_recovery_point(self) -> Optional[builtins.str]:
        """
...
class MysqlDbSystemReadEndpoint(dict):
    ...
    def __init__(__self__, *,
                 ...
                 read_endpoint_ip_address: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] exclude_ips: (Updatable) A list of IP addresses of read replicas that are excluded from serving read requests.
        :param builtins.bool is_enabled: (Updatable) Specifies if the DB System read endpoint is enabled or not.
        :param builtins.str read_endpoint_hostname_label: (Updatable) The hostname for the read endpoint of the DB System. Used for DNS.
               
               The value is the hostname portion of the primary private IP's fully qualified domain name (FQDN)  (for example, "dbsystem-1" in FQDN "dbsystem-1.subnet123.vcn1.oraclevcn.com").
               
               Must be unique across all VNICs in the subnet and comply with RFC 952 and RFC 1123.
        :param builtins.str read_endpoint_ip_address: (Updatable) The IP address the DB System read endpoint is configured to listen on. A private IP address of your choice to assign to the read endpoint of the DB System. Must be an available IP address within the subnet's CIDR. If you don't specify a value, Oracle automatically assigns a private IP address from the subnet. This should be a "dotted-quad" style IPv4 address.
        """
        if exclude_ips is not None:
            pulumi.set(__self__, "exclude_ips", exclude_ips)
        if is_enabled is not None:
...
class MysqlDbSystemSecureConnections(dict):
    ...
    def __init__(__self__, *,
                 ...
                 certificate_id: Optional[builtins.str] = None):
        """
        :param builtins.str certificate_generation_type: (Updatable) Select whether to use MySQL Database Service-managed certificate (SYSTEM) or your own certificate (BYOC).
        :param builtins.str certificate_id: (Updatable) The OCID of the certificate to use.
        """
        pulumi.set(__self__, "certificate_generation_type", certificate_generation_type)
        if certificate_id is not None:
            pulumi.set(__self__, "certificate_id", certificate_id)
    ...
    @property
    @pulumi.getter(name="certificateGenerationType")
    def certificate_generation_type(self) -> builtins.str:
        """
...
class MysqlDbSystemSource(dict):
    ...
    def recovery_point(self) -> Optional[builtins.str]:
        """
...
class GetChannelSourceResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str hostname: The network address of the MySQL instance.
        :param builtins.int port: The port the source MySQL instance listens on.
...
class GetChannelSourceAnonymousTransactionsHandlingResult(dict):
    def __init__(__self__, *,
                 last_configured_log_filename: builtins.str,
                 last_configured_log_offset: builtins.str,
                 policy: builtins.str,
                 uuid: builtins.str):
        """
        :param builtins.str last_configured_log_filename: Specifies one of the coordinates (file) at which the replica should begin reading the source's log. As this value specifies the point where replication starts from, it is only used once, when it starts. It is never used again, unless a new UpdateChannel operation modifies it.
    ...
    @property
    @pulumi.getter(name="lastConfiguredLogFilename")
    def last_configured_log_filename(self) -> builtins.str:
        """
        Specifies one of the coordinates (file) at which the replica should begin reading the source's log. As this value specifies the point where replication starts from, it is only used once, when it starts. It is never used again, unless a new UpdateChannel operation modifies it.
        """
        return pulumi.get(self, "last_configured_log_filename")
    ...
    @property
    @pulumi.getter(name="lastConfiguredLogOffset")
    def last_configured_log_offset(self) -> builtins.str:
        """
        Specifies one of the coordinates (offset) at which the replica should begin reading the source's log. As this value specifies the point where replication starts from, it is only used once, when it starts. It is never used again, unless a new UpdateChannel operation modifies it.
        """
        return pulumi.get(self, "last_configured_log_offset")
...
class GetChannelTargetResult(dict):
    def __init__(__self__, *,
                 applier_username: builtins.str,
                 channel_name: builtins.str,
                 db_system_id: builtins.str,
                 delay_in_seconds: builtins.int,
                 filters: Sequence['outputs.GetChannelTargetFilterResult'],
                 tables_without_primary_key_handling: builtins.str,
                 target_type: builtins.str):
        """
        :param builtins.str applier_username: The username for the replication applier of the target MySQL DB System.
        :param builtins.str channel_name: The case-insensitive name that identifies the replication channel. Channel names must follow the rules defined for [MySQL identifiers](https://dev.mysql.com/doc/refman/8.0/en/identifiers.html). The names of non-Deleted Channels must be unique for each DB System.
        :param builtins.str db_system_id: The OCID of the source DB System.
        :param builtins.int delay_in_seconds: Specifies the amount of time, in seconds, that the channel waits before  applying a transaction received from the source.
    ...
    @property
    @pulumi.getter(name="applierUsername")
    def applier_username(self) -> builtins.str:
        """
        The username for the replication applier of the target MySQL DB System.
        """
        return pulumi.get(self, "applier_username")
    ...
    @property
    @pulumi.getter(name="tablesWithoutPrimaryKeyHandling")
    def tables_without_primary_key_handling(self) -> builtins.str:
        """
        Specifies how a replication channel handles the creation and alteration of tables  that do not have a primary key.
        """
        return pulumi.get(self, "tables_without_primary_key_handling")
...
class GetChannelsChannelResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str description: User provided description of the Channel.
        :param builtins.str display_name: A filter to return only the resource matching the given display name exactly.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: The OCID of the Channel.
        :param builtins.bool is_enabled: If true, returns only Channels that are enabled. If false, returns only Channels that are disabled.
        :param builtins.str lifecycle_details: A message describing the state of the Channel.
        ...
        :param builtins.str state: The LifecycleState of the Channel.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param Sequence['GetChannelsChannelTargetArgs'] targets: Details about the Channel target.
        :param builtins.str time_created: The date and time the Channel was created, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        :param builtins.str time_updated: The time the Channel was last updated, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
        pulumi.set(__self__, "description", description)
...
class GetHeatWaveClusterClusterNodeResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str node_id: The ID of the node within MySQL HeatWave cluster.
        :param builtins.str state: The current state of the HeatWave cluster.
        :param builtins.str time_created: The date and time the HeatWave cluster was created, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        :param builtins.str time_updated: The time the HeatWave cluster was last updated, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        """
        pulumi.set(__self__, "node_id", node_id)
...
class GetMysqlBackupDbSystemSnapshotResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str compartment_id: The OCID of the compartment the DB System belongs in.
        :param builtins.str configuration_id: The OCID of the Configuration to be used for Instances in this DB System.
        :param builtins.str crash_recovery: Whether to run the DB System with InnoDB Redo Logs and the Double Write Buffer enabled or disabled, and whether to enable or disable syncing of the Binary Logs.
        :param builtins.int data_storage_size_in_gb: DEPRECATED: User specified size of the data volume. May be less than current allocatedStorageSizeInGBs. Replaced by dataStorage.dataStorageSizeInGBs.
    ...
    @property
    @pulumi.getter(name="crashRecovery")
    def crash_recovery(self) -> builtins.str:
        """
        Whether to run the DB System with InnoDB Redo Logs and the Double Write Buffer enabled or disabled, and whether to enable or disable syncing of the Binary Logs.
        """
        return pulumi.get(self, "crash_recovery")
    ...
    @property
    @pulumi.getter(name="databaseManagement")
    def database_management(self) -> builtins.str:
        """
        Whether to enable monitoring via the Database Management service.
        """
        return pulumi.get(self, "database_management")
    ...
    @property
    @pulumi.getter(name="mysqlVersion")
    def mysql_version(self) -> builtins.str:
        """
        The MySQL server version of the DB System used for backup.
        """
        return pulumi.get(self, "mysql_version")
...
class GetMysqlBackupDbSystemSnapshotBackupPolicyCopyPolicyResult(dict):
    def __init__(__self__, *,
                 backup_copy_retention_in_days: builtins.int,
                 copy_to_region: builtins.str):
        """
        :param builtins.int backup_copy_retention_in_days: Number of days to retain the copied DB system backup.
        :param builtins.str copy_to_region: The destination region name to which the DB system backup will be copied.
    ...
    @property
    @pulumi.getter(name="backupCopyRetentionInDays")
    def backup_copy_retention_in_days(self) -> builtins.int:
        """
        Number of days to retain the copied DB system backup.
        """
        return pulumi.get(self, "backup_copy_retention_in_days")
...
class GetMysqlBackupDbSystemSnapshotDataStorageResult(dict):
    def __init__(__self__, *,
                 ...
                 data_storage_size_in_gb: builtins.int,
                 data_storage_size_limit_in_gbs: builtins.int,
                 is_auto_expand_storage_enabled: builtins.bool,
                 max_storage_size_in_gbs: builtins.int):
        """
        :param builtins.int allocated_storage_size_in_gbs: The actual allocated storage size for the DB System. This may be higher than dataStorageSizeInGBs if an automatic storage expansion has occurred.
        :param builtins.int data_storage_size_in_gb: DEPRECATED: User specified size of the data volume. May be less than current allocatedStorageSizeInGBs. Replaced by dataStorage.dataStorageSizeInGBs.
        :param builtins.int data_storage_size_limit_in_gbs: The absolute limit the DB System's storage size may ever expand to, either manually or automatically. This limit is based based on the initial dataStorageSizeInGBs when the DB System was first created. Both dataStorageSizeInGBs and maxDataStorageSizeInGBs can not exceed this value.
    ...
    @property
    @pulumi.getter(name="dataStorageSizeLimitInGbs")
    def data_storage_size_limit_in_gbs(self) -> builtins.int:
        """
        The absolute limit the DB System's storage size may ever expand to, either manually or automatically. This limit is based based on the initial dataStorageSizeInGBs when the DB System was first created. Both dataStorageSizeInGBs and maxDataStorageSizeInGBs can not exceed this value.
        """
        return pulumi.get(self, "data_storage_size_limit_in_gbs")
    ...
    @property
    @pulumi.getter(name="isAutoExpandStorageEnabled")
    def is_auto_expand_storage_enabled(self) -> builtins.bool:
        """
        Enable/disable automatic storage expansion. When set to true, the DB System will automatically add storage incrementally up to the value specified in maxStorageSizeInGBs.
        """
        return pulumi.get(self, "is_auto_expand_storage_enabled")
    ...
    @property
    @pulumi.getter(name="maxStorageSizeInGbs")
    def max_storage_size_in_gbs(self) -> builtins.int:
        """
        Maximum storage size this DB System can expand to. When isAutoExpandStorageEnabled is set to true, the DB System will add storage incrementally up to this value.
        """
        return pulumi.get(self, "max_storage_size_in_gbs")
...
class GetMysqlBackupDbSystemSnapshotDeletionPolicyResult(dict):
    def __init__(__self__, *,
                 automatic_backup_retention: builtins.str,
                 final_backup: builtins.str,
    ...
    @property
    @pulumi.getter(name="automaticBackupRetention")
    def automatic_backup_retention(self) -> builtins.str:
        """
        Specifies if any automatic backups created for a DB System should be retained or deleted when the DB System is deleted.
        """
        return pulumi.get(self, "automatic_backup_retention")
    ...
    @property
    @pulumi.getter(name="finalBackup")
    def final_backup(self) -> builtins.str:
        """
        Specifies whether or not a backup is taken when the DB System is deleted. REQUIRE_FINAL_BACKUP: a backup is taken if the DB System is deleted. SKIP_FINAL_BACKUP: a backup is not taken if the DB System is deleted.
        """
        return pulumi.get(self, "final_backup")
    ...
    @property
    @pulumi.getter(name="isDeleteProtected")
    def is_delete_protected(self) -> builtins.bool:
        """
        Specifies whether the DB System can be deleted. Set to true to prevent deletion, false (default) to allow.
        """
        return pulumi.get(self, "is_delete_protected")
...
class GetMysqlBackupDbSystemSnapshotReadEndpointResult(dict):
    def __init__(__self__, *,
                 exclude_ips: Sequence[builtins.str],
                 is_enabled: builtins.bool,
                 read_endpoint_hostname_label: builtins.str,
                 read_endpoint_ip_address: builtins.str):
        """
        :param Sequence[builtins.str] exclude_ips: A list of IP addresses of read replicas that are excluded from serving read requests.
        :param builtins.bool is_enabled: Specifies if the DB System read endpoint is enabled or not.
        :param builtins.str read_endpoint_hostname_label: The hostname for the read endpoint of the DB System. Used for DNS.
    ...
    @property
    @pulumi.getter(name="excludeIps")
    def exclude_ips(self) -> Sequence[builtins.str]:
        """
        A list of IP addresses of read replicas that are excluded from serving read requests.
        """
        return pulumi.get(self, "exclude_ips")
    ...
    @property
    @pulumi.getter(name="readEndpointHostnameLabel")
    def read_endpoint_hostname_label(self) -> builtins.str:
        """
        The hostname for the read endpoint of the DB System. Used for DNS.
        """
        return pulumi.get(self, "read_endpoint_hostname_label")
    ...
    @property
    @pulumi.getter(name="readEndpointIpAddress")
    def read_endpoint_ip_address(self) -> builtins.str:
        """
        The IP address the DB System read endpoint is configured to listen on. A private IP address of your choice to assign to the read endpoint of the DB System. Must be an available IP address within the subnet's CIDR. If you don't specify a value, Oracle automatically assigns a private IP address from the subnet. This should be a "dotted-quad" style IPv4 address.
        """
        return pulumi.get(self, "read_endpoint_ip_address")
...
class GetMysqlBackupSourceDetailResult(dict):
    def __init__(__self__, *,
                 ...
                 region: builtins.str):
        """
        :param builtins.str backup_id: The OCID of the Backup
        :param builtins.str compartment_id: The OCID of the compartment the DB System belongs in.
        :param builtins.str region: The region identifier of the region where the DB system exists. For more information, please see [Regions and Availability Domains](https://docs.oracle.com/en-us/iaas/Content/General/Concepts/regions.htm).
        """
        pulumi.set(__self__, "backup_id", backup_id)
...
class GetMysqlBackupsBackupResult(dict):
    def __init__(__self__, *,
                 backup_size_in_gbs: builtins.int,
                 ...
                 state: builtins.str,
                 system_tags: Mapping[str, builtins.str],
                 time_copy_created: builtins.str,
                 time_created: builtins.str,
                 time_updated: builtins.str):
        """
        :param builtins.int backup_size_in_gbs: The size of the backup in base-2 (IEC) gibibytes. (GiB).
        :param builtins.str backup_type: The type of backup.
        :param builtins.str compartment_id: The compartment [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        ...
        :param builtins.str time_created: The time the backup record was created.
        :param builtins.str time_updated: The time at which the backup was updated.
        """
    ...
    def backup_size_in_gbs(self) -> builtins.int:
        """
    ...
    def immediate_source_backup_id(self) -> builtins.str:
        """
    ...
    def original_source_backup_id(self) -> builtins.str:
        """
    ...
    def time_copy_created(self) -> builtins.str:
        """
...
class GetMysqlConfigurationInitVariableResult(dict):
    def __init__(__self__, *,
                 lower_case_table_names: builtins.str):
        """
        :param builtins.str lower_case_table_names: Represents the MySQL server system variable lower_case_table_names (https://dev.mysql.com/doc/refman/8.0/en/server-system-variables.html#sysvar_lower_case_table_names).
        """
        pulumi.set(__self__, "lower_case_table_names", lower_case_table_names)
...
class GetMysqlConfigurationVariableResult(dict):
    def __init__(__self__, *,
                 auto_increment_increment: builtins.int,
                 auto_increment_offset: builtins.int,
                 autocommit: builtins.bool,
                 big_tables: builtins.bool,
                 binlog_expire_logs_seconds: builtins.int,
                 binlog_group_commit_sync_delay: builtins.int,
                 binlog_group_commit_sync_no_delay_count: builtins.int,
                 binlog_row_metadata: builtins.str,
                 binlog_row_value_options: builtins.str,
                 binlog_transaction_compression: builtins.bool,
                 block_encryption_mode: builtins.str,
                 character_set_server: builtins.str,
                 collation_server: builtins.str,
                 completion_type: builtins.str,
                 connect_timeout: builtins.int,
                 connection_memory_chunk_size: builtins.int,
                 connection_memory_limit: builtins.str,
                 cte_max_recursion_depth: builtins.str,
                 default_authentication_plugin: builtins.str,
                 explain_format: builtins.str,
                 explicit_defaults_for_timestamp: builtins.bool,
                 foreign_key_checks: builtins.bool,
                 generated_random_password_length: builtins.int,
                 global_connection_memory_limit: builtins.str,
                 global_connection_memory_tracking: builtins.bool,
                 group_concat_max_len: builtins.str,
                 group_replication_consistency: builtins.str,
                 information_schema_stats_expiry: builtins.int,
                 innodb_adaptive_hash_index: builtins.bool,
                 innodb_autoinc_lock_mode: builtins.int,
                 innodb_buffer_pool_dump_pct: builtins.int,
                 innodb_buffer_pool_instances: builtins.int,
                 innodb_buffer_pool_size: builtins.str,
                 innodb_change_buffering: builtins.str,
                 innodb_ddl_buffer_size: builtins.str,
                 innodb_ddl_threads: builtins.int,
                 innodb_ft_enable_stopword: builtins.bool,
                 innodb_ft_max_token_size: builtins.int,
                 innodb_ft_min_token_size: builtins.int,
                 innodb_ft_num_word_optimize: builtins.int,
                 innodb_ft_result_cache_limit: builtins.str,
                 innodb_ft_server_stopword_table: builtins.str,
                 innodb_lock_wait_timeout: builtins.int,
                 innodb_log_writer_threads: builtins.bool,
                 innodb_max_purge_lag: builtins.str,
                 innodb_max_purge_lag_delay: builtins.int,
                 innodb_numa_interleave: builtins.bool,
                 innodb_online_alter_log_max_size: builtins.str,
                 innodb_redo_log_capacity: builtins.str,
                 innodb_rollback_on_timeout: builtins.bool,
                 innodb_sort_buffer_size: builtins.int,
                 innodb_stats_persistent_sample_pages: builtins.str,
                 innodb_stats_transient_sample_pages: builtins.str,
                 innodb_strict_mode: builtins.bool,
                 innodb_undo_log_truncate: builtins.bool,
                 interactive_timeout: builtins.int,
                 join_buffer_size: builtins.str,
                 local_infile: builtins.bool,
                 long_query_time: builtins.int,
                 mandatory_roles: builtins.str,
                 max_allowed_packet: builtins.int,
                 max_binlog_cache_size: builtins.str,
                 max_connect_errors: builtins.str,
                 max_connections: builtins.int,
                 max_execution_time: builtins.str,
                 max_heap_table_size: builtins.str,
                 max_prepared_stmt_count: builtins.int,
                 max_seeks_for_key: builtins.str,
                 max_user_connections: builtins.str,
                 mysql_firewall_mode: builtins.bool,
                 mysql_zstd_default_compression_level: builtins.int,
                 mysqlx_connect_timeout: builtins.int,
                 mysqlx_deflate_default_compression_level: builtins.int,
                 mysqlx_deflate_max_client_compression_level: builtins.int,
                 mysqlx_document_id_unique_prefix: builtins.int,
                 mysqlx_enable_hello_notice: builtins.bool,
                 mysqlx_idle_worker_thread_timeout: builtins.int,
                 mysqlx_interactive_timeout: builtins.int,
                 mysqlx_lz4default_compression_level: builtins.int,
                 mysqlx_lz4max_client_compression_level: builtins.int,
                 mysqlx_max_allowed_packet: builtins.int,
                 mysqlx_min_worker_threads: builtins.int,
                 mysqlx_read_timeout: builtins.int,
                 mysqlx_wait_timeout: builtins.int,
                 mysqlx_write_timeout: builtins.int,
                 mysqlx_zstd_default_compression_level: builtins.int,
                 mysqlx_zstd_max_client_compression_level: builtins.int,
                 net_read_timeout: builtins.int,
                 net_write_timeout: builtins.int,
                 optimizer_switch: builtins.str,
                 parser_max_mem_size: builtins.str,
                 query_alloc_block_size: builtins.str,
                 query_prealloc_size: builtins.str,
                 range_optimizer_max_mem_size: builtins.str,
                 regexp_time_limit: builtins.int,
                 relay_log_space_limit: builtins.str,
                 replica_net_timeout: builtins.int,
                 replica_parallel_workers: builtins.int,
                 replica_type_conversions: builtins.str,
                 require_secure_transport: builtins.bool,
                 skip_name_resolve: builtins.bool,
                 sort_buffer_size: builtins.str,
                 sql_generate_invisible_primary_key: builtins.bool,
                 sql_mode: builtins.str,
                 sql_require_primary_key: builtins.bool,
                 sql_warnings: builtins.bool,
                 table_definition_cache: builtins.int,
                 table_open_cache: builtins.int,
                 temptable_max_ram: builtins.str,
                 thread_pool_dedicated_listeners: builtins.bool,
                 thread_pool_max_transactions_limit: builtins.int,
                 thread_pool_query_threads_per_group: builtins.int,
                 thread_pool_size: builtins.int,
                 thread_pool_transaction_delay: builtins.int,
                 time_zone: builtins.str,
                 tmp_table_size: builtins.str,
                 transaction_isolation: builtins.str,
    ...
    @property
    @pulumi.getter(name="autoIncrementIncrement")
    def auto_increment_increment(self) -> builtins.int:
        """
        auto_increment_increment and auto_increment_offset are intended for use with circular (source-to-source) replication, and can be used to control the operation of AUTO_INCREMENT columns. Both variables have global and session values, and each can assume an integer value between 1 and 65,535 inclusive.
        """
        return pulumi.get(self, "auto_increment_increment")
    ...
    @property
    @pulumi.getter(name="autoIncrementOffset")
    def auto_increment_offset(self) -> builtins.int:
        """
        This variable has a default value of 1. If it is left with its default value, and Group Replication is started on the server in multi-primary mode, it is changed to the server ID.
        """
        return pulumi.get(self, "auto_increment_offset")
    ...
    @property
    @pulumi.getter
    def autocommit(self) -> builtins.bool:
        """
        ("autocommit")
        """
        return pulumi.get(self, "autocommit")
    ...
    @property
    @pulumi.getter(name="bigTables")
    def big_tables(self) -> builtins.bool:
        """
        If enabled, the server stores all temporary tables on disk rather than in memory.
        """
        return pulumi.get(self, "big_tables")
    ...
    @property
    @pulumi.getter(name="binlogExpireLogsSeconds")
    def binlog_expire_logs_seconds(self) -> builtins.int:
        """
        Sets the binary log expiration period in seconds. binlogExpireLogsSeconds corresponds to the MySQL binary logging system variable [binlog_expire_logs_seconds](https://dev.mysql.com/doc/refman/8.0/en/replication-options-binary-log.html#sysvar_binlog_expire_logs_seconds).
        """
        return pulumi.get(self, "binlog_expire_logs_seconds")
    ...
    @property
    @pulumi.getter(name="binlogGroupCommitSyncDelay")
    def binlog_group_commit_sync_delay(self) -> builtins.int:
        """
        Controls how many microseconds the binary log commit waits before synchronizing the binary log file to disk. There is no delay by default. Setting this variable to a microsecond delay enables more transactions to be synchronized together to disk at once, reducing the overall time to commit a group of transactions because the larger groups required fewer time units per group.
        """
        return pulumi.get(self, "binlog_group_commit_sync_delay")
    ...
    @property
    @pulumi.getter(name="binlogGroupCommitSyncNoDelayCount")
    def binlog_group_commit_sync_no_delay_count(self) -> builtins.int:
        """
        The maximum number of transactions to wait for before aborting the current delay as specified by binlog_group_commit_sync_delay. If binlog_group_commit_sync_delay is set to 0, then this option has no effect.
        """
        return pulumi.get(self, "binlog_group_commit_sync_no_delay_count")
    ...
    @property
    @pulumi.getter(name="binlogRowMetadata")
    def binlog_row_metadata(self) -> builtins.str:
        """
        Configures the amount of table metadata added to the binary log when using row-based logging. binlogRowMetadata corresponds to the MySQL binary logging system variable [binlog_row_metadata](https://dev.mysql.com/doc/refman/8.0/en/replication-options-binary-log.html#sysvar_binlog_row_metadata).
        """
        return pulumi.get(self, "binlog_row_metadata")
    ...
    @property
    @pulumi.getter(name="binlogRowValueOptions")
    def binlog_row_value_options(self) -> builtins.str:
        """
        When set to PARTIAL_JSON, this enables use of a space-efficient binary log format for updates that modify only a small portion of a JSON document. binlogRowValueOptions corresponds to the MySQL binary logging system variable [binlog_row_value_options](https://dev.mysql.com/doc/refman/8.0/en/replication-options-binary-log.html#sysvar_binlog_row_value_options).
        """
        return pulumi.get(self, "binlog_row_value_options")
    ...
    @property
    @pulumi.getter(name="binlogTransactionCompression")
    def binlog_transaction_compression(self) -> builtins.bool:
        """
        Enables compression for transactions that are written to binary log files on this server. binlogTransactionCompression corresponds to the MySQL binary logging system variable [binlog_transaction_compression](https://dev.mysql.com/doc/refman/8.0/en/replication-options-binary-log.html#sysvar_binlog_transaction_compression).
        """
        return pulumi.get(self, "binlog_transaction_compression")
    ...
    @property
    @pulumi.getter(name="blockEncryptionMode")
    def block_encryption_mode(self) -> builtins.str:
        """
        This variable controls the block encryption mode for block-based algorithms such as AES. It affects encryption for AES_ENCRYPT() and AES_DECRYPT(). block_encryption_mode takes a value in aes-keylen-mode format, where keylen is the key length in bits and mode is the encryption mode. The value is not case-sensitive. Permitted keylen values are 128, 192, and 256. Permitted mode values are ECB, CBC, CFB1, CFB8, CFB128, and OFB.
        """
        return pulumi.get(self, "block_encryption_mode")
    ...
    @property
    @pulumi.getter(name="characterSetServer")
    def character_set_server(self) -> builtins.str:
        """
        The server's default character set. If you set this variable, you should also set collation_server to specify the collation for the character set.
        """
        return pulumi.get(self, "character_set_server")
    ...
    @property
    @pulumi.getter(name="collationServer")
    def collation_server(self) -> builtins.str:
        """
        The server's default collation.
        """
        return pulumi.get(self, "collation_server")
    ...
    @property
    @pulumi.getter(name="completionType")
    def completion_type(self) -> builtins.str:
        """
        ("completion_type")
        """
        return pulumi.get(self, "completion_type")
    ...
    @property
    @pulumi.getter(name="connectionMemoryChunkSize")
    def connection_memory_chunk_size(self) -> builtins.int:
        """
        Set the chunking size for updates to the global memory usage counter Global_connection_memory.
        """
        return pulumi.get(self, "connection_memory_chunk_size")
    ...
    @property
    @pulumi.getter(name="connectionMemoryLimit")
    def connection_memory_limit(self) -> builtins.str:
        """
        Set the maximum amount of memory that can be used by a single user connection.
        """
        return pulumi.get(self, "connection_memory_limit")
    ...
    @property
    @pulumi.getter(name="cteMaxRecursionDepth")
    def cte_max_recursion_depth(self) -> builtins.str:
        """
        ("cte_max_recursion_depth")
        """
        return pulumi.get(self, "cte_max_recursion_depth")
    ...
    @property
    @pulumi.getter(name="defaultAuthenticationPlugin")
    def default_authentication_plugin(self) -> builtins.str:
        """
        The default authentication plugin. This must be a plugin that uses internal credentials storage, so these values are permitted: mysql_native_password, sha256_password, caching_sha2_password.
        """
        return pulumi.get(self, "default_authentication_plugin")
    ...
    @property
    @pulumi.getter(name="explainFormat")
    def explain_format(self) -> builtins.str:
        """
        This variable determines the default output format used by EXPLAIN in the absence of a FORMAT option when displaying a query execution plan.
        """
        return pulumi.get(self, "explain_format")
    ...
    @property
    @pulumi.getter(name="explicitDefaultsForTimestamp")
    def explicit_defaults_for_timestamp(self) -> builtins.bool:
        """
        This system variable determines whether the server enables certain nonstandard behaviors for default values and NULL-value handling in TIMESTAMP columns. By default, explicit_defaults_for_timestamp is enabled, which disables the nonstandard behaviors. Disabling explicit_defaults_for_timestamp results in a warning.
        """
        return pulumi.get(self, "explicit_defaults_for_timestamp")
    ...
    @property
    @pulumi.getter(name="foreignKeyChecks")
    def foreign_key_checks(self) -> builtins.bool:
        """
        ("foreign_key_checks")
        """
        return pulumi.get(self, "foreign_key_checks")
    ...
    @pulumi.getter(name="generatedRandomPasswordLength")
    @_utilities.deprecated("""The 'generated_random_password_length' field has been deprecated and may be removed in a future version. Do not use this field.""")
    def generated_random_password_length(self) -> builtins.int:
        """
        ("generated_random_password_length") DEPRECATED -- variable should not be settable and will be ignored
        """
        return pulumi.get(self, "generated_random_password_length")
    ...
    @property
    @pulumi.getter(name="globalConnectionMemoryLimit")
    def global_connection_memory_limit(self) -> builtins.str:
        """
        Set the total amount of memory that can be used by all user connections.
        """
        return pulumi.get(self, "global_connection_memory_limit")
    ...
    @property
    @pulumi.getter(name="globalConnectionMemoryTracking")
    def global_connection_memory_tracking(self) -> builtins.bool:
        """
        Determines whether the MySQL server calculates Global_connection_memory.
        """
        return pulumi.get(self, "global_connection_memory_tracking")
    ...
    @property
    @pulumi.getter(name="groupConcatMaxLen")
    def group_concat_max_len(self) -> builtins.str:
        """
        Specifies the maximum permitted result length in bytes for the GROUP_CONCAT() function.
        """
        return pulumi.get(self, "group_concat_max_len")
    ...
    @property
    @pulumi.getter(name="groupReplicationConsistency")
    def group_replication_consistency(self) -> builtins.str:
        """
        * EVENTUAL: Both RO and RW transactions do not wait for preceding transactions to be applied before executing. A RW transaction does not wait for other members to apply a transaction. This means that a transaction could be externalized on one member before the others. This also means that in the event of a primary failover, the new primary can accept new RO and RW transactions before the previous primary transactions are all applied. RO transactions could result in outdated values, RW transactions could result in a rollback due to conflicts.
        * BEFORE_ON_PRIMARY_FAILOVER: New RO or RW transactions with a newly elected primary that is applying backlog from the old primary are held (not applied) until any backlog has been applied. This ensures that when a primary failover happens, intentionally or not, clients always see the latest value on the primary. This guarantees consistency, but means that clients must be able to handle the delay in the event that a backlog is being applied. Usually this delay should be minimal, but does depend on the size of the backlog.
        * BEFORE: A RW transaction waits for all preceding transactions to complete before being applied. A RO transaction waits for all preceding transactions to complete before being executed. This ensures that this transaction reads the latest value by only affecting the latency of the transaction. This reduces the overhead of synchronization on every RW transaction, by ensuring synchronization is used only on RO transactions. This consistency level also includes the consistency guarantees provided by BEFORE_ON_PRIMARY_FAILOVER.
    ...
    @property
    @pulumi.getter(name="informationSchemaStatsExpiry")
    def information_schema_stats_expiry(self) -> builtins.int:
        """
        ("information_schema_stats_expiry")
        """
        return pulumi.get(self, "information_schema_stats_expiry")
    ...
    @property
    @pulumi.getter(name="innodbAdaptiveHashIndex")
    def innodb_adaptive_hash_index(self) -> builtins.bool:
        """
        Whether the InnoDB adaptive hash index is enabled or disabled. It may be desirable, depending on your workload, to dynamically enable or disable adaptive hash indexing to improve query performance. Because the adaptive hash index may not be useful for all workloads, conduct benchmarks with it both enabled and disabled, using realistic workloads.
        """
        return pulumi.get(self, "innodb_adaptive_hash_index")
    ...
    @property
    @pulumi.getter(name="innodbAutoincLockMode")
    def innodb_autoinc_lock_mode(self) -> builtins.int:
        """
        The lock mode to use for generating auto-increment values. Permissible values are 0, 1, or 2, for traditional, consecutive, or interleaved, respectively.
        """
        return pulumi.get(self, "innodb_autoinc_lock_mode")
    ...
    @property
    @pulumi.getter(name="innodbBufferPoolDumpPct")
    def innodb_buffer_pool_dump_pct(self) -> builtins.int:
        """
        Specifies the percentage of the most recently used pages for each buffer pool to read out and dump.
        """
        return pulumi.get(self, "innodb_buffer_pool_dump_pct")
    ...
    @property
    @pulumi.getter(name="innodbBufferPoolInstances")
    def innodb_buffer_pool_instances(self) -> builtins.int:
        """
        ("innodb_buffer_pool_instances")
        """
        return pulumi.get(self, "innodb_buffer_pool_instances")
    ...
    @property
    @pulumi.getter(name="innodbBufferPoolSize")
    def innodb_buffer_pool_size(self) -> builtins.str:
        """
        The size (in bytes) of the buffer pool, that is, the memory area where InnoDB caches table and index data.
        """
        return pulumi.get(self, "innodb_buffer_pool_size")
    ...
    @property
    @pulumi.getter(name="innodbChangeBuffering")
    def innodb_change_buffering(self) -> builtins.str:
        """
        Whether InnoDB performs change buffering, an optimization that delays write operations to secondary indexes so that the I/O operations can be performed sequentially. Permitted values are described in the following table. Values may also be specified numerically.
        """
        return pulumi.get(self, "innodb_change_buffering")
    ...
    @property
    @pulumi.getter(name="innodbDdlBufferSize")
    def innodb_ddl_buffer_size(self) -> builtins.str:
        """
        innodbDdlBufferSize corresponds to the MySQL system variable [innodb_ddl_buffer_size] (https://dev.mysql.com/doc/refman/8.0/en/innodb-parameters.html#sysvar_innodb_ddl_buffer_size)
        """
        return pulumi.get(self, "innodb_ddl_buffer_size")
    ...
    @property
    @pulumi.getter(name="innodbDdlThreads")
    def innodb_ddl_threads(self) -> builtins.int:
        """
        innodbDdlThreads corresponds to the MySQL system variable [innodb_ddl_threads] (https://dev.mysql.com/doc/refman/8.0/en/innodb-parameters.html#sysvar_innodb_ddl_threads)
        """
        return pulumi.get(self, "innodb_ddl_threads")
    ...
    @property
    @pulumi.getter(name="innodbFtEnableStopword")
    def innodb_ft_enable_stopword(self) -> builtins.bool:
        """
        ("innodb_ft_enable_stopword")
        """
        return pulumi.get(self, "innodb_ft_enable_stopword")
    ...
    @property
    @pulumi.getter(name="innodbFtMaxTokenSize")
    def innodb_ft_max_token_size(self) -> builtins.int:
        """
        ("innodb_ft_max_token_size")
        """
        return pulumi.get(self, "innodb_ft_max_token_size")
    ...
    @property
    @pulumi.getter(name="innodbFtMinTokenSize")
    def innodb_ft_min_token_size(self) -> builtins.int:
        """
        ("innodb_ft_min_token_size")
        """
        return pulumi.get(self, "innodb_ft_min_token_size")
    ...
    @property
    @pulumi.getter(name="innodbFtNumWordOptimize")
    def innodb_ft_num_word_optimize(self) -> builtins.int:
        """
        ("innodb_ft_num_word_optimize")
        """
        return pulumi.get(self, "innodb_ft_num_word_optimize")
    ...
    @property
    @pulumi.getter(name="innodbFtResultCacheLimit")
    def innodb_ft_result_cache_limit(self) -> builtins.str:
        """
        ("innodb_ft_result_cache_limit")
        """
        return pulumi.get(self, "innodb_ft_result_cache_limit")
    ...
    @property
    @pulumi.getter(name="innodbLockWaitTimeout")
    def innodb_lock_wait_timeout(self) -> builtins.int:
        """
        ("innodb_lock_wait_timeout")
        """
        return pulumi.get(self, "innodb_lock_wait_timeout")
    ...
    @property
    @pulumi.getter(name="innodbLogWriterThreads")
    def innodb_log_writer_threads(self) -> builtins.bool:
        """
        Enables dedicated log writer threads for writing redo log records from the log buffer to the system buffers and flushing the system buffers to the redo log files.
        """
        return pulumi.get(self, "innodb_log_writer_threads")
    ...
    @property
    @pulumi.getter(name="innodbMaxPurgeLag")
    def innodb_max_purge_lag(self) -> builtins.str:
        """
        The desired maximum purge lag in terms of transactions.
        """
        return pulumi.get(self, "innodb_max_purge_lag")
    ...
    @property
    @pulumi.getter(name="innodbMaxPurgeLagDelay")
    def innodb_max_purge_lag_delay(self) -> builtins.int:
        """
        The maximum delay in microseconds for the delay imposed when the innodb_max_purge_lag threshold is exceeded.
        """
        return pulumi.get(self, "innodb_max_purge_lag_delay")
    ...
    @property
    @pulumi.getter(name="innodbNumaInterleave")
    def innodb_numa_interleave(self) -> builtins.bool:
        """
        Enables the NUMA interleave memory policy for allocation of the InnoDB buffer pool. When innodb_numa_interleave is enabled, the NUMA memory policy is set to MPOL_INTERLEAVE for the mysqld process. After the InnoDB buffer pool is allocated, the NUMA memory policy is set back to MPOL_DEFAULT. For the innodb_numa_interleave option to be available, MySQL must be compiled on a NUMA-enabled Linux system.
        """
        return pulumi.get(self, "innodb_numa_interleave")
    ...
    @property
    @pulumi.getter(name="innodbOnlineAlterLogMaxSize")
    def innodb_online_alter_log_max_size(self) -> builtins.str:
        """
        Specifies an upper limit in bytes on the size of the temporary log files used during online DDL operations for InnoDB tables. There is one such log file for each index being created or table being altered. This log file stores data inserted, updated, or deleted in the table during the DDL operation.
        """
        return pulumi.get(self, "innodb_online_alter_log_max_size")
    ...
    @property
    @pulumi.getter(name="innodbRedoLogCapacity")
    def innodb_redo_log_capacity(self) -> builtins.str:
        """
        Defines the amount of disk space occupied by redo log files. innodb_redo_log_capacity supercedes the innodb_log_files_in_group and innodb_log_file_size variables, which are both ignored if innodb_redo_log_capacity is defined. If innodb_redo_log_capacity is not defined, and if neither innodb_log_file_size or innodb_log_files_in_group are defined, then the default innodb_redo_log_capacity value is used.
        """
        return pulumi.get(self, "innodb_redo_log_capacity")
    ...
    @property
    @pulumi.getter(name="innodbRollbackOnTimeout")
    def innodb_rollback_on_timeout(self) -> builtins.bool:
        """
        InnoDB rolls back only the last statement on a transaction timeout by default. If --innodb-rollback-on-timeout is specified, a transaction timeout causes InnoDB to abort and roll back the entire transaction.
        """
        return pulumi.get(self, "innodb_rollback_on_timeout")
    ...
    @property
    @pulumi.getter(name="innodbSortBufferSize")
    def innodb_sort_buffer_size(self) -> builtins.int:
        """
        This variable defines:
        * The sort buffer size for online DDL operations that create or rebuild secondary indexes. However, as of MySQL 8.0.27, this responsibility is subsumed by the innodb_ddl_buffer_size variable.
        * The amount by which the temporary log file is extended when recording concurrent DML during an online DDL operation, and the size of the temporary log file read buffer and write buffer.
    ...
    @property
    @pulumi.getter(name="innodbStatsPersistentSamplePages")
    def innodb_stats_persistent_sample_pages(self) -> builtins.str:
        """
        The number of index pages to sample when estimating cardinality and other statistics for an indexed column, such as those calculated by ANALYZE TABLE.
        """
        return pulumi.get(self, "innodb_stats_persistent_sample_pages")
    ...
    @property
    @pulumi.getter(name="innodbStatsTransientSamplePages")
    def innodb_stats_transient_sample_pages(self) -> builtins.str:
        """
        The number of index pages to sample when estimating cardinality and other statistics for an indexed column, such as those calculated by [ANALYZE TABLE](https://dev.mysql.com/doc/refman/8.0/en/analyze-table.html).
        """
        return pulumi.get(self, "innodb_stats_transient_sample_pages")
    ...
    @property
    @pulumi.getter(name="innodbStrictMode")
    def innodb_strict_mode(self) -> builtins.bool:
        """
        When you enable innodbStrictMode, the InnoDB storage engine returns errors instead of warnings for invalid or incompatible table options.
        """
        return pulumi.get(self, "innodb_strict_mode")
    ...
    @property
    @pulumi.getter(name="innodbUndoLogTruncate")
    def innodb_undo_log_truncate(self) -> builtins.bool:
        """
        When enabled, undo tablespaces that exceed the threshold value defined by innodb_max_undo_log_size are marked for truncation. Only undo tablespaces can be truncated. Truncating undo logs that reside in the system tablespace is not supported. For truncation to occur, there must be at least two undo tablespaces.
        """
        return pulumi.get(self, "innodb_undo_log_truncate")
    ...
    @property
    @pulumi.getter(name="interactiveTimeout")
    def interactive_timeout(self) -> builtins.int:
        """
        The number of seconds the server waits for activity on an interactive connection before closing it.
        """
        return pulumi.get(self, "interactive_timeout")
    ...
    @property
    @pulumi.getter(name="joinBufferSize")
    def join_buffer_size(self) -> builtins.str:
        """
        The minimum size of the buffer that is used for plain index scans, range index scans, and joins that do not use indexes and thus perform full table scans. In MySQL 8.0.18 and later, this variable also controls the amount of memory used for hash joins. Normally, the best way to get fast joins is to add indexes. Increase the value of join_buffer_size to get a faster full join when adding indexes is not possible. One join buffer is allocated for each full join between two tables. For a complex join between several tables for which indexes are not used, multiple join buffers might be necessary.
        """
        return pulumi.get(self, "join_buffer_size")
    ...
    @property
    @pulumi.getter(name="localInfile")
    def local_infile(self) -> builtins.bool:
        """
        This variable controls server-side LOCAL capability for LOAD DATA statements. Depending on the local_infile setting, the server refuses or permits local data loading by clients that have LOCAL enabled on the client side.
        """
        return pulumi.get(self, "local_infile")
    ...
    @property
    @pulumi.getter(name="longQueryTime")
    def long_query_time(self) -> builtins.int:
        """
        If a query takes longer than this many seconds, the server increments the Slow_queries status variable. If the slow query log is enabled, the query is logged to the slow query log file. This value is measured in real time, not CPU time, so a query that is under the threshold on a lightly loaded system might be above the threshold on a heavily loaded one.
        """
        return pulumi.get(self, "long_query_time")
    ...
    @property
    @pulumi.getter(name="mandatoryRoles")
    def mandatory_roles(self) -> builtins.str:
        """
        ("mandatory_roles")
        """
        return pulumi.get(self, "mandatory_roles")
    ...
    @property
    @pulumi.getter(name="maxAllowedPacket")
    def max_allowed_packet(self) -> builtins.int:
        """
        The maximum size of one packet or any generated/intermediate string.
        """
        return pulumi.get(self, "max_allowed_packet")
    ...
    @property
    @pulumi.getter(name="maxBinlogCacheSize")
    def max_binlog_cache_size(self) -> builtins.str:
        """
        Sets the size of the transaction cache.
        """
        return pulumi.get(self, "max_binlog_cache_size")
    ...
    @property
    @pulumi.getter(name="maxConnectErrors")
    def max_connect_errors(self) -> builtins.str:
        """
        ("max_connect_errors")
        """
        return pulumi.get(self, "max_connect_errors")
    ...
    @property
    @pulumi.getter(name="maxExecutionTime")
    def max_execution_time(self) -> builtins.str:
        """
        ("max_execution_time")
        """
        return pulumi.get(self, "max_execution_time")
    ...
    @property
    @pulumi.getter(name="maxHeapTableSize")
    def max_heap_table_size(self) -> builtins.str:
        """
        This variable sets the maximum size to which user-created MEMORY tables are permitted to grow.
        """
        return pulumi.get(self, "max_heap_table_size")
    ...
    @property
    @pulumi.getter(name="maxPreparedStmtCount")
    def max_prepared_stmt_count(self) -> builtins.int:
        """
        ("max_prepared_stmt_count")
        """
        return pulumi.get(self, "max_prepared_stmt_count")
    ...
    @property
    @pulumi.getter(name="maxSeeksForKey")
    def max_seeks_for_key(self) -> builtins.str:
        """
        Limit the assumed maximum number of seeks when looking up rows based on a key. The MySQL optimizer assumes that no more than this number of key seeks are required when searching for matching rows in a table by scanning an index, regardless of the actual cardinality of the index (see Section 15.7.7.22, “SHOW INDEX Statement”). By setting this to a low value (say, 100), you can force MySQL to prefer indexes instead of table scans.
        """
        return pulumi.get(self, "max_seeks_for_key")
    ...
    @property
    @pulumi.getter(name="maxUserConnections")
    def max_user_connections(self) -> builtins.str:
        """
        The maximum number of simultaneous connections permitted to any given MySQL user account. A value of 0 (the default) means “no limit.” This variable has a global value that can be set at server startup or runtime. It also has a read-only session value that indicates the effective simultaneous-connection limit that applies to the account associated with the current session.
        """
        return pulumi.get(self, "max_user_connections")
    ...
    @property
    @pulumi.getter(name="mysqlFirewallMode")
    def mysql_firewall_mode(self) -> builtins.bool:
        """
        ("mysql_firewall_mode")
        """
        return pulumi.get(self, "mysql_firewall_mode")
    ...
    @pulumi.getter(name="mysqlZstdDefaultCompressionLevel")
    @_utilities.deprecated("""The 'mysql_zstd_default_compression_level' field has been deprecated and may be removed in a future version. Do not use this field.""")
    def mysql_zstd_default_compression_level(self) -> builtins.int:
        """
        DEPRECATED -- typo of mysqlx_zstd_default_compression_level. variable will be ignored.
        """
        return pulumi.get(self, "mysql_zstd_default_compression_level")
    ...
    @property
    @pulumi.getter(name="mysqlxConnectTimeout")
    def mysqlx_connect_timeout(self) -> builtins.int:
        """
        The number of seconds X Plugin waits for the first packet to be received from newly connected clients.
        """
        return pulumi.get(self, "mysqlx_connect_timeout")
    ...
    @property
    @pulumi.getter(name="mysqlxDeflateDefaultCompressionLevel")
    def mysqlx_deflate_default_compression_level(self) -> builtins.int:
        """
        Set the default compression level for the deflate algorithm. ("mysqlx_deflate_default_compression_level")
        """
        return pulumi.get(self, "mysqlx_deflate_default_compression_level")
    ...
    @property
    @pulumi.getter(name="mysqlxDeflateMaxClientCompressionLevel")
    def mysqlx_deflate_max_client_compression_level(self) -> builtins.int:
        """
        Limit the upper bound of accepted compression levels for the deflate algorithm. ("mysqlx_deflate_max_client_compression_level")
        """
        return pulumi.get(self, "mysqlx_deflate_max_client_compression_level")
    ...
    @pulumi.getter(name="mysqlxDocumentIdUniquePrefix")
    @_utilities.deprecated("""The 'mysqlx_document_id_unique_prefix' field has been deprecated and may be removed in a future version. Do not use this field.""")
    def mysqlx_document_id_unique_prefix(self) -> builtins.int:
        """
        ("mysqlx_document_id_unique_prefix") DEPRECATED -- variable should not be settable and will be ignored
        """
        return pulumi.get(self, "mysqlx_document_id_unique_prefix")
    ...
    @property
    @pulumi.getter(name="mysqlxEnableHelloNotice")
    def mysqlx_enable_hello_notice(self) -> builtins.bool:
        """
        ("mysqlx_enable_hello_notice") DEPRECATED -- variable should not be settable and will be ignored
        """
        return pulumi.get(self, "mysqlx_enable_hello_notice")
    ...
    @pulumi.getter(name="mysqlxIdleWorkerThreadTimeout")
    @_utilities.deprecated("""The 'mysqlx_idle_worker_thread_timeout' field has been deprecated and may be removed in a future version. Do not use this field.""")
    def mysqlx_idle_worker_thread_timeout(self) -> builtins.int:
        """
        ("mysqlx_idle_worker_thread_timeout") DEPRECATED -- variable should not be settable and will be ignored
        """
        return pulumi.get(self, "mysqlx_idle_worker_thread_timeout")
    ...
    @property
    @pulumi.getter(name="mysqlxInteractiveTimeout")
    def mysqlx_interactive_timeout(self) -> builtins.int:
        """
        The number of seconds to wait for interactive clients to timeout.
        """
        return pulumi.get(self, "mysqlx_interactive_timeout")
    ...
    @property
    @pulumi.getter(name="mysqlxLz4defaultCompressionLevel")
    def mysqlx_lz4default_compression_level(self) -> builtins.int:
        """
        Set the default compression level for the lz4 algorithm. ("mysqlx_lz4_default_compression_level")
        """
        return pulumi.get(self, "mysqlx_lz4default_compression_level")
    ...
    @property
    @pulumi.getter(name="mysqlxLz4maxClientCompressionLevel")
    def mysqlx_lz4max_client_compression_level(self) -> builtins.int:
        """
        Limit the upper bound of accepted compression levels for the lz4 algorithm. ("mysqlx_lz4_max_client_compression_level")
        """
        return pulumi.get(self, "mysqlx_lz4max_client_compression_level")
    ...
    @property
    @pulumi.getter(name="mysqlxMaxAllowedPacket")
    def mysqlx_max_allowed_packet(self) -> builtins.int:
        """
        The maximum size of network packets that can be received by X Plugin.
        """
        return pulumi.get(self, "mysqlx_max_allowed_packet")
    ...
    @pulumi.getter(name="mysqlxMinWorkerThreads")
    @_utilities.deprecated("""The 'mysqlx_min_worker_threads' field has been deprecated and may be removed in a future version. Do not use this field.""")
    def mysqlx_min_worker_threads(self) -> builtins.int:
        """
        ("mysqlx_min_worker_threads") DEPRECATED -- variable should not be settable and will be ignored
        """
        return pulumi.get(self, "mysqlx_min_worker_threads")
    ...
    @property
    @pulumi.getter(name="mysqlxReadTimeout")
    def mysqlx_read_timeout(self) -> builtins.int:
        """
        The number of seconds that X Plugin waits for blocking read operations to complete. After this time, if the read operation is not successful, X Plugin closes the connection and returns a warning notice with the error code ER_IO_READ_ERROR to the client application.
        """
        return pulumi.get(self, "mysqlx_read_timeout")
    ...
    @property
    @pulumi.getter(name="mysqlxWaitTimeout")
    def mysqlx_wait_timeout(self) -> builtins.int:
        """
        The number of seconds that X Plugin waits for activity on a connection.
        """
        return pulumi.get(self, "mysqlx_wait_timeout")
    ...
    @property
    @pulumi.getter(name="mysqlxWriteTimeout")
    def mysqlx_write_timeout(self) -> builtins.int:
        """
        The number of seconds that X Plugin waits for blocking write operations to complete. After this time, if the write operation is not successful, X Plugin closes the connection.
        """
        return pulumi.get(self, "mysqlx_write_timeout")
    ...
    @property
    @pulumi.getter(name="mysqlxZstdDefaultCompressionLevel")
    def mysqlx_zstd_default_compression_level(self) -> builtins.int:
        """
        Set the default compression level for the zstd algorithm. ("mysqlx_zstd_default_compression_level")
        """
        return pulumi.get(self, "mysqlx_zstd_default_compression_level")
    ...
    @property
    @pulumi.getter(name="mysqlxZstdMaxClientCompressionLevel")
    def mysqlx_zstd_max_client_compression_level(self) -> builtins.int:
        """
        Limit the upper bound of accepted compression levels for the zstd algorithm. ("mysqlx_zstd_max_client_compression_level")
        """
        return pulumi.get(self, "mysqlx_zstd_max_client_compression_level")
    ...
    @property
    @pulumi.getter(name="netReadTimeout")
    def net_read_timeout(self) -> builtins.int:
        """
        The number of seconds to wait for more data from a connection before aborting the read.
        """
        return pulumi.get(self, "net_read_timeout")
    ...
    @property
    @pulumi.getter(name="netWriteTimeout")
    def net_write_timeout(self) -> builtins.int:
        """
        The number of seconds to wait for a block to be written to a connection before aborting the write.
        """
        return pulumi.get(self, "net_write_timeout")
    ...
    @property
    @pulumi.getter(name="optimizerSwitch")
    def optimizer_switch(self) -> builtins.str:
        """
        The optimizer_switch system variable enables control over optimizer behavior. The value of this variable is a set of flags, each of which has a value of on or off to indicate whether the corresponding optimizer behavior is enabled or disabled. This variable has global and session values and can be changed at runtime. The global default can be set at server startup.
        """
        return pulumi.get(self, "optimizer_switch")
    ...
    @property
    @pulumi.getter(name="parserMaxMemSize")
    def parser_max_mem_size(self) -> builtins.str:
        """
        ("parser_max_mem_size")
        """
        return pulumi.get(self, "parser_max_mem_size")
    ...
    @pulumi.getter(name="queryAllocBlockSize")
    @_utilities.deprecated("""The 'query_alloc_block_size' field has been deprecated and may be removed in a future version. Do not use this field.""")
    def query_alloc_block_size(self) -> builtins.str:
        """
        ("query_alloc_block_size") DEPRECATED -- variable should not be settable and will be ignored
        """
        return pulumi.get(self, "query_alloc_block_size")
    ...
    @property
    @pulumi.getter(name="queryPreallocSize")
    def query_prealloc_size(self) -> builtins.str:
        """
        ("query_prealloc_size") DEPRECATED -- variable should not be settable and will be ignored
        """
        return pulumi.get(self, "query_prealloc_size")
    ...
    @pulumi.getter(name="rangeOptimizerMaxMemSize")
    @_utilities.deprecated("""The 'query_prealloc_size' field has been deprecated and may be removed in a future version. Do not use this field.""")
    def range_optimizer_max_mem_size(self) -> builtins.str:
        """
        The limit on memory consumption for the range optimizer. A value of 0 means “no limit.” If an execution plan considered by the optimizer uses the range access method but the optimizer estimates that the amount of memory needed for this method would exceed the limit, it abandons the plan and considers other plans.
        """
        return pulumi.get(self, "range_optimizer_max_mem_size")
    ...
    @property
    @pulumi.getter(name="regexpTimeLimit")
    def regexp_time_limit(self) -> builtins.int:
        """
        regexpTimeLimit corresponds to the MySQL system variable [regexp_time_limit] (https://dev.mysql.com/doc/refman/8.0/en/server-system-variables.html#sysvar_regexp_time_limit)
        """
        return pulumi.get(self, "regexp_time_limit")
    ...
    @property
    @pulumi.getter(name="relayLogSpaceLimit")
    def relay_log_space_limit(self) -> builtins.str:
        """
        The maximum amount of space to use for all relay logs.
        """
        return pulumi.get(self, "relay_log_space_limit")
    ...
    @property
    @pulumi.getter(name="replicaNetTimeout")
    def replica_net_timeout(self) -> builtins.int:
        """
        Specifies the number of seconds to wait for more data or a heartbeat signal from the source before the replica considers the connection broken, aborts the read, and tries to reconnect. Setting this variable has no immediate effect. The state of the variable applies on all subsequent START REPLICA commands.
        """
        return pulumi.get(self, "replica_net_timeout")
    ...
    @property
    @pulumi.getter(name="replicaParallelWorkers")
    def replica_parallel_workers(self) -> builtins.int:
        """
        Beginning with MySQL 8.0.26, slave_parallel_workers is deprecated, and you should use replica_parallel_workers instead. (Prior to MySQL 8.0.26, you must use slave_parallel_workers to set the number of applier threads.)
        """
        return pulumi.get(self, "replica_parallel_workers")
    ...
    @property
    @pulumi.getter(name="replicaTypeConversions")
    def replica_type_conversions(self) -> builtins.str:
        """
        From MySQL 8.0.26, use replica_type_conversions in place of slave_type_conversions, which is deprecated from that release. In releases before MySQL 8.0.26, use slave_type_conversions.
        """
        return pulumi.get(self, "replica_type_conversions")
    ...
    @property
    @pulumi.getter(name="requireSecureTransport")
    def require_secure_transport(self) -> builtins.bool:
        """
        Whether client connections to the server are required to use some form of secure transport. When this variable is enabled, the server permits only TCP/IP connections encrypted using TLS/SSL, or connections that use a socket file or shared memory. The server rejects nonsecure connection attempts, which fail with an ER_SECURE_TRANSPORT_REQUIRED error.
        """
        return pulumi.get(self, "require_secure_transport")
    ...
    @property
    @pulumi.getter(name="skipNameResolve")
    def skip_name_resolve(self) -> builtins.bool:
        """
        Whether to resolve host names when checking client connections. If this variable is OFF, mysqld resolves host names when checking client connections. If it is ON, mysqld uses only IP numbers; in this case, all Host column values in the grant tables must be IP addresses. See Section 7.1.12.3, “DNS Lookups and the Host Cache”.
        """
        return pulumi.get(self, "skip_name_resolve")
    ...
    @property
    @pulumi.getter(name="sortBufferSize")
    def sort_buffer_size(self) -> builtins.str:
        """
        Each session that must perform a sort allocates a buffer of this size.
        """
        return pulumi.get(self, "sort_buffer_size")
    ...
    @property
    @pulumi.getter(name="sqlGenerateInvisiblePrimaryKey")
    def sql_generate_invisible_primary_key(self) -> builtins.bool:
        """
        Whether GIPK mode is in effect, in which case a MySQL replication source server adds a generated invisible primary key to any InnoDB table that is created without one.
        """
        return pulumi.get(self, "sql_generate_invisible_primary_key")
    ...
    @property
    @pulumi.getter(name="sqlRequirePrimaryKey")
    def sql_require_primary_key(self) -> builtins.bool:
        """
        ("sql_require_primary_key")
        """
        return pulumi.get(self, "sql_require_primary_key")
    ...
    @property
    @pulumi.getter(name="sqlWarnings")
    def sql_warnings(self) -> builtins.bool:
        """
        ("sql_warnings")
        """
        return pulumi.get(self, "sql_warnings")
    ...
    @property
    @pulumi.getter(name="tableDefinitionCache")
    def table_definition_cache(self) -> builtins.int:
        """
        The number of table definitions that can be stored in the table definition cache. If you use a large number of tables, you can create a large table definition cache to speed up opening of tables. The table definition cache takes less space and does not use file descriptors, unlike the normal table cache.
        """
        return pulumi.get(self, "table_definition_cache")
    ...
    @property
    @pulumi.getter(name="tableOpenCache")
    def table_open_cache(self) -> builtins.int:
        """
        The number of open tables for all threads. Increasing this value increases the number of file descriptors that mysqld requires.
        """
        return pulumi.get(self, "table_open_cache")
    ...
    @property
    @pulumi.getter(name="temptableMaxRam")
    def temptable_max_ram(self) -> builtins.str:
        """
        Defines the maximum amount of memory that can be occupied by the TempTable storage engine before it starts storing data on disk. The default value is 1073741824 bytes (1GiB). For more information, see Section 10.4.4, “Internal Temporary Table Use in MySQL”.
        """
        return pulumi.get(self, "temptable_max_ram")
    ...
    @property
    @pulumi.getter(name="threadPoolDedicatedListeners")
    def thread_pool_dedicated_listeners(self) -> builtins.bool:
        """
        Controls whether the thread pool uses dedicated listener threads. If enabled, a listener thread in each thread group is dedicated to the task of listening for network events from clients, ensuring that the maximum number of query worker threads is no more than the value specified by threadPoolMaxTransactionsLimit. threadPoolDedicatedListeners corresponds to the MySQL Database Service-specific system variable thread_pool_dedicated_listeners.
        """
        return pulumi.get(self, "thread_pool_dedicated_listeners")
    ...
    @property
    @pulumi.getter(name="threadPoolMaxTransactionsLimit")
    def thread_pool_max_transactions_limit(self) -> builtins.int:
        """
        Limits the maximum number of open transactions to the defined value. The default value is 0, which enforces no limit. threadPoolMaxTransactionsLimit corresponds to the MySQL Database Service-specific system variable thread_pool_max_transactions_limit.
        """
        return pulumi.get(self, "thread_pool_max_transactions_limit")
    ...
    @property
    @pulumi.getter(name="threadPoolQueryThreadsPerGroup")
    def thread_pool_query_threads_per_group(self) -> builtins.int:
        """
        The maximum number of query threads permitted in a thread group. The maximum value is 4096, but if thread_pool_max_transactions_limit is set, thread_pool_query_threads_per_group must not exceed that value. The default value of 1 means there is one active query thread in each thread group, which works well for many loads. When you are using the high concurrency thread pool algorithm (thread_pool_algorithm = 1), consider increasing the value if you experience slower response times due to long-running transactions.
        """
        return pulumi.get(self, "thread_pool_query_threads_per_group")
    ...
    @property
    @pulumi.getter(name="threadPoolTransactionDelay")
    def thread_pool_transaction_delay(self) -> builtins.int:
        """
        The delay period before executing a new transaction, in milliseconds. The maximum value is 300000 (5 minutes). A transaction delay can be used in cases where parallel transactions affect the performance of other operations due to resource contention. For example, if parallel transactions affect index creation or an online buffer pool resizing operation, you can configure a transaction delay to reduce resource contention while those operations are running.
        """
        return pulumi.get(self, "thread_pool_transaction_delay")
    ...
    @property
    @pulumi.getter(name="tmpTableSize")
    def tmp_table_size(self) -> builtins.str:
        """
        The maximum size of internal in-memory temporary tables. This variable does not apply to user-created MEMORY tables.
        """
        return pulumi.get(self, "tmp_table_size")
    ...
    @property
    @pulumi.getter(name="transactionIsolation")
    def transaction_isolation(self) -> builtins.str:
        """
        ("transaction_isolation")
        """
        return pulumi.get(self, "transaction_isolation")
    ...
    @property
    @pulumi.getter(name="waitTimeout")
    def wait_timeout(self) -> builtins.int:
        """
        The number of seconds the server waits for activity on a noninteractive connection before closing it.
        """
        return pulumi.get(self, "wait_timeout")
...
class GetMysqlConfigurationsConfigurationResult(dict):
    def __init__(__self__, *,
                 ...
                 parent_configuration_id: builtins.str,
                 shape_name: builtins.str,
                 state: builtins.str,
                 system_tags: Mapping[str, builtins.str],
                 time_created: builtins.str,
        ...
        :param builtins.str compartment_id: The compartment [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str description: User-provided data about the Configuration.
        :param builtins.str display_name: A filter to return only the resource matching the given display name exactly.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: The OCID of the Configuration.
        ...
        :param builtins.str parent_configuration_id: The OCID of the Configuration from which this Configuration is "derived". This is entirely a metadata relationship. There is no relation between the values in this Configuration and its parent.
        :param builtins.str shape_name: The requested Shape name.
        :param builtins.str state: Configuration Lifecycle State
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The date and time the Configuration was created, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        :param builtins.str time_updated: The date and time the Configuration was last updated, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        :param builtins.str type: The requested Configuration types.
    ...
    def parent_configuration_id(self) -> builtins.str:
        """
...
class GetMysqlDbSystemChannelResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str compartment_id: The OCID of the compartment the DB System belongs in.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str display_name: The user-friendly name for the DB System. It does not have to be unique.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: The OCID of the DB System.
        :param builtins.bool is_enabled: Specifies if the DB System read endpoint is enabled or not.
        :param builtins.str lifecycle_details: Additional information about the current lifecycleState.
...
class GetMysqlDbSystemCurrentPlacementResult(dict):
    def __init__(__self__, *,
                 ...
                 fault_domain: builtins.str):
        """
        :param builtins.str availability_domain: The availability domain in which the DB System is placed.
        :param builtins.str fault_domain: The fault domain on which to deploy the Read/Write endpoint. This defines the preferred primary instance.
        """
        pulumi.set(__self__, "availability_domain", availability_domain)
        pulumi.set(__self__, "fault_domain", fault_domain)
...
class GetMysqlDbSystemCustomerContactResult(dict):
    def __init__(__self__, *,
                 email: builtins.str):
        """
        :param builtins.str email: The email address used by Oracle to send notifications regarding the DB System.
        """
        pulumi.set(__self__, "email", email)
...
class GetMysqlDbSystemDataStorageResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int allocated_storage_size_in_gbs: The actual allocated storage size for the DB System. This may be higher than dataStorageSizeInGBs if an automatic storage expansion has occurred.
        :param builtins.int data_storage_size_in_gb: Initial size of the data volume in GiBs that will be created and attached.
        :param builtins.int data_storage_size_limit_in_gbs: The absolute limit the DB System's storage size may ever expand to, either manually or automatically. This limit is based based on the initial dataStorageSizeInGBs when the DB System was first created. Both dataStorageSizeInGBs and maxDataStorageSizeInGBs can not exceed this value.
        :param builtins.bool is_auto_expand_storage_enabled: Enable/disable automatic storage expansion. When set to true, the DB System will automatically add storage incrementally up to the value specified in maxStorageSizeInGBs.
        :param builtins.int max_storage_size_in_gbs: Maximum storage size this DB System can expand to. When isAutoExpandStorageEnabled is set to true, the DB System will add storage incrementally up to this value.
        """
...
class GetMysqlDbSystemHeatWaveClusterResult(dict):
    def __init__(__self__, *,
                 ...
                 is_lakehouse_enabled: builtins.bool,
                 shape_name: builtins.str,
                 state: builtins.str,
                 time_created: builtins.str,
                 time_updated: builtins.str):
    ...
    @property
    @pulumi.getter(name="isLakehouseEnabled")
    def is_lakehouse_enabled(self) -> builtins.bool:
        """
        Lakehouse enabled status for the HeatWave cluster.
        """
        return pulumi.get(self, "is_lakehouse_enabled")
...
class GetMysqlDbSystemPointInTimeRecoveryDetailResult(dict):
    def __init__(__self__, *,
                 time_earliest_recovery_point: builtins.str,
                 time_latest_recovery_point: builtins.str):
        """
        :param builtins.str time_earliest_recovery_point: Earliest recovery time point for the DB System, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        :param builtins.str time_latest_recovery_point: Latest recovery time point for the DB System, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        """
    ...
    @property
    @pulumi.getter(name="timeEarliestRecoveryPoint")
    def time_earliest_recovery_point(self) -> builtins.str:
        """
        Earliest recovery time point for the DB System, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        """
        return pulumi.get(self, "time_earliest_recovery_point")
    ...
    @property
    @pulumi.getter(name="timeLatestRecoveryPoint")
    def time_latest_recovery_point(self) -> builtins.str:
        """
        Latest recovery time point for the DB System, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        """
        return pulumi.get(self, "time_latest_recovery_point")
...
class GetMysqlDbSystemSourceResult(dict):
    ...
    @property
    @pulumi.getter(name="recoveryPoint")
    def recovery_point(self) -> builtins.str:
        """
        The date and time, as per RFC 3339, of the change up to which the new DB System shall be restored to, using a backup and logs from the original DB System. In case no point in time is specified, then this new DB System shall be restored up to the latest change recorded for the original DB System.
        """
        return pulumi.get(self, "recovery_point")
...
class GetMysqlDbSystemsDbSystemResult(dict):
    def __init__(__self__, *,
                 ...
                 time_updated: builtins.str):
        """
        :param builtins.str access_mode: The access mode indicating if the database access is unrestricted (to all MySQL user accounts),  or restricted (to only certain users with specific privileges):
        ...
        :param builtins.str database_management: Filter DB Systems by their Database Management configuration.
        :param builtins.str database_mode: The database mode indicating the types of statements that are allowed to run in the the DB system. This mode applies only to statements run by user connections. Replicated write statements continue  to be allowed regardless of the DatabaseMode.
        ...
        :param builtins.str id: The OCID of the DB System.
        :param builtins.str ip_address: The IP address the DB System is configured to listen on. A private IP address of the primary endpoint of the DB System. Must be an available IP address within the subnet's CIDR. This will be a "dotted-quad" style IPv4 address.
        :param builtins.bool is_heat_wave_cluster_attached: If true, return only DB Systems with a HeatWave cluster attached, if false return only DB Systems with no HeatWave cluster attached. If not present, return all DB Systems.
        :param builtins.bool is_highly_available: Specifies if the DB System is highly available.
        :param builtins.str lifecycle_details: Additional information about the current lifecycleState.
        ...
        :param builtins.str state: DbSystem Lifecycle State
        :param builtins.str subnet_id: The OCID of the subnet the DB System is associated with.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The date and time the DB System was created.
        :param builtins.str time_updated: The time the DB System was last updated.
    ...
    def shutdown_type(self) -> builtins.str:
...
class GetMysqlVersionVersionResult(dict):
    def __init__(__self__, *,
                 version_family: builtins.str,
                 versions: Sequence['outputs.GetMysqlVersionVersionVersionResult']):
        """
        :param builtins.str version_family: A descriptive summary of a group of versions.
    ...
    def version_family(self) -> builtins.str:
        """
...
class GetMysqlVersionVersionVersionResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str description: A link to a page describing the version.
        :param builtins.str version: The specific version identifier
        """
        pulumi.set(__self__, "description", description)
...
class GetReplicasReplicaResult(dict):
    def __init__(__self__, *,
                 ...
                 time_updated: builtins.str):
        """
        :param builtins.str availability_domain: The name of the Availability Domain the read replica is located in.
        :param builtins.str compartment_id: The compartment [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param builtins.str configuration_id: The requested Configuration instance.
        :param builtins.str db_system_id: The DB System [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        ...
        :param builtins.str ip_address: The IP address the read replica is configured to listen on.
        ...
        :param builtins.str shape_name: The shape currently in use by the read replica. The shape determines the resources allocated:  CPU cores and memory for VM shapes, CPU cores, memory and storage for non-VM (bare metal) shapes.  To get a list of shapes, use the [ListShapes](https://docs.cloud.oracle.com/iaas/api/#/en/mysql/20190415/ShapeSummary/ListShapes) operation.
        :param builtins.str state: The LifecycleState of the read replica.
        :param builtins.str time_created: The date and time the read replica was created, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        :param builtins.str time_updated: The time the read replica was last updated, as described by [RFC 3339](https://tools.ietf.org/rfc/rfc3339).
        """
        pulumi.set(__self__, "availability_domain", availability_domain)
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "configuration_id", configuration_id)
...
class GetShapesShapeResult(dict):
    def __init__(__self__, *,
                 ...
                 is_supported_fors: Sequence[builtins.str],
                 memory_size_in_gbs: builtins.int,
                 name: builtins.str):
        """
        :param builtins.int cpu_core_count: The number of CPU Cores the Instance provides. These are "OCPU"s.
        :param Sequence[builtins.str] is_supported_fors: Return shapes that are supported by the service feature.
        :param builtins.int memory_size_in_gbs: The amount of RAM the Instance provides. This is an IEC base-2 number.
        :param builtins.str name: Name
        """
    ...
    def is_supported_fors(self) -> Sequence[builtins.str]:
        """
