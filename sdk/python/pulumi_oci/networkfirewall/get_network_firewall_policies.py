...
def get_network_firewall_policies(compartment_id: Optional[str] = None,
    ...
    test_network_firewall_policies = oci.NetworkFirewall.get_network_firewall_policies(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetNetworkFirewallPoliciesResult(
        ...
        id=__ret__.id,
        network_firewall_policy_summary_collections=__ret__.network_firewall_policy_summary_collections,
        state=__ret__.state)
