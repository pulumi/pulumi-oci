...
def get_network_firewall_policy(network_firewall_policy_id: Optional[builtins.str] = None,
...
def get_network_firewall_policy_output(network_firewall_policy_id: Optional[pulumi.Input[builtins.str]] = None,
