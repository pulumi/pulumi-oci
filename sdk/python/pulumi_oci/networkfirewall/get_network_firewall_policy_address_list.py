...
class GetNetworkFirewallPolicyAddressListResult:
    ...
    def total_addresses(self) -> builtins.int:
        """
...
def get_network_firewall_policy_address_list(name: Optional[builtins.str] = None,
...
def get_network_firewall_policy_address_list_output(name: Optional[pulumi.Input[builtins.str]] = None,
