...
def get_network_firewall_policy_application(name: Optional[builtins.str] = None,
...
def get_network_firewall_policy_application_output(name: Optional[pulumi.Input[builtins.str]] = None,
