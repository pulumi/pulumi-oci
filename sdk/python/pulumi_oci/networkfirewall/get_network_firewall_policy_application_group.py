...
class GetNetworkFirewallPolicyApplicationGroupResult:
    ...
    def total_apps(self) -> builtins.int:
        """
...
def get_network_firewall_policy_application_group(name: Optional[builtins.str] = None,
...
def get_network_firewall_policy_application_group_output(name: Optional[pulumi.Input[builtins.str]] = None,
