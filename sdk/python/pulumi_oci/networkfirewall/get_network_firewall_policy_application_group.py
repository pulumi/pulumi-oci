...
def get_network_firewall_policy_application_group(name: Optional[_builtins.str] = None,
...
def get_network_firewall_policy_application_group_output(name: Optional[pulumi.Input[_builtins.str]] = None,
