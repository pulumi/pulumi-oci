...
class GetNetworkFirewallPolicyDecryptionRulesResult:
    ...
    def decryption_rule_priority_order(self) -> Optional[_builtins.int]:
...
def get_network_firewall_policy_decryption_rules(decryption_rule_priority_order: Optional[_builtins.int] = None,
    ...
    :param _builtins.int decryption_rule_priority_order: Unique priority order for Decryption Rules in the network firewall policy.
