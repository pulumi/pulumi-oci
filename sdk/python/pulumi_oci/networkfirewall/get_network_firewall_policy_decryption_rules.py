...
class GetNetworkFirewallPolicyDecryptionRulesResult:
    ...
    def decryption_rule_priority_order(self) -> Optional[builtins.int]:
...
def get_network_firewall_policy_decryption_rules(decryption_rule_priority_order: Optional[builtins.int] = None,
    ...
    :param builtins.int decryption_rule_priority_order: Unique priority order for Decryption Rules in the network firewall policy.
...
def get_network_firewall_policy_decryption_rules_output(decryption_rule_priority_order: Optional[pulumi.Input[Optional[builtins.int]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetNetworkFirewallPolicyDecryptionRulesResult(
        ...
        decryption_rule_summary_collections=pulumi.get(__response__, 'decryption_rule_summary_collections'),
