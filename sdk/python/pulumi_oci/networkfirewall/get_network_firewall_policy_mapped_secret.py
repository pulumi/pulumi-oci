...
def get_network_firewall_policy_mapped_secret(name: Optional[builtins.str] = None,
...
def get_network_firewall_policy_mapped_secret_output(name: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetNetworkFirewallPolicyMappedSecretResult(
        ...
        vault_secret_id=pulumi.get(__response__, 'vault_secret_id'),
