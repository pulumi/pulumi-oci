...
def get_network_firewall_policy_mapped_secret(name: Optional[_builtins.str] = None,
...
def get_network_firewall_policy_mapped_secret_output(name: Optional[pulumi.Input[_builtins.str]] = None,
