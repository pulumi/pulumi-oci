...
class GetNetworkFirewallPolicySecurityRuleResult:
    ...
    @property
    @pulumi.getter
    def inspection(self) -> builtins.str:
        """
...
def get_network_firewall_policy_security_rule(name: Optional[builtins.str] = None,
...
def get_network_firewall_policy_security_rule_output(name: Optional[pulumi.Input[builtins.str]] = None,
