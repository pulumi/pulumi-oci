...
class GetNetworkFirewallPolicySecurityRulesResult:
    ...
    def security_rule_priority_order(self) -> Optional[builtins.int]:
...
def get_network_firewall_policy_security_rules(display_name: Optional[builtins.str] = None,
                                               ...
                                               security_rule_priority_order: Optional[builtins.int] = None,
    ...
    :param builtins.int security_rule_priority_order: Unique priority order for Security Rules in the network firewall policy.
    """
    __args__ = dict()
...
def get_network_firewall_policy_security_rules_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                      ...
                                                      security_rule_priority_order: Optional[pulumi.Input[Optional[builtins.int]]] = None,
