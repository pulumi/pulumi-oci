...
def get_network_firewall_policy_service(name: Optional[_builtins.str] = None,
...
def get_network_firewall_policy_service_output(name: Optional[pulumi.Input[_builtins.str]] = None,
