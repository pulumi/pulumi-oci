...
def get_network_firewall_policy_service_lists(display_name: Optional[builtins.str] = None,
...
def get_network_firewall_policy_service_lists_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
