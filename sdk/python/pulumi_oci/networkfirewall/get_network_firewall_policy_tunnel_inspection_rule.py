...
class GetNetworkFirewallPolicyTunnelInspectionRuleResult:
    ...
    def tunnel_inspection_rule_name(self) -> builtins.str:
...
def get_network_firewall_policy_tunnel_inspection_rule(network_firewall_policy_id: Optional[builtins.str] = None,
                                                       tunnel_inspection_rule_name: Optional[builtins.str] = None,
    ...
    :param builtins.str tunnel_inspection_rule_name: Unique identifier for Tunnel Inspection Rules in the network firewall policy.
    """
    __args__ = dict()
...
def get_network_firewall_policy_tunnel_inspection_rule_output(network_firewall_policy_id: Optional[pulumi.Input[builtins.str]] = None,
                                                              tunnel_inspection_rule_name: Optional[pulumi.Input[builtins.str]] = None,
