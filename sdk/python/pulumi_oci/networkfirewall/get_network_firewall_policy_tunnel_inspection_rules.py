...
class GetNetworkFirewallPolicyTunnelInspectionRulesResult:
    ...
    def tunnel_inspection_rule_priority_order(self) -> Optional[builtins.int]:
...
def get_network_firewall_policy_tunnel_inspection_rules(display_name: Optional[builtins.str] = None,
                                                        ...
                                                        tunnel_inspection_rule_priority_order: Optional[builtins.int] = None,
    ...
    :param builtins.int tunnel_inspection_rule_priority_order: Unique priority order for Tunnel Inspection rules in the network firewall policy.
    """
    __args__ = dict()
...
def get_network_firewall_policy_tunnel_inspection_rules_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                               ...
                                                               tunnel_inspection_rule_priority_order: Optional[pulumi.Input[Optional[builtins.int]]] = None,
