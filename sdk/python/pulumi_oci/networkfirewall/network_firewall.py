...
class NetworkFirewallArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the Network Firewall.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name for the Network Firewall. Does not have to be unique, and it's changeable. Avoid entering confidential information.
    ...
    @property
    @pulumi.getter
    def ipv4address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ipv4address.setter
    def ipv4address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ipv4address", value)

    @property
    @pulumi.getter
    def ipv6address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @ipv6address.setter
    def ipv6address(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _NetworkFirewallState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] time_created: The time at which the Network Firewall was created in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339). Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_updated: The time at which the Network Firewall was updated in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339). Example: `2016-08-25T21:10:29.600Z`
        """
        if availability_domain is not None:
            pulumi.set(__self__, "availability_domain", availability_domain)
...
class NetworkFirewall(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkFirewall':
        """
    ...
    @property
    @pulumi.getter
    def ipv4address(self) -> pulumi.Output[builtins.str]:
        """
        IPv4 address for the Network Firewall.
        """
        return pulumi.get(self, "ipv4address")
    ...
    @property
    @pulumi.getter
    def ipv6address(self) -> pulumi.Output[builtins.str]:
        """
        IPv6 address for the Network Firewall.
        """
        return pulumi.get(self, "ipv6address")
