...
class NetworkFirewallPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_network_firewall_policy = oci.network_firewall.NetworkFirewallPolicy("testNetworkFirewallPolicy",
            compartment_id=var["compartment_id"],
            application_lists=var["network_firewall_policy_application_lists"],
            decryption_profiles=[oci.network.firewall.NetworkFirewallPolicyDecryptionProfileArgs(
            ...
            decryption_rules=[oci.network.firewall.NetworkFirewallPolicyDecryptionRuleArgs(
                action=var["network_firewall_policy_decryption_rules_action"],
                condition=oci.network.firewall.NetworkFirewallPolicyDecryptionRuleConditionArgs(
            ...
            mapped_secrets=[oci.network.firewall.NetworkFirewallPolicyMappedSecretArgs(
            ...
            security_rules=[oci.network.firewall.NetworkFirewallPolicySecurityRuleArgs(
                action=var["network_firewall_policy_security_rules_action"],
                condition=oci.network.firewall.NetworkFirewallPolicySecurityRuleConditionArgs(
