...
class NetworkFirewallPolicyApplicationArgs:
    def __init__(__self__, *,
                 icmp_type: pulumi.Input[builtins.int],
        ...
        :param pulumi.Input[builtins.int] icmp_type: (Updatable) The value of the ICMP/IMCP_V6 message Type field as defined by [RFC 4443](https://www.rfc-editor.org/rfc/rfc4443.html#section-2.1).
        :param pulumi.Input[builtins.str] network_firewall_policy_id: Unique Network Firewall Policy identifier
        :param pulumi.Input[builtins.str] type: Describes the type of application. The accepted values are - * ICMP * ICMP_V6
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.int] icmp_code: (Updatable) The value of the ICMP/ICMP_V6 message Code (subtype) field as defined by [RFC 4443](https://www.rfc-editor.org/rfc/rfc4443.html#section-2.1).
    ...
    def icmp_type(self) -> pulumi.Input[builtins.int]:
        """
    ...
    @icmp_type.setter
    def icmp_type(self, value: pulumi.Input[builtins.int]):
...
class _NetworkFirewallPolicyApplicationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name of the application
        :param pulumi.Input[builtins.str] network_firewall_policy_id: Unique Network Firewall Policy identifier
        :param pulumi.Input[builtins.str] parent_resource_id: OCID of the Network Firewall Policy this application belongs to.
        :param pulumi.Input[builtins.str] type: Describes the type of application. The accepted values are - * ICMP * ICMP_V6
...
class NetworkFirewallPolicyApplication(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network_firewall_policy_id: Optional[pulumi.Input[builtins.str]] = None,
            parent_resource_id: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkFirewallPolicyApplication':
        """
    ...
    @property
    @pulumi.getter(name="icmpCode")
    def icmp_code(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The value of the ICMP/ICMP_V6 message Code (subtype) field as defined by [RFC 4443](https://www.rfc-editor.org/rfc/rfc4443.html#section-2.1).
        """
        return pulumi.get(self, "icmp_code")
    ...
    @property
    @pulumi.getter(name="icmpType")
    def icmp_type(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The value of the ICMP/IMCP_V6 message Type field as defined by [RFC 4443](https://www.rfc-editor.org/rfc/rfc4443.html#section-2.1).
        """
        return pulumi.get(self, "icmp_type")
