...
class _NetworkFirewallPolicyApplicationGroupState:
    def __init__(__self__, *,
                 ...
                 total_apps: pulumi.Input[Optional[_builtins.int]] = None):
        """
    ...
    def total_apps(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    @total_apps.setter
    def total_apps(self, value: pulumi.Input[Optional[_builtins.int]]):
...
class NetworkFirewallPolicyApplicationGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network_firewall_policy_id: pulumi.Input[Optional[_builtins.str]] = None,
            parent_resource_id: pulumi.Input[Optional[_builtins.str]] = None,
            total_apps: pulumi.Input[Optional[_builtins.int]] = None) -> 'NetworkFirewallPolicyApplicationGroup':
        """
