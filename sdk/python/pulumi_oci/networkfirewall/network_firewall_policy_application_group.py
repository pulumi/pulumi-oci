...
class NetworkFirewallPolicyApplicationGroupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] apps: (Updatable) Collection of application names. The apps referenced in the application group must already be present in the policy before being used in the application group.
        ...
        :param pulumi.Input[builtins.str] name: Name of the application group.
        """
...
class _NetworkFirewallPolicyApplicationGroupState:
    def __init__(__self__, *,
                 ...
                 total_apps: Optional[pulumi.Input[builtins.int]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] network_firewall_policy_id: Unique Network Firewall Policy identifier
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] parent_resource_id: OCID of the Network Firewall Policy this application group belongs to.
        :param pulumi.Input[builtins.int] total_apps: Count of total applications in the given application group.
        """
        if apps is not None:
            pulumi.set(__self__, "apps", apps)
        if name is not None:
    ...
    def total_apps(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @total_apps.setter
    def total_apps(self, value: Optional[pulumi.Input[builtins.int]]):
...
class NetworkFirewallPolicyApplicationGroup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network_firewall_policy_id: Optional[pulumi.Input[builtins.str]] = None,
            parent_resource_id: Optional[pulumi.Input[builtins.str]] = None,
            total_apps: Optional[pulumi.Input[builtins.int]] = None) -> 'NetworkFirewallPolicyApplicationGroup':
        """
    ...
    @property
    @pulumi.getter(name="totalApps")
    def total_apps(self) -> pulumi.Output[builtins.int]:
        """
        Count of total applications in the given application group.
        """
        return pulumi.get(self, "total_apps")
