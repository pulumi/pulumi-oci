...
class NetworkFirewallPolicyDecryptionProfileArgs:
    def __init__(__self__, *,
                 ...
                 are_certificate_extensions_restricted: Optional[pulumi.Input[builtins.bool]] = None,
                 is_auto_include_alt_name: Optional[pulumi.Input[builtins.bool]] = None,
                 is_expired_certificate_blocked: Optional[pulumi.Input[builtins.bool]] = None,
                 is_out_of_capacity_blocked: Optional[pulumi.Input[builtins.bool]] = None,
                 is_revocation_status_timeout_blocked: Optional[pulumi.Input[builtins.bool]] = None,
                 is_unknown_revocation_status_blocked: Optional[pulumi.Input[builtins.bool]] = None,
                 is_unsupported_cipher_blocked: Optional[pulumi.Input[builtins.bool]] = None,
                 is_unsupported_version_blocked: Optional[pulumi.Input[builtins.bool]] = None,
                 is_untrusted_issuer_blocked: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] type: Describes the type of decryption profile. The accepted values are - * SSL_FORWARD_PROXY * SSL_INBOUND_INSPECTION
        :param pulumi.Input[builtins.bool] are_certificate_extensions_restricted: (Updatable) Whether to block sessions if the server's certificate uses extensions other than key usage and/or extended key usage.
        :param pulumi.Input[builtins.bool] is_auto_include_alt_name: (Updatable) Whether to automatically append SAN to impersonating certificate if server certificate is missing SAN.
        :param pulumi.Input[builtins.bool] is_expired_certificate_blocked: (Updatable) Whether to block sessions if server's certificate is expired.
        :param pulumi.Input[builtins.bool] is_out_of_capacity_blocked: (Updatable) Whether to block sessions if the firewall is temporarily unable to decrypt their traffic.
        :param pulumi.Input[builtins.bool] is_revocation_status_timeout_blocked: (Updatable) Whether to block sessions if the revocation status check for server's certificate does not succeed within the maximum allowed time (defaulting to 5 seconds).
        :param pulumi.Input[builtins.bool] is_unknown_revocation_status_blocked: (Updatable) Whether to block sessions if the revocation status check for server's certificate results in "unknown".
        :param pulumi.Input[builtins.bool] is_unsupported_cipher_blocked: (Updatable) Whether to block sessions if SSL cipher suite is not supported.
        :param pulumi.Input[builtins.bool] is_unsupported_version_blocked: (Updatable) Whether to block sessions if SSL version is not supported.
        :param pulumi.Input[builtins.bool] is_untrusted_issuer_blocked: (Updatable) Whether to block sessions if server's certificate is issued by an untrusted certificate authority (CA).
        :param pulumi.Input[builtins.str] name: Name of the decryption profile.
        """
    ...
    def are_certificate_extensions_restricted(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def are_certificate_extensions_restricted(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "are_certificate_extensions_restricted", value)

    @property
    @pulumi.getter(name="isAutoIncludeAltName")
    def is_auto_include_alt_name(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_auto_include_alt_name(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_auto_include_alt_name", value)

    @property
    @pulumi.getter(name="isExpiredCertificateBlocked")
    def is_expired_certificate_blocked(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_expired_certificate_blocked(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_expired_certificate_blocked", value)

    @property
    @pulumi.getter(name="isOutOfCapacityBlocked")
    def is_out_of_capacity_blocked(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_out_of_capacity_blocked(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_out_of_capacity_blocked", value)

    @property
    @pulumi.getter(name="isRevocationStatusTimeoutBlocked")
    def is_revocation_status_timeout_blocked(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_revocation_status_timeout_blocked(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_revocation_status_timeout_blocked", value)

    @property
    @pulumi.getter(name="isUnknownRevocationStatusBlocked")
    def is_unknown_revocation_status_blocked(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_unknown_revocation_status_blocked(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_unknown_revocation_status_blocked", value)

    @property
    @pulumi.getter(name="isUnsupportedCipherBlocked")
    def is_unsupported_cipher_blocked(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_unsupported_cipher_blocked(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_unsupported_cipher_blocked", value)

    @property
    @pulumi.getter(name="isUnsupportedVersionBlocked")
    def is_unsupported_version_blocked(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_unsupported_version_blocked(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_unsupported_version_blocked", value)

    @property
    @pulumi.getter(name="isUntrustedIssuerBlocked")
    def is_untrusted_issuer_blocked(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_untrusted_issuer_blocked(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class NetworkFirewallPolicyDecryptionProfile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            network_firewall_policy_id: Optional[pulumi.Input[builtins.str]] = None,
            parent_resource_id: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkFirewallPolicyDecryptionProfile':
        """
    ...
    @property
    @pulumi.getter(name="areCertificateExtensionsRestricted")
    def are_certificate_extensions_restricted(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Whether to block sessions if the server's certificate uses extensions other than key usage and/or extended key usage.
        """
        return pulumi.get(self, "are_certificate_extensions_restricted")
    ...
    @property
    @pulumi.getter(name="isAutoIncludeAltName")
    def is_auto_include_alt_name(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Whether to automatically append SAN to impersonating certificate if server certificate is missing SAN.
        """
        return pulumi.get(self, "is_auto_include_alt_name")
    ...
    @property
    @pulumi.getter(name="isExpiredCertificateBlocked")
    def is_expired_certificate_blocked(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Whether to block sessions if server's certificate is expired.
        """
        return pulumi.get(self, "is_expired_certificate_blocked")
    ...
    @property
    @pulumi.getter(name="isOutOfCapacityBlocked")
    def is_out_of_capacity_blocked(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Whether to block sessions if the firewall is temporarily unable to decrypt their traffic.
        """
        return pulumi.get(self, "is_out_of_capacity_blocked")
    ...
    @property
    @pulumi.getter(name="isRevocationStatusTimeoutBlocked")
    def is_revocation_status_timeout_blocked(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Whether to block sessions if the revocation status check for server's certificate does not succeed within the maximum allowed time (defaulting to 5 seconds).
        """
        return pulumi.get(self, "is_revocation_status_timeout_blocked")
    ...
    @property
    @pulumi.getter(name="isUnknownRevocationStatusBlocked")
    def is_unknown_revocation_status_blocked(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Whether to block sessions if the revocation status check for server's certificate results in "unknown".
        """
        return pulumi.get(self, "is_unknown_revocation_status_blocked")
    ...
    @property
    @pulumi.getter(name="isUnsupportedCipherBlocked")
    def is_unsupported_cipher_blocked(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Whether to block sessions if SSL cipher suite is not supported.
        """
        return pulumi.get(self, "is_unsupported_cipher_blocked")
    ...
    @property
    @pulumi.getter(name="isUnsupportedVersionBlocked")
    def is_unsupported_version_blocked(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Whether to block sessions if SSL version is not supported.
        """
        return pulumi.get(self, "is_unsupported_version_blocked")
    ...
    @property
    @pulumi.getter(name="isUntrustedIssuerBlocked")
    def is_untrusted_issuer_blocked(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Whether to block sessions if server's certificate is issued by an untrusted certificate authority (CA).
        """
        return pulumi.get(self, "is_untrusted_issuer_blocked")
