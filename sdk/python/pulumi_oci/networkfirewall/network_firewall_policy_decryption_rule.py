...
class NetworkFirewallPolicyDecryptionRuleArgs:
    def __init__(__self__, *,
                 ...
                 decryption_profile: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] decryption_profile: (Updatable) The name of the decryption profile to use.
        :param pulumi.Input[builtins.str] name: Name for the decryption rule, must be unique within the policy.
        ...
        :param pulumi.Input[builtins.str] secret: (Updatable) The name of a mapped secret. Its `type` must match that of the specified decryption profile.
        """
    ...
    def decryption_profile(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def decryption_profile(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _NetworkFirewallPolicyDecryptionRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name for the decryption rule, must be unique within the policy.
        :param pulumi.Input[builtins.str] network_firewall_policy_id: Unique Network Firewall Policy identifier
        :param pulumi.Input[builtins.str] parent_resource_id: OCID of the Network Firewall Policy this decryption rule belongs to.
        :param pulumi.Input['NetworkFirewallPolicyDecryptionRulePositionArgs'] position: (Updatable) An object which defines the position of the rule. Only one of `after_rule` or `before_rule` should be provided.
        :param pulumi.Input[builtins.str] secret: (Updatable) The name of a mapped secret. Its `type` must match that of the specified decryption profile.
        """
...
class NetworkFirewallPolicyDecryptionRule(pulumi.CustomResource):
    ...
    pulumi_type = "oci:NetworkFirewall/networkFirewallPolicyDecryptionRule:NetworkFirewallPolicyDecryptionRule"
    ...
    def get(resource_name: str,
            ...
            position: Optional[pulumi.Input[Union['NetworkFirewallPolicyDecryptionRulePositionArgs', 'NetworkFirewallPolicyDecryptionRulePositionArgsDict']]] = None,
            priority_order: Optional[pulumi.Input[builtins.str]] = None,
            secret: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkFirewallPolicyDecryptionRule':
        """
    ...
    @property
    @pulumi.getter(name="decryptionProfile")
    def decryption_profile(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (Updatable) The name of the decryption profile to use.
        """
        return pulumi.get(self, "decryption_profile")
    ...
    @property
    @pulumi.getter(name="priorityOrder")
    def priority_order(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "priority_order")
