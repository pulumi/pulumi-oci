...
class NetworkFirewallPolicySecurityRuleArgs:
    def __init__(__self__, *,
                 ...
                 inspection: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] action: (Updatable) Types of Action on the Traffic flow.
        ...
        :param pulumi.Input[builtins.str] inspection: (Updatable) Type of inspection to affect the traffic flow. This is only applicable if action is INSPECT.
               * INTRUSION_DETECTION - Intrusion Detection.
               * INTRUSION_PREVENTION - Intrusion Detection and Prevention. Traffic classified as potentially malicious will be rejected as described in `type`.
        :param pulumi.Input[builtins.str] name: Name for the Security rule, must be unique within the policy.
    ...
    @property
    @pulumi.getter
    def inspection(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @inspection.setter
    def inspection(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _NetworkFirewallPolicySecurityRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name for the Security rule, must be unique within the policy.
        :param pulumi.Input[builtins.str] network_firewall_policy_id: Unique Network Firewall Policy identifier
        :param pulumi.Input[builtins.str] parent_resource_id: OCID of the Network Firewall Policy this security rule belongs to.
        :param pulumi.Input[Sequence[pulumi.Input['NetworkFirewallPolicySecurityRulePositionArgs']]] positions: (Updatable) An object which defines the position of the rule. Only one of the following position references should be provided.
        """
...
class NetworkFirewallPolicySecurityRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            parent_resource_id: Optional[pulumi.Input[builtins.str]] = None,
            positions: Optional[pulumi.Input[Sequence[pulumi.Input[Union['NetworkFirewallPolicySecurityRulePositionArgs', 'NetworkFirewallPolicySecurityRulePositionArgsDict']]]]] = None,
            priority_order: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkFirewallPolicySecurityRule':
        """
    ...
    @property
    @pulumi.getter
    def inspection(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (Updatable) Type of inspection to affect the traffic flow. This is only applicable if action is INSPECT.
        * INTRUSION_DETECTION - Intrusion Detection.
        * INTRUSION_PREVENTION - Intrusion Detection and Prevention. Traffic classified as potentially malicious will be rejected as described in `type`.
