...
class NetworkFirewallPolicyServiceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: Describes the type of Service. The accepted values are 
...
class _NetworkFirewallPolicyServiceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name of the service
        :param pulumi.Input[builtins.str] network_firewall_policy_id: Unique Network Firewall Policy identifier
        :param pulumi.Input[builtins.str] parent_resource_id: OCID of the Network Firewall Policy this service belongs to.
        :param pulumi.Input[Sequence[pulumi.Input['NetworkFirewallPolicyServicePortRangeArgs']]] port_ranges: (Updatable) List of port-ranges to be used.
        :param pulumi.Input[builtins.str] type: Describes the type of Service. The accepted values are 
...
class NetworkFirewallPolicyService(pulumi.CustomResource):
    ...
    pulumi_type = "oci:NetworkFirewall/networkFirewallPolicyService:NetworkFirewallPolicyService"
    ...
    def get(resource_name: str,
            ...
            parent_resource_id: Optional[pulumi.Input[builtins.str]] = None,
            port_ranges: Optional[pulumi.Input[Sequence[pulumi.Input[Union['NetworkFirewallPolicyServicePortRangeArgs', 'NetworkFirewallPolicyServicePortRangeArgsDict']]]]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkFirewallPolicyService':
        """
