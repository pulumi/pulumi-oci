...
class NetworkFirewallPolicyTunnelInspectionRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] protocol: (Updatable) Types of Tunnel Inspection Protocol to be applied on the traffic.
               * VXLAN - VXLAN Tunnel Inspection Protocol will be applied on the traffic.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] action: (Updatable) Types of Inspect Action on the traffic flow.
               * INSPECT - Inspect the traffic.
               * INSPECT_AND_CAPTURE_LOG - Inspect and capture logs for the traffic.
        :param pulumi.Input[builtins.str] name: Name for the Tunnel Inspection Rule, must be unique within the policy.
...
class _NetworkFirewallPolicyTunnelInspectionRuleState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: Name for the Tunnel Inspection Rule, must be unique within the policy.
        :param pulumi.Input[builtins.str] network_firewall_policy_id: Unique Network Firewall Policy identifier
        :param pulumi.Input[builtins.str] parent_resource_id: OCID of the Network Firewall Policy this Tunnel Inspection Rule belongs to.
        :param pulumi.Input['NetworkFirewallPolicyTunnelInspectionRulePositionArgs'] position: (Updatable) An object which defines the position of the rule.
...
class NetworkFirewallPolicyTunnelInspectionRule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            priority_order: Optional[pulumi.Input[builtins.str]] = None,
            profile: Optional[pulumi.Input[Union['NetworkFirewallPolicyTunnelInspectionRuleProfileArgs', 'NetworkFirewallPolicyTunnelInspectionRuleProfileArgsDict']]] = None,
            protocol: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkFirewallPolicyTunnelInspectionRule':
        """
