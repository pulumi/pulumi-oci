...
class _NetworkFirewallPolicyUrlListState:
    def __init__(__self__, *,
                 ...
                 total_urls: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] name: Unique name to identify the group of urls to be used in the policy rules.
        :param pulumi.Input[builtins.str] network_firewall_policy_id: Unique Network Firewall Policy identifier
        :param pulumi.Input[builtins.str] parent_resource_id: OCID of the Network Firewall Policy this URL List belongs to.
        :param pulumi.Input[builtins.int] total_urls: Total count of URLs in the URL List
        :param pulumi.Input[Sequence[pulumi.Input['NetworkFirewallPolicyUrlListUrlArgs']]] urls: (Updatable) List of urls.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
    ...
    def total_urls(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @total_urls.setter
    def total_urls(self, value: Optional[pulumi.Input[builtins.int]]):
...
class NetworkFirewallPolicyUrlList(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="totalUrls")
    def total_urls(self) -> pulumi.Output[builtins.int]:
        """
        Total count of URLs in the URL List
        """
        return pulumi.get(self, "total_urls")
