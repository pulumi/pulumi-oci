...
class NetworkFirewallPolicyDecryptionRuleCondition(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] destination_addresses: (Updatable) An array of address list names to be evaluated against the traffic destination address.
        :param Sequence[builtins.str] source_addresses: (Updatable) An array of address list names to be evaluated against the traffic source address.
        """
...
class NetworkFirewallPolicySecurityRuleCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 source_addresses: Optional[Sequence[builtins.str]] = None,
                 urls: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] applications: (Updatable) An array of application group names to be evaluated against the traffic protocol and protocol-specific parameters.
        :param Sequence[builtins.str] destination_addresses: (Updatable) An array of address list names to be evaluated against the traffic destination address.
        :param Sequence[builtins.str] services: (Updatable) An array of service list names to be evaluated against the traffic protocol and protocol-specific parameters.
        :param Sequence[builtins.str] source_addresses: (Updatable) An array of address list names to be evaluated against the traffic source address.
        :param Sequence[builtins.str] urls: (Updatable) An array of URL list names to be evaluated against the HTTP(S) request target.
        """
    ...
    @property
    @pulumi.getter
    def urls(self) -> Optional[Sequence[builtins.str]]:
        """
...
class NetworkFirewallPolicyServicePortRange(dict):
    ...
    def __init__(__self__, *,
                 minimum_port: builtins.int,
                 maximum_port: Optional[builtins.int] = None):
        """
        :param builtins.int minimum_port: (Updatable) The minimum port in the range (inclusive), or the sole port of a single-port range.
        :param builtins.int maximum_port: (Updatable) The maximum port in the range (inclusive), which may be absent for a single-port range.
        """
    ...
    def minimum_port(self) -> builtins.int:
        """
    ...
    def maximum_port(self) -> Optional[builtins.int]:
        """
...
class NetworkFirewallPolicyTunnelInspectionRuleProfile(dict):
    ...
    def __init__(__self__, *,
                 must_return_traffic_to_source: Optional[builtins.bool] = None):
        """
        :param builtins.bool must_return_traffic_to_source: (Updatable) Return scanned VXLAN tunnel traffic to source.
        """
    ...
    def must_return_traffic_to_source(self) -> Optional[builtins.bool]:
        """
...
class GetNetworkFirewallPoliciesNetworkFirewallPolicySummaryCollectionItemResult(dict):
    def __init__(__self__, *,
                 attached_network_firewall_count: builtins.int,
        ...
        """
        :param builtins.int attached_network_firewall_count: Count of number of Network Firewall attached to the Policy.
        ...
        :param builtins.str time_created: The time instant at which the Network Firewall Policy was created in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339). Example: `2016-08-25T21:10:29.600Z`
        :param builtins.str time_updated: The time instant at which the Network Firewall Policy was updated in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339). Example: `2016-08-25T21:10:29.600Z`
        """
    ...
    def attached_network_firewall_count(self) -> builtins.int:
        """
...
class GetNetworkFirewallPolicyAddressListsAddressListSummaryCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 total_addresses: builtins.int,
                 type: builtins.str):
        """
        :param Sequence[builtins.str] addresses: List of addresses.
        ...
        :param builtins.str parent_resource_id: OCID of the Network Firewall Policy this Address List belongs to.
        :param builtins.int total_addresses: Count of total Addresses in the AddressList
        :param builtins.str type: Type of address list.
        """
...
class GetNetworkFirewallPolicyApplicationGroupsApplicationGroupSummaryCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 network_firewall_policy_id: builtins.str,
                 parent_resource_id: builtins.str,
                 total_apps: builtins.int):
        """
        :param Sequence[builtins.str] apps: List of apps in the group.
        :param builtins.str name: Name of the application Group.
        :param builtins.str network_firewall_policy_id: Unique Network Firewall Policy identifier
        :param builtins.str parent_resource_id: OCID of the Network Firewall Policy this application group belongs to.
        :param builtins.int total_apps: Count of total applications in the given application group.
        """
...
class GetNetworkFirewallPolicyApplicationsApplicationSummaryCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.int icmp_code: The value of the ICMP6 message Code (subtype) field as defined by [RFC 4443](https://www.rfc-editor.org/rfc/rfc4443.html#section-2.1).
        :param builtins.int icmp_type: The value of the ICMP6 message Type field as defined by [RFC 4443](https://www.rfc-editor.org/rfc/rfc4443.html#section-2.1).
        :param builtins.str name: Name of the application.
        :param builtins.str network_firewall_policy_id: Unique Network Firewall Policy identifier
        :param builtins.str parent_resource_id: OCID of the Network Firewall Policy this application belongs to.
        :param builtins.str type: Describes the type of Application.
        """
...
class GetNetworkFirewallPolicyDecryptionProfilesDecryptionProfileSummaryCollectionItemResult(dict):
    def __init__(__self__, *,
                 are_certificate_extensions_restricted: builtins.bool,
                 is_auto_include_alt_name: builtins.bool,
                 is_expired_certificate_blocked: builtins.bool,
                 is_out_of_capacity_blocked: builtins.bool,
                 is_revocation_status_timeout_blocked: builtins.bool,
                 is_unknown_revocation_status_blocked: builtins.bool,
                 is_unsupported_cipher_blocked: builtins.bool,
                 is_unsupported_version_blocked: builtins.bool,
                 is_untrusted_issuer_blocked: builtins.bool,
                 name: builtins.str,
                 network_firewall_policy_id: builtins.str,
                 parent_resource_id: builtins.str,
                 type: builtins.str):
        """
        :param builtins.bool are_certificate_extensions_restricted: Whether to block sessions if the server's certificate uses extensions other than key usage and/or extended key usage.
        :param builtins.bool is_auto_include_alt_name: Whether to automatically append SAN to impersonating certificate if server certificate is missing SAN.
        :param builtins.bool is_expired_certificate_blocked: Whether to block sessions if server's certificate is expired.
        :param builtins.bool is_out_of_capacity_blocked: Whether to block sessions if the firewall is temporarily unable to decrypt their traffic.
        :param builtins.bool is_revocation_status_timeout_blocked: Whether to block sessions if the revocation status check for server's certificate does not succeed within the maximum allowed time (defaulting to 5 seconds).
        :param builtins.bool is_unknown_revocation_status_blocked: Whether to block sessions if the revocation status check for server's certificate results in "unknown".
        :param builtins.bool is_unsupported_cipher_blocked: Whether to block sessions if SSL cipher suite is not supported.
        :param builtins.bool is_unsupported_version_blocked: Whether to block sessions if SSL version is not supported.
        :param builtins.bool is_untrusted_issuer_blocked: Whether to block sessions if server's certificate is issued by an untrusted certificate authority (CA).
        ...
        :param builtins.str type: Describes the type of Decryption Profile SslForwardProxy or SslInboundInspection.
        """
...
class GetNetworkFirewallPolicyDecryptionRulesDecryptionRuleSummaryCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 decryption_profile: Optional[builtins.str] = None,
                 priority_order: Optional[builtins.str] = None,
        ...
        :param builtins.str network_firewall_policy_id: Unique Network Firewall Policy identifier
        :param builtins.str parent_resource_id: OCID of the Network Firewall Policy this decryption rule belongs to.
        ...
        :param builtins.str decryption_profile: The name of the decryption profile to use.
        :param builtins.str secret: The name of a mapped secret. Its `type` must match that of the specified decryption profile.
        """
    ...
    def decryption_profile(self) -> Optional[builtins.str]:
        """
    ...
    def priority_order(self) -> Optional[builtins.str]:
...
class GetNetworkFirewallPolicyMappedSecretsMappedSecretSummaryCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str network_firewall_policy_id: Unique Network Firewall Policy identifier
        :param builtins.str parent_resource_id: OCID of the Network Firewall Policy this Mapped Secret belongs to.
        :param builtins.str source: Source of the secrets, where the secrets are stored.
        :param builtins.str type: Type of the secrets mapped based on the policy.
               * `SSL_INBOUND_INSPECTION`: For Inbound inspection of SSL traffic.
               * `SSL_FORWARD_PROXY`: For forward proxy certificates for SSL inspection.
        :param builtins.str vault_secret_id: OCID for the Vault Secret to be used.
        :param builtins.int version_number: Version number of the secret to be used.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "network_firewall_policy_id", network_firewall_policy_id)
        pulumi.set(__self__, "parent_resource_id", parent_resource_id)
    ...
    def version_number(self) -> builtins.int:
        """
...
class GetNetworkFirewallPolicySecurityRuleConditionResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] applications: An array of application list names to be evaluated against the traffic protocol and protocol-specific parameters.
        :param Sequence[builtins.str] destination_addresses: An array of IP address list names to be evaluated against the traffic destination address.
        :param Sequence[builtins.str] services: An array of service list names to be evaluated against the traffic protocol and protocol-specific parameters.
        :param Sequence[builtins.str] source_addresses: An array of IP address list names to be evaluated against the traffic source address.
        :param Sequence[builtins.str] urls: An array of URL pattern list names to be evaluated against the HTTP(S) request target.
        """
        pulumi.set(__self__, "applications", applications)
        pulumi.set(__self__, "destination_addresses", destination_addresses)
        pulumi.set(__self__, "services", services)
...
class GetNetworkFirewallPolicySecurityRulesSecurityRuleSummaryCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 inspection: Optional[builtins.str] = None,
                 priority_order: Optional[builtins.str] = None):
        """
        :param builtins.str action: Types of Action on the Traffic flow.
        ...
        :param builtins.str name: Name for the Security rule, must be unique within the policy.
        :param builtins.str network_firewall_policy_id: Unique Network Firewall Policy identifier
        :param builtins.str parent_resource_id: OCID of the Network Firewall Policy this security rule belongs to.
        ...
        :param builtins.str inspection: Type of inspection to affect the Traffic flow. This is only applicable if action is INSPECT.
    ...
    @property
    @pulumi.getter
    def inspection(self) -> Optional[builtins.str]:
        """
...
class GetNetworkFirewallPolicyServiceListsServiceListSummaryCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 parent_resource_id: builtins.str,
                 services: Sequence[builtins.str],
                 total_services: builtins.int):
        """
        :param builtins.str name: Name of the service Group.
        :param builtins.str network_firewall_policy_id: Unique Network Firewall Policy identifier
        :param builtins.str parent_resource_id: OCID of the Network Firewall Policy this serviceList belongs to.
        :param Sequence[builtins.str] services: List of services in the group.
        :param builtins.int total_services: Count of total services in the given service List.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "network_firewall_policy_id", network_firewall_policy_id)
        pulumi.set(__self__, "parent_resource_id", parent_resource_id)
...
class GetNetworkFirewallPolicyServicePortRangeResult(dict):
    def __init__(__self__, *,
                 maximum_port: builtins.int,
                 minimum_port: builtins.int):
        """
        :param builtins.int maximum_port: The maximum port in the range (inclusive), which may be absent for a single-port range.
        :param builtins.int minimum_port: The minimum port in the range (inclusive), or the sole port of a single-port range.
        """
        pulumi.set(__self__, "maximum_port", maximum_port)
        pulumi.set(__self__, "minimum_port", minimum_port)
    ...
    @property
    @pulumi.getter(name="maximumPort")
    def maximum_port(self) -> builtins.int:
        """
...
class GetNetworkFirewallPolicyServicesServiceSummaryCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str name: Name of the service.
        :param builtins.str network_firewall_policy_id: Unique Network Firewall Policy identifier
        :param builtins.str parent_resource_id: OCID of the Network Firewall Policy this service belongs to.
        ...
        :param builtins.str type: Describes the type of Service.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "network_firewall_policy_id", network_firewall_policy_id)
        pulumi.set(__self__, "parent_resource_id", parent_resource_id)
...
class GetNetworkFirewallPolicyTunnelInspectionRuleConditionResult(dict):
    def __init__(__self__, *,
                 ...
                 source_addresses: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] destination_addresses: An array of address list names to be evaluated against the traffic destination address.
        :param Sequence[builtins.str] source_addresses: An array of address list names to be evaluated against the traffic source address.
        """
        pulumi.set(__self__, "destination_addresses", destination_addresses)
        pulumi.set(__self__, "source_addresses", source_addresses)
...
class GetNetworkFirewallPolicyTunnelInspectionRuleProfileResult(dict):
    def __init__(__self__, *,
                 must_return_traffic_to_source: builtins.bool):
        """
        :param builtins.bool must_return_traffic_to_source: Return scanned VXLAN tunnel traffic to source.
        """
        pulumi.set(__self__, "must_return_traffic_to_source", must_return_traffic_to_source)

    @property
    @pulumi.getter(name="mustReturnTrafficToSource")
    def must_return_traffic_to_source(self) -> builtins.bool:
        """
...
class GetNetworkFirewallPolicyTunnelInspectionRulesTunnelInspectionRuleSummaryCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: Types of Inspect Action on the Traffic flow.
        ...
        :param builtins.str name: Name for the Tunnel Inspection Rule, must be unique within the policy.
        :param builtins.str network_firewall_policy_id: Unique Network Firewall Policy identifier
        :param builtins.str parent_resource_id: OCID of the Network Firewall Policy this Tunnel Inspection Rule belongs to.
        ...
        :param builtins.str protocol: Types of Tunnel Inspection Protocol to be applied on the traffic.
...
class GetNetworkFirewallPolicyUrlListUrlResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str pattern: A string consisting of a concatenation of optional host component and optional path component. The host component may start with `*.` to match the case-insensitive domain and all its subdomains. The path component must start with a `/`, and may end with `*` to match all paths of which it is a case-sensitive prefix. A missing host component matches all request domains, and a missing path component matches all request paths. An empty value matches all requests.
        :param builtins.str type: The type of pattern.
...
class GetNetworkFirewallPolicyUrlListsUrlListSummaryCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 network_firewall_policy_id: builtins.str,
                 parent_resource_id: builtins.str,
                 total_urls: builtins.int,
                 urls: Sequence['outputs.GetNetworkFirewallPolicyUrlListsUrlListSummaryCollectionItemUrlResult']):
        """
        :param builtins.str name: Unique name identifier for the URL list.
        :param builtins.str network_firewall_policy_id: Unique Network Firewall Policy identifier
        :param builtins.str parent_resource_id: OCID of the Network Firewall Policy this URL List belongs to.
        :param builtins.int total_urls: Total count of URLs in the URL List
...
class GetNetworkFirewallsNetworkFirewallCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str state: A filter to return only resources with a lifecycleState matching the given value.
        :param builtins.str subnet_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet associated with the Network Firewall.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The time at which the Network Firewall was created in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339). Example: `2016-08-25T21:10:29.600Z`
        :param builtins.str time_updated: The time at which the Network Firewall was updated in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339). Example: `2016-08-25T21:10:29.600Z`
        """
    ...
    @property
    @pulumi.getter
    def ipv4address(self) -> builtins.str:
        """
