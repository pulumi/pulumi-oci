...
def get_backend_health(backend_name: Optional[builtins.str] = None,
    ...
    :param builtins.str backend_set_name: The name of the backend set associated with the backend server for which to retrieve the health status.  Example: `example_backend_set`
...
def get_backend_health_output(backend_name: Optional[pulumi.Input[builtins.str]] = None,
