...
def get_backends(backend_set_name: Optional[str] = None,
    ...
    test_backends = oci.NetworkLoadBalancer.get_backends(backend_set_name=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetBackendsResult(
        backend_collections=__ret__.backend_collections,
