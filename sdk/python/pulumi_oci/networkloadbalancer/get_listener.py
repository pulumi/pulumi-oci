...
def get_listener(listener_name: Optional[builtins.str] = None,
    ...
    :param builtins.str listener_name: The name of the listener to get.  Example: `example_listener`
...
def get_listener_output(listener_name: Optional[pulumi.Input[builtins.str]] = None,
