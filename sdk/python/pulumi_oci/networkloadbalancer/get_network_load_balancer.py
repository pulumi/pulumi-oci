...
def get_network_load_balancer(network_load_balancer_id: Optional[builtins.str] = None,
...
def get_network_load_balancer_output(network_load_balancer_id: Optional[pulumi.Input[builtins.str]] = None,
