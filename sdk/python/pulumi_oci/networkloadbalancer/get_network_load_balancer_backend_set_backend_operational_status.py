...
def get_network_load_balancer_backend_set_backend_operational_status(backend_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str backend_set_name: The name of the backend set associated with the backend server for which to retrieve the operational status.  Example: `example_backend_set`
