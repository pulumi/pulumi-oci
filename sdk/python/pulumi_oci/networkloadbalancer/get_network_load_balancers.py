...
def get_network_load_balancers(compartment_id: Optional[builtins.str] = None,
...
def get_network_load_balancers_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
