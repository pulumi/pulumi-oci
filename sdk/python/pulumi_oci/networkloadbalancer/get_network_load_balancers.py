...
def get_network_load_balancers(compartment_id: Optional[str] = None,
    ...
    test_network_load_balancers = oci.NetworkLoadBalancer.get_network_load_balancers(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
