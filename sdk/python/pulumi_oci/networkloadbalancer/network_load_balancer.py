...
class NetworkLoadBalancerArgs:
    def __init__(__self__, *,
                 ...
                 assigned_ipv6: Optional[pulumi.Input[builtins.str]] = None,
                 assigned_private_ipv4: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_preserve_source_destination: Optional[pulumi.Input[builtins.bool]] = None,
                 is_private: Optional[pulumi.Input[builtins.bool]] = None,
                 is_symmetric_hash_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 network_security_group_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 nlb_ip_version: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 subnet_ipv6cidr: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a NetworkLoadBalancer resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the network load balancer.
        :param pulumi.Input[builtins.str] display_name: (Updatable) Network load balancer identifier, which can be renamed.
        :param pulumi.Input[builtins.str] subnet_id: The subnet in which the network load balancer is spawned [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param pulumi.Input[builtins.str] assigned_ipv6: IPv6 address to be assigned to the network load balancer being created. This IP address has to be part of one of the prefixes supported by the subnet. Example: "2607:9b80:9a0a:9a7e:abcd:ef01:2345:6789"
        :param pulumi.Input[builtins.str] assigned_private_ipv4: Private IP address to be assigned to the network load balancer being created. This IP address has to be in the CIDR range of the subnet where network load balancer is being created Example: "10.0.0.1"
        ...
        :param pulumi.Input[builtins.bool] is_private: Whether the network load balancer has a virtual cloud network-local (private) IP address.
               ...
               Example: `true`
        :param pulumi.Input[builtins.bool] is_symmetric_hash_enabled: (Updatable) This can only be enabled when NLB is working in transparent mode with source destination header preservation enabled.  This removes the additional dependency from NLB backends(like Firewalls) to perform SNAT. 
               
               Example: `true`
               Example: `true`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] network_security_group_ids: (Updatable) An array of network security groups [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) associated with the network load balancer.
        ...
        :param pulumi.Input[builtins.str] nlb_ip_version: (Updatable) IP version associated with the NLB.
        :param pulumi.Input[Sequence[pulumi.Input['NetworkLoadBalancerReservedIpArgs']]] reserved_ips: An array of reserved Ips.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] security_attributes: (Updatable) ZPR tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"oracle-zpr": {"td": {"value": "42", "mode": "audit"}}}`
        :param pulumi.Input[builtins.str] subnet_ipv6cidr: IPv6 subnet prefix selection. If Ipv6 subnet prefix is passed, Nlb Ipv6 Address would be assign within the cidr block. NLB has to be dual or single stack ipv6 to support this.
    ...
    def assigned_ipv6(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def assigned_ipv6(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "assigned_ipv6", value)

    @property
    @pulumi.getter(name="assignedPrivateIpv4")
    def assigned_private_ipv4(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def assigned_private_ipv4(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_preserve_source_destination(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) This parameter can be enabled only if backends are compute OCIDs. When enabled, the skipSourceDestinationCheck parameter is automatically enabled on the load balancer VNIC, and packets are sent to the backend with the entire IP header intact.
        """
    ...
    def is_preserve_source_destination(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def is_symmetric_hash_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_symmetric_hash_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def nlb_ip_version(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nlb_ip_version(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def subnet_ipv6cidr(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def subnet_ipv6cidr(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _NetworkLoadBalancerState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input['NetworkLoadBalancerReservedIpArgs']]] reserved_ips: An array of reserved Ips.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] security_attributes: (Updatable) ZPR tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"oracle-zpr": {"td": {"value": "42", "mode": "audit"}}}`
        :param pulumi.Input[builtins.str] state: The current state of the network load balancer.
        :param pulumi.Input[builtins.str] subnet_id: The subnet in which the network load balancer is spawned [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param pulumi.Input[builtins.str] subnet_ipv6cidr: IPv6 subnet prefix selection. If Ipv6 subnet prefix is passed, Nlb Ipv6 Address would be assign within the cidr block. NLB has to be dual or single stack ipv6 to support this.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] system_tags: Key-value pair representing system tags' keys and values scoped to a namespace. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.str] time_created: The date and time the network load balancer was created, in the format defined by RFC3339.  Example: `2020-05-01T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_updated: The time the network load balancer was updated. An RFC3339 formatted date-time string.  Example: `2020-05-01T22:10:29.600Z`
        """
        if assigned_ipv6 is not None:
            pulumi.set(__self__, "assigned_ipv6", assigned_ipv6)
        if assigned_private_ipv4 is not None:
...
class NetworkLoadBalancer(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'NetworkLoadBalancer':
        """
    ...
    @property
    @pulumi.getter(name="assignedIpv6")
    def assigned_ipv6(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        IPv6 address to be assigned to the network load balancer being created. This IP address has to be part of one of the prefixes supported by the subnet. Example: "2607:9b80:9a0a:9a7e:abcd:ef01:2345:6789"
        """
        return pulumi.get(self, "assigned_ipv6")
    ...
    @property
    @pulumi.getter(name="assignedPrivateIpv4")
    def assigned_private_ipv4(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Private IP address to be assigned to the network load balancer being created. This IP address has to be in the CIDR range of the subnet where network load balancer is being created Example: "10.0.0.1"
        """
        return pulumi.get(self, "assigned_private_ipv4")
    ...
    @property
    @pulumi.getter(name="isPreserveSourceDestination")
    def is_preserve_source_destination(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) This parameter can be enabled only if backends are compute OCIDs. When enabled, the skipSourceDestinationCheck parameter is automatically enabled on the load balancer VNIC, and packets are sent to the backend with the entire IP header intact.
        """
        return pulumi.get(self, "is_preserve_source_destination")
    ...
    @property
    @pulumi.getter(name="isSymmetricHashEnabled")
    def is_symmetric_hash_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) This can only be enabled when NLB is working in transparent mode with source destination header preservation enabled.  This removes the additional dependency from NLB backends(like Firewalls) to perform SNAT. 
    ...
    @property
    @pulumi.getter(name="networkSecurityGroupIds")
    def network_security_group_ids(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        (Updatable) An array of network security groups [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) associated with the network load balancer.
    ...
    @property
    @pulumi.getter(name="nlbIpVersion")
    def nlb_ip_version(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) IP version associated with the NLB.
        """
        return pulumi.get(self, "nlb_ip_version")
    ...
    @property
    @pulumi.getter(name="subnetIpv6cidr")
    def subnet_ipv6cidr(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        IPv6 subnet prefix selection. If Ipv6 subnet prefix is passed, Nlb Ipv6 Address would be assign within the cidr block. NLB has to be dual or single stack ipv6 to support this.
