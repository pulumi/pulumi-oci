...
class BackendSetBackend(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_drain: Optional[builtins.bool] = None,
                 is_offline: Optional[builtins.bool] = None,
                 name: Optional[builtins.str] = None,
                 target_id: Optional[builtins.str] = None,
                 weight: Optional[builtins.int] = None):
        """
        :param builtins.int port: (Updatable) The communication port for the backend server.  Example: `8080`
        :param builtins.str ip_address: (Updatable) The IP address of the backend server.  Example: `10.0.0.3`
        :param builtins.bool is_backup: (Updatable) Whether the network load balancer should treat this server as a backup unit. If `true`, then the network load balancer forwards no ingress traffic to this backend server unless all other backend servers not marked as "isBackup" fail the health check policy.  Example: `false`
        :param builtins.bool is_drain: (Updatable) Whether the network load balancer should drain this server. Servers marked "isDrain" receive no incoming traffic.  Example: `false`
        :param builtins.bool is_offline: (Updatable) Whether the network load balancer should treat this server as offline. Offline servers receive no incoming traffic.  Example: `false`
        :param builtins.str name: (Updatable) A read-only field showing the IP address/OCID and port that uniquely identify this backend server in the backend set.  Example: `10.0.0.3:8080`, or `ocid1.privateip..oc1.<var>&lt;unique_ID&gt;</var>:443` or `10.0.0.3:0`
        :param builtins.str target_id: (Updatable) The IP OCID/Instance OCID associated with the backend server. Example: `ocid1.privateip..oc1.<var>&lt;unique_ID&gt;</var>`
        :param builtins.int weight: (Updatable) The network load balancing policy weight assigned to the server. Backend servers with a higher weight receive a larger proportion of incoming traffic. For example, a server weighted '3' receives three times the number of new connections as a server weighted '1'. For more information about load balancing policies, see [Network Load Balancer Policies](https://docs.cloud.oracle.com/iaas/Content/NetworkLoadBalancer/introduction.htm#Policies).  Example: `3`
        """
    ...
    def is_drain(self) -> Optional[builtins.bool]:
        """
    ...
    def is_offline(self) -> Optional[builtins.bool]:
        """
...
class BackendSetHealthChecker(dict):
    ...
    def __init__(__self__, *,
                 ...
                 interval_in_millis: Optional[builtins.int] = None,
                 port: Optional[builtins.int] = None,
                 request_data: Optional[builtins.str] = None,
                 response_body_regex: Optional[builtins.str] = None,
                 response_data: Optional[builtins.str] = None,
                 retries: Optional[builtins.int] = None,
                 return_code: Optional[builtins.int] = None,
                 timeout_in_millis: Optional[builtins.int] = None,
                 url_path: Optional[builtins.str] = None):
        """
        :param builtins.str protocol: (Updatable) The protocol the health check must use; either HTTP, HTTPS, UDP, TCP or DNS.  Example: `HTTP`
        :param 'BackendSetHealthCheckerDnsArgs' dns: (Updatable) DNS healthcheck configurations.
        :param builtins.int interval_in_millis: (Updatable) The interval between health checks, in milliseconds. The default value is 10000 (10 seconds).  Example: `10000`
        :param builtins.int port: (Updatable) The backend server port against which to run the health check. If the port is not specified, then the network load balancer uses the port information from the `Backend` object. The port must be specified if the backend port is 0.  Example: `8080`
        :param builtins.str request_data: (Updatable) Base64 encoded pattern to be sent as UDP or TCP health check probe.
        :param builtins.str response_body_regex: (Updatable) A regular expression for parsing the response body from the backend server.  Example: `^((?!false).|\\s)*$`
        :param builtins.str response_data: (Updatable) Base64 encoded pattern to be validated as UDP or TCP health check probe response.
        :param builtins.int retries: (Updatable) The number of retries to attempt before a backend server is considered "unhealthy". This number also applies when recovering a server to the "healthy" state. The default value is 3.  Example: `3`
        :param builtins.int return_code: (Updatable) The status code a healthy backend server should return. If you configure the health check policy to use the HTTP protocol, then you can use common HTTP status codes such as "200".  Example: `200`
        :param builtins.int timeout_in_millis: (Updatable) The maximum time, in milliseconds, to wait for a reply to a health check. A health check is successful only if a reply returns within this timeout period. The default value is 3000 (3 seconds).  Example: `3000`
        :param builtins.str url_path: (Updatable) The path against which to run the health check.  Example: `/healthcheck`
        """
    ...
    def interval_in_millis(self) -> Optional[builtins.int]:
        """
    ...
    def request_data(self) -> Optional[builtins.str]:
        """
    ...
    def response_body_regex(self) -> Optional[builtins.str]:
        """
    ...
    def response_data(self) -> Optional[builtins.str]:
        """
    ...
    def return_code(self) -> Optional[builtins.int]:
        """
...
class BackendSetHealthCheckerDns(dict):
    ...
    def __init__(__self__, *,
                 ...
                 query_class: Optional[builtins.str] = None,
                 query_type: Optional[builtins.str] = None,
                 rcodes: Optional[Sequence[builtins.str]] = None,
                 transport_protocol: Optional[builtins.str] = None):
        """
        :param builtins.str domain_name: (Updatable) The absolute fully-qualified domain name to perform periodic DNS queries. If not provided, an extra dot will be added at the end of a domain name during the query.
        :param builtins.str query_class: (Updatable) The class the dns health check query to use; either IN or CH.  Example: `IN`
        :param builtins.str query_type: (Updatable) The type the dns health check query to use; A, AAAA, TXT.  Example: `A`
        :param Sequence[builtins.str] rcodes: (Updatable) An array that represents accepetable RCODE values for DNS query response. Example: ["NOERROR", "NXDOMAIN"]
        :param builtins.str transport_protocol: (Updatable) DNS transport protocol; either UDP or TCP.  Example: `UDP`
        """
    ...
    def query_class(self) -> Optional[builtins.str]:
        """
    ...
    @property
    @pulumi.getter
    def rcodes(self) -> Optional[Sequence[builtins.str]]:
        """
...
class NetworkLoadBalancerIpAddress(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str ip_address: An IP address.  Example: `192.168.0.3`
        :param builtins.str ip_version: IP version associated with the listener.
        :param builtins.bool is_public: Whether the IP address is public or private.
...
class NetworkLoadBalancerIpAddressReservedIp(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str id: OCID of the reserved public IP address created with the virtual cloud network.
        """
        if id is not None:
...
class NetworkLoadBalancersBackendSetsUnifiedHealthChecker(dict):
    ...
    def __init__(__self__, *,
                 ...
                 url_path: Optional[builtins.str] = None):
        """
        :param builtins.str protocol: (Updatable) The protocol the health check must use; either HTTP or HTTPS, or UDP or TCP.  Example: `HTTP`
...
class GetBackendHealthHealthCheckResultResult(dict):
    def __init__(__self__, *,
                 health_check_status: builtins.str,
                 timestamp: builtins.str):
        """
        :param builtins.str health_check_status: The result of the most recent health check.
        :param builtins.str timestamp: The date and time the data was retrieved, in the format defined by RFC3339.  Example: `2020-05-01T18:28:11+00:00`
        """
...
class GetBackendSetBackendResult(dict):
    def __init__(__self__, *,
                 ...
                 is_backup: builtins.bool,
                 is_drain: builtins.bool,
        ...
        :param builtins.bool is_backup: Whether the network load balancer should treat this server as a backup unit. If `true`, then the network load balancer forwards no ingress traffic to this backend server unless all other backend servers not marked as "isBackup" fail the health check policy.  Example: `false`
        :param builtins.bool is_drain: Whether the network load balancer should drain this server. Servers marked "isDrain" receive no incoming traffic.  Example: `false`
        :param builtins.bool is_offline: Whether the network load balancer should treat this server as offline. Offline servers receive no incoming traffic.  Example: `false`
        :param builtins.str name: A user-friendly name for the backend set that must be unique and cannot be changed.
        :param builtins.int port: The backend server port against which to run the health check. If the port is not specified, then the network load balancer uses the port information from the `Backend` object. The port must be specified if the backend port is 0.  Example: `8080`
        :param builtins.str target_id: The IP OCID/Instance OCID associated with the backend server. Example: `ocid1.privateip..oc1.<var>&lt;unique_ID&gt;</var>`
        :param builtins.int weight: The network load balancing policy weight assigned to the server. Backend servers with a higher weight receive a larger proportion of incoming traffic. For example, a server weighted '3' receives three times the number of new connections as a server weighted '1'. For more information about network load balancing policies, see [Network Load Balancer Policies](https://docs.cloud.oracle.com/iaas/Content/NetworkLoadBalancer/introduction.htm#Policies).  Example: `3`
        """
        pulumi.set(__self__, "ip_address", ip_address)
        pulumi.set(__self__, "is_backup", is_backup)
        pulumi.set(__self__, "is_drain", is_drain)
    ...
    @property
    @pulumi.getter(name="isBackup")
    def is_backup(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="isDrain")
    def is_drain(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="isOffline")
    def is_offline(self) -> builtins.bool:
        """
...
class GetBackendSetHealthCheckerResult(dict):
    def __init__(__self__, *,
                 ...
                 interval_in_millis: builtins.int,
                 port: builtins.int,
                 protocol: builtins.str,
                 request_data: builtins.str,
                 response_body_regex: builtins.str,
        ...
        :param builtins.int interval_in_millis: The interval between health checks, in milliseconds. The default value is 10000 (10 seconds).  Example: `10000`
        :param builtins.int port: The backend server port against which to run the health check. If the port is not specified, then the network load balancer uses the port information from the `Backend` object. The port must be specified if the backend port is 0.  Example: `8080`
        :param builtins.str protocol: The protocol the health check must use; either HTTP, HTTPS, UDP, TCP or DNS.  Example: `HTTP`
        :param builtins.str request_data: Base64 encoded pattern to be sent as UDP or TCP health check probe.
        :param builtins.str response_body_regex: A regular expression for parsing the response body from the backend server.  Example: `^((?!false).|\\s)*$`
        :param builtins.str response_data: Base64 encoded pattern to be validated as UDP or TCP health check probe response.
        :param builtins.int retries: The number of retries to attempt before a backend server is considered "unhealthy". This number also applies when recovering a server to the "healthy" state. The default value is 3.  Example: `3`
        :param builtins.int return_code: The status code a healthy backend server should return. If you configure the health check policy to use the HTTP protocol, then you can use common HTTP status codes such as "200".  Example: `200`
        :param builtins.int timeout_in_millis: The maximum time, in milliseconds, to wait for a reply to a health check. A health check is successful only if a reply returns within this timeout period. The default value is 3000 (3 seconds).  Example: `3000`
        :param builtins.str url_path: The path against which to run the health check.  Example: `/healthcheck`
        """
        pulumi.set(__self__, "dns", dns)
        pulumi.set(__self__, "interval_in_millis", interval_in_millis)
        pulumi.set(__self__, "port", port)
    ...
    @property
    @pulumi.getter(name="intervalInMillis")
    def interval_in_millis(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="requestData")
    def request_data(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="responseBodyRegex")
    def response_body_regex(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="responseData")
    def response_data(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="returnCode")
    def return_code(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="timeoutInMillis")
    def timeout_in_millis(self) -> builtins.int:
        """
...
class GetBackendSetHealthCheckerDnResult(dict):
    def __init__(__self__, *,
                 domain_name: builtins.str,
                 query_class: builtins.str,
                 query_type: builtins.str,
                 rcodes: Sequence[builtins.str],
                 transport_protocol: builtins.str):
        """
        :param builtins.str domain_name: The absolute fully-qualified domain name to perform periodic DNS queries. If not provided, an extra dot will be added at the end of a domain name during the query.
        :param builtins.str query_class: The class the dns health check query to use; either IN or CH.  Example: `IN`
        :param builtins.str query_type: The type the dns health check query to use; A, AAAA, TXT.  Example: `A`
        :param Sequence[builtins.str] rcodes: An array that represents accepetable RCODE values for DNS query response. Example: ["NOERROR", "NXDOMAIN"]
        :param builtins.str transport_protocol: DNS transport protocol; either UDP or TCP.  Example: `UDP`
        """
        pulumi.set(__self__, "domain_name", domain_name)
        pulumi.set(__self__, "query_class", query_class)
        pulumi.set(__self__, "query_type", query_type)
    ...
    @property
    @pulumi.getter(name="queryClass")
    def query_class(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter
    def rcodes(self) -> Sequence[builtins.str]:
        """
...
class GetBackendSetsBackendSetCollectionItemResult(dict):
    def __init__(__self__, *,
                 are_operationally_active_backends_preferred: builtins.bool,
                 ...
                 is_fail_open: builtins.bool,
                 is_instant_failover_enabled: builtins.bool,
                 is_instant_failover_tcp_reset_enabled: builtins.bool,
                 is_preserve_source: builtins.bool,
                 name: builtins.str,
                 network_load_balancer_id: builtins.str,
                 policy: builtins.str):
        """
        :param builtins.bool are_operationally_active_backends_preferred: If enabled, NLB supports active-standby backends. The standby backend takes over the traffic when the active node fails, and continues to serve the traffic even when the old active node is back healthy.
        ...
        :param builtins.str ip_version: IP version associated with the backend set.
        :param builtins.bool is_fail_open: If enabled, the network load balancer will continue to distribute traffic in the configured distribution in the event all backends are unhealthy. The value is false by default.
        :param builtins.bool is_instant_failover_enabled: If enabled existing connections will be forwarded to an alternative healthy backend as soon as current backend becomes unhealthy.
        :param builtins.bool is_instant_failover_tcp_reset_enabled: If enabled along with instant failover, the network load balancer will send TCP RST to the clients for the existing connections instead of failing over to a healthy backend. This only applies when using the instant failover. By default, TCP RST is enabled.
        :param builtins.bool is_preserve_source: If this parameter is enabled, then the network load balancer preserves the source IP of the packet when it is forwarded to backends. Backends see the original source IP. If the isPreserveSourceDestination parameter is enabled for the network load balancer resource, then this parameter cannot be disabled. The value is true by default.
        :param builtins.str name: A user-friendly name for the backend set that must be unique and cannot be changed.
        ...
        :param builtins.str policy: The network load balancer policy for the backend set.  Example: `FIVE_TUPLE`
        """
...
class GetBackendsBackendCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 weight: builtins.int):
        """
        :param builtins.str backend_set_name: The name of the backend set associated with the backend servers.  Example: `example_backend_set`
        :param builtins.str ip_address: The IP address of the backend server. Example: `10.0.0.3`
        :param builtins.bool is_backup: Whether the network load balancer should treat this server as a backup unit. If `true`, then the network load balancer forwards no ingress traffic to this backend server unless all other backend servers not marked as "isBackup" fail the health check policy.  Example: `false`
        :param builtins.bool is_drain: Whether the network load balancer should drain this server. Servers marked "isDrain" receive no incoming traffic.  Example: `false`
        :param builtins.bool is_offline: Whether the network load balancer should treat this server as offline. Offline servers receive no incoming traffic.  Example: `false`
...
class GetListenersListenerCollectionItemResult(dict):
    def __init__(__self__, *,
                 default_backend_set_name: builtins.str,
                 id: builtins.str,
                 ip_version: builtins.str,
                 is_ppv2enabled: builtins.bool,
                 l3ip_idle_timeout: builtins.int,
                 name: builtins.str,
                 network_load_balancer_id: builtins.str,
                 port: builtins.int,
                 protocol: builtins.str,
                 tcp_idle_timeout: builtins.int,
                 udp_idle_timeout: builtins.int):
        """
        :param builtins.str default_backend_set_name: The name of the associated backend set.  Example: `example_backend_set`
        :param builtins.str ip_version: IP version associated with the listener.
        :param builtins.bool is_ppv2enabled: Property to enable/disable PPv2 feature for this listener.
        :param builtins.int l3ip_idle_timeout: The duration for L3IP idle timeout in seconds. Example: `200`
        :param builtins.str name: A friendly name for the listener. It must be unique and it cannot be changed.  Example: `example_listener`
        :param builtins.str network_load_balancer_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the network load balancer to update.
        :param builtins.int port: The communication port for the listener.  Example: `80`
        :param builtins.str protocol: The protocol on which the listener accepts connection requests. For public network load balancers, ANY protocol refers to TCP/UDP with the wildcard port. For private network load balancers, ANY protocol refers to TCP/UDP/ICMP (note that ICMP requires isPreserveSourceDestination to be set to true). "ListNetworkLoadBalancersProtocols" API is deprecated and it will not return the updated values. Use the allowed values for the protocol instead.  Example: `TCP`
        :param builtins.int tcp_idle_timeout: The duration for TCP idle timeout in seconds. Example: `300`
        :param builtins.int udp_idle_timeout: The duration for UDP idle timeout in seconds. Example: `120`
        """
    ...
    def default_backend_set_name(self) -> builtins.str:
        """
    ...
    def is_ppv2enabled(self) -> builtins.bool:
        """
    ...
    def l3ip_idle_timeout(self) -> builtins.int:
        """
    ...
    def tcp_idle_timeout(self) -> builtins.int:
        """
    ...
    def udp_idle_timeout(self) -> builtins.int:
        """
...
class GetNetworkLoadBalancersNetworkLoadBalancerCollectionItemResult(dict):
    def __init__(__self__, *,
                 assigned_ipv6: builtins.str,
                 assigned_private_ipv4: builtins.str,
                 ...
                 is_preserve_source_destination: builtins.bool,
                 is_private: builtins.bool,
                 is_symmetric_hash_enabled: builtins.bool,
                 lifecycle_details: builtins.str,
                 network_security_group_ids: Sequence[builtins.str],
                 nlb_ip_version: builtins.str,
                 ...
                 subnet_ipv6cidr: builtins.str,
                 system_tags: Mapping[str, builtins.str],
                 time_created: builtins.str,
                 time_updated: builtins.str):
        """
        :param builtins.str compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the network load balancers to list.
        ...
        :param builtins.bool is_preserve_source_destination: When enabled, the skipSourceDestinationCheck parameter is automatically enabled on the load balancer VNIC. Packets are sent to the backend set without any changes to the source and destination IP.
        :param builtins.bool is_private: Whether the network load balancer has a virtual cloud network-local (private) IP address.
        ...
        :param Sequence[builtins.str] network_security_group_ids: An array of network security groups [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) associated with the network load balancer.
        :param builtins.str nlb_ip_version: IP version associated with the NLB.
        :param Mapping[str, builtins.str] security_attributes: ZPR tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{ "oracle-zpr": { "td": { "value": "42", "mode": "audit" } } }`
        :param builtins.str state: A filter to return only resources that match the given lifecycle state.
        :param builtins.str subnet_id: The subnet in which the network load balancer is spawned [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)."
        :param Mapping[str, builtins.str] system_tags: Key-value pair representing system tags' keys and values scoped to a namespace. Example: `{"bar-key": "value"}`
        :param builtins.str time_created: The date and time the network load balancer was created, in the format defined by RFC3339.  Example: `2020-05-01T21:10:29.600Z`
        :param builtins.str time_updated: The time the network load balancer was updated. An RFC3339 formatted date-time string.  Example: `2020-05-01T22:10:29.600Z`
        """
    ...
    def assigned_ipv6(self) -> builtins.str:
        return pulumi.get(self, "assigned_ipv6")

    @property
    @pulumi.getter(name="assignedPrivateIpv4")
    def assigned_private_ipv4(self) -> builtins.str:
    ...
    def is_preserve_source_destination(self) -> builtins.bool:
        """
    ...
    def is_symmetric_hash_enabled(self) -> builtins.bool:
    ...
    def nlb_ip_version(self) -> builtins.str:
        """
    ...
    def subnet_ipv6cidr(self) -> builtins.str:
...
class GetNetworkLoadBalancersPoliciesNetworkLoadBalancersPolicyCollectionResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] items: Array of NetworkLoadBalancersPolicySummary objects.
        """
        pulumi.set(__self__, "items", items)
...
class GetNetworkLoadBalancersProtocolsNetworkLoadBalancersProtocolCollectionResult(dict):
    def __init__(__self__, *,
                 items: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] items: Array of NetworkLoadBalancersProtocolSummary objects.
        """
        pulumi.set(__self__, "items", items)
