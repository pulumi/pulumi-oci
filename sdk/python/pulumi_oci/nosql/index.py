...
class IndexArgs:
    def __init__(__self__, *,
                 ...
                 table_name_or_id: pulumi.Input[builtins.str],
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 is_if_not_exists: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Index resource.
        :param pulumi.Input[Sequence[pulumi.Input['IndexKeyArgs']]] keys: A set of keys for a secondary index.
        :param pulumi.Input[builtins.str] table_name_or_id: A table name within the compartment, or a table OCID.
    ...
    def table_name_or_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def table_name_or_id(self, value: pulumi.Input[builtins.str]):
    ...
    def is_if_not_exists(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_if_not_exists(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _IndexState:
    def __init__(__self__, *,
                 ...
                 table_name_or_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] name: Index name.
        :param pulumi.Input[builtins.str] state: The state of an index.
        :param pulumi.Input[builtins.str] table_id: the OCID of the table to which this index belongs.
        :param pulumi.Input[builtins.str] table_name: The name of the table to which this index belongs.
        :param pulumi.Input[builtins.str] table_name_or_id: A table name within the compartment, or a table OCID.
    ...
    @property
    @pulumi.getter(name="tableNameOrId")
    def table_name_or_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        A table name within the compartment, or a table OCID.
    ...
    @table_name_or_id.setter
    def table_name_or_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "table_name_or_id", value)
...
class Index(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            table_id: Optional[pulumi.Input[builtins.str]] = None,
            table_name: Optional[pulumi.Input[builtins.str]] = None,
            table_name_or_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Index':
        """
    ...
    @property
    @pulumi.getter(name="isIfNotExists")
    def is_if_not_exists(self) -> pulumi.Output[builtins.bool]:
        """
        If true, the operation completes successfully even when the index exists.  Otherwise, an attempt to create an index that already exists will return an error.
        """
        return pulumi.get(self, "is_if_not_exists")
    ...
    @property
    @pulumi.getter(name="tableNameOrId")
    def table_name_or_id(self) -> pulumi.Output[builtins.str]:
        """
        A table name within the compartment, or a table OCID.
