...
class Table(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="isAutoReclaimable")
    def is_auto_reclaimable(self) -> pulumi.Output[Optional[bool]]:
        return pulumi.get(self, "is_auto_reclaimable")

    @property
    @pulumi.getter(name="isMultiRegion")
    def is_multi_region(self) -> pulumi.Output[Optional[bool]]:
        return pulumi.get(self, "is_multi_region")
    ...
    @property
    @pulumi.getter(name="localReplicaInitializationInPercent")
    def local_replica_initialization_in_percent(self) -> pulumi.Output[Optional[int]]:
        return pulumi.get(self, "local_replica_initialization_in_percent")
    ...
    @property
    @pulumi.getter(name="schemaState")
    def schema_state(self) -> pulumi.Output[Optional[str]]:
        return pulumi.get(self, "schema_state")

    @property
    @pulumi.getter
    def schemas(self) -> pulumi.Output[Optional[Sequence['outputs.TableSchema']]]:
        return pulumi.get(self, "schemas")
    ...
    @property
    @pulumi.getter(name="tableLimits")
    def table_limits(self) -> pulumi.Output[Optional['outputs.TableTableLimits']]:
        return pulumi.get(self, "table_limits")
