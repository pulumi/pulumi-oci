...
class TableReplicaInitArgs:
    def __init__(__self__, *,
                 ...
                 max_read_units: Optional[pulumi.Input[builtins.int]] = None,
                 max_write_units: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a TableReplica resource.
        :param pulumi.Input[builtins.str] region: Name of the remote region in standard Oracle Cloud Infrastructure format, i.e. us-ashburn-1
    ...
    def max_read_units(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_read_units(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_read_units", value)

    @property
    @pulumi.getter(name="maxWriteUnits")
    def max_write_units(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def max_write_units(self, value: Optional[pulumi.Input[builtins.int]]):
...
class TableReplica(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            max_write_units: Optional[pulumi.Input[builtins.int]] = None,
            region: Optional[pulumi.Input[builtins.str]] = None,
            table_name_or_id: Optional[pulumi.Input[builtins.str]] = None) -> 'TableReplica':
        """
    ...
    @property
    @pulumi.getter(name="maxReadUnits")
    def max_read_units(self) -> pulumi.Output[builtins.int]:
        """
        Maximum sustained read throughput limit for the new replica table. If not specified, the local table's read limit is used.
        """
        return pulumi.get(self, "max_read_units")
    ...
    @property
    @pulumi.getter(name="maxWriteUnits")
    def max_write_units(self) -> pulumi.Output[builtins.int]:
        """
        Maximum sustained write throughput limit for the new replica table. If not specified, the local table's write limit is used.
        """
        return pulumi.get(self, "max_write_units")
