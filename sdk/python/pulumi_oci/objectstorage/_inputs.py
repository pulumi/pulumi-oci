...
__all__ = [
    ...
    'BucketRetentionRuleArgsDict',
    'BucketRetentionRuleDurationArgs',
    'BucketRetentionRuleDurationArgsDict',
    ...
    'GetBucketSummariesFilterArgsDict',
    'GetObjectVersionsFilterArgs',
    'GetObjectVersionsFilterArgsDict',
...
if not MYPY:
    class BucketRetentionRuleArgsDict(TypedDict):
        ...
        (Updatable)
        """
        retention_rule_id: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        time_rule_locked: NotRequired[pulumi.Input[builtins.str]]
        """
...
class BucketRetentionRuleArgs:
    def __init__(__self__, *,
                 ...
                 retention_rule_id: Optional[pulumi.Input[builtins.str]] = None,
                 time_created: Optional[pulumi.Input[builtins.str]] = None,
                 time_modified: Optional[pulumi.Input[builtins.str]] = None,
                 time_rule_locked: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] display_name: A user-specified name for the retention rule. Names can be helpful in identifying retention rules. The name should be unique. This attribute is a forcenew attribute
        :param pulumi.Input['BucketRetentionRuleDurationArgs'] duration: (Updatable)
        :param pulumi.Input[builtins.str] retention_rule_id: Unique identifier for the retention rule.
        :param pulumi.Input[builtins.str] time_created: The date and time the bucket was created, as described in [RFC 2616](https://tools.ietf.org/html/rfc2616#section-14.29).
        :param pulumi.Input[builtins.str] time_modified: The date and time that the retention rule was modified as per [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] time_rule_locked: (Updatable) The date and time as per [RFC 3339](https://tools.ietf.org/html/rfc3339) after which this rule is locked and can only be deleted by deleting the bucket. Once a rule is locked, only increases in the duration are allowed and no other properties can be changed. This property cannot be updated for rules that are in a locked state. Specifying it when a duration is not specified is considered an error.
        """
    ...
    def retention_rule_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Unique identifier for the retention rule.
        """
    ...
    def retention_rule_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_rule_locked(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The date and time as per [RFC 3339](https://tools.ietf.org/html/rfc3339) after which this rule is locked and can only be deleted by deleting the bucket. Once a rule is locked, only increases in the duration are allowed and no other properties can be changed. This property cannot be updated for rules that are in a locked state. Specifying it when a duration is not specified is considered an error.
        """
    ...
    def time_rule_locked(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_rule_locked", value)


if not MYPY:
    class BucketRetentionRuleDurationArgsDict(TypedDict):
        time_amount: pulumi.Input[builtins.str]
        """
...
class BucketRetentionRuleDurationArgs:
    def __init__(__self__, *,
                 ...
                 time_unit: pulumi.Input[builtins.str]):
        """
        :param pulumi.Input[builtins.str] time_amount: (Updatable) The timeAmount is interpreted in units defined by the timeUnit parameter, and is calculated in relation to each object's Last-Modified timestamp.
        :param pulumi.Input[builtins.str] time_unit: (Updatable) The unit that should be used to interpret timeAmount.
        """
    ...
    def time_amount(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The timeAmount is interpreted in units defined by the timeUnit parameter, and is calculated in relation to each object's Last-Modified timestamp.
        """
    ...
    @time_amount.setter
    def time_amount(self, value: pulumi.Input[builtins.str]):
...
class ObjectLifecyclePolicyRuleArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] action: (Updatable) The action of the object lifecycle policy rule. Rules using the action 'ARCHIVE' move objects from Standard and InfrequentAccess storage tiers into the [Archive storage tier](https://docs.cloud.oracle.com/iaas/Content/Archive/Concepts/archivestorageoverview.htm). Rules using the action 'INFREQUENT_ACCESS' move objects from Standard storage tier into the Infrequent Access Storage tier. Objects that are already in InfrequentAccess tier or in Archive tier are left untouched. Rules using the action 'DELETE' permanently delete objects from buckets. Rules using 'ABORT' abort the uncommitted multipart-uploads and permanently delete their parts from buckets.
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) A Boolean that determines whether this rule is currently enabled.
        :param pulumi.Input[builtins.str] name: (Updatable) The name of the lifecycle rule to be applied.
        :param pulumi.Input[builtins.str] time_amount: (Updatable) Specifies the age of objects to apply the rule to. The timeAmount is interpreted in units defined by the timeUnit parameter, and is calculated in relation to each object's Last-Modified time.
        :param pulumi.Input[builtins.str] time_unit: (Updatable) The unit that should be used to interpret timeAmount.  Days are defined as starting and ending at midnight UTC. Years are defined as 365.2425 days long and likewise round up to the next midnight UTC. 
        ...
        :param pulumi.Input[builtins.str] target: (Updatable) The target of the object lifecycle policy rule. The values of target can be either "objects", "multipart-uploads" or "previous-object-versions". This field when declared as "objects" is used to specify ARCHIVE, INFREQUENT_ACCESS or DELETE rule for objects. This field when declared as "previous-object-versions" is used to specify ARCHIVE, INFREQUENT_ACCESS or DELETE rule for previous versions of existing objects. This field when declared as "multipart-uploads" is used to specify the ABORT (only) rule for uncommitted multipart-uploads.
        """
...
if not MYPY:
    class ObjectLifecyclePolicyRuleObjectNameFilterArgsDict(TypedDict):
        exclusion_patterns: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
        ...
        *           Matches any string of characters. ?           Matches any single character . [...]       Matches a group of characters. A group of characters can be: A set of characters, for example: [Zafg9@]. This matches any character in the brackets. A range of characters, for example: [a-z]. This matches any character in the range. [a-f] is equivalent to [abcdef]. For character ranges only the CHARACTER-CHARACTER pattern is supported. [ab-yz] is not valid [a-mn-z] is not valid Character ranges can not start with ^ or : To include a '-' in the range, make it the first or last character.
        """
        inclusion_patterns: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class ObjectLifecyclePolicyRuleObjectNameFilterArgs:
    def __init__(__self__, *,
                 exclusion_patterns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 inclusion_patterns: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 inclusion_prefixes: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] exclusion_patterns: (Updatable) An array of glob patterns to match the object names to exclude. An empty array is ignored. Exclusion patterns take precedence over inclusion patterns. A Glob pattern is a sequence of characters to match text. Any character that appears in the pattern, other than the special pattern characters described below, matches itself. Glob patterns must be between 1 and 1024 characters.
               
               The special pattern characters have the following meanings:
               
               \\           Escapes the following character
               *           Matches any string of characters. ?           Matches any single character . [...]       Matches a group of characters. A group of characters can be: A set of characters, for example: [Zafg9@]. This matches any character in the brackets. A range of characters, for example: [a-z]. This matches any character in the range. [a-f] is equivalent to [abcdef]. For character ranges only the CHARACTER-CHARACTER pattern is supported. [ab-yz] is not valid [a-mn-z] is not valid Character ranges can not start with ^ or : To include a '-' in the range, make it the first or last character.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] inclusion_patterns: (Updatable) An array of glob patterns to match the object names to include. An empty array includes all objects in the bucket. Exclusion patterns take precedence over inclusion patterns. A Glob pattern is a sequence of characters to match text. Any character that appears in the pattern, other than the special pattern characters described below, matches itself. Glob patterns must be between 1 and 1024 characters.
               
               The special pattern characters have the following meanings:
               
               \\           Escapes the following character
               *           Matches any string of characters. ?           Matches any single character . [...]       Matches a group of characters. A group of characters can be: A set of characters, for example: [Zafg9@]. This matches any character in the brackets. A range of characters, for example: [a-z]. This matches any character in the range. [a-f] is equivalent to [abcdef]. For character ranges only the CHARACTER-CHARACTER pattern is supported. [ab-yz] is not valid [a-mn-z] is not valid Character ranges can not start with ^ or : To include a '-' in the range, make it the first or last character.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] inclusion_prefixes: (Updatable) An array of object name prefixes that the rule will apply to. An empty array means to include all objects.
        """
    ...
    def exclusion_patterns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        (Updatable) An array of glob patterns to match the object names to exclude. An empty array is ignored. Exclusion patterns take precedence over inclusion patterns. A Glob pattern is a sequence of characters to match text. Any character that appears in the pattern, other than the special pattern characters described below, matches itself. Glob patterns must be between 1 and 1024 characters.
    ...
    def exclusion_patterns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
        pulumi.set(self, "exclusion_patterns", value)

    @property
    @pulumi.getter(name="inclusionPatterns")
    def inclusion_patterns(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        (Updatable) An array of glob patterns to match the object names to include. An empty array includes all objects in the bucket. Exclusion patterns take precedence over inclusion patterns. A Glob pattern is a sequence of characters to match text. Any character that appears in the pattern, other than the special pattern characters described below, matches itself. Glob patterns must be between 1 and 1024 characters.
    ...
    def inclusion_patterns(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class StorageObjectSourceUriDetailsArgsDict(TypedDict):
        ...
        """
        destination_object_if_match_etag: NotRequired[pulumi.Input[builtins.str]]
        """
        The entity tag to match the target object.
        """
        destination_object_if_none_match_etag: NotRequired[pulumi.Input[builtins.str]]
        """
        The entity tag to not match the target object.
        """
        source_object_if_match_etag: NotRequired[pulumi.Input[builtins.str]]
        """
        The entity tag to match the source object.
        """
        source_version_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class StorageObjectSourceUriDetailsArgs:
    def __init__(__self__, *,
                 ...
                 object: pulumi.Input[builtins.str],
                 region: pulumi.Input[builtins.str],
                 destination_object_if_match_etag: Optional[pulumi.Input[builtins.str]] = None,
                 destination_object_if_none_match_etag: Optional[pulumi.Input[builtins.str]] = None,
                 source_object_if_match_etag: Optional[pulumi.Input[builtins.str]] = None,
                 source_version_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] bucket: The name of the bucket for the source object.
        :param pulumi.Input[builtins.str] namespace: The top-level namespace of the source object.
        :param pulumi.Input[builtins.str] object: The name of the source object.
        :param pulumi.Input[builtins.str] region: The region of the source object.
        :param pulumi.Input[builtins.str] destination_object_if_match_etag: The entity tag to match the target object.
        :param pulumi.Input[builtins.str] destination_object_if_none_match_etag: The entity tag to not match the target object.
        :param pulumi.Input[builtins.str] source_object_if_match_etag: The entity tag to match the source object.
        :param pulumi.Input[builtins.str] source_version_id: The version id of the object to be restored.
    ...
    def destination_object_if_match_etag(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The entity tag to match the target object.
        """
    ...
    def destination_object_if_match_etag(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "destination_object_if_match_etag", value)

    @property
    @pulumi.getter(name="destinationObjectIfNoneMatchEtag")
    def destination_object_if_none_match_etag(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The entity tag to not match the target object.
        """
    ...
    def destination_object_if_none_match_etag(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "destination_object_if_none_match_etag", value)

    @property
    @pulumi.getter(name="sourceObjectIfMatchEtag")
    def source_object_if_match_etag(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The entity tag to match the source object.
        """
    ...
    def source_object_if_match_etag(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "source_object_if_match_etag", value)

    @property
    @pulumi.getter(name="sourceVersionId")
    def source_version_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The version id of the object to be restored.
    ...
    def source_version_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class GetBucketSummariesFilterArgs:
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the bucket. Avoid entering confidential information. Example: my-new-bucket1
        """
        pulumi.set(__self__, "name", name)
...
class GetObjectVersionsFilterArgs:
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: The name of the object. Avoid entering confidential information. Example: test/object1.log
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
...
class GetPreauthrequestsFilterArgs:
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: The user-provided name of the pre-authenticated request.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
