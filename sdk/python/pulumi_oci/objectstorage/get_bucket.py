...
def get_bucket(name: Optional[str] = None,
    ...
    return AwaitableGetBucketResult(
        ...
        approximate_count=__ret__.approximate_count,
        approximate_size=__ret__.approximate_size,
        auto_tiering=__ret__.auto_tiering,
        bucket_id=__ret__.bucket_id,
        ...
        object_events_enabled=__ret__.object_events_enabled,
        object_lifecycle_policy_etag=__ret__.object_lifecycle_policy_etag,
        replication_enabled=__ret__.replication_enabled,
        retention_rules=__ret__.retention_rules,
