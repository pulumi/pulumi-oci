...
def get_bucket_summaries(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str compartment_id: The ID of the compartment in which to list buckets.
...
def get_bucket_summaries_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
