...
def get_namespace(compartment_id: Optional[builtins.str] = None,
...
def get_namespace_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
