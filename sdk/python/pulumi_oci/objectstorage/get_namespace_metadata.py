...
class GetNamespaceMetadataResult:
    ...
    def default_s3compartment_id(self) -> _builtins.str:
        return pulumi.get(self, "default_s3compartment_id")

    @_builtins.property
    @pulumi.getter(name="defaultSwiftCompartmentId")
    def default_swift_compartment_id(self) -> _builtins.str:
...
def get_namespace_metadata(namespace: Optional[_builtins.str] = None,
