...
class GetNamespaceMetadataResult:
    ...
    def default_s3compartment_id(self) -> builtins.str:
        return pulumi.get(self, "default_s3compartment_id")

    @property
    @pulumi.getter(name="defaultSwiftCompartmentId")
    def default_swift_compartment_id(self) -> builtins.str:
...
def get_namespace_metadata(namespace: Optional[builtins.str] = None,
...
def get_namespace_metadata_output(namespace: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetNamespaceMetadataResult(
        ...
        default_swift_compartment_id=pulumi.get(__response__, 'default_swift_compartment_id'),
