...
def get_object_head(bucket: Optional[builtins.str] = None,
    ...
    :param builtins.str namespace: The top-level namespace used for the request.
...
def get_object_head_output(bucket: Optional[pulumi.Input[builtins.str]] = None,
