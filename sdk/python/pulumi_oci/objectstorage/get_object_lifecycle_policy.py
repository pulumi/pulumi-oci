...
def get_object_lifecycle_policy(bucket: Optional[builtins.str] = None,
...
def get_object_lifecycle_policy_output(bucket: Optional[pulumi.Input[builtins.str]] = None,
