...
class GetPreauthrequestResult:
    ...
    def bucket_listing_action(self) -> builtins.str:
        """
...
def get_preauthrequest(bucket: Optional[builtins.str] = None,
                       namespace: Optional[builtins.str] = None,
                       par_id: Optional[builtins.str] = None,
    ...
    :param builtins.str par_id: The unique identifier for the pre-authenticated request. This can be used to manage operations against the pre-authenticated request, such as GET or DELETE.
    """
    __args__ = dict()
...
def get_preauthrequest_output(bucket: Optional[pulumi.Input[builtins.str]] = None,
                              namespace: Optional[pulumi.Input[builtins.str]] = None,
                              par_id: Optional[pulumi.Input[builtins.str]] = None,
