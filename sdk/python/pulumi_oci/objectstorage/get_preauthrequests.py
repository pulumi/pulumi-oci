...
def get_preauthrequests(bucket: Optional[builtins.str] = None,
    ...
    :param builtins.str object_name_prefix: User-specified object name prefixes can be used to query and return a list of pre-authenticated requests.
    """
    __args__ = dict()
...
def get_preauthrequests_output(bucket: Optional[pulumi.Input[builtins.str]] = None,
                               ...
                               object_name_prefix: Optional[pulumi.Input[Optional[builtins.str]]] = None,
