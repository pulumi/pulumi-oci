...
def get_private_endpoint_summaries(compartment_id: Optional[builtins.str] = None,
...
def get_private_endpoint_summaries_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
