...
class GetReplicationPolicyResult:
    ...
    def delete_object_in_destination_bucket(self) -> builtins.str:
    ...
    def destination_region_name(self) -> builtins.str:
        """
    ...
    def time_last_sync(self) -> builtins.str:
        """
...
def get_replication_policy(bucket: Optional[builtins.str] = None,
    ...
    :param builtins.str replication_id: The ID of the replication policy.
    """
    __args__ = dict()
...
def get_replication_policy_output(bucket: Optional[pulumi.Input[builtins.str]] = None,
