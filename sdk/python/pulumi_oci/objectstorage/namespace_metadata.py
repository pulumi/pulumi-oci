...
class NamespaceMetadataArgs:
    def __init__(__self__, *,
                 ...
                 default_s3compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 default_swift_compartment_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    def default_s3compartment_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "default_s3compartment_id")

    @default_s3compartment_id.setter
    def default_s3compartment_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "default_s3compartment_id", value)

    @property
    @pulumi.getter(name="defaultSwiftCompartmentId")
    def default_swift_compartment_id(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "default_swift_compartment_id")

    @default_swift_compartment_id.setter
    def default_swift_compartment_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class NamespaceMetadata(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            default_s3compartment_id: Optional[pulumi.Input[builtins.str]] = None,
            default_swift_compartment_id: Optional[pulumi.Input[builtins.str]] = None,
            namespace: Optional[pulumi.Input[builtins.str]] = None) -> 'NamespaceMetadata':
        """
    ...
    @property
    @pulumi.getter(name="defaultS3compartmentId")
    def default_s3compartment_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "default_s3compartment_id")

    @property
    @pulumi.getter(name="defaultSwiftCompartmentId")
    def default_swift_compartment_id(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "default_swift_compartment_id")
