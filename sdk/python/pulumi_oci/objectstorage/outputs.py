...
class BucketRetentionRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 retention_rule_id: Optional[builtins.str] = None,
                 time_created: Optional[builtins.str] = None,
                 time_modified: Optional[builtins.str] = None,
                 time_rule_locked: Optional[builtins.str] = None):
        """
        :param builtins.str display_name: A user-specified name for the retention rule. Names can be helpful in identifying retention rules. The name should be unique. This attribute is a forcenew attribute
        :param 'BucketRetentionRuleDurationArgs' duration: (Updatable)
        :param builtins.str retention_rule_id: Unique identifier for the retention rule.
        :param builtins.str time_created: The date and time the bucket was created, as described in [RFC 2616](https://tools.ietf.org/html/rfc2616#section-14.29).
        :param builtins.str time_modified: The date and time that the retention rule was modified as per [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param builtins.str time_rule_locked: (Updatable) The date and time as per [RFC 3339](https://tools.ietf.org/html/rfc3339) after which this rule is locked and can only be deleted by deleting the bucket. Once a rule is locked, only increases in the duration are allowed and no other properties can be changed. This property cannot be updated for rules that are in a locked state. Specifying it when a duration is not specified is considered an error.
        """
    ...
    def retention_rule_id(self) -> Optional[builtins.str]:
        """
    ...
    def time_rule_locked(self) -> Optional[builtins.str]:
        """
        (Updatable) The date and time as per [RFC 3339](https://tools.ietf.org/html/rfc3339) after which this rule is locked and can only be deleted by deleting the bucket. Once a rule is locked, only increases in the duration are allowed and no other properties can be changed. This property cannot be updated for rules that are in a locked state. Specifying it when a duration is not specified is considered an error.
        """
...
class BucketRetentionRuleDuration(dict):
    ...
    def __init__(__self__, *,
                 time_amount: builtins.str,
                 time_unit: builtins.str):
        """
        :param builtins.str time_amount: (Updatable) The timeAmount is interpreted in units defined by the timeUnit parameter, and is calculated in relation to each object's Last-Modified timestamp.
        :param builtins.str time_unit: (Updatable) The unit that should be used to interpret timeAmount.
        """
    ...
    def time_amount(self) -> builtins.str:
        """
...
class ObjectLifecyclePolicyRule(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: (Updatable) The action of the object lifecycle policy rule. Rules using the action 'ARCHIVE' move objects from Standard and InfrequentAccess storage tiers into the [Archive storage tier](https://docs.cloud.oracle.com/iaas/Content/Archive/Concepts/archivestorageoverview.htm). Rules using the action 'INFREQUENT_ACCESS' move objects from Standard storage tier into the Infrequent Access Storage tier. Objects that are already in InfrequentAccess tier or in Archive tier are left untouched. Rules using the action 'DELETE' permanently delete objects from buckets. Rules using 'ABORT' abort the uncommitted multipart-uploads and permanently delete their parts from buckets.
        :param builtins.bool is_enabled: (Updatable) A Boolean that determines whether this rule is currently enabled.
        :param builtins.str name: (Updatable) The name of the lifecycle rule to be applied.
        :param builtins.str time_amount: (Updatable) Specifies the age of objects to apply the rule to. The timeAmount is interpreted in units defined by the timeUnit parameter, and is calculated in relation to each object's Last-Modified time.
        :param builtins.str time_unit: (Updatable) The unit that should be used to interpret timeAmount.  Days are defined as starting and ending at midnight UTC. Years are defined as 365.2425 days long and likewise round up to the next midnight UTC. 
...
class ObjectLifecyclePolicyRuleObjectNameFilter(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] exclusion_patterns: (Updatable) An array of glob patterns to match the object names to exclude. An empty array is ignored. Exclusion patterns take precedence over inclusion patterns. A Glob pattern is a sequence of characters to match text. Any character that appears in the pattern, other than the special pattern characters described below, matches itself. Glob patterns must be between 1 and 1024 characters.
        ...
        :param Sequence[builtins.str] inclusion_patterns: (Updatable) An array of glob patterns to match the object names to include. An empty array includes all objects in the bucket. Exclusion patterns take precedence over inclusion patterns. A Glob pattern is a sequence of characters to match text. Any character that appears in the pattern, other than the special pattern characters described below, matches itself. Glob patterns must be between 1 and 1024 characters.
               
               The special pattern characters have the following meanings:
               
               \\           Escapes the following character
               *           Matches any string of characters. ?           Matches any single character . [...]       Matches a group of characters. A group of characters can be: A set of characters, for example: [Zafg9@]. This matches any character in the brackets. A range of characters, for example: [a-z]. This matches any character in the range. [a-f] is equivalent to [abcdef]. For character ranges only the CHARACTER-CHARACTER pattern is supported. [ab-yz] is not valid [a-mn-z] is not valid Character ranges can not start with ^ or : To include a '-' in the range, make it the first or last character.
        :param Sequence[builtins.str] inclusion_prefixes: (Updatable) An array of object name prefixes that the rule will apply to. An empty array means to include all objects.
        """
...
class StorageObjectSourceUriDetails(dict):
    ...
    def __init__(__self__, *,
                 ...
                 object: builtins.str,
                 region: builtins.str,
                 destination_object_if_match_etag: Optional[builtins.str] = None,
                 destination_object_if_none_match_etag: Optional[builtins.str] = None,
                 source_object_if_match_etag: Optional[builtins.str] = None,
                 source_version_id: Optional[builtins.str] = None):
        """
        :param builtins.str bucket: The name of the bucket for the source object.
        :param builtins.str namespace: The top-level namespace of the source object.
        :param builtins.str object: The name of the source object.
        :param builtins.str region: The region of the source object.
        :param builtins.str destination_object_if_match_etag: The entity tag to match the target object.
        :param builtins.str destination_object_if_none_match_etag: The entity tag to not match the target object.
        :param builtins.str source_object_if_match_etag: The entity tag to match the source object.
        :param builtins.str source_version_id: The version id of the object to be restored.
    ...
    def destination_object_if_match_etag(self) -> Optional[builtins.str]:
        """
    ...
    def destination_object_if_none_match_etag(self) -> Optional[builtins.str]:
        """
    ...
    def source_object_if_match_etag(self) -> Optional[builtins.str]:
        """
    ...
    def source_version_id(self) -> Optional[builtins.str]:
        """
...
class GetBucketRetentionRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 retention_rule_id: builtins.str,
                 time_created: builtins.str,
                 time_modified: builtins.str,
                 time_rule_locked: builtins.str):
        """
        :param builtins.str display_name: User specified name for the retention rule.
        :param builtins.str retention_rule_id: Unique identifier for the retention rule.
        :param builtins.str time_created: The date and time the bucket was created, as described in [RFC 2616](https://tools.ietf.org/html/rfc2616#section-14.29).
        :param builtins.str time_modified: The date and time that the retention rule was modified as per [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param builtins.str time_rule_locked: The date and time as per [RFC 3339](https://tools.ietf.org/html/rfc3339) after which this rule becomes locked. and can only be deleted by deleting the bucket.
        """
        pulumi.set(__self__, "display_name", display_name)
    ...
    @property
    @pulumi.getter(name="retentionRuleId")
    def retention_rule_id(self) -> builtins.str:
        """
        Unique identifier for the retention rule.
        """
        return pulumi.get(self, "retention_rule_id")
    ...
    @property
    @pulumi.getter(name="timeRuleLocked")
    def time_rule_locked(self) -> builtins.str:
        """
...
class GetBucketRetentionRuleDurationResult(dict):
    def __init__(__self__, *,
                 ...
                 time_unit: builtins.str):
        """
        :param builtins.str time_amount: The timeAmount is interpreted in units defined by the timeUnit parameter, and is calculated in relation to each object's Last-Modified timestamp.
        :param builtins.str time_unit: The unit that should be used to interpret timeAmount.
        """
        pulumi.set(__self__, "time_amount", time_amount)
        pulumi.set(__self__, "time_unit", time_unit)
...
class GetBucketSummariesBucketSummaryResult(dict):
    def __init__(__self__, *,
                 ...
                 approximate_count: builtins.str,
                 approximate_size: builtins.str,
                 auto_tiering: builtins.str,
                 ...
                 name: builtins.str,
                 namespace: builtins.str,
                 object_events_enabled: builtins.bool,
                 object_lifecycle_policy_etag: builtins.str,
                 replication_enabled: builtins.bool,
                 retention_rules: Sequence['outputs.GetBucketSummariesBucketSummaryRetentionRuleResult'],
                 storage_tier: builtins.str,
                 time_created: builtins.str,
                 versioning: builtins.str):
        """
        :param builtins.str access_type: The type of public access enabled on this bucket. A bucket is set to `NoPublicAccess` by default, which only allows an authenticated caller to access the bucket and its contents. When `ObjectRead` is enabled on the bucket, public access is allowed for the `GetObject`, `HeadObject`, and `ListObjects` operations. When `ObjectReadWithoutList` is enabled on the bucket, public access is allowed for the `GetObject` and `HeadObject` operations.
        :param builtins.str approximate_count: The approximate number of objects in the bucket. Count statistics are reported periodically. You will see a lag between what is displayed and the actual object count.
        :param builtins.str approximate_size: The approximate total size in bytes of all objects in the bucket. Size statistics are reported periodically. You will see a lag between what is displayed and the actual size of the bucket.
        :param builtins.str auto_tiering: The auto tiering status on the bucket. A bucket is created with auto tiering `Disabled` by default. For auto tiering `InfrequentAccess`, objects are transitioned automatically between the 'Standard' and 'InfrequentAccess' tiers based on the access pattern of the objects.
        :param builtins.str compartment_id: The ID of the compartment in which to list buckets.
        :param builtins.str created_by: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the user who created the bucket.
        ...
        :param builtins.str etag: The entity tag (ETag) for the bucket.
        ...
        :param builtins.bool is_read_only: Whether or not this bucket is read only. By default, `isReadOnly` is set to `false`. This will be set to 'true' when this bucket is configured as a destination in a replication policy.
        :param builtins.str kms_key_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a master encryption key used to call the Key Management service to generate a data encryption key or to encrypt or decrypt a data encryption key.
        :param Mapping[str, builtins.str] metadata: Arbitrary string keys and values for user-defined metadata.
        ...
        :param builtins.bool object_events_enabled: Whether or not events are emitted for object state changes in this bucket. By default, `objectEventsEnabled` is set to `false`. Set `objectEventsEnabled` to `true` to emit events for object state changes. For more information about events, see [Overview of Events](https://docs.cloud.oracle.com/iaas/Content/Events/Concepts/eventsoverview.htm).
        :param builtins.str object_lifecycle_policy_etag: The entity tag (ETag) for the live object lifecycle policy on the bucket.
        :param builtins.bool replication_enabled: Whether or not this bucket is a replication source. By default, `replicationEnabled` is set to `false`. This will be set to 'true' when you create a replication policy for the bucket.
        :param builtins.str storage_tier: The storage tier type assigned to the bucket. A bucket is set to `Standard` tier by default, which means objects uploaded or copied to the bucket will be in the standard storage tier. When the `Archive` tier type is set explicitly for a bucket, objects uploaded or copied to the bucket will be stored in archive storage. The `storageTier` property is immutable after bucket is created.
        :param builtins.str time_created: The date and time the bucket was created, as described in [RFC 2616](https://tools.ietf.org/html/rfc2616#section-14.29).
        :param builtins.str versioning: The versioning status on the bucket. A bucket is created with versioning `Disabled` by default. For versioning `Enabled`, objects are protected from overwrites and deletes, by maintaining their version history. When versioning is `Suspended`, the previous versions will still remain but new versions will no longer be created when overwitten or deleted.
        """
    ...
    def approximate_count(self) -> builtins.str:
        """
    ...
    def approximate_size(self) -> builtins.str:
        """
    ...
    def auto_tiering(self) -> builtins.str:
        """
    ...
    def object_events_enabled(self) -> builtins.bool:
        """
    ...
    def object_lifecycle_policy_etag(self) -> builtins.str:
        """
    ...
    def replication_enabled(self) -> builtins.bool:
        """
...
class GetObjectLifecyclePolicyRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 time_unit: builtins.str):
        """
        :param builtins.str action: The action of the object lifecycle policy rule. Rules using the action 'ARCHIVE' move objects from Standard and InfrequentAccess storage tiers into the [Archive storage tier](https://docs.cloud.oracle.com/iaas/Content/Archive/Concepts/archivestorageoverview.htm). Rules using the action 'INFREQUENT_ACCESS' move objects from Standard storage tier into the Infrequent Access Storage tier. Objects that are already in InfrequentAccess tier or in Archive tier are left untouched. Rules using the action 'DELETE' permanently delete objects from buckets. Rules using 'ABORT' abort the uncommitted multipart-uploads and permanently delete their parts from buckets.
        :param builtins.bool is_enabled: A Boolean that determines whether this rule is currently enabled.
        :param builtins.str name: The name of the lifecycle rule to be applied.
        :param Sequence['GetObjectLifecyclePolicyRuleObjectNameFilterArgs'] object_name_filters: A filter that compares object names to a set of prefixes or patterns to determine if a rule applies to a given object. The filter can contain include glob patterns, exclude glob patterns and inclusion prefixes. The inclusion prefixes property is kept for backward compatibility. It is recommended to use inclusion patterns instead of prefixes. Exclusions take precedence over inclusions.
        :param builtins.str target: The target of the object lifecycle policy rule. The values of target can be either "objects", "multipart-uploads" or "previous-object-versions". This field when declared as "objects" is used to specify ARCHIVE, INFREQUENT_ACCESS or DELETE rule for objects. This field when declared as "previous-object-versions" is used to specify ARCHIVE, INFREQUENT_ACCESS or DELETE rule for previous versions of existing objects. This field when declared as "multipart-uploads" is used to specify the ABORT (only) rule for uncommitted multipart-uploads.
        :param builtins.str time_amount: Specifies the age of objects to apply the rule to. The timeAmount is interpreted in units defined by the timeUnit parameter, and is calculated in relation to each object's Last-Modified time.
        :param builtins.str time_unit: The unit that should be used to interpret timeAmount.  Days are defined as starting and ending at midnight UTC. Years are defined as 365.2425 days long and likewise round up to the next midnight UTC.
        """
        pulumi.set(__self__, "action", action)
        pulumi.set(__self__, "is_enabled", is_enabled)
        pulumi.set(__self__, "name", name)
...
class GetObjectLifecyclePolicyRuleObjectNameFilterResult(dict):
    def __init__(__self__, *,
                 exclusion_patterns: Sequence[builtins.str],
                 inclusion_patterns: Sequence[builtins.str],
                 inclusion_prefixes: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] exclusion_patterns: An array of glob patterns to match the object names to exclude. An empty array is ignored. Exclusion patterns take precedence over inclusion patterns. A Glob pattern is a sequence of characters to match text. Any character that appears in the pattern, other than the special pattern characters described below, matches itself. Glob patterns must be between 1 and 1024 characters.
        :param Sequence[builtins.str] inclusion_patterns: An array of glob patterns to match the object names to include. An empty array includes all objects in the bucket. Exclusion patterns take precedence over inclusion patterns. A Glob pattern is a sequence of characters to match text. Any character that appears in the pattern, other than the special pattern characters described below, matches itself. Glob patterns must be between 1 and 1024 characters.
        :param Sequence[builtins.str] inclusion_prefixes: An array of object name prefixes that the rule will apply to. An empty array means to include all objects.
        """
        pulumi.set(__self__, "exclusion_patterns", exclusion_patterns)
        pulumi.set(__self__, "inclusion_patterns", inclusion_patterns)
        pulumi.set(__self__, "inclusion_prefixes", inclusion_prefixes)
    ...
    @property
    @pulumi.getter(name="exclusionPatterns")
    def exclusion_patterns(self) -> Sequence[builtins.str]:
        """
        An array of glob patterns to match the object names to exclude. An empty array is ignored. Exclusion patterns take precedence over inclusion patterns. A Glob pattern is a sequence of characters to match text. Any character that appears in the pattern, other than the special pattern characters described below, matches itself. Glob patterns must be between 1 and 1024 characters.
        """
        return pulumi.get(self, "exclusion_patterns")
    ...
    @property
    @pulumi.getter(name="inclusionPatterns")
    def inclusion_patterns(self) -> Sequence[builtins.str]:
        """
        An array of glob patterns to match the object names to include. An empty array includes all objects in the bucket. Exclusion patterns take precedence over inclusion patterns. A Glob pattern is a sequence of characters to match text. Any character that appears in the pattern, other than the special pattern characters described below, matches itself. Glob patterns must be between 1 and 1024 characters.
        """
        return pulumi.get(self, "inclusion_patterns")
    ...
    @property
    @pulumi.getter(name="inclusionPrefixes")
    def inclusion_prefixes(self) -> Sequence[builtins.str]:
        """
...
class GetObjectVersionsItemResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str archival_state: Archival state of an object. This field is set only for objects in Archive tier.
        :param builtins.str etag: The current entity tag (ETag) for the object.
        :param builtins.bool is_delete_marker: This flag will indicate if the version is deleted or not.
        :param builtins.str md5: Base64-encoded MD5 hash of the object data.
        :param builtins.str name: The name of the object. Avoid entering confidential information. Example: test/object1.log
        :param builtins.str size: Size of the object in bytes.
        :param builtins.str storage_tier: The storage tier that the object is stored in.
        :param builtins.str time_created: The date and time the object was created, as described in [RFC 2616](https://tools.ietf.org/html/rfc2616#section-14.29).
        :param builtins.str time_modified: The date and time the object was modified, as described in [RFC 2616](https://tools.ietf.org/rfc/rfc2616#section-14.29).
        :param builtins.str version_id: VersionId of the object.
        """
    ...
    def archival_state(self) -> builtins.str:
        """
...
class GetPreauthrequestsPreauthenticatedRequestResult(dict):
    def __init__(__self__, *,
                 ...
                 bucket: builtins.str,
                 bucket_listing_action: builtins.str,
        ...
        """
        :param builtins.str access_type: The operation that can be performed on this resource.
        :param builtins.str access_uri: The URI to embed in the URL when using the pre-authenticated request.
        :param builtins.str bucket: The name of the bucket. Avoid entering confidential information. Example: `my-new-bucket1`
        :param builtins.str bucket_listing_action: Specifies whether a list operation is allowed on a PAR with accessType "AnyObjectRead" or "AnyObjectReadWrite". Deny: Prevents the user from performing a list operation. ListObjects: Authorizes the user to perform a list operation.
        :param builtins.str id: The unique identifier to use when directly addressing the pre-authenticated request.
        :param builtins.str name: The user-provided name of the pre-authenticated request.
        :param builtins.str namespace: The Object Storage namespace used for the request.
        :param builtins.str object: Deprecated. Instead use `object_name`.The name of the object that is being granted access to by the pre-authenticated request. Avoid entering confidential information. The object name can be null and if so, the pre-authenticated request grants access to the entire bucket. Example: test/object1.log
        :param builtins.str object_name: The name of the object that is being granted access to by the pre-authenticated request. Avoid entering confidential information. The object name can be null and if so, the pre-authenticated request grants access to the entire bucket. Example: test/object1.log
        :param builtins.str time_created: The date when the pre-authenticated request was created as per specification [RFC 3339](https://tools.ietf.org/html/rfc3339).
        :param builtins.str time_expires: The expiration date for the pre-authenticated request as per [RFC 3339](https://tools.ietf.org/html/rfc3339). After this date the pre-authenticated request will no longer be valid.
        """
        pulumi.set(__self__, "access_type", access_type)
...
class GetPrivateEndpointSummariesPrivateEndpointSummaryResult(dict):
    def __init__(__self__, *,
                 ...
                 additional_prefixes: Sequence[builtins.str],
                 compartment_id: builtins.str,
                 created_by: builtins.str,
                 defined_tags: Mapping[str, builtins.str],
                 etag: builtins.str,
                 fqdns: Mapping[str, Mapping[str, Mapping[str, builtins.str]]],
                 freeform_tags: Mapping[str, builtins.str],
                 id: builtins.str,
                 name: builtins.str,
                 namespace: builtins.str,
    ...
    def additional_prefixes(self) -> Sequence[builtins.str]:
    ...
    @property
    @pulumi.getter
    def fqdns(self) -> Mapping[str, Mapping[str, Mapping[str, builtins.str]]]:
...
class GetReplicationPoliciesReplicationPolicyResult(dict):
    def __init__(__self__, *,
                 bucket: builtins.str,
                 delete_object_in_destination_bucket: builtins.str,
                 destination_bucket_name: builtins.str,
                 destination_region_name: builtins.str,
                 id: builtins.str,
                 name: builtins.str,
                 namespace: builtins.str,
                 status: builtins.str,
                 ...
                 time_created: builtins.str,
                 time_last_sync: builtins.str):
        """
        :param builtins.str bucket: The name of the bucket. Avoid entering confidential information. Example: `my-new-bucket1`
        :param builtins.str destination_bucket_name: The bucket to replicate to in the destination region. Replication policy creation does not automatically create a destination bucket. Create the destination bucket before creating the policy.
        :param builtins.str destination_region_name: The destination region to replicate to, for example "us-ashburn-1".
        :param builtins.str id: The id of the replication policy.
        :param builtins.str name: The name of the policy.
        :param builtins.str namespace: The Object Storage namespace used for the request.
        :param builtins.str status: The replication status of the policy. If the status is CLIENT_ERROR, once the user fixes the issue described in the status message, the status will become ACTIVE.
        :param builtins.str status_message: A human-readable description of the status.
        :param builtins.str time_created: The date when the replication policy was created as per [RFC 3339](https://tools.ietf.org/html/rfc3339).
        :param builtins.str time_last_sync: Changes made to the source bucket before this time has been replicated.
        """
        pulumi.set(__self__, "bucket", bucket)
...
class GetReplicationSourcesReplicationSourceResult(dict):
    def __init__(__self__, *,
                 ...
                 source_region_name: builtins.str):
        """
        :param builtins.str policy_name: The name of the policy.
        :param builtins.str source_bucket_name: The source bucket replicating data from.
        :param builtins.str source_region_name: The source region replicating data from, for example "us-ashburn-1".
        """
    ...
    def source_region_name(self) -> builtins.str:
        """
