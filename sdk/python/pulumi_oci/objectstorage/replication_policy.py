...
class ReplicationPolicyArgs:
    def __init__(__self__, *,
                 ...
                 destination_bucket_name: pulumi.Input[builtins.str],
                 destination_region_name: pulumi.Input[builtins.str],
                 namespace: pulumi.Input[builtins.str],
                 delete_object_in_destination_bucket: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] destination_bucket_name: The bucket to replicate to in the destination region. Replication policy creation does not automatically create a destination bucket. Create the destination bucket before creating the policy.
        :param pulumi.Input[builtins.str] destination_region_name: The destination region to replicate to, for example "us-ashburn-1".
        :param pulumi.Input[builtins.str] namespace: The Object Storage namespace used for the request.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] name: The name of the policy. Avoid entering confidential information.
        """
    ...
    def destination_bucket_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def destination_bucket_name(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "destination_bucket_name", value)

    @property
    @pulumi.getter(name="destinationRegionName")
    def destination_region_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def destination_region_name(self, value: pulumi.Input[builtins.str]):
    ...
    def delete_object_in_destination_bucket(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "delete_object_in_destination_bucket")

    @delete_object_in_destination_bucket.setter
    def delete_object_in_destination_bucket(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ReplicationPolicyState:
    def __init__(__self__, *,
                 ...
                 delete_object_in_destination_bucket: Optional[pulumi.Input[builtins.str]] = None,
                 destination_bucket_name: Optional[pulumi.Input[builtins.str]] = None,
                 destination_region_name: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 namespace: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 status_message: Optional[pulumi.Input[builtins.str]] = None,
                 time_created: Optional[pulumi.Input[builtins.str]] = None,
                 time_last_sync: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] namespace: The Object Storage namespace used for the request.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] status: The replication status of the policy. If the status is CLIENT_ERROR, once the user fixes the issue described in the status message, the status will become ACTIVE.
        :param pulumi.Input[builtins.str] status_message: A human-readable description of the status.
        :param pulumi.Input[builtins.str] time_created: The date when the replication policy was created as per [RFC 3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] time_last_sync: Changes made to the source bucket before this time has been replicated.
        """
    ...
    @property
    @pulumi.getter(name="destinationBucketName")
    def destination_bucket_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The bucket to replicate to in the destination region. Replication policy creation does not automatically create a destination bucket. Create the destination bucket before creating the policy.
        """
        return pulumi.get(self, "destination_bucket_name")
    ...
    @destination_bucket_name.setter
    def destination_bucket_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "destination_bucket_name", value)

    @property
    @pulumi.getter(name="destinationRegionName")
    def destination_region_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The destination region to replicate to, for example "us-ashburn-1".
        """
        return pulumi.get(self, "destination_region_name")
    ...
    @destination_region_name.setter
    def destination_region_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "destination_region_name", value)
    ...
    def time_last_sync(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_last_sync(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ReplicationPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status_message: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_last_sync: Optional[pulumi.Input[builtins.str]] = None) -> 'ReplicationPolicy':
        """
    ...
    @pulumi.getter(name="deleteObjectInDestinationBucket")
    @_utilities.deprecated("""The 'delete_object_in_destination_bucket' field has been deprecated. It is no longer supported.""")
    def delete_object_in_destination_bucket(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "delete_object_in_destination_bucket")

    @property
    @pulumi.getter(name="destinationBucketName")
    def destination_bucket_name(self) -> pulumi.Output[builtins.str]:
        """
        The bucket to replicate to in the destination region. Replication policy creation does not automatically create a destination bucket. Create the destination bucket before creating the policy.
        """
        return pulumi.get(self, "destination_bucket_name")
    ...
    @property
    @pulumi.getter(name="destinationRegionName")
    def destination_region_name(self) -> pulumi.Output[builtins.str]:
        """
        The destination region to replicate to, for example "us-ashburn-1".
        """
        return pulumi.get(self, "destination_region_name")
    ...
    @property
    @pulumi.getter(name="timeLastSync")
    def time_last_sync(self) -> pulumi.Output[builtins.str]:
        """
        Changes made to the source bucket before this time has been replicated.
        """
        return pulumi.get(self, "time_last_sync")
