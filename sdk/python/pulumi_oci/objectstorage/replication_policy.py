...
class ReplicationPolicyArgs:
    ...
    def destination_bucket_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def destination_bucket_name(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "destination_bucket_name", value)

    @_builtins.property
    @pulumi.getter(name="destinationRegionName")
    def destination_region_name(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def destination_region_name(self, value: pulumi.Input[_builtins.str]):
...
class _ReplicationPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] status_message: A human-readable description of the status.
        :param pulumi.Input[_builtins.str] time_created: The date when the replication policy was created as per [RFC 3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[_builtins.str] time_last_sync: Changes made to the source bucket before this time has been replicated.
        """
...
class ReplicationPolicy(pulumi.CustomResource):
    ...
    @pulumi.getter(name="deleteObjectInDestinationBucket")
    @_utilities.deprecated("""The 'delete_object_in_destination_bucket' field has been deprecated. It is no longer supported.""")
    def delete_object_in_destination_bucket(self) -> pulumi.Output[Optional[_builtins.str]]:
        return pulumi.get(self, "delete_object_in_destination_bucket")

    @_builtins.property
    @pulumi.getter(name="destinationBucketName")
    def destination_bucket_name(self) -> pulumi.Output[_builtins.str]:
        """
        The bucket to replicate to in the destination region. Replication policy creation does not automatically create a destination bucket. Create the destination bucket before creating the policy.
        """
        return pulumi.get(self, "destination_bucket_name")
    ...
    @_builtins.property
    @pulumi.getter(name="destinationRegionName")
    def destination_region_name(self) -> pulumi.Output[_builtins.str]:
        """
        The destination region to replicate to, for example "us-ashburn-1".
        """
        return pulumi.get(self, "destination_region_name")
    ...
    @_builtins.property
    @pulumi.getter(name="timeLastSync")
    def time_last_sync(self) -> pulumi.Output[_builtins.str]:
        """
        Changes made to the source bucket before this time has been replicated.
        """
        return pulumi.get(self, "time_last_sync")
