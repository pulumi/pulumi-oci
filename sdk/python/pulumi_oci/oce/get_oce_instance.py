...
class GetOceInstanceResult:
    ...
    def oce_instance_id(self) -> builtins.str:
...
def get_oce_instance(oce_instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str oce_instance_id: unique OceInstance identifier
    """
    __args__ = dict()
...
def get_oce_instance_output(oce_instance_id: Optional[pulumi.Input[builtins.str]] = None,
