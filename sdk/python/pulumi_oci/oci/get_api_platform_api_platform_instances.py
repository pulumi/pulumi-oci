...
def get_api_platform_api_platform_instances(compartment_id: Optional[_builtins.str] = None,
                                            filters: Optional[Sequence[Union['GetApiPlatformApiPlatformInstancesFilterArgs', 'GetApiPlatformApiPlatformInstancesFilterArgsDict', 'outputs.GetApiPlatformApiPlatformInstancesFilterResult']]] = None,
...
def get_api_platform_api_platform_instances_output(compartment_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                                   filters: pulumi.Input[Optional[Optional[Sequence[Union['GetApiPlatformApiPlatformInstancesFilterArgs', 'GetApiPlatformApiPlatformInstancesFilterArgsDict', 'outputs.GetApiPlatformApiPlatformInstancesFilterResult']]]]] = None,
