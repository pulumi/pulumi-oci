...
__all__ = [
    'GetBatchBatchContextShapesResult',
    'AwaitableGetBatchBatchContextShapesResult',
    'get_batch_batch_context_shapes',
    'get_batch_batch_context_shapes_output',
]

@pulumi.output_type
class GetBatchBatchContextShapesResult:
    """
    ...
    def __init__(__self__, availability_domain=None, batch_context_shape_collections=None, compartment_id=None, filters=None, id=None, shape_type=None):
        ...
        if batch_context_shape_collections and not isinstance(batch_context_shape_collections, list):
            raise TypeError("Expected argument 'batch_context_shape_collections' to be a list")
        pulumi.set(__self__, "batch_context_shape_collections", batch_context_shape_collections)
    ...
    @_builtins.property
    @pulumi.getter(name="batchContextShapeCollections")
    def batch_context_shape_collections(self) -> Sequence['outputs.GetBatchBatchContextShapesBatchContextShapeCollectionResult']:
        """
        The list of batch_context_shape_collection.
        """
        return pulumi.get(self, "batch_context_shape_collections")
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetBatchBatchContextShapesFilterResult']]:
...
class AwaitableGetBatchBatchContextShapesResult(GetBatchBatchContextShapesResult):
    ...
    def __await__(self):
        if False:
            yield self
        return GetBatchBatchContextShapesResult(
...
def get_batch_batch_context_shapes(availability_domain: Optional[_builtins.str] = None,
                                   ...
                                   filters: Optional[Sequence[Union['GetBatchBatchContextShapesFilterArgs', 'GetBatchBatchContextShapesFilterArgsDict', 'outputs.GetBatchBatchContextShapesFilterResult']]] = None,
    ...
    return AwaitableGetBatchBatchContextShapesResult(
...
def get_batch_batch_context_shapes_output(availability_domain: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                          ...
                                          filters: pulumi.Input[Optional[Optional[Sequence[Union['GetBatchBatchContextShapesFilterArgs', 'GetBatchBatchContextShapesFilterArgsDict', 'outputs.GetBatchBatchContextShapesFilterResult']]]]] = None,
