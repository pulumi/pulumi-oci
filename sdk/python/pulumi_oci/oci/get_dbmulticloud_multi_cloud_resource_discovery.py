...
class GetDbmulticloudMultiCloudResourceDiscoveryResult:
    ...
    def multi_cloud_resource_discovery_id(self) -> _builtins.str:
...
def get_dbmulticloud_multi_cloud_resource_discovery(multi_cloud_resource_discovery_id: Optional[_builtins.str] = None,
