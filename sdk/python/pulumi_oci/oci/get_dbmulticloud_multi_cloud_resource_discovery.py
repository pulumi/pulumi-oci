...
__all__ = [
    'GetDbmulticloudMultiCloudResourceDiscoveryResult',
    'AwaitableGetDbmulticloudMultiCloudResourceDiscoveryResult',
    'get_dbmulticloud_multi_cloud_resource_discovery',
    'get_dbmulticloud_multi_cloud_resource_discovery_output',
]

@pulumi.output_type
class GetDbmulticloudMultiCloudResourceDiscoveryResult:
    """
    ...
    def multi_cloud_resource_discovery_id(self) -> builtins.str:
    ...
    @property
    @pulumi.getter
    def resources(self) -> Sequence['outputs.GetDbmulticloudMultiCloudResourceDiscoveryResourceResult']:
        """
...
class AwaitableGetDbmulticloudMultiCloudResourceDiscoveryResult(GetDbmulticloudMultiCloudResourceDiscoveryResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDbmulticloudMultiCloudResourceDiscoveryResult(
...
def get_dbmulticloud_multi_cloud_resource_discovery(multi_cloud_resource_discovery_id: Optional[builtins.str] = None,
                                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDbmulticloudMultiCloudResourceDiscoveryResult:
    """
    ...
    :param builtins.str multi_cloud_resource_discovery_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Multi Cloud Discovery Resource.
    """
    __args__ = dict()
    __args__['multiCloudResourceDiscoveryId'] = multi_cloud_resource_discovery_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:oci/getDbmulticloudMultiCloudResourceDiscovery:getDbmulticloudMultiCloudResourceDiscovery', __args__, opts=opts, typ=GetDbmulticloudMultiCloudResourceDiscoveryResult).value

    return AwaitableGetDbmulticloudMultiCloudResourceDiscoveryResult(
...
def get_dbmulticloud_multi_cloud_resource_discovery_output(multi_cloud_resource_discovery_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:oci/getDbmulticloudMultiCloudResourceDiscovery:getDbmulticloudMultiCloudResourceDiscovery', __args__, opts=opts, typ=GetDbmulticloudMultiCloudResourceDiscoveryResult)
    return __ret__.apply(lambda __response__: GetDbmulticloudMultiCloudResourceDiscoveryResult(
