...
def get_dbmulticloud_oracle_db_azure_blob_container(oracle_db_azure_blob_container_id: Optional[builtins.str] = None,
    ...
    :param builtins.str oracle_db_azure_blob_container_id: The ID of the Oracle DB Azure Blob Container Resource.
    """
    __args__ = dict()
...
def get_dbmulticloud_oracle_db_azure_blob_container_output(oracle_db_azure_blob_container_id: Optional[pulumi.Input[builtins.str]] = None,
