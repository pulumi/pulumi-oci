...
class GetDbmulticloudOracleDbAzureBlobMountResult:
    ...
    def oracle_db_azure_blob_mount_id(self) -> builtins.str:
...
def get_dbmulticloud_oracle_db_azure_blob_mount(oracle_db_azure_blob_mount_id: Optional[builtins.str] = None,
    ...
    :param builtins.str oracle_db_azure_blob_mount_id: The ID of the Azure Container Resource.
    """
    __args__ = dict()
...
def get_dbmulticloud_oracle_db_azure_blob_mount_output(oracle_db_azure_blob_mount_id: Optional[pulumi.Input[builtins.str]] = None,
