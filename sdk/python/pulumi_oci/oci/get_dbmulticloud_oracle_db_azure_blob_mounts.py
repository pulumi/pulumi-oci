...
class GetDbmulticloudOracleDbAzureBlobMountsResult:
    ...
    def oracle_db_azure_blob_mount_id(self) -> Optional[builtins.str]:
...
def get_dbmulticloud_oracle_db_azure_blob_mounts(compartment_id: Optional[builtins.str] = None,
                                                 ...
                                                 oracle_db_azure_blob_mount_id: Optional[builtins.str] = None,
    ...
    :param builtins.str oracle_db_azure_blob_mount_id: ID of Oracle DB Azure Blob Mount Resource.
...
def get_dbmulticloud_oracle_db_azure_blob_mounts_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                                        ...
                                                        oracle_db_azure_blob_mount_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
