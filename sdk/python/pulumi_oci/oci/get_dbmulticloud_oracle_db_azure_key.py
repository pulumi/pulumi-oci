...
class GetDbmulticloudOracleDbAzureKeyResult:
    ...
    def oracle_db_azure_key_id(self) -> _builtins.str:
...
def get_dbmulticloud_oracle_db_azure_key(oracle_db_azure_key_id: Optional[_builtins.str] = None,
...
def get_dbmulticloud_oracle_db_azure_key_output(oracle_db_azure_key_id: Optional[pulumi.Input[_builtins.str]] = None,
