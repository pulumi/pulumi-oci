...
__all__ = [
    'GetDbmulticloudOracleDbAzureKeyResult',
    'AwaitableGetDbmulticloudOracleDbAzureKeyResult',
    'get_dbmulticloud_oracle_db_azure_key',
    'get_dbmulticloud_oracle_db_azure_key_output',
]

@pulumi.output_type
class GetDbmulticloudOracleDbAzureKeyResult:
    """
    ...
    def oracle_db_azure_key_id(self) -> builtins.str:
...
class AwaitableGetDbmulticloudOracleDbAzureKeyResult(GetDbmulticloudOracleDbAzureKeyResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDbmulticloudOracleDbAzureKeyResult(
...
def get_dbmulticloud_oracle_db_azure_key(oracle_db_azure_key_id: Optional[builtins.str] = None,
                                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDbmulticloudOracleDbAzureKeyResult:
    """
    ...
    :param builtins.str oracle_db_azure_key_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Oracle DB Azure Vault Key Resource.
    """
    __args__ = dict()
    __args__['oracleDbAzureKeyId'] = oracle_db_azure_key_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:oci/getDbmulticloudOracleDbAzureKey:getDbmulticloudOracleDbAzureKey', __args__, opts=opts, typ=GetDbmulticloudOracleDbAzureKeyResult).value

    return AwaitableGetDbmulticloudOracleDbAzureKeyResult(
        azure_key_id=pulumi.get(__ret__, 'azure_key_id'),
...
def get_dbmulticloud_oracle_db_azure_key_output(oracle_db_azure_key_id: Optional[pulumi.Input[builtins.str]] = None,
                                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetDbmulticloudOracleDbAzureKeyResult]:
    """
    This data source provides details about a specific Oracle Db Azure Key resource in Oracle Cloud Infrastructure Dbmulticloud service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:oci/getDbmulticloudOracleDbAzureKey:getDbmulticloudOracleDbAzureKey', __args__, opts=opts, typ=GetDbmulticloudOracleDbAzureKeyResult)
    return __ret__.apply(lambda __response__: GetDbmulticloudOracleDbAzureKeyResult(
        azure_key_id=pulumi.get(__response__, 'azure_key_id'),
