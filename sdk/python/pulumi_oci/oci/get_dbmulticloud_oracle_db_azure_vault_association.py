...
__all__ = [
    'GetDbmulticloudOracleDbAzureVaultAssociationResult',
    'AwaitableGetDbmulticloudOracleDbAzureVaultAssociationResult',
    'get_dbmulticloud_oracle_db_azure_vault_association',
    'get_dbmulticloud_oracle_db_azure_vault_association_output',
]

@pulumi.output_type
class GetDbmulticloudOracleDbAzureVaultAssociationResult:
    """
    A collection of values returned by getDbmulticloudOracleDbAzureVaultAssociation.
    """
    def __init__(__self__, compartment_id=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, is_resource_accessible=None, last_modification=None, lifecycle_state_details=None, oracle_db_azure_connector_id=None, oracle_db_azure_vault_association_id=None, oracle_db_azure_vault_id=None, state=None, system_tags=None, time_created=None, time_updated=None):
        ...
        if is_resource_accessible and not isinstance(is_resource_accessible, bool):
            raise TypeError("Expected argument 'is_resource_accessible' to be a bool")
        ...
        if oracle_db_azure_vault_association_id and not isinstance(oracle_db_azure_vault_association_id, str):
            raise TypeError("Expected argument 'oracle_db_azure_vault_association_id' to be a str")
        pulumi.set(__self__, "oracle_db_azure_vault_association_id", oracle_db_azure_vault_association_id)
    ...
    @property
    @pulumi.getter(name="oracleDbAzureVaultAssociationId")
    def oracle_db_azure_vault_association_id(self) -> builtins.str:
        return pulumi.get(self, "oracle_db_azure_vault_association_id")
...
class AwaitableGetDbmulticloudOracleDbAzureVaultAssociationResult(GetDbmulticloudOracleDbAzureVaultAssociationResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDbmulticloudOracleDbAzureVaultAssociationResult(
            compartment_id=self.compartment_id,
            defined_tags=self.defined_tags,
            display_name=self.display_name,
            freeform_tags=self.freeform_tags,
            id=self.id,
            is_resource_accessible=self.is_resource_accessible,
            ...
            oracle_db_azure_vault_association_id=self.oracle_db_azure_vault_association_id,
...
def get_dbmulticloud_oracle_db_azure_vault_association(oracle_db_azure_vault_association_id: Optional[builtins.str] = None,
                                                       opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDbmulticloudOracleDbAzureVaultAssociationResult:
    """
    ...
    :param builtins.str oracle_db_azure_vault_association_id: The ID of the Oracle DB Azure Vault Association Resource.
    """
    __args__ = dict()
    __args__['oracleDbAzureVaultAssociationId'] = oracle_db_azure_vault_association_id
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:oci/getDbmulticloudOracleDbAzureVaultAssociation:getDbmulticloudOracleDbAzureVaultAssociation', __args__, opts=opts, typ=GetDbmulticloudOracleDbAzureVaultAssociationResult).value

    return AwaitableGetDbmulticloudOracleDbAzureVaultAssociationResult(
        compartment_id=pulumi.get(__ret__, 'compartment_id'),
        defined_tags=pulumi.get(__ret__, 'defined_tags'),
        display_name=pulumi.get(__ret__, 'display_name'),
        freeform_tags=pulumi.get(__ret__, 'freeform_tags'),
        id=pulumi.get(__ret__, 'id'),
        is_resource_accessible=pulumi.get(__ret__, 'is_resource_accessible'),
        ...
        oracle_db_azure_vault_association_id=pulumi.get(__ret__, 'oracle_db_azure_vault_association_id'),
        oracle_db_azure_vault_id=pulumi.get(__ret__, 'oracle_db_azure_vault_id'),
        state=pulumi.get(__ret__, 'state'),
        system_tags=pulumi.get(__ret__, 'system_tags'),
        time_created=pulumi.get(__ret__, 'time_created'),
        time_updated=pulumi.get(__ret__, 'time_updated'))
def get_dbmulticloud_oracle_db_azure_vault_association_output(oracle_db_azure_vault_association_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:oci/getDbmulticloudOracleDbAzureVaultAssociation:getDbmulticloudOracleDbAzureVaultAssociation', __args__, opts=opts, typ=GetDbmulticloudOracleDbAzureVaultAssociationResult)
    return __ret__.apply(lambda __response__: GetDbmulticloudOracleDbAzureVaultAssociationResult(
        compartment_id=pulumi.get(__response__, 'compartment_id'),
        defined_tags=pulumi.get(__response__, 'defined_tags'),
        display_name=pulumi.get(__response__, 'display_name'),
        freeform_tags=pulumi.get(__response__, 'freeform_tags'),
        id=pulumi.get(__response__, 'id'),
        is_resource_accessible=pulumi.get(__response__, 'is_resource_accessible'),
        ...
        oracle_db_azure_vault_association_id=pulumi.get(__response__, 'oracle_db_azure_vault_association_id'),
