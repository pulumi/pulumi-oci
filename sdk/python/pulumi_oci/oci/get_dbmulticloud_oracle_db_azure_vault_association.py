...
class GetDbmulticloudOracleDbAzureVaultAssociationResult:
    ...
    def oracle_db_azure_vault_association_id(self) -> _builtins.str:
...
def get_dbmulticloud_oracle_db_azure_vault_association(oracle_db_azure_vault_association_id: Optional[_builtins.str] = None,
