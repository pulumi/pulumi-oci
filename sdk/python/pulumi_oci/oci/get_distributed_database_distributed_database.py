...
class GetDistributedDatabaseDistributedDatabaseResult:
    ...
    def __init__(__self__, catalog_details=None, change_db_backup_config_trigger=None, character_set=None, chunks=None, compartment_id=None, configure_sharding_is_rebalance_required=None, configure_sharding_trigger=None, connection_strings=None, database_version=None, db_backup_configs=None, db_deployment_type=None, defined_tags=None, display_name=None, distributed_database_id=None, download_gsm_certificate_signing_request_trigger=None, effective_replication_unit=None, freeform_tags=None, generate_gsm_certificate_signing_request_trigger=None, generate_wallet_downloaded_wallet_content_length=None, generate_wallet_downloaded_wallet_etag=None, generate_wallet_downloaded_wallet_last_modified=None, generate_wallet_downloaded_wallet_zip_base64=None, generate_wallet_password=None, generate_wallet_trigger=None, gsm_details=None, gsm_ssh_public_key=None, id=None, latest_gsm_image_details=None, lifecycle_details=None, listener_port=None, listener_port_tls=None, metadata=None, move_replication_unit_trigger=None, ncharacter_set=None, ons_port_local=None, ons_port_remote=None, patch_operations=None, prefix=None, private_endpoint_ids=None, recreate_failed_resource_trigger=None, replication_factor=None, replication_method=None, replication_unit=None, scan_listener_port=None, shard_details=None, sharding_method=None, start_database_trigger=None, state=None, stop_database_trigger=None, system_tags=None, time_created=None, time_updated=None, upload_signed_certificate_and_generate_wallet_trigger=None, validate_network_details=None, validate_network_trigger=None):
        ...
        if distributed_database_id and not isinstance(distributed_database_id, str):
            raise TypeError("Expected argument 'distributed_database_id' to be a str")
        pulumi.set(__self__, "distributed_database_id", distributed_database_id)
        ...
        if gsm_ssh_public_key and not isinstance(gsm_ssh_public_key, str):
            raise TypeError("Expected argument 'gsm_ssh_public_key' to be a str")
        pulumi.set(__self__, "gsm_ssh_public_key", gsm_ssh_public_key)
        if id and not isinstance(id, str):
            raise TypeError("Expected argument 'id' to be a str")
        pulumi.set(__self__, "id", id)
        if latest_gsm_image_details and not isinstance(latest_gsm_image_details, list):
            raise TypeError("Expected argument 'latest_gsm_image_details' to be a list")
    ...
    def catalog_details(self) -> Sequence['outputs.GetDistributedDatabaseDistributedDatabaseCatalogDetailResult']:
        """
    ...
    def connection_strings(self) -> Sequence['outputs.GetDistributedDatabaseDistributedDatabaseConnectionStringResult']:
        """
    ...
    def db_backup_configs(self) -> Sequence['outputs.GetDistributedDatabaseDistributedDatabaseDbBackupConfigResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter(name="distributedDatabaseId")
    def distributed_database_id(self) -> _builtins.str:
        return pulumi.get(self, "distributed_database_id")
    ...
    def gsm_details(self) -> Sequence['outputs.GetDistributedDatabaseDistributedDatabaseGsmDetailResult']:
        """
        Collection of catalogs associated with the Globally distributed database.
        """
    ...
    def latest_gsm_image_details(self) -> Sequence['outputs.GetDistributedDatabaseDistributedDatabaseLatestGsmImageDetailResult']:
        """
    ...
    def patch_operations(self) -> Sequence['outputs.GetDistributedDatabaseDistributedDatabasePatchOperationResult']:
    ...
    def shard_details(self) -> Sequence['outputs.GetDistributedDatabaseDistributedDatabaseShardDetailResult']:
        """
    ...
    def validate_network_details(self) -> Sequence['outputs.GetDistributedDatabaseDistributedDatabaseValidateNetworkDetailResult']:
...
class AwaitableGetDistributedDatabaseDistributedDatabaseResult(GetDistributedDatabaseDistributedDatabaseResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDistributedDatabaseDistributedDatabaseResult(
            ...
            distributed_database_id=self.distributed_database_id,
            ...
            gsm_ssh_public_key=self.gsm_ssh_public_key,
            id=self.id,
            latest_gsm_image_details=self.latest_gsm_image_details,
...
def get_distributed_database_distributed_database(distributed_database_id: Optional[_builtins.str] = None,
                                                  metadata: Optional[_builtins.str] = None,
                                                  opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetDistributedDatabaseDistributedDatabaseResult:
    """
    ...
    :param _builtins.str distributed_database_id: Globally distributed database identifier
    :param _builtins.str metadata: Comma separated names of argument corresponding to which metadata need to be retrived.
    """
    __args__ = dict()
    __args__['distributedDatabaseId'] = distributed_database_id
    __args__['metadata'] = metadata
    opts = pulumi.InvokeOptions.merge(_utilities.get_invoke_opts_defaults(), opts)
    __ret__ = pulumi.runtime.invoke('oci:oci/getDistributedDatabaseDistributedDatabase:getDistributedDatabaseDistributedDatabase', __args__, opts=opts, typ=GetDistributedDatabaseDistributedDatabaseResult).value

    return AwaitableGetDistributedDatabaseDistributedDatabaseResult(
        ...
        gsm_ssh_public_key=pulumi.get(__ret__, 'gsm_ssh_public_key'),
        id=pulumi.get(__ret__, 'id'),
        latest_gsm_image_details=pulumi.get(__ret__, 'latest_gsm_image_details'),
...
def get_distributed_database_distributed_database_output(distributed_database_id: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:oci/getDistributedDatabaseDistributedDatabase:getDistributedDatabaseDistributedDatabase', __args__, opts=opts, typ=GetDistributedDatabaseDistributedDatabaseResult)
    return __ret__.apply(lambda __response__: GetDistributedDatabaseDistributedDatabaseResult(
        ...
        distributed_database_id=pulumi.get(__response__, 'distributed_database_id'),
        ...
        gsm_ssh_public_key=pulumi.get(__response__, 'gsm_ssh_public_key'),
        id=pulumi.get(__response__, 'id'),
        latest_gsm_image_details=pulumi.get(__response__, 'latest_gsm_image_details'),
