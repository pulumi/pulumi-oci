...
__all__ = [
    'GetDistributedDatabaseDistributedDatabasesResult',
    'AwaitableGetDistributedDatabaseDistributedDatabasesResult',
    'get_distributed_database_distributed_databases',
    'get_distributed_database_distributed_databases_output',
]

@pulumi.output_type
class GetDistributedDatabaseDistributedDatabasesResult:
    """
    ...
    def __init__(__self__, compartment_id=None, db_deployment_type=None, display_name=None, distributed_database_collections=None, filters=None, id=None, metadata=None, private_endpoint_id=None, state=None):
        ...
        if distributed_database_collections and not isinstance(distributed_database_collections, list):
            raise TypeError("Expected argument 'distributed_database_collections' to be a list")
        pulumi.set(__self__, "distributed_database_collections", distributed_database_collections)
    ...
    @_builtins.property
    @pulumi.getter(name="distributedDatabaseCollections")
    def distributed_database_collections(self) -> Sequence['outputs.GetDistributedDatabaseDistributedDatabasesDistributedDatabaseCollectionResult']:
        """
        The list of distributed_database_collection.
        """
        return pulumi.get(self, "distributed_database_collections")

    @_builtins.property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetDistributedDatabaseDistributedDatabasesFilterResult']]:
...
class AwaitableGetDistributedDatabaseDistributedDatabasesResult(GetDistributedDatabaseDistributedDatabasesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetDistributedDatabaseDistributedDatabasesResult(
            compartment_id=self.compartment_id,
            db_deployment_type=self.db_deployment_type,
            display_name=self.display_name,
            distributed_database_collections=self.distributed_database_collections,
...
def get_distributed_database_distributed_databases(compartment_id: Optional[_builtins.str] = None,
    ...
    return AwaitableGetDistributedDatabaseDistributedDatabasesResult(
        compartment_id=pulumi.get(__ret__, 'compartment_id'),
        db_deployment_type=pulumi.get(__ret__, 'db_deployment_type'),
        display_name=pulumi.get(__ret__, 'display_name'),
        distributed_database_collections=pulumi.get(__ret__, 'distributed_database_collections'),
...
def get_distributed_database_distributed_databases_output(compartment_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetDistributedDatabaseDistributedDatabasesResult(
        compartment_id=pulumi.get(__response__, 'compartment_id'),
        db_deployment_type=pulumi.get(__response__, 'db_deployment_type'),
        display_name=pulumi.get(__response__, 'display_name'),
        distributed_database_collections=pulumi.get(__response__, 'distributed_database_collections'),
