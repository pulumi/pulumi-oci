...
def get_wlms_managed_instance_server(managed_instance_id: Optional[_builtins.str] = None,
...
def get_wlms_managed_instance_server_output(managed_instance_id: Optional[pulumi.Input[_builtins.str]] = None,
