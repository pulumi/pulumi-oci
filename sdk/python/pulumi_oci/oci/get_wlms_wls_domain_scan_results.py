...
def get_wlms_wls_domain_scan_results_output(filters: pulumi.Input[Optional[Optional[Sequence[Union['GetWlmsWlsDomainScanResultsFilterArgs', 'GetWlmsWlsDomainScanResultsFilterArgsDict']]]]] = None,
