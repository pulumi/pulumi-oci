...
class DatastoreArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] display_name: (Updatable) A descriptive name for the Datastore. It must be unique within a SDDC, start with a letter, and contain only letters, digits, whitespaces, dashes and underscores. Avoid entering confidential information.
...
class _DatastoreState:
    def __init__(__self__, *,
                 ...
                 block_volume_details: Optional[pulumi.Input[Sequence[pulumi.Input['DatastoreBlockVolumeDetailArgs']]]] = None,
                 block_volume_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}` 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] sddc_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the SDDC that Datastore is associated with.
        :param pulumi.Input[_builtins.str] state: The current state of the Datastore.
        ...
        :param pulumi.Input[_builtins.str] time_created: The date and time the Datastore was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339). Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[_builtins.str] time_updated: The date and time the Datastore was updated, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        """
        if availability_domain is not None:
            pulumi.set(__self__, "availability_domain", availability_domain)
        if block_volume_details is not None:
    ...
    def block_volume_details(self) -> Optional[pulumi.Input[Sequence[pulumi.Input['DatastoreBlockVolumeDetailArgs']]]]:
        """
        The list of Block Volume details that belong to the datastore.
        """
        return pulumi.get(self, "block_volume_details")

    @block_volume_details.setter
    def block_volume_details(self, value: Optional[pulumi.Input[Sequence[pulumi.Input['DatastoreBlockVolumeDetailArgs']]]]):
        pulumi.set(self, "block_volume_details", value)

    @_builtins.property
    @pulumi.getter(name="blockVolumeIds")
    def block_volume_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]:
        """
        The List of Block volume [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)s that belong to the Datastore.
        """
        return pulumi.get(self, "block_volume_ids")
    ...
    @block_volume_ids.setter
    def block_volume_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]]):
        pulumi.set(self, "block_volume_ids", value)
...
@pulumi.type_token("oci:Ocvp/datastore:Datastore")
class Datastore(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if block_volume_ids is None and not opts.urn:
                raise TypeError("Missing required property 'block_volume_ids'")
            __props__.__dict__["block_volume_ids"] = block_volume_ids
            ...
            __props__.__dict__["block_volume_details"] = None
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            availability_domain: Optional[pulumi.Input[_builtins.str]] = None,
            block_volume_details: Optional[pulumi.Input[Sequence[pulumi.Input[Union['DatastoreBlockVolumeDetailArgs', 'DatastoreBlockVolumeDetailArgsDict']]]]] = None,
            block_volume_ids: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            capacity_in_gbs: Optional[pulumi.Input[_builtins.float]] = None,
            cluster_id: Optional[pulumi.Input[_builtins.str]] = None,
            compartment_id: Optional[pulumi.Input[_builtins.str]] = None,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[_builtins.str]] = None,
            time_updated: Optional[pulumi.Input[_builtins.str]] = None) -> 'Datastore':
        """
        ...
        __props__.__dict__["availability_domain"] = availability_domain
        __props__.__dict__["block_volume_details"] = block_volume_details
        __props__.__dict__["block_volume_ids"] = block_volume_ids
    ...
    @_builtins.property
    @pulumi.getter(name="blockVolumeDetails")
    def block_volume_details(self) -> pulumi.Output[Sequence['outputs.DatastoreBlockVolumeDetail']]:
        """
        The list of Block Volume details that belong to the datastore.
        """
        return pulumi.get(self, "block_volume_details")
    ...
    @_builtins.property
    @pulumi.getter(name="blockVolumeIds")
    def block_volume_ids(self) -> pulumi.Output[Sequence[_builtins.str]]:
        """
        The List of Block volume [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)s that belong to the Datastore.
        """
        return pulumi.get(self, "block_volume_ids")
