...
class EsxiHostArgs:
    def __init__(__self__, *,
                 billing_donor_host_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 current_sku: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 esxi_software_version: Optional[pulumi.Input[builtins.str]] = None,
                 failed_esxi_host_id: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 host_ocpu_count: Optional[pulumi.Input[builtins.float]] = None,
                 host_shape_name: Optional[pulumi.Input[builtins.str]] = None,
                 next_sku: Optional[pulumi.Input[builtins.str]] = None,
                 non_upgraded_esxi_host_id: Optional[pulumi.Input[builtins.str]] = None,
                 sddc_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a EsxiHost resource.
        :param pulumi.Input[builtins.str] billing_donor_host_id: (Optional) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the deleted ESXi Host with LeftOver billing cycle.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) A descriptive name for the ESXi host. It's changeable. Esxi Host name requirements are 1-16 character length limit, Must start with a letter,  Must be English letters, numbers, - only, No repeating hyphens, Must be unique within the Cluster.
    ...
    def billing_donor_host_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def billing_donor_host_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def current_sku(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Optional) The billing option currently used by the ESXi host. It is only effective during resource creation. Changes to its value after creation will be ignored. [ListSupportedSkus](https://docs.cloud.oracle.com/iaas/api/#/en/vmware/20200501/SupportedSkuSummary/ListSupportedSkus). **Deprecated**. Please use `current_commitment` instead.
        """
    ...
    @current_sku.setter
    def current_sku(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def failed_esxi_host_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def failed_esxi_host_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def host_ocpu_count(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def host_ocpu_count(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "host_ocpu_count", value)

    @property
    @pulumi.getter(name="hostShapeName")
    def host_shape_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def host_shape_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def next_sku(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "next_sku")

    @next_sku.setter
    def next_sku(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def non_upgraded_esxi_host_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Optional) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the ESXi host that will be upgraded. This is an optional parameter. If this parameter is specified, an ESXi host with the new software version is created to replace the original one, and the `nonUpgradedEsxiHostId` field is updated in the newly created Esxi host. See [Upgrading VMware Software](https://docs.cloud.oracle.com/iaas/Content/VMware/Concepts/upgrade.htm) for more information.
        """
    ...
    def non_upgraded_esxi_host_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _EsxiHostState:
    def __init__(__self__, *,
                 billing_contract_end_date: Optional[pulumi.Input[builtins.str]] = None,
                 billing_donor_host_id: Optional[pulumi.Input[builtins.str]] = None,
                 capacity_reservation_id: Optional[pulumi.Input[builtins.str]] = None,
                 cluster_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 current_commitment: Optional[pulumi.Input[builtins.str]] = None,
                 current_sku: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 esxi_software_version: Optional[pulumi.Input[builtins.str]] = None,
                 failed_esxi_host_id: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 grace_period_end_date: Optional[pulumi.Input[builtins.str]] = None,
                 host_ocpu_count: Optional[pulumi.Input[builtins.float]] = None,
                 host_shape_name: Optional[pulumi.Input[builtins.str]] = None,
                 is_billing_continuation_in_progress: Optional[pulumi.Input[builtins.bool]] = None,
                 is_billing_swapping_in_progress: Optional[pulumi.Input[builtins.bool]] = None,
                 next_commitment: Optional[pulumi.Input[builtins.str]] = None,
                 next_sku: Optional[pulumi.Input[builtins.str]] = None,
                 non_upgraded_esxi_host_id: Optional[pulumi.Input[builtins.str]] = None,
                 replacement_esxi_host_id: Optional[pulumi.Input[builtins.str]] = None,
                 sddc_id: Optional[pulumi.Input[builtins.str]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 swap_billing_host_id: Optional[pulumi.Input[builtins.str]] = None,
                 time_created: Optional[pulumi.Input[builtins.str]] = None,
                 time_updated: Optional[pulumi.Input[builtins.str]] = None,
                 upgraded_replacement_esxi_host_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] billing_contract_end_date: Current billing cycle end date. If the value in `currentCommitment` and `nextCommitment` are different, the value specified in `nextCommitment` becomes the new `currentCommitment` when the `contractEndDate` is reached. Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] billing_donor_host_id: (Optional) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the deleted ESXi Host with LeftOver billing cycle.
        :param pulumi.Input[builtins.str] capacity_reservation_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Capacity Reservation.
        :param pulumi.Input[builtins.str] cluster_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Cluster to add the ESXi host to.
        ...
        :param pulumi.Input[builtins.str] compute_availability_domain: The availability domain to create the ESXi host in. If keep empty, for AD-specific Cluster, new ESXi host will be created in the same availability domain; for multi-AD Cluster, new ESXi host will be auto assigned to the next availability domain following evenly distribution strategy.
        :param pulumi.Input[builtins.str] compute_instance_id: In terms of implementation, an ESXi host is a Compute instance that is configured with the chosen bundle of VMware software. The `computeInstanceId` is the [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of that Compute instance.
        :param pulumi.Input[builtins.str] current_commitment: The billing option currently used by the ESXi host. [ListSupportedCommitments](https://docs.cloud.oracle.com/iaas/api/#/en/vmware/20230701/SupportedCommitmentSummary/ListSupportedCommitments).
        :param pulumi.Input[builtins.str] current_sku: (Optional) The billing option currently used by the ESXi host. It is only effective during resource creation. Changes to its value after creation will be ignored. [ListSupportedSkus](https://docs.cloud.oracle.com/iaas/api/#/en/vmware/20200501/SupportedSkuSummary/ListSupportedSkus). **Deprecated**. Please use `current_commitment` instead.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] display_name: (Updatable) A descriptive name for the ESXi host. It's changeable. Esxi Host name requirements are 1-16 character length limit, Must start with a letter,  Must be English letters, numbers, - only, No repeating hyphens, Must be unique within the Cluster.
        ...
        :param pulumi.Input[builtins.str] failed_esxi_host_id: (Optional) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the ESXi host that is failed. This is an optional parameter. If this parameter is specified, a new ESXi host will be created to replace the failed one, and the `failedEsxiHostId` field will be updated in the newly created Esxi host.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] grace_period_end_date: The date and time when the new esxi host should start billing cycle. [RFC3339](https://tools.ietf.org/html/rfc3339). Example: `2021-07-25T21:10:29.600Z`
        :param pulumi.Input[builtins.float] host_ocpu_count: The OCPU count of the ESXi host.
        :param pulumi.Input[builtins.str] host_shape_name: The compute shape name of the ESXi host. [ListSupportedHostShapes](https://docs.cloud.oracle.com/iaas/api/#/en/vmware/20230701/SupportedHostShapes/ListSupportedHostShapes).
        :param pulumi.Input[builtins.bool] is_billing_continuation_in_progress: Indicates whether this host is in the progress of billing continuation.
        :param pulumi.Input[builtins.bool] is_billing_swapping_in_progress: Indicates whether this host is in the progress of swapping billing.
        :param pulumi.Input[builtins.str] next_commitment: The billing option to switch to after the current billing cycle ends. If `nextCommitment` is null or empty, `currentCommitment` continues to the next billing cycle. [ListSupportedCommitments](https://docs.cloud.oracle.com/iaas/api/#/en/vmware/20230701/SupportedCommitmentSummary/ListSupportedCommitments).
        :param pulumi.Input[builtins.str] non_upgraded_esxi_host_id: (Optional) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the ESXi host that will be upgraded. This is an optional parameter. If this parameter is specified, an ESXi host with the new software version is created to replace the original one, and the `nonUpgradedEsxiHostId` field is updated in the newly created Esxi host. See [Upgrading VMware Software](https://docs.cloud.oracle.com/iaas/Content/VMware/Concepts/upgrade.htm) for more information.
        :param pulumi.Input[builtins.str] replacement_esxi_host_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the esxi host that is newly created to replace the failed node.
        :param pulumi.Input[builtins.str] sddc_id: (Optional) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the SDDC to add the ESXi host to. This field has been deprecated. Please use `cluster_id` instead. Either `sddc_id` or `cluster_id` must be configured for `Ocvp.EsxiHost` resource.  **Deprecated**. Please use `cluster_id` instead.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The current state of the ESXi host.
        :param pulumi.Input[builtins.str] swap_billing_host_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the active ESXi Host to swap billing with current host.
        :param pulumi.Input[builtins.str] time_created: The date and time the ESXi host was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_updated: The date and time the ESXi host was updated, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        :param pulumi.Input[builtins.str] upgraded_replacement_esxi_host_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the ESXi host that is newly created to upgrade the original host.
        :param pulumi.Input[builtins.str] vmware_software_version: The version of VMware software that Oracle Cloud VMware Solution installed on the ESXi hosts.
        """
    ...
    def billing_contract_end_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def billing_contract_end_date(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def current_commitment(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def current_commitment(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def grace_period_end_date(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def grace_period_end_date(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_billing_continuation_in_progress(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_billing_continuation_in_progress(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_billing_continuation_in_progress", value)

    @property
    @pulumi.getter(name="isBillingSwappingInProgress")
    def is_billing_swapping_in_progress(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_billing_swapping_in_progress(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_billing_swapping_in_progress", value)

    @property
    @pulumi.getter(name="nextCommitment")
    def next_commitment(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def next_commitment(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def replacement_esxi_host_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def replacement_esxi_host_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def swap_billing_host_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def swap_billing_host_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def upgraded_replacement_esxi_host_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def upgraded_replacement_esxi_host_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EsxiHost(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            upgraded_replacement_esxi_host_id: Optional[pulumi.Input[builtins.str]] = None,
            vmware_software_version: Optional[pulumi.Input[builtins.str]] = None) -> 'EsxiHost':
        """
    ...
    @property
    @pulumi.getter(name="billingContractEndDate")
    def billing_contract_end_date(self) -> pulumi.Output[builtins.str]:
        """
        Current billing cycle end date. If the value in `currentCommitment` and `nextCommitment` are different, the value specified in `nextCommitment` becomes the new `currentCommitment` when the `contractEndDate` is reached. Example: `2016-08-25T21:10:29.600Z`
        """
        return pulumi.get(self, "billing_contract_end_date")
    ...
    @pulumi.getter(name="billingDonorHostId")
    @_utilities.deprecated("""This 'billing_donor_host_id' argument has been deprecated and will be computed only.""")
    def billing_donor_host_id(self) -> pulumi.Output[builtins.str]:
        """
        (Optional) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the deleted ESXi Host with LeftOver billing cycle.
        """
        return pulumi.get(self, "billing_donor_host_id")
    ...
    @property
    @pulumi.getter(name="currentCommitment")
    def current_commitment(self) -> pulumi.Output[builtins.str]:
        """
        The billing option currently used by the ESXi host. [ListSupportedCommitments](https://docs.cloud.oracle.com/iaas/api/#/en/vmware/20230701/SupportedCommitmentSummary/ListSupportedCommitments).
        """
        return pulumi.get(self, "current_commitment")
    ...
    @pulumi.getter(name="currentSku")
    @_utilities.deprecated("""The 'current_sku' field has been deprecated. It is no longer supported.""")
    def current_sku(self) -> pulumi.Output[builtins.str]:
        """
        (Optional) The billing option currently used by the ESXi host. It is only effective during resource creation. Changes to its value after creation will be ignored. [ListSupportedSkus](https://docs.cloud.oracle.com/iaas/api/#/en/vmware/20200501/SupportedSkuSummary/ListSupportedSkus). **Deprecated**. Please use `current_commitment` instead.
        """
        return pulumi.get(self, "current_sku")
    ...
    @pulumi.getter(name="failedEsxiHostId")
    @_utilities.deprecated("""This 'failed_esxi_host_id' argument has been deprecated and will be computed only.""")
    def failed_esxi_host_id(self) -> pulumi.Output[builtins.str]:
        """
        (Optional) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the ESXi host that is failed. This is an optional parameter. If this parameter is specified, a new ESXi host will be created to replace the failed one, and the `failedEsxiHostId` field will be updated in the newly created Esxi host.
        """
        return pulumi.get(self, "failed_esxi_host_id")
    ...
    @property
    @pulumi.getter(name="gracePeriodEndDate")
    def grace_period_end_date(self) -> pulumi.Output[builtins.str]:
        """
        The date and time when the new esxi host should start billing cycle. [RFC3339](https://tools.ietf.org/html/rfc3339). Example: `2021-07-25T21:10:29.600Z`
        """
        return pulumi.get(self, "grace_period_end_date")
    ...
    @property
    @pulumi.getter(name="hostOcpuCount")
    def host_ocpu_count(self) -> pulumi.Output[builtins.float]:
        """
        The OCPU count of the ESXi host.
        """
        return pulumi.get(self, "host_ocpu_count")
    ...
    @property
    @pulumi.getter(name="hostShapeName")
    def host_shape_name(self) -> pulumi.Output[builtins.str]:
        """
        The compute shape name of the ESXi host. [ListSupportedHostShapes](https://docs.cloud.oracle.com/iaas/api/#/en/vmware/20230701/SupportedHostShapes/ListSupportedHostShapes).
        """
        return pulumi.get(self, "host_shape_name")
    ...
    @property
    @pulumi.getter(name="isBillingContinuationInProgress")
    def is_billing_continuation_in_progress(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether this host is in the progress of billing continuation.
        """
        return pulumi.get(self, "is_billing_continuation_in_progress")
    ...
    @property
    @pulumi.getter(name="isBillingSwappingInProgress")
    def is_billing_swapping_in_progress(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether this host is in the progress of swapping billing.
        """
        return pulumi.get(self, "is_billing_swapping_in_progress")
    ...
    @property
    @pulumi.getter(name="nextCommitment")
    def next_commitment(self) -> pulumi.Output[builtins.str]:
        """
        The billing option to switch to after the current billing cycle ends. If `nextCommitment` is null or empty, `currentCommitment` continues to the next billing cycle. [ListSupportedCommitments](https://docs.cloud.oracle.com/iaas/api/#/en/vmware/20230701/SupportedCommitmentSummary/ListSupportedCommitments).
        """
        return pulumi.get(self, "next_commitment")
    ...
    @pulumi.getter(name="nextSku")
    @_utilities.deprecated("""The 'next_sku' field has been deprecated. It is no longer supported.""")
    def next_sku(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "next_sku")

    @property
    @pulumi.getter(name="nonUpgradedEsxiHostId")
    @_utilities.deprecated("""This 'non_upgraded_esxi_host_id' argument has been deprecated and will be computed only.""")
    def non_upgraded_esxi_host_id(self) -> pulumi.Output[builtins.str]:
        """
        (Optional) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the ESXi host that will be upgraded. This is an optional parameter. If this parameter is specified, an ESXi host with the new software version is created to replace the original one, and the `nonUpgradedEsxiHostId` field is updated in the newly created Esxi host. See [Upgrading VMware Software](https://docs.cloud.oracle.com/iaas/Content/VMware/Concepts/upgrade.htm) for more information.
        """
        return pulumi.get(self, "non_upgraded_esxi_host_id")
    ...
    @property
    @pulumi.getter(name="replacementEsxiHostId")
    def replacement_esxi_host_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the esxi host that is newly created to replace the failed node.
        """
        return pulumi.get(self, "replacement_esxi_host_id")
    ...
    @pulumi.getter(name="sddcId")
    @_utilities.deprecated("""The 'sddc_id' field has been deprecated. Please use 'cluster_id' instead.""")
    def sddc_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (Optional) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the SDDC to add the ESXi host to. This field has been deprecated. Please use `cluster_id` instead. Either `sddc_id` or `cluster_id` must be configured for `Ocvp.EsxiHost` resource.  **Deprecated**. Please use `cluster_id` instead.
    ...
    @property
    @pulumi.getter(name="swapBillingHostId")
    def swap_billing_host_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the active ESXi Host to swap billing with current host.
        """
        return pulumi.get(self, "swap_billing_host_id")
    ...
    @property
    @pulumi.getter(name="upgradedReplacementEsxiHostId")
    def upgraded_replacement_esxi_host_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the ESXi host that is newly created to upgrade the original host.
        """
        return pulumi.get(self, "upgraded_replacement_esxi_host_id")
