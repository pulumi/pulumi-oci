...
class GetDatastoreResult:
    ...
    """
    def __init__(__self__, availability_domain=None, block_volume_details=None, block_volume_ids=None, capacity_in_gbs=None, cluster_id=None, compartment_id=None, datastore_id=None, defined_tags=None, display_name=None, freeform_tags=None, id=None, sddc_id=None, state=None, system_tags=None, time_created=None, time_updated=None):
        if availability_domain and not isinstance(availability_domain, str):
            raise TypeError("Expected argument 'availability_domain' to be a str")
        pulumi.set(__self__, "availability_domain", availability_domain)
        if block_volume_details and not isinstance(block_volume_details, list):
            raise TypeError("Expected argument 'block_volume_details' to be a list")
        pulumi.set(__self__, "block_volume_details", block_volume_details)
        if block_volume_ids and not isinstance(block_volume_ids, list):
            raise TypeError("Expected argument 'block_volume_ids' to be a list")
    ...
    def block_volume_details(self) -> Sequence['outputs.GetDatastoreBlockVolumeDetailResult']:
        """
...
class AwaitableGetDatastoreResult(GetDatastoreResult):
    ...
    def __await__(self):
        ...
        return GetDatastoreResult(
            ...
            block_volume_details=self.block_volume_details,
            block_volume_ids=self.block_volume_ids,
...
def get_datastore(datastore_id: Optional[_builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('oci:Ocvp/getDatastore:getDatastore', __args__, opts=opts, typ=GetDatastoreResult).value

    return AwaitableGetDatastoreResult(
        availability_domain=pulumi.get(__ret__, 'availability_domain'),
        block_volume_details=pulumi.get(__ret__, 'block_volume_details'),
        block_volume_ids=pulumi.get(__ret__, 'block_volume_ids'),
...
def get_datastore_output(datastore_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Ocvp/getDatastore:getDatastore', __args__, opts=opts, typ=GetDatastoreResult)
    return __ret__.apply(lambda __response__: GetDatastoreResult(
        availability_domain=pulumi.get(__response__, 'availability_domain'),
        block_volume_details=pulumi.get(__response__, 'block_volume_details'),
        block_volume_ids=pulumi.get(__response__, 'block_volume_ids'),
