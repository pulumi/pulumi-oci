...
class GetExsiHostResult:
    ...
    def esxi_host_id(self) -> builtins.str:
...
def get_exsi_host(esxi_host_id: Optional[builtins.str] = None,
    ...
    :param builtins.str esxi_host_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the ESXi host.
    """
    __args__ = dict()
...
def get_exsi_host_output(esxi_host_id: Optional[pulumi.Input[builtins.str]] = None,
