...
class GetRetrievePasswordResult:
    ...
    def sddc_password(self) -> Mapping[str, builtins.str]:
        """
...
def get_retrieve_password(sddc_id: Optional[builtins.str] = None,
    ...
    :param builtins.str sddc_id: The [OCID](https://www.terraform.io/Content/General/Concepts/identifiers.htm) of the SDDC.
    :param builtins.str type: The SDDC password type.
    """
    __args__ = dict()
...
def get_retrieve_password_output(sddc_id: Optional[pulumi.Input[builtins.str]] = None,
