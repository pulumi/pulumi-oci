...
class GetRetrievePasswordResult:
    ...
    def sddc_password(self) -> Mapping[str, _builtins.str]:
        """
...
def get_retrieve_password(sddc_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str type: The SDDC password type.
    """
    __args__ = dict()
