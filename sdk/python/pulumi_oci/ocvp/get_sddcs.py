...
class GetSddcsResult:
    ...
    def compute_availability_domain(self) -> Optional[builtins.str]:
        """
...
def get_sddcs(compartment_id: Optional[builtins.str] = None,
              compute_availability_domain: Optional[builtins.str] = None,
...
def get_sddcs_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                     compute_availability_domain: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Ocvp/getSddcs:getSddcs', __args__, opts=opts, typ=GetSddcsResult)
    return __ret__.apply(lambda __response__: GetSddcsResult(
        compartment_id=pulumi.get(__response__, 'compartment_id'),
        compute_availability_domain=pulumi.get(__response__, 'compute_availability_domain'),
        display_name=pulumi.get(__response__, 'display_name'),
        filters=pulumi.get(__response__, 'filters'),
        id=pulumi.get(__response__, 'id'),
        sddc_collections=pulumi.get(__response__, 'sddc_collections'),
