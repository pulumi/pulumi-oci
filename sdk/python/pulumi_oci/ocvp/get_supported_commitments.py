...
def get_supported_commitments(compartment_id: Optional[builtins.str] = None,
...
def get_supported_commitments_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
