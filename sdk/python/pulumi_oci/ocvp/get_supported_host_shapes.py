...
class GetSupportedHostShapesResult:
    ...
    def is_single_host_sddc_supported(self) -> Optional[builtins.bool]:
        """
    ...
    def sddc_type(self) -> Optional[builtins.str]:
...
def get_supported_host_shapes(compartment_id: Optional[builtins.str] = None,
                              ...
                              is_single_host_sddc_supported: Optional[builtins.bool] = None,
                              name: Optional[builtins.str] = None,
                              sddc_type: Optional[builtins.str] = None,
    ...
    :param builtins.str initial_host_shape_name: A filter to return only the shapes compatible with the initial host shape of the Cluster.
    ...
    :param builtins.str sddc_type: (Optional) A filter to return only resources that match the given SDDC type exactly.
    """
    __args__ = dict()
...
def get_supported_host_shapes_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                     ...
                                     initial_host_shape_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     is_single_host_sddc_supported: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                     name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                     sddc_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
