...
class GetSupportedVmwareSoftwareVersionsResult:
    ...
    def version_to_upgrade(self) -> Optional[builtins.str]:
...
def get_supported_vmware_software_versions(compartment_id: Optional[builtins.str] = None,
                                           ...
                                           version_to_upgrade: Optional[builtins.str] = None,
    ...
    :param builtins.str version_to_upgrade: A filter to return only VMware software versions that the given VMware software version can be upgraded to.
    """
    __args__ = dict()
...
def get_supported_vmware_software_versions_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                                  ...
                                                  version_to_upgrade: Optional[pulumi.Input[Optional[builtins.str]]] = None,
