...
class GetSupportedVmwareSoftwareVersionsResult:
    ...
    def version_to_upgrade(self) -> Optional[_builtins.str]:
...
def get_supported_vmware_software_versions(compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str version_to_upgrade: A filter to return only VMware software versions that the given VMware software version can be upgraded to.
    """
    __args__ = dict()
