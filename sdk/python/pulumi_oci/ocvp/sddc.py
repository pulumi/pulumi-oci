...
class SddcArgs:
    def __init__(__self__, *,
                 ...
                 ssh_authorized_keys: pulumi.Input[builtins.str],
                 vmware_software_version: pulumi.Input[builtins.str],
                 ...
                 hcx_action: Optional[pulumi.Input[builtins.str]] = None,
                 hcx_vlan_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 initial_sku: Optional[pulumi.Input[builtins.str]] = None,
                 instance_display_name_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 is_hcx_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_shielded_instance_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_single_host_sddc: Optional[pulumi.Input[builtins.bool]] = None,
                 nsx_edge_uplink1vlan_id: Optional[pulumi.Input[builtins.str]] = None,
                 nsx_edge_uplink2vlan_id: Optional[pulumi.Input[builtins.str]] = None,
                 nsx_edge_vtep_vlan_id: Optional[pulumi.Input[builtins.str]] = None,
                 nsx_vtep_vlan_id: Optional[pulumi.Input[builtins.str]] = None,
                 provisioning_subnet_id: Optional[pulumi.Input[builtins.str]] = None,
                 provisioning_vlan_id: Optional[pulumi.Input[builtins.str]] = None,
                 refresh_hcx_license_status: Optional[pulumi.Input[builtins.bool]] = None,
                 replication_vlan_id: Optional[pulumi.Input[builtins.str]] = None,
                 reserving_hcx_on_premise_license_keys: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 vmotion_vlan_id: Optional[pulumi.Input[builtins.str]] = None,
                 vsan_vlan_id: Optional[pulumi.Input[builtins.str]] = None,
                 vsphere_vlan_id: Optional[pulumi.Input[builtins.str]] = None,
                 workload_network_cidr: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Sddc resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to contain the SDDC.
        :param pulumi.Input[builtins.str] ssh_authorized_keys: (Updatable) One or more public SSH keys to be included in the `~/.ssh/authorized_keys` file for the default user on each ESXi host. Use a newline character to separate multiple keys. The SSH keys must be in the format required for the `authorized_keys` file
        ...
        :param pulumi.Input[builtins.str] capacity_reservation_id: (Optional) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Capacity Reservation. **Deprecated**. Please use `capacity_reservation_id` of `initial_cluster_configurations` instead.
        :param pulumi.Input[builtins.str] compute_availability_domain: (Required) The availability domain to create the SDDC's ESXi hosts in. For multi-AD SDDC deployment, set to `multi-AD`. **Deprecated**. Please use `compute_availability_domain` of `initial_cluster_configurations` instead.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) A descriptive name for the SDDC. SDDC name requirements are 1-16 character length limit, Must start with a letter, Must be English letters, numbers, - only, No repeating hyphens, Must be unique within the region. Avoid entering confidential information.
        :param pulumi.Input[builtins.int] esxi_hosts_count: (Required) The number of ESXi hosts to create in the SDDC. You can add more hosts later (see [CreateEsxiHost](https://docs.cloud.oracle.com/iaas/api/#/en/vmware/20200501/EsxiHost/CreateEsxiHost)). Creating a SDDC with a ESXi host count of 1 will be considered a single ESXi host SDDC. **Deprecated**. Please use `esxi_hosts_count` of `initial_cluster_configurations` instead.
        ...
        :param pulumi.Input[builtins.float] initial_host_ocpu_count: (Optional) The initial OCPU count of the SDDC's ESXi hosts. **Deprecated**. Please use `initial_host_ocpu_count` of `initial_cluster_configurations` instead.
        :param pulumi.Input[builtins.str] initial_host_shape_name: (Optional) The initial compute shape of the SDDC's ESXi hosts. [ListSupportedHostShapes](https://docs.cloud.oracle.com/iaas/api/#/en/vmware/20200501/SupportedHostShapes/ListSupportedHostShapes). **Deprecated**. Please use `initial_host_shape_name` of `initial_cluster_configurations` instead.
        :param pulumi.Input[builtins.str] initial_sku: (Optional) The billing option selected during SDDC creation. [ListSupportedSkus](https://docs.cloud.oracle.com/iaas/api/#/en/vmware/20200501/SupportedSkuSummary/ListSupportedSkus). **Deprecated**. Please use  `initial_commitment` of `initial_cluster_configurations` instead.
        :param pulumi.Input[builtins.str] instance_display_name_prefix: (Optional) A prefix used in the name of each ESXi host and Compute instance in the SDDC. If this isn't set, the SDDC's `displayName` is used as the prefix. 
        ...
        :param pulumi.Input[builtins.bool] is_hcx_enabled: For SDDC with dense compute shapes, this parameter indicates whether to enable HCX Advanced for this SDDC. For SDDC with standard compute shapes, this parameter is equivalent to `isHcxEnterpriseEnabled`.
        :param pulumi.Input[builtins.bool] is_shielded_instance_enabled: (Optional) Indicates whether shielded instance is enabled for this SDDC. **Deprecated**. Please use `is_shielded_instance_enabled` of `initial_cluster_configurations` instead.
        :param pulumi.Input[builtins.bool] is_single_host_sddc: Indicates whether this SDDC is designated for only single ESXi host.
        :param pulumi.Input[builtins.str] nsx_edge_uplink1vlan_id: (Required) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the NSX Edge Uplink 1 component of the VMware environment. **Deprecated**. Please use `nsx_edge_uplink1vlan_id` of `network_configuration` instead.
        :param pulumi.Input[builtins.str] nsx_edge_uplink2vlan_id: (Required) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the NSX Edge Uplink 2 component of the VMware environment. **Deprecated**. Please use `nsx_edge_uplink2vlan_id` of `network_configuration` instead.
               
               **Note:** This VLAN is reserved for future use to deploy public-facing applications on the VMware SDDC.
        :param pulumi.Input[builtins.str] nsx_edge_vtep_vlan_id: (Required) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the NSX Edge VTEP component of the VMware environment. **Deprecated**. Please use `nsx_edge_vtep_vlan_id` of `network_configuration` instead.
        :param pulumi.Input[builtins.str] nsx_vtep_vlan_id: (Required) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the NSX VTEP component of the VMware environment. **Deprecated**. Please use `nsx_vtep_vlan_id` of `network_configuration` instead.
        :param pulumi.Input[builtins.str] provisioning_subnet_id: (Required) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management subnet to use for provisioning the SDDC. **Deprecated**. Please use `provisioning_subnet_id` of `network_configuration` instead.
        :param pulumi.Input[builtins.str] provisioning_vlan_id: (Optional) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN used by the SDDC for the Provisioning component of the VMware environment. **Deprecated**. Please use `provisioning_vlan_id` of `network_configuration` instead.
        :param pulumi.Input[builtins.bool] refresh_hcx_license_status: (Updatable) HCX on-premise licenses status will be refreshed whenever the value of this field is changed.
        :param pulumi.Input[builtins.str] replication_vlan_id: (Optional) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN used by the SDDC for the vSphere Replication component of the VMware environment. **Deprecated**. Please use `replication_vlan_id` of `network_configuration` instead.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] reserving_hcx_on_premise_license_keys: (Updatable) The HCX on-premise licenses to be reserved when downgrade from HCX Enterprise to HCX Advanced. It should not be provided during resource creation. It is required and can only be set when the hcx_action is "DOWNGRADE". Its value can only be changed when hcx_action is updated.
        :param pulumi.Input[builtins.str] vmotion_vlan_id: (Required) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the vMotion component of the VMware environment. **Deprecated**. Please use `vmotion_vlan_id` of `network_configuration` instead.
        :param pulumi.Input[builtins.str] vsan_vlan_id: (Required) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the vSAN component of the VMware environment. **Deprecated**. Please use `vsan_vlan_id` of `network_configuration` instead.
        :param pulumi.Input[builtins.str] vsphere_vlan_id: (Required) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the vSphere component of the VMware environment. **Deprecated**. Please use `vsphere_vlan_id` of `network_configuration` instead.
        :param pulumi.Input[builtins.str] workload_network_cidr: (Optional) The CIDR block for the IP addresses that VMware VMs in the SDDC use to run application workloads.  **Deprecated**. Please use `workload_network_cidr` of `initial_cluster_configurations` instead.
    ...
    def ssh_authorized_keys(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def ssh_authorized_keys(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "ssh_authorized_keys", value)

    @property
    @pulumi.getter(name="vmwareSoftwareVersion")
    def vmware_software_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def vmware_software_version(self, value: pulumi.Input[builtins.str]):
    ...
    def hcx_action(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "hcx_action")

    @hcx_action.setter
    def hcx_action(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def hcx_vlan_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @hcx_vlan_id.setter
    def hcx_vlan_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def initial_sku(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @initial_sku.setter
    def initial_sku(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_hcx_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_hcx_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def is_single_host_sddc(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_single_host_sddc(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def nsx_edge_uplink1vlan_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nsx_edge_uplink1vlan_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def nsx_edge_uplink2vlan_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nsx_edge_uplink2vlan_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def nsx_edge_vtep_vlan_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nsx_edge_vtep_vlan_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def nsx_vtep_vlan_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nsx_vtep_vlan_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def provisioning_subnet_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provisioning_subnet_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def provisioning_vlan_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def provisioning_vlan_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "provisioning_vlan_id", value)

    @property
    @pulumi.getter(name="refreshHcxLicenseStatus")
    def refresh_hcx_license_status(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def refresh_hcx_license_status(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def replication_vlan_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def replication_vlan_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "replication_vlan_id", value)

    @property
    @pulumi.getter(name="reservingHcxOnPremiseLicenseKeys")
    def reserving_hcx_on_premise_license_keys(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def reserving_hcx_on_premise_license_keys(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def vmotion_vlan_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vmotion_vlan_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def vsan_vlan_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @vsan_vlan_id.setter
    def vsan_vlan_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def vsphere_vlan_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vsphere_vlan_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _SddcState:
    def __init__(__self__, *,
                 ...
                 capacity_reservation_id: Optional[pulumi.Input[builtins.str]] = None,
                 clusters_count: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 hcx_action: Optional[pulumi.Input[builtins.str]] = None,
                 hcx_fqdn: Optional[pulumi.Input[builtins.str]] = None,
                 hcx_initial_password: Optional[pulumi.Input[builtins.str]] = None,
                 hcx_mode: Optional[pulumi.Input[builtins.str]] = None,
                 hcx_on_prem_key: Optional[pulumi.Input[builtins.str]] = None,
                 hcx_on_prem_licenses: Optional[pulumi.Input[Sequence[pulumi.Input['SddcHcxOnPremLicenseArgs']]]] = None,
                 hcx_private_ip_id: Optional[pulumi.Input[builtins.str]] = None,
                 hcx_vlan_id: Optional[pulumi.Input[builtins.str]] = None,
                 initial_configurations: Optional[pulumi.Input[Sequence[pulumi.Input['SddcInitialConfigurationArgs']]]] = None,
                 initial_host_ocpu_count: Optional[pulumi.Input[builtins.float]] = None,
                 initial_host_shape_name: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 instance_display_name_prefix: Optional[pulumi.Input[builtins.str]] = None,
                 is_hcx_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_hcx_enterprise_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_hcx_pending_downgrade: Optional[pulumi.Input[builtins.bool]] = None,
                 is_shielded_instance_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_single_host_sddc: Optional[pulumi.Input[builtins.bool]] = None,
                 nsx_edge_uplink1vlan_id: Optional[pulumi.Input[builtins.str]] = None,
                 nsx_edge_uplink2vlan_id: Optional[pulumi.Input[builtins.str]] = None,
                 nsx_edge_uplink_ip_id: Optional[pulumi.Input[builtins.str]] = None,
                 nsx_edge_vtep_vlan_id: Optional[pulumi.Input[builtins.str]] = None,
                 nsx_manager_fqdn: Optional[pulumi.Input[builtins.str]] = None,
                 nsx_manager_initial_password: Optional[pulumi.Input[builtins.str]] = None,
                 nsx_manager_private_ip_id: Optional[pulumi.Input[builtins.str]] = None,
                 nsx_manager_username: Optional[pulumi.Input[builtins.str]] = None,
                 nsx_overlay_segment_name: Optional[pulumi.Input[builtins.str]] = None,
                 nsx_vtep_vlan_id: Optional[pulumi.Input[builtins.str]] = None,
                 provisioning_subnet_id: Optional[pulumi.Input[builtins.str]] = None,
                 provisioning_vlan_id: Optional[pulumi.Input[builtins.str]] = None,
                 refresh_hcx_license_status: Optional[pulumi.Input[builtins.bool]] = None,
                 replication_vlan_id: Optional[pulumi.Input[builtins.str]] = None,
                 reserving_hcx_on_premise_license_keys: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 ssh_authorized_keys: Optional[pulumi.Input[builtins.str]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 time_created: Optional[pulumi.Input[builtins.str]] = None,
                 time_hcx_billing_cycle_end: Optional[pulumi.Input[builtins.str]] = None,
                 time_hcx_license_status_updated: Optional[pulumi.Input[builtins.str]] = None,
                 time_updated: Optional[pulumi.Input[builtins.str]] = None,
                 upgrade_licenses: Optional[pulumi.Input[Sequence[pulumi.Input['SddcUpgradeLicenseArgs']]]] = None,
                 vcenter_fqdn: Optional[pulumi.Input[builtins.str]] = None,
                 vcenter_initial_password: Optional[pulumi.Input[builtins.str]] = None,
                 vcenter_private_ip_id: Optional[pulumi.Input[builtins.str]] = None,
                 vcenter_username: Optional[pulumi.Input[builtins.str]] = None,
                 vmotion_vlan_id: Optional[pulumi.Input[builtins.str]] = None,
                 vmware_software_version: Optional[pulumi.Input[builtins.str]] = None,
                 vsan_vlan_id: Optional[pulumi.Input[builtins.str]] = None,
                 vsphere_upgrade_guide: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.int] actual_esxi_hosts_count: The number of actual ESXi hosts in the SDDC on the cloud. This attribute will be different when esxi Host is added to an existing SDDC. **Deprecated**.
        :param pulumi.Input[builtins.str] capacity_reservation_id: (Optional) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Capacity Reservation. **Deprecated**. Please use `capacity_reservation_id` of `initial_cluster_configurations` instead.
        :param pulumi.Input[builtins.int] clusters_count: The number of Clusters in the SDDC.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment to contain the SDDC.
        :param pulumi.Input[builtins.str] compute_availability_domain: (Required) The availability domain to create the SDDC's ESXi hosts in. For multi-AD SDDC deployment, set to `multi-AD`. **Deprecated**. Please use `compute_availability_domain` of `initial_cluster_configurations` instead.
        :param pulumi.Input[Sequence[pulumi.Input['SddcDatastoreArgs']]] datastores: (Optional) A list of datastore info for the SDDC. This value is required only when `initialHostShapeName` is a standard shape. **Deprecated**. Please use `datastores` of `initial_cluster_configurations` instead.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        ...
        :param pulumi.Input[builtins.str] esxi_software_version: (Updatable) The ESXi software bundle to install on the ESXi hosts in the SDDC.  Only versions under the same vmwareSoftwareVersion and have been validate by Oracle Cloud VMware Solution will be accepted. To get a list of the available versions, use [ListSupportedVmwareSoftwareVersions](https://docs.cloud.oracle.com/iaas/api/#/en/vmware/20230701/SupportedVmwareSoftwareVersionSummary/ListSupportedVmwareSoftwareVersions).
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] hcx_fqdn: The FQDN for HCX Manager.  Example: `hcx-my-sddc.sddc.us-phoenix-1.oraclecloud.com`
        :param pulumi.Input[builtins.str] hcx_initial_password: (**Deprecated**) The SDDC includes an administrator username and initial password for HCX Manager. Make sure to change this initial HCX Manager password to a different value. **Deprecated**. Please use the `ocvp_get_retrieve_password` data source instead.
        :param pulumi.Input[builtins.str] hcx_mode: HCX configuration of the SDDC.
        :param pulumi.Input[builtins.str] hcx_on_prem_key: (**Deprecated**) The activation keys to use on the on-premises HCX Enterprise appliances you site pair with HCX Manager in your VMware Solution. The number of keys provided depends on the HCX license type. HCX Advanced provides 3 activation keys. HCX Enterprise provides 10 activation keys. **Deprecated**. Please use `hcx_on_prem_licenses` instead.
        ...
        :param pulumi.Input[builtins.str] hcx_private_ip_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `PrivateIp` object that is the virtual IP (VIP) for HCX Manager. For information about `PrivateIp` objects, see the Core Services API.
        :param pulumi.Input[builtins.str] hcx_vlan_id: (Optional) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the HCX component of the VMware environment. This value is required only when `isHcxEnabled` is true. **Deprecated**. Please use `hcx_vlan_id` of `network_configuration` instead.
        :param pulumi.Input[Sequence[pulumi.Input['SddcInitialConfigurationArgs']]] initial_configurations: Details of SDDC initial configuration
        :param pulumi.Input[builtins.float] initial_host_ocpu_count: (Optional) The initial OCPU count of the SDDC's ESXi hosts. **Deprecated**. Please use `initial_host_ocpu_count` of `initial_cluster_configurations` instead.
        :param pulumi.Input[builtins.str] initial_host_shape_name: (Optional) The initial compute shape of the SDDC's ESXi hosts. [ListSupportedHostShapes](https://docs.cloud.oracle.com/iaas/api/#/en/vmware/20200501/SupportedHostShapes/ListSupportedHostShapes). **Deprecated**. Please use `initial_host_shape_name` of `initial_cluster_configurations` instead.
        ...
        :param pulumi.Input[builtins.str] instance_display_name_prefix: (Optional) A prefix used in the name of each ESXi host and Compute instance in the SDDC. If this isn't set, the SDDC's `displayName` is used as the prefix. 
               ...
               For example, if the value is `mySDDC`, the ESXi hosts are named `mySDDC-1`, `mySDDC-2`, and so on. **Deprecated**. Please use  `instance_display_name_prefix` of `initial_cluster_configurations` instead.
        :param pulumi.Input[builtins.bool] is_hcx_enabled: For SDDC with dense compute shapes, this parameter indicates whether to enable HCX Advanced for this SDDC. For SDDC with standard compute shapes, this parameter is equivalent to `isHcxEnterpriseEnabled`.
        :param pulumi.Input[builtins.bool] is_hcx_enterprise_enabled: (**Deprecated**) Indicates whether HCX Enterprise is enabled for this SDDC.
        :param pulumi.Input[builtins.bool] is_hcx_pending_downgrade: Indicates whether SDDC is pending downgrade from HCX Enterprise to HCX Advanced.
        :param pulumi.Input[builtins.bool] is_shielded_instance_enabled: (Optional) Indicates whether shielded instance is enabled for this SDDC. **Deprecated**. Please use `is_shielded_instance_enabled` of `initial_cluster_configurations` instead.
        :param pulumi.Input[builtins.bool] is_single_host_sddc: Indicates whether this SDDC is designated for only single ESXi host.
        :param pulumi.Input[builtins.str] nsx_edge_uplink1vlan_id: (Required) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the NSX Edge Uplink 1 component of the VMware environment. **Deprecated**. Please use `nsx_edge_uplink1vlan_id` of `network_configuration` instead.
        :param pulumi.Input[builtins.str] nsx_edge_uplink2vlan_id: (Required) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the NSX Edge Uplink 2 component of the VMware environment. **Deprecated**. Please use `nsx_edge_uplink2vlan_id` of `network_configuration` instead.
               ...
               **Note:** This VLAN is reserved for future use to deploy public-facing applications on the VMware SDDC.
        :param pulumi.Input[builtins.str] nsx_edge_uplink_ip_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `PrivateIp` object that is the virtual IP (VIP) for the NSX Edge Uplink. Use this OCID as the route target for route table rules when setting up connectivity between the SDDC and other networks. For information about `PrivateIp` objects, see the Core Services API.
        :param pulumi.Input[builtins.str] nsx_edge_vtep_vlan_id: (Required) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the NSX Edge VTEP component of the VMware environment. **Deprecated**. Please use `nsx_edge_vtep_vlan_id` of `network_configuration` instead.
        :param pulumi.Input[builtins.str] nsx_manager_fqdn: The FQDN for NSX Manager.  Example: `nsx-my-sddc.sddc.us-phoenix-1.oraclecloud.com`
        :param pulumi.Input[builtins.str] nsx_manager_initial_password: (**Deprecated**) The SDDC includes an administrator username and initial password for NSX Manager. Make sure to change this initial NSX Manager password to a different value. **Deprecated**. Please use the `ocvp_get_retrieve_password` data source instead.
        :param pulumi.Input[builtins.str] nsx_manager_private_ip_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `PrivateIp` object that is the virtual IP (VIP) for NSX Manager. For information about `PrivateIp` objects, see the Core Services API.
        :param pulumi.Input[builtins.str] nsx_manager_username: The SDDC includes an administrator username and initial password for NSX Manager. You can change this initial username to a different value in NSX Manager.
        :param pulumi.Input[builtins.str] nsx_overlay_segment_name: (**Deprecated**) The VMware NSX overlay workload segment to host your application. Connect to workload portgroup in vCenter to access this overlay segment.
        :param pulumi.Input[builtins.str] nsx_vtep_vlan_id: (Required) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the NSX VTEP component of the VMware environment. **Deprecated**. Please use `nsx_vtep_vlan_id` of `network_configuration` instead.
        :param pulumi.Input[builtins.str] provisioning_subnet_id: (Required) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management subnet to use for provisioning the SDDC. **Deprecated**. Please use `provisioning_subnet_id` of `network_configuration` instead.
        :param pulumi.Input[builtins.str] provisioning_vlan_id: (Optional) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN used by the SDDC for the Provisioning component of the VMware environment. **Deprecated**. Please use `provisioning_vlan_id` of `network_configuration` instead.
        :param pulumi.Input[builtins.bool] refresh_hcx_license_status: (Updatable) HCX on-premise licenses status will be refreshed whenever the value of this field is changed.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] reserving_hcx_on_premise_license_keys: (Updatable) The HCX on-premise licenses to be reserved when downgrade from HCX Enterprise to HCX Advanced. It should not be provided during resource creation. It is required and can only be set when the hcx_action is "DOWNGRADE". Its value can only be changed when hcx_action is updated.
        :param pulumi.Input[builtins.str] ssh_authorized_keys: (Updatable) One or more public SSH keys to be included in the `~/.ssh/authorized_keys` file for the default user on each ESXi host. Use a newline character to separate multiple keys. The SSH keys must be in the format required for the `authorized_keys` file
        :param pulumi.Input[builtins.str] state: The current state of the SDDC.
        :param pulumi.Input[builtins.str] time_created: The date and time the SDDC was created, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_hcx_billing_cycle_end: The date and time current HCX Enterprise billing cycle ends, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_hcx_license_status_updated: The date and time the SDDC's HCX on-premise license status was updated, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_updated: The date and time the SDDC was updated, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
        ...
        :param pulumi.Input[builtins.str] vcenter_fqdn: The FQDN for vCenter.  Example: `vcenter-my-sddc.sddc.us-phoenix-1.oraclecloud.com`
        :param pulumi.Input[builtins.str] vcenter_initial_password: (**Deprecated**) The SDDC includes an administrator username and initial password for vCenter. Make sure to change this initial vCenter password to a different value. **Deprecated**. Please use the `ocvp_get_retrieve_password` data source instead.
        :param pulumi.Input[builtins.str] vcenter_private_ip_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `PrivateIp` object that is the virtual IP (VIP) for vCenter. For information about `PrivateIp` objects, see the Core Services API.
        :param pulumi.Input[builtins.str] vcenter_username: The SDDC includes an administrator username and initial password for vCenter. You can change this initial username to a different value in vCenter.
        :param pulumi.Input[builtins.str] vmotion_vlan_id: (Required) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the vMotion component of the VMware environment. **Deprecated**. Please use `vmotion_vlan_id` of `network_configuration` instead.
        :param pulumi.Input[builtins.str] vmware_software_version: (Updatable) The VMware software bundle to install on the ESXi hosts in the SDDC. To get a list of the available versions, use [ListSupportedVmwareSoftwareVersions](https://docs.cloud.oracle.com/iaas/api/#/en/vmware/20200501/SupportedVmwareSoftwareVersionSummary/ListSupportedVmwareSoftwareVersions).
        :param pulumi.Input[builtins.str] vsan_vlan_id: (Required) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the vSAN component of the VMware environment. **Deprecated**. Please use `vsan_vlan_id` of `network_configuration` instead.
        :param pulumi.Input[builtins.str] vsphere_upgrade_guide: (**Deprecated**) The link to guidance for upgrading vSphere.
    ...
    def clusters_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def clusters_count(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def hcx_fqdn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @hcx_fqdn.setter
    def hcx_fqdn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def hcx_initial_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def hcx_initial_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "hcx_initial_password", value)

    @property
    @pulumi.getter(name="hcxMode")
    def hcx_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @hcx_mode.setter
    def hcx_mode(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def hcx_on_prem_key(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def hcx_on_prem_key(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def hcx_private_ip_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def hcx_private_ip_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_hcx_enterprise_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_hcx_enterprise_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_hcx_enterprise_enabled", value)

    @property
    @pulumi.getter(name="isHcxPendingDowngrade")
    def is_hcx_pending_downgrade(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_hcx_pending_downgrade(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def nsx_edge_uplink_ip_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `PrivateIp` object that is the virtual IP (VIP) for the NSX Edge Uplink. Use this OCID as the route target for route table rules when setting up connectivity between the SDDC and other networks. For information about `PrivateIp` objects, see the Core Services API.
        """
    ...
    def nsx_edge_uplink_ip_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def nsx_manager_fqdn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nsx_manager_fqdn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def nsx_manager_initial_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nsx_manager_initial_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "nsx_manager_initial_password", value)

    @property
    @pulumi.getter(name="nsxManagerPrivateIpId")
    def nsx_manager_private_ip_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nsx_manager_private_ip_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "nsx_manager_private_ip_id", value)

    @property
    @pulumi.getter(name="nsxManagerUsername")
    def nsx_manager_username(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nsx_manager_username(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def nsx_overlay_segment_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def nsx_overlay_segment_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    @property
    @pulumi.getter(name="sshAuthorizedKeys")
    def ssh_authorized_keys(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) One or more public SSH keys to be included in the `~/.ssh/authorized_keys` file for the default user on each ESXi host. Use a newline character to separate multiple keys. The SSH keys must be in the format required for the `authorized_keys` file
        """
        return pulumi.get(self, "ssh_authorized_keys")
    ...
    @ssh_authorized_keys.setter
    def ssh_authorized_keys(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ssh_authorized_keys", value)
    ...
    def time_hcx_billing_cycle_end(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_hcx_billing_cycle_end(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_hcx_billing_cycle_end", value)

    @property
    @pulumi.getter(name="timeHcxLicenseStatusUpdated")
    def time_hcx_license_status_updated(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_hcx_license_status_updated(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def vcenter_fqdn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @vcenter_fqdn.setter
    def vcenter_fqdn(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def vcenter_initial_password(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vcenter_initial_password(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vcenter_initial_password", value)

    @property
    @pulumi.getter(name="vcenterPrivateIpId")
    def vcenter_private_ip_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vcenter_private_ip_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "vcenter_private_ip_id", value)

    @property
    @pulumi.getter(name="vcenterUsername")
    def vcenter_username(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vcenter_username(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def vsphere_upgrade_guide(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vsphere_upgrade_guide(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Sddc(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            vsphere_vlan_id: Optional[pulumi.Input[builtins.str]] = None,
            workload_network_cidr: Optional[pulumi.Input[builtins.str]] = None) -> 'Sddc':
        """
    ...
    @property
    @pulumi.getter(name="clustersCount")
    def clusters_count(self) -> pulumi.Output[builtins.int]:
        """
        The number of Clusters in the SDDC.
        """
        return pulumi.get(self, "clusters_count")
    ...
    @pulumi.getter(name="computeAvailabilityDomain")
    @_utilities.deprecated("""The 'compute_availability_domain' field has been deprecated. Please use 'initial_configuration' instead.""")
    def compute_availability_domain(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (Required) The availability domain to create the SDDC's ESXi hosts in. For multi-AD SDDC deployment, set to `multi-AD`. **Deprecated**. Please use `compute_availability_domain` of `initial_cluster_configurations` instead.
        """
        return pulumi.get(self, "compute_availability_domain")
    ...
    @pulumi.getter(name="esxiHostsCount")
    @_utilities.deprecated("""The 'esxi_hosts_count' field has been deprecated. Please use 'initial_configuration' instead.""")
    def esxi_hosts_count(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        (Required) The number of ESXi hosts to create in the SDDC. You can add more hosts later (see [CreateEsxiHost](https://docs.cloud.oracle.com/iaas/api/#/en/vmware/20200501/EsxiHost/CreateEsxiHost)). Creating a SDDC with a ESXi host count of 1 will be considered a single ESXi host SDDC. **Deprecated**. Please use `esxi_hosts_count` of `initial_cluster_configurations` instead.
    ...
    @property
    @pulumi.getter(name="hcxAction")
    def hcx_action(self) -> pulumi.Output[Optional[builtins.str]]:
        return pulumi.get(self, "hcx_action")

    @property
    @pulumi.getter(name="hcxFqdn")
    def hcx_fqdn(self) -> pulumi.Output[builtins.str]:
        """
        The FQDN for HCX Manager.  Example: `hcx-my-sddc.sddc.us-phoenix-1.oraclecloud.com`
        """
        return pulumi.get(self, "hcx_fqdn")
    ...
    @pulumi.getter(name="hcxInitialPassword")
    @_utilities.deprecated("""The 'hcx_initial_password' field has been deprecated. Please use the 'oci_ocvp_retrieve_password' data source instead.""")
    def hcx_initial_password(self) -> pulumi.Output[builtins.str]:
        """
        (**Deprecated**) The SDDC includes an administrator username and initial password for HCX Manager. Make sure to change this initial HCX Manager password to a different value. **Deprecated**. Please use the `ocvp_get_retrieve_password` data source instead.
        """
        return pulumi.get(self, "hcx_initial_password")
    ...
    @property
    @pulumi.getter(name="hcxMode")
    def hcx_mode(self) -> pulumi.Output[builtins.str]:
        """
        HCX configuration of the SDDC.
        """
        return pulumi.get(self, "hcx_mode")
    ...
    @pulumi.getter(name="hcxOnPremKey")
    @_utilities.deprecated("""The 'hcx_on_prem_key' field has been deprecated and may be removed in a future version. Do not use this field.""")
    def hcx_on_prem_key(self) -> pulumi.Output[builtins.str]:
        """
        (**Deprecated**) The activation keys to use on the on-premises HCX Enterprise appliances you site pair with HCX Manager in your VMware Solution. The number of keys provided depends on the HCX license type. HCX Advanced provides 3 activation keys. HCX Enterprise provides 10 activation keys. **Deprecated**. Please use `hcx_on_prem_licenses` instead.
        """
        return pulumi.get(self, "hcx_on_prem_key")
    ...
    @property
    @pulumi.getter(name="hcxPrivateIpId")
    def hcx_private_ip_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `PrivateIp` object that is the virtual IP (VIP) for HCX Manager. For information about `PrivateIp` objects, see the Core Services API.
        """
        return pulumi.get(self, "hcx_private_ip_id")
    ...
    @pulumi.getter(name="hcxVlanId")
    @_utilities.deprecated("""The 'hcx_vlan_id' field has been deprecated. Please use 'initial_configuration' instead.""")
    def hcx_vlan_id(self) -> pulumi.Output[builtins.str]:
        """
        (Optional) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the HCX component of the VMware environment. This value is required only when `isHcxEnabled` is true. **Deprecated**. Please use `hcx_vlan_id` of `network_configuration` instead.
        """
        return pulumi.get(self, "hcx_vlan_id")
    ...
    @pulumi.getter(name="initialSku")
    @_utilities.deprecated("""The 'initial_sku' field has been deprecated. Please use 'initial_configuration' instead.""")
    def initial_sku(self) -> pulumi.Output[builtins.str]:
        """
        (Optional) The billing option selected during SDDC creation. [ListSupportedSkus](https://docs.cloud.oracle.com/iaas/api/#/en/vmware/20200501/SupportedSkuSummary/ListSupportedSkus). **Deprecated**. Please use  `initial_commitment` of `initial_cluster_configurations` instead.
        """
        return pulumi.get(self, "initial_sku")
    ...
    @property
    @pulumi.getter(name="isHcxEnabled")
    def is_hcx_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        For SDDC with dense compute shapes, this parameter indicates whether to enable HCX Advanced for this SDDC. For SDDC with standard compute shapes, this parameter is equivalent to `isHcxEnterpriseEnabled`.
        """
        return pulumi.get(self, "is_hcx_enabled")
    ...
    @pulumi.getter(name="isHcxEnterpriseEnabled")
    @_utilities.deprecated("""The 'is_hcx_enterprise_enabled' field has been deprecated and may be removed in a future version. Do not use this field.""")
    def is_hcx_enterprise_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (**Deprecated**) Indicates whether HCX Enterprise is enabled for this SDDC.
        """
        return pulumi.get(self, "is_hcx_enterprise_enabled")
    ...
    @property
    @pulumi.getter(name="isHcxPendingDowngrade")
    def is_hcx_pending_downgrade(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether SDDC is pending downgrade from HCX Enterprise to HCX Advanced.
        """
        return pulumi.get(self, "is_hcx_pending_downgrade")
    ...
    @property
    @pulumi.getter(name="isSingleHostSddc")
    def is_single_host_sddc(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether this SDDC is designated for only single ESXi host.
        """
        return pulumi.get(self, "is_single_host_sddc")
    ...
    @pulumi.getter(name="nsxEdgeUplink1vlanId")
    @_utilities.deprecated("""The 'nsx_edge_uplink1vlan_id' field has been deprecated. Please use 'initial_configuration' instead.""")
    def nsx_edge_uplink1vlan_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (Required) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the NSX Edge Uplink 1 component of the VMware environment. **Deprecated**. Please use `nsx_edge_uplink1vlan_id` of `network_configuration` instead.
        """
        return pulumi.get(self, "nsx_edge_uplink1vlan_id")
    ...
    @pulumi.getter(name="nsxEdgeUplink2vlanId")
    @_utilities.deprecated("""The 'nsx_edge_uplink2vlan_id' field has been deprecated. Please use 'initial_configuration' instead.""")
    def nsx_edge_uplink2vlan_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (Required) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the NSX Edge Uplink 2 component of the VMware environment. **Deprecated**. Please use `nsx_edge_uplink2vlan_id` of `network_configuration` instead.
    ...
    @property
    @pulumi.getter(name="nsxEdgeUplinkIpId")
    def nsx_edge_uplink_ip_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `PrivateIp` object that is the virtual IP (VIP) for the NSX Edge Uplink. Use this OCID as the route target for route table rules when setting up connectivity between the SDDC and other networks. For information about `PrivateIp` objects, see the Core Services API.
        """
        return pulumi.get(self, "nsx_edge_uplink_ip_id")
    ...
    @pulumi.getter(name="nsxEdgeVtepVlanId")
    @_utilities.deprecated("""The 'nsx_edge_vtep_vlan_id' field has been deprecated. Please use 'initial_configuration' instead.""")
    def nsx_edge_vtep_vlan_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (Required) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the NSX Edge VTEP component of the VMware environment. **Deprecated**. Please use `nsx_edge_vtep_vlan_id` of `network_configuration` instead.
        """
        return pulumi.get(self, "nsx_edge_vtep_vlan_id")
    ...
    @property
    @pulumi.getter(name="nsxManagerFqdn")
    def nsx_manager_fqdn(self) -> pulumi.Output[builtins.str]:
        """
        The FQDN for NSX Manager.  Example: `nsx-my-sddc.sddc.us-phoenix-1.oraclecloud.com`
        """
        return pulumi.get(self, "nsx_manager_fqdn")
    ...
    @pulumi.getter(name="nsxManagerInitialPassword")
    @_utilities.deprecated("""The 'nsx_manager_initial_password' field has been deprecated. Please use the 'oci_ocvp_retrieve_password' data source instead.""")
    def nsx_manager_initial_password(self) -> pulumi.Output[builtins.str]:
        """
        (**Deprecated**) The SDDC includes an administrator username and initial password for NSX Manager. Make sure to change this initial NSX Manager password to a different value. **Deprecated**. Please use the `ocvp_get_retrieve_password` data source instead.
        """
        return pulumi.get(self, "nsx_manager_initial_password")
    ...
    @property
    @pulumi.getter(name="nsxManagerPrivateIpId")
    def nsx_manager_private_ip_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `PrivateIp` object that is the virtual IP (VIP) for NSX Manager. For information about `PrivateIp` objects, see the Core Services API.
        """
        return pulumi.get(self, "nsx_manager_private_ip_id")
    ...
    @property
    @pulumi.getter(name="nsxManagerUsername")
    def nsx_manager_username(self) -> pulumi.Output[builtins.str]:
        """
        The SDDC includes an administrator username and initial password for NSX Manager. You can change this initial username to a different value in NSX Manager.
        """
        return pulumi.get(self, "nsx_manager_username")
    ...
    @pulumi.getter(name="nsxOverlaySegmentName")
    @_utilities.deprecated("""The 'nsx_overlay_segment_name' field has been deprecated and may be removed in a future version. Do not use this field.""")
    def nsx_overlay_segment_name(self) -> pulumi.Output[builtins.str]:
        """
        (**Deprecated**) The VMware NSX overlay workload segment to host your application. Connect to workload portgroup in vCenter to access this overlay segment.
        """
        return pulumi.get(self, "nsx_overlay_segment_name")
    ...
    @pulumi.getter(name="nsxVtepVlanId")
    @_utilities.deprecated("""The 'nsx_vtep_vlan_id' field has been deprecated. Please use 'initial_configuration' instead.""")
    def nsx_vtep_vlan_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (Required) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the NSX VTEP component of the VMware environment. **Deprecated**. Please use `nsx_vtep_vlan_id` of `network_configuration` instead.
        """
        return pulumi.get(self, "nsx_vtep_vlan_id")
    ...
    @pulumi.getter(name="provisioningSubnetId")
    @_utilities.deprecated("""The 'provisioning_subnet_id' field has been deprecated. Please use 'initial_configuration' instead.""")
    def provisioning_subnet_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (Required) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management subnet to use for provisioning the SDDC. **Deprecated**. Please use `provisioning_subnet_id` of `network_configuration` instead.
        """
        return pulumi.get(self, "provisioning_subnet_id")
    ...
    @pulumi.getter(name="provisioningVlanId")
    @_utilities.deprecated("""The 'provisioning_vlan_id' field has been deprecated. Please use 'initial_configuration' instead.""")
    def provisioning_vlan_id(self) -> pulumi.Output[builtins.str]:
        """
        (Optional) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN used by the SDDC for the Provisioning component of the VMware environment. **Deprecated**. Please use `provisioning_vlan_id` of `network_configuration` instead.
        """
        return pulumi.get(self, "provisioning_vlan_id")
    ...
    @property
    @pulumi.getter(name="refreshHcxLicenseStatus")
    def refresh_hcx_license_status(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        (Updatable) HCX on-premise licenses status will be refreshed whenever the value of this field is changed.
        """
        return pulumi.get(self, "refresh_hcx_license_status")
    ...
    @pulumi.getter(name="replicationVlanId")
    @_utilities.deprecated("""The 'replication_vlan_id' field has been deprecated. Please use 'initial_configuration' instead.""")
    def replication_vlan_id(self) -> pulumi.Output[builtins.str]:
        """
        (Optional) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN used by the SDDC for the vSphere Replication component of the VMware environment. **Deprecated**. Please use `replication_vlan_id` of `network_configuration` instead.
        """
        return pulumi.get(self, "replication_vlan_id")
    ...
    @property
    @pulumi.getter(name="reservingHcxOnPremiseLicenseKeys")
    def reserving_hcx_on_premise_license_keys(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        (Updatable) The HCX on-premise licenses to be reserved when downgrade from HCX Enterprise to HCX Advanced. It should not be provided during resource creation. It is required and can only be set when the hcx_action is "DOWNGRADE". Its value can only be changed when hcx_action is updated.
        """
        return pulumi.get(self, "reserving_hcx_on_premise_license_keys")
    ...
    @property
    @pulumi.getter(name="sshAuthorizedKeys")
    def ssh_authorized_keys(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) One or more public SSH keys to be included in the `~/.ssh/authorized_keys` file for the default user on each ESXi host. Use a newline character to separate multiple keys. The SSH keys must be in the format required for the `authorized_keys` file
        """
        return pulumi.get(self, "ssh_authorized_keys")
    ...
    @property
    @pulumi.getter(name="timeHcxBillingCycleEnd")
    def time_hcx_billing_cycle_end(self) -> pulumi.Output[builtins.str]:
        """
        The date and time current HCX Enterprise billing cycle ends, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        """
        return pulumi.get(self, "time_hcx_billing_cycle_end")
    ...
    @property
    @pulumi.getter(name="timeHcxLicenseStatusUpdated")
    def time_hcx_license_status_updated(self) -> pulumi.Output[builtins.str]:
        """
        The date and time the SDDC's HCX on-premise license status was updated, in the format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        """
        return pulumi.get(self, "time_hcx_license_status_updated")
    ...
    @property
    @pulumi.getter(name="vcenterFqdn")
    def vcenter_fqdn(self) -> pulumi.Output[builtins.str]:
        """
        The FQDN for vCenter.  Example: `vcenter-my-sddc.sddc.us-phoenix-1.oraclecloud.com`
        """
        return pulumi.get(self, "vcenter_fqdn")
    ...
    @pulumi.getter(name="vcenterInitialPassword")
    @_utilities.deprecated("""The 'vcenter_initial_password' field has been deprecated. Please use the 'oci_ocvp_retrieve_password' data source instead.""")
    def vcenter_initial_password(self) -> pulumi.Output[builtins.str]:
        """
        (**Deprecated**) The SDDC includes an administrator username and initial password for vCenter. Make sure to change this initial vCenter password to a different value. **Deprecated**. Please use the `ocvp_get_retrieve_password` data source instead.
        """
        return pulumi.get(self, "vcenter_initial_password")
    ...
    @property
    @pulumi.getter(name="vcenterPrivateIpId")
    def vcenter_private_ip_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `PrivateIp` object that is the virtual IP (VIP) for vCenter. For information about `PrivateIp` objects, see the Core Services API.
        """
        return pulumi.get(self, "vcenter_private_ip_id")
    ...
    @property
    @pulumi.getter(name="vcenterUsername")
    def vcenter_username(self) -> pulumi.Output[builtins.str]:
        """
        The SDDC includes an administrator username and initial password for vCenter. You can change this initial username to a different value in vCenter.
        """
        return pulumi.get(self, "vcenter_username")
    ...
    @pulumi.getter(name="vmotionVlanId")
    @_utilities.deprecated("""The 'vmotion_vlan_id' field has been deprecated. Please use 'initial_configuration' instead.""")
    def vmotion_vlan_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (Required) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the vMotion component of the VMware environment. **Deprecated**. Please use `vmotion_vlan_id` of `network_configuration` instead.
        """
        return pulumi.get(self, "vmotion_vlan_id")
    ...
    @pulumi.getter(name="vsanVlanId")
    @_utilities.deprecated("""The 'vsan_vlan_id' field has been deprecated. Please use 'initial_configuration' instead.""")
    def vsan_vlan_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (Required) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the vSAN component of the VMware environment. **Deprecated**. Please use `vsan_vlan_id` of `network_configuration` instead.
        """
        return pulumi.get(self, "vsan_vlan_id")
    ...
    @pulumi.getter(name="vsphereUpgradeGuide")
    @_utilities.deprecated("""The 'vsphere_upgrade_guide' field has been deprecated and may be removed in a future version. Do not use this field.""")
    def vsphere_upgrade_guide(self) -> pulumi.Output[builtins.str]:
        """
        (**Deprecated**) The link to guidance for upgrading vSphere.
        """
        return pulumi.get(self, "vsphere_upgrade_guide")
    ...
    @pulumi.getter(name="vsphereVlanId")
    @_utilities.deprecated("""The 'vsphere_vlan_id' field has been deprecated. Please use 'initial_configuration' instead.""")
    def vsphere_vlan_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (Required) (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN to use for the vSphere component of the VMware environment. **Deprecated**. Please use `vsphere_vlan_id` of `network_configuration` instead.
        """
        return pulumi.get(self, "vsphere_vlan_id")
