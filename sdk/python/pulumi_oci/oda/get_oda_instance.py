...
def get_oda_instance(oda_instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str oda_instance_id: Unique Digital Assistant instance identifier.
    """
    __args__ = dict()
...
def get_oda_instance_output(oda_instance_id: Optional[pulumi.Input[builtins.str]] = None,
