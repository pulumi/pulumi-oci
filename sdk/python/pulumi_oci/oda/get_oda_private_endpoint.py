...
def get_oda_private_endpoint(oda_private_endpoint_id: Optional[builtins.str] = None,
...
def get_oda_private_endpoint_output(oda_private_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
