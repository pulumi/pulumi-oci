...
class GetOdaPrivateEndpointAttachmentResult:
    ...
    def oda_private_endpoint_attachment_id(self) -> builtins.str:
...
def get_oda_private_endpoint_attachment(oda_private_endpoint_attachment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str oda_private_endpoint_attachment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of ODA Private Endpoint Attachment.
    """
    __args__ = dict()
...
def get_oda_private_endpoint_attachment_output(oda_private_endpoint_attachment_id: Optional[pulumi.Input[builtins.str]] = None,
