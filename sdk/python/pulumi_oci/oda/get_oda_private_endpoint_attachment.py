...
class GetOdaPrivateEndpointAttachmentResult:
    ...
    def oda_private_endpoint_attachment_id(self) -> _builtins.str:
...
def get_oda_private_endpoint_attachment(oda_private_endpoint_attachment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str oda_private_endpoint_attachment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of ODA Private Endpoint Attachment.
    """
    __args__ = dict()
...
def get_oda_private_endpoint_attachment_output(oda_private_endpoint_attachment_id: Optional[pulumi.Input[_builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetOdaPrivateEndpointAttachmentResult(
        ...
        oda_private_endpoint_attachment_id=pulumi.get(__response__, 'oda_private_endpoint_attachment_id'),
