...
def get_oda_private_endpoint_scan_proxies(filters: Optional[Sequence[pulumi.InputType['GetOdaPrivateEndpointScanProxiesFilterArgs']]] = None,
    ...
    test_oda_private_endpoint_scan_proxies = oci.Oda.get_oda_private_endpoint_scan_proxies(oda_private_endpoint_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetOdaPrivateEndpointScanProxiesResult(
        ...
        oda_private_endpoint_scan_proxy_collections=__ret__.oda_private_endpoint_scan_proxy_collections,
        state=__ret__.state)
