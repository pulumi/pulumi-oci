...
class GetOdaPrivateEndpointScanProxyResult:
    ...
    def oda_private_endpoint_scan_proxy_id(self) -> builtins.str:
...
def get_oda_private_endpoint_scan_proxy(oda_private_endpoint_id: Optional[builtins.str] = None,
                                        oda_private_endpoint_scan_proxy_id: Optional[builtins.str] = None,
    ...
    :param builtins.str oda_private_endpoint_scan_proxy_id: Unique ODA Private Endpoint Scan Proxy identifier.
    """
    __args__ = dict()
...
def get_oda_private_endpoint_scan_proxy_output(oda_private_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
                                               oda_private_endpoint_scan_proxy_id: Optional[pulumi.Input[builtins.str]] = None,
