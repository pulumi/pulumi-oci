...
def get_oda_private_endpoints(compartment_id: Optional[builtins.str] = None,
...
def get_oda_private_endpoints_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Oda/getOdaPrivateEndpoints:getOdaPrivateEndpoints', __args__, opts=opts, typ=GetOdaPrivateEndpointsResult)
    return __ret__.apply(lambda __response__: GetOdaPrivateEndpointsResult(
        compartment_id=pulumi.get(__response__, 'compartment_id'),
        display_name=pulumi.get(__response__, 'display_name'),
        filters=pulumi.get(__response__, 'filters'),
        id=pulumi.get(__response__, 'id'),
        oda_private_endpoint_collections=pulumi.get(__response__, 'oda_private_endpoint_collections'),
