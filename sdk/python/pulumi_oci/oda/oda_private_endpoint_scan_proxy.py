...
class OdaPrivateEndpointScanProxyArgs:
    def __init__(__self__, *,
                 ...
                 scan_listener_type: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a OdaPrivateEndpointScanProxy resource.
        :param pulumi.Input[builtins.str] oda_private_endpoint_id: Unique ODA Private Endpoint identifier which is the [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param pulumi.Input[builtins.str] protocol: The protocol used for communication between client, scanProxy and RAC's scan listeners
        ...
        :param pulumi.Input[builtins.str] scan_listener_type: Type indicating whether Scan listener is specified by its FQDN or list of IPs 
    ...
    def scan_listener_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def scan_listener_type(self, value: pulumi.Input[builtins.str]):
...
class _OdaPrivateEndpointScanProxyState:
    def __init__(__self__, *,
                 ...
                 scan_listener_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] scan_listener_type: Type indicating whether Scan listener is specified by its FQDN or list of IPs 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The current state of the ODA Private Endpoint Scan Proxy.
    ...
    @property
    @pulumi.getter(name="scanListenerType")
    def scan_listener_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Type indicating whether Scan listener is specified by its FQDN or list of IPs 
    ...
    @scan_listener_type.setter
    def scan_listener_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "scan_listener_type", value)
...
class OdaPrivateEndpointScanProxy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            scan_listener_type: Optional[pulumi.Input[builtins.str]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'OdaPrivateEndpointScanProxy':
        """
    ...
    @property
    @pulumi.getter(name="scanListenerType")
    def scan_listener_type(self) -> pulumi.Output[builtins.str]:
        """
        Type indicating whether Scan listener is specified by its FQDN or list of IPs 
