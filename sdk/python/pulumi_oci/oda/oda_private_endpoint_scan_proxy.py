...
class OdaPrivateEndpointScanProxyArgs:
    ...
    def scan_listener_type(self, value: pulumi.Input[_builtins.str]):
...
class _OdaPrivateEndpointScanProxyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] scan_listener_type: Type indicating whether Scan listener is specified by its FQDN or list of IPs 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] state: The current state of the ODA Private Endpoint Scan Proxy.
