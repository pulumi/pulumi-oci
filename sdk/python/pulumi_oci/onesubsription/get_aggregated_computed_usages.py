...
class GetAggregatedComputedUsagesResult:
    ...
    @property
    @pulumi.getter
    def grouping(self) -> Optional[builtins.str]:
    ...
    def parent_product(self) -> Optional[builtins.str]:
        """
        Product description
        """
    ...
    def time_from(self) -> builtins.str:
        return pulumi.get(self, "time_from")

    @property
    @pulumi.getter(name="timeTo")
    def time_to(self) -> builtins.str:
...
def get_aggregated_computed_usages(compartment_id: Optional[builtins.str] = None,
                                   filters: Optional[Sequence[Union['GetAggregatedComputedUsagesFilterArgs', 'GetAggregatedComputedUsagesFilterArgsDict']]] = None,
                                   grouping: Optional[builtins.str] = None,
                                   parent_product: Optional[builtins.str] = None,
    ...
    :param builtins.str grouping: Grouping criteria to use for aggregate the computed Usage, either hourly (`HOURLY`), daily (`DAILY`), monthly(`MONTHLY`) or none (`NONE`) to not follow a grouping criteria by date.
    :param builtins.str parent_product: Product part number for subscribed service line, called parent product.
    ...
    :param builtins.str time_from: Initial date to filter Computed Usage data in SPM. In the case of non aggregated data the time period between of fromDate and toDate , expressed in RFC 3339 timestamp format.
    :param builtins.str time_to: Final date to filter Computed Usage data in SPM, expressed in RFC 3339 timestamp format.
    """
    __args__ = dict()
...
def get_aggregated_computed_usages_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                          ...
                                          grouping: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          parent_product: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          subscription_id: Optional[pulumi.Input[builtins.str]] = None,
                                          time_from: Optional[pulumi.Input[builtins.str]] = None,
                                          time_to: Optional[pulumi.Input[builtins.str]] = None,
