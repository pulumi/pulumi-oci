...
class GetInvoiceLineComputedUsagesResult:
    ...
    def invoice_line_id(self) -> builtins.str:
...
def get_invoice_line_computed_usages(compartment_id: Optional[builtins.str] = None,
                                     ...
                                     invoice_line_id: Optional[builtins.str] = None,
    ...
    :param builtins.str invoice_line_id: Invoice Line Identifier - Primary Key SPM
    """
    __args__ = dict()
...
def get_invoice_line_computed_usages_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                            ...
                                            invoice_line_id: Optional[pulumi.Input[builtins.str]] = None,
