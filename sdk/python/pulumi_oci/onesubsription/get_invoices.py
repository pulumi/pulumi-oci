...
def get_invoices(ar_customer_transaction_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str ar_customer_transaction_id: AR Unique identifier for an invoice .
    ...
    :param _builtins.str time_from: Initial date to filter Invoice data in SPM.
    :param _builtins.str time_to: Final date to filter Invoice data in SPM.
    """
    __args__ = dict()
...
def get_invoices_output(ar_customer_transaction_id: Optional[pulumi.Input[_builtins.str]] = None,
