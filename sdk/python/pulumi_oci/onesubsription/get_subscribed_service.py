...
def get_subscribed_service(fields: Optional[Sequence[str]] = None,
    ...
    return AwaitableGetSubscribedServiceResult(
        ...
        agreement_name=__ret__.agreement_name,
        ...
        bill_to_contacts=__ret__.bill_to_contacts,
        bill_to_customers=__ret__.bill_to_customers,
        billing_frequency=__ret__.billing_frequency,
        booking_opty_number=__ret__.booking_opty_number,
        buyer_email=__ret__.buyer_email,
        commitment_schedule_id=__ret__.commitment_schedule_id,
        commitment_services=__ret__.commitment_services,
        created_by=__ret__.created_by,
        credit_percentage=__ret__.credit_percentage,
        csi=__ret__.csi,
        customer_transaction_reference=__ret__.customer_transaction_reference,
        data_center=__ret__.data_center,
        data_center_region=__ret__.data_center_region,
        eligible_to_renew=__ret__.eligible_to_renew,
        end_user_addresses=__ret__.end_user_addresses,
        end_user_contacts=__ret__.end_user_contacts,
        end_user_customers=__ret__.end_user_customers,
        fields=__ret__.fields,
        fulfillment_set=__ret__.fulfillment_set,
        funded_allocation_value=__ret__.funded_allocation_value,
        id=__ret__.id,
        is_allowance=__ret__.is_allowance,
        is_cap_to_price_list=__ret__.is_cap_to_price_list,
        is_credit_enabled=__ret__.is_credit_enabled,
        is_having_usage=__ret__.is_having_usage,
        is_intent_to_pay=__ret__.is_intent_to_pay,
        is_payg=__ret__.is_payg,
        is_single_rate_card=__ret__.is_single_rate_card,
        is_variable_commitment=__ret__.is_variable_commitment,
        line_net_amount=__ret__.line_net_amount,
        major_set=__ret__.major_set,
        net_unit_price=__ret__.net_unit_price,
        operation_type=__ret__.operation_type,
        order_header_id=__ret__.order_header_id,
        order_line_id=__ret__.order_line_id,
        order_line_number=__ret__.order_line_number,
        order_number=__ret__.order_number,
        order_type=__ret__.order_type,
        original_promo_amount=__ret__.original_promo_amount,
        overage_bill_to=__ret__.overage_bill_to,
        overage_discount_percentage=__ret__.overage_discount_percentage,
        overage_policy=__ret__.overage_policy,
        partner_credit_amount=__ret__.partner_credit_amount,
        partner_transaction_type=__ret__.partner_transaction_type,
        payg_policy=__ret__.payg_policy,
        payment_method=__ret__.payment_method,
        payment_number=__ret__.payment_number,
        payment_terms=__ret__.payment_terms,
        price_period=__ret__.price_period,
        pricing_model=__ret__.pricing_model,
        products=__ret__.products,
        program_type=__ret__.program_type,
        promo_order_line_id=__ret__.promo_order_line_id,
        promo_type=__ret__.promo_type,
        promotion_pricing_type=__ret__.promotion_pricing_type,
        provisioning_source=__ret__.provisioning_source,
        quantity=__ret__.quantity,
        rate_card_discount_percentage=__ret__.rate_card_discount_percentage,
        rate_cards=__ret__.rate_cards,
        ratecard_type=__ret__.ratecard_type,
        renewal_opty_id=__ret__.renewal_opty_id,
        renewal_opty_number=__ret__.renewal_opty_number,
        renewal_opty_type=__ret__.renewal_opty_type,
        renewed_subscribed_service_id=__ret__.renewed_subscribed_service_id,
        reseller_addresses=__ret__.reseller_addresses,
        reseller_contacts=__ret__.reseller_contacts,
        reseller_customers=__ret__.reseller_customers,
        revenue_line_id=__ret__.revenue_line_id,
        revenue_line_number=__ret__.revenue_line_number,
        revised_arr_in_lc=__ret__.revised_arr_in_lc,
        revised_arr_in_sc=__ret__.revised_arr_in_sc,
        sales_account_party_id=__ret__.sales_account_party_id,
        sales_channel=__ret__.sales_channel,
        serial_number=__ret__.serial_number,
        service_to_addresses=__ret__.service_to_addresses,
        service_to_contacts=__ret__.service_to_contacts,
        service_to_customers=__ret__.service_to_customers,
        sold_to_contacts=__ret__.sold_to_contacts,
        sold_to_customers=__ret__.sold_to_customers,
        start_date_type=__ret__.start_date_type,
        status=__ret__.status,
        subscribed_service_id=__ret__.subscribed_service_id,
        subscription_id=__ret__.subscription_id,
        subscription_source=__ret__.subscription_source,
        system_arr_in_lc=__ret__.system_arr_in_lc,
        system_arr_in_sc=__ret__.system_arr_in_sc,
        system_atr_arr_in_lc=__ret__.system_atr_arr_in_lc,
        system_atr_arr_in_sc=__ret__.system_atr_arr_in_sc,
        term_value=__ret__.term_value,
        term_value_uom=__ret__.term_value_uom,
        time_agreement_end=__ret__.time_agreement_end,
        time_created=__ret__.time_created,
        time_customer_config=__ret__.time_customer_config,
        time_end=__ret__.time_end,
        time_majorset_end=__ret__.time_majorset_end,
        time_majorset_start=__ret__.time_majorset_start,
        time_payment_expiry=__ret__.time_payment_expiry,
        time_provisioned=__ret__.time_provisioned,
        time_service_configuration_email_sent=__ret__.time_service_configuration_email_sent,
        time_start=__ret__.time_start,
        time_updated=__ret__.time_updated,
        time_welcome_email_sent=__ret__.time_welcome_email_sent,
        total_value=__ret__.total_value,
        transaction_extension_id=__ret__.transaction_extension_id,
        type=__ret__.type,
