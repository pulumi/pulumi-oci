...
def get_notification_topic(topic_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str topic_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the topic to retrieve.
