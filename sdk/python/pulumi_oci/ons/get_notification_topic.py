...
def get_notification_topic(topic_id: Optional[builtins.str] = None,
    ...
    :param builtins.str topic_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the topic to retrieve.
...
def get_notification_topic_output(topic_id: Optional[pulumi.Input[builtins.str]] = None,
