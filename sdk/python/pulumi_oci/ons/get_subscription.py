...
class GetSubscriptionResult:
    ...
    def delivery_policy(self) -> _builtins.str:
        """
...
def get_subscription(subscription_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str subscription_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subscription to retrieve.
    """
    __args__ = dict()
