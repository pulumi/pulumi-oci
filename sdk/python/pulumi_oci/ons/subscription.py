...
class SubscriptionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] protocol: The protocol used for the subscription.
        ...
        :param pulumi.Input[builtins.str] topic_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the topic for the subscription. 
        ...
        :param pulumi.Input[builtins.str] delivery_policy: The delivery policy of the subscription. Stored as a JSON string.
...
class _SubscriptionState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment for the subscription.
        :param pulumi.Input[builtins.str] created_time: The time when this suscription was created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] delivery_policy: The delivery policy of the subscription. Stored as a JSON string.
        :param pulumi.Input[builtins.str] endpoint: A locator that corresponds to the subscription protocol. For example, an email address for a subscription that uses the `EMAIL` protocol, or a URL for a subscription that uses an HTTP-based protocol. HTTP-based protocols use URL endpoints that begin with "http:" or "https:". A URL cannot exceed 512 characters. Avoid entering confidential information.
        ...
        :param pulumi.Input[builtins.str] protocol: The protocol used for the subscription.
               ...
               * `SMS`
               ...
               For information about subscription protocols, see [To create a subscription](https://docs.cloud.oracle.com/iaas/Content/Notification/Tasks/managingtopicsandsubscriptions.htm#createSub).
        :param pulumi.Input[builtins.str] state: The lifecycle state of the subscription. The status of a new subscription is PENDING; when confirmed, the subscription status changes to ACTIVE.
        :param pulumi.Input[builtins.str] topic_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the topic for the subscription. 
...
class Subscription(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="deliveryPolicy")
    def delivery_policy(self) -> pulumi.Output[builtins.str]:
        """
        The delivery policy of the subscription. Stored as a JSON string.
        """
        return pulumi.get(self, "delivery_policy")
