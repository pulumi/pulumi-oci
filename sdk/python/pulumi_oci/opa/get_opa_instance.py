...
class GetOpaInstanceResult:
    ...
    def opa_instance_id(self) -> _builtins.str:
...
def get_opa_instance(opa_instance_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str opa_instance_id: unique OpaInstance identifier
    """
    __args__ = dict()
