...
def get_opa_instance(opa_instance_id: Optional[str] = None,
    ...
    return AwaitableGetOpaInstanceResult(
        ...
        identity_app_display_name=__ret__.identity_app_display_name,
        identity_app_guid=__ret__.identity_app_guid,
        identity_app_opc_service_instance_guid=__ret__.identity_app_opc_service_instance_guid,
        identity_domain_url=__ret__.identity_domain_url,
        instance_url=__ret__.instance_url,
        is_breakglass_enabled=__ret__.is_breakglass_enabled,
        metering_type=__ret__.metering_type,
        opa_instance_id=__ret__.opa_instance_id,
