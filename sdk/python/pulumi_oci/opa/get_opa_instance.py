...
class GetOpaInstanceResult:
    ...
    def opa_instance_id(self) -> builtins.str:
...
def get_opa_instance(opa_instance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str opa_instance_id: unique OpaInstance identifier
    """
    __args__ = dict()
...
def get_opa_instance_output(opa_instance_id: Optional[pulumi.Input[builtins.str]] = None,
