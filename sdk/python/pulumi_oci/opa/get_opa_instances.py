...
def get_opa_instances(compartment_id: Optional[builtins.str] = None,
...
def get_opa_instances_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetOpaInstancesResult(
        ...
        opa_instance_collections=pulumi.get(__response__, 'opa_instance_collections'),
