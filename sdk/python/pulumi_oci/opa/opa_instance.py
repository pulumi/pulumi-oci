...
class OpaInstanceArgs:
    def __init__(__self__, *,
                 ...
                 is_breakglass_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 metering_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) OpaInstance Identifier. User-friendly name for the instance. Avoid entering confidential information. You can change this value anytime.
        :param pulumi.Input[builtins.str] shape_name: Shape of the instance.
        :param pulumi.Input[builtins.str] consumption_model: Parameter specifying which entitlement to use for billing purposes
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Description of the Oracle Process Automation instance.
        ...
        :param pulumi.Input[builtins.str] idcs_at: IDCS Authentication token. This is required for all realms with IDCS. This property is optional, as it is not required for non-IDCS realms.
        :param pulumi.Input[builtins.bool] is_breakglass_enabled: indicates if breakGlass is enabled for the opa instance.
        :param pulumi.Input[builtins.str] metering_type: MeteringType Identifier
        :param pulumi.Input[builtins.str] state: (Updatable) The target state for the Opa Instance. Could be set to `ACTIVE` or `INACTIVE`. 
    ...
    def is_breakglass_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_breakglass_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_breakglass_enabled", value)

    @property
    @pulumi.getter(name="meteringType")
    def metering_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def metering_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _OpaInstanceState:
    def __init__(__self__, *,
                 ...
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 idcs_at: Optional[pulumi.Input[builtins.str]] = None,
                 identity_app_display_name: Optional[pulumi.Input[builtins.str]] = None,
                 identity_app_guid: Optional[pulumi.Input[builtins.str]] = None,
                 identity_app_opc_service_instance_guid: Optional[pulumi.Input[builtins.str]] = None,
                 identity_domain_url: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.str] idcs_at: IDCS Authentication token. This is required for all realms with IDCS. This property is optional, as it is not required for non-IDCS realms.
        :param pulumi.Input[builtins.str] identity_app_display_name: This property specifies the name of the Identity Application instance OPA has created inside the user-specified identity domain. This identity application instance may be used to host user roll mappings to grant access to this OPA instance for users within the identity domain.
        :param pulumi.Input[builtins.str] identity_app_guid: This property specifies the GUID of the Identity Application instance OPA has created inside the user-specified identity domain. This identity application instance may be used to host user role mappings to grant access to this OPA instance for users within the identity domain.
        :param pulumi.Input[builtins.str] identity_app_opc_service_instance_guid: This property specifies the OPC Service Instance GUID of the Identity Application instance OPA has created inside the user-specified identity domain. This identity application instance may be used to host user roll mappings to grant access to this OPA instance for users within the identity domain.
        :param pulumi.Input[builtins.str] identity_domain_url: This property specifies the domain url of the Identity Application instance OPA has created inside the user-specified identity domain. This identity application instance may be used to host user roll mappings to grant access to this OPA instance for users within the identity domain.
        :param pulumi.Input[builtins.str] instance_url: OPA Instance URL
        :param pulumi.Input[builtins.bool] is_breakglass_enabled: indicates if breakGlass is enabled for the opa instance.
        :param pulumi.Input[builtins.str] metering_type: MeteringType Identifier
        :param pulumi.Input[builtins.str] shape_name: Shape of the instance.
        :param pulumi.Input[builtins.str] state: (Updatable) The target state for the Opa Instance. Could be set to `ACTIVE` or `INACTIVE`. 
        ...
        :param pulumi.Input[builtins.str] time_created: The time when OpaInstance was created. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.str] time_updated: The time the OpaInstance was updated. An RFC3339 formatted datetime string
        """
    ...
    def identity_app_display_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def identity_app_display_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "identity_app_display_name", value)

    @property
    @pulumi.getter(name="identityAppGuid")
    def identity_app_guid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def identity_app_guid(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "identity_app_guid", value)

    @property
    @pulumi.getter(name="identityAppOpcServiceInstanceGuid")
    def identity_app_opc_service_instance_guid(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def identity_app_opc_service_instance_guid(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "identity_app_opc_service_instance_guid", value)

    @property
    @pulumi.getter(name="identityDomainUrl")
    def identity_domain_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def identity_domain_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class OpaInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'OpaInstance':
        """
    ...
    @property
    @pulumi.getter(name="idcsAt")
    def idcs_at(self) -> pulumi.Output[builtins.str]:
        """
        IDCS Authentication token. This is required for all realms with IDCS. This property is optional, as it is not required for non-IDCS realms.
        """
        return pulumi.get(self, "idcs_at")
    ...
    @property
    @pulumi.getter(name="identityAppDisplayName")
    def identity_app_display_name(self) -> pulumi.Output[builtins.str]:
        """
        This property specifies the name of the Identity Application instance OPA has created inside the user-specified identity domain. This identity application instance may be used to host user roll mappings to grant access to this OPA instance for users within the identity domain.
        """
        return pulumi.get(self, "identity_app_display_name")
    ...
    @property
    @pulumi.getter(name="identityAppGuid")
    def identity_app_guid(self) -> pulumi.Output[builtins.str]:
        """
        This property specifies the GUID of the Identity Application instance OPA has created inside the user-specified identity domain. This identity application instance may be used to host user role mappings to grant access to this OPA instance for users within the identity domain.
        """
        return pulumi.get(self, "identity_app_guid")
    ...
    @property
    @pulumi.getter(name="identityAppOpcServiceInstanceGuid")
    def identity_app_opc_service_instance_guid(self) -> pulumi.Output[builtins.str]:
        """
        This property specifies the OPC Service Instance GUID of the Identity Application instance OPA has created inside the user-specified identity domain. This identity application instance may be used to host user roll mappings to grant access to this OPA instance for users within the identity domain.
        """
        return pulumi.get(self, "identity_app_opc_service_instance_guid")
    ...
    @property
    @pulumi.getter(name="identityDomainUrl")
    def identity_domain_url(self) -> pulumi.Output[builtins.str]:
        """
        This property specifies the domain url of the Identity Application instance OPA has created inside the user-specified identity domain. This identity application instance may be used to host user roll mappings to grant access to this OPA instance for users within the identity domain.
        """
        return pulumi.get(self, "identity_domain_url")
    ...
    @property
    @pulumi.getter(name="isBreakglassEnabled")
    def is_breakglass_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        indicates if breakGlass is enabled for the opa instance.
        """
        return pulumi.get(self, "is_breakglass_enabled")
    ...
    @property
    @pulumi.getter(name="meteringType")
    def metering_type(self) -> pulumi.Output[builtins.str]:
        """
        MeteringType Identifier
        """
        return pulumi.get(self, "metering_type")
