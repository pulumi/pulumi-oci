...
class GetOpaInstancesOpaInstanceCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 identity_app_display_name: builtins.str,
                 identity_app_guid: builtins.str,
                 identity_app_opc_service_instance_guid: builtins.str,
                 identity_domain_url: builtins.str,
                 instance_url: builtins.str,
                 is_breakglass_enabled: builtins.bool,
        ...
        :param builtins.str description: Description of the Process Automation instance.
        ...
        :param builtins.str id: unique OpaInstance identifier
        :param builtins.str identity_app_display_name: This property specifies the name of the Identity Application instance OPA has created inside the user-specified identity domain. This identity application instance may be used to host user roll mappings to grant access to this OPA instance for users within the identity domain.
        :param builtins.str identity_app_guid: This property specifies the GUID of the Identity Application instance OPA has created inside the user-specified identity domain. This identity application instance may be used to host user role mappings to grant access to this OPA instance for users within the identity domain.
        :param builtins.str identity_app_opc_service_instance_guid: This property specifies the OPC Service Instance GUID of the Identity Application instance OPA has created inside the user-specified identity domain. This identity application instance may be used to host user roll mappings to grant access to this OPA instance for users within the identity domain.
        :param builtins.str identity_domain_url: This property specifies the domain url of the Identity Application instance OPA has created inside the user-specified identity domain. This identity application instance may be used to host user roll mappings to grant access to this OPA instance for users within the identity domain.
        :param builtins.str instance_url: OPA Instance URL
        :param builtins.bool is_breakglass_enabled: indicates if breakGlass is enabled for the opa instance.
        :param builtins.str metering_type: MeteringType Identifier
        :param builtins.str shape_name: Shape of the instance.
        ...
        :param builtins.str time_created: The time when OpaInstance was created. An RFC3339 formatted datetime string
        :param builtins.str time_updated: The time the OpaInstance was updated. An RFC3339 formatted datetime string
        """
    ...
    def identity_app_display_name(self) -> builtins.str:
        """
    ...
    def identity_app_opc_service_instance_guid(self) -> builtins.str:
        """
    ...
    def identity_domain_url(self) -> builtins.str:
        """
    ...
    def is_breakglass_enabled(self) -> builtins.bool:
        """
