...
class ClusterArgs:
    def __init__(__self__, *,
                 ...
                 data_node_count: pulumi.Input[builtins.int],
                 data_node_host_memory_gb: pulumi.Input[builtins.int],
                 data_node_host_ocpu_count: pulumi.Input[builtins.int],
                 data_node_host_type: pulumi.Input[builtins.str],
                 data_node_storage_gb: pulumi.Input[builtins.int],
                 display_name: pulumi.Input[builtins.str],
                 master_node_count: pulumi.Input[builtins.int],
                 master_node_host_memory_gb: pulumi.Input[builtins.int],
                 master_node_host_ocpu_count: pulumi.Input[builtins.int],
                 master_node_host_type: pulumi.Input[builtins.str],
                 opendashboard_node_count: pulumi.Input[builtins.int],
                 opendashboard_node_host_memory_gb: pulumi.Input[builtins.int],
                 opendashboard_node_host_ocpu_count: pulumi.Input[builtins.int],
                 software_version: pulumi.Input[builtins.str],
                 subnet_compartment_id: pulumi.Input[builtins.str],
                 subnet_id: pulumi.Input[builtins.str],
                 vcn_compartment_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment to create the cluster in.
        :param pulumi.Input[builtins.int] data_node_count: (Updatable) The number of data nodes to configure for the cluster.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The name of the cluster. Avoid entering confidential information.
        :param pulumi.Input[builtins.int] master_node_count: (Updatable) The number of master nodes to configure for the cluster.
        ...
        :param pulumi.Input[builtins.str] vcn_compartment_id: The OCID for the compartment where the cluster's VCN is located.
    ...
    def data_node_count(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def data_node_count(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "data_node_count", value)

    @property
    @pulumi.getter(name="dataNodeHostMemoryGb")
    def data_node_host_memory_gb(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def data_node_host_memory_gb(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "data_node_host_memory_gb", value)

    @property
    @pulumi.getter(name="dataNodeHostOcpuCount")
    def data_node_host_ocpu_count(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def data_node_host_ocpu_count(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "data_node_host_ocpu_count", value)

    @property
    @pulumi.getter(name="dataNodeHostType")
    def data_node_host_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def data_node_host_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "data_node_host_type", value)

    @property
    @pulumi.getter(name="dataNodeStorageGb")
    def data_node_storage_gb(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def data_node_storage_gb(self, value: pulumi.Input[builtins.int]):
    ...
    def master_node_count(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def master_node_count(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "master_node_count", value)

    @property
    @pulumi.getter(name="masterNodeHostMemoryGb")
    def master_node_host_memory_gb(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def master_node_host_memory_gb(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "master_node_host_memory_gb", value)

    @property
    @pulumi.getter(name="masterNodeHostOcpuCount")
    def master_node_host_ocpu_count(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def master_node_host_ocpu_count(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "master_node_host_ocpu_count", value)

    @property
    @pulumi.getter(name="masterNodeHostType")
    def master_node_host_type(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def master_node_host_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "master_node_host_type", value)

    @property
    @pulumi.getter(name="opendashboardNodeCount")
    def opendashboard_node_count(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def opendashboard_node_count(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "opendashboard_node_count", value)

    @property
    @pulumi.getter(name="opendashboardNodeHostMemoryGb")
    def opendashboard_node_host_memory_gb(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def opendashboard_node_host_memory_gb(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "opendashboard_node_host_memory_gb", value)

    @property
    @pulumi.getter(name="opendashboardNodeHostOcpuCount")
    def opendashboard_node_host_ocpu_count(self) -> pulumi.Input[builtins.int]:
        """
    ...
    def opendashboard_node_host_ocpu_count(self, value: pulumi.Input[builtins.int]):
    ...
    def subnet_compartment_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def subnet_compartment_id(self, value: pulumi.Input[builtins.str]):
    ...
    def vcn_compartment_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def vcn_compartment_id(self, value: pulumi.Input[builtins.str]):
    ...
    def configure_outbound_cluster_trigger(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def configure_outbound_cluster_trigger(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "configure_outbound_cluster_trigger", value)

    @property
    @pulumi.getter(name="dataNodeHostBareMetalShape")
    def data_node_host_bare_metal_shape(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def data_node_host_bare_metal_shape(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def inbound_cluster_ids(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def inbound_cluster_ids(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    def master_node_host_bare_metal_shape(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def master_node_host_bare_metal_shape(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def reverse_connection_endpoint_customer_ips(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def security_master_user_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "security_master_user_name", value)

    @property
    @pulumi.getter(name="securityMasterUserPasswordHash")
    def security_master_user_password_hash(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def security_master_user_password_hash(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def upgrade_major_version_trigger(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def upgrade_major_version_trigger(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _ClusterState:
    def __init__(__self__, *,
                 availability_domains: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 configure_outbound_cluster_trigger: Optional[pulumi.Input[builtins.int]] = None,
                 data_node_count: Optional[pulumi.Input[builtins.int]] = None,
                 data_node_host_bare_metal_shape: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 maintenance_details: Optional[pulumi.Input['ClusterMaintenanceDetailsArgs']] = None,
                 master_node_count: Optional[pulumi.Input[builtins.int]] = None,
                 master_node_host_bare_metal_shape: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 total_storage_gb: Optional[pulumi.Input[builtins.int]] = None,
                 upgrade_major_version_trigger: Optional[pulumi.Input[builtins.int]] = None,
                 vcn_compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 vcn_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Cluster resources.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] availability_domains: The availability domains to distribute the cluser nodes across.
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment to create the cluster in.
        :param pulumi.Input[builtins.int] configure_outbound_cluster_trigger: (Updatable) An optional property when incremented triggers Configure Outbound Cluster. Could be set to any integer value.
        :param pulumi.Input[builtins.int] data_node_count: (Updatable) The number of data nodes to configure for the cluster.
        :param pulumi.Input[builtins.str] data_node_host_bare_metal_shape: The bare metal shape for the cluster's data nodes.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] display_name: (Updatable) The name of the cluster. Avoid entering confidential information.
        :param pulumi.Input[builtins.str] fqdn: The fully qualified domain name (FQDN) for the cluster's API endpoint.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] inbound_cluster_ids: List of inbound clusters that will be queried using cross cluster search
        :param pulumi.Input[builtins.str] lifecycle_details: Additional information about the current lifecycle state of the cluster.
        :param pulumi.Input['ClusterMaintenanceDetailsArgs'] maintenance_details: (Updatable) Details for creation of maintenance details
        :param pulumi.Input[builtins.int] master_node_count: (Updatable) The number of master nodes to configure for the cluster.
        :param pulumi.Input[builtins.str] master_node_host_bare_metal_shape: The bare metal shape for the cluster's master nodes.
        :param pulumi.Input[builtins.int] master_node_host_memory_gb: (Updatable) The amount of memory in GB, to configure per node for the cluster's master nodes.
        ...
        :param pulumi.Input[builtins.str] subnet_id: The OCID of the cluster's subnet.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param pulumi.Input[builtins.str] time_created: The amount of time in milliseconds since the cluster was created.
        :param pulumi.Input[builtins.str] time_deleted: The amount of time in milliseconds since the cluster was updated.
        :param pulumi.Input[builtins.str] time_updated: The amount of time in milliseconds since the cluster was updated.
        :param pulumi.Input[builtins.int] total_storage_gb: The size in GB of the cluster's total storage.
        :param pulumi.Input[builtins.int] upgrade_major_version_trigger: An optional property to upgrade the major version of the cluster. This workflow upgrades the cluster without creating a clone. If you want to create a clone and upgrade the clone for testing please use SDK or CLI.
    ...
    def availability_domains(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def availability_domains(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
    ...
    @property
    @pulumi.getter(name="dataNodeCount")
    def data_node_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The number of data nodes to configure for the cluster.
        """
        return pulumi.get(self, "data_node_count")
    ...
    @data_node_count.setter
    def data_node_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "data_node_count", value)
    ...
    @property
    @pulumi.getter(name="dataNodeHostMemoryGb")
    def data_node_host_memory_gb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The amount of memory in GB, to configure per node for the cluster's data nodes.
        """
        return pulumi.get(self, "data_node_host_memory_gb")
    ...
    @data_node_host_memory_gb.setter
    def data_node_host_memory_gb(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "data_node_host_memory_gb", value)

    @property
    @pulumi.getter(name="dataNodeHostOcpuCount")
    def data_node_host_ocpu_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The number of OCPUs to configure for the cluster's data nodes.
        """
        return pulumi.get(self, "data_node_host_ocpu_count")
    ...
    @property
    @pulumi.getter(name="dataNodeHostType")
    def data_node_host_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        TThe instance type for the cluster's data nodes.
        """
        return pulumi.get(self, "data_node_host_type")
    ...
    @data_node_host_type.setter
    def data_node_host_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "data_node_host_type", value)

    @property
    @pulumi.getter(name="dataNodeStorageGb")
    def data_node_storage_gb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The amount of storage in GB, to configure per node for the cluster's data nodes.
        """
        return pulumi.get(self, "data_node_storage_gb")
    ...
    @data_node_storage_gb.setter
    def data_node_storage_gb(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "data_node_storage_gb", value)
    ...
    @property
    @pulumi.getter(name="masterNodeCount")
    def master_node_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The number of master nodes to configure for the cluster.
        """
        return pulumi.get(self, "master_node_count")
    ...
    @master_node_count.setter
    def master_node_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "master_node_count", value)
    ...
    @property
    @pulumi.getter(name="masterNodeHostMemoryGb")
    def master_node_host_memory_gb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The amount of memory in GB, to configure per node for the cluster's master nodes.
        """
        return pulumi.get(self, "master_node_host_memory_gb")
    ...
    @master_node_host_memory_gb.setter
    def master_node_host_memory_gb(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "master_node_host_memory_gb", value)

    @property
    @pulumi.getter(name="masterNodeHostOcpuCount")
    def master_node_host_ocpu_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The number of OCPUs to configure for the cluser's master nodes.
        """
        return pulumi.get(self, "master_node_host_ocpu_count")
    ...
    @master_node_host_ocpu_count.setter
    def master_node_host_ocpu_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "master_node_host_ocpu_count", value)
    ...
    @master_node_host_type.setter
    def master_node_host_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "master_node_host_type", value)

    @property
    @pulumi.getter(name="opendashboardFqdn")
    def opendashboard_fqdn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def opendashboard_fqdn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "opendashboard_fqdn", value)

    @property
    @pulumi.getter(name="opendashboardNodeCount")
    def opendashboard_node_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The number of OpenSearch Dashboard nodes to configure for the cluster.
        """
        return pulumi.get(self, "opendashboard_node_count")
    ...
    @opendashboard_node_count.setter
    def opendashboard_node_count(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "opendashboard_node_count", value)

    @property
    @pulumi.getter(name="opendashboardNodeHostMemoryGb")
    def opendashboard_node_host_memory_gb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The amount of memory in GB, to configure for the cluster's OpenSearch Dashboard nodes.
        """
        return pulumi.get(self, "opendashboard_node_host_memory_gb")
    ...
    @opendashboard_node_host_memory_gb.setter
    def opendashboard_node_host_memory_gb(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "opendashboard_node_host_memory_gb", value)

    @property
    @pulumi.getter(name="opendashboardNodeHostOcpuCount")
    def opendashboard_node_host_ocpu_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The number of OCPUs to configure for the cluster's OpenSearch Dashboard nodes.
        """
        return pulumi.get(self, "opendashboard_node_host_ocpu_count")
    ...
    def opendashboard_private_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def opendashboard_private_ip(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "opendashboard_private_ip", value)

    @property
    @pulumi.getter(name="opensearchFqdn")
    def opensearch_fqdn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The fully qualified domain name (FQDN) for the cluster's API endpoint.
        """
    ...
    def opensearch_fqdn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "opensearch_fqdn", value)

    @property
    @pulumi.getter(name="opensearchPrivateIp")
    def opensearch_private_ip(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def opensearch_private_ip(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def total_storage_gb(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def total_storage_gb(self, value: Optional[pulumi.Input[builtins.int]]):
...
class Cluster(pulumi.CustomResource):
    ...
    pulumi_type = "oci:Opensearch/cluster:Cluster"
    ...
    @property
    @pulumi.getter(name="availabilityDomains")
    def availability_domains(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The availability domains to distribute the cluser nodes across.
        """
        return pulumi.get(self, "availability_domains")
    ...
    @property
    @pulumi.getter(name="configureOutboundClusterTrigger")
    def configure_outbound_cluster_trigger(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        (Updatable) An optional property when incremented triggers Configure Outbound Cluster. Could be set to any integer value.
        """
        return pulumi.get(self, "configure_outbound_cluster_trigger")
    ...
    @property
    @pulumi.getter(name="dataNodeCount")
    def data_node_count(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The number of data nodes to configure for the cluster.
        """
        return pulumi.get(self, "data_node_count")
    ...
    @property
    @pulumi.getter(name="dataNodeHostBareMetalShape")
    def data_node_host_bare_metal_shape(self) -> pulumi.Output[builtins.str]:
        """
        The bare metal shape for the cluster's data nodes.
        """
        return pulumi.get(self, "data_node_host_bare_metal_shape")
    ...
    @property
    @pulumi.getter(name="dataNodeHostMemoryGb")
    def data_node_host_memory_gb(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The amount of memory in GB, to configure per node for the cluster's data nodes.
        """
        return pulumi.get(self, "data_node_host_memory_gb")
    ...
    @property
    @pulumi.getter(name="dataNodeHostOcpuCount")
    def data_node_host_ocpu_count(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The number of OCPUs to configure for the cluster's data nodes.
        """
        return pulumi.get(self, "data_node_host_ocpu_count")
    ...
    @property
    @pulumi.getter(name="dataNodeHostType")
    def data_node_host_type(self) -> pulumi.Output[builtins.str]:
        """
        TThe instance type for the cluster's data nodes.
        """
        return pulumi.get(self, "data_node_host_type")
    ...
    @property
    @pulumi.getter(name="dataNodeStorageGb")
    def data_node_storage_gb(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The amount of storage in GB, to configure per node for the cluster's data nodes.
        """
        return pulumi.get(self, "data_node_storage_gb")
    ...
    @property
    @pulumi.getter(name="inboundClusterIds")
    def inbound_cluster_ids(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        List of inbound clusters that will be queried using cross cluster search
        """
        return pulumi.get(self, "inbound_cluster_ids")
    ...
    @property
    @pulumi.getter(name="masterNodeCount")
    def master_node_count(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The number of master nodes to configure for the cluster.
        """
        return pulumi.get(self, "master_node_count")
    ...
    @property
    @pulumi.getter(name="masterNodeHostBareMetalShape")
    def master_node_host_bare_metal_shape(self) -> pulumi.Output[builtins.str]:
        """
        The bare metal shape for the cluster's master nodes.
        """
        return pulumi.get(self, "master_node_host_bare_metal_shape")
    ...
    @property
    @pulumi.getter(name="masterNodeHostMemoryGb")
    def master_node_host_memory_gb(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The amount of memory in GB, to configure per node for the cluster's master nodes.
        """
        return pulumi.get(self, "master_node_host_memory_gb")
    ...
    @property
    @pulumi.getter(name="masterNodeHostOcpuCount")
    def master_node_host_ocpu_count(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The number of OCPUs to configure for the cluser's master nodes.
        """
        return pulumi.get(self, "master_node_host_ocpu_count")
    ...
    @property
    @pulumi.getter(name="opendashboardFqdn")
    def opendashboard_fqdn(self) -> pulumi.Output[builtins.str]:
        """
        The fully qualified domain name (FQDN) for the cluster's OpenSearch Dashboard API endpoint.
        """
        return pulumi.get(self, "opendashboard_fqdn")
    ...
    @property
    @pulumi.getter(name="opendashboardNodeCount")
    def opendashboard_node_count(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The number of OpenSearch Dashboard nodes to configure for the cluster.
        """
        return pulumi.get(self, "opendashboard_node_count")
    ...
    @property
    @pulumi.getter(name="opendashboardNodeHostMemoryGb")
    def opendashboard_node_host_memory_gb(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The amount of memory in GB, to configure for the cluster's OpenSearch Dashboard nodes.
        """
        return pulumi.get(self, "opendashboard_node_host_memory_gb")
    ...
    @property
    @pulumi.getter(name="opendashboardNodeHostOcpuCount")
    def opendashboard_node_host_ocpu_count(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The number of OCPUs to configure for the cluster's OpenSearch Dashboard nodes.
        """
        return pulumi.get(self, "opendashboard_node_host_ocpu_count")
    ...
    @property
    @pulumi.getter(name="opendashboardPrivateIp")
    def opendashboard_private_ip(self) -> pulumi.Output[builtins.str]:
        """
        The private IP address for the cluster's OpenSearch Dashboard.
        """
        return pulumi.get(self, "opendashboard_private_ip")
    ...
    @property
    @pulumi.getter(name="opensearchFqdn")
    def opensearch_fqdn(self) -> pulumi.Output[builtins.str]:
        """
        The fully qualified domain name (FQDN) for the cluster's API endpoint.
        """
        return pulumi.get(self, "opensearch_fqdn")
    ...
    @property
    @pulumi.getter(name="opensearchPrivateIp")
    def opensearch_private_ip(self) -> pulumi.Output[builtins.str]:
        """
        The cluster's private IP address.
        """
        return pulumi.get(self, "opensearch_private_ip")
    ...
    @property
    @pulumi.getter(name="reverseConnectionEndpointCustomerIps")
    def reverse_connection_endpoint_customer_ips(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) The customer IP addresses of the endpoint in customer VCN
        """
        return pulumi.get(self, "reverse_connection_endpoint_customer_ips")
    ...
    @property
    @pulumi.getter(name="securityMasterUserPasswordHash")
    def security_master_user_password_hash(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The password hash of the master user that are used to manage security config
        """
        return pulumi.get(self, "security_master_user_password_hash")
    ...
    @property
    @pulumi.getter(name="totalStorageGb")
    def total_storage_gb(self) -> pulumi.Output[builtins.int]:
        """
        The size in GB of the cluster's total storage.
        """
        return pulumi.get(self, "total_storage_gb")
    ...
    @property
    @pulumi.getter(name="upgradeMajorVersionTrigger")
    def upgrade_major_version_trigger(self) -> pulumi.Output[builtins.int]:
        """
        An optional property to upgrade the major version of the cluster. This workflow upgrades the cluster without creating a clone. If you want to create a clone and upgrade the clone for testing please use SDK or CLI.
