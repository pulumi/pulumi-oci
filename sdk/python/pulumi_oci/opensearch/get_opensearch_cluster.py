...
class GetOpensearchClusterResult:
    ...
    def opensearch_cluster_id(self) -> builtins.str:
...
def get_opensearch_cluster(opensearch_cluster_id: Optional[builtins.str] = None,
    ...
    :param builtins.str opensearch_cluster_id: unique OpensearchCluster identifier
    """
    __args__ = dict()
...
def get_opensearch_cluster_output(opensearch_cluster_id: Optional[pulumi.Input[builtins.str]] = None,
