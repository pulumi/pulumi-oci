...
def get_opensearch_cluster(opensearch_cluster_id: Optional[str] = None,
    ...
    return AwaitableGetOpensearchClusterResult(
        ...
        data_node_count=__ret__.data_node_count,
        data_node_host_bare_metal_shape=__ret__.data_node_host_bare_metal_shape,
        data_node_host_memory_gb=__ret__.data_node_host_memory_gb,
        data_node_host_ocpu_count=__ret__.data_node_host_ocpu_count,
        data_node_host_type=__ret__.data_node_host_type,
        data_node_storage_gb=__ret__.data_node_storage_gb,
        ...
        master_node_count=__ret__.master_node_count,
        master_node_host_bare_metal_shape=__ret__.master_node_host_bare_metal_shape,
        master_node_host_memory_gb=__ret__.master_node_host_memory_gb,
        master_node_host_ocpu_count=__ret__.master_node_host_ocpu_count,
        master_node_host_type=__ret__.master_node_host_type,
        opendashboard_fqdn=__ret__.opendashboard_fqdn,
        opendashboard_node_count=__ret__.opendashboard_node_count,
        opendashboard_node_host_memory_gb=__ret__.opendashboard_node_host_memory_gb,
        opendashboard_node_host_ocpu_count=__ret__.opendashboard_node_host_ocpu_count,
        opendashboard_private_ip=__ret__.opendashboard_private_ip,
        ...
        total_storage_gb=__ret__.total_storage_gb,
        vcn_compartment_id=__ret__.vcn_compartment_id,
