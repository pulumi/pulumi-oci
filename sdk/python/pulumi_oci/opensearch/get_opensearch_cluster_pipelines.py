...
class GetOpensearchClusterPipelinesResult:
    ...
    def pipeline_component_id(self) -> Optional[builtins.str]:
...
def get_opensearch_cluster_pipelines(compartment_id: Optional[builtins.str] = None,
                                     ...
                                     pipeline_component_id: Optional[builtins.str] = None,
    ...
    :param builtins.str pipeline_component_id: A filter to return pipelines whose any component has the given pipelineComponentId.
...
def get_opensearch_cluster_pipelines_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                            ...
                                            pipeline_component_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
