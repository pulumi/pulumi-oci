...
def get_opensearch_version(compartment_id: Optional[_builtins.str] = None,
...
def get_opensearch_version_output(compartment_id: Optional[pulumi.Input[_builtins.str]] = None,
