...
def get_opensearch_version(compartment_id: Optional[builtins.str] = None,
...
def get_opensearch_version_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
