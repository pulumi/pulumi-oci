...
class OpensearchClusterPipelineArgs:
    def __init__(__self__, *,
                 ...
                 data_prepper_configuration_body: pulumi.Input[_builtins.str],
                 display_name: pulumi.Input[_builtins.str],
                 memory_gb: pulumi.Input[_builtins.int],
        ...
        :param pulumi.Input[_builtins.int] memory_gb: (Updatable) The amount of memory in GB, for each pipeline node.
        :param pulumi.Input[_builtins.int] node_count: (Updatable) The number of nodes configured for the pipeline.
        ...
        :param pulumi.Input[_builtins.str] node_shape: (Updatable) The pipeline node shape.
        :param pulumi.Input[_builtins.str] nsg_id: (Updatable) The OCID of the NSG where the pipeline private endpoint vnic will be attached.
    ...
    def data_prepper_configuration_body(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def data_prepper_configuration_body(self, value: pulumi.Input[_builtins.str]):
    ...
    def memory_gb(self) -> pulumi.Input[_builtins.int]:
        """
    ...
    @memory_gb.setter
    def memory_gb(self, value: pulumi.Input[_builtins.int]):
...
class _OpensearchClusterPipelineState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] ocpu_count: (Updatable) The number of OCPUs configured for each pipeline node.
        :param pulumi.Input[_builtins.bool] opc_dry_run: (Updatable) Indicates that the request is a dry run, if set to "true". A dry run request does not modify the configuration item details and is used only to perform validation on the submitted data.
        :param pulumi.Input[_builtins.str] opensearch_pipeline_fqdn: The fully qualified domain name (FQDN) for the cluster's API endpoint.
        ...
        :param pulumi.Input[_builtins.str] time_created: The date and time the cluster pipeline was created. Format defined by [RFC3339](https://tools.ietf.org/html/rfc3339).
...
class OpensearchClusterPipeline(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="dataPrepperConfigurationBody")
    def data_prepper_configuration_body(self) -> pulumi.Output[_builtins.str]:
        """
        (Updatable) The data prepper config in YAML format. The command accepts the data prepper config as a string or within a .yaml file. If you provide the configuration as a string, each new line must be escaped with \\.
        """
        return pulumi.get(self, "data_prepper_configuration_body")
    ...
    @_builtins.property
    @pulumi.getter(name="memoryGb")
    def memory_gb(self) -> pulumi.Output[_builtins.int]:
        """
        (Updatable) The amount of memory in GB, for each pipeline node.
        """
        return pulumi.get(self, "memory_gb")
    ...
    @_builtins.property
    @pulumi.getter(name="ocpuCount")
    def ocpu_count(self) -> pulumi.Output[_builtins.int]:
        """
        (Updatable) The number of OCPUs configured for each pipeline node.
        """
        return pulumi.get(self, "ocpu_count")
    ...
    @_builtins.property
    @pulumi.getter(name="opensearchPipelineFqdn")
    def opensearch_pipeline_fqdn(self) -> pulumi.Output[_builtins.str]:
        """
        The fully qualified domain name (FQDN) for the cluster's API endpoint.
        """
        return pulumi.get(self, "opensearch_pipeline_fqdn")
    ...
    @_builtins.property
    @pulumi.getter(name="opensearchPipelinePrivateIp")
    def opensearch_pipeline_private_ip(self) -> pulumi.Output[_builtins.str]:
        """
        The pipeline's private IP address.
        """
        return pulumi.get(self, "opensearch_pipeline_private_ip")
    ...
    @_builtins.property
    @pulumi.getter(name="pipelineMode")
    def pipeline_mode(self) -> pulumi.Output[_builtins.str]:
        """
        The current state of the pipeline.
        """
        return pulumi.get(self, "pipeline_mode")
