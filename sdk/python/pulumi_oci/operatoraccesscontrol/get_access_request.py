...
def get_access_request(access_request_id: Optional[builtins.str] = None,
...
def get_access_request_output(access_request_id: Optional[pulumi.Input[builtins.str]] = None,
