...
class GetAccessRequestAuditLogReportResult:
    ...
    def audit_report_status(self) -> builtins.str:
        """
    ...
    def enable_process_tree(self) -> Optional[builtins.int]:
    ...
    def process_tree(self) -> builtins.str:
        """
    ...
    def time_of_report_generation(self) -> builtins.str:
        """
...
def get_access_request_audit_log_report(access_request_id: Optional[builtins.str] = None,
                                        enable_process_tree: Optional[builtins.int] = None,
    ...
    :param builtins.int enable_process_tree: To enable process tree computation in audit report
    """
    __args__ = dict()
...
def get_access_request_audit_log_report_output(access_request_id: Optional[pulumi.Input[builtins.str]] = None,
                                               enable_process_tree: Optional[pulumi.Input[Optional[builtins.int]]] = None,
