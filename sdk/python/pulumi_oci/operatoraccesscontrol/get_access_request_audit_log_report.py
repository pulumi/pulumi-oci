...
class GetAccessRequestAuditLogReportResult:
    ...
    def audit_report_status(self) -> _builtins.str:
        """
    ...
    def enable_process_tree(self) -> Optional[_builtins.int]:
    ...
    def process_tree(self) -> _builtins.str:
        """
    ...
    def time_of_report_generation(self) -> _builtins.str:
        """
...
def get_access_request_audit_log_report(access_request_id: Optional[_builtins.str] = None,
                                        enable_process_tree: Optional[_builtins.int] = None,
    ...
    :param _builtins.int enable_process_tree: To enable process tree computation in audit report
    """
    __args__ = dict()
