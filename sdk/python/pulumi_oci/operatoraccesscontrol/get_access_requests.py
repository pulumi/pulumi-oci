...
def get_access_requests(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str time_end: Query start time in UTC in ISO 8601 format(inclusive). Example 2019-10-30T00:00:00Z (yyyy-MM-ddThh:mm:ssZ). timeIntervalStart and timeIntervalEnd parameters are used together.
    :param builtins.str time_start: Query start time in UTC in ISO 8601 format(inclusive). Example 2019-10-30T00:00:00Z (yyyy-MM-ddThh:mm:ssZ). timeIntervalStart and timeIntervalEnd parameters are used together.
    """
    __args__ = dict()
...
def get_access_requests_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
