...
class GetActionResult:
    ...
    def operator_action_id(self) -> _builtins.str:
...
def get_action(operator_action_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str operator_action_id: Unique Oracle supplied identifier associated with the operator action.
    """
    __args__ = dict()
