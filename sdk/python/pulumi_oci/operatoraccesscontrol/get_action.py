...
class GetActionResult:
    ...
    def operator_action_id(self) -> builtins.str:
...
def get_action(operator_action_id: Optional[builtins.str] = None,
    ...
    :param builtins.str operator_action_id: Unique Oracle supplied identifier associated with the operator action.
    """
    __args__ = dict()
...
def get_action_output(operator_action_id: Optional[pulumi.Input[builtins.str]] = None,
