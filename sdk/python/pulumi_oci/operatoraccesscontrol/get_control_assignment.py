...
def get_control_assignment(operator_control_assignment_id: Optional[str] = None,
    ...
    return AwaitableGetControlAssignmentResult(
        assigner_id=__ret__.assigner_id,
        comment=__ret__.comment,
        compartment_id=__ret__.compartment_id,
        defined_tags=__ret__.defined_tags,
        detachment_description=__ret__.detachment_description,
        ...
        remote_syslog_server_ca_cert=__ret__.remote_syslog_server_ca_cert,
        remote_syslog_server_port=__ret__.remote_syslog_server_port,
        ...
        state=__ret__.state,
        time_assignment_from=__ret__.time_assignment_from,
        time_assignment_to=__ret__.time_assignment_to,
        time_of_assignment=__ret__.time_of_assignment,
        time_of_deletion=__ret__.time_of_deletion,
        unassigner_id=__ret__.unassigner_id)
