...
class GetControlAssignmentResult:
    ...
    def operator_control_assignment_id(self) -> builtins.str:
...
def get_control_assignment(operator_control_assignment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str operator_control_assignment_id: unique OperatorControl identifier
    """
    __args__ = dict()
...
def get_control_assignment_output(operator_control_assignment_id: Optional[pulumi.Input[builtins.str]] = None,
