...
class GetControlAssignmentsResult:
    ...
    def operator_control_name(self) -> Optional[builtins.str]:
...
def get_control_assignments(compartment_id: Optional[builtins.str] = None,
                            filters: Optional[Sequence[Union['GetControlAssignmentsFilterArgs', 'GetControlAssignmentsFilterArgsDict']]] = None,
                            operator_control_name: Optional[builtins.str] = None,
    ...
    :param builtins.str operator_control_name: A filter to return OperatorControl that match the given operatorControlName.
...
def get_control_assignments_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                   ...
                                   operator_control_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
