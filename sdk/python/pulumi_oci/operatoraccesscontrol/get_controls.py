...
def get_controls(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str display_name: A filter to return OperatorControl that match the entire display name given.
...
def get_controls_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
