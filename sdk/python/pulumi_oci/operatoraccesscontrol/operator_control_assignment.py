...
class OperatorControlAssignmentArgs:
    def __init__(__self__, *,
                 ...
                 is_enforced_always: pulumi.Input[builtins.bool],
                 operator_control_id: pulumi.Input[builtins.str],
                 resource_compartment_id: pulumi.Input[builtins.str],
                 ...
                 is_hypervisor_log_forwarded: Optional[pulumi.Input[builtins.bool]] = None,
                 is_log_forwarded: Optional[pulumi.Input[builtins.bool]] = None,
                 remote_syslog_server_address: Optional[pulumi.Input[builtins.str]] = None,
                 remote_syslog_server_ca_cert: Optional[pulumi.Input[builtins.str]] = None,
                 remote_syslog_server_port: Optional[pulumi.Input[builtins.int]] = None,
                 time_assignment_from: Optional[pulumi.Input[builtins.str]] = None,
                 time_assignment_to: Optional[pulumi.Input[builtins.str]] = None,
                 validate_assignment_trigger: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a OperatorControlAssignment resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment that contains the operator control assignment.
        :param pulumi.Input[builtins.bool] is_enforced_always: (Updatable) If set, then the target resource is always governed by the operator control.
        :param pulumi.Input[builtins.str] operator_control_id: The OCID of the operator control that is being assigned to a target resource.
        :param pulumi.Input[builtins.str] resource_compartment_id: The OCID of the compartment that contains the target resource.
        :param pulumi.Input[builtins.str] resource_id: The OCID of the target resource being brought under the governance of the operator control.
        :param pulumi.Input[builtins.str] resource_name: Name of the target resource.
        :param pulumi.Input[builtins.str] resource_type: Type of the target resource.
        :param pulumi.Input[builtins.str] comment: (Updatable) Comment about the assignment of the operator control to this target resource.
        ...
        :param pulumi.Input[builtins.bool] is_auto_approve_during_maintenance: (Updatable) The boolean if true would autoApprove during maintenance.
        :param pulumi.Input[builtins.bool] is_hypervisor_log_forwarded: (Updatable) If set, then the hypervisor audit logs will be forwarded to the relevant remote syslog server
        :param pulumi.Input[builtins.bool] is_log_forwarded: (Updatable) If set, then the audit logs will be forwarded to the relevant remote logging server
        :param pulumi.Input[builtins.str] remote_syslog_server_address: (Updatable) The address of the remote syslog server where the audit logs will be forwarded to. Address in host or IP format.
        :param pulumi.Input[builtins.str] remote_syslog_server_ca_cert: (Updatable) The CA certificate of the remote syslog server. Identity of the remote syslog server will be asserted based on this certificate.
        :param pulumi.Input[builtins.int] remote_syslog_server_port: (Updatable) The listening port of the remote syslog server. The port range is 0 - 65535. Only TCP supported.
        :param pulumi.Input[builtins.str] time_assignment_from: (Updatable) The time at which the target resource will be brought under the governance of the operator control in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: '2020-05-22T21:10:29.600Z'
        :param pulumi.Input[builtins.str] time_assignment_to: (Updatable) The time at which the target resource will leave the governance of the operator control in [RFC 3339](https://tools.ietf.org/html/rfc3339)timestamp format.Example: '2020-05-22T21:10:29.600Z'
        :param pulumi.Input[builtins.int] validate_assignment_trigger: (Updatable) An optional property when incremented triggers Validate Assignment. Could be set to any integer value.
    ...
    def is_enforced_always(self) -> pulumi.Input[builtins.bool]:
        """
    ...
    def is_enforced_always(self, value: pulumi.Input[builtins.bool]):
        pulumi.set(self, "is_enforced_always", value)

    @property
    @pulumi.getter(name="operatorControlId")
    def operator_control_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def operator_control_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "operator_control_id", value)

    @property
    @pulumi.getter(name="resourceCompartmentId")
    def resource_compartment_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def resource_compartment_id(self, value: pulumi.Input[builtins.str]):
    ...
    def is_hypervisor_log_forwarded(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_hypervisor_log_forwarded(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_hypervisor_log_forwarded", value)

    @property
    @pulumi.getter(name="isLogForwarded")
    def is_log_forwarded(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_log_forwarded(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_log_forwarded", value)

    @property
    @pulumi.getter(name="remoteSyslogServerAddress")
    def remote_syslog_server_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def remote_syslog_server_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "remote_syslog_server_address", value)

    @property
    @pulumi.getter(name="remoteSyslogServerCaCert")
    def remote_syslog_server_ca_cert(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def remote_syslog_server_ca_cert(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "remote_syslog_server_ca_cert", value)

    @property
    @pulumi.getter(name="remoteSyslogServerPort")
    def remote_syslog_server_port(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def remote_syslog_server_port(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "remote_syslog_server_port", value)

    @property
    @pulumi.getter(name="timeAssignmentFrom")
    def time_assignment_from(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_assignment_from(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_assignment_from", value)

    @property
    @pulumi.getter(name="timeAssignmentTo")
    def time_assignment_to(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_assignment_to(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_assignment_to", value)

    @property
    @pulumi.getter(name="validateAssignmentTrigger")
    def validate_assignment_trigger(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def validate_assignment_trigger(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _OperatorControlAssignmentState:
    def __init__(__self__, *,
                 assigner_id: Optional[pulumi.Input[builtins.str]] = None,
                 comment: Optional[pulumi.Input[builtins.str]] = None,
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 detachment_description: Optional[pulumi.Input[builtins.str]] = None,
                 error_code: Optional[pulumi.Input[builtins.int]] = None,
                 error_message: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_auto_approve_during_maintenance: Optional[pulumi.Input[builtins.bool]] = None,
                 is_default_assignment: Optional[pulumi.Input[builtins.bool]] = None,
                 is_enforced_always: Optional[pulumi.Input[builtins.bool]] = None,
                 is_hypervisor_log_forwarded: Optional[pulumi.Input[builtins.bool]] = None,
                 is_log_forwarded: Optional[pulumi.Input[builtins.bool]] = None,
                 lifecycle_details: Optional[pulumi.Input[builtins.str]] = None,
                 op_control_name: Optional[pulumi.Input[builtins.str]] = None,
                 operator_control_id: Optional[pulumi.Input[builtins.str]] = None,
                 remote_syslog_server_address: Optional[pulumi.Input[builtins.str]] = None,
                 remote_syslog_server_ca_cert: Optional[pulumi.Input[builtins.str]] = None,
                 remote_syslog_server_port: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 time_assignment_from: Optional[pulumi.Input[builtins.str]] = None,
                 time_assignment_to: Optional[pulumi.Input[builtins.str]] = None,
                 time_of_assignment: Optional[pulumi.Input[builtins.str]] = None,
                 time_of_deletion: Optional[pulumi.Input[builtins.str]] = None,
                 unassigner_id: Optional[pulumi.Input[builtins.str]] = None,
                 validate_assignment_trigger: Optional[pulumi.Input[builtins.int]] = None):
        """
        Input properties used for looking up and filtering OperatorControlAssignment resources.
        :param pulumi.Input[builtins.str] assigner_id: The OCID of the user who created this operator control assignment.
        :param pulumi.Input[builtins.str] comment: (Updatable) Comment about the assignment of the operator control to this target resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment that contains the operator control assignment.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace.
        :param pulumi.Input[builtins.str] detachment_description: description containing reason for releasing of OperatorControl.
        :param pulumi.Input[builtins.int] error_code: The code identifying the error occurred during Assignment operation.
        :param pulumi.Input[builtins.str] error_message: The message describing the error occurred during Assignment operation.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.
        :param pulumi.Input[builtins.bool] is_auto_approve_during_maintenance: (Updatable) The boolean if true would autoApprove during maintenance.
        :param pulumi.Input[builtins.bool] is_default_assignment: Whether the assignment is a default assignment.
        :param pulumi.Input[builtins.bool] is_enforced_always: (Updatable) If set, then the target resource is always governed by the operator control.
        :param pulumi.Input[builtins.bool] is_hypervisor_log_forwarded: (Updatable) If set, then the hypervisor audit logs will be forwarded to the relevant remote syslog server
        :param pulumi.Input[builtins.bool] is_log_forwarded: (Updatable) If set, then the audit logs will be forwarded to the relevant remote logging server
        :param pulumi.Input[builtins.str] lifecycle_details: More in detail about the lifeCycleState.
        :param pulumi.Input[builtins.str] op_control_name: Name of the operator control name associated.
        :param pulumi.Input[builtins.str] operator_control_id: The OCID of the operator control that is being assigned to a target resource.
        :param pulumi.Input[builtins.str] remote_syslog_server_address: (Updatable) The address of the remote syslog server where the audit logs will be forwarded to. Address in host or IP format.
        :param pulumi.Input[builtins.str] remote_syslog_server_ca_cert: (Updatable) The CA certificate of the remote syslog server. Identity of the remote syslog server will be asserted based on this certificate.
        :param pulumi.Input[builtins.int] remote_syslog_server_port: (Updatable) The listening port of the remote syslog server. The port range is 0 - 65535. Only TCP supported.
        ...
        :param pulumi.Input[builtins.str] resource_name: Name of the target resource.
        :param pulumi.Input[builtins.str] resource_type: Type of the target resource.
        :param pulumi.Input[builtins.str] state: The current lifcycle state of the OperatorControl.
        :param pulumi.Input[builtins.str] time_assignment_from: (Updatable) The time at which the target resource will be brought under the governance of the operator control in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: '2020-05-22T21:10:29.600Z'
        :param pulumi.Input[builtins.str] time_assignment_to: (Updatable) The time at which the target resource will leave the governance of the operator control in [RFC 3339](https://tools.ietf.org/html/rfc3339)timestamp format.Example: '2020-05-22T21:10:29.600Z'
        :param pulumi.Input[builtins.str] time_of_assignment: Time when the operator control assignment is created in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: '2020-05-22T21:10:29.600Z'
        :param pulumi.Input[builtins.str] time_of_deletion: Time on which the operator control assignment was deleted in [RFC 3339](https://tools.ietf.org/html/rfc3339)timestamp format.Example: '2020-05-22T21:10:29.600Z'
        :param pulumi.Input[builtins.str] unassigner_id: User id who released the operatorControl.
        :param pulumi.Input[builtins.int] validate_assignment_trigger: (Updatable) An optional property when incremented triggers Validate Assignment. Could be set to any integer value.
    ...
    def assigner_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @assigner_id.setter
    def assigner_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def detachment_description(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def detachment_description(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_default_assignment(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_default_assignment(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_default_assignment", value)

    @property
    @pulumi.getter(name="isEnforcedAlways")
    def is_enforced_always(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) If set, then the target resource is always governed by the operator control.
        """
        return pulumi.get(self, "is_enforced_always")
    ...
    @is_enforced_always.setter
    def is_enforced_always(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_enforced_always", value)
    ...
    def op_control_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def op_control_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "op_control_name", value)

    @property
    @pulumi.getter(name="operatorControlId")
    def operator_control_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The OCID of the operator control that is being assigned to a target resource.
        """
        return pulumi.get(self, "operator_control_id")
    ...
    @operator_control_id.setter
    def operator_control_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "operator_control_id", value)
    ...
    def time_of_assignment(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_of_assignment(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def unassigner_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def unassigner_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class OperatorControlAssignment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        :param pulumi.Input[builtins.str] resource_compartment_id: The OCID of the compartment that contains the target resource.
        :param pulumi.Input[builtins.str] resource_id: The OCID of the target resource being brought under the governance of the operator control.
        :param pulumi.Input[builtins.str] resource_name_: Name of the target resource.
        :param pulumi.Input[builtins.str] resource_type: Type of the target resource.
        :param pulumi.Input[builtins.str] time_assignment_from: (Updatable) The time at which the target resource will be brought under the governance of the operator control in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: '2020-05-22T21:10:29.600Z'
        :param pulumi.Input[builtins.str] time_assignment_to: (Updatable) The time at which the target resource will leave the governance of the operator control in [RFC 3339](https://tools.ietf.org/html/rfc3339)timestamp format.Example: '2020-05-22T21:10:29.600Z'
        :param pulumi.Input[builtins.int] validate_assignment_trigger: (Updatable) An optional property when incremented triggers Validate Assignment. Could be set to any integer value.
    ...
    def get(resource_name: str,
            ...
            time_of_deletion: Optional[pulumi.Input[builtins.str]] = None,
            unassigner_id: Optional[pulumi.Input[builtins.str]] = None,
            validate_assignment_trigger: Optional[pulumi.Input[builtins.int]] = None) -> 'OperatorControlAssignment':
        """
    ...
    @property
    @pulumi.getter(name="assignerId")
    def assigner_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the user who created this operator control assignment.
        """
        return pulumi.get(self, "assigner_id")
    ...
    @property
    @pulumi.getter(name="detachmentDescription")
    def detachment_description(self) -> pulumi.Output[builtins.str]:
        """
        description containing reason for releasing of OperatorControl.
        """
        return pulumi.get(self, "detachment_description")
    ...
    @property
    @pulumi.getter(name="errorCode")
    def error_code(self) -> pulumi.Output[builtins.int]:
        """
        The code identifying the error occurred during Assignment operation.
        """
        return pulumi.get(self, "error_code")
    ...
    @property
    @pulumi.getter(name="isDefaultAssignment")
    def is_default_assignment(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the assignment is a default assignment.
        """
        return pulumi.get(self, "is_default_assignment")
    ...
    @property
    @pulumi.getter(name="isEnforcedAlways")
    def is_enforced_always(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) If set, then the target resource is always governed by the operator control.
        """
        return pulumi.get(self, "is_enforced_always")
    ...
    @property
    @pulumi.getter(name="isHypervisorLogForwarded")
    def is_hypervisor_log_forwarded(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) If set, then the hypervisor audit logs will be forwarded to the relevant remote syslog server
        """
        return pulumi.get(self, "is_hypervisor_log_forwarded")
    ...
    @property
    @pulumi.getter(name="isLogForwarded")
    def is_log_forwarded(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) If set, then the audit logs will be forwarded to the relevant remote logging server
        """
        return pulumi.get(self, "is_log_forwarded")
    ...
    @property
    @pulumi.getter(name="opControlName")
    def op_control_name(self) -> pulumi.Output[builtins.str]:
        """
        Name of the operator control name associated.
        """
        return pulumi.get(self, "op_control_name")
    ...
    @property
    @pulumi.getter(name="operatorControlId")
    def operator_control_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the operator control that is being assigned to a target resource.
        """
        return pulumi.get(self, "operator_control_id")
    ...
    @property
    @pulumi.getter(name="remoteSyslogServerAddress")
    def remote_syslog_server_address(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The address of the remote syslog server where the audit logs will be forwarded to. Address in host or IP format.
        """
        return pulumi.get(self, "remote_syslog_server_address")
    ...
    @property
    @pulumi.getter(name="remoteSyslogServerCaCert")
    def remote_syslog_server_ca_cert(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The CA certificate of the remote syslog server. Identity of the remote syslog server will be asserted based on this certificate.
        """
        return pulumi.get(self, "remote_syslog_server_ca_cert")
    ...
    @property
    @pulumi.getter(name="remoteSyslogServerPort")
    def remote_syslog_server_port(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The listening port of the remote syslog server. The port range is 0 - 65535. Only TCP supported.
        """
        return pulumi.get(self, "remote_syslog_server_port")
    ...
    @property
    @pulumi.getter(name="resourceCompartmentId")
    def resource_compartment_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the compartment that contains the target resource.
        """
        return pulumi.get(self, "resource_compartment_id")
    ...
    @property
    @pulumi.getter(name="timeAssignmentFrom")
    def time_assignment_from(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The time at which the target resource will be brought under the governance of the operator control in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: '2020-05-22T21:10:29.600Z'
        """
        return pulumi.get(self, "time_assignment_from")
    ...
    @property
    @pulumi.getter(name="timeAssignmentTo")
    def time_assignment_to(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The time at which the target resource will leave the governance of the operator control in [RFC 3339](https://tools.ietf.org/html/rfc3339)timestamp format.Example: '2020-05-22T21:10:29.600Z'
        """
        return pulumi.get(self, "time_assignment_to")
    ...
    @property
    @pulumi.getter(name="timeOfAssignment")
    def time_of_assignment(self) -> pulumi.Output[builtins.str]:
        """
        Time when the operator control assignment is created in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: '2020-05-22T21:10:29.600Z'
        """
        return pulumi.get(self, "time_of_assignment")
    ...
    @property
    @pulumi.getter(name="unassignerId")
    def unassigner_id(self) -> pulumi.Output[builtins.str]:
        """
        User id who released the operatorControl.
        """
        return pulumi.get(self, "unassigner_id")
    ...
    @property
    @pulumi.getter(name="validateAssignmentTrigger")
    def validate_assignment_trigger(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        (Updatable) An optional property when incremented triggers Validate Assignment. Could be set to any integer value.
