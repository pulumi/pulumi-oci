...
class GetAccessRequestApproverDetailResult(dict):
    def __init__(__self__, *,
                 ...
                 approval_additional_message: _builtins.str,
        ...
        :param _builtins.str approval_additional_message: Additional message specified by the approver of the request.
        ...
        :param _builtins.str time_approved_for_access: Time for when the access request should start that is authorized by the customer in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.Example: '2020-05-22T21:10:29.600Z'
        :param _builtins.str time_of_authorization: Time when the access request was authorized by the customer in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.Example: '2020-05-22T21:10:29.600Z'
        """
    ...
    def approval_additional_message(self) -> _builtins.str:
        """
...
class GetAccessRequestHistoryItemResult(dict):
    def __init__(__self__, *,
                 actions_lists: Sequence[_builtins.str],
        ...
        """
        :param Sequence[_builtins.str] actions_lists: List of operator actions for which approvals were requested by the operator.
        :param _builtins.str description: Reason or description about the cause of change.
        :param _builtins.int duration: Duration for approval of request or extension depending on the type of action.
        :param _builtins.bool is_auto_approved: Whether the access request was automatically approved.
        :param _builtins.str state: The current state of the AccessRequest.
        :param _builtins.str time_of_action: Time when the respective action happened in [RFC 3339](https://tools.ietf.org/html/rfc3339)timestamp format. Example: '2020-05-22T21:10:29.600Z'
        :param _builtins.str user_id: Approver who modified the access request.
        """
    ...
    def actions_lists(self) -> Sequence[_builtins.str]:
        """
...
class GetAccessRequestsAccessRequestCollectionItemResult(dict):
    def __init__(__self__, *,
                 access_reason_summary: _builtins.str,
                 action_requests_lists: Sequence[_builtins.str],
                 ...
                 id: _builtins.str,
                 is_auto_approved: _builtins.bool,
                 is_validate_assignment: _builtins.bool,
                 lifecycle_details: _builtins.str,
                 number_of_approvers: _builtins.int,
                 number_of_approvers_required: _builtins.int,
                 number_of_extension_approvers: _builtins.int,
                 opctl_additional_message: _builtins.str,
                 opctl_id: _builtins.str,
                 opctl_name: _builtins.str,
                 ...
                 state: _builtins.str,
                 sub_resource_lists: Sequence[_builtins.str],
                 system_message: _builtins.str,
                 time_of_creation: _builtins.str,
                 time_of_modification: _builtins.str,
                 time_of_user_creation: _builtins.str,
                 time_requested_for_future_access: _builtins.str,
                 user_id: _builtins.str,
                 workflow_ids: Sequence[_builtins.str]):
        """
        :param _builtins.str access_reason_summary: Summary comment by the operator creating the access request.
        :param Sequence[_builtins.str] action_requests_lists: List of operator actions for which approval is sought by the operator user.
        :param _builtins.str approver_comment: The last recent Comment entered by the approver of the request.
        ...
        :param Sequence[_builtins.str] audit_types: Specifies the type of auditing to be enabled. There are two levels of auditing: command-level and keystroke-level.  By default, auditing is enabled at the command level i.e., each command issued by the operator is audited. When keystroke-level is chosen,  in addition to command level logging, key strokes are also logged.
        :param _builtins.str closure_comment: The comment entered by the operator while closing the request.
        :param _builtins.str compartment_id: The ID of the compartment in which to list resources.
        :param Mapping[str, _builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace.
        :param _builtins.int duration: Duration in hours for which access is sought on the target resource.
        :param _builtins.int extend_duration: Duration in hours for which extension access is sought on the target resource.
        ...
        :param Mapping[str, _builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.
        :param _builtins.str id: The OCID of the access request.
        :param _builtins.bool is_auto_approved: Whether the access request was automatically approved.
        :param _builtins.bool is_validate_assignment: Whether the access request was requested for Validate Assignment.
        :param _builtins.str lifecycle_details: more in detail about the lifeCycleState.
        :param _builtins.int number_of_approvers: Number of approvers who have authorized an access request.
        :param _builtins.int number_of_approvers_required: Number of approvers required to approve an access request.
        :param _builtins.int number_of_extension_approvers: Number of approvers who have authorized an access request for extension.
        :param _builtins.str opctl_additional_message: Additional message specific to the access request that can be specified by the approver at the time of approval.
        :param _builtins.str opctl_id: The OCID of the operator control governing the target resource.
        :param _builtins.str opctl_name: Name of the Operator control governing the target resource.
        :param _builtins.str operator_id: A unique identifier associated with the operator who raised the request. This identifier can not be used directly to identify the operator. You need to provide this identifier if you would like Oracle to provide additional information about the operator action within Oracle tenancy.
        :param _builtins.str reason: Summary reason for which the operator is requesting access on the target resource.
        ...
        :param _builtins.str resource_id: The OCID of the target resource associated with the access request. The operator raises an access request to get approval to  access the target resource.
        ...
        :param Sequence[_builtins.str] sub_resource_lists: The subresources requested for approval.
        :param _builtins.str system_message: System message that will be displayed to the operator at login to the target resource.
        :param _builtins.str time_of_creation: Time when the access request was created in [RFC 3339](https://tools.ietf.org/html/rfc3339)timestamp format. Example: '2020-05-22T21:10:29.600Z'
        :param _builtins.str time_of_modification: Time when the access request was last modified in [RFC 3339](https://tools.ietf.org/html/rfc3339)timestamp format. Example: '2020-05-22T21:10:29.600Z'
        :param _builtins.str time_of_user_creation: The time when access request is scheduled to be approved in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.Example: '2020-05-22T21:10:29.600Z'
        :param _builtins.str time_requested_for_future_access: Time in future when the user for the access request needs to be created in [RFC 3339](https://tools.ietf.org/html/rfc3339)timestamp format. Example: '2020-05-22T21:10:29.600Z'
        :param _builtins.str user_id: The OCID of the user that last modified the access request.
        :param Sequence[_builtins.str] workflow_ids: The OCID of the workflow associated with the access request. This is needed if you want to contact Oracle Support for a stuck access request or for an access request that encounters an internal error.
        """
...
class GetActionsOperatorActionCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param _builtins.str component: Name of the infrastructure layer associated with the operator action.
        :param _builtins.str customer_display_name: Display Name of the operator action.
        :param _builtins.str description: Description of the operator action in terms of associated risk profile, and characteristics of the operating system commands made available to the operator under this operator action.
        :param _builtins.str id: Unique Oracle assigned identifier for the operator action.
        :param _builtins.str name: A filter to return only resources that match the entire display name given.
...
class GetControlAssignmentsOperatorControlAssignmentCollectionItemResult(dict):
    def __init__(__self__, *,
                 assigner_id: _builtins.str,
                 comment: _builtins.str,
                 compartment_id: _builtins.str,
                 defined_tags: Mapping[str, _builtins.str],
                 detachment_description: _builtins.str,
                 error_code: _builtins.int,
                 error_message: _builtins.str,
                 freeform_tags: Mapping[str, _builtins.str],
                 id: _builtins.str,
                 is_auto_approve_during_maintenance: _builtins.bool,
                 is_default_assignment: _builtins.bool,
                 is_enforced_always: _builtins.bool,
                 is_hypervisor_log_forwarded: _builtins.bool,
                 is_log_forwarded: _builtins.bool,
                 lifecycle_details: _builtins.str,
                 op_control_name: _builtins.str,
                 operator_control_id: _builtins.str,
                 remote_syslog_server_address: _builtins.str,
                 remote_syslog_server_ca_cert: _builtins.str,
                 remote_syslog_server_port: _builtins.int,
                 resource_compartment_id: _builtins.str,
                 resource_id: _builtins.str,
                 resource_name: _builtins.str,
                 resource_type: _builtins.str,
                 state: _builtins.str,
                 time_assignment_from: _builtins.str,
                 time_assignment_to: _builtins.str,
                 time_of_assignment: _builtins.str,
                 time_of_deletion: _builtins.str,
                 unassigner_id: _builtins.str,
                 validate_assignment_trigger: _builtins.int):
        """
        :param _builtins.str assigner_id: The OCID of the user who created this operator control assignment.
        :param _builtins.str comment: Comment about the assignment of the operator control to this target resource.
        :param _builtins.str compartment_id: The ID of the compartment in which to list resources.
        :param Mapping[str, _builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace.
        :param _builtins.str detachment_description: description containing reason for releasing of OperatorControl.
        :param _builtins.int error_code: The code identifying the error occurred during Assignment operation.
        :param _builtins.str error_message: The message describing the error occurred during Assignment operation.
        :param Mapping[str, _builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.
        :param _builtins.str id: The OCID of the operator control assignment.
        :param _builtins.bool is_auto_approve_during_maintenance: The boolean if true would autoApprove during maintenance.
        :param _builtins.bool is_default_assignment: Whether the assignment is a default assignment.
        :param _builtins.bool is_enforced_always: If set, then the target resource is always governed by the operator control.
        :param _builtins.bool is_hypervisor_log_forwarded: If set, then the hypervisor audit logs will be forwarded to the relevant remote syslog server
        :param _builtins.bool is_log_forwarded: If set indicates that the audit logs are being forwarded to the relevant remote logging server
        :param _builtins.str lifecycle_details: More in detail about the lifeCycleState.
        :param _builtins.str op_control_name: Name of the operator control name associated.
        :param _builtins.str operator_control_id: The OCID of the operator control.
        :param _builtins.str remote_syslog_server_address: The address of the remote syslog server where the audit logs are being forwarded to. Address in host or IP format.
        :param _builtins.str remote_syslog_server_ca_cert: The CA certificate of the remote syslog server.
        :param _builtins.int remote_syslog_server_port: The listening port of the remote syslog server. The port range is 0 - 65535. Only TCP supported.
        :param _builtins.str resource_compartment_id: The OCID of the compartment that contains the target resource.
        :param _builtins.str resource_id: The OCID of the target resource.
        :param _builtins.str resource_name: A filter to return only resources that match the given ResourceName.
        :param _builtins.str resource_type: A filter to return only lists of resources that match the entire given service type.
        ...
        :param _builtins.str time_assignment_from: The time at which the target resource will be brought under the governance of the operator control expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.  Example: '2020-05-22T21:10:29.600Z'
        :param _builtins.str time_assignment_to: The time at which the target resource will leave the governance of the operator control expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: '2020-05-22T21:10:29.600Z'
        :param _builtins.str time_of_assignment: Time when the operator control assignment is created in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: '2020-05-22T21:10:29.600Z'
        :param _builtins.str time_of_deletion: Time on which the operator control assignment was deleted in [RFC 3339](https://tools.ietf.org/html/rfc3339)timestamp format.Example: '2020-05-22T21:10:29.600Z'
        :param _builtins.str unassigner_id: User id who released the operatorControl.
        """
...
class GetControlsOperatorControlCollectionItemResult(dict):
    def __init__(__self__, *,
                 approval_required_op_action_lists: Sequence[_builtins.str],
                 approver_groups_lists: Sequence[_builtins.str],
                 approvers_lists: Sequence[_builtins.str],
                 compartment_id: _builtins.str,
                 defined_tags: Mapping[str, _builtins.str],
                 description: _builtins.str,
                 email_id_lists: Sequence[_builtins.str],
                 freeform_tags: Mapping[str, _builtins.str],
                 id: _builtins.str,
                 ...
                 time_of_modification: _builtins.str):
        """
        :param Sequence[_builtins.str] approval_required_op_action_lists: List of operator actions that need explicit approval. Any operator action not in the pre-approved list will require explicit approval. Access requests associated with a resource governed by this operator control will be require explicit approval if the access request contains any operator action in this list.
        :param Sequence[_builtins.str] approver_groups_lists: List of user groups who can approve an access request associated with a target resource under the governance of this operator control.
        :param Sequence[_builtins.str] approvers_lists: List of users who can approve an access request associated with a target resource under the governance of this operator control.
        :param _builtins.str compartment_id: The ID of the compartment in which to list resources.
        :param Mapping[str, _builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace.
        :param _builtins.str description: Description of operator control.
        :param Sequence[_builtins.str] email_id_lists: List of emailId.
        :param Mapping[str, _builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only.
        :param _builtins.str id: The OCID of the operator control.
        ...
        :param _builtins.str system_message: System message that would be displayed to the operator users on accessing the target resource under the governance of this operator control.
        :param _builtins.str time_of_creation: Time when the operator control was created expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: '2020-05-22T21:10:29.600Z'
        :param _builtins.str time_of_deletion: Time when deleted expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339)timestamp format. Example: '2020-05-22T21:10:29.600Z'. Note a deleted operator control still stays in the system, so that you can still audit operator actions associated with access requests raised on target resources governed by the deleted operator control.
        :param _builtins.str time_of_modification: Time when the operator control was last modified expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: '2020-05-22T21:10:29.600Z'
        """
