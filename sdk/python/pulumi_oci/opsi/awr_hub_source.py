...
class AwrHubSourceArgs:
    def __init__(__self__, *,
                 awr_hub_id: pulumi.Input[builtins.str],
                 compartment_id: pulumi.Input[builtins.str],
                 type: pulumi.Input[builtins.str],
                 associated_opsi_id: Optional[pulumi.Input[builtins.str]] = None,
                 associated_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a AwrHubSource resource.
        :param pulumi.Input[builtins.str] awr_hub_id: AWR Hub OCID
        ...
        :param pulumi.Input[builtins.str] type: (Updatable) source type of the database
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] associated_opsi_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the database id.
        :param pulumi.Input[builtins.str] associated_resource_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the database id.
        ...
        :param pulumi.Input[builtins.str] name: The name of the Awr Hub source database.
        """
    ...
    def awr_hub_id(self) -> pulumi.Input[builtins.str]:
        """
        AWR Hub OCID
        """
    ...
    @awr_hub_id.setter
    def awr_hub_id(self, value: pulumi.Input[builtins.str]):
    ...
    def associated_opsi_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def associated_opsi_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "associated_opsi_id", value)

    @property
    @pulumi.getter(name="associatedResourceId")
    def associated_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the database id.
        """
    ...
    def associated_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _AwrHubSourceState:
    def __init__(__self__, *,
                 associated_opsi_id: Optional[pulumi.Input[builtins.str]] = None,
                 associated_resource_id: Optional[pulumi.Input[builtins.str]] = None,
                 awr_hub_id: Optional[pulumi.Input[builtins.str]] = None,
                 awr_hub_opsi_source_id: Optional[pulumi.Input[builtins.str]] = None,
                 awr_source_database_id: Optional[pulumi.Input[builtins.str]] = None,
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 hours_since_last_import: Optional[pulumi.Input[builtins.float]] = None,
                 is_registered_with_awr_hub: Optional[pulumi.Input[builtins.bool]] = None,
                 max_snapshot_identifier: Optional[pulumi.Input[builtins.float]] = None,
                 min_snapshot_identifier: Optional[pulumi.Input[builtins.float]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 source_mail_box_url: Optional[pulumi.Input[builtins.str]] = None,
                 state: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 time_created: Optional[pulumi.Input[builtins.str]] = None,
                 time_first_snapshot_generated: Optional[pulumi.Input[builtins.str]] = None,
                 time_last_snapshot_generated: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] associated_resource_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the database id.
        :param pulumi.Input[builtins.str] awr_hub_id: AWR Hub OCID
        :param pulumi.Input[builtins.str] awr_hub_opsi_source_id: The shorted string of the Awr Hub source database identifier.
        :param pulumi.Input[builtins.str] awr_source_database_id: DatabaseId of the Source database for which AWR Data will be uploaded to AWR Hub.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.float] hours_since_last_import: Number of hours since last AWR snapshots import happened from the Source database.
        :param pulumi.Input[builtins.bool] is_registered_with_awr_hub: This is `true` if the source databse is registered with a Awr Hub, otherwise `false`
        :param pulumi.Input[builtins.float] max_snapshot_identifier: The maximum snapshot identifier of the source database for which AWR data is uploaded to AWR Hub.
        :param pulumi.Input[builtins.float] min_snapshot_identifier: The minimum snapshot identifier of the source database for which AWR data is uploaded to AWR Hub.
        :param pulumi.Input[builtins.str] name: The name of the Awr Hub source database.
        :param pulumi.Input[builtins.str] source_mail_box_url: Opsi Mailbox URL based on the Awr Hub and Awr Hub source.
        :param pulumi.Input[builtins.str] state: the current state of the source database
        :param pulumi.Input[builtins.str] status: Indicates the status of a source database in Operations Insights
        ...
        :param pulumi.Input[builtins.str] time_first_snapshot_generated: The time at which the earliest snapshot was generated in the source database for which data is uploaded to AWR Hub. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.str] time_last_snapshot_generated: The time at which the latest snapshot was generated in the source database for which data is uploaded to AWR Hub. An RFC3339 formatted datetime string
    ...
    @property
    @pulumi.getter(name="awrHubId")
    def awr_hub_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        AWR Hub OCID
        """
        return pulumi.get(self, "awr_hub_id")
    ...
    @awr_hub_id.setter
    def awr_hub_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "awr_hub_id", value)

    @property
    @pulumi.getter(name="awrHubOpsiSourceId")
    def awr_hub_opsi_source_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def awr_hub_opsi_source_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "awr_hub_opsi_source_id", value)

    @property
    @pulumi.getter(name="awrSourceDatabaseId")
    def awr_source_database_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def awr_source_database_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def hours_since_last_import(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def hours_since_last_import(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "hours_since_last_import", value)

    @property
    @pulumi.getter(name="isRegisteredWithAwrHub")
    def is_registered_with_awr_hub(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_registered_with_awr_hub(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_registered_with_awr_hub", value)

    @property
    @pulumi.getter(name="maxSnapshotIdentifier")
    def max_snapshot_identifier(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def max_snapshot_identifier(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "max_snapshot_identifier", value)

    @property
    @pulumi.getter(name="minSnapshotIdentifier")
    def min_snapshot_identifier(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def min_snapshot_identifier(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    def source_mail_box_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def source_mail_box_url(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_first_snapshot_generated(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_first_snapshot_generated(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_first_snapshot_generated", value)

    @property
    @pulumi.getter(name="timeLastSnapshotGenerated")
    def time_last_snapshot_generated(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_last_snapshot_generated(self, value: Optional[pulumi.Input[builtins.str]]):
...
class AwrHubSource(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_last_snapshot_generated: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'AwrHubSource':
        """
    ...
    @property
    @pulumi.getter(name="associatedOpsiId")
    def associated_opsi_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the database id.
        """
        return pulumi.get(self, "associated_opsi_id")
    ...
    @property
    @pulumi.getter(name="associatedResourceId")
    def associated_resource_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the database id.
        """
        return pulumi.get(self, "associated_resource_id")
    ...
    @property
    @pulumi.getter(name="awrHubId")
    def awr_hub_id(self) -> pulumi.Output[builtins.str]:
        """
        AWR Hub OCID
        """
        return pulumi.get(self, "awr_hub_id")
    ...
    @property
    @pulumi.getter(name="awrHubOpsiSourceId")
    def awr_hub_opsi_source_id(self) -> pulumi.Output[builtins.str]:
        """
        The shorted string of the Awr Hub source database identifier.
        """
        return pulumi.get(self, "awr_hub_opsi_source_id")
    ...
    @property
    @pulumi.getter(name="awrSourceDatabaseId")
    def awr_source_database_id(self) -> pulumi.Output[builtins.str]:
        """
        DatabaseId of the Source database for which AWR Data will be uploaded to AWR Hub.
        """
        return pulumi.get(self, "awr_source_database_id")
    ...
    @property
    @pulumi.getter(name="hoursSinceLastImport")
    def hours_since_last_import(self) -> pulumi.Output[builtins.float]:
        """
        Number of hours since last AWR snapshots import happened from the Source database.
        """
        return pulumi.get(self, "hours_since_last_import")
    ...
    @property
    @pulumi.getter(name="isRegisteredWithAwrHub")
    def is_registered_with_awr_hub(self) -> pulumi.Output[builtins.bool]:
        """
        This is `true` if the source databse is registered with a Awr Hub, otherwise `false`
        """
        return pulumi.get(self, "is_registered_with_awr_hub")
    ...
    @property
    @pulumi.getter(name="maxSnapshotIdentifier")
    def max_snapshot_identifier(self) -> pulumi.Output[builtins.float]:
        """
        The maximum snapshot identifier of the source database for which AWR data is uploaded to AWR Hub.
        """
        return pulumi.get(self, "max_snapshot_identifier")
    ...
    @property
    @pulumi.getter(name="minSnapshotIdentifier")
    def min_snapshot_identifier(self) -> pulumi.Output[builtins.float]:
        """
        The minimum snapshot identifier of the source database for which AWR data is uploaded to AWR Hub.
        """
        return pulumi.get(self, "min_snapshot_identifier")
    ...
    @property
    @pulumi.getter(name="sourceMailBoxUrl")
    def source_mail_box_url(self) -> pulumi.Output[builtins.str]:
        """
        Opsi Mailbox URL based on the Awr Hub and Awr Hub source.
        """
        return pulumi.get(self, "source_mail_box_url")
    ...
    @property
    @pulumi.getter(name="timeFirstSnapshotGenerated")
    def time_first_snapshot_generated(self) -> pulumi.Output[builtins.str]:
        """
        The time at which the earliest snapshot was generated in the source database for which data is uploaded to AWR Hub. An RFC3339 formatted datetime string
        """
        return pulumi.get(self, "time_first_snapshot_generated")
    ...
    @property
    @pulumi.getter(name="timeLastSnapshotGenerated")
    def time_last_snapshot_generated(self) -> pulumi.Output[builtins.str]:
        """
        The time at which the latest snapshot was generated in the source database for which data is uploaded to AWR Hub. An RFC3339 formatted datetime string
        """
        return pulumi.get(self, "time_last_snapshot_generated")
