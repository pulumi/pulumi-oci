...
class AwrHubSourceAwrhubsourcesManagementArgs:
    def __init__(__self__, *,
                 awr_hub_source_id: pulumi.Input[_builtins.str],
    ...
    def awr_hub_source_id(self) -> pulumi.Input[_builtins.str]:
        """
    ...
    def awr_hub_source_id(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "awr_hub_source_id", value)

    @_builtins.property
    @pulumi.getter(name="enableAwrhubsource")
    def enable_awrhubsource(self) -> pulumi.Input[_builtins.bool]:
        """
    ...
    def enable_awrhubsource(self, value: pulumi.Input[_builtins.bool]):
...
class AwrHubSourceAwrhubsourcesManagement(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="awrHubSourceId")
    def awr_hub_source_id(self) -> pulumi.Output[_builtins.str]:
        """
        Unique Awr Hub Source identifier
        """
        return pulumi.get(self, "awr_hub_source_id")
