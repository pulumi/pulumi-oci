...
class DatabaseInsightArgs:
    def __init__(__self__, *,
                 ...
                 database_connection_status_details: Optional[pulumi.Input[builtins.str]] = None,
                 database_connector_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] entity_source: (Updatable) Source of the database entity.
        ...
        :param pulumi.Input[builtins.str] connector_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of External Database Connector
        ...
        :param pulumi.Input[builtins.str] database_connection_status_details: A message describing the status of the database connection of this resource. For example, it can be used to provide actionable information about the permission and content validity of the database connection.
        :param pulumi.Input[builtins.str] database_connector_id: (Updatable) The DBM owned database connector [OCID](https://www.terraform.io/iaas/database-management/doc/view-connector-details.html) mapping to the database credentials and connection details.
        ...
        :param pulumi.Input[builtins.bool] is_advanced_features_enabled: Flag is to identify if advanced features for autonomous database is enabled or not
    ...
    def database_connection_status_details(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def database_connection_status_details(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "database_connection_status_details", value)

    @property
    @pulumi.getter(name="databaseConnectorId")
    def database_connector_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def database_connector_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _DatabaseInsightState:
    def __init__(__self__, *,
                 ...
                 database_connection_status_details: Optional[pulumi.Input[builtins.str]] = None,
                 database_connector_id: Optional[pulumi.Input[builtins.str]] = None,
                 database_display_name: Optional[pulumi.Input[builtins.str]] = None,
                 database_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_advanced_features_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_heat_wave_cluster_attached: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 root_id: Optional[pulumi.Input[builtins.str]] = None,
                 service_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] database_connection_status_details: A message describing the status of the database connection of this resource. For example, it can be used to provide actionable information about the permission and content validity of the database connection.
        :param pulumi.Input[builtins.str] database_connector_id: (Updatable) The DBM owned database connector [OCID](https://www.terraform.io/iaas/database-management/doc/view-connector-details.html) mapping to the database credentials and connection details.
        :param pulumi.Input[builtins.str] database_display_name: Display name of database
        :param pulumi.Input[builtins.str] database_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the database.
        :param pulumi.Input[builtins.str] database_name: Name of database
        :param pulumi.Input[builtins.str] database_resource_type: Oracle Cloud Infrastructure database resource type
        :param pulumi.Input[builtins.str] database_type: Ops Insights internal representation of the database type.
        :param pulumi.Input[builtins.str] database_version: The version of the database.
        :param pulumi.Input[builtins.str] dbm_private_endpoint_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Database Management private endpoint. This field and opsi_private_endpoint_id are mutually exclusive. If DBM private endpoint ID is provided, a new OPSI private endpoint ID will be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[builtins.str] deployment_type: Database Deployment Type (EXACS will be supported in the future)
        :param pulumi.Input[builtins.str] enterprise_manager_bridge_id: OPSI Enterprise Manager Bridge OCID
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.bool] is_advanced_features_enabled: Flag is to identify if advanced features for autonomous database is enabled or not
        :param pulumi.Input[builtins.bool] is_heat_wave_cluster_attached: Specifies if MYSQL DB System has heatwave cluster attached.
        :param pulumi.Input[builtins.bool] is_highly_available: Specifies if MYSQL DB System is highly available.
        ...
        :param pulumi.Input[builtins.str] management_agent_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Management Agent
        :param pulumi.Input[builtins.str] opsi_private_endpoint_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the OPSI private endpoint
        :param pulumi.Input[builtins.str] parent_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VM Cluster or DB System ID, depending on which configuration the resource belongs to.
        :param pulumi.Input[builtins.int] processor_count: Processor count. This is the OCPU count for Autonomous Database and CPU core count for other database types.
        :param pulumi.Input[builtins.str] root_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata Infrastructure.
        :param pulumi.Input[builtins.str] service_name: Database service name used for connection requests.
        ...
        :param pulumi.Input[builtins.str] time_created: The time the database insight was first enabled. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.str] time_updated: The time the database insight was updated. An RFC3339 formatted datetime string
        """
    ...
    def database_display_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def database_display_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_heat_wave_cluster_attached(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_heat_wave_cluster_attached(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def root_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @root_id.setter
    def root_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class DatabaseInsight(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'DatabaseInsight':
        """
    ...
    @property
    @pulumi.getter(name="databaseConnectionStatusDetails")
    def database_connection_status_details(self) -> pulumi.Output[builtins.str]:
        """
        A message describing the status of the database connection of this resource. For example, it can be used to provide actionable information about the permission and content validity of the database connection.
        """
        return pulumi.get(self, "database_connection_status_details")
    ...
    @property
    @pulumi.getter(name="databaseConnectorId")
    def database_connector_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The DBM owned database connector [OCID](https://www.terraform.io/iaas/database-management/doc/view-connector-details.html) mapping to the database credentials and connection details.
        """
        return pulumi.get(self, "database_connector_id")
    ...
    @property
    @pulumi.getter(name="databaseDisplayName")
    def database_display_name(self) -> pulumi.Output[builtins.str]:
        """
        Display name of database
        """
        return pulumi.get(self, "database_display_name")
    ...
    @property
    @pulumi.getter(name="databaseResourceType")
    def database_resource_type(self) -> pulumi.Output[builtins.str]:
        """
        Oracle Cloud Infrastructure database resource type
        """
        return pulumi.get(self, "database_resource_type")
    ...
    @property
    @pulumi.getter(name="dbmPrivateEndpointId")
    def dbm_private_endpoint_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Database Management private endpoint. This field and opsi_private_endpoint_id are mutually exclusive. If DBM private endpoint ID is provided, a new OPSI private endpoint ID will be created.
        """
        return pulumi.get(self, "dbm_private_endpoint_id")
    ...
    @property
    @pulumi.getter(name="isHeatWaveClusterAttached")
    def is_heat_wave_cluster_attached(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies if MYSQL DB System has heatwave cluster attached.
        """
        return pulumi.get(self, "is_heat_wave_cluster_attached")
    ...
    @property
    @pulumi.getter(name="isHighlyAvailable")
    def is_highly_available(self) -> pulumi.Output[builtins.bool]:
        """
        Specifies if MYSQL DB System is highly available.
        """
        return pulumi.get(self, "is_highly_available")
    ...
    @property
    @pulumi.getter(name="managementAgentId")
    def management_agent_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Management Agent
        """
        return pulumi.get(self, "management_agent_id")
    ...
    @property
    @pulumi.getter(name="opsiPrivateEndpointId")
    def opsi_private_endpoint_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the OPSI private endpoint
        """
        return pulumi.get(self, "opsi_private_endpoint_id")
    ...
    @property
    @pulumi.getter(name="rootId")
    def root_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata Infrastructure.
        """
        return pulumi.get(self, "root_id")
