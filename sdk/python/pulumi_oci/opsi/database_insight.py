...
class DatabaseInsightArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] connector_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of External Database Connector
        ...
        :param pulumi.Input[_builtins.str] database_connection_status_details: A message describing the status of the database connection of this resource. For example, it can be used to provide actionable information about the permission and content validity of the database connection.
        :param pulumi.Input[_builtins.str] database_connector_id: (Updatable) The DBM owned database connector [OCID](https://www.terraform.io/iaas/database-management/doc/view-connector-details.html) mapping to the database credentials and connection details.
        ...
        :param pulumi.Input[_builtins.str] exadata_insight_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata insight.
...
class _DatabaseInsightState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] database_connection_status_details: A message describing the status of the database connection of this resource. For example, it can be used to provide actionable information about the permission and content validity of the database connection.
        :param pulumi.Input[_builtins.str] database_connector_id: (Updatable) The DBM owned database connector [OCID](https://www.terraform.io/iaas/database-management/doc/view-connector-details.html) mapping to the database credentials and connection details.
        :param pulumi.Input[_builtins.str] database_display_name: Display name of database
        :param pulumi.Input[_builtins.str] database_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the database.
        :param pulumi.Input[_builtins.str] database_name: Name of database
        :param pulumi.Input[_builtins.str] database_resource_type: Oracle Cloud Infrastructure database resource type
        :param pulumi.Input[_builtins.str] database_type: Ops Insights internal representation of the database type.
        :param pulumi.Input[_builtins.str] database_version: The version of the database.
        :param pulumi.Input[_builtins.str] dbm_private_endpoint_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Database Management private endpoint. This field and opsi_private_endpoint_id are mutually exclusive. If DBM private endpoint ID is provided, a new OPSI private endpoint ID will be created.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[_builtins.str] deployment_type: Database Deployment Type (EXACS will be supported in the future)
        :param pulumi.Input[_builtins.str] enterprise_manager_bridge_id: OPSI Enterprise Manager Bridge OCID
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[_builtins.bool] is_advanced_features_enabled: Flag is to identify if advanced features for autonomous database is enabled or not
        :param pulumi.Input[_builtins.bool] is_heat_wave_cluster_attached: Specifies if MYSQL DB System has heatwave cluster attached.
        :param pulumi.Input[_builtins.bool] is_highly_available: Specifies if MYSQL DB System is highly available.
        :param pulumi.Input[_builtins.str] lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in Failed state.
        :param pulumi.Input[_builtins.str] management_agent_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Management Agent
        :param pulumi.Input[_builtins.str] opsi_private_endpoint_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the OPSI private endpoint
        :param pulumi.Input[_builtins.str] parent_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VM Cluster or DB System ID, depending on which configuration the resource belongs to.
        :param pulumi.Input[_builtins.int] processor_count: Processor count. This is the OCPU count for Autonomous Database and CPU core count for other database types.
        :param pulumi.Input[_builtins.str] root_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata Infrastructure.
        :param pulumi.Input[_builtins.str] service_name: Database service name used for connection requests.
        ...
        :param pulumi.Input[_builtins.str] status: (Updatable) Status of the resource. Example: "ENABLED", "DISABLED". Resource can be either enabled or disabled by updating the value of status field to either "ENABLED" or "DISABLED"
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values. The resource destruction here is basically a soft delete. User cannot create resource using the same EM managed bridge OCID. If resource is in enabled state during destruction, the resource will be disabled automatically before performing delete operation.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param pulumi.Input[_builtins.str] time_created: The time the database insight was first enabled. An RFC3339 formatted datetime string
        :param pulumi.Input[_builtins.str] time_updated: The time the database insight was updated. An RFC3339 formatted datetime string
        """
...
class DatabaseInsight(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                 connection_credential_details: pulumi.Input[Optional[Union['DatabaseInsightConnectionCredentialDetailsArgs', 'DatabaseInsightConnectionCredentialDetailsArgsDict', 'outputs.DatabaseInsightConnectionCredentialDetails']]] = None,
                 connection_details: pulumi.Input[Optional[Union['DatabaseInsightConnectionDetailsArgs', 'DatabaseInsightConnectionDetailsArgsDict', 'outputs.DatabaseInsightConnectionDetails']]] = None,
                 connector_id: pulumi.Input[Optional[_builtins.str]] = None,
                 credential_details: pulumi.Input[Optional[Union['DatabaseInsightCredentialDetailsArgs', 'DatabaseInsightCredentialDetailsArgsDict', 'outputs.DatabaseInsightCredentialDetails']]] = None,
                 database_connection_status_details: pulumi.Input[Optional[_builtins.str]] = None,
                 database_connector_id: pulumi.Input[Optional[_builtins.str]] = None,
                 database_id: pulumi.Input[Optional[_builtins.str]] = None,
                 database_resource_type: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[_builtins.str] compartment_id: (Updatable) Compartment Identifier of database
        :param pulumi.Input[Union['DatabaseInsightConnectionCredentialDetailsArgs', 'DatabaseInsightConnectionCredentialDetailsArgsDict', 'outputs.DatabaseInsightConnectionCredentialDetails']] connection_credential_details: User credential details to connect to the database.
        :param pulumi.Input[Union['DatabaseInsightConnectionDetailsArgs', 'DatabaseInsightConnectionDetailsArgsDict', 'outputs.DatabaseInsightConnectionDetails']] connection_details: Connection details to connect to the database. HostName, protocol, and port should be specified.
        :param pulumi.Input[_builtins.str] connector_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of External Database Connector
        :param pulumi.Input[Union['DatabaseInsightCredentialDetailsArgs', 'DatabaseInsightCredentialDetailsArgsDict', 'outputs.DatabaseInsightCredentialDetails']] credential_details: User credential details to connect to the database.
        :param pulumi.Input[_builtins.str] database_connection_status_details: A message describing the status of the database connection of this resource. For example, it can be used to provide actionable information about the permission and content validity of the database connection.
        :param pulumi.Input[_builtins.str] database_connector_id: (Updatable) The DBM owned database connector [OCID](https://www.terraform.io/iaas/database-management/doc/view-connector-details.html) mapping to the database credentials and connection details.
        :param pulumi.Input[_builtins.str] database_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the database.
        :param pulumi.Input[_builtins.str] database_resource_type: Oracle Cloud Infrastructure database resource type
    ...
    @_builtins.property
    @pulumi.getter(name="databaseConnectionStatusDetails")
    def database_connection_status_details(self) -> pulumi.Output[_builtins.str]:
        """
        A message describing the status of the database connection of this resource. For example, it can be used to provide actionable information about the permission and content validity of the database connection.
        """
        return pulumi.get(self, "database_connection_status_details")
    ...
    @_builtins.property
    @pulumi.getter(name="databaseConnectorId")
    def database_connector_id(self) -> pulumi.Output[_builtins.str]:
        """
        (Updatable) The DBM owned database connector [OCID](https://www.terraform.io/iaas/database-management/doc/view-connector-details.html) mapping to the database credentials and connection details.
        """
        return pulumi.get(self, "database_connector_id")
    ...
    @_builtins.property
    @pulumi.getter(name="databaseDisplayName")
    def database_display_name(self) -> pulumi.Output[_builtins.str]:
        """
        Display name of database
        """
        return pulumi.get(self, "database_display_name")
    ...
    @_builtins.property
    @pulumi.getter(name="databaseResourceType")
    def database_resource_type(self) -> pulumi.Output[_builtins.str]:
        """
        Oracle Cloud Infrastructure database resource type
        """
        return pulumi.get(self, "database_resource_type")
    ...
    @_builtins.property
    @pulumi.getter(name="dbmPrivateEndpointId")
    def dbm_private_endpoint_id(self) -> pulumi.Output[_builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Database Management private endpoint. This field and opsi_private_endpoint_id are mutually exclusive. If DBM private endpoint ID is provided, a new OPSI private endpoint ID will be created.
        """
        return pulumi.get(self, "dbm_private_endpoint_id")
    ...
    @_builtins.property
    @pulumi.getter(name="exadataInsightId")
    def exadata_insight_id(self) -> pulumi.Output[_builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata insight.
        """
        return pulumi.get(self, "exadata_insight_id")
    ...
    @_builtins.property
    @pulumi.getter(name="isAdvancedFeaturesEnabled")
    def is_advanced_features_enabled(self) -> pulumi.Output[_builtins.bool]:
        """
        Flag is to identify if advanced features for autonomous database is enabled or not
        """
        return pulumi.get(self, "is_advanced_features_enabled")
    ...
    @_builtins.property
    @pulumi.getter(name="opsiPrivateEndpointId")
    def opsi_private_endpoint_id(self) -> pulumi.Output[_builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the OPSI private endpoint
        """
        return pulumi.get(self, "opsi_private_endpoint_id")
    ...
    @_builtins.property
    @pulumi.getter(name="processorCount")
    def processor_count(self) -> pulumi.Output[_builtins.int]:
        """
        Processor count. This is the OCPU count for Autonomous Database and CPU core count for other database types.
        """
        return pulumi.get(self, "processor_count")
