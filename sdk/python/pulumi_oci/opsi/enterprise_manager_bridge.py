...
class EnterpriseManagerBridgeArgs:
    def __init__(__self__, *,
                 ...
                 object_storage_bucket_name: pulumi.Input[builtins.str],
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a EnterpriseManagerBridge resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) Compartment identifier of the Enterprise Manager bridge
        :param pulumi.Input[builtins.str] display_name: (Updatable) User-friedly name of Enterprise Manager Bridge that does not have to be unique.
        :param pulumi.Input[builtins.str] object_storage_bucket_name: Object Storage Bucket Name
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Description of Enterprise Manager Bridge
    ...
    def object_storage_bucket_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def object_storage_bucket_name(self, value: pulumi.Input[builtins.str]):
...
class _EnterpriseManagerBridgeState:
    def __init__(__self__, *,
                 ...
                 object_storage_bucket_name: Optional[pulumi.Input[builtins.str]] = None,
                 object_storage_bucket_status_details: Optional[pulumi.Input[builtins.str]] = None,
                 object_storage_namespace_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] object_storage_bucket_name: Object Storage Bucket Name
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] object_storage_bucket_status_details: A message describing status of the object storage bucket of this resource. For example, it can be used to provide actionable information about the permission and content validity of the bucket.
        :param pulumi.Input[builtins.str] object_storage_namespace_name: Object Storage Namespace Name
        :param pulumi.Input[builtins.str] state: The current state of the Enterprise Manager bridge.
        ...
        :param pulumi.Input[builtins.str] time_created: The time the the Enterprise Manager bridge was first created. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.str] time_updated: The time the Enterprise Manager bridge was updated. An RFC3339 formatted datetime string
        """
    ...
    @property
    @pulumi.getter(name="objectStorageBucketName")
    def object_storage_bucket_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Object Storage Bucket Name
    ...
    @object_storage_bucket_name.setter
    def object_storage_bucket_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "object_storage_bucket_name", value)

    @property
    @pulumi.getter(name="objectStorageBucketStatusDetails")
    def object_storage_bucket_status_details(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def object_storage_bucket_status_details(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "object_storage_bucket_status_details", value)

    @property
    @pulumi.getter(name="objectStorageNamespaceName")
    def object_storage_namespace_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def object_storage_namespace_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class EnterpriseManagerBridge(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'EnterpriseManagerBridge':
        """
    ...
    @property
    @pulumi.getter(name="objectStorageBucketName")
    def object_storage_bucket_name(self) -> pulumi.Output[builtins.str]:
        """
        Object Storage Bucket Name
    ...
    @property
    @pulumi.getter(name="objectStorageBucketStatusDetails")
    def object_storage_bucket_status_details(self) -> pulumi.Output[builtins.str]:
        """
        A message describing status of the object storage bucket of this resource. For example, it can be used to provide actionable information about the permission and content validity of the bucket.
        """
        return pulumi.get(self, "object_storage_bucket_status_details")
    ...
    @property
    @pulumi.getter(name="objectStorageNamespaceName")
    def object_storage_namespace_name(self) -> pulumi.Output[builtins.str]:
        """
        Object Storage Namespace Name
        """
        return pulumi.get(self, "object_storage_namespace_name")
