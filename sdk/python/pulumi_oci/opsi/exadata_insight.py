...
class ExadataInsightArgs:
    def __init__(__self__, *,
                 ...
                 exadata_infra_id: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_auto_sync_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) Compartment Identifier of Exadata insight
        ...
        :param pulumi.Input[builtins.str] exadata_infra_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata Infrastructure.
        ...
        :param pulumi.Input[builtins.bool] is_auto_sync_enabled: (Updatable) Set to true to enable automatic enablement and disablement of related targets from Enterprise Manager. New resources (e.g. Database Insights) will be placed in the same compartment as the related Exadata Insight.
    ...
    def exadata_infra_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def exadata_infra_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_auto_sync_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_auto_sync_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ExadataInsightState:
    def __init__(__self__, *,
                 ...
                 exadata_display_name: Optional[pulumi.Input[builtins.str]] = None,
                 exadata_infra_id: Optional[pulumi.Input[builtins.str]] = None,
                 exadata_infra_resource_type: Optional[pulumi.Input[builtins.str]] = None,
                 exadata_name: Optional[pulumi.Input[builtins.str]] = None,
                 exadata_rack_type: Optional[pulumi.Input[builtins.str]] = None,
                 exadata_shape: Optional[pulumi.Input[builtins.str]] = None,
                 exadata_type: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_auto_sync_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 is_virtualized_exadata: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] enterprise_manager_identifier: Enterprise Manager Unique Identifier
        :param pulumi.Input[builtins.str] entity_source: (Updatable) Source of the Exadata system.
        :param pulumi.Input[builtins.str] exadata_display_name: The user-friendly name for the Exadata system. The name does not have to be unique.
        :param pulumi.Input[builtins.str] exadata_infra_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata Infrastructure.
        :param pulumi.Input[builtins.str] exadata_name: The Exadata system name. If the Exadata systems managed by Enterprise Manager, the name is unique amongst the Exadata systems managed by the same Enterprise Manager.
        :param pulumi.Input[builtins.str] exadata_rack_type: Exadata rack type.
        :param pulumi.Input[builtins.str] exadata_type: Operations Insights internal representation of the the Exadata system type.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.bool] is_auto_sync_enabled: (Updatable) Set to true to enable automatic enablement and disablement of related targets from Enterprise Manager. New resources (e.g. Database Insights) will be placed in the same compartment as the related Exadata Insight.
        :param pulumi.Input[builtins.bool] is_virtualized_exadata: true if virtualization is used in the Exadata system
        ...
        :param pulumi.Input[builtins.str] state: The current state of the Exadata insight.
        :param pulumi.Input[builtins.str] status: (Updatable) Status of the resource. Example: "ENABLED", "DISABLED". Resource can be either enabled or disabled by updating the value of status field to either "ENABLED" or "DISABLED"
        ...
        :param pulumi.Input[builtins.str] time_created: The time the the Exadata insight was first enabled. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.str] time_updated: The time the Exadata insight was updated. An RFC3339 formatted datetime string
        """
    ...
    def exadata_display_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def exadata_display_name(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def exadata_infra_resource_type(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "exadata_infra_resource_type")

    @exadata_infra_resource_type.setter
    def exadata_infra_resource_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "exadata_infra_resource_type", value)

    @property
    @pulumi.getter(name="exadataName")
    def exadata_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @exadata_name.setter
    def exadata_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "exadata_name", value)

    @property
    @pulumi.getter(name="exadataRackType")
    def exadata_rack_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Exadata rack type.
        """
    ...
    def exadata_rack_type(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "exadata_rack_type", value)

    @property
    @pulumi.getter(name="exadataShape")
    def exadata_shape(self) -> Optional[pulumi.Input[builtins.str]]:
        return pulumi.get(self, "exadata_shape")

    @exadata_shape.setter
    def exadata_shape(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "exadata_shape", value)

    @property
    @pulumi.getter(name="exadataType")
    def exadata_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @exadata_type.setter
    def exadata_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_virtualized_exadata(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_virtualized_exadata(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class ExadataInsight(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'ExadataInsight':
        """
    ...
    @property
    @pulumi.getter(name="exadataDisplayName")
    def exadata_display_name(self) -> pulumi.Output[builtins.str]:
        """
        The user-friendly name for the Exadata system. The name does not have to be unique.
        """
        return pulumi.get(self, "exadata_display_name")
    ...
    @property
    @pulumi.getter(name="exadataInfraId")
    def exadata_infra_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Exadata Infrastructure.
        """
        return pulumi.get(self, "exadata_infra_id")
    ...
    @property
    @pulumi.getter(name="exadataInfraResourceType")
    def exadata_infra_resource_type(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "exadata_infra_resource_type")

    @property
    @pulumi.getter(name="exadataName")
    def exadata_name(self) -> pulumi.Output[builtins.str]:
        """
        The Exadata system name. If the Exadata systems managed by Enterprise Manager, the name is unique amongst the Exadata systems managed by the same Enterprise Manager.
        """
        return pulumi.get(self, "exadata_name")
    ...
    @property
    @pulumi.getter(name="exadataRackType")
    def exadata_rack_type(self) -> pulumi.Output[builtins.str]:
        """
        Exadata rack type.
        """
        return pulumi.get(self, "exadata_rack_type")
    ...
    @property
    @pulumi.getter(name="exadataShape")
    def exadata_shape(self) -> pulumi.Output[builtins.str]:
        return pulumi.get(self, "exadata_shape")

    @property
    @pulumi.getter(name="exadataType")
    def exadata_type(self) -> pulumi.Output[builtins.str]:
        """
        Operations Insights internal representation of the the Exadata system type.
        """
        return pulumi.get(self, "exadata_type")
    ...
    @property
    @pulumi.getter(name="isAutoSyncEnabled")
    def is_auto_sync_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Set to true to enable automatic enablement and disablement of related targets from Enterprise Manager. New resources (e.g. Database Insights) will be placed in the same compartment as the related Exadata Insight.
        """
        return pulumi.get(self, "is_auto_sync_enabled")
    ...
    @property
    @pulumi.getter(name="isVirtualizedExadata")
    def is_virtualized_exadata(self) -> pulumi.Output[builtins.bool]:
        """
        true if virtualization is used in the Exadata system
        """
        return pulumi.get(self, "is_virtualized_exadata")
