...
def get_awr_hub_awr_snapshots(awr_hub_id: Optional[builtins.str] = None,
...
def get_awr_hub_awr_snapshots_output(awr_hub_id: Optional[pulumi.Input[builtins.str]] = None,
