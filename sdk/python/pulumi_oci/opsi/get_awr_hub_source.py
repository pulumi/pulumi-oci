...
class GetAwrHubSourceResult:
    ...
    def awr_hub_source_id(self) -> builtins.str:
...
def get_awr_hub_source(awr_hub_source_id: Optional[builtins.str] = None,
    ...
    :param builtins.str awr_hub_source_id: Unique Awr Hub Source identifier
    """
    __args__ = dict()
...
def get_awr_hub_source_output(awr_hub_source_id: Optional[pulumi.Input[builtins.str]] = None,
