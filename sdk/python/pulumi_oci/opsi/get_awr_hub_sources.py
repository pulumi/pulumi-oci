...
class GetAwrHubSourcesResult:
    ...
    def awr_hub_source_id(self) -> Optional[builtins.str]:
...
def get_awr_hub_sources(awr_hub_id: Optional[builtins.str] = None,
                        awr_hub_source_id: Optional[builtins.str] = None,
    ...
    :param builtins.str awr_hub_source_id: Awr Hub source identifier
    ...
    :param Sequence[builtins.str] source_types: Filter by one or more database type. Possible values are ADW-S, ATP-S, ADW-D, ATP-D, EXTERNAL-PDB, EXTERNAL-NONCDB.
...
def get_awr_hub_sources_output(awr_hub_id: Optional[pulumi.Input[builtins.str]] = None,
                               awr_hub_source_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
