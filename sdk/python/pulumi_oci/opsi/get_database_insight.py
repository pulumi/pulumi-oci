...
class GetDatabaseInsightResult:
    ...
    def database_insight_id(self) -> builtins.str:
...
def get_database_insight(database_insight_id: Optional[builtins.str] = None,
    ...
    :param builtins.str database_insight_id: Unique database insight identifier
    """
    __args__ = dict()
...
def get_database_insight_output(database_insight_id: Optional[pulumi.Input[builtins.str]] = None,
