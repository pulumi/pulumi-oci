...
class GetDatabaseInsightsResult:
    ...
    def database_ids(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def database_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def exadata_insight_id(self) -> Optional[builtins.str]:
        """
...
def get_database_insights(compartment_id: Optional[builtins.str] = None,
                          compartment_id_in_subtree: Optional[builtins.bool] = None,
                          database_ids: Optional[Sequence[builtins.str]] = None,
                          database_types: Optional[Sequence[builtins.str]] = None,
                          enterprise_manager_bridge_id: Optional[builtins.str] = None,
                          exadata_insight_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] database_ids: Optional list of database [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the associated DBaaS entity.
    :param Sequence[builtins.str] database_types: Filter by one or more database type. Possible values are ADW-S, ATP-S, ADW-D, ATP-D, EXTERNAL-PDB, EXTERNAL-NONCDB.
    ...
    :param Sequence[builtins.str] fields: Specifies the fields to return in a database summary response. By default all fields are returned if omitted.
...
def get_database_insights_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 compartment_id_in_subtree: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                 database_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                 database_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                 enterprise_manager_bridge_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 exadata_insight_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 ...
                                 opsi_private_endpoint_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
