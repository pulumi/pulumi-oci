...
def get_exadata_insight(exadata_insight_id: Optional[builtins.str] = None,
    ...
    :param builtins.str exadata_insight_id: Unique Exadata insight identifier
    """
    __args__ = dict()
...
def get_exadata_insight_output(exadata_insight_id: Optional[pulumi.Input[builtins.str]] = None,
