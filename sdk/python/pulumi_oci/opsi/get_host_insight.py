...
class GetHostInsightResult:
    ...
    def host_insight_id(self) -> builtins.str:
...
def get_host_insight(host_insight_id: Optional[builtins.str] = None,
    ...
    :param builtins.str host_insight_id: Unique host insight identifier
    """
    __args__ = dict()
...
def get_host_insight_output(host_insight_id: Optional[pulumi.Input[builtins.str]] = None,
