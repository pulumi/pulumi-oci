...
class GetHostInsightsResult:
    ...
    def host_types(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_host_insights(compartment_id: Optional[builtins.str] = None,
                      ...
                      host_types: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] host_types: Filter by one or more host types. Possible values are CLOUD-HOST, EXTERNAL-HOST, COMANAGED-VM-HOST, COMANAGED-BM-HOST, COMANAGED-EXACS-HOST, COMANAGED-EXACC-HOST
...
def get_host_insights_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             ...
                             host_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
