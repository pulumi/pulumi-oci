...
def get_importable_agent_entity(compartment_id: Optional[_builtins.str] = None,
...
def get_importable_agent_entity_output(compartment_id: Optional[pulumi.Input[_builtins.str]] = None,
