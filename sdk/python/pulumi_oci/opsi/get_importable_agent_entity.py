...
def get_importable_agent_entity(compartment_id: Optional[builtins.str] = None,
...
def get_importable_agent_entity_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
