...
def get_importable_compute_entities(compartment_id: Optional[builtins.str] = None,
...
def get_importable_compute_entities_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
