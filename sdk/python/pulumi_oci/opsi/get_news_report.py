...
class GetNewsReportResult:
    ...
    def news_report_id(self) -> builtins.str:
...
def get_news_report(news_report_id: Optional[builtins.str] = None,
    ...
    :param builtins.str news_report_id: Unique news report identifier.
    """
    __args__ = dict()
...
def get_news_report_output(news_report_id: Optional[pulumi.Input[builtins.str]] = None,
