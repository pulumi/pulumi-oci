...
class GetNewsReportResult:
    ...
    def news_report_id(self) -> _builtins.str:
...
def get_news_report(news_report_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str news_report_id: Unique news report identifier.
    """
    __args__ = dict()
