...
class GetOperationsInsightsPrivateEndpointResult:
    ...
    def operations_insights_private_endpoint_id(self) -> _builtins.str:
...
def get_operations_insights_private_endpoint(operations_insights_private_endpoint_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str operations_insights_private_endpoint_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Operation Insights private endpoint.
    """
    __args__ = dict()
