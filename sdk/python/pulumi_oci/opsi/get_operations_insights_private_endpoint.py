...
class GetOperationsInsightsPrivateEndpointResult:
    ...
    def operations_insights_private_endpoint_id(self) -> builtins.str:
...
def get_operations_insights_private_endpoint(operations_insights_private_endpoint_id: Optional[builtins.str] = None,
    ...
    :param builtins.str operations_insights_private_endpoint_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Operation Insights private endpoint.
    """
    __args__ = dict()
...
def get_operations_insights_private_endpoint_output(operations_insights_private_endpoint_id: Optional[pulumi.Input[builtins.str]] = None,
