...
def get_operations_insights_warehouse(operations_insights_warehouse_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str operations_insights_warehouse_id: Unique Ops Insights Warehouse identifier
    """
    __args__ = dict()
