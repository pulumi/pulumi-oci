...
def get_operations_insights_warehouse(operations_insights_warehouse_id: Optional[builtins.str] = None,
    ...
    :param builtins.str operations_insights_warehouse_id: Unique Ops Insights Warehouse identifier
    """
    __args__ = dict()
...
def get_operations_insights_warehouse_output(operations_insights_warehouse_id: Optional[pulumi.Input[builtins.str]] = None,
