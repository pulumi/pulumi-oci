...
def get_operations_insights_warehouse_resource_usage_summary(operations_insights_warehouse_id: Optional[builtins.str] = None,
...
def get_operations_insights_warehouse_resource_usage_summary_output(operations_insights_warehouse_id: Optional[pulumi.Input[builtins.str]] = None,
