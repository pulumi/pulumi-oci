...
class GetOperationsInsightsWarehouseUserResult:
    ...
    def operations_insights_warehouse_user_id(self) -> _builtins.str:
...
def get_operations_insights_warehouse_user(operations_insights_warehouse_user_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str operations_insights_warehouse_user_id: Unique Operations Insights Warehouse User identifier
    """
    __args__ = dict()
