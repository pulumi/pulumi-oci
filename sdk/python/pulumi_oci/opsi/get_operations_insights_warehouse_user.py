...
class GetOperationsInsightsWarehouseUserResult:
    ...
    def operations_insights_warehouse_user_id(self) -> builtins.str:
...
def get_operations_insights_warehouse_user(operations_insights_warehouse_user_id: Optional[builtins.str] = None,
    ...
    :param builtins.str operations_insights_warehouse_user_id: Unique Operations Insights Warehouse User identifier
    """
    __args__ = dict()
...
def get_operations_insights_warehouse_user_output(operations_insights_warehouse_user_id: Optional[pulumi.Input[builtins.str]] = None,
