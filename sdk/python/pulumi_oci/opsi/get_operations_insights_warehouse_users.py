...
def get_operations_insights_warehouse_users(compartment_id: Optional[builtins.str] = None,
...
def get_operations_insights_warehouse_users_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
