...
def get_operations_insights_warehouses(compartment_id: Optional[builtins.str] = None,
...
def get_operations_insights_warehouses_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
