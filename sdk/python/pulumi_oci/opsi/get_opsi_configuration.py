...
class GetOpsiConfigurationResult:
    ...
    def opsi_configuration_id(self) -> builtins.str:
...
def get_opsi_configuration(config_item_custom_statuses: Optional[Sequence[builtins.str]] = None,
                           config_item_fields: Optional[Sequence[builtins.str]] = None,
                           config_items_applicable_contexts: Optional[Sequence[builtins.str]] = None,
                           opsi_config_fields: Optional[Sequence[builtins.str]] = None,
                           opsi_configuration_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] config_item_custom_statuses: Specifies whether only customized configuration items or only non-customized configuration items or both have to be returned. By default only customized configuration items are returned.
    :param Sequence[builtins.str] config_item_fields: Specifies the fields to return in a config item summary.
    :param Sequence[builtins.str] config_items_applicable_contexts: Returns the configuration items filtered by applicable contexts sent in this param. By default configuration items of all applicable contexts are returned.
    :param Sequence[builtins.str] opsi_config_fields: Optional fields to return as part of OpsiConfiguration object. Unless requested, these fields will not be returned by default.
    :param builtins.str opsi_configuration_id: [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of OPSI configuration resource.
    """
    __args__ = dict()
...
def get_opsi_configuration_output(config_item_custom_statuses: Optional[pulumi.Input[Sequence[builtins.str]]] = None,
                                  config_item_fields: Optional[pulumi.Input[Sequence[builtins.str]]] = None,
                                  config_items_applicable_contexts: Optional[pulumi.Input[Sequence[builtins.str]]] = None,
                                  opsi_config_fields: Optional[pulumi.Input[Sequence[builtins.str]]] = None,
                                  opsi_configuration_id: Optional[pulumi.Input[builtins.str]] = None,
