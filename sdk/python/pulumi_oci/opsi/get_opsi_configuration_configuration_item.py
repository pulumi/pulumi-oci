...
class GetOpsiConfigurationConfigurationItemResult:
    ...
    def config_item_fields(self) -> Optional[Sequence[_builtins.str]]:
    ...
    def config_items_applicable_contexts(self) -> Optional[Sequence[_builtins.str]]:
...
def get_opsi_configuration_configuration_item(compartment_id: Optional[_builtins.str] = None,
                                              ...
                                              opsi_config_type: Optional[_builtins.str] = None,
    ...
    :param _builtins.str opsi_config_type: Filter to return configuration items based on configuration type of OPSI configuration.
    """
    __args__ = dict()
