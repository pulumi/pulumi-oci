...
class GetOpsiConfigurationsResult:
    ...
    def opsi_config_types(self) -> Optional[Sequence[_builtins.str]]:
        """
...
def get_opsi_configurations(compartment_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] opsi_config_types: Filter to return based on configuration type of OPSI configuration.
    :param Sequence[_builtins.str] states: Filter to return based on Lifecycle state of OPSI configuration.
    """
    __args__ = dict()
...
def get_opsi_configurations_output(compartment_id: Optional[pulumi.Input[_builtins.str]] = None,
                                   ...
                                   opsi_config_types: Optional[pulumi.Input[Optional[Sequence[_builtins.str]]]] = None,
