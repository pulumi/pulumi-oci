...
class NewsReportArgs:
    def __init__(__self__, *,
                 ...
                 news_frequency: pulumi.Input[builtins.str],
                 ons_topic_id: pulumi.Input[builtins.str],
                 are_child_compartments_included: Optional[pulumi.Input[builtins.bool]] = None,
                 day_of_week: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 match_rule: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 status: Optional[pulumi.Input[builtins.str]] = None,
                 tag_filters: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a NewsReport resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) Compartment Identifier where the news report will be created.
        :param pulumi.Input['NewsReportContentTypesArgs'] content_types: (Updatable) Content types that the news report can handle.
        :param pulumi.Input[builtins.str] description: (Updatable) The description of the news report.
        :param pulumi.Input[builtins.str] locale: (Updatable) Language of the news report.
        :param pulumi.Input[builtins.str] news_frequency: (Updatable) News report frequency.
        :param pulumi.Input[builtins.str] ons_topic_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the ONS topic.
        :param pulumi.Input[builtins.bool] are_child_compartments_included: (Updatable) A flag to consider the resources within a given compartment and all sub-compartments.
        :param pulumi.Input[builtins.str] day_of_week: (Updatable) Day of the week in which the news report will be sent if the frequency is set to WEEKLY.
        ...
        :param pulumi.Input[builtins.str] match_rule: (Updatable) Match rule used for tag filters.
        :param pulumi.Input[builtins.str] name: (Updatable) The news report name.
        :param pulumi.Input[builtins.str] status: (Updatable) Defines if the news report will be enabled or disabled.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tag_filters: (Updatable) List of tag filters; each filter composed by a namespace, key, and value. Example for defined tags - '<TagNamespace>.<TagKey>=<TagValue>'. Example for freeform tags - '<TagKey>=<TagValue>' 
    ...
    def news_frequency(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def news_frequency(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "news_frequency", value)

    @property
    @pulumi.getter(name="onsTopicId")
    def ons_topic_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @ons_topic_id.setter
    def ons_topic_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "ons_topic_id", value)

    @property
    @pulumi.getter(name="areChildCompartmentsIncluded")
    def are_child_compartments_included(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def are_child_compartments_included(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def match_rule(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @match_rule.setter
    def match_rule(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def tag_filters(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @tag_filters.setter
    def tag_filters(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _NewsReportState:
    def __init__(__self__, *,
                 ...
                 match_rule: Optional[pulumi.Input[builtins.str]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 news_frequency: Optional[pulumi.Input[builtins.str]] = None,
                 ons_topic_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] news_frequency: (Updatable) News report frequency.
        :param pulumi.Input[builtins.str] ons_topic_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the ONS topic.
        :param pulumi.Input[builtins.str] state: The current state of the news report.
        :param pulumi.Input[builtins.str] status: (Updatable) Defines if the news report will be enabled or disabled.
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] tag_filters: (Updatable) List of tag filters; each filter composed by a namespace, key, and value. Example for defined tags - '<TagNamespace>.<TagKey>=<TagValue>'. Example for freeform tags - '<TagKey>=<TagValue>' 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] time_created: The time the the news report was first enabled. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The time the news report was updated. An RFC3339 formatted datetime string.
        """
        if are_child_compartments_included is not None:
            pulumi.set(__self__, "are_child_compartments_included", are_child_compartments_included)
    ...
    @property
    @pulumi.getter(name="newsFrequency")
    def news_frequency(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) News report frequency.
        """
        return pulumi.get(self, "news_frequency")
    ...
    @news_frequency.setter
    def news_frequency(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "news_frequency", value)

    @property
    @pulumi.getter(name="onsTopicId")
    def ons_topic_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the ONS topic.
        """
        return pulumi.get(self, "ons_topic_id")
    ...
    @ons_topic_id.setter
    def ons_topic_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ons_topic_id", value)
...
class NewsReport(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tag_filters: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'NewsReport':
        """
    ...
    @property
    @pulumi.getter(name="areChildCompartmentsIncluded")
    def are_child_compartments_included(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) A flag to consider the resources within a given compartment and all sub-compartments.
        """
        return pulumi.get(self, "are_child_compartments_included")
    ...
    @property
    @pulumi.getter(name="dayOfWeek")
    def day_of_week(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Day of the week in which the news report will be sent if the frequency is set to WEEKLY.
        """
        return pulumi.get(self, "day_of_week")
    ...
    @property
    @pulumi.getter(name="matchRule")
    def match_rule(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Match rule used for tag filters.
        """
        return pulumi.get(self, "match_rule")
    ...
    @property
    @pulumi.getter(name="newsFrequency")
    def news_frequency(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) News report frequency.
        """
        return pulumi.get(self, "news_frequency")
    ...
    @property
    @pulumi.getter(name="onsTopicId")
    def ons_topic_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the ONS topic.
        """
        return pulumi.get(self, "ons_topic_id")
    ...
    @property
    @pulumi.getter(name="tagFilters")
    def tag_filters(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) List of tag filters; each filter composed by a namespace, key, and value. Example for defined tags - '<TagNamespace>.<TagKey>=<TagValue>'. Example for freeform tags - '<TagKey>=<TagValue>' 
