...
class OperationsInsightsPrivateEndpointArgs:
    def __init__(__self__, *,
        ...
        """
        OperationsInsightsPrivateEndpointArgs._configure(
    ...
    def _configure(
        ...
        if is_used_for_rac_dbs is None and 'isUsedForRacDbs' in kwargs:
            is_used_for_rac_dbs = kwargs['isUsedForRacDbs']
        if is_used_for_rac_dbs is None:
            raise TypeError("Missing 'is_used_for_rac_dbs' argument")
        ...
        if private_endpoint_status_details is None and 'privateEndpointStatusDetails' in kwargs:
    ...
    def __init__(__self__, *,
        ...
        :param pulumi.Input[str] vcn_id: The VCN [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Private service accessed database.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        """
        _OperationsInsightsPrivateEndpointState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            compartment_id=compartment_id,
            defined_tags=defined_tags,
            description=description,
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            OperationsInsightsPrivateEndpointArgs._configure(_setter, **kwargs)
