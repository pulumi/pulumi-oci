...
class OperationsInsightsPrivateEndpointArgs:
    ...
    def private_endpoint_status_details(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
...
class _OperationsInsightsPrivateEndpointState:
    ...
    @_builtins.property
    @pulumi.getter(name="isUsedForRacDbs")
    def is_used_for_rac_dbs(self) -> pulumi.Input[Optional[_builtins.bool]]:
        """
        This flag was previously used to create a private endpoint with scan proxy. Setting this to true will now create a private endpoint with a DNS proxy causing `isProxyEnabled` flag to be true; this is used exclusively for full feature support for dedicated Autonomous Databases.
        """
        return pulumi.get(self, "is_used_for_rac_dbs")
    ...
    @is_used_for_rac_dbs.setter
    def is_used_for_rac_dbs(self, value: pulumi.Input[Optional[_builtins.bool]]):
        pulumi.set(self, "is_used_for_rac_dbs", value)
...
class OperationsInsightsPrivateEndpoint(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            vcn_id: pulumi.Input[Optional[_builtins.str]] = None) -> 'OperationsInsightsPrivateEndpoint':
        """
