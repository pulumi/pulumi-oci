...
class EnrollmentStatusArgs:
    def __init__(__self__, *,
                 enrollment_status_id: pulumi.Input[builtins.str],
                 status: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a EnrollmentStatus resource.
        :param pulumi.Input[builtins.str] enrollment_status_id: The unique OCID associated with the enrollment status.
        :param pulumi.Input[builtins.str] status: (Updatable) The Cloud Advisor enrollment status.
    ...
    def enrollment_status_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def enrollment_status_id(self, value: pulumi.Input[builtins.str]):
...
class _EnrollmentStatusState:
    def __init__(__self__, *,
                 ...
                 enrollment_status_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] enrollment_status_id: The unique OCID associated with the enrollment status.
        :param pulumi.Input[builtins.str] state: The enrollment status' current state.
        :param pulumi.Input[builtins.str] status: (Updatable) The Cloud Advisor enrollment status.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] status_reason: The reason for the enrollment status of the tenancy.
        :param pulumi.Input[builtins.str] time_created: The date and time the enrollment status was created, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_updated: The date and time the enrollment status was last updated, in the format defined by RFC3339.
        """
    ...
    @property
    @pulumi.getter(name="enrollmentStatusId")
    def enrollment_status_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The unique OCID associated with the enrollment status.
        """
        return pulumi.get(self, "enrollment_status_id")
    ...
    @enrollment_status_id.setter
    def enrollment_status_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "enrollment_status_id", value)
...
class EnrollmentStatus(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            status_reason: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'EnrollmentStatus':
        """
    ...
    @property
    @pulumi.getter(name="enrollmentStatusId")
    def enrollment_status_id(self) -> pulumi.Output[builtins.str]:
        """
        The unique OCID associated with the enrollment status.
        """
        return pulumi.get(self, "enrollment_status_id")
