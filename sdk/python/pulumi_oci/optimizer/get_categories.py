...
class GetCategoriesResult:
    ...
    def child_tenancy_ids(self) -> Optional[Sequence[_builtins.str]]:
    ...
    def include_organization(self) -> Optional[_builtins.bool]:
...
def get_categories(child_tenancy_ids: Optional[Sequence[_builtins.str]] = None,
                   compartment_id: Optional[_builtins.str] = None,
                   compartment_id_in_subtree: Optional[_builtins.bool] = None,
                   filters: Optional[Sequence[Union['GetCategoriesFilterArgs', 'GetCategoriesFilterArgsDict', 'outputs.GetCategoriesFilterResult']]] = None,
                   include_organization: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool include_organization: When set to true, the data for all child tenancies including the parent is returned. That is, if  there is an organization with parent P and children A and B, to return the data for the parent P, child  A and child B, this parameter value should be set to true.
...
def get_categories_output(child_tenancy_ids: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                          ...
                          filters: pulumi.Input[Optional[Optional[Sequence[Union['GetCategoriesFilterArgs', 'GetCategoriesFilterArgsDict', 'outputs.GetCategoriesFilterResult']]]]] = None,
