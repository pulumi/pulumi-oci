...
def get_enrollment_statuses(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str status: A filter that returns results that match the Cloud Advisor enrollment status specified.
    """
    __args__ = dict()
...
def get_enrollment_statuses_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
