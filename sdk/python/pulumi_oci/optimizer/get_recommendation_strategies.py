...
def get_recommendation_strategies(compartment_id: Optional[builtins.str] = None,
...
def get_recommendation_strategies_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
