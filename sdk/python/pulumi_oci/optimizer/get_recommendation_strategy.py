...
def get_recommendation_strategy(compartment_id: Optional[builtins.str] = None,
...
def get_recommendation_strategy_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
