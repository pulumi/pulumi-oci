...
class GetRecommendationsResult:
    ...
    def category_id(self) -> Optional[builtins.str]:
        """
...
def get_recommendations(category_id: Optional[builtins.str] = None,
                        category_name: Optional[builtins.str] = None,
                        child_tenancy_ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.str category_id: The unique OCID associated with the category.
    :param builtins.str category_name: Optional. A filter that returns results that match the category name specified.
...
def get_recommendations_output(category_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               category_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                               child_tenancy_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
