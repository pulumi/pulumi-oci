...
class ProfileLevelsConfigurationItem(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str level: (Updatable) The pre-defined profile level.
        :param builtins.str recommendation_id: (Updatable) The unique OCID of the recommendation.
        """
...
class ProfileTargetCompartments(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] items: (Updatable) The list of OCIDs attached to the compartments specified in the current profile override.
        """
        pulumi.set(__self__, "items", items)
...
class ProfileTargetTagsItem(dict):
    ...
    def __init__(__self__, *,
                 tag_definition_name: builtins.str,
                 tag_namespace_name: builtins.str,
                 tag_value_type: builtins.str,
                 tag_values: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str tag_definition_name: (Updatable) The name you use to refer to the tag, also known as the tag key.
        :param builtins.str tag_namespace_name: (Updatable) The name of the tag namespace.
        :param builtins.str tag_value_type: (Updatable) Specifies which tag value types in the `tagValues` field result in overrides of the recommendation criteria.
        ...
        :param Sequence[builtins.str] tag_values: (Updatable) The list of tag values. The tag value is the value that the user applying the tag adds to the tag key.
    ...
    def tag_namespace_name(self) -> builtins.str:
        """
    ...
    def tag_value_type(self) -> builtins.str:
        """
...
class RecommendationResourceCount(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int count: The count of resources.
        :param builtins.str status: (Updatable) The status of the recommendation.
        """
...
class RecommendationSupportedLevelItem(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The name of the profile level.
        """
        if name is not None:
...
class ResourceActionAction(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str description: Text describing the recommended action.
        :param builtins.str type: The status of the resource action.
        :param builtins.str url: The URL path to documentation that explains how to perform the action.
        """
...
class GetCategoriesCategoryCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 compartment_name: builtins.str,
                 description: builtins.str,
                 estimated_cost_saving: builtins.float,
                 extended_metadata: Mapping[str, builtins.str],
                 id: builtins.str,
                 name: builtins.str,
        ...
        :param builtins.str compartment_name: The name associated with the compartment.
        :param builtins.str description: Text describing the category.
        :param builtins.float estimated_cost_saving: The estimated cost savings, in dollars, for the category.
        :param Mapping[str, builtins.str] extended_metadata: Additional metadata key/value pairs for the category.
        :param builtins.str id: The unique OCID of the category.
        ...
        :param builtins.str time_created: The date and time the category details were created, in the format defined by RFC3339.
        :param builtins.str time_updated: The date and time the category details were last updated, in the format defined by RFC3339.
        """
...
class GetCategoriesCategoryCollectionItemRecommendationCountResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int count: The count of resources.
        :param builtins.str importance: The level of importance assigned to the recommendation.
        """
        pulumi.set(__self__, "count", count)
...
class GetCategoriesCategoryCollectionItemResourceCountResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int count: The count of resources.
        :param builtins.str status: The recommendation status of the resource.
        """
        pulumi.set(__self__, "count", count)
        pulumi.set(__self__, "status", status)
...
class GetEnrollmentStatusesEnrollmentStatusCollectionItemResult(dict):
    def __init__(__self__, *,
                 compartment_id: builtins.str,
                 enrollment_status_id: builtins.str,
                 id: builtins.str,
                 state: builtins.str,
                 status: builtins.str,
        ...
        """
        :param builtins.str compartment_id: The OCID of the compartment.
        :param builtins.str id: The OCID of the enrollment status.
        :param builtins.str state: A filter that returns results that match the lifecycle state specified.
        :param builtins.str status: A filter that returns results that match the Cloud Advisor enrollment status specified.
        :param builtins.str status_reason: The reason for the enrollment status of the tenancy.
        :param builtins.str time_created: The date and time the enrollment status was created, in the format defined by RFC3339.
        :param builtins.str time_updated: The date and time the enrollment status was last updated, in the format defined by RFC3339.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
...
class GetHistoriesHistoryCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 resource_action_id: builtins.str,
        ...
        :param builtins.str compartment_id: The OCID of the compartment.
        :param builtins.str compartment_name: The name assigned to the compartment.
        :param builtins.float estimated_cost_saving: The estimated cost savings, in dollars, for the resource action.
        :param Mapping[str, builtins.str] extended_metadata: Additional metadata key/value pairs that you provide. They serve the same purpose and functionality as fields in the `metadata` object.
        :param builtins.str id: The unique OCID associated with the recommendation history.
        :param Mapping[str, builtins.str] metadata: Custom metadata key/value pairs for the resource action.
        :param builtins.str name: Optional. A filter that returns results that match the name specified.
        ...
        :param builtins.str resource_id: The unique OCID associated with the resource.
        ...
        :param builtins.str time_created: The date and time the recommendation history was created, in the format defined by RFC3339.
        """
...
class GetProfileLevelItemResult(dict):
    def __init__(__self__, *,
                 default_interval: builtins.int,
                 metrics: Sequence['outputs.GetProfileLevelItemMetricResult'],
                 name: builtins.str,
                 recommendation_name: builtins.str,
                 time_created: builtins.str,
                 time_updated: builtins.str,
                 valid_intervals: Sequence[builtins.int]):
        """
        :param builtins.int default_interval: The default aggregation interval (in days) for profiles using this profile level.
        ...
        :param builtins.str time_created: The date and time the category details were created, in the format defined by RFC3339.
        :param builtins.str time_updated: The date and time the category details were last updated, in the format defined by RFC3339.
        :param Sequence[builtins.int] valid_intervals: An array of aggregation intervals (in days) allowed for profiles using this profile level.
        """
    ...
    def default_interval(self) -> builtins.int:
        """
    ...
    def valid_intervals(self) -> Sequence[builtins.int]:
        """
...
class GetProfileLevelItemMetricResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Optional. A filter that returns results that match the name specified.
        :param builtins.str statistic: The name of the statistic (e.g., `p95`).
        :param builtins.float target: Optional. The metric value that the recommendation will target.
        :param builtins.float threshold: The threshold that must be crossed for the recommendation to appear.
        """
        pulumi.set(__self__, "name", name)
...
class GetProfileLevelsConfigurationItemResult(dict):
    def __init__(__self__, *,
                 ...
                 recommendation_id: builtins.str):
        """
        :param builtins.str level: The pre-defined profile level.
        :param builtins.str recommendation_id: The unique OCID of the recommendation.
        """
        pulumi.set(__self__, "level", level)
        pulumi.set(__self__, "recommendation_id", recommendation_id)
...
class GetProfileTargetCompartmentResult(dict):
    def __init__(__self__, *,
                 items: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] items: The list of tags specified in the current profile override.
        """
        pulumi.set(__self__, "items", items)
...
class GetProfileTargetTagItemResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str tag_definition_name: The name you use to refer to the tag, also known as the tag key.
        :param builtins.str tag_namespace_name: The name of the tag namespace.
        :param builtins.str tag_value_type: Specifies which tag value types in the `tagValues` field result in overrides of the recommendation criteria.
        :param Sequence[builtins.str] tag_values: The list of tag values. The tag value is the value that the user applying the tag adds to the tag key.
        """
        pulumi.set(__self__, "tag_definition_name", tag_definition_name)
        pulumi.set(__self__, "tag_namespace_name", tag_namespace_name)
        pulumi.set(__self__, "tag_value_type", tag_value_type)
...
class GetProfilesProfileCollectionItemResult(dict):
    def __init__(__self__, *,
                 aggregation_interval_in_days: builtins.int,
                 compartment_id: builtins.str,
                 ...
                 time_updated: builtins.str):
        """
        :param builtins.int aggregation_interval_in_days: The time period over which to collect data for the recommendations, measured in number of days.
        :param builtins.str compartment_id: The OCID of the compartment.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str description: Text describing the profile. Avoid entering confidential information.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair applied without any predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Exists for cross-compatibility only.  Example: `{"bar-key": "value"}`
        :param builtins.str id: The unique OCID of the profile.
        ...
        :param builtins.str time_created: The date and time the profile was created, in the format defined by RFC3339.
        :param builtins.str time_updated: The date and time the profile was last updated, in the format defined by RFC3339.
        """
...
class GetRecommendationResourceCountResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.int count: The count of resources.
        :param builtins.str status: The current status of the recommendation.
        """
        pulumi.set(__self__, "count", count)
        pulumi.set(__self__, "status", status)
...
class GetRecommendationStrategiesRecommendationStrategyCollectionItemStrategyResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool is_default: Whether this is the default recommendation strategy.
        ...
        :param builtins.str strategy_name: The name of the strategy.
        """
...
class GetRecommendationStrategiesRecommendationStrategyCollectionItemStrategyParametersDefinitionResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str description: Text describing the strategy parameter.
        :param builtins.bool is_required: Whether this parameter is required.
        :param builtins.str name: Optional. A filter that returns results that match the name specified.
        :param Sequence[Any] possible_values: The list of possible values used for these strategy parameters.
        :param builtins.str type: The type of strategy parameter.
        """
...
class GetRecommendationsRecommendationCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 time_created: builtins.str,
                 time_status_begin: builtins.str,
                 time_status_end: builtins.str,
                 time_updated: builtins.str):
        """
        :param builtins.str category_id: The unique OCID associated with the category.
        :param builtins.str compartment_id: The OCID of the compartment.
        :param builtins.str description: Text describing the recommendation.
        :param builtins.float estimated_cost_saving: The estimated cost savings, in dollars, for the recommendation.
        :param Mapping[str, builtins.str] extended_metadata: Additional metadata key/value pairs for the recommendation.
        :param builtins.str id: The unique OCID associated with the recommendation.
        :param builtins.str importance: The level of importance assigned to the recommendation.
        :param builtins.str name: Optional. A filter that returns results that match the name specified.
        ...
        :param builtins.str time_created: The date and time the recommendation details were created, in the format defined by RFC3339.
        :param builtins.str time_status_begin: The date and time that the recommendation entered its current status. The format is defined by RFC3339.
        :param builtins.str time_status_end: The date and time the current status will change. The format is defined by RFC3339.
        :param builtins.str time_updated: The date and time the recommendation details were last updated, in the format defined by RFC3339.
        """
        pulumi.set(__self__, "category_id", category_id)
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "description", description)
...
class GetResourceActionsResourceActionCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.float estimated_cost_saving: The estimated cost savings, in dollars, for the resource action.
        :param Mapping[str, builtins.str] extended_metadata: Additional metadata key/value pairs that you provide. They serve the same purpose and functionality as fields in the `metadata` object.
        :param builtins.str id: The unique OCID associated with the resource action.
        :param Mapping[str, builtins.str] metadata: Custom metadata key/value pairs for the resource action.
        :param builtins.str name: Optional. A filter that returns results that match the name specified.
        :param builtins.str recommendation_id: The unique OCID associated with the recommendation.
        :param builtins.str resource_id: The unique OCID associated with the resource.
        ...
        :param builtins.str state: A filter that returns results that match the lifecycle state specified.
        :param builtins.str status: A filter that returns recommendations that match the status specified.
        :param builtins.str time_created: The date and time the resource action details were created, in the format defined by RFC3339.
        :param builtins.str time_status_begin: The date and time that the resource action entered its current status. The format is defined by RFC3339.
        :param builtins.str time_status_end: The date and time the current status will change. The format is defined by RFC3339.
        :param builtins.str time_updated: The date and time the resource action details were last updated, in the format defined by RFC3339.
        """
        pulumi.set(__self__, "actions", actions)
        pulumi.set(__self__, "category_id", category_id)
        pulumi.set(__self__, "compartment_id", compartment_id)
