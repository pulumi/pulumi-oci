...
class _RecommendationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] estimated_cost_saving: The estimated cost savings, in dollars, for the recommendation.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] extended_metadata: Additional metadata key/value pairs for the recommendation.
        ...
        :param pulumi.Input[_builtins.str] time_status_end: (Updatable) The date and time the current status will change. The format is defined by RFC3339.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] time_updated: The date and time the recommendation details were last updated, in the format defined by RFC3339.
        """
