...
class _RecommendationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] description: Text describing the recommendation.
        :param pulumi.Input[builtins.float] estimated_cost_saving: The estimated cost savings, in dollars, for the recommendation.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] extended_metadata: Additional metadata key/value pairs for the recommendation.
        :param pulumi.Input[builtins.str] importance: The level of importance assigned to the recommendation.
        ...
        :param pulumi.Input[builtins.str] state: The recommendation's current state.
        :param pulumi.Input[builtins.str] status: (Updatable) The status of the recommendation.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the recommendation details were created, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_status_begin: The date and time that the recommendation entered its current status. The format is defined by RFC3339.
        :param pulumi.Input[builtins.str] time_status_end: (Updatable) The date and time the current status will change. The format is defined by RFC3339.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] time_updated: The date and time the recommendation details were last updated, in the format defined by RFC3339.
        """
...
class Recommendation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_status_begin: Optional[pulumi.Input[builtins.str]] = None,
            time_status_end: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'Recommendation':
        """
