...
class ResourceActionArgs:
    def __init__(__self__, *,
                 resource_action_id: pulumi.Input[builtins.str],
                 status: pulumi.Input[builtins.str],
                 time_status_end: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a ResourceAction resource.
        :param pulumi.Input[builtins.str] resource_action_id: The unique OCID associated with the resource action.
        :param pulumi.Input[builtins.str] status: (Updatable) The status of the resource action.
        :param pulumi.Input[builtins.str] time_status_end: (Updatable) The date and time the current status will change. The format is defined by RFC3339.
    ...
    def resource_action_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def resource_action_id(self, value: pulumi.Input[builtins.str]):
    ...
    def time_status_end(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_status_end(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ResourceActionState:
    def __init__(__self__, *,
                 ...
                 estimated_cost_saving: Optional[pulumi.Input[builtins.float]] = None,
                 ...
                 time_status_begin: Optional[pulumi.Input[builtins.str]] = None,
                 time_status_end: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] category_id: The unique OCID associated with the category.
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment.
        :param pulumi.Input[builtins.str] compartment_name: The name associated with the compartment.
        :param pulumi.Input[builtins.float] estimated_cost_saving: The estimated cost savings, in dollars, for the resource action.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] extended_metadata: Additional metadata key/value pairs that you provide. They serve the same purpose and functionality as fields in the `metadata` object.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: Custom metadata key/value pairs for the resource action.
        :param pulumi.Input[builtins.str] name: The name assigned to the resource.
        :param pulumi.Input[builtins.str] recommendation_id: The unique OCID associated with the recommendation.
        :param pulumi.Input[builtins.str] resource_action_id: The unique OCID associated with the resource action.
        :param pulumi.Input[builtins.str] resource_id: The unique OCID associated with the resource.
        :param pulumi.Input[builtins.str] resource_type: The kind of resource.
        :param pulumi.Input[builtins.str] state: The resource action's current state.
        :param pulumi.Input[builtins.str] status: (Updatable) The status of the resource action.
        :param pulumi.Input[builtins.str] time_created: The date and time the resource action details were created, in the format defined by RFC3339.
        :param pulumi.Input[builtins.str] time_status_begin: The date and time that the resource action entered its current status. The format is defined by RFC3339.
        :param pulumi.Input[builtins.str] time_status_end: (Updatable) The date and time the current status will change. The format is defined by RFC3339.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] time_updated: The date and time the resource action details were last updated, in the format defined by RFC3339.
        """
    ...
    def estimated_cost_saving(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def estimated_cost_saving(self, value: Optional[pulumi.Input[builtins.float]]):
    ...
    @property
    @pulumi.getter(name="resourceActionId")
    def resource_action_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The unique OCID associated with the resource action.
        """
        return pulumi.get(self, "resource_action_id")
    ...
    @resource_action_id.setter
    def resource_action_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "resource_action_id", value)
    ...
    def time_status_begin(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_status_begin(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ResourceAction(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_status_begin: Optional[pulumi.Input[builtins.str]] = None,
            time_status_end: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'ResourceAction':
        """
    ...
    @property
    @pulumi.getter(name="compartmentName")
    def compartment_name(self) -> pulumi.Output[builtins.str]:
        """
        The name associated with the compartment.
        """
        return pulumi.get(self, "compartment_name")
    ...
    @property
    @pulumi.getter(name="estimatedCostSaving")
    def estimated_cost_saving(self) -> pulumi.Output[builtins.float]:
        """
        The estimated cost savings, in dollars, for the resource action.
        """
        return pulumi.get(self, "estimated_cost_saving")
    ...
    @property
    @pulumi.getter(name="resourceActionId")
    def resource_action_id(self) -> pulumi.Output[builtins.str]:
        """
        The unique OCID associated with the resource action.
        """
        return pulumi.get(self, "resource_action_id")
    ...
    @property
    @pulumi.getter(name="timeStatusBegin")
    def time_status_begin(self) -> pulumi.Output[builtins.str]:
        """
        The date and time that the resource action entered its current status. The format is defined by RFC3339.
        """
        return pulumi.get(self, "time_status_begin")
    ...
    @property
    @pulumi.getter(name="timeStatusEnd")
    def time_status_end(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The date and time the current status will change. The format is defined by RFC3339.
