...
def get_managed_instance(managed_instance_id: Optional[str] = None,
    ...
    test_managed_instance = oci.OsManagement.get_managed_instance(managed_instance_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
    ```
    ...
    return AwaitableGetManagedInstanceResult(
        autonomouses=__ret__.autonomouses,
        bug_updates_available=__ret__.bug_updates_available,
        child_software_sources=__ret__.child_software_sources,
        compartment_id=__ret__.compartment_id,
        description=__ret__.description,
        display_name=__ret__.display_name,
        enhancement_updates_available=__ret__.enhancement_updates_available,
        id=__ret__.id,
        is_data_collection_authorized=__ret__.is_data_collection_authorized,
        is_reboot_required=__ret__.is_reboot_required,
        ksplice_effective_kernel_version=__ret__.ksplice_effective_kernel_version,
        last_boot=__ret__.last_boot,
        last_checkin=__ret__.last_checkin,
        managed_instance_groups=__ret__.managed_instance_groups,
        managed_instance_id=__ret__.managed_instance_id,
        notification_topic_id=__ret__.notification_topic_id,
        os_family=__ret__.os_family,
        os_kernel_version=__ret__.os_kernel_version,
        os_name=__ret__.os_name,
        os_version=__ret__.os_version,
        other_updates_available=__ret__.other_updates_available,
        parent_software_sources=__ret__.parent_software_sources,
        scheduled_job_count=__ret__.scheduled_job_count,
        security_updates_available=__ret__.security_updates_available,
        status=__ret__.status,
        updates_available=__ret__.updates_available,
        work_request_count=__ret__.work_request_count)
