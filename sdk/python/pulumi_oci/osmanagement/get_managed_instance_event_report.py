...
class GetManagedInstanceEventReportResult:
    ...
    def latest_timestamp_greater_than_or_equal_to(self) -> Optional[builtins.str]:
        return pulumi.get(self, "latest_timestamp_greater_than_or_equal_to")

    @property
    @pulumi.getter(name="latestTimestampLessThan")
    def latest_timestamp_less_than(self) -> Optional[builtins.str]:
...
def get_managed_instance_event_report(compartment_id: Optional[builtins.str] = None,
                                      latest_timestamp_greater_than_or_equal_to: Optional[builtins.str] = None,
                                      latest_timestamp_less_than: Optional[builtins.str] = None,
    ...
    :param builtins.str latest_timestamp_greater_than_or_equal_to: filter event occurrence. Selecting only those last occurred on or after given date in ISO 8601 format Example: 2017-07-14T02:40:00.000Z
    :param builtins.str latest_timestamp_less_than: filter event occurrence. Selecting only those last occurred before given date in ISO 8601 format Example: 2017-07-14T02:40:00.000Z
    :param builtins.str managed_instance_id: Instance Oracle Cloud identifier (ocid)
    """
    __args__ = dict()
...
def get_managed_instance_event_report_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                             latest_timestamp_greater_than_or_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                             latest_timestamp_less_than: Optional[pulumi.Input[Optional[builtins.str]]] = None,
