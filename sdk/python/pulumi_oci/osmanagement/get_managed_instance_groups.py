...
def get_managed_instance_groups(compartment_id: Optional[builtins.str] = None,
...
def get_managed_instance_groups_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
