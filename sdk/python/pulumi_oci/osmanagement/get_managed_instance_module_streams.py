...
class GetManagedInstanceModuleStreamsResult:
    ...
    def stream_status(self) -> Optional[builtins.str]:
...
def get_managed_instance_module_streams(compartment_id: Optional[builtins.str] = None,
                                        filters: Optional[Sequence[Union['GetManagedInstanceModuleStreamsFilterArgs', 'GetManagedInstanceModuleStreamsFilterArgsDict']]] = None,
                                        ...
                                        stream_status: Optional[builtins.str] = None,
    ...
    :param builtins.str stream_status: The status of the stream
...
def get_managed_instance_module_streams_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                               ...
                                               stream_status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
