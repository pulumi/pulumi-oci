...
def get_managed_instance_stream_profile(compartment_id: Optional[builtins.str] = None,
                                        ...
                                        profile_status: Optional[builtins.str] = None,
    ...
    :param builtins.str compartment_id: The ID of the compartment in which to list resources. This parameter is optional and in some cases may have no effect.
    ...
    :param builtins.str profile_status: The status of the profile.
...
def get_managed_instance_stream_profile_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                               ...
                                               profile_status: Optional[pulumi.Input[Optional[builtins.str]]] = None,
