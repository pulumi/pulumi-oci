...
def get_software_source_stream_profile(compartment_id: Optional[builtins.str] = None,
                                       filters: Optional[Sequence[Union['GetSoftwareSourceStreamProfileFilterArgs', 'GetSoftwareSourceStreamProfileFilterArgsDict']]] = None,
...
def get_software_source_stream_profile_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                              filters: Optional[pulumi.Input[Optional[Sequence[Union['GetSoftwareSourceStreamProfileFilterArgs', 'GetSoftwareSourceStreamProfileFilterArgsDict']]]]] = None,
                                              ...
                                              opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetSoftwareSourceStreamProfileResult]:
    """
    This data source provides the list of Software Source Stream Profiles in Oracle Cloud Infrastructure OS Management service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:OsManagement/getSoftwareSourceStreamProfile:getSoftwareSourceStreamProfile', __args__, opts=opts, typ=GetSoftwareSourceStreamProfileResult)
    return __ret__.apply(lambda __response__: GetSoftwareSourceStreamProfileResult(
        compartment_id=pulumi.get(__response__, 'compartment_id'),
        filters=pulumi.get(__response__, 'filters'),
        id=pulumi.get(__response__, 'id'),
        module_name=pulumi.get(__response__, 'module_name'),
        module_stream_profiles=pulumi.get(__response__, 'module_stream_profiles'),
