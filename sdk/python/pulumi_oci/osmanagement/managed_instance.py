...
class ManagedInstanceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] is_data_collection_authorized: (Updatable) True if user allow data collection for this instance
        :param pulumi.Input[builtins.str] notification_topic_id: (Updatable) OCID of the ONS topic used to send notification to users
...
class _ManagedInstanceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] bug_updates_available: Number of bug fix type updates available to be installed
        ...
        :param pulumi.Input[builtins.int] enhancement_updates_available: Number of enhancement type updates available to be installed
        :param pulumi.Input[builtins.bool] is_data_collection_authorized: (Updatable) True if user allow data collection for this instance
        ...
        :param pulumi.Input[builtins.int] other_updates_available: Number of non-classified updates available to be installed
        ...
        :param pulumi.Input[builtins.int] security_updates_available: Number of security type updates available to be installed
...
@pulumi.type_token("oci:OsManagement/managedInstance:ManagedInstance")
class ManagedInstance(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="isDataCollectionAuthorized")
    def is_data_collection_authorized(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) True if user allow data collection for this instance
        """
        return pulumi.get(self, "is_data_collection_authorized")
