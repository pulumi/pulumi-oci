    ...
    def __init__(__self__,
        ...
        **NOTE** The resource on CREATE will detach any already attached parent software source, child software sources, managed instance groups to the managed instance.
        ...
        test_managed_instance_management = oci.os_management.ManagedInstanceManagement("testManagedInstanceManagement",
            ...
            parent_software_source=oci.os.management.ManagedInstanceManagementParentSoftwareSourceArgs(
            ...
            managed_instance_groups=[oci.os.management.ManagedInstanceManagementManagedInstanceGroupArgs(
            ...
            child_software_sources=[oci.os.management.ManagedInstanceManagementChildSoftwareSourceArgs(
