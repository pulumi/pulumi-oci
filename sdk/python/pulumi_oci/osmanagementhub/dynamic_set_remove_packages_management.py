...
__all__ = ['DynamicSetRemovePackagesManagementArgs', 'DynamicSetRemovePackagesManagement']

@pulumi.input_type
class DynamicSetRemovePackagesManagementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['DynamicSetRemovePackagesManagementWorkRequestDetailsArgs'] work_request_details: Provides the name and description of the job.
        """
...
@pulumi.type_token("oci:OsManagementHub/dynamicSetRemovePackagesManagement:DynamicSetRemovePackagesManagement")
class DynamicSetRemovePackagesManagement(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 managed_instances: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 package_names: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 work_request_details: pulumi.Input[Optional[Union['DynamicSetRemovePackagesManagementWorkRequestDetailsArgs', 'DynamicSetRemovePackagesManagementWorkRequestDetailsArgsDict', 'outputs.DynamicSetRemovePackagesManagementWorkRequestDetails']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] managed_instances: The list of managed instance OCIDs to be attached/detached.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] package_names: The list of package names.
        :param pulumi.Input[Union['DynamicSetRemovePackagesManagementWorkRequestDetailsArgs', 'DynamicSetRemovePackagesManagementWorkRequestDetailsArgsDict', 'outputs.DynamicSetRemovePackagesManagementWorkRequestDetails']] work_request_details: Provides the name and description of the job.
        """
        ...
    @overload
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param DynamicSetRemovePackagesManagementArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(DynamicSetRemovePackagesManagementArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = DynamicSetRemovePackagesManagementArgs.__new__(DynamicSetRemovePackagesManagementArgs)
        ...
        super(DynamicSetRemovePackagesManagement, __self__).__init__(
            'oci:OsManagementHub/dynamicSetRemovePackagesManagement:DynamicSetRemovePackagesManagement',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            managed_instances: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            package_names: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            work_request_details: pulumi.Input[Optional[Union['DynamicSetRemovePackagesManagementWorkRequestDetailsArgs', 'DynamicSetRemovePackagesManagementWorkRequestDetailsArgsDict', 'outputs.DynamicSetRemovePackagesManagementWorkRequestDetails']]] = None) -> 'DynamicSetRemovePackagesManagement':
        """
        ...
        __props__ = _DynamicSetRemovePackagesManagementState.__new__(_DynamicSetRemovePackagesManagementState)

        __props__.__dict__["dynamic_set_id"] = dynamic_set_id
        __props__.__dict__["managed_instances"] = managed_instances
        __props__.__dict__["package_names"] = package_names
        __props__.__dict__["work_request_details"] = work_request_details
        return DynamicSetRemovePackagesManagement(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="workRequestDetails")
    def work_request_details(self) -> pulumi.Output['outputs.DynamicSetRemovePackagesManagementWorkRequestDetails']:
        """
        Provides the name and description of the job.
        """
        return pulumi.get(self, "work_request_details")
