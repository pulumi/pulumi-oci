...
class EventArgs:
    def __init__(__self__, *,
                 event_id: pulumi.Input[builtins.str],
                 compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Event resource.
        :param pulumi.Input[builtins.str] event_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the event.
    ...
    def event_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @event_id.setter
    def event_id(self, value: pulumi.Input[builtins.str]):
...
class _EventState:
    def __init__(__self__, *,
                 ...
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 event_details: Optional[pulumi.Input[builtins.str]] = None,
                 event_id: Optional[pulumi.Input[builtins.str]] = None,
                 event_summary: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 ...
                 time_occurred: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] event_details: Details of an event.
        :param pulumi.Input[builtins.str] event_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the event.
        :param pulumi.Input[builtins.str] event_summary: Summary of the event.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}` 
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.bool] is_managed_by_autonomous_linux: Indicates whether the event occurred on a resource that is managed by the Autonomous Linux service.
        :param pulumi.Input[builtins.str] lifecycle_details: Describes the current state of the event in more detail. For example, the  message can provide actionable information for a resource in the 'FAILED' state.
        :param pulumi.Input[builtins.str] resource_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the managed instance or resource where the event occurred.
        :param pulumi.Input[builtins.str] state: The current state of the event.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the Event was created, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_occurred: The date and time that the event occurred.
        :param pulumi.Input[builtins.str] time_updated: The date and time that the event was updated (in [RFC 3339](https://tools.ietf.org/html/rfc3339) format). Example: `2016-08-25T21:10:29.600Z`
    ...
    def event_details(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Details of an event.
        """
    ...
    def event_details(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def event_summary(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def event_summary(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_occurred(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_occurred(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Event(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_occurred: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'Event':
        """
    ...
    @property
    @pulumi.getter(name="eventDetails")
    def event_details(self) -> pulumi.Output[builtins.str]:
        """
        Details of an event.
        """
        return pulumi.get(self, "event_details")
    ...
    @property
    @pulumi.getter(name="eventId")
    def event_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the event.
        """
        return pulumi.get(self, "event_id")
    ...
    @property
    @pulumi.getter(name="eventSummary")
    def event_summary(self) -> pulumi.Output[builtins.str]:
        """
        Summary of the event.
        """
        return pulumi.get(self, "event_summary")
    ...
    @property
    @pulumi.getter(name="timeOccurred")
    def time_occurred(self) -> pulumi.Output[builtins.str]:
        """
        The date and time that the event occurred.
        """
        return pulumi.get(self, "time_occurred")
