...
class GetEntitlementsResult:
    ...
    @property
    @pulumi.getter
    def csi(self) -> Optional[builtins.str]:
        """
...
def get_entitlements(compartment_id: Optional[builtins.str] = None,
                     csi: Optional[builtins.str] = None,
...
def get_entitlements_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                            csi: Optional[pulumi.Input[Optional[builtins.str]]] = None,
