...
class GetErrataResult:
    ...
    def advisory_severities(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def advisory_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def classification_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def time_issue_date_end(self) -> Optional[builtins.str]:
        return pulumi.get(self, "time_issue_date_end")

    @property
    @pulumi.getter(name="timeIssueDateStart")
    def time_issue_date_start(self) -> Optional[builtins.str]:
...
def get_errata(advisory_severities: Optional[Sequence[builtins.str]] = None,
               advisory_types: Optional[Sequence[builtins.str]] = None,
               classification_types: Optional[Sequence[builtins.str]] = None,
               ...
               time_issue_date_end: Optional[builtins.str] = None,
               time_issue_date_start: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] advisory_severities: The advisory severity.
    :param Sequence[builtins.str] advisory_types: A filter to return only errata that match the given advisory types.
    :param Sequence[builtins.str] classification_types: A filter to return only packages that match the given update classification type.
    ...
    :param builtins.str name_contains: A filter to return resources that may partially match the erratum name given.
    :param Sequence[builtins.str] names: The assigned erratum name. It's unique and not changeable.  Example: `ELSA-2020-5804`
    :param builtins.str os_family: A filter to return only resources that match the given operating system family.
    :param builtins.str time_issue_date_end: The issue date before which to list all errata, in ISO 8601 format  Example: 2017-07-14T02:40:00.000Z
    :param builtins.str time_issue_date_start: The issue date after which to list all errata, in ISO 8601 format  Example: 2017-07-14T02:40:00.000Z
    """
    __args__ = dict()
...
def get_errata_output(advisory_severities: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                      advisory_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                      classification_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                      ...
                      time_issue_date_end: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      time_issue_date_start: Optional[pulumi.Input[Optional[builtins.str]]] = None,
