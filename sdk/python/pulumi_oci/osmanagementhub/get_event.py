...
def get_event(event_id: Optional[builtins.str] = None,
    ...
    :param builtins.str event_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the event.
    """
    __args__ = dict()
...
def get_event_output(event_id: Optional[pulumi.Input[builtins.str]] = None,
