...
class GetEventsResult:
    ...
    def event_summary(self) -> Optional[builtins.str]:
        """
    ...
    def event_summary_contains(self) -> Optional[builtins.str]:
...
def get_events(compartment_id: Optional[builtins.str] = None,
               event_fingerprint: Optional[builtins.str] = None,
               event_summary: Optional[builtins.str] = None,
               event_summary_contains: Optional[builtins.str] = None,
    ...
    :param builtins.str event_summary_contains: A filter to return only events with a summary that contains the value provided.
    ...
    :param builtins.str time_created_greater_than_or_equal_to: A filter that returns events that occurred on or after the date provided.       Example: `2016-08-25T21:10:29.600Z`
    :param builtins.str time_created_less_than: A filter that returns events that occurred on or before the date provided.       Example: `2016-08-25T21:10:29.600Z`
    :param Sequence[builtins.str] types: A filter to return only resources whose type matches the given value.
    """
    __args__ = dict()
...
def get_events_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      event_fingerprint: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      event_summary: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                      event_summary_contains: Optional[pulumi.Input[Optional[builtins.str]]] = None,
