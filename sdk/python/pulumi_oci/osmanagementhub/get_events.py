...
class GetEventsResult:
    ...
    def event_summary(self) -> Optional[_builtins.str]:
        """
    ...
    def event_summary_contains(self) -> Optional[_builtins.str]:
...
def get_events(compartment_id: Optional[_builtins.str] = None,
               ...
               event_summary: Optional[_builtins.str] = None,
               event_summary_contains: Optional[_builtins.str] = None,
    ...
    :param _builtins.str event_summary_contains: A filter to return only events with a summary that contains the value provided.
    ...
    :param _builtins.str time_created_greater_than_or_equal_to: A filter that returns events that occurred on or after the date provided.       Example: `2016-08-25T21:10:29.600Z`
    :param _builtins.str time_created_less_than: A filter that returns events that occurred on or before the date provided.       Example: `2016-08-25T21:10:29.600Z`
    :param Sequence[_builtins.str] types: A filter to return only resources whose type matches the given value.
    """
    __args__ = dict()
...
def get_events_output(compartment_id: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                      event_fingerprint: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                      event_summary: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
                      event_summary_contains: Optional[pulumi.Input[Optional[_builtins.str]]] = None,
