...
def get_lifecycle_environment(lifecycle_environment_id: Optional[builtins.str] = None,
...
def get_lifecycle_environment_output(lifecycle_environment_id: Optional[pulumi.Input[builtins.str]] = None,
