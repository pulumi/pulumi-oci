...
def get_lifecycle_stage(lifecycle_stage_id: Optional[_builtins.str] = None,
...
def get_lifecycle_stage_output(lifecycle_stage_id: Optional[pulumi.Input[_builtins.str]] = None,
