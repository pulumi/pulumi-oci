...
class GetLifecycleStagesResult:
    ...
    def lifecycle_stage_id(self) -> Optional[_builtins.str]:
...
def get_lifecycle_stages(arch_type: Optional[_builtins.str] = None,
                         compartment_id: Optional[_builtins.str] = None,
                         display_name_contains: Optional[_builtins.str] = None,
                         display_names: Optional[Sequence[_builtins.str]] = None,
                         filters: Optional[Sequence[Union['GetLifecycleStagesFilterArgs', 'GetLifecycleStagesFilterArgsDict', 'outputs.GetLifecycleStagesFilterResult']]] = None,
                         lifecycle_stage_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str lifecycle_stage_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the lifecycle stage.
    ...
    :param _builtins.str software_source_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the software source. This filter returns resources associated with this software source.
...
def get_lifecycle_stages_output(arch_type: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                ...
                                filters: pulumi.Input[Optional[Optional[Sequence[Union['GetLifecycleStagesFilterArgs', 'GetLifecycleStagesFilterArgsDict', 'outputs.GetLifecycleStagesFilterResult']]]]] = None,
                                lifecycle_stage_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
