...
class GetLifecycleStagesResult:
    ...
    def lifecycle_stage_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "lifecycle_stage_id")

    @property
    @pulumi.getter(name="locationNotEqualTos")
    def location_not_equal_tos(self) -> Optional[Sequence[builtins.str]]:
...
def get_lifecycle_stages(arch_type: Optional[builtins.str] = None,
                         ...
                         filters: Optional[Sequence[Union['GetLifecycleStagesFilterArgs', 'GetLifecycleStagesFilterArgsDict']]] = None,
                         lifecycle_stage_id: Optional[builtins.str] = None,
                         location_not_equal_tos: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.str lifecycle_stage_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the lifecycle stage.
    :param Sequence[builtins.str] location_not_equal_tos: A filter to return only resources whose location does not match the given value.
    :param Sequence[builtins.str] locations: A filter to return only resources whose location matches the given value.
    :param builtins.str os_family: A filter to return only resources that match the given operating system family.
    :param builtins.str software_source_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the software source. This filter returns resources associated with this software source.
...
def get_lifecycle_stages_output(arch_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                ...
                                filters: Optional[pulumi.Input[Optional[Sequence[Union['GetLifecycleStagesFilterArgs', 'GetLifecycleStagesFilterArgsDict']]]]] = None,
                                lifecycle_stage_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                location_not_equal_tos: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
