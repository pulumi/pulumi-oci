...
def get_managed_instance_available_packages(compartment_id: Optional[builtins.str] = None,
...
def get_managed_instance_available_packages_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
