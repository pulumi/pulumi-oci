...
__all__ = [
    'GetManagedInstanceAvailableSoftwareSourcesResult',
    'AwaitableGetManagedInstanceAvailableSoftwareSourcesResult',
    'get_managed_instance_available_software_sources',
    'get_managed_instance_available_software_sources_output',
]

@pulumi.output_type
class GetManagedInstanceAvailableSoftwareSourcesResult:
    """
    A collection of values returned by getManagedInstanceAvailableSoftwareSources.
    """
    def __init__(__self__, available_software_source_collections=None, compartment_id=None, display_name_contains=None, display_names=None, filters=None, id=None, managed_instance_id=None):
    ...
    def available_software_source_collections(self) -> Sequence['outputs.GetManagedInstanceAvailableSoftwareSourcesAvailableSoftwareSourceCollectionResult']:
        """
    ...
    @_builtins.property
    @pulumi.getter
    def filters(self) -> Optional[Sequence['outputs.GetManagedInstanceAvailableSoftwareSourcesFilterResult']]:
...
class AwaitableGetManagedInstanceAvailableSoftwareSourcesResult(GetManagedInstanceAvailableSoftwareSourcesResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetManagedInstanceAvailableSoftwareSourcesResult(
...
def get_managed_instance_available_software_sources(compartment_id: Optional[_builtins.str] = None,
                                                    display_name_contains: Optional[_builtins.str] = None,
                                                    display_names: Optional[Sequence[_builtins.str]] = None,
                                                    filters: Optional[Sequence[Union['GetManagedInstanceAvailableSoftwareSourcesFilterArgs', 'GetManagedInstanceAvailableSoftwareSourcesFilterArgsDict', 'outputs.GetManagedInstanceAvailableSoftwareSourcesFilterResult']]] = None,
                                                    managed_instance_id: Optional[_builtins.str] = None,
                                                    opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetManagedInstanceAvailableSoftwareSourcesResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('oci:OsManagementHub/getManagedInstanceAvailableSoftwareSources:getManagedInstanceAvailableSoftwareSources', __args__, opts=opts, typ=GetManagedInstanceAvailableSoftwareSourcesResult).value

    return AwaitableGetManagedInstanceAvailableSoftwareSourcesResult(
...
def get_managed_instance_available_software_sources_output(compartment_id: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                                           ...
                                                           filters: pulumi.Input[Optional[Optional[Sequence[Union['GetManagedInstanceAvailableSoftwareSourcesFilterArgs', 'GetManagedInstanceAvailableSoftwareSourcesFilterArgsDict', 'outputs.GetManagedInstanceAvailableSoftwareSourcesFilterResult']]]]] = None,
                                                           managed_instance_id: pulumi.Input[Optional[_builtins.str]] = None,
                                                           opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetManagedInstanceAvailableSoftwareSourcesResult]:
    """
    This data source provides the list of Managed Instance Available Software Sources in Oracle Cloud Infrastructure Os Management Hub service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:OsManagementHub/getManagedInstanceAvailableSoftwareSources:getManagedInstanceAvailableSoftwareSources', __args__, opts=opts, typ=GetManagedInstanceAvailableSoftwareSourcesResult)
    return __ret__.apply(lambda __response__: GetManagedInstanceAvailableSoftwareSourcesResult(
