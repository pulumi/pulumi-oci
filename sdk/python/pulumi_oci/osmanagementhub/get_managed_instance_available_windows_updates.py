...
class GetManagedInstanceAvailableWindowsUpdatesResult:
    ...
    def is_installable(self) -> Optional[_builtins.str]:
...
def get_managed_instance_available_windows_updates(classification_types: Optional[Sequence[_builtins.str]] = None,
                                                   compartment_id: Optional[_builtins.str] = None,
                                                   display_name: Optional[_builtins.str] = None,
                                                   display_name_contains: Optional[_builtins.str] = None,
                                                   filters: Optional[Sequence[Union['GetManagedInstanceAvailableWindowsUpdatesFilterArgs', 'GetManagedInstanceAvailableWindowsUpdatesFilterArgsDict', 'outputs.GetManagedInstanceAvailableWindowsUpdatesFilterResult']]] = None,
                                                   is_installable: Optional[_builtins.str] = None,
    ...
    :param _builtins.str is_installable: Indicates if the update can be installed by the OS Management Hub service.
    ...
    :param Sequence[_builtins.str] names: A filter based on the unique identifier for the Windows update. Note that this is not an OCID, but is a unique identifier assigned by Microsoft.  Example: '6981d463-cd91-4a26-b7c4-ea4ded9183ed'
    """
    __args__ = dict()
...
def get_managed_instance_available_windows_updates_output(classification_types: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                                                          ...
                                                          filters: pulumi.Input[Optional[Optional[Sequence[Union['GetManagedInstanceAvailableWindowsUpdatesFilterArgs', 'GetManagedInstanceAvailableWindowsUpdatesFilterArgsDict', 'outputs.GetManagedInstanceAvailableWindowsUpdatesFilterResult']]]]] = None,
