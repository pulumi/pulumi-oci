...
class GetManagedInstanceAvailableWindowsUpdatesResult:
    ...
    def is_installable(self) -> Optional[builtins.str]:
...
def get_managed_instance_available_windows_updates(classification_types: Optional[Sequence[builtins.str]] = None,
                                                   ...
                                                   is_installable: Optional[builtins.str] = None,
    ...
    :param builtins.str is_installable: Indicates if the update can be installed by the OS Management Hub service.
    ...
    :param Sequence[builtins.str] names: A filter based on the unique identifier for the Windows update. Note that this is not an OCID, but is a unique identifier assigned by Microsoft.  Example: '6981d463-cd91-4a26-b7c4-ea4ded9183ed'
    """
    __args__ = dict()
...
def get_managed_instance_available_windows_updates_output(classification_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                                          ...
                                                          is_installable: Optional[pulumi.Input[Optional[builtins.str]]] = None,
