...
def get_managed_instance_errata(classification_types: Optional[Sequence[builtins.str]] = None,
...
def get_managed_instance_errata_output(classification_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
