...
def get_managed_instance_group(managed_instance_group_id: Optional[builtins.str] = None,
...
def get_managed_instance_group_output(managed_instance_group_id: Optional[pulumi.Input[builtins.str]] = None,
