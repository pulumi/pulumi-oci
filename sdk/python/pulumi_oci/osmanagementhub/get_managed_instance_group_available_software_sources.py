...
def get_managed_instance_group_available_software_sources(compartment_id: Optional[builtins.str] = None,
...
def get_managed_instance_group_available_software_sources_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
