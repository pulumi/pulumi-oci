...
def get_managed_instance_groups(arch_type: Optional[builtins.str] = None,
...
def get_managed_instance_groups_output(arch_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
