...
class GetManagedInstanceInstalledPackagesResult:
    ...
    def time_install_date_end(self) -> Optional[builtins.str]:
        return pulumi.get(self, "time_install_date_end")

    @property
    @pulumi.getter(name="timeInstallDateStart")
    def time_install_date_start(self) -> Optional[builtins.str]:
...
def get_managed_instance_installed_packages(compartment_id: Optional[builtins.str] = None,
                                            display_name_contains: Optional[builtins.str] = None,
                                            display_names: Optional[Sequence[builtins.str]] = None,
                                            filters: Optional[Sequence[Union['GetManagedInstanceInstalledPackagesFilterArgs', 'GetManagedInstanceInstalledPackagesFilterArgsDict']]] = None,
                                            managed_instance_id: Optional[builtins.str] = None,
                                            time_install_date_end: Optional[builtins.str] = None,
                                            time_install_date_start: Optional[builtins.str] = None,
    ...
    :param builtins.str time_install_date_end: A filter to return only packages that were installed on or before the date provided, in ISO 8601 format.  Example: 2017-07-14T02:40:00.000Z
    :param builtins.str time_install_date_start: The install date after which to list all packages, in ISO 8601 format  Example: 2017-07-14T02:40:00.000Z
    """
    __args__ = dict()
...
def get_managed_instance_installed_packages_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                   ...
                                                   time_install_date_end: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                   time_install_date_start: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetManagedInstanceInstalledPackagesResult(
        ...
        installed_package_collections=pulumi.get(__response__, 'installed_package_collections'),
