...
def get_managed_instance_installed_windows_updates(compartment_id: Optional[builtins.str] = None,
...
def get_managed_instance_installed_windows_updates_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetManagedInstanceInstalledWindowsUpdatesResult(
        ...
        installed_windows_update_collections=pulumi.get(__response__, 'installed_windows_update_collections'),
