...
def get_managed_instance_modules(compartment_id: Optional[builtins.str] = None,
...
def get_managed_instance_modules_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
