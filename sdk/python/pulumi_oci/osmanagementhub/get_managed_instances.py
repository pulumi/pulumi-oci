...
class GetManagedInstancesResult:
    ...
    def group_not_equal_to(self) -> Optional[builtins.str]:
    ...
    def is_attached_to_group_or_lifecycle_stage(self) -> Optional[builtins.bool]:
    ...
    def is_management_station(self) -> Optional[builtins.bool]:
        """
    ...
    def is_profile_attached(self) -> Optional[builtins.bool]:
    ...
    def lifecycle_environment(self) -> Optional[builtins.str]:
        """
    ...
    def lifecycle_environment_not_equal_to(self) -> Optional[builtins.str]:
        return pulumi.get(self, "lifecycle_environment_not_equal_to")

    @property
    @pulumi.getter(name="lifecycleStage")
    def lifecycle_stage(self) -> Optional[builtins.str]:
        """
        Id and name of a resource to simplify the display for the user.
        """
    ...
    def lifecycle_stage_not_equal_to(self) -> Optional[builtins.str]:
    ...
    def profile_not_equal_tos(self) -> Optional[Sequence[builtins.str]]:
...
def get_managed_instances(advisory_names: Optional[Sequence[builtins.str]] = None,
                          agent_version: Optional[builtins.str] = None,
                          arch_types: Optional[Sequence[builtins.str]] = None,
                          ...
                          group_not_equal_to: Optional[builtins.str] = None,
                          is_attached_to_group_or_lifecycle_stage: Optional[builtins.bool] = None,
                          is_managed_by_autonomous_linux: Optional[builtins.bool] = None,
                          is_management_station: Optional[builtins.bool] = None,
                          is_profile_attached: Optional[builtins.bool] = None,
                          is_reboot_required: Optional[builtins.bool] = None,
                          lifecycle_environment: Optional[builtins.str] = None,
                          lifecycle_environment_not_equal_to: Optional[builtins.str] = None,
                          lifecycle_stage: Optional[builtins.str] = None,
                          lifecycle_stage_not_equal_to: Optional[builtins.str] = None,
                          ...
                          profile_not_equal_tos: Optional[Sequence[builtins.str]] = None,
    ...
    :param builtins.str group: A filter to return only managed instances that are attached to the specified group.
    :param builtins.str group_not_equal_to: A filter to return only managed instances that are NOT attached to the specified group.
    :param builtins.bool is_attached_to_group_or_lifecycle_stage: A filter to return only managed instances that are attached to the specified group or lifecycle environment.
    ...
    :param builtins.bool is_profile_attached: A filter to return only managed instances with a registration profile attached.
    ...
    :param builtins.str lifecycle_environment: A filter to return only managed instances in a specific lifecycle environment.
    :param builtins.str lifecycle_environment_not_equal_to: A filter to return only managed instances that aren't in a specific lifecycle environment.
    :param builtins.str lifecycle_stage: A filter to return only managed instances that are associated with the specified lifecycle environment.
    :param builtins.str lifecycle_stage_not_equal_to: A filter to return only managed instances that are NOT associated with the specified lifecycle environment.
    ...
    :param Sequence[builtins.str] profile_not_equal_tos: A multi filter to return only managed instances that don't contain the given profile [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    :param Sequence[builtins.str] profiles: A multi filter to return only managed instances that match the given profile ids.
    ...
    :param Sequence[builtins.str] statuses: A filter to return only managed instances whose status matches the status provided.
    """
    __args__ = dict()
...
def get_managed_instances_output(advisory_names: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                 agent_version: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 arch_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                 ...
                                 group_not_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 is_attached_to_group_or_lifecycle_stage: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                 is_managed_by_autonomous_linux: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                 is_management_station: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                 is_profile_attached: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                 is_reboot_required: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                 lifecycle_environment: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 lifecycle_environment_not_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 lifecycle_stage: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 lifecycle_stage_not_equal_to: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                 ...
                                 profile_not_equal_tos: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                 profiles: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
