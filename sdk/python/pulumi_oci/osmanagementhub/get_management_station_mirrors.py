...
class GetManagementStationMirrorsResult:
    ...
    def mirror_states(self) -> Optional[Sequence[builtins.str]]:
...
def get_management_station_mirrors(display_name: Optional[builtins.str] = None,
                                   ...
                                   management_station_id: Optional[builtins.str] = None,
                                   mirror_states: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] mirror_states: List of Mirror state to filter by
    """
    __args__ = dict()
...
def get_management_station_mirrors_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                          ...
                                          mirror_states: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
