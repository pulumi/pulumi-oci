...
def get_management_stations(compartment_id: Optional[builtins.str] = None,
...
def get_management_stations_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
