...
def get_profile_available_software_sources(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str profile_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the registration profile.
    """
    __args__ = dict()
...
def get_profile_available_software_sources_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
