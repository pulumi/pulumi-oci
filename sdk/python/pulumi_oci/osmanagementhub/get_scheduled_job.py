...
def get_scheduled_job(scheduled_job_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str scheduled_job_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the scheduled job.
    """
    __args__ = dict()
