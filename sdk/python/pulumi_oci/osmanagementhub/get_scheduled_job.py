...
def get_scheduled_job(scheduled_job_id: Optional[builtins.str] = None,
    ...
    :param builtins.str scheduled_job_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the scheduled job.
    """
    __args__ = dict()
...
def get_scheduled_job_output(scheduled_job_id: Optional[pulumi.Input[builtins.str]] = None,
