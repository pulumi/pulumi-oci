...
class GetScheduledJobsResult:
    ...
    def is_managed_by_autonomous_linux(self) -> Optional[builtins.bool]:
        """
    ...
    def is_restricted(self) -> Optional[builtins.bool]:
        """
    ...
    def managed_compartment_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "managed_compartment_id")

    @property
    @pulumi.getter(name="managedInstanceGroupId")
    def managed_instance_group_id(self) -> Optional[builtins.str]:
...
def get_scheduled_jobs(compartment_id: Optional[builtins.str] = None,
                       ...
                       is_managed_by_autonomous_linux: Optional[builtins.bool] = None,
                       is_restricted: Optional[builtins.bool] = None,
                       ...
                       managed_compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.bool compartment_id_in_subtree: Indicates whether to include subcompartments in the returned results. Default is false.
    ...
    :param builtins.str lifecycle_stage_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the lifecycle stage. This resource returns resources associated with this lifecycle stage.
    ...
    :param builtins.str managed_compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the managed compartment. This filter returns resources associated with this compartment.
    :param builtins.str managed_instance_group_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the managed instance group. This filter returns resources associated with this group.
    ...
    :param builtins.str time_end: A filter to return only resources with a date on or before the given value, in ISO 8601 format.  Example: 2017-07-14T02:40:00.000Z
    :param builtins.str time_start: A filter to return only resources with a date on or after the given value, in ISO 8601 format.  Example: 2017-07-14T02:40:00.000Z
    """
    __args__ = dict()
...
def get_scheduled_jobs_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              ...
                              is_managed_by_autonomous_linux: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                              is_restricted: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                              ...
                              managed_compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              managed_instance_group_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              managed_instance_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              operation_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              schedule_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetScheduledJobsResult(
        ...
        managed_compartment_id=pulumi.get(__response__, 'managed_compartment_id'),
        ...
        scheduled_job_collections=pulumi.get(__response__, 'scheduled_job_collections'),
