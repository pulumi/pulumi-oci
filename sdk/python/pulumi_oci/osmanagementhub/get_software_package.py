...
def get_software_package(software_package_name: Optional[builtins.str] = None,
...
def get_software_package_output(software_package_name: Optional[pulumi.Input[builtins.str]] = None,
