...
def get_software_packages(architecture: Optional[builtins.str] = None,
...
def get_software_packages_output(architecture: Optional[pulumi.Input[Optional[builtins.str]]] = None,
