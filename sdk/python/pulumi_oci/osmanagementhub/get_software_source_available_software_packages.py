...
def get_software_source_available_software_packages(display_name: Optional[builtins.str] = None,
...
def get_software_source_available_software_packages_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
