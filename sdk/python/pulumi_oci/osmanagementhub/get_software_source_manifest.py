...
def get_software_source_manifest(software_source_id: Optional[builtins.str] = None,
...
def get_software_source_manifest_output(software_source_id: Optional[pulumi.Input[builtins.str]] = None,
