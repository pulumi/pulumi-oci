...
def get_software_source_module_stream(module_name: Optional[_builtins.str] = None,
...
def get_software_source_module_stream_output(module_name: Optional[pulumi.Input[_builtins.str]] = None,
