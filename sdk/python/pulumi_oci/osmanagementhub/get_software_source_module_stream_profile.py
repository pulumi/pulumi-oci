...
def get_software_source_module_stream_profile(module_name: Optional[builtins.str] = None,
    ...
    :param builtins.str profile_name: The name of the module stream profile.
...
def get_software_source_module_stream_profile_output(module_name: Optional[pulumi.Input[builtins.str]] = None,
