...
class GetSoftwareSourcePackageGroupsResult:
    ...
    def group_types(self) -> Optional[Sequence[builtins.str]]:
        """
...
def get_software_source_package_groups(compartment_id: Optional[builtins.str] = None,
                                       ...
                                       group_types: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] group_types: A filter to return only package groups of the specified type.
...
def get_software_source_package_groups_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                              ...
                                              group_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
