...
def get_software_source_vendors(compartment_id: Optional[builtins.str] = None,
...
def get_software_source_vendors_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
