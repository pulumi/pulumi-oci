...
class GetSoftwareSourcesResult:
    ...
    def display_name_not_equal_tos(self) -> Optional[Sequence[_builtins.str]]:
    ...
    def is_mirror_sync_allowed(self) -> Optional[_builtins.bool]:
        """
...
def get_software_sources(arch_types: Optional[Sequence[_builtins.str]] = None,
                         ...
                         display_name_not_equal_tos: Optional[Sequence[_builtins.str]] = None,
                         filters: Optional[Sequence[Union['GetSoftwareSourcesFilterArgs', 'GetSoftwareSourcesFilterArgsDict', 'outputs.GetSoftwareSourcesFilterResult']]] = None,
                         is_mandatory_for_autonomous_linux: Optional[_builtins.bool] = None,
                         is_mirror_sync_allowed: Optional[_builtins.bool] = None,
    ...
    :param Sequence[_builtins.str] display_name_not_equal_tos: A multi filter to return resources that do not contains the given display names.
    ...
    :param _builtins.str software_source_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for the software source.
...
def get_software_sources_output(arch_types: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                                ...
                                display_name_not_equal_tos: pulumi.Input[Optional[Optional[Sequence[_builtins.str]]]] = None,
                                filters: pulumi.Input[Optional[Optional[Sequence[Union['GetSoftwareSourcesFilterArgs', 'GetSoftwareSourcesFilterArgsDict', 'outputs.GetSoftwareSourcesFilterResult']]]]] = None,
                                is_mandatory_for_autonomous_linux: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
                                is_mirror_sync_allowed: pulumi.Input[Optional[Optional[_builtins.bool]]] = None,
