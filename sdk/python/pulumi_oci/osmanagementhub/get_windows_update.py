...
class GetWindowsUpdateResult:
    ...
    def windows_update_id(self) -> _builtins.str:
...
def get_windows_update(windows_update_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str windows_update_id: The unique identifier for the Windows update. Note that this is not an OCID, but is a unique identifier assigned by Microsoft.  Example: '6981d463-cd91-4a26-b7c4-ea4ded9183ed'
    """
    __args__ = dict()
...
def get_windows_update_output(windows_update_id: Optional[pulumi.Input[_builtins.str]] = None,
