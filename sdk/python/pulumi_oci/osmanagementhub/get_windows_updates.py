...
def get_windows_updates(classification_types: Optional[Sequence[builtins.str]] = None,
...
def get_windows_updates_output(classification_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
