...
class _LifecycleEnvironmentState:
    def __init__(__self__, *,
                 ...
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 managed_instance_ids: pulumi.Input[Optional[Sequence[pulumi.Input['LifecycleEnvironmentManagedInstanceIdArgs']]]] = None,
                 os_family: pulumi.Input[Optional[_builtins.str]] = None,
                 stages: pulumi.Input[Optional[Sequence[pulumi.Input['LifecycleEnvironmentStageArgs']]]] = None,
    ...
    def managed_instance_ids(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['LifecycleEnvironmentManagedInstanceIdArgs']]]]:
        """
    ...
    def managed_instance_ids(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['LifecycleEnvironmentManagedInstanceIdArgs']]]]):
    ...
    @_builtins.property
    @pulumi.getter
    def stages(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['LifecycleEnvironmentStageArgs']]]]:
        """
        (Updatable) User-specified list of ranked lifecycle stages used within the lifecycle environment.
        """
        return pulumi.get(self, "stages")
    ...
    @stages.setter
    def stages(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['LifecycleEnvironmentStageArgs']]]]):
        pulumi.set(self, "stages", value)
...
class LifecycleEnvironment(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 os_family: pulumi.Input[Optional[_builtins.str]] = None,
                 stages: pulumi.Input[Optional[Sequence[pulumi.Input[Union['LifecycleEnvironmentStageArgs', 'LifecycleEnvironmentStageArgsDict', 'outputs.LifecycleEnvironmentStage']]]]] = None,
                 vendor_name: pulumi.Input[Optional[_builtins.str]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] location: The location of managed instances attached to the lifecycle environment. If no location is provided, the default is 'ON_PREMISE.'
        :param pulumi.Input[_builtins.str] os_family: The operating system of the managed instances in the lifecycle environment.
        :param pulumi.Input[Sequence[pulumi.Input[Union['LifecycleEnvironmentStageArgs', 'LifecycleEnvironmentStageArgsDict', 'outputs.LifecycleEnvironmentStage']]]] stages: (Updatable) User-specified list of ranked lifecycle stages used within the lifecycle environment.
        :param pulumi.Input[_builtins.str] vendor_name: The vendor of the operating system used by the managed instances in the lifecycle environment.
    ...
    def get(resource_name: str,
            ...
            freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            location: pulumi.Input[Optional[_builtins.str]] = None,
            managed_instance_ids: pulumi.Input[Optional[Sequence[pulumi.Input[Union['LifecycleEnvironmentManagedInstanceIdArgs', 'LifecycleEnvironmentManagedInstanceIdArgsDict', 'outputs.LifecycleEnvironmentManagedInstanceId']]]]] = None,
            os_family: pulumi.Input[Optional[_builtins.str]] = None,
            stages: pulumi.Input[Optional[Sequence[pulumi.Input[Union['LifecycleEnvironmentStageArgs', 'LifecycleEnvironmentStageArgsDict', 'outputs.LifecycleEnvironmentStage']]]]] = None,
            state: pulumi.Input[Optional[_builtins.str]] = None,
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_modified: pulumi.Input[Optional[_builtins.str]] = None,
            vendor_name: pulumi.Input[Optional[_builtins.str]] = None) -> 'LifecycleEnvironment':
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[_builtins.str] location: The location of managed instances attached to the lifecycle environment. If no location is provided, the default is 'ON_PREMISE.'
        :param pulumi.Input[Sequence[pulumi.Input[Union['LifecycleEnvironmentManagedInstanceIdArgs', 'LifecycleEnvironmentManagedInstanceIdArgsDict', 'outputs.LifecycleEnvironmentManagedInstanceId']]]] managed_instance_ids: The list of managed instances associated with the lifecycle stage.
        :param pulumi.Input[_builtins.str] os_family: The operating system of the managed instances in the lifecycle environment.
        :param pulumi.Input[Sequence[pulumi.Input[Union['LifecycleEnvironmentStageArgs', 'LifecycleEnvironmentStageArgsDict', 'outputs.LifecycleEnvironmentStage']]]] stages: (Updatable) User-specified list of ranked lifecycle stages used within the lifecycle environment.
        :param pulumi.Input[_builtins.str] state: The current state of the lifecycle environment.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"orcl-cloud.free-tier-retained": "true"}`
