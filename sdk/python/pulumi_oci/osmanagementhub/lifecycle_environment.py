...
class LifecycleEnvironmentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that contains the lifecycle environment.
...
class LifecycleEnvironment(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_modified: Optional[pulumi.Input[builtins.str]] = None,
            vendor_name: Optional[pulumi.Input[builtins.str]] = None) -> 'LifecycleEnvironment':
        """
