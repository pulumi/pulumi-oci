...
class ManagedInstanceAttachProfileManagementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] profile_id: The profile [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to attach to the managed instance.
...
@pulumi.type_token("oci:OsManagementHub/managedInstanceAttachProfileManagement:ManagedInstanceAttachProfileManagement")
class ManagedInstanceAttachProfileManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            managed_instance_id: Optional[pulumi.Input[builtins.str]] = None,
            profile_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ManagedInstanceAttachProfileManagement':
        """
