...
class ManagedInstanceGroupArgs:
    def __init__(__self__, *,
                 ...
                 autonomous_settings: pulumi.Input[Optional['ManagedInstanceGroupAutonomousSettingsArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] location: The location of managed instances attached to the group. If no location is provided, the default is on premises.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] managed_instance_ids: The list of managed instance [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to be added to the group.
    ...
    def autonomous_settings(self) -> pulumi.Input[Optional['ManagedInstanceGroupAutonomousSettingsArgs']]:
        """
    ...
    def autonomous_settings(self, value: pulumi.Input[Optional['ManagedInstanceGroupAutonomousSettingsArgs']]):
...
class _ManagedInstanceGroupState:
    def __init__(__self__, *,
                 ...
                 location: pulumi.Input[Optional[_builtins.str]] = None,
                 managed_instance_count: pulumi.Input[Optional[_builtins.int]] = None,
                 managed_instance_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 notification_topic_id: pulumi.Input[Optional[_builtins.str]] = None,
                 os_family: pulumi.Input[Optional[_builtins.str]] = None,
                 pending_job_count: pulumi.Input[Optional[_builtins.int]] = None,
                 software_source_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 software_sources: pulumi.Input[Optional[Sequence[pulumi.Input['ManagedInstanceGroupSoftwareSourceArgs']]]] = None,
        ...
        :param pulumi.Input[_builtins.str] display_name: (Updatable) A user-friendly name for the managed instance group. Does not have to be unique and you can change the name later. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[_builtins.bool] is_managed_by_autonomous_linux: Indicates whether the Autonomous Linux service manages the group.
        :param pulumi.Input[_builtins.str] location: The location of managed instances attached to the group. If no location is provided, the default is on premises.
        :param pulumi.Input[_builtins.int] managed_instance_count: The number of managed instances in the group.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] managed_instance_ids: The list of managed instance [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to be added to the group.
        :param pulumi.Input[_builtins.str] notification_topic_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for the Oracle Notifications service (ONS) topic. ONS is the channel used to send notifications to the customer.
        :param pulumi.Input[_builtins.str] os_family: The operating system type of the managed instances that will be attached to this group.
        :param pulumi.Input[_builtins.int] pending_job_count: The number of scheduled jobs pending against the managed instance group.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] software_source_ids: The list of software source [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) available to the managed instances in the group.
        ...
        :param pulumi.Input[_builtins.str] state: The current state of the managed instance group.
    ...
    def managed_instance_count(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def managed_instance_count(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def pending_job_count(self) -> pulumi.Input[Optional[_builtins.int]]:
        """
    ...
    def pending_job_count(self, value: pulumi.Input[Optional[_builtins.int]]):
    ...
    def software_sources(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['ManagedInstanceGroupSoftwareSourceArgs']]]]:
        """
    ...
    def software_sources(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['ManagedInstanceGroupSoftwareSourceArgs']]]]):
...
class ManagedInstanceGroup(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 arch_type: pulumi.Input[Optional[_builtins.str]] = None,
                 autonomous_settings: pulumi.Input[Optional[Union['ManagedInstanceGroupAutonomousSettingsArgs', 'ManagedInstanceGroupAutonomousSettingsArgsDict', 'outputs.ManagedInstanceGroupAutonomousSettings']]] = None,
                 compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 description: pulumi.Input[Optional[_builtins.str]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
    ...
    def get(resource_name: str,
            ...
            pending_job_count: pulumi.Input[Optional[_builtins.int]] = None,
            software_source_ids: pulumi.Input[Optional[Sequence[pulumi.Input[_builtins.str]]]] = None,
            software_sources: pulumi.Input[Optional[Sequence[pulumi.Input[Union['ManagedInstanceGroupSoftwareSourceArgs', 'ManagedInstanceGroupSoftwareSourceArgsDict', 'outputs.ManagedInstanceGroupSoftwareSource']]]]] = None,
            state: pulumi.Input[Optional[_builtins.str]] = None,
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_modified: pulumi.Input[Optional[_builtins.str]] = None,
            vendor_name: pulumi.Input[Optional[_builtins.str]] = None) -> 'ManagedInstanceGroup':
        """
        ...
        :param pulumi.Input[_builtins.int] pending_job_count: The number of scheduled jobs pending against the managed instance group.
        :param pulumi.Input[Sequence[pulumi.Input[_builtins.str]]] software_source_ids: The list of software source [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) available to the managed instances in the group.
        :param pulumi.Input[Sequence[pulumi.Input[Union['ManagedInstanceGroupSoftwareSourceArgs', 'ManagedInstanceGroupSoftwareSourceArgsDict', 'outputs.ManagedInstanceGroupSoftwareSource']]]] software_sources: The list of software sources that the managed instance group will use.
        :param pulumi.Input[_builtins.str] state: The current state of the managed instance group.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param pulumi.Input[_builtins.str] time_created: The time the managed instance group was created (in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) format).
        :param pulumi.Input[_builtins.str] time_modified: The time the managed instance group was last modified (in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) format).
    ...
    @_builtins.property
    @pulumi.getter(name="managedInstanceCount")
    def managed_instance_count(self) -> pulumi.Output[_builtins.int]:
        """
        The number of managed instances in the group.
        """
        return pulumi.get(self, "managed_instance_count")
    ...
    @_builtins.property
    @pulumi.getter(name="pendingJobCount")
    def pending_job_count(self) -> pulumi.Output[_builtins.int]:
        """
        The number of scheduled jobs pending against the managed instance group.
        """
        return pulumi.get(self, "pending_job_count")
