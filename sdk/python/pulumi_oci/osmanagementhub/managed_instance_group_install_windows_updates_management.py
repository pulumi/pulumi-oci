...
class ManagedInstanceGroupInstallWindowsUpdatesManagementArgs:
    def __init__(__self__, *,
                 ...
                 windows_update_types: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] windows_update_types: The type of Windows updates to be applied.
    ...
    def windows_update_types(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    def windows_update_types(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
...
class ManagedInstanceGroupInstallWindowsUpdatesManagement(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="windowsUpdateTypes")
    def windows_update_types(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The type of Windows updates to be applied.
        """
        return pulumi.get(self, "windows_update_types")
