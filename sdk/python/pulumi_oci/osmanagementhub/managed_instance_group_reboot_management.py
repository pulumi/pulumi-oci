...
class ManagedInstanceGroupRebootManagementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.int] reboot_timeout_in_mins: The number of minutes the service waits for the reboot to complete. If the instances in the group don't reboot  within this time, the reboot job status is set to failed.
