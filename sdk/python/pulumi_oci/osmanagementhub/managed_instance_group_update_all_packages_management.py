...
class ManagedInstanceGroupUpdateAllPackagesManagementArgs:
    def __init__(__self__, *,
                 ...
                 update_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] update_types: The type of updates to be applied.
    ...
    def update_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    @update_types.setter
    def update_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ManagedInstanceGroupUpdateAllPackagesManagement(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="updateTypes")
    def update_types(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        The type of updates to be applied.
        """
        return pulumi.get(self, "update_types")
