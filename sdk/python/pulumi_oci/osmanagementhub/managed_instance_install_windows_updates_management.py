...
class ManagedInstanceInstallWindowsUpdatesManagementArgs:
    def __init__(__self__, *,
                 ...
                 windows_update_types: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] windows_update_names: The list of Windows update unique identifiers.  Note that this is not an OCID, but is a unique identifier assigned by Microsoft. Example: '6981d463-cd91-4a26-b7c4-ea4ded9183ed'
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] windows_update_types: The types of Windows updates to be installed.
    ...
    def windows_update_types(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def windows_update_types(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class ManagedInstanceInstallWindowsUpdatesManagement(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="windowsUpdateNames")
    def windows_update_names(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The list of Windows update unique identifiers.  Note that this is not an OCID, but is a unique identifier assigned by Microsoft. Example: '6981d463-cd91-4a26-b7c4-ea4ded9183ed'
        """
        return pulumi.get(self, "windows_update_names")
    ...
    @property
    @pulumi.getter(name="windowsUpdateTypes")
    def windows_update_types(self) -> pulumi.Output[Optional[Sequence[builtins.str]]]:
        """
        The types of Windows updates to be installed.
        """
        return pulumi.get(self, "windows_update_types")
