...
__all__ = ['ManagedInstanceRemovePackagesManagementArgs', 'ManagedInstanceRemovePackagesManagement']

@pulumi.input_type
class ManagedInstanceRemovePackagesManagementArgs:
    def __init__(__self__, *,
                 managed_instance_id: pulumi.Input[_builtins.str],
                 package_names: pulumi.Input[Sequence[pulumi.Input[_builtins.str]]],
                 work_request_details: Optional[pulumi.Input['ManagedInstanceRemovePackagesManagementWorkRequestDetailsArgs']] = None):
        """
        ...
        :param pulumi.Input['ManagedInstanceRemovePackagesManagementWorkRequestDetailsArgs'] work_request_details: Provides the name and description of the job.
        """
    ...
    def work_request_details(self) -> Optional[pulumi.Input['ManagedInstanceRemovePackagesManagementWorkRequestDetailsArgs']]:
        """
    ...
    def work_request_details(self, value: Optional[pulumi.Input['ManagedInstanceRemovePackagesManagementWorkRequestDetailsArgs']]):
        pulumi.set(self, "work_request_details", value)


@pulumi.input_type
class _ManagedInstanceRemovePackagesManagementState:
    def __init__(__self__, *,
...
@pulumi.type_token("oci:OsManagementHub/managedInstanceRemovePackagesManagement:ManagedInstanceRemovePackagesManagement")
class ManagedInstanceRemovePackagesManagement(pulumi.CustomResource):
    @overload
    def __init__(__self__,
                 resource_name: str,
                 ...
                 managed_instance_id: Optional[pulumi.Input[_builtins.str]] = None,
                 package_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
                 work_request_details: Optional[pulumi.Input[Union['ManagedInstanceRemovePackagesManagementWorkRequestDetailsArgs', 'ManagedInstanceRemovePackagesManagementWorkRequestDetailsArgsDict']]] = None,
                 __props__=None):
        """
    ...
    def __init__(__self__,
        ...
        :param str resource_name: The name of the resource.
        :param ManagedInstanceRemovePackagesManagementArgs args: The arguments to use to populate this resource's properties.
        :param pulumi.ResourceOptions opts: Options for the resource.
        """
        ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        resource_args, opts = _utilities.get_resource_args_opts(ManagedInstanceRemovePackagesManagementArgs, pulumi.ResourceOptions, *args, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__ = ManagedInstanceRemovePackagesManagementArgs.__new__(ManagedInstanceRemovePackagesManagementArgs)
        ...
        super(ManagedInstanceRemovePackagesManagement, __self__).__init__(
            'oci:OsManagementHub/managedInstanceRemovePackagesManagement:ManagedInstanceRemovePackagesManagement',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            managed_instance_id: Optional[pulumi.Input[_builtins.str]] = None,
            package_names: Optional[pulumi.Input[Sequence[pulumi.Input[_builtins.str]]]] = None,
            work_request_details: Optional[pulumi.Input[Union['ManagedInstanceRemovePackagesManagementWorkRequestDetailsArgs', 'ManagedInstanceRemovePackagesManagementWorkRequestDetailsArgsDict']]] = None) -> 'ManagedInstanceRemovePackagesManagement':
        """
        ...
        __props__ = _ManagedInstanceRemovePackagesManagementState.__new__(_ManagedInstanceRemovePackagesManagementState)

        __props__.__dict__["managed_instance_id"] = managed_instance_id
        __props__.__dict__["package_names"] = package_names
        __props__.__dict__["work_request_details"] = work_request_details
        return ManagedInstanceRemovePackagesManagement(resource_name, opts=opts, __props__=__props__)
    ...
    @_builtins.property
    @pulumi.getter(name="workRequestDetails")
    def work_request_details(self) -> pulumi.Output['outputs.ManagedInstanceRemovePackagesManagementWorkRequestDetails']:
        """
        Provides the name and description of the job.
        """
        return pulumi.get(self, "work_request_details")
