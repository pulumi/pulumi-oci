...
class ManagedInstanceUpdatePackagesManagementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] update_types: The types of updates to be applied.
...
class ManagedInstanceUpdatePackagesManagement(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 package_names: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 update_types: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
                 work_request_details: Optional[pulumi.Input[pulumi.InputType['ManagedInstanceUpdatePackagesManagementWorkRequestDetailsArgs']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[str]]] package_names: The list of package names.
        :param pulumi.Input[Sequence[pulumi.Input[str]]] update_types: The types of updates to be applied.
        :param pulumi.Input[pulumi.InputType['ManagedInstanceUpdatePackagesManagementWorkRequestDetailsArgs']] work_request_details: Provides the name and description of the job.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            package_names: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            update_types: Optional[pulumi.Input[Sequence[pulumi.Input[str]]]] = None,
            work_request_details: Optional[pulumi.Input[pulumi.InputType['ManagedInstanceUpdatePackagesManagementWorkRequestDetailsArgs']]] = None) -> 'ManagedInstanceUpdatePackagesManagement':
        """
    ...
    @property
    @pulumi.getter(name="packageNames")
    def package_names(self) -> pulumi.Output[Optional[Sequence[str]]]:
        """
        The list of package names.
        """
        return pulumi.get(self, "package_names")
    ...
    @property
    @pulumi.getter(name="updateTypes")
    def update_types(self) -> pulumi.Output[Optional[Sequence[str]]]:
        """
        The types of updates to be applied.
        """
        return pulumi.get(self, "update_types")
