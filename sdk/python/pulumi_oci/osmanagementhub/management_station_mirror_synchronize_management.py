...
class ManagementStationMirrorSynchronizeManagementArgs:
    def __init__(__self__, *,
                 management_station_id: pulumi.Input[builtins.str],
                 mirror_id: pulumi.Input[builtins.str]):
        """
        The set of arguments for constructing a ManagementStationMirrorSynchronizeManagement resource.
        :param pulumi.Input[builtins.str] management_station_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management station.
        :param pulumi.Input[builtins.str] mirror_id: Unique Software Source identifier
    ...
    def management_station_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def management_station_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "management_station_id", value)

    @property
    @pulumi.getter(name="mirrorId")
    def mirror_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @mirror_id.setter
    def mirror_id(self, value: pulumi.Input[builtins.str]):
...
class _ManagementStationMirrorSynchronizeManagementState:
    def __init__(__self__, *,
                 management_station_id: Optional[pulumi.Input[builtins.str]] = None,
                 mirror_id: Optional[pulumi.Input[builtins.str]] = None):
        """
    ...
    @property
    @pulumi.getter(name="managementStationId")
    def management_station_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management station.
        """
        return pulumi.get(self, "management_station_id")
    ...
    @management_station_id.setter
    def management_station_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "management_station_id", value)

    @property
    @pulumi.getter(name="mirrorId")
    def mirror_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Unique Software Source identifier
    ...
    @mirror_id.setter
    def mirror_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mirror_id", value)


class ManagementStationMirrorSynchronizeManagement(pulumi.CustomResource):

    pulumi_type = "oci:OsManagementHub/managementStationMirrorSynchronizeManagement:ManagementStationMirrorSynchronizeManagement"
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            management_station_id: Optional[pulumi.Input[builtins.str]] = None,
            mirror_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ManagementStationMirrorSynchronizeManagement':
        """
    ...
    @property
    @pulumi.getter(name="managementStationId")
    def management_station_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management station.
        """
        return pulumi.get(self, "management_station_id")
    ...
    @property
    @pulumi.getter(name="mirrorId")
    def mirror_id(self) -> pulumi.Output[builtins.str]:
        """
        Unique Software Source identifier
