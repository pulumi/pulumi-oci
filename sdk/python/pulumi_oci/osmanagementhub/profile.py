...
class ProfileArgs:
    def __init__(__self__, *,
                 ...
                 is_default_profile: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 registration_type: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that contains the registration profile.
        ...
        :param pulumi.Input[builtins.str] profile_type: The type of profile.
        :param pulumi.Input[builtins.str] arch_type: The architecture type.
        ...
        :param pulumi.Input[builtins.bool] is_default_profile: (Updatable) Indicates if the profile is set as the default. There is exactly one default profile for a specified architecture, OS family, registration type, and vendor. When registering an instance with the corresonding characteristics, the default profile is used, unless another profile is specified.
        :param pulumi.Input[builtins.str] lifecycle_stage_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the lifecycle stage that the instance will be associated with.
        :param pulumi.Input[builtins.str] managed_instance_group_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the managed instance group that the instance will join after registration.
        :param pulumi.Input[builtins.str] management_station_id: description: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management station to associate  with an instance once registered. This is required when creating a profile for non-OCI instances.
        :param pulumi.Input[builtins.str] os_family: The operating system family.
        :param pulumi.Input[builtins.str] registration_type: The type of instance to register.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] software_source_ids: The list of software source [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) that the registration profile will use.
        :param pulumi.Input[builtins.str] vendor_name: The vendor of the operating system for the instance.
    ...
    def is_default_profile(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_default_profile(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def registration_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def registration_type(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ProfileState:
    def __init__(__self__, *,
                 ...
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_default_profile: Optional[pulumi.Input[builtins.bool]] = None,
                 is_service_provided_profile: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] is_default_profile: (Updatable) Indicates if the profile is set as the default. There is exactly one default profile for a specified architecture, OS family, registration type, and vendor. When registering an instance with the corresonding characteristics, the default profile is used, unless another profile is specified.
        :param pulumi.Input[builtins.bool] is_service_provided_profile: Indicates if the profile was created by the service. OS Management Hub provides a limited set of standardized profiles that can be used to register Autonomous Linux or Windows instances.
        ...
        :param pulumi.Input[builtins.str] os_family: The operating system family.
        :param pulumi.Input[builtins.str] profile_type: The type of profile.
        :param pulumi.Input[builtins.str] profile_version: The version of the profile. The version is automatically incremented each time the profiled is edited.
        :param pulumi.Input[builtins.str] registration_type: The type of instance to register.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] software_source_ids: The list of software source [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) that the registration profile will use.
        ...
        :param pulumi.Input[builtins.str] state: The current state of the registration profile.
        ...
        :param pulumi.Input[builtins.str] time_created: The time the registration profile was created (in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) format).
        :param pulumi.Input[builtins.str] time_modified: The time the registration profile was last modified (in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) format).
        :param pulumi.Input[builtins.str] vendor_name: The vendor of the operating system for the instance.
    ...
    def is_service_provided_profile(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_service_provided_profile(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class Profile(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_modified: Optional[pulumi.Input[builtins.str]] = None,
            vendor_name: Optional[pulumi.Input[builtins.str]] = None) -> 'Profile':
        """
    ...
    @property
    @pulumi.getter(name="isDefaultProfile")
    def is_default_profile(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Indicates if the profile is set as the default. There is exactly one default profile for a specified architecture, OS family, registration type, and vendor. When registering an instance with the corresonding characteristics, the default profile is used, unless another profile is specified.
        """
        return pulumi.get(self, "is_default_profile")
    ...
    @property
    @pulumi.getter(name="isServiceProvidedProfile")
    def is_service_provided_profile(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates if the profile was created by the service. OS Management Hub provides a limited set of standardized profiles that can be used to register Autonomous Linux or Windows instances.
        """
        return pulumi.get(self, "is_service_provided_profile")
    ...
    @property
    @pulumi.getter(name="registrationType")
    def registration_type(self) -> pulumi.Output[builtins.str]:
        """
        The type of instance to register.
        """
        return pulumi.get(self, "registration_type")
