...
class ProfileAttachManagementStationManagementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] management_station_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the management station that the instance will be associated with.
...
class ProfileAttachManagementStationManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            management_station_id: Optional[pulumi.Input[builtins.str]] = None,
            profile_id: Optional[pulumi.Input[builtins.str]] = None) -> 'ProfileAttachManagementStationManagement':
        """
