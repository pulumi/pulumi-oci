...
class ProfileAttachSoftwareSourcesManagementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] software_sources: List of software source [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to attach to the profile.
...
class ProfileAttachSoftwareSourcesManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            opts: Optional[pulumi.ResourceOptions] = None,
            profile_id: Optional[pulumi.Input[builtins.str]] = None,
            software_sources: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'ProfileAttachSoftwareSourcesManagement':
        """
