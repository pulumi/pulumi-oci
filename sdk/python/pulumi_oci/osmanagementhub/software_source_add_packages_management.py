...
class SoftwareSourceAddPackagesManagementArgs:
    def __init__(__self__, *,
                 packages: pulumi.Input[Sequence[pulumi.Input[builtins.str]]],
                 software_source_id: pulumi.Input[builtins.str],
                 is_continue_on_missing_packages: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a SoftwareSourceAddPackagesManagement resource.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] packages: List of packages specified by the name of the package (N) or the full package name (NVRA or NEVRA).
        ...
        :param pulumi.Input[builtins.bool] is_continue_on_missing_packages: Indicates whether the service should generate a custom software source when the package list contains invalid values. When set to true, the service ignores any invalid packages and generates the custom software source with using the valid packages.
        """
    ...
    @property
    @pulumi.getter
    def packages(self) -> pulumi.Input[Sequence[pulumi.Input[builtins.str]]]:
        """
    ...
    @packages.setter
    def packages(self, value: pulumi.Input[Sequence[pulumi.Input[builtins.str]]]):
    ...
    def is_continue_on_missing_packages(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_continue_on_missing_packages(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class SoftwareSourceAddPackagesManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            is_continue_on_missing_packages: Optional[pulumi.Input[builtins.bool]] = None,
            packages: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
            software_source_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SoftwareSourceAddPackagesManagement':
        """
    ...
    @property
    @pulumi.getter(name="isContinueOnMissingPackages")
    def is_continue_on_missing_packages(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the service should generate a custom software source when the package list contains invalid values. When set to true, the service ignores any invalid packages and generates the custom software source with using the valid packages.
        """
        return pulumi.get(self, "is_continue_on_missing_packages")
