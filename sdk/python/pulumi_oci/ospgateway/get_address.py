...
def get_address(address_id: Optional[builtins.str] = None,
    ...
    :param builtins.str address_id: The identifier of the address.
...
def get_address_output(address_id: Optional[pulumi.Input[builtins.str]] = None,
