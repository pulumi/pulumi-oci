...
def get_address_rule(compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str country_code: Country code for the address rule in ISO-3166-1 2-letter format.
...
def get_address_rule_output(compartment_id: Optional[pulumi.Input[_builtins.str]] = None,
