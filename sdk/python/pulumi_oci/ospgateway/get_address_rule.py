...
def get_address_rule(compartment_id: Optional[builtins.str] = None,
                     country_code: Optional[builtins.str] = None,
                     osp_home_region: Optional[builtins.str] = None,
    ...
    :param builtins.str country_code: Country code for the address rule in ISO-3166-1 2-letter format.
...
def get_address_rule_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
