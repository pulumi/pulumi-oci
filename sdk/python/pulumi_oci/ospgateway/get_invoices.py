...
class GetInvoicesResult:
    ...
    def search_text(self) -> Optional[builtins.str]:
...
def get_invoices(compartment_id: Optional[builtins.str] = None,
                 ...
                 search_text: Optional[builtins.str] = None,
                 statuses: Optional[Sequence[builtins.str]] = None,
                 time_invoice_end: Optional[builtins.str] = None,
                 time_invoice_start: Optional[builtins.str] = None,
                 time_payment_end: Optional[builtins.str] = None,
                 time_payment_start: Optional[builtins.str] = None,
    ...
    :param builtins.str search_text: A filter to only return resources that match the given value. Looking for partial matches in the following fileds: Invoice No., Reference No. (plan number), Payment Ref, Total Amount(plan number), Balance Due(plan number) and Party/Customer Name
    :param Sequence[builtins.str] statuses: A filter to only return resources that match one of the status elements.
    :param builtins.str time_invoice_end: description: End time (UTC) of the target invoice date range for which to fetch invoice data (exclusive).
    :param builtins.str time_invoice_start: description: Start time (UTC) of the target invoice date range for which to fetch invoice data (inclusive).
    :param builtins.str time_payment_end: description: End time (UTC) of the target payment date range for which to fetch invoice data (exclusive).
    :param builtins.str time_payment_start: description: Start time (UTC) of the target payment date range for which to fetch invoice data (inclusive).
    :param Sequence[builtins.str] types: A filter to only return resources that match the given type exactly.
    """
    __args__ = dict()
...
def get_invoices_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                        filters: Optional[pulumi.Input[Optional[Sequence[Union['GetInvoicesFilterArgs', 'GetInvoicesFilterArgsDict']]]]] = None,
                        invoice_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        osp_home_region: Optional[pulumi.Input[builtins.str]] = None,
                        search_text: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        statuses: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                        time_invoice_end: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        time_invoice_start: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        time_payment_end: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                        time_payment_start: Optional[pulumi.Input[Optional[builtins.str]]] = None,
