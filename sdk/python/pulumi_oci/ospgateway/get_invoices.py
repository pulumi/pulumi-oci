...
def get_invoices(compartment_id: Optional[_builtins.str] = None,
                 ...
                 time_invoice_end: Optional[_builtins.str] = None,
                 time_invoice_start: Optional[_builtins.str] = None,
                 time_payment_end: Optional[_builtins.str] = None,
                 time_payment_start: Optional[_builtins.str] = None,
    ...
    :param _builtins.str search_text: A filter to only return resources that match the given value. Looking for partial matches in the following fileds: Invoice No., Reference No. (plan number), Payment Ref, Total Amount(plan number), Balance Due(plan number) and Party/Customer Name
    :param Sequence[_builtins.str] statuses: A filter to only return resources that match one of the status elements.
    :param _builtins.str time_invoice_end: description: End time (UTC) of the target invoice date range for which to fetch invoice data (exclusive).
    :param _builtins.str time_invoice_start: description: Start time (UTC) of the target invoice date range for which to fetch invoice data (inclusive).
    :param _builtins.str time_payment_end: description: End time (UTC) of the target payment date range for which to fetch invoice data (exclusive).
    :param _builtins.str time_payment_start: description: Start time (UTC) of the target payment date range for which to fetch invoice data (inclusive).
    :param Sequence[_builtins.str] types: A filter to only return resources that match the given type exactly.
    """
    __args__ = dict()
