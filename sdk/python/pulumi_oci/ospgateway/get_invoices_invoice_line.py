...
def get_invoices_invoice_line(compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str internal_invoice_id: The identifier of the invoice.
...
def get_invoices_invoice_line_output(compartment_id: Optional[pulumi.Input[_builtins.str]] = None,
