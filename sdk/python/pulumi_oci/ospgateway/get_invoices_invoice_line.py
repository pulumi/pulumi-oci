...
def get_invoices_invoice_line(compartment_id: Optional[str] = None,
    ...
    test_invoices_invoice_line = oci.OspGateway.get_invoices_invoice_line(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
