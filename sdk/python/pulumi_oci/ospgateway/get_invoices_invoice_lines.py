...
def get_invoices_invoice_lines(compartment_id: Optional[builtins.str] = None,
...
def get_invoices_invoice_lines_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
