...
def get_subscription(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str subscription_id: Subscription id(OCID).
    """
    __args__ = dict()
...
def get_subscription_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
