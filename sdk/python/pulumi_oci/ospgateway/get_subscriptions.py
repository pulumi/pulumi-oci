...
def get_subscriptions(compartment_id: Optional[str] = None,
    ...
    test_subscriptions = oci.OspGateway.get_subscriptions(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
