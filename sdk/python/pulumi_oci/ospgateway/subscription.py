...
class SubscriptionArgs:
    def __init__(__self__, *,
                 ...
                 osp_home_region: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] osp_home_region: (Updatable) The home region's public name of the logged in user.
        ...
        :param pulumi.Input[builtins.str] subscription_id: Subscription id(OCID).
    ...
    def osp_home_region(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def osp_home_region(self, value: pulumi.Input[builtins.str]):
...
class _SubscriptionState:
    def __init__(__self__, *,
                 ...
                 bill_to_cust_account_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 osp_home_region: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 ship_to_cust_acct_role_id: Optional[pulumi.Input[builtins.str]] = None,
                 ship_to_cust_acct_site_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 subscription_plan_number: Optional[pulumi.Input[builtins.str]] = None,
                 tax_infos: Optional[pulumi.Input[Sequence[pulumi.Input['SubscriptionTaxInfoArgs']]]] = None,
                 time_personal_to_corporate_conv: Optional[pulumi.Input[builtins.str]] = None,
                 time_plan_upgrade: Optional[pulumi.Input[builtins.str]] = None,
                 time_start: Optional[pulumi.Input[builtins.str]] = None,
                 upgrade_state: Optional[pulumi.Input[builtins.str]] = None,
                 upgrade_state_details: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Subscription resources.
        :param pulumi.Input[builtins.str] account_type: Account type.
        :param pulumi.Input[builtins.str] bill_to_cust_account_id: Bill to customer Account id.
        ...
        :param pulumi.Input[builtins.str] plan_type: Subscription plan type.
        :param pulumi.Input[builtins.str] ship_to_cust_acct_role_id: Ship to customer account role.
        :param pulumi.Input[builtins.str] ship_to_cust_acct_site_id: Ship to customer account site address id.
        :param pulumi.Input['SubscriptionSubscriptionArgs'] subscription: (Updatable) Subscription details object which extends the SubscriptionSummary
        :param pulumi.Input[builtins.str] subscription_id: Subscription id(OCID).
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] subscription_plan_number: Subscription plan number.
        :param pulumi.Input[Sequence[pulumi.Input['SubscriptionTaxInfoArgs']]] tax_infos: Tax details.
        :param pulumi.Input[builtins.str] time_personal_to_corporate_conv: Date of upgrade/conversion when account type changed from PERSONAL to CORPORATE
        :param pulumi.Input[builtins.str] time_plan_upgrade: Date of upgrade/conversion when planType changed from FREE_TIER to PAYG
        :param pulumi.Input[builtins.str] time_start: Start date of the subscription.
        :param pulumi.Input[builtins.str] upgrade_state: Status of the upgrade.
        :param pulumi.Input[builtins.str] upgrade_state_details: This field is used to describe the Upgrade State in case of error (E.g. Upgrade failure caused by interfacing Tax details- TaxError)
        """
    ...
    def bill_to_cust_account_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def bill_to_cust_account_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def gsi_org_code(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def is_intent_to_pay(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    @property
    @pulumi.getter(name="ospHomeRegion")
    def osp_home_region(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The home region's public name of the logged in user.
        """
        return pulumi.get(self, "osp_home_region")
    ...
    @osp_home_region.setter
    def osp_home_region(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "osp_home_region", value)
    ...
    def ship_to_cust_acct_role_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ship_to_cust_acct_role_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "ship_to_cust_acct_role_id", value)

    @property
    @pulumi.getter(name="shipToCustAcctSiteId")
    def ship_to_cust_acct_site_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def ship_to_cust_acct_site_id(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def subscription_plan_number(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def subscription_plan_number(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_personal_to_corporate_conv(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_personal_to_corporate_conv(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_personal_to_corporate_conv", value)

    @property
    @pulumi.getter(name="timePlanUpgrade")
    def time_plan_upgrade(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_plan_upgrade(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def upgrade_state(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def upgrade_state(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "upgrade_state", value)

    @property
    @pulumi.getter(name="upgradeStateDetails")
    def upgrade_state_details(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def upgrade_state_details(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "upgrade_state_details", value)


@pulumi.type_token("oci:OspGateway/subscription:Subscription")
class Subscription(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_start: Optional[pulumi.Input[builtins.str]] = None,
            upgrade_state: Optional[pulumi.Input[builtins.str]] = None,
            upgrade_state_details: Optional[pulumi.Input[builtins.str]] = None) -> 'Subscription':
        """
    ...
    @property
    @pulumi.getter(name="billToCustAccountId")
    def bill_to_cust_account_id(self) -> pulumi.Output[builtins.str]:
        """
        Bill to customer Account id.
        """
        return pulumi.get(self, "bill_to_cust_account_id")
    ...
    @property
    @pulumi.getter(name="currencyCode")
    def currency_code(self) -> pulumi.Output[builtins.str]:
        """
        Currency code
        """
        return pulumi.get(self, "currency_code")
    ...
    @property
    @pulumi.getter(name="gsiOrgCode")
    def gsi_org_code(self) -> pulumi.Output[builtins.str]:
        """
        GSI Subscription external code.
        """
        return pulumi.get(self, "gsi_org_code")
    ...
    @property
    @pulumi.getter(name="ospHomeRegion")
    def osp_home_region(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The home region's public name of the logged in user.
        """
        return pulumi.get(self, "osp_home_region")
    ...
    @property
    @pulumi.getter(name="planType")
    def plan_type(self) -> pulumi.Output[builtins.str]:
        """
        Subscription plan type.
        """
        return pulumi.get(self, "plan_type")
    ...
    @property
    @pulumi.getter(name="shipToCustAcctRoleId")
    def ship_to_cust_acct_role_id(self) -> pulumi.Output[builtins.str]:
        """
        Ship to customer account role.
        """
        return pulumi.get(self, "ship_to_cust_acct_role_id")
    ...
    @property
    @pulumi.getter(name="shipToCustAcctSiteId")
    def ship_to_cust_acct_site_id(self) -> pulumi.Output[builtins.str]:
        """
        Ship to customer account site address id.
        """
        return pulumi.get(self, "ship_to_cust_acct_site_id")
    ...
    @property
    @pulumi.getter(name="subscriptionPlanNumber")
    def subscription_plan_number(self) -> pulumi.Output[builtins.str]:
        """
        Subscription plan number.
        """
        return pulumi.get(self, "subscription_plan_number")
    ...
    @property
    @pulumi.getter(name="timePersonalToCorporateConv")
    def time_personal_to_corporate_conv(self) -> pulumi.Output[builtins.str]:
        """
        Date of upgrade/conversion when account type changed from PERSONAL to CORPORATE
        """
        return pulumi.get(self, "time_personal_to_corporate_conv")
    ...
    @property
    @pulumi.getter(name="timePlanUpgrade")
    def time_plan_upgrade(self) -> pulumi.Output[builtins.str]:
        """
        Date of upgrade/conversion when planType changed from FREE_TIER to PAYG
        """
        return pulumi.get(self, "time_plan_upgrade")
    ...
    @property
    @pulumi.getter(name="timeStart")
    def time_start(self) -> pulumi.Output[builtins.str]:
        """
        Start date of the subscription.
        """
        return pulumi.get(self, "time_start")
    ...
    @property
    @pulumi.getter(name="upgradeState")
    def upgrade_state(self) -> pulumi.Output[builtins.str]:
        """
        Status of the upgrade.
        """
        return pulumi.get(self, "upgrade_state")
    ...
    @property
    @pulumi.getter(name="upgradeStateDetails")
    def upgrade_state_details(self) -> pulumi.Output[builtins.str]:
        """
        This field is used to describe the Upgrade State in case of error (E.g. Upgrade failure caused by interfacing Tax details- TaxError)
        """
        return pulumi.get(self, "upgrade_state_details")
