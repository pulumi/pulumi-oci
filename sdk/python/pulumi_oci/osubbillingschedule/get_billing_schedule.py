...
def get_billing_schedule(compartment_id: Optional[builtins.str] = None,
...
def get_billing_schedule_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
