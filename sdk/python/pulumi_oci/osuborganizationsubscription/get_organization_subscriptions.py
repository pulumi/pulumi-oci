...
class GetOrganizationSubscriptionsResult:
    ...
    def subscription_ids(self) -> _builtins.str:
...
def get_organization_subscriptions(compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str subscription_ids: Comma separated list of subscription ids, pass "DUMMY" as value
...
def get_organization_subscriptions_output(compartment_id: Optional[pulumi.Input[_builtins.str]] = None,
                                          ...
                                          subscription_ids: Optional[pulumi.Input[_builtins.str]] = None,
