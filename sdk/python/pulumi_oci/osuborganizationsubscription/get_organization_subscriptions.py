...
class GetOrganizationSubscriptionsResult:
    ...
    def subscription_ids(self) -> builtins.str:
...
def get_organization_subscriptions(compartment_id: Optional[builtins.str] = None,
                                   ...
                                   subscription_ids: Optional[builtins.str] = None,
    ...
    :param builtins.str subscription_ids: Comma separated list of subscription ids, pass "DUMMY" as value
...
def get_organization_subscriptions_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                          ...
                                          subscription_ids: Optional[pulumi.Input[builtins.str]] = None,
