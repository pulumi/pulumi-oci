...
class GetCommitmentsResult:
    ...
    def x_one_gateway_subscription_id(self) -> Optional[_builtins.str]:
...
def get_commitments(compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str x_one_gateway_subscription_id: This header is meant to be used only for internal purposes and will be ignored on any public request. The purpose of this header is  to help on Gateway to API calls identification.
