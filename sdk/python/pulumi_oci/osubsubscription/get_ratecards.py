...
def get_ratecards(compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str time_from: This param is used to get the rate card(s) whose effective start date starts on or after a particular date
    :param _builtins.str time_to: This param is used to get the rate card(s) whose effective end date ends on or before a particular date
