...
class GetRatecardsResult:
    ...
    def part_number(self) -> Optional[builtins.str]:
        """
        Product part numner
        """
...
def get_ratecards(compartment_id: Optional[builtins.str] = None,
                  filters: Optional[Sequence[Union['GetRatecardsFilterArgs', 'GetRatecardsFilterArgsDict']]] = None,
                  part_number: Optional[builtins.str] = None,
    ...
    :param builtins.str time_from: This param is used to get the rate card(s) whose effective start date starts on or after a particular date
    :param builtins.str time_to: This param is used to get the rate card(s) whose effective end date ends on or before a particular date
...
def get_ratecards_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                         filters: Optional[pulumi.Input[Optional[Sequence[Union['GetRatecardsFilterArgs', 'GetRatecardsFilterArgsDict']]]]] = None,
                         part_number: Optional[pulumi.Input[Optional[builtins.str]]] = None,
