...
class GetSubscriptionsResult:
    ...
    def buyer_email(self) -> Optional[builtins.str]:
    ...
    def is_commit_info_required(self) -> Optional[builtins.bool]:
        return pulumi.get(self, "is_commit_info_required")

    @property
    @pulumi.getter(name="planNumber")
    def plan_number(self) -> Optional[builtins.str]:
...
def get_subscriptions(buyer_email: Optional[builtins.str] = None,
                      ...
                      is_commit_info_required: Optional[builtins.bool] = None,
                      plan_number: Optional[builtins.str] = None,
    ...
    :param builtins.str buyer_email: Buyer Email Id
    :param builtins.str compartment_id: The OCID of the compartment.
    :param builtins.bool is_commit_info_required: Boolean value to decide whether commitment services will be shown
    :param builtins.str plan_number: The Plan Number
...
def get_subscriptions_output(buyer_email: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                             ...
                             is_commit_info_required: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                             plan_number: Optional[pulumi.Input[Optional[builtins.str]]] = None,
