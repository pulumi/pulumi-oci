...
def get_commitment_aggregateds(compartment_id: Optional[builtins.str] = None,
...
def get_commitment_aggregateds_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
