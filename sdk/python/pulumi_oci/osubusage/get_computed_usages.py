...
class GetComputedUsagesResult:
    ...
    def computed_product(self) -> Optional[builtins.str]:
...
def get_computed_usages(compartment_id: Optional[builtins.str] = None,
                        computed_product: Optional[builtins.str] = None,
    ...
    :param builtins.str computed_product: Product part number for Computed Usage .
...
def get_computed_usages_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                               computed_product: Optional[pulumi.Input[Optional[builtins.str]]] = None,
