...
class BackupArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that contains the backup.
        :param pulumi.Input[builtins.str] db_system_id: The ID of the database system.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) A description for the backup.
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly display name for the backup. Avoid entering confidential information.
        ...
        :param pulumi.Input[builtins.int] retention_period: (Updatable) Backup retention period in days.
...
class _BackupState:
    def __init__(__self__, *,
                 backup_size: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 last_accepted_request_token: Optional[pulumi.Input[builtins.str]] = None,
                 last_completed_request_token: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 time_created_precise: Optional[pulumi.Input[builtins.str]] = None,
                 time_updated: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Backup resources.
        :param pulumi.Input[builtins.int] backup_size: The size of the backup, in gigabytes.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that contains the backup.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly display name for the backup. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.str] last_accepted_request_token: lastAcceptedRequestToken from MP.
        :param pulumi.Input[builtins.str] last_completed_request_token: lastCompletedRequestToken from MP.
        ...
        :param pulumi.Input[builtins.int] retention_period: (Updatable) Backup retention period in days.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input['BackupSourceBackupDetailsArgs'] source_backup_details: Information about the Source Backup associated with a backup.
        :param pulumi.Input[builtins.str] source_type: Specifies whether the backup was created manually, taken on schedule defined in the a backup policy, or copied from the remote location.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the backup request was received, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_created_precise: The date and time the backup was created. This is the time the actual point-in-time data snapshot was taken, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_updated: The date and time the backup was updated, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
        """
    ...
    def backup_size(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    @backup_size.setter
    def backup_size(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def last_accepted_request_token(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_accepted_request_token(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "last_accepted_request_token", value)

    @property
    @pulumi.getter(name="lastCompletedRequestToken")
    def last_completed_request_token(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def last_completed_request_token(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_created_precise(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_created_precise(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Backup(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_created_precise: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'Backup':
        """
    ...
    @property
    @pulumi.getter(name="backupSize")
    def backup_size(self) -> pulumi.Output[builtins.int]:
        """
        The size of the backup, in gigabytes.
        """
        return pulumi.get(self, "backup_size")
    ...
    @property
    @pulumi.getter(name="lastAcceptedRequestToken")
    def last_accepted_request_token(self) -> pulumi.Output[builtins.str]:
        """
        lastAcceptedRequestToken from MP.
        """
        return pulumi.get(self, "last_accepted_request_token")
    ...
    @property
    @pulumi.getter(name="lastCompletedRequestToken")
    def last_completed_request_token(self) -> pulumi.Output[builtins.str]:
        """
        lastCompletedRequestToken from MP.
        """
        return pulumi.get(self, "last_completed_request_token")
    ...
    @property
    @pulumi.getter(name="timeCreatedPrecise")
    def time_created_precise(self) -> pulumi.Output[builtins.str]:
        """
        The date and time the backup was created. This is the time the actual point-in-time data snapshot was taken, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
        """
        return pulumi.get(self, "time_created_precise")
