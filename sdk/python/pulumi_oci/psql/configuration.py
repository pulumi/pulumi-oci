...
class ConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 is_flexible: Optional[pulumi.Input[builtins.bool]] = None,
                 system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None):
        """
        The set of arguments for constructing a Configuration resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that contains the configuration.
        ...
        :param pulumi.Input[builtins.str] db_version: Version of the PostgreSQL database.
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly display name for the configuration. Avoid entering confidential information.
        :param pulumi.Input[builtins.str] shape: The name of the shape for the configuration. Example: `VM.Standard.E4.Flex`
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Details about the configuration set.
        ...
        :param pulumi.Input[builtins.int] instance_memory_size_in_gbs: Memory size in gigabytes with 1GB increment.
               
               Skip or set it's value to 0 if configuration is for a flexible shape.
        :param pulumi.Input[builtins.int] instance_ocpu_count: CPU core count.
               
               Skip or set it's value to 0 if configuration is for a flexible shape.
        :param pulumi.Input[builtins.bool] is_flexible: Whether the configuration supports flexible shapes.
    ...
    def is_flexible(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_flexible.setter
    def is_flexible(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ConfigurationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that contains the configuration.
        :param pulumi.Input[builtins.str] config_type: The type of configuration. Either user-created or a default configuration.
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] system_tags: System tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"orcl-cloud.free-tier-retained": "true"}` 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] time_created: The date and time that the configuration was created, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
        """
...
class Configuration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'Configuration':
        """
    ...
    @property
    @pulumi.getter(name="isFlexible")
    def is_flexible(self) -> pulumi.Output[builtins.bool]:
        """
        Whether the configuration supports flexible shapes.
        """
        return pulumi.get(self, "is_flexible")
