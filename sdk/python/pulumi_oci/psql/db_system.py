...
class DbSystemArgs:
    def __init__(__self__, *,
                 ...
                 apply_config: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 instance_memory_size_in_gbs: Optional[pulumi.Input[builtins.int]] = None,
                 instance_ocpu_count: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that contains the database system.
        :param pulumi.Input[builtins.str] db_version: Version of database system software.
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly display name for the database system. Avoid entering confidential information.
        :param pulumi.Input['DbSystemNetworkDetailsArgs'] network_details: (Updatable) Network details for the database system.
        :param pulumi.Input[builtins.str] shape: (Updatable) The name of the shape for the database instance node. Use the /shapes API for accepted shapes. Example: `VM.Standard.E4.Flex`
        :param pulumi.Input['DbSystemStorageDetailsArgs'] storage_details: (Updatable) Storage details of the database system.
        :param pulumi.Input[builtins.str] apply_config: Whether a configuration update requires a restart of the database instance or a reload of the configuration. Some configuration changes require a restart of database instances to be applied. Apply config can be passed as `RESTART` or `RELOAD`
        :param pulumi.Input[builtins.str] config_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the configuration associated with the database system.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) A user-provided description of a database system.
        ...
        :param pulumi.Input[builtins.int] instance_count: Count of database instances nodes to be created in the database system.
        :param pulumi.Input[builtins.int] instance_memory_size_in_gbs: (Updatable) The total amount of memory available to each database instance node, in gigabytes.
        :param pulumi.Input[builtins.int] instance_ocpu_count: (Updatable) The total number of OCPUs available to each database instance node.
        ...
        :param pulumi.Input[builtins.str] system_type: Type of the database system.
    ...
    def apply_config(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @apply_config.setter
    def apply_config(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def instance_memory_size_in_gbs(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def instance_memory_size_in_gbs(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "instance_memory_size_in_gbs", value)

    @property
    @pulumi.getter(name="instanceOcpuCount")
    def instance_ocpu_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def instance_ocpu_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _DbSystemState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] admin_username: The database system administrator username.
        :param pulumi.Input[builtins.str] apply_config: Whether a configuration update requires a restart of the database instance or a reload of the configuration. Some configuration changes require a restart of database instances to be applied. Apply config can be passed as `RESTART` or `RELOAD`
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment that contains the database system.
        :param pulumi.Input[builtins.str] config_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the configuration associated with the database system.
        :param pulumi.Input['DbSystemCredentialsArgs'] credentials: Initial database system credentials that the database system will be provisioned with. The password details are not visible on any subsequent operation, such as GET /dbSystems/{dbSystemId}.
        ...
        :param pulumi.Input[builtins.str] shape: (Updatable) The name of the shape for the database instance node. Use the /shapes API for accepted shapes. Example: `VM.Standard.E4.Flex`
        :param pulumi.Input['DbSystemSourceArgs'] source: The source used to restore the database system.
        :param pulumi.Input[builtins.str] state: The current state of the database system.
        :param pulumi.Input['DbSystemStorageDetailsArgs'] storage_details: (Updatable) Storage details of the database system.
        ...
        :param pulumi.Input[builtins.str] system_type: Type of the database system.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] time_created: The date and time that the database system was created, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_updated: The date and time that the database system was updated, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2016-08-25T21:10:29.600Z`
        """
...
class DbSystem(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_type: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'DbSystem':
        """
    ...
    @property
    @pulumi.getter(name="applyConfig")
    def apply_config(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Whether a configuration update requires a restart of the database instance or a reload of the configuration. Some configuration changes require a restart of database instances to be applied. Apply config can be passed as `RESTART` or `RELOAD`
        """
        return pulumi.get(self, "apply_config")
    ...
    @property
    @pulumi.getter(name="instanceMemorySizeInGbs")
    def instance_memory_size_in_gbs(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The total amount of memory available to each database instance node, in gigabytes.
        """
        return pulumi.get(self, "instance_memory_size_in_gbs")
    ...
    @property
    @pulumi.getter(name="instanceOcpuCount")
    def instance_ocpu_count(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The total number of OCPUs available to each database instance node.
        """
        return pulumi.get(self, "instance_ocpu_count")
