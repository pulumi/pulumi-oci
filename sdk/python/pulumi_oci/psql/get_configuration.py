...
def get_configuration(configuration_id: Optional[builtins.str] = None,
...
def get_configuration_output(configuration_id: Optional[pulumi.Input[builtins.str]] = None,
