...
def get_configurations(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str configuration_id: A unique identifier for the configuration.
...
def get_configurations_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                              config_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
