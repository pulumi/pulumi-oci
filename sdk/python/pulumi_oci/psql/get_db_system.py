...
class GetDbSystemResult:
    ...
    def excluded_fields(self) -> Optional[builtins.str]:
...
def get_db_system(db_system_id: Optional[builtins.str] = None,
                  excluded_fields: Optional[builtins.str] = None,
    ...
    :param builtins.str excluded_fields: A filter to exclude database configuration when this query parameter is set to OverrideDbConfig.
    """
    __args__ = dict()
...
def get_db_system_output(db_system_id: Optional[pulumi.Input[builtins.str]] = None,
                         excluded_fields: Optional[pulumi.Input[Optional[builtins.str]]] = None,
