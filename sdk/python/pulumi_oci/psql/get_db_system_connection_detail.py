...
def get_db_system_connection_detail(db_system_id: Optional[builtins.str] = None,
...
def get_db_system_connection_detail_output(db_system_id: Optional[pulumi.Input[builtins.str]] = None,
