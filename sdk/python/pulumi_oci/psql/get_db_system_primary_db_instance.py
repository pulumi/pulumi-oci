...
def get_db_system_primary_db_instance(db_system_id: Optional[builtins.str] = None,
    ...
    :param builtins.str db_system_id: A unique identifier for the database system.
    """
    __args__ = dict()
...
def get_db_system_primary_db_instance_output(db_system_id: Optional[pulumi.Input[builtins.str]] = None,
