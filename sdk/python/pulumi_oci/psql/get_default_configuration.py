...
class GetDefaultConfigurationResult:
    ...
    def default_configuration_id(self) -> builtins.str:
...
def get_default_configuration(default_configuration_id: Optional[builtins.str] = None,
    ...
    :param builtins.str default_configuration_id: A unique identifier for the configuration.
    """
    __args__ = dict()
...
def get_default_configuration_output(default_configuration_id: Optional[pulumi.Input[builtins.str]] = None,
