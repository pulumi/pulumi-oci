...
def get_default_configurations(configuration_id: Optional[builtins.str] = None,
...
def get_default_configurations_output(configuration_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
