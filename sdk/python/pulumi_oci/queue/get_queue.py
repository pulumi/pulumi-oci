...
def get_queue(queue_id: Optional[builtins.str] = None,
    ...
    :param builtins.str queue_id: The unique queue identifier.
    """
    __args__ = dict()
...
def get_queue_output(queue_id: Optional[pulumi.Input[builtins.str]] = None,
