...
def get_queue(queue_id: Optional[str] = None,
    ...
    return AwaitableGetQueueResult(
        ...
        custom_encryption_key_id=__ret__.custom_encryption_key_id,
        dead_letter_queue_delivery_count=__ret__.dead_letter_queue_delivery_count,
        ...
        purge_queue=__ret__.purge_queue,
        purge_type=__ret__.purge_type,
        queue_id=__ret__.queue_id,
        retention_in_seconds=__ret__.retention_in_seconds,
        state=__ret__.state,
        system_tags=__ret__.system_tags,
        time_created=__ret__.time_created,
        time_updated=__ret__.time_updated,
        timeout_in_seconds=__ret__.timeout_in_seconds,
        visibility_in_seconds=__ret__.visibility_in_seconds)
