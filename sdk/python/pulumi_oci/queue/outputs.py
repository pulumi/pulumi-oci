...
class GetQueuesQueueCollectionItemResult(dict):
    def __init__(__self__, *,
                 channel_consumption_limit: builtins.int,
                 compartment_id: builtins.str,
                 custom_encryption_key_id: builtins.str,
                 dead_letter_queue_delivery_count: builtins.int,
                 ...
                 purge_trigger: builtins.int,
                 purge_type: builtins.str,
                 retention_in_seconds: builtins.int,
                 state: builtins.str,
                 system_tags: Mapping[str, builtins.str],
                 time_created: builtins.str,
                 time_updated: builtins.str,
                 timeout_in_seconds: builtins.int,
                 visibility_in_seconds: builtins.int):
        """
        :param builtins.int channel_consumption_limit: The percentage of allocated queue resources that can be consumed by a single channel. For example, if a queue has a storage limit of 2Gb, and a single channel consumption limit is 0.1 (10%), that means data size of a single channel  can't exceed 200Mb. Consumption limit of 100% (default) means that a single channel can consume up-to all allocated queue's resources.
        ...
        :param builtins.str custom_encryption_key_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the custom encryption key to be used to encrypt messages content.
        :param builtins.int dead_letter_queue_delivery_count: The number of times a message can be delivered to a consumer before being moved to the dead letter queue. A value of 0 indicates that the DLQ is not used.
        ...
        :param builtins.str id: The unique queue identifier.
        :param builtins.str lifecycle_details: Any additional details about the current state of the queue.
        :param builtins.str messages_endpoint: The endpoint to use to consume or publish messages in the queue.
        :param builtins.int retention_in_seconds: The retention period of the messages in the queue, in seconds.
        ...
        :param builtins.str time_created: The time that the queue was created, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2018-04-20T00:00:07.405Z`
        :param builtins.str time_updated: The time that the queue was updated, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2018-04-20T00:00:07.405Z`
        :param builtins.int timeout_in_seconds: The default polling timeout of the messages in the queue, in seconds.
        :param builtins.int visibility_in_seconds: The default visibility timeout of the messages consumed from the queue, in seconds.
        """
    ...
    def channel_consumption_limit(self) -> builtins.int:
        """
    ...
    def custom_encryption_key_id(self) -> builtins.str:
        """
    ...
    def dead_letter_queue_delivery_count(self) -> builtins.int:
        """
    ...
    def visibility_in_seconds(self) -> builtins.int:
        """
