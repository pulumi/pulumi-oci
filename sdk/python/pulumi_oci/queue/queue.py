...
class QueueArgs:
    def __init__(__self__, *,
                 ...
                 channel_consumption_limit: Optional[pulumi.Input[builtins.int]] = None,
                 custom_encryption_key_id: Optional[pulumi.Input[builtins.str]] = None,
                 dead_letter_queue_delivery_count: Optional[pulumi.Input[builtins.int]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 purge_trigger: Optional[pulumi.Input[builtins.int]] = None,
                 purge_type: Optional[pulumi.Input[builtins.str]] = None,
                 retention_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 timeout_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
                 visibility_in_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        The set of arguments for constructing a Queue resource.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the queue.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The user-friendly name of the queue.
        :param pulumi.Input[builtins.int] channel_consumption_limit: (Updatable) The percentage of allocated queue resources that can be consumed by a single channel. For example, if a queue has a storage limit of 2Gb, and a single channel consumption limit is 0.1 (10%), that means data size of a single channel  can't exceed 200Mb. Consumption limit of 100% (default) means that a single channel can consume up-to all allocated queue's resources.
        :param pulumi.Input[builtins.str] custom_encryption_key_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the custom encryption key to be used to encrypt messages content.
        :param pulumi.Input[builtins.int] dead_letter_queue_delivery_count: (Updatable) The number of times a message can be delivered to a consumer before being moved to the dead letter queue. A value of 0 indicates that the DLQ is not used.
        ...
        :param pulumi.Input[builtins.int] purge_trigger: (Updatable) An optional property when incremented triggers Purge. Could be set to any integer value.
        :param pulumi.Input[builtins.str] purge_type: (Updatable) An optional value that specifies the purge behavior for the Queue. Could be set to NORMAL, DLQ or BOTH. If unset, the default value is NORMAL
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.int] retention_in_seconds: The retention period of messages in the queue, in seconds.
        :param pulumi.Input[builtins.int] timeout_in_seconds: (Updatable) The default polling timeout of the messages in the queue, in seconds.
        :param pulumi.Input[builtins.int] visibility_in_seconds: (Updatable) The default visibility timeout of the messages consumed from the queue, in seconds.
        """
    ...
    def channel_consumption_limit(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The percentage of allocated queue resources that can be consumed by a single channel. For example, if a queue has a storage limit of 2Gb, and a single channel consumption limit is 0.1 (10%), that means data size of a single channel  can't exceed 200Mb. Consumption limit of 100% (default) means that a single channel can consume up-to all allocated queue's resources.
        """
    ...
    def channel_consumption_limit(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "channel_consumption_limit", value)

    @property
    @pulumi.getter(name="customEncryptionKeyId")
    def custom_encryption_key_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def custom_encryption_key_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "custom_encryption_key_id", value)

    @property
    @pulumi.getter(name="deadLetterQueueDeliveryCount")
    def dead_letter_queue_delivery_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def dead_letter_queue_delivery_count(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def purge_trigger(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def purge_trigger(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "purge_trigger", value)

    @property
    @pulumi.getter(name="purgeType")
    def purge_type(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @purge_type.setter
    def purge_type(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def visibility_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def visibility_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
class _QueueState:
    def __init__(__self__, *,
                 ...
                 messages_endpoint: Optional[pulumi.Input[builtins.str]] = None,
                 purge_trigger: Optional[pulumi.Input[builtins.int]] = None,
                 purge_type: Optional[pulumi.Input[builtins.str]] = None,
                 retention_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The user-friendly name of the queue.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.str] lifecycle_details: Any additional details about the current state of the queue.
        :param pulumi.Input[builtins.str] messages_endpoint: The endpoint to use to consume or publish messages in the queue.
        :param pulumi.Input[builtins.int] purge_trigger: (Updatable) An optional property when incremented triggers Purge. Could be set to any integer value.
        :param pulumi.Input[builtins.str] purge_type: (Updatable) An optional value that specifies the purge behavior for the Queue. Could be set to NORMAL, DLQ or BOTH. If unset, the default value is NORMAL
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.int] retention_in_seconds: The retention period of messages in the queue, in seconds.
        :param pulumi.Input[builtins.str] state: The current state of the queue.
        ...
        :param pulumi.Input[builtins.str] time_created: The time that the queue was created, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2018-04-20T00:00:07.405Z`
        :param pulumi.Input[builtins.str] time_updated: The time that the queue was updated, expressed in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2018-04-20T00:00:07.405Z`
        :param pulumi.Input[builtins.int] timeout_in_seconds: (Updatable) The default polling timeout of the messages in the queue, in seconds.
        :param pulumi.Input[builtins.int] visibility_in_seconds: (Updatable) The default visibility timeout of the messages consumed from the queue, in seconds.
        """
        if channel_consumption_limit is not None:
    ...
    def messages_endpoint(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def messages_endpoint(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Queue(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            timeout_in_seconds: Optional[pulumi.Input[builtins.int]] = None,
            visibility_in_seconds: Optional[pulumi.Input[builtins.int]] = None) -> 'Queue':
        """
    ...
    @property
    @pulumi.getter(name="channelConsumptionLimit")
    def channel_consumption_limit(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The percentage of allocated queue resources that can be consumed by a single channel. For example, if a queue has a storage limit of 2Gb, and a single channel consumption limit is 0.1 (10%), that means data size of a single channel  can't exceed 200Mb. Consumption limit of 100% (default) means that a single channel can consume up-to all allocated queue's resources.
        """
        return pulumi.get(self, "channel_consumption_limit")
    ...
    @property
    @pulumi.getter(name="customEncryptionKeyId")
    def custom_encryption_key_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the custom encryption key to be used to encrypt messages content.
        """
        return pulumi.get(self, "custom_encryption_key_id")
    ...
    @property
    @pulumi.getter(name="deadLetterQueueDeliveryCount")
    def dead_letter_queue_delivery_count(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The number of times a message can be delivered to a consumer before being moved to the dead letter queue. A value of 0 indicates that the DLQ is not used.
        """
        return pulumi.get(self, "dead_letter_queue_delivery_count")
    ...
    @property
    @pulumi.getter(name="messagesEndpoint")
    def messages_endpoint(self) -> pulumi.Output[builtins.str]:
        """
        The endpoint to use to consume or publish messages in the queue.
        """
        return pulumi.get(self, "messages_endpoint")
    ...
    @property
    @pulumi.getter(name="purgeTrigger")
    def purge_trigger(self) -> pulumi.Output[Optional[builtins.int]]:
        """
        (Updatable) An optional property when incremented triggers Purge. Could be set to any integer value.
        """
        return pulumi.get(self, "purge_trigger")
    ...
    @property
    @pulumi.getter(name="purgeType")
    def purge_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        (Updatable) An optional value that specifies the purge behavior for the Queue. Could be set to NORMAL, DLQ or BOTH. If unset, the default value is NORMAL
    ...
    @property
    @pulumi.getter(name="visibilityInSeconds")
    def visibility_in_seconds(self) -> pulumi.Output[builtins.int]:
        """
        (Updatable) The default visibility timeout of the messages consumed from the queue, in seconds.
        """
        return pulumi.get(self, "visibility_in_seconds")
