...
class ProtectedDatabaseMetricArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.float] current_retention_period_in_seconds: Number of seconds backups are currently retained for this database.
        :param pulumi.Input[_builtins.float] db_size_in_gbs: The estimated space, in gigabytes, consumed by the protected database. The database size is based on the size of the data files in the catalog, and does not include archive logs.
        :param pulumi.Input[_builtins.bool] is_redo_logs_enabled: The value TRUE indicates that the protected database is configured to use Real-time data protection, and redo-data is sent from the protected database to Recovery Service. Real-time data protection substantially reduces the window of potential data loss that exists between successive archived redo log backups.
        :param pulumi.Input[_builtins.float] minimum_recovery_needed_in_days: Number of days of redo/archive to be applied to recover database.
        :param pulumi.Input[_builtins.float] retention_period_in_days: The maximum number of days to retain backups for a protected database.
        :param pulumi.Input[_builtins.float] unprotected_window_in_seconds: This is the time window when there is data loss exposure. The point after which recovery is impossible unless additional redo is available.  This is the time we received the last backup or last redo-log shipped.
        """
...
class ProtectedDatabaseRecoveryServiceSubnetArgs:
    ...
    def recovery_service_subnet_id(self) -> pulumi.Input[_builtins.str]:
        """
        (Updatable) The recovery service subnet OCID.
        """
    ...
    def recovery_service_subnet_id(self, value: pulumi.Input[_builtins.str]):
