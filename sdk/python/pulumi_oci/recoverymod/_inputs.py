...
if not MYPY:
    class ProtectedDatabaseMetricArgsDict(TypedDict):
        backup_space_estimate_in_gbs: NotRequired[pulumi.Input[builtins.float]]
        """
        ...
        """
        backup_space_used_in_gbs: NotRequired[pulumi.Input[builtins.float]]
        """
        Backup storage space, in gigabytes, utilized by the protected database. Oracle charges for the total storage used.
        """
        current_retention_period_in_seconds: NotRequired[pulumi.Input[builtins.float]]
        """
        Number of seconds backups are currently retained for this database.
        """
        db_size_in_gbs: NotRequired[pulumi.Input[builtins.float]]
        """
        ...
        """
        is_redo_logs_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        minimum_recovery_needed_in_days: NotRequired[pulumi.Input[builtins.float]]
        """
        Number of days of redo/archive to be applied to recover database.
        """
        retention_period_in_days: NotRequired[pulumi.Input[builtins.float]]
        """
        The maximum number of days to retain backups for a protected database.
        """
        unprotected_window_in_seconds: NotRequired[pulumi.Input[builtins.float]]
        """
...
class ProtectedDatabaseMetricArgs:
    def __init__(__self__, *,
                 backup_space_estimate_in_gbs: Optional[pulumi.Input[builtins.float]] = None,
                 backup_space_used_in_gbs: Optional[pulumi.Input[builtins.float]] = None,
                 current_retention_period_in_seconds: Optional[pulumi.Input[builtins.float]] = None,
                 db_size_in_gbs: Optional[pulumi.Input[builtins.float]] = None,
                 is_redo_logs_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 minimum_recovery_needed_in_days: Optional[pulumi.Input[builtins.float]] = None,
                 retention_period_in_days: Optional[pulumi.Input[builtins.float]] = None,
                 unprotected_window_in_seconds: Optional[pulumi.Input[builtins.float]] = None):
        """
        :param pulumi.Input[builtins.float] backup_space_estimate_in_gbs: The estimated backup storage space, in gigabytes, required to meet the recovery window goal, including foot print and backups for the protected database.
        :param pulumi.Input[builtins.float] backup_space_used_in_gbs: Backup storage space, in gigabytes, utilized by the protected database. Oracle charges for the total storage used.
        :param pulumi.Input[builtins.float] current_retention_period_in_seconds: Number of seconds backups are currently retained for this database.
        :param pulumi.Input[builtins.float] db_size_in_gbs: The estimated space, in gigabytes, consumed by the protected database. The database size is based on the size of the data files in the catalog, and does not include archive logs.
        :param pulumi.Input[builtins.bool] is_redo_logs_enabled: The value TRUE indicates that the protected database is configured to use Real-time data protection, and redo-data is sent from the protected database to Recovery Service. Real-time data protection substantially reduces the window of potential data loss that exists between successive archived redo log backups.
        :param pulumi.Input[builtins.float] minimum_recovery_needed_in_days: Number of days of redo/archive to be applied to recover database.
        :param pulumi.Input[builtins.float] retention_period_in_days: The maximum number of days to retain backups for a protected database.
        :param pulumi.Input[builtins.float] unprotected_window_in_seconds: This is the time window when there is data loss exposure. The point after which recovery is impossible unless additional redo is available.  This is the time we received the last backup or last redo-log shipped.
        """
    ...
    def backup_space_estimate_in_gbs(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The estimated backup storage space, in gigabytes, required to meet the recovery window goal, including foot print and backups for the protected database.
        """
    ...
    def backup_space_estimate_in_gbs(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "backup_space_estimate_in_gbs", value)

    @property
    @pulumi.getter(name="backupSpaceUsedInGbs")
    def backup_space_used_in_gbs(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Backup storage space, in gigabytes, utilized by the protected database. Oracle charges for the total storage used.
        """
    ...
    def backup_space_used_in_gbs(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "backup_space_used_in_gbs", value)

    @property
    @pulumi.getter(name="currentRetentionPeriodInSeconds")
    def current_retention_period_in_seconds(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Number of seconds backups are currently retained for this database.
        """
    ...
    def current_retention_period_in_seconds(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "current_retention_period_in_seconds", value)

    @property
    @pulumi.getter(name="dbSizeInGbs")
    def db_size_in_gbs(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The estimated space, in gigabytes, consumed by the protected database. The database size is based on the size of the data files in the catalog, and does not include archive logs.
        """
    ...
    def db_size_in_gbs(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "db_size_in_gbs", value)

    @property
    @pulumi.getter(name="isRedoLogsEnabled")
    def is_redo_logs_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        The value TRUE indicates that the protected database is configured to use Real-time data protection, and redo-data is sent from the protected database to Recovery Service. Real-time data protection substantially reduces the window of potential data loss that exists between successive archived redo log backups.
        """
    ...
    def is_redo_logs_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_redo_logs_enabled", value)

    @property
    @pulumi.getter(name="minimumRecoveryNeededInDays")
    def minimum_recovery_needed_in_days(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        Number of days of redo/archive to be applied to recover database.
        """
    ...
    def minimum_recovery_needed_in_days(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "minimum_recovery_needed_in_days", value)

    @property
    @pulumi.getter(name="retentionPeriodInDays")
    def retention_period_in_days(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        The maximum number of days to retain backups for a protected database.
        """
    ...
    def retention_period_in_days(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "retention_period_in_days", value)

    @property
    @pulumi.getter(name="unprotectedWindowInSeconds")
    def unprotected_window_in_seconds(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        This is the time window when there is data loss exposure. The point after which recovery is impossible unless additional redo is available.  This is the time we received the last backup or last redo-log shipped.
        """
    ...
    def unprotected_window_in_seconds(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "unprotected_window_in_seconds", value)


if not MYPY:
    class ProtectedDatabaseRecoveryServiceSubnetArgsDict(TypedDict):
        recovery_service_subnet_id: pulumi.Input[builtins.str]
        """
...
class ProtectedDatabaseRecoveryServiceSubnetArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] recovery_service_subnet_id: (Updatable) The recovery service subnet OCID.
    ...
    def recovery_service_subnet_id(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) The recovery service subnet OCID.
        """
    ...
    def recovery_service_subnet_id(self, value: pulumi.Input[builtins.str]):
