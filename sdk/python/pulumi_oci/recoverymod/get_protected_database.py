...
class GetProtectedDatabaseResult:
    ...
    def protected_database_id(self) -> builtins.str:
...
def get_protected_database(protected_database_id: Optional[builtins.str] = None,
    ...
    :param builtins.str protected_database_id: The protected database OCID.
    """
    __args__ = dict()
...
def get_protected_database_output(protected_database_id: Optional[pulumi.Input[builtins.str]] = None,
