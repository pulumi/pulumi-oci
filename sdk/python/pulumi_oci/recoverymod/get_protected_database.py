...
def get_protected_database(protected_database_id: Optional[str] = None,
    ...
    test_protected_database = oci.RecoveryMod.get_protected_database(protected_database_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference))
    ```
    ...
    return AwaitableGetProtectedDatabaseResult(
        ...
        database_size=__ret__.database_size,
        db_unique_name=__ret__.db_unique_name,
        defined_tags=__ret__.defined_tags,
        display_name=__ret__.display_name,
        freeform_tags=__ret__.freeform_tags,
        health=__ret__.health,
        health_details=__ret__.health_details,
        id=__ret__.id,
        is_read_only_resource=__ret__.is_read_only_resource,
        is_redo_logs_shipped=__ret__.is_redo_logs_shipped,
        ...
        recovery_service_subnets=__ret__.recovery_service_subnets,
        state=__ret__.state,
        system_tags=__ret__.system_tags,
        time_created=__ret__.time_created,
        time_updated=__ret__.time_updated,
        vpc_user_name=__ret__.vpc_user_name)
