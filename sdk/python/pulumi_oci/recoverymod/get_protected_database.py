...
def get_protected_database(protected_database_id: Optional[_builtins.str] = None,
...
def get_protected_database_output(protected_database_id: Optional[pulumi.Input[_builtins.str]] = None,
