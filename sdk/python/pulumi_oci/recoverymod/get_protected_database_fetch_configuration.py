...
def get_protected_database_fetch_configuration(base64_encode_content: Optional[builtins.bool] = None,
                                               configuration_type: Optional[builtins.str] = None,
                                               protected_database_id: Optional[builtins.str] = None,
    ...
    :param builtins.str configuration_type: Currently has four config options ALL, TNSNAMES, HOSTS and CABUNDLE. All will return a zipped folder containing the contents of both tnsnames and the certificateChainPem.
...
def get_protected_database_fetch_configuration_output(base64_encode_content: Optional[pulumi.Input[Optional[builtins.bool]]] = None,
                                                      configuration_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                                      protected_database_id: Optional[pulumi.Input[builtins.str]] = None,
