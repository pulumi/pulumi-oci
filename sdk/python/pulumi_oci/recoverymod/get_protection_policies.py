...
class GetProtectionPoliciesResult:
    ...
    def protection_policy_id(self) -> Optional[builtins.str]:
...
def get_protection_policies(compartment_id: Optional[builtins.str] = None,
                            ...
                            protection_policy_id: Optional[builtins.str] = None,
    ...
    :param builtins.str owner: A filter to return only the policies that match the owner as 'Customer' or 'Oracle'.
...
def get_protection_policies_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                   ...
                                   protection_policy_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
