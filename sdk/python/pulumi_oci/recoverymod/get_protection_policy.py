...
def get_protection_policy(protection_policy_id: Optional[builtins.str] = None,
...
def get_protection_policy_output(protection_policy_id: Optional[pulumi.Input[builtins.str]] = None,
