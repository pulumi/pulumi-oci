...
def get_recovery_service_subnets(compartment_id: Optional[builtins.str] = None,
...
def get_recovery_service_subnets_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
