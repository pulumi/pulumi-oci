...
def get_recovery_service_subnets(compartment_id: Optional[str] = None,
    ...
    test_recovery_service_subnets = oci.RecoveryMod.get_recovery_service_subnets(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
