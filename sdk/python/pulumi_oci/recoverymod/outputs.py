...
class ProtectedDatabaseMetric(dict):
    ...
    def __init__(__self__, *,
                 backup_space_estimate_in_gbs: Optional[builtins.float] = None,
                 backup_space_used_in_gbs: Optional[builtins.float] = None,
                 current_retention_period_in_seconds: Optional[builtins.float] = None,
                 db_size_in_gbs: Optional[builtins.float] = None,
                 is_redo_logs_enabled: Optional[builtins.bool] = None,
                 minimum_recovery_needed_in_days: Optional[builtins.float] = None,
                 retention_period_in_days: Optional[builtins.float] = None,
                 unprotected_window_in_seconds: Optional[builtins.float] = None):
        """
        :param builtins.float backup_space_estimate_in_gbs: The estimated backup storage space, in gigabytes, required to meet the recovery window goal, including foot print and backups for the protected database.
        :param builtins.float backup_space_used_in_gbs: Backup storage space, in gigabytes, utilized by the protected database. Oracle charges for the total storage used.
        :param builtins.float current_retention_period_in_seconds: Number of seconds backups are currently retained for this database.
        :param builtins.float db_size_in_gbs: The estimated space, in gigabytes, consumed by the protected database. The database size is based on the size of the data files in the catalog, and does not include archive logs.
        :param builtins.bool is_redo_logs_enabled: The value TRUE indicates that the protected database is configured to use Real-time data protection, and redo-data is sent from the protected database to Recovery Service. Real-time data protection substantially reduces the window of potential data loss that exists between successive archived redo log backups.
        :param builtins.float minimum_recovery_needed_in_days: Number of days of redo/archive to be applied to recover database.
        :param builtins.float retention_period_in_days: The maximum number of days to retain backups for a protected database.
        :param builtins.float unprotected_window_in_seconds: This is the time window when there is data loss exposure. The point after which recovery is impossible unless additional redo is available.  This is the time we received the last backup or last redo-log shipped.
        """
    ...
    def backup_space_estimate_in_gbs(self) -> Optional[builtins.float]:
        """
    ...
    def backup_space_used_in_gbs(self) -> Optional[builtins.float]:
        """
    ...
    def current_retention_period_in_seconds(self) -> Optional[builtins.float]:
        """
    ...
    def db_size_in_gbs(self) -> Optional[builtins.float]:
        """
    ...
    def is_redo_logs_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def minimum_recovery_needed_in_days(self) -> Optional[builtins.float]:
        """
    ...
    def retention_period_in_days(self) -> Optional[builtins.float]:
        """
    ...
    def unprotected_window_in_seconds(self) -> Optional[builtins.float]:
        """
...
class ProtectedDatabaseRecoveryServiceSubnet(dict):
    ...
    def __init__(__self__, *,
                 recovery_service_subnet_id: builtins.str,
                 state: Optional[builtins.str] = None):
        """
        :param builtins.str recovery_service_subnet_id: (Updatable) The recovery service subnet OCID.
        :param builtins.str state: The current state of the Protected Database.
        """
    ...
    def recovery_service_subnet_id(self) -> builtins.str:
        """
...
class GetProtectedDatabaseMetricResult(dict):
    def __init__(__self__, *,
                 backup_space_estimate_in_gbs: builtins.float,
                 backup_space_used_in_gbs: builtins.float,
                 current_retention_period_in_seconds: builtins.float,
                 db_size_in_gbs: builtins.float,
                 is_redo_logs_enabled: builtins.bool,
                 minimum_recovery_needed_in_days: builtins.float,
                 retention_period_in_days: builtins.float,
                 unprotected_window_in_seconds: builtins.float):
        """
        :param builtins.float backup_space_estimate_in_gbs: The estimated backup storage space, in gigabytes, required to meet the recovery window goal, including foot print and backups for the protected database.
        :param builtins.float backup_space_used_in_gbs: Backup storage space, in gigabytes, utilized by the protected database. Oracle charges for the total storage used.
        :param builtins.float current_retention_period_in_seconds: Number of seconds backups are currently retained for this database.
    ...
    @property
    @pulumi.getter(name="backupSpaceEstimateInGbs")
    def backup_space_estimate_in_gbs(self) -> builtins.float:
        """
        The estimated backup storage space, in gigabytes, required to meet the recovery window goal, including foot print and backups for the protected database.
        """
        return pulumi.get(self, "backup_space_estimate_in_gbs")
    ...
    @property
    @pulumi.getter(name="backupSpaceUsedInGbs")
    def backup_space_used_in_gbs(self) -> builtins.float:
        """
        Backup storage space, in gigabytes, utilized by the protected database. Oracle charges for the total storage used.
        """
        return pulumi.get(self, "backup_space_used_in_gbs")
    ...
    @property
    @pulumi.getter(name="currentRetentionPeriodInSeconds")
    def current_retention_period_in_seconds(self) -> builtins.float:
        """
        Number of seconds backups are currently retained for this database.
        """
        return pulumi.get(self, "current_retention_period_in_seconds")
    ...
    @property
    @pulumi.getter(name="dbSizeInGbs")
    def db_size_in_gbs(self) -> builtins.float:
        """
        The estimated space, in gigabytes, consumed by the protected database. The database size is based on the size of the data files in the catalog, and does not include archive logs.
        """
        return pulumi.get(self, "db_size_in_gbs")
    ...
    @property
    @pulumi.getter(name="isRedoLogsEnabled")
    def is_redo_logs_enabled(self) -> builtins.bool:
        """
        The value TRUE indicates that the protected database is configured to use Real-time data protection, and redo-data is sent from the protected database to Recovery Service. Real-time data protection substantially reduces the window of potential data loss that exists between successive archived redo log backups.
        """
        return pulumi.get(self, "is_redo_logs_enabled")
    ...
    @property
    @pulumi.getter(name="minimumRecoveryNeededInDays")
    def minimum_recovery_needed_in_days(self) -> builtins.float:
        """
        Number of days of redo/archive to be applied to recover database.
        """
        return pulumi.get(self, "minimum_recovery_needed_in_days")
    ...
    @property
    @pulumi.getter(name="retentionPeriodInDays")
    def retention_period_in_days(self) -> builtins.float:
        """
        The maximum number of days to retain backups for a protected database.
        """
        return pulumi.get(self, "retention_period_in_days")
    ...
    @property
    @pulumi.getter(name="unprotectedWindowInSeconds")
    def unprotected_window_in_seconds(self) -> builtins.float:
        """
        This is the time window when there is data loss exposure. The point after which recovery is impossible unless additional redo is available.  This is the time we received the last backup or last redo-log shipped.
        """
        return pulumi.get(self, "unprotected_window_in_seconds")
...
class GetProtectedDatabaseRecoveryServiceSubnetResult(dict):
    def __init__(__self__, *,
                 ...
                 state: builtins.str):
        """
        :param builtins.str recovery_service_subnet_id: Recovery Service Subnet Identifier.
        :param builtins.str state: The current state of the Protected Database.
        """
        pulumi.set(__self__, "recovery_service_subnet_id", recovery_service_subnet_id)
        pulumi.set(__self__, "state", state)
...
class GetProtectedDatabasesProtectedDatabaseCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 database_size: builtins.str,
                 db_unique_name: builtins.str,
                 defined_tags: Mapping[str, builtins.str],
                 deletion_schedule: builtins.str,
                 display_name: builtins.str,
                 freeform_tags: Mapping[str, builtins.str],
                 health: builtins.str,
                 health_details: builtins.str,
                 id: builtins.str,
                 is_read_only_resource: builtins.bool,
                 is_redo_logs_shipped: builtins.bool,
                 ...
                 policy_locked_date_time: builtins.str,
                 protection_policy_id: builtins.str,
                 ...
                 vpc_user_name: builtins.str):
        """
        :param builtins.str compartment_id: The compartment OCID.
        :param builtins.str database_id: The OCID of the protected database.
        :param builtins.str database_size: The size of the protected database. XS - Less than 5GB, S - 5GB to 50GB, M - 50GB to 500GB, L - 500GB to 1TB, XL - 1TB to 5TB, XXL - Greater than 5TB.
        :param builtins.str db_unique_name: The dbUniqueName for the protected database in Recovery Service. You cannot change the unique name.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`. For more information, see [Resource Tags](https://docs.oracle.com/en-us/iaas/Content/General/Concepts/resourcetags.htm)
        ...
        :param builtins.str health: Indicates the protection status of the database.
        :param builtins.str health_details: A message describing the current health of the protected database.
        :param builtins.str id: The protected database OCID.
        :param builtins.bool is_read_only_resource: Indicates whether the protected database is created by Recovery Service or created manually. Set to <b>TRUE</b> for a service-defined protected database. When you enable the OCI-managed automatic backups option for a database and set Recovery Service as the backup destination, then Recovery Service creates the associated protected database resource. Set to <b>FALSE</b> for a user-defined protected database.
        :param builtins.bool is_redo_logs_shipped: The value TRUE indicates that the protected database is configured to use Real-time data protection, and redo-data is sent from the protected database to Recovery Service. Real-time data protection substantially reduces the window of potential data loss that exists between successive archived redo log backups. For this to be effective, additional configuration is needed on client side.
        :param builtins.str lifecycle_details: Detailed description about the current lifecycle state of the protected database. For example, it can be used to provide actionable information for a resource in a Failed state.
        ...
        :param builtins.str policy_locked_date_time: An RFC3339 formatted datetime string that specifies the exact date and time for the retention lock to take effect and permanently lock the retention period defined in the policy.
        :param builtins.str protection_policy_id: The protection policy OCID.
        ...
        :param builtins.str subscription_id: The OCID of the cloud service subscription to which the protected database is linked.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`. For more information, see [Resource Tags](https://docs.oracle.com/en-us/iaas/Content/General/Concepts/resourcetags.htm)
        :param builtins.str time_created: An RFC3339 formatted datetime string that indicates the created time for a protected database. For example: '2020-05-22T21:10:29.600Z'
        :param builtins.str time_updated: An RFC3339 formatted datetime string that indicates the last updated time for a protected database. For example: '2020-05-22T21:10:29.600Z'
        :param builtins.str vpc_user_name: The virtual private catalog (VPC) user credentials that authenticates the protected database to access Recovery Service.
        """
    ...
    def database_size(self) -> builtins.str:
        """
    ...
    def deletion_schedule(self) -> builtins.str:
    ...
    def health_details(self) -> builtins.str:
        """
    ...
    def is_read_only_resource(self) -> builtins.bool:
        """
    ...
    def is_redo_logs_shipped(self) -> builtins.bool:
        """
        The value TRUE indicates that the protected database is configured to use Real-time data protection, and redo-data is sent from the protected database to Recovery Service. Real-time data protection substantially reduces the window of potential data loss that exists between successive archived redo log backups. For this to be effective, additional configuration is needed on client side.
        """
    ...
    def policy_locked_date_time(self) -> builtins.str:
        """
    ...
    def protection_policy_id(self) -> builtins.str:
        """
    ...
    def vpc_user_name(self) -> builtins.str:
        """
...
class GetProtectedDatabasesProtectedDatabaseCollectionItemRecoveryServiceSubnetResult(dict):
    def __init__(__self__, *,
                 ...
                 state: builtins.str):
        """
        :param builtins.str recovery_service_subnet_id: The recovery service subnet OCID.
        :param builtins.str state: A filter to return only the resources that match the specified lifecycle state.
        """
        pulumi.set(__self__, "recovery_service_subnet_id", recovery_service_subnet_id)
        pulumi.set(__self__, "state", state)
...
class GetProtectionPoliciesProtectionPolicyCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 freeform_tags: Mapping[str, builtins.str],
                 id: builtins.str,
                 is_predefined_policy: builtins.bool,
                 lifecycle_details: builtins.str,
                 must_enforce_cloud_locality: builtins.bool,
                 policy_locked_date_time: builtins.str,
                 state: builtins.str,
                 system_tags: Mapping[str, builtins.str],
                 time_created: builtins.str,
                 time_updated: builtins.str):
        """
        :param builtins.int backup_retention_period_in_days: The maximum number of days to retain backups for a protected database. Specify a period ranging from a minimum 14 days to a maximum 95 days. For example, specify the value 55 if you want to retain backups for 55 days.
        :param builtins.str compartment_id: The compartment OCID.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`. For more information, see [Resource Tags](https://docs.oracle.com/en-us/iaas/Content/General/Concepts/resourcetags.htm)
        :param builtins.str display_name: A filter to return only resources that match the entire 'displayname' given.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: The protection policy OCID.
        :param builtins.bool is_predefined_policy: Set to TRUE if the policy is Oracle-defined, and FALSE for a user-defined custom policy. You can modify only the custom policies.
        :param builtins.str lifecycle_details: Detailed description about the current lifecycle state of the protection policy. For example, it can be used to provide actionable information for a resource in a Failed state.
        :param builtins.bool must_enforce_cloud_locality: Indicates whether the protection policy enforces Recovery Service to retain backups in the same cloud service environment where your Oracle Database is provisioned.
        :param builtins.str policy_locked_date_time: An RFC3339 formatted datetime string that specifies the exact date and time for the retention lock to take effect and permanently lock the retention period defined in the policy.
        :param builtins.str state: A filter to return only resources their lifecycleState matches the given lifecycleState.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`. For more information, see [Resource Tags](https://docs.oracle.com/en-us/iaas/Content/General/Concepts/resourcetags.htm)
        :param builtins.str time_created: An RFC3339 formatted datetime string that indicates the created time for the protection policy. For example: '2020-05-22T21:10:29.600Z'.
        :param builtins.str time_updated: An RFC3339 formatted datetime string that indicates the updated time for the protection policy. For example: '2020-05-22T21:10:29.600Z'.
        """
    ...
    def is_predefined_policy(self) -> builtins.bool:
        """
    ...
    def must_enforce_cloud_locality(self) -> builtins.bool:
        """
...
class GetRecoveryServiceSubnetsRecoveryServiceSubnetCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str display_name: A filter to return only resources that match the entire 'displayname' given.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: The recovery service subnet OCID.
        :param builtins.str lifecycle_details: Detailed description about the current lifecycle state of the recovery service subnet. For example, it can be used to provide actionable information for a resource in a Failed state
        ...
        :param builtins.str state: A filter to return only the resources that match the specified lifecycle state.
        :param builtins.str subnet_id: Deprecated. One of the subnets associated with the Recovery Service subnet.
        :param Sequence[builtins.str] subnets: A list of OCIDs of all the subnets associated with the Recovery Service subnet.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`. For more information, see [Resource Tags](https://docs.oracle.com/en-us/iaas/Content/General/Concepts/resourcetags.htm)
        :param builtins.str time_created: An RFC3339 formatted datetime string that indicates the last created time for a recovery service subnet. For example: '2020-05-22T21:10:29.600Z'.
        :param builtins.str time_updated: An RFC3339 formatted datetime string that indicates the last updated time for a recovery service subnet. For example: '2020-05-22T21:10:29.600Z'.
        :param builtins.str vcn_id: The OCID of the virtual cloud network (VCN) associated with the recovery service subnet.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
        pulumi.set(__self__, "display_name", display_name)
