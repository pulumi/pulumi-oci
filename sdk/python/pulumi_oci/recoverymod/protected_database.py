...
class ProtectedDatabaseArgs:
    def __init__(__self__, *,
                 ...
                 db_unique_name: pulumi.Input[builtins.str],
                 display_name: pulumi.Input[builtins.str],
                 password: pulumi.Input[builtins.str],
                 protection_policy_id: pulumi.Input[builtins.str],
                 ...
                 database_size: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 deletion_schedule: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_redo_logs_shipped: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment that contains the protected database.
        :param pulumi.Input[builtins.str] db_unique_name: The dbUniqueName of the protected database in Recovery Service. You cannot change the unique name.
        :param pulumi.Input[builtins.str] display_name: (Updatable) The protected database name. You can change the displayName. Avoid entering confidential information.
        :param pulumi.Input[builtins.str] password: (Updatable) Password credential which can be used to connect to Protected Database. It must contain at least 2 uppercase, 2 lowercase, 2 numeric and 2 special characters. The special characters must be underscore (_), number sign (https://docs.cloud.oracle.com/iaas/api/#) or hyphen (-). The password must not contain the username "admin", regardless of casing.
        :param pulumi.Input[builtins.str] protection_policy_id: (Updatable) The OCID of the protection policy associated with the protected database.
        ...
        :param pulumi.Input[builtins.str] database_id: The OCID of the protected database.
        :param pulumi.Input[builtins.str] database_size: (Updatable) The size of the protected database. XS - Less than 5GB, S - 5GB to 50GB, M - 50GB to 500GB, L - 500GB to 1TB, XL - 1TB to 5TB, XXL - Greater than 5TB.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`. For more information, see [Resource Tags](https://docs.oracle.com/en-us/iaas/Content/General/Concepts/resourcetags.htm)
        :param pulumi.Input[builtins.str] deletion_schedule: (Updatable) Defines a preferred schedule to delete a protected database after you terminate the source database.
        ...
        :param pulumi.Input[builtins.bool] is_redo_logs_shipped: (Updatable) The value TRUE indicates that the protected database is configured to use Real-time data protection, and redo-data is sent from the protected database to Recovery Service. Real-time data protection substantially reduces the window of potential data loss that exists between successive archived redo log backups.
        :param pulumi.Input[builtins.str] subscription_id: (Updatable) The OCID of the cloud service subscription to which you want to link the protected database.  For example, specify the Microsoft Azure subscription ID if you want to provision the protected database in Azure. 
    ...
    def db_unique_name(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def db_unique_name(self, value: pulumi.Input[builtins.str]):
    ...
    def protection_policy_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def protection_policy_id(self, value: pulumi.Input[builtins.str]):
    ...
    def database_size(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def database_size(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def deletion_schedule(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def deletion_schedule(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_redo_logs_shipped(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) The value TRUE indicates that the protected database is configured to use Real-time data protection, and redo-data is sent from the protected database to Recovery Service. Real-time data protection substantially reduces the window of potential data loss that exists between successive archived redo log backups.
        """
    ...
    def is_redo_logs_shipped(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _ProtectedDatabaseState:
    def __init__(__self__, *,
                 ...
                 health_details: Optional[pulumi.Input[builtins.str]] = None,
                 is_read_only_resource: Optional[pulumi.Input[builtins.bool]] = None,
                 is_redo_logs_shipped: Optional[pulumi.Input[builtins.bool]] = None,
                 lifecycle_details: Optional[pulumi.Input[builtins.str]] = None,
                 metrics: Optional[pulumi.Input[Sequence[pulumi.Input['ProtectedDatabaseMetricArgs']]]] = None,
                 password: Optional[pulumi.Input[builtins.str]] = None,
                 policy_locked_date_time: Optional[pulumi.Input[builtins.str]] = None,
                 protection_policy_id: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 vpc_user_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) The protected database name. You can change the displayName. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.str] health: Indicates the protection status of the database.
        :param pulumi.Input[builtins.str] health_details: A message describing the current health of the protected database.
        :param pulumi.Input[builtins.bool] is_read_only_resource: Indicates whether the protected database is created by Recovery Service or created manually. Set to <b>TRUE</b> for a service-defined protected database. When you enable the OCI-managed automatic backups option for a database and set Recovery Service as the backup destination, then Recovery Service creates the associated protected database resource. Set to <b>FALSE</b> for a user-defined protected database.
        :param pulumi.Input[builtins.bool] is_redo_logs_shipped: (Updatable) The value TRUE indicates that the protected database is configured to use Real-time data protection, and redo-data is sent from the protected database to Recovery Service. Real-time data protection substantially reduces the window of potential data loss that exists between successive archived redo log backups.
        :param pulumi.Input[builtins.str] lifecycle_details: Detailed description about the current lifecycle state of the protected database. For example, it can be used to provide actionable information for a resource in a Failed state.
        ...
        :param pulumi.Input[builtins.str] password: (Updatable) Password credential which can be used to connect to Protected Database. It must contain at least 2 uppercase, 2 lowercase, 2 numeric and 2 special characters. The special characters must be underscore (_), number sign (https://docs.cloud.oracle.com/iaas/api/#) or hyphen (-). The password must not contain the username "admin", regardless of casing.
        :param pulumi.Input[builtins.str] policy_locked_date_time: An RFC3339 formatted datetime string that specifies the exact date and time for the retention lock to take effect and permanently lock the retention period defined in the policy.
        :param pulumi.Input[builtins.str] protection_policy_id: (Updatable) The OCID of the protection policy associated with the protected database.
        :param pulumi.Input[Sequence[pulumi.Input['ProtectedDatabaseRecoveryServiceSubnetArgs']]] recovery_service_subnets: (Updatable) List of recovery service subnet resources associated with the protected database.
        :param pulumi.Input[builtins.str] state: The current state of the Protected Database.
        :param pulumi.Input[builtins.str] subscription_id: (Updatable) The OCID of the cloud service subscription to which you want to link the protected database.  For example, specify the Microsoft Azure subscription ID if you want to provision the protected database in Azure. 
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`. For more information, see [Resource Tags](https://docs.oracle.com/en-us/iaas/Content/General/Concepts/resourcetags.htm)
        :param pulumi.Input[builtins.str] time_created: An RFC3339 formatted datetime string that indicates the created time for a protected database. For example: '2020-05-22T21:10:29.600Z'
        :param pulumi.Input[builtins.str] time_updated: An RFC3339 formatted datetime string that indicates the last updated time for a protected database. For example: '2020-05-22T21:10:29.600Z'
        :param pulumi.Input[builtins.str] vpc_user_name: The virtual private catalog (VPC) user credentials that authenticates the protected database to access Recovery Service.
        """
    ...
    def health_details(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def health_details(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "health_details", value)

    @property
    @pulumi.getter(name="isReadOnlyResource")
    def is_read_only_resource(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_read_only_resource(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def policy_locked_date_time(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def policy_locked_date_time(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "policy_locked_date_time", value)

    @property
    @pulumi.getter(name="protectionPolicyId")
    def protection_policy_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The OCID of the protection policy associated with the protected database.
        """
        return pulumi.get(self, "protection_policy_id")
    ...
    @protection_policy_id.setter
    def protection_policy_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "protection_policy_id", value)
    ...
    def vpc_user_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vpc_user_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ProtectedDatabase(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            vpc_user_name: Optional[pulumi.Input[builtins.str]] = None) -> 'ProtectedDatabase':
        """
    ...
    @property
    @pulumi.getter(name="databaseSize")
    def database_size(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The size of the protected database. XS - Less than 5GB, S - 5GB to 50GB, M - 50GB to 500GB, L - 500GB to 1TB, XL - 1TB to 5TB, XXL - Greater than 5TB.
        """
        return pulumi.get(self, "database_size")
    ...
    @property
    @pulumi.getter(name="deletionSchedule")
    def deletion_schedule(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Defines a preferred schedule to delete a protected database after you terminate the source database.
        * The default schedule is DELETE_AFTER_72_HOURS, so that the delete operation can occur 72 hours (3 days) after the source database is terminated.
        * The alternate schedule is DELETE_AFTER_RETENTION_PERIOD. Specify this option if you want to delete a protected database only after the policy-defined backup retention period expires.
    ...
    @property
    @pulumi.getter(name="healthDetails")
    def health_details(self) -> pulumi.Output[builtins.str]:
        """
        A message describing the current health of the protected database.
        """
        return pulumi.get(self, "health_details")
    ...
    @property
    @pulumi.getter(name="isReadOnlyResource")
    def is_read_only_resource(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the protected database is created by Recovery Service or created manually. Set to <b>TRUE</b> for a service-defined protected database. When you enable the OCI-managed automatic backups option for a database and set Recovery Service as the backup destination, then Recovery Service creates the associated protected database resource. Set to <b>FALSE</b> for a user-defined protected database.
        """
        return pulumi.get(self, "is_read_only_resource")
    ...
    @property
    @pulumi.getter(name="isRedoLogsShipped")
    def is_redo_logs_shipped(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) The value TRUE indicates that the protected database is configured to use Real-time data protection, and redo-data is sent from the protected database to Recovery Service. Real-time data protection substantially reduces the window of potential data loss that exists between successive archived redo log backups.
        """
        return pulumi.get(self, "is_redo_logs_shipped")
    ...
    @property
    @pulumi.getter(name="policyLockedDateTime")
    def policy_locked_date_time(self) -> pulumi.Output[builtins.str]:
        """
        An RFC3339 formatted datetime string that specifies the exact date and time for the retention lock to take effect and permanently lock the retention period defined in the policy.
        """
        return pulumi.get(self, "policy_locked_date_time")
    ...
    @property
    @pulumi.getter(name="protectionPolicyId")
    def protection_policy_id(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The OCID of the protection policy associated with the protected database.
        """
        return pulumi.get(self, "protection_policy_id")
    ...
    @property
    @pulumi.getter(name="vpcUserName")
    def vpc_user_name(self) -> pulumi.Output[builtins.str]:
        """
        The virtual private catalog (VPC) user credentials that authenticates the protected database to access Recovery Service.
        """
        return pulumi.get(self, "vpc_user_name")
