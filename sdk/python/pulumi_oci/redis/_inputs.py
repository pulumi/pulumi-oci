...
if not MYPY:
    class RedisClusterNodeCollectionItemArgsDict(TypedDict):
        ...
        """
        private_endpoint_fqdn: NotRequired[pulumi.Input[builtins.str]]
        """
...
class RedisClusterNodeCollectionItemArgs:
    def __init__(__self__, *,
                 ...
                 private_endpoint_fqdn: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] private_endpoint_fqdn: The fully qualified domain name (FQDN) of the API endpoint to access a specific node.
        :param pulumi.Input[builtins.str] private_endpoint_ip_address: The private IP address of the API endpoint to access a specific node.
        """
    ...
    def private_endpoint_fqdn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The fully qualified domain name (FQDN) of the API endpoint to access a specific node.
        """
    ...
    def private_endpoint_fqdn(self, value: Optional[pulumi.Input[builtins.str]]):
