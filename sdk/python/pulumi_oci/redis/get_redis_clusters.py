...
def get_redis_clusters(compartment_id: Optional[builtins.str] = None,
...
def get_redis_clusters_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
