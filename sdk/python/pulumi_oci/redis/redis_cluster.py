...
class RedisClusterArgs:
    def __init__(__self__, *,
                 ...
                 node_memory_in_gbs: pulumi.Input[builtins.float],
                 software_version: pulumi.Input[builtins.str],
                 subnet_id: pulumi.Input[builtins.str],
                 cluster_mode: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm#Oracle) of the compartment that contains the cluster.
        ...
        :param pulumi.Input[builtins.int] node_count: (Updatable) The number of nodes per shard in the cluster when clusterMode is SHARDED. This is the total number of nodes when clusterMode is NONSHARDED.
        :param pulumi.Input[builtins.float] node_memory_in_gbs: (Updatable) The amount of memory allocated to the cluster's nodes, in gigabytes.
        :param pulumi.Input[builtins.str] software_version: (Updatable) The Oracle Cloud Infrastructure Cache engine version that the cluster is running.
        :param pulumi.Input[builtins.str] subnet_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm#Oracle) of the cluster's subnet.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] cluster_mode: Specifies whether the cluster is sharded or non-sharded.
        ...
        :param pulumi.Input[builtins.int] shard_count: (Updatable) The number of shards in sharded cluster. Only applicable when clusterMode is SHARDED.
        """
    ...
    def node_memory_in_gbs(self) -> pulumi.Input[builtins.float]:
        """
    ...
    def node_memory_in_gbs(self, value: pulumi.Input[builtins.float]):
        pulumi.set(self, "node_memory_in_gbs", value)

    @property
    @pulumi.getter(name="softwareVersion")
    def software_version(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def software_version(self, value: pulumi.Input[builtins.str]):
    ...
    def cluster_mode(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @cluster_mode.setter
    def cluster_mode(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _RedisClusterState:
    def __init__(__self__, *,
                 ...
                 node_memory_in_gbs: Optional[pulumi.Input[builtins.float]] = None,
                 nsg_ids: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
                 primary_endpoint_ip_address: Optional[pulumi.Input[builtins.str]] = None,
                 primary_fqdn: Optional[pulumi.Input[builtins.str]] = None,
                 replicas_endpoint_ip_address: Optional[pulumi.Input[builtins.str]] = None,
                 replicas_fqdn: Optional[pulumi.Input[builtins.str]] = None,
                 shard_count: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name. Does not have to be unique, and it's changeable. Avoid entering confidential information.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.str] lifecycle_details: A message describing the current state in more detail. For example, the message might provide actionable information for a resource in `FAILED` state.
        :param pulumi.Input[Sequence[pulumi.Input['RedisClusterNodeCollectionArgs']]] node_collections: The collection of  cluster nodes.
        :param pulumi.Input[builtins.int] node_count: (Updatable) The number of nodes per shard in the cluster when clusterMode is SHARDED. This is the total number of nodes when clusterMode is NONSHARDED.
        :param pulumi.Input[builtins.float] node_memory_in_gbs: (Updatable) The amount of memory allocated to the cluster's nodes, in gigabytes.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] nsg_ids: (Updatable) A list of Network Security Group (NSG) [OCIDs](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) associated with this cluster. For more information, see [Using an NSG for Clusters](https://docs.cloud.oracle.com/iaas/Content/ocicache/connecttocluster.htm#connecttocluster__networksecuritygroup).
        :param pulumi.Input[builtins.str] primary_endpoint_ip_address: The private IP address of the API endpoint for the cluster's primary node.
        :param pulumi.Input[builtins.str] primary_fqdn: The fully qualified domain name (FQDN) of the API endpoint for the cluster's primary node.
        :param pulumi.Input[builtins.str] replicas_endpoint_ip_address: The private IP address of the API endpoint for the cluster's replica nodes.
        :param pulumi.Input[builtins.str] replicas_fqdn: The fully qualified domain name (FQDN) of the API endpoint for the cluster's replica nodes.
        :param pulumi.Input[builtins.int] shard_count: (Updatable) The number of shards in sharded cluster. Only applicable when clusterMode is SHARDED.
        :param pulumi.Input[builtins.str] software_version: (Updatable) The Oracle Cloud Infrastructure Cache engine version that the cluster is running.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the cluster was created. An [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339) formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The date and time the cluster was updated. An [RFC3339](https://datatracker.ietf.org/doc/html/rfc3339) formatted datetime string.
        """
        if cluster_mode is not None:
            pulumi.set(__self__, "cluster_mode", cluster_mode)
    ...
    @property
    @pulumi.getter(name="nodeMemoryInGbs")
    def node_memory_in_gbs(self) -> Optional[pulumi.Input[builtins.float]]:
        """
        (Updatable) The amount of memory allocated to the cluster's nodes, in gigabytes.
        """
        return pulumi.get(self, "node_memory_in_gbs")
    ...
    @node_memory_in_gbs.setter
    def node_memory_in_gbs(self, value: Optional[pulumi.Input[builtins.float]]):
        pulumi.set(self, "node_memory_in_gbs", value)
    ...
    def primary_endpoint_ip_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def primary_endpoint_ip_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "primary_endpoint_ip_address", value)

    @property
    @pulumi.getter(name="primaryFqdn")
    def primary_fqdn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @primary_fqdn.setter
    def primary_fqdn(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "primary_fqdn", value)

    @property
    @pulumi.getter(name="replicasEndpointIpAddress")
    def replicas_endpoint_ip_address(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def replicas_endpoint_ip_address(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "replicas_endpoint_ip_address", value)

    @property
    @pulumi.getter(name="replicasFqdn")
    def replicas_fqdn(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def replicas_fqdn(self, value: Optional[pulumi.Input[builtins.str]]):
...
class RedisCluster(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'RedisCluster':
        """
    ...
    @property
    @pulumi.getter(name="clusterMode")
    def cluster_mode(self) -> pulumi.Output[builtins.str]:
        """
        Specifies whether the cluster is sharded or non-sharded.
        """
        return pulumi.get(self, "cluster_mode")
    ...
    @property
    @pulumi.getter(name="nodeMemoryInGbs")
    def node_memory_in_gbs(self) -> pulumi.Output[builtins.float]:
        """
        (Updatable) The amount of memory allocated to the cluster's nodes, in gigabytes.
        """
        return pulumi.get(self, "node_memory_in_gbs")
    ...
    @property
    @pulumi.getter(name="primaryEndpointIpAddress")
    def primary_endpoint_ip_address(self) -> pulumi.Output[builtins.str]:
        """
        The private IP address of the API endpoint for the cluster's primary node.
        """
        return pulumi.get(self, "primary_endpoint_ip_address")
    ...
    @property
    @pulumi.getter(name="primaryFqdn")
    def primary_fqdn(self) -> pulumi.Output[builtins.str]:
        """
        The fully qualified domain name (FQDN) of the API endpoint for the cluster's primary node.
        """
        return pulumi.get(self, "primary_fqdn")
    ...
    @property
    @pulumi.getter(name="replicasEndpointIpAddress")
    def replicas_endpoint_ip_address(self) -> pulumi.Output[builtins.str]:
        """
        The private IP address of the API endpoint for the cluster's replica nodes.
        """
        return pulumi.get(self, "replicas_endpoint_ip_address")
    ...
    @property
    @pulumi.getter(name="replicasFqdn")
    def replicas_fqdn(self) -> pulumi.Output[builtins.str]:
        """
        The fully qualified domain name (FQDN) of the API endpoint for the cluster's replica nodes.
        """
        return pulumi.get(self, "replicas_fqdn")
    ...
    @property
    @pulumi.getter(name="softwareVersion")
    def software_version(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) The Oracle Cloud Infrastructure Cache engine version that the cluster is running.
        """
        return pulumi.get(self, "software_version")
