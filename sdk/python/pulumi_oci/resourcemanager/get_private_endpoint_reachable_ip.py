...
def get_private_endpoint_reachable_ip(private_endpoint_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str private_ip: The IP address of the resource in the private subnet.
    """
    __args__ = dict()
