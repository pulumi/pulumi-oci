...
class GetPrivateEndpointsPrivateEndpointCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 is_used_with_configuration_source_provider: builtins.bool,
                 nsg_id_lists: Sequence[builtins.str],
                 ...
                 vcn_id: builtins.str):
        """
        :param builtins.str compartment_id: A filter to return only resources that exist in the compartment, identified by [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        ...
        :param builtins.str description: Description of the private endpoint. Avoid entering confidential information.
        :param builtins.str display_name: A filter to return only resources that match the given display name exactly. Use this filter to list a resource by name. Requires `sortBy` set to `DISPLAYNAME`. Alternatively, when you know the resource OCID, use the related Get operation.
        :param Sequence[builtins.str] dns_zones: DNS Proxy forwards any DNS FQDN queries over into the consumer DNS resolver if the DNS FQDN is included in the dns zones list otherwise it goes to service provider VCN resolver.
        :param Mapping[str, builtins.str] freeform_tags: Free-form tags associated with the resource. Each tag is a key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param builtins.str id: Unique identifier ([OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)) of the private endpoint details.
        :param builtins.bool is_used_with_configuration_source_provider: When `true`, allows the private endpoint to be used with a configuration source provider.
        :param Sequence[builtins.str] nsg_id_lists: An array of network security groups (NSG) that the customer can optionally provide.
        :param Sequence[builtins.str] source_ips: The source IPs which resource manager service will use to connect to customer's network. Automatically assigned by Resource Manager Service.
        :param builtins.str state: The current lifecycle state of the private endpoint.
        :param builtins.str subnet_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet within the VCN for the private endpoint.
        :param builtins.str time_created: The date and time at which the private endpoint was created. Format is defined by RFC3339. Example: `2020-11-25T21:10:29.600Z`
...
class GetStacksStackResult(dict):
    def __init__(__self__, *,
        ...
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param builtins.str description: General description of the stack.
        :param builtins.str display_name: Display name on which to query.
        :param Mapping[str, builtins.str] freeform_tags: Free-form tags associated with this resource. Each tag is a key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        ...
        :param builtins.str state: A filter that returns only those resources that match the specified lifecycle state. The state value is case-insensitive.
               ...
               * DELETING
               * DELETED
        :param builtins.str time_created: The date and time at which the stack was created.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
