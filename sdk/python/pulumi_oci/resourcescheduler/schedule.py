...
class ScheduleArgs:
    def __init__(__self__, *,
                 ...
                 recurrence_details: pulumi.Input[builtins.str],
                 ...
                 time_ends: Optional[pulumi.Input[builtins.str]] = None,
                 time_starts: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] time_ends: (Updatable) This is the date and time the schedule ends, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339)  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_starts: (Updatable) This is the date and time the schedule starts, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339)  Example: `2016-08-25T21:10:29.600Z`
        """
    ...
    def recurrence_details(self, value: pulumi.Input[builtins.str]):
    ...
    def time_ends(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @time_ends.setter
    def time_ends(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_ends", value)

    @property
    @pulumi.getter(name="timeStarts")
    def time_starts(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @time_starts.setter
    def time_starts(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ScheduleState:
    def __init__(__self__, *,
                 ...
                 time_ends: Optional[pulumi.Input[builtins.str]] = None,
                 time_last_run: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] state: (Updatable) The target state for the Schedule. Could be set to `ACTIVE` or `INACTIVE`. 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] system_tags: These are system tags for this resource. Each key is predefined and scoped to a namespace.  Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param pulumi.Input[builtins.str] time_created: This is the date and time the schedule was created, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_ends: (Updatable) This is the date and time the schedule ends, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339)  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_last_run: This is the date and time the schedule runs last time, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_next_run: This is the date and time the schedule run the next time, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_starts: (Updatable) This is the date and time the schedule starts, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339)  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_updated: This is the date and time the schedule was updated, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        """
    ...
    @recurrence_details.setter
    def recurrence_details(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "recurrence_details", value)
    ...
    def time_last_run(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_last_run(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Schedule(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_next_run: Optional[pulumi.Input[builtins.str]] = None,
            time_starts: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'Schedule':
        """
    ...
    @property
    @pulumi.getter(name="timeEnds")
    def time_ends(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) This is the date and time the schedule ends, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339)  Example: `2016-08-25T21:10:29.600Z`
        """
        return pulumi.get(self, "time_ends")
    ...
    @property
    @pulumi.getter(name="timeLastRun")
    def time_last_run(self) -> pulumi.Output[builtins.str]:
        """
        This is the date and time the schedule runs last time, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        """
        return pulumi.get(self, "time_last_run")
    ...
    @property
    @pulumi.getter(name="timeStarts")
    def time_starts(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) This is the date and time the schedule starts, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339)  Example: `2016-08-25T21:10:29.600Z`
        """
        return pulumi.get(self, "time_starts")
