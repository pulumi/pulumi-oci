...
if not MYPY:
    class ConnectorSourceArgsDict(TypedDict):
        ...
        """
        config_map: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ConnectorSourceArgs:
    def __init__(__self__, *,
                 kind: pulumi.Input[builtins.str],
                 config_map: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] config_map: (Updatable) The configuration map for the connector plugin. This map includes parameters specific to the connector plugin type.  For example, for `QueueSource`, the map lists the OCID of the selected queue. To find the parameters for a connector plugin, get the plugin using [GetConnectorPlugin](https://docs.cloud.oracle.com/iaas/api/#/en/serviceconnectors/latest/ConnectorPlugin/GetConnectorPlugin) and review its schema value.
    ...
    def config_map(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The configuration map for the connector plugin. This map includes parameters specific to the connector plugin type.  For example, for `QueueSource`, the map lists the OCID of the selected queue. To find the parameters for a connector plugin, get the plugin using [GetConnectorPlugin](https://docs.cloud.oracle.com/iaas/api/#/en/serviceconnectors/latest/ConnectorPlugin/GetConnectorPlugin) and review its schema value.
        """
    ...
    @config_map.setter
    def config_map(self, value: Optional[pulumi.Input[builtins.str]]):
...
class ConnectorSourceLogSourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the log source.
        :param pulumi.Input[builtins.str] log_group_id: (Updatable) Identifier of the log group. Either `_Audit` or the [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the log group. Note: For the Notifications target, only `_Audit` is allowed.
...
class ConnectorSourceMonitoringSourceArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of a compartment containing metric namespaces you want to use for the Monitoring source.
...
class ConnectorSourceMonitoringSourceNamespaceDetailsNamespaceArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] namespace: (Updatable) The source service or application to use when querying for metric data points. Must begin with `oci_`.  Example: `oci_computeagent`
        """
...
if not MYPY:
    class ConnectorTargetArgsDict(TypedDict):
        ...
        (Updatable) The type discriminator.
        """
        batch_rollover_size_in_mbs: NotRequired[pulumi.Input[builtins.int]]
        """
        (Updatable) The batch rollover size in megabytes.
        """
        batch_rollover_time_in_ms: NotRequired[pulumi.Input[builtins.int]]
        """
        (Updatable) The batch rollover time in milliseconds.
        """
        batch_size_in_kbs: NotRequired[pulumi.Input[builtins.int]]
        """
        (Updatable) The batch rollover size in kilobytes. Only one size option can be specified: `batchSizeInKbs` or `batchSizeInNum`.
        """
        batch_size_in_num: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        batch_time_in_sec: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        enable_formatted_messaging: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        log_source_identifier: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        object_name_prefix: NotRequired[pulumi.Input[builtins.str]]
        """
...
class ConnectorTargetArgs:
    def __init__(__self__, *,
                 kind: pulumi.Input[builtins.str],
                 batch_rollover_size_in_mbs: Optional[pulumi.Input[builtins.int]] = None,
                 batch_rollover_time_in_ms: Optional[pulumi.Input[builtins.int]] = None,
                 batch_size_in_kbs: Optional[pulumi.Input[builtins.int]] = None,
                 batch_size_in_num: Optional[pulumi.Input[builtins.int]] = None,
                 ...
                 enable_formatted_messaging: Optional[pulumi.Input[builtins.bool]] = None,
                 function_id: Optional[pulumi.Input[builtins.str]] = None,
                 log_group_id: Optional[pulumi.Input[builtins.str]] = None,
                 log_source_identifier: Optional[pulumi.Input[builtins.str]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] kind: (Updatable) The type discriminator.
        :param pulumi.Input[builtins.int] batch_rollover_size_in_mbs: (Updatable) The batch rollover size in megabytes.
        :param pulumi.Input[builtins.int] batch_rollover_time_in_ms: (Updatable) The batch rollover time in milliseconds.
        :param pulumi.Input[builtins.int] batch_size_in_kbs: (Updatable) The batch rollover size in kilobytes. Only one size option can be specified: `batchSizeInKbs` or `batchSizeInNum`.
        :param pulumi.Input[builtins.int] batch_size_in_num: (Updatable) The batch rollover size in number of messages. Only one size option can be specified: `batchSizeInKbs` or `batchSizeInNum`.
        :param pulumi.Input[builtins.int] batch_time_in_sec: (Updatable) The batch rollover time in seconds.
        :param pulumi.Input[builtins.str] bucket: (Updatable) The name of the bucket. Valid characters are letters (upper or lower case), numbers, hyphens (-), underscores(_), and periods (.). Bucket names must be unique within an Object Storage namespace. Avoid entering confidential information. Example: my-new-bucket1
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment containing the metric.
        ...
        :param pulumi.Input[builtins.bool] enable_formatted_messaging: (Updatable) Whether to apply a simplified, user-friendly format to the message. Applies only when friendly formatting is supported by the connector source and the subscription protocol. Example: `true`
        :param pulumi.Input[builtins.str] function_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the function.
        :param pulumi.Input[builtins.str] log_group_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Logging Analytics log group.
        :param pulumi.Input[builtins.str] log_source_identifier: (Updatable) Identifier of the log source that you want to use for processing data received from the connector source. Applies to `StreamingSource` only. Equivalent to `name` at [LogAnalyticsSource](https://docs.cloud.oracle.com/iaas/api/#/en/logan-api-spec/latest/LogAnalyticsSource/).
        :param pulumi.Input[builtins.str] metric: (Updatable) The name of the metric. Example: `CpuUtilization`
    ...
    def batch_rollover_size_in_mbs(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The batch rollover size in megabytes.
        """
    ...
    def batch_rollover_size_in_mbs(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "batch_rollover_size_in_mbs", value)

    @property
    @pulumi.getter(name="batchRolloverTimeInMs")
    def batch_rollover_time_in_ms(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The batch rollover time in milliseconds.
        """
    ...
    def batch_rollover_time_in_ms(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "batch_rollover_time_in_ms", value)

    @property
    @pulumi.getter(name="batchSizeInKbs")
    def batch_size_in_kbs(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The batch rollover size in kilobytes. Only one size option can be specified: `batchSizeInKbs` or `batchSizeInNum`.
        """
    ...
    def batch_size_in_kbs(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "batch_size_in_kbs", value)

    @property
    @pulumi.getter(name="batchSizeInNum")
    def batch_size_in_num(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The batch rollover size in number of messages. Only one size option can be specified: `batchSizeInKbs` or `batchSizeInNum`.
        """
    ...
    def batch_size_in_num(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "batch_size_in_num", value)

    @property
    @pulumi.getter(name="batchTimeInSec")
    def batch_time_in_sec(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The batch rollover time in seconds.
        """
    ...
    def batch_time_in_sec(self, value: Optional[pulumi.Input[builtins.int]]):
    ...
    def enable_formatted_messaging(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) Whether to apply a simplified, user-friendly format to the message. Applies only when friendly formatting is supported by the connector source and the subscription protocol. Example: `true`
        """
    ...
    def enable_formatted_messaging(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def log_source_identifier(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Identifier of the log source that you want to use for processing data received from the connector source. Applies to `StreamingSource` only. Equivalent to `name` at [LogAnalyticsSource](https://docs.cloud.oracle.com/iaas/api/#/en/logan-api-spec/latest/LogAnalyticsSource/).
        """
    ...
    def log_source_identifier(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def object_name_prefix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The prefix of the objects. Avoid entering confidential information.
        """
...
class ConnectorTargetDimensionArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] name: (Updatable) Dimension key. A valid dimension key includes only printable ASCII, excluding periods (.) and spaces. Custom dimension keys are acceptable. Avoid entering confidential information. Due to use by Connector Hub, the following dimension names are reserved: `connectorId`, `connectorName`, `connectorSourceType`. For information on valid dimension keys and values, see [MetricDataDetails Reference](https://docs.cloud.oracle.com/iaas/api/#/en/monitoring/latest/datatypes/MetricDataDetails). Example: `type`
        """
