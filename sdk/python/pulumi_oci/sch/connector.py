    ...
    def __init__(__self__,
        ...
        test_service_connector = oci.sch.Connector("testServiceConnector",
            ...
            target=oci.sch.ConnectorTargetArgs(
                kind=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                batch_rollover_size_in_mbs=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                batch_rollover_time_in_ms=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                ...
                enable_formatted_messaging=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                function_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                log_group_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                log_source_identifier=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                metric=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                metric_namespace=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                namespace=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
            ...
            tasks=[oci.sch.ConnectorTaskArgs(
                kind=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                batch_size_in_kbs=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
                batch_time_in_sec=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
