...
class GetConnectorPluginResult:
    ...
    def connector_plugin_name(self) -> _builtins.str:
...
def get_connector_plugin(connector_plugin_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str connector_plugin_name: The name of the connector plugin. This name indicates the service to be called by the connector plugin. For example, `QueueSource` indicates the Queue service.
    """
    __args__ = dict()
