...
class GetConnectorPluginResult:
    ...
    def connector_plugin_name(self) -> builtins.str:
...
def get_connector_plugin(connector_plugin_name: Optional[builtins.str] = None,
    ...
    :param builtins.str connector_plugin_name: The name of the connector plugin. This name indicates the service to be called by the connector plugin. For example, `QueueSource` indicates the Queue service.
    """
    __args__ = dict()
...
def get_connector_plugin_output(connector_plugin_name: Optional[pulumi.Input[builtins.str]] = None,
