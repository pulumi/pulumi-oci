...
def get_connector_plugins(display_name: Optional[builtins.str] = None,
...
def get_connector_plugins_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
