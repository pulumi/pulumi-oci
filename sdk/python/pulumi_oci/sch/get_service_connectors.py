...
def get_service_connectors(compartment_id: Optional[str] = None,
    ...
    test_service_connectors = oci.Sch.get_service_connectors(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetServiceConnectorsResult(
        ...
        id=__ret__.id,
        service_connector_collections=__ret__.service_connector_collections,
        state=__ret__.state)
