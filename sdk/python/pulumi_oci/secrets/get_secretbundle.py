...
class GetSecretbundleResult:
    ...
    def secret_version_name(self) -> Optional[builtins.str]:
...
def get_secretbundle(secret_id: Optional[builtins.str] = None,
                     secret_version_name: Optional[builtins.str] = None,
    ...
    :param builtins.str secret_version_name: The name of the secret. (This might be referred to as the name of the secret version. Names are unique across the different versions of a secret.)
    :param builtins.str stage: The rotation state of the secret version.
...
def get_secretbundle_output(secret_id: Optional[pulumi.Input[builtins.str]] = None,
                            secret_version_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            stage: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                            version_number: Optional[pulumi.Input[Optional[builtins.str]]] = None,
