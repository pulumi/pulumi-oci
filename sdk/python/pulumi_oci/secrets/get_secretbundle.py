...
class GetSecretbundleResult:
    ...
    def secret_version_name(self) -> Optional[_builtins.str]:
...
def get_secretbundle(secret_id: Optional[_builtins.str] = None,
                     secret_version_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str secret_version_name: The name of the secret. (This might be referred to as the name of the secret version. Names are unique across the different versions of a secret.)
    :param _builtins.str stage: The rotation state of the secret version.
