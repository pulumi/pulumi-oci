...
class GetSecurityAttributeResult:
    ...
    def security_attribute_name(self) -> _builtins.str:
...
def get_security_attribute(security_attribute_name: Optional[_builtins.str] = None,
    ...
    :param _builtins.str security_attribute_name: The name of the security attribute.
...
def get_security_attribute_output(security_attribute_name: Optional[pulumi.Input[_builtins.str]] = None,
