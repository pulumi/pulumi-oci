...
class GetSecurityAttributeResult:
    ...
    def security_attribute_name(self) -> builtins.str:
...
def get_security_attribute(security_attribute_name: Optional[builtins.str] = None,
    ...
    :param builtins.str security_attribute_name: The name of the security attribute.
...
def get_security_attribute_output(security_attribute_name: Optional[pulumi.Input[builtins.str]] = None,
