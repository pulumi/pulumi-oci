...
def get_security_attribute_namespaces(compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.bool compartment_id_in_subtree: An optional boolean parameter indicating whether to retrieve all security attribute namespaces in subcompartments. If this parameter is not specified, only the namespaces defined in the specified compartment are retrieved.
