...
class SecurityAttributeArgs:
    def __init__(__self__, *,
                 ...
                 security_attribute_namespace_id: pulumi.Input[builtins.str],
                 is_retired: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) The description you assign to the security attribute during creation.
        :param pulumi.Input[builtins.str] security_attribute_namespace_id: The OCID of the security attribute namespace.
        :param pulumi.Input[builtins.bool] is_retired: Indicates whether the security attribute is retired. See [Managing Security Attribute Namespaces](https://docs.cloud.oracle.com/iaas/Content/zero-trust-packet-routing/managing-security-attribute-namespaces.htm).
        :param pulumi.Input[builtins.str] name: The name you assign to the security attribute during creation. This is the security attribute key. The name must be unique within the namespace and cannot be changed.
    ...
    def security_attribute_namespace_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def security_attribute_namespace_id(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "security_attribute_namespace_id", value)

    @property
    @pulumi.getter(name="isRetired")
    def is_retired(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    @is_retired.setter
    def is_retired(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _SecurityAttributeState:
    def __init__(__self__, *,
                 ...
                 is_retired: Optional[pulumi.Input[builtins.bool]] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
                 security_attribute_namespace_id: Optional[pulumi.Input[builtins.str]] = None,
                 security_attribute_namespace_name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: The OCID of the compartment that contains the security attribute definition.
        :param pulumi.Input[builtins.str] description: (Updatable) The description you assign to the security attribute during creation.
        :param pulumi.Input[builtins.bool] is_retired: Indicates whether the security attribute is retired. See [Managing Security Attribute Namespaces](https://docs.cloud.oracle.com/iaas/Content/zero-trust-packet-routing/managing-security-attribute-namespaces.htm).
        :param pulumi.Input[builtins.str] name: The name you assign to the security attribute during creation. This is the security attribute key. The name must be unique within the namespace and cannot be changed.
        :param pulumi.Input[builtins.str] security_attribute_namespace_id: The OCID of the security attribute namespace.
        :param pulumi.Input[builtins.str] security_attribute_namespace_name: The name of the security attribute namespace that contains the security attribute.
        :param pulumi.Input[builtins.str] state: The security attribute's current state. After creating a security attribute, make sure its `lifecycleState` is ACTIVE before using it. After retiring a security attribute, make sure its `lifecycleState` is INACTIVE before using it. If you delete a security attribute, you cannot delete another security attribute until the deleted security attribute's `lifecycleState` changes from DELETING to DELETED.
        :param pulumi.Input[builtins.str] time_created: Date and time the security attribute was created, in the format defined by RFC3339.  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] type: The data type of the security attribute.
        :param pulumi.Input['SecurityAttributeValidatorArgs'] validator: (Updatable) Validates a security attribute value. Each validator performs validation steps in addition to the standard validation for security attribute values. For more information, see [Limits on Security Attributes](https://docs.cloud.oracle.com/iaas/Content/zero-trust-packet-routing/overview.htm).
    ...
    @property
    @pulumi.getter(name="securityAttributeNamespaceId")
    def security_attribute_namespace_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The OCID of the security attribute namespace.
        """
        return pulumi.get(self, "security_attribute_namespace_id")
    ...
    @security_attribute_namespace_id.setter
    def security_attribute_namespace_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "security_attribute_namespace_id", value)

    @property
    @pulumi.getter(name="securityAttributeNamespaceName")
    def security_attribute_namespace_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def security_attribute_namespace_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SecurityAttribute(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="isRetired")
    def is_retired(self) -> pulumi.Output[builtins.bool]:
        """
        Indicates whether the security attribute is retired. See [Managing Security Attribute Namespaces](https://docs.cloud.oracle.com/iaas/Content/zero-trust-packet-routing/managing-security-attribute-namespaces.htm).
        """
        return pulumi.get(self, "is_retired")
    ...
    @property
    @pulumi.getter(name="securityAttributeNamespaceId")
    def security_attribute_namespace_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the security attribute namespace.
        """
        return pulumi.get(self, "security_attribute_namespace_id")
    ...
    @property
    @pulumi.getter(name="securityAttributeNamespaceName")
    def security_attribute_namespace_name(self) -> pulumi.Output[builtins.str]:
        """
        The name of the security attribute namespace that contains the security attribute.
        """
        return pulumi.get(self, "security_attribute_namespace_name")
