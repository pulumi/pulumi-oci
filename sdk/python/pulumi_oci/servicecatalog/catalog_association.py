...
class CatalogAssociationArgs:
    def __init__(__self__, *,
                 ...
                 service_catalog_id: pulumi.Input[builtins.str],
                 entity_type: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a CatalogAssociation resource.
        :param pulumi.Input[builtins.str] entity_id: Identifier of the entity being associated with service catalog.
        :param pulumi.Input[builtins.str] service_catalog_id: Identifier of the service catalog.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] entity_type: The type of the entity that is associated with the service catalog.
        """
    ...
    def service_catalog_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def service_catalog_id(self, value: pulumi.Input[builtins.str]):
...
class _CatalogAssociationState:
    def __init__(__self__, *,
                 ...
                 entity_type: Optional[pulumi.Input[builtins.str]] = None,
                 service_catalog_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] service_catalog_id: Identifier of the service catalog.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] time_created: Timestamp of when the resource was associated with service catalog.
        """
    ...
    @property
    @pulumi.getter(name="serviceCatalogId")
    def service_catalog_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Identifier of the service catalog.
    ...
    @service_catalog_id.setter
    def service_catalog_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "service_catalog_id", value)
...
class CatalogAssociation(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            entity_type: Optional[pulumi.Input[builtins.str]] = None,
            service_catalog_id: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'CatalogAssociation':
        """
    ...
    @property
    @pulumi.getter(name="serviceCatalogId")
    def service_catalog_id(self) -> pulumi.Output[builtins.str]:
        """
        Identifier of the service catalog.
