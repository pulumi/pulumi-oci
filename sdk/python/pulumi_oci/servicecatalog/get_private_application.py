...
def get_private_application(private_application_id: Optional[builtins.str] = None,
...
def get_private_application_output(private_application_id: Optional[pulumi.Input[builtins.str]] = None,
