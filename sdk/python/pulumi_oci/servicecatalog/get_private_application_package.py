...
class GetPrivateApplicationPackageResult:
    ...
    def private_application_package_id(self) -> builtins.str:
...
def get_private_application_package(private_application_package_id: Optional[builtins.str] = None,
...
def get_private_application_package_output(private_application_package_id: Optional[pulumi.Input[builtins.str]] = None,
