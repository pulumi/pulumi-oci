...
class GetPrivateApplicationPackagesResult:
    ...
    def package_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def private_application_package_id(self) -> Optional[builtins.str]:
...
def get_private_application_packages(display_name: Optional[builtins.str] = None,
                                     filters: Optional[Sequence[Union['GetPrivateApplicationPackagesFilterArgs', 'GetPrivateApplicationPackagesFilterArgsDict']]] = None,
                                     package_types: Optional[Sequence[builtins.str]] = None,
                                     private_application_id: Optional[builtins.str] = None,
                                     private_application_package_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] package_types: Name of the package type. If multiple package types are provided, then any resource with one or more matching package types will be returned.
    :param builtins.str private_application_id: The unique identifier for the private application.
    :param builtins.str private_application_package_id: The unique identifier for the private application package.
    """
    __args__ = dict()
...
def get_private_application_packages_output(display_name: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                            ...
                                            package_types: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                            private_application_id: Optional[pulumi.Input[builtins.str]] = None,
                                            private_application_package_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
