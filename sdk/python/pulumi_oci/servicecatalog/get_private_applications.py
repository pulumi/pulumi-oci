...
class GetPrivateApplicationsResult:
    ...
    def private_application_id(self) -> Optional[builtins.str]:
...
def get_private_applications(compartment_id: Optional[builtins.str] = None,
...
def get_private_applications_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                    ...
                                    private_application_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
    ...
    return __ret__.apply(lambda __response__: GetPrivateApplicationsResult(
        ...
        private_application_collections=pulumi.get(__response__, 'private_application_collections'),
