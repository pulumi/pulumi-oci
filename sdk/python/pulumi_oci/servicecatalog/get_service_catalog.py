...
def get_service_catalog(service_catalog_id: Optional[builtins.str] = None,
...
def get_service_catalog_output(service_catalog_id: Optional[pulumi.Input[builtins.str]] = None,
