...
class GetServiceCatalogAssociationResult:
    ...
    def service_catalog_association_id(self) -> builtins.str:
...
def get_service_catalog_association(service_catalog_association_id: Optional[builtins.str] = None,
    ...
    :param builtins.str service_catalog_association_id: The unique identifier of the service catalog association.
    """
    __args__ = dict()
...
def get_service_catalog_association_output(service_catalog_association_id: Optional[pulumi.Input[builtins.str]] = None,
