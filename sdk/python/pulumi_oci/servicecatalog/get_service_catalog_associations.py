...
class GetServiceCatalogAssociationsResult:
    ...
    def service_catalog_association_id(self) -> Optional[builtins.str]:
...
def get_service_catalog_associations(entity_id: Optional[builtins.str] = None,
                                     ...
                                     service_catalog_association_id: Optional[builtins.str] = None,
    ...
    :param builtins.str service_catalog_association_id: The unique identifier for the service catalog association.
...
def get_service_catalog_associations_output(entity_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                            ...
                                            service_catalog_association_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
