...
class PrivateApplicationArgs:
    def __init__(__self__, *,
                 ...
                 short_description: pulumi.Input[builtins.str],
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 logo_file_base64encoded: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment where you want to create the private application.
        ...
        :param pulumi.Input[builtins.str] short_description: (Updatable) A short description of the private application.
        ...
        :param pulumi.Input[builtins.str] logo_file_base64encoded: (Updatable) Base64-encoded logo to use as the private application icon. Template icon file requirements: PNG format, 50 KB maximum, 130 x 130 pixels.
        :param pulumi.Input[builtins.str] long_description: (Updatable) A long description of the private application.
        """
    ...
    def short_description(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def short_description(self, value: pulumi.Input[builtins.str]):
    ...
    def logo_file_base64encoded(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def logo_file_base64encoded(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _PrivateApplicationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] long_description: (Updatable) A long description of the private application.
        :param pulumi.Input['PrivateApplicationPackageDetailsArgs'] package_details: A base object for creating a private application package.
        :param pulumi.Input[builtins.str] package_type: Type of packages within this private application.
        :param pulumi.Input[builtins.str] short_description: (Updatable) A short description of the private application.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The lifecycle state of the private application.
        :param pulumi.Input[builtins.str] time_created: The date and time the private application was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.  Example: `2021-05-26T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_updated: The date and time the private application was last modified, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.  Example: `2021-12-10T05:10:29.721Z`
        """
...
@pulumi.type_token("oci:ServiceCatalog/privateApplication:PrivateApplication")
class PrivateApplication(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'PrivateApplication':
        """
    ...
    @property
    @pulumi.getter(name="logoFileBase64encoded")
    def logo_file_base64encoded(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Base64-encoded logo to use as the private application icon. Template icon file requirements: PNG format, 50 KB maximum, 130 x 130 pixels.
        """
        return pulumi.get(self, "logo_file_base64encoded")
    ...
    @property
    @pulumi.getter(name="longDescription")
    def long_description(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) A long description of the private application.
        """
        return pulumi.get(self, "long_description")
