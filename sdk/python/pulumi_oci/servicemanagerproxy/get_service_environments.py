...
class GetServiceEnvironmentsResult:
    ...
    def service_environment_id(self) -> Optional[builtins.str]:
        return pulumi.get(self, "service_environment_id")

    @property
    @pulumi.getter(name="serviceEnvironmentType")
    def service_environment_type(self) -> Optional[builtins.str]:
...
def get_service_environments(compartment_id: Optional[builtins.str] = None,
                             ...
                             service_environment_type: Optional[builtins.str] = None,
    ...
    :param builtins.str service_environment_type: The environment's service definition type.  For example, "RGBUOROMS" is the service definition type for "Oracle Retail Order Management Cloud Service".
    """
    __args__ = dict()
...
def get_service_environments_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                    ...
                                    service_environment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    service_environment_type: Optional[pulumi.Input[Optional[builtins.str]]] = None,
