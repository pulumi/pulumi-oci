...
def get_access_policy(access_policy_id: Optional[builtins.str] = None,
    ...
    :param builtins.str access_policy_id: Unique AccessPolicy identifier.
    """
    __args__ = dict()
...
def get_access_policy_output(access_policy_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:ServiceMesh/getAccessPolicy:getAccessPolicy', __args__, opts=opts, typ=GetAccessPolicyResult)
