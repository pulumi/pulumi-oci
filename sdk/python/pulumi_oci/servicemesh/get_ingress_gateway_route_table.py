...
class GetIngressGatewayRouteTableResult:
    ...
    def ingress_gateway_route_table_id(self) -> builtins.str:
...
def get_ingress_gateway_route_table(ingress_gateway_route_table_id: Optional[builtins.str] = None,
    ...
    :param builtins.str ingress_gateway_route_table_id: Unique IngressGatewayRouteTable identifier.
    """
    __args__ = dict()
...
def get_ingress_gateway_route_table_output(ingress_gateway_route_table_id: Optional[pulumi.Input[builtins.str]] = None,
