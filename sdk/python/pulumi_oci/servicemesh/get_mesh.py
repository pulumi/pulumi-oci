...
def get_mesh(mesh_id: Optional[builtins.str] = None,
...
def get_mesh_output(mesh_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:ServiceMesh/getMesh:getMesh', __args__, opts=opts, typ=GetMeshResult)
