...
def get_meshes(compartment_id: Optional[str] = None,
    ...
    test_meshes = oci.ServiceMesh.get_meshes(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetMeshesResult(
        ...
        id=__ret__.id,
        mesh_collections=__ret__.mesh_collections,
        state=__ret__.state)
