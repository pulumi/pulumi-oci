...
def get_virtual_deployment(virtual_deployment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str virtual_deployment_id: Unique VirtualDeployment identifier.
    """
    __args__ = dict()
...
def get_virtual_deployment_output(virtual_deployment_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetVirtualDeploymentResult(
        ...
        virtual_deployment_id=pulumi.get(__response__, 'virtual_deployment_id'),
