...
def get_virtual_deployments(compartment_id: Optional[builtins.str] = None,
...
def get_virtual_deployments_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
