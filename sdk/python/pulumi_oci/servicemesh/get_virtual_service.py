...
def get_virtual_service(virtual_service_id: Optional[builtins.str] = None,
...
def get_virtual_service_output(virtual_service_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetVirtualServiceResult(
        ...
        default_routing_policies=pulumi.get(__response__, 'default_routing_policies'),
