...
def get_virtual_service_route_tables(compartment_id: Optional[builtins.str] = None,
                                     filters: Optional[Sequence[Union['GetVirtualServiceRouteTablesFilterArgs', 'GetVirtualServiceRouteTablesFilterArgsDict']]] = None,
...
def get_virtual_service_route_tables_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                            ...
                                            virtual_service_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                            opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetVirtualServiceRouteTablesResult]:
    """
    This data source provides the list of Virtual Service Route Tables in Oracle Cloud Infrastructure Service Mesh service.
