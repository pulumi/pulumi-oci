...
class IngressGateway(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_ingress_gateway = oci.service_mesh.IngressGateway("testIngressGateway",
            ...
            hosts=[oci.service.mesh.IngressGatewayHostArgs(
                listeners=[oci.service.mesh.IngressGatewayHostListenerArgs(
                    port=var["ingress_gateway_hosts_listeners_port"],
                    protocol=var["ingress_gateway_hosts_listeners_protocol"],
                    tls=oci.service.mesh.IngressGatewayHostListenerTlsArgs(
                        mode=var["ingress_gateway_hosts_listeners_tls_mode"],
                        client_validation=oci.service.mesh.IngressGatewayHostListenerTlsClientValidationArgs(
                            subject_alternate_names=var["ingress_gateway_hosts_listeners_tls_client_validation_subject_alternate_names"],
                            trusted_ca_bundle=oci.service.mesh.IngressGatewayHostListenerTlsClientValidationTrustedCaBundleArgs(
                        ...
                        server_certificate=oci.service.mesh.IngressGatewayHostListenerTlsServerCertificateArgs(
            ...
            access_logging=oci.service.mesh.IngressGatewayAccessLoggingArgs(
            ...
            mtls=oci.service.mesh.IngressGatewayMtlsArgs(
