...
class IngressGatewayRouteTable(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_ingress_gateway_route_table = oci.service_mesh.IngressGatewayRouteTable("testIngressGatewayRouteTable",
            ...
            route_rules=[oci.service.mesh.IngressGatewayRouteTableRouteRuleArgs(
                destinations=[oci.service.mesh.IngressGatewayRouteTableRouteRuleDestinationArgs(
                ...
                ingress_gateway_host=oci.service.mesh.IngressGatewayRouteTableRouteRuleIngressGatewayHostArgs(
