...
class IngressGatewayRouteTableArgs:
    def __init__(__self__, *,
                 ...
                 ingress_gateway_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] ingress_gateway_id: The OCID of the service mesh in which this access policy is created.
        ...
        :param pulumi.Input[builtins.str] name: A user-friendly name. The name must be unique within the same ingress gateway and cannot be changed after creation. Avoid entering confidential information.  Example: `My unique resource name`
        :param pulumi.Input[builtins.int] priority: (Updatable) The priority of the route table. Lower value means higher priority. The routes are declared based on the priority.
        """
    ...
    def ingress_gateway_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def ingress_gateway_id(self, value: pulumi.Input[builtins.str]):
...
class IngressGatewayRouteTable(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'IngressGatewayRouteTable':
        """
    ...
    @property
    @pulumi.getter(name="ingressGatewayId")
    def ingress_gateway_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the service mesh in which this access policy is created.
        """
        return pulumi.get(self, "ingress_gateway_id")
