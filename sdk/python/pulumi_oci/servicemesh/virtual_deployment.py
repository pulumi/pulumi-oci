...
class VirtualDeployment(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_virtual_deployment = oci.service_mesh.VirtualDeployment("testVirtualDeployment",
            ...
            listeners=[oci.service.mesh.VirtualDeploymentListenerArgs(
                port=var["virtual_deployment_listeners_port"],
                protocol=var["virtual_deployment_listeners_protocol"],
            )],
            service_discovery=oci.service.mesh.VirtualDeploymentServiceDiscoveryArgs(
            ...
            access_logging=oci.service.mesh.VirtualDeploymentAccessLoggingArgs(
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[str]] = None,
            time_updated: Optional[pulumi.Input[str]] = None,
            virtual_service_id: Optional[pulumi.Input[str]] = None) -> 'VirtualDeployment':
        """
