...
class VirtualServiceArgs:
    def __init__(__self__, *,
                 ...
                 mesh_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] mesh_id: The OCID of the service mesh in which this virtual service is created.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) Description of the resource. It can be changed after creation. Avoid entering confidential information.  Example: `This is my new resource`
        ...
        :param pulumi.Input[builtins.str] name: A user-friendly name. The name has to be unique within the same service mesh and cannot be changed after creation. Avoid entering confidential information.  Example: `My unique resource name` 
    ...
    def mesh_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    @mesh_id.setter
    def mesh_id(self, value: pulumi.Input[builtins.str]):
...
class _VirtualServiceState:
    def __init__(__self__, *,
                 ...
                 mesh_id: Optional[pulumi.Input[builtins.str]] = None,
                 mtls: Optional[pulumi.Input['VirtualServiceMtlsArgs']] = None,
                 name: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] time_created: The time when this resource was created in an RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The time when this resource was updated in an RFC3339 formatted datetime string.
        """
    ...
    @property
    @pulumi.getter(name="meshId")
    def mesh_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The OCID of the service mesh in which this virtual service is created.
        """
        return pulumi.get(self, "mesh_id")
    ...
    @mesh_id.setter
    def mesh_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "mesh_id", value)
...
class VirtualService(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'VirtualService':
        """
    ...
    @property
    @pulumi.getter(name="meshId")
    def mesh_id(self) -> pulumi.Output[builtins.str]:
        """
        The OCID of the service mesh in which this virtual service is created.
        """
        return pulumi.get(self, "mesh_id")
