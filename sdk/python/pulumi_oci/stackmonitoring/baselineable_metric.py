...
class BaselineableMetric(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 __props__=None):
        """
        Create a BaselineableMetric resource with the given unique name, props, and options.
    ...
    @property
    @pulumi.getter(name="isOutOfBox")
    def is_out_of_box(self) -> pulumi.Output[Optional[bool]]:
        return pulumi.get(self, "is_out_of_box")
    ...
    @property
    @pulumi.getter(name="timeLastUpdated")
    def time_last_updated(self) -> pulumi.Output[Optional[str]]:
        return pulumi.get(self, "time_last_updated")
