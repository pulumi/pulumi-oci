...
class _DiscoveryJobState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] should_propagate_tags_to_discovered_resources: If this parameter set to true, the specified tags will be applied  to all resources discovered in the current request.  Default is true. 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] state: The current state of the DiscoveryJob Resource.
        :param pulumi.Input[_builtins.str] status: Specifies the status of the discovery job
        :param pulumi.Input[_builtins.str] status_message: The short summary of the status of the discovery job
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param pulumi.Input[_builtins.str] tenant_id: The OCID of Tenant
        :param pulumi.Input[_builtins.str] time_updated: The time the discovery Job was updated.
        :param pulumi.Input[_builtins.str] user_id: The OCID of user in which the job is submitted
        """
...
class DiscoveryJob(pulumi.CustomResource):
    ...
    @_builtins.property
    @pulumi.getter(name="discoveryClient")
    def discovery_client(self) -> pulumi.Output[_builtins.str]:
        """
        Client who submits discovery job.
        """
        return pulumi.get(self, "discovery_client")
    ...
    @_builtins.property
    @pulumi.getter(name="discoveryType")
    def discovery_type(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        Add option submits new discovery Job. Add with retry option to re-submit failed discovery job. Refresh option refreshes the existing discovered resources.
        """
        return pulumi.get(self, "discovery_type")
    ...
    @_builtins.property
    @pulumi.getter(name="shouldPropagateTagsToDiscoveredResources")
    def should_propagate_tags_to_discovered_resources(self) -> pulumi.Output[_builtins.bool]:
        """
        If this parameter set to true, the specified tags will be applied  to all resources discovered in the current request.  Default is true. 
