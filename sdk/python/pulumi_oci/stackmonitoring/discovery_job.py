...
class DiscoveryJobArgs:
    def __init__(__self__, *,
                 ...
                 discovery_client: Optional[pulumi.Input[builtins.str]] = None,
                 discovery_type: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 should_propagate_tags_to_discovered_resources: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a DiscoveryJob resource.
        :param pulumi.Input[builtins.str] compartment_id: The OCID of Compartment
        ...
        :param pulumi.Input[builtins.str] discovery_client: Client who submits discovery job.
        :param pulumi.Input[builtins.str] discovery_type: Add option submits new discovery Job. Add with retry option to re-submit failed discovery job. Refresh option refreshes the existing discovered resources.
        ...
        :param pulumi.Input[builtins.bool] should_propagate_tags_to_discovered_resources: If this parameter set to true, the specified tags will be applied  to all resources discovered in the current request.  Default is true. 
    ...
    def discovery_client(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def discovery_client(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def should_propagate_tags_to_discovered_resources(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def should_propagate_tags_to_discovered_resources(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _DiscoveryJobState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.bool] should_propagate_tags_to_discovered_resources: If this parameter set to true, the specified tags will be applied  to all resources discovered in the current request.  Default is true. 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The current state of the DiscoveryJob Resource.
        :param pulumi.Input[builtins.str] status: Specifies the status of the discovery job
        :param pulumi.Input[builtins.str] status_message: The short summary of the status of the discovery job
        ...
        :param pulumi.Input[builtins.str] tenant_id: The OCID of Tenant
        :param pulumi.Input[builtins.str] time_updated: The time the discovery Job was updated.
        :param pulumi.Input[builtins.str] user_id: The OCID of user in which the job is submitted
        """
...
class DiscoveryJob(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tenant_id: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'DiscoveryJob':
        """
    ...
    @property
    @pulumi.getter(name="discoveryClient")
    def discovery_client(self) -> pulumi.Output[builtins.str]:
        """
        Client who submits discovery job.
        """
        return pulumi.get(self, "discovery_client")
    ...
    @property
    @pulumi.getter(name="discoveryType")
    def discovery_type(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Add option submits new discovery Job. Add with retry option to re-submit failed discovery job. Refresh option refreshes the existing discovered resources.
        """
        return pulumi.get(self, "discovery_type")
    ...
    @property
    @pulumi.getter(name="shouldPropagateTagsToDiscoveredResources")
    def should_propagate_tags_to_discovered_resources(self) -> pulumi.Output[builtins.bool]:
        """
        If this parameter set to true, the specified tags will be applied  to all resources discovered in the current request.  Default is true. 
