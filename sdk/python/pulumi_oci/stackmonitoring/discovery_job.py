...
class DiscoveryJob(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_discovery_job = oci.stack_monitoring.DiscoveryJob("testDiscoveryJob",
            ...
            discovery_details=oci.stack.monitoring.DiscoveryJobDiscoveryDetailsArgs(
                agent_id=var["management_agent_id"],
                properties=oci.stack.monitoring.DiscoveryJobDiscoveryDetailsPropertiesArgs(
                ...
                credentials=oci.stack.monitoring.DiscoveryJobDiscoveryDetailsCredentialsArgs(
                    items=[oci.stack.monitoring.DiscoveryJobDiscoveryDetailsCredentialsItemArgs(
                        ...
                        properties=oci.stack.monitoring.DiscoveryJobDiscoveryDetailsCredentialsItemPropertiesArgs(
                            properties_map=var["discovery_job_discovery_details_credentials_items_properties_properties_map"],
                        ),
                    )],
                ),
                tags=oci.stack.monitoring.DiscoveryJobDiscoveryDetailsTagsArgs(
