...
def get_config(config_id: Optional[builtins.str] = None,
    ...
    :param builtins.str config_id: Unique Config identifier.
    """
    __args__ = dict()
...
def get_config_output(config_id: Optional[pulumi.Input[builtins.str]] = None,
