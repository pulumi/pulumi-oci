...
def get_configs(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str state: The current state of the Config.
    :param builtins.str type: A filter to return only configuration items for a given config type. The only valid config type is `"AUTO_PROMOTE"`
    """
    __args__ = dict()
...
def get_configs_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
