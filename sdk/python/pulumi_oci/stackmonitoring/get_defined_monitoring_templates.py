...
def get_defined_monitoring_templates(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the tenancy(root) for which  defined monitored templates should be listed.
...
def get_defined_monitoring_templates_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
