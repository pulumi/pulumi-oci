...
class GetDiscoveryJobResult:
    ...
    def discovery_client(self) -> builtins.str:
        """
    ...
    def should_propagate_tags_to_discovered_resources(self) -> builtins.bool:
...
def get_discovery_job(discovery_job_id: Optional[builtins.str] = None,
    ...
    :param builtins.str discovery_job_id: The Discovery Job ID
    """
    __args__ = dict()
...
def get_discovery_job_output(discovery_job_id: Optional[pulumi.Input[builtins.str]] = None,
