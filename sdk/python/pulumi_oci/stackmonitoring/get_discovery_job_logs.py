...
def get_discovery_job_logs(discovery_job_id: Optional[builtins.str] = None,
    ...
    :param builtins.str log_type: The log type like INFO, WARNING, ERROR, SUCCESS
    """
    __args__ = dict()
...
def get_discovery_job_logs_output(discovery_job_id: Optional[pulumi.Input[builtins.str]] = None,
