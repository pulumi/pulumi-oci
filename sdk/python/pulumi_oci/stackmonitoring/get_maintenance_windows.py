...
def get_maintenance_windows(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str lifecycle_details: A filter to return maintenance windows with matching lifecycleDetails.
    :param builtins.str name: A filter to return maintenance windows that match exact resource name.
    :param builtins.str status: A filter to return only maintenance windows with matching lifecycleState.
    """
    __args__ = dict()
...
def get_maintenance_windows_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
