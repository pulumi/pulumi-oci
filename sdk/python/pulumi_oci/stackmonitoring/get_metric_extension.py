...
class GetMetricExtensionResult:
    ...
    def metric_extension_id(self) -> _builtins.str:
...
def get_metric_extension(metric_extension_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str metric_extension_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the metric extension resource.
    """
    __args__ = dict()
