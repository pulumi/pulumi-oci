...
class GetMetricExtensionResult:
    ...
    def metric_extension_id(self) -> builtins.str:
...
def get_metric_extension(metric_extension_id: Optional[builtins.str] = None,
    ...
    :param builtins.str metric_extension_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the metric extension resource.
    """
    __args__ = dict()
...
def get_metric_extension_output(metric_extension_id: Optional[pulumi.Input[builtins.str]] = None,
