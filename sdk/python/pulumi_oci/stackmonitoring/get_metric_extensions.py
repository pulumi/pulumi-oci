...
class GetMetricExtensionsResult:
    ...
    def enabled_on_resource_id(self) -> Optional[_builtins.str]:
    ...
    def metric_extension_id(self) -> Optional[_builtins.str]:
...
def get_metric_extensions(compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str enabled_on_resource_id: A filter to return metric extensions based on input resource Id on which metric extension is enabled
    :param _builtins.str metric_extension_id: Identifier for the metric extension
