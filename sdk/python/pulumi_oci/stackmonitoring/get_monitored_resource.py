...
class GetMonitoredResourceResult:
    ...
    def external_resource_id(self) -> builtins.str:
    ...
    def monitored_resource_id(self) -> builtins.str:
    ...
    def resource_time_zone(self) -> builtins.str:
        """
...
def get_monitored_resource(monitored_resource_id: Optional[builtins.str] = None,
    ...
    :param builtins.str monitored_resource_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of monitored resource.
    """
    __args__ = dict()
...
def get_monitored_resource_output(monitored_resource_id: Optional[pulumi.Input[builtins.str]] = None,
