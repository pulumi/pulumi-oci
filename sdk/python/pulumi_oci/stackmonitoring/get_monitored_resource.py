...
class GetMonitoredResourceResult:
    ...
    def monitored_resource_id(self) -> _builtins.str:
...
def get_monitored_resource(monitored_resource_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str monitored_resource_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of monitored resource.
    """
    __args__ = dict()
