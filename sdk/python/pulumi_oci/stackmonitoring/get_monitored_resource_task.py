...
class GetMonitoredResourceTaskResult:
    ...
    def monitored_resource_task_id(self) -> builtins.str:
...
def get_monitored_resource_task(monitored_resource_task_id: Optional[builtins.str] = None,
    ...
    :param builtins.str monitored_resource_task_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of stack monitoring resource task.
    """
    __args__ = dict()
