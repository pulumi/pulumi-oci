...
def get_monitored_resource_tasks(compartment_id: Optional[builtins.str] = None,
...
def get_monitored_resource_tasks_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
