...
class GetMonitoredResourceTypesResult:
    ...
    def exclude_fields(self) -> Optional[Sequence[_builtins.str]]:
    ...
    def is_exclude_system_types(self) -> Optional[_builtins.bool]:
...
def get_monitored_resource_types(compartment_id: Optional[_builtins.str] = None,
                                 exclude_fields: Optional[Sequence[_builtins.str]] = None,
                                 fields: Optional[Sequence[_builtins.str]] = None,
                                 filters: Optional[Sequence[Union['GetMonitoredResourceTypesFilterArgs', 'GetMonitoredResourceTypesFilterArgsDict', 'outputs.GetMonitoredResourceTypesFilterResult']]] = None,
                                 is_exclude_system_types: Optional[_builtins.bool] = None,
    ...
    :param _builtins.bool is_exclude_system_types: A filter to exclude system resource types. If set to true, system resource types will be excluded.
...
def get_monitored_resource_types_output(compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                                        ...
                                        filters: pulumi.Input[Optional[Optional[Sequence[Union['GetMonitoredResourceTypesFilterArgs', 'GetMonitoredResourceTypesFilterArgsDict', 'outputs.GetMonitoredResourceTypesFilterResult']]]]] = None,
