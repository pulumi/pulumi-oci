...
class GetMonitoredResourceTypesResult:
    ...
    def exclude_fields(self) -> Optional[Sequence[builtins.str]]:
    ...
    def is_exclude_system_types(self) -> Optional[builtins.bool]:
...
def get_monitored_resource_types(compartment_id: Optional[builtins.str] = None,
                                 exclude_fields: Optional[Sequence[builtins.str]] = None,
