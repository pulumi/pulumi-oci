...
class GetMonitoredResourcesResult:
    ...
    def work_request_id(self) -> Optional[builtins.str]:
...
def get_monitored_resources(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str status: A filter to return only resources with matching lifecycleState.
    :param builtins.str work_request_id: A filter to return resources which were impacted as part of this work request identifier.
    """
    __args__ = dict()
...
def get_monitored_resources_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                   ...
                                   work_request_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
