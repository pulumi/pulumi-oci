...
def get_monitoring_template_alarm_condition(alarm_condition_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str alarm_condition_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the alarm condition.
