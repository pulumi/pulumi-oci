...
def get_monitoring_template_alarm_conditions(alarm_condition_id: Optional[builtins.str] = None,
    ...
    :param builtins.str state: A filter to return alarm condition based on Lifecycle State.
    :param builtins.str status: A filter to return alarm condition based on input status.
    """
    __args__ = dict()
...
def get_monitoring_template_alarm_conditions_output(alarm_condition_id: Optional[pulumi.Input[builtins.str]] = None,
