...
class GetMonitoringTemplatesResult:
    ...
    def monitoring_template_id(self) -> Optional[_builtins.str]:
...
def get_monitoring_templates(compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str monitoring_template_id: A filter to return monitoring template based on input monitoringTemplateId
    :param Sequence[_builtins.str] namespaces: namespace filter.
