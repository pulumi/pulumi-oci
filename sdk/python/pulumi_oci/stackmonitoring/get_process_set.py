...
class GetProcessSetResult:
    ...
    def process_set_id(self) -> builtins.str:
...
def get_process_set(process_set_id: Optional[builtins.str] = None,
    ...
    :param builtins.str process_set_id: The Process Set ID
    """
    __args__ = dict()
...
def get_process_set_output(process_set_id: Optional[pulumi.Input[builtins.str]] = None,
