...
class MaintenanceWindowsStopArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] maintenance_window_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of maintenance window.
...
class MaintenanceWindowsStop(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            id: pulumi.Input[str],
            opts: Optional[pulumi.ResourceOptions] = None,
            maintenance_window_id: Optional[pulumi.Input[builtins.str]] = None) -> 'MaintenanceWindowsStop':
        """
