...
class MetricExtensionArgs:
    def __init__(__self__, *,
                 collection_recurrences: pulumi.Input[builtins.str],
                 ...
                 publish_trigger: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a MetricExtension resource.
        :param pulumi.Input[builtins.str] collection_recurrences: (Updatable) Schedule of metric extension should use RFC 5545 format i.e. recur-rule-part = "FREQ";INTERVAL where FREQ rule part identifies the type of recurrence rule. Valid values are "MINUTELY","HOURLY","DAILY" to specify repeating events based on an interval of a minute, an hour and a day or more. Example- FREQ=DAILY;INTERVAL=1
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) Metric Extension display name.
        ...
        :param pulumi.Input[builtins.str] resource_type: Resource type to which Metric Extension applies
        :param pulumi.Input[builtins.str] description: (Updatable) Description of the metric extension.
        :param pulumi.Input[builtins.str] name: Metric Extension Resource name.
        :param pulumi.Input[builtins.bool] publish_trigger: (Updatable) An optional property when set to `true` triggers Publish of a metric extension. Once set to `true`, it cannot be changed back to `false`. Update of publish_trigger cannot be combined with other updates in the same request. A metric extension cannot be tested and its definition cannot be updated once it is marked published or publish_trigger is updated to `true`.
    ...
    def collection_recurrences(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def collection_recurrences(self, value: pulumi.Input[builtins.str]):
    ...
    def publish_trigger(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def publish_trigger(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _MetricExtensionState:
    def __init__(__self__, *,
                 collection_method: Optional[pulumi.Input[builtins.str]] = None,
                 collection_recurrences: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 enabled_on_resources_count: Optional[pulumi.Input[builtins.int]] = None,
        ...
        :param pulumi.Input[builtins.str] collection_method: Type of possible collection methods.
        :param pulumi.Input[builtins.str] collection_recurrences: (Updatable) Schedule of metric extension should use RFC 5545 format i.e. recur-rule-part = "FREQ";INTERVAL where FREQ rule part identifies the type of recurrence rule. Valid values are "MINUTELY","HOURLY","DAILY" to specify repeating events based on an interval of a minute, an hour and a day or more. Example- FREQ=DAILY;INTERVAL=1
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) Compartment Identifier [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)
        :param pulumi.Input[builtins.str] created_by: Created by user
        :param pulumi.Input[builtins.str] description: (Updatable) Description of the metric extension.
        :param pulumi.Input[builtins.str] display_name: (Updatable) Metric Extension display name.
        ...
        :param pulumi.Input[builtins.int] enabled_on_resources_count: Count of resources on which this metric extension is enabled.
        :param pulumi.Input[builtins.str] last_updated_by: Last updated by user
        :param pulumi.Input[Sequence[pulumi.Input['MetricExtensionMetricListArgs']]] metric_lists: (Updatable) List of metrics which are part of this metric extension
        :param pulumi.Input[builtins.str] name: Metric Extension Resource name.
        :param pulumi.Input[builtins.bool] publish_trigger: (Updatable) An optional property when set to `true` triggers Publish of a metric extension. Once set to `true`, it cannot be changed back to `false`. Update of publish_trigger cannot be combined with other updates in the same request. A metric extension cannot be tested and its definition cannot be updated once it is marked published or publish_trigger is updated to `true`.
        ...
        :param pulumi.Input['MetricExtensionQueryPropertiesArgs'] query_properties: (Updatable) Collection method and query properties details of metric extension
        :param pulumi.Input[builtins.str] resource_type: Resource type to which Metric Extension applies
        :param pulumi.Input[builtins.str] resource_uri: The URI path that the user can do a GET on to access the metric extension metadata
        :param pulumi.Input[builtins.str] state: The current lifecycle state of the metric extension
        :param pulumi.Input[builtins.str] status: The current status of the metric extension i.e. whether it is Draft or Published
        ...
        :param pulumi.Input[builtins.str] time_created: Metric Extension creation time. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: Metric Extension update time. An RFC3339 formatted datetime string.
        """
    ...
    def collection_method(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def collection_method(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "collection_method", value)

    @property
    @pulumi.getter(name="collectionRecurrences")
    def collection_recurrences(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) Schedule of metric extension should use RFC 5545 format i.e. recur-rule-part = "FREQ";INTERVAL where FREQ rule part identifies the type of recurrence rule. Valid values are "MINUTELY","HOURLY","DAILY" to specify repeating events based on an interval of a minute, an hour and a day or more. Example- FREQ=DAILY;INTERVAL=1
        """
        return pulumi.get(self, "collection_recurrences")
    ...
    @collection_recurrences.setter
    def collection_recurrences(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "collection_recurrences", value)
    ...
    def enabled_on_resources_count(self) -> Optional[pulumi.Input[builtins.int]]:
        """
    ...
    def enabled_on_resources_count(self, value: Optional[pulumi.Input[builtins.int]]):
...
class MetricExtension(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            tenant_id: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'MetricExtension':
        """
    ...
    @property
    @pulumi.getter(name="collectionMethod")
    def collection_method(self) -> pulumi.Output[builtins.str]:
        """
        Type of possible collection methods.
        """
        return pulumi.get(self, "collection_method")
    ...
    @property
    @pulumi.getter(name="collectionRecurrences")
    def collection_recurrences(self) -> pulumi.Output[builtins.str]:
        """
        (Updatable) Schedule of metric extension should use RFC 5545 format i.e. recur-rule-part = "FREQ";INTERVAL where FREQ rule part identifies the type of recurrence rule. Valid values are "MINUTELY","HOURLY","DAILY" to specify repeating events based on an interval of a minute, an hour and a day or more. Example- FREQ=DAILY;INTERVAL=1
        """
        return pulumi.get(self, "collection_recurrences")
    ...
    @property
    @pulumi.getter(name="enabledOnResourcesCount")
    def enabled_on_resources_count(self) -> pulumi.Output[builtins.int]:
        """
        Count of resources on which this metric extension is enabled.
        """
        return pulumi.get(self, "enabled_on_resources_count")
    ...
    @property
    @pulumi.getter(name="publishTrigger")
    def publish_trigger(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        (Updatable) An optional property when set to `true` triggers Publish of a metric extension. Once set to `true`, it cannot be changed back to `false`. Update of publish_trigger cannot be combined with other updates in the same request. A metric extension cannot be tested and its definition cannot be updated once it is marked published or publish_trigger is updated to `true`.
