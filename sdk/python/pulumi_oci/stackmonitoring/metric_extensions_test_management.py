...
class MetricExtensionsTestManagementArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] resource_ids: List of Resource IDs [OCID]. Currently, supports only one resource id per request.
...
class _MetricExtensionsTestManagementState:
    def __init__(__self__, *,
                 ...
                 test_run_id: Optional[pulumi.Input[builtins.str]] = None,
                 test_run_metric_suffix: Optional[pulumi.Input[builtins.str]] = None,
                 test_run_namespace_name: Optional[pulumi.Input[builtins.str]] = None,
                 test_run_resource_group_name: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] resource_ids: List of Resource IDs [OCID]. Currently, supports only one resource id per request.
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] test_run_id: Test Run Id
        :param pulumi.Input[builtins.str] test_run_metric_suffix: Test Run Metric Suffix
        :param pulumi.Input[builtins.str] test_run_namespace_name: Test Run Namespace name
        :param pulumi.Input[builtins.str] test_run_resource_group_name: Test Run Resource Group name
        """
    ...
    def test_run_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        Test Run Id
        """
    ...
    @test_run_id.setter
    def test_run_id(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "test_run_id", value)

    @property
    @pulumi.getter(name="testRunMetricSuffix")
    def test_run_metric_suffix(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def test_run_metric_suffix(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "test_run_metric_suffix", value)

    @property
    @pulumi.getter(name="testRunNamespaceName")
    def test_run_namespace_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def test_run_namespace_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "test_run_namespace_name", value)

    @property
    @pulumi.getter(name="testRunResourceGroupName")
    def test_run_resource_group_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def test_run_resource_group_name(self, value: Optional[pulumi.Input[builtins.str]]):
...
class MetricExtensionsTestManagement(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            test_run_metric_suffix: Optional[pulumi.Input[builtins.str]] = None,
            test_run_namespace_name: Optional[pulumi.Input[builtins.str]] = None,
            test_run_resource_group_name: Optional[pulumi.Input[builtins.str]] = None) -> 'MetricExtensionsTestManagement':
        """
    ...
    @property
    @pulumi.getter(name="testRunId")
    def test_run_id(self) -> pulumi.Output[builtins.str]:
        """
        Test Run Id
        """
        return pulumi.get(self, "test_run_id")
    ...
    @property
    @pulumi.getter(name="testRunMetricSuffix")
    def test_run_metric_suffix(self) -> pulumi.Output[builtins.str]:
        """
        Test Run Metric Suffix
        """
        return pulumi.get(self, "test_run_metric_suffix")
    ...
    @property
    @pulumi.getter(name="testRunNamespaceName")
    def test_run_namespace_name(self) -> pulumi.Output[builtins.str]:
        """
        Test Run Namespace name
        """
        return pulumi.get(self, "test_run_namespace_name")
    ...
    @property
    @pulumi.getter(name="testRunResourceGroupName")
    def test_run_resource_group_name(self) -> pulumi.Output[builtins.str]:
        """
        Test Run Resource Group name
        """
        return pulumi.get(self, "test_run_resource_group_name")
