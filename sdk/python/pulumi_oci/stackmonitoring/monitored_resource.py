...
class MonitoredResourceArgs:
    def __init__(__self__, *,
                 ...
                 external_resource_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) Monitored resource display name.
        ...
        :param pulumi.Input[builtins.str] host_name: (Updatable) Host name of the monitored resource.
        :param pulumi.Input[builtins.str] license: (Updatable) License edition of the monitored resource. If not provided  the default license type for the compartment will be used.
        :param pulumi.Input[builtins.str] management_agent_id: Management Agent Identifier [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        ...
        :param pulumi.Input[builtins.str] resource_time_zone: (Updatable) Time zone in the form of tz database canonical zone ID. Specifies the preference with a value that uses the IANA Time Zone Database format (x-obmcs-time-zone). For example - America/Los_Angeles
        """
    ...
    def external_resource_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def external_resource_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _MonitoredResourceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] state: Lifecycle state of the monitored resource.
        ...
        :param pulumi.Input[builtins.str] tenant_id: Tenancy Identifier [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param pulumi.Input[builtins.str] time_created: The date and time when the monitored resource was created, expressed in  [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.
        :param pulumi.Input[builtins.str] time_updated: The date and time when the monitored resource was last updated, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.
        :param pulumi.Input[builtins.str] type: Monitored Resource Type. 
...
class MonitoredResource(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'MonitoredResource':
        """
    ...
    @property
    @pulumi.getter(name="externalResourceId")
    def external_resource_id(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Generally used by DBaaS to send the Database OCID stored on the DBaaS. The same will be passed to resource service to enable Stack Monitoring Service on DBM. This will be stored in Stack Monitoring Resource Service data store as identifier for monitored resource. If this header is not set as part of the request, then an id will be generated and stored for the resource.
        """
        return pulumi.get(self, "external_resource_id")
