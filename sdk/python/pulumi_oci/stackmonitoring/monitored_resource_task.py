...
class MonitoredResourceTaskArgs:
    def __init__(__self__, *,
        ...
        """
        MonitoredResourceTaskArgs._configure(
...
class _MonitoredResourceTaskState:
    def __init__(__self__, *,
        ...
        """
        _MonitoredResourceTaskState._configure(
            lambda key, value: pulumi.set(__self__, key, value),
            compartment_id=compartment_id,
            defined_tags=defined_tags,
            freeform_tags=freeform_tags,
...
class MonitoredResourceTask(pulumi.CustomResource):
    ...
    def __init__(__self__, resource_name: str, *args, **kwargs):
        ...
        if resource_args is not None:
            ...
            def _setter(key, value):
                kwargs[key] = value
            MonitoredResourceTaskArgs._configure(_setter, **kwargs)
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            if task_details is not None and not isinstance(task_details, MonitoredResourceTaskTaskDetailsArgs):
                task_details = task_details or {}
                def _setter(key, value):
                    task_details[key] = value
                MonitoredResourceTaskTaskDetailsArgs._configure(_setter, **task_details)
