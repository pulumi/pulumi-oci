...
class MonitoredResourcesAssociateMonitoredResourceArgs:
    def __init__(__self__, *,
                 ...
                 destination_resource_id: pulumi.Input[builtins.str],
        ...
        :param pulumi.Input[builtins.str] association_type: Association type to be created between source and destination resources.
    ...
    def destination_resource_id(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def destination_resource_id(self, value: pulumi.Input[builtins.str]):
...
class _MonitoredResourcesAssociateMonitoredResourceState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] association_type: Association type to be created between source and destination resources.
        :param pulumi.Input[builtins.str] category: Association category. Possible values are:
        ...
        :param pulumi.Input[builtins.str] time_created: The time when the association was created. An RFC3339 formatted datetime string.
        """
...
class MonitoredResourcesAssociateMonitoredResource(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            source_resource_id: Optional[pulumi.Input[builtins.str]] = None,
            tenant_id: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'MonitoredResourcesAssociateMonitoredResource':
        """
    ...
    @property
    @pulumi.getter(name="destinationResourceId")
    def destination_resource_id(self) -> pulumi.Output[builtins.str]:
        """
        Destination Monitored Resource Identifier [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        """
        return pulumi.get(self, "destination_resource_id")
