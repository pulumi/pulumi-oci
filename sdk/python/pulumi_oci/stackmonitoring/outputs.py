...
class ConfigAdditionalConfigurations(dict):
    ...
    def __init__(__self__, *,
                 properties_map: Optional[Mapping[str, builtins.str]] = None):
        """
        :param Mapping[str, builtins.str] properties_map: (Updatable) Key/Value pair of Property
        """
    ...
    def properties_map(self) -> Optional[Mapping[str, builtins.str]]:
        """
...
class ConfigDynamicGroup(dict):
    ...
    def __init__(__self__, *,
                 ...
                 stack_monitoring_assignment: Optional[builtins.str] = None):
        """
        :param builtins.str domain: (Updatable) Identity domain name
        :param builtins.str name: (Updatable) Name of dynamic Group
        :param builtins.str stack_monitoring_assignment: (Updatable) Assignment of dynamic group in context of Stack Monitoring service. It describes the purpose of dynamic groups in Stack Monitoring.
        """
    ...
    def stack_monitoring_assignment(self) -> Optional[builtins.str]:
        """
...
class ConfigUserGroup(dict):
    ...
    def __init__(__self__, *,
                 domain: Optional[builtins.str] = None,
                 name: Optional[builtins.str] = None,
                 stack_monitoring_role: Optional[builtins.str] = None):
        """
        :param builtins.str domain: (Updatable) Identity domain name
        :param builtins.str name: (Updatable) Name of user Group
        :param builtins.str stack_monitoring_role: (Updatable) Role assigned to user group in context of Stack Monitoring service. Access role can be for example: ADMINISTRATOR, OPERATOR, VIEWER, any other access role
        """
        if domain is not None:
            pulumi.set(__self__, "domain", domain)
        if name is not None:
    ...
    def stack_monitoring_role(self) -> Optional[builtins.str]:
        """
...
class DiscoveryJobDiscoveryDetails(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str agent_id: The OCID of Management Agent
        :param 'DiscoveryJobDiscoveryDetailsPropertiesArgs' properties: Property Details
        :param builtins.str resource_name: The Name of resource type
        ...
        :param builtins.str license: License edition of the monitored resource.
...
class DiscoveryJobDiscoveryDetailsCredentialsItem(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str credential_name: Name of Credential
        :param builtins.str credential_type: Name of Credential Type
...
class DiscoveryJobDiscoveryDetailsCredentialsItemProperties(dict):
    ...
    def __init__(__self__, *,
                 properties_map: Optional[Mapping[str, builtins.str]] = None):
        """
        :param Mapping[str, builtins.str] properties_map: Key/Value pair of Property
        """
        if properties_map is not None:
            pulumi.set(__self__, "properties_map", properties_map)
...
class MaintenanceWindowResource(dict):
    ...
    def __init__(__self__, *,
                 ...
                 are_members_included: Optional[builtins.bool] = None):
        """
        :param builtins.str resource_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of monitored resource part of the Maintenance window.
        :param builtins.bool are_members_included: (Updatable) Flag to indicate if the members of the resource has to be include in the Maintenance Window.
        """
    ...
    def are_members_included(self) -> Optional[builtins.bool]:
        """
...
class MaintenanceWindowResourcesDetail(dict):
    ...
    def __init__(__self__, *,
                 name: Optional[builtins.str] = None,
                 number_of_members: Optional[builtins.int] = None,
                 resource_id: Optional[builtins.str] = None,
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str name: Maintenance Window name.
        :param builtins.int number_of_members: Number of members of the resource
        :param builtins.str resource_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of monitored resource part of the Maintenance window.
        :param builtins.str type: Type of the monitored resource
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
    ...
    def number_of_members(self) -> Optional[builtins.int]:
        """
...
class MaintenanceWindowSchedule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 maintenance_window_duration: Optional[builtins.str] = None,
                 maintenance_window_recurrences: Optional[builtins.str] = None,
                 time_maintenance_window_end: Optional[builtins.str] = None,
                 time_maintenance_window_start: Optional[builtins.str] = None):
        """
        :param builtins.str schedule_type: (Updatable) Property to identify the type of the Maintenance Window.
        :param builtins.str maintenance_window_duration: (Updatable) Duration time of each recurrence of each Maintenance Window. It must be specified as a string in ISO 8601 extended format.
        :param builtins.str maintenance_window_recurrences: (Updatable) A RFC5545 formatted recurrence string which represents the Maintenance Window Recurrence. Please refer this for details:https://datatracker.ietf.org/doc/html/rfc5545#section-3.3.10 FREQ: Frequency of the Maintenance Window. The supported values are: DAILY and WEEKLY. BYDAY: Comma separated days for Weekly Maintenance Window. BYHOUR: Specifies the start hour of each recurrence after `timeMaintenanceWindowStart` value. BYMINUTE: Specifies the start minute of each reccurrence after `timeMaintenanceWindowStart` value. The default value is 00 BYSECOND: Specifies the start second of each reccurrence after `timeMaintenanceWindowStart` value. The default value is 00 Other Rules are not supported.
        :param builtins.str time_maintenance_window_end: (Updatable) Start time of Maintenance window. A RFC3339 formatted datetime string
        :param builtins.str time_maintenance_window_start: (Updatable) Start time of Maintenance window. A RFC3339 formatted datetime string 
    ...
    def maintenance_window_duration(self) -> Optional[builtins.str]:
        """
    ...
    def maintenance_window_recurrences(self) -> Optional[builtins.str]:
        """
    ...
    def time_maintenance_window_end(self) -> Optional[builtins.str]:
        """
    ...
    def time_maintenance_window_start(self) -> Optional[builtins.str]:
        """
        (Updatable) Start time of Maintenance window. A RFC3339 formatted datetime string 
...
class MetricExtensionEnabledOnResource(dict):
    ...
    def __init__(__self__, *,
                 resource_id: Optional[builtins.str] = None):
        """
        :param builtins.str resource_id: The OCID of the resource on which Metric Extension is enabled
        """
        if resource_id is not None:
            pulumi.set(__self__, "resource_id", resource_id)
...
class MetricExtensionMetricList(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: builtins.str,
                 compute_expression: Optional[builtins.str] = None,
                 display_name: Optional[builtins.str] = None,
                 is_dimension: Optional[builtins.bool] = None,
                 is_hidden: Optional[builtins.bool] = None,
                 metric_category: Optional[builtins.str] = None,
                 unit: Optional[builtins.str] = None):
        """
        :param builtins.str data_type: (Updatable) Data type of value of this metric
        :param builtins.str name: (Updatable) Name of the metric.
        :param builtins.str compute_expression: (Updatable) Compute Expression to calculate the value of this metric
        :param builtins.str display_name: (Updatable) Display name of the metric.
        :param builtins.bool is_dimension: (Updatable) Current metric need to be included as dimension or not
        :param builtins.bool is_hidden: (Updatable) Flag to marks whether a metric has to be uploaded or not. When isHidden = false > Metric is uploaded, isHidden = true > Metric is NOT uploaded
        :param builtins.str metric_category: (Updatable) Metric category
        :param builtins.str unit: (Updatable) Unit of metric value
        """
    ...
    def compute_expression(self) -> Optional[builtins.str]:
        """
    ...
    def is_dimension(self) -> Optional[builtins.bool]:
        """
    ...
    def metric_category(self) -> Optional[builtins.str]:
        """
...
class MetricExtensionQueryProperties(dict):
    ...
    def __init__(__self__, *,
                 collection_method: builtins.str,
                 arguments: Optional[builtins.str] = None,
                 auto_row_prefix: Optional[builtins.str] = None,
                 command: Optional[builtins.str] = None,
                 delimiter: Optional[builtins.str] = None,
                 identity_metric: Optional[builtins.str] = None,
                 in_param_details: Optional[Sequence['outputs.MetricExtensionQueryPropertiesInParamDetail']] = None,
                 is_metric_service_enabled: Optional[builtins.bool] = None,
                 jmx_attributes: Optional[builtins.str] = None,
                 managed_bean_query: Optional[builtins.str] = None,
                 ...
                 response_content_type: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str collection_method: (Updatable) Type of possible collection methods.
        :param builtins.str arguments: (Updatable) Arguments required by either command or script
        :param builtins.str auto_row_prefix: (Updatable) Prefix for an auto generated metric, in case multiple rows with non unique key values are returned
        :param builtins.str command: (Updatable) OS command to execute without arguments
        :param builtins.str delimiter: (Updatable) Character used to delimit multiple metric values in single line of output
        :param builtins.str identity_metric: (Updatable) Semi-colon separated list of key properties from Managed Bean ObjectName to be used as key metrics
        ...
        :param builtins.bool is_metric_service_enabled: (Updatable) Indicates if Metric Service is enabled on server domain
        :param builtins.str jmx_attributes: (Updatable) List of JMX attributes or Metric Service Table columns separated by semi-colon
        :param builtins.str managed_bean_query: (Updatable) JMX Managed Bean Query or Metric Service Table name
        ...
        :param builtins.str protocol_type: (Updatable) Supported protocol of resources to be associated with this metric extension. This is optional and defaults to HTTPS, which uses secure connection to the URL
        :param builtins.str response_content_type: (Updatable) Type of content response given by the http(s) URL
        ...
        :param builtins.str sql_type: (Updatable) Type of SQL data collection method i.e. either a Statement or SQL Script File
        :param builtins.str starts_with: (Updatable) String prefix used to identify metric output of the OS Command
        :param builtins.str url: (Updatable) Http(s) end point URL
        """
    ...
    def collection_method(self) -> builtins.str:
        """
    ...
    def auto_row_prefix(self) -> Optional[builtins.str]:
        """
    ...
    def identity_metric(self) -> Optional[builtins.str]:
        """
    ...
    def is_metric_service_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def jmx_attributes(self) -> Optional[builtins.str]:
        """
    ...
    def managed_bean_query(self) -> Optional[builtins.str]:
        """
    ...
    def response_content_type(self) -> Optional[builtins.str]:
        """
...
class MetricExtensionQueryPropertiesInParamDetail(dict):
    ...
    def __init__(__self__, *,
                 in_param_position: builtins.int,
                 in_param_value: builtins.str):
        """
        :param builtins.int in_param_position: (Updatable) Position of IN parameter
        :param builtins.str in_param_value: (Updatable) Value of IN parameter
        """
    ...
    def in_param_position(self) -> builtins.int:
        """
    ...
    def in_param_value(self) -> builtins.str:
        """
...
class MetricExtensionQueryPropertiesOutParamDetails(dict):
    ...
    def __init__(__self__, *,
                 out_param_position: builtins.int,
                 out_param_type: builtins.str,
                 out_param_name: Optional[builtins.str] = None):
        """
        :param builtins.int out_param_position: (Updatable) Position of PL/SQL procedure OUT parameter. The value of this property is ignored during update, if "outParamType" is set to NO_OUT_PARAM value.
        :param builtins.str out_param_type: (Updatable) SQL Type of PL/SQL procedure OUT parameter. During the update, to completely remove the out parameter, use the value NO_OUT_PARAM. In that case, the value of "outParamPosition" will be ignored.
        :param builtins.str out_param_name: (Updatable) Name of the Out Parameter
        """
    ...
    def out_param_position(self) -> builtins.int:
        """
    ...
    def out_param_type(self) -> builtins.str:
        """
    ...
    def out_param_name(self) -> Optional[builtins.str]:
        """
...
class MetricExtensionQueryPropertiesScriptDetails(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str content: (Updatable) Content of the script/JavaScript file as base64 encoded string
        :param builtins.str name: (Updatable) Name of the script file
        """
...
class MetricExtensionQueryPropertiesSqlDetails(dict):
    ...
    def __init__(__self__, *,
                 content: builtins.str,
                 script_file_name: Optional[builtins.str] = None):
        """
        :param builtins.str content: (Updatable) Sql statement or script file content as base64 encoded string
        :param builtins.str script_file_name: (Updatable) If a script needs to be executed, then provide file name of the script
        """
        pulumi.set(__self__, "content", content)
    ...
    def script_file_name(self) -> Optional[builtins.str]:
        """
...
class MonitoredResourceAdditionalAlias(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str name: (Updatable) The name of the alias, within the context of the source.
        :param builtins.str source: (Updatable) The source type and source name combination,delimited with (.) separator. Example: {source type}.{source name} and source type max char limit is 63.
        """
...
class MonitoredResourceAdditionalAliasCredential(dict):
    def __init__(__self__, *,
                 ...
                 source: builtins.str):
        """
        :param builtins.str name: (Updatable) The name of the pre-existing source credential which alias cred should point to. This should refer to the pre-existing source attribute which is bound to credential name.
        :param builtins.str service: (Updatable) The name of the service owning the credential.  Example: stack-monitoring or dbmgmt
        :param builtins.str source: (Updatable) The source type and source name combination,delimited with (.) separator. This refers to the pre-existing source which alias cred should point to. Ex. {source type}.{source name} and source type max char limit is 63.
        """
        pulumi.set(__self__, "name", name)
...
class MonitoredResourceAdditionalCredential(dict):
    ...
    def __init__(__self__, *,
                 ...
                 type: Optional[builtins.str] = None):
        """
        :param builtins.str credential_type: (Updatable) Type of credentials specified in the credentials element. Three possible values - EXISTING, PLAINTEXT and ENCRYPTED.
        ...
        :param builtins.str description: (Updatable) The user-specified textual description of the credential.
        :param builtins.str key_id: (Updatable) The master key should be created in Oracle Cloud Infrastructure Vault owned by the client of this API.  The user should have permission to access the vault key.
        :param builtins.str name: (Updatable) The name of the credential, within the context of the source.
        ...
        :param builtins.str source: (Updatable) The source type and source name combination, delimited with (.) separator. {source type}.{source name} and source type max char limit is 63.
        :param builtins.str type: (Updatable) The type of the credential ( ex. JMXCreds,DBCreds).
        """
...
class MonitoredResourceAdditionalCredentialProperty(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: (Updatable) The name of the credential property, should confirm with names of properties of this credential's type.  Example: For JMXCreds type, credential property name for weblogic user is 'Username'.
        :param builtins.str value: (Updatable) The value of the credential property name. Example: For JMXCreds type, credential property value for 'Username' property is 'weblogic'.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class MonitoredResourceDatabaseConnectionDetails(dict):
    ...
    def __init__(__self__, *,
                 ...
                 db_id: Optional[builtins.str] = None,
                 db_unique_name: Optional[builtins.str] = None,
                 ssl_secret_id: Optional[builtins.str] = None):
        """
        :param builtins.int port: (Updatable) Listener Port number used for connection requests.
        :param builtins.str protocol: (Updatable) Protocol used in DB connection string when connecting to external database service.
        :param builtins.str service_name: (Updatable) Service name used for connection requests.
        :param builtins.str connector_id: (Updatable) Database connector Identifier [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param builtins.str db_id: (Updatable) dbId of the database.
        :param builtins.str db_unique_name: (Updatable) UniqueName used for database connection requests.
        :param builtins.str ssl_secret_id: (Updatable) SSL Secret Identifier for TCPS connector in Oracle Cloud Infrastructure Vault[OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        """
    ...
    def db_id(self) -> Optional[builtins.str]:
        """
...
class MonitoredResourceProperty(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str name: (Updatable) Property Name.
        :param builtins.str value: (Updatable) Property Value.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
        if value is not None:
...
class MonitoredResourceTaskTaskDetails(dict):
    ...
    def console_path_prefix(self) -> Optional[builtins.str]:
        """
    ...
    def external_id_mapping(self) -> Optional[builtins.str]:
        """
    ...
    def resource_name_filter(self) -> Optional[builtins.str]:
        """
    ...
    def resource_name_mapping(self) -> Optional[builtins.str]:
        """
    ...
    def resource_type_filter(self) -> Optional[builtins.str]:
        """
    ...
    def resource_type_mapping(self) -> Optional[builtins.str]:
        """
    ...
    def should_use_metrics_flow_for_status(self) -> Optional[builtins.bool]:
        """
...
class MonitoredResourceTypeMetadata(dict):
    ...
    def __init__(__self__, *,
                 format: builtins.str,
                 agent_properties: Optional[Sequence[builtins.str]] = None,
                 ...
                 valid_properties_for_creates: Optional[Sequence[builtins.str]] = None,
                 valid_properties_for_updates: Optional[Sequence[builtins.str]] = None,
                 valid_property_values: Optional[Mapping[str, builtins.str]] = None,
                 valid_sub_resource_types: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str format: (Updatable) ResourceType metadata format to be used. Currently supports only one format. Possible values - SYSTEM_FORMAT.
               * SYSTEM_FORMAT - The resource type metadata is defined in machine friendly format.
        :param Sequence[builtins.str] agent_properties: (Updatable) List of properties needed by the agent for monitoring the resource.  Valid only if resource type is Oracle Cloud Infrastructure management agent based. When specified,  these properties are passed to the management agent during resource create or update.
        :param Sequence[builtins.str] required_properties: (Updatable) List of required properties for resource type.
        ...
        :param Sequence[builtins.str] valid_properties_for_creates: (Updatable) List of valid properties for resource type while creating the monitored resource.  If resources of this type specifies any other properties during create operation,  the operation will fail.
        :param Sequence[builtins.str] valid_properties_for_updates: (Updatable) List of valid properties for resource type while updating the monitored resource.  If resources of this type specifies any other properties during update operation,  the operation will fail.
        :param Mapping[str, builtins.str] valid_property_values: (Updatable) List of valid values for the properties. This is useful when resource type wants to restrict only certain values for some properties. For instance for 'osType' property,  supported values can be restricted to be either Linux or Windows. Example: `{ "osType": "Linux,Windows,Solaris"}`
        :param Sequence[builtins.str] valid_sub_resource_types: (Updatable) List of valid sub-resource types for a composite resource type. The sub-resource types will be obtained from the valid association pairs corresponding to the composite resource types. It will be empty for non composite resource types
        """
    ...
    def agent_properties(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def valid_properties_for_creates(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def valid_properties_for_updates(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def valid_property_values(self) -> Optional[Mapping[str, builtins.str]]:
        """
    ...
    def valid_sub_resource_types(self) -> Optional[Sequence[builtins.str]]:
        """
...
class MonitoredResourceTypeMetadataUniquePropertySet(dict):
    def __init__(__self__, *,
                 properties: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] properties: (Updatable) List of properties.
        """
        pulumi.set(__self__, "properties", properties)
...
class MonitoredResourcesAssociateMonitoredResourceDestinationResourceDetail(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str name: Monitored Resource Name.
        :param builtins.str type: Monitored Resource Type.
        """
...
class MonitoredResourcesListMemberItem(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str host_name: Monitored Resource Host Name.
        :param builtins.str license: License edition of the monitored resource.
        :param builtins.str parent_id: Parent monitored resource identifier [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param builtins.str resource_category: Resource Category to indicate the kind of resource type.
        :param builtins.str resource_display_name: Monitored resource display name.
        :param builtins.str resource_id: Monitored resource identifier [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param builtins.str resource_name: Monitored Resource Name.
        :param builtins.str resource_type: Monitored Resource Type.
...
class MonitoredResourcesSearchAssociationItem(dict):
    ...
    def __init__(__self__, *,
                 ...
                 destination_resource_id: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str association_type: Association type filter to search associated resources.
        ...
        :param builtins.str destination_resource_id: Destination Monitored Resource Identifier [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        ...
        :param builtins.str source_resource_id: Source Monitored Resource Identifier [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param builtins.str time_created: The association creation time. An RFC3339 formatted datetime string.
        """
    ...
    def destination_resource_id(self) -> Optional[builtins.str]:
        """
...
class MonitoredResourcesSearchItem(dict):
    ...
    def __init__(__self__, *,
        ...
        :param builtins.str compartment_id: Compartment Identifier [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str display_name: Monitored resource display name.
        :param builtins.str external_id: External resource is any Oracle Cloud Infrastructure resource identifier [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) which is not a Stack Monitoring service resource. Currently supports only following resource types - Container database, non-container database,  pluggable database and Oracle Cloud Infrastructure compute instance.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str host_name: A filter to return resources with host name match.
        :param builtins.str id: Monitored resource identifier [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param builtins.str license: License edition of the monitored resource.
        :param builtins.str management_agent_id: A filter to return resources with matching management agent id.
        ...
        :param builtins.str resource_category: Resource category filter.
        :param builtins.str source_type: Source type filter.
        :param builtins.str state: A filter to return resources with matching lifecycle state.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: Monitored resource creation time. An RFC3339 formatted datetime string.
        :param builtins.str time_updated: Monitored resource update time. An RFC3339 formatted datetime string.
        :param builtins.str type: A filter to return resources that match resource type. 
...
class MonitoringTemplateAlarmConditionCondition(dict):
    ...
    def __init__(__self__, *,
                 ...
                 should_append_note: Optional[builtins.bool] = None,
                 should_append_url: Optional[builtins.bool] = None,
                 trigger_delay: Optional[builtins.str] = None):
        """
        :param builtins.str query: (Updatable) The Monitoring Query Language (MQL) expression to evaluate for the alarm.
        :param builtins.str severity: (Updatable) Severity - Critical/Warning
        :param builtins.str body: (Updatable) The human-readable content of the delivered alarm notification. Oracle recommends providing guidance to operators for resolving the alarm condition. Consider adding links to standard runbook practices. Avoid entering confidential information.
        :param builtins.bool should_append_note: (Updatable) Whether the note need to add into bottom of the body for mapping the alarms information with template or not.
        :param builtins.bool should_append_url: (Updatable) Whether the URL need to add into bottom of the body for mapping the alarms information with template or not.
        :param builtins.str trigger_delay: (Updatable) The period of time that the condition defined in the alarm must persist before the alarm state changes from "OK" to "FIRING".
        """
    ...
    def should_append_note(self) -> Optional[builtins.bool]:
        """
    ...
    def should_append_url(self) -> Optional[builtins.bool]:
        """
    ...
    def trigger_delay(self) -> Optional[builtins.str]:
        """
...
class MonitoringTemplateMember(dict):
    ...
    def __init__(__self__, *,
                 id: builtins.str,
                 type: builtins.str,
                 composite_type: Optional[builtins.str] = None):
        """
        :param builtins.str id: (Updatable) The OCID of the resourceInstance/resourceType/resourceGroup
        :param builtins.str type: (Updatable) Type of the member reference RESOURCE_INSTANCE, RESOURCE_TYPE, RESOURCE_GROUP
        :param builtins.str composite_type: (Updatable) The OCID of the composite resource type like EBS or Peoplesoft.
        """
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "type", type)
    ...
    def composite_type(self) -> Optional[builtins.str]:
        """
...
class ProcessSetSpecificationItem(dict):
    ...
    def __init__(__self__, *,
                 ...
                 process_command: Optional[builtins.str] = None,
                 process_line_regex_pattern: Optional[builtins.str] = None,
                 process_user: Optional[builtins.str] = None):
        """
        :param builtins.str label: (Updatable) Optional label used to identify a single filter.
        :param builtins.str process_command: (Updatable) String literal used for exact matching on process name.
        :param builtins.str process_line_regex_pattern: (Updatable) Regex pattern matching on process arguments.
        :param builtins.str process_user: (Updatable) String literal used for exact matching on process user.
    ...
    def process_command(self) -> Optional[builtins.str]:
        """
    ...
    def process_line_regex_pattern(self) -> Optional[builtins.str]:
        """
    ...
    def process_user(self) -> Optional[builtins.str]:
        """
...
class GetBaselineableMetricsBaselineableMetricSummaryCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str column: metric column name
        :param builtins.str compartment_id: The ID of the compartment in which data is listed.
        :param builtins.str created_by: Created user id
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: OCID of the metric
        :param builtins.bool is_out_of_box: Is the baseline enabled metric defined out of box by Oracle or by end-user
        :param builtins.str last_updated_by: last Updated user id
        ...
        :param builtins.str resource_type: Resource Type
        :param builtins.str state: The current lifecycle state of the metric extension
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str tenancy_id: OCID of the tenancy
        :param builtins.str time_created: creation date
        :param builtins.str time_last_updated: last updated time
        """
    ...
    def is_out_of_box(self) -> builtins.bool:
        """
...
class GetConfigAdditionalConfigurationResult(dict):
    def __init__(__self__, *,
                 properties_map: Mapping[str, builtins.str]):
        """
        :param Mapping[str, builtins.str] properties_map: Key/Value pair of Property
        """
        pulumi.set(__self__, "properties_map", properties_map)
    ...
    @property
    @pulumi.getter(name="propertiesMap")
    def properties_map(self) -> Mapping[str, builtins.str]:
        """
        Key/Value pair of Property
        """
        return pulumi.get(self, "properties_map")
...
class GetConfigDynamicGroupResult(dict):
    def __init__(__self__, *,
                 domain: builtins.str,
                 name: builtins.str,
                 stack_monitoring_assignment: builtins.str):
        """
        :param builtins.str domain: Identity domain name
        :param builtins.str name: Name of user Group
        :param builtins.str stack_monitoring_assignment: Assignment of dynamic group in context of Stack Monitoring service. It describes the purpose of dynamic groups in Stack Monitoring.
        """
        pulumi.set(__self__, "domain", domain)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "stack_monitoring_assignment", stack_monitoring_assignment)
    ...
    @property
    @pulumi.getter(name="stackMonitoringAssignment")
    def stack_monitoring_assignment(self) -> builtins.str:
        """
...
class GetConfigUserGroupResult(dict):
    def __init__(__self__, *,
                 domain: builtins.str,
                 name: builtins.str,
                 stack_monitoring_role: builtins.str):
        """
        :param builtins.str domain: Identity domain name
        :param builtins.str name: Name of user Group
        :param builtins.str stack_monitoring_role: Role assigned to user group in context of Stack Monitoring service. Access role can be for example: ADMINISTRATOR, OPERATOR, VIEWER, any other access role
        """
        pulumi.set(__self__, "domain", domain)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "stack_monitoring_role", stack_monitoring_role)
    ...
    @property
    @pulumi.getter(name="stackMonitoringRole")
    def stack_monitoring_role(self) -> builtins.str:
        """
...
class GetConfigsConfigCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 is_manually_onboarded: builtins.bool,
                 license: builtins.str,
                 policy_names: Sequence[builtins.str],
                 resource_type: builtins.str,
                 state: builtins.str,
                 system_tags: Mapping[str, builtins.str],
                 time_created: builtins.str,
        ...
        :param builtins.str compartment_id: The ID of the compartment in which data is listed.
        :param builtins.str config_type: The type of configuration.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        ...
        :param builtins.bool is_enabled: True if automatic activation of the Management Agent plugin, automatic promotion or enterprise extensibility is enabled, false if it is not enabled.
        :param builtins.bool is_manually_onboarded: True if customer decides marks configuration as manually configured.
        :param builtins.str license: License edition.
        :param Sequence[builtins.str] policy_names: List of policy names assigned for onboarding
        :param builtins.str resource_type: The type of resource to configure for automatic promotion.
        :param builtins.str state: The current state of the Config.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The time the configuration was created. An RFC3339 formatted datetime string.
        :param builtins.str time_updated: The time the Config was updated.
        ...
        :param builtins.str version: Assigned version to given onboard configuration.
        """
    ...
    def is_manually_onboarded(self) -> builtins.bool:
        """
    ...
    def policy_names(self) -> Sequence[builtins.str]:
        """
...
class GetDefinedMonitoringTemplatesDefinedMonitoringTemplateCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 time_updated: builtins.str):
        """
        :param builtins.str composite_type: Type of composite resource type OCID like EBS/PEOPLE_SOFT.
        ...
        :param builtins.str id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the definedMonitoringTemplate.
        :param builtins.str namespace: The stack monitoring service or application emitting the metric that is evaluated by the alarm.
        :param builtins.str resource_type: The resource types OCID.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The date and time the monitoringTemplate was created. Format defined by RFC3339.
        :param builtins.str time_updated: The date and time the monitoringTemplate was updated. Format defined by RFC3339.
        """
        pulumi.set(__self__, "composite_type", composite_type)
...
class GetDefinedMonitoringTemplatesDefinedMonitoringTemplateCollectionItemDefinedAlarmConditionResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str condition_type: Type of defined monitoring template.
        ...
        :param builtins.str metric_name: The metric name.
        """
...
class GetDefinedMonitoringTemplatesDefinedMonitoringTemplateCollectionItemDefinedAlarmConditionConditionResult(dict):
    def __init__(__self__, *,
                 ...
                 query: builtins.str,
                 severity: builtins.str,
                 should_append_note: builtins.bool,
                 should_append_url: builtins.bool,
                 trigger_delay: builtins.str):
        """
        :param builtins.str body: The human-readable content of the delivered alarm notification. Oracle recommends providing guidance to operators for resolving the alarm condition. Consider adding links to standard runbook practices. Avoid entering confidential information.
        :param builtins.str query: The Monitoring Query Language (MQL) expression to evaluate for the alarm.
        :param builtins.str severity: Severity - Critical/Warning
        :param builtins.bool should_append_note: Whether the note need to add into bottom of the body for mapping the alarms information with template or not.
        :param builtins.bool should_append_url: Whether the URL need to add into bottom of the body for mapping the alarms information with template or not.
        :param builtins.str trigger_delay: The period of time that the condition defined in the alarm must persist before the alarm state changes from "OK" to "FIRING".
        """
        pulumi.set(__self__, "body", body)
        pulumi.set(__self__, "query", query)
        pulumi.set(__self__, "severity", severity)
    ...
    @property
    @pulumi.getter(name="shouldAppendNote")
    def should_append_note(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="shouldAppendUrl")
    def should_append_url(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="triggerDelay")
    def trigger_delay(self) -> builtins.str:
        """
...
class GetDiscoveryJobLogsDiscoveryJobLogCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 time_created: builtins.str):
        """
        :param builtins.str id: The OCID of Discovery job
        :param builtins.str log_message: Log message
        :param builtins.str log_type: The log type like INFO, WARNING, ERROR, SUCCESS
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: Time the Job log was created
        """
        pulumi.set(__self__, "id", id)
    ...
    def log_message(self) -> builtins.str:
        """
        Log message
        """
...
class GetDiscoveryJobsDiscoveryJobCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str compartment_id: The ID of the compartment in which data is listed.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str discovery_type: Add option submits new discovery Job. Add with retry option to re-submit failed discovery job. Refresh option refreshes the existing discovered resources.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: The OCID of Discovery job
        :param builtins.str resource_name: The Name of resource type
        :param builtins.str resource_type: Resource Type.
        :param builtins.str state: The current state of the DiscoveryJob Resource.
        :param builtins.str status: Specifies the status of the discovery job
        :param builtins.str status_message: The short summary of the status of the discovery job
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str tenant_id: The OCID of Tenant
        :param builtins.str time_updated: The time the discovery Job was updated.
        :param builtins.str user_id: The OCID of user in which the job is submitted
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
...
class GetMaintenanceWindowResourceResult(dict):
    def __init__(__self__, *,
                 are_members_included: builtins.bool,
                 resource_id: builtins.str):
        """
        :param builtins.bool are_members_included: Flag to indicate if the members of the resource has to be include in the Maintenance Window.
        :param builtins.str resource_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of monitored resource part of the Maintenance window.
        """
        pulumi.set(__self__, "are_members_included", are_members_included)
        pulumi.set(__self__, "resource_id", resource_id)
    ...
    @property
    @pulumi.getter(name="areMembersIncluded")
    def are_members_included(self) -> builtins.bool:
        """
...
class GetMaintenanceWindowResourcesDetailResult(dict):
    def __init__(__self__, *,
                 name: builtins.str,
                 number_of_members: builtins.int,
                 resource_id: builtins.str,
                 type: builtins.str):
        """
        :param builtins.str name: Name of the monitored resource
        :param builtins.int number_of_members: Number of members of the resource
        :param builtins.str resource_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of monitored resource part of the Maintenance window.
        :param builtins.str type: Type of the monitored resource
        """
    ...
    @property
    @pulumi.getter(name="numberOfMembers")
    def number_of_members(self) -> builtins.int:
        """
        Number of members of the resource
        """
        return pulumi.get(self, "number_of_members")
...
class GetMaintenanceWindowScheduleResult(dict):
    def __init__(__self__, *,
                 maintenance_window_duration: builtins.str,
                 maintenance_window_recurrences: builtins.str,
                 schedule_type: builtins.str,
                 time_maintenance_window_end: builtins.str,
                 time_maintenance_window_start: builtins.str):
        """
        :param builtins.str maintenance_window_duration: Duration time of each recurrence of each Maintenance Window. It must be specified as a string in ISO 8601 extended format.
        :param builtins.str maintenance_window_recurrences: A RFC5545 formatted recurrence string which represents the Maintenance Window Recurrence. Please refer this for details:https://datatracker.ietf.org/doc/html/rfc5545#section-3.3.10 FREQ: Frequency of the Maintenance Window. The supported values are: DAILY and WEEKLY. BYDAY: Comma separated days for Weekly Maintenance Window. BYHOUR: Specifies the start hour of each recurrence after `timeMaintenanceWindowStart` value. BYMINUTE: Specifies the start minute of each reccurrence after `timeMaintenanceWindowStart` value. The default value is 00 BYSECOND: Specifies the start second of each reccurrence after `timeMaintenanceWindowStart` value. The default value is 00 Other Rules are not supported.
        :param builtins.str schedule_type: Property to identify the type of the Maintenance Window.
        :param builtins.str time_maintenance_window_end: Start time of Maintenance window. A RFC3339 formatted datetime string
        :param builtins.str time_maintenance_window_start: Start time of Maintenance window. A RFC3339 formatted datetime string
        """
        pulumi.set(__self__, "maintenance_window_duration", maintenance_window_duration)
        pulumi.set(__self__, "maintenance_window_recurrences", maintenance_window_recurrences)
        pulumi.set(__self__, "schedule_type", schedule_type)
    ...
    @property
    @pulumi.getter(name="maintenanceWindowDuration")
    def maintenance_window_duration(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="maintenanceWindowRecurrences")
    def maintenance_window_recurrences(self) -> builtins.str:
        """
...
class GetMaintenanceWindowsMaintenanceWindowCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str,
                 number_of_resources: builtins.int,
        ...
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of maintenance window.
        ...
        :param builtins.str state: Lifecycle state of the monitored resource.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
    ...
    def number_of_resources(self) -> builtins.int:
...
class GetMetricExtensionMetricListResult(dict):
    def __init__(__self__, *,
                 compute_expression: builtins.str,
                 data_type: builtins.str,
                 display_name: builtins.str,
                 is_dimension: builtins.bool,
                 is_hidden: builtins.bool,
                 metric_category: builtins.str,
                 name: builtins.str,
                 unit: builtins.str):
        """
        :param builtins.str compute_expression: Compute Expression to calculate the value of this metric
        :param builtins.str data_type: Data type of value of this metric
        :param builtins.str display_name: Display name of the metric.
        :param builtins.bool is_dimension: Current metric need to be included as dimension or not
        :param builtins.bool is_hidden: Flag to marks whether a metric has to be uploaded or not. When isHidden = false > Metric is uploaded, isHidden = true > Metric is NOT uploaded
        :param builtins.str metric_category: Metric category
        :param builtins.str name: Name of the script file
        :param builtins.str unit: Unit of metric value
        """
        pulumi.set(__self__, "compute_expression", compute_expression)
        pulumi.set(__self__, "data_type", data_type)
        pulumi.set(__self__, "display_name", display_name)
    ...
    @property
    @pulumi.getter(name="computeExpression")
    def compute_expression(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="isDimension")
    def is_dimension(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="metricCategory")
    def metric_category(self) -> builtins.str:
        """
        Metric category
        """
        return pulumi.get(self, "metric_category")
...
class GetMetricExtensionQueryPropertyResult(dict):
    def __init__(__self__, *,
                 ...
                 starts_with: builtins.str,
                 url: builtins.str):
        """
        :param builtins.str arguments: Arguments required by either command or script
        :param builtins.str auto_row_prefix: Prefix for an auto generated metric, in case multiple rows with non unique key values are returned
        :param builtins.str collection_method: Type of possible collection methods.
        :param builtins.str command: OS command to execute without arguments
        :param builtins.str delimiter: Character used to delimit multiple metric values in single line of output
        :param builtins.str identity_metric: Semi-colon separated list of key properties from Managed Bean ObjectName to be used as key metrics
        ...
        :param builtins.bool is_metric_service_enabled: Indicates if Metric Service is enabled on server domain
        :param builtins.str jmx_attributes: List of JMX attributes or Metric Service Table columns separated by semi-colon
        :param builtins.str managed_bean_query: JMX Managed Bean Query or Metric Service Table name
        ...
        :param builtins.str protocol_type: Supported protocol of resources to be associated with this metric extension. This is optional and defaults to HTTPS, which uses secure connection to the URL
        :param builtins.str response_content_type: Type of content response given by the http(s) URL
        ...
        :param builtins.str sql_type: Type of SQL data collection method i.e. either a Statement or SQL Script File
        :param builtins.str starts_with: String prefix used to identify metric output of the OS Command
        :param builtins.str url: Http(s) end point URL
        """
        pulumi.set(__self__, "arguments", arguments)
        pulumi.set(__self__, "auto_row_prefix", auto_row_prefix)
        pulumi.set(__self__, "collection_method", collection_method)
    ...
    @property
    @pulumi.getter(name="autoRowPrefix")
    def auto_row_prefix(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="identityMetric")
    def identity_metric(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="isMetricServiceEnabled")
    def is_metric_service_enabled(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="jmxAttributes")
    def jmx_attributes(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="managedBeanQuery")
    def managed_bean_query(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="responseContentType")
    def response_content_type(self) -> builtins.str:
        """
...
class GetMetricExtensionQueryPropertyInParamDetailResult(dict):
    def __init__(__self__, *,
                 ...
                 in_param_value: builtins.str):
        """
        :param builtins.int in_param_position: Position of IN parameter
        :param builtins.str in_param_value: Value of IN parameter
        """
        pulumi.set(__self__, "in_param_position", in_param_position)
        pulumi.set(__self__, "in_param_value", in_param_value)
...
class GetMetricExtensionQueryPropertyOutParamDetailResult(dict):
    def __init__(__self__, *,
                 out_param_name: builtins.str,
                 out_param_position: builtins.int,
                 out_param_type: builtins.str):
        """
        :param builtins.str out_param_name: Name of the Out Parameter
        :param builtins.int out_param_position: Position of PL/SQL procedure OUT parameter. The value of this property is ignored during update, if "outParamType" is set to NO_OUT_PARAM value.
        :param builtins.str out_param_type: SQL Type of PL/SQL procedure OUT parameter. During the update, to completely remove the out parameter, use the value NO_OUT_PARAM. In that case, the value of "outParamPosition" will be ignored.
        """
        pulumi.set(__self__, "out_param_name", out_param_name)
        pulumi.set(__self__, "out_param_position", out_param_position)
        pulumi.set(__self__, "out_param_type", out_param_type)
    ...
    @property
    @pulumi.getter(name="outParamName")
    def out_param_name(self) -> builtins.str:
        """
...
class GetMetricExtensionQueryPropertyScriptDetailResult(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param builtins.str content: Sql statement or script file content as base64 encoded string
        :param builtins.str name: Name of the script file
        """
        pulumi.set(__self__, "content", content)
        pulumi.set(__self__, "name", name)
...
class GetMetricExtensionQueryPropertySqlDetailResult(dict):
    def __init__(__self__, *,
                 content: builtins.str,
                 script_file_name: builtins.str):
        """
        :param builtins.str content: Sql statement or script file content as base64 encoded string
        :param builtins.str script_file_name: If a script needs to be executed, then provide file name of the script
        """
        pulumi.set(__self__, "content", content)
        pulumi.set(__self__, "script_file_name", script_file_name)
    ...
    @property
    @pulumi.getter(name="scriptFileName")
    def script_file_name(self) -> builtins.str:
        """
...
class GetMetricExtensionsMetricExtensionCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.int enabled_on_resources_count: Count of resources on which this metric extension is enabled.
        :param builtins.str id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of Metric Extension resource
        :param builtins.str last_updated_by: Last updated by user
        ...
        :param builtins.str resource_uri: The URI path that the user can do a GET on to access the metric extension metadata
        ...
        :param builtins.str tenant_id: Tenant Identifier [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)
        :param builtins.str time_created: Metric Extension creation time. An RFC3339 formatted datetime string.
        :param builtins.str time_updated: Metric Extension update time. An RFC3339 formatted datetime string.
        """
        pulumi.set(__self__, "collection_method", collection_method)
    ...
    def collection_recurrences(self) -> builtins.str:
        """
    ...
    def enabled_on_resources_count(self) -> builtins.int:
        """
    ...
    def publish_trigger(self) -> builtins.bool:
...
class GetMonitoredResourceAdditionalAliasResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str name: Property Name.
        :param builtins.str source: The source type and source name combination, delimited with (.) separator. {source type}.{source name} and source type max char limit is 63.
        """
        pulumi.set(__self__, "credentials", credentials)
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "source", source)
...
class GetMonitoredResourceAdditionalAliasCredentialResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Property Name.
        :param builtins.str service: The name of the service owning the credential.  Example: stack-monitoring or dbmgmt
        :param builtins.str source: The source type and source name combination, delimited with (.) separator. {source type}.{source name} and source type max char limit is 63.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "service", service)
...
class GetMonitoredResourceAdditionalCredentialResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str credential_type: Type of credentials specified in the credentials element. Three possible values - EXISTING, PLAINTEXT and ENCRYPTED.
               * EXISTING  - Credential is already stored in agent and only credential name need to be passed for existing credential.
               * PLAINTEXT - The credential properties will have credentials in plain text format.
               * ENCRYPTED - The credential properties will have credentials stored in vault in encrypted format using KMS client which uses master key for encryption. The same master key will be used to decrypt the credentials before passing on to the management agent.
        :param builtins.str description: The user-specified textual description of the credential.
        :param builtins.str key_id: The master key should be created in Oracle Cloud Infrastructure Vault owned by the client of this API.  The user should have permission to access the vault key.
        :param builtins.str name: Property Name.
...
class GetMonitoredResourceDatabaseConnectionDetailResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str connector_id: Database connector Identifier [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param builtins.str db_id: dbId of the database.
        :param builtins.str db_unique_name: UniqueName used for database connection requests.
        :param builtins.int port: Listener Port number used for connection requests.
        :param builtins.str protocol: Protocol used in DB connection string when connecting to external database service.
        :param builtins.str service_name: Service name used for connection requests.
        :param builtins.str ssl_secret_id: SSL Secret Identifier for TCPS connector in Oracle Cloud Infrastructure Vault[OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        """
        pulumi.set(__self__, "connector_id", connector_id)
        pulumi.set(__self__, "db_id", db_id)
        pulumi.set(__self__, "db_unique_name", db_unique_name)
...
class GetMonitoredResourceTaskTaskDetailResult(dict):
    ...
    @property
    @pulumi.getter(name="availabilityProxyMetricCollectionInterval")
    def availability_proxy_metric_collection_interval(self) -> builtins.int:
        """
        Metrics collection interval in seconds used when calculating the availability of the  resource based on metrics specified using the property 'availabilityProxyMetrics'.
        """
        return pulumi.get(self, "availability_proxy_metric_collection_interval")
    ...
    @property
    @pulumi.getter(name="consolePathPrefix")
    def console_path_prefix(self) -> builtins.str:
        """
        The console path prefix to use for providing service home url page navigation.  For example if the prefix provided is 'security/bastion/bastions', the URL used for navigation will be https://<cloudhostname>/security/bastion/bastions/<resourceOcid>. If not provided, service home page link  will not be shown in the stack monitoring home page.
        """
        return pulumi.get(self, "console_path_prefix")
    ...
    @property
    @pulumi.getter(name="externalIdMapping")
    def external_id_mapping(self) -> builtins.str:
        """
        The external resource identifier property in the metric dimensions.  Resources imported will be using this property value for external id.
        """
        return pulumi.get(self, "external_id_mapping")
    ...
    @property
    @pulumi.getter(name="resourceNameFilter")
    def resource_name_filter(self) -> builtins.str:
        """
        The resource name filter. Resources matching with the resource name filter will be imported. Regular expressions will be accepted.
        """
        return pulumi.get(self, "resource_name_filter")
    ...
    @property
    @pulumi.getter(name="resourceNameMapping")
    def resource_name_mapping(self) -> builtins.str:
        """
        The resource name property in the metric dimensions.  Resources imported will be using this property value for resource name.
        """
        return pulumi.get(self, "resource_name_mapping")
    ...
    @property
    @pulumi.getter(name="resourceTypeFilter")
    def resource_type_filter(self) -> builtins.str:
        """
        The resource type filter. Resources matching with the resource type filter will be imported. Regular expressions will be accepted.
        """
        return pulumi.get(self, "resource_type_filter")
    ...
    @property
    @pulumi.getter(name="resourceTypeMapping")
    def resource_type_mapping(self) -> builtins.str:
        """
        The resource type property in the metric dimensions.  Resources imported will be using this property value for resource type. If not specified, namespace will be used for resource type.
        """
        return pulumi.get(self, "resource_type_mapping")
    ...
    @property
    @pulumi.getter(name="shouldUseMetricsFlowForStatus")
    def should_use_metrics_flow_for_status(self) -> builtins.bool:
        """
        Flag to indicate whether status is calculated using metrics or  LifeCycleState attribute of the resource in Oracle Cloud Infrastructure service.
        """
        return pulumi.get(self, "should_use_metrics_flow_for_status")
...
class GetMonitoredResourceTypeMetadataResult(dict):
    def __init__(__self__, *,
                 agent_properties: Sequence[builtins.str],
                 format: builtins.str,
                 required_properties: Sequence[builtins.str],
                 unique_property_sets: Sequence['outputs.GetMonitoredResourceTypeMetadataUniquePropertySetResult'],
                 valid_properties_for_creates: Sequence[builtins.str],
                 valid_properties_for_updates: Sequence[builtins.str],
                 valid_property_values: Mapping[str, builtins.str],
                 valid_sub_resource_types: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] agent_properties: List of properties needed by the agent for monitoring the resource.  Valid only if resource type is Oracle Cloud Infrastructure management agent based. When specified,  these properties are passed to the management agent during resource create or update.
        :param builtins.str format: ResourceType metadata format to be used. Currently supports only one format. Possible values - SYSTEM_FORMAT.
               * SYSTEM_FORMAT - The resource type metadata is defined in machine friendly format.
        :param Sequence[builtins.str] required_properties: List of required properties for resource type.
        ...
        :param Sequence[builtins.str] valid_properties_for_creates: List of valid properties for resource type while creating the monitored resource.  If resources of this type specifies any other properties during create operation,  the operation will fail.
        :param Sequence[builtins.str] valid_properties_for_updates: List of valid properties for resource type while updating the monitored resource.  If resources of this type specifies any other properties during update operation,  the operation will fail.
        :param Mapping[str, builtins.str] valid_property_values: List of valid values for the properties. This is useful when resource type wants to restrict only certain values for some properties. For instance for 'osType' property,  supported values can be restricted to be either Linux or Windows. Example: `{"osType": "Linux,Windows,Solaris", "osVersion": "v6.0,v7.0"}`
        :param Sequence[builtins.str] valid_sub_resource_types: List of valid sub-resource types for a composite resource type. The sub-resource types will be obtained from the valid association pairs corresponding to the composite resource types. It will be empty for non composite resource types
        """
        pulumi.set(__self__, "agent_properties", agent_properties)
        pulumi.set(__self__, "format", format)
        pulumi.set(__self__, "required_properties", required_properties)
    ...
    @property
    @pulumi.getter(name="agentProperties")
    def agent_properties(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="requiredProperties")
    def required_properties(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="validPropertiesForCreates")
    def valid_properties_for_creates(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="validPropertiesForUpdates")
    def valid_properties_for_updates(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="validPropertyValues")
    def valid_property_values(self) -> Mapping[str, builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="validSubResourceTypes")
    def valid_sub_resource_types(self) -> Sequence[builtins.str]:
        """
...
class GetMonitoredResourceTypeMetadataUniquePropertySetResult(dict):
    def __init__(__self__, *,
                 properties: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] properties: List of properties.
        """
        pulumi.set(__self__, "properties", properties)
...
class GetMonitoredResourceTypesMonitoredResourceTypesCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str,
                 resource_category: builtins.str,
...
class GetMonitoredResourcesMonitoredResourceCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 external_resource_id: builtins.str,
                 freeform_tags: Mapping[str, builtins.str],
                 ...
                 resource_category: builtins.str,
                 resource_time_zone: builtins.str,
                 source_type: builtins.str,
                 state: builtins.str,
                 system_tags: Mapping[str, builtins.str],
                 tenant_id: builtins.str,
        ...
        :param builtins.str host_name: Monitored resource host name.
        :param builtins.str id: Monitored resource identifier [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param builtins.str management_agent_id: Management Agent Identifier [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param builtins.str name: A filter to return resources that match exact resource name.
        ...
        :param builtins.str resource_category: Resource Category to indicate the kind of resource type.
        :param builtins.str resource_time_zone: Time zone in the form of tz database canonical zone ID.
        :param builtins.str source_type: Source type to indicate if the resource is stack monitoring discovered, Oracle Cloud Infrastructure native resource, etc.
        :param builtins.str state: Lifecycle state of the monitored resource.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str tenant_id: Tenancy Identifier [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param builtins.str time_created: The date and time when the monitored resource was created, expressed in  [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.
        :param builtins.str time_updated: The date and time when the monitored resource was last updated, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format.
        :param builtins.str type: Monitored Resource Type.
        """
...
class GetMonitoringTemplateAlarmConditionsAlarmConditionCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 metric_name: builtins.str,
                 monitoring_template_id: builtins.str,
                 namespace: builtins.str,
                 resource_type: builtins.str,
                 state: builtins.str,
                 status: builtins.str,
                 ...
                 time_updated: builtins.str):
        """
        :param builtins.str composite_type: The OCID of the composite resource type like EBS/PEOPLE_SOFT.
        :param builtins.str condition_type: Type of defined monitoring template.
        ...
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Alarm Condition.
        :param builtins.str metric_name: metricName filter.
        ...
        :param builtins.str namespace: The stack monitoring service or application emitting the metric that is evaluated by the alarm.
        :param builtins.str resource_type: The resource type OCID.
        ...
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The date and time the alarm condition was created. Format defined by RFC3339.
        :param builtins.str time_updated: The date and time the alarm condition was updated. Format defined by RFC3339.
        """
        pulumi.set(__self__, "composite_type", composite_type)
        pulumi.set(__self__, "condition_type", condition_type)
        pulumi.set(__self__, "conditions", conditions)
...
class GetMonitoringTemplateMemberResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str composite_type: The OCID of the composite resource type like EBS or Peoplesoft.
        :param builtins.str id: The OCID of the resourceInstance/resourceType/resourceGroup
        :param builtins.str type: Type of the member reference RESOURCE_INSTANCE, RESOURCE_TYPE, RESOURCE_GROUP
        """
        pulumi.set(__self__, "composite_type", composite_type)
        pulumi.set(__self__, "id", id)
        pulumi.set(__self__, "type", type)
...
class GetMonitoringTemplatesMonitoringTemplateCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 freeform_tags: Mapping[str, builtins.str],
                 id: builtins.str,
                 is_alarms_enabled: builtins.bool,
                 is_split_notification_enabled: builtins.bool,
                 ...
                 time_created: builtins.str,
                 time_updated: builtins.str,
                 total_alarm_conditions: builtins.float,
                 total_applied_alarm_conditions: builtins.float):
        """
        :param builtins.str compartment_id: The ID of the compartment in which data is listed.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str description: A user-friendly description for the monitoring template. It does not have to be unique, and it's changeable. Avoid entering confidential information.
        :param Sequence[builtins.str] destinations: A list of destinations for alarm notifications. Each destination is represented by the OCID of a related resource.
        :param builtins.str display_name: A filter to return monitoring template based on name.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: The OCID of the resourceInstance/resourceType/resourceGroup
        :param builtins.bool is_alarms_enabled: Whether the alarm is enabled or disabled. Default value is enabled.
        :param builtins.bool is_split_notification_enabled: Whether the alarm notification is enabled or disabled, it will be Enabled by default.
        ...
        :param builtins.str message_format: The format to use for alarm notifications.
        ...
        :param builtins.str tenant_id: Tenant Identifier [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm)
        :param builtins.str time_created: The date and time the monitoringTemplate was created. Format defined by RFC3339.
        :param builtins.str time_updated: The date and time the monitoringTemplate was last updated. Format defined by RFC3339.
        :param builtins.float total_alarm_conditions: Total Alarm Conditions
        :param builtins.float total_applied_alarm_conditions: Total Applied Alarm Conditions
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
        pulumi.set(__self__, "description", description)
...
class GetProcessSetSpecificationItemResult(dict):
    def __init__(__self__, *,
                 label: builtins.str,
                 process_command: builtins.str,
                 process_line_regex_pattern: builtins.str,
                 process_user: builtins.str):
        """
        :param builtins.str label: Optional label used to identify a single filter.
        :param builtins.str process_command: String literal used for exact matching on process name.
        :param builtins.str process_line_regex_pattern: Regex pattern matching on process arguments.
        :param builtins.str process_user: String literal used for exact matching on process user.
        """
        pulumi.set(__self__, "label", label)
        pulumi.set(__self__, "process_command", process_command)
        pulumi.set(__self__, "process_line_regex_pattern", process_line_regex_pattern)
    ...
    @property
    @pulumi.getter(name="processCommand")
    def process_command(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="processLineRegexPattern")
    def process_line_regex_pattern(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="processUser")
    def process_user(self) -> builtins.str:
        """
...
class GetProcessSetsProcessSetCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the Process Set.
        :param builtins.str revision: The current revision of the Process Set.
        ...
        :param builtins.str state: The current state of the Resource.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The time the process set was created. An RFC3339 formatted datetime string.
        :param builtins.str time_updated: The time the process set was last updated. An RFC3339 formatted datetime string.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
        pulumi.set(__self__, "display_name", display_name)
