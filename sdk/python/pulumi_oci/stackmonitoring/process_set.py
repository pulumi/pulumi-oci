...
class ProcessSetArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) Name of the Process Set.
...
class _ProcessSetState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) Name of the Process Set.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[builtins.str] revision: The current revision of the Process Set.
        :param pulumi.Input['ProcessSetSpecificationArgs'] specification: (Updatable) Collection of regular expression specifications used to identify the processes to be monitored.
        ...
        :param pulumi.Input[builtins.str] time_created: The time the process set was created. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The time the process set was last updated. An RFC3339 formatted datetime string.
        """
...
class ProcessSet(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'ProcessSet':
        """
