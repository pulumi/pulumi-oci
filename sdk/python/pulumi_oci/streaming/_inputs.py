...
if not MYPY:
    class StreamPoolCustomEncryptionKeyArgsDict(TypedDict):
        ...
        """
        key_state: NotRequired[pulumi.Input[builtins.str]]
        """
...
class StreamPoolCustomEncryptionKeyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] kms_key_id: (Updatable) Custom Encryption Key (Master Key) ocid.
        :param pulumi.Input[builtins.str] key_state: Life cycle State of the custom key
        """
...
if not MYPY:
    class StreamPoolKafkaSettingsArgsDict(TypedDict):
        auto_create_topics_enable: NotRequired[pulumi.Input[builtins.bool]]
        """
        (Updatable) Enable auto creation of topic on the server.
        """
        bootstrap_servers: NotRequired[pulumi.Input[builtins.str]]
        """
        (Updatable) Bootstrap servers.
        """
        log_retention_hours: NotRequired[pulumi.Input[builtins.int]]
        """
        (Updatable) The number of hours to keep a log file before deleting it (in hours).
        """
        num_partitions: NotRequired[pulumi.Input[builtins.int]]
        """
...
class StreamPoolKafkaSettingsArgs:
    def __init__(__self__, *,
                 ...
                 num_partitions: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.bool] auto_create_topics_enable: (Updatable) Enable auto creation of topic on the server.
        :param pulumi.Input[builtins.str] bootstrap_servers: (Updatable) Bootstrap servers.
        :param pulumi.Input[builtins.int] log_retention_hours: (Updatable) The number of hours to keep a log file before deleting it (in hours).
        :param pulumi.Input[builtins.int] num_partitions: (Updatable) The default number of log partitions per topic.
        """
    ...
    def num_partitions(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The default number of log partitions per topic.
        """
    ...
    def num_partitions(self, value: Optional[pulumi.Input[builtins.int]]):
...
class StreamPoolPrivateEndpointSettingsArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] nsg_ids: The optional list of network security groups to be used with the private endpoint of the stream pool. That value cannot be changed.
        :param pulumi.Input[builtins.str] private_endpoint_ip: The optional private IP you want to be associated with your private stream pool. That parameter can only be specified when the subnetId parameter is set. It cannot be changed. The private IP needs to be part of the CIDR range of the specified subnetId or the creation will fail. If not specified a random IP inside the subnet will be chosen. After the stream pool is created, a custom FQDN, pointing to this private IP, is created. The FQDN is then used to access the service instead of the private IP.
        :param pulumi.Input[builtins.str] subnet_id: If specified, the stream pool will be private and only accessible from inside that subnet. Producing-to and consuming-from a stream inside a private stream pool can also only be done from inside the subnet. That value cannot be changed. 
