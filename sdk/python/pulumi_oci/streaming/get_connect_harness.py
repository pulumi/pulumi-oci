...
class GetConnectHarnessResult:
    ...
    def connect_harness_id(self) -> builtins.str:
...
def get_connect_harness(connect_harness_id: Optional[builtins.str] = None,
    ...
    :param builtins.str connect_harness_id: The OCID of the connect harness.
    """
    __args__ = dict()
...
def get_connect_harness_output(connect_harness_id: Optional[pulumi.Input[builtins.str]] = None,
