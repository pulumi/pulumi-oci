...
def get_connect_harnesses(compartment_id: Optional[builtins.str] = None,
...
def get_connect_harnesses_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
