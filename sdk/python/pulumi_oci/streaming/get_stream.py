...
def get_stream(stream_id: Optional[builtins.str] = None,
    ...
    :param builtins.str stream_id: The OCID of the stream.
    """
    __args__ = dict()
...
def get_stream_output(stream_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetStreamResult(
        ...
        retention_in_hours=pulumi.get(__response__, 'retention_in_hours'),
