...
def get_stream_pool(stream_pool_id: Optional[builtins.str] = None,
    ...
    :param builtins.str stream_pool_id: The OCID of the stream pool.
    """
    __args__ = dict()
...
def get_stream_pool_output(stream_pool_id: Optional[pulumi.Input[builtins.str]] = None,
