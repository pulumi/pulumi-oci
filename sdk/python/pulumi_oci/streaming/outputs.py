...
class StreamPoolCustomEncryptionKey(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str kms_key_id: (Updatable) Custom Encryption Key (Master Key) ocid.
        :param builtins.str key_state: Life cycle State of the custom key
        """
    ...
    def key_state(self) -> Optional[builtins.str]:
        """
...
class StreamPoolKafkaSettings(dict):
    ...
    def __init__(__self__, *,
                 auto_create_topics_enable: Optional[builtins.bool] = None,
                 bootstrap_servers: Optional[builtins.str] = None,
                 log_retention_hours: Optional[builtins.int] = None,
                 num_partitions: Optional[builtins.int] = None):
        """
        :param builtins.bool auto_create_topics_enable: (Updatable) Enable auto creation of topic on the server.
        :param builtins.str bootstrap_servers: (Updatable) Bootstrap servers.
        :param builtins.int log_retention_hours: (Updatable) The number of hours to keep a log file before deleting it (in hours).
        :param builtins.int num_partitions: (Updatable) The default number of log partitions per topic.
        """
    ...
    def auto_create_topics_enable(self) -> Optional[builtins.bool]:
        """
    ...
    def bootstrap_servers(self) -> Optional[builtins.str]:
        """
    ...
    def log_retention_hours(self) -> Optional[builtins.int]:
        """
    ...
    def num_partitions(self) -> Optional[builtins.int]:
        """
...
class StreamPoolPrivateEndpointSettings(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] nsg_ids: The optional list of network security groups to be used with the private endpoint of the stream pool. That value cannot be changed.
        :param builtins.str private_endpoint_ip: The optional private IP you want to be associated with your private stream pool. That parameter can only be specified when the subnetId parameter is set. It cannot be changed. The private IP needs to be part of the CIDR range of the specified subnetId or the creation will fail. If not specified a random IP inside the subnet will be chosen. After the stream pool is created, a custom FQDN, pointing to this private IP, is created. The FQDN is then used to access the service instead of the private IP.
        :param builtins.str subnet_id: If specified, the stream pool will be private and only accessible from inside that subnet. Producing-to and consuming-from a stream inside a private stream pool can also only be done from inside the subnet. That value cannot be changed. 
...
class GetConnectHarnessesConnectHarnessResult(dict):
    def __init__(__self__, *,
        ...
        :param Mapping[str, builtins.str] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair that is applied with no predefined name, type, or namespace. Exists for cross-compatibility only. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param builtins.str id: A filter to return only resources that match the given ID exactly.
        :param builtins.str lifecycle_state_details: Any additional details about the current state of the connect harness.
        ...
        :param builtins.str time_created: The date and time the connect harness was created, expressed in in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2018-04-20T00:00:07.405Z`
        """
...
class GetStreamPoolCustomEncryptionKeyResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key_state: Life cycle State of the custom key
        :param builtins.str kms_key_id: Custom Encryption Key (Master Key) ocid.
        """
        pulumi.set(__self__, "key_state", key_state)
        pulumi.set(__self__, "kms_key_id", kms_key_id)
...
class GetStreamPoolKafkaSettingResult(dict):
    def __init__(__self__, *,
                 auto_create_topics_enable: builtins.bool,
                 bootstrap_servers: builtins.str,
                 log_retention_hours: builtins.int,
                 num_partitions: builtins.int):
        """
        :param builtins.bool auto_create_topics_enable: Enable auto creation of topic on the server.
        :param builtins.str bootstrap_servers: Bootstrap servers.
        :param builtins.int log_retention_hours: The number of hours to keep a log file before deleting it (in hours).
        :param builtins.int num_partitions: The default number of log partitions per topic.
        """
        pulumi.set(__self__, "auto_create_topics_enable", auto_create_topics_enable)
        pulumi.set(__self__, "bootstrap_servers", bootstrap_servers)
        pulumi.set(__self__, "log_retention_hours", log_retention_hours)
    ...
    @property
    @pulumi.getter(name="autoCreateTopicsEnable")
    def auto_create_topics_enable(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="numPartitions")
    def num_partitions(self) -> builtins.int:
        """
...
class GetStreamPoolPrivateEndpointSettingResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] nsg_ids: The optional list of network security groups that are associated with the private endpoint of the stream pool.
        :param builtins.str private_endpoint_ip: The private IP associated with the stream pool in the associated subnetId. The stream pool's FQDN resolves to that IP and should be used - instead of the private IP - in order to not trigger any TLS issues.
        :param builtins.str subnet_id: The subnet id from which the private stream pool can be accessed. Trying to access the streams from another network location will result in an error.
        """
        pulumi.set(__self__, "nsg_ids", nsg_ids)
        pulumi.set(__self__, "private_endpoint_ip", private_endpoint_ip)
        pulumi.set(__self__, "subnet_id", subnet_id)
...
class GetStreamPoolsStreamPoolResult(dict):
    def __init__(__self__, *,
        ...
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations": {"CostCenter": "42"}}'
        :param builtins.str endpoint_fqdn: The FQDN used to access the streams inside the stream pool (same FQDN as the messagesEndpoint attribute of a [Stream](https://docs.cloud.oracle.com/iaas/api/#/en/streaming/20180418/Stream) object). If the stream pool is private, the FQDN is customized and can only be accessed from inside the associated subnetId, otherwise the FQDN is publicly resolvable. Depending on which protocol you attempt to use, you need to either prepend https or append the Kafka port.
        :param Mapping[str, builtins.str] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair that is applied with no predefined name, type, or namespace. Exists for cross-compatibility only. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param builtins.str id: A filter to return only resources that match the given ID exactly.
        :param builtins.bool is_private: True if the stream pool is private, false otherwise. The associated endpoint and subnetId of a private stream pool can be retrieved through the [GetStreamPool](https://docs.cloud.oracle.com/iaas/api/#/en/streaming/20180418/StreamPool/GetStreamPool) API.
        :param Sequence['GetStreamPoolsStreamPoolKafkaSettingArgs'] kafka_settings: Settings for the Kafka compatibility layer.
        :param builtins.str lifecycle_state_details: Any additional details about the current state of the stream.
        :param builtins.str name: A filter to return only resources that match the given name exactly.
        ...
        :param builtins.str state: A filter to only return resources that match the given lifecycle state. The state value is case-insensitive.
        :param builtins.str time_created: The date and time the stream pool was created, expressed in in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2018-04-20T00:00:07.405Z`
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
    ...
    def endpoint_fqdn(self) -> builtins.str:
        """
    ...
    def is_private(self) -> builtins.bool:
        """
...
class GetStreamsStreamResult(dict):
    def __init__(__self__, *,
                 ...
                 id: builtins.str,
                 lifecycle_state_details: builtins.str,
                 messages_endpoint: builtins.str,
                 name: builtins.str,
                 partitions: builtins.int,
                 retention_in_hours: builtins.int,
                 state: builtins.str,
        ...
        :param builtins.str id: A filter to return only resources that match the given ID exactly.
        :param builtins.str lifecycle_state_details: Any additional details about the current state of the stream.
        :param builtins.str messages_endpoint: The endpoint to use when creating the StreamClient to consume or publish messages in the stream. If the associated stream pool is private, the endpoint is also private and can only be accessed from inside the stream pool's associated subnet.
        :param builtins.str name: A filter to return only resources that match the given name exactly.
        :param builtins.int partitions: The number of partitions in the stream.
        :param builtins.int retention_in_hours: The retention period of the stream, in hours. This property is read-only.
        :param builtins.str state: A filter to only return resources that match the given lifecycle state. The state value is case-insensitive.
        ...
        :param builtins.str time_created: The date and time the stream was created, expressed in in [RFC 3339](https://tools.ietf.org/rfc/rfc3339) timestamp format.  Example: `2018-04-20T00:00:07.405Z`
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
        pulumi.set(__self__, "freeform_tags", freeform_tags)
    ...
    def messages_endpoint(self) -> builtins.str:
        """
    ...
    def retention_in_hours(self) -> builtins.int:
        """
