...
def get_assigned_subscription(assigned_subscription_id: Optional[_builtins.str] = None,
...
def get_assigned_subscription_output(assigned_subscription_id: Optional[pulumi.Input[_builtins.str]] = None,
