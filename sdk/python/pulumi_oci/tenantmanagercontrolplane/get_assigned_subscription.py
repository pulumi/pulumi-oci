...
def get_assigned_subscription(assigned_subscription_id: Optional[builtins.str] = None,
...
def get_assigned_subscription_output(assigned_subscription_id: Optional[pulumi.Input[builtins.str]] = None,
