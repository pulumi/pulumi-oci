...
class GetAssignedSubscriptionLineItemsResult:
    ...
    def assigned_subscription_id(self) -> builtins.str:
...
def get_assigned_subscription_line_items(assigned_subscription_id: Optional[builtins.str] = None,
    ...
    :param builtins.str assigned_subscription_id: OCID of the assigned Oracle Cloud Subscription.
    """
    __args__ = dict()
...
def get_assigned_subscription_line_items_output(assigned_subscription_id: Optional[pulumi.Input[builtins.str]] = None,
