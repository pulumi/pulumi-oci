...
def get_assigned_subscriptions(compartment_id: Optional[_builtins.str] = None,
                               entity_version: Optional[_builtins.str] = None,
                               filters: Optional[Sequence[Union['GetAssignedSubscriptionsFilterArgs', 'GetAssignedSubscriptionsFilterArgsDict', 'outputs.GetAssignedSubscriptionsFilterResult']]] = None,
...
def get_assigned_subscriptions_output(compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                                      entity_version: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                      filters: pulumi.Input[Optional[Optional[Sequence[Union['GetAssignedSubscriptionsFilterArgs', 'GetAssignedSubscriptionsFilterArgsDict', 'outputs.GetAssignedSubscriptionsFilterResult']]]]] = None,
