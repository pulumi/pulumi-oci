...
class GetDomainGovernanceResult:
    ...
    def domain_governance_id(self) -> builtins.str:
...
def get_domain_governance(domain_governance_id: Optional[builtins.str] = None,
    ...
    :param builtins.str domain_governance_id: The domain governance OCID.
    """
    __args__ = dict()
...
def get_domain_governance_output(domain_governance_id: Optional[pulumi.Input[builtins.str]] = None,
