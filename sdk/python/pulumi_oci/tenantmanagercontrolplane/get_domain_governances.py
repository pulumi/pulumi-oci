...
class GetDomainGovernancesResult:
    ...
    def domain_governance_id(self) -> Optional[builtins.str]:
...
def get_domain_governances(compartment_id: Optional[builtins.str] = None,
                           domain_governance_id: Optional[builtins.str] = None,
...
def get_domain_governances_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                  domain_governance_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
