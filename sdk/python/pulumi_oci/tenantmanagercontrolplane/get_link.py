...
def get_link(link_id: Optional[builtins.str] = None,
    ...
    :param builtins.str link_id: OCID of the link to retrieve.
    """
    __args__ = dict()
...
def get_link_output(link_id: Optional[pulumi.Input[builtins.str]] = None,
