...
def get_recipient_invitation(recipient_invitation_id: Optional[builtins.str] = None,
    ...
    :param builtins.str recipient_invitation_id: OCID of the recipient invitation to retrieve.
    """
    __args__ = dict()
...
def get_recipient_invitation_output(recipient_invitation_id: Optional[pulumi.Input[builtins.str]] = None,
