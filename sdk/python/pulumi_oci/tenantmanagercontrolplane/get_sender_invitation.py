...
def get_sender_invitation(sender_invitation_id: Optional[builtins.str] = None,
    ...
    :param builtins.str sender_invitation_id: OCID of the sender invitation to retrieve.
    """
    __args__ = dict()
...
def get_sender_invitation_output(sender_invitation_id: Optional[pulumi.Input[builtins.str]] = None,
