...
class GetSubscriptionMappingResult:
    ...
    def subscription_mapping_id(self) -> builtins.str:
...
def get_subscription_mapping(subscription_mapping_id: Optional[builtins.str] = None,
    ...
    :param builtins.str subscription_mapping_id: OCID of the subscriptionMappingId.
    """
    __args__ = dict()
...
def get_subscription_mapping_output(subscription_mapping_id: Optional[pulumi.Input[builtins.str]] = None,
