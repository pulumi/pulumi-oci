...
def get_subscriptions(compartment_id: Optional[builtins.str] = None,
...
def get_subscriptions_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
