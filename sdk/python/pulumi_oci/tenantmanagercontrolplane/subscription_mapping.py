...
class SubscriptionMappingArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] compartment_id: OCID of the compartment. Always a tenancy OCID.
        :param pulumi.Input[builtins.str] subscription_id: OCID of Subscription.
...
class _SubscriptionMappingState:
    def __init__(__self__, *,
                 ...
                 is_explicitly_assigned: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: OCID of the compartment. Always a tenancy OCID.
        :param pulumi.Input[builtins.bool] is_explicitly_assigned: Denotes if the subscription is explicity assigned to the root compartment or tenancy.
        :param pulumi.Input[builtins.str] state: Lifecycle state of the subscriptionMapping.
        :param pulumi.Input[builtins.str] subscription_id: OCID of Subscription.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] time_created: Date-time when subscription mapping was created.
        :param pulumi.Input[builtins.str] time_terminated: Date-time when subscription mapping was terminated.
        :param pulumi.Input[builtins.str] time_updated: Date-time when subscription mapping was updated.
        """
    ...
    def is_explicitly_assigned(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_explicitly_assigned(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class SubscriptionMapping(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_terminated: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'SubscriptionMapping':
        """
    ...
    @property
    @pulumi.getter(name="isExplicitlyAssigned")
    def is_explicitly_assigned(self) -> pulumi.Output[builtins.bool]:
        """
        Denotes if the subscription is explicity assigned to the root compartment or tenancy.
        """
        return pulumi.get(self, "is_explicitly_assigned")
    ...
    @property
    @pulumi.getter(name="timeTerminated")
    def time_terminated(self) -> pulumi.Output[builtins.str]:
        """
        Date-time when subscription mapping was terminated.
        """
        return pulumi.get(self, "time_terminated")
