...
class SubscriptionRedeemableUserItemArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] email_id: The email ID for a user that can redeem rewards.
        :param pulumi.Input[builtins.str] first_name: The first name of the user that can redeem rewards.
        :param pulumi.Input[builtins.str] last_name: The last name of the user that can redeem rewards.
        """
