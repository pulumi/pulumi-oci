...
class GetSubscriptionProductResult:
    ...
    @property
    @pulumi.getter
    def producttype(self) -> Optional[builtins.str]:
...
def get_subscription_product(producttype: Optional[builtins.str] = None,
                             subscription_id: Optional[builtins.str] = None,
                             tenancy_id: Optional[builtins.str] = None,
                             usage_period_key: Optional[builtins.str] = None,
    ...
    :param builtins.str producttype: The field to specify the type of product.
    ...
    :param builtins.str usage_period_key: The SPM Identifier for the usage period.
    """
    __args__ = dict()
...
def get_subscription_product_output(producttype: Optional[pulumi.Input[Optional[builtins.str]]] = None,
                                    subscription_id: Optional[pulumi.Input[builtins.str]] = None,
                                    tenancy_id: Optional[pulumi.Input[builtins.str]] = None,
                                    usage_period_key: Optional[pulumi.Input[builtins.str]] = None,
