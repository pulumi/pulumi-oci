...
def get_subscription_redeemable_user(subscription_id: Optional[builtins.str] = None,
...
def get_subscription_redeemable_user_output(subscription_id: Optional[pulumi.Input[builtins.str]] = None,
