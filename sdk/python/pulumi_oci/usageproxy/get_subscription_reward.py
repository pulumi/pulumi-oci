...
def get_subscription_reward(subscription_id: Optional[builtins.str] = None,
...
def get_subscription_reward_output(subscription_id: Optional[pulumi.Input[builtins.str]] = None,
