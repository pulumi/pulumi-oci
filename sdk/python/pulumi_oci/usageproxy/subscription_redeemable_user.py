...
class SubscriptionRedeemableUserArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] subscription_id: The subscription ID for which rewards information is requested for.
        :param pulumi.Input[builtins.str] tenancy_id: The OCID of the tenancy.
        :param pulumi.Input[builtins.str] user_id: The user ID of the person to send a copy of an email.
...
class SubscriptionRedeemableUser(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            subscription_id: Optional[pulumi.Input[builtins.str]] = None,
            tenancy_id: Optional[pulumi.Input[builtins.str]] = None,
            user_id: Optional[pulumi.Input[builtins.str]] = None) -> 'SubscriptionRedeemableUser':
        """
