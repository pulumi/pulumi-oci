...
if not MYPY:
    class SecretRotationConfigArgsDict(TypedDict):
        ...
        """
        is_scheduled_rotation_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class SecretRotationConfigArgs:
    def __init__(__self__, *,
                 ...
                 is_scheduled_rotation_enabled: Optional[pulumi.Input[builtins.bool]] = None,
    ...
    def is_scheduled_rotation_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) Enables auto rotation, when set to true rotationInterval must be set.
        """
    ...
    def is_scheduled_rotation_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class SecretRotationConfigTargetSystemDetailsArgsDict(TypedDict):
        target_system_type: pulumi.Input[builtins.str]
        """
        (Updatable) Unique identifier of the target system that Vault Secret connects to.
        """
        adb_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class SecretRotationConfigTargetSystemDetailsArgs:
    def __init__(__self__, *,
                 target_system_type: pulumi.Input[builtins.str],
                 adb_id: Optional[pulumi.Input[builtins.str]] = None,
                 function_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] target_system_type: (Updatable) Unique identifier of the target system that Vault Secret connects to.
        :param pulumi.Input[builtins.str] adb_id: (Updatable) The unique identifier (OCID) for the autonomous database that Vault Secret connects to.
        :param pulumi.Input[builtins.str] function_id: (Updatable) The unique identifier (OCID) of the Oracle Cloud Infrastructure Functions that vault secret connects to.
        """
    ...
    def target_system_type(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) Unique identifier of the target system that Vault Secret connects to.
        """
    ...
    def target_system_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "target_system_type", value)

    @property
    @pulumi.getter(name="adbId")
    def adb_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The unique identifier (OCID) for the autonomous database that Vault Secret connects to.
        """
    ...
    @adb_id.setter
    def adb_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class SecretSecretContentArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] content_type: (Updatable) The base64-encoded content of the secret.
        :param pulumi.Input[builtins.str] content: (Updatable) The base64-encoded content of the secret.
        :param pulumi.Input[builtins.str] name: (Updatable) Names should be unique within a secret. Valid characters are uppercase or lowercase letters, numbers, hyphens, underscores, and periods.
        :param pulumi.Input[builtins.str] stage: (Updatable) The rotation state of the secret content. The default is `CURRENT`, meaning that the secret is currently in use. A secret version that you mark as `PENDING` is staged and available for use, but you don't yet want to rotate it into current, active use. For example, you might create or update a secret and mark its rotation state as `PENDING` if you haven't yet updated the secret on the target system. When creating a secret, only the value `CURRENT` is applicable, although the value `LATEST` is also automatically applied. When updating a secret, you can specify a version's rotation state as either `CURRENT` or `PENDING`.
        """
...
if not MYPY:
    class SecretSecretGenerationContextArgsDict(TypedDict):
        generation_template: pulumi.Input[builtins.str]
        """
        (Updatable) Name of random bytes generation template for generating random byte type secret.
        """
        generation_type: pulumi.Input[builtins.str]
        """
        (Updatable) Name of the predefined secret generation type.
        """
        passphrase_length: NotRequired[pulumi.Input[builtins.int]]
        """
        (Updatable) Length of the passphrase to be generated
        """
        secret_template: NotRequired[pulumi.Input[builtins.str]]
        """
...
class SecretSecretGenerationContextArgs:
    def __init__(__self__, *,
                 generation_template: pulumi.Input[builtins.str],
                 generation_type: pulumi.Input[builtins.str],
                 passphrase_length: Optional[pulumi.Input[builtins.int]] = None,
                 secret_template: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] generation_template: (Updatable) Name of random bytes generation template for generating random byte type secret.
        :param pulumi.Input[builtins.str] generation_type: (Updatable) Name of the predefined secret generation type.
        :param pulumi.Input[builtins.int] passphrase_length: (Updatable) Length of the passphrase to be generated
        :param pulumi.Input[builtins.str] secret_template: (Updatable) SecretTemplate captures structure in which customer wants to store secrets. This is optional and a default structure is available for each secret type.  The template can have any structure with static values that are not generated. Within the template, you can insert predefined placeholders to store secrets.  These placeholders are later replaced with the generated content and saved as a Base64 encoded content.
        """
    ...
    def generation_template(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) Name of random bytes generation template for generating random byte type secret.
        """
    ...
    def generation_template(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "generation_template", value)

    @property
    @pulumi.getter(name="generationType")
    def generation_type(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) Name of the predefined secret generation type.
        """
    ...
    def generation_type(self, value: pulumi.Input[builtins.str]):
        pulumi.set(self, "generation_type", value)

    @property
    @pulumi.getter(name="passphraseLength")
    def passphrase_length(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) Length of the passphrase to be generated
        """
    ...
    def passphrase_length(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "passphrase_length", value)

    @property
    @pulumi.getter(name="secretTemplate")
    def secret_template(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) SecretTemplate captures structure in which customer wants to store secrets. This is optional and a default structure is available for each secret type.  The template can have any structure with static values that are not generated. Within the template, you can insert predefined placeholders to store secrets.  These placeholders are later replaced with the generated content and saved as a Base64 encoded content.
        """
    ...
    def secret_template(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class SecretSecretRuleArgsDict(TypedDict):
        ...
        """
        is_enforced_on_deleted_secret_versions: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        is_secret_content_retrieval_blocked_on_expiry: NotRequired[pulumi.Input[builtins.bool]]
        """
        ...
        """
        secret_version_expiry_interval: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        """
        time_of_absolute_expiry: NotRequired[pulumi.Input[builtins.str]]
        """
...
class SecretSecretRuleArgs:
    def __init__(__self__, *,
                 rule_type: pulumi.Input[builtins.str],
                 is_enforced_on_deleted_secret_versions: Optional[pulumi.Input[builtins.bool]] = None,
                 is_secret_content_retrieval_blocked_on_expiry: Optional[pulumi.Input[builtins.bool]] = None,
                 secret_version_expiry_interval: Optional[pulumi.Input[builtins.str]] = None,
                 time_of_absolute_expiry: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] rule_type: (Updatable) The type of rule, which either controls when the secret contents expire or whether they can be reused.
        :param pulumi.Input[builtins.bool] is_enforced_on_deleted_secret_versions: (Updatable) A property indicating whether the rule is applied even if the secret version with the content you are trying to reuse was deleted.
        :param pulumi.Input[builtins.bool] is_secret_content_retrieval_blocked_on_expiry: (Updatable) A property indicating whether to block retrieval of the secret content, on expiry. The default is false. If the secret has already expired and you would like to retrieve the secret contents, you need to edit the secret rule to disable this property, to allow reading the secret content.
        :param pulumi.Input[builtins.str] secret_version_expiry_interval: (Updatable) A property indicating how long the secret contents will be considered valid, expressed in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601#Time_intervals) format. The secret needs to be updated when the secret content expires. The timer resets after you update the secret contents. The minimum value is 1 day and the maximum value is 90 days for this property. Currently, only intervals expressed in days are supported. For example, pass `P3D` to have the secret version expire every 3 days.
        :param pulumi.Input[builtins.str] time_of_absolute_expiry: (Updatable) An optional property indicating the absolute time when this secret will expire, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. The minimum number of days from current time is 1 day and the maximum number of days from current time is 365 days. Example: `2019-04-03T21:10:29.600Z`
        """
    ...
    def is_enforced_on_deleted_secret_versions(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) A property indicating whether the rule is applied even if the secret version with the content you are trying to reuse was deleted.
        """
    ...
    def is_enforced_on_deleted_secret_versions(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_enforced_on_deleted_secret_versions", value)

    @property
    @pulumi.getter(name="isSecretContentRetrievalBlockedOnExpiry")
    def is_secret_content_retrieval_blocked_on_expiry(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) A property indicating whether to block retrieval of the secret content, on expiry. The default is false. If the secret has already expired and you would like to retrieve the secret contents, you need to edit the secret rule to disable this property, to allow reading the secret content.
        """
    ...
    def is_secret_content_retrieval_blocked_on_expiry(self, value: Optional[pulumi.Input[builtins.bool]]):
        pulumi.set(self, "is_secret_content_retrieval_blocked_on_expiry", value)

    @property
    @pulumi.getter(name="secretVersionExpiryInterval")
    def secret_version_expiry_interval(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) A property indicating how long the secret contents will be considered valid, expressed in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601#Time_intervals) format. The secret needs to be updated when the secret content expires. The timer resets after you update the secret contents. The minimum value is 1 day and the maximum value is 90 days for this property. Currently, only intervals expressed in days are supported. For example, pass `P3D` to have the secret version expire every 3 days.
        """
    ...
    def secret_version_expiry_interval(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "secret_version_expiry_interval", value)

    @property
    @pulumi.getter(name="timeOfAbsoluteExpiry")
    def time_of_absolute_expiry(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) An optional property indicating the absolute time when this secret will expire, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. The minimum number of days from current time is 1 day and the maximum number of days from current time is 365 days. Example: `2019-04-03T21:10:29.600Z`
        """
    ...
    def time_of_absolute_expiry(self, value: Optional[pulumi.Input[builtins.str]]):
...
class GetSecretsFilterArgs:
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: The secret name.
        """
        pulumi.set(__self__, "name", name)
