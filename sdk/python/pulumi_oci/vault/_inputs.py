...
class SecretRotationConfigTargetSystemDetailsArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] function_id: (Updatable) The unique identifier (OCID) of the Oracle Cloud Infrastructure Functions that vault secret connects to.
        """
    ...
    def target_system_type(self) -> pulumi.Input[_builtins.str]:
        """
        (Updatable) Unique identifier of the target system that Vault Secret connects to.
        """
    ...
    def target_system_type(self, value: pulumi.Input[_builtins.str]):
...
class SecretSecretContentArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] name: (Updatable) Names should be unique within a secret. Valid characters are uppercase or lowercase letters, numbers, hyphens, underscores, and periods.
        :param pulumi.Input[_builtins.str] stage: (Updatable) The rotation state of the secret content. The default is `CURRENT`, meaning that the secret is currently in use. A secret version that you mark as `PENDING` is staged and available for use, but you don't yet want to rotate it into current, active use. For example, you might create or update a secret and mark its rotation state as `PENDING` if you haven't yet updated the secret on the target system. When creating a secret, only the value `CURRENT` is applicable, although the value `LATEST` is also automatically applied. When updating a secret, you can specify a version's rotation state as either `CURRENT` or `PENDING`.
        """
...
class SecretSecretGenerationContextArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] passphrase_length: (Updatable) Length of the passphrase to be generated
        :param pulumi.Input[_builtins.str] secret_template: (Updatable) SecretTemplate captures structure in which customer wants to store secrets. This is optional and a default structure is available for each secret type.  The template can have any structure with static values that are not generated. Within the template, you can insert predefined placeholders to store secrets.  These placeholders are later replaced with the generated content and saved as a Base64 encoded content.
        """
    ...
    def generation_template(self) -> pulumi.Input[_builtins.str]:
        """
        (Updatable) Name of random bytes generation template for generating random byte type secret.
        """
    ...
    def generation_template(self, value: pulumi.Input[_builtins.str]):
        pulumi.set(self, "generation_template", value)

    @_builtins.property
    @pulumi.getter(name="generationType")
    def generation_type(self) -> pulumi.Input[_builtins.str]:
        """
        (Updatable) Name of the predefined secret generation type.
        """
    ...
    def generation_type(self, value: pulumi.Input[_builtins.str]):
...
class SecretSecretRuleArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.bool] is_secret_content_retrieval_blocked_on_expiry: (Updatable) A property indicating whether to block retrieval of the secret content, on expiry. The default is false. If the secret has already expired and you would like to retrieve the secret contents, you need to edit the secret rule to disable this property, to allow reading the secret content.
        :param pulumi.Input[_builtins.str] secret_version_expiry_interval: (Updatable) A property indicating how long the secret contents will be considered valid, expressed in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601#Time_intervals) format. The secret needs to be updated when the secret content expires. The timer resets after you update the secret contents. The minimum value is 1 day and the maximum value is 90 days for this property. Currently, only intervals expressed in days are supported. For example, pass `P3D` to have the secret version expire every 3 days.
        :param pulumi.Input[_builtins.str] time_of_absolute_expiry: (Updatable) An optional property indicating the absolute time when this secret will expire, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. The minimum number of days from current time is 1 day and the maximum number of days from current time is 365 days. Example: `2019-04-03T21:10:29.600Z`
        """
