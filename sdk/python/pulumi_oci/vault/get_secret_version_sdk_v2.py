...
class GetSecretVersionSdkV2Result:
    ...
    def is_content_auto_generated(self) -> builtins.bool:
    ...
    def secret_version_number(self) -> builtins.str:
...
def get_secret_version_sdk_v2(secret_id: Optional[builtins.str] = None,
                              secret_version_number: Optional[builtins.str] = None,
...
def get_secret_version_sdk_v2_output(secret_id: Optional[pulumi.Input[builtins.str]] = None,
                                     secret_version_number: Optional[pulumi.Input[builtins.str]] = None,
