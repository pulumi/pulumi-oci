...
class GetSecretVersionSdkV2Result:
    ...
    def is_content_auto_generated(self) -> _builtins.bool:
    ...
    def secret_version_number(self) -> _builtins.str:
...
def get_secret_version_sdk_v2(secret_id: Optional[_builtins.str] = None,
                              secret_version_number: Optional[_builtins.str] = None,
