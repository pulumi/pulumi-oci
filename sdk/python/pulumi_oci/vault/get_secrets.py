...
def get_secrets(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str state: A filter that returns only resources that match the specified lifecycle state. The state value is case-insensitive.
...
def get_secrets_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                       ...
                       vault_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
