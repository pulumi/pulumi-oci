...
class SecretRotationConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_scheduled_rotation_enabled: Optional[builtins.bool] = None,
    ...
    def is_scheduled_rotation_enabled(self) -> Optional[builtins.bool]:
        """
...
class SecretRotationConfigTargetSystemDetails(dict):
    ...
    def __init__(__self__, *,
                 target_system_type: builtins.str,
                 adb_id: Optional[builtins.str] = None,
                 function_id: Optional[builtins.str] = None):
        """
        :param builtins.str target_system_type: (Updatable) Unique identifier of the target system that Vault Secret connects to.
        :param builtins.str adb_id: (Updatable) The unique identifier (OCID) for the autonomous database that Vault Secret connects to.
        :param builtins.str function_id: (Updatable) The unique identifier (OCID) of the Oracle Cloud Infrastructure Functions that vault secret connects to.
        """
    ...
    def target_system_type(self) -> builtins.str:
        """
    ...
    def adb_id(self) -> Optional[builtins.str]:
        """
...
class SecretSecretContent(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str content_type: (Updatable) The base64-encoded content of the secret.
        :param builtins.str content: (Updatable) The base64-encoded content of the secret.
        :param builtins.str name: (Updatable) Names should be unique within a secret. Valid characters are uppercase or lowercase letters, numbers, hyphens, underscores, and periods.
        :param builtins.str stage: (Updatable) The rotation state of the secret content. The default is `CURRENT`, meaning that the secret is currently in use. A secret version that you mark as `PENDING` is staged and available for use, but you don't yet want to rotate it into current, active use. For example, you might create or update a secret and mark its rotation state as `PENDING` if you haven't yet updated the secret on the target system. When creating a secret, only the value `CURRENT` is applicable, although the value `LATEST` is also automatically applied. When updating a secret, you can specify a version's rotation state as either `CURRENT` or `PENDING`.
        """
...
class SecretSecretGenerationContext(dict):
    ...
    def __init__(__self__, *,
                 generation_template: builtins.str,
                 generation_type: builtins.str,
                 passphrase_length: Optional[builtins.int] = None,
                 secret_template: Optional[builtins.str] = None):
        """
        :param builtins.str generation_template: (Updatable) Name of random bytes generation template for generating random byte type secret.
        :param builtins.str generation_type: (Updatable) Name of the predefined secret generation type.
        :param builtins.int passphrase_length: (Updatable) Length of the passphrase to be generated
        :param builtins.str secret_template: (Updatable) SecretTemplate captures structure in which customer wants to store secrets. This is optional and a default structure is available for each secret type.  The template can have any structure with static values that are not generated. Within the template, you can insert predefined placeholders to store secrets.  These placeholders are later replaced with the generated content and saved as a Base64 encoded content.
        """
    ...
    def generation_template(self) -> builtins.str:
        """
    ...
    def generation_type(self) -> builtins.str:
        """
    ...
    def passphrase_length(self) -> Optional[builtins.int]:
        """
    ...
    def secret_template(self) -> Optional[builtins.str]:
        """
...
class SecretSecretRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 is_enforced_on_deleted_secret_versions: Optional[builtins.bool] = None,
                 is_secret_content_retrieval_blocked_on_expiry: Optional[builtins.bool] = None,
                 secret_version_expiry_interval: Optional[builtins.str] = None,
                 time_of_absolute_expiry: Optional[builtins.str] = None):
        """
        :param builtins.str rule_type: (Updatable) The type of rule, which either controls when the secret contents expire or whether they can be reused.
        :param builtins.bool is_enforced_on_deleted_secret_versions: (Updatable) A property indicating whether the rule is applied even if the secret version with the content you are trying to reuse was deleted.
        :param builtins.bool is_secret_content_retrieval_blocked_on_expiry: (Updatable) A property indicating whether to block retrieval of the secret content, on expiry. The default is false. If the secret has already expired and you would like to retrieve the secret contents, you need to edit the secret rule to disable this property, to allow reading the secret content.
        :param builtins.str secret_version_expiry_interval: (Updatable) A property indicating how long the secret contents will be considered valid, expressed in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601#Time_intervals) format. The secret needs to be updated when the secret content expires. The timer resets after you update the secret contents. The minimum value is 1 day and the maximum value is 90 days for this property. Currently, only intervals expressed in days are supported. For example, pass `P3D` to have the secret version expire every 3 days.
        :param builtins.str time_of_absolute_expiry: (Updatable) An optional property indicating the absolute time when this secret will expire, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. The minimum number of days from current time is 1 day and the maximum number of days from current time is 365 days. Example: `2019-04-03T21:10:29.600Z`
        """
    ...
    def is_enforced_on_deleted_secret_versions(self) -> Optional[builtins.bool]:
        """
    ...
    def is_secret_content_retrieval_blocked_on_expiry(self) -> Optional[builtins.bool]:
        """
    ...
    def secret_version_expiry_interval(self) -> Optional[builtins.str]:
        """
    ...
    def time_of_absolute_expiry(self) -> Optional[builtins.str]:
        """
...
class GetSecretRotationConfigResult(dict):
    def __init__(__self__, *,
                 is_scheduled_rotation_enabled: builtins.bool,
                 rotation_interval: builtins.str,
                 target_system_details: Sequence['outputs.GetSecretRotationConfigTargetSystemDetailResult']):
        """
        :param builtins.bool is_scheduled_rotation_enabled: Enables auto rotation, when set to true rotationInterval must be set.
        :param builtins.str rotation_interval: The time interval that indicates the frequency for rotating secret data, as described in ISO 8601 format. The minimum value is 1 day and maximum value is 360 days. For example, if you want to set the time interval for rotating a secret data as 30 days, the duration is expressed as "P30D."
    ...
    @property
    @pulumi.getter(name="isScheduledRotationEnabled")
    def is_scheduled_rotation_enabled(self) -> builtins.bool:
        """
...
class GetSecretRotationConfigTargetSystemDetailResult(dict):
    def __init__(__self__, *,
                 ...
                 target_system_type: builtins.str):
        """
        :param builtins.str adb_id: The unique identifier (OCID) for the autonomous database that Vault Secret connects to.
        :param builtins.str function_id: The unique identifier (OCID) of the Oracle Cloud Infrastructure Functions that vault secret connects to.
        :param builtins.str target_system_type: Unique identifier of the target system that Vault Secret connects to.
        """
        pulumi.set(__self__, "adb_id", adb_id)
        pulumi.set(__self__, "function_id", function_id)
        pulumi.set(__self__, "target_system_type", target_system_type)
...
class GetSecretSecretGenerationContextResult(dict):
    def __init__(__self__, *,
                 generation_template: builtins.str,
                 generation_type: builtins.str,
                 passphrase_length: builtins.int,
                 secret_template: builtins.str):
        """
        :param builtins.str generation_template: Name of random bytes generation template for generating random byte type secret.
        :param builtins.str generation_type: Name of the predefined secret generation type.
        :param builtins.int passphrase_length: Length of the passphrase to be generated
        :param builtins.str secret_template: SecretTemplate captures structure in which customer wants to store secrets. This is optional and a default structure is available for each secret type.  The template can have any structure with static values that are not generated. Within the template, you can insert predefined placeholders to store secrets.  These placeholders are later replaced with the generated content and saved as a Base64 encoded content.
        """
        pulumi.set(__self__, "generation_template", generation_template)
        pulumi.set(__self__, "generation_type", generation_type)
        pulumi.set(__self__, "passphrase_length", passphrase_length)
    ...
    @property
    @pulumi.getter(name="passphraseLength")
    def passphrase_length(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="secretTemplate")
    def secret_template(self) -> builtins.str:
        """
...
class GetSecretSecretRuleResult(dict):
    def __init__(__self__, *,
                 is_enforced_on_deleted_secret_versions: builtins.bool,
                 is_secret_content_retrieval_blocked_on_expiry: builtins.bool,
                 rule_type: builtins.str,
                 secret_version_expiry_interval: builtins.str,
                 time_of_absolute_expiry: builtins.str):
        """
        :param builtins.bool is_enforced_on_deleted_secret_versions: A property indicating whether the rule is applied even if the secret version with the content you are trying to reuse was deleted.
        :param builtins.bool is_secret_content_retrieval_blocked_on_expiry: A property indicating whether to block retrieval of the secret content, on expiry. The default is false. If the secret has already expired and you would like to retrieve the secret contents, you need to edit the secret rule to disable this property, to allow reading the secret content.
        :param builtins.str rule_type: The type of rule, which either controls when the secret contents expire or whether they can be reused.
        :param builtins.str secret_version_expiry_interval: A property indicating how long the secret contents will be considered valid, expressed in [ISO 8601](https://en.wikipedia.org/wiki/ISO_8601#Time_intervals) format. The secret needs to be updated when the secret content expires. The timer resets after you update the secret contents. The minimum value is 1 day and the maximum value is 90 days for this property. Currently, only intervals expressed in days are supported. For example, pass `P3D` to have the secret version expire every 3 days.
        :param builtins.str time_of_absolute_expiry: An optional property indicating the absolute time when this secret will expire, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. The minimum number of days from current time is 1 day and the maximum number of days from current time is 365 days. Example: `2019-04-03T21:10:29.600Z`
        """
        pulumi.set(__self__, "is_enforced_on_deleted_secret_versions", is_enforced_on_deleted_secret_versions)
        pulumi.set(__self__, "is_secret_content_retrieval_blocked_on_expiry", is_secret_content_retrieval_blocked_on_expiry)
        pulumi.set(__self__, "rule_type", rule_type)
    ...
    @property
    @pulumi.getter(name="isEnforcedOnDeletedSecretVersions")
    def is_enforced_on_deleted_secret_versions(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="isSecretContentRetrievalBlockedOnExpiry")
    def is_secret_content_retrieval_blocked_on_expiry(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="secretVersionExpiryInterval")
    def secret_version_expiry_interval(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="timeOfAbsoluteExpiry")
    def time_of_absolute_expiry(self) -> builtins.str:
        """
...
class GetSecretsSecretResult(dict):
    def __init__(__self__, *,
                 ...
                 current_version_number: builtins.str,
                 defined_tags: Mapping[str, builtins.str],
                 description: builtins.str,
                 enable_auto_generation: builtins.bool,
                 freeform_tags: Mapping[str, builtins.str],
                 id: builtins.str,
                 is_auto_generation_enabled: builtins.bool,
                 key_id: builtins.str,
                 last_rotation_time: builtins.str,
                 ...
                 time_of_current_version_expiry: builtins.str,
                 time_of_deletion: builtins.str,
                 vault_id: builtins.str):
        """
        :param builtins.str compartment_id: The OCID of the compartment.
        :param builtins.str current_version_number: The version number of the secret version that's currently in use.
        ...
        :param builtins.str description: A brief description of the secret. Avoid entering confidential information.
        ...
        :param builtins.str id: The OCID of the secret.
        :param builtins.bool is_auto_generation_enabled: The value of this flag determines whether or not secret content will be generated automatically.
        :param builtins.str key_id: The OCID of the master encryption key that is used to encrypt the secret. You must specify a symmetric key to encrypt the secret during import to the vault. You cannot encrypt secrets with asymmetric keys. Furthermore, the key must exist in the vault that you specify.
        :param builtins.str last_rotation_time: A property indicating when the secret was last rotated successfully, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
        :param builtins.str lifecycle_details: Additional information about the current lifecycle state of the secret.
        :param Mapping[str, builtins.str] metadata: Additional metadata that you can use to provide context about how to use the secret or during rotation or other administrative tasks. For example, for a secret that you use to connect to a database, the additional metadata might specify the connection endpoint and the connection string. Provide additional metadata as key-value pairs.
        :param builtins.str next_rotation_time: A property indicating when the secret is scheduled to be rotated, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
        ...
        :param builtins.str rotation_status: Additional information about the status of the secret rotation
        ...
        :param builtins.str secret_name: The user-friendly name of the secret. Avoid entering confidential information.
        ...
        :param builtins.str time_created: A property indicating when the secret was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
        :param builtins.str time_of_current_version_expiry: An optional property indicating when the current secret version will expire, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
        :param builtins.str time_of_deletion: An optional property indicating when to delete the secret, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
    ...
    def current_version_number(self) -> builtins.str:
        """
    ...
    def enable_auto_generation(self) -> builtins.bool:
    ...
    def is_auto_generation_enabled(self) -> builtins.bool:
        """
    ...
    def rotation_status(self) -> builtins.str:
        """
    ...
    def time_of_current_version_expiry(self) -> builtins.str:
        """
