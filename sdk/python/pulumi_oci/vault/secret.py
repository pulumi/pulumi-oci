...
class SecretArgs:
    def __init__(__self__, *,
                 ...
                 enable_auto_generation: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment where you want to create the secret.
        :param pulumi.Input[builtins.str] key_id: The OCID of the master encryption key that is used to encrypt the secret. You must specify a symmetric key to encrypt the secret during import to the vault. You cannot encrypt secrets with asymmetric keys. Furthermore, the key must exist in the vault that you specify.
        :param pulumi.Input[builtins.str] secret_name: A user-friendly name for the secret. Secret names should be unique within a vault. Avoid entering confidential information. Valid characters are uppercase or lowercase letters, numbers, hyphens, underscores, and periods.
        :param pulumi.Input[builtins.str] vault_id: The OCID of the vault where you want to create the secret.
        ...
        :param pulumi.Input[builtins.str] description: (Updatable) A brief description of the secret. Avoid entering confidential information.
        :param pulumi.Input[builtins.bool] enable_auto_generation: (Updatable) The value of this flag determines whether or not secret content will be generated automatically. If not set, it defaults to false.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: (Updatable) Additional metadata that you can use to provide context about how to use the secret during rotation or other administrative tasks. For example, for a secret that you use to connect to a database, the additional metadata might specify the connection endpoint and the connection string. Provide additional metadata as key-value pairs.
    ...
    def enable_auto_generation(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def enable_auto_generation(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _SecretState:
    def __init__(__self__, *,
                 ...
                 current_version_number: Optional[pulumi.Input[builtins.str]] = None,
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 description: Optional[pulumi.Input[builtins.str]] = None,
                 enable_auto_generation: Optional[pulumi.Input[builtins.bool]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_auto_generation_enabled: Optional[pulumi.Input[builtins.bool]] = None,
                 ...
                 rotation_config: Optional[pulumi.Input['SecretRotationConfigArgs']] = None,
                 rotation_status: Optional[pulumi.Input[builtins.str]] = None,
                 secret_content: Optional[pulumi.Input['SecretSecretContentArgs']] = None,
                 secret_generation_context: Optional[pulumi.Input['SecretSecretGenerationContextArgs']] = None,
                 ...
                 time_of_current_version_expiry: Optional[pulumi.Input[builtins.str]] = None,
                 time_of_deletion: Optional[pulumi.Input[builtins.str]] = None,
                 vault_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        Input properties used for looking up and filtering Secret resources.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The OCID of the compartment where you want to create the secret.
        :param pulumi.Input[builtins.str] current_version_number: The version number of the secret version that's currently in use.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] description: (Updatable) A brief description of the secret. Avoid entering confidential information.
        :param pulumi.Input[builtins.bool] enable_auto_generation: (Updatable) The value of this flag determines whether or not secret content will be generated automatically. If not set, it defaults to false.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm). Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] is_auto_generation_enabled: The value of this flag determines whether or not secret content will be generated automatically.
        :param pulumi.Input[builtins.str] key_id: The OCID of the master encryption key that is used to encrypt the secret. You must specify a symmetric key to encrypt the secret during import to the vault. You cannot encrypt secrets with asymmetric keys. Furthermore, the key must exist in the vault that you specify.
        :param pulumi.Input[builtins.str] last_rotation_time: A property indicating when the secret was last rotated successfully, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
        :param pulumi.Input[builtins.str] lifecycle_details: Additional information about the current lifecycle state of the secret.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] metadata: (Updatable) Additional metadata that you can use to provide context about how to use the secret during rotation or other administrative tasks. For example, for a secret that you use to connect to a database, the additional metadata might specify the connection endpoint and the connection string. Provide additional metadata as key-value pairs.
        :param pulumi.Input[builtins.str] next_rotation_time: A property indicating when the secret is scheduled to be rotated, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
        :param pulumi.Input['SecretRotationConfigArgs'] rotation_config: (Updatable) Defines the frequency of the rotation and the information about the target system
        :param pulumi.Input[builtins.str] rotation_status: Additional information about the status of the secret rotation
        :param pulumi.Input['SecretSecretContentArgs'] secret_content: (Updatable) The content of the secret and metadata to help identify it.
        :param pulumi.Input['SecretSecretGenerationContextArgs'] secret_generation_context: (Updatable) Captures a configurable set of secret generation rules such as length, base characters, additional characters, and so on.
        :param pulumi.Input[builtins.str] secret_name: A user-friendly name for the secret. Secret names should be unique within a vault. Avoid entering confidential information. Valid characters are uppercase or lowercase letters, numbers, hyphens, underscores, and periods.
        :param pulumi.Input[Sequence[pulumi.Input['SecretSecretRuleArgs']]] secret_rules: (Updatable) A list of rules to control how the secret is used and managed.
        :param pulumi.Input[builtins.str] state: The current lifecycle state of the secret.
        :param pulumi.Input[builtins.str] time_created: A property indicating when the secret was created, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_of_current_version_expiry: An optional property indicating when the current secret version will expire, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_of_deletion: An optional property indicating when to delete the secret, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
        :param pulumi.Input[builtins.str] vault_id: The OCID of the vault where you want to create the secret.
    ...
    def current_version_number(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def current_version_number(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def is_auto_generation_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_auto_generation_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
    ...
    def rotation_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def rotation_status(self, value: Optional[pulumi.Input[builtins.str]]):
    ...
    def time_of_current_version_expiry(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_of_current_version_expiry(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Secret(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_of_current_version_expiry: Optional[pulumi.Input[builtins.str]] = None,
            time_of_deletion: Optional[pulumi.Input[builtins.str]] = None,
            vault_id: Optional[pulumi.Input[builtins.str]] = None) -> 'Secret':
        """
    ...
    @property
    @pulumi.getter(name="currentVersionNumber")
    def current_version_number(self) -> pulumi.Output[builtins.str]:
        """
        The version number of the secret version that's currently in use.
        """
        return pulumi.get(self, "current_version_number")
    ...
    @property
    @pulumi.getter(name="enableAutoGeneration")
    def enable_auto_generation(self) -> pulumi.Output[Optional[builtins.bool]]:
        """
        (Updatable) The value of this flag determines whether or not secret content will be generated automatically. If not set, it defaults to false.
        """
        return pulumi.get(self, "enable_auto_generation")
    ...
    @property
    @pulumi.getter(name="isAutoGenerationEnabled")
    def is_auto_generation_enabled(self) -> pulumi.Output[builtins.bool]:
        """
        The value of this flag determines whether or not secret content will be generated automatically.
        """
        return pulumi.get(self, "is_auto_generation_enabled")
    ...
    @property
    @pulumi.getter(name="nextRotationTime")
    def next_rotation_time(self) -> pulumi.Output[builtins.str]:
        """
        A property indicating when the secret is scheduled to be rotated, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
        """
        return pulumi.get(self, "next_rotation_time")
    ...
    @property
    @pulumi.getter(name="rotationStatus")
    def rotation_status(self) -> pulumi.Output[builtins.str]:
        """
        Additional information about the status of the secret rotation
        """
        return pulumi.get(self, "rotation_status")
    ...
    @property
    @pulumi.getter(name="timeOfCurrentVersionExpiry")
    def time_of_current_version_expiry(self) -> pulumi.Output[builtins.str]:
        """
        An optional property indicating when the current secret version will expire, expressed in [RFC 3339](https://tools.ietf.org/html/rfc3339) timestamp format. Example: `2019-04-03T21:10:29.600Z`
        """
        return pulumi.get(self, "time_of_current_version_expiry")
