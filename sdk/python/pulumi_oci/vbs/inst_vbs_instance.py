...
class InstVbsInstanceArgs:
    def __init__(__self__, *,
                 ...
                 is_resource_usage_agreement_granted: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) Compartment Identifier. It can only be the root compartment
        ...
        :param pulumi.Input[builtins.str] idcs_access_token: IDCS personal acceess token identifying IDCS user and stripe for the VBS service
        :param pulumi.Input[builtins.bool] is_resource_usage_agreement_granted: (Updatable) Whether VBS is authorized to create and use resources in the customer tenancy
        :param pulumi.Input[builtins.str] name: Service Instance Name
        :param pulumi.Input[builtins.str] resource_compartment_id: (Updatable) Compartment where VBS may create additional resources for the service instance
    ...
    def is_resource_usage_agreement_granted(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_resource_usage_agreement_granted(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _InstVbsInstanceState:
    def __init__(__self__, *,
                 ...
                 vbs_access_url: Optional[pulumi.Input[builtins.str]] = None):
        """
        ...
        :param pulumi.Input[builtins.str] resource_compartment_id: (Updatable) Compartment where VBS may create additional resources for the service instance
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The current state of the VbsInstance.
        ...
        :param pulumi.Input[builtins.str] time_created: The time the the VbsInstance was created. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.str] time_updated: The time the VbsInstance was updated. An RFC3339 formatted datetime string
        :param pulumi.Input[builtins.str] vbs_access_url: Public web URL for accessing the VBS service instance
        """
    ...
    def vbs_access_url(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def vbs_access_url(self, value: Optional[pulumi.Input[builtins.str]]):
...
class InstVbsInstance(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            vbs_access_url: Optional[pulumi.Input[builtins.str]] = None) -> 'InstVbsInstance':
        """
    ...
    @property
    @pulumi.getter(name="isResourceUsageAgreementGranted")
    def is_resource_usage_agreement_granted(self) -> pulumi.Output[builtins.bool]:
        """
        (Updatable) Whether VBS is authorized to create and use resources in the customer tenancy
        """
        return pulumi.get(self, "is_resource_usage_agreement_granted")
    ...
    @property
    @pulumi.getter(name="vbsAccessUrl")
    def vbs_access_url(self) -> pulumi.Output[builtins.str]:
        """
        Public web URL for accessing the VBS service instance
        """
        return pulumi.get(self, "vbs_access_url")
