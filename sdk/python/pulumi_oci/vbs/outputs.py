...
class GetInstVbsInstancesVbsInstanceSummaryCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 is_resource_usage_agreement_granted: builtins.bool,
        ...
        :param builtins.str display_name: Service instance display name
        ...
        :param builtins.bool is_resource_usage_agreement_granted: Whether the VBS service instance owner explicitly approved VBS to create and use resources in the customer tenancy
        ...
        :param builtins.str name: A filter to return only resources that match the entire name given.
        :param builtins.str resource_compartment_id: Compartment where VBS may create additional resources for the service instance
        ...
        :param builtins.str time_created: The time the the VbsInstance was created. An RFC3339 formatted datetime string
        :param builtins.str time_updated: The time the VbsInstance was updated. An RFC3339 formatted datetime string
        :param builtins.str vbs_access_url: Public web URL for accessing the VBS service instance
        """
