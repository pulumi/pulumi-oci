...
class GetVbInstanceApplicationsResult:
    ...
    def idcs_open_id(self) -> Optional[_builtins.str]:
        return pulumi.get(self, "idcs_open_id")

    @_builtins.property
    @pulumi.getter(name="vbInstanceId")
    def vb_instance_id(self) -> _builtins.str:
...
def get_vb_instance_applications(idcs_open_id: Optional[_builtins.str] = None,
                                 vb_instance_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str idcs_open_id: Encrypted IDCS Open ID token which allows access to Visual Builder REST apis
    :param _builtins.str vb_instance_id: Unique Vb Instance identifier.
    """
    __args__ = dict()
