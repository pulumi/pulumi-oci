...
def get_vb_instances(compartment_id: Optional[str] = None,
    ...
    test_vb_instances = oci.VisualBuilder.get_vb_instances(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetVbInstancesResult(
        ...
        id=__ret__.id,
        state=__ret__.state,
        vb_instance_summary_collections=__ret__.vb_instance_summary_collections)
