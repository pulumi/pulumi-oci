...
class VbInstanceArgs:
    def __init__(__self__, *,
                 ...
                 alternate_custom_endpoints: pulumi.Input[Optional[Sequence[pulumi.Input['VbInstanceAlternateCustomEndpointArgs']]]] = None,
                 consumption_model: pulumi.Input[Optional[_builtins.str]] = None,
                 custom_endpoint: pulumi.Input[Optional['VbInstanceCustomEndpointArgs']] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 idcs_open_id: pulumi.Input[Optional[_builtins.str]] = None,
                 is_visual_builder_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 network_endpoint_details: pulumi.Input[Optional['VbInstanceNetworkEndpointDetailsArgs']] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] idcs_open_id: (Updatable) Encrypted IDCS Open ID token. This is required for pre-UCPIS cloud accounts, but not UCPIS, hence not a required parameter
    ...
    def alternate_custom_endpoints(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['VbInstanceAlternateCustomEndpointArgs']]]]:
        """
    ...
    def alternate_custom_endpoints(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['VbInstanceAlternateCustomEndpointArgs']]]]):
    ...
    def custom_endpoint(self) -> pulumi.Input[Optional['VbInstanceCustomEndpointArgs']]:
        """
    ...
    def custom_endpoint(self, value: pulumi.Input[Optional['VbInstanceCustomEndpointArgs']]):
    ...
    def idcs_open_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    @idcs_open_id.setter
    def idcs_open_id(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def network_endpoint_details(self) -> pulumi.Input[Optional['VbInstanceNetworkEndpointDetailsArgs']]:
        """
    ...
    def network_endpoint_details(self, value: pulumi.Input[Optional['VbInstanceNetworkEndpointDetailsArgs']]):
...
class _VbInstanceState:
    def __init__(__self__, *,
                 ...
                 is_visual_builder_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 management_nat_gateway_ip: pulumi.Input[Optional[_builtins.str]] = None,
                 management_vcn_id: pulumi.Input[Optional[_builtins.str]] = None,
                 network_endpoint_details: pulumi.Input[Optional['VbInstanceNetworkEndpointDetailsArgs']] = None,
                 node_count: pulumi.Input[Optional[_builtins.int]] = None,
                 service_nat_gateway_ip: pulumi.Input[Optional[_builtins.str]] = None,
                 service_vcn_id: pulumi.Input[Optional[_builtins.str]] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[_builtins.str] idcs_open_id: (Updatable) Encrypted IDCS Open ID token. This is required for pre-UCPIS cloud accounts, but not UCPIS, hence not a required parameter
        :param pulumi.Input[_builtins.str] instance_url: The Vb Instance URL.
        :param pulumi.Input[_builtins.bool] is_visual_builder_enabled: (Updatable) Visual Builder is enabled or not.
        :param pulumi.Input[_builtins.str] management_nat_gateway_ip: The NAT gateway IP address for the VB management VCN
        ...
        :param pulumi.Input[_builtins.int] node_count: (Updatable) The number of Nodes
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] service_nat_gateway_ip: The NAT gateway IP address for the VB service VCN
        :param pulumi.Input[_builtins.str] service_vcn_id: The Oracle Cloud ID (OCID) of the Visual Builder service VCN
        :param pulumi.Input[_builtins.str] state: The current state of the vb instance.
        ...
        :param pulumi.Input[_builtins.str] time_created: The time the the VbInstance was created. An RFC3339 formatted datetime string.
        :param pulumi.Input[_builtins.str] time_updated: The time the VbInstance was updated. An RFC3339 formatted datetime string.
        """
        if alternate_custom_endpoints is not None:
            pulumi.set(__self__, "alternate_custom_endpoints", alternate_custom_endpoints)
    ...
    def management_nat_gateway_ip(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def management_nat_gateway_ip(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "management_nat_gateway_ip", value)

    @_builtins.property
    @pulumi.getter(name="managementVcnId")
    def management_vcn_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def management_vcn_id(self, value: pulumi.Input[Optional[_builtins.str]]):
    ...
    def service_nat_gateway_ip(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def service_nat_gateway_ip(self, value: pulumi.Input[Optional[_builtins.str]]):
        pulumi.set(self, "service_nat_gateway_ip", value)

    @_builtins.property
    @pulumi.getter(name="serviceVcnId")
    def service_vcn_id(self) -> pulumi.Input[Optional[_builtins.str]]:
        """
    ...
    def service_vcn_id(self, value: pulumi.Input[Optional[_builtins.str]]):
...
class VbInstance(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 alternate_custom_endpoints: pulumi.Input[Optional[Sequence[pulumi.Input[Union['VbInstanceAlternateCustomEndpointArgs', 'VbInstanceAlternateCustomEndpointArgsDict', 'outputs.VbInstanceAlternateCustomEndpoint']]]]] = None,
                 compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                 consumption_model: pulumi.Input[Optional[_builtins.str]] = None,
                 custom_endpoint: pulumi.Input[Optional[Union['VbInstanceCustomEndpointArgs', 'VbInstanceCustomEndpointArgsDict', 'outputs.VbInstanceCustomEndpoint']]] = None,
                 defined_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 idcs_open_id: pulumi.Input[Optional[_builtins.str]] = None,
                 is_visual_builder_enabled: pulumi.Input[Optional[_builtins.bool]] = None,
                 network_endpoint_details: pulumi.Input[Optional[Union['VbInstanceNetworkEndpointDetailsArgs', 'VbInstanceNetworkEndpointDetailsArgsDict', 'outputs.VbInstanceNetworkEndpointDetails']]] = None,
                 node_count: pulumi.Input[Optional[_builtins.int]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Sequence[pulumi.Input[Union['VbInstanceAlternateCustomEndpointArgs', 'VbInstanceAlternateCustomEndpointArgsDict', 'outputs.VbInstanceAlternateCustomEndpoint']]]] alternate_custom_endpoints: (Updatable) A list of alternate custom endpoints to be used for the vb instance URL (contact Oracle for alternateCustomEndpoints availability for a specific instance).
        :param pulumi.Input[_builtins.str] compartment_id: (Updatable) Compartment Identifier.
        :param pulumi.Input[_builtins.str] consumption_model: Optional parameter specifying which entitlement to use for billing purposes. Only required if the account possesses more than one entitlement.
        :param pulumi.Input[Union['VbInstanceCustomEndpointArgs', 'VbInstanceCustomEndpointArgsDict', 'outputs.VbInstanceCustomEndpoint']] custom_endpoint: (Updatable) Details for a custom endpoint for the vb instance (update).
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] defined_tags: (Updatable) Usage of predefined tag keys. These predefined keys are scoped to namespaces. Example: `{"foo-namespace.bar-key": "value"}`
        :param pulumi.Input[_builtins.str] display_name: (Updatable) Vb Instance Identifier.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[_builtins.str] idcs_open_id: (Updatable) Encrypted IDCS Open ID token. This is required for pre-UCPIS cloud accounts, but not UCPIS, hence not a required parameter
        :param pulumi.Input[_builtins.bool] is_visual_builder_enabled: (Updatable) Visual Builder is enabled or not.
        :param pulumi.Input[Union['VbInstanceNetworkEndpointDetailsArgs', 'VbInstanceNetworkEndpointDetailsArgsDict', 'outputs.VbInstanceNetworkEndpointDetails']] network_endpoint_details: (Updatable) Base representation of a network endpoint. In input payload to update an Visual Builder instance endpoint details, an empty payload will clear out any existing configuration for Public Visual Builder instance.
        :param pulumi.Input[_builtins.int] node_count: (Updatable) The number of Nodes
    ...
    def get(resource_name: str,
            ...
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None) -> 'VbInstance':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="idcsOpenId")
    def idcs_open_id(self) -> pulumi.Output[Optional[_builtins.str]]:
        """
        (Updatable) Encrypted IDCS Open ID token. This is required for pre-UCPIS cloud accounts, but not UCPIS, hence not a required parameter
        """
        return pulumi.get(self, "idcs_open_id")
    ...
    @_builtins.property
    @pulumi.getter(name="managementNatGatewayIp")
    def management_nat_gateway_ip(self) -> pulumi.Output[_builtins.str]:
        """
        The NAT gateway IP address for the VB management VCN
        """
        return pulumi.get(self, "management_nat_gateway_ip")
    ...
    @_builtins.property
    @pulumi.getter(name="managementVcnId")
    def management_vcn_id(self) -> pulumi.Output[_builtins.str]:
        """
        The Oracle Cloud ID (OCID) of the Visual Builder management VCN
        """
        return pulumi.get(self, "management_vcn_id")
    ...
    @_builtins.property
    @pulumi.getter(name="serviceNatGatewayIp")
    def service_nat_gateway_ip(self) -> pulumi.Output[_builtins.str]:
        """
        The NAT gateway IP address for the VB service VCN
        """
        return pulumi.get(self, "service_nat_gateway_ip")
    ...
    @_builtins.property
    @pulumi.getter(name="serviceVcnId")
    def service_vcn_id(self) -> pulumi.Output[_builtins.str]:
        """
        The Oracle Cloud ID (OCID) of the Visual Builder service VCN
        """
        return pulumi.get(self, "service_vcn_id")
