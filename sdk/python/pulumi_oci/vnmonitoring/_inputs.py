...
if not MYPY:
    class PathAnalysiDestinationEndpointArgsDict(TypedDict):
        ...
        """
        network_load_balancer_id: NotRequired[pulumi.Input[builtins.str]]
        """
...
class PathAnalysiDestinationEndpointArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: The type of the `Endpoint`.
        :param pulumi.Input[builtins.str] address: The IPv4 address of the COMPUTE_INSTANCE-type `Endpoint` object.
        :param pulumi.Input[builtins.str] instance_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute instance.
        :param pulumi.Input[builtins.str] listener_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the network load balancer listener.
        :param pulumi.Input[builtins.str] load_balancer_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the listener's load balancer.
        :param pulumi.Input[builtins.str] network_load_balancer_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the listener's network load balancer.
    ...
    def network_load_balancer_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the listener's network load balancer.
        """
    ...
    def network_load_balancer_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
if not MYPY:
    class PathAnalysiProtocolParametersArgsDict(TypedDict):
        ...
        """
        icmp_code: NotRequired[pulumi.Input[builtins.int]]
        """
        The [ICMP](https://www.iana.org/assignments/icmp-parameters/icmp-parameters.xhtml) code.
        """
        icmp_type: NotRequired[pulumi.Input[builtins.int]]
        """
...
class PathAnalysiProtocolParametersArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: The type of the `ProtocolParameters` object.
        :param pulumi.Input[builtins.int] destination_port: The destination port to use in a `PathAnalyzerTest` resource.
        :param pulumi.Input[builtins.int] icmp_code: The [ICMP](https://www.iana.org/assignments/icmp-parameters/icmp-parameters.xhtml) code.
        :param pulumi.Input[builtins.int] icmp_type: The [ICMP](https://www.iana.org/assignments/icmp-parameters/icmp-parameters.xhtml) type.
        :param pulumi.Input[builtins.int] source_port: The source port to use in a `PathAnalyzerTest` resource.
        """
        pulumi.set(__self__, "type", type)
...
if not MYPY:
    class PathAnalysiQueryOptionsArgsDict(TypedDict):
        is_bi_directional_analysis: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class PathAnalysiQueryOptionsArgs:
    def __init__(__self__, *,
                 is_bi_directional_analysis: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] is_bi_directional_analysis: If true, a path analysis is done for both the forward and reverse routes.
        """
    ...
    def is_bi_directional_analysis(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        If true, a path analysis is done for both the forward and reverse routes.
        """
    ...
    def is_bi_directional_analysis(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class PathAnalyzerTestDestinationEndpointArgs:
    def __init__(__self__, *,
                 ...
                 vnic_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] type: (Updatable) The type of the `Endpoint`.
        :param pulumi.Input[builtins.str] address: (Updatable) The IPv4 address of the COMPUTE_INSTANCE-type `Endpoint` object.
        :param pulumi.Input[builtins.str] instance_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compute instance.
        :param pulumi.Input[builtins.str] listener_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the network load balancer listener.
        :param pulumi.Input[builtins.str] load_balancer_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the listener's load balancer.
        :param pulumi.Input[builtins.str] network_load_balancer_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the listener's network load balancer.
        :param pulumi.Input[builtins.str] state: The current state of the `PathAnalyzerTest` resource.
        :param pulumi.Input[builtins.str] subnet_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the subnet containing the IP address. This can be used to disambiguate which subnet is intended, in case the IP address is used in more than one subnet (when there are subnets with overlapping IP ranges).
        :param pulumi.Input[builtins.str] vlan_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VLAN containing the IP address. This can be used to disambiguate which VLAN is queried, in case the endpoint IP address belongs to more than one VLAN (when there are VLANs with overlapping IP ranges).
        :param pulumi.Input[builtins.str] vnic_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VNIC attached to the compute instance.
        """
        pulumi.set(__self__, "type", type)
        if address is not None:
            pulumi.set(__self__, "address", address)
...
class PathAnalyzerTestProtocolParametersArgs:
    def __init__(__self__, *,
                 ...
                 source_port: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.str] type: (Updatable) The type of the `ProtocolParameters` object.
        :param pulumi.Input[builtins.int] destination_port: (Updatable) The destination port to use in a `PathAnalyzerTest` resource.
        :param pulumi.Input[builtins.int] icmp_code: (Updatable) The [ICMP](https://www.iana.org/assignments/icmp-parameters/icmp-parameters.xhtml) code.
        :param pulumi.Input[builtins.int] icmp_type: (Updatable) The [ICMP](https://www.iana.org/assignments/icmp-parameters/icmp-parameters.xhtml) type.
        :param pulumi.Input[builtins.int] source_port: (Updatable) The source port to use in a `PathAnalyzerTest` resource.
        """
        pulumi.set(__self__, "type", type)
        if destination_port is not None:
            pulumi.set(__self__, "destination_port", destination_port)
...
class PathAnalyzerTestQueryOptionsArgs:
    def __init__(__self__, *,
                 is_bi_directional_analysis: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] is_bi_directional_analysis: (Updatable) If true, a path analysis is done for both the forward and reverse routes.
        """
        if is_bi_directional_analysis is not None:
            pulumi.set(__self__, "is_bi_directional_analysis", is_bi_directional_analysis)
