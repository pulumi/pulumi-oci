...
class GetPathAnalyzerTestResult:
    ...
    def path_analyzer_test_id(self) -> _builtins.str:
...
def get_path_analyzer_test(path_analyzer_test_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str path_analyzer_test_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `PathAnalyzerTest` resource.
    """
    __args__ = dict()
