...
class GetPathAnalyzerTestResult:
    ...
    def path_analyzer_test_id(self) -> builtins.str:
...
def get_path_analyzer_test(path_analyzer_test_id: Optional[builtins.str] = None,
    ...
    :param builtins.str path_analyzer_test_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `PathAnalyzerTest` resource.
    """
    __args__ = dict()
...
def get_path_analyzer_test_output(path_analyzer_test_id: Optional[pulumi.Input[builtins.str]] = None,
