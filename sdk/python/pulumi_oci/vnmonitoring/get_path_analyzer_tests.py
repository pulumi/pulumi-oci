...
def get_path_analyzer_tests(compartment_id: Optional[str] = None,
    ...
    test_path_analyzer_tests = oci.VnMonitoring.get_path_analyzer_tests(compartment_id=%!v(PANIC=Format method: runtime error: invalid memory address or nil pointer dereference),
    ...
    return AwaitableGetPathAnalyzerTestsResult(
        ...
        id=__ret__.id,
        path_analyzer_test_collections=__ret__.path_analyzer_test_collections,
        state=__ret__.state)
