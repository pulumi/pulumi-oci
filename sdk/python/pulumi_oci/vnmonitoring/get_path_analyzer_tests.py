...
def get_path_analyzer_tests(compartment_id: Optional[builtins.str] = None,
...
def get_path_analyzer_tests_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
