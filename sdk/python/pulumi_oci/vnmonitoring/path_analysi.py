...
class PathAnalysi(pulumi.CustomResource):
    ...
    def __init__(__self__,
        ...
        test_path_analysi = oci.vn_monitoring.PathAnalysi("testPathAnalysi",
            ...
            destination_endpoint=oci.vn.monitoring.PathAnalysiDestinationEndpointArgs(
            ...
            protocol_parameters=oci.vn.monitoring.PathAnalysiProtocolParametersArgs(
            ...
            query_options=oci.vn.monitoring.PathAnalysiQueryOptionsArgs(
                is_bi_directional_analysis=var["path_analysi_query_options_is_bi_directional_analysis"],
            ),
            source_endpoint=oci.vn.monitoring.PathAnalysiSourceEndpointArgs(
