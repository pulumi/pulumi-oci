...
class PathAnalysiArgs:
    def __init__(__self__, *,
                 ...
                 path_analyzer_test_id: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] type: The type of the `PathAnalysis` query.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] cache_control: The Cache-Control HTTP header holds directives (instructions) for caching in both requests and responses.
        :param pulumi.Input[builtins.str] compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) for the compartment.
        ...
        :param pulumi.Input[builtins.str] path_analyzer_test_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `PathAnalyzerTest` resource.
        :param pulumi.Input[builtins.int] protocol: The IP protocol to used for the path analysis.
    ...
    def path_analyzer_test_id(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def path_analyzer_test_id(self, value: Optional[pulumi.Input[builtins.str]]):
...
class PathAnalysi(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            query_options: Optional[pulumi.Input[Union['PathAnalysiQueryOptionsArgs', 'PathAnalysiQueryOptionsArgsDict']]] = None,
            source_endpoint: Optional[pulumi.Input[Union['PathAnalysiSourceEndpointArgs', 'PathAnalysiSourceEndpointArgsDict']]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None) -> 'PathAnalysi':
        """
    ...
    @property
    @pulumi.getter(name="cacheControl")
    def cache_control(self) -> pulumi.Output[builtins.str]:
        """
        The Cache-Control HTTP header holds directives (instructions) for caching in both requests and responses.
        """
        return pulumi.get(self, "cache_control")
    ...
    @property
    @pulumi.getter(name="pathAnalyzerTestId")
    def path_analyzer_test_id(self) -> pulumi.Output[builtins.str]:
        """
        The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the `PathAnalyzerTest` resource.
        """
        return pulumi.get(self, "path_analyzer_test_id")
