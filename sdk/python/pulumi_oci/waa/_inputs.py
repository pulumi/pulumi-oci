...
if not MYPY:
    class AppAccelerationPolicyResponseCachingPolicyArgsDict(TypedDict):
        is_response_header_based_caching_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class AppAccelerationPolicyResponseCachingPolicyArgs:
    def __init__(__self__, *,
                 is_response_header_based_caching_enabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        :param pulumi.Input[builtins.bool] is_response_header_based_caching_enabled: (Updatable) When false, responses will not be cached by the backend based on response headers.
    ...
    def is_response_header_based_caching_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) When false, responses will not be cached by the backend based on response headers.
    ...
    def is_response_header_based_caching_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class AppAccelerationPolicyResponseCompressionPolicyGzipCompressionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.bool] is_enabled: (Updatable) When true, support for gzip compression is enabled. HTTP responses will be compressed with gzip only if the client indicates support for gzip via the "Accept-Encoding: gzip" request header.
