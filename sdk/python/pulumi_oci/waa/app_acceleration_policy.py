...
class AppAccelerationPolicyArgs:
    def __init__(__self__, *,
                 ...
                 response_caching_policy: pulumi.Input[Optional['AppAccelerationPolicyResponseCachingPolicyArgs']] = None,
                 response_compression_policy: pulumi.Input[Optional['AppAccelerationPolicyResponseCompressionPolicyArgs']] = None,
        ...
        :param pulumi.Input[_builtins.str] display_name: (Updatable) WebAppAccelerationPolicy display name, can be renamed.
    ...
    def response_caching_policy(self) -> pulumi.Input[Optional['AppAccelerationPolicyResponseCachingPolicyArgs']]:
        """
    ...
    def response_caching_policy(self, value: pulumi.Input[Optional['AppAccelerationPolicyResponseCachingPolicyArgs']]):
        pulumi.set(self, "response_caching_policy", value)

    @_builtins.property
    @pulumi.getter(name="responseCompressionPolicy")
    def response_compression_policy(self) -> pulumi.Input[Optional['AppAccelerationPolicyResponseCompressionPolicyArgs']]:
        """
    ...
    def response_compression_policy(self, value: pulumi.Input[Optional['AppAccelerationPolicyResponseCompressionPolicyArgs']]):
...
class _AppAccelerationPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AppAccelerationPolicyResponseCompressionPolicyArgs'] response_compression_policy: (Updatable) An object that specifies a compression policy for HTTP response from ENABLEMENT POINT to the client.
               ...
               HTTP responses will only be compressed if the client indicates support for one of the enabled compression algorithms via the "Accept-Encoding" request header.
        :param pulumi.Input[_builtins.str] state: The current state of the WebAppAccelerationPolicy.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] system_tags: (Updatable) Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[_builtins.str] time_created: The time the WebAppAccelerationPolicy was created. An RFC3339 formatted datetime string.
        :param pulumi.Input[_builtins.str] time_updated: The time the WebAppAccelerationPolicy was updated. An RFC3339 formatted datetime string.
        """
...
class AppAccelerationPolicy(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 display_name: pulumi.Input[Optional[_builtins.str]] = None,
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 response_caching_policy: pulumi.Input[Optional[Union['AppAccelerationPolicyResponseCachingPolicyArgs', 'AppAccelerationPolicyResponseCachingPolicyArgsDict', 'outputs.AppAccelerationPolicyResponseCachingPolicy']]] = None,
                 response_compression_policy: pulumi.Input[Optional[Union['AppAccelerationPolicyResponseCompressionPolicyArgs', 'AppAccelerationPolicyResponseCompressionPolicyArgsDict', 'outputs.AppAccelerationPolicyResponseCompressionPolicy']]] = None,
                 system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[_builtins.str] display_name: (Updatable) WebAppAccelerationPolicy display name, can be renamed.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param pulumi.Input[Union['AppAccelerationPolicyResponseCachingPolicyArgs', 'AppAccelerationPolicyResponseCachingPolicyArgsDict', 'outputs.AppAccelerationPolicyResponseCachingPolicy']] response_caching_policy: (Updatable) An object that specifies an HTTP response caching policy.
        :param pulumi.Input[Union['AppAccelerationPolicyResponseCompressionPolicyArgs', 'AppAccelerationPolicyResponseCompressionPolicyArgsDict', 'outputs.AppAccelerationPolicyResponseCompressionPolicy']] response_compression_policy: (Updatable) An object that specifies a compression policy for HTTP response from ENABLEMENT POINT to the client.
    ...
    def get(resource_name: str,
            ...
            system_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None,
            time_updated: pulumi.Input[Optional[_builtins.str]] = None) -> 'AppAccelerationPolicy':
        """
