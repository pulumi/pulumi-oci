...
class GetAppAccelerationResult:
    ...
    def web_app_acceleration_id(self) -> _builtins.str:
...
def get_app_acceleration(web_app_acceleration_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str web_app_acceleration_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the WebAppAcceleration.
    """
    __args__ = dict()
...
def get_app_acceleration_output(web_app_acceleration_id: Optional[pulumi.Input[_builtins.str]] = None,
                                opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAppAccelerationResult]:
    """
    This data source provides details about a specific Web App Acceleration resource in Oracle Cloud Infrastructure Waa service.
    ...
    __ret__ = pulumi.runtime.invoke_output('oci:Waa/getAppAcceleration:getAppAcceleration', __args__, opts=opts, typ=GetAppAccelerationResult)
    return __ret__.apply(lambda __response__: GetAppAccelerationResult(
        ...
        web_app_acceleration_id=pulumi.get(__response__, 'web_app_acceleration_id'),
