...
class GetAppAccelerationResult:
    ...
    def web_app_acceleration_id(self) -> builtins.str:
...
def get_app_acceleration(web_app_acceleration_id: Optional[builtins.str] = None,
    ...
    :param builtins.str web_app_acceleration_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the WebAppAcceleration.
    """
    __args__ = dict()
...
def get_app_acceleration_output(web_app_acceleration_id: Optional[pulumi.Input[builtins.str]] = None,
