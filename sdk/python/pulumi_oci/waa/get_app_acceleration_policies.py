...
def get_app_acceleration_policies(compartment_id: Optional[_builtins.str] = None,
                                  display_name: Optional[_builtins.str] = None,
                                  filters: Optional[Sequence[Union['GetAppAccelerationPoliciesFilterArgs', 'GetAppAccelerationPoliciesFilterArgsDict', 'outputs.GetAppAccelerationPoliciesFilterResult']]] = None,
    ...
    :param _builtins.str id: A filter to return only the WebAppAccelerationPolicy with the given [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
...
def get_app_acceleration_policies_output(compartment_id: pulumi.Input[Optional[_builtins.str]] = None,
                                         display_name: pulumi.Input[Optional[Optional[_builtins.str]]] = None,
                                         filters: pulumi.Input[Optional[Optional[Sequence[Union['GetAppAccelerationPoliciesFilterArgs', 'GetAppAccelerationPoliciesFilterArgsDict', 'outputs.GetAppAccelerationPoliciesFilterResult']]]]] = None,
