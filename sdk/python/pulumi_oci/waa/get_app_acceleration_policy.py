...
class GetAppAccelerationPolicyResult:
    ...
    def web_app_acceleration_policy_id(self) -> builtins.str:
...
def get_app_acceleration_policy(web_app_acceleration_policy_id: Optional[builtins.str] = None,
    ...
    :param builtins.str web_app_acceleration_policy_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the WebAppAccelerationPolicy.
    """
    __args__ = dict()
...
def get_app_acceleration_policy_output(web_app_acceleration_policy_id: Optional[pulumi.Input[builtins.str]] = None,
