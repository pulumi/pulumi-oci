...
class GetAppAccelerationsResult:
    ...
    def web_app_acceleration_policy_id(self) -> Optional[builtins.str]:
        """
...
def get_app_accelerations(compartment_id: Optional[builtins.str] = None,
                          ...
                          web_app_acceleration_policy_id: Optional[builtins.str] = None,
    ...
    :param builtins.str id: A filter to return only the WebAppAcceleration with the given [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
    :param Sequence[builtins.str] states: A filter to return only resources that match the given lifecycleState.
    :param builtins.str web_app_acceleration_policy_id: A filter to return only the WebAppAcceleration with the given [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of related WebAppAccelerationPolicy.
    """
    __args__ = dict()
...
def get_app_accelerations_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                                 ...
                                 web_app_acceleration_policy_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
