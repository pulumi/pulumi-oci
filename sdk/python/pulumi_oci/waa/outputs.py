...
class AppAccelerationPolicyResponseCachingPolicy(dict):
    ...
    def __init__(__self__, *,
                 is_response_header_based_caching_enabled: Optional[builtins.bool] = None):
        """
        :param builtins.bool is_response_header_based_caching_enabled: (Updatable) When false, responses will not be cached by the backend based on response headers.
    ...
    def is_response_header_based_caching_enabled(self) -> Optional[builtins.bool]:
        """
...
class AppAccelerationPolicyResponseCompressionPolicyGzipCompression(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool is_enabled: (Updatable) When true, support for gzip compression is enabled. HTTP responses will be compressed with gzip only if the client indicates support for gzip via the "Accept-Encoding: gzip" request header.
...
class GetAppAccelerationPoliciesWebAppAccelerationPolicyCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str time_created: The time the WebAppAccelerationPolicy was created. An RFC3339 formatted datetime string.
        :param builtins.str time_updated: The time the WebAppAccelerationPolicy was updated. An RFC3339 formatted datetime string.
        """
...
class GetAppAccelerationPoliciesWebAppAccelerationPolicyCollectionItemResponseCachingPolicyResult(dict):
    def __init__(__self__, *,
                 is_response_header_based_caching_enabled: builtins.bool):
        """
        :param builtins.bool is_response_header_based_caching_enabled: When false, responses will not be cached by the backend based on response headers.
        """
        pulumi.set(__self__, "is_response_header_based_caching_enabled", is_response_header_based_caching_enabled)

    @property
    @pulumi.getter(name="isResponseHeaderBasedCachingEnabled")
    def is_response_header_based_caching_enabled(self) -> builtins.bool:
        """
...
class GetAppAccelerationPoliciesWebAppAccelerationPolicyCollectionItemResponseCompressionPolicyGzipCompressionResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.bool is_enabled: When true, support for gzip compression is enabled. HTTP responses will be compressed with gzip only if the client indicates support for gzip via the "Accept-Encoding: gzip" request header.
        """
        pulumi.set(__self__, "is_enabled", is_enabled)
...
class GetAppAccelerationsWebAppAccelerationCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 time_created: builtins.str,
                 time_updated: builtins.str,
                 web_app_acceleration_policy_id: builtins.str):
        """
        ...
        :param builtins.str lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in FAILED state.
        :param builtins.str load_balancer_id: LoadBalancer [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to which the WebAppAccelerationPolicy is attached to.
        :param builtins.str state: A filter to return only resources that match the given lifecycleState.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The time the WebAppAcceleration was created. An RFC3339 formatted datetime string.
        :param builtins.str time_updated: The time the WebAppAcceleration was updated. An RFC3339 formatted datetime string.
