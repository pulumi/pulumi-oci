...
class AddressListArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] addresses: (Updatable) A list of IP addresses or CIDR notations.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which to create the address list.
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name for the address list.
...
class _AddressListState:
    def __init__(__self__, *,
                 address_count: Optional[pulumi.Input[builtins.float]] = None,
        ...
        :param pulumi.Input[builtins.float] address_count: The total number of unique IP addresses in the address list.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] addresses: (Updatable) A list of IP addresses or CIDR notations.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which to create the address list.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name for the address list.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}` 
               ...
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] state: The current lifecycle state of the address list.
        :param pulumi.Input[builtins.str] time_created: The date and time the address list was created, expressed in RFC 3339 timestamp format.
        """
    ...
    def address_count(self) -> Optional[pulumi.Input[builtins.float]]:
        """
    ...
    def address_count(self, value: Optional[pulumi.Input[builtins.float]]):
...
class AddressList(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            state: Optional[pulumi.Input[builtins.str]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None) -> 'AddressList':
        """
    ...
    @property
    @pulumi.getter(name="addressCount")
    def address_count(self) -> pulumi.Output[builtins.float]:
        """
        The total number of unique IP addresses in the address list.
        """
        return pulumi.get(self, "address_count")
