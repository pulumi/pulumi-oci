...
class CertificateArgs:
    def __init__(__self__, *,
                 certificate_data: pulumi.Input[builtins.str],
                 compartment_id: pulumi.Input[builtins.str],
                 private_key_data: pulumi.Input[builtins.str],
                 defined_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 display_name: Optional[pulumi.Input[builtins.str]] = None,
                 freeform_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
                 is_trust_verification_disabled: Optional[pulumi.Input[builtins.bool]] = None):
        """
        The set of arguments for constructing a Certificate resource.
        :param pulumi.Input[builtins.str] certificate_data: The data of the SSL certificate.
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which to create the SSL certificate.
        :param pulumi.Input[builtins.str] private_key_data: The private key of the SSL certificate.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name for the SSL certificate. The name can be changed and does not need to be unique.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.bool] is_trust_verification_disabled: Set to `true` if the SSL certificate is self-signed.
        """
    ...
    def certificate_data(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def certificate_data(self, value: pulumi.Input[builtins.str]):
    ...
    def private_key_data(self) -> pulumi.Input[builtins.str]:
        """
    ...
    def private_key_data(self, value: pulumi.Input[builtins.str]):
    ...
    def is_trust_verification_disabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
    ...
    def is_trust_verification_disabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
class _CertificateState:
    def __init__(__self__, *,
                 ...
                 private_key_data: Optional[pulumi.Input[builtins.str]] = None,
                 ...
                 time_not_valid_after: Optional[pulumi.Input[builtins.str]] = None,
                 time_not_valid_before: Optional[pulumi.Input[builtins.str]] = None,
        ...
        :param pulumi.Input[builtins.str] serial_number: A unique, positive integer assigned by the Certificate Authority (CA). The issuer name and serial number identify a unique certificate.
        :param pulumi.Input[builtins.str] signature_algorithm: The identifier for the cryptographic algorithm used by the Certificate Authority (CA) to sign this certificate.
        :param pulumi.Input[builtins.str] state: The current lifecycle state of the SSL certificate.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time the certificate was created, expressed in RFC 3339 timestamp format.
        :param pulumi.Input[builtins.str] time_not_valid_after: The date and time the certificate will expire, expressed in RFC 3339 timestamp format.
        :param pulumi.Input[builtins.str] time_not_valid_before: The date and time the certificate will become valid, expressed in RFC 3339 timestamp format.
        :param pulumi.Input[builtins.int] version: The version of the encoded certificate.
        """
    ...
    @property
    @pulumi.getter(name="privateKeyData")
    def private_key_data(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        The private key of the SSL certificate.
    ...
    @private_key_data.setter
    def private_key_data(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "private_key_data", value)
    ...
    def time_not_valid_after(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_not_valid_after(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "time_not_valid_after", value)

    @property
    @pulumi.getter(name="timeNotValidBefore")
    def time_not_valid_before(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    def time_not_valid_before(self, value: Optional[pulumi.Input[builtins.str]]):
...
class Certificate(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_not_valid_after: Optional[pulumi.Input[builtins.str]] = None,
            time_not_valid_before: Optional[pulumi.Input[builtins.str]] = None,
            version: Optional[pulumi.Input[builtins.int]] = None) -> 'Certificate':
        """
    ...
    @property
    @pulumi.getter(name="isTrustVerificationDisabled")
    def is_trust_verification_disabled(self) -> pulumi.Output[builtins.bool]:
        """
        Set to `true` if the SSL certificate is self-signed.
        """
        return pulumi.get(self, "is_trust_verification_disabled")
    ...
    @property
    @pulumi.getter(name="privateKeyData")
    def private_key_data(self) -> pulumi.Output[builtins.str]:
        """
        The private key of the SSL certificate.
    ...
    @property
    @pulumi.getter(name="timeNotValidAfter")
    def time_not_valid_after(self) -> pulumi.Output[builtins.str]:
        """
        The date and time the certificate will expire, expressed in RFC 3339 timestamp format.
        """
        return pulumi.get(self, "time_not_valid_after")
    ...
    @property
    @pulumi.getter(name="timeNotValidBefore")
    def time_not_valid_before(self) -> pulumi.Output[builtins.str]:
        """
        The date and time the certificate will become valid, expressed in RFC 3339 timestamp format.
        """
        return pulumi.get(self, "time_not_valid_before")
