...
class GetAddressListResult:
    ...
    def address_count(self) -> builtins.float:
        """
...
def get_address_list(address_list_id: Optional[builtins.str] = None,
    ...
    :param builtins.str address_list_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the address list. This number is generated when the address list is added to the compartment.
    """
    __args__ = dict()
...
def get_address_list_output(address_list_id: Optional[pulumi.Input[builtins.str]] = None,
