...
class GetAddressListResult:
    ...
    def address_list_id(self) -> _builtins.str:
...
def get_address_list(address_list_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str address_list_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the address list. This number is generated when the address list is added to the compartment.
    """
    __args__ = dict()
