...
def get_address_lists(compartment_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment. This number is generated when the compartment is created.
    :param Sequence[_builtins.str] ids: Filter address lists using a list of address lists OCIDs.
    :param Sequence[_builtins.str] names: Filter address lists using a list of names.
    :param Sequence[_builtins.str] states: Filter address lists using a list of lifecycle states.
    :param _builtins.str time_created_greater_than_or_equal_to: A filter that matches address lists created on or after the specified date-time.
    :param _builtins.str time_created_less_than: A filter that matches address lists created before the specified date-time.
    """
    __args__ = dict()
...
def get_address_lists_output(compartment_id: Optional[pulumi.Input[_builtins.str]] = None,
