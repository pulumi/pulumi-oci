...
def get_address_lists(compartment_id: Optional[builtins.str] = None,
    ...
    :param builtins.str compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment. This number is generated when the compartment is created.
    :param Sequence[builtins.str] ids: Filter address lists using a list of address lists OCIDs.
    :param Sequence[builtins.str] names: Filter address lists using a list of names.
    :param Sequence[builtins.str] states: Filter address lists using a list of lifecycle states.
    :param builtins.str time_created_greater_than_or_equal_to: A filter that matches address lists created on or after the specified date-time.
    :param builtins.str time_created_less_than: A filter that matches address lists created before the specified date-time.
    """
    __args__ = dict()
...
def get_address_lists_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
                             ...
                             opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetAddressListsResult]:
    """
    This data source provides the list of Address Lists in Oracle Cloud Infrastructure Web Application Acceleration and Security service.
