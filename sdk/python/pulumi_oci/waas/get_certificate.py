...
class GetCertificateResult:
    ...
    def is_trust_verification_disabled(self) -> builtins.bool:
        """
    ...
    def time_not_valid_after(self) -> builtins.str:
        """
    ...
    def time_not_valid_before(self) -> builtins.str:
        """
...
def get_certificate(certificate_id: Optional[builtins.str] = None,
    ...
    :param builtins.str certificate_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the SSL certificate used in the WAAS policy. This number is generated when the certificate is added to the policy.
    """
    __args__ = dict()
