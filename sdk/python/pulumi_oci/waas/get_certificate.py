...
def get_certificate(certificate_id: Optional[str] = None,
    ...
    return AwaitableGetCertificateResult(
        ...
        id=__ret__.id,
        is_trust_verification_disabled=__ret__.is_trust_verification_disabled,
        issued_by=__ret__.issued_by,
        issuer_names=__ret__.issuer_names,
        private_key_data=__ret__.private_key_data,
        public_key_infos=__ret__.public_key_infos,
        ...
        time_not_valid_before=__ret__.time_not_valid_before,
