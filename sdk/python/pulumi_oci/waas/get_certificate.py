...
class GetCertificateResult:
    ...
    def certificate_data(self) -> _builtins.str:
        """
    ...
    def is_trust_verification_disabled(self) -> _builtins.bool:
        """
    ...
    def issued_by(self) -> _builtins.str:
    ...
    def private_key_data(self) -> _builtins.str:
    ...
    def time_not_valid_before(self) -> _builtins.str:
        """
...
def get_certificate(certificate_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str certificate_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the SSL certificate used in the WAAS policy. This number is generated when the certificate is added to the policy.
    """
    __args__ = dict()
