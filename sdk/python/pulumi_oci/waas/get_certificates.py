...
def get_certificates(compartment_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] display_names: Filter certificates using a list of display names.
    :param Sequence[_builtins.str] ids: Filter certificates using a list of certificates OCIDs.
    :param Sequence[_builtins.str] states: Filter certificates using a list of lifecycle states.
    :param _builtins.str time_created_greater_than_or_equal_to: A filter that matches certificates created on or after the specified date-time.
    :param _builtins.str time_created_less_than: A filter that matches certificates created before the specified date-time.
    """
    __args__ = dict()
