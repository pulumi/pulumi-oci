...
class GetCustomProtectionRuleResult:
    ...
    def custom_protection_rule_id(self) -> _builtins.str:
...
def get_custom_protection_rule(custom_protection_rule_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str custom_protection_rule_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the custom protection rule. This number is generated when the custom protection rule is added to the compartment.
    """
    __args__ = dict()
