...
class GetCustomProtectionRuleResult:
    ...
    def custom_protection_rule_id(self) -> builtins.str:
...
def get_custom_protection_rule(custom_protection_rule_id: Optional[builtins.str] = None,
    ...
    :param builtins.str custom_protection_rule_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the custom protection rule. This number is generated when the custom protection rule is added to the compartment.
    """
    __args__ = dict()
...
def get_custom_protection_rule_output(custom_protection_rule_id: Optional[pulumi.Input[builtins.str]] = None,
