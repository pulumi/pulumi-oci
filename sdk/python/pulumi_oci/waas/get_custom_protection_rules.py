...
def get_custom_protection_rules(compartment_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] display_names: Filter custom protection rules using a list of display names.
    :param Sequence[builtins.str] ids: Filter custom protection rules using a list of custom protection rule OCIDs.
    :param Sequence[builtins.str] states: Filter Custom Protection rules using a list of lifecycle states.
    :param builtins.str time_created_greater_than_or_equal_to: A filter that matches Custom Protection rules created on or after the specified date-time.
    :param builtins.str time_created_less_than: A filter that matches custom protection rules created before the specified date-time.
    """
    __args__ = dict()
...
def get_custom_protection_rules_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
