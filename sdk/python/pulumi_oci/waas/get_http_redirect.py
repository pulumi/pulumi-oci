...
class GetHttpRedirectResult:
    ...
    def http_redirect_id(self) -> builtins.str:
...
def get_http_redirect(http_redirect_id: Optional[builtins.str] = None,
    ...
    :param builtins.str http_redirect_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the HTTP Redirect.
    """
    __args__ = dict()
...
def get_http_redirect_output(http_redirect_id: Optional[pulumi.Input[builtins.str]] = None,
