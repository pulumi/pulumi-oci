...
def get_http_redirects(compartment_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] display_names: Filter redirects using a display name.
    :param Sequence[builtins.str] ids: Filter redirects using a list of redirect OCIDs.
    :param Sequence[builtins.str] states: Filter redirects using a list of lifecycle states.
    :param builtins.str time_created_greater_than_or_equal_to: A filter that matches redirects created on or after the specified date and time.
    :param builtins.str time_created_less_than: A filter that matches redirects created before the specified date-time. Default to 1 day before now.
    """
    __args__ = dict()
...
def get_http_redirects_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
