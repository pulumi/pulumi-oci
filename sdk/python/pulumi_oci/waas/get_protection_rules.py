...
class GetProtectionRulesResult:
    ...
    def mod_security_rule_ids(self) -> Optional[Sequence[builtins.str]]:
...
def get_protection_rules(actions: Optional[Sequence[builtins.str]] = None,
                         filters: Optional[Sequence[Union['GetProtectionRulesFilterArgs', 'GetProtectionRulesFilterArgsDict']]] = None,
                         mod_security_rule_ids: Optional[Sequence[builtins.str]] = None,
    ...
    :param Sequence[builtins.str] actions: Filter rules using a list of actions.
    :param Sequence[builtins.str] mod_security_rule_ids: Filter rules using a list of ModSecurity rule IDs.
...
def get_protection_rules_output(actions: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
                                filters: Optional[pulumi.Input[Optional[Sequence[Union['GetProtectionRulesFilterArgs', 'GetProtectionRulesFilterArgsDict']]]]] = None,
                                mod_security_rule_ids: Optional[pulumi.Input[Optional[Sequence[builtins.str]]]] = None,
