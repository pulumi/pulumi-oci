...
class GetProtectionRulesResult:
    ...
    def mod_security_rule_ids(self) -> Optional[Sequence[_builtins.str]]:
...
def get_protection_rules(actions: Optional[Sequence[_builtins.str]] = None,
    ...
    :param Sequence[_builtins.str] actions: Filter rules using a list of actions.
    :param Sequence[_builtins.str] mod_security_rule_ids: Filter rules using a list of ModSecurity rule IDs.
