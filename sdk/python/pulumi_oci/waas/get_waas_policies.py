...
def get_waas_policies(compartment_id: Optional[_builtins.str] = None,
    ...
    :param Sequence[_builtins.str] display_names: Filter policies using a list of display names.
    :param Sequence[_builtins.str] ids: Filter policies using a list of policy OCIDs.
    :param Sequence[_builtins.str] states: Filter policies using a list of lifecycle states.
    :param _builtins.str time_created_greater_than_or_equal_to: A filter that matches policies created on or after the specified date and time.
    :param _builtins.str time_created_less_than: A filter that matches policies created before the specified date-time.
    """
    __args__ = dict()
