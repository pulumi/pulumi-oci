...
def get_waas_policies(compartment_id: Optional[builtins.str] = None,
    ...
    :param Sequence[builtins.str] display_names: Filter policies using a list of display names.
    :param Sequence[builtins.str] ids: Filter policies using a list of policy OCIDs.
    :param Sequence[builtins.str] states: Filter policies using a list of lifecycle states.
    :param builtins.str time_created_greater_than_or_equal_to: A filter that matches policies created on or after the specified date and time.
    :param builtins.str time_created_less_than: A filter that matches policies created before the specified date-time.
    """
    __args__ = dict()
...
def get_waas_policies_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    return __ret__.apply(lambda __response__: GetWaasPoliciesResult(
        ...
        waas_policies=pulumi.get(__response__, 'waas_policies')))
