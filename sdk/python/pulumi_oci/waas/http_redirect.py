...
class HttpRedirectArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.int] response_code: (Updatable) The response code returned for the redirect to the client. For more information, see [RFC 7231](https://tools.ietf.org/html/rfc7231#section-6.4).
        """
...
class _HttpRedirectState:
    def __init__(__self__, *,
                 ...
                 target: pulumi.Input[Optional['HttpRedirectTargetArgs']] = None,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[_builtins.int] response_code: (Updatable) The response code returned for the redirect to the client. For more information, see [RFC 7231](https://tools.ietf.org/html/rfc7231#section-6.4).
        :param pulumi.Input[_builtins.str] state: The current lifecycle state of the HTTP Redirect.
        :param pulumi.Input['HttpRedirectTargetArgs'] target: (Updatable) The redirect target object including all the redirect data.
    ...
    @_builtins.property
    @pulumi.getter
    def target(self) -> pulumi.Input[Optional['HttpRedirectTargetArgs']]:
        """
        (Updatable) The redirect target object including all the redirect data.
        """
        return pulumi.get(self, "target")
    ...
    @target.setter
    def target(self, value: pulumi.Input[Optional['HttpRedirectTargetArgs']]):
        pulumi.set(self, "target", value)
...
class HttpRedirect(pulumi.CustomResource):
    ...
    def __init__(__self__,
                 ...
                 freeform_tags: pulumi.Input[Optional[Mapping[str, pulumi.Input[_builtins.str]]]] = None,
                 response_code: pulumi.Input[Optional[_builtins.int]] = None,
                 target: pulumi.Input[Optional[Union['HttpRedirectTargetArgs', 'HttpRedirectTargetArgsDict', 'outputs.HttpRedirectTarget']]] = None,
                 __props__=None):
        """
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] freeform_tags: (Updatable) Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[_builtins.int] response_code: (Updatable) The response code returned for the redirect to the client. For more information, see [RFC 7231](https://tools.ietf.org/html/rfc7231#section-6.4).
        :param pulumi.Input[Union['HttpRedirectTargetArgs', 'HttpRedirectTargetArgsDict', 'outputs.HttpRedirectTarget']] target: (Updatable) The redirect target object including all the redirect data.
        """
        ...
    @overload
    def __init__(__self__,
    ...
    def get(resource_name: str,
            ...
            state: pulumi.Input[Optional[_builtins.str]] = None,
            target: pulumi.Input[Optional[Union['HttpRedirectTargetArgs', 'HttpRedirectTargetArgsDict', 'outputs.HttpRedirectTarget']]] = None,
            time_created: pulumi.Input[Optional[_builtins.str]] = None) -> 'HttpRedirect':
        """
    ...
    @_builtins.property
    @pulumi.getter(name="responseCode")
    def response_code(self) -> pulumi.Output[_builtins.int]:
        """
        (Updatable) The response code returned for the redirect to the client. For more information, see [RFC 7231](https://tools.ietf.org/html/rfc7231#section-6.4).
        """
        return pulumi.get(self, "response_code")
