...
class CertificateExtension(dict):
    ...
    def __init__(__self__, *,
                 is_critical: Optional[builtins.bool] = None,
                 name: Optional[builtins.str] = None,
                 value: Optional[builtins.str] = None):
        """
        :param builtins.bool is_critical: The critical flag of the extension. Critical extensions must be processed, non-critical extensions can be ignored.
        :param builtins.str name: The certificate extension name.
        :param builtins.str value: The certificate extension value.
        """
    ...
    def is_critical(self) -> Optional[builtins.bool]:
        """
...
class CertificateIssuerName(dict):
    ...
    def __init__(__self__, *,
                 ...
                 state_province: Optional[builtins.str] = None):
        """
        :param builtins.str common_name: The fully qualified domain name used for DNS lookups of the server.
        :param builtins.str country: ISO 3166-1 alpha-2 code of the country where the organization is located. For a list of codes, see [ISO's website](https://www.iso.org/obp/ui/#search/code/).
        :param builtins.str email_address: The email address of the server's administrator.
        :param builtins.str locality: The city in which the organization is located.
        :param builtins.str organization: The organization name.
        :param builtins.str organizational_unit: The field to differentiate between divisions within an organization.
        :param builtins.str state_province: The province where the organization is located.
        """
    ...
    def state_province(self) -> Optional[builtins.str]:
        """
...
class CertificatePublicKeyInfo(dict):
    ...
    def __init__(__self__, *,
                 ...
                 exponent: Optional[builtins.int] = None,
                 key_size: Optional[builtins.int] = None):
        """
        :param builtins.str algorithm: The algorithm identifier and parameters for the public key.
        :param builtins.int exponent: The private key exponent.
        :param builtins.int key_size: The number of bits in a key used by a cryptographic algorithm.
        """
    ...
    @property
    @pulumi.getter
    def exponent(self) -> Optional[builtins.int]:
        """
...
class HttpRedirectTarget(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str host: (Updatable) The host portion of the redirect.
        ...
        :param builtins.str protocol: (Updatable) The protocol used for the target, http or https.
        ...
        :param builtins.int port: (Updatable) Port number of the target destination of the redirect, default to match protocol
        """
...
class PolicyOrigin(dict):
    ...
    def __init__(__self__, *,
        ...
        """
        :param builtins.str uri: (Updatable) The URI of the origin. Does not support paths. Port numbers should be specified in the `httpPort` and `httpsPort` fields.
        :param Sequence['PolicyOriginCustomHeaderArgs'] custom_headers: (Updatable) A list of HTTP headers to forward to your origin.
        :param builtins.int http_port: (Updatable) The HTTP port on the origin that the web application listens on. If unspecified, defaults to `80`. If `0` is specified - the origin is not used for HTTP traffic.
        :param builtins.int https_port: (Updatable) The HTTPS port on the origin that the web application listens on. If unspecified, defaults to `443`. If `0` is specified - the origin is not used for HTTPS traffic.
        """
...
class PolicyOriginCustomHeader(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str name: (Updatable) The name of the header.
        :param builtins.str value: (Updatable) The value of the header.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class PolicyOriginGroupOriginGroup(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str origin: The key in the map of origins referencing the origin used for the Web Application Firewall. The origin must already be included in `Origins`. Required when creating the `WafConfig` resource, but not on update.
        """
...
class PolicyPolicyConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 cipher_group: Optional[builtins.str] = None,
                 client_address_header: Optional[builtins.str] = None,
                 health_checks: Optional['outputs.PolicyPolicyConfigHealthChecks'] = None,
                 is_behind_cdn: Optional[builtins.bool] = None,
                 is_cache_control_respected: Optional[builtins.bool] = None,
                 is_https_enabled: Optional[builtins.bool] = None,
                 is_https_forced: Optional[builtins.bool] = None,
                 is_origin_compression_enabled: Optional[builtins.bool] = None,
                 is_response_buffering_enabled: Optional[builtins.bool] = None,
                 is_sni_enabled: Optional[builtins.bool] = None,
                 ...
                 websocket_path_prefixes: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str certificate_id: (Updatable) The OCID of the SSL certificate to use if HTTPS is supported.
        :param builtins.str cipher_group: (Updatable) The set cipher group for the configured TLS protocol. This sets the configuration for the TLS connections between clients and edge nodes only.
        ...
        :param builtins.str client_address_header: (Updatable) Specifies an HTTP header name which is treated as the connecting client's IP address. Applicable only if `isBehindCdn` is enabled.
        ...
        :param builtins.bool is_behind_cdn: (Updatable) Enabling `isBehindCdn` allows for the collection of IP addresses from client requests if the WAF is connected to a CDN.
        :param builtins.bool is_cache_control_respected: (Updatable) Enable or disable automatic content caching based on the response `cache-control` header. This feature enables the origin to act as a proxy cache. Caching is usually defined using `cache-control` header. For example `cache-control: max-age=120` means that the returned resource is valid for 120 seconds. Caching rules will overwrite this setting.
        :param builtins.bool is_https_enabled: (Updatable) Enable or disable HTTPS support. If true, a `certificateId` is required. If unspecified, defaults to `false`.
        :param builtins.bool is_https_forced: (Updatable) Force HTTP to HTTPS redirection. If unspecified, defaults to `false`.
        :param builtins.bool is_origin_compression_enabled: (Updatable) Enable or disable GZIP compression of origin responses. If enabled, the header `Accept-Encoding: gzip` is sent to origin, otherwise, the empty `Accept-Encoding:` header is used.
        :param builtins.bool is_response_buffering_enabled: (Updatable) Enable or disable buffering of responses from the origin. Buffering improves overall stability in case of network issues, but slightly increases Time To First Byte.
        :param builtins.bool is_sni_enabled: (Updatable) SNI stands for Server Name Indication and is an extension of the TLS protocol. It indicates which hostname is being contacted by the browser at the beginning of the 'handshake'-process. This allows a server to connect multiple SSL Certificates to one IP address and port.
    ...
    def cipher_group(self) -> Optional[builtins.str]:
        """
    ...
    def client_address_header(self) -> Optional[builtins.str]:
        """
    ...
    def is_behind_cdn(self) -> Optional[builtins.bool]:
        """
    ...
    def is_cache_control_respected(self) -> Optional[builtins.bool]:
        """
        (Updatable) Enable or disable automatic content caching based on the response `cache-control` header. This feature enables the origin to act as a proxy cache. Caching is usually defined using `cache-control` header. For example `cache-control: max-age=120` means that the returned resource is valid for 120 seconds. Caching rules will overwrite this setting.
        """
    ...
    def is_https_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def is_https_forced(self) -> Optional[builtins.bool]:
        """
    ...
    def is_origin_compression_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def is_response_buffering_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def is_sni_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def websocket_path_prefixes(self) -> Optional[Sequence[builtins.str]]:
        """
        (Updatable) ModSecurity is not capable to inspect WebSockets. Therefore paths specified here have WAF disabled if Connection request header from the client has the value Upgrade (case insensitive matching) and Upgrade request header has the value websocket (case insensitive matching). Paths matches if the concatenation of request URL path and query starts with the contents of the one of `websocketPathPrefixes` array value. In All other cases challenges, like JSC, HIC and etc., remain active.
        """
...
class PolicyPolicyConfigHealthChecks(dict):
    ...
    def __init__(__self__, *,
                 expected_response_code_groups: Optional[Sequence[builtins.str]] = None,
                 expected_response_text: Optional[builtins.str] = None,
                 ...
                 is_response_text_check_enabled: Optional[builtins.bool] = None,
        ...
        """
        :param Sequence[builtins.str] expected_response_code_groups: (Updatable) The HTTP response codes that signify a healthy state.
               * **2XX:** Success response code group.
               * **3XX:** Redirection response code group.
               * **4XX:** Client errors response code group.
               * **5XX:** Server errors response code group.
        :param builtins.str expected_response_text: (Updatable) Health check will search for the given text in a case-sensitive manner within the response body and will fail if the text is not found.
        :param Mapping[str, builtins.str] headers: (Updatable) HTTP header fields to include in health check requests, expressed as `"name": "value"` properties. Because HTTP header field names are case-insensitive, any use of names that are case-insensitive equal to other names will be rejected. If Host is not specified, requests will include a Host header field with value matching the policy's protected domain. If User-Agent is not specified, requests will include a User-Agent header field with value "waf health checks".
               
               **Note:** The only currently-supported header fields are Host and User-Agent.
        :param builtins.int healthy_threshold: (Updatable) Number of successful health checks after which the server is marked up.
        :param builtins.int interval_in_seconds: (Updatable) Time between health checks of an individual origin server, in seconds.
        :param builtins.bool is_enabled: (Updatable) Enables or disables the health checks.
        :param builtins.bool is_response_text_check_enabled: (Updatable) Enables or disables additional check for predefined text in addition to response code.
        :param builtins.str method: (Updatable) An HTTP verb (i.e. HEAD, GET, or POST) to use when performing the health check.
        :param builtins.str path: (Updatable) Path to visit on your origins when performing the health check.
        :param builtins.int timeout_in_seconds: (Updatable) Response timeout represents wait time until request is considered failed, in seconds.
        :param builtins.int unhealthy_threshold: (Updatable) Number of failed health checks after which the server is marked down.
        """
    ...
    def expected_response_code_groups(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def expected_response_text(self) -> Optional[builtins.str]:
        """
    ...
    def is_response_text_check_enabled(self) -> Optional[builtins.bool]:
        """
...
class PolicyPolicyConfigLoadBalancingMethod(dict):
    ...
    def __init__(__self__, *,
                 ...
                 expiration_time_in_seconds: Optional[builtins.int] = None,
                 name: Optional[builtins.str] = None):
        """
        :param builtins.str method: (Updatable) Load balancing methods are algorithms used to efficiently distribute traffic among origin servers.
        ...
        :param builtins.str domain: (Updatable) The domain for which the cookie is set, defaults to WAAS policy domain.
        :param builtins.int expiration_time_in_seconds: (Updatable) The time for which a browser should keep the cookie in seconds. Empty value will cause the cookie to expire at the end of a browser session.
        :param builtins.str name: (Updatable) The name of the cookie used to track the persistence. Can contain any US-ASCII character except separator or control character.
        """
        pulumi.set(__self__, "method", method)
    ...
    def expiration_time_in_seconds(self) -> Optional[builtins.int]:
        """
...
class PolicyWafConfig(dict):
    ...
    def __init__(__self__, *,
                 ...
                 origin_groups: Optional[Sequence[builtins.str]] = None,
    ...
    @property
    @pulumi.getter(name="originGroups")
    def origin_groups(self) -> Optional[Sequence[builtins.str]]:
        """
        (Updatable) The map of origin groups and their keys used to associate origins to the `wafConfig`. Origin groups allow you to apply weights to groups of origins for load balancing purposes. Origins with higher weights will receive larger proportions of client requests. To add additional origins to your WAAS policy, update the `origins` field of a `UpdateWaasPolicy` request.
        """
        return pulumi.get(self, "origin_groups")
...
class PolicyWafConfigAccessRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: builtins.str,
                 block_action: Optional[builtins.str] = None,
                 block_error_page_code: Optional[builtins.str] = None,
                 block_error_page_description: Optional[builtins.str] = None,
                 block_error_page_message: Optional[builtins.str] = None,
                 block_response_code: Optional[builtins.int] = None,
                 bypass_challenges: Optional[Sequence[builtins.str]] = None,
                 captcha_footer: Optional[builtins.str] = None,
                 captcha_header: Optional[builtins.str] = None,
                 captcha_submit_label: Optional[builtins.str] = None,
                 captcha_title: Optional[builtins.str] = None,
        ...
        """
        :param builtins.str action: (Updatable) The action to take when the access criteria are met for a rule. If unspecified, defaults to `ALLOW`.
        ...
        :param builtins.str name: (Updatable) The unique name of the access rule.
        :param builtins.str block_action: (Updatable) The method used to block requests if `action` is set to `BLOCK` and the access criteria are met. If unspecified, defaults to `SET_RESPONSE_CODE`.
        :param builtins.str block_error_page_code: (Updatable) The error code to show on the error page when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_ERROR_PAGE`, and the access criteria are met. If unspecified, defaults to 'Access rules'.
        :param builtins.str block_error_page_description: (Updatable) The description text to show on the error page when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_ERROR_PAGE`, and the access criteria are met. If unspecified, defaults to 'Access blocked by website owner. Please contact support.'
        :param builtins.str block_error_page_message: (Updatable) The message to show on the error page when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_ERROR_PAGE`, and the access criteria are met. If unspecified, defaults to 'Access to the website is blocked.'
        :param builtins.int block_response_code: (Updatable) The response status code to return when `action` is set to `BLOCK`, `blockAction` is set to `SET_RESPONSE_CODE`, and the access criteria are met. If unspecified, defaults to `403`. The list of available response codes: `200`, `201`, `202`, `204`, `206`, `300`, `301`, `302`, `303`, `304`, `307`, `400`, `401`, `403`, `404`, `405`, `408`, `409`, `411`, `412`, `413`, `414`, `415`, `416`, `422`, `444`, `494`, `495`, `496`, `497`, `499`, `500`, `501`, `502`, `503`, `504`, `507`.
        :param Sequence[builtins.str] bypass_challenges: (Updatable) The list of challenges to bypass when `action` is set to `BYPASS`. If unspecified or empty, all challenges are bypassed.
               * **JS_CHALLENGE:** Bypasses JavaScript Challenge.
               * **DEVICE_FINGERPRINT_CHALLENGE:** Bypasses Device Fingerprint Challenge.
               * **HUMAN_INTERACTION_CHALLENGE:** Bypasses Human Interaction Challenge.
               * **CAPTCHA:** Bypasses CAPTCHA Challenge.
        :param builtins.str captcha_footer: (Updatable) The text to show in the footer when showing a CAPTCHA challenge when `action` is set to `SHOW_CAPTCHA` and the request is challenged.
        :param builtins.str captcha_header: (Updatable) The text to show in the header when showing a CAPTCHA challenge when `action` is set to `SHOW_CAPTCHA` and the request is challenged.
        :param builtins.str captcha_submit_label: (Updatable) The text to show on the label of the CAPTCHA challenge submit button when `action` is set to `SHOW_CAPTCHA` and the request is challenged.
        :param builtins.str captcha_title: (Updatable) The title used when showing a CAPTCHA challenge when `action` is set to `SHOW_CAPTCHA` and the request is challenged.
        :param builtins.str redirect_response_code: (Updatable) The response status code to return when `action` is set to `REDIRECT`.
               * **MOVED_PERMANENTLY:** Used for designating the permanent movement of a page (numerical code - 301).
               * **FOUND:** Used for designating the temporary movement of a page (numerical code - 302).
        :param builtins.str redirect_url: (Updatable) The target to which the request should be redirected, represented as a URI reference. Required when `action` is `REDIRECT`.
    ...
    def block_action(self) -> Optional[builtins.str]:
        """
    ...
    def block_error_page_code(self) -> Optional[builtins.str]:
        """
    ...
    def block_error_page_description(self) -> Optional[builtins.str]:
        """
    ...
    def block_error_page_message(self) -> Optional[builtins.str]:
        """
    ...
    def block_response_code(self) -> Optional[builtins.int]:
        """
        (Updatable) The response status code to return when `action` is set to `BLOCK`, `blockAction` is set to `SET_RESPONSE_CODE`, and the access criteria are met. If unspecified, defaults to `403`. The list of available response codes: `200`, `201`, `202`, `204`, `206`, `300`, `301`, `302`, `303`, `304`, `307`, `400`, `401`, `403`, `404`, `405`, `408`, `409`, `411`, `412`, `413`, `414`, `415`, `416`, `422`, `444`, `494`, `495`, `496`, `497`, `499`, `500`, `501`, `502`, `503`, `504`, `507`.
        """
    ...
    def bypass_challenges(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def captcha_footer(self) -> Optional[builtins.str]:
        """
    ...
    def captcha_header(self) -> Optional[builtins.str]:
        """
    ...
    def captcha_submit_label(self) -> Optional[builtins.str]:
        """
    ...
    def captcha_title(self) -> Optional[builtins.str]:
        """
...
class PolicyWafConfigAccessRuleCriteria(dict):
    ...
    def __init__(__self__, *,
                 ...
                 value: builtins.str,
                 is_case_sensitive: Optional[builtins.bool] = None):
        """
        :param builtins.str condition: (Updatable) The criteria the access rule and JavaScript Challenge uses to determine if action should be taken on a request.
        ...
        :param builtins.str value: (Updatable) The criteria value.
        :param builtins.bool is_case_sensitive: (Updatable) When enabled, the condition will be matched with case-sensitive rules.
        """
    ...
    def is_case_sensitive(self) -> Optional[builtins.bool]:
        """
...
class PolicyWafConfigAccessRuleResponseHeaderManipulation(dict):
    def __init__(__self__, *,
                 ...
                 value: Optional[builtins.str] = None):
        """
        :param builtins.str action: (Updatable) The action can be one of these values: `ADD_HTTP_RESPONSE_HEADER`, `EXTEND_HTTP_RESPONSE_HEADER`, `REMOVE_HTTP_RESPONSE_HEADER`
        :param builtins.str header: (Updatable) A header field name that conforms to RFC 7230.  Example: `example_header_name`
        :param builtins.str value: (Updatable) A header field value that conforms to RFC 7230.  Example: `example_value`
        """
        pulumi.set(__self__, "action", action)
...
class PolicyWafConfigAddressRateLimiting(dict):
    ...
    def __init__(__self__, *,
                 ...
                 allowed_rate_per_address: Optional[builtins.int] = None,
                 block_response_code: Optional[builtins.int] = None,
                 max_delayed_count_per_address: Optional[builtins.int] = None):
        """
        :param builtins.bool is_enabled: (Updatable) Enables or disables the address rate limiting Web Application Firewall feature.
        :param builtins.int allowed_rate_per_address: (Updatable) The number of allowed requests per second from one IP address. If unspecified, defaults to `1`.
        :param builtins.int block_response_code: (Updatable) The response status code returned when a request is blocked. If unspecified, defaults to `503`. The list of available response codes: `400`, `401`, `403`, `404`, `405`, `408`, `409`, `411`, `412`, `413`, `414`, `415`, `416`, `422`, `494`, `495`, `496`, `497`, `499`, `500`, `501`, `502`, `503`, `504`, `507`.
        :param builtins.int max_delayed_count_per_address: (Updatable) The maximum number of requests allowed to be queued before subsequent requests are dropped. If unspecified, defaults to `10`.
        """
        pulumi.set(__self__, "is_enabled", is_enabled)
    ...
    def allowed_rate_per_address(self) -> Optional[builtins.int]:
        """
    ...
    def max_delayed_count_per_address(self) -> Optional[builtins.int]:
        """
...
class PolicyWafConfigCachingRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 name: builtins.str,
                 caching_duration: Optional[builtins.str] = None,
                 client_caching_duration: Optional[builtins.str] = None,
                 is_client_caching_enabled: Optional[builtins.bool] = None,
                 key: Optional[builtins.str] = None):
        """
        :param builtins.str action: (Updatable) The action to take when the criteria of a caching rule are met.
        ...
        :param builtins.str name: (Updatable) The name of the caching rule.
        :param builtins.str caching_duration: (Updatable) The duration to cache content for the caching rule, specified in ISO 8601 extended format. Supported units: seconds, minutes, hours, days, weeks, months. The maximum value that can be set for any unit is `99`. Mixing of multiple units is not supported. Only applies when the `action` is set to `CACHE`. Example: `PT1H`
        :param builtins.str client_caching_duration: (Updatable) The duration to cache content in the user's browser, specified in ISO 8601 extended format. Supported units: seconds, minutes, hours, days, weeks, months. The maximum value that can be set for any unit is `99`. Mixing of multiple units is not supported. Only applies when the `action` is set to `CACHE`. Example: `PT1H`
        :param builtins.bool is_client_caching_enabled: (Updatable) Enables or disables client caching. Browsers use the `Cache-Control` header value for caching content locally in the browser. This setting overrides the addition of a `Cache-Control` header in responses.
        :param builtins.str key: (Updatable) The unique key for the caching rule.
        """
        pulumi.set(__self__, "action", action)
        pulumi.set(__self__, "criterias", criterias)
        pulumi.set(__self__, "name", name)
    ...
    def caching_duration(self) -> Optional[builtins.str]:
        """
        (Updatable) The duration to cache content for the caching rule, specified in ISO 8601 extended format. Supported units: seconds, minutes, hours, days, weeks, months. The maximum value that can be set for any unit is `99`. Mixing of multiple units is not supported. Only applies when the `action` is set to `CACHE`. Example: `PT1H`
        """
    ...
    def client_caching_duration(self) -> Optional[builtins.str]:
        """
        (Updatable) The duration to cache content in the user's browser, specified in ISO 8601 extended format. Supported units: seconds, minutes, hours, days, weeks, months. The maximum value that can be set for any unit is `99`. Mixing of multiple units is not supported. Only applies when the `action` is set to `CACHE`. Example: `PT1H`
        """
    ...
    def is_client_caching_enabled(self) -> Optional[builtins.bool]:
        """
...
class PolicyWafConfigCachingRuleCriteria(dict):
    def __init__(__self__, *,
                 ...
                 value: builtins.str):
        """
        :param builtins.str condition: (Updatable) The condition of the caching rule criteria.
        ...
        :param builtins.str value: (Updatable) The value of the caching rule criteria.
        """
        pulumi.set(__self__, "condition", condition)
        pulumi.set(__self__, "value", value)
...
class PolicyWafConfigCaptcha(dict):
    ...
    def __init__(__self__, *,
                 ...
                 session_expiration_in_seconds: builtins.int,
        ...
        """
        :param builtins.str failure_message: (Updatable) The text to show when incorrect CAPTCHA text is entered. If unspecified, defaults to `The CAPTCHA was incorrect. Try again.`
        :param builtins.int session_expiration_in_seconds: (Updatable) The amount of time before the CAPTCHA expires, in seconds. If unspecified, defaults to `300`.
        :param builtins.str submit_label: (Updatable) The text to show on the label of the CAPTCHA challenge submit button. If unspecified, defaults to `Yes, I am human`.
        :param builtins.str title: (Updatable) The title used when displaying a CAPTCHA challenge. If unspecified, defaults to `Are you human?`
        :param builtins.str url: (Updatable) The unique URL path at which to show the CAPTCHA challenge.
        :param builtins.str footer_text: (Updatable) The text to show in the footer when showing a CAPTCHA challenge. If unspecified, defaults to 'Enter the letters and numbers as they are shown in the image above.'
        :param builtins.str header_text: (Updatable) The text to show in the header when showing a CAPTCHA challenge. If unspecified, defaults to 'We have detected an increased number of attempts to access this website. To help us keep this site secure, please let us know that you are not a robot by entering the text from the image below.'
        """
    ...
    def session_expiration_in_seconds(self) -> builtins.int:
        """
    ...
    def submit_label(self) -> builtins.str:
        """
...
class PolicyWafConfigCustomProtectionRule(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: (Updatable) The action to take when the custom protection rule is triggered. `DETECT` - Logs the request when the criteria of the custom protection rule are met. `BLOCK` - Blocks the request when the criteria of the custom protection rule are met.
        :param Sequence['PolicyWafConfigCustomProtectionRuleExclusionArgs'] exclusions: (Updatable)
        :param builtins.str id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the custom protection rule.
        """
...
class PolicyWafConfigCustomProtectionRuleExclusion(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] exclusions: (Updatable) An array of The target property of a request that would allow it to bypass the protection rule. For example, when `target` is `REQUEST_COOKIE_NAMES`, the list may include names of cookies to exclude from the protection rule. When the target is `ARGS`, the list may include strings of URL query parameters and values from form-urlencoded XML, JSON, AMP, or POST payloads to exclude from the protection rule. `Exclusions` properties must not contain whitespace, comma or |. **Note:** If protection rules have been enabled that utilize the `maxArgumentCount` or `maxTotalNameLengthOfArguments` properties, and the `target` property has been set to `ARGS`, it is important that the `exclusions` properties be defined to honor those protection rule settings in a consistent manner.
        :param builtins.str target: (Updatable) The target of the exclusion.
        """
        if exclusions is not None:
            pulumi.set(__self__, "exclusions", exclusions)
...
class PolicyWafConfigDeviceFingerprintChallenge(dict):
    ...
    def __init__(__self__, *,
                 is_enabled: builtins.bool,
                 action: Optional[builtins.str] = None,
                 action_expiration_in_seconds: Optional[builtins.int] = None,
                 ...
                 failure_threshold_expiration_in_seconds: Optional[builtins.int] = None,
                 max_address_count: Optional[builtins.int] = None,
                 max_address_count_expiration_in_seconds: Optional[builtins.int] = None):
        """
        :param builtins.bool is_enabled: (Updatable) Enables or disables the device fingerprint challenge Web Application Firewall feature.
        :param builtins.str action: (Updatable) The action to take on requests from detected bots. If unspecified, defaults to `DETECT`.
        :param builtins.int action_expiration_in_seconds: (Updatable) The number of seconds between challenges for the same IP address. If unspecified, defaults to `60`.
        ...
        :param builtins.int failure_threshold: (Updatable) The number of failed requests allowed before taking action. If unspecified, defaults to `10`.
        :param builtins.int failure_threshold_expiration_in_seconds: (Updatable) The number of seconds before the failure threshold resets. If unspecified, defaults to `60`.
        :param builtins.int max_address_count: (Updatable) The maximum number of IP addresses permitted with the same device fingerprint. If unspecified, defaults to `20`.
        :param builtins.int max_address_count_expiration_in_seconds: (Updatable) The number of seconds before the maximum addresses count resets. If unspecified, defaults to `60`.
        """
        pulumi.set(__self__, "is_enabled", is_enabled)
        if action is not None:
            pulumi.set(__self__, "action", action)
    ...
    def action_expiration_in_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def failure_threshold_expiration_in_seconds(self) -> Optional[builtins.int]:
        """
    ...
    def max_address_count(self) -> Optional[builtins.int]:
        """
    ...
    def max_address_count_expiration_in_seconds(self) -> Optional[builtins.int]:
        """
...
class PolicyWafConfigDeviceFingerprintChallengeChallengeSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 captcha_title: Optional[builtins.str] = None):
        """
        :param builtins.str block_action: (Updatable) The method used to block requests that fail the challenge, if `action` is set to `BLOCK`. If unspecified, defaults to `SHOW_ERROR_PAGE`.
        :param builtins.str block_error_page_code: (Updatable) The error code to show on the error page when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_ERROR_PAGE` and the request is blocked. If unspecified, defaults to `403`.
        :param builtins.str block_error_page_description: (Updatable) The description text to show on the error page when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_ERROR_PAGE`, and the request is blocked. If unspecified, defaults to `Access blocked by website owner. Please contact support.`
        :param builtins.str block_error_page_message: (Updatable) The message to show on the error page when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_ERROR_PAGE`, and the request is blocked. If unspecified, defaults to `Access to the website is blocked`.
        ...
        :param builtins.str captcha_footer: (Updatable) The text to show in the footer when showing a CAPTCHA challenge when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_CAPTCHA`, and the request is blocked. If unspecified, default to `Enter the letters and numbers as they are shown in image above`.
        :param builtins.str captcha_header: (Updatable) The text to show in the header when showing a CAPTCHA challenge when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_CAPTCHA`, and the request is blocked. If unspecified, defaults to `We have detected an increased number of attempts to access this webapp. To help us keep this webapp secure, please let us know that you are not a robot by entering the text from captcha below.`
        :param builtins.str captcha_submit_label: (Updatable) The text to show on the label of the CAPTCHA challenge submit button when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_CAPTCHA`, and the request is blocked. If unspecified, defaults to `Yes, I am human`.
        :param builtins.str captcha_title: (Updatable) The title used when showing a CAPTCHA challenge when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_CAPTCHA`, and the request is blocked. If unspecified, defaults to `Are you human?`
        """
        if block_action is not None:
            pulumi.set(__self__, "block_action", block_action)
        if block_error_page_code is not None:
...
class PolicyWafConfigHumanInteractionChallenge(dict):
    ...
    def __init__(__self__, *,
                 ...
                 failure_threshold: Optional[builtins.int] = None,
                 failure_threshold_expiration_in_seconds: Optional[builtins.int] = None,
                 interaction_threshold: Optional[builtins.int] = None,
                 is_nat_enabled: Optional[builtins.bool] = None,
                 recording_period_in_seconds: Optional[builtins.int] = None,
                 set_http_header: Optional['outputs.PolicyWafConfigHumanInteractionChallengeSetHttpHeader'] = None):
        """
        :param builtins.bool is_enabled: (Updatable) Enables or disables the human interaction challenge Web Application Firewall feature.
        :param builtins.str action: (Updatable) The action to take against requests from detected bots. If unspecified, defaults to `DETECT`.
        :param builtins.int action_expiration_in_seconds: (Updatable) The number of seconds between challenges for the same IP address. If unspecified, defaults to `60`.
        ...
        :param builtins.int failure_threshold: (Updatable) The number of failed requests before taking action. If unspecified, defaults to `10`.
        :param builtins.int failure_threshold_expiration_in_seconds: (Updatable) The number of seconds before the failure threshold resets. If unspecified, defaults to  `60`.
        :param builtins.int interaction_threshold: (Updatable) The number of interactions required to pass the challenge. If unspecified, defaults to `3`.
        :param builtins.bool is_nat_enabled: (Updatable) When enabled, the user is identified not only by the IP address but also by an unique additional hash, which prevents blocking visitors with shared IP addresses.
        :param builtins.int recording_period_in_seconds: (Updatable) The number of seconds to record the interactions from the user. If unspecified, defaults to `15`.
    ...
    def interaction_threshold(self) -> Optional[builtins.int]:
        """
    ...
    def is_nat_enabled(self) -> Optional[builtins.bool]:
        """
    ...
    def recording_period_in_seconds(self) -> Optional[builtins.int]:
        """
...
class PolicyWafConfigJsChallenge(dict):
    ...
    def __init__(__self__, *,
                 ...
                 action: Optional[builtins.str] = None,
                 action_expiration_in_seconds: Optional[builtins.int] = None,
                 are_redirects_challenged: Optional[builtins.bool] = None,
        ...
        """
        :param builtins.bool is_enabled: (Updatable) Enables or disables the JavaScript challenge Web Application Firewall feature.
        :param builtins.str action: (Updatable) The action to take against requests from detected bots. If unspecified, defaults to `DETECT`.
        :param builtins.int action_expiration_in_seconds: (Updatable) The number of seconds between challenges from the same IP address. If unspecified, defaults to `60`.
        :param builtins.bool are_redirects_challenged: (Updatable) When enabled, redirect responses from the origin will also be challenged. This will change HTTP 301/302 responses from origin to HTTP 200 with an HTML body containing JavaScript page redirection.
    ...
    def are_redirects_challenged(self) -> Optional[builtins.bool]:
        """
...
class PolicyWafConfigProtectionSettings(dict):
    ...
    def __init__(__self__, *,
                 ...
                 block_error_page_message: Optional[builtins.str] = None,
                 block_response_code: Optional[builtins.int] = None,
                 is_response_inspected: Optional[builtins.bool] = None,
                 max_argument_count: Optional[builtins.int] = None,
                 max_name_length_per_argument: Optional[builtins.int] = None,
                 max_response_size_in_ki_b: Optional[builtins.int] = None,
                 max_total_name_length_of_arguments: Optional[builtins.int] = None,
                 media_types: Optional[Sequence[builtins.str]] = None,
                 recommendations_period_in_days: Optional[builtins.int] = None):
        """
        :param Sequence[builtins.str] allowed_http_methods: (Updatable) The list of allowed HTTP methods. If unspecified, default to `[OPTIONS, GET, HEAD, POST]`. This setting only applies if a corresponding protection rule is enabled, such as the "Restrict HTTP Request Methods" rule (key: 911100).
        :param builtins.str block_action: (Updatable) If `action` is set to `BLOCK`, this specifies how the traffic is blocked when detected as malicious by a protection rule. If unspecified, defaults to `SET_RESPONSE_CODE`.
        :param builtins.str block_error_page_code: (Updatable) The error code to show on the error page when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_ERROR_PAGE`, and the traffic is detected as malicious by a protection rule. If unspecified, defaults to `403`.
        :param builtins.str block_error_page_description: (Updatable) The description text to show on the error page when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_ERROR_PAGE`, and the traffic is detected as malicious by a protection rule. If unspecified, defaults to `Access blocked by website owner. Please contact support.`
        :param builtins.str block_error_page_message: (Updatable) The message to show on the error page when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_ERROR_PAGE`, and the traffic is detected as malicious by a protection rule. If unspecified, defaults to 'Access to the website is blocked.'
        ...
        :param Sequence[builtins.str] media_types: (Updatable) The list of media types to allow for inspection, if `isResponseInspected` is enabled. Only responses with MIME types in this list will be inspected. If unspecified, defaults to `["text/html", "text/plain", "text/xml"]`.
               ...
               * application/xml
               * text/xml
        :param builtins.int recommendations_period_in_days: (Updatable) The length of time to analyze traffic traffic, in days. After the analysis period, `WafRecommendations` will be populated. If unspecified, defaults to `10`.
    ...
    def is_response_inspected(self) -> Optional[builtins.bool]:
        """
    ...
    def max_argument_count(self) -> Optional[builtins.int]:
        """
        (Updatable) The maximum number of arguments allowed to be passed to your application before an action is taken. Arguements are query parameters or body parameters in a PUT or POST request. If unspecified, defaults to `255`. This setting only applies if a corresponding protection rule is enabled, such as the "Number of Arguments Limits" rule (key: 960335).  Example: If `maxArgumentCount` to `2` for the Max Number of Arguments protection rule (key: 960335), the following requests would be blocked: `GET /myapp/path?query=one&query=two&query=three` `POST /myapp/path` with Body `{"argument1":"one","argument2":"two","argument3":"three"}`
        """
    ...
    def max_name_length_per_argument(self) -> Optional[builtins.int]:
        """
    ...
    def max_response_size_in_ki_b(self) -> Optional[builtins.int]:
        """
    ...
    def max_total_name_length_of_arguments(self) -> Optional[builtins.int]:
        """
        (Updatable) The maximum length allowed for the sum of the argument name and value, in characters. Arguements are query parameters or body parameters in a PUT or POST request. If unspecified, defaults to `64000`. This setting only applies if a corresponding protection rule is enabled, such as the "Total Arguments Limits" rule (key: 960341).
        """
    ...
    def media_types(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def recommendations_period_in_days(self) -> Optional[builtins.int]:
        """
...
class PolicyWafConfigWhitelist(dict):
    ...
    def __init__(__self__, *,
                 name: builtins.str,
                 address_lists: Optional[Sequence[builtins.str]] = None,
                 addresses: Optional[Sequence[builtins.str]] = None):
        """
        :param builtins.str name: (Updatable) The unique name of the whitelist.
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param Sequence[builtins.str] address_lists: (Updatable) A list of [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of IP address lists to include in the whitelist.
        :param Sequence[builtins.str] addresses: (Updatable) A set of IP addresses or CIDR notations to include in the whitelist.
        """
        pulumi.set(__self__, "name", name)
    ...
    def address_lists(self) -> Optional[Sequence[builtins.str]]:
        """
...
class ProtectionRuleExclusion(dict):
    def __init__(__self__, *,
                 ...
                 target: Optional[builtins.str] = None):
        """
        :param Sequence[builtins.str] exclusions: An array of The target property of a request that would allow it to bypass the protection rule. For example, when `target` is `REQUEST_COOKIE_NAMES`, the list may include names of cookies to exclude from the protection rule. When the target is `ARGS`, the list may include strings of URL query parameters and values from form-urlencoded XML, JSON, AMP, or POST payloads to exclude from the protection rule. `Exclusions` properties must not contain whitespace, comma or |. **Note:** If protection rules have been enabled that utilize the `maxArgumentCount` or `maxTotalNameLengthOfArguments` properties, and the `target` property has been set to `ARGS`, it is important that the `exclusions` properties be defined to honor those protection rule settings in a consistent manner.
        :param builtins.str target: The target of the exclusion.
...
class GetAddressListsAddressListResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.float address_count: The total number of unique IP addresses in the address list.
        :param Sequence[builtins.str] addresses: The list of IP addresses or CIDR notations.
        ...
        :param builtins.str display_name: The user-friendly name of the address list.
        ...
        :param builtins.str id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the address list.
        :param builtins.str state: The current lifecycle state of the address list.
        :param builtins.str time_created: The date and time the address list was created, expressed in RFC 3339 timestamp format.
        """
...
class GetCertificateExtensionResult(dict):
    ...
    @property
    @pulumi.getter(name="isCritical")
    def is_critical(self) -> builtins.bool:
        """
        The critical flag of the extension. Critical extensions must be processed, non-critical extensions can be ignored.
        """
        return pulumi.get(self, "is_critical")
...
class GetCertificatePublicKeyInfoResult(dict):
    ...
    @property
    @pulumi.getter
    def exponent(self) -> builtins.int:
        """
        The private key exponent.
        """
        return pulumi.get(self, "exponent")
...
class GetCertificatesCertificateResult(dict):
    def __init__(__self__, *,
                 ...
                 freeform_tags: Mapping[str, builtins.str],
                 id: builtins.str,
                 is_trust_verification_disabled: builtins.bool,
                 issued_by: builtins.str,
                 issuer_names: Sequence['outputs.GetCertificatesCertificateIssuerNameResult'],
                 private_key_data: builtins.str,
                 ...
                 time_created: builtins.str,
                 time_not_valid_after: builtins.str,
                 time_not_valid_before: builtins.str,
                 version: builtins.int):
        """
        :param builtins.str certificate_data: The data of the SSL certificate.
        :param builtins.str compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment. This number is generated when the compartment is created.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param builtins.str display_name: The user-friendly name of the SSL certificate.
        ...
        :param Mapping[str, builtins.str] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param builtins.str id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the SSL certificate.
        :param builtins.bool is_trust_verification_disabled: This indicates whether trust verification was disabled during the creation of SSL certificate. If `true` SSL certificate trust verification was disabled and this SSL certificate is most likely self-signed.
        ...
        :param builtins.str serial_number: A unique, positive integer assigned by the Certificate Authority (CA). The issuer name and serial number identify a unique certificate.
        :param builtins.str signature_algorithm: The identifier for the cryptographic algorithm used by the Certificate Authority (CA) to sign this certificate.
        :param builtins.str state: The current lifecycle state of the SSL certificate.
        :param Sequence['GetCertificatesCertificateSubjectNameArgs'] subject_names: The entity to be secured by the certificate.
        :param builtins.str time_created: The date and time the certificate was created, expressed in RFC 3339 timestamp format.
        :param builtins.str time_not_valid_after: The date and time the certificate will expire, expressed in RFC 3339 timestamp format.
        :param builtins.str time_not_valid_before: The date and time the certificate will become valid, expressed in RFC 3339 timestamp format.
        :param builtins.int version: The version of the encoded certificate.
        """
...
class GetCustomProtectionRulesCustomProtectionRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 freeform_tags: Mapping[str, builtins.str],
                 id: builtins.str,
                 mod_security_rule_ids: Sequence[builtins.str],
                 state: builtins.str,
        ...
        :param builtins.str compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment. This number is generated when the compartment is created.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param builtins.str description: The description of the custom protection rule.
        :param builtins.str display_name: The user-friendly name of the custom protection rule.
        :param Mapping[str, builtins.str] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param builtins.str id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the custom protection rule.
        :param Sequence[builtins.str] mod_security_rule_ids: The auto-generated ID for the custom protection rule. These IDs are referenced in logs.
        :param builtins.str state: The current lifecycle state of the custom protection rule.
        :param builtins.str template: The template text of the custom protection rule. All custom protection rules are expressed in ModSecurity Rule Language.
        :param builtins.str time_created: The date and time the protection rule was created, expressed in RFC 3339 timestamp format.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
...
class GetEdgeSubnetsEdgeSubnetResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str cidr: An edge node subnet. This can include /24 or /8 addresses.
        :param builtins.str region: The name of the region containing the indicated subnet.
        :param builtins.str time_modified: The date and time the last change was made to the indicated edge node subnet, expressed in RFC 3339 timestamp format.
        """
...
class GetHttpRedirectTargetResult(dict):
    def __init__(__self__, *,
                 ...
                 query: builtins.str):
        """
        :param builtins.str host: The host portion of the redirect.
        :param builtins.str path: The path component of the target URL (e.g., "/path/to/resource" in "https://target.example.com/path/to/resource?redirected"), which can be empty, static, or request-copying, or request-prefixing. Use of \\ is not permitted except to escape a following \\, {, or }. An empty value is treated the same as static "/". A static value must begin with a leading "/", optionally followed by other path characters. A request-copying value must exactly match "{path}", and will be replaced with the path component of the request URL (including its initial "/"). A request-prefixing value must start with "/" and end with a non-escaped "{path}", which will be replaced with the path component of the request URL (including its initial "/"). Only one such replacement token is allowed.
        :param builtins.int port: Port number of the target destination of the redirect, default to match protocol
        :param builtins.str protocol: The protocol used for the target, http or https.
        :param builtins.str query: The query component of the target URL (e.g., "?redirected" in "https://target.example.com/path/to/resource?redirected"), which can be empty, static, or request-copying. Use of \\ is not permitted except to escape a following \\, {, or }. An empty value results in a redirection target URL with no query component. A static value must begin with a leading "?", optionally followed by other query characters. A request-copying value must exactly match "{query}", and will be replaced with the query component of the request URL (including a leading "?" if and only if the request URL includes a query component).
        """
        pulumi.set(__self__, "host", host)
        pulumi.set(__self__, "path", path)
        pulumi.set(__self__, "port", port)
...
class GetHttpRedirectsHttpRedirectResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment. This number is generated when the compartment is created.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param builtins.str display_name: The user-friendly name of the HTTP Redirect. The name can be changed and does not need to be unique.
        :param builtins.str domain: The domain from which traffic will be redirected.
        :param Mapping[str, builtins.str] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param builtins.str id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the HTTP Redirect.
        :param builtins.int response_code: The response code returned for the redirect to the client. For more information, see [RFC 7231](https://tools.ietf.org/html/rfc7231#section-6.4).
        :param builtins.str state: The current lifecycle state of the HTTP Redirect.
        :param Sequence['GetHttpRedirectsHttpRedirectTargetArgs'] targets: The redirect target object including all the redirect data.
        :param builtins.str time_created: The date and time the policy was created, expressed in RFC 3339 timestamp format.
        """
        pulumi.set(__self__, "compartment_id", compartment_id)
        pulumi.set(__self__, "defined_tags", defined_tags)
        pulumi.set(__self__, "display_name", display_name)
...
class GetProtectionRulesProtectionRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 mod_security_rule_ids: Sequence[builtins.str],
                 name: builtins.str,
                 waas_policy_id: builtins.str):
        """
        :param builtins.str action: Filter rules using a list of actions.
        :param builtins.str description: The description of the protection rule.
        ...
        :param builtins.str key: The unique key of the protection rule.
        :param Sequence[builtins.str] labels: The list of labels for the protection rule.
        :param Sequence[builtins.str] mod_security_rule_ids: The list of the ModSecurity rule IDs that apply to this protection rule. For more information about ModSecurity's open source WAF rules, see [Mod Security's documentation](https://www.modsecurity.org/CRS/Documentation/index.html).
        :param builtins.str name: The name of the protection rule.
...
class GetWaasPoliciesWaasPolicyResult(dict):
    def __init__(__self__, *,
                 additional_domains: Sequence[builtins.str],
                 cname: builtins.str,
                 compartment_id: builtins.str,
                 defined_tags: Mapping[str, builtins.str],
                 display_name: builtins.str,
        ...
        """
        :param Sequence[builtins.str] additional_domains: An array of additional domains for this web application.
        :param builtins.str cname: The CNAME record to add to your DNS configuration to route traffic for the domain, and all additional domains, through the WAF.
        :param builtins.str compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment. This number is generated when the compartment is created.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param builtins.str display_name: The user-friendly name of the WAAS policy. The name can be changed and does not need to be unique.
        :param builtins.str domain: The domain for which the cookie is set, defaults to WAAS policy domain.
        :param Mapping[str, builtins.str] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param builtins.str id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the custom protection rule.
        ...
        :param builtins.str state: The current lifecycle state of the WAAS policy.
        :param builtins.str time_created: The date and time the policy was created, expressed in RFC 3339 timestamp format.
    ...
    def additional_domains(self) -> Sequence[builtins.str]:
        """
...
class GetWaasPoliciesWaasPolicyOriginResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.int http_port: The HTTP port on the origin that the web application listens on. If unspecified, defaults to `80`. If `0` is specified - the origin is not used for HTTP traffic.
        :param builtins.int https_port: The HTTPS port on the origin that the web application listens on. If unspecified, defaults to `443`. If `0` is specified - the origin is not used for HTTPS traffic.
        :param builtins.str uri: The URI of the origin. Does not support paths. Port numbers should be specified in the `httpPort` and `httpsPort` fields.
        """
        pulumi.set(__self__, "custom_headers", custom_headers)
        pulumi.set(__self__, "http_port", http_port)
        pulumi.set(__self__, "https_port", https_port)
...
class GetWaasPoliciesWaasPolicyPolicyConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 cipher_group: builtins.str,
                 client_address_header: builtins.str,
                 health_checks: Sequence['outputs.GetWaasPoliciesWaasPolicyPolicyConfigHealthCheckResult'],
                 is_behind_cdn: builtins.bool,
                 is_cache_control_respected: builtins.bool,
                 is_https_enabled: builtins.bool,
                 is_https_forced: builtins.bool,
                 is_origin_compression_enabled: builtins.bool,
                 is_response_buffering_enabled: builtins.bool,
                 is_sni_enabled: builtins.bool,
                 load_balancing_methods: Sequence['outputs.GetWaasPoliciesWaasPolicyPolicyConfigLoadBalancingMethodResult'],
                 tls_protocols: Sequence[builtins.str],
                 websocket_path_prefixes: Sequence[builtins.str]):
        """
        :param builtins.str certificate_id: The OCID of the SSL certificate to use if HTTPS is supported.
        :param builtins.str cipher_group: The set cipher group for the configured TLS protocol. This sets the configuration for the TLS connections between clients and edge nodes only.
               * **DEFAULT:** Cipher group supports TLS 1.0, TLS 1.1, TLS 1.2, TLS 1.3 protocols. It has the following ciphers enabled: `ECDHE-RSA-AES128-GCM-SHA256:ECDHE-ECDSA-AES128-GCM-SHA256:ECDHE-RSA-AES256-GCM-SHA384:ECDHE-ECDSA-AES256-GCM-SHA384:DHE-RSA-AES128-GCM-SHA256:DHE-DSS-AES128-GCM-SHA256:kEDH+AESGCM:ECDHE-RSA-AES128-SHA256:ECDHE-ECDSA-AES128-SHA256:ECDHE-RSA-AES128-SHA:ECDHE-ECDSA-AES128-SHA:ECDHE-RSA-AES256-SHA384:ECDHE-ECDSA-AES256-SHA384:ECDHE-RSA-AES256-SHA:ECDHE-ECDSA-AES256-SHA:DHE-RSA-AES128-SHA256:DHE-RSA-AES128-SHA:DHE-DSS-AES128-SHA256:DHE-RSA-AES256-SHA256:DHE-DSS-AES256-SHA:DHE-RSA-AES256-SHA:AES128-GCM-SHA256:AES256-GCM-SHA384:AES128-SHA256:AES256-SHA256:AES128-SHA:AES256-SHA:AES:CAMELLIA:!DES-CBC3-SHA:!aNULL:!eNULL:!EXPORT:!DES:!RC4:!MD5:!PSK:!aECDH:!EDH-DSS-DES-CBC3-SHA:!EDH-RSA-DES-CBC3-SHA:!KRB5-DES-CBC3-SHA`
        :param builtins.str client_address_header: Specifies an HTTP header name which is treated as the connecting client's IP address. Applicable only if `isBehindCdn` is enabled.
        ...
        :param builtins.bool is_behind_cdn: Enabling `isBehindCdn` allows for the collection of IP addresses from client requests if the WAF is connected to a CDN.
        :param builtins.bool is_cache_control_respected: Enable or disable automatic content caching based on the response `cache-control` header. This feature enables the origin to act as a proxy cache. Caching is usually defined using `cache-control` header. For example `cache-control: max-age=120` means that the returned resource is valid for 120 seconds. Caching rules will overwrite this setting.
        :param builtins.bool is_https_enabled: Enable or disable HTTPS support. If true, a `certificateId` is required. If unspecified, defaults to `false`.
        :param builtins.bool is_https_forced: Force HTTP to HTTPS redirection. If unspecified, defaults to `false`.
        :param builtins.bool is_origin_compression_enabled: Enable or disable GZIP compression of origin responses. If enabled, the header `Accept-Encoding: gzip` is sent to origin, otherwise, the empty `Accept-Encoding:` header is used.
        :param builtins.bool is_response_buffering_enabled: Enable or disable buffering of responses from the origin. Buffering improves overall stability in case of network issues, but slightly increases Time To First Byte.
        :param builtins.bool is_sni_enabled: SNI stands for Server Name Indication and is an extension of the TLS protocol. It indicates which hostname is being contacted by the browser at the beginning of the 'handshake'-process. This allows a server to connect multiple SSL Certificates to one IP address and port.
        ...
        :param Sequence[builtins.str] tls_protocols: A list of allowed TLS protocols. Only applicable when HTTPS support is enabled. The TLS protocol is negotiated while the request is connecting and the most recent protocol supported by both the edge node and client browser will be selected. If no such version exists, the connection will be aborted.
               * **TLS_V1:** corresponds to TLS 1.0 specification.
               * **TLS_V1_1:** corresponds to TLS 1.1 specification.
               * **TLS_V1_2:** corresponds to TLS 1.2 specification.
               * **TLS_V1_3:** corresponds to TLS 1.3 specification.
    ...
    @property
    @pulumi.getter(name="cipherGroup")
    def cipher_group(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="clientAddressHeader")
    def client_address_header(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="isBehindCdn")
    def is_behind_cdn(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="isCacheControlRespected")
    def is_cache_control_respected(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="isHttpsForced")
    def is_https_forced(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="isOriginCompressionEnabled")
    def is_origin_compression_enabled(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="isResponseBufferingEnabled")
    def is_response_buffering_enabled(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="isSniEnabled")
    def is_sni_enabled(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="websocketPathPrefixes")
    def websocket_path_prefixes(self) -> Sequence[builtins.str]:
        """
        ModSecurity is not capable to inspect WebSockets. Therefore paths specified here have WAF disabled if Connection request header from the client has the value Upgrade (case insensitive matching) and Upgrade request header has the value websocket (case insensitive matching). Paths matches if the concatenation of request URL path and query starts with the contents of the one of `websocketPathPrefixes` array value. In All other cases challenges, like JSC, HIC and etc., remain active.
        """
        return pulumi.get(self, "websocket_path_prefixes")
...
class GetWaasPoliciesWaasPolicyPolicyConfigHealthCheckResult(dict):
    def __init__(__self__, *,
                 expected_response_code_groups: Sequence[builtins.str],
                 expected_response_text: builtins.str,
                 headers: Mapping[str, builtins.str],
                 healthy_threshold: builtins.int,
                 interval_in_seconds: builtins.int,
                 is_enabled: builtins.bool,
                 is_response_text_check_enabled: builtins.bool,
                 method: builtins.str,
                 path: builtins.str,
                 timeout_in_seconds: builtins.int,
                 unhealthy_threshold: builtins.int):
        """
        :param Sequence[builtins.str] expected_response_code_groups: The HTTP response codes that signify a healthy state.
               * **2XX:** Success response code group.
               * **3XX:** Redirection response code group.
               * **4XX:** Client errors response code group.
               * **5XX:** Server errors response code group.
        :param builtins.str expected_response_text: Health check will search for the given text in a case-sensitive manner within the response body and will fail if the text is not found.
        :param Mapping[str, builtins.str] headers: HTTP header fields to include in health check requests, expressed as `"name": "value"` properties. Because HTTP header field names are case-insensitive, any use of names that are case-insensitive equal to other names will be rejected. If Host is not specified, requests will include a Host header field with value matching the policy's protected domain. If User-Agent is not specified, requests will include a User-Agent header field with value "waf health checks".
        :param builtins.int healthy_threshold: Number of successful health checks after which the server is marked up.
        :param builtins.int interval_in_seconds: Time between health checks of an individual origin server, in seconds.
        :param builtins.bool is_enabled: Enables or disables the JavaScript challenge Web Application Firewall feature.
        :param builtins.bool is_response_text_check_enabled: Enables or disables additional check for predefined text in addition to response code.
        :param builtins.str method: Load balancing methods are algorithms used to efficiently distribute traffic among origin servers.
               * **[IP_HASH](https://www.terraform.io/iaas/api/#/en/waas/latest/datatypes/IPHashLoadBalancingMethod):** All the incoming requests from the same client IP address should go to the same content origination server. IP_HASH load balancing method uses origin weights when choosing which origin should the hash be assigned to initially.
               * **[ROUND_ROBIN](https://www.terraform.io/iaas/api/#/en/waas/latest/datatypes/RoundRobinLoadBalancingMethod):** Forwards requests sequentially to the available origin servers. The first request - to the first origin server, the second request - to the next origin server, and so on. After it sends a request to the last origin server, it starts again with the first origin server. When using weights on origins, Weighted Round Robin assigns more requests to origins with a greater weight. Over a period of time, origins will receive a number of requests in proportion to their weight.
               * **[STICKY_COOKIE](https://www.terraform.io/iaas/api/#/en/waas/latest/datatypes/StickyCookieLoadBalancingMethod):** Adds a session cookie to the first response from the origin server and identifies the server that sent the response. The client's next request contains the cookie value, and nginx routes the request to the origin server that responded to the first request. STICKY_COOKIE load balancing method falls back to Round Robin for the first request.
        :param builtins.str path: Path to visit on your origins when performing the health check.
        :param builtins.int timeout_in_seconds: Response timeout represents wait time until request is considered failed, in seconds.
        :param builtins.int unhealthy_threshold: Number of failed health checks after which the server is marked down.
        """
        pulumi.set(__self__, "expected_response_code_groups", expected_response_code_groups)
        pulumi.set(__self__, "expected_response_text", expected_response_text)
        pulumi.set(__self__, "headers", headers)
    ...
    @property
    @pulumi.getter(name="expectedResponseCodeGroups")
    def expected_response_code_groups(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="expectedResponseText")
    def expected_response_text(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="isResponseTextCheckEnabled")
    def is_response_text_check_enabled(self) -> builtins.bool:
        """
...
class GetWaasPoliciesWaasPolicyPolicyConfigLoadBalancingMethodResult(dict):
    def __init__(__self__, *,
                 domain: builtins.str,
                 expiration_time_in_seconds: builtins.int,
                 method: builtins.str,
                 name: builtins.str):
        """
        :param builtins.str domain: The domain for which the cookie is set, defaults to WAAS policy domain.
        :param builtins.int expiration_time_in_seconds: The time for which a browser should keep the cookie in seconds. Empty value will cause the cookie to expire at the end of a browser session.
        :param builtins.str method: Load balancing methods are algorithms used to efficiently distribute traffic among origin servers.
               * **[IP_HASH](https://www.terraform.io/iaas/api/#/en/waas/latest/datatypes/IPHashLoadBalancingMethod):** All the incoming requests from the same client IP address should go to the same content origination server. IP_HASH load balancing method uses origin weights when choosing which origin should the hash be assigned to initially.
               * **[ROUND_ROBIN](https://www.terraform.io/iaas/api/#/en/waas/latest/datatypes/RoundRobinLoadBalancingMethod):** Forwards requests sequentially to the available origin servers. The first request - to the first origin server, the second request - to the next origin server, and so on. After it sends a request to the last origin server, it starts again with the first origin server. When using weights on origins, Weighted Round Robin assigns more requests to origins with a greater weight. Over a period of time, origins will receive a number of requests in proportion to their weight.
               * **[STICKY_COOKIE](https://www.terraform.io/iaas/api/#/en/waas/latest/datatypes/StickyCookieLoadBalancingMethod):** Adds a session cookie to the first response from the origin server and identifies the server that sent the response. The client's next request contains the cookie value, and nginx routes the request to the origin server that responded to the first request. STICKY_COOKIE load balancing method falls back to Round Robin for the first request.
    ...
    @property
    @pulumi.getter(name="expirationTimeInSeconds")
    def expiration_time_in_seconds(self) -> builtins.int:
        """
...
class GetWaasPoliciesWaasPolicyWafConfigResult(dict):
    def __init__(__self__, *,
                 ...
                 origin: builtins.str,
                 origin_groups: Sequence[builtins.str],
    ...
    @property
    @pulumi.getter(name="originGroups")
    def origin_groups(self) -> Sequence[builtins.str]:
        """
        The map of origin groups and their keys used to associate origins to the `wafConfig`. Origin groups allow you to apply weights to groups of origins for load balancing purposes. Origins with higher weights will receive larger proportions of client requests. To add additional origins to your WAAS policy, update the `origins` field of a `UpdateWaasPolicy` request.
        """
        return pulumi.get(self, "origin_groups")
...
class GetWaasPoliciesWaasPolicyWafConfigAccessRuleResult(dict):
    def __init__(__self__, *,
                 action: builtins.str,
                 block_action: builtins.str,
                 block_error_page_code: builtins.str,
                 block_error_page_description: builtins.str,
                 block_error_page_message: builtins.str,
                 block_response_code: builtins.int,
                 bypass_challenges: Sequence[builtins.str],
                 captcha_footer: builtins.str,
                 captcha_header: builtins.str,
                 captcha_submit_label: builtins.str,
                 captcha_title: builtins.str,
        ...
        """
        :param builtins.str action: The action to take against requests from detected bots. If unspecified, defaults to `DETECT`.
        :param builtins.str block_action: If `action` is set to `BLOCK`, this specifies how the traffic is blocked when detected as malicious by a protection rule. If unspecified, defaults to `SET_RESPONSE_CODE`.
        :param builtins.str block_error_page_code: The error code to show on the error page when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_ERROR_PAGE`, and the traffic is detected as malicious by a protection rule. If unspecified, defaults to `403`.
        :param builtins.str block_error_page_description: The description text to show on the error page when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_ERROR_PAGE`, and the traffic is detected as malicious by a protection rule. If unspecified, defaults to `Access blocked by website owner. Please contact support.`
        :param builtins.str block_error_page_message: The message to show on the error page when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_ERROR_PAGE`, and the traffic is detected as malicious by a protection rule. If unspecified, defaults to 'Access to the website is blocked.'
        :param builtins.int block_response_code: The response code returned when `action` is set to `BLOCK`, `blockAction` is set to `SET_RESPONSE_CODE`, and the traffic is detected as malicious by a protection rule. If unspecified, defaults to `403`. The list of available response codes: `400`, `401`, `403`, `405`, `409`, `411`, `412`, `413`, `414`, `415`, `416`, `500`, `501`, `502`, `503`, `504`, `507`.
        :param Sequence[builtins.str] bypass_challenges: The list of challenges to bypass when `action` is set to `BYPASS`. If unspecified or empty, all challenges are bypassed.
               * **JS_CHALLENGE:** Bypasses JavaScript Challenge.
               * **DEVICE_FINGERPRINT_CHALLENGE:** Bypasses Device Fingerprint Challenge.
               * **HUMAN_INTERACTION_CHALLENGE:** Bypasses Human Interaction Challenge.
               * **CAPTCHA:** Bypasses CAPTCHA Challenge.
        :param builtins.str captcha_footer: The text to show in the footer when showing a CAPTCHA challenge when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_CAPTCHA`, and the request is blocked. If unspecified, default to `Enter the letters and numbers as they are shown in image above`.
        :param builtins.str captcha_header: The text to show in the header when showing a CAPTCHA challenge when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_CAPTCHA`, and the request is blocked. If unspecified, defaults to `We have detected an increased number of attempts to access this webapp. To help us keep this webapp secure, please let us know that you are not a robot by entering the text from captcha below.`
        :param builtins.str captcha_submit_label: The text to show on the label of the CAPTCHA challenge submit button when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_CAPTCHA`, and the request is blocked. If unspecified, defaults to `Yes, I am human`.
        :param builtins.str captcha_title: The title used when showing a CAPTCHA challenge when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_CAPTCHA`, and the request is blocked. If unspecified, defaults to `Are you human?`
        ...
        :param builtins.str name: The unique name of the whitelist.
        :param builtins.str redirect_response_code: The response status code to return when `action` is set to `REDIRECT`.
               * **MOVED_PERMANENTLY:** Used for designating the permanent movement of a page (numerical code - 301).
               * **FOUND:** Used for designating the temporary movement of a page (numerical code - 302).
        :param builtins.str redirect_url: The target to which the request should be redirected, represented as a URI reference. Required when `action` is `REDIRECT`.
    ...
    @property
    @pulumi.getter(name="blockAction")
    def block_action(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="blockErrorPageCode")
    def block_error_page_code(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="blockErrorPageDescription")
    def block_error_page_description(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="blockErrorPageMessage")
    def block_error_page_message(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="blockResponseCode")
    def block_response_code(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="bypassChallenges")
    def bypass_challenges(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="captchaFooter")
    def captcha_footer(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="captchaHeader")
    def captcha_header(self) -> builtins.str:
        """
        The text to show in the header when showing a CAPTCHA challenge when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_CAPTCHA`, and the request is blocked. If unspecified, defaults to `We have detected an increased number of attempts to access this webapp. To help us keep this webapp secure, please let us know that you are not a robot by entering the text from captcha below.`
        """
        return pulumi.get(self, "captcha_header")
    ...
    @property
    @pulumi.getter(name="captchaSubmitLabel")
    def captcha_submit_label(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="captchaTitle")
    def captcha_title(self) -> builtins.str:
        """
...
class GetWaasPoliciesWaasPolicyWafConfigAccessRuleCriteriaResult(dict):
    def __init__(__self__, *,
                 condition: builtins.str,
                 is_case_sensitive: builtins.bool,
                 value: builtins.str):
        """
        :param builtins.str condition: The criteria the access rule and JavaScript Challenge uses to determine if action should be taken on a request.
               * **URL_IS:** Matches if the concatenation of request URL path and query is identical to the contents of the `value` field. URL must start with a `/`.
               * **URL_IS_NOT:** Matches if the concatenation of request URL path and query is not identical to the contents of the `value` field. URL must start with a `/`.
               * **URL_STARTS_WITH:** Matches if the concatenation of request URL path and query starts with the contents of the `value` field. URL must start with a `/`.
               * **URL_PART_ENDS_WITH:** Matches if the concatenation of request URL path and query ends with the contents of the `value` field.
               ...
               * **HTTP_HEADER_CONTAINS:** The HTTP_HEADER_CONTAINS criteria is defined using a compound value separated by a colon: a header field name and a header field value. `host:test.example.com` is an example of a criteria value where `host` is the header field name and `test.example.com` is the header field value. A request matches when the header field name is a case insensitive match and the header field value is a case insensitive, substring match. *Example:* With a criteria value of `host:test.example.com`, where `host` is the name of the field and `test.example.com` is the value of the host field, a request with the header values, `Host: www.test.example.com` will match, where as a request with header values of `host: www.example.com` or `host: test.sub.example.com` will not match.
               * **HTTP_METHOD_IS:** Matches if the request method is identical to one of the values listed in field. The `value` in this case is string with one or multiple HTTP methods separated by new line symbol \\n The list of available methods: `GET`, `HEAD`, `POST`, `PUT`, `DELETE`, `CONNECT`, `OPTIONS`, `TRACE`, `PATCH`
        :param builtins.bool is_case_sensitive: When enabled, the condition will be matched with case-sensitive rules.
        :param builtins.str value: The value of the header.
        """
        pulumi.set(__self__, "condition", condition)
        pulumi.set(__self__, "is_case_sensitive", is_case_sensitive)
    ...
    @property
    @pulumi.getter(name="isCaseSensitive")
    def is_case_sensitive(self) -> builtins.bool:
        """
...
class GetWaasPoliciesWaasPolicyWafConfigAccessRuleResponseHeaderManipulationResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action: The action to take against requests from detected bots. If unspecified, defaults to `DETECT`.
        :param builtins.str header: A header field name that conforms to RFC 7230.  Example: `example_header_name`
        :param builtins.str value: The value of the header.
        """
        pulumi.set(__self__, "action", action)
        pulumi.set(__self__, "header", header)
...
class GetWaasPoliciesWaasPolicyWafConfigAddressRateLimitingResult(dict):
    def __init__(__self__, *,
                 allowed_rate_per_address: builtins.int,
                 block_response_code: builtins.int,
                 is_enabled: builtins.bool,
                 max_delayed_count_per_address: builtins.int):
        """
        :param builtins.int allowed_rate_per_address: The number of allowed requests per second from one IP address. If unspecified, defaults to `1`.
        :param builtins.int block_response_code: The response code returned when `action` is set to `BLOCK`, `blockAction` is set to `SET_RESPONSE_CODE`, and the traffic is detected as malicious by a protection rule. If unspecified, defaults to `403`. The list of available response codes: `400`, `401`, `403`, `405`, `409`, `411`, `412`, `413`, `414`, `415`, `416`, `500`, `501`, `502`, `503`, `504`, `507`.
        :param builtins.bool is_enabled: Enables or disables the JavaScript challenge Web Application Firewall feature.
        :param builtins.int max_delayed_count_per_address: The maximum number of requests allowed to be queued before subsequent requests are dropped. If unspecified, defaults to `10`.
        """
        pulumi.set(__self__, "allowed_rate_per_address", allowed_rate_per_address)
        pulumi.set(__self__, "block_response_code", block_response_code)
        pulumi.set(__self__, "is_enabled", is_enabled)
    ...
    @property
    @pulumi.getter(name="allowedRatePerAddress")
    def allowed_rate_per_address(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="maxDelayedCountPerAddress")
    def max_delayed_count_per_address(self) -> builtins.int:
        """
...
class GetWaasPoliciesWaasPolicyWafConfigCachingRuleResult(dict):
    def __init__(__self__, *,
                 action: builtins.str,
                 caching_duration: builtins.str,
                 client_caching_duration: builtins.str,
                 criterias: Sequence['outputs.GetWaasPoliciesWaasPolicyWafConfigCachingRuleCriteriaResult'],
                 is_client_caching_enabled: builtins.bool,
                 key: builtins.str,
                 name: builtins.str):
        """
        :param builtins.str action: The action to take against requests from detected bots. If unspecified, defaults to `DETECT`.
        :param builtins.str caching_duration: The duration to cache content for the caching rule, specified in ISO 8601 extended format. Supported units: seconds, minutes, hours, days, weeks, months. The maximum value that can be set for any unit is `99`. Mixing of multiple units is not supported. Only applies when the `action` is set to `CACHE`. Example: `PT1H`
        ...
        :param builtins.bool is_client_caching_enabled: Enables or disables client caching. Browsers use the `Cache-Control` header value for caching content locally in the browser. This setting overrides the addition of a `Cache-Control` header in responses.
        :param builtins.str key: The unique key for the caching rule.
        :param builtins.str name: The unique name of the whitelist.
        """
        pulumi.set(__self__, "action", action)
        pulumi.set(__self__, "caching_duration", caching_duration)
    ...
    @property
    @pulumi.getter(name="cachingDuration")
    def caching_duration(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="clientCachingDuration")
    def client_caching_duration(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="isClientCachingEnabled")
    def is_client_caching_enabled(self) -> builtins.bool:
        """
...
class GetWaasPoliciesWaasPolicyWafConfigCaptchaResult(dict):
    def __init__(__self__, *,
                 failure_message: builtins.str,
                 footer_text: builtins.str,
                 header_text: builtins.str,
                 session_expiration_in_seconds: builtins.int,
                 submit_label: builtins.str,
                 title: builtins.str,
                 url: builtins.str):
        """
        :param builtins.str failure_message: The text to show when incorrect CAPTCHA text is entered. If unspecified, defaults to `The CAPTCHA was incorrect. Try again.`
        :param builtins.str footer_text: The text to show in the footer when showing a CAPTCHA challenge. If unspecified, defaults to 'Enter the letters and numbers as they are shown in the image above.'
        :param builtins.str header_text: The text to show in the header when showing a CAPTCHA challenge. If unspecified, defaults to 'We have detected an increased number of attempts to access this website. To help us keep this site secure, please let us know that you are not a robot by entering the text from the image below.'
        :param builtins.int session_expiration_in_seconds: The amount of time before the CAPTCHA expires, in seconds. If unspecified, defaults to `300`.
        :param builtins.str submit_label: The text to show on the label of the CAPTCHA challenge submit button. If unspecified, defaults to `Yes, I am human`.
        :param builtins.str title: The title used when displaying a CAPTCHA challenge. If unspecified, defaults to `Are you human?`
        :param builtins.str url: The unique URL path at which to show the CAPTCHA challenge.
        """
        pulumi.set(__self__, "failure_message", failure_message)
        pulumi.set(__self__, "footer_text", footer_text)
        pulumi.set(__self__, "header_text", header_text)
...
class GetWaasPoliciesWaasPolicyWafConfigDeviceFingerprintChallengeResult(dict):
    def __init__(__self__, *,
                 action: builtins.str,
                 action_expiration_in_seconds: builtins.int,
                 ...
                 failure_threshold_expiration_in_seconds: builtins.int,
                 is_enabled: builtins.bool,
                 max_address_count: builtins.int,
                 max_address_count_expiration_in_seconds: builtins.int):
        """
        :param builtins.str action: The action to take against requests from detected bots. If unspecified, defaults to `DETECT`.
        :param builtins.int action_expiration_in_seconds: The number of seconds between challenges from the same IP address. If unspecified, defaults to `60`.
        ...
        :param builtins.int failure_threshold: The number of failed requests before taking action. If unspecified, defaults to `10`.
        :param builtins.int failure_threshold_expiration_in_seconds: The number of seconds before the failure threshold resets. If unspecified, defaults to  `60`.
        :param builtins.bool is_enabled: Enables or disables the JavaScript challenge Web Application Firewall feature.
        :param builtins.int max_address_count: The maximum number of IP addresses permitted with the same device fingerprint. If unspecified, defaults to `20`.
        :param builtins.int max_address_count_expiration_in_seconds: The number of seconds before the maximum addresses count resets. If unspecified, defaults to `60`.
        """
        pulumi.set(__self__, "action", action)
        pulumi.set(__self__, "action_expiration_in_seconds", action_expiration_in_seconds)
        pulumi.set(__self__, "challenge_settings", challenge_settings)
    ...
    @property
    @pulumi.getter(name="actionExpirationInSeconds")
    def action_expiration_in_seconds(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="failureThresholdExpirationInSeconds")
    def failure_threshold_expiration_in_seconds(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="maxAddressCount")
    def max_address_count(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="maxAddressCountExpirationInSeconds")
    def max_address_count_expiration_in_seconds(self) -> builtins.int:
        """
...
class GetWaasPoliciesWaasPolicyWafConfigHumanInteractionChallengeResult(dict):
    def __init__(__self__, *,
                 ...
                 failure_threshold: builtins.int,
                 failure_threshold_expiration_in_seconds: builtins.int,
                 interaction_threshold: builtins.int,
                 is_enabled: builtins.bool,
                 is_nat_enabled: builtins.bool,
                 recording_period_in_seconds: builtins.int,
        ...
        :param builtins.int failure_threshold: The number of failed requests before taking action. If unspecified, defaults to `10`.
        :param builtins.int failure_threshold_expiration_in_seconds: The number of seconds before the failure threshold resets. If unspecified, defaults to  `60`.
        :param builtins.int interaction_threshold: The number of interactions required to pass the challenge. If unspecified, defaults to `3`.
        :param builtins.bool is_enabled: Enables or disables the JavaScript challenge Web Application Firewall feature.
        :param builtins.bool is_nat_enabled: When enabled, the user is identified not only by the IP address but also by an unique additional hash, which prevents blocking visitors with shared IP addresses.
        :param builtins.int recording_period_in_seconds: The number of seconds to record the interactions from the user. If unspecified, defaults to `15`.
    ...
    @property
    @pulumi.getter(name="interactionThreshold")
    def interaction_threshold(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="recordingPeriodInSeconds")
    def recording_period_in_seconds(self) -> builtins.int:
        """
...
class GetWaasPoliciesWaasPolicyWafConfigJsChallengeResult(dict):
    def __init__(__self__, *,
                 action: builtins.str,
                 action_expiration_in_seconds: builtins.int,
                 are_redirects_challenged: builtins.bool,
        ...
        :param builtins.str action: The action to take against requests from detected bots. If unspecified, defaults to `DETECT`.
        :param builtins.int action_expiration_in_seconds: The number of seconds between challenges from the same IP address. If unspecified, defaults to `60`.
        :param builtins.bool are_redirects_challenged: When enabled, redirect responses from the origin will also be challenged. This will change HTTP 301/302 responses from origin to HTTP 200 with an HTML body containing JavaScript page redirection.
    ...
    @property
    @pulumi.getter(name="areRedirectsChallenged")
    def are_redirects_challenged(self) -> builtins.bool:
        """
...
class GetWaasPoliciesWaasPolicyWafConfigProtectionSettingResult(dict):
    def __init__(__self__, *,
                 ...
                 block_error_page_message: builtins.str,
                 block_response_code: builtins.int,
                 is_response_inspected: builtins.bool,
                 max_argument_count: builtins.int,
                 max_name_length_per_argument: builtins.int,
                 max_response_size_in_ki_b: builtins.int,
                 max_total_name_length_of_arguments: builtins.int,
                 media_types: Sequence[builtins.str],
                 recommendations_period_in_days: builtins.int):
        """
        :param Sequence[builtins.str] allowed_http_methods: The list of allowed HTTP methods. If unspecified, default to `[OPTIONS, GET, HEAD, POST]`. This setting only applies if a corresponding protection rule is enabled, such as the "Restrict HTTP Request Methods" rule (key: 911100).
        :param builtins.str block_action: If `action` is set to `BLOCK`, this specifies how the traffic is blocked when detected as malicious by a protection rule. If unspecified, defaults to `SET_RESPONSE_CODE`.
        :param builtins.str block_error_page_code: The error code to show on the error page when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_ERROR_PAGE`, and the traffic is detected as malicious by a protection rule. If unspecified, defaults to `403`.
        :param builtins.str block_error_page_description: The description text to show on the error page when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_ERROR_PAGE`, and the traffic is detected as malicious by a protection rule. If unspecified, defaults to `Access blocked by website owner. Please contact support.`
        :param builtins.str block_error_page_message: The message to show on the error page when `action` is set to `BLOCK`, `blockAction` is set to `SHOW_ERROR_PAGE`, and the traffic is detected as malicious by a protection rule. If unspecified, defaults to 'Access to the website is blocked.'
        :param builtins.int block_response_code: The response code returned when `action` is set to `BLOCK`, `blockAction` is set to `SET_RESPONSE_CODE`, and the traffic is detected as malicious by a protection rule. If unspecified, defaults to `403`. The list of available response codes: `400`, `401`, `403`, `405`, `409`, `411`, `412`, `413`, `414`, `415`, `416`, `500`, `501`, `502`, `503`, `504`, `507`.
        :param builtins.bool is_response_inspected: Inspects the response body of origin responses. Can be used to detect leakage of sensitive data. If unspecified, defaults to `false`.
        :param builtins.int max_argument_count: The maximum number of arguments allowed to be passed to your application before an action is taken. Arguements are query parameters or body parameters in a PUT or POST request. If unspecified, defaults to `255`. This setting only applies if a corresponding protection rule is enabled, such as the "Number of Arguments Limits" rule (key: 960335).  Example: If `maxArgumentCount` to `2` for the Max Number of Arguments protection rule (key: 960335), the following requests would be blocked: `GET /myapp/path?query=one&query=two&query=three` `POST /myapp/path` with Body `{"argument1":"one","argument2":"two","argument3":"three"}`
        :param builtins.int max_name_length_per_argument: The maximum length allowed for each argument name, in characters. Arguements are query parameters or body parameters in a PUT or POST request. If unspecified, defaults to `400`. This setting only applies if a corresponding protection rule is enabled, such as the "Values Limits" rule (key: 960208).
        :param builtins.int max_response_size_in_ki_b: The maximum response size to be fully inspected, in binary kilobytes (KiB). Anything over this limit will be partially inspected. If unspecified, defaults to `1024`.
        :param builtins.int max_total_name_length_of_arguments: The maximum length allowed for the sum of the argument name and value, in characters. Arguements are query parameters or body parameters in a PUT or POST request. If unspecified, defaults to `64000`. This setting only applies if a corresponding protection rule is enabled, such as the "Total Arguments Limits" rule (key: 960341).
        :param Sequence[builtins.str] media_types: The list of media types to allow for inspection, if `isResponseInspected` is enabled. Only responses with MIME types in this list will be inspected. If unspecified, defaults to `["text/html", "text/plain", "text/xml"]`.
        :param builtins.int recommendations_period_in_days: The length of time to analyze traffic traffic, in days. After the analysis period, `WafRecommendations` will be populated. If unspecified, defaults to `10`.
        """
        pulumi.set(__self__, "allowed_http_methods", allowed_http_methods)
        pulumi.set(__self__, "block_action", block_action)
        pulumi.set(__self__, "block_error_page_code", block_error_page_code)
    ...
    @property
    @pulumi.getter(name="isResponseInspected")
    def is_response_inspected(self) -> builtins.bool:
        """
    ...
    @property
    @pulumi.getter(name="maxArgumentCount")
    def max_argument_count(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="maxNameLengthPerArgument")
    def max_name_length_per_argument(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="maxResponseSizeInKiB")
    def max_response_size_in_ki_b(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="maxTotalNameLengthOfArguments")
    def max_total_name_length_of_arguments(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="mediaTypes")
    def media_types(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="recommendationsPeriodInDays")
    def recommendations_period_in_days(self) -> builtins.int:
        """
...
class GetWaasPoliciesWaasPolicyWafConfigWhitelistResult(dict):
    def __init__(__self__, *,
                 ...
                 name: builtins.str):
        """
        :param Sequence[builtins.str] address_lists: A list of [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of IP address lists to include in the whitelist.
        :param Sequence[builtins.str] addresses: A set of IP addresses or CIDR notations to include in the whitelist.
        :param builtins.str name: The unique name of the whitelist.
        """
        pulumi.set(__self__, "address_lists", address_lists)
        pulumi.set(__self__, "addresses", addresses)
