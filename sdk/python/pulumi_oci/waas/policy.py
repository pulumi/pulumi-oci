...
class PolicyArgs:
    def __init__(__self__, *,
                 ...
                 additional_domains: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None,
        ...
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which to create the WAAS policy.
        :param pulumi.Input[builtins.str] domain: The web application domain that the WAAS policy protects.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] additional_domains: (Updatable) An array of additional domains for the specified web application.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name for the WAAS policy. The name can be changed and does not need to be unique.
    ...
    def additional_domains(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
    ...
    def additional_domains(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
class _PolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] additional_domains: (Updatable) An array of additional domains for the specified web application.
        :param pulumi.Input[builtins.str] cname: The CNAME record to add to your DNS configuration to route traffic for the domain, and all additional domains, through the WAF.
        :param pulumi.Input[builtins.str] compartment_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which to create the WAAS policy.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: (Updatable) Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[builtins.str] display_name: (Updatable) A user-friendly name for the WAAS policy. The name can be changed and does not need to be unique.
        :param pulumi.Input[builtins.str] domain: The web application domain that the WAAS policy protects.
        ...
        :param pulumi.Input[Sequence[pulumi.Input['PolicyOriginArgs']]] origins: (Updatable) A map of host to origin for the web application. The key should be a customer friendly name for the host, ex. primary, secondary, etc.
        :param pulumi.Input['PolicyPolicyConfigArgs'] policy_config: (Updatable) The configuration details for the WAAS policy.
        :param pulumi.Input[builtins.str] state: The current lifecycle state of the WAAS policy.
...
class Policy(pulumi.CustomResource):
    ...
    @property
    @pulumi.getter(name="additionalDomains")
    def additional_domains(self) -> pulumi.Output[Sequence[builtins.str]]:
        """
        (Updatable) An array of additional domains for the specified web application.
        """
        return pulumi.get(self, "additional_domains")
