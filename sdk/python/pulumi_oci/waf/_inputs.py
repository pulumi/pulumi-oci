...
class AppFirewallPolicyActionArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: (Updatable) Action name. Can be used to reference the action.
        :param pulumi.Input[builtins.str] type: (Updatable) 
               * **CHECK** is a non-terminating action that does not stop the execution of rules in current module, just emits a log message documenting result of rule execution.
               * **ALLOW** is a non-terminating action which upon matching rule skips all remaining rules in the current module.
               * **RETURN_HTTP_RESPONSE** is a terminating action which is executed immediately, returns a defined HTTP response.
        :param pulumi.Input['AppFirewallPolicyActionBodyArgs'] body: (Updatable) Type of returned HTTP response body.
        :param pulumi.Input[builtins.int] code: (Updatable) Response code.
...
class AppFirewallPolicyActionBodyArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] type: (Updatable) Type of HttpResponseBody.
        :param pulumi.Input[builtins.str] text: (Updatable) Static response body text.
        """
        pulumi.set(__self__, "type", type)
...
class AppFirewallPolicyActionHeaderArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] name: (Updatable) The name of the header field.
        :param pulumi.Input[builtins.str] value: (Updatable) The value of the header field.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
if not MYPY:
    class AppFirewallPolicyRequestAccessControlArgsDict(TypedDict):
        default_action_name: pulumi.Input[builtins.str]
        """
...
class AppFirewallPolicyRequestAccessControlArgs:
    def __init__(__self__, *,
        ...
        """
        :param pulumi.Input[builtins.str] default_action_name: (Updatable) References an default Action to take if no AccessControlRule was matched. Allowed action types:
               * **ALLOW** continues execution of other modules and their rules.
               * **RETURN_HTTP_RESPONSE** terminates further execution of modules and rules and returns defined HTTP response.
    ...
    def default_action_name(self) -> pulumi.Input[builtins.str]:
        """
        (Updatable) References an default Action to take if no AccessControlRule was matched. Allowed action types:
        * **ALLOW** continues execution of other modules and their rules.
        * **RETURN_HTTP_RESPONSE** terminates further execution of modules and rules and returns defined HTTP response.
    ...
    def default_action_name(self, value: pulumi.Input[builtins.str]):
...
if not MYPY:
    class AppFirewallPolicyRequestAccessControlRuleArgsDict(TypedDict):
        ...
        """
        condition_language: NotRequired[pulumi.Input[builtins.str]]
        """
...
class AppFirewallPolicyRequestAccessControlRuleArgs:
    def __init__(__self__, *,
                 ...
                 condition_language: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] action_name: (Updatable) References action by name from actions defined in WebAppFirewallPolicy.
        :param pulumi.Input[builtins.str] name: (Updatable) Rule name. Must be unique within the module.
        :param pulumi.Input[builtins.str] type: (Updatable) Type of WebAppFirewallPolicyRule.
        :param pulumi.Input[builtins.str] condition: (Updatable) An expression that determines whether or not the rule action should be executed.
        :param pulumi.Input[builtins.str] condition_language: (Updatable) The language used to parse condition from field `condition`. Available languages:
               * **JMESPATH** an extended JMESPath language syntax.
        """
    ...
    def condition_language(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) The language used to parse condition from field `condition`. Available languages:
        * **JMESPATH** an extended JMESPath language syntax.
        """
    ...
    def condition_language(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "condition_language", value)


if not MYPY:
    class AppFirewallPolicyRequestProtectionArgsDict(TypedDict):
        body_inspection_size_limit_exceeded_action_name: NotRequired[pulumi.Input[builtins.str]]
        """
        ...
        * **RETURN_HTTP_RESPONSE** terminates further execution of modules and rules and returns defined HTTP response.
        """
        body_inspection_size_limit_in_bytes: NotRequired[pulumi.Input[builtins.int]]
        """
...
class AppFirewallPolicyRequestProtectionArgs:
    def __init__(__self__, *,
                 body_inspection_size_limit_exceeded_action_name: Optional[pulumi.Input[builtins.str]] = None,
                 body_inspection_size_limit_in_bytes: Optional[pulumi.Input[builtins.int]] = None,
                 rules: Optional[pulumi.Input[Sequence[pulumi.Input['AppFirewallPolicyRequestProtectionRuleArgs']]]] = None):
        """
        :param pulumi.Input[builtins.str] body_inspection_size_limit_exceeded_action_name: (Updatable) References action by name from actions defined in WebAppFirewallPolicy. Executed if HTTP message body size exceeds limit set in field `bodyInspectionSizeLimitInBytes`.
               
               If this field is `null` HTTP message body will inspected up to `bodyInspectionSizeLimitInBytes` and the rest will not be inspected by Protection Capabilities.
               
               Allowed action types:
               * **RETURN_HTTP_RESPONSE** terminates further execution of modules and rules and returns defined HTTP response.
        :param pulumi.Input[builtins.int] body_inspection_size_limit_in_bytes: (Updatable) Maximum size of inspected HTTP message body in bytes. Actions to take if this limit is exceeded are defined in `bodyInspectionSizeLimitExceededActionName`.
    ...
    def body_inspection_size_limit_exceeded_action_name(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) References action by name from actions defined in WebAppFirewallPolicy. Executed if HTTP message body size exceeds limit set in field `bodyInspectionSizeLimitInBytes`.
    ...
    def body_inspection_size_limit_exceeded_action_name(self, value: Optional[pulumi.Input[builtins.str]]):
        pulumi.set(self, "body_inspection_size_limit_exceeded_action_name", value)

    @property
    @pulumi.getter(name="bodyInspectionSizeLimitInBytes")
    def body_inspection_size_limit_in_bytes(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) Maximum size of inspected HTTP message body in bytes. Actions to take if this limit is exceeded are defined in `bodyInspectionSizeLimitExceededActionName`.
    ...
    def body_inspection_size_limit_in_bytes(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class AppFirewallPolicyRequestProtectionRuleArgsDict(TypedDict):
        ...
        * **JMESPATH** an extended JMESPath language syntax.
        """
        is_body_inspection_enabled: NotRequired[pulumi.Input[builtins.bool]]
        """
...
class AppFirewallPolicyRequestProtectionRuleArgs:
    def __init__(__self__, *,
                 ...
                 condition: Optional[pulumi.Input[builtins.str]] = None,
                 condition_language: Optional[pulumi.Input[builtins.str]] = None,
                 is_body_inspection_enabled: Optional[pulumi.Input[builtins.bool]] = None,
        ...
        :param pulumi.Input[builtins.str] condition_language: (Updatable) The language used to parse condition from field `condition`. Available languages:
               * **JMESPATH** an extended JMESPath language syntax.
        :param pulumi.Input[builtins.bool] is_body_inspection_enabled: (Updatable) Enables/disables body inspection for this protection rule. Only Protection Rules in RequestProtection can have this option enabled. Response body inspection will be available at a later date.
    ...
    def is_body_inspection_enabled(self) -> Optional[pulumi.Input[builtins.bool]]:
        """
        (Updatable) Enables/disables body inspection for this protection rule. Only Protection Rules in RequestProtection can have this option enabled. Response body inspection will be available at a later date.
        """
    ...
    def is_body_inspection_enabled(self, value: Optional[pulumi.Input[builtins.bool]]):
...
if not MYPY:
    class AppFirewallPolicyRequestProtectionRuleProtectionCapabilityArgsDict(TypedDict):
        ...
        """
        collaborative_action_threshold: NotRequired[pulumi.Input[builtins.int]]
        """
...
class AppFirewallPolicyRequestProtectionRuleProtectionCapabilityArgs:
    def __init__(__self__, *,
                 ...
                 collaborative_action_threshold: Optional[pulumi.Input[builtins.int]] = None,
        ...
        """
        :param pulumi.Input[builtins.str] key: (Updatable) Unique key of referenced protection capability.
        :param pulumi.Input[builtins.int] version: (Updatable) Version of referenced protection capability.
        :param pulumi.Input[builtins.str] action_name: (Updatable) Override action to take if capability was triggered, defined in Protection Rule for this capability. Only actions of type CHECK are allowed.
        :param pulumi.Input[builtins.int] collaborative_action_threshold: (Updatable) The minimum sum of weights of associated collaborative protection capabilities that have triggered which must be reached in order for _this_ capability to trigger. This field is ignored for non-collaborative capabilities.
    ...
    def collaborative_action_threshold(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) The minimum sum of weights of associated collaborative protection capabilities that have triggered which must be reached in order for _this_ capability to trigger. This field is ignored for non-collaborative capabilities.
        """
    ...
    def collaborative_action_threshold(self, value: Optional[pulumi.Input[builtins.int]]):
...
class AppFirewallPolicyRequestProtectionRuleProtectionCapabilityCollaborativeWeightArgs:
    def __init__(__self__, *,
                 ...
                 weight: pulumi.Input[builtins.int]):
        """
        :param pulumi.Input[builtins.str] key: (Updatable) Unique key of collaborative capability for which weight will be overridden.
        :param pulumi.Input[builtins.int] weight: (Updatable) The value of weight to set.
        """
        pulumi.set(__self__, "key", key)
...
if not MYPY:
    class AppFirewallPolicyRequestProtectionRuleProtectionCapabilityExclusionsArgsDict(TypedDict):
        ...
        """
        request_cookies: NotRequired[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]
        """
...
class AppFirewallPolicyRequestProtectionRuleProtectionCapabilityExclusionsArgs:
    def __init__(__self__, *,
                 ...
                 request_cookies: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] args: (Updatable) List of URL query parameter values from form-urlencoded XML, JSON, AMP, or POST payloads to exclude from inspecting. Example: If we have query parameter 'argumentName=argumentValue' and args=['argumentName'], both 'argumentName' and 'argumentValue' will not be inspected.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] request_cookies: (Updatable) List of HTTP request cookie values (by cookie name) to exclude from inspecting. Example: If we have cookie 'cookieName=cookieValue' and requestCookies=['cookieName'], both 'cookieName' and 'cookieValue' will not be inspected.
        """
        if args is not None:
    ...
    def request_cookies(self) -> Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]:
        """
        (Updatable) List of HTTP request cookie values (by cookie name) to exclude from inspecting. Example: If we have cookie 'cookieName=cookieValue' and requestCookies=['cookieName'], both 'cookieName' and 'cookieValue' will not be inspected.
        """
    ...
    def request_cookies(self, value: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]]):
...
if not MYPY:
    class AppFirewallPolicyRequestProtectionRuleProtectionCapabilitySettingsArgsDict(TypedDict):
        ...
        """
        max_http_request_header_length: NotRequired[pulumi.Input[builtins.int]]
        """
        ...
        """
        max_http_request_headers: NotRequired[pulumi.Input[builtins.int]]
        """
...
class AppFirewallPolicyRequestProtectionRuleProtectionCapabilitySettingsArgs:
    def __init__(__self__, *,
                 ...
                 max_http_request_header_length: Optional[pulumi.Input[builtins.int]] = None,
                 max_http_request_headers: Optional[pulumi.Input[builtins.int]] = None,
                 max_number_of_arguments: Optional[pulumi.Input[builtins.int]] = None,
                 max_single_argument_length: Optional[pulumi.Input[builtins.int]] = None,
                 max_total_argument_length: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] allowed_http_methods: (Updatable) List of allowed HTTP methods. Each value as a RFC7230 formated token string. Used in protection capability 911100: Restrict HTTP Request Methods.
        :param pulumi.Input[builtins.int] max_http_request_header_length: (Updatable) Maximum allowed length of headers in an HTTP request. Used in protection capability: 9200024: Limit length of request header size.
        :param pulumi.Input[builtins.int] max_http_request_headers: (Updatable) Maximum number of headers allowed in an HTTP request. Used in protection capability 9200014: Limit Number of Request Headers.
        :param pulumi.Input[builtins.int] max_number_of_arguments: (Updatable) Maximum number of arguments allowed. Used in protection capability 920380: Number of Arguments Limits.
        :param pulumi.Input[builtins.int] max_single_argument_length: (Updatable) Maximum allowed length of a single argument. Used in protection capability 920370: Limit argument value length.
        :param pulumi.Input[builtins.int] max_total_argument_length: (Updatable) Maximum allowed total length of all arguments. Used in protection capability 920390: Limit arguments total length.
        """
    ...
    def max_http_request_header_length(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) Maximum allowed length of headers in an HTTP request. Used in protection capability: 9200024: Limit length of request header size.
        """
    ...
    def max_http_request_header_length(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_http_request_header_length", value)

    @property
    @pulumi.getter(name="maxHttpRequestHeaders")
    def max_http_request_headers(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) Maximum number of headers allowed in an HTTP request. Used in protection capability 9200014: Limit Number of Request Headers.
        """
    ...
    def max_http_request_headers(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_http_request_headers", value)

    @property
    @pulumi.getter(name="maxNumberOfArguments")
    def max_number_of_arguments(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) Maximum number of arguments allowed. Used in protection capability 920380: Number of Arguments Limits.
        """
    ...
    def max_number_of_arguments(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_number_of_arguments", value)

    @property
    @pulumi.getter(name="maxSingleArgumentLength")
    def max_single_argument_length(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) Maximum allowed length of a single argument. Used in protection capability 920370: Limit argument value length.
        """
    ...
    def max_single_argument_length(self, value: Optional[pulumi.Input[builtins.int]]):
        pulumi.set(self, "max_single_argument_length", value)

    @property
    @pulumi.getter(name="maxTotalArgumentLength")
    def max_total_argument_length(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) Maximum allowed total length of all arguments. Used in protection capability 920390: Limit arguments total length.
        """
    ...
    def max_total_argument_length(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class AppFirewallPolicyRequestRateLimitingRuleConfigurationArgsDict(TypedDict):
        period_in_seconds: pulumi.Input[builtins.int]
        """
        (Updatable) Evaluation period in seconds.
        """
        requests_limit: pulumi.Input[builtins.int]
        """
        (Updatable) Requests allowed per evaluation period.
        """
        action_duration_in_seconds: NotRequired[pulumi.Input[builtins.int]]
        """
...
class AppFirewallPolicyRequestRateLimitingRuleConfigurationArgs:
    def __init__(__self__, *,
                 period_in_seconds: pulumi.Input[builtins.int],
                 requests_limit: pulumi.Input[builtins.int],
                 action_duration_in_seconds: Optional[pulumi.Input[builtins.int]] = None):
        """
        :param pulumi.Input[builtins.int] period_in_seconds: (Updatable) Evaluation period in seconds.
        :param pulumi.Input[builtins.int] requests_limit: (Updatable) Requests allowed per evaluation period.
        :param pulumi.Input[builtins.int] action_duration_in_seconds: (Updatable) Duration of block action application in seconds when `requestsLimit` is reached. Optional and can be 0 (no block duration).
        """
    ...
    def period_in_seconds(self) -> pulumi.Input[builtins.int]:
        """
        (Updatable) Evaluation period in seconds.
        """
    ...
    def period_in_seconds(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "period_in_seconds", value)

    @property
    @pulumi.getter(name="requestsLimit")
    def requests_limit(self) -> pulumi.Input[builtins.int]:
        """
        (Updatable) Requests allowed per evaluation period.
        """
    ...
    def requests_limit(self, value: pulumi.Input[builtins.int]):
        pulumi.set(self, "requests_limit", value)

    @property
    @pulumi.getter(name="actionDurationInSeconds")
    def action_duration_in_seconds(self) -> Optional[pulumi.Input[builtins.int]]:
        """
        (Updatable) Duration of block action application in seconds when `requestsLimit` is reached. Optional and can be 0 (no block duration).
        """
    ...
    def action_duration_in_seconds(self, value: Optional[pulumi.Input[builtins.int]]):
...
if not MYPY:
    class NetworkAddressListVcnAddressArgsDict(TypedDict):
        addresses: NotRequired[pulumi.Input[builtins.str]]
        """
...
class NetworkAddressListVcnAddressArgs:
    def __init__(__self__, *,
                 addresses: Optional[pulumi.Input[builtins.str]] = None,
                 vcn_id: Optional[pulumi.Input[builtins.str]] = None):
        """
        :param pulumi.Input[builtins.str] addresses: (Updatable) A private IP address or CIDR IP address range.
        :param pulumi.Input[builtins.str] vcn_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VCN.
    ...
    @property
    @pulumi.getter
    def addresses(self) -> Optional[pulumi.Input[builtins.str]]:
        """
        (Updatable) A private IP address or CIDR IP address range.
        """
    ...
    @addresses.setter
    def addresses(self, value: Optional[pulumi.Input[builtins.str]]):
