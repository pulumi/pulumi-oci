...
class AppFirewallPolicyArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) WebAppFirewallPolicy display name, can be renamed.
...
class _AppFirewallPolicyState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input['AppFirewallPolicyResponseAccessControlArgs'] response_access_control: (Updatable) Module that allows inspection of HTTP response properties and to return a defined HTTP response.
        :param pulumi.Input['AppFirewallPolicyResponseProtectionArgs'] response_protection: (Updatable) Module that allows to enable OCI-managed protection capabilities for HTTP responses.
        :param pulumi.Input[builtins.str] state: The current state of the WebAppFirewallPolicy.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] system_tags: (Updatable) Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}` 
               
               
               ** IMPORTANT **
               Any change to a property that does not support update will force the destruction and recreation of the resource with the new property values
        :param pulumi.Input[builtins.str] time_created: The time the WebAppFirewallPolicy was created. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The time the WebAppFirewallPolicy was updated. An RFC3339 formatted datetime string.
        """
        if actions is not None:
            pulumi.set(__self__, "actions", actions)
...
class AppFirewallPolicy(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            system_tags: Optional[pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]]] = None,
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None) -> 'AppFirewallPolicy':
        """
