...
class GetNetworkAddressListResult:
    ...
    def network_address_list_id(self) -> builtins.str:
...
def get_network_address_list(network_address_list_id: Optional[builtins.str] = None,
    ...
    :param builtins.str network_address_list_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the NetworkAddressList.
    """
    __args__ = dict()
...
def get_network_address_list_output(network_address_list_id: Optional[pulumi.Input[builtins.str]] = None,
