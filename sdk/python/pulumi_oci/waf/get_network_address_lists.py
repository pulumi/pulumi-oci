...
def get_network_address_lists(compartment_id: Optional[builtins.str] = None,
...
def get_network_address_lists_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
