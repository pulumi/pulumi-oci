...
class GetWebAppFirewallResult:
    ...
    def web_app_firewall_id(self) -> _builtins.str:
...
def get_web_app_firewall(web_app_firewall_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str web_app_firewall_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the WebAppFirewall.
    """
    __args__ = dict()
