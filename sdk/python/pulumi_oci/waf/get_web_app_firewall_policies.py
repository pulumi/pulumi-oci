...
def get_web_app_firewall_policies(compartment_id: Optional[builtins.str] = None,
...
def get_web_app_firewall_policies_output(compartment_id: Optional[pulumi.Input[builtins.str]] = None,
