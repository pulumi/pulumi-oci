...
def get_web_app_firewall_policy(web_app_firewall_policy_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str web_app_firewall_policy_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the WebAppFirewallPolicy.
    """
    __args__ = dict()
...
def get_web_app_firewall_policy_output(web_app_firewall_policy_id: Optional[pulumi.Input[_builtins.str]] = None,
