...
class NetworkAddressListArgs:
    def __init__(__self__, *,
                 ...
                 vcn_addresses: pulumi.Input[Optional[Sequence[pulumi.Input['NetworkAddressListVcnAddressArgs']]]] = None):
        """
        ...
        :param pulumi.Input[_builtins.str] display_name: (Updatable) NetworkAddressList display name, can be renamed.
    ...
    def vcn_addresses(self) -> pulumi.Input[Optional[Sequence[pulumi.Input['NetworkAddressListVcnAddressArgs']]]]:
        """
    ...
    def vcn_addresses(self, value: pulumi.Input[Optional[Sequence[pulumi.Input['NetworkAddressListVcnAddressArgs']]]]):
...
class _NetworkAddressListState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] state: The current state of the NetworkAddressList.
        :param pulumi.Input[Mapping[str, pulumi.Input[_builtins.str]]] system_tags: (Updatable) Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
