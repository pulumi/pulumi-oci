...
class NetworkAddressListArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] type: (Updatable) Type of NetworkAddressList.
        :param pulumi.Input[Sequence[pulumi.Input[builtins.str]]] addresses: (Updatable) A list of IP address prefixes in CIDR notation. To specify all addresses, use "0.0.0.0/0" for IPv4 and "::/0" for IPv6.
        ...
        :param pulumi.Input[builtins.str] display_name: (Updatable) NetworkAddressList display name, can be renamed.
...
class _NetworkAddressListState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] state: The current state of the NetworkAddressList.
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] system_tags: (Updatable) Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param pulumi.Input[builtins.str] time_created: The time the NetworkAddressList was created. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] time_updated: The time the NetworkAddressList was updated. An RFC3339 formatted datetime string.
        :param pulumi.Input[builtins.str] type: (Updatable) Type of NetworkAddressList.
        :param pulumi.Input[Sequence[pulumi.Input['NetworkAddressListVcnAddressArgs']]] vcn_addresses: (Updatable) A list of private address prefixes, each associated with a particular VCN. To specify all addresses in a VCN, use "0.0.0.0/0" for IPv4 and "::/0" for IPv6.
        """
        if addresses is not None:
...
class NetworkAddressList(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            type: Optional[pulumi.Input[builtins.str]] = None,
            vcn_addresses: Optional[pulumi.Input[Sequence[pulumi.Input[Union['NetworkAddressListVcnAddressArgs', 'NetworkAddressListVcnAddressArgsDict']]]]] = None) -> 'NetworkAddressList':
        """
