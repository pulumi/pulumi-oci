...
class AppFirewallPolicyAction(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: (Updatable) Action name. Can be used to reference the action.
        :param builtins.str type: (Updatable) 
        ...
        :param builtins.int code: (Updatable) Response code.
...
class AppFirewallPolicyActionBody(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str type: (Updatable) Type of HttpResponseBody.
        :param builtins.str text: (Updatable) Static response body text.
        """
        pulumi.set(__self__, "type", type)
...
class AppFirewallPolicyActionHeader(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: (Updatable) The name of the header field.
        :param builtins.str value: (Updatable) The value of the header field.
        """
        if name is not None:
            pulumi.set(__self__, "name", name)
...
class AppFirewallPolicyRequestAccessControl(dict):
    ...
    def __init__(__self__, *,
                 default_action_name: builtins.str,
                 rules: Optional[Sequence['outputs.AppFirewallPolicyRequestAccessControlRule']] = None):
        """
        :param builtins.str default_action_name: (Updatable) References an default Action to take if no AccessControlRule was matched. Allowed action types:
    ...
    def default_action_name(self) -> builtins.str:
        """
...
class AppFirewallPolicyRequestAccessControlRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 condition_language: Optional[builtins.str] = None):
        """
        :param builtins.str action_name: (Updatable) References action by name from actions defined in WebAppFirewallPolicy.
        :param builtins.str name: (Updatable) Rule name. Must be unique within the module.
        :param builtins.str type: (Updatable) Type of WebAppFirewallPolicyRule.
        :param builtins.str condition: (Updatable) An expression that determines whether or not the rule action should be executed.
        :param builtins.str condition_language: (Updatable) The language used to parse condition from field `condition`. Available languages:
    ...
    def condition_language(self) -> Optional[builtins.str]:
        """
...
class AppFirewallPolicyRequestProtection(dict):
    ...
    def __init__(__self__, *,
                 body_inspection_size_limit_exceeded_action_name: Optional[builtins.str] = None,
                 body_inspection_size_limit_in_bytes: Optional[builtins.int] = None,
                 rules: Optional[Sequence['outputs.AppFirewallPolicyRequestProtectionRule']] = None):
        """
        :param builtins.str body_inspection_size_limit_exceeded_action_name: (Updatable) References action by name from actions defined in WebAppFirewallPolicy. Executed if HTTP message body size exceeds limit set in field `bodyInspectionSizeLimitInBytes`.
               ...
               * **RETURN_HTTP_RESPONSE** terminates further execution of modules and rules and returns defined HTTP response.
        :param builtins.int body_inspection_size_limit_in_bytes: (Updatable) Maximum size of inspected HTTP message body in bytes. Actions to take if this limit is exceeded are defined in `bodyInspectionSizeLimitExceededActionName`.
    ...
    def body_inspection_size_limit_exceeded_action_name(self) -> Optional[builtins.str]:
        """
    ...
    def body_inspection_size_limit_in_bytes(self) -> Optional[builtins.int]:
        """
...
class AppFirewallPolicyRequestProtectionRule(dict):
    ...
    def __init__(__self__, *,
                 ...
                 condition: Optional[builtins.str] = None,
                 condition_language: Optional[builtins.str] = None,
                 is_body_inspection_enabled: Optional[builtins.bool] = None,
        ...
        :param builtins.str condition_language: (Updatable) The language used to parse condition from field `condition`. Available languages:
               * **JMESPATH** an extended JMESPath language syntax.
        :param builtins.bool is_body_inspection_enabled: (Updatable) Enables/disables body inspection for this protection rule. Only Protection Rules in RequestProtection can have this option enabled. Response body inspection will be available at a later date.
    ...
    def is_body_inspection_enabled(self) -> Optional[builtins.bool]:
        """
...
class AppFirewallPolicyRequestProtectionRuleProtectionCapability(dict):
    ...
    def __init__(__self__, *,
                 ...
                 collaborative_action_threshold: Optional[builtins.int] = None,
        ...
        """
        :param builtins.str key: (Updatable) Unique key of referenced protection capability.
        :param builtins.int version: (Updatable) Version of referenced protection capability.
        :param builtins.str action_name: (Updatable) Override action to take if capability was triggered, defined in Protection Rule for this capability. Only actions of type CHECK are allowed.
        :param builtins.int collaborative_action_threshold: (Updatable) The minimum sum of weights of associated collaborative protection capabilities that have triggered which must be reached in order for _this_ capability to trigger. This field is ignored for non-collaborative capabilities.
    ...
    def collaborative_action_threshold(self) -> Optional[builtins.int]:
        """
...
class AppFirewallPolicyRequestProtectionRuleProtectionCapabilityCollaborativeWeight(dict):
    def __init__(__self__, *,
                 ...
                 weight: builtins.int):
        """
        :param builtins.str key: (Updatable) Unique key of collaborative capability for which weight will be overridden.
        :param builtins.int weight: (Updatable) The value of weight to set.
        """
        pulumi.set(__self__, "key", key)
...
class AppFirewallPolicyRequestProtectionRuleProtectionCapabilityExclusions(dict):
    ...
    def __init__(__self__, *,
                 ...
                 request_cookies: Optional[Sequence[builtins.str]] = None):
        """
        :param Sequence[builtins.str] args: (Updatable) List of URL query parameter values from form-urlencoded XML, JSON, AMP, or POST payloads to exclude from inspecting. Example: If we have query parameter 'argumentName=argumentValue' and args=['argumentName'], both 'argumentName' and 'argumentValue' will not be inspected.
        :param Sequence[builtins.str] request_cookies: (Updatable) List of HTTP request cookie values (by cookie name) to exclude from inspecting. Example: If we have cookie 'cookieName=cookieValue' and requestCookies=['cookieName'], both 'cookieName' and 'cookieValue' will not be inspected.
        """
        if args is not None:
    ...
    def request_cookies(self) -> Optional[Sequence[builtins.str]]:
        """
...
class AppFirewallPolicyRequestProtectionRuleProtectionCapabilitySettings(dict):
    ...
    def __init__(__self__, *,
                 allowed_http_methods: Optional[Sequence[builtins.str]] = None,
                 max_http_request_header_length: Optional[builtins.int] = None,
                 max_http_request_headers: Optional[builtins.int] = None,
                 max_number_of_arguments: Optional[builtins.int] = None,
                 max_single_argument_length: Optional[builtins.int] = None,
                 max_total_argument_length: Optional[builtins.int] = None):
        """
        :param Sequence[builtins.str] allowed_http_methods: (Updatable) List of allowed HTTP methods. Each value as a RFC7230 formated token string. Used in protection capability 911100: Restrict HTTP Request Methods.
        :param builtins.int max_http_request_header_length: (Updatable) Maximum allowed length of headers in an HTTP request. Used in protection capability: 9200024: Limit length of request header size.
        :param builtins.int max_http_request_headers: (Updatable) Maximum number of headers allowed in an HTTP request. Used in protection capability 9200014: Limit Number of Request Headers.
        :param builtins.int max_number_of_arguments: (Updatable) Maximum number of arguments allowed. Used in protection capability 920380: Number of Arguments Limits.
        :param builtins.int max_single_argument_length: (Updatable) Maximum allowed length of a single argument. Used in protection capability 920370: Limit argument value length.
        :param builtins.int max_total_argument_length: (Updatable) Maximum allowed total length of all arguments. Used in protection capability 920390: Limit arguments total length.
        """
    ...
    def allowed_http_methods(self) -> Optional[Sequence[builtins.str]]:
        """
    ...
    def max_http_request_header_length(self) -> Optional[builtins.int]:
        """
    ...
    def max_http_request_headers(self) -> Optional[builtins.int]:
        """
    ...
    def max_number_of_arguments(self) -> Optional[builtins.int]:
        """
    ...
    def max_single_argument_length(self) -> Optional[builtins.int]:
        """
    ...
    def max_total_argument_length(self) -> Optional[builtins.int]:
        """
...
class AppFirewallPolicyRequestRateLimitingRuleConfiguration(dict):
    ...
    def __init__(__self__, *,
                 period_in_seconds: builtins.int,
                 requests_limit: builtins.int,
                 action_duration_in_seconds: Optional[builtins.int] = None):
        """
        :param builtins.int period_in_seconds: (Updatable) Evaluation period in seconds.
        :param builtins.int requests_limit: (Updatable) Requests allowed per evaluation period.
        :param builtins.int action_duration_in_seconds: (Updatable) Duration of block action application in seconds when `requestsLimit` is reached. Optional and can be 0 (no block duration).
        """
    ...
    def period_in_seconds(self) -> builtins.int:
        """
    ...
    def requests_limit(self) -> builtins.int:
        """
    ...
    def action_duration_in_seconds(self) -> Optional[builtins.int]:
        """
...
class NetworkAddressListVcnAddress(dict):
    ...
    def __init__(__self__, *,
                 addresses: Optional[builtins.str] = None,
                 vcn_id: Optional[builtins.str] = None):
        """
        :param builtins.str addresses: (Updatable) A private IP address or CIDR IP address range.
        :param builtins.str vcn_id: (Updatable) The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the VCN.
    ...
    @property
    @pulumi.getter
    def addresses(self) -> Optional[builtins.str]:
        """
...
class GetFirewallsWebAppFirewallCollectionItemResult(dict):
    def __init__(__self__, *,
                 ...
                 web_app_firewall_policy_id: builtins.str):
        """
        :param builtins.str backend_type: Type of the WebAppFirewall, as example LOAD_BALANCER.
        ...
        :param builtins.str id: A filter to return only the WebAppFirewall with the given [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        ...
        :param builtins.str load_balancer_id: LoadBalancer [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) to which the WebAppFirewallPolicy is attached to.
        :param builtins.str state: A filter to return only resources that match the given lifecycleState.
        ...
        :param builtins.str time_created: The time the WebAppFirewall was created. An RFC3339 formatted datetime string.
        :param builtins.str time_updated: The time the WebAppFirewall was updated. An RFC3339 formatted datetime string.
        :param builtins.str web_app_firewall_policy_id: A filter to return only the WebAppFirewall with the given [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of related WebAppFirewallPolicy.
        """
...
class GetNetworkAddressListVcnAddressResult(dict):
    def __init__(__self__, *,
                 addresses: builtins.str,
                 vcn_id: builtins.str):
        """
        :param builtins.str addresses: A private IP address or CIDR IP address range.
    ...
    @property
    @pulumi.getter
    def addresses(self) -> builtins.str:
        """
...
class GetNetworkAddressListsNetworkAddressListCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param Sequence[builtins.str] addresses: A private IP address or CIDR IP address range.
        :param builtins.str compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the compartment in which to list resources.
        :param Mapping[str, builtins.str] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. Example: `{"foo-namespace.bar-key": "value"}`
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: A filter to return only the NetworkAddressList with the given [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param builtins.str lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in FAILED state.
        :param builtins.str state: A filter to return only resources that match the given lifecycleState.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The time the NetworkAddressList was created. An RFC3339 formatted datetime string.
        :param builtins.str time_updated: The time the NetworkAddressList was updated. An RFC3339 formatted datetime string.
        :param builtins.str type: Type of NetworkAddressList.
...
class GetProtectionCapabilitiesProtectionCapabilityCollectionItemResult(dict):
    def __init__(__self__, *,
                 collaborative_action_threshold: builtins.int,
                 ...
                 display_name: builtins.str,
                 group_tags: Sequence[builtins.str],
                 is_latest_version: builtins.bool,
                 key: builtins.str,
                 type: builtins.str,
                 version: builtins.int):
        """
        :param builtins.int collaborative_action_threshold: The default collaborative action threshold for OCI-managed collaborative protection capability. Collaborative protection capabilities are made of several simple, non-collaborative protection capabilities (referred to as `contributing capabilities` later on) which have weights assigned to them. These weights can be found in the `collaborativeWeights` array. For incoming/outgoing HTTP messages, all contributing capabilities are executed and the sum of all triggered contributing capabilities weights is calculated. Only if this sum is greater than or equal to `collaborativeActionThreshold` is the incoming/outgoing HTTP message marked as malicious.
        ...
        :param builtins.str description: The description of protection capability.
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param Sequence[builtins.str] group_tags: The list of unique names protection capability group tags that are associated with this capability. Example: ["PCI", "Recommended"]
        :param builtins.bool is_latest_version: A filter to return only resources that matches given isLatestVersion.
        :param builtins.str key: The unique key of protection capability to filter by.
        :param builtins.str type: A filter to return only resources that matches given type.
        :param builtins.int version: The version of protection capability.
        """
        pulumi.set(__self__, "collaborative_action_threshold", collaborative_action_threshold)
        pulumi.set(__self__, "collaborative_weights", collaborative_weights)
    ...
    @property
    @pulumi.getter(name="collaborativeActionThreshold")
    def collaborative_action_threshold(self) -> builtins.int:
        """
    ...
    def group_tags(self) -> Sequence[builtins.str]:
        """
...
class GetProtectionCapabilitiesProtectionCapabilityCollectionItemCollaborativeWeightResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param builtins.str key: The unique key of protection capability to filter by.
        :param builtins.int weight: The weight of contributing protection capability.
        """
        pulumi.set(__self__, "display_name", display_name)
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "weight", weight)
...
class GetWebAppFirewallPoliciesFilterResult(dict):
    def __init__(__self__, *,
                 ...
                 regex: Optional[builtins.bool] = None):
        """
        :param builtins.str name: Rule name. Must be unique within the module.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "values", values)
        if regex is not None:
...
class GetWebAppFirewallPoliciesWebAppFirewallPolicyCollectionItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str display_name: A filter to return only resources that match the entire display name given.
        :param Mapping[str, builtins.str] freeform_tags: Simple key-value pair that is applied without any predefined name, type or scope. Exists for cross-compatibility only. Example: `{"bar-key": "value"}`
        :param builtins.str id: A filter to return only the WebAppFirewallPolicy with the given [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm).
        :param builtins.str lifecycle_details: A message describing the current state in more detail. For example, can be used to provide actionable information for a resource in FAILED state.
        ...
        :param builtins.str state: A filter to return only resources that match the given lifecycleState.
        :param Mapping[str, builtins.str] system_tags: Usage of system tag keys. These predefined keys are scoped to namespaces. Example: `{"orcl-cloud.free-tier-retained": "true"}`
        :param builtins.str time_created: The time the WebAppFirewallPolicy was created. An RFC3339 formatted datetime string.
        :param builtins.str time_updated: The time the WebAppFirewallPolicy was updated. An RFC3339 formatted datetime string.
        """
...
class GetWebAppFirewallPoliciesWebAppFirewallPolicyCollectionItemActionResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.int code: Response code.
        ...
        :param builtins.str name: Rule name. Must be unique within the module.
        :param builtins.str type: Type of WebAppFirewallPolicyRule.
        """
...
class GetWebAppFirewallPoliciesWebAppFirewallPolicyCollectionItemActionBodyResult(dict):
    def __init__(__self__, *,
                 ...
                 type: builtins.str):
        """
        :param builtins.str text: Static response body text.
        :param builtins.str type: Type of WebAppFirewallPolicyRule.
        """
        pulumi.set(__self__, "template", template)
        pulumi.set(__self__, "text", text)
...
class GetWebAppFirewallPoliciesWebAppFirewallPolicyCollectionItemActionHeaderResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str name: Rule name. Must be unique within the module.
        :param builtins.str value: The value of the header field.
        """
        pulumi.set(__self__, "name", name)
        pulumi.set(__self__, "value", value)
...
class GetWebAppFirewallPoliciesWebAppFirewallPolicyCollectionItemRequestAccessControlResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str default_action_name: References an default Action to take if no AccessControlRule was matched. Allowed action types:
               * **ALLOW** continues execution of other modules and their rules.
               * **RETURN_HTTP_RESPONSE** terminates further execution of modules and rules and returns defined HTTP response.
...
class GetWebAppFirewallPoliciesWebAppFirewallPolicyCollectionItemRequestAccessControlRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 condition_language: builtins.str,
                 name: builtins.str,
                 type: builtins.str):
        """
        :param builtins.str action_name: Override action to take if capability was triggered, defined in Protection Rule for this capability. Only actions of type CHECK are allowed.
        :param builtins.str condition: An expression that determines whether or not the rule action should be executed.
        :param builtins.str condition_language: The language used to parse condition from field `condition`. Available languages:
               * **JMESPATH** an extended JMESPath language syntax.
        :param builtins.str name: Rule name. Must be unique within the module.
        :param builtins.str type: Type of WebAppFirewallPolicyRule.
        """
    ...
    @property
    @pulumi.getter(name="conditionLanguage")
    def condition_language(self) -> builtins.str:
        """
...
class GetWebAppFirewallPoliciesWebAppFirewallPolicyCollectionItemRequestProtectionResult(dict):
    def __init__(__self__, *,
                 body_inspection_size_limit_exceeded_action_name: builtins.str,
                 body_inspection_size_limit_in_bytes: builtins.int,
                 rules: Sequence['outputs.GetWebAppFirewallPoliciesWebAppFirewallPolicyCollectionItemRequestProtectionRuleResult']):
        """
        :param builtins.str body_inspection_size_limit_exceeded_action_name: References action by name from actions defined in WebAppFirewallPolicy. Executed if HTTP message body size exceeds limit set in field `bodyInspectionSizeLimitInBytes`.
        :param builtins.int body_inspection_size_limit_in_bytes: Maximum size of inspected HTTP message body in bytes. Actions to take if this limit is exceeded are defined in `bodyInspectionSizeLimitExceededActionName`.
    ...
    @property
    @pulumi.getter(name="bodyInspectionSizeLimitExceededActionName")
    def body_inspection_size_limit_exceeded_action_name(self) -> builtins.str:
        """
    ...
    @property
    @pulumi.getter(name="bodyInspectionSizeLimitInBytes")
    def body_inspection_size_limit_in_bytes(self) -> builtins.int:
        """
...
class GetWebAppFirewallPoliciesWebAppFirewallPolicyCollectionItemRequestProtectionRuleResult(dict):
    def __init__(__self__, *,
                 ...
                 condition: builtins.str,
                 condition_language: builtins.str,
                 is_body_inspection_enabled: builtins.bool,
                 name: builtins.str,
        ...
        :param builtins.str condition_language: The language used to parse condition from field `condition`. Available languages:
               * **JMESPATH** an extended JMESPath language syntax.
        :param builtins.bool is_body_inspection_enabled: Enables/disables body inspection for this protection rule. Only Protection Rules in RequestProtection can have this option enabled. Response body inspection will be available at a later date.
        :param builtins.str name: Rule name. Must be unique within the module.
    ...
    @property
    @pulumi.getter(name="isBodyInspectionEnabled")
    def is_body_inspection_enabled(self) -> builtins.bool:
        """
...
class GetWebAppFirewallPoliciesWebAppFirewallPolicyCollectionItemRequestProtectionRuleProtectionCapabilityResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str action_name: Override action to take if capability was triggered, defined in Protection Rule for this capability. Only actions of type CHECK are allowed.
        :param builtins.int collaborative_action_threshold: The minimum sum of weights of associated collaborative protection capabilities that have triggered which must be reached in order for _this_ capability to trigger. This field is ignored for non-collaborative capabilities.
        ...
        :param builtins.str key: Unique key of referenced protection capability.
        :param builtins.int version: Version of referenced protection capability.
        """
        pulumi.set(__self__, "action_name", action_name)
        pulumi.set(__self__, "collaborative_action_threshold", collaborative_action_threshold)
        pulumi.set(__self__, "collaborative_weights", collaborative_weights)
...
class GetWebAppFirewallPoliciesWebAppFirewallPolicyCollectionItemRequestProtectionRuleProtectionCapabilityCollaborativeWeightResult(dict):
    def __init__(__self__, *,
        ...
        """
        :param builtins.str key: Unique key of referenced protection capability.
        :param builtins.int weight: The value of weight to set.
        """
        pulumi.set(__self__, "key", key)
        pulumi.set(__self__, "weight", weight)
...
class GetWebAppFirewallPoliciesWebAppFirewallPolicyCollectionItemRequestProtectionRuleProtectionCapabilityExclusionResult(dict):
    def __init__(__self__, *,
                 ...
                 request_cookies: Sequence[builtins.str]):
        """
        :param Sequence[builtins.str] args: List of URL query parameter values from form-urlencoded XML, JSON, AMP, or POST payloads to exclude from inspecting. Example: If we have query parameter 'argumentName=argumentValue' and args=['argumentName'], both 'argumentName' and 'argumentValue' will not be inspected.
        :param Sequence[builtins.str] request_cookies: List of HTTP request cookie values (by cookie name) to exclude from inspecting. Example: If we have cookie 'cookieName=cookieValue' and requestCookies=['cookieName'], both 'cookieName' and 'cookieValue' will not be inspected.
        """
        pulumi.set(__self__, "args", args)
        pulumi.set(__self__, "request_cookies", request_cookies)
    ...
    @property
    @pulumi.getter(name="requestCookies")
    def request_cookies(self) -> Sequence[builtins.str]:
        """
...
class GetWebAppFirewallPoliciesWebAppFirewallPolicyCollectionItemRequestProtectionRuleProtectionCapabilitySettingResult(dict):
    def __init__(__self__, *,
                 allowed_http_methods: Sequence[builtins.str],
                 max_http_request_header_length: builtins.int,
                 max_http_request_headers: builtins.int,
                 max_number_of_arguments: builtins.int,
                 max_single_argument_length: builtins.int,
                 max_total_argument_length: builtins.int):
        """
        :param Sequence[builtins.str] allowed_http_methods: List of allowed HTTP methods. Each value as a RFC7230 formated token string. Used in protection capability 911100: Restrict HTTP Request Methods.
        :param builtins.int max_http_request_header_length: Maximum allowed length of headers in an HTTP request. Used in protection capability: 9200024: Limit length of request header size.
        :param builtins.int max_http_request_headers: Maximum number of headers allowed in an HTTP request. Used in protection capability 9200014: Limit Number of Request Headers.
        :param builtins.int max_number_of_arguments: Maximum number of arguments allowed. Used in protection capability 920380: Number of Arguments Limits.
        :param builtins.int max_single_argument_length: Maximum allowed length of a single argument. Used in protection capability 920370: Limit argument value length.
        :param builtins.int max_total_argument_length: Maximum allowed total length of all arguments. Used in protection capability 920390: Limit arguments total length.
        """
        pulumi.set(__self__, "allowed_http_methods", allowed_http_methods)
        pulumi.set(__self__, "max_http_request_header_length", max_http_request_header_length)
        pulumi.set(__self__, "max_http_request_headers", max_http_request_headers)
    ...
    @property
    @pulumi.getter(name="allowedHttpMethods")
    def allowed_http_methods(self) -> Sequence[builtins.str]:
        """
    ...
    @property
    @pulumi.getter(name="maxHttpRequestHeaderLength")
    def max_http_request_header_length(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="maxHttpRequestHeaders")
    def max_http_request_headers(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="maxNumberOfArguments")
    def max_number_of_arguments(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="maxSingleArgumentLength")
    def max_single_argument_length(self) -> builtins.int:
        """
    ...
    @property
    @pulumi.getter(name="maxTotalArgumentLength")
    def max_total_argument_length(self) -> builtins.int:
        """
...
class GetWebAppFirewallPoliciesWebAppFirewallPolicyCollectionItemRequestRateLimitingRuleConfigurationResult(dict):
    def __init__(__self__, *,
                 action_duration_in_seconds: builtins.int,
                 period_in_seconds: builtins.int,
                 requests_limit: builtins.int):
        """
        :param builtins.int action_duration_in_seconds: Duration of block action application in seconds when `requestsLimit` is reached. Optional and can be 0 (no block duration).
        :param builtins.int period_in_seconds: Evaluation period in seconds.
        :param builtins.int requests_limit: Requests allowed per evaluation period.
        """
        pulumi.set(__self__, "action_duration_in_seconds", action_duration_in_seconds)
        pulumi.set(__self__, "period_in_seconds", period_in_seconds)
        pulumi.set(__self__, "requests_limit", requests_limit)
    ...
    @property
    @pulumi.getter(name="actionDurationInSeconds")
    def action_duration_in_seconds(self) -> builtins.int:
        """
