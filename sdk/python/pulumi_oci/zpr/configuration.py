...
class ConfigurationArgs:
    def __init__(__self__, *,
                 ...
                 zpr_status: Optional[pulumi.Input[builtins.str]] = None):
        """
        The set of arguments for constructing a Configuration resource.
        :param pulumi.Input[builtins.str] compartment_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the tenancy into which ZPR resources will be bootstrapped.
        ...
        :param pulumi.Input[builtins.str] zpr_status: The enabled or disabled status of ZPR in the tenancy.
    ...
    def zpr_status(self) -> Optional[pulumi.Input[builtins.str]]:
        """
    ...
    @zpr_status.setter
    def zpr_status(self, value: Optional[pulumi.Input[builtins.str]]):
...
class _ConfigurationState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] defined_tags: Defined tags for this resource. Each key is predefined and scoped to a namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Operations.CostCenter": "42"}`
        :param pulumi.Input[Mapping[str, pulumi.Input[builtins.str]]] freeform_tags: Free-form tags for this resource. Each tag is a simple key-value pair with no predefined name, type, or namespace. For more information, see [Resource Tags](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/resourcetags.htm).  Example: `{"Department": "Finance"}`
        :param pulumi.Input[builtins.str] lifecycle_details: A message that describes the current state of ZPR in more detail. For example, can be used to provide actionable information for a resource in the Failed state.
        :param pulumi.Input[builtins.str] state: The current state of ZPR in the tenancy.
        ...
        :param pulumi.Input[builtins.str] time_created: The date and time that ZPR was onboarded to the tenancy, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] time_updated: The date and time that ZPR was updated, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param pulumi.Input[builtins.str] zpr_status: The enabled or disabled status of ZPR in the tenancy.
...
class Configuration(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            time_created: Optional[pulumi.Input[builtins.str]] = None,
            time_updated: Optional[pulumi.Input[builtins.str]] = None,
            zpr_status: Optional[pulumi.Input[builtins.str]] = None) -> 'Configuration':
        """
    ...
    @property
    @pulumi.getter(name="zprStatus")
    def zpr_status(self) -> pulumi.Output[builtins.str]:
        """
        The enabled or disabled status of ZPR in the tenancy.
