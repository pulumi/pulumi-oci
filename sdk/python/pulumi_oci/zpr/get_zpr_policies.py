...
def get_zpr_policies(compartment_id: Optional[builtins.str] = None,
...
def get_zpr_policies_output(compartment_id: Optional[pulumi.Input[Optional[builtins.str]]] = None,
