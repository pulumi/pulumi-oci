...
class GetZprPolicyResult:
    ...
    def zpr_policy_id(self) -> _builtins.str:
...
def get_zpr_policy(zpr_policy_id: Optional[_builtins.str] = None,
    ...
    :param _builtins.str zpr_policy_id: The [OCID](https://docs.cloud.oracle.com/iaas/Content/General/Concepts/identifiers.htm) of the ZprPolicy.
    """
    __args__ = dict()
...
def get_zpr_policy_output(zpr_policy_id: Optional[pulumi.Input[_builtins.str]] = None,
