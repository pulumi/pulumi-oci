...
class GetZprPoliciesZprPolicyItemResult(dict):
    def __init__(__self__, *,
        ...
        :param builtins.str description: The description you assign to the ZprPolicy during creation. Does not have to be unique, and it's changeable.
        ...
        :param builtins.str lifecycle_details: A message that describes the current state of the ZprPolicy in more detail. For example, can be used to provide actionable information for a resource in the Failed state.
        :param builtins.str name: A filter to return only resources that match the entire display name given.
        ...
        :param Sequence[builtins.str] statements: An array of ZprPolicy statements (up to 25 statements per ZprPolicy) written in the Zero Trust Packet Routing Policy Language.
        ...
        :param builtins.str time_created: The date and time the ZprPolicy was created, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        :param builtins.str time_updated: The date and time the ZprPolicy was updated, in the format defined by [RFC 3339](https://tools.ietf.org/html/rfc3339).  Example: `2016-08-25T21:10:29.600Z`
        """
